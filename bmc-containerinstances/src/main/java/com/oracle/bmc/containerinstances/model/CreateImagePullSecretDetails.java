...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "secretType",
        defaultImpl = CreateImagePullSecretDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateVaultImagePullSecretDetails.class,
            name = "VAULT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateBasicImagePullSecretDetails.class,
            name = "BASIC")
})
...
public class CreateImagePullSecretDetails
    ...
    protected CreateImagePullSecretDetails(String registryEndpoint) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateImagePullSecretDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateImagePullSecretDetails)) {
            return false;
        }

        CreateImagePullSecretDetails other = (CreateImagePullSecretDetails) o;
    ...
    public enum SecretType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static SecretType create(String key) {
            ...
            throw new IllegalArgumentException("Invalid SecretType: " + key);
        }
    };
}
