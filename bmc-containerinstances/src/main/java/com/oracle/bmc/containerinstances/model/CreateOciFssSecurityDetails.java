...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "auth",
        defaultImpl = CreateOciFssSecurityDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateOciFssSysSecurityDetails.class,
            name = "SYS")
})
...
public class CreateOciFssSecurityDetails
    ...
    protected CreateOciFssSecurityDetails(Boolean isEncryptedInTransit) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOciFssSecurityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOciFssSecurityDetails)) {
            return false;
        }

        CreateOciFssSecurityDetails other = (CreateOciFssSecurityDetails) o;
