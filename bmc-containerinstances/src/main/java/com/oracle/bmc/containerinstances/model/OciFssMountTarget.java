...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = OciFssMountTarget.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = OciFssMountTargetId.class,
        name = "OCID"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class OciFssMountTarget extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected OciFssMountTarget() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciFssMountTarget)) {
            return false;
        }

        OciFssMountTarget other = (OciFssMountTarget) o;
     ...
     *
     **/
    public enum OciFssMountTargetType {
        Ocid("OCID"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(OciFssMountTargetType.class);
        ...
        public static OciFssMountTargetType create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'OciFssMountTargetType', returning UnknownEnumValue",
                    key);
