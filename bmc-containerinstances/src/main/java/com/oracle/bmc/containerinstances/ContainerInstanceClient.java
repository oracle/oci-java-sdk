...
public class ContainerInstanceClient implements ContainerInstance {
    /**
     ...
     */
    protected ContainerInstanceClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeContainerInstanceCompartmentResponse changeContainerInstanceCompartment(
        ...
        LOG.trace("Called changeContainerInstanceCompartment");
    ...
    public CreateContainerInstanceResponse createContainerInstance(
        ...
        LOG.trace("Called createContainerInstance");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateContainerInstanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteContainerInstanceResponse deleteContainerInstance(
        ...
        LOG.trace("Called deleteContainerInstance");
    ...
    public GetContainerInstanceResponse getContainerInstance(GetContainerInstanceRequest request) {
        LOG.trace("Called getContainerInstance");
    ...
    public ListContainerInstanceShapesResponse listContainerInstanceShapes(
        ...
        LOG.trace("Called listContainerInstanceShapes");
    ...
    public ListContainerInstancesResponse listContainerInstances(
        ...
        LOG.trace("Called listContainerInstances");
    ...
    public RestartContainerInstanceResponse restartContainerInstance(
        ...
        LOG.trace("Called restartContainerInstance");
    ...
    public StartContainerInstanceResponse startContainerInstance(
        ...
        LOG.trace("Called startContainerInstance");
    ...
    public StopContainerInstanceResponse stopContainerInstance(
        ...
        LOG.trace("Called stopContainerInstance");
    ...
    public UpdateContainerResponse updateContainer(UpdateContainerRequest request) {
        LOG.trace("Called updateContainer");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateContainerDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateContainerInstanceResponse updateContainerInstance(
        ...
        LOG.trace("Called updateContainerInstance");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateContainerInstanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
