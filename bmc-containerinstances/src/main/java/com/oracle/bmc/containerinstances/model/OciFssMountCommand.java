...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OciFssMountCommand.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class OciFssMountCommand extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountOptions"})
    public OciFssMountCommand(java.util.List<OciFssMountOption> mountOptions) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<OciFssMountOption> mountOptions;
         ...
         * @return this builder
         **/
        public Builder mountOptions(java.util.List<OciFssMountOption> mountOptions) {
            this.mountOptions = mountOptions;
        ...
        public OciFssMountCommand build() {
            OciFssMountCommand model = new OciFssMountCommand(this.mountOptions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciFssMountCommand model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("mountOptions")
    private final java.util.List<OciFssMountOption> mountOptions;

    /**
     * List of mount options to be used in the mount command. The order of this array will be maintained while preparing the mount command.
     * @return the value
     **/
    public java.util.List<OciFssMountOption> getMountOptions() {
        return mountOptions;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciFssMountCommand)) {
            return false;
        }

        OciFssMountCommand other = (OciFssMountCommand) o;
