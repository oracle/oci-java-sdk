...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = BasicImagePullSecret.Builder.class
)
...
public final class BasicImagePullSecret extends ImagePullSecret {
    ...
    public static class Builder {
        ...
        public BasicImagePullSecret build() {
            BasicImagePullSecret model = new BasicImagePullSecret(this.registryEndpoint);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BasicImagePullSecret model) {
    ...
    @Deprecated
    public BasicImagePullSecret(String registryEndpoint) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BasicImagePullSecret(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BasicImagePullSecret)) {
            return false;
        }

        BasicImagePullSecret other = (BasicImagePullSecret) o;
