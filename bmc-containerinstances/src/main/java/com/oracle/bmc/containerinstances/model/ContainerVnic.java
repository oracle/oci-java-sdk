...
public final class ContainerVnic extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public ContainerVnic build() {
            ContainerVnic model = new ContainerVnic(this.vnicId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ContainerVnic model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContainerVnic)) {
            return false;
        }

        ContainerVnic other = (ContainerVnic) o;
        return java.util.Objects.equals(this.vnicId, other.vnicId) && super.equals(other);
    }
