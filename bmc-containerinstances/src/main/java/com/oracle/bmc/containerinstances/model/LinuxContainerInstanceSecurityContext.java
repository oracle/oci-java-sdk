...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LinuxContainerInstanceSecurityContext.Builder.class)
...
public final class LinuxContainerInstanceSecurityContext extends ContainerInstanceSecurityContext {
    ...
    public static class Builder {
        ...
        public LinuxContainerInstanceSecurityContext build() {
            LinuxContainerInstanceSecurityContext model =
                    new LinuxContainerInstanceSecurityContext(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LinuxContainerInstanceSecurityContext model) {
    ...
    @Deprecated
    public LinuxContainerInstanceSecurityContext(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LinuxContainerInstanceSecurityContext(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LinuxContainerInstanceSecurityContext)) {
            return false;
        }

        LinuxContainerInstanceSecurityContext other = (LinuxContainerInstanceSecurityContext) o;
