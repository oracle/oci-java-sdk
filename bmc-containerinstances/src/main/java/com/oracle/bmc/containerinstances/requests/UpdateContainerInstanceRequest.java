...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerinstances/UpdateContainerInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateContainerInstanceRequest.
 */
...
public class UpdateContainerInstanceRequest
    ...
    public static class Builder
        ...
        public UpdateContainerInstanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateContainerInstanceRequest(containerInstanceId, updateContainerInstanceDetails, ifMatch, opcRequestId);
        }
    }
