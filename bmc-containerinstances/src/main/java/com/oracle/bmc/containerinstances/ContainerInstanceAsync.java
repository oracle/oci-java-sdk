...
public interface ContainerInstanceAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateContainerInstanceResponse> createContainerInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteContainerInstanceResponse> deleteContainerInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetContainerResponse> getContainer(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetContainerInstanceResponse> getContainerInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListContainerInstanceShapesResponse> listContainerInstanceShapes(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListContainerInstancesResponse> listContainerInstances(
    ...
    /**
     * Restarts a container instance. When provided, If-Match is checked against ETag values of the
     * container instance.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RestartContainerInstanceResponse> restartContainerInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RetrieveLogsResponse> retrieveLogs(
            RetrieveLogsRequest request,
            com.oracle.bmc.responses.AsyncHandler<RetrieveLogsRequest, RetrieveLogsResponse>
                    handler);

    /**
     * Starts a container instance if it is \"inactive\". No effect otherwise. When provided,
     * If-Match is checked against ETag values of the container instance.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<StartContainerInstanceResponse> startContainerInstance(
    ...
    /**
     * Stops a container instance if it is \"active\". No effect otherwise. When provided, If-Match
     * is checked against ETag values of the container instance.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<StopContainerInstanceResponse> stopContainerInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateContainerResponse> updateContainer(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateContainerInstanceResponse> updateContainerInstance(
