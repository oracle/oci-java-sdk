 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListLongTermBackupsRequest.
 */
...
public class ListLongTermBackupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The long-term backup OCID. Use longTermBackupId to filter a long-term backup based on its
     * unique identifier.
     */
    private String id;
    ...
    /**
     * The protected database OCID. Use protectedDatabaseId to list the long-term backups of a
     * specific protected database.
     */
    ...
    public static class Builder
        ...
        public ListLongTermBackupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListLongTermBackupsRequest(compartmentId, id, displayName, protectedDatabaseId,
