...
public class GetRecoveryServiceSubnetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetRecoveryServiceSubnetConverter.class);

    public static com.oracle.bmc.recovery.requests.GetRecoveryServiceSubnetRequest interceptRequest(
            com.oracle.bmc.recovery.requests.GetRecoveryServiceSubnetRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.recovery.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.recovery.responses.GetRecoveryServiceSubnetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.recovery.responses.GetRecoveryServiceSubnetResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.recovery.responses
                                                        .GetRecoveryServiceSubnetResponse.builder()
