...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/recovery/ChangeProtectedDatabaseCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeProtectedDatabaseCompartmentRequest.
 */
...
public class ChangeProtectedDatabaseCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeProtectedDatabaseCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeProtectedDatabaseCompartmentRequest(protectedDatabaseId, changeProtectedDatabaseCompartmentDetails, ifMatch, opcRequestId);
        }
    }
