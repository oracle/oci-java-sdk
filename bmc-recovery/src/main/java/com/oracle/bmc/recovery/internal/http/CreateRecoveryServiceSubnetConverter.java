...
public class CreateRecoveryServiceSubnetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateRecoveryServiceSubnetConverter.class);

    public static com.oracle.bmc.recovery.requests.CreateRecoveryServiceSubnetRequest
            interceptRequest(
                    com.oracle.bmc.recovery.requests.CreateRecoveryServiceSubnetRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.recovery.responses.CreateRecoveryServiceSubnetResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.recovery.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.recovery.responses.CreateRecoveryServiceSubnetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.http.internal.WithHeaders<
                                                com.oracle.bmc.recovery.model.RecoveryServiceSubnet>
                                        response = responseFn.apply(rawResponse);
                                javax.ws.rs.core.MultivaluedMap<String, String> headers =
                                        response.getHeaders();

                                com.oracle.bmc.recovery.responses
                                                .CreateRecoveryServiceSubnetResponse.Builder
                                        builder =
                                                com.oracle.bmc.recovery.responses
                                                        .CreateRecoveryServiceSubnetResponse
                                                        .builder()
                                ...
                                builder.recoveryServiceSubnet(response.getItem());
