 ...
 * to any list operations of DatabaseRecovery where multiple pages of data may be fetched. Two
...
public class DatabaseRecoveryPaginators {
     ...
     * listLongTermBackups operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.recovery.model.LongTermBackupSummary} objects contained in responses from the
     * listLongTermBackups operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.LongTermBackupSummary} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.recovery.model.LongTermBackupSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListLongTermBackupsRequest,
                ListLongTermBackupsResponse,
                com.oracle.bmc.recovery.model.LongTermBackupSummary>(
                new java.util.function.Supplier<ListLongTermBackupsRequest.Builder>() {
                    @Override
                    public ListLongTermBackupsRequest.Builder get() {
                        return ListLongTermBackupsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listProtectedDatabases operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.ProtectedDatabaseSummary} objects contained in responses from
     * the listProtectedDatabases operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.ProtectedDatabaseSummary} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listProtectionPolicies operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.ProtectionPolicySummary} objects contained in responses from
     * the listProtectionPolicies operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.ProtectionPolicySummary} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRecoveryServiceSubnets operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.RecoveryServiceSubnetSummary} objects contained in responses
     * from the listRecoveryServiceSubnets operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.RecoveryServiceSubnetSummary} objects contained in
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.WorkRequestError} objects contained in responses from the
     * listWorkRequestErrors operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.WorkRequestError} objects contained in responses received
     *     from the service.
     */
    public Iterable<com.oracle.bmc.recovery.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse,
                com.oracle.bmc.recovery.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.WorkRequestLogEntry} objects contained in responses from the
     * listWorkRequestLogs operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.WorkRequestLogEntry} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.recovery.model.WorkRequestSummary} objects contained in responses from the
     * listWorkRequests operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.recovery.model.WorkRequestSummary} objects contained in responses received
     *     from the service.
     */
