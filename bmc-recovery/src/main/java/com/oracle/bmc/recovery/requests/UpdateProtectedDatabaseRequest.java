...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/recovery/UpdateProtectedDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateProtectedDatabaseRequest.
 */
...
public class UpdateProtectedDatabaseRequest
    ...
    public static class Builder
        ...
        public UpdateProtectedDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateProtectedDatabaseRequest(protectedDatabaseId, updateProtectedDatabaseDetails, ifMatch, opcRequestId);
        }
    }
