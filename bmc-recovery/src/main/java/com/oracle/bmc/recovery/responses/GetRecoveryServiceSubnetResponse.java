...
public class GetRecoveryServiceSubnetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetRecoveryServiceSubnetResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetRecoveryServiceSubnetResponse o) {
         ...
         */
        @Override
        public GetRecoveryServiceSubnetResponse build() {
            return new GetRecoveryServiceSubnetResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, recoveryServiceSubnet);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRecoveryServiceSubnetResponse)) {
            return false;
        }

        GetRecoveryServiceSubnetResponse other = (GetRecoveryServiceSubnetResponse) o;
