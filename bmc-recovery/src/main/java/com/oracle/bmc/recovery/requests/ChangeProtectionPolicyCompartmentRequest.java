...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/recovery/ChangeProtectionPolicyCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeProtectionPolicyCompartmentRequest.
 */
...
public class ChangeProtectionPolicyCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeProtectionPolicyCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeProtectionPolicyCompartmentRequest(protectionPolicyId, changeProtectionPolicyCompartmentDetails, ifMatch, opcRequestId);
        }
    }
