...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateLongTermBackupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateLongTermBackupDetails
    ...
    public UpdateLongTermBackupDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateLongTermBackupDetails build() {
            UpdateLongTermBackupDetails model =
                    new UpdateLongTermBackupDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateLongTermBackupDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateLongTermBackupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLongTermBackupDetails)) {
            return false;
        }

        UpdateLongTermBackupDetails other = (UpdateLongTermBackupDetails) o;
