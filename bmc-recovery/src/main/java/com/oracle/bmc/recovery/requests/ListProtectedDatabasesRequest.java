...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/recovery/ListProtectedDatabasesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListProtectedDatabasesRequest.
 */
...
public class ListProtectedDatabasesRequest
    ...
    public static class Builder
        ...
        public ListProtectedDatabasesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListProtectedDatabasesRequest(compartmentId, lifecycleState, displayName, id, protectionPolicyId, recoveryServiceSubnetId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
