...
public final class WorkRequestSummary
    ...
    public static class Builder {
        ...
        /**
         * The date and time the request was accepted, as described in [RFC
         * 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The precision for this time
        ...
        /**
         * The date and time the work request transitioned from ACCEPTED to IN_PROGRESS, as
         * described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The precision
         * for this time object is in milliseconds.
         */
         ...
         * as described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The
         * precision for this time object is in milliseconds.
         */
    ...
    /**
     * The date and time the request was accepted, as described in [RFC
     * 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The precision for this time object
     * is in milliseconds.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeAccepted")
    ...
    /**
     * The date and time the work request transitioned from ACCEPTED to IN_PROGRESS, as described in
     * [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The precision for this time
     * object is in milliseconds.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeStarted")
     ...
     * described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29. The precision for
     * this time object is in milliseconds.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeFinished")
