...
/**
 * The common work item details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BasicWorkItemDetails.Builder.class)
...
public final class BasicWorkItemDetails extends WorkItemDetails {
    ...
    public static class Builder {
        ...
        public BasicWorkItemDetails build() {
            BasicWorkItemDetails model = new BasicWorkItemDetails(this.workItemType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BasicWorkItemDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BasicWorkItemDetails)) {
            return false;
        }

        BasicWorkItemDetails other = (BasicWorkItemDetails) o;
