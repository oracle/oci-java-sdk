...
public interface JmsUtilsAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteJavaMigrationAnalysisResponse> deleteJavaMigrationAnalysis(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetJavaMigrationAnalysisResponse> getJavaMigrationAnalysis(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetPerformanceTuningAnalysisResponse> getPerformanceTuningAnalysis(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetSubscriptionAcknowledgmentConfigurationResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListJavaMigrationAnalysisResponse> listJavaMigrationAnalysis(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RequestJavaMigrationAnalysisResponse> requestJavaMigrationAnalysis(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateSubscriptionAcknowledgmentConfigurationResponse>
