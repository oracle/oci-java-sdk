 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDynamicGroupsRequest.
 */
...
public class ListDynamicGroupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDynamicGroupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDynamicGroupsRequest(compartmentId, page, limit, name, sortBy, sortOrder,
            // lifecycleState);
        }
    }
