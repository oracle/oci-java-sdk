...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/GetTagDefaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTagDefaultRequest.
 */
...
public class GetTagDefaultRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(GetTagDefaultRequest o) {
         ...
         */
        public GetTagDefaultRequest build() {
            GetTagDefaultRequest request = buildWithoutInvocationCallback();
