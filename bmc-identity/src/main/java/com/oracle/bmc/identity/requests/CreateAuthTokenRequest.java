...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/CreateAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAuthTokenRequest.
 */
...
public class CreateAuthTokenRequest
    ...
    public static class Builder
        ...
        public Builder createAuthTokenDetails(
                com.oracle.bmc.identity.model.CreateAuthTokenDetails createAuthTokenDetails) {
        ...
        public CreateAuthTokenRequest buildWithoutInvocationCallback() {
            ...
            request.createAuthTokenDetails = createAuthTokenDetails;
            request.userId = userId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateAuthTokenRequest(createAuthTokenDetails, userId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createAuthTokenDetails=").append(String.valueOf(this.createAuthTokenDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createAuthTokenDetails, other.createAuthTokenDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createAuthTokenDetails == null
                                ? 43
                                : this.createAuthTokenDetails.hashCode());
