...
public class UpdateCustomerSecretKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code CustomerSecretKeySummary} instance. */
    ...
    public String toString() {
        ...
        sb.append(",customerSecretKeySummary=").append(String.valueOf(customerSecretKeySummary));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCustomerSecretKeyResponse)) {
            return false;
        }

        UpdateCustomerSecretKeyResponse other = (UpdateCustomerSecretKeyResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.customerSecretKeySummary, other.customerSecretKeySummary);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.customerSecretKeySummary == null
                                ? 43
                                : this.customerSecretKeySummary.hashCode());
        return result;
    }
}
