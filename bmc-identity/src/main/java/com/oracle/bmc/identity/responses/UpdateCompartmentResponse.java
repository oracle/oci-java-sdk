...
public class UpdateCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateCompartmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCompartmentResponse)) {
            return false;
        }

        UpdateCompartmentResponse other = (UpdateCompartmentResponse) o;
