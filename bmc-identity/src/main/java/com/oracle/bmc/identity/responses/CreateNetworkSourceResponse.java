...
public class CreateNetworkSourceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNetworkSourceResponse)) {
            return false;
        }

        CreateNetworkSourceResponse other = (CreateNetworkSourceResponse) o;
