...
public class CreateIdpGroupMappingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateIdpGroupMappingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateIdpGroupMappingResponse> {
         ...
         */
        @Override
        public Builder copy(CreateIdpGroupMappingResponse o) {
        ...
        public CreateIdpGroupMappingResponse build() {
            return new CreateIdpGroupMappingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIdpGroupMappingResponse)) {
            return false;
        }

        CreateIdpGroupMappingResponse other = (CreateIdpGroupMappingResponse) o;
