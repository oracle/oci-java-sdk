...
public class UpdatePolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdatePolicyResponse> {
         ...
         */
        @Override
        public Builder copy(UpdatePolicyResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePolicyResponse)) {
            return false;
        }
