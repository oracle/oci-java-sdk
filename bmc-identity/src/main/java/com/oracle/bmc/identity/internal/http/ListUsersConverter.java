...
public class ListUsersConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, ListUsersRequest request) {
        if (request == null) {
    ...
    public static Function<Response, ListUsersResponse> fromResponse() {
        final Function<Response, ListUsersResponse> transformer =
                new Function<Response, ListUsersResponse>() {
                    @Override
                    public ListUsersResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for ListUsersResponse");
                        Function<Response, WithHeaders<List<User>>> responseFn =
                                RESPONSE_CONVERSION_FACTORY.create(
                                        new GenericType<List<User>>() {});

                        WithHeaders<List<User>> response = responseFn.apply(rawResponse);
