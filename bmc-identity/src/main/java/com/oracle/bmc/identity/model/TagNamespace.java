...
/**
 * A managed container for defined tags. A tag namespace is unique in a tenancy. For more
 * information, see [Managing Tags and Tag
 * Namespaces](https://docs.cloud.oracle.com/Content/Tagging/Tasks/managingtagsandtagnamespaces.htm).
 *
...
public final class TagNamespace extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The tagnamespace's current state. After creating a tagnamespace, make sure its {@code
         * lifecycleState} is ACTIVE before using it. After retiring a tagnamespace, make sure its
         * {@code lifecycleState} is INACTIVE before using it.
         */
        ...
        /**
         * Date and time the tagNamespace was created, in the format defined by RFC3339. Example:
    ...
    /**
     * Date and time the tagNamespace was created, in the format defined by RFC3339. Example: {@code
