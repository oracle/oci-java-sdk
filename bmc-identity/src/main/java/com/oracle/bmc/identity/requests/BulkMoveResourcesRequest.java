...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/BulkMoveResourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BulkMoveResourcesRequest.
 */
...
public class BulkMoveResourcesRequest
     ...
     * Request object for bulk move resources in the compartment.
     */
    public com.oracle.bmc.identity.model.BulkMoveResourcesDetails getBulkMoveResourcesDetails() {
    ...
    public static class Builder
        ...
        /**
         * Request object for bulk move resources in the compartment.
         * @param bulkMoveResourcesDetails the value to set
         * @return this builder instance
         */
        public Builder bulkMoveResourcesDetails(
                com.oracle.bmc.identity.model.BulkMoveResourcesDetails bulkMoveResourcesDetails) {
        ...
        public BulkMoveResourcesRequest buildWithoutInvocationCallback() {
            ...
            request.bulkMoveResourcesDetails = bulkMoveResourcesDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new BulkMoveResourcesRequest(compartmentId, bulkMoveResourcesDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",bulkMoveResourcesDetails=")
                .append(String.valueOf(this.bulkMoveResourcesDetails));
    ...
    public boolean equals(Object o) {
        ...
        BulkMoveResourcesRequest other = (BulkMoveResourcesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.compartmentId, other.compartmentId)
                && java.util.Objects.equals(
                        this.bulkMoveResourcesDetails, other.bulkMoveResourcesDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.bulkMoveResourcesDetails == null
                                ? 43
                                : this.bulkMoveResourcesDetails.hashCode());
