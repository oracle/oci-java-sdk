...
public final class ImportStandardTagsDetails {
    ...
    public static class Builder {
        ...
        public ImportStandardTagsDetails build() {
            ImportStandardTagsDetails __instance__ =
                    new ImportStandardTagsDetails(compartmentId, standardTagNamespaceName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportStandardTagsDetails o) {
