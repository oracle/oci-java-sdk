...
/**
 * As the name suggests, an {@code SmtpCredentialSummary} object contains information about an
 * {@code SmtpCredential}. The SMTP credential is used for SMTP authentication with the [Email
 * Delivery Service](https://docs.cloud.oracle.com/Content/Email/Concepts/overview.htm). <br>
