...
public class DeactivateDomainResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeactivateDomainResponse> {
        ...
        public DeactivateDomainResponse build() {
            return new DeactivateDomainResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeactivateDomainResponse)) {
            return false;
        }

        DeactivateDomainResponse other = (DeactivateDomainResponse) o;
