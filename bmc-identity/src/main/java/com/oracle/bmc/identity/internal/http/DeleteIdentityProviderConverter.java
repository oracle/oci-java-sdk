...
public class DeleteIdentityProviderConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, DeleteIdentityProviderRequest request) {
        if (request == null) {
    ...
    public static Function<Response, DeleteIdentityProviderResponse> fromResponse() {
        final Function<Response, DeleteIdentityProviderResponse> transformer =
                new Function<Response, DeleteIdentityProviderResponse>() {
                    @Override
                    public DeleteIdentityProviderResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for DeleteIdentityProviderResponse");
