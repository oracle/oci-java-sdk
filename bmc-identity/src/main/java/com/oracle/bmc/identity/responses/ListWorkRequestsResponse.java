...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.identity.model.WorkRequestSummary} instances. */
    private java.util.List<com.oracle.bmc.identity.model.WorkRequestSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.identity.model.WorkRequestSummary> getItems() {
        return items;
    }
    ...
    private ListWorkRequestsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.identity.model.WorkRequestSummary> items) {
