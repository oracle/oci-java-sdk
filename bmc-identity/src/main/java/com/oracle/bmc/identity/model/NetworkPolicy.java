...
public class NetworkPolicy {
    ...
    public static class Builder {
        ...
        public NetworkPolicy build() {
            NetworkPolicy __instance__ = new NetworkPolicy(networkSourceIds);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkPolicy o) {
            Builder copiedBuilder = networkSourceIds(o.getNetworkSourceIds());
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("networkSourceIds")
    java.util.List<String> networkSourceIds;
