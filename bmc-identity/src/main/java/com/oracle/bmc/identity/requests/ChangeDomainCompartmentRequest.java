...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/ChangeDomainCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDomainCompartmentRequest.
 */
...
public class ChangeDomainCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeDomainCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeDomainCompartmentRequest(domainId, changeDomainCompartmentDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
