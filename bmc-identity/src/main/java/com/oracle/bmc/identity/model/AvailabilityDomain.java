 ...
 * instances, volumes, and subnets. A region contains several Availability Domains. For more
 * information, see [Regions and Availability
 * Domains](https://docs.cloud.oracle.com/Content/General/Concepts/regions.htm). <br>
...
public final class AvailabilityDomain
    ...
    public static class Builder {
        ...
        public AvailabilityDomain build() {
            AvailabilityDomain model =
                    new AvailabilityDomain(this.name, this.id, this.compartmentId);
