...
public class ActivateMfaTotpDeviceResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.identity.model.MfaTotpDeviceSummary getMfaTotpDeviceSummary() {
        return mfaTotpDeviceSummary;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ActivateMfaTotpDeviceResponse> {
         ...
         * @return this builder
         */
        public Builder mfaTotpDeviceSummary(
                com.oracle.bmc.identity.model.MfaTotpDeviceSummary mfaTotpDeviceSummary) {
            this.mfaTotpDeviceSummary = mfaTotpDeviceSummary;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",mfaTotpDeviceSummary=").append(String.valueOf(mfaTotpDeviceSummary));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateMfaTotpDeviceResponse)) {
            return false;
        }

        ActivateMfaTotpDeviceResponse other = (ActivateMfaTotpDeviceResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.mfaTotpDeviceSummary, other.mfaTotpDeviceSummary);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.mfaTotpDeviceSummary == null
                                ? 43
                                : this.mfaTotpDeviceSummary.hashCode());
        return result;
    }
}
