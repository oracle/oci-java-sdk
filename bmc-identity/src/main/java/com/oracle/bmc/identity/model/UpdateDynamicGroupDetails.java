...
/**
 * Properties for updating a dynamic group. <br>
...
public final class UpdateDynamicGroupDetails
    ...
    public UpdateDynamicGroupDetails(
            String description,
            String matchingRule,
    ...
    public static class Builder {
        /**
         * The description you assign to the dynamic group. Does not have to be unique, and it's
         * changeable.
         *
        ...
        /**
         * The matching rule to dynamically match an instance certificate to this dynamic group. For
         * rule syntax, see [Managing Dynamic
         * Groups](https://docs.cloud.oracle.com/Content/Identity/dynamicgroups/managingdynamicgroups.htm).
         */
        ...
        public UpdateDynamicGroupDetails build() {
            UpdateDynamicGroupDetails model =
                    new UpdateDynamicGroupDetails(
                            this.description,
                            this.matchingRule,
                            this.freeformTags,
                            this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDynamicGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDynamicGroupDetails)) {
            return false;
        }

        UpdateDynamicGroupDetails other = (UpdateDynamicGroupDetails) o;
