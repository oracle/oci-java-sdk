...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/CreateGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateGroupRequest.
 */
...
public class CreateGroupRequest
    ...
    public static class Builder
        ...
        public Builder createGroupDetails(
                com.oracle.bmc.identity.model.CreateGroupDetails createGroupDetails) {
        ...
        public CreateGroupRequest buildWithoutInvocationCallback() {
            ...
            request.createGroupDetails = createGroupDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateGroupRequest(createGroupDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createGroupDetails=").append(String.valueOf(this.createGroupDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                && java.util.Objects.equals(this.createGroupDetails, other.createGroupDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createGroupDetails == null
                                ? 43
                                : this.createGroupDetails.hashCode());
        result =
                (result * PRIME)
