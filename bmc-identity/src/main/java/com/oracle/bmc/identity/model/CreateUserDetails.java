...
public final class CreateUserDetails
    ...
    public static class Builder {
        ...
        /**
         * The description you assign to the user during creation. Does not have to be unique, and
         * it's changeable.
         *
    ...
    /**
     * The description you assign to the user during creation. Does not have to be unique, and it's
     * changeable.
     *
     * <p>(For tenancies that support identity domains) You can have an empty description.
     */
