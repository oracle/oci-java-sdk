...
/**
 * A localized geographic area, such as Phoenix, AZ. Oracle Cloud Infrastructure is hosted in
 * regions and Availability Domains. A region is composed of several Availability Domains. An
 * Availability Domain is one or more data centers located within a region. For more information,
...
public final class Region extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        /**
         * The key of the region. See [Regions and Availability
        ...
        /**
         * The name of the region. See [Regions and Availability
         * Domains](https://docs.cloud.oracle.com/Content/General/Concepts/regions.htm) for the full
