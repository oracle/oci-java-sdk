...
/**
 * (For tenancies that support identity domains) An IAM work request object that allows users to
 * track the status of asynchronous API requests. <br>
...
public final class IamWorkRequest
