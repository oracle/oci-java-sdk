...
public class ListTaggingWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.identity.model.TaggingWorkRequestLogSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTaggingWorkRequestLogsResponse)) {
            return false;
        }

        ListTaggingWorkRequestLogsResponse other = (ListTaggingWorkRequestLogsResponse) o;
