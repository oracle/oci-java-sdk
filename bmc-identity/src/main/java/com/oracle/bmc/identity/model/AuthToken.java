...
/**
 * An {@code AuthToken} is an Oracle-generated token string that you can use to authenticate with
 * third-party APIs that do not support Oracle Cloud Infrastructure's signature-based
 * authentication. For example, use an {@code AuthToken} to authenticate with a Swift client with
 * the Object Storage Service.
 *
 * <p>The auth token is associated with the user's Console login. Auth tokens never expire. A user
 * can have up to two auth tokens at a time.
 *
 * <p>*Note:** The token is always an Oracle-generated string; you can't change it to a string of
 * your choice.
 *
...
public final class AuthToken extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        /**
         * The auth token. The value is available only in the response for {@code CreateAuthToken},
         * and not for {@code ListAuthTokens} or {@code UpdateAuthToken}.
         */
        ...
        /**
         * The description you assign to the auth token. Does not have to be unique, and it's
         * changeable.
         *
        ...
        /**
         * Date and time when this auth token will expire, in the format defined by RFC3339. Null if
         * it never expires.
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        /**
         * The token's current state. After creating an auth token, make sure its {@code
    ...
    /**
     * The auth token. The value is available only in the response for {@code CreateAuthToken}, and
     * not for {@code ListAuthTokens} or {@code UpdateAuthToken}.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("token")
    ...
    /**
     * Date and time when this auth token will expire, in the format defined by RFC3339. Null if it
     * never expires.
     *
     * <p>Example: {@code 2016-08-25T21:10:29.600Z}
     */
    ...
    /**
     * The token's current state. After creating an auth token, make sure its {@code lifecycleState}
