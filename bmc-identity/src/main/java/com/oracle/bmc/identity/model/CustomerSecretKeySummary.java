...
/**
 * As the name suggests, a {@code CustomerSecretKeySummary} object contains information about a
 * {@code CustomerSecretKey}. A {@code CustomerSecretKey} is an Oracle-provided key for using the
 * Object Storage Service's Amazon S3 compatible API. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CustomerSecretKeySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CustomerSecretKeySummary
    ...
    public CustomerSecretKeySummary(
            String id,
            String userId,
            String displayName,
    ...
    public static class Builder {
        ...
        /**
         * The displayName you assign to the secret key. Does not have to be unique, and it's
         * changeable.
         */
        ...
        public CustomerSecretKeySummary build() {
            CustomerSecretKeySummary model =
                    new CustomerSecretKeySummary(
                            this.id,
                            this.userId,
                            this.displayName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomerSecretKeySummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CustomerSecretKeySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomerSecretKeySummary)) {
            return false;
        }

        CustomerSecretKeySummary other = (CustomerSecretKeySummary) o;
