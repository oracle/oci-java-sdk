...
public class GetUserGroupMembershipResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserGroupMembershipResponse)) {
            return false;
        }

        GetUserGroupMembershipResponse other = (GetUserGroupMembershipResponse) o;
