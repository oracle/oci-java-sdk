...
public class CreateMfaTotpDeviceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateMfaTotpDeviceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMfaTotpDeviceResponse> {
        ...
        public CreateMfaTotpDeviceResponse build() {
            return new CreateMfaTotpDeviceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMfaTotpDeviceResponse)) {
            return false;
        }

        CreateMfaTotpDeviceResponse other = (CreateMfaTotpDeviceResponse) o;
