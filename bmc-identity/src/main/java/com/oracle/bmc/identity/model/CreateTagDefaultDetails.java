...
public final class CreateTagDefaultDetails
    ...
    public static class Builder {
        /**
         * The OCID of the compartment. The tag default will be applied to all new resources created
         * in this compartment.
         */
    ...
    /**
     * The OCID of the compartment. The tag default will be applied to all new resources created in
     * this compartment.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
