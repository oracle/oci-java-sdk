...
public class CreateTagResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTagResponse> {
        ...
        public CreateTagResponse build() {
            return new CreateTagResponse(__httpStatusCode__, headers, opcRequestId, etag, tag);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTagResponse)) {
            return false;
        }
