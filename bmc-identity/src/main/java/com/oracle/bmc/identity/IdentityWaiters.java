...
public class IdentityWaiters {
    ...
    public IdentityWaiters(java.util.concurrent.ExecutorService executorService, Identity client) {
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetDomainRequest, GetDomainResponse> forDomain(
            GetDomainRequest request,
            com.oracle.bmc.identity.model.Domain.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetDomainRequest, GetDomainResponse> forDomain(
            GetDomainRequest request,
            com.oracle.bmc.identity.model.Domain.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Domain.
    private com.oracle.bmc.waiter.Waiter<GetDomainRequest, GetDomainResponse> forDomain(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetDomainRequest request,
            final com.oracle.bmc.identity.model.Domain.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.identity.model.Domain.LifecycleState> targetStatesSet =
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetIamWorkRequestRequest, GetIamWorkRequestResponse>
            forIamWorkRequest(GetIamWorkRequestRequest request) {
        return forIamWorkRequest(com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetIamWorkRequestRequest, GetIamWorkRequestResponse>
            forIamWorkRequest(
                    ...
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        return forIamWorkRequest(
                com.oracle.bmc.waiter.Waiters.newWaiter(terminationStrategy, delayStrategy),
                request);
    }

    // Helper method to create a new Waiter for IamWorkRequest.
    private com.oracle.bmc.waiter.Waiter<GetIamWorkRequestRequest, GetIamWorkRequestResponse>
            forIamWorkRequest(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetIamWorkRequestRequest request) {
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                executorService,
                waiter.toCallable(
                        () -> request,
