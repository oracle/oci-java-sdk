...
public class GetCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public com.oracle.bmc.identity.model.Compartment getCompartment() {
        return compartment;
    }
    ...
    public static class Builder {
        ...
        public Builder compartment(com.oracle.bmc.identity.model.Compartment compartment) {
            this.compartment = compartment;
            return this;
        }
        ...
        public GetCompartmentResponse build() {
            return new GetCompartmentResponse(__httpStatusCode__, opcRequestId, etag, compartment);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",compartment=").append(String.valueOf(compartment));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCompartmentResponse)) {
            return false;
        }

        GetCompartmentResponse other = (GetCompartmentResponse) o;
