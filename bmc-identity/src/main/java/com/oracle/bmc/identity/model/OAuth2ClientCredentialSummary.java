...
/**
 * User can define Oauth clients in IAM, then use it to generate a token to grant access to app
 * resources. <br>
...
public final class OAuth2ClientCredentialSummary
    ...
    public static class Builder {
        ...
        /**
         * The credential's current state. After creating a Oauth credential, make sure its {@code
        ...
        /**
         * Date and time the {@code OAuth2ClientCredential} object was created, in the format
         * defined by RFC3339.
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
    ...
    /**
     * Date and time the {@code OAuth2ClientCredential} object was created, in the format defined by
     * RFC3339.
     *
     * <p>Example: {@code 2016-08-25T21:10:29.600Z}
     */
