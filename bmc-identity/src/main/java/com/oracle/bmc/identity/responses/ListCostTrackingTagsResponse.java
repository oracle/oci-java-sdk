...
public class ListCostTrackingTagsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.identity.model.Tag> items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCostTrackingTagsResponse)) {
            return false;
        }

        ListCostTrackingTagsResponse other = (ListCostTrackingTagsResponse) o;
