...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/DeleteSwiftPasswordExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSwiftPasswordRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteSwiftPasswordRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteSwiftPasswordRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteSwiftPasswordRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSwiftPasswordRequest
         */
        public DeleteSwiftPasswordRequest build() {
            DeleteSwiftPasswordRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteSwiftPasswordRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteSwiftPasswordRequest(userId, swiftPasswordId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().userId(userId).swiftPasswordId(swiftPasswordId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        DeleteSwiftPasswordRequest other = (DeleteSwiftPasswordRequest) o;
