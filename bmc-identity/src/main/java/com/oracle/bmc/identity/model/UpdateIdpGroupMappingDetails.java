...
public final class UpdateIdpGroupMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"idpGroupName", "groupId"})
    public UpdateIdpGroupMappingDetails(String idpGroupName, String groupId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateIdpGroupMappingDetails build() {
            UpdateIdpGroupMappingDetails model =
                    new UpdateIdpGroupMappingDetails(this.idpGroupName, this.groupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateIdpGroupMappingDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIdpGroupMappingDetails)) {
            return false;
        }

        UpdateIdpGroupMappingDetails other = (UpdateIdpGroupMappingDetails) o;
