...
/**
 * (For tenancies that support identity domains) Details for creating an identity domain. <br>
...
public final class CreateDomainDetails
    ...
    public static class Builder {
         ...
         * receive notifications like a welcome email. This field is required only if admin
         * information is provided. This field is otherwise optional.
         */
         ...
         * primary email address or not. The default is true.
         */
    ...
    /**
     * Indicates whether or not the administrator user created in the IDCS stripe would like to
     * receive notifications like a welcome email. This field is required only if admin information
     * is provided. This field is otherwise optional.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isNotificationBypassed")
