...
public class UpdateIdpGroupMappingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIdpGroupMappingResponse)) {
            return false;
        }

        UpdateIdpGroupMappingResponse other = (UpdateIdpGroupMappingResponse) o;
