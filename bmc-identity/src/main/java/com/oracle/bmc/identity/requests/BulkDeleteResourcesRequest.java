...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/BulkDeleteResourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BulkDeleteResourcesRequest.
 */
...
public class BulkDeleteResourcesRequest
    ...
    public static class Builder
        ...
        public BulkDeleteResourcesRequest buildWithoutInvocationCallback() {
            ...
            request.bulkDeleteResourcesDetails = bulkDeleteResourcesDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new BulkDeleteResourcesRequest(compartmentId, bulkDeleteResourcesDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",bulkDeleteResourcesDetails=")
                .append(String.valueOf(this.bulkDeleteResourcesDetails));
    ...
    public boolean equals(Object o) {
        ...
        BulkDeleteResourcesRequest other = (BulkDeleteResourcesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.compartmentId, other.compartmentId)
                && java.util.Objects.equals(
                        this.bulkDeleteResourcesDetails, other.bulkDeleteResourcesDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.bulkDeleteResourcesDetails == null
                                ? 43
                                : this.bulkDeleteResourcesDetails.hashCode());
