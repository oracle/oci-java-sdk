...
public class UpdateTagNamespaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTagNamespaceResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTagNamespaceResponse)) {
            return false;
        }

        UpdateTagNamespaceResponse other = (UpdateTagNamespaceResponse) o;
