...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identity/MoveCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use MoveCompartmentRequest.
 */
...
public class MoveCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Request object for moving a compartment.
         * @param moveCompartmentDetails the value to set
         * @return this builder instance
         */
        ...
        public Builder copy(MoveCompartmentRequest o) {
            ...
            moveCompartmentDetails(o.getMoveCompartmentDetails());
        ...
        public MoveCompartmentRequest build() {
            MoveCompartmentRequest request = buildWithoutInvocationCallback();
