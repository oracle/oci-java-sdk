...
public class UpdatePolicyConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, UpdatePolicyRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdatePolicyResponse> fromResponse() {
        final Function<Response, UpdatePolicyResponse> transformer =
                new Function<Response, UpdatePolicyResponse>() {
                    @Override
                    public UpdatePolicyResponse apply(Response rawResponse) {
                        ...
                        UpdatePolicyResponse.Builder builder = UpdatePolicyResponse.builder();
