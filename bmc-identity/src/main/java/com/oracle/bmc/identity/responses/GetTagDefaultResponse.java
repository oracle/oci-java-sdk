...
public class GetTagDefaultResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTagDefaultResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTagDefaultResponse)) {
            return false;
        }

        GetTagDefaultResponse other = (GetTagDefaultResponse) o;
