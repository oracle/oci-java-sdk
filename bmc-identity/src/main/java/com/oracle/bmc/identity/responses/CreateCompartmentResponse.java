...
public class CreateCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateCompartmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCompartmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCompartmentResponse)) {
            return false;
        }

        CreateCompartmentResponse other = (CreateCompartmentResponse) o;
