...
public class UpdateUserStateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateUserStateResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateUserStateResponse)) {
            return false;
        }

        UpdateUserStateResponse other = (UpdateUserStateResponse) o;
