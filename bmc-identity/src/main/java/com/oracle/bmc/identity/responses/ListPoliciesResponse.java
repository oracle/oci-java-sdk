...
public class ListPoliciesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public java.util.List<com.oracle.bmc.identity.model.Policy> getItems() {
        return items;
    }
    ...
    private ListPoliciesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.identity.model.Policy> items) {
    ...
    public static class Builder {
        ...
        public Builder items(java.util.List<com.oracle.bmc.identity.model.Policy> items) {
            this.items = items;
            return this;
        }
        ...
        public ListPoliciesResponse build() {
            return new ListPoliciesResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
