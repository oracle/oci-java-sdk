...
public class UpdateTagResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTagResponse> {
        ...
        public UpdateTagResponse build() {
            return new UpdateTagResponse(__httpStatusCode__, headers, opcRequestId, etag, tag);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTagResponse)) {
            return false;
        }
