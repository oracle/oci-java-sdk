...
public class UpdateAuthenticationPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code AuthenticationPolicy} instance. */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAuthenticationPolicyResponse)) {
            return false;
        }

        UpdateAuthenticationPolicyResponse other = (UpdateAuthenticationPolicyResponse) o;
