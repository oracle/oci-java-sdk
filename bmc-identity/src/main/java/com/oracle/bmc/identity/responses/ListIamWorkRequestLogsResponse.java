...
public class ListIamWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListIamWorkRequestLogsResponse(
            ...
            Float retryAfter,
            String opcNextPage,
            java.util.List<com.oracle.bmc.identity.model.IamWorkRequestLogSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIamWorkRequestLogsResponse)) {
            return false;
        }

        ListIamWorkRequestLogsResponse other = (ListIamWorkRequestLogsResponse) o;
