...
public class CreateDbCredentialDetails {
    ...
    public static class Builder {
        ...
        public CreateDbCredentialDetails build() {
            CreateDbCredentialDetails __instance__ =
                    new CreateDbCredentialDetails(password, description);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDbCredentialDetails o) {
            Builder copiedBuilder = password(o.getPassword()).description(o.getDescription());
