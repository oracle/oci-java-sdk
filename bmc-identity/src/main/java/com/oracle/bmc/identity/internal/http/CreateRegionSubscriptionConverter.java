...
public class CreateRegionSubscriptionConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, CreateRegionSubscriptionRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateRegionSubscriptionResponse> fromResponse() {
        final Function<Response, CreateRegionSubscriptionResponse> transformer =
                new Function<Response, CreateRegionSubscriptionResponse>() {
                    @Override
                    public CreateRegionSubscriptionResponse apply(Response rawResponse) {
                        ...
                        Function<Response, WithHeaders<RegionSubscription>> responseFn =
                                RESPONSE_CONVERSION_FACTORY.create(RegionSubscription.class);

                        WithHeaders<RegionSubscription> response = responseFn.apply(rawResponse);
