...
public class GetUserUIPasswordInformationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder uIPasswordInformation(
                com.oracle.bmc.identity.model.UIPasswordInformation uIPasswordInformation) {
            this.uIPasswordInformation = uIPasswordInformation;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",uIPasswordInformation=").append(String.valueOf(uIPasswordInformation));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserUIPasswordInformationResponse)) {
            return false;
        }

        GetUserUIPasswordInformationResponse other = (GetUserUIPasswordInformationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.uIPasswordInformation, other.uIPasswordInformation);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.uIPasswordInformation == null
                                ? 43
                                : this.uIPasswordInformation.hashCode());
        return result;
    }
}
