...
/**
 * The guardaril version applied on the given content. <br>
...
public final class GuardrailVersionResponse
    ...
    public static class Builder {
        /**
         * The guardrail system version string, e.g., "1.0.0". When a PATCH version is not
         * specified, the latest available PATCH within the specified MAJOR and MINOR version will
         * be used.
         */
    ...
    /**
     * The guardrail system version string, e.g., "1.0.0". When a PATCH version is not specified,
     * the latest available PATCH within the specified MAJOR and MINOR version will be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("version")
