...
/**
 * The base64 encoded video data or a video uri if it's supported. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VideoUrl.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VideoUrl extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"url", "detail"})
    public VideoUrl(String url, Detail detail) {
        super();
        this.url = url;
        this.detail = detail;
    }
    ...
    public static class Builder {
         ...
         *
         * <p>Example for an mp4 video: {@code { "type": "VIDEO", "videoUrl": { "url":
         * "data:video/mp4;base64,<base64 encoded video content>" } }}
         *
         * <p>Example with a video uri: {@code { "type": "VIDEO", "videoUrl": { "url":
         * "data:video/mp4;uri,<video uri>" } }}
         */
         ...
         * the base64 encoded video to tokens.
         */
        ...
        public VideoUrl build() {
            VideoUrl model = new VideoUrl(this.url, this.detail);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VideoUrl model) {
     ...
     * base64 encoded video to tokens.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoUrl)) {
            return false;
        }

        VideoUrl other = (VideoUrl) o;
