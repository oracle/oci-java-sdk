...
/**
 * Represents a single instance of system message. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SystemMessage.Builder.class)
...
public final class SystemMessage extends Message {
    ...
    public static class Builder {
        ...
        public SystemMessage build() {
            SystemMessage model = new SystemMessage(this.content, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SystemMessage model) {
    ...
    @Deprecated
    public SystemMessage(java.util.List<ChatContent> content, String name) {
        super(content);
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        SystemMessage other = (SystemMessage) o;
