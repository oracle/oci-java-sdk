...
/**
 * Represents a single instance of user message. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserMessage.Builder.class)
...
public final class UserMessage extends Message {
    ...
    public static class Builder {
        ...
        public UserMessage build() {
            UserMessage model = new UserMessage(this.content, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserMessage model) {
    ...
    @Deprecated
    public UserMessage(java.util.List<ChatContent> content, String name) {
        super(content);
        this.name = name;
    }
