...
/**
 * Provide a base64 encoded audio or an audio uri if it's supported. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AudioUrl.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AudioUrl extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"url", "detail"})
    public AudioUrl(String url, Detail detail) {
        super();
        this.url = url;
        this.detail = detail;
    }
    ...
    public static class Builder {
         ...
         *
         * <p>Example for an mp3 audio: {@code { "type": "AUDIO", "audioUrl": { "url":
         * "data:audio/mp3;base64,<base64 encoded audio content>" } }}
         *
         * <p>Example with an audio uri: {@code { "type": "AUDIO", "audioUrl": { "url":
         * "data:audio/mp3;uri,<audio uri>" } }}
         */
         ...
         * the base64 encoded audio to tokens.
         */
        ...
        public AudioUrl build() {
            AudioUrl model = new AudioUrl(this.url, this.detail);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AudioUrl model) {
     ...
     * base64 encoded audio to tokens.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AudioUrl)) {
            return false;
        }

        AudioUrl other = (AudioUrl) o;
