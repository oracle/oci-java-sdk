 ...
 * to any list operations of GenerativeAiInference where multiple pages of data may be fetched. Two
...
public class GenerativeAiInferencePaginators {
     ...
     * listGuardrailVersions operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.generativeaiinference.model.GuardrailVersionSummary} objects contained in
     * responses from the listGuardrailVersions operation. This iterable will fetch more data from
