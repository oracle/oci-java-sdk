...
/**
 * The base64 encoded document data or a document uri if it's supported. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DocumentUrl.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DocumentUrl extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"url", "detail"})
    public DocumentUrl(String url, Detail detail) {
        super();
        this.url = url;
        this.detail = detail;
    }
    ...
    public static class Builder {
         ...
         *
         * <p>Example for a pdf document: {@code { "type": "DOCUMENT", "documentUrl": { "url":
         * "data:application/pdf;base64,<base64 encoded document content>" } }}
         *
         * <p>Example with a document uri: {@code { "type": "DOCUMENT", "videoUrl": { "url":
         * "data:application/pdf;uri,<document uri>" } }}
         */
         ...
         * the base64 encoded document to tokens.
         */
        ...
        public DocumentUrl build() {
            DocumentUrl model = new DocumentUrl(this.url, this.detail);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DocumentUrl model) {
     ...
     * base64 encoded document to tokens.
     */
    ...
    public boolean equals(Object o) {
        ...
        DocumentUrl other = (DocumentUrl) o;
