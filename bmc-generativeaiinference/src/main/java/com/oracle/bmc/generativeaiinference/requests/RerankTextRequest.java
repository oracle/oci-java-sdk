...
public class RerankTextRequest
    ...
    public com.oracle.bmc.generativeaiinference.model.RerankTextDetails getBody$() {
        return rerankTextDetails;
    }
    ...
    public static class Builder
         ...
         */
        public Builder rerankTextDetails(
                com.oracle.bmc.generativeaiinference.model.RerankTextDetails rerankTextDetails) {
            this.rerankTextDetails = rerankTextDetails;
            return this;
        }
        ...
        public Builder copy(RerankTextRequest o) {
            rerankTextDetails(o.getRerankTextDetails());
         ...
         */
        public RerankTextRequest build() {
            RerankTextRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.generativeaiinference.model.RerankTextDetails body) {
            rerankTextDetails(body);
            return this;
        }
         ...
         * @return instance of RerankTextRequest
         */
        public RerankTextRequest buildWithoutInvocationCallback() {
            RerankTextRequest request = new RerankTextRequest();
            request.rerankTextDetails = rerankTextDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RerankTextRequest(rerankTextDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",rerankTextDetails=").append(String.valueOf(this.rerankTextDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RerankTextRequest)) {
            return false;
        }

        RerankTextRequest other = (RerankTextRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.rerankTextDetails, other.rerankTextDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.rerankTextDetails == null ? 43 : this.rerankTextDetails.hashCode());
        result =
                (result * PRIME)
