...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ImageContent.Builder.class)
...
public final class ImageContent extends ChatContent {
    ...
    public static class Builder {
        ...
        public ImageContent build() {
            ImageContent model = new ImageContent(this.imageUrl);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImageContent model) {
