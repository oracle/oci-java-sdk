...
import com.oracle.bmc.generativeaiinference.internal.http.*;
...
public class GenerativeAiInferenceAsyncClient implements GenerativeAiInferenceAsync {
    /**
    ...
    public static class Builder
        ...
        public GenerativeAiInferenceAsyncClient build(
            ...
            return new GenerativeAiInferenceAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ApplyGuardrailsResponse> applyGuardrails(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async applyGuardrails");
        final ApplyGuardrailsRequest interceptedRequest =
                ApplyGuardrailsConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ApplyGuardrailsConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ApplyGuardrailsResponse>
                transformer =
                        ApplyGuardrailsConverter.fromResponse(
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ApplyGuardrailsRequest, ApplyGuardrailsResponse>,
                        java.util.concurrent.Future<ApplyGuardrailsResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getApplyGuardrailsDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<ChatResponse> chat(
        ...
        LOG.trace("Called async chat");
        final ChatRequest interceptedRequest = ChatConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChatConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "GenerativeAiInference",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ChatResponse> transformer =
                ChatConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ChatRequest, ChatResponse> handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<ChatRequest, ChatResponse>,
                        java.util.concurrent.Future<ChatResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getChatDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<EmbedTextResponse> embedText(
            ...
            final com.oracle.bmc.responses.AsyncHandler<EmbedTextRequest, EmbedTextResponse>
                    handler) {
        LOG.trace("Called async embedText");
        final EmbedTextRequest interceptedRequest = EmbedTextConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                EmbedTextConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "GenerativeAiInference",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, EmbedTextResponse>
                transformer =
                        EmbedTextConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<EmbedTextRequest, EmbedTextResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<EmbedTextRequest, EmbedTextResponse>,
                        java.util.concurrent.Future<EmbedTextResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getEmbedTextDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<GenerateTextResponse> generateText(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GenerateTextRequest, GenerateTextResponse>
                    handler) {
        LOG.trace("Called async generateText");
        final GenerateTextRequest interceptedRequest =
                GenerateTextConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GenerateTextConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "GenerativeAiInference",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GenerateTextResponse>
                transformer =
                        GenerateTextConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<GenerateTextResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getGenerateTextDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<RerankTextResponse> rerankText(
            ...
            final com.oracle.bmc.responses.AsyncHandler<RerankTextRequest, RerankTextResponse>
                    handler) {
        LOG.trace("Called async rerankText");
        final RerankTextRequest interceptedRequest = RerankTextConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                RerankTextConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "GenerativeAiInference",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, RerankTextResponse>
                transformer =
                        RerankTextConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<RerankTextRequest, RerankTextResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                RerankTextRequest, RerankTextResponse>,
                        java.util.concurrent.Future<RerankTextResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getRerankTextDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<SummarizeTextResponse> summarizeText(
            ...
            final com.oracle.bmc.responses.AsyncHandler<SummarizeTextRequest, SummarizeTextResponse>
                    handler) {
        LOG.trace("Called async summarizeText");
        final SummarizeTextRequest interceptedRequest =
                SummarizeTextConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                SummarizeTextConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "GenerativeAiInference",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, SummarizeTextResponse>
                transformer =
                        SummarizeTextConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<SummarizeTextResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getSummarizeTextDetails(),
                                ib,
                                transformer);
