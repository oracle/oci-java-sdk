...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/desktops/ListDesktopPoolDesktopsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDesktopPoolDesktopsRequest.
 */
...
public class ListDesktopPoolDesktopsRequest
    ...
    public static class Builder
        ...
        public ListDesktopPoolDesktopsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListDesktopPoolDesktopsRequest(compartmentId, desktopPoolId, availabilityDomain, displayName, id, lifecycleState, limit, sortBy, sortOrder, opcRequestId, page);
        }
    }
