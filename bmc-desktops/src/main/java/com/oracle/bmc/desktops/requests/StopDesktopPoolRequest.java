...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/desktops/StopDesktopPoolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StopDesktopPoolRequest.
 */
...
public class StopDesktopPoolRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public StopDesktopPoolRequest build() {
            StopDesktopPoolRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StopDesktopPoolRequest
         */
        public StopDesktopPoolRequest buildWithoutInvocationCallback() {
            StopDesktopPoolRequest request = new StopDesktopPoolRequest();
            request.desktopPoolId = desktopPoolId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new StopDesktopPoolRequest(desktopPoolId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDesktopPoolRequest)) {
            return false;
        }

        StopDesktopPoolRequest other = (StopDesktopPoolRequest) o;
