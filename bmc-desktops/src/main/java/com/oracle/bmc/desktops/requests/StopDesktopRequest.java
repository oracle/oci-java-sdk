...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/desktops/StopDesktopExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StopDesktopRequest.
 */
...
public class StopDesktopRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public StopDesktopRequest build() {
            StopDesktopRequest request = buildWithoutInvocationCallback();
        ...
        public StopDesktopRequest buildWithoutInvocationCallback() {
            StopDesktopRequest request = new StopDesktopRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDesktopRequest)) {
            return false;
        }

        StopDesktopRequest other = (StopDesktopRequest) o;
