...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/desktops/GetDesktopExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDesktopRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220618")
public class GetDesktopRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDesktopRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetDesktopRequest
         */
        public GetDesktopRequest build() {
            GetDesktopRequest request = buildWithoutInvocationCallback();
        ...
        public GetDesktopRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDesktopRequest(desktopId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().desktopId(desktopId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetDesktopRequest other = (GetDesktopRequest) o;
