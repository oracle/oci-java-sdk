...
/**
 * Provides information about a desktop pool including all configuration parameters. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DesktopPool.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DesktopPool extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public enum UseDedicatedVmHost implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(UseDedicatedVmHost.class);
        ...
        public static UseDedicatedVmHost create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'UseDedicatedVmHost', returning UnknownEnumValue",
                    key);
    ...
    public boolean equals(Object o) {
        ...
        DesktopPool other = (DesktopPool) o;
