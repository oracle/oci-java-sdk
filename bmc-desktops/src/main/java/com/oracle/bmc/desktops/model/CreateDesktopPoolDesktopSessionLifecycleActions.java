...
/**
 * The details of action to be triggered in case of inactivity or disconnect <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDesktopPoolDesktopSessionLifecycleActions.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateDesktopPoolDesktopSessionLifecycleActions
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"inactivity", "disconnect"})
    public CreateDesktopPoolDesktopSessionLifecycleActions(
    ...
    public static class Builder {
        ...
        public CreateDesktopPoolDesktopSessionLifecycleActions build() {
            CreateDesktopPoolDesktopSessionLifecycleActions model =
                    new CreateDesktopPoolDesktopSessionLifecycleActions(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDesktopPoolDesktopSessionLifecycleActions model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDesktopPoolDesktopSessionLifecycleActions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDesktopPoolDesktopSessionLifecycleActions)) {
            return false;
        }

        CreateDesktopPoolDesktopSessionLifecycleActions other =
                (CreateDesktopPoolDesktopSessionLifecycleActions) o;
