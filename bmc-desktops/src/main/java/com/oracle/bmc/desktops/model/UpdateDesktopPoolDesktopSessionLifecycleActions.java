...
/**
 * The update details of action to be triggered in case of inactivity or disconnect <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDesktopPoolDesktopSessionLifecycleActions.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateDesktopPoolDesktopSessionLifecycleActions
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"inactivity", "disconnect"})
    public UpdateDesktopPoolDesktopSessionLifecycleActions(
    ...
    public static class Builder {
        ...
        public UpdateDesktopPoolDesktopSessionLifecycleActions build() {
            UpdateDesktopPoolDesktopSessionLifecycleActions model =
                    new UpdateDesktopPoolDesktopSessionLifecycleActions(
                            this.inactivity, this.disconnect);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDesktopPoolDesktopSessionLifecycleActions model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDesktopPoolDesktopSessionLifecycleActions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDesktopPoolDesktopSessionLifecycleActions)) {
            return false;
        }

        UpdateDesktopPoolDesktopSessionLifecycleActions other =
                (UpdateDesktopPoolDesktopSessionLifecycleActions) o;
