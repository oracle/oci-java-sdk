...
public class ListingSubscriptionsDeprecatedResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListingSubscriptionsDeprecatedResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListingSubscriptionsDeprecatedResponse o) {
         ...
         */
        @Override
        public ListingSubscriptionsDeprecatedResponse build() {
            return new ListingSubscriptionsDeprecatedResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListingSubscriptionsDeprecatedResponse)) {
            return false;
        }

        ListingSubscriptionsDeprecatedResponse other = (ListingSubscriptionsDeprecatedResponse) o;
