...
/**
 * The base 64 encoded JWT token which is mapped to a particular subscription. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SubscriptionToken.Builder.class)
...
public final class SubscriptionToken
    ...
    public static class Builder {
        ...
        public SubscriptionToken build() {
            SubscriptionToken model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SubscriptionToken model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubscriptionToken)) {
            return false;
        }

        SubscriptionToken other = (SubscriptionToken) o;
