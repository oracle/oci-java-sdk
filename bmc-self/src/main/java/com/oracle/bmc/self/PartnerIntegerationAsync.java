...
public interface PartnerIntegerationAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ActivateSubscriptionResponse> activateSubscription(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListingSubscriptionsResponse> listingSubscriptions(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ResolveSubscriptionResponse> resolveSubscription(
