...
public interface PartnerIntegeration extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ActivateSubscriptionDeprecated API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/ListPartnersExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListPartners API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/ListingSubscriptionsExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListingSubscriptions API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/ListingSubscriptionsDeprecatedExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListingSubscriptionsDeprecated API.
     */
    ListingSubscriptionsDeprecatedResponse listingSubscriptionsDeprecated(
            ListingSubscriptionsDeprecatedRequest request);

    /**
     * This API returns the subscription details by resolving JWT token to corresponding
     * subscription and move its state to Pending Activation state.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     * @throws BmcException when an error occurs. This operation uses
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ResolveSubscription
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ResolveSubscriptionDeprecated API.
     */
    ResolveSubscriptionDeprecatedResponse resolveSubscriptionDeprecated(
            ResolveSubscriptionDeprecatedRequest request);

    /**
     * Asynchronously submits a UTF-8 CSV usage file for marketplace offers. The file must not
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/SubmitSubscriptionUsageBatchExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     SubmitSubscriptionUsageBatch API.
     */
    SubmitSubscriptionUsageBatchResponse submitSubscriptionUsageBatch(
            SubmitSubscriptionUsageBatchRequest request);

    /**
     * Synchronously submits usage records for marketplace offers. Each record must include `id`,
     * `marketplaceOfferId`, `amount`, `currencyCode`, `timeUsageStarted`, `timeUsageEnded`, and
     * `usageDimensionName`.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     SubmitSubscriptionUsageRecords API.
     */
    SubmitSubscriptionUsageRecordsResponse submitSubscriptionUsageRecords(
     ...
     */
    PartnerIntegerationPaginators getPaginators();
}
