...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/ResolveSubscriptionDeprecatedExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResolveSubscriptionDeprecatedRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260129")
public class ResolveSubscriptionDeprecatedRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ResolveSubscriptionDeprecatedRequest o) {
        ...
        /**
         * Build the instance of ResolveSubscriptionDeprecatedRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResolveSubscriptionDeprecatedRequest
         */
        public ResolveSubscriptionDeprecatedRequest build() {
            ResolveSubscriptionDeprecatedRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ResolveSubscriptionDeprecatedRequest
         */
        public ResolveSubscriptionDeprecatedRequest buildWithoutInvocationCallback() {
            ResolveSubscriptionDeprecatedRequest request =
                    new ResolveSubscriptionDeprecatedRequest();
            request.resolveSubscriptionDetails = resolveSubscriptionDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new ResolveSubscriptionDeprecatedRequest(resolveSubscriptionDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResolveSubscriptionDeprecatedRequest)) {
            return false;
        }

        ResolveSubscriptionDeprecatedRequest other = (ResolveSubscriptionDeprecatedRequest) o;
