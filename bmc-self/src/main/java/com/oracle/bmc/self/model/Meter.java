...
/**
 * Details provide by seller for activation of its product. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Meter.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Meter extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "rateAllocation", "extendedMetadata"})
    public Meter(
            String name, Float rateAllocation, java.util.List<ExtendedMetadata> extendedMetadata) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private java.util.List<ExtendedMetadata> extendedMetadata;
         ...
         * @return this builder
         */
        public Builder extendedMetadata(java.util.List<ExtendedMetadata> extendedMetadata) {
            this.extendedMetadata = extendedMetadata;
        ...
        public Meter build() {
            Meter model = new Meter(this.name, this.rateAllocation, this.extendedMetadata);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Meter model) {
    ...
    /** Additional data give by sku. */
    @com.fasterxml.jackson.annotation.JsonProperty("extendedMetadata")
    private final java.util.List<ExtendedMetadata> extendedMetadata;
     ...
     * @return the value
     */
    public java.util.List<ExtendedMetadata> getExtendedMetadata() {
