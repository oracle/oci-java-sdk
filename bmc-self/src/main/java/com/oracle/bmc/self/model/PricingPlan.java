...
/**
 * A pricing plan details provided by the Publisher. <br>
...
public final class PricingPlan extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    /** Specifies the interval at which billing occurs for the subscription plan. */
    public enum PlanDuration implements com.oracle.bmc.http.internal.BmcEnum {
        Annual("ANNUAL"),
