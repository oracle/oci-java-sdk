...
public class ResolveSubscriptionDeprecatedResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code PartnerSubscription} instance. */
    ...
    private ResolveSubscriptionDeprecatedResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ResolveSubscriptionDeprecatedResponse o) {
         ...
         */
        @Override
        public ResolveSubscriptionDeprecatedResponse build() {
            return new ResolveSubscriptionDeprecatedResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResolveSubscriptionDeprecatedResponse)) {
            return false;
        }

        ResolveSubscriptionDeprecatedResponse other = (ResolveSubscriptionDeprecatedResponse) o;
