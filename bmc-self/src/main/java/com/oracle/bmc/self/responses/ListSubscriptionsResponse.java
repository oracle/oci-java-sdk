...
public class ListSubscriptionsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     */
    private com.oracle.bmc.self.model.SubscriptionCollection subscriptionCollection;

    /**
     * The returned SubscriptionCollection instance.
     * @return the value
     */
    public com.oracle.bmc.self.model.SubscriptionCollection getSubscriptionCollection() {
    ...
    private ListSubscriptionsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.self.model.SubscriptionCollection subscriptionCollection) {
    ...
    public static class Builder {
        ...
        public ListSubscriptionsResponse build() {
            return new ListSubscriptionsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, subscriptionCollection);
        }
    }
