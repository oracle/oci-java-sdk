...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.self.model.WorkRequest workRequest;
     ...
     * @return the value
     */
    public com.oracle.bmc.self.model.WorkRequest getWorkRequest() {
        return workRequest;
    }
    ...
    private GetWorkRequestResponse(
            ...
            String opcRequestId,
            Integer retryAfter,
            com.oracle.bmc.self.model.WorkRequest workRequest) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder workRequest(com.oracle.bmc.self.model.WorkRequest workRequest) {
            this.workRequest = workRequest;
            return this;
        }
