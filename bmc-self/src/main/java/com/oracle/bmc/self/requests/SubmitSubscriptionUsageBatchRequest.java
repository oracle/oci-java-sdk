...
public class SubmitSubscriptionUsageBatchRequest
     ...
     * {@code ProductSku}, {@code UnitOfMeasure}, {@code UnitPrice}, {@code ContractDuration}, and
     * {@code AdditionalMetadata}. When provided in CSV, {@code AdditionalMetadata} must be a JSON
     * array of {@code ExtendedMetadata} objects. {@code MarketplaceOfferId} must be a subscription
     * or private offer OCID.
     */
    ...
    public static class Builder
         ...
         * CustomerTenancyId}, {@code BillingIdentifier}, {@code ProductSku}, {@code UnitOfMeasure},
         * {@code UnitPrice}, {@code ContractDuration}, and {@code AdditionalMetadata}. When
         * provided in CSV, {@code AdditionalMetadata} must be a JSON array of {@code
         * ExtendedMetadata} objects. {@code MarketplaceOfferId} must be a subscription or private
         * offer OCID.
         */
        ...
        public SubmitSubscriptionUsageBatchRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SubmitSubscriptionUsageBatchRequest(compartmentId,
            // submitSubscriptionUsageBatchDetails, opcRetryToken, opcRequestId);
        }
    }
