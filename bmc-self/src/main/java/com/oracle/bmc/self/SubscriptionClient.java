...
public class SubscriptionClient implements Subscription {
    ...
    public CancelSubscriptionResponse cancelSubscription(CancelSubscriptionRequest request) {
        LOG.trace("Called cancelSubscription");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CancelSubscriptionResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCancelSubscriptionDetails(),
                                                retriedRequest);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateSubscriptionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetSubscriptionTokenResponse getSubscriptionToken(GetSubscriptionTokenRequest request) {
        LOG.trace("Called getSubscriptionToken");
        final GetSubscriptionTokenRequest interceptedRequest =
                GetSubscriptionTokenConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateSubscriptionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
