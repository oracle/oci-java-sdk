 ...
 * to any list operations of PartnerIntegeration where multiple pages of data may be fetched. Two
...
public class PartnerIntegerationPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.self.model.ListingSubscriptionSummary} objects contained in responses from the
     * listingSubscriptions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.self.model.ListingSubscriptionSummary} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listingSubscriptionsDeprecated operation. This iterable will fetch more data from the server
     * as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
