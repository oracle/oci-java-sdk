...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/self/ListSubscriptionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSubscriptionsRequest.
 */
...
public class ListSubscriptionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     *
     */
    private com.oracle.bmc.self.model.LifecycleDetailsEnum lifecycleDetails;
     ...
     *
     */
    public com.oracle.bmc.self.model.LifecycleDetailsEnum getLifecycleDetails() {
     ...
     */
    private com.oracle.bmc.self.model.SortOrder sortOrder;

    /**
     * The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}).
     */
    public com.oracle.bmc.self.model.SortOrder getSortOrder() {
        return sortOrder;
    }
    /**
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.self.model.LifecycleDetailsEnum lifecycleDetails = null;
        ...
        public Builder lifecycleDetails(
                com.oracle.bmc.self.model.LifecycleDetailsEnum lifecycleDetails) {
         ...
         * The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}).
         */
        private com.oracle.bmc.self.model.SortOrder sortOrder = null;
         ...
         * @return this builder instance
         */
        public Builder sortOrder(com.oracle.bmc.self.model.SortOrder sortOrder) {
        ...
        public ListSubscriptionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSubscriptionsRequest(compartmentId, lifecycleDetails, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
