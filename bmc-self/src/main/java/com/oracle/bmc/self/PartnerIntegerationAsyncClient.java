...
public class PartnerIntegerationAsyncClient implements PartnerIntegerationAsync {
    /**
    ...
    public static class Builder
        ...
        public PartnerIntegerationAsyncClient build(
            ...
            return new PartnerIntegerationAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ActivateSubscriptionResponse> activateSubscription(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async activateSubscription");
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ActivateSubscriptionRequest, ActivateSubscriptionResponse>,
                        java.util.concurrent.Future<ActivateSubscriptionResponse>>
                futureSupplier =
    ...
    public java.util.concurrent.Future<ListingSubscriptionsResponse> listingSubscriptions(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listingSubscriptions");
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListingSubscriptionsRequest, ListingSubscriptionsResponse>,
                        java.util.concurrent.Future<ListingSubscriptionsResponse>>
    ...
    public java.util.concurrent.Future<ResolveSubscriptionResponse> resolveSubscription(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async resolveSubscription");
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ResolveSubscriptionRequest, ResolveSubscriptionResponse>,
                        java.util.concurrent.Future<ResolveSubscriptionResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
