...
import com.oracle.bmc.self.internal.http.*;
...
public class PartnerIntegerationClient implements PartnerIntegeration {
    /**
     ...
     */
    protected PartnerIntegerationClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public PartnerIntegerationClient build(
            ...
            return new PartnerIntegerationClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ActivateSubscriptionResponse activateSubscription(ActivateSubscriptionRequest request) {
        LOG.trace("Called activateSubscription");
        final ActivateSubscriptionRequest interceptedRequest =
                ActivateSubscriptionConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ActivateSubscriptionConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ActivateSubscriptionResponse>
                transformer =
    ...
    public ListPartnersResponse listPartners(ListPartnersRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListPartnersResponse> transformer =
    ...
    public ListingSubscriptionsResponse listingSubscriptions(ListingSubscriptionsRequest request) {
        LOG.trace("Called listingSubscriptions");
        final ListingSubscriptionsRequest interceptedRequest =
                ListingSubscriptionsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListingSubscriptionsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListingSubscriptionsResponse>
                transformer =
    ...
    public ResolveSubscriptionResponse resolveSubscription(ResolveSubscriptionRequest request) {
        ...
        final ResolveSubscriptionRequest interceptedRequest =
                ResolveSubscriptionConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ResolveSubscriptionConverter.fromRequest(client, interceptedRequest);
    ...
    public SubmitSubscriptionUsageBatchResponse submitSubscriptionUsageBatch(
        ...
        LOG.trace("Called submitSubscriptionUsageBatch");
        try {
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier =
                    com.oracle.bmc.retrier.Retriers.createPreferredRetrier(
                                    ...
                                    try {
                                        javax.ws.rs.core.Response response =
                                                client.post(
                                                        ib,
                                                        retriedRequest
                                                                .getSubmitSubscriptionUsageBatchDetails(),
                                                        retriedRequest);
                                        return transformer.apply(response);
    ...
    public SubmitSubscriptionUsageRecordsResponse submitSubscriptionUsageRecords(
        ...
        LOG.trace("Called submitSubscriptionUsageRecords");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getSubmitSubscriptionUsageRecordsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
