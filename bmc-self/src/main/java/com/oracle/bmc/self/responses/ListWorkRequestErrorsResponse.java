...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     */
    private com.oracle.bmc.self.model.WorkRequestErrorCollection workRequestErrorCollection;

    /**
     * The returned WorkRequestErrorCollection instance.
     * @return the value
     */
    public com.oracle.bmc.self.model.WorkRequestErrorCollection getWorkRequestErrorCollection() {
    ...
    private ListWorkRequestErrorsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.self.model.WorkRequestErrorCollection workRequestErrorCollection) {
