...
public class MetricBase extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * <p>
     * {@code COMPUTE_AGENT}: CPU or memory metrics emitted by the Compute Instance Monitoring plugin.
     * <p>
     * {@code CUSTOM_QUERY}: A custom Monitoring Query Language (MQL) expression.
     *
     **/
