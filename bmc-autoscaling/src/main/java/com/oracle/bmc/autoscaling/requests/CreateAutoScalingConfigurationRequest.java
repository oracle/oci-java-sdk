...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/autoscaling/CreateAutoScalingConfigurationExample.java.html">here</a> to see how to use CreateAutoScalingConfigurationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181001")
@lombok.Builder(builderClassName = "Builder", buildMethodName = "buildWithoutInvocationCallback")
@lombok.Getter
public class CreateAutoScalingConfigurationRequest
        extends com.oracle.bmc.requests.BmcRequest<CreateAutoScalingConfigurationDetails> {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(CreateAutoScalingConfigurationDetails body) {
