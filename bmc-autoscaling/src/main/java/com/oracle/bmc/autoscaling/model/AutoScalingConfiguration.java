...
public final class AutoScalingConfiguration
    ...
    public static class Builder {
        ...
        /**
         * Autoscaling policy definitions for the autoscaling configuration. An autoscaling policy
         * defines the criteria that trigger autoscaling actions and the actions to take.
         */
