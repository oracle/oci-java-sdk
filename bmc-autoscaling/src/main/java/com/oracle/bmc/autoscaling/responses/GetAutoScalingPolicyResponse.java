...
public class GetAutoScalingPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAutoScalingPolicyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAutoScalingPolicyResponse)) {
            return false;
        }

        GetAutoScalingPolicyResponse other = (GetAutoScalingPolicyResponse) o;
