...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/autoscaling/UpdateAutoScalingConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAutoScalingConfigurationRequest.
 */
...
public class UpdateAutoScalingConfigurationRequest
    ...
    public static class Builder
        ...
        public UpdateAutoScalingConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAutoScalingConfigurationRequest(autoScalingConfigurationId, updateAutoScalingConfigurationDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
