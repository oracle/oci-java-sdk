...
/**
 * An autoscaling policy that defines threshold-based rules for an autoscaling configuration. <br>
...
public final class ThresholdPolicy extends AutoScalingPolicy {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ThresholdPolicy model) {
