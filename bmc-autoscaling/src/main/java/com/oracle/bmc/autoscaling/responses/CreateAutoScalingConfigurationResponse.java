...
public class CreateAutoScalingConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateAutoScalingConfigurationResponse(
    ...
    public static class Builder {
        ...
        public CreateAutoScalingConfigurationResponse build() {
            return new CreateAutoScalingConfigurationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutoScalingConfigurationResponse)) {
            return false;
        }

        CreateAutoScalingConfigurationResponse other = (CreateAutoScalingConfigurationResponse) o;
