...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/autoscaling/DeleteAutoScalingConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAutoScalingConfigurationRequest.
 */
...
public class DeleteAutoScalingConfigurationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAutoScalingConfigurationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAutoScalingConfigurationRequest o) {
        ...
        /**
         * Build the instance of DeleteAutoScalingConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAutoScalingConfigurationRequest
         */
        public DeleteAutoScalingConfigurationRequest build() {
            DeleteAutoScalingConfigurationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAutoScalingConfigurationRequest
         */
        public DeleteAutoScalingConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteAutoScalingConfigurationRequest(autoScalingConfigurationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAutoScalingConfigurationRequest)) {
            return false;
        }

        DeleteAutoScalingConfigurationRequest other = (DeleteAutoScalingConfigurationRequest) o;
