...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/autoscaling/ListAutoScalingPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutoScalingPoliciesRequest.
 */
...
public class ListAutoScalingPoliciesRequest
    ...
    public static class Builder
        ...
        public ListAutoScalingPoliciesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutoScalingPoliciesRequest(autoScalingConfigurationId, displayName, opcRequestId, limit, page, sortBy, sortOrder);
        }
    }
