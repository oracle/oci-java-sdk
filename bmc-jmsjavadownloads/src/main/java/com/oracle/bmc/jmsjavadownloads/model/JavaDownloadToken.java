...
/**
 * A JavaDownloadToken is a primary resource for the script friendly URLs. The value of this token
 * serves as the authorization token for the download. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = JavaDownloadToken.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class JavaDownloadToken
    ...
    public static class Builder {
        ...
        public JavaDownloadToken build() {
            JavaDownloadToken model =
                    new JavaDownloadToken(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.createdBy,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JavaDownloadToken model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JavaDownloadToken)) {
            return false;
        }

        JavaDownloadToken other = (JavaDownloadToken) o;
