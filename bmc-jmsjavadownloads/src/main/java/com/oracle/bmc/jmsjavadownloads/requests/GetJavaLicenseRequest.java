...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jmsjavadownloads/GetJavaLicenseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJavaLicenseRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230601")
public class GetJavaLicenseRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetJavaLicenseRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetJavaLicenseRequest
         */
        public GetJavaLicenseRequest build() {
            GetJavaLicenseRequest request = buildWithoutInvocationCallback();
        ...
        public GetJavaLicenseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetJavaLicenseRequest(licenseType, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().licenseType(licenseType).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetJavaLicenseRequest other = (GetJavaLicenseRequest) o;
