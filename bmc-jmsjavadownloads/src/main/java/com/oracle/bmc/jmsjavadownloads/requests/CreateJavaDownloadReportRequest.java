...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jmsjavadownloads/CreateJavaDownloadReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateJavaDownloadReportRequest.
 */
...
public class CreateJavaDownloadReportRequest
    ...
    public static class Builder
        ...
        public CreateJavaDownloadReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateJavaDownloadReportRequest(createJavaDownloadReportDetails, opcRetryToken, opcRequestId);
        }
    }
