...
public class ListJavaLicensesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListJavaLicensesConverter.class);

    public static com.oracle.bmc.jmsjavadownloads.requests.ListJavaLicensesRequest interceptRequest(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.jmsjavadownloads.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jmsjavadownloads.responses.ListJavaLicensesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.jmsjavadownloads.responses.ListJavaLicensesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.jmsjavadownloads.responses
                                                        .ListJavaLicensesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.javaLicenseCollection(response.getItem());
