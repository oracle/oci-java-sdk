...
/**
 * Details about a Java download report in a tenancy. The report is a file in Object Storage. It
 * contains the download records in a specific format. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = JavaDownloadReport.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class JavaDownloadReport
    ...
    public static class Builder {
        ...
        public JavaDownloadReport build() {
            JavaDownloadReport model =
                    new JavaDownloadReport(
                            this.id,
                            this.displayName,
                            this.format,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JavaDownloadReport model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JavaDownloadReport)) {
            return false;
        }

        JavaDownloadReport other = (JavaDownloadReport) o;
