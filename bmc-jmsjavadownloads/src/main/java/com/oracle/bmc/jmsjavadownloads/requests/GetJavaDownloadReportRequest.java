...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jmsjavadownloads/GetJavaDownloadReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJavaDownloadReportRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230601")
public class GetJavaDownloadReportRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetJavaDownloadReportRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetJavaDownloadReportRequest o) {
         ...
         *
         * @return instance of GetJavaDownloadReportRequest
         */
        public GetJavaDownloadReportRequest build() {
            GetJavaDownloadReportRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetJavaDownloadReportRequest
         */
        public GetJavaDownloadReportRequest buildWithoutInvocationCallback() {
            GetJavaDownloadReportRequest request = new GetJavaDownloadReportRequest();
            request.javaDownloadReportId = javaDownloadReportId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetJavaDownloadReportRequest(javaDownloadReportId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetJavaDownloadReportRequest)) {
            return false;
        }

        GetJavaDownloadReportRequest other = (GetJavaDownloadReportRequest) o;
