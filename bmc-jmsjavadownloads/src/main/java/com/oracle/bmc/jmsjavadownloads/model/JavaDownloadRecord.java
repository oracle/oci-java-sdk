...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = JavaDownloadRecord.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class JavaDownloadRecord extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public JavaDownloadRecord build() {
            JavaDownloadRecord model =
                    new JavaDownloadRecord(
                            this.familyVersion,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JavaDownloadRecord model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JavaDownloadRecord)) {
            return false;
        }

        JavaDownloadRecord other = (JavaDownloadRecord) o;
