...
public class DeleteJavaDownloadReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteJavaDownloadReportResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteJavaDownloadReportResponse o) {
         ...
         */
        @Override
        public DeleteJavaDownloadReportResponse build() {
            return new DeleteJavaDownloadReportResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteJavaDownloadReportResponse)) {
            return false;
        }

        DeleteJavaDownloadReportResponse other = (DeleteJavaDownloadReportResponse) o;
