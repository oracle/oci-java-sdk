...
public class DeleteJavaDownloadTokenResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteJavaDownloadTokenResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteJavaDownloadTokenResponse o) {
         ...
         */
        @Override
        public DeleteJavaDownloadTokenResponse build() {
            return new DeleteJavaDownloadTokenResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteJavaDownloadTokenResponse)) {
            return false;
        }

        DeleteJavaDownloadTokenResponse other = (DeleteJavaDownloadTokenResponse) o;
