...
public interface JavaDownloadAsync extends AutoCloseable {
     ...
     * API to get information about available artifacts for a specific release. Each such artifact
     * is uniquely identified by an `artifactId`. Refer {@link #javaArtifact(JavaArtifactRequest,
