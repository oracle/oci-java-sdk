...
public class UpdateJavaDownloadTokenResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateJavaDownloadTokenResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateJavaDownloadTokenResponse o) {
         ...
         */
        @Override
        public UpdateJavaDownloadTokenResponse build() {
            return new UpdateJavaDownloadTokenResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateJavaDownloadTokenResponse)) {
            return false;
        }

        UpdateJavaDownloadTokenResponse other = (UpdateJavaDownloadTokenResponse) o;
