...
public class CreateJavaDownloadReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateJavaDownloadReportResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateJavaDownloadReportResponse o) {
         ...
         */
        @Override
        public CreateJavaDownloadReportResponse build() {
            return new CreateJavaDownloadReportResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateJavaDownloadReportResponse)) {
            return false;
        }

        CreateJavaDownloadReportResponse other = (CreateJavaDownloadReportResponse) o;
