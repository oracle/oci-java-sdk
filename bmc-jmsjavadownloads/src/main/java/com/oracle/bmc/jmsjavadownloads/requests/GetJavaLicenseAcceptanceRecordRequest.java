...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jmsjavadownloads/GetJavaLicenseAcceptanceRecordExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJavaLicenseAcceptanceRecordRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230601")
public class GetJavaLicenseAcceptanceRecordRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetJavaLicenseAcceptanceRecordRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetJavaLicenseAcceptanceRecordRequest o) {
        ...
        /**
         * Build the instance of GetJavaLicenseAcceptanceRecordRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetJavaLicenseAcceptanceRecordRequest
         */
        public GetJavaLicenseAcceptanceRecordRequest build() {
            GetJavaLicenseAcceptanceRecordRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetJavaLicenseAcceptanceRecordRequest
         */
        public GetJavaLicenseAcceptanceRecordRequest buildWithoutInvocationCallback() {
            GetJavaLicenseAcceptanceRecordRequest request =
                    new GetJavaLicenseAcceptanceRecordRequest();
            request.javaLicenseAcceptanceRecordId = javaLicenseAcceptanceRecordId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetJavaLicenseAcceptanceRecordRequest(javaLicenseAcceptanceRecordId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetJavaLicenseAcceptanceRecordRequest)) {
            return false;
        }

        GetJavaLicenseAcceptanceRecordRequest other = (GetJavaLicenseAcceptanceRecordRequest) o;
