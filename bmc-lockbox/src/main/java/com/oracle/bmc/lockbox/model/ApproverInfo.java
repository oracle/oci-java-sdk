...
public final class ApproverInfo {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ApproverInfo build() {
            ApproverInfo __instance__ = new ApproverInfo(approverType, approverId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApproverInfo o) {
            Builder copiedBuilder = approverType(o.getApproverType()).approverId(o.getApproverId());
