...
public class GetApprovalTemplateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetApprovalTemplateResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetApprovalTemplateResponse> {
         ...
         */
        @Override
        public Builder copy(GetApprovalTemplateResponse o) {
         ...
         */
        @Override
        public GetApprovalTemplateResponse build() {
            return new GetApprovalTemplateResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, approvalTemplate);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApprovalTemplateResponse)) {
            return false;
        }

        GetApprovalTemplateResponse other = (GetApprovalTemplateResponse) o;
