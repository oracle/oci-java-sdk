...
public class GetLockboxResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "etag", "opcRequestId", "lockbox"})
    ...
    public static class Builder {
        ...
        public GetLockboxResponse build() {
            return new GetLockboxResponse(__httpStatusCode__, etag, opcRequestId, lockbox);
        }
    }
