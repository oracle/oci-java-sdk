...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/lockbox/ExportAccessRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExportAccessRequestsRequest.
 */
...
public class ExportAccessRequestsRequest
    ...
    public static class Builder
        ...
        public ExportAccessRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ExportAccessRequestsRequest(exportAccessRequestsDetails, opcRequestId, id, displayName, lifecycleState, lockboxPartner, partnerId, requestorId, limit, page, sortOrder, sortBy);
        }
    }
