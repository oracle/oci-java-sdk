...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/lockbox/ListAccessRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAccessRequestsRequest.
 */
...
public class ListAccessRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAccessRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAccessRequestsRequest(opcRequestId, lockboxId, id, displayName, lifecycleState, lockboxPartner, partnerId, requestorId, limit, page, sortOrder, sortBy, timeCreatedAfter, timeCreatedBefore);
        }
    }
