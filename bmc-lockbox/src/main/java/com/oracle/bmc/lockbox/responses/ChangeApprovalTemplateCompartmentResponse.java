...
public class ChangeApprovalTemplateCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeApprovalTemplateCompartmentResponse)) {
            return false;
        }

        ChangeApprovalTemplateCompartmentResponse other =
                (ChangeApprovalTemplateCompartmentResponse) o;
