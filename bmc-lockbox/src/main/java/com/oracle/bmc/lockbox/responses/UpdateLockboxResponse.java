...
public class UpdateLockboxResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "opcRequestId", "etag", "lockbox"})
    ...
    public static class Builder {
        ...
        public UpdateLockboxResponse build() {
            return new UpdateLockboxResponse(__httpStatusCode__, opcRequestId, etag, lockbox);
        }
    }
