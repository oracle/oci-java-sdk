...
public class UpdateLockboxResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateLockboxResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateLockboxResponse o) {
         ...
         */
        @Override
        public UpdateLockboxResponse build() {
            return new UpdateLockboxResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, lockbox);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLockboxResponse)) {
            return false;
        }

        UpdateLockboxResponse other = (UpdateLockboxResponse) o;
