...
public class LockboxWaiters {
    ...
    public LockboxWaiters(java.util.concurrent.ExecutorService executorService, Lockbox client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetAccessRequestRequest, GetAccessRequestResponse>
            forAccessRequest(
                    ...
                    com.oracle.bmc.lockbox.model.AccessRequest.LifecycleState... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetAccessRequestRequest, GetAccessRequestResponse>
            forAccessRequest(
                    GetAccessRequestRequest request,
                    com.oracle.bmc.lockbox.model.AccessRequest.LifecycleState targetState,
    ...
    private com.oracle.bmc.waiter.Waiter<GetAccessRequestRequest, GetAccessRequestResponse>
            forAccessRequest(
                    ...
                    final com.oracle.bmc.lockbox.model.AccessRequest.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.lockbox.model.AccessRequest.LifecycleState>
    ...
    public com.oracle.bmc.waiter.Waiter<GetApprovalTemplateRequest, GetApprovalTemplateResponse>
            forApprovalTemplate(
                    ...
                    com.oracle.bmc.lockbox.model.ApprovalTemplate.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forApprovalTemplate(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetApprovalTemplateRequest, GetApprovalTemplateResponse>
            forApprovalTemplate(
                    GetApprovalTemplateRequest request,
                    com.oracle.bmc.lockbox.model.ApprovalTemplate.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for ApprovalTemplate.
    private com.oracle.bmc.waiter.Waiter<GetApprovalTemplateRequest, GetApprovalTemplateResponse>
            forApprovalTemplate(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetApprovalTemplateRequest request,
                    final com.oracle.bmc.lockbox.model.ApprovalTemplate.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.lockbox.model.ApprovalTemplate.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetApprovalTemplateResponse apply(
                                    GetApprovalTemplateRequest request) {
                                return client.getApprovalTemplate(request);
                            }
                        },
                        new java.util.function.Predicate<GetApprovalTemplateResponse>() {
                            @Override
                            public boolean test(GetApprovalTemplateResponse response) {
                                return targetStatesSet.contains(
                                        response.getApprovalTemplate().getLifecycleState());
                            }
                        },
    ...
    public com.oracle.bmc.waiter.Waiter<GetLockboxRequest, GetLockboxResponse> forLockbox(
            ...
            com.oracle.bmc.lockbox.model.Lockbox.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetLockboxRequest, GetLockboxResponse> forLockbox(
            GetLockboxRequest request,
            com.oracle.bmc.lockbox.model.Lockbox.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Lockbox.
    private com.oracle.bmc.waiter.Waiter<GetLockboxRequest, GetLockboxResponse> forLockbox(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetLockboxRequest request,
            final com.oracle.bmc.lockbox.model.Lockbox.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.lockbox.model.Lockbox.LifecycleState> targetStatesSet =
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetLockboxRequest, GetLockboxResponse>() {
                            @Override
                            public GetLockboxResponse apply(GetLockboxRequest request) {
                                return client.getLockbox(request);
                            }
                        },
                        new java.util.function.Predicate<GetLockboxResponse>() {
                            @Override
                            public boolean test(GetLockboxResponse response) {
                                return targetStatesSet.contains(
                                        response.getLockbox().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.lockbox.model.Lockbox.LifecycleState.Deleted)),
                request);
    }
