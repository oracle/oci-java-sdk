...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/lockbox/ChangeApprovalTemplateCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeApprovalTemplateCompartmentRequest.
 */
...
public class ChangeApprovalTemplateCompartmentRequest
    ...
    public com.oracle.bmc.lockbox.model.ChangeApprovalTemplateCompartmentDetails getBody$() {
        return changeApprovalTemplateCompartmentDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder changeApprovalTemplateCompartmentDetails(
                com.oracle.bmc.lockbox.model.ChangeApprovalTemplateCompartmentDetails
                        changeApprovalTemplateCompartmentDetails) {
            this.changeApprovalTemplateCompartmentDetails =
                    changeApprovalTemplateCompartmentDetails;
            return this;
        }
        ...
        public Builder copy(ChangeApprovalTemplateCompartmentRequest o) {
            ...
            changeApprovalTemplateCompartmentDetails(
                    o.getChangeApprovalTemplateCompartmentDetails());
        ...
        public ChangeApprovalTemplateCompartmentRequest build() {
            ChangeApprovalTemplateCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.lockbox.model.ChangeApprovalTemplateCompartmentDetails body) {
            changeApprovalTemplateCompartmentDetails(body);
            return this;
        }
        ...
        public ChangeApprovalTemplateCompartmentRequest buildWithoutInvocationCallback() {
            ChangeApprovalTemplateCompartmentRequest request =
                    new ChangeApprovalTemplateCompartmentRequest();
            request.approvalTemplateId = approvalTemplateId;
            request.changeApprovalTemplateCompartmentDetails =
                    changeApprovalTemplateCompartmentDetails;
    ...
    public String toString() {
        ...
        sb.append(",changeApprovalTemplateCompartmentDetails=")
                .append(String.valueOf(this.changeApprovalTemplateCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeApprovalTemplateCompartmentRequest)) {
            return false;
        }

        ChangeApprovalTemplateCompartmentRequest other =
                (ChangeApprovalTemplateCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.approvalTemplateId, other.approvalTemplateId)
                && java.util.Objects.equals(
                        this.changeApprovalTemplateCompartmentDetails,
                        other.changeApprovalTemplateCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeApprovalTemplateCompartmentDetails == null
                                ? 43
                                : this.changeApprovalTemplateCompartmentDetails.hashCode());
