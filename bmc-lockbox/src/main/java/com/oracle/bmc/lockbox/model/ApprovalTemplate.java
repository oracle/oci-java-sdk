...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApprovalTemplate.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ApprovalTemplate extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalTemplate model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApprovalTemplate)) {
            return false;
        }

        ApprovalTemplate other = (ApprovalTemplate) o;
