...
public class ListZprConfigurationWorkRequestErrorsResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListZprConfigurationWorkRequestErrorsResponse)) {
            return false;
        }

        ListZprConfigurationWorkRequestErrorsResponse other =
                (ListZprConfigurationWorkRequestErrorsResponse) o;
