...
public class ZprClient implements Zpr {
    /**
    ...
    public CreateZprPolicyResponse createZprPolicy(CreateZprPolicyRequest request) {
        LOG.trace("Called createZprPolicy");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateZprPolicyResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateZprPolicyDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteZprPolicyResponse deleteZprPolicy(DeleteZprPolicyRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteZprPolicyResponse>
                transformer =
    ...
    public GetZprConfigurationWorkRequestResponse getZprConfigurationWorkRequest(
        ...
        LOG.trace("Called getZprConfigurationWorkRequest");
    ...
    public GetZprPolicyResponse getZprPolicy(GetZprPolicyRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetZprPolicyResponse> transformer =
    ...
    public GetZprPolicyWorkRequestResponse getZprPolicyWorkRequest(
        ...
        LOG.trace("Called getZprPolicyWorkRequest");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetZprPolicyWorkRequestResponse>
                transformer =
    ...
    public ListZprConfigurationWorkRequestErrorsResponse listZprConfigurationWorkRequestErrors(
        ...
        LOG.trace("Called listZprConfigurationWorkRequestErrors");
    ...
    public ListZprConfigurationWorkRequestLogsResponse listZprConfigurationWorkRequestLogs(
        ...
        LOG.trace("Called listZprConfigurationWorkRequestLogs");
    ...
    public ListZprConfigurationWorkRequestsResponse listZprConfigurationWorkRequests(
        ...
        LOG.trace("Called listZprConfigurationWorkRequests");
    ...
    public ListZprPoliciesResponse listZprPolicies(ListZprPoliciesRequest request) {
        LOG.trace("Called listZprPolicies");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListZprPoliciesResponse>
                transformer =
    ...
    public ListZprPolicyWorkRequestErrorsResponse listZprPolicyWorkRequestErrors(
        ...
        LOG.trace("Called listZprPolicyWorkRequestErrors");
    ...
    public ListZprPolicyWorkRequestLogsResponse listZprPolicyWorkRequestLogs(
        ...
        LOG.trace("Called listZprPolicyWorkRequestLogs");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListZprPolicyWorkRequestLogsResponse>
                transformer =
    ...
    public ListZprPolicyWorkRequestsResponse listZprPolicyWorkRequests(
        ...
        LOG.trace("Called listZprPolicyWorkRequests");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListZprPolicyWorkRequestsResponse>
                transformer =
    ...
    public UpdateZprPolicyResponse updateZprPolicy(UpdateZprPolicyRequest request) {
        LOG.trace("Called updateZprPolicy");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateZprPolicyResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateZprPolicyDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
