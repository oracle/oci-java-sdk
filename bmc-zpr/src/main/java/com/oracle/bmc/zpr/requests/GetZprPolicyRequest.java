...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/zpr/GetZprPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetZprPolicyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240301")
public class GetZprPolicyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetZprPolicyRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetZprPolicyRequest
         */
        public GetZprPolicyRequest build() {
            GetZprPolicyRequest request = buildWithoutInvocationCallback();
        ...
        public GetZprPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetZprPolicyRequest(zprPolicyId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().zprPolicyId(zprPolicyId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetZprPolicyRequest other = (GetZprPolicyRequest) o;
