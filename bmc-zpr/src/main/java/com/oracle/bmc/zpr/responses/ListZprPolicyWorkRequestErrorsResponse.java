...
public class ListZprPolicyWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ListZprPolicyWorkRequestErrorsResponse o) {
         ...
         */
        public ListZprPolicyWorkRequestErrorsResponse build() {
            return new ListZprPolicyWorkRequestErrorsResponse(
                    __httpStatusCode__,
                    headers,
                    opcNextPage,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListZprPolicyWorkRequestErrorsResponse)) {
            return false;
        }

        ListZprPolicyWorkRequestErrorsResponse other = (ListZprPolicyWorkRequestErrorsResponse) o;
