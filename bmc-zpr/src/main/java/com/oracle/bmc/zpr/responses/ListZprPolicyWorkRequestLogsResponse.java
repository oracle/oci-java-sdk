...
public class ListZprPolicyWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private com.oracle.bmc.zpr.model.WorkRequestLogEntryCollection workRequestLogEntryCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.zpr.model.WorkRequestLogEntryCollection
    ...
    private ListZprPolicyWorkRequestLogsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.zpr.model.WorkRequestLogEntryCollection workRequestLogEntryCollection) {
    ...
    public static class Builder
        ...
        /** The returned {@code WorkRequestLogEntryCollection} instance. */
        private com.oracle.bmc.zpr.model.WorkRequestLogEntryCollection
                workRequestLogEntryCollection;
         ...
         */
        @Override
        public Builder copy(ListZprPolicyWorkRequestLogsResponse o) {
         ...
         */
        @Override
        public ListZprPolicyWorkRequestLogsResponse build() {
            return new ListZprPolicyWorkRequestLogsResponse(
                    __httpStatusCode__,
                    headers,
                    opcNextPage,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListZprPolicyWorkRequestLogsResponse)) {
            return false;
        }

        ListZprPolicyWorkRequestLogsResponse other = (ListZprPolicyWorkRequestLogsResponse) o;
