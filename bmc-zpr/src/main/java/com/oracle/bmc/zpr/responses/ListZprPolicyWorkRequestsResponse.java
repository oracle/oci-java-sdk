...
public class ListZprPolicyWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private com.oracle.bmc.zpr.model.WorkRequestSummaryCollection workRequestSummaryCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.zpr.model.WorkRequestSummaryCollection getWorkRequestSummaryCollection() {
    ...
    private ListZprPolicyWorkRequestsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.zpr.model.WorkRequestSummaryCollection workRequestSummaryCollection) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListZprPolicyWorkRequestsResponse o) {
         ...
         */
        @Override
        public ListZprPolicyWorkRequestsResponse build() {
            return new ListZprPolicyWorkRequestsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListZprPolicyWorkRequestsResponse)) {
            return false;
        }

        ListZprPolicyWorkRequestsResponse other = (ListZprPolicyWorkRequestsResponse) o;
