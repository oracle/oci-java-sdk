...
public class GetConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.zpr.model.Configuration configuration;
     ...
     * @return the value
     */
    public com.oracle.bmc.zpr.model.Configuration getConfiguration() {
    ...
    private GetConfigurationResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.zpr.model.Configuration configuration) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder configuration(com.oracle.bmc.zpr.model.Configuration configuration) {
            this.configuration = configuration;
            return this;
        }
