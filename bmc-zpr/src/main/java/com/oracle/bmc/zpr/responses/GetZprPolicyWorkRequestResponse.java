...
public class GetZprPolicyWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetZprPolicyWorkRequestResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetZprPolicyWorkRequestResponse o) {
         ...
         */
        @Override
        public GetZprPolicyWorkRequestResponse build() {
            return new GetZprPolicyWorkRequestResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetZprPolicyWorkRequestResponse)) {
            return false;
        }

        GetZprPolicyWorkRequestResponse other = (GetZprPolicyWorkRequestResponse) o;
