...
public class CreateCccUpgradeScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateCccUpgradeScheduleResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateCccUpgradeScheduleResponse o) {
         ...
         */
        @Override
        public CreateCccUpgradeScheduleResponse build() {
            return new CreateCccUpgradeScheduleResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCccUpgradeScheduleResponse)) {
            return false;
        }

        CreateCccUpgradeScheduleResponse other = (CreateCccUpgradeScheduleResponse) o;
