...
public class ComputeCloudAtCustomerClient implements ComputeCloudAtCustomer {
    /**
     ...
     */
    protected ComputeCloudAtCustomerClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeCccInfrastructureCompartmentResponse changeCccInfrastructureCompartment(
        ...
        LOG.trace("Called changeCccInfrastructureCompartment");
    ...
    public ChangeCccUpgradeScheduleCompartmentResponse changeCccUpgradeScheduleCompartment(
        ...
        LOG.trace("Called changeCccUpgradeScheduleCompartment");
    ...
    public CreateCccInfrastructureResponse createCccInfrastructure(
        ...
        LOG.trace("Called createCccInfrastructure");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateCccInfrastructureResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateCccInfrastructureDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateCccUpgradeScheduleResponse createCccUpgradeSchedule(
        ...
        LOG.trace("Called createCccUpgradeSchedule");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateCccUpgradeScheduleResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateCccUpgradeScheduleDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteCccInfrastructureResponse deleteCccInfrastructure(
        ...
        LOG.trace("Called deleteCccInfrastructure");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteCccInfrastructureResponse>
                transformer =
    ...
    public DeleteCccUpgradeScheduleResponse deleteCccUpgradeSchedule(
        ...
        LOG.trace("Called deleteCccUpgradeSchedule");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteCccUpgradeScheduleResponse>
                transformer =
    ...
    public GetCccInfrastructureResponse getCccInfrastructure(GetCccInfrastructureRequest request) {
        LOG.trace("Called getCccInfrastructure");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetCccInfrastructureResponse>
                transformer =
    ...
    public GetCccUpgradeScheduleResponse getCccUpgradeSchedule(
        ...
        LOG.trace("Called getCccUpgradeSchedule");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetCccUpgradeScheduleResponse>
                transformer =
    ...
    public ListCccInfrastructuresResponse listCccInfrastructures(
        ...
        LOG.trace("Called listCccInfrastructures");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListCccInfrastructuresResponse>
                transformer =
    ...
    public ListCccUpgradeSchedulesResponse listCccUpgradeSchedules(
        ...
        LOG.trace("Called listCccUpgradeSchedules");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListCccUpgradeSchedulesResponse>
                transformer =
    ...
    public UpdateCccInfrastructureResponse updateCccInfrastructure(
        ...
        LOG.trace("Called updateCccInfrastructure");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateCccInfrastructureResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateCccInfrastructureDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateCccUpgradeScheduleResponse updateCccUpgradeSchedule(
        ...
        LOG.trace("Called updateCccUpgradeSchedule");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateCccUpgradeScheduleResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateCccUpgradeScheduleDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
