...
public final class CreateCccUpgradeScheduleDetails
    ...
    public CreateCccUpgradeScheduleDetails(
            String displayName,
            String compartmentId,
            String description,
            java.util.List<CreateCccScheduleEvent> events,
    ...
    public static class Builder {
        ...
        public CreateCccUpgradeScheduleDetails build() {
            CreateCccUpgradeScheduleDetails model =
                    new CreateCccUpgradeScheduleDetails(
                            this.displayName,
                            this.compartmentId,
                            this.description,
                            this.events,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCccUpgradeScheduleDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCccUpgradeScheduleDetails)) {
            return false;
        }

        CreateCccUpgradeScheduleDetails other = (CreateCccUpgradeScheduleDetails) o;
