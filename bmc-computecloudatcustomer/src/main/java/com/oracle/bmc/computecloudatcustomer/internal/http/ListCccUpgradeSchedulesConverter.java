...
public class ListCccUpgradeSchedulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListCccUpgradeSchedulesConverter.class);

    public static com.oracle.bmc.computecloudatcustomer.requests.ListCccUpgradeSchedulesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.computecloudatcustomer.requests.ListCccUpgradeSchedulesRequest request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20221208").path("cccUpgradeSchedules");

        if (request.getCccUpgradeScheduleId() != null) {
            target =
                    target.queryParam(
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.computecloudatcustomer.responses.ListCccUpgradeSchedulesResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.computecloudatcustomer.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.computecloudatcustomer.responses.ListCccUpgradeSchedulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.computecloudatcustomer.responses
                                                .ListCccUpgradeSchedulesResponse.Builder
                                        builder =
                                                com.oracle.bmc.computecloudatcustomer.responses
                                                        .ListCccUpgradeSchedulesResponse.builder()
                                ...
                                builder.cccUpgradeScheduleCollection(response.getItem());
