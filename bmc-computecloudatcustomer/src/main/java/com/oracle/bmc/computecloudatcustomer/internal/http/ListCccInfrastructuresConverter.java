...
public class ListCccInfrastructuresConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListCccInfrastructuresConverter.class);

    public static com.oracle.bmc.computecloudatcustomer.requests.ListCccInfrastructuresRequest
            interceptRequest(
                    com.oracle.bmc.computecloudatcustomer.requests.ListCccInfrastructuresRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.computecloudatcustomer.requests.ListCccInfrastructuresRequest request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20221208").path("cccInfrastructures");
        ...
        if (request.getCccInfrastructureId() != null) {
            target =
                    target.queryParam(
                            "cccInfrastructureId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.computecloudatcustomer.responses.ListCccInfrastructuresResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.computecloudatcustomer.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.computecloudatcustomer.responses.ListCccInfrastructuresResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.cccInfrastructureCollection(response.getItem());
