...
public class GetCccInfrastructureConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetCccInfrastructureConverter.class);

    public static com.oracle.bmc.computecloudatcustomer.requests.GetCccInfrastructureRequest
            interceptRequest(
                    com.oracle.bmc.computecloudatcustomer.requests.GetCccInfrastructureRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.computecloudatcustomer.requests.GetCccInfrastructureRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.computecloudatcustomer.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.computecloudatcustomer.responses.GetCccInfrastructureResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.computecloudatcustomer.responses
                                                .GetCccInfrastructureResponse.Builder
                                        builder =
                                                com.oracle.bmc.computecloudatcustomer.responses
                                                        .GetCccInfrastructureResponse.builder()
