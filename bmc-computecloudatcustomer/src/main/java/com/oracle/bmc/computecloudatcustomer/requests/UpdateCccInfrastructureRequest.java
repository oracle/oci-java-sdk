...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/computecloudatcustomer/UpdateCccInfrastructureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCccInfrastructureRequest.
 */
...
public class UpdateCccInfrastructureRequest
    ...
    public static class Builder
        ...
        public UpdateCccInfrastructureRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCccInfrastructureRequest(cccInfrastructureId, updateCccInfrastructureDetails, ifMatch, opcRequestId);
        }
    }
