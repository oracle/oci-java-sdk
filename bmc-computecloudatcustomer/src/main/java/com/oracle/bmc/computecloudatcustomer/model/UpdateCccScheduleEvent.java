...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateCccScheduleEvent.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateCccScheduleEvent
    ...
    public static class Builder {
        ...
        public UpdateCccScheduleEvent build() {
            UpdateCccScheduleEvent model =
                    new UpdateCccScheduleEvent(
                            this.description,
                            this.timeStart,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateCccScheduleEvent model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateCccScheduleEvent(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCccScheduleEvent)) {
            return false;
        }

        UpdateCccScheduleEvent other = (UpdateCccScheduleEvent) o;
