...
public class LoggingClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Logging {
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, LoggingClient> {
        ...
        public LoggingClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new LoggingClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public PutLogsResponse putLogs(PutLogsRequest request) {
        ...
        return clientCall(request, PutLogsResponse::builder)
                ...
                .appendPathParam("push")
                .accept("application/json")
                .appendHeader(
                        "timestamp-opc-agent-processing", request.getTimestampOpcAgentProcessing())
                .appendHeader("opc-agent-version", request.getOpcAgentVersion())
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .hasBody()
                .handleResponseHeaderString("opc-request-id", PutLogsResponse.Builder::opcRequestId)
                .callSync();
    }
