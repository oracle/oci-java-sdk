...
/**
 * A single batch of Log Entries. <br>
...
public final class LogEntryBatch extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * Source of the logs that generated the message. This could be the instance name, hostname,
         * or the source used to read the event. For example, "ServerA".
         */
         ...
         * to read the event. For example: "/var/log/application.log".
         */
        ...
        /**
         * The timestamp for all log entries in this batch. This can be considered as the default
         * timestamp for each entry, unless it is overwritten by the entry time. An
    ...
    /**
     * Source of the logs that generated the message. This could be the instance name, hostname, or
     * the source used to read the event. For example, "ServerA".
     */
    @com.fasterxml.jackson.annotation.JsonProperty("source")
    ...
    /**
     * This optional field is useful for specifying the specific sub-resource or input file used to
     * read the event. For example: "/var/log/application.log".
     */
    @com.fasterxml.jackson.annotation.JsonProperty("subject")
    ...
    /**
     * The timestamp for all log entries in this batch. This can be considered as the default
     * timestamp for each entry, unless it is overwritten by the entry time. An RFC3339-formatted
     * date-time string with milliseconds precision.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("defaultlogentrytime")
