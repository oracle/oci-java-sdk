...
public class DeleteScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteScheduleResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteScheduleResponse o) {
        ...
        public DeleteScheduleResponse build() {
            return new DeleteScheduleResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteScheduleResponse)) {
            return false;
        }

        DeleteScheduleResponse other = (DeleteScheduleResponse) o;
