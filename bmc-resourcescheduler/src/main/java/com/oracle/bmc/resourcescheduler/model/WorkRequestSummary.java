...
/**
 * This is the summary information about an asynchronous work request. <br>
...
public final class WorkRequestSummary
    ...
    public static class Builder {
        ...
        /**
         * This is the date and time the work request was created, in the format defined by [RFC
        ...
        /**
         * This is the date and time the work request was started, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         */
        ...
        /**
         * This is the date and time the work request was finished, in the format defined by [RFC
        ...
        /**
         * This is the date and time the work request was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/rfc/rfc3339).
         */
