...
/**
 * This is an input parameter that will be passed as URL query parameter. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = QueryParameter.Builder.class)
...
public final class QueryParameter extends Parameter {
    ...
    public static class Builder {
        ...
        public QueryParameter build() {
            QueryParameter model = new QueryParameter(this.value);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueryParameter model) {
    ...
    @Deprecated
    public QueryParameter(java.util.Map<String, String> value) {
        super();
        this.value = value;
    }
