...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcescheduler/ChangeScheduleCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeScheduleCompartmentRequest.
 */
...
public class ChangeScheduleCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeScheduleCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeScheduleCompartmentRequest(scheduleId, changeScheduleCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
