...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcescheduler/ActivateScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ActivateScheduleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240430")
public class ActivateScheduleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ActivateScheduleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ActivateScheduleRequest o) {
        ...
        /**
         * Build the instance of ActivateScheduleRequest as configured by this builder
         *
         ...
         *
         * @return instance of ActivateScheduleRequest
         */
        public ActivateScheduleRequest build() {
            ActivateScheduleRequest request = buildWithoutInvocationCallback();
        ...
        public ActivateScheduleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ActivateScheduleRequest(scheduleId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateScheduleRequest)) {
            return false;
        }

        ActivateScheduleRequest other = (ActivateScheduleRequest) o;
