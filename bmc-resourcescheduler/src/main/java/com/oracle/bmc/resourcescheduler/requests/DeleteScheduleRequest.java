...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcescheduler/DeleteScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteScheduleRequest.
 */
...
public class DeleteScheduleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteScheduleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteScheduleRequest(scheduleId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().scheduleId(scheduleId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
