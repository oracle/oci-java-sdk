...
public class ChangeScheduleCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeScheduleCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeScheduleCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeScheduleCompartmentResponse build() {
            return new ChangeScheduleCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeScheduleCompartmentResponse)) {
            return false;
        }

        ChangeScheduleCompartmentResponse other = (ChangeScheduleCompartmentResponse) o;
