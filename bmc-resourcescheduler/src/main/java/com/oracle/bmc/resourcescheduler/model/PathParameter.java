...
/**
 * This is an input parameter that will be passed as URL path parameter. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PathParameter.Builder.class)
...
public final class PathParameter extends Parameter {
    ...
    public static class Builder {
        ...
        public PathParameter build() {
            PathParameter model = new PathParameter(this.value);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PathParameter model) {
    ...
    @Deprecated
    public PathParameter(java.util.Map<String, String> value) {
        super();
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PathParameter)) {
            return false;
        }

        PathParameter other = (PathParameter) o;
