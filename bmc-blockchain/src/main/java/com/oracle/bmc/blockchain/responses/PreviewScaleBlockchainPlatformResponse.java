...
public class PreviewScaleBlockchainPlatformResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public String toString() {
        ...
        sb.append(",scaledBlockchainPlatformPreview=")
                .append(String.valueOf(scaledBlockchainPlatformPreview));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PreviewScaleBlockchainPlatformResponse)) {
            return false;
        }

        PreviewScaleBlockchainPlatformResponse other = (PreviewScaleBlockchainPlatformResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.scaledBlockchainPlatformPreview,
                        other.scaledBlockchainPlatformPreview);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.scaledBlockchainPlatformPreview == null
                                ? 43
                                : this.scaledBlockchainPlatformPreview.hashCode());
        return result;
    }
}
