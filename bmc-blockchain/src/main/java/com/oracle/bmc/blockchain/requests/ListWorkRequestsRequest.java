...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * descending. Default order for WORKREQUESTID is ascending. If no value is specified
    ...
    public static class Builder
         ...
         * is descending. Default order for WORKREQUESTID is ascending. If no value is specified
         * TIMESTARTED is default.
         */
        ...
        public ListWorkRequestsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListWorkRequestsRequest(compartmentId, blockchainPlatformId, sortOrder, sortBy,
