...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/ChangeBlockchainPlatformCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeBlockchainPlatformCompartmentRequest.
 */
...
public class ChangeBlockchainPlatformCompartmentRequest
    ...
    public static class Builder
        ...
        public Builder changeBlockchainPlatformCompartmentDetails(
                com.oracle.bmc.blockchain.model.ChangeBlockchainPlatformCompartmentDetails
                        changeBlockchainPlatformCompartmentDetails) {
            this.changeBlockchainPlatformCompartmentDetails =
                    changeBlockchainPlatformCompartmentDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeBlockchainPlatformCompartmentRequest o) {
            blockchainPlatformId(o.getBlockchainPlatformId());
            changeBlockchainPlatformCompartmentDetails(
                    o.getChangeBlockchainPlatformCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeBlockchainPlatformCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeBlockchainPlatformCompartmentRequest
         */
        public ChangeBlockchainPlatformCompartmentRequest build() {
            ChangeBlockchainPlatformCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        public ChangeBlockchainPlatformCompartmentRequest buildWithoutInvocationCallback() {
            ChangeBlockchainPlatformCompartmentRequest request =
                    new ChangeBlockchainPlatformCompartmentRequest();
            request.blockchainPlatformId = blockchainPlatformId;
            request.changeBlockchainPlatformCompartmentDetails =
                    changeBlockchainPlatformCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeBlockchainPlatformCompartmentRequest(blockchainPlatformId, changeBlockchainPlatformCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeBlockchainPlatformCompartmentDetails=")
                .append(String.valueOf(this.changeBlockchainPlatformCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeBlockchainPlatformCompartmentRequest)) {
            return false;
        }

        ChangeBlockchainPlatformCompartmentRequest other =
                (ChangeBlockchainPlatformCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.blockchainPlatformId, other.blockchainPlatformId)
                && java.util.Objects.equals(
                        this.changeBlockchainPlatformCompartmentDetails,
                        other.changeBlockchainPlatformCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeBlockchainPlatformCompartmentDetails == null
                                ? 43
                                : this.changeBlockchainPlatformCompartmentDetails.hashCode());
