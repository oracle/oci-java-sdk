...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/StartBlockchainPlatformExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartBlockchainPlatformRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20191010")
public class StartBlockchainPlatformRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(StartBlockchainPlatformRequest o) {
         ...
         *
         * @return instance of StartBlockchainPlatformRequest
         */
        public StartBlockchainPlatformRequest build() {
            StartBlockchainPlatformRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StartBlockchainPlatformRequest
         */
        public StartBlockchainPlatformRequest buildWithoutInvocationCallback() {
            StartBlockchainPlatformRequest request = new StartBlockchainPlatformRequest();
            request.blockchainPlatformId = blockchainPlatformId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new StartBlockchainPlatformRequest(blockchainPlatformId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartBlockchainPlatformRequest)) {
            return false;
        }

        StartBlockchainPlatformRequest other = (StartBlockchainPlatformRequest) o;
