...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/DeletePeerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePeerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20191010")
public class DeletePeerRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePeerRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeletePeerRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePeerRequest
         */
        public DeletePeerRequest build() {
            DeletePeerRequest request = buildWithoutInvocationCallback();
        ...
        public DeletePeerRequest buildWithoutInvocationCallback() {
            DeletePeerRequest request = new DeletePeerRequest();
            ...
            return request;
            // new DeletePeerRequest(blockchainPlatformId, peerId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePeerRequest)) {
            return false;
        }

        DeletePeerRequest other = (DeletePeerRequest) o;
