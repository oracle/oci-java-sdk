...
public class DeleteBlockchainPlatformConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteBlockchainPlatformConverter.class);

    public static com.oracle.bmc.blockchain.requests.DeleteBlockchainPlatformRequest
            interceptRequest(
                    com.oracle.bmc.blockchain.requests.DeleteBlockchainPlatformRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.blockchain.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.blockchain.responses.DeleteBlockchainPlatformResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.blockchain.responses.DeleteBlockchainPlatformResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.blockchain.responses
                                                        .DeleteBlockchainPlatformResponse.builder()
                                                        .__httpStatusCode__(
