...
public class ScaleBlockchainPlatformResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleBlockchainPlatformResponse)) {
            return false;
        }

        ScaleBlockchainPlatformResponse other = (ScaleBlockchainPlatformResponse) o;
