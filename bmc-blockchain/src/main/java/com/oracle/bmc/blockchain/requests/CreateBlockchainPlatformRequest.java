...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/CreateBlockchainPlatformExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBlockchainPlatformRequest.
 */
...
public class CreateBlockchainPlatformRequest
    ...
    public static class Builder
        ...
        public CreateBlockchainPlatformRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateBlockchainPlatformRequest(createBlockchainPlatformDetails, opcRetryToken, opcRequestId);
        }
    }
