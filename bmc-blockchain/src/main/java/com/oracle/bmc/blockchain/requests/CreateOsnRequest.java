...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/CreateOsnExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOsnRequest.
 */
...
public class CreateOsnRequest
    ...
    public static class Builder
         ...
         * Input payload to create blockchain platform OSN. The payload cannot be empty.
         *
         * @param createOsnDetails the value to set
         * @return this builder instance
         */
