...
public class ChangeBlockchainPlatformCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeBlockchainPlatformCompartmentResponse)) {
            return false;
        }

        ChangeBlockchainPlatformCompartmentResponse other =
                (ChangeBlockchainPlatformCompartmentResponse) o;
