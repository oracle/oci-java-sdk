...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/UpgradeBlockchainPlatformExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpgradeBlockchainPlatformRequest.
 */
...
public class UpgradeBlockchainPlatformRequest
    ...
    public static class Builder
        ...
        public UpgradeBlockchainPlatformRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpgradeBlockchainPlatformRequest(upgradeBlockchainPlatformDetails, blockchainPlatformId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
