...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/blockchain/StopBlockchainPlatformExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StopBlockchainPlatformRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20191010")
public class StopBlockchainPlatformRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(StopBlockchainPlatformRequest o) {
         ...
         *
         * @return instance of StopBlockchainPlatformRequest
         */
        public StopBlockchainPlatformRequest build() {
            StopBlockchainPlatformRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StopBlockchainPlatformRequest
         */
        public StopBlockchainPlatformRequest buildWithoutInvocationCallback() {
            StopBlockchainPlatformRequest request = new StopBlockchainPlatformRequest();
            request.blockchainPlatformId = blockchainPlatformId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new StopBlockchainPlatformRequest(blockchainPlatformId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopBlockchainPlatformRequest)) {
            return false;
        }

        StopBlockchainPlatformRequest other = (StopBlockchainPlatformRequest) o;
