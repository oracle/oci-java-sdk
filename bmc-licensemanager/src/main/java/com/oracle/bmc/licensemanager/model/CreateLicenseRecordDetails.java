...
public final class CreateLicenseRecordDetails
    ...
    public CreateLicenseRecordDetails(
            String displayName,
            Boolean isPerpetual,
    ...
    public static class Builder {
        ...
        public CreateLicenseRecordDetails build() {
            CreateLicenseRecordDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateLicenseRecordDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLicenseRecordDetails)) {
            return false;
        }

        CreateLicenseRecordDetails other = (CreateLicenseRecordDetails) o;
