...
public final class UpdateProductLicenseDetails {
    ...
    public static class Builder {
        ...
        public UpdateProductLicenseDetails build() {
            UpdateProductLicenseDetails __instance__ =
                    new UpdateProductLicenseDetails(images, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateProductLicenseDetails o) {
