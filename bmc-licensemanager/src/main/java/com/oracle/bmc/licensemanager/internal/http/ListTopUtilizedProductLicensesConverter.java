...
public class ListTopUtilizedProductLicensesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTopUtilizedProductLicensesConverter.class);

    public static com.oracle.bmc.licensemanager.requests.ListTopUtilizedProductLicensesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.licensemanager.requests.ListTopUtilizedProductLicensesRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220430").path("topUtilizedProductLicenses");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.licensemanager.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.licensemanager.responses.ListTopUtilizedProductLicensesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
