...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/licensemanager/UpdateLicenseRecordExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateLicenseRecordRequest.
 */
...
public class UpdateLicenseRecordRequest
    ...
    public static class Builder
         ...
         * Details to update a license record entity.
         *
         * @param updateLicenseRecordDetails the value to set
         * @return this builder instance
         */
        ...
        public UpdateLicenseRecordRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateLicenseRecordRequest(licenseRecordId, updateLicenseRecordDetails, ifMatch,
            // opcRequestId);
        }
    }
