...
public class UpdateLicenseRecordResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateLicenseRecordResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLicenseRecordResponse)) {
            return false;
        }

        UpdateLicenseRecordResponse other = (UpdateLicenseRecordResponse) o;
