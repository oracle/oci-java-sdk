...
public class ListTopUtilizedResourcesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.licensemanager.model.TopUtilizedResourceCollection
            getTopUtilizedResourceCollection() {
        return topUtilizedResourceCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder topUtilizedResourceCollection(
                com.oracle.bmc.licensemanager.model.TopUtilizedResourceCollection
                        topUtilizedResourceCollection) {
            this.topUtilizedResourceCollection = topUtilizedResourceCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",topUtilizedResourceCollection=")
                .append(String.valueOf(topUtilizedResourceCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTopUtilizedResourcesResponse)) {
            return false;
        }

        ListTopUtilizedResourcesResponse other = (ListTopUtilizedResourcesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.topUtilizedResourceCollection, other.topUtilizedResourceCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.topUtilizedResourceCollection == null
                                ? 43
                                : this.topUtilizedResourceCollection.hashCode());
        return result;
    }
}
