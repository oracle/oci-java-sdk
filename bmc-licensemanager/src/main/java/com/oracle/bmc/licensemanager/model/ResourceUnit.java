...
public enum ResourceUnit implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    static {
        ...
        for (ResourceUnit v : ResourceUnit.values()) {
    ...
    public static ResourceUnit create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'ResourceUnit', returning UnknownEnumValue",
                key);
