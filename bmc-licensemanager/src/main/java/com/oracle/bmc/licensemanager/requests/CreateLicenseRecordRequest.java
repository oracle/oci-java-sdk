...
public class CreateLicenseRecordRequest
    ...
    public com.oracle.bmc.licensemanager.model.CreateLicenseRecordDetails getBody$() {
        return createLicenseRecordDetails;
    }
    ...
    public static class Builder
        ...
        public Builder copy(CreateLicenseRecordRequest o) {
            createLicenseRecordDetails(o.getCreateLicenseRecordDetails());
         ...
         */
        public CreateLicenseRecordRequest build() {
            CreateLicenseRecordRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.licensemanager.model.CreateLicenseRecordDetails body) {
