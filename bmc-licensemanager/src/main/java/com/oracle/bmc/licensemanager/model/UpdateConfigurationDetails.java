...
public final class UpdateConfigurationDetails {
    ...
    public static class Builder {
        ...
        public UpdateConfigurationDetails build() {
            UpdateConfigurationDetails __instance__ = new UpdateConfigurationDetails(emailIds);
        ...
        public Builder copy(UpdateConfigurationDetails o) {
            Builder copiedBuilder = emailIds(o.getEmailIds());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.emailIds, other.emailIds)
