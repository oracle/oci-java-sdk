...
public class GetLicenseRecordResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetLicenseRecordResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetLicenseRecordResponse> {
         ...
         */
        @Override
        public Builder copy(GetLicenseRecordResponse o) {
         ...
         */
        @Override
        public GetLicenseRecordResponse build() {
            return new GetLicenseRecordResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, licenseRecord);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLicenseRecordResponse)) {
            return false;
        }

        GetLicenseRecordResponse other = (GetLicenseRecordResponse) o;
