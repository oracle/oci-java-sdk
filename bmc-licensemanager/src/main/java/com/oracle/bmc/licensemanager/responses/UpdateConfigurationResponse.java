...
public class UpdateConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.licensemanager.model.Configuration configuration;
     ...
     * @return the value
     */
    public com.oracle.bmc.licensemanager.model.Configuration getConfiguration() {
    ...
    private UpdateConfigurationResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.licensemanager.model.Configuration configuration) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateConfigurationResponse> {
