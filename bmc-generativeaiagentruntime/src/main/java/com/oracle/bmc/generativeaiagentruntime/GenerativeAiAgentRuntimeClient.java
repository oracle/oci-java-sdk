...
import com.oracle.bmc.generativeaiagentruntime.internal.http.*;
...
public class GenerativeAiAgentRuntimeClient implements GenerativeAiAgentRuntime {
    /**
     ...
     */
    protected GenerativeAiAgentRuntimeClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public GenerativeAiAgentRuntimeClient build(
            ...
            return new GenerativeAiAgentRuntimeClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public RetrieveMetadataResponse retrieveMetadata(RetrieveMetadataRequest request) {
        LOG.trace("Called retrieveMetadata");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RetrieveMetadataResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRetrieveMetadataDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
