...
/**
 * The location of the OCI Database that the agent will use. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OciDatabaseSourceLocation.Builder.class)
...
public final class OciDatabaseSourceLocation extends SourceLocation {
    ...
    public static class Builder {
        ...
        public OciDatabaseSourceLocation build() {
            OciDatabaseSourceLocation model =
                    new OciDatabaseSourceLocation(this.id, this.functionName, this.url);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciDatabaseSourceLocation model) {
    ...
    @Deprecated
    public OciDatabaseSourceLocation(String id, String functionName, String url) {
        super();
        this.id = id;
        this.functionName = functionName;
        this.url = url;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OciDatabaseSourceLocation(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciDatabaseSourceLocation)) {
            return false;
        }

        OciDatabaseSourceLocation other = (OciDatabaseSourceLocation) o;
