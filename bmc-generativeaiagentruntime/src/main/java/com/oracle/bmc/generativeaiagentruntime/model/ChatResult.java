...
public final class ChatResult extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"message", "traces"})
    public ChatResult(Message message, java.util.List<Trace> traces) {
        super();
    ...
    public static class Builder {
        ...
        public ChatResult build() {
            ChatResult model = new ChatResult(this.message, this.traces);
