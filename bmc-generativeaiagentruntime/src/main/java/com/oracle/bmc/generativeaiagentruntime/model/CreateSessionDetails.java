...
/**
 * Information about the new session. <br>
...
public final class CreateSessionDetails
    ...
    public CreateSessionDetails(String displayName, String description) {
        super();
    ...
    public static class Builder {
        /**
         * The name of the session. A session names doesn't have to be unique and you can change the
         * session name later.
         */
        ...
        public CreateSessionDetails build() {
            CreateSessionDetails model =
                    new CreateSessionDetails(this.displayName, this.description);
