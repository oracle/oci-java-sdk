...
public final class InstanceCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public InstanceCollection(java.util.List<InstanceSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         **/
        public Builder items(java.util.List<InstanceSummary> items) {
            this.items = items;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<InstanceSummary> items;

    /**
     * List of instances.
     * @return the value
     **/
    public java.util.List<InstanceSummary> getItems() {
        return items;
    }
