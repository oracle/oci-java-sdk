...
/**
 * Summary information about an Instance. <br>
...
public final class InstanceSummary
    ...
    public static class Builder {
         ...
         *
         * <p>Example: {@code https://idcs-1234567890.identity.oraclecloud.com}
         */
         ...
         *
         * <p>Example: {@code {"orcl-cloud": {"example-key": "example-value"}}}
         */
    ...
    /** The current state of the Instance. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Instance.LifecycleState lifecycleState;
