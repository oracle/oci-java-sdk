...
public class CancelWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelWorkRequestResponse> {
        ...
        public CancelWorkRequestResponse build() {
            return new CancelWorkRequestResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
