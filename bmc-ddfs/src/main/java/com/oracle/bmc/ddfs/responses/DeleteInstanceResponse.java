...
public class DeleteInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteInstanceResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteInstanceResponse)) {
            return false;
        }
