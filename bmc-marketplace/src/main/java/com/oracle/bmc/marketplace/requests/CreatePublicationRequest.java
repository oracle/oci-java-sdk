...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplace/CreatePublicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePublicationRequest.
 */
...
public class CreatePublicationRequest
     ...
     * The details for creating the publication.
     */
    public com.oracle.bmc.marketplace.model.CreatePublicationDetails getCreatePublicationDetails() {
    ...
    public static class Builder
        ...
        /**
         * The details for creating the publication.
         * @param createPublicationDetails the value to set
         * @return this builder instance
         */
        public Builder createPublicationDetails(
                com.oracle.bmc.marketplace.model.CreatePublicationDetails
        ...
        public CreatePublicationRequest buildWithoutInvocationCallback() {
            ...
            request.createPublicationDetails = createPublicationDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreatePublicationRequest(createPublicationDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createPublicationDetails=")
                .append(String.valueOf(this.createPublicationDetails));
    ...
    public boolean equals(Object o) {
        ...
        CreatePublicationRequest other = (CreatePublicationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createPublicationDetails, other.createPublicationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createPublicationDetails == null
                                ? 43
                                : this.createPublicationDetails.hashCode());
        result =
                (result * PRIME)
