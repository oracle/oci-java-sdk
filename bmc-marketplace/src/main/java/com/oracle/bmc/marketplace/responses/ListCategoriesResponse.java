...
public class ListCategoriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.marketplace.model.CategorySummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.marketplace.model.CategorySummary> getItems() {
        return items;
    }
    ...
    private ListCategoriesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.marketplace.model.CategorySummary> items) {
