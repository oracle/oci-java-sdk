...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplace/CreateAcceptedAgreementExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAcceptedAgreementRequest.
 */
...
public class CreateAcceptedAgreementRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAcceptedAgreementRequest o) {
            createAcceptedAgreementDetails(o.getCreateAcceptedAgreementDetails());
         ...
         */
        public CreateAcceptedAgreementRequest build() {
            CreateAcceptedAgreementRequest request = buildWithoutInvocationCallback();
