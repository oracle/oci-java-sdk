...
public class UpdateAcceptedAgreementResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateAcceptedAgreementResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateAcceptedAgreementResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAcceptedAgreementResponse)) {
            return false;
        }

        UpdateAcceptedAgreementResponse other = (UpdateAcceptedAgreementResponse) o;
