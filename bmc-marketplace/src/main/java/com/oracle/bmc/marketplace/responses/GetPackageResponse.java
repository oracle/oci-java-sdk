...
public class GetPackageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public Builder copy(GetPackageResponse o) {
            ...
            etag(o.getEtag());
            listingPackage(o.getListingPackage());
        ...
        public GetPackageResponse build() {
            return new GetPackageResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, listingPackage);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",listingPackage=").append(String.valueOf(listingPackage));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.listingPackage, other.listingPackage);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.listingPackage == null ? 43 : this.listingPackage.hashCode());
        return result;
    }
}
