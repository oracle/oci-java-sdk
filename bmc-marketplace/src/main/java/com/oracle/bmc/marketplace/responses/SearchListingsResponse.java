...
public class SearchListingsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SearchListingsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchListingsResponse)) {
            return false;
        }

        SearchListingsResponse other = (SearchListingsResponse) o;
