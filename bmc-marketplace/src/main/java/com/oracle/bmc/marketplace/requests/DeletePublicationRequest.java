...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplace/DeletePublicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePublicationRequest.
 */
...
public class DeletePublicationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePublicationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePublicationRequest o) {
         ...
         *
         * @return instance of DeletePublicationRequest
         */
        public DeletePublicationRequest build() {
            DeletePublicationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePublicationRequest
         */
        public DeletePublicationRequest buildWithoutInvocationCallback() {
            DeletePublicationRequest request = new DeletePublicationRequest();
            request.publicationId = publicationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeletePublicationRequest(publicationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePublicationRequest)) {
            return false;
        }

        DeletePublicationRequest other = (DeletePublicationRequest) o;
