...
public class AccountClient implements Account {
    ...
    public GetLaunchEligibilityResponse getLaunchEligibility(GetLaunchEligibilityRequest request) {
        LOG.trace("Called getLaunchEligibility");
        final GetLaunchEligibilityRequest interceptedRequest =
    ...
    public GetThirdPartyPaidListingEligibilityResponse getThirdPartyPaidListingEligibility(
        ...
        LOG.trace("Called getThirdPartyPaidListingEligibility");
        final GetThirdPartyPaidListingEligibilityRequest interceptedRequest =
                GetThirdPartyPaidListingEligibilityConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
