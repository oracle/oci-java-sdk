...
public class AccountClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Account {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AccountClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, AccountClient> {
        ...
        public AccountClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new AccountClient(this, authenticationDetailsProvider);
        }
    }
    ...
    @Override
    public GetLaunchEligibilityResponse getLaunchEligibility(GetLaunchEligibilityRequest request) {
        Objects.requireNonNull(request.getCompartmentId(), "compartmentId is required");

        Objects.requireNonNull(request.getImageId(), "imageId is required");

        return clientCall(request, GetLaunchEligibilityResponse::builder)
                .logger(LOG, "getLaunchEligibility")
                .serviceDetails(
                        "Account",
                        "GetLaunchEligibility",
                        "https://docs.oracle.com/iaas/api/#/en/marketplace/20181001/LaunchEligibility/GetLaunchEligibility")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(GetLaunchEligibilityRequest::builder)
                .basePath("/20181001")
                .appendPathParam("launchEligibility")
    ...
    @Override
    public GetThirdPartyPaidListingEligibilityResponse getThirdPartyPaidListingEligibility(
            GetThirdPartyPaidListingEligibilityRequest request) {
        Objects.requireNonNull(request.getCompartmentId(), "compartmentId is required");

        return clientCall(request, GetThirdPartyPaidListingEligibilityResponse::builder)
                .logger(LOG, "getThirdPartyPaidListingEligibility")
                .serviceDetails(
                        "Account",
                ...
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(GetThirdPartyPaidListingEligibilityRequest::builder)
                .basePath("/20181001")
                .appendPathParam("thirdPartyPaidListingEligibility")
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .accept("application/json")
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBody(
