...
public class GetPublicationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPublicationResponse> {
         ...
         * @return this builder
         */
        public Builder publication(com.oracle.bmc.marketplace.model.Publication publication) {
            this.publication = publication;
            return this;
        }
        ...
        public GetPublicationResponse build() {
            return new GetPublicationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, publication);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",publication=").append(String.valueOf(publication));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        GetPublicationResponse other = (GetPublicationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.publication, other.publication);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.publication == null ? 43 : this.publication.hashCode());
        return result;
    }
}
