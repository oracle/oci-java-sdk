...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplace/ExportListingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExportListingRequest.
 */
...
public class ExportListingRequest
    ...
    public static class Builder
        ...
        public ExportListingRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ExportListingRequest(listingId, packageVersion, exportPackageDetails, opcRetryToken, opcRequestId);
        }
    }
