...
public class ListAcceptedAgreementsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListAcceptedAgreementsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListAcceptedAgreementsResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAcceptedAgreementsResponse)) {
            return false;
        }

        ListAcceptedAgreementsResponse other = (ListAcceptedAgreementsResponse) o;
