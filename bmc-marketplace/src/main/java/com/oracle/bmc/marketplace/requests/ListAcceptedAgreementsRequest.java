...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplace/ListAcceptedAgreementsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAcceptedAgreementsRequest.
 */
...
public class ListAcceptedAgreementsRequest
    ...
    public static class Builder
        ...
        public ListAcceptedAgreementsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListAcceptedAgreementsRequest(compartmentId, displayName, listingId, packageVersion, acceptedAgreementId, opcRequestId, sortBy, sortOrder, limit, page);
        }
    }
