...
/**
 * PostgreSQL database system management policy update details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagementPolicyDetails.Builder.class)
...
public final class ManagementPolicyDetails
    ...
    public static class Builder {
         ...
         *
         * <p>This string is of the format: "{day-of-week} {time-of-day}". "{day-of-week}" is a
         * case-insensitive string like "mon", "tue", &c. "{time-of-day}" is the "Time" portion of
         * an RFC3339-formatted timestamp. Any second or sub-second time data will be truncated to
         * zero.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementPolicyDetails model) {
     ...
     *
     * <p>This string is of the format: "{day-of-week} {time-of-day}". "{day-of-week}" is a
     * case-insensitive string like "mon", "tue", &c. "{time-of-day}" is the "Time" portion of an
     * RFC3339-formatted timestamp. Any second or sub-second time data will be truncated to zero.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("maintenanceWindowStart")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementPolicyDetails)) {
            return false;
        }
