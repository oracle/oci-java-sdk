...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/GetBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBackupRequest.
 */
...
public class GetBackupRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetBackupRequest(backupId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().backupId(backupId).opcRequestId(opcRequestId);
    }
