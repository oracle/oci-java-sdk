...
/**
 * The information to update Configuration. <br>
...
public final class UpdateConfigurationDetails
    ...
    public UpdateConfigurationDetails(String displayName, String description) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateConfigurationDetails build() {
            UpdateConfigurationDetails model =
                    new UpdateConfigurationDetails(this.displayName, this.description);
