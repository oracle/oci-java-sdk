...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ListConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListConfigurationsRequest.
 */
...
public class ListConfigurationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListConfigurationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListConfigurationsRequest(compartmentId, lifecycleState, configType, displayName, dbVersion, shape, configurationId, instanceOcpuCount, instanceMemorySizeInGBs, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
