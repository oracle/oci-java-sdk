...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateReplicationConfigDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateReplicationConfigDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRpoEnforced", "rpoInSeconds"})
    public CreateReplicationConfigDetails(Boolean isRpoEnforced, Long rpoInSeconds) {
        super();
    ...
    public static class Builder {
        ...
        public CreateReplicationConfigDetails build() {
            CreateReplicationConfigDetails model =
                    new CreateReplicationConfigDetails(this.isRpoEnforced, this.rpoInSeconds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateReplicationConfigDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateReplicationConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateReplicationConfigDetails)) {
            return false;
        }

        CreateReplicationConfigDetails other = (CreateReplicationConfigDetails) o;
