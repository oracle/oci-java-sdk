...
public class PostgresqlPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDbSystemReplicas operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListDbSystemReplicasResponse> listDbSystemReplicasResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDbSystemReplicasRequest.Builder, ListDbSystemReplicasRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psql.model.DbSystemReplicaSummary} objects
     * contained in responses from the listDbSystemReplicas operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psql.model.DbSystemReplicaSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.psql.model.DbSystemReplicaSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListDbSystemReplicasRequest.Builder, ListDbSystemReplicasRequest,
                ListDbSystemReplicasResponse, com.oracle.bmc.psql.model.DbSystemReplicaSummary>(
                new java.util.function.Supplier<ListDbSystemReplicasRequest.Builder>() {
                    @Override
                    public ListDbSystemReplicasRequest.Builder get() {
                        return ListDbSystemReplicasRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listInsightCapabilities operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListInsightCapabilitiesResponse> listInsightCapabilitiesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListInsightCapabilitiesRequest.Builder, ListInsightCapabilitiesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psql.model.InsightCapabilitySummary} objects
     * contained in responses from the listInsightCapabilities operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psql.model.InsightCapabilitySummary} objects
     * contained in responses received from the service.
     */
