...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = NoneBackupPolicy.Builder.class)
...
public final class NoneBackupPolicy extends BackupPolicy {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NoneBackupPolicy)) {
            return false;
        }

        NoneBackupPolicy other = (NoneBackupPolicy) o;
