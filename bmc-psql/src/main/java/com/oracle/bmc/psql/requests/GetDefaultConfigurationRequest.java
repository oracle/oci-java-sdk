...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/GetDefaultConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDefaultConfigurationRequest.
 */
...
public class GetDefaultConfigurationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDefaultConfigurationRequest, java.lang.Void> {
        ...
        public Builder copy(GetDefaultConfigurationRequest o) {
            defaultConfigurationId(o.getDefaultConfigurationId());
        ...
        /**
         * Build the instance of GetDefaultConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDefaultConfigurationRequest
         */
        public GetDefaultConfigurationRequest build() {
            GetDefaultConfigurationRequest request = buildWithoutInvocationCallback();
        ...
        public GetDefaultConfigurationRequest buildWithoutInvocationCallback() {
            ...
            request.defaultConfigurationId = defaultConfigurationId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDefaultConfigurationRequest(defaultConfigurationId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        GetDefaultConfigurationRequest other = (GetDefaultConfigurationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.defaultConfigurationId, other.defaultConfigurationId)
        ...
        result =
                (result * PRIME)
                        + (this.defaultConfigurationId == null
                                ? 43
                                : this.defaultConfigurationId.hashCode());
