...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ShapeCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ShapeCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public ShapeCollection(java.util.List<ShapeSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public ShapeCollection build() {
            ShapeCollection model = new ShapeCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShapeCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShapeCollection)) {
            return false;
        }

        ShapeCollection other = (ShapeCollection) o;
