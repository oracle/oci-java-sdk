...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ChangeRoleToStandaloneExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeRoleToStandaloneRequest.
 */
...
public class ChangeRoleToStandaloneRequest
    ...
    public static class Builder
        ...
        public ChangeRoleToStandaloneRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeRoleToStandaloneRequest(changeRoleToStandaloneDetails, dbSystemId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
