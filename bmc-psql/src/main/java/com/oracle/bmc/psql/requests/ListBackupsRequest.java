...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ListBackupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBackupsRequest.
 */
...
public class ListBackupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListBackupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListBackupsRequest(compartmentId, timeStarted, timeEnded, lifecycleState, displayName, backupId, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
