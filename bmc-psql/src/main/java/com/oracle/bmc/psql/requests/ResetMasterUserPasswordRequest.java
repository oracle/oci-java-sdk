...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ResetMasterUserPasswordExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResetMasterUserPasswordRequest.
 */
...
public class ResetMasterUserPasswordRequest
    ...
    public static class Builder
        ...
        public ResetMasterUserPasswordRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ResetMasterUserPasswordRequest(dbSystemId, resetMasterUserPasswordDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
