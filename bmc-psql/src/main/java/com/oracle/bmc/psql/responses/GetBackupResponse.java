...
public class GetBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.psql.model.Backup backup;
     ...
     * @return the value
     */
    public com.oracle.bmc.psql.model.Backup getBackup() {
        return backup;
    }
    ...
    private GetBackupResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.psql.model.Backup backup) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder backup(com.oracle.bmc.psql.model.Backup backup) {
            this.backup = backup;
            return this;
        }
        ...
        public GetBackupResponse build() {
            return new GetBackupResponse(__httpStatusCode__, headers, etag, opcRequestId, backup);
        }
    }
