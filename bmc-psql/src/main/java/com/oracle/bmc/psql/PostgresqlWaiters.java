...
public class PostgresqlWaiters {
    ...
    public PostgresqlWaiters(
            java.util.concurrent.ExecutorService executorService, Postgresql client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetBackupRequest, GetBackupResponse> forBackup(
            ...
            com.oracle.bmc.psql.model.Backup.LifecycleState... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetBackupRequest, GetBackupResponse> forBackup(
            GetBackupRequest request,
            com.oracle.bmc.psql.model.Backup.LifecycleState targetState,
    ...
    private com.oracle.bmc.waiter.Waiter<GetBackupRequest, GetBackupResponse> forBackup(
            ...
            final com.oracle.bmc.psql.model.Backup.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.psql.model.Backup.LifecycleState> targetStatesSet =
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.psql.model.Backup.LifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetConfigurationRequest, GetConfigurationResponse>
            forConfiguration(
                    ...
                    com.oracle.bmc.psql.model.Configuration.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetConfigurationRequest, GetConfigurationResponse>
            forConfiguration(
                    GetConfigurationRequest request,
                    com.oracle.bmc.psql.model.Configuration.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetConfigurationRequest, GetConfigurationResponse>
            forConfiguration(
                    ...
                    final com.oracle.bmc.psql.model.Configuration.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.psql.model.Configuration.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.psql.model.Configuration.LifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetDbSystemRequest, GetDbSystemResponse> forDbSystem(
            ...
            com.oracle.bmc.psql.model.DbSystem.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetDbSystemRequest, GetDbSystemResponse> forDbSystem(
            GetDbSystemRequest request,
            com.oracle.bmc.psql.model.DbSystem.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetDbSystemRequest, GetDbSystemResponse> forDbSystem(
            ...
            final com.oracle.bmc.psql.model.DbSystem.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.psql.model.DbSystem.LifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.psql.model.DbSystem.LifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forDefaultConfiguration(
                    GetDefaultConfigurationRequest request,
                    com.oracle.bmc.psql.model.DefaultConfiguration.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forDefaultConfiguration(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forDefaultConfiguration(
                    GetDefaultConfigurationRequest request,
                    com.oracle.bmc.psql.model.DefaultConfiguration.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for DefaultConfiguration.
    private com.oracle.bmc.waiter.Waiter<
                    GetDefaultConfigurationRequest, GetDefaultConfigurationResponse>
            forDefaultConfiguration(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetDefaultConfigurationRequest request,
                    final com.oracle.bmc.psql.model.DefaultConfiguration.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.psql.model.DefaultConfiguration.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetDefaultConfigurationRequest, GetDefaultConfigurationResponse>() {
                            @Override
                            public GetDefaultConfigurationResponse apply(
                                    GetDefaultConfigurationRequest request) {
                                return client.getDefaultConfiguration(request);
                            }
                        },
                        new java.util.function.Predicate<GetDefaultConfigurationResponse>() {
                            @Override
                            public boolean test(GetDefaultConfigurationResponse response) {
                                return targetStatesSet.contains(
                                        response.getDefaultConfiguration().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.psql.model.DefaultConfiguration.LifecycleState
                                        .Deleted)),
                request);
    }
