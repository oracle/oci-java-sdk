...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/GetConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetConfigurationRequest.
 */
...
public class GetConfigurationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetConfigurationRequest(configurationId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().configurationId(configurationId).opcRequestId(opcRequestId);
    }
