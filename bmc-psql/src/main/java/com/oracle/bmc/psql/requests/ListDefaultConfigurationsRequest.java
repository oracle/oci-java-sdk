...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ListDefaultConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDefaultConfigurationsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220915")
public class ListDefaultConfigurationsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDefaultConfigurationsRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.psql.model.Configuration.LifecycleState lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDefaultConfigurationsRequest o) {
        ...
        /**
         * Build the instance of ListDefaultConfigurationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDefaultConfigurationsRequest
         */
        public ListDefaultConfigurationsRequest build() {
            ListDefaultConfigurationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDefaultConfigurationsRequest
         */
        public ListDefaultConfigurationsRequest buildWithoutInvocationCallback() {
            ListDefaultConfigurationsRequest request = new ListDefaultConfigurationsRequest();
            ...
            return request;
            // new ListDefaultConfigurationsRequest(lifecycleState, displayName, dbVersion, shape, instanceOcpuCount, instanceMemorySizeInGBs, configurationId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDefaultConfigurationsRequest)) {
            return false;
        }

        ListDefaultConfigurationsRequest other = (ListDefaultConfigurationsRequest) o;
