...
/**
 * List of DB Configuration Values. <br>
...
public final class ConfigurationDetails
    ...
    public ConfigurationDetails(java.util.List<ConfigParams> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<ConfigParams> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<ConfigParams> items) {
            this.items = items;
        ...
        public ConfigurationDetails build() {
            ConfigurationDetails model = new ConfigurationDetails(this.items);
    ...
    /** List of ConfigParms object. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<ConfigParams> items;
     ...
     * @return the value
     */
    public java.util.List<ConfigParams> getItems() {
        return items;
    }
