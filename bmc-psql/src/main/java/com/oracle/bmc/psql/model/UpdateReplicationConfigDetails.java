...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateReplicationConfigDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateReplicationConfigDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRpoEnforced", "rpoInSeconds"})
    public UpdateReplicationConfigDetails(Boolean isRpoEnforced, Long rpoInSeconds) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateReplicationConfigDetails build() {
            UpdateReplicationConfigDetails model =
                    new UpdateReplicationConfigDetails(this.isRpoEnforced, this.rpoInSeconds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateReplicationConfigDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateReplicationConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReplicationConfigDetails)) {
            return false;
        }

        UpdateReplicationConfigDetails other = (UpdateReplicationConfigDetails) o;
