...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = PatchDbSystemDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class PatchDbSystemDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public PatchDbSystemDetails(java.util.List<PatchInstruction> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public PatchDbSystemDetails build() {
            PatchDbSystemDetails model = new PatchDbSystemDetails(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchDbSystemDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PatchDbSystemDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchDbSystemDetails)) {
            return false;
        }

        PatchDbSystemDetails other = (PatchDbSystemDetails) o;
