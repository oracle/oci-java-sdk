...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psql/ChangeConfigurationCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeConfigurationCompartmentRequest.
 */
...
public class ChangeConfigurationCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeConfigurationCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeConfigurationCompartmentRequest(configurationId, changeConfigurationCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
