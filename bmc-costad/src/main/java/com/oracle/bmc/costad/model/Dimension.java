...
/**
 * The dimension used for filtering. Available dimensions are: "service", "skuName",
 * "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "tenantName,
 * "tenantId", "platform", "region", "logicalAd", "resourceId". For example: {@code [{value:
 * "COMPUTE", key: "service"}]} <br>
...
public final class Dimension extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public Dimension build() {
            Dimension model = new Dimension(this.key, this.value);
