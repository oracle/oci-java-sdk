...
public final class CostAnomalyEventCollection
    ...
    public CostAnomalyEventCollection(java.util.List<CostAnomalyEventSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<CostAnomalyEventSummary> items;
         ...
         * @return this builder
         **/
        public Builder items(java.util.List<CostAnomalyEventSummary> items) {
            this.items = items;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<CostAnomalyEventSummary> items;

    /**
     * A page of CostAnomalyMonitorSummary objects.
     * @return the value
     **/
    public java.util.List<CostAnomalyEventSummary> getItems() {
        return items;
    }
