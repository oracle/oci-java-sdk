...
public class CostAdPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listCostAlertSubscriptions operation. This iterable
    ...
    public Iterable<ListCostAlertSubscriptionsResponse> listCostAlertSubscriptionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListCostAlertSubscriptionsRequest.Builder, ListCostAlertSubscriptionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.costad.model.CostAlertSubscriptionSummary} objects
     * contained in responses from the listCostAlertSubscriptions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.costad.model.CostAlertSubscriptionSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.costad.model.CostAlertSubscriptionSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                new java.util.function.Function<
                        ...
                        java.util.List<
                                com.oracle.bmc.costad.model.CostAlertSubscriptionSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.costad.model.CostAlertSubscriptionSummary>
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listCostAnomalyEvents operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListCostAnomalyEventsResponse> listCostAnomalyEventsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListCostAnomalyEventsRequest.Builder, ListCostAnomalyEventsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.costad.model.CostAnomalyEventSummary} objects
     * contained in responses from the listCostAnomalyEvents operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.costad.model.CostAnomalyEventSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.costad.model.CostAnomalyEventSummary>
            listCostAnomalyEventsRecordIterator(final ListCostAnomalyEventsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListCostAnomalyEventsRequest.Builder, ListCostAnomalyEventsRequest,
                ListCostAnomalyEventsResponse, com.oracle.bmc.costad.model.CostAnomalyEventSummary>(
                new java.util.function.Supplier<ListCostAnomalyEventsRequest.Builder>() {
                    @Override
                    public ListCostAnomalyEventsRequest.Builder get() {
                        return ListCostAnomalyEventsRequest.builder().copy(request);
                ...
                new java.util.function.Function<
                        ListCostAnomalyEventsResponse,
                        java.util.List<com.oracle.bmc.costad.model.CostAnomalyEventSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.costad.model.CostAnomalyEventSummary>
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listCostAnomalyMonitors operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListCostAnomalyMonitorsResponse> listCostAnomalyMonitorsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListCostAnomalyMonitorsRequest.Builder, ListCostAnomalyMonitorsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.costad.model.CostAnomalyMonitorSummary} objects
     * contained in responses from the listCostAnomalyMonitors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.costad.model.CostAnomalyMonitorSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.costad.model.CostAnomalyMonitorSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                new java.util.function.Function<
                        ListCostAnomalyMonitorsResponse,
                        java.util.List<com.oracle.bmc.costad.model.CostAnomalyMonitorSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.costad.model.CostAnomalyMonitorSummary>
