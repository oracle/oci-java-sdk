...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CostAnomalyMonitorSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CostAnomalyMonitorSummary
    ...
    public CostAnomalyMonitorSummary(
            String id,
            String compartmentId,
            String name,
            MonitorType type,
            String description,
            CostAnomalyMonitor.LifecycleState lifecycleState,
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder type(MonitorType type) {
            this.type = type;
        ...
        private CostAnomalyMonitor.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(CostAnomalyMonitor.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public CostAnomalyMonitorSummary build() {
            CostAnomalyMonitorSummary model =
                    new CostAnomalyMonitorSummary(
                            this.id,
                            this.compartmentId,
                            this.name,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CostAnomalyMonitorSummary model) {
    ...
    /** The current state of the cost monitor. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final CostAnomalyMonitor.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public CostAnomalyMonitor.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CostAnomalyMonitorSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CostAnomalyMonitorSummary)) {
            return false;
        }

        CostAnomalyMonitorSummary other = (CostAnomalyMonitorSummary) o;
