...
public class SummarizeCostAnomalyEventAnalyticsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SummarizeCostAnomalyEventAnalyticsConverter.class);

    public static com.oracle.bmc.costad.requests.SummarizeCostAnomalyEventAnalyticsRequest
            interceptRequest(
                    com.oracle.bmc.costad.requests.SummarizeCostAnomalyEventAnalyticsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.costad.requests.SummarizeCostAnomalyEventAnalyticsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20190111").path("costAnomalyEventAnalytics");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.costad.responses.SummarizeCostAnomalyEventAnalyticsResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.costad.responses
                                            .SummarizeCostAnomalyEventAnalyticsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.costad.responses.SummarizeCostAnomalyEventAnalyticsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.costAnomalyEventAnalyticCollection(response.getItem());
