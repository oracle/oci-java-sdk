...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waf/ListWebAppFirewallPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWebAppFirewallPoliciesRequest.
 */
...
public class ListWebAppFirewallPoliciesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListWebAppFirewallPoliciesRequest
         */
        public ListWebAppFirewallPoliciesRequest buildWithoutInvocationCallback() {
            ListWebAppFirewallPoliciesRequest request = new ListWebAppFirewallPoliciesRequest();
            ...
            return request;
            // new ListWebAppFirewallPoliciesRequest(compartmentId, lifecycleState, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWebAppFirewallPoliciesRequest)) {
            return false;
        }

        ListWebAppFirewallPoliciesRequest other = (ListWebAppFirewallPoliciesRequest) o;
