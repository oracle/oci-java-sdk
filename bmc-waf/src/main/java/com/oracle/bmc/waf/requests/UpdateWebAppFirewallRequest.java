...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waf/UpdateWebAppFirewallExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateWebAppFirewallRequest.
 */
...
public class UpdateWebAppFirewallRequest
    ...
    public com.oracle.bmc.waf.model.UpdateWebAppFirewallDetails getBody$() {
        return updateWebAppFirewallDetails;
    }
    ...
    public static class Builder
        ...
        public Builder updateWebAppFirewallDetails(
                com.oracle.bmc.waf.model.UpdateWebAppFirewallDetails updateWebAppFirewallDetails) {
            this.updateWebAppFirewallDetails = updateWebAppFirewallDetails;
            return this;
        }
        ...
        public Builder copy(UpdateWebAppFirewallRequest o) {
            ...
            updateWebAppFirewallDetails(o.getUpdateWebAppFirewallDetails());
         ...
         */
        public UpdateWebAppFirewallRequest build() {
            UpdateWebAppFirewallRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.waf.model.UpdateWebAppFirewallDetails body) {
            updateWebAppFirewallDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateWebAppFirewallRequest
         */
        public UpdateWebAppFirewallRequest buildWithoutInvocationCallback() {
            UpdateWebAppFirewallRequest request = new UpdateWebAppFirewallRequest();
            request.webAppFirewallId = webAppFirewallId;
            request.updateWebAppFirewallDetails = updateWebAppFirewallDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateWebAppFirewallDetails=")
                .append(String.valueOf(this.updateWebAppFirewallDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWebAppFirewallRequest)) {
            return false;
        }

        UpdateWebAppFirewallRequest other = (UpdateWebAppFirewallRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.webAppFirewallId, other.webAppFirewallId)
                && java.util.Objects.equals(
                        this.updateWebAppFirewallDetails, other.updateWebAppFirewallDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateWebAppFirewallDetails == null
                                ? 43
                                : this.updateWebAppFirewallDetails.hashCode());
