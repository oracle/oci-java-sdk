...
/**
 * The information to be updated for NetworkAddressListVcnAddresses. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateNetworkAddressListVcnAddressesDetails.Builder.class)
...
public final class UpdateNetworkAddressListVcnAddressesDetails
    ...
    @Deprecated
    public UpdateNetworkAddressListVcnAddressesDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNetworkAddressListVcnAddressesDetails)) {
            return false;
        }
