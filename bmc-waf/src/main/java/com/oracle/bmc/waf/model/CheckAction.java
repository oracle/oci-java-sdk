 ...
 * just emits a log message documenting result of rule execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CheckAction.Builder.class)
...
public final class CheckAction extends Action {
    ...
    public static class Builder {
        ...
        public CheckAction build() {
            CheckAction model = new CheckAction(this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CheckAction model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckAction)) {
            return false;
        }

        CheckAction other = (CheckAction) o;
