...
public class StaticTextHttpResponseBody extends HttpResponseBody {
    ...
    public static class Builder {
        ...
        public StaticTextHttpResponseBody build() {
            StaticTextHttpResponseBody __instance__ = new StaticTextHttpResponseBody(text);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StaticTextHttpResponseBody o) {
