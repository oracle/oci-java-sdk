...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AllowAction.Builder.class)
...
public final class AllowAction extends Action {
    ...
    @Deprecated
    public AllowAction(String name) {
        super(name);
    }
