...
public class ListProtectionCapabilityGroupTagsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListProtectionCapabilityGroupTagsConverter.class);

    public static com.oracle.bmc.waf.requests.ListProtectionCapabilityGroupTagsRequest
            interceptRequest(
                    com.oracle.bmc.waf.requests.ListProtectionCapabilityGroupTagsRequest request) {
