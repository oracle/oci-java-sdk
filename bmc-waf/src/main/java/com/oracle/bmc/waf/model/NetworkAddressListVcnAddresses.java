...
public final class NetworkAddressListVcnAddresses extends NetworkAddressList {
    ...
    public static class Builder {
        ...
        public NetworkAddressListVcnAddresses build() {
            NetworkAddressListVcnAddresses __instance__ =
                    new NetworkAddressListVcnAddresses(
                            id,
                            displayName,
                            compartmentId,
                            timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkAddressListVcnAddresses o) {
    ...
    @Deprecated
    public NetworkAddressListVcnAddresses(
            String id,
            String displayName,
    ...
    public String toString() {
        ...
        sb.append("NetworkAddressListVcnAddresses(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkAddressListVcnAddresses)) {
            return false;
        }

        NetworkAddressListVcnAddresses other = (NetworkAddressListVcnAddresses) o;
