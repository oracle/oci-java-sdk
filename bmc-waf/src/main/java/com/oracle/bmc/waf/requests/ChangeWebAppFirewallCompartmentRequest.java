...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waf/ChangeWebAppFirewallCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeWebAppFirewallCompartmentRequest.
 */
...
public class ChangeWebAppFirewallCompartmentRequest
     ...
     * The information to be updated.
     */
    public com.oracle.bmc.waf.model.ChangeWebAppFirewallCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.waf.model.ChangeWebAppFirewallCompartmentDetails
                changeWebAppFirewallCompartmentDetails = null;

        /**
         * The information to be updated.
         * @param changeWebAppFirewallCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeWebAppFirewallCompartmentDetails(
                com.oracle.bmc.waf.model.ChangeWebAppFirewallCompartmentDetails
                        changeWebAppFirewallCompartmentDetails) {
            this.changeWebAppFirewallCompartmentDetails = changeWebAppFirewallCompartmentDetails;
            return this;
        }
         ...
         * @return instance of ChangeWebAppFirewallCompartmentRequest
         */
        public ChangeWebAppFirewallCompartmentRequest buildWithoutInvocationCallback() {
            ChangeWebAppFirewallCompartmentRequest request =
                    new ChangeWebAppFirewallCompartmentRequest();
            request.webAppFirewallId = webAppFirewallId;
            request.changeWebAppFirewallCompartmentDetails = changeWebAppFirewallCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ChangeWebAppFirewallCompartmentRequest(webAppFirewallId, changeWebAppFirewallCompartmentDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeWebAppFirewallCompartmentDetails=")
                .append(String.valueOf(this.changeWebAppFirewallCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeWebAppFirewallCompartmentRequest)) {
            return false;
        }

        ChangeWebAppFirewallCompartmentRequest other = (ChangeWebAppFirewallCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.webAppFirewallId, other.webAppFirewallId)
                && java.util.Objects.equals(
                        this.changeWebAppFirewallCompartmentDetails,
                        other.changeWebAppFirewallCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.webAppFirewallId == null ? 43 : this.webAppFirewallId.hashCode());
        result =
                (result * PRIME)
                        + (this.changeWebAppFirewallCompartmentDetails == null
                                ? 43
                                : this.changeWebAppFirewallCompartmentDetails.hashCode());
