...
/**
 * Summary of NetworkAddressListVcnAddresses. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkAddressListVcnAddressesSummary.Builder.class)
...
public final class NetworkAddressListVcnAddressesSummary extends NetworkAddressListSummary {
    ...
    public static class Builder {
        ...
        public NetworkAddressListVcnAddressesSummary build() {
            NetworkAddressListVcnAddressesSummary model =
                    new NetworkAddressListVcnAddressesSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkAddressListVcnAddressesSummary model) {
    ...
    @Deprecated
    public NetworkAddressListVcnAddressesSummary(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NetworkAddressListVcnAddressesSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkAddressListVcnAddressesSummary)) {
            return false;
        }

        NetworkAddressListVcnAddressesSummary other = (NetworkAddressListVcnAddressesSummary) o;
