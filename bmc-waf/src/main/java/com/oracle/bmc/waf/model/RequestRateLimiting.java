...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RequestRateLimiting.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RequestRateLimiting
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"rules"})
    public RequestRateLimiting(java.util.List<RequestRateLimitingRule> rules) {
        super();
        this.rules = rules;
    }
    ...
    public static class Builder {
        /**
         * Ordered list of RequestRateLimitingRules. Rules are executed in order of appearance in
         * this array.
         */
        ...
        public RequestRateLimiting build() {
            RequestRateLimiting model = new RequestRateLimiting(this.rules);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RequestRateLimiting model) {
    ...
    /**
     * Ordered list of RequestRateLimitingRules. Rules are executed in order of appearance in this
     * array.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("rules")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestRateLimiting)) {
            return false;
        }

        RequestRateLimiting other = (RequestRateLimiting) o;
