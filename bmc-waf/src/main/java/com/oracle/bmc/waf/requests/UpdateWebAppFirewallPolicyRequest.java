...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waf/UpdateWebAppFirewallPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateWebAppFirewallPolicyRequest.
 */
...
public class UpdateWebAppFirewallPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateWebAppFirewallPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateWebAppFirewallPolicyRequest(webAppFirewallPolicyId, updateWebAppFirewallPolicyDetails, ifMatch, opcRequestId);
        }
    }
