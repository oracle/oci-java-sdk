...
/**
 * Module that allows to enable OCI-managed protection capabilities for HTTP responses. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ResponseProtection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ResponseProtection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"rules"})
    public ResponseProtection(java.util.List<ProtectionRule> rules) {
        super();
        this.rules = rules;
    }
    ...
    public static class Builder {
         ...
         * RESPONSE_PROTECTION_CAPABILITY type.
         */
        ...
        public ResponseProtection build() {
            ResponseProtection model = new ResponseProtection(this.rules);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResponseProtection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResponseProtection)) {
            return false;
        }

        ResponseProtection other = (ResponseProtection) o;
