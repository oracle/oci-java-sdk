...
/**
 * Summary of the WebAppFirewallLoadBalancer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = WebAppFirewallLoadBalancerSummary.Builder.class)
...
public final class WebAppFirewallLoadBalancerSummary extends WebAppFirewallSummary {
    ...
    public static class Builder {
        ...
        private WebAppFirewall.LifecycleState lifecycleState;

        public Builder lifecycleState(WebAppFirewall.LifecycleState lifecycleState) {
        ...
        public WebAppFirewallLoadBalancerSummary build() {
            WebAppFirewallLoadBalancerSummary model =
                    new WebAppFirewallLoadBalancerSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WebAppFirewallLoadBalancerSummary model) {
    ...
    @Deprecated
    public WebAppFirewallLoadBalancerSummary(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WebAppFirewallLoadBalancerSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAppFirewallLoadBalancerSummary)) {
            return false;
        }

        WebAppFirewallLoadBalancerSummary other = (WebAppFirewallLoadBalancerSummary) o;
