...
/**
 * The information to be updated. When updating WebAppFirewallPolicy, shallow merge is used for all
 * top-level fields, meaning that top-level fields with defined values are completely overwritten
 * and top-level fields without defined values are unchanged. <br>
...
public final class UpdateWebAppFirewallPolicyDetails
    ...
    public UpdateWebAppFirewallPolicyDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateWebAppFirewallPolicyDetails build() {
            UpdateWebAppFirewallPolicyDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateWebAppFirewallPolicyDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWebAppFirewallPolicyDetails)) {
            return false;
        }

        UpdateWebAppFirewallPolicyDetails other = (UpdateWebAppFirewallPolicyDetails) o;
