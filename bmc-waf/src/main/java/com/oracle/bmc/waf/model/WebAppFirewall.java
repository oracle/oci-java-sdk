...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = WebAppFirewall.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = WebAppFirewallLoadBalancer.class,
            name = "LOAD_BALANCER")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public class WebAppFirewall extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAppFirewall)) {
            return false;
        }

        WebAppFirewall other = (WebAppFirewall) o;
