...
public class CreateNetworkAddressListVcnAddressesDetails extends CreateNetworkAddressListDetails {
    ...
    public static class Builder {
        ...
        public CreateNetworkAddressListVcnAddressesDetails build() {
            CreateNetworkAddressListVcnAddressesDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNetworkAddressListVcnAddressesDetails o) {
