...
/**
 * Rule that represents Request/Response Access Control. Only actions of the following types are
 * allowed to be referenced in this rule: * CHECK * ALLOW * RETURN_HTTP_RESPONSE <br>
...
public final class AccessControlRule extends WebAppFirewallPolicyRule {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccessControlRule)) {
            return false;
        }
