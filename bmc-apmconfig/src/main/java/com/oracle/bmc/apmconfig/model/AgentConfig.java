...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AgentConfig.Builder.class)
...
public final class AgentConfig extends Config {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgentConfig model) {
