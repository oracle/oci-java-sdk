...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmconfig/ListDataFilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDataFilesRequest.
 */
...
public class ListDataFilesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDataFilesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataFilesRequest(apmDomainId, apmType, name, timeLastModifiedBefore, timeLastModifiedAfter, limit, page, sortOrder, sortBy, metadata, opcRetryToken, opcClientRequestId);
        }
    }
