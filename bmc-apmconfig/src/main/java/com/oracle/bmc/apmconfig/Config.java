...
/**
 * Use the Application Performance Monitoring Configuration API to query and set Application
...
public interface Config extends AutoCloseable {
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmconfig/DeleteDataFileExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use DeleteDataFile API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmconfig/GetDataFileExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetDataFile API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use HeadDataFile API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListDataFiles API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use PutDataFile API.
     */
     ...
     * success, 422 when validation fails.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     * @throws BmcException when an error occurs. This operation uses
