...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MacsApmExtensionSummary.Builder.class)
...
public final class MacsApmExtensionSummary extends ConfigSummary {
    ...
    public static class Builder {
        ...
        public MacsApmExtensionSummary build() {
            MacsApmExtensionSummary model =
                    new MacsApmExtensionSummary(
                            this.id,
                            this.timeCreated,
                            this.timeUpdated,
                            this.createdBy,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacsApmExtensionSummary model) {
    ...
    @Deprecated
    public MacsApmExtensionSummary(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MacsApmExtensionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacsApmExtensionSummary)) {
            return false;
        }

        MacsApmExtensionSummary other = (MacsApmExtensionSummary) o;
