 ...
 * can exist in the configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApdexRules.Builder.class)
...
public final class ApdexRules extends Config {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApdexRules model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApdexRules)) {
            return false;
        }

        ApdexRules other = (ApdexRules) o;
