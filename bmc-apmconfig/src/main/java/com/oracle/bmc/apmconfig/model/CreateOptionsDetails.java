...
public final class CreateOptionsDetails extends CreateConfigDetails {
    ...
    public static class Builder {
        ...
        public CreateOptionsDetails build() {
            CreateOptionsDetails __instance__ =
                    new CreateOptionsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOptionsDetails o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOptionsDetails)) {
            return false;
        }

        CreateOptionsDetails other = (CreateOptionsDetails) o;
