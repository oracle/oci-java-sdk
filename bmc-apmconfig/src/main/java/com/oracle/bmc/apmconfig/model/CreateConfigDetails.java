...
/**
 * The request body used to create new configuration items. It must specify the configuration type
 * of the item, as well as the actual data to populate the item with. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "configType",
        defaultImpl = CreateConfigDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateSpanFilterDetails.class,
            name = "SPAN_FILTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
...
public class CreateConfigDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"freeformTags", "definedTags"})
    protected CreateConfigDetails(
