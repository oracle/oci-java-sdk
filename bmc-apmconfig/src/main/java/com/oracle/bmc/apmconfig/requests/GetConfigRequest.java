...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmconfig/GetConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetConfigRequest.
 */
...
public class GetConfigRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetConfigRequest, java.lang.Void> {
        ...
        public GetConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetConfigRequest(apmDomainId, configId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().apmDomainId(apmDomainId).configId(configId).opcRequestId(opcRequestId);
    }
