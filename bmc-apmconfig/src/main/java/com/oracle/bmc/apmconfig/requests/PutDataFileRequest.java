...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmconfig/PutDataFileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutDataFileRequest.
 */
...
public class PutDataFileRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
    ...
    public static class Builder
        ...
        public PutDataFileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutDataFileRequest(putDataFileBody, dataFileName, apmDomainId, apmType, contentMD5, contentType, contentLanguage, contentEncoding, contentDisposition, metadata, opcRetryToken, opcClientRequestId);
        }
    }
