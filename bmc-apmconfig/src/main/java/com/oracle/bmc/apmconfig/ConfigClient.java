...
public class ConfigClient implements Config {
    ...
    public CopyConfigurationResponse copyConfiguration(CopyConfigurationRequest request) {
        LOG.trace("Called copyConfiguration");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CopyConfigurationResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCopyConfigurationDetails(),
                                                retriedRequest);
    ...
    public ExportConfigurationResponse exportConfiguration(ExportConfigurationRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ExportConfigurationResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getExportConfigurationDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ImportConfigurationResponse importConfiguration(ImportConfigurationRequest request) {
        LOG.trace("Called importConfiguration");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ImportConfigurationResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getImportConfigurationDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateMatchAgentsWithAttributeKeyResponse updateMatchAgentsWithAttributeKey(
        ...
        LOG.trace("Called updateMatchAgentsWithAttributeKey");
