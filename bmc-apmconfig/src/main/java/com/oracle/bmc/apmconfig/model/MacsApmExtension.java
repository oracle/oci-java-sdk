...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MacsApmExtension.Builder.class)
...
public final class MacsApmExtension extends Config {
    ...
    public static class Builder {
        ...
        public MacsApmExtension build() {
            MacsApmExtension model =
                    new MacsApmExtension(
                            this.id,
                            this.timeCreated,
                            this.timeUpdated,
                            this.createdBy,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacsApmExtension model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacsApmExtension)) {
            return false;
        }

        MacsApmExtension other = (MacsApmExtension) o;
