...
/**
 * Output of running a set of span enrichment rules against a span. <br>
...
public final class TestSpanEnrichmentOutput extends TestOutput {
    ...
    /**
     * A list of booleans indicating whether the corresponding filter in the input matched the input
     * span.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("filters")
