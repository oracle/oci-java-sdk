...
public class GetMatchAgentsWithAttributeKeyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMatchAgentsWithAttributeKeyConverter.class);

    public static com.oracle.bmc.apmconfig.requests.GetMatchAgentsWithAttributeKeyRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.apmconfig.requests.GetMatchAgentsWithAttributeKeyRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        .path("/20210201")
                        .path("actions")
                        .path("matchAgentsWithAttributeKey");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.apmconfig.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apmconfig.responses.GetMatchAgentsWithAttributeKeyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.apmconfig.responses
                                                .GetMatchAgentsWithAttributeKeyResponse.Builder
                                        builder =
                                                com.oracle.bmc.apmconfig.responses
                                                        .GetMatchAgentsWithAttributeKeyResponse
                                                        .builder()
                                ...
                                builder.matchAgentsWithAttributeKey(response.getItem());
