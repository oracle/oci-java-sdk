...
/**
 * A collection of Data File summaries. <br>
...
public final class DataFileSummaryCollection
    ...
    public DataFileSummaryCollection(java.util.List<DataFileSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<DataFileSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<DataFileSummary> items) {
            this.items = items;
    ...
    /** A list of Data File summaries. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<DataFileSummary> items;
     ...
     * @return the value
     */
    public java.util.List<DataFileSummary> getItems() {
        return items;
    }
