...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMacsApmExtensionDetails.Builder.class)
...
public final class UpdateMacsApmExtensionDetails extends UpdateConfigDetails {
    ...
    public static class Builder {
        ...
        public UpdateMacsApmExtensionDetails build() {
            UpdateMacsApmExtensionDetails model =
                    new UpdateMacsApmExtensionDetails(
                            this.freeformTags,
                            this.definedTags,
                            this.displayName,
                            this.processFilter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMacsApmExtensionDetails model) {
    ...
    @Deprecated
    public UpdateMacsApmExtensionDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMacsApmExtensionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMacsApmExtensionDetails)) {
            return false;
        }

        UpdateMacsApmExtensionDetails other = (UpdateMacsApmExtensionDetails) o;
