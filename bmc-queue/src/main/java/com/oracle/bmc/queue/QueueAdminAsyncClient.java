...
public class QueueAdminAsyncClient implements QueueAdminAsync {
    /**
    ...
    public static class Builder
        ...
        public QueueAdminAsyncClient build(
            ...
            return new QueueAdminAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ChangeQueueCompartmentResponse> changeQueueCompartment(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async changeQueueCompartment");
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ChangeQueueCompartmentRequest, ChangeQueueCompartmentResponse>,
                        java.util.concurrent.Future<ChangeQueueCompartmentResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getChangeQueueCompartmentDetails(),
                                ib,
                                transformer);
    ...
    @Override
    public java.util.concurrent.Future<CreateConsumerGroupResponse> createConsumerGroup(
            CreateConsumerGroupRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            CreateConsumerGroupRequest, CreateConsumerGroupResponse>
                    handler) {
        LOG.trace("Called async createConsumerGroup");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CreateConsumerGroupResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateConsumerGroupRequest, CreateConsumerGroupResponse>,
                        java.util.concurrent.Future<CreateConsumerGroupResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateConsumerGroupDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<CreateQueueResponse> createQueue(
            ...
            final com.oracle.bmc.responses.AsyncHandler<CreateQueueRequest, CreateQueueResponse>
                    handler) {
        LOG.trace("Called async createQueue");
        ...
        com.oracle.bmc.responses.AsyncHandler<CreateQueueRequest, CreateQueueResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateQueueRequest, CreateQueueResponse>,
                        java.util.concurrent.Future<CreateQueueResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateQueueDetails(),
                                ib,
                                transformer);
    ...
    @Override
    public java.util.concurrent.Future<DeleteConsumerGroupResponse> deleteConsumerGroup(
            DeleteConsumerGroupRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            DeleteConsumerGroupRequest, DeleteConsumerGroupResponse>
                    handler) {
        LOG.trace("Called async deleteConsumerGroup");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, DeleteConsumerGroupResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeleteConsumerGroupRequest, DeleteConsumerGroupResponse>,
                        java.util.concurrent.Future<DeleteConsumerGroupResponse>>
    ...
    public java.util.concurrent.Future<DeleteQueueResponse> deleteQueue(
            ...
            final com.oracle.bmc.responses.AsyncHandler<DeleteQueueRequest, DeleteQueueResponse>
                    handler) {
        LOG.trace("Called async deleteQueue");
        ...
        com.oracle.bmc.responses.AsyncHandler<DeleteQueueRequest, DeleteQueueResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeleteQueueRequest, DeleteQueueResponse>,
                        java.util.concurrent.Future<DeleteQueueResponse>>
                futureSupplier = client.deleteFutureSupplier(interceptedRequest, ib, transformer);
    ...
    @Override
    public java.util.concurrent.Future<GetConsumerGroupResponse> getConsumerGroup(
            GetConsumerGroupRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            GetConsumerGroupRequest, GetConsumerGroupResponse>
                    handler) {
        LOG.trace("Called async getConsumerGroup");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetConsumerGroupResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetConsumerGroupRequest, GetConsumerGroupResponse>,
                        java.util.concurrent.Future<GetConsumerGroupResponse>>
    ...
    public java.util.concurrent.Future<GetQueueResponse> getQueue(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetQueueRequest, GetQueueResponse>
                    handler) {
        LOG.trace("Called async getQueue");
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<GetQueueRequest, GetQueueResponse>,
                        java.util.concurrent.Future<GetQueueResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);

        if (this.authenticationDetailsProvider
                instanceof com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider) {
            return new com.oracle.bmc.util.internal.RefreshAuthTokenWrapper<
                    GetQueueRequest, GetQueueResponse>(
                    (com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider)
                            this.authenticationDetailsProvider,
                    handlerToUse,
                    futureSupplier) {
    ...
    @Override
    public java.util.concurrent.Future<ListConsumerGroupsResponse> listConsumerGroups(
            ListConsumerGroupsRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            ListConsumerGroupsRequest, ListConsumerGroupsResponse>
                    handler) {
        LOG.trace("Called async listConsumerGroups");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListConsumerGroupsResponse>
                transformer =
                        ListConsumerGroupsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ListConsumerGroupsRequest, ListConsumerGroupsResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListConsumerGroupsRequest, ListConsumerGroupsResponse>,
                        java.util.concurrent.Future<ListConsumerGroupsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<ListQueuesResponse> listQueues(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ListQueuesRequest, ListQueuesResponse>
                    handler) {
        LOG.trace("Called async listQueues");
        ...
        com.oracle.bmc.responses.AsyncHandler<ListQueuesRequest, ListQueuesResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListQueuesRequest, ListQueuesResponse>,
                        java.util.concurrent.Future<ListQueuesResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<PurgeQueueResponse> purgeQueue(
            ...
            final com.oracle.bmc.responses.AsyncHandler<PurgeQueueRequest, PurgeQueueResponse>
                    handler) {
        LOG.trace("Called async purgeQueue");
        ...
        com.oracle.bmc.responses.AsyncHandler<PurgeQueueRequest, PurgeQueueResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                PurgeQueueRequest, PurgeQueueResponse>,
                        java.util.concurrent.Future<PurgeQueueResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getPurgeQueueDetails(),
                                ib,
                                transformer);
    ...
    @Override
    public java.util.concurrent.Future<UpdateConsumerGroupResponse> updateConsumerGroup(
            UpdateConsumerGroupRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            UpdateConsumerGroupRequest, UpdateConsumerGroupResponse>
                    handler) {
        LOG.trace("Called async updateConsumerGroup");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, UpdateConsumerGroupResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateConsumerGroupRequest, UpdateConsumerGroupResponse>,
                        java.util.concurrent.Future<UpdateConsumerGroupResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateConsumerGroupDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<UpdateQueueResponse> updateQueue(
            ...
            final com.oracle.bmc.responses.AsyncHandler<UpdateQueueRequest, UpdateQueueResponse>
                    handler) {
        LOG.trace("Called async updateQueue");
        ...
        com.oracle.bmc.responses.AsyncHandler<UpdateQueueRequest, UpdateQueueResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateQueueRequest, UpdateQueueResponse>,
                        java.util.concurrent.Future<UpdateQueueResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateQueueDetails(),
                                ib,
                                transformer);
