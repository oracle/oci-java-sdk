...
/**
 * A detailed representation of a consumer group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ConsumerGroup.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ConsumerGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConsumerGroup model) {
     ...
     * consumers of the group. An empty value means that all messages will be available in the
     * group.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("filter")
