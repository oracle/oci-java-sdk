...
/**
 * The information about a new consumer group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConsumerGroupDetails.Builder.class)
...
public final class CreateConsumerGroupDetails
    ...
    public CreateConsumerGroupDetails(
            String displayName,
            String filter,
            String queueId,
            Boolean isEnabled,
    ...
    public static class Builder {
         ...
         * specified, it will be using the value defined at the queue level.
         */
        ...
        public CreateConsumerGroupDetails build() {
            CreateConsumerGroupDetails model =
                    new CreateConsumerGroupDetails(
                            this.displayName,
                            this.filter,
                            this.queueId,
                            this.isEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConsumerGroupDetails model) {
     ...
     * letter queue. A value of 0 indicates that the DLQ is not used. If the value isn't specified,
     * it will be using the value defined at the queue level.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("deadLetterQueueDeliveryCount")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConsumerGroupDetails)) {
            return false;
        }

        CreateConsumerGroupDetails other = (CreateConsumerGroupDetails) o;
