...
public interface QueueAdminAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeQueueCompartmentResponse> changeQueueCompartment(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<CreateQueueResponse> createQueue(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetQueueResponse> getQueue(
            GetQueueRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetQueueRequest, GetQueueResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListQueuesResponse> listQueues(
            ListQueuesRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListQueuesRequest, ListQueuesResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateQueueResponse> updateQueue(
            UpdateQueueRequest request,
            com.oracle.bmc.responses.AsyncHandler<UpdateQueueRequest, UpdateQueueResponse> handler);
}
