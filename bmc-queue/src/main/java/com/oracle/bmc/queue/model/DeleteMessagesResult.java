...
/**
 * The response to a DeleteMessages request. It indicates the number of server and client failures
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeleteMessagesResult.Builder.class)
...
public final class DeleteMessagesResult
    ...
    public DeleteMessagesResult(
            ...
            java.util.List<DeleteMessagesResultEntry> entries) {
        super();
    ...
    public static class Builder {
        /**
         * The number of messages that failed to be deleted from the queue because of a server
         * failure.
         */
        ...
        /**
         * The number of messages that failed to be deleted from the queue because of a client
         * failure such as an invalid receipt.
         */
         ...
         * the same as in the {@code DeleteMessagesDetails} object. If a message was successfully
         * deleted from the queue, the entry does not contain any fields. If a message failed to be
         * deleted from the queue, the entry includes the {@code errorCode} and {@code errorMessage}
         * fields.
         */
        @com.fasterxml.jackson.annotation.JsonProperty("entries")
        private java.util.List<DeleteMessagesResultEntry> entries;
         ...
         * @return this builder
         */
        public Builder entries(java.util.List<DeleteMessagesResultEntry> entries) {
            this.entries = entries;
        ...
        public DeleteMessagesResult build() {
            DeleteMessagesResult model =
                    new DeleteMessagesResult(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeleteMessagesResult model) {
    ...
    /**
     * The number of messages that failed to be deleted from the queue because of a client failure
     * such as an invalid receipt.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("clientFailures")
     ...
     * same as in the {@code DeleteMessagesDetails} object. If a message was successfully deleted
     * from the queue, the entry does not contain any fields. If a message failed to be deleted from
     * the queue, the entry includes the {@code errorCode} and {@code errorMessage} fields.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("entries")
    private final java.util.List<DeleteMessagesResultEntry> entries;
     ...
     * @return the value
     */
    public java.util.List<DeleteMessagesResultEntry> getEntries() {
        return entries;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeleteMessagesResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMessagesResult)) {
            return false;
        }

        DeleteMessagesResult other = (DeleteMessagesResult) o;
