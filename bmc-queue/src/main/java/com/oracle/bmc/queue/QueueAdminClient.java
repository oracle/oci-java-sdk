...
public class QueueAdminClient implements QueueAdmin {
    ...
    public ChangeQueueCompartmentResponse changeQueueCompartment(
        ...
        final ChangeQueueCompartmentRequest interceptedRequest =
                ChangeQueueCompartmentConverter.interceptRequest(request);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeQueueCompartmentDetails(),
                                                retriedRequest);
    ...
    public CreateConsumerGroupResponse createConsumerGroup(CreateConsumerGroupRequest request) {
        LOG.trace("Called createConsumerGroup");
        final CreateConsumerGroupRequest interceptedRequest =
                CreateConsumerGroupConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateConsumerGroupConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateConsumerGroupResponse>
                transformer =
                        CreateConsumerGroupConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateConsumerGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateQueueResponse createQueue(CreateQueueRequest request) {
        ...
        final CreateQueueRequest interceptedRequest =
                CreateQueueConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateQueueConverter.fromRequest(client, interceptedRequest);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateQueueDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteConsumerGroupResponse deleteConsumerGroup(DeleteConsumerGroupRequest request) {
        LOG.trace("Called deleteConsumerGroup");
        final DeleteConsumerGroupRequest interceptedRequest =
                DeleteConsumerGroupConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteConsumerGroupConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteConsumerGroupResponse>
                transformer =
                        DeleteConsumerGroupConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public DeleteQueueResponse deleteQueue(DeleteQueueRequest request) {
        ...
        final DeleteQueueRequest interceptedRequest =
                DeleteQueueConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public GetConsumerGroupResponse getConsumerGroup(GetConsumerGroupRequest request) {
        LOG.trace("Called getConsumerGroup");
        final GetConsumerGroupRequest interceptedRequest =
                GetConsumerGroupConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetConsumerGroupConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetConsumerGroupResponse>
                transformer =
                        GetConsumerGroupConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public GetQueueResponse getQueue(GetQueueRequest request) {
        ...
        final GetQueueRequest interceptedRequest = GetQueueConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public ListConsumerGroupsResponse listConsumerGroups(ListConsumerGroupsRequest request) {
        LOG.trace("Called listConsumerGroups");
        final ListConsumerGroupsRequest interceptedRequest =
                ListConsumerGroupsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListConsumerGroupsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListConsumerGroupsResponse>
                transformer =
                        ListConsumerGroupsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListQueuesResponse listQueues(ListQueuesRequest request) {
        ...
        final ListQueuesRequest interceptedRequest = ListQueuesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public PurgeQueueResponse purgeQueue(PurgeQueueRequest request) {
        ...
        final PurgeQueueRequest interceptedRequest = PurgeQueueConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getPurgeQueueDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateConsumerGroupResponse updateConsumerGroup(UpdateConsumerGroupRequest request) {
        LOG.trace("Called updateConsumerGroup");
        final UpdateConsumerGroupRequest interceptedRequest =
                UpdateConsumerGroupConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateConsumerGroupConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateConsumerGroupResponse>
                transformer =
                        UpdateConsumerGroupConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateConsumerGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateQueueResponse updateQueue(UpdateQueueRequest request) {
        ...
        final UpdateQueueRequest interceptedRequest =
                UpdateQueueConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateQueueDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
