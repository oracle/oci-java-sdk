...
public class GetPrivateApplicationPackageActionDownloadConfigResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPrivateApplicationPackageActionDownloadConfigResponse)) {
            return false;
        }

        GetPrivateApplicationPackageActionDownloadConfigResponse other =
                (GetPrivateApplicationPackageActionDownloadConfigResponse) o;
