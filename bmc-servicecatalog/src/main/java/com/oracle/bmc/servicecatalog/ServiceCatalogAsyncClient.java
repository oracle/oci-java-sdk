...
public class ServiceCatalogAsyncClient implements ServiceCatalogAsync {
    ...
    public java.util.concurrent.Future<ListAllApplicationsResponse> listAllApplications(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listAllApplications");
        final ListAllApplicationsRequest interceptedRequest =
                ListAllApplicationsConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListAllApplicationsConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "ServiceCatalog",
                        "ListAllApplications",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListAllApplicationsResponse>
                transformer =
                        ListAllApplicationsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<
                        ListAllApplicationsRequest, ListAllApplicationsResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListAllApplicationsRequest, ListAllApplicationsResponse>,
                        java.util.concurrent.Future<ListAllApplicationsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
