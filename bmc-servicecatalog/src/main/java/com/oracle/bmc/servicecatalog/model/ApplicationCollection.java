...
/**
 * Collection of applications in a given service catalog or a tenancy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApplicationCollection.Builder.class)
...
public final class ApplicationCollection
    ...
    public ApplicationCollection(java.util.List<ApplicationSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public ApplicationCollection build() {
            ApplicationCollection model = new ApplicationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplicationCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ApplicationCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplicationCollection)) {
            return false;
        }

        ApplicationCollection other = (ApplicationCollection) o;
