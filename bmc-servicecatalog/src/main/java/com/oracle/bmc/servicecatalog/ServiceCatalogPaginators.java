...
public class ServiceCatalogPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listAllApplications operation. This iterable
    ...
    public Iterable<ListAllApplicationsResponse> listAllApplicationsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListAllApplicationsRequest.Builder, ListAllApplicationsRequest,
     ...
     * contained in responses from the listAllApplications operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
