...
public class GetServiceCatalogAssociationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetServiceCatalogAssociationResponse(
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder serviceCatalogAssociation(
                com.oracle.bmc.servicecatalog.model.ServiceCatalogAssociation
                        serviceCatalogAssociation) {
            this.serviceCatalogAssociation = serviceCatalogAssociation;
            return this;
         ...
         */
        @Override
        public Builder copy(GetServiceCatalogAssociationResponse o) {
         ...
         */
        @Override
        public GetServiceCatalogAssociationResponse build() {
            return new GetServiceCatalogAssociationResponse(
    ...
    public String toString() {
        ...
        sb.append(",serviceCatalogAssociation=").append(String.valueOf(serviceCatalogAssociation));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetServiceCatalogAssociationResponse)) {
            return false;
        }

        GetServiceCatalogAssociationResponse other = (GetServiceCatalogAssociationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.serviceCatalogAssociation, other.serviceCatalogAssociation);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.serviceCatalogAssociation == null
                                ? 43
                                : this.serviceCatalogAssociation.hashCode());
        return result;
    }
}
