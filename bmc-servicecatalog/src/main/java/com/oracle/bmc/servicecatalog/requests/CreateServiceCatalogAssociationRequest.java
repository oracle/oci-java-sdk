...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/CreateServiceCatalogAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateServiceCatalogAssociationRequest.
 */
...
public class CreateServiceCatalogAssociationRequest
    ...
    public static class Builder
         ...
         */
        public Builder createServiceCatalogAssociationDetails(
                com.oracle.bmc.servicecatalog.model.CreateServiceCatalogAssociationDetails
                        createServiceCatalogAssociationDetails) {
            this.createServiceCatalogAssociationDetails = createServiceCatalogAssociationDetails;
            return this;
        }
        ...
        public Builder copy(CreateServiceCatalogAssociationRequest o) {
            createServiceCatalogAssociationDetails(o.getCreateServiceCatalogAssociationDetails());
         ...
         */
        public CreateServiceCatalogAssociationRequest build() {
            CreateServiceCatalogAssociationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateServiceCatalogAssociationRequest
         */
        public CreateServiceCatalogAssociationRequest buildWithoutInvocationCallback() {
            CreateServiceCatalogAssociationRequest request =
                    new CreateServiceCatalogAssociationRequest();
            request.createServiceCatalogAssociationDetails = createServiceCatalogAssociationDetails;
    ...
    public String toString() {
        ...
        sb.append(",createServiceCatalogAssociationDetails=")
                .append(String.valueOf(this.createServiceCatalogAssociationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceCatalogAssociationRequest)) {
            return false;
        }

        CreateServiceCatalogAssociationRequest other = (CreateServiceCatalogAssociationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createServiceCatalogAssociationDetails,
                        other.createServiceCatalogAssociationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createServiceCatalogAssociationDetails == null
                                ? 43
                                : this.createServiceCatalogAssociationDetails.hashCode());
        result =
                (result * PRIME)
