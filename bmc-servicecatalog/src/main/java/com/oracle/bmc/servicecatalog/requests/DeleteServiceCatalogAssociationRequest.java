...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/DeleteServiceCatalogAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteServiceCatalogAssociationRequest.
 */
...
public class DeleteServiceCatalogAssociationRequest
    ...
    public static class Builder
        ...
        public DeleteServiceCatalogAssociationRequest buildWithoutInvocationCallback() {
            DeleteServiceCatalogAssociationRequest request =
                    new DeleteServiceCatalogAssociationRequest();
            request.serviceCatalogAssociationId = serviceCatalogAssociationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteServiceCatalogAssociationRequest(serviceCatalogAssociationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        DeleteServiceCatalogAssociationRequest other = (DeleteServiceCatalogAssociationRequest) o;
