...
/**
 * A base object for creating a private application package. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CreatePrivateApplicationPackage.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreatePrivateApplicationStackPackage.class,
            name = "STACK")
})
...
public class CreatePrivateApplicationPackage
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePrivateApplicationPackage)) {
            return false;
        }
