...
public class ListApplicationsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.servicecatalog.model.ApplicationCollection getApplicationCollection() {
    ...
    private ListApplicationsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.servicecatalog.model.ApplicationCollection applicationCollection) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder applicationCollection(
                com.oracle.bmc.servicecatalog.model.ApplicationCollection applicationCollection) {
            this.applicationCollection = applicationCollection;
            return this;
        }
        ...
        public Builder copy(ListApplicationsResponse o) {
            ...
            applicationCollection(o.getApplicationCollection());
        ...
        public ListApplicationsResponse build() {
            return new ListApplicationsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, applicationCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",applicationCollection=").append(String.valueOf(applicationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.applicationCollection, other.applicationCollection);
    }
        ...
        result =
                (result * PRIME)
                        + (this.applicationCollection == null
                                ? 43
                                : this.applicationCollection.hashCode());
        return result;
    }
}
