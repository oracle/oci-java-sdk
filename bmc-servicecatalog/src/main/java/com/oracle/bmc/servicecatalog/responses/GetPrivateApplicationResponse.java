...
public class GetPrivateApplicationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetPrivateApplicationResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPrivateApplicationResponse> {
         ...
         */
        @Override
        public Builder copy(GetPrivateApplicationResponse o) {
        ...
        public GetPrivateApplicationResponse build() {
            return new GetPrivateApplicationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, privateApplication);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPrivateApplicationResponse)) {
            return false;
        }

        GetPrivateApplicationResponse other = (GetPrivateApplicationResponse) o;
