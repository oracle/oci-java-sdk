...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/ListAllApplicationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAllApplicationsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210527")
public class ListAllApplicationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAllApplicationsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAllApplicationsRequest o) {
        ...
        /**
         * Build the instance of ListAllApplicationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAllApplicationsRequest
         */
        public ListAllApplicationsRequest build() {
            ListAllApplicationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAllApplicationsRequest
         */
        public ListAllApplicationsRequest buildWithoutInvocationCallback() {
            ListAllApplicationsRequest request = new ListAllApplicationsRequest();
            ...
            return request;
            // new ListAllApplicationsRequest(compartmentId, entityType, opcRequestId, limit, page, displayName, entityId, publisherId, packageType, pricing, isFeatured, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAllApplicationsRequest)) {
            return false;
        }

        ListAllApplicationsRequest other = (ListAllApplicationsRequest) o;
