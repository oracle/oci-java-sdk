 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAllApplicationsRequest.
 */
...
public class ListAllApplicationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAllApplicationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAllApplicationsRequest(compartmentId, entityType, opcRequestId, limit, page,
            // displayName, entityId, publisherId, packageType, pricing, isFeatured, sortOrder);
        }
    }
