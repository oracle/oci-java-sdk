...
public class CreateServiceCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateServiceCatalogResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceCatalogResponse)) {
            return false;
        }

        CreateServiceCatalogResponse other = (CreateServiceCatalogResponse) o;
