...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/CreateServiceCatalogExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateServiceCatalogRequest.
 */
...
public class CreateServiceCatalogRequest
    ...
    public static class Builder
        ...
        public Builder createServiceCatalogDetails(
                com.oracle.bmc.servicecatalog.model.CreateServiceCatalogDetails
                        createServiceCatalogDetails) {
            this.createServiceCatalogDetails = createServiceCatalogDetails;
            return this;
        }
         ...
         * @return instance of CreateServiceCatalogRequest
         */
        public CreateServiceCatalogRequest buildWithoutInvocationCallback() {
            CreateServiceCatalogRequest request = new CreateServiceCatalogRequest();
            request.createServiceCatalogDetails = createServiceCatalogDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateServiceCatalogRequest(createServiceCatalogDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createServiceCatalogDetails=")
                .append(String.valueOf(this.createServiceCatalogDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceCatalogRequest)) {
            return false;
        }

        CreateServiceCatalogRequest other = (CreateServiceCatalogRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createServiceCatalogDetails, other.createServiceCatalogDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createServiceCatalogDetails == null
                                ? 43
                                : this.createServiceCatalogDetails.hashCode());
        result =
                (result * PRIME)
