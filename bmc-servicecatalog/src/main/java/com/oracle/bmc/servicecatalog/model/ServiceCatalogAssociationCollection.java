...
public final class ServiceCatalogAssociationCollection {
    ...
    public static class Builder {
        ...
        public ServiceCatalogAssociationCollection build() {
            ServiceCatalogAssociationCollection __instance__ =
                    new ServiceCatalogAssociationCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ServiceCatalogAssociationCollection o) {
