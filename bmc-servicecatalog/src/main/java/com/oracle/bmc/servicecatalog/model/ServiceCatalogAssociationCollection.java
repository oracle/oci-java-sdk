...
public final class ServiceCatalogAssociationCollection
    ...
    public ServiceCatalogAssociationCollection(
            java.util.List<ServiceCatalogAssociationSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public ServiceCatalogAssociationCollection build() {
            ServiceCatalogAssociationCollection model =
                    new ServiceCatalogAssociationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ServiceCatalogAssociationCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceCatalogAssociationCollection)) {
            return false;
        }

        ServiceCatalogAssociationCollection other = (ServiceCatalogAssociationCollection) o;
