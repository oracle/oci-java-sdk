...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/CreatePrivateApplicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePrivateApplicationRequest.
 */
...
public class CreatePrivateApplicationRequest
    ...
    public static class Builder
        ...
        public Builder createPrivateApplicationDetails(
                com.oracle.bmc.servicecatalog.model.CreatePrivateApplicationDetails
                        createPrivateApplicationDetails) {
            this.createPrivateApplicationDetails = createPrivateApplicationDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreatePrivateApplicationRequest o) {
            createPrivateApplicationDetails(o.getCreatePrivateApplicationDetails());
         ...
         *
         * @return instance of CreatePrivateApplicationRequest
         */
        public CreatePrivateApplicationRequest build() {
            CreatePrivateApplicationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreatePrivateApplicationRequest
         */
        public CreatePrivateApplicationRequest buildWithoutInvocationCallback() {
            CreatePrivateApplicationRequest request = new CreatePrivateApplicationRequest();
            request.createPrivateApplicationDetails = createPrivateApplicationDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreatePrivateApplicationRequest(createPrivateApplicationDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createPrivateApplicationDetails=")
                .append(String.valueOf(this.createPrivateApplicationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePrivateApplicationRequest)) {
            return false;
        }

        CreatePrivateApplicationRequest other = (CreatePrivateApplicationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createPrivateApplicationDetails, other.createPrivateApplicationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createPrivateApplicationDetails == null
                                ? 43
                                : this.createPrivateApplicationDetails.hashCode());
        result =
                (result * PRIME)
