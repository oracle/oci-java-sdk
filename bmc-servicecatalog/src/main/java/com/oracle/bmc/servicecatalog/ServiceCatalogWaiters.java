...
public class ServiceCatalogWaiters {
    ...
    public ServiceCatalogWaiters(
            java.util.concurrent.ExecutorService executorService, ServiceCatalog client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetPrivateApplicationRequest, GetPrivateApplicationResponse>
            forPrivateApplication(
                    GetPrivateApplicationRequest request,
                    com.oracle.bmc.servicecatalog.model.PrivateApplication.LifecycleState...
                            targetStates) {
    ...
    // Helper method to create a new Waiter for PrivateApplication.
    private com.oracle.bmc.waiter.Waiter<
                    GetPrivateApplicationRequest, GetPrivateApplicationResponse>
            forPrivateApplication(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetPrivateApplicationRequest request,
                    final com.oracle.bmc.servicecatalog.model.PrivateApplication.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.servicecatalog.model.PrivateApplication.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.servicecatalog.model.PrivateApplication
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetServiceCatalogRequest, GetServiceCatalogResponse>
            forServiceCatalog(
                    GetServiceCatalogRequest request,
                    com.oracle.bmc.servicecatalog.model.ServiceCatalog.LifecycleState...
                            targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
    ...
    public com.oracle.bmc.waiter.Waiter<GetServiceCatalogRequest, GetServiceCatalogResponse>
            forServiceCatalog(
                    GetServiceCatalogRequest request,
                    com.oracle.bmc.servicecatalog.model.ServiceCatalog.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for ServiceCatalog.
    private com.oracle.bmc.waiter.Waiter<GetServiceCatalogRequest, GetServiceCatalogResponse>
            forServiceCatalog(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetServiceCatalogRequest request,
                    final com.oracle.bmc.servicecatalog.model.ServiceCatalog.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.servicecatalog.model.ServiceCatalog.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
