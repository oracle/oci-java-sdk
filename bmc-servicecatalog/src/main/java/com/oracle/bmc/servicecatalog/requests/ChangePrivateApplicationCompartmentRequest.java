...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicecatalog/ChangePrivateApplicationCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangePrivateApplicationCompartmentRequest.
 */
...
public class ChangePrivateApplicationCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangePrivateApplicationCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangePrivateApplicationCompartmentRequest(privateApplicationId, changePrivateApplicationCompartmentDetails, opcRequestId, ifMatch);
        }
    }
