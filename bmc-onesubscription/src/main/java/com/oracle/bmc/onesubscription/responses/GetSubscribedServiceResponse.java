...
public class GetSubscribedServiceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.onesubscription.model.SubscribedService getSubscribedService() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSubscribedServiceResponse> {
         ...
         * @return this builder
         */
        public Builder subscribedService(
                com.oracle.bmc.onesubscription.model.SubscribedService subscribedService) {
            this.subscribedService = subscribedService;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",subscribedService=").append(String.valueOf(subscribedService));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSubscribedServiceResponse)) {
            return false;
        }

        GetSubscribedServiceResponse other = (GetSubscribedServiceResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.subscribedService, other.subscribedService);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.subscribedService == null ? 43 : this.subscribedService.hashCode());
        return result;
    }
}
