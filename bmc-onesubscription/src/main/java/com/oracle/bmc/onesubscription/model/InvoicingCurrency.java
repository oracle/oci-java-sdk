...
public final class InvoicingCurrency
    ...
    public static class Builder {
        ...
        public InvoicingCurrency build() {
            InvoicingCurrency model =
                    new InvoicingCurrency(this.name, this.isoCode, this.stdPrecision);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvoicingCurrency model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvoicingCurrency)) {
            return false;
        }

        InvoicingCurrency other = (InvoicingCurrency) o;
