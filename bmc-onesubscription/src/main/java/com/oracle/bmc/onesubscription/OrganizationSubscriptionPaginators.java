...
public class OrganizationSubscriptionPaginators {
     ...
     * com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary} objects contained in
     * responses from the listOrganizationSubscriptions operation. This iterable will fetch more
     * data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary} objects contained
