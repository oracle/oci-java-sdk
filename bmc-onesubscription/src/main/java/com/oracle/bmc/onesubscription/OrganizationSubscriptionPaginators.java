...
public class OrganizationSubscriptionPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOrganizationSubscriptions operation. This iterable
    ...
    public Iterable<ListOrganizationSubscriptionsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOrganizationSubscriptionsRequest.Builder, ListOrganizationSubscriptionsRequest,
                ...
                new com.google.common.base.Function<
                        ListOrganizationSubscriptionsResponse, String>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary} objects
     * contained in responses from the listOrganizationSubscriptions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary>
            listOrganizationSubscriptionsRecordIterator(
                    final ListOrganizationSubscriptionsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListOrganizationSubscriptionsRequest.Builder, ListOrganizationSubscriptionsRequest,
                ListOrganizationSubscriptionsResponse,
                com.oracle.bmc.onesubscription.model.OrganizationSubscriptionSummary>(
                new com.google.common.base.Supplier<
                        ListOrganizationSubscriptionsRequest.Builder>() {
                    @Override
                    public ListOrganizationSubscriptionsRequest.Builder get() {
