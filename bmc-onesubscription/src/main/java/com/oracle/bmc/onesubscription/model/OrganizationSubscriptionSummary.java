...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OrganizationSubscriptionSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class OrganizationSubscriptionSummary {
    @Deprecated
    ...
    public OrganizationSubscriptionSummary(
            String id,
            String serviceName,
            String type,
            String status,
            ...
            OrgnizationSubsCurrency currency,
            String totalValue) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public Builder currency(OrgnizationSubsCurrency currency) {
            this.currency = currency;
        ...
        public OrganizationSubscriptionSummary build() {
            OrganizationSubscriptionSummary __instance__ =
                    new OrganizationSubscriptionSummary(
                            id,
                            serviceName,
                            type,
                            status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OrganizationSubscriptionSummary o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrganizationSubscriptionSummary)) {
            return false;
        }

        OrganizationSubscriptionSummary other = (OrganizationSubscriptionSummary) o;
