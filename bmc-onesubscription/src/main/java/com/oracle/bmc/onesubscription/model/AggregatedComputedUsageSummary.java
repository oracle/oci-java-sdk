...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AggregatedComputedUsageSummary.Builder.class
)
...
public final class AggregatedComputedUsageSummary {
    ...
    public AggregatedComputedUsageSummary(
    ...
    public static class Builder {
        ...
        public AggregatedComputedUsageSummary build() {
            AggregatedComputedUsageSummary __instance__ =
                    new AggregatedComputedUsageSummary(
                            subscriptionId,
                            parentSubscribedServiceId,
                            parentProduct,
                            timeStart,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AggregatedComputedUsageSummary o) {
    ...
    public boolean equals(Object o) {
        ...
        AggregatedComputedUsageSummary other = (AggregatedComputedUsageSummary) o;
