...
public class SubscriptionPaginators {
     ...
     * com.oracle.bmc.onesubscription.model.SubscriptionSummary} objects contained in responses from
     * the listSubscriptions operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.onesubscription.model.SubscriptionSummary} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.onesubscription.model.SubscriptionSummary>
            listSubscriptionsRecordIterator(final ListSubscriptionsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListSubscriptionsRequest.Builder,
                ListSubscriptionsRequest,
                ListSubscriptionsResponse,
                com.oracle.bmc.onesubscription.model.SubscriptionSummary>(
                new java.util.function.Supplier<ListSubscriptionsRequest.Builder>() {
                    @Override
                    public ListSubscriptionsRequest.Builder get() {
                        return ListSubscriptionsRequest.builder().copy(request);
                ...
                new java.util.function.Function<
                        ...
                        java.util.List<
                                com.oracle.bmc.onesubscription.model.SubscriptionSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.onesubscription.model.SubscriptionSummary>
