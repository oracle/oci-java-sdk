...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/onesubscription/ListBillingSchedulesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBillingSchedulesRequest.
 */
...
public class ListBillingSchedulesRequest
    ...
    public static class Builder
        ...
        public ListBillingSchedulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListBillingSchedulesRequest(compartmentId, subscriptionId, subscribedServiceId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
