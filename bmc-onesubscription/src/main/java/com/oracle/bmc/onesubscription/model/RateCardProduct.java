...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RateCardProduct.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class RateCardProduct extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public RateCardProduct build() {
            RateCardProduct model =
                    new RateCardProduct(
                            this.partNumber,
                            this.name,
                            this.unitOfMeasure,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RateCardProduct model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RateCardProduct)) {
            return false;
        }

        RateCardProduct other = (RateCardProduct) o;
