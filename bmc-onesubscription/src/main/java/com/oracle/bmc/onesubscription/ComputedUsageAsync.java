...
public interface ComputedUsageAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetComputedUsageResponse> getComputedUsage(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListAggregatedComputedUsagesResponse> listAggregatedComputedUsages(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListComputedUsagesResponse> listComputedUsages(
