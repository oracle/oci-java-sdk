...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/onesubscription/GetCommitmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetCommitmentRequest.
 */
...
public class GetCommitmentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetCommitmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetCommitmentRequest(commitmentId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().commitmentId(commitmentId).opcRequestId(opcRequestId);
    }
