...
public class OrganizationSubscriptionClient implements OrganizationSubscription {
     ...
     */
    protected OrganizationSubscriptionClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public OrganizationSubscriptionClient build(
            ...
            return new OrganizationSubscriptionClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ListOrganizationSubscriptionsResponse listOrganizationSubscriptions(
        ...
        LOG.trace("Called listOrganizationSubscriptions");
        final ListOrganizationSubscriptionsRequest interceptedRequest =
