...
public final class InvoicingOrganization {
    ...
    public static class Builder {
        ...
        public InvoicingOrganization build() {
            InvoicingOrganization __instance__ = new InvoicingOrganization(name, number);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvoicingOrganization o) {
            Builder copiedBuilder = name(o.getName()).number(o.getNumber());
    ...
    public String toString() {
        ...
        sb.append("InvoicingOrganization(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvoicingOrganization)) {
            return false;
        }

        InvoicingOrganization other = (InvoicingOrganization) o;
