...
public class InvoiceSummaryAsyncClient implements InvoiceSummaryAsync {
    /**
    ...
    public static class Builder
        ...
        public InvoiceSummaryAsyncClient build(
            ...
            return new InvoiceSummaryAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ListInvoicelineComputedUsagesResponse>
            listInvoicelineComputedUsages(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listInvoicelineComputedUsages");
        final ListInvoicelineComputedUsagesRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListInvoicelineComputedUsagesRequest,
                                ListInvoicelineComputedUsagesResponse>,
                        java.util.concurrent.Future<ListInvoicelineComputedUsagesResponse>>
