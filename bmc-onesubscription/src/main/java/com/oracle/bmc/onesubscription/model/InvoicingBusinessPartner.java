...
public final class InvoicingBusinessPartner
    ...
    public static class Builder {
        ...
        public InvoicingBusinessPartner build() {
            InvoicingBusinessPartner model =
                    new InvoicingBusinessPartner(
                            this.name,
                            this.namePhonetic,
                            this.tcaCustomerAccountNumber,
                            this.isPublicSector,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvoicingBusinessPartner model) {
            ...
            if (model.wasPropertyExplicitlySet("tcaCustomerAccountNumber")) {
                this.tcaCustomerAccountNumber(model.getTcaCustomerAccountNumber());
            }
