...
public class ComputedUsagePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listAggregatedComputedUsages operation. This iterable
    ...
    public Iterable<ListAggregatedComputedUsagesResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListAggregatedComputedUsagesRequest.Builder, ListAggregatedComputedUsagesRequest,
                ListAggregatedComputedUsagesResponse>(
                new com.google.common.base.Supplier<ListAggregatedComputedUsagesRequest.Builder>() {
                    @Override
                ...
                new com.google.common.base.Function<
                        ListAggregatedComputedUsagesResponse, String>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.onesubscription.model.AggregatedComputedUsageSummary} objects
     * contained in responses from the listAggregatedComputedUsages operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.onesubscription.model.AggregatedComputedUsageSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.onesubscription.model.ComputedUsageSummary} objects
     * contained in responses from the listComputedUsages operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.onesubscription.model.ComputedUsageSummary} objects
     * contained in responses received from the service.
     */
