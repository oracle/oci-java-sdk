...
public interface SubscribedServiceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetSubscribedServiceResponse> getSubscribedService(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListSubscribedServicesResponse> listSubscribedServices(
