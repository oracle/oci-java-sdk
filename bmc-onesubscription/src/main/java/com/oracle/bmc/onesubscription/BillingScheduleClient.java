...
public class BillingScheduleClient implements BillingSchedule {
     ...
     */
    protected BillingScheduleClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public BillingScheduleClient build(
            ...
            return new BillingScheduleClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ListBillingSchedulesResponse listBillingSchedules(ListBillingSchedulesRequest request) {
        LOG.trace("Called listBillingSchedules");
        final ListBillingSchedulesRequest interceptedRequest =
