...
public class BillingScheduleClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, BillingScheduleClient> {
    ...
    public ListBillingSchedulesResponse listBillingSchedules(ListBillingSchedulesRequest request) {
        ...
        return clientCall(request, ListBillingSchedulesResponse::builder)
                .logger(LOG, "listBillingSchedules")
                .serviceDetails("BillingSchedule", "ListBillingSchedules", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListBillingSchedulesRequest::builder)
                .basePath("/20190111")
                .appendPathParam("billingSchedules")
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .appendQueryParam("subscriptionId", request.getSubscriptionId())
                .appendQueryParam("subscribedServiceId", request.getSubscribedServiceId())
                ...
                .handleBodyList(
                        com.oracle.bmc.onesubscription.model.BillingScheduleSummary.class,
                        ListBillingSchedulesResponse.Builder::items)
                .handleResponseHeaderString(
                        "opc-next-page", ListBillingSchedulesResponse.Builder::opcNextPage)
                .handleResponseHeaderString(
                        "opc-request-id", ListBillingSchedulesResponse.Builder::opcRequestId)
                .callSync();
    }
