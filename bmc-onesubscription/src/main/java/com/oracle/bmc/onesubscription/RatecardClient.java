...
public class RatecardClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    private RatecardClient(
        ...
        this.paginators = new RatecardPaginators(this);
    }
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, RatecardClient> {
    ...
    public ListRateCardsResponse listRateCards(ListRateCardsRequest request) {
        ...
        return clientCall(request, ListRateCardsResponse::builder)
                .logger(LOG, "listRateCards")
                .serviceDetails("Ratecard", "ListRateCards", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListRateCardsRequest::builder)
                .basePath("/20190111")
                .appendPathParam("ratecards")
                ...
                .appendQueryParam("partNumber", request.getPartNumber())
                ...
                .handleBodyList(
                        com.oracle.bmc.onesubscription.model.RateCardSummary.class,
                        ListRateCardsResponse.Builder::items)
                .handleResponseHeaderString(
                        "opc-next-page", ListRateCardsResponse.Builder::opcNextPage)
                .handleResponseHeaderString(
                        "opc-request-id", ListRateCardsResponse.Builder::opcRequestId)
                .callSync();
    }
