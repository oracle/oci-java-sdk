...
public class RatecardClient implements Ratecard {
    /**
    ...
    public ListRateCardsResponse listRateCards(ListRateCardsRequest request) {
        LOG.trace("Called listRateCards");
        final ListRateCardsRequest interceptedRequest =
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListRateCardsResponse> transformer =
