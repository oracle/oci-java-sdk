...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/onesubscription/ListCommitmentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCommitmentsRequest.
 */
...
public class ListCommitmentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCommitmentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCommitmentsRequest(subscribedServiceId, compartmentId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
