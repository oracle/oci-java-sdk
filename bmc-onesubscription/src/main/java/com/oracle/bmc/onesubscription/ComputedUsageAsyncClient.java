...
public class ComputedUsageAsyncClient implements ComputedUsageAsync {
    ...
    @Override
    public java.util.concurrent.Future<ListAggregatedComputedUsagesResponse>
            listAggregatedComputedUsages(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listAggregatedComputedUsages");
        ...
        com.oracle.bmc.responses.AsyncHandler<
                        ListAggregatedComputedUsagesRequest, ListAggregatedComputedUsagesResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListAggregatedComputedUsagesRequest,
                                ListAggregatedComputedUsagesResponse>,
                        java.util.concurrent.Future<ListAggregatedComputedUsagesResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
