...
public class ListOrganizationSubscriptionsConverter {
    ...
    public static com.oracle.bmc.onesubscription.requests.ListOrganizationSubscriptionsRequest
            interceptRequest(
                    com.oracle.bmc.onesubscription.requests.ListOrganizationSubscriptionsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.onesubscription.requests.ListOrganizationSubscriptionsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20190111").path("organizationSubscription");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.onesubscription.responses.ListOrganizationSubscriptionsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.onesubscription.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.onesubscription.responses.ListOrganizationSubscriptionsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
