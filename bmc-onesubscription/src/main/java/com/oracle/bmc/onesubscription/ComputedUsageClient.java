...
public class ComputedUsageClient implements ComputedUsage {
    ...
    public static class Builder
        ...
        public ComputedUsageClient build(
            ...
            return new ComputedUsageClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public GetComputedUsageResponse getComputedUsage(GetComputedUsageRequest request) {
        LOG.trace("Called getComputedUsage");
        final GetComputedUsageRequest interceptedRequest =
                GetComputedUsageConverter.interceptRequest(request);
    ...
    @Override
    public ListAggregatedComputedUsagesResponse listAggregatedComputedUsages(
            ListAggregatedComputedUsagesRequest request) {
        LOG.trace("Called listAggregatedComputedUsages");
        final ListAggregatedComputedUsagesRequest interceptedRequest =
                ListAggregatedComputedUsagesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListAggregatedComputedUsagesConverter.fromRequest(client, interceptedRequest);
        com.google.common.base.Function<
                        javax.ws.rs.core.Response, ListAggregatedComputedUsagesResponse>
                transformer = ListAggregatedComputedUsagesConverter.fromResponse();
        ...
        com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
        com.oracle.bmc.ServiceDetails.setServiceDetails(
                "ComputedUsage", "ListAggregatedComputedUsages", ib.getRequestUri().toString(), "");
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
    ...
    public ListComputedUsagesResponse listComputedUsages(ListComputedUsagesRequest request) {
        LOG.trace("Called listComputedUsages");
        final ListComputedUsagesRequest interceptedRequest =
                ListComputedUsagesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
