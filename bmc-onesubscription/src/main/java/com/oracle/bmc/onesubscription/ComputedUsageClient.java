...
public class ComputedUsageClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public static final com.oracle.bmc.Service SERVICE =
            com.oracle.bmc.Services.serviceBuilder()
                    .serviceName(ComputedUsageClient.class.getName())
    ...
    public GetComputedUsageResponse getComputedUsage(GetComputedUsageRequest request) {
        ...
        return clientCall(request, GetComputedUsageResponse::builder)
                ...
                .handleBody(
                        com.oracle.bmc.onesubscription.model.ComputedUsage.class,
    ...
    public ListAggregatedComputedUsagesResponse listAggregatedComputedUsages(
        ...
        return clientCall(request, ListAggregatedComputedUsagesResponse::builder)
                .logger(LOG, "listAggregatedComputedUsages")
                .serviceDetails("ComputedUsage", "ListAggregatedComputedUsages", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListAggregatedComputedUsagesRequest::builder)
                .basePath("/20190111")
                .appendPathParam("aggregatedComputedUsages")
                .appendQueryParam("compartmentId", request.getCompartmentId())
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBodyList(
                        com.oracle.bmc.onesubscription.model.AggregatedComputedUsageSummary.class,
                        ListAggregatedComputedUsagesResponse.Builder::items)
                .handleResponseHeaderString(
                        "opc-next-page", ListAggregatedComputedUsagesResponse.Builder::opcNextPage)
                .handleResponseHeaderString(
                        "opc-request-id",
                        ListAggregatedComputedUsagesResponse.Builder::opcRequestId)
                .callSync();
    }
    ...
    public ListComputedUsagesResponse listComputedUsages(ListComputedUsagesRequest request) {
        ...
        return clientCall(request, ListComputedUsagesResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBodyList(
                        com.oracle.bmc.onesubscription.model.ComputedUsageSummary.class,
