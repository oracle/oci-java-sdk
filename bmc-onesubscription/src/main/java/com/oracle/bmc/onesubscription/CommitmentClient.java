...
public class CommitmentClient implements Commitment {
    /**
    ...
    public GetCommitmentResponse getCommitment(GetCommitmentRequest request) {
        LOG.trace("Called getCommitment");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetCommitmentResponse> transformer =
    ...
    public ListCommitmentsResponse listCommitments(ListCommitmentsRequest request) {
        LOG.trace("Called listCommitments");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListCommitmentsResponse>
                transformer =
