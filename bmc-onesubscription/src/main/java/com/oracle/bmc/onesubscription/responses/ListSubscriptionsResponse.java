...
public class ListSubscriptionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.onesubscription.model.SubscriptionSummary} instances. */
    private java.util.List<com.oracle.bmc.onesubscription.model.SubscriptionSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.onesubscription.model.SubscriptionSummary> getItems() {
        return items;
    }
    ...
    private ListSubscriptionsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.onesubscription.model.SubscriptionSummary> items) {
