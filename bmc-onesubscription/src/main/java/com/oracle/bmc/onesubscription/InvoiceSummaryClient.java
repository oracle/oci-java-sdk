...
public class InvoiceSummaryClient implements InvoiceSummary {
    /**
     ...
     */
    protected InvoiceSummaryClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public InvoiceSummaryClient build(
            ...
            return new InvoiceSummaryClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ListInvoicelineComputedUsagesResponse listInvoicelineComputedUsages(
        ...
        LOG.trace("Called listInvoicelineComputedUsages");
