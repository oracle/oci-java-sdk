...
public class ListComputedUsagesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.onesubscription.model.ComputedUsageSummary> getItems() {
        return items;
    }
    ...
    private ListComputedUsagesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.onesubscription.model.ComputedUsageSummary> items) {
