...
public class CreateTopicResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTopicResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTopicResponse)) {
            return false;
        }

        CreateTopicResponse other = (CreateTopicResponse) o;
