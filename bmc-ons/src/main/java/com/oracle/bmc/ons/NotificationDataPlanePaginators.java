 ...
 * to any list operations of NotificationDataPlane where multiple pages of data may be fetched. Two
...
public class NotificationDataPlanePaginators {
     ...
     * com.oracle.bmc.ons.model.SubscriptionSummary} objects contained in responses from the
     * listSubscriptions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.ons.model.SubscriptionSummary} objects contained in responses received
     *     from the service.
     */
    public Iterable<com.oracle.bmc.ons.model.SubscriptionSummary> listSubscriptionsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListSubscriptionsRequest,
                ListSubscriptionsResponse,
                com.oracle.bmc.ons.model.SubscriptionSummary>(
                new java.util.function.Supplier<ListSubscriptionsRequest.Builder>() {
                    @Override
                    public ListSubscriptionsRequest.Builder get() {
                        return ListSubscriptionsRequest.builder().copy(request);
