 ...
 * to any list operations of NotificationDataPlane where multiple pages of data may be fetched.
...
public class NotificationDataPlanePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.ons.model.SubscriptionSummary} objects
     * contained in responses from the listSubscriptions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.ons.model.SubscriptionSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.ons.model.SubscriptionSummary> listSubscriptionsRecordIterator(
            final ListSubscriptionsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListSubscriptionsRequest.Builder, ListSubscriptionsRequest,
                ListSubscriptionsResponse, com.oracle.bmc.ons.model.SubscriptionSummary>(
                new com.google.common.base.Supplier<ListSubscriptionsRequest.Builder>() {
                    @Override
                    public ListSubscriptionsRequest.Builder get() {
                        return ListSubscriptionsRequest.builder().copy(request);
                ...
                new com.google.common.base.Function<
                        ListSubscriptionsResponse,
                        java.util.List<com.oracle.bmc.ons.model.SubscriptionSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.ons.model.SubscriptionSummary> apply(
