...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ons/ResendSubscriptionConfirmationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResendSubscriptionConfirmationRequest.
 */
...
public class ResendSubscriptionConfirmationRequest
    ...
    public static class Builder
         ...
         * @return instance of ResendSubscriptionConfirmationRequest
         */
        public ResendSubscriptionConfirmationRequest buildWithoutInvocationCallback() {
            ResendSubscriptionConfirmationRequest request =
                    new ResendSubscriptionConfirmationRequest();
            request.id = id;
            request.opcRequestId = opcRequestId;
            return request;
            // new ResendSubscriptionConfirmationRequest(id, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResendSubscriptionConfirmationRequest)) {
            return false;
        }

        ResendSubscriptionConfirmationRequest other = (ResendSubscriptionConfirmationRequest) o;
