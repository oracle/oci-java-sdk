...
public interface NotificationDataPlaneAsync extends AutoCloseable {
     ...
     *
     * <p>The topic endpoint is required for this operation. To get the topic endpoint, use {@link
     * #getTopic(GetTopicRequest, Consumer, Consumer) getTopic} and review the `apiEndpoint` value
     * in the response ({@link NotificationTopic}).
     *
     * <p>Limits information follows.
     *
     * <p>Message size limit per request: 64KB.
     *
     * <p>Message delivery rate limit per endpoint: 60 messages per minute for HTTP-based protocols,
     * 10 messages per minute for the `EMAIL` protocol. HTTP-based protocols use URL endpoints that
     * begin with \"http:\" or \"https:\".
     *
     * <p>Transactions Per Minute (TPM) per-tenancy limit for this operation: 60 per topic. (This
