...
/**
 * A summary of the properties that define a topic. <br>
...
public final class NotificationTopicSummary
    ...
    public NotificationTopicSummary(
            String name,
            String topicId,
            String shortTopicId,
    ...
    public static class Builder {
        ...
        public NotificationTopicSummary build() {
            NotificationTopicSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotificationTopicSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NotificationTopicSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotificationTopicSummary)) {
            return false;
        }

        NotificationTopicSummary other = (NotificationTopicSummary) o;
