...
public class UpdateTopicResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTopicResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTopicResponse)) {
            return false;
        }

        UpdateTopicResponse other = (UpdateTopicResponse) o;
