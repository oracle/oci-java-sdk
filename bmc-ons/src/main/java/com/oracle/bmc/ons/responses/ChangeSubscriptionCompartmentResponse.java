...
public class ChangeSubscriptionCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ChangeSubscriptionCompartmentResponse(int __httpStatusCode__, String opcRequestId) {
    ...
    public static class Builder {
        ...
        public ChangeSubscriptionCompartmentResponse build() {
            return new ChangeSubscriptionCompartmentResponse(__httpStatusCode__, opcRequestId);
        }
    }
}
