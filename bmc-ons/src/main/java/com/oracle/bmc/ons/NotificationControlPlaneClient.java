...
public class NotificationControlPlaneClient implements NotificationControlPlane {
     ...
     */
    protected NotificationControlPlaneClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public NotificationControlPlaneClient build(
                ...
                com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                        authenticationDetailsProvider) {
            return new NotificationControlPlaneClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeTopicCompartmentDetails(),
                                                retriedRequest);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateTopicDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetTopicResponse getTopic(GetTopicRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, GetTopicResponse> transformer =
                GetTopicConverter.fromResponse();
    ...
    public ListTopicsResponse listTopics(ListTopicsRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ListTopicsResponse> transformer =
                ListTopicsConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getTopicAttributesDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
