...
public class NotificationControlPlanePaginators {
     ...
     * com.oracle.bmc.ons.model.NotificationTopicSummary} objects contained in responses from the
     * listTopics operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.ons.model.NotificationTopicSummary} objects contained in responses
     *     received from the service.
     */
