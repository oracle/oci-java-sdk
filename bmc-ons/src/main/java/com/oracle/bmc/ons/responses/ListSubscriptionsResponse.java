...
public class ListSubscriptionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.ons.model.SubscriptionSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.ons.model.SubscriptionSummary> getItems() {
        return items;
    }
    ...
    private ListSubscriptionsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.ons.model.SubscriptionSummary> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.ons.model.SubscriptionSummary> items) {
            this.items = items;
            return this;
        }
