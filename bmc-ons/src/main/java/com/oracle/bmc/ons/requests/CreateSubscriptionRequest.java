...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ons/CreateSubscriptionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateSubscriptionRequest.
 */
...
public class CreateSubscriptionRequest
    ...
    public static class Builder
        ...
        public Builder createSubscriptionDetails(
                com.oracle.bmc.ons.model.CreateSubscriptionDetails createSubscriptionDetails) {
         ...
         * @return instance of CreateSubscriptionRequest
         */
        public CreateSubscriptionRequest buildWithoutInvocationCallback() {
            CreateSubscriptionRequest request = new CreateSubscriptionRequest();
            request.createSubscriptionDetails = createSubscriptionDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateSubscriptionRequest(createSubscriptionDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createSubscriptionDetails=")
                .append(String.valueOf(this.createSubscriptionDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createSubscriptionDetails, other.createSubscriptionDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createSubscriptionDetails == null
                                ? 43
                                : this.createSubscriptionDetails.hashCode());
        result =
                (result * PRIME)
