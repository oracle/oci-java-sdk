...
public class ListManagedInstancesConverter {
    ...
    public static com.oracle.bmc.wlms.requests.ListManagedInstancesRequest interceptRequest(
            com.oracle.bmc.wlms.requests.ListManagedInstancesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20241101").path("managedInstances");
        ...
        if (request.getPluginStatus() != null) {
            target =
                    target.queryParam(
                            "pluginStatus",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getPluginStatus().getValue()));
        }
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.wlms.responses.ListManagedInstancesResponse>() {
                            @Override
                            public com.oracle.bmc.wlms.responses.ListManagedInstancesResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.wlms.responses.ListManagedInstancesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.wlms.responses.ListManagedInstancesResponse.Builder
                                        builder =
