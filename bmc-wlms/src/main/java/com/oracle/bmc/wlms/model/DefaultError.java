...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DefaultError.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DefaultError extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public DefaultError build() {
            DefaultError model = new DefaultError(this.code, this.message);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DefaultError model) {
