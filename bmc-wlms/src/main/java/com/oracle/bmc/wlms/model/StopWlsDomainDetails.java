...
/**
 * The configuration details for the stop WebLogic domain operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StopWlsDomainDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StopWlsDomainDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isForceServersShutdown"})
    public StopWlsDomainDetails(Boolean isForceServersShutdown) {
        super();
    ...
    public static class Builder {
        ...
        public StopWlsDomainDetails build() {
            StopWlsDomainDetails model = new StopWlsDomainDetails(this.isForceServersShutdown);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StopWlsDomainDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StopWlsDomainDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopWlsDomainDetails)) {
            return false;
        }

        StopWlsDomainDetails other = (StopWlsDomainDetails) o;
