...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListAgreementRecordsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAgreementRecordsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListAgreementRecordsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAgreementRecordsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAgreementRecordsRequest o) {
        ...
        /**
         * Build the instance of ListAgreementRecordsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAgreementRecordsRequest
         */
        public ListAgreementRecordsRequest build() {
            ListAgreementRecordsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAgreementRecordsRequest
         */
        public ListAgreementRecordsRequest buildWithoutInvocationCallback() {
            ListAgreementRecordsRequest request = new ListAgreementRecordsRequest();
            ...
            return request;
            // new ListAgreementRecordsRequest(wlsDomainId, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAgreementRecordsRequest)) {
            return false;
        }

        ListAgreementRecordsRequest other = (ListAgreementRecordsRequest) o;
