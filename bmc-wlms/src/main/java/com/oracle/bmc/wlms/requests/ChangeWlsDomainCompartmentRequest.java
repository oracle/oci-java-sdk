...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ChangeWlsDomainCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeWlsDomainCompartmentRequest.
 */
...
public class ChangeWlsDomainCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeWlsDomainCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeWlsDomainCompartmentRequest(wlsDomainId, changeWlsDomainCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
