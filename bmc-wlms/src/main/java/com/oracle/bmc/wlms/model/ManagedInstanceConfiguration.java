...
/**
 * The configuration for a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedInstanceConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ManagedInstanceConfiguration
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"discoveryInterval", "domainSearchPaths"})
    public ManagedInstanceConfiguration(
    ...
    public static class Builder {
        ...
        public ManagedInstanceConfiguration build() {
            ManagedInstanceConfiguration model =
                    new ManagedInstanceConfiguration(
                            this.discoveryInterval, this.domainSearchPaths);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedInstanceConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedInstanceConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedInstanceConfiguration)) {
            return false;
        }

        ManagedInstanceConfiguration other = (ManagedInstanceConfiguration) o;
