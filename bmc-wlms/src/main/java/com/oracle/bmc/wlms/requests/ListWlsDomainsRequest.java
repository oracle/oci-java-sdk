...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListWlsDomainsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWlsDomainsRequest.
 */
...
public class ListWlsDomainsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListWlsDomainsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWlsDomainsRequest(compartmentId, lifecycleState, displayName, id, weblogicVersion, middlewareType, patchReadinessStatus, opcRequestId, opcRetryToken, limit, page, sortOrder, sortBy);
        }
    }
