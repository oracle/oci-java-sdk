...
public class ListManagedInstanceScanResultsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListManagedInstanceScanResultsConverter.class);

    public static com.oracle.bmc.wlms.requests.ListManagedInstanceScanResultsRequest
            interceptRequest(
                    com.oracle.bmc.wlms.requests.ListManagedInstanceScanResultsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getWlsDomainId() != null) {
            target =
                    target.queryParam(
                            "wlsDomainId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.wlms.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.wlms.responses.ListManagedInstanceScanResultsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.scanResultCollection(response.getItem());
