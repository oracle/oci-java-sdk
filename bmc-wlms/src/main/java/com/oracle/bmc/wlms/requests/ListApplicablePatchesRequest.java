...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListApplicablePatchesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApplicablePatchesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListApplicablePatchesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListApplicablePatchesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListApplicablePatchesRequest o) {
        ...
        /**
         * Build the instance of ListApplicablePatchesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListApplicablePatchesRequest
         */
        public ListApplicablePatchesRequest build() {
            ListApplicablePatchesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListApplicablePatchesRequest
         */
        public ListApplicablePatchesRequest buildWithoutInvocationCallback() {
            ListApplicablePatchesRequest request = new ListApplicablePatchesRequest();
            ...
            return request;
            // new ListApplicablePatchesRequest(wlsDomainId, opcRequestId, opcRetryToken, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListApplicablePatchesRequest)) {
            return false;
        }

        ListApplicablePatchesRequest other = (ListApplicablePatchesRequest) o;
