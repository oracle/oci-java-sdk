...
public class WeblogicManagementServicePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listAgreementRecords operation. This iterable
    ...
    public Iterable<ListAgreementRecordsResponse> listAgreementRecordsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListAgreementRecordsRequest.Builder, ListAgreementRecordsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.AgreementRecordSummary} objects
     * contained in responses from the listAgreementRecords operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.AgreementRecordSummary} objects
    ...
    public Iterable<com.oracle.bmc.wlms.model.AgreementRecordSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListAgreementRecordsRequest.Builder, ListAgreementRecordsRequest,
                ListAgreementRecordsResponse, com.oracle.bmc.wlms.model.AgreementRecordSummary>(
                new java.util.function.Supplier<ListAgreementRecordsRequest.Builder>() {
                    @Override
                    public ListAgreementRecordsRequest.Builder get() {
                        return ListAgreementRecordsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listApplicablePatches operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListApplicablePatchesResponse> listApplicablePatchesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListApplicablePatchesRequest.Builder, ListApplicablePatchesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ApplicablePatchSummary} objects
     * contained in responses from the listApplicablePatches operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ApplicablePatchSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.ApplicablePatchSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListApplicablePatchesRequest.Builder, ListApplicablePatchesRequest,
                ListApplicablePatchesResponse, com.oracle.bmc.wlms.model.ApplicablePatchSummary>(
                new java.util.function.Supplier<ListApplicablePatchesRequest.Builder>() {
                    @Override
                    public ListApplicablePatchesRequest.Builder get() {
                        return ListApplicablePatchesRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listManagedInstanceScanResults operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ScanResultSummary} objects
     * contained in responses from the listManagedInstanceScanResults operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ScanResultSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listManagedInstanceServerInstalledPatches operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.InstalledPatchSummary} objects
     * contained in responses from the listManagedInstanceServerInstalledPatches operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.InstalledPatchSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listManagedInstanceServers operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListManagedInstanceServersResponse> listManagedInstanceServersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListManagedInstanceServersRequest.Builder, ListManagedInstanceServersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ServerSummary} objects
     * contained in responses from the listManagedInstanceServers operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ServerSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.ServerSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListManagedInstanceServersRequest.Builder, ListManagedInstanceServersRequest,
                ListManagedInstanceServersResponse, com.oracle.bmc.wlms.model.ServerSummary>(
                new java.util.function.Supplier<ListManagedInstanceServersRequest.Builder>() {
                    @Override
                    public ListManagedInstanceServersRequest.Builder get() {
                        return ListManagedInstanceServersRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ManagedInstanceSummary} objects
     * contained in responses from the listManagedInstances operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ManagedInstanceSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.ManagedInstanceSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListManagedInstancesRequest.Builder, ListManagedInstancesRequest,
                ListManagedInstancesResponse, com.oracle.bmc.wlms.model.ManagedInstanceSummary>(
                new java.util.function.Supplier<ListManagedInstancesRequest.Builder>() {
                    @Override
                    public ListManagedInstancesRequest.Builder get() {
                        return ListManagedInstancesRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomainScanResults operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListWlsDomainScanResultsResponse> listWlsDomainScanResultsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListWlsDomainScanResultsRequest.Builder, ListWlsDomainScanResultsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ScanResultSummary} objects
     * contained in responses from the listWlsDomainScanResults operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ScanResultSummary} objects
    ...
    public Iterable<com.oracle.bmc.wlms.model.ScanResultSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWlsDomainScanResultsRequest.Builder, ListWlsDomainScanResultsRequest,
                ListWlsDomainScanResultsResponse, com.oracle.bmc.wlms.model.ScanResultSummary>(
                new java.util.function.Supplier<ListWlsDomainScanResultsRequest.Builder>() {
                    @Override
                    public ListWlsDomainScanResultsRequest.Builder get() {
                        return ListWlsDomainScanResultsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomainServerBackups operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListWlsDomainServerBackupsResponse> listWlsDomainServerBackupsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListWlsDomainServerBackupsRequest.Builder, ListWlsDomainServerBackupsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.BackupSummary} objects
     * contained in responses from the listWlsDomainServerBackups operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.BackupSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.BackupSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWlsDomainServerBackupsRequest.Builder, ListWlsDomainServerBackupsRequest,
                ListWlsDomainServerBackupsResponse, com.oracle.bmc.wlms.model.BackupSummary>(
                new java.util.function.Supplier<ListWlsDomainServerBackupsRequest.Builder>() {
                    @Override
                    public ListWlsDomainServerBackupsRequest.Builder get() {
                        return ListWlsDomainServerBackupsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomainServerInstalledPatches operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.InstalledPatchSummary} objects
     * contained in responses from the listWlsDomainServerInstalledPatches operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.InstalledPatchSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomainServers operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListWlsDomainServersResponse> listWlsDomainServersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListWlsDomainServersRequest.Builder, ListWlsDomainServersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.ServerSummary} objects
     * contained in responses from the listWlsDomainServers operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.ServerSummary} objects
    ...
    public Iterable<com.oracle.bmc.wlms.model.ServerSummary> listWlsDomainServersRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWlsDomainServersRequest.Builder, ListWlsDomainServersRequest,
                ListWlsDomainServersResponse, com.oracle.bmc.wlms.model.ServerSummary>(
                new java.util.function.Supplier<ListWlsDomainServersRequest.Builder>() {
                    @Override
                    public ListWlsDomainServersRequest.Builder get() {
                        return ListWlsDomainServersRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomains operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.WlsDomainSummary} objects
     * contained in responses from the listWlsDomains operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.WlsDomainSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listWlsDomainsSharingMiddlewares operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListWlsDomainsSharingMiddlewaresResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                ListWlsDomainsSharingMiddlewaresRequest, ListWlsDomainsSharingMiddlewaresResponse>(
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.WlsDomainSummary} objects
     * contained in responses from the listWlsDomainsSharingMiddlewares operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.WlsDomainSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestError} objects
     * contained in responses from the listWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.WorkRequestError> listWorkRequestErrorsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestErrorsRequest.Builder, ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse, com.oracle.bmc.wlms.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestLogEntry} objects
     * contained in responses from the listWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.wlms.model.WorkRequestLogEntry>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestLogsRequest.Builder, ListWorkRequestLogsRequest,
                ListWorkRequestLogsResponse, com.oracle.bmc.wlms.model.WorkRequestLogEntry>(
                new java.util.function.Supplier<ListWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListWorkRequestLogsRequest.Builder get() {
                        return ListWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestSummary} objects
     * contained in responses from the listWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.wlms.model.WorkRequestSummary} objects
     * contained in responses received from the service.
     */
