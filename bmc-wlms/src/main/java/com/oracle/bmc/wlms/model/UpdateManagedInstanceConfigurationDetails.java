...
/**
 * The managed instance configuration for update operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateManagedInstanceConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateManagedInstanceConfigurationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"discoveryInterval", "domainSearchPaths"})
    public UpdateManagedInstanceConfigurationDetails(
    ...
    public static class Builder {
        ...
        public UpdateManagedInstanceConfigurationDetails build() {
            UpdateManagedInstanceConfigurationDetails model =
                    new UpdateManagedInstanceConfigurationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateManagedInstanceConfigurationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateManagedInstanceConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagedInstanceConfigurationDetails)) {
            return false;
        }

        UpdateManagedInstanceConfigurationDetails other =
                (UpdateManagedInstanceConfigurationDetails) o;
