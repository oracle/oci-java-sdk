...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListWlsDomainServersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWlsDomainServersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListWlsDomainServersRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListWlsDomainServersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListWlsDomainServersRequest o) {
        ...
        /**
         * Build the instance of ListWlsDomainServersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWlsDomainServersRequest
         */
        public ListWlsDomainServersRequest build() {
            ListWlsDomainServersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWlsDomainServersRequest
         */
        public ListWlsDomainServersRequest buildWithoutInvocationCallback() {
            ListWlsDomainServersRequest request = new ListWlsDomainServersRequest();
            ...
            return request;
            // new ListWlsDomainServersRequest(wlsDomainId, name, opcRequestId, opcRetryToken, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWlsDomainServersRequest)) {
            return false;
        }

        ListWlsDomainServersRequest other = (ListWlsDomainServersRequest) o;
