...
public class GetWlsDomainServerBackupContentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetWlsDomainServerBackupContentConverter.class);

    public static com.oracle.bmc.wlms.requests.GetWlsDomainServerBackupContentRequest
            interceptRequest(
                    com.oracle.bmc.wlms.requests.GetWlsDomainServerBackupContentRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.wlms.responses.GetWlsDomainServerBackupContentResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.wlms.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.wlms.responses.GetWlsDomainServerBackupContentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.wlms.responses
                                                .GetWlsDomainServerBackupContentResponse.Builder
                                        builder =
                                                com.oracle.bmc.wlms.responses
                                                        .GetWlsDomainServerBackupContentResponse
                                                        .builder()
                                ...
                                builder.backupContent(response.getItem());
