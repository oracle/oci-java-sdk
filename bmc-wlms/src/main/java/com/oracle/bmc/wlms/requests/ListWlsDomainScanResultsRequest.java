...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListWlsDomainScanResultsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWlsDomainScanResultsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListWlsDomainScanResultsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListWlsDomainScanResultsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListWlsDomainScanResultsRequest o) {
        ...
        /**
         * Build the instance of ListWlsDomainScanResultsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWlsDomainScanResultsRequest
         */
        public ListWlsDomainScanResultsRequest build() {
            ListWlsDomainScanResultsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWlsDomainScanResultsRequest
         */
        public ListWlsDomainScanResultsRequest buildWithoutInvocationCallback() {
            ListWlsDomainScanResultsRequest request = new ListWlsDomainScanResultsRequest();
            ...
            return request;
            // new ListWlsDomainScanResultsRequest(wlsDomainId, serverName, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWlsDomainScanResultsRequest)) {
            return false;
        }

        ListWlsDomainScanResultsRequest other = (ListWlsDomainScanResultsRequest) o;
