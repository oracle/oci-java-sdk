...
public class ListWlsDomainsSharingMiddlewaresResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListWlsDomainsSharingMiddlewaresResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListWlsDomainsSharingMiddlewaresResponse o) {
         ...
         */
        @Override
        public ListWlsDomainsSharingMiddlewaresResponse build() {
            return new ListWlsDomainsSharingMiddlewaresResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWlsDomainsSharingMiddlewaresResponse)) {
            return false;
        }

        ListWlsDomainsSharingMiddlewaresResponse other =
                (ListWlsDomainsSharingMiddlewaresResponse) o;
