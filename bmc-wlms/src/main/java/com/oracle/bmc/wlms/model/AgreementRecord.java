...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AgreementRecord.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AgreementRecord extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public AgreementRecord build() {
            AgreementRecord model =
                    new AgreementRecord(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgreementRecord model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgreementRecord)) {
            return false;
        }

        AgreementRecord other = (AgreementRecord) o;
