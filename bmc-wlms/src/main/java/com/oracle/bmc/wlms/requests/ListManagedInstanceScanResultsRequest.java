...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListManagedInstanceScanResultsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedInstanceScanResultsRequest.
 */
...
public class ListManagedInstanceScanResultsRequest
    ...
    public static class Builder
        ...
        public ListManagedInstanceScanResultsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagedInstanceScanResultsRequest(managedInstanceId, opcRequestId, limit, page, sortOrder, sortBy, wlsDomainId, serverName);
        }
    }
