...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListWlsDomainServerBackupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWlsDomainServerBackupsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListWlsDomainServerBackupsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListWlsDomainServerBackupsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListWlsDomainServerBackupsRequest o) {
        ...
        /**
         * Build the instance of ListWlsDomainServerBackupsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWlsDomainServerBackupsRequest
         */
        public ListWlsDomainServerBackupsRequest build() {
            ListWlsDomainServerBackupsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWlsDomainServerBackupsRequest
         */
        public ListWlsDomainServerBackupsRequest buildWithoutInvocationCallback() {
            ListWlsDomainServerBackupsRequest request = new ListWlsDomainServerBackupsRequest();
            ...
            return request;
            // new ListWlsDomainServerBackupsRequest(wlsDomainId, serverId, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWlsDomainServerBackupsRequest)) {
            return false;
        }

        ListWlsDomainServerBackupsRequest other = (ListWlsDomainServerBackupsRequest) o;
