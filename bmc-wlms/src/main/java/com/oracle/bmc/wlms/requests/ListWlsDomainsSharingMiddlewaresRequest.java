...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/ListWlsDomainsSharingMiddlewaresExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWlsDomainsSharingMiddlewaresRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class ListWlsDomainsSharingMiddlewaresRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListWlsDomainsSharingMiddlewaresRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListWlsDomainsSharingMiddlewaresRequest o) {
        ...
        /**
         * Build the instance of ListWlsDomainsSharingMiddlewaresRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListWlsDomainsSharingMiddlewaresRequest
         */
        public ListWlsDomainsSharingMiddlewaresRequest build() {
            ListWlsDomainsSharingMiddlewaresRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListWlsDomainsSharingMiddlewaresRequest
         */
        public ListWlsDomainsSharingMiddlewaresRequest buildWithoutInvocationCallback() {
            ListWlsDomainsSharingMiddlewaresRequest request =
                    new ListWlsDomainsSharingMiddlewaresRequest();
            ...
            return request;
            // new ListWlsDomainsSharingMiddlewaresRequest(wlsDomainId, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWlsDomainsSharingMiddlewaresRequest)) {
            return false;
        }

        ListWlsDomainsSharingMiddlewaresRequest other = (ListWlsDomainsSharingMiddlewaresRequest) o;
