...
/**
 * Async client implementation for WeblogicManagementServiceConfiguration service. <br>
...
public class WeblogicManagementServiceConfigurationAsyncClient
        extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements WeblogicManagementServiceConfigurationAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    WeblogicManagementServiceConfigurationAsyncClient.class);

    WeblogicManagementServiceConfigurationAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, WeblogicManagementServiceConfigurationAsyncClient> {
         ...
         * @return the client
         */
        public WeblogicManagementServiceConfigurationAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new WeblogicManagementServiceConfigurationAsyncClient(
    ...
    public java.util.concurrent.Future<GetConfigurationResponse> getConfiguration(
        ...
        return clientCall(request, GetConfigurationResponse::builder)
                ...
                .serviceDetails(
                        ...
                        "GetConfiguration",
                        "https://docs.oracle.com/iaas/api/#/en/wlms/20241101/Configuration/GetConfiguration")
                ...
                .handleBody(
                        com.oracle.bmc.wlms.model.Configuration.class,
    ...
    public java.util.concurrent.Future<UpdateConfigurationResponse> updateConfiguration(
        ...
        return clientCall(request, UpdateConfigurationResponse::builder)
                ...
                .serviceDetails(
                        "WeblogicManagementServiceConfiguration",
                        "UpdateConfiguration",
                        "https://docs.oracle.com/iaas/api/#/en/wlms/20241101/Configuration/UpdateConfiguration")
     ...
     */
    @Deprecated
    public WeblogicManagementServiceConfigurationAsyncClient(
