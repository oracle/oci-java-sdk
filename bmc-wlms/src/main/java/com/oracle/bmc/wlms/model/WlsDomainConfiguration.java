...
/**
 * The WebLogic domain configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = WlsDomainConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class WlsDomainConfiguration
    ...
    public static class Builder {
        ...
        public WlsDomainConfiguration build() {
            WlsDomainConfiguration model =
                    new WlsDomainConfiguration(
                            this.isPatchEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WlsDomainConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WlsDomainConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WlsDomainConfiguration)) {
            return false;
        }

        WlsDomainConfiguration other = (WlsDomainConfiguration) o;
