...
/**
 * Details of installed patch in a server. <br>
...
public final class InstalledPatchSummary
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"id", "description", "displayName"})
    public InstalledPatchSummary(String id, String description, String displayName) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public InstalledPatchSummary build() {
            InstalledPatchSummary model =
                    new InstalledPatchSummary(this.id, this.description, this.displayName);
