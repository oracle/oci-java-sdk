...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/GetWlsDomainServerBackupContentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetWlsDomainServerBackupContentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class GetWlsDomainServerBackupContentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetWlsDomainServerBackupContentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetWlsDomainServerBackupContentRequest o) {
        ...
        /**
         * Build the instance of GetWlsDomainServerBackupContentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetWlsDomainServerBackupContentRequest
         */
        public GetWlsDomainServerBackupContentRequest build() {
            GetWlsDomainServerBackupContentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetWlsDomainServerBackupContentRequest
         */
        public GetWlsDomainServerBackupContentRequest buildWithoutInvocationCallback() {
            GetWlsDomainServerBackupContentRequest request =
                    new GetWlsDomainServerBackupContentRequest();
            request.wlsDomainId = wlsDomainId;
            request.serverId = serverId;
            request.backupId = backupId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetWlsDomainServerBackupContentRequest(wlsDomainId, serverId, backupId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWlsDomainServerBackupContentRequest)) {
            return false;
        }

        GetWlsDomainServerBackupContentRequest other = (GetWlsDomainServerBackupContentRequest) o;
