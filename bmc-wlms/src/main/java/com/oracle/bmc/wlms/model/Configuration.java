...
public final class Configuration extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public Configuration(Integer discoveryInterval, java.util.List<String> domainSearchPaths) {
        super();
    ...
    public static class Builder {
        ...
        public Configuration build() {
            Configuration model = new Configuration(this.discoveryInterval, this.domainSearchPaths);
