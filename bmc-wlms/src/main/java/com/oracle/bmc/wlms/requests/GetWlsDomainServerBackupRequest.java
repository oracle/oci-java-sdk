...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/GetWlsDomainServerBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetWlsDomainServerBackupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241101")
public class GetWlsDomainServerBackupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetWlsDomainServerBackupRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetWlsDomainServerBackupRequest o) {
        ...
        /**
         * Build the instance of GetWlsDomainServerBackupRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetWlsDomainServerBackupRequest
         */
        public GetWlsDomainServerBackupRequest build() {
            GetWlsDomainServerBackupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetWlsDomainServerBackupRequest
         */
        public GetWlsDomainServerBackupRequest buildWithoutInvocationCallback() {
            GetWlsDomainServerBackupRequest request = new GetWlsDomainServerBackupRequest();
            request.wlsDomainId = wlsDomainId;
            request.serverId = serverId;
            request.backupId = backupId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetWlsDomainServerBackupRequest(wlsDomainId, serverId, backupId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWlsDomainServerBackupRequest)) {
            return false;
        }

        GetWlsDomainServerBackupRequest other = (GetWlsDomainServerBackupRequest) o;
