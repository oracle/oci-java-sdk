...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/wlms/UpdateWlsDomainCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateWlsDomainCredentialRequest.
 */
...
public class UpdateWlsDomainCredentialRequest
    ...
    public static class Builder
        ...
        public UpdateWlsDomainCredentialRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateWlsDomainCredentialRequest(wlsDomainId, credentialType, updateWlsDomainCredentialDetails, ifMatch, opcRequestId);
        }
    }
