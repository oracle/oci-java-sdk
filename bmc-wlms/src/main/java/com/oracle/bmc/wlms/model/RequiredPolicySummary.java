...
/**
 * The summary information about the required policy for WebLogic Management Service. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RequiredPolicySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RequiredPolicySummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "description", "statements"})
    public RequiredPolicySummary(
            String name, String description, java.util.List<String> statements) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public RequiredPolicySummary build() {
            RequiredPolicySummary model =
                    new RequiredPolicySummary(this.name, this.description, this.statements);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RequiredPolicySummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RequiredPolicySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequiredPolicySummary)) {
            return false;
        }

        RequiredPolicySummary other = (RequiredPolicySummary) o;
