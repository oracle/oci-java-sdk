...
public final class TranscriptionTaskCollection
    ...
    public static class Builder {
        ...
        public TranscriptionTaskCollection build() {
            TranscriptionTaskCollection model = new TranscriptionTaskCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TranscriptionTaskCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TranscriptionTaskCollection)) {
            return false;
        }

        TranscriptionTaskCollection other = (TranscriptionTaskCollection) o;
