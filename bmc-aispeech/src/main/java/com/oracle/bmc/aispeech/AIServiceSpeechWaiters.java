...
public class AIServiceSpeechWaiters {
    ...
    private com.oracle.bmc.waiter.Waiter<GetCustomizationRequest, GetCustomizationResponse>
            forCustomization(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetCustomizationRequest request,
                    final com.oracle.bmc.aispeech.model.Customization.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.aispeech.model.Customization.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetCustomizationResponse apply(GetCustomizationRequest request) {
                                return client.getCustomization(request);
                            }
                        },
                        new java.util.function.Predicate<GetCustomizationResponse>() {
                            @Override
                            public boolean test(GetCustomizationResponse response) {
                                return targetStatesSet.contains(
                                        response.getCustomization().getLifecycleState());
                            }
                        },
