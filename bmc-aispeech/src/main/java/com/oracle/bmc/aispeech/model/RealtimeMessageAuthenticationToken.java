...
public final class RealtimeMessageAuthenticationToken extends RealtimeMessageAuthentication {
    ...
    public static class Builder {
        ...
        public RealtimeMessageAuthenticationToken build() {
            RealtimeMessageAuthenticationToken model =
                    new RealtimeMessageAuthenticationToken(this.compartmentId, this.token);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RealtimeMessageAuthenticationToken model) {
    ...
    @Deprecated
    public RealtimeMessageAuthenticationToken(String compartmentId, String token) {
        super(compartmentId);
        this.token = token;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RealtimeMessageAuthenticationToken(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RealtimeMessageAuthenticationToken)) {
            return false;
        }

        RealtimeMessageAuthenticationToken other = (RealtimeMessageAuthenticationToken) o;
