...
public class SynthesizeSpeechResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SynthesizeSpeechResponse> {
         ...
         */
        @Override
        public Builder copy(SynthesizeSpeechResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SynthesizeSpeechResponse)) {
            return false;
        }

        SynthesizeSpeechResponse other = (SynthesizeSpeechResponse) o;
