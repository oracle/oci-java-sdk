...
public final class ObjectListFileInputLocation extends InputLocation {
    ...
    public static class Builder {
        ...
        public ObjectListFileInputLocation build() {
            ObjectListFileInputLocation model =
                    new ObjectListFileInputLocation(this.objectLocation);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectListFileInputLocation model) {
