...
public class GetTranscriptionJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTranscriptionJobResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTranscriptionJobResponse)) {
            return false;
        }

        GetTranscriptionJobResponse other = (GetTranscriptionJobResponse) o;
