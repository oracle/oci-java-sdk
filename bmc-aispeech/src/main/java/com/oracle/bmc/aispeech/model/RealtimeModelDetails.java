...
public final class RealtimeModelDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public RealtimeModelDetails build() {
            RealtimeModelDetails model = new RealtimeModelDetails(this.domain, this.languageCode);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RealtimeModelDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RealtimeModelDetails)) {
            return false;
        }

        RealtimeModelDetails other = (RealtimeModelDetails) o;
