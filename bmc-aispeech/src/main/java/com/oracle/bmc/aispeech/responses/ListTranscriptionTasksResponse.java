...
public class ListTranscriptionTasksResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.aispeech.model.TranscriptionTaskCollection
            getTranscriptionTaskCollection() {
        return transcriptionTaskCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder transcriptionTaskCollection(
    ...
    public String toString() {
        ...
        sb.append(",transcriptionTaskCollection=")
                .append(String.valueOf(transcriptionTaskCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTranscriptionTasksResponse)) {
            return false;
        }

        ListTranscriptionTasksResponse other = (ListTranscriptionTasksResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.transcriptionTaskCollection, other.transcriptionTaskCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.transcriptionTaskCollection == null
                                ? 43
                                : this.transcriptionTaskCollection.hashCode());
        return result;
    }
}
