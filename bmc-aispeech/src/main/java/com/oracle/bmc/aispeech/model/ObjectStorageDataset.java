...
public final class ObjectStorageDataset extends CustomizationDatasetDetails {
    ...
    public static class Builder {
        ...
        public ObjectStorageDataset build() {
            ObjectStorageDataset model =
                    new ObjectStorageDataset(this.entityType, this.locationDetails);
    ...
    @Deprecated
    public ObjectStorageDataset(String entityType, LocationDetails locationDetails) {
        super();
        this.entityType = entityType;
        this.locationDetails = locationDetails;
    }
