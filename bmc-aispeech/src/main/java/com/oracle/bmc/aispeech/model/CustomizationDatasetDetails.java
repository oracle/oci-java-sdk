...
/**
 * Customization Training Dataset <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CustomizationDatasetDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStorageDataset.class,
            name = "OBJECT_STORAGE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = EntityListDataset.class,
            name = "ENTITY_LIST")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class CustomizationDatasetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected CustomizationDatasetDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CustomizationDatasetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomizationDatasetDetails)) {
            return false;
        }

        CustomizationDatasetDetails other = (CustomizationDatasetDetails) o;
