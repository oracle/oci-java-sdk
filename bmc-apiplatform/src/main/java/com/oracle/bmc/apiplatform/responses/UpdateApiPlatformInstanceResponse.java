...
public class UpdateApiPlatformInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateApiPlatformInstanceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateApiPlatformInstanceResponse o) {
         ...
         */
        @Override
        public UpdateApiPlatformInstanceResponse build() {
            return new UpdateApiPlatformInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateApiPlatformInstanceResponse)) {
            return false;
        }

        UpdateApiPlatformInstanceResponse other = (UpdateApiPlatformInstanceResponse) o;
