...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apiplatform/DeleteApiPlatformInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApiPlatformInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240829")
public class DeleteApiPlatformInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteApiPlatformInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteApiPlatformInstanceRequest o) {
        ...
        /**
         * Build the instance of DeleteApiPlatformInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteApiPlatformInstanceRequest
         */
        public DeleteApiPlatformInstanceRequest build() {
            DeleteApiPlatformInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteApiPlatformInstanceRequest
         */
        public DeleteApiPlatformInstanceRequest buildWithoutInvocationCallback() {
            DeleteApiPlatformInstanceRequest request = new DeleteApiPlatformInstanceRequest();
            request.apiPlatformInstanceId = apiPlatformInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteApiPlatformInstanceRequest(apiPlatformInstanceId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApiPlatformInstanceRequest)) {
            return false;
        }

        DeleteApiPlatformInstanceRequest other = (DeleteApiPlatformInstanceRequest) o;
