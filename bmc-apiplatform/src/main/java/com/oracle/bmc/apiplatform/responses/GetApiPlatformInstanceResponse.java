...
public class GetApiPlatformInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetApiPlatformInstanceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetApiPlatformInstanceResponse o) {
         ...
         */
        @Override
        public GetApiPlatformInstanceResponse build() {
            return new GetApiPlatformInstanceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, apiPlatformInstance);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApiPlatformInstanceResponse)) {
            return false;
        }

        GetApiPlatformInstanceResponse other = (GetApiPlatformInstanceResponse) o;
