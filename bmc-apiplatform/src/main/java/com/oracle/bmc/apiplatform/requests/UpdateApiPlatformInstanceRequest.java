...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apiplatform/UpdateApiPlatformInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateApiPlatformInstanceRequest.
 */
...
public class UpdateApiPlatformInstanceRequest
    ...
    public static class Builder
        ...
        public UpdateApiPlatformInstanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateApiPlatformInstanceRequest(apiPlatformInstanceId, updateApiPlatformInstanceDetails, ifMatch, opcRequestId);
        }
    }
