...
public class ApiPlatformWaiters {
    ...
    public ApiPlatformWaiters(
            java.util.concurrent.ExecutorService executorService, ApiPlatform client) {
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forApiPlatformInstance(
                    GetApiPlatformInstanceRequest request,
                    com.oracle.bmc.apiplatform.model.ApiPlatformInstance.LifecycleState targetState,
    ...
    // Helper method to create a new Waiter for ApiPlatformInstance.
    private com.oracle.bmc.waiter.Waiter<
                    GetApiPlatformInstanceRequest, GetApiPlatformInstanceResponse>
            forApiPlatformInstance(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetApiPlatformInstanceRequest request,
                    final com.oracle.bmc.apiplatform.model.ApiPlatformInstance.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.apiplatform.model.ApiPlatformInstance.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetApiPlatformInstanceRequest, GetApiPlatformInstanceResponse>() {
                            @Override
                            public GetApiPlatformInstanceResponse apply(
                                    GetApiPlatformInstanceRequest request) {
                                return client.getApiPlatformInstance(request);
                            }
                        },
                        new java.util.function.Predicate<GetApiPlatformInstanceResponse>() {
                            @Override
                            public boolean test(GetApiPlatformInstanceResponse response) {
                                return targetStatesSet.contains(
                                        response.getApiPlatformInstance().getLifecycleState());
                            }
                        },
