...
public interface ApiPlatformAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateApiPlatformInstanceResponse> createApiPlatformInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteApiPlatformInstanceResponse> deleteApiPlatformInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetApiPlatformInstanceResponse> getApiPlatformInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListApiPlatformInstancesResponse> listApiPlatformInstances(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateApiPlatformInstanceResponse> updateApiPlatformInstance(
