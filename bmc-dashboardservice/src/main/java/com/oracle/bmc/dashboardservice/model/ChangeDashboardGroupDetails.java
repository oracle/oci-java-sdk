...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ChangeDashboardGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ChangeDashboardGroupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dashboardGroupId"})
    public ChangeDashboardGroupDetails(String dashboardGroupId) {
        super();
    ...
    public static class Builder {
         ...
         * dashboardGroup into which the resource should be moved.
         */
        ...
        public ChangeDashboardGroupDetails build() {
            ChangeDashboardGroupDetails model =
                    new ChangeDashboardGroupDetails(this.dashboardGroupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeDashboardGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDashboardGroupDetails)) {
            return false;
        }

        ChangeDashboardGroupDetails other = (ChangeDashboardGroupDetails) o;
