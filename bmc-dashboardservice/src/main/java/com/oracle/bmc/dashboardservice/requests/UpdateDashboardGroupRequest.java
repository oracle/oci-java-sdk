...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dashboardservice/UpdateDashboardGroupExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDashboardGroupRequest.
 */
...
public class UpdateDashboardGroupRequest
    ...
    public static class Builder
        ...
        public UpdateDashboardGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDashboardGroupRequest(dashboardGroupId, updateDashboardGroupDetails,
            // ifMatch, opcRequestId, opcCrossRegion);
        }
    }
