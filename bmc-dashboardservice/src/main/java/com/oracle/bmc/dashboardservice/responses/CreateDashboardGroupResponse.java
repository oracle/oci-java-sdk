...
public class CreateDashboardGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateDashboardGroupResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDashboardGroupResponse> {
         ...
         */
        @Override
        public Builder copy(CreateDashboardGroupResponse o) {
         ...
         */
        @Override
        public CreateDashboardGroupResponse build() {
            return new CreateDashboardGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDashboardGroupResponse)) {
            return false;
        }

        CreateDashboardGroupResponse other = (CreateDashboardGroupResponse) o;
