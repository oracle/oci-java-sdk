 ...
 * to any list operations of DashboardGroup where multiple pages of data may be fetched. Two styles
...
public class DashboardGroupPaginators {
     ...
     * listDashboardGroups operation. This iterable will fetch more data from the server as needed.
     *
    ...
    public Iterable<ListDashboardGroupsResponse> listDashboardGroupsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Supplier<ListDashboardGroupsRequest.Builder>() {
                    @Override
                    public ListDashboardGroupsRequest.Builder get() {
                        return ListDashboardGroupsRequest.builder().copy(request);
                    }
                },
                new java.util.function.Function<ListDashboardGroupsResponse, String>() {
                    @Override
     ...
     * com.oracle.bmc.dashboardservice.model.DashboardGroupSummary} objects contained in responses
     * from the listDashboardGroups operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.dashboardservice.model.DashboardGroupSummary} objects contained in
