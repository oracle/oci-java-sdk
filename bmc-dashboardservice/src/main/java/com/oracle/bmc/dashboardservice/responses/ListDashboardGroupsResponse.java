...
public class ListDashboardGroupsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.dashboardservice.model.DashboardGroupCollection
            getDashboardGroupCollection() {
        return dashboardGroupCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListDashboardGroupsResponse> {
         ...
         * @return this builder
         */
        public Builder dashboardGroupCollection(
                com.oracle.bmc.dashboardservice.model.DashboardGroupCollection
                        dashboardGroupCollection) {
            this.dashboardGroupCollection = dashboardGroupCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",dashboardGroupCollection=").append(String.valueOf(dashboardGroupCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDashboardGroupsResponse)) {
            return false;
        }

        ListDashboardGroupsResponse other = (ListDashboardGroupsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.dashboardGroupCollection, other.dashboardGroupCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dashboardGroupCollection == null
                                ? 43
                                : this.dashboardGroupCollection.hashCode());
        return result;
    }
}
