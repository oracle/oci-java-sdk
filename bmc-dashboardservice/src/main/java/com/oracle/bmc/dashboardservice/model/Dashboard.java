...
/**
 * The base schema for a dashboard. Derived schemas have configurations and widgets specific to the
 * {@code schemaVersion}. <br>
...
public class Dashboard extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
