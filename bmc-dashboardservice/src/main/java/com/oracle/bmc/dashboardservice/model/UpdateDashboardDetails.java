...
/**
 * The base schema for updating a dashboard. Derived schemas have configurations and widgets
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = UpdateDashboardDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateV1DashboardDetails.class,
            name = "V1")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class UpdateDashboardDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "description", "freeformTags", "definedTags"})
    protected UpdateDashboardDetails(
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDashboardDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDashboardDetails)) {
            return false;
        }

        UpdateDashboardDetails other = (UpdateDashboardDetails) o;
