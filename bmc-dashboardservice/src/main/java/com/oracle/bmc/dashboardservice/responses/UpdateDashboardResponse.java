...
public class UpdateDashboardResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public UpdateDashboardResponse build() {
            return new UpdateDashboardResponse(__httpStatusCode__, etag, opcRequestId, dashboard);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDashboardResponse)) {
            return false;
        }

        UpdateDashboardResponse other = (UpdateDashboardResponse) o;
