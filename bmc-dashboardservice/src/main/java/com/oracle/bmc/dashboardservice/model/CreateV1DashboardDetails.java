...
/**
 * Details for creating a version 1 dashboard. The interpretation of the {@code config} and {@code
...
public final class CreateV1DashboardDetails extends CreateDashboardDetails {
    ...
    public static class Builder {
        ...
        public CreateV1DashboardDetails build() {
            CreateV1DashboardDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateV1DashboardDetails model) {
