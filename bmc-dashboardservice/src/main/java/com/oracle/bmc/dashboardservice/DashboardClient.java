...
public class DashboardClient implements Dashboard {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DashboardClient.class);
    ...
    public ChangeDashboardGroupResponse changeDashboardGroup(ChangeDashboardGroupRequest request) {
        LOG.trace("Called changeDashboardGroup");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ChangeDashboardGroupResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeDashboardGroupDetails(),
                                                retriedRequest);
    ...
    public CreateDashboardResponse createDashboard(CreateDashboardRequest request) {
        LOG.trace("Called createDashboard");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDashboardDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteDashboardResponse deleteDashboard(DeleteDashboardRequest request) {
        LOG.trace("Called deleteDashboard");
    ...
    public ListDashboardsResponse listDashboards(ListDashboardsRequest request) {
        LOG.trace("Called listDashboards");
    ...
    public UpdateDashboardResponse updateDashboard(UpdateDashboardRequest request) {
        LOG.trace("Called updateDashboard");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateDashboardDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
