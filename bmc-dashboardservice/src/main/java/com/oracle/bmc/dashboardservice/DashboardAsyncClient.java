...
public class DashboardAsyncClient implements DashboardAsync {
    /**
    ...
    public static class Builder
        ...
        public DashboardAsyncClient build(
            ...
            return new DashboardAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ChangeDashboardGroupResponse> changeDashboardGroup(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async changeDashboardGroup");
        final ChangeDashboardGroupRequest interceptedRequest =
                ChangeDashboardGroupConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeDashboardGroupConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ChangeDashboardGroupResponse>
                transformer =
                        ChangeDashboardGroupConverter.fromResponse(
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ChangeDashboardGroupRequest, ChangeDashboardGroupResponse>,
                        java.util.concurrent.Future<ChangeDashboardGroupResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getChangeDashboardGroupDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<CreateDashboardResponse> createDashboard(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async createDashboard");
        final CreateDashboardRequest interceptedRequest =
                CreateDashboardConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateDashboardConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CreateDashboardResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateDashboardRequest, CreateDashboardResponse>,
                        java.util.concurrent.Future<CreateDashboardResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateDashboardDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<DeleteDashboardResponse> deleteDashboard(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async deleteDashboard");
        final DeleteDashboardRequest interceptedRequest =
                DeleteDashboardConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, DeleteDashboardResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeleteDashboardRequest, DeleteDashboardResponse>,
                        java.util.concurrent.Future<DeleteDashboardResponse>>
    ...
    public java.util.concurrent.Future<GetDashboardResponse> getDashboard(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetDashboardRequest, GetDashboardResponse>
                    handler) {
        LOG.trace("Called async getDashboard");
        final GetDashboardRequest interceptedRequest =
                GetDashboardConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetDashboardResponse>
                transformer =
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<GetDashboardResponse>>
    ...
    public java.util.concurrent.Future<ListDashboardsResponse> listDashboards(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listDashboards");
        final ListDashboardsRequest interceptedRequest =
                ListDashboardsConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListDashboardsResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListDashboardsRequest, ListDashboardsResponse>,
                        java.util.concurrent.Future<ListDashboardsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<UpdateDashboardResponse> updateDashboard(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async updateDashboard");
        final UpdateDashboardRequest interceptedRequest =
                UpdateDashboardConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, UpdateDashboardResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateDashboardRequest, UpdateDashboardResponse>,
                        java.util.concurrent.Future<UpdateDashboardResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateDashboardDetails(),
                                ib,
                                transformer);
