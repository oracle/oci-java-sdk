...
public class StackAsyncClient implements StackAsync {
    /**
    ...
    public java.util.concurrent.Future<AddServiceResponse> addService(
            ...
            final com.oracle.bmc.responses.AsyncHandler<AddServiceRequest, AddServiceResponse>
                    handler) {
        LOG.trace("Called async addService");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, AddServiceResponse>
                transformer =
                        AddServiceConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<AddServiceRequest, AddServiceResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                AddServiceRequest, AddServiceResponse>,
                        java.util.concurrent.Future<AddServiceResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getAddServiceDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<DeployArtifactsResponse> deployArtifacts(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async deployArtifacts");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, DeployArtifactsResponse>
                transformer =
                        DeployArtifactsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<DeployArtifactsRequest, DeployArtifactsResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeployArtifactsRequest, DeployArtifactsResponse>,
                        java.util.concurrent.Future<DeployArtifactsResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getDeployArtifactsDetails(),
                                ib,
                                transformer);
