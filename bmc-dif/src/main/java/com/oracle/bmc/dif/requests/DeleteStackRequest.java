...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dif/DeleteStackExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteStackRequest.
 */
...
public class DeleteStackRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteStackRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteStackRequest(stackId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().stackId(stackId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
