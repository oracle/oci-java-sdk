...
public final class ShapeConfig extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"memoryInGBs", "ocpus"})
    public ShapeConfig(Integer memoryInGBs, Integer ocpus) {
        super();
    ...
    public static class Builder {
        ...
        public ShapeConfig build() {
            ShapeConfig model = new ShapeConfig(this.memoryInGBs, this.ocpus);
