...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DataflowDetail.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DataflowDetail extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private DataflowConnections connections;

        public Builder connections(DataflowConnections connections) {
            this.connections = connections;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataflowDetail model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("connections")
    private final DataflowConnections connections;

    public DataflowConnections getConnections() {
        return connections;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataflowDetail)) {
            return false;
        }

        DataflowDetail other = (DataflowDetail) o;
