...
import com.oracle.bmc.dif.internal.http.*;
...
public class StackClient implements Stack {
    /**
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(StackClient.class);

    com.oracle.bmc.http.internal.RestClient getClient() {
        return client;
    }

    private final StackWaiters waiters;

    private final StackPaginators paginators;
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("Stack-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new StackWaiters(executorService, this);

        this.paginators = new StackPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, StackClient> {
    ...
    public AddServiceResponse addService(AddServiceRequest request) {
        LOG.trace("Called addService");
        final AddServiceRequest interceptedRequest = AddServiceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                AddServiceConverter.fromRequest(client, interceptedRequest);
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "AddService", ib.getRequestUri().toString(), "");
        java.util.function.Function<javax.ws.rs.core.Response, AddServiceResponse> transformer =
                AddServiceConverter.fromResponse(java.util.Optional.of(serviceDetails));
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getAddServiceDetails(),
                                                retriedRequest);
    ...
    public CancelWorkRequestResponse cancelWorkRequest(CancelWorkRequestRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "CancelWorkRequest", ib.getRequestUri().toString(), "");
    ...
    public ChangeStackCompartmentResponse changeStackCompartment(
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "ChangeStackCompartment", ib.getRequestUri().toString(), "");
    ...
    public CreateStackResponse createStack(CreateStackRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "CreateStack", ib.getRequestUri().toString(), "");
    ...
    public DeleteStackResponse deleteStack(DeleteStackRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "DeleteStack", ib.getRequestUri().toString(), "");
    ...
    @Override
    public DeployArtifactsResponse deployArtifacts(DeployArtifactsRequest request) {
        LOG.trace("Called deployArtifacts");
        final DeployArtifactsRequest interceptedRequest =
                DeployArtifactsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeployArtifactsConverter.fromRequest(client, interceptedRequest);
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "DeployArtifacts", ib.getRequestUri().toString(), "");
        java.util.function.Function<javax.ws.rs.core.Response, DeployArtifactsResponse>
                transformer =
                        DeployArtifactsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getDeployArtifactsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetStackResponse getStack(GetStackRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "GetStack", ib.getRequestUri().toString(), "");
    ...
    public GetWorkRequestResponse getWorkRequest(GetWorkRequestRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "GetWorkRequest", ib.getRequestUri().toString(), "");
    ...
    public ListStacksResponse listStacks(ListStacksRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "ListStacks", ib.getRequestUri().toString(), "");
    ...
    public ListWorkRequestErrorsResponse listWorkRequestErrors(
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "ListWorkRequestErrors", ib.getRequestUri().toString(), "");
    ...
    public ListWorkRequestLogsResponse listWorkRequestLogs(ListWorkRequestLogsRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "ListWorkRequestLogs", ib.getRequestUri().toString(), "");
    ...
    public ListWorkRequestsResponse listWorkRequests(ListWorkRequestsRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "ListWorkRequests", ib.getRequestUri().toString(), "");
    ...
    public UpdateStackResponse updateStack(UpdateStackRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Stack", "UpdateStack", ib.getRequestUri().toString(), "");
    ...
    @Override
    public StackWaiters getWaiters() {
        return waiters;
    }

    @Override
    public StackPaginators getPaginators() {
        return paginators;
    }
}
