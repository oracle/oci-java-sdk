...
public class StackClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Stack {
        ...
        public StackClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new StackClient(this, authenticationDetailsProvider, executorService);
        }
    }
