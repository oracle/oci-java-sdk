...
/**
 * Detail to deploy artifacts for OKE service. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OkeArtifactsDetail.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OkeArtifactsDetail
    ...
    public static class Builder {
        ...
        /**
         * List of kubernetes secrets to create or update in the namespace-name of the target
         * cluster. Each entry source secret values from OCI vault.
         */
        ...
        public OkeArtifactsDetail build() {
            OkeArtifactsDetail model =
                    new OkeArtifactsDetail(
                            this.instanceId,
                            this.secrets,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeArtifactsDetail model) {
    ...
    /**
     * List of kubernetes secrets to create or update in the namespace-name of the target cluster.
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeArtifactsDetail)) {
            return false;
        }

        OkeArtifactsDetail other = (OkeArtifactsDetail) o;
