...
/**
 * Details of Object Storage instance to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageUpdateDetail.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ObjectStorageUpdateDetail
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"instanceId", "objectVersioning", "autoTiering"})
    public ObjectStorageUpdateDetail(
            String instanceId, ObjectVersioning objectVersioning, AutoTiering autoTiering) {
        super();
    ...
    public static class Builder {
        ...
        public ObjectStorageUpdateDetail build() {
            ObjectStorageUpdateDetail model =
                    new ObjectStorageUpdateDetail(
                            this.instanceId, this.objectVersioning, this.autoTiering);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageUpdateDetail model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectStorageUpdateDetail(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageUpdateDetail)) {
            return false;
        }

        ObjectStorageUpdateDetail other = (ObjectStorageUpdateDetail) o;
