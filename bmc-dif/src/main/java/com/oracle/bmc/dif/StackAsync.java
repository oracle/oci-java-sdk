...
public interface StackAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<AddServiceResponse> addService(
            AddServiceRequest request,
            com.oracle.bmc.responses.AsyncHandler<AddServiceRequest, AddServiceResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeployArtifactsResponse> deployArtifacts(
