...
public class ListIncidentsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.cims.model.IncidentSummary> items) {
            this.items = items;
            return this;
        }
        ...
        public ListIncidentsResponse build() {
            return new ListIncidentsResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        ListIncidentsResponse other = (ListIncidentsResponse) o;
