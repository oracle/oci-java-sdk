...
public class IncidentAsyncClient implements IncidentAsync {
    ...
    public java.util.concurrent.Future<CreateIncidentResponse> createIncident(
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CreateIncidentResponse>
                transformer =
    ...
    public java.util.concurrent.Future<GetIncidentResponse> getIncident(
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetIncidentResponse>
                transformer =
    ...
    public java.util.concurrent.Future<ListIncidentsResponse> listIncidents(
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListIncidentsResponse>
                transformer =
    ...
    @Override
    public java.util.concurrent.Future<PutAttachmentResponse> putAttachment(
            PutAttachmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<PutAttachmentRequest, PutAttachmentResponse>
                    handler) {
        LOG.trace("Called async putAttachment");
        if (request.getRetryConfiguration() != null
                || authenticationDetailsProvider
                        instanceof com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider) {
            request =
                    com.oracle.bmc.retrier.Retriers.wrapBodyInputStreamIfNecessary(
                            request, PutAttachmentRequest.builder());
        }
        final PutAttachmentRequest interceptedRequest =
                PutAttachmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                PutAttachmentConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Incident",
                        "PutAttachment",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, PutAttachmentResponse>
                transformer =
                        PutAttachmentConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                PutAttachmentRequest, PutAttachmentResponse>,
                        java.util.concurrent.Future<PutAttachmentResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getPutAttachmentDetails(),
                                ib,
                                transformer);
            ...
            return new com.oracle.bmc.util.internal.RefreshAuthTokenWrapper<
                ...
                protected void beforeRetryAction() {
                    ...
                    com.oracle.bmc.retrier.Retriers.tryResetStreamForRetry(
                            interceptedRequest.getPutAttachmentDetails(), true);
                }
            };
        } else {
            return futureSupplier.apply(handlerToUse);
    ...
    public java.util.concurrent.Future<UpdateIncidentResponse> updateIncident(
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, UpdateIncidentResponse>
                transformer =
    ...
    public java.util.concurrent.Future<ValidateUserResponse> validateUser(
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ValidateUserResponse>
                transformer =
