...
public class PutAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutAttachmentResponse> {
         ...
         */
        @Override
        public Builder copy(PutAttachmentResponse o) {
         ...
         */
        @Override
        public PutAttachmentResponse build() {
            return new PutAttachmentResponse(__httpStatusCode__, headers, opcRequestId, incident);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutAttachmentResponse)) {
            return false;
        }

        PutAttachmentResponse other = (PutAttachmentResponse) o;
