...
/**
 * Details about the TechSupportItem object. <br>
...
public final class TechSupportItem extends Item {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TechSupportItem model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TechSupportItem)) {
            return false;
        }

        TechSupportItem other = (TechSupportItem) o;
