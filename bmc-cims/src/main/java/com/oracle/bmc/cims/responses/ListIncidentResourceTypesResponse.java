...
public class ListIncidentResourceTypesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.cims.model.IncidentResourceType> items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIncidentResourceTypesResponse)) {
            return false;
        }

        ListIncidentResourceTypesResponse other = (ListIncidentResourceTypesResponse) o;
