...
public class PutAttachmentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PutAttachmentConverter.class);

    public static com.oracle.bmc.cims.requests.PutAttachmentRequest interceptRequest(
            com.oracle.bmc.cims.requests.PutAttachmentRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getPutAttachmentDetails(), "putAttachmentDetails is required");
        Validate.notBlank(request.getIncidentKey(), "incidentKey must not be blank");
        Validate.notNull(request.getAttachmentName(), "attachmentName is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");
        Validate.notNull(request.getIsRestrictedFlag(), "isRestrictedFlag is required");
    ...
    public static java.util.function.Function<
                    javax.ws.rs.core.Response, com.oracle.bmc.cims.responses.PutAttachmentResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cims.responses.PutAttachmentResponse>() {
                            @Override
                            public com.oracle.bmc.cims.responses.PutAttachmentResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cims.responses.PutAttachmentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.cims.responses.PutAttachmentResponse.Builder
                                        builder =
                                                com.oracle.bmc.cims.responses.PutAttachmentResponse
                                                        .builder()
