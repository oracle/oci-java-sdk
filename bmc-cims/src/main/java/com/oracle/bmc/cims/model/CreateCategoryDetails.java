...
public final class CreateCategoryDetails {
    ...
    public static class Builder {
        ...
        public CreateCategoryDetails build() {
            CreateCategoryDetails __instance__ = new CreateCategoryDetails(categoryKey);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCategoryDetails o) {
            Builder copiedBuilder = categoryKey(o.getCategoryKey());
