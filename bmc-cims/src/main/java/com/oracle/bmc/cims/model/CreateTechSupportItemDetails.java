...
public class CreateTechSupportItemDetails extends CreateItemDetails {
    ...
    public static class Builder {
        ...
        public CreateTechSupportItemDetails build() {
            CreateTechSupportItemDetails __instance__ =
                    new CreateTechSupportItemDetails(category, subCategory, issueType, name);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTechSupportItemDetails o) {
