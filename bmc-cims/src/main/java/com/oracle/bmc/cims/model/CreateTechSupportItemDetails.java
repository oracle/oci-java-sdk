...
/**
 * Details about the issue that the technical support request relates to. Avoid entering
 * confidential information. For information about {@code TECH} support requests, see [Creating a
 * Technical Support
 * Request](https://docs.oracle.com/iaas/Content/GSG/support/create-incident-technical.htm). <br>
