...
public class PutAttachmentRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
    ...
    public static class Builder
        ...
        public PutAttachmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutAttachmentRequest(putAttachmentDetails, incidentKey, attachmentName, compartmentId, isRestrictedFlag, opcRequestId, ocid, ifMatch, homeregion, problemtype, bearertokentype, bearertoken, idtoken, domainid);
        }
    }
