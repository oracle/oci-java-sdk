 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutAttachmentRequest.
 */
...
public class PutAttachmentRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
    ...
    /**
     * The name of the file to attach to the support request. Avoid entering confidential
     * information.
     */
    ...
    /**
     * Set to {@code true} when the attachment contains personal information (PI) or protected
