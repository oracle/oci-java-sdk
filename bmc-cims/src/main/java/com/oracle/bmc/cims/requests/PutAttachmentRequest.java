...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cims/PutAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutAttachmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181231")
public class PutAttachmentRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {

    /**
     * File to be uploaded as attachment to the Service Request.
     */
    private java.io.InputStream putAttachmentDetails;

    /**
     * File to be uploaded as attachment to the Service Request.
     */
    public java.io.InputStream getPutAttachmentDetails() {
        return putAttachmentDetails;
    }
    /**
     ...
     *
     */
    public Boolean getIsRestrictedFlag() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutAttachmentRequest, java.io.InputStream> {
         ...
         * File to be uploaded as attachment to the Service Request.
         */
        private java.io.InputStream putAttachmentDetails = null;

        /**
         * File to be uploaded as attachment to the Service Request.
         * @param putAttachmentDetails the value to set
         * @return this builder instance
         */
        public Builder putAttachmentDetails(java.io.InputStream putAttachmentDetails) {
            this.putAttachmentDetails = putAttachmentDetails;
            return this;
        }
        ...
        /**
         * The name of the file to attach to the support request. Avoid entering confidential information.
         * @param attachmentName the value to set
         * @return this builder instance
         */
         ...
         *
         */
        private Boolean isRestrictedFlag = null;

        /**
         * Set to {@code true} when the attachment contains personal information (PI)
         * or protected health information (PHI).
         *
         * @param isRestrictedFlag the value to set
         * @return this builder instance
         */
        public Builder isRestrictedFlag(Boolean isRestrictedFlag) {
            this.isRestrictedFlag = isRestrictedFlag;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(PutAttachmentRequest o) {
            putAttachmentDetails(o.getPutAttachmentDetails());
        ...
        /**
         * Build the instance of PutAttachmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutAttachmentRequest
         */
        public PutAttachmentRequest build() {
            PutAttachmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutAttachmentRequest
         */
        public PutAttachmentRequest buildWithoutInvocationCallback() {
            PutAttachmentRequest request = new PutAttachmentRequest();
            request.putAttachmentDetails = putAttachmentDetails;
            ...
            return request;
            // new PutAttachmentRequest(putAttachmentDetails, incidentKey, attachmentName, compartmentId, isRestrictedFlag, csi, opcRequestId, ocid, ifMatch, homeregion, problemtype, bearertokentype, bearertoken, idtoken, domainid);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",putAttachmentDetails=").append(String.valueOf(this.putAttachmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutAttachmentRequest)) {
            return false;
        }

        PutAttachmentRequest other = (PutAttachmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.putAttachmentDetails, other.putAttachmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.putAttachmentDetails == null
                                ? 43
                                : this.putAttachmentDetails.hashCode());
        result = (result * PRIME) + (this.incidentKey == null ? 43 : this.incidentKey.hashCode());
        result =
                (result * PRIME)
                        + (this.attachmentName == null ? 43 : this.attachmentName.hashCode());
        result =
                (result * PRIME)
