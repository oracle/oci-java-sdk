...
public class SubCategory {
    ...
    public static class Builder {
        ...
        public SubCategory build() {
            SubCategory __instance__ = new SubCategory(subCategoryKey, name);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SubCategory o) {
            Builder copiedBuilder = subCategoryKey(o.getSubCategoryKey()).name(o.getName());
