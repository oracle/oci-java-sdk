...
public class IssueType {
    ...
    public static class Builder {
        ...
        public IssueType build() {
            IssueType __instance__ = new IssueType(issueTypeKey, label);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IssueType o) {
            Builder copiedBuilder = issueTypeKey(o.getIssueTypeKey()).label(o.getLabel());
