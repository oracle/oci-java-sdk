...
public class ListIncidentsConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListIncidentsConverter.class);
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.cims.responses.ListIncidentsResponse apply(
                                ...
                                java.util.Optional<java.util.List<String>> asOfTimeHeader =
                                        com.oracle.bmc.http.internal.HeaderUtils.getHeadersWithName(
                                                headers, "as-of-time");
                                if (asOfTimeHeader.isPresent()) {
                                    builder.asOfTime(
                                            com.oracle.bmc.http.internal.HeaderUtils.toValue(
                                                    "as-of-time",
                                                    asOfTimeHeader.get().get(0),
                                                    String.class));
                                }
