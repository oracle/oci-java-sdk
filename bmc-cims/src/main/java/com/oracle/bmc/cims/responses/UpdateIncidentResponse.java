...
public class UpdateIncidentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateIncidentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateIncidentResponse> {
        ...
        public UpdateIncidentResponse build() {
            return new UpdateIncidentResponse(__httpStatusCode__, headers, opcRequestId, incident);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIncidentResponse)) {
            return false;
        }

        UpdateIncidentResponse other = (UpdateIncidentResponse) o;
