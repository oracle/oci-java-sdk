...
public class LogSearchAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements LogSearchAsync {
    ...
    public static class Builder
        ...
        public LogSearchAsyncClient build(
                @javax.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new LogSearchAsyncClient(this, authenticationDetailsProvider);
        }
    }
    ...
    @Override
    public java.util.concurrent.Future<SearchLogsResponse> searchLogs(
            SearchLogsRequest request,
            final com.oracle.bmc.responses.AsyncHandler<SearchLogsRequest, SearchLogsResponse>
                    handler) {
