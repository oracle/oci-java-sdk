...
public class LogSearchAsyncClient implements LogSearchAsync {
    /**
    ...
    public static class Builder
        ...
        public LogSearchAsyncClient build(
                ...
                com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                        authenticationDetailsProvider) {
            return new LogSearchAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<SearchLogsResponse> searchLogs(
        ...
        if (this.authenticationDetailsProvider
            ...
            return new com.oracle.bmc.util.internal.RefreshAuthTokenTransformingFuture<
                    javax.ws.rs.core.Response, SearchLogsResponse>(
                    responseFuture,
                    transformer,
                    (com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider)
                            this.authenticationDetailsProvider,
