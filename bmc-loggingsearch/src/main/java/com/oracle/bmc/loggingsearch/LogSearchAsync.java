...
public interface LogSearchAsync extends AutoCloseable {
     ...
     *
     * <p>See [Using the
     * API](https://docs.cloud.oracle.com/Content/Logging/Concepts/using_the_api_searchlogs.htm) for
     * SDK examples.
     *
     ...
     */
    java.util.concurrent.Future<SearchLogsResponse> searchLogs(
            SearchLogsRequest request,
            com.oracle.bmc.responses.AsyncHandler<SearchLogsRequest, SearchLogsResponse> handler);
}
