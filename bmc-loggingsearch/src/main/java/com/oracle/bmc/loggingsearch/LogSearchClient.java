...
public class LogSearchClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public SearchLogsResponse searchLogs(SearchLogsRequest request) {
        ...
        return clientCall(request, SearchLogsResponse::builder)
                ...
                .hasBody()
                .handleBody(
                        com.oracle.bmc.loggingsearch.model.SearchResponse.class,
                        SearchLogsResponse.Builder::searchResponse)
                .handleResponseHeaderString(
                        "opc-next-page", SearchLogsResponse.Builder::opcNextPage)
                .handleResponseHeaderString(
                        "opc-request-id", SearchLogsResponse.Builder::opcRequestId)
                .callSync();
    }
