 ...
 */
package com.oracle.bmc.loggingsearch;
...
public class LogSearchClient implements LogSearch {
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, LogSearchClient> {
    ...
    @Override
    public SearchLogsResponse searchLogs(SearchLogsRequest request) {
        LOG.trace("Called searchLogs");
        final SearchLogsRequest interceptedRequest = SearchLogsConverter.interceptRequest(request);
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, SearchLogsResponse> transformer =
                SearchLogsConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getSearchLogsDetails(),
                                                retriedRequest);
