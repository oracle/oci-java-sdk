...
public class AppmgmtControlWaiters {
    ...
    public AppmgmtControlWaiters(
            java.util.concurrent.ExecutorService executorService, AppmgmtControl client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetMonitoredInstanceRequest, GetMonitoredInstanceResponse>
            forMonitoredInstance(
    ...
    // Helper method to create a new Waiter for MonitoredInstance.
    private com.oracle.bmc.waiter.Waiter<GetMonitoredInstanceRequest, GetMonitoredInstanceResponse>
            forMonitoredInstance(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetMonitoredInstanceRequest request,
                    final com.oracle.bmc.appmgmtcontrol.model.MonitoredInstance.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.appmgmtcontrol.model.MonitoredInstance.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new com.google.common.base.Function<
                            ...
                            @Override
                            public GetMonitoredInstanceResponse apply(
                                    GetMonitoredInstanceRequest request) {
                                return client.getMonitoredInstance(request);
                            }
                        },
                        new com.google.common.base.Predicate<GetMonitoredInstanceResponse>() {
                            @Override
                            public boolean apply(GetMonitoredInstanceResponse response) {
                                return targetStatesSet.contains(
                                        response.getMonitoredInstance().getLifecycleState());
                            }
                        },
