...
public class GetWorkRequestConverter {
    ...
    public static com.oracle.bmc.appmgmtcontrol.requests.GetWorkRequestRequest interceptRequest(
            com.oracle.bmc.appmgmtcontrol.requests.GetWorkRequestRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.appmgmtcontrol.responses.GetWorkRequestResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.appmgmtcontrol.responses.GetWorkRequestResponse>() {
                            @Override
                            public com.oracle.bmc.appmgmtcontrol.responses.GetWorkRequestResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.appmgmtcontrol.responses.GetWorkRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.appmgmtcontrol.model.WorkRequest
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
