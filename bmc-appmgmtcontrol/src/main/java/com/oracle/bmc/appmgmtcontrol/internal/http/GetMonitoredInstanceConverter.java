...
public class GetMonitoredInstanceConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMonitoredInstanceConverter.class);

    public static com.oracle.bmc.appmgmtcontrol.requests.GetMonitoredInstanceRequest
            interceptRequest(
                    com.oracle.bmc.appmgmtcontrol.requests.GetMonitoredInstanceRequest request) {
