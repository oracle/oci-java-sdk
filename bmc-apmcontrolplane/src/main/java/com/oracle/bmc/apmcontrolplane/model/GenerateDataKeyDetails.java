...
public final class GenerateDataKeyDetails
    ...
    public static class Builder {
        ...
        public GenerateDataKeyDetails build() {
            GenerateDataKeyDetails model = new GenerateDataKeyDetails(this.name, this.type);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateDataKeyDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GenerateDataKeyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDataKeyDetails)) {
            return false;
        }

        GenerateDataKeyDetails other = (GenerateDataKeyDetails) o;
