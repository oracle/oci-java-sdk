...
public final class DataKeySummary {
    @Deprecated
    ...
    public static class Builder {
        ...
        public DataKeySummary build() {
            DataKeySummary __instance__ = new DataKeySummary(value, name, type);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataKeySummary o) {
            Builder copiedBuilder = value(o.getValue()).name(o.getName()).type(o.getType());
