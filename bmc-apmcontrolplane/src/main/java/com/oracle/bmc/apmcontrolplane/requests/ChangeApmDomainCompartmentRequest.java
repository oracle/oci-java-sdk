...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmcontrolplane/ChangeApmDomainCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeApmDomainCompartmentRequest.
 */
...
public class ChangeApmDomainCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeApmDomainCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeApmDomainCompartmentRequest(apmDomainId, changeApmDomainCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
