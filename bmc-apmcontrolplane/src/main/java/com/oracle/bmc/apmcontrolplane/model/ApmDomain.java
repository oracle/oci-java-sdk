...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApmDomain.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class ApmDomain extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("dataUploadEndpoint")
        private String dataUploadEndpoint;

        /**
         * The endpoint where the APM agents upload their observations and metrics.
         *
         * @param dataUploadEndpoint the value to set
         * @return this builder
         */
        public Builder dataUploadEndpoint(String dataUploadEndpoint) {
            this.dataUploadEndpoint = dataUploadEndpoint;
            this.__explicitlySet__.add("dataUploadEndpoint");
            return this;
        }
        ...
        public ApmDomain build() {
            ApmDomain model =
                    new ApmDomain(
                            this.dataUploadEndpoint,
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApmDomain model) {
            if (model.wasPropertyExplicitlySet("dataUploadEndpoint")) {
                this.dataUploadEndpoint(model.getDataUploadEndpoint());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("dataUploadEndpoint=").append(String.valueOf(this.dataUploadEndpoint));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApmDomain)) {
            return false;
        }

        ApmDomain other = (ApmDomain) o;
        return java.util.Objects.equals(this.dataUploadEndpoint, other.dataUploadEndpoint)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataUploadEndpoint == null
                                ? 43
                                : this.dataUploadEndpoint.hashCode());
