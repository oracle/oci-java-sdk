...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmcontrolplane/DeleteApmDomainExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApmDomainRequest.
 */
...
public class DeleteApmDomainRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public DeleteApmDomainRequest build() {
            DeleteApmDomainRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteApmDomainRequest
         */
        public DeleteApmDomainRequest buildWithoutInvocationCallback() {
            DeleteApmDomainRequest request = new DeleteApmDomainRequest();
            request.apmDomainId = apmDomainId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteApmDomainRequest(apmDomainId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApmDomainRequest)) {
            return false;
        }

        DeleteApmDomainRequest other = (DeleteApmDomainRequest) o;
