...
/**
 * The credentials for the HeatWave MySQL DB System administrator user, containing the username and
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlDbSystemAdminUserDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MySqlDbSystemAdminUserDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"username", "passwordVaultSecretId"})
    public MySqlDbSystemAdminUserDetails(String username, String passwordVaultSecretId) {
        super();
    ...
    public static class Builder {
        ...
        public MySqlDbSystemAdminUserDetails build() {
            MySqlDbSystemAdminUserDetails model =
                    new MySqlDbSystemAdminUserDetails(this.username, this.passwordVaultSecretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlDbSystemAdminUserDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlDbSystemAdminUserDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlDbSystemAdminUserDetails)) {
            return false;
        }

        MySqlDbSystemAdminUserDetails other = (MySqlDbSystemAdminUserDetails) o;
