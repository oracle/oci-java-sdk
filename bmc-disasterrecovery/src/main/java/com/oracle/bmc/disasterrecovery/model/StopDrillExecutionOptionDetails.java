...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StopDrillExecutionOptionDetails.Builder.class)
...
public final class StopDrillExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public StopDrillExecutionOptionDetails build() {
            StopDrillExecutionOptionDetails model =
                    new StopDrillExecutionOptionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StopDrillExecutionOptionDetails model) {
    ...
    @Deprecated
    public StopDrillExecutionOptionDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDrillExecutionOptionDetails)) {
            return false;
        }

        StopDrillExecutionOptionDetails other = (StopDrillExecutionOptionDetails) o;
