...
/**
 * Properties for an Autonomous Database Serverless member in an Automatic DR configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutomaticDrConfigurationMemberAutonomousDatabase.Builder.class)
...
public final class AutomaticDrConfigurationMemberAutonomousDatabase
    ...
    public static class Builder {
         ...
         * Database Serverless member in the Automatic DR configuration.
         *
        ...
        /**
         * A flag indicating if the automatic failover should be enabled for the Autonomous Database
         * Serverless member in the Automatic DR configuration.
         *
         * <p>Example: {@code false}
         */
        ...
        public AutomaticDrConfigurationMemberAutonomousDatabase build() {
            AutomaticDrConfigurationMemberAutonomousDatabase model =
                    new AutomaticDrConfigurationMemberAutonomousDatabase(
                            this.memberId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutomaticDrConfigurationMemberAutonomousDatabase model) {
    ...
    @Deprecated
    public AutomaticDrConfigurationMemberAutonomousDatabase(
    ...
    /**
     * A flag indicating if the automatic switchover should be enabled for the Autonomous Database
     * Serverless member in the Automatic DR configuration.
     *
     * <p>Example: {@code false}
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutomaticDrConfigurationMemberAutonomousDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutomaticDrConfigurationMemberAutonomousDatabase)) {
            return false;
        }

        AutomaticDrConfigurationMemberAutonomousDatabase other =
                (AutomaticDrConfigurationMemberAutonomousDatabase) o;
