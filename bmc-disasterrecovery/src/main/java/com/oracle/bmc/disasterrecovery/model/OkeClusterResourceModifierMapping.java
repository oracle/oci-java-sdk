...
/**
 * The mapping of OKE namespaces to config maps for an OKE member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OkeClusterResourceModifierMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OkeClusterResourceModifierMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"namespace", "configMap"})
    public OkeClusterResourceModifierMapping(String namespace, String configMap) {
        super();
    ...
    public static class Builder {
        ...
        public OkeClusterResourceModifierMapping build() {
            OkeClusterResourceModifierMapping model =
                    new OkeClusterResourceModifierMapping(this.namespace, this.configMap);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeClusterResourceModifierMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeClusterResourceModifierMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeClusterResourceModifierMapping)) {
            return false;
        }

        OkeClusterResourceModifierMapping other = (OkeClusterResourceModifierMapping) o;
