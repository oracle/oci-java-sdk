...
/**
 * The details for updating an Invoke Oracle Function Precheck step. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails.Builder.class)
...
public final class UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails
    ...
    public static class Builder {
        ...
        public UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails build() {
            UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails model =
                    new UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails model) {
    ...
    @Deprecated
    public UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails(
            String functionId, String requestBody) {
        super();
        this.functionId = functionId;
        this.requestBody = requestBody;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails)) {
            return false;
        }

        UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails other =
                (UpdateInvokeFunctionUserDefinedCustomPrecheckStepDetails) o;
