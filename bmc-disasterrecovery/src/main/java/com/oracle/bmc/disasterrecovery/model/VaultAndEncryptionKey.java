 ...
 *
 * <p>The customer-managed encryption key in this will be used to encrypt all the volumes of the
 * volume group after they move to the destination region. If you specify this common vault and
 * encryption key, you cannot specify vaults and encryption keys individually for each volume using
 * 'sourceVolumeToDestinationEncryptionKeyMappings'.
 *
 * <p>The customer-managed encryption key in this will be used to encrypt the file system when it
 * move to the destination region. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VaultAndEncryptionKey.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VaultAndEncryptionKey
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"vaultId", "encryptionKeyId"})
    public VaultAndEncryptionKey(String vaultId, String encryptionKeyId) {
        super();
    ...
    public static class Builder {
        ...
        public VaultAndEncryptionKey build() {
            VaultAndEncryptionKey model =
                    new VaultAndEncryptionKey(this.vaultId, this.encryptionKeyId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VaultAndEncryptionKey model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VaultAndEncryptionKey(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VaultAndEncryptionKey)) {
            return false;
        }

        VaultAndEncryptionKey other = (VaultAndEncryptionKey) o;
