...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMySqlDbSystemAdminUserDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMySqlDbSystemAdminUserDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"username", "passwordVaultSecretId"})
    public CreateMySqlDbSystemAdminUserDetails(String username, String passwordVaultSecretId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateMySqlDbSystemAdminUserDetails build() {
            CreateMySqlDbSystemAdminUserDetails model =
                    new CreateMySqlDbSystemAdminUserDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlDbSystemAdminUserDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMySqlDbSystemAdminUserDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMySqlDbSystemAdminUserDetails)) {
            return false;
        }

        CreateMySqlDbSystemAdminUserDetails other = (CreateMySqlDbSystemAdminUserDetails) o;
