...
/**
 * The details for updating a block volume attachment or detachment operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"blockVolumeId", "volumeAttachmentReferenceInstanceId"})
    public UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails(
    ...
    public static class Builder {
        ...
        public UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails build() {
            UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails model =
                    new UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails)) {
            return false;
        }

        UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails other =
                (UpdateComputeInstanceNonMovableBlockVolumeAttachOperationDetails) o;
