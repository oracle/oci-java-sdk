...
/**
 * The details for creating a file system mount. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateFileSystemMountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateFileSystemMountDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountTargetId"})
    public CreateFileSystemMountDetails(String mountTargetId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateFileSystemMountDetails build() {
            CreateFileSystemMountDetails model =
                    new CreateFileSystemMountDetails(this.mountTargetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateFileSystemMountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateFileSystemMountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFileSystemMountDetails)) {
            return false;
        }

        CreateFileSystemMountDetails other = (CreateFileSystemMountDetails) o;
