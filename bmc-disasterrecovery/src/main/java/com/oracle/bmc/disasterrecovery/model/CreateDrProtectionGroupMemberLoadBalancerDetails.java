...
/**
 * Create properties for a load balancer member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDrProtectionGroupMemberLoadBalancerDetails.Builder.class)
...
public final class CreateDrProtectionGroupMemberLoadBalancerDetails
    ...
    public static class Builder {
        ...
        public CreateDrProtectionGroupMemberLoadBalancerDetails build() {
            CreateDrProtectionGroupMemberLoadBalancerDetails model =
                    new CreateDrProtectionGroupMemberLoadBalancerDetails(
    ...
    @Deprecated
    public CreateDrProtectionGroupMemberLoadBalancerDetails(
            String memberId,
    ...
    public boolean equals(Object o) {
        ...
        CreateDrProtectionGroupMemberLoadBalancerDetails other =
                (CreateDrProtectionGroupMemberLoadBalancerDetails) o;
