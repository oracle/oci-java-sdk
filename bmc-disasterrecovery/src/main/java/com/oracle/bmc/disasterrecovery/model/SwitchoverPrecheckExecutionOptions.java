...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SwitchoverPrecheckExecutionOptions.Builder.class)
...
public final class SwitchoverPrecheckExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public SwitchoverPrecheckExecutionOptions build() {
            SwitchoverPrecheckExecutionOptions model =
                    new SwitchoverPrecheckExecutionOptions(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchoverPrecheckExecutionOptions model) {
    ...
    @Deprecated
    public SwitchoverPrecheckExecutionOptions(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SwitchoverPrecheckExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverPrecheckExecutionOptions)) {
            return false;
        }

        SwitchoverPrecheckExecutionOptions other = (SwitchoverPrecheckExecutionOptions) o;
