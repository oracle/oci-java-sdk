...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateBlockVolumeMountDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CreateBlockVolumeMountDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountPoint"})
    public CreateBlockVolumeMountDetails(String mountPoint) {
        super();
    ...
    public static class Builder {
        ...
        public CreateBlockVolumeMountDetails build() {
            CreateBlockVolumeMountDetails model =
                    new CreateBlockVolumeMountDetails(this.mountPoint);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateBlockVolumeMountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateBlockVolumeMountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBlockVolumeMountDetails)) {
            return false;
        }

        CreateBlockVolumeMountDetails other = (CreateBlockVolumeMountDetails) o;
