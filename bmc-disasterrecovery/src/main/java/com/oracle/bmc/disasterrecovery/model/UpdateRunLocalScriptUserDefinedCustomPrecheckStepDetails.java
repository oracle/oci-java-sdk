...
/**
 * The details for updating a Run Local Script Precheck step. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails.Builder.class)
...
public final class UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails
    ...
    public static class Builder {
        ...
        public UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails build() {
            UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails model =
                    new UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails model) {
    ...
    @Deprecated
    public UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails)) {
            return false;
        }

        UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails other =
                (UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails) o;
