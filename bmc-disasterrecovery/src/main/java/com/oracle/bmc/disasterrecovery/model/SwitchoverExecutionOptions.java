...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SwitchoverExecutionOptions.Builder.class
)
...
public final class SwitchoverExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public SwitchoverExecutionOptions build() {
            SwitchoverExecutionOptions model =
                    new SwitchoverExecutionOptions(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchoverExecutionOptions model) {
    ...
    @Deprecated
    public SwitchoverExecutionOptions(Boolean arePrechecksEnabled, Boolean areWarningsIgnored) {
        super();
        this.arePrechecksEnabled = arePrechecksEnabled;
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SwitchoverExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverExecutionOptions)) {
            return false;
        }

        SwitchoverExecutionOptions other = (SwitchoverExecutionOptions) o;
