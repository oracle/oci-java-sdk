...
public class UpdateDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public UpdateDrPlanExecutionResponse build() {
            return new UpdateDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrPlanExecutionResponse)) {
            return false;
        }

        UpdateDrPlanExecutionResponse other = (UpdateDrPlanExecutionResponse) o;
