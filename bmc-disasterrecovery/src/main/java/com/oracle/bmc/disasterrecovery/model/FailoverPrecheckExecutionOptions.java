...
/**
 * Options for failover precheck execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FailoverPrecheckExecutionOptions.Builder.class)
...
public final class FailoverPrecheckExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public FailoverPrecheckExecutionOptions build() {
            FailoverPrecheckExecutionOptions model =
                    new FailoverPrecheckExecutionOptions(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FailoverPrecheckExecutionOptions model) {
    ...
    @Deprecated
    public FailoverPrecheckExecutionOptions(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FailoverPrecheckExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverPrecheckExecutionOptions)) {
            return false;
        }

        FailoverPrecheckExecutionOptions other = (FailoverPrecheckExecutionOptions) o;
