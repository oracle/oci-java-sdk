...
/**
 * Update properties for a load balancer member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDrProtectionGroupMemberLoadBalancerDetails.Builder.class)
...
public final class UpdateDrProtectionGroupMemberLoadBalancerDetails
    ...
    public static class Builder {
        ...
        private java.util.List<LoadBalancerBackendSetMappingDetails> backendSetMappings;
        ...
        public Builder backendSetMappings(
                java.util.List<LoadBalancerBackendSetMappingDetails> backendSetMappings) {
        ...
        public UpdateDrProtectionGroupMemberLoadBalancerDetails build() {
            UpdateDrProtectionGroupMemberLoadBalancerDetails model =
                    new UpdateDrProtectionGroupMemberLoadBalancerDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrProtectionGroupMemberLoadBalancerDetails model) {
    ...
    @Deprecated
    public UpdateDrProtectionGroupMemberLoadBalancerDetails(
            String memberId,
    ...
    /** A list of backend set mappings that are used to transfer or update backends during DR. */
    @com.fasterxml.jackson.annotation.JsonProperty("backendSetMappings")
    private final java.util.List<LoadBalancerBackendSetMappingDetails> backendSetMappings;
     ...
     * @return the value
     */
    public java.util.List<LoadBalancerBackendSetMappingDetails> getBackendSetMappings() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupMemberLoadBalancerDetails)) {
            return false;
        }

        UpdateDrProtectionGroupMemberLoadBalancerDetails other =
                (UpdateDrProtectionGroupMemberLoadBalancerDetails) o;
