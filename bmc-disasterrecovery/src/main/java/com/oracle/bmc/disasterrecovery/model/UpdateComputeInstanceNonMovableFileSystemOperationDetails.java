...
/**
 * The details for updating the operations performed on a file systems for non-movable compute
 * instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateComputeInstanceNonMovableFileSystemOperationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateComputeInstanceNonMovableFileSystemOperationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"exportPath", "mountPoint", "mountTargetId"})
    public UpdateComputeInstanceNonMovableFileSystemOperationDetails(
    ...
    public static class Builder {
        ...
        public UpdateComputeInstanceNonMovableFileSystemOperationDetails build() {
            UpdateComputeInstanceNonMovableFileSystemOperationDetails model =
                    new UpdateComputeInstanceNonMovableFileSystemOperationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateComputeInstanceNonMovableFileSystemOperationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateComputeInstanceNonMovableFileSystemOperationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateComputeInstanceNonMovableFileSystemOperationDetails)) {
            return false;
        }

        UpdateComputeInstanceNonMovableFileSystemOperationDetails other =
                (UpdateComputeInstanceNonMovableFileSystemOperationDetails) o;
