...
public final class UpdateDrProtectionGroupDetails
    ...
    public UpdateDrProtectionGroupDetails(
            String displayName,
            UpdateObjectStorageLogLocationDetails logLocation,
            java.util.List<UpdateDrProtectionGroupMemberDetails> members,
    ...
    public static class Builder {
        ...
        public Builder logLocation(UpdateObjectStorageLogLocationDetails logLocation) {
            this.logLocation = logLocation;
        ...
        public UpdateDrProtectionGroupDetails build() {
            UpdateDrProtectionGroupDetails model =
                    new UpdateDrProtectionGroupDetails(
                            this.displayName,
                            this.logLocation,
                            this.members,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrProtectionGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupDetails)) {
            return false;
        }

        UpdateDrProtectionGroupDetails other = (UpdateDrProtectionGroupDetails) o;
