...
/**
 * The virtual node pool configuration properties for an OKE member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OkeClusterVirtualNodePoolConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OkeClusterVirtualNodePoolConfiguration
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "minimum", "maximum"})
    public OkeClusterVirtualNodePoolConfiguration(String id, Integer minimum, Integer maximum) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public OkeClusterVirtualNodePoolConfiguration build() {
            OkeClusterVirtualNodePoolConfiguration model =
                    new OkeClusterVirtualNodePoolConfiguration(this.id, this.minimum, this.maximum);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeClusterVirtualNodePoolConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeClusterVirtualNodePoolConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeClusterVirtualNodePoolConfiguration)) {
            return false;
        }

        OkeClusterVirtualNodePoolConfiguration other = (OkeClusterVirtualNodePoolConfiguration) o;
