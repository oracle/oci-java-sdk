...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/ResumeDrPlanExecutionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResumeDrPlanExecutionRequest.
 */
...
public class ResumeDrPlanExecutionRequest
    ...
    public static class Builder
        ...
        public ResumeDrPlanExecutionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ResumeDrPlanExecutionRequest(resumeDrPlanExecutionDetails, drPlanExecutionId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
