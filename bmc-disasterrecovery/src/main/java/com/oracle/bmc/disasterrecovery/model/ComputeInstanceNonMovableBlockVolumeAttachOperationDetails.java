...
/**
 * The details for attaching or detaching a block volume to a non-movable compute instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComputeInstanceNonMovableBlockVolumeAttachOperationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ComputeInstanceNonMovableBlockVolumeAttachOperationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"blockVolumeId", "volumeAttachmentReferenceInstanceId"})
    public ComputeInstanceNonMovableBlockVolumeAttachOperationDetails(
            String blockVolumeId, String volumeAttachmentReferenceInstanceId) {
        super();
    ...
    public static class Builder {
        ...
        public ComputeInstanceNonMovableBlockVolumeAttachOperationDetails build() {
            ComputeInstanceNonMovableBlockVolumeAttachOperationDetails model =
                    new ComputeInstanceNonMovableBlockVolumeAttachOperationDetails(
                            this.blockVolumeId, this.volumeAttachmentReferenceInstanceId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceNonMovableBlockVolumeAttachOperationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceNonMovableBlockVolumeAttachOperationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceNonMovableBlockVolumeAttachOperationDetails)) {
            return false;
        }

        ComputeInstanceNonMovableBlockVolumeAttachOperationDetails other =
                (ComputeInstanceNonMovableBlockVolumeAttachOperationDetails) o;
