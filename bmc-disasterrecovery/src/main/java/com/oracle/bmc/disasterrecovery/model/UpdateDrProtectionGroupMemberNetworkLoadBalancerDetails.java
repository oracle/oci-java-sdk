...
/**
 * Update properties for a network load balancer member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails.Builder.class)
...
public final class UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails
    ...
    public static class Builder {
        ...
        public UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails build() {
            UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails model =
                    new UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails(
                            this.memberId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails model) {
    ...
    @Deprecated
    public UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails(
            String memberId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails)) {
            return false;
        }

        UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails other =
                (UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails) o;
