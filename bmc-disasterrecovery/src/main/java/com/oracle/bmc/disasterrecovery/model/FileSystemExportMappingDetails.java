...
/**
 * The mapping between a file system export in the primary region and a mount target in the standby
 * region. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FileSystemExportMappingDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FileSystemExportMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"exportId", "destinationMountTargetId"})
    public FileSystemExportMappingDetails(String exportId, String destinationMountTargetId) {
        super();
    ...
    public static class Builder {
        ...
        public FileSystemExportMappingDetails build() {
            FileSystemExportMappingDetails model =
                    new FileSystemExportMappingDetails(
                            this.exportId, this.destinationMountTargetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FileSystemExportMappingDetails model) {
    ...
    /**
     * The OCID of the destination mount target in the destination region which is used to export
     * the file system.
     *
     * <p>Example: {@code ocid1.mounttarget.oc1..uniqueID}
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FileSystemExportMappingDetails)) {
            return false;
        }

        FileSystemExportMappingDetails other = (FileSystemExportMappingDetails) o;
