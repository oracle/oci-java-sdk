...
/**
 * The details for updating the unmount properties of a file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFileSystemUnmountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateFileSystemUnmountDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountTargetId"})
    public UpdateFileSystemUnmountDetails(String mountTargetId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateFileSystemUnmountDetails build() {
            UpdateFileSystemUnmountDetails model =
                    new UpdateFileSystemUnmountDetails(this.mountTargetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateFileSystemUnmountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFileSystemUnmountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFileSystemUnmountDetails)) {
            return false;
        }

        UpdateFileSystemUnmountDetails other = (UpdateFileSystemUnmountDetails) o;
