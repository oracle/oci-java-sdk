...
public class UpdateDrProtectionGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateDrProtectionGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateDrProtectionGroupResponse o) {
         ...
         */
        public UpdateDrProtectionGroupResponse build() {
            return new UpdateDrProtectionGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupResponse)) {
            return false;
        }

        UpdateDrProtectionGroupResponse other = (UpdateDrProtectionGroupResponse) o;
