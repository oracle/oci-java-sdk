...
public final class NetworkLoadBalancerBackendSetMapping
    ...
    public NetworkLoadBalancerBackendSetMapping(
    ...
    public static class Builder {
        ...
        public NetworkLoadBalancerBackendSetMapping build() {
            NetworkLoadBalancerBackendSetMapping model =
                    new NetworkLoadBalancerBackendSetMapping(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkLoadBalancerBackendSetMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NetworkLoadBalancerBackendSetMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkLoadBalancerBackendSetMapping)) {
            return false;
        }

        NetworkLoadBalancerBackendSetMapping other = (NetworkLoadBalancerBackendSetMapping) o;
