...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMySqlDbSystemReplicationUserDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMySqlDbSystemReplicationUserDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"username", "passwordVaultSecretId"})
    public CreateMySqlDbSystemReplicationUserDetails(
    ...
    public static class Builder {
        ...
        public CreateMySqlDbSystemReplicationUserDetails build() {
            CreateMySqlDbSystemReplicationUserDetails model =
                    new CreateMySqlDbSystemReplicationUserDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlDbSystemReplicationUserDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMySqlDbSystemReplicationUserDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMySqlDbSystemReplicationUserDetails)) {
            return false;
        }

        CreateMySqlDbSystemReplicationUserDetails other =
                (CreateMySqlDbSystemReplicationUserDetails) o;
