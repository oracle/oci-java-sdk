...
/**
 * The properties for a volume group member of a DR protection group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DrProtectionGroupMemberVolumeGroup.Builder.class)
...
public final class DrProtectionGroupMemberVolumeGroup extends DrProtectionGroupMember {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrProtectionGroupMemberVolumeGroup)) {
            return false;
        }
