...
public class RefreshDrPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshDrPlanResponse> {
         ...
         */
        @Override
        public Builder copy(RefreshDrPlanResponse o) {
         ...
         */
        @Override
        public RefreshDrPlanResponse build() {
            return new RefreshDrPlanResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshDrPlanResponse)) {
            return false;
        }

        RefreshDrPlanResponse other = (RefreshDrPlanResponse) o;
