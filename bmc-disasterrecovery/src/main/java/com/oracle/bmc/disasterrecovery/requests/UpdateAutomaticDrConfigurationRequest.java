...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/UpdateAutomaticDrConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAutomaticDrConfigurationRequest.
 */
...
public class UpdateAutomaticDrConfigurationRequest
    ...
    public static class Builder
        ...
        public UpdateAutomaticDrConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAutomaticDrConfigurationRequest(updateAutomaticDrConfigurationDetails, automaticDrConfigurationId, ifMatch, opcRequestId);
        }
    }
