...
public class UpdateAutomaticDrConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateAutomaticDrConfigurationResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateAutomaticDrConfigurationResponse o) {
         ...
         */
        @Override
        public UpdateAutomaticDrConfigurationResponse build() {
            return new UpdateAutomaticDrConfigurationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutomaticDrConfigurationResponse)) {
            return false;
        }

        UpdateAutomaticDrConfigurationResponse other = (UpdateAutomaticDrConfigurationResponse) o;
