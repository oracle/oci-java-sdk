...
/**
 * Update properties for an Autonomous Database member. <br>
...
public final class UpdateDrProtectionGroupMemberAutonomousDatabaseDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrProtectionGroupMemberAutonomousDatabaseDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupMemberAutonomousDatabaseDetails)) {
            return false;
        }
