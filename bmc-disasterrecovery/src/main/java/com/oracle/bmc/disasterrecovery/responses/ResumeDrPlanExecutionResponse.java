...
public class ResumeDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ResumeDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ResumeDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(ResumeDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public ResumeDrPlanExecutionResponse build() {
            return new ResumeDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResumeDrPlanExecutionResponse)) {
            return false;
        }

        ResumeDrPlanExecutionResponse other = (ResumeDrPlanExecutionResponse) o;
