...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StopDrillPrecheckExecutionOptionDetails.Builder.class)
...
public final class StopDrillPrecheckExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public StopDrillPrecheckExecutionOptionDetails build() {
            StopDrillPrecheckExecutionOptionDetails model =
                    new StopDrillPrecheckExecutionOptionDetails(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StopDrillPrecheckExecutionOptionDetails model) {
    ...
    @Deprecated
    public StopDrillPrecheckExecutionOptionDetails(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StopDrillPrecheckExecutionOptionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDrillPrecheckExecutionOptionDetails)) {
            return false;
        }

        StopDrillPrecheckExecutionOptionDetails other = (StopDrillPrecheckExecutionOptionDetails) o;
