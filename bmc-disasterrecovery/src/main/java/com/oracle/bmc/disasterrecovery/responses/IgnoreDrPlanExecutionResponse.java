...
public class IgnoreDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private IgnoreDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<IgnoreDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(IgnoreDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public IgnoreDrPlanExecutionResponse build() {
            return new IgnoreDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IgnoreDrPlanExecutionResponse)) {
            return false;
        }

        IgnoreDrPlanExecutionResponse other = (IgnoreDrPlanExecutionResponse) o;
