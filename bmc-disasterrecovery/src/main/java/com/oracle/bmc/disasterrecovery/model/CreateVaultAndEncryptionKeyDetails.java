...
/**
 * Create properties for a customer-managed vault and encryption key in the destination region. The
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateVaultAndEncryptionKeyDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateVaultAndEncryptionKeyDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"vaultId", "encryptionKeyId"})
    public CreateVaultAndEncryptionKeyDetails(String vaultId, String encryptionKeyId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateVaultAndEncryptionKeyDetails build() {
            CreateVaultAndEncryptionKeyDetails model =
                    new CreateVaultAndEncryptionKeyDetails(this.vaultId, this.encryptionKeyId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateVaultAndEncryptionKeyDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateVaultAndEncryptionKeyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVaultAndEncryptionKeyDetails)) {
            return false;
        }

        CreateVaultAndEncryptionKeyDetails other = (CreateVaultAndEncryptionKeyDetails) o;
