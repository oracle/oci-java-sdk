...
public class DisassociateDrProtectionGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DisassociateDrProtectionGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DisassociateDrProtectionGroupResponse o) {
        ...
        public DisassociateDrProtectionGroupResponse build() {
            return new DisassociateDrProtectionGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisassociateDrProtectionGroupResponse)) {
            return false;
        }

        DisassociateDrProtectionGroupResponse other = (DisassociateDrProtectionGroupResponse) o;
