...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails.Builder.class
)
...
public final class UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails
    ...
    public static class Builder {
        ...
        public UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails build() {
            UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails model =
                    new UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(
                            this.memberId,
    ...
    @Deprecated
    public UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails other =
                (UpdateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails) o;
