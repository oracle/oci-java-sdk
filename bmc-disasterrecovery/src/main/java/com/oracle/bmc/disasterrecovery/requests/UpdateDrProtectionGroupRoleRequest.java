...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/UpdateDrProtectionGroupRoleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDrProtectionGroupRoleRequest.
 */
...
public class UpdateDrProtectionGroupRoleRequest
    ...
    public static class Builder
        ...
        public UpdateDrProtectionGroupRoleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDrProtectionGroupRoleRequest(updateDrProtectionGroupRoleDetails, drProtectionGroupId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
