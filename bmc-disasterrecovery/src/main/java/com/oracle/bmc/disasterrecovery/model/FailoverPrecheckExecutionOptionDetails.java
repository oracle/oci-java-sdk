...
/**
 * Options for a failover precheck execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FailoverPrecheckExecutionOptionDetails.Builder.class)
...
public final class FailoverPrecheckExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public FailoverPrecheckExecutionOptionDetails build() {
            FailoverPrecheckExecutionOptionDetails model =
                    new FailoverPrecheckExecutionOptionDetails(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FailoverPrecheckExecutionOptionDetails model) {
    ...
    @Deprecated
    public FailoverPrecheckExecutionOptionDetails(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FailoverPrecheckExecutionOptionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverPrecheckExecutionOptionDetails)) {
            return false;
        }

        FailoverPrecheckExecutionOptionDetails other = (FailoverPrecheckExecutionOptionDetails) o;
