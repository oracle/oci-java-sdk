...
/**
 * Options for stop drill execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StopDrillExecutionOptions.Builder.class)
...
public final class StopDrillExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public StopDrillExecutionOptions build() {
            StopDrillExecutionOptions model =
                    new StopDrillExecutionOptions(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StopDrillExecutionOptions model) {
    ...
    @Deprecated
    public StopDrillExecutionOptions(Boolean arePrechecksEnabled, Boolean areWarningsIgnored) {
        super();
        this.arePrechecksEnabled = arePrechecksEnabled;
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StopDrillExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDrillExecutionOptions)) {
            return false;
        }

        StopDrillExecutionOptions other = (StopDrillExecutionOptions) o;
