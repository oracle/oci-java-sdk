...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails.Builder.class)
...
public final class UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails
        extends UpdateAutomaticDrConfigurationMemberDetails {
    ...
    public static class Builder {
        ...
        public UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails build() {
            UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails model =
                    new UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails(
                            this.memberId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails model) {
    ...
    @Deprecated
    public UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails)) {
            return false;
        }

        UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails other =
                (UpdateAutomaticDrConfigurationMemberAutonomousDatabaseDetails) o;
