...
/**
 * The details of operations performed on a file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComputeInstanceMovableFileSystemOperation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ComputeInstanceMovableFileSystemOperation
    ...
    public ComputeInstanceMovableFileSystemOperation(
            String exportPath,
            String mountPoint,
            FileSystemMountDetails mountDetails,
            FileSystemUnmountDetails unmountDetails) {
        super();
    ...
    public static class Builder {
        ...
        private FileSystemMountDetails mountDetails;

        public Builder mountDetails(FileSystemMountDetails mountDetails) {
            this.mountDetails = mountDetails;
        ...
        private FileSystemUnmountDetails unmountDetails;

        public Builder unmountDetails(FileSystemUnmountDetails unmountDetails) {
            this.unmountDetails = unmountDetails;
        ...
        public ComputeInstanceMovableFileSystemOperation build() {
            ComputeInstanceMovableFileSystemOperation model =
                    new ComputeInstanceMovableFileSystemOperation(
                            this.exportPath,
                            this.mountPoint,
                            this.mountDetails,
                            this.unmountDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceMovableFileSystemOperation model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("mountDetails")
    private final FileSystemMountDetails mountDetails;

    public FileSystemMountDetails getMountDetails() {
        return mountDetails;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("unmountDetails")
    private final FileSystemUnmountDetails unmountDetails;

    public FileSystemUnmountDetails getUnmountDetails() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceMovableFileSystemOperation(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceMovableFileSystemOperation)) {
            return false;
        }

        ComputeInstanceMovableFileSystemOperation other =
                (ComputeInstanceMovableFileSystemOperation) o;
