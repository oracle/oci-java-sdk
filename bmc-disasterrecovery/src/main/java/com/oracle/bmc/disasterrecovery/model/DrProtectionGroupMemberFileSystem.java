...
public final class DrProtectionGroupMemberFileSystem extends DrProtectionGroupMember {
    ...
    public static class Builder {
        ...
        public DrProtectionGroupMemberFileSystem build() {
            DrProtectionGroupMemberFileSystem model =
                    new DrProtectionGroupMemberFileSystem(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DrProtectionGroupMemberFileSystem model) {
    ...
    @Deprecated
    public DrProtectionGroupMemberFileSystem(
            String memberId,
            String destinationAvailabilityDomain,
            java.util.List<FileSystemExportMapping> exportMappings) {
        super(memberId);
        this.destinationAvailabilityDomain = destinationAvailabilityDomain;
        this.exportMappings = exportMappings;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DrProtectionGroupMemberFileSystem(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrProtectionGroupMemberFileSystem)) {
            return false;
        }

        DrProtectionGroupMemberFileSystem other = (DrProtectionGroupMemberFileSystem) o;
