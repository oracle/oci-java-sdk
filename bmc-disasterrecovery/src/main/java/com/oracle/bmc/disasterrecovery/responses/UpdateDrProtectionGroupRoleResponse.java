...
public class UpdateDrProtectionGroupRoleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateDrProtectionGroupRoleResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateDrProtectionGroupRoleResponse o) {
         ...
         */
        @Override
        public UpdateDrProtectionGroupRoleResponse build() {
            return new UpdateDrProtectionGroupRoleResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrProtectionGroupRoleResponse)) {
            return false;
        }

        UpdateDrProtectionGroupRoleResponse other = (UpdateDrProtectionGroupRoleResponse) o;
