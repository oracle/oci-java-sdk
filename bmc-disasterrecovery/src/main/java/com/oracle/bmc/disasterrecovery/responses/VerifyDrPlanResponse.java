...
public class VerifyDrPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<VerifyDrPlanResponse> {
         ...
         */
        @Override
        public Builder copy(VerifyDrPlanResponse o) {
         ...
         */
        @Override
        public VerifyDrPlanResponse build() {
            return new VerifyDrPlanResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerifyDrPlanResponse)) {
            return false;
        }

        VerifyDrPlanResponse other = (VerifyDrPlanResponse) o;
