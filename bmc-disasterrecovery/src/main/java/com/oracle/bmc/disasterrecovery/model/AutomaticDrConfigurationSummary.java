...
/**
 * The summary of an Automatic DR configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutomaticDrConfigurationSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutomaticDrConfigurationSummary
    ...
    public AutomaticDrConfigurationSummary(
            String id,
            String displayName,
    ...
    public static class Builder {
        ...
        /**
         * The date and time the Automatic DR configuration was created. An RFC3339 formatted
         * datetime string.
         *
         * <p>Example: {@code 2024-03-29T09:36:42Z}
         */
        ...
        /**
         * The date and time the Automatic DR configuration was updated. An RFC3339 formatted
         * datetime string.
         *
         * <p>Example: {@code 2024-03-29T09:36:42Z}
         */
        ...
        private AutomaticDrConfigurationLifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(AutomaticDrConfigurationLifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public AutomaticDrConfigurationSummary build() {
            AutomaticDrConfigurationSummary model =
                    new AutomaticDrConfigurationSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutomaticDrConfigurationSummary model) {
    ...
    /**
     * The date and time the Automatic DR configuration was created. An RFC3339 formatted datetime
     * string.
     *
     * <p>Example: {@code 2024-03-29T09:36:42Z}
     */
    ...
    /**
     * The date and time the Automatic DR configuration was updated. An RFC3339 formatted datetime
     * string.
     *
     * <p>Example: {@code 2024-03-29T09:36:42Z}
     */
    ...
    /** The current state of the Automatic DR configuration. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final AutomaticDrConfigurationLifecycleState lifecycleState;
     ...
     * @return the value
     */
    public AutomaticDrConfigurationLifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutomaticDrConfigurationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutomaticDrConfigurationSummary)) {
            return false;
        }

        AutomaticDrConfigurationSummary other = (AutomaticDrConfigurationSummary) o;
