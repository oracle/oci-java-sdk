...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateBlockVolumeAttachmentDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateBlockVolumeAttachmentDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"volumeAttachmentReferenceInstanceId"})
    public UpdateBlockVolumeAttachmentDetails(String volumeAttachmentReferenceInstanceId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateBlockVolumeAttachmentDetails build() {
            UpdateBlockVolumeAttachmentDetails model =
                    new UpdateBlockVolumeAttachmentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBlockVolumeAttachmentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateBlockVolumeAttachmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBlockVolumeAttachmentDetails)) {
            return false;
        }

        UpdateBlockVolumeAttachmentDetails other = (UpdateBlockVolumeAttachmentDetails) o;
