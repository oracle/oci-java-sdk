...
public final class CreateOkeBackupLocationDetails
    ...
    public static class Builder {
        ...
        public CreateOkeBackupLocationDetails build() {
            CreateOkeBackupLocationDetails model =
                    new CreateOkeBackupLocationDetails(this.namespace, this.bucket);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOkeBackupLocationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOkeBackupLocationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOkeBackupLocationDetails)) {
            return false;
        }

        CreateOkeBackupLocationDetails other = (CreateOkeBackupLocationDetails) o;
