...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StartDrillPrecheckExecutionOptions.Builder.class)
...
public final class StartDrillPrecheckExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public StartDrillPrecheckExecutionOptions build() {
            StartDrillPrecheckExecutionOptions model =
                    new StartDrillPrecheckExecutionOptions(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StartDrillPrecheckExecutionOptions model) {
    ...
    @Deprecated
    public StartDrillPrecheckExecutionOptions(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StartDrillPrecheckExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDrillPrecheckExecutionOptions)) {
            return false;
        }

        StartDrillPrecheckExecutionOptions other = (StartDrillPrecheckExecutionOptions) o;
