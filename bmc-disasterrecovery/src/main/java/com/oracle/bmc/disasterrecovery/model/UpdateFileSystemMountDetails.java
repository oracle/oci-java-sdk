...
/**
 * The details for updating the mount properties of a file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFileSystemMountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateFileSystemMountDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountTargetId"})
    public UpdateFileSystemMountDetails(String mountTargetId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateFileSystemMountDetails build() {
            UpdateFileSystemMountDetails model =
                    new UpdateFileSystemMountDetails(this.mountTargetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateFileSystemMountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFileSystemMountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFileSystemMountDetails)) {
            return false;
        }

        UpdateFileSystemMountDetails other = (UpdateFileSystemMountDetails) o;
