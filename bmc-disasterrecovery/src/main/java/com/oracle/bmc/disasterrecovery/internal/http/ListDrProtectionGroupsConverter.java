...
public class ListDrProtectionGroupsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListDrProtectionGroupsConverter.class);

    public static com.oracle.bmc.disasterrecovery.requests.ListDrProtectionGroupsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.disasterrecovery.requests.ListDrProtectionGroupsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220125").path("drProtectionGroups");
        ...
        if (request.getDrProtectionGroupId() != null) {
            target =
                    target.queryParam(
                            "drProtectionGroupId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.disasterrecovery.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.disasterrecovery.responses.ListDrProtectionGroupsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.drProtectionGroupCollection(response.getItem());
