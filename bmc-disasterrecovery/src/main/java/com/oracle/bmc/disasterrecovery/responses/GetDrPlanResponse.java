...
public class GetDrPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDrPlanResponse> {
         ...
         */
        @Override
        public Builder copy(GetDrPlanResponse o) {
         ...
         */
        @Override
        public GetDrPlanResponse build() {
            return new GetDrPlanResponse(__httpStatusCode__, headers, etag, opcRequestId, drPlan);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDrPlanResponse)) {
            return false;
        }

        GetDrPlanResponse other = (GetDrPlanResponse) o;
