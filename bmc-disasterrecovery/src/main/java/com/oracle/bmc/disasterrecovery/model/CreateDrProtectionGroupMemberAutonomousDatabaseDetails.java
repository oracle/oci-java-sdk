...
/**
 * Create properties for an Autonomous Database Serverless member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDrProtectionGroupMemberAutonomousDatabaseDetails.Builder.class)
...
public final class CreateDrProtectionGroupMemberAutonomousDatabaseDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrProtectionGroupMemberAutonomousDatabaseDetails)) {
            return false;
        }
