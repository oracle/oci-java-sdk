...
/**
 * A backend set mapping between source and destination load balancer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LoadBalancerBackendSetMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class LoadBalancerBackendSetMapping
    ...
    public LoadBalancerBackendSetMapping(
    ...
    public static class Builder {
         ...
         * destination region load balancer. For movable instances this flag should be set to
         * 'false'.
         *
         * <p>Example: {@code true}
         */
         ...
         *
         * <p>Example: {@code My_Source_Backend_Set}
         */
         ...
         *
         * <p>Example: {@code My_Destination_Backend_Set}
         */
        ...
        public LoadBalancerBackendSetMapping build() {
            LoadBalancerBackendSetMapping model =
                    new LoadBalancerBackendSetMapping(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LoadBalancerBackendSetMapping model) {
     ...
     * region load balancer. For movable instances this flag should be set to 'false'.
     *
     * <p>Example: {@code true}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isBackendSetForNonMovable")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LoadBalancerBackendSetMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadBalancerBackendSetMapping)) {
            return false;
        }

        LoadBalancerBackendSetMapping other = (LoadBalancerBackendSetMapping) o;
