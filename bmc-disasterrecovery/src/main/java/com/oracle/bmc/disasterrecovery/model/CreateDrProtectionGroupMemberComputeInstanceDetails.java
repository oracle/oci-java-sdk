...
/**
 * Deprecated. Create properties for a compute instance member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDrProtectionGroupMemberComputeInstanceDetails.Builder.class)
...
public final class CreateDrProtectionGroupMemberComputeInstanceDetails
    ...
    public static class Builder {
        ...
        public CreateDrProtectionGroupMemberComputeInstanceDetails build() {
            CreateDrProtectionGroupMemberComputeInstanceDetails model =
                    new CreateDrProtectionGroupMemberComputeInstanceDetails(
                            this.memberId,
                            this.isMovable,
                            this.vnicMapping,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDrProtectionGroupMemberComputeInstanceDetails model) {
    ...
    @Deprecated
    public CreateDrProtectionGroupMemberComputeInstanceDetails(
            String memberId,
            Boolean isMovable,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrProtectionGroupMemberComputeInstanceDetails)) {
            return false;
        }

        CreateDrProtectionGroupMemberComputeInstanceDetails other =
                (CreateDrProtectionGroupMemberComputeInstanceDetails) o;
