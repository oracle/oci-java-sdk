...
public class CreateAutomaticDrConfigurationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateAutomaticDrConfigurationConverter.class);

    public static com.oracle.bmc.disasterrecovery.requests.CreateAutomaticDrConfigurationRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220125").path("automaticDrConfigurations");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.disasterrecovery.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.disasterrecovery.responses.CreateAutomaticDrConfigurationResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.disasterrecovery.responses
                                                .CreateAutomaticDrConfigurationResponse.Builder
                                        builder =
                                                com.oracle.bmc.disasterrecovery.responses
                                                        .CreateAutomaticDrConfigurationResponse
                                                        .builder()
                                ...
                                builder.automaticDrConfiguration(response.getItem());
