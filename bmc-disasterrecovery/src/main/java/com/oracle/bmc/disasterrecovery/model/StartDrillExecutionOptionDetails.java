...
/**
 * Options for start drill execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StartDrillExecutionOptionDetails.Builder.class)
...
public final class StartDrillExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public StartDrillExecutionOptionDetails build() {
            StartDrillExecutionOptionDetails model =
                    new StartDrillExecutionOptionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StartDrillExecutionOptionDetails model) {
    ...
    @Deprecated
    public StartDrillExecutionOptionDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StartDrillExecutionOptionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDrillExecutionOptionDetails)) {
            return false;
        }

        StartDrillExecutionOptionDetails other = (StartDrillExecutionOptionDetails) o;
