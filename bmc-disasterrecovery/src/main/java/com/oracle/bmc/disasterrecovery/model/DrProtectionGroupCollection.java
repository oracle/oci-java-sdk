...
/**
 * A list of DR Protection Groups. <br>
...
public final class DrProtectionGroupCollection
    ...
    public static class Builder {
        ...
        public DrProtectionGroupCollection build() {
            DrProtectionGroupCollection model = new DrProtectionGroupCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DrProtectionGroupCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrProtectionGroupCollection)) {
            return false;
        }

        DrProtectionGroupCollection other = (DrProtectionGroupCollection) o;
