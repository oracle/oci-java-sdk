...
/**
 * Options for start drill precheck execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StartDrillPrecheckExecutionOptionDetails.Builder.class)
...
public final class StartDrillPrecheckExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public StartDrillPrecheckExecutionOptionDetails build() {
            StartDrillPrecheckExecutionOptionDetails model =
                    new StartDrillPrecheckExecutionOptionDetails(this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StartDrillPrecheckExecutionOptionDetails model) {
    ...
    @Deprecated
    public StartDrillPrecheckExecutionOptionDetails(Boolean areWarningsIgnored) {
        super();
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StartDrillPrecheckExecutionOptionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDrillPrecheckExecutionOptionDetails)) {
            return false;
        }

        StartDrillPrecheckExecutionOptionDetails other =
                (StartDrillPrecheckExecutionOptionDetails) o;
