...
public class UpdateDrPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDrPlanResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDrPlanResponse o) {
         ...
         */
        @Override
        public UpdateDrPlanResponse build() {
            return new UpdateDrPlanResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrPlanResponse)) {
            return false;
        }

        UpdateDrPlanResponse other = (UpdateDrPlanResponse) o;
