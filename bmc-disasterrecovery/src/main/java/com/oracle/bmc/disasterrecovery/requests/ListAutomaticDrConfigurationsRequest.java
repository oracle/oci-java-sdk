...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/ListAutomaticDrConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutomaticDrConfigurationsRequest.
 */
...
public class ListAutomaticDrConfigurationsRequest
    ...
    public static class Builder
        ...
        public ListAutomaticDrConfigurationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutomaticDrConfigurationsRequest(drProtectionGroupId, automaticDrConfigurationId, lifecycleState, lifecycleStateNotEqualTo, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
