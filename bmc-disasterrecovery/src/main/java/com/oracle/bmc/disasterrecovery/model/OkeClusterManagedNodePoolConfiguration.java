...
/**
 * The managed node pool configuration properties for an OKE member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OkeClusterManagedNodePoolConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OkeClusterManagedNodePoolConfiguration
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "minimum", "maximum"})
    public OkeClusterManagedNodePoolConfiguration(String id, Integer minimum, Integer maximum) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public OkeClusterManagedNodePoolConfiguration build() {
            OkeClusterManagedNodePoolConfiguration model =
                    new OkeClusterManagedNodePoolConfiguration(this.id, this.minimum, this.maximum);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeClusterManagedNodePoolConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeClusterManagedNodePoolConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeClusterManagedNodePoolConfiguration)) {
            return false;
        }

        OkeClusterManagedNodePoolConfiguration other = (OkeClusterManagedNodePoolConfiguration) o;
