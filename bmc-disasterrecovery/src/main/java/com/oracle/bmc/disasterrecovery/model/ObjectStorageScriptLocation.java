...
/**
 * Information about an Object Storage script location for a user-defined step in a DR Plan. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageScriptLocation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class ObjectStorageScriptLocation
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"namespace", "bucket", "object"})
    public ObjectStorageScriptLocation(String namespace, String bucket, String object) {
        super();
    ...
    public static class Builder {
        ...
        public ObjectStorageScriptLocation build() {
            ObjectStorageScriptLocation model =
                    new ObjectStorageScriptLocation(this.namespace, this.bucket, this.object);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageScriptLocation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageScriptLocation)) {
            return false;
        }

        ObjectStorageScriptLocation other = (ObjectStorageScriptLocation) o;
