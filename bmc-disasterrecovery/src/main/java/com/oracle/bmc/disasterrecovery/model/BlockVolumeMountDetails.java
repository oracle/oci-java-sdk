...
/**
 * Deprecated. Use the 'ComputeInstanceNonMovableBlockVolumeMountOperationDetails' definition
 * instead of this. The details for mounting or unmounting the file system on a block volume. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BlockVolumeMountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BlockVolumeMountDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountPoint"})
    public BlockVolumeMountDetails(String mountPoint) {
        super();
    ...
    public static class Builder {
        ...
        public BlockVolumeMountDetails build() {
            BlockVolumeMountDetails model = new BlockVolumeMountDetails(this.mountPoint);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BlockVolumeMountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BlockVolumeMountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BlockVolumeMountDetails)) {
            return false;
        }

        BlockVolumeMountDetails other = (BlockVolumeMountDetails) o;
