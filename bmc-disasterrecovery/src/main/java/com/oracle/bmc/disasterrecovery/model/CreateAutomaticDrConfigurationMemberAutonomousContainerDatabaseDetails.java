...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails.Builder.class
)
...
public final class CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails
    ...
    public static class Builder {
        ...
        public CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails build() {
            CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails model =
                    new CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(
                            this.memberId,
    ...
    @Deprecated
    public CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails other =
                (CreateAutomaticDrConfigurationMemberAutonomousContainerDatabaseDetails) o;
