...
public class DeleteDrProtectionGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteDrProtectionGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteDrProtectionGroupResponse o) {
         ...
         */
        @Override
        public DeleteDrProtectionGroupResponse build() {
            return new DeleteDrProtectionGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDrProtectionGroupResponse)) {
            return false;
        }

        DeleteDrProtectionGroupResponse other = (DeleteDrProtectionGroupResponse) o;
