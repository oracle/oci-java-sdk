...
/**
 * Create properties for a Database (DBCS) member. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDrProtectionGroupMemberDatabaseDetails.Builder.class)
...
public final class CreateDrProtectionGroupMemberDatabaseDetails
    ...
    public static class Builder {
        ...
        public CreateDrProtectionGroupMemberDatabaseDetails build() {
            CreateDrProtectionGroupMemberDatabaseDetails model =
                    new CreateDrProtectionGroupMemberDatabaseDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDrProtectionGroupMemberDatabaseDetails model) {
    ...
    @Deprecated
    public CreateDrProtectionGroupMemberDatabaseDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDrProtectionGroupMemberDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrProtectionGroupMemberDatabaseDetails)) {
            return false;
        }

        CreateDrProtectionGroupMemberDatabaseDetails other =
                (CreateDrProtectionGroupMemberDatabaseDetails) o;
