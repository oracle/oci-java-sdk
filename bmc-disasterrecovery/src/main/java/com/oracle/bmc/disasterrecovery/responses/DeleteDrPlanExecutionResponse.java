...
public class DeleteDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public DeleteDrPlanExecutionResponse build() {
            return new DeleteDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDrPlanExecutionResponse)) {
            return false;
        }

        DeleteDrPlanExecutionResponse other = (DeleteDrPlanExecutionResponse) o;
