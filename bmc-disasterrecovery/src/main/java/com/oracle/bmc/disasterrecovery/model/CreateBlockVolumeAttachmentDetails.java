...
/**
 * Deprecated. Use the 'CreateComputeInstanceNonMovableBlockVolumeAttachOperationDetails' definition
 * instead of this. The details for creating a block volume attachment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateBlockVolumeAttachmentDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateBlockVolumeAttachmentDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"volumeAttachmentReferenceInstanceId"})
    public CreateBlockVolumeAttachmentDetails(String volumeAttachmentReferenceInstanceId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateBlockVolumeAttachmentDetails build() {
            CreateBlockVolumeAttachmentDetails model =
                    new CreateBlockVolumeAttachmentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateBlockVolumeAttachmentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateBlockVolumeAttachmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBlockVolumeAttachmentDetails)) {
            return false;
        }

        CreateBlockVolumeAttachmentDetails other = (CreateBlockVolumeAttachmentDetails) o;
