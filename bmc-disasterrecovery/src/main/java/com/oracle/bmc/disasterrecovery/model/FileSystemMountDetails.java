...
/**
 * Mount details of a file system. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FileSystemMountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FileSystemMountDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mountTargetId"})
    public FileSystemMountDetails(String mountTargetId) {
        super();
    ...
    public static class Builder {
        ...
        public FileSystemMountDetails build() {
            FileSystemMountDetails model = new FileSystemMountDetails(this.mountTargetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FileSystemMountDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FileSystemMountDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FileSystemMountDetails)) {
            return false;
        }

        FileSystemMountDetails other = (FileSystemMountDetails) o;
