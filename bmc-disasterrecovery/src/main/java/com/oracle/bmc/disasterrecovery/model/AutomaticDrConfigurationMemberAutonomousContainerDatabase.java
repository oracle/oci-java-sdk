...
/**
 * Properties for an Autonomous Container Database member in an Automatic DR configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutomaticDrConfigurationMemberAutonomousContainerDatabase.Builder.class)
...
public final class AutomaticDrConfigurationMemberAutonomousContainerDatabase
        extends AutomaticDrConfigurationMember {
    ...
    public static class Builder {
        ...
        /**
         * A flag indicating if the automatic switchover should be enabled for the Autonomous
         * Container Database member in the Automatic DR configuration.
         *
        ...
        /**
         * A flag indicating if the automatic failover should be enabled for the Autonomous
         * Container Database member in the Automatic DR configuration.
         *
         * <p>Example: {@code false}
         */
        ...
        public AutomaticDrConfigurationMemberAutonomousContainerDatabase build() {
            AutomaticDrConfigurationMemberAutonomousContainerDatabase model =
                    new AutomaticDrConfigurationMemberAutonomousContainerDatabase(
                            this.memberId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutomaticDrConfigurationMemberAutonomousContainerDatabase model) {
    ...
    @Deprecated
    public AutomaticDrConfigurationMemberAutonomousContainerDatabase(
    ...
    /**
     * A flag indicating if the automatic switchover should be enabled for the Autonomous Container
     * Database member in the Automatic DR configuration.
     *
     * <p>Example: {@code false}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isAutoSwitchoverEnabled")
    ...
    /**
     * A flag indicating if the automatic failover should be enabled for the Autonomous Container
     * Database member in the Automatic DR configuration.
     *
     * <p>Example: {@code false}
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutomaticDrConfigurationMemberAutonomousContainerDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutomaticDrConfigurationMemberAutonomousContainerDatabase)) {
            return false;
        }

        AutomaticDrConfigurationMemberAutonomousContainerDatabase other =
                (AutomaticDrConfigurationMemberAutonomousContainerDatabase) o;
