...
public class RetryDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RetryDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RetryDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(RetryDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public RetryDrPlanExecutionResponse build() {
            return new RetryDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetryDrPlanExecutionResponse)) {
            return false;
        }

        RetryDrPlanExecutionResponse other = (RetryDrPlanExecutionResponse) o;
