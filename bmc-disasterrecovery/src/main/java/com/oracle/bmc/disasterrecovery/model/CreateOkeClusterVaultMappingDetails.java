...
/**
 * Create source-to-destination mapping for a vault. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOkeClusterVaultMappingDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateOkeClusterVaultMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"sourceVaultId", "destinationVaultId"})
    public CreateOkeClusterVaultMappingDetails(String sourceVaultId, String destinationVaultId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateOkeClusterVaultMappingDetails build() {
            CreateOkeClusterVaultMappingDetails model =
                    new CreateOkeClusterVaultMappingDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOkeClusterVaultMappingDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOkeClusterVaultMappingDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOkeClusterVaultMappingDetails)) {
            return false;
        }

        CreateOkeClusterVaultMappingDetails other = (CreateOkeClusterVaultMappingDetails) o;
