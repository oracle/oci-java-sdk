...
/**
 * Update source-to-destination mapping for a load balancer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOkeClusterLoadBalancerMappingDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOkeClusterLoadBalancerMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"sourceLoadBalancerId", "destinationLoadBalancerId"})
    public UpdateOkeClusterLoadBalancerMappingDetails(
    ...
    public static class Builder {
        ...
        public UpdateOkeClusterLoadBalancerMappingDetails build() {
            UpdateOkeClusterLoadBalancerMappingDetails model =
                    new UpdateOkeClusterLoadBalancerMappingDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOkeClusterLoadBalancerMappingDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOkeClusterLoadBalancerMappingDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOkeClusterLoadBalancerMappingDetails)) {
            return false;
        }

        UpdateOkeClusterLoadBalancerMappingDetails other =
                (UpdateOkeClusterLoadBalancerMappingDetails) o;
