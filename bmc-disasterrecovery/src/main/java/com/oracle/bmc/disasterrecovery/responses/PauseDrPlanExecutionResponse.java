...
public class PauseDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PauseDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PauseDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(PauseDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public PauseDrPlanExecutionResponse build() {
            return new PauseDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PauseDrPlanExecutionResponse)) {
            return false;
        }

        PauseDrPlanExecutionResponse other = (PauseDrPlanExecutionResponse) o;
