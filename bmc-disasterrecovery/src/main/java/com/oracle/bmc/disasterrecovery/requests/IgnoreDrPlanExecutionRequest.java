...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/IgnoreDrPlanExecutionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use IgnoreDrPlanExecutionRequest.
 */
...
public class IgnoreDrPlanExecutionRequest
    ...
    public static class Builder
        ...
        public IgnoreDrPlanExecutionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new IgnoreDrPlanExecutionRequest(ignoreDrPlanExecutionDetails, drPlanExecutionId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
