...
/**
 * Source-to-destination mapping for a load balancer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OkeClusterLoadBalancerMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OkeClusterLoadBalancerMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"sourceLoadBalancerId", "destinationLoadBalancerId"})
    public OkeClusterLoadBalancerMapping(
    ...
    public static class Builder {
        ...
        public OkeClusterLoadBalancerMapping build() {
            OkeClusterLoadBalancerMapping model =
                    new OkeClusterLoadBalancerMapping(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeClusterLoadBalancerMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeClusterLoadBalancerMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeClusterLoadBalancerMapping)) {
            return false;
        }

        OkeClusterLoadBalancerMapping other = (OkeClusterLoadBalancerMapping) o;
