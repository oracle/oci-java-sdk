...
/**
 * Invoke Oracle function User Defined custom precheck step details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InvokeFunctionUserDefinedCustomPrecheckStep.Builder.class)
...
public final class InvokeFunctionUserDefinedCustomPrecheckStep extends DrPlanUserDefinedStep {
    ...
    public static class Builder {
        ...
        public InvokeFunctionUserDefinedCustomPrecheckStep build() {
            InvokeFunctionUserDefinedCustomPrecheckStep model =
                    new InvokeFunctionUserDefinedCustomPrecheckStep(
                            this.functionId, this.functionRegion, this.requestBody);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvokeFunctionUserDefinedCustomPrecheckStep model) {
    ...
    @Deprecated
    public InvokeFunctionUserDefinedCustomPrecheckStep(
            String functionId, String functionRegion, String requestBody) {
        super();
        this.functionId = functionId;
        this.functionRegion = functionRegion;
        this.requestBody = requestBody;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InvokeFunctionUserDefinedCustomPrecheckStep(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvokeFunctionUserDefinedCustomPrecheckStep)) {
            return false;
        }

        InvokeFunctionUserDefinedCustomPrecheckStep other =
                (InvokeFunctionUserDefinedCustomPrecheckStep) o;
