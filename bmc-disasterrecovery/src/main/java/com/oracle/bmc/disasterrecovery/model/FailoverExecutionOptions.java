...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FailoverExecutionOptions.Builder.class)
...
public final class FailoverExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public FailoverExecutionOptions build() {
            FailoverExecutionOptions model =
                    new FailoverExecutionOptions(this.arePrechecksEnabled, this.areWarningsIgnored);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FailoverExecutionOptions model) {
    ...
    @Deprecated
    public FailoverExecutionOptions(Boolean arePrechecksEnabled, Boolean areWarningsIgnored) {
        super();
        this.arePrechecksEnabled = arePrechecksEnabled;
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FailoverExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverExecutionOptions)) {
            return false;
        }

        FailoverExecutionOptions other = (FailoverExecutionOptions) o;
