...
/**
 * Options for failover execution. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FailoverExecutionOptionDetails.Builder.class)
...
public final class FailoverExecutionOptionDetails extends DrPlanExecutionOptionDetails {
    ...
    public static class Builder {
        ...
        public FailoverExecutionOptionDetails build() {
            FailoverExecutionOptionDetails model =
                    new FailoverExecutionOptionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FailoverExecutionOptionDetails model) {
    ...
    @Deprecated
    public FailoverExecutionOptionDetails(Boolean arePrechecksEnabled, Boolean areWarningsIgnored) {
        super();
        this.arePrechecksEnabled = arePrechecksEnabled;
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FailoverExecutionOptionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverExecutionOptionDetails)) {
            return false;
        }

        FailoverExecutionOptionDetails other = (FailoverExecutionOptionDetails) o;
