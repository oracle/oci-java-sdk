...
/**
 * Create source volume ID to destination customer managed vault and encryption key ID mapping for a
 * volume group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateSourceVolumeToDestinationEncryptionKeyMappingDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateSourceVolumeToDestinationEncryptionKeyMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"sourceVolumeId", "destinationEncryptionKey"})
    public CreateSourceVolumeToDestinationEncryptionKeyMappingDetails(
            String sourceVolumeId, CreateVaultAndEncryptionKeyDetails destinationEncryptionKey) {
        super();
    ...
    public static class Builder {
        ...
        public CreateSourceVolumeToDestinationEncryptionKeyMappingDetails build() {
            CreateSourceVolumeToDestinationEncryptionKeyMappingDetails model =
                    new CreateSourceVolumeToDestinationEncryptionKeyMappingDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSourceVolumeToDestinationEncryptionKeyMappingDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSourceVolumeToDestinationEncryptionKeyMappingDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSourceVolumeToDestinationEncryptionKeyMappingDetails)) {
            return false;
        }

        CreateSourceVolumeToDestinationEncryptionKeyMappingDetails other =
                (CreateSourceVolumeToDestinationEncryptionKeyMappingDetails) o;
