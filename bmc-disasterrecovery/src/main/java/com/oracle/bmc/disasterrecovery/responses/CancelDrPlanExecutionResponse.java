...
public class CancelDrPlanExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CancelDrPlanExecutionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelDrPlanExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(CancelDrPlanExecutionResponse o) {
         ...
         */
        @Override
        public CancelDrPlanExecutionResponse build() {
            return new CancelDrPlanExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelDrPlanExecutionResponse)) {
            return false;
        }

        CancelDrPlanExecutionResponse other = (CancelDrPlanExecutionResponse) o;
