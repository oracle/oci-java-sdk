...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMySqlDbSystemAdminUserDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateMySqlDbSystemAdminUserDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"username", "passwordVaultSecretId"})
    public UpdateMySqlDbSystemAdminUserDetails(String username, String passwordVaultSecretId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateMySqlDbSystemAdminUserDetails build() {
            UpdateMySqlDbSystemAdminUserDetails model =
                    new UpdateMySqlDbSystemAdminUserDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMySqlDbSystemAdminUserDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMySqlDbSystemAdminUserDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMySqlDbSystemAdminUserDetails)) {
            return false;
        }

        UpdateMySqlDbSystemAdminUserDetails other = (UpdateMySqlDbSystemAdminUserDetails) o;
