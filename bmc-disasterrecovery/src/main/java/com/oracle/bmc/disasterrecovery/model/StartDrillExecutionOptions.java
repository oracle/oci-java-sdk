...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StartDrillExecutionOptions.Builder.class)
...
public final class StartDrillExecutionOptions extends DrPlanExecutionOptions {
    ...
    public static class Builder {
        ...
        public StartDrillExecutionOptions build() {
            StartDrillExecutionOptions model =
                    new StartDrillExecutionOptions(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StartDrillExecutionOptions model) {
    ...
    @Deprecated
    public StartDrillExecutionOptions(Boolean arePrechecksEnabled, Boolean areWarningsIgnored) {
        super();
        this.arePrechecksEnabled = arePrechecksEnabled;
        this.areWarningsIgnored = areWarningsIgnored;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StartDrillExecutionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDrillExecutionOptions)) {
            return false;
        }

        StartDrillExecutionOptions other = (StartDrillExecutionOptions) o;
