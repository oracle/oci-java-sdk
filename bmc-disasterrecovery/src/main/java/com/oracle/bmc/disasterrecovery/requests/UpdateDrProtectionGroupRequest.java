...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/disasterrecovery/UpdateDrProtectionGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDrProtectionGroupRequest.
 */
...
public class UpdateDrProtectionGroupRequest
    ...
    public static class Builder
        ...
        public UpdateDrProtectionGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDrProtectionGroupRequest(updateDrProtectionGroupDetails, drProtectionGroupId, ifMatch, opcRequestId);
        }
    }
