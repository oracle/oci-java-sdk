...
public class CreateDrProtectionGroupMemberDetails
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDrProtectionGroupMemberDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrProtectionGroupMemberDetails)) {
            return false;
        }

        CreateDrProtectionGroupMemberDetails other = (CreateDrProtectionGroupMemberDetails) o;
