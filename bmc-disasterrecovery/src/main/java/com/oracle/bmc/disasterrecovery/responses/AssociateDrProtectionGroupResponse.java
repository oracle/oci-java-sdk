...
public class AssociateDrProtectionGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AssociateDrProtectionGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(AssociateDrProtectionGroupResponse o) {
         ...
         */
        @Override
        public AssociateDrProtectionGroupResponse build() {
            return new AssociateDrProtectionGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssociateDrProtectionGroupResponse)) {
            return false;
        }

        AssociateDrProtectionGroupResponse other = (AssociateDrProtectionGroupResponse) o;
