...
/**
 * Update properties for Database member in an Automatic DR configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAutomaticDrConfigurationMemberDatabaseDetails.Builder.class)
...
public final class UpdateAutomaticDrConfigurationMemberDatabaseDetails
    ...
    public static class Builder {
        ...
        public UpdateAutomaticDrConfigurationMemberDatabaseDetails build() {
            UpdateAutomaticDrConfigurationMemberDatabaseDetails model =
                    new UpdateAutomaticDrConfigurationMemberDatabaseDetails(
                            this.memberId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAutomaticDrConfigurationMemberDatabaseDetails model) {
    ...
    @Deprecated
    public UpdateAutomaticDrConfigurationMemberDatabaseDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAutomaticDrConfigurationMemberDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutomaticDrConfigurationMemberDatabaseDetails)) {
            return false;
        }

        UpdateAutomaticDrConfigurationMemberDatabaseDetails other =
                (UpdateAutomaticDrConfigurationMemberDatabaseDetails) o;
