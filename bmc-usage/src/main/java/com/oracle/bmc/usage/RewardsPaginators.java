 ...
 * to any list operations of Rewards where multiple pages of data may be fetched. Two styles of
...
public class RewardsPaginators {
     ...
     * com.oracle.bmc.usage.model.ProductSummary} objects contained in responses from the
     * listProducts operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.usage.model.ProductSummary} objects contained in responses received from
     *     the service.
     */
     ...
     * listRedeemableUsers operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.usage.model.RedeemableUserSummary} objects contained in responses from the
     * listRedeemableUsers operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.usage.model.RedeemableUserSummary} objects contained in responses received
     *     from the service.
     */
    public Iterable<com.oracle.bmc.usage.model.RedeemableUserSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListRedeemableUsersRequest,
                ListRedeemableUsersResponse,
                com.oracle.bmc.usage.model.RedeemableUserSummary>(
                new java.util.function.Supplier<ListRedeemableUsersRequest.Builder>() {
                    @Override
                    public ListRedeemableUsersRequest.Builder get() {
                        return ListRedeemableUsersRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRedemptions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.usage.model.RedemptionSummary} objects contained in responses from the
     * listRedemptions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.usage.model.RedemptionSummary} objects contained in responses received
     *     from the service.
     */
