 ...
 * to any list operations of Usagelimits where multiple pages of data may be fetched.
...
public class UsagelimitsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listUsageLimits operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.usage.model.UsageLimitSummary} objects
     * contained in responses from the listUsageLimits operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.usage.model.UsageLimitSummary} objects
