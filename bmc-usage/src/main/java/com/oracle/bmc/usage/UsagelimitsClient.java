...
public class UsagelimitsClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UsagelimitsClient.class);

    private final UsagelimitsPaginators paginators;
    ...
    UsagelimitsClient(
        ...
        this.paginators = new UsagelimitsPaginators(this);
    }
    ...
    public static class Builder
         ...
         * @return the client
         */
        public UsagelimitsClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new UsagelimitsClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public ListUsageLimitsResponse listUsageLimits(ListUsageLimitsRequest request) {
        ...
        return clientCall(request, ListUsageLimitsResponse::builder)
                .logger(LOG, "listUsageLimits")
                .serviceDetails(
                        "Usagelimits",
                        "ListUsageLimits",
                        "https://docs.oracle.com/iaas/api/#/en/usage-proxy/20190111/UsageLimitSummary/ListUsageLimits")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListUsageLimitsRequest::builder)
                .basePath("/20190111")
                .appendPathParam("usagelimits")
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .appendQueryParam("subscriptionId", request.getSubscriptionId())
                .appendQueryParam("limitType", request.getLimitType())
                ...
                .handleBody(
                        com.oracle.bmc.usage.model.UsageLimitCollection.class,
                        ListUsageLimitsResponse.Builder::usageLimitCollection)
                .handleResponseHeaderString(
                        "opc-request-id", ListUsageLimitsResponse.Builder::opcRequestId)
                .handleResponseHeaderString(
                        "opc-next-page", ListUsageLimitsResponse.Builder::opcNextPage)
                .callSync();
    }
