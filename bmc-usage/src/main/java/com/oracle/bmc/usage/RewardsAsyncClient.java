...
public class RewardsAsyncClient implements RewardsAsync {
    /**
    ...
    public java.util.concurrent.Future<CreateRedeemableUserResponse> createRedeemableUser(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async createRedeemableUser");
        final CreateRedeemableUserRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateRedeemableUserRequest, CreateRedeemableUserResponse>,
                        java.util.concurrent.Future<CreateRedeemableUserResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateRedeemableUserDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<DeleteRedeemableUserResponse> deleteRedeemableUser(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async deleteRedeemableUser");
        final DeleteRedeemableUserRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeleteRedeemableUserRequest, DeleteRedeemableUserResponse>,
                        java.util.concurrent.Future<DeleteRedeemableUserResponse>>
    ...
    public java.util.concurrent.Future<ListRedeemableUsersResponse> listRedeemableUsers(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listRedeemableUsers");
        final ListRedeemableUsersRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListRedeemableUsersRequest, ListRedeemableUsersResponse>,
                        java.util.concurrent.Future<ListRedeemableUsersResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<ListRewardsResponse> listRewards(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ListRewardsRequest, ListRewardsResponse>
                    handler) {
        LOG.trace("Called async listRewards");
        final ListRewardsRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListRewardsRequest, ListRewardsResponse>,
                        java.util.concurrent.Future<ListRewardsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
