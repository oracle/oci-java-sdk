...
public class ResourcesClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ResourcesClient.class);

    private final ResourcesPaginators paginators;
    ...
    ResourcesClient(
        ...
        this.paginators = new ResourcesPaginators(this);
    }
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ResourcesClient> {
         ...
         * @return the client
         */
        public ResourcesClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ResourcesClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public ListResourceQuotaResponse listResourceQuota(ListResourceQuotaRequest request) {
        ...
        return clientCall(request, ListResourceQuotaResponse::builder)
                .logger(LOG, "listResourceQuota")
                .serviceDetails(
                        "Resources",
                        "ListResourceQuota",
                        "https://docs.oracle.com/iaas/api/#/en/usage-proxy/20190111/ResourceQuotumSummary/ListResourceQuota")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListResourceQuotaRequest::builder)
                .basePath("/20190111")
                .appendPathParam("resources")
                .appendPathParam("quota")
                .appendQueryParam("serviceName", request.getServiceName())
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .appendQueryParam("serviceEntitlement", request.getServiceEntitlement())
    ...
    public ListResourcesResponse listResources(ListResourcesRequest request) {
        ...
        return clientCall(request, ListResourcesResponse::builder)
                ...
                .appendQueryParam("serviceName", request.getServiceName())
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .appendQueryParam("entitlementId", request.getEntitlementId())
                .appendQueryParam("page", request.getPage())
                .appendQueryParam("limit", request.getLimit())
                .appendEnumQueryParam("sortOrder", request.getSortOrder())
                .appendEnumQueryParam("sortBy", request.getSortBy())
