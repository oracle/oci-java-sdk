...
public class ResourcesClient implements Resources {
    /**
    ...
    public ListResourceQuotaResponse listResourceQuota(ListResourceQuotaRequest request) {
        LOG.trace("Called listResourceQuota");
        final ListResourceQuotaRequest interceptedRequest =
                ListResourceQuotaConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListResourceQuotaConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListResourceQuotaResponse>
                transformer =
                        ListResourceQuotaConverter.fromResponse(
