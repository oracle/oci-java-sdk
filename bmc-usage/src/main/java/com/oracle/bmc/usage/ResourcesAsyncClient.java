...
/**
 * Async client implementation for Resources service. <br/>
...
public class ResourcesAsyncClient implements ResourcesAsync {
    /**
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ResourcesAsyncClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ResourcesAsyncClient> {
         ...
         * @return the client
         */
        public ResourcesAsyncClient build(
            ...
            return new ResourcesAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public java.util.concurrent.Future<ListResourceQuotaResponse> listResourceQuota(
            ListResourceQuotaRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            ListResourceQuotaRequest, ListResourceQuotaResponse>
                    handler) {
        LOG.trace("Called async listResourceQuota");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListResourceQuotaResponse>
                transformer =
                        ListResourceQuotaConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ListResourceQuotaRequest, ListResourceQuotaResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListResourceQuotaRequest, ListResourceQuotaResponse>,
                        java.util.concurrent.Future<ListResourceQuotaResponse>>
