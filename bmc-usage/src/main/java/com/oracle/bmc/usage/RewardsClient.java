...
public class RewardsClient implements Rewards {
    ...
    public CreateRedeemableUserResponse createRedeemableUser(CreateRedeemableUserRequest request) {
        LOG.trace("Called createRedeemableUser");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateRedeemableUserDetails(),
                                                retriedRequest);
    ...
    public DeleteRedeemableUserResponse deleteRedeemableUser(DeleteRedeemableUserRequest request) {
        LOG.trace("Called deleteRedeemableUser");
    ...
    public ListRedeemableUsersResponse listRedeemableUsers(ListRedeemableUsersRequest request) {
        LOG.trace("Called listRedeemableUsers");
    ...
    public ListRedemptionsResponse listRedemptions(ListRedemptionsRequest request) {
        LOG.trace("Called listRedemptions");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListRedemptionsResponse>
                transformer =
