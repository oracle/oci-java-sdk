...
public final class DataIngestionJobCollection
    ...
    public static class Builder {
        ...
        public DataIngestionJobCollection build() {
            DataIngestionJobCollection model = new DataIngestionJobCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataIngestionJobCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataIngestionJobCollection)) {
            return false;
        }

        DataIngestionJobCollection other = (DataIngestionJobCollection) o;
