...
public class GetAgentEndpointConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAgentEndpointConverter.class);

    public static com.oracle.bmc.generativeaiagent.requests.GetAgentEndpointRequest
            interceptRequest(
                    com.oracle.bmc.generativeaiagent.requests.GetAgentEndpointRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.generativeaiagent.responses.GetAgentEndpointResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.generativeaiagent.responses
                                        .GetAgentEndpointResponse>() {
                            @Override
                            public com.oracle.bmc.generativeaiagent.responses
                                            .GetAgentEndpointResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeaiagent.responses.GetAgentEndpointResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.agentEndpoint(response.getItem());
