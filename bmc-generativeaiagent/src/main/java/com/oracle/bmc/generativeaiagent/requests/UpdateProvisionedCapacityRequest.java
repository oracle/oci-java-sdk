...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/UpdateProvisionedCapacityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateProvisionedCapacityRequest.
 */
...
public class UpdateProvisionedCapacityRequest
    ...
    public static class Builder
        ...
        public UpdateProvisionedCapacityRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateProvisionedCapacityRequest(provisionedCapacityId, updateProvisionedCapacityDetails, ifMatch, opcRequestId);
        }
    }
