...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = DatabaseConnection.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabaseToolConnection.class,
        name = "DATABASE_TOOL_CONNECTION"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class DatabaseConnection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * - {@code DATABASE_TOOL_CONNECTION}: This allows the service to connect to a vector store via a Database Tools Connection.
     *
     **/
