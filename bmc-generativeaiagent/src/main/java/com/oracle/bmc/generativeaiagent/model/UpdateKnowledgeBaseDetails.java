 ...
 *
 * <p>The data to update a knowledge base. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateKnowledgeBaseDetails.Builder.class)
...
public final class UpdateKnowledgeBaseDetails
    ...
    public UpdateKnowledgeBaseDetails(
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public UpdateKnowledgeBaseDetails build() {
            UpdateKnowledgeBaseDetails model =
                    new UpdateKnowledgeBaseDetails(
                            this.displayName,
                            this.description,
                            this.indexConfig,
                            this.freeformTags,
