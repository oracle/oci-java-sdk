...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/ListProvisionedCapacitiesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListProvisionedCapacitiesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class ListProvisionedCapacitiesRequest
     ...
     *
     */
    private com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity.LifecycleState
            lifecycleState;
     ...
     *
     */
    public com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListProvisionedCapacitiesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListProvisionedCapacitiesRequest o) {
        ...
        /**
         * Build the instance of ListProvisionedCapacitiesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListProvisionedCapacitiesRequest
         */
        public ListProvisionedCapacitiesRequest build() {
            ListProvisionedCapacitiesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListProvisionedCapacitiesRequest
         */
        public ListProvisionedCapacitiesRequest buildWithoutInvocationCallback() {
            ListProvisionedCapacitiesRequest request = new ListProvisionedCapacitiesRequest();
            ...
            return request;
            // new ListProvisionedCapacitiesRequest(compartmentId, provisionedCapacityId, lifecycleState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListProvisionedCapacitiesRequest)) {
            return false;
        }

        ListProvisionedCapacitiesRequest other = (ListProvisionedCapacitiesRequest) o;
