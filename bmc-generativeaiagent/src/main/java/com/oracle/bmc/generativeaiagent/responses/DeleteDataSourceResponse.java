...
public class DeleteDataSourceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteDataSourceResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteDataSourceResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDataSourceResponse)) {
            return false;
        }

        DeleteDataSourceResponse other = (DeleteDataSourceResponse) o;
