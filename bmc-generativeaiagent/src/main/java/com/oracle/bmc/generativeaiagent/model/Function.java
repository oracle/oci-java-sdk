...
/**
 * Details of Function for Function calling tool. <br>
...
public final class Function extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * The parameters the function accepts, defined using a JSON Schema object. Refer to the
         * guide for examples and the JSON Schema documentation for details on the format.
         */
    ...
    /**
     * The parameters the function accepts, defined using a JSON Schema object. Refer to the guide
