...
public class CreateDataIngestionJobConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateDataIngestionJobConverter.class);

    public static com.oracle.bmc.generativeaiagent.requests.CreateDataIngestionJobRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.generativeaiagent.requests.CreateDataIngestionJobRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20240531").path("dataIngestionJobs");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.generativeaiagent.responses.CreateDataIngestionJobResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.generativeaiagent.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeaiagent.responses.CreateDataIngestionJobResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.generativeaiagent.responses
                                                .CreateDataIngestionJobResponse.Builder
                                        builder =
                                                com.oracle.bmc.generativeaiagent.responses
                                                        .CreateDataIngestionJobResponse.builder()
                                ...
                                builder.dataIngestionJob(response.getItem());
