 ...
 * **CreateAgentDetails**
 *
 * <p>The data to create an agent. <br>
...
public final class CreateAgentDetails
    ...
    public static class Builder {
         ...
         * of the compartment to create the agent in.
         */
        ...
        public Builder knowledgeBaseIds(java.util.List<String> knowledgeBaseIds) {
            this.knowledgeBaseIds = knowledgeBaseIds;
            this.__explicitlySet__.add("knowledgeBaseIds");
            return this;
        }
        ...
        public Builder copy(CreateAgentDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("knowledgeBaseIds")) {
                this.knowledgeBaseIds(model.getKnowledgeBaseIds());
            }
     ...
     * the compartment to create the agent in.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * List of [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
     * of the knowledgeBases associated with agent.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("knowledgeBaseIds")
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.knowledgeBaseIds == null ? 43 : this.knowledgeBaseIds.hashCode());
        result =
                (result * PRIME)
