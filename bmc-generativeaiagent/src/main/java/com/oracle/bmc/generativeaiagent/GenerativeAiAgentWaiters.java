...
public class GenerativeAiAgentWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forProvisionedCapacity(
                    GetProvisionedCapacityRequest request,
                    com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity.LifecycleState...
                            targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
    ...
    // Helper method to create a new Waiter for ProvisionedCapacity.
    private com.oracle.bmc.waiter.Waiter<
                    GetProvisionedCapacityRequest, GetProvisionedCapacityResponse>
            forProvisionedCapacity(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetProvisionedCapacityRequest request,
                    final com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity.LifecycleState
                                    ...
                            targetStates) {
        final java.util.Set<
                        com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetProvisionedCapacityRequest, GetProvisionedCapacityResponse>() {
                            @Override
                            public GetProvisionedCapacityResponse apply(
                                    GetProvisionedCapacityRequest request) {
                                return client.getProvisionedCapacity(request);
                            }
                        },
                        new java.util.function.Predicate<GetProvisionedCapacityResponse>() {
                            @Override
                            public boolean test(GetProvisionedCapacityResponse response) {
                                return targetStatesSet.contains(
                                        response.getProvisionedCapacity().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.generativeaiagent.model.ProvisionedCapacity
                                        .LifecycleState.Deleted)),
                request);
    }
