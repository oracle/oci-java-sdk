...
public class DeleteKnowledgeBaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteKnowledgeBaseResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteKnowledgeBaseResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteKnowledgeBaseResponse)) {
            return false;
        }

        DeleteKnowledgeBaseResponse other = (DeleteKnowledgeBaseResponse) o;
