...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/CreateProvisionedCapacityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateProvisionedCapacityRequest.
 */
...
public class CreateProvisionedCapacityRequest
    ...
    public static class Builder
        ...
        public CreateProvisionedCapacityRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateProvisionedCapacityRequest(createProvisionedCapacityDetails, opcRetryToken, opcRequestId);
        }
    }
