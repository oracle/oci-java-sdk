...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/GetProvisionedCapacityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetProvisionedCapacityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class GetProvisionedCapacityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetProvisionedCapacityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetProvisionedCapacityRequest o) {
        ...
        /**
         * Build the instance of GetProvisionedCapacityRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetProvisionedCapacityRequest
         */
        public GetProvisionedCapacityRequest build() {
            GetProvisionedCapacityRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetProvisionedCapacityRequest
         */
        public GetProvisionedCapacityRequest buildWithoutInvocationCallback() {
            GetProvisionedCapacityRequest request = new GetProvisionedCapacityRequest();
            request.provisionedCapacityId = provisionedCapacityId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetProvisionedCapacityRequest(provisionedCapacityId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetProvisionedCapacityRequest)) {
            return false;
        }

        GetProvisionedCapacityRequest other = (GetProvisionedCapacityRequest) o;
