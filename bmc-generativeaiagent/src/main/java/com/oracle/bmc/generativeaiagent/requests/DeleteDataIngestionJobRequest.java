...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/DeleteDataIngestionJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDataIngestionJobRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class DeleteDataIngestionJobRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDataIngestionJobRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDataIngestionJobRequest o) {
        ...
        /**
         * Build the instance of DeleteDataIngestionJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDataIngestionJobRequest
         */
        public DeleteDataIngestionJobRequest build() {
            DeleteDataIngestionJobRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDataIngestionJobRequest
         */
        public DeleteDataIngestionJobRequest buildWithoutInvocationCallback() {
            DeleteDataIngestionJobRequest request = new DeleteDataIngestionJobRequest();
            request.dataIngestionJobId = dataIngestionJobId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDataIngestionJobRequest(dataIngestionJobId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDataIngestionJobRequest)) {
            return false;
        }

        DeleteDataIngestionJobRequest other = (DeleteDataIngestionJobRequest) o;
