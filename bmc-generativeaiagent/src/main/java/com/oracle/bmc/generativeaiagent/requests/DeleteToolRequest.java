...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/DeleteToolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteToolRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class DeleteToolRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteToolRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteToolRequest o) {
            toolId(o.getToolId());
         ...
         *
         * @return instance of DeleteToolRequest
         */
        public DeleteToolRequest build() {
            DeleteToolRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteToolRequest
         */
        public DeleteToolRequest buildWithoutInvocationCallback() {
            DeleteToolRequest request = new DeleteToolRequest();
            request.toolId = toolId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteToolRequest(toolId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().toolId(toolId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteToolRequest)) {
            return false;
        }

        DeleteToolRequest other = (DeleteToolRequest) o;
