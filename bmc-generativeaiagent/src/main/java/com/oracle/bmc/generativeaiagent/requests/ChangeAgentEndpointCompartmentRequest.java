...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/ChangeAgentEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAgentEndpointCompartmentRequest.
 */
...
public class ChangeAgentEndpointCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeAgentEndpointCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeAgentEndpointCompartmentRequest(agentEndpointId, changeAgentEndpointCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
