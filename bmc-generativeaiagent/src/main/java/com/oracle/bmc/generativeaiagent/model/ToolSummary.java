...
/**
 * Summary information of a Tool. <br>
...
public final class ToolSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private Tool.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(Tool.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
    ...
    /** The current state of the agent. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Tool.LifecycleState lifecycleState;
