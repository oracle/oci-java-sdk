 ...
 * **AgentSummary**
 *
 * <p>Summary information about an agent. <br>
...
public final class AgentSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * A message that describes the current state of the agent in more detail. For example, can
    ...
    /**
     * A message that describes the current state of the agent in more detail. For example, can be
