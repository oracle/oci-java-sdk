...
public class CreateAgentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.generativeaiagent.model.Agent agent;
     ...
     * @return the value
     */
    public com.oracle.bmc.generativeaiagent.model.Agent getAgent() {
        return agent;
    }
    ...
    private CreateAgentResponse(
            ...
            String opcRequestId,
            com.oracle.bmc.generativeaiagent.model.Agent agent) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAgentResponse> {
         ...
         * @return this builder
         */
        public Builder agent(com.oracle.bmc.generativeaiagent.model.Agent agent) {
            this.agent = agent;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(CreateAgentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAgentResponse)) {
            return false;
        }
