...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/DeleteProvisionedCapacityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteProvisionedCapacityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class DeleteProvisionedCapacityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteProvisionedCapacityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteProvisionedCapacityRequest o) {
        ...
        /**
         * Build the instance of DeleteProvisionedCapacityRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteProvisionedCapacityRequest
         */
        public DeleteProvisionedCapacityRequest build() {
            DeleteProvisionedCapacityRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteProvisionedCapacityRequest
         */
        public DeleteProvisionedCapacityRequest buildWithoutInvocationCallback() {
            DeleteProvisionedCapacityRequest request = new DeleteProvisionedCapacityRequest();
            request.provisionedCapacityId = provisionedCapacityId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteProvisionedCapacityRequest(provisionedCapacityId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteProvisionedCapacityRequest)) {
            return false;
        }

        DeleteProvisionedCapacityRequest other = (DeleteProvisionedCapacityRequest) o;
