...
public class CreateAgentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateAgentConverter.class);

    public static com.oracle.bmc.generativeaiagent.requests.CreateAgentRequest interceptRequest(
            com.oracle.bmc.generativeaiagent.requests.CreateAgentRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getCreateAgentDetails(), "createAgentDetails is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20240531").path("agents");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.generativeaiagent.responses.CreateAgentResponse>() {
                            @Override
                            public com.oracle.bmc.generativeaiagent.responses.CreateAgentResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeaiagent.responses.CreateAgentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
