 ...
 * **WorkRequestLogEntry**
 *
 * <p>A log message from performing an operation that is tracked by a work request. <br>
...
public final class WorkRequestLogEntry
    ...
    public static class Builder {
        ...
        /**
         * The date and time the log message was written, in the format defined by [RFC
