 ...
 * **DataSourceSummary**
 *
 * <p>Summary information about a data source. <br>
...
public final class DataSourceSummary
    ...
    public static class Builder {
        ...
        /**
         * The date and time the DataSource was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        private DataSource.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(DataSource.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
    ...
    /** The current state of the data source. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final DataSource.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public DataSource.LifecycleState getLifecycleState() {
