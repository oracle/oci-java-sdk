...
public class CreateDataSourceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     * URL for the created data source. The data source OCID is generated after this request is
     * sent.
     */
    ...
    private com.oracle.bmc.generativeaiagent.model.DataSource dataSource;
     ...
     * @return the value
     */
    public com.oracle.bmc.generativeaiagent.model.DataSource getDataSource() {
        return dataSource;
    }
    ...
    private CreateDataSourceResponse(
            ...
            String opcRequestId,
            com.oracle.bmc.generativeaiagent.model.DataSource dataSource) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDataSourceResponse> {
         ...
         * @return this builder
         */
        public Builder dataSource(com.oracle.bmc.generativeaiagent.model.DataSource dataSource) {
            this.dataSource = dataSource;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(CreateDataSourceResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",dataSource=").append(String.valueOf(dataSource));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataSourceResponse)) {
            return false;
        }

        CreateDataSourceResponse other = (CreateDataSourceResponse) o;
