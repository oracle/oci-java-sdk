 ...
 *
 * <p>The details of the customer Database Tools Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolConnection.Builder.class)
...
public final class DatabaseToolConnection extends DatabaseConnection {
    ...
    public static class Builder {
        ...
        public DatabaseToolConnection build() {
            DatabaseToolConnection model = new DatabaseToolConnection(this.connectionId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolConnection model) {
    ...
    @Deprecated
    public DatabaseToolConnection(String connectionId) {
        super();
        this.connectionId = connectionId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolConnection)) {
            return false;
        }

        DatabaseToolConnection other = (DatabaseToolConnection) o;
