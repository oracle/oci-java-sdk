...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/GetToolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetToolRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240531")
public class GetToolRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetToolRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetToolRequest o) {
            toolId(o.getToolId());
         ...
         *
         * @return instance of GetToolRequest
         */
        public GetToolRequest build() {
            GetToolRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetToolRequest
         */
        public GetToolRequest buildWithoutInvocationCallback() {
            GetToolRequest request = new GetToolRequest();
            request.toolId = toolId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetToolRequest(toolId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().toolId(toolId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetToolRequest)) {
            return false;
        }
