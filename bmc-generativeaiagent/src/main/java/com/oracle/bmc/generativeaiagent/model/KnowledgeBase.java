...
public final class KnowledgeBase extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("indexConfig")
        ...
        /**
         * The date and time the knowledge base was created, in the format defined by [RFC
        ...
        /**
         * The date and time the knowledge base was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        /**
         * A message that describes the current state of the knowledge base in more detail. For
