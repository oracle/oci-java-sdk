 ...
 *
 * <p>Summary information about a data ingestion job. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataIngestionJobSummary.Builder.class)
...
public final class DataIngestionJobSummary
    ...
    public static class Builder {
        ...
        private DataIngestionJob.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(DataIngestionJob.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public DataIngestionJobSummary build() {
            DataIngestionJobSummary model =
                    new DataIngestionJobSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.dataSourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataIngestionJobSummary model) {
    ...
    /** The current state of the data ingestion job. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final DataIngestionJob.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public DataIngestionJob.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataIngestionJobSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataIngestionJobSummary)) {
            return false;
        }

        DataIngestionJobSummary other = (DataIngestionJobSummary) o;
