...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AgentEndpoint.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AgentEndpoint extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgentEndpoint model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AgentEndpoint)) {
            return false;
        }

        AgentEndpoint other = (AgentEndpoint) o;
