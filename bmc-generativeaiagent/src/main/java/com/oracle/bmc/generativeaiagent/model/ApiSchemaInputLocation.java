...
public class ApiSchemaInputLocation extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * - {@code INLINE}: The Api schema input location is inline.
     * - {@code OBJECT_STORAGE_LOCATION}: The Api schema input location is object storage.
     *
     **/
    public enum ApiSchemaInputLocationType {
        Inline("INLINE"),
