...
public class ListDataIngestionJobsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.generativeaiagent.model.DataIngestionJobCollection
            getDataIngestionJobCollection() {
        return dataIngestionJobCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder dataIngestionJobCollection(
                com.oracle.bmc.generativeaiagent.model.DataIngestionJobCollection
                        dataIngestionJobCollection) {
            this.dataIngestionJobCollection = dataIngestionJobCollection;
            return this;
        ...
        public Builder copy(ListDataIngestionJobsResponse o) {
            ...
            dataIngestionJobCollection(o.getDataIngestionJobCollection());
    ...
    public String toString() {
        ...
        sb.append(",dataIngestionJobCollection=")
                .append(String.valueOf(dataIngestionJobCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDataIngestionJobsResponse)) {
            return false;
        }

        ListDataIngestionJobsResponse other = (ListDataIngestionJobsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.dataIngestionJobCollection, other.dataIngestionJobCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataIngestionJobCollection == null
                                ? 43
                                : this.dataIngestionJobCollection.hashCode());
        return result;
    }
}
