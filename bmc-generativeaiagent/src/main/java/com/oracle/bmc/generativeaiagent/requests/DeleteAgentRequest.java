...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaiagent/DeleteAgentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAgentRequest.
 */
...
public class DeleteAgentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteAgentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteAgentRequest(agentId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().agentId(agentId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
