...
public class GenerateSensitiveDataModelForDownloadDetails {
    ...
    public static class Builder {
        ...
        public GenerateSensitiveDataModelForDownloadDetails build() {
            GenerateSensitiveDataModelForDownloadDetails __instance__ =
                    new GenerateSensitiveDataModelForDownloadDetails(dataModelFormat);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateSensitiveDataModelForDownloadDetails o) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("dataModelFormat")
    DataModelFormat dataModelFormat;
