...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UpdateUnifiedAuditPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateUnifiedAuditPolicyRequest.
 */
...
public class UpdateUnifiedAuditPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateUnifiedAuditPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateUnifiedAuditPolicyRequest(unifiedAuditPolicyId, updateUnifiedAuditPolicyDetails, ifMatch, opcRequestId);
        }
    }
