...
public class ListCryptoAssessmentKeysRequest
    ...
    /**
     * Filters key results to rows whose primary or secondary keystore type matches any of the
     * specified key manager types.
     */
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Filters key results to rows whose primary or secondary keystore type
         * matches any of the specified key manager types.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        public ListCryptoAssessmentKeysRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentKeysRequest(compartmentId, compartmentIdInSubtree,
            // accessLevel, assessmentId, assessmentType, targetId, targetIds, feature, keyId,
            // keyType, keyManagerType, sortBy, sortOrder, opcRequestId, limit, page);
        }
    }
