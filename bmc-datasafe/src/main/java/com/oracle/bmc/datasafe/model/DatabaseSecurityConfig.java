...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseSecurityConfig.Builder.class)
...
public final class DatabaseSecurityConfig
    ...
    public static class Builder {
        ...
        public DatabaseSecurityConfig build() {
            DatabaseSecurityConfig model =
                    new DatabaseSecurityConfig(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseSecurityConfig model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseSecurityConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseSecurityConfig)) {
            return false;
        }

        DatabaseSecurityConfig other = (DatabaseSecurityConfig) o;
