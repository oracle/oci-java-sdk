...
public class GetDiscoveryJobResultResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code DiscoveryJobResult} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDiscoveryJobResultResponse> {
        ...
        public GetDiscoveryJobResultResponse build() {
            return new GetDiscoveryJobResultResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, discoveryJobResult);
        }
    }
