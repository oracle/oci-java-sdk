...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetDatabaseViewAccessEntryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseViewAccessEntryRequest.
 */
...
public class GetDatabaseViewAccessEntryRequest
    ...
    public static class Builder
        ...
        public GetDatabaseViewAccessEntryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDatabaseViewAccessEntryRequest(securityPolicyReportId, databaseViewAccessEntryKey, opcRequestId);
        }
    }
