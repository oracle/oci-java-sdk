...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ChangeTargetDatabaseCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeTargetDatabaseCompartmentRequest.
 */
...
public class ChangeTargetDatabaseCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeTargetDatabaseCompartmentRequest as configured by this builder
         *
        ...
        public ChangeTargetDatabaseCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeTargetDatabaseCompartmentRequest(targetDatabaseId, changeTargetDatabaseCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
