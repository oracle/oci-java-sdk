...
public class GenerateReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GenerateReportResponse o) {
        ...
        public GenerateReportResponse build() {
            return new GenerateReportResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateReportResponse)) {
            return false;
        }
