...
public class GetAlertResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAlertResponse> {
        ...
        public GetAlertResponse build() {
            return new GetAlertResponse(__httpStatusCode__, headers, etag, opcRequestId, alert);
        }
    }
