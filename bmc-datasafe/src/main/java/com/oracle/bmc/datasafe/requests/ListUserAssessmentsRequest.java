 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUserAssessmentsRequest.
 */
...
public class ListUserAssessmentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only user assessments that were created after the specified date and time,
     * as defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Using
     * timeCreatedGreaterThanOrEqualTo parameter retrieves all assessments created after that date.
     *
    ...
    public static class Builder
        ...
        /**
         * A filter to return user assessments that were created by either the system or by a user
         * only.
         */
        ...
        /**
         * A filter to return only user assessments that were created after the specified date and
         * time, as defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Using
         * timeCreatedGreaterThanOrEqualTo parameter retrieves all assessments created after that
         * date.
         *
         * <p>*Example:** 2016-12-19T16:39:57.600Z
         */
        ...
        /**
         * A filter to return only only target database resources or target database group
         * resources.
         */
        ...
        public ListUserAssessmentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUserAssessmentsRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // displayName, scheduleUserAssessmentId, isScheduleAssessment, isBaseline, targetId,
            // type, triggeredBy, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, limit, page,
            // lifecycleState, sortOrder, sortBy, opcRequestId, targetType, targetDatabaseGroupId);
        }
    }
