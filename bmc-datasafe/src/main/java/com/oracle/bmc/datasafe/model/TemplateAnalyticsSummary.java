...
/**
 * The summary of template analytics data. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TemplateAnalyticsSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class TemplateAnalyticsSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"metricName", "dimensions", "count"})
    public TemplateAnalyticsSummary(
            MetricName metricName, TemplateAnalyticsDimensions dimensions, Long count) {
        super();
    ...
    public static class Builder {
        ...
        private TemplateAnalyticsDimensions dimensions;

        public Builder dimensions(TemplateAnalyticsDimensions dimensions) {
            this.dimensions = dimensions;
        ...
        public TemplateAnalyticsSummary build() {
            TemplateAnalyticsSummary model =
                    new TemplateAnalyticsSummary(this.metricName, this.dimensions, this.count);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TemplateAnalyticsSummary model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dimensions")
    private final TemplateAnalyticsDimensions dimensions;

    public TemplateAnalyticsDimensions getDimensions() {
        return dimensions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TemplateAnalyticsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TemplateAnalyticsSummary)) {
            return false;
        }

        TemplateAnalyticsSummary other = (TemplateAnalyticsSummary) o;
