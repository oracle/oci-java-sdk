...
public final class CreatePeerTargetDatabaseDetails
    ...
    public static class Builder {
        /**
         * The display name of the peer target database in Data Safe. The name is modifiable and
        ...
        /**
         * The OCID of the Data Guard Association resource in which the database being registered is
         * considered as peer database to the primary database.
         */
    ...
    /**
     * The display name of the peer target database in Data Safe. The name is modifiable and does
