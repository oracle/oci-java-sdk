...
/**
 * The details used to create a new audit profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAuditProfileDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAuditProfileDetails
    ...
    public CreateAuditProfileDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the target database or target database group for which the audit profile is
         * created.
         */
         ...
         * override both the global and the target database group level paid usage settings.
        ...
        public CreateAuditProfileDetails build() {
            CreateAuditProfileDetails model =
                    new CreateAuditProfileDetails(
                            this.displayName,
                            this.compartmentId,
                            this.targetId,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAuditProfileDetails model) {
     ...
     * both the global and the target database group level paid usage settings. Enabling paid usage
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAuditProfileDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAuditProfileDetails)) {
            return false;
        }

        CreateAuditProfileDetails other = (CreateAuditProfileDetails) o;
