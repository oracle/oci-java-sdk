...
/**
 * Details to update a sensitive category. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateSensitiveCategoryDetails.Builder.class)
...
public final class UpdateSensitiveCategoryDetails extends UpdateSensitiveTypeDetails {
    ...
    public static class Builder {
        ...
        public UpdateSensitiveCategoryDetails build() {
            UpdateSensitiveCategoryDetails model =
                    new UpdateSensitiveCategoryDetails(
                            this.displayName,
                            this.shortName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSensitiveCategoryDetails model) {
    ...
    @Deprecated
    public UpdateSensitiveCategoryDetails(
            String displayName,
            String shortName,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSensitiveCategoryDetails)) {
            return false;
        }

        UpdateSensitiveCategoryDetails other = (UpdateSensitiveCategoryDetails) o;
