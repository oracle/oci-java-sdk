...
public class ListDiscoveryJobResultsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.datasafe.model.DiscoveryJobResultCollection
            getDiscoveryJobResultCollection() {
        return discoveryJobResultCollection;
    }
    ...
    private ListDiscoveryJobResultsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            String opcPrevPage,
            com.oracle.bmc.datasafe.model.DiscoveryJobResultCollection
                    discoveryJobResultCollection) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder discoveryJobResultCollection(
                com.oracle.bmc.datasafe.model.DiscoveryJobResultCollection
                        discoveryJobResultCollection) {
            this.discoveryJobResultCollection = discoveryJobResultCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(ListDiscoveryJobResultsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            opcPrevPage(o.getOpcPrevPage());
            discoveryJobResultCollection(o.getDiscoveryJobResultCollection());
         ...
         */
        @Override
        public ListDiscoveryJobResultsResponse build() {
            return new ListDiscoveryJobResultsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public String toString() {
        ...
        sb.append(",discoveryJobResultCollection=")
                .append(String.valueOf(discoveryJobResultCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDiscoveryJobResultsResponse)) {
            return false;
        }

        ListDiscoveryJobResultsResponse other = (ListDiscoveryJobResultsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.discoveryJobResultCollection, other.discoveryJobResultCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.discoveryJobResultCollection == null
                                ? 43
                                : this.discoveryJobResultCollection.hashCode());
        return result;
    }
}
