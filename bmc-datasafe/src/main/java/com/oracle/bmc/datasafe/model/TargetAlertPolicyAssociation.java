...
/**
 * The association of the target database to an alert policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TargetAlertPolicyAssociation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class TargetAlertPolicyAssociation
    ...
    public TargetAlertPolicyAssociation(
            String id,
            String displayName,
            String description,
            String policyId,
    ...
    public static class Builder {
        ...
        public TargetAlertPolicyAssociation build() {
            TargetAlertPolicyAssociation model =
                    new TargetAlertPolicyAssociation(
                            this.id,
                            this.displayName,
                            this.description,
                            this.policyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetAlertPolicyAssociation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetAlertPolicyAssociation)) {
            return false;
        }

        TargetAlertPolicyAssociation other = (TargetAlertPolicyAssociation) o;
