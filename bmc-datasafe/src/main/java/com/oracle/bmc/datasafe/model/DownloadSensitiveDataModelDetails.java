...
/**
 * Details to download a sensitive data model. <br>
...
public final class DownloadSensitiveDataModelDetails
    ...
    public static class Builder {
        ...
        public DownloadSensitiveDataModelDetails build() {
            DownloadSensitiveDataModelDetails model =
                    new DownloadSensitiveDataModelDetails(this.dataModelFormat);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DownloadSensitiveDataModelDetails model) {
