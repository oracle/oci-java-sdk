...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ScheduleReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ScheduleReportRequest.
 */
...
public class ScheduleReportRequest
    ...
    public static class Builder
        ...
        public ScheduleReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ScheduleReportRequest(reportDefinitionId, scheduleReportDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
