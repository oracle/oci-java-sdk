...
public class DeleteSensitiveTypeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteSensitiveTypeResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSensitiveTypeResponse)) {
            return false;
        }

        DeleteSensitiveTypeResponse other = (DeleteSensitiveTypeResponse) o;
