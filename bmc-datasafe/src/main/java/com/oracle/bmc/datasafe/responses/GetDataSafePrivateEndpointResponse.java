...
public class GetDataSafePrivateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetDataSafePrivateEndpointResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDataSafePrivateEndpointResponse o) {
         ...
         */
        @Override
        public GetDataSafePrivateEndpointResponse build() {
            return new GetDataSafePrivateEndpointResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, dataSafePrivateEndpoint);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",dataSafePrivateEndpoint=").append(String.valueOf(dataSafePrivateEndpoint));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDataSafePrivateEndpointResponse)) {
            return false;
        }

        GetDataSafePrivateEndpointResponse other = (GetDataSafePrivateEndpointResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.dataSafePrivateEndpoint, other.dataSafePrivateEndpoint);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataSafePrivateEndpoint == null
                                ? 43
                                : this.dataSafePrivateEndpoint.hashCode());
        return result;
    }
}
