...
/**
 * The volume data point for audit data collected by datasafe. <br>
...
public final class CollectedAuditVolumeSummary
    ...
    public static class Builder {
         ...
         * collected by Data Safe is displayed. This field will be the UTC start of the day of the
         * first day of the month for which the aggregate count corresponds to, in the format
    ...
    /**
     * Represents the month under consideration in which the aggregated audit data volume collected
     * by Data Safe is displayed. This field will be the UTC start of the day of the first day of
     * the month for which the aggregate count corresponds to, in the format defined by RFC3339..
