...
/**
 * Summary of a library masking format. <br>
...
public final class LibraryMaskingFormatSummary
    ...
    public LibraryMaskingFormatSummary(
            String id,
    ...
    public static class Builder {
        ...
        public LibraryMaskingFormatSummary build() {
            LibraryMaskingFormatSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LibraryMaskingFormatSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LibraryMaskingFormatSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LibraryMaskingFormatSummary)) {
            return false;
        }

        LibraryMaskingFormatSummary other = (LibraryMaskingFormatSummary) o;
