...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ChangeLibraryMaskingFormatCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeLibraryMaskingFormatCompartmentRequest.
 */
...
public class ChangeLibraryMaskingFormatCompartmentRequest
    ...
    public com.oracle.bmc.datasafe.model.ChangeLibraryMaskingFormatCompartmentDetails getBody$() {
        return changeLibraryMaskingFormatCompartmentDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder changeLibraryMaskingFormatCompartmentDetails(
                com.oracle.bmc.datasafe.model.ChangeLibraryMaskingFormatCompartmentDetails
                        changeLibraryMaskingFormatCompartmentDetails) {
            this.changeLibraryMaskingFormatCompartmentDetails =
                    changeLibraryMaskingFormatCompartmentDetails;
            return this;
        }
        ...
        public Builder copy(ChangeLibraryMaskingFormatCompartmentRequest o) {
            ...
            changeLibraryMaskingFormatCompartmentDetails(
                    o.getChangeLibraryMaskingFormatCompartmentDetails());
         ...
         */
        public ChangeLibraryMaskingFormatCompartmentRequest build() {
            ChangeLibraryMaskingFormatCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.datasafe.model.ChangeLibraryMaskingFormatCompartmentDetails body) {
            changeLibraryMaskingFormatCompartmentDetails(body);
            return this;
        }
         ...
         * @return instance of ChangeLibraryMaskingFormatCompartmentRequest
         */
        public ChangeLibraryMaskingFormatCompartmentRequest buildWithoutInvocationCallback() {
            ChangeLibraryMaskingFormatCompartmentRequest request =
                    new ChangeLibraryMaskingFormatCompartmentRequest();
            request.libraryMaskingFormatId = libraryMaskingFormatId;
            request.changeLibraryMaskingFormatCompartmentDetails =
                    changeLibraryMaskingFormatCompartmentDetails;
    ...
    public String toString() {
        ...
        sb.append(",changeLibraryMaskingFormatCompartmentDetails=")
                .append(String.valueOf(this.changeLibraryMaskingFormatCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeLibraryMaskingFormatCompartmentRequest)) {
            return false;
        }

        ChangeLibraryMaskingFormatCompartmentRequest other =
                (ChangeLibraryMaskingFormatCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.libraryMaskingFormatId, other.libraryMaskingFormatId)
                && java.util.Objects.equals(
                        this.changeLibraryMaskingFormatCompartmentDetails,
                        other.changeLibraryMaskingFormatCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeLibraryMaskingFormatCompartmentDetails == null
                                ? 43
                                : this.changeLibraryMaskingFormatCompartmentDetails.hashCode());
