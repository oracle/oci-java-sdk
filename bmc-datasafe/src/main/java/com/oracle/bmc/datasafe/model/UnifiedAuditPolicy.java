...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UnifiedAuditPolicy.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UnifiedAuditPolicy extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public UnifiedAuditPolicy build() {
            UnifiedAuditPolicy model =
                    new UnifiedAuditPolicy(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAuditPolicy model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAuditPolicy)) {
            return false;
        }

        UnifiedAuditPolicy other = (UnifiedAuditPolicy) o;
