...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UnifiedAuditPolicyConfig.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UnifiedAuditPolicyConfig
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"excludeDatasafeUser"})
    public UnifiedAuditPolicyConfig(ExcludeDatasafeUser excludeDatasafeUser) {
        super();
    ...
    public static class Builder {
        ...
        public UnifiedAuditPolicyConfig build() {
            UnifiedAuditPolicyConfig model = new UnifiedAuditPolicyConfig(this.excludeDatasafeUser);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAuditPolicyConfig model) {
     ...
     * Specifies whether the Data Safe service account on the target database should be excluded in the unified audit policy.
     **/
    public enum ExcludeDatasafeUser {
        Enabled("ENABLED"),
        Disabled("DISABLED"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(ExcludeDatasafeUser.class);
        ...
        public static ExcludeDatasafeUser create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'ExcludeDatasafeUser', returning UnknownEnumValue",
                    key);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAuditPolicyConfig)) {
            return false;
        }

        UnifiedAuditPolicyConfig other = (UnifiedAuditPolicyConfig) o;
