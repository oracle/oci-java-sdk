...
public final class UserAssessment
    ...
    public static class Builder {
         ...
         * is system generated. SAVED: A saved user assessment. LATEST assessments will always be
         * saved to maintain the history of runs. A SAVED assessment is also generated by a
         ...
         * database risks in one compartment. It is automatically updated once the latest assessment
         * or refresh action is executed, as well as when a target is deleted or move to a different
         * compartment.
         */
     ...
     * system generated. SAVED: A saved user assessment. LATEST assessments will always be saved to
     * maintain the history of runs. A SAVED assessment is also generated by a 'refresh' action
     ...
     * compartment. This will keep an up-to-date status of all database risks in one compartment. It
     * is automatically updated once the latest assessment or refresh action is executed, as well as
     * when a target is deleted or move to a different compartment.
     */
