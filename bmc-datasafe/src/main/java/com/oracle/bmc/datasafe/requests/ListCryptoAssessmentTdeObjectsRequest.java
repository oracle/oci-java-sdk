...
public class ListCryptoAssessmentTdeObjectsRequest
    ...
    /**
     * Filters TDE object summary rows by derived encryption status. NOT_SUPPORTED maps to rows
     * where encryptionObserved is NOT_SUPPORTED, UNENCRYPTED maps to rows where encryptionObserved
     * is null or NONE, and ENCRYPTED maps to rows where the observed encryption algorithm is any
     * other value.
     */
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Filters TDE object summary rows by any of the specified observed
        ...
        /**
         * Filters TDE object summary rows by derived encryption status. NOT_SUPPORTED maps to rows
         * where encryptionObserved is NOT_SUPPORTED, UNENCRYPTED maps to rows where
         * encryptionObserved is null or NONE, and ENCRYPTED maps to rows where the observed
         * encryption algorithm is any other value.
         */
        ...
        public ListCryptoAssessmentTdeObjectsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentTdeObjectsRequest(compartmentId, objectType,
            // compartmentIdInSubtree, accessLevel, assessmentId, assessmentType, targetId,
            // targetIds, quantumReadiness, encryptionObserved, encryptionStatus, sortBy, sortOrder,
