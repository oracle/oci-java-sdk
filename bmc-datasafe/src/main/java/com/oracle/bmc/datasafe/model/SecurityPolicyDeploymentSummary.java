...
/**
 * The resource represents the state of the deployment of a security policy on a target. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SecurityPolicyDeploymentSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SecurityPolicyDeploymentSummary
    ...
    public SecurityPolicyDeploymentSummary(
            String id,
    ...
    public static class Builder {
        ...
        /**
         * The last date and time the security policy was deployed, in the format defined by
         * RFC3339.
         */
        ...
        private SecurityPolicyDeploymentLifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(SecurityPolicyDeploymentLifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public SecurityPolicyDeploymentSummary build() {
            SecurityPolicyDeploymentSummary model =
                    new SecurityPolicyDeploymentSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityPolicyDeploymentSummary model) {
    ...
    /** The current state of the security policy deployment. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final SecurityPolicyDeploymentLifecycleState lifecycleState;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SecurityPolicyDeploymentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityPolicyDeploymentSummary)) {
            return false;
        }

        SecurityPolicyDeploymentSummary other = (SecurityPolicyDeploymentSummary) o;
