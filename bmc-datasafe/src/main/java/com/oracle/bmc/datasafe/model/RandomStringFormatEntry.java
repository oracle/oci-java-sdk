 ...
 * The length range is defined by the startLength and endLength attributes. The start length must be
 * less than or equal to the end length. When masking columns with uniqueness constraint, ensure
 * that the length range is sufficient enough to generate unique values. To learn more, check Random
...
public final class RandomStringFormatEntry extends FormatEntry {
    ...
    public static class Builder {
        ...
        /**
         * The minimum number of characters the generated strings should have. It can be any integer
        ...
        /**
         * The maximum number of characters the generated strings should have. It can be any integer
