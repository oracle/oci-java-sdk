...
public class ListAuditTrailsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datasafe.model.AuditTrailCollection getAuditTrailCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListAuditTrailsResponse> {
         ...
         * @return this builder
         */
        public Builder auditTrailCollection(
                com.oracle.bmc.datasafe.model.AuditTrailCollection auditTrailCollection) {
            this.auditTrailCollection = auditTrailCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",auditTrailCollection=").append(String.valueOf(auditTrailCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAuditTrailsResponse)) {
            return false;
        }

        ListAuditTrailsResponse other = (ListAuditTrailsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.auditTrailCollection, other.auditTrailCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.auditTrailCollection == null
                                ? 43
                                : this.auditTrailCollection.hashCode());
        return result;
    }
}
