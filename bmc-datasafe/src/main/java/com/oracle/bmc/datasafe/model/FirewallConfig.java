...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FirewallConfig.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class FirewallConfig extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FirewallConfig model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FirewallConfig)) {
            return false;
        }

        FirewallConfig other = (FirewallConfig) o;
