...
public class ListReportsConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListReportsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListReportsRequest interceptRequest(
            com.oracle.bmc.datasafe.requests.ListReportsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20181201").path("reports");
        ...
        if (request.getDataSource() != null) {
            target =
                    target.queryParam(
                            "dataSource",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getDataSource().getValue()));
        }
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datasafe.responses.ListReportsResponse>() {
                            @Override
                            public com.oracle.bmc.datasafe.responses.ListReportsResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListReportsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.datasafe.model.ReportCollection
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.datasafe.responses.ListReportsResponse.Builder
                                        builder =
