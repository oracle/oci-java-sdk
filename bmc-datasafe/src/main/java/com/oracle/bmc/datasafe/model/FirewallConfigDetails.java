...
/**
 * Details to update the SQL Firewall configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FirewallConfigDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FirewallConfigDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"status", "violationLogAutoPurge", "excludeJob"})
    public FirewallConfigDetails(
    ...
    public static class Builder {
         ...
         * database after collecting the violation logs and persisting them in Data Safe.
         */
        ...
        public FirewallConfigDetails build() {
            FirewallConfigDetails model =
                    new FirewallConfigDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FirewallConfigDetails model) {
     ...
     * after collecting the violation logs and persisting them in Data Safe.
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FirewallConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FirewallConfigDetails)) {
            return false;
        }

        FirewallConfigDetails other = (FirewallConfigDetails) o;
