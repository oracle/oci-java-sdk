...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AllUserCondition.Builder.class)
...
public final class AllUserCondition extends PolicyCondition {
    ...
    public static class Builder {
        ...
        public AllUserCondition build() {
            AllUserCondition model =
                    new AllUserCondition(this.entitySelection, this.operationStatus);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AllUserCondition model) {
    ...
    @Deprecated
    public AllUserCondition(EntitySelection entitySelection, OperationStatus operationStatus) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AllUserCondition)) {
            return false;
        }

        AllUserCondition other = (AllUserCondition) o;
