...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UnsetSecurityAssessmentBaselineExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UnsetSecurityAssessmentBaselineRequest.
 */
...
public class UnsetSecurityAssessmentBaselineRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(UnsetSecurityAssessmentBaselineRequest o) {
        ...
        /**
         * Build the instance of UnsetSecurityAssessmentBaselineRequest as configured by this builder
         *
         ...
         *
         * @return instance of UnsetSecurityAssessmentBaselineRequest
         */
        public UnsetSecurityAssessmentBaselineRequest build() {
            UnsetSecurityAssessmentBaselineRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UnsetSecurityAssessmentBaselineRequest
         */
        public UnsetSecurityAssessmentBaselineRequest buildWithoutInvocationCallback() {
            UnsetSecurityAssessmentBaselineRequest request =
                    new UnsetSecurityAssessmentBaselineRequest();
            ...
            return request;
            // new UnsetSecurityAssessmentBaselineRequest(securityAssessmentId, ifMatch, opcRetryToken, opcRequestId, unsetSecurityAssessmentBaselineDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnsetSecurityAssessmentBaselineRequest)) {
            return false;
        }

        UnsetSecurityAssessmentBaselineRequest other = (UnsetSecurityAssessmentBaselineRequest) o;
