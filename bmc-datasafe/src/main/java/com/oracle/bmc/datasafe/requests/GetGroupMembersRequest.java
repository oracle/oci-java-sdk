...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetGroupMembersExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetGroupMembersRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class GetGroupMembersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetGroupMembersRequest, java.lang.Void> {
        ...
        /**
         * A filter to return the target database only if it is a member of the target database
         * group.
         */
         ...
         * @return this builder instance
         */
        public Builder copy(GetGroupMembersRequest o) {
        ...
        /**
         * Build the instance of GetGroupMembersRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetGroupMembersRequest
         */
        public GetGroupMembersRequest build() {
            GetGroupMembersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetGroupMembersRequest
         */
        public GetGroupMembersRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new GetGroupMembersRequest(targetDatabaseGroupId, opcRequestId, targetDatabaseId,
            // limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGroupMembersRequest)) {
            return false;
        }

        GetGroupMembersRequest other = (GetGroupMembersRequest) o;
