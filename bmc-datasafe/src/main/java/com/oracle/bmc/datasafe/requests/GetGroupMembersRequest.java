...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetGroupMembersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetGroupMembersRequest.
 */
...
public class GetGroupMembersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetGroupMembersRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new GetGroupMembersRequest(targetDatabaseGroupId, opcRequestId, targetDatabaseId, limit, page);
        }
    }
