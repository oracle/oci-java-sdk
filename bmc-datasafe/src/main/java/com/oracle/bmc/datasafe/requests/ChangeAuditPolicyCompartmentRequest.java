...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ChangeAuditPolicyCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAuditPolicyCompartmentRequest.
 */
...
public class ChangeAuditPolicyCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeAuditPolicyCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeAuditPolicyCompartmentRequest(auditPolicyId, changeAuditPolicyCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
