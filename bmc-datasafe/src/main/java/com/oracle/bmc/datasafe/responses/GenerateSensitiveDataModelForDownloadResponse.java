...
public class GenerateSensitiveDataModelForDownloadResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateSensitiveDataModelForDownloadResponse)) {
            return false;
        }

        GenerateSensitiveDataModelForDownloadResponse other =
                (GenerateSensitiveDataModelForDownloadResponse) o;
