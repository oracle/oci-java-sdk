...
public class UpdateColumnSourceSdmDetails extends UpdateColumnSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateColumnSourceSdmDetails build() {
            UpdateColumnSourceSdmDetails __instance__ =
                    new UpdateColumnSourceSdmDetails(sensitiveDataModelId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateColumnSourceSdmDetails o) {
