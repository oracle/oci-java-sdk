 ...
 * condition in a library masking format. <br>
...
public final class CreateLibraryMaskingFormatDetails
    ...
    public static class Builder {
        /**
         * The display name of the library masking format. The name does not have to be unique, and
         * it's changeable.
         */
        ...
        /**
         * An array of OCIDs of the sensitive types compatible with the library masking format. It
         * helps track the sensitive types for which the library masking format is being created.
         */
        ...
        public CreateLibraryMaskingFormatDetails build() {
            CreateLibraryMaskingFormatDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateLibraryMaskingFormatDetails model) {
    ...
    /**
     * The display name of the library masking format. The name does not have to be unique, and it's
     * changeable.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("displayName")
    ...
    /**
     * An array of OCIDs of the sensitive types compatible with the library masking format. It helps
     * track the sensitive types for which the library masking format is being created.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sensitiveTypeIds")
