...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/EnableDataSafeConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use EnableDataSafeConfigurationRequest.
 */
...
public class EnableDataSafeConfigurationRequest
    ...
    public static class Builder
        ...
        public EnableDataSafeConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new EnableDataSafeConfigurationRequest(enableDataSafeConfigurationDetails, compartmentId, ifMatch, opcRequestId);
        }
    }
