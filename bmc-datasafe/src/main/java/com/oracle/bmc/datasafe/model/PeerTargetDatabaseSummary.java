...
public final class PeerTargetDatabaseSummary
    ...
    public PeerTargetDatabaseSummary(
            String displayName,
            String description,
            Integer key,
            String role,
    ...
    public static class Builder {
        ...
        public PeerTargetDatabaseSummary build() {
            PeerTargetDatabaseSummary model =
                    new PeerTargetDatabaseSummary(
                            this.displayName,
                            this.description,
                            this.key,
                            this.role,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PeerTargetDatabaseSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PeerTargetDatabaseSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PeerTargetDatabaseSummary)) {
            return false;
        }

        PeerTargetDatabaseSummary other = (PeerTargetDatabaseSummary) o;
