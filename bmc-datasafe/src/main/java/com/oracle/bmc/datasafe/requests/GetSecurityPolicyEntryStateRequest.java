...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetSecurityPolicyEntryStateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSecurityPolicyEntryStateRequest.
 */
...
public class GetSecurityPolicyEntryStateRequest
    ...
    public static class Builder
        ...
        public GetSecurityPolicyEntryStateRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSecurityPolicyEntryStateRequest(securityPolicyDeploymentId, securityPolicyEntryStateId, opcRequestId);
        }
    }
