...
public class ListOnPremConnectorsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datasafe.model.OnPremConnectorSummary> getItems() {
        return items;
    }
    ...
    private ListOnPremConnectorsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.datasafe.model.OnPremConnectorSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListOnPremConnectorsResponse> {
         ...
         */
        @Override
        public ListOnPremConnectorsResponse build() {
            return new ListOnPremConnectorsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOnPremConnectorsResponse)) {
            return false;
        }

        ListOnPremConnectorsResponse other = (ListOnPremConnectorsResponse) o;
