...
public class DownloadSecurityAssessmentReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadSecurityAssessmentReportResponse)) {
            return false;
        }

        DownloadSecurityAssessmentReportResponse other =
                (DownloadSecurityAssessmentReportResponse) o;
