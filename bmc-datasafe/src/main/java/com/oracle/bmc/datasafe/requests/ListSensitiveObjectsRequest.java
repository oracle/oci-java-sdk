...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListSensitiveObjectsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSensitiveObjectsRequest.
 */
...
public class ListSensitiveObjectsRequest
    ...
    public static class Builder
        ...
        public ListSensitiveObjectsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSensitiveObjectsRequest(sensitiveDataModelId, schemaName, objectName, objectType, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
