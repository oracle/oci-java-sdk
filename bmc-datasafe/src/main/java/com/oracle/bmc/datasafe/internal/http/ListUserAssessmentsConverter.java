...
public class ListUserAssessmentsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListUserAssessmentsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListUserAssessmentsRequest interceptRequest(
            com.oracle.bmc.datasafe.requests.ListUserAssessmentsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getScheduleUserAssessmentId() != null) {
            target =
                    target.queryParam(
                            "scheduleUserAssessmentId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getScheduleUserAssessmentId()));
        }
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datasafe.responses.ListUserAssessmentsResponse>() {
                            @Override
                            public com.oracle.bmc.datasafe.responses.ListUserAssessmentsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListUserAssessmentsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
