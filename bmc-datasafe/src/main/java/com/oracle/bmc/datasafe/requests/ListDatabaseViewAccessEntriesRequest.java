...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListDatabaseViewAccessEntriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatabaseViewAccessEntriesRequest.
 */
...
public class ListDatabaseViewAccessEntriesRequest
    ...
    public static class Builder
        ...
        public ListDatabaseViewAccessEntriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDatabaseViewAccessEntriesRequest(securityPolicyReportId, limit, page, scimQuery, targetId, sortBy, sortOrder, opcRequestId);
        }
    }
