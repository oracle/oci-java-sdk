...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListChecksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListChecksRequest.
 */
...
public class ListChecksRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListChecksRequest buildWithoutInvocationCallback() {
            ...
            request.key = key;
            return request;
            // new ListChecksRequest(securityAssessmentId, opcRequestId, limit, page, sortOrder, sortBy, suggestedSeverity, containsSeverity, containsReferences, compartmentIdInSubtree, accessLevel, key);
        }
    }
