...
/**
 * Collection of security policy summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SecurityPolicyCollection.Builder.class)
...
public final class SecurityPolicyCollection
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<SecurityPolicySummary> items) {
            this.items = items;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityPolicyCollection)) {
            return false;
        }
