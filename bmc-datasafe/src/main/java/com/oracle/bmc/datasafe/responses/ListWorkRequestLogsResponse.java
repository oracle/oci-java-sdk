...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datasafe.model.WorkRequestLogEntry> getItems() {
        return items;
    }
    ...
    private ListWorkRequestLogsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.datasafe.model.WorkRequestLogEntry> items) {
