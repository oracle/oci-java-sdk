...
public class GetSecurityPolicyEntryStateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder securityPolicyEntryState(
                com.oracle.bmc.datasafe.model.SecurityPolicyEntryState securityPolicyEntryState) {
            this.securityPolicyEntryState = securityPolicyEntryState;
            return this;
        }
        ...
        public Builder copy(GetSecurityPolicyEntryStateResponse o) {
            ...
            securityPolicyEntryState(o.getSecurityPolicyEntryState());
    ...
    public String toString() {
        ...
        sb.append(",securityPolicyEntryState=").append(String.valueOf(securityPolicyEntryState));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSecurityPolicyEntryStateResponse)) {
            return false;
        }

        GetSecurityPolicyEntryStateResponse other = (GetSecurityPolicyEntryStateResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.securityPolicyEntryState, other.securityPolicyEntryState);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.securityPolicyEntryState == null
                                ? 43
                                : this.securityPolicyEntryState.hashCode());
        return result;
    }
}
