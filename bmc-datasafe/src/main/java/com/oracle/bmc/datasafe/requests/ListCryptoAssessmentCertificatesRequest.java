...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListCryptoAssessmentCertificatesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCryptoAssessmentCertificatesRequest.
 */
...
public class ListCryptoAssessmentCertificatesRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListCryptoAssessmentCertificatesRequest as configured by this builder
         *
        ...
        public ListCryptoAssessmentCertificatesRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentCertificatesRequest(compartmentId, compartmentIdInSubtree, accessLevel, assessmentId, assessmentType, targetId, targetIds, certificateType, status, publicKeyType, signatureAlgorithm, expiryBucket, daysToExpiry, sortBy, sortOrder, opcRequestId, limit, page);
        }
    }
