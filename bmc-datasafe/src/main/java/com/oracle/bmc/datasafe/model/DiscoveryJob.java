...
/**
 * A data discovery job. It helps track job's metadata as well as result statistics. <br>
...
public final class DiscoveryJob extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * Indicates if all the existing sensitive types are used for data discovery. If it's set to
         * true, the sensitiveTypeIdsForDiscovery attribute is ignored and all sensitive types are
         * used.
         */
    ...
    /**
     * Indicates if all the existing sensitive types are used for data discovery. If it's set to
     * true, the sensitiveTypeIdsForDiscovery attribute is ignored and all sensitive types are used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isIncludeAllSensitiveTypes")
