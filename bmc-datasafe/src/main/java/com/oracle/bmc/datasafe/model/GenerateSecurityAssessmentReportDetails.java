...
public class GenerateSecurityAssessmentReportDetails {
    ...
    public static class Builder {
        ...
        public GenerateSecurityAssessmentReportDetails build() {
            GenerateSecurityAssessmentReportDetails __instance__ =
                    new GenerateSecurityAssessmentReportDetails(format);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateSecurityAssessmentReportDetails o) {
