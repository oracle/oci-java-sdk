...
public class ListFindingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListFindingsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFindingsRequest(securityAssessmentId, opcRequestId, isTopFinding, severity, containsSeverity, category, lifecycleState, references, containsReferences, limit, page, compartmentId, compartmentIdInSubtree, accessLevel, targetId, targetIds, scimQuery, field, sortBy, sortOrder, findingKey);
        }
    }
