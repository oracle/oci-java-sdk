...
public class ListFindingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * A filter to return only findings that match the specified risk level(s). Use containsOracleDefinedSeverity parameter if need to filter by one or multiple risk levels.
     **/
    public enum ContainsOracleDefinedSeverity {
        High("HIGH"),
        Medium("MEDIUM"),
        Low("LOW"),
        Evaluate("EVALUATE"),
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A filter to return only findings that match the specified risk level(s). Use containsOracleDefinedSeverity parameter if need to filter by one or multiple risk levels.
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        /**
         * Singular setter. An optional filter to return only findings that match the specified target ids. Use this parameter to filter by multiple target ids.
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        public ListFindingsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFindingsRequest(securityAssessmentId, opcRequestId, isTopFinding, severity, containsSeverity, category, containsOracleDefinedSeverity, lifecycleState, references, containsReferences, limit, page, compartmentId, compartmentIdInSubtree, accessLevel, targetId, targetIds, scimQuery, field, sortBy, sortOrder, findingKey);
        }
    }
