...
public class ListTargetAlertPolicyAssociationsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTargetAlertPolicyAssociationsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListTargetAlertPolicyAssociationsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.datasafe.requests.ListTargetAlertPolicyAssociationsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20181201").path("targetAlertPolicyAssociations");

        if (request.getTargetAlertPolicyAssociationId() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.datasafe.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListTargetAlertPolicyAssociationsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
