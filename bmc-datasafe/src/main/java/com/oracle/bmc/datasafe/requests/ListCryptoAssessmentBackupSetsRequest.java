...
public class ListCryptoAssessmentBackupSetsRequest
    ...
    public static class Builder
        ...
        public ListCryptoAssessmentBackupSetsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentBackupSetsRequest(compartmentId, compartmentIdInSubtree,
            // accessLevel, assessmentId, assessmentType, targetId, targetIds, backupSetKey,
            // isEncrypted, sortBy, sortOrder, opcRequestId, limit, page);
        }
    }
