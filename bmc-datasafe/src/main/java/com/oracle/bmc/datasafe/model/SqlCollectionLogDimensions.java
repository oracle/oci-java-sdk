...
public final class SqlCollectionLogDimensions
    ...
    public SqlCollectionLogDimensions(
            String clientIp, String clientOsUserName, String clientProgram) {
        super();
    ...
    public static class Builder {
        ...
        public SqlCollectionLogDimensions build() {
            SqlCollectionLogDimensions model =
                    new SqlCollectionLogDimensions(
                            this.clientIp, this.clientOsUserName, this.clientProgram);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SqlCollectionLogDimensions model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SqlCollectionLogDimensions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SqlCollectionLogDimensions)) {
            return false;
        }

        SqlCollectionLogDimensions other = (SqlCollectionLogDimensions) o;
