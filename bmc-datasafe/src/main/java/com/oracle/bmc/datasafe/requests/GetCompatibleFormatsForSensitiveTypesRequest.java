...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetCompatibleFormatsForSensitiveTypesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetCompatibleFormatsForSensitiveTypesRequest.
 */
...
public class GetCompatibleFormatsForSensitiveTypesRequest
    ...
    public static class Builder
        ...
        public GetCompatibleFormatsForSensitiveTypesRequest buildWithoutInvocationCallback() {
            GetCompatibleFormatsForSensitiveTypesRequest request =
                    new GetCompatibleFormatsForSensitiveTypesRequest();
            ...
            return request;
            // new GetCompatibleFormatsForSensitiveTypesRequest(compartmentId, compartmentIdInSubtree, accessLevel, limit, page, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCompatibleFormatsForSensitiveTypesRequest)) {
            return false;
        }

        GetCompatibleFormatsForSensitiveTypesRequest other =
                (GetCompatibleFormatsForSensitiveTypesRequest) o;
