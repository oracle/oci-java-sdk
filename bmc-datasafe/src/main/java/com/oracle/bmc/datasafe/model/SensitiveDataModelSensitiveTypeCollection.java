...
/**
 * A collection of sensitive types summary objects present in a sensitive data model. <br>
...
public final class SensitiveDataModelSensitiveTypeCollection
    ...
    public SensitiveDataModelSensitiveTypeCollection(
            java.util.List<SensitiveDataModelSensitiveTypeSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<SensitiveDataModelSensitiveTypeSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<SensitiveDataModelSensitiveTypeSummary> items) {
            this.items = items;
    ...
    /** An array of sensitive types summary objects present in a sensitive data model. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<SensitiveDataModelSensitiveTypeSummary> items;
     ...
     * @return the value
     */
    public java.util.List<SensitiveDataModelSensitiveTypeSummary> getItems() {
        return items;
    }
