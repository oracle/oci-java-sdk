...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UpdateSensitiveDataModelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSensitiveDataModelRequest.
 */
...
public class UpdateSensitiveDataModelRequest
    ...
    public static class Builder
        ...
        public UpdateSensitiveDataModelRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSensitiveDataModelRequest(sensitiveDataModelId, updateSensitiveDataModelDetails, ifMatch, opcRequestId);
        }
    }
