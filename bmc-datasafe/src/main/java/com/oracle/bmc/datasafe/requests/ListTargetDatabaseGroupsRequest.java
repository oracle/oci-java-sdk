...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListTargetDatabaseGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTargetDatabaseGroupsRequest.
 */
...
public class ListTargetDatabaseGroupsRequest
    ...
    public static class Builder
        ...
        public ListTargetDatabaseGroupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTargetDatabaseGroupsRequest(compartmentId, displayName, filter, sortBy, lifecycleState, compartmentIdInSubtree, accessLevel, sortOrder, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, opcRequestId, limit, page, targetDatabaseGroupId);
        }
    }
