...
public class ListTargetDatabaseGroupsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTargetDatabaseGroupsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListTargetDatabaseGroupsRequest interceptRequest(
            com.oracle.bmc.datasafe.requests.ListTargetDatabaseGroupsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.datasafe.responses.ListTargetDatabaseGroupsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.datasafe.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListTargetDatabaseGroupsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.datasafe.responses.ListTargetDatabaseGroupsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.datasafe.responses
                                                        .ListTargetDatabaseGroupsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.targetDatabaseGroupCollection(response.getItem());
