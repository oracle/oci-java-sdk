...
public class GetOnPremConnectorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOnPremConnectorResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOnPremConnectorResponse)) {
            return false;
        }

        GetOnPremConnectorResponse other = (GetOnPremConnectorResponse) o;
