...
public final class AuditEventAggregationDimensions
    ...
    public AuditEventAggregationDimensions(
            ...
            java.util.List<String> objectOwner,
            java.util.List<String> auditPolicies,
            java.util.List<String> objectName,
            java.util.List<String> osUserName,
            java.util.List<String> errorCode,
            java.util.List<String> clientIp,
            java.util.List<String> externalUserId) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<String> objectOwner;
         ...
         * @return this builder
         */
        public Builder objectOwner(java.util.List<String> objectOwner) {
            this.objectOwner = objectOwner;
        ...
        private java.util.List<String> auditPolicies;
         ...
         * @return this builder
         */
        public Builder auditPolicies(java.util.List<String> auditPolicies) {
            this.auditPolicies = auditPolicies;
        ...
        private java.util.List<String> osUserName;
         ...
         * @return this builder
         */
        public Builder osUserName(java.util.List<String> osUserName) {
            this.osUserName = osUserName;
        ...
        private java.util.List<String> externalUserId;
         ...
         * @return this builder
         */
        public Builder externalUserId(java.util.List<String> externalUserId) {
            this.externalUserId = externalUserId;
    ...
    /** The schema name of the object affected by the action. */
    @com.fasterxml.jackson.annotation.JsonProperty("objectOwner")
    private final java.util.List<String> objectOwner;
     ...
     * @return the value
     */
    public java.util.List<String> getObjectOwner() {
        return objectOwner;
    }

    /** Comma-seperated list of audit policies that caused the current audit event. */
    @com.fasterxml.jackson.annotation.JsonProperty("auditPolicies")
    private final java.util.List<String> auditPolicies;
     ...
     * @return the value
     */
    public java.util.List<String> getAuditPolicies() {
        return auditPolicies;
    }

    /** The name of the object affected by the action. */
    @com.fasterxml.jackson.annotation.JsonProperty("objectName")
    private final java.util.List<String> objectName;
    ...
    /** The name of the operating system user for the database session. */
    @com.fasterxml.jackson.annotation.JsonProperty("osUserName")
    private final java.util.List<String> osUserName;
     ...
     * @return the value
     */
    public java.util.List<String> getOsUserName() {
        return osUserName;
    }

    /** The Oracle error code generated by the action. */
    @com.fasterxml.jackson.annotation.JsonProperty("errorCode")
    private final java.util.List<String> errorCode;
    ...
    /** The user ID of the external user of the audit event. */
    @com.fasterxml.jackson.annotation.JsonProperty("externalUserId")
    private final java.util.List<String> externalUserId;
     ...
     * @return the value
     */
    public java.util.List<String> getExternalUserId() {
