...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListTargetAlertPolicyAssociationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTargetAlertPolicyAssociationsRequest.
 */
...
public class ListTargetAlertPolicyAssociationsRequest
    ...
    public static class Builder
        ...
        public ListTargetAlertPolicyAssociationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTargetAlertPolicyAssociationsRequest(compartmentId, targetAlertPolicyAssociationId, alertPolicyId, targetId, lifecycleState, limit, page, sortOrder, sortBy, targetType, opcRequestId, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, compartmentIdInSubtree, accessLevel);
        }
    }
