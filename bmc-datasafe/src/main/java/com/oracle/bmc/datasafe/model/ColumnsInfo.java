...
/**
 * columnsInfo object has details of column group with schema details. <br>
...
public final class ColumnsInfo extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * Sensitive type ocids of each column groups. Order needs to be maintained with the parent
         * column group. For the DB defined referential relations identified during SDM creation, we
         * cannot add sensitive types. Instead use the sensitiveColumn POST API to mark the columns
         * sensitive.
         */
