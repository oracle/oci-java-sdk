...
public class ListDiscoveryJobsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDiscoveryJobsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListDiscoveryJobsRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // displayName, discoveryJobId, targetId, lifecycleState, sensitiveDataModelId,
            // sortOrder, sortBy, opcRequestId, limit, page);
        }
    }
