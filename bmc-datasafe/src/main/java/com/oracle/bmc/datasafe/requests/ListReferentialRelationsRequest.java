...
public class ListReferentialRelationsRequest
    ...
    public static class Builder
        ...
        public ListReferentialRelationsRequest build() {
            ListReferentialRelationsRequest request = buildWithoutInvocationCallback();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListReferentialRelationsRequest)) {
            return false;
        }

        ListReferentialRelationsRequest other = (ListReferentialRelationsRequest) o;
