...
public final class MaskDataDetails
    ...
    public static class Builder {
         ...
         * recompile manually using UTL_RECOMP package. If it's not provided, the value of the
         * parallelDegree attribute in the MaskingPolicy resource is used.
         */
     ...
     * using UTL_RECOMP package. If it's not provided, the value of the parallelDegree attribute in
     * the MaskingPolicy resource is used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("recompile")
