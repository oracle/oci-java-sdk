...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListCryptoAssessmentWalletsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCryptoAssessmentWalletsRequest.
 */
...
public class ListCryptoAssessmentWalletsRequest
    ...
    public static class Builder
        ...
        public ListCryptoAssessmentWalletsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentWalletsRequest(compartmentId, compartmentIdInSubtree, accessLevel, assessmentId, assessmentType, targetId, targetIds, feature, walletEncryptionAlgorithm, sortBy, sortOrder, opcRequestId, limit, page);
        }
    }
