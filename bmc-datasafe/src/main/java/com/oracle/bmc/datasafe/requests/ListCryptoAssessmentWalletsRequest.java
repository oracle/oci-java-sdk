...
public class ListCryptoAssessmentWalletsRequest
    ...
    private com.oracle.bmc.datasafe.model.CryptoAssessmentWalletSummary.Feature feature;

    /** A filter to return only wallets for the specified feature. */
    public com.oracle.bmc.datasafe.model.CryptoAssessmentWalletSummary.Feature getFeature() {
        return feature;
    }
    /**
     * A filter to return only wallets whose encryption algorithm exactly matches any of the
     * specified values, case-insensitively.
     */
    private java.util.List<String> walletEncryptionAlgorithm;

    /**
     * A filter to return only wallets whose encryption algorithm exactly matches any of the
     * specified values, case-insensitively.
     */
    public java.util.List<String> getWalletEncryptionAlgorithm() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCryptoAssessmentWalletsRequest, java.lang.Void> {
        ...
        /** A filter to return only wallets for the specified feature. */
        private com.oracle.bmc.datasafe.model.CryptoAssessmentWalletSummary.Feature feature = null;
        ...
        public Builder feature(
                com.oracle.bmc.datasafe.model.CryptoAssessmentWalletSummary.Feature feature) {
         ...
         * specified values, case-insensitively.
         */
        private java.util.List<String> walletEncryptionAlgorithm = null;
         ...
         * @return this builder instance
         */
        public Builder walletEncryptionAlgorithm(java.util.List<String> walletEncryptionAlgorithm) {
            this.walletEncryptionAlgorithm = walletEncryptionAlgorithm;
            return this;
        }

        /**
         * Singular setter. A filter to return only wallets whose encryption algorithm exactly
         * matches any of the specified values, case-insensitively.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        public Builder walletEncryptionAlgorithm(String singularValue) {
            return this.walletEncryptionAlgorithm(java.util.Arrays.asList(singularValue));
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ListCryptoAssessmentWalletsRequest o) {
            ...
            walletEncryptionAlgorithm(o.getWalletEncryptionAlgorithm());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListCryptoAssessmentWalletsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCryptoAssessmentWalletsRequest
         */
        public ListCryptoAssessmentWalletsRequest build() {
            ListCryptoAssessmentWalletsRequest request = buildWithoutInvocationCallback();
        ...
        public ListCryptoAssessmentWalletsRequest buildWithoutInvocationCallback() {
            ListCryptoAssessmentWalletsRequest request = new ListCryptoAssessmentWalletsRequest();
            ...
            request.walletEncryptionAlgorithm = walletEncryptionAlgorithm;
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentWalletsRequest(compartmentId, compartmentIdInSubtree,
            // accessLevel, assessmentId, assessmentType, targetId, targetIds, feature,
            // walletEncryptionAlgorithm, sortBy, sortOrder, opcRequestId, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCryptoAssessmentWalletsRequest)) {
            return false;
        }

        ListCryptoAssessmentWalletsRequest other = (ListCryptoAssessmentWalletsRequest) o;
