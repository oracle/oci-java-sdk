...
/**
 * The resource represents sensitive types to be exported in Data Safe. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SensitiveTypesExport.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SensitiveTypesExport
    ...
    public static class Builder {
        ...
        /**
         * Indicates if all the existing user-defined sensitive types are used for export. If it's
         * set to true, the sensitiveTypeIdsForExport attribute is ignored and all user-defined
         * sensitive types are exported.
         */
        ...
        public SensitiveTypesExport build() {
            SensitiveTypesExport model =
                    new SensitiveTypesExport(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SensitiveTypesExport model) {
    ...
    /**
     * Indicates if all the existing user-defined sensitive types are used for export. If it's set
     * to true, the sensitiveTypeIdsForExport attribute is ignored and all user-defined sensitive
     * types are exported.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isIncludeAllSensitiveTypes")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SensitiveTypesExport(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SensitiveTypesExport)) {
            return false;
        }

        SensitiveTypesExport other = (SensitiveTypesExport) o;
