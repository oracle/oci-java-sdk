 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAuditProfilesRequest.
 */
...
public class ListAuditProfilesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A optional filter to return only resources that match the specified retention configured
     * value.
     */
    ...
    /**
     * Indicates if you want to continue audit record collection beyond the free limit of one
     * million audit records per month per target database, incurring additional charges. The
     * default value is inherited from the global settings. You can change at the global level or at
     * the target level.
     */
    ...
    public static class Builder
         ...
         * Indicates if you want to continue audit record collection beyond the free limit of one
         * million audit records per month per target database, incurring additional charges. The
         * default value is inherited from the global settings. You can change at the global level
        ...
        public ListAuditProfilesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAuditProfilesRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // auditProfileId, targetId, targetDatabaseGroupId, targetType, displayName, limit,
            // page, lifecycleState, isOverrideGlobalRetentionSetting, isPaidUsageEnabled,
            // auditCollectedVolumeGreaterThanOrEqualTo, sortOrder, sortBy, opcRequestId);
        }
    }
