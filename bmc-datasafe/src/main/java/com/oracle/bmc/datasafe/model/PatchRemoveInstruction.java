...
public class PatchRemoveInstruction extends PatchInstruction {
    ...
    public static class Builder {
        ...
        public PatchRemoveInstruction build() {
            PatchRemoveInstruction __instance__ = new PatchRemoveInstruction(selection);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchRemoveInstruction o) {
            Builder copiedBuilder = selection(o.getSelection());
