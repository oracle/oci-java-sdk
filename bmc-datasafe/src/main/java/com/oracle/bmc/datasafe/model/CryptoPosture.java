...
/**
 * Cryptographic posture details captured by the assessment. <br>
...
public final class CryptoPosture extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * Common FIPS mode configured for the assessment when the target uses common FIPS
         * configuration.
         */
     ...
     * configuration.
     */
    public enum FipsModeConfigured implements com.oracle.bmc.http.internal.BmcEnum {
        Fips1402("FIPS_140_2"),
        Fips1403("FIPS_140_3"),
