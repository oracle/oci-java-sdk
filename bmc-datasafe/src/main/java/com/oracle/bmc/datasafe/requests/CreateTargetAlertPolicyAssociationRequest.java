...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/CreateTargetAlertPolicyAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateTargetAlertPolicyAssociationRequest.
 */
...
public class CreateTargetAlertPolicyAssociationRequest
    ...
    public static class Builder
        ...
        /**
         * The details used to create a new target-alert policy association.
         * @param createTargetAlertPolicyAssociationDetails the value to set
