 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAuditTrailRequest.
 */
...
public class UpdateAuditTrailRequest
    ...
    public static class Builder
        ...
        public UpdateAuditTrailRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAuditTrailRequest(auditTrailId, updateAuditTrailDetails, ifMatch,
            // opcRequestId);
        }
    }
