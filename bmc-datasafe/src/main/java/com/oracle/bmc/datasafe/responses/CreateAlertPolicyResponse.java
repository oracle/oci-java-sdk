...
public class CreateAlertPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAlertPolicyResponse> {
         ...
         */
        @Override
        public Builder copy(CreateAlertPolicyResponse o) {
         ...
         */
        @Override
        public CreateAlertPolicyResponse build() {
            return new CreateAlertPolicyResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAlertPolicyResponse)) {
            return false;
        }

        CreateAlertPolicyResponse other = (CreateAlertPolicyResponse) o;
