...
/**
 * Details to update a library masking format. Note that updating the formatEntries attribute
 * replaces all the existing masking format entries with the specified format entries. <br>
