...
public class CreatePeerTargetDatabaseRequest
    ...
    public static class Builder
        ...
        /**
         * Database details used to create the peer target database under the primary target
         * database.
         */
        private com.oracle.bmc.datasafe.model.CreatePeerTargetDatabaseDetails
        ...
        public CreatePeerTargetDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreatePeerTargetDatabaseRequest(targetDatabaseId,
            // createPeerTargetDatabaseDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
