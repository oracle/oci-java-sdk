...
public class ListFindingAnalyticsRequest
    ...
    public static class Builder
        ...
        public ListFindingAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFindingAnalyticsRequest(compartmentId, compartmentIdInSubtree, accessLevel, isTopFinding, groupBy, topFindingStatus, severity, findingKey, opcRequestId, limit, page, targetDatabaseGroupId, containsReferences, targetIds, category, containsSeverity, scimQuery);
        }
    }
