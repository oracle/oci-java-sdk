...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListSensitiveTypesExportsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSensitiveTypesExportsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class ListSensitiveTypesExportsRequest
     ...
     */
    private com.oracle.bmc.datasafe.model.SensitiveTypesExportLifecycleState lifecycleState;

    /**
     * A filter to return only the resources that match the specified lifecycle state.
     */
    public com.oracle.bmc.datasafe.model.SensitiveTypesExportLifecycleState getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSensitiveTypesExportsRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.datasafe.model.SensitiveTypesExportLifecycleState lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSensitiveTypesExportsRequest o) {
        ...
        /**
         * Build the instance of ListSensitiveTypesExportsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSensitiveTypesExportsRequest
         */
        public ListSensitiveTypesExportsRequest build() {
            ListSensitiveTypesExportsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListSensitiveTypesExportsRequest
         */
        public ListSensitiveTypesExportsRequest buildWithoutInvocationCallback() {
            ListSensitiveTypesExportsRequest request = new ListSensitiveTypesExportsRequest();
            ...
            return request;
            // new ListSensitiveTypesExportsRequest(compartmentId, compartmentIdInSubtree, accessLevel, displayName, limit, page, lifecycleState, sensitiveTypesExportId, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSensitiveTypesExportsRequest)) {
            return false;
        }

        ListSensitiveTypesExportsRequest other = (ListSensitiveTypesExportsRequest) o;
