...
public class ListSensitiveTypesExportsRequest
    ...
    public static class Builder
         ...
         * sensitive types export resource.
         */
        ...
        public ListSensitiveTypesExportsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSensitiveTypesExportsRequest(compartmentId, compartmentIdInSubtree,
            // accessLevel, displayName, limit, page, lifecycleState, sensitiveTypesExportId,
            // timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, sortOrder, sortBy,
            // opcRequestId);
        }
    }
