...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetDatabaseTableAccessEntryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseTableAccessEntryRequest.
 */
...
public class GetDatabaseTableAccessEntryRequest
    ...
    public static class Builder
        ...
        public GetDatabaseTableAccessEntryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDatabaseTableAccessEntryRequest(securityPolicyReportId, databaseTableAccessEntryKey, opcRequestId);
        }
    }
