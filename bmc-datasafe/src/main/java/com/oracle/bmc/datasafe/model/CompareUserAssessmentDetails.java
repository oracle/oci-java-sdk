...
public final class CompareUserAssessmentDetails {
    ...
    public static class Builder {
        ...
        public CompareUserAssessmentDetails build() {
            CompareUserAssessmentDetails __instance__ =
                    new CompareUserAssessmentDetails(comparisonUserAssessmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompareUserAssessmentDetails o) {
            Builder copiedBuilder = comparisonUserAssessmentId(o.getComparisonUserAssessmentId());
