...
public class ListCryptoAssessmentsRequest
    ...
    /**
     * A filter to return only crypto assessments associated with the specified target OCID. When
     * provided, targetType must also be specified.
     */
    ...
    /**
     * A filter to return crypto assessments belonging to the specified target type. {@code
     * ListCryptoAssessments} returns assessment rows; use {@code targetDatabaseGroupId} to list the
     * underlying target database assessments for a group.
     */
    ...
    /**
     * A filter to return only crypto assessments that match any of the specified posture
     * categories.
     */
    ...
    /**
     * A filter to return only crypto assessments whose scheduled execution state matches the
     * specified value.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only crypto assessments associated with the specified target OCID.
         * When provided, targetType must also be specified.
         */
        ...
        /**
         * A filter to return crypto assessments belonging to the specified target type. {@code
         * ListCryptoAssessments} returns assessment rows; use {@code targetDatabaseGroupId} to list
         * the underlying target database assessments for a group.
         */
        ...
        /**
         * Singular setter. A filter to return only crypto assessments that match any of the
         * specified posture categories.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        /**
         * The field used to sort crypto assessments. You can specify only one sort order
         * (sortOrder).
         */
        ...
        public ListCryptoAssessmentsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentsRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // displayName, type, assessmentId, targetId, targetIds, targetDatabaseGroupId,
            // targetType, postureCategory, isAssessmentScheduled, lifecycleState, sortBy,
