...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ApplySdmMaskingPolicyDifferenceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ApplySdmMaskingPolicyDifferenceRequest.
 */
...
public class ApplySdmMaskingPolicyDifferenceRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ApplySdmMaskingPolicyDifferenceRequest as configured by this builder
         *
        ...
        public ApplySdmMaskingPolicyDifferenceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ApplySdmMaskingPolicyDifferenceRequest(maskingPolicyId, applySdmMaskingPolicyDifferenceDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
