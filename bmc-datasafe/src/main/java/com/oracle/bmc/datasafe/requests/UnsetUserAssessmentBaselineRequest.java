...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UnsetUserAssessmentBaselineExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UnsetUserAssessmentBaselineRequest.
 */
...
public class UnsetUserAssessmentBaselineRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(UnsetUserAssessmentBaselineRequest o) {
         ...
         *
         * @return instance of UnsetUserAssessmentBaselineRequest
         */
        public UnsetUserAssessmentBaselineRequest build() {
            UnsetUserAssessmentBaselineRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UnsetUserAssessmentBaselineRequest
         */
        public UnsetUserAssessmentBaselineRequest buildWithoutInvocationCallback() {
            UnsetUserAssessmentBaselineRequest request = new UnsetUserAssessmentBaselineRequest();
            ...
            return request;
            // new UnsetUserAssessmentBaselineRequest(userAssessmentId, ifMatch, opcRetryToken, opcRequestId, unsetUserAssessmentBaselineDetails);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnsetUserAssessmentBaselineRequest)) {
            return false;
        }

        UnsetUserAssessmentBaselineRequest other = (UnsetUserAssessmentBaselineRequest) o;
