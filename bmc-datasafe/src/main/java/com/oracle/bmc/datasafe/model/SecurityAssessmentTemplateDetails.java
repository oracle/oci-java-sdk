...
/**
 * The details required to set the template for the assessment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SecurityAssessmentTemplateDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SecurityAssessmentTemplateDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"templateAssessmentId"})
    public SecurityAssessmentTemplateDetails(String templateAssessmentId) {
        super();
    ...
    public static class Builder {
        ...
        public SecurityAssessmentTemplateDetails build() {
            SecurityAssessmentTemplateDetails model =
                    new SecurityAssessmentTemplateDetails(this.templateAssessmentId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityAssessmentTemplateDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityAssessmentTemplateDetails)) {
            return false;
        }

        SecurityAssessmentTemplateDetails other = (SecurityAssessmentTemplateDetails) o;
