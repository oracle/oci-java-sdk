...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/DeleteMaskingColumnExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMaskingColumnRequest.
 */
...
public class DeleteMaskingColumnRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteMaskingColumnRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteMaskingColumnRequest(maskingColumnKey, maskingPolicyId, ifMatch, opcRequestId);
        }
    }
