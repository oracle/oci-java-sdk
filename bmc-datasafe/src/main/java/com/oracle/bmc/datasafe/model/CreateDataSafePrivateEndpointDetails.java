...
/**
 * The details used to create the new Data Safe private endpoint. <br>
...
public final class CreateDataSafePrivateEndpointDetails
    ...
    public static class Builder {
        /**
         * The display name for the private endpoint. The name does not have to be unique, and it's
         * changeable.
         */
        ...
        public CreateDataSafePrivateEndpointDetails build() {
            CreateDataSafePrivateEndpointDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataSafePrivateEndpointDetails model) {
