...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListMaskingReportsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMaskingReportsRequest.
 */
...
public class ListMaskingReportsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMaskingReportsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMaskingReportsRequest(compartmentId, limit, page, maskingPolicyId, targetId, targetDatabaseGroupId, sortOrder, sortBy, opcRequestId, compartmentIdInSubtree, accessLevel);
        }
    }
