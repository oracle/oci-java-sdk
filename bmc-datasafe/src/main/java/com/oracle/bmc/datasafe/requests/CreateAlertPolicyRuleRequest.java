...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/CreateAlertPolicyRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAlertPolicyRuleRequest.
 */
...
public class CreateAlertPolicyRuleRequest
    ...
    public com.oracle.bmc.datasafe.model.CreateAlertPolicyRuleDetails getBody$() {
        return createAlertPolicyRuleDetails;
    }
    ...
    public static class Builder
         ...
         */
        public Builder createAlertPolicyRuleDetails(
                com.oracle.bmc.datasafe.model.CreateAlertPolicyRuleDetails
                        createAlertPolicyRuleDetails) {
            this.createAlertPolicyRuleDetails = createAlertPolicyRuleDetails;
            return this;
        }
        ...
        public Builder copy(CreateAlertPolicyRuleRequest o) {
            createAlertPolicyRuleDetails(o.getCreateAlertPolicyRuleDetails());
         ...
         */
        public CreateAlertPolicyRuleRequest build() {
            CreateAlertPolicyRuleRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.datasafe.model.CreateAlertPolicyRuleDetails body) {
         ...
         * @return instance of CreateAlertPolicyRuleRequest
         */
        public CreateAlertPolicyRuleRequest buildWithoutInvocationCallback() {
            CreateAlertPolicyRuleRequest request = new CreateAlertPolicyRuleRequest();
            request.createAlertPolicyRuleDetails = createAlertPolicyRuleDetails;
    ...
    public String toString() {
        ...
        sb.append(",createAlertPolicyRuleDetails=")
                .append(String.valueOf(this.createAlertPolicyRuleDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAlertPolicyRuleRequest)) {
            return false;
        }

        CreateAlertPolicyRuleRequest other = (CreateAlertPolicyRuleRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createAlertPolicyRuleDetails, other.createAlertPolicyRuleDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createAlertPolicyRuleDetails == null
                                ? 43
                                : this.createAlertPolicyRuleDetails.hashCode());
        result =
                (result * PRIME)
