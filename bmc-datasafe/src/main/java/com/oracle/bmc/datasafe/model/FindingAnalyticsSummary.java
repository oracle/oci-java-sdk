 ...
 * details such as metric name, findingKey, title (topFindingCategory for top finding), severity
...
public final class FindingAnalyticsSummary
    ...
    public FindingAnalyticsSummary(
            MetricName metricName, FindingAnalyticsDimensions dimensions, Long count) {
        super();
    ...
    public static class Builder {
        ...
        private FindingAnalyticsDimensions dimensions;

        public Builder dimensions(FindingAnalyticsDimensions dimensions) {
            this.dimensions = dimensions;
        ...
        public FindingAnalyticsSummary build() {
            FindingAnalyticsSummary model =
                    new FindingAnalyticsSummary(this.metricName, this.dimensions, this.count);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FindingAnalyticsSummary model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dimensions")
    private final FindingAnalyticsDimensions dimensions;

    public FindingAnalyticsDimensions getDimensions() {
        return dimensions;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FindingAnalyticsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FindingAnalyticsSummary)) {
            return false;
        }

        FindingAnalyticsSummary other = (FindingAnalyticsSummary) o;
