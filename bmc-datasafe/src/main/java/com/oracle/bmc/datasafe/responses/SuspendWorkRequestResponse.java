...
public class SuspendWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SuspendWorkRequestResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SuspendWorkRequestResponse)) {
            return false;
        }

        SuspendWorkRequestResponse other = (SuspendWorkRequestResponse) o;
