...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SqlCollectionSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SqlCollectionSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SqlCollectionSummary build() {
            SqlCollectionSummary model =
                    new SqlCollectionSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SqlCollectionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SqlCollectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SqlCollectionSummary)) {
            return false;
        }

        SqlCollectionSummary other = (SqlCollectionSummary) o;
