...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/RefreshSecurityAssessmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshSecurityAssessmentRequest.
 */
...
public class RefreshSecurityAssessmentRequest
     ...
     * Details to create an on-demand saved security assessment.
     */
    public com.oracle.bmc.datasafe.model.RunSecurityAssessmentDetails
            getRunSecurityAssessmentDetails() {
    ...
    public static class Builder
         ...
         * Details to create an on-demand saved security assessment.
         */
        private com.oracle.bmc.datasafe.model.RunSecurityAssessmentDetails
                runSecurityAssessmentDetails = null;

        /**
         * Details to create an on-demand saved security assessment.
         * @param runSecurityAssessmentDetails the value to set
         * @return this builder instance
         */
        public Builder runSecurityAssessmentDetails(
                com.oracle.bmc.datasafe.model.RunSecurityAssessmentDetails
        ...
        public RefreshSecurityAssessmentRequest buildWithoutInvocationCallback() {
            ...
            request.runSecurityAssessmentDetails = runSecurityAssessmentDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RefreshSecurityAssessmentRequest(securityAssessmentId, runSecurityAssessmentDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",runSecurityAssessmentDetails=")
                .append(String.valueOf(this.runSecurityAssessmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        RefreshSecurityAssessmentRequest other = (RefreshSecurityAssessmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.securityAssessmentId, other.securityAssessmentId)
                && java.util.Objects.equals(
                        this.runSecurityAssessmentDetails, other.runSecurityAssessmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.runSecurityAssessmentDetails == null
                                ? 43
                                : this.runSecurityAssessmentDetails.hashCode());
        result =
                (result * PRIME)
