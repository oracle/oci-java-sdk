...
public class ListReportsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListReportsRequest buildWithoutInvocationCallback() {
            ...
            request.type = type;
            return request;
            // new ListReportsRequest(compartmentId, compartmentIdInSubtree, accessLevel, displayName, limit, page, sortOrder, sortBy, reportDefinitionId, timeGeneratedGreaterThanOrEqualTo, timeGeneratedLessThan, opcRequestId, lifecycleState, type);
        }
    }
