...
public final class AuditPolicySummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuditPolicySummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuditPolicySummary)) {
            return false;
        }

        AuditPolicySummary other = (AuditPolicySummary) o;
