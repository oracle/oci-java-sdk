...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/BulkCreateUnifiedAuditPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BulkCreateUnifiedAuditPolicyRequest.
 */
...
public class BulkCreateUnifiedAuditPolicyRequest
    ...
    public static class Builder
        ...
        public BulkCreateUnifiedAuditPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new BulkCreateUnifiedAuditPolicyRequest(bulkCreateUnifiedAuditPolicyDetails, opcRequestId, opcRetryToken);
        }
    }
