...
public class GetTargetAlertPolicyAssociationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public GetTargetAlertPolicyAssociationResponse build() {
            return new GetTargetAlertPolicyAssociationResponse(
                    __httpStatusCode__, etag, opcRequestId, targetAlertPolicyAssociation);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTargetAlertPolicyAssociationResponse)) {
            return false;
        }

        GetTargetAlertPolicyAssociationResponse other = (GetTargetAlertPolicyAssociationResponse) o;
