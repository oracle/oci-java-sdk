...
public final class GenerateOnPremConnectorConfigurationDetails
    ...
    public static class Builder {
        ...
        public GenerateOnPremConnectorConfigurationDetails build() {
            GenerateOnPremConnectorConfigurationDetails model =
                    new GenerateOnPremConnectorConfigurationDetails(this.password);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateOnPremConnectorConfigurationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateOnPremConnectorConfigurationDetails)) {
            return false;
        }

        GenerateOnPremConnectorConfigurationDetails other =
                (GenerateOnPremConnectorConfigurationDetails) o;
