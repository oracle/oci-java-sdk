...
public class UpdateReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateReportResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateReportResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReportResponse)) {
            return false;
        }
