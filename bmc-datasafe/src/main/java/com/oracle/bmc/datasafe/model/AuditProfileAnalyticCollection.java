...
/**
 * Details of audit profile analytic summary. <br>
...
public final class AuditProfileAnalyticCollection
    ...
    public static class Builder {
        ...
        public AuditProfileAnalyticCollection build() {
            AuditProfileAnalyticCollection model = new AuditProfileAnalyticCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuditProfileAnalyticCollection model) {
