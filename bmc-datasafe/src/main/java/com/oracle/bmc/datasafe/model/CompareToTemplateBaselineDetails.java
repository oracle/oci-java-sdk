...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CompareToTemplateBaselineDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CompareToTemplateBaselineDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"comparisonSecurityAssessmentId"})
    public CompareToTemplateBaselineDetails(String comparisonSecurityAssessmentId) {
        super();
    ...
    public static class Builder {
        /**
         * The OCID of the security assessment. In this case a security assessment needs to be a template baseline assessment.
         *
         **/
        ...
        public CompareToTemplateBaselineDetails build() {
            CompareToTemplateBaselineDetails model =
                    new CompareToTemplateBaselineDetails(this.comparisonSecurityAssessmentId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompareToTemplateBaselineDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompareToTemplateBaselineDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompareToTemplateBaselineDetails)) {
            return false;
        }

        CompareToTemplateBaselineDetails other = (CompareToTemplateBaselineDetails) o;
