...
public final class UserAssessmentSummary
    ...
    public static class Builder {
         ...
         * targets in one compartment. This will keep an up-to-date status of all potential risks
         * identified in the compartment. It is automatically updated once the latest assessment or
