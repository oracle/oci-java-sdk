...
public final class UserAssessmentSummary
    ...
    public static class Builder {
        ...
        /**
         * The last date and time the user assessment was updated, in the format defined by
         * [RFC3339](https://tools.ietf.org/html/rfc3339).
         */
         ...
         * of all potential risks identified in the compartment. It is automatically updated once
         * the latest assessment or refresh action is executed, as well as when a target is deleted
         * or moved to a different compartment.
         */
