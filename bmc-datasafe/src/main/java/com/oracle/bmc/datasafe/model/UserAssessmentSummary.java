...
/**
 * The summary of the user assessment. <br>
...
public final class UserAssessmentSummary
    ...
    public static class Builder {
        ...
        /**
         * Indicates if the assessment is a baseline assessment. This applies to saved user
         * assessments only.
         */
        ...
        /**
         * The date and time when the user assessment was created, in the format defined by
        ...
        /**
         * The last date and time when the user assessment was updated, in the format defined by
         * [RFC3339](https://tools.ietf.org/html/rfc3339).
         */
         ...
         * is system generated. SAVED: A saved user assessment. LATEST assessments are always saved
         * to maintain the history of runs. A SAVED assessment is also generated by a 'refresh'
         * action (triggered by the user). SAVE_SCHEDULE: The schedule for periodic save of LATEST
         * assessments. COMPARTMENT: An automatic managed assessment type that stores all details of
         * targets in one compartment. This type keeps an up-to-date status of all database risks in
         * one compartment. It is automatically updated when the latest assessment or refresh action
         * is executed. It is also automatically updated when a target is deleted or move to a
    ...
    /**
     * Indicates if the assessment is a baseline assessment. This applies to saved user assessments
     * only.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isBaseline")
     ...
     * system generated. SAVED: A saved user assessment. LATEST assessments are always saved to
     * maintain the history of runs. A SAVED assessment is also generated by a 'refresh' action
     * (triggered by the user). SAVE_SCHEDULE: The schedule for periodic save of LATEST assessments.
     * COMPARTMENT: An automatic managed assessment type that stores all details of targets in one
     * compartment. This type keeps an up-to-date status of all database risks in one compartment.
     * It is automatically updated when the latest assessment or refresh action is executed. It is
     * also automatically updated when a target is deleted or move to a different compartment.
     */
