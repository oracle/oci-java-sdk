...
public final class AuditSpecification
    ...
    public static class Builder {
         ...
         * target database. The status is PARTIALLY_ENABLED if any of the constituent database audit
         * policies is not enabled.
         */
     ...
     * database. The status is PARTIALLY_ENABLED if any of the constituent database audit policies
     * is not enabled.
     */
    public enum EnableStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Enabled("ENABLED"),
        Disabled("DISABLED"),
    ...
    /** Indicates on whom the audit policy is enabled. */
    public enum EnabledEntities implements com.oracle.bmc.http.internal.BmcEnum {
        AllUsers("ALL_USERS"),
