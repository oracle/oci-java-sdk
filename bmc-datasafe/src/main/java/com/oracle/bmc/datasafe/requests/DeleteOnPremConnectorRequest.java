...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/DeleteOnPremConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOnPremConnectorRequest.
 */
...
public class DeleteOnPremConnectorRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteOnPremConnectorRequest
         */
        public DeleteOnPremConnectorRequest buildWithoutInvocationCallback() {
            DeleteOnPremConnectorRequest request = new DeleteOnPremConnectorRequest();
            request.onPremConnectorId = onPremConnectorId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOnPremConnectorRequest(onPremConnectorId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOnPremConnectorRequest)) {
            return false;
        }

        DeleteOnPremConnectorRequest other = (DeleteOnPremConnectorRequest) o;
