...
public class ListDatabaseSecurityConfigsRequest
    ...
    private com.oracle.bmc.datasafe.model.DatabaseSecurityConfigLifecycleState lifecycleState;

    /** The current state of the database security configuration. */
    public com.oracle.bmc.datasafe.model.DatabaseSecurityConfigLifecycleState getLifecycleState() {
        return lifecycleState;
    }
    /**
     * An optional filter to return only resources that match the specified OCID of the database
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDatabaseSecurityConfigsRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.datasafe.model.DatabaseSecurityConfigLifecycleState lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDatabaseSecurityConfigsRequest o) {
        ...
        /**
         * Build the instance of ListDatabaseSecurityConfigsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDatabaseSecurityConfigsRequest
         */
        public ListDatabaseSecurityConfigsRequest build() {
            ListDatabaseSecurityConfigsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDatabaseSecurityConfigsRequest
         */
        public ListDatabaseSecurityConfigsRequest buildWithoutInvocationCallback() {
            ListDatabaseSecurityConfigsRequest request = new ListDatabaseSecurityConfigsRequest();
            ...
            return request;
            // new ListDatabaseSecurityConfigsRequest(compartmentId, compartmentIdInSubtree,
            // accessLevel, displayName, limit, page, lifecycleState, databaseSecurityConfigId,
            // timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, targetId,
            // targetDatabaseGroupId, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseSecurityConfigsRequest)) {
            return false;
        }

        ListDatabaseSecurityConfigsRequest other = (ListDatabaseSecurityConfigsRequest) o;
