...
public final class WorkRequestSummary
    ...
    public enum OperationType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        UpdateTargetDatabasePrivilege("UPDATE_TARGET_DATABASE_PRIVILEGE"),
        ...
        UpdateCryptoAssessment("UPDATE_CRYPTO_ASSESSMENT"),
        CreateCryptoAssessment("CREATE_CRYPTO_ASSESSMENT"),
        RefreshCryptoAssessment("REFRESH_CRYPTO_ASSESSMENT"),
        GenerateCryptoAssessmentReport("GENERATE_CRYPTO_ASSESSMENT_REPORT"),
        DownloadCryptoAssessmentReport("DOWNLOAD_CRYPTO_ASSESSMENT_REPORT"),
        ChangeCryptoAssessmentCompartment("CHANGE_CRYPTO_ASSESSMENT_COMPARTMENT"),
        DeleteCryptoAssessment("DELETE_CRYPTO_ASSESSMENT"),
