...
public class ListSqlCollectionAnalyticsRequest
    ...
    public static class Builder
        ...
        public ListSqlCollectionAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSqlCollectionAnalyticsRequest(compartmentId, compartmentIdInSubtree, accessLevel, limit, page, lifecycleState, targetId, targetDatabaseGroupId, opcRequestId, groupBy, timeStarted, timeEnded);
        }
    }
