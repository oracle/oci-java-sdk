...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GenerateSecurityAssessmentReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GenerateSecurityAssessmentReportRequest.
 */
...
public class GenerateSecurityAssessmentReportRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of GenerateSecurityAssessmentReportRequest as configured by this builder
         *
        ...
        public GenerateSecurityAssessmentReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GenerateSecurityAssessmentReportRequest(securityAssessmentId, generateSecurityAssessmentReportDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
