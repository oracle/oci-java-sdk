...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListMaskingAnalyticsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMaskingAnalyticsRequest.
 */
...
public class ListMaskingAnalyticsRequest
    ...
    public static class Builder
        ...
        public ListMaskingAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMaskingAnalyticsRequest(compartmentId, compartmentIdInSubtree, groupBy, targetId, maskingPolicyId, sensitiveTypeId, targetDatabaseGroupId, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
