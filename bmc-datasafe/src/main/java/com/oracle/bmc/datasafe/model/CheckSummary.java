...
/**
 * The summary of the security rule to be evaluated by security assessment to create finding. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CheckSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CheckSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CheckSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckSummary)) {
            return false;
        }

        CheckSummary other = (CheckSummary) o;
