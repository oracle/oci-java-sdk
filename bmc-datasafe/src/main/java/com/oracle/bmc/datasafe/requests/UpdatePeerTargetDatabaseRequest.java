...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UpdatePeerTargetDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePeerTargetDatabaseRequest.
 */
...
public class UpdatePeerTargetDatabaseRequest
    ...
    public static class Builder
        ...
        public UpdatePeerTargetDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePeerTargetDatabaseRequest(targetDatabaseId, peerTargetDatabaseId, updatePeerTargetDatabaseDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
