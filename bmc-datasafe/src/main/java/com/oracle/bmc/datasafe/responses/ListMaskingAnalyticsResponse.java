...
public class ListMaskingAnalyticsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.datasafe.model.MaskingAnalyticsCollection
            getMaskingAnalyticsCollection() {
        return maskingAnalyticsCollection;
    }
    ...
    private ListMaskingAnalyticsResponse(
        ...
        this.maskingAnalyticsCollection = maskingAnalyticsCollection;
    }

    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListMaskingAnalyticsResponse> {
         ...
         * @return this builder
         */
        public Builder maskingAnalyticsCollection(
                com.oracle.bmc.datasafe.model.MaskingAnalyticsCollection
                        maskingAnalyticsCollection) {
            this.maskingAnalyticsCollection = maskingAnalyticsCollection;
            return this;
        }
        ...
        public Builder copy(ListMaskingAnalyticsResponse o) {
            ...
            maskingAnalyticsCollection(o.getMaskingAnalyticsCollection());
    ...
    public String toString() {
        ...
        sb.append(",maskingAnalyticsCollection=")
                .append(String.valueOf(maskingAnalyticsCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMaskingAnalyticsResponse)) {
            return false;
        }

        ListMaskingAnalyticsResponse other = (ListMaskingAnalyticsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.maskingAnalyticsCollection, other.maskingAnalyticsCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.maskingAnalyticsCollection == null
                                ? 43
                                : this.maskingAnalyticsCollection.hashCode());
        return result;
    }
}
