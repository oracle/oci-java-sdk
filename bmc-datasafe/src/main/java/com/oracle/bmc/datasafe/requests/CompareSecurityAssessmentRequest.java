...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/CompareSecurityAssessmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CompareSecurityAssessmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class CompareSecurityAssessmentRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.datasafe.model.CompareSecurityAssessmentDetails> {
    ...
    public com.oracle.bmc.datasafe.model.CompareSecurityAssessmentDetails getBody$() {
        return compareSecurityAssessmentDetails;
    }
    ...
    public static class Builder
        ...
        public Builder copy(CompareSecurityAssessmentRequest o) {
            ...
            compareSecurityAssessmentDetails(o.getCompareSecurityAssessmentDetails());
        ...
        /**
         * Build the instance of CompareSecurityAssessmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of CompareSecurityAssessmentRequest
         */
        public CompareSecurityAssessmentRequest build() {
            CompareSecurityAssessmentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.datasafe.model.CompareSecurityAssessmentDetails body) {
            compareSecurityAssessmentDetails(body);
            return this;
        }
        ...
        public CompareSecurityAssessmentRequest buildWithoutInvocationCallback() {
            ...
            request.compareSecurityAssessmentDetails = compareSecurityAssessmentDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new CompareSecurityAssessmentRequest(securityAssessmentId, compareSecurityAssessmentDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",compareSecurityAssessmentDetails=")
                .append(String.valueOf(this.compareSecurityAssessmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        CompareSecurityAssessmentRequest other = (CompareSecurityAssessmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.securityAssessmentId, other.securityAssessmentId)
                && java.util.Objects.equals(
                        this.compareSecurityAssessmentDetails,
                        other.compareSecurityAssessmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.compareSecurityAssessmentDetails == null
                                ? 43
                                : this.compareSecurityAssessmentDetails.hashCode());
        result =
                (result * PRIME)
