...
public class DeleteLibraryMaskingFormatResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLibraryMaskingFormatResponse)) {
            return false;
        }

        DeleteLibraryMaskingFormatResponse other = (DeleteLibraryMaskingFormatResponse) o;
