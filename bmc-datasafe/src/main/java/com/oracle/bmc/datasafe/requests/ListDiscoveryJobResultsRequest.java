...
public class ListDiscoveryJobResultsRequest
    ...
    /**
     * A filter to return the discovery result resources based on the value of their isResultApplied
     * attribute.
     */
    ...
    /**
     * A filter to return the discovery job results with the specified confidence level. Confidence
     * level of discovery job result associated with a seeded sensitive type can either be HIGH or
     * LOW. While the confidence level of discovery job result associated with a user defined
     * sensitive will be NONE.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return the discovery result resources based on the value of their
         * isResultApplied attribute.
         */
         ...
         * Confidence level of discovery job result associated with a seeded sensitive type can
         * either be HIGH or LOW. While the confidence level of discovery job result associated with
         * a user defined sensitive will be NONE.
         */
        private java.util.List<com.oracle.bmc.datasafe.model.ConfidenceLevelEnum> confidenceLevel =
                null;
        ...
        /**
         * Singular setter. A filter to return the discovery job results with the specified
         * confidence level. Confidence level of discovery job result associated with a seeded
         * sensitive type can either be HIGH or LOW. While the confidence level of discovery job
         * result associated with a user defined sensitive will be NONE.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        public ListDiscoveryJobResultsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListDiscoveryJobResultsRequest(discoveryJobId, discoveryType, plannedAction,
            // isResultApplied, schemaName, objectName, columnName, sortOrder, confidenceLevel,
            // sortBy, opcRequestId, limit, page);
        }
    }
