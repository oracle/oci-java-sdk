...
public class GetDataSafeConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datasafe.model.DataSafeConfiguration getDataSafeConfiguration() {
        return dataSafeConfiguration;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder dataSafeConfiguration(
                com.oracle.bmc.datasafe.model.DataSafeConfiguration dataSafeConfiguration) {
            this.dataSafeConfiguration = dataSafeConfiguration;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(GetDataSafeConfigurationResponse o) {
        ...
        public GetDataSafeConfigurationResponse build() {
            return new GetDataSafeConfigurationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, dataSafeConfiguration);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",dataSafeConfiguration=").append(String.valueOf(dataSafeConfiguration));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDataSafeConfigurationResponse)) {
            return false;
        }

        GetDataSafeConfigurationResponse other = (GetDataSafeConfigurationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.dataSafeConfiguration, other.dataSafeConfiguration);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataSafeConfiguration == null
                                ? 43
                                : this.dataSafeConfiguration.hashCode());
        return result;
    }
}
