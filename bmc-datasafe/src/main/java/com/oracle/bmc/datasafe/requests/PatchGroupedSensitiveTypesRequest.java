...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/PatchGroupedSensitiveTypesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchGroupedSensitiveTypesRequest.
 */
...
public class PatchGroupedSensitiveTypesRequest
    ...
    public static class Builder
        ...
        public PatchGroupedSensitiveTypesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchGroupedSensitiveTypesRequest(sensitiveTypeGroupId, patchGroupedSensitiveTypesDetails, ifMatch, opcRequestId);
        }
    }
