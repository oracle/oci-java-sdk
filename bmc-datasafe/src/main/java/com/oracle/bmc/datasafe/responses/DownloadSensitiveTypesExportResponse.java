...
public class DownloadSensitiveTypesExportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DownloadSensitiveTypesExportResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DownloadSensitiveTypesExportResponse o) {
         ...
         */
        @Override
        public DownloadSensitiveTypesExportResponse build() {
            return new DownloadSensitiveTypesExportResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadSensitiveTypesExportResponse)) {
            return false;
        }

        DownloadSensitiveTypesExportResponse other = (DownloadSensitiveTypesExportResponse) o;
