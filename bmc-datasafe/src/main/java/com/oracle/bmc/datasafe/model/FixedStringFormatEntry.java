...
public final class FixedStringFormatEntry extends FormatEntry {
    ...
    public static class Builder {
        ...
        public FixedStringFormatEntry build() {
            FixedStringFormatEntry __instance__ =
                    new FixedStringFormatEntry(description, fixedString);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FixedStringFormatEntry o) {
            Builder copiedBuilder = description(o.getDescription()).fixedString(o.getFixedString());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.fixedString, other.fixedString)
