...
/**
 * Details of aggregation dimension summarizing alerts. <br>
...
public final class AlertsAggregationDimension
    ...
    public static class Builder {
        ...
        public AlertsAggregationDimension build() {
            AlertsAggregationDimension model = new AlertsAggregationDimension(this.groupBy);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AlertsAggregationDimension model) {
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.groupBy, other.groupBy) && super.equals(other);
    }
