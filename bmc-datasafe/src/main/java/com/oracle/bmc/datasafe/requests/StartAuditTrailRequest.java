...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/StartAuditTrailExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartAuditTrailRequest.
 */
...
public class StartAuditTrailRequest
    ...
    public static class Builder
        ...
        public StartAuditTrailRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new StartAuditTrailRequest(startAuditTrailDetails, auditTrailId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
