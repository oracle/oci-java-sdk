...
public class ListDataSafePrivateEndpointsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.datasafe.model.DataSafePrivateEndpointSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDataSafePrivateEndpointsResponse)) {
            return false;
        }

        ListDataSafePrivateEndpointsResponse other = (ListDataSafePrivateEndpointsResponse) o;
