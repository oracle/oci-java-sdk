...
/**
 * Details of the sensitive data model that's used as the source of masking columns.. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ColumnSourceFromSdmDetails.Builder.class)
...
public final class ColumnSourceFromSdmDetails extends ColumnSourceDetails {
    ...
    public static class Builder {
        ...
        public ColumnSourceFromSdmDetails build() {
            ColumnSourceFromSdmDetails model =
                    new ColumnSourceFromSdmDetails(this.sensitiveDataModelId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ColumnSourceFromSdmDetails model) {
    ...
    @Deprecated
    public ColumnSourceFromSdmDetails(String sensitiveDataModelId) {
        super();
        this.sensitiveDataModelId = sensitiveDataModelId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ColumnSourceFromSdmDetails)) {
            return false;
        }

        ColumnSourceFromSdmDetails other = (ColumnSourceFromSdmDetails) o;
