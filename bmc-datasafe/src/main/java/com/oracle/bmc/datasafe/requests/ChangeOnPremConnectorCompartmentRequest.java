...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ChangeOnPremConnectorCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeOnPremConnectorCompartmentRequest.
 */
...
public class ChangeOnPremConnectorCompartmentRequest
     ...
     * The details used to change the compartment of an on-premises connector.
     */
    public com.oracle.bmc.datasafe.model.ChangeOnPremConnectorCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.datasafe.model.ChangeOnPremConnectorCompartmentDetails
                changeOnPremConnectorCompartmentDetails = null;

        /**
         * The details used to change the compartment of an on-premises connector.
         * @param changeOnPremConnectorCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeOnPremConnectorCompartmentDetails(
                com.oracle.bmc.datasafe.model.ChangeOnPremConnectorCompartmentDetails
                        changeOnPremConnectorCompartmentDetails) {
            this.changeOnPremConnectorCompartmentDetails = changeOnPremConnectorCompartmentDetails;
            return this;
        }
         ...
         * @return instance of ChangeOnPremConnectorCompartmentRequest
         */
        public ChangeOnPremConnectorCompartmentRequest buildWithoutInvocationCallback() {
            ChangeOnPremConnectorCompartmentRequest request =
                    new ChangeOnPremConnectorCompartmentRequest();
            request.onPremConnectorId = onPremConnectorId;
            request.changeOnPremConnectorCompartmentDetails =
                    changeOnPremConnectorCompartmentDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeOnPremConnectorCompartmentRequest(onPremConnectorId, changeOnPremConnectorCompartmentDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeOnPremConnectorCompartmentDetails=")
                .append(String.valueOf(this.changeOnPremConnectorCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeOnPremConnectorCompartmentRequest)) {
            return false;
        }

        ChangeOnPremConnectorCompartmentRequest other = (ChangeOnPremConnectorCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.onPremConnectorId, other.onPremConnectorId)
                && java.util.Objects.equals(
                        this.changeOnPremConnectorCompartmentDetails,
                        other.changeOnPremConnectorCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeOnPremConnectorCompartmentDetails == null
                                ? 43
                                : this.changeOnPremConnectorCompartmentDetails.hashCode());
