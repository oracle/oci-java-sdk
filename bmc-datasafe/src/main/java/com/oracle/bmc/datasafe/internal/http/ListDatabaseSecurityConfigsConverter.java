...
public class ListDatabaseSecurityConfigsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListDatabaseSecurityConfigsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListDatabaseSecurityConfigsRequest
            interceptRequest(
                    com.oracle.bmc.datasafe.requests.ListDatabaseSecurityConfigsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20181201").path("databaseSecurityConfigs");
        ...
        if (request.getDatabaseSecurityConfigId() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.datasafe.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListDatabaseSecurityConfigsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.databaseSecurityConfigCollection(response.getItem());
