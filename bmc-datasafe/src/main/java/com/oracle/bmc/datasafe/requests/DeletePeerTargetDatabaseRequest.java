...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/DeletePeerTargetDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePeerTargetDatabaseRequest.
 */
...
public class DeletePeerTargetDatabaseRequest
    ...
    public static class Builder
        ...
        public DeletePeerTargetDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeletePeerTargetDatabaseRequest(targetDatabaseId, peerTargetDatabaseId, ifMatch, opcRequestId);
        }
    }
