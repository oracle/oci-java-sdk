...
public class DownloadSensitiveDataModelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DownloadSensitiveDataModelResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DownloadSensitiveDataModelResponse o) {
         ...
         */
        @Override
        public DownloadSensitiveDataModelResponse build() {
            return new DownloadSensitiveDataModelResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadSensitiveDataModelResponse)) {
            return false;
        }

        DownloadSensitiveDataModelResponse other = (DownloadSensitiveDataModelResponse) o;
