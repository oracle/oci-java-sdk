...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListTemplateAnalyticsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTemplateAnalyticsRequest.
 */
...
public class ListTemplateAnalyticsRequest
    ...
    public static class Builder
        ...
        public ListTemplateAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListTemplateAnalyticsRequest(compartmentId, compartmentIdInSubtree, accessLevel, templateAssessmentId, templateBaselineAssessmentId, isGroup, isCompared, isCompliant, targetId, targetDatabaseGroupId, opcRequestId, limit, page);
        }
    }
