...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListTemplateAnalyticsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use
 * ListTemplateAnalyticsRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class ListTemplateAnalyticsRequest
    ...
    /**
     * A filter to return only the target group related information if the OCID belongs to a target
     * group.
     */
    ...
    /**
     * A filter to return only the statistics where the comparison between the latest assessment and
     * the template baseline assessment is done.
     */
    ...
    /**
     * A filter to return only the statistics where the latest assessment is compliant with the
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListTemplateAnalyticsRequest, java.lang.Void> {
        ...
        /** The OCID of the security assessment of type TEMPLATE_BASELINE. */
        private String templateBaselineAssessmentId = null;
        ...
        /**
         * A filter to return only the target group related information if the OCID belongs to a
         * target group.
         */
        ...
        /**
         * A filter to return only the statistics where the comparison between the latest assessment
         * and the template baseline assessment is done.
         */
        private Boolean isCompared = null;
         ...
         * @return this builder instance
         */
        public Builder copy(ListTemplateAnalyticsRequest o) {
            compartmentId(o.getCompartmentId());
            compartmentIdInSubtree(o.getCompartmentIdInSubtree());
            accessLevel(o.getAccessLevel());
            templateAssessmentId(o.getTemplateAssessmentId());
            templateBaselineAssessmentId(o.getTemplateBaselineAssessmentId());
            isGroup(o.getIsGroup());
            isCompared(o.getIsCompared());
            isCompliant(o.getIsCompliant());
        ...
        /**
         * Build the instance of ListTemplateAnalyticsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListTemplateAnalyticsRequest
         */
        public ListTemplateAnalyticsRequest build() {
            ListTemplateAnalyticsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListTemplateAnalyticsRequest
         */
        public ListTemplateAnalyticsRequest buildWithoutInvocationCallback() {
            ListTemplateAnalyticsRequest request = new ListTemplateAnalyticsRequest();
            request.compartmentId = compartmentId;
            request.compartmentIdInSubtree = compartmentIdInSubtree;
            request.accessLevel = accessLevel;
            request.templateAssessmentId = templateAssessmentId;
            request.templateBaselineAssessmentId = templateBaselineAssessmentId;
            request.isGroup = isGroup;
            request.isCompared = isCompared;
            request.isCompliant = isCompliant;
            ...
            request.page = page;
            return request;
            // new ListTemplateAnalyticsRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // templateAssessmentId, templateBaselineAssessmentId, isGroup, isCompared, isCompliant,
            // targetId, targetDatabaseGroupId, opcRequestId, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTemplateAnalyticsRequest)) {
            return false;
        }

        ListTemplateAnalyticsRequest other = (ListTemplateAnalyticsRequest) o;
