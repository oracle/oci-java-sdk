...
public class ListSqlCollectionsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListSqlCollectionsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListSqlCollectionsRequest interceptRequest(
            com.oracle.bmc.datasafe.requests.ListSqlCollectionsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20181201").path("sqlCollections");
        ...
        if (request.getSqlCollectionId() != null) {
            target =
                    target.queryParam(
                            "sqlCollectionId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datasafe.responses.ListSqlCollectionsResponse>() {
                            @Override
                            public com.oracle.bmc.datasafe.responses.ListSqlCollectionsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListSqlCollectionsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.datasafe.responses.ListSqlCollectionsResponse.Builder
                                        builder =
                                ...
                                builder.sqlCollectionCollection(response.getItem());
