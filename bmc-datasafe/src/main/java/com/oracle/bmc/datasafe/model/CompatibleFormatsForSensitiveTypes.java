...
public class CompatibleFormatsForSensitiveTypes {
    ...
    public static class Builder {
        ...
        public CompatibleFormatsForSensitiveTypes build() {
            CompatibleFormatsForSensitiveTypes __instance__ =
                    new CompatibleFormatsForSensitiveTypes(formatsForSensitiveType);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompatibleFormatsForSensitiveTypes o) {
            Builder copiedBuilder = formatsForSensitiveType(o.getFormatsForSensitiveType());
