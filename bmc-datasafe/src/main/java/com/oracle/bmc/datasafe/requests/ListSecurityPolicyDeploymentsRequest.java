...
public class ListSecurityPolicyDeploymentsRequest
    ...
    public static class Builder
        ...
        public ListSecurityPolicyDeploymentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSecurityPolicyDeploymentsRequest(compartmentId, compartmentIdInSubtree, accessLevel, displayName, limit, page, lifecycleState, securityPolicyDeploymentId, targetId, targetType, securityPolicyId, sortOrder, sortBy, opcRequestId);
        }
    }
