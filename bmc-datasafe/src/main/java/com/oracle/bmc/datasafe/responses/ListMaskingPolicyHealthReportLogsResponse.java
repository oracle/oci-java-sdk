...
public class ListMaskingPolicyHealthReportLogsResponse
    ...
    public com.oracle.bmc.datasafe.model.MaskingPolicyHealthReportLogCollection
            getMaskingPolicyHealthReportLogCollection() {
        return maskingPolicyHealthReportLogCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder maskingPolicyHealthReportLogCollection(
                com.oracle.bmc.datasafe.model.MaskingPolicyHealthReportLogCollection
                        maskingPolicyHealthReportLogCollection) {
            this.maskingPolicyHealthReportLogCollection = maskingPolicyHealthReportLogCollection;
            return this;
        ...
        public Builder copy(ListMaskingPolicyHealthReportLogsResponse o) {
            ...
            maskingPolicyHealthReportLogCollection(o.getMaskingPolicyHealthReportLogCollection());
    ...
    public String toString() {
        ...
        sb.append(",maskingPolicyHealthReportLogCollection=")
                .append(String.valueOf(maskingPolicyHealthReportLogCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMaskingPolicyHealthReportLogsResponse)) {
            return false;
        }

        ListMaskingPolicyHealthReportLogsResponse other =
                (ListMaskingPolicyHealthReportLogsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.maskingPolicyHealthReportLogCollection,
                        other.maskingPolicyHealthReportLogCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.maskingPolicyHealthReportLogCollection == null
                                ? 43
                                : this.maskingPolicyHealthReportLogCollection.hashCode());
        return result;
    }
}
