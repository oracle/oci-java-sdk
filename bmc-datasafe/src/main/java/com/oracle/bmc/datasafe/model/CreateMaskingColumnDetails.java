...
/**
 * Details to create a new masking column. You can use this to add a parent column only. It
 * automatically adds the child columns from the associated sensitive data model or target database.
 * If you provide the sensitiveTypeId attribute but not the maskingFormats attribute, it
 * automatically assigns the default masking format associated with the specified sensitive type.
 * Alternatively, if you provide the maskingFormats attribute, the specified masking formats are
 * assigned to the column.
 *
 * <p>Using the maskingFormats attribute, you can assign one or more masking formats to a column.
 * You can specify a condition as part of each masking format. It enables you to do <a
 ...
 * formats and the associated conditions. A masking format can have one or more format entries. The
 ...
 *
 * <p>You can use the maskingColumnGroup attribute to group the columns that you would like to mask
 * together. It enables you to do <a
 ...
 * or compound masking</a> that ensures that the masked data across the columns in a group continue
 * to retain the same logical relationship. <br>
...
public final class CreateMaskingColumnDetails
    ...
    public static class Builder {
        /**
         * The name of the schema that contains the database column. This attribute cannot be
         * updated for an existing masking column.
         */
        ...
        /**
         * The name of the object (table or editioning view) that contains the database column. This
         ...
         * column. Note that the same name is used for the masking column. There is no separate
         * displayName attribute for the masking column.
         */
        ...
        /**
         * The OCID of the sensitive type to be associated with the masking column. Note that if the
         * maskingFormats attribute isn't provided while creating a masking column, the default
         * masking format associated with the specified sensitive type is assigned to the masking
         * column.
         */
    ...
    /**
     * The name of the schema that contains the database column. This attribute cannot be updated
     * for an existing masking column.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("schemaName")
    ...
    /**
     * The OCID of the sensitive type to be associated with the masking column. Note that if the
     * maskingFormats attribute isn't provided while creating a masking column, the default masking
     * format associated with the specified sensitive type is assigned to the masking column.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sensitiveTypeId")
