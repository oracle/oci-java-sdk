...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListAttributeSetsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAttributeSetsRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class ListAttributeSetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only attribute set resources that matches the specified attribute set OCID
     * query param.
     */
    ...
    /**
     * A filter to return only attribute set resources that matches the specified attribute set type
     * query param.
     */
    private com.oracle.bmc.datasafe.model.AttributeSet.AttributeSetType attributeSetType;

    /**
     * A filter to return only attribute set resources that matches the specified attribute set type
     * query param.
     */
    public com.oracle.bmc.datasafe.model.AttributeSet.AttributeSetType getAttributeSetType() {
        return attributeSetType;
    }
    /** The current state of an attribute set. */
    private com.oracle.bmc.datasafe.model.AttributeSet.LifecycleState lifecycleState;

    /** The current state of an attribute set. */
    public com.oracle.bmc.datasafe.model.AttributeSet.LifecycleState getLifecycleState() {
    ...
    /**
     * A filter to return user defined or seeded attribute set resources that matches the specified
     * is user defined query param. A true value indicates user defined attribute set.
     */
    ...
    public enum InUse implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static InUse create(String key) {
            ...
            throw new IllegalArgumentException("Invalid InUse: " + key);
        }
    };
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAttributeSetsRequest, java.lang.Void> {
        ...
        /**
         * A filter to return only attribute set resources that matches the specified attribute set
         * OCID query param.
         */
         ...
         * type query param.
         */
        private com.oracle.bmc.datasafe.model.AttributeSet.AttributeSetType attributeSetType = null;
         ...
         * @return this builder instance
         */
        public Builder attributeSetType(
                com.oracle.bmc.datasafe.model.AttributeSet.AttributeSetType attributeSetType) {
            this.attributeSetType = attributeSetType;
            return this;
        }

        /** The current state of an attribute set. */
        private com.oracle.bmc.datasafe.model.AttributeSet.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.datasafe.model.AttributeSet.LifecycleState lifecycleState) {
        ...
        /**
         * A filter to return user defined or seeded attribute set resources that matches the
         * specified is user defined query param. A true value indicates user defined attribute set.
         */
         ...
         * @return this builder instance
         */
        public Builder copy(ListAttributeSetsRequest o) {
            ...
            attributeSetId(o.getAttributeSetId());
            attributeSetType(o.getAttributeSetType());
        ...
        /**
         * Build the instance of ListAttributeSetsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAttributeSetsRequest
         */
        public ListAttributeSetsRequest build() {
            ListAttributeSetsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAttributeSetsRequest
         */
        public ListAttributeSetsRequest buildWithoutInvocationCallback() {
            ListAttributeSetsRequest request = new ListAttributeSetsRequest();
            ...
            request.attributeSetType = attributeSetType;
            ...
            request.inUse = inUse;
            return request;
            // new ListAttributeSetsRequest(compartmentId, compartmentIdInSubtree, accessLevel,
            // limit, page, displayName, attributeSetId, attributeSetType, lifecycleState,
            // sortOrder, sortBy, opcRequestId, isUserDefined, inUse);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAttributeSetsRequest)) {
            return false;
        }

        ListAttributeSetsRequest other = (ListAttributeSetsRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.attributeSetId, other.attributeSetId)
