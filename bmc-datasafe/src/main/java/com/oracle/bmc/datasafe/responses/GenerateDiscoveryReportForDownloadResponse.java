...
public class GenerateDiscoveryReportForDownloadResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDiscoveryReportForDownloadResponse)) {
            return false;
        }

        GenerateDiscoveryReportForDownloadResponse other =
                (GenerateDiscoveryReportForDownloadResponse) o;
