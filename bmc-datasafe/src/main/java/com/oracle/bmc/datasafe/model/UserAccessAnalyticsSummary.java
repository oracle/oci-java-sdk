...
public final class UserAccessAnalyticsSummary
    ...
    public static class Builder {
        ...
        public UserAccessAnalyticsSummary build() {
            UserAccessAnalyticsSummary model =
                    new UserAccessAnalyticsSummary(this.count, this.userName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserAccessAnalyticsSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserAccessAnalyticsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserAccessAnalyticsSummary)) {
            return false;
        }

        UserAccessAnalyticsSummary other = (UserAccessAnalyticsSummary) o;
