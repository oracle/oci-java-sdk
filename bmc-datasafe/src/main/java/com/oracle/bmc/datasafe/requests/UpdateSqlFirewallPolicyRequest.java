...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UpdateSqlFirewallPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSqlFirewallPolicyRequest.
 */
...
public class UpdateSqlFirewallPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateSqlFirewallPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSqlFirewallPolicyRequest(sqlFirewallPolicyId, updateSqlFirewallPolicyDetails, ifMatch, opcRequestId);
        }
    }
