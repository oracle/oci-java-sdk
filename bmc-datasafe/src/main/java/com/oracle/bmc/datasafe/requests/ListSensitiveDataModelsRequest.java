...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListSensitiveDataModelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSensitiveDataModelsRequest.
 */
...
public class ListSensitiveDataModelsRequest
    ...
    public static class Builder
        ...
        public ListSensitiveDataModelsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSensitiveDataModelsRequest(compartmentId, compartmentIdInSubtree, accessLevel, displayName, sensitiveDataModelId, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, targetId, sortOrder, sortBy, opcRequestId, limit, page, lifecycleState);
        }
    }
