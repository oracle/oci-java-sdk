...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UnifiedAuditPolicyDefinition.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UnifiedAuditPolicyDefinition
    ...
    public UnifiedAuditPolicyDefinition(
            String id,
    ...
    public static class Builder {
        ...
        public UnifiedAuditPolicyDefinition build() {
            UnifiedAuditPolicyDefinition model =
                    new UnifiedAuditPolicyDefinition(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAuditPolicyDefinition model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAuditPolicyDefinition)) {
            return false;
        }

        UnifiedAuditPolicyDefinition other = (UnifiedAuditPolicyDefinition) o;
