...
public final class AuditTrail extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * The date and time of the last purge job. The purge job deletes audit data in the target
         * database every seven days so that the database's audit trail does not become too large.
    ...
    /**
     * The OCID of the compartment that contains the audit trail and is the same as the compartment
     * of the audit profile resource.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * The date and time until when the audit events were collected from the target database by the
     * Data Safe audit trail collection process, in the format defined by RFC3339.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeLastCollected")
    ...
    /**
     * The date and time of the last purge job. The purge job deletes audit data in the target
     * database every seven days so that the database's audit trail does not become too large. In
    ...
    /** The current status of the audit trail purge job. */
    public enum PurgeJobStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Succeeded("SUCCEEDED"),
        Failed("FAILED"),
