...
/**
 * Details to apply the discovery results to a sensitive data model. <br>
...
public final class ApplyDiscoveryJobResultsDetails
    ...
    public static class Builder {
        ...
        public ApplyDiscoveryJobResultsDetails build() {
            ApplyDiscoveryJobResultsDetails model =
                    new ApplyDiscoveryJobResultsDetails(this.discoveryJobId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplyDiscoveryJobResultsDetails model) {
