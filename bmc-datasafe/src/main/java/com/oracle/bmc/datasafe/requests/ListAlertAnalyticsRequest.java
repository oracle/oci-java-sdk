...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListAlertAnalyticsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAlertAnalyticsRequest.
 */
...
public class ListAlertAnalyticsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAlertAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAlertAnalyticsRequest(compartmentId, compartmentIdInSubtree, limit, page, opcRequestId, ifMatch, timeStarted, timeEnded, queryTimeZone, sortOrder, sortBy, accessLevel, scimQuery, summaryField, groupBy, opcRetryToken);
        }
    }
