...
public class ListAlertAnalyticsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * quoted.)
     *
     * <p>*Example:** | (timeCreated ge "2021-06-04T01:00:26.000Z") and (targetNames eq "target_1")
     * (featureDetails.userName eq "user") and (targetNames eq "target_1") Supported fields:
    ...
    public static class Builder
         ...
         *
         * <p>*Example:** | (timeCreated ge "2021-06-04T01:00:26.000Z") and (targetNames eq
         * "target_1") (featureDetails.userName eq "user") and (targetNames eq "target_1") Supported
         * fields: severity status alertType targetIds targetNames operationTime lifecycleState
         * displayName timeCreated timeUpdated featureDetails.* (* can be any field in nestedStrMap
         * in Feature Attributes in Alert Summary. For example -
         * userName,object,clientHostname,osUserName,clientIPs,clientId,commandText,commandParam,clientProgram,objectType,targetOwner)
         */
