...
public class ListProfileAnalyticsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datasafe.model.ProfileAggregation> getItems() {
        return items;
    }
    ...
    private ListProfileAnalyticsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            String opcPrevPage,
            java.util.List<com.oracle.bmc.datasafe.model.ProfileAggregation> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListProfileAnalyticsResponse> {
         ...
         */
        @Override
        public Builder copy(ListProfileAnalyticsResponse o) {
         ...
         */
        @Override
        public ListProfileAnalyticsResponse build() {
            return new ListProfileAnalyticsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListProfileAnalyticsResponse)) {
            return false;
        }

        ListProfileAnalyticsResponse other = (ListProfileAnalyticsResponse) o;
