...
public class CreateSdmMaskingPolicyDifferenceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateSdmMaskingPolicyDifferenceResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateSdmMaskingPolicyDifferenceResponse o) {
         ...
         */
        public CreateSdmMaskingPolicyDifferenceResponse build() {
            return new CreateSdmMaskingPolicyDifferenceResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSdmMaskingPolicyDifferenceResponse)) {
            return false;
        }

        CreateSdmMaskingPolicyDifferenceResponse other =
                (CreateSdmMaskingPolicyDifferenceResponse) o;
