...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ChangeSecurityPolicyCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeSecurityPolicyCompartmentRequest.
 */
...
public class ChangeSecurityPolicyCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeSecurityPolicyCompartmentRequest as configured by this builder
         *
        ...
        public ChangeSecurityPolicyCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeSecurityPolicyCompartmentRequest(securityPolicyId, changeSecurityPolicyCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
