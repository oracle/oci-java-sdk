...
public final class UpdateSecurityAssessmentDetails {
    ...
    public static class Builder {
        ...
        public UpdateSecurityAssessmentDetails build() {
            UpdateSecurityAssessmentDetails __instance__ =
                    new UpdateSecurityAssessmentDetails(
                            displayName, description, schedule, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSecurityAssessmentDetails o) {
