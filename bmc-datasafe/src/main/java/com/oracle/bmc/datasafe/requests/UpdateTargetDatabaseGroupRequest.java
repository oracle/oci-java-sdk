...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/UpdateTargetDatabaseGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateTargetDatabaseGroupRequest.
 */
...
public class UpdateTargetDatabaseGroupRequest
    ...
    public static class Builder
        ...
        public UpdateTargetDatabaseGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateTargetDatabaseGroupRequest(targetDatabaseGroupId, updateTargetDatabaseGroupDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
