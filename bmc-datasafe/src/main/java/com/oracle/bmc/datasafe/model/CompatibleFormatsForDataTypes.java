...
public class CompatibleFormatsForDataTypes {
    ...
    public static class Builder {
        ...
        public CompatibleFormatsForDataTypes build() {
            CompatibleFormatsForDataTypes __instance__ =
                    new CompatibleFormatsForDataTypes(formatsForDataType);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompatibleFormatsForDataTypes o) {
            Builder copiedBuilder = formatsForDataType(o.getFormatsForDataType());
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("formatsForDataType")
    java.util.List<FormatsForDataType> formatsForDataType;
