...
public class ListCryptoAssessmentFindingTargetsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListCryptoAssessmentFindingTargetsRequest as configured by this
         * builder
         *
        ...
        public ListCryptoAssessmentFindingTargetsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListCryptoAssessmentFindingTargetsRequest(compartmentId, findingKey,
            // assessmentType, targetId, targetIds, status, isQuantumReadinessCheck, sortBy,
            // sortOrder, compartmentIdInSubtree, accessLevel, opcRequestId, limit, page);
        }
    }
