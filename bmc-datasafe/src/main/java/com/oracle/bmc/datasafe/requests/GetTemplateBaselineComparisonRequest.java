...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/GetTemplateBaselineComparisonExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTemplateBaselineComparisonRequest.
 */
...
public class GetTemplateBaselineComparisonRequest
    ...
    public static class Builder
        ...
        public GetTemplateBaselineComparisonRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetTemplateBaselineComparisonRequest(securityAssessmentId, comparisonSecurityAssessmentId, targetId, category, findingKey, opcRequestId);
        }
    }
