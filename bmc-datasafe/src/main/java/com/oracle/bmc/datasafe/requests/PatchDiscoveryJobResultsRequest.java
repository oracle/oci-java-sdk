...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/PatchDiscoveryJobResultsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchDiscoveryJobResultsRequest.
 */
...
public class PatchDiscoveryJobResultsRequest
    ...
    public static class Builder
        ...
        public PatchDiscoveryJobResultsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchDiscoveryJobResultsRequest(discoveryJobId, patchDiscoveryJobResultDetails, ifMatch, opcRequestId);
        }
    }
