...
/**
 * Category key for crypto findings. These are stable values meant for programmatic use; clients can
 * map them to user-facing labels.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public enum CryptoFindingCategory implements com.oracle.bmc.http.internal.BmcEnum {
