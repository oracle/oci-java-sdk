...
public class ListReferentialRelationsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListReferentialRelationsConverter.class);

    public static com.oracle.bmc.datasafe.requests.ListReferentialRelationsRequest interceptRequest(
            com.oracle.bmc.datasafe.requests.ListReferentialRelationsRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.datasafe.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datasafe.responses.ListReferentialRelationsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.datasafe.responses.ListReferentialRelationsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.datasafe.responses
                                                        .ListReferentialRelationsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.referentialRelationCollection(response.getItem());
