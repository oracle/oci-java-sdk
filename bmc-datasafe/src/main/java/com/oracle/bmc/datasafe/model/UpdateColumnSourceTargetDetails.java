...
public class UpdateColumnSourceTargetDetails extends UpdateColumnSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateColumnSourceTargetDetails build() {
            UpdateColumnSourceTargetDetails __instance__ =
                    new UpdateColumnSourceTargetDetails(targetId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateColumnSourceTargetDetails o) {
