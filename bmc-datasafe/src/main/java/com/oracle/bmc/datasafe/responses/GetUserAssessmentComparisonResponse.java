...
public class GetUserAssessmentComparisonResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetUserAssessmentComparisonResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            userAssessmentComparison(o.getUserAssessmentComparison());
        ...
        public GetUserAssessmentComparisonResponse build() {
            return new GetUserAssessmentComparisonResponse(
                    __httpStatusCode__, headers, opcRequestId, userAssessmentComparison);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",userAssessmentComparison=").append(String.valueOf(userAssessmentComparison));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserAssessmentComparisonResponse)) {
            return false;
        }

        GetUserAssessmentComparisonResponse other = (GetUserAssessmentComparisonResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.userAssessmentComparison, other.userAssessmentComparison);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userAssessmentComparison == null
                                ? 43
                                : this.userAssessmentComparison.hashCode());
        return result;
    }
}
