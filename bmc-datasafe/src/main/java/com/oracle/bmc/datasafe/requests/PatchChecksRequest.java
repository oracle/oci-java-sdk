...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/PatchChecksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchChecksRequest.
 */
...
public class PatchChecksRequest
    ...
    public static class Builder
        ...
        public PatchChecksRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchChecksRequest(securityAssessmentId, patchChecksDetails, opcRequestId, ifMatch);
        }
    }
