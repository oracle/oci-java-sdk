...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListUnifiedAuditPolicyDefinitionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUnifiedAuditPolicyDefinitionsRequest.
 */
...
public class ListUnifiedAuditPolicyDefinitionsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListUnifiedAuditPolicyDefinitionsRequest as configured by this builder
         *
        ...
        public ListUnifiedAuditPolicyDefinitionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUnifiedAuditPolicyDefinitionsRequest(compartmentId, lifecycleState, unifiedAuditPolicyDefinitionId, accessLevel, displayName, isSeeded, unifiedAuditPolicyCategory, unifiedAuditPolicyName, limit, page, compartmentIdInSubtree, sortOrder, sortBy, opcRequestId);
        }
    }
