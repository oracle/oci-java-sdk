...
public class SecurityAssessmentBaseLineDetails {
    ...
    public static class Builder {
        ...
        public SecurityAssessmentBaseLineDetails build() {
            SecurityAssessmentBaseLineDetails __instance__ =
                    new SecurityAssessmentBaseLineDetails(assessmentIds);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityAssessmentBaseLineDetails o) {
