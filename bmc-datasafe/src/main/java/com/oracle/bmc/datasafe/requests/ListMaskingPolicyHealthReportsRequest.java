...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListMaskingPolicyHealthReportsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMaskingPolicyHealthReportsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class ListMaskingPolicyHealthReportsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMaskingPolicyHealthReportsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMaskingPolicyHealthReportsRequest o) {
        ...
        /**
         * Build the instance of ListMaskingPolicyHealthReportsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMaskingPolicyHealthReportsRequest
         */
        public ListMaskingPolicyHealthReportsRequest build() {
            ListMaskingPolicyHealthReportsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMaskingPolicyHealthReportsRequest
         */
        public ListMaskingPolicyHealthReportsRequest buildWithoutInvocationCallback() {
            ListMaskingPolicyHealthReportsRequest request =
                    new ListMaskingPolicyHealthReportsRequest();
            ...
            return request;
            // new ListMaskingPolicyHealthReportsRequest(compartmentId, maskingPolicyHealthReportId, limit, page, opcRequestId, compartmentIdInSubtree, accessLevel, sortBy, sortOrder, displayName, targetId, maskingPolicyId, lifecycleState);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMaskingPolicyHealthReportsRequest)) {
            return false;
        }

        ListMaskingPolicyHealthReportsRequest other = (ListMaskingPolicyHealthReportsRequest) o;
