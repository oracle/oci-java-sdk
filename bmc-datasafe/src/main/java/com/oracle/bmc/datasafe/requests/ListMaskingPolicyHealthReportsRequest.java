...
public class ListMaskingPolicyHealthReportsRequest
    ...
    /**
     * A filter to return only the resources that match the specified masking policy health report
     * OCID.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only the resources that match the specified masking policy health
         * report OCID.
         */
        ...
        public ListMaskingPolicyHealthReportsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMaskingPolicyHealthReportsRequest(compartmentId, maskingPolicyHealthReportId,
            // limit, page, opcRequestId, compartmentIdInSubtree, accessLevel, sortBy, sortOrder,
            // displayName, targetId, maskingPolicyId, lifecycleState);
        }
    }
