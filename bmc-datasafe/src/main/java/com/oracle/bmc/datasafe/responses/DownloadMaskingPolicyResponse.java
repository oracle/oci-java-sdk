...
public class DownloadMaskingPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DownloadMaskingPolicyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadMaskingPolicyResponse)) {
            return false;
        }

        DownloadMaskingPolicyResponse other = (DownloadMaskingPolicyResponse) o;
