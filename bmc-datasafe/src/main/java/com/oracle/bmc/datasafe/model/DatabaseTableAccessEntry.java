...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseTableAccessEntry.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DatabaseTableAccessEntry
    ...
    public DatabaseTableAccessEntry(
            String key,
            String grantee,
    ...
    public static class Builder {
        ...
        public DatabaseTableAccessEntry build() {
            DatabaseTableAccessEntry model =
                    new DatabaseTableAccessEntry(
                            this.key,
                            this.grantee,
                            this.accessType,
                            this.tableSchema,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseTableAccessEntry model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseTableAccessEntry(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseTableAccessEntry)) {
            return false;
        }

        DatabaseTableAccessEntry other = (DatabaseTableAccessEntry) o;
