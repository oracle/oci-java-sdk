...
public class AuditEventAggregationItems {
    ...
    public static class Builder {
        ...
        private AuditEventAggregationDimensions dimensions;

        public Builder dimensions(AuditEventAggregationDimensions dimensions) {
        ...
        public AuditEventAggregationItems build() {
            AuditEventAggregationItems __instance__ =
                    new AuditEventAggregationItems(
                            displayName, metricName, timeStarted, timeEnded, count, dimensions);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuditEventAggregationItems o) {
