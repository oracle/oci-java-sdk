...
public final class ReferentialRelationSummary
    ...
    public ReferentialRelationSummary(
            String key,
    ...
    public static class Builder {
        ...
        public ReferentialRelationSummary build() {
            ReferentialRelationSummary model =
                    new ReferentialRelationSummary(
                            this.key,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReferentialRelationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ReferentialRelationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReferentialRelationSummary)) {
            return false;
        }

        ReferentialRelationSummary other = (ReferentialRelationSummary) o;
