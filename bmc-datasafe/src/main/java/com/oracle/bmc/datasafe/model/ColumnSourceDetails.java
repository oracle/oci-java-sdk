...
/**
 * The source of masking columns. <br>
...
public class ColumnSourceDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ColumnSourceDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ColumnSourceDetails)) {
            return false;
        }

        ColumnSourceDetails other = (ColumnSourceDetails) o;
    ...
    public enum ColumnSource implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(ColumnSource.class);
