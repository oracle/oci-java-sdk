...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListUnifiedAuditPoliciesExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use
 * ListUnifiedAuditPoliciesRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181201")
public class ListUnifiedAuditPoliciesRequest
    ...
    private com.oracle.bmc.datasafe.model.UnifiedAuditPolicyLifecycleState lifecycleState;

    /** The current state of the Unified Audit policy. */
    public com.oracle.bmc.datasafe.model.UnifiedAuditPolicyLifecycleState getLifecycleState() {
    ...
    /**
     * A boolean flag indicating to list seeded unified audit policies. Set this parameter to get
     * list of seeded unified audit policies.
     */
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListUnifiedAuditPoliciesRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.datasafe.model.UnifiedAuditPolicyLifecycleState lifecycleState) {
        ...
        /**
         * A boolean flag indicating to list seeded unified audit policies. Set this parameter to
         * get list of seeded unified audit policies.
         */
         ...
         * @return this builder instance
         */
        public Builder copy(ListUnifiedAuditPoliciesRequest o) {
        ...
        /**
         * Build the instance of ListUnifiedAuditPoliciesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListUnifiedAuditPoliciesRequest
         */
        public ListUnifiedAuditPoliciesRequest build() {
            ListUnifiedAuditPoliciesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUnifiedAuditPoliciesRequest
         */
        public ListUnifiedAuditPoliciesRequest buildWithoutInvocationCallback() {
            ListUnifiedAuditPoliciesRequest request = new ListUnifiedAuditPoliciesRequest();
            ...
            return request;
            // new ListUnifiedAuditPoliciesRequest(compartmentId, securityPolicyId, lifecycleState,
            // accessLevel, displayName, isSeeded, timeCreatedGreaterThanOrEqualTo,
            // timeCreatedLessThan, limit, page, unifiedAuditPolicyDefinitionId,
            // unifiedAuditPolicyId, sortOrder, sortBy, opcRequestId, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUnifiedAuditPoliciesRequest)) {
            return false;
        }

        ListUnifiedAuditPoliciesRequest other = (ListUnifiedAuditPoliciesRequest) o;
