...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/ListUnifiedAuditPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUnifiedAuditPoliciesRequest.
 */
...
public class ListUnifiedAuditPoliciesRequest
    ...
    public static class Builder
        ...
        public ListUnifiedAuditPoliciesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUnifiedAuditPoliciesRequest(compartmentId, securityPolicyId, lifecycleState, accessLevel, displayName, isSeeded, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan, limit, page, unifiedAuditPolicyDefinitionId, unifiedAuditPolicyId, sortOrder, sortBy, opcRequestId, compartmentIdInSubtree);
        }
    }
