...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datasafe/PatchSdmMaskingPolicyDifferenceColumnsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSdmMaskingPolicyDifferenceColumnsRequest.
 */
...
public class PatchSdmMaskingPolicyDifferenceColumnsRequest
    ...
    public static class Builder
        ...
        public PatchSdmMaskingPolicyDifferenceColumnsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchSdmMaskingPolicyDifferenceColumnsRequest(sdmMaskingPolicyDifferenceId, patchSdmMaskingPolicyDifferenceColumnsDetails, ifMatch, opcRequestId);
        }
    }
