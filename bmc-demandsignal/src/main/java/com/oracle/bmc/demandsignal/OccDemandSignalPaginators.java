 ...
 * to any list operations of OccDemandSignal where multiple pages of data may be fetched. Two styles
...
public class OccDemandSignalPaginators {
     ...
     * listOccDemandSignals operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.demandsignal.model.OccDemandSignalSummary} objects contained in responses from
     * the listOccDemandSignals operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.demandsignal.model.OccDemandSignalSummary} objects contained in responses
     *     received from the service.
     */
