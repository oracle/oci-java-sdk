...
public class OccMetricAlarmClient implements OccMetricAlarm {
    /**
     ...
     */
    protected OccMetricAlarmClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public OccMetricAlarmClient build(
            ...
            return new OccMetricAlarmClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public CreateOccMetricAlarmResponse createOccMetricAlarm(CreateOccMetricAlarmRequest request) {
        LOG.trace("Called createOccMetricAlarm");
        final CreateOccMetricAlarmRequest interceptedRequest =
                CreateOccMetricAlarmConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateOccMetricAlarmConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateOccMetricAlarmResponse>
                transformer =
                        CreateOccMetricAlarmConverter.fromResponse(
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateOccMetricAlarmDetails(),
                                                retriedRequest);
    ...
    public DeleteOccMetricAlarmResponse deleteOccMetricAlarm(DeleteOccMetricAlarmRequest request) {
        LOG.trace("Called deleteOccMetricAlarm");
        final DeleteOccMetricAlarmRequest interceptedRequest =
                DeleteOccMetricAlarmConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteOccMetricAlarmConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteOccMetricAlarmResponse>
                transformer =
                        DeleteOccMetricAlarmConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public GetOccMetricAlarmResponse getOccMetricAlarm(GetOccMetricAlarmRequest request) {
        LOG.trace("Called getOccMetricAlarm");
        final GetOccMetricAlarmRequest interceptedRequest =
                GetOccMetricAlarmConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetOccMetricAlarmConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetOccMetricAlarmResponse>
                transformer =
                        GetOccMetricAlarmConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListOccMetricAlarmsResponse listOccMetricAlarms(ListOccMetricAlarmsRequest request) {
        LOG.trace("Called listOccMetricAlarms");
        final ListOccMetricAlarmsRequest interceptedRequest =
                ListOccMetricAlarmsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListOccMetricAlarmsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListOccMetricAlarmsResponse>
                transformer =
                        ListOccMetricAlarmsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public UpdateOccMetricAlarmResponse updateOccMetricAlarm(UpdateOccMetricAlarmRequest request) {
        LOG.trace("Called updateOccMetricAlarm");
        final UpdateOccMetricAlarmRequest interceptedRequest =
                UpdateOccMetricAlarmConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateOccMetricAlarmConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateOccMetricAlarmResponse>
                transformer =
                        UpdateOccMetricAlarmConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateOccMetricAlarmDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
