...
public class ListOccDemandSignalsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.demandsignal.model.OccDemandSignalCollection
            getOccDemandSignalCollection() {
        return occDemandSignalCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder occDemandSignalCollection(
        ...
        public Builder copy(ListOccDemandSignalsResponse o) {
            ...
            occDemandSignalCollection(o.getOccDemandSignalCollection());
    ...
    public String toString() {
        ...
        sb.append(",occDemandSignalCollection=").append(String.valueOf(occDemandSignalCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccDemandSignalsResponse)) {
            return false;
        }

        ListOccDemandSignalsResponse other = (ListOccDemandSignalsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.occDemandSignalCollection, other.occDemandSignalCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.occDemandSignalCollection == null
                                ? 43
                                : this.occDemandSignalCollection.hashCode());
        return result;
    }
}
