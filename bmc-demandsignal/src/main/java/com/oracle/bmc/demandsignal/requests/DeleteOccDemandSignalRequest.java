...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/demandsignal/DeleteOccDemandSignalExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOccDemandSignalRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240430")
public class DeleteOccDemandSignalRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOccDemandSignalRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOccDemandSignalRequest o) {
        ...
        /**
         * Build the instance of DeleteOccDemandSignalRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteOccDemandSignalRequest
         */
        public DeleteOccDemandSignalRequest build() {
            DeleteOccDemandSignalRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOccDemandSignalRequest
         */
        public DeleteOccDemandSignalRequest buildWithoutInvocationCallback() {
            DeleteOccDemandSignalRequest request = new DeleteOccDemandSignalRequest();
            request.occDemandSignalId = occDemandSignalId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOccDemandSignalRequest(occDemandSignalId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccDemandSignalRequest)) {
            return false;
        }

        DeleteOccDemandSignalRequest other = (DeleteOccDemandSignalRequest) o;
