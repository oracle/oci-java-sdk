...
public class OccDemandSignalClient implements OccDemandSignal {
    /**
     ...
     */
    protected OccDemandSignalClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public OccDemandSignalClient build(
            ...
            return new OccDemandSignalClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ChangeOccDemandSignalCompartmentResponse changeOccDemandSignalCompartment(
        ...
        LOG.trace("Called changeOccDemandSignalCompartment");
    ...
    public CreateOccDemandSignalResponse createOccDemandSignal(
        ...
        LOG.trace("Called createOccDemandSignal");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateOccDemandSignalResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateOccDemandSignalDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteOccDemandSignalResponse deleteOccDemandSignal(
        ...
        LOG.trace("Called deleteOccDemandSignal");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteOccDemandSignalResponse>
                transformer =
    ...
    public GetOccDemandSignalResponse getOccDemandSignal(GetOccDemandSignalRequest request) {
        LOG.trace("Called getOccDemandSignal");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetOccDemandSignalResponse>
                transformer =
    ...
    public ListOccDemandSignalsResponse listOccDemandSignals(ListOccDemandSignalsRequest request) {
        LOG.trace("Called listOccDemandSignals");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListOccDemandSignalsResponse>
                transformer =
    ...
    public PatchOccDemandSignalResponse patchOccDemandSignal(PatchOccDemandSignalRequest request) {
        LOG.trace("Called patchOccDemandSignal");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, PatchOccDemandSignalResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.patch(
                                                ib,
                                                retriedRequest.getPatchOccDemandSignalDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateOccDemandSignalResponse updateOccDemandSignal(
        ...
        LOG.trace("Called updateOccDemandSignal");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateOccDemandSignalResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateOccDemandSignalDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
