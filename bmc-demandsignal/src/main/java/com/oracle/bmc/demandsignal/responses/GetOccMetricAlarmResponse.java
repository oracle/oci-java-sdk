...
public class GetOccMetricAlarmResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetOccMetricAlarmResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOccMetricAlarmResponse> {
         ...
         */
        @Override
        public Builder copy(GetOccMetricAlarmResponse o) {
         ...
         */
        @Override
        public GetOccMetricAlarmResponse build() {
            return new GetOccMetricAlarmResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccMetricAlarmResponse)) {
            return false;
        }

        GetOccMetricAlarmResponse other = (GetOccMetricAlarmResponse) o;
