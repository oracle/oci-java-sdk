...
public interface OccMetricAlarmAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateOccMetricAlarmResponse> createOccMetricAlarm(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOccMetricAlarmResponse> deleteOccMetricAlarm(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOccMetricAlarmResponse> getOccMetricAlarm(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOccMetricAlarmsResponse> listOccMetricAlarms(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOccMetricAlarmResponse> updateOccMetricAlarm(
