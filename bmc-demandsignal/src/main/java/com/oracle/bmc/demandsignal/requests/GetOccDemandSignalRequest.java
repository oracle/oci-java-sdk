...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/demandsignal/GetOccDemandSignalExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOccDemandSignalRequest.
 */
...
public class GetOccDemandSignalRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOccDemandSignalRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOccDemandSignalRequest o) {
        ...
        /**
         * Build the instance of GetOccDemandSignalRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOccDemandSignalRequest
         */
        public GetOccDemandSignalRequest build() {
            GetOccDemandSignalRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOccDemandSignalRequest
         */
        public GetOccDemandSignalRequest buildWithoutInvocationCallback() {
            GetOccDemandSignalRequest request = new GetOccDemandSignalRequest();
            request.occDemandSignalId = occDemandSignalId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetOccDemandSignalRequest(occDemandSignalId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().occDemandSignalId(occDemandSignalId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccDemandSignalRequest)) {
            return false;
        }

        GetOccDemandSignalRequest other = (GetOccDemandSignalRequest) o;
