...
public interface OccDemandSignalAsync extends AutoCloseable {
    ...
    /**
     * Moves a OccDemandSignal into a different compartment within the same tenancy. For information
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateOccDemandSignalResponse> createOccDemandSignal(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOccDemandSignalResponse> deleteOccDemandSignal(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOccDemandSignalResponse> getOccDemandSignal(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOccDemandSignalsResponse> listOccDemandSignals(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<PatchOccDemandSignalResponse> patchOccDemandSignal(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOccDemandSignalResponse> updateOccDemandSignal(
