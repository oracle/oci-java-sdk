 ...
 * to any list operations of OccMetricAlarm where multiple pages of data may be fetched. Two styles
...
public class OccMetricAlarmPaginators {
     ...
     * listOccMetricAlarms operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.demandsignal.model.OccMetricAlarmSummary} objects contained in responses from
     * the listOccMetricAlarms operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.demandsignal.model.OccMetricAlarmSummary} objects contained in responses
     *     received from the service.
     */
