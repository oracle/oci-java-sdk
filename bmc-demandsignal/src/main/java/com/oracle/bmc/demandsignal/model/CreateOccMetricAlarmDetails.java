...
/**
 * Payload for creating an OccMetricAlarm. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOccMetricAlarmDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateOccMetricAlarmDetails
    ...
    public CreateOccMetricAlarmDetails(
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public CreateOccMetricAlarmDetails build() {
            CreateOccMetricAlarmDetails model =
                    new CreateOccMetricAlarmDetails(
                            this.displayName,
                            this.description,
                            this.lifecycleState,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOccMetricAlarmDetails model) {
    ...
    public enum ThresholdType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static ThresholdType create(String key) {
            ...
            throw new IllegalArgumentException("Invalid ThresholdType: " + key);
        }
    };
    /** Units in which threshold is being stored. */
    @com.fasterxml.jackson.annotation.JsonProperty("thresholdType")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOccMetricAlarmDetails)) {
            return false;
        }

        CreateOccMetricAlarmDetails other = (CreateOccMetricAlarmDetails) o;
