...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OccMetricAlarmSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OccMetricAlarmSummary
    ...
    public OccMetricAlarmSummary(
            String id,
            String displayName,
            String description,
            java.util.Date timeCreated,
            java.util.Date timeUpdated,
            OccMetricAlarm.LifecycleState lifecycleState,
            String compartmentId,
            Boolean isActive,
            java.util.List<String> subscribers,
            OccMetricAlarm.Frequency frequency,
            Integer threshold,
    ...
    public static class Builder {
        ...
        private OccMetricAlarm.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(OccMetricAlarm.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        private OccMetricAlarm.Frequency frequency;
         ...
         * @return this builder
         */
        public Builder frequency(OccMetricAlarm.Frequency frequency) {
            this.frequency = frequency;
        ...
        public OccMetricAlarmSummary build() {
            OccMetricAlarmSummary model =
                    new OccMetricAlarmSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OccMetricAlarmSummary model) {
    ...
    /** The current lifecycle state of the resource. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final OccMetricAlarm.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public OccMetricAlarm.LifecycleState getLifecycleState() {
    ...
    /** Frequency at which notifications should be sent. */
    @com.fasterxml.jackson.annotation.JsonProperty("frequency")
    private final OccMetricAlarm.Frequency frequency;
     ...
     * @return the value
     */
    public OccMetricAlarm.Frequency getFrequency() {
        return frequency;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OccMetricAlarmSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OccMetricAlarmSummary)) {
            return false;
        }

        OccMetricAlarmSummary other = (OccMetricAlarmSummary) o;
