...
/**
 * Fields that can be updated for OccMetricAlarm. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOccMetricAlarmDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOccMetricAlarmDetails
    ...
    public UpdateOccMetricAlarmDetails(
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public UpdateOccMetricAlarmDetails build() {
            UpdateOccMetricAlarmDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOccMetricAlarmDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOccMetricAlarmDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccMetricAlarmDetails)) {
            return false;
        }

        UpdateOccMetricAlarmDetails other = (UpdateOccMetricAlarmDetails) o;
