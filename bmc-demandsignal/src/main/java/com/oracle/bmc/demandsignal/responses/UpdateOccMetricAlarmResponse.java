...
public class UpdateOccMetricAlarmResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code OccMetricAlarm} instance. */
    ...
    private UpdateOccMetricAlarmResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateOccMetricAlarmResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateOccMetricAlarmResponse o) {
         ...
         */
        @Override
        public UpdateOccMetricAlarmResponse build() {
            return new UpdateOccMetricAlarmResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccMetricAlarmResponse)) {
            return false;
        }

        UpdateOccMetricAlarmResponse other = (UpdateOccMetricAlarmResponse) o;
