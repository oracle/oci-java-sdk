...
public class UpdateQueryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateQueryResponse> {
        ...
        public UpdateQueryResponse build() {
            return new UpdateQueryResponse(__httpStatusCode__, headers, opcRequestId, etag, query);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateQueryResponse)) {
            return false;
        }
