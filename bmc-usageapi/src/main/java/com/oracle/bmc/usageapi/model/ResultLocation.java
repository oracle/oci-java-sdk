...
/**
 * The location where usage or cost CSVs will be uploaded defined by {@code locationType}, which
 * corresponds with type-specific characteristics. <br>
...
public class ResultLocation extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
