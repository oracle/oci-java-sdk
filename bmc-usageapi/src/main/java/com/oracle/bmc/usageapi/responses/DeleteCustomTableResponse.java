...
public class DeleteCustomTableResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteCustomTableResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteCustomTableResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteCustomTableResponse o) {
        ...
        public DeleteCustomTableResponse build() {
            return new DeleteCustomTableResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCustomTableResponse)) {
            return false;
        }

        DeleteCustomTableResponse other = (DeleteCustomTableResponse) o;
