...
public class ListCustomTablesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder customTableCollection(
                com.oracle.bmc.usageapi.model.CustomTableCollection customTableCollection) {
            this.customTableCollection = customTableCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",customTableCollection=").append(String.valueOf(customTableCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCustomTablesResponse)) {
            return false;
        }

        ListCustomTablesResponse other = (ListCustomTablesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.customTableCollection, other.customTableCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.customTableCollection == null
                                ? 43
                                : this.customTableCollection.hashCode());
        return result;
    }
}
