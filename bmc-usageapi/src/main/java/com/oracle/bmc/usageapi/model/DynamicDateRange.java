...
/**
 * The saved dynamic date range (required when the static date range is missing). <br>
...
public final class DynamicDateRange extends DateRange {
    ...
    /** */
    public enum DynamicDateRangeType implements com.oracle.bmc.http.internal.BmcEnum {
