...
public class GetEmailRecipientsGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder emailRecipientsGroup(
                com.oracle.bmc.usageapi.model.EmailRecipientsGroup emailRecipientsGroup) {
            this.emailRecipientsGroup = emailRecipientsGroup;
            return this;
        }
        ...
        public Builder copy(GetEmailRecipientsGroupResponse o) {
            ...
            etag(o.getEtag());
            emailRecipientsGroup(o.getEmailRecipientsGroup());
    ...
    public String toString() {
        ...
        sb.append(",emailRecipientsGroup=").append(String.valueOf(emailRecipientsGroup));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEmailRecipientsGroupResponse)) {
            return false;
        }

        GetEmailRecipientsGroupResponse other = (GetEmailRecipientsGroupResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.emailRecipientsGroup, other.emailRecipientsGroup);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.emailRecipientsGroup == null
                                ? 43
                                : this.emailRecipientsGroup.hashCode());
        return result;
    }
}
