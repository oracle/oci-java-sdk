...
public class CreateQueryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateQueryResponse> {
        ...
        public CreateQueryResponse build() {
            return new CreateQueryResponse(__httpStatusCode__, headers, opcRequestId, etag, query);
        }
    }
