...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/usageapi/GetCustomTableExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetCustomTableRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200107")
public class GetCustomTableRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetCustomTableRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetCustomTableRequest
         */
        public GetCustomTableRequest build() {
            GetCustomTableRequest request = buildWithoutInvocationCallback();
        ...
        public GetCustomTableRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetCustomTableRequest(customTableId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().customTableId(customTableId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetCustomTableRequest other = (GetCustomTableRequest) o;
