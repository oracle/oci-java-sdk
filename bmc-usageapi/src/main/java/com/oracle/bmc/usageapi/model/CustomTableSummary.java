...
public class CustomTableSummary {
    ...
    public static class Builder {
        ...
        public CustomTableSummary build() {
            CustomTableSummary __instance__ = new CustomTableSummary(id, savedCustomTable);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomTableSummary o) {
            Builder copiedBuilder = id(o.getId()).savedCustomTable(o.getSavedCustomTable());
