...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/usageapi/RequestUsageCarbonEmissionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestUsageCarbonEmissionsRequest.
 */
...
public class RequestUsageCarbonEmissionsRequest
    ...
    public static class Builder
        ...
        public RequestUsageCarbonEmissionsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new RequestUsageCarbonEmissionsRequest(requestUsageCarbonEmissionsDetails, opcRequestId, page, limit);
        }
    }
