...
/**
 * New query detail with savedRequestUsageCarbonEmissionsDetails, savedCostAnalysisUI, and
 * displayName. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateUsageCarbonEmissionsQueryDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateUsageCarbonEmissionsQueryDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"compartmentId", "queryDefinition"})
    public CreateUsageCarbonEmissionsQueryDetails(
            String compartmentId, UsageCarbonEmissionsQueryDefinition queryDefinition) {
        super();
    ...
    public static class Builder {
        ...
        public CreateUsageCarbonEmissionsQueryDetails build() {
            CreateUsageCarbonEmissionsQueryDetails model =
                    new CreateUsageCarbonEmissionsQueryDetails(
                            this.compartmentId, this.queryDefinition);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateUsageCarbonEmissionsQueryDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateUsageCarbonEmissionsQueryDetails)) {
            return false;
        }

        CreateUsageCarbonEmissionsQueryDetails other = (CreateUsageCarbonEmissionsQueryDetails) o;
