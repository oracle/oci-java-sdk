...
public class GetQueryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetQueryResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetQueryResponse)) {
            return false;
        }

        GetQueryResponse other = (GetQueryResponse) o;
