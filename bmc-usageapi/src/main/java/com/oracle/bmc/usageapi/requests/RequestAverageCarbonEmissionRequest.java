...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/usageapi/RequestAverageCarbonEmissionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestAverageCarbonEmissionRequest.
 */
...
public class RequestAverageCarbonEmissionRequest
    ...
    public static class Builder
        ...
        public RequestAverageCarbonEmissionRequest build() {
            RequestAverageCarbonEmissionRequest request = buildWithoutInvocationCallback();
        ...
        public RequestAverageCarbonEmissionRequest buildWithoutInvocationCallback() {
            ...
            request.skuPartNumber = skuPartNumber;
            request.opcRequestId = opcRequestId;
            return request;
            // new RequestAverageCarbonEmissionRequest(skuPartNumber, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().skuPartNumber(skuPartNumber).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        RequestAverageCarbonEmissionRequest other = (RequestAverageCarbonEmissionRequest) o;
