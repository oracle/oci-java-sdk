...
public final class CreateQueryDetails {
    ...
    public static class Builder {
        ...
        public CreateQueryDetails build() {
            CreateQueryDetails __instance__ =
                    new CreateQueryDetails(compartmentId, queryDefinition);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateQueryDetails o) {
            Builder copiedBuilder =
                    compartmentId(o.getCompartmentId()).queryDefinition(o.getQueryDefinition());
