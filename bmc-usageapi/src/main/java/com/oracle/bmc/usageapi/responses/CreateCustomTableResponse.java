...
public class CreateCustomTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCustomTableResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCustomTableResponse)) {
            return false;
        }

        CreateCustomTableResponse other = (CreateCustomTableResponse) o;
