...
public class CreateReplicationScheduleConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateReplicationScheduleConverter.class);

    public static com.oracle.bmc.cloudmigrations.requests.CreateReplicationScheduleRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.cloudmigrations.requests.CreateReplicationScheduleRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220919").path("replicationSchedules");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.cloudmigrations.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudmigrations.responses.CreateReplicationScheduleResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.replicationSchedule(response.getItem());
