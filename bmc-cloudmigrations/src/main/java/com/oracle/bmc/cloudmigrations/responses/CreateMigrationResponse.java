...
public class CreateMigrationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMigrationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMigrationResponse)) {
            return false;
        }

        CreateMigrationResponse other = (CreateMigrationResponse) o;
