...
/**
 * Results of a migration search. Contains both migration summary items and other information, such
 * as metadata. <br>
...
public final class MigrationCollection
    ...
    public static class Builder {
        ...
        public MigrationCollection build() {
            MigrationCollection model = new MigrationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MigrationCollection model) {
