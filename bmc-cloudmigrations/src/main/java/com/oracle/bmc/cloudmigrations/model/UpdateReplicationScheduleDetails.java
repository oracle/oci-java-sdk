...
/**
 * Information about replication schedule to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateReplicationScheduleDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateReplicationScheduleDetails
    ...
    public UpdateReplicationScheduleDetails(
            String displayName,
    ...
    public static class Builder {
        /**
         * A user-friendly name for a replication schedule. Does not have to be unique, and is
        ...
        public UpdateReplicationScheduleDetails build() {
            UpdateReplicationScheduleDetails model =
                    new UpdateReplicationScheduleDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateReplicationScheduleDetails model) {
    ...
    /**
     * A user-friendly name for a replication schedule. Does not have to be unique, and is mutable.
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReplicationScheduleDetails)) {
            return false;
        }

        UpdateReplicationScheduleDetails other = (UpdateReplicationScheduleDetails) o;
