...
public class UpdateMigrationAssetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateMigrationAssetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateMigrationAssetResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateMigrationAssetResponse o) {
         ...
         */
        @Override
        public UpdateMigrationAssetResponse build() {
            return new UpdateMigrationAssetResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, migrationAsset);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMigrationAssetResponse)) {
            return false;
        }

        UpdateMigrationAssetResponse other = (UpdateMigrationAssetResponse) o;
