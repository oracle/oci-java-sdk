...
/**
 * OLVM asset source update request. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOlvmAssetSourceDetails.Builder.class)
...
public final class UpdateOlvmAssetSourceDetails extends UpdateAssetSourceDetails {
    ...
    public static class Builder {
        ...
        /**
         * Endpoint for OLVM asset discovery and replication in the form of {@code
         * https://<host>:<port>}
         */
        ...
        public UpdateOlvmAssetSourceDetails build() {
            UpdateOlvmAssetSourceDetails model =
                    new UpdateOlvmAssetSourceDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOlvmAssetSourceDetails model) {
    ...
    @Deprecated
    public UpdateOlvmAssetSourceDetails(
            String displayName,
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("olvmEndpoint")
    private final String olvmEndpoint;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOlvmAssetSourceDetails(");
        sb.append("super=").append(super.toString(includeByteArrayContents));
        sb.append(", olvmEndpoint=").append(String.valueOf(this.olvmEndpoint));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOlvmAssetSourceDetails)) {
            return false;
        }

        UpdateOlvmAssetSourceDetails other = (UpdateOlvmAssetSourceDetails) o;
        return java.util.Objects.equals(this.olvmEndpoint, other.olvmEndpoint)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.olvmEndpoint == null ? 43 : this.olvmEndpoint.hashCode());
        result =
                (result * PRIME)
