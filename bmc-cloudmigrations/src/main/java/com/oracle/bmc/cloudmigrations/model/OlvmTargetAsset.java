...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OlvmTargetAsset.Builder.class)
...
public final class OlvmTargetAsset extends TargetAsset {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OlvmTargetAsset model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OlvmTargetAsset)) {
            return false;
        }

        OlvmTargetAsset other = (OlvmTargetAsset) o;
