...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudmigrations/ListWorkRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestsRequest.
 */
...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.cloudmigrations.model.OperationStatus status;

    /**
     * A filter to return only resources where the resource's lifecycle state matches the given operation status.
     */
    public com.oracle.bmc.cloudmigrations.model.OperationStatus getStatus() {
        return status;
    }
    /**
     * A filter to return only resources where the resource's lifecycle state matches the given operation type.
     */
    private com.oracle.bmc.cloudmigrations.model.OperationType operationType;

    /**
     * A filter to return only resources where the resource's lifecycle state matches the given operation type.
     */
    public com.oracle.bmc.cloudmigrations.model.OperationType getOperationType() {
    ...
    public static class Builder
         ...
         * A filter to return only resources where the resource's lifecycle state matches the given operation status.
         */
        private com.oracle.bmc.cloudmigrations.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.cloudmigrations.model.OperationStatus status) {
            this.status = status;
            return this;
        }
         ...
         * A filter to return only resources where the resource's lifecycle state matches the given operation type.
         */
        private com.oracle.bmc.cloudmigrations.model.OperationType operationType = null;
        ...
        public Builder operationType(
                com.oracle.bmc.cloudmigrations.model.OperationType operationType) {
        ...
        public ListWorkRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWorkRequestsRequest(compartmentId, workRequestId, status, operationType, resourceId, opcRequestId, page, limit, sortOrder, sortBy);
        }
    }
