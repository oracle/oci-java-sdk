...
public class CreateReplicationScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder replicationSchedule(
                com.oracle.bmc.cloudmigrations.model.ReplicationSchedule replicationSchedule) {
            this.replicationSchedule = replicationSchedule;
            return this;
        }
        ...
        public Builder copy(CreateReplicationScheduleResponse o) {
            ...
            replicationSchedule(o.getReplicationSchedule());
    ...
    public String toString() {
        ...
        sb.append(",replicationSchedule=").append(String.valueOf(replicationSchedule));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateReplicationScheduleResponse)) {
            return false;
        }

        CreateReplicationScheduleResponse other = (CreateReplicationScheduleResponse) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.replicationSchedule, other.replicationSchedule);
    }
        ...
        result =
                (result * PRIME)
                        + (this.replicationSchedule == null
                                ? 43
                                : this.replicationSchedule.hashCode());
        return result;
    }
}
