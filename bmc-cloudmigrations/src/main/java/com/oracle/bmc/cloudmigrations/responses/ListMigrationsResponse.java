...
public class ListMigrationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code MigrationCollection} instance. */
    private com.oracle.bmc.cloudmigrations.model.MigrationCollection migrationCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudmigrations.model.MigrationCollection getMigrationCollection() {
    ...
    private ListMigrationsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.cloudmigrations.model.MigrationCollection migrationCollection) {
    ...
    public static class Builder
         ...
         * The returned {@code MigrationCollection} instance.
         *
         * @param migrationCollection the value to set
         * @return this builder
         */
        ...
        public Builder copy(ListMigrationsResponse o) {
            ...
            migrationCollection(o.getMigrationCollection());
        ...
        public ListMigrationsResponse build() {
            return new ListMigrationsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, migrationCollection);
        }
    }
