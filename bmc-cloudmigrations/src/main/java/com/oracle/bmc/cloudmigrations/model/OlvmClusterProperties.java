...
public final class OlvmClusterProperties
    ...
    /** FIPS mode of the cluster. */
    public enum FipsMode implements com.oracle.bmc.http.internal.BmcEnum {
        Disabled("DISABLED"),
        Enabled("ENABLED"),
        Undefined("UNDEFINED"),
        ;
    ...
    /** The type of firewall to be used on hosts in this cluster. */
    public enum FirewallType implements com.oracle.bmc.http.internal.BmcEnum {
        Firewalld("FIREWALLD"),
        Iptables("IPTABLES"),
        ;
    ...
    /** The memory consumption threshold type for logging audit log events. */
    public enum LogMaxMemoryUsedThresholdType implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    /** Describes all switch types supported by the Manager */
    public enum SwitchType implements com.oracle.bmc.http.internal.BmcEnum {
        Legacy("LEGACY"),
        Ovs("OVS"),
        ;
