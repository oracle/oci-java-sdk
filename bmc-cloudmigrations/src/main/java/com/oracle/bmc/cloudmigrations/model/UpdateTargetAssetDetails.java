...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = UpdateTargetAssetDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateVmTargetAssetDetails.class,
        name = "INSTANCE"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateOlvmTargetAssetDetails.class,
        name = "OLVM_INSTANCE"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class UpdateTargetAssetDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isExcludedFromExecution"})
    protected UpdateTargetAssetDetails(Boolean isExcludedFromExecution) {
        super();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetAssetDetails)) {
            return false;
        }

        UpdateTargetAssetDetails other = (UpdateTargetAssetDetails) o;
        return java.util.Objects.equals(this.isExcludedFromExecution, other.isExcludedFromExecution)
                && super.equals(other);
    }
