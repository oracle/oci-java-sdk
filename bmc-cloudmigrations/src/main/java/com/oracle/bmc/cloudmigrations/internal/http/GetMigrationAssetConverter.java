...
public class GetMigrationAssetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMigrationAssetConverter.class);

    public static com.oracle.bmc.cloudmigrations.requests.GetMigrationAssetRequest interceptRequest(
            com.oracle.bmc.cloudmigrations.requests.GetMigrationAssetRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cloudmigrations.responses
                                        .GetMigrationAssetResponse>() {
                            @Override
                            public com.oracle.bmc.cloudmigrations.responses
                                            .GetMigrationAssetResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudmigrations.responses.GetMigrationAssetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.cloudmigrations.responses.GetMigrationAssetResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.cloudmigrations.responses
                                                        .GetMigrationAssetResponse.builder()
