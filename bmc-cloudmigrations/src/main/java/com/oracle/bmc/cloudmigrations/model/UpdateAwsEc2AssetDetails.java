...
/**
 * The information of AWS VM asset to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAwsEc2AssetDetails.Builder.class)
...
public final class UpdateAwsEc2AssetDetails extends UpdateAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateAwsEc2AssetDetails build() {
            UpdateAwsEc2AssetDetails model =
                    new UpdateAwsEc2AssetDetails(
                            this.displayName,
                            this.assetSourceIds,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAwsEc2AssetDetails model) {
    ...
    @Deprecated
    public UpdateAwsEc2AssetDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAwsEc2AssetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAwsEc2AssetDetails)) {
            return false;
        }

        UpdateAwsEc2AssetDetails other = (UpdateAwsEc2AssetDetails) o;
