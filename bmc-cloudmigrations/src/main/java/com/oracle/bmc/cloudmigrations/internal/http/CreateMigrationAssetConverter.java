...
public class CreateMigrationAssetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateMigrationAssetConverter.class);

    public static com.oracle.bmc.cloudmigrations.requests.CreateMigrationAssetRequest
            interceptRequest(
                    com.oracle.bmc.cloudmigrations.requests.CreateMigrationAssetRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220919").path("migrationAssets");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.cloudmigrations.responses.CreateMigrationAssetResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cloudmigrations.responses
                                        .CreateMigrationAssetResponse>() {
                            @Override
                            public com.oracle.bmc.cloudmigrations.responses
                                            .CreateMigrationAssetResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudmigrations.responses.CreateMigrationAssetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.cloudmigrations.responses
                                                .CreateMigrationAssetResponse.Builder
                                        builder =
                                                com.oracle.bmc.cloudmigrations.responses
                                                        .CreateMigrationAssetResponse.builder()
