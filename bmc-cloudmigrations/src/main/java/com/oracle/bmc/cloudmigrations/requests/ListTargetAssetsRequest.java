...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudmigrations/ListTargetAssetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTargetAssetsRequest.
 */
...
public class ListTargetAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListTargetAssetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTargetAssetsRequest(migrationPlanId, displayName, targetAssetId, limit, page, lifecycleState, sortOrder, sortBy, opcRequestId);
        }
    }
