...
/**
 * Summary of an OLVM asset source provided in the list. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OlvmAssetSourceSummary.Builder.class)
...
public final class OlvmAssetSourceSummary extends AssetSourceSummary {
    ...
    public static class Builder {
        ...
        public OlvmAssetSourceSummary build() {
            OlvmAssetSourceSummary model =
                    new OlvmAssetSourceSummary(
                            this.id,
                            this.compartmentId,
                            this.environmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OlvmAssetSourceSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OlvmAssetSourceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OlvmAssetSourceSummary)) {
            return false;
        }

        OlvmAssetSourceSummary other = (OlvmAssetSourceSummary) o;
