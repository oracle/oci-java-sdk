...
public class GetMigrationAssetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetMigrationAssetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetMigrationAssetResponse> {
         ...
         */
        @Override
        public Builder copy(GetMigrationAssetResponse o) {
         ...
         */
        @Override
        public GetMigrationAssetResponse build() {
            return new GetMigrationAssetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMigrationAssetResponse)) {
            return false;
        }

        GetMigrationAssetResponse other = (GetMigrationAssetResponse) o;
