...
public class TargetAssetSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    private final MigrationAssetSummary migrationAsset;

    public MigrationAssetSummary getMigrationAsset() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetAssetSummary)) {
            return false;
        }

        TargetAssetSummary other = (TargetAssetSummary) o;
