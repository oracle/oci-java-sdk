...
public class GetReplicationProgressResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder replicationProgress(
                com.oracle.bmc.cloudmigrations.model.ReplicationProgress replicationProgress) {
            this.replicationProgress = replicationProgress;
            return this;
        }
        ...
        public Builder copy(GetReplicationProgressResponse o) {
            ...
            replicationProgress(o.getReplicationProgress());
    ...
    public String toString() {
        ...
        sb.append(",replicationProgress=").append(String.valueOf(replicationProgress));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetReplicationProgressResponse)) {
            return false;
        }

        GetReplicationProgressResponse other = (GetReplicationProgressResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.replicationProgress, other.replicationProgress);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.replicationProgress == null
                                ? 43
                                : this.replicationProgress.hashCode());
        return result;
    }
}
