...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VmAsset.Builder.class)
...
public final class VmAsset extends Asset {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VmAsset model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VmAsset)) {
            return false;
        }

        VmAsset other = (VmAsset) o;
