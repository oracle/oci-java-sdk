...
/**
 * Logical unit of the host storage. <br>
...
public final class LogicalUnit extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The maximum number of bytes that can be discarded by the logical unit???s underlying
        ...
        /**
         * True, if previously discarded blocks in the logical unit???s underlying storage are read
         * back as zeros.
         */
    ...
    /**
     * The maximum number of bytes that can be discarded by the logical unit???s underlying storage
    ...
    /**
     * True, if previously discarded blocks in the logical unit???s underlying storage are read back
     * as zeros.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isDiscardZeroesData")
    ...
    /** LUN Status */
    public enum LunStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Free("FREE"),
        Unusable("UNUSABLE"),
        Used("USED"),
        ;
