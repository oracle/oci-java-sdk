...
/**
 * VMware asset source. Used for discovery of virtual machines (VMs) registered in the VMware
 * vCenter installation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VmWareAssetSource.Builder.class)
...
public final class VmWareAssetSource extends AssetSource {
    ...
    public static class Builder {
        ...
        public VmWareAssetSource build() {
            VmWareAssetSource model =
                    new VmWareAssetSource(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.environmentId,
    ...
    public boolean equals(Object o) {
        ...
        VmWareAssetSource other = (VmWareAssetSource) o;
