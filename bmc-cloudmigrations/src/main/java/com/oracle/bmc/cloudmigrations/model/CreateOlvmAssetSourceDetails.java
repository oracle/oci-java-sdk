...
/**
 * OLVM asset source creation request. <br>
...
public final class CreateOlvmAssetSourceDetails extends CreateAssetSourceDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOlvmAssetSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOlvmAssetSourceDetails)) {
            return false;
        }

        CreateOlvmAssetSourceDetails other = (CreateOlvmAssetSourceDetails) o;
