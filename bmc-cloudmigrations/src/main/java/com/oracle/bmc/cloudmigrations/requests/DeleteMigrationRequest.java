...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudmigrations/DeleteMigrationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMigrationRequest.
 */
...
public class DeleteMigrationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public DeleteMigrationRequest build() {
            DeleteMigrationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMigrationRequest
         */
        public DeleteMigrationRequest buildWithoutInvocationCallback() {
            DeleteMigrationRequest request = new DeleteMigrationRequest();
            request.migrationId = migrationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteMigrationRequest(migrationId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().migrationId(migrationId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMigrationRequest)) {
            return false;
        }

        DeleteMigrationRequest other = (DeleteMigrationRequest) o;
