...
/**
 * Description of the OLVM target asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOlvmTargetAssetDetails.Builder.class)
...
public final class UpdateOlvmTargetAssetDetails extends UpdateTargetAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateOlvmTargetAssetDetails build() {
            UpdateOlvmTargetAssetDetails model =
                    new UpdateOlvmTargetAssetDetails(this.isExcludedFromExecution, this.msLicense);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOlvmTargetAssetDetails model) {
    ...
    @Deprecated
    public UpdateOlvmTargetAssetDetails(Boolean isExcludedFromExecution, String msLicense) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOlvmTargetAssetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOlvmTargetAssetDetails)) {
            return false;
        }

        UpdateOlvmTargetAssetDetails other = (UpdateOlvmTargetAssetDetails) o;
