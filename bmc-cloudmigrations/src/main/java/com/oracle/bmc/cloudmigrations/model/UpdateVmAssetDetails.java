...
/**
 * The information of VM asset to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateVmAssetDetails.Builder.class)
...
public final class UpdateVmAssetDetails extends UpdateAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateVmAssetDetails build() {
            UpdateVmAssetDetails model =
                    new UpdateVmAssetDetails(
                            this.displayName,
                            this.assetSourceIds,
                            this.freeformTags,
                            this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVmAssetDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateVmAssetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVmAssetDetails)) {
            return false;
        }

        UpdateVmAssetDetails other = (UpdateVmAssetDetails) o;
