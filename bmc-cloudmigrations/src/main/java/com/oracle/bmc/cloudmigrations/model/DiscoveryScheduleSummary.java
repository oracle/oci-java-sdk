...
/**
 * Summarized information about a discovery schedule. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DiscoveryScheduleSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DiscoveryScheduleSummary
    ...
    public DiscoveryScheduleSummary(
            String id,
            String displayName,
    ...
    public static class Builder {
        ...
        private DiscoveryScheduleLifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(DiscoveryScheduleLifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public DiscoveryScheduleSummary build() {
            DiscoveryScheduleSummary model =
                    new DiscoveryScheduleSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveryScheduleSummary model) {
    ...
    /** Current state of the discovery schedule. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final DiscoveryScheduleLifecycleState lifecycleState;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveryScheduleSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveryScheduleSummary)) {
            return false;
        }

        DiscoveryScheduleSummary other = (DiscoveryScheduleSummary) o;
