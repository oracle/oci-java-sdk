...
public final class LaunchInstanceAgentConfigDetails
    ...
    public static class Builder {
         ...
         * the monitoring plugins. By default, the value is false (monitoring plugins are enabled).
         *
         ...
         *
         * <p>- If {@code isMonitoringDisabled} is true, all the monitoring plugins are disabled,
        ...
        /**
         * Whether Oracle Cloud Agent can run all the available management plugins. By default, the
         ...
         * command.
         *
         * <p>The management plugins are controlled by this parameter and the per-plugin
         * configuration in the {@code pluginsConfig} object.
         *
         * <p>- If {@code isManagementDisabled} is true, all the management plugins are disabled,
     ...
     * the monitoring plugins are enabled. You can optionally disable individual monitoring plugins
     * by providing a value in the {@code pluginsConfig} object.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isMonitoringDisabled")
     ...
     * command.
     *
     * <p>The management plugins are controlled by this parameter and the per-plugin configuration
     * in the {@code pluginsConfig} object.
     *
     * <p>- If {@code isManagementDisabled} is true, all the management plugins are disabled,
     * regardless of the per-plugin configuration. - If {@code isManagementDisabled} is false, all
     * the management plugins are enabled. You can optionally disable individual management plugins
     * by providing a value in the {@code pluginsConfig} object.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isManagementDisabled")
