...
public final class CreateVnicDetails
    ...
    public static class Builder {
         ...
         * of the subnet to create the VNIC. When launching an instance, use this {@code subnetId}
     ...
     * the subnet to create the VNIC. When launching an instance, use this {@code subnetId} instead
