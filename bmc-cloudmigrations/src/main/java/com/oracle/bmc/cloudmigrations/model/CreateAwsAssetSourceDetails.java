...
/**
 * AWS asset source creation request. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAwsAssetSourceDetails.Builder.class)
...
public final class CreateAwsAssetSourceDetails extends CreateAssetSourceDetails {
    ...
    public static class Builder {
        ...
        public CreateAwsAssetSourceDetails build() {
            CreateAwsAssetSourceDetails model =
                    new CreateAwsAssetSourceDetails(
                            this.displayName,
                            this.compartmentId,
                            this.environmentId,
                            this.inventoryId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAwsAssetSourceDetails model) {
    ...
    @Deprecated
    public CreateAwsAssetSourceDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAwsAssetSourceDetails)) {
            return false;
        }

        CreateAwsAssetSourceDetails other = (CreateAwsAssetSourceDetails) o;
