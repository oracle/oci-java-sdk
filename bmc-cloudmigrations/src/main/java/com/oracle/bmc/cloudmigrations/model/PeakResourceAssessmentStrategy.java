...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PeakResourceAssessmentStrategy.Builder.class)
...
public final class PeakResourceAssessmentStrategy extends ResourceAssessmentStrategy {
    ...
    public static class Builder {
        ...
        public PeakResourceAssessmentStrategy build() {
            PeakResourceAssessmentStrategy model =
                    new PeakResourceAssessmentStrategy(
                            this.resourceType,
    ...
    @Deprecated
    public PeakResourceAssessmentStrategy(
    ...
    public boolean equals(Object o) {
        ...
        PeakResourceAssessmentStrategy other = (PeakResourceAssessmentStrategy) o;
