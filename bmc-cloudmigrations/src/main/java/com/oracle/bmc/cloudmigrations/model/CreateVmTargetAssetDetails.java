...
public final class CreateVmTargetAssetDetails extends CreateTargetAssetDetails {
    ...
    public static class Builder {
        ...
        public CreateVmTargetAssetDetails build() {
            CreateVmTargetAssetDetails model =
                    new CreateVmTargetAssetDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateVmTargetAssetDetails model) {
    ...
    @Deprecated
    public CreateVmTargetAssetDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateVmTargetAssetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVmTargetAssetDetails)) {
            return false;
        }

        CreateVmTargetAssetDetails other = (CreateVmTargetAssetDetails) o;
