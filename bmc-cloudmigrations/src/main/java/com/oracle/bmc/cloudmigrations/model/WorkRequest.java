...
/**
 * A description of a work request status. <br>
...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * scoped to the same compartment as the resource that is affected by the work request. If
         * the work request affects multiple resources, and these resources are not in the same
         * compartment, the service team can choose the primary resource of the compartment to be
         * used.
         */
     ...
     * the same compartment as the resource that is affected by the work request. If the work
     * request affects multiple resources, and these resources are not in the same compartment, the
     * service team can choose the primary resource of the compartment to be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
