...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudmigrations/UpdateReplicationScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateReplicationScheduleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220919")
public class UpdateReplicationScheduleRequest
     ...
     */
    private com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails
            updateReplicationScheduleDetails;

    /**
     * The information to be updated.
     */
    public com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails
    ...
    public com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails getBody$() {
        return updateReplicationScheduleDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails
                updateReplicationScheduleDetails = null;

        /**
         * The information to be updated.
         * @param updateReplicationScheduleDetails the value to set
         * @return this builder instance
         */
        public Builder updateReplicationScheduleDetails(
                com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails
                        updateReplicationScheduleDetails) {
            this.updateReplicationScheduleDetails = updateReplicationScheduleDetails;
            return this;
        }
        ...
        /**
         * Build the instance of UpdateReplicationScheduleRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateReplicationScheduleRequest
         */
        public UpdateReplicationScheduleRequest build() {
            UpdateReplicationScheduleRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.cloudmigrations.model.UpdateReplicationScheduleDetails body) {
            updateReplicationScheduleDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateReplicationScheduleRequest
         */
        public UpdateReplicationScheduleRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReplicationScheduleRequest)) {
            return false;
        }

        UpdateReplicationScheduleRequest other = (UpdateReplicationScheduleRequest) o;
