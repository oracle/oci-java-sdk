...
/**
 * The information of VMware VM asset to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateVmwareVmAssetDetails.Builder.class)
...
public final class UpdateVmwareVmAssetDetails extends UpdateAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateVmwareVmAssetDetails build() {
            UpdateVmwareVmAssetDetails model =
                    new UpdateVmwareVmAssetDetails(
                            this.displayName,
                            this.assetSourceIds,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVmwareVmAssetDetails model) {
    ...
    @Deprecated
    public UpdateVmwareVmAssetDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVmwareVmAssetDetails)) {
            return false;
        }

        UpdateVmwareVmAssetDetails other = (UpdateVmwareVmAssetDetails) o;
