...
public class ListTargetAssetsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder targetAssetCollection(
                com.oracle.bmc.cloudmigrations.model.TargetAssetCollection targetAssetCollection) {
            this.targetAssetCollection = targetAssetCollection;
            return this;
        }
        ...
        public Builder copy(ListTargetAssetsResponse o) {
            ...
            targetAssetCollection(o.getTargetAssetCollection());
    ...
    public String toString() {
        ...
        sb.append(",targetAssetCollection=").append(String.valueOf(targetAssetCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTargetAssetsResponse)) {
            return false;
        }

        ListTargetAssetsResponse other = (ListTargetAssetsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.targetAssetCollection, other.targetAssetCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.targetAssetCollection == null
                                ? 43
                                : this.targetAssetCollection.hashCode());
        return result;
    }
}
