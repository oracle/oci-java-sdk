...
/**
 * A resource that is created and operated by a work request. <br>
...
public final class WorkRequestResource
    ...
    public static class Builder {
        ...
        /**
         * The way in which this resource is affected by the work is tracked in the work request. A
         * resource being created, updated, or deleted will remain in the IN_PROGRESS state until
         * work is complete for that resource. At this point, it transitions to CREATED, UPDATED, or
     ...
     * is complete for that resource. At this point, it transitions to CREATED, UPDATED, or DELETED,
     * respectively.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("actionType")
