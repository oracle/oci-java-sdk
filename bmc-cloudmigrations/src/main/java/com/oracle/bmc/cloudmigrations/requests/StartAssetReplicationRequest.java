...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudmigrations/StartAssetReplicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartAssetReplicationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220919")
public class StartAssetReplicationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    StartAssetReplicationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(StartAssetReplicationRequest o) {
         ...
         *
         * @return instance of StartAssetReplicationRequest
         */
        public StartAssetReplicationRequest build() {
            StartAssetReplicationRequest request = buildWithoutInvocationCallback();
        ...
        public StartAssetReplicationRequest buildWithoutInvocationCallback() {
            StartAssetReplicationRequest request = new StartAssetReplicationRequest();
            request.migrationAssetId = migrationAssetId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new StartAssetReplicationRequest(migrationAssetId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartAssetReplicationRequest)) {
            return false;
        }

        StartAssetReplicationRequest other = (StartAssetReplicationRequest) o;
