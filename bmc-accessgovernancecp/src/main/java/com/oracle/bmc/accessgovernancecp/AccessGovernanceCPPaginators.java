 ...
 * to any list operations of AccessGovernanceCP where multiple pages of data may be fetched. Two
...
public class AccessGovernanceCPPaginators {
     ...
     * listGovernanceInstances operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.accessgovernancecp.model.GovernanceInstanceSummary} objects contained in
     * responses from the listGovernanceInstances operation. This iterable will fetch more data from
