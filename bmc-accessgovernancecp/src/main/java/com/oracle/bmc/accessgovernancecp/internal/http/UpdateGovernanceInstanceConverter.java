...
public class UpdateGovernanceInstanceConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateGovernanceInstanceConverter.class);

    public static com.oracle.bmc.accessgovernancecp.requests.UpdateGovernanceInstanceRequest
            interceptRequest(
                    com.oracle.bmc.accessgovernancecp.requests.UpdateGovernanceInstanceRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.accessgovernancecp.requests.UpdateGovernanceInstanceRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.accessgovernancecp.responses.UpdateGovernanceInstanceResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.accessgovernancecp.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.accessgovernancecp.responses.UpdateGovernanceInstanceResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.accessgovernancecp.responses
                                                .UpdateGovernanceInstanceResponse.Builder
                                        builder =
                                                com.oracle.bmc.accessgovernancecp.responses
                                                        .UpdateGovernanceInstanceResponse.builder()
                                ...
                                builder.governanceInstance(response.getItem());
