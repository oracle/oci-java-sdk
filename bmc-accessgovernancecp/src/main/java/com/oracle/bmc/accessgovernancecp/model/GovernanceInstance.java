...
public final class GovernanceInstance extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GovernanceInstance model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GovernanceInstance)) {
            return false;
        }

        GovernanceInstance other = (GovernanceInstance) o;
