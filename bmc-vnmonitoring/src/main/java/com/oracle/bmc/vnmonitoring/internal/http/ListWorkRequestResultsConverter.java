...
public class ListWorkRequestResultsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListWorkRequestResultsConverter.class);

    public static com.oracle.bmc.vnmonitoring.requests.ListWorkRequestResultsRequest
            interceptRequest(
                    com.oracle.bmc.vnmonitoring.requests.ListWorkRequestResultsRequest request) {
        ...
        if (request.getResultType() != null) {
            target =
                    target.queryParam(
                            "resultType",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getResultType().getValue()));
        }
