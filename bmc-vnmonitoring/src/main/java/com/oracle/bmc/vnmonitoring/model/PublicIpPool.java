 ...
 * Resources like load balancers and compute instances can be allocated public IP addresses from a
 * public IP pool. <br>
...
public final class PublicIpPool extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         * of the compartment containing this pool.
         */
     ...
     * the compartment containing this pool.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublicIpPool)) {
            return false;
        }

        PublicIpPool other = (PublicIpPool) o;
        return java.util.Objects.equals(this.cidrBlocks, other.cidrBlocks)
