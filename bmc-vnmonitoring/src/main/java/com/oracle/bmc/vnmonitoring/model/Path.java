...
/**
 * Defines the configuration of the traffic path in {@code PathAnalysisResult}. <br>
...
public final class Path extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
