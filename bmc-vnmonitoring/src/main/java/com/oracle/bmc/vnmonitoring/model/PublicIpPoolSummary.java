...
public final class PublicIpPoolSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private PublicIpPool.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(PublicIpPool.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public PublicIpPoolSummary build() {
            PublicIpPoolSummary model =
                    new PublicIpPoolSummary(
                            this.compartmentId,
                            this.definedTags,
                            this.displayName,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PublicIpPoolSummary model) {
