...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = StatefulIngressSecurityListConfiguration.Builder.class
)
...
public final class StatefulIngressSecurityListConfiguration extends AllowedSecurityConfiguration {
    ...
    public static class Builder {
        ...
        private EgressSecurityRule securityRule;

        public Builder securityRule(EgressSecurityRule securityRule) {
        ...
        public StatefulIngressSecurityListConfiguration build() {
            StatefulIngressSecurityListConfiguration __instance__ =
                    new StatefulIngressSecurityListConfiguration(securityListId, securityRule);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StatefulIngressSecurityListConfiguration o) {
    ...
    @Deprecated
    public StatefulIngressSecurityListConfiguration(
            String securityListId, EgressSecurityRule securityRule) {
        super();
        this.securityListId = securityListId;
        this.securityRule = securityRule;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("securityRule")
    private final EgressSecurityRule securityRule;

    public EgressSecurityRule getSecurityRule() {
        return securityRule;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StatefulIngressSecurityListConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StatefulIngressSecurityListConfiguration)) {
            return false;
        }

        StatefulIngressSecurityListConfiguration other =
                (StatefulIngressSecurityListConfiguration) o;
