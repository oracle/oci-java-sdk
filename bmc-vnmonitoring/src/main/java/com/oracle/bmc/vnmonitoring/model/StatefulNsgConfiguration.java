...
/**
 * Defines the stateful network security group configuration that allowed the traffic. <br>
...
public final class StatefulNsgConfiguration extends AllowedSecurityConfiguration {
    ...
    public static class Builder {
        ...
        public StatefulNsgConfiguration build() {
            StatefulNsgConfiguration model =
                    new StatefulNsgConfiguration(this.nsgId, this.securityRule);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StatefulNsgConfiguration model) {
