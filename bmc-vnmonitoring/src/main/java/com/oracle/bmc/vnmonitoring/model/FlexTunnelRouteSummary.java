...
/**
 * A summary of the routes advertised to and received from the SD-WAN. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FlexTunnelRouteSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FlexTunnelRouteSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"prefix", "age", "isBestPath", "asPath", "advertiser"})
    public FlexTunnelRouteSummary(
            String prefix,
            Long age,
            Boolean isBestPath,
    ...
    public static class Builder {
        ...
        public FlexTunnelRouteSummary build() {
            FlexTunnelRouteSummary model =
                    new FlexTunnelRouteSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FlexTunnelRouteSummary model) {
    ...
    public enum Advertiser implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static Advertiser create(String key) {
            ...
            throw new IllegalArgumentException("Invalid Advertiser: " + key);
        }
    };
    /** The source of the route advertisement. */
    @com.fasterxml.jackson.annotation.JsonProperty("advertiser")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FlexTunnelRouteSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlexTunnelRouteSummary)) {
            return false;
        }

        FlexTunnelRouteSummary other = (FlexTunnelRouteSummary) o;
