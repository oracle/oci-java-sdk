...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ZprCidrUnsupportedSecurityActionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ZprCidrUnsupportedSecurityActionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRestrictedOrPartial", "evaluatedZprPolicies"})
    public ZprCidrUnsupportedSecurityActionDetails(
    ...
    public static class Builder {
        ...
        public ZprCidrUnsupportedSecurityActionDetails build() {
            ZprCidrUnsupportedSecurityActionDetails model =
                    new ZprCidrUnsupportedSecurityActionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ZprCidrUnsupportedSecurityActionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ZprCidrUnsupportedSecurityActionDetails)) {
            return false;
        }

        ZprCidrUnsupportedSecurityActionDetails other = (ZprCidrUnsupportedSecurityActionDetails) o;
