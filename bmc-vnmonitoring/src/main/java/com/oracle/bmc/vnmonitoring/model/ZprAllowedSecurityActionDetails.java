...
/**
 * Defines details for the security action taken on zpr allowed traffic. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ZprAllowedSecurityActionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ZprAllowedSecurityActionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRestrictedOrPartial", "allowedSecurityConfiguration"})
    public ZprAllowedSecurityActionDetails(
    ...
    public static class Builder {
        ...
        public ZprAllowedSecurityActionDetails build() {
            ZprAllowedSecurityActionDetails model =
                    new ZprAllowedSecurityActionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ZprAllowedSecurityActionDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ZprAllowedSecurityActionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ZprAllowedSecurityActionDetails)) {
            return false;
        }

        ZprAllowedSecurityActionDetails other = (ZprAllowedSecurityActionDetails) o;
