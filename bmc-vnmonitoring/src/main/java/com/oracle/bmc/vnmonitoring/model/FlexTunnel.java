 ...
 * establish BGP and advertise routes. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FlexTunnel.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FlexTunnel extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The date and time the flex tunnel was created, in the format defined by
        ...
        private FlexTunnelConfiguration flexTunnelConfiguration;

        public Builder flexTunnelConfiguration(FlexTunnelConfiguration flexTunnelConfiguration) {
            this.flexTunnelConfiguration = flexTunnelConfiguration;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FlexTunnel model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("flexTunnelConfiguration")
    private final FlexTunnelConfiguration flexTunnelConfiguration;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlexTunnel)) {
            return false;
        }

        FlexTunnel other = (FlexTunnel) o;
