...
public final class UpdateInternetGatewayDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateInternetGatewayDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateInternetGatewayDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateInternetGatewayDetails)) {
            return false;
        }

        UpdateInternetGatewayDetails other = (UpdateInternetGatewayDetails) o;
