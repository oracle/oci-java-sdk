...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = FlexTunnelBgpSession.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class FlexTunnelBgpSession extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public FlexTunnelBgpSession build() {
            FlexTunnelBgpSession model =
                    new FlexTunnelBgpSession(
                            this.customerBgpAsn,
                            this.oracleBgpAsn,
                            this.customerBgpIp,
                            this.oracleBgpIp,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FlexTunnelBgpSession model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FlexTunnelBgpSession(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlexTunnelBgpSession)) {
            return false;
        }

        FlexTunnelBgpSession other = (FlexTunnelBgpSession) o;
