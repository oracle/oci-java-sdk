...
public interface VnMonitoringAsync extends AutoCloseable {
     ...
     * <p>
     * If the work request status is successful, use {@link #listWorkRequestResults(ListWorkRequestResultsRequest, Consumer, Consumer) listWorkRequestResults}
     * with the work request ID to ask for the successful analysis results. If the work request status is failed, use
     * {@link #listWorkRequestErrors(ListWorkRequestErrorsRequest, Consumer, Consumer) listWorkRequestErrors}
