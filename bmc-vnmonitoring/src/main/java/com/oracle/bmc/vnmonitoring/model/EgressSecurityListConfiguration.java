...
/**
 * Defines the subnet egress security list configuration that allowed the traffic. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EgressSecurityListConfiguration.Builder.class)
...
public final class EgressSecurityListConfiguration extends AllowedSecurityConfiguration {
    ...
    @Deprecated
    public EgressSecurityListConfiguration(String securityListId, EgressSecurityRule securityRule) {
        super();
        this.securityListId = securityListId;
        this.securityRule = securityRule;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EgressSecurityListConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgressSecurityListConfiguration)) {
            return false;
        }
