...
/**
 * Defines the configuration for TCP protocol parameters. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TcpProtocolParameters.Builder.class)
...
public final class TcpProtocolParameters extends ProtocolParameters {
    ...
    public static class Builder {
        ...
        public TcpProtocolParameters build() {
            TcpProtocolParameters model =
                    new TcpProtocolParameters(this.sourcePort, this.destinationPort);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TcpProtocolParameters model) {
    ...
    @Deprecated
    public TcpProtocolParameters(Integer sourcePort, Integer destinationPort) {
        super();
        this.sourcePort = sourcePort;
        this.destinationPort = destinationPort;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TcpProtocolParameters)) {
            return false;
        }

        TcpProtocolParameters other = (TcpProtocolParameters) o;
