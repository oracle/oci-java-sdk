...
/**
 * Defines the {@code contains} relationship between virtual network topology entities. A {@code
 * Contains} relationship is defined when an entity fully owns, contains or manages another entity.
 * For example, a subnet is contained and managed in the scope of a VCN, therefore a VCN has a
 * {@code contains} relationship to a subnet. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TopologyContainsEntityRelationship.Builder.class)
...
public final class TopologyContainsEntityRelationship extends TopologyEntityRelationship {
    ...
    @Deprecated
    public TopologyContainsEntityRelationship(String id1, String id2) {
        super(id1, id2);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TopologyContainsEntityRelationship)) {
            return false;
        }
