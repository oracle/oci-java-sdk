...
/**
 * Defines details for the security action taken on zpr unsupported traffic. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ZprNsgUnsupportedSecurityActionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ZprNsgUnsupportedSecurityActionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRestrictedOrPartial", "evaluatedZprPolicies"})
    public ZprNsgUnsupportedSecurityActionDetails(
    ...
    public static class Builder {
        ...
        public ZprNsgUnsupportedSecurityActionDetails build() {
            ZprNsgUnsupportedSecurityActionDetails model =
                    new ZprNsgUnsupportedSecurityActionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ZprNsgUnsupportedSecurityActionDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ZprNsgUnsupportedSecurityActionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ZprNsgUnsupportedSecurityActionDetails)) {
            return false;
        }

        ZprNsgUnsupportedSecurityActionDetails other = (ZprNsgUnsupportedSecurityActionDetails) o;
