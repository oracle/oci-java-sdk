...
public final class IngressSecurityListConfiguration extends AllowedSecurityConfiguration {
    ...
    public static class Builder {
        ...
        public IngressSecurityListConfiguration build() {
            IngressSecurityListConfiguration model =
                    new IngressSecurityListConfiguration(this.securityListId, this.securityRule);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressSecurityListConfiguration model) {
