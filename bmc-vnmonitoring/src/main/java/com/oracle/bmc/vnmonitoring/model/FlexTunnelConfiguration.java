...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "tunnelType",
    defaultImpl = FlexTunnelConfiguration.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = GreFlexTunnelConfiguration.class,
        name = "GRE"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class FlexTunnelConfiguration extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"customerTunnelIp", "oracleTunnelIp", "bgpSession"})
    protected FlexTunnelConfiguration(
    ...
    private final FlexTunnelBgpSession bgpSession;

    public FlexTunnelBgpSession getBgpSession() {
        return bgpSession;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FlexTunnelConfiguration)) {
            return false;
        }

        FlexTunnelConfiguration other = (FlexTunnelConfiguration) o;
