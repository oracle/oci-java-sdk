...
/**
 * Defines the details required for a NETWORK_LOAD_BALANCER_LISTENER-type {@code Endpoint}. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkLoadBalancerListenerEndpoint.Builder.class)
...
public final class NetworkLoadBalancerListenerEndpoint extends Endpoint {
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the
         * listener's network load balancer.
         */
        ...
        public NetworkLoadBalancerListenerEndpoint build() {
            NetworkLoadBalancerListenerEndpoint model =
                    new NetworkLoadBalancerListenerEndpoint(
                            this.listenerId, this.networkLoadBalancerId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkLoadBalancerListenerEndpoint model) {
    ...
    @Deprecated
    public NetworkLoadBalancerListenerEndpoint(String listenerId, String networkLoadBalancerId) {
        super();
        this.listenerId = listenerId;
        this.networkLoadBalancerId = networkLoadBalancerId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NetworkLoadBalancerListenerEndpoint(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkLoadBalancerListenerEndpoint)) {
            return false;
        }

        NetworkLoadBalancerListenerEndpoint other = (NetworkLoadBalancerListenerEndpoint) o;
