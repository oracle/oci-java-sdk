 ...
 * Addresses](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/ipv6.htm). <br>
...
public final class Ipv6 extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * of the compartment containing the IPv6. This is the same as the VNIC's compartment.
         */
         ...
         * CIDR block of the VNIC's subnet (see the {@code ipv6PublicCidrBlock} attribute for the
         * {@link Subnet} object).
         *
         * <p>If your organization did NOT assign a custom IPv6 CIDR to the VCN for the private
         * address space, Oracle provides the IPv6 CIDR and uses that same CIDR for the private and
         * public address space. Therefore the {@code publicIpAddress} would be the same as the
         * {@code ipAddress}.
         *
         * <p>If your organization assigned a custom IPv6 CIDR to the VCN for the address space, the
         * right 80 bits of the IPv6 IP (the subnet and address bits) are the same as for the {@code
         * ipAddress}. But the left 48 bits are from the IPv6 CIDR that Oracle assigned to the VCN.
         *
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the VNIC the IPv6 is assigned to. The VNIC and IPv6 must be in the same subnet.
         */
     ...
     * the compartment containing the IPv6. This is the same as the VNIC's compartment.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * The IPv6 address to be used for internet communication. The address is within the IPv6 CIDR
     * block of the VNIC's subnet (see the {@code ipv6PublicCidrBlock} attribute for the {@link
     * Subnet} object).
     *
     * <p>If your organization did NOT assign a custom IPv6 CIDR to the VCN for the private address
     * space, Oracle provides the IPv6 CIDR and uses that same CIDR for the private and public
     * address space. Therefore the {@code publicIpAddress} would be the same as the {@code
     * ipAddress}.
     *
     * <p>If your organization assigned a custom IPv6 CIDR to the VCN for the address space, the
     * right 80 bits of the IPv6 IP (the subnet and address bits) are the same as for the {@code
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the VNIC the IPv6 is assigned to. The VNIC and IPv6 must be in the same subnet.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("vnicId")
