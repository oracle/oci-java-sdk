 ...
 * Lists](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securitylists.htm). **Note:**
 * Compare security lists to {@link NetworkSecurityGroup}s, which let you apply a set of security
 ...
 * type of access to an instance, make sure both the security lists associated with the instance's
...
public final class SecurityList extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityList model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityList)) {
            return false;
        }

        SecurityList other = (SecurityList) o;
