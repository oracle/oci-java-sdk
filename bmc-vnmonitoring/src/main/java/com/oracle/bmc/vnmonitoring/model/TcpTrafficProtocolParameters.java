...
/**
 * Defines the {@code TrafficProtocolParameters} configuration for the TCP protocol. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TcpTrafficProtocolParameters.Builder.class)
...
public final class TcpTrafficProtocolParameters extends TrafficProtocolParameters {
    ...
    public static class Builder {
        ...
        public TcpTrafficProtocolParameters build() {
            TcpTrafficProtocolParameters model =
                    new TcpTrafficProtocolParameters(this.sourcePort, this.destinationPort);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TcpTrafficProtocolParameters model) {
    ...
    @Deprecated
    public TcpTrafficProtocolParameters(Integer sourcePort, Integer destinationPort) {
        super();
        this.sourcePort = sourcePort;
        this.destinationPort = destinationPort;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TcpTrafficProtocolParameters(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TcpTrafficProtocolParameters)) {
            return false;
        }

        TcpTrafficProtocolParameters other = (TcpTrafficProtocolParameters) o;
