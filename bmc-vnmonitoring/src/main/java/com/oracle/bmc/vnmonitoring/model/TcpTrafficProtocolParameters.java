...
public final class TcpTrafficProtocolParameters extends TrafficProtocolParameters {
    ...
    public static class Builder {
        ...
        public TcpTrafficProtocolParameters build() {
            TcpTrafficProtocolParameters __instance__ =
                    new TcpTrafficProtocolParameters(sourcePort, destinationPort);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TcpTrafficProtocolParameters o) {
