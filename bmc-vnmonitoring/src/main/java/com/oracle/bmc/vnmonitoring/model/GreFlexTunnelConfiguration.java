...
/**
 * The gre tunnel configuration details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GreFlexTunnelConfiguration.Builder.class)
...
public final class GreFlexTunnelConfiguration extends FlexTunnelConfiguration {
    ...
    public static class Builder {
        ...
        private FlexTunnelBgpSession bgpSession;

        public Builder bgpSession(FlexTunnelBgpSession bgpSession) {
        ...
        public GreFlexTunnelConfiguration build() {
            GreFlexTunnelConfiguration model =
                    new GreFlexTunnelConfiguration(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GreFlexTunnelConfiguration model) {
    ...
    @Deprecated
    public GreFlexTunnelConfiguration(
            String customerTunnelIp, String oracleTunnelIp, FlexTunnelBgpSession bgpSession) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GreFlexTunnelConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GreFlexTunnelConfiguration)) {
            return false;
        }

        GreFlexTunnelConfiguration other = (GreFlexTunnelConfiguration) o;
