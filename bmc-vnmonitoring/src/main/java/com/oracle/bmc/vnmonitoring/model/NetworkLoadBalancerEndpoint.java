...
/**
 * Defines the details required for a NETWORK_LOAD_BALANCER-type {@code Endpoint}. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkLoadBalancerEndpoint.Builder.class)
...
public final class NetworkLoadBalancerEndpoint extends Endpoint {
    ...
    @Deprecated
    public NetworkLoadBalancerEndpoint(String networkLoadBalancerId) {
        super();
        this.networkLoadBalancerId = networkLoadBalancerId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkLoadBalancerEndpoint)) {
            return false;
        }
