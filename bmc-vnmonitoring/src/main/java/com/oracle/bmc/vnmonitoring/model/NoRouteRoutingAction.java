...
/**
 * Defines the routing actions taken on traffic when no route is found. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NoRouteRoutingAction.Builder.class)
...
public final class NoRouteRoutingAction extends RoutingAction {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("noRouteRoutingActionDetails")
        private NoRouteRoutingActionDetails noRouteRoutingActionDetails;

        public Builder noRouteRoutingActionDetails(
    ...
    @Deprecated
    public NoRouteRoutingAction(
            ActionType actionType, NoRouteRoutingActionDetails noRouteRoutingActionDetails) {
        super(actionType);
        this.noRouteRoutingActionDetails = noRouteRoutingActionDetails;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NoRouteRoutingAction)) {
            return false;
        }
