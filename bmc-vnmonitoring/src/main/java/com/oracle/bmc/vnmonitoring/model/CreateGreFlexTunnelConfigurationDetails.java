...
/**
 * The gre tunnel configuration create details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGreFlexTunnelConfigurationDetails.Builder.class)
...
public final class CreateGreFlexTunnelConfigurationDetails
        extends CreateFlexTunnelConfigurationDetails {
    ...
    public static class Builder {
        ...
        private CreateFlexTunnelBgpSessionDetails bgpSession;

        public Builder bgpSession(CreateFlexTunnelBgpSessionDetails bgpSession) {
        ...
        public CreateGreFlexTunnelConfigurationDetails build() {
            CreateGreFlexTunnelConfigurationDetails model =
                    new CreateGreFlexTunnelConfigurationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGreFlexTunnelConfigurationDetails model) {
    ...
    @Deprecated
    public CreateGreFlexTunnelConfigurationDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGreFlexTunnelConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGreFlexTunnelConfigurationDetails)) {
            return false;
        }

        CreateGreFlexTunnelConfigurationDetails other = (CreateGreFlexTunnelConfigurationDetails) o;
