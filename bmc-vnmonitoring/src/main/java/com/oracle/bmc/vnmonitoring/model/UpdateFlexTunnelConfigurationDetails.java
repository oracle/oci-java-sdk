...
/**
 * The update details for tunnel configuration. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "tunnelType",
        defaultImpl = UpdateFlexTunnelConfigurationDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateGreFlexTunnelConfigurationDetails.class,
            name = "GRE")
})
...
public class UpdateFlexTunnelConfigurationDetails
    ...
    protected UpdateFlexTunnelConfigurationDetails(
    ...
    private final UpdateFlexTunnelBgpSessionDetails bgpSession;

    public UpdateFlexTunnelBgpSessionDetails getBgpSession() {
        return bgpSession;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFlexTunnelConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFlexTunnelConfigurationDetails)) {
            return false;
        }

        UpdateFlexTunnelConfigurationDetails other = (UpdateFlexTunnelConfigurationDetails) o;
