...
/**
 * Defines the details saved in a {@code PathAnalyzerTest} resource. These configuration details are
 * used to run a [Network Path
 * Analyzer](https://docs.oracle.com/iaas/Content/Network/Concepts/path_analyzer.htm) analysis. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PathAnalyzerTest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PathAnalyzerTest
    ...
    public static class Builder {
        ...
        public PathAnalyzerTest build() {
            PathAnalyzerTest model =
                    new PathAnalyzerTest(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.protocol,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PathAnalyzerTest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PathAnalyzerTest)) {
            return false;
        }

        PathAnalyzerTest other = (PathAnalyzerTest) o;
