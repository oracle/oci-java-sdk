...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementdashboard/CreateManagementDashboardExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateManagementDashboardRequest.
 */
...
public class CreateManagementDashboardRequest
    ...
    public static class Builder
        ...
        public Builder createManagementDashboardDetails(
                com.oracle.bmc.managementdashboard.model.CreateManagementDashboardDetails
                        createManagementDashboardDetails) {
            this.createManagementDashboardDetails = createManagementDashboardDetails;
            return this;
        }
        ...
        public Builder copy(CreateManagementDashboardRequest o) {
            createManagementDashboardDetails(o.getCreateManagementDashboardDetails());
         ...
         */
        public CreateManagementDashboardRequest build() {
            CreateManagementDashboardRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateManagementDashboardRequest
         */
        public CreateManagementDashboardRequest buildWithoutInvocationCallback() {
            CreateManagementDashboardRequest request = new CreateManagementDashboardRequest();
            request.createManagementDashboardDetails = createManagementDashboardDetails;
    ...
    public String toString() {
        ...
        sb.append(",createManagementDashboardDetails=")
                .append(String.valueOf(this.createManagementDashboardDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManagementDashboardRequest)) {
            return false;
        }

        CreateManagementDashboardRequest other = (CreateManagementDashboardRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createManagementDashboardDetails,
                        other.createManagementDashboardDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createManagementDashboardDetails == null
                                ? 43
                                : this.createManagementDashboardDetails.hashCode());
        result =
                (result * PRIME)
