...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementdashboard/ImportDashboardExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ImportDashboardRequest.
 */
...
public class ImportDashboardRequest
    ...
    public static class Builder
        ...
        public ImportDashboardRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ImportDashboardRequest(managementDashboardImportDetails, ifMatch, opcRetryToken, opcRequestId, overrideSameName, overrideDashboardCompartmentOcid, overrideSavedSearchCompartmentOcid);
        }
    }
