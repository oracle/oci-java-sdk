...
public class ListManagementSavedSearchesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListManagementSavedSearchesResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagementSavedSearchesResponse)) {
            return false;
        }

        ListManagementSavedSearchesResponse other = (ListManagementSavedSearchesResponse) o;
