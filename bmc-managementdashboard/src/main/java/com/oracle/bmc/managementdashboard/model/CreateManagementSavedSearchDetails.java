...
public final class CreateManagementSavedSearchDetails
    ...
    public CreateManagementSavedSearchDetails(
            String id,
            String displayName,
            String providerId,
    ...
    public static class Builder {
        /**
         * ID of the saved search, which must only be provided for Out-of-the-Box (OOB) saved
         * search.
         */
        ...
        public CreateManagementSavedSearchDetails build() {
            CreateManagementSavedSearchDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateManagementSavedSearchDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManagementSavedSearchDetails)) {
            return false;
        }

        CreateManagementSavedSearchDetails other = (CreateManagementSavedSearchDetails) o;
