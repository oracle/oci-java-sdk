...
public class ListOobManagementSavedSearchesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListOobManagementSavedSearchesConverter.class);

    public static com.oracle.bmc.managementdashboard.requests.ListOobManagementSavedSearchesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.managementdashboard.requests.ListOobManagementSavedSearchesRequest
                    request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20200901").path("oobManagementSavedSearches");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.managementdashboard.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.managementdashboard.responses.ListOobManagementSavedSearchesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
