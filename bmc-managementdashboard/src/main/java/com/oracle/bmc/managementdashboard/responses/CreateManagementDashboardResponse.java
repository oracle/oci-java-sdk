...
public class CreateManagementDashboardResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManagementDashboardResponse)) {
            return false;
        }

        CreateManagementDashboardResponse other = (CreateManagementDashboardResponse) o;
