...
public class GetOobManagementSavedSearchResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetOobManagementSavedSearchResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetOobManagementSavedSearchResponse o) {
         ...
         */
        @Override
        public GetOobManagementSavedSearchResponse build() {
            return new GetOobManagementSavedSearchResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, managementSavedSearch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOobManagementSavedSearchResponse)) {
            return false;
        }

        GetOobManagementSavedSearchResponse other = (GetOobManagementSavedSearchResponse) o;
