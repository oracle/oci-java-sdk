...
public final class ManagementDashboardImportDetails {
    ...
    public static class Builder {
        ...
        public ManagementDashboardImportDetails build() {
            ManagementDashboardImportDetails __instance__ =
                    new ManagementDashboardImportDetails(dashboards, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementDashboardImportDetails o) {
