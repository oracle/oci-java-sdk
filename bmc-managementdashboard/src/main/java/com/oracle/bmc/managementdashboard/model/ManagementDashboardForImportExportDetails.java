...
/**
 * Properties of a dashboard, including dashboard ID and saved searches, for import purposes. <br>
...
public final class ManagementDashboardForImportExportDetails
    ...
    public static class Builder {
        ...
        public ManagementDashboardForImportExportDetails build() {
            ManagementDashboardForImportExportDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementDashboardForImportExportDetails model) {
