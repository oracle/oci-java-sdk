...
public class GetOobManagementDashboardResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetOobManagementDashboardResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetOobManagementDashboardResponse o) {
         ...
         */
        @Override
        public GetOobManagementDashboardResponse build() {
            return new GetOobManagementDashboardResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOobManagementDashboardResponse)) {
            return false;
        }

        GetOobManagementDashboardResponse other = (GetOobManagementDashboardResponse) o;
