...
public class GetManagementSavedSearchResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetManagementSavedSearchResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetManagementSavedSearchResponse o) {
        ...
        public GetManagementSavedSearchResponse build() {
            return new GetManagementSavedSearchResponse(
                    __httpStatusCode__,
                    etag,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetManagementSavedSearchResponse)) {
            return false;
        }

        GetManagementSavedSearchResponse other = (GetManagementSavedSearchResponse) o;
