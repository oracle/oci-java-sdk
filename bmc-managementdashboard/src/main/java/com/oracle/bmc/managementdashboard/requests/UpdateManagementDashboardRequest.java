...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementdashboard/UpdateManagementDashboardExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateManagementDashboardRequest.
 */
...
public class UpdateManagementDashboardRequest
    ...
    public static class Builder
        ...
        public UpdateManagementDashboardRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateManagementDashboardRequest(managementDashboardId, updateManagementDashboardDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
