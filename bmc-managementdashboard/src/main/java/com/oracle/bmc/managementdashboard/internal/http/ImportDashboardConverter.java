...
public class ImportDashboardConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ImportDashboardConverter.class);

    public static com.oracle.bmc.managementdashboard.requests.ImportDashboardRequest
            interceptRequest(
                    com.oracle.bmc.managementdashboard.requests.ImportDashboardRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getOverrideSameName() != null) {
            target =
                    target.queryParam(
                            "overrideSameName",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getOverrideSameName()));
        }

        if (request.getOverrideDashboardCompartmentOcid() != null) {
            target =
                    target.queryParam(
        ...
        if (request.getOverrideSavedSearchCompartmentOcid() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.managementdashboard.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.managementdashboard.responses.ImportDashboardResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
