...
public class ListOobManagementDashboardsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListOobManagementDashboardsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListOobManagementDashboardsResponse o) {
         ...
         */
        @Override
        public ListOobManagementDashboardsResponse build() {
            return new ListOobManagementDashboardsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOobManagementDashboardsResponse)) {
            return false;
        }

        ListOobManagementDashboardsResponse other = (ListOobManagementDashboardsResponse) o;
