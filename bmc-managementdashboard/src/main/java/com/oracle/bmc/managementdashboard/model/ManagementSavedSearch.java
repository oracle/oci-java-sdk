...
/**
 * Properties of a saved search. <br>
...
public final class ManagementSavedSearch
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementSavedSearch model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagementSavedSearch(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementSavedSearch)) {
            return false;
        }

        ManagementSavedSearch other = (ManagementSavedSearch) o;
