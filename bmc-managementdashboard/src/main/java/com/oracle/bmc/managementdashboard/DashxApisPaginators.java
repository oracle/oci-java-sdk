 ...
 * to any list operations of DashxApis where multiple pages of data may be fetched. Two styles of
...
public class DashxApisPaginators {
     ...
     * listManagementDashboards operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * responses from the listManagementDashboards operation. This iterable will fetch more data
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listManagementSavedSearches operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     ...
     * responses from the listManagementSavedSearches operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
