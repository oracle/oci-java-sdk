...
public class GetManagementDashboardResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public GetManagementDashboardResponse build() {
            return new GetManagementDashboardResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetManagementDashboardResponse)) {
            return false;
        }

        GetManagementDashboardResponse other = (GetManagementDashboardResponse) o;
