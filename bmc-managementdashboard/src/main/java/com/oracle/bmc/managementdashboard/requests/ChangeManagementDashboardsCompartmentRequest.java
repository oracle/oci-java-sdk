...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementdashboard/ChangeManagementDashboardsCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeManagementDashboardsCompartmentRequest.
 */
...
public class ChangeManagementDashboardsCompartmentRequest
    ...
    public static class Builder
        ...
        public Builder changeManagementDashboardsCompartmentDetails(
                com.oracle.bmc.managementdashboard.model
                                .ChangeManagementDashboardsCompartmentDetails
                        changeManagementDashboardsCompartmentDetails) {
            this.changeManagementDashboardsCompartmentDetails =
                    changeManagementDashboardsCompartmentDetails;
            return this;
        }
         ...
         * @return instance of ChangeManagementDashboardsCompartmentRequest
         */
        public ChangeManagementDashboardsCompartmentRequest buildWithoutInvocationCallback() {
            ChangeManagementDashboardsCompartmentRequest request =
                    new ChangeManagementDashboardsCompartmentRequest();
            request.managementDashboardId = managementDashboardId;
            request.changeManagementDashboardsCompartmentDetails =
                    changeManagementDashboardsCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new ChangeManagementDashboardsCompartmentRequest(managementDashboardId, changeManagementDashboardsCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeManagementDashboardsCompartmentDetails=")
                .append(String.valueOf(this.changeManagementDashboardsCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeManagementDashboardsCompartmentRequest)) {
            return false;
        }

        ChangeManagementDashboardsCompartmentRequest other =
                (ChangeManagementDashboardsCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.managementDashboardId, other.managementDashboardId)
                && java.util.Objects.equals(
                        this.changeManagementDashboardsCompartmentDetails,
                        other.changeManagementDashboardsCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeManagementDashboardsCompartmentDetails == null
                                ? 43
                                : this.changeManagementDashboardsCompartmentDetails.hashCode());
