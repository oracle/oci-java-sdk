...
public class ChangeManagementSavedSearchesCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeManagementSavedSearchesCompartmentResponse)) {
            return false;
        }

        ChangeManagementSavedSearchesCompartmentResponse other =
                (ChangeManagementSavedSearchesCompartmentResponse) o;
