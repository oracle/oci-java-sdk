...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementdashboard/ExportDashboardExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExportDashboardRequest.
 */
...
public class ExportDashboardRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ExportDashboardRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ExportDashboardRequest(exportDashboardId, opcRetryToken, opcRequestId, exportTags);
        }
    }
