...
/**
 * The resource created or operated on by a work request. <br>
...
public final class WorkRequestResource
    ...
    public static class Builder {
        ...
        /**
         * The way in which the resource is affected by the work tracked in the work request. A
         * resource being created, updated, or deleted remains in the IN_PROGRESS state until work
         * is complete for that resource, at which point the state transitions to CREATED, UPDATED,
    ...
    /**
     * The way in which the resource is affected by the work tracked in the work request. A resource
     * being created, updated, or deleted remains in the IN_PROGRESS state until work is complete
     * for that resource, at which point the state transitions to CREATED, UPDATED, or DELETED,
     * respectively.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("actionType")
