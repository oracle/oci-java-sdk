...
public class DeactivateClusterPlacementGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeactivateClusterPlacementGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeactivateClusterPlacementGroupResponse o) {
         ...
         */
        public DeactivateClusterPlacementGroupResponse build() {
            return new DeactivateClusterPlacementGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeactivateClusterPlacementGroupResponse)) {
            return false;
        }

        DeactivateClusterPlacementGroupResponse other = (DeactivateClusterPlacementGroupResponse) o;
