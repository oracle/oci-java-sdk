...
public interface ClusterPlacementGroupsCPAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateClusterPlacementGroupResponse> createClusterPlacementGroup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteClusterPlacementGroupResponse> deleteClusterPlacementGroup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetClusterPlacementGroupResponse> getClusterPlacementGroup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListClusterPlacementGroupsResponse> listClusterPlacementGroups(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateClusterPlacementGroupResponse> updateClusterPlacementGroup(
