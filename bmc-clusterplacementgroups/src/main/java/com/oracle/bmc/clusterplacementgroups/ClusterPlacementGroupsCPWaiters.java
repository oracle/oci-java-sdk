...
public class ClusterPlacementGroupsCPWaiters {
    ...
    public ClusterPlacementGroupsCPWaiters(
            java.util.concurrent.ExecutorService executorService, ClusterPlacementGroupsCP client) {
    ...
    public com.oracle.bmc.waiter.Waiter<
        ...
        return forClusterPlacementGroup(
    ...
    // Helper method to create a new Waiter for ClusterPlacementGroup.
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetClusterPlacementGroupRequest,
                                GetClusterPlacementGroupResponse>() {
                            @Override
                            public GetClusterPlacementGroupResponse apply(
                                    GetClusterPlacementGroupRequest request) {
                                return client.getClusterPlacementGroup(request);
                            }
                        },
                        new java.util.function.Predicate<GetClusterPlacementGroupResponse>() {
                            @Override
                            public boolean test(GetClusterPlacementGroupResponse response) {
                                return targetStatesSet.contains(
                                        response.getClusterPlacementGroup().getLifecycleState());
                            }
                        },
