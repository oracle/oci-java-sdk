...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only resources with a lifecycle state that matches the specified operation
     * status.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only resources with a lifecycle state that matches the specified
         * operation status.
         */
