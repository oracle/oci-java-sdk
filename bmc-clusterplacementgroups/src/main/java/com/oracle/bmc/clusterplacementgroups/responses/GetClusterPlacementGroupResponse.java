...
public class GetClusterPlacementGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetClusterPlacementGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetClusterPlacementGroupResponse o) {
         ...
         */
        @Override
        public GetClusterPlacementGroupResponse build() {
            return new GetClusterPlacementGroupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, clusterPlacementGroup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetClusterPlacementGroupResponse)) {
            return false;
        }

        GetClusterPlacementGroupResponse other = (GetClusterPlacementGroupResponse) o;
