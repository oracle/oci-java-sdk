...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     */
    private com.oracle.bmc.clusterplacementgroups.model.WorkRequest workRequest;

    /**
     * The returned WorkRequest instance.
     * @return the value
     */
    public com.oracle.bmc.clusterplacementgroups.model.WorkRequest getWorkRequest() {
        return workRequest;
    }
    ...
    private GetWorkRequestResponse(
            ...
            String opcRequestId,
            Integer retryAfter,
            com.oracle.bmc.clusterplacementgroups.model.WorkRequest workRequest) {
