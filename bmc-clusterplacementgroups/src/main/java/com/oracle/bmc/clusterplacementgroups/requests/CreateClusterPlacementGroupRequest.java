...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/clusterplacementgroups/CreateClusterPlacementGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateClusterPlacementGroupRequest.
 */
...
public class CreateClusterPlacementGroupRequest
    ...
    public static class Builder
        ...
        public CreateClusterPlacementGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateClusterPlacementGroupRequest(createClusterPlacementGroupDetails, opcRetryToken, opcRequestId, opcDryRun);
        }
    }
