...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/clusterplacementgroups/UpdateClusterPlacementGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateClusterPlacementGroupRequest.
 */
...
public class UpdateClusterPlacementGroupRequest
    ...
    public static class Builder
        ...
        public UpdateClusterPlacementGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateClusterPlacementGroupRequest(clusterPlacementGroupId, updateClusterPlacementGroupDetails, ifMatch, opcRequestId);
        }
    }
