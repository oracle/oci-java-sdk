...
public class ActivateClusterPlacementGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ActivateClusterPlacementGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ActivateClusterPlacementGroupResponse o) {
         ...
         */
        @Override
        public ActivateClusterPlacementGroupResponse build() {
            return new ActivateClusterPlacementGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateClusterPlacementGroupResponse)) {
            return false;
        }

        ActivateClusterPlacementGroupResponse other = (ActivateClusterPlacementGroupResponse) o;
