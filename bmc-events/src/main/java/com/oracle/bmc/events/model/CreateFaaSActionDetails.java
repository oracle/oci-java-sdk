...
/**
 * Create an action that delivers to an Oracle Functions Service endpoint. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateFaaSActionDetails.Builder.class)
...
public final class CreateFaaSActionDetails extends ActionDetails {
    ...
    @Deprecated
    public CreateFaaSActionDetails(Boolean isEnabled, String description, String functionId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFaaSActionDetails)) {
            return false;
        }
