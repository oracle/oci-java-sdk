...
public class UpdateRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRuleResponse> {
        ...
        public UpdateRuleResponse build() {
            return new UpdateRuleResponse(__httpStatusCode__, headers, etag, opcRequestId, rule);
        }
    }
