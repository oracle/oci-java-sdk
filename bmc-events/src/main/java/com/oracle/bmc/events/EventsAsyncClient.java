...
public class EventsAsyncClient implements EventsAsync {
    /**
    ...
    public java.util.concurrent.Future<ChangeRuleCompartmentResponse> changeRuleCompartment(
            final ChangeRuleCompartmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            ChangeRuleCompartmentRequest, ChangeRuleCompartmentResponse>
                    handler) {
        LOG.trace("Called async changeRuleCompartment");
        final ChangeRuleCompartmentRequest interceptedRequest =
                ChangeRuleCompartmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeRuleCompartmentConverter.fromRequest(client, interceptedRequest);
    ...
    public java.util.concurrent.Future<CreateRuleResponse> createRule(
        ...
        if (this.authenticationDetailsProvider
                instanceof com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider) {
            return new com.oracle.bmc.util.internal.RefreshAuthTokenTransformingFuture<
                    javax.ws.rs.core.Response, CreateRuleResponse>(
                    responseFuture,
                    transformer,
                    (com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider)
                            this.authenticationDetailsProvider,
