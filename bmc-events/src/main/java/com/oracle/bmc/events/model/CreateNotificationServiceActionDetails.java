...
/**
 * Create an action that delivers to an Oracle Notification Service topic. <br>
...
public final class CreateNotificationServiceActionDetails extends ActionDetails {
    ...
    public static class Builder {
        ...
        public CreateNotificationServiceActionDetails build() {
            CreateNotificationServiceActionDetails model =
                    new CreateNotificationServiceActionDetails(
                            this.isEnabled, this.description, this.topicId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNotificationServiceActionDetails model) {
     ...
     * the topic to which messages are delivered.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("topicId")
