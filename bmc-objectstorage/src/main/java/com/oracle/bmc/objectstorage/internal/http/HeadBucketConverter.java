...
@Slf4j
public class HeadBucketConverter {
    private static final ResponseConversionFunctionFactory RESPONSE_CONVERSION_FACTORY =
            new ResponseConversionFunctionFactory();

    public static HeadBucketRequest interceptRequest(HeadBucketRequest request) {

        return request;
    }

    public static Invocation.Builder fromRequest(RestClient client, HeadBucketRequest request) {
        if (request == null) {
    ...
    public static Function<Response, HeadBucketResponse> fromResponse() {
        final Function<Response, HeadBucketResponse> transformer =
                new Function<Response, HeadBucketResponse>() {
                    @Override
                    public HeadBucketResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for HeadBucketResponse");
                        ...
                        HeadBucketResponse responseWrapper = builder.build();
