...
public class DeleteObjectConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, DeleteObjectRequest request) {
        if (request == null) {
    ...
    public static Function<Response, DeleteObjectResponse> fromResponse() {
        final Function<Response, DeleteObjectResponse> transformer =
                new Function<Response, DeleteObjectResponse>() {
                    @Override
