...
public class HeadObjectConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, HeadObjectRequest request) {
        if (request == null) {
    ...
    public static Function<Response, HeadObjectResponse> fromResponse() {
        final Function<Response, HeadObjectResponse> transformer =
                new Function<Response, HeadObjectResponse>() {
                    @Override
