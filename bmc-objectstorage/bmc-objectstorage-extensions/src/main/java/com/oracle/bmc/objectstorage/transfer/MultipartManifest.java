...
public interface MultipartManifest {
    ...
    /**
     * Check to see if abort has been called on the upload. Once aborted, the upload cannot have
     * anymore parts added to it.
     *
     ...
     * progress.
     *
     * <p>In the event that an upload is aborted, parts that have not been started yet will show up
     * as in-progress in the manifest.
     *
