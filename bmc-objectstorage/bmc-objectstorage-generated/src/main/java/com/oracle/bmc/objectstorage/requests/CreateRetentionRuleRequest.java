...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/objectstorage/CreateRetentionRuleExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateRetentionRuleRequest.
 */
...
public class CreateRetentionRuleRequest
    ...
    public static class Builder
         ...
         * The retention rule to create for the bucket.
         *
         * @param createRetentionRuleDetails the value to set
         * @return this builder instance
         */
        ...
        public CreateRetentionRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateRetentionRuleRequest(namespaceName, bucketName, createRetentionRuleDetails,
            // opcClientRequestId);
        }
    }
