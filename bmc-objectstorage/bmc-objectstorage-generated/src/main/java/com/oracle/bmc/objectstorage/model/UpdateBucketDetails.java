...
public final class UpdateBucketDetails
    ...
    public static class Builder {
        ...
        /**
         * The name of the bucket. Valid characters are uppercase or lowercase letters, numbers,
         * hyphens, underscores, and periods. Bucket names must be unique within an Object Storage
         ...
         * overwitten or deleted. Versioning cannot be disabled on a bucket once enabled.
         */
        ...
        /**
         * The auto tiering status on the bucket. If in state {@code InfrequentAccess}, objects are
         * transitioned automatically between the 'Standard' and 'InfrequentAccess' tiers based on
         * the access pattern of the objects. When auto tiering is {@code Disabled}, there will be
         * no automatic transitions between storage tiers.
         */
         ...
         * the region.
         *
         * <p>BucketScope can only be updated from NAMESPACE to REGION, it cannot be updated from
         * REGION to NAMESPACE. Updating bucket scope is possible only if the bucket name is valid
         * and there is no existing regionally unique bucket with the same name.
         */
    ...
    /**
     * The auto tiering status on the bucket. If in state {@code InfrequentAccess}, objects are
     * transitioned automatically between the 'Standard' and 'InfrequentAccess' tiers based on the
     * access pattern of the objects. When auto tiering is {@code Disabled}, there will be no
     * automatic transitions between storage tiers.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("autoTiering")
     ...
     * region.
     *
     * <p>BucketScope can only be updated from NAMESPACE to REGION, it cannot be updated from REGION
     * to NAMESPACE. Updating bucket scope is possible only if the bucket name is valid and there is
