...
public class GetReplicationPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetReplicationPolicyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetReplicationPolicyResponse)) {
            return false;
        }

        GetReplicationPolicyResponse other = (GetReplicationPolicyResponse) o;
