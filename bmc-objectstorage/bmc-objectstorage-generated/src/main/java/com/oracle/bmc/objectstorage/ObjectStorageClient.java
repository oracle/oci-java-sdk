...
public class ObjectStorageClient implements ObjectStorage {
    ...
    public BatchDeleteObjectsResponse batchDeleteObjects(BatchDeleteObjectsRequest request) {
        LOG.trace("Called batchDeleteObjects");
        final BatchDeleteObjectsRequest interceptedRequest =
                BatchDeleteObjectsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                BatchDeleteObjectsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BatchDeleteObjectsResponse>
                transformer =
                        BatchDeleteObjectsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBatchDeleteObjectsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
