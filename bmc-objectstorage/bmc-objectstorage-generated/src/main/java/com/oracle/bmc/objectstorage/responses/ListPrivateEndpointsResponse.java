...
public class ListPrivateEndpointsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * For paginating a list of PEs. In the GET request, set the limit to the number of Private
     * Endpoint items that you want returned in the response. If the {@code opc-next-page} header
     * appears in the response, then this is a partial list and there are additional Private
     * Endpoint's to get. Include the header's value as the {@code page} parameter in the subsequent
    ...
    /** A list of {@code com.oracle.bmc.objectstorage.model.PrivateEndpointSummary} instances. */
    ...
    public static class Builder
        ...
        /**
         * For paginating a list of PEs. In the GET request, set the limit to the number of Private
         * Endpoint items that you want returned in the response. If the {@code opc-next-page}
         * header appears in the response, then this is a partial list and there are additional
         * Private Endpoint's to get. Include the header's value as the {@code page} parameter in
         * the subsequent GET request to get the next batch of PEs. Repeat this process to retrieve
