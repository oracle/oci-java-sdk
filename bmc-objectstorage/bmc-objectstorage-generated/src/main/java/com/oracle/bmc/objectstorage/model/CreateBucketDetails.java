...
public final class CreateBucketDetails
    ...
    public static class Builder {
         ...
         * namespace. Avoid entering confidential information. example: Example: my-new-bucket1
         */
        ...
        /**
         * The type of storage tier of this bucket. A bucket is set to 'Standard' tier by default,
         * which means the bucket will be put in the standard storage tier. When 'Archive' tier type
         * is set explicitly, the bucket is put in the Archive Storage tier. The 'storageTier'
         ...
         * tiering {@code Disabled}. Use this option to enable auto tiering during bucket creation.
         * Objects in a bucket with auto tiering set to {@code InfrequentAccess} are transitioned
    ...
    /**
     * The type of storage tier of this bucket. A bucket is set to 'Standard' tier by default, which
     * means the bucket will be put in the standard storage tier. When 'Archive' tier type is set
     * explicitly, the bucket is put in the Archive Storage tier. The 'storageTier' property is
     ...
     * version enabled bucket are protected from overwrites and deletions. Previous versions of the
     ...
     * {@code Disabled}. Use this option to enable auto tiering during bucket creation. Objects in a
     * bucket with auto tiering set to {@code InfrequentAccess} are transitioned automatically
