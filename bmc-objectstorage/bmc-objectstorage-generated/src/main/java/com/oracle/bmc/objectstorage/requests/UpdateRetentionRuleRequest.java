 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateRetentionRuleRequest.
 */
...
public class UpdateRetentionRuleRequest
    ...
    public static class Builder
        ...
        public UpdateRetentionRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateRetentionRuleRequest(namespaceName, bucketName, retentionRuleId,
            // updateRetentionRuleDetails, ifMatch, opcClientRequestId);
        }
    }
