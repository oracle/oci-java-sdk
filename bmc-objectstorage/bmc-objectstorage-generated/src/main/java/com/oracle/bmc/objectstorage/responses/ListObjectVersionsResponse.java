...
public class ListObjectVersionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * For paginating a list of object versions. In the GET request, set the limit to the number of
     * object versions that you want returned in the response. If the {@code opc-next-page} header
     * appears in the response, then this is a partial list and there are additional object versions
     * to get. Include the header's value as the {@code page} parameter in the subsequent GET
     * request to get the next batch of object versions and prefixes. Repeat this process to
     * retrieve the entire list of object versions and prefixes.
     *
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListObjectVersionsResponse> {
        ...
        /**
         * For paginating a list of object versions. In the GET request, set the limit to the number
         * of object versions that you want returned in the response. If the {@code opc-next-page}
         * header appears in the response, then this is a partial list and there are additional
         * object versions to get. Include the header's value as the {@code page} parameter in the
         * subsequent GET request to get the next batch of object versions and prefixes. Repeat this
         * process to retrieve the entire list of object versions and prefixes.
         *
         * <p>For more details about how pagination works, see [List
         * Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
         */
