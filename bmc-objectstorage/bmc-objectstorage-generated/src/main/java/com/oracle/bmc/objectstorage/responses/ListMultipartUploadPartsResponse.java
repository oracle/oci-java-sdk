...
public class ListMultipartUploadPartsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.objectstorage.model.MultipartUploadPartSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMultipartUploadPartsResponse)) {
            return false;
        }

        ListMultipartUploadPartsResponse other = (ListMultipartUploadPartsResponse) o;
