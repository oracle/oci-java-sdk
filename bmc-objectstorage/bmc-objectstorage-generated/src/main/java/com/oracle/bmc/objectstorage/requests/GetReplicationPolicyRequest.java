...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/objectstorage/GetReplicationPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetReplicationPolicyRequest.
 */
...
public class GetReplicationPolicyRequest
    ...
    public static class Builder
        ...
        public GetReplicationPolicyRequest buildWithoutInvocationCallback() {
            GetReplicationPolicyRequest request = new GetReplicationPolicyRequest();
            request.namespaceName = namespaceName;
            request.bucketName = bucketName;
            request.replicationId = replicationId;
            request.opcClientRequestId = opcClientRequestId;
            return request;
            // new GetReplicationPolicyRequest(namespaceName, bucketName, replicationId, opcClientRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetReplicationPolicyRequest)) {
            return false;
        }

        GetReplicationPolicyRequest other = (GetReplicationPolicyRequest) o;
