 ...
 * to any list operations of ObjectStorage where multiple pages of data may be fetched. Two styles
...
public class ObjectStoragePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBuckets
     ...
     * com.oracle.bmc.objectstorage.model.BucketSummary} objects contained in responses from the
     * listBuckets operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.BucketSummary} objects contained in responses received
     *     from the service.
     */
     ...
     * listMultipartUploadParts operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.MultipartUploadPartSummary} objects contained in responses
     * from the listMultipartUploadParts operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.MultipartUploadPartSummary} objects contained in
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listMultipartUploads operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.MultipartUpload} objects contained in responses from the
     * listMultipartUploads operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.MultipartUpload} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listObjectVersions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.ObjectVersionSummary} objects contained in responses from
     * the listObjectVersions operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.ObjectVersionSummary} objects contained in responses
     *     received from the service.
     */
                ...
                new java.util.function.Function<
                    ...
                    public ListObjectsRequest apply(
                        ...
                        if (input.getNextPageToken() == null) {
                            ...
                            return input.getRequestBuilder()
                                    .start(input.getNextPageToken().orElse(null))
                                    .build();
                        }
                    }
                },
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.ObjectSummary} objects contained in responses from the
     * listObjects operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.ObjectSummary} objects contained in responses received
     *     from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listPreauthenticatedRequests operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.PreauthenticatedRequestSummary} objects contained in
     * responses from the listPreauthenticatedRequests operation. This iterable will fetch more data
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.ReplicationPolicySummary} objects contained in responses
     * from the listReplicationPolicies operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.ReplicationPolicySummary} objects contained in
     *     responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listReplicationSources operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.ReplicationSource} objects contained in responses from the
     * listReplicationSources operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.ReplicationSource} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRetentionRules operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.RetentionRuleSummary} objects contained in responses from
     * the listRetentionRules operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.RetentionRuleSummary} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.WorkRequestError} objects contained in responses from the
     * listWorkRequestErrors operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.WorkRequestError} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.objectstorage.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse,
                com.oracle.bmc.objectstorage.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.WorkRequestLogEntry} objects contained in responses from
     * the listWorkRequestLogs operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.WorkRequestLogEntry} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.objectstorage.model.WorkRequestSummary} objects contained in responses from
     * the listWorkRequests operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.objectstorage.model.WorkRequestSummary} objects contained in responses
     *     received from the service.
     */
