...
public class AbortMultipartUploadResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AbortMultipartUploadResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbortMultipartUploadResponse)) {
            return false;
        }

        AbortMultipartUploadResponse other = (AbortMultipartUploadResponse) o;
