...
public class ListReplicationPoliciesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListReplicationPoliciesResponse(
            ...
            String opcNextPage,
            java.util.List<com.oracle.bmc.objectstorage.model.ReplicationPolicySummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListReplicationPoliciesResponse)) {
            return false;
        }

        ListReplicationPoliciesResponse other = (ListReplicationPoliciesResponse) o;
