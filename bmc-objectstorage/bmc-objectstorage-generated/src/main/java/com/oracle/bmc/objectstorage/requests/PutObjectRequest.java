...
public class PutObjectRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream>
     ...
     * In the OCI CLI, you can set this value to 'auto' to have the CLI infer the content type from
     * the file name. Specifying values for this header has no effect on Object Storage behavior.
     * Programs that read the object determine what to do based on the value provided. For example,
    ...
    public static class Builder
         ...
         * PutObject call. In the OCI CLI, you can set this value to 'auto' to have the CLI infer
         * the content type from the file name. Specifying values for this header has no effect on
         * Object Storage behavior. Programs that read the object determine what to do based on the
         * value provided. For example, you could use this header to identify and perform special
