...
/**
 * Common set of Object Storage and Archive Storage APIs for managing buckets, objects, and related
 * resources. For more information, see [Overview of Object
...
public interface ObjectStorageAsync extends AutoCloseable {
     ...
     * #deleteObject(DeleteObjectRequest, Consumer, Consumer) deleteObject} first. In addition, you
     * cannot delete a bucket that has a multipart upload in progress or a pre-authenticated request
