...
/**
 * Update details for configuration source provider of the type {@code GITLAB_ACCESS_TOKEN}. This
 * type corresponds to a configuration source provider in GitLab that is authenticated with a
...
public final class UpdateGitlabAccessTokenConfigurationSourceProviderDetails
    ...
    public static class Builder {
        ...
        public UpdateGitlabAccessTokenConfigurationSourceProviderDetails build() {
            UpdateGitlabAccessTokenConfigurationSourceProviderDetails model =
                    new UpdateGitlabAccessTokenConfigurationSourceProviderDetails(
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGitlabAccessTokenConfigurationSourceProviderDetails model) {
    ...
    @Deprecated
    public UpdateGitlabAccessTokenConfigurationSourceProviderDetails(
            String displayName,
            String description,
            PrivateServerConfigDetails privateServerConfigDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateGitlabAccessTokenConfigurationSourceProviderDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGitlabAccessTokenConfigurationSourceProviderDetails)) {
            return false;
        }

        UpdateGitlabAccessTokenConfigurationSourceProviderDetails other =
                (UpdateGitlabAccessTokenConfigurationSourceProviderDetails) o;
