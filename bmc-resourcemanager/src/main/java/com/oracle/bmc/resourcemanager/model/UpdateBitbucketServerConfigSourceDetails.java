...
/**
 * Update details for a Bitbucket Server configuration source. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateBitbucketServerConfigSourceDetails.Builder.class)
...
public final class UpdateBitbucketServerConfigSourceDetails extends UpdateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateBitbucketServerConfigSourceDetails build() {
            UpdateBitbucketServerConfigSourceDetails model =
                    new UpdateBitbucketServerConfigSourceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBitbucketServerConfigSourceDetails model) {
    ...
    @Deprecated
    public UpdateBitbucketServerConfigSourceDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBitbucketServerConfigSourceDetails)) {
            return false;
        }

        UpdateBitbucketServerConfigSourceDetails other =
                (UpdateBitbucketServerConfigSourceDetails) o;
