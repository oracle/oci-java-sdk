...
public class DeleteTemplateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteTemplateResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteTemplateResponse o) {
        ...
        public DeleteTemplateResponse build() {
            return new DeleteTemplateResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
