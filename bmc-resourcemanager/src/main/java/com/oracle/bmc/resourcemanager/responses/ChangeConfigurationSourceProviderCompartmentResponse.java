...
public class ChangeConfigurationSourceProviderCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeConfigurationSourceProviderCompartmentResponse)) {
            return false;
        }

        ChangeConfigurationSourceProviderCompartmentResponse other =
                (ChangeConfigurationSourceProviderCompartmentResponse) o;
