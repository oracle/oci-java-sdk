...
public class CreateConfigurationSourceProviderConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateConfigurationSourceProviderConverter.class);

    public static com.oracle.bmc.resourcemanager.requests.CreateConfigurationSourceProviderRequest
            interceptRequest(
                    com.oracle.bmc.resourcemanager.requests.CreateConfigurationSourceProviderRequest
                            request) {
