...
public class JobOperationDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected JobOperationDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobOperationDetails)) {
            return false;
        }

        JobOperationDetails other = (JobOperationDetails) o;
