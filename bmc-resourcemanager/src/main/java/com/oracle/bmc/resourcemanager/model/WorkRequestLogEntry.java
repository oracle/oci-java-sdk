...
public final class WorkRequestLogEntry
    ...
    public static class Builder {
        ...
        /**
         * The date and time when the log message was written. Format is defined by RFC3339.
    ...
    /**
     * The date and time when the log message was written. Format is defined by RFC3339. Example:
