...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcemanager/ChangeStackCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeStackCompartmentRequest.
 */
...
public class ChangeStackCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeStackCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeStackCompartmentRequest(stackId, changeStackCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
