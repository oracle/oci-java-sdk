...
public class GetStackResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetStackResponse> {
        ...
        public GetStackResponse build() {
            return new GetStackResponse(__httpStatusCode__, headers, opcRequestId, etag, stack);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetStackResponse)) {
            return false;
        }

        GetStackResponse other = (GetStackResponse) o;
