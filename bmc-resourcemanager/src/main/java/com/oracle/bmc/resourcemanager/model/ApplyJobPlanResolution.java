...
public final class ApplyJobPlanResolution
    ...
    public static class Builder {
         ...
         * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the most
         * recently run plan job. {@code True} if using the latest job
         * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be a
         * plan job that completed successfully.
         */
     ...
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the most
     * recently run plan job. {@code True} if using the latest job
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be a plan
