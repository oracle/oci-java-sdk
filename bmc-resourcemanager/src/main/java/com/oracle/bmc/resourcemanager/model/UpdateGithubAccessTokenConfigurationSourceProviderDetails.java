...
/**
 * Update details for a configuration source provider of the type {@code GITHUB_ACCESS_TOKEN}. This
 * type corresponds to a configuration source provider in GitHub that is authenticated with a
...
public final class UpdateGithubAccessTokenConfigurationSourceProviderDetails
    ...
    public static class Builder {
        ...
        public UpdateGithubAccessTokenConfigurationSourceProviderDetails build() {
            UpdateGithubAccessTokenConfigurationSourceProviderDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGithubAccessTokenConfigurationSourceProviderDetails model) {
