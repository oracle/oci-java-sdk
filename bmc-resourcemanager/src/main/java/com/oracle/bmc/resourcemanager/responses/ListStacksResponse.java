...
public class ListStacksResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.resourcemanager.model.StackSummary> getItems() {
        return items;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListStacksResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListStacksResponse)) {
            return false;
        }

        ListStacksResponse other = (ListStacksResponse) o;
