...
public class ResourceManagerWaiters {
    ...
    public ResourceManagerWaiters(
            java.util.concurrent.ExecutorService executorService, ResourceManager client) {
    ...
    private com.oracle.bmc.waiter.Waiter<
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Predicate<GetConfigurationSourceProviderResponse>() {
                            @Override
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            com.oracle.bmc.resourcemanager.model.Job.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            GetJobRequest request,
            com.oracle.bmc.resourcemanager.model.Job.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            final com.oracle.bmc.resourcemanager.model.Job.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.resourcemanager.model.Job.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
    ...
    public com.oracle.bmc.waiter.Waiter<GetPrivateEndpointRequest, GetPrivateEndpointResponse>
            forPrivateEndpoint(
                    GetPrivateEndpointRequest request,
                    com.oracle.bmc.resourcemanager.model.PrivateEndpoint.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetPrivateEndpointRequest, GetPrivateEndpointResponse>
            forPrivateEndpoint(
                    ...
                    final com.oracle.bmc.resourcemanager.model.PrivateEndpoint.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.resourcemanager.model.PrivateEndpoint.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetStackRequest, GetStackResponse> forStack(
            GetStackRequest request,
            com.oracle.bmc.resourcemanager.model.Stack.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetStackRequest, GetStackResponse> forStack(
            GetStackRequest request,
            com.oracle.bmc.resourcemanager.model.Stack.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Stack.
    private com.oracle.bmc.waiter.Waiter<GetStackRequest, GetStackResponse> forStack(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetStackRequest request,
            final com.oracle.bmc.resourcemanager.model.Stack.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.resourcemanager.model.Stack.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetStackRequest, GetStackResponse>() {
                            @Override
                            public GetStackResponse apply(GetStackRequest request) {
                                return client.getStack(request);
                            }
                        },
                        new java.util.function.Predicate<GetStackResponse>() {
                            @Override
                            public boolean test(GetStackResponse response) {
                                return targetStatesSet.contains(
                                        response.getStack().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
    ...
    private com.oracle.bmc.waiter.Waiter<GetTemplateRequest, GetTemplateResponse> forTemplate(
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetTemplateRequest, GetTemplateResponse>() {
                            @Override
                            public GetTemplateResponse apply(GetTemplateRequest request) {
                                return client.getTemplate(request);
                            }
                        },
                        new java.util.function.Predicate<GetTemplateResponse>() {
                            @Override
