 ...
 * Note: Older stacks that use Terraform version 12.x or 13.x must be explicitly updated to use
 * Terraform Registry ({@code isThirdPartyProviderExperienceEnabled=true}). See {@link
 * #updateStack(UpdateStackRequest) updateStack}. For more information, see [To use Terraform
 * Registry with an older
 * stack](https://docs.cloud.oracle.com/iaas/Content/ResourceManager/Tasks/managingstacksandjobs.htm#use-tf-reg).
 * <br>
