...
public final class ObjectStorageConfigSource extends ConfigSource {
    ...
    public static class Builder {
        ...
        public ObjectStorageConfigSource build() {
            ObjectStorageConfigSource __instance__ =
                    new ObjectStorageConfigSource(workingDirectory, region, namespace, bucketName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageConfigSource o) {
    ...
    @Deprecated
    public ObjectStorageConfigSource(
    ...
    public String toString() {
        ...
        sb.append("ObjectStorageConfigSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageConfigSource)) {
            return false;
        }

        ObjectStorageConfigSource other = (ObjectStorageConfigSource) o;
