...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcemanager/GetWorkRequestLogEntriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetWorkRequestLogEntriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20180917")
public class GetWorkRequestLogEntriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetWorkRequestLogEntriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetWorkRequestLogEntriesRequest o) {
        ...
        /**
         * Build the instance of GetWorkRequestLogEntriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetWorkRequestLogEntriesRequest
         */
        public GetWorkRequestLogEntriesRequest build() {
            GetWorkRequestLogEntriesRequest request = buildWithoutInvocationCallback();
        ...
        public GetWorkRequestLogEntriesRequest buildWithoutInvocationCallback() {
            GetWorkRequestLogEntriesRequest request = new GetWorkRequestLogEntriesRequest();
            ...
            return request;
            // new GetWorkRequestLogEntriesRequest(workRequestId, opcRequestId, type, levelGreaterThanOrEqualTo, sortOrder, limit, page, timestampGreaterThanOrEqualTo, timestampLessThanOrEqualTo);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWorkRequestLogEntriesRequest)) {
            return false;
        }

        GetWorkRequestLogEntriesRequest other = (GetWorkRequestLogEntriesRequest) o;
