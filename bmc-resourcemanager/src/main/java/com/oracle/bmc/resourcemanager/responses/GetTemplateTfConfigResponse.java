...
public class GetTemplateTfConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTemplateTfConfigResponse> {
         ...
         */
        @Override
        public Builder copy(GetTemplateTfConfigResponse o) {
        ...
        public GetTemplateTfConfigResponse build() {
            return new GetTemplateTfConfigResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTemplateTfConfigResponse)) {
            return false;
        }

        GetTemplateTfConfigResponse other = (GetTemplateTfConfigResponse) o;
