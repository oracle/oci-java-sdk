...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcemanager/DeleteConfigurationSourceProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteConfigurationSourceProviderRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20180917")
public class DeleteConfigurationSourceProviderRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteConfigurationSourceProviderRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteConfigurationSourceProviderRequest o) {
        ...
        /**
         * Build the instance of DeleteConfigurationSourceProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteConfigurationSourceProviderRequest
         */
        public DeleteConfigurationSourceProviderRequest build() {
            DeleteConfigurationSourceProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteConfigurationSourceProviderRequest
         */
        public DeleteConfigurationSourceProviderRequest buildWithoutInvocationCallback() {
            DeleteConfigurationSourceProviderRequest request =
                    new DeleteConfigurationSourceProviderRequest();
            request.configurationSourceProviderId = configurationSourceProviderId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteConfigurationSourceProviderRequest(configurationSourceProviderId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteConfigurationSourceProviderRequest)) {
            return false;
        }

        DeleteConfigurationSourceProviderRequest other =
                (DeleteConfigurationSourceProviderRequest) o;
