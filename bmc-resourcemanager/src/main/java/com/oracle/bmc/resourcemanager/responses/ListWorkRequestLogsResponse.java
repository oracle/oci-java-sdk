...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.resourcemanager.model.WorkRequestLogEntry> getItems() {
        return items;
    }
    ...
    private ListWorkRequestLogsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.resourcemanager.model.WorkRequestLogEntry> items) {
