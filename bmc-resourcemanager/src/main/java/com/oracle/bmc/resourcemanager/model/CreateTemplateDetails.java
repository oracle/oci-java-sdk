...
/**
 * The configuration details for creating a template. <br>
...
public final class CreateTemplateDetails
    ...
    public static class Builder {
        ...
        /**
         * Base64-encoded logo to use as the template icon. Template icon file requirements: PNG
         * format, 50 KB maximum, 110 x 110 pixels.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTemplateDetails model) {
    ...
    /**
     * Base64-encoded logo to use as the template icon. Template icon file requirements: PNG format,
     * 50 KB maximum, 110 x 110 pixels.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("logoFileBase64Encoded")
