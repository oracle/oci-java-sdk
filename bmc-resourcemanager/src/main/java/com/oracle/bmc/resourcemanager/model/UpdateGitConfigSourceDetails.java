...
public class UpdateGitConfigSourceDetails extends UpdateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateGitConfigSourceDetails build() {
            UpdateGitConfigSourceDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGitConfigSourceDetails o) {
