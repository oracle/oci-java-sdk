...
/**
 * Update details for a Terraform configuration zip file. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateZipUploadConfigSourceDetails.Builder.class)
...
public final class UpdateZipUploadConfigSourceDetails extends UpdateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateZipUploadConfigSourceDetails build() {
            UpdateZipUploadConfigSourceDetails model =
                    new UpdateZipUploadConfigSourceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateZipUploadConfigSourceDetails model) {
    ...
    @Deprecated
    public UpdateZipUploadConfigSourceDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateZipUploadConfigSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateZipUploadConfigSourceDetails)) {
            return false;
        }

        UpdateZipUploadConfigSourceDetails other = (UpdateZipUploadConfigSourceDetails) o;
