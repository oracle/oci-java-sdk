...
public final class UpdateZipUploadConfigSourceDetails extends UpdateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateZipUploadConfigSourceDetails build() {
            UpdateZipUploadConfigSourceDetails __instance__ =
                    new UpdateZipUploadConfigSourceDetails(workingDirectory, zipFileBase64Encoded);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateZipUploadConfigSourceDetails o) {
