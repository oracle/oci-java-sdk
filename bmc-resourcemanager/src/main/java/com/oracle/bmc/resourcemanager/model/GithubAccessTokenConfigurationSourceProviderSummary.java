...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = GithubAccessTokenConfigurationSourceProviderSummary.Builder.class
)
...
public final class GithubAccessTokenConfigurationSourceProviderSummary
    ...
    public static class Builder {
        ...
        public GithubAccessTokenConfigurationSourceProviderSummary build() {
            GithubAccessTokenConfigurationSourceProviderSummary __instance__ =
                    new GithubAccessTokenConfigurationSourceProviderSummary(
                            id,
                            compartmentId,
                            displayName,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GithubAccessTokenConfigurationSourceProviderSummary o) {
    ...
    public String toString() {
        ...
        sb.append("GithubAccessTokenConfigurationSourceProviderSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GithubAccessTokenConfigurationSourceProviderSummary)) {
            return false;
        }

        GithubAccessTokenConfigurationSourceProviderSummary other =
                (GithubAccessTokenConfigurationSourceProviderSummary) o;
