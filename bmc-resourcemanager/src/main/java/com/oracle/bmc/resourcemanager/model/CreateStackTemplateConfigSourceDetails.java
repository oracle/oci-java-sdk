...
/**
 * Creation details for a template to use as the source of the Terraform configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateStackTemplateConfigSourceDetails.Builder.class)
...
public final class CreateStackTemplateConfigSourceDetails extends CreateConfigSourceDetails {
    ...
    @Deprecated
    public CreateStackTemplateConfigSourceDetails(String workingDirectory, String templateId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateStackTemplateConfigSourceDetails)) {
            return false;
        }
