...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcemanager/DeleteStackExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteStackRequest.
 */
...
public class DeleteStackRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteStackRequest
         */
        public DeleteStackRequest buildWithoutInvocationCallback() {
            DeleteStackRequest request = new DeleteStackRequest();
            request.stackId = stackId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteStackRequest(stackId, opcRequestId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().stackId(stackId).opcRequestId(opcRequestId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteStackRequest)) {
            return false;
        }

        DeleteStackRequest other = (DeleteStackRequest) o;
