...
public class UpdateObjectStorageConfigSourceDetails extends UpdateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateObjectStorageConfigSourceDetails build() {
            UpdateObjectStorageConfigSourceDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateObjectStorageConfigSourceDetails o) {
