...
public class GetJobTfStateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetJobTfStateResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetJobTfStateResponse)) {
            return false;
        }

        GetJobTfStateResponse other = (GetJobTfStateResponse) o;
