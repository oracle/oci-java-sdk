...
public final class CreateBitbucketCloudConfigSourceDetails extends CreateConfigSourceDetails {
    ...
    public static class Builder {
        ...
        public CreateBitbucketCloudConfigSourceDetails build() {
            CreateBitbucketCloudConfigSourceDetails model =
                    new CreateBitbucketCloudConfigSourceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateBitbucketCloudConfigSourceDetails model) {
    ...
    @Deprecated
    public CreateBitbucketCloudConfigSourceDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateBitbucketCloudConfigSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBitbucketCloudConfigSourceDetails)) {
            return false;
        }

        CreateBitbucketCloudConfigSourceDetails other = (CreateBitbucketCloudConfigSourceDetails) o;
