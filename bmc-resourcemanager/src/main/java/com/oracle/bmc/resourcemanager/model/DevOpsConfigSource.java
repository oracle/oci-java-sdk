...
/**
 * Metadata about the [DevOps](https://docs.cloud.oracle.com/iaas/Content/devops/using/home.htm)
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DevOpsConfigSource.Builder.class)
...
public final class DevOpsConfigSource extends ConfigSource {
    ...
    public static class Builder {
        ...
        public DevOpsConfigSource build() {
            DevOpsConfigSource model =
                    new DevOpsConfigSource(
    ...
    public boolean equals(Object o) {
        ...
        DevOpsConfigSource other = (DevOpsConfigSource) o;
