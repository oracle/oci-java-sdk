...
/**
 * Drift status details for resources in the stack. <br>
...
public final class StackResourceDriftCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public StackResourceDriftCollection(java.util.List<StackResourceDriftSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public StackResourceDriftCollection build() {
            StackResourceDriftCollection model = new StackResourceDriftCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StackResourceDriftCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StackResourceDriftCollection)) {
            return false;
        }

        StackResourceDriftCollection other = (StackResourceDriftCollection) o;
