...
/**
 * Job details that are specific to plan operations. <br>
...
public final class CreatePlanJobOperationDetails extends CreateJobOperationDetails {
    ...
    public static class Builder {
        ...
        public CreatePlanJobOperationDetails build() {
            CreatePlanJobOperationDetails model =
                    new CreatePlanJobOperationDetails(
                            this.isProviderUpgradeRequired, this.terraformAdvancedOptions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePlanJobOperationDetails model) {
    ...
    public CreatePlanJobOperationDetails(
            Boolean isProviderUpgradeRequired, TerraformAdvancedOptions terraformAdvancedOptions) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePlanJobOperationDetails)) {
            return false;
        }

        CreatePlanJobOperationDetails other = (CreatePlanJobOperationDetails) o;
