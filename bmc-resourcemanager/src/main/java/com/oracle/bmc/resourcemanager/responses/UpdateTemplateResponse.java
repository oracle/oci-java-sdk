...
public class UpdateTemplateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateTemplateResponse o) {
        ...
        public UpdateTemplateResponse build() {
            return new UpdateTemplateResponse(__httpStatusCode__, opcRequestId, etag, template);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTemplateResponse)) {
            return false;
        }
