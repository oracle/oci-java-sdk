...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcemanager/ListJobAssociatedResourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListJobAssociatedResourcesRequest.
 */
...
public class ListJobAssociatedResourcesRequest
    ...
    public static class Builder
        ...
        public ListJobAssociatedResourcesRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListJobAssociatedResourcesRequest(jobId, opcRequestId, compartmentId, terraformResourceType, limit, page);
        }
    }
