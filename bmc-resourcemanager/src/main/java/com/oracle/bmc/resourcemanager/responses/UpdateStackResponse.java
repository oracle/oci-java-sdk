...
public class UpdateStackResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateStackResponse> {
        ...
        public UpdateStackResponse build() {
            return new UpdateStackResponse(__httpStatusCode__, headers, opcRequestId, etag, stack);
        }
    }
