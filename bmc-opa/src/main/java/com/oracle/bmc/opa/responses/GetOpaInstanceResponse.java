...
public class GetOpaInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOpaInstanceResponse> {
        ...
        public GetOpaInstanceResponse build() {
            return new GetOpaInstanceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, opaInstance);
        }
    }
