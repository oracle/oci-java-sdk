...
public class OpaInstanceAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
    ...
    private OpaInstanceAsyncClient(
    ...
    public static class Builder
        ...
        public OpaInstanceAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new OpaInstanceAsyncClient(this, authenticationDetailsProvider);
        }
    }
