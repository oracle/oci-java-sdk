...
public final class OpaInstance {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OpaInstance o) {
            Builder copiedBuilder =
                    id(o.getId())
                            ...
                            .identityAppDisplayName(o.getIdentityAppDisplayName())
                            .identityDomainUrl(o.getIdentityDomainUrl())
                            .identityAppOpcServiceInstanceGuid(
                                    o.getIdentityAppOpcServiceInstanceGuid())
