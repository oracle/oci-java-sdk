...
public class CreateDisApplicationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDisApplicationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDisApplicationResponse)) {
            return false;
        }

        CreateDisApplicationResponse other = (CreateDisApplicationResponse) o;
