...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDataAssetFromMySqlHeatWave.Builder.class)
...
public final class UpdateDataAssetFromMySqlHeatWave extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromMySqlHeatWave defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromMySqlHeatWave defaultConnection) {
        ...
        public UpdateDataAssetFromMySqlHeatWave build() {
            UpdateDataAssetFromMySqlHeatWave model =
                    new UpdateDataAssetFromMySqlHeatWave(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromMySqlHeatWave model) {
    ...
    @Deprecated
    public UpdateDataAssetFromMySqlHeatWave(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String port,
            String serviceName,
            UpdateConnectionFromMySqlHeatWave defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromMySqlHeatWave defaultConnection;

    public UpdateConnectionFromMySqlHeatWave getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataAssetFromMySqlHeatWave(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromMySqlHeatWave)) {
            return false;
        }

        UpdateDataAssetFromMySqlHeatWave other = (UpdateDataAssetFromMySqlHeatWave) o;
