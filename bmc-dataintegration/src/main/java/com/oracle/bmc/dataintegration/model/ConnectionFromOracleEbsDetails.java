...
/**
 * The connection details for an E-Business Suite data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOracleEbsDetails.Builder.class)
...
public final class ConnectionFromOracleEbsDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromOracleEbsDetails build() {
            ConnectionFromOracleEbsDetails model =
                    new ConnectionFromOracleEbsDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOracleEbsDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromOracleEbsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOracleEbsDetails)) {
            return false;
        }

        ConnectionFromOracleEbsDetails other = (ConnectionFromOracleEbsDetails) o;
