...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDataAssetFromLake.Builder.class)
...
public final class UpdateDataAssetFromLake extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromLake defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromLake defaultConnection) {
        ...
        public UpdateDataAssetFromLake build() {
            UpdateDataAssetFromLake model =
                    new UpdateDataAssetFromLake(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromLake model) {
    ...
    @Deprecated
    public UpdateDataAssetFromLake(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromLake defaultConnection;

    public UpdateConnectionFromLake getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataAssetFromLake(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromLake)) {
            return false;
        }

        UpdateDataAssetFromLake other = (UpdateDataAssetFromLake) o;
