...
/**
 * Properties to configure writing to Oracle Autonomous Transaction Processing. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleAtpWriteAttribute.Builder.class)
...
public final class OracleAtpWriteAttribute extends AbstractWriteAttribute {
    ...
    public static class Builder {
        ...
        public OracleAtpWriteAttribute build() {
            OracleAtpWriteAttribute model =
                    new OracleAtpWriteAttribute(
                            this.bucketName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAtpWriteAttribute model) {
    ...
    @Deprecated
    public OracleAtpWriteAttribute(
            String bucketName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAtpWriteAttribute)) {
            return false;
        }

        OracleAtpWriteAttribute other = (OracleAtpWriteAttribute) o;
