...
/**
 * The type representing the dynamic field concept. Dynamic fields have a dynamic type handler to
 * define how to generate the field. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DynamicInputField.Builder.class)
...
public final class DynamicInputField extends TypedObject {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DynamicInputField)) {
            return false;
        }
