...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/DeleteDataFlowValidationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDataFlowValidationRequest.
 */
...
public class DeleteDataFlowValidationRequest
    ...
    public static class Builder
        ...
        public DeleteDataFlowValidationRequest buildWithoutInvocationCallback() {
            DeleteDataFlowValidationRequest request = new DeleteDataFlowValidationRequest();
            request.workspaceId = workspaceId;
            request.dataFlowValidationKey = dataFlowValidationKey;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDataFlowValidationRequest(workspaceId, dataFlowValidationKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDataFlowValidationRequest)) {
            return false;
        }

        DeleteDataFlowValidationRequest other = (DeleteDataFlowValidationRequest) o;
