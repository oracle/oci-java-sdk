...
public final class DataAssetFromLakehouseDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromLakehouseDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromLakehouseDetails defaultConnection) {
        ...
        public DataAssetFromLakehouseDetails build() {
            DataAssetFromLakehouseDetails model =
                    new DataAssetFromLakehouseDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromLakehouseDetails model) {
    ...
    @Deprecated
    public DataAssetFromLakehouseDetails(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromLakehouseDetails defaultConnection;

    public ConnectionFromLakehouseDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromLakehouseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromLakehouseDetails)) {
            return false;
        }

        DataAssetFromLakehouseDetails other = (DataAssetFromLakehouseDetails) o;
