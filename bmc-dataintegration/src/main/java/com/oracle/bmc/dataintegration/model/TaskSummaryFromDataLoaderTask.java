...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TaskSummaryFromDataLoaderTask.Builder.class
)
...
public final class TaskSummaryFromDataLoaderTask extends TaskSummary {
    ...
    public static class Builder {
        ...
        public TaskSummaryFromDataLoaderTask build() {
            TaskSummaryFromDataLoaderTask __instance__ =
                    new TaskSummaryFromDataLoaderTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskSummaryFromDataLoaderTask o) {
    ...
    @Deprecated
    public TaskSummaryFromDataLoaderTask(
            String key,
            String modelVersion,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskSummaryFromDataLoaderTask)) {
            return false;
        }

        TaskSummaryFromDataLoaderTask other = (TaskSummaryFromDataLoaderTask) o;
