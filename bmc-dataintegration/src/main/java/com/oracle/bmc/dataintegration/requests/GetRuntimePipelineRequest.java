...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetRuntimePipelineExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetRuntimePipelineRequest.
 */
...
public class GetRuntimePipelineRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetRuntimePipelineRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetRuntimePipelineRequest(workspaceId, applicationKey, runtimePipelineKey, opcRequestId, expandReferences);
        }
    }
