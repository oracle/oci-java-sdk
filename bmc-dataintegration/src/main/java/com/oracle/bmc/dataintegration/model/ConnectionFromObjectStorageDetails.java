...
/**
 * The connection summary details for an Oracle Object Storage data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromObjectStorageDetails.Builder.class)
...
public final class ConnectionFromObjectStorageDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromObjectStorageDetails build() {
            ConnectionFromObjectStorageDetails model =
                    new ConnectionFromObjectStorageDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromObjectStorageDetails model) {
    ...
    @Deprecated
    public ConnectionFromObjectStorageDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromObjectStorageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromObjectStorageDetails)) {
            return false;
        }

        ConnectionFromObjectStorageDetails other = (ConnectionFromObjectStorageDetails) o;
