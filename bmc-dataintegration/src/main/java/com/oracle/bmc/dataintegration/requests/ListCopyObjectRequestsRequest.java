...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListCopyObjectRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCopyObjectRequestsRequest.
 */
...
public class ListCopyObjectRequestsRequest
    ...
    public static class Builder
        ...
        public ListCopyObjectRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCopyObjectRequestsRequest(workspaceId, opcRequestId, limit, page, name, sortOrder, sortBy, copyStatus, projection, timeStartedInMillis, timeEndedInMillis);
        }
    }
