...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataAssetFromMySqlHeatWave.Builder.class
)
...
public final class DataAssetFromMySqlHeatWave extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromMySqlHeatWaveDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromMySqlHeatWaveDetails defaultConnection) {
        ...
        public DataAssetFromMySqlHeatWave build() {
            DataAssetFromMySqlHeatWave model =
                    new DataAssetFromMySqlHeatWave(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromMySqlHeatWave model) {
    ...
    @Deprecated
    public DataAssetFromMySqlHeatWave(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String port,
            String serviceName,
            ConnectionFromMySqlHeatWaveDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromMySqlHeatWaveDetails defaultConnection;

    public ConnectionFromMySqlHeatWaveDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromMySqlHeatWave(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromMySqlHeatWave)) {
            return false;
        }

        DataAssetFromMySqlHeatWave other = (DataAssetFromMySqlHeatWave) o;
