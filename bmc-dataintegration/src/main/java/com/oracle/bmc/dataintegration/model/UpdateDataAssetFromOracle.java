...
public final class UpdateDataAssetFromOracle extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        public Builder defaultConnection(UpdateConnectionFromOracle defaultConnection) {
        ...
        public UpdateDataAssetFromOracle build() {
            UpdateDataAssetFromOracle __instance__ =
                    new UpdateDataAssetFromOracle(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromOracle o) {
    ...
    @Deprecated
    public UpdateDataAssetFromOracle(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromOracle defaultConnection;

    public UpdateConnectionFromOracle getDefaultConnection() {
    ...
    public String toString() {
        ...
        sb.append("UpdateDataAssetFromOracle(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromOracle)) {
            return false;
        }

        UpdateDataAssetFromOracle other = (UpdateDataAssetFromOracle) o;
