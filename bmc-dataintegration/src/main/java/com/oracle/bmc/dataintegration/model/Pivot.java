...
/**
 * Pivot operator has one input and one output. Pivot operator takes group by columns, a pivot key
 * with values and aggregations. Output is the pivoted table. <br>
...
public final class Pivot extends Operator {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Pivot model) {
