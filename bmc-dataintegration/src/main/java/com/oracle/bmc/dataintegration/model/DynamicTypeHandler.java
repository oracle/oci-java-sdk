...
/**
 * This type defines how to derived fields for the dynamic type itself. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "modelType",
        defaultImpl = DynamicTypeHandler.class)
...
public class DynamicTypeHandler extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected DynamicTypeHandler() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DynamicTypeHandler)) {
            return false;
        }

        DynamicTypeHandler other = (DynamicTypeHandler) o;
