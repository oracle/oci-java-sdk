...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromRestBasicAuth.Builder.class
)
...
public final class ConnectionFromRestBasicAuth extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromRestBasicAuth build() {
            ConnectionFromRestBasicAuth model =
                    new ConnectionFromRestBasicAuth(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromRestBasicAuth model) {
    ...
    @Deprecated
    public ConnectionFromRestBasicAuth(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromRestBasicAuth(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromRestBasicAuth)) {
            return false;
        }

        ConnectionFromRestBasicAuth other = (ConnectionFromRestBasicAuth) o;
