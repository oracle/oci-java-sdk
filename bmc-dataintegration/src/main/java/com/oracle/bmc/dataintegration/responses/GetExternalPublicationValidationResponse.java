...
public class GetExternalPublicationValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetExternalPublicationValidationResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExternalPublicationValidationResponse)) {
            return false;
        }

        GetExternalPublicationValidationResponse other =
                (GetExternalPublicationValidationResponse) o;
