...
public class UpdateDataFlowResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDataFlowResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDataFlowResponse o) {
         ...
         */
        @Override
        public UpdateDataFlowResponse build() {
            return new UpdateDataFlowResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, dataFlow);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataFlowResponse)) {
            return false;
        }

        UpdateDataFlowResponse other = (UpdateDataFlowResponse) o;
