...
/**
 * The last run details for the task run. <br>
...
public final class LastRunDetails
    ...
    public static class Builder {
         ...
         * schedule. On scenarios where reference to the lastRunDetails is needed, a value can be
         * passed in create.
         */
         ...
         * Time in milliseconds for the pervious schedule.
         *
         * @param lastRunTimeMillis the value to set
         * @return this builder
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LastRunDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("lastRunTimeMillis")) {
                this.lastRunTimeMillis(model.getLastRunTimeMillis());
            }
            return this;
        }
    }
    ...
    /**
     * Generated key that can be used in API calls to identify Last run details of a task schedule.
     * On scenarios where reference to the lastRunDetails is needed, a value can be passed in
     * create.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("key")
