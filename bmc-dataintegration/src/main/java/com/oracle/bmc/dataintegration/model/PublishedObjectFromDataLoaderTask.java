...
public class PublishedObjectFromDataLoaderTask extends PublishedObject {
    ...
    public static class Builder {
        ...
        public PublishedObjectFromDataLoaderTask build() {
            PublishedObjectFromDataLoaderTask __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PublishedObjectFromDataLoaderTask o) {
