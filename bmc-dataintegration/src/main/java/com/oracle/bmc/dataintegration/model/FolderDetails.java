...
/**
 * The details including name, description for the folder, which is a container of other folders,
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FolderDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class FolderDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FolderDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FolderDetails)) {
            return false;
        }

        FolderDetails other = (FolderDetails) o;
