...
public class UpdateDataAssetFromMySQL extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateDataAssetFromMySQL build() {
            UpdateDataAssetFromMySQL __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromMySQL o) {
