...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetPipelineValidationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPipelineValidationRequest.
 */
...
public class GetPipelineValidationRequest
    ...
    public static class Builder
        ...
        public GetPipelineValidationRequest buildWithoutInvocationCallback() {
            GetPipelineValidationRequest request = new GetPipelineValidationRequest();
            request.workspaceId = workspaceId;
            request.pipelineValidationKey = pipelineValidationKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetPipelineValidationRequest(workspaceId, pipelineValidationKey, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .pipelineValidationKey(pipelineValidationKey)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPipelineValidationRequest)) {
            return false;
        }

        GetPipelineValidationRequest other = (GetPipelineValidationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.workspaceId, other.workspaceId)
                && java.util.Objects.equals(this.pipelineValidationKey, other.pipelineValidationKey)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.pipelineValidationKey == null
                                ? 43
                                : this.pipelineValidationKey.hashCode());
