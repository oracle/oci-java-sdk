...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListPipelineValidationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPipelineValidationsRequest.
 */
...
public class ListPipelineValidationsRequest
    ...
    public static class Builder
         ...
         * @return instance of ListPipelineValidationsRequest
         */
        public ListPipelineValidationsRequest buildWithoutInvocationCallback() {
            ListPipelineValidationsRequest request = new ListPipelineValidationsRequest();
            ...
            return request;
            // new ListPipelineValidationsRequest(workspaceId, key, name, identifier, fields, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPipelineValidationsRequest)) {
            return false;
        }

        ListPipelineValidationsRequest other = (ListPipelineValidationsRequest) o;
