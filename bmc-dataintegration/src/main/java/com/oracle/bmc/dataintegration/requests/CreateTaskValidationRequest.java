...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/CreateTaskValidationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateTaskValidationRequest.
 */
...
public class CreateTaskValidationRequest
    ...
    public static class Builder
        ...
        public CreateTaskValidationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateTaskValidationRequest(workspaceId, createTaskValidationDetails, opcRequestId, opcRetryToken);
        }
    }
