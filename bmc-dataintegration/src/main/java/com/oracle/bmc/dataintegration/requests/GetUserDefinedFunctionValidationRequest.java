...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetUserDefinedFunctionValidationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetUserDefinedFunctionValidationRequest.
 */
...
public class GetUserDefinedFunctionValidationRequest
    ...
    public static class Builder
        ...
        public Builder copy(GetUserDefinedFunctionValidationRequest o) {
            ...
            userDefinedFunctionValidationKey(o.getUserDefinedFunctionValidationKey());
        ...
        public GetUserDefinedFunctionValidationRequest build() {
            GetUserDefinedFunctionValidationRequest request = buildWithoutInvocationCallback();
        ...
        public GetUserDefinedFunctionValidationRequest buildWithoutInvocationCallback() {
            GetUserDefinedFunctionValidationRequest request =
                    new GetUserDefinedFunctionValidationRequest();
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .userDefinedFunctionValidationKey(userDefinedFunctionValidationKey)
    ...
    public String toString() {
        ...
        sb.append(",userDefinedFunctionValidationKey=")
                .append(String.valueOf(this.userDefinedFunctionValidationKey));
    ...
    public boolean equals(Object o) {
        ...
        GetUserDefinedFunctionValidationRequest other = (GetUserDefinedFunctionValidationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.workspaceId, other.workspaceId)
                && java.util.Objects.equals(
                        this.userDefinedFunctionValidationKey,
                        other.userDefinedFunctionValidationKey)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userDefinedFunctionValidationKey == null
                                ? 43
                                : this.userDefinedFunctionValidationKey.hashCode());
