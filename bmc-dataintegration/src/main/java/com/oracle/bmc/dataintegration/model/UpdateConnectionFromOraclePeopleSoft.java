...
/**
 * The details to update an Oracle PeopleSoft data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromOraclePeopleSoft.Builder.class)
...
public final class UpdateConnectionFromOraclePeopleSoft extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromOraclePeopleSoft build() {
            UpdateConnectionFromOraclePeopleSoft model =
                    new UpdateConnectionFromOraclePeopleSoft(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromOraclePeopleSoft model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromOraclePeopleSoft(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromOraclePeopleSoft)) {
            return false;
        }

        UpdateConnectionFromOraclePeopleSoft other = (UpdateConnectionFromOraclePeopleSoft) o;
