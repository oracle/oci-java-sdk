...
public final class TaskFromPipelineTaskDetails extends Task {
    ...
    public static class Builder {
        ...
        public TaskFromPipelineTaskDetails build() {
            TaskFromPipelineTaskDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskFromPipelineTaskDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TaskFromPipelineTaskDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskFromPipelineTaskDetails)) {
            return false;
        }

        TaskFromPipelineTaskDetails other = (TaskFromPipelineTaskDetails) o;
