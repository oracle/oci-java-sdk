...
/**
 * The connection summary details for a Fusion applications BIP connection. <br>
...
public final class ConnectionSummaryFromBIP extends ConnectionSummary {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromBIP(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromBIP)) {
            return false;
        }
