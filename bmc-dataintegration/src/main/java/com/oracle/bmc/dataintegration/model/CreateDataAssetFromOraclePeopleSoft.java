...
public final class CreateDataAssetFromOraclePeopleSoft extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromOraclePeopleSoft defaultConnection;

        public Builder defaultConnection(CreateConnectionFromOraclePeopleSoft defaultConnection) {
        ...
        public CreateDataAssetFromOraclePeopleSoft build() {
            CreateDataAssetFromOraclePeopleSoft model =
                    new CreateDataAssetFromOraclePeopleSoft(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromOraclePeopleSoft model) {
    ...
    @Deprecated
    public CreateDataAssetFromOraclePeopleSoft(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromOraclePeopleSoft defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromOraclePeopleSoft defaultConnection;

    public CreateConnectionFromOraclePeopleSoft getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromOraclePeopleSoft(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromOraclePeopleSoft)) {
            return false;
        }

        CreateDataAssetFromOraclePeopleSoft other = (CreateDataAssetFromOraclePeopleSoft) o;
