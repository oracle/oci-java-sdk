...
/**
 * The details to update a generic JDBC data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromJdbc.Builder.class)
...
public final class UpdateConnectionFromJdbc extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromJdbc build() {
            UpdateConnectionFromJdbc model =
                    new UpdateConnectionFromJdbc(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromJdbc model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromJdbc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromJdbc)) {
            return false;
        }

        UpdateConnectionFromJdbc other = (UpdateConnectionFromJdbc) o;
