...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOraclePeopleSoft.Builder.class)
...
public final class ConnectionFromOraclePeopleSoft extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromOraclePeopleSoft build() {
            ConnectionFromOraclePeopleSoft model =
                    new ConnectionFromOraclePeopleSoft(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOraclePeopleSoft model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromOraclePeopleSoft(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOraclePeopleSoft)) {
            return false;
        }

        ConnectionFromOraclePeopleSoft other = (ConnectionFromOraclePeopleSoft) o;
