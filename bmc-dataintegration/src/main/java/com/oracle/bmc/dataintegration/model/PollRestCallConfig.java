...
public final class PollRestCallConfig
    ...
    public static class Builder {
        ...
        public PollRestCallConfig build() {
            PollRestCallConfig model =
                    new PollRestCallConfig(this.methodType, this.requestHeaders, this.configValues);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PollRestCallConfig model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PollRestCallConfig)) {
            return false;
        }

        PollRestCallConfig other = (PollRestCallConfig) o;
