...
/**
 * This rule projects fields as a group recognised as name pattern. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GroupedNamePatternRule.Builder.class)
...
public final class GroupedNamePatternRule extends ProjectionRule {
    ...
    public static class Builder {
        ...
        public GroupedNamePatternRule build() {
            GroupedNamePatternRule model =
                    new GroupedNamePatternRule(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
    ...
    public boolean equals(Object o) {
        ...
        GroupedNamePatternRule other = (GroupedNamePatternRule) o;
