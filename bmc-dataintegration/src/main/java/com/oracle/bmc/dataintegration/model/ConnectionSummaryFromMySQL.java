...
/**
 * The connection details for a MYSQL data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromMySQL.Builder.class)
...
public final class ConnectionSummaryFromMySQL extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromMySQL build() {
            ConnectionSummaryFromMySQL model =
                    new ConnectionSummaryFromMySQL(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromMySQL model) {
    ...
    @Deprecated
    public ConnectionSummaryFromMySQL(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromMySQL(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromMySQL)) {
            return false;
        }

        ConnectionSummaryFromMySQL other = (ConnectionSummaryFromMySQL) o;
