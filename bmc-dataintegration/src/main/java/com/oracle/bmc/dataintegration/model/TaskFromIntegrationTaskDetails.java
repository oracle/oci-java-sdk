...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TaskFromIntegrationTaskDetails.Builder.class
)
...
public final class TaskFromIntegrationTaskDetails extends Task {
    ...
    public static class Builder {
        ...
        public TaskFromIntegrationTaskDetails build() {
            TaskFromIntegrationTaskDetails __instance__ =
                    new TaskFromIntegrationTaskDetails(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskFromIntegrationTaskDetails o) {
    ...
    @Deprecated
    public TaskFromIntegrationTaskDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TaskFromIntegrationTaskDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskFromIntegrationTaskDetails)) {
            return false;
        }

        TaskFromIntegrationTaskDetails other = (TaskFromIntegrationTaskDetails) o;
