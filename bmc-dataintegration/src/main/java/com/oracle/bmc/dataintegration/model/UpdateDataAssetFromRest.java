...
/**
 * Details to update the Rest data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDataAssetFromRest.Builder.class)
...
public final class UpdateDataAssetFromRest extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionDetails defaultConnection;

        public Builder defaultConnection(UpdateConnectionDetails defaultConnection) {
        ...
        public UpdateDataAssetFromRest build() {
            UpdateDataAssetFromRest model =
                    new UpdateDataAssetFromRest(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromRest model) {
    ...
    @Deprecated
    public UpdateDataAssetFromRest(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionDetails defaultConnection;

    public UpdateConnectionDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataAssetFromRest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromRest)) {
            return false;
        }

        UpdateDataAssetFromRest other = (UpdateDataAssetFromRest) o;
