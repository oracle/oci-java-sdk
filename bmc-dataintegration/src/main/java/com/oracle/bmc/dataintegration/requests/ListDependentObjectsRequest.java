...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListDependentObjectsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDependentObjectsRequest.
 */
...
public class ListDependentObjectsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDependentObjectsRequest, java.lang.Void> {
         ...
         *
         * @return instance of ListDependentObjectsRequest
         */
        public ListDependentObjectsRequest build() {
            ListDependentObjectsRequest request = buildWithoutInvocationCallback();
        ...
        public ListDependentObjectsRequest buildWithoutInvocationCallback() {
            ListDependentObjectsRequest request = new ListDependentObjectsRequest();
            ...
            return request;
            // new ListDependentObjectsRequest(workspaceId, applicationKey, fields, name, nameContains, identifier, type, typeInSubtree, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDependentObjectsRequest)) {
            return false;
        }

        ListDependentObjectsRequest other = (ListDependentObjectsRequest) o;
