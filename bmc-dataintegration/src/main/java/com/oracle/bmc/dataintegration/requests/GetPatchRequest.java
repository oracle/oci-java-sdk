...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetPatchExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPatchRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200430")
public class GetPatchRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetPatchRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetPatchRequest
         */
        public GetPatchRequest build() {
            GetPatchRequest request = buildWithoutInvocationCallback();
        ...
        public GetPatchRequest buildWithoutInvocationCallback() {
            GetPatchRequest request = new GetPatchRequest();
            request.workspaceId = workspaceId;
            request.applicationKey = applicationKey;
            request.patchKey = patchKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetPatchRequest(workspaceId, applicationKey, patchKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPatchRequest)) {
            return false;
        }

        GetPatchRequest other = (GetPatchRequest) o;
