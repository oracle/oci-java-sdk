...
public final class PipelineValidationSummary
    ...
    public PipelineValidationSummary(
    ...
    public static class Builder {
        ...
        public PipelineValidationSummary build() {
            PipelineValidationSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PipelineValidationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PipelineValidationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PipelineValidationSummary)) {
            return false;
        }

        PipelineValidationSummary other = (PipelineValidationSummary) o;
