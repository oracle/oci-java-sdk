...
/**
 * Secret configuration if used for storing sensitive info <br>
...
public class SecretConfig extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected SecretConfig() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretConfig)) {
            return false;
        }

        SecretConfig other = (SecretConfig) o;
