...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateDataAssetFromMySQL.Builder.class
)
...
public final class CreateDataAssetFromMySQL extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromMySQL defaultConnection;

        public Builder defaultConnection(CreateConnectionFromMySQL defaultConnection) {
        ...
        public CreateDataAssetFromMySQL build() {
            CreateDataAssetFromMySQL __instance__ =
                    new CreateDataAssetFromMySQL(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromMySQL o) {
    ...
    @Deprecated
    public CreateDataAssetFromMySQL(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String port,
            String serviceName,
            CreateConnectionFromMySQL defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromMySQL defaultConnection;

    public CreateConnectionFromMySQL getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromMySQL(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromMySQL)) {
            return false;
        }

        CreateDataAssetFromMySQL other = (CreateDataAssetFromMySQL) o;
