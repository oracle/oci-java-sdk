...
/**
 * This is the collection of external publication validation summaries. It may be a collection of
 * lightweight details or full definitions. <br>
...
public final class ExternalPublicationValidationSummaryCollection
    ...
    public static class Builder {
        ...
        public ExternalPublicationValidationSummaryCollection build() {
            ExternalPublicationValidationSummaryCollection model =
                    new ExternalPublicationValidationSummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalPublicationValidationSummaryCollection model) {
