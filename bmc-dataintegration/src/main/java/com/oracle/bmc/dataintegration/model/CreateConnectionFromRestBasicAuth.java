...
public final class CreateConnectionFromRestBasicAuth extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromRestBasicAuth build() {
            CreateConnectionFromRestBasicAuth model =
                    new CreateConnectionFromRestBasicAuth(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromRestBasicAuth model) {
    ...
    @Deprecated
    public CreateConnectionFromRestBasicAuth(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromRestBasicAuth(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromRestBasicAuth)) {
            return false;
        }

        CreateConnectionFromRestBasicAuth other = (CreateConnectionFromRestBasicAuth) o;
        return java.util.Objects.equals(this.username, other.username)
                && java.util.Objects.equals(this.passwordSecret, other.passwordSecret)
                && java.util.Objects.equals(this.authHeader, other.authHeader)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.authHeader == null ? 43 : this.authHeader.hashCode());
        return result;
    }
}
