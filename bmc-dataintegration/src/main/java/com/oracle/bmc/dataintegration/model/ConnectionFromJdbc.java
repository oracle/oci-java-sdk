...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromJdbc.Builder.class)
...
public final class ConnectionFromJdbc extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromJdbc build() {
            ConnectionFromJdbc model =
                    new ConnectionFromJdbc(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromJdbc model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromJdbc)) {
            return false;
        }

        ConnectionFromJdbc other = (ConnectionFromJdbc) o;
