...
/**
 * Summary details for the Lakehouse data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromLakehouse.Builder.class)
...
public final class DataAssetSummaryFromLakehouse extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        public DataAssetSummaryFromLakehouse build() {
            DataAssetSummaryFromLakehouse model =
                    new DataAssetSummaryFromLakehouse(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
    ...
    @Deprecated
    public DataAssetSummaryFromLakehouse(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            ConnectionSummaryFromLakehouse defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    public boolean equals(Object o) {
        ...
        DataAssetSummaryFromLakehouse other = (DataAssetSummaryFromLakehouse) o;
