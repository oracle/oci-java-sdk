...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataEntityFromViewEntityDetails.Builder.class
)
...
public final class DataEntityFromViewEntityDetails extends DataEntityDetails {
    ...
    public static class Builder {
        ...
        public DataEntityFromViewEntityDetails build() {
            DataEntityFromViewEntityDetails __instance__ =
                    new DataEntityFromViewEntityDetails(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromViewEntityDetails o) {
    ...
    public boolean equals(Object o) {
        ...
        DataEntityFromViewEntityDetails other = (DataEntityFromViewEntityDetails) o;
