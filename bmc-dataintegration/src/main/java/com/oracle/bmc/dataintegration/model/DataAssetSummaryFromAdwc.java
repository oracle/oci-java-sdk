...
/**
 * Summary details for the Autonomous Data Warehouse data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromAdwc.Builder.class)
...
public final class DataAssetSummaryFromAdwc extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        private ConnectionSummaryFromAdwc defaultConnection;

        public Builder defaultConnection(ConnectionSummaryFromAdwc defaultConnection) {
        ...
        public DataAssetSummaryFromAdwc build() {
            DataAssetSummaryFromAdwc model =
                    new DataAssetSummaryFromAdwc(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetSummaryFromAdwc model) {
    ...
    @Deprecated
    public DataAssetSummaryFromAdwc(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String driverClass,
            ConnectionSummaryFromAdwc defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionSummaryFromAdwc defaultConnection;

    public ConnectionSummaryFromAdwc getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetSummaryFromAdwc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromAdwc)) {
            return false;
        }

        DataAssetSummaryFromAdwc other = (DataAssetSummaryFromAdwc) o;
