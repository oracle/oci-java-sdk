...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListExportRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExportRequestsRequest.
 */
...
public class ListExportRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListExportRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListExportRequestsRequest(workspaceId, opcRequestId, page, limit, name, sortOrder, sortBy, exportStatus, projection, timeStartedInMillis, timeEndedInMillis);
        }
    }
