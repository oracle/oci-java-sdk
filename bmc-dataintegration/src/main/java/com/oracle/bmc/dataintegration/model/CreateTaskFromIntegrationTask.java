...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateTaskFromIntegrationTask.Builder.class
)
...
public final class CreateTaskFromIntegrationTask extends CreateTaskDetails {
    ...
    public static class Builder {
        ...
        public CreateTaskFromIntegrationTask build() {
            CreateTaskFromIntegrationTask __instance__ =
                    new CreateTaskFromIntegrationTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTaskFromIntegrationTask o) {
    ...
    @Deprecated
    public CreateTaskFromIntegrationTask(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateTaskFromIntegrationTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTaskFromIntegrationTask)) {
            return false;
        }

        CreateTaskFromIntegrationTask other = (CreateTaskFromIntegrationTask) o;
