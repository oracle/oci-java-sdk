...
public final class UpdateTaskFromDataLoaderTask extends UpdateTaskDetails {
    ...
    public static class Builder {
        ...
        public UpdateTaskFromDataLoaderTask build() {
            UpdateTaskFromDataLoaderTask __instance__ =
                    new UpdateTaskFromDataLoaderTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTaskFromDataLoaderTask o) {
    ...
    @Deprecated
    public UpdateTaskFromDataLoaderTask(
            String key,
            String modelVersion,
    ...
    public String toString() {
        ...
        sb.append("UpdateTaskFromDataLoaderTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTaskFromDataLoaderTask)) {
            return false;
        }

        UpdateTaskFromDataLoaderTask other = (UpdateTaskFromDataLoaderTask) o;
