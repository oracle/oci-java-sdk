...
/**
 * The type representing the abstract field concept. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AbstractField.Builder.class)
...
public final class AbstractField extends TypedObject {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AbstractField model) {
