...
public final class KeyRange extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public KeyRange build() {
            KeyRange model = new KeyRange(this.key, this.range);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KeyRange model) {
            if (model.wasPropertyExplicitlySet("key")) {
                this.key(model.getKey());
            }
            if (model.wasPropertyExplicitlySet("range")) {
