...
/**
 * The details to create a Fusion applications BIP connection. <br>
...
public final class CreateConnectionFromBIP extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromBIP model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromBIP(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromBIP)) {
            return false;
        }

        CreateConnectionFromBIP other = (CreateConnectionFromBIP) o;
