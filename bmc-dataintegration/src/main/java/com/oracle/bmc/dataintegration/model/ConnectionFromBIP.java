...
public final class ConnectionFromBIP extends Connection {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromBIP model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromBIP)) {
            return false;
        }

        ConnectionFromBIP other = (ConnectionFromBIP) o;
