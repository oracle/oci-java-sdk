...
public class GetDataFlowValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDataFlowValidationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDataFlowValidationResponse)) {
            return false;
        }

        GetDataFlowValidationResponse other = (GetDataFlowValidationResponse) o;
