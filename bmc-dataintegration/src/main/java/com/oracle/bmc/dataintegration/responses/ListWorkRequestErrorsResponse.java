...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.dataintegration.model.WorkRequestError} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.dataintegration.model.WorkRequestError> getItems() {
        return items;
    }
    ...
    private ListWorkRequestErrorsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.dataintegration.model.WorkRequestError> items) {
