...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EntityShapeFromObject.Builder.class
)
...
public final class EntityShapeFromObject extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromObject build() {
            EntityShapeFromObject model =
                    new EntityShapeFromObject(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromObject model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityShapeFromObject(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromObject)) {
            return false;
        }

        EntityShapeFromObject other = (EntityShapeFromObject) o;
