...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromRest.Builder.class)
...
public final class DataAssetSummaryFromRest extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        public DataAssetSummaryFromRest build() {
            DataAssetSummaryFromRest model =
                    new DataAssetSummaryFromRest(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetSummaryFromRest model) {
    ...
    @Deprecated
    public DataAssetSummaryFromRest(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetSummaryFromRest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromRest)) {
            return false;
        }

        DataAssetSummaryFromRest other = (DataAssetSummaryFromRest) o;
