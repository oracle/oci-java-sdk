...
/**
 * Variable definitions in the pipeline. <br>
...
public final class Variable extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        /**
         * Generated key that can be used in API calls to identify variable. On scenarios where
         * reference to the variable is needed, a value can be passed in create.
         */
