...
public class CreateApplicationDetailedDescriptionResponse
    ...
    private CreateApplicationDetailedDescriptionResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateApplicationDetailedDescriptionResponse o) {
         ...
         */
        public CreateApplicationDetailedDescriptionResponse build() {
            return new CreateApplicationDetailedDescriptionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApplicationDetailedDescriptionResponse)) {
            return false;
        }

        CreateApplicationDetailedDescriptionResponse other =
                (CreateApplicationDetailedDescriptionResponse) o;
