...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/CreateUserDefinedFunctionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateUserDefinedFunctionRequest.
 */
...
public class CreateUserDefinedFunctionRequest
    ...
    public static class Builder
        ...
        public CreateUserDefinedFunctionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateUserDefinedFunctionRequest(workspaceId, createUserDefinedFunctionDetails, opcRetryToken, opcRequestId);
        }
    }
