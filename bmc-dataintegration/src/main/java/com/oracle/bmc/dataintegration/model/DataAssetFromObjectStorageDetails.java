...
public class DataAssetFromObjectStorageDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        public DataAssetFromObjectStorageDetails build() {
            DataAssetFromObjectStorageDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromObjectStorageDetails o) {
