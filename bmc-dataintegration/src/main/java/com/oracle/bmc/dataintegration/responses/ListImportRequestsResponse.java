...
public class ListImportRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.dataintegration.model.ImportRequestSummaryCollection
            getImportRequestSummaryCollection() {
        return importRequestSummaryCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder importRequestSummaryCollection(
                com.oracle.bmc.dataintegration.model.ImportRequestSummaryCollection
                        importRequestSummaryCollection) {
            this.importRequestSummaryCollection = importRequestSummaryCollection;
            return this;
        ...
        public Builder copy(ListImportRequestsResponse o) {
            ...
            importRequestSummaryCollection(o.getImportRequestSummaryCollection());
    ...
    public String toString() {
        ...
        sb.append(",importRequestSummaryCollection=")
                .append(String.valueOf(importRequestSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListImportRequestsResponse)) {
            return false;
        }

        ListImportRequestsResponse other = (ListImportRequestsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.importRequestSummaryCollection, other.importRequestSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.importRequestSummaryCollection == null
                                ? 43
                                : this.importRequestSummaryCollection.hashCode());
        return result;
    }
}
