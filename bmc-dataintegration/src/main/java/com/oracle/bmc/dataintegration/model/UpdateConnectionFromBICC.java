...
/**
 * The details to update a FUSION_APP BICC connection. <br>
...
public final class UpdateConnectionFromBICC extends UpdateConnectionDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromBICC(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromBICC)) {
            return false;
        }

        UpdateConnectionFromBICC other = (UpdateConnectionFromBICC) o;
