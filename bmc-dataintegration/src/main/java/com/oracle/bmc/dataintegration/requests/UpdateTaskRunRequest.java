...
public class UpdateTaskRunRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateTaskRunDetails(
                com.oracle.bmc.dataintegration.model.UpdateTaskRunDetails updateTaskRunDetails) {
        ...
        public UpdateTaskRunRequest buildWithoutInvocationCallback() {
            UpdateTaskRunRequest request = new UpdateTaskRunRequest();
            request.workspaceId = workspaceId;
            request.applicationKey = applicationKey;
            request.taskRunKey = taskRunKey;
            request.updateTaskRunDetails = updateTaskRunDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateTaskRunDetails=").append(String.valueOf(this.updateTaskRunDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTaskRunRequest)) {
            return false;
        }

        UpdateTaskRunRequest other = (UpdateTaskRunRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.updateTaskRunDetails, other.updateTaskRunDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateTaskRunDetails == null
                                ? 43
                                : this.updateTaskRunDetails.hashCode());
