...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListTaskRunLineagesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTaskRunLineagesRequest.
 */
...
public class ListTaskRunLineagesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public ListTaskRunLineagesRequest build() {
            ListTaskRunLineagesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListTaskRunLineagesRequest
         */
        public ListTaskRunLineagesRequest buildWithoutInvocationCallback() {
            ListTaskRunLineagesRequest request = new ListTaskRunLineagesRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTaskRunLineagesRequest)) {
            return false;
        }

        ListTaskRunLineagesRequest other = (ListTaskRunLineagesRequest) o;
