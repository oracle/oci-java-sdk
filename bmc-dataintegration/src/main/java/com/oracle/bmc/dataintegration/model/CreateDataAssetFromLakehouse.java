...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDataAssetFromLakehouse.Builder.class)
...
public final class CreateDataAssetFromLakehouse extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        public Builder defaultConnection(CreateConnectionFromLakehouse defaultConnection) {
        ...
        public CreateDataAssetFromLakehouse build() {
            CreateDataAssetFromLakehouse model =
                    new CreateDataAssetFromLakehouse(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromLakehouse model) {
    ...
    @Deprecated
    public CreateDataAssetFromLakehouse(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromLakehouse defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromLakehouse)) {
            return false;
        }

        CreateDataAssetFromLakehouse other = (CreateDataAssetFromLakehouse) o;
