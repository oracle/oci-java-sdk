...
/**
 * The details to update an Autonomous Data Warehouse data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromAdwc.Builder.class)
...
public final class UpdateConnectionFromAdwc extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromAdwc build() {
            UpdateConnectionFromAdwc model =
                    new UpdateConnectionFromAdwc(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromAdwc model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromAdwc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromAdwc)) {
            return false;
        }

        UpdateConnectionFromAdwc other = (UpdateConnectionFromAdwc) o;
