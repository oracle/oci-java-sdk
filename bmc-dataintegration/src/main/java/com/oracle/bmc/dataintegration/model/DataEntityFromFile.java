...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataEntityFromFile.Builder.class
)
...
public final class DataEntityFromFile extends DataEntity {
    ...
    public static class Builder {
        ...
        public DataEntityFromFile build() {
            DataEntityFromFile __instance__ =
                    new DataEntityFromFile(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromFile o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromFile)) {
            return false;
        }

        DataEntityFromFile other = (DataEntityFromFile) o;
