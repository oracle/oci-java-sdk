...
public final class DataAssetFromAtpDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromAtpDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromAtpDetails defaultConnection) {
        ...
        public DataAssetFromAtpDetails build() {
            DataAssetFromAtpDetails model =
                    new DataAssetFromAtpDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromAtpDetails model) {
