...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromMySqlHeatWave.Builder.class)
...
public final class ConnectionFromMySqlHeatWave extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromMySqlHeatWave build() {
            ConnectionFromMySqlHeatWave model =
                    new ConnectionFromMySqlHeatWave(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromMySqlHeatWave model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromMySqlHeatWave(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromMySqlHeatWave)) {
            return false;
        }

        ConnectionFromMySqlHeatWave other = (ConnectionFromMySqlHeatWave) o;
