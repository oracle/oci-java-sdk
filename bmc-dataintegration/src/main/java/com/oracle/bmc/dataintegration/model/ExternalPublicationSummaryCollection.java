...
public final class ExternalPublicationSummaryCollection {
    ...
    public static class Builder {
        ...
        public ExternalPublicationSummaryCollection build() {
            ExternalPublicationSummaryCollection __instance__ =
                    new ExternalPublicationSummaryCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalPublicationSummaryCollection o) {
