...
public final class ExternalPublicationSummaryCollection
    ...
    public static class Builder {
        ...
        public ExternalPublicationSummaryCollection build() {
            ExternalPublicationSummaryCollection model =
                    new ExternalPublicationSummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalPublicationSummaryCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalPublicationSummaryCollection)) {
            return false;
        }

        ExternalPublicationSummaryCollection other = (ExternalPublicationSummaryCollection) o;
