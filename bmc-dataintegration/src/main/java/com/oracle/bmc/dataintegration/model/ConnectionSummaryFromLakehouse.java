...
/**
 * The connection summary details for a Lakehouse connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromLakehouse.Builder.class)
...
public final class ConnectionSummaryFromLakehouse extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromLakehouse build() {
            ConnectionSummaryFromLakehouse model =
                    new ConnectionSummaryFromLakehouse(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromLakehouse model) {
    ...
    @Deprecated
    public ConnectionSummaryFromLakehouse(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromLakehouse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromLakehouse)) {
            return false;
        }

        ConnectionSummaryFromLakehouse other = (ConnectionSummaryFromLakehouse) o;
