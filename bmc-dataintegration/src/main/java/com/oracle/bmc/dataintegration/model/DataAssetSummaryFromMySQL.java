...
/**
 * Summary details for the MYSQL data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromMySQL.Builder.class)
...
public final class DataAssetSummaryFromMySQL extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        private ConnectionSummaryFromMySQL defaultConnection;

        public Builder defaultConnection(ConnectionSummaryFromMySQL defaultConnection) {
        ...
        public DataAssetSummaryFromMySQL build() {
            DataAssetSummaryFromMySQL model =
                    new DataAssetSummaryFromMySQL(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetSummaryFromMySQL model) {
    ...
    @Deprecated
    public DataAssetSummaryFromMySQL(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String port,
            String serviceName,
            ConnectionSummaryFromMySQL defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionSummaryFromMySQL defaultConnection;

    public ConnectionSummaryFromMySQL getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetSummaryFromMySQL(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromMySQL)) {
            return false;
        }

        DataAssetSummaryFromMySQL other = (DataAssetSummaryFromMySQL) o;
