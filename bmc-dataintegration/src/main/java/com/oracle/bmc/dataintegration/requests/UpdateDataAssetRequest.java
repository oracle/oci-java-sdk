...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/UpdateDataAssetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDataAssetRequest.
 */
...
public class UpdateDataAssetRequest
    ...
    public com.oracle.bmc.dataintegration.model.UpdateDataAssetDetails getUpdateDataAssetDetails() {
    ...
    public static class Builder
        ...
        public UpdateDataAssetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDataAssetRequest(workspaceId, dataAssetKey, updateDataAssetDetails, opcRequestId, ifMatch);
        }
    }
