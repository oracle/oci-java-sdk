...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ChangeCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCompartmentRequest.
 */
...
public class ChangeCompartmentRequest
     ...
     * The information needed to move a workspace to a specified compartment.
     */
    public com.oracle.bmc.dataintegration.model.ChangeCompartmentDetails
    ...
    public static class Builder
         ...
         * The information needed to move a workspace to a specified compartment.
         */
        private com.oracle.bmc.dataintegration.model.ChangeCompartmentDetails
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeCompartmentRequest o) {
        ...
        /**
         * Build the instance of ChangeCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeCompartmentRequest
         */
        public ChangeCompartmentRequest build() {
            ChangeCompartmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ChangeCompartmentRequest
         */
        public ChangeCompartmentRequest buildWithoutInvocationCallback() {
            ChangeCompartmentRequest request = new ChangeCompartmentRequest();
            ...
            return request;
            // new ChangeCompartmentRequest(workspaceId, changeCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeCompartmentRequest)) {
            return false;
        }

        ChangeCompartmentRequest other = (ChangeCompartmentRequest) o;
