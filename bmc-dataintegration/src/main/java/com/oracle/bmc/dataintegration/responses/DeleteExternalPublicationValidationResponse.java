...
public class DeleteExternalPublicationValidationResponse
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteExternalPublicationValidationResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExternalPublicationValidationResponse)) {
            return false;
        }

        DeleteExternalPublicationValidationResponse other =
                (DeleteExternalPublicationValidationResponse) o;
