...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataEntityFromSql.Builder.class
)
...
public final class DataEntityFromSql extends DataEntity {
    ...
    public static class Builder {
        ...
        public DataEntityFromSql build() {
            DataEntityFromSql __instance__ =
                    new DataEntityFromSql(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromSql o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromSql)) {
            return false;
        }

        DataEntityFromSql other = (DataEntityFromSql) o;
