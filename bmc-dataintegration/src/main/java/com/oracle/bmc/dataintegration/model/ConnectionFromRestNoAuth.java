...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromRestNoAuth.Builder.class
)
...
public final class ConnectionFromRestNoAuth extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromRestNoAuth build() {
            ConnectionFromRestNoAuth model =
                    new ConnectionFromRestNoAuth(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromRestNoAuth model) {
    ...
    @Deprecated
    public ConnectionFromRestNoAuth(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromRestNoAuth(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromRestNoAuth)) {
            return false;
        }

        ConnectionFromRestNoAuth other = (ConnectionFromRestNoAuth) o;
