...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntitySummaryFromSql.Builder.class)
...
public final class DataEntitySummaryFromSql extends DataEntitySummary {
    ...
    public static class Builder {
        ...
        public DataEntitySummaryFromSql build() {
            DataEntitySummaryFromSql model =
                    new DataEntitySummaryFromSql(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntitySummaryFromSql model) {
    ...
    @Deprecated
    public DataEntitySummaryFromSql(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntitySummaryFromSql(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntitySummaryFromSql)) {
            return false;
        }

        DataEntitySummaryFromSql other = (DataEntitySummaryFromSql) o;
