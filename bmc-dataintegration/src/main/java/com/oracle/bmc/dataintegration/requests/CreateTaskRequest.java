...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/CreateTaskExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateTaskRequest.
 */
...
public class CreateTaskRequest
    ...
    public static class Builder
        ...
        public Builder createTaskDetails(
                com.oracle.bmc.dataintegration.model.CreateTaskDetails createTaskDetails) {
        ...
        public Builder copy(CreateTaskRequest o) {
            ...
            createTaskDetails(o.getCreateTaskDetails());
        ...
        /**
         * Build the instance of CreateTaskRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateTaskRequest
         */
        public CreateTaskRequest build() {
            CreateTaskRequest request = buildWithoutInvocationCallback();
        ...
        public CreateTaskRequest buildWithoutInvocationCallback() {
            ...
            request.createTaskDetails = createTaskDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateTaskRequest(workspaceId, createTaskDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.createTaskDetails, other.createTaskDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createTaskDetails == null ? 43 : this.createTaskDetails.hashCode());
        result =
                (result * PRIME)
