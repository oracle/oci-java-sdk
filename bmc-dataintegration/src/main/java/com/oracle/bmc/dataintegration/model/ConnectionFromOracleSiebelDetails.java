...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOracleSiebelDetails.Builder.class)
...
public final class ConnectionFromOracleSiebelDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromOracleSiebelDetails build() {
            ConnectionFromOracleSiebelDetails model =
                    new ConnectionFromOracleSiebelDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOracleSiebelDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromOracleSiebelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOracleSiebelDetails)) {
            return false;
        }

        ConnectionFromOracleSiebelDetails other = (ConnectionFromOracleSiebelDetails) o;
