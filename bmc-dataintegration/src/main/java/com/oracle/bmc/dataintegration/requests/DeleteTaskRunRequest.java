...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/DeleteTaskRunExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteTaskRunRequest.
 */
...
public class DeleteTaskRunRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteTaskRunRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteTaskRunRequest(workspaceId, applicationKey, taskRunKey, ifMatch,
            // opcRequestId);
        }
    }
