...
public class UpdateDisApplicationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateDisApplicationResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDisApplicationResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDisApplicationResponse o) {
         ...
         */
        @Override
        public UpdateDisApplicationResponse build() {
            return new UpdateDisApplicationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, disApplication);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDisApplicationResponse)) {
            return false;
        }

        UpdateDisApplicationResponse other = (UpdateDisApplicationResponse) o;
