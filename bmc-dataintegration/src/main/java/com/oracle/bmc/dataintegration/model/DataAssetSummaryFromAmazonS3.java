...
/**
 * Summary details for the Amazon s3 data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromAmazonS3.Builder.class)
...
public final class DataAssetSummaryFromAmazonS3 extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        private ConnectionSummaryFromAmazonS3 defaultConnection;

        public Builder defaultConnection(ConnectionSummaryFromAmazonS3 defaultConnection) {
        ...
        public DataAssetSummaryFromAmazonS3 build() {
            DataAssetSummaryFromAmazonS3 model =
                    new DataAssetSummaryFromAmazonS3(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetSummaryFromAmazonS3 model) {
    ...
    @Deprecated
    public DataAssetSummaryFromAmazonS3(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String region,
            ConnectionSummaryFromAmazonS3 defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionSummaryFromAmazonS3 defaultConnection;

    public ConnectionSummaryFromAmazonS3 getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetSummaryFromAmazonS3(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromAmazonS3)) {
            return false;
        }

        DataAssetSummaryFromAmazonS3 other = (DataAssetSummaryFromAmazonS3) o;
