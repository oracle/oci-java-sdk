...
/**
 * The connection summary details for an Autonomous Data Warehouse data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromAdwc.Builder.class)
...
public final class ConnectionSummaryFromAdwc extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromAdwc build() {
            ConnectionSummaryFromAdwc model =
                    new ConnectionSummaryFromAdwc(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromAdwc model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromAdwc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromAdwc)) {
            return false;
        }

        ConnectionSummaryFromAdwc other = (ConnectionSummaryFromAdwc) o;
