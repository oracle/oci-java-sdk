...
public class CreateWorkspaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateWorkspaceResponse o) {
        ...
        public CreateWorkspaceResponse build() {
            return new CreateWorkspaceResponse(__httpStatusCode__, opcRequestId, opcWorkRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateWorkspaceResponse)) {
            return false;
        }
