...
public class CreateDataFlowResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateDataFlowResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDataFlowResponse> {
         ...
         */
        @Override
        public Builder copy(CreateDataFlowResponse o) {
        ...
        public CreateDataFlowResponse build() {
            return new CreateDataFlowResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataFlowResponse)) {
            return false;
        }

        CreateDataFlowResponse other = (CreateDataFlowResponse) o;
