...
public class GetScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetScheduleResponse> {
        ...
        public GetScheduleResponse build() {
            return new GetScheduleResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, schedule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetScheduleResponse)) {
            return false;
        }

        GetScheduleResponse other = (GetScheduleResponse) o;
