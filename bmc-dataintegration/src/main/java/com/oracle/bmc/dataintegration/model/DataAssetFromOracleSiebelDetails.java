...
/**
 * Details for the Oracle Siebel data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetFromOracleSiebelDetails.Builder.class)
...
public final class DataAssetFromOracleSiebelDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromOracleSiebelDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromOracleSiebelDetails defaultConnection) {
        ...
        public DataAssetFromOracleSiebelDetails build() {
            DataAssetFromOracleSiebelDetails model =
                    new DataAssetFromOracleSiebelDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromOracleSiebelDetails model) {
    ...
    @Deprecated
    public DataAssetFromOracleSiebelDetails(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            ConnectionFromOracleSiebelDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromOracleSiebelDetails defaultConnection;

    public ConnectionFromOracleSiebelDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromOracleSiebelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromOracleSiebelDetails)) {
            return false;
        }

        DataAssetFromOracleSiebelDetails other = (DataAssetFromOracleSiebelDetails) o;
