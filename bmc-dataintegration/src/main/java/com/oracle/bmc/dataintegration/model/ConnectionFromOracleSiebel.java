...
/**
 * The connection details for an Oracle Siebel data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOracleSiebel.Builder.class)
...
public final class ConnectionFromOracleSiebel extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromOracleSiebel build() {
            ConnectionFromOracleSiebel model =
                    new ConnectionFromOracleSiebel(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOracleSiebel model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromOracleSiebel(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOracleSiebel)) {
            return false;
        }

        ConnectionFromOracleSiebel other = (ConnectionFromOracleSiebel) o;
