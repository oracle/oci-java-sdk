...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EntityShapeFromFile.Builder.class
)
...
public final class EntityShapeFromFile extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromFile build() {
            EntityShapeFromFile __instance__ =
                    new EntityShapeFromFile(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromFile o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromFile)) {
            return false;
        }

        EntityShapeFromFile other = (EntityShapeFromFile) o;
