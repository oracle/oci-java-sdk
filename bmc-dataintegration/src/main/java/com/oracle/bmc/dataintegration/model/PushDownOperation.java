...
/**
 * The information about a push down operation. <br>
...
public class PushDownOperation extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected PushDownOperation() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PushDownOperation)) {
            return false;
        }

        PushDownOperation other = (PushDownOperation) o;
