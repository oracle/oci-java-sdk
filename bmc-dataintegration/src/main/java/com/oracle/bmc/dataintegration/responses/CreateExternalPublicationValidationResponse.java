...
public class CreateExternalPublicationValidationResponse
    ...
    public String toString() {
        ...
        sb.append(",externalPublicationValidation=")
                .append(String.valueOf(externalPublicationValidation));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExternalPublicationValidationResponse)) {
            return false;
        }

        CreateExternalPublicationValidationResponse other =
                (CreateExternalPublicationValidationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.externalPublicationValidation, other.externalPublicationValidation);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.externalPublicationValidation == null
                                ? 43
                                : this.externalPublicationValidation.hashCode());
        return result;
    }
}
