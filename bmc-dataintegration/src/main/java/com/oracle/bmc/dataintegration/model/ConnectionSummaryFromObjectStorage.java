...
/**
 * The connection details for an Oracle Object Storage data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromObjectStorage.Builder.class)
...
public final class ConnectionSummaryFromObjectStorage extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromObjectStorage build() {
            ConnectionSummaryFromObjectStorage model =
                    new ConnectionSummaryFromObjectStorage(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
    ...
    public boolean equals(Object o) {
        ...
        ConnectionSummaryFromObjectStorage other = (ConnectionSummaryFromObjectStorage) o;
