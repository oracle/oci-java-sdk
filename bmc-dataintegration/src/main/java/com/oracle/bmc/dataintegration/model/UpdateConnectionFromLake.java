...
/**
 * The details to update a Lake connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromLake.Builder.class)
...
public final class UpdateConnectionFromLake extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromLake build() {
            UpdateConnectionFromLake model =
                    new UpdateConnectionFromLake(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromLake model) {
    ...
    @Deprecated
    public UpdateConnectionFromLake(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromLake(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromLake)) {
            return false;
        }

        UpdateConnectionFromLake other = (UpdateConnectionFromLake) o;
