...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDataAssetFromAdwc.Builder.class
)
...
public final class UpdateDataAssetFromAdwc extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        public Builder defaultConnection(UpdateConnectionFromAdwc defaultConnection) {
        ...
        public UpdateDataAssetFromAdwc build() {
            UpdateDataAssetFromAdwc __instance__ =
                    new UpdateDataAssetFromAdwc(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromAdwc o) {
    ...
    @Deprecated
    public UpdateDataAssetFromAdwc(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromAdwc)) {
            return false;
        }

        UpdateDataAssetFromAdwc other = (UpdateDataAssetFromAdwc) o;
