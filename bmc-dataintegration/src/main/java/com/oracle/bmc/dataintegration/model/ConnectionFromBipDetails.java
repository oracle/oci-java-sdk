...
/**
 * The connection details for a Fusion applications BIP connection. <br>
...
public final class ConnectionFromBipDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromBipDetails build() {
            ConnectionFromBipDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromBipDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromBipDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromBipDetails)) {
            return false;
        }

        ConnectionFromBipDetails other = (ConnectionFromBipDetails) o;
