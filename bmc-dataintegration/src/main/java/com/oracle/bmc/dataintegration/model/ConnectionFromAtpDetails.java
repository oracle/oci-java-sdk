...
/**
 * The connection details for an Autonomous Transaction Processing data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromAtpDetails.Builder.class)
...
public final class ConnectionFromAtpDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromAtpDetails build() {
            ConnectionFromAtpDetails model =
                    new ConnectionFromAtpDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromAtpDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromAtpDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromAtpDetails)) {
            return false;
        }

        ConnectionFromAtpDetails other = (ConnectionFromAtpDetails) o;
