...
/**
 * The information about the projection object. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Projection.Builder.class)
...
public final class Projection extends Operator {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Projection model) {
