...
/**
 * The connection summary details for an Oracle Database data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromOracle.Builder.class)
...
public final class ConnectionSummaryFromOracle extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromOracle build() {
            ConnectionSummaryFromOracle model =
                    new ConnectionSummaryFromOracle(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromOracle model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromOracle)) {
            return false;
        }

        ConnectionSummaryFromOracle other = (ConnectionSummaryFromOracle) o;
