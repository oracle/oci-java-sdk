...
/**
 * The information about a data flow task. <br>
...
public final class TaskFromDataLoaderTaskDetails extends Task {
    ...
    public static class Builder {
        ...
        public TaskFromDataLoaderTaskDetails build() {
            TaskFromDataLoaderTaskDetails model =
                    new TaskFromDataLoaderTaskDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskFromDataLoaderTaskDetails model) {
