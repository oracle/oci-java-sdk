...
/**
 * The information about the aggregator operator. The aggregate operator performs calculations, like
 * sum or count, on all rows or a group of rows to create new, derivative attributes. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Aggregator.Builder.class)
...
public final class Aggregator extends Operator {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Aggregator model) {
