...
/**
 * The details to update an Oracle Database data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromOracle.Builder.class)
...
public final class UpdateConnectionFromOracle extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromOracle build() {
            UpdateConnectionFromOracle model =
                    new UpdateConnectionFromOracle(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromOracle model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromOracle(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromOracle)) {
            return false;
        }

        UpdateConnectionFromOracle other = (UpdateConnectionFromOracle) o;
