...
public final class DecisionOutputPort extends TypedObject {
    ...
    public static class Builder {
        ...
        public DecisionOutputPort build() {
            DecisionOutputPort model =
                    new DecisionOutputPort(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.configValues,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DecisionOutputPort model) {
            ...
            if (model.wasPropertyExplicitlySet("decisionOutputPortType")) {
                this.decisionOutputPortType(model.getDecisionOutputPortType());
            }
            return this;
        }
    }
    ...
    public DecisionOutputPort(
            ...
            DecisionOutputPortType decisionOutputPortType) {
    ...
    public enum DecisionOutputPortType {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(DecisionOutputPortType.class);

        private final String value;
        private static java.util.Map<String, DecisionOutputPortType> map;

        static {
            map = new java.util.HashMap<>();
            for (DecisionOutputPortType v : DecisionOutputPortType.values()) {
                if (v != UnknownEnumValue) {
                    map.put(v.getValue(), v);
                }
            }
        ...
        DecisionOutputPortType(String value) {
            this.value = value;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static DecisionOutputPortType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'DecisionOutputPortType', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DecisionOutputPort)) {
            return false;
        }

        DecisionOutputPort other = (DecisionOutputPort) o;
        return java.util.Objects.equals(this.portType, other.portType)
                && java.util.Objects.equals(this.fields, other.fields)
                && java.util.Objects.equals(
                        this.decisionOutputPortType, other.decisionOutputPortType)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.decisionOutputPortType == null
                                ? 43
                                : this.decisionOutputPortType.hashCode());
        return result;
    }
}
