...
public final class UpdateDataAssetFromObjectStorage extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromObjectStorage defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromObjectStorage defaultConnection) {
        ...
        public UpdateDataAssetFromObjectStorage build() {
            UpdateDataAssetFromObjectStorage __instance__ =
                    new UpdateDataAssetFromObjectStorage(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromObjectStorage o) {
