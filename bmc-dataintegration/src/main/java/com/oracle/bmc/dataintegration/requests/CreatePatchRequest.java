...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/CreatePatchExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePatchRequest.
 */
...
public class CreatePatchRequest
    ...
    public static class Builder
        ...
        public Builder createPatchDetails(
                com.oracle.bmc.dataintegration.model.CreatePatchDetails createPatchDetails) {
            this.createPatchDetails = createPatchDetails;
            return this;
        }
        ...
        public Builder copy(CreatePatchRequest o) {
            ...
            createPatchDetails(o.getCreatePatchDetails());
         ...
         */
        public CreatePatchRequest build() {
            CreatePatchRequest request = buildWithoutInvocationCallback();
        ...
        public CreatePatchRequest buildWithoutInvocationCallback() {
            CreatePatchRequest request = new CreatePatchRequest();
            request.workspaceId = workspaceId;
            request.applicationKey = applicationKey;
            request.createPatchDetails = createPatchDetails;
    ...
    public String toString() {
        ...
        sb.append(",createPatchDetails=").append(String.valueOf(this.createPatchDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePatchRequest)) {
            return false;
        }

        CreatePatchRequest other = (CreatePatchRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.workspaceId, other.workspaceId)
                && java.util.Objects.equals(this.applicationKey, other.applicationKey)
                && java.util.Objects.equals(this.createPatchDetails, other.createPatchDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createPatchDetails == null
                                ? 43
                                : this.createPatchDetails.hashCode());
