...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UniqueDataKey.Builder.class)
...
public final class UniqueDataKey extends UniqueKey {
    ...
    public static class Builder {
        ...
        public UniqueDataKey build() {
            UniqueDataKey __instance__ =
                    new UniqueDataKey(
                            key, modelVersion, parentRef, name, attributeRefs, objectStatus);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UniqueDataKey o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UniqueDataKey)) {
            return false;
        }

        UniqueDataKey other = (UniqueDataKey) o;
