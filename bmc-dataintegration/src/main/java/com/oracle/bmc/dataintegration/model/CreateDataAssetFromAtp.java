...
/**
 * Details for the Autonomous Transaction Processing data asset type. <br>
...
public final class CreateDataAssetFromAtp extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromAtp model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromAtp defaultConnection;

    public CreateConnectionFromAtp getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromAtp(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromAtp)) {
            return false;
        }

        CreateDataAssetFromAtp other = (CreateDataAssetFromAtp) o;
