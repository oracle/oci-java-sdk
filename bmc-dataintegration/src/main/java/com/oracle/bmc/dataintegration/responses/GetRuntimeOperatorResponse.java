...
public class GetRuntimeOperatorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder runtimeOperator(
                com.oracle.bmc.dataintegration.model.RuntimeOperator runtimeOperator) {
            this.runtimeOperator = runtimeOperator;
            return this;
        }
        ...
        public Builder copy(GetRuntimeOperatorResponse o) {
            ...
            runtimeOperator(o.getRuntimeOperator());
    ...
    public String toString() {
        ...
        sb.append(",runtimeOperator=").append(String.valueOf(runtimeOperator));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRuntimeOperatorResponse)) {
            return false;
        }

        GetRuntimeOperatorResponse other = (GetRuntimeOperatorResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.runtimeOperator, other.runtimeOperator);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.runtimeOperator == null ? 43 : this.runtimeOperator.hashCode());
        return result;
    }
}
