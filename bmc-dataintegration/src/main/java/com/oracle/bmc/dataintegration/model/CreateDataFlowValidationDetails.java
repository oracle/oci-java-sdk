...
/**
 * The properties used in create dataflow validation operations. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDataFlowValidationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateDataFlowValidationDetails
    ...
    public static class Builder {
        ...
        public CreateDataFlowValidationDetails build() {
            CreateDataFlowValidationDetails model =
                    new CreateDataFlowValidationDetails(
                            this.key,
                            this.modelType,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataFlowValidationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataFlowValidationDetails)) {
            return false;
        }

        CreateDataFlowValidationDetails other = (CreateDataFlowValidationDetails) o;
