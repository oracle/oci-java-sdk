...
/**
 * OCI DataFlow Shape configuration. Use shapeOcpuParam and shapeMemoryParam config params for
 * configuring number of OCPUs and memory in GBs respectively. <br>
...
public final class ShapeDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public ShapeDetails(ConfigValues configValues) {
        super();
    ...
    public static class Builder {
        ...
        public ShapeDetails build() {
            ShapeDetails model = new ShapeDetails(this.configValues);
