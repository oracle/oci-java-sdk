...
/**
 * The connection summary details for a Lake connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromLake.Builder.class)
...
public final class ConnectionSummaryFromLake extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromLake build() {
            ConnectionSummaryFromLake model =
                    new ConnectionSummaryFromLake(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromLake model) {
    ...
    @Deprecated
    public ConnectionSummaryFromLake(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromLake(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromLake)) {
            return false;
        }

        ConnectionSummaryFromLake other = (ConnectionSummaryFromLake) o;
