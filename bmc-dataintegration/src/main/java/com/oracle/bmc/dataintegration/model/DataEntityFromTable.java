...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntityFromTable.Builder.class)
...
public final class DataEntityFromTable extends DataEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromTable)) {
            return false;
        }

        DataEntityFromTable other = (DataEntityFromTable) o;
