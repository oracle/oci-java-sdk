...
public final class CreateTaskFromPipelineTask extends CreateTaskDetails {
    ...
    public static class Builder {
        ...
        public CreateTaskFromPipelineTask build() {
            CreateTaskFromPipelineTask model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTaskFromPipelineTask model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateTaskFromPipelineTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTaskFromPipelineTask)) {
            return false;
        }

        CreateTaskFromPipelineTask other = (CreateTaskFromPipelineTask) o;
