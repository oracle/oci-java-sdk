...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateTaskFromIntegrationTask.Builder.class
)
...
public final class UpdateTaskFromIntegrationTask extends UpdateTaskDetails {
    ...
    public static class Builder {
        ...
        public UpdateTaskFromIntegrationTask build() {
            UpdateTaskFromIntegrationTask __instance__ =
                    new UpdateTaskFromIntegrationTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTaskFromIntegrationTask o) {
    ...
    @Deprecated
    public UpdateTaskFromIntegrationTask(
            String key,
            String modelVersion,
    ...
    public String toString() {
        ...
        sb.append("UpdateTaskFromIntegrationTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTaskFromIntegrationTask)) {
            return false;
        }

        UpdateTaskFromIntegrationTask other = (UpdateTaskFromIntegrationTask) o;
