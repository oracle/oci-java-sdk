...
/**
 * The details to create an Oracle Database data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromOracle.Builder.class)
...
public final class CreateConnectionFromOracle extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromOracle build() {
            CreateConnectionFromOracle model =
                    new CreateConnectionFromOracle(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromOracle model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromOracle(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromOracle)) {
            return false;
        }

        CreateConnectionFromOracle other = (CreateConnectionFromOracle) o;
