...
/**
 * The table entity data entity. <br>
...
public final class DataEntityFromTableEntityDetails extends DataEntityDetails {
    ...
    public static class Builder {
        ...
        public DataEntityFromTableEntityDetails build() {
            DataEntityFromTableEntityDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromTableEntityDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntityFromTableEntityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromTableEntityDetails)) {
            return false;
        }

        DataEntityFromTableEntityDetails other = (DataEntityFromTableEntityDetails) o;
