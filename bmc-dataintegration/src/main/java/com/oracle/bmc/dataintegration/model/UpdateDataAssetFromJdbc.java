...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDataAssetFromJdbc.Builder.class
)
...
public final class UpdateDataAssetFromJdbc extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromJdbc defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromJdbc defaultConnection) {
        ...
        public UpdateDataAssetFromJdbc build() {
            UpdateDataAssetFromJdbc __instance__ =
                    new UpdateDataAssetFromJdbc(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromJdbc o) {
    ...
    @Deprecated
    public UpdateDataAssetFromJdbc(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            UpdateConnectionFromJdbc defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromJdbc defaultConnection;

    public UpdateConnectionFromJdbc getDefaultConnection() {
    ...
    public String toString() {
        ...
        sb.append("UpdateDataAssetFromJdbc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromJdbc)) {
            return false;
        }

        UpdateDataAssetFromJdbc other = (UpdateDataAssetFromJdbc) o;
