...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromMySQLDetails.Builder.class
)
...
public final class ConnectionFromMySQLDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromMySQLDetails build() {
            ConnectionFromMySQLDetails __instance__ =
                    new ConnectionFromMySQLDetails(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromMySQLDetails o) {
    ...
    @Deprecated
    public ConnectionFromMySQLDetails(
            String key,
            String modelVersion,
    ...
    public String toString() {
        ...
        sb.append("ConnectionFromMySQLDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromMySQLDetails)) {
            return false;
        }

        ConnectionFromMySQLDetails other = (ConnectionFromMySQLDetails) o;
