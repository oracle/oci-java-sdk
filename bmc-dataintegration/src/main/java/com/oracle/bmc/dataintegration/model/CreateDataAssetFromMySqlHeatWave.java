...
/**
 * Details for the MYSQL HeatWave data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDataAssetFromMySqlHeatWave.Builder.class)
...
public final class CreateDataAssetFromMySqlHeatWave extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromMySqlHeatWave defaultConnection;

        public Builder defaultConnection(CreateConnectionFromMySqlHeatWave defaultConnection) {
        ...
        public CreateDataAssetFromMySqlHeatWave build() {
            CreateDataAssetFromMySqlHeatWave model =
                    new CreateDataAssetFromMySqlHeatWave(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromMySqlHeatWave model) {
    ...
    @Deprecated
    public CreateDataAssetFromMySqlHeatWave(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            String port,
            String serviceName,
            CreateConnectionFromMySqlHeatWave defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromMySqlHeatWave defaultConnection;

    public CreateConnectionFromMySqlHeatWave getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromMySqlHeatWave(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromMySqlHeatWave)) {
            return false;
        }

        CreateDataAssetFromMySqlHeatWave other = (CreateDataAssetFromMySqlHeatWave) o;
