...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromAdwc.Builder.class
)
...
public final class ConnectionFromAdwc extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromAdwc build() {
            ConnectionFromAdwc __instance__ =
                    new ConnectionFromAdwc(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromAdwc o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromAdwc)) {
            return false;
        }

        ConnectionFromAdwc other = (ConnectionFromAdwc) o;
