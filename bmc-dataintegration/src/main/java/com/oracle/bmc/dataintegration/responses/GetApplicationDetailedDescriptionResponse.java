...
public class GetApplicationDetailedDescriptionResponse
    ...
    public static class Builder
        ...
        public Builder copy(GetApplicationDetailedDescriptionResponse o) {
            ...
            detailedDescription(o.getDetailedDescription());
    ...
    public String toString() {
        ...
        sb.append(",detailedDescription=").append(String.valueOf(detailedDescription));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApplicationDetailedDescriptionResponse)) {
            return false;
        }

        GetApplicationDetailedDescriptionResponse other =
                (GetApplicationDetailedDescriptionResponse) o;
