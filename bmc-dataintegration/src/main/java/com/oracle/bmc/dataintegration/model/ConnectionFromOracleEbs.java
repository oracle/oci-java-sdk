...
/**
 * The connection details for E-Business Suite data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOracleEbs.Builder.class)
...
public final class ConnectionFromOracleEbs extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromOracleEbs build() {
            ConnectionFromOracleEbs model =
                    new ConnectionFromOracleEbs(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOracleEbs model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOracleEbs)) {
            return false;
        }

        ConnectionFromOracleEbs other = (ConnectionFromOracleEbs) o;
