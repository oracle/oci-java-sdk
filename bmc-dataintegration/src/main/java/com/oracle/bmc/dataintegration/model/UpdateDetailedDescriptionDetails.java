...
/**
 * Properties used in detailed description update operations. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDetailedDescriptionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UpdateDetailedDescriptionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"logo", "detailedDescription"})
    public UpdateDetailedDescriptionDetails(String logo, String detailedDescription) {
        super();
        this.logo = logo;
    ...
    public static class Builder {
        ...
        public UpdateDetailedDescriptionDetails build() {
            UpdateDetailedDescriptionDetails model =
                    new UpdateDetailedDescriptionDetails(this.logo, this.detailedDescription);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDetailedDescriptionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDetailedDescriptionDetails)) {
            return false;
        }

        UpdateDetailedDescriptionDetails other = (UpdateDetailedDescriptionDetails) o;
