...
/**
 * The connection details for a data asset. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    ...
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ConnectionFromRestNoAuthDetails.class,
...
public class ConnectionDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
