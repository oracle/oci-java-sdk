 ...
 * _DATE. This is defined using a regular expression. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = NamePatternRule.Builder.class)
...
public final class NamePatternRule extends ProjectionRule {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NamePatternRule)) {
            return false;
        }

        NamePatternRule other = (NamePatternRule) o;
