...
/**
 * Summary details for the generic JDBC data asset type. <br>
...
public final class DataAssetSummaryFromJdbc extends DataAssetSummary {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionSummaryFromJdbc defaultConnection;

    public ConnectionSummaryFromJdbc getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetSummaryFromJdbc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromJdbc)) {
            return false;
        }

        DataAssetSummaryFromJdbc other = (DataAssetSummaryFromJdbc) o;
