...
public final class PublishedObjectSummaryFromIntegrationTask extends PublishedObjectSummary {
    ...
    public static class Builder {
        ...
        public PublishedObjectSummaryFromIntegrationTask build() {
            PublishedObjectSummaryFromIntegrationTask __instance__ =
                    new PublishedObjectSummaryFromIntegrationTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PublishedObjectSummaryFromIntegrationTask o) {
    ...
    @Deprecated
    public PublishedObjectSummaryFromIntegrationTask(
            String key,
            String modelVersion,
    ...
    public String toString() {
        ...
        sb.append("PublishedObjectSummaryFromIntegrationTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublishedObjectSummaryFromIntegrationTask)) {
            return false;
        }

        PublishedObjectSummaryFromIntegrationTask other =
                (PublishedObjectSummaryFromIntegrationTask) o;
