...
public class UpdateApplicationDetailedDescriptionResponse
    ...
    private UpdateApplicationDetailedDescriptionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateApplicationDetailedDescriptionResponse o) {
         ...
         */
        @Override
        public UpdateApplicationDetailedDescriptionResponse build() {
            return new UpdateApplicationDetailedDescriptionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateApplicationDetailedDescriptionResponse)) {
            return false;
        }

        UpdateApplicationDetailedDescriptionResponse other =
                (UpdateApplicationDetailedDescriptionResponse) o;
