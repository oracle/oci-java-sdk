...
/**
 * The information about a data flow validation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataFlowValidationSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DataFlowValidationSummary
    ...
    public DataFlowValidationSummary(
    ...
    public static class Builder {
        ...
        public DataFlowValidationSummary build() {
            DataFlowValidationSummary model =
                    new DataFlowValidationSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataFlowValidationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataFlowValidationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataFlowValidationSummary)) {
            return false;
        }

        DataFlowValidationSummary other = (DataFlowValidationSummary) o;
