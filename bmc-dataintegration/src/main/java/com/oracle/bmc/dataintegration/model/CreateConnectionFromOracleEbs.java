...
/**
 * The details to create E-Business Suite data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromOracleEbs.Builder.class)
...
public final class CreateConnectionFromOracleEbs extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromOracleEbs build() {
            CreateConnectionFromOracleEbs model =
                    new CreateConnectionFromOracleEbs(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromOracleEbs model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromOracleEbs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromOracleEbs)) {
            return false;
        }

        CreateConnectionFromOracleEbs other = (CreateConnectionFromOracleEbs) o;
