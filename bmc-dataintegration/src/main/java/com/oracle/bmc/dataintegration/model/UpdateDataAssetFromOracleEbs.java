...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDataAssetFromOracleEbs.Builder.class)
...
public final class UpdateDataAssetFromOracleEbs extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromOracleEbs defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromOracleEbs defaultConnection) {
        ...
        public UpdateDataAssetFromOracleEbs build() {
            UpdateDataAssetFromOracleEbs model =
                    new UpdateDataAssetFromOracleEbs(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromOracleEbs model) {
    ...
    @Deprecated
    public UpdateDataAssetFromOracleEbs(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            UpdateConnectionFromOracleEbs defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromOracleEbs defaultConnection;

    public UpdateConnectionFromOracleEbs getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataAssetFromOracleEbs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromOracleEbs)) {
            return false;
        }

        UpdateDataAssetFromOracleEbs other = (UpdateDataAssetFromOracleEbs) o;
