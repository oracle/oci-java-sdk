...
public class ConnectionFromAmazonS3Details extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromAmazonS3Details build() {
            ConnectionFromAmazonS3Details __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromAmazonS3Details o) {
