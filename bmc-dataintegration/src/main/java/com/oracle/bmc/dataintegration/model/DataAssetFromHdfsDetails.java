...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetFromHdfsDetails.Builder.class)
...
public final class DataAssetFromHdfsDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        public Builder defaultConnection(ConnectionFromHdfsDetails defaultConnection) {
        ...
        public DataAssetFromHdfsDetails build() {
            DataAssetFromHdfsDetails model =
                    new DataAssetFromHdfsDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromHdfsDetails model) {
    ...
    public DataAssetFromHdfsDetails(
            ...
            ConnectionFromHdfsDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromHdfsDetails)) {
            return false;
        }

        DataAssetFromHdfsDetails other = (DataAssetFromHdfsDetails) o;
