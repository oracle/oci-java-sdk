...
/**
 * The details to create an Autonomous Transaction Processing data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromAtp.Builder.class)
...
public final class CreateConnectionFromAtp extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromAtp build() {
            CreateConnectionFromAtp model =
                    new CreateConnectionFromAtp(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromAtp model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromAtp(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromAtp)) {
            return false;
        }

        CreateConnectionFromAtp other = (CreateConnectionFromAtp) o;
