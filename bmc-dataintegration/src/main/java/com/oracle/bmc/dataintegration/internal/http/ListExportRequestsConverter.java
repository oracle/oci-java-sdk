...
public class ListExportRequestsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListExportRequestsConverter.class);

    public static com.oracle.bmc.dataintegration.requests.ListExportRequestsRequest
            interceptRequest(
                    com.oracle.bmc.dataintegration.requests.ListExportRequestsRequest request) {
        ...
        if (request.getExportStatus() != null) {
            target =
                    target.queryParam(
                            "exportStatus",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getExportStatus().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dataintegration.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dataintegration.responses.ListExportRequestsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.exportRequestSummaryCollection(response.getItem());
