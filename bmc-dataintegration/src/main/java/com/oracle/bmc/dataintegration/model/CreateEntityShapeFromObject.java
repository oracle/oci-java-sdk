...
/**
 * The application object entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateEntityShapeFromObject.Builder.class)
...
public final class CreateEntityShapeFromObject extends CreateEntityShapeDetails {
    ...
    public static class Builder {
        ...
        public CreateEntityShapeFromObject build() {
            CreateEntityShapeFromObject model =
                    new CreateEntityShapeFromObject(
                            this.key,
                            this.parentRef,
                            this.name,
                            this.description,
    ...
    public boolean equals(Object o) {
        ...
        CreateEntityShapeFromObject other = (CreateEntityShapeFromObject) o;
