...
/**
 * Properties used for specifying OCI vault configuration <br>
...
public final class OciVaultSecretConfig extends SecretConfig {
    ...
    public static class Builder {
        ...
        public OciVaultSecretConfig build() {
            OciVaultSecretConfig model = new OciVaultSecretConfig(this.secretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciVaultSecretConfig model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OciVaultSecretConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciVaultSecretConfig)) {
            return false;
        }

        OciVaultSecretConfig other = (OciVaultSecretConfig) o;
