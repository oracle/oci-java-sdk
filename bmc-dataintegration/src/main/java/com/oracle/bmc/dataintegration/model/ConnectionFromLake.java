...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromLake.Builder.class
)
...
public final class ConnectionFromLake extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromLake build() {
            ConnectionFromLake model =
                    new ConnectionFromLake(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromLake model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromLake)) {
            return false;
        }

        ConnectionFromLake other = (ConnectionFromLake) o;
