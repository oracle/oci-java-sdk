...
public final class ConnectionSummaryFromHdfs extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromHdfs build() {
            ConnectionSummaryFromHdfs model =
                    new ConnectionSummaryFromHdfs(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
    ...
    @Deprecated
    public ConnectionSummaryFromHdfs(
            String key,
            String modelVersion,
    ...
    public boolean equals(Object o) {
        ...
        ConnectionSummaryFromHdfs other = (ConnectionSummaryFromHdfs) o;
