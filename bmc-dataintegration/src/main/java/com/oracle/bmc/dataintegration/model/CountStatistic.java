...
public class CountStatistic {
    ...
    public static class Builder {
        ...
        public CountStatistic build() {
            CountStatistic __instance__ = new CountStatistic(objectTypeCountList);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CountStatistic o) {
            Builder copiedBuilder = objectTypeCountList(o.getObjectTypeCountList());
