...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromMySQL.Builder.class)
...
public final class ConnectionFromMySQL extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromMySQL build() {
            ConnectionFromMySQL model =
                    new ConnectionFromMySQL(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromMySQL model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromMySQL)) {
            return false;
        }

        ConnectionFromMySQL other = (ConnectionFromMySQL) o;
