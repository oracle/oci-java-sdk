...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDataAssetFromOracleSiebel.Builder.class
)
...
public final class UpdateDataAssetFromOracleSiebel extends UpdateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private UpdateConnectionFromOracleSiebel defaultConnection;

        public Builder defaultConnection(UpdateConnectionFromOracleSiebel defaultConnection) {
        ...
        public UpdateDataAssetFromOracleSiebel build() {
            UpdateDataAssetFromOracleSiebel model =
                    new UpdateDataAssetFromOracleSiebel(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataAssetFromOracleSiebel model) {
    ...
    @Deprecated
    public UpdateDataAssetFromOracleSiebel(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            UpdateConnectionFromOracleSiebel defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final UpdateConnectionFromOracleSiebel defaultConnection;

    public UpdateConnectionFromOracleSiebel getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataAssetFromOracleSiebel(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromOracleSiebel)) {
            return false;
        }

        UpdateDataAssetFromOracleSiebel other = (UpdateDataAssetFromOracleSiebel) o;
