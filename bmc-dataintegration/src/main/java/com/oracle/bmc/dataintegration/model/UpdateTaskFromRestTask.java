...
public final class UpdateTaskFromRestTask extends UpdateTaskDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTaskFromRestTask model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTaskFromRestTask)) {
            return false;
        }

        UpdateTaskFromRestTask other = (UpdateTaskFromRestTask) o;
