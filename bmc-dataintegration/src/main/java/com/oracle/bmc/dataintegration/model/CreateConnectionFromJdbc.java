...
/**
 * The details to create a generic JDBC data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromJdbc.Builder.class)
...
public final class CreateConnectionFromJdbc extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromJdbc build() {
            CreateConnectionFromJdbc model =
                    new CreateConnectionFromJdbc(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromJdbc model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromJdbc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromJdbc)) {
            return false;
        }

        CreateConnectionFromJdbc other = (CreateConnectionFromJdbc) o;
