...
public class GetTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTaskResponse> {
        ...
        public GetTaskResponse build() {
            return new GetTaskResponse(__httpStatusCode__, headers, etag, opcRequestId, task);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTaskResponse)) {
            return false;
        }
