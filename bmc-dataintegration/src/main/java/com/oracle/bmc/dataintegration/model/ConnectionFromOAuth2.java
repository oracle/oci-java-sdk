...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromOAuth2.Builder.class)
...
public final class ConnectionFromOAuth2 extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromOAuth2 build() {
            ConnectionFromOAuth2 model =
                    new ConnectionFromOAuth2(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOAuth2 model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromOAuth2(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOAuth2)) {
            return false;
        }

        ConnectionFromOAuth2 other = (ConnectionFromOAuth2) o;
