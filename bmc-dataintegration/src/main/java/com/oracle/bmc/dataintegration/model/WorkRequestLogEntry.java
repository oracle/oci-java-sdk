...
/**
 * The log message from executing an operation that is tracked by a work request. <br>
...
public final class WorkRequestLogEntry
    ...
    public static class Builder {
        ...
        /**
         * The date and time the log message was written, in the timestamp format defined by [RFC
