...
public class GetConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.dataintegration.model.Connection getConnection() {
        return connection;
    }
    ...
    private GetConnectionResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.dataintegration.model.Connection connection) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetConnectionResponse> {
         ...
         * @return this builder
         */
        public Builder connection(com.oracle.bmc.dataintegration.model.Connection connection) {
            this.connection = connection;
            return this;
        }
