...
/**
 * The connection details for a generic JDBC data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromJdbcDetails.Builder.class)
...
public final class ConnectionFromJdbcDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromJdbcDetails build() {
            ConnectionFromJdbcDetails model =
                    new ConnectionFromJdbcDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromJdbcDetails model) {
    ...
    @Deprecated
    public ConnectionFromJdbcDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromJdbcDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromJdbcDetails)) {
            return false;
        }

        ConnectionFromJdbcDetails other = (ConnectionFromJdbcDetails) o;
