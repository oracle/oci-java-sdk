...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataEntitySummaryFromTable.Builder.class
)
...
public final class DataEntitySummaryFromTable extends DataEntitySummary {
    ...
    public static class Builder {
        ...
        public DataEntitySummaryFromTable build() {
            DataEntitySummaryFromTable __instance__ =
                    new DataEntitySummaryFromTable(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntitySummaryFromTable o) {
    ...
    @Deprecated
    public DataEntitySummaryFromTable(
    ...
    public String toString() {
        ...
        sb.append("DataEntitySummaryFromTable(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntitySummaryFromTable)) {
            return false;
        }

        DataEntitySummaryFromTable other = (DataEntitySummaryFromTable) o;
