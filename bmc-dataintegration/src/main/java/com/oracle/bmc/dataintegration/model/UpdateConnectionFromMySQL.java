...
/**
 * The details to update a MYSQL data asset connection. <br>
...
public final class UpdateConnectionFromMySQL extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromMySQL build() {
            UpdateConnectionFromMySQL model =
                    new UpdateConnectionFromMySQL(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromMySQL model) {
