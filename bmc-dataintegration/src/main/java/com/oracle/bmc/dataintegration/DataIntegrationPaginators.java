...
public class DataIntegrationPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listCopyObjectRequests operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListCopyObjectRequestsResponse> listCopyObjectRequestsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListCopyObjectRequestsRequest.Builder, ListCopyObjectRequestsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dataintegration.model.CopyObjectRequestSummary} objects
     * contained in responses from the listCopyObjectRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dataintegration.model.CopyObjectRequestSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listExportRequests operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListExportRequestsResponse> listExportRequestsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListExportRequestsRequest.Builder, ListExportRequestsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dataintegration.model.ExportRequestSummary} objects
     * contained in responses from the listExportRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dataintegration.model.ExportRequestSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listImportRequests operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListImportRequestsResponse> listImportRequestsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListImportRequestsRequest.Builder, ListImportRequestsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dataintegration.model.ImportRequestSummary} objects
     * contained in responses from the listImportRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dataintegration.model.ImportRequestSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dataintegration.model.TemplateSummary} objects
     * contained in responses from the listTemplates operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dataintegration.model.TemplateSummary} objects
     * contained in responses received from the service.
     */
