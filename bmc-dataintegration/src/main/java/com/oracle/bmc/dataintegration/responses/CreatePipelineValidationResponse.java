...
public class CreatePipelineValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public CreatePipelineValidationResponse build() {
            return new CreatePipelineValidationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePipelineValidationResponse)) {
            return false;
        }

        CreatePipelineValidationResponse other = (CreatePipelineValidationResponse) o;
