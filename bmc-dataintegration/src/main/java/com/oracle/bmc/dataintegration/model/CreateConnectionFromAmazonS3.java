...
/**
 * The details to create a Amazon S3 connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromAmazonS3.Builder.class)
...
public final class CreateConnectionFromAmazonS3 extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromAmazonS3 build() {
            CreateConnectionFromAmazonS3 model =
                    new CreateConnectionFromAmazonS3(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromAmazonS3 model) {
    ...
    @Deprecated
    public CreateConnectionFromAmazonS3(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromAmazonS3(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromAmazonS3)) {
            return false;
        }

        CreateConnectionFromAmazonS3 other = (CreateConnectionFromAmazonS3) o;
