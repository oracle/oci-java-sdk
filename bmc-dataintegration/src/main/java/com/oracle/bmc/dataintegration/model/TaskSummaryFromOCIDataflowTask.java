...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TaskSummaryFromOCIDataflowTask.Builder.class
)
...
public final class TaskSummaryFromOCIDataflowTask extends TaskSummary {
    ...
    public static class Builder {
        ...
        public TaskSummaryFromOCIDataflowTask build() {
            TaskSummaryFromOCIDataflowTask __instance__ =
                    new TaskSummaryFromOCIDataflowTask(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskSummaryFromOCIDataflowTask o) {
    ...
    @Deprecated
    public TaskSummaryFromOCIDataflowTask(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TaskSummaryFromOCIDataflowTask(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskSummaryFromOCIDataflowTask)) {
            return false;
        }

        TaskSummaryFromOCIDataflowTask other = (TaskSummaryFromOCIDataflowTask) o;
