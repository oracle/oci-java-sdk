...
/**
 * Details for the E-Business Suite data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetFromOracleEbsDetails.Builder.class)
...
public final class DataAssetFromOracleEbsDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromOracleEbsDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromOracleEbsDetails defaultConnection) {
        ...
        public DataAssetFromOracleEbsDetails build() {
            DataAssetFromOracleEbsDetails model =
                    new DataAssetFromOracleEbsDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromOracleEbsDetails model) {
    ...
    @Deprecated
    public DataAssetFromOracleEbsDetails(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            ConnectionFromOracleEbsDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromOracleEbsDetails defaultConnection;

    public ConnectionFromOracleEbsDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromOracleEbsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromOracleEbsDetails)) {
            return false;
        }

        DataAssetFromOracleEbsDetails other = (DataAssetFromOracleEbsDetails) o;
