...
/**
 * Properties used in data flow update operations. <br>
...
public final class UpdateDataFlowDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDataFlowDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDataFlowDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataFlowDetails)) {
            return false;
        }

        UpdateDataFlowDetails other = (UpdateDataFlowDetails) o;
