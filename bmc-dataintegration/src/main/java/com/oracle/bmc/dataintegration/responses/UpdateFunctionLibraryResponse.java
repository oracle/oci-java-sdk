...
public class UpdateFunctionLibraryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateFunctionLibraryResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateFunctionLibraryResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateFunctionLibraryResponse o) {
         ...
         */
        @Override
        public UpdateFunctionLibraryResponse build() {
            return new UpdateFunctionLibraryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFunctionLibraryResponse)) {
            return false;
        }

        UpdateFunctionLibraryResponse other = (UpdateFunctionLibraryResponse) o;
