...
/**
 * Copy metadata object response summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CopyObjectRequestSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CopyObjectRequestSummary
    ...
    public CopyObjectRequestSummary(
            String key,
    ...
    public static class Builder {
        ...
        public CopyObjectRequestSummary build() {
            CopyObjectRequestSummary model =
                    new CopyObjectRequestSummary(
                            this.key,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CopyObjectRequestSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CopyObjectRequestSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyObjectRequestSummary)) {
            return false;
        }

        CopyObjectRequestSummary other = (CopyObjectRequestSummary) o;
