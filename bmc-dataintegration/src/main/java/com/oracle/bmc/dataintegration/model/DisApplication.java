...
public final class DisApplication extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DisApplication model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisApplication)) {
            return false;
        }

        DisApplication other = (DisApplication) o;
