...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TaskFromOCIDataflowTaskDetails.Builder.class
)
...
public final class TaskFromOCIDataflowTaskDetails extends Task {
    ...
    public static class Builder {
        ...
        public TaskFromOCIDataflowTaskDetails build() {
            TaskFromOCIDataflowTaskDetails __instance__ =
                    new TaskFromOCIDataflowTaskDetails(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskFromOCIDataflowTaskDetails o) {
    ...
    @Deprecated
    public TaskFromOCIDataflowTaskDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TaskFromOCIDataflowTaskDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskFromOCIDataflowTaskDetails)) {
            return false;
        }

        TaskFromOCIDataflowTaskDetails other = (TaskFromOCIDataflowTaskDetails) o;
