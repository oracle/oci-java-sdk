...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDataAssetFromOracleSiebel.Builder.class)
...
public final class CreateDataAssetFromOracleSiebel extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromOracleSiebel defaultConnection;

        public Builder defaultConnection(CreateConnectionFromOracleSiebel defaultConnection) {
        ...
        public CreateDataAssetFromOracleSiebel build() {
            CreateDataAssetFromOracleSiebel model =
                    new CreateDataAssetFromOracleSiebel(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromOracleSiebel model) {
    ...
    @Deprecated
    public CreateDataAssetFromOracleSiebel(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromOracleSiebel defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromOracleSiebel defaultConnection;

    public CreateConnectionFromOracleSiebel getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromOracleSiebel(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromOracleSiebel)) {
            return false;
        }

        CreateDataAssetFromOracleSiebel other = (CreateDataAssetFromOracleSiebel) o;
