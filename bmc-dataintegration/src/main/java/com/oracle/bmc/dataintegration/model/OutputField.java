...
/**
 * Output fields of an operator. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OutputField.Builder.class)
...
public final class OutputField extends TypedObject {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OutputField model) {
