...
public final class DataAssetFromLakeDetails extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromLakeDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromLakeDetails defaultConnection) {
        ...
        public DataAssetFromLakeDetails build() {
            DataAssetFromLakeDetails model =
                    new DataAssetFromLakeDetails(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromLakeDetails model) {
    ...
    @Deprecated
    public DataAssetFromLakeDetails(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            ConnectionFromLakeDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromLakeDetails defaultConnection;

    public ConnectionFromLakeDetails getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromLakeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromLakeDetails)) {
            return false;
        }

        DataAssetFromLakeDetails other = (DataAssetFromLakeDetails) o;
