...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetTaskScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTaskScheduleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200430")
public class GetTaskScheduleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetTaskScheduleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetTaskScheduleRequest o) {
        ...
        /**
         * Build the instance of GetTaskScheduleRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetTaskScheduleRequest
         */
        public GetTaskScheduleRequest build() {
            GetTaskScheduleRequest request = buildWithoutInvocationCallback();
        ...
        public GetTaskScheduleRequest buildWithoutInvocationCallback() {
            GetTaskScheduleRequest request = new GetTaskScheduleRequest();
            request.workspaceId = workspaceId;
            request.applicationKey = applicationKey;
            request.taskScheduleKey = taskScheduleKey;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetTaskScheduleRequest(workspaceId, applicationKey, taskScheduleKey, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTaskScheduleRequest)) {
            return false;
        }

        GetTaskScheduleRequest other = (GetTaskScheduleRequest) o;
