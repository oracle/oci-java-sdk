...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/GetTaskScheduleExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTaskScheduleRequest.
 */
...
public class GetTaskScheduleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetTaskScheduleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetTaskScheduleRequest(workspaceId, applicationKey, taskScheduleKey,
            // opcRequestId);
        }
    }
