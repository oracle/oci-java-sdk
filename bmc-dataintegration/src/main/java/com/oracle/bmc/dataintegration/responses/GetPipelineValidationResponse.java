...
public class GetPipelineValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.dataintegration.model.PipelineValidation getPipelineValidation() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPipelineValidationResponse> {
         ...
         * @return this builder
         */
        public Builder pipelineValidation(
                com.oracle.bmc.dataintegration.model.PipelineValidation pipelineValidation) {
            this.pipelineValidation = pipelineValidation;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",pipelineValidation=").append(String.valueOf(pipelineValidation));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPipelineValidationResponse)) {
            return false;
        }

        GetPipelineValidationResponse other = (GetPipelineValidationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.pipelineValidation, other.pipelineValidation);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.pipelineValidation == null
                                ? 43
                                : this.pipelineValidation.hashCode());
        return result;
    }
}
