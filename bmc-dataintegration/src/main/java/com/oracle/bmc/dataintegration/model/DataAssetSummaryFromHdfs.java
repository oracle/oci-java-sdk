...
/**
 * Summary details for the HDFS data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetSummaryFromHdfs.Builder.class)
...
public final class DataAssetSummaryFromHdfs extends DataAssetSummary {
    ...
    public static class Builder {
        ...
        public DataAssetSummaryFromHdfs build() {
            DataAssetSummaryFromHdfs model =
                    new DataAssetSummaryFromHdfs(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
    ...
    @Deprecated
    public DataAssetSummaryFromHdfs(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            ConnectionSummaryFromHdfs defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    public boolean equals(Object o) {
        ...
        DataAssetSummaryFromHdfs other = (DataAssetSummaryFromHdfs) o;
