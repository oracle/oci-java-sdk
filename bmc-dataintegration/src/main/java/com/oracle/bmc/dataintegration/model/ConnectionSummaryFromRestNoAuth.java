...
/**
 * The connection summary for a no auth rest connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromRestNoAuth.Builder.class)
...
public final class ConnectionSummaryFromRestNoAuth extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromRestNoAuth build() {
            ConnectionSummaryFromRestNoAuth model =
                    new ConnectionSummaryFromRestNoAuth(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromRestNoAuth model) {
    ...
    @Deprecated
    public ConnectionSummaryFromRestNoAuth(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromRestNoAuth(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromRestNoAuth)) {
            return false;
        }

        ConnectionSummaryFromRestNoAuth other = (ConnectionSummaryFromRestNoAuth) o;
