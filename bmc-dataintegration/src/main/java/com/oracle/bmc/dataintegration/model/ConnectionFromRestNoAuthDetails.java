...
/**
 * The connection details for a no auth rest connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromRestNoAuthDetails.Builder.class)
...
public final class ConnectionFromRestNoAuthDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromRestNoAuthDetails build() {
            ConnectionFromRestNoAuthDetails model =
                    new ConnectionFromRestNoAuthDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromRestNoAuthDetails model) {
    ...
    @Deprecated
    public ConnectionFromRestNoAuthDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromRestNoAuthDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromRestNoAuthDetails)) {
            return false;
        }

        ConnectionFromRestNoAuthDetails other = (ConnectionFromRestNoAuthDetails) o;
