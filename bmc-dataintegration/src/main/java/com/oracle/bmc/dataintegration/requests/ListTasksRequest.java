...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListTasksExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTasksRequest.
 */
...
public class ListTasksRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListTasksRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTasksRequest(workspaceId, opcRequestId, folderId, fields, name, key,
            // identifier, type, limit, page, sortOrder, sortBy);
        }
    }
