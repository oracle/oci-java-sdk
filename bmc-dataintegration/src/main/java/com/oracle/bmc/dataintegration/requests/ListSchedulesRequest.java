...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListSchedulesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSchedulesRequest.
 */
...
public class ListSchedulesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListSchedulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSchedulesRequest(workspaceId, applicationKey, key, name, identifier, type, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
