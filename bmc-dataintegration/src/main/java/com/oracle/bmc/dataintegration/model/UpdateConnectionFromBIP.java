...
/**
 * The details to update a Fusion applications BIP connection. <br>
...
public final class UpdateConnectionFromBIP extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromBIP model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromBIP(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromBIP)) {
            return false;
        }

        UpdateConnectionFromBIP other = (UpdateConnectionFromBIP) o;
