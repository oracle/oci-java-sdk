...
/**
 * The Function operator supports users adding a custom OCI Function into the data flow. <br>
...
public final class Function extends Operator {
    ...
    public static class Builder {
        ...
        public Builder copy(Function model) {
            ...
            if (model.wasPropertyExplicitlySet("ociFunction")) {
                this.ociFunction(model.getOciFunction());
            }
            return this;
        }
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("ociFunction")
    private final OciFunction ociFunction;

    public OciFunction getOciFunction() {
        return ociFunction;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", ociFunction=").append(String.valueOf(this.ociFunction));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.ociFunction, other.ociFunction) && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.ociFunction == null ? 43 : this.ociFunction.hashCode());
        return result;
    }
}
