...
/**
 * The connection details for the HDFS data asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromHdfs.Builder.class)
...
public final class ConnectionFromHdfs extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromHdfs build() {
            ConnectionFromHdfs model =
                    new ConnectionFromHdfs(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromHdfs model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromHdfs)) {
            return false;
        }

        ConnectionFromHdfs other = (ConnectionFromHdfs) o;
