...
/**
 * The error that occured while executing an operation that is tracked by a work request. <br>
...
public final class WorkRequestError
    ...
    public static class Builder {
        /**
         * A machine-usable code for the error that occured, as listed in [API
        ...
        /**
         * The date and time the error occured, in the timestamp format defined by [RFC
