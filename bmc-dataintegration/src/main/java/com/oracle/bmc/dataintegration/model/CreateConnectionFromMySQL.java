...
/**
 * The details to create a MYSQL data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateConnectionFromMySQL.Builder.class)
...
public final class CreateConnectionFromMySQL extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromMySQL build() {
            CreateConnectionFromMySQL model =
                    new CreateConnectionFromMySQL(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromMySQL model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateConnectionFromMySQL(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromMySQL)) {
            return false;
        }

        CreateConnectionFromMySQL other = (CreateConnectionFromMySQL) o;
