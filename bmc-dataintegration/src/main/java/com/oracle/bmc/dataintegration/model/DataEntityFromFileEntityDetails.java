...
/**
 * The file data entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntityFromFileEntityDetails.Builder.class)
...
public final class DataEntityFromFileEntityDetails extends DataEntityDetails {
    ...
    public static class Builder {
        ...
        public DataEntityFromFileEntityDetails build() {
            DataEntityFromFileEntityDetails model =
                    new DataEntityFromFileEntityDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromFileEntityDetails model) {
    ...
    @Deprecated
    public DataEntityFromFileEntityDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntityFromFileEntityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromFileEntityDetails)) {
            return false;
        }

        DataEntityFromFileEntityDetails other = (DataEntityFromFileEntityDetails) o;
