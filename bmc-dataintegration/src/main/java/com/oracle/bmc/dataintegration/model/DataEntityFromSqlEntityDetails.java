...
/**
 * The sql entity data entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntityFromSqlEntityDetails.Builder.class)
...
public final class DataEntityFromSqlEntityDetails extends DataEntityDetails {
    ...
    public static class Builder {
        ...
        public DataEntityFromSqlEntityDetails build() {
            DataEntityFromSqlEntityDetails model =
                    new DataEntityFromSqlEntityDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromSqlEntityDetails model) {
    ...
    @Deprecated
    public DataEntityFromSqlEntityDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntityFromSqlEntityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromSqlEntityDetails)) {
            return false;
        }

        DataEntityFromSqlEntityDetails other = (DataEntityFromSqlEntityDetails) o;
