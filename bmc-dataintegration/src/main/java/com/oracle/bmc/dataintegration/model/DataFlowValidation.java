...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataFlowValidation.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DataFlowValidation extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public DataFlowValidation build() {
            DataFlowValidation model =
                    new DataFlowValidation(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataFlowValidation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataFlowValidation)) {
            return false;
        }

        DataFlowValidation other = (DataFlowValidation) o;
