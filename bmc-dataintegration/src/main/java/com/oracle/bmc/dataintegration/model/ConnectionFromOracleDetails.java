...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromOracleDetails.Builder.class
)
...
public final class ConnectionFromOracleDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromOracleDetails build() {
            ConnectionFromOracleDetails __instance__ =
                    new ConnectionFromOracleDetails(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromOracleDetails o) {
    ...
    public String toString() {
        ...
        sb.append("ConnectionFromOracleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromOracleDetails)) {
            return false;
        }

        ConnectionFromOracleDetails other = (ConnectionFromOracleDetails) o;
