...
public final class CreateConnectionFromObjectStorage extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateConnectionFromObjectStorage build() {
            CreateConnectionFromObjectStorage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateConnectionFromObjectStorage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionFromObjectStorage)) {
            return false;
        }

        CreateConnectionFromObjectStorage other = (CreateConnectionFromObjectStorage) o;
