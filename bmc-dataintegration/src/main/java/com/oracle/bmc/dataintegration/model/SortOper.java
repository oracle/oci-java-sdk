...
/**
 * The information about the sort operator. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SortOper.Builder.class)
...
public final class SortOper extends Operator {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("sortKey")
        private SortKey sortKey;

        public Builder sortKey(SortKey sortKey) {
            this.sortKey = sortKey;
            this.__explicitlySet__.add("sortKey");
            return this;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SortOper model) {
            ...
            if (model.wasPropertyExplicitlySet("sortKey")) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", sortKey=").append(String.valueOf(this.sortKey));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SortOper)) {
            return false;
        }

        SortOper other = (SortOper) o;
        return java.util.Objects.equals(this.sortKey, other.sortKey) && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.sortKey == null ? 43 : this.sortKey.hashCode());
        return result;
    }
}
