...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromLakehouseDetails.Builder.class)
...
public final class ConnectionFromLakehouseDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromLakehouseDetails build() {
            ConnectionFromLakehouseDetails model =
                    new ConnectionFromLakehouseDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromLakehouseDetails model) {
    ...
    @Deprecated
    public ConnectionFromLakehouseDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromLakehouseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromLakehouseDetails)) {
            return false;
        }

        ConnectionFromLakehouseDetails other = (ConnectionFromLakehouseDetails) o;
