...
/**
 * The connection details for a Lakehouse connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromLakehouse.Builder.class)
...
public final class ConnectionFromLakehouse extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromLakehouse build() {
            ConnectionFromLakehouse model =
                    new ConnectionFromLakehouse(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromLakehouse model) {
    ...
    @Deprecated
    public ConnectionFromLakehouse(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromLakehouse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromLakehouse)) {
            return false;
        }

        ConnectionFromLakehouse other = (ConnectionFromLakehouse) o;
