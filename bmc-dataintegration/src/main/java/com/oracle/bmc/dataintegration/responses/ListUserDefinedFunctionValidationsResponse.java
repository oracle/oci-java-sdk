...
public class ListUserDefinedFunctionValidationsResponse
    ...
    private ListUserDefinedFunctionValidationsResponse(
        ...
        this.userDefinedFunctionValidationSummaryCollection =
                userDefinedFunctionValidationSummaryCollection;
    }
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListUserDefinedFunctionValidationsResponse o) {
            ...
            userDefinedFunctionValidationSummaryCollection(
                    o.getUserDefinedFunctionValidationSummaryCollection());
    ...
    public String toString() {
        ...
        sb.append(",userDefinedFunctionValidationSummaryCollection=")
                .append(String.valueOf(userDefinedFunctionValidationSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUserDefinedFunctionValidationsResponse)) {
            return false;
        }

        ListUserDefinedFunctionValidationsResponse other =
                (ListUserDefinedFunctionValidationsResponse) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.userDefinedFunctionValidationSummaryCollection,
                        other.userDefinedFunctionValidationSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userDefinedFunctionValidationSummaryCollection == null
                                ? 43
                                : this.userDefinedFunctionValidationSummaryCollection.hashCode());
        return result;
    }
}
