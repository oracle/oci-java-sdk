...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListFunctionLibrariesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFunctionLibrariesRequest.
 */
...
public class ListFunctionLibrariesRequest
    ...
    public static class Builder
        ...
        public ListFunctionLibrariesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFunctionLibrariesRequest(workspaceId, opcRequestId, aggregatorKey, fields, name, identifier, page, limit, sortOrder, sortBy);
        }
    }
