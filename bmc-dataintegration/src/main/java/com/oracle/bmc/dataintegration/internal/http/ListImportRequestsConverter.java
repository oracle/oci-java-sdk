...
public class ListImportRequestsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListImportRequestsConverter.class);

    public static com.oracle.bmc.dataintegration.requests.ListImportRequestsRequest
            interceptRequest(
                    com.oracle.bmc.dataintegration.requests.ListImportRequestsRequest request) {
        ...
        if (request.getImportStatus() != null) {
            target =
                    target.queryParam(
                            "importStatus",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getImportStatus().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dataintegration.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dataintegration.responses.ListImportRequestsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dataintegration.responses.ListImportRequestsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.dataintegration.responses
                                                        .ListImportRequestsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.importRequestSummaryCollection(response.getItem());
