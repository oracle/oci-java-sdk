...
public class DeleteWorkspaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public DeleteWorkspaceResponse build() {
            return new DeleteWorkspaceResponse(__httpStatusCode__, opcRequestId, opcWorkRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWorkspaceResponse)) {
            return false;
        }

        DeleteWorkspaceResponse other = (DeleteWorkspaceResponse) o;
