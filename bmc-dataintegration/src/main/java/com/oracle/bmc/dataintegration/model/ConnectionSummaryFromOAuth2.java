...
/**
 * The connection summary for a OAuth connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionSummaryFromOAuth2.Builder.class)
...
public final class ConnectionSummaryFromOAuth2 extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ConnectionSummaryFromOAuth2 build() {
            ConnectionSummaryFromOAuth2 model =
                    new ConnectionSummaryFromOAuth2(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionSummaryFromOAuth2 model) {
    ...
    @Deprecated
    public ConnectionSummaryFromOAuth2(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionSummaryFromOAuth2(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionSummaryFromOAuth2)) {
            return false;
        }

        ConnectionSummaryFromOAuth2 other = (ConnectionSummaryFromOAuth2) o;
