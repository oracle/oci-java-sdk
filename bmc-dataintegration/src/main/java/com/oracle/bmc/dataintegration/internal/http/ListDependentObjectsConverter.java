...
public class ListDependentObjectsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListDependentObjectsConverter.class);

    public static com.oracle.bmc.dataintegration.requests.ListDependentObjectsRequest
            interceptRequest(
                    com.oracle.bmc.dataintegration.requests.ListDependentObjectsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getTypeInSubtree() != null) {
            target =
                    target.queryParam(
                            "typeInSubtree",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getTypeInSubtree()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dataintegration.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dataintegration.responses.ListDependentObjectsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
