...
/**
 * Details for the Amazon s3 data asset type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDataAssetFromAmazonS3.Builder.class)
...
public final class UpdateDataAssetFromAmazonS3 extends UpdateDataAssetDetails {
    ...
    @Deprecated
    public UpdateDataAssetFromAmazonS3(
            String key,
            String modelVersion,
            String name,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataAssetFromAmazonS3)) {
            return false;
        }
