...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDataAssetFromOracleEbs.Builder.class)
...
public final class CreateDataAssetFromOracleEbs extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromOracleEbs defaultConnection;

        public Builder defaultConnection(CreateConnectionFromOracleEbs defaultConnection) {
        ...
        public CreateDataAssetFromOracleEbs build() {
            CreateDataAssetFromOracleEbs model =
                    new CreateDataAssetFromOracleEbs(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromOracleEbs model) {
    ...
    @Deprecated
    public CreateDataAssetFromOracleEbs(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromOracleEbs defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromOracleEbs defaultConnection;

    public CreateConnectionFromOracleEbs getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromOracleEbs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromOracleEbs)) {
            return false;
        }

        CreateDataAssetFromOracleEbs other = (CreateDataAssetFromOracleEbs) o;
