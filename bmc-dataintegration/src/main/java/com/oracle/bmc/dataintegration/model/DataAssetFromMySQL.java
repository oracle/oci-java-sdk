...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataAssetFromMySQL.Builder.class
)
...
public final class DataAssetFromMySQL extends DataAsset {
    ...
    public static class Builder {
        ...
        private ConnectionFromMySQLDetails defaultConnection;

        public Builder defaultConnection(ConnectionFromMySQLDetails defaultConnection) {
        ...
        public DataAssetFromMySQL build() {
            DataAssetFromMySQL __instance__ =
                    new DataAssetFromMySQL(
                            key,
                            modelVersion,
                            name,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetFromMySQL o) {
    ...
    public DataAssetFromMySQL(
            ...
            String port,
            String serviceName,
            ConnectionFromMySQLDetails defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionFromMySQLDetails defaultConnection;

    public ConnectionFromMySQLDetails getDefaultConnection() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromMySQL)) {
            return false;
        }

        DataAssetFromMySQL other = (DataAssetFromMySQL) o;
