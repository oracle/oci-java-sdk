...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/ListRuntimePipelinesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRuntimePipelinesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200430")
public class ListRuntimePipelinesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListRuntimePipelinesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListRuntimePipelinesRequest o) {
        ...
        /**
         * Build the instance of ListRuntimePipelinesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRuntimePipelinesRequest
         */
        public ListRuntimePipelinesRequest build() {
            ListRuntimePipelinesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRuntimePipelinesRequest
         */
        public ListRuntimePipelinesRequest buildWithoutInvocationCallback() {
            ListRuntimePipelinesRequest request = new ListRuntimePipelinesRequest();
            ...
            return request;
            // new ListRuntimePipelinesRequest(workspaceId, applicationKey, opcRequestId, key, aggregatorKey, fields, name, identifier, page, limit, sortOrder, sortBy, aggregatorType, filter);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRuntimePipelinesRequest)) {
            return false;
        }

        ListRuntimePipelinesRequest other = (ListRuntimePipelinesRequest) o;
