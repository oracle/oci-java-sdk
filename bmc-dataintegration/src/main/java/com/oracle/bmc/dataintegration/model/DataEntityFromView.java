...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntityFromView.Builder.class)
...
public final class DataEntityFromView extends DataEntity {
    ...
    public static class Builder {
        ...
        public DataEntityFromView build() {
            DataEntityFromView model =
                    new DataEntityFromView(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromView model) {
