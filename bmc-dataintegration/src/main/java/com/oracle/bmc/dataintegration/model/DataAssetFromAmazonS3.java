...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataAssetFromAmazonS3.Builder.class)
...
public final class DataAssetFromAmazonS3 extends DataAsset {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataAssetFromAmazonS3(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetFromAmazonS3)) {
            return false;
        }
