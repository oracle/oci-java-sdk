...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateDataAssetFromLake.Builder.class
)
...
public final class CreateDataAssetFromLake extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromLake defaultConnection;

        public Builder defaultConnection(CreateConnectionFromLake defaultConnection) {
        ...
        public CreateDataAssetFromLake build() {
            CreateDataAssetFromLake model =
                    new CreateDataAssetFromLake(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromLake model) {
    ...
    @Deprecated
    public CreateDataAssetFromLake(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromLake defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromLake defaultConnection;

    public CreateConnectionFromLake getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromLake(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromLake)) {
            return false;
        }

        CreateDataAssetFromLake other = (CreateDataAssetFromLake) o;
