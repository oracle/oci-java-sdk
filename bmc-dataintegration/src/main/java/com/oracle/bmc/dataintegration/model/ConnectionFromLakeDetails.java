...
/**
 * The connection details for a Lake connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromLakeDetails.Builder.class)
...
public final class ConnectionFromLakeDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromLakeDetails build() {
            ConnectionFromLakeDetails model =
                    new ConnectionFromLakeDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromLakeDetails model) {
    ...
    @Deprecated
    public ConnectionFromLakeDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConnectionFromLakeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromLakeDetails)) {
            return false;
        }

        ConnectionFromLakeDetails other = (ConnectionFromLakeDetails) o;
