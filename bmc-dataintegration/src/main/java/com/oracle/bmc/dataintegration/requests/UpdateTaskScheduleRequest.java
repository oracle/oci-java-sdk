...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataintegration/UpdateTaskScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateTaskScheduleRequest.
 */
...
public class UpdateTaskScheduleRequest
    ...
    public static class Builder
        ...
        public UpdateTaskScheduleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateTaskScheduleRequest(workspaceId, applicationKey, taskScheduleKey, updateTaskScheduleDetails, ifMatch, opcRequestId);
        }
    }
