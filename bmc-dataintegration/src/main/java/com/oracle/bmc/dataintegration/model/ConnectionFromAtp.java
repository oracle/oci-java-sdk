...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConnectionFromAtp.Builder.class
)
...
public final class ConnectionFromAtp extends Connection {
    ...
    public static class Builder {
        ...
        public ConnectionFromAtp build() {
            ConnectionFromAtp __instance__ =
                    new ConnectionFromAtp(
                            key,
                            modelVersion,
                            parentRef,
                            name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConnectionFromAtp o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectionFromAtp)) {
            return false;
        }

        ConnectionFromAtp other = (ConnectionFromAtp) o;
