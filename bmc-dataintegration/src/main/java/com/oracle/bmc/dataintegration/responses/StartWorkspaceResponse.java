...
public class StartWorkspaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StartWorkspaceResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartWorkspaceResponse)) {
            return false;
        }

        StartWorkspaceResponse other = (StartWorkspaceResponse) o;
