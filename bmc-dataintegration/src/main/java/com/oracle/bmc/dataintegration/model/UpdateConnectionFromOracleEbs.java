...
/**
 * The details to update E-Business Suite data asset connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateConnectionFromOracleEbs.Builder.class)
...
public final class UpdateConnectionFromOracleEbs extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateConnectionFromOracleEbs build() {
            UpdateConnectionFromOracleEbs model =
                    new UpdateConnectionFromOracleEbs(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateConnectionFromOracleEbs model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateConnectionFromOracleEbs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConnectionFromOracleEbs)) {
            return false;
        }

        UpdateConnectionFromOracleEbs other = (UpdateConnectionFromOracleEbs) o;
