...
public class UpdateTaskFromOCIDataflowTask extends UpdateTaskDetails {
    ...
    public static class Builder {
        ...
        public UpdateTaskFromOCIDataflowTask build() {
            UpdateTaskFromOCIDataflowTask __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTaskFromOCIDataflowTask o) {
            Builder copiedBuilder =
                    key(o.getKey())
                            ...
                            .dataflowApplication(o.getDataflowApplication());
