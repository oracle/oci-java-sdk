...
/**
 * An operator for chosing pipeline path using a condition <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DecisionOperator.Builder.class)
...
public final class DecisionOperator extends Operator {
    ...
    public static class Builder {
        ...
        public DecisionOperator build() {
            DecisionOperator model =
                    new DecisionOperator(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DecisionOperator model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DecisionOperator)) {
            return false;
        }

        DecisionOperator other = (DecisionOperator) o;
