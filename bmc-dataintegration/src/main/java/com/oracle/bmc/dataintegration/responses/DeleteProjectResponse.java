...
public class DeleteProjectResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteProjectResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteProjectResponse o) {
        ...
        public DeleteProjectResponse build() {
            return new DeleteProjectResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteProjectResponse)) {
            return false;
        }

        DeleteProjectResponse other = (DeleteProjectResponse) o;
