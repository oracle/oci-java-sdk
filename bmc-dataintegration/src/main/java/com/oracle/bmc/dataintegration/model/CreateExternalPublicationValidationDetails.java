...
public final class CreateExternalPublicationValidationDetails
    ...
    public static class Builder {
        ...
        public CreateExternalPublicationValidationDetails build() {
            CreateExternalPublicationValidationDetails model =
                    new CreateExternalPublicationValidationDetails(this.key);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateExternalPublicationValidationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExternalPublicationValidationDetails)) {
            return false;
        }

        CreateExternalPublicationValidationDetails other =
                (CreateExternalPublicationValidationDetails) o;
