...
public final class CreateExternalPublicationValidationDetails {
    ...
    public static class Builder {
        ...
        public CreateExternalPublicationValidationDetails build() {
            CreateExternalPublicationValidationDetails __instance__ =
                    new CreateExternalPublicationValidationDetails(key);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateExternalPublicationValidationDetails o) {
