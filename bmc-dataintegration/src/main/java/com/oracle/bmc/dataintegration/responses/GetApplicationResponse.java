...
public class GetApplicationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public com.oracle.bmc.dataintegration.model.Application getApplication() {
        return application;
    }
    ...
    public static class Builder {
        ...
        public Builder application(com.oracle.bmc.dataintegration.model.Application application) {
            this.application = application;
            return this;
        }
        ...
        public GetApplicationResponse build() {
            return new GetApplicationResponse(__httpStatusCode__, etag, opcRequestId, application);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApplicationResponse)) {
            return false;
        }
