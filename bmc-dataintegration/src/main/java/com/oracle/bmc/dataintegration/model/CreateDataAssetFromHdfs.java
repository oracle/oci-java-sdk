...
public final class CreateDataAssetFromHdfs extends CreateDataAssetDetails {
    ...
    public static class Builder {
        ...
        private CreateConnectionFromHdfs defaultConnection;

        public Builder defaultConnection(CreateConnectionFromHdfs defaultConnection) {
        ...
        public CreateDataAssetFromHdfs build() {
            CreateDataAssetFromHdfs model =
                    new CreateDataAssetFromHdfs(
                            this.key,
                            this.modelVersion,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDataAssetFromHdfs model) {
    ...
    @Deprecated
    public CreateDataAssetFromHdfs(
            String key,
            String modelVersion,
            String name,
            String description,
            ...
            CreateConnectionFromHdfs defaultConnection) {
        super(
                key,
                modelVersion,
                name,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final CreateConnectionFromHdfs defaultConnection;

    public CreateConnectionFromHdfs getDefaultConnection() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDataAssetFromHdfs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDataAssetFromHdfs)) {
            return false;
        }

        CreateDataAssetFromHdfs other = (CreateDataAssetFromHdfs) o;
