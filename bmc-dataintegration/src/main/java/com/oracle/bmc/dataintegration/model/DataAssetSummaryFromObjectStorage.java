...
/**
 * Summary details for the Oracle Object storage data asset type. <br>
...
public final class DataAssetSummaryFromObjectStorage extends DataAssetSummary {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("defaultConnection")
    private final ConnectionSummaryFromObjectStorage defaultConnection;

    public ConnectionSummaryFromObjectStorage getDefaultConnection() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataAssetSummaryFromObjectStorage)) {
            return false;
        }

        DataAssetSummaryFromObjectStorage other = (DataAssetSummaryFromObjectStorage) o;
