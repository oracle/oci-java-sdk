...
public class GetTaskScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetTaskScheduleResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTaskScheduleResponse> {
         ...
         */
        @Override
        public Builder copy(GetTaskScheduleResponse o) {
         ...
         */
        @Override
        public GetTaskScheduleResponse build() {
            return new GetTaskScheduleResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, taskSchedule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTaskScheduleResponse)) {
            return false;
        }

        GetTaskScheduleResponse other = (GetTaskScheduleResponse) o;
