...
/**
 * The connection details for a basic auth rest connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConnectionFromRestBasicAuthDetails.Builder.class)
...
public final class ConnectionFromRestBasicAuthDetails extends ConnectionDetails {
    ...
    public static class Builder {
        ...
        public ConnectionFromRestBasicAuthDetails build() {
            ConnectionFromRestBasicAuthDetails model =
                    new ConnectionFromRestBasicAuthDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
    ...
    public boolean equals(Object o) {
        ...
        ConnectionFromRestBasicAuthDetails other = (ConnectionFromRestBasicAuthDetails) o;
