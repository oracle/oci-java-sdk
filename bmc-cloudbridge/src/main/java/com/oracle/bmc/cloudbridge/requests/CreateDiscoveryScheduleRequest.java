...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/CreateDiscoveryScheduleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateDiscoveryScheduleRequest.
 */
...
public class CreateDiscoveryScheduleRequest
    ...
    public static class Builder
        ...
        public CreateDiscoveryScheduleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateDiscoveryScheduleRequest(createDiscoveryScheduleDetails, opcRetryToken, opcRequestId);
        }
    }
