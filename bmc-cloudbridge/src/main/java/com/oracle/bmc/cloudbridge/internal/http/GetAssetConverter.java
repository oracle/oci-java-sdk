...
public class GetAssetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAssetConverter.class);

    public static com.oracle.bmc.cloudbridge.requests.GetAssetRequest interceptRequest(
            com.oracle.bmc.cloudbridge.requests.GetAssetRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cloudbridge.responses.GetAssetResponse>() {
                            @Override
                            public com.oracle.bmc.cloudbridge.responses.GetAssetResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudbridge.responses.GetAssetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
