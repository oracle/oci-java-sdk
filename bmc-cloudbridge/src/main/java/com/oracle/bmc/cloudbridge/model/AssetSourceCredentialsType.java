...
public enum AssetSourceCredentialsType implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AssetSourceCredentialsType.class);
    ...
    public static AssetSourceCredentialsType create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'AssetSourceCredentialsType', returning UnknownEnumValue",
                key);
