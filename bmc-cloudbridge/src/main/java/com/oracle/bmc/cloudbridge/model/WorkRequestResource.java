...
/**
 * A resource that a work request creates and operates on. <br>
...
public final class WorkRequestResource
    ...
    public static class Builder {
         ...
         * work is complete for that resource. At that point, the resource will transition to
     ...
     * is complete for that resource. At that point, the resource will transition to CREATED,
