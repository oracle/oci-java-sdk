...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only resources for which the lifecycleState matches the given
     * OperationStatus.
     */
    private com.oracle.bmc.cloudbridge.model.OperationStatus status;

    /**
     * A filter to return only resources for which the lifecycleState matches the given
     * OperationStatus.
     */
    public com.oracle.bmc.cloudbridge.model.OperationStatus getStatus() {
        return status;
    }
    ...
    /**
     * The field to sort by. Only one sort order can be provided. By default, the order for
    ...
    public static class Builder
         ...
         * OperationStatus.
         */
        private com.oracle.bmc.cloudbridge.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.cloudbridge.model.OperationStatus status) {
            this.status = status;
            return this;
        }
