...
/**
 * The type describes the configuration of a virtual network interface. <br>
...
public final class OlvmNicConfiguration
    ...
    public static class Builder {
        ...
        /**
         * Specifies whether the network interface should be activated on the virtual machine guest
