...
/**
 * Volume Group of the host storage <br>
...
public final class VolumeGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "logicalUnits"})
    public VolumeGroup(String id, java.util.List<LogicalUnit> logicalUnits) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public VolumeGroup build() {
            VolumeGroup model = new VolumeGroup(this.id, this.logicalUnits);
