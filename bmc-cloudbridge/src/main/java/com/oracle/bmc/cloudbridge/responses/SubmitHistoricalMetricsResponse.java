...
public class SubmitHistoricalMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.cloudbridge.model.HistoricalMetricCollection
            getHistoricalMetricCollection() {
        return historicalMetricCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder historicalMetricCollection(
                com.oracle.bmc.cloudbridge.model.HistoricalMetricCollection
                        historicalMetricCollection) {
            this.historicalMetricCollection = historicalMetricCollection;
            return this;
        ...
        public Builder copy(SubmitHistoricalMetricsResponse o) {
            ...
            historicalMetricCollection(o.getHistoricalMetricCollection());
    ...
    public String toString() {
        ...
        sb.append(",historicalMetricCollection=")
                .append(String.valueOf(historicalMetricCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubmitHistoricalMetricsResponse)) {
            return false;
        }

        SubmitHistoricalMetricsResponse other = (SubmitHistoricalMetricsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.historicalMetricCollection, other.historicalMetricCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.historicalMetricCollection == null
                                ? 43
                                : this.historicalMetricCollection.hashCode());
        return result;
    }
}
