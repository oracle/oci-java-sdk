...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * scoped to the same compartment as the resource that the work request affects. If the work
     ...
     * affects multiple resources, and these resources are not in the same compartment, the service
     * team can choose the primary resource whose compartment should be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
