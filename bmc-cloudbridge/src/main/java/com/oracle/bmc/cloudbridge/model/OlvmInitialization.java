...
/**
 * Type representing initialization configuration of a virtual machine. <br>
...
public final class OlvmInitialization
    ...
    public static class Builder {
        ...
        /**
         * Defines the values for the cloud-init protocol. This protocol decides how the cloud-init
         * network parameters are formatted before being passed to the virtual machine in order to
         * be processed by cloud-init.
         */
    ...
    /**
     * Defines the values for the cloud-init protocol. This protocol decides how the cloud-init
     * network parameters are formatted before being passed to the virtual machine in order to be
     * processed by cloud-init.
     */
    public enum CloudInitNetworkProtocol implements com.oracle.bmc.http.internal.BmcEnum {
        Eni("ENI"),
