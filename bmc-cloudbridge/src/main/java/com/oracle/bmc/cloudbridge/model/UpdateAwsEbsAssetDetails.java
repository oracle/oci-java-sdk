...
/**
 * The information of AWS EBS asset to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAwsEbsAssetDetails.Builder.class)
...
public final class UpdateAwsEbsAssetDetails extends UpdateAssetDetails {
    ...
    public static class Builder {
        ...
        public UpdateAwsEbsAssetDetails build() {
            UpdateAwsEbsAssetDetails model =
                    new UpdateAwsEbsAssetDetails(
                            this.displayName,
                            this.assetSourceIds,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAwsEbsAssetDetails model) {
    ...
    @Deprecated
    public UpdateAwsEbsAssetDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAwsEbsAssetDetails)) {
            return false;
        }

        UpdateAwsEbsAssetDetails other = (UpdateAwsEbsAssetDetails) o;
