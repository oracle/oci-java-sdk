...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/AnalyzeAssetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AnalyzeAssetsRequest.
 */
...
public class AnalyzeAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public AnalyzeAssetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AnalyzeAssetsRequest(compartmentId, aggregationProperties, limit, page, lifecycleState, sourceKey, externalAssetKey, assetType, sortOrder, opcRequestId, groupBy, inventoryId, assetClassName, assetClassVersion);
        }
    }
