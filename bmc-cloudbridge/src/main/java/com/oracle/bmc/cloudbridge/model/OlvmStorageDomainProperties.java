...
/**
 * OLVM Storage Domain properties. <br>
...
public final class OlvmStorageDomainProperties
    ...
    public static class Builder {
        ...
        /**
         * Indicates whether disks' blocks on block storage domains will be discarded right before
         * they are deleted.
         */
        ...
        /**
         * Indicates whether a block storage domain supports the property that discard zeroes the
         * data.
         */
        ...
        /**
         * If the free space available on the storage domain is below this percentage, warning
    ...
    /**
     * Indicates whether disks' blocks on block storage domains will be discarded right before they
     * are deleted.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isDiscardAfterDelete")
    ...
    /**
     * If the free space available on the storage domain is below this percentage, warning messages
     * are displayed to the user and logged.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("warningLowSpaceIndicatorInPercentage")
    ...
    /** Status of storage domain. */
    public enum StorageDomainStatus implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    /** Indicates the kind of data managed by a storage domain. */
    public enum StorageDomainType implements com.oracle.bmc.http.internal.BmcEnum {
        Data("DATA"),
        Export("EXPORT"),
        Image("IMAGE"),
        Iso("ISO"),
