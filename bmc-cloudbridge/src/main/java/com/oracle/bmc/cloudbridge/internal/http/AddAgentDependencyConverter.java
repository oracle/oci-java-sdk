...
public class AddAgentDependencyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AddAgentDependencyConverter.class);

    public static com.oracle.bmc.cloudbridge.requests.AddAgentDependencyRequest interceptRequest(
            com.oracle.bmc.cloudbridge.requests.AddAgentDependencyRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cloudbridge.responses.AddAgentDependencyResponse>() {
                            @Override
                            public com.oracle.bmc.cloudbridge.responses.AddAgentDependencyResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudbridge.responses.AddAgentDependencyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.cloudbridge.responses.AddAgentDependencyResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.cloudbridge.responses
                                                        .AddAgentDependencyResponse.builder()
