...
/**
 * Logical grouping of memory-related properties of virtual machine-like entities. <br>
...
public final class OlvmMemoryPolicy
    ...
    public static class Builder {
        ...
        /**
         * The amount of memory, in bytes, that is guaranteed to not be drained by the balloon
         * mechanism
         */
