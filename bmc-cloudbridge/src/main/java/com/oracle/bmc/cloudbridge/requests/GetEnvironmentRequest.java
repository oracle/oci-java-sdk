...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/GetEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetEnvironmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220509")
public class GetEnvironmentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetEnvironmentRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetEnvironmentRequest
         */
        public GetEnvironmentRequest build() {
            GetEnvironmentRequest request = buildWithoutInvocationCallback();
        ...
        public GetEnvironmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetEnvironmentRequest(environmentId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().environmentId(environmentId).opcRequestId(opcRequestId);
    }
