...
public class GetPluginResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPluginResponse> {
         ...
         */
        @Override
        public Builder copy(GetPluginResponse o) {
        ...
        public GetPluginResponse build() {
            return new GetPluginResponse(__httpStatusCode__, headers, etag, opcRequestId, plugin);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPluginResponse)) {
            return false;
        }

        GetPluginResponse other = (GetPluginResponse) o;
