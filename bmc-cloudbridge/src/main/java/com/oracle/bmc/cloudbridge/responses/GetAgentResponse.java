...
public class GetAgentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.cloudbridge.model.Agent agent;
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudbridge.model.Agent getAgent() {
        return agent;
    }
    ...
    private GetAgentResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.cloudbridge.model.Agent agent) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAgentResponse> {
         ...
         * @return this builder
         */
        public Builder agent(com.oracle.bmc.cloudbridge.model.Agent agent) {
            this.agent = agent;
            return this;
        }
        ...
        public GetAgentResponse build() {
            return new GetAgentResponse(__httpStatusCode__, headers, etag, opcRequestId, agent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAgentResponse)) {
            return false;
        }
