...
public class InventoryClient implements Inventory {
    ...
    public AnalyzeAssetsResponse analyzeAssets(AnalyzeAssetsRequest request) {
        LOG.trace("Called analyzeAssets");
    ...
    public ChangeAssetCompartmentResponse changeAssetCompartment(
        ...
        LOG.trace("Called changeAssetCompartment");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeAssetCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ChangeAssetTagsResponse changeAssetTags(ChangeAssetTagsRequest request) {
        LOG.trace("Called changeAssetTags");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeAssetTagsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateAssetDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateInventoryResponse createInventory(CreateInventoryRequest request) {
        LOG.trace("Called createInventory");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateInventoryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteInventoryResponse deleteInventory(DeleteInventoryRequest request) {
        LOG.trace("Called deleteInventory");
    ...
    public ImportInventoryResponse importInventory(ImportInventoryRequest request) {
        LOG.trace("Called importInventory");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getImportInventoryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ListHistoricalMetricsResponse listHistoricalMetrics(
        ...
        LOG.trace("Called listHistoricalMetrics");
    ...
    public ListInventoriesResponse listInventories(ListInventoriesRequest request) {
        LOG.trace("Called listInventories");
    ...
    public SubmitHistoricalMetricsResponse submitHistoricalMetrics(
        ...
        LOG.trace("Called submitHistoricalMetrics");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getSubmitHistoricalMetricsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateAssetDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateInventoryResponse updateInventory(UpdateInventoryRequest request) {
        LOG.trace("Called updateInventory");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateInventoryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
