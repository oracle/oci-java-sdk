...
public final class OlvmVirtualMachine
    ...
    public static class Builder {
        ...
        /**
         * If true, the virtual machine has been started using the run once command, meaning
         * it\u2019s configuration might differ from the stored one for the purpose of this single
         * run.
         */
    ...
    /**
     * If true, the virtual machine is reconfigured to the latest version of it\u2019s template when
     * it is started.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isUseLatestTemplateVersion")
