...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/ListAgentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAgentsRequest.
 */
...
public class ListAgentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.cloudbridge.model.Agent.LifecycleState lifecycleState;

    /**
     * A filter to return only resources their lifecycleState matches the given lifecycleState.
     */
    public com.oracle.bmc.cloudbridge.model.Agent.LifecycleState getLifecycleState() {
    ...
    public static class Builder
         ...
         * A filter to return only resources their lifecycleState matches the given lifecycleState.
         */
        private com.oracle.bmc.cloudbridge.model.Agent.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.cloudbridge.model.Agent.LifecycleState lifecycleState) {
        ...
        public ListAgentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAgentsRequest(compartmentId, environmentId, lifecycleState, displayName, agentId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
