...
public final class OlvmDisplay extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    /**
     * The secured port address on the guest, in case of using TLS, to connect the graphic console
     * client to.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("securePort")
    ...
    /** The graphic console protocol type. */
    public enum DisplayType implements com.oracle.bmc.http.internal.BmcEnum {
        Spice("SPICE"),
        Vnc("VNC"),
        ;
