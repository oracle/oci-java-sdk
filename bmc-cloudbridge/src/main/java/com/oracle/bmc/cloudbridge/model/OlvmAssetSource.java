...
/**
 * OLVM asset source. Used for discovery of clusters and storage domains registered in the OLVM
 * environment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OlvmAssetSource.Builder.class)
...
public final class OlvmAssetSource extends AssetSource {
    ...
    public static class Builder {
        ...
        public OlvmAssetSource build() {
            OlvmAssetSource model =
                    new OlvmAssetSource(
                            this.id,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OlvmAssetSource model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OlvmAssetSource)) {
            return false;
        }

        OlvmAssetSource other = (OlvmAssetSource) o;
