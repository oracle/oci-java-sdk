...
/**
 * Represents a cluster fencing policy. <br>
...
public final class OlvmFencingPolicy
    ...
    public static class Builder {
        ...
        /**
         * A flag indicating if fencing should be skipped if Gluster bricks are up and running in
        ...
        /**
         * A flag indicating if fencing should be skipped if Gluster bricks are up and running and
         * Gluster quorum will not be met without those bricks.
         */
    ...
    /**
     * A flag indicating if fencing should be skipped if Gluster bricks are up and running in the
     * host being fenced.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isSkipIfGlusterBricksUp")
