...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/UpdateEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateEnvironmentRequest.
 */
...
public class UpdateEnvironmentRequest
    ...
    public com.oracle.bmc.cloudbridge.model.UpdateEnvironmentDetails getBody$() {
        return updateEnvironmentDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateEnvironmentDetails(
                com.oracle.bmc.cloudbridge.model.UpdateEnvironmentDetails
                        updateEnvironmentDetails) {
            this.updateEnvironmentDetails = updateEnvironmentDetails;
            return this;
        }
        ...
        public Builder copy(UpdateEnvironmentRequest o) {
            ...
            updateEnvironmentDetails(o.getUpdateEnvironmentDetails());
        ...
        public UpdateEnvironmentRequest build() {
            UpdateEnvironmentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.cloudbridge.model.UpdateEnvironmentDetails body) {
            updateEnvironmentDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateEnvironmentRequest
         */
        public UpdateEnvironmentRequest buildWithoutInvocationCallback() {
            UpdateEnvironmentRequest request = new UpdateEnvironmentRequest();
            request.environmentId = environmentId;
            request.updateEnvironmentDetails = updateEnvironmentDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateEnvironmentDetails=")
                .append(String.valueOf(this.updateEnvironmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEnvironmentRequest)) {
            return false;
        }

        UpdateEnvironmentRequest other = (UpdateEnvironmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.environmentId, other.environmentId)
                && java.util.Objects.equals(
                        this.updateEnvironmentDetails, other.updateEnvironmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateEnvironmentDetails == null
                                ? 43
                                : this.updateEnvironmentDetails.hashCode());
