...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/ChangeEnvironmentCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeEnvironmentCompartmentRequest.
 */
...
public class ChangeEnvironmentCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeEnvironmentCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeEnvironmentCompartmentRequest(environmentId, changeEnvironmentCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
