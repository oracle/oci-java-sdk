...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudbridge/AddAgentDependencyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddAgentDependencyRequest.
 */
...
public class AddAgentDependencyRequest
    ...
    public com.oracle.bmc.cloudbridge.model.AddAgentDependencyDetails getBody$() {
        return addAgentDependencyDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder addAgentDependencyDetails(
                com.oracle.bmc.cloudbridge.model.AddAgentDependencyDetails
                        addAgentDependencyDetails) {
            this.addAgentDependencyDetails = addAgentDependencyDetails;
            return this;
        }
        ...
        public Builder copy(AddAgentDependencyRequest o) {
            ...
            addAgentDependencyDetails(o.getAddAgentDependencyDetails());
         ...
         */
        public AddAgentDependencyRequest build() {
            AddAgentDependencyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.cloudbridge.model.AddAgentDependencyDetails body) {
            addAgentDependencyDetails(body);
            return this;
        }
         ...
         * @return instance of AddAgentDependencyRequest
         */
        public AddAgentDependencyRequest buildWithoutInvocationCallback() {
            AddAgentDependencyRequest request = new AddAgentDependencyRequest();
            request.environmentId = environmentId;
            request.addAgentDependencyDetails = addAgentDependencyDetails;
    ...
    public String toString() {
        ...
        sb.append(",addAgentDependencyDetails=")
                .append(String.valueOf(this.addAgentDependencyDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddAgentDependencyRequest)) {
            return false;
        }

        AddAgentDependencyRequest other = (AddAgentDependencyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.environmentId, other.environmentId)
                && java.util.Objects.equals(
                        this.addAgentDependencyDetails, other.addAgentDependencyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.addAgentDependencyDetails == null
                                ? 43
                                : this.addAgentDependencyDetails.hashCode());
