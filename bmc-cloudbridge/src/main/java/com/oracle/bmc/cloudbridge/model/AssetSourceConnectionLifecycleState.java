...
public enum AssetSourceConnectionLifecycleState implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AssetSourceConnectionLifecycleState.class);
    ...
    public static AssetSourceConnectionLifecycleState create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'AssetSourceConnectionLifecycleState', returning UnknownEnumValue",
                key);
