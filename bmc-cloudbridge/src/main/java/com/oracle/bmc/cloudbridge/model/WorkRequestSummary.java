...
public final class WorkRequestSummary
    ...
    public static class Builder {
         ...
         * request affects multiple resources, and these resources are not in the same compartment,
         * the service team can choose the primary resource whose compartment should be used.
         */
        ...
        /**
         * The date and time when the request was created, as described in [RFC
        ...
        /**
         * The date and time when the request started, as described in [RFC
         * 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
         */
        ...
        /**
         * The date and time when the object was complete, as described in [RFC
     ...
     * multiple resources, and these resources are not in the same compartment, the service team can
     * choose the primary resource whose compartment should be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
