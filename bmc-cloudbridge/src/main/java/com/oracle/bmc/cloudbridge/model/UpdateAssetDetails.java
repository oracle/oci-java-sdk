...
/**
 * The information of asset to be updated. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            ...
            name = "VM"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateAwsEbsAssetDetails.class,
            name = "AWS_EBS"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateVmwareVmAssetDetails.class,
            name = "VMWARE_VM"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateAwsEc2AssetDetails.class,
            name = "AWS_EC2")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class UpdateAssetDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
