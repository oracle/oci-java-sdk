...
/**
 * A JSON formatted type of asset. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = InventoryAsset.Builder.class)
...
public final class InventoryAsset extends Asset {
    ...
    public static class Builder {
        ...
        public InventoryAsset build() {
            InventoryAsset model =
                    new InventoryAsset(
                            this.displayName,
                            this.inventoryId,
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InventoryAsset model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InventoryAsset)) {
            return false;
        }

        InventoryAsset other = (InventoryAsset) o;
