...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMirrorConfigurationDetails.Builder.class)
...
public final class UpdateMirrorConfigurationDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMirrorConfigurationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMirrorConfigurationDetails)) {
            return false;
        }

        UpdateMirrorConfigurationDetails other = (UpdateMirrorConfigurationDetails) o;
