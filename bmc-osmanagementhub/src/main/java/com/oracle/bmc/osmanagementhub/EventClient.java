...
public class EventClient implements Event {
    ...
    public ChangeEventCompartmentResponse changeEventCompartment(
        ...
        LOG.trace("Called changeEventCompartment");
        final ChangeEventCompartmentRequest interceptedRequest =
                ChangeEventCompartmentConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeEventCompartmentConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ChangeEventCompartmentResponse>
                transformer =
                        ChangeEventCompartmentConverter.fromResponse(
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeEventCompartmentDetails(),
                                                retriedRequest);
    ...
    public DeleteEventResponse deleteEvent(DeleteEventRequest request) {
        LOG.trace("Called deleteEvent");
        final DeleteEventRequest interceptedRequest =
                DeleteEventConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteEventConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteEventResponse> transformer =
                DeleteEventConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
    ...
    public ImportEventContentResponse importEventContent(ImportEventContentRequest request) {
        LOG.trace("Called importEventContent");
        final ImportEventContentRequest interceptedRequest =
                ImportEventContentConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ImportEventContentConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ImportEventContentResponse>
                transformer =
                        ImportEventContentConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
