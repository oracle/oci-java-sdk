...
/**
 * Provides the details for disabling a module stream on a managed instance group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DisableModuleStreamOnManagedInstanceGroupDetails.Builder.class)
...
public final class DisableModuleStreamOnManagedInstanceGroupDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DisableModuleStreamOnManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableModuleStreamOnManagedInstanceGroupDetails)) {
            return false;
        }

        DisableModuleStreamOnManagedInstanceGroupDetails other =
