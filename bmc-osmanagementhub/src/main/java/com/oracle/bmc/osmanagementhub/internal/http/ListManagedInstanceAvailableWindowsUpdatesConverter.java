...
public class ListManagedInstanceAvailableWindowsUpdatesConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    ListManagedInstanceAvailableWindowsUpdatesConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getIsInstallable() != null) {
            target =
                    target.queryParam(
                            "isInstallable",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getIsInstallable().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.ListManagedInstanceAvailableWindowsUpdatesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.availableWindowsUpdateCollection(response.getItem());
