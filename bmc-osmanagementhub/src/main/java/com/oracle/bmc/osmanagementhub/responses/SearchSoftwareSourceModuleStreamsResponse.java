...
public class SearchSoftwareSourceModuleStreamsResponse
    ...
    private SearchSoftwareSourceModuleStreamsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SearchSoftwareSourceModuleStreamsResponse o) {
         ...
         */
        public SearchSoftwareSourceModuleStreamsResponse build() {
            return new SearchSoftwareSourceModuleStreamsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchSoftwareSourceModuleStreamsResponse)) {
            return false;
        }

        SearchSoftwareSourceModuleStreamsResponse other =
                (SearchSoftwareSourceModuleStreamsResponse) o;
