...
public class GetManagedInstanceAnalyticContentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetManagedInstanceAnalyticContentConverter.class);

    public static com.oracle.bmc.osmanagementhub.requests.GetManagedInstanceAnalyticContentRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getInstanceLocation() != null) {
            target =
                    target.queryParam(
                            "instanceLocation",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getInstanceLocation().getValue()));
        }

        if (request.getSecurityUpdatesAvailableEqualsTo() != null) {
            target =
                    target.queryParam(
        ...
        if (request.getBugUpdatesAvailableEqualsTo() != null) {
            target =
                    target.queryParam(
        ...
        if (request.getBugUpdatesAvailableGreaterThan() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.GetManagedInstanceAnalyticContentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.osmanagementhub.responses
                                                .GetManagedInstanceAnalyticContentResponse.Builder
                                        builder =
                                                com.oracle.bmc.osmanagementhub.responses
                                                        .GetManagedInstanceAnalyticContentResponse
                                                        .builder()
