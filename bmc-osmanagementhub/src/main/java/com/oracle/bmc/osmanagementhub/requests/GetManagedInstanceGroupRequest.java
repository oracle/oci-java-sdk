...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/GetManagedInstanceGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetManagedInstanceGroupRequest.
 */
...
public class GetManagedInstanceGroupRequest
    ...
    public static class Builder
        ...
        public GetManagedInstanceGroupRequest buildWithoutInvocationCallback() {
            GetManagedInstanceGroupRequest request = new GetManagedInstanceGroupRequest();
            request.managedInstanceGroupId = managedInstanceGroupId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetManagedInstanceGroupRequest(managedInstanceGroupId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetManagedInstanceGroupRequest)) {
            return false;
        }

        GetManagedInstanceGroupRequest other = (GetManagedInstanceGroupRequest) o;
