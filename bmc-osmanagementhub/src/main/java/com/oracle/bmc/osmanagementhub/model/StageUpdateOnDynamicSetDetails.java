...
/**
 * Provides the information used to stage updates on a dynamic set. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StageUpdateOnDynamicSetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StageUpdateOnDynamicSetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"updateTypes", "managedInstances", "workRequestDetails"})
    public StageUpdateOnDynamicSetDetails(
    ...
    public static class Builder {
        ...
        public StageUpdateOnDynamicSetDetails build() {
            StageUpdateOnDynamicSetDetails model =
                    new StageUpdateOnDynamicSetDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageUpdateOnDynamicSetDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StageUpdateOnDynamicSetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageUpdateOnDynamicSetDetails)) {
            return false;
        }

        StageUpdateOnDynamicSetDetails other = (StageUpdateOnDynamicSetDetails) o;
