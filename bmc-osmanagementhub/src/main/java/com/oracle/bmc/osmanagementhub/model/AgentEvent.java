...
/**
 * Provides information about the agent event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AgentEvent.Builder.class)
...
public final class AgentEvent extends Event {
    ...
    public static class Builder {
        ...
        private AgentEventData data;

        public Builder data(AgentEventData data) {
            this.data = data;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgentEvent model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final AgentEventData data;

    public AgentEventData getData() {
        return data;
    }
