 ...
 * to any list operations of DynamicSet where multiple pages of data may be fetched.
...
public class DynamicSetPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDynamicSets operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.osmanagementhub.model.DynamicSetSummary} objects
     * contained in responses from the listDynamicSets operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.osmanagementhub.model.DynamicSetSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listManagedInstancesInDynamicSet operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListManagedInstancesInDynamicSetResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                ListManagedInstancesInDynamicSetRequest, ListManagedInstancesInDynamicSetResponse>(
     ...
     * contained in responses from the listManagedInstancesInDynamicSet operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
