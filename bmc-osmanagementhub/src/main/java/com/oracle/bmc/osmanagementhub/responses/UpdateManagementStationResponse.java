...
public class UpdateManagementStationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateManagementStationResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateManagementStationResponse o) {
         ...
         */
        public UpdateManagementStationResponse build() {
            return new UpdateManagementStationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, managementStation);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagementStationResponse)) {
            return false;
        }

        UpdateManagementStationResponse other = (UpdateManagementStationResponse) o;
