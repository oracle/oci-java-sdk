...
/**
 * Provides the information used to detach the software sources from the managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DetachSoftwareSourcesFromManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DetachSoftwareSourcesFromManagedInstanceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"softwareSources", "workRequestDetails"})
    public DetachSoftwareSourcesFromManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public DetachSoftwareSourcesFromManagedInstanceDetails build() {
            DetachSoftwareSourcesFromManagedInstanceDetails model =
                    new DetachSoftwareSourcesFromManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetachSoftwareSourcesFromManagedInstanceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DetachSoftwareSourcesFromManagedInstanceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachSoftwareSourcesFromManagedInstanceDetails)) {
            return false;
        }

        DetachSoftwareSourcesFromManagedInstanceDetails other =
                (DetachSoftwareSourcesFromManagedInstanceDetails) o;
