...
public final class VersionedCustomSoftwareSource extends SoftwareSource {
    ...
    public static class Builder {
        ...
        public VersionedCustomSoftwareSource build() {
            VersionedCustomSoftwareSource model =
                    new VersionedCustomSoftwareSource(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VersionedCustomSoftwareSource model) {
    ...
    @Deprecated
    public VersionedCustomSoftwareSource(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VersionedCustomSoftwareSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VersionedCustomSoftwareSource)) {
            return false;
        }

        VersionedCustomSoftwareSource other = (VersionedCustomSoftwareSource) o;
