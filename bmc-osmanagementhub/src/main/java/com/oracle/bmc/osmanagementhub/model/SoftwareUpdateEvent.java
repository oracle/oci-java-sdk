...
/**
 * Provides information for a software update event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SoftwareUpdateEvent.Builder.class)
...
public final class SoftwareUpdateEvent extends Event {
    ...
    public static class Builder {
        ...
        public SoftwareUpdateEvent build() {
            SoftwareUpdateEvent model =
                    new SoftwareUpdateEvent(
                            this.id,
                            this.eventSummary,
                            this.compartmentId,
                            this.eventDetails,
    ...
    public boolean equals(Object o) {
        ...
        SoftwareUpdateEvent other = (SoftwareUpdateEvent) o;
