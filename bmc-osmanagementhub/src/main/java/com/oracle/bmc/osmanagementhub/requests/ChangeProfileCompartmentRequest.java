...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ChangeProfileCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeProfileCompartmentRequest.
 */
...
public class ChangeProfileCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeProfileCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeProfileCompartmentRequest(profileId, changeProfileCompartmentDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
