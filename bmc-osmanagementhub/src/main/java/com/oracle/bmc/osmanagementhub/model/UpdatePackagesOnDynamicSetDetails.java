...
/**
 * Provides the information used to update software packages on a dynamic set. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdatePackagesOnDynamicSetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdatePackagesOnDynamicSetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"updateTypes", "managedInstances", "workRequestDetails"})
    public UpdatePackagesOnDynamicSetDetails(
    ...
    public static class Builder {
        ...
        public UpdatePackagesOnDynamicSetDetails build() {
            UpdatePackagesOnDynamicSetDetails model =
                    new UpdatePackagesOnDynamicSetDetails(
                            this.updateTypes, this.managedInstances, this.workRequestDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePackagesOnDynamicSetDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePackagesOnDynamicSetDetails)) {
            return false;
        }

        UpdatePackagesOnDynamicSetDetails other = (UpdatePackagesOnDynamicSetDetails) o;
