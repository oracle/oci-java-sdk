...
public interface EventAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeEventCompartmentResponse> changeEventCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteEventResponse> deleteEvent(
            DeleteEventRequest request,
            com.oracle.bmc.responses.AsyncHandler<DeleteEventRequest, DeleteEventResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ImportEventContentResponse> importEventContent(
