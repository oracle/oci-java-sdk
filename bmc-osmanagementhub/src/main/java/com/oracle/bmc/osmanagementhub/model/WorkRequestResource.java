...
public final class WorkRequestResource extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public WorkRequestResource(
            TargetResourceEntityType entityType,
    ...
    public static class Builder {
        ...
        private TargetResourceEntityType entityType;
         ...
         * @return this builder
         **/
        public Builder entityType(TargetResourceEntityType entityType) {
            this.entityType = entityType;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("entityType")
    private final TargetResourceEntityType entityType;

    /**
     * The resource type that the work request affects.
     * @return the value
     **/
    public TargetResourceEntityType getEntityType() {
        return entityType;
    }
