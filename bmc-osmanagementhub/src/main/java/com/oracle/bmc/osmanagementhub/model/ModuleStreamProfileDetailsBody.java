...
/**
 * The details of the module stream profile to be installed/removed on a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ModuleStreamProfileDetailsBody.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ModuleStreamProfileDetailsBody
    ...
    public ModuleStreamProfileDetailsBody(
            String moduleName,
            String streamName,
            String profileName,
    ...
    public static class Builder {
        ...
        public ModuleStreamProfileDetailsBody build() {
            ModuleStreamProfileDetailsBody model =
                    new ModuleStreamProfileDetailsBody(
                            this.moduleName,
                            this.streamName,
                            this.profileName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ModuleStreamProfileDetailsBody model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ModuleStreamProfileDetailsBody(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModuleStreamProfileDetailsBody)) {
            return false;
        }

        ModuleStreamProfileDetailsBody other = (ModuleStreamProfileDetailsBody) o;
