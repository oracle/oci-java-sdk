...
/**
 * The details about the software sources to be attached/detached. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SoftwareSourcesDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SoftwareSourcesDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"softwareSources", "workRequestDetails"})
    public SoftwareSourcesDetails(
    ...
    public static class Builder {
        ...
        public SoftwareSourcesDetails build() {
            SoftwareSourcesDetails model =
                    new SoftwareSourcesDetails(this.softwareSources, this.workRequestDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SoftwareSourcesDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SoftwareSourcesDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SoftwareSourcesDetails)) {
            return false;
        }

        SoftwareSourcesDetails other = (SoftwareSourcesDetails) o;
