...
public class ListManagedInstanceGroupAvailablePackagesResponse
    ...
    public com.oracle.bmc.osmanagementhub.model.ManagedInstanceGroupAvailablePackageCollection
            getManagedInstanceGroupAvailablePackageCollection() {
        return managedInstanceGroupAvailablePackageCollection;
    }
    ...
    private ListManagedInstanceGroupAvailablePackagesResponse(
        ...
        this.managedInstanceGroupAvailablePackageCollection =
                managedInstanceGroupAvailablePackageCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder managedInstanceGroupAvailablePackageCollection(
                com.oracle.bmc.osmanagementhub.model.ManagedInstanceGroupAvailablePackageCollection
                        managedInstanceGroupAvailablePackageCollection) {
            this.managedInstanceGroupAvailablePackageCollection =
                    managedInstanceGroupAvailablePackageCollection;
        ...
        public Builder copy(ListManagedInstanceGroupAvailablePackagesResponse o) {
            ...
            managedInstanceGroupAvailablePackageCollection(
                    o.getManagedInstanceGroupAvailablePackageCollection());
    ...
    public String toString() {
        ...
        sb.append(",managedInstanceGroupAvailablePackageCollection=")
                .append(String.valueOf(managedInstanceGroupAvailablePackageCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedInstanceGroupAvailablePackagesResponse)) {
            return false;
        }

        ListManagedInstanceGroupAvailablePackagesResponse other =
                (ListManagedInstanceGroupAvailablePackagesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.managedInstanceGroupAvailablePackageCollection,
                        other.managedInstanceGroupAvailablePackageCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.managedInstanceGroupAvailablePackageCollection == null
                                ? 43
                                : this.managedInstanceGroupAvailablePackageCollection.hashCode());
        return result;
    }
}
