...
/**
 * Updatable settings for the Autonomous Linux service. This is required when creating an Autonomous
 * Linux Managed Instance Group. Do not include it when creating a standard (non-Autonomous) Managed
 * Instance Group. <br>
