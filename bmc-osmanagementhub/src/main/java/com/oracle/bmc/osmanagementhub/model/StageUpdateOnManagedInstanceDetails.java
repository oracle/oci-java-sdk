...
/**
 * Provides the information used to stage updates on an instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StageUpdateOnManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StageUpdateOnManagedInstanceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames", "updateTypes", "workRequestDetails"})
    public StageUpdateOnManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public StageUpdateOnManagedInstanceDetails build() {
            StageUpdateOnManagedInstanceDetails model =
                    new StageUpdateOnManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageUpdateOnManagedInstanceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StageUpdateOnManagedInstanceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageUpdateOnManagedInstanceDetails)) {
            return false;
        }

        StageUpdateOnManagedInstanceDetails other = (StageUpdateOnManagedInstanceDetails) o;
