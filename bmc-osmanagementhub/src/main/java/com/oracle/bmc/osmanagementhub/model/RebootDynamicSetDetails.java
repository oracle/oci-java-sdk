...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RebootDynamicSetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RebootDynamicSetDetails
    ...
    public RebootDynamicSetDetails(
    ...
    public static class Builder {
        ...
        public RebootDynamicSetDetails build() {
            RebootDynamicSetDetails model =
                    new RebootDynamicSetDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RebootDynamicSetDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RebootDynamicSetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebootDynamicSetDetails)) {
            return false;
        }

        RebootDynamicSetDetails other = (RebootDynamicSetDetails) o;
