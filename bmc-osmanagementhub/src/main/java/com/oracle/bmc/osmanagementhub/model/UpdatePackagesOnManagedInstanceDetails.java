...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdatePackagesOnManagedInstanceDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdatePackagesOnManagedInstanceDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames", "updateTypes", "workRequestDetails"})
    public UpdatePackagesOnManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public UpdatePackagesOnManagedInstanceDetails build() {
            UpdatePackagesOnManagedInstanceDetails model =
                    new UpdatePackagesOnManagedInstanceDetails(
                            this.packageNames, this.updateTypes, this.workRequestDetails);
    ...
    public boolean equals(Object o) {
        ...
        UpdatePackagesOnManagedInstanceDetails other = (UpdatePackagesOnManagedInstanceDetails) o;
