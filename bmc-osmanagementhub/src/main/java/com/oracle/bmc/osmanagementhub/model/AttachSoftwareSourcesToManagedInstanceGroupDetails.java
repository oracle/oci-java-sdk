...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AttachSoftwareSourcesToManagedInstanceGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AttachSoftwareSourcesToManagedInstanceGroupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"softwareSources", "workRequestDetails"})
    public AttachSoftwareSourcesToManagedInstanceGroupDetails(
    ...
    public static class Builder {
        ...
        public AttachSoftwareSourcesToManagedInstanceGroupDetails build() {
            AttachSoftwareSourcesToManagedInstanceGroupDetails model =
                    new AttachSoftwareSourcesToManagedInstanceGroupDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachSoftwareSourcesToManagedInstanceGroupDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AttachSoftwareSourcesToManagedInstanceGroupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachSoftwareSourcesToManagedInstanceGroupDetails)) {
            return false;
        }

        AttachSoftwareSourcesToManagedInstanceGroupDetails other =
                (AttachSoftwareSourcesToManagedInstanceGroupDetails) o;
