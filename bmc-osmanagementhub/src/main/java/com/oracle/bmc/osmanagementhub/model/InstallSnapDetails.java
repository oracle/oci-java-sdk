...
/**
 * Provides the information used to install a snap. <br>
...
public final class InstallSnapDetails
    ...
    public static class Builder {
        /**
         * The snap channel to install from (e.g. stable, 1.2/edge, beta, candidate, or a custom
         * channel).
         */
        ...
        /**
         * If false, allows installing snaps not signed by the Snap Store. E.g., snaps from local
    ...
    /**
     * If false, allows installing snaps not signed by the Snap Store. E.g., snaps from local file.
     * Use with caution.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isSigned")
