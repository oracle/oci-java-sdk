...
public class GetSoftwareSourceManifestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetSoftwareSourceManifestResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetSoftwareSourceManifestResponse o) {
         ...
         */
        @Override
        public GetSoftwareSourceManifestResponse build() {
            return new GetSoftwareSourceManifestResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSoftwareSourceManifestResponse)) {
            return false;
        }

        GetSoftwareSourceManifestResponse other = (GetSoftwareSourceManifestResponse) o;
