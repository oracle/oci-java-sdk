...
public class PreviewManagedInstancesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(PreviewManagedInstancesResponse o) {
         ...
         */
        public PreviewManagedInstancesResponse build() {
            return new PreviewManagedInstancesResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PreviewManagedInstancesResponse)) {
            return false;
        }

        PreviewManagedInstancesResponse other = (PreviewManagedInstancesResponse) o;
