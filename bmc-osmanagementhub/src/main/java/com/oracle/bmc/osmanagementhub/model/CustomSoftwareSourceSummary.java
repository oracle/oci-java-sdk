...
/**
 * A custom software source contains a custom collection of packages. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CustomSoftwareSourceSummary.Builder.class)
...
public final class CustomSoftwareSourceSummary extends SoftwareSourceSummary {
    ...
    public static class Builder {
        ...
        public CustomSoftwareSourceSummary build() {
            CustomSoftwareSourceSummary model =
                    new CustomSoftwareSourceSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.repoId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomSoftwareSourceSummary model) {
    ...
    @Deprecated
    public CustomSoftwareSourceSummary(
            String id,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomSoftwareSourceSummary)) {
            return false;
        }
