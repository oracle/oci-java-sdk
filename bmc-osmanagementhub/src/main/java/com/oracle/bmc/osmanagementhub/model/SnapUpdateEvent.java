...
/**
 * Provides information for a snap update event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SnapUpdateEvent.Builder.class)
...
public final class SnapUpdateEvent extends Event {
    ...
    public static class Builder {
        ...
        private SnapUpdateEventData data;

        public Builder data(SnapUpdateEventData data) {
            this.data = data;
        ...
        public SnapUpdateEvent build() {
            SnapUpdateEvent model =
                    new SnapUpdateEvent(
                            this.id,
                            this.eventSummary,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SnapUpdateEvent model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final SnapUpdateEventData data;

    public SnapUpdateEventData getData() {
        return data;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnapUpdateEvent)) {
            return false;
        }

        SnapUpdateEvent other = (SnapUpdateEvent) o;
