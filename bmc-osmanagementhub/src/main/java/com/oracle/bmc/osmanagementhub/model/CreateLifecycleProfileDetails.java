...
/**
 * Description of a lifecycle registration profile to be created. <br>
...
public final class CreateLifecycleProfileDetails extends CreateProfileDetails {
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the lifecycle stage from which the registration profile will inherit its
         * software source.
         */
    ...
    /**
     * The OCID of the lifecycle stage from which the registration profile will inherit its software
     * source.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleStageId")
