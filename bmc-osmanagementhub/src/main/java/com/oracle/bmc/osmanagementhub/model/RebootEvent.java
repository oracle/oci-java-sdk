...
/**
 * Provides information for a reboot event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RebootEvent.Builder.class)
...
public final class RebootEvent extends Event {
    ...
    public static class Builder {
        ...
        private RebootEventData data;

        public Builder data(RebootEventData data) {
            this.data = data;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RebootEvent model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final RebootEventData data;

    public RebootEventData getData() {
        return data;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebootEvent)) {
            return false;
        }

        RebootEvent other = (RebootEvent) o;
