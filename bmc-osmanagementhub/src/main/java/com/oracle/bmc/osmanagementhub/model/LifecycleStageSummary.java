...
/**
 * Provides summary information for a lifecycle stage. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LifecycleStageSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class LifecycleStageSummary
    ...
    public static class Builder {
        ...
        /**
         * The user-friendly name for the lifecycle environment. Does not have to be unique, and
        ...
        public LifecycleStageSummary build() {
            LifecycleStageSummary model =
                    new LifecycleStageSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.lifecycleEnvironmentId,
                            this.lifecycleEnvironmentDisplayName,
                            this.rank,
                            this.osFamily,
                            this.archType,
                            this.vendorName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LifecycleStageSummary model) {
            ...
            if (model.wasPropertyExplicitlySet("lifecycleEnvironmentDisplayName")) {
                this.lifecycleEnvironmentDisplayName(model.getLifecycleEnvironmentDisplayName());
            }
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the compartment that contains the lifecycle stage.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the lifecycle environment that contains the lifecycle stage.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleEnvironmentId")
    ...
    /**
     * The user-friendly name for the lifecycle environment. Does not have to be unique, and it's
    ...
    public String getLifecycleEnvironmentDisplayName() {
        return lifecycleEnvironmentDisplayName;
    }
    ...
    /**
     * The time the lifecycle stage was created (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339)
     * format).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeCreated")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", lifecycleEnvironmentDisplayName=")
                .append(String.valueOf(this.lifecycleEnvironmentDisplayName));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LifecycleStageSummary)) {
            return false;
        }

        LifecycleStageSummary other = (LifecycleStageSummary) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(
                        this.lifecycleEnvironmentDisplayName, other.lifecycleEnvironmentDisplayName)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.lifecycleEnvironmentDisplayName == null
                                ? 43
                                : this.lifecycleEnvironmentDisplayName.hashCode());
