...
public class GetEventResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.osmanagementhub.model.Event event;
     ...
     * @return the value
     */
    public com.oracle.bmc.osmanagementhub.model.Event getEvent() {
        return event;
    }
    ...
    private GetEventResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.osmanagementhub.model.Event event) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetEventResponse> {
         ...
         * @return this builder
         */
        public Builder event(com.oracle.bmc.osmanagementhub.model.Event event) {
            this.event = event;
            return this;
        }
        ...
        public GetEventResponse build() {
            return new GetEventResponse(__httpStatusCode__, headers, etag, opcRequestId, event);
        }
    }
