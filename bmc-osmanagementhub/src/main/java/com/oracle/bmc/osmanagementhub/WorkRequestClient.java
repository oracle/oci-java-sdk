...
public class WorkRequestClient implements WorkRequest {
    /**
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("WorkRequest-waiters-%d")
                                    .build());
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, WorkRequestClient> {
    ...
    @Override
    public RerunWorkRequestResponse rerunWorkRequest(RerunWorkRequestRequest request) {
        LOG.trace("Called rerunWorkRequest");
        final RerunWorkRequestRequest interceptedRequest =
                RerunWorkRequestConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                RerunWorkRequestConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RerunWorkRequestResponse>
                transformer =
                        RerunWorkRequestConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRerunWorkRequestDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
