...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A filter to return the resources whose parent resources are not the same as the given resource OCID(s).
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        public ListWorkRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWorkRequestsRequest(compartmentId, workRequestId, status, resourceId, opcRequestId, page, limit, sortOrder, sortBy, initiatorId, parentId, parentResourcesNotEqualTo, operationType, displayNameContains);
        }
    }
