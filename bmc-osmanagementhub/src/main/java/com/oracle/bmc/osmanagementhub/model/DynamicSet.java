...
/**
 * An object that defines the dynamic set. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DynamicSet.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DynamicSet extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public DynamicSet(
            ...
            java.util.List<TargetCompartmentDetails> targetCompartments,
            MatchType matchType,
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * compartment that contains the dynamic set.
         */
        ...
        /**
         * The date and time the dynamic set was created (in [RFC
        ...
        /**
         * The date and time the dynamic set was last updated (in [RFC
         * 3339](https://tools.ietf.org/rfc/rfc3339) format).
         */
        ...
        private java.util.List<TargetCompartmentDetails> targetCompartments;

        /**
         * The list of compartment details.
         *
         * @param targetCompartments the value to set
         * @return this builder
         */
        public Builder targetCompartments(
                java.util.List<TargetCompartmentDetails> targetCompartments) {
            this.targetCompartments = targetCompartments;
        ...
        public Builder matchingRule(MatchingRule matchingRule) {
            this.matchingRule = matchingRule;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DynamicSet model) {
    ...
    /** Number of scheduled jobs currently targeting this dynamic set. */
    @com.fasterxml.jackson.annotation.JsonProperty("scheduledJobCount")
    private final String scheduledJobCount;
     ...
     * @return the value
     */
    public String getScheduledJobCount() {
        return scheduledJobCount;
    }

    /** The list of compartment details. */
    @com.fasterxml.jackson.annotation.JsonProperty("targetCompartments")
    private final java.util.List<TargetCompartmentDetails> targetCompartments;
     ...
     * @return the value
     */
    public java.util.List<TargetCompartmentDetails> getTargetCompartments() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DynamicSet)) {
            return false;
        }

        DynamicSet other = (DynamicSet) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.matchType, other.matchType)
