...
/**
 * Provides the information used to install, remove, or update software packages. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SoftwarePackagesDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SoftwarePackagesDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames", "workRequestDetails"})
    public SoftwarePackagesDetails(
    ...
    public static class Builder {
        ...
        public SoftwarePackagesDetails build() {
            SoftwarePackagesDetails model =
                    new SoftwarePackagesDetails(this.packageNames, this.workRequestDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SoftwarePackagesDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SoftwarePackagesDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SoftwarePackagesDetails)) {
            return false;
        }

        SoftwarePackagesDetails other = (SoftwarePackagesDetails) o;
