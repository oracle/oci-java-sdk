...
/**
 * Provides the information used to install software packages on a dynamic set. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstallPackagesOnDynamicSetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InstallPackagesOnDynamicSetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"managedInstances", "packageNames", "workRequestDetails"})
    public InstallPackagesOnDynamicSetDetails(
    ...
    public static class Builder {
        ...
        public InstallPackagesOnDynamicSetDetails build() {
            InstallPackagesOnDynamicSetDetails model =
                    new InstallPackagesOnDynamicSetDetails(
                            this.managedInstances, this.packageNames, this.workRequestDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstallPackagesOnDynamicSetDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstallPackagesOnDynamicSetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallPackagesOnDynamicSetDetails)) {
            return false;
        }

        InstallPackagesOnDynamicSetDetails other = (InstallPackagesOnDynamicSetDetails) o;
