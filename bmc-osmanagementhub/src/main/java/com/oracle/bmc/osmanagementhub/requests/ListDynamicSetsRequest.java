...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListDynamicSetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDynamicSetsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListDynamicSetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDynamicSetsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDynamicSetsRequest o) {
        ...
        /**
         * Build the instance of ListDynamicSetsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDynamicSetsRequest
         */
        public ListDynamicSetsRequest build() {
            ListDynamicSetsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDynamicSetsRequest
         */
        public ListDynamicSetsRequest buildWithoutInvocationCallback() {
            ListDynamicSetsRequest request = new ListDynamicSetsRequest();
            ...
            return request;
            // new ListDynamicSetsRequest(compartmentId, displayNameContains, displayName, dynamicSetId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDynamicSetsRequest)) {
            return false;
        }

        ListDynamicSetsRequest other = (ListDynamicSetsRequest) o;
