 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDynamicSetsRequest.
 */
...
public class ListDynamicSetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDynamicSetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDynamicSetsRequest(compartmentId, displayNameContains, displayName,
            // dynamicSetId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
