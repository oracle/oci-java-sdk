...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/AttachSoftwareSourcesToProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachSoftwareSourcesToProfileRequest.
 */
...
public class AttachSoftwareSourcesToProfileRequest
    ...
    public static class Builder
        ...
        public AttachSoftwareSourcesToProfileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AttachSoftwareSourcesToProfileRequest(profileId, attachSoftwareSourcesToProfileDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
