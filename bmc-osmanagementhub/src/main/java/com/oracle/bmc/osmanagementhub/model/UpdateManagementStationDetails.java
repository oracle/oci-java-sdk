...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateManagementStationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateManagementStationDetails
    ...
    public UpdateManagementStationDetails(
            String displayName,
            String description,
            String hostname,
    ...
    public static class Builder {
        ...
        private UpdateProxyConfigurationDetails proxy;

        public Builder proxy(UpdateProxyConfigurationDetails proxy) {
            this.proxy = proxy;
        ...
        private UpdateMirrorConfigurationDetails mirror;

        public Builder mirror(UpdateMirrorConfigurationDetails mirror) {
            this.mirror = mirror;
        ...
        public UpdateManagementStationDetails build() {
            UpdateManagementStationDetails model =
                    new UpdateManagementStationDetails(
                            this.displayName,
                            this.description,
                            this.hostname,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateManagementStationDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("proxy")
    private final UpdateProxyConfigurationDetails proxy;

    public UpdateProxyConfigurationDetails getProxy() {
        return proxy;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("mirror")
    private final UpdateMirrorConfigurationDetails mirror;

    public UpdateMirrorConfigurationDetails getMirror() {
        return mirror;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagementStationDetails)) {
            return false;
        }

        UpdateManagementStationDetails other = (UpdateManagementStationDetails) o;
