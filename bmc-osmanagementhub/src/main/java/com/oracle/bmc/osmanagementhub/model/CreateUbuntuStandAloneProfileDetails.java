...
/**
 * Provides the information used to create an Ubuntu standalone registration profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateUbuntuStandAloneProfileDetails.Builder.class)
...
public final class CreateUbuntuStandAloneProfileDetails extends CreateProfileDetails {
    ...
    public static class Builder {
        ...
        public CreateUbuntuStandAloneProfileDetails build() {
            CreateUbuntuStandAloneProfileDetails model =
                    new CreateUbuntuStandAloneProfileDetails(
                            this.displayName,
                            this.compartmentId,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateUbuntuStandAloneProfileDetails model) {
    ...
    @Deprecated
    public CreateUbuntuStandAloneProfileDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateUbuntuStandAloneProfileDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateUbuntuStandAloneProfileDetails)) {
            return false;
        }

        CreateUbuntuStandAloneProfileDetails other = (CreateUbuntuStandAloneProfileDetails) o;
