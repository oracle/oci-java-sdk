...
public final class PrivateSoftwareSource extends SoftwareSource {
    ...
    public static class Builder {
        ...
        public PrivateSoftwareSource build() {
            PrivateSoftwareSource model =
                    new PrivateSoftwareSource(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrivateSoftwareSource model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrivateSoftwareSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrivateSoftwareSource)) {
            return false;
        }

        PrivateSoftwareSource other = (PrivateSoftwareSource) o;
