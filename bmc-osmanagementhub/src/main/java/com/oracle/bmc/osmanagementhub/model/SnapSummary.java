...
/**
 * Provides summary information for a snap. <br>
...
public final class SnapSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The date and time of the snap's last refresh in [RFC
