...
/**
 * Provides the information used to download Windows updates of a specified type on managed
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StageWindowsUpdatesOnManagedInstancesInCompartmentDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StageWindowsUpdatesOnManagedInstancesInCompartmentDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"compartmentId", "windowsUpdateTypes", "workRequestDetails"})
    public StageWindowsUpdatesOnManagedInstancesInCompartmentDetails(
    ...
    public static class Builder {
        ...
        public StageWindowsUpdatesOnManagedInstancesInCompartmentDetails build() {
            StageWindowsUpdatesOnManagedInstancesInCompartmentDetails model =
                    new StageWindowsUpdatesOnManagedInstancesInCompartmentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageWindowsUpdatesOnManagedInstancesInCompartmentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StageWindowsUpdatesOnManagedInstancesInCompartmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageWindowsUpdatesOnManagedInstancesInCompartmentDetails)) {
            return false;
        }

        StageWindowsUpdatesOnManagedInstancesInCompartmentDetails other =
                (StageWindowsUpdatesOnManagedInstancesInCompartmentDetails) o;
