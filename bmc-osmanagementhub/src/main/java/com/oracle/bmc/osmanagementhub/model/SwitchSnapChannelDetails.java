...
/**
 * Provides the information used to switch a snap channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SwitchSnapChannelDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SwitchSnapChannelDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "channel"})
    public SwitchSnapChannelDetails(String name, String channel) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public SwitchSnapChannelDetails build() {
            SwitchSnapChannelDetails model = new SwitchSnapChannelDetails(this.name, this.channel);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchSnapChannelDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchSnapChannelDetails)) {
            return false;
        }

        SwitchSnapChannelDetails other = (SwitchSnapChannelDetails) o;
