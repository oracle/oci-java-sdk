 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetWindowsUpdateRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class GetWindowsUpdateRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {

    /**
     * The unique identifier for the Windows update. Note that this is not an OCID, but is a unique
    ...
    public static class Builder
        ...
        /**
         * The unique identifier for the Windows update. Note that this is not an OCID, but is a
