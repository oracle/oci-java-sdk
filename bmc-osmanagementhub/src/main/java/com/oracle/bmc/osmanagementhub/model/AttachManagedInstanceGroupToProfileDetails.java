...
/**
 * Provides the information used to attach a managed instance group to a profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AttachManagedInstanceGroupToProfileDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AttachManagedInstanceGroupToProfileDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"managedInstanceGroupId"})
    public AttachManagedInstanceGroupToProfileDetails(String managedInstanceGroupId) {
        super();
    ...
    public static class Builder {
        ...
        public AttachManagedInstanceGroupToProfileDetails build() {
            AttachManagedInstanceGroupToProfileDetails model =
                    new AttachManagedInstanceGroupToProfileDetails(this.managedInstanceGroupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachManagedInstanceGroupToProfileDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachManagedInstanceGroupToProfileDetails)) {
            return false;
        }

        AttachManagedInstanceGroupToProfileDetails other =
                (AttachManagedInstanceGroupToProfileDetails) o;
