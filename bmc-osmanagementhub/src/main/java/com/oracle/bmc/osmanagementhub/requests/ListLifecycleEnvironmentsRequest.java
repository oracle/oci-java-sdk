...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListLifecycleEnvironmentsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use
 * ListLifecycleEnvironmentsRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListLifecycleEnvironmentsRequest
    ...
    private com.oracle.bmc.osmanagementhub.model.LifecycleEnvironment.LifecycleState lifecycleState;

    /** A filter to return only the lifecycle environments that match the display name given. */
    public com.oracle.bmc.osmanagementhub.model.LifecycleEnvironment.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListLifecycleEnvironmentsRequest, java.lang.Void> {
        ...
        /** A filter to return only the lifecycle environments that match the display name given. */
        private com.oracle.bmc.osmanagementhub.model.LifecycleEnvironment.LifecycleState
                lifecycleState = null;
         ...
         * @return this builder instance
         */
        public Builder copy(ListLifecycleEnvironmentsRequest o) {
        ...
        /**
         * Build the instance of ListLifecycleEnvironmentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListLifecycleEnvironmentsRequest
         */
        public ListLifecycleEnvironmentsRequest build() {
            ListLifecycleEnvironmentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListLifecycleEnvironmentsRequest
         */
        public ListLifecycleEnvironmentsRequest buildWithoutInvocationCallback() {
            ListLifecycleEnvironmentsRequest request = new ListLifecycleEnvironmentsRequest();
            ...
            return request;
            // new ListLifecycleEnvironmentsRequest(compartmentId, displayName, displayNameContains,
            // lifecycleEnvironmentId, archType, osFamily, location, locationNotEqualTo, limit,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListLifecycleEnvironmentsRequest)) {
            return false;
        }

        ListLifecycleEnvironmentsRequest other = (ListLifecycleEnvironmentsRequest) o;
