...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RebootManagedInstanceGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RebootManagedInstanceGroupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"rebootTimeoutInMins", "workRequestDetails"})
    public RebootManagedInstanceGroupDetails(
    ...
    public static class Builder {
         ...
         * the group don't reboot within this time, the reboot job status is set to failed.
         */
        ...
        public RebootManagedInstanceGroupDetails build() {
            RebootManagedInstanceGroupDetails model =
                    new RebootManagedInstanceGroupDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RebootManagedInstanceGroupDetails model) {
     ...
     * group don't reboot within this time, the reboot job status is set to failed.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("rebootTimeoutInMins")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RebootManagedInstanceGroupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebootManagedInstanceGroupDetails)) {
            return false;
        }

        RebootManagedInstanceGroupDetails other = (RebootManagedInstanceGroupDetails) o;
