...
/**
 * Summary information pertaining to an installed package on a managed instance group. <br>
...
public final class ManagedInstanceGroupInstalledPackageSummary
    ...
    public static class Builder {
        ...
        public ManagedInstanceGroupInstalledPackageSummary build() {
            ManagedInstanceGroupInstalledPackageSummary model =
                    new ManagedInstanceGroupInstalledPackageSummary(this.name, this.architecture);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedInstanceGroupInstalledPackageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedInstanceGroupInstalledPackageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedInstanceGroupInstalledPackageSummary)) {
            return false;
        }

        ManagedInstanceGroupInstalledPackageSummary other =
                (ManagedInstanceGroupInstalledPackageSummary) o;
