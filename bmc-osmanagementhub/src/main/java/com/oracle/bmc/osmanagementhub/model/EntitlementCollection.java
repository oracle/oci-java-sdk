...
public final class EntitlementCollection
    ...
    public static class Builder {
        ...
        public EntitlementCollection build() {
            EntitlementCollection model = new EntitlementCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntitlementCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntitlementCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntitlementCollection)) {
            return false;
        }

        EntitlementCollection other = (EntitlementCollection) o;
