...
/**
 * The details of the user-friendly names to be used for actions. <br>
...
public final class WorkRequestDetails
    ...
    public static class Builder {
        /**
         * A user-friendly name for the resulting job. Does not have to be unique, and it's
        ...
        /**
         * User specified information about the resulting job. Does not have to be unique, and it's
         * changeable. Avoid entering confidential information.
         */
