...
/**
 * The managed instances to detach from the lifecycle stage. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DetachManagedInstancesFromLifecycleStageDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DetachManagedInstancesFromLifecycleStageDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"managedInstanceDetails"})
    public DetachManagedInstancesFromLifecycleStageDetails(
    ...
    public static class Builder {
        ...
        public DetachManagedInstancesFromLifecycleStageDetails build() {
            DetachManagedInstancesFromLifecycleStageDetails model =
                    new DetachManagedInstancesFromLifecycleStageDetails(
                            this.managedInstanceDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetachManagedInstancesFromLifecycleStageDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachManagedInstancesFromLifecycleStageDetails)) {
            return false;
        }

        DetachManagedInstancesFromLifecycleStageDetails other =
                (DetachManagedInstancesFromLifecycleStageDetails) o;
