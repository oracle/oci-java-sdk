...
/**
 * Provides information about the management station event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagementStationEvent.Builder.class)
...
public final class ManagementStationEvent extends Event {
    ...
    public static class Builder {
        ...
        private ManagementStationEventData data;

        public Builder data(ManagementStationEventData data) {
            this.data = data;
        ...
        public ManagementStationEvent build() {
            ManagementStationEvent model =
                    new ManagementStationEvent(
                            this.id,
                            this.eventSummary,
                            this.compartmentId,
                            this.eventDetails,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementStationEvent model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final ManagementStationEventData data;

    public ManagementStationEventData getData() {
        return data;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagementStationEvent(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementStationEvent)) {
            return false;
        }

        ManagementStationEvent other = (ManagementStationEvent) o;
