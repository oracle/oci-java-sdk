...
public final class CreateThirdPartySoftwareSourceDetails extends CreateSoftwareSourceDetails {
    ...
    public static class Builder {
        ...
        public CreateThirdPartySoftwareSourceDetails build() {
            CreateThirdPartySoftwareSourceDetails model =
                    new CreateThirdPartySoftwareSourceDetails(
                            this.compartmentId,
                            this.displayName,
                            this.description,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateThirdPartySoftwareSourceDetails model) {
    ...
    @Deprecated
    public CreateThirdPartySoftwareSourceDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateThirdPartySoftwareSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateThirdPartySoftwareSourceDetails)) {
            return false;
        }

        CreateThirdPartySoftwareSourceDetails other = (CreateThirdPartySoftwareSourceDetails) o;
        return java.util.Objects.equals(this.osFamily, other.osFamily)
