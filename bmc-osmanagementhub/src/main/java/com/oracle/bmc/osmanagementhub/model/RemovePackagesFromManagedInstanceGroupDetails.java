...
/**
 * The names of the packages to be removed from the managed instance group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemovePackagesFromManagedInstanceGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RemovePackagesFromManagedInstanceGroupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames", "workRequestDetails"})
    public RemovePackagesFromManagedInstanceGroupDetails(
    ...
    public static class Builder {
        ...
        public RemovePackagesFromManagedInstanceGroupDetails build() {
            RemovePackagesFromManagedInstanceGroupDetails model =
                    new RemovePackagesFromManagedInstanceGroupDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemovePackagesFromManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePackagesFromManagedInstanceGroupDetails)) {
            return false;
        }

        RemovePackagesFromManagedInstanceGroupDetails other =
                (RemovePackagesFromManagedInstanceGroupDetails) o;
