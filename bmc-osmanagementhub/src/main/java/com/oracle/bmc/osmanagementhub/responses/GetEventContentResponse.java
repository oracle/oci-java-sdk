...
public class GetEventContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetEventContentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEventContentResponse)) {
            return false;
        }

        GetEventContentResponse other = (GetEventContentResponse) o;
