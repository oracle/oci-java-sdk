...
/**
 * Provides the information used to detach software sources from a profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DetachSoftwareSourcesFromProfileDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DetachSoftwareSourcesFromProfileDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"softwareSources"})
    public DetachSoftwareSourcesFromProfileDetails(java.util.List<String> softwareSources) {
        super();
    ...
    public static class Builder {
        ...
        public DetachSoftwareSourcesFromProfileDetails build() {
            DetachSoftwareSourcesFromProfileDetails model =
                    new DetachSoftwareSourcesFromProfileDetails(this.softwareSources);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetachSoftwareSourcesFromProfileDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachSoftwareSourcesFromProfileDetails)) {
            return false;
        }

        DetachSoftwareSourcesFromProfileDetails other = (DetachSoftwareSourcesFromProfileDetails) o;
