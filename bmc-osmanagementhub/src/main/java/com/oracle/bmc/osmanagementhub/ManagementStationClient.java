...
public class ManagementStationClient implements ManagementStation {
    /**
     ...
     */
    protected ManagementStationClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateManagementStationDetails(),
                                                retriedRequest);
    ...
    public DeleteManagementStationResponse deleteManagementStation(
        ...
        LOG.trace("Called deleteManagementStation");
    ...
    public GetManagementStationResponse getManagementStation(GetManagementStationRequest request) {
        LOG.trace("Called getManagementStation");
    ...
    public ListManagementStationsResponse listManagementStations(
        ...
        LOG.trace("Called listManagementStations");
    ...
    public SynchronizeMirrorsResponse synchronizeMirrors(SynchronizeMirrorsRequest request) {
        LOG.trace("Called synchronizeMirrors");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getSynchronizeMirrorsDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public SynchronizeSingleMirrorsResponse synchronizeSingleMirrors(
        ...
        LOG.trace("Called synchronizeSingleMirrors");
    ...
    public UpdateManagementStationResponse updateManagementStation(
        ...
        LOG.trace("Called updateManagementStation");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateManagementStationDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
