...
/**
 * Provides the information used to disable a module stream on a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DisableModuleStreamOnManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DisableModuleStreamOnManagedInstanceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"moduleName", "streamName", "workRequestDetails"})
    public DisableModuleStreamOnManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public DisableModuleStreamOnManagedInstanceDetails build() {
            DisableModuleStreamOnManagedInstanceDetails model =
                    new DisableModuleStreamOnManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DisableModuleStreamOnManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableModuleStreamOnManagedInstanceDetails)) {
            return false;
        }

        DisableModuleStreamOnManagedInstanceDetails other =
                (DisableModuleStreamOnManagedInstanceDetails) o;
