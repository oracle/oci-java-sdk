...
public class DeleteEventResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteEventResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteEventResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteEventResponse)) {
            return false;
        }
