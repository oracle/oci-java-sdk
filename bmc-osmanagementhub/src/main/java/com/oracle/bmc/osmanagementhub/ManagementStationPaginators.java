 ...
 * to any list operations of ManagementStation where multiple pages of data may be fetched. Two
...
public class ManagementStationPaginators {
     ...
     * listManagementStations operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.osmanagementhub.model.ManagementStationSummary} objects contained in responses
     * from the listManagementStations operation. This iterable will fetch more data from the server
     * as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.osmanagementhub.model.ManagementStationSummary} objects contained in
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.osmanagementhub.model.MirrorSummary} objects contained in responses from the
     * listMirrors operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.osmanagementhub.model.MirrorSummary} objects contained in responses
     *     received from the service.
     */
