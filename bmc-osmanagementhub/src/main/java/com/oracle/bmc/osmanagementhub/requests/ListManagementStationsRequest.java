...
public class ListManagementStationsRequest
    ...
    public static class Builder
        ...
        public ListManagementStationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagementStationsRequest(compartmentId, displayName, displayNameContains, lifecycleState, managedInstanceId, limit, page, location, locationNotEqualTo, sortOrder, sortBy, opcRequestId, id, healthState);
        }
    }
