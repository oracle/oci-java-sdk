...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = StageUpdateOnAllManagedInstancesInCompartmentDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class StageUpdateOnAllManagedInstancesInCompartmentDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"compartmentId", "updateTypes", "workRequestDetails"})
    public StageUpdateOnAllManagedInstancesInCompartmentDetails(
    ...
    public static class Builder {
        ...
        public StageUpdateOnAllManagedInstancesInCompartmentDetails build() {
            StageUpdateOnAllManagedInstancesInCompartmentDetails model =
                    new StageUpdateOnAllManagedInstancesInCompartmentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageUpdateOnAllManagedInstancesInCompartmentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StageUpdateOnAllManagedInstancesInCompartmentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageUpdateOnAllManagedInstancesInCompartmentDetails)) {
            return false;
        }

        StageUpdateOnAllManagedInstancesInCompartmentDetails other =
                (StageUpdateOnAllManagedInstancesInCompartmentDetails) o;
