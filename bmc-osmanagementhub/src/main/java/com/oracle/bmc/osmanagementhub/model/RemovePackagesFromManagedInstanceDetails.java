...
/**
 * Provides the information used to remove software packages from a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemovePackagesFromManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RemovePackagesFromManagedInstanceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames", "workRequestDetails"})
    public RemovePackagesFromManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public RemovePackagesFromManagedInstanceDetails build() {
            RemovePackagesFromManagedInstanceDetails model =
                    new RemovePackagesFromManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemovePackagesFromManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePackagesFromManagedInstanceDetails)) {
            return false;
        }

        RemovePackagesFromManagedInstanceDetails other =
                (RemovePackagesFromManagedInstanceDetails) o;
