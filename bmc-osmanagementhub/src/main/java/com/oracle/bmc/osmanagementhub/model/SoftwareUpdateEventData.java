...
/**
 * Provides additional information for a software update event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SoftwareUpdateEventData.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SoftwareUpdateEventData
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"operationType", "status", "additionalDetails"})
    public SoftwareUpdateEventData(
    ...
    public static class Builder {
        ...
        public SoftwareUpdateEventData build() {
            SoftwareUpdateEventData model =
                    new SoftwareUpdateEventData(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SoftwareUpdateEventData model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SoftwareUpdateEventData(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SoftwareUpdateEventData)) {
            return false;
        }

        SoftwareUpdateEventData other = (SoftwareUpdateEventData) o;
