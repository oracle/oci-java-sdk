...
/**
 * Provides summary information about a software package available for installation on a managed
 * instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AvailablePackageSummary.Builder.class)
...
public final class AvailablePackageSummary extends PackageSummary {
    ...
    public static class Builder {
        ...
        public AvailablePackageSummary build() {
            AvailablePackageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AvailablePackageSummary model) {
    ...
    @Deprecated
    public AvailablePackageSummary(
            String displayName,
            String name,
            String type,
            String version,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AvailablePackageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AvailablePackageSummary)) {
            return false;
        }

        AvailablePackageSummary other = (AvailablePackageSummary) o;
