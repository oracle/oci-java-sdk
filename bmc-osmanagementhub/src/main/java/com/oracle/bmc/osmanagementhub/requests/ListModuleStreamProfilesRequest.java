...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListModuleStreamProfilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModuleStreamProfilesRequest.
 */
...
public class ListModuleStreamProfilesRequest
    ...
    public static class Builder
        ...
        public ListModuleStreamProfilesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListModuleStreamProfilesRequest(softwareSourceId, moduleName, streamName, name, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
