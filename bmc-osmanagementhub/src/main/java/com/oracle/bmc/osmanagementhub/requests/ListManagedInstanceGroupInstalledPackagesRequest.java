...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListManagedInstanceGroupInstalledPackagesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedInstanceGroupInstalledPackagesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListManagedInstanceGroupInstalledPackagesRequest
     ...
     *
     */
    private java.util.Date timeInstallDateStart;
     ...
     *
     */
    public java.util.Date getTimeInstallDateStart() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListManagedInstanceGroupInstalledPackagesRequest, java.lang.Void> {
         ...
         *
         */
        private java.util.Date timeInstallDateStart = null;
         ...
         * Example: 2017-07-14T02:40:00.000Z
         *
         * @param timeInstallDateStart the value to set
         * @return this builder instance
         */
        public Builder timeInstallDateStart(java.util.Date timeInstallDateStart) {
         ...
         * Example: 2017-07-14T02:40:00.000Z
         *
         * @param timeInstallDateEnd the value to set
         * @return this builder instance
         */
        public Builder timeInstallDateEnd(java.util.Date timeInstallDateEnd) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListManagedInstanceGroupInstalledPackagesRequest o) {
            managedInstanceGroupId(o.getManagedInstanceGroupId());
            displayName(o.getDisplayName());
            displayNameContains(o.getDisplayNameContains());
            timeInstallDateStart(o.getTimeInstallDateStart());
            timeInstallDateEnd(o.getTimeInstallDateEnd());
        ...
        /**
         * Build the instance of ListManagedInstanceGroupInstalledPackagesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListManagedInstanceGroupInstalledPackagesRequest
         */
        public ListManagedInstanceGroupInstalledPackagesRequest build() {
         ...
         * @return instance of ListManagedInstanceGroupInstalledPackagesRequest
         */
        public ListManagedInstanceGroupInstalledPackagesRequest buildWithoutInvocationCallback() {
            ListManagedInstanceGroupInstalledPackagesRequest request =
                    new ListManagedInstanceGroupInstalledPackagesRequest();
            request.managedInstanceGroupId = managedInstanceGroupId;
            request.displayName = displayName;
            request.displayNameContains = displayNameContains;
            request.timeInstallDateStart = timeInstallDateStart;
            request.timeInstallDateEnd = timeInstallDateEnd;
            ...
            return request;
            // new ListManagedInstanceGroupInstalledPackagesRequest(managedInstanceGroupId, displayName, displayNameContains, timeInstallDateStart, timeInstallDateEnd, compartmentId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",timeInstallDateStart=").append(String.valueOf(this.timeInstallDateStart));
        sb.append(",timeInstallDateEnd=").append(String.valueOf(this.timeInstallDateEnd));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedInstanceGroupInstalledPackagesRequest)) {
            return false;
        }

        ListManagedInstanceGroupInstalledPackagesRequest other =
                (ListManagedInstanceGroupInstalledPackagesRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.timeInstallDateStart, other.timeInstallDateStart)
                && java.util.Objects.equals(this.timeInstallDateEnd, other.timeInstallDateEnd)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.timeInstallDateStart == null
                                ? 43
                                : this.timeInstallDateStart.hashCode());
        result =
                (result * PRIME)
                        + (this.timeInstallDateEnd == null
                                ? 43
                                : this.timeInstallDateEnd.hashCode());
        result =
                (result * PRIME)
