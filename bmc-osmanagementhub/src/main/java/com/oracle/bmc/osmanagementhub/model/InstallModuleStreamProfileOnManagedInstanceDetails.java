...
/**
 * Provides the information used to install a module stream profile on a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstallModuleStreamProfileOnManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InstallModuleStreamProfileOnManagedInstanceDetails
    ...
    public InstallModuleStreamProfileOnManagedInstanceDetails(
            String moduleName,
            String streamName,
            String profileName,
    ...
    public static class Builder {
        ...
        public InstallModuleStreamProfileOnManagedInstanceDetails build() {
            InstallModuleStreamProfileOnManagedInstanceDetails model =
                    new InstallModuleStreamProfileOnManagedInstanceDetails(
                            this.moduleName,
                            this.streamName,
                            this.profileName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstallModuleStreamProfileOnManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallModuleStreamProfileOnManagedInstanceDetails)) {
            return false;
        }

        InstallModuleStreamProfileOnManagedInstanceDetails other =
                (InstallModuleStreamProfileOnManagedInstanceDetails) o;
