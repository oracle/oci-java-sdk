...
public class ListManagedInstanceGroupInstalledPackagesConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    ListManagedInstanceGroupInstalledPackagesConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.osmanagementhub.requests.ListManagedInstanceGroupInstalledPackagesRequest
                    request) {
        ...
        if (request.getTimeInstallDateStart() != null) {
            target =
                    target.queryParam(
                            "timeInstallDateStart",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getTimeInstallDateStart()));
        }

        if (request.getTimeInstallDateEnd() != null) {
            target =
                    target.queryParam(
                            "timeInstallDateEnd",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getTimeInstallDateEnd()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.ListManagedInstanceGroupInstalledPackagesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.managedInstanceGroupInstalledPackageCollection(
                                        response.getItem());
