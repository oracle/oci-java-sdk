...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SwitchModuleStreamOnManagedInstanceDetails.Builder.class)
...
public final class SwitchModuleStreamOnManagedInstanceDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchModuleStreamOnManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchModuleStreamOnManagedInstanceDetails)) {
            return false;
        }

        SwitchModuleStreamOnManagedInstanceDetails other =
                (SwitchModuleStreamOnManagedInstanceDetails) o;
