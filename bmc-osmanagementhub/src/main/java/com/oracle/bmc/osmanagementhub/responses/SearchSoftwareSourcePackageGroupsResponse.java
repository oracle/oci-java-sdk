...
public class SearchSoftwareSourcePackageGroupsResponse
    ...
    private SearchSoftwareSourcePackageGroupsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SearchSoftwareSourcePackageGroupsResponse o) {
         ...
         */
        public SearchSoftwareSourcePackageGroupsResponse build() {
            return new SearchSoftwareSourcePackageGroupsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchSoftwareSourcePackageGroupsResponse)) {
            return false;
        }

        SearchSoftwareSourcePackageGroupsResponse other =
                (SearchSoftwareSourcePackageGroupsResponse) o;
