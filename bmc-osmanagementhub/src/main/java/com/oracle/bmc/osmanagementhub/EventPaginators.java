...
public class EventPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.osmanagementhub.model.EventSummary} objects
     * contained in responses from the listEvents operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.osmanagementhub.model.EventSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.osmanagementhub.model.EventSummary> listEventsRecordIterator(
            final ListEventsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                new java.util.function.Function<
                        ListEventsResponse,
                        java.util.List<com.oracle.bmc.osmanagementhub.model.EventSummary>>() {
                    @Override
                    public java.util.List<com.oracle.bmc.osmanagementhub.model.EventSummary> apply(
