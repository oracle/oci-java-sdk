...
public class ListManagedInstancesInDynamicSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ListManagedInstancesInDynamicSetResponse o) {
         ...
         */
        public ListManagedInstancesInDynamicSetResponse build() {
            return new ListManagedInstancesInDynamicSetResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedInstancesInDynamicSetResponse)) {
            return false;
        }

        ListManagedInstancesInDynamicSetResponse other =
                (ListManagedInstancesInDynamicSetResponse) o;
