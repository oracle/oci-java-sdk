...
public class ListManagedInstanceGroupManagedInstancesResponse
    ...
    private ListManagedInstanceGroupManagedInstancesResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListManagedInstanceGroupManagedInstancesResponse o) {
         ...
         */
        @Override
        public ListManagedInstanceGroupManagedInstancesResponse build() {
            return new ListManagedInstanceGroupManagedInstancesResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedInstanceGroupManagedInstancesResponse)) {
            return false;
        }

        ListManagedInstanceGroupManagedInstancesResponse other =
                (ListManagedInstanceGroupManagedInstancesResponse) o;
