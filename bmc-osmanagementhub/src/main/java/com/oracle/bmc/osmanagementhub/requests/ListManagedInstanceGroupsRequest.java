...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListManagedInstanceGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedInstanceGroupsRequest.
 */
...
public class ListManagedInstanceGroupsRequest
    ...
    public static class Builder
        ...
        public ListManagedInstanceGroupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagedInstanceGroupsRequest(compartmentId, managedInstanceGroupId, softwareSourceId, displayName, displayNameContains, archType, osFamily, limit, page, lifecycleState, location, locationNotEqualTo, isManagedByAutonomousLinux, sortOrder, sortBy, opcRequestId);
        }
    }
