...
public class LifecycleEnvironmentClient implements LifecycleEnvironment {
    /**
     ...
     */
    protected LifecycleEnvironmentClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public AttachManagedInstancesToLifecycleStageResponse attachManagedInstancesToLifecycleStage(
        ...
        LOG.trace("Called attachManagedInstancesToLifecycleStage");
    ...
    public DeleteLifecycleEnvironmentResponse deleteLifecycleEnvironment(
        ...
        LOG.trace("Called deleteLifecycleEnvironment");
    ...
    public DetachManagedInstancesFromLifecycleStageResponse
        ...
        LOG.trace("Called detachManagedInstancesFromLifecycleStage");
    ...
    public GetLifecycleEnvironmentResponse getLifecycleEnvironment(
        ...
        LOG.trace("Called getLifecycleEnvironment");
    ...
    public GetLifecycleStageResponse getLifecycleStage(GetLifecycleStageRequest request) {
        LOG.trace("Called getLifecycleStage");
    ...
    public ListLifecycleEnvironmentsResponse listLifecycleEnvironments(
        ...
        LOG.trace("Called listLifecycleEnvironments");
    ...
    public ListLifecycleStageInstalledPackagesResponse listLifecycleStageInstalledPackages(
        ...
        LOG.trace("Called listLifecycleStageInstalledPackages");
    ...
    public ListLifecycleStagesResponse listLifecycleStages(ListLifecycleStagesRequest request) {
        LOG.trace("Called listLifecycleStages");
    ...
    public PromoteSoftwareSourceToLifecycleStageResponse promoteSoftwareSourceToLifecycleStage(
        ...
        LOG.trace("Called promoteSoftwareSourceToLifecycleStage");
    ...
    public RebootLifecycleStageResponse rebootLifecycleStage(RebootLifecycleStageRequest request) {
        LOG.trace("Called rebootLifecycleStage");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RebootLifecycleStageResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRebootLifecycleStageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateLifecycleEnvironmentResponse updateLifecycleEnvironment(
        ...
        LOG.trace("Called updateLifecycleEnvironment");
