...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListProfileAvailableSoftwareSourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListProfileAvailableSoftwareSourcesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListProfileAvailableSoftwareSourcesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListProfileAvailableSoftwareSourcesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListProfileAvailableSoftwareSourcesRequest o) {
        ...
        /**
         * Build the instance of ListProfileAvailableSoftwareSourcesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListProfileAvailableSoftwareSourcesRequest
         */
        public ListProfileAvailableSoftwareSourcesRequest build() {
            ListProfileAvailableSoftwareSourcesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListProfileAvailableSoftwareSourcesRequest
         */
        public ListProfileAvailableSoftwareSourcesRequest buildWithoutInvocationCallback() {
            ListProfileAvailableSoftwareSourcesRequest request =
                    new ListProfileAvailableSoftwareSourcesRequest();
            ...
            return request;
            // new ListProfileAvailableSoftwareSourcesRequest(profileId, displayName, displayNameContains, compartmentId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListProfileAvailableSoftwareSourcesRequest)) {
            return false;
        }

        ListProfileAvailableSoftwareSourcesRequest other =
                (ListProfileAvailableSoftwareSourcesRequest) o;
