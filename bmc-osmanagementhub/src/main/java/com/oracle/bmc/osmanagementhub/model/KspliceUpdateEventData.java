...
/**
 * Provides additional information for a Ksplice update event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = KspliceUpdateEventData.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class KspliceUpdateEventData
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"operationType", "status", "additionalDetails"})
    public KspliceUpdateEventData(
    ...
    public static class Builder {
        ...
        public KspliceUpdateEventData build() {
            KspliceUpdateEventData model =
                    new KspliceUpdateEventData(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KspliceUpdateEventData model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KspliceUpdateEventData(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KspliceUpdateEventData)) {
            return false;
        }

        KspliceUpdateEventData other = (KspliceUpdateEventData) o;
