...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ListEntitlementsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEntitlementsRequest.
 */
...
public class ListEntitlementsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListEntitlementsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListEntitlementsRequest(compartmentId, csi, vendorName, limit, page, sortOrder,
            // sortBy, opcRequestId);
        }
    }
