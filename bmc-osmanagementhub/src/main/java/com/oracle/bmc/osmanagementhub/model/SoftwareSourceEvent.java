...
/**
 * Provides information for a software source event. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SoftwareSourceEvent.Builder.class)
...
public final class SoftwareSourceEvent extends Event {
    ...
    public static class Builder {
        ...
        private SoftwareSourceEventData data;

        public Builder data(SoftwareSourceEventData data) {
            this.data = data;
        ...
        public SoftwareSourceEvent build() {
            SoftwareSourceEvent model =
                    new SoftwareSourceEvent(
                            this.id,
                            this.eventSummary,
                            this.compartmentId,
                            this.eventDetails,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SoftwareSourceEvent model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final SoftwareSourceEventData data;

    public SoftwareSourceEventData getData() {
        return data;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SoftwareSourceEvent)) {
            return false;
        }

        SoftwareSourceEvent other = (SoftwareSourceEvent) o;
