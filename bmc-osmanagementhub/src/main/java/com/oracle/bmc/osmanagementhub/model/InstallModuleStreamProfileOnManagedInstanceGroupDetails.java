...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstallModuleStreamProfileOnManagedInstanceGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InstallModuleStreamProfileOnManagedInstanceGroupDetails
    ...
    public static class Builder {
        ...
        public InstallModuleStreamProfileOnManagedInstanceGroupDetails build() {
            InstallModuleStreamProfileOnManagedInstanceGroupDetails model =
                    new InstallModuleStreamProfileOnManagedInstanceGroupDetails(
                            this.moduleName,
                            this.streamName,
                            this.profileName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstallModuleStreamProfileOnManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallModuleStreamProfileOnManagedInstanceGroupDetails)) {
            return false;
        }

        InstallModuleStreamProfileOnManagedInstanceGroupDetails other =
                (InstallModuleStreamProfileOnManagedInstanceGroupDetails) o;
