...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/GetManagedInstanceAnalyticContentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetManagedInstanceAnalyticContentRequest.
 */
...
public class GetManagedInstanceAnalyticContentRequest
    ...
    public static class Builder
        ...
        public GetManagedInstanceAnalyticContentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetManagedInstanceAnalyticContentRequest(compartmentId, managedInstanceGroupId, lifecycleEnvironmentId, lifecycleStageId, status, displayName, displayNameContains, instanceLocation, securityUpdatesAvailableEqualsTo, bugUpdatesAvailableEqualsTo, securityUpdatesAvailableGreaterThan, bugUpdatesAvailableGreaterThan, opcRequestId);
        }
    }
