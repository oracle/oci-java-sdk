...
/**
 * Provides a list of packages to be removed from the software source. <br>
...
public final class RemovePackagesFromSoftwareSourceDetails
    ...
    public RemovePackagesFromSoftwareSourceDetails(java.util.List<String> packages) {
        super();
    ...
    public static class Builder {
        ...
        public RemovePackagesFromSoftwareSourceDetails build() {
            RemovePackagesFromSoftwareSourceDetails model =
                    new RemovePackagesFromSoftwareSourceDetails(this.packages);
