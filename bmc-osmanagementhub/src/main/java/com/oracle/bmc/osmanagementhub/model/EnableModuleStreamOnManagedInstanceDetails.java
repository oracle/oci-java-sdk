...
/**
 * Provides the information used to enable a module stream on a managed instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EnableModuleStreamOnManagedInstanceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EnableModuleStreamOnManagedInstanceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"moduleName", "streamName", "workRequestDetails"})
    public EnableModuleStreamOnManagedInstanceDetails(
    ...
    public static class Builder {
        ...
        public EnableModuleStreamOnManagedInstanceDetails build() {
            EnableModuleStreamOnManagedInstanceDetails model =
                    new EnableModuleStreamOnManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableModuleStreamOnManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableModuleStreamOnManagedInstanceDetails)) {
            return false;
        }

        EnableModuleStreamOnManagedInstanceDetails other =
                (EnableModuleStreamOnManagedInstanceDetails) o;
