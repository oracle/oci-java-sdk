...
/**
 * Provides the information used to detach software sources from a managed instance group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DetachSoftwareSourcesFromManagedInstanceGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DetachSoftwareSourcesFromManagedInstanceGroupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"softwareSources", "workRequestDetails"})
    public DetachSoftwareSourcesFromManagedInstanceGroupDetails(
    ...
    public static class Builder {
        ...
        public DetachSoftwareSourcesFromManagedInstanceGroupDetails build() {
            DetachSoftwareSourcesFromManagedInstanceGroupDetails model =
                    new DetachSoftwareSourcesFromManagedInstanceGroupDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetachSoftwareSourcesFromManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachSoftwareSourcesFromManagedInstanceGroupDetails)) {
            return false;
        }

        DetachSoftwareSourcesFromManagedInstanceGroupDetails other =
                (DetachSoftwareSourcesFromManagedInstanceGroupDetails) o;
