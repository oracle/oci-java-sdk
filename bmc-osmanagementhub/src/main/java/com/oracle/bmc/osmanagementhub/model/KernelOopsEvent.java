...
/**
 * Information about the kernel OOPS event. A kernel OOPS event occurs when the kernel detects an
 * erroneous state inside itself. <br>
...
public final class KernelOopsEvent extends Event {
    ...
    public static class Builder {
        ...
        private KernelEventData data;

        public Builder data(KernelEventData data) {
            this.data = data;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("data")
    private final KernelEventData data;

    public KernelEventData getData() {
        return data;
    }
