...
public class SynchronizeSingleMirrorsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SynchronizeSingleMirrorsConverter.class);

    public static com.oracle.bmc.osmanagementhub.requests.SynchronizeSingleMirrorsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.osmanagementhub.requests.SynchronizeSingleMirrorsRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getManagementStationId()))
                        .path("mirrors")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getMirrorId()))
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.SynchronizeSingleMirrorsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.osmanagementhub.responses
                                                .SynchronizeSingleMirrorsResponse.Builder
                                        builder =
                                                com.oracle.bmc.osmanagementhub.responses
                                                        .SynchronizeSingleMirrorsResponse.builder()
