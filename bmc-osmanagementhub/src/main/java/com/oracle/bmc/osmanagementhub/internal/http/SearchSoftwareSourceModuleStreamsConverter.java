...
public class SearchSoftwareSourceModuleStreamsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SearchSoftwareSourceModuleStreamsConverter.class);

    public static com.oracle.bmc.osmanagementhub.requests.SearchSoftwareSourceModuleStreamsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        .path("/20220901")
                        .path("softwareSourceModuleStreams")
                        .path("actions")
                        .path("search");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.SearchSoftwareSourceModuleStreamsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.osmanagementhub.responses
                                                .SearchSoftwareSourceModuleStreamsResponse.Builder
                                        builder =
                                                com.oracle.bmc.osmanagementhub.responses
                                                        .SearchSoftwareSourceModuleStreamsResponse
                                                        .builder()
