...
/**
 * Provides the information for a standalone registration profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UbuntuStandaloneProfile.Builder.class)
...
public final class UbuntuStandaloneProfile extends Profile {
    ...
    public static class Builder {
        ...
        public UbuntuStandaloneProfile build() {
            UbuntuStandaloneProfile model =
                    new UbuntuStandaloneProfile(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UbuntuStandaloneProfile model) {
    ...
    @Deprecated
    public UbuntuStandaloneProfile(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UbuntuStandaloneProfile(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UbuntuStandaloneProfile)) {
            return false;
        }

        UbuntuStandaloneProfile other = (UbuntuStandaloneProfile) o;
