...
public class DeleteProfileResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteProfileResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteProfileResponse)) {
            return false;
        }
