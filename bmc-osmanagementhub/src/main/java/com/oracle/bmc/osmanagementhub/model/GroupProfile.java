...
/**
 * Provides the information for a group registration profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GroupProfile.Builder.class)
...
public final class GroupProfile extends Profile {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GroupProfile model) {
    ...
    public boolean equals(Object o) {
        ...
        GroupProfile other = (GroupProfile) o;
        return java.util.Objects.equals(this.managedInstanceGroup, other.managedInstanceGroup)
                && super.equals(other);
    }
