...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/ManageModuleStreamsOnManagedInstanceGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ManageModuleStreamsOnManagedInstanceGroupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ManageModuleStreamsOnManagedInstanceGroupRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder manageModuleStreamsOnManagedInstanceGroupDetails(
                com.oracle.bmc.osmanagementhub.model
                                .ManageModuleStreamsOnManagedInstanceGroupDetails
                        manageModuleStreamsOnManagedInstanceGroupDetails) {
            this.manageModuleStreamsOnManagedInstanceGroupDetails =
                    manageModuleStreamsOnManagedInstanceGroupDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ManageModuleStreamsOnManagedInstanceGroupRequest o) {
            managedInstanceGroupId(o.getManagedInstanceGroupId());
            manageModuleStreamsOnManagedInstanceGroupDetails(
                    o.getManageModuleStreamsOnManagedInstanceGroupDetails());
        ...
        /**
         * Build the instance of ManageModuleStreamsOnManagedInstanceGroupRequest as configured by this builder
         *
         ...
         *
         * @return instance of ManageModuleStreamsOnManagedInstanceGroupRequest
         */
        ...
        public Builder body$(
                com.oracle.bmc.osmanagementhub.model
                                .ManageModuleStreamsOnManagedInstanceGroupDetails
                        body) {
            manageModuleStreamsOnManagedInstanceGroupDetails(body);
            return this;
        }
        ...
        public ManageModuleStreamsOnManagedInstanceGroupRequest buildWithoutInvocationCallback() {
            ManageModuleStreamsOnManagedInstanceGroupRequest request =
                    new ManageModuleStreamsOnManagedInstanceGroupRequest();
            request.managedInstanceGroupId = managedInstanceGroupId;
            request.manageModuleStreamsOnManagedInstanceGroupDetails =
                    manageModuleStreamsOnManagedInstanceGroupDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new ManageModuleStreamsOnManagedInstanceGroupRequest(managedInstanceGroupId, manageModuleStreamsOnManagedInstanceGroupDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",manageModuleStreamsOnManagedInstanceGroupDetails=")
                .append(String.valueOf(this.manageModuleStreamsOnManagedInstanceGroupDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManageModuleStreamsOnManagedInstanceGroupRequest)) {
            return false;
        }

        ManageModuleStreamsOnManagedInstanceGroupRequest other =
                (ManageModuleStreamsOnManagedInstanceGroupRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.managedInstanceGroupId, other.managedInstanceGroupId)
                && java.util.Objects.equals(
                        this.manageModuleStreamsOnManagedInstanceGroupDetails,
                        other.manageModuleStreamsOnManagedInstanceGroupDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.manageModuleStreamsOnManagedInstanceGroupDetails == null
                                ? 43
                                : this.manageModuleStreamsOnManagedInstanceGroupDetails.hashCode());
