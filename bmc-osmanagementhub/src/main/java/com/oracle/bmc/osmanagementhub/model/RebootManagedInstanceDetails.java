...
public final class RebootManagedInstanceDetails
    ...
    public static class Builder {
        ...
        public RebootManagedInstanceDetails build() {
            RebootManagedInstanceDetails model =
                    new RebootManagedInstanceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RebootManagedInstanceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RebootManagedInstanceDetails)) {
            return false;
        }

        RebootManagedInstanceDetails other = (RebootManagedInstanceDetails) o;
