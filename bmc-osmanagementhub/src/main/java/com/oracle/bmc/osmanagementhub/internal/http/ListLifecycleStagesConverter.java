...
public class ListLifecycleStagesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListLifecycleStagesConverter.class);

    public static com.oracle.bmc.osmanagementhub.requests.ListLifecycleStagesRequest
            interceptRequest(
                    com.oracle.bmc.osmanagementhub.requests.ListLifecycleStagesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220901").path("lifecycleStages");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagementhub.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagementhub.responses.ListLifecycleStagesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.osmanagementhub.responses.ListLifecycleStagesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.osmanagementhub.responses
                                                        .ListLifecycleStagesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.lifecycleStageCollection(response.getItem());
