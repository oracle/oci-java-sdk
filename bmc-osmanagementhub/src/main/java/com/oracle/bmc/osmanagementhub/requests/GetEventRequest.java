...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagementhub/GetEventExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetEventRequest.
 */
...
public class GetEventRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetEventRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetEventRequest(eventId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().eventId(eventId).opcRequestId(opcRequestId);
    }
