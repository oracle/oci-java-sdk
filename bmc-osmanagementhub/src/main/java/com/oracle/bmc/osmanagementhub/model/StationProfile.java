...
/**
 * Provides the information for a management station registration profile. A management station
 * profile can only be used by a single management station. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StationProfile.Builder.class)
...
public final class StationProfile extends Profile {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StationProfile model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StationProfile)) {
            return false;
        }

        StationProfile other = (StationProfile) o;
