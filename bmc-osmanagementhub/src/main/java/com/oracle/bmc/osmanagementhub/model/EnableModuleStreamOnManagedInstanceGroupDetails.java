...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EnableModuleStreamOnManagedInstanceGroupDetails.Builder.class
)
...
public final class EnableModuleStreamOnManagedInstanceGroupDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableModuleStreamOnManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableModuleStreamOnManagedInstanceGroupDetails)) {
            return false;
        }

        EnableModuleStreamOnManagedInstanceGroupDetails other =
