...
public class GetStreamCdnConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetStreamCdnConfigResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetStreamCdnConfigResponse)) {
            return false;
        }

        GetStreamCdnConfigResponse other = (GetStreamCdnConfigResponse) o;
