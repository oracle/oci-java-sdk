...
public class GeneratePlaylistResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GeneratePlaylistResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GeneratePlaylistResponse)) {
            return false;
        }

        GeneratePlaylistResponse other = (GeneratePlaylistResponse) o;
