...
public final class CreateMediaWorkflowConfigurationDetails {
    ...
    public static class Builder {
        ...
        public CreateMediaWorkflowConfigurationDetails build() {
            CreateMediaWorkflowConfigurationDetails __instance__ =
                    new CreateMediaWorkflowConfigurationDetails(
                            displayName, parameters, compartmentId, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMediaWorkflowConfigurationDetails o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMediaWorkflowConfigurationDetails)) {
            return false;
        }

        CreateMediaWorkflowConfigurationDetails other = (CreateMediaWorkflowConfigurationDetails) o;
