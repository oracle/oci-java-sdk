...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/ListMediaWorkflowTaskDeclarationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMediaWorkflowTaskDeclarationsRequest.
 */
...
public class ListMediaWorkflowTaskDeclarationsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListMediaWorkflowTaskDeclarationsRequest as configured by this builder
         *
        ...
        public ListMediaWorkflowTaskDeclarationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMediaWorkflowTaskDeclarationsRequest(compartmentId, name, version, isCurrent, sortBy, limit, page, sortOrder, opcRequestId);
        }
    }
