...
public final class MediaWorkflowTaskDeclaration {
    ...
    public static class Builder {
        ...
        public MediaWorkflowTaskDeclaration build() {
            MediaWorkflowTaskDeclaration __instance__ =
                    new MediaWorkflowTaskDeclaration(
                            name, version, parametersSchema, parametersSchemaAllowingReferences);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MediaWorkflowTaskDeclaration o) {
            Builder copiedBuilder =
                    name(o.getName())
                            .version(o.getVersion())
                            .parametersSchema(o.getParametersSchema())
                            .parametersSchemaAllowingReferences(
                                    o.getParametersSchemaAllowingReferences());
