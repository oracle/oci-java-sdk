...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/DeleteMediaWorkflowConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMediaWorkflowConfigurationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class DeleteMediaWorkflowConfigurationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMediaWorkflowConfigurationRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteMediaWorkflowConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMediaWorkflowConfigurationRequest
         */
        public DeleteMediaWorkflowConfigurationRequest build() {
            DeleteMediaWorkflowConfigurationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMediaWorkflowConfigurationRequest
         */
        public DeleteMediaWorkflowConfigurationRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMediaWorkflowConfigurationRequest)) {
            return false;
        }

        DeleteMediaWorkflowConfigurationRequest other = (DeleteMediaWorkflowConfigurationRequest) o;
