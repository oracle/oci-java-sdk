...
public final class StreamCdnConfig {
    ...
    public static class Builder {
        ...
        public StreamCdnConfig build() {
            StreamCdnConfig __instance__ =
                    new StreamCdnConfig(
                            id,
                            displayName,
                            compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamCdnConfig o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamCdnConfig)) {
            return false;
        }

        StreamCdnConfig other = (StreamCdnConfig) o;
