...
public class ListMediaWorkflowTaskDeclarationsResponse
    ...
    public com.oracle.bmc.mediaservices.model.MediaWorkflowTaskDeclarationCollection
            getMediaWorkflowTaskDeclarationCollection() {
        return mediaWorkflowTaskDeclarationCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder mediaWorkflowTaskDeclarationCollection(
                com.oracle.bmc.mediaservices.model.MediaWorkflowTaskDeclarationCollection
                        mediaWorkflowTaskDeclarationCollection) {
            this.mediaWorkflowTaskDeclarationCollection = mediaWorkflowTaskDeclarationCollection;
            return this;
        ...
        public Builder copy(ListMediaWorkflowTaskDeclarationsResponse o) {
            ...
            mediaWorkflowTaskDeclarationCollection(o.getMediaWorkflowTaskDeclarationCollection());
    ...
    public String toString() {
        ...
        sb.append(",mediaWorkflowTaskDeclarationCollection=")
                .append(String.valueOf(mediaWorkflowTaskDeclarationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMediaWorkflowTaskDeclarationsResponse)) {
            return false;
        }

        ListMediaWorkflowTaskDeclarationsResponse other =
                (ListMediaWorkflowTaskDeclarationsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.mediaWorkflowTaskDeclarationCollection,
                        other.mediaWorkflowTaskDeclarationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.mediaWorkflowTaskDeclarationCollection == null
                                ? 43
                                : this.mediaWorkflowTaskDeclarationCollection.hashCode());
        return result;
    }
}
