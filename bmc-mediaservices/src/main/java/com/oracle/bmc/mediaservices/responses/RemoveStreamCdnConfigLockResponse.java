...
public class RemoveStreamCdnConfigLockResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RemoveStreamCdnConfigLockResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RemoveStreamCdnConfigLockResponse o) {
         ...
         */
        @Override
        public RemoveStreamCdnConfigLockResponse build() {
            return new RemoveStreamCdnConfigLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveStreamCdnConfigLockResponse)) {
            return false;
        }

        RemoveStreamCdnConfigLockResponse other = (RemoveStreamCdnConfigLockResponse) o;
