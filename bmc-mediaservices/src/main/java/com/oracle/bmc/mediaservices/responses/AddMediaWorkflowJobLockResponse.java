...
public class AddMediaWorkflowJobLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AddMediaWorkflowJobLockResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(AddMediaWorkflowJobLockResponse o) {
         ...
         */
        public AddMediaWorkflowJobLockResponse build() {
            return new AddMediaWorkflowJobLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddMediaWorkflowJobLockResponse)) {
            return false;
        }

        AddMediaWorkflowJobLockResponse other = (AddMediaWorkflowJobLockResponse) o;
