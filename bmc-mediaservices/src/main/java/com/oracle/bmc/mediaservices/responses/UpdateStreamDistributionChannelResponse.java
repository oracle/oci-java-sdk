...
public class UpdateStreamDistributionChannelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStreamDistributionChannelResponse)) {
            return false;
        }

        UpdateStreamDistributionChannelResponse other = (UpdateStreamDistributionChannelResponse) o;
