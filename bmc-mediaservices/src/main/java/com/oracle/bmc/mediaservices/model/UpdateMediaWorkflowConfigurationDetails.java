...
public final class UpdateMediaWorkflowConfigurationDetails {
    ...
    public static class Builder {
        ...
        public UpdateMediaWorkflowConfigurationDetails build() {
            UpdateMediaWorkflowConfigurationDetails __instance__ =
                    new UpdateMediaWorkflowConfigurationDetails(
                            displayName, parameters, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMediaWorkflowConfigurationDetails o) {
