...
public class GetStreamPackagingConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetStreamPackagingConfigResponse)) {
            return false;
        }

        GetStreamPackagingConfigResponse other = (GetStreamPackagingConfigResponse) o;
