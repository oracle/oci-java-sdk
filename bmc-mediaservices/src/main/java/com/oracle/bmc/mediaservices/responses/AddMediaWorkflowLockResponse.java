...
public class AddMediaWorkflowLockResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code MediaWorkflow} instance. */
    ...
    private AddMediaWorkflowLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddMediaWorkflowLockResponse> {
         ...
         */
        @Override
        public Builder copy(AddMediaWorkflowLockResponse o) {
         ...
         */
        @Override
        public AddMediaWorkflowLockResponse build() {
            return new AddMediaWorkflowLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddMediaWorkflowLockResponse)) {
            return false;
        }

        AddMediaWorkflowLockResponse other = (AddMediaWorkflowLockResponse) o;
