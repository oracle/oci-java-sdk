...
public class MediaServicesPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMediaWorkflowJobFacts operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListMediaWorkflowJobFactsResponse> listMediaWorkflowJobFactsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMediaWorkflowJobFactsRequest.Builder, ListMediaWorkflowJobFactsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.mediaservices.model.MediaWorkflowJobFactSummary} objects
     * contained in responses from the listMediaWorkflowJobFacts operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.mediaservices.model.MediaWorkflowJobFactSummary} objects
     * contained in responses received from the service.
     */
