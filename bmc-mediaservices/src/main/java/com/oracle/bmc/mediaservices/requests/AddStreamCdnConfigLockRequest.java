...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/AddStreamCdnConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddStreamCdnConfigLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class AddStreamCdnConfigLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddStreamCdnConfigLockRequest o) {
        ...
        /**
         * Build the instance of AddStreamCdnConfigLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddStreamCdnConfigLockRequest
         */
        public AddStreamCdnConfigLockRequest build() {
            AddStreamCdnConfigLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddStreamCdnConfigLockRequest
         */
        public AddStreamCdnConfigLockRequest buildWithoutInvocationCallback() {
            AddStreamCdnConfigLockRequest request = new AddStreamCdnConfigLockRequest();
            ...
            return request;
            // new AddStreamCdnConfigLockRequest(addResourceLockDetails, streamCdnConfigId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddStreamCdnConfigLockRequest)) {
            return false;
        }

        AddStreamCdnConfigLockRequest other = (AddStreamCdnConfigLockRequest) o;
