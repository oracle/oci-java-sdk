...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/RemoveMediaWorkflowConfigurationLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveMediaWorkflowConfigurationLockRequest.
 */
...
public class RemoveMediaWorkflowConfigurationLockRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of RemoveMediaWorkflowConfigurationLockRequest as configured by this builder
         *
        ...
        public RemoveMediaWorkflowConfigurationLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RemoveMediaWorkflowConfigurationLockRequest(removeResourceLockDetails, mediaWorkflowConfigurationId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
