...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/UpdateMediaWorkflowConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateMediaWorkflowConfigurationRequest.
 */
...
public class UpdateMediaWorkflowConfigurationRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of UpdateMediaWorkflowConfigurationRequest as configured by this builder
         *
        ...
        public UpdateMediaWorkflowConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateMediaWorkflowConfigurationRequest(mediaWorkflowConfigurationId, updateMediaWorkflowConfigurationDetails, isLockOverride, ifMatch, opcRequestId);
        }
    }
