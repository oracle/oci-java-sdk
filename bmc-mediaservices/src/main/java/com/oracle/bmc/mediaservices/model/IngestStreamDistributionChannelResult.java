...
public final class IngestStreamDistributionChannelResult {
    ...
    public static class Builder {
        ...
        public IngestStreamDistributionChannelResult build() {
            IngestStreamDistributionChannelResult __instance__ =
                    new IngestStreamDistributionChannelResult(mediaWorkflowJobId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngestStreamDistributionChannelResult o) {
            Builder copiedBuilder = mediaWorkflowJobId(o.getMediaWorkflowJobId());
