...
public class CreateMediaWorkflowConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMediaWorkflowConfigurationResponse)) {
            return false;
        }

        CreateMediaWorkflowConfigurationResponse other =
                (CreateMediaWorkflowConfigurationResponse) o;
