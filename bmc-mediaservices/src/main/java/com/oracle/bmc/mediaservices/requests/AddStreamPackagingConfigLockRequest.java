...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/AddStreamPackagingConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddStreamPackagingConfigLockRequest.
 */
...
public class AddStreamPackagingConfigLockRequest
    ...
    public static class Builder
        ...
        public AddStreamPackagingConfigLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddStreamPackagingConfigLockRequest(addResourceLockDetails, streamPackagingConfigId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
