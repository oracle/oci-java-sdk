...
public final class MediaAssetDistributionChannelAttachment {
    ...
    public static class Builder {
        ...
        public MediaAssetDistributionChannelAttachment build() {
            MediaAssetDistributionChannelAttachment __instance__ =
                    new MediaAssetDistributionChannelAttachment(
                            distributionChannelId,
                            displayName,
                            version,
                            lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MediaAssetDistributionChannelAttachment o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaAssetDistributionChannelAttachment)) {
            return false;
        }

        MediaAssetDistributionChannelAttachment other = (MediaAssetDistributionChannelAttachment) o;
