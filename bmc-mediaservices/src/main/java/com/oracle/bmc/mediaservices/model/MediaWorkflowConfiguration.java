...
/**
 * Resusable set of values that can be referenced either in a MediaWorkflow or when running a
 * MediaWorkflowJob. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MediaWorkflowConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class MediaWorkflowConfiguration
    ...
    public static class Builder {
        ...
        /**
         * The time when the the MediaWorkflowConfiguration was created. An RFC3339 formatted
         * datetime string.
         */
        ...
        /**
         * The time when the MediaWorkflowConfiguration was updated. An RFC3339 formatted datetime
         * string.
         */
        ...
        public MediaWorkflowConfiguration build() {
            MediaWorkflowConfiguration model =
                    new MediaWorkflowConfiguration(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.parameters,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MediaWorkflowConfiguration model) {
    ...
    /**
     * The time when the the MediaWorkflowConfiguration was created. An RFC3339 formatted datetime
     * string.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeCreated")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaWorkflowConfiguration)) {
            return false;
        }

        MediaWorkflowConfiguration other = (MediaWorkflowConfiguration) o;
