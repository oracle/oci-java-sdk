...
public class UpdateStreamCdnConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateStreamCdnConfigResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateStreamCdnConfigResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateStreamCdnConfigResponse o) {
         ...
         */
        @Override
        public UpdateStreamCdnConfigResponse build() {
            return new UpdateStreamCdnConfigResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStreamCdnConfigResponse)) {
            return false;
        }

        UpdateStreamCdnConfigResponse other = (UpdateStreamCdnConfigResponse) o;
