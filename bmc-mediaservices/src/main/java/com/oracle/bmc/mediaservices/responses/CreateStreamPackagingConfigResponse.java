...
public class CreateStreamPackagingConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateStreamPackagingConfigResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateStreamPackagingConfigResponse o) {
         ...
         */
        public CreateStreamPackagingConfigResponse build() {
            return new CreateStreamPackagingConfigResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateStreamPackagingConfigResponse)) {
            return false;
        }

        CreateStreamPackagingConfigResponse other = (CreateStreamPackagingConfigResponse) o;
