...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/RemoveStreamCdnConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveStreamCdnConfigLockRequest.
 */
...
public class RemoveStreamCdnConfigLockRequest
    ...
    public static class Builder
         ...
         */
        public RemoveStreamCdnConfigLockRequest build() {
            RemoveStreamCdnConfigLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveStreamCdnConfigLockRequest
         */
        public RemoveStreamCdnConfigLockRequest buildWithoutInvocationCallback() {
            RemoveStreamCdnConfigLockRequest request = new RemoveStreamCdnConfigLockRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveStreamCdnConfigLockRequest)) {
            return false;
        }

        RemoveStreamCdnConfigLockRequest other = (RemoveStreamCdnConfigLockRequest) o;
