...
public class CreateMediaWorkflowJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateMediaWorkflowJobResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateMediaWorkflowJobResponse o) {
         ...
         */
        @Override
        public CreateMediaWorkflowJobResponse build() {
            return new CreateMediaWorkflowJobResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMediaWorkflowJobResponse)) {
            return false;
        }

        CreateMediaWorkflowJobResponse other = (CreateMediaWorkflowJobResponse) o;
