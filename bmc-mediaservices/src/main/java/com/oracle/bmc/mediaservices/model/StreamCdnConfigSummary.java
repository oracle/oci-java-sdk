...
/**
 * Summary of the StreamCdnConfig. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StreamCdnConfigSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StreamCdnConfigSummary
    ...
    public static class Builder {
        ...
        /**
         * The time when the the CDN Configuration was created. An RFC3339 formatted datetime
         * string.
         */
        ...
        private StreamCdnConfig.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(StreamCdnConfig.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public StreamCdnConfigSummary build() {
            StreamCdnConfigSummary model =
                    new StreamCdnConfigSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamCdnConfigSummary model) {
    ...
    /** The current state of the CDN Configuration. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final StreamCdnConfig.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public StreamCdnConfig.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StreamCdnConfigSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamCdnConfigSummary)) {
            return false;
        }

        StreamCdnConfigSummary other = (StreamCdnConfigSummary) o;
