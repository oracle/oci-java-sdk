...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/AddMediaWorkflowJobLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddMediaWorkflowJobLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class AddMediaWorkflowJobLockRequest
    ...
    public static class Builder
         ...
         */
        public Builder addLockDetails(
                com.oracle.bmc.mediaservices.model.AddLockDetails addLockDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(AddMediaWorkflowJobLockRequest o) {
        ...
        /**
         * Build the instance of AddMediaWorkflowJobLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddMediaWorkflowJobLockRequest
         */
        public AddMediaWorkflowJobLockRequest build() {
            AddMediaWorkflowJobLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddMediaWorkflowJobLockRequest
         */
        public AddMediaWorkflowJobLockRequest buildWithoutInvocationCallback() {
            AddMediaWorkflowJobLockRequest request = new AddMediaWorkflowJobLockRequest();
            ...
            return request;
            // new AddMediaWorkflowJobLockRequest(addLockDetails, mediaWorkflowJobId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddMediaWorkflowJobLockRequest)) {
            return false;
        }

        AddMediaWorkflowJobLockRequest other = (AddMediaWorkflowJobLockRequest) o;
