...
public class CreateStreamCdnConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateStreamCdnConfigResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateStreamCdnConfigResponse> {
         ...
         */
        @Override
        public Builder copy(CreateStreamCdnConfigResponse o) {
         ...
         */
        @Override
        public CreateStreamCdnConfigResponse build() {
            return new CreateStreamCdnConfigResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateStreamCdnConfigResponse)) {
            return false;
        }

        CreateStreamCdnConfigResponse other = (CreateStreamCdnConfigResponse) o;
