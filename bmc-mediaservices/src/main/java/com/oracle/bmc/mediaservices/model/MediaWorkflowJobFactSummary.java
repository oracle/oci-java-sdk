...
public final class MediaWorkflowJobFactSummary {
    ...
    public static class Builder {
        ...
        public MediaWorkflowJobFactSummary build() {
            MediaWorkflowJobFactSummary __instance__ =
                    new MediaWorkflowJobFactSummary(mediaWorkflowJobId, key, name, type);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MediaWorkflowJobFactSummary o) {
