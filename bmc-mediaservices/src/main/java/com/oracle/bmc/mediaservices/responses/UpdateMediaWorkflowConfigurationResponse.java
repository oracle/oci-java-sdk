...
public class UpdateMediaWorkflowConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateMediaWorkflowConfigurationResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateMediaWorkflowConfigurationResponse o) {
         ...
         */
        public UpdateMediaWorkflowConfigurationResponse build() {
            return new UpdateMediaWorkflowConfigurationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMediaWorkflowConfigurationResponse)) {
            return false;
        }

        UpdateMediaWorkflowConfigurationResponse other =
                (UpdateMediaWorkflowConfigurationResponse) o;
