...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/UpdateStreamPackagingConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateStreamPackagingConfigRequest.
 */
...
public class UpdateStreamPackagingConfigRequest
    ...
    public static class Builder
        ...
        public UpdateStreamPackagingConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateStreamPackagingConfigRequest(streamPackagingConfigId, updateStreamPackagingConfigDetails, isLockOverride, ifMatch, opcRequestId);
        }
    }
