...
public class ListSystemMediaWorkflowsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.mediaservices.model.SystemMediaWorkflowCollection
            getSystemMediaWorkflowCollection() {
        return systemMediaWorkflowCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder systemMediaWorkflowCollection(
                com.oracle.bmc.mediaservices.model.SystemMediaWorkflowCollection
                        systemMediaWorkflowCollection) {
            this.systemMediaWorkflowCollection = systemMediaWorkflowCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",systemMediaWorkflowCollection=")
                .append(String.valueOf(systemMediaWorkflowCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSystemMediaWorkflowsResponse)) {
            return false;
        }

        ListSystemMediaWorkflowsResponse other = (ListSystemMediaWorkflowsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.systemMediaWorkflowCollection, other.systemMediaWorkflowCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.systemMediaWorkflowCollection == null
                                ? 43
                                : this.systemMediaWorkflowCollection.hashCode());
        return result;
    }
}
