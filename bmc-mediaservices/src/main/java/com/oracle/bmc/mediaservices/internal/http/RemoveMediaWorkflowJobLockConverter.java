...
public class RemoveMediaWorkflowJobLockConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RemoveMediaWorkflowJobLockConverter.class);

    public static com.oracle.bmc.mediaservices.requests.RemoveMediaWorkflowJobLockRequest
            interceptRequest(
                    com.oracle.bmc.mediaservices.requests.RemoveMediaWorkflowJobLockRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.mediaservices.requests.RemoveMediaWorkflowJobLockRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.mediaservices.responses.RemoveMediaWorkflowJobLockResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.mediaservices.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.mediaservices.responses.RemoveMediaWorkflowJobLockResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.mediaservices.responses
                                                .RemoveMediaWorkflowJobLockResponse.Builder
                                        builder =
                                                com.oracle.bmc.mediaservices.responses
                                                        .RemoveMediaWorkflowJobLockResponse
                                                        .builder()
