...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/RemoveMediaWorkflowJobLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveMediaWorkflowJobLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class RemoveMediaWorkflowJobLockRequest
     ...
     */
    private com.oracle.bmc.mediaservices.model.RemoveLockDetails removeLockDetails;

    /**
     * The details to be updated for the RemoveLock.
     */
    public com.oracle.bmc.mediaservices.model.RemoveLockDetails getRemoveLockDetails() {
    ...
    public static class Builder
         ...
         * The details to be updated for the RemoveLock.
         */
        private com.oracle.bmc.mediaservices.model.RemoveLockDetails removeLockDetails = null;
        ...
        public Builder removeLockDetails(
                com.oracle.bmc.mediaservices.model.RemoveLockDetails removeLockDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveMediaWorkflowJobLockRequest o) {
        ...
        /**
         * Build the instance of RemoveMediaWorkflowJobLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveMediaWorkflowJobLockRequest
         */
        public RemoveMediaWorkflowJobLockRequest build() {
            RemoveMediaWorkflowJobLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveMediaWorkflowJobLockRequest
         */
        public RemoveMediaWorkflowJobLockRequest buildWithoutInvocationCallback() {
            RemoveMediaWorkflowJobLockRequest request = new RemoveMediaWorkflowJobLockRequest();
            ...
            return request;
            // new RemoveMediaWorkflowJobLockRequest(removeLockDetails, mediaWorkflowJobId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveMediaWorkflowJobLockRequest)) {
            return false;
        }

        RemoveMediaWorkflowJobLockRequest other = (RemoveMediaWorkflowJobLockRequest) o;
