...
public class RemoveStreamDistributionChannelLockResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveStreamDistributionChannelLockResponse)) {
            return false;
        }

        RemoveStreamDistributionChannelLockResponse other =
                (RemoveStreamDistributionChannelLockResponse) o;
