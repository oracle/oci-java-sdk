...
public class ListStreamCdnConfigsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.mediaservices.model.StreamCdnConfigCollection
            getStreamCdnConfigCollection() {
        return streamCdnConfigCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListStreamCdnConfigsResponse> {
         ...
         * @return this builder
         */
        public Builder streamCdnConfigCollection(
                com.oracle.bmc.mediaservices.model.StreamCdnConfigCollection
                        streamCdnConfigCollection) {
            this.streamCdnConfigCollection = streamCdnConfigCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",streamCdnConfigCollection=").append(String.valueOf(streamCdnConfigCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListStreamCdnConfigsResponse)) {
            return false;
        }

        ListStreamCdnConfigsResponse other = (ListStreamCdnConfigsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.streamCdnConfigCollection, other.streamCdnConfigCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.streamCdnConfigCollection == null
                                ? 43
                                : this.streamCdnConfigCollection.hashCode());
        return result;
    }
}
