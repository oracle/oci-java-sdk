...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/RemoveStreamPackagingConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveStreamPackagingConfigLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class RemoveStreamPackagingConfigLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveStreamPackagingConfigLockRequest o) {
        ...
        /**
         * Build the instance of RemoveStreamPackagingConfigLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveStreamPackagingConfigLockRequest
         */
        public RemoveStreamPackagingConfigLockRequest build() {
            RemoveStreamPackagingConfigLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveStreamPackagingConfigLockRequest
         */
        public RemoveStreamPackagingConfigLockRequest buildWithoutInvocationCallback() {
            RemoveStreamPackagingConfigLockRequest request =
                    new RemoveStreamPackagingConfigLockRequest();
            ...
            return request;
            // new RemoveStreamPackagingConfigLockRequest(removeResourceLockDetails, streamPackagingConfigId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveStreamPackagingConfigLockRequest)) {
            return false;
        }

        RemoveStreamPackagingConfigLockRequest other = (RemoveStreamPackagingConfigLockRequest) o;
