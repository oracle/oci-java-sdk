...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/AddStreamDistributionChannelLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddStreamDistributionChannelLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class AddStreamDistributionChannelLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddStreamDistributionChannelLockRequest o) {
        ...
        /**
         * Build the instance of AddStreamDistributionChannelLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddStreamDistributionChannelLockRequest
         */
        public AddStreamDistributionChannelLockRequest build() {
            AddStreamDistributionChannelLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddStreamDistributionChannelLockRequest
         */
        public AddStreamDistributionChannelLockRequest buildWithoutInvocationCallback() {
            AddStreamDistributionChannelLockRequest request =
                    new AddStreamDistributionChannelLockRequest();
            ...
            return request;
            // new AddStreamDistributionChannelLockRequest(addResourceLockDetails, streamDistributionChannelId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddStreamDistributionChannelLockRequest)) {
            return false;
        }

        AddStreamDistributionChannelLockRequest other = (AddStreamDistributionChannelLockRequest) o;
