...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mediaservices/GetMediaAssetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMediaAssetRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211101")
public class GetMediaAssetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMediaAssetRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetMediaAssetRequest
         */
        public GetMediaAssetRequest build() {
            GetMediaAssetRequest request = buildWithoutInvocationCallback();
        ...
        public GetMediaAssetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetMediaAssetRequest(mediaAssetId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().mediaAssetId(mediaAssetId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetMediaAssetRequest other = (GetMediaAssetRequest) o;
