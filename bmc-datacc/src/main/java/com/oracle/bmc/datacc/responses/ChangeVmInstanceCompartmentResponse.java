...
public class ChangeVmInstanceCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeVmInstanceCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeVmInstanceCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeVmInstanceCompartmentResponse build() {
            return new ChangeVmInstanceCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVmInstanceCompartmentResponse)) {
            return false;
        }

        ChangeVmInstanceCompartmentResponse other = (ChangeVmInstanceCompartmentResponse) o;
