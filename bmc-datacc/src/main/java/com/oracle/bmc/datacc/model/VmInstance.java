...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VmInstance.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VmInstance extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VmInstance model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VmInstance)) {
            return false;
        }

        VmInstance other = (VmInstance) o;
