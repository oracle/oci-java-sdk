...
public class CreateInfrastructureResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateInfrastructureResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateInfrastructureResponse> {
         ...
         */
        @Override
        public Builder copy(CreateInfrastructureResponse o) {
         ...
         */
        @Override
        public CreateInfrastructureResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateInfrastructureResponse)) {
            return false;
        }

        CreateInfrastructureResponse other = (CreateInfrastructureResponse) o;
