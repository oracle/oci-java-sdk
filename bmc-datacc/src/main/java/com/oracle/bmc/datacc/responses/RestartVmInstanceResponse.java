...
public class RestartVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RestartVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RestartVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(RestartVmInstanceResponse o) {
         ...
         */
        @Override
        public RestartVmInstanceResponse build() {
            return new RestartVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartVmInstanceResponse)) {
            return false;
        }

        RestartVmInstanceResponse other = (RestartVmInstanceResponse) o;
