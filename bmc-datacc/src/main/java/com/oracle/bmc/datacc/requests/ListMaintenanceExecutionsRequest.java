...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/ListMaintenanceExecutionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMaintenanceExecutionsRequest.
 */
...
public class ListMaintenanceExecutionsRequest
    ...
    public static class Builder
        ...
        public ListMaintenanceExecutionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMaintenanceExecutionsRequest(compartmentId, displayName, infrastructureId, targetResourceType, maintenanceType, maintenanceRunId, lifecycleState, maintenanceSubtype, timeAcceptedLessThanOrEqualTo, timeAcceptedGreaterThanOrEqualTo, type, limit, page, sortBy, sortOrder, opcRequestId);
        }
    }
