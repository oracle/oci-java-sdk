...
public class GetVmInstanceConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetVmInstanceConverter.class);

    public static com.oracle.bmc.datacc.requests.GetVmInstanceRequest interceptRequest(
            com.oracle.bmc.datacc.requests.GetVmInstanceRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datacc.responses.GetVmInstanceResponse>() {
                            @Override
                            public com.oracle.bmc.datacc.responses.GetVmInstanceResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datacc.responses.GetVmInstanceResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.datacc.model.VmInstance>>
                                        responseFn;
                                ...
                                com.oracle.bmc.datacc.responses.GetVmInstanceResponse.Builder
                                        builder =
                                                com.oracle.bmc.datacc.responses
                                                        .GetVmInstanceResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.vmInstance(response.getItem());
