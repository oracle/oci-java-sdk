...
public class DownloadInfrastructureConfigFileResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DownloadInfrastructureConfigFileResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DownloadInfrastructureConfigFileResponse o) {
        ...
        public DownloadInfrastructureConfigFileResponse build() {
            return new DownloadInfrastructureConfigFileResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadInfrastructureConfigFileResponse)) {
            return false;
        }

        DownloadInfrastructureConfigFileResponse other =
                (DownloadInfrastructureConfigFileResponse) o;
