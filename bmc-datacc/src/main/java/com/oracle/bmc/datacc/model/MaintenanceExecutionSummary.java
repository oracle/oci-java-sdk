...
/**
 * Summary of a maintenance executions. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MaintenanceExecutionSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MaintenanceExecutionSummary
    ...
    public MaintenanceExecutionSummary(
            String id,
    ...
    public static class Builder {
        ...
        public MaintenanceExecutionSummary build() {
            MaintenanceExecutionSummary model =
                    new MaintenanceExecutionSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MaintenanceExecutionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MaintenanceExecutionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MaintenanceExecutionSummary)) {
            return false;
        }

        MaintenanceExecutionSummary other = (MaintenanceExecutionSummary) o;
