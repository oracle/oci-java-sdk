...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/ChangeInfrastructureCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeInfrastructureCompartmentRequest.
 */
...
public class ChangeInfrastructureCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeInfrastructureCompartmentRequest as configured by this builder
         *
        ...
        public ChangeInfrastructureCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeInfrastructureCompartmentRequest(infrastructureId, changeInfrastructureCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
