...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/ListVmClusterNetworksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVmClusterNetworksRequest.
 */
...
public class ListVmClusterNetworksRequest
    ...
    public static class Builder
        ...
        public ListVmClusterNetworksRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVmClusterNetworksRequest(compartmentId, displayName, lifecycleState, isScanEnabled, limit, page, sortOrder, sortBy, opcRequestId, infrastructureId, nodeCount, vmNetworkConsumerType);
        }
    }
