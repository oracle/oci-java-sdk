...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/RestartVmInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RestartVmInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251101")
public class RestartVmInstanceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RestartVmInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RestartVmInstanceRequest o) {
        ...
        /**
         * Build the instance of RestartVmInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of RestartVmInstanceRequest
         */
        public RestartVmInstanceRequest build() {
            RestartVmInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RestartVmInstanceRequest
         */
        public RestartVmInstanceRequest buildWithoutInvocationCallback() {
            RestartVmInstanceRequest request = new RestartVmInstanceRequest();
            request.vmInstanceId = vmInstanceId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RestartVmInstanceRequest(vmInstanceId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartVmInstanceRequest)) {
            return false;
        }

        RestartVmInstanceRequest other = (RestartVmInstanceRequest) o;
