...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/MigrateVmInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use MigrateVmInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251101")
public class MigrateVmInstanceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    MigrateVmInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(MigrateVmInstanceRequest o) {
        ...
        /**
         * Build the instance of MigrateVmInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of MigrateVmInstanceRequest
         */
        public MigrateVmInstanceRequest build() {
            MigrateVmInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of MigrateVmInstanceRequest
         */
        public MigrateVmInstanceRequest buildWithoutInvocationCallback() {
            MigrateVmInstanceRequest request = new MigrateVmInstanceRequest();
            request.vmInstanceId = vmInstanceId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new MigrateVmInstanceRequest(vmInstanceId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrateVmInstanceRequest)) {
            return false;
        }

        MigrateVmInstanceRequest other = (MigrateVmInstanceRequest) o;
