...
public class StartVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StartVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StartVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(StartVmInstanceResponse o) {
         ...
         */
        @Override
        public StartVmInstanceResponse build() {
            return new StartVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartVmInstanceResponse)) {
            return false;
        }

        StartVmInstanceResponse other = (StartVmInstanceResponse) o;
