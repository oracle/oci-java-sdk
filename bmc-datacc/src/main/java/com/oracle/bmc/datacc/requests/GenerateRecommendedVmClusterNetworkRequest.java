...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/GenerateRecommendedVmClusterNetworkExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GenerateRecommendedVmClusterNetworkRequest.
 */
...
public class GenerateRecommendedVmClusterNetworkRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails> {

    /**
     * Request to generate a recommended VM cluster network details configuration.
     */
    private com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails
            generateRecommendedVmClusterNetworkDetails;

    /**
     * Request to generate a recommended VM cluster network details configuration.
     */
    public com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails
            getGenerateRecommendedVmClusterNetworkDetails() {
        return generateRecommendedVmClusterNetworkDetails;
    }
    /**
    ...
    public com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails getBody$() {
        return generateRecommendedVmClusterNetworkDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails
                generateRecommendedVmClusterNetworkDetails = null;

        /**
         * Request to generate a recommended VM cluster network details configuration.
         * @param generateRecommendedVmClusterNetworkDetails the value to set
         * @return this builder instance
         */
        public Builder generateRecommendedVmClusterNetworkDetails(
                com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails
                        generateRecommendedVmClusterNetworkDetails) {
            this.generateRecommendedVmClusterNetworkDetails =
                    generateRecommendedVmClusterNetworkDetails;
            return this;
        }
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.datacc.model.GenerateRecommendedVmClusterNetworkDetails body) {
            generateRecommendedVmClusterNetworkDetails(body);
            return this;
        }
        ...
        public GenerateRecommendedVmClusterNetworkRequest buildWithoutInvocationCallback() {
            ...
            request.generateRecommendedVmClusterNetworkDetails =
                    generateRecommendedVmClusterNetworkDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new GenerateRecommendedVmClusterNetworkRequest(generateRecommendedVmClusterNetworkDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",generateRecommendedVmClusterNetworkDetails=")
                .append(String.valueOf(this.generateRecommendedVmClusterNetworkDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                && java.util.Objects.equals(
                        this.generateRecommendedVmClusterNetworkDetails,
                        other.generateRecommendedVmClusterNetworkDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.generateRecommendedVmClusterNetworkDetails == null
                                ? 43
                                : this.generateRecommendedVmClusterNetworkDetails.hashCode());
        result =
                (result * PRIME)
