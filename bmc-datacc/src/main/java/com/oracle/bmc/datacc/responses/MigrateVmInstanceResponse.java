...
public class MigrateVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private MigrateVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<MigrateVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(MigrateVmInstanceResponse o) {
         ...
         */
        @Override
        public MigrateVmInstanceResponse build() {
            return new MigrateVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrateVmInstanceResponse)) {
            return false;
        }

        MigrateVmInstanceResponse other = (MigrateVmInstanceResponse) o;
