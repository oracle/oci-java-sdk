...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/RescheduleMaintenanceRunExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RescheduleMaintenanceRunRequest.
 */
...
public class RescheduleMaintenanceRunRequest
    ...
    public static class Builder
        ...
        public RescheduleMaintenanceRunRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RescheduleMaintenanceRunRequest(maintenanceRunId, rescheduleMaintenanceRunDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
