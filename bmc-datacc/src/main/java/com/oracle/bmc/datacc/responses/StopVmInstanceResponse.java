...
public class StopVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StopVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(StopVmInstanceResponse o) {
         ...
         */
        @Override
        public StopVmInstanceResponse build() {
            return new StopVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopVmInstanceResponse)) {
            return false;
        }

        StopVmInstanceResponse other = (StopVmInstanceResponse) o;
