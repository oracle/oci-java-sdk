...
public class CreateVmClusterNetworkConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateVmClusterNetworkConverter.class);

    public static com.oracle.bmc.datacc.requests.CreateVmClusterNetworkRequest interceptRequest(
            com.oracle.bmc.datacc.requests.CreateVmClusterNetworkRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20251101").path("vmClusterNetworks");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.datacc.responses.CreateVmClusterNetworkResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datacc.responses.CreateVmClusterNetworkResponse>() {
                            @Override
                            public com.oracle.bmc.datacc.responses.CreateVmClusterNetworkResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datacc.responses.CreateVmClusterNetworkResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.datacc.model.VmClusterNetwork
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
