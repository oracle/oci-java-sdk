...
public class ListMaintenanceExecutionsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListMaintenanceExecutionsConverter.class);

    public static com.oracle.bmc.datacc.requests.ListMaintenanceExecutionsRequest interceptRequest(
            com.oracle.bmc.datacc.requests.ListMaintenanceExecutionsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20251101").path("maintenanceExecutions");
        ...
        if (request.getMaintenanceRunId() != null) {
            target =
                    target.queryParam(
                            "maintenanceRunId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.datacc.responses.ListMaintenanceExecutionsResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.datacc.responses.ListMaintenanceExecutionsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datacc.responses.ListMaintenanceExecutionsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.datacc.responses.ListMaintenanceExecutionsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.datacc.responses
                                                        .ListMaintenanceExecutionsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.maintenanceExecutionCollection(response.getItem());
