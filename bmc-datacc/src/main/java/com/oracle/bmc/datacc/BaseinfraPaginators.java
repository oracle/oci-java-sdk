...
public class BaseinfraPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listInfrastructures operation. This iterable
    ...
    public Iterable<ListInfrastructuresResponse> listInfrastructuresResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListInfrastructuresRequest.Builder, ListInfrastructuresRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.InfrastructureSummary} objects
     * contained in responses from the listInfrastructures operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.InfrastructureSummary} objects
    ...
    public Iterable<com.oracle.bmc.datacc.model.InfrastructureSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListInfrastructuresRequest.Builder, ListInfrastructuresRequest,
                ListInfrastructuresResponse, com.oracle.bmc.datacc.model.InfrastructureSummary>(
                new java.util.function.Supplier<ListInfrastructuresRequest.Builder>() {
                    @Override
                    public ListInfrastructuresRequest.Builder get() {
                        return ListInfrastructuresRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMaintenanceExecutions operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListMaintenanceExecutionsResponse> listMaintenanceExecutionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMaintenanceExecutionsRequest.Builder, ListMaintenanceExecutionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.MaintenanceExecutionSummary} objects
     * contained in responses from the listMaintenanceExecutions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.MaintenanceExecutionSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.MaintenanceRunSummary} objects
     * contained in responses from the listMaintenanceRuns operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.MaintenanceRunSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.datacc.model.MaintenanceRunSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListMaintenanceRunsRequest.Builder, ListMaintenanceRunsRequest,
                ListMaintenanceRunsResponse, com.oracle.bmc.datacc.model.MaintenanceRunSummary>(
                new java.util.function.Supplier<ListMaintenanceRunsRequest.Builder>() {
                    @Override
                    public ListMaintenanceRunsRequest.Builder get() {
                        return ListMaintenanceRunsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.VmClusterNetworkSummary} objects
     * contained in responses from the listVmClusterNetworks operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.VmClusterNetworkSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.datacc.model.VmClusterNetworkSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListVmClusterNetworksRequest.Builder, ListVmClusterNetworksRequest,
                ListVmClusterNetworksResponse, com.oracle.bmc.datacc.model.VmClusterNetworkSummary>(
                new java.util.function.Supplier<ListVmClusterNetworksRequest.Builder>() {
                    @Override
                    public ListVmClusterNetworksRequest.Builder get() {
                        return ListVmClusterNetworksRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listVmInstances operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.VmInstanceSummary} objects
     * contained in responses from the listVmInstances operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.VmInstanceSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.WorkRequestError} objects
     * contained in responses from the listWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.datacc.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestErrorsRequest.Builder, ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse, com.oracle.bmc.datacc.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.WorkRequestLogEntry} objects
     * contained in responses from the listWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.datacc.model.WorkRequestLogEntry>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestLogsRequest.Builder, ListWorkRequestLogsRequest,
                ListWorkRequestLogsResponse, com.oracle.bmc.datacc.model.WorkRequestLogEntry>(
                new java.util.function.Supplier<ListWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListWorkRequestLogsRequest.Builder get() {
                        return ListWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.datacc.model.WorkRequest} objects
     * contained in responses from the listWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.datacc.model.WorkRequest} objects
     * contained in responses received from the service.
     */
