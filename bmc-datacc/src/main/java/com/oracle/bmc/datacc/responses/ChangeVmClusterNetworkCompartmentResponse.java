...
public class ChangeVmClusterNetworkCompartmentResponse
    ...
    private ChangeVmClusterNetworkCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeVmClusterNetworkCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeVmClusterNetworkCompartmentResponse build() {
            return new ChangeVmClusterNetworkCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVmClusterNetworkCompartmentResponse)) {
            return false;
        }

        ChangeVmClusterNetworkCompartmentResponse other =
                (ChangeVmClusterNetworkCompartmentResponse) o;
