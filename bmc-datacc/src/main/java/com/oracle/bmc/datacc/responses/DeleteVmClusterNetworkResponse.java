...
public class DeleteVmClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public DeleteVmClusterNetworkResponse build() {
            return new DeleteVmClusterNetworkResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVmClusterNetworkResponse)) {
            return false;
        }

        DeleteVmClusterNetworkResponse other = (DeleteVmClusterNetworkResponse) o;
