...
/**
 * Contact details for Database Infrastructure. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InfrastructureContact.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InfrastructureContact
    ...
    public static class Builder {
        ...
        /**
         * If {@code true}, this Database Infrastructure contact is a primary contact. If {@code
         * false}, this Database Infrastructure is a secondary contact.
         */
        ...
        /**
         * If {@code true}, this Database Infrastructure contact is a valid My Oracle Support (MOS)
         * contact. If {@code false}, this Database Infrastructure contact is not a valid MOS
         * contact.
         */
        ...
        public InfrastructureContact build() {
            InfrastructureContact model =
                    new InfrastructureContact(
                            this.name,
                            this.phoneNumber,
                            this.email,
                            this.isPrimary,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InfrastructureContact model) {
    ...
    /**
     * If {@code true}, this Database Infrastructure contact is a primary contact. If {@code false},
     * this Database Infrastructure is a secondary contact.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isPrimary")
    ...
    /**
     * If {@code true}, this Database Infrastructure contact is a valid My Oracle Support (MOS)
     * contact. If {@code false}, this Database Infrastructure contact is not a valid MOS contact.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isContactMosValidated")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InfrastructureContact(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InfrastructureContact)) {
            return false;
        }

        InfrastructureContact other = (InfrastructureContact) o;
