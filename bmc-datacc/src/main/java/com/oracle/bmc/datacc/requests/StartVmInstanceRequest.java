...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/StartVmInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartVmInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251101")
public class StartVmInstanceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    StartVmInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(StartVmInstanceRequest o) {
        ...
        /**
         * Build the instance of StartVmInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of StartVmInstanceRequest
         */
        public StartVmInstanceRequest build() {
            StartVmInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StartVmInstanceRequest
         */
        public StartVmInstanceRequest buildWithoutInvocationCallback() {
            StartVmInstanceRequest request = new StartVmInstanceRequest();
            request.vmInstanceId = vmInstanceId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new StartVmInstanceRequest(vmInstanceId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartVmInstanceRequest)) {
            return false;
        }

        StartVmInstanceRequest other = (StartVmInstanceRequest) o;
