...
/**
 * Request to update Database Infrastructure resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateInfrastructureDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateInfrastructureDetails
    ...
    public UpdateInfrastructureDetails(
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public UpdateInfrastructureDetails build() {
            UpdateInfrastructureDetails model =
                    new UpdateInfrastructureDetails(
                            this.displayName,
                            this.description,
                            this.systemModel,
                            this.shape,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateInfrastructureDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateInfrastructureDetails)) {
            return false;
        }

        UpdateInfrastructureDetails other = (UpdateInfrastructureDetails) o;
