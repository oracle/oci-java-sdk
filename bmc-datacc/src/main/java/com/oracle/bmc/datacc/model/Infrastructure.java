...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Infrastructure.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class Infrastructure extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Infrastructure(
            ...
            java.util.List<InfrastructureServer> servers,
    ...
    public static class Builder {
         ...
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("recoDiskPercentage")
        private Integer recoDiskPercentage;

        /**
         * Percentage of disk space assigned for RECO disk group.
         * @param recoDiskPercentage the value to set
         * @return this builder
         **/
        public Builder recoDiskPercentage(Integer recoDiskPercentage) {
            this.recoDiskPercentage = recoDiskPercentage;
            this.__explicitlySet__.add("recoDiskPercentage");
            return this;
        }
        /**
        ...
        private java.util.List<InfrastructureServer> servers;
         ...
         * @return this builder
         **/
        public Builder servers(java.util.List<InfrastructureServer> servers) {
            this.servers = servers;
         ...
         *
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("networkAdapterConfiguration")
        private String networkAdapterConfiguration;

        /**
         * The network adapter, transceiver and cable configuration for the client and backup networks.
         *
         * @param networkAdapterConfiguration the value to set
         * @return this builder
         **/
        public Builder networkAdapterConfiguration(String networkAdapterConfiguration) {
            this.networkAdapterConfiguration = networkAdapterConfiguration;
            this.__explicitlySet__.add("networkAdapterConfiguration");
            return this;
        }
        /**
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Infrastructure model) {
            ...
            if (model.wasPropertyExplicitlySet("recoDiskPercentage")) {
                this.recoDiskPercentage(model.getRecoDiskPercentage());
            }
            ...
            if (model.wasPropertyExplicitlySet("networkAdapterConfiguration")) {
                this.networkAdapterConfiguration(model.getNetworkAdapterConfiguration());
            }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("recoDiskPercentage")
    private final Integer recoDiskPercentage;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("servers")
    private final java.util.List<InfrastructureServer> servers;

    /**
     * A list of Database Infrastructure nodes.
     * @return the value
     **/
    public java.util.List<InfrastructureServer> getServers() {
        return servers;
    }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("networkAdapterConfiguration")
    private final String networkAdapterConfiguration;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", recoDiskPercentage=").append(String.valueOf(this.recoDiskPercentage));
        ...
        sb.append(", networkAdapterConfiguration=")
                .append(String.valueOf(this.networkAdapterConfiguration));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.recoDiskPercentage, other.recoDiskPercentage)
                ...
                && java.util.Objects.equals(
                        this.networkAdapterConfiguration, other.networkAdapterConfiguration)
                && java.util.Objects.equals(
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.recoDiskPercentage == null
                                ? 43
                                : this.recoDiskPercentage.hashCode());
        ...
        result =
                (result * PRIME)
                        + (this.networkAdapterConfiguration == null
                                ? 43
                                : this.networkAdapterConfiguration.hashCode());
        result =
                (result * PRIME)
