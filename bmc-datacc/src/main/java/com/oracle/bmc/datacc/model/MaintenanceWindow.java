...
public final class MaintenanceWindow
    ...
    public MaintenanceWindow(
            MaintenancePreference preference,
            BasePatchingMode patchingMode,
            ...
            java.util.List<DaysOfWeek> daysOfWeek,
    ...
    public static class Builder {
        ...
        private MaintenancePreference preference;
         ...
         * @return this builder
         */
        public Builder preference(MaintenancePreference preference) {
            this.preference = preference;
            this.__explicitlySet__.add("preference");
            return this;
        }
        /**
         * Cloud Database Infrastructure node patching method. *IMPORTANT*: Non-rolling
         * infrastructure patching involves system down time. See [Oracle-Managed Database
        ...
        private BasePatchingMode patchingMode;
         ...
         * @return this builder
         */
        public Builder patchingMode(BasePatchingMode patchingMode) {
            this.patchingMode = patchingMode;
         ...
         * Infrastructure server patching operation. Custom action timeout is in minutes and valid
        ...
        private java.util.List<Months> months;
         ...
         * @return this builder
         */
        public Builder months(java.util.List<Months> months) {
            this.months = months;
         ...
         * @return this builder
         */
        public Builder daysOfWeek(java.util.List<DaysOfWeek> daysOfWeek) {
            this.daysOfWeek = daysOfWeek;
    ...
    /** The maintenance window scheduling preference. */
    @com.fasterxml.jackson.annotation.JsonProperty("preference")
    private final MaintenancePreference preference;
     ...
     * @return the value
     */
    public MaintenancePreference getPreference() {
        return preference;
    }

    /**
     * Cloud Database Infrastructure node patching method. *IMPORTANT*: Non-rolling infrastructure
     * patching involves system down time. See [Oracle-Managed Database Infrastructure Maintenance
     * Updates](https://docs.oracle.com/iaas/Content/Database/Concepts/examaintenance.htm#Oracle)
     * for more information.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("patchingMode")
    private final BasePatchingMode patchingMode;
     ...
     * @return the value
     */
    public BasePatchingMode getPatchingMode() {
        return patchingMode;
    }
    ...
    /**
     * Determines the amount of time the system will wait before the start of each Database
     * Infrastructure server patching operation. Custom action timeout is in minutes and valid value
     * is between 15 to 120 (inclusive).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("customActionTimeoutInMins")
    ...
    /** */
    public enum Months implements com.oracle.bmc.http.internal.BmcEnum {
        January("JANUARY"),
        February("FEBRUARY"),
        March("MARCH"),
        April("APRIL"),
        ...
        private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(Months.class);

        private final String value;
        private static java.util.Map<String, Months> map;

        static {
            map = new java.util.HashMap<>();
            for (Months v : Months.values()) {
        ...
        public static Months create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'Months', returning UnknownEnumValue",
                    key);
    ...
    /** Months during the year when maintenance should be performed. */
    @com.fasterxml.jackson.annotation.JsonProperty("months")
    private final java.util.List<Months> months;
     ...
     * @return the value
     */
    public java.util.List<Months> getMonths() {
        return months;
    }
    ...
    /** */
    public enum DaysOfWeek implements com.oracle.bmc.http.internal.BmcEnum {
        Monday("MONDAY"),
        Tuesday("TUESDAY"),
        Wednesday("WEDNESDAY"),
        Thursday("THURSDAY"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(DaysOfWeek.class);

        private final String value;
        private static java.util.Map<String, DaysOfWeek> map;

        static {
            map = new java.util.HashMap<>();
            for (DaysOfWeek v : DaysOfWeek.values()) {
                if (v != UnknownEnumValue) {
                    map.put(v.getValue(), v);
                }
            }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static DaysOfWeek create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'DaysOfWeek', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
