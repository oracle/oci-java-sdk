...
public final class ScanDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"hostname", "ips"})
    public ScanDetails(String hostname, java.util.List<String> ips) {
        super();
    ...
    public static class Builder {
        ...
        public ScanDetails build() {
            ScanDetails model = new ScanDetails(this.hostname, this.ips);
