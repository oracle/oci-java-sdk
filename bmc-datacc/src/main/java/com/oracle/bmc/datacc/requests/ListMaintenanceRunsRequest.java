...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacc/ListMaintenanceRunsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMaintenanceRunsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251101")
public class ListMaintenanceRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMaintenanceRunsRequest, java.lang.Void> {
         ...
         *
         * @return instance of ListMaintenanceRunsRequest
         */
        public ListMaintenanceRunsRequest build() {
            ListMaintenanceRunsRequest request = buildWithoutInvocationCallback();
        ...
        public ListMaintenanceRunsRequest buildWithoutInvocationCallback() {
            ListMaintenanceRunsRequest request = new ListMaintenanceRunsRequest();
            ...
            return request;
            // new ListMaintenanceRunsRequest(compartmentId, displayName, infrastructureId, targetResourceType, maintenanceType, lifecycleState, maintenanceSubtype, timeAcceptedLessThanOrEqualTo, timeAcceptedGreaterThanOrEqualTo, limit, page, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        ListMaintenanceRunsRequest other = (ListMaintenanceRunsRequest) o;
