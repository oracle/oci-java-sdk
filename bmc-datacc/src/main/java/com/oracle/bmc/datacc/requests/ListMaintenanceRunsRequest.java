...
public class ListMaintenanceRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMaintenanceRunsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMaintenanceRunsRequest(compartmentId, displayName, infrastructureId,
            // targetResourceType, maintenanceType, lifecycleState, maintenanceSubtype,
            // timeAcceptedLessThanOrEqualTo, timeAcceptedGreaterThanOrEqualTo, limit, page, sortBy,
