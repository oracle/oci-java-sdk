...
public class ValidateInfrastructureResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ValidateInfrastructureResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ValidateInfrastructureResponse o) {
         ...
         */
        @Override
        public ValidateInfrastructureResponse build() {
            return new ValidateInfrastructureResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateInfrastructureResponse)) {
            return false;
        }

        ValidateInfrastructureResponse other = (ValidateInfrastructureResponse) o;
