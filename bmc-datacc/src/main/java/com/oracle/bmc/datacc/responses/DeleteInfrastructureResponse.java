...
public class DeleteInfrastructureResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteInfrastructureResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteInfrastructureResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteInfrastructureResponse o) {
         ...
         */
        @Override
        public DeleteInfrastructureResponse build() {
            return new DeleteInfrastructureResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteInfrastructureResponse)) {
            return false;
        }

        DeleteInfrastructureResponse other = (DeleteInfrastructureResponse) o;
