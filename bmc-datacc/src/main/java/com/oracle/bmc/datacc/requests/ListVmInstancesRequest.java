 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVmInstancesRequest.
 */
...
public class ListVmInstancesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
     * Database Infrastructure Server Id.
     */
    ...
    public static class Builder
        ...
        public ListVmInstancesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVmInstancesRequest(compartmentId, displayName, lifecycleState, limit, page,
            // sortOrder, sortBy, opcRequestId, infrastructureId, baseServerId);
        }
    }
