...
public class DeleteVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteVmInstanceResponse o) {
         ...
         */
        @Override
        public DeleteVmInstanceResponse build() {
            return new DeleteVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVmInstanceResponse)) {
            return false;
        }

        DeleteVmInstanceResponse other = (DeleteVmInstanceResponse) o;
