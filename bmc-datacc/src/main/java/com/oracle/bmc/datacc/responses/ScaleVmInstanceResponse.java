...
public class ScaleVmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ScaleVmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ScaleVmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(ScaleVmInstanceResponse o) {
         ...
         */
        @Override
        public ScaleVmInstanceResponse build() {
            return new ScaleVmInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleVmInstanceResponse)) {
            return false;
        }

        ScaleVmInstanceResponse other = (ScaleVmInstanceResponse) o;
