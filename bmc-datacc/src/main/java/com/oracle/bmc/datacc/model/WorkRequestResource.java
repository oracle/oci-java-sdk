...
public final class WorkRequestResource
    ...
    public static class Builder {
         ...
         * is complete for that resource. When work is complete, the state transitions to CREATED,
         * UPDATED, or DELETED.
         */
         ...
         * resource being acted on by the work request.
         */
     ...
     * complete for that resource. When work is complete, the state transitions to CREATED, UPDATED,
     * or DELETED.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("actionType")
