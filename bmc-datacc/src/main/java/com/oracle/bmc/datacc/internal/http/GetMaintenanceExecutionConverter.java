...
public class GetMaintenanceExecutionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMaintenanceExecutionConverter.class);

    public static com.oracle.bmc.datacc.requests.GetMaintenanceExecutionRequest interceptRequest(
            com.oracle.bmc.datacc.requests.GetMaintenanceExecutionRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getMaintenanceExecutionId()));
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.datacc.responses.GetMaintenanceExecutionResponse>() {
                            @Override
                            public com.oracle.bmc.datacc.responses.GetMaintenanceExecutionResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datacc.responses.GetMaintenanceExecutionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.datacc.responses.GetMaintenanceExecutionResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.datacc.responses
                                                        .GetMaintenanceExecutionResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.maintenanceExecution(response.getItem());
