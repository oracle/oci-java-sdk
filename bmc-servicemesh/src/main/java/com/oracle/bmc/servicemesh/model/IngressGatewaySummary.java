...
/**
 * Summary of the IngressGateway. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IngressGatewaySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IngressGatewaySummary
    ...
    public static class Builder {
        ...
        private IngressGateway.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(IngressGateway.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public IngressGatewaySummary build() {
            IngressGatewaySummary model =
                    new IngressGatewaySummary(
                            this.id,
                            this.name,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressGatewaySummary model) {
    ...
    /** The current state of the IngressGateway. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final IngressGateway.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public IngressGateway.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IngressGatewaySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressGatewaySummary)) {
            return false;
        }

        IngressGatewaySummary other = (IngressGatewaySummary) o;
