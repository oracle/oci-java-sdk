...
public class GetVirtualServiceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVirtualServiceResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVirtualServiceResponse)) {
            return false;
        }

        GetVirtualServiceResponse other = (GetVirtualServiceResponse) o;
