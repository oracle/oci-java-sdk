...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemesh/UpdateVirtualServiceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateVirtualServiceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220615")
public class UpdateVirtualServiceRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.servicemesh.model.UpdateVirtualServiceDetails> {
    ...
    public com.oracle.bmc.servicemesh.model.UpdateVirtualServiceDetails getBody$() {
        return updateVirtualServiceDetails;
    }
    ...
    public static class Builder
        ...
        public Builder copy(UpdateVirtualServiceRequest o) {
            ...
            updateVirtualServiceDetails(o.getUpdateVirtualServiceDetails());
        ...
        /**
         * Build the instance of UpdateVirtualServiceRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateVirtualServiceRequest
         */
        public UpdateVirtualServiceRequest build() {
            UpdateVirtualServiceRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.servicemesh.model.UpdateVirtualServiceDetails body) {
            updateVirtualServiceDetails(body);
            return this;
        }
        ...
        public UpdateVirtualServiceRequest buildWithoutInvocationCallback() {
            ...
            request.updateVirtualServiceDetails = updateVirtualServiceDetails;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateVirtualServiceRequest(virtualServiceId, updateVirtualServiceDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateVirtualServiceDetails=")
                .append(String.valueOf(this.updateVirtualServiceDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateVirtualServiceRequest other = (UpdateVirtualServiceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.virtualServiceId, other.virtualServiceId)
                && java.util.Objects.equals(
                        this.updateVirtualServiceDetails, other.updateVirtualServiceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateVirtualServiceDetails == null
                                ? 43
                                : this.updateVirtualServiceDetails.hashCode());
