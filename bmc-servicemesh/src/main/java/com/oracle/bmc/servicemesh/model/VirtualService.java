...
/**
 * This resource represents a customer-managed service in the Service Mesh. Each virtual service
 * declares multiple running versions of the service and maps to a group of instances/pods running a
 * specific version of the actual service. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VirtualService.Builder.class)
...
public final class VirtualService
    ...
    public static class Builder {
        ...
        private MutualTransportLayerSecurity mtls;

        public Builder mtls(MutualTransportLayerSecurity mtls) {
            this.mtls = mtls;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualService model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("mtls")
    private final MutualTransportLayerSecurity mtls;

    public MutualTransportLayerSecurity getMtls() {
        return mtls;
    }
