...
/**
 * Summary of the IngressGatewayRouteTable. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IngressGatewayRouteTableSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IngressGatewayRouteTableSummary
    ...
    public IngressGatewayRouteTableSummary(
            String id,
            String name,
            String description,
    ...
    public static class Builder {
        ...
        /**
         * A user-friendly name. The name must be unique within the same ingress gateway and cannot
        ...
        private IngressGatewayRouteTable.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(IngressGatewayRouteTable.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public IngressGatewayRouteTableSummary build() {
            IngressGatewayRouteTableSummary model =
                    new IngressGatewayRouteTableSummary(
                            this.id,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressGatewayRouteTableSummary model) {
    ...
    /**
     * A user-friendly name. The name must be unique within the same ingress gateway and cannot be
    ...
    /** The current state of the ingress gateway. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final IngressGatewayRouteTable.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public IngressGatewayRouteTable.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IngressGatewayRouteTableSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressGatewayRouteTableSummary)) {
            return false;
        }

        IngressGatewayRouteTableSummary other = (IngressGatewayRouteTableSummary) o;
