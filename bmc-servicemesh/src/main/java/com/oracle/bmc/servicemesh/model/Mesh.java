...
/**
 * The mesh resource is the top-level container that represents the logical boundary of application
 * traffic between the services and deployments that reside within it. A mesh also provides a unit
 * of access control. <br>
...
public final class Mesh extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * A user-friendly name. The name does not have to be unique and can be changed after
         ...
         * authentication. Currently we only support one certificate authority, but this may expand
         * in future releases. Request with more than one certificate authority will be rejected.
         */
        ...
        public Builder certificateAuthorities(
                java.util.List<CertificateAuthority> certificateAuthorities) {
            this.certificateAuthorities = certificateAuthorities;
            this.__explicitlySet__.add("certificateAuthorities");
            return this;
        }

        @com.fasterxml.jackson.annotation.JsonProperty("mtls")
        private MeshMutualTransportLayerSecurity mtls;

        public Builder mtls(MeshMutualTransportLayerSecurity mtls) {
            this.mtls = mtls;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Mesh model) {
            ...
            if (model.wasPropertyExplicitlySet("certificateAuthorities")) {
                this.certificateAuthorities(model.getCertificateAuthorities());
            }
    ...
    /**
     * A list of certificate authority resources to use for creating leaf certificates for mTLS
     * authentication. Currently we only support one certificate authority, but this may expand in
     * future releases. Request with more than one certificate authority will be rejected.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("certificateAuthorities")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("mtls")
    private final MeshMutualTransportLayerSecurity mtls;

    public MeshMutualTransportLayerSecurity getMtls() {
        return mtls;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", certificateAuthorities=").append(String.valueOf(this.certificateAuthorities));
        ...
        result =
                (result * PRIME)
                        + (this.certificateAuthorities == null
                                ? 43
                                : this.certificateAuthorities.hashCode());
