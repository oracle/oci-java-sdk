...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TcpIngressGatewayTrafficRouteRuleDetails.Builder.class
)
...
public final class TcpIngressGatewayTrafficRouteRuleDetails
    ...
    public static class Builder {
        ...
        public TcpIngressGatewayTrafficRouteRuleDetails build() {
            TcpIngressGatewayTrafficRouteRuleDetails model =
                    new TcpIngressGatewayTrafficRouteRuleDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TcpIngressGatewayTrafficRouteRuleDetails model) {
    ...
    @Deprecated
    public TcpIngressGatewayTrafficRouteRuleDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TcpIngressGatewayTrafficRouteRuleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TcpIngressGatewayTrafficRouteRuleDetails)) {
            return false;
        }

        TcpIngressGatewayTrafficRouteRuleDetails other =
                (TcpIngressGatewayTrafficRouteRuleDetails) o;
