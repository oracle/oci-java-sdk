...
/**
 * Access policies enable administrators to restrict the access of certain services. <br>
...
public final class AccessPolicy extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AccessPolicy model) {
