...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemesh/CreateIngressGatewayRouteTableExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIngressGatewayRouteTableRequest.
 */
...
public class CreateIngressGatewayRouteTableRequest
    ...
    public static class Builder
        ...
        public CreateIngressGatewayRouteTableRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateIngressGatewayRouteTableRequest(createIngressGatewayRouteTableDetails, opcRetryToken, opcRequestId);
        }
    }
