...
public final class IngressGatewayAccessPolicyTarget extends AccessPolicyTarget {
    ...
    public static class Builder {
        ...
        public IngressGatewayAccessPolicyTarget build() {
            IngressGatewayAccessPolicyTarget model =
                    new IngressGatewayAccessPolicyTarget(this.ingressGatewayId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressGatewayAccessPolicyTarget model) {
