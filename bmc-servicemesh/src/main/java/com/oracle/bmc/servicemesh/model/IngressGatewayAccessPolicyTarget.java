...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = IngressGatewayAccessPolicyTarget.Builder.class
)
...
public final class IngressGatewayAccessPolicyTarget extends AccessPolicyTarget {
    ...
    public static class Builder {
        ...
        public IngressGatewayAccessPolicyTarget build() {
            IngressGatewayAccessPolicyTarget __instance__ =
                    new IngressGatewayAccessPolicyTarget(ingressGatewayId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressGatewayAccessPolicyTarget o) {
            Builder copiedBuilder = ingressGatewayId(o.getIngressGatewayId());
    ...
    @Deprecated
    public IngressGatewayAccessPolicyTarget(String ingressGatewayId) {
        super();
        this.ingressGatewayId = ingressGatewayId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IngressGatewayAccessPolicyTarget(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngressGatewayAccessPolicyTarget)) {
            return false;
        }

        IngressGatewayAccessPolicyTarget other = (IngressGatewayAccessPolicyTarget) o;
