...
public class CreateVirtualServiceRouteTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateVirtualServiceRouteTableResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateVirtualServiceRouteTableResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",virtualServiceRouteTable=").append(String.valueOf(virtualServiceRouteTable));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVirtualServiceRouteTableResponse)) {
            return false;
        }

        CreateVirtualServiceRouteTableResponse other = (CreateVirtualServiceRouteTableResponse) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.virtualServiceRouteTable, other.virtualServiceRouteTable);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.virtualServiceRouteTable == null
                                ? 43
                                : this.virtualServiceRouteTable.hashCode());
        return result;
    }
}
