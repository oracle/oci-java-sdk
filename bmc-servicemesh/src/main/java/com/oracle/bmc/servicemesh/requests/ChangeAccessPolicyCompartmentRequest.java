...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemesh/ChangeAccessPolicyCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAccessPolicyCompartmentRequest.
 */
...
public class ChangeAccessPolicyCompartmentRequest
     ...
     * The information to be updated.
     */
    public com.oracle.bmc.servicemesh.model.ChangeAccessPolicyCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.servicemesh.model.ChangeAccessPolicyCompartmentDetails
                changeAccessPolicyCompartmentDetails = null;

        /**
         * The information to be updated.
         * @param changeAccessPolicyCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeAccessPolicyCompartmentDetails(
                com.oracle.bmc.servicemesh.model.ChangeAccessPolicyCompartmentDetails
                        changeAccessPolicyCompartmentDetails) {
            this.changeAccessPolicyCompartmentDetails = changeAccessPolicyCompartmentDetails;
            return this;
        }
         ...
         * @return instance of ChangeAccessPolicyCompartmentRequest
         */
        public ChangeAccessPolicyCompartmentRequest buildWithoutInvocationCallback() {
            ChangeAccessPolicyCompartmentRequest request =
                    new ChangeAccessPolicyCompartmentRequest();
            request.accessPolicyId = accessPolicyId;
            request.changeAccessPolicyCompartmentDetails = changeAccessPolicyCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeAccessPolicyCompartmentRequest(accessPolicyId, changeAccessPolicyCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeAccessPolicyCompartmentDetails=")
                .append(String.valueOf(this.changeAccessPolicyCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAccessPolicyCompartmentRequest)) {
            return false;
        }

        ChangeAccessPolicyCompartmentRequest other = (ChangeAccessPolicyCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.accessPolicyId, other.accessPolicyId)
                && java.util.Objects.equals(
                        this.changeAccessPolicyCompartmentDetails,
                        other.changeAccessPolicyCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeAccessPolicyCompartmentDetails == null
                                ? 43
                                : this.changeAccessPolicyCompartmentDetails.hashCode());
