...
/**
 * Details of the proxy such as version of the proxy image. <br>
...
public final class ProxyDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
