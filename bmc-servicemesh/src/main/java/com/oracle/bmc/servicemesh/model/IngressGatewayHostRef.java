...
public final class IngressGatewayHostRef {
    ...
    public static class Builder {
        ...
        public IngressGatewayHostRef build() {
            IngressGatewayHostRef __instance__ = new IngressGatewayHostRef(name, port);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngressGatewayHostRef o) {
            Builder copiedBuilder = name(o.getName()).port(o.getPort());
