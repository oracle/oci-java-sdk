...
/**
 * This resource represents a customer-managed virtual service deployment in the Service Mesh. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VirtualDeployment.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VirtualDeployment
    ...
    public static class Builder {
        ...
        public VirtualDeployment build() {
            VirtualDeployment model =
                    new VirtualDeployment(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualDeployment model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VirtualDeployment)) {
            return false;
        }

        VirtualDeployment other = (VirtualDeployment) o;
