...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HttpIngressGatewayTrafficRouteRuleDetails.Builder.class)
...
public final class HttpIngressGatewayTrafficRouteRuleDetails
    ...
    public static class Builder {
        ...
        public HttpIngressGatewayTrafficRouteRuleDetails build() {
            HttpIngressGatewayTrafficRouteRuleDetails model =
                    new HttpIngressGatewayTrafficRouteRuleDetails(
    ...
    @Deprecated
    public HttpIngressGatewayTrafficRouteRuleDetails(
    ...
    public boolean equals(Object o) {
        ...
        HttpIngressGatewayTrafficRouteRuleDetails other =
                (HttpIngressGatewayTrafficRouteRuleDetails) o;
