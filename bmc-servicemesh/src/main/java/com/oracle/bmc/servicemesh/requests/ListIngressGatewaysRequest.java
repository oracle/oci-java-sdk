...
public class ListIngressGatewaysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         */
        public ListIngressGatewaysRequest build() {
            ListIngressGatewaysRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListIngressGatewaysRequest
         */
        public ListIngressGatewaysRequest buildWithoutInvocationCallback() {
            ListIngressGatewaysRequest request = new ListIngressGatewaysRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIngressGatewaysRequest)) {
            return false;
        }

        ListIngressGatewaysRequest other = (ListIngressGatewaysRequest) o;
