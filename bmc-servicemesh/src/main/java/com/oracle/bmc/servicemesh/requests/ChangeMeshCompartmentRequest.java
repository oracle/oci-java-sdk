...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemesh/ChangeMeshCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeMeshCompartmentRequest.
 */
...
public class ChangeMeshCompartmentRequest
    ...
    public com.oracle.bmc.servicemesh.model.ChangeMeshCompartmentDetails getBody$() {
        return changeMeshCompartmentDetails;
    }
    ...
    public static class Builder
        ...
        /**
         * The information to be updated.
         * @param changeMeshCompartmentDetails the value to set
         * @return this builder instance
         */
        ...
        public Builder copy(ChangeMeshCompartmentRequest o) {
            meshId(o.getMeshId());
            changeMeshCompartmentDetails(o.getChangeMeshCompartmentDetails());
        ...
        public ChangeMeshCompartmentRequest build() {
            ChangeMeshCompartmentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.servicemesh.model.ChangeMeshCompartmentDetails body) {
