...
public final class UpdateAccessPolicyDetails
    ...
    public static class Builder {
        ...
        public UpdateAccessPolicyDetails build() {
            UpdateAccessPolicyDetails model =
                    new UpdateAccessPolicyDetails(
                            this.description, this.rules, this.freeformTags, this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAccessPolicyDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAccessPolicyDetails)) {
            return false;
        }

        UpdateAccessPolicyDetails other = (UpdateAccessPolicyDetails) o;
