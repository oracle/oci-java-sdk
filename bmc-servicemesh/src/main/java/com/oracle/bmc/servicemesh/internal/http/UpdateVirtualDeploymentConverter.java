...
public class UpdateVirtualDeploymentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateVirtualDeploymentConverter.class);

    public static com.oracle.bmc.servicemesh.requests.UpdateVirtualDeploymentRequest
            interceptRequest(
                    com.oracle.bmc.servicemesh.requests.UpdateVirtualDeploymentRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getVirtualDeploymentId()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.servicemesh.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.servicemesh.responses.UpdateVirtualDeploymentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.servicemesh.responses.UpdateVirtualDeploymentResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.servicemesh.responses
                                                        .UpdateVirtualDeploymentResponse.builder()
