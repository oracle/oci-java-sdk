...
public final class DefaultVirtualServiceRoutingPolicy {
    ...
    public static class Builder {
        ...
        public DefaultVirtualServiceRoutingPolicy build() {
            DefaultVirtualServiceRoutingPolicy __instance__ =
                    new DefaultVirtualServiceRoutingPolicy(type);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DefaultVirtualServiceRoutingPolicy o) {
            Builder copiedBuilder = type(o.getType());
