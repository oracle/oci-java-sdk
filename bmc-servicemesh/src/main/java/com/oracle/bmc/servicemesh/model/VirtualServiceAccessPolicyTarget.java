...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VirtualServiceAccessPolicyTarget.Builder.class
)
...
public final class VirtualServiceAccessPolicyTarget extends AccessPolicyTarget {
    ...
    public static class Builder {
        ...
        public VirtualServiceAccessPolicyTarget build() {
            VirtualServiceAccessPolicyTarget __instance__ =
                    new VirtualServiceAccessPolicyTarget(virtualServiceId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualServiceAccessPolicyTarget o) {
            Builder copiedBuilder = virtualServiceId(o.getVirtualServiceId());
    ...
    @Deprecated
    public VirtualServiceAccessPolicyTarget(String virtualServiceId) {
        super();
        this.virtualServiceId = virtualServiceId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VirtualServiceAccessPolicyTarget(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VirtualServiceAccessPolicyTarget)) {
            return false;
        }

        VirtualServiceAccessPolicyTarget other = (VirtualServiceAccessPolicyTarget) o;
