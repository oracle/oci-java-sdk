...
public final class VirtualServiceAccessPolicyTarget extends AccessPolicyTarget {
    ...
    public static class Builder {
        ...
        public VirtualServiceAccessPolicyTarget build() {
            VirtualServiceAccessPolicyTarget model =
                    new VirtualServiceAccessPolicyTarget(this.virtualServiceId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualServiceAccessPolicyTarget model) {
