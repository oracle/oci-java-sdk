...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemesh/UpdateMeshExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateMeshRequest.
 */
...
public class UpdateMeshRequest
    ...
    public com.oracle.bmc.servicemesh.model.UpdateMeshDetails getBody$() {
        return updateMeshDetails;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    UpdateMeshRequest, com.oracle.bmc.servicemesh.model.UpdateMeshDetails> {
        ...
        public Builder updateMeshDetails(
                com.oracle.bmc.servicemesh.model.UpdateMeshDetails updateMeshDetails) {
        ...
        public Builder copy(UpdateMeshRequest o) {
            meshId(o.getMeshId());
            updateMeshDetails(o.getUpdateMeshDetails());
         ...
         *
         * @return instance of UpdateMeshRequest
         */
        public UpdateMeshRequest build() {
            UpdateMeshRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.servicemesh.model.UpdateMeshDetails body) {
            updateMeshDetails(body);
            return this;
        }
        ...
        public UpdateMeshRequest buildWithoutInvocationCallback() {
            ...
            request.updateMeshDetails = updateMeshDetails;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateMeshRequest(meshId, updateMeshDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateMeshDetails=").append(String.valueOf(this.updateMeshDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateMeshRequest other = (UpdateMeshRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.meshId, other.meshId)
                && java.util.Objects.equals(this.updateMeshDetails, other.updateMeshDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateMeshDetails == null ? 43 : this.updateMeshDetails.hashCode());
