...
/**
 * The information about the new VirtualServiceRouteTable. <br>
...
public final class CreateVirtualServiceRouteTableDetails
    ...
    public static class Builder {
        ...
        public CreateVirtualServiceRouteTableDetails build() {
            CreateVirtualServiceRouteTableDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateVirtualServiceRouteTableDetails model) {
