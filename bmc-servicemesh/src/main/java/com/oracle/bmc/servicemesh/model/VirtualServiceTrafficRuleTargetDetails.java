...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VirtualServiceTrafficRuleTargetDetails.Builder.class
)
...
public final class VirtualServiceTrafficRuleTargetDetails extends TrafficRuleTargetDetails {
    ...
    public static class Builder {
        ...
        public VirtualServiceTrafficRuleTargetDetails build() {
            VirtualServiceTrafficRuleTargetDetails model =
                    new VirtualServiceTrafficRuleTargetDetails(
    ...
    @Deprecated
    public VirtualServiceTrafficRuleTargetDetails(
            String virtualServiceId, Integer port, Integer weight) {
        super();
        this.virtualServiceId = virtualServiceId;
        this.port = port;
        this.weight = weight;
    ...
    public boolean equals(Object o) {
        ...
        VirtualServiceTrafficRuleTargetDetails other = (VirtualServiceTrafficRuleTargetDetails) o;
