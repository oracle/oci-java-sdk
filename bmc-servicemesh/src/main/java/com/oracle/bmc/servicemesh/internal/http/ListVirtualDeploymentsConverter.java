...
public class ListVirtualDeploymentsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListVirtualDeploymentsConverter.class);

    public static com.oracle.bmc.servicemesh.requests.ListVirtualDeploymentsRequest
            interceptRequest(
                    com.oracle.bmc.servicemesh.requests.ListVirtualDeploymentsRequest request) {
