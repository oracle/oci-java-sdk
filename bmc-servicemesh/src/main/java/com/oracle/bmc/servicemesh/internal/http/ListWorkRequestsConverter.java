...
public class ListWorkRequestsConverter {
    ...
    public static com.oracle.bmc.servicemesh.requests.ListWorkRequestsRequest interceptRequest(
            com.oracle.bmc.servicemesh.requests.ListWorkRequestsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220615").path("workRequests");
        ...
        if (request.getOperationStatus() != null) {
            target =
                    target.queryParam(
                            "operationStatus",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getOperationStatus().getValue()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.servicemesh.responses.ListWorkRequestsResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.servicemesh.responses.ListWorkRequestsResponse>() {
                            @Override
                            public com.oracle.bmc.servicemesh.responses.ListWorkRequestsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.servicemesh.responses.ListWorkRequestsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
