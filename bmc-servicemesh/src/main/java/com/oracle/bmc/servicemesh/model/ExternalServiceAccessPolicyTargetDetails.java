...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExternalServiceAccessPolicyTargetDetails.Builder.class)
...
public final class ExternalServiceAccessPolicyTargetDetails extends AccessPolicyTargetDetails {
    ...
    public static class Builder {
        ...
        public ExternalServiceAccessPolicyTargetDetails build() {
            ExternalServiceAccessPolicyTargetDetails model =
                    new ExternalServiceAccessPolicyTargetDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalServiceAccessPolicyTargetDetails model) {
    ...
    @Deprecated
    public ExternalServiceAccessPolicyTargetDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalServiceAccessPolicyTargetDetails)) {
            return false;
        }

        ExternalServiceAccessPolicyTargetDetails other =
                (ExternalServiceAccessPolicyTargetDetails) o;
