...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VirtualDeploymentTrafficRuleTargetDetails.Builder.class
)
...
public final class VirtualDeploymentTrafficRuleTargetDetails extends TrafficRuleTargetDetails {
    ...
    public static class Builder {
        ...
        public VirtualDeploymentTrafficRuleTargetDetails build() {
            VirtualDeploymentTrafficRuleTargetDetails model =
                    new VirtualDeploymentTrafficRuleTargetDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualDeploymentTrafficRuleTargetDetails model) {
    ...
    @Deprecated
    public VirtualDeploymentTrafficRuleTargetDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VirtualDeploymentTrafficRuleTargetDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VirtualDeploymentTrafficRuleTargetDetails)) {
            return false;
        }

        VirtualDeploymentTrafficRuleTargetDetails other =
                (VirtualDeploymentTrafficRuleTargetDetails) o;
