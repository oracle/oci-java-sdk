...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/certificates/ListCertificateAuthorityBundleVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCertificateAuthorityBundleVersionsRequest.
 */
...
public class ListCertificateAuthorityBundleVersionsRequest
    ...
    public static class Builder
         ...
         * @return instance of ListCertificateAuthorityBundleVersionsRequest
         */
        public ListCertificateAuthorityBundleVersionsRequest buildWithoutInvocationCallback() {
            ListCertificateAuthorityBundleVersionsRequest request =
                    new ListCertificateAuthorityBundleVersionsRequest();
            request.certificateAuthorityId = certificateAuthorityId;
            request.opcRequestId = opcRequestId;
            request.sortBy = sortBy;
            request.sortOrder = sortOrder;
            return request;
            // new ListCertificateAuthorityBundleVersionsRequest(certificateAuthorityId, opcRequestId, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCertificateAuthorityBundleVersionsRequest)) {
            return false;
        }

        ListCertificateAuthorityBundleVersionsRequest other =
                (ListCertificateAuthorityBundleVersionsRequest) o;
