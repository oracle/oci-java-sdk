...
import com.oracle.bmc.certificates.internal.http.*;
...
public class CertificatesClient implements Certificates {
    ...
    public GetCertificateAuthorityBundleResponse getCertificateAuthorityBundle(
        ...
        LOG.trace("Called getCertificateAuthorityBundle");
        final GetCertificateAuthorityBundleRequest interceptedRequest =
    ...
    public GetCertificateBundleResponse getCertificateBundle(GetCertificateBundleRequest request) {
        LOG.trace("Called getCertificateBundle");
        final GetCertificateBundleRequest interceptedRequest =
    ...
    public ListCertificateAuthorityBundleVersionsResponse listCertificateAuthorityBundleVersions(
        ...
        LOG.trace("Called listCertificateAuthorityBundleVersions");
        final ListCertificateAuthorityBundleVersionsRequest interceptedRequest =
                ListCertificateAuthorityBundleVersionsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public ListCertificateBundleVersionsResponse listCertificateBundleVersions(
        ...
        LOG.trace("Called listCertificateBundleVersions");
        final ListCertificateBundleVersionsRequest interceptedRequest =
