...
/**
 * An object that describes a period of time during which an entity is valid. <br>
...
public final class Validity extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
