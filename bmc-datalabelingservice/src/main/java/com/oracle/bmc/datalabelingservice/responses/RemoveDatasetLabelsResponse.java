...
public class RemoveDatasetLabelsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RemoveDatasetLabelsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveDatasetLabelsResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveDatasetLabelsResponse o) {
         ...
         */
        @Override
        public RemoveDatasetLabelsResponse build() {
            return new RemoveDatasetLabelsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatasetLabelsResponse)) {
            return false;
        }

        RemoveDatasetLabelsResponse other = (RemoveDatasetLabelsResponse) o;
