...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datalabelingservice/SnapshotDatasetExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SnapshotDatasetRequest.
 */
...
public class SnapshotDatasetRequest
    ...
    public static class Builder
        ...
        public SnapshotDatasetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SnapshotDatasetRequest(datasetId, snapshotDatasetDetails, opcRetryToken, ifMatch,
            // opcRequestId);
        }
    }
