...
public class AddDatasetLabelsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private AddDatasetLabelsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddDatasetLabelsResponse> {
         ...
         */
        @Override
        public Builder copy(AddDatasetLabelsResponse o) {
         ...
         */
        @Override
        public AddDatasetLabelsResponse build() {
            return new AddDatasetLabelsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatasetLabelsResponse)) {
            return false;
        }

        AddDatasetLabelsResponse other = (AddDatasetLabelsResponse) o;
