...
public interface DataLabelingManagementAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<AddDatasetLabelsResponse> addDatasetLabels(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ChangeDatasetCompartmentResponse> changeDatasetCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateDatasetResponse> createDataset(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteDatasetResponse> deleteDataset(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GenerateDatasetRecordsResponse> generateDatasetRecords(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ImportPreAnnotatedDataResponse> importPreAnnotatedData(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListAnnotationFormatsResponse> listAnnotationFormats(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListDatasetsResponse> listDatasets(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RemoveDatasetLabelsResponse> removeDatasetLabels(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RenameDatasetLabelsResponse> renameDatasetLabels(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<SnapshotDatasetResponse> snapshotDataset(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateDatasetResponse> updateDataset(
