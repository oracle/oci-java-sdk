...
public class RenameDatasetLabelsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RenameDatasetLabelsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RenameDatasetLabelsResponse)) {
            return false;
        }

        RenameDatasetLabelsResponse other = (RenameDatasetLabelsResponse) o;
