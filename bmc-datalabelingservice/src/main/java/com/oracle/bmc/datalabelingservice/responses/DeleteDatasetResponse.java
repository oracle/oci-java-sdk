...
public class DeleteDatasetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteDatasetResponse o) {
        ...
        public DeleteDatasetResponse build() {
            return new DeleteDatasetResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatasetResponse)) {
            return false;
        }

        DeleteDatasetResponse other = (DeleteDatasetResponse) o;
