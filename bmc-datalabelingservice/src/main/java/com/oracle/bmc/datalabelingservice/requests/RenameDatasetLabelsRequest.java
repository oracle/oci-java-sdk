...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datalabelingservice/RenameDatasetLabelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RenameDatasetLabelsRequest.
 */
...
public class RenameDatasetLabelsRequest
    ...
    public static class Builder
        ...
        public RenameDatasetLabelsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RenameDatasetLabelsRequest(datasetId, renameDatasetLabelsDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
