...
public final class RemoveDatasetLabelsDetails {
    ...
    public static class Builder {
        ...
        public RemoveDatasetLabelsDetails build() {
            RemoveDatasetLabelsDetails __instance__ = new RemoveDatasetLabelsDetails(labelSet);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveDatasetLabelsDetails o) {
            Builder copiedBuilder = labelSet(o.getLabelSet());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.labelSet, other.labelSet)
