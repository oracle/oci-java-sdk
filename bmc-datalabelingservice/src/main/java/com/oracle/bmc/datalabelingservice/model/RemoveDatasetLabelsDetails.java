...
/**
 * Removes a subset of Labels from the Dataset's LabelSet. This LabelSet will be subtracted from the
 * current Dataset's LabelSet. Requests\u00A0with non-existent Labels will be rejected. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemoveDatasetLabelsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RemoveDatasetLabelsDetails
    ...
    public static class Builder {
        ...
        public RemoveDatasetLabelsDetails build() {
            RemoveDatasetLabelsDetails model = new RemoveDatasetLabelsDetails(this.labelSet);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveDatasetLabelsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatasetLabelsDetails)) {
            return false;
        }

        RemoveDatasetLabelsDetails other = (RemoveDatasetLabelsDetails) o;
