...
/**
 * Allows user to import dataset labels, records and annotations from dataset files <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ImportPreAnnotatedDataDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ImportPreAnnotatedDataDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"importFormat", "importMetadataPath"})
    public ImportPreAnnotatedDataDetails(
    ...
    public static class Builder {
        ...
        public ImportPreAnnotatedDataDetails build() {
            ImportPreAnnotatedDataDetails model =
                    new ImportPreAnnotatedDataDetails(this.importFormat, this.importMetadataPath);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportPreAnnotatedDataDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportPreAnnotatedDataDetails)) {
            return false;
        }

        ImportPreAnnotatedDataDetails other = (ImportPreAnnotatedDataDetails) o;
