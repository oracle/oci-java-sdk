...
/**
 * Object storage path for the metadata file <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "sourceType",
        defaultImpl = ImportMetadataPath.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStorageImportMetadataPath.class,
            name = "OBJECT_STORAGE")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class ImportMetadataPath extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ImportMetadataPath() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportMetadataPath)) {
            return false;
        }

        ImportMetadataPath other = (ImportMetadataPath) o;
