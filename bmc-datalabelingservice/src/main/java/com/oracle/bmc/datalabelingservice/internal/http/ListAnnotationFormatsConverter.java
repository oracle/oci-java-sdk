...
public class ListAnnotationFormatsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAnnotationFormatsConverter.class);

    public static com.oracle.bmc.datalabelingservice.requests.ListAnnotationFormatsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.datalabelingservice.requests.ListAnnotationFormatsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20211001").path("annotationFormats");
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.datalabelingservice.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datalabelingservice.responses.ListAnnotationFormatsResponse");
