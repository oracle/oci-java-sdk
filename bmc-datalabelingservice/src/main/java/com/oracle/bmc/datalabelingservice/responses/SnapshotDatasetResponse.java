...
public class SnapshotDatasetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SnapshotDatasetResponse o) {
         ...
         */
        public SnapshotDatasetResponse build() {
            return new SnapshotDatasetResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnapshotDatasetResponse)) {
            return false;
        }

        SnapshotDatasetResponse other = (SnapshotDatasetResponse) o;
