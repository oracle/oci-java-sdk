...
public class GenerateDatasetRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GenerateDatasetRecordsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GenerateDatasetRecordsResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDatasetRecordsResponse)) {
            return false;
        }

        GenerateDatasetRecordsResponse other = (GenerateDatasetRecordsResponse) o;
