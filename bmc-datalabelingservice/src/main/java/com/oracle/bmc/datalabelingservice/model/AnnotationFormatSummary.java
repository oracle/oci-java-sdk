...
public class AnnotationFormatSummary {
    ...
    public static class Builder {
        ...
        public AnnotationFormatSummary build() {
            AnnotationFormatSummary __instance__ = new AnnotationFormatSummary(name);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnnotationFormatSummary o) {
