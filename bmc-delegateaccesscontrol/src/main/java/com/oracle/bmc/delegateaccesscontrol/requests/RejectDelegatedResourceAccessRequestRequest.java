...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/delegateaccesscontrol/RejectDelegatedResourceAccessRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RejectDelegatedResourceAccessRequestRequest.
 */
...
public class RejectDelegatedResourceAccessRequestRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of RejectDelegatedResourceAccessRequestRequest as configured by this builder
         *
        ...
        public RejectDelegatedResourceAccessRequestRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RejectDelegatedResourceAccessRequestRequest(delegatedResourceAccessRequestId, rejectDelegatedResourceAccessRequestDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
