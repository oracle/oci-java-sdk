...
/**
 * Details for asking operator to provide more information. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ServiceProviderInteractionRequestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ServiceProviderInteractionRequestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"moreInfoDetails"})
    public ServiceProviderInteractionRequestDetails(String moreInfoDetails) {
        super();
    ...
    public static class Builder {
        ...
        public ServiceProviderInteractionRequestDetails build() {
            ServiceProviderInteractionRequestDetails model =
                    new ServiceProviderInteractionRequestDetails(this.moreInfoDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ServiceProviderInteractionRequestDetails model) {
            if (model.wasPropertyExplicitlySet("moreInfoDetails")) {
                this.moreInfoDetails(model.getMoreInfoDetails());
            }
            return this;
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceProviderInteractionRequestDetails)) {
            return false;
        }

        ServiceProviderInteractionRequestDetails other =
                (ServiceProviderInteractionRequestDetails) o;
