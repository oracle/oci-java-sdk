...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/delegateaccesscontrol/ServiceProviderInteractionRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ServiceProviderInteractionRequestRequest.
 */
...
public class ServiceProviderInteractionRequestRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ServiceProviderInteractionRequestRequest as configured by this builder
         *
        ...
        public ServiceProviderInteractionRequestRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ServiceProviderInteractionRequestRequest(delegatedResourceAccessRequestId, serviceProviderInteractionRequestDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
