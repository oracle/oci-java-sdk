...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/delegateaccesscontrol/ListServiceProviderInteractionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListServiceProviderInteractionsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230801")
public class ListServiceProviderInteractionsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListServiceProviderInteractionsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListServiceProviderInteractionsRequest o) {
        ...
        /**
         * Build the instance of ListServiceProviderInteractionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListServiceProviderInteractionsRequest
         */
        public ListServiceProviderInteractionsRequest build() {
            ListServiceProviderInteractionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListServiceProviderInteractionsRequest
         */
        public ListServiceProviderInteractionsRequest buildWithoutInvocationCallback() {
            ListServiceProviderInteractionsRequest request =
                    new ListServiceProviderInteractionsRequest();
            request.delegatedResourceAccessRequestId = delegatedResourceAccessRequestId;
            request.limit = limit;
            request.page = page;
            request.opcRequestId = opcRequestId;
            return request;
            // new ListServiceProviderInteractionsRequest(delegatedResourceAccessRequestId, limit, page, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListServiceProviderInteractionsRequest)) {
            return false;
        }

        ListServiceProviderInteractionsRequest other = (ListServiceProviderInteractionsRequest) o;
