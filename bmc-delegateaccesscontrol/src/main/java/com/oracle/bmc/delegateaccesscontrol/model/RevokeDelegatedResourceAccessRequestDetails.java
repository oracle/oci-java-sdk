...
/**
 * Summary of why the already approved Delegated Resource Access Request was revoked. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RevokeDelegatedResourceAccessRequestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RevokeDelegatedResourceAccessRequestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"approverComment"})
    public RevokeDelegatedResourceAccessRequestDetails(String approverComment) {
        super();
    ...
    public static class Builder {
        ...
        public RevokeDelegatedResourceAccessRequestDetails build() {
            RevokeDelegatedResourceAccessRequestDetails model =
                    new RevokeDelegatedResourceAccessRequestDetails(this.approverComment);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeDelegatedResourceAccessRequestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeDelegatedResourceAccessRequestDetails)) {
            return false;
        }

        RevokeDelegatedResourceAccessRequestDetails other =
                (RevokeDelegatedResourceAccessRequestDetails) o;
