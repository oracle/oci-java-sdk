...
public class ServiceProviderInteractionRequestConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ServiceProviderInteractionRequestConverter.class);
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getDelegatedResourceAccessRequestId()))
                        .path("actions")
                        .path("serviceProviderInteractionRequest");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.delegateaccesscontrol.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.delegateaccesscontrol.responses.ServiceProviderInteractionRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.delegateaccesscontrol.responses
                                                .ServiceProviderInteractionRequestResponse.Builder
                                        builder =
                                                com.oracle.bmc.delegateaccesscontrol.responses
                                                        .ServiceProviderInteractionRequestResponse
                                                        .builder()
