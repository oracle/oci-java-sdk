...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/delegateaccesscontrol/GetDelegatedResourceAccessRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDelegatedResourceAccessRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230801")
public class GetDelegatedResourceAccessRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDelegatedResourceAccessRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDelegatedResourceAccessRequestRequest o) {
        ...
        /**
         * Build the instance of GetDelegatedResourceAccessRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDelegatedResourceAccessRequestRequest
         */
        public GetDelegatedResourceAccessRequestRequest build() {
            GetDelegatedResourceAccessRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDelegatedResourceAccessRequestRequest
         */
        public GetDelegatedResourceAccessRequestRequest buildWithoutInvocationCallback() {
            GetDelegatedResourceAccessRequestRequest request =
                    new GetDelegatedResourceAccessRequestRequest();
            request.delegatedResourceAccessRequestId = delegatedResourceAccessRequestId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDelegatedResourceAccessRequestRequest(delegatedResourceAccessRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDelegatedResourceAccessRequestRequest)) {
            return false;
        }

        GetDelegatedResourceAccessRequestRequest other =
                (GetDelegatedResourceAccessRequestRequest) o;
