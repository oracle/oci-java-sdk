...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/delegateaccesscontrol/ListServiceProvidersExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListServiceProvidersRequest.
 */
...
public class ListServiceProvidersRequest
    ...
    /**
     * A filter to return only Service Provider resources whose lifecycleState matches the given
     * Service Provider lifecycle state.
     */
    ...
    /**
     * A filter to return only Service Provider resources whose supported resource type matches the
     * given resource type.
     */
    ...
    /**
     * A filter to return only Service Provider resources whose provider type matches the given
     * provider type.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only Service Provider resources whose supported resource type matches
        ...
        public ListServiceProvidersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListServiceProvidersRequest(compartmentId, lifecycleState, name,
            // supportedResourceType, serviceProviderType, limit, page, sortOrder, sortBy,
            // opcRequestId);
        }
    }
