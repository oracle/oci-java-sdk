...
/**
 * Summary of why the Delegated Resource Access Request was rejected. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RejectDelegatedResourceAccessRequestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RejectDelegatedResourceAccessRequestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"approverComment"})
    public RejectDelegatedResourceAccessRequestDetails(String approverComment) {
        super();
    ...
    public static class Builder {
        ...
        public RejectDelegatedResourceAccessRequestDetails build() {
            RejectDelegatedResourceAccessRequestDetails model =
                    new RejectDelegatedResourceAccessRequestDetails(this.approverComment);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RejectDelegatedResourceAccessRequestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RejectDelegatedResourceAccessRequestDetails)) {
            return false;
        }

        RejectDelegatedResourceAccessRequestDetails other =
                (RejectDelegatedResourceAccessRequestDetails) o;
