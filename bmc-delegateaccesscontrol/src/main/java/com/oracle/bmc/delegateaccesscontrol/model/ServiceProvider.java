...
/**
 * Details of the Service Provider. Service provider offers services to the customer to support the
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ServiceProvider.Builder.class)
...
public final class ServiceProvider
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder serviceProviderType(ServiceProviderType serviceProviderType) {
            this.serviceProviderType = serviceProviderType;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ServiceProvider model) {
    ...
    /** Service Provider type. */
    public enum ServiceProviderType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(ServiceProviderType.class);

        private final String value;
        private static java.util.Map<String, ServiceProviderType> map;

        static {
            map = new java.util.HashMap<>();
            for (ServiceProviderType v : ServiceProviderType.values()) {
        ...
        ServiceProviderType(String value) {
            this.value = value;
        }
        ...
        public static ServiceProviderType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'ServiceProviderType', returning UnknownEnumValue",
                    key);
