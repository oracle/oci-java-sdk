...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/limitsincrease/GetLimitsIncreaseItemRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetLimitsIncreaseItemRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251101")
public class GetLimitsIncreaseItemRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetLimitsIncreaseItemRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetLimitsIncreaseItemRequestRequest o) {
        ...
        /**
         * Build the instance of GetLimitsIncreaseItemRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetLimitsIncreaseItemRequestRequest
         */
        public GetLimitsIncreaseItemRequestRequest build() {
            GetLimitsIncreaseItemRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetLimitsIncreaseItemRequestRequest
         */
        public GetLimitsIncreaseItemRequestRequest buildWithoutInvocationCallback() {
            GetLimitsIncreaseItemRequestRequest request = new GetLimitsIncreaseItemRequestRequest();
            request.limitsIncreaseItemRequestId = limitsIncreaseItemRequestId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetLimitsIncreaseItemRequestRequest(limitsIncreaseItemRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLimitsIncreaseItemRequestRequest)) {
            return false;
        }

        GetLimitsIncreaseItemRequestRequest other = (GetLimitsIncreaseItemRequestRequest) o;
