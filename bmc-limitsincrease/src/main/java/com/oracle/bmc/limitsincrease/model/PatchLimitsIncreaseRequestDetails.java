...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = PatchLimitsIncreaseRequestDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class PatchLimitsIncreaseRequestDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public PatchLimitsIncreaseRequestDetails(java.util.List<PatchInstruction> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public PatchLimitsIncreaseRequestDetails build() {
            PatchLimitsIncreaseRequestDetails model =
                    new PatchLimitsIncreaseRequestDetails(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchLimitsIncreaseRequestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchLimitsIncreaseRequestDetails)) {
            return false;
        }

        PatchLimitsIncreaseRequestDetails other = (PatchLimitsIncreaseRequestDetails) o;
