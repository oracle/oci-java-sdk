...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/limitsincrease/ListLimitsIncreaseRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListLimitsIncreaseRequestsRequest.
 */
...
public class ListLimitsIncreaseRequestsRequest
    ...
    public static class Builder
        ...
        public ListLimitsIncreaseRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListLimitsIncreaseRequestsRequest(compartmentId, lifecycleState, displayName, sortOrder, sortBy, limit, page, opcRequestId);
        }
    }
