...
/**
 * Details for updating an IoT flow runtime. This operation supports partial updates. When
 * networkConfig is omitted, the existing network configuration is preserved. When networkConfig is
 * provided, the complete network configuration is replaced. To remove the network configuration,
 * pass networkConfig as null. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateIotFlowRuntimeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateIotFlowRuntimeDetails
    ...
    public UpdateIotFlowRuntimeDetails(
            String displayName,
            String description,
            Scale scale,
    ...
    public static class Builder {
        ...
        public UpdateIotFlowRuntimeDetails build() {
            UpdateIotFlowRuntimeDetails model =
                    new UpdateIotFlowRuntimeDetails(
                            this.displayName,
                            this.description,
                            this.scale,
                            this.networkConfig,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateIotFlowRuntimeDetails model) {
    ...
    public enum Scale implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static Scale create(String key) {
            ...
            throw new IllegalArgumentException("Invalid Scale: " + key);
        }
    };
    /**
     * The scale of the IoT flow runtime. Larger values allocate more CPU and memory for higher
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIotFlowRuntimeDetails)) {
            return false;
        }

        UpdateIotFlowRuntimeDetails other = (UpdateIotFlowRuntimeDetails) o;
