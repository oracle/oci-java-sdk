...
/**
 * Connectivity type of the digital twin instance. Possible values are: DIRECT - The instance
 * connects directly to the cloud. INDIRECT - The instance connects to the cloud through a gateway.
 * GATEWAY - The instance acts as a gateway and relays data from other instances. NONE - The
 * instance is not expected to have any connectivity.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public enum DigitalTwinInstanceConnectivityType implements com.oracle.bmc.http.internal.BmcEnum {
    Direct("DIRECT"),
    Indirect("INDIRECT"),
    Gateway("GATEWAY"),
    None("NONE"),
