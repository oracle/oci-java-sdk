...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/UpdateDigitalTwinAdapterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDigitalTwinAdapterRequest.
 */
...
public class UpdateDigitalTwinAdapterRequest
    ...
    public static class Builder
        ...
        public UpdateDigitalTwinAdapterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDigitalTwinAdapterRequest(digitalTwinAdapterId, updateDigitalTwinAdapterDetails, ifMatch, opcRequestId);
        }
    }
