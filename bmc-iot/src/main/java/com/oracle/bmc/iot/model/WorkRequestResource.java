...
public final class WorkRequestResource
    ...
    public static class Builder {
        ...
        /**
         * Describes how this resource is affected by the operation tracked in the work request. A
         * resource being created, updated, or deleted remains in the IN_PROGRESS state until the
         * work is complete, at which point it transitions to CREATED, UPDATED, or DELETED,
         * respectively.
         */
     ...
     * is complete, at which point it transitions to CREATED, UPDATED, or DELETED, respectively.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("actionType")
