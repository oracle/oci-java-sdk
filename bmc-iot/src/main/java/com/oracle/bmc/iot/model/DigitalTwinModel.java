...
/**
 * A digital twin model, defined using [Digital Twins Definition
 * Language](https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v3/DTDL.v3.md),
 * specifies the schema for digital twin instance, including its components, properties, telemetry,
 * commands, and relationships within the IoT domain.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DigitalTwinModel.Builder.class)
...
public final class DigitalTwinModel
    ...
    public static class Builder {
        ...
        /**
         * This is the DTMI (Digital Twin Model Identifier) of the digital twin model as defined in
         * DTDL specification.
         */
        @com.fasterxml.jackson.annotation.JsonProperty("specUri")
         ...
         * DTDL specification.
         *
         * @param specUri the value to set
         * @return this builder
         */
        public Builder specUri(String specUri) {
            this.specUri = specUri;
            this.__explicitlySet__.add("specUri");
            return this;
        }
        /**
        ...
        public DigitalTwinModel build() {
            DigitalTwinModel model =
                    new DigitalTwinModel(
                            this.id,
                            this.iotDomainId,
                            this.specUri,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DigitalTwinModel model) {
            ...
            if (model.wasPropertyExplicitlySet("specUri")) {
                this.specUri(model.getSpecUri());
            }
    ...
    /**
     * This is the DTMI (Digital Twin Model Identifier) of the digital twin model as defined in DTDL
     * specification.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("specUri")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DigitalTwinModel(");
        sb.append("super=").append(super.toString());
        sb.append("id=").append(String.valueOf(this.id));
        sb.append(", iotDomainId=").append(String.valueOf(this.iotDomainId));
        sb.append(", specUri=").append(String.valueOf(this.specUri));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DigitalTwinModel)) {
            return false;
        }

        DigitalTwinModel other = (DigitalTwinModel) o;
        return java.util.Objects.equals(this.id, other.id)
                && java.util.Objects.equals(this.iotDomainId, other.iotDomainId)
                && java.util.Objects.equals(this.specUri, other.specUri)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.specUri == null ? 43 : this.specUri.hashCode());
