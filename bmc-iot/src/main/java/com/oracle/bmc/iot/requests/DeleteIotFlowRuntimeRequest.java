...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteIotFlowRuntimeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteIotFlowRuntimeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteIotFlowRuntimeRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteIotFlowRuntimeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteIotFlowRuntimeRequest o) {
        ...
        /**
         * Build the instance of DeleteIotFlowRuntimeRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteIotFlowRuntimeRequest
         */
        public DeleteIotFlowRuntimeRequest build() {
            DeleteIotFlowRuntimeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteIotFlowRuntimeRequest
         */
        public DeleteIotFlowRuntimeRequest buildWithoutInvocationCallback() {
            DeleteIotFlowRuntimeRequest request = new DeleteIotFlowRuntimeRequest();
            request.iotFlowRuntimeId = iotFlowRuntimeId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteIotFlowRuntimeRequest(iotFlowRuntimeId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIotFlowRuntimeRequest)) {
            return false;
        }

        DeleteIotFlowRuntimeRequest other = (DeleteIotFlowRuntimeRequest) o;
