...
/**
 * Network access configuration for an IoT flow runtime. <br>
...
public final class NetworkConfigDetails
    ...
    public static class Builder {
        ...
        /**
         * The File Storage mounts to attach to the IoT flow runtime. If specified, this list must
         * contain from 1 to 5 items.
         */
