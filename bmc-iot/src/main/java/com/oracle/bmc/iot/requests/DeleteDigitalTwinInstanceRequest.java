...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteDigitalTwinInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDigitalTwinInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteDigitalTwinInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDigitalTwinInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDigitalTwinInstanceRequest o) {
        ...
        /**
         * Build the instance of DeleteDigitalTwinInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDigitalTwinInstanceRequest
         */
        public DeleteDigitalTwinInstanceRequest build() {
            DeleteDigitalTwinInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDigitalTwinInstanceRequest
         */
        public DeleteDigitalTwinInstanceRequest buildWithoutInvocationCallback() {
            DeleteDigitalTwinInstanceRequest request = new DeleteDigitalTwinInstanceRequest();
            request.digitalTwinInstanceId = digitalTwinInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDigitalTwinInstanceRequest(digitalTwinInstanceId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDigitalTwinInstanceRequest)) {
            return false;
        }

        DeleteDigitalTwinInstanceRequest other = (DeleteDigitalTwinInstanceRequest) o;
