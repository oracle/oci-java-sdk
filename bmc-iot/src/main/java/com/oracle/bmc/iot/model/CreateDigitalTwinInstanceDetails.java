...
/**
 * The information about new digital twin instance to be created. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDigitalTwinInstanceDetails.Builder.class)
...
public final class CreateDigitalTwinInstanceDetails
    ...
    public static class Builder {
        ...
        public CreateDigitalTwinInstanceDetails build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDigitalTwinInstanceDetails)) {
            return false;
        }
