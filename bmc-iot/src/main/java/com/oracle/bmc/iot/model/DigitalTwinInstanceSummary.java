...
/**
 * Summary of the digital twin instance <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DigitalTwinInstanceSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DigitalTwinInstanceSummary
    ...
    public DigitalTwinInstanceSummary(
            String id,
            String iotDomainId,
            String authId,
            String externalKey,
    ...
    public static class Builder {
        ...
        public DigitalTwinInstanceSummary build() {
            DigitalTwinInstanceSummary model =
                    new DigitalTwinInstanceSummary(
                            this.id,
                            this.iotDomainId,
                            this.authId,
                            this.externalKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DigitalTwinInstanceSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DigitalTwinInstanceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DigitalTwinInstanceSummary)) {
            return false;
        }

        DigitalTwinInstanceSummary other = (DigitalTwinInstanceSummary) o;
