...
public class CreateIotFlowRuntimeConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateIotFlowRuntimeConverter.class);

    public static com.oracle.bmc.iot.requests.CreateIotFlowRuntimeRequest interceptRequest(
            com.oracle.bmc.iot.requests.CreateIotFlowRuntimeRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.iot.responses.CreateIotFlowRuntimeResponse>() {
                            @Override
                            public com.oracle.bmc.iot.responses.CreateIotFlowRuntimeResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.iot.responses.CreateIotFlowRuntimeResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.iot.responses.CreateIotFlowRuntimeResponse.Builder
                                        builder =
                                                com.oracle.bmc.iot.responses
                                                        .CreateIotFlowRuntimeResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.iotFlowRuntime(response.getItem());
