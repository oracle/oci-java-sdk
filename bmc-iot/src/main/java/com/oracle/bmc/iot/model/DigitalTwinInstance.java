...
/**
 * A digital twin instance is a virtual representation of a physical IoT device within the IoT
 * domain.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DigitalTwinInstance.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DigitalTwinInstance
    ...
    public static class Builder {
        ...
        public DigitalTwinInstance build() {
            DigitalTwinInstance model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DigitalTwinInstance model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DigitalTwinInstance)) {
            return false;
        }
