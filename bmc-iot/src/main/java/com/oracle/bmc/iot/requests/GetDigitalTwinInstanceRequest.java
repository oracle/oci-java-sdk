...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/GetDigitalTwinInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDigitalTwinInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class GetDigitalTwinInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDigitalTwinInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDigitalTwinInstanceRequest o) {
        ...
        /**
         * Build the instance of GetDigitalTwinInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDigitalTwinInstanceRequest
         */
        public GetDigitalTwinInstanceRequest build() {
            GetDigitalTwinInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDigitalTwinInstanceRequest
         */
        public GetDigitalTwinInstanceRequest buildWithoutInvocationCallback() {
            GetDigitalTwinInstanceRequest request = new GetDigitalTwinInstanceRequest();
            request.digitalTwinInstanceId = digitalTwinInstanceId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDigitalTwinInstanceRequest(digitalTwinInstanceId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDigitalTwinInstanceRequest)) {
            return false;
        }

        GetDigitalTwinInstanceRequest other = (GetDigitalTwinInstanceRequest) o;
