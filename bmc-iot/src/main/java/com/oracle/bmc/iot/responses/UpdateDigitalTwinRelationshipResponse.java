...
public class UpdateDigitalTwinRelationshipResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned DigitalTwinRelationship instance.
     */
    ...
    private UpdateDigitalTwinRelationshipResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateDigitalTwinRelationshipResponse o) {
         ...
         */
        public UpdateDigitalTwinRelationshipResponse build() {
            return new UpdateDigitalTwinRelationshipResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDigitalTwinRelationshipResponse)) {
            return false;
        }

        UpdateDigitalTwinRelationshipResponse other = (UpdateDigitalTwinRelationshipResponse) o;
