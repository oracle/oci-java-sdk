...
/**
 * This contains configuration for apex data access. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApexDataAccessDetails.Builder.class)
...
public final class ApexDataAccessDetails extends ConfigureIotDomainDataAccessDetails {
    ...
    public static class Builder {
        ...
        public ApexDataAccessDetails build() {
            ApexDataAccessDetails model =
                    new ApexDataAccessDetails(this.dbWorkspaceAdminInitialPassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApexDataAccessDetails model) {
            if (model.wasPropertyExplicitlySet("dbWorkspaceAdminInitialPassword")) {
                this.dbWorkspaceAdminInitialPassword(model.getDbWorkspaceAdminInitialPassword());
            }
            return this;
        }
    }
    ...
    @Deprecated
    public ApexDataAccessDetails(
            @com.fasterxml.jackson.annotation.JsonProperty("dbWorkspaceAdminInitialPassword")
                    char[] dbWorkspaceAdminInitialPassword) {
        super();
        this.dbWorkspaceAdminInitialPassword = dbWorkspaceAdminInitialPassword;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ApexDataAccessDetails(");
        sb.append("super=").append(super.toString(includeByteArrayContents));
        sb.append(", dbWorkspaceAdminInitialPassword=").append("<redacted>");
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApexDataAccessDetails)) {
            return false;
        }

        ApexDataAccessDetails other = (ApexDataAccessDetails) o;
        return java.util.Objects.equals(
                        this.dbWorkspaceAdminInitialPassword, other.dbWorkspaceAdminInitialPassword)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dbWorkspaceAdminInitialPassword == null
                                ? 43
                                : this.dbWorkspaceAdminInitialPassword.hashCode());
        return result;
    }
}
