...
public class ConfigureIotDomainDataAccessConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ConfigureIotDomainDataAccessConverter.class);

    public static com.oracle.bmc.iot.requests.ConfigureIotDomainDataAccessRequest interceptRequest(
            com.oracle.bmc.iot.requests.ConfigureIotDomainDataAccessRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getIotDomainId()))
                        .path("actions")
                        .path("configureDataAccess");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.iot.responses.ConfigureIotDomainDataAccessResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.iot.responses.ConfigureIotDomainDataAccessResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
