...
public class GetIotFlowRuntimeFlowsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetIotFlowRuntimeFlowsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetIotFlowRuntimeFlowsResponse o) {
        ...
        public GetIotFlowRuntimeFlowsResponse build() {
            return new GetIotFlowRuntimeFlowsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIotFlowRuntimeFlowsResponse)) {
            return false;
        }

        GetIotFlowRuntimeFlowsResponse other = (GetIotFlowRuntimeFlowsResponse) o;
