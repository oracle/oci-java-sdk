...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/ListDigitalTwinAdaptersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDigitalTwinAdaptersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class ListDigitalTwinAdaptersRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDigitalTwinAdaptersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDigitalTwinAdaptersRequest o) {
        ...
        /**
         * Build the instance of ListDigitalTwinAdaptersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDigitalTwinAdaptersRequest
         */
        public ListDigitalTwinAdaptersRequest build() {
            ListDigitalTwinAdaptersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDigitalTwinAdaptersRequest
         */
        public ListDigitalTwinAdaptersRequest buildWithoutInvocationCallback() {
            ListDigitalTwinAdaptersRequest request = new ListDigitalTwinAdaptersRequest();
            ...
            return request;
            // new ListDigitalTwinAdaptersRequest(iotDomainId, id, digitalTwinModelSpecUri, digitalTwinModelId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDigitalTwinAdaptersRequest)) {
            return false;
        }

        ListDigitalTwinAdaptersRequest other = (ListDigitalTwinAdaptersRequest) o;
