...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = IotDomainSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class IotDomainSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public IotDomainSummary(
            String id,
            String iotDomainGroupId,
            String compartmentId,
            String displayName,
            String description,
            IotDomain.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private IotDomain.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(IotDomain.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public IotDomainSummary build() {
            IotDomainSummary model =
                    new IotDomainSummary(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IotDomainSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final IotDomain.LifecycleState lifecycleState;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IotDomainSummary)) {
            return false;
        }

        IotDomainSummary other = (IotDomainSummary) o;
