...
public class GetDigitalTwinInstanceContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDigitalTwinInstanceContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDigitalTwinInstanceContentResponse o) {
         ...
         */
        @Override
        public GetDigitalTwinInstanceContentResponse build() {
            return new GetDigitalTwinInstanceContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDigitalTwinInstanceContentResponse)) {
            return false;
        }

        GetDigitalTwinInstanceContentResponse other = (GetDigitalTwinInstanceContentResponse) o;
