...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteIotDomainGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteIotDomainGroupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteIotDomainGroupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteIotDomainGroupRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteIotDomainGroupRequest o) {
        ...
        /**
         * Build the instance of DeleteIotDomainGroupRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteIotDomainGroupRequest
         */
        public DeleteIotDomainGroupRequest build() {
            DeleteIotDomainGroupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteIotDomainGroupRequest
         */
        public DeleteIotDomainGroupRequest buildWithoutInvocationCallback() {
            DeleteIotDomainGroupRequest request = new DeleteIotDomainGroupRequest();
            request.iotDomainGroupId = iotDomainGroupId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteIotDomainGroupRequest(iotDomainGroupId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIotDomainGroupRequest)) {
            return false;
        }

        DeleteIotDomainGroupRequest other = (DeleteIotDomainGroupRequest) o;
