...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/GetDigitalTwinModelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDigitalTwinModelRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class GetDigitalTwinModelRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDigitalTwinModelRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDigitalTwinModelRequest o) {
        ...
        /**
         * Build the instance of GetDigitalTwinModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDigitalTwinModelRequest
         */
        public GetDigitalTwinModelRequest build() {
            GetDigitalTwinModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDigitalTwinModelRequest
         */
        public GetDigitalTwinModelRequest buildWithoutInvocationCallback() {
            GetDigitalTwinModelRequest request = new GetDigitalTwinModelRequest();
            request.digitalTwinModelId = digitalTwinModelId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDigitalTwinModelRequest(digitalTwinModelId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDigitalTwinModelRequest)) {
            return false;
        }

        GetDigitalTwinModelRequest other = (GetDigitalTwinModelRequest) o;
