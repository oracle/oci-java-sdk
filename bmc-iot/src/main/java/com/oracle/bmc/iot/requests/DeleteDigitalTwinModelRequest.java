...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteDigitalTwinModelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDigitalTwinModelRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteDigitalTwinModelRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDigitalTwinModelRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDigitalTwinModelRequest o) {
        ...
        /**
         * Build the instance of DeleteDigitalTwinModelRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDigitalTwinModelRequest
         */
        public DeleteDigitalTwinModelRequest build() {
            DeleteDigitalTwinModelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDigitalTwinModelRequest
         */
        public DeleteDigitalTwinModelRequest buildWithoutInvocationCallback() {
            DeleteDigitalTwinModelRequest request = new DeleteDigitalTwinModelRequest();
            request.digitalTwinModelId = digitalTwinModelId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDigitalTwinModelRequest(digitalTwinModelId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDigitalTwinModelRequest)) {
            return false;
        }

        DeleteDigitalTwinModelRequest other = (DeleteDigitalTwinModelRequest) o;
