...
/**
 * Details about a File Storage mount for an IoT flow runtime. <br>
...
public final class FileStorageMountDetails
    ...
    public static class Builder {
        /**
         * The path relative to {@code /mnt} where the File Storage export is mounted. Do not
         * include a leading slash or the {@code /mnt} prefix.
         */
    ...
    /**
     * The path relative to {@code /mnt} where the File Storage export is mounted. Do not include a
     * leading slash or the {@code /mnt} prefix.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("mountPath")
