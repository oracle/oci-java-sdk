...
public class IotWaiters {
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetIotFlowRuntimeRequest, GetIotFlowRuntimeResponse>
            forIotFlowRuntime(
    ...
    public com.oracle.bmc.waiter.Waiter<GetIotFlowRuntimeRequest, GetIotFlowRuntimeResponse>
            forIotFlowRuntime(
                    GetIotFlowRuntimeRequest request,
                    com.oracle.bmc.iot.model.IotFlowRuntime.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for IotFlowRuntime.
    private com.oracle.bmc.waiter.Waiter<GetIotFlowRuntimeRequest, GetIotFlowRuntimeResponse>
            forIotFlowRuntime(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetIotFlowRuntimeRequest request,
                    final com.oracle.bmc.iot.model.IotFlowRuntime.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.iot.model.IotFlowRuntime.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetIotFlowRuntimeResponse apply(
                                    GetIotFlowRuntimeRequest request) {
                                return client.getIotFlowRuntime(request);
                            }
                        },
                        new java.util.function.Predicate<GetIotFlowRuntimeResponse>() {
                            @Override
                            public boolean test(GetIotFlowRuntimeResponse response) {
                                return targetStatesSet.contains(
                                        response.getIotFlowRuntime().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.iot.model.IotFlowRuntime.LifecycleState.Deleted)),
                request);
    }
