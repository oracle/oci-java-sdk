...
/**
 * Log group resource used to validate logConfig.logGroupId for an IoT flow runtime. <br>
...
public final class LogGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
