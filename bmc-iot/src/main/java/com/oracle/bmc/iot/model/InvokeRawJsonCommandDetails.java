...
/**
 * Json data payload definition <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InvokeRawJsonCommandDetails.Builder.class)
...
public final class InvokeRawJsonCommandDetails extends InvokeRawCommandDetails {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder requestData(java.util.Map<String, Object> requestData) {
        ...
        public InvokeRawJsonCommandDetails build() {
            InvokeRawJsonCommandDetails model =
                    new InvokeRawJsonCommandDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvokeRawJsonCommandDetails model) {
    ...
    @Deprecated
    public InvokeRawJsonCommandDetails(
     ...
     * @return the value
     */
    public java.util.Map<String, Object> getRequestData() {
        return requestData;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InvokeRawJsonCommandDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvokeRawJsonCommandDetails)) {
            return false;
        }

        InvokeRawJsonCommandDetails other = (InvokeRawJsonCommandDetails) o;
