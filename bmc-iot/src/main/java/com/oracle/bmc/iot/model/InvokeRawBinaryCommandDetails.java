...
/**
 * Binary data payload definition <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InvokeRawBinaryCommandDetails.Builder.class)
...
public final class InvokeRawBinaryCommandDetails extends InvokeRawCommandDetails {
    ...
    public static class Builder {
        ...
        public InvokeRawBinaryCommandDetails build() {
            InvokeRawBinaryCommandDetails model =
                    new InvokeRawBinaryCommandDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvokeRawBinaryCommandDetails model) {
    ...
    @Deprecated
    public InvokeRawBinaryCommandDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InvokeRawBinaryCommandDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvokeRawBinaryCommandDetails)) {
            return false;
        }

        InvokeRawBinaryCommandDetails other = (InvokeRawBinaryCommandDetails) o;
