...
public class GetDigitalTwinRelationshipResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDigitalTwinRelationshipResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDigitalTwinRelationshipResponse o) {
         ...
         */
        @Override
        public GetDigitalTwinRelationshipResponse build() {
            return new GetDigitalTwinRelationshipResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDigitalTwinRelationshipResponse)) {
            return false;
        }

        GetDigitalTwinRelationshipResponse other = (GetDigitalTwinRelationshipResponse) o;
