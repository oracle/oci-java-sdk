...
public class CreateIotDomainGroupConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateIotDomainGroupConverter.class);

    public static com.oracle.bmc.iot.requests.CreateIotDomainGroupRequest interceptRequest(
            com.oracle.bmc.iot.requests.CreateIotDomainGroupRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20250531").path("iotDomainGroups");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.iot.responses.CreateIotDomainGroupResponse>() {
                            @Override
                            public com.oracle.bmc.iot.responses.CreateIotDomainGroupResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.iot.responses.CreateIotDomainGroupResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.iot.model.IotDomainGroup>>
                                        responseFn;
                                ...
                                com.oracle.bmc.iot.responses.CreateIotDomainGroupResponse.Builder
                                        builder =
                                                com.oracle.bmc.iot.responses
                                                        .CreateIotDomainGroupResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.iotDomainGroup(response.getItem());
