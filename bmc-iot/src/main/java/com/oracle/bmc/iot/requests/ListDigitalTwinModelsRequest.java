...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/ListDigitalTwinModelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDigitalTwinModelsRequest.
 */
...
public class ListDigitalTwinModelsRequest
    ...
    public static class Builder
        ...
        public ListDigitalTwinModelsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDigitalTwinModelsRequest(iotDomainId, id, displayName, specUriStartsWith, limit, page, lifecycleState, sortOrder, sortBy, opcRequestId);
        }
    }
