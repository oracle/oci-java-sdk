...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteDigitalTwinRelationshipExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDigitalTwinRelationshipRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteDigitalTwinRelationshipRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDigitalTwinRelationshipRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDigitalTwinRelationshipRequest o) {
        ...
        /**
         * Build the instance of DeleteDigitalTwinRelationshipRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDigitalTwinRelationshipRequest
         */
        public DeleteDigitalTwinRelationshipRequest build() {
            DeleteDigitalTwinRelationshipRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDigitalTwinRelationshipRequest
         */
        public DeleteDigitalTwinRelationshipRequest buildWithoutInvocationCallback() {
            DeleteDigitalTwinRelationshipRequest request =
                    new DeleteDigitalTwinRelationshipRequest();
            request.digitalTwinRelationshipId = digitalTwinRelationshipId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDigitalTwinRelationshipRequest(digitalTwinRelationshipId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDigitalTwinRelationshipRequest)) {
            return false;
        }

        DeleteDigitalTwinRelationshipRequest other = (DeleteDigitalTwinRelationshipRequest) o;
