...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/ListDigitalTwinRelationshipsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDigitalTwinRelationshipsRequest.
 */
...
public class ListDigitalTwinRelationshipsRequest
    ...
    public static class Builder
        ...
        public ListDigitalTwinRelationshipsRequest buildWithoutInvocationCallback() {
            ...
            request.id = id;
            return request;
            // new ListDigitalTwinRelationshipsRequest(iotDomainId, displayName, contentPath, sourceDigitalTwinInstanceId, targetDigitalTwinInstanceId, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId, id);
        }
    }
