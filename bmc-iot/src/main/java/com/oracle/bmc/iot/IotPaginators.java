...
public class IotPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDigitalTwinAdapters operation. This iterable
    ...
    public Iterable<ListDigitalTwinAdaptersResponse> listDigitalTwinAdaptersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDigitalTwinAdaptersRequest.Builder, ListDigitalTwinAdaptersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinAdapterSummary} objects
     * contained in responses from the listDigitalTwinAdapters operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinAdapterSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDigitalTwinInstances operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListDigitalTwinInstancesResponse> listDigitalTwinInstancesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDigitalTwinInstancesRequest.Builder, ListDigitalTwinInstancesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinInstanceSummary} objects
     * contained in responses from the listDigitalTwinInstances operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinInstanceSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDigitalTwinModels operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListDigitalTwinModelsResponse> listDigitalTwinModelsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDigitalTwinModelsRequest.Builder, ListDigitalTwinModelsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinModelSummary} objects
     * contained in responses from the listDigitalTwinModels operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinModelSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.iot.model.DigitalTwinModelSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListDigitalTwinModelsRequest.Builder, ListDigitalTwinModelsRequest,
                ListDigitalTwinModelsResponse, com.oracle.bmc.iot.model.DigitalTwinModelSummary>(
                new java.util.function.Supplier<ListDigitalTwinModelsRequest.Builder>() {
                    @Override
                    public ListDigitalTwinModelsRequest.Builder get() {
                        return ListDigitalTwinModelsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDigitalTwinRelationships operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListDigitalTwinRelationshipsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDigitalTwinRelationshipsRequest.Builder, ListDigitalTwinRelationshipsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinRelationshipSummary} objects
     * contained in responses from the listDigitalTwinRelationships operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.DigitalTwinRelationshipSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listIotDomainGroups operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListIotDomainGroupsResponse> listIotDomainGroupsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListIotDomainGroupsRequest.Builder, ListIotDomainGroupsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.IotDomainGroupSummary} objects
     * contained in responses from the listIotDomainGroups operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.IotDomainGroupSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.iot.model.IotDomainGroupSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListIotDomainGroupsRequest.Builder, ListIotDomainGroupsRequest,
                ListIotDomainGroupsResponse, com.oracle.bmc.iot.model.IotDomainGroupSummary>(
                new java.util.function.Supplier<ListIotDomainGroupsRequest.Builder>() {
                    @Override
                    public ListIotDomainGroupsRequest.Builder get() {
                        return ListIotDomainGroupsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listIotDomains operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.IotDomainSummary} objects
     * contained in responses from the listIotDomains operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.IotDomainSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listIotFlowRuntimes operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListIotFlowRuntimesResponse> listIotFlowRuntimesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListIotFlowRuntimesRequest.Builder, ListIotFlowRuntimesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.IotFlowRuntimeSummary} objects
     * contained in responses from the listIotFlowRuntimes operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.IotFlowRuntimeSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.iot.model.IotFlowRuntimeSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListIotFlowRuntimesRequest.Builder, ListIotFlowRuntimesRequest,
                ListIotFlowRuntimesResponse, com.oracle.bmc.iot.model.IotFlowRuntimeSummary>(
                new java.util.function.Supplier<ListIotFlowRuntimesRequest.Builder>() {
                    @Override
                    public ListIotFlowRuntimesRequest.Builder get() {
                        return ListIotFlowRuntimesRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.WorkRequestError} objects
     * contained in responses from the listWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.iot.model.WorkRequestError> listWorkRequestErrorsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestErrorsRequest.Builder, ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse, com.oracle.bmc.iot.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.WorkRequestLogEntry} objects
     * contained in responses from the listWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.iot.model.WorkRequestLogEntry> listWorkRequestLogsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestLogsRequest.Builder, ListWorkRequestLogsRequest,
                ListWorkRequestLogsResponse, com.oracle.bmc.iot.model.WorkRequestLogEntry>(
                new java.util.function.Supplier<ListWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListWorkRequestLogsRequest.Builder get() {
                        return ListWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.iot.model.WorkRequestSummary} objects
     * contained in responses from the listWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.iot.model.WorkRequestSummary} objects
     * contained in responses received from the service.
     */
