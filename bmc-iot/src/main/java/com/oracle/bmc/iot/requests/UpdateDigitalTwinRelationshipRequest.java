...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/UpdateDigitalTwinRelationshipExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDigitalTwinRelationshipRequest.
 */
...
public class UpdateDigitalTwinRelationshipRequest
    ...
    public static class Builder
        ...
        public UpdateDigitalTwinRelationshipRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDigitalTwinRelationshipRequest(digitalTwinRelationshipId, updateDigitalTwinRelationshipDetails, ifMatch, opcRequestId);
        }
    }
