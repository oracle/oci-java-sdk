...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/GetDigitalTwinRelationshipExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDigitalTwinRelationshipRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class GetDigitalTwinRelationshipRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDigitalTwinRelationshipRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDigitalTwinRelationshipRequest o) {
        ...
        /**
         * Build the instance of GetDigitalTwinRelationshipRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDigitalTwinRelationshipRequest
         */
        public GetDigitalTwinRelationshipRequest build() {
            GetDigitalTwinRelationshipRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDigitalTwinRelationshipRequest
         */
        public GetDigitalTwinRelationshipRequest buildWithoutInvocationCallback() {
            GetDigitalTwinRelationshipRequest request = new GetDigitalTwinRelationshipRequest();
            request.digitalTwinRelationshipId = digitalTwinRelationshipId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDigitalTwinRelationshipRequest(digitalTwinRelationshipId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDigitalTwinRelationshipRequest)) {
            return false;
        }

        GetDigitalTwinRelationshipRequest other = (GetDigitalTwinRelationshipRequest) o;
