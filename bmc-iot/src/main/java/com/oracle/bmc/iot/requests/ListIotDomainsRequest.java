...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/ListIotDomainsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListIotDomainsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class ListIotDomainsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     *
     */
    private com.oracle.bmc.iot.model.IotDomain.LifecycleState lifecycleState;

    /**
     * Filter resources whose lifecycleState matches the specified value.
     *
     */
    public com.oracle.bmc.iot.model.IotDomain.LifecycleState getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListIotDomainsRequest, java.lang.Void> {
         ...
         *
         */
        private com.oracle.bmc.iot.model.IotDomain.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.iot.model.IotDomain.LifecycleState lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListIotDomainsRequest o) {
        ...
        /**
         * Build the instance of ListIotDomainsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListIotDomainsRequest
         */
        public ListIotDomainsRequest build() {
            ListIotDomainsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListIotDomainsRequest
         */
        public ListIotDomainsRequest buildWithoutInvocationCallback() {
            ListIotDomainsRequest request = new ListIotDomainsRequest();
            ...
            return request;
            // new ListIotDomainsRequest(compartmentId, id, iotDomainGroupId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIotDomainsRequest)) {
            return false;
        }

        ListIotDomainsRequest other = (ListIotDomainsRequest) o;
