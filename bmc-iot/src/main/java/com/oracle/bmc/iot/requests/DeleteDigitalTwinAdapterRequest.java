...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/iot/DeleteDigitalTwinAdapterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDigitalTwinAdapterRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250531")
public class DeleteDigitalTwinAdapterRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDigitalTwinAdapterRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDigitalTwinAdapterRequest o) {
        ...
        /**
         * Build the instance of DeleteDigitalTwinAdapterRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDigitalTwinAdapterRequest
         */
        public DeleteDigitalTwinAdapterRequest build() {
            DeleteDigitalTwinAdapterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDigitalTwinAdapterRequest
         */
        public DeleteDigitalTwinAdapterRequest buildWithoutInvocationCallback() {
            DeleteDigitalTwinAdapterRequest request = new DeleteDigitalTwinAdapterRequest();
            request.digitalTwinAdapterId = digitalTwinAdapterId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDigitalTwinAdapterRequest(digitalTwinAdapterId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDigitalTwinAdapterRequest)) {
            return false;
        }

        DeleteDigitalTwinAdapterRequest other = (DeleteDigitalTwinAdapterRequest) o;
