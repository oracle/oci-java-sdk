...
public class UpdateIotFlowRuntimeFlowsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateIotFlowRuntimeFlowsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateIotFlowRuntimeFlowsResponse o) {
         ...
         */
        @Override
        public UpdateIotFlowRuntimeFlowsResponse build() {
            return new UpdateIotFlowRuntimeFlowsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIotFlowRuntimeFlowsResponse)) {
            return false;
        }

        UpdateIotFlowRuntimeFlowsResponse other = (UpdateIotFlowRuntimeFlowsResponse) o;
