...
/**
 * A digital twin relationship represents an association between two digital twin instances. It can
 * include properties to describe the nature and context of the association within the IoT domain.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DigitalTwinRelationship.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DigitalTwinRelationship
    ...
    public DigitalTwinRelationship(
            String id,
            String iotDomainId,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public DigitalTwinRelationship build() {
            DigitalTwinRelationship model =
                    new DigitalTwinRelationship(
                            this.id,
                            this.iotDomainId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DigitalTwinRelationship model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DigitalTwinRelationship(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DigitalTwinRelationship)) {
            return false;
        }

        DigitalTwinRelationship other = (DigitalTwinRelationship) o;
