...
public class InvokeRawCommandConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(InvokeRawCommandConverter.class);

    public static com.oracle.bmc.iot.requests.InvokeRawCommandRequest interceptRequest(
            com.oracle.bmc.iot.requests.InvokeRawCommandRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.iot.responses.InvokeRawCommandResponse>() {
                            @Override
                            public com.oracle.bmc.iot.responses.InvokeRawCommandResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.iot.responses.InvokeRawCommandResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.iot.responses.InvokeRawCommandResponse.Builder
                                        builder =
                                                com.oracle.bmc.iot.responses
                                                        .InvokeRawCommandResponse.builder()
