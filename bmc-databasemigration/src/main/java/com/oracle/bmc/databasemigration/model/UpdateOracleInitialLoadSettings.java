...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleInitialLoadSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOracleInitialLoadSettings
    ...
    public UpdateOracleInitialLoadSettings(
    ...
    public static class Builder {
        ...
        public UpdateOracleInitialLoadSettings build() {
            UpdateOracleInitialLoadSettings model =
                    new UpdateOracleInitialLoadSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleInitialLoadSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleInitialLoadSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleInitialLoadSettings)) {
            return false;
        }

        UpdateOracleInitialLoadSettings other = (UpdateOracleInitialLoadSettings) o;
