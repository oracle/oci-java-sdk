...
public final class UpdateOracleAdvisorSettings
    ...
    public static class Builder {
        ...
        public UpdateOracleAdvisorSettings build() {
            UpdateOracleAdvisorSettings model =
                    new UpdateOracleAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleAdvisorSettings model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleAdvisorSettings)) {
            return false;
        }

        UpdateOracleAdvisorSettings other = (UpdateOracleAdvisorSettings) o;
