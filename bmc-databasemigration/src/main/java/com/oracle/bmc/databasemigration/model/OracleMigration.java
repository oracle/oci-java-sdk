...
/**
 * Oracle Migration resource. Deprecated: The parent-level Oracle migration configuration properties
 * on this model are deprecated. Use {@code migrationSettings} instead. <br>
