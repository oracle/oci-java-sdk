...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateOracleDbLinkDataTransferMediumDetails.Builder.class
)
...
public final class CreateOracleDbLinkDataTransferMediumDetails
    ...
    public static class Builder {
        ...
        public CreateOracleDbLinkDataTransferMediumDetails build() {
            CreateOracleDbLinkDataTransferMediumDetails model =
                    new CreateOracleDbLinkDataTransferMediumDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleDbLinkDataTransferMediumDetails model) {
    ...
    @Deprecated
    public CreateOracleDbLinkDataTransferMediumDetails(
            CreateObjectStoreBucket objectStorageBucket, String name) {
        super();
        this.objectStorageBucket = objectStorageBucket;
        this.name = name;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleDbLinkDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleDbLinkDataTransferMediumDetails)) {
            return false;
        }

        CreateOracleDbLinkDataTransferMediumDetails other =
                (CreateOracleDbLinkDataTransferMediumDetails) o;
