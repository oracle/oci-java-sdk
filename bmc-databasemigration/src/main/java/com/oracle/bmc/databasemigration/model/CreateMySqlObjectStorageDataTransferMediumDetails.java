...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateMySqlObjectStorageDataTransferMediumDetails.Builder.class
)
...
public final class CreateMySqlObjectStorageDataTransferMediumDetails
        extends CreateMySqlDataTransferMediumDetails {
    ...
    public static class Builder {
        ...
        public CreateMySqlObjectStorageDataTransferMediumDetails build() {
            CreateMySqlObjectStorageDataTransferMediumDetails model =
                    new CreateMySqlObjectStorageDataTransferMediumDetails(this.objectStorageBucket);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlObjectStorageDataTransferMediumDetails model) {
    ...
    @Deprecated
    public CreateMySqlObjectStorageDataTransferMediumDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMySqlObjectStorageDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        CreateMySqlObjectStorageDataTransferMediumDetails other =
                (CreateMySqlObjectStorageDataTransferMediumDetails) o;
