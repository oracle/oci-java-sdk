...
public final class ObjectStoreBucket extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"namespaceName", "bucketName"})
    public ObjectStoreBucket(String namespaceName, String bucketName) {
        super();
    ...
    public static class Builder {
        ...
        public ObjectStoreBucket build() {
            ObjectStoreBucket model = new ObjectStoreBucket(this.namespaceName, this.bucketName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStoreBucket model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStoreBucket)) {
            return false;
        }

        ObjectStoreBucket other = (ObjectStoreBucket) o;
