...
/**
 * Create settings for an online logical Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOracleOnlineLogicalMigrationSettings.Builder.class)
...
public final class CreateOracleOnlineLogicalMigrationSettings
    ...
    public static class Builder {
        ...
        public CreateOracleOnlineLogicalMigrationSettings build() {
            CreateOracleOnlineLogicalMigrationSettings model =
                    new CreateOracleOnlineLogicalMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleOnlineLogicalMigrationSettings model) {
    ...
    @Deprecated
    public CreateOracleOnlineLogicalMigrationSettings(
            CreateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleOnlineLogicalMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleOnlineLogicalMigrationSettings)) {
            return false;
        }

        CreateOracleOnlineLogicalMigrationSettings other =
                (CreateOracleOnlineLogicalMigrationSettings) o;
