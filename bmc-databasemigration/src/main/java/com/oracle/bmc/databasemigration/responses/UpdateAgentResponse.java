...
public class UpdateAgentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemigration.model.Agent getAgent() {
        return agent;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateAgentResponse> {
         ...
         * @return this builder
         */
        public Builder agent(com.oracle.bmc.databasemigration.model.Agent agent) {
            this.agent = agent;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(UpdateAgentResponse o) {
        ...
        public UpdateAgentResponse build() {
            return new UpdateAgentResponse(__httpStatusCode__, headers, opcRequestId, etag, agent);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAgentResponse)) {
            return false;
        }

        UpdateAgentResponse other = (UpdateAgentResponse) o;
