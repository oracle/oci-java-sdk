...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbLinkDataTransferMediumDetails.Builder.class)
...
public final class DbLinkDataTransferMediumDetails extends DataTransferMediumDetailsV2 {
    ...
    public static class Builder {
        ...
        public DbLinkDataTransferMediumDetails build() {
            DbLinkDataTransferMediumDetails model =
                    new DbLinkDataTransferMediumDetails(this.objectStorageBucket, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbLinkDataTransferMediumDetails model) {
    ...
    @Deprecated
    public DbLinkDataTransferMediumDetails(ObjectStoreBucket objectStorageBucket, String name) {
        super();
        this.objectStorageBucket = objectStorageBucket;
        this.name = name;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbLinkDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbLinkDataTransferMediumDetails)) {
            return false;
        }

        DbLinkDataTransferMediumDetails other = (DbLinkDataTransferMediumDetails) o;
