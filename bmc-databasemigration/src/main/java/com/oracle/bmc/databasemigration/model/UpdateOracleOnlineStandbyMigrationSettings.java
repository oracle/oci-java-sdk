...
/**
 * Update settings for an online standby Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleOnlineStandbyMigrationSettings.Builder.class)
...
public final class UpdateOracleOnlineStandbyMigrationSettings
    ...
    public static class Builder {
        ...
        public UpdateOracleOnlineStandbyMigrationSettings build() {
            UpdateOracleOnlineStandbyMigrationSettings model =
                    new UpdateOracleOnlineStandbyMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleOnlineStandbyMigrationSettings model) {
    ...
    @Deprecated
    public UpdateOracleOnlineStandbyMigrationSettings(
            UpdateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleOnlineStandbyMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleOnlineStandbyMigrationSettings)) {
            return false;
        }

        UpdateOracleOnlineStandbyMigrationSettings other =
                (UpdateOracleOnlineStandbyMigrationSettings) o;
