...
/**
 * Create settings for an offline logical Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOracleOfflineLogicalMigrationSettings.Builder.class)
...
public final class CreateOracleOfflineLogicalMigrationSettings
        extends CreateOracleMigrationSettings {
    ...
    public static class Builder {
        ...
        public CreateOracleOfflineLogicalMigrationSettings build() {
            CreateOracleOfflineLogicalMigrationSettings model =
                    new CreateOracleOfflineLogicalMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleOfflineLogicalMigrationSettings model) {
    ...
    @Deprecated
    public CreateOracleOfflineLogicalMigrationSettings(
            CreateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleOfflineLogicalMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleOfflineLogicalMigrationSettings)) {
            return false;
        }

        CreateOracleOfflineLogicalMigrationSettings other =
                (CreateOracleOfflineLogicalMigrationSettings) o;
