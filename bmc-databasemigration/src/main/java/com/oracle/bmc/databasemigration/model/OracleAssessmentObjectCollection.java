...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OracleAssessmentObjectCollection.Builder.class
)
...
public final class OracleAssessmentObjectCollection extends AssessmentObjectCollection {
    ...
    public static class Builder {
        ...
        public OracleAssessmentObjectCollection build() {
            OracleAssessmentObjectCollection model =
                    new OracleAssessmentObjectCollection(this.items, this.bulkIncludeExcludeData);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAssessmentObjectCollection model) {
    ...
    @Deprecated
    public OracleAssessmentObjectCollection(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleAssessmentObjectCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAssessmentObjectCollection)) {
            return false;
        }

        OracleAssessmentObjectCollection other = (OracleAssessmentObjectCollection) o;
