...
/**
 * Optional properties for Curl-based dump transfer in source or target host. <br>
...
public final class CreateCurlTransferDetails extends CreateHostDumpTransferDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCurlTransferDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCurlTransferDetails)) {
            return false;
        }

        CreateCurlTransferDetails other = (CreateCurlTransferDetails) o;
