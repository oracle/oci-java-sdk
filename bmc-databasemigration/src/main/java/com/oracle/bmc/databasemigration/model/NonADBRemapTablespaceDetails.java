...
public final class NonADBRemapTablespaceDetails extends TargetTypeTablespaceDetails {
    ...
    public static class Builder {
        ...
        public NonADBRemapTablespaceDetails build() {
            NonADBRemapTablespaceDetails model = new NonADBRemapTablespaceDetails(this.remapTarget);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NonADBRemapTablespaceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NonADBRemapTablespaceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NonADBRemapTablespaceDetails)) {
            return false;
        }

        NonADBRemapTablespaceDetails other = (NonADBRemapTablespaceDetails) o;
