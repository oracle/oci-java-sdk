...
public class GetParameterFileVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder parameterFileVersion(
                com.oracle.bmc.databasemigration.model.ParameterFileVersion parameterFileVersion) {
            this.parameterFileVersion = parameterFileVersion;
            return this;
        }
        ...
        public Builder copy(GetParameterFileVersionResponse o) {
            ...
            etag(o.getEtag());
            parameterFileVersion(o.getParameterFileVersion());
    ...
    public String toString() {
        ...
        sb.append(",parameterFileVersion=").append(String.valueOf(parameterFileVersion));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetParameterFileVersionResponse)) {
            return false;
        }

        GetParameterFileVersionResponse other = (GetParameterFileVersionResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.parameterFileVersion, other.parameterFileVersion);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.parameterFileVersion == null
                                ? 43
                                : this.parameterFileVersion.hashCode());
        return result;
    }
}
