...
/**
 * Create settings for an online standby Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOracleOnlineStandbyMigrationSettings.Builder.class)
...
public final class CreateOracleOnlineStandbyMigrationSettings
    ...
    public static class Builder {
        ...
        public CreateOracleOnlineStandbyMigrationSettings build() {
            CreateOracleOnlineStandbyMigrationSettings model =
                    new CreateOracleOnlineStandbyMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleOnlineStandbyMigrationSettings model) {
    ...
    @Deprecated
    public CreateOracleOnlineStandbyMigrationSettings(
            CreateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleOnlineStandbyMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleOnlineStandbyMigrationSettings)) {
            return false;
        }

        CreateOracleOnlineStandbyMigrationSettings other =
                (CreateOracleOnlineStandbyMigrationSettings) o;
