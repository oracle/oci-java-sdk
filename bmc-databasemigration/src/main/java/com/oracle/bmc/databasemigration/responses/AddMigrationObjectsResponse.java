...
public class AddMigrationObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private AddMigrationObjectsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddMigrationObjectsResponse> {
        ...
        public AddMigrationObjectsResponse build() {
            return new AddMigrationObjectsResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddMigrationObjectsResponse)) {
            return false;
        }

        AddMigrationObjectsResponse other = (AddMigrationObjectsResponse) o;
