...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMySqlInitialLoadSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMySqlInitialLoadSettings
    ...
    public CreateMySqlInitialLoadSettings(
    ...
    public static class Builder {
        ...
        public CreateMySqlInitialLoadSettings build() {
            CreateMySqlInitialLoadSettings model =
                    new CreateMySqlInitialLoadSettings(
                            this.isConsistent,
                            this.isTzUtc,
                            this.compatibility,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlInitialLoadSettings model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMySqlInitialLoadSettings)) {
            return false;
        }

        CreateMySqlInitialLoadSettings other = (CreateMySqlInitialLoadSettings) o;
