...
public class ResumeJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ResumeJobResponse> {
         ...
         */
        @Override
        public ResumeJobResponse build() {
            return new ResumeJobResponse(__httpStatusCode__, headers, opcRequestId, etag, job);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResumeJobResponse)) {
            return false;
        }

        ResumeJobResponse other = (ResumeJobResponse) o;
