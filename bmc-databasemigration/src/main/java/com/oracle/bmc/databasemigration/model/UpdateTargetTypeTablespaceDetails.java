...
public class UpdateTargetTypeTablespaceDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateTargetTypeTablespaceDetails(");
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetTypeTablespaceDetails)) {
            return false;
        }

        UpdateTargetTypeTablespaceDetails other = (UpdateTargetTypeTablespaceDetails) o;
        return true;
    }
