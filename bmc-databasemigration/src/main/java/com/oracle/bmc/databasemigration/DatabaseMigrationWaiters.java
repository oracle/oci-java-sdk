...
public class DatabaseMigrationWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<
        ...
        return forDataVerificationDetail(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    // Helper method to create a new Waiter for DataVerificationDetail.
    private com.oracle.bmc.waiter.Waiter<
                    GetDataVerificationDetailRequest, GetDataVerificationDetailResponse>
            forDataVerificationDetail(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetDataVerificationDetailRequest request,
                    final com.oracle.bmc.databasemigration.model.DataVerificationDetail
                                    .LifecycleState...
                            targetStates) {
        final java.util.Set<
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetDataVerificationDetailResponse apply(
                                    GetDataVerificationDetailRequest request) {
                                return client.getDataVerificationDetail(request);
                            }
                        },
                        new java.util.function.Predicate<GetDataVerificationDetailResponse>() {
                            @Override
                            public boolean test(GetDataVerificationDetailResponse response) {
                                return targetStatesSet.contains(
                                        response.getDataVerificationDetail().getLifecycleState());
                            }
                        },
                        false),
                request);
