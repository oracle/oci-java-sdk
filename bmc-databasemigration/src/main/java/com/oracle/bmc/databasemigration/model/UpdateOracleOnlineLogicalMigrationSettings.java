...
/**
 * Update settings for an online logical Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleOnlineLogicalMigrationSettings.Builder.class)
...
public final class UpdateOracleOnlineLogicalMigrationSettings
    ...
    public static class Builder {
        ...
        public UpdateOracleOnlineLogicalMigrationSettings build() {
            UpdateOracleOnlineLogicalMigrationSettings model =
                    new UpdateOracleOnlineLogicalMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleOnlineLogicalMigrationSettings model) {
    ...
    @Deprecated
    public UpdateOracleOnlineLogicalMigrationSettings(
            UpdateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleOnlineLogicalMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleOnlineLogicalMigrationSettings)) {
            return false;
        }

        UpdateOracleOnlineLogicalMigrationSettings other =
                (UpdateOracleOnlineLogicalMigrationSettings) o;
