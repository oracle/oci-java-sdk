...
public class GetAssessorCheckConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAssessorCheckConverter.class);

    public static com.oracle.bmc.databasemigration.requests.GetAssessorCheckRequest
            interceptRequest(
                    com.oracle.bmc.databasemigration.requests.GetAssessorCheckRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasemigration.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemigration.responses.GetAssessorCheckResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasemigration.responses.GetAssessorCheckResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.databasemigration.responses
                                                        .GetAssessorCheckResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.assessorCheck(response.getItem());
