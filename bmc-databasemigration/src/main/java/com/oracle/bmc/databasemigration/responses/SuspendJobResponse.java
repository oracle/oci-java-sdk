...
public class SuspendJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SuspendJobResponse> {
         ...
         */
        @Override
        public Builder copy(SuspendJobResponse o) {
        ...
        public SuspendJobResponse build() {
            return new SuspendJobResponse(__httpStatusCode__, headers, opcRequestId, etag, job);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SuspendJobResponse)) {
            return false;
        }

        SuspendJobResponse other = (SuspendJobResponse) o;
