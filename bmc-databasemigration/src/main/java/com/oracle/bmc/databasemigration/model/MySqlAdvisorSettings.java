...
/**
 * Details about Advisor Settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlAdvisorSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MySqlAdvisorSettings
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public MySqlAdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public MySqlAdvisorSettings build() {
            MySqlAdvisorSettings model =
                    new MySqlAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlAdvisorSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlAdvisorSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlAdvisorSettings)) {
            return false;
        }

        MySqlAdvisorSettings other = (MySqlAdvisorSettings) o;
