...
/**
 * Oracle online standby migration settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleOnlineStandbyMigrationSettings.Builder.class)
...
public final class OracleOnlineStandbyMigrationSettings extends OracleMigrationSettings {
    ...
    public static class Builder {
        ...
        public OracleOnlineStandbyMigrationSettings build() {
            OracleOnlineStandbyMigrationSettings model =
                    new OracleOnlineStandbyMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleOnlineStandbyMigrationSettings model) {
    ...
    @Deprecated
    public OracleOnlineStandbyMigrationSettings(
            OracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleOnlineStandbyMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleOnlineStandbyMigrationSettings)) {
            return false;
        }

        OracleOnlineStandbyMigrationSettings other = (OracleOnlineStandbyMigrationSettings) o;
