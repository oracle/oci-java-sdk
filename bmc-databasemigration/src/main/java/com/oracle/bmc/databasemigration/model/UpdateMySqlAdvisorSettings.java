...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMySqlAdvisorSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateMySqlAdvisorSettings
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public UpdateMySqlAdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateMySqlAdvisorSettings build() {
            UpdateMySqlAdvisorSettings model =
                    new UpdateMySqlAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMySqlAdvisorSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMySqlAdvisorSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMySqlAdvisorSettings)) {
            return false;
        }

        UpdateMySqlAdvisorSettings other = (UpdateMySqlAdvisorSettings) o;
