...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/ListAffectedObjectsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAffectedObjectsRequest.
 */
...
public class ListAffectedObjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAffectedObjectsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListAffectedObjectsRequest(assessmentId, assessorName, checkName, opcRequestId, ifMatch, sortBy, sortOrder, limit, page);
        }
    }
