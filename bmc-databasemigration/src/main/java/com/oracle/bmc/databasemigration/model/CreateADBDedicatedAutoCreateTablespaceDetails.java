...
public final class CreateADBDedicatedAutoCreateTablespaceDetails
    ...
    public static class Builder {
        ...
        public CreateADBDedicatedAutoCreateTablespaceDetails build() {
            CreateADBDedicatedAutoCreateTablespaceDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateADBDedicatedAutoCreateTablespaceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateADBDedicatedAutoCreateTablespaceDetails)) {
            return false;
        }

        CreateADBDedicatedAutoCreateTablespaceDetails other =
                (CreateADBDedicatedAutoCreateTablespaceDetails) o;
