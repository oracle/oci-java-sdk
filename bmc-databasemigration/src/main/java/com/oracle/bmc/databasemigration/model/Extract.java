...
/**
 * Parameters for Extract processes. <br>
...
public final class Extract extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"performanceProfile", "longTransDuration"})
    public Extract(ExtractPerformanceProfile performanceProfile, Integer longTransDuration) {
        super();
    ...
    public static class Builder {
        ...
        public Extract build() {
            Extract model = new Extract(this.performanceProfile, this.longTransDuration);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Extract model) {
