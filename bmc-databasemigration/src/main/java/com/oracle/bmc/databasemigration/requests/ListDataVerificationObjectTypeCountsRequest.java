...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/ListDataVerificationObjectTypeCountsExample.java.html"
...
public class ListDataVerificationObjectTypeCountsRequest
    ...
    /**
     * The field to sort by. Only one sort order may be provided. Default order for deltaPercent is
     * descending.
     */
    ...
    public static class Builder
        ...
        /**
         * The field to sort by. Only one sort order may be provided. Default order for deltaPercent
         * is descending.
         */
        ...
        /**
         * Build the instance of ListDataVerificationObjectTypeCountsRequest as configured by this
         * builder
         *
        ...
        public ListDataVerificationObjectTypeCountsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataVerificationObjectTypeCountsRequest(migrationId, compartmentId,
            // opcRequestId, ifMatch, schemaName, objectType, filter, minAbsDeltaPercent, limit,
