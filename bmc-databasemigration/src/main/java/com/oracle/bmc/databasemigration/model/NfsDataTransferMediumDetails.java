...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NfsDataTransferMediumDetails.Builder.class)
...
public final class NfsDataTransferMediumDetails extends DataTransferMediumDetailsV2 {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NfsDataTransferMediumDetails)) {
            return false;
        }
