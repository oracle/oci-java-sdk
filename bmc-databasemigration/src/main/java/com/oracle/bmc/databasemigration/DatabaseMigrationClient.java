...
public class DatabaseMigrationClient implements DatabaseMigration {
    ...
    public AbortJobResponse abortJob(AbortJobRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, AbortJobResponse> transformer =
                AbortJobConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeAgentCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetAgentResponse getAgent(GetAgentRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, GetAgentResponse> transformer =
                GetAgentConverter.fromResponse();
    ...
    public ListAgentImagesResponse listAgentImages(ListAgentImagesRequest request) {
        LOG.trace("Called listAgentImages");
    ...
    public ListAgentsResponse listAgents(ListAgentsRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ListAgentsResponse> transformer =
                ListAgentsConverter.fromResponse();
    ...
    public ResumeJobResponse resumeJob(ResumeJobRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ResumeJobResponse> transformer =
                ResumeJobConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateAgentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
