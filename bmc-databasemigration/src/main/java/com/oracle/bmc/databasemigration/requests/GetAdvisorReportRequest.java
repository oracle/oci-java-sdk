...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/GetAdvisorReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAdvisorReportRequest.
 */
...
public class GetAdvisorReportRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of GetAdvisorReportRequest
         */
        public GetAdvisorReportRequest buildWithoutInvocationCallback() {
            GetAdvisorReportRequest request = new GetAdvisorReportRequest();
            request.jobId = jobId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAdvisorReportRequest(jobId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAdvisorReportRequest)) {
            return false;
        }

        GetAdvisorReportRequest other = (GetAdvisorReportRequest) o;
