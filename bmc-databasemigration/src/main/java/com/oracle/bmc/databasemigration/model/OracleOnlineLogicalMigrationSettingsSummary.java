...
/**
 * Oracle online logical migration summary settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleOnlineLogicalMigrationSettingsSummary.Builder.class)
...
public final class OracleOnlineLogicalMigrationSettingsSummary
    ...
    public static class Builder {
        ...
        public OracleOnlineLogicalMigrationSettingsSummary build() {
            OracleOnlineLogicalMigrationSettingsSummary model =
                    new OracleOnlineLogicalMigrationSettingsSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleOnlineLogicalMigrationSettingsSummary model) {
    ...
    @Deprecated
    public OracleOnlineLogicalMigrationSettingsSummary(String sourceContainerDatabaseConnectionId) {
        super();
        this.sourceContainerDatabaseConnectionId = sourceContainerDatabaseConnectionId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleOnlineLogicalMigrationSettingsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleOnlineLogicalMigrationSettingsSummary)) {
            return false;
        }

        OracleOnlineLogicalMigrationSettingsSummary other =
                (OracleOnlineLogicalMigrationSettingsSummary) o;
