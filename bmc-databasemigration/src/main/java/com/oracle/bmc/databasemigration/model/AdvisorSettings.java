...
public final class AdvisorSettings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public AdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public AdvisorSettings build() {
            AdvisorSettings model = new AdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdvisorSettings model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvisorSettings)) {
            return false;
        }

        AdvisorSettings other = (AdvisorSettings) o;
