...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateGoldenGateHubDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateGoldenGateHubDetails
    ...
    public static class Builder {
        ...
        public UpdateGoldenGateHubDetails build() {
            UpdateGoldenGateHubDetails model =
                    new UpdateGoldenGateHubDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGoldenGateHubDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateGoldenGateHubDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGoldenGateHubDetails)) {
            return false;
        }

        UpdateGoldenGateHubDetails other = (UpdateGoldenGateHubDetails) o;
