...
public class ListMigrationObjectTypesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemigration.model.MigrationObjectTypeSummaryCollection
            getMigrationObjectTypeSummaryCollection() {
        return migrationObjectTypeSummaryCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder migrationObjectTypeSummaryCollection(
                com.oracle.bmc.databasemigration.model.MigrationObjectTypeSummaryCollection
                        migrationObjectTypeSummaryCollection) {
            this.migrationObjectTypeSummaryCollection = migrationObjectTypeSummaryCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",migrationObjectTypeSummaryCollection=")
                .append(String.valueOf(migrationObjectTypeSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMigrationObjectTypesResponse)) {
            return false;
        }

        ListMigrationObjectTypesResponse other = (ListMigrationObjectTypesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.migrationObjectTypeSummaryCollection,
                        other.migrationObjectTypeSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.migrationObjectTypeSummaryCollection == null
                                ? 43
                                : this.migrationObjectTypeSummaryCollection.hashCode());
        return result;
    }
}
