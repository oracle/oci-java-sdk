...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleNfsDataTransferMediumDetails.Builder.class)
...
public final class OracleNfsDataTransferMediumDetails extends OracleDataTransferMediumDetails {
    ...
    public static class Builder {
        ...
        public OracleNfsDataTransferMediumDetails build() {
            OracleNfsDataTransferMediumDetails model =
                    new OracleNfsDataTransferMediumDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleNfsDataTransferMediumDetails model) {
    ...
    @Deprecated
    public OracleNfsDataTransferMediumDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleNfsDataTransferMediumDetails)) {
            return false;
        }

        OracleNfsDataTransferMediumDetails other = (OracleNfsDataTransferMediumDetails) o;
