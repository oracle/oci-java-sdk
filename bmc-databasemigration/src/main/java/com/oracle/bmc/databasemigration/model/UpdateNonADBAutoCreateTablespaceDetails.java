...
public final class UpdateNonADBAutoCreateTablespaceDetails
    ...
    public static class Builder {
        ...
        public UpdateNonADBAutoCreateTablespaceDetails build() {
            UpdateNonADBAutoCreateTablespaceDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateNonADBAutoCreateTablespaceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateNonADBAutoCreateTablespaceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNonADBAutoCreateTablespaceDetails)) {
            return false;
        }

        UpdateNonADBAutoCreateTablespaceDetails other = (UpdateNonADBAutoCreateTablespaceDetails) o;
