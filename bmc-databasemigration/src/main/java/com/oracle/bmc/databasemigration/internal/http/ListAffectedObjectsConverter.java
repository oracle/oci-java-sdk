...
public class ListAffectedObjectsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAffectedObjectsConverter.class);

    public static com.oracle.bmc.databasemigration.requests.ListAffectedObjectsRequest
            interceptRequest(
                    com.oracle.bmc.databasemigration.requests.ListAffectedObjectsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasemigration.responses.ListAffectedObjectsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasemigration.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemigration.responses.ListAffectedObjectsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasemigration.responses
                                                .ListAffectedObjectsResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasemigration.responses
                                                        .ListAffectedObjectsResponse.builder()
                                ...
                                builder.affectedObjectsCollection(response.getItem());
