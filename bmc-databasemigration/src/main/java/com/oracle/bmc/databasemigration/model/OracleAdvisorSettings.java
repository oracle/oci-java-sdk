...
/**
 * Details about Oracle Advisor Settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleAdvisorSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleAdvisorSettings
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public OracleAdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public OracleAdvisorSettings build() {
            OracleAdvisorSettings model =
                    new OracleAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAdvisorSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleAdvisorSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAdvisorSettings)) {
            return false;
        }

        OracleAdvisorSettings other = (OracleAdvisorSettings) o;
