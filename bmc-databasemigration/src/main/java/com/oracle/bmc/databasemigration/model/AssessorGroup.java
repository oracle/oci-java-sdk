...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AssessorGroup.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AssessorGroup extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "displayName", "description", "actions"})
    public AssessorGroup(
            String name,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public AssessorGroup build() {
            AssessorGroup model =
                    new AssessorGroup(this.name, this.displayName, this.description, this.actions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssessorGroup model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssessorGroup)) {
            return false;
        }

        AssessorGroup other = (AssessorGroup) o;
