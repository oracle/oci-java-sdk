...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMySqlInitialLoadSettings.Builder.class)
...
public final class UpdateMySqlInitialLoadSettings
    ...
    public UpdateMySqlInitialLoadSettings(
    ...
    public static class Builder {
        ...
        public UpdateMySqlInitialLoadSettings build() {
            UpdateMySqlInitialLoadSettings model =
                    new UpdateMySqlInitialLoadSettings(
                            this.isConsistent,
                            this.isTzUtc,
                            this.compatibility,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMySqlInitialLoadSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMySqlInitialLoadSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMySqlInitialLoadSettings)) {
            return false;
        }

        UpdateMySqlInitialLoadSettings other = (UpdateMySqlInitialLoadSettings) o;
