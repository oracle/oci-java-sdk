...
public final class CreateMigrationDetails
    ...
    public static class Builder {
        ...
        /**
         * Database objects to exclude/include from migration in CSV format. The excludeObjects and
         * includeObjects fields will be ignored if this field is not null.
         */
