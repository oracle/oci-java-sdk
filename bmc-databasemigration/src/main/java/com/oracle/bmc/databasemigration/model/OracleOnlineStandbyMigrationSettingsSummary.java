...
/**
 * Oracle online standby migration summary settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleOnlineStandbyMigrationSettingsSummary.Builder.class)
...
public final class OracleOnlineStandbyMigrationSettingsSummary
        extends OracleMigrationSettingsSummary {
    ...
    public static class Builder {
        ...
        public OracleOnlineStandbyMigrationSettingsSummary build() {
            OracleOnlineStandbyMigrationSettingsSummary model =
                    new OracleOnlineStandbyMigrationSettingsSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleOnlineStandbyMigrationSettingsSummary model) {
    ...
    @Deprecated
    public OracleOnlineStandbyMigrationSettingsSummary(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleOnlineStandbyMigrationSettingsSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleOnlineStandbyMigrationSettingsSummary)) {
            return false;
        }

        OracleOnlineStandbyMigrationSettingsSummary other =
                (OracleOnlineStandbyMigrationSettingsSummary) o;
