...
/**
 * Table row count comparison result line for Oracle migrations. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDataVerificationTableRowCountSummary.Builder.class)
...
public final class OracleDataVerificationTableRowCountSummary
    ...
    public static class Builder {
        ...
        /**
         * Time of last statistics collection in the source used for the dictionary-based row count
         * estimate. This value is reported per row because statistics can be collected at different
         * times per object. This timestamp is stored in UTC.
         */
        ...
        /**
         * Time of last statistics collection in the target used for the dictionary-based row count
         * estimate. This value is reported per row because statistics can be collected at different
         * times per object. This timestamp is stored in UTC.
         */
        ...
        public OracleDataVerificationTableRowCountSummary build() {
            OracleDataVerificationTableRowCountSummary model =
                    new OracleDataVerificationTableRowCountSummary(
                            this.owner,
                            this.tableName,
                            this.sourceRowCount,
                            this.targetRowCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDataVerificationTableRowCountSummary model) {
    ...
    @Deprecated
    public OracleDataVerificationTableRowCountSummary(
            String owner,
            String tableName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDataVerificationTableRowCountSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDataVerificationTableRowCountSummary)) {
            return false;
        }

        OracleDataVerificationTableRowCountSummary other =
                (OracleDataVerificationTableRowCountSummary) o;
