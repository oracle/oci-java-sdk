...
public final class OracleDatabaseObjectSummary
    ...
    public OracleDatabaseObjectSummary(
    ...
    public static class Builder {
        ...
        public OracleDatabaseObjectSummary build() {
            OracleDatabaseObjectSummary model =
                    new OracleDatabaseObjectSummary(
                            this.objectStatus,
                            this.owner,
                            this.objectName,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDatabaseObjectSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDatabaseObjectSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDatabaseObjectSummary)) {
            return false;
        }

        OracleDatabaseObjectSummary other = (OracleDatabaseObjectSummary) o;
