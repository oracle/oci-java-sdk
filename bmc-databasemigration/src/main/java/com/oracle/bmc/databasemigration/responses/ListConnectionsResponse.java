...
public class ListConnectionsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemigration.model.ConnectionCollection getConnectionCollection() {
    ...
    private ListConnectionsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.databasemigration.model.ConnectionCollection connectionCollection) {
