...
/**
 * Clone settings for an online logical Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloneOracleOnlineLogicalMigrationSettings.Builder.class)
...
public final class CloneOracleOnlineLogicalMigrationSettings extends CloneOracleMigrationSettings {
    ...
    public static class Builder {
        ...
        public CloneOracleOnlineLogicalMigrationSettings build() {
            CloneOracleOnlineLogicalMigrationSettings model =
                    new CloneOracleOnlineLogicalMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloneOracleOnlineLogicalMigrationSettings model) {
    ...
    @Deprecated
    public CloneOracleOnlineLogicalMigrationSettings(String sourceContainerDatabaseConnectionId) {
        super();
        this.sourceContainerDatabaseConnectionId = sourceContainerDatabaseConnectionId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloneOracleOnlineLogicalMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneOracleOnlineLogicalMigrationSettings)) {
            return false;
        }

        CloneOracleOnlineLogicalMigrationSettings other =
                (CloneOracleOnlineLogicalMigrationSettings) o;
