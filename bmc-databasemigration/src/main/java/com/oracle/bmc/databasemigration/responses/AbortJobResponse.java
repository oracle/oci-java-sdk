...
public class AbortJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AbortJobResponse> {
         ...
         */
        @Override
        public Builder copy(AbortJobResponse o) {
         ...
         */
        @Override
        public AbortJobResponse build() {
            return new AbortJobResponse(__httpStatusCode__, headers, opcRequestId, etag, job);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbortJobResponse)) {
            return false;
        }

        AbortJobResponse other = (AbortJobResponse) o;
