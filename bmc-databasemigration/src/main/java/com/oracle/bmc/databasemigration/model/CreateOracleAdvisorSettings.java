...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOracleAdvisorSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateOracleAdvisorSettings
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public CreateOracleAdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public CreateOracleAdvisorSettings build() {
            CreateOracleAdvisorSettings model =
                    new CreateOracleAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleAdvisorSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleAdvisorSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleAdvisorSettings)) {
            return false;
        }

        CreateOracleAdvisorSettings other = (CreateOracleAdvisorSettings) o;
