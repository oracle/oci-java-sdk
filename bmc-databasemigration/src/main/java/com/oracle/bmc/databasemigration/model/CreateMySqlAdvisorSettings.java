...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMySqlAdvisorSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMySqlAdvisorSettings
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isSkipAdvisor", "isIgnoreErrors"})
    public CreateMySqlAdvisorSettings(Boolean isSkipAdvisor, Boolean isIgnoreErrors) {
        super();
    ...
    public static class Builder {
        ...
        public CreateMySqlAdvisorSettings build() {
            CreateMySqlAdvisorSettings model =
                    new CreateMySqlAdvisorSettings(this.isSkipAdvisor, this.isIgnoreErrors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlAdvisorSettings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMySqlAdvisorSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMySqlAdvisorSettings)) {
            return false;
        }

        CreateMySqlAdvisorSettings other = (CreateMySqlAdvisorSettings) o;
