...
/**
 * Database Administrator Credentials details. An empty object would result in the removal of the
 * stored details. <br>
...
public final class UpdateAdminCredentials
    ...
    public static class Builder {
        ...
        public UpdateAdminCredentials build() {
            UpdateAdminCredentials model = new UpdateAdminCredentials(this.username, this.password);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAdminCredentials model) {
