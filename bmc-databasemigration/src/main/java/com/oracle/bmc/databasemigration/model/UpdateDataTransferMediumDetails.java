...
/**
 * Data Transfer Medium details for the Migration. Only one type of data transfer medium can be
 * specified, except for the case of Amazon RDS Oracle as source, where Object Storage Details along
 * with AwsS3Details are required. If an empty object is specified, the stored Data Transfer Medium
 * details will be removed. <br>
