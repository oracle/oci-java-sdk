...
public final class ADBDedicatedAutoCreateTablespaceDetails extends TargetTypeTablespaceDetails {
    ...
    public static class Builder {
        ...
        public ADBDedicatedAutoCreateTablespaceDetails build() {
            ADBDedicatedAutoCreateTablespaceDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ADBDedicatedAutoCreateTablespaceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ADBDedicatedAutoCreateTablespaceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ADBDedicatedAutoCreateTablespaceDetails)) {
            return false;
        }

        ADBDedicatedAutoCreateTablespaceDetails other = (ADBDedicatedAutoCreateTablespaceDetails) o;
