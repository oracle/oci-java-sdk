...
/**
 * OCI Object Storage bucket will be used to store Data Pump dump files for the migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleObjectStorageDataTransferMediumDetails.Builder.class)
...
public final class UpdateOracleObjectStorageDataTransferMediumDetails
    ...
    public static class Builder {
        ...
        public UpdateOracleObjectStorageDataTransferMediumDetails build() {
            UpdateOracleObjectStorageDataTransferMediumDetails model =
                    new UpdateOracleObjectStorageDataTransferMediumDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleObjectStorageDataTransferMediumDetails model) {
    ...
    @Deprecated
    public UpdateOracleObjectStorageDataTransferMediumDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleObjectStorageDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleObjectStorageDataTransferMediumDetails)) {
            return false;
        }

        UpdateOracleObjectStorageDataTransferMediumDetails other =
                (UpdateOracleObjectStorageDataTransferMediumDetails) o;
