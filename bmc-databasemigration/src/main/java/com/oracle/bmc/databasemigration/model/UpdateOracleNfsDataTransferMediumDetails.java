...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateOracleNfsDataTransferMediumDetails.Builder.class
)
...
public final class UpdateOracleNfsDataTransferMediumDetails
    ...
    public static class Builder {
        ...
        public UpdateOracleNfsDataTransferMediumDetails build() {
            UpdateOracleNfsDataTransferMediumDetails model =
                    new UpdateOracleNfsDataTransferMediumDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleNfsDataTransferMediumDetails model) {
    ...
    @Deprecated
    public UpdateOracleNfsDataTransferMediumDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleNfsDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleNfsDataTransferMediumDetails)) {
            return false;
        }

        UpdateOracleNfsDataTransferMediumDetails other =
                (UpdateOracleNfsDataTransferMediumDetails) o;
