...
public class GetJobOutputContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetJobOutputContentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetJobOutputContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetJobOutputContentResponse o) {
         ...
         */
        @Override
        public GetJobOutputContentResponse build() {
            return new GetJobOutputContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetJobOutputContentResponse)) {
            return false;
        }

        GetJobOutputContentResponse other = (GetJobOutputContentResponse) o;
