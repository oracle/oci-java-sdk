...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/ListMigrationParametersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMigrationParametersRequest.
 */
...
public class ListMigrationParametersRequest
     ...
     *
     */
    private com.oracle.bmc.databasemigration.model.MigrationTypes migrationType;

    /**
     * A filter to return only resources that match a certain Migration Type.
     *
     */
    public com.oracle.bmc.databasemigration.model.MigrationTypes getMigrationType() {
     ...
     *
     */
    private com.oracle.bmc.databasemigration.model.DatabaseCombination databaseCombination;

    /**
     * A filter to return only resources that match a certain Database Combination.
     *
     */
    public com.oracle.bmc.databasemigration.model.DatabaseCombination getDatabaseCombination() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMigrationParametersRequest, java.lang.Void> {
         ...
         *
         */
        private com.oracle.bmc.databasemigration.model.MigrationTypes migrationType = null;
         ...
         * @return this builder instance
         */
        public Builder migrationType(
                com.oracle.bmc.databasemigration.model.MigrationTypes migrationType) {
         ...
         * @return this builder instance
         */
        public Builder databaseCombination(
                com.oracle.bmc.databasemigration.model.DatabaseCombination databaseCombination) {
        ...
        public Builder copy(ListMigrationParametersRequest o) {
            ...
            migrationType(o.getMigrationType());
            databaseCombination(o.getDatabaseCombination());
            limit(o.getLimit());
            page(o.getPage());
            sortBy(o.getSortBy());
         ...
         *
         * @return instance of ListMigrationParametersRequest
         */
        public ListMigrationParametersRequest build() {
            ListMigrationParametersRequest request = buildWithoutInvocationCallback();
        ...
        public ListMigrationParametersRequest buildWithoutInvocationCallback() {
            ...
            request.databaseCombination = databaseCombination;
            request.limit = limit;
            request.page = page;
            request.sortBy = sortBy;
            request.sortOrder = sortOrder;
            return request;
            // new ListMigrationParametersRequest(opcRequestId, migrationType, databaseCombination, limit, page, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        ListMigrationParametersRequest other = (ListMigrationParametersRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.migrationType, other.migrationType)
                && java.util.Objects.equals(this.databaseCombination, other.databaseCombination)
