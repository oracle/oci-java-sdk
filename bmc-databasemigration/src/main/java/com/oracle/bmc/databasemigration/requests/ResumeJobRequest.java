...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/ResumeJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResumeJobRequest.
 */
...
public class ResumeJobRequest
    ...
    public static class Builder
        ...
        public Builder resumeJobDetails(
                com.oracle.bmc.databasemigration.model.ResumeJobDetails resumeJobDetails) {
        ...
        public Builder copy(ResumeJobRequest o) {
            ...
            resumeJobDetails(o.getResumeJobDetails());
        ...
        /**
         * Build the instance of ResumeJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResumeJobRequest
         */
        public ResumeJobRequest build() {
            ResumeJobRequest request = buildWithoutInvocationCallback();
        ...
        public ResumeJobRequest buildWithoutInvocationCallback() {
            ...
            request.resumeJobDetails = resumeJobDetails;
            return request;
            // new ResumeJobRequest(jobId, ifMatch, opcRetryToken, opcRequestId, resumeJobDetails);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",resumeJobDetails=").append(String.valueOf(this.resumeJobDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        ResumeJobRequest other = (ResumeJobRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.jobId, other.jobId)
                && java.util.Objects.equals(this.ifMatch, other.ifMatch)
                && java.util.Objects.equals(this.opcRetryToken, other.opcRetryToken)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.resumeJobDetails, other.resumeJobDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.resumeJobDetails == null ? 43 : this.resumeJobDetails.hashCode());
        return result;
    }
}
