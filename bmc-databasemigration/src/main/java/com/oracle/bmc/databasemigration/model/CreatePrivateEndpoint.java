...
/**
 * OCI Private Endpoint configuration details. Not required for source container database
 * connections, it will default to the specified Source Database Connection Private Endpoint. <br>
...
public final class CreatePrivateEndpoint
    ...
    public static class Builder {
        ...
        public CreatePrivateEndpoint build() {
            CreatePrivateEndpoint model =
                    new CreatePrivateEndpoint(this.compartmentId, this.vcnId, this.subnetId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePrivateEndpoint model) {
     ...
     * where the Private Endpoint will be bound to.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("vcnId")
