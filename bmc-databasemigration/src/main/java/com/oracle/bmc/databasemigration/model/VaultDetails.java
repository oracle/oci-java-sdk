...
public final class VaultDetails {
    @Deprecated
    ...
    public static class Builder {
        ...
        public VaultDetails build() {
            VaultDetails __instance__ = new VaultDetails(compartmentId, vaultId, keyId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VaultDetails o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VaultDetails)) {
            return false;
        }

        VaultDetails other = (VaultDetails) o;
