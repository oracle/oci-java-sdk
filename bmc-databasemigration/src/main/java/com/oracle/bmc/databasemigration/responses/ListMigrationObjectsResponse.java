...
public class ListMigrationObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code MigrationObjectCollection} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListMigrationObjectsResponse> {
         ...
         * The returned {@code MigrationObjectCollection} instance.
         *
         * @param migrationObjectCollection the value to set
         * @return this builder
         */
