...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/ListAssessmentObjectTypesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAssessmentObjectTypesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230518")
public class ListAssessmentObjectTypesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAssessmentObjectTypesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAssessmentObjectTypesRequest o) {
        ...
        /**
         * Build the instance of ListAssessmentObjectTypesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAssessmentObjectTypesRequest
         */
        public ListAssessmentObjectTypesRequest build() {
            ListAssessmentObjectTypesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAssessmentObjectTypesRequest
         */
        public ListAssessmentObjectTypesRequest buildWithoutInvocationCallback() {
            ListAssessmentObjectTypesRequest request = new ListAssessmentObjectTypesRequest();
            ...
            request.page = page;
            return request;
            // new ListAssessmentObjectTypesRequest(connectionType, opcRequestId, sortBy, sortOrder, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAssessmentObjectTypesRequest)) {
            return false;
        }

        ListAssessmentObjectTypesRequest other = (ListAssessmentObjectTypesRequest) o;
