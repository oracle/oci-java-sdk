...
/**
 * Common Migration Objects collection. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = MigrationObjectCollection.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = MySqlMigrationObjectCollection.class,
            name = "MYSQL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = OracleMigrationObjectCollection.class,
            name = "ORACLE")
})
...
public class MigrationObjectCollection
    ...
    protected MigrationObjectCollection() {
        super();
    }
