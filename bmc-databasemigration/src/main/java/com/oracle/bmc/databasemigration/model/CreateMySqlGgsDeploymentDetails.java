...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateMySqlGgsDeploymentDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CreateMySqlGgsDeploymentDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"replicat", "acceptableLag"})
    public CreateMySqlGgsDeploymentDetails(CreateReplicat replicat, Integer acceptableLag) {
        super();
    ...
    public static class Builder {
        ...
        public CreateMySqlGgsDeploymentDetails build() {
            CreateMySqlGgsDeploymentDetails model =
                    new CreateMySqlGgsDeploymentDetails(this.replicat, this.acceptableLag);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMySqlGgsDeploymentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMySqlGgsDeploymentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMySqlGgsDeploymentDetails)) {
            return false;
        }

        CreateMySqlGgsDeploymentDetails other = (CreateMySqlGgsDeploymentDetails) o;
