...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MySqlGgsDeploymentDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MySqlGgsDeploymentDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"ggsDeployment", "replicat", "acceptableLag"})
    public MySqlGgsDeploymentDetails(
            GgsDeployment ggsDeployment, Replicat replicat, Integer acceptableLag) {
        super();
    ...
    public static class Builder {
        ...
        public MySqlGgsDeploymentDetails build() {
            MySqlGgsDeploymentDetails model =
                    new MySqlGgsDeploymentDetails(
                            this.ggsDeployment, this.replicat, this.acceptableLag);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlGgsDeploymentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MySqlGgsDeploymentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlGgsDeploymentDetails)) {
            return false;
        }

        MySqlGgsDeploymentDetails other = (MySqlGgsDeploymentDetails) o;
