...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageDataTransferMediumDetails.Builder.class)
...
public final class ObjectStorageDataTransferMediumDetails extends DataTransferMediumDetailsV2 {
    ...
    public static class Builder {
        ...
        public ObjectStorageDataTransferMediumDetails build() {
            ObjectStorageDataTransferMediumDetails model =
                    new ObjectStorageDataTransferMediumDetails(this.objectStorageBucket);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageDataTransferMediumDetails model) {
    ...
    @Deprecated
    public ObjectStorageDataTransferMediumDetails(ObjectStoreBucket objectStorageBucket) {
        super();
        this.objectStorageBucket = objectStorageBucket;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectStorageDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageDataTransferMediumDetails)) {
            return false;
        }

        ObjectStorageDataTransferMediumDetails other = (ObjectStorageDataTransferMediumDetails) o;
