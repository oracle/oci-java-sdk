...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDbLinkDataTransferMediumDetails.Builder.class)
...
public final class OracleDbLinkDataTransferMediumDetails extends OracleDataTransferMediumDetails {
    ...
    public static class Builder {
        ...
        public OracleDbLinkDataTransferMediumDetails build() {
            OracleDbLinkDataTransferMediumDetails model =
                    new OracleDbLinkDataTransferMediumDetails(this.objectStorageBucket, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbLinkDataTransferMediumDetails model) {
    ...
    @Deprecated
    public OracleDbLinkDataTransferMediumDetails(
            ObjectStoreBucket objectStorageBucket, String name) {
        super();
        this.objectStorageBucket = objectStorageBucket;
        this.name = name;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDbLinkDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbLinkDataTransferMediumDetails)) {
            return false;
        }

        OracleDbLinkDataTransferMediumDetails other = (OracleDbLinkDataTransferMediumDetails) o;
