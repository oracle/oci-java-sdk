...
/**
 * Object type count comparison summary line for Oracle migrations. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDataVerificationObjectTypeCountSummary.Builder.class)
...
public final class OracleDataVerificationObjectTypeCountSummary
    ...
    public static class Builder {
        ...
        private OracleDatabaseObjectTypes objectType;
         ...
         * @return this builder
         */
        public Builder objectType(OracleDatabaseObjectTypes objectType) {
        ...
        public OracleDataVerificationObjectTypeCountSummary build() {
            OracleDataVerificationObjectTypeCountSummary model =
                    new OracleDataVerificationObjectTypeCountSummary(
                            this.schemaName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDataVerificationObjectTypeCountSummary model) {
    ...
    @Deprecated
    public OracleDataVerificationObjectTypeCountSummary(
            String schemaName,
            Integer sourceObjectCount,
            Integer targetObjectCount,
            Double deltaPercent,
            OracleDatabaseObjectTypes objectType,
    ...
    /** Oracle database object type. */
    @com.fasterxml.jackson.annotation.JsonProperty("objectType")
    private final OracleDatabaseObjectTypes objectType;
     ...
     * @return the value
     */
    public OracleDatabaseObjectTypes getObjectType() {
        return objectType;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDataVerificationObjectTypeCountSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDataVerificationObjectTypeCountSummary)) {
            return false;
        }

        OracleDataVerificationObjectTypeCountSummary other =
                (OracleDataVerificationObjectTypeCountSummary) o;
