...
public class RemoveMigrationObjectsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RemoveMigrationObjectsResponse(
    ...
    public static class Builder {
        ...
        public RemoveMigrationObjectsResponse build() {
            return new RemoveMigrationObjectsResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveMigrationObjectsResponse)) {
            return false;
        }

        RemoveMigrationObjectsResponse other = (RemoveMigrationObjectsResponse) o;
