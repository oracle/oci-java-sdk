...
/**
 * Update settings for an offline logical Oracle migration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleOfflineLogicalMigrationSettings.Builder.class)
...
public final class UpdateOracleOfflineLogicalMigrationSettings
        extends UpdateOracleMigrationSettings {
    ...
    public static class Builder {
        ...
        public UpdateOracleOfflineLogicalMigrationSettings build() {
            UpdateOracleOfflineLogicalMigrationSettings model =
                    new UpdateOracleOfflineLogicalMigrationSettings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleOfflineLogicalMigrationSettings model) {
    ...
    @Deprecated
    public UpdateOracleOfflineLogicalMigrationSettings(
            UpdateOracleDataTransferMediumDetails dataTransferMediumDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleOfflineLogicalMigrationSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleOfflineLogicalMigrationSettings)) {
            return false;
        }

        UpdateOracleOfflineLogicalMigrationSettings other =
                (UpdateOracleOfflineLogicalMigrationSettings) o;
