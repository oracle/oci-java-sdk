...
/**
 * Details about Oracle GoldenGate GGS Deployment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGoldenGateServiceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateGoldenGateServiceDetails
    ...
    public CreateGoldenGateServiceDetails(
    ...
    public static class Builder {
        ...
        public CreateGoldenGateServiceDetails build() {
            CreateGoldenGateServiceDetails model =
                    new CreateGoldenGateServiceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGoldenGateServiceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGoldenGateServiceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGoldenGateServiceDetails)) {
            return false;
        }

        CreateGoldenGateServiceDetails other = (CreateGoldenGateServiceDetails) o;
