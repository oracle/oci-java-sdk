...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleGgsDeploymentDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOracleGgsDeploymentDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"extract", "replicat", "acceptableLag"})
    public UpdateOracleGgsDeploymentDetails(
            UpdateExtract extract, UpdateReplicat replicat, Integer acceptableLag) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateOracleGgsDeploymentDetails build() {
            UpdateOracleGgsDeploymentDetails model =
                    new UpdateOracleGgsDeploymentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleGgsDeploymentDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOracleGgsDeploymentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleGgsDeploymentDetails)) {
            return false;
        }

        UpdateOracleGgsDeploymentDetails other = (UpdateOracleGgsDeploymentDetails) o;
