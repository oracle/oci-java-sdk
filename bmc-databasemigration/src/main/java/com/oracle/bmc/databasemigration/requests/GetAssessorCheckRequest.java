...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/GetAssessorCheckExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAssessorCheckRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230518")
public class GetAssessorCheckRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAssessorCheckRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetAssessorCheckRequest o) {
        ...
        /**
         * Build the instance of GetAssessorCheckRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAssessorCheckRequest
         */
        public GetAssessorCheckRequest build() {
            GetAssessorCheckRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAssessorCheckRequest
         */
        public GetAssessorCheckRequest buildWithoutInvocationCallback() {
            GetAssessorCheckRequest request = new GetAssessorCheckRequest();
            ...
            return request;
            // new GetAssessorCheckRequest(assessmentId, compartmentId, assessorName, checkName, opcRequestId, displayName, limit, page, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAssessorCheckRequest)) {
            return false;
        }

        GetAssessorCheckRequest other = (GetAssessorCheckRequest) o;
