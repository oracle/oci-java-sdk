...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemigration/UpdateAdvisorReportCheckExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAdvisorReportCheckRequest.
 */
...
public class UpdateAdvisorReportCheckRequest
    ...
    public static class Builder
        ...
        public UpdateAdvisorReportCheckRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAdvisorReportCheckRequest(jobId, advisorReportCheckId, updateAdvisorReportCheck, opcRequestId, ifMatch);
        }
    }
