...
/**
 * OCI Private Endpoint configuration details. An empty object would result in the removal of the
 * stored details. <br>
...
public final class UpdatePrivateEndpoint
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePrivateEndpoint)) {
            return false;
        }

        UpdatePrivateEndpoint other = (UpdatePrivateEndpoint) o;
