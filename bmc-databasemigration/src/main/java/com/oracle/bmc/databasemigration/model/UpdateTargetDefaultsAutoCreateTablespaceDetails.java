...
public final class UpdateTargetDefaultsAutoCreateTablespaceDetails
    ...
    public static class Builder {
        ...
        public UpdateTargetDefaultsAutoCreateTablespaceDetails build() {
            UpdateTargetDefaultsAutoCreateTablespaceDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTargetDefaultsAutoCreateTablespaceDetails model) {
            return this;
        }
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateTargetDefaultsAutoCreateTablespaceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetDefaultsAutoCreateTablespaceDetails)) {
            return false;
        }

        UpdateTargetDefaultsAutoCreateTablespaceDetails other =
                (UpdateTargetDefaultsAutoCreateTablespaceDetails) o;
