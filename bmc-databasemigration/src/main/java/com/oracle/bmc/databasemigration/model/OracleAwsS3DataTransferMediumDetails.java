...
public final class OracleAwsS3DataTransferMediumDetails extends OracleDataTransferMediumDetails {
    ...
    public static class Builder {
        ...
        public OracleAwsS3DataTransferMediumDetails build() {
            OracleAwsS3DataTransferMediumDetails model =
                    new OracleAwsS3DataTransferMediumDetails(
                            this.name,
                            this.region,
                            this.accessKeyId,
    ...
    public boolean equals(Object o) {
        ...
        OracleAwsS3DataTransferMediumDetails other = (OracleAwsS3DataTransferMediumDetails) o;
