...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOracleObjectStorageDataTransferMediumDetails.Builder.class)
...
public final class CreateOracleObjectStorageDataTransferMediumDetails
    ...
    public static class Builder {
        ...
        public CreateOracleObjectStorageDataTransferMediumDetails build() {
            CreateOracleObjectStorageDataTransferMediumDetails model =
                    new CreateOracleObjectStorageDataTransferMediumDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOracleObjectStorageDataTransferMediumDetails model) {
    ...
    @Deprecated
    public CreateOracleObjectStorageDataTransferMediumDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOracleObjectStorageDataTransferMediumDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOracleObjectStorageDataTransferMediumDetails)) {
            return false;
        }

        CreateOracleObjectStorageDataTransferMediumDetails other =
                (CreateOracleObjectStorageDataTransferMediumDetails) o;
