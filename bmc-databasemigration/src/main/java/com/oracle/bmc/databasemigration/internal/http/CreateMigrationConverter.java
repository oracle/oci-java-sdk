...
public class CreateMigrationConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateMigrationConverter.class);

    public static com.oracle.bmc.databasemigration.requests.CreateMigrationRequest interceptRequest(
            com.oracle.bmc.databasemigration.requests.CreateMigrationRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20230518").path("migrations");
