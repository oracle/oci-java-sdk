...
public class RunDataVerificationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RunDataVerificationConverter.class);

    public static com.oracle.bmc.databasemigration.requests.RunDataVerificationRequest
            interceptRequest(
                    com.oracle.bmc.databasemigration.requests.RunDataVerificationRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.databasemigration.responses
                                        .RunDataVerificationResponse>() {
                            @Override
                            public com.oracle.bmc.databasemigration.responses
                                            .RunDataVerificationResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemigration.responses.RunDataVerificationResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasemigration.responses
                                                .RunDataVerificationResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasemigration.responses
                                                        .RunDataVerificationResponse.builder()
                                ...
                                builder.dataVerificationDetail(response.getItem());
