...
public class ListRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datalabelingservicedataplane.model.RecordCollection
            getRecordCollection() {
    ...
    private ListRecordsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.datalabelingservicedataplane.model.RecordCollection recordCollection) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListRecordsResponse> {
         ...
         */
        @Override
        public Builder copy(ListRecordsResponse o) {
        ...
        public ListRecordsResponse build() {
            return new ListRecordsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, recordCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecordsResponse)) {
            return false;
        }

        ListRecordsResponse other = (ListRecordsResponse) o;
