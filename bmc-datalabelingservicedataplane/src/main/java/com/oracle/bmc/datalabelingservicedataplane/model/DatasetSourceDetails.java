...
/**
 * This allows the customer to specify the source of the dataset. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStorageDatasetSourceDetails.class,
            name = "OBJECT_STORAGE")
})
...
public class DatasetSourceDetails
    ...
    /**
     * The source type. OBJECT_STORAGE allows the user to describe where in object storage the
     * dataset is.
     */
