...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datalabelingservicedataplane/UpdateAnnotationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAnnotationRequest.
 */
...
public class UpdateAnnotationRequest
    ...
    public static class Builder
        ...
        public UpdateAnnotationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAnnotationRequest(annotationId, updateAnnotationDetails, ifMatch, opcRequestId);
        }
    }
