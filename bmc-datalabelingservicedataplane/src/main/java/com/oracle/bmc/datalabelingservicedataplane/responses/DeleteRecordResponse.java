...
public class DeleteRecordResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteRecordResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteRecordResponse o) {
        ...
        public DeleteRecordResponse build() {
            return new DeleteRecordResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRecordResponse)) {
            return false;
        }

        DeleteRecordResponse other = (DeleteRecordResponse) o;
