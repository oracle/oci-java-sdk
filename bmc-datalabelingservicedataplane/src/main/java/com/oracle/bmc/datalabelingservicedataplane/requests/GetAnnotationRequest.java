...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datalabelingservicedataplane/GetAnnotationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAnnotationRequest.
 */
...
public class GetAnnotationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAnnotationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetAnnotationRequest o) {
         ...
         *
         * @return instance of GetAnnotationRequest
         */
        public GetAnnotationRequest build() {
            GetAnnotationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAnnotationRequest
         */
        public GetAnnotationRequest buildWithoutInvocationCallback() {
            GetAnnotationRequest request = new GetAnnotationRequest();
            request.annotationId = annotationId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetAnnotationRequest(annotationId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().annotationId(annotationId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAnnotationRequest)) {
            return false;
        }

        GetAnnotationRequest other = (GetAnnotationRequest) o;
