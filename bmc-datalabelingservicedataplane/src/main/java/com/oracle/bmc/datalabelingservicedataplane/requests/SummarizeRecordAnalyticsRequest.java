...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datalabelingservicedataplane/SummarizeRecordAnalyticsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeRecordAnalyticsRequest.
 */
...
public class SummarizeRecordAnalyticsRequest
    ...
    public static class Builder
        ...
        public SummarizeRecordAnalyticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeRecordAnalyticsRequest(compartmentId, datasetId, lifecycleState, limit, page, sortOrder, recordGroupBy, sortBy, opcRequestId);
        }
    }
