 ...
 * to any list operations of DataLabeling where multiple pages of data may be fetched. Two styles of
...
public class DataLabelingPaginators {
     ...
     * listAnnotations operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.datalabelingservicedataplane.model.AnnotationSummary} objects contained in
     * responses from the listAnnotations operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.datalabelingservicedataplane.model.RecordSummary} objects contained in
     * responses from the listRecords operation. This iterable will fetch more data from the server
     * as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
