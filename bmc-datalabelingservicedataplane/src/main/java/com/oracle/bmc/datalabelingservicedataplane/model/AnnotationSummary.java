...
/**
 * An annotation summary is the representation returned in list views. It is usually a subset of the
 * full annotation entity and should not contain any potentially sensitive information. <br>
