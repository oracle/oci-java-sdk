...
/**
 * The source information is a polymorphic entity. It captures the details of data used for record
 * creation. The discriminator type must match the dataset's source type. The convention is enforced
 * by the API. <br>
