...
public final class AnnotationAnalyticsAggregationCollection
    ...
    public static class Builder {
        ...
        public AnnotationAnalyticsAggregationCollection build() {
            AnnotationAnalyticsAggregationCollection model =
                    new AnnotationAnalyticsAggregationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnnotationAnalyticsAggregationCollection model) {
