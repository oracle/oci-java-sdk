...
public class CreateAnnotationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAnnotationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAnnotationResponse)) {
            return false;
        }

        CreateAnnotationResponse other = (CreateAnnotationResponse) o;
