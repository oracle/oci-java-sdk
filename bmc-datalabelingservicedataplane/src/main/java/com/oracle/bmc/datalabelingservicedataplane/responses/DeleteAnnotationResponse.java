...
public class DeleteAnnotationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteAnnotationResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteAnnotationResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteAnnotationResponse o) {
        ...
        public DeleteAnnotationResponse build() {
            return new DeleteAnnotationResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAnnotationResponse)) {
            return false;
        }

        DeleteAnnotationResponse other = (DeleteAnnotationResponse) o;
