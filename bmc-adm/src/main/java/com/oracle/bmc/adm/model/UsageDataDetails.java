...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "sourceType",
        defaultImpl = UsageDataDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UsageDataViaObjectStorageTupleDetails.class,
            name = "objectStorageTuple")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class UsageDataDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected UsageDataDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsageDataDetails)) {
            return false;
        }

        UsageDataDetails other = (UsageDataDetails) o;
