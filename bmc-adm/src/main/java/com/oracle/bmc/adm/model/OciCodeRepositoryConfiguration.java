 ...
 * use the OCI DevOps Code Repository. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OciCodeRepositoryConfiguration.Builder.class)
...
public final class OciCodeRepositoryConfiguration extends ScmConfiguration {
    ...
    public static class Builder {
        ...
        public OciCodeRepositoryConfiguration build() {
            OciCodeRepositoryConfiguration model =
                    new OciCodeRepositoryConfiguration(
                            this.branch,
                            this.buildFileLocation,
                            this.isAutomergeEnabled,
                            this.ociCodeRepositoryId);
    ...
    @Deprecated
    public OciCodeRepositoryConfiguration(
            String branch,
    ...
    public boolean equals(Object o) {
        ...
        OciCodeRepositoryConfiguration other = (OciCodeRepositoryConfiguration) o;
        return java.util.Objects.equals(this.ociCodeRepositoryId, other.ociCodeRepositoryId)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ociCodeRepositoryId == null
                                ? 43
                                : this.ociCodeRepositoryId.hashCode());
        return result;
    }
}
