...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/adm/ListKnowledgeBasesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListKnowledgeBasesRequest.
 */
...
public class ListKnowledgeBasesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListKnowledgeBasesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListKnowledgeBasesRequest(id, sortBy, lifecycleState, sortOrder, displayName, limit, page, compartmentId, opcRequestId);
        }
    }
