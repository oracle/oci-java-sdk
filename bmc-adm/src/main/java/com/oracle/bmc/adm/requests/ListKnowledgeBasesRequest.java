...
public class ListKnowledgeBasesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The field used to sort Knowledge Bases. Only one sort order is allowed. Default order for
     * _displayName_ is **ascending alphabetical order**. Default order for _lifecyleState_ is the
     * following sequence: **CREATING, ACTIVE, UPDATING, FAILED, DELETING, and DELETED**.Default
     * order for _timeCreated_ is **descending**. Default order for _timeUpdated_ is **descending**.
     */
    ...
    public static class Builder
        ...
        /**
         * The field used to sort Knowledge Bases. Only one sort order is allowed. Default order for
         * _displayName_ is **ascending alphabetical order**. Default order for _lifecyleState_ is
         * the following sequence: **CREATING, ACTIVE, UPDATING, FAILED, DELETING, and
         * DELETED**.Default order for _timeCreated_ is **descending**. Default order for
         * _timeUpdated_ is **descending**.
         */
        ...
        public Builder lifecycleState(
                com.oracle.bmc.adm.model.KnowledgeBase.LifecycleState lifecycleState) {
        ...
        public ListKnowledgeBasesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListKnowledgeBasesRequest(id, sortBy, lifecycleState, sortOrder, displayName,
