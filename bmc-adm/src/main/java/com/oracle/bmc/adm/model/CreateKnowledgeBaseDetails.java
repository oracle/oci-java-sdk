...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateKnowledgeBaseDetails.Builder.class
)
...
public final class CreateKnowledgeBaseDetails {
    ...
    public CreateKnowledgeBaseDetails(
    ...
    public static class Builder {
        ...
        public CreateKnowledgeBaseDetails build() {
            CreateKnowledgeBaseDetails __instance__ =
                    new CreateKnowledgeBaseDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateKnowledgeBaseDetails o) {
