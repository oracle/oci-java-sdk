...
public final class UpdateKnowledgeBaseDetails {
    ...
    public static class Builder {
        ...
        public UpdateKnowledgeBaseDetails build() {
            UpdateKnowledgeBaseDetails __instance__ =
                    new UpdateKnowledgeBaseDetails(displayName, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateKnowledgeBaseDetails o) {
