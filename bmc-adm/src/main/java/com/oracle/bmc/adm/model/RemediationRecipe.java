 ...
 * and the details of each of the remediation stages (Detect, Recommend, Verify, and Apply). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemediationRecipe.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RemediationRecipe
    ...
    public static class Builder {
        ...
        public RemediationRecipe build() {
            RemediationRecipe model =
                    new RemediationRecipe(
                            this.id,
                            this.displayName,
                            this.timeCreated,
                            this.timeUpdated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemediationRecipe model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemediationRecipe)) {
            return false;
        }

        RemediationRecipe other = (RemediationRecipe) o;
