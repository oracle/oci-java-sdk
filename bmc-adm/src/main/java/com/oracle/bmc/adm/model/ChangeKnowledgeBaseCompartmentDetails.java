...
public final class ChangeKnowledgeBaseCompartmentDetails {
    ...
    public static class Builder {
        ...
        public ChangeKnowledgeBaseCompartmentDetails build() {
            ChangeKnowledgeBaseCompartmentDetails __instance__ =
                    new ChangeKnowledgeBaseCompartmentDetails(compartmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeKnowledgeBaseCompartmentDetails o) {
