...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/adm/CreateKnowledgeBaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateKnowledgeBaseRequest.
 */
...
public class CreateKnowledgeBaseRequest
    ...
    public static class Builder
        ...
        public Builder createKnowledgeBaseDetails(
                com.oracle.bmc.adm.model.CreateKnowledgeBaseDetails createKnowledgeBaseDetails) {
            this.createKnowledgeBaseDetails = createKnowledgeBaseDetails;
            return this;
        }
         ...
         * @return instance of CreateKnowledgeBaseRequest
         */
        public CreateKnowledgeBaseRequest buildWithoutInvocationCallback() {
            CreateKnowledgeBaseRequest request = new CreateKnowledgeBaseRequest();
            request.createKnowledgeBaseDetails = createKnowledgeBaseDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateKnowledgeBaseRequest(createKnowledgeBaseDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createKnowledgeBaseDetails=")
                .append(String.valueOf(this.createKnowledgeBaseDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKnowledgeBaseRequest)) {
            return false;
        }

        CreateKnowledgeBaseRequest other = (CreateKnowledgeBaseRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createKnowledgeBaseDetails, other.createKnowledgeBaseDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createKnowledgeBaseDetails == null
                                ? 43
                                : this.createKnowledgeBaseDetails.hashCode());
