...
/**
 * A verify stage will run a build pipeline in a branch. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VerifyStage.Builder.class)
...
public final class VerifyStage extends RemediationRunStage {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerifyStage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerifyStage)) {
            return false;
        }

        VerifyStage other = (VerifyStage) o;
