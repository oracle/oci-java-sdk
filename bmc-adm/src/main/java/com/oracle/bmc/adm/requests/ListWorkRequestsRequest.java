...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /** A filter to return only resources that match the specified OperationStatus. */
    public com.oracle.bmc.adm.model.OperationStatus getStatus() {
        return status;
    }
    /**
    ...
    /**
     * The field used to sort WorkRequests. Only one sort order is allowed. Default order for
     * _timeAccepted_ is **descending**.
     */
    ...
    public static class Builder
        ...
        /** A filter to return only resources that match the specified OperationStatus. */
        private com.oracle.bmc.adm.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.adm.model.OperationStatus status) {
            this.status = status;
            return this;
        }
