...
public class UpdateRemediationRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateRemediationRunResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRemediationRunResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateRemediationRunResponse o) {
         ...
         */
        @Override
        public UpdateRemediationRunResponse build() {
            return new UpdateRemediationRunResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRemediationRunResponse)) {
            return false;
        }

        UpdateRemediationRunResponse other = (UpdateRemediationRunResponse) o;
