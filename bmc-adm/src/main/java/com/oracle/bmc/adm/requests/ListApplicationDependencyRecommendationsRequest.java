...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/adm/ListApplicationDependencyRecommendationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApplicationDependencyRecommendationsRequest.
 */
...
public class ListApplicationDependencyRecommendationsRequest
    ...
    public static class Builder
        ...
        public ListApplicationDependencyRecommendationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListApplicationDependencyRecommendationsRequest(remediationRunId, opcRequestId, limit, page, sortOrder, gav, purl, sortBy);
        }
    }
