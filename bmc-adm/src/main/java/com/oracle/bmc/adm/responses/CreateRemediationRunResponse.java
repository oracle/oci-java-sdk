...
public class CreateRemediationRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateRemediationRunResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateRemediationRunResponse> {
         ...
         */
        @Override
        public Builder copy(CreateRemediationRunResponse o) {
         ...
         */
        @Override
        public CreateRemediationRunResponse build() {
            return new CreateRemediationRunResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, remediationRun);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRemediationRunResponse)) {
            return false;
        }

        CreateRemediationRunResponse other = (CreateRemediationRunResponse) o;
