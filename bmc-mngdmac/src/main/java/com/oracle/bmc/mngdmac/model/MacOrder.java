...
public final class MacOrder extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacOrder model) {
            ...
            if (model.wasPropertyExplicitlySet("timeCanceled")) {
                this.timeCanceled(model.getTimeCanceled());
            }
            return this;
        }
    }
    ...
    public enum CommitmentTerm implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(CommitmentTerm.class);

        private final String value;
        private static java.util.Map<String, CommitmentTerm> map;

        static {
            map = new java.util.HashMap<>();
            for (CommitmentTerm v : CommitmentTerm.values()) {
                if (v != UnknownEnumValue) {
                    map.put(v.getValue(), v);
                }
            }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static CommitmentTerm create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'CommitmentTerm', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
    ...
    public enum OrderStatus implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(OrderStatus.class);

        private final String value;
        private static java.util.Map<String, OrderStatus> map;
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static OrderStatus create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'OrderStatus', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", timeCanceled=").append(String.valueOf(this.timeCanceled));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacOrder)) {
            return false;
        }

        MacOrder other = (MacOrder) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.cancelReason, other.cancelReason)
                && java.util.Objects.equals(this.timeCanceled, other.timeCanceled)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.timeCanceled == null ? 43 : this.timeCanceled.hashCode());
