...
public class MacDeviceClient extends com.oracle.bmc.http.internal.BaseSyncClient
        implements MacDevice {
        ...
        public MacDeviceClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new MacDeviceClient(this, authenticationDetailsProvider, executorService);
        }
    }
