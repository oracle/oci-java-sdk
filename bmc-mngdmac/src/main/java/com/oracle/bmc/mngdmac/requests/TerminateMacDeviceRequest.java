...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mngdmac/TerminateMacDeviceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use TerminateMacDeviceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250320")
public class TerminateMacDeviceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    TerminateMacDeviceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(TerminateMacDeviceRequest o) {
        ...
        /**
         * Build the instance of TerminateMacDeviceRequest as configured by this builder
         *
         ...
         *
         * @return instance of TerminateMacDeviceRequest
         */
        public TerminateMacDeviceRequest build() {
            TerminateMacDeviceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of TerminateMacDeviceRequest
         */
        public TerminateMacDeviceRequest buildWithoutInvocationCallback() {
            TerminateMacDeviceRequest request = new TerminateMacDeviceRequest();
            ...
            return request;
            // new TerminateMacDeviceRequest(macDeviceId, macOrderId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TerminateMacDeviceRequest)) {
            return false;
        }

        TerminateMacDeviceRequest other = (TerminateMacDeviceRequest) o;
