...
public interface MacDeviceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetMacDeviceResponse> getMacDevice(
            GetMacDeviceRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetMacDeviceRequest, GetMacDeviceResponse>
                    handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListMacDevicesResponse> listMacDevices(
            ListMacDevicesRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListMacDevicesRequest, ListMacDevicesResponse>
                    handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<TerminateMacDeviceResponse> terminateMacDevice(
