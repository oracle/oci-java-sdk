...
import com.oracle.bmc.mngdmac.internal.http.*;
...
public class MacOrderAsyncClient implements MacOrderAsync {
    /**
    ...
    public static class Builder
        ...
        public MacOrderAsyncClient build(
            ...
            return new MacOrderAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<CancelMacOrderResponse> cancelMacOrder(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async cancelMacOrder");
        final CancelMacOrderRequest interceptedRequest =
                CancelMacOrderConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CancelMacOrderConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CancelMacOrderResponse>
                transformer =
                        CancelMacOrderConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CancelMacOrderRequest, CancelMacOrderResponse>,
                        java.util.concurrent.Future<CancelMacOrderResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCancelMacOrderDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<ChangeMacOrderCompartmentResponse> changeMacOrderCompartment(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async changeMacOrderCompartment");
        final ChangeMacOrderCompartmentRequest interceptedRequest =
                ChangeMacOrderCompartmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeMacOrderCompartmentConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "MacOrder",
        ...
        final java.util.function.Function<
                        javax.ws.rs.core.Response, ChangeMacOrderCompartmentResponse>
                transformer =
                        ChangeMacOrderCompartmentConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<
                        ChangeMacOrderCompartmentRequest, ChangeMacOrderCompartmentResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<ChangeMacOrderCompartmentResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getChangeMacOrderCompartmentDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<CreateMacOrderResponse> createMacOrder(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async createMacOrder");
        final CreateMacOrderRequest interceptedRequest =
                CreateMacOrderConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateMacOrderConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "MacOrder",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CreateMacOrderResponse>
                transformer =
                        CreateMacOrderConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateMacOrderRequest, CreateMacOrderResponse>,
                        java.util.concurrent.Future<CreateMacOrderResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateMacOrderDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<GetMacOrderResponse> getMacOrder(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetMacOrderRequest, GetMacOrderResponse>
                    handler) {
        LOG.trace("Called async getMacOrder");
        final GetMacOrderRequest interceptedRequest =
                GetMacOrderConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetMacOrderConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "MacOrder",
                        "GetMacOrder",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetMacOrderResponse>
                transformer =
                        GetMacOrderConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<GetMacOrderRequest, GetMacOrderResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetMacOrderRequest, GetMacOrderResponse>,
                        java.util.concurrent.Future<GetMacOrderResponse>>
    ...
    public java.util.concurrent.Future<ListMacOrdersResponse> listMacOrders(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ListMacOrdersRequest, ListMacOrdersResponse>
                    handler) {
        LOG.trace("Called async listMacOrders");
        final ListMacOrdersRequest interceptedRequest =
                ListMacOrdersConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListMacOrdersConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "MacOrder",
                        "ListMacOrders",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListMacOrdersResponse>
                transformer =
                        ListMacOrdersConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ListMacOrdersRequest, ListMacOrdersResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListMacOrdersRequest, ListMacOrdersResponse>,
                        java.util.concurrent.Future<ListMacOrdersResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<UpdateMacOrderResponse> updateMacOrder(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async updateMacOrder");
        final UpdateMacOrderRequest interceptedRequest =
                UpdateMacOrderConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateMacOrderConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "MacOrder",
                        "UpdateMacOrder",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, UpdateMacOrderResponse>
                transformer =
                        UpdateMacOrderConverter.fromResponse(java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateMacOrderRequest, UpdateMacOrderResponse>,
                        java.util.concurrent.Future<UpdateMacOrderResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateMacOrderDetails(),
                                ib,
                                transformer);
