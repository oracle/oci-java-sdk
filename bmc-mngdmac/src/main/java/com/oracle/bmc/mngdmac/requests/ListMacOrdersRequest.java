...
public class ListMacOrdersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public Builder lifecycleState(
                com.oracle.bmc.mngdmac.model.MacOrder.LifecycleState lifecycleState) {
         ...
         */
        public ListMacOrdersRequest build() {
            ListMacOrdersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMacOrdersRequest
         */
        public ListMacOrdersRequest buildWithoutInvocationCallback() {
            ListMacOrdersRequest request = new ListMacOrdersRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMacOrdersRequest)) {
            return false;
        }

        ListMacOrdersRequest other = (ListMacOrdersRequest) o;
