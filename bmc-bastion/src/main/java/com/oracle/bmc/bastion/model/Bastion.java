...
/**
 * A bastion resource. A bastion provides secured, public access to target resources in the cloud
 * that you cannot otherwise reach from the internet. A bastion resides in a public subnet and
 * establishes the network infrastructure needed to connect a user to a target resource in a private
 * subnet. <br>
...
public final class Bastion extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
