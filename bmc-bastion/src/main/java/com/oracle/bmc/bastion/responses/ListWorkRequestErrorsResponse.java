...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bastion.model.WorkRequestError} instances. */
    private java.util.List<com.oracle.bmc.bastion.model.WorkRequestError> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.bastion.model.WorkRequestError> getItems() {
        return items;
    }
    ...
    private ListWorkRequestErrorsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.bastion.model.WorkRequestError> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.bastion.model.WorkRequestError> items) {
            this.items = items;
            return this;
        }
