...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bastion/ChangeBastionCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeBastionCompartmentRequest.
 */
...
public class ChangeBastionCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeBastionCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeBastionCompartmentRequest(bastionId, changeBastionCompartmentDetails, ifMatch, opcRequestId);
        }
    }
