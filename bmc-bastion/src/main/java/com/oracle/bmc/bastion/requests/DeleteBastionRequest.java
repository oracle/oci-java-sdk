...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bastion/DeleteBastionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteBastionRequest.
 */
...
public class DeleteBastionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteBastionRequest
         */
        public DeleteBastionRequest buildWithoutInvocationCallback() {
            DeleteBastionRequest request = new DeleteBastionRequest();
            request.bastionId = bastionId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteBastionRequest(bastionId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().bastionId(bastionId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBastionRequest)) {
            return false;
        }

        DeleteBastionRequest other = (DeleteBastionRequest) o;
