...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bastion/DeleteSessionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSessionRequest.
 */
...
public class DeleteSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteSessionRequest(sessionId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().sessionId(sessionId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
