...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bastion.model.WorkRequestSummary} instances. */
    private java.util.List<com.oracle.bmc.bastion.model.WorkRequestSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.bastion.model.WorkRequestSummary> getItems() {
        return items;
    }
    ...
    private ListWorkRequestsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.bastion.model.WorkRequestSummary> items) {
