 ...
 * to any list operations of Bastion where multiple pages of data may be fetched. Two styles of
...
public class BastionPaginators {
    ...
    public Iterable<ListBastionsResponse> listBastionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Supplier<ListBastionsRequest.Builder>() {
                    @Override
                    public ListBastionsRequest.Builder get() {
                        return ListBastionsRequest.builder().copy(request);
                    }
                },
                new java.util.function.Function<ListBastionsResponse, String>() {
                    @Override
                ...
                new java.util.function.Function<ListBastionsRequest, ListBastionsResponse>() {
                    @Override
     ...
     * com.oracle.bmc.bastion.model.BastionSummary} objects contained in responses from the
     * listBastions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.bastion.model.BastionSummary} objects contained in responses received from
     *     the service.
     */
    ...
    public Iterable<ListSessionsResponse> listSessionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Supplier<ListSessionsRequest.Builder>() {
                    @Override
                    public ListSessionsRequest.Builder get() {
                        return ListSessionsRequest.builder().copy(request);
                    }
                },
                new java.util.function.Function<ListSessionsResponse, String>() {
                    @Override
                ...
                new java.util.function.Function<ListSessionsRequest, ListSessionsResponse>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.bastion.model.SessionSummary} objects contained in responses from the
     * listSessions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.bastion.model.SessionSummary} objects contained in responses received from
     *     the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.bastion.model.WorkRequestError} objects contained in responses from the
     * listWorkRequestErrors operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.bastion.model.WorkRequestError} objects contained in responses received
     *     from the service.
     */
    public Iterable<com.oracle.bmc.bastion.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse,
                com.oracle.bmc.bastion.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.bastion.model.WorkRequestLogEntry} objects contained in responses from the
     * listWorkRequestLogs operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.bastion.model.WorkRequestLogEntry} objects contained in responses received
     *     from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.bastion.model.WorkRequestSummary} objects contained in responses from the
     * listWorkRequests operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.bastion.model.WorkRequestSummary} objects contained in responses received
     *     from the service.
     */
