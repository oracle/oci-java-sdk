...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bastion.model.WorkRequestLogEntry} instances. */
    private java.util.List<com.oracle.bmc.bastion.model.WorkRequestLogEntry> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.bastion.model.WorkRequestLogEntry> getItems() {
        return items;
    }
    ...
    private ListWorkRequestLogsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.bastion.model.WorkRequestLogEntry> items) {
