...
public class GetBastionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBastionResponse> {
         ...
         */
        @Override
        public GetBastionResponse build() {
            return new GetBastionResponse(__httpStatusCode__, headers, etag, opcRequestId, bastion);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBastionResponse)) {
            return false;
        }

        GetBastionResponse other = (GetBastionResponse) o;
