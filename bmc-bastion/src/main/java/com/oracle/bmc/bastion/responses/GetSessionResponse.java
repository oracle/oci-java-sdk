...
public class GetSessionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSessionResponse> {
        ...
        public GetSessionResponse build() {
            return new GetSessionResponse(__httpStatusCode__, headers, etag, opcRequestId, session);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSessionResponse)) {
            return false;
        }
