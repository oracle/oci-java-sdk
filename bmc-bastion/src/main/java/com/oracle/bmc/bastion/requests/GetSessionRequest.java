...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bastion/GetSessionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSessionRequest.
 */
...
public class GetSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSessionRequest(sessionId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().sessionId(sessionId).opcRequestId(opcRequestId);
    }
