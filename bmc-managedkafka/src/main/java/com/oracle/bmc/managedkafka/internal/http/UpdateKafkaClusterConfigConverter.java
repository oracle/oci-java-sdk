...
public class UpdateKafkaClusterConfigConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateKafkaClusterConfigConverter.class);

    public static com.oracle.bmc.managedkafka.requests.UpdateKafkaClusterConfigRequest
            interceptRequest(
                    com.oracle.bmc.managedkafka.requests.UpdateKafkaClusterConfigRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.managedkafka.responses.UpdateKafkaClusterConfigResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.managedkafka.responses
                                        .UpdateKafkaClusterConfigResponse>() {
                            @Override
                            public com.oracle.bmc.managedkafka.responses
                                            .UpdateKafkaClusterConfigResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.managedkafka.responses.UpdateKafkaClusterConfigResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.managedkafka.responses
                                                .UpdateKafkaClusterConfigResponse.Builder
                                        builder =
                                                com.oracle.bmc.managedkafka.responses
                                                        .UpdateKafkaClusterConfigResponse.builder()
