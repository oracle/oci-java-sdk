...
public class GetKafkaClusterConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetKafkaClusterConfigResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetKafkaClusterConfigResponse> {
         ...
         */
        @Override
        public Builder copy(GetKafkaClusterConfigResponse o) {
         ...
         */
        @Override
        public GetKafkaClusterConfigResponse build() {
            return new GetKafkaClusterConfigResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, kafkaClusterConfig);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetKafkaClusterConfigResponse)) {
            return false;
        }

        GetKafkaClusterConfigResponse other = (GetKafkaClusterConfigResponse) o;
