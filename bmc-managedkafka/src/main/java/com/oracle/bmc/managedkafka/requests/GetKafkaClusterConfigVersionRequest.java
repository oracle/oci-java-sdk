...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managedkafka/GetKafkaClusterConfigVersionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetKafkaClusterConfigVersionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240901")
public class GetKafkaClusterConfigVersionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetKafkaClusterConfigVersionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetKafkaClusterConfigVersionRequest o) {
        ...
        /**
         * Build the instance of GetKafkaClusterConfigVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetKafkaClusterConfigVersionRequest
         */
        public GetKafkaClusterConfigVersionRequest build() {
            GetKafkaClusterConfigVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetKafkaClusterConfigVersionRequest
         */
        public GetKafkaClusterConfigVersionRequest buildWithoutInvocationCallback() {
            GetKafkaClusterConfigVersionRequest request = new GetKafkaClusterConfigVersionRequest();
            request.kafkaClusterConfigId = kafkaClusterConfigId;
            request.versionNumber = versionNumber;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetKafkaClusterConfigVersionRequest(kafkaClusterConfigId, versionNumber, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetKafkaClusterConfigVersionRequest)) {
            return false;
        }

        GetKafkaClusterConfigVersionRequest other = (GetKafkaClusterConfigVersionRequest) o;
