...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managedkafka/DeleteKafkaClusterConfigVersionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteKafkaClusterConfigVersionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240901")
public class DeleteKafkaClusterConfigVersionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteKafkaClusterConfigVersionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteKafkaClusterConfigVersionRequest o) {
        ...
        /**
         * Build the instance of DeleteKafkaClusterConfigVersionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteKafkaClusterConfigVersionRequest
         */
        public DeleteKafkaClusterConfigVersionRequest build() {
            DeleteKafkaClusterConfigVersionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteKafkaClusterConfigVersionRequest
         */
        public DeleteKafkaClusterConfigVersionRequest buildWithoutInvocationCallback() {
            DeleteKafkaClusterConfigVersionRequest request =
                    new DeleteKafkaClusterConfigVersionRequest();
            request.kafkaClusterConfigId = kafkaClusterConfigId;
            request.versionNumber = versionNumber;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteKafkaClusterConfigVersionRequest(kafkaClusterConfigId, versionNumber, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteKafkaClusterConfigVersionRequest)) {
            return false;
        }

        DeleteKafkaClusterConfigVersionRequest other = (DeleteKafkaClusterConfigVersionRequest) o;
