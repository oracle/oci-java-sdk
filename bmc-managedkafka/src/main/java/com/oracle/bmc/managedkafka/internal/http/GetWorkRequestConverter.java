...
public class GetWorkRequestConverter {
    ...
    public static com.oracle.bmc.managedkafka.requests.GetWorkRequestRequest interceptRequest(
            com.oracle.bmc.managedkafka.requests.GetWorkRequestRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.managedkafka.responses.GetWorkRequestResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.managedkafka.responses.GetWorkRequestResponse>() {
                            @Override
                            public com.oracle.bmc.managedkafka.responses.GetWorkRequestResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.managedkafka.responses.GetWorkRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.managedkafka.model.WorkRequest
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.managedkafka.responses.GetWorkRequestResponse.Builder
                                        builder =
