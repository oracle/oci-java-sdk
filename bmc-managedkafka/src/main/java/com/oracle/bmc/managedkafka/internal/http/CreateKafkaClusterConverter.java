...
public class CreateKafkaClusterConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateKafkaClusterConverter.class);

    public static com.oracle.bmc.managedkafka.requests.CreateKafkaClusterRequest interceptRequest(
            com.oracle.bmc.managedkafka.requests.CreateKafkaClusterRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20240901").path("kafkaClusters");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.managedkafka.responses.CreateKafkaClusterResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.managedkafka.responses
                                        .CreateKafkaClusterResponse>() {
                            @Override
                            public com.oracle.bmc.managedkafka.responses.CreateKafkaClusterResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.managedkafka.responses.CreateKafkaClusterResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.managedkafka.responses.CreateKafkaClusterResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.managedkafka.responses
                                                        .CreateKafkaClusterResponse.builder()
