...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = KafkaClusterSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class KafkaClusterSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public KafkaClusterSummary(
            String id,
            String displayName,
            String compartmentId,
            java.util.Date timeCreated,
            java.util.Date timeUpdated,
            KafkaCluster.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private KafkaCluster.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(KafkaCluster.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public KafkaClusterSummary build() {
            KafkaClusterSummary model =
                    new KafkaClusterSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KafkaClusterSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final KafkaCluster.LifecycleState lifecycleState;

    /**
     * The current state of the KafkaCluster.
     * @return the value
     **/
    public KafkaCluster.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KafkaClusterSummary)) {
            return false;
        }

        KafkaClusterSummary other = (KafkaClusterSummary) o;
