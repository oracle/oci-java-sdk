...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "addonType",
        defaultImpl = UpdateAddonDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdatePublicConnectivityAddonDetails.class,
            name = "PUBLICCONNECTIVITY")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class UpdateAddonDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"description"})
    protected UpdateAddonDetails(String description) {
        super();
