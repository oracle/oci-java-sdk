...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managedkafka/UpdateKafkaClusterConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateKafkaClusterConfigRequest.
 */
...
public class UpdateKafkaClusterConfigRequest
    ...
    public static class Builder
        ...
        public UpdateKafkaClusterConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateKafkaClusterConfigRequest(kafkaClusterConfigId, updateKafkaClusterConfigDetails, ifMatch, opcRequestId);
        }
    }
