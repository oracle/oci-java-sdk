...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managedkafka/DeleteKafkaClusterConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteKafkaClusterConfigRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240901")
public class DeleteKafkaClusterConfigRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteKafkaClusterConfigRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteKafkaClusterConfigRequest o) {
        ...
        /**
         * Build the instance of DeleteKafkaClusterConfigRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteKafkaClusterConfigRequest
         */
        public DeleteKafkaClusterConfigRequest build() {
            DeleteKafkaClusterConfigRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteKafkaClusterConfigRequest
         */
        public DeleteKafkaClusterConfigRequest buildWithoutInvocationCallback() {
            DeleteKafkaClusterConfigRequest request = new DeleteKafkaClusterConfigRequest();
            request.kafkaClusterConfigId = kafkaClusterConfigId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteKafkaClusterConfigRequest(kafkaClusterConfigId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteKafkaClusterConfigRequest)) {
            return false;
        }

        DeleteKafkaClusterConfigRequest other = (DeleteKafkaClusterConfigRequest) o;
