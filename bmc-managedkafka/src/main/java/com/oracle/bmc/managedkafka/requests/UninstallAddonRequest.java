...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managedkafka/UninstallAddonExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UninstallAddonRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240901")
public class UninstallAddonRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    UninstallAddonRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(UninstallAddonRequest o) {
        ...
        /**
         * Build the instance of UninstallAddonRequest as configured by this builder
         *
         ...
         *
         * @return instance of UninstallAddonRequest
         */
        public UninstallAddonRequest build() {
            UninstallAddonRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UninstallAddonRequest
         */
        public UninstallAddonRequest buildWithoutInvocationCallback() {
            UninstallAddonRequest request = new UninstallAddonRequest();
            request.kafkaClusterId = kafkaClusterId;
            request.addonName = addonName;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UninstallAddonRequest(kafkaClusterId, addonName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UninstallAddonRequest)) {
            return false;
        }

        UninstallAddonRequest other = (UninstallAddonRequest) o;
