...
public interface MultiCloudResourceDiscovery extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ChangeMultiCloudResourceDiscoveryCompartmentExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ChangeMultiCloudResourceDiscoveryCompartment API.
     */
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/CreateMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use CreateMultiCloudResourceDiscovery API.
     */
    CreateMultiCloudResourceDiscoveryResponse createMultiCloudResourceDiscovery(
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use DeleteMultiCloudResourceDiscovery API.
     */
    DeleteMultiCloudResourceDiscoveryResponse deleteMultiCloudResourceDiscovery(
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetMultiCloudResourceDiscovery API.
     */
    GetMultiCloudResourceDiscoveryResponse getMultiCloudResourceDiscovery(
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListMultiCloudResourceDiscoveriesExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListMultiCloudResourceDiscoveries API.
     */
    ListMultiCloudResourceDiscoveriesResponse listMultiCloudResourceDiscoveries(
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/UpdateMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use UpdateMultiCloudResourceDiscovery API.
     */
    UpdateMultiCloudResourceDiscoveryResponse updateMultiCloudResourceDiscovery(
     ...
     */
    MultiCloudResourceDiscoveryWaiters getWaiters();
     ...
     */
    MultiCloudResourceDiscoveryPaginators getPaginators();
}
