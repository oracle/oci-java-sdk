...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbAzureVaultAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOracleDbAzureVaultAssociationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class DeleteOracleDbAzureVaultAssociationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOracleDbAzureVaultAssociationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOracleDbAzureVaultAssociationRequest o) {
        ...
        /**
         * Build the instance of DeleteOracleDbAzureVaultAssociationRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteOracleDbAzureVaultAssociationRequest
         */
        public DeleteOracleDbAzureVaultAssociationRequest build() {
            DeleteOracleDbAzureVaultAssociationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOracleDbAzureVaultAssociationRequest
         */
        public DeleteOracleDbAzureVaultAssociationRequest buildWithoutInvocationCallback() {
            DeleteOracleDbAzureVaultAssociationRequest request =
                    new DeleteOracleDbAzureVaultAssociationRequest();
            request.oracleDbAzureVaultAssociationId = oracleDbAzureVaultAssociationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOracleDbAzureVaultAssociationRequest(oracleDbAzureVaultAssociationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOracleDbAzureVaultAssociationRequest)) {
            return false;
        }

        DeleteOracleDbAzureVaultAssociationRequest other =
                (DeleteOracleDbAzureVaultAssociationRequest) o;
