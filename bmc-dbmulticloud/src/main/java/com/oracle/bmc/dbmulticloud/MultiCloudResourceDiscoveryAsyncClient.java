...
public class MultiCloudResourceDiscoveryAsyncClient implements MultiCloudResourceDiscoveryAsync {
    /**
    ...
    public static class Builder
        ...
        public MultiCloudResourceDiscoveryAsyncClient build(
            ...
            return new MultiCloudResourceDiscoveryAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ChangeMultiCloudResourceDiscoveryCompartmentResponse>
            changeMultiCloudResourceDiscoveryCompartment(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async changeMultiCloudResourceDiscoveryCompartment");
    ...
    public java.util.concurrent.Future<CreateMultiCloudResourceDiscoveryResponse>
            createMultiCloudResourceDiscovery(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async createMultiCloudResourceDiscovery");
        ...
        java.util.function.Function<
                ...
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateMultiCloudResourceDiscoveryDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<DeleteMultiCloudResourceDiscoveryResponse>
            deleteMultiCloudResourceDiscovery(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async deleteMultiCloudResourceDiscovery");
    ...
    public java.util.concurrent.Future<GetMultiCloudResourceDiscoveryResponse>
            getMultiCloudResourceDiscovery(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async getMultiCloudResourceDiscovery");
    ...
    public java.util.concurrent.Future<ListMultiCloudResourceDiscoveriesResponse>
            listMultiCloudResourceDiscoveries(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listMultiCloudResourceDiscoveries");
    ...
    public java.util.concurrent.Future<UpdateMultiCloudResourceDiscoveryResponse>
            updateMultiCloudResourceDiscovery(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async updateMultiCloudResourceDiscovery");
        ...
        java.util.function.Function<
                ...
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateMultiCloudResourceDiscoveryDetails(),
                                ib,
                                transformer);
