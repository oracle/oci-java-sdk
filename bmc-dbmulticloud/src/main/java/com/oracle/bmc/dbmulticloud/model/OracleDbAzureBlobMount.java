...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDbAzureBlobMount.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbAzureBlobMount
    ...
    public static class Builder {
        ...
        /**
         * Time when the Oracle DB Azure Blob Mount was created in [RFC
        ...
        /**
         * Time when the Oracle DB Azure Blob Mount was last modified, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g.
         * '2020-05-22T21:10:29.600Z'
         */
        ...
        public OracleDbAzureBlobMount build() {
            OracleDbAzureBlobMount model =
                    new OracleDbAzureBlobMount(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbAzureBlobMount model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDbAzureBlobMount(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbAzureBlobMount)) {
            return false;
        }

        OracleDbAzureBlobMount other = (OracleDbAzureBlobMount) o;
