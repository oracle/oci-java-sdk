...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetOracleDbAzureBlobContainerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOracleDbAzureBlobContainerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class GetOracleDbAzureBlobContainerRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOracleDbAzureBlobContainerRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOracleDbAzureBlobContainerRequest o) {
        ...
        /**
         * Build the instance of GetOracleDbAzureBlobContainerRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOracleDbAzureBlobContainerRequest
         */
        public GetOracleDbAzureBlobContainerRequest build() {
            GetOracleDbAzureBlobContainerRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOracleDbAzureBlobContainerRequest
         */
        public GetOracleDbAzureBlobContainerRequest buildWithoutInvocationCallback() {
            GetOracleDbAzureBlobContainerRequest request =
                    new GetOracleDbAzureBlobContainerRequest();
            ...
            return request;
            // new GetOracleDbAzureBlobContainerRequest(oracleDbAzureBlobContainerId, limit, page, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOracleDbAzureBlobContainerRequest)) {
            return false;
        }

        GetOracleDbAzureBlobContainerRequest other = (GetOracleDbAzureBlobContainerRequest) o;
