...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMultiCloudResourceDiscoveryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class GetMultiCloudResourceDiscoveryRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMultiCloudResourceDiscoveryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetMultiCloudResourceDiscoveryRequest o) {
        ...
        /**
         * Build the instance of GetMultiCloudResourceDiscoveryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetMultiCloudResourceDiscoveryRequest
         */
        public GetMultiCloudResourceDiscoveryRequest build() {
            GetMultiCloudResourceDiscoveryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetMultiCloudResourceDiscoveryRequest
         */
        public GetMultiCloudResourceDiscoveryRequest buildWithoutInvocationCallback() {
            GetMultiCloudResourceDiscoveryRequest request =
                    new GetMultiCloudResourceDiscoveryRequest();
            ...
            return request;
            // new GetMultiCloudResourceDiscoveryRequest(multiCloudResourceDiscoveryId, limit, page, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMultiCloudResourceDiscoveryRequest)) {
            return false;
        }

        GetMultiCloudResourceDiscoveryRequest other = (GetMultiCloudResourceDiscoveryRequest) o;
