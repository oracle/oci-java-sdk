...
public class DbMulticloudAwsProviderPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAwsIdentityConnectors operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAwsIdentityConnectorSummary} objects
     * contained in responses from the listOracleDbAwsIdentityConnectors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAwsIdentityConnectorSummary} objects
    ...
    public Iterable<com.oracle.bmc.dbmulticloud.model.OracleDbAwsIdentityConnectorSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListOracleDbAwsIdentityConnectorsRequest.Builder,
                ListOracleDbAwsIdentityConnectorsRequest, ListOracleDbAwsIdentityConnectorsResponse,
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAwsKeys operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListOracleDbAwsKeysResponse> listOracleDbAwsKeysResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOracleDbAwsKeysRequest.Builder, ListOracleDbAwsKeysRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAwsKeySummary} objects
     * contained in responses from the listOracleDbAwsKeys operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAwsKeySummary} objects
     * contained in responses received from the service.
     */
