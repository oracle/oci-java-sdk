...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbAzureBlobContainerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOracleDbAzureBlobContainerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class DeleteOracleDbAzureBlobContainerRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOracleDbAzureBlobContainerRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOracleDbAzureBlobContainerRequest o) {
        ...
        /**
         * Build the instance of DeleteOracleDbAzureBlobContainerRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteOracleDbAzureBlobContainerRequest
         */
        public DeleteOracleDbAzureBlobContainerRequest build() {
            DeleteOracleDbAzureBlobContainerRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOracleDbAzureBlobContainerRequest
         */
        public DeleteOracleDbAzureBlobContainerRequest buildWithoutInvocationCallback() {
            DeleteOracleDbAzureBlobContainerRequest request =
                    new DeleteOracleDbAzureBlobContainerRequest();
            request.oracleDbAzureBlobContainerId = oracleDbAzureBlobContainerId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOracleDbAzureBlobContainerRequest(oracleDbAzureBlobContainerId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOracleDbAzureBlobContainerRequest)) {
            return false;
        }

        DeleteOracleDbAzureBlobContainerRequest other = (DeleteOracleDbAzureBlobContainerRequest) o;
