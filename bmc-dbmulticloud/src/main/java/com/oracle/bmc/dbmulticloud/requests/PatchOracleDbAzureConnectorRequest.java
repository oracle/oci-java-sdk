...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/PatchOracleDbAzureConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchOracleDbAzureConnectorRequest.
 */
...
public class PatchOracleDbAzureConnectorRequest
    ...
    public static class Builder
        ...
        public PatchOracleDbAzureConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchOracleDbAzureConnectorRequest(oracleDbAzureConnectorId, patchOracleDbAzureConnectorDetails, ifMatch, opcRequestId);
        }
    }
