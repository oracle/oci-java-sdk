...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetOracleDbGcpKeyRingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOracleDbGcpKeyRingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class GetOracleDbGcpKeyRingRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOracleDbGcpKeyRingRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOracleDbGcpKeyRingRequest o) {
        ...
        /**
         * Build the instance of GetOracleDbGcpKeyRingRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOracleDbGcpKeyRingRequest
         */
        public GetOracleDbGcpKeyRingRequest build() {
            GetOracleDbGcpKeyRingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOracleDbGcpKeyRingRequest
         */
        public GetOracleDbGcpKeyRingRequest buildWithoutInvocationCallback() {
            GetOracleDbGcpKeyRingRequest request = new GetOracleDbGcpKeyRingRequest();
            ...
            return request;
            // new GetOracleDbGcpKeyRingRequest(oracleDbGcpKeyRingId, limit, page, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOracleDbGcpKeyRingRequest)) {
            return false;
        }

        GetOracleDbGcpKeyRingRequest other = (GetOracleDbGcpKeyRingRequest) o;
