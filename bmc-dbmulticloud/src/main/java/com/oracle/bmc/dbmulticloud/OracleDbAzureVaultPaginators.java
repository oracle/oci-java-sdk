 ...
 * to any list operations of OracleDbAzureVault where multiple pages of data may be fetched.
...
public class OracleDbAzureVaultPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAzureVaults operation. This iterable
    ...
    public Iterable<ListOracleDbAzureVaultsResponse> listOracleDbAzureVaultsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOracleDbAzureVaultsRequest.Builder, ListOracleDbAzureVaultsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureVaultSummary} objects
     * contained in responses from the listOracleDbAzureVaults operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureVaultSummary} objects
