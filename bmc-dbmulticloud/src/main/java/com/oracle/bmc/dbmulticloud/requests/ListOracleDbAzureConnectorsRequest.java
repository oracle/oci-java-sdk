...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureConnectorsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbAzureConnectorsRequest.
 */
...
public class ListOracleDbAzureConnectorsRequest
    ...
    public static class Builder
        ...
        public ListOracleDbAzureConnectorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOracleDbAzureConnectorsRequest(compartmentId, displayName, oracleDbAzureConnectorId, lifecycleState, dbClusterResourceId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
