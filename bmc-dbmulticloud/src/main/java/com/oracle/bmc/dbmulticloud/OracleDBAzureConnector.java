...
public interface OracleDBAzureConnector extends AutoCloseable {
     ...
     *     ChangeOracleDbAzureConnectorCompartment API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     CreateOracleDbAzureConnector API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbAzureConnectorExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     DeleteOracleDbAzureConnector API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListOracleDbAzureConnectors API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     PatchOracleDbAzureConnector API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     UpdateOracleDbAzureConnector API.
     */
