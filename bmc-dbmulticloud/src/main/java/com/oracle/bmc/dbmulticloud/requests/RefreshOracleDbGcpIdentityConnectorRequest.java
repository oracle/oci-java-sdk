...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbGcpIdentityConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshOracleDbGcpIdentityConnectorRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class RefreshOracleDbGcpIdentityConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RefreshOracleDbGcpIdentityConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshOracleDbGcpIdentityConnectorRequest o) {
        ...
        /**
         * Build the instance of RefreshOracleDbGcpIdentityConnectorRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshOracleDbGcpIdentityConnectorRequest
         */
        public RefreshOracleDbGcpIdentityConnectorRequest build() {
            RefreshOracleDbGcpIdentityConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshOracleDbGcpIdentityConnectorRequest
         */
        public RefreshOracleDbGcpIdentityConnectorRequest buildWithoutInvocationCallback() {
            RefreshOracleDbGcpIdentityConnectorRequest request =
                    new RefreshOracleDbGcpIdentityConnectorRequest();
            request.oracleDbGcpIdentityConnectorId = oracleDbGcpIdentityConnectorId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new RefreshOracleDbGcpIdentityConnectorRequest(oracleDbGcpIdentityConnectorId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshOracleDbGcpIdentityConnectorRequest)) {
            return false;
        }

        RefreshOracleDbGcpIdentityConnectorRequest other =
                (RefreshOracleDbGcpIdentityConnectorRequest) o;
