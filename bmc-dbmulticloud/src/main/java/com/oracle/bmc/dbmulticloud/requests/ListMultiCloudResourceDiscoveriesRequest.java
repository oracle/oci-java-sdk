...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListMultiCloudResourceDiscoveriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMultiCloudResourceDiscoveriesRequest.
 */
...
public class ListMultiCloudResourceDiscoveriesRequest
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Specifies the type(s) of resources to discover in the target cloud provider.
        ...
        /**
         * Build the instance of ListMultiCloudResourceDiscoveriesRequest as configured by this builder
         *
        ...
        public ListMultiCloudResourceDiscoveriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMultiCloudResourceDiscoveriesRequest(compartmentId, displayName, multiCloudResourceDiscoveryId, lifecycleState, oracleDbAzureConnectorId, resourceType, resourcesFilter, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
