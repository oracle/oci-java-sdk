...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbAzureConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshOracleDbAzureConnectorRequest.
 */
...
public class RefreshOracleDbAzureConnectorRequest
    ...
    public static class Builder
        ...
        public RefreshOracleDbAzureConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RefreshOracleDbAzureConnectorRequest(oracleDbAzureConnectorId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
