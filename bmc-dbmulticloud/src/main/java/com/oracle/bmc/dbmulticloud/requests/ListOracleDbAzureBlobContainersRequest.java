...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureBlobContainersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbAzureBlobContainersRequest.
 */
...
public class ListOracleDbAzureBlobContainersRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListOracleDbAzureBlobContainersRequest as configured by this builder
         *
        ...
        public ListOracleDbAzureBlobContainersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOracleDbAzureBlobContainersRequest(compartmentId, displayName, oracleDbAzureBlobContainerId, lifecycleState, azureStorageAccountName, azureStorageContainerName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
