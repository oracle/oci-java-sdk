...
public class GetWorkRequestConverter {
    ...
    public static com.oracle.bmc.dbmulticloud.requests.GetWorkRequestRequest interceptRequest(
            com.oracle.bmc.dbmulticloud.requests.GetWorkRequestRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dbmulticloud.responses.GetWorkRequestResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.dbmulticloud.responses.GetWorkRequestResponse>() {
                            @Override
                            public com.oracle.bmc.dbmulticloud.responses.GetWorkRequestResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dbmulticloud.responses.GetWorkRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.dbmulticloud.model.WorkRequest
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.dbmulticloud.responses.GetWorkRequestResponse.Builder
                                        builder =
