...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/UpdateOracleDbAzureVaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOracleDbAzureVaultRequest.
 */
...
public class UpdateOracleDbAzureVaultRequest
    ...
    public static class Builder
        ...
        public UpdateOracleDbAzureVaultRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOracleDbAzureVaultRequest(oracleDbAzureVaultId, updateOracleDbAzureVaultDetails, ifMatch, opcRequestId);
        }
    }
