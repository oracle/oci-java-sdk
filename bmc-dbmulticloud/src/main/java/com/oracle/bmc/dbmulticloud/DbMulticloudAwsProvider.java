...
public interface DbMulticloudAwsProvider extends AutoCloseable {
     ...
     *     ChangeOracleDbAwsIdentityConnectorCompartment API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ChangeOracleDbAwsKeyCompartment API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     CreateOracleDbAwsIdentityConnector API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbAwsIdentityConnectorExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     DeleteOracleDbAwsIdentityConnector API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     GetOracleDbAwsIdentityConnector API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetOracleDbAwsKey
     *     API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAwsIdentityConnectorsExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListOracleDbAwsIdentityConnectors API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListOracleDbAwsKeys
     *     API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbAwsIdentityConnectorExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     RefreshOracleDbAwsIdentityConnector API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     UpdateOracleDbAwsIdentityConnector API.
     */
