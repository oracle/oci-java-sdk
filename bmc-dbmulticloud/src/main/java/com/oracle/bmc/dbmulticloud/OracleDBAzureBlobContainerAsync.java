...
public interface OracleDBAzureBlobContainerAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeOracleDbAzureBlobContainerCompartmentResponse>
    ...
    /**
     * Retrieves the details of an Oracle DB\u2013associated Azure Blob Container using the
     * specified container resource
    ...
    /**
     * Modifies the existing Oracle DB Azure Blob Container resource for a given
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
