...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/UpdateOracleDbAzureBlobMountExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOracleDbAzureBlobMountRequest.
 */
...
public class UpdateOracleDbAzureBlobMountRequest
    ...
    public static class Builder
        ...
        public UpdateOracleDbAzureBlobMountRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOracleDbAzureBlobMountRequest(oracleDbAzureBlobMountId, updateOracleDbAzureBlobMountDetails, ifMatch, opcRequestId);
        }
    }
