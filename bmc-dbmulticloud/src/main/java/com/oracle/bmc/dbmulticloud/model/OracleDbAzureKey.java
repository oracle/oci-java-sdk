...
/**
 * Oracle DB Azure Key resource object. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OracleDbAzureKey.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbAzureKey
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * compartment that contains Oracle DB Azure Vault Key resource.
         */
        ...
        public Builder azureKeyId(String azureKeyId) {
            this.azureKeyId = azureKeyId;
            this.__explicitlySet__.add("azureKeyId");
            return this;
        }
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
        ...
        public OracleDbAzureKey build() {
            OracleDbAzureKey model =
                    new OracleDbAzureKey(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.azureKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbAzureKey model) {
            ...
            if (model.wasPropertyExplicitlySet("azureKeyId")) {
                this.azureKeyId(model.getAzureKeyId());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDbAzureKey(");
        sb.append("super=").append(super.toString());
        sb.append("id=").append(String.valueOf(this.id));
        sb.append(", compartmentId=").append(String.valueOf(this.compartmentId));
        sb.append(", displayName=").append(String.valueOf(this.displayName));
        sb.append(", azureKeyId=").append(String.valueOf(this.azureKeyId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbAzureKey)) {
            return false;
        }

        OracleDbAzureKey other = (OracleDbAzureKey) o;
        return java.util.Objects.equals(this.id, other.id)
                && java.util.Objects.equals(this.compartmentId, other.compartmentId)
                && java.util.Objects.equals(this.displayName, other.displayName)
                && java.util.Objects.equals(this.azureKeyId, other.azureKeyId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.azureKeyId == null ? 43 : this.azureKeyId.hashCode());
        result =
                (result * PRIME)
