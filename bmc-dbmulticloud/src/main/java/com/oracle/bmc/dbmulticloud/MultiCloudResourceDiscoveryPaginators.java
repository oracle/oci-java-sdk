 ...
 * to any list operations of MultiCloudResourceDiscovery where multiple pages of data may be fetched.
...
public class MultiCloudResourceDiscoveryPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMultiCloudResourceDiscoveries operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.MultiCloudResourceDiscoverySummary} objects
     * contained in responses from the listMultiCloudResourceDiscoveries operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.MultiCloudResourceDiscoverySummary} objects
    ...
    public Iterable<com.oracle.bmc.dbmulticloud.model.MultiCloudResourceDiscoverySummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListMultiCloudResourceDiscoveriesRequest.Builder,
                ListMultiCloudResourceDiscoveriesRequest, ListMultiCloudResourceDiscoveriesResponse,
