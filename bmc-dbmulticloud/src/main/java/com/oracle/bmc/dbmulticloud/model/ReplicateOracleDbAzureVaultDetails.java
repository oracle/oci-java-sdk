...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ReplicateOracleDbAzureVaultDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ReplicateOracleDbAzureVaultDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"targetRegion", "action"})
    public ReplicateOracleDbAzureVaultDetails(String targetRegion, ReplicationActions action) {
        super();
    ...
    public static class Builder {
        ...
        public ReplicateOracleDbAzureVaultDetails build() {
            ReplicateOracleDbAzureVaultDetails model =
                    new ReplicateOracleDbAzureVaultDetails(this.targetRegion, this.action);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReplicateOracleDbAzureVaultDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicateOracleDbAzureVaultDetails)) {
            return false;
        }

        ReplicateOracleDbAzureVaultDetails other = (ReplicateOracleDbAzureVaultDetails) o;
