...
public interface OracleDbAzureKey extends AutoCloseable {
    ...
    /**
     * Retrieves detailed information about a Oracle DB Azure Key resource by specifying its unique
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetOracleDbAzureKey
     *     API.
     */
