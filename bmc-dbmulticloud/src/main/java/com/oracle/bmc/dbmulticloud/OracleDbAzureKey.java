...
public interface OracleDbAzureKey extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetOracleDbAzureKeyExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetOracleDbAzureKey API.
     */
    GetOracleDbAzureKeyResponse getOracleDbAzureKey(GetOracleDbAzureKeyRequest request);
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureKeysExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListOracleDbAzureKeys API.
     */
    ListOracleDbAzureKeysResponse listOracleDbAzureKeys(ListOracleDbAzureKeysRequest request);
     ...
     */
    OracleDbAzureKeyWaiters getWaiters();
     ...
     */
    OracleDbAzureKeyPaginators getPaginators();
}
