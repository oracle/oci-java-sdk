...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleDbAzureBlobMountDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOracleDbAzureBlobMountDetails
    ...
    public UpdateOracleDbAzureBlobMountDetails(
    ...
    public static class Builder {
        /**
         * The OCID of the compartment that contains where to create Oracle DB Azure Blob Mount
         * resource.
         */
        ...
        public UpdateOracleDbAzureBlobMountDetails build() {
            UpdateOracleDbAzureBlobMountDetails model =
                    new UpdateOracleDbAzureBlobMountDetails(
                            this.compartmentId,
                            this.displayName,
                            this.oracleDbAzureConnectorId,
                            this.oracleDbAzureBlobContainerId,
                            this.freeformTags,
                            this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleDbAzureBlobMountDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("oracleDbAzureBlobContainerId")) {
                this.oracleDbAzureBlobContainerId(model.getOracleDbAzureBlobContainerId());
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleDbAzureBlobMountDetails)) {
            return false;
        }

        UpdateOracleDbAzureBlobMountDetails other = (UpdateOracleDbAzureBlobMountDetails) o;
