...
/**
 * Oracle DB Azure Vault Resource Object. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDbAzureVault.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbAzureVault
    ...
    public static class Builder {
        ...
        /**
         * The Compartment
         * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) that has
         * this DB Azure Vault Resource.
         */
        ...
        /**
         * Time when the DB Azure Vault was created in [RFC
        ...
        /**
         * Time when the DB Azure Vault was last modified, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g.
         * '2020-05-23T21:10:29.600Z'
         */
        ...
        public OracleDbAzureVault build() {
            OracleDbAzureVault model =
                    new OracleDbAzureVault(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbAzureVault model) {
     ...
     * that has this DB Azure Vault Resource.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * Time when the DB Azure Vault was created in [RFC 3339](https://tools.ietf.org/html/rfc3339)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbAzureVault)) {
            return false;
        }

        OracleDbAzureVault other = (OracleDbAzureVault) o;
