...
public class DbMulticloudAwsProviderClient implements DbMulticloudAwsProvider {
    /**
     ...
     */
    protected DbMulticloudAwsProviderClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeOracleDbAwsIdentityConnectorCompartmentResponse
        ...
        LOG.trace("Called changeOracleDbAwsIdentityConnectorCompartment");
    ...
    public ChangeOracleDbAwsKeyCompartmentResponse changeOracleDbAwsKeyCompartment(
        ...
        LOG.trace("Called changeOracleDbAwsKeyCompartment");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getChangeOracleDbAwsKeyCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateOracleDbAwsIdentityConnectorResponse createOracleDbAwsIdentityConnector(
        ...
        LOG.trace("Called createOracleDbAwsIdentityConnector");
    ...
    public CreateOracleDbAwsKeyResponse createOracleDbAwsKey(CreateOracleDbAwsKeyRequest request) {
        LOG.trace("Called createOracleDbAwsKey");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateOracleDbAwsKeyResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateOracleDbAwsKeyDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteOracleDbAwsIdentityConnectorResponse deleteOracleDbAwsIdentityConnector(
        ...
        LOG.trace("Called deleteOracleDbAwsIdentityConnector");
    ...
    public DeleteOracleDbAwsKeyResponse deleteOracleDbAwsKey(DeleteOracleDbAwsKeyRequest request) {
        LOG.trace("Called deleteOracleDbAwsKey");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteOracleDbAwsKeyResponse>
                transformer =
    ...
    public GetOracleDbAwsIdentityConnectorResponse getOracleDbAwsIdentityConnector(
        ...
        LOG.trace("Called getOracleDbAwsIdentityConnector");
    ...
    public GetOracleDbAwsKeyResponse getOracleDbAwsKey(GetOracleDbAwsKeyRequest request) {
        LOG.trace("Called getOracleDbAwsKey");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetOracleDbAwsKeyResponse>
                transformer =
    ...
    public ListOracleDbAwsIdentityConnectorsResponse listOracleDbAwsIdentityConnectors(
        ...
        LOG.trace("Called listOracleDbAwsIdentityConnectors");
    ...
    public ListOracleDbAwsKeysResponse listOracleDbAwsKeys(ListOracleDbAwsKeysRequest request) {
        LOG.trace("Called listOracleDbAwsKeys");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListOracleDbAwsKeysResponse>
                transformer =
    ...
    public RefreshOracleDbAwsIdentityConnectorResponse refreshOracleDbAwsIdentityConnector(
        ...
        LOG.trace("Called refreshOracleDbAwsIdentityConnector");
    ...
    public RefreshOracleDbAwsKeyResponse refreshOracleDbAwsKey(
        ...
        LOG.trace("Called refreshOracleDbAwsKey");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RefreshOracleDbAwsKeyResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRefreshOracleDbAwsKeyDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateOracleDbAwsKeyResponse updateOracleDbAwsKey(UpdateOracleDbAwsKeyRequest request) {
        LOG.trace("Called updateOracleDbAwsKey");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateOracleDbAwsKeyResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateOracleDbAwsKeyDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
