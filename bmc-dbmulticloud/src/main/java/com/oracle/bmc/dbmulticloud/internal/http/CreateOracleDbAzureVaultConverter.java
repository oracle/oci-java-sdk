...
public class CreateOracleDbAzureVaultConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateOracleDbAzureVaultConverter.class);

    public static com.oracle.bmc.dbmulticloud.requests.CreateOracleDbAzureVaultRequest
            interceptRequest(
                    com.oracle.bmc.dbmulticloud.requests.CreateOracleDbAzureVaultRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dbmulticloud.responses.CreateOracleDbAzureVaultResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.dbmulticloud.responses
                                        .CreateOracleDbAzureVaultResponse>() {
                            @Override
                            public com.oracle.bmc.dbmulticloud.responses
                                            .CreateOracleDbAzureVaultResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dbmulticloud.responses.CreateOracleDbAzureVaultResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dbmulticloud.responses
                                                .CreateOracleDbAzureVaultResponse.Builder
                                        builder =
                                                com.oracle.bmc.dbmulticloud.responses
                                                        .CreateOracleDbAzureVaultResponse.builder()
                                ...
                                builder.oracleDbAzureVault(response.getItem());
