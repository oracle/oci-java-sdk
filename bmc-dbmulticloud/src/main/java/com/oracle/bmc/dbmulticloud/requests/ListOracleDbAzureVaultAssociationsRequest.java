...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureVaultAssociationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbAzureVaultAssociationsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class ListOracleDbAzureVaultAssociationsRequest
     ...
     *
     */
    private com.oracle.bmc.dbmulticloud.model.OracleDbAzureVaultAssociation.LifecycleState
            lifecycleState;
     ...
     *
     */
    public com.oracle.bmc.dbmulticloud.model.OracleDbAzureVaultAssociation.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOracleDbAzureVaultAssociationsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOracleDbAzureVaultAssociationsRequest o) {
        ...
        /**
         * Build the instance of ListOracleDbAzureVaultAssociationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOracleDbAzureVaultAssociationsRequest
         */
        public ListOracleDbAzureVaultAssociationsRequest build() {
            ListOracleDbAzureVaultAssociationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOracleDbAzureVaultAssociationsRequest
         */
        public ListOracleDbAzureVaultAssociationsRequest buildWithoutInvocationCallback() {
            ListOracleDbAzureVaultAssociationsRequest request =
                    new ListOracleDbAzureVaultAssociationsRequest();
            ...
            return request;
            // new ListOracleDbAzureVaultAssociationsRequest(compartmentId, oracleDbAzureVaultId, displayName, oracleDbAzureVaultAssociationId, lifecycleState, oracleDbAzureConnectorId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOracleDbAzureVaultAssociationsRequest)) {
            return false;
        }

        ListOracleDbAzureVaultAssociationsRequest other =
                (ListOracleDbAzureVaultAssociationsRequest) o;
