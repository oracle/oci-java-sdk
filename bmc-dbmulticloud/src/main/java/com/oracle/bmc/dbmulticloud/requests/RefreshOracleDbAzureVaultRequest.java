...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbAzureVaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshOracleDbAzureVaultRequest.
 */
...
public class RefreshOracleDbAzureVaultRequest
    ...
    public static class Builder
         ...
         *
         * @return instance of RefreshOracleDbAzureVaultRequest
         */
        public RefreshOracleDbAzureVaultRequest build() {
            RefreshOracleDbAzureVaultRequest request = buildWithoutInvocationCallback();
        ...
        public RefreshOracleDbAzureVaultRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RefreshOracleDbAzureVaultRequest(oracleDbAzureVaultId, refreshOracleDbAzureVaultDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshOracleDbAzureVaultRequest)) {
            return false;
        }
