...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureVaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOracleDbAzureVaultRequest.
 */
...
public class CreateOracleDbAzureVaultRequest
    ...
    public static class Builder
        ...
        public CreateOracleDbAzureVaultRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateOracleDbAzureVaultRequest(createOracleDbAzureVaultDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
