...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbGcpKeyRingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbGcpKeyRingsRequest.
 */
...
public class ListOracleDbGcpKeyRingsRequest
    ...
    public static class Builder
        ...
        public ListOracleDbGcpKeyRingsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOracleDbGcpKeyRingsRequest(compartmentId, displayName, oracleDbGcpKeyRingId, lifecycleState, oracleDbGcpConnectorId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
