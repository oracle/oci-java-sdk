...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteMultiCloudResourceDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMultiCloudResourceDiscoveryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class DeleteMultiCloudResourceDiscoveryRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMultiCloudResourceDiscoveryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMultiCloudResourceDiscoveryRequest o) {
        ...
        /**
         * Build the instance of DeleteMultiCloudResourceDiscoveryRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMultiCloudResourceDiscoveryRequest
         */
        public DeleteMultiCloudResourceDiscoveryRequest build() {
            DeleteMultiCloudResourceDiscoveryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMultiCloudResourceDiscoveryRequest
         */
        public DeleteMultiCloudResourceDiscoveryRequest buildWithoutInvocationCallback() {
            DeleteMultiCloudResourceDiscoveryRequest request =
                    new DeleteMultiCloudResourceDiscoveryRequest();
            request.multiCloudResourceDiscoveryId = multiCloudResourceDiscoveryId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteMultiCloudResourceDiscoveryRequest(multiCloudResourceDiscoveryId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMultiCloudResourceDiscoveryRequest)) {
            return false;
        }

        DeleteMultiCloudResourceDiscoveryRequest other =
                (DeleteMultiCloudResourceDiscoveryRequest) o;
