...
public class UpdateOracleDbAzureVaultConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateOracleDbAzureVaultConverter.class);

    public static com.oracle.bmc.dbmulticloud.requests.UpdateOracleDbAzureVaultRequest
            interceptRequest(
                    com.oracle.bmc.dbmulticloud.requests.UpdateOracleDbAzureVaultRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dbmulticloud.responses.UpdateOracleDbAzureVaultResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dbmulticloud.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dbmulticloud.responses.UpdateOracleDbAzureVaultResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dbmulticloud.responses
                                                .UpdateOracleDbAzureVaultResponse.Builder
                                        builder =
                                                com.oracle.bmc.dbmulticloud.responses
                                                        .UpdateOracleDbAzureVaultResponse.builder()
