...
/**
 * Oracle DB AWS Key Resource object. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OracleDbAwsKey.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbAwsKey
    ...
    public static class Builder {
         ...
         * contains this Oracle DB AWS Key resource.
         */
        ...
        /**
         * Time when the DB AWS Key resource was created in [RFC
        ...
        /**
         * Time when the DB AWS Key resource was last modified, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g.
         * '2020-05-23T21:10:29.600Z'.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbAwsKey model) {
     ...
     * that contains this Oracle DB AWS Key resource.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbAwsKey)) {
            return false;
        }

        OracleDbAwsKey other = (OracleDbAwsKey) o;
