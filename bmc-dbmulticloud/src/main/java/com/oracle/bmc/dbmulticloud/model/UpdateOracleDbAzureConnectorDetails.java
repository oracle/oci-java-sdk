...
/**
 * This object is about to provide input params to update Oracle DB Azure Connector Resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOracleDbAzureConnectorDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateOracleDbAzureConnectorDetails
    ...
    public UpdateOracleDbAzureConnectorDetails(
    ...
    public static class Builder {
        ...
        /**
         * The ID of the Oracle DB Cluster Resource where this Azure Arc Agent Identity to
         * configure.
         */
        ...
        public UpdateOracleDbAzureConnectorDetails build() {
            UpdateOracleDbAzureConnectorDetails model =
                    new UpdateOracleDbAzureConnectorDetails(
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOracleDbAzureConnectorDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOracleDbAzureConnectorDetails)) {
            return false;
        }

        UpdateOracleDbAzureConnectorDetails other = (UpdateOracleDbAzureConnectorDetails) o;
