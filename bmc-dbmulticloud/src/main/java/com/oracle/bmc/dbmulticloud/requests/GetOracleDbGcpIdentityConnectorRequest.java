...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetOracleDbGcpIdentityConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOracleDbGcpIdentityConnectorRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class GetOracleDbGcpIdentityConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOracleDbGcpIdentityConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOracleDbGcpIdentityConnectorRequest o) {
        ...
        /**
         * Build the instance of GetOracleDbGcpIdentityConnectorRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOracleDbGcpIdentityConnectorRequest
         */
        public GetOracleDbGcpIdentityConnectorRequest build() {
            GetOracleDbGcpIdentityConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOracleDbGcpIdentityConnectorRequest
         */
        public GetOracleDbGcpIdentityConnectorRequest buildWithoutInvocationCallback() {
            GetOracleDbGcpIdentityConnectorRequest request =
                    new GetOracleDbGcpIdentityConnectorRequest();
            request.oracleDbGcpIdentityConnectorId = oracleDbGcpIdentityConnectorId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetOracleDbGcpIdentityConnectorRequest(oracleDbGcpIdentityConnectorId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOracleDbGcpIdentityConnectorRequest)) {
            return false;
        }

        GetOracleDbGcpIdentityConnectorRequest other = (GetOracleDbGcpIdentityConnectorRequest) o;
