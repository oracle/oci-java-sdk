...
public interface OracleDbAzureKeyAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetOracleDbAzureKeyResponse> getOracleDbAzureKey(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOracleDbAzureKeysResponse> listOracleDbAzureKeys(
