...
/**
 * AWS Identity Connector Node Details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AwsNodes.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AwsNodes extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"hostName", "hostId", "status", "timeLastChecked"})
    public AwsNodes(String hostName, String hostId, Status status, java.util.Date timeLastChecked) {
        super();
    ...
    public static class Builder {
        ...
        /**
         * Time when the AWS Identity Connector's status was checked [RFC
        ...
        public AwsNodes build() {
            AwsNodes model =
                    new AwsNodes(this.hostName, this.hostId, this.status, this.timeLastChecked);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwsNodes model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwsNodes)) {
            return false;
        }

        AwsNodes other = (AwsNodes) o;
