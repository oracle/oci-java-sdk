...
/**
 * Oracle DB Google Cloud Key resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OracleDbGcpKey.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbGcpKey
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * compartment that contains Oracle DB Google Key resource.
         */
        ...
        /**
         * TThe Google Cloud Key ID and Key URL associated with the Google Key under the specified
         * Key Ring resource.
         */
        ...
        /**
         * Time when the Oracle DB Google Key resource was created in [RFC
        ...
        /**
         * Time when the Oracle DB Google Key resource was last modified, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g.
         * '2020-05-22T21:10:29.600Z'
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbGcpKey model) {
    ...
    /**
     * TThe Google Cloud Key ID and Key URL associated with the Google Key under the specified Key
     * Ring resource.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("gcpKeyId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbGcpKey)) {
            return false;
        }

        OracleDbGcpKey other = (OracleDbGcpKey) o;
