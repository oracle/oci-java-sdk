...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbGcpIdentityConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOracleDbGcpIdentityConnectorRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class DeleteOracleDbGcpIdentityConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOracleDbGcpIdentityConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOracleDbGcpIdentityConnectorRequest o) {
        ...
        /**
         * Build the instance of DeleteOracleDbGcpIdentityConnectorRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteOracleDbGcpIdentityConnectorRequest
         */
        public DeleteOracleDbGcpIdentityConnectorRequest build() {
            DeleteOracleDbGcpIdentityConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOracleDbGcpIdentityConnectorRequest
         */
        public DeleteOracleDbGcpIdentityConnectorRequest buildWithoutInvocationCallback() {
            DeleteOracleDbGcpIdentityConnectorRequest request =
                    new DeleteOracleDbGcpIdentityConnectorRequest();
            request.oracleDbGcpIdentityConnectorId = oracleDbGcpIdentityConnectorId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOracleDbGcpIdentityConnectorRequest(oracleDbGcpIdentityConnectorId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOracleDbGcpIdentityConnectorRequest)) {
            return false;
        }

        DeleteOracleDbGcpIdentityConnectorRequest other =
                (DeleteOracleDbGcpIdentityConnectorRequest) o;
