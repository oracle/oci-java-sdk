...
public class OracleDbAzureKeyClient extends com.oracle.bmc.http.internal.BaseSyncClient
        implements OracleDbAzureKey {
        ...
        public OracleDbAzureKeyClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new OracleDbAzureKeyClient(this, authenticationDetailsProvider, executorService);
        }
    }
