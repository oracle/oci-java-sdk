 ...
 * to any list operations of OracleDBAzureConnector where multiple pages of data may be fetched.
...
public class OracleDBAzureConnectorPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAzureConnectors operation. This iterable
    ...
    public Iterable<ListOracleDbAzureConnectorsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOracleDbAzureConnectorsRequest.Builder, ListOracleDbAzureConnectorsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureConnectorSummary} objects
     * contained in responses from the listOracleDbAzureConnectors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureConnectorSummary} objects
