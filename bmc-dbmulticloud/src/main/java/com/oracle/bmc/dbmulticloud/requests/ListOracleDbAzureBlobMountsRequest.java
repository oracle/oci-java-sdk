...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureBlobMountsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbAzureBlobMountsRequest.
 */
...
public class ListOracleDbAzureBlobMountsRequest
    ...
    public static class Builder
        ...
        public ListOracleDbAzureBlobMountsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOracleDbAzureBlobMountsRequest(compartmentId, displayName, oracleDbAzureBlobMountId, lifecycleState, oracleDbAzureBlobContainerId, oracleDbAzureConnectorId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
