...
/**
 * Replicate Oracle AWS Key resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ReplicateOracleDbAwsKeyDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ReplicateOracleDbAwsKeyDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"targetRegion", "action"})
    public ReplicateOracleDbAwsKeyDetails(String targetRegion, ReplicationActions action) {
        super();
    ...
    public static class Builder {
        ...
        public ReplicateOracleDbAwsKeyDetails build() {
            ReplicateOracleDbAwsKeyDetails model =
                    new ReplicateOracleDbAwsKeyDetails(this.targetRegion, this.action);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReplicateOracleDbAwsKeyDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicateOracleDbAwsKeyDetails)) {
            return false;
        }

        ReplicateOracleDbAwsKeyDetails other = (ReplicateOracleDbAwsKeyDetails) o;
