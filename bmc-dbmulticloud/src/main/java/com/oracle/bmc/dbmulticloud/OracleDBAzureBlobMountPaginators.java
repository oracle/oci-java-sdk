 ...
 * to any list operations of OracleDBAzureBlobMount where multiple pages of data may be fetched.
...
public class OracleDBAzureBlobMountPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAzureBlobMounts operation. This iterable
    ...
    public Iterable<ListOracleDbAzureBlobMountsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOracleDbAzureBlobMountsRequest.Builder, ListOracleDbAzureBlobMountsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureBlobMountSummary} objects
     * contained in responses from the listOracleDbAzureBlobMounts operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureBlobMountSummary} objects
