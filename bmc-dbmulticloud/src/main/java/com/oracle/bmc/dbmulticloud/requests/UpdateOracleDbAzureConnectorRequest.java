...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/UpdateOracleDbAzureConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOracleDbAzureConnectorRequest.
 */
...
public class UpdateOracleDbAzureConnectorRequest
    ...
    public static class Builder
        ...
        public UpdateOracleDbAzureConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOracleDbAzureConnectorRequest(oracleDbAzureConnectorId, updateOracleDbAzureConnectorDetails, ifMatch, opcRequestId);
        }
    }
