...
public class UpdateOracleDbGcpKeyRingConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateOracleDbGcpKeyRingConverter.class);

    public static com.oracle.bmc.dbmulticloud.requests.UpdateOracleDbGcpKeyRingRequest
            interceptRequest(
                    com.oracle.bmc.dbmulticloud.requests.UpdateOracleDbGcpKeyRingRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dbmulticloud.responses.UpdateOracleDbGcpKeyRingResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dbmulticloud.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dbmulticloud.responses.UpdateOracleDbGcpKeyRingResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dbmulticloud.responses
                                                .UpdateOracleDbGcpKeyRingResponse.Builder
                                        builder =
                                                com.oracle.bmc.dbmulticloud.responses
                                                        .UpdateOracleDbGcpKeyRingResponse.builder()
