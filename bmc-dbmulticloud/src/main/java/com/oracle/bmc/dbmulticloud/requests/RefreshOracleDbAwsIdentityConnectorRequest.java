...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbAwsIdentityConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshOracleDbAwsIdentityConnectorRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class RefreshOracleDbAwsIdentityConnectorRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RefreshOracleDbAwsIdentityConnectorRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RefreshOracleDbAwsIdentityConnectorRequest o) {
        ...
        /**
         * Build the instance of RefreshOracleDbAwsIdentityConnectorRequest as configured by this builder
         *
         ...
         *
         * @return instance of RefreshOracleDbAwsIdentityConnectorRequest
         */
        public RefreshOracleDbAwsIdentityConnectorRequest build() {
            RefreshOracleDbAwsIdentityConnectorRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RefreshOracleDbAwsIdentityConnectorRequest
         */
        public RefreshOracleDbAwsIdentityConnectorRequest buildWithoutInvocationCallback() {
            RefreshOracleDbAwsIdentityConnectorRequest request =
                    new RefreshOracleDbAwsIdentityConnectorRequest();
            request.oracleDbAwsIdentityConnectorId = oracleDbAwsIdentityConnectorId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new RefreshOracleDbAwsIdentityConnectorRequest(oracleDbAwsIdentityConnectorId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshOracleDbAwsIdentityConnectorRequest)) {
            return false;
        }

        RefreshOracleDbAwsIdentityConnectorRequest other =
                (RefreshOracleDbAwsIdentityConnectorRequest) o;
