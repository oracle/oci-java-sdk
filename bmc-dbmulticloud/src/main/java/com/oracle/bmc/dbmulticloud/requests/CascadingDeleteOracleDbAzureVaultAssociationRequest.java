...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/CascadingDeleteOracleDbAzureVaultAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CascadingDeleteOracleDbAzureVaultAssociationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class CascadingDeleteOracleDbAzureVaultAssociationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CascadingDeleteOracleDbAzureVaultAssociationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(CascadingDeleteOracleDbAzureVaultAssociationRequest o) {
        ...
        /**
         * Build the instance of CascadingDeleteOracleDbAzureVaultAssociationRequest as configured by this builder
         *
         ...
         *
         * @return instance of CascadingDeleteOracleDbAzureVaultAssociationRequest
         */
        public CascadingDeleteOracleDbAzureVaultAssociationRequest build() {
         ...
         * @return instance of CascadingDeleteOracleDbAzureVaultAssociationRequest
         */
        public CascadingDeleteOracleDbAzureVaultAssociationRequest
                buildWithoutInvocationCallback() {
            CascadingDeleteOracleDbAzureVaultAssociationRequest request =
                    new CascadingDeleteOracleDbAzureVaultAssociationRequest();
            request.oracleDbAzureVaultAssociationId = oracleDbAzureVaultAssociationId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new CascadingDeleteOracleDbAzureVaultAssociationRequest(oracleDbAzureVaultAssociationId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CascadingDeleteOracleDbAzureVaultAssociationRequest)) {
            return false;
        }

        CascadingDeleteOracleDbAzureVaultAssociationRequest other =
                (CascadingDeleteOracleDbAzureVaultAssociationRequest) o;
