...
public class OracleDBAzureBlobContainerPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAzureBlobContainers operation. This iterable
    ...
    public Iterable<ListOracleDbAzureBlobContainersResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                ListOracleDbAzureBlobContainersRequest, ListOracleDbAzureBlobContainersResponse>(
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureBlobContainerSummary} objects
     * contained in responses from the listOracleDbAzureBlobContainers operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureBlobContainerSummary} objects
