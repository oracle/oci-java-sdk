...
public class MultiCloudResourceDiscoveryClient implements MultiCloudResourceDiscovery {
    /**
     ...
     */
    protected MultiCloudResourceDiscoveryClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeMultiCloudResourceDiscoveryCompartmentResponse
        ...
        LOG.trace("Called changeMultiCloudResourceDiscoveryCompartment");
        final ChangeMultiCloudResourceDiscoveryCompartmentRequest interceptedRequest =
                ChangeMultiCloudResourceDiscoveryCompartmentConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeMultiCloudResourceDiscoveryCompartmentConverter.fromRequest(
        ...
        java.util.function.Function<
                ...
                transformer =
                        ChangeMultiCloudResourceDiscoveryCompartmentConverter.fromResponse(
    ...
    public CreateMultiCloudResourceDiscoveryResponse createMultiCloudResourceDiscovery(
        ...
        LOG.trace("Called createMultiCloudResourceDiscovery");
        final CreateMultiCloudResourceDiscoveryRequest interceptedRequest =
                CreateMultiCloudResourceDiscoveryConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateMultiCloudResourceDiscoveryConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, CreateMultiCloudResourceDiscoveryResponse>
                transformer =
                        CreateMultiCloudResourceDiscoveryConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getCreateMultiCloudResourceDiscoveryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteMultiCloudResourceDiscoveryResponse deleteMultiCloudResourceDiscovery(
        ...
        LOG.trace("Called deleteMultiCloudResourceDiscovery");
        final DeleteMultiCloudResourceDiscoveryRequest interceptedRequest =
                DeleteMultiCloudResourceDiscoveryConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteMultiCloudResourceDiscoveryConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, DeleteMultiCloudResourceDiscoveryResponse>
                transformer =
                        DeleteMultiCloudResourceDiscoveryConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public GetMultiCloudResourceDiscoveryResponse getMultiCloudResourceDiscovery(
        ...
        LOG.trace("Called getMultiCloudResourceDiscovery");
        final GetMultiCloudResourceDiscoveryRequest interceptedRequest =
                GetMultiCloudResourceDiscoveryConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetMultiCloudResourceDiscoveryConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, GetMultiCloudResourceDiscoveryResponse>
                transformer =
                        GetMultiCloudResourceDiscoveryConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListMultiCloudResourceDiscoveriesResponse listMultiCloudResourceDiscoveries(
        ...
        LOG.trace("Called listMultiCloudResourceDiscoveries");
        final ListMultiCloudResourceDiscoveriesRequest interceptedRequest =
                ListMultiCloudResourceDiscoveriesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListMultiCloudResourceDiscoveriesConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, ListMultiCloudResourceDiscoveriesResponse>
                transformer =
                        ListMultiCloudResourceDiscoveriesConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public UpdateMultiCloudResourceDiscoveryResponse updateMultiCloudResourceDiscovery(
        ...
        LOG.trace("Called updateMultiCloudResourceDiscovery");
        final UpdateMultiCloudResourceDiscoveryRequest interceptedRequest =
                UpdateMultiCloudResourceDiscoveryConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateMultiCloudResourceDiscoveryConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, UpdateMultiCloudResourceDiscoveryResponse>
                transformer =
                        UpdateMultiCloudResourceDiscoveryConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest
                                                        .getUpdateMultiCloudResourceDiscoveryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
