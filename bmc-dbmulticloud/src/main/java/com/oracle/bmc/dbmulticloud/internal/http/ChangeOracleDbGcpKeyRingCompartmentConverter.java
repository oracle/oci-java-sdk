...
public class ChangeOracleDbGcpKeyRingCompartmentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ChangeOracleDbGcpKeyRingCompartmentConverter.class);

    public static com.oracle.bmc.dbmulticloud.requests.ChangeOracleDbGcpKeyRingCompartmentRequest
            interceptRequest(
                    com.oracle.bmc.dbmulticloud.requests.ChangeOracleDbGcpKeyRingCompartmentRequest
                            request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getOracleDbGcpKeyRingId()))
                        .path("actions")
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dbmulticloud.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dbmulticloud.responses.ChangeOracleDbGcpKeyRingCompartmentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dbmulticloud.responses
                                                .ChangeOracleDbGcpKeyRingCompartmentResponse.Builder
                                        builder =
                                                com.oracle.bmc.dbmulticloud.responses
                                                        .ChangeOracleDbGcpKeyRingCompartmentResponse
                                                        .builder()
