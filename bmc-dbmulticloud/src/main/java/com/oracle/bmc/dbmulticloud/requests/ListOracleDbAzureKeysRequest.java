...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureKeysExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOracleDbAzureKeysRequest.
 */
...
public class ListOracleDbAzureKeysRequest
    ...
    public static class Builder
        ...
        public ListOracleDbAzureKeysRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOracleDbAzureKeysRequest(compartmentId, displayName, oracleDbAzureVaultId, oracleDbAzureKeyId, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
