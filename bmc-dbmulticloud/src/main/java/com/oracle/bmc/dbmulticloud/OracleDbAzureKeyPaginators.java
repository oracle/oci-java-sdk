 ...
 * to any list operations of OracleDbAzureKey where multiple pages of data may be fetched.
...
public class OracleDbAzureKeyPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOracleDbAzureKeys operation. This iterable
    ...
    public Iterable<ListOracleDbAzureKeysResponse> listOracleDbAzureKeysResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOracleDbAzureKeysRequest.Builder, ListOracleDbAzureKeysRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureKeySummary} objects
     * contained in responses from the listOracleDbAzureKeys operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.dbmulticloud.model.OracleDbAzureKeySummary} objects
