...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/CreateOracleDbAzureConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOracleDbAzureConnectorRequest.
 */
...
public class CreateOracleDbAzureConnectorRequest
    ...
    public static class Builder
        ...
        public CreateOracleDbAzureConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateOracleDbAzureConnectorRequest(createOracleDbAzureConnectorDetails, opcRetryToken, opcRequestId);
        }
    }
