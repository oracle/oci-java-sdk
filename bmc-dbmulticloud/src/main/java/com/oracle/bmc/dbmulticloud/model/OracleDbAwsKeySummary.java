...
/**
 * Oracle Oracle DB AWS Key Resource Summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDbAwsKeySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbAwsKeySummary
    ...
    public static class Builder {
         ...
         * new Oracle DB AWS Key resource.
         */
         ...
         * compartment contains Oracle DB AWS Key resource.
         */
         ...
         * @return this builder
         */
        public Builder lifecycleState(OracleDbAwsKey.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        /**
         * Time when the Oracle Oracle DB AWS Key resource was created in [RFC
        ...
        /**
         * Time when the Oracle Oracle DB AWS Key resource was last modified, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g.
         * '2020-05-23T21:10:29.600Z'.
         */
        ...
        public OracleDbAwsKeySummary build() {
            OracleDbAwsKeySummary model =
                    new OracleDbAwsKeySummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbAwsKeySummary model) {
     ...
     * @return the value
     */
    public OracleDbAwsKey.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDbAwsKeySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbAwsKeySummary)) {
            return false;
        }

        OracleDbAwsKeySummary other = (OracleDbAwsKeySummary) o;
