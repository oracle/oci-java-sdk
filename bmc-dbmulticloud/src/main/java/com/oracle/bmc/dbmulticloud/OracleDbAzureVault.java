...
public interface OracleDbAzureVault extends AutoCloseable {
     ...
     *     ChangeOracleDbAzureVaultCompartment API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/DeleteOracleDbAzureVaultExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     DeleteOracleDbAzureVault API.
     */
    DeleteOracleDbAzureVaultResponse deleteOracleDbAzureVault(
            DeleteOracleDbAzureVaultRequest request);

    /**
     * Retrieves detailed information about an Oracle Database Azure Vault resource using its unique
     * resource [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). This
     * operation returns metadata and configuration details associated with the specified vault
     * resource.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ListOracleDbAzureVaultsExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListOracleDbAzureVaults API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/RefreshOracleDbAzureVaultExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     RefreshOracleDbAzureVault API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/ReplicateOracleDbAzureVaultExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ReplicateOracleDbAzureVault API.
     */
    ReplicateOracleDbAzureVaultResponse replicateOracleDbAzureVault(
            ReplicateOracleDbAzureVaultRequest request);

    /**
     * Modifies the configuration details of an existing Oracle Database Azure Vault resource
     * identified by its unique
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). This operation
     * updates only the specified fields in the request body.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     * @throws BmcException when an error occurs. This operation uses
