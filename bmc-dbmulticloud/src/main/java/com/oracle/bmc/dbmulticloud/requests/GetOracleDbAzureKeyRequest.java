...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dbmulticloud/GetOracleDbAzureKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOracleDbAzureKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240501")
public class GetOracleDbAzureKeyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOracleDbAzureKeyRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOracleDbAzureKeyRequest o) {
        ...
        /**
         * Build the instance of GetOracleDbAzureKeyRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOracleDbAzureKeyRequest
         */
        public GetOracleDbAzureKeyRequest build() {
            GetOracleDbAzureKeyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOracleDbAzureKeyRequest
         */
        public GetOracleDbAzureKeyRequest buildWithoutInvocationCallback() {
            GetOracleDbAzureKeyRequest request = new GetOracleDbAzureKeyRequest();
            ...
            return request;
            // new GetOracleDbAzureKeyRequest(oracleDbAzureKeyId, limit, page, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOracleDbAzureKeyRequest)) {
            return false;
        }

        GetOracleDbAzureKeyRequest other = (GetOracleDbAzureKeyRequest) o;
