...
/**
 * This resource is used to create and manage a GCP Identity Connector for Oracle Database running
 * on Oracle Exadata Database Service on Dedicated Infrastructure (ExaDB-D). The Identity Connector
 * enables secure communication between Oracle Cloud and Google Cloud services. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleDbGcpIdentityConnector.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OracleDbGcpIdentityConnector
    ...
    public OracleDbGcpIdentityConnector(
            String id,
            String displayName,
    ...
    public static class Builder {
        ...
        private GcpIdentityConnectivityStatus gcpIdentityConnectivityStatus;
        ...
        public OracleDbGcpIdentityConnector build() {
            OracleDbGcpIdentityConnector model =
                    new OracleDbGcpIdentityConnector(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.issuerUrl,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleDbGcpIdentityConnector model) {
    ...
    /** The current Connectivity status of GCP Identity Connector resource. */
    public enum GcpIdentityConnectivityStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Connected("CONNECTED"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(GcpIdentityConnectivityStatus.class);

        private final String value;
        private static java.util.Map<String, GcpIdentityConnectivityStatus> map;

        static {
            map = new java.util.HashMap<>();
            for (GcpIdentityConnectivityStatus v : GcpIdentityConnectivityStatus.values()) {
        ...
        GcpIdentityConnectivityStatus(String value) {
            this.value = value;
        }
        ...
        public static GcpIdentityConnectivityStatus create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'GcpIdentityConnectivityStatus', returning UnknownEnumValue",
                    key);
    ...
    /** The current Connectivity status of GCP Identity Connector resource. */
    @com.fasterxml.jackson.annotation.JsonProperty("gcpIdentityConnectivityStatus")
    private final GcpIdentityConnectivityStatus gcpIdentityConnectivityStatus;
     ...
     * @return the value
     */
    public GcpIdentityConnectivityStatus getGcpIdentityConnectivityStatus() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleDbGcpIdentityConnector(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleDbGcpIdentityConnector)) {
            return false;
        }

        OracleDbGcpIdentityConnector other = (OracleDbGcpIdentityConnector) o;
