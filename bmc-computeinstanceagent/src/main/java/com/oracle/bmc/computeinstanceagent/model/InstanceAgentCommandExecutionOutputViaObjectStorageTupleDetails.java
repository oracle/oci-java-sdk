...
/**
 * The execution output from a command when saved to an Object Storage bucket. <br>
...
public final class InstanceAgentCommandExecutionOutputViaObjectStorageTupleDetails
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceAgentCommandExecutionOutputViaObjectStorageTupleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceAgentCommandExecutionOutputViaObjectStorageTupleDetails)) {
            return false;
        }

        InstanceAgentCommandExecutionOutputViaObjectStorageTupleDetails other =
                (InstanceAgentCommandExecutionOutputViaObjectStorageTupleDetails) o;
