...
public class CancelInstanceAgentCommandConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CancelInstanceAgentCommandConverter.class);

    public static com.oracle.bmc.computeinstanceagent.requests.CancelInstanceAgentCommandRequest
            interceptRequest(
                    com.oracle.bmc.computeinstanceagent.requests.CancelInstanceAgentCommandRequest
                            request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.computeinstanceagent.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.computeinstanceagent.responses.CancelInstanceAgentCommandResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.computeinstanceagent.responses
                                                .CancelInstanceAgentCommandResponse.Builder
                                        builder =
                                                com.oracle.bmc.computeinstanceagent.responses
                                                        .CancelInstanceAgentCommandResponse
                                                        .builder()
