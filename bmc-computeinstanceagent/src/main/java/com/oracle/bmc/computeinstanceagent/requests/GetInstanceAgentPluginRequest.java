...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/computeinstanceagent/GetInstanceAgentPluginExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetInstanceAgentPluginRequest.
 */
...
public class GetInstanceAgentPluginRequest
    ...
    public static class Builder
        ...
        public GetInstanceAgentPluginRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetInstanceAgentPluginRequest(instanceagentId, compartmentId, pluginName, opcRequestId);
        }
    }
