...
public class ListInstanceAgentCommandsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.computeinstanceagent.model.InstanceAgentCommandSummary>
            getItems() {
        return items;
    }
    ...
    private ListInstanceAgentCommandsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.computeinstanceagent.model.InstanceAgentCommandSummary>
                    items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListInstanceAgentCommandsResponse o) {
         ...
         */
        @Override
        public ListInstanceAgentCommandsResponse build() {
            return new ListInstanceAgentCommandsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInstanceAgentCommandsResponse)) {
            return false;
        }

        ListInstanceAgentCommandsResponse other = (ListInstanceAgentCommandsResponse) o;
