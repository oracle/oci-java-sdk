...
public interface PluginAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetInstanceAgentPluginResponse> getInstanceAgentPlugin(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListInstanceAgentPluginsResponse> listInstanceAgentPlugins(
