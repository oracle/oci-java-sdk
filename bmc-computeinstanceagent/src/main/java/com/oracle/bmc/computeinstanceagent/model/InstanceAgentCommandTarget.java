...
/**
 * The target instance that the command runs on. <br>
...
public final class InstanceAgentCommandTarget
    ...
    public static class Builder {
        ...
        public InstanceAgentCommandTarget build() {
            InstanceAgentCommandTarget model = new InstanceAgentCommandTarget(this.instanceId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceAgentCommandTarget model) {
