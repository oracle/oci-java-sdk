 ...
 * to any list operations of Plugin where multiple pages of data may be fetched. Two styles of
...
public class PluginPaginators {
     ...
     * listInstanceAgentPlugins operation. This iterable will fetch more data from the server as
     * needed.
     *
    ...
    public Iterable<ListInstanceAgentPluginsResponse> listInstanceAgentPluginsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Supplier<ListInstanceAgentPluginsRequest.Builder>() {
                    @Override
                    public ListInstanceAgentPluginsRequest.Builder get() {
                        return ListInstanceAgentPluginsRequest.builder().copy(request);
                    }
                },
                new java.util.function.Function<ListInstanceAgentPluginsResponse, String>() {
                    @Override
     ...
     * com.oracle.bmc.computeinstanceagent.model.InstanceAgentPluginSummary} objects contained in
     * responses from the listInstanceAgentPlugins operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.computeinstanceagent.model.InstanceAgentPluginSummary} objects contained
