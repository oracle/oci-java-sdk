...
public class GetInstanceAgentCommandResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder instanceAgentCommand(
                com.oracle.bmc.computeinstanceagent.model.InstanceAgentCommand
                        instanceAgentCommand) {
            this.instanceAgentCommand = instanceAgentCommand;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",instanceAgentCommand=").append(String.valueOf(instanceAgentCommand));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetInstanceAgentCommandResponse)) {
            return false;
        }

        GetInstanceAgentCommandResponse other = (GetInstanceAgentCommandResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.instanceAgentCommand, other.instanceAgentCommand);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.instanceAgentCommand == null
                                ? 43
                                : this.instanceAgentCommand.hashCode());
        return result;
    }
}
