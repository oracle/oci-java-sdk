...
public class ListInstanceAgentPluginsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.computeinstanceagent.model.InstanceAgentPluginSummary>
            getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInstanceAgentPluginsResponse)) {
            return false;
        }

        ListInstanceAgentPluginsResponse other = (ListInstanceAgentPluginsResponse) o;
