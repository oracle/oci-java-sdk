...
public class InstanceAgentCommandSourceDetails
     ...
     *
     * <p>- {@code TEXT} - uses a plain text command that is specified inline with the request. -
     * {@code OBJECT_STORAGE_URI} - imports a command from an Object Storage URL. - {@code
