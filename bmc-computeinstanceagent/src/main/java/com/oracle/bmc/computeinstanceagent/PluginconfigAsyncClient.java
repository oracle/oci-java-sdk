...
public class PluginconfigAsyncClient implements PluginconfigAsync {
    /**
    ...
    public static class Builder
        ...
        public PluginconfigAsyncClient build(
            ...
            return new PluginconfigAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<ListInstanceagentAvailablePluginsResponse>
            listInstanceagentAvailablePlugins(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listInstanceagentAvailablePlugins");
