...
public class PluginconfigClient implements Pluginconfig {
    ...
    public ListInstanceagentAvailablePluginsResponse listInstanceagentAvailablePlugins(
        ...
        LOG.trace("Called listInstanceagentAvailablePlugins");
        final ListInstanceagentAvailablePluginsRequest interceptedRequest =
