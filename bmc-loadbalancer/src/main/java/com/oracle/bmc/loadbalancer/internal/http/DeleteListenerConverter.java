...
public class DeleteListenerConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, DeleteListenerRequest request) {
        if (request == null) {
    ...
    public static Function<Response, DeleteListenerResponse> fromResponse() {
        final Function<Response, DeleteListenerResponse> transformer =
                new Function<Response, DeleteListenerResponse>() {
                    @Override
                    public DeleteListenerResponse apply(Response rawResponse) {
                        ...
                        DeleteListenerResponse.Builder builder = DeleteListenerResponse.builder();
