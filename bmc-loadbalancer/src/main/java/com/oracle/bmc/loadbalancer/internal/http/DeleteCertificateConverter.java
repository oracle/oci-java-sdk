...
@Slf4j
public class DeleteCertificateConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, DeleteCertificateRequest request) {
        if (request == null) {
        ...
        WebTarget target =
                client.getBaseTarget()
                        ...
                        .path("certificates")
                        .path(encodePathSegment(request.getCertificateName()));
    ...
    public static Function<Response, DeleteCertificateResponse> fromResponse() {
        final Function<Response, DeleteCertificateResponse> transformer =
                new Function<Response, DeleteCertificateResponse>() {
                    @Override
                    public DeleteCertificateResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for DeleteCertificateResponse");
