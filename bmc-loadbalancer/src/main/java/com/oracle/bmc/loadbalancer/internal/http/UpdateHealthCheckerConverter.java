...
public class UpdateHealthCheckerConverter {
    ...
    public static UpdateHealthCheckerRequest interceptRequest(UpdateHealthCheckerRequest request) {

        return request;
    }

    public static Invocation.Builder fromRequest(
            RestClient client, UpdateHealthCheckerRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdateHealthCheckerResponse> fromResponse() {
        final Function<Response, UpdateHealthCheckerResponse> transformer =
                new Function<Response, UpdateHealthCheckerResponse>() {
                    @Override
                    public UpdateHealthCheckerResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for UpdateHealthCheckerResponse");
                        ...
                        UpdateHealthCheckerResponse.Builder builder =
                        ...
                        UpdateHealthCheckerResponse responseWrapper = builder.build();
