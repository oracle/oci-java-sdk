 ...
 * Work](https://docs.oracle.com/iaas/Content/Balance/Reference/lbpolicies.htm). <br>
...
public final class LoadBalancerPolicy
    ...
    public static class Builder {
        ...
        public LoadBalancerPolicy build() {
            LoadBalancerPolicy model = new LoadBalancerPolicy(this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LoadBalancerPolicy model) {
