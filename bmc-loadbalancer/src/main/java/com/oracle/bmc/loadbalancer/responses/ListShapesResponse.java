...
public class ListShapesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.loadbalancer.model.LoadBalancerShape} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.loadbalancer.model.LoadBalancerShape> getItems() {
        return items;
    }
    ...
    private ListShapesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.loadbalancer.model.LoadBalancerShape> items) {
