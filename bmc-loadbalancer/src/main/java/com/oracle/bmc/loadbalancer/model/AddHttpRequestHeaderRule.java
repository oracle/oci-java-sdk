 ...
 *
 * <p>If a matching header already exists in the request, the system removes all of its occurrences,
 * and then adds the new header.
 *
...
public final class AddHttpRequestHeaderRule extends Rule {
    ...
    public static class Builder {
        ...
        public AddHttpRequestHeaderRule build() {
            AddHttpRequestHeaderRule model = new AddHttpRequestHeaderRule(this.header, this.value);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddHttpRequestHeaderRule model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddHttpRequestHeaderRule(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddHttpRequestHeaderRule)) {
            return false;
        }

        AddHttpRequestHeaderRule other = (AddHttpRequestHeaderRule) o;
