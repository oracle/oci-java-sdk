...
public final class CreateLoadBalancerDetails
    ...
    public static class Builder {
        ...
        /**
         * The configuration details to create load balancer using Flexible shape. This is required
         * only if shapeName is {@code Flexible}.
         */
         ...
         * specified NSGs.
         *
         * <p>The benefits of using NSGs with the load balancer include:
         *
         ...
         *
         * <p>Example: {@code ["ocid1.nsg.oc1.phx.unique_ID"]}
         */
