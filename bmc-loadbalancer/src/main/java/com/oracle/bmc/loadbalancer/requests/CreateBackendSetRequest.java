...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/CreateBackendSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBackendSetRequest.
 */
...
public class CreateBackendSetRequest
    ...
    public com.oracle.bmc.loadbalancer.model.CreateBackendSetDetails getBody$() {
        return createBackendSetDetails;
    }
    ...
    public static class Builder
        ...
        public Builder createBackendSetDetails(
                com.oracle.bmc.loadbalancer.model.CreateBackendSetDetails createBackendSetDetails) {
        ...
        public CreateBackendSetRequest build() {
            CreateBackendSetRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.loadbalancer.model.CreateBackendSetDetails body) {
        ...
        public CreateBackendSetRequest buildWithoutInvocationCallback() {
            CreateBackendSetRequest request = new CreateBackendSetRequest();
            request.createBackendSetDetails = createBackendSetDetails;
            request.loadBalancerId = loadBalancerId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateBackendSetRequest(createBackendSetDetails, loadBalancerId, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBackendSetRequest)) {
            return false;
        }

        CreateBackendSetRequest other = (CreateBackendSetRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createBackendSetDetails, other.createBackendSetDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createBackendSetDetails == null
                                ? 43
                                : this.createBackendSetDetails.hashCode());
        result =
                (result * PRIME)
