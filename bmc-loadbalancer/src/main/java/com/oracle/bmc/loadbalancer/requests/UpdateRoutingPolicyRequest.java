...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/UpdateRoutingPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateRoutingPolicyRequest.
 */
...
public class UpdateRoutingPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateRoutingPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateRoutingPolicyRequest(updateRoutingPolicyDetails, loadBalancerId, routingPolicyName, opcRequestId, ifMatch, opcRetryToken);
        }
    }
