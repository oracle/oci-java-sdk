...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/CreateHostnameExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateHostnameRequest.
 */
...
public class CreateHostnameRequest
    ...
    public static class Builder
        ...
        public CreateHostnameRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateHostnameRequest(createHostnameDetails, loadBalancerId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
