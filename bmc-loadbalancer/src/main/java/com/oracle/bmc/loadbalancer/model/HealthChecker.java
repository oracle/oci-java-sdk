 ...
 * Policies](https://docs.oracle.com/iaas/Content/Balance/Tasks/editinghealthcheck.htm). <br>
...
public final class HealthChecker extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * policy to use the HTTP protocol, you can use common HTTP status codes such as "200".
         *
         * <p>Example: {@code 200}
         */
         ...
         * number also applies when recovering a server to the "healthy" state. Defaults to 3.
         *
         * <p>Example: {@code 3}
         */
         ...
         * is successful only if a reply returns within this timeout period. Defaults to 3000 (3
         * seconds).
         *
         * <p>Example: {@code 3000}
         */
     ...
     * successful only if a reply returns within this timeout period. Defaults to 3000 (3 seconds).
     *
     * <p>Example: {@code 3000}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeoutInMillis")
