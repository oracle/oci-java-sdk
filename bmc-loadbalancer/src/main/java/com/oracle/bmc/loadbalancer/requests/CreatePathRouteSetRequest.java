...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/CreatePathRouteSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePathRouteSetRequest.
 */
...
public class CreatePathRouteSetRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreatePathRouteSetRequest o) {
            createPathRouteSetDetails(o.getCreatePathRouteSetDetails());
         ...
         */
        public CreatePathRouteSetRequest build() {
            CreatePathRouteSetRequest request = buildWithoutInvocationCallback();
