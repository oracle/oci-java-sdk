...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/CreateRoutingPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateRoutingPolicyRequest.
 */
...
public class CreateRoutingPolicyRequest
     ...
     * The details of the routing policy rules to add.
     */
    public com.oracle.bmc.loadbalancer.model.CreateRoutingPolicyDetails
    ...
    public static class Builder
         ...
         * The details of the routing policy rules to add.
         */
        private com.oracle.bmc.loadbalancer.model.CreateRoutingPolicyDetails
                createRoutingPolicyDetails = null;

        /**
         * The details of the routing policy rules to add.
         * @param createRoutingPolicyDetails the value to set
         * @return this builder instance
         */
        public Builder createRoutingPolicyDetails(
                com.oracle.bmc.loadbalancer.model.CreateRoutingPolicyDetails
                        createRoutingPolicyDetails) {
            this.createRoutingPolicyDetails = createRoutingPolicyDetails;
            return this;
        }
         ...
         * @return instance of CreateRoutingPolicyRequest
         */
        public CreateRoutingPolicyRequest buildWithoutInvocationCallback() {
            CreateRoutingPolicyRequest request = new CreateRoutingPolicyRequest();
            request.createRoutingPolicyDetails = createRoutingPolicyDetails;
            request.loadBalancerId = loadBalancerId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new CreateRoutingPolicyRequest(createRoutingPolicyDetails, loadBalancerId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createRoutingPolicyDetails=")
                .append(String.valueOf(this.createRoutingPolicyDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRoutingPolicyRequest)) {
            return false;
        }

        CreateRoutingPolicyRequest other = (CreateRoutingPolicyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createRoutingPolicyDetails, other.createRoutingPolicyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createRoutingPolicyDetails == null
                                ? 43
                                : this.createRoutingPolicyDetails.hashCode());
        result =
                (result * PRIME)
