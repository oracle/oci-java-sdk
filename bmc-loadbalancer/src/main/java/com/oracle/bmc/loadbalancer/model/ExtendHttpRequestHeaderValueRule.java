...
/**
 * An object that represents the action of modifying a request header value. This rule applies only
 * to HTTP listeners.
 *
...
public final class ExtendHttpRequestHeaderValueRule extends Rule {
    ...
    public static class Builder {
        ...
        /**
         * A string to prepend to the header value. The resulting header value must conform to RFC
         * 7230. With the following exceptions: * value cannot contain {@code $} * value cannot
        ...
        /**
         * A string to append to the header value. The resulting header value must conform to RFC
         * 7230. With the following exceptions: * value cannot contain {@code $} * value cannot
         * contain patterns like {@code {variable_name}}. They are reserved for future extensions.
         * Currently, such values are invalid.
         *
     ...
     * With the following exceptions: * value cannot contain {@code $} * value cannot contain
