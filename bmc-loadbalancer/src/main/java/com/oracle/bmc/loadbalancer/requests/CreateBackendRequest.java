...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/CreateBackendExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBackendRequest.
 */
...
public class CreateBackendRequest
    ...
    public static class Builder
        ...
        public CreateBackendRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateBackendRequest(createBackendDetails, loadBalancerId, backendSetName, opcRequestId, ifMatch, opcRetryToken);
        }
    }
