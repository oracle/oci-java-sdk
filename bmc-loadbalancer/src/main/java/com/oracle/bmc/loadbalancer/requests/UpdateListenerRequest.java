...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/UpdateListenerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateListenerRequest.
 */
...
public class UpdateListenerRequest
    ...
    public static class Builder
        ...
        public Builder updateListenerDetails(
                com.oracle.bmc.loadbalancer.model.UpdateListenerDetails updateListenerDetails) {
        ...
        public UpdateListenerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateListenerRequest(updateListenerDetails, loadBalancerId, listenerName, opcRequestId, opcRetryToken, ifMatch);
        }
    }
