...
public class ListPoliciesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.loadbalancer.model.LoadBalancerPolicy} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.loadbalancer.model.LoadBalancerPolicy> getItems() {
        return items;
    }
    ...
    private ListPoliciesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.loadbalancer.model.LoadBalancerPolicy> items) {
