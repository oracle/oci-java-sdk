...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.loadbalancer.model.WorkRequest} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.loadbalancer.model.WorkRequest> getItems() {
        return items;
    }
    ...
    private ListWorkRequestsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.loadbalancer.model.WorkRequest> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.loadbalancer.model.WorkRequest> items) {
            this.items = items;
            return this;
        }
