...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/DeleteRoutingPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRoutingPolicyRequest.
 */
...
public class DeleteRoutingPolicyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteRoutingPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteRoutingPolicyRequest(loadBalancerId, routingPolicyName, opcRequestId, ifMatch);
        }
    }
