...
public class UpdateLoadBalancerResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateLoadBalancerResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateLoadBalancerResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLoadBalancerResponse)) {
            return false;
        }

        UpdateLoadBalancerResponse other = (UpdateLoadBalancerResponse) o;
