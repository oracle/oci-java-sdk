...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/DeletePathRouteSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePathRouteSetRequest.
 */
...
public class DeletePathRouteSetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeletePathRouteSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeletePathRouteSetRequest(loadBalancerId, pathRouteSetName, opcRequestId, ifMatch);
        }
    }
