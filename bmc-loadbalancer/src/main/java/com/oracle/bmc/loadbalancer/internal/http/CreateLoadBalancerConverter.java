...
public class CreateLoadBalancerConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, CreateLoadBalancerRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateLoadBalancerResponse> fromResponse() {
        final Function<Response, CreateLoadBalancerResponse> transformer =
                new Function<Response, CreateLoadBalancerResponse>() {
                    @Override
                    public CreateLoadBalancerResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateLoadBalancerResponse");
