...
public final class CreateSSLCipherSuiteDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "ciphers"})
    public CreateSSLCipherSuiteDetails(String name, java.util.List<String> ciphers) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public CreateSSLCipherSuiteDetails build() {
            CreateSSLCipherSuiteDetails model =
                    new CreateSSLCipherSuiteDetails(this.name, this.ciphers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSSLCipherSuiteDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSSLCipherSuiteDetails)) {
            return false;
        }

        CreateSSLCipherSuiteDetails other = (CreateSSLCipherSuiteDetails) o;
