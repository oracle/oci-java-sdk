...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/GetRoutingPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetRoutingPolicyRequest.
 */
...
public class GetRoutingPolicyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetRoutingPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetRoutingPolicyRequest(loadBalancerId, routingPolicyName, opcRequestId, ifMatch);
        }
    }
