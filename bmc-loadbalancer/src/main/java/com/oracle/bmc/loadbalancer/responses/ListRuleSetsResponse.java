...
public class ListRuleSetsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.loadbalancer.model.RuleSet> getItems() {
        return items;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListRuleSetsResponse> {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.loadbalancer.model.RuleSet> items) {
            this.items = items;
            return this;
        }
        ...
        public ListRuleSetsResponse build() {
            return new ListRuleSetsResponse(__httpStatusCode__, headers, opcRequestId, eTag, items);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRuleSetsResponse)) {
            return false;
        }

        ListRuleSetsResponse other = (ListRuleSetsResponse) o;
