...
public class ListBackendSetsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.loadbalancer.model.BackendSet> items) {
            this.items = items;
            return this;
        }
        ...
        public ListBackendSetsResponse build() {
            return new ListBackendSetsResponse(__httpStatusCode__, opcRequestId, items);
        }
    }
