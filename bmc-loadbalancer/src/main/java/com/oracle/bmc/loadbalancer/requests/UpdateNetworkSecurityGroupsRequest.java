...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/UpdateNetworkSecurityGroupsExample.java.html"
...
public class UpdateNetworkSecurityGroupsRequest
     ...
     * balancer to update the NSGs for.
     */
    ...
    public static class Builder
        ...
        public Builder updateNetworkSecurityGroupsDetails(
                com.oracle.bmc.loadbalancer.model.UpdateNetworkSecurityGroupsDetails
                        updateNetworkSecurityGroupsDetails) {
            this.updateNetworkSecurityGroupsDetails = updateNetworkSecurityGroupsDetails;
            return this;
        }
        ...
        public Builder copy(UpdateNetworkSecurityGroupsRequest o) {
            updateNetworkSecurityGroupsDetails(o.getUpdateNetworkSecurityGroupsDetails());
         ...
         */
        public UpdateNetworkSecurityGroupsRequest build() {
            UpdateNetworkSecurityGroupsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of UpdateNetworkSecurityGroupsRequest
         */
        public UpdateNetworkSecurityGroupsRequest buildWithoutInvocationCallback() {
            UpdateNetworkSecurityGroupsRequest request = new UpdateNetworkSecurityGroupsRequest();
            request.updateNetworkSecurityGroupsDetails = updateNetworkSecurityGroupsDetails;
            request.loadBalancerId = loadBalancerId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateNetworkSecurityGroupsRequest(updateNetworkSecurityGroupsDetails,
            // loadBalancerId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateNetworkSecurityGroupsDetails=")
                .append(String.valueOf(this.updateNetworkSecurityGroupsDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNetworkSecurityGroupsRequest)) {
            return false;
        }

        UpdateNetworkSecurityGroupsRequest other = (UpdateNetworkSecurityGroupsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.updateNetworkSecurityGroupsDetails,
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateNetworkSecurityGroupsDetails == null
                                ? 43
                                : this.updateNetworkSecurityGroupsDetails.hashCode());
        result =
                (result * PRIME)
