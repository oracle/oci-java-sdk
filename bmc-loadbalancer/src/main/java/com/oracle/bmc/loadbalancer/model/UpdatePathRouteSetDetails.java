...
/**
 * An updated set of path route rules that overwrites the existing set of rules. <br>
...
public final class UpdatePathRouteSetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"pathRoutes"})
    public UpdatePathRouteSetDetails(java.util.List<PathRoute> pathRoutes) {
        super();
    ...
    public static class Builder {
        ...
        public UpdatePathRouteSetDetails build() {
            UpdatePathRouteSetDetails model = new UpdatePathRouteSetDetails(this.pathRoutes);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePathRouteSetDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePathRouteSetDetails)) {
            return false;
        }

        UpdatePathRouteSetDetails other = (UpdatePathRouteSetDetails) o;
