...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/GetBackendHealthExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBackendHealthRequest.
 */
...
public class GetBackendHealthRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetBackendHealthRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetBackendHealthRequest(loadBalancerId, backendSetName, backendName, opcRequestId);
        }
    }
