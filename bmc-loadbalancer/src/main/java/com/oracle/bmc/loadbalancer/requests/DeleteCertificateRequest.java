...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/DeleteCertificateExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCertificateRequest.
 */
...
public class DeleteCertificateRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * balancer associated with the certificate bundle to be deleted.
     */
    ...
    public static class Builder
         ...
         * load balancer associated with the certificate bundle to be deleted.
         */
        ...
        public DeleteCertificateRequest buildWithoutInvocationCallback() {
            ...
            request.certificateName = certificateName;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteCertificateRequest(loadBalancerId, certificateName, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCertificateRequest)) {
            return false;
        }

        DeleteCertificateRequest other = (DeleteCertificateRequest) o;
