...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/GetPathRouteSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPathRouteSetRequest.
 */
...
public class GetPathRouteSetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetPathRouteSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetPathRouteSetRequest(loadBalancerId, pathRouteSetName, opcRequestId, ifMatch);
        }
    }
