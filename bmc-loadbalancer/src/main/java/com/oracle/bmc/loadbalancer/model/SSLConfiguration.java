 ...
 *
 * <p>To use SSL, a listener must be associated with a {@link Certificate}.
 *
...
public final class SSLConfiguration
    ...
    public static class Builder {
         ...
         *
         * <p>*Note:** This configuration is applicable only when the load balancer is acting as an
         * SSL/HTTPS server. This field is ignored when the {@code SSLConfiguration} object is
         * associated with a backend set.
         */
         ...
         *
         * <p>If this field is not specified, the default is {@code
         * oci-default-ssl-cipher-suite-v1}.
         *
         * <p>*Notes:**
         *
         * <p>You must ensure compatibility between the specified SSL protocols and the ciphers
         * configured in the cipher suite. Clients cannot perform an SSL handshake if there is an
         * incompatible configuration. * You must ensure compatibility between the ciphers
         * configured in the cipher suite and the configured certificates. For example, RSA-based
         * ciphers require RSA certificates and ECDSA-based ciphers require ECDSA certificates. * If
         * the cipher configuration is not modified after load balancer creation, the {@code GET}
         * operation returns {@code oci-default-ssl-cipher-suite-v1} as the value of this field in
         * the SSL configuration for existing listeners that predate this feature. * If the cipher
         * configuration was modified using Oracle operations after load balancer creation, the
         * {@code GET} operation returns {@code oci-customized-ssl-cipher-suite} as the value of
         * this field in the SSL configuration for existing listeners that predate this feature. *
         * The {@code GET} operation returns {@code oci-wider-compatible-ssl-cipher-suite-v1} as the
         * value of this field in the SSL configuration for existing backend sets that predate this
         * feature. * If the {@code GET} operation on a listener returns {@code
         * oci-customized-ssl-cipher-suite} as the value of this field, you must specify an
         * appropriate predefined or custom cipher suite name when updating the resource. * The
         * {@code oci-customized-ssl-cipher-suite} Oracle reserved cipher suite name is not accepted
         * as valid input for this field.
         *
         ...
         *
         * <p>The load balancer uses SSL protocols to establish a secure connection between a client
         * and a server. A secure connection ensures that all data passed between the client and the
         * server is private.
         *
         ...
         *
         * <p>*Warning:** All SSL listeners created on a given port must use the same set of SSL
         * protocols.
         *
         * <p>*Notes:**
         *
         * <p>The handshake to establish an SSL connection fails if the client supports none of the
         * specified protocols. * You must ensure compatibility between the specified SSL protocols
         * and the ciphers configured in the cipher suite. * For all existing load balancer
         * listeners and backend sets that predate this feature, the {@code GET} operation displays
         * a list of SSL protocols currently used by those resources.
         *
         * <p>example: {@code ["TLSv1.1", "TLSv1.2"]}
         */
     ...
     * associated with a backend set.
     */
    public enum ServerOrderPreference implements com.oracle.bmc.http.internal.BmcEnum {
        Enabled("ENABLED"),
        Disabled("DISABLED"),
     ...
     * The name of the cipher suite to use for HTTPS or SSL connections.
     *
     * <p>If this field is not specified, the default is {@code oci-default-ssl-cipher-suite-v1}.
     *
     * <p>*Notes:**
     *
     * <p>You must ensure compatibility between the specified SSL protocols and the ciphers
     * configured in the cipher suite. Clients cannot perform an SSL handshake if there is an
     * incompatible configuration. * You must ensure compatibility between the ciphers configured in
     * the cipher suite and the configured certificates. For example, RSA-based ciphers require RSA
     * certificates and ECDSA-based ciphers require ECDSA certificates. * If the cipher
     * configuration is not modified after load balancer creation, the {@code GET} operation returns
     * {@code oci-default-ssl-cipher-suite-v1} as the value of this field in the SSL configuration
     * for existing listeners that predate this feature. * If the cipher configuration was modified
     * using Oracle operations after load balancer creation, the {@code GET} operation returns
     * {@code oci-customized-ssl-cipher-suite} as the value of this field in the SSL configuration
     * for existing listeners that predate this feature. * The {@code GET} operation returns {@code
     * oci-wider-compatible-ssl-cipher-suite-v1} as the value of this field in the SSL configuration
     * for existing backend sets that predate this feature. * If the {@code GET} operation on a
     * listener returns {@code oci-customized-ssl-cipher-suite} as the value of this field, you must
     * specify an appropriate predefined or custom cipher suite name when updating the resource. *
     * The {@code oci-customized-ssl-cipher-suite} Oracle reserved cipher suite name is not accepted
     * as valid input for this field.
     *
     * <p>example: {@code example_cipher_suite}
     */
     ...
     * A list of SSL protocols the load balancer must support for HTTPS or SSL connections.
     *
     * <p>The load balancer uses SSL protocols to establish a secure connection between a client and
     * a server. A secure connection ensures that all data passed between the client and the server
     * is private.
     *
     * <p>The Load Balancing service supports the following protocols:
     *
     ...
     *
     * <p>The handshake to establish an SSL connection fails if the client supports none of the
     * specified protocols. * You must ensure compatibility between the specified SSL protocols and
     * the ciphers configured in the cipher suite. * For all existing load balancer listeners and
     * backend sets that predate this feature, the {@code GET} operation displays a list of SSL
     * protocols currently used by those resources.
     *
     * <p>example: {@code ["TLSv1.1", "TLSv1.2"]}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("protocols")
