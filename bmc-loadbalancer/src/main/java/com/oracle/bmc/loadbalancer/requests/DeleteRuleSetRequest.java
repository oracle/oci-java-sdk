...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/DeleteRuleSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRuleSetRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20170115")
public class DeleteRuleSetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteRuleSetRequest, java.lang.Void> {
        ...
        public DeleteRuleSetRequest buildWithoutInvocationCallback() {
            DeleteRuleSetRequest request = new DeleteRuleSetRequest();
            request.loadBalancerId = loadBalancerId;
            request.ruleSetName = ruleSetName;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteRuleSetRequest(loadBalancerId, ruleSetName, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRuleSetRequest)) {
            return false;
        }

        DeleteRuleSetRequest other = (DeleteRuleSetRequest) o;
