 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateHostnameRequest.
 */
...
public class UpdateHostnameRequest
     ...
     * balancer associated with the virtual hostname to update.
     */
    ...
    public static class Builder
         ...
         * load balancer associated with the virtual hostname to update.
         */
