...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loadbalancer/DeleteListenerExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteListenerRequest.
 */
...
public class DeleteListenerRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * balancer associated with the listener to delete.
     */
    ...
    public static class Builder
        ...
        public DeleteListenerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteListenerRequest(loadBalancerId, listenerName, opcRequestId, ifMatch);
        }
    }
