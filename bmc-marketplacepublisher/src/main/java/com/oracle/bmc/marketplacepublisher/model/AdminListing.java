...
/**
 * The model for the Admin Marketplace Publisher listing. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AdminListing.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdminListing extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public AdminListing(
            ...
            java.util.List<ListingPart> parts,
    ...
    public static class Builder {
         ...
         * <p>For example:
         *
         * <p>{@code {"listingRevisionStatus": "Published","listingRevision": "1" }}
         */
        ...
        private java.util.List<ListingPart> parts;

        /**
         * List of parts provider by marketplace admin.
         *
         * @param parts the value to set
         * @return this builder
         */
        public Builder parts(java.util.List<ListingPart> parts) {
            this.parts = parts;
            this.__explicitlySet__.add("parts");
            return this;
        }
        /**
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminListing model) {
            ...
            if (model.wasPropertyExplicitlySet("parts")) {
    ...
    /** List of parts provider by marketplace admin. */
    @com.fasterxml.jackson.annotation.JsonProperty("parts")
    private final java.util.List<ListingPart> parts;
     ...
     * @return the value
     */
    public java.util.List<ListingPart> getParts() {
        return parts;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", parts=").append(String.valueOf(this.parts));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminListing)) {
            return false;
        }

        AdminListing other = (AdminListing) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.parts, other.parts)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.parts == null ? 43 : this.parts.hashCode());
