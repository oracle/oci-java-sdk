...
public class UpdateListingRevisionBannerContentResponse
    ...
    private UpdateListingRevisionBannerContentResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateListingRevisionBannerContentResponse o) {
         ...
         */
        public UpdateListingRevisionBannerContentResponse build() {
            return new UpdateListingRevisionBannerContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionBannerContentResponse)) {
            return false;
        }

        UpdateListingRevisionBannerContentResponse other =
                (UpdateListingRevisionBannerContentResponse) o;
