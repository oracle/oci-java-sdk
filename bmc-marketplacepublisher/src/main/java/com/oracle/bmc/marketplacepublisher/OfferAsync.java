...
public interface OfferAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateOfferResponse> createOffer(
            CreateOfferRequest request,
            com.oracle.bmc.responses.AsyncHandler<CreateOfferRequest, CreateOfferResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOfferResponse> deleteOffer(
            DeleteOfferRequest request,
            com.oracle.bmc.responses.AsyncHandler<DeleteOfferRequest, DeleteOfferResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetOfferResponse> getOffer(
            GetOfferRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetOfferRequest, GetOfferResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetOfferInternalDetailResponse> getOfferInternalDetail(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListOffersResponse> listOffers(
