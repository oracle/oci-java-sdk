...
public class GenerateCustomerInstanceReportExportConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GenerateCustomerInstanceReportExportConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplacepublisher.requests.GenerateCustomerInstanceReportExportRequest
                    request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GenerateCustomerInstanceReportExportResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                java.util.Optional<java.util.List<String>> exportIdentifierHeader =
                                        com.oracle.bmc.http.internal.HeaderUtils.getHeadersWithName(
                                                headers, "exportIdentifier");
                                if (exportIdentifierHeader.isPresent()) {
                                    builder.exportIdentifier(
                                            com.oracle.bmc.http.internal.HeaderUtils.toValue(
                                                    "exportIdentifier",
                                                    exportIdentifierHeader.get().get(0),
                                                    String.class));
                                }
