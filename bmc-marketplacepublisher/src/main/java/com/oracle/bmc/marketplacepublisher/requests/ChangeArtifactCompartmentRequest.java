...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ChangeArtifactCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeArtifactCompartmentRequest.
 */
...
public class ChangeArtifactCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeArtifactCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeArtifactCompartmentRequest(artifactId, changeArtifactCompartmentDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
