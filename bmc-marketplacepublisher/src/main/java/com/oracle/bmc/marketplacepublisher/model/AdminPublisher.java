...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AdminPublisher.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AdminPublisher extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public AdminPublisher(
        ...
        this.uploadOsParUrl = uploadOsParUrl;
        this.id = id;
    ...
    public static class Builder {
         ...
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("uploadOsParUrl")
        private String uploadOsParUrl;

        /**
         * upload access object storage par url
         * @param uploadOsParUrl the value to set
         * @return this builder
         **/
        public Builder uploadOsParUrl(String uploadOsParUrl) {
            this.uploadOsParUrl = uploadOsParUrl;
            this.__explicitlySet__.add("uploadOsParUrl");
            return this;
        }
        /**
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminPublisher model) {
            ...
            if (model.wasPropertyExplicitlySet("uploadOsParUrl")) {
                this.uploadOsParUrl(model.getUploadOsParUrl());
            }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("uploadOsParUrl")
    private final String uploadOsParUrl;

    /**
     * upload access object storage par url
     * @return the value
     **/
    public String getUploadOsParUrl() {
        return uploadOsParUrl;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", uploadOsParUrl=").append(String.valueOf(this.uploadOsParUrl));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminPublisher)) {
            return false;
        }

        AdminPublisher other = (AdminPublisher) o;
        return java.util.Objects.equals(this.publisherStatus, other.publisherStatus)
                ...
                && java.util.Objects.equals(this.uploadOsParUrl, other.uploadOsParUrl)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.uploadOsParUrl == null ? 43 : this.uploadOsParUrl.hashCode());
