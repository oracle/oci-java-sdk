...
public final class PricingRate extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"billingCurrency", "rate"})
    public PricingRate(String billingCurrency, Float rate) {
        super();
    ...
    public static class Builder {
        ...
        /**
         * The currency supported, in the format specified by ISO-4217
         * @param billingCurrency the value to set
         * @return this builder
         **/
        public Builder billingCurrency(String billingCurrency) {
            this.billingCurrency = billingCurrency;
            this.__explicitlySet__.add("billingCurrency");
            return this;
        }
        /**
        ...
        public PricingRate build() {
            PricingRate model = new PricingRate(this.billingCurrency, this.rate);
        ...
        public Builder copy(PricingRate model) {
            if (model.wasPropertyExplicitlySet("billingCurrency")) {
                this.billingCurrency(model.getBillingCurrency());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("billingCurrency=").append(String.valueOf(this.billingCurrency));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.billingCurrency, other.billingCurrency)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.billingCurrency == null ? 43 : this.billingCurrency.hashCode());
