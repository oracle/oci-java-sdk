...
public class GetSupportDocContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetSupportDocContentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSupportDocContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetSupportDocContentResponse o) {
         ...
         */
        @Override
        public GetSupportDocContentResponse build() {
            return new GetSupportDocContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSupportDocContentResponse)) {
            return false;
        }

        GetSupportDocContentResponse other = (GetSupportDocContentResponse) o;
