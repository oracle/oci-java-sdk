...
public class GetAttachmentContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetAttachmentContentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAttachmentContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetAttachmentContentResponse o) {
         ...
         */
        @Override
        public GetAttachmentContentResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAttachmentContentResponse)) {
            return false;
        }

        GetAttachmentContentResponse other = (GetAttachmentContentResponse) o;
