...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = AdminListingRevision.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = AdminServiceListingRevision.class,
        name = "SERVICE"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = AdminAiAgentListingRevision.class,
        name = "AI_AGENT"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = AdminOciListingRevision.class,
        name = "OCI_APPLICATION"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = AdminLeadGenListingRevision.class,
        name = "LEAD_GENERATION"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class AdminListingRevision extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected AdminListingRevision(
            String id,
            String legacyId,
            String listingId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminListingRevision(");
        ...
        sb.append(", approverEmail=").append(String.valueOf(this.approverEmail));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminListingRevision)) {
            return false;
        }

        AdminListingRevision other = (AdminListingRevision) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.approverEmail, other.approverEmail)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.approverEmail == null ? 43 : this.approverEmail.hashCode());
