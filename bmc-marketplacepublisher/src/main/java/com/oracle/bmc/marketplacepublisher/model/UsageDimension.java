...
/**
 * Usage dimension for usage-based or hybrid SaaS pricing. <br>
...
public final class UsageDimension
    ...
    public static class Builder {
        /**
         * Server-generated unique identifier for the usage dimension. If omitted in the request, it
    ...
    /**
     * Server-generated unique identifier for the usage dimension. If omitted in the request, it is
    ...
    /** Billing frequency used for the dimension. */
    public enum DimensionBillingFrequency implements com.oracle.bmc.http.internal.BmcEnum {
        Monthly("MONTHLY"),
        Quarterly("QUARTERLY"),
