...
public class UpdateArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateArtifactResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateArtifactResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateArtifactResponse)) {
            return false;
        }

        UpdateArtifactResponse other = (UpdateArtifactResponse) o;
