...
/**
 * The model for a summary of a listing revision notes. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ListingRevisionNoteSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ListingRevisionNoteSummary
    ...
    public ListingRevisionNoteSummary(
            String id,
    ...
    public static class Builder {
        ...
        private ListingRevisionNote.NoteSource noteSource;
         ...
         * @return this builder
         */
        public Builder noteSource(ListingRevisionNote.NoteSource noteSource) {
            this.noteSource = noteSource;
        ...
        private ListingRevisionNote.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(ListingRevisionNote.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public ListingRevisionNoteSummary build() {
            ListingRevisionNoteSummary model =
                    new ListingRevisionNoteSummary(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ListingRevisionNoteSummary model) {
    ...
    /** type of the note. */
    @com.fasterxml.jackson.annotation.JsonProperty("noteSource")
    private final ListingRevisionNote.NoteSource noteSource;
     ...
     * @return the value
     */
    public ListingRevisionNote.NoteSource getNoteSource() {
        return noteSource;
    }
    ...
    /** The current state of the note. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final ListingRevisionNote.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public ListingRevisionNote.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ListingRevisionNoteSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListingRevisionNoteSummary)) {
            return false;
        }

        ListingRevisionNoteSummary other = (ListingRevisionNoteSummary) o;
