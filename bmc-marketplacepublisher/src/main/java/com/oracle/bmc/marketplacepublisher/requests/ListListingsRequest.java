...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListListingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListListingsRequest.
 */
...
public class ListListingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListListingsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListListingsRequest(compartmentId, lifecycleState, name, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
