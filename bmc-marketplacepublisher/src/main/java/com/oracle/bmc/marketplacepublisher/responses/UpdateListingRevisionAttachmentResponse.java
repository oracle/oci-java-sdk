...
public class UpdateListingRevisionAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateListingRevisionAttachmentResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateListingRevisionAttachmentResponse o) {
         ...
         */
        public UpdateListingRevisionAttachmentResponse build() {
            return new UpdateListingRevisionAttachmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionAttachmentResponse)) {
            return false;
        }

        UpdateListingRevisionAttachmentResponse other = (UpdateListingRevisionAttachmentResponse) o;
