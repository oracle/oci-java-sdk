...
/**
 * A pricing plan provided by the Publisher. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            ...
            name = "METERED"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = SaaSPricingPlan.class,
            name = "FIXED")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class PricingPlan extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"rates"})
    protected PricingPlan(java.util.List<PricingRate> rates) {
        super();
        this.rates = rates;
    }
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.rates, other.rates) && super.equals(other);
    }
