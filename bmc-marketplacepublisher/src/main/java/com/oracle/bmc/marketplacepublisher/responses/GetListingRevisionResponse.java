...
public class GetListingRevisionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetListingRevisionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetListingRevisionResponse> {
         ...
         */
        @Override
        public Builder copy(GetListingRevisionResponse o) {
         ...
         */
        @Override
        public GetListingRevisionResponse build() {
            return new GetListingRevisionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetListingRevisionResponse)) {
            return false;
        }

        GetListingRevisionResponse other = (GetListingRevisionResponse) o;
