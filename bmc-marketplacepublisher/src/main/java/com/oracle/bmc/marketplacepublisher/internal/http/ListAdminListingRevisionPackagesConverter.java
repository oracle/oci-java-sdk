...
public class ListAdminListingRevisionPackagesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAdminListingRevisionPackagesConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplacepublisher.requests.ListAdminListingRevisionPackagesRequest
                    request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getListingRevisionId(), "listingRevisionId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20241201").path("adminListingRevisionPackages");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.ListAdminListingRevisionPackagesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.adminListingRevisionPackageCollection(response.getItem());
