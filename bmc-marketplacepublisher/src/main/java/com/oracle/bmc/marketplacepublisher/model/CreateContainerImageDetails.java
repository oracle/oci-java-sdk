...
/**
 * Container image details required to create a container artifact. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateContainerImageDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateContainerImageDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"sourceRegistryId", "sourceRegistryUrl"})
    public CreateContainerImageDetails(String sourceRegistryId, String sourceRegistryUrl) {
        super();
    ...
    public static class Builder {
        ...
        public CreateContainerImageDetails build() {
            CreateContainerImageDetails model =
                    new CreateContainerImageDetails(this.sourceRegistryId, this.sourceRegistryUrl);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateContainerImageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateContainerImageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContainerImageDetails)) {
            return false;
        }

        CreateContainerImageDetails other = (CreateContainerImageDetails) o;
