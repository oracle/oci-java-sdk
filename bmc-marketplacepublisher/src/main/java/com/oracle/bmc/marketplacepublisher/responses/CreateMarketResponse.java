...
public class CreateMarketResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMarketResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMarketResponse o) {
         ...
         */
        @Override
        public CreateMarketResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMarketResponse)) {
            return false;
        }

        CreateMarketResponse other = (CreateMarketResponse) o;
