...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateLeadGenListingRevisionDetails.Builder.class)
...
public final class UpdateLeadGenListingRevisionDetails extends UpdateListingRevisionDetails {
    ...
    public static class Builder {
        ...
        public UpdateLeadGenListingRevisionDetails build() {
            UpdateLeadGenListingRevisionDetails model =
                    new UpdateLeadGenListingRevisionDetails(
                            this.displayName,
                            this.headline,
                            this.tagline,
                            this.keywords,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateLeadGenListingRevisionDetails model) {
    ...
    @Deprecated
    public UpdateLeadGenListingRevisionDetails(
            String displayName,
            String headline,
            String tagline,
            String keywords,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateLeadGenListingRevisionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLeadGenListingRevisionDetails)) {
            return false;
        }

        UpdateLeadGenListingRevisionDetails other = (UpdateLeadGenListingRevisionDetails) o;
