...
public class GetTermVersionContentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetTermVersionContentConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetTermVersionContentRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplacepublisher.requests.GetTermVersionContentRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                        .GetTermVersionContentResponse>() {
                            @Override
                            public com.oracle.bmc.marketplacepublisher.responses
                                            .GetTermVersionContentResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetTermVersionContentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                                .GetTermVersionContentResponse.Builder
                                        builder =
                                                com.oracle.bmc.marketplacepublisher.responses
                                                        .GetTermVersionContentResponse.builder()
