...
public class DeleteOfferResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteOfferResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteOfferResponse o) {
         ...
         */
        @Override
        public DeleteOfferResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOfferResponse)) {
            return false;
        }

        DeleteOfferResponse other = (DeleteOfferResponse) o;
