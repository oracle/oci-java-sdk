...
/**
 * A package for container image listings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminContainerPackage.Builder.class)
...
public final class AdminContainerPackage extends AdminListingRevisionPackage {
    ...
    public static class Builder {
        ...
        public AdminContainerPackage build() {
            AdminContainerPackage model =
                    new AdminContainerPackage(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminContainerPackage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminContainerPackage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminContainerPackage)) {
            return false;
        }

        AdminContainerPackage other = (AdminContainerPackage) o;
