...
public class UpdateListingRevisionNoteResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateListingRevisionNoteResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateListingRevisionNoteResponse o) {
         ...
         */
        @Override
        public UpdateListingRevisionNoteResponse build() {
            return new UpdateListingRevisionNoteResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, listingRevisionNote);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionNoteResponse)) {
            return false;
        }

        UpdateListingRevisionNoteResponse other = (UpdateListingRevisionNoteResponse) o;
