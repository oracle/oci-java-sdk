...
public class UpdateTermVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateTermVersionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTermVersionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateTermVersionResponse o) {
         ...
         */
        @Override
        public UpdateTermVersionResponse build() {
            return new UpdateTermVersionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTermVersionResponse)) {
            return false;
        }

        UpdateTermVersionResponse other = (UpdateTermVersionResponse) o;
