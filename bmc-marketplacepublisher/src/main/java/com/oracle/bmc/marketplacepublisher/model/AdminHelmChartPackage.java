...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AdminHelmChartPackage.Builder.class
)
...
public final class AdminHelmChartPackage extends AdminListingRevisionPackage {
    ...
    public static class Builder {
        ...
        public AdminHelmChartPackage build() {
            AdminHelmChartPackage model =
                    new AdminHelmChartPackage(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminHelmChartPackage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminHelmChartPackage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminHelmChartPackage)) {
            return false;
        }

        AdminHelmChartPackage other = (AdminHelmChartPackage) o;
