...
/**
 * Banner uploaded by the Publisher to be attached to the listing revision. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ListingRevisionBannerAttachment.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ListingRevisionBannerAttachment
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"contentUrl", "mimeType", "name"})
    public ListingRevisionBannerAttachment(String contentUrl, String mimeType, String name) {
        super();
    ...
    public static class Builder {
        ...
        public ListingRevisionBannerAttachment build() {
            ListingRevisionBannerAttachment model =
                    new ListingRevisionBannerAttachment(this.contentUrl, this.mimeType, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ListingRevisionBannerAttachment model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ListingRevisionBannerAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListingRevisionBannerAttachment)) {
            return false;
        }

        ListingRevisionBannerAttachment other = (ListingRevisionBannerAttachment) o;
