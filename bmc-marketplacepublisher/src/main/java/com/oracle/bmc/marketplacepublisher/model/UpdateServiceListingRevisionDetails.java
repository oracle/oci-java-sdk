...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateServiceListingRevisionDetails.Builder.class)
...
public final class UpdateServiceListingRevisionDetails extends UpdateListingRevisionDetails {
    ...
    public static class Builder {
        ...
        public UpdateServiceListingRevisionDetails build() {
            UpdateServiceListingRevisionDetails model =
                    new UpdateServiceListingRevisionDetails(
                            this.displayName,
                            this.headline,
                            this.tagline,
                            this.keywords,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateServiceListingRevisionDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateServiceListingRevisionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateServiceListingRevisionDetails)) {
            return false;
        }

        UpdateServiceListingRevisionDetails other = (UpdateServiceListingRevisionDetails) o;
