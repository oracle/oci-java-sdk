...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListAdminListingRevisionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAdminListingRevisionsRequest.
 */
...
public class ListAdminListingRevisionsRequest
    ...
    public static class Builder
        ...
        public ListAdminListingRevisionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAdminListingRevisionsRequest(listingId, compartmentId, listingType, displayName, publisherId, lifecycleState, listingRevisionStatus, statusCsv, product, timeCreatedAfter, timeUpdatedAfter, limit, page, sortOrder, sortBy, pricingType, isPrivateOfferEnabled, dataSource, opcRequestId);
        }
    }
