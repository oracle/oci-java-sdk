...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateMarketDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CreateMarketDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "code", "categoryCode", "billToCountries"})
    public CreateMarketDetails(
            String name,
            String code,
            String categoryCode,
            java.util.List<BillToCountry> billToCountries) {
        super();
        this.name = name;
        this.code = code;
    ...
    public static class Builder {
        ...
        private java.util.List<BillToCountry> billToCountries;
         ...
         * @return this builder
         **/
        public Builder billToCountries(java.util.List<BillToCountry> billToCountries) {
            this.billToCountries = billToCountries;
        ...
        public CreateMarketDetails build() {
            CreateMarketDetails model =
                    new CreateMarketDetails(
                            this.name, this.code, this.categoryCode, this.billToCountries);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMarketDetails model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("billToCountries")
    private final java.util.List<BillToCountry> billToCountries;

    /**
     * bill to countries for the market.
     * @return the value
     **/
    public java.util.List<BillToCountry> getBillToCountries() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMarketDetails)) {
            return false;
        }

        CreateMarketDetails other = (CreateMarketDetails) o;
