...
public class UpdateTermVersionContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateTermVersionContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateTermVersionContentResponse o) {
         ...
         */
        @Override
        public UpdateTermVersionContentResponse build() {
            return new UpdateTermVersionContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTermVersionContentResponse)) {
            return false;
        }

        UpdateTermVersionContentResponse other = (UpdateTermVersionContentResponse) o;
