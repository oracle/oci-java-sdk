...
public class CreateListingRevisionPackageResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateListingRevisionPackageResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateListingRevisionPackageResponse o) {
         ...
         */
        public CreateListingRevisionPackageResponse build() {
            return new CreateListingRevisionPackageResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateListingRevisionPackageResponse)) {
            return false;
        }

        CreateListingRevisionPackageResponse other = (CreateListingRevisionPackageResponse) o;
