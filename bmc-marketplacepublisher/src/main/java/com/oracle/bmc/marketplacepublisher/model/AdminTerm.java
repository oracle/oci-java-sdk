...
/**
 * Base model object for the admin term. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AdminTerm.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdminTerm extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder author(Term.Author author) {
            this.author = author;
        ...
        private Term.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(Term.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminTerm model) {
    ...
    /** Who authored the term. Publisher terms will be defaulted to 'PARTNER'. */
    @com.fasterxml.jackson.annotation.JsonProperty("author")
    private final Term.Author author;
    ...
    /** The current state for the Term. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Term.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public Term.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminTerm)) {
            return false;
        }

        AdminTerm other = (AdminTerm) o;
