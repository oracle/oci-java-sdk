...
public class CreateListingRevisionAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateListingRevisionAttachmentResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateListingRevisionAttachmentResponse o) {
         ...
         */
        public CreateListingRevisionAttachmentResponse build() {
            return new CreateListingRevisionAttachmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateListingRevisionAttachmentResponse)) {
            return false;
        }

        CreateListingRevisionAttachmentResponse other = (CreateListingRevisionAttachmentResponse) o;
