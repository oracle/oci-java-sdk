...
public class GetListingConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetListingConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetListingRequest interceptRequest(
            com.oracle.bmc.marketplacepublisher.requests.GetListingRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                        .GetListingResponse>() {
                            @Override
                            public com.oracle.bmc.marketplacepublisher.responses.GetListingResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetListingResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
