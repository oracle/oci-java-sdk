...
/**
 * A package for machine image listings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminMachineImagePackage.Builder.class)
...
public final class AdminMachineImagePackage extends AdminListingRevisionPackage {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("machineImageDetails")
        private MachineImagePackageDetails machineImageDetails;

        public Builder machineImageDetails(MachineImagePackageDetails machineImageDetails) {
            this.machineImageDetails = machineImageDetails;
            this.__explicitlySet__.add("machineImageDetails");
            return this;
        }
        ...
        public AdminMachineImagePackage build() {
            AdminMachineImagePackage model =
                    new AdminMachineImagePackage(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminMachineImagePackage model) {
            ...
            if (model.wasPropertyExplicitlySet("machineImageDetails")) {
                this.machineImageDetails(model.getMachineImageDetails());
            }
            return this;
        }
    }
    ...
    @Deprecated
    public AdminMachineImagePackage(
            String id,
            String legacyId,
            String displayName,
            String description,
            ...
            MachineImagePackageDetails machineImageDetails) {
        super(
                id,
                legacyId,
                displayName,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("machineImageDetails")
    private final MachineImagePackageDetails machineImageDetails;

    public MachineImagePackageDetails getMachineImageDetails() {
        return machineImageDetails;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminMachineImagePackage(");
        sb.append("super=").append(super.toString(includeByteArrayContents));
        sb.append(", machineImageDetails=").append(String.valueOf(this.machineImageDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminMachineImagePackage)) {
            return false;
        }

        AdminMachineImagePackage other = (AdminMachineImagePackage) o;
        return java.util.Objects.equals(this.machineImageDetails, other.machineImageDetails)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.machineImageDetails == null
                                ? 43
                                : this.machineImageDetails.hashCode());
        return result;
    }
}
