...
public class GetTermVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code TermVersion} instance. */
    ...
    private GetTermVersionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTermVersionResponse> {
         ...
         */
        @Override
        public Builder copy(GetTermVersionResponse o) {
         ...
         */
        @Override
        public GetTermVersionResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTermVersionResponse)) {
            return false;
        }

        GetTermVersionResponse other = (GetTermVersionResponse) o;
