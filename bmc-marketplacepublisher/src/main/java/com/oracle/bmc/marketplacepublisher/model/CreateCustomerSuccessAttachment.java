...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateCustomerSuccessAttachment.Builder.class)
...
public final class CreateCustomerSuccessAttachment extends CreateListingRevisionAttachmentDetails {
    ...
    public static class Builder {
        ...
        public CreateCustomerSuccessAttachment build() {
            CreateCustomerSuccessAttachment model =
                    new CreateCustomerSuccessAttachment(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCustomerSuccessAttachment model) {
    ...
    @Deprecated
    public CreateCustomerSuccessAttachment(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCustomerSuccessAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCustomerSuccessAttachment)) {
            return false;
        }

        CreateCustomerSuccessAttachment other = (CreateCustomerSuccessAttachment) o;
