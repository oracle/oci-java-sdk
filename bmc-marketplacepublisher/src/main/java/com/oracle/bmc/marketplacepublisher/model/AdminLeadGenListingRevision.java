...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminLeadGenListingRevision.Builder.class)
...
public final class AdminLeadGenListingRevision extends AdminListingRevision {
    ...
    public static class Builder {
        ...
        public AdminLeadGenListingRevision build() {
            AdminLeadGenListingRevision model =
                    new AdminLeadGenListingRevision(
                            this.id,
                            this.legacyId,
                            this.listingId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminLeadGenListingRevision model) {
    ...
    @Deprecated
    public AdminLeadGenListingRevision(
            String id,
            String legacyId,
            String listingId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminLeadGenListingRevision(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminLeadGenListingRevision)) {
            return false;
        }

        AdminLeadGenListingRevision other = (AdminLeadGenListingRevision) o;
