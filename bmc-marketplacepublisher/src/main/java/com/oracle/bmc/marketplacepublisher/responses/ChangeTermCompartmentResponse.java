...
public class ChangeTermCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ChangeTermCompartmentResponse> {
         ...
         */
        @Override
        public Builder copy(ChangeTermCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeTermCompartmentResponse)) {
            return false;
        }
