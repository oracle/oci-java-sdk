...
public class CreateArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateArtifactResponse> {
         ...
         */
        @Override
        public Builder copy(CreateArtifactResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateArtifactResponse)) {
            return false;
        }

        CreateArtifactResponse other = (CreateArtifactResponse) o;
