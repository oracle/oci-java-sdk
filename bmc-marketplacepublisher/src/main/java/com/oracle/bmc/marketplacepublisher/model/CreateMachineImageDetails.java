...
/**
 * Machine image details required to create an Image artifact. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMachineImageDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMachineImageDetails
    ...
    public CreateMachineImageDetails(
    ...
    public static class Builder {
        ...
        /**
         * Indicates if the customer is allowed to take a snapshot of running instance created from
         * the machine image.
         */
        ...
        public CreateMachineImageDetails build() {
            CreateMachineImageDetails model =
                    new CreateMachineImageDetails(
                            this.sourceImageId,
                            this.username,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMachineImageDetails model) {
    ...
    /**
     * Indicates if the customer is allowed to take a snapshot of running instance created from the
     * machine image.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isSnapshotAllowed")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMachineImageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMachineImageDetails)) {
            return false;
        }

        CreateMachineImageDetails other = (CreateMachineImageDetails) o;
