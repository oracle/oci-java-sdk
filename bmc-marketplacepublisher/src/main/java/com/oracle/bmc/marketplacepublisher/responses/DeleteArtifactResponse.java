...
public class DeleteArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteArtifactResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteArtifactResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteArtifactResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteArtifactResponse)) {
            return false;
        }

        DeleteArtifactResponse other = (DeleteArtifactResponse) o;
