...
public class GetListingRevisionIconContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetListingRevisionIconContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetListingRevisionIconContentResponse o) {
         ...
         */
        @Override
        public GetListingRevisionIconContentResponse build() {
            return new GetListingRevisionIconContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetListingRevisionIconContentResponse)) {
            return false;
        }

        GetListingRevisionIconContentResponse other = (GetListingRevisionIconContentResponse) o;
