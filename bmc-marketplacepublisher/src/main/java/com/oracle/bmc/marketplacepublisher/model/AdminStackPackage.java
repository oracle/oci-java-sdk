...
/**
 * A package for Stack listings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminStackPackage.Builder.class)
...
public final class AdminStackPackage extends AdminListingRevisionPackage {
    ...
    public static class Builder {
        ...
        public AdminStackPackage build() {
            AdminStackPackage model =
                    new AdminStackPackage(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminStackPackage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminStackPackage)) {
            return false;
        }

        AdminStackPackage other = (AdminStackPackage) o;
