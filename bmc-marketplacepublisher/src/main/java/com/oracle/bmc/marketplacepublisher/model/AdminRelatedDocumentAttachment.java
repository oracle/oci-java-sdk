...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminRelatedDocumentAttachment.Builder.class)
...
public final class AdminRelatedDocumentAttachment extends AdminListingRevisionAttachment {
    ...
    public static class Builder {
        ...
        public AdminRelatedDocumentAttachment build() {
            AdminRelatedDocumentAttachment model =
                    new AdminRelatedDocumentAttachment(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminRelatedDocumentAttachment model) {
    ...
    @Deprecated
    public AdminRelatedDocumentAttachment(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminRelatedDocumentAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminRelatedDocumentAttachment)) {
            return false;
        }

        AdminRelatedDocumentAttachment other = (AdminRelatedDocumentAttachment) o;
