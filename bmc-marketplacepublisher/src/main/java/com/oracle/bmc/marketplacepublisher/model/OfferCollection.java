...
public final class OfferCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public OfferCollection(java.util.List<OfferSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<OfferSummary> items;
         ...
         * @return this builder
         **/
        public Builder items(java.util.List<OfferSummary> items) {
            this.items = items;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<OfferSummary> items;

    /**
     * List of offers.
     * @return the value
     **/
    public java.util.List<OfferSummary> getItems() {
        return items;
    }
