...
/**
 * Details to create a new helm chart image artifact. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateKubernetesImageArtifactDetails.Builder.class)
...
public final class CreateKubernetesImageArtifactDetails extends CreateArtifactDetails {
    ...
    public static class Builder {
        ...
        private CreateHelmChartImageDetails helmChart;

        public Builder helmChart(CreateHelmChartImageDetails helmChart) {
        ...
        public CreateKubernetesImageArtifactDetails build() {
            CreateKubernetesImageArtifactDetails model =
                    new CreateKubernetesImageArtifactDetails(
                            this.compartmentId,
                            this.displayName,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateKubernetesImageArtifactDetails model) {
    ...
    @Deprecated
    public CreateKubernetesImageArtifactDetails(
            String compartmentId,
            String displayName,
            java.util.Map<String, String> freeformTags,
            java.util.Map<String, java.util.Map<String, Object>> definedTags,
            CreateHelmChartImageDetails helmChart,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("helmChart")
    private final CreateHelmChartImageDetails helmChart;

    public CreateHelmChartImageDetails getHelmChart() {
        return helmChart;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateKubernetesImageArtifactDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKubernetesImageArtifactDetails)) {
            return false;
        }

        CreateKubernetesImageArtifactDetails other = (CreateKubernetesImageArtifactDetails) o;
