...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = UpdateListingRevisionDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateServiceListingRevisionDetails.class,
            name = "SERVICE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateOciListingRevisionDetails.class,
            name = "OCI_APPLICATION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateLeadGenListingRevisionDetails.class,
...
public class UpdateListingRevisionDetails
    ...
    protected UpdateListingRevisionDetails(
            String displayName,
            String headline,
            String tagline,
            String keywords,
