...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateListingRevisionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateListingRevisionDetails
    ...
    public UpdateListingRevisionDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateListingRevisionDetails build() {
            UpdateListingRevisionDetails model =
                    new UpdateListingRevisionDetails(
                            this.displayName,
                            this.versionDetails,
                            this.headline,
                            this.tagline,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateListingRevisionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionDetails)) {
            return false;
        }

        UpdateListingRevisionDetails other = (UpdateListingRevisionDetails) o;
