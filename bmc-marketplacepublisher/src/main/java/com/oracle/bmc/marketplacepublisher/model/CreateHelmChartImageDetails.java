...
public final class CreateHelmChartImageDetails
    ...
    public CreateHelmChartImageDetails(
    ...
    public static class Builder {
        ...
        public CreateHelmChartImageDetails build() {
            CreateHelmChartImageDetails model =
                    new CreateHelmChartImageDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateHelmChartImageDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateHelmChartImageDetails)) {
            return false;
        }

        CreateHelmChartImageDetails other = (CreateHelmChartImageDetails) o;
