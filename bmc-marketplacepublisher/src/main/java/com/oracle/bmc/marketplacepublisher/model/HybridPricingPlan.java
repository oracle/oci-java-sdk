...
/**
 * Hybrid SaaS pricing plan with a base fee and dimension-based overage billing. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HybridPricingPlan.Builder.class)
...
public final class HybridPricingPlan extends PricingPlan {
    ...
    public static class Builder {
        ...
        public HybridPricingPlan build() {
            HybridPricingPlan model =
                    new HybridPricingPlan(
                            this.rates,
                            this.pricingPlanKey,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HybridPricingPlan model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HybridPricingPlan)) {
            return false;
        }

        HybridPricingPlan other = (HybridPricingPlan) o;
