...
public class GetCategoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.marketplacepublisher.model.Category category;
     ...
     * @return the value
     */
    public com.oracle.bmc.marketplacepublisher.model.Category getCategory() {
        return category;
    }
    ...
    private GetCategoryResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.marketplacepublisher.model.Category category) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder category(com.oracle.bmc.marketplacepublisher.model.Category category) {
            this.category = category;
            return this;
        }
        ...
        public GetCategoryResponse build() {
            return new GetCategoryResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, category);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",category=").append(String.valueOf(category));
        sb.append(")");
        return sb.toString();
    }
