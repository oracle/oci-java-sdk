...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/SubmitListingRevisionForReviewExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SubmitListingRevisionForReviewRequest.
 */
...
public class SubmitListingRevisionForReviewRequest
    ...
    public static class Builder
        ...
        public SubmitListingRevisionForReviewRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SubmitListingRevisionForReviewRequest(submitListingRevisionForReviewDetails, listingRevisionId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
