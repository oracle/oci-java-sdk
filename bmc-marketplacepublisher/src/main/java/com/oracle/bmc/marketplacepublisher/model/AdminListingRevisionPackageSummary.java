...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminListingRevisionPackageSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdminListingRevisionPackageSummary
    ...
    public AdminListingRevisionPackageSummary(
            String id,
            String legacyId,
    ...
    public static class Builder {
        ...
        /**
         * The date and time the publication package was updated, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
         *
         * <p>Example: {@code 2022-09-24T21:10:29.600Z}
         */
        ...
        public AdminListingRevisionPackageSummary build() {
            AdminListingRevisionPackageSummary model =
                    new AdminListingRevisionPackageSummary(
                            this.id,
                            this.legacyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminListingRevisionPackageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminListingRevisionPackageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminListingRevisionPackageSummary)) {
            return false;
        }

        AdminListingRevisionPackageSummary other = (AdminListingRevisionPackageSummary) o;
