...
/**
 * Update the attachment for the listing revision. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = UpdateListingRevisionAttachmentDetails.class)
...
public class UpdateListingRevisionAttachmentDetails
    ...
    protected UpdateListingRevisionAttachmentDetails(
            String displayName,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionAttachmentDetails)) {
            return false;
        }

        UpdateListingRevisionAttachmentDetails other = (UpdateListingRevisionAttachmentDetails) o;
