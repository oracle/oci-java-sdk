...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/UpdateListingRevisionIconContentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateListingRevisionIconContentRequest.
 */
...
public class UpdateListingRevisionIconContentRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateListingRevisionIconContent(
                java.io.InputStream updateListingRevisionIconContent) {
            this.updateListingRevisionIconContent = updateListingRevisionIconContent;
            return this;
        }
        ...
        public Builder copy(UpdateListingRevisionIconContentRequest o) {
            ...
            updateListingRevisionIconContent(o.getUpdateListingRevisionIconContent());
         ...
         */
        public UpdateListingRevisionIconContentRequest build() {
            UpdateListingRevisionIconContentRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(java.io.InputStream body) {
            updateListingRevisionIconContent(body);
            return this;
        }
         ...
         * @return instance of UpdateListingRevisionIconContentRequest
         */
        public UpdateListingRevisionIconContentRequest buildWithoutInvocationCallback() {
            UpdateListingRevisionIconContentRequest request =
                    new UpdateListingRevisionIconContentRequest();
            request.listingRevisionId = listingRevisionId;
            request.updateListingRevisionIconContent = updateListingRevisionIconContent;
    ...
    public String toString() {
        ...
        sb.append(",updateListingRevisionIconContent=")
                .append(String.valueOf(this.updateListingRevisionIconContent));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionIconContentRequest)) {
            return false;
        }

        UpdateListingRevisionIconContentRequest other = (UpdateListingRevisionIconContentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.listingRevisionId, other.listingRevisionId)
                && java.util.Objects.equals(
                        this.updateListingRevisionIconContent,
                        other.updateListingRevisionIconContent)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateListingRevisionIconContent == null
                                ? 43
                                : this.updateListingRevisionIconContent.hashCode());
