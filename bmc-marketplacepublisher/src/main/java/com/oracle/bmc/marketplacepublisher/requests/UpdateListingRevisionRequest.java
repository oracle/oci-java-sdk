...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/UpdateListingRevisionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateListingRevisionRequest.
 */
...
public class UpdateListingRevisionRequest
    ...
    public static class Builder
        ...
        public UpdateListingRevisionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateListingRevisionRequest(listingRevisionId, updateListingRevisionDetails, ifMatch, opcRequestId);
        }
    }
