...
public class GetAdminListingRevisionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code AdminListingRevision} instance. */
    ...
    private GetAdminListingRevisionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetAdminListingRevisionResponse o) {
         ...
         */
        @Override
        public GetAdminListingRevisionResponse build() {
            return new GetAdminListingRevisionResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, adminListingRevision);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAdminListingRevisionResponse)) {
            return false;
        }

        GetAdminListingRevisionResponse other = (GetAdminListingRevisionResponse) o;
