...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOciListingRevisionDetails.Builder.class)
...
public final class UpdateOciListingRevisionDetails extends UpdateListingRevisionDetails {
    ...
    public static class Builder {
        ...
        public UpdateOciListingRevisionDetails build() {
            UpdateOciListingRevisionDetails model =
                    new UpdateOciListingRevisionDetails(
                            this.displayName,
                            this.headline,
                            this.tagline,
                            this.keywords,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOciListingRevisionDetails model) {
    ...
    @Deprecated
    public UpdateOciListingRevisionDetails(
            String displayName,
            String headline,
            String tagline,
            String keywords,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOciListingRevisionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOciListingRevisionDetails)) {
            return false;
        }

        UpdateOciListingRevisionDetails other = (UpdateOciListingRevisionDetails) o;
