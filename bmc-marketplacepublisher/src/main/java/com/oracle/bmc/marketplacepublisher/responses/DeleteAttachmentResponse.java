...
public class DeleteAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteAttachmentResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteAttachmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAttachmentResponse)) {
            return false;
        }
