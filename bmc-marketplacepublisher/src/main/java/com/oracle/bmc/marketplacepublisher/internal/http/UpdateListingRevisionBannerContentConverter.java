...
public class UpdateListingRevisionBannerContentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateListingRevisionBannerContentConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplacepublisher.requests.UpdateListingRevisionBannerContentRequest
                    request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getListingRevisionId(), "listingRevisionId must not be blank");
        Validate.notNull(request.getBannerName(), "bannerName is required");
        Validate.notNull(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.UpdateListingRevisionBannerContentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                                .UpdateListingRevisionBannerContentResponse.Builder
                                        builder =
                                                com.oracle.bmc.marketplacepublisher.responses
                                                        .UpdateListingRevisionBannerContentResponse
                                                        .builder()
