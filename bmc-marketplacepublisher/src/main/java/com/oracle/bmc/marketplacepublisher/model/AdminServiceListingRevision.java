...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AdminServiceListingRevision.Builder.class
)
...
public final class AdminServiceListingRevision extends AdminListingRevision {
    ...
    public static class Builder {
        ...
        public AdminServiceListingRevision build() {
            AdminServiceListingRevision model =
                    new AdminServiceListingRevision(
                            this.id,
                            this.legacyId,
                            this.listingId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminServiceListingRevision model) {
    ...
    @Deprecated
    public AdminServiceListingRevision(
            String id,
            String legacyId,
            String listingId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminServiceListingRevision(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminServiceListingRevision)) {
            return false;
        }

        AdminServiceListingRevision other = (AdminServiceListingRevision) o;
