...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListCustomerInstanceReportRecordsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCustomerInstanceReportRecordsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241201")
public class ListCustomerInstanceReportRecordsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCustomerInstanceReportRecordsRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of ListCustomerInstanceReportRecordsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCustomerInstanceReportRecordsRequest
         */
        public ListCustomerInstanceReportRecordsRequest build() {
            ListCustomerInstanceReportRecordsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCustomerInstanceReportRecordsRequest
         */
        public ListCustomerInstanceReportRecordsRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCustomerInstanceReportRecordsRequest)) {
            return false;
        }

        ListCustomerInstanceReportRecordsRequest other =
