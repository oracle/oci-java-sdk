...
public class ListCustomerInstanceReportRecordsRequest
    ...
    /**
     * The field to sort by. Only one sort order may be provided. Default order for instance_id is
     * ascending.
     */
    ...
    public static class Builder
        ...
        /**
         * The field to sort by. Only one sort order may be provided. Default order for instance_id
         * is ascending.
         */
        ...
        /**
         * Build the instance of ListCustomerInstanceReportRecordsRequest as configured by this
         * builder
         *
        ...
        public ListCustomerInstanceReportRecordsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCustomerInstanceReportRecordsRequest(compartmentId, opcRequestId, limit,
