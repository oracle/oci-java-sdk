...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListAdminArtifactsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAdminArtifactsRequest.
 */
...
public class ListAdminArtifactsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAdminArtifactsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAdminArtifactsRequest(compartmentId, publisherId, artifactType, lifecycleState, displayName, status, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
