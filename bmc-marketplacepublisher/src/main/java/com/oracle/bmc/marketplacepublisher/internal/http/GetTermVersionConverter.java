...
public class GetTermVersionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetTermVersionConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetTermVersionRequest
            interceptRequest(
                    com.oracle.bmc.marketplacepublisher.requests.GetTermVersionRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.marketplacepublisher.responses.GetTermVersionResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetTermVersionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplacepublisher.responses.GetTermVersionResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.marketplacepublisher.responses
                                                        .GetTermVersionResponse.builder()
