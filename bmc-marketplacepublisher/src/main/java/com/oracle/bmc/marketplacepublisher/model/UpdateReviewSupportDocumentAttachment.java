...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateReviewSupportDocumentAttachment.Builder.class)
...
public final class UpdateReviewSupportDocumentAttachment
        extends UpdateListingRevisionAttachmentDetails {
    ...
    public static class Builder {
        ...
        public UpdateReviewSupportDocumentAttachment build() {
            UpdateReviewSupportDocumentAttachment model =
                    new UpdateReviewSupportDocumentAttachment(
                            this.displayName,
                            this.description,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateReviewSupportDocumentAttachment model) {
    ...
    @Deprecated
    public UpdateReviewSupportDocumentAttachment(
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateReviewSupportDocumentAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReviewSupportDocumentAttachment)) {
            return false;
        }

        UpdateReviewSupportDocumentAttachment other = (UpdateReviewSupportDocumentAttachment) o;
