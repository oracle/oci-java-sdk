...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateServiceListingRevisionDetails.Builder.class)
...
public final class CreateServiceListingRevisionDetails extends CreateListingRevisionDetails {
    ...
    public static class Builder {
        ...
        public CreateServiceListingRevisionDetails build() {
            CreateServiceListingRevisionDetails model =
                    new CreateServiceListingRevisionDetails(
                            this.displayName,
                            this.listingId,
                            this.headline,
                            this.tagline,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateServiceListingRevisionDetails model) {
    ...
    @Deprecated
    public CreateServiceListingRevisionDetails(
            String displayName,
            String listingId,
            String headline,
            String tagline,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateServiceListingRevisionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceListingRevisionDetails)) {
            return false;
        }

        CreateServiceListingRevisionDetails other = (CreateServiceListingRevisionDetails) o;
