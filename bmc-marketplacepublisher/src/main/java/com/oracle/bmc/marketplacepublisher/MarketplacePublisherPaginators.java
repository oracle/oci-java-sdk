...
public class MarketplacePublisherPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listCustomerInstanceReportExports operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.marketplacepublisher.model.CustomerInstanceReportExportSummary} objects
     * contained in responses from the listCustomerInstanceReportExports operation. This iterable
