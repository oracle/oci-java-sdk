...
/**
 * Customer success attachment for the listing revision. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminCustomerSuccessAttachment.Builder.class)
...
public final class AdminCustomerSuccessAttachment extends AdminListingRevisionAttachment {
    ...
    public static class Builder {
        ...
        public AdminCustomerSuccessAttachment build() {
            AdminCustomerSuccessAttachment model =
                    new AdminCustomerSuccessAttachment(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminCustomerSuccessAttachment model) {
    ...
    @Deprecated
    public AdminCustomerSuccessAttachment(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminCustomerSuccessAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminCustomerSuccessAttachment)) {
            return false;
        }

        AdminCustomerSuccessAttachment other = (AdminCustomerSuccessAttachment) o;
