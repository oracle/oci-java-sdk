...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListListingRevisionNotesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListListingRevisionNotesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListListingRevisionNotesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListListingRevisionNotesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListListingRevisionNotesRequest o) {
        ...
        /**
         * Build the instance of ListListingRevisionNotesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListListingRevisionNotesRequest
         */
        public ListListingRevisionNotesRequest build() {
            ListListingRevisionNotesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListListingRevisionNotesRequest
         */
        public ListListingRevisionNotesRequest buildWithoutInvocationCallback() {
            ListListingRevisionNotesRequest request = new ListListingRevisionNotesRequest();
            ...
            return request;
            // new ListListingRevisionNotesRequest(listingRevisionId, compartmentId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListListingRevisionNotesRequest)) {
            return false;
        }

        ListListingRevisionNotesRequest other = (ListListingRevisionNotesRequest) o;
