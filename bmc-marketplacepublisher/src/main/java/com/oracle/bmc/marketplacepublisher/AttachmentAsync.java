...
public interface AttachmentAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateAttachmentResponse> createAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteAttachmentResponse> deleteAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetAttachmentResponse> getAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetAttachmentContentResponse> getAttachmentContent(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListAttachmentsResponse> listAttachments(
