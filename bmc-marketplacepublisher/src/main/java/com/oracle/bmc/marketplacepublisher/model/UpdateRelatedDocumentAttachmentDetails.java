...
/**
 * Update Details of the related document attachment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateRelatedDocumentAttachmentDetails.Builder.class)
...
public final class UpdateRelatedDocumentAttachmentDetails
    ...
    public static class Builder {
        ...
        public UpdateRelatedDocumentAttachmentDetails build() {
            UpdateRelatedDocumentAttachmentDetails model =
                    new UpdateRelatedDocumentAttachmentDetails(
                            this.displayName,
                            this.description,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateRelatedDocumentAttachmentDetails model) {
    ...
    @Deprecated
    public UpdateRelatedDocumentAttachmentDetails(
            String displayName,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRelatedDocumentAttachmentDetails)) {
            return false;
        }
