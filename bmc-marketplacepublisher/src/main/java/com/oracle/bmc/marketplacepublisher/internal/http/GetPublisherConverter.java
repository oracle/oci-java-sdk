...
public class GetPublisherConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetPublisherConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetPublisherRequest interceptRequest(
            com.oracle.bmc.marketplacepublisher.requests.GetPublisherRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetPublisherResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplacepublisher.responses.GetPublisherResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.marketplacepublisher.responses
                                                        .GetPublisherResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.publisher(response.getItem());
