...
public class UpdateListingRevisionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateListingRevisionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateListingRevisionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateListingRevisionResponse o) {
         ...
         */
        @Override
        public UpdateListingRevisionResponse build() {
            return new UpdateListingRevisionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionResponse)) {
            return false;
        }

        UpdateListingRevisionResponse other = (UpdateListingRevisionResponse) o;
