...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListDisbursementReportRecordsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDisbursementReportRecordsRequest.
 */
...
public class ListDisbursementReportRecordsRequest
    ...
    public static class Builder
        ...
        public ListDisbursementReportRecordsRequest buildWithoutInvocationCallback() {
            ...
            request.name = name;
            return request;
            // new ListDisbursementReportRecordsRequest(compartmentId, dateRange, opcRequestId, limit, page, sortOrder, sortBy, name);
        }
    }
