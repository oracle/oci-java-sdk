...
public final class ListingRevisionIconAttachment
    ...
    public static class Builder {
        ...
        public ListingRevisionIconAttachment build() {
            ListingRevisionIconAttachment model =
                    new ListingRevisionIconAttachment(this.contentUrl, this.mimeType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ListingRevisionIconAttachment model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ListingRevisionIconAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListingRevisionIconAttachment)) {
            return false;
        }

        ListingRevisionIconAttachment other = (ListingRevisionIconAttachment) o;
