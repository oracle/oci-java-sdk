...
public class UpdateListingRevisionIconContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateListingRevisionIconContentResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateListingRevisionIconContentResponse o) {
         ...
         */
        public UpdateListingRevisionIconContentResponse build() {
            return new UpdateListingRevisionIconContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateListingRevisionIconContentResponse)) {
            return false;
        }

        UpdateListingRevisionIconContentResponse other =
                (UpdateListingRevisionIconContentResponse) o;
