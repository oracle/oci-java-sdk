...
public class GetListingRevisionAttachmentContentResponse
    ...
    private GetListingRevisionAttachmentContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetListingRevisionAttachmentContentResponse o) {
         ...
         */
        @Override
        public GetListingRevisionAttachmentContentResponse build() {
            return new GetListingRevisionAttachmentContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetListingRevisionAttachmentContentResponse)) {
            return false;
        }

        GetListingRevisionAttachmentContentResponse other =
                (GetListingRevisionAttachmentContentResponse) o;
