...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminWorkRequestSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdminWorkRequestSummary
    ...
    public AdminWorkRequestSummary(
    ...
    public static class Builder {
        ...
        public AdminWorkRequestSummary build() {
            AdminWorkRequestSummary model =
                    new AdminWorkRequestSummary(
                            this.operationType,
                            this.status,
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminWorkRequestSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminWorkRequestSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminWorkRequestSummary)) {
            return false;
        }

        AdminWorkRequestSummary other = (AdminWorkRequestSummary) o;
