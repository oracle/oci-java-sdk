...
/**
 * Model object for the term version details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AdminTermVersion.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdminTermVersion
    ...
    public AdminTermVersion(
            ...
            Author author,
            AdminTermVersionAttachment attachment,
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("termAuthor")
        private TermAuthor termAuthor;

        /**
         * Who authored the term. Publisher terms will be defaulted to 'PARTNER'.
         *
         * @param termAuthor the value to set
         * @return this builder
         */
        public Builder termAuthor(TermAuthor termAuthor) {
            this.termAuthor = termAuthor;
            this.__explicitlySet__.add("termAuthor");
            return this;
        }
        ...
        private AdminTermVersionAttachment attachment;

        public Builder attachment(AdminTermVersionAttachment attachment) {
            this.attachment = attachment;
        ...
        public AdminTermVersion build() {
            AdminTermVersion model =
                    new AdminTermVersion(
                            this.id,
                            this.legacyId,
                            this.termId,
                            this.termAuthor,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminTermVersion model) {
            ...
            if (model.wasPropertyExplicitlySet("termAuthor")) {
                this.termAuthor(model.getTermAuthor());
            }
    ...
    /** Who authored the term. Publisher terms will be defaulted to 'PARTNER'. */
    public enum TermAuthor implements com.oracle.bmc.http.internal.BmcEnum {
        Oracle("ORACLE"),
        Partner("PARTNER"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(TermAuthor.class);

        private final String value;
        private static java.util.Map<String, TermAuthor> map;

        static {
            map = new java.util.HashMap<>();
            for (TermAuthor v : TermAuthor.values()) {
        ...
        public static TermAuthor create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'TermAuthor', returning UnknownEnumValue",
                    key);
    ...
    /** Who authored the term. Publisher terms will be defaulted to 'PARTNER'. */
    @com.fasterxml.jackson.annotation.JsonProperty("termAuthor")
    private final TermAuthor termAuthor;
     ...
     * @return the value
     */
    public TermAuthor getTermAuthor() {
        return termAuthor;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("attachment")
    private final AdminTermVersionAttachment attachment;

    public AdminTermVersionAttachment getAttachment() {
        return attachment;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminTermVersion)) {
            return false;
        }

        AdminTermVersion other = (AdminTermVersion) o;
        return java.util.Objects.equals(this.id, other.id)
                && java.util.Objects.equals(this.legacyId, other.legacyId)
                && java.util.Objects.equals(this.termId, other.termId)
                && java.util.Objects.equals(this.termAuthor, other.termAuthor)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.termAuthor == null ? 43 : this.termAuthor.hashCode());
