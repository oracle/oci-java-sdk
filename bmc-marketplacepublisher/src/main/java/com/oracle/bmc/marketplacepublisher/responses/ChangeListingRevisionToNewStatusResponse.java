...
public class ChangeListingRevisionToNewStatusResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeListingRevisionToNewStatusResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeListingRevisionToNewStatusResponse o) {
         ...
         */
        public ChangeListingRevisionToNewStatusResponse build() {
            return new ChangeListingRevisionToNewStatusResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeListingRevisionToNewStatusResponse)) {
            return false;
        }

        ChangeListingRevisionToNewStatusResponse other =
                (ChangeListingRevisionToNewStatusResponse) o;
