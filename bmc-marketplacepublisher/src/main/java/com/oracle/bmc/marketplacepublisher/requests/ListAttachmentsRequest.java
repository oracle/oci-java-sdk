...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListAttachmentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAttachmentsRequest.
 */
...
public class ListAttachmentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAttachmentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAttachmentsRequest(offerId, buyerCompartmentId, sellerCompartmentId, lifecycleState, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
