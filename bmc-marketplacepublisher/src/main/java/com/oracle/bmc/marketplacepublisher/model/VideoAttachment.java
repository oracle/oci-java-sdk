...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VideoAttachment.Builder.class)
...
public final class VideoAttachment extends ListingRevisionAttachment {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VideoAttachment model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoAttachment)) {
            return false;
        }
