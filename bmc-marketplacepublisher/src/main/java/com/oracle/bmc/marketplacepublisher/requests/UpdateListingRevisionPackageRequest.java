...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/UpdateListingRevisionPackageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateListingRevisionPackageRequest.
 */
...
public class UpdateListingRevisionPackageRequest
    ...
    public static class Builder
        ...
        public UpdateListingRevisionPackageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateListingRevisionPackageRequest(listingRevisionPackageId, updateListingRevisionPackageDetails, ifMatch, opcRequestId);
        }
    }
