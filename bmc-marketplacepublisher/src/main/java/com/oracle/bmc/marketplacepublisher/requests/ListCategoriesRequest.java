...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListCategoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCategoriesRequest.
 */
...
public class ListCategoriesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCategoriesRequest buildWithoutInvocationCallback() {
            ...
            request.name = name;
            return request;
            // new ListCategoriesRequest(compartmentId, limit, page, productCode, sortOrder, sortBy, opcRequestId, name);
        }
    }
