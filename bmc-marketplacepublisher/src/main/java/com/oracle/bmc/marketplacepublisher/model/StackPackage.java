...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StackPackage.Builder.class)
...
public final class StackPackage extends ListingRevisionPackage {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StackPackage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StackPackage)) {
            return false;
        }

        StackPackage other = (StackPackage) o;
