...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ContainerPackage.Builder.class)
...
public final class ContainerPackage extends ListingRevisionPackage {
    ...
    public static class Builder {
        ...
        public ContainerPackage build() {
            ContainerPackage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ContainerPackage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContainerPackage)) {
            return false;
        }

        ContainerPackage other = (ContainerPackage) o;
