...
public class GetAdminListingRevisionPackageConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAdminListingRevisionPackageConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetAdminListingRevisionPackageRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplacepublisher.requests.GetAdminListingRevisionPackageRequest
                    request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplacepublisher.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetAdminListingRevisionPackageResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                                .GetAdminListingRevisionPackageResponse.Builder
                                        builder =
                                                com.oracle.bmc.marketplacepublisher.responses
                                                        .GetAdminListingRevisionPackageResponse
                                                        .builder()
                                ...
                                builder.adminListingRevisionPackage(response.getItem());
