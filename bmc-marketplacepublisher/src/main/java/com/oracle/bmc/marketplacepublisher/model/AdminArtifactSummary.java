...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AdminArtifactSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AdminArtifactSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("artifactType")
         ...
         * @return this builder
         **/
        public Builder artifactType(ArtifactTypeEnum artifactType) {
            this.artifactType = artifactType;
            this.__explicitlySet__.add("artifactType");
            return this;
        }
        /**
        ...
        public AdminArtifactSummary build() {
            AdminArtifactSummary model =
                    new AdminArtifactSummary(
                            this.id,
                            this.legacyId,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminArtifactSummary model) {
            ...
            if (model.wasPropertyExplicitlySet("artifactType")) {
                this.artifactType(model.getArtifactType());
            }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Artifact.LifecycleState lifecycleState;

    /**
     * The current state for the Artifact.
     * @return the value
     **/
    public Artifact.LifecycleState getLifecycleState() {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("status")
    private final Artifact.Status status;

    /**
     * The current status for the Artifact.
     * @return the value
     **/
    public Artifact.Status getStatus() {
        return status;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminArtifactSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminArtifactSummary)) {
            return false;
        }

        AdminArtifactSummary other = (AdminArtifactSummary) o;
