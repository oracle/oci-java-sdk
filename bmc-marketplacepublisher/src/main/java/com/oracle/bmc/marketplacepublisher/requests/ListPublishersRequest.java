...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListPublishersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPublishersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListPublishersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListPublishersRequest buildWithoutInvocationCallback() {
            ListPublishersRequest request = new ListPublishersRequest();
            ...
            request.name = name;
            return request;
            // new ListPublishersRequest(compartmentId, limit, page, sortOrder, sortBy, opcRequestId, name);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPublishersRequest)) {
            return false;
        }

        ListPublishersRequest other = (ListPublishersRequest) o;
