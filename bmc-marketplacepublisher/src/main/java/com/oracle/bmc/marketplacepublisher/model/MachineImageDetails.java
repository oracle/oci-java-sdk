...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MachineImageDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MachineImageDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public MachineImageDetails build() {
            MachineImageDetails model =
                    new MachineImageDetails(
                            this.sourceImageId,
                            this.username,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MachineImageDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MachineImageDetails)) {
            return false;
        }

        MachineImageDetails other = (MachineImageDetails) o;
