...
/**
 * A attachment for the listing revision. User can provide an external URL/upload a file <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = ListingRevisionAttachment.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = RelatedDocumentAttachment.class,
...
public class ListingRevisionAttachment
    ...
    protected ListingRevisionAttachment(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ListingRevisionAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListingRevisionAttachment)) {
            return false;
        }

        ListingRevisionAttachment other = (ListingRevisionAttachment) o;
    ...
    /**
     * Possible values for the publisher listing revision attachments. The attachment type informs
     * the type of attachment for the listing revision.
     */
