...
public class GetTermVersionContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetTermVersionContentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTermVersionContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetTermVersionContentResponse o) {
         ...
         */
        @Override
        public GetTermVersionContentResponse build() {
            return new GetTermVersionContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTermVersionContentResponse)) {
            return false;
        }

        GetTermVersionContentResponse other = (GetTermVersionContentResponse) o;
