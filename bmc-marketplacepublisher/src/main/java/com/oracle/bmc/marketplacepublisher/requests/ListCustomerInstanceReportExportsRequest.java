...
public class ListCustomerInstanceReportExportsRequest
     ...
     * descending. Default order for fileName is ascending.
     */
    ...
    public static class Builder
         ...
         * is descending. Default order for fileName is ascending.
         */
        ...
        /**
         * Build the instance of ListCustomerInstanceReportExportsRequest as configured by this
         * builder
         *
        ...
        public ListCustomerInstanceReportExportsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCustomerInstanceReportExportsRequest(compartmentId, opcRequestId, limit,
            // page, sortOrder, sortBy, name, listingId, status, shape, region, realm,
            // tenantAdminDomain, packageVersion, instanceOcid, timeInstanceCreationFromDate,
            // timeInstanceCreationToDate, timeInstanceTerminationFromDate,
