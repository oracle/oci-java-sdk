...
public class GetProductConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetProductConverter.class);

    public static com.oracle.bmc.marketplacepublisher.requests.GetProductRequest interceptRequest(
            com.oracle.bmc.marketplacepublisher.requests.GetProductRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.marketplacepublisher.responses
                                        .GetProductResponse>() {
                            @Override
                            public com.oracle.bmc.marketplacepublisher.responses.GetProductResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplacepublisher.responses.GetProductResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.product(response.getItem());
