...
public class SubmitListingRevisionForReviewResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SubmitListingRevisionForReviewResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SubmitListingRevisionForReviewResponse o) {
         ...
         */
        public SubmitListingRevisionForReviewResponse build() {
            return new SubmitListingRevisionForReviewResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubmitListingRevisionForReviewResponse)) {
            return false;
        }

        SubmitListingRevisionForReviewResponse other = (SubmitListingRevisionForReviewResponse) o;
