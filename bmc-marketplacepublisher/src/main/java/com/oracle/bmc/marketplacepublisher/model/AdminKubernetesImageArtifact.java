...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminKubernetesImageArtifact.Builder.class)
...
public final class AdminKubernetesImageArtifact extends AdminArtifact {
    ...
    public static class Builder {
        ...
        public AdminKubernetesImageArtifact build() {
            AdminKubernetesImageArtifact model =
                    new AdminKubernetesImageArtifact(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminKubernetesImageArtifact model) {
    ...
    @Deprecated
    public AdminKubernetesImageArtifact(
            String id,
            String legacyId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminKubernetesImageArtifact(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminKubernetesImageArtifact)) {
            return false;
        }

        AdminKubernetesImageArtifact other = (AdminKubernetesImageArtifact) o;
