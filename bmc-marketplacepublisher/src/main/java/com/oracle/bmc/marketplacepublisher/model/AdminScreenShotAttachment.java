...
/**
 * Screenshot attachment for the listing revision. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminScreenShotAttachment.Builder.class)
...
public final class AdminScreenShotAttachment extends AdminListingRevisionAttachment {
    ...
    public static class Builder {
        ...
        public AdminScreenShotAttachment build() {
            AdminScreenShotAttachment model =
                    new AdminScreenShotAttachment(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminScreenShotAttachment model) {
    ...
    @Deprecated
    public AdminScreenShotAttachment(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminScreenShotAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminScreenShotAttachment)) {
            return false;
        }

        AdminScreenShotAttachment other = (AdminScreenShotAttachment) o;
