...
/**
 * Review document attachment for the listing revision. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ReviewSupportDocumentAttachment.Builder.class)
...
public final class ReviewSupportDocumentAttachment extends ListingRevisionAttachment {
    ...
    public static class Builder {
        ...
        public ReviewSupportDocumentAttachment build() {
            ReviewSupportDocumentAttachment model =
                    new ReviewSupportDocumentAttachment(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReviewSupportDocumentAttachment model) {
    ...
    @Deprecated
    public ReviewSupportDocumentAttachment(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ReviewSupportDocumentAttachment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReviewSupportDocumentAttachment)) {
            return false;
        }

        ReviewSupportDocumentAttachment other = (ReviewSupportDocumentAttachment) o;
