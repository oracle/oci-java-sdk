...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplacepublisher/ListListingRevisionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListListingRevisionsRequest.
 */
...
public class ListListingRevisionsRequest
    ...
    public static class Builder
         ...
         */
        public ListListingRevisionsRequest build() {
            ListListingRevisionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListListingRevisionsRequest
         */
        public ListListingRevisionsRequest buildWithoutInvocationCallback() {
            ListListingRevisionsRequest request = new ListListingRevisionsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListListingRevisionsRequest)) {
            return false;
        }

        ListListingRevisionsRequest other = (ListListingRevisionsRequest) o;
