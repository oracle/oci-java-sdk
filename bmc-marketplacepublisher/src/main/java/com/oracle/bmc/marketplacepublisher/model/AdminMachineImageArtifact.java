...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdminMachineImageArtifact.Builder.class)
...
public final class AdminMachineImageArtifact extends AdminArtifact {
    ...
    public static class Builder {
        ...
        public AdminMachineImageArtifact build() {
            AdminMachineImageArtifact model =
                    new AdminMachineImageArtifact(
                            this.id,
                            this.legacyId,
                            this.displayName,
                            this.status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdminMachineImageArtifact model) {
    ...
    @Deprecated
    public AdminMachineImageArtifact(
            String id,
            String legacyId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdminMachineImageArtifact(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminMachineImageArtifact)) {
            return false;
        }

        AdminMachineImageArtifact other = (AdminMachineImageArtifact) o;
