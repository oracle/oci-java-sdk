...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VcnVariable.Builder.class)
...
public final class VcnVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private VcnVariableDependsOn dependsOn;

        public Builder dependsOn(VcnVariableDependsOn dependsOn) {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VcnVariable model) {
    ...
    public VcnVariable(
            ...
            Boolean isRequired,
            String visible,
            VcnVariableDependsOn dependsOn) {
        super(title, description, isRequired, visible);
        this.dependsOn = dependsOn;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final VcnVariableDependsOn dependsOn;

    public VcnVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VcnVariable)) {
            return false;
        }

        VcnVariable other = (VcnVariable) o;
