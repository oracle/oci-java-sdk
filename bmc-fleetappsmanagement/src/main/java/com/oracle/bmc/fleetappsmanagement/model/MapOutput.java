...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MapOutput.Builder.class)
...
public final class MapOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MapOutput model) {
