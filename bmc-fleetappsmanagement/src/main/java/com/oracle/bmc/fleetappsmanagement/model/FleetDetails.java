...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "fleetType",
        defaultImpl = FleetDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GroupFleetDetails.class,
            name = "GROUP"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ProductFleetDetails.class,
            name = "PRODUCT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GenericFleetDetails.class,
            name = "GENERIC"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = EnvironmentFleetDetails.class,
            name = "ENVIRONMENT")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class FleetDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected FleetDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FleetDetails)) {
            return false;
        }

        FleetDetails other = (FleetDetails) o;
