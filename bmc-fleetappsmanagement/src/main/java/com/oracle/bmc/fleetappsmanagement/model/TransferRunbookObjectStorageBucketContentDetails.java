...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TransferRunbookObjectStorageBucketContentDetails.Builder.class)
...
public final class TransferRunbookObjectStorageBucketContentDetails
        extends TransferRunbookContentDetails {
    ...
    public static class Builder {
        ...
        public TransferRunbookObjectStorageBucketContentDetails build() {
            TransferRunbookObjectStorageBucketContentDetails model =
                    new TransferRunbookObjectStorageBucketContentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TransferRunbookObjectStorageBucketContentDetails model) {
    ...
    @Deprecated
    public TransferRunbookObjectStorageBucketContentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TransferRunbookObjectStorageBucketContentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TransferRunbookObjectStorageBucketContentDetails)) {
            return false;
        }

        TransferRunbookObjectStorageBucketContentDetails other =
                (TransferRunbookObjectStorageBucketContentDetails) o;
