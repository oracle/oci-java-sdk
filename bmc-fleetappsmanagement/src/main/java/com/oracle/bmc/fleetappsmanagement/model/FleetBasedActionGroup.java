...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FleetBasedActionGroup.Builder.class)
...
public final class FleetBasedActionGroup extends ActionGroup {
    ...
    public static class Builder {
        ...
        /**
         * Sequence of the Action Group. Action groups will be executed in a seuential order. All
         * Action Groups having the same sequence will be executed parallely. If no value is
         * provided a default value of 1 will be given.
         */
        ...
        public FleetBasedActionGroup build() {
            FleetBasedActionGroup model =
                    new FleetBasedActionGroup(
                            this.displayName,
                            this.fleetId,
                            this.sequence,
                            this.runbookId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FleetBasedActionGroup model) {
    ...
    /**
     * Sequence of the Action Group. Action groups will be executed in a seuential order. All Action
     * Groups having the same sequence will be executed parallely. If no value is provided a default
     * value of 1 will be given.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sequence")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FleetBasedActionGroup(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FleetBasedActionGroup)) {
            return false;
        }

        FleetBasedActionGroup other = (FleetBasedActionGroup) o;
