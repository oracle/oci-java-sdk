...
public class RequestResourceValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RequestResourceValidationResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RequestResourceValidationResponse o) {
         ...
         */
        @Override
        public RequestResourceValidationResponse build() {
            return new RequestResourceValidationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestResourceValidationResponse)) {
            return false;
        }

        RequestResourceValidationResponse other = (RequestResourceValidationResponse) o;
