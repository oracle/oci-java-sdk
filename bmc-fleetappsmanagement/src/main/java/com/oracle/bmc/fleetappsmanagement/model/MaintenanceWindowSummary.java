...
/**
 * Summary of the MaintenanceWindow. <br>
...
public final class MaintenanceWindowSummary
    ...
    public static class Builder {
        ...
        private MaintenanceWindow.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(MaintenanceWindow.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
    ...
    /** The current state of the MaintenanceWindow. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final MaintenanceWindow.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public MaintenanceWindow.LifecycleState getLifecycleState() {
