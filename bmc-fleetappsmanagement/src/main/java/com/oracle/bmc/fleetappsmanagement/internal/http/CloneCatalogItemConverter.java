...
public class CloneCatalogItemConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CloneCatalogItemConverter.class);

    public static com.oracle.bmc.fleetappsmanagement.requests.CloneCatalogItemRequest
            interceptRequest(
                    com.oracle.bmc.fleetappsmanagement.requests.CloneCatalogItemRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.fleetappsmanagement.responses.CloneCatalogItemResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.fleetappsmanagement.responses
                                        .CloneCatalogItemResponse>() {
                            @Override
                            public com.oracle.bmc.fleetappsmanagement.responses
                                            .CloneCatalogItemResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetappsmanagement.responses.CloneCatalogItemResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fleetappsmanagement.responses
                                                .CloneCatalogItemResponse.Builder
                                        builder =
                                                com.oracle.bmc.fleetappsmanagement.responses
                                                        .CloneCatalogItemResponse.builder()
                                ...
                                builder.catalogItem(response.getItem());
