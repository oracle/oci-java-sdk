 ...
 * to any list operations of FleetAppsManagementMaintenanceWindow where multiple pages of data may
 * be fetched. Two styles of iteration are supported:
 *
 * <ul>
...
public class FleetAppsManagementMaintenanceWindowPaginators {
     ...
     * com.oracle.bmc.fleetappsmanagement.model.MaintenanceWindowSummary} objects contained in
     * responses from the listMaintenanceWindows operation. This iterable will fetch more data from
