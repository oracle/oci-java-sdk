...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TimeBasedPauseDetails.Builder.class
)
...
public final class TimeBasedPauseDetails extends PauseDetails {
    ...
    public static class Builder {
        ...
        public TimeBasedPauseDetails build() {
            TimeBasedPauseDetails model = new TimeBasedPauseDetails(this.durationInMinutes);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TimeBasedPauseDetails model) {
    ...
    @Deprecated
    public TimeBasedPauseDetails(Integer durationInMinutes) {
        super();
        this.durationInMinutes = durationInMinutes;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TimeBasedPauseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TimeBasedPauseDetails)) {
            return false;
        }

        TimeBasedPauseDetails other = (TimeBasedPauseDetails) o;
