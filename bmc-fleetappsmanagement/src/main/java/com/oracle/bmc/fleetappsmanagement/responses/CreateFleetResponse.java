...
public class CreateFleetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.fleetappsmanagement.model.Fleet fleet;
     ...
     * @return the value
     */
    public com.oracle.bmc.fleetappsmanagement.model.Fleet getFleet() {
        return fleet;
    }
    ...
    private CreateFleetResponse(
            ...
            String opcRequestId,
            com.oracle.bmc.fleetappsmanagement.model.Fleet fleet) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateFleetResponse> {
         ...
         * @return this builder
         */
        public Builder fleet(com.oracle.bmc.fleetappsmanagement.model.Fleet fleet) {
            this.fleet = fleet;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(CreateFleetResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",fleet=").append(String.valueOf(fleet));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFleetResponse)) {
            return false;
        }

        CreateFleetResponse other = (CreateFleetResponse) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.fleet, other.fleet);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.fleet == null ? 43 : this.fleet.hashCode());
        return result;
    }
}
