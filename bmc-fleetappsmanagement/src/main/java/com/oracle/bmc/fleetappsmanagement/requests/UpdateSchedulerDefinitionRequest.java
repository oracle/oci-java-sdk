...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/UpdateSchedulerDefinitionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSchedulerDefinitionRequest.
 */
...
public class UpdateSchedulerDefinitionRequest
    ...
    public static class Builder
        ...
        public UpdateSchedulerDefinitionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSchedulerDefinitionRequest(schedulerDefinitionId, updateSchedulerDefinitionDetails, ifMatch, opcRequestId);
        }
    }
