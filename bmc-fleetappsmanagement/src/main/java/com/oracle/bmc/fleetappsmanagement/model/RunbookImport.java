...
/**
 * Runbook Import Status check details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RunbookImport.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RunbookImport extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RunbookImport model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunbookImport)) {
            return false;
        }

        RunbookImport other = (RunbookImport) o;
