...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OcidOutput.Builder.class)
...
public final class OcidOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OcidOutput model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OcidOutput)) {
            return false;
        }

        OcidOutput other = (OcidOutput) o;
