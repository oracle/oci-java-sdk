...
public class GetTaskRecordResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTaskRecordResponse> {
         ...
         */
        @Override
        public Builder copy(GetTaskRecordResponse o) {
         ...
         */
        @Override
        public GetTaskRecordResponse build() {
            return new GetTaskRecordResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTaskRecordResponse)) {
            return false;
        }

        GetTaskRecordResponse other = (GetTaskRecordResponse) o;
