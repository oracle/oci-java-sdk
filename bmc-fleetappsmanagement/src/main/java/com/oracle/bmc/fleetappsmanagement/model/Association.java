...
public final class Association extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "displayName"})
    public Association(String id, String displayName) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public Association build() {
            Association model = new Association(this.id, this.displayName);
