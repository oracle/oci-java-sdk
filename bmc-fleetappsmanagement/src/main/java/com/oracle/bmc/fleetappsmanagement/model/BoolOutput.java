...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BoolOutput.Builder.class)
...
public final class BoolOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BoolOutput model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BoolOutput)) {
            return false;
        }

        BoolOutput other = (BoolOutput) o;
