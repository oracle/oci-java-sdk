...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ExportRunbookVersionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExportRunbookVersionRequest.
 */
...
public class ExportRunbookVersionRequest
    ...
    public static class Builder
        ...
        public ExportRunbookVersionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ExportRunbookVersionRequest(exportRunbookVersionDetails, runbookVersionId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
