...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListFleetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFleetsRequest.
 */
...
public class ListFleetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListFleetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFleetsRequest(lifecycleState, compartmentId, fleetType, applicationType, product, environmentType, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
