...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = JsonOutput.Builder.class)
...
public final class JsonOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JsonOutput model) {
