...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StringOutput.Builder.class)
...
public final class StringOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StringOutput model) {
    ...
    public boolean equals(Object o) {
        ...
        StringOutput other = (StringOutput) o;
