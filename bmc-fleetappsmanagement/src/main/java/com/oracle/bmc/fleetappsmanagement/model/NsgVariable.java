...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = NsgVariable.Builder.class)
...
public final class NsgVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private NsgVariableDependsOn dependsOn;

        public Builder dependsOn(NsgVariableDependsOn dependsOn) {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NsgVariable model) {
    ...
    public NsgVariable(
            ...
            Boolean isRequired,
            String visible,
            NsgVariableDependsOn dependsOn) {
        super(title, description, isRequired, visible);
        this.dependsOn = dependsOn;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final NsgVariableDependsOn dependsOn;

    public NsgVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NsgVariable)) {
            return false;
        }

        NsgVariable other = (NsgVariable) o;
