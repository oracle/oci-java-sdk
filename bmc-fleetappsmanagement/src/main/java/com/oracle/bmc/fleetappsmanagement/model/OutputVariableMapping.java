...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OutputVariableMapping.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class OutputVariableMapping
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "outputVariableDetails"})
    public OutputVariableMapping(String name, OutputVariableDetails outputVariableDetails) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public OutputVariableMapping build() {
            OutputVariableMapping model =
                    new OutputVariableMapping(this.name, this.outputVariableDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OutputVariableMapping model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutputVariableMapping)) {
            return false;
        }

        OutputVariableMapping other = (OutputVariableMapping) o;
        return java.util.Objects.equals(this.name, other.name)
                && java.util.Objects.equals(this.outputVariableDetails, other.outputVariableDetails)
                && super.equals(other);
    }
