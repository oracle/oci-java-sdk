...
public class FleetAppsManagementOperationsWaiters {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetPatchRequest, GetPatchResponse> forPatch(
    ...
    public com.oracle.bmc.waiter.Waiter<GetPatchRequest, GetPatchResponse> forPatch(
            GetPatchRequest request,
            com.oracle.bmc.fleetappsmanagement.model.Patch.LifecycleState targetState,
    ...
    // Helper method to create a new Waiter for Patch.
    private com.oracle.bmc.waiter.Waiter<GetPatchRequest, GetPatchResponse> forPatch(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetPatchRequest request,
            final com.oracle.bmc.fleetappsmanagement.model.Patch.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.fleetappsmanagement.model.Patch.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetPatchRequest, GetPatchResponse>() {
                            @Override
                            public GetPatchResponse apply(GetPatchRequest request) {
                                return client.getPatch(request);
                            }
                        },
                        new java.util.function.Predicate<GetPatchResponse>() {
                            @Override
                            public boolean test(GetPatchResponse response) {
                                return targetStatesSet.contains(
                                        response.getPatch().getLifecycleState());
                            }
                        },
