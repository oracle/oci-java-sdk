...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListRunbookVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRunbookVersionsRequest.
 */
...
public class ListRunbookVersionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListRunbookVersionsRequest buildWithoutInvocationCallback() {
            ...
            request.name = name;
            return request;
            // new ListRunbookVersionsRequest(compartmentId, lifecycleState, runbookId, id, limit, page, sortOrder, sortBy, opcRequestId, name);
        }
    }
