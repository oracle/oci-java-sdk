...
public final class RunbookSummary
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder type(Runbook.Type type) {
            this.type = type;
         ...
         * @return this builder
         */
        public Builder lifecycleState(Runbook.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public RunbookSummary build() {
            RunbookSummary model =
                    new RunbookSummary(
                            this.id,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RunbookSummary model) {
    ...
    /** The type of the runbook. */
    @com.fasterxml.jackson.annotation.JsonProperty("type")
    private final Runbook.Type type;
     ...
     * @return the value
     */
    public Runbook.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunbookSummary)) {
            return false;
        }

        RunbookSummary other = (RunbookSummary) o;
