...
public class ChangeFleetCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeFleetCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeFleetCompartmentResponse build() {
            return new ChangeFleetCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeFleetCompartmentResponse)) {
            return false;
        }

        ChangeFleetCompartmentResponse other = (ChangeFleetCompartmentResponse) o;
