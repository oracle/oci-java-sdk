...
/**
 * Set of rules that are used to calculate the compliance status of the product. Specific rules will
 * take precedence over broader rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CompliancePolicyRule.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CompliancePolicyRule
    ...
    public static class Builder {
        ...
        public CompliancePolicyRule build() {
            CompliancePolicyRule model =
                    new CompliancePolicyRule(
                            this.id,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompliancePolicyRule model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompliancePolicyRule(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompliancePolicyRule)) {
            return false;
        }

        CompliancePolicyRule other = (CompliancePolicyRule) o;
