...
public final class UpdateRunbookDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public UpdateRunbookDetails build() {
            UpdateRunbookDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateRunbookDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateRunbookDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRunbookDetails)) {
            return false;
        }
