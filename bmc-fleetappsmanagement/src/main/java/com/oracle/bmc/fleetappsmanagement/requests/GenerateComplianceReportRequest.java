...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/GenerateComplianceReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GenerateComplianceReportRequest.
 */
...
public class GenerateComplianceReportRequest
    ...
    public static class Builder
        ...
        public GenerateComplianceReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GenerateComplianceReportRequest(generateComplianceReportDetails, fleetId, opcRetryToken, opcRequestId);
        }
    }
