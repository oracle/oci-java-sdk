...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/GetMaintenanceWindowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMaintenanceWindowRequest.
 */
...
public class GetMaintenanceWindowRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMaintenanceWindowRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetMaintenanceWindowRequest
         */
        public GetMaintenanceWindowRequest build() {
            GetMaintenanceWindowRequest request = buildWithoutInvocationCallback();
        ...
        public GetMaintenanceWindowRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetMaintenanceWindowRequest(maintenanceWindowId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().maintenanceWindowId(maintenanceWindowId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetMaintenanceWindowRequest other = (GetMaintenanceWindowRequest) o;
