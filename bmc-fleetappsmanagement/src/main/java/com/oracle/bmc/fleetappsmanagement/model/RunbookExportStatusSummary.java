...
/**
 * Summary of the Runbook export status. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RunbookExportStatusSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RunbookExportStatusSummary
    ...
    public RunbookExportStatusSummary(
            String trackingId,
            String runbookId,
            String runbookName,
    ...
    public static class Builder {
        ...
        public RunbookExportStatusSummary build() {
            RunbookExportStatusSummary model =
                    new RunbookExportStatusSummary(
                            this.trackingId,
                            this.runbookId,
                            this.runbookName,
                            this.runbookVersion,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RunbookExportStatusSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RunbookExportStatusSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunbookExportStatusSummary)) {
            return false;
        }

        RunbookExportStatusSummary other = (RunbookExportStatusSummary) o;
