...
public final class UpdateSchedulerDefinitionDetails
    ...
    public static class Builder {
        ...
        public UpdateSchedulerDefinitionDetails build() {
            UpdateSchedulerDefinitionDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSchedulerDefinitionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSchedulerDefinitionDetails)) {
            return false;
        }
