...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CatalogTemplateResultConfig.Builder.class)
...
public final class CatalogTemplateResultConfig extends CatalogResultPayload {
    ...
    public static class Builder {
        ...
        public CatalogTemplateResultConfig build() {
            CatalogTemplateResultConfig model =
                    new CatalogTemplateResultConfig(this.workingDirectory, this.templateId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CatalogTemplateResultConfig model) {
    ...
    @Deprecated
    public CatalogTemplateResultConfig(String workingDirectory, String templateId) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CatalogTemplateResultConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogTemplateResultConfig)) {
            return false;
        }

        CatalogTemplateResultConfig other = (CatalogTemplateResultConfig) o;
