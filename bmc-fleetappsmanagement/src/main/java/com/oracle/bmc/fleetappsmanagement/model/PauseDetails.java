...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "kind",
        defaultImpl = PauseDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UserActionBasedPauseDetails.class,
            name = "USER_ACTION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = TimeBasedPauseDetails.class,
            name = "TIME_BASED")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class PauseDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected PauseDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PauseDetails)) {
            return false;
        }

        PauseDetails other = (PauseDetails) o;
