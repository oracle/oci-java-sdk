...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/UpdateFleetCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateFleetCredentialRequest.
 */
...
public class UpdateFleetCredentialRequest
    ...
    public static class Builder
        ...
        public UpdateFleetCredentialRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateFleetCredentialRequest(fleetCredentialId, fleetId, updateFleetCredentialDetails, ifMatch, opcRequestId);
        }
    }
