...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PatchFileObjectStorageBucketContentDetails.Builder.class)
...
public final class PatchFileObjectStorageBucketContentDetails extends PatchFileContentDetails {
    ...
    public static class Builder {
        ...
        public PatchFileObjectStorageBucketContentDetails build() {
            PatchFileObjectStorageBucketContentDetails model =
                    new PatchFileObjectStorageBucketContentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchFileObjectStorageBucketContentDetails model) {
    ...
    @Deprecated
    public PatchFileObjectStorageBucketContentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PatchFileObjectStorageBucketContentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchFileObjectStorageBucketContentDetails)) {
            return false;
        }

        PatchFileObjectStorageBucketContentDetails other =
                (PatchFileObjectStorageBucketContentDetails) o;
