...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/DeletePatchExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePatchRequest.
 */
...
public class DeletePatchRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeletePatchRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeletePatchRequest(patchId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().patchId(patchId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
