...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceShapeVariable.Builder.class)
...
public final class InstanceShapeVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private InstanceShapeVariableDependsOn dependsOn;

        public Builder dependsOn(InstanceShapeVariableDependsOn dependsOn) {
        ...
        public InstanceShapeVariable build() {
            InstanceShapeVariable model =
                    new InstanceShapeVariable(
                            this.title,
                            this.description,
                            this.isRequired,
                            this.visible,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceShapeVariable model) {
    ...
    @Deprecated
    public InstanceShapeVariable(
            String title,
            String description,
            Boolean isRequired,
            String visible,
            String pattern,
            InstanceShapeVariableDependsOn dependsOn) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final InstanceShapeVariableDependsOn dependsOn;

    public InstanceShapeVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceShapeVariable(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceShapeVariable)) {
            return false;
        }

        InstanceShapeVariable other = (InstanceShapeVariable) o;
