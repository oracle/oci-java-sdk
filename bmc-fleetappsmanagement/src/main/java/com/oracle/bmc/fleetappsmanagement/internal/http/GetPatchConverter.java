...
public class GetPatchConverter {
    ...
    public static com.oracle.bmc.fleetappsmanagement.requests.GetPatchRequest interceptRequest(
            com.oracle.bmc.fleetappsmanagement.requests.GetPatchRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.fleetappsmanagement.responses.GetPatchResponse>() {
                            @Override
                            public com.oracle.bmc.fleetappsmanagement.responses.GetPatchResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetappsmanagement.responses.GetPatchResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.fleetappsmanagement.model.Patch
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
