...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IdentityDomainVariable.Builder.class)
...
public final class IdentityDomainVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private IdentityDomainVariableDependsOn dependsOn;

        public Builder dependsOn(IdentityDomainVariableDependsOn dependsOn) {
        ...
        public IdentityDomainVariable build() {
            IdentityDomainVariable model =
                    new IdentityDomainVariable(
                            this.title,
                            this.description,
                            this.isRequired,
                            this.visible,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityDomainVariable model) {
    ...
    @Deprecated
    public IdentityDomainVariable(
            String title,
            String description,
            Boolean isRequired,
            String visible,
            String pattern,
            IdentityDomainVariableDependsOn dependsOn) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final IdentityDomainVariableDependsOn dependsOn;

    public IdentityDomainVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IdentityDomainVariable(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityDomainVariable)) {
            return false;
        }

        IdentityDomainVariable other = (IdentityDomainVariable) o;
