...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CustomSchedule.class,
            name = "CUSTOM"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = MaintenanceWindowSchedule.class,
...
public class Schedule extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"executionStartdate"})
    protected Schedule(java.util.Date executionStartdate) {
        super();
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.executionStartdate, other.executionStartdate)
                && super.equals(other);
    }
