...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdatePropertyDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdatePropertyDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "selection", "valueType", "values"})
    ...
    public static class Builder {
        ...
        public UpdatePropertyDetails build() {
            UpdatePropertyDetails model =
                    new UpdatePropertyDetails(
                            this.displayName, this.selection, this.valueType, this.values);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePropertyDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePropertyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePropertyDetails)) {
            return false;
        }

        UpdatePropertyDetails other = (UpdatePropertyDetails) o;
