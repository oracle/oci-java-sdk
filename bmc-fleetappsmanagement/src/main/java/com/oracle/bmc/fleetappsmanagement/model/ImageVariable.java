...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ImageVariable.Builder.class)
...
public final class ImageVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private ImageVariableDependsOn dependsOn;

        public Builder dependsOn(ImageVariableDependsOn dependsOn) {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImageVariable model) {
    ...
    public ImageVariable(
            ...
            String visible,
            String pattern,
            ImageVariableDependsOn dependsOn) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final ImageVariableDependsOn dependsOn;

    public ImageVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImageVariable)) {
            return false;
        }

        ImageVariable other = (ImageVariable) o;
