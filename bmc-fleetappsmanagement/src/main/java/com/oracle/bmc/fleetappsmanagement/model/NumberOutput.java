...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = NumberOutput.Builder.class)
...
public final class NumberOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NumberOutput model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NumberOutput)) {
            return false;
        }

        NumberOutput other = (NumberOutput) o;
