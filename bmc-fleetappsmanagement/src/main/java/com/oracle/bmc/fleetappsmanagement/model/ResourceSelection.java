...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = ResourceSelection.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DynamicResourceSelection.class,
            name = "DYNAMIC"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ManualResourceSelection.class,
            name = "MANUAL")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class ResourceSelection extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ResourceSelection() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceSelection)) {
            return false;
        }

        ResourceSelection other = (ResourceSelection) o;
