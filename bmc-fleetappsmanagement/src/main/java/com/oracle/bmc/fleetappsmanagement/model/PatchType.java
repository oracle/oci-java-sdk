...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PatchType.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PatchType extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"platformConfigurationId"})
    public PatchType(String platformConfigurationId) {
        super();
    ...
    public static class Builder {
        ...
        public PatchType build() {
            PatchType model = new PatchType(this.platformConfigurationId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchType model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchType)) {
            return false;
        }

        PatchType other = (PatchType) o;
