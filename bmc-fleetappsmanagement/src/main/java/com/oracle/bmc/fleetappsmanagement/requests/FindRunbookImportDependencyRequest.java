...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/FindRunbookImportDependencyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use FindRunbookImportDependencyRequest.
 */
...
public class FindRunbookImportDependencyRequest
    ...
    public static class Builder
        ...
        public FindRunbookImportDependencyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new FindRunbookImportDependencyRequest(findRunbookImportDependencyDetails, limit, page, opcRequestId);
        }
    }
