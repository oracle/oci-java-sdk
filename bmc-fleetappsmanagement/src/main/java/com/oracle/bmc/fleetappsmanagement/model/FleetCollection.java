...
/**
 * Results of a fleet search. Contains both FleetSummary items and other information, such as
 * metadata. <br>
...
public final class FleetCollection
    ...
    public static class Builder {
        ...
        public FleetCollection build() {
            FleetCollection model = new FleetCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FleetCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FleetCollection)) {
            return false;
        }

        FleetCollection other = (FleetCollection) o;
