...
/**
 * Summary of the Runbook import status. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RunbookImportStatusSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RunbookImportStatusSummary
    ...
    public RunbookImportStatusSummary(
            String trackingId,
            String runbookId,
            String runbookName,
    ...
    public static class Builder {
        ...
        public RunbookImportStatusSummary build() {
            RunbookImportStatusSummary model =
                    new RunbookImportStatusSummary(
                            this.trackingId,
                            this.runbookId,
                            this.runbookName,
                            this.runbookVersion,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RunbookImportStatusSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RunbookImportStatusSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunbookImportStatusSummary)) {
            return false;
        }

        RunbookImportStatusSummary other = (RunbookImportStatusSummary) o;
