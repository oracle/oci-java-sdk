...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = TagVariable.Builder.class)
...
public final class TagVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private TagVariableDependsOn dependsOn;

        public Builder dependsOn(TagVariableDependsOn dependsOn) {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TagVariable model) {
    ...
    public TagVariable(
            ...
            Boolean isRequired,
            String visible,
            TagVariableDependsOn dependsOn) {
        super(title, description, isRequired, visible);
        this.dependsOn = dependsOn;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final TagVariableDependsOn dependsOn;

    public TagVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TagVariable)) {
            return false;
        }

        TagVariable other = (TagVariable) o;
