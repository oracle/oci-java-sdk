...
public class GetOnboardingResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code Onboarding} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOnboardingResponse> {
         ...
         */
        @Override
        public Builder copy(GetOnboardingResponse o) {
         ...
         */
        @Override
        public GetOnboardingResponse build() {
            return new GetOnboardingResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, onboarding);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOnboardingResponse)) {
            return false;
        }

        GetOnboardingResponse other = (GetOnboardingResponse) o;
