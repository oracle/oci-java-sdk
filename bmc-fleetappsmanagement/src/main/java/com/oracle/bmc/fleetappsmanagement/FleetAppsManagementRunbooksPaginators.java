...
public class FleetAppsManagementRunbooksPaginators {
     ...
     * listRunbookExportStatuses operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.fleetappsmanagement.model.RunbookExportStatusSummary} objects contained in
     * responses from the listRunbookExportStatuses operation. This iterable will fetch more data
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRunbookImportStatuses operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.fleetappsmanagement.model.RunbookImportStatusSummary} objects contained in
     * responses from the listRunbookImportStatuses operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listRunbookVersions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
     *     received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.fleetappsmanagement.model.RunbookVersionSummary} objects contained in
     * responses from the listRunbookVersions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
