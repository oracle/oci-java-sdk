...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "kind",
        defaultImpl = RunOnDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = SelfHostedInstanceRunOnDetails.class,
            name = "SELF_HOSTED_INSTANCES"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ScheduleInstanceRunOnDetails.class,
...
public class RunOnDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected RunOnDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunOnDetails)) {
            return false;
        }

        RunOnDetails other = (RunOnDetails) o;
