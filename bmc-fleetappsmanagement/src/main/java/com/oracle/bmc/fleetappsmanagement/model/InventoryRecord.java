...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = InventoryRecord.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class InventoryRecord extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InventoryRecord model) {
    ...
    public boolean equals(Object o) {
        ...
        InventoryRecord other = (InventoryRecord) o;
