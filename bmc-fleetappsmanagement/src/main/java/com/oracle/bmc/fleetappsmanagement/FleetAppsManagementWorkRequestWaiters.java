 ...
 * resources of FleetAppsManagementWorkRequest.
 *
 * <p>The default configuration used is defined by {@link
 * com.oracle.bmc.waiter.Waiters.Waiters#DEFAULT_POLLING_WAITER}.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250228")
public class FleetAppsManagementWorkRequestWaiters {
    private final java.util.concurrent.ExecutorService executorService;
    private final FleetAppsManagementWorkRequest client;

    public FleetAppsManagementWorkRequestWaiters(
            java.util.concurrent.ExecutorService executorService,
            FleetAppsManagementWorkRequest client) {
