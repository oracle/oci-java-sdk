...
public final class FleetTargetSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public FleetTargetSummary build() {
            FleetTargetSummary model =
                    new FleetTargetSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.version,
    ...
    public boolean equals(Object o) {
        ...
        FleetTargetSummary other = (FleetTargetSummary) o;
