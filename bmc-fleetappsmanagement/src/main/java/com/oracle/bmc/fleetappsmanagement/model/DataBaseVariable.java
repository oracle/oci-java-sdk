...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DataBaseVariable.Builder.class)
...
public final class DataBaseVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private DataBaseVariableDependsOn dependsOn;

        public Builder dependsOn(DataBaseVariableDependsOn dependsOn) {
        ...
        public DataBaseVariable build() {
            DataBaseVariable model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataBaseVariable model) {
    ...
    public DataBaseVariable(
            ...
            Boolean isRequired,
            String visible,
            DataBaseVariableDependsOn dependsOn) {
        super(title, description, isRequired, visible);
        this.dependsOn = dependsOn;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final DataBaseVariableDependsOn dependsOn;

    public DataBaseVariableDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataBaseVariable)) {
            return false;
        }

        DataBaseVariable other = (DataBaseVariable) o;
