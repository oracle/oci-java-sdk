...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListSchedulerExecutionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSchedulerExecutionsRequest.
 */
...
public class ListSchedulerExecutionsRequest
    ...
    public static class Builder
        ...
        public ListSchedulerExecutionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSchedulerExecutionsRequest(compartmentId, displayName, timeScheduledGreaterThanOrEqualTo, timeScheduledLessThan, schedulerDefintionId, schedulerJobId, resourceId, runbookId, runbookVersionName, substate, lifecycleOperation, compartmentIdInSubtree, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
