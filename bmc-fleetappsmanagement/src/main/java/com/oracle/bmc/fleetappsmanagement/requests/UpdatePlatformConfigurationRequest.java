...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/UpdatePlatformConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePlatformConfigurationRequest.
 */
...
public class UpdatePlatformConfigurationRequest
    ...
    public static class Builder
        ...
        public UpdatePlatformConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePlatformConfigurationRequest(platformConfigurationId, updatePlatformConfigurationDetails, ifMatch, opcRequestId);
        }
    }
