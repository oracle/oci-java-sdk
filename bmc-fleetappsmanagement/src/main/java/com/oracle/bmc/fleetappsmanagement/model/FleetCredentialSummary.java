...
/**
 * Summary of the FleetCredential. <br>
...
public final class FleetCredentialSummary
    ...
    public static class Builder {
        ...
        public FleetCredentialSummary build() {
            FleetCredentialSummary model =
                    new FleetCredentialSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FleetCredentialSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FleetCredentialSummary)) {
            return false;
        }

        FleetCredentialSummary other = (FleetCredentialSummary) o;
