...
public final class ProductConfigCategoryDetails extends ConfigCategoryDetails {
    ...
    public static class Builder {
         ...
         * credentials for Oracle WebLogic Application server. This property is not applicable if
         * isSoftlink is set to true.
         */
         ...
         * concurrent manager can be the components of the Oracle E-Business Suite. This property is
         * not applicable if isSoftlink is set to true.
         */
         ...
         * you have created that are compatible with the present one. This property is not
         * applicable if isSoftlink is set to true.
         */
        ...
        /**
         * Patch Types associated with this Product. This property is not applicable if isSoftlink
         * is set to true.
         */
        ...
        /**
         * The OCID of the product that would be the target for the softlink. This property is
     ...
     * for Oracle WebLogic Application server. This property is not applicable if isSoftlink is set
     * to true.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("credentials")
     ...
     * manager can be the components of the Oracle E-Business Suite. This property is not applicable
     * if isSoftlink is set to true.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("components")
     ...
     * have created that are compatible with the present one. This property is not applicable if
     * isSoftlink is set to true.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compatibleProducts")
    ...
    /**
     * Patch Types associated with this Product. This property is not applicable if isSoftlink is
     * set to true.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("patchTypes")
