...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/RequestTargetDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestTargetDiscoveryRequest.
 */
...
public class RequestTargetDiscoveryRequest
    ...
    public static class Builder
        ...
        public RequestTargetDiscoveryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RequestTargetDiscoveryRequest(requestTargetDiscoveryDetails, fleetId, opcRetryToken, opcRequestId);
        }
    }
