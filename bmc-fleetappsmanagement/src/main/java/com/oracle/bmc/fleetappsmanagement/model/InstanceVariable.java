...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = InstanceVariable.Builder.class)
...
public final class InstanceVariable extends BaseVariable {
    ...
    public static class Builder {
        ...
        private InstanceVariableDependsOn dependsOn;

        public Builder dependsOn(InstanceVariableDependsOn dependsOn) {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceVariable model) {
    ...
    public InstanceVariable(
            ...
            Boolean isRequired,
            String visible,
            InstanceVariableDependsOn dependsOn) {
        super(title, description, isRequired, visible);
        this.dependsOn = dependsOn;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final InstanceVariableDependsOn dependsOn;

    public InstanceVariableDependsOn getDependsOn() {
        return dependsOn;
    }
