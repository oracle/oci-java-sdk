...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ListOutput.Builder.class)
...
public final class ListOutput extends BaseOutput {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ListOutput model) {
