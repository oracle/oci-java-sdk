...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FleetCredential.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class FleetCredential extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FleetCredential model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FleetCredential)) {
            return false;
        }

        FleetCredential other = (FleetCredential) o;
