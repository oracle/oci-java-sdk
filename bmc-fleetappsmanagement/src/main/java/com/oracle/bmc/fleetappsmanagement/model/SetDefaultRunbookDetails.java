...
/**
 * Request to set default Runbook <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SetDefaultRunbookDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SetDefaultRunbookDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"runbookId"})
    public SetDefaultRunbookDetails(String runbookId) {
        super();
    ...
    public static class Builder {
        ...
        public SetDefaultRunbookDetails build() {
            SetDefaultRunbookDetails model = new SetDefaultRunbookDetails(this.runbookId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SetDefaultRunbookDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SetDefaultRunbookDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetDefaultRunbookDetails)) {
            return false;
        }

        SetDefaultRunbookDetails other = (SetDefaultRunbookDetails) o;
