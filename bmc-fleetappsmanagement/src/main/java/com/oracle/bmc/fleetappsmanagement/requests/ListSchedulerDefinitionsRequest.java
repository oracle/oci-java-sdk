...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListSchedulerDefinitionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSchedulerDefinitionsRequest.
 */
...
public class ListSchedulerDefinitionsRequest
    ...
    public static class Builder
        ...
        public ListSchedulerDefinitionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSchedulerDefinitionsRequest(compartmentId, lifecycleState, displayName, product, id, maintenanceWindowId, runbookId, fleetId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
