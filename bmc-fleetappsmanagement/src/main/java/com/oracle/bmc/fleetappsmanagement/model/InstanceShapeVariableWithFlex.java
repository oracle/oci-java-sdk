...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceShapeVariableWithFlex.Builder.class)
...
public final class InstanceShapeVariableWithFlex extends BaseVariable {
    ...
    public static class Builder {
        ...
        private InstanceShapeVariableWithFlexDependsOn dependsOn;

        public Builder dependsOn(InstanceShapeVariableWithFlexDependsOn dependsOn) {
        ...
        public InstanceShapeVariableWithFlex build() {
            InstanceShapeVariableWithFlex model =
                    new InstanceShapeVariableWithFlex(
                            this.title,
                            this.description,
                            this.isRequired,
                            this.visible,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceShapeVariableWithFlex model) {
    ...
    @Deprecated
    public InstanceShapeVariableWithFlex(
            String title,
            String description,
            Boolean isRequired,
            String visible,
            String pattern,
            InstanceShapeVariableWithFlexDependsOn dependsOn) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dependsOn")
    private final InstanceShapeVariableWithFlexDependsOn dependsOn;

    public InstanceShapeVariableWithFlexDependsOn getDependsOn() {
        return dependsOn;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceShapeVariableWithFlex(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceShapeVariableWithFlex)) {
            return false;
        }

        InstanceShapeVariableWithFlex other = (InstanceShapeVariableWithFlex) o;
