...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListStepsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListStepsRequest.
 */
...
public class ListStepsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListStepsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListStepsRequest(schedulerJobId, jobActivityId, resourceTaskId, stepName, targetName, sequence, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
