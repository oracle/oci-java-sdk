...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "sourceType",
        defaultImpl = ConfigFileDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStorageBucketConfigFileDetails.class,
            name = "OBJECT_STORAGE_BUCKET")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class ConfigFileDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ConfigFileDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigFileDetails)) {
            return false;
        }

        ConfigFileDetails other = (ConfigFileDetails) o;
