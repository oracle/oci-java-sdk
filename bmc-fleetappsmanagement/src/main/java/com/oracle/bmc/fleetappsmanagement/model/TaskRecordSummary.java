...
public final class TaskRecordSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public TaskRecordSummary(
            String id,
            String displayName,
            String description,
            TaskRecord.Type type,
            TaskRecord.LifecycleState lifecycleState,
    ...
    public static class Builder {
         ...
         * @return this builder
         **/
        public Builder type(TaskRecord.Type type) {
            this.type = type;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(TaskRecord.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public TaskRecordSummary build() {
            TaskRecordSummary model =
                    new TaskRecordSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TaskRecordSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("type")
    private final TaskRecord.Type type;

    /**
     * Task type.
     * @return the value
     **/
    public TaskRecord.Type getType() {
        return type;
    }
     ...
     * @return the value
     **/
    public TaskRecord.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskRecordSummary)) {
            return false;
        }

        TaskRecordSummary other = (TaskRecordSummary) o;
