...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InputFileObjectStorageBucketContentDetails.Builder.class)
...
public final class InputFileObjectStorageBucketContentDetails extends InputFileContentDetails {
    ...
    public static class Builder {
        ...
        public InputFileObjectStorageBucketContentDetails build() {
            InputFileObjectStorageBucketContentDetails model =
                    new InputFileObjectStorageBucketContentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InputFileObjectStorageBucketContentDetails model) {
    ...
    @Deprecated
    public InputFileObjectStorageBucketContentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InputFileObjectStorageBucketContentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InputFileObjectStorageBucketContentDetails)) {
            return false;
        }

        InputFileObjectStorageBucketContentDetails other =
                (InputFileObjectStorageBucketContentDetails) o;
