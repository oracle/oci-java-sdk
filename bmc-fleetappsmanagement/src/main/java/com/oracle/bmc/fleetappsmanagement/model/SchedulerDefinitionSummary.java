...
/**
 * Summary of the SchedulerDefinition. <br>
...
public final class SchedulerDefinitionSummary
    ...
    public SchedulerDefinitionSummary(
            String id,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public SchedulerDefinitionSummary build() {
            SchedulerDefinitionSummary model =
                    new SchedulerDefinitionSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SchedulerDefinitionSummary model) {
    ...
    /** The current state of the SchedulerDefinition. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final SchedulerDefinition.LifecycleState lifecycleState;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SchedulerDefinitionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SchedulerDefinitionSummary)) {
            return false;
        }

        SchedulerDefinitionSummary other = (SchedulerDefinitionSummary) o;
