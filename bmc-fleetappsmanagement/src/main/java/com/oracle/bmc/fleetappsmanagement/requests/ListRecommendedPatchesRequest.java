...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListRecommendedPatchesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRecommendedPatchesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250228")
public class ListRecommendedPatchesRequest
    ...
    public enum PatchLevel {
        ...
        public static PatchLevel create(String key) {
            ...
            throw new IllegalArgumentException("Invalid PatchLevel: " + key);
        }
    };
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListRecommendedPatchesRequest, java.lang.Void> {
         ...
         * Patch level.
         */
        private PatchLevel patchLevel = null;
         ...
         * @return this builder instance
         */
        public Builder copy(ListRecommendedPatchesRequest o) {
            compartmentId(o.getCompartmentId());
            targetId(o.getTargetId());
            targetName(o.getTargetName());
            patchLevel(o.getPatchLevel());
        ...
        /**
         * Build the instance of ListRecommendedPatchesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListRecommendedPatchesRequest
         */
        public ListRecommendedPatchesRequest build() {
            ListRecommendedPatchesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListRecommendedPatchesRequest
         */
        public ListRecommendedPatchesRequest buildWithoutInvocationCallback() {
            ListRecommendedPatchesRequest request = new ListRecommendedPatchesRequest();
            request.compartmentId = compartmentId;
            request.targetId = targetId;
            request.targetName = targetName;
            request.patchLevel = patchLevel;
            ...
            return request;
            // new ListRecommendedPatchesRequest(compartmentId, targetId, targetName, patchLevel, severity, patchType, patchId, limit, page, sortOrder, opcRequestId, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecommendedPatchesRequest)) {
            return false;
        }

        ListRecommendedPatchesRequest other = (ListRecommendedPatchesRequest) o;
