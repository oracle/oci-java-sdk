...
public class GetSchedulerDefinitionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code SchedulerDefinition} instance. */
    ...
    private GetSchedulerDefinitionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetSchedulerDefinitionResponse o) {
         ...
         */
        @Override
        public GetSchedulerDefinitionResponse build() {
            return new GetSchedulerDefinitionResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, schedulerDefinition);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSchedulerDefinitionResponse)) {
            return false;
        }

        GetSchedulerDefinitionResponse other = (GetSchedulerDefinitionResponse) o;
