...
public class RequestResourceValidationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RequestResourceValidationConverter.class);

    public static com.oracle.bmc.fleetappsmanagement.requests.RequestResourceValidationRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.fleetappsmanagement.requests.RequestResourceValidationRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getFleetId()))
                        .path("actions")
                        .path("requestResourceValidation");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.fleetappsmanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetappsmanagement.responses.RequestResourceValidationResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fleetappsmanagement.responses
                                                .RequestResourceValidationResponse.Builder
                                        builder =
                                                com.oracle.bmc.fleetappsmanagement.responses
                                                        .RequestResourceValidationResponse.builder()
