...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RequestResourceValidationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RequestResourceValidationDetails
    ...
    public static class Builder {
        ...
        public RequestResourceValidationDetails build() {
            RequestResourceValidationDetails model =
                    new RequestResourceValidationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RequestResourceValidationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestResourceValidationDetails)) {
            return false;
        }

        RequestResourceValidationDetails other = (RequestResourceValidationDetails) o;
