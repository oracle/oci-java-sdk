...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListCatalogItemsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCatalogItemsRequest.
 */
...
public class ListCatalogItemsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCatalogItemsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCatalogItemsRequest(compartmentId, configSourceType, lifecycleState, sortOrder, sortBy, displayName, limit, page, opcRequestId, catalogListingId, catalogListingVersionCriteria, packageType, shouldListPublicItems);
        }
    }
