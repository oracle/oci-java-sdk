...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ListInventoryRecordsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInventoryRecordsRequest.
 */
...
public class ListInventoryRecordsRequest
    ...
    public static class Builder
        ...
        public ListInventoryRecordsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListInventoryRecordsRequest(compartmentId, compartmentIdInSubtree, fleetId, resourceId, limit, page, sortOrder, opcRequestId, isDetailsRequired, sortBy);
        }
    }
