...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFleetCredentialDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateFleetCredentialDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "entitySpecifics", "user", "password"})
    public UpdateFleetCredentialDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateFleetCredentialDetails build() {
            UpdateFleetCredentialDetails model =
                    new UpdateFleetCredentialDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateFleetCredentialDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFleetCredentialDetails)) {
            return false;
        }

        UpdateFleetCredentialDetails other = (UpdateFleetCredentialDetails) o;
