...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageBucketContentDetails.Builder.class)
...
public final class ObjectStorageBucketContentDetails extends ContentDetails {
    ...
    public static class Builder {
        ...
        public ObjectStorageBucketContentDetails build() {
            ObjectStorageBucketContentDetails model =
                    new ObjectStorageBucketContentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageBucketContentDetails model) {
    ...
    @Deprecated
    public ObjectStorageBucketContentDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageBucketContentDetails)) {
            return false;
        }

        ObjectStorageBucketContentDetails other = (ObjectStorageBucketContentDetails) o;
