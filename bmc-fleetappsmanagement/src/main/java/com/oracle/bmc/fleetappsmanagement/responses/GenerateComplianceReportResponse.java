...
public class GenerateComplianceReportResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GenerateComplianceReportResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GenerateComplianceReportResponse o) {
         ...
         */
        @Override
        public GenerateComplianceReportResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateComplianceReportResponse)) {
            return false;
        }

        GenerateComplianceReportResponse other = (GenerateComplianceReportResponse) o;
