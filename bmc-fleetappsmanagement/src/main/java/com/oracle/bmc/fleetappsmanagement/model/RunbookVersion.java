...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RunbookVersion.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class RunbookVersion extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RunbookVersion model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunbookVersion)) {
            return false;
        }

        RunbookVersion other = (RunbookVersion) o;
