...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetappsmanagement/ChangeCatalogItemCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCatalogItemCompartmentRequest.
 */
...
public class ChangeCatalogItemCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeCatalogItemCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeCatalogItemCompartmentRequest(catalogItemId, changeCatalogItemCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
