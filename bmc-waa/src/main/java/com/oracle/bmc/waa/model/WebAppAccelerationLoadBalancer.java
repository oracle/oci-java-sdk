...
/**
 * WebAppAcceleration to a LoadBalancer resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = WebAppAccelerationLoadBalancer.Builder.class)
...
public final class WebAppAccelerationLoadBalancer extends WebAppAcceleration {
    ...
    public static class Builder {
        ...
        public WebAppAccelerationLoadBalancer build() {
            WebAppAccelerationLoadBalancer model =
                    new WebAppAccelerationLoadBalancer(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WebAppAccelerationLoadBalancer model) {
    ...
    @Deprecated
    public WebAppAccelerationLoadBalancer(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WebAppAccelerationLoadBalancer(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAppAccelerationLoadBalancer)) {
            return false;
        }

        WebAppAccelerationLoadBalancer other = (WebAppAccelerationLoadBalancer) o;
