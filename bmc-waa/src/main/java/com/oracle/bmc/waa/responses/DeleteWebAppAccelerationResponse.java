...
public class DeleteWebAppAccelerationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteWebAppAccelerationResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteWebAppAccelerationResponse o) {
         ...
         */
        @Override
        public DeleteWebAppAccelerationResponse build() {
            return new DeleteWebAppAccelerationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWebAppAccelerationResponse)) {
            return false;
        }

        DeleteWebAppAccelerationResponse other = (DeleteWebAppAccelerationResponse) o;
