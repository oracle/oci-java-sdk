...
/**
 * A resource connecting a WebAppAccelerationPolicy to a backend of particular type, applying that
 * policy's coverage to the backend. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = WebAppAcceleration.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = WebAppAccelerationLoadBalancer.class,
            name = "LOAD_BALANCER")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class WebAppAcceleration extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * WebAppAccelerationPolicy, which is attached to the resource.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAppAcceleration)) {
            return false;
        }

        WebAppAcceleration other = (WebAppAcceleration) o;
