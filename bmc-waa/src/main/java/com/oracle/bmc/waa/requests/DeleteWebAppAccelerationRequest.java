...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waa/DeleteWebAppAccelerationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteWebAppAccelerationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211230")
public class DeleteWebAppAccelerationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteWebAppAccelerationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteWebAppAccelerationRequest o) {
        ...
        /**
         * Build the instance of DeleteWebAppAccelerationRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteWebAppAccelerationRequest
         */
        public DeleteWebAppAccelerationRequest build() {
            DeleteWebAppAccelerationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteWebAppAccelerationRequest
         */
        public DeleteWebAppAccelerationRequest buildWithoutInvocationCallback() {
            DeleteWebAppAccelerationRequest request = new DeleteWebAppAccelerationRequest();
            request.webAppAccelerationId = webAppAccelerationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteWebAppAccelerationRequest(webAppAccelerationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWebAppAccelerationRequest)) {
            return false;
        }

        DeleteWebAppAccelerationRequest other = (DeleteWebAppAccelerationRequest) o;
