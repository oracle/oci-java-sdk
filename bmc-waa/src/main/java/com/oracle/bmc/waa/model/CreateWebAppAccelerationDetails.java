...
/**
 * The information about new WebAppAcceleration. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CreateWebAppAccelerationDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateWebAppAccelerationLoadBalancerDetails.class,
            name = "LOAD_BALANCER")
})
...
public class CreateWebAppAccelerationDetails
    ...
    protected CreateWebAppAccelerationDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateWebAppAccelerationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateWebAppAccelerationDetails)) {
            return false;
        }

        CreateWebAppAccelerationDetails other = (CreateWebAppAccelerationDetails) o;
