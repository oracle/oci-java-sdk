...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waa/DeleteWebAppAccelerationPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteWebAppAccelerationPolicyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211230")
public class DeleteWebAppAccelerationPolicyRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteWebAppAccelerationPolicyRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteWebAppAccelerationPolicyRequest o) {
        ...
        /**
         * Build the instance of DeleteWebAppAccelerationPolicyRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteWebAppAccelerationPolicyRequest
         */
        public DeleteWebAppAccelerationPolicyRequest build() {
            DeleteWebAppAccelerationPolicyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteWebAppAccelerationPolicyRequest
         */
        public DeleteWebAppAccelerationPolicyRequest buildWithoutInvocationCallback() {
            DeleteWebAppAccelerationPolicyRequest request =
                    new DeleteWebAppAccelerationPolicyRequest();
            request.webAppAccelerationPolicyId = webAppAccelerationPolicyId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteWebAppAccelerationPolicyRequest(webAppAccelerationPolicyId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWebAppAccelerationPolicyRequest)) {
            return false;
        }

        DeleteWebAppAccelerationPolicyRequest other = (DeleteWebAppAccelerationPolicyRequest) o;
