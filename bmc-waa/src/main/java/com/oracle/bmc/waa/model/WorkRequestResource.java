...
/**
 * A resource created or operated on by a WorkRequest. <br>
...
public final class WorkRequestResource
    ...
    public static class Builder {
        ...
        /**
         * The way in which this resource is affected by the work tracked in the WorkRequest. A
         ...
         * resource the WorkRequest affects.
         */
    ...
    /**
     * The way in which this resource is affected by the work tracked in the WorkRequest. A resource
     * being created, updated, or deleted will remain in the IN_PROGRESS state until work is
     * complete for that resource at which point it will transition to CREATED, UPDATED, or DELETED,
     * respectively.
     */
