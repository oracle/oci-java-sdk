...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waa/UpdateWebAppAccelerationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateWebAppAccelerationRequest.
 */
...
public class UpdateWebAppAccelerationRequest
    ...
    public com.oracle.bmc.waa.model.UpdateWebAppAccelerationDetails getBody$() {
        return updateWebAppAccelerationDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateWebAppAccelerationDetails(
                com.oracle.bmc.waa.model.UpdateWebAppAccelerationDetails
                        updateWebAppAccelerationDetails) {
            this.updateWebAppAccelerationDetails = updateWebAppAccelerationDetails;
            return this;
        }
        ...
        public Builder copy(UpdateWebAppAccelerationRequest o) {
            ...
            updateWebAppAccelerationDetails(o.getUpdateWebAppAccelerationDetails());
         ...
         */
        public UpdateWebAppAccelerationRequest build() {
            UpdateWebAppAccelerationRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.waa.model.UpdateWebAppAccelerationDetails body) {
            updateWebAppAccelerationDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateWebAppAccelerationRequest
         */
        public UpdateWebAppAccelerationRequest buildWithoutInvocationCallback() {
            UpdateWebAppAccelerationRequest request = new UpdateWebAppAccelerationRequest();
            request.webAppAccelerationId = webAppAccelerationId;
            request.updateWebAppAccelerationDetails = updateWebAppAccelerationDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateWebAppAccelerationDetails=")
                .append(String.valueOf(this.updateWebAppAccelerationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWebAppAccelerationRequest)) {
            return false;
        }

        UpdateWebAppAccelerationRequest other = (UpdateWebAppAccelerationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.webAppAccelerationId, other.webAppAccelerationId)
                && java.util.Objects.equals(
                        this.updateWebAppAccelerationDetails, other.updateWebAppAccelerationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateWebAppAccelerationDetails == null
                                ? 43
                                : this.updateWebAppAccelerationDetails.hashCode());
