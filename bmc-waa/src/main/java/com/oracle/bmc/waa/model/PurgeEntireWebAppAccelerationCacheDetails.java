...
/**
 * Clears all resources from the cache of the WebAppAcceleration. <br>
...
public final class PurgeEntireWebAppAccelerationCacheDetails
    ...
    public static class Builder {
        ...
        public PurgeEntireWebAppAccelerationCacheDetails build() {
            PurgeEntireWebAppAccelerationCacheDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PurgeEntireWebAppAccelerationCacheDetails model) {
            return this;
        }
    }
