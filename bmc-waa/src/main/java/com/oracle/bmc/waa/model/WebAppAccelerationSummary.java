...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = WebAppAccelerationSummary.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = WebAppAccelerationLoadBalancerSummary.class,
        name = "LOAD_BALANCER"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class WebAppAccelerationSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected WebAppAccelerationSummary(
            String id,
            String displayName,
    ...
    private final WebAppAcceleration.LifecycleState lifecycleState;

    /**
     * The current state of the WebAppAcceleration.
     * @return the value
     **/
    public WebAppAcceleration.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WebAppAccelerationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WebAppAccelerationSummary)) {
            return false;
        }

        WebAppAccelerationSummary other = (WebAppAccelerationSummary) o;
