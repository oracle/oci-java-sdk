...
public class ListWebAppAccelerationPoliciesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListWebAppAccelerationPoliciesConverter.class);

    public static com.oracle.bmc.waa.requests.ListWebAppAccelerationPoliciesRequest
            interceptRequest(
                    com.oracle.bmc.waa.requests.ListWebAppAccelerationPoliciesRequest request) {
