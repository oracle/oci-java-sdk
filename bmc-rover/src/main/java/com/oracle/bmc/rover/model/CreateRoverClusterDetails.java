...
/**
 * The information required to create a RoverCluster. <br>
...
public final class CreateRoverClusterDetails
    ...
    public CreateRoverClusterDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public CreateRoverClusterDetails build() {
            CreateRoverClusterDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateRoverClusterDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRoverClusterDetails)) {
            return false;
        }

        CreateRoverClusterDetails other = (CreateRoverClusterDetails) o;
