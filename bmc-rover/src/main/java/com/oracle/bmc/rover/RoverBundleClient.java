...
public class RoverBundleClient implements RoverBundle {
    /**
    ...
    public ListRoverClusterRoverBundleRequestsResponse listRoverClusterRoverBundleRequests(
        ...
        LOG.trace("Called listRoverClusterRoverBundleRequests");
    ...
    public ListRoverNodeRoverBundleRequestsResponse listRoverNodeRoverBundleRequests(
        ...
        LOG.trace("Called listRoverNodeRoverBundleRequests");
    ...
    public RequestBundleRoverClusterResponse requestBundleRoverCluster(
        ...
        LOG.trace("Called requestBundleRoverCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RequestBundleRoverClusterResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRequestRoverBundleDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public RequestBundleRoverNodeResponse requestBundleRoverNode(
        ...
        LOG.trace("Called requestBundleRoverNode");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RequestBundleRoverNodeResponse>
                transformer =
    ...
    public RetrieveAvailableBundleVersionsRoverClusterResponse
        ...
        LOG.trace("Called retrieveAvailableBundleVersionsRoverCluster");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCurrentRoverBundleDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public RetrieveAvailableBundleVersionsRoverNodeResponse
        ...
        LOG.trace("Called retrieveAvailableBundleVersionsRoverNode");
    ...
    public RetrieveBundleStatusRoverClusterResponse retrieveBundleStatusRoverCluster(
        ...
        LOG.trace("Called retrieveBundleStatusRoverCluster");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRoverBundleStatusDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public RetrieveBundleStatusRoverNodeResponse retrieveBundleStatusRoverNode(
        ...
        LOG.trace("Called retrieveBundleStatusRoverNode");
