...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/rover/RequestAdditionalNodesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestAdditionalNodesRequest.
 */
...
public class RequestAdditionalNodesRequest
    ...
    public static class Builder
        ...
        public RequestAdditionalNodesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RequestAdditionalNodesRequest(roverClusterId, requestAdditionalNodesDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
