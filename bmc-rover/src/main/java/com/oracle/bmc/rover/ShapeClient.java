...
public class ShapeClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Shape {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ShapeAsyncClient.class);
    ...
    private ShapeClient(
        ...
        this.paginators = new ShapePaginators(this);
    }
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ShapeClient> {
        ...
        public ShapeClient build(
                @javax.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ShapeClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public ListShapesResponse listShapes(ListShapesRequest request) {
        ...
        return clientCall(request, ListShapesResponse::builder)
                ...
                .handleBody(
                        com.oracle.bmc.rover.model.ShapeCollection.class,
                ...
                .handleResponseHeaderString(
                        "opc-prev-page", ListShapesResponse.Builder::opcPrevPage)
                .operationUsesDefaultRetries()
                .callSync();
    }

    @Override
    public ShapePaginators getPaginators() {
        return paginators;
    }
