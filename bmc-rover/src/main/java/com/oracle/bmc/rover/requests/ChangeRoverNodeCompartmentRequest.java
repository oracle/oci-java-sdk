...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/rover/ChangeRoverNodeCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeRoverNodeCompartmentRequest.
 */
...
public class ChangeRoverNodeCompartmentRequest
     ...
     * CompartmentId of the destination compartment
     */
    public com.oracle.bmc.rover.model.ChangeRoverNodeCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.rover.model.ChangeRoverNodeCompartmentDetails
                changeRoverNodeCompartmentDetails = null;

        /**
         * CompartmentId of the destination compartment
         * @param changeRoverNodeCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeRoverNodeCompartmentDetails(
                com.oracle.bmc.rover.model.ChangeRoverNodeCompartmentDetails
                        changeRoverNodeCompartmentDetails) {
            this.changeRoverNodeCompartmentDetails = changeRoverNodeCompartmentDetails;
            return this;
        }
         ...
         * @return instance of ChangeRoverNodeCompartmentRequest
         */
        public ChangeRoverNodeCompartmentRequest buildWithoutInvocationCallback() {
            ChangeRoverNodeCompartmentRequest request = new ChangeRoverNodeCompartmentRequest();
            request.roverNodeId = roverNodeId;
            request.changeRoverNodeCompartmentDetails = changeRoverNodeCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeRoverNodeCompartmentRequest(roverNodeId, changeRoverNodeCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeRoverNodeCompartmentDetails=")
                .append(String.valueOf(this.changeRoverNodeCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeRoverNodeCompartmentRequest)) {
            return false;
        }

        ChangeRoverNodeCompartmentRequest other = (ChangeRoverNodeCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.roverNodeId, other.roverNodeId)
                && java.util.Objects.equals(
                        this.changeRoverNodeCompartmentDetails,
                        other.changeRoverNodeCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeRoverNodeCompartmentDetails == null
                                ? 43
                                : this.changeRoverNodeCompartmentDetails.hashCode());
