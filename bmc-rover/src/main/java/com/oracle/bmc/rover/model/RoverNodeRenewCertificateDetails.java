...
public final class RoverNodeRenewCertificateDetails
    ...
    public static class Builder {
        ...
        public RoverNodeRenewCertificateDetails build() {
            RoverNodeRenewCertificateDetails model =
                    new RoverNodeRenewCertificateDetails(this.csr, this.timeCertValidityEnd);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RoverNodeRenewCertificateDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoverNodeRenewCertificateDetails)) {
            return false;
        }

        RoverNodeRenewCertificateDetails other = (RoverNodeRenewCertificateDetails) o;
