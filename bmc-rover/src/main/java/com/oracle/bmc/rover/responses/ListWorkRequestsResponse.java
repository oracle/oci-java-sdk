...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.rover.model.WorkRequestCollection getWorkRequestCollection() {
    ...
    private ListWorkRequestsResponse(
            ...
            String opcNextPage,
            String opcPrevPage,
            com.oracle.bmc.rover.model.WorkRequestCollection workRequestCollection) {
