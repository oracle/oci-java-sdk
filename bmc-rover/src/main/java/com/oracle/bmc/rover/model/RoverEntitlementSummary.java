...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RoverEntitlementSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RoverEntitlementSummary
    ...
    public RoverEntitlementSummary(
            String id,
    ...
    public static class Builder {
        ...
        private RoverEntitlement.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(RoverEntitlement.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public RoverEntitlementSummary build() {
            RoverEntitlementSummary model =
                    new RoverEntitlementSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.requestorName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RoverEntitlementSummary model) {
    ...
    /** Lifecyclestate for the entitlement. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final RoverEntitlement.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public RoverEntitlement.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RoverEntitlementSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoverEntitlementSummary)) {
            return false;
        }

        RoverEntitlementSummary other = (RoverEntitlementSummary) o;
