...
public class CreateRoverClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateRoverClusterResponse> {
         ...
         */
        @Override
        public Builder copy(CreateRoverClusterResponse o) {
         ...
         */
        @Override
        public CreateRoverClusterResponse build() {
            return new CreateRoverClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRoverClusterResponse)) {
            return false;
        }

        CreateRoverClusterResponse other = (CreateRoverClusterResponse) o;
