...
public class RoverNodePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listRoverNodes operation. This iterable
    ...
    public Iterable<ListRoverNodesResponse> listRoverNodesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new com.google.common.base.Supplier<ListRoverNodesRequest.Builder>() {
                    @Override
                    public ListRoverNodesRequest.Builder get() {
                        return ListRoverNodesRequest.builder().copy(request);
                    }
                },
                new com.google.common.base.Function<ListRoverNodesResponse, String>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.rover.model.RoverNodeSummary} objects
     * contained in responses from the listRoverNodes operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.rover.model.RoverNodeSummary} objects
