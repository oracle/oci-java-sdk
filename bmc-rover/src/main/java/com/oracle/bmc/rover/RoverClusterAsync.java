...
public interface RoverClusterAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateRoverClusterResponse> createRoverCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteRoverClusterResponse> deleteRoverCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetRoverClusterResponse> getRoverCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetRoverClusterCertificateResponse> getRoverClusterCertificate(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListRoverClustersResponse> listRoverClusters(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RequestAdditionalNodesResponse> requestAdditionalNodes(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateRoverClusterResponse> updateRoverCluster(
