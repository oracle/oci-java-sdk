...
public class UpdateRoverClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code RoverCluster} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRoverClusterResponse> {
         ...
         * The returned {@code RoverCluster} instance.
         *
         * @param roverCluster the value to set
         * @return this builder
         */
        ...
        public UpdateRoverClusterResponse build() {
            return new UpdateRoverClusterResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, roverCluster);
        }
    }
