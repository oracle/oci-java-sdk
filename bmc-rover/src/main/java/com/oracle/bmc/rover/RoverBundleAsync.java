...
public interface RoverBundleAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RequestBundleRoverClusterResponse> requestBundleRoverCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RequestBundleRoverNodeResponse> requestBundleRoverNode(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RetrieveAvailableBundleVersionsRoverClusterResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RetrieveAvailableBundleVersionsRoverNodeResponse>
