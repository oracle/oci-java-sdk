 ...
 * to any list operations of RoverEntitlement where multiple pages of data may be fetched.
...
public class RoverEntitlementPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listRoverEntitlements operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
     */
    public Iterable<ListRoverEntitlementsResponse> listRoverEntitlementsResponseIterator(
            final ListRoverEntitlementsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Function<
                    ...
                    @Override
                    public ListRoverEntitlementsRequest apply(
                            com.oracle.bmc.paginator.internal.RequestBuilderAndToken<
                                            ListRoverEntitlementsRequest.Builder>
                                    input) {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.rover.model.RoverEntitlementSummary} objects
     * contained in responses from the listRoverEntitlements operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.rover.model.RoverEntitlementSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.rover.model.RoverEntitlementSummary>
            listRoverEntitlementsRecordIterator(final ListRoverEntitlementsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                new java.util.function.Function<
                    ...
                    @Override
                    public java.util.List<com.oracle.bmc.rover.model.RoverEntitlementSummary> apply(
                            ListRoverEntitlementsResponse response) {
