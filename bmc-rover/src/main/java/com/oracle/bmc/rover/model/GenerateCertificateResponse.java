...
/**
 * The information of rover node certificate generated by Oracle Cloud Infrastructure certificate
 * service. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GenerateCertificateResponse.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GenerateCertificateResponse
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"roverNodeId", "certificateDetails"})
    public GenerateCertificateResponse(String roverNodeId, CertificateDetails certificateDetails) {
        super();
    ...
    public static class Builder {
        ...
        public GenerateCertificateResponse build() {
            GenerateCertificateResponse model =
                    new GenerateCertificateResponse(this.roverNodeId, this.certificateDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateCertificateResponse model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateCertificateResponse)) {
            return false;
        }

        GenerateCertificateResponse other = (GenerateCertificateResponse) o;
