...
public class CreateRoverEntitlementConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateRoverEntitlementConverter.class);

    public static com.oracle.bmc.rover.requests.CreateRoverEntitlementRequest interceptRequest(
            com.oracle.bmc.rover.requests.CreateRoverEntitlementRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.rover.responses.CreateRoverEntitlementResponse>() {
                            @Override
                            public com.oracle.bmc.rover.responses.CreateRoverEntitlementResponse
                                ...
                                com.oracle.bmc.rover.responses.CreateRoverEntitlementResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.rover.responses
                                                        .CreateRoverEntitlementResponse.builder()
