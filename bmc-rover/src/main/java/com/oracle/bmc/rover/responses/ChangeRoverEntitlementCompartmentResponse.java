...
public class ChangeRoverEntitlementCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeRoverEntitlementCompartmentResponse)) {
            return false;
        }

        ChangeRoverEntitlementCompartmentResponse other =
                (ChangeRoverEntitlementCompartmentResponse) o;
