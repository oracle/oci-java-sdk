...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/rover/ListRoverNodeRoverBundleRequestsExample.java.html"
...
public class ListRoverNodeRoverBundleRequestsRequest
    ...
    /**
     * The field to sort by. Only one sort order may be provided. Default order for timeTaskCreated
     * is descending. If no value is specified timeTaskCreated is default.
     */
    ...
    public static class Builder
         ...
         * timeTaskCreated is descending. If no value is specified timeTaskCreated is default.
         */
        ...
        /**
         * Build the instance of ListRoverNodeRoverBundleRequestsRequest as configured by this
         * builder
         *
        ...
        public ListRoverNodeRoverBundleRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListRoverNodeRoverBundleRequestsRequest(roverNodeId, opcRequestId, limit, page,
            // sortOrder, sortBy);
        }
    }
