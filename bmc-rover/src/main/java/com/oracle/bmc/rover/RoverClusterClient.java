...
public class RoverClusterClient implements RoverCluster {
    ...
    public RequestAdditionalNodesResponse requestAdditionalNodes(
        ...
        LOG.trace("Called requestAdditionalNodes");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RequestAdditionalNodesResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getRequestAdditionalNodesDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
