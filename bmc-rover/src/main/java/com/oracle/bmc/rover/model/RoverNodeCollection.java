...
public final class RoverNodeCollection
    ...
    public static class Builder {
        ...
        public RoverNodeCollection build() {
            RoverNodeCollection model = new RoverNodeCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RoverNodeCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoverNodeCollection)) {
            return false;
        }

        RoverNodeCollection other = (RoverNodeCollection) o;
