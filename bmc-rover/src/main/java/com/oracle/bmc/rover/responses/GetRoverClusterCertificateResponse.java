...
public class GetRoverClusterCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.rover.model.RoverClusterCertificate getRoverClusterCertificate() {
        return roverClusterCertificate;
    }
    ...
    public static class Builder {
        ...
        public Builder roverClusterCertificate(
                com.oracle.bmc.rover.model.RoverClusterCertificate roverClusterCertificate) {
            this.roverClusterCertificate = roverClusterCertificate;
            return this;
        }
        ...
        public Builder copy(GetRoverClusterCertificateResponse o) {
            ...
            roverClusterCertificate(o.getRoverClusterCertificate());
        ...
        public GetRoverClusterCertificateResponse build() {
            return new GetRoverClusterCertificateResponse(
                    __httpStatusCode__, etag, opcRequestId, roverClusterCertificate);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",roverClusterCertificate=").append(String.valueOf(roverClusterCertificate));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRoverClusterCertificateResponse)) {
            return false;
        }

        GetRoverClusterCertificateResponse other = (GetRoverClusterCertificateResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.roverClusterCertificate, other.roverClusterCertificate);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.roverClusterCertificate == null
                                ? 43
                                : this.roverClusterCertificate.hashCode());
        return result;
    }
}
