...
public class GetRoverClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetRoverClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetRoverClusterResponse> {
         ...
         */
        @Override
        public Builder copy(GetRoverClusterResponse o) {
        ...
        public GetRoverClusterResponse build() {
            return new GetRoverClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRoverClusterResponse)) {
            return false;
        }

        GetRoverClusterResponse other = (GetRoverClusterResponse) o;
