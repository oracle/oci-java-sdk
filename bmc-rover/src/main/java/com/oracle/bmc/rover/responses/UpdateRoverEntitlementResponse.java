...
public class UpdateRoverEntitlementResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRoverEntitlementResponse)) {
            return false;
        }

        UpdateRoverEntitlementResponse other = (UpdateRoverEntitlementResponse) o;
