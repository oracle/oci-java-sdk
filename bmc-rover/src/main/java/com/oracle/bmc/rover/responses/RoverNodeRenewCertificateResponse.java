...
public class RoverNodeRenewCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder renewCertificateResponse(
                com.oracle.bmc.rover.model.RenewCertificateResponse renewCertificateResponse) {
            this.renewCertificateResponse = renewCertificateResponse;
            return this;
        }
        ...
        public Builder copy(RoverNodeRenewCertificateResponse o) {
            ...
            renewCertificateResponse(o.getRenewCertificateResponse());
    ...
    public String toString() {
        ...
        sb.append(",renewCertificateResponse=").append(String.valueOf(renewCertificateResponse));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoverNodeRenewCertificateResponse)) {
            return false;
        }

        RoverNodeRenewCertificateResponse other = (RoverNodeRenewCertificateResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.renewCertificateResponse, other.renewCertificateResponse);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.renewCertificateResponse == null
                                ? 43
                                : this.renewCertificateResponse.hashCode());
        return result;
    }
}
