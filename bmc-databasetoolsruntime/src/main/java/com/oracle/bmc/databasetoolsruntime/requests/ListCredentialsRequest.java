 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCredentialsRequest.
 */
...
public class ListCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCredentialsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCredentialsRequest(databaseToolsConnectionId, opcRequestId, ifMatch, limit,
            // page, sortOrder);
        }
    }
