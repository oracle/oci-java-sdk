...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/DeleteCredentialPublicSynonymExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCredentialPublicSynonymRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class DeleteCredentialPublicSynonymRequest
     ...
     * The name of the public synonym for the credential
     */
    public String getPublicSynonymKey() {
        return publicSynonymKey;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteCredentialPublicSynonymRequest, java.lang.Void> {
         ...
         * The name of the public synonym for the credential
         */
        private String publicSynonymKey = null;

        /**
         * The name of the public synonym for the credential
         * @param publicSynonymKey the value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteCredentialPublicSynonymRequest o) {
            databaseToolsConnectionId(o.getDatabaseToolsConnectionId());
            credentialKey(o.getCredentialKey());
            publicSynonymKey(o.getPublicSynonymKey());
        ...
        /**
         * Build the instance of DeleteCredentialPublicSynonymRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteCredentialPublicSynonymRequest
         */
        public DeleteCredentialPublicSynonymRequest build() {
            DeleteCredentialPublicSynonymRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteCredentialPublicSynonymRequest
         */
        public DeleteCredentialPublicSynonymRequest buildWithoutInvocationCallback() {
            DeleteCredentialPublicSynonymRequest request =
                    new DeleteCredentialPublicSynonymRequest();
            ...
            return request;
            // new DeleteCredentialPublicSynonymRequest(databaseToolsConnectionId, credentialKey, publicSynonymKey, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",publicSynonymKey=").append(String.valueOf(this.publicSynonymKey));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCredentialPublicSynonymRequest)) {
            return false;
        }

        DeleteCredentialPublicSynonymRequest other = (DeleteCredentialPublicSynonymRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.publicSynonymKey, other.publicSynonymKey)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.publicSynonymKey == null ? 43 : this.publicSynonymKey.hashCode());
