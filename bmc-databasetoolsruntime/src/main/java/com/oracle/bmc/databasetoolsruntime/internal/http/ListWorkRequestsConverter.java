...
public class ListWorkRequestsConverter {
    ...
    public static com.oracle.bmc.databasetoolsruntime.requests.ListWorkRequestsRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.ListWorkRequestsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20230222").path("workRequests");
        ...
        if (request.getCreatedByPrincipalId() != null) {
            target =
                    target.queryParam(
                            "createdByPrincipalId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getCreatedByPrincipalId()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasetoolsruntime.responses.ListWorkRequestsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.ListWorkRequestsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
