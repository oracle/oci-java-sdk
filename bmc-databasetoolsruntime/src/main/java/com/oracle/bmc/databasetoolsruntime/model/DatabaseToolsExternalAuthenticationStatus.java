...
/**
 * The status of the external authentication. AVAILABLE if the external authentication can be used
 * with this connection. UNAVAILABLE if not. ENABLED if the external authentication is enabled.
 * UNKNOWN if the user has insufficient privilege.
 */
