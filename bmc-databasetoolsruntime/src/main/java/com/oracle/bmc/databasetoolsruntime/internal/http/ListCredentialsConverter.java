...
public class ListCredentialsConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListCredentialsConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.ListCredentialsRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.ListCredentialsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasetoolsruntime.responses.ListCredentialsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.ListCredentialsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .ListCredentialsResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .ListCredentialsResponse.builder()
