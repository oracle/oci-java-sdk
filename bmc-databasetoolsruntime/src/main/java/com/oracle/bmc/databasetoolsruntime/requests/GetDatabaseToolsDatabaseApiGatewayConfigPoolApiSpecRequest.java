...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest o) {
        ...
        /**
         * Build the instance of GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest build() {
         ...
         * @return instance of GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
                buildWithoutInvocationCallback() {
            GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest request =
                    new GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest();
            ...
            return request;
            // new GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, apiSpecKey, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest)) {
            return false;
        }

        GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest other =
                (GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest) o;
