...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefault.class,
            name = "DEFAULT")
})
...
public class DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec
    ...
    protected DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec(
            String key,
            String displayName,
    ...
    public enum DatabaseObjectType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(DatabaseObjectType.class);
        ...
        public static DatabaseObjectType create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'DatabaseObjectType', returning UnknownEnumValue",
                    key);
    ...
    public enum Operations implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(Operations.class);
        ...
        public static Operations create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'Operations', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
    ...
    public enum SecuritySchemes implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(SecuritySchemes.class);
        ...
        public static SecuritySchemes create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'SecuritySchemes', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec)) {
            return false;
        }

        DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec other =
                (DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec) o;
