...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ListUserCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUserCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ListUserCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListUserCredentialsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListUserCredentialsRequest o) {
        ...
        /**
         * Build the instance of ListUserCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListUserCredentialsRequest
         */
        public ListUserCredentialsRequest build() {
            ListUserCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUserCredentialsRequest
         */
        public ListUserCredentialsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUserCredentialsRequest(databaseToolsConnectionId, userKey, opcRequestId, ifMatch, limit, page, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUserCredentialsRequest)) {
            return false;
        }

        ListUserCredentialsRequest other = (ListUserCredentialsRequest) o;
