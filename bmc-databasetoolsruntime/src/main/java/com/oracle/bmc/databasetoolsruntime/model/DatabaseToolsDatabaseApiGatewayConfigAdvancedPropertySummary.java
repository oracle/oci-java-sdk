...
/**
 * Description of a database API gateway config setting to be provided as an advanced property. <br>
...
public final class DatabaseToolsDatabaseApiGatewayConfigAdvancedPropertySummary
    ...
    public static class Builder {
        ...
        /**
         * The config types that support this advanced property. The supported types are GLOBAL and
         * POOL.
         */
        ...
        /**
         * The type of database (as determined by a type of Database Tools connection) to which this
         * setting applies. The advancedProperty applies to all types of Database Tools connection
         * when null. This is only applicable when configTypes includes POOL.
         */
        ...
        /**
         * A list of string values (if applicable) supported by this database API gateway config
         * setting.
         */
    ...
    /** */
    public enum DatabaseToolsConnectionTypes implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    /**
     * The type of database (as determined by a type of Database Tools connection) to which this
     * setting applies. The advancedProperty applies to all types of Database Tools connection when
     * null. This is only applicable when configTypes includes POOL.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("databaseToolsConnectionTypes")
