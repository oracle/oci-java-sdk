...
/**
 * Connection validation details. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            ...
            name = "POSTGRESQL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ValidateDatabaseToolsConnectionMySqlDetails.class,
            name = "MYSQL"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
...
public class ValidateDatabaseToolsConnectionDetails
    ...
    protected ValidateDatabaseToolsConnectionDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateDatabaseToolsConnectionDetails)) {
            return false;
        }

        ValidateDatabaseToolsConnectionDetails other = (ValidateDatabaseToolsConnectionDetails) o;
