...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserCredential.Builder.class)
...
public final class UserCredential
    ...
    public static class Builder {
        ...
        /**
         * Name of the user that will be used to log in to the remote database or the remote or
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserCredential model) {
    ...
    /**
     * Name of the user that will be used to log in to the remote database or the remote or local
     * operating system
     */
    @com.fasterxml.jackson.annotation.JsonProperty("userName")
