...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest o) {
        ...
        /**
         * Build the instance of GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest build() {
        ...
        public GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest
                buildWithoutInvocationCallback() {
            GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest request =
                    new GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest();
            ...
            return request;
            // new GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, autoApiSpecKey, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest)) {
            return false;
        }

        GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest other =
                (GetDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest) o;
