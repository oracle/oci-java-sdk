...
/**
 * External identity provider for AZURE_AD <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder =
                PropertySetOracleDatabaseExternalAuthenticationIdentityProviderAzureAd.Builder
                        .class)
...
public final class PropertySetOracleDatabaseExternalAuthenticationIdentityProviderAzureAd
    ...
    public static class Builder {
        /**
         * External identity provider configuration parameters. Simple key-value pair Example: {
         * "tenant_id": "...", "application_id_uri": "...", ... }
         */
