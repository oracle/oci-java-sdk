...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetCredentialPublicSynonymExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetCredentialPublicSynonymRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class GetCredentialPublicSynonymRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetCredentialPublicSynonymRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetCredentialPublicSynonymRequest o) {
        ...
        /**
         * Build the instance of GetCredentialPublicSynonymRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetCredentialPublicSynonymRequest
         */
        public GetCredentialPublicSynonymRequest build() {
            GetCredentialPublicSynonymRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetCredentialPublicSynonymRequest
         */
        public GetCredentialPublicSynonymRequest buildWithoutInvocationCallback() {
            GetCredentialPublicSynonymRequest request = new GetCredentialPublicSynonymRequest();
            ...
            return request;
            // new GetCredentialPublicSynonymRequest(databaseToolsConnectionId, credentialKey, publicSynonymKey, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCredentialPublicSynonymRequest)) {
            return false;
        }

        GetCredentialPublicSynonymRequest other = (GetCredentialPublicSynonymRequest) o;
