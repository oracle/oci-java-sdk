...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetPropertySetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPropertySetRequest.
 */
...
public class GetPropertySetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetPropertySetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetPropertySetRequest(databaseToolsConnectionId, propertySetKey, opcRequestId, ifMatch);
        }
    }
