...
public class GetUserCredentialConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetUserCredentialConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.GetUserCredentialRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.GetUserCredentialRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasetoolsruntime.responses.GetUserCredentialResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                        .GetUserCredentialResponse>() {
                            @Override
                            public com.oracle.bmc.databasetoolsruntime.responses
                                            .GetUserCredentialResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.GetUserCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .GetUserCredentialResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .GetUserCredentialResponse.builder()
                                ...
                                builder.userCredential(response.getItem());
