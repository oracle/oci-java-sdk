...
/**
 * Contains the update details of an APEX FA Integration property set <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdatePropertySetApexFaIntegrationDetails.Builder.class)
...
public final class UpdatePropertySetApexFaIntegrationDetails extends UpdatePropertySetDetails {
    ...
    public static class Builder {
        ...
        public UpdatePropertySetApexFaIntegrationDetails build() {
            UpdatePropertySetApexFaIntegrationDetails model =
                    new UpdatePropertySetApexFaIntegrationDetails(
                            this.authenticationSubstitutions, this.instanceDbmsCredentialEnabled);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePropertySetApexFaIntegrationDetails model) {
    ...
    @Deprecated
    public UpdatePropertySetApexFaIntegrationDetails(
            java.util.Map<String, String> authenticationSubstitutions,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePropertySetApexFaIntegrationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePropertySetApexFaIntegrationDetails)) {
            return false;
        }

        UpdatePropertySetApexFaIntegrationDetails other =
                (UpdatePropertySetApexFaIntegrationDetails) o;
