...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/CreateCredentialExecuteGranteeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCredentialExecuteGranteeRequest.
 */
...
public class CreateCredentialExecuteGranteeRequest
    ...
    public static class Builder
        ...
        public CreateCredentialExecuteGranteeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateCredentialExecuteGranteeRequest(databaseToolsConnectionId, credentialKey, createCredentialExecuteGranteeDetails, opcRequestId, ifMatch);
        }
    }
