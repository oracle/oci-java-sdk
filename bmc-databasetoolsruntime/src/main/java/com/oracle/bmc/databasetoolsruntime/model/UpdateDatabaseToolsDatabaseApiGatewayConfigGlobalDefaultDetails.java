...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails.Builder.class)
...
public final class UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails
    ...
    public static class Builder {
        ...
        public UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails build() {
            UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails model =
                    new UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails(
                            this.poolRoute,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails model) {
    ...
    @Deprecated
    public UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails(
            PoolRoute poolRoute,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails)) {
            return false;
        }

        UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails) o;
