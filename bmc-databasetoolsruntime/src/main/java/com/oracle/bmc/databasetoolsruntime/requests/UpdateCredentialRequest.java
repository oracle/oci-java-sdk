...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/UpdateCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCredentialRequest.
 */
...
public class UpdateCredentialRequest
     ...
     */
    private com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails
            updateCredentialDetails;

    /**
     * The information to be updated.
     */
    public com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails
            getUpdateCredentialDetails() {
        return updateCredentialDetails;
    }
    /**
    ...
    public com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails getBody$() {
        return updateCredentialDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails
                updateCredentialDetails = null;

        /**
         * The information to be updated.
         * @param updateCredentialDetails the value to set
         * @return this builder instance
         */
        public Builder updateCredentialDetails(
                com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails
                        updateCredentialDetails) {
            this.updateCredentialDetails = updateCredentialDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateCredentialRequest o) {
            databaseToolsConnectionId(o.getDatabaseToolsConnectionId());
            credentialKey(o.getCredentialKey());
            updateCredentialDetails(o.getUpdateCredentialDetails());
        ...
        /**
         * Build the instance of UpdateCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateCredentialRequest
         */
        public UpdateCredentialRequest build() {
            UpdateCredentialRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model.UpdateCredentialDetails body) {
            updateCredentialDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateCredentialRequest
         */
        public UpdateCredentialRequest buildWithoutInvocationCallback() {
            ...
            request.updateCredentialDetails = updateCredentialDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateCredentialRequest(databaseToolsConnectionId, credentialKey, updateCredentialDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateCredentialDetails=").append(String.valueOf(this.updateCredentialDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateCredentialDetails, other.updateCredentialDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateCredentialDetails == null
                                ? 43
                                : this.updateCredentialDetails.hashCode());
