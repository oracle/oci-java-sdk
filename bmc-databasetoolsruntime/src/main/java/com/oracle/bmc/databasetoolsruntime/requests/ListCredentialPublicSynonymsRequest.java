...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ListCredentialPublicSynonymsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCredentialPublicSynonymsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ListCredentialPublicSynonymsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCredentialPublicSynonymsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCredentialPublicSynonymsRequest o) {
        ...
        /**
         * Build the instance of ListCredentialPublicSynonymsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCredentialPublicSynonymsRequest
         */
        public ListCredentialPublicSynonymsRequest build() {
            ListCredentialPublicSynonymsRequest request = buildWithoutInvocationCallback();
        ...
        public ListCredentialPublicSynonymsRequest buildWithoutInvocationCallback() {
            ListCredentialPublicSynonymsRequest request = new ListCredentialPublicSynonymsRequest();
            ...
            return request;
            // new ListCredentialPublicSynonymsRequest(databaseToolsConnectionId, credentialKey, opcRequestId, ifMatch, limit, page, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCredentialPublicSynonymsRequest)) {
            return false;
        }

        ListCredentialPublicSynonymsRequest other = (ListCredentialPublicSynonymsRequest) o;
