...
public final class WorkRequestSummary
    ...
    public WorkRequestSummary(
            ...
            String createdByPrincipalDomainId,
        ...
        this.createdByPrincipalDomainId = createdByPrincipalDomainId;
    ...
    public static class Builder {
        /**
         * A user-friendly name for the operation. If provided for an asynchronous operation, this
         * value will be propagated to the displayName property of the resulting Work Request,
         * allowing for easier identification and tracking of the operation's progress and outcome.
         * This name is purely for descriptive purposes and does not affect the functionality of the
         * operation itself.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("createdByPrincipalDomainId")
        private String createdByPrincipalDomainId;

        /**
         * Identity domain OCID for the user that submitted the asynchronous request.
         *
         * @param createdByPrincipalDomainId the value to set
         * @return this builder
         */
        public Builder createdByPrincipalDomainId(String createdByPrincipalDomainId) {
            this.createdByPrincipalDomainId = createdByPrincipalDomainId;
            this.__explicitlySet__.add("createdByPrincipalDomainId");
            return this;
        }
        ...
        /**
         * The date and time the work request is eligible to be launched, in the format defined by
         * RFC3339.
         */
        ...
        public WorkRequestSummary build() {
            WorkRequestSummary model =
                    new WorkRequestSummary(
                            ...
                            this.createdByPrincipalDomainId,
                            this.resources,
        ...
        public Builder copy(WorkRequestSummary model) {
            ...
            if (model.wasPropertyExplicitlySet("createdByPrincipalDomainId")) {
                this.createdByPrincipalDomainId(model.getCreatedByPrincipalDomainId());
            }
    ...
    /**
     * A user-friendly name for the operation. If provided for an asynchronous operation, this value
     * will be propagated to the displayName property of the resulting Work Request, allowing for
     * easier identification and tracking of the operation's progress and outcome. This name is
     * purely for descriptive purposes and does not affect the functionality of the operation
     * itself.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("displayName")
    ...
    /** Identity domain OCID for the user that submitted the asynchronous request. */
    @com.fasterxml.jackson.annotation.JsonProperty("createdByPrincipalDomainId")
    private final String createdByPrincipalDomainId;
    ...
    public String getCreatedByPrincipalDomainId() {
        return createdByPrincipalDomainId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", createdByPrincipalDomainId=")
                .append(String.valueOf(this.createdByPrincipalDomainId));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.displayName, other.displayName)
                ...
                && java.util.Objects.equals(
                        this.createdByPrincipalDomainId, other.createdByPrincipalDomainId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createdByPrincipalDomainId == null
                                ? 43
                                : this.createdByPrincipalDomainId.hashCode());
