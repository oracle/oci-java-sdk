...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = DatabaseToolsDatabaseApiGatewayConfigPoolContent.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabaseToolsDatabaseApiGatewayConfigPoolContentDefault.class,
        name = "DEFAULT"
    )
})
...
public class DatabaseToolsDatabaseApiGatewayConfigPoolContent
    ...
    protected DatabaseToolsDatabaseApiGatewayConfigPoolContent(
            String key,
            String displayName,
            ...
            java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec> apiSpecs,
            java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec> autoApiSpecs,
        ...
        this.autoApiSpecs = autoApiSpecs;
     ...
     **/
    public enum DatabaseActionsStatus {
        Enabled("ENABLED"),
        Disabled("DISABLED"),
        ;
     ...
     **/
    public enum RestEnabledSqlStatus {
        Enabled("ENABLED"),
        Disabled("DISABLED"),
        ;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("apiSpecs")
    private final java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec> apiSpecs;

    /**
     * Array of Database Tools database API gateway config API spec items.
     * @return the value
     **/
    public java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolApiSpec> getApiSpecs() {
        return apiSpecs;
    }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("autoApiSpecs")
    private final java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec> autoApiSpecs;

    /**
     * Array of Database Tools database API gateway config auto API spec items.
     * @return the value
     **/
    public java.util.List<DatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec> getAutoApiSpecs() {
        return autoApiSpecs;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsDatabaseApiGatewayConfigPoolContent(");
        ...
        sb.append(", apiSpecs=").append(String.valueOf(this.apiSpecs));
        sb.append(", autoApiSpecs=").append(String.valueOf(this.autoApiSpecs));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsDatabaseApiGatewayConfigPoolContent)) {
            return false;
        }

        DatabaseToolsDatabaseApiGatewayConfigPoolContent other =
                (DatabaseToolsDatabaseApiGatewayConfigPoolContent) o;
        return java.util.Objects.equals(this.key, other.key)
                ...
                && java.util.Objects.equals(this.apiSpecs, other.apiSpecs)
                && java.util.Objects.equals(this.autoApiSpecs, other.autoApiSpecs)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.apiSpecs == null ? 43 : this.apiSpecs.hashCode());
        result = (result * PRIME) + (this.autoApiSpecs == null ? 43 : this.autoApiSpecs.hashCode());
