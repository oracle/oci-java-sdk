...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails.Builder.class
)
...
public final class UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails
        extends UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails {
    ...
    public static class Builder {
        ...
        public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails build() {
            UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails model =
                    new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails(
                            this.displayName,
    ...
    @Deprecated
    public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails(");
    ...
    public boolean equals(Object o) {
        ...
        UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails) o;
