...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A filter to return only work requests with one of the specified status
         * values.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
        ...
        public ListWorkRequestsRequest buildWithoutInvocationCallback() {
            ...
            // sortOrder, sortBy, page, limit, operationType, createdByPrincipalId, status);
        }
    }
