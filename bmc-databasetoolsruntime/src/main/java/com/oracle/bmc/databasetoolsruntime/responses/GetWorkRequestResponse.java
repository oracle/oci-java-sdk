...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.databasetoolsruntime.model.WorkRequest workRequest;
     ...
     * @return the value
     */
    public com.oracle.bmc.databasetoolsruntime.model.WorkRequest getWorkRequest() {
        return workRequest;
    }
    ...
    private GetWorkRequestResponse(
            ...
            Float retryAfter,
            String etag,
            com.oracle.bmc.databasetoolsruntime.model.WorkRequest workRequest) {
    ...
    public static class Builder
        ...
        public GetWorkRequestResponse build() {
            return new GetWorkRequestResponse(
                    __httpStatusCode__, headers, opcRequestId, retryAfter, etag, workRequest);
        }
    }
