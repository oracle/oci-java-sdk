...
public class DeleteCredentialExecuteGranteeConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteCredentialExecuteGranteeConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.DeleteCredentialExecuteGranteeRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.databasetoolsruntime.requests.DeleteCredentialExecuteGranteeRequest
                    request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("executeGrantees")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getExecuteGranteeKey()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.DeleteCredentialExecuteGranteeResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .DeleteCredentialExecuteGranteeResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .DeleteCredentialExecuteGranteeResponse
                                                        .builder()
