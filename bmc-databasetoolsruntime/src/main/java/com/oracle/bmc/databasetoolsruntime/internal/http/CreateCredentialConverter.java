...
public class CreateCredentialConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateCredentialConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.CreateCredentialRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.CreateCredentialRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasetoolsruntime.responses.CreateCredentialResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.CreateCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .CreateCredentialResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .CreateCredentialResponse.builder()
