...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ExecuteSqlDatabaseToolsConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExecuteSqlDatabaseToolsConnectionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ExecuteSqlDatabaseToolsConnectionRequest
     ...
     */
    private com.oracle.bmc.databasetoolsruntime.model.ExecuteSqlDatabaseToolsConnectionDetails
            executeSqlDatabaseToolsConnectionDetails;

    /**
     * Script to execute on a DatabaseToolsConnection.
     */
    public com.oracle.bmc.databasetoolsruntime.model.ExecuteSqlDatabaseToolsConnectionDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.databasetoolsruntime.model.ExecuteSqlDatabaseToolsConnectionDetails
                executeSqlDatabaseToolsConnectionDetails = null;

        /**
         * Script to execute on a DatabaseToolsConnection.
         * @param executeSqlDatabaseToolsConnectionDetails the value to set
         * @return this builder instance
         */
        public Builder executeSqlDatabaseToolsConnectionDetails(
                com.oracle.bmc.databasetoolsruntime.model.ExecuteSqlDatabaseToolsConnectionDetails
                        executeSqlDatabaseToolsConnectionDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(ExecuteSqlDatabaseToolsConnectionRequest o) {
            databaseToolsConnectionId(o.getDatabaseToolsConnectionId());
            executeSqlDatabaseToolsConnectionDetails(
                    o.getExecuteSqlDatabaseToolsConnectionDetails());
        ...
        /**
         * Build the instance of ExecuteSqlDatabaseToolsConnectionRequest as configured by this builder
         *
         ...
         *
         * @return instance of ExecuteSqlDatabaseToolsConnectionRequest
         */
        public ExecuteSqlDatabaseToolsConnectionRequest build() {
            ExecuteSqlDatabaseToolsConnectionRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model.ExecuteSqlDatabaseToolsConnectionDetails
                        body) {
            executeSqlDatabaseToolsConnectionDetails(body);
            return this;
        }
         ...
         * @return instance of ExecuteSqlDatabaseToolsConnectionRequest
         */
        public ExecuteSqlDatabaseToolsConnectionRequest buildWithoutInvocationCallback() {
            ExecuteSqlDatabaseToolsConnectionRequest request =
                    new ExecuteSqlDatabaseToolsConnectionRequest();
            request.databaseToolsConnectionId = databaseToolsConnectionId;
            request.executeSqlDatabaseToolsConnectionDetails =
                    executeSqlDatabaseToolsConnectionDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new ExecuteSqlDatabaseToolsConnectionRequest(databaseToolsConnectionId, executeSqlDatabaseToolsConnectionDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",executeSqlDatabaseToolsConnectionDetails=")
                .append(String.valueOf(this.executeSqlDatabaseToolsConnectionDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExecuteSqlDatabaseToolsConnectionRequest)) {
            return false;
        }

        ExecuteSqlDatabaseToolsConnectionRequest other =
                (ExecuteSqlDatabaseToolsConnectionRequest) o;
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.executeSqlDatabaseToolsConnectionDetails == null
                                ? 43
                                : this.executeSqlDatabaseToolsConnectionDetails.hashCode());
