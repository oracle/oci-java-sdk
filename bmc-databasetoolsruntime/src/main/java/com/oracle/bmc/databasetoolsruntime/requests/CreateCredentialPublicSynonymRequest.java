...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/CreateCredentialPublicSynonymExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCredentialPublicSynonymRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class CreateCredentialPublicSynonymRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails> {
     ...
     */
    private com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails
            createCredentialPublicSynonymDetails;

    /**
     * The payload to create a public synonym for the given credentials.
     */
    public com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails
            getCreateCredentialPublicSynonymDetails() {
        return createCredentialPublicSynonymDetails;
    }
    /**
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails
                createCredentialPublicSynonymDetails = null;

        /**
         * The payload to create a public synonym for the given credentials.
         * @param createCredentialPublicSynonymDetails the value to set
         * @return this builder instance
         */
        public Builder createCredentialPublicSynonymDetails(
                com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails
                        createCredentialPublicSynonymDetails) {
            this.createCredentialPublicSynonymDetails = createCredentialPublicSynonymDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateCredentialPublicSynonymRequest o) {
            databaseToolsConnectionId(o.getDatabaseToolsConnectionId());
            credentialKey(o.getCredentialKey());
            createCredentialPublicSynonymDetails(o.getCreateCredentialPublicSynonymDetails());
        ...
        /**
         * Build the instance of CreateCredentialPublicSynonymRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateCredentialPublicSynonymRequest
         */
        public CreateCredentialPublicSynonymRequest build() {
            CreateCredentialPublicSynonymRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model.CreateCredentialPublicSynonymDetails
                        body) {
            createCredentialPublicSynonymDetails(body);
            return this;
        }
         ...
         * @return instance of CreateCredentialPublicSynonymRequest
         */
        public CreateCredentialPublicSynonymRequest buildWithoutInvocationCallback() {
            CreateCredentialPublicSynonymRequest request =
                    new CreateCredentialPublicSynonymRequest();
            request.databaseToolsConnectionId = databaseToolsConnectionId;
            request.credentialKey = credentialKey;
            request.createCredentialPublicSynonymDetails = createCredentialPublicSynonymDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new CreateCredentialPublicSynonymRequest(databaseToolsConnectionId, credentialKey, createCredentialPublicSynonymDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createCredentialPublicSynonymDetails=")
                .append(String.valueOf(this.createCredentialPublicSynonymDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCredentialPublicSynonymRequest)) {
            return false;
        }

        CreateCredentialPublicSynonymRequest other = (CreateCredentialPublicSynonymRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.createCredentialPublicSynonymDetails,
                        other.createCredentialPublicSynonymDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createCredentialPublicSynonymDetails == null
                                ? 43
                                : this.createCredentialPublicSynonymDetails.hashCode());
