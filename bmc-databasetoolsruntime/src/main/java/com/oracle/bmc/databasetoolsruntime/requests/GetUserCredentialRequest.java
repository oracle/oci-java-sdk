...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetUserCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetUserCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class GetUserCredentialRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetUserCredentialRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetUserCredentialRequest o) {
        ...
        /**
         * Build the instance of GetUserCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetUserCredentialRequest
         */
        public GetUserCredentialRequest build() {
            GetUserCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetUserCredentialRequest
         */
        public GetUserCredentialRequest buildWithoutInvocationCallback() {
            GetUserCredentialRequest request = new GetUserCredentialRequest();
            ...
            return request;
            // new GetUserCredentialRequest(databaseToolsConnectionId, userKey, credentialKey, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserCredentialRequest)) {
            return false;
        }

        GetUserCredentialRequest other = (GetUserCredentialRequest) o;
