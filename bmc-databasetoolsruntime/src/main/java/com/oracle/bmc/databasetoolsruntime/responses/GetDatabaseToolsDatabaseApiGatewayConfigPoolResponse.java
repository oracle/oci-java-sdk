...
public class GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse
    ...
    private GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse o) {
         ...
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse build() {
            return new GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse)) {
            return false;
        }

        GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse other =
                (GetDatabaseToolsDatabaseApiGatewayConfigPoolResponse) o;
