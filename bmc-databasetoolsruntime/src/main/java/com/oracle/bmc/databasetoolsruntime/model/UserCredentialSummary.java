...
/**
 * User Credential information <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserCredentialSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserCredentialSummary
    ...
    public static class Builder {
        ...
        public UserCredentialSummary build() {
            UserCredentialSummary model =
                    new UserCredentialSummary(
                            this.key,
                            this.userName,
                            this.windowsDomain,
                            this.enabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserCredentialSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserCredentialSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserCredentialSummary)) {
            return false;
        }

        UserCredentialSummary other = (UserCredentialSummary) o;
