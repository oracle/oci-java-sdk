...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = DatabaseToolsIdentity.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsIdentityOracleDatabaseResourcePrincipal.class,
            name = "ORACLE_DATABASE_RESOURCE_PRINCIPAL")
})
...
public class DatabaseToolsIdentity
    ...
    protected DatabaseToolsIdentity(
            String id,
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
     * compartment containing the Database Tools identity.
     */
    ...
    private final DatabaseToolsIdentityLifecycleState lifecycleState;
     ...
     * @return the value
     */
    public DatabaseToolsIdentityLifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsIdentity(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsIdentity)) {
            return false;
        }

        DatabaseToolsIdentity other = (DatabaseToolsIdentity) o;
