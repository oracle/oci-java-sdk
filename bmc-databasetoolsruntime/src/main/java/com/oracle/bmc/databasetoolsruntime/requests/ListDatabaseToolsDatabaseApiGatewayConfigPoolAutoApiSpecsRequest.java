...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest o) {
        ...
        /**
         * Build the instance of ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest
         */
        public ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest build() {
        ...
        public ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest
                buildWithoutInvocationCallback() {
            ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest request =
                    new ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest();
            ...
            return request;
            // new ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest)) {
            return false;
        }

        ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest other =
                (ListDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecsRequest) o;
