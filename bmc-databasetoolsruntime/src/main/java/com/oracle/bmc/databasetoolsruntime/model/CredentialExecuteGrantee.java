...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CredentialExecuteGrantee.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CredentialExecuteGrantee
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"key"})
    public CredentialExecuteGrantee(String key) {
        super();
        this.key = key;
    }
    ...
    public static class Builder {
        ...
        public CredentialExecuteGrantee build() {
            CredentialExecuteGrantee model = new CredentialExecuteGrantee(this.key);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CredentialExecuteGrantee model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CredentialExecuteGrantee(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialExecuteGrantee)) {
            return false;
        }

        CredentialExecuteGrantee other = (CredentialExecuteGrantee) o;
