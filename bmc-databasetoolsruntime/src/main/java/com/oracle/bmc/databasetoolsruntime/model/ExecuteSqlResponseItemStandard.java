...
/**
 * A statement execution response for Standard type requests. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExecuteSqlResponseItemStandard.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExecuteSqlResponseItemStandard
    ...
    public ExecuteSqlResponseItemStandard(
            Integer statementId,
    ...
    public static class Builder {
        ...
        /**
         * Output from DBMS_OUTPUT package. Server output must be enabled (e.g., SET SERVEROUTPUT
         * ON).
         */
        ...
        public ExecuteSqlResponseItemStandard build() {
            ExecuteSqlResponseItemStandard model =
                    new ExecuteSqlResponseItemStandard(
                            this.statementId,
                            this.statementType,
                            this.statementPos,
                            this.statementText,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExecuteSqlResponseItemStandard model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExecuteSqlResponseItemStandard(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExecuteSqlResponseItemStandard)) {
            return false;
        }

        ExecuteSqlResponseItemStandard other = (ExecuteSqlResponseItemStandard) o;
