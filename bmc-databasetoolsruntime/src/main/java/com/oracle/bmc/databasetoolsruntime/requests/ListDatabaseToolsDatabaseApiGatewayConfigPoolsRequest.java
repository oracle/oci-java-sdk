...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ListDatabaseToolsDatabaseApiGatewayConfigPoolsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest o) {
        ...
        /**
         * Build the instance of ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest
         */
        public ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest build() {
        ...
        public ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest
                buildWithoutInvocationCallback() {
            ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest request =
                    new ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest();
            ...
            return request;
            // new ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest(databaseToolsDatabaseApiGatewayConfigId, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest)) {
            return false;
        }

        ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest other =
                (ListDatabaseToolsDatabaseApiGatewayConfigPoolsRequest) o;
