...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/GetCredentialExecuteGranteeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetCredentialExecuteGranteeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class GetCredentialExecuteGranteeRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetCredentialExecuteGranteeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetCredentialExecuteGranteeRequest o) {
        ...
        /**
         * Build the instance of GetCredentialExecuteGranteeRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetCredentialExecuteGranteeRequest
         */
        public GetCredentialExecuteGranteeRequest build() {
            GetCredentialExecuteGranteeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetCredentialExecuteGranteeRequest
         */
        public GetCredentialExecuteGranteeRequest buildWithoutInvocationCallback() {
            GetCredentialExecuteGranteeRequest request = new GetCredentialExecuteGranteeRequest();
            ...
            return request;
            // new GetCredentialExecuteGranteeRequest(databaseToolsConnectionId, credentialKey, executeGranteeKey, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCredentialExecuteGranteeRequest)) {
            return false;
        }

        GetCredentialExecuteGranteeRequest other = (GetCredentialExecuteGranteeRequest) o;
