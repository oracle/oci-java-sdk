...
public class GetCredentialExecuteGranteeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code CredentialExecuteGrantee} instance. */
    ...
    private GetCredentialExecuteGranteeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetCredentialExecuteGranteeResponse o) {
         ...
         */
        @Override
        public GetCredentialExecuteGranteeResponse build() {
            return new GetCredentialExecuteGranteeResponse(
                    __httpStatusCode__, headers, opcRequestId, credentialExecuteGrantee);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCredentialExecuteGranteeResponse)) {
            return false;
        }

        GetCredentialExecuteGranteeResponse other = (GetCredentialExecuteGranteeResponse) o;
