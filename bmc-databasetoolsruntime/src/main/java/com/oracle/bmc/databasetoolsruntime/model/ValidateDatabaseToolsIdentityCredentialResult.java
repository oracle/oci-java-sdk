...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = ValidateDatabaseToolsIdentityCredentialResult.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult.class,
...
public class ValidateDatabaseToolsIdentityCredentialResult
    ...
    protected ValidateDatabaseToolsIdentityCredentialResult(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateDatabaseToolsIdentityCredentialResult)) {
            return false;
        }

        ValidateDatabaseToolsIdentityCredentialResult other =
                (ValidateDatabaseToolsIdentityCredentialResult) o;
