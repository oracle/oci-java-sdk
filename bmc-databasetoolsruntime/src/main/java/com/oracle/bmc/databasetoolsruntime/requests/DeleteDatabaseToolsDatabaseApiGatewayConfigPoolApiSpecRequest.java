...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest o) {
        ...
        /**
         * Build the instance of DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
         */
        public DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest build() {
         ...
         * @return instance of DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
         */
        public DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
                buildWithoutInvocationCallback() {
            DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest request =
                    new DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest();
            ...
            return request;
            // new DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, apiSpecKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest)) {
            return false;
        }

        DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest other =
                (DeleteDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest) o;
