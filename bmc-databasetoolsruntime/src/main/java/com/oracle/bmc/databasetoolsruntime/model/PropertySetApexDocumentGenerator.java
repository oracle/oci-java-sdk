...
/**
 * Contains the details of an APEX Document Generator property set <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PropertySetApexDocumentGenerator.Builder.class)
...
public final class PropertySetApexDocumentGenerator extends PropertySet {
    ...
    public static class Builder {
        ...
        private PrintServerType printServerType;
         ...
         * @return this builder
         */
        public Builder printServerType(PrintServerType printServerType) {
        ...
        private AutonomousDatabaseResourcePrincipalStatus autonomousDatabaseResourcePrincipalStatus;
        ...
        public PropertySetApexDocumentGenerator build() {
            PropertySetApexDocumentGenerator model =
                    new PropertySetApexDocumentGenerator(
                            this.isMutable,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PropertySetApexDocumentGenerator model) {
    ...
    @Deprecated
    public PropertySetApexDocumentGenerator(
            Boolean isMutable,
    ...
    /** The print server type */
    public enum PrintServerType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(PrintServerType.class);

        private final String value;
        private static java.util.Map<String, PrintServerType> map;

        static {
            map = new java.util.HashMap<>();
            for (PrintServerType v : PrintServerType.values()) {
        ...
        public static PrintServerType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'PrintServerType', returning UnknownEnumValue",
                    key);
    ...
    /** The print server type */
    @com.fasterxml.jackson.annotation.JsonProperty("printServerType")
    private final PrintServerType printServerType;
     ...
     * @return the value
     */
    public PrintServerType getPrintServerType() {
     ...
     */
    public enum AutonomousDatabaseResourcePrincipalStatus
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(AutonomousDatabaseResourcePrincipalStatus.class);

        private final String value;
        private static java.util.Map<String, AutonomousDatabaseResourcePrincipalStatus> map;

        static {
            map = new java.util.HashMap<>();
            for (AutonomousDatabaseResourcePrincipalStatus v :
                    AutonomousDatabaseResourcePrincipalStatus.values()) {
                if (v != UnknownEnumValue) {
                    map.put(v.getValue(), v);
                }
            }
        ...
        AutonomousDatabaseResourcePrincipalStatus(String value) {
            this.value = value;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static AutonomousDatabaseResourcePrincipalStatus create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'AutonomousDatabaseResourcePrincipalStatus', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("autonomousDatabaseResourcePrincipalStatus")
    private final AutonomousDatabaseResourcePrincipalStatus
            autonomousDatabaseResourcePrincipalStatus;
     ...
     * @return the value
     */
    public AutonomousDatabaseResourcePrincipalStatus
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PropertySetApexDocumentGenerator(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PropertySetApexDocumentGenerator)) {
            return false;
        }

        PropertySetApexDocumentGenerator other = (PropertySetApexDocumentGenerator) o;
