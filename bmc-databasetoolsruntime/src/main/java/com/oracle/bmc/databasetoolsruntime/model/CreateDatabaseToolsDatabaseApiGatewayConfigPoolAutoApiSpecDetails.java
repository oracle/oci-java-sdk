...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails.class,
            name = "DEFAULT")
})
...
public class CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails
    ...
    protected CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails)) {
            return false;
        }

        CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails other =
                (CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails) o;
