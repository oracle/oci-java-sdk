...
/**
 * Contains the update details of an Oracle Database External Authentication property set <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdatePropertySetOracleDatabaseExternalAuthenticationDetails.Builder.class)
...
public final class UpdatePropertySetOracleDatabaseExternalAuthenticationDetails
        extends UpdatePropertySetDetails {
    ...
    public static class Builder {
        ...
        public UpdatePropertySetOracleDatabaseExternalAuthenticationDetails build() {
            UpdatePropertySetOracleDatabaseExternalAuthenticationDetails model =
                    new UpdatePropertySetOracleDatabaseExternalAuthenticationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePropertySetOracleDatabaseExternalAuthenticationDetails model) {
    ...
    @Deprecated
    public UpdatePropertySetOracleDatabaseExternalAuthenticationDetails(
            PropertySetOracleDatabaseExternalAuthenticationIdentityProvider identityProvider) {
        super();
        this.identityProvider = identityProvider;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePropertySetOracleDatabaseExternalAuthenticationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePropertySetOracleDatabaseExternalAuthenticationDetails)) {
            return false;
        }

        UpdatePropertySetOracleDatabaseExternalAuthenticationDetails other =
                (UpdatePropertySetOracleDatabaseExternalAuthenticationDetails) o;
