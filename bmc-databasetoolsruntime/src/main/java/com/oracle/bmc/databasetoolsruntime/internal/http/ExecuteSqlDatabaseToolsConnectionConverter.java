...
public class ExecuteSqlDatabaseToolsConnectionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ExecuteSqlDatabaseToolsConnectionConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.databasetoolsruntime.requests.ExecuteSqlDatabaseToolsConnectionRequest
                    request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.ExecuteSqlDatabaseToolsConnectionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .ExecuteSqlDatabaseToolsConnectionResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .ExecuteSqlDatabaseToolsConnectionResponse
                                                        .builder()
                                ...
                                builder.executeSqlResponse(response.getItem());
