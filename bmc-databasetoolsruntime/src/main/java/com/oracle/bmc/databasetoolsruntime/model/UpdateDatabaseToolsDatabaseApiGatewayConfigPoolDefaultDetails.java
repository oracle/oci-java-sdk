...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails.Builder.class
)
...
public final class UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails
        extends UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails {
    ...
    public static class Builder {
        ...
        public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails build() {
            UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails model =
                    new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails(
                            this.displayName,
                            this.poolRouteValue,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails model) {
    ...
    @Deprecated
    public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails)) {
            return false;
        }

        UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails) o;
