...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/DeleteDatabaseToolsDatabaseApiGatewayConfigPoolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest o) {
        ...
        /**
         * Build the instance of DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest
         */
        public DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest build() {
        ...
        public DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest
                buildWithoutInvocationCallback() {
            DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest request =
                    new DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest();
            ...
            return request;
            // new DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest)) {
            return false;
        }

        DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest other =
                (DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest) o;
