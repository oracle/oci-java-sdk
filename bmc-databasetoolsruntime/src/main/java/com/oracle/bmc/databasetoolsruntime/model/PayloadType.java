...
public enum PayloadType {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PayloadType.class);

    private final String value;
    private static java.util.Map<String, PayloadType> map;
    ...
    public static PayloadType create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'PayloadType', returning UnknownEnumValue",
                key);
