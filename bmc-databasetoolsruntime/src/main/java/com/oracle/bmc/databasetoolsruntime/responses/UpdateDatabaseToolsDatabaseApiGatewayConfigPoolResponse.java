...
public class UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse
    ...
    private UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse o) {
         ...
         */
        public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse build() {
            return new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse)) {
            return false;
        }

        UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigPoolResponse) o;
