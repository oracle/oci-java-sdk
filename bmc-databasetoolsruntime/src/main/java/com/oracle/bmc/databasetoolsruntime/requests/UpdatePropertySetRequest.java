...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/UpdatePropertySetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePropertySetRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class UpdatePropertySetRequest
     ...
     */
    private com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails
            updatePropertySetDetails;

    /**
     * The information to be updated.
     */
    public com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails
            getUpdatePropertySetDetails() {
    ...
    public com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails getBody$() {
        return updatePropertySetDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails
                updatePropertySetDetails = null;

        /**
         * The information to be updated.
         * @param updatePropertySetDetails the value to set
         * @return this builder instance
         */
        public Builder updatePropertySetDetails(
                com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails
                        updatePropertySetDetails) {
            this.updatePropertySetDetails = updatePropertySetDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(UpdatePropertySetRequest o) {
            databaseToolsConnectionId(o.getDatabaseToolsConnectionId());
            propertySetKey(o.getPropertySetKey());
            updatePropertySetDetails(o.getUpdatePropertySetDetails());
        ...
        /**
         * Build the instance of UpdatePropertySetRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdatePropertySetRequest
         */
        public UpdatePropertySetRequest build() {
            UpdatePropertySetRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model.UpdatePropertySetDetails body) {
            updatePropertySetDetails(body);
            return this;
        }
        ...
        public UpdatePropertySetRequest buildWithoutInvocationCallback() {
            UpdatePropertySetRequest request = new UpdatePropertySetRequest();
            request.databaseToolsConnectionId = databaseToolsConnectionId;
            request.propertySetKey = propertySetKey;
            request.updatePropertySetDetails = updatePropertySetDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdatePropertySetRequest(databaseToolsConnectionId, propertySetKey, updatePropertySetDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updatePropertySetDetails=")
                .append(String.valueOf(this.updatePropertySetDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePropertySetRequest)) {
            return false;
        }

        UpdatePropertySetRequest other = (UpdatePropertySetRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updatePropertySetDetails, other.updatePropertySetDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updatePropertySetDetails == null
                                ? 43
                                : this.updatePropertySetDetails.hashCode());
