...
public class DeleteCredentialConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteCredentialConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.DeleteCredentialRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.DeleteCredentialRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.DeleteCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .DeleteCredentialResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .DeleteCredentialResponse.builder()
