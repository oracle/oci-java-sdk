...
public class UpdatePropertySetConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdatePropertySetConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.UpdatePropertySetRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.UpdatePropertySetRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getPropertySetKey().getValue()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.UpdatePropertySetResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.propertySet(response.getItem());
