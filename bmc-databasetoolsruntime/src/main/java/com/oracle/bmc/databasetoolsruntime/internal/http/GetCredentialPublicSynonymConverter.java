...
public class GetCredentialPublicSynonymConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetCredentialPublicSynonymConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.GetCredentialPublicSynonymRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.GetCredentialPublicSynonymRequest
                            request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.GetCredentialPublicSynonymResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .GetCredentialPublicSynonymResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .GetCredentialPublicSynonymResponse
                                                        .builder()
                                ...
                                builder.credentialPublicSynonym(response.getItem());
