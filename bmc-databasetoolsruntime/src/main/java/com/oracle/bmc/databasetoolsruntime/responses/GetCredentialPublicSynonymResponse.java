...
public class GetCredentialPublicSynonymResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetCredentialPublicSynonymResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetCredentialPublicSynonymResponse o) {
         ...
         */
        public GetCredentialPublicSynonymResponse build() {
            return new GetCredentialPublicSynonymResponse(
                    __httpStatusCode__, headers, opcRequestId, credentialPublicSynonym);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCredentialPublicSynonymResponse)) {
            return false;
        }

        GetCredentialPublicSynonymResponse other = (GetCredentialPublicSynonymResponse) o;
