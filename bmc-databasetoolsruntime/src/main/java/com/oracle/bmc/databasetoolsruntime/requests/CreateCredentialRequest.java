...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/CreateCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCredentialRequest.
 */
...
public class CreateCredentialRequest
     ...
     */
    private com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails
            createCredentialDetails;

    /**
     * The payload to create credential.
     */
    public com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails
            getCreateCredentialDetails() {
    ...
    public com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails getBody$() {
        return createCredentialDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails
                createCredentialDetails = null;

        /**
         * The payload to create credential.
         * @param createCredentialDetails the value to set
         * @return this builder instance
         */
        public Builder createCredentialDetails(
                com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails
                        createCredentialDetails) {
            this.createCredentialDetails = createCredentialDetails;
            return this;
        }
        ...
        public Builder copy(CreateCredentialRequest o) {
            ...
            createCredentialDetails(o.getCreateCredentialDetails());
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model.CreateCredentialDetails body) {
            createCredentialDetails(body);
            return this;
        }
        ...
        public CreateCredentialRequest buildWithoutInvocationCallback() {
            ...
            request.createCredentialDetails = createCredentialDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new CreateCredentialRequest(databaseToolsConnectionId, createCredentialDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createCredentialDetails=").append(String.valueOf(this.createCredentialDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.createCredentialDetails, other.createCredentialDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createCredentialDetails == null
                                ? 43
                                : this.createCredentialDetails.hashCode());
