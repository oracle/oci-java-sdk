...
public class ListUserCredentialsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListUserCredentialsConverter.class);

    public static com.oracle.bmc.databasetoolsruntime.requests.ListUserCredentialsRequest
            interceptRequest(
                    com.oracle.bmc.databasetoolsruntime.requests.ListUserCredentialsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.databasetoolsruntime.requests.ListUserCredentialsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.databasetoolsruntime.responses.ListUserCredentialsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasetoolsruntime.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasetoolsruntime.responses.ListUserCredentialsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasetoolsruntime.responses
                                                .ListUserCredentialsResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasetoolsruntime.responses
                                                        .ListUserCredentialsResponse.builder()
                                ...
                                builder.userCredentialCollection(response.getItem());
