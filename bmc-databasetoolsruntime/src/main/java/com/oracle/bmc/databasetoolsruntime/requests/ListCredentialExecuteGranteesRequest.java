...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/ListCredentialExecuteGranteesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCredentialExecuteGranteesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class ListCredentialExecuteGranteesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCredentialExecuteGranteesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCredentialExecuteGranteesRequest o) {
        ...
        /**
         * Build the instance of ListCredentialExecuteGranteesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCredentialExecuteGranteesRequest
         */
        public ListCredentialExecuteGranteesRequest build() {
            ListCredentialExecuteGranteesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCredentialExecuteGranteesRequest
         */
        public ListCredentialExecuteGranteesRequest buildWithoutInvocationCallback() {
            ListCredentialExecuteGranteesRequest request =
                    new ListCredentialExecuteGranteesRequest();
            ...
            return request;
            // new ListCredentialExecuteGranteesRequest(databaseToolsConnectionId, credentialKey, opcRequestId, ifMatch, limit, page, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCredentialExecuteGranteesRequest)) {
            return false;
        }

        ListCredentialExecuteGranteesRequest other = (ListCredentialExecuteGranteesRequest) o;
