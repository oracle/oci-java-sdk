...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetoolsruntime/UpdateDatabaseToolsDatabaseApiGatewayConfigPoolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230222")
public class UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest
    ...
    public com.oracle.bmc.databasetoolsruntime.model
        ...
        return updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails;
    }
    /**
    ...
    public static class Builder
        ...
        private com.oracle.bmc.databasetoolsruntime.model
                        .UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails
                updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails = null;

        /**
         * The information to be updated.
         * @param updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails the value to set
         * @return this builder instance
         */
        public Builder updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails(
                com.oracle.bmc.databasetoolsruntime.model
                                .UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails
                        updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails) {
            this.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails =
                    updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest o) {
            databaseToolsDatabaseApiGatewayConfigId(o.getDatabaseToolsDatabaseApiGatewayConfigId());
            poolKey(o.getPoolKey());
            updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails(
                    o.getUpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails());
        ...
        /**
         * Build the instance of UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest
         */
        ...
        public Builder body$(
                com.oracle.bmc.databasetoolsruntime.model
                                .UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDetails
                        body) {
            updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest
         */
        public UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest
                buildWithoutInvocationCallback() {
            UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest request =
                    new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest();
            request.databaseToolsDatabaseApiGatewayConfigId =
                    databaseToolsDatabaseApiGatewayConfigId;
            request.poolKey = poolKey;
            request.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails =
                    updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest(databaseToolsDatabaseApiGatewayConfigId, poolKey, updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest)) {
            return false;
        }

        UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails,
                        other.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails == null
                                ? 43
                                : this.updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails
                                        .hashCode());
