...
public class AddressServiceClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public static class Builder
        ...
        public AddressServiceClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new AddressServiceClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public GetAddressResponse getAddress(GetAddressRequest request) {
        ...
        return clientCall(request, GetAddressResponse::builder)
                .logger(LOG, "getAddress")
                .serviceDetails("AddressService", "GetAddress", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(GetAddressRequest::builder)
                .basePath("/20191001")
                .appendPathParam("addresses")
                .appendPathParam(request.getAddressId())
    ...
    public VerifyAddressResponse verifyAddress(VerifyAddressRequest request) {
        ...
        Objects.requireNonNull(
                request.getVerifyAddressDetails(), "verifyAddressDetails is required");

        return clientCall(request, VerifyAddressResponse::builder)
                .logger(LOG, "verifyAddress")
                .serviceDetails("AddressService", "VerifyAddress", "")
                .method(com.oracle.bmc.http.client.Method.POST)
                .requestBuilder(VerifyAddressRequest::builder)
                .basePath("/20191001")
                .appendPathParam("addresses")
                .appendPathParam("action")
                .appendPathParam("verification")
                .appendQueryParam("ospHomeRegion", request.getOspHomeRegion())
                .appendQueryParam("compartmentId", request.getCompartmentId())
                .accept("application/json")
                ...
                .handleBody(
                        ...
                        VerifyAddressResponse.Builder::verifyAddressReceipt)
                .handleResponseHeaderString(
