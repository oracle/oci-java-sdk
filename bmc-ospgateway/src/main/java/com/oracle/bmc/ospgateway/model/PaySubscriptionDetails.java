...
/**
 * Request object for paying a subscription <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PaySubscriptionDetails.Builder.class)
...
public final class PaySubscriptionDetails
    ...
    public static class Builder {
        ...
        public PaySubscriptionDetails build() {
            PaySubscriptionDetails model =
                    new PaySubscriptionDetails(this.subscription, this.languageCode, this.email);
    ...
    public boolean equals(Object o) {
        ...
        PaySubscriptionDetails other = (PaySubscriptionDetails) o;
