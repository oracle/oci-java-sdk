...
public interface SubscriptionServiceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<AuthorizeSubscriptionPaymentResponse> authorizeSubscriptionPayment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<PaySubscriptionResponse> paySubscription(
