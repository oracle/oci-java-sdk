...
public interface InvoiceServiceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<DownloadPdfContentResponse> downloadPdfContent(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetInvoiceResponse> getInvoice(
            GetInvoiceRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetInvoiceRequest, GetInvoiceResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListInvoiceLinesResponse> listInvoiceLines(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<PayInvoiceResponse> payInvoice(
            PayInvoiceRequest request,
            com.oracle.bmc.responses.AsyncHandler<PayInvoiceRequest, PayInvoiceResponse> handler);
}
