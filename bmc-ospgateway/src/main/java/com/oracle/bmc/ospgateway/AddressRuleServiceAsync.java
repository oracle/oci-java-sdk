...
public interface AddressRuleServiceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetAddressRuleResponse> getAddressRule(
            GetAddressRuleRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetAddressRuleRequest, GetAddressRuleResponse>
                    handler);
}
