...
public class PayInvoiceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PayInvoiceResponse> {
        ...
        public PayInvoiceResponse build() {
            return new PayInvoiceResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, payInvoiceReceipt);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",payInvoiceReceipt=").append(String.valueOf(payInvoiceReceipt));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PayInvoiceResponse)) {
            return false;
        }

        PayInvoiceResponse other = (PayInvoiceResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.payInvoiceReceipt, other.payInvoiceReceipt);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.payInvoiceReceipt == null ? 43 : this.payInvoiceReceipt.hashCode());
        return result;
    }
}
