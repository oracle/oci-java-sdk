...
public class SubscriptionServiceClient implements SubscriptionService {
     ...
     */
    protected SubscriptionServiceClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public AuthorizeSubscriptionPaymentResponse authorizeSubscriptionPayment(
        ...
        LOG.trace("Called authorizeSubscriptionPayment");
    ...
    public PaySubscriptionResponse paySubscription(PaySubscriptionRequest request) {
        LOG.trace("Called paySubscription");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getPaySubscriptionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
