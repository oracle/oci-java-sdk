...
public class InvoiceServiceAsyncClient implements InvoiceServiceAsync {
    /**
    ...
    public static class Builder
        ...
        public InvoiceServiceAsyncClient build(
            ...
            return new InvoiceServiceAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<DownloadPdfContentResponse> downloadPdfContent(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async downloadPdfContent");
        if (com.oracle.bmc.http.ApacheUtils.isExtraStreamLogsEnabled()) {
            LOG.warn(
                    "downloadPdfContent returns a stream, please make sure to close the stream to avoid any indefinite hangs");
        ...
        final DownloadPdfContentRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DownloadPdfContentRequest, DownloadPdfContentResponse>,
                        java.util.concurrent.Future<DownloadPdfContentResponse>>
    ...
    public java.util.concurrent.Future<GetInvoiceResponse> getInvoice(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetInvoiceRequest, GetInvoiceResponse>
                    handler) {
        LOG.trace("Called async getInvoice");
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<GetInvoiceResponse>>
    ...
    public java.util.concurrent.Future<ListInvoiceLinesResponse> listInvoiceLines(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listInvoiceLines");
        final ListInvoiceLinesRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListInvoiceLinesRequest, ListInvoiceLinesResponse>,
                        java.util.concurrent.Future<ListInvoiceLinesResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<ListInvoicesResponse> listInvoices(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ListInvoicesRequest, ListInvoicesResponse>
                    handler) {
        LOG.trace("Called async listInvoices");
        final ListInvoicesRequest interceptedRequest =
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<ListInvoicesResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<PayInvoiceResponse> payInvoice(
            ...
            final com.oracle.bmc.responses.AsyncHandler<PayInvoiceRequest, PayInvoiceResponse>
                    handler) {
        LOG.trace("Called async payInvoice");
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<PayInvoiceResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getPayInvoiceDetails(),
                                ib,
                                transformer);
