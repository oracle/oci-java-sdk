...
public class GetSubscriptionResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.ospgateway.model.Subscription getSubscription() {
        return subscription;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder subscription(com.oracle.bmc.ospgateway.model.Subscription subscription) {
            this.subscription = subscription;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSubscriptionResponse)) {
            return false;
        }
