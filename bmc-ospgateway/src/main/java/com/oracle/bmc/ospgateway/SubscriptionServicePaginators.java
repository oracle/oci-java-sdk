 ...
 * to any list operations of SubscriptionService where multiple pages of data may be fetched. Two
...
public class SubscriptionServicePaginators {
    ...
    public SubscriptionServicePaginators(SubscriptionService client) {
        this.client = client;
    }
     ...
     * com.oracle.bmc.ospgateway.model.SubscriptionSummary} objects contained in responses from the
     * listSubscriptions operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.ospgateway.model.SubscriptionSummary} objects contained in responses
     *     received from the service.
     */
