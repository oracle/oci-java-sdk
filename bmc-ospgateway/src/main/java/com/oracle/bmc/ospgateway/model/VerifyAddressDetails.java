...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VerifyAddressDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class VerifyAddressDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public VerifyAddressDetails build() {
            VerifyAddressDetails model =
                    new VerifyAddressDetails(
                            this.addressKey,
                            this.line1,
                            this.line2,
                            this.line3,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerifyAddressDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VerifyAddressDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VerifyAddressDetails)) {
            return false;
        }

        VerifyAddressDetails other = (VerifyAddressDetails) o;
