...
public class DeleteAnalyticsInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteAnalyticsInstanceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public DeleteAnalyticsInstanceResponse build() {
            return new DeleteAnalyticsInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAnalyticsInstanceResponse)) {
            return false;
        }

        DeleteAnalyticsInstanceResponse other = (DeleteAnalyticsInstanceResponse) o;
