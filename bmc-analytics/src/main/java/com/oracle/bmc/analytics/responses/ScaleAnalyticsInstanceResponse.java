...
public class ScaleAnalyticsInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ScaleAnalyticsInstanceResponse o) {
         ...
         */
        @Override
        public ScaleAnalyticsInstanceResponse build() {
            return new ScaleAnalyticsInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleAnalyticsInstanceResponse)) {
            return false;
        }

        ScaleAnalyticsInstanceResponse other = (ScaleAnalyticsInstanceResponse) o;
