...
public enum FeatureSet implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(FeatureSet.class);

    private final String value;
    private static java.util.Map<String, FeatureSet> map;
    ...
    public static FeatureSet create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'FeatureSet', returning UnknownEnumValue",
                key);
