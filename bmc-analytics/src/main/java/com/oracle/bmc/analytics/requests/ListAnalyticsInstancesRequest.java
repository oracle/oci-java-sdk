...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/ListAnalyticsInstancesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAnalyticsInstancesRequest.
 */
...
public class ListAnalyticsInstancesRequest
    ...
    public static class Builder
        ...
        public ListAnalyticsInstancesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAnalyticsInstancesRequest(compartmentId, opcRequestId, name, capacityType, featureSet, lifecycleState, limit, page, sortBy, sortOrder);
        }
    }
