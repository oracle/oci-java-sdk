...
public class GetPrivateAccessChannelResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.analytics.model.PrivateAccessChannel getPrivateAccessChannel() {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder privateAccessChannel(
                com.oracle.bmc.analytics.model.PrivateAccessChannel privateAccessChannel) {
            this.privateAccessChannel = privateAccessChannel;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",privateAccessChannel=").append(String.valueOf(privateAccessChannel));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPrivateAccessChannelResponse)) {
            return false;
        }

        GetPrivateAccessChannelResponse other = (GetPrivateAccessChannelResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.privateAccessChannel, other.privateAccessChannel);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.privateAccessChannel == null
                                ? 43
                                : this.privateAccessChannel.hashCode());
        return result;
    }
}
