...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/SetKmsKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SetKmsKeyRequest.
 */
...
public class SetKmsKeyRequest
    ...
    public com.oracle.bmc.analytics.model.SetKmsKeyDetails getBody$() {
        return setKmsKeyDetails;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SetKmsKeyRequest, com.oracle.bmc.analytics.model.SetKmsKeyDetails> {
        ...
        public Builder setKmsKeyDetails(
                com.oracle.bmc.analytics.model.SetKmsKeyDetails setKmsKeyDetails) {
        ...
        public Builder copy(SetKmsKeyRequest o) {
            ...
            setKmsKeyDetails(o.getSetKmsKeyDetails());
        ...
        /**
         * Build the instance of SetKmsKeyRequest as configured by this builder
         *
         ...
         *
         * @return instance of SetKmsKeyRequest
         */
        public SetKmsKeyRequest build() {
            SetKmsKeyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.analytics.model.SetKmsKeyDetails body) {
            setKmsKeyDetails(body);
            return this;
        }
        ...
        public SetKmsKeyRequest buildWithoutInvocationCallback() {
            ...
            request.setKmsKeyDetails = setKmsKeyDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new SetKmsKeyRequest(analyticsInstanceId, setKmsKeyDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",setKmsKeyDetails=").append(String.valueOf(this.setKmsKeyDetails));
    ...
    public boolean equals(Object o) {
        ...
        SetKmsKeyRequest other = (SetKmsKeyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.analyticsInstanceId, other.analyticsInstanceId)
                && java.util.Objects.equals(this.setKmsKeyDetails, other.setKmsKeyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.setKmsKeyDetails == null ? 43 : this.setKmsKeyDetails.hashCode());
