...
public class SetKmsKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SetKmsKeyResponse> {
         ...
         */
        @Override
        public Builder copy(SetKmsKeyResponse o) {
         ...
         */
        @Override
        public SetKmsKeyResponse build() {
            return new SetKmsKeyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetKmsKeyResponse)) {
            return false;
        }

        SetKmsKeyResponse other = (SetKmsKeyResponse) o;
