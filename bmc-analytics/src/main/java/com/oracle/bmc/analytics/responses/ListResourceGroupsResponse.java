...
public class ListResourceGroupsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.analytics.model.InstanceResourceGroupSummary} instances. */
    private java.util.List<com.oracle.bmc.analytics.model.InstanceResourceGroupSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.analytics.model.InstanceResourceGroupSummary> getItems() {
        return items;
    }
    ...
    private ListResourceGroupsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.analytics.model.InstanceResourceGroupSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListResourceGroupsResponse> {
