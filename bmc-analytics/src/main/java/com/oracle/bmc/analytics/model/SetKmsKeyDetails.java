...
public final class SetKmsKeyDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SetKmsKeyDetails build() {
            SetKmsKeyDetails model = new SetKmsKeyDetails(this.kmsKeyId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SetKmsKeyDetails model) {
