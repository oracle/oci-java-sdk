...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.analytics.model.WorkRequestError} instances. */
    private java.util.List<com.oracle.bmc.analytics.model.WorkRequestError> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.analytics.model.WorkRequestError> getItems() {
        return items;
    }
    ...
    private ListWorkRequestErrorsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.analytics.model.WorkRequestError> items) {
