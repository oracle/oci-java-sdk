...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/DeletePrivateAccessChannelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePrivateAccessChannelRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190331")
public class DeletePrivateAccessChannelRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePrivateAccessChannelRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePrivateAccessChannelRequest o) {
        ...
        /**
         * Build the instance of DeletePrivateAccessChannelRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePrivateAccessChannelRequest
         */
        public DeletePrivateAccessChannelRequest build() {
            DeletePrivateAccessChannelRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePrivateAccessChannelRequest
         */
        public DeletePrivateAccessChannelRequest buildWithoutInvocationCallback() {
            DeletePrivateAccessChannelRequest request = new DeletePrivateAccessChannelRequest();
            ...
            return request;
            // new DeletePrivateAccessChannelRequest(privateAccessChannelKey, analyticsInstanceId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePrivateAccessChannelRequest)) {
            return false;
        }

        DeletePrivateAccessChannelRequest other = (DeletePrivateAccessChannelRequest) o;
