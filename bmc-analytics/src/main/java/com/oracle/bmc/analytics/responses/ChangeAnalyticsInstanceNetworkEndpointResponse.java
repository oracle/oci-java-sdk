...
public class ChangeAnalyticsInstanceNetworkEndpointResponse
    ...
    private ChangeAnalyticsInstanceNetworkEndpointResponse(
    ...
    public static class Builder {
         ...
         */
        public ChangeAnalyticsInstanceNetworkEndpointResponse build() {
            return new ChangeAnalyticsInstanceNetworkEndpointResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAnalyticsInstanceNetworkEndpointResponse)) {
            return false;
        }

        ChangeAnalyticsInstanceNetworkEndpointResponse other =
                (ChangeAnalyticsInstanceNetworkEndpointResponse) o;
