...
public final class UpdateAnalyticsInstanceDetails {
    ...
    public static class Builder {
        ...
        public UpdateAnalyticsInstanceDetails build() {
            UpdateAnalyticsInstanceDetails __instance__ =
                    new UpdateAnalyticsInstanceDetails(
                            description, emailNotification, licenseType, definedTags, freeformTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAnalyticsInstanceDetails o) {
