...
public class ListAnalyticsInstancesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAnalyticsInstancesConverter.class);
        ...
        if (request.getCapacityType() != null) {
            target =
                    target.queryParam(
                            "capacityType",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getCapacityType().getValue()));
        }

        if (request.getFeatureSet() != null) {
            target =
                    target.queryParam(
                            "featureSet",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getFeatureSet().getValue()));
        }
