 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateResourceGroupRequest.
 */
...
public class UpdateResourceGroupRequest
    ...
    public static class Builder
        ...
        public UpdateResourceGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateResourceGroupRequest(analyticsInstanceId, analyticsInstanceResourceGroupId,
            // updateResourceGroupDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
