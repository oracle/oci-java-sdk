 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteVanityUrlRequest.
 */
...
public class DeleteVanityUrlRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteVanityUrlRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteVanityUrlRequest(analyticsInstanceId, vanityUrlKey, ifMatch, opcRequestId,
            // opcRetryToken);
        }
    }
