...
public class DeleteVanityUrlResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteVanityUrlResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteVanityUrlResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteVanityUrlResponse o) {
        ...
        public DeleteVanityUrlResponse build() {
            return new DeleteVanityUrlResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVanityUrlResponse)) {
            return false;
        }

        DeleteVanityUrlResponse other = (DeleteVanityUrlResponse) o;
