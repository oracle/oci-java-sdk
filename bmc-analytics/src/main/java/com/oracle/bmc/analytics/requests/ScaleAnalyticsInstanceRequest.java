...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/ScaleAnalyticsInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ScaleAnalyticsInstanceRequest.
 */
...
public class ScaleAnalyticsInstanceRequest
     ...
     *
     */
    public com.oracle.bmc.analytics.model.ScaleAnalyticsInstanceDetails
            getScaleAnalyticsInstanceDetails() {
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.analytics.model.ScaleAnalyticsInstanceDetails
                scaleAnalyticsInstanceDetails = null;

        /**
         * Input payload for scaling an Analytics instance up or down.
         *
         * @param scaleAnalyticsInstanceDetails the value to set
         * @return this builder instance
         */
        public Builder scaleAnalyticsInstanceDetails(
                com.oracle.bmc.analytics.model.ScaleAnalyticsInstanceDetails
                        scaleAnalyticsInstanceDetails) {
            this.scaleAnalyticsInstanceDetails = scaleAnalyticsInstanceDetails;
            return this;
        }
         ...
         * @return instance of ScaleAnalyticsInstanceRequest
         */
        public ScaleAnalyticsInstanceRequest buildWithoutInvocationCallback() {
            ScaleAnalyticsInstanceRequest request = new ScaleAnalyticsInstanceRequest();
            request.analyticsInstanceId = analyticsInstanceId;
            request.scaleAnalyticsInstanceDetails = scaleAnalyticsInstanceDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ScaleAnalyticsInstanceRequest(analyticsInstanceId, scaleAnalyticsInstanceDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",scaleAnalyticsInstanceDetails=")
                .append(String.valueOf(this.scaleAnalyticsInstanceDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleAnalyticsInstanceRequest)) {
            return false;
        }

        ScaleAnalyticsInstanceRequest other = (ScaleAnalyticsInstanceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.analyticsInstanceId, other.analyticsInstanceId)
                && java.util.Objects.equals(
                        this.scaleAnalyticsInstanceDetails, other.scaleAnalyticsInstanceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.scaleAnalyticsInstanceDetails == null
                                ? 43
                                : this.scaleAnalyticsInstanceDetails.hashCode());
