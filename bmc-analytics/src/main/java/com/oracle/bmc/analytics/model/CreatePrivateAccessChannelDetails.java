...
/**
 * Input payload to create a Private Access Channel. <br>
...
public final class CreatePrivateAccessChannelDetails
    ...
    public static class Builder {
        ...
        public CreatePrivateAccessChannelDetails build() {
            CreatePrivateAccessChannelDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePrivateAccessChannelDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePrivateAccessChannelDetails)) {
            return false;
        }

        CreatePrivateAccessChannelDetails other = (CreatePrivateAccessChannelDetails) o;
