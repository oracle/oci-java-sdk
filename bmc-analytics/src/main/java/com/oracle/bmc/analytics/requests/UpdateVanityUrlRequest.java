...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/UpdateVanityUrlExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateVanityUrlRequest.
 */
...
public class UpdateVanityUrlRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateVanityUrlDetails(
                com.oracle.bmc.analytics.model.UpdateVanityUrlDetails updateVanityUrlDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateVanityUrlRequest o) {
            analyticsInstanceId(o.getAnalyticsInstanceId());
            vanityUrlKey(o.getVanityUrlKey());
            updateVanityUrlDetails(o.getUpdateVanityUrlDetails());
         ...
         *
         * @return instance of UpdateVanityUrlRequest
         */
        public UpdateVanityUrlRequest build() {
            UpdateVanityUrlRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateVanityUrlRequest buildWithoutInvocationCallback() {
            UpdateVanityUrlRequest request = new UpdateVanityUrlRequest();
            request.analyticsInstanceId = analyticsInstanceId;
            request.vanityUrlKey = vanityUrlKey;
            request.updateVanityUrlDetails = updateVanityUrlDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new UpdateVanityUrlRequest(analyticsInstanceId, vanityUrlKey, updateVanityUrlDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVanityUrlRequest)) {
            return false;
        }

        UpdateVanityUrlRequest other = (UpdateVanityUrlRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateVanityUrlDetails, other.updateVanityUrlDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateVanityUrlDetails == null
                                ? 43
                                : this.updateVanityUrlDetails.hashCode());
