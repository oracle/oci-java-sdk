...
public class GetAnalyticsInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAnalyticsInstanceResponse> {
         ...
         */
        @Override
        public GetAnalyticsInstanceResponse build() {
            return new GetAnalyticsInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAnalyticsInstanceResponse)) {
            return false;
        }

        GetAnalyticsInstanceResponse other = (GetAnalyticsInstanceResponse) o;
