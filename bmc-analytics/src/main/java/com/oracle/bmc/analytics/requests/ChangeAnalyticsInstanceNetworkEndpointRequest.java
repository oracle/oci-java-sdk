...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/analytics/ChangeAnalyticsInstanceNetworkEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAnalyticsInstanceNetworkEndpointRequest.
 */
...
public class ChangeAnalyticsInstanceNetworkEndpointRequest
    ...
    public static class Builder
        ...
        public ChangeAnalyticsInstanceNetworkEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeAnalyticsInstanceNetworkEndpointRequest(analyticsInstanceId, changeAnalyticsInstanceNetworkEndpointDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
