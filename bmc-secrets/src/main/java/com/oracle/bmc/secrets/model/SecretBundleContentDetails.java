...
public class SecretBundleContentDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected SecretBundleContentDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SecretBundleContentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecretBundleContentDetails)) {
            return false;
        }

        SecretBundleContentDetails other = (SecretBundleContentDetails) o;
