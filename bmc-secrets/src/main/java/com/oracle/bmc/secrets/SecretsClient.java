...
import com.oracle.bmc.secrets.internal.http.*;
...
public class SecretsClient implements Secrets {
    ...
    public GetSecretBundleResponse getSecretBundle(GetSecretBundleRequest request) {
        LOG.trace("Called getSecretBundle");
        final GetSecretBundleRequest interceptedRequest =
                GetSecretBundleConverter.interceptRequest(request);
    ...
    public ListSecretBundleVersionsResponse listSecretBundleVersions(
        ...
        final ListSecretBundleVersionsRequest interceptedRequest =
                ListSecretBundleVersionsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListSecretBundleVersionsConverter.fromRequest(client, interceptedRequest);
