...
/**
 * Access token response for OCI Container Registry extension authentication. <br>
...
public final class AccessToken extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
