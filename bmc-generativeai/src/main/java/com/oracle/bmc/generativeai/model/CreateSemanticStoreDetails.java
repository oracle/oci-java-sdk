...
/**
 * The data to create a SemanticStore. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateSemanticStoreDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateSemanticStoreDetails
    ...
    public CreateSemanticStoreDetails(
            String description,
    ...
    public static class Builder {
         ...
         * user-defined semantics. When false, enrichment uses metadata only. When omitted, this
        ...
        private CreateDataSourceDetails dataSource;

        public Builder dataSource(CreateDataSourceDetails dataSource) {
            this.dataSource = dataSource;
        ...
        public CreateSemanticStoreDetails build() {
            CreateSemanticStoreDetails model =
                    new CreateSemanticStoreDetails(
                            this.description,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSemanticStoreDetails model) {
     ...
     * semantics. When false, enrichment uses metadata only. When omitted, this value defaults to
     * true.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isUserDefinedSemanticsEnabled")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dataSource")
    private final CreateDataSourceDetails dataSource;

    public CreateDataSourceDetails getDataSource() {
        return dataSource;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSemanticStoreDetails)) {
            return false;
        }

        CreateSemanticStoreDetails other = (CreateSemanticStoreDetails) o;
