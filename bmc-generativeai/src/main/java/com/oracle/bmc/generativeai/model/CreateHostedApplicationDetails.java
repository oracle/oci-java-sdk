...
/**
 * The details required to create a hosted application. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateHostedApplicationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateHostedApplicationDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateHostedApplicationDetails)) {
            return false;
        }
