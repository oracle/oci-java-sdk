...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataSourceDatabaseToolsConnectionDetails.Builder.class
)
...
public final class DataSourceDatabaseToolsConnectionDetails extends DataSourceDetails {
    ...
    public static class Builder {
        ...
        public DataSourceDatabaseToolsConnectionDetails build() {
            DataSourceDatabaseToolsConnectionDetails model =
                    new DataSourceDatabaseToolsConnectionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataSourceDatabaseToolsConnectionDetails model) {
    ...
    @Deprecated
    public DataSourceDatabaseToolsConnectionDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataSourceDatabaseToolsConnectionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataSourceDatabaseToolsConnectionDetails)) {
            return false;
        }

        DataSourceDatabaseToolsConnectionDetails other =
                (DataSourceDatabaseToolsConnectionDetails) o;
