...
/**
 * Summary information for a VectorStoreConnectorFileSync <br>
...
public final class VectorStoreConnectorFileSyncSummary
    ...
    public static class Builder {
        ...
        /**
         * The date and time that the FileSync operation was created in the format of an RFC3339
         * datetime string.
         */
        ...
        /**
         * The date and time when the FileSync operation has started in the format of an RFC3339
         * datetime string.
         */
        ...
        /**
         * The date and time when the FileSync operation has ended in the format of an RFC3339
         * datetime string.
         */
        ...
        /**
         * The duration (in seconds) taken for the VectorStoreConnectorFileSync operation to
         * complete.
         */
        ...
        /**
         * The type of the FileSync operation based on how it is triggered. The type can be either
         * MANUAL or SCHEDULED
         */
    ...
    /**
     * The date and time when the FileSync operation has ended in the format of an RFC3339 datetime
     * string.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeEnded")
