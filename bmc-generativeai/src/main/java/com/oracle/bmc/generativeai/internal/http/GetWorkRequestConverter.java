...
public class GetWorkRequestConverter {
    ...
    public static com.oracle.bmc.generativeai.requests.GetWorkRequestRequest interceptRequest(
            com.oracle.bmc.generativeai.requests.GetWorkRequestRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.generativeai.responses.GetWorkRequestResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.generativeai.responses.GetWorkRequestResponse>() {
                            @Override
                            public com.oracle.bmc.generativeai.responses.GetWorkRequestResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeai.responses.GetWorkRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.generativeai.model.WorkRequest
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.generativeai.responses.GetWorkRequestResponse.Builder
                                        builder =
