...
/**
 * Configuration for generating embeddings from extracted information. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = EmbeddingConfig.Builder.class)
...
public final class EmbeddingConfig extends ModelConfig {
    ...
    public static class Builder {
        ...
        public EmbeddingConfig build() {
            EmbeddingConfig model = new EmbeddingConfig(this.llmSelection);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EmbeddingConfig model) {
    ...
    @Deprecated
    public EmbeddingConfig(LlmSelection llmSelection) {
        super(llmSelection);
    }
