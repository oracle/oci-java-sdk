...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HostedApplicationStorage.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HostedApplicationStorage
    ...
    public HostedApplicationStorage(
            String id,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        /**
         * A message describing the current state of the hosted application storage in more detail
         * that can provide actionable information.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("applicationIds")
        private java.util.List<String> applicationIds;

        /**
         * A list of application OCID.
         *
         * @param applicationIds the value to set
         * @return this builder
         */
        public Builder applicationIds(java.util.List<String> applicationIds) {
            this.applicationIds = applicationIds;
            this.__explicitlySet__.add("applicationIds");
            return this;
        }
        /**
        ...
        public HostedApplicationStorage build() {
            HostedApplicationStorage model =
                    new HostedApplicationStorage(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HostedApplicationStorage model) {
            ...
            if (model.wasPropertyExplicitlySet("applicationIds")) {
                this.applicationIds(model.getApplicationIds());
            }
    ...
    /**
     * A message describing the current state of the hosted application storage in more detail that
    ...
    /** A list of application OCID. */
    @com.fasterxml.jackson.annotation.JsonProperty("applicationIds")
    private final java.util.List<String> applicationIds;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HostedApplicationStorage(");
        ...
        sb.append(", applicationIds=").append(String.valueOf(this.applicationIds));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostedApplicationStorage)) {
            return false;
        }

        HostedApplicationStorage other = (HostedApplicationStorage) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.applicationIds, other.applicationIds)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.applicationIds == null ? 43 : this.applicationIds.hashCode());
