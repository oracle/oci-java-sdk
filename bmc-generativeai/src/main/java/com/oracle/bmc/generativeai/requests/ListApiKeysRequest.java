...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/ListApiKeysExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApiKeysRequest.
 */
...
public class ListApiKeysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.generativeai.model.ApiKey.LifecycleState lifecycleState;

    /**
     * A filter to return only resources that their lifecycle state matches the given lifecycle state.
     */
    public com.oracle.bmc.generativeai.model.ApiKey.LifecycleState getLifecycleState() {
    ...
    public static class Builder
         ...
         * A filter to return only resources that their lifecycle state matches the given lifecycle state.
         */
        private com.oracle.bmc.generativeai.model.ApiKey.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.generativeai.model.ApiKey.LifecycleState lifecycleState) {
        ...
        public ListApiKeysRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListApiKeysRequest(compartmentId, lifecycleState, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
