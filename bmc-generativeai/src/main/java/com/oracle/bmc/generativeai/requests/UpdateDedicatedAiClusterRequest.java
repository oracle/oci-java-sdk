...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/UpdateDedicatedAiClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDedicatedAiClusterRequest.
 */
...
public class UpdateDedicatedAiClusterRequest
    ...
    public static class Builder
        ...
        public UpdateDedicatedAiClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDedicatedAiClusterRequest(dedicatedAiClusterId, updateDedicatedAiClusterDetails, ifMatch, opcRequestId);
        }
    }
