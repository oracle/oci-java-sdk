 ...
 * moderation removes toxic and biased content from responses. It's recommended to use content
 * moderation. <br>
...
public final class ContentModerationConfig
    ...
    public ContentModerationConfig(Boolean isEnabled) {
        super();
    ...
    public static class Builder {
        ...
        public ContentModerationConfig build() {
            ContentModerationConfig model = new ContentModerationConfig(this.isEnabled);
