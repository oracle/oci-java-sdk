...
/**
 * An error encountered while performing an operation that is tracked by this work request. <br>
...
public final class WorkRequestError
    ...
    public static class Builder {
         ...
         * Errors](https://docs.cloud.oracle.com/iaas/Content/API/References/apierrors.htm).
         */
        ...
        /**
         * The date and time that the error occurred, in the format defined by [RFC
