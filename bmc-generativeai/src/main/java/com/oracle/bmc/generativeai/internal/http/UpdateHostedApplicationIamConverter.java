...
public class UpdateHostedApplicationIamConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateHostedApplicationIamConverter.class);

    public static com.oracle.bmc.generativeai.requests.UpdateHostedApplicationIamRequest
            interceptRequest(
                    com.oracle.bmc.generativeai.requests.UpdateHostedApplicationIamRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.generativeai.requests.UpdateHostedApplicationIamRequest request) {
                ...
                newBaseTarget
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getHostedApplicationIamId()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.generativeai.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeai.responses.UpdateHostedApplicationIamResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.generativeai.responses
                                                .UpdateHostedApplicationIamResponse.Builder
                                        builder =
                                                com.oracle.bmc.generativeai.responses
                                                        .UpdateHostedApplicationIamResponse
                                                        .builder()
