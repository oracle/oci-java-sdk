...
public class CreateImportedModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateImportedModelResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateImportedModelResponse> {
         ...
         */
        @Override
        public Builder copy(CreateImportedModelResponse o) {
         ...
         */
        @Override
        public CreateImportedModelResponse build() {
            return new CreateImportedModelResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateImportedModelResponse)) {
            return false;
        }

        CreateImportedModelResponse other = (CreateImportedModelResponse) o;
