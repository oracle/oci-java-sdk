...
/**
 * The interval schedule config. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ScheduleIntervalConfig.Builder.class)
...
public final class ScheduleIntervalConfig extends ScheduleConfig {
    ...
    public static class Builder {
        ...
        public ScheduleIntervalConfig build() {
            ScheduleIntervalConfig model =
                    new ScheduleIntervalConfig(
                            this.state,
                            this.timeStart,
                            this.timeEnd,
                            this.frequency,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleIntervalConfig model) {
    ...
    @Deprecated
    public ScheduleIntervalConfig(
            State state,
            java.util.Date timeStart,
            java.util.Date timeEnd,
            Frequency frequency,
            Integer interval) {
        super(state, timeStart, timeEnd);
        this.frequency = frequency;
        this.interval = interval;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ScheduleIntervalConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleIntervalConfig)) {
            return false;
        }

        ScheduleIntervalConfig other = (ScheduleIntervalConfig) o;
