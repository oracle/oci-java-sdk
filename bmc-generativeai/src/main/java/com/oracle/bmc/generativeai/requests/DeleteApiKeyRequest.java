...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/DeleteApiKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApiKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231130")
public class DeleteApiKeyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteApiKeyRequest, java.lang.Void> {
         ...
         *
         * @return instance of DeleteApiKeyRequest
         */
        public DeleteApiKeyRequest build() {
            DeleteApiKeyRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteApiKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteApiKeyRequest(apiKeyId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().apiKeyId(apiKeyId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
