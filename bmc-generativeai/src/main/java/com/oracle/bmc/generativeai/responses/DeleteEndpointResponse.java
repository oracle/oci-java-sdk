...
public class DeleteEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteEndpointResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteEndpointResponse)) {
            return false;
        }

        DeleteEndpointResponse other = (DeleteEndpointResponse) o;
