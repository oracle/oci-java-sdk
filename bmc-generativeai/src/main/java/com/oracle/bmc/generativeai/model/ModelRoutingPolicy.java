...
/**
 * The model routing policy for the routing profile. Routing candidates are selected from the
 * allowed models list. <br>
...
public final class ModelRoutingPolicy
    ...
    public static class Builder {
        /**
         * The ordered list of model names the routing candidate is selected from (for example,
         * {@code meta.llama-3-70b-instruct}).
         *
    ...
    /**
     * The ordered list of model names the routing candidate is selected from (for example, {@code
