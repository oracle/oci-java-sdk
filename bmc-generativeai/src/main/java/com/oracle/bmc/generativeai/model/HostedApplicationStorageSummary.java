...
/**
 * Summary information about a hosted application storage. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HostedApplicationStorageSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HostedApplicationStorageSummary
    ...
    public HostedApplicationStorageSummary(
            String id,
            String displayName,
            String description,
            ...
            HostedApplicationStorage.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private HostedApplicationStorage.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(HostedApplicationStorage.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public HostedApplicationStorageSummary build() {
            HostedApplicationStorageSummary model =
                    new HostedApplicationStorageSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HostedApplicationStorageSummary model) {
    ...
    /** The current state of the hosted application storage. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final HostedApplicationStorage.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public HostedApplicationStorage.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HostedApplicationStorageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostedApplicationStorageSummary)) {
            return false;
        }

        HostedApplicationStorageSummary other = (HostedApplicationStorageSummary) o;
