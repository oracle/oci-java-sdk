...
public class GenerativeAiPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listApiKeys operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.ApiKeySummary} objects
     * contained in responses from the listApiKeys operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.ApiKeySummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listGenerativeAiPrivateEndpoints operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListGenerativeAiPrivateEndpointsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                ListGenerativeAiPrivateEndpointsRequest, ListGenerativeAiPrivateEndpointsResponse>(
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.GenerativeAiPrivateEndpointSummary} objects
     * contained in responses from the listGenerativeAiPrivateEndpoints operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.GenerativeAiPrivateEndpointSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listGenerativeAiProjects operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListGenerativeAiProjectsResponse> listGenerativeAiProjectsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListGenerativeAiProjectsRequest.Builder, ListGenerativeAiProjectsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.GenerativeAiProjectSummary} objects
     * contained in responses from the listGenerativeAiProjects operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.GenerativeAiProjectSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHostedApplicationStorages operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListHostedApplicationStoragesResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListHostedApplicationStoragesRequest.Builder, ListHostedApplicationStoragesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationStorageSummary} objects
     * contained in responses from the listHostedApplicationStorages operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationStorageSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHostedApplications operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListHostedApplicationsResponse> listHostedApplicationsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListHostedApplicationsRequest.Builder, ListHostedApplicationsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationSummary} objects
     * contained in responses from the listHostedApplications operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHostedApplicationsIam operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListHostedApplicationsIamResponse> listHostedApplicationsIamResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListHostedApplicationsIamRequest.Builder, ListHostedApplicationsIamRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationSummary} objects
     * contained in responses from the listHostedApplicationsIam operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.HostedApplicationSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHostedDeployments operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListHostedDeploymentsResponse> listHostedDeploymentsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListHostedDeploymentsRequest.Builder, ListHostedDeploymentsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.HostedDeploymentSummary} objects
     * contained in responses from the listHostedDeployments operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.HostedDeploymentSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listImportedModels operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListImportedModelsResponse> listImportedModelsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListImportedModelsRequest.Builder, ListImportedModelsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.ImportedModelSummary} objects
     * contained in responses from the listImportedModels operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.ImportedModelSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.generativeai.model.ImportedModelSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListImportedModelsRequest.Builder, ListImportedModelsRequest,
                ListImportedModelsResponse, com.oracle.bmc.generativeai.model.ImportedModelSummary>(
                new java.util.function.Supplier<ListImportedModelsRequest.Builder>() {
                    @Override
                    public ListImportedModelsRequest.Builder get() {
                        return ListImportedModelsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listModelDiscovery operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListModelDiscoveryResponse> listModelDiscoveryResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListModelDiscoveryRequest.Builder, ListModelDiscoveryRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.ModelDiscovery} objects
     * contained in responses from the listModelDiscovery operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.ModelDiscovery} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.generativeai.model.ModelDiscovery>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListModelDiscoveryRequest.Builder, ListModelDiscoveryRequest,
                ListModelDiscoveryResponse, com.oracle.bmc.generativeai.model.ModelDiscovery>(
                new java.util.function.Supplier<ListModelDiscoveryRequest.Builder>() {
                    @Override
                    public ListModelDiscoveryRequest.Builder get() {
                        return ListModelDiscoveryRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listRoutingProfiles operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListRoutingProfilesResponse> listRoutingProfilesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListRoutingProfilesRequest.Builder, ListRoutingProfilesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.RoutingProfileSummary} objects
     * contained in responses from the listRoutingProfiles operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.RoutingProfileSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listSemanticStores operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListSemanticStoresResponse> listSemanticStoresResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListSemanticStoresRequest.Builder, ListSemanticStoresRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.SemanticStoreSummary} objects
     * contained in responses from the listSemanticStores operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.SemanticStoreSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.generativeai.model.SemanticStoreSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListSemanticStoresRequest.Builder, ListSemanticStoresRequest,
                ListSemanticStoresResponse, com.oracle.bmc.generativeai.model.SemanticStoreSummary>(
                new java.util.function.Supplier<ListSemanticStoresRequest.Builder>() {
                    @Override
                    public ListSemanticStoresRequest.Builder get() {
                        return ListSemanticStoresRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listVectorStoreConnectorFileSyncIngestionLogs operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.FileSyncIngestionLogs} objects
     * contained in responses from the listVectorStoreConnectorFileSyncIngestionLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.FileSyncIngestionLogs} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listVectorStoreConnectorFileSyncs operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorFileSyncSummary} objects
     * contained in responses from the listVectorStoreConnectorFileSyncs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorFileSyncSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.generativeai.model.VectorStoreConnectorFileSyncSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListVectorStoreConnectorFileSyncsRequest.Builder,
                ListVectorStoreConnectorFileSyncsRequest, ListVectorStoreConnectorFileSyncsResponse,
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listVectorStoreConnectorIngestionLogs operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorIngestionLogs} objects
     * contained in responses from the listVectorStoreConnectorIngestionLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorIngestionLogs} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listVectorStoreConnectors operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListVectorStoreConnectorsResponse> listVectorStoreConnectorsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListVectorStoreConnectorsRequest.Builder, ListVectorStoreConnectorsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorSummary} objects
     * contained in responses from the listVectorStoreConnectors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.generativeai.model.VectorStoreConnectorSummary} objects
     * contained in responses received from the service.
     */
