...
/**
 * A Semantic Store is a container resource of semantic records, with controllable enrichment
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SemanticStore.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SemanticStore extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SemanticStore model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SemanticStore)) {
            return false;
        }

        SemanticStore other = (SemanticStore) o;
