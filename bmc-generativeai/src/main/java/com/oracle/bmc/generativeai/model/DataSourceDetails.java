...
/**
 * Defines the data source that the semantic model connects to. <br>
...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DataSourceDatabaseToolsConnectionDetails.class,
            name = "DATABASE_TOOLS_CONNECTION")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class DataSourceDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected DataSourceDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataSourceDetails)) {
            return false;
        }

        DataSourceDetails other = (DataSourceDetails) o;
    ...
    public enum ConnectionType implements com.oracle.bmc.http.internal.BmcEnum {
        DatabaseToolsConnection("DATABASE_TOOLS_CONNECTION"),
