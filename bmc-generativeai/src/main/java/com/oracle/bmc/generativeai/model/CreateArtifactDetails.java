...
/**
 * Artifact configuration input for the deployment. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CreateArtifactDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateSingleDockerArtifactDetails.class,
...
public class CreateArtifactDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateArtifactDetails)) {
            return false;
        }
    ...
    public enum ArtifactType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static ArtifactType create(String key) {
            ...
            throw new IllegalArgumentException("Invalid ArtifactType: " + key);
        }
    };
}
