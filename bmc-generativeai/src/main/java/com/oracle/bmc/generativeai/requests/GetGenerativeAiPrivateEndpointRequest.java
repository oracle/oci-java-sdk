...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/GetGenerativeAiPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetGenerativeAiPrivateEndpointRequest.
 */
...
public class GetGenerativeAiPrivateEndpointRequest
    ...
    public static class Builder
        ...
        public GetGenerativeAiPrivateEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetGenerativeAiPrivateEndpointRequest(generativeAiPrivateEndpointId, opcRequestId);
        }
    }
