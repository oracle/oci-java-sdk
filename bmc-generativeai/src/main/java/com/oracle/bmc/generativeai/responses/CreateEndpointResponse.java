...
public class CreateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateEndpointResponse> {
         ...
         * @return this builder
         */
        public Builder endpoint(com.oracle.bmc.generativeai.model.Endpoint endpoint) {
            this.endpoint = endpoint;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(CreateEndpointResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEndpointResponse)) {
            return false;
        }

        CreateEndpointResponse other = (CreateEndpointResponse) o;
