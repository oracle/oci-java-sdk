...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GenerativeAiProject.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GenerativeAiProject
    ...
    public static class Builder {
        ...
        /**
         * The date and time that the generativeAiProject was created in the format of an RFC3339
         * datetime string.
         */
        ...
        /**
         * The date and time that the generativeAiProject was updated in the format of an RFC3339
         * datetime string.
         */
        ...
        public GenerativeAiProject build() {
            GenerativeAiProject model =
                    new GenerativeAiProject(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerativeAiProject model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerativeAiProject)) {
            return false;
        }

        GenerativeAiProject other = (GenerativeAiProject) o;
