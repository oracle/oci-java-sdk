...
/**
 * Hosted Application IAM, defines shared configurations that apply across multiple deployments of
 * the Agent or MCP application.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HostedApplicationIam.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HostedApplicationIam
    ...
    public static class Builder {
        ...
        public HostedApplicationIam build() {
            HostedApplicationIam model =
                    new HostedApplicationIam(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HostedApplicationIam model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HostedApplicationIam(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostedApplicationIam)) {
            return false;
        }

        HostedApplicationIam other = (HostedApplicationIam) o;
