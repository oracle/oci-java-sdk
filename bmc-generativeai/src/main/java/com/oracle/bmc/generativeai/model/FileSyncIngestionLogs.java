...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = FileSyncIngestionLogs.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class FileSyncIngestionLogs
    ...
    public static class Builder {
        ...
        public FileSyncIngestionLogs build() {
            FileSyncIngestionLogs model =
                    new FileSyncIngestionLogs(
                            this.fileId,
                            this.filePath,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FileSyncIngestionLogs model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FileSyncIngestionLogs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FileSyncIngestionLogs)) {
            return false;
        }

        FileSyncIngestionLogs other = (FileSyncIngestionLogs) o;
