...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/DeleteGenerativeAiPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteGenerativeAiPrivateEndpointRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231130")
public class DeleteGenerativeAiPrivateEndpointRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteGenerativeAiPrivateEndpointRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteGenerativeAiPrivateEndpointRequest o) {
        ...
        /**
         * Build the instance of DeleteGenerativeAiPrivateEndpointRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteGenerativeAiPrivateEndpointRequest
         */
        public DeleteGenerativeAiPrivateEndpointRequest build() {
            DeleteGenerativeAiPrivateEndpointRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteGenerativeAiPrivateEndpointRequest
         */
        public DeleteGenerativeAiPrivateEndpointRequest buildWithoutInvocationCallback() {
            DeleteGenerativeAiPrivateEndpointRequest request =
                    new DeleteGenerativeAiPrivateEndpointRequest();
            request.generativeAiPrivateEndpointId = generativeAiPrivateEndpointId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteGenerativeAiPrivateEndpointRequest(generativeAiPrivateEndpointId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteGenerativeAiPrivateEndpointRequest)) {
            return false;
        }

        DeleteGenerativeAiPrivateEndpointRequest other =
                (DeleteGenerativeAiPrivateEndpointRequest) o;
