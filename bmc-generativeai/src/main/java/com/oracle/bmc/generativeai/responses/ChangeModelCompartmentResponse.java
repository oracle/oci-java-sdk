...
public class ChangeModelCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ChangeModelCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeModelCompartmentResponse o) {
        ...
        public ChangeModelCompartmentResponse build() {
            return new ChangeModelCompartmentResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeModelCompartmentResponse)) {
            return false;
        }

        ChangeModelCompartmentResponse other = (ChangeModelCompartmentResponse) o;
