...
/**
 * Defines the source location and method used to import the model. Supports importing from Hugging
 * Face, an Object Storage location, or by referencing an already imported model. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "sourceType",
        defaultImpl = ModelDataSource.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStorageObject.class,
            name = "OBJECT_STORAGE_OBJECT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = HuggingFaceModel.class,
            name = "HUGGING_FACE_MODEL")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class ModelDataSource extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ModelDataSource() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModelDataSource)) {
            return false;
        }

        ModelDataSource other = (ModelDataSource) o;
