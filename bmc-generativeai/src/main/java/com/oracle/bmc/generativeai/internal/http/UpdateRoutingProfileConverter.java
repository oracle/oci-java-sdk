...
public class UpdateRoutingProfileConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateRoutingProfileConverter.class);

    public static com.oracle.bmc.generativeai.requests.UpdateRoutingProfileRequest interceptRequest(
            com.oracle.bmc.generativeai.requests.UpdateRoutingProfileRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.generativeai.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeai.responses.UpdateRoutingProfileResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.generativeai.model.RoutingProfile
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.generativeai.responses.UpdateRoutingProfileResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.generativeai.responses
                                                        .UpdateRoutingProfileResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.routingProfile(response.getItem());
