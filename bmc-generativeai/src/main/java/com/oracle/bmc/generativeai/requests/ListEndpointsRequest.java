...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/ListEndpointsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEndpointsRequest.
 */
...
public class ListEndpointsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.generativeai.model.Endpoint.LifecycleState lifecycleState;

    /**
     * A filter to return only resources that their lifecycle state matches the given lifecycle state.
     */
    public com.oracle.bmc.generativeai.model.Endpoint.LifecycleState getLifecycleState() {
    ...
    public static class Builder
         ...
         * A filter to return only resources that their lifecycle state matches the given lifecycle state.
         */
        private com.oracle.bmc.generativeai.model.Endpoint.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.generativeai.model.Endpoint.LifecycleState lifecycleState) {
