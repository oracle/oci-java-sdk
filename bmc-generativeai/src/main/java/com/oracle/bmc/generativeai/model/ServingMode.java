...
/**
 * The deployment mode of the model, which can be either ON_DEMAND (the model is hosted in a shared
 * environment and can be accessed on demand) or DEDICATED (the model is hosted in a dedicated
 * environment for better performance and isolation).
 */
