...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeai/ListModelDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelDiscoveryRequest.
 */
...
public class ListModelDiscoveryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A filter to return only resources whose serving modes match the given servingModes.
         * @param singularValue the singular value to set
         * @return this builder instance
         */
        ...
        public ListModelDiscoveryRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListModelDiscoveryRequest(compartmentId, realm, region, modelId, servingMode, apiCapability, capability, modelAccess, isDeprecated, isOnDemandRetired, isDedicatedRetired, opcRequestId, limit, page);
        }
    }
