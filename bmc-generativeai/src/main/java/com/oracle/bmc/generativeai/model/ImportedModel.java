...
/**
 * Represents a model imported into the system based on an external data source, such as Hugging
 * Face or Object Storage.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ImportedModel.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ImportedModel extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private ImportedModel previousState;

        public Builder previousState(ImportedModel previousState) {
            this.previousState = previousState;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportedModel model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("previousState")
    private final ImportedModel previousState;

    public ImportedModel getPreviousState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportedModel)) {
            return false;
        }

        ImportedModel other = (ImportedModel) o;
