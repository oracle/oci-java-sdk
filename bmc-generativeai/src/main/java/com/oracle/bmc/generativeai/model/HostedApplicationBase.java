...
/**
 * Common properties shared by HostedApplication and HostedApplicationIam. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HostedApplicationBase.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HostedApplicationBase
    ...
    public static class Builder {
        ...
        public HostedApplicationBase build() {
            HostedApplicationBase model =
                    new HostedApplicationBase(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HostedApplicationBase model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HostedApplicationBase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostedApplicationBase)) {
            return false;
        }

        HostedApplicationBase other = (HostedApplicationBase) o;
