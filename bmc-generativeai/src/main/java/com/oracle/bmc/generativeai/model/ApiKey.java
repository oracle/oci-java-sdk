...
/**
 * ApiKeys are resources used to access GenAI models. You must be authorized through an IAM policy
 * to use any API operations. If you're not authorized, contact an administrator who manages OCI
 * resource access. See [Getting Started with
...
public final class ApiKey extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public ApiKey(
            ...
            java.util.List<ApiKeyItem> keys,
    ...
    public static class Builder {
        ...
        private java.util.List<ApiKeyItem> keys;
         ...
         * @return this builder
         */
        public Builder keys(java.util.List<ApiKeyItem> keys) {
            this.keys = keys;
    ...
    /** The list of keys. */
    @com.fasterxml.jackson.annotation.JsonProperty("keys")
    private final java.util.List<ApiKeyItem> keys;
     ...
     * @return the value
     */
    public java.util.List<ApiKeyItem> getKeys() {
        return keys;
    }
