...
/**
 * Hosted Application, defines shared configurations that apply across multiple deployments of the
 * Agent or MCP application.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HostedApplication.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HostedApplication
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostedApplication)) {
            return false;
        }
