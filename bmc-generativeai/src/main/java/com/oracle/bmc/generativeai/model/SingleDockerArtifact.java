...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SingleDockerArtifact.Builder.class)
...
public final class SingleDockerArtifact extends Artifact {
    ...
    public static class Builder {
        ...
        public Builder hostedDeploymentId(String hostedDeploymentId) {
            ...
            this.__explicitlySet__.add("hostedDeploymentId");
            return this;
        }
        ...
        public SingleDockerArtifact build() {
            SingleDockerArtifact model =
                    new SingleDockerArtifact(
                            this.id,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SingleDockerArtifact model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SingleDockerArtifact(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SingleDockerArtifact)) {
            return false;
        }

        SingleDockerArtifact other = (SingleDockerArtifact) o;
