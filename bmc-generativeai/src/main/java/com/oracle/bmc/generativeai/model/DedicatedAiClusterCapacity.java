...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = DedicatedAiClusterCapacity.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DedicatedAiClusterHostingCapacity.class,
        name = "HOSTING_CAPACITY"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class DedicatedAiClusterCapacity extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected DedicatedAiClusterCapacity() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DedicatedAiClusterCapacity(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DedicatedAiClusterCapacity)) {
            return false;
        }

        DedicatedAiClusterCapacity other = (DedicatedAiClusterCapacity) o;
    ...
    public enum CapacityType {
        HostingCapacity("HOSTING_CAPACITY"),
