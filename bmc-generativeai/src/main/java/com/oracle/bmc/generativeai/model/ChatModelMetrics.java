...
/**
 * The chat model metrics of the fine-tuning process. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ChatModelMetrics.Builder.class)
...
public final class ChatModelMetrics extends ModelMetrics {
    ...
    public static class Builder {
        ...
        public ChatModelMetrics build() {
            ChatModelMetrics model = new ChatModelMetrics(this.finalAccuracy, this.finalLoss);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChatModelMetrics model) {
    ...
    @Deprecated
    public ChatModelMetrics(Double finalAccuracy, Double finalLoss) {
        super();
        this.finalAccuracy = finalAccuracy;
        this.finalLoss = finalLoss;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChatModelMetrics)) {
            return false;
        }

        ChatModelMetrics other = (ChatModelMetrics) o;
