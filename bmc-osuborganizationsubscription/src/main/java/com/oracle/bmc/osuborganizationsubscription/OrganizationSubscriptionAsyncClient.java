...
public class OrganizationSubscriptionAsyncClient implements OrganizationSubscriptionAsync {
     ...
     */
    public OrganizationSubscriptionAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, OrganizationSubscriptionAsyncClient> {
    ...
    @Override
    public java.util.concurrent.Future<ListOrganizationSubscriptionsResponse>
            listOrganizationSubscriptions(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listOrganizationSubscriptions");
