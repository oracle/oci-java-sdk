...
public class SubscriptionPaginators {
     ...
     * com.oracle.bmc.osubsubscription.model.SubscriptionSummary} objects contained in responses
     * from the listSubscriptions operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
