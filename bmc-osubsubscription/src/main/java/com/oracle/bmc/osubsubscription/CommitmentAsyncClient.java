...
public class CommitmentAsyncClient implements CommitmentAsync {
    /**
    ...
    public static class Builder
        ...
        public CommitmentAsyncClient build(
            ...
            return new CommitmentAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<GetCommitmentResponse> getCommitment(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetCommitmentRequest, GetCommitmentResponse>
                    handler) {
        LOG.trace("Called async getCommitment");
        final GetCommitmentRequest interceptedRequest =
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<GetCommitmentResponse>>
    ...
    public java.util.concurrent.Future<ListCommitmentsResponse> listCommitments(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listCommitments");
        final ListCommitmentsRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListCommitmentsRequest, ListCommitmentsResponse>,
                        java.util.concurrent.Future<ListCommitmentsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
