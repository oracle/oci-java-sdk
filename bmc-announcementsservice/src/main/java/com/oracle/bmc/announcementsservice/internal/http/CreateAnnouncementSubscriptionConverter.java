...
public class CreateAnnouncementSubscriptionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateAnnouncementSubscriptionConverter.class);

    public static com.oracle.bmc.announcementsservice.requests.CreateAnnouncementSubscriptionRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.announcementsservice.requests.CreateAnnouncementSubscriptionRequest
                    request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20180904").path("announcementSubscriptions");
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.announcementsservice.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.announcementsservice.responses.CreateAnnouncementSubscriptionResponse");
                                ...
                                com.oracle.bmc.announcementsservice.responses
                                                .CreateAnnouncementSubscriptionResponse.Builder
                                        builder =
                                                com.oracle.bmc.announcementsservice.responses
                                                        .CreateAnnouncementSubscriptionResponse
                                                        .builder()
