...
/**
 * The details for creating a new announcement subscription. <br>
...
public final class CreateAnnouncementSubscriptionDetails
    ...
    public static class Builder {
         ...
         * announcements that match the configured announcement subscription. The caller of the
         * operation needs the ONS_TOPIC_PUBLISH permission for the targeted Notifications service
         * topic. For more information about Notifications permissions, see [Details for
        ...
        /**
         * A list of filter groups for the announcement subscription. A filter group combines one or
         * more filters that the Announcements service applies to announcements for matching
         * purposes.
         */
        ...
        public CreateAnnouncementSubscriptionDetails build() {
            CreateAnnouncementSubscriptionDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAnnouncementSubscriptionDetails model) {
     ...
     * that match the configured announcement subscription. The caller of the operation needs the
    ...
    /**
     * A list of filter groups for the announcement subscription. A filter group combines one or
     * more filters that the Announcements service applies to announcements for matching purposes.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("filterGroups")
