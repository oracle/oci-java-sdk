...
public class ListAnnouncementsPreferencesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.announcementsservice.model.AnnouncementsPreferencesSummary>
            getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAnnouncementsPreferencesResponse)) {
            return false;
        }

        ListAnnouncementsPreferencesResponse other = (ListAnnouncementsPreferencesResponse) o;
