...
/**
 * Async client implementation for Service service. <br>
...
public class ServiceAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements ServiceAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ServiceAsyncClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ServiceAsyncClient> {
         ...
         * @return the client
         */
        public ServiceAsyncClient build(
    ...
    public java.util.concurrent.Future<ListServicesResponse> listServices(
        ...
        return clientCall(request, ListServicesResponse::builder)
                ...
                .appendEnumQueryParam("commsManagerName", request.getCommsManagerName())
                ...
                .handleBody(
                        com.oracle.bmc.announcementsservice.model.ServicesCollection.class,
                        ListServicesResponse.Builder::servicesCollection)
