...
/**
 * The details for updating a filter group in an announcement subscription. <br>
...
public final class UpdateFilterGroupDetails
    ...
    public static class Builder {
        /**
         * A list of filters against which the Announcements service will match announcements. You
