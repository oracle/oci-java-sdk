...
public class GetAnnouncementSubscriptionConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAnnouncementSubscriptionConverter.class);

    public static com.oracle.bmc.announcementsservice.requests.GetAnnouncementSubscriptionRequest
            interceptRequest(
                    com.oracle.bmc.announcementsservice.requests.GetAnnouncementSubscriptionRequest
                            request) {
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.announcementsservice.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.announcementsservice.responses.GetAnnouncementSubscriptionResponse");
                                ...
                                com.oracle.bmc.announcementsservice.responses
                                                .GetAnnouncementSubscriptionResponse.Builder
                                        builder =
                                                com.oracle.bmc.announcementsservice.responses
                                                        .GetAnnouncementSubscriptionResponse
                                                        .builder()
