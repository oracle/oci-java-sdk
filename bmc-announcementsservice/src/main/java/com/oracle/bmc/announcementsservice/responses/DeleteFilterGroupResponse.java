...
public class DeleteFilterGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteFilterGroupResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteFilterGroupResponse)) {
            return false;
        }

        DeleteFilterGroupResponse other = (DeleteFilterGroupResponse) o;
