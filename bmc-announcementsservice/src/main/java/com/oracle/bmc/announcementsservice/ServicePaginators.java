 ...
 * to any list operations of Service where multiple pages of data may be fetched. Two styles of
...
public class ServicePaginators {
     ...
     * com.oracle.bmc.announcementsservice.model.ServiceSummary} objects contained in responses from
     * the listServices operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.announcementsservice.model.ServiceSummary} objects contained in responses
     *     received from the service.
     */
