...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/announcementsservice/GetAnnouncementsPreferenceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAnnouncementsPreferenceRequest.
 */
...
public class GetAnnouncementsPreferenceRequest
    ...
    public static class Builder
        ...
        public GetAnnouncementsPreferenceRequest build() {
            GetAnnouncementsPreferenceRequest request = buildWithoutInvocationCallback();
