...
/**
 * The details for creating a new filter group for an announcement subscription. <br>
...
public final class CreateFilterGroupDetails
    ...
    public static class Builder {
        /**
         * The name of the filter group. The name must be unique and it cannot be changed. Avoid
