...
public class CreateAnnouncementsPreferencesDetails
    ...
    public static class Builder {
        ...
        public CreateAnnouncementsPreferencesDetails build() {
            CreateAnnouncementsPreferencesDetails __instance__ =
                    new CreateAnnouncementsPreferencesDetails(
                            isUnsubscribed, compartmentId, preferenceType);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAnnouncementsPreferencesDetails o) {
