...
/**
 * A summary representation of an announcement subscription. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AnnouncementSubscriptionSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AnnouncementSubscriptionSummary
    ...
    public AnnouncementSubscriptionSummary(
            String id,
            String displayName,
    ...
    public static class Builder {
        ...
        private AnnouncementSubscription.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(AnnouncementSubscription.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public AnnouncementSubscriptionSummary build() {
            AnnouncementSubscriptionSummary model =
                    new AnnouncementSubscriptionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnnouncementSubscriptionSummary model) {
    ...
    /** The current lifecycle state of the announcement subscription. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final AnnouncementSubscription.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public AnnouncementSubscription.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AnnouncementSubscriptionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnnouncementSubscriptionSummary)) {
            return false;
        }

        AnnouncementSubscriptionSummary other = (AnnouncementSubscriptionSummary) o;
