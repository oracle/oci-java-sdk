...
public class AnnouncementSubscriptionClient implements AnnouncementSubscription {
    /**
     ...
     */
    protected AnnouncementSubscriptionClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeAnnouncementSubscriptionCompartmentResponse
        ...
        LOG.trace("Called changeAnnouncementSubscriptionCompartment");
    ...
    public CreateAnnouncementSubscriptionResponse createAnnouncementSubscription(
        ...
        LOG.trace("Called createAnnouncementSubscription");
    ...
    public CreateFilterGroupResponse createFilterGroup(CreateFilterGroupRequest request) {
        LOG.trace("Called createFilterGroup");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateFilterGroupResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateFilterGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteAnnouncementSubscriptionResponse deleteAnnouncementSubscription(
        ...
        LOG.trace("Called deleteAnnouncementSubscription");
    ...
    public DeleteFilterGroupResponse deleteFilterGroup(DeleteFilterGroupRequest request) {
        LOG.trace("Called deleteFilterGroup");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteFilterGroupResponse>
                transformer =
    ...
    public GetAnnouncementSubscriptionResponse getAnnouncementSubscription(
        ...
        LOG.trace("Called getAnnouncementSubscription");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetAnnouncementSubscriptionResponse>
                transformer =
    ...
    public ListAnnouncementSubscriptionsResponse listAnnouncementSubscriptions(
        ...
        LOG.trace("Called listAnnouncementSubscriptions");
    ...
    public UpdateAnnouncementSubscriptionResponse updateAnnouncementSubscription(
        ...
        LOG.trace("Called updateAnnouncementSubscription");
    ...
    public UpdateFilterGroupResponse updateFilterGroup(UpdateFilterGroupRequest request) {
        LOG.trace("Called updateFilterGroup");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateFilterGroupResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateFilterGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
