...
/**
 * The object for announcement email preferences. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AnnouncementsPreferences.Builder.class)
...
public final class AnnouncementsPreferences extends BaseAnnouncementsPreferences {
    ...
    public static class Builder {
        ...
        public AnnouncementsPreferences build() {
            AnnouncementsPreferences model =
                    new AnnouncementsPreferences(
                            this.compartmentId,
                            this.id,
                            this.isUnsubscribed,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnnouncementsPreferences model) {
    ...
    @Deprecated
    public AnnouncementsPreferences(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnnouncementsPreferences)) {
            return false;
        }

        AnnouncementsPreferences other = (AnnouncementsPreferences) o;
