...
public class ServiceClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Service {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ServiceClient.class);

    private final ServicePaginators paginators;
    ...
    ServiceClient(
        ...
        this.paginators = new ServicePaginators(this);
    }
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ServiceClient> {
        ...
        public ServiceClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ServiceClient(this, authenticationDetailsProvider);
        }
    }
    ...
    @Override
    public ServicePaginators getPaginators() {
        return paginators;
    }
