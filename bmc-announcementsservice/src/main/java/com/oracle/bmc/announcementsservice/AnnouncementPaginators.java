 ...
 * to any list operations of Announcement where multiple pages of data may be fetched. Two styles of
...
public class AnnouncementPaginators {
     ...
     * com.oracle.bmc.announcementsservice.model.AnnouncementSummary} objects contained in responses
     * from the listAnnouncements operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.announcementsservice.model.AnnouncementSummary} objects contained in
