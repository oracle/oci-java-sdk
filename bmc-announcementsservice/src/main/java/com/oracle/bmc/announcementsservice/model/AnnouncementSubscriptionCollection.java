...
/**
 * The results of a search for announcement subscriptions. This object contains both announcement
 * subscription summary objects and other information, such as metadata. <br>
...
public final class AnnouncementSubscriptionCollection
    ...
    public static class Builder {
        ...
        public AnnouncementSubscriptionCollection build() {
            AnnouncementSubscriptionCollection model =
                    new AnnouncementSubscriptionCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnnouncementSubscriptionCollection model) {
