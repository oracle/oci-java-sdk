...
public class CreateSenderResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSenderResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSenderResponse)) {
            return false;
        }

        CreateSenderResponse other = (CreateSenderResponse) o;
