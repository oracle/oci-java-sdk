...
public class EmailPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listEmailIpPools operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.email.model.EmailIpPoolSummary} objects
     * contained in responses from the listEmailIpPools operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.email.model.EmailIpPoolSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listEmailOutboundIps operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListEmailOutboundIpsResponse> listEmailOutboundIpsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListEmailOutboundIpsRequest.Builder, ListEmailOutboundIpsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.email.model.EmailOutboundIpSummary} objects
     * contained in responses from the listEmailOutboundIps operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.email.model.EmailOutboundIpSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.email.model.EmailOutboundIpSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListEmailOutboundIpsRequest.Builder, ListEmailOutboundIpsRequest,
                ListEmailOutboundIpsResponse, com.oracle.bmc.email.model.EmailOutboundIpSummary>(
                new java.util.function.Supplier<ListEmailOutboundIpsRequest.Builder>() {
                    @Override
                    public ListEmailOutboundIpsRequest.Builder get() {
                        return ListEmailOutboundIpsRequest.builder().copy(request);
