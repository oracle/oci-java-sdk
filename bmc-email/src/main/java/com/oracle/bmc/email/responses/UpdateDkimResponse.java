...
public class UpdateDkimResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDkimResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDkimResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDkimResponse)) {
            return false;
        }

        UpdateDkimResponse other = (UpdateDkimResponse) o;
