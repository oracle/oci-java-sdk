...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EmailIpPoolSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class EmailIpPoolSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public EmailIpPoolSummary(
            String id,
            String name,
            String compartmentId,
            EmailIpPool.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private EmailIpPool.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(EmailIpPool.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public EmailIpPoolSummary build() {
            EmailIpPoolSummary model =
                    new EmailIpPoolSummary(
                            this.id,
                            this.name,
                            this.compartmentId,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EmailIpPoolSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final EmailIpPool.LifecycleState lifecycleState;

    /**
     * The current state of the IpPool.
     * @return the value
     **/
    public EmailIpPool.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmailIpPoolSummary)) {
            return false;
        }

        EmailIpPoolSummary other = (EmailIpPoolSummary) o;
