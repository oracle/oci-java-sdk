...
public class ChangeEmailDomainCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeEmailDomainCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeEmailDomainCompartmentResponse)) {
            return false;
        }

        ChangeEmailDomainCompartmentResponse other = (ChangeEmailDomainCompartmentResponse) o;
