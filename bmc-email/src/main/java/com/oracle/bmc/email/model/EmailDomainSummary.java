...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EmailDomainSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class EmailDomainSummary
    ...
    public EmailDomainSummary(
            String name,
            String id,
            String compartmentId,
            EmailDomain.LifecycleState lifecycleState,
            String activeDkimId,
            String description,
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder lifecycleState(EmailDomain.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the DKIM key that is adding the DKIM signature for this email domain.
         */
        ...
        public EmailDomainSummary build() {
            EmailDomainSummary model =
                    new EmailDomainSummary(
                            this.name,
                            this.id,
                            this.compartmentId,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EmailDomainSummary model) {
    ...
    /** The current state of the email domain. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final EmailDomain.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public EmailDomain.LifecycleState getLifecycleState() {
        return lifecycleState;
    }

    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the DKIM key that is adding the DKIM signature for this email domain.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("activeDkimId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmailDomainSummary)) {
            return false;
        }

        EmailDomainSummary other = (EmailDomainSummary) o;
