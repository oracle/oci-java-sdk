...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/RemoveReturnPathLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveReturnPathLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20170907")
public class RemoveReturnPathLockRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RemoveReturnPathLockRequest, com.oracle.bmc.email.model.RemoveLockDetails> {
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveReturnPathLockRequest o) {
        ...
        /**
         * Build the instance of RemoveReturnPathLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveReturnPathLockRequest
         */
        public RemoveReturnPathLockRequest build() {
            RemoveReturnPathLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveReturnPathLockRequest
         */
        public RemoveReturnPathLockRequest buildWithoutInvocationCallback() {
            RemoveReturnPathLockRequest request = new RemoveReturnPathLockRequest();
            request.emailReturnPathId = emailReturnPathId;
            request.removeLockDetails = removeLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveReturnPathLockRequest(emailReturnPathId, removeLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveReturnPathLockRequest)) {
            return false;
        }

        RemoveReturnPathLockRequest other = (RemoveReturnPathLockRequest) o;
