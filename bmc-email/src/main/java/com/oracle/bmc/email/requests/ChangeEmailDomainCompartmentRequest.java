...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/ChangeEmailDomainCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeEmailDomainCompartmentRequest.
 */
...
public class ChangeEmailDomainCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeEmailDomainCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeEmailDomainCompartmentRequest(emailDomainId, changeEmailDomainCompartmentDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
