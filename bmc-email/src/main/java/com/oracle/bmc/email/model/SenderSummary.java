...
/**
 * The email addresses and {@code senderId} representing an approved sender. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SenderSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SenderSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SenderSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SenderSummary)) {
            return false;
        }

        SenderSummary other = (SenderSummary) o;
