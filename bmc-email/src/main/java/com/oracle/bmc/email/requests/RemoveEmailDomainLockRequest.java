...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/RemoveEmailDomainLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveEmailDomainLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20170907")
public class RemoveEmailDomainLockRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RemoveEmailDomainLockRequest, com.oracle.bmc.email.model.RemoveLockDetails> {
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveEmailDomainLockRequest o) {
        ...
        /**
         * Build the instance of RemoveEmailDomainLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveEmailDomainLockRequest
         */
        public RemoveEmailDomainLockRequest build() {
            RemoveEmailDomainLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveEmailDomainLockRequest
         */
        public RemoveEmailDomainLockRequest buildWithoutInvocationCallback() {
            RemoveEmailDomainLockRequest request = new RemoveEmailDomainLockRequest();
            request.emailDomainId = emailDomainId;
            request.removeLockDetails = removeLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveEmailDomainLockRequest(emailDomainId, removeLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveEmailDomainLockRequest)) {
            return false;
        }

        RemoveEmailDomainLockRequest other = (RemoveEmailDomainLockRequest) o;
