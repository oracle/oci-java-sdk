...
/**
 * Outbound IP details to be assigned to the IpPool. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddEmailOutboundIpDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddEmailOutboundIpDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"outboundIps"})
    public AddEmailOutboundIpDetails(java.util.List<String> outboundIps) {
        super();
    ...
    public static class Builder {
        /**
         * List of public IPs to ADD to the IpPool. Public IPs must be in the AVAILABLE state to be
         * assigned to the IpPool.
         */
        ...
        public AddEmailOutboundIpDetails build() {
            AddEmailOutboundIpDetails model = new AddEmailOutboundIpDetails(this.outboundIps);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddEmailOutboundIpDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddEmailOutboundIpDetails)) {
            return false;
        }

        AddEmailOutboundIpDetails other = (AddEmailOutboundIpDetails) o;
