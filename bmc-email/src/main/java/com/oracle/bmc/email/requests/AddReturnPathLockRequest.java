...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/AddReturnPathLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddReturnPathLockRequest.
 */
...
public class AddReturnPathLockRequest
    ...
    public static class Builder
        ...
        public AddReturnPathLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddReturnPathLockRequest(emailReturnPathId, addLockDetails, opcRequestId, ifMatch);
        }
    }
