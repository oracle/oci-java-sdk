...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/ChangeEmailIpPoolCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeEmailIpPoolCompartmentRequest.
 */
...
public class ChangeEmailIpPoolCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeEmailIpPoolCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeEmailIpPoolCompartmentRequest(emailIpPoolId, changeEmailIpPoolCompartmentDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
