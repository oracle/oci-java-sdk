...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/ListEmailReturnPathsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEmailReturnPathsRequest.
 */
...
public class ListEmailReturnPathsRequest
    ...
    public static class Builder
        ...
        public Builder lifecycleState(
                com.oracle.bmc.email.model.EmailReturnPath.LifecycleState lifecycleState) {
        ...
        public Builder copy(ListEmailReturnPathsRequest o) {
            ...
            parentResourceId(o.getParentResourceId());
            id(o.getId());
            name(o.getName());
            limit(o.getLimit());
            page(o.getPage());
        ...
        public ListEmailReturnPathsRequest build() {
            ListEmailReturnPathsRequest request = buildWithoutInvocationCallback();
        ...
        public ListEmailReturnPathsRequest buildWithoutInvocationCallback() {
            ListEmailReturnPathsRequest request = new ListEmailReturnPathsRequest();
            request.opcRequestId = opcRequestId;
            request.compartmentId = compartmentId;
            request.parentResourceId = parentResourceId;
            request.id = id;
            request.name = name;
            request.limit = limit;
            request.page = page;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListEmailReturnPathsRequest)) {
            return false;
        }

        ListEmailReturnPathsRequest other = (ListEmailReturnPathsRequest) o;
