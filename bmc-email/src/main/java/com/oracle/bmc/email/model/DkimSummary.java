...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DkimSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class DkimSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DkimSummary model) {
    ...
    /** The current state of the DKIM. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final Dkim.LifecycleState lifecycleState;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DkimSummary)) {
            return false;
        }

        DkimSummary other = (DkimSummary) o;
