...
public class GetEmailDomainResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetEmailDomainResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEmailDomainResponse)) {
            return false;
        }

        GetEmailDomainResponse other = (GetEmailDomainResponse) o;
