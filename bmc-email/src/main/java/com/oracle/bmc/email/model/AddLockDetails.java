...
public final class AddLockDetails
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"type", "compartmentId", "relatedResourceId", "message"})
    public AddLockDetails(
            Type type, String compartmentId, String relatedResourceId, String message) {
        super();
        this.type = type;
    ...
    public static class Builder {
        ...
        public AddLockDetails build() {
            AddLockDetails model =
                    new AddLockDetails(
                            this.type, this.compartmentId, this.relatedResourceId, this.message);
