...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/GetDkimExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDkimRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20170907")
public class GetDkimRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetDkimRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetDkimRequest
         */
        public GetDkimRequest build() {
            GetDkimRequest request = buildWithoutInvocationCallback();
        ...
        public GetDkimRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDkimRequest(dkimId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().dkimId(dkimId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetDkimRequest other = (GetDkimRequest) o;
