...
/**
 * The attributes to update an IpPool which will be used to route emails. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateEmailIpPoolDetails.Builder.class)
...
public final class UpdateEmailIpPoolDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEmailIpPoolDetails)) {
            return false;
        }
