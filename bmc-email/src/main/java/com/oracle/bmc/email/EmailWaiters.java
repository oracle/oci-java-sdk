...
public class EmailWaiters {
    ...
    public EmailWaiters(java.util.concurrent.ExecutorService executorService, Email client) {
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetEmailIpPoolRequest, GetEmailIpPoolResponse>
            forEmailIpPool(
                    GetEmailIpPoolRequest request,
                    com.oracle.bmc.email.model.EmailIpPool.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forEmailIpPool(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetEmailIpPoolRequest, GetEmailIpPoolResponse>
            forEmailIpPool(
                    GetEmailIpPoolRequest request,
                    com.oracle.bmc.email.model.EmailIpPool.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for EmailIpPool.
    private com.oracle.bmc.waiter.Waiter<GetEmailIpPoolRequest, GetEmailIpPoolResponse>
            forEmailIpPool(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetEmailIpPoolRequest request,
                    final com.oracle.bmc.email.model.EmailIpPool.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.email.model.EmailIpPool.LifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetEmailIpPoolResponse apply(GetEmailIpPoolRequest request) {
                                return client.getEmailIpPool(request);
                            }
                        },
                        new java.util.function.Predicate<GetEmailIpPoolResponse>() {
                            @Override
                            public boolean test(GetEmailIpPoolResponse response) {
                                return targetStatesSet.contains(
                                        response.getEmailIpPool().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.email.model.EmailIpPool.LifecycleState.Deleted)),
                request);
    }
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetEmailReturnPathRequest, GetEmailReturnPathResponse>
            forEmailReturnPath(
    ...
    public com.oracle.bmc.waiter.Waiter<GetEmailReturnPathRequest, GetEmailReturnPathResponse>
            forEmailReturnPath(
                    GetEmailReturnPathRequest request,
                    com.oracle.bmc.email.model.EmailReturnPath.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for EmailReturnPath.
    private com.oracle.bmc.waiter.Waiter<GetEmailReturnPathRequest, GetEmailReturnPathResponse>
            forEmailReturnPath(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetEmailReturnPathRequest request,
                    final com.oracle.bmc.email.model.EmailReturnPath.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.email.model.EmailReturnPath.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetEmailReturnPathResponse apply(
                                    GetEmailReturnPathRequest request) {
                                return client.getEmailReturnPath(request);
                            }
                        },
                        new java.util.function.Predicate<GetEmailReturnPathResponse>() {
                            @Override
                            public boolean test(GetEmailReturnPathResponse response) {
                                return targetStatesSet.contains(
                                        response.getEmailReturnPath().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.email.model.EmailReturnPath.LifecycleState.Deleted)),
                request);
    }
