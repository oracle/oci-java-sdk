...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     */
    private com.oracle.bmc.email.model.WorkRequest workRequest;

    /**
     * The returned WorkRequest instance.
     * @return the value
     */
    public com.oracle.bmc.email.model.WorkRequest getWorkRequest() {
        return workRequest;
    }
    ...
    private GetWorkRequestResponse(
            ...
            String opcRequestId,
            Integer retryAfter,
            com.oracle.bmc.email.model.WorkRequest workRequest) {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder workRequest(com.oracle.bmc.email.model.WorkRequest workRequest) {
            this.workRequest = workRequest;
            return this;
        }
