...
/**
 * The configuration details for creating a new email domain. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateEmailDomainDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateEmailDomainDetails
    ...
    public static class Builder {
        ...
        public CreateEmailDomainDetails build() {
            CreateEmailDomainDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEmailDomainDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateEmailDomainDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEmailDomainDetails)) {
            return false;
        }
