...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/email/AddEmailIpPoolLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddEmailIpPoolLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20170907")
public class AddEmailIpPoolLockRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    AddEmailIpPoolLockRequest, com.oracle.bmc.email.model.AddLockDetails> {
         ...
         * @return this builder instance
         */
        public Builder copy(AddEmailIpPoolLockRequest o) {
        ...
        /**
         * Build the instance of AddEmailIpPoolLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddEmailIpPoolLockRequest
         */
        public AddEmailIpPoolLockRequest build() {
            AddEmailIpPoolLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddEmailIpPoolLockRequest
         */
        public AddEmailIpPoolLockRequest buildWithoutInvocationCallback() {
            AddEmailIpPoolLockRequest request = new AddEmailIpPoolLockRequest();
            request.emailIpPoolId = emailIpPoolId;
            request.addLockDetails = addLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new AddEmailIpPoolLockRequest(emailIpPoolId, addLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddEmailIpPoolLockRequest)) {
            return false;
        }

        AddEmailIpPoolLockRequest other = (AddEmailIpPoolLockRequest) o;
