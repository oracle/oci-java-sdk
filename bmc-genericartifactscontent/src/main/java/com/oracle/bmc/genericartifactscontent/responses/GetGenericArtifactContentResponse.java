...
public class GetGenericArtifactContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetGenericArtifactContentResponse(
    ...
    public static class Builder
        ...
        public GetGenericArtifactContentResponse build() {
            return new GetGenericArtifactContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGenericArtifactContentResponse)) {
            return false;
        }

        GetGenericArtifactContentResponse other = (GetGenericArtifactContentResponse) o;
