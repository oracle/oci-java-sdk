...
/**
 * The metadata of the artifact. <br>
...
public final class GenericArtifact
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenericArtifact model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenericArtifact)) {
            return false;
        }

        GenericArtifact other = (GenericArtifact) o;
