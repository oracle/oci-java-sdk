...
public class SummarizeOperationsInsightsWarehouseResourceUsageResponse
    ...
    public com.oracle.bmc.opsi.model.SummarizeOperationsInsightsWarehouseResourceUsageAggregation
            getSummarizeOperationsInsightsWarehouseResourceUsageAggregation() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder summarizeOperationsInsightsWarehouseResourceUsageAggregation(
        ...
        public Builder copy(SummarizeOperationsInsightsWarehouseResourceUsageResponse o) {
            ...
            summarizeOperationsInsightsWarehouseResourceUsageAggregation(
                    o.getSummarizeOperationsInsightsWarehouseResourceUsageAggregation());
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeOperationsInsightsWarehouseResourceUsageResponse)) {
            return false;
        }

        SummarizeOperationsInsightsWarehouseResourceUsageResponse other =
                (SummarizeOperationsInsightsWarehouseResourceUsageResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.summarizeOperationsInsightsWarehouseResourceUsageAggregation,
                        other.summarizeOperationsInsightsWarehouseResourceUsageAggregation);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.summarizeOperationsInsightsWarehouseResourceUsageAggregation == null
                                ? 43
                                : this.summarizeOperationsInsightsWarehouseResourceUsageAggregation
                                        .hashCode());
        return result;
