...
/**
 * Input Host Details used for connection requests for private endpoint accessed db resource. <br>
...
public final class PeComanagedDatabaseHostDetails
    ...
    public static class Builder {
        ...
        /**
         * Listener port number used for connection requests for rivate endpoint accessed db
         * resource.
         */
