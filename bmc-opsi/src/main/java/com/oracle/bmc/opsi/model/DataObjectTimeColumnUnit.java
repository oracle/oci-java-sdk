...
/**
 * Unit details of a data object column of TIME unit category. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataObjectTimeColumnUnit.Builder.class)
...
public final class DataObjectTimeColumnUnit extends DataObjectColumnUnit {
    ...
    public static class Builder {
        ...
        public DataObjectTimeColumnUnit build() {
            DataObjectTimeColumnUnit model =
                    new DataObjectTimeColumnUnit(this.displayName, this.unit);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataObjectTimeColumnUnit model) {
    ...
    @Deprecated
    public DataObjectTimeColumnUnit(String displayName, Unit unit) {
        super(displayName);
        this.unit = unit;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataObjectTimeColumnUnit(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataObjectTimeColumnUnit)) {
            return false;
        }

        DataObjectTimeColumnUnit other = (DataObjectTimeColumnUnit) o;
