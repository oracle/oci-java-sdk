...
public class CreateOperationsInsightsPrivateEndpointResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOperationsInsightsPrivateEndpointResponse)) {
            return false;
        }

        CreateOperationsInsightsPrivateEndpointResponse other =
                (CreateOperationsInsightsPrivateEndpointResponse) o;
