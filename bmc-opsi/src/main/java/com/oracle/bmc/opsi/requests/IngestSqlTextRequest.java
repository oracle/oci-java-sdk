 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use IngestSqlTextRequest.
 */
...
public class IngestSqlTextRequest
    ...
    public static class Builder
         ...
         * Collection of SQL text objects for a particular database.
         *
         * @param ingestSqlTextDetails the value to set
        ...
        public IngestSqlTextRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new IngestSqlTextRequest(ingestSqlTextDetails, compartmentId, databaseId, id,
