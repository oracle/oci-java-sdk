...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMacsManagedCloudExadataInsightDetails.Builder.class)
...
public final class CreateMacsManagedCloudExadataInsightDetails extends CreateExadataInsightDetails {
    ...
    public static class Builder {
        ...
        private java.util.List<CreateMacsManagedCloudExadataVmclusterDetails>
                memberVmClusterDetails;

        public Builder memberVmClusterDetails(
                java.util.List<CreateMacsManagedCloudExadataVmclusterDetails>
                        memberVmClusterDetails) {
        ...
        public CreateMacsManagedCloudExadataInsightDetails build() {
            CreateMacsManagedCloudExadataInsightDetails model =
                    new CreateMacsManagedCloudExadataInsightDetails(
                            this.compartmentId,
                            this.freeformTags,
                            this.definedTags,
                            this.exadataInfraId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMacsManagedCloudExadataInsightDetails model) {
    ...
    @Deprecated
    public CreateMacsManagedCloudExadataInsightDetails(
            String compartmentId,
            java.util.Map<String, String> freeformTags,
            java.util.Map<String, java.util.Map<String, Object>> definedTags,
            String exadataInfraId,
            java.util.List<CreateMacsManagedCloudExadataVmclusterDetails> memberVmClusterDetails) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("memberVmClusterDetails")
    private final java.util.List<CreateMacsManagedCloudExadataVmclusterDetails>
            memberVmClusterDetails;

    public java.util.List<CreateMacsManagedCloudExadataVmclusterDetails>
            getMemberVmClusterDetails() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMacsManagedCloudExadataInsightDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMacsManagedCloudExadataInsightDetails)) {
            return false;
        }

        CreateMacsManagedCloudExadataInsightDetails other =
                (CreateMacsManagedCloudExadataInsightDetails) o;
