...
public class SummarizeHostInsightResourceUsageTrendAggregationCollection {
    ...
    public static class Builder {
        ...
        public SummarizeHostInsightResourceUsageTrendAggregationCollection build() {
            SummarizeHostInsightResourceUsageTrendAggregationCollection __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SummarizeHostInsightResourceUsageTrendAggregationCollection o) {
