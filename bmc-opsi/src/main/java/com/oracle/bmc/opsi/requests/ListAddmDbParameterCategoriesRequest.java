...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbParameterCategoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbParameterCategoriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAddmDbParameterCategoriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAddmDbParameterCategoriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAddmDbParameterCategoriesRequest o) {
        ...
        /**
         * Build the instance of ListAddmDbParameterCategoriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAddmDbParameterCategoriesRequest
         */
        public ListAddmDbParameterCategoriesRequest build() {
            ListAddmDbParameterCategoriesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAddmDbParameterCategoriesRequest
         */
        public ListAddmDbParameterCategoriesRequest buildWithoutInvocationCallback() {
            ListAddmDbParameterCategoriesRequest request =
                    new ListAddmDbParameterCategoriesRequest();
            ...
            return request;
            // new ListAddmDbParameterCategoriesRequest(compartmentId, databaseId, id, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbParameterCategoriesRequest)) {
            return false;
        }

        ListAddmDbParameterCategoriesRequest other = (ListAddmDbParameterCategoriesRequest) o;
