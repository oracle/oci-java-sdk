...
/**
 * Details of a VIEW type data object in a Warehouse. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = WarehouseViewDataObjectDetails.Builder.class)
...
public final class WarehouseViewDataObjectDetails extends WarehouseDataObjectDetails {
    ...
    public static class Builder {
        ...
        public WarehouseViewDataObjectDetails build() {
            WarehouseViewDataObjectDetails model =
                    new WarehouseViewDataObjectDetails(this.columnsMetadata);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WarehouseViewDataObjectDetails model) {
    ...
    @Deprecated
    public WarehouseViewDataObjectDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WarehouseViewDataObjectDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WarehouseViewDataObjectDetails)) {
            return false;
        }

        WarehouseViewDataObjectDetails other = (WarehouseViewDataObjectDetails) o;
