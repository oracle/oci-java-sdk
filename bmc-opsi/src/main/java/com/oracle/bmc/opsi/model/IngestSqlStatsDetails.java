...
public final class IngestSqlStatsDetails
    ...
    public static class Builder {
        ...
        public IngestSqlStatsDetails build() {
            IngestSqlStatsDetails model = new IngestSqlStatsDetails(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IngestSqlStatsDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IngestSqlStatsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngestSqlStatsDetails)) {
            return false;
        }

        IngestSqlStatsDetails other = (IngestSqlStatsDetails) o;
