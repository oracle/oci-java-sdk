...
public class DeleteOperationsInsightsWarehouseResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOperationsInsightsWarehouseResponse)) {
            return false;
        }

        DeleteOperationsInsightsWarehouseResponse other =
                (DeleteOperationsInsightsWarehouseResponse) o;
