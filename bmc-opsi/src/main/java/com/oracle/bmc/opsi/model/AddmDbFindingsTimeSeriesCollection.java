...
/**
 * ADDM findings time series response. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbFindingsTimeSeriesCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddmDbFindingsTimeSeriesCollection
    ...
    public AddmDbFindingsTimeSeriesCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbFindingsTimeSeriesSummary> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbFindingsTimeSeriesSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbFindingsTimeSeriesSummary> items) {
            this.items = items;
        ...
        public AddmDbFindingsTimeSeriesCollection build() {
            AddmDbFindingsTimeSeriesCollection model =
                    new AddmDbFindingsTimeSeriesCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbFindingsTimeSeriesCollection model) {
    ...
    /** List of ADDM finding time series data */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbFindingsTimeSeriesSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbFindingsTimeSeriesSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddmDbFindingsTimeSeriesCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbFindingsTimeSeriesCollection)) {
            return false;
        }

        AddmDbFindingsTimeSeriesCollection other = (AddmDbFindingsTimeSeriesCollection) o;
