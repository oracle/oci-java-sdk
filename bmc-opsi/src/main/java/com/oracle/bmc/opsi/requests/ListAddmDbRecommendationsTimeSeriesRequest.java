...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbRecommendationsTimeSeriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbRecommendationsTimeSeriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAddmDbRecommendationsTimeSeriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAddmDbRecommendationsTimeSeriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAddmDbRecommendationsTimeSeriesRequest o) {
        ...
        /**
         * Build the instance of ListAddmDbRecommendationsTimeSeriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAddmDbRecommendationsTimeSeriesRequest
         */
        public ListAddmDbRecommendationsTimeSeriesRequest build() {
            ListAddmDbRecommendationsTimeSeriesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAddmDbRecommendationsTimeSeriesRequest
         */
        public ListAddmDbRecommendationsTimeSeriesRequest buildWithoutInvocationCallback() {
            ListAddmDbRecommendationsTimeSeriesRequest request =
                    new ListAddmDbRecommendationsTimeSeriesRequest();
            ...
            return request;
            // new ListAddmDbRecommendationsTimeSeriesRequest(compartmentId, databaseId, id, instanceNumber, timeIntervalStart, timeIntervalEnd, categoryName, sqlIdentifier, ownerOrNameContains, nameContains, name, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbRecommendationsTimeSeriesRequest)) {
            return false;
        }

        ListAddmDbRecommendationsTimeSeriesRequest other =
                (ListAddmDbRecommendationsTimeSeriesRequest) o;
