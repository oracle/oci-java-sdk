...
public class ListAddmDbRecommendationsTimeSeriesRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListAddmDbRecommendationsTimeSeriesRequest as configured by this
         * builder
         *
        ...
        public ListAddmDbRecommendationsTimeSeriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAddmDbRecommendationsTimeSeriesRequest(compartmentId, databaseId, id,
            // instanceNumber, timeIntervalStart, timeIntervalEnd, categoryName, sqlIdentifier,
            // ownerOrNameContains, nameContains, name, limit, page, sortOrder, sortBy,
