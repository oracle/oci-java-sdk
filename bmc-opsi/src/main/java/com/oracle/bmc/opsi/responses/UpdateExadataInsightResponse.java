...
public class UpdateExadataInsightResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateExadataInsightResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExadataInsightResponse)) {
            return false;
        }

        UpdateExadataInsightResponse other = (UpdateExadataInsightResponse) o;
