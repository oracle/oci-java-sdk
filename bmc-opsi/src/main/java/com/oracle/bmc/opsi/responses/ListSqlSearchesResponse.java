...
public class ListSqlSearchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSqlSearchesResponse> {
        ...
        public ListSqlSearchesResponse build() {
            return new ListSqlSearchesResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, sqlSearchCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",sqlSearchCollection=").append(String.valueOf(sqlSearchCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSqlSearchesResponse)) {
            return false;
        }

        ListSqlSearchesResponse other = (ListSqlSearchesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.sqlSearchCollection, other.sqlSearchCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.sqlSearchCollection == null
                                ? 43
                                : this.sqlSearchCollection.hashCode());
        return result;
    }
}
