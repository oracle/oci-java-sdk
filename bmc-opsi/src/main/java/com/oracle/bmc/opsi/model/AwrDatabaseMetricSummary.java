...
public final class AwrDatabaseMetricSummary {
    ...
    public static class Builder {
        ...
        public AwrDatabaseMetricSummary build() {
            AwrDatabaseMetricSummary __instance__ =
                    new AwrDatabaseMetricSummary(name, timestamp, avgValue, minValue, maxValue);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDatabaseMetricSummary o) {
