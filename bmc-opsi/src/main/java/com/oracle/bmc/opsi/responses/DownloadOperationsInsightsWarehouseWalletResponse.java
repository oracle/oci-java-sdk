...
public class DownloadOperationsInsightsWarehouseWalletResponse
    ...
    private DownloadOperationsInsightsWarehouseWalletResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DownloadOperationsInsightsWarehouseWalletResponse o) {
         ...
         */
        @Override
        public DownloadOperationsInsightsWarehouseWalletResponse build() {
            return new DownloadOperationsInsightsWarehouseWalletResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadOperationsInsightsWarehouseWalletResponse)) {
            return false;
        }

        DownloadOperationsInsightsWarehouseWalletResponse other =
                (DownloadOperationsInsightsWarehouseWalletResponse) o;
