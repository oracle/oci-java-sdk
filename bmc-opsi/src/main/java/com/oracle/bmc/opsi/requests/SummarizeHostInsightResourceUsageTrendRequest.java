...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeHostInsightResourceUsageTrendExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeHostInsightResourceUsageTrendRequest.
 */
...
public class SummarizeHostInsightResourceUsageTrendRequest
    ...
    public static class Builder
        ...
        public SummarizeHostInsightResourceUsageTrendRequest buildWithoutInvocationCallback() {
            SummarizeHostInsightResourceUsageTrendRequest request =
                    new SummarizeHostInsightResourceUsageTrendRequest();
            ...
            return request;
            // new SummarizeHostInsightResourceUsageTrendRequest(compartmentId, resourceMetric, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, platformType, id, exadataInsightId, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree, hostType, hostId, vmclusterName, status);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        SummarizeHostInsightResourceUsageTrendRequest other =
                (SummarizeHostInsightResourceUsageTrendRequest) o;
