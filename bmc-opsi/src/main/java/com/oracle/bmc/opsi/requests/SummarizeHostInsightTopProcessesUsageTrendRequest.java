...
public class SummarizeHostInsightTopProcessesUsageTrendRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeHostInsightTopProcessesUsageTrendRequest as configured by
         * this builder
         *
        ...
        public SummarizeHostInsightTopProcessesUsageTrendRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeHostInsightTopProcessesUsageTrendRequest(compartmentId, id,
            // resourceMetric, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, page,
            // limit, opcRequestId, hostType, hostId, processHash, statistic, status);
        }
    }
