...
public class ListAddmDbFindingsTimeSeriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.opsi.model.AddmDbFindingsTimeSeriesCollection
            getAddmDbFindingsTimeSeriesCollection() {
        return addmDbFindingsTimeSeriesCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder addmDbFindingsTimeSeriesCollection(
                com.oracle.bmc.opsi.model.AddmDbFindingsTimeSeriesCollection
                        addmDbFindingsTimeSeriesCollection) {
            this.addmDbFindingsTimeSeriesCollection = addmDbFindingsTimeSeriesCollection;
            return this;
        ...
        public Builder copy(ListAddmDbFindingsTimeSeriesResponse o) {
            ...
            addmDbFindingsTimeSeriesCollection(o.getAddmDbFindingsTimeSeriesCollection());
    ...
    public String toString() {
        ...
        sb.append(",addmDbFindingsTimeSeriesCollection=")
                .append(String.valueOf(addmDbFindingsTimeSeriesCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbFindingsTimeSeriesResponse)) {
            return false;
        }

        ListAddmDbFindingsTimeSeriesResponse other = (ListAddmDbFindingsTimeSeriesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.addmDbFindingsTimeSeriesCollection,
                        other.addmDbFindingsTimeSeriesCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.addmDbFindingsTimeSeriesCollection == null
                                ? 43
                                : this.addmDbFindingsTimeSeriesCollection.hashCode());
        return result;
    }
}
