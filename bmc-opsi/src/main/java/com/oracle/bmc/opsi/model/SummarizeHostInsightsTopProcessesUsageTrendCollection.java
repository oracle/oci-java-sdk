...
public final class SummarizeHostInsightsTopProcessesUsageTrendCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"timeIntervalStart", "timeIntervalEnd", "items"})
    public SummarizeHostInsightsTopProcessesUsageTrendCollection(
    ...
    public static class Builder {
        ...
        public SummarizeHostInsightsTopProcessesUsageTrendCollection build() {
            SummarizeHostInsightsTopProcessesUsageTrendCollection model =
                    new SummarizeHostInsightsTopProcessesUsageTrendCollection(
                            this.timeIntervalStart, this.timeIntervalEnd, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SummarizeHostInsightsTopProcessesUsageTrendCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightsTopProcessesUsageTrendCollection)) {
            return false;
        }

        SummarizeHostInsightsTopProcessesUsageTrendCollection other =
                (SummarizeHostInsightsTopProcessesUsageTrendCollection) o;
