...
public class ListSqlTextsConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListSqlTextsConverter.class);

    public static com.oracle.bmc.opsi.requests.ListSqlTextsRequest interceptRequest(
            com.oracle.bmc.opsi.requests.ListSqlTextsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20200630").path("databaseInsights").path("sqlTexts");
    ...
    public static java.util.function.Function<
                    javax.ws.rs.core.Response, com.oracle.bmc.opsi.responses.ListSqlTextsResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.opsi.responses.ListSqlTextsResponse>() {
                            @Override
                            public com.oracle.bmc.opsi.responses.ListSqlTextsResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.opsi.responses.ListSqlTextsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.opsi.responses.ListSqlTextsResponse responseWrapper =
                                        builder.build();
