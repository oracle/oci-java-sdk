...
public class SummarizeAwrDatabaseMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.opsi.model.AwrDatabaseMetricCollection getAwrDatabaseMetricCollection() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder awrDatabaseMetricCollection(
                com.oracle.bmc.opsi.model.AwrDatabaseMetricCollection awrDatabaseMetricCollection) {
            this.awrDatabaseMetricCollection = awrDatabaseMetricCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",awrDatabaseMetricCollection=")
                .append(String.valueOf(awrDatabaseMetricCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseMetricsResponse)) {
            return false;
        }

        SummarizeAwrDatabaseMetricsResponse other = (SummarizeAwrDatabaseMetricsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.awrDatabaseMetricCollection, other.awrDatabaseMetricCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.awrDatabaseMetricCollection == null
                                ? 43
                                : this.awrDatabaseMetricCollection.hashCode());
        return result;
    }
}
