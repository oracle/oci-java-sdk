...
public class SummarizeHostInsightResourceStatisticsResponse
    ...
    /**
     * The returned {@code SummarizeHostInsightResourceStatisticsAggregationCollection} instance.
     */
    ...
    public com.oracle.bmc.opsi.model.SummarizeHostInsightResourceStatisticsAggregationCollection
            getSummarizeHostInsightResourceStatisticsAggregationCollection() {
    ...
    public static class Builder
        ...
        /**
         * The returned {@code SummarizeHostInsightResourceStatisticsAggregationCollection}
         * instance.
         */
         ...
         * @return this builder
         */
        public Builder summarizeHostInsightResourceStatisticsAggregationCollection(
        ...
        public Builder copy(SummarizeHostInsightResourceStatisticsResponse o) {
            ...
            summarizeHostInsightResourceStatisticsAggregationCollection(
                    o.getSummarizeHostInsightResourceStatisticsAggregationCollection());
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightResourceStatisticsResponse)) {
            return false;
        }

        SummarizeHostInsightResourceStatisticsResponse other =
                (SummarizeHostInsightResourceStatisticsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.summarizeHostInsightResourceStatisticsAggregationCollection,
                        other.summarizeHostInsightResourceStatisticsAggregationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.summarizeHostInsightResourceStatisticsAggregationCollection == null
                                ? 43
                                : this.summarizeHostInsightResourceStatisticsAggregationCollection
                                        .hashCode());
        return result;
