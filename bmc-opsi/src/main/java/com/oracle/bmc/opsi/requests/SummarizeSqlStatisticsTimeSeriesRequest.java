...
public class SummarizeSqlStatisticsTimeSeriesRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeSqlStatisticsTimeSeriesRequest as configured by this
         * builder
         *
        ...
        public SummarizeSqlStatisticsTimeSeriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeSqlStatisticsTimeSeriesRequest(compartmentId, sqlIdentifier, databaseId,
            // id, exadataInsightId, cdbName, hostName, analysisTimeInterval, timeIntervalStart,
            // timeIntervalEnd, page, opcRequestId, definedTagEquals, freeformTagEquals,
