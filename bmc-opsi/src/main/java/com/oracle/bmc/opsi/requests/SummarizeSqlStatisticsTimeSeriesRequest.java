...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeSqlStatisticsTimeSeriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeSqlStatisticsTimeSeriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeSqlStatisticsTimeSeriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeSqlStatisticsTimeSeriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeSqlStatisticsTimeSeriesRequest o) {
        ...
        /**
         * Build the instance of SummarizeSqlStatisticsTimeSeriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeSqlStatisticsTimeSeriesRequest
         */
        public SummarizeSqlStatisticsTimeSeriesRequest build() {
            SummarizeSqlStatisticsTimeSeriesRequest request = buildWithoutInvocationCallback();
        ...
        public SummarizeSqlStatisticsTimeSeriesRequest buildWithoutInvocationCallback() {
            SummarizeSqlStatisticsTimeSeriesRequest request =
                    new SummarizeSqlStatisticsTimeSeriesRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeSqlStatisticsTimeSeriesRequest)) {
            return false;
        }

        SummarizeSqlStatisticsTimeSeriesRequest other = (SummarizeSqlStatisticsTimeSeriesRequest) o;
