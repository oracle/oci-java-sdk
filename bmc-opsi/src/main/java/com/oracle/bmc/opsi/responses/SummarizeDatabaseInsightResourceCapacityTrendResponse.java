...
public class SummarizeDatabaseInsightResourceCapacityTrendResponse
    ...
    public static class Builder {
        ...
        /**
         * The returned SummarizeDatabaseInsightResourceCapacityTrendAggregationCollection instance.
         * @param summarizeDatabaseInsightResourceCapacityTrendAggregationCollection the value to set
         * @return this builder
         */
         ...
         */
        public Builder copy(SummarizeDatabaseInsightResourceCapacityTrendResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            summarizeDatabaseInsightResourceCapacityTrendAggregationCollection(
                    o.getSummarizeDatabaseInsightResourceCapacityTrendAggregationCollection());
        ...
        public SummarizeDatabaseInsightResourceCapacityTrendResponse build() {
            return new SummarizeDatabaseInsightResourceCapacityTrendResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
