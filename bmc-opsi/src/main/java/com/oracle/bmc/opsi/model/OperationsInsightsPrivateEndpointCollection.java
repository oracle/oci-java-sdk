...
/**
 * A collection of Operation Insights private endpoint objects. <br>
...
public final class OperationsInsightsPrivateEndpointCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public OperationsInsightsPrivateEndpointCollection(
    ...
    public static class Builder {
        ...
        public OperationsInsightsPrivateEndpointCollection build() {
            OperationsInsightsPrivateEndpointCollection model =
                    new OperationsInsightsPrivateEndpointCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OperationsInsightsPrivateEndpointCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperationsInsightsPrivateEndpointCollection)) {
            return false;
        }

        OperationsInsightsPrivateEndpointCollection other =
                (OperationsInsightsPrivateEndpointCollection) o;
