...
public class OperationsInsightsAsyncClient implements OperationsInsightsAsync {
    ...
    public java.util.concurrent.Future<ChangeExternalMysqlDatabaseInsightConnectionResponse>
            changeExternalMysqlDatabaseInsightConnection(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async changeExternalMysqlDatabaseInsightConnection");
    ...
    public java.util.concurrent.Future<ChangeMacsManagedCloudDatabaseInsightConnectionResponse>
            changeMacsManagedCloudDatabaseInsightConnection(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async changeMacsManagedCloudDatabaseInsightConnection");
    ...
    public java.util.concurrent.Future<IngestMySqlSqlStatsResponse> ingestMySqlSqlStats(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async ingestMySqlSqlStats");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, IngestMySqlSqlStatsResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                IngestMySqlSqlStatsRequest, IngestMySqlSqlStatsResponse>,
                        java.util.concurrent.Future<IngestMySqlSqlStatsResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getIngestMySqlSqlStatsDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<IngestMySqlSqlTextResponse> ingestMySqlSqlText(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async ingestMySqlSqlText");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, IngestMySqlSqlTextResponse>
                transformer =
                        IngestMySqlSqlTextConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<IngestMySqlSqlTextRequest, IngestMySqlSqlTextResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                IngestMySqlSqlTextRequest, IngestMySqlSqlTextResponse>,
                        java.util.concurrent.Future<IngestMySqlSqlTextResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getIngestMySqlSqlTextDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<SummarizeHostInsightIoUsageTrendResponse>
            summarizeHostInsightIoUsageTrend(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async summarizeHostInsightIoUsageTrend");
    ...
    public java.util.concurrent.Future<TestMacsManagedCloudDatabaseInsightConnectionResponse>
            testMacsManagedCloudDatabaseInsightConnection(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async testMacsManagedCloudDatabaseInsightConnection");
