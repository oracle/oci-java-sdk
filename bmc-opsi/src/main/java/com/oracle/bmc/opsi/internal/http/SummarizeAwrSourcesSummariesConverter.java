...
public class SummarizeAwrSourcesSummariesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SummarizeAwrSourcesSummariesConverter.class);

    public static com.oracle.bmc.opsi.requests.SummarizeAwrSourcesSummariesRequest interceptRequest(
            com.oracle.bmc.opsi.requests.SummarizeAwrSourcesSummariesRequest request) {
