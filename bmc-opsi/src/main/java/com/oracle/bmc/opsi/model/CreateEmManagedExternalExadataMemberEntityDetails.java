...
/**
 * Compartment [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
 * Enterprise Manager member entity (e.g. databases and hosts) associated with an Exadata system.
 * <br>
...
public final class CreateEmManagedExternalExadataMemberEntityDetails
    ...
    public static class Builder {
        ...
        public CreateEmManagedExternalExadataMemberEntityDetails build() {
            CreateEmManagedExternalExadataMemberEntityDetails model =
                    new CreateEmManagedExternalExadataMemberEntityDetails(
                            this.enterpriseManagerEntityIdentifier, this.compartmentId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEmManagedExternalExadataMemberEntityDetails model) {
