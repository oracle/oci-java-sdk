...
public final class CreateEmManagedExternalExadataMemberEntityDetails {
    ...
    public static class Builder {
        ...
        public CreateEmManagedExternalExadataMemberEntityDetails build() {
            CreateEmManagedExternalExadataMemberEntityDetails __instance__ =
                    new CreateEmManagedExternalExadataMemberEntityDetails(
                            enterpriseManagerEntityIdentifier, compartmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEmManagedExternalExadataMemberEntityDetails o) {
            Builder copiedBuilder =
                    enterpriseManagerEntityIdentifier(o.getEnterpriseManagerEntityIdentifier())
