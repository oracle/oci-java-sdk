...
public class QueryWarehouseDataObjectDataResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private QueryWarehouseDataObjectDataResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(QueryWarehouseDataObjectDataResponse o) {
         ...
         */
        @Override
        public QueryWarehouseDataObjectDataResponse build() {
            return new QueryWarehouseDataObjectDataResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueryWarehouseDataObjectDataResponse)) {
            return false;
        }

        QueryWarehouseDataObjectDataResponse other = (QueryWarehouseDataObjectDataResponse) o;
