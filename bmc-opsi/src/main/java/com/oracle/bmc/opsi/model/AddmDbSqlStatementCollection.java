...
/**
 * Summarizes SQL statements over specified time period <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbSqlStatementCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddmDbSqlStatementCollection
    ...
    public AddmDbSqlStatementCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbSqlStatementSummary> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbSqlStatementSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbSqlStatementSummary> items) {
            this.items = items;
        ...
        public AddmDbSqlStatementCollection build() {
            AddmDbSqlStatementCollection model =
                    new AddmDbSqlStatementCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbSqlStatementCollection model) {
    ...
    /** List of SQL statements */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbSqlStatementSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbSqlStatementSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddmDbSqlStatementCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbSqlStatementCollection)) {
            return false;
        }

        AddmDbSqlStatementCollection other = (AddmDbSqlStatementCollection) o;
