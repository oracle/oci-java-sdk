...
public class SummarizeSqlStatisticsRequest
    ...
    public static class Builder
        ...
        public SummarizeSqlStatisticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeSqlStatisticsRequest(compartmentId, databaseType, databaseId, id,
            // exadataInsightId, cdbName, hostName, databaseTimePctGreaterThan, sqlIdentifier,
            // analysisTimeInterval, timeIntervalStart, timeIntervalEnd, limit, page, opcRequestId,
            // sortOrder, sortBy, category, definedTagEquals, freeformTagEquals, definedTagExists,
