...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbFindingsTimeSeriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbFindingsTimeSeriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAddmDbFindingsTimeSeriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAddmDbFindingsTimeSeriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAddmDbFindingsTimeSeriesRequest o) {
        ...
        /**
         * Build the instance of ListAddmDbFindingsTimeSeriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAddmDbFindingsTimeSeriesRequest
         */
        public ListAddmDbFindingsTimeSeriesRequest build() {
            ListAddmDbFindingsTimeSeriesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAddmDbFindingsTimeSeriesRequest
         */
        public ListAddmDbFindingsTimeSeriesRequest buildWithoutInvocationCallback() {
            ListAddmDbFindingsTimeSeriesRequest request = new ListAddmDbFindingsTimeSeriesRequest();
            ...
            return request;
            // new ListAddmDbFindingsTimeSeriesRequest(compartmentId, databaseId, id, instanceNumber, timeIntervalStart, timeIntervalEnd, categoryName, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbFindingsTimeSeriesRequest)) {
            return false;
        }

        ListAddmDbFindingsTimeSeriesRequest other = (ListAddmDbFindingsTimeSeriesRequest) o;
