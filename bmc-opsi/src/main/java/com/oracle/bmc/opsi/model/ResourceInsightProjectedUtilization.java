...
/**
 * Projected utilization(High/low) for cpu or storage <br>
...
public final class ResourceInsightProjectedUtilization
    ...
    public static class Builder {
        ...
        public ResourceInsightProjectedUtilization build() {
            ResourceInsightProjectedUtilization model =
                    new ResourceInsightProjectedUtilization(this.low, this.high);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResourceInsightProjectedUtilization model) {
