...
public class SummarizeAwrDatabaseCpuUsagesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.opsi.model.AwrDatabaseCpuUsageCollection
            getAwrDatabaseCpuUsageCollection() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder awrDatabaseCpuUsageCollection(
    ...
    public String toString() {
        ...
        sb.append(",awrDatabaseCpuUsageCollection=")
                .append(String.valueOf(awrDatabaseCpuUsageCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseCpuUsagesResponse)) {
            return false;
        }

        SummarizeAwrDatabaseCpuUsagesResponse other = (SummarizeAwrDatabaseCpuUsagesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.awrDatabaseCpuUsageCollection, other.awrDatabaseCpuUsageCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.awrDatabaseCpuUsageCollection == null
                                ? 43
                                : this.awrDatabaseCpuUsageCollection.hashCode());
        return result;
    }
}
