...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ChangeExternalMysqlDatabaseInsightConnectionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ChangeExternalMysqlDatabaseInsightConnectionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"databaseConnectorId"})
    public ChangeExternalMysqlDatabaseInsightConnectionDetails(String databaseConnectorId) {
        super();
    ...
    public static class Builder {
        ...
        public ChangeExternalMysqlDatabaseInsightConnectionDetails build() {
            ChangeExternalMysqlDatabaseInsightConnectionDetails model =
                    new ChangeExternalMysqlDatabaseInsightConnectionDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeExternalMysqlDatabaseInsightConnectionDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ChangeExternalMysqlDatabaseInsightConnectionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExternalMysqlDatabaseInsightConnectionDetails)) {
            return false;
        }

        ChangeExternalMysqlDatabaseInsightConnectionDetails other =
                (ChangeExternalMysqlDatabaseInsightConnectionDetails) o;
