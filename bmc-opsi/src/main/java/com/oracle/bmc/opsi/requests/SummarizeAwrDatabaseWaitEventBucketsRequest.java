...
public class SummarizeAwrDatabaseWaitEventBucketsRequest
    ...
    public static class Builder
         ...
         */
        public SummarizeAwrDatabaseWaitEventBucketsRequest build() {
            SummarizeAwrDatabaseWaitEventBucketsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeAwrDatabaseWaitEventBucketsRequest
         */
        public SummarizeAwrDatabaseWaitEventBucketsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDatabaseWaitEventBucketsRequest request =
                    new SummarizeAwrDatabaseWaitEventBucketsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseWaitEventBucketsRequest)) {
            return false;
        }

        SummarizeAwrDatabaseWaitEventBucketsRequest other =
                (SummarizeAwrDatabaseWaitEventBucketsRequest) o;
