...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SummarizeHostInsightIoUsageTrendAggregationCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SummarizeHostInsightIoUsageTrendAggregationCollection
    ...
    public SummarizeHostInsightIoUsageTrendAggregationCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            Long itemDurationInMs,
            java.util.List<IoUsageTrendAggregation> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<IoUsageTrendAggregation> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<IoUsageTrendAggregation> items) {
            this.items = items;
        ...
        public SummarizeHostInsightIoUsageTrendAggregationCollection build() {
            SummarizeHostInsightIoUsageTrendAggregationCollection model =
                    new SummarizeHostInsightIoUsageTrendAggregationCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SummarizeHostInsightIoUsageTrendAggregationCollection model) {
    ...
    /** Collection of Usage Data with time stamps for all IO interfaces. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<IoUsageTrendAggregation> items;
     ...
     * @return the value
     */
    public java.util.List<IoUsageTrendAggregation> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SummarizeHostInsightIoUsageTrendAggregationCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightIoUsageTrendAggregationCollection)) {
            return false;
        }

        SummarizeHostInsightIoUsageTrendAggregationCollection other =
                (SummarizeHostInsightIoUsageTrendAggregationCollection) o;
