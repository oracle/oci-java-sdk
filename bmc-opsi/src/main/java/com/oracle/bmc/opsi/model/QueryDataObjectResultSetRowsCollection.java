...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "format",
    defaultImpl = QueryDataObjectResultSetRowsCollection.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = QueryDataObjectJsonResultSetRowsCollection.class,
        name = "JSON"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class QueryDataObjectResultSetRowsCollection
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected QueryDataObjectResultSetRowsCollection() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueryDataObjectResultSetRowsCollection)) {
            return false;
        }

        QueryDataObjectResultSetRowsCollection other = (QueryDataObjectResultSetRowsCollection) o;
