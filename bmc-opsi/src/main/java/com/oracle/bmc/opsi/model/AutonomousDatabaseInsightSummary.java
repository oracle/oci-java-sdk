...
public class AutonomousDatabaseInsightSummary extends DatabaseInsightSummary {
    ...
    public static class Builder {
        ...
        public AutonomousDatabaseInsightSummary build() {
            AutonomousDatabaseInsightSummary __instance__ =
                    new AutonomousDatabaseInsightSummary(
                            id,
                            databaseId,
                            compartmentId,
                            databaseName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousDatabaseInsightSummary o) {
    ...
    @Deprecated
    public AutonomousDatabaseInsightSummary(
            String id,
            String databaseId,
