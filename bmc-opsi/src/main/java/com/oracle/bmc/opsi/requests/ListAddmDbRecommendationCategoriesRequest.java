...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbRecommendationCategoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbRecommendationCategoriesRequest.
 */
...
public class ListAddmDbRecommendationCategoriesRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListAddmDbRecommendationCategoriesRequest as configured by this builder
         *
        ...
        public ListAddmDbRecommendationCategoriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAddmDbRecommendationCategoriesRequest(compartmentId, databaseId, id, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
