...
public class SummarizeSqlStatisticsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.opsi.model.SqlStatisticAggregationCollection
            getSqlStatisticAggregationCollection() {
        return sqlStatisticAggregationCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder sqlStatisticAggregationCollection(
                com.oracle.bmc.opsi.model.SqlStatisticAggregationCollection
                        sqlStatisticAggregationCollection) {
            this.sqlStatisticAggregationCollection = sqlStatisticAggregationCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(SummarizeSqlStatisticsResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",sqlStatisticAggregationCollection=")
                .append(String.valueOf(sqlStatisticAggregationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeSqlStatisticsResponse)) {
            return false;
        }

        SummarizeSqlStatisticsResponse other = (SummarizeSqlStatisticsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.sqlStatisticAggregationCollection,
                        other.sqlStatisticAggregationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.sqlStatisticAggregationCollection == null
                                ? 43
                                : this.sqlStatisticAggregationCollection.hashCode());
        return result;
    }
}
