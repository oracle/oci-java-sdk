...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/DeleteOperationsInsightsPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOperationsInsightsPrivateEndpointRequest.
 */
...
public class DeleteOperationsInsightsPrivateEndpointRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteOperationsInsightsPrivateEndpointRequest
         */
        public DeleteOperationsInsightsPrivateEndpointRequest buildWithoutInvocationCallback() {
            DeleteOperationsInsightsPrivateEndpointRequest request =
                    new DeleteOperationsInsightsPrivateEndpointRequest();
            request.operationsInsightsPrivateEndpointId = operationsInsightsPrivateEndpointId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOperationsInsightsPrivateEndpointRequest(operationsInsightsPrivateEndpointId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOperationsInsightsPrivateEndpointRequest)) {
            return false;
        }

        DeleteOperationsInsightsPrivateEndpointRequest other =
                (DeleteOperationsInsightsPrivateEndpointRequest) o;
