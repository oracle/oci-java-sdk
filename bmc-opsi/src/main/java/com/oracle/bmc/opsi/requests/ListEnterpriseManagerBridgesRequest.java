...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListEnterpriseManagerBridgesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEnterpriseManagerBridgesRequest.
 */
...
public class ListEnterpriseManagerBridgesRequest
    ...
    public static class Builder
        ...
        public ListEnterpriseManagerBridgesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListEnterpriseManagerBridgesRequest(compartmentId, displayName, id, lifecycleState, limit, page, sortOrder, sortBy, compartmentIdInSubtree, opcRequestId);
        }
    }
