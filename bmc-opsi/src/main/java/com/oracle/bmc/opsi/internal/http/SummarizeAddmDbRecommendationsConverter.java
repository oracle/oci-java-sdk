...
public class SummarizeAddmDbRecommendationsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SummarizeAddmDbRecommendationsConverter.class);

    public static com.oracle.bmc.opsi.requests.SummarizeAddmDbRecommendationsRequest
            interceptRequest(
                    com.oracle.bmc.opsi.requests.SummarizeAddmDbRecommendationsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getFindingIdentifier() != null) {
            target =
                    target.queryParam(
                            "findingIdentifier",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getFindingIdentifier()));
        }

        if (request.getSqlIdentifier() != null) {
            target =
                    target.queryParam(
                            "sqlIdentifier",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
        ...
        if (request.getOwnerOrNameContains() != null) {
            target =
                    target.queryParam(
                            "ownerOrNameContains",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getOwnerOrNameContains()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.opsi.responses.SummarizeAddmDbRecommendationsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.opsi.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.opsi.responses.SummarizeAddmDbRecommendationsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.addmDbRecommendationAggregationCollection(
                                        response.getItem());
