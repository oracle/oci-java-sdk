...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAwrDatabaseSysstatsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDatabaseSysstatsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeAwrDatabaseSysstatsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAwrDatabaseSysstatsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAwrDatabaseSysstatsRequest o) {
        ...
        /**
         * Build the instance of SummarizeAwrDatabaseSysstatsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAwrDatabaseSysstatsRequest
         */
        public SummarizeAwrDatabaseSysstatsRequest build() {
            SummarizeAwrDatabaseSysstatsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeAwrDatabaseSysstatsRequest
         */
        public SummarizeAwrDatabaseSysstatsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDatabaseSysstatsRequest request = new SummarizeAwrDatabaseSysstatsRequest();
            ...
            return request;
            // new SummarizeAwrDatabaseSysstatsRequest(awrHubId, awrSourceDatabaseIdentifier, name, instanceNumber, beginSnapshotIdentifierGreaterThanOrEqualTo, endSnapshotIdentifierLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseSysstatsRequest)) {
            return false;
        }

        SummarizeAwrDatabaseSysstatsRequest other = (SummarizeAwrDatabaseSysstatsRequest) o;
