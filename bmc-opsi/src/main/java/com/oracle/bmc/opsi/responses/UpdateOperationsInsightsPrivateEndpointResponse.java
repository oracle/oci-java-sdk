...
public class UpdateOperationsInsightsPrivateEndpointResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOperationsInsightsPrivateEndpointResponse)) {
            return false;
        }

        UpdateOperationsInsightsPrivateEndpointResponse other =
                (UpdateOperationsInsightsPrivateEndpointResponse) o;
