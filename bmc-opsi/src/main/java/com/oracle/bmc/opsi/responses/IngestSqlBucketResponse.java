...
public class IngestSqlBucketResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.opsi.model.IngestSqlBucketResponseDetails
            getIngestSqlBucketResponseDetails() {
        return ingestSqlBucketResponseDetails;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder ingestSqlBucketResponseDetails(
                com.oracle.bmc.opsi.model.IngestSqlBucketResponseDetails
                        ingestSqlBucketResponseDetails) {
            this.ingestSqlBucketResponseDetails = ingestSqlBucketResponseDetails;
            return this;
        ...
        public Builder copy(IngestSqlBucketResponse o) {
            ...
            etag(o.getEtag());
            ingestSqlBucketResponseDetails(o.getIngestSqlBucketResponseDetails());
        ...
        public IngestSqlBucketResponse build() {
            return new IngestSqlBucketResponse(
                    __httpStatusCode__, opcRequestId, etag, ingestSqlBucketResponseDetails);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",ingestSqlBucketResponseDetails=")
                .append(String.valueOf(ingestSqlBucketResponseDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngestSqlBucketResponse)) {
            return false;
        }

        IngestSqlBucketResponse other = (IngestSqlBucketResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.ingestSqlBucketResponseDetails, other.ingestSqlBucketResponseDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ingestSqlBucketResponseDetails == null
                                ? 43
                                : this.ingestSqlBucketResponseDetails.hashCode());
        return result;
    }
}
