...
public final class DownloadOperationsInsightsWarehouseWalletDetails {
    ...
    public static class Builder {
        ...
        public DownloadOperationsInsightsWarehouseWalletDetails build() {
            DownloadOperationsInsightsWarehouseWalletDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DownloadOperationsInsightsWarehouseWalletDetails o) {
            Builder copiedBuilder =
                    operationsInsightsWarehouseWalletPassword(
                            o.getOperationsInsightsWarehouseWalletPassword());
