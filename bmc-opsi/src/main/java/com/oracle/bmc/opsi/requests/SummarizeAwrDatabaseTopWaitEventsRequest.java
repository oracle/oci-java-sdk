...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAwrDatabaseTopWaitEventsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDatabaseTopWaitEventsRequest.
 */
...
public class SummarizeAwrDatabaseTopWaitEventsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeAwrDatabaseTopWaitEventsRequest as configured by this builder
         *
        ...
        public SummarizeAwrDatabaseTopWaitEventsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDatabaseTopWaitEventsRequest(awrHubId, awrSourceDatabaseIdentifier, instanceNumber, beginSnapshotIdentifierGreaterThanOrEqualTo, endSnapshotIdentifierLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, sessionType, topN, sortBy, sortOrder, opcRequestId);
        }
    }
