...
public class GetNewsReportResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetNewsReportResponse> {
         ...
         */
        @Override
        public Builder copy(GetNewsReportResponse o) {
         ...
         */
        @Override
        public GetNewsReportResponse build() {
            return new GetNewsReportResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, newsReport);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetNewsReportResponse)) {
            return false;
        }

        GetNewsReportResponse other = (GetNewsReportResponse) o;
