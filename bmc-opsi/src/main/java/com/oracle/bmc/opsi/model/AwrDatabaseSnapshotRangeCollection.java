...
public final class AwrDatabaseSnapshotRangeCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDatabaseSnapshotRangeCollection build() {
            AwrDatabaseSnapshotRangeCollection __instance__ =
                    new AwrDatabaseSnapshotRangeCollection(name, version, dbQueryTimeInSecs, items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDatabaseSnapshotRangeCollection o) {
    ...
    @Deprecated
    public AwrDatabaseSnapshotRangeCollection(
            String name,
            String version,
            Double dbQueryTimeInSecs,
            java.util.List<AwrDatabaseSnapshotRangeSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDatabaseSnapshotRangeCollection)) {
            return false;
        }

        AwrDatabaseSnapshotRangeCollection other = (AwrDatabaseSnapshotRangeCollection) o;
