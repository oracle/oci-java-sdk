...
public class SummarizeAddmDbSchemaObjectsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SummarizeAddmDbSchemaObjectsConverter.class);

    public static com.oracle.bmc.opsi.requests.SummarizeAddmDbSchemaObjectsRequest interceptRequest(
            com.oracle.bmc.opsi.requests.SummarizeAddmDbSchemaObjectsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getObjectIdentifier(), "objectIdentifier is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        .path("/20200630")
                        .path("databaseInsights")
                        .path("addmDbSchemaObjects");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.opsi.responses.SummarizeAddmDbSchemaObjectsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.opsi.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.opsi.responses.SummarizeAddmDbSchemaObjectsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.addmDbSchemaObjectCollection(response.getItem());
