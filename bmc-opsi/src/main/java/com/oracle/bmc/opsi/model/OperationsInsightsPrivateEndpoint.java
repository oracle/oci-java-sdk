...
/**
 * A private endpoint that allows Operation Insights services to connect to databases in a
 * customer's virtual cloud network (VCN). <br>
...
public final class OperationsInsightsPrivateEndpoint
    ...
    public static class Builder {
        ...
        /**
         * The private IP addresses assigned to the private endpoint. All IP addresses will be
         * concatenated if it is RAC DBs.
         */
        ...
        /**
         * The flag is to identify if private endpoint is used for rac database or not. This flag is
