...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ExadataDiskgroupStatisticsSummary.Builder.class
)
...
public final class ExadataDiskgroupStatisticsSummary
    ...
    public static class Builder {
        ...
        public Builder resourceDetails(DiskGroupDetails resourceDetails) {
        ...
        public ExadataDiskgroupStatisticsSummary build() {
            ExadataDiskgroupStatisticsSummary __instance__ =
                    new ExadataDiskgroupStatisticsSummary(resourceDetails, currentStatistics);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataDiskgroupStatisticsSummary o) {
    ...
    @Deprecated
    public ExadataDiskgroupStatisticsSummary(
            DiskGroupDetails resourceDetails, ExadataInsightResourceStatistics currentStatistics) {
        super();
        this.resourceDetails = resourceDetails;
        this.currentStatistics = currentStatistics;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataDiskgroupStatisticsSummary)) {
            return false;
        }

        ExadataDiskgroupStatisticsSummary other = (ExadataDiskgroupStatisticsSummary) o;
