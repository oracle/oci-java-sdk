...
/**
 * Diskgroup details and statistics. <br>
...
public final class ExadataDiskgroupStatisticsSummary
    ...
    public static class Builder {
        ...
        public ExadataDiskgroupStatisticsSummary build() {
            ExadataDiskgroupStatisticsSummary model =
                    new ExadataDiskgroupStatisticsSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataDiskgroupStatisticsSummary model) {
