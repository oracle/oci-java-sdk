...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/UpdateDatabaseInsightExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDatabaseInsightRequest.
 */
...
public class UpdateDatabaseInsightRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateDatabaseInsightRequest o) {
            databaseInsightId(o.getDatabaseInsightId());
            updateDatabaseInsightDetails(o.getUpdateDatabaseInsightDetails());
        ...
        /**
         * Build the instance of UpdateDatabaseInsightRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateDatabaseInsightRequest
         */
        public UpdateDatabaseInsightRequest build() {
            UpdateDatabaseInsightRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateDatabaseInsightRequest buildWithoutInvocationCallback() {
            UpdateDatabaseInsightRequest request = new UpdateDatabaseInsightRequest();
            request.databaseInsightId = databaseInsightId;
            request.updateDatabaseInsightDetails = updateDatabaseInsightDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateDatabaseInsightRequest(databaseInsightId, updateDatabaseInsightDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateDatabaseInsightDetails=")
                .append(String.valueOf(this.updateDatabaseInsightDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseInsightRequest)) {
            return false;
        }

        UpdateDatabaseInsightRequest other = (UpdateDatabaseInsightRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.databaseInsightId, other.databaseInsightId)
                && java.util.Objects.equals(
                        this.updateDatabaseInsightDetails, other.updateDatabaseInsightDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateDatabaseInsightDetails == null
                                ? 43
                                : this.updateDatabaseInsightDetails.hashCode());
