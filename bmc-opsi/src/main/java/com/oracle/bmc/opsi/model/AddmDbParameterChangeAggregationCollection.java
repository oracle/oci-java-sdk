...
/**
 * Summarizes AWR parameter change history over specified time period for specified parameter <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbParameterChangeAggregationCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class AddmDbParameterChangeAggregationCollection
    ...
    public AddmDbParameterChangeAggregationCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbParameterChangeAggregation> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbParameterChangeAggregation> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbParameterChangeAggregation> items) {
            this.items = items;
        ...
        public AddmDbParameterChangeAggregationCollection build() {
            AddmDbParameterChangeAggregationCollection model =
                    new AddmDbParameterChangeAggregationCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbParameterChangeAggregationCollection model) {
    ...
    /** List of AWR parameter changes */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbParameterChangeAggregation> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbParameterChangeAggregation> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbParameterChangeAggregationCollection)) {
            return false;
        }

        AddmDbParameterChangeAggregationCollection other =
                (AddmDbParameterChangeAggregationCollection) o;
