...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeDatabaseInsightResourceUtilizationInsightExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeDatabaseInsightResourceUtilizationInsightRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeDatabaseInsightResourceUtilizationInsightRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeDatabaseInsightResourceUtilizationInsightRequest, java.lang.Void> {
        ...
        /**
         * Singular setter. Optional list of exadata insight resource [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeDatabaseInsightResourceUtilizationInsightRequest o) {
        ...
        /**
         * Build the instance of SummarizeDatabaseInsightResourceUtilizationInsightRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeDatabaseInsightResourceUtilizationInsightRequest
         */
        public SummarizeDatabaseInsightResourceUtilizationInsightRequest build() {
         ...
         * @return instance of SummarizeDatabaseInsightResourceUtilizationInsightRequest
         */
        public SummarizeDatabaseInsightResourceUtilizationInsightRequest
                buildWithoutInvocationCallback() {
            SummarizeDatabaseInsightResourceUtilizationInsightRequest request =
                    new SummarizeDatabaseInsightResourceUtilizationInsightRequest();
            ...
            return request;
            // new SummarizeDatabaseInsightResourceUtilizationInsightRequest(compartmentId, resourceMetric, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, databaseType, databaseId, id, exadataInsightId, forecastDays, hostName, isDatabaseInstanceLevelMetrics, page, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree, vmclusterName, cdbName, highUtilizationThreshold, lowUtilizationThreshold);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeDatabaseInsightResourceUtilizationInsightRequest)) {
            return false;
        }

        SummarizeDatabaseInsightResourceUtilizationInsightRequest other =
                (SummarizeDatabaseInsightResourceUtilizationInsightRequest) o;
