...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeHostInsightStorageUsageTrendExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeHostInsightStorageUsageTrendRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeHostInsightStorageUsageTrendRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeHostInsightStorageUsageTrendRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeHostInsightStorageUsageTrendRequest o) {
        ...
        /**
         * Build the instance of SummarizeHostInsightStorageUsageTrendRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeHostInsightStorageUsageTrendRequest
         */
        public SummarizeHostInsightStorageUsageTrendRequest build() {
            SummarizeHostInsightStorageUsageTrendRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeHostInsightStorageUsageTrendRequest
         */
        public SummarizeHostInsightStorageUsageTrendRequest buildWithoutInvocationCallback() {
            SummarizeHostInsightStorageUsageTrendRequest request =
                    new SummarizeHostInsightStorageUsageTrendRequest();
            ...
            return request;
            // new SummarizeHostInsightStorageUsageTrendRequest(compartmentId, id, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, hostId, page, limit, statistic, opcRequestId, status);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightStorageUsageTrendRequest)) {
            return false;
        }

        SummarizeHostInsightStorageUsageTrendRequest other =
                (SummarizeHostInsightStorageUsageTrendRequest) o;
