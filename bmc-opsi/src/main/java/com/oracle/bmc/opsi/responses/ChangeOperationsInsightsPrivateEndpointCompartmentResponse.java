...
public class ChangeOperationsInsightsPrivateEndpointCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeOperationsInsightsPrivateEndpointCompartmentResponse)) {
            return false;
        }

        ChangeOperationsInsightsPrivateEndpointCompartmentResponse other =
                (ChangeOperationsInsightsPrivateEndpointCompartmentResponse) o;
