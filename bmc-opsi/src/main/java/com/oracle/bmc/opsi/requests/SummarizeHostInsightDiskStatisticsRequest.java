...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeHostInsightDiskStatisticsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeHostInsightDiskStatisticsRequest.
 */
...
public class SummarizeHostInsightDiskStatisticsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeHostInsightDiskStatisticsRequest as configured by this builder
         *
        ...
        public SummarizeHostInsightDiskStatisticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeHostInsightDiskStatisticsRequest(compartmentId, id, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, hostId, statistic, opcRequestId, status);
        }
    }
