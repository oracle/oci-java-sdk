...
public class SummarizeAddmDbParametersRequest
     ...
     */
    private String nameOrValueContains;

    /**
     * Optional filter to return only resources whose name or value contains the substring given.
     * The match is not case sensitive.
     */
    public String getNameOrValueContains() {
        return nameOrValueContains;
    }
    /**
    ...
    public enum IsChanged implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static java.util.Map<String, IsChanged> map;

        static {
            map = new java.util.HashMap<>();
            for (IsChanged v : IsChanged.values()) {
                map.put(v.getValue(), v);
            }
        }

        IsChanged(String value) {
            this.value = value;
        }
        ...
        public static IsChanged create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            throw new IllegalArgumentException("Invalid IsChanged: " + key);
        }
    };
    ...
    public enum IsDefault implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private final String value;
        private static java.util.Map<String, IsDefault> map;
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static IsDefault create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            throw new IllegalArgumentException("Invalid IsDefault: " + key);
        }
    };
    ...
    /**
     * Optional filter to return only parameters which have recommendations in the specified time
     * period. Valid values include: TRUE, FALSE
     */
    private HasRecommendations hasRecommendations;
    ...
    public enum HasRecommendations implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private final String value;
        private static java.util.Map<String, HasRecommendations> map;

        static {
            map = new java.util.HashMap<>();
            for (HasRecommendations v : HasRecommendations.values()) {
                map.put(v.getValue(), v);
            }
        }

        HasRecommendations(String value) {
            this.value = value;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static HasRecommendations create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            throw new IllegalArgumentException("Invalid HasRecommendations: " + key);
        }
    };
     ...
     * period. Valid values include: TRUE, FALSE
     */
    public HasRecommendations getHasRecommendations() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAddmDbParametersRequest, java.lang.Void> {
        ...
        /**
         * Optional filter to return only resources whose name or value contains the substring
         * given. The match is not case sensitive.
         */
        private String nameOrValueContains = null;

        /**
         * Optional filter to return only resources whose name or value contains the substring
         * given. The match is not case sensitive.
         *
         * @param nameOrValueContains the value to set
         * @return this builder instance
         */
        public Builder nameOrValueContains(String nameOrValueContains) {
            this.nameOrValueContains = nameOrValueContains;
            return this;
        }

        /**
         * Optional filter to return only parameters whose value changed in the specified time
         * period. Valid values include: TRUE, FALSE
         */
        private IsChanged isChanged = null;
         ...
         * @return this builder instance
         */
        public Builder isChanged(IsChanged isChanged) {
            this.isChanged = isChanged;
            return this;
        }

        /**
         * Optional filter to return only parameters whose end value was set to the default value
         * (TRUE) or was specified in the parameter file (FALSE). Valid values include: TRUE, FALSE
         */
        private IsDefault isDefault = null;
         ...
         * @return this builder instance
         */
        public Builder isDefault(IsDefault isDefault) {
            this.isDefault = isDefault;
            return this;
        }

        /**
         * Optional filter to return only parameters which have recommendations in the specified
         * time period. Valid values include: TRUE, FALSE
         */
        private HasRecommendations hasRecommendations = null;

        /**
         * Optional filter to return only parameters which have recommendations in the specified
         * time period. Valid values include: TRUE, FALSE
         *
         * @param hasRecommendations the value to set
         * @return this builder instance
         */
        public Builder hasRecommendations(HasRecommendations hasRecommendations) {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAddmDbParametersRequest o) {
            ...
            nameOrValueContains(o.getNameOrValueContains());
            isChanged(o.getIsChanged());
            isDefault(o.getIsDefault());
            hasRecommendations(o.getHasRecommendations());
            limit(o.getLimit());
            page(o.getPage());
        ...
        /**
         * Build the instance of SummarizeAddmDbParametersRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAddmDbParametersRequest
         */
        public SummarizeAddmDbParametersRequest build() {
            SummarizeAddmDbParametersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeAddmDbParametersRequest
         */
        public SummarizeAddmDbParametersRequest buildWithoutInvocationCallback() {
            SummarizeAddmDbParametersRequest request = new SummarizeAddmDbParametersRequest();
            ...
            request.nameOrValueContains = nameOrValueContains;
            request.isChanged = isChanged;
            request.isDefault = isDefault;
            request.hasRecommendations = hasRecommendations;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new SummarizeAddmDbParametersRequest(compartmentId, databaseId, id, instanceNumber,
            // timeIntervalStart, timeIntervalEnd, categoryName, nameOrValueContains, isChanged,
            // isDefault, hasRecommendations, limit, page, sortOrder, sortBy, opcRequestId,
    ...
    public String toString() {
        ...
        sb.append(",nameOrValueContains=").append(String.valueOf(this.nameOrValueContains));
        sb.append(",isChanged=").append(String.valueOf(this.isChanged));
        sb.append(",isDefault=").append(String.valueOf(this.isDefault));
        sb.append(",hasRecommendations=").append(String.valueOf(this.hasRecommendations));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAddmDbParametersRequest)) {
            return false;
        }

        SummarizeAddmDbParametersRequest other = (SummarizeAddmDbParametersRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.nameOrValueContains, other.nameOrValueContains)
                && java.util.Objects.equals(this.isChanged, other.isChanged)
                && java.util.Objects.equals(this.isDefault, other.isDefault)
                && java.util.Objects.equals(this.hasRecommendations, other.hasRecommendations)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.nameOrValueContains == null
                                ? 43
                                : this.nameOrValueContains.hashCode());
        result = (result * PRIME) + (this.isChanged == null ? 43 : this.isChanged.hashCode());
        result = (result * PRIME) + (this.isDefault == null ? 43 : this.isDefault.hashCode());
        result =
                (result * PRIME)
                        + (this.hasRecommendations == null
                                ? 43
                                : this.hasRecommendations.hashCode());
