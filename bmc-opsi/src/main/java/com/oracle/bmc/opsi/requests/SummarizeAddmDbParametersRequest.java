...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAddmDbParametersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAddmDbParametersRequest.
 */
...
public class SummarizeAddmDbParametersRequest
    ...
    public static class Builder
        ...
        public SummarizeAddmDbParametersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAddmDbParametersRequest(compartmentId, databaseId, id, instanceNumber, timeIntervalStart, timeIntervalEnd, categoryName, nameOrValueContains, isChanged, isDefault, hasRecommendations, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
