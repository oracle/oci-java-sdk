...
/**
 * Credentials by named credentials stored in management agent to connect database <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CredentialByNamedCredentials.Builder.class)
...
public final class CredentialByNamedCredentials extends CredentialDetails {
    ...
    public static class Builder {
        ...
        /**
         * The credential
         * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) stored in
         * management agent.
         */
        ...
        public CredentialByNamedCredentials build() {
            CredentialByNamedCredentials model =
                    new CredentialByNamedCredentials(
                            this.credentialSourceName, this.namedCredentialId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CredentialByNamedCredentials model) {
    ...
    @Deprecated
    public CredentialByNamedCredentials(String credentialSourceName, String namedCredentialId) {
        super(credentialSourceName);
        this.namedCredentialId = namedCredentialId;
    }

    /**
     * The credential [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
     * stored in management agent.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("namedCredentialId")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CredentialByNamedCredentials(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialByNamedCredentials)) {
            return false;
        }

        CredentialByNamedCredentials other = (CredentialByNamedCredentials) o;
