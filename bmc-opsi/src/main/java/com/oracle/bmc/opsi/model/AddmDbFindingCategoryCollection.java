...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbFindingCategoryCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class AddmDbFindingCategoryCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"databaseDetailsItems", "items"})
    public AddmDbFindingCategoryCollection(
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbFindingCategorySummary> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbFindingCategorySummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbFindingCategorySummary> items) {
            this.items = items;
        ...
        public AddmDbFindingCategoryCollection build() {
            AddmDbFindingCategoryCollection model =
                    new AddmDbFindingCategoryCollection(this.databaseDetailsItems, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbFindingCategoryCollection model) {
    ...
    /** List of finding categories */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbFindingCategorySummary> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbFindingCategorySummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbFindingCategoryCollection)) {
            return false;
        }

        AddmDbFindingCategoryCollection other = (AddmDbFindingCategoryCollection) o;
