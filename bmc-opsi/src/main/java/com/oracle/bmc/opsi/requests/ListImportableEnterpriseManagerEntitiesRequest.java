...
public class ListImportableEnterpriseManagerEntitiesRequest
    ...
    /**
     * Filter by one or more Enterprise Manager entity types. Currently, the supported types are
     * "oracle_pdb", "oracle_database", "host", "oracle_dbmachine", "oracle_exa_cloud_service", and
     * "oracle_oci_exadata_cloud_service". If this parameter is not specified, targets of all
     * supported entity types are returned by default.
     */
    ...
    /**
     * Used in combination with enterpriseManagerParentEntityIdentifier to return the members of a
     * particular Enterprise Manager parent entity. Both enterpriseManagerIdentifier and
     * enterpriseManagerParentEntityIdentifier must be specified to identify a particular Enterprise
     * Manager parent entity.
     */
    ...
    /**
     * Used in combination with enterpriseManagerIdentifier to return the members of a particular
     * Enterprise Manager parent entity. Both enterpriseManagerIdentifier and
     * enterpriseManagerParentEntityIdentifier must be specified to identify a particular Enterprise
     * Manager parent entity.
     */
    ...
    public static class Builder
        ...
        /**
         * Filter by one or more Enterprise Manager entity types. Currently, the supported types are
         * "oracle_pdb", "oracle_database", "host", "oracle_dbmachine", "oracle_exa_cloud_service",
         * and "oracle_oci_exadata_cloud_service". If this parameter is not specified, targets of
        ...
        /**
         * Singular setter. Filter by one or more Enterprise Manager entity types. Currently, the
         * supported types are "oracle_pdb", "oracle_database", "host", "oracle_dbmachine",
         * "oracle_exa_cloud_service", and "oracle_oci_exadata_cloud_service". If this parameter is
         * not specified, targets of all supported entity types are returned by default.
         *
        ...
        /**
         * Used in combination with enterpriseManagerParentEntityIdentifier to return the members of
         * a particular Enterprise Manager parent entity. Both enterpriseManagerIdentifier and
         * enterpriseManagerParentEntityIdentifier must be specified to identify a particular
         * Enterprise Manager parent entity.
         */
        ...
        /**
         * Used in combination with enterpriseManagerIdentifier to return the members of a
         * particular Enterprise Manager parent entity. Both enterpriseManagerIdentifier and
         * enterpriseManagerParentEntityIdentifier must be specified to identify a particular
         * Enterprise Manager parent entity.
         */
        ...
        /**
         * Build the instance of ListImportableEnterpriseManagerEntitiesRequest as configured by
         * this builder
         *
        ...
        public ListImportableEnterpriseManagerEntitiesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListImportableEnterpriseManagerEntitiesRequest(enterpriseManagerBridgeId, limit,
            // page, enterpriseManagerEntityType, enterpriseManagerIdentifier,
            // enterpriseManagerParentEntityIdentifier, opcRequestId);
        }
    }
