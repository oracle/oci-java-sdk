...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAwrHubsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAwrHubsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAwrHubsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAwrHubsRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                java.util.List<com.oracle.bmc.opsi.model.AwrHubLifecycleState> lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAwrHubsRequest o) {
        ...
        /**
         * Build the instance of ListAwrHubsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAwrHubsRequest
         */
        public ListAwrHubsRequest build() {
            ListAwrHubsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAwrHubsRequest
         */
        public ListAwrHubsRequest buildWithoutInvocationCallback() {
            ListAwrHubsRequest request = new ListAwrHubsRequest();
            ...
            return request;
            // new ListAwrHubsRequest(operationsInsightsWarehouseId, compartmentId, displayName, id, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAwrHubsRequest)) {
            return false;
        }

        ListAwrHubsRequest other = (ListAwrHubsRequest) o;
