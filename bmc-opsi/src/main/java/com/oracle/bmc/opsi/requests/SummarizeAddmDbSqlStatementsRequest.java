...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAddmDbSqlStatementsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAddmDbSqlStatementsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeAddmDbSqlStatementsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAddmDbSqlStatementsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAddmDbSqlStatementsRequest o) {
        ...
        /**
         * Build the instance of SummarizeAddmDbSqlStatementsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAddmDbSqlStatementsRequest
         */
        public SummarizeAddmDbSqlStatementsRequest build() {
            SummarizeAddmDbSqlStatementsRequest request = buildWithoutInvocationCallback();
        ...
        public SummarizeAddmDbSqlStatementsRequest buildWithoutInvocationCallback() {
            SummarizeAddmDbSqlStatementsRequest request = new SummarizeAddmDbSqlStatementsRequest();
            ...
            return request;
            // new SummarizeAddmDbSqlStatementsRequest(compartmentId, sqlIdentifier, databaseId, id, timeIntervalStart, timeIntervalEnd, limit, page, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAddmDbSqlStatementsRequest)) {
            return false;
        }

        SummarizeAddmDbSqlStatementsRequest other = (SummarizeAddmDbSqlStatementsRequest) o;
