...
public class SummarizeAddmDbSqlStatementsRequest
    ...
    /** One or more unique SQL_IDs for a SQL Statement. Example: {@code 6rgjh9bjmy2s7} */
    ...
    public static class Builder
        ...
        /**
         * Singular setter. One or more unique SQL_IDs for a SQL Statement. Example: {@code
         * 6rgjh9bjmy2s7}
         *
        ...
        public SummarizeAddmDbSqlStatementsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAddmDbSqlStatementsRequest(compartmentId, sqlIdentifier, databaseId, id,
            // timeIntervalStart, timeIntervalEnd, limit, page, opcRequestId, definedTagEquals,
