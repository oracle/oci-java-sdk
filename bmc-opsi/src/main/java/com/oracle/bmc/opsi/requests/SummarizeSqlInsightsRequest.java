...
public class SummarizeSqlInsightsRequest
    ...
    public static class Builder
        ...
        public SummarizeSqlInsightsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeSqlInsightsRequest(compartmentId, databaseType, databaseId, id, exadataInsightId, cdbName, hostName, databaseTimePctGreaterThan, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, page, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
