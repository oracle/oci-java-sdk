...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeSqlInsightsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeSqlInsightsRequest.
 */
...
public class SummarizeSqlInsightsRequest
    ...
    public static class Builder
        ...
        public SummarizeSqlInsightsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeSqlInsightsRequest(compartmentId, databaseType, databaseId, id, exadataInsightId, cdbName, hostName, databaseTimePctGreaterThan, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, page, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree, vmclusterName);
        }
    }
