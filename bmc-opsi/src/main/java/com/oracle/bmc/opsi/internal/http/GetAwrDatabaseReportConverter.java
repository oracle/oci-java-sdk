...
public class GetAwrDatabaseReportConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAwrDatabaseReportConverter.class);

    public static com.oracle.bmc.opsi.requests.GetAwrDatabaseReportRequest interceptRequest(
            com.oracle.bmc.opsi.requests.GetAwrDatabaseReportRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.opsi.responses.GetAwrDatabaseReportResponse>() {
                            @Override
                            public com.oracle.bmc.opsi.responses.GetAwrDatabaseReportResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.opsi.responses.GetAwrDatabaseReportResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.opsi.model.AwrDatabaseReport
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.opsi.responses.GetAwrDatabaseReportResponse.Builder
                                        builder =
                                ...
                                builder.awrDatabaseReport(response.getItem());
