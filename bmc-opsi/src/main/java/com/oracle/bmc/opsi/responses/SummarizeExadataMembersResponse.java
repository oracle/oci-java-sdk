...
public class SummarizeExadataMembersResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeExadataMembersResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcTotalItems(o.getOpcTotalItems());
            opcNextPage(o.getOpcNextPage());
            exadataMemberCollection(o.getExadataMemberCollection());
    ...
    public String toString() {
        ...
        sb.append(",exadataMemberCollection=").append(String.valueOf(exadataMemberCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExadataMembersResponse)) {
            return false;
        }

        SummarizeExadataMembersResponse other = (SummarizeExadataMembersResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcTotalItems, other.opcTotalItems)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.exadataMemberCollection, other.exadataMemberCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.exadataMemberCollection == null
                                ? 43
                                : this.exadataMemberCollection.hashCode());
        return result;
    }
}
