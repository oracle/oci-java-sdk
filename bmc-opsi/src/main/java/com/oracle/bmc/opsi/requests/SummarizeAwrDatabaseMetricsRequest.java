...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAwrDatabaseMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDatabaseMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeAwrDatabaseMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAwrDatabaseMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAwrDatabaseMetricsRequest o) {
        ...
        /**
         * Build the instance of SummarizeAwrDatabaseMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAwrDatabaseMetricsRequest
         */
        public SummarizeAwrDatabaseMetricsRequest build() {
            SummarizeAwrDatabaseMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeAwrDatabaseMetricsRequest
         */
        public SummarizeAwrDatabaseMetricsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDatabaseMetricsRequest request = new SummarizeAwrDatabaseMetricsRequest();
            ...
            return request;
            // new SummarizeAwrDatabaseMetricsRequest(awrHubId, awrSourceDatabaseIdentifier, name, instanceNumber, beginSnapshotIdentifierGreaterThanOrEqualTo, endSnapshotIdentifierLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseMetricsRequest)) {
            return false;
        }

        SummarizeAwrDatabaseMetricsRequest other = (SummarizeAwrDatabaseMetricsRequest) o;
