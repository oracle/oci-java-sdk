...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAddmDbParameterChangesExample.java.html"
...
public class SummarizeAddmDbParameterChangesRequest
    ...
    /**
     * Required filter to return only changes for the specified parameter. The match is case
     * sensitive.
     */
    private String name;
    ...
    /**
     * Optional filter to return only resources whose value contains the substring given. The match
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeAddmDbParameterChangesRequest as configured by this
         * builder
         *
        ...
        public SummarizeAddmDbParameterChangesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAddmDbParameterChangesRequest(compartmentId, name, databaseId, id,
            // instanceNumber, timeIntervalStart, timeIntervalEnd, valueContains, limit, page,
            // sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals,
