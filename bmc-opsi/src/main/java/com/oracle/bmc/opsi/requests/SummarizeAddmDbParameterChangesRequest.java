...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAddmDbParameterChangesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAddmDbParameterChangesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeAddmDbParameterChangesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAddmDbParameterChangesRequest, java.lang.Void> {
         ...
         *
         */
        private String valueContains = null;

        /**
         * Optional filter to return only resources whose value contains the substring given. The
         * match is not case sensitive.
         *
         * @param valueContains the value to set
         * @return this builder instance
         */
        public Builder valueContains(String valueContains) {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAddmDbParameterChangesRequest o) {
            ...
            valueContains(o.getValueContains());
            limit(o.getLimit());
            page(o.getPage());
        ...
        /**
         * Build the instance of SummarizeAddmDbParameterChangesRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAddmDbParameterChangesRequest
         */
        public SummarizeAddmDbParameterChangesRequest build() {
            SummarizeAddmDbParameterChangesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeAddmDbParameterChangesRequest
         */
        public SummarizeAddmDbParameterChangesRequest buildWithoutInvocationCallback() {
            SummarizeAddmDbParameterChangesRequest request =
                    new SummarizeAddmDbParameterChangesRequest();
            ...
            request.valueContains = valueContains;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new SummarizeAddmDbParameterChangesRequest(compartmentId, name, databaseId, id, instanceNumber, timeIntervalStart, timeIntervalEnd, valueContains, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",valueContains=").append(String.valueOf(this.valueContains));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAddmDbParameterChangesRequest)) {
            return false;
        }

        SummarizeAddmDbParameterChangesRequest other = (SummarizeAddmDbParameterChangesRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.valueContains, other.valueContains)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.valueContains == null ? 43 : this.valueContains.hashCode());
