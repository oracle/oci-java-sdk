...
public class DeleteOperationsInsightsPrivateEndpointResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOperationsInsightsPrivateEndpointResponse)) {
            return false;
        }

        DeleteOperationsInsightsPrivateEndpointResponse other =
                (DeleteOperationsInsightsPrivateEndpointResponse) o;
