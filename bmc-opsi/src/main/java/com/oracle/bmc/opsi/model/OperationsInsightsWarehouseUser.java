...
public final class OperationsInsightsWarehouseUser
    ...
    public OperationsInsightsWarehouseUser(
    ...
    public static class Builder {
        ...
        public OperationsInsightsWarehouseUser build() {
            OperationsInsightsWarehouseUser model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OperationsInsightsWarehouseUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperationsInsightsWarehouseUser)) {
            return false;
        }

        OperationsInsightsWarehouseUser other = (OperationsInsightsWarehouseUser) o;
