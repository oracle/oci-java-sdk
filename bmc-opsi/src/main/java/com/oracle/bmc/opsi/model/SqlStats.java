...
public final class SqlStats extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /** Total integer of parse calls Example: {@code 60} */
        ...
        /**
         * Number of I/O bytes exchanged between Oracle Database and the storage system. Typically
         * used for Cache Fusion or parallel queries
         */
        ...
        /**
         * Number of physical read I/O requests issued by the monitored SQL. The requests may not be
         * disk reads
         */
    ...
    /**
     * Number of I/O bytes exchanged between Oracle Database and the storage system. Typically used
     * for Cache Fusion or parallel queries
     */
    @com.fasterxml.jackson.annotation.JsonProperty("ioInterconnectBytes")
