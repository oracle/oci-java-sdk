...
public class ListAwrDatabaseSnapshotsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAwrDatabaseSnapshotsConverter.class);

    public static com.oracle.bmc.opsi.requests.ListAwrDatabaseSnapshotsRequest interceptRequest(
            com.oracle.bmc.opsi.requests.ListAwrDatabaseSnapshotsRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.opsi.responses.ListAwrDatabaseSnapshotsResponse>() {
                            @Override
                            public com.oracle.bmc.opsi.responses.ListAwrDatabaseSnapshotsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.opsi.responses.ListAwrDatabaseSnapshotsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.opsi.responses.ListAwrDatabaseSnapshotsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.opsi.responses
                                                        .ListAwrDatabaseSnapshotsResponse.builder()
                                                        .__httpStatusCode__(
                                                                rawResponse.getStatus());

                                builder.awrDatabaseSnapshotCollection(response.getItem());
