...
public class SummarizeDatabaseInsightResourceStatisticsRequest
    ...
    public static class Builder
        ...
        public SummarizeDatabaseInsightResourceStatisticsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeDatabaseInsightResourceStatisticsRequest(compartmentId, resourceMetric, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, databaseType, databaseId, id, exadataInsightId, cdbName, percentile, insightBy, forecastDays, limit, page, sortOrder, sortBy, hostName, isDatabaseInstanceLevelMetrics, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree, vmclusterName);
        }
    }
