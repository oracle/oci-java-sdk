...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeAwrDatabaseWaitEventsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDatabaseWaitEventsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeAwrDatabaseWaitEventsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeAwrDatabaseWaitEventsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeAwrDatabaseWaitEventsRequest o) {
        ...
        /**
         * Build the instance of SummarizeAwrDatabaseWaitEventsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeAwrDatabaseWaitEventsRequest
         */
        public SummarizeAwrDatabaseWaitEventsRequest build() {
            SummarizeAwrDatabaseWaitEventsRequest request = buildWithoutInvocationCallback();
        ...
        public SummarizeAwrDatabaseWaitEventsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDatabaseWaitEventsRequest request =
                    new SummarizeAwrDatabaseWaitEventsRequest();
            ...
            return request;
            // new SummarizeAwrDatabaseWaitEventsRequest(awrHubId, awrSourceDatabaseIdentifier, instanceNumber, beginSnapshotIdentifierGreaterThanOrEqualTo, endSnapshotIdentifierLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, name, sessionType, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDatabaseWaitEventsRequest)) {
            return false;
        }

        SummarizeAwrDatabaseWaitEventsRequest other = (SummarizeAwrDatabaseWaitEventsRequest) o;
