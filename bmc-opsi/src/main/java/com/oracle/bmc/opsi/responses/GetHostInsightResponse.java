...
public class GetHostInsightResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetHostInsightResponse> {
        ...
        public GetHostInsightResponse build() {
            return new GetHostInsightResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, hostInsight);
        }
    }
