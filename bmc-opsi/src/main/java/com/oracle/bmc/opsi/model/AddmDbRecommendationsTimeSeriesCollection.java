...
/**
 * ADDM recommendations time series <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbRecommendationsTimeSeriesCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddmDbRecommendationsTimeSeriesCollection
    ...
    public AddmDbRecommendationsTimeSeriesCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbRecommendationsTimeSeriesSummary> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbRecommendationsTimeSeriesSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbRecommendationsTimeSeriesSummary> items) {
            this.items = items;
        ...
        public AddmDbRecommendationsTimeSeriesCollection build() {
            AddmDbRecommendationsTimeSeriesCollection model =
                    new AddmDbRecommendationsTimeSeriesCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbRecommendationsTimeSeriesCollection model) {
    ...
    /** List of ADDM recommendations time series data */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbRecommendationsTimeSeriesSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbRecommendationsTimeSeriesSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddmDbRecommendationsTimeSeriesCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbRecommendationsTimeSeriesCollection)) {
            return false;
        }

        AddmDbRecommendationsTimeSeriesCollection other =
                (AddmDbRecommendationsTimeSeriesCollection) o;
