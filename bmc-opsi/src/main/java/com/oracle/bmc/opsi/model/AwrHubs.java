...
public final class AwrHubs {
    ...
    public static class Builder {
        ...
        public AwrHubs build() {
            AwrHubs __instance__ = new AwrHubs(awrHubs);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrHubs o) {
            Builder copiedBuilder = awrHubs(o.getAwrHubs());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.awrHubs, other.awrHubs)
