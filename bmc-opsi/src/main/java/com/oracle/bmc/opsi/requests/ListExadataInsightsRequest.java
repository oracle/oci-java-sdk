...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListExadataInsightsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExadataInsightsRequest.
 */
...
public class ListExadataInsightsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * Exadata insight list sort options. If {@code fields} parameter is selected, the {@code
     * sortBy} parameter must be one of the fields specified. Default order for timeCreated is
     * descending. Default order for exadataName is ascending. If no value is specified timeCreated
     * is default.
     */
    ...
    public static class Builder
        ...
        public ListExadataInsightsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListExadataInsightsRequest(compartmentId, enterpriseManagerBridgeId, id, status,
            // lifecycleState, exadataType, limit, page, sortOrder, sortBy, compartmentIdInSubtree,
            // opcRequestId);
        }
    }
