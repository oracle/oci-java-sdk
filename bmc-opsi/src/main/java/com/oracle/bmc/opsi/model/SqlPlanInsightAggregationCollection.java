...
public final class SqlPlanInsightAggregationCollection
    ...
    public static class Builder {
        ...
        public SqlPlanInsightAggregationCollection build() {
            SqlPlanInsightAggregationCollection model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SqlPlanInsightAggregationCollection model) {
            ...
            if (model.wasPropertyExplicitlySet("insights")) {
                this.insights(model.getInsights());
            }
