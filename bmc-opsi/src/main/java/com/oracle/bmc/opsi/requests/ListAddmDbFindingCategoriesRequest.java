...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbFindingCategoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbFindingCategoriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAddmDbFindingCategoriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAddmDbFindingCategoriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAddmDbFindingCategoriesRequest o) {
        ...
        /**
         * Build the instance of ListAddmDbFindingCategoriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAddmDbFindingCategoriesRequest
         */
        public ListAddmDbFindingCategoriesRequest build() {
            ListAddmDbFindingCategoriesRequest request = buildWithoutInvocationCallback();
        ...
        public ListAddmDbFindingCategoriesRequest buildWithoutInvocationCallback() {
            ListAddmDbFindingCategoriesRequest request = new ListAddmDbFindingCategoriesRequest();
            ...
            return request;
            // new ListAddmDbFindingCategoriesRequest(compartmentId, databaseId, id, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbFindingCategoriesRequest)) {
            return false;
        }

        ListAddmDbFindingCategoriesRequest other = (ListAddmDbFindingCategoriesRequest) o;
