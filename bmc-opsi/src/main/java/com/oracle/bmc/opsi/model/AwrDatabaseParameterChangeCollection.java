...
/**
 * The AWR database parameter change history. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AwrDatabaseParameterChangeCollection.Builder.class)
...
public final class AwrDatabaseParameterChangeCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        private java.util.List<AwrDatabaseParameterChangeSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AwrDatabaseParameterChangeSummary> items) {
            this.items = items;
    ...
    @Deprecated
    public AwrDatabaseParameterChangeCollection(
            String name,
            String version,
            Double dbQueryTimeInSecs,
            java.util.List<AwrDatabaseParameterChangeSummary> items) {
    ...
    /** A list of AWR database parameter change summary data. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDatabaseParameterChangeSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AwrDatabaseParameterChangeSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDatabaseParameterChangeCollection)) {
            return false;
        }
