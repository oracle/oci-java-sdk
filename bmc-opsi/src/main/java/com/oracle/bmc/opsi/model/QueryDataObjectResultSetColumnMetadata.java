...
public final class QueryDataObjectResultSetColumnMetadata {
    ...
    public static class Builder {
        ...
        public QueryDataObjectResultSetColumnMetadata build() {
            QueryDataObjectResultSetColumnMetadata __instance__ =
                    new QueryDataObjectResultSetColumnMetadata(name, dataTypeName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueryDataObjectResultSetColumnMetadata o) {
            Builder copiedBuilder = name(o.getName()).dataTypeName(o.getDataTypeName());
