...
/**
 * Configuration summary of a Exacs exadata machine. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadataExacsConfigurationSummary.Builder.class)
...
public final class ExadataExacsConfigurationSummary extends ExadataConfigurationSummary {
    ...
    public static class Builder {
        ...
        public ExadataExacsConfigurationSummary build() {
            ExadataExacsConfigurationSummary model =
                    new ExadataExacsConfigurationSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataExacsConfigurationSummary model) {
    ...
    @Deprecated
    public ExadataExacsConfigurationSummary(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadataExacsConfigurationSummary)) {
            return false;
        }

        ExadataExacsConfigurationSummary other = (ExadataExacsConfigurationSummary) o;
