...
public final class ExadataHostStatisticsSummary
    ...
    public static class Builder {
        ...
        public ExadataHostStatisticsSummary build() {
            ExadataHostStatisticsSummary __instance__ =
                    new ExadataHostStatisticsSummary(resourceDetails, currentStatistics);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadataHostStatisticsSummary o) {
