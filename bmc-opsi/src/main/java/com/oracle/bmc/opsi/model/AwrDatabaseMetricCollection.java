...
public final class AwrDatabaseMetricCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDatabaseMetricCollection build() {
            AwrDatabaseMetricCollection __instance__ =
                    new AwrDatabaseMetricCollection(name, version, dbQueryTimeInSecs, items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDatabaseMetricCollection o) {
