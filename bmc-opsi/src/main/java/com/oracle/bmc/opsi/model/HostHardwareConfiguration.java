...
public class HostHardwareConfiguration extends HostConfigurationMetricGroup {
    ...
    public static class Builder {
        ...
        public HostHardwareConfiguration build() {
            HostHardwareConfiguration __instance__ =
                    new HostHardwareConfiguration(timeCollected, cpuArchitecture);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HostHardwareConfiguration o) {
            Builder copiedBuilder =
                    timeCollected(o.getTimeCollected()).cpuArchitecture(o.getCpuArchitecture());
