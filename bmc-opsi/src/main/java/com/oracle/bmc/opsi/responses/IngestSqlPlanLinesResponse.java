...
public class IngestSqlPlanLinesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.opsi.model.IngestSqlPlanLinesResponseDetails
            getIngestSqlPlanLinesResponseDetails() {
        return ingestSqlPlanLinesResponseDetails;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<IngestSqlPlanLinesResponse> {
         ...
         * @return this builder
         */
        public Builder ingestSqlPlanLinesResponseDetails(
                com.oracle.bmc.opsi.model.IngestSqlPlanLinesResponseDetails
                        ingestSqlPlanLinesResponseDetails) {
            this.ingestSqlPlanLinesResponseDetails = ingestSqlPlanLinesResponseDetails;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",ingestSqlPlanLinesResponseDetails=")
                .append(String.valueOf(ingestSqlPlanLinesResponseDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngestSqlPlanLinesResponse)) {
            return false;
        }

        IngestSqlPlanLinesResponse other = (IngestSqlPlanLinesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.ingestSqlPlanLinesResponseDetails,
                        other.ingestSqlPlanLinesResponseDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ingestSqlPlanLinesResponseDetails == null
                                ? 43
                                : this.ingestSqlPlanLinesResponseDetails.hashCode());
        return result;
    }
}
