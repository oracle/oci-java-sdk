 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbsRequest.
 */
...
public class ListAddmDbsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAddmDbsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAddmDbsRequest(compartmentId, databaseId, id, timeIntervalStart,
            // timeIntervalEnd, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals,
