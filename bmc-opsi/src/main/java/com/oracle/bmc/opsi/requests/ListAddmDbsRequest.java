...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAddmDbsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddmDbsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAddmDbsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAddmDbsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAddmDbsRequest o) {
        ...
        /**
         * Build the instance of ListAddmDbsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAddmDbsRequest
         */
        public ListAddmDbsRequest build() {
            ListAddmDbsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAddmDbsRequest
         */
        public ListAddmDbsRequest buildWithoutInvocationCallback() {
            ListAddmDbsRequest request = new ListAddmDbsRequest();
            ...
            return request;
            // new ListAddmDbsRequest(compartmentId, databaseId, id, timeIntervalStart, timeIntervalEnd, limit, page, sortOrder, sortBy, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAddmDbsRequest)) {
            return false;
        }

        ListAddmDbsRequest other = (ListAddmDbsRequest) o;
