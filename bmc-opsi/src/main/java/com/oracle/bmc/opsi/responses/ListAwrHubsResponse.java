...
public class ListAwrHubsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.opsi.model.AwrHubSummaryCollection getAwrHubSummaryCollection() {
        return awrHubSummaryCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListAwrHubsResponse> {
         ...
         * @return this builder
         */
        public Builder awrHubSummaryCollection(
                com.oracle.bmc.opsi.model.AwrHubSummaryCollection awrHubSummaryCollection) {
            this.awrHubSummaryCollection = awrHubSummaryCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",awrHubSummaryCollection=").append(String.valueOf(awrHubSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAwrHubsResponse)) {
            return false;
        }

        ListAwrHubsResponse other = (ListAwrHubsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.awrHubSummaryCollection, other.awrHubSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.awrHubSummaryCollection == null
                                ? 43
                                : this.awrHubSummaryCollection.hashCode());
        return result;
    }
}
