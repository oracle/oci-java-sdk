...
/**
 * Summary of a Private Endpoint host insight resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PeComanagedHostInsightSummary.Builder.class)
...
public final class PeComanagedHostInsightSummary extends HostInsightSummary {
    ...
    public static class Builder {
        ...
        public PeComanagedHostInsightSummary build() {
            PeComanagedHostInsightSummary model =
                    new PeComanagedHostInsightSummary(
                            this.id,
                            this.compartmentId,
                            this.hostName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PeComanagedHostInsightSummary model) {
    ...
    @Deprecated
    public PeComanagedHostInsightSummary(
            String id,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PeComanagedHostInsightSummary)) {
            return false;
        }

        PeComanagedHostInsightSummary other = (PeComanagedHostInsightSummary) o;
        return java.util.Objects.equals(this.platformType, other.platformType)
