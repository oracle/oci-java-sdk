...
public class ListSqlTextsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSqlTextsResponse> {
         ...
         */
        @Override
        public Builder copy(ListSqlTextsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            sqlTextCollection(o.getSqlTextCollection());
         ...
         */
        @Override
        public ListSqlTextsResponse build() {
            return new ListSqlTextsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, sqlTextCollection);
        }
    }
