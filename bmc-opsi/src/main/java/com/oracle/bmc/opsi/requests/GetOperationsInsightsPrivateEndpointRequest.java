...
public class GetOperationsInsightsPrivateEndpointRequest
    ...
    public static class Builder
         ...
         * @return instance of GetOperationsInsightsPrivateEndpointRequest
         */
        public GetOperationsInsightsPrivateEndpointRequest buildWithoutInvocationCallback() {
            GetOperationsInsightsPrivateEndpointRequest request =
                    new GetOperationsInsightsPrivateEndpointRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOperationsInsightsPrivateEndpointRequest)) {
            return false;
        }

        GetOperationsInsightsPrivateEndpointRequest other =
                (GetOperationsInsightsPrivateEndpointRequest) o;
