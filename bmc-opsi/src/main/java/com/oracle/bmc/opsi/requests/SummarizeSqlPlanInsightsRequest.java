...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeSqlPlanInsightsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeSqlPlanInsightsRequest.
 */
...
public class SummarizeSqlPlanInsightsRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeSqlPlanInsightsRequest o) {
         ...
         */
        public SummarizeSqlPlanInsightsRequest build() {
            SummarizeSqlPlanInsightsRequest request = buildWithoutInvocationCallback();
