...
public final class OperationsInsightsWarehouses {
    ...
    public static class Builder {
        ...
        public OperationsInsightsWarehouses build() {
            OperationsInsightsWarehouses __instance__ =
                    new OperationsInsightsWarehouses(operationsInsightsWarehouses);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OperationsInsightsWarehouses o) {
            Builder copiedBuilder =
                    operationsInsightsWarehouses(o.getOperationsInsightsWarehouses());
