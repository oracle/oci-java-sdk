...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeSqlStatisticsTimeSeriesByPlanExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeSqlStatisticsTimeSeriesByPlanRequest.
 */
...
public class SummarizeSqlStatisticsTimeSeriesByPlanRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SummarizeSqlStatisticsTimeSeriesByPlanRequest as configured by this builder
         *
        ...
        public SummarizeSqlStatisticsTimeSeriesByPlanRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeSqlStatisticsTimeSeriesByPlanRequest(compartmentId, sqlIdentifier, databaseId, id, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, page, opcRequestId);
        }
    }
