...
@com.fasterxml.jackson.annotation.JsonSubTypes({
    ...
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateMacsManagedExternalHostInsightDetails.class,
        name = "MACS_MANAGED_EXTERNAL_HOST"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateMacsManagedCloudHostInsightDetails.class,
        name = "MACS_MANAGED_CLOUD_HOST"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdatePeComanagedHostInsightDetails.class,
        name = "PE_COMANAGED_HOST"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class UpdateHostInsightDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"freeformTags", "definedTags"})
    protected UpdateHostInsightDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateHostInsightDetails)) {
            return false;
        }

        UpdateHostInsightDetails other = (UpdateHostInsightDetails) o;
