...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/SummarizeHostInsightResourceUsageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeHostInsightResourceUsageRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class SummarizeHostInsightResourceUsageRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeHostInsightResourceUsageRequest, java.lang.Void> {
        ...
        /**
         * Singular setter. Optional list of host insight resource [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
         *
         * @param singularValue the singular value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeHostInsightResourceUsageRequest o) {
        ...
        /**
         * Build the instance of SummarizeHostInsightResourceUsageRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeHostInsightResourceUsageRequest
         */
        public SummarizeHostInsightResourceUsageRequest build() {
            SummarizeHostInsightResourceUsageRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeHostInsightResourceUsageRequest
         */
        public SummarizeHostInsightResourceUsageRequest buildWithoutInvocationCallback() {
            SummarizeHostInsightResourceUsageRequest request =
                    new SummarizeHostInsightResourceUsageRequest();
            ...
            return request;
            // new SummarizeHostInsightResourceUsageRequest(compartmentId, resourceMetric, analysisTimeInterval, timeIntervalStart, timeIntervalEnd, platformType, id, exadataInsightId, page, percentile, opcRequestId, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, compartmentIdInSubtree, hostType, hostId, vmclusterName, status);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightResourceUsageRequest)) {
            return false;
        }

        SummarizeHostInsightResourceUsageRequest other =
                (SummarizeHostInsightResourceUsageRequest) o;
