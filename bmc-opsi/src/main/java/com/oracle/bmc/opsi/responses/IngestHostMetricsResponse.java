...
public class IngestHostMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<IngestHostMetricsResponse> {
    ...
    public String toString() {
        ...
        sb.append(",ingestHostMetricsResponseDetails=")
                .append(String.valueOf(ingestHostMetricsResponseDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IngestHostMetricsResponse)) {
            return false;
        }

        IngestHostMetricsResponse other = (IngestHostMetricsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(
                        this.ingestHostMetricsResponseDetails,
                        other.ingestHostMetricsResponseDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ingestHostMetricsResponseDetails == null
                                ? 43
                                : this.ingestHostMetricsResponseDetails.hashCode());
        return result;
    }
}
