...
/**
 * The information about the members of Exadata system to be added. If memberEntityDetails is not
 * specified, the the Enterprise Manager entity (e.g. databases and hosts) associated with an
 * Exadata system will be placed in the same compartment as the Exadata system. <br>
...
public final class AddEmManagedExternalExadataInsightMembersDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddEmManagedExternalExadataInsightMembersDetails)) {
            return false;
        }
