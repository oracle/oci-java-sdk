...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListOpsiDataObjectsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOpsiDataObjectsRequest.
 */
...
public class ListOpsiDataObjectsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public Builder dataObjectType(
                java.util.List<com.oracle.bmc.opsi.model.OpsiDataObjectType> dataObjectType) {
         ...
         */
        public ListOpsiDataObjectsRequest build() {
            ListOpsiDataObjectsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOpsiDataObjectsRequest
         */
        public ListOpsiDataObjectsRequest buildWithoutInvocationCallback() {
            ListOpsiDataObjectsRequest request = new ListOpsiDataObjectsRequest();
            ...
            return request;
            // new ListOpsiDataObjectsRequest(compartmentId, dataObjectType, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOpsiDataObjectsRequest)) {
            return false;
        }

        ListOpsiDataObjectsRequest other = (ListOpsiDataObjectsRequest) o;
