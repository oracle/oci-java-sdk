...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SummarizeHostInsightStorageUsageTrendAggregationCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SummarizeHostInsightStorageUsageTrendAggregationCollection
    ...
    public SummarizeHostInsightStorageUsageTrendAggregationCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            UsageUnit usageUnit,
            Long itemDurationInMs,
            java.util.List<StorageUsageTrendAggregation> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<StorageUsageTrendAggregation> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<StorageUsageTrendAggregation> items) {
            this.items = items;
        ...
        public SummarizeHostInsightStorageUsageTrendAggregationCollection build() {
            SummarizeHostInsightStorageUsageTrendAggregationCollection model =
                    new SummarizeHostInsightStorageUsageTrendAggregationCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SummarizeHostInsightStorageUsageTrendAggregationCollection model) {
    ...
    /** Collection of Usage Data with time stamps for all filesystems. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<StorageUsageTrendAggregation> items;
     ...
     * @return the value
     */
    public java.util.List<StorageUsageTrendAggregation> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SummarizeHostInsightStorageUsageTrendAggregationCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeHostInsightStorageUsageTrendAggregationCollection)) {
            return false;
        }

        SummarizeHostInsightStorageUsageTrendAggregationCollection other =
                (SummarizeHostInsightStorageUsageTrendAggregationCollection) o;
