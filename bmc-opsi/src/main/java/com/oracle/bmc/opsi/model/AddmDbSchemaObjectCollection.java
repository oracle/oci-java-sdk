...
/**
 * Summarizes Schema Objects over specified time period <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbSchemaObjectCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddmDbSchemaObjectCollection
    ...
    public AddmDbSchemaObjectCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbSchemaObjectSummary> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbSchemaObjectSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbSchemaObjectSummary> items) {
            this.items = items;
        ...
        public AddmDbSchemaObjectCollection build() {
            AddmDbSchemaObjectCollection model =
                    new AddmDbSchemaObjectCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbSchemaObjectCollection model) {
    ...
    /** List of Schema Objects */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbSchemaObjectSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbSchemaObjectSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddmDbSchemaObjectCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbSchemaObjectCollection)) {
            return false;
        }

        AddmDbSchemaObjectCollection other = (AddmDbSchemaObjectCollection) o;
