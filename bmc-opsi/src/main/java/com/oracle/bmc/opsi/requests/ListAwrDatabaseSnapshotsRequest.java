...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opsi/ListAwrDatabaseSnapshotsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAwrDatabaseSnapshotsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class ListAwrDatabaseSnapshotsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAwrDatabaseSnapshotsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAwrDatabaseSnapshotsRequest o) {
         ...
         *
         * @return instance of ListAwrDatabaseSnapshotsRequest
         */
        public ListAwrDatabaseSnapshotsRequest build() {
            ListAwrDatabaseSnapshotsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAwrDatabaseSnapshotsRequest
         */
        public ListAwrDatabaseSnapshotsRequest buildWithoutInvocationCallback() {
            ListAwrDatabaseSnapshotsRequest request = new ListAwrDatabaseSnapshotsRequest();
            ...
            return request;
            // new ListAwrDatabaseSnapshotsRequest(awrHubId, awrSourceDatabaseIdentifier, instanceNumber, beginSnapshotIdentifierGreaterThanOrEqualTo, endSnapshotIdentifierLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAwrDatabaseSnapshotsRequest)) {
            return false;
        }

        ListAwrDatabaseSnapshotsRequest other = (ListAwrDatabaseSnapshotsRequest) o;
