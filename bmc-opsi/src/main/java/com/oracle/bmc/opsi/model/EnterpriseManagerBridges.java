...
public class EnterpriseManagerBridges {
    ...
    public static class Builder {
        ...
        public EnterpriseManagerBridges build() {
            EnterpriseManagerBridges __instance__ =
                    new EnterpriseManagerBridges(enterpriseManagerBridges);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnterpriseManagerBridges o) {
            Builder copiedBuilder = enterpriseManagerBridges(o.getEnterpriseManagerBridges());
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("enterpriseManagerBridges")
    Object enterpriseManagerBridges;
