...
/**
 * Summarizes ADDM findings over specified time period <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddmDbFindingAggregationCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddmDbFindingAggregationCollection
    ...
    public AddmDbFindingAggregationCollection(
            java.util.Date timeIntervalStart,
            java.util.Date timeIntervalEnd,
            java.util.List<DatabaseDetails> databaseDetailsItems,
            java.util.List<AddmDbFindingAggregation> items) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<AddmDbFindingAggregation> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AddmDbFindingAggregation> items) {
            this.items = items;
        ...
        public AddmDbFindingAggregationCollection build() {
            AddmDbFindingAggregationCollection model =
                    new AddmDbFindingAggregationCollection(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddmDbFindingAggregationCollection model) {
    ...
    /** List of ADDM finding summaries */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AddmDbFindingAggregation> items;
     ...
     * @return the value
     */
    public java.util.List<AddmDbFindingAggregation> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddmDbFindingAggregationCollection)) {
            return false;
        }

        AddmDbFindingAggregationCollection other = (AddmDbFindingAggregationCollection) o;
