...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EnableEmManagedExternalHostInsightDetails.Builder.class
)
...
public final class EnableEmManagedExternalHostInsightDetails extends EnableHostInsightDetails {
    ...
    @Deprecated
    public EnableEmManagedExternalHostInsightDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableEmManagedExternalHostInsightDetails)) {
            return false;
        }
