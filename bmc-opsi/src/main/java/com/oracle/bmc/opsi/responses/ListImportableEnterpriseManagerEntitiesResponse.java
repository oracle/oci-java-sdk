...
public class ListImportableEnterpriseManagerEntitiesResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListImportableEnterpriseManagerEntitiesResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            importableEnterpriseManagerEntityCollection(
                    o.getImportableEnterpriseManagerEntityCollection());
         ...
         */
        @Override
        public ListImportableEnterpriseManagerEntitiesResponse build() {
            return new ListImportableEnterpriseManagerEntitiesResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
