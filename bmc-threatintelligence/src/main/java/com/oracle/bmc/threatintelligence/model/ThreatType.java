...
/**
 * A threat type along with attribution data that associates it to a threat indicator. <br>
...
public final class ThreatType extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
