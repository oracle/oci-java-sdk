...
public class SummarizeIndicatorsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeIndicatorsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SummarizeIndicatorsResponse> {
         ...
         */
        @Override
        public Builder copy(SummarizeIndicatorsResponse o) {
         ...
         */
        @Override
        public SummarizeIndicatorsResponse build() {
            return new SummarizeIndicatorsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeIndicatorsResponse)) {
            return false;
        }

        SummarizeIndicatorsResponse other = (SummarizeIndicatorsResponse) o;
