...
public final class IndicatorReference extends EntityReference {
    ...
    public static class Builder {
        ...
        public IndicatorReference build() {
            IndicatorReference __instance__ = new IndicatorReference(indicatorId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IndicatorReference o) {
            Builder copiedBuilder = indicatorId(o.getIndicatorId());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.indicatorId, other.indicatorId)
