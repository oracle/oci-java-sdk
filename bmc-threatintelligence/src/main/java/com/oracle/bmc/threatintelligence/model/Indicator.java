 ...
 * Indicators can be plain text or computed (hashed) values. <br>
...
public final class Indicator extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The value for this indicator. The value's format is dependent upon its {@code type}.
         * Examples:
         *
         * <p>DOMAIN_NAME "evil.example.com"
         *
         * <p>MD5_HASH "44d88612fea8a8f36de82e1278abb02f"
         *
         * <p>IP_ADDRESS "2001:db8::1"
         */
        ...
        /**
         * A map of relationships between the indicator and other entities. Each relationship has a
         * name (string), related entity, and attribution (supporting data).
         */
        ...
        /**
         * The date and time that this indicator was last updated. The value is the same as {@code
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("attributes")
    private final java.util.List<IndicatorAttribute> attributes;
     ...
     * @return the value
     */
    public java.util.List<IndicatorAttribute> getAttributes() {
        return attributes;
    }

    /**
     * A map of relationships between the indicator and other entities. Each relationship has a name
     * (string), related entity, and attribution (supporting data).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("relationships")
    private final java.util.List<IndicatorRelationship> relationships;
     ...
     * @return the value
     */
    public java.util.List<IndicatorRelationship> getRelationships() {
