 ...
 * to any list operations of Threatintel where multiple pages of data may be fetched.
...
public class ThreatintelPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listIndicators operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.threatintelligence.model.IndicatorSummary} objects
     * contained in responses from the listIndicators operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.threatintelligence.model.IndicatorSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listThreatTypes operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.threatintelligence.model.ThreatTypeSummary} objects
     * contained in responses from the listThreatTypes operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.threatintelligence.model.ThreatTypeSummary} objects
     * contained in responses received from the service.
     */
