...
public class WorkRequestAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
    ...
    public static class Builder
        ...
        private Builder(com.oracle.bmc.Service service) {
            super(service);
            final String packageName = "workrequests";
    ...
    public java.util.concurrent.Future<GetWorkRequestResponse> getWorkRequest(
        ...
        return clientCall(request, GetWorkRequestResponse::builder)
                ...
                .handleBody(
                        com.oracle.bmc.workrequests.model.WorkRequest.class,
    ...
    public java.util.concurrent.Future<ListWorkRequestErrorsResponse> listWorkRequestErrors(
        ...
        return clientCall(request, ListWorkRequestErrorsResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBodyList(
                        com.oracle.bmc.workrequests.model.WorkRequestError.class,
    ...
    public java.util.concurrent.Future<ListWorkRequestLogsResponse> listWorkRequestLogs(
        ...
        return clientCall(request, ListWorkRequestLogsResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBodyList(
                        com.oracle.bmc.workrequests.model.WorkRequestLogEntry.class,
    ...
    public java.util.concurrent.Future<ListWorkRequestsResponse> listWorkRequests(
        ...
        return clientCall(request, ListWorkRequestsResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBodyList(
                        com.oracle.bmc.workrequests.model.WorkRequestSummary.class,
