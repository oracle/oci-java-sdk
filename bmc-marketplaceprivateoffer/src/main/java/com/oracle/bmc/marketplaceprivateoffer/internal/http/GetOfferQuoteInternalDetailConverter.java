...
public class GetOfferQuoteInternalDetailConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetOfferQuoteInternalDetailConverter.class);

    public static com.oracle.bmc.marketplaceprivateoffer.requests.GetOfferQuoteInternalDetailRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.marketplaceprivateoffer.requests.GetOfferQuoteInternalDetailRequest
                    request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.marketplaceprivateoffer.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.marketplaceprivateoffer.responses.GetOfferQuoteInternalDetailResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.marketplaceprivateoffer.responses
                                                .GetOfferQuoteInternalDetailResponse.Builder
                                        builder =
                                                com.oracle.bmc.marketplaceprivateoffer.responses
                                                        .GetOfferQuoteInternalDetailResponse
                                                        .builder()
                                ...
                                builder.offerQuoteInternalDetail(response.getItem());
