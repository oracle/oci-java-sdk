...
public class OfferWaiters {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetOfferRequest, GetOfferResponse> forOffer(
    ...
    private com.oracle.bmc.waiter.Waiter<GetOfferRequest, GetOfferResponse> forOffer(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetOfferRequest request,
            final com.oracle.bmc.marketplaceprivateoffer.model.Offer.LifecycleState...
                    targetStates) {
        final java.util.Set<com.oracle.bmc.marketplaceprivateoffer.model.Offer.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        () -> request,
                        new java.util.function.Function<GetOfferRequest, GetOfferResponse>() {
                            @Override
                            public GetOfferResponse apply(GetOfferRequest request) {
                                return client.getOffer(request);
                            }
                        },
                        new java.util.function.Predicate<GetOfferResponse>() {
                            @Override
