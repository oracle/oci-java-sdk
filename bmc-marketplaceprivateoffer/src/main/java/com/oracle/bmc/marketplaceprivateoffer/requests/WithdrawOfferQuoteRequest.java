...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplaceprivateoffer/WithdrawOfferQuoteExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use WithdrawOfferQuoteRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class WithdrawOfferQuoteRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    WithdrawOfferQuoteRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(WithdrawOfferQuoteRequest o) {
        ...
        /**
         * Build the instance of WithdrawOfferQuoteRequest as configured by this builder
         *
         ...
         *
         * @return instance of WithdrawOfferQuoteRequest
         */
        public WithdrawOfferQuoteRequest build() {
            WithdrawOfferQuoteRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of WithdrawOfferQuoteRequest
         */
        public WithdrawOfferQuoteRequest buildWithoutInvocationCallback() {
            WithdrawOfferQuoteRequest request = new WithdrawOfferQuoteRequest();
            ...
            return request;
            // new WithdrawOfferQuoteRequest(offerQuoteId, resellerCompartmentId, isvCompartmentId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WithdrawOfferQuoteRequest)) {
            return false;
        }

        WithdrawOfferQuoteRequest other = (WithdrawOfferQuoteRequest) o;
