...
public class WithdrawOfferResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<WithdrawOfferResponse> {
         ...
         */
        @Override
        public Builder copy(WithdrawOfferResponse o) {
         ...
         */
        @Override
        public WithdrawOfferResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WithdrawOfferResponse)) {
            return false;
        }

        WithdrawOfferResponse other = (WithdrawOfferResponse) o;
