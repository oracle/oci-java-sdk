...
public class AttachmentPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.marketplaceprivateoffer.model.AttachmentSummary} objects
     * contained in responses from the listAttachments operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.marketplaceprivateoffer.model.AttachmentSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.marketplaceprivateoffer.model.AttachmentSummary>
