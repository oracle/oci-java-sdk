...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplaceprivateoffer/ListOffersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOffersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class ListOffersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.marketplaceprivateoffer.model.Offer.LifecycleState lifecycleState;

    /**
     * A filter to return only resources their lifecycleState matches the given lifecycleState.
     */
    public com.oracle.bmc.marketplaceprivateoffer.model.Offer.LifecycleState getLifecycleState() {
     ...
     */
    private com.oracle.bmc.marketplaceprivateoffer.model.SortOrder sortOrder;

    /**
     * The sort order to use, either 'ASC' or 'DESC'.
     */
    public com.oracle.bmc.marketplaceprivateoffer.model.SortOrder getSortOrder() {
        return sortOrder;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOffersRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.marketplaceprivateoffer.model.Offer.LifecycleState lifecycleState) {
         ...
         * The sort order to use, either 'ASC' or 'DESC'.
         */
        private com.oracle.bmc.marketplaceprivateoffer.model.SortOrder sortOrder = null;
         ...
         * @return this builder instance
         */
        public Builder sortOrder(com.oracle.bmc.marketplaceprivateoffer.model.SortOrder sortOrder) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOffersRequest o) {
        ...
        /**
         * Build the instance of ListOffersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOffersRequest
         */
        public ListOffersRequest build() {
            ListOffersRequest request = buildWithoutInvocationCallback();
        ...
        public ListOffersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOffersRequest(buyerCompartmentId, sellerCompartmentId, lifecycleState, displayName, id, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOffersRequest)) {
            return false;
        }

        ListOffersRequest other = (ListOffersRequest) o;
