...
public interface QuoteAttachmentAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateQuoteAttachmentResponse> createQuoteAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteQuoteAttachmentResponse> deleteQuoteAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetQuoteAttachmentResponse> getQuoteAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetQuoteAttachmentContentResponse> getQuoteAttachmentContent(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListQuoteAttachmentsResponse> listQuoteAttachments(
