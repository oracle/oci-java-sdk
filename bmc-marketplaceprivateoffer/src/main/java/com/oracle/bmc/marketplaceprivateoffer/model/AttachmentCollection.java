...
public final class AttachmentCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public AttachmentCollection(java.util.List<AttachmentSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<AttachmentSummary> items;
         ...
         * @return this builder
         **/
        public Builder items(java.util.List<AttachmentSummary> items) {
            this.items = items;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AttachmentSummary> items;

    /**
     * List of attachment.
     * @return the value
     **/
    public java.util.List<AttachmentSummary> getItems() {
        return items;
    }
