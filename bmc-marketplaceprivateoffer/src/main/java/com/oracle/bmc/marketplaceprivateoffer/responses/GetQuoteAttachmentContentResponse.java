...
public class GetQuoteAttachmentContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetQuoteAttachmentContentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<
                    GetQuoteAttachmentContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetQuoteAttachmentContentResponse o) {
         ...
         */
        @Override
        public GetQuoteAttachmentContentResponse build() {
            return new GetQuoteAttachmentContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetQuoteAttachmentContentResponse)) {
            return false;
        }

        GetQuoteAttachmentContentResponse other = (GetQuoteAttachmentContentResponse) o;
