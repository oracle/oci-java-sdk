...
/**
 * The information related to the reseller of an offer quote. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ResellerInformation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ResellerInformation
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"primaryContact", "additionalContacts"})
    public ResellerInformation(Contact primaryContact, java.util.List<Contact> additionalContacts) {
        super();
    ...
    public static class Builder {
        ...
        public ResellerInformation build() {
            ResellerInformation model =
                    new ResellerInformation(this.primaryContact, this.additionalContacts);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResellerInformation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResellerInformation)) {
            return false;
        }

        ResellerInformation other = (ResellerInformation) o;
