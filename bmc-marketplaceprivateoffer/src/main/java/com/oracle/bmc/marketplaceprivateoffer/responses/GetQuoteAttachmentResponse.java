...
public class GetQuoteAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetQuoteAttachmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetQuoteAttachmentResponse> {
         ...
         */
        @Override
        public Builder copy(GetQuoteAttachmentResponse o) {
         ...
         */
        @Override
        public GetQuoteAttachmentResponse build() {
            return new GetQuoteAttachmentResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, quoteAttachment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetQuoteAttachmentResponse)) {
            return false;
        }

        GetQuoteAttachmentResponse other = (GetQuoteAttachmentResponse) o;
