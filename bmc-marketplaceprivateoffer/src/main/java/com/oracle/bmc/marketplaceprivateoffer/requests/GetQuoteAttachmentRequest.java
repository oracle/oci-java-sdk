...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/marketplaceprivateoffer/GetQuoteAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetQuoteAttachmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220901")
public class GetQuoteAttachmentRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetQuoteAttachmentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetQuoteAttachmentRequest o) {
        ...
        /**
         * Build the instance of GetQuoteAttachmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetQuoteAttachmentRequest
         */
        public GetQuoteAttachmentRequest build() {
            GetQuoteAttachmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetQuoteAttachmentRequest
         */
        public GetQuoteAttachmentRequest buildWithoutInvocationCallback() {
            GetQuoteAttachmentRequest request = new GetQuoteAttachmentRequest();
            request.offerQuoteId = offerQuoteId;
            request.quoteAttachmentId = quoteAttachmentId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetQuoteAttachmentRequest(offerQuoteId, quoteAttachmentId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetQuoteAttachmentRequest)) {
            return false;
        }

        GetQuoteAttachmentRequest other = (GetQuoteAttachmentRequest) o;
