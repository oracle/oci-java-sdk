...
public class SendOfferResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SendOfferResponse> {
         ...
         */
        @Override
        public Builder copy(SendOfferResponse o) {
         ...
         */
        @Override
        public SendOfferResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SendOfferResponse)) {
            return false;
        }

        SendOfferResponse other = (SendOfferResponse) o;
