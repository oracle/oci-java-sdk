...
/**
 * The information about new offer quotes. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOfferQuoteDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateOfferQuoteDetails
    ...
    public CreateOfferQuoteDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public CreateOfferQuoteDetails build() {
            CreateOfferQuoteDetails model =
                    new CreateOfferQuoteDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOfferQuoteDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOfferQuoteDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOfferQuoteDetails)) {
            return false;
        }

        CreateOfferQuoteDetails other = (CreateOfferQuoteDetails) o;
