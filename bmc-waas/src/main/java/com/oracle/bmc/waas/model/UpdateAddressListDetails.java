...
public final class UpdateAddressListDetails {
    ...
    public static class Builder {
        ...
        public UpdateAddressListDetails build() {
            UpdateAddressListDetails __instance__ =
                    new UpdateAddressListDetails(displayName, addresses, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAddressListDetails o) {
