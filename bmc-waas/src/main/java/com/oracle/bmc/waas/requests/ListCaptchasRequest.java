...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/ListCaptchasExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCaptchasRequest.
 */
...
public class ListCaptchasRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListCaptchasRequest
         */
        public ListCaptchasRequest buildWithoutInvocationCallback() {
            ListCaptchasRequest request = new ListCaptchasRequest();
            request.waasPolicyId = waasPolicyId;
            request.opcRequestId = opcRequestId;
            request.limit = limit;
            request.page = page;
            return request;
            // new ListCaptchasRequest(waasPolicyId, opcRequestId, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCaptchasRequest)) {
            return false;
        }

        ListCaptchasRequest other = (ListCaptchasRequest) o;
