...
public final class CustomProtectionRuleSetting
    ...
    public static class Builder {
        ...
        public CustomProtectionRuleSetting build() {
            CustomProtectionRuleSetting model =
                    new CustomProtectionRuleSetting(this.id, this.action, this.exclusions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomProtectionRuleSetting model) {
