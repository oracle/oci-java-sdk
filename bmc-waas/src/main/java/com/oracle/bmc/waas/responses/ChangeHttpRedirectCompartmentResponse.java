...
public class ChangeHttpRedirectCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeHttpRedirectCompartmentResponse)) {
            return false;
        }

        ChangeHttpRedirectCompartmentResponse other = (ChangeHttpRedirectCompartmentResponse) o;
