...
public interface RedirectAsync extends AutoCloseable {
    ...
    /**
     * Moves HTTP Redirect into a different compartment. When provided, If-Match is checked against
     * ETag values of the WAAS policy.
     *
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateHttpRedirectResponse> createHttpRedirect(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteHttpRedirectResponse> deleteHttpRedirect(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetHttpRedirectResponse> getHttpRedirect(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListHttpRedirectsResponse> listHttpRedirects(
    ...
    /**
     * Updates the details of a HTTP Redirect, including target and tags. Only the fields specified
     * in the request body will be updated; all other properties will remain unchanged.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateHttpRedirectResponse> updateHttpRedirect(
