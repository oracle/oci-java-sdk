...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/ChangeHttpRedirectCompartmentExample.java.html"
...
public class ChangeHttpRedirectCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * @param changeHttpRedirectCompartmentDetails the value to set
         * @return this builder instance
         */
        ...
        public ChangeHttpRedirectCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeHttpRedirectCompartmentRequest(httpRedirectId,
            // changeHttpRedirectCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
