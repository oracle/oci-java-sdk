...
public class ListEdgeSubnetsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.waas.model.EdgeSubnet> items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListEdgeSubnetsResponse)) {
            return false;
        }

        ListEdgeSubnetsResponse other = (ListEdgeSubnetsResponse) o;
