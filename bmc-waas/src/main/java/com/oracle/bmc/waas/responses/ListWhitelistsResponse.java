...
public class ListWhitelistsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListWhitelistsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWhitelistsResponse)) {
            return false;
        }

        ListWhitelistsResponse other = (ListWhitelistsResponse) o;
