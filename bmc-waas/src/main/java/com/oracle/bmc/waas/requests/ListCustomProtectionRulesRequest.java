...
public class ListCustomProtectionRulesRequest
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Filter custom protection rules using a list of custom protection rule
         * OCIDs.
         *
        ...
        public ListCustomProtectionRulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCustomProtectionRulesRequest(compartmentId, opcRequestId, limit, page,
            // sortBy, sortOrder, id, displayName, lifecycleState, timeCreatedGreaterThanOrEqualTo,
            // timeCreatedLessThan);
        }
    }
