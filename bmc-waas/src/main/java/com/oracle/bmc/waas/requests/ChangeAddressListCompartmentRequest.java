...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/ChangeAddressListCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAddressListCompartmentRequest.
 */
...
public class ChangeAddressListCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeAddressListCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeAddressListCompartmentRequest(addressListId, changeAddressListCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
