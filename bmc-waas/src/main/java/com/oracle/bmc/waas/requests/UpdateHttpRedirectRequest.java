...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/UpdateHttpRedirectExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateHttpRedirectRequest.
 */
...
public class UpdateHttpRedirectRequest
    ...
    public com.oracle.bmc.waas.model.UpdateHttpRedirectDetails getBody$() {
        return updateHttpRedirectDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateHttpRedirectDetails(
                com.oracle.bmc.waas.model.UpdateHttpRedirectDetails updateHttpRedirectDetails) {
        ...
        public Builder copy(UpdateHttpRedirectRequest o) {
            ...
            updateHttpRedirectDetails(o.getUpdateHttpRedirectDetails());
        ...
        public UpdateHttpRedirectRequest build() {
            UpdateHttpRedirectRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.waas.model.UpdateHttpRedirectDetails body) {
            updateHttpRedirectDetails(body);
            return this;
        }
        ...
        public UpdateHttpRedirectRequest buildWithoutInvocationCallback() {
            ...
            request.updateHttpRedirectDetails = updateHttpRedirectDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateHttpRedirectDetails=")
                .append(String.valueOf(this.updateHttpRedirectDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateHttpRedirectRequest other = (UpdateHttpRedirectRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.httpRedirectId, other.httpRedirectId)
                && java.util.Objects.equals(
                        this.updateHttpRedirectDetails, other.updateHttpRedirectDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateHttpRedirectDetails == null
                                ? 43
                                : this.updateHttpRedirectDetails.hashCode());
