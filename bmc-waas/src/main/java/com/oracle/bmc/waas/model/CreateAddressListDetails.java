...
/**
 * The data used to create a new address list of IP addresses and CIDR notations. <br>
...
public final class CreateAddressListDetails
    ...
    public static class Builder {
         ...
         * compartment in which to create the address list.
         */
     ...
     * which to create the address list.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
