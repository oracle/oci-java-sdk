...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/UpdateWafAddressRateLimitingExample.java.html"
...
public class UpdateWafAddressRateLimitingRequest
    ...
    public static class Builder
         ...
         * The address rate limiting settings.
         *
         * @param updateWafAddressRateLimitingDetails the value to set
         * @return this builder instance
         */
        ...
        public UpdateWafAddressRateLimitingRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateWafAddressRateLimitingRequest(waasPolicyId,
            // updateWafAddressRateLimitingDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
