...
public class DeleteCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteCertificateResponse> {
        ...
        public DeleteCertificateResponse build() {
            return new DeleteCertificateResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCertificateResponse)) {
            return false;
        }

        DeleteCertificateResponse other = (DeleteCertificateResponse) o;
