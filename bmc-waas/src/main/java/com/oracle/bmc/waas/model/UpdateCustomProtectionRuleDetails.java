...
/**
 * Updates the configuration details of a custom protection rule. Custom protection rules can only
 * be updated if they are not active in a WAAS policy. **Warning:** Oracle recommends that you avoid
...
public final class UpdateCustomProtectionRuleDetails
    ...
    public static class Builder {
        ...
        public UpdateCustomProtectionRuleDetails build() {
            UpdateCustomProtectionRuleDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateCustomProtectionRuleDetails model) {
