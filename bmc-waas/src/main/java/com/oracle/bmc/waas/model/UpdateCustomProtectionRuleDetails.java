...
public final class UpdateCustomProtectionRuleDetails {
    @Deprecated
    ...
    public UpdateCustomProtectionRuleDetails(
            String displayName,
            String description,
            String template,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCustomProtectionRuleDetails)) {
            return false;
        }

        UpdateCustomProtectionRuleDetails other = (UpdateCustomProtectionRuleDetails) o;
