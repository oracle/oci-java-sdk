 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListProtectionRulesRequest.
 */
...
public class ListProtectionRulesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListProtectionRulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListProtectionRulesRequest(waasPolicyId, opcRequestId, limit, page,
            // modSecurityRuleId, action);
        }
    }
