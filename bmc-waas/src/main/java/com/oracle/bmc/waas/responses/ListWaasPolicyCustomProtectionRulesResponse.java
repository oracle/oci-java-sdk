...
public class ListWaasPolicyCustomProtectionRulesResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.waas.model.WaasPolicyCustomProtectionRuleSummary>
            getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.waas.model.WaasPolicyCustomProtectionRuleSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWaasPolicyCustomProtectionRulesResponse)) {
            return false;
        }

        ListWaasPolicyCustomProtectionRulesResponse other =
                (ListWaasPolicyCustomProtectionRulesResponse) o;
