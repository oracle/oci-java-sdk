...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/ListWaasPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWaasPoliciesRequest.
 */
...
public class ListWaasPoliciesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListWaasPoliciesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWaasPoliciesRequest(compartmentId, opcRequestId, limit, page, sortBy, sortOrder, id, displayName, lifecycleState, timeCreatedGreaterThanOrEqualTo, timeCreatedLessThan);
        }
    }
