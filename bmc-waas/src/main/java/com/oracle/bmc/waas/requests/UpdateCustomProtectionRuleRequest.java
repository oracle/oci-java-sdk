...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/UpdateCustomProtectionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCustomProtectionRuleRequest.
 */
...
public class UpdateCustomProtectionRuleRequest
    ...
    public static class Builder
        ...
        public UpdateCustomProtectionRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCustomProtectionRuleRequest(customProtectionRuleId, updateCustomProtectionRuleDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
