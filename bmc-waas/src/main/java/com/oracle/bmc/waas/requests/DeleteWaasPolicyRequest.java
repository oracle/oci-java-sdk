...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/DeleteWaasPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteWaasPolicyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181116")
public class DeleteWaasPolicyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteWaasPolicyRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteWaasPolicyRequest o) {
         ...
         *
         * @return instance of DeleteWaasPolicyRequest
         */
        public DeleteWaasPolicyRequest build() {
            DeleteWaasPolicyRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteWaasPolicyRequest buildWithoutInvocationCallback() {
            DeleteWaasPolicyRequest request = new DeleteWaasPolicyRequest();
            request.waasPolicyId = waasPolicyId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteWaasPolicyRequest(waasPolicyId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteWaasPolicyRequest)) {
            return false;
        }

        DeleteWaasPolicyRequest other = (DeleteWaasPolicyRequest) o;
