...
public final class CreateCustomProtectionRuleDetails
    ...
    public static class Builder {
         ...
         *
         * <p><p><p><p>The example contains two }SecRules{@code each having distinct regex
         * expression to match the }Cookie header value during the second input analysis phase.
         *
     ...
     *
     * <p><p><p><p>The example contains two }SecRules{@code each having distinct regex expression to
