 ...
 * Rules](https://docs.oracle.com/iaas/Content/WAF/Tasks/customprotectionrules.htm). **Warning:**
 * Oracle recommends that you avoid using any confidential information when you supply string values
 * using the API. <br>
