...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/DeleteHttpRedirectExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteHttpRedirectRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20181116")
public class DeleteHttpRedirectRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteHttpRedirectRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteHttpRedirectRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteHttpRedirectRequest
         */
        public DeleteHttpRedirectRequest build() {
            DeleteHttpRedirectRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteHttpRedirectRequest buildWithoutInvocationCallback() {
            DeleteHttpRedirectRequest request = new DeleteHttpRedirectRequest();
            request.httpRedirectId = httpRedirectId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteHttpRedirectRequest(httpRedirectId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteHttpRedirectRequest)) {
            return false;
        }

        DeleteHttpRedirectRequest other = (DeleteHttpRedirectRequest) o;
