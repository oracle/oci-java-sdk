...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/DeleteCustomProtectionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCustomProtectionRuleRequest.
 */
...
public class DeleteCustomProtectionRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteCustomProtectionRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteCustomProtectionRuleRequest o) {
         ...
         *
         * @return instance of DeleteCustomProtectionRuleRequest
         */
        public DeleteCustomProtectionRuleRequest build() {
            DeleteCustomProtectionRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteCustomProtectionRuleRequest
         */
        public DeleteCustomProtectionRuleRequest buildWithoutInvocationCallback() {
            DeleteCustomProtectionRuleRequest request = new DeleteCustomProtectionRuleRequest();
            request.customProtectionRuleId = customProtectionRuleId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteCustomProtectionRuleRequest(customProtectionRuleId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCustomProtectionRuleRequest)) {
            return false;
        }

        DeleteCustomProtectionRuleRequest other = (DeleteCustomProtectionRuleRequest) o;
