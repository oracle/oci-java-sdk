 ...
 * {@code WorkRequest} objects provide visibility for in-progress work flows. For more information
 * about work requests, see [Viewing the State of a Work
...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * The date and time the work request moved from the {@code ACCEPTED} state to the {@code
