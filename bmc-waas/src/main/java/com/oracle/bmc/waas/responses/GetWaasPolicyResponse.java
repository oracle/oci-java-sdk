...
public class GetWaasPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public Builder waasPolicy(com.oracle.bmc.waas.model.WaasPolicy waasPolicy) {
            this.waasPolicy = waasPolicy;
            return this;
        }
        ...
        public Builder copy(GetWaasPolicyResponse o) {
            ...
            waasPolicy(o.getWaasPolicy());

            return this;
        }

        public GetWaasPolicyResponse build() {
            return new GetWaasPolicyResponse(__httpStatusCode__, etag, opcRequestId, waasPolicy);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",waasPolicy=").append(String.valueOf(waasPolicy));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetWaasPolicyResponse)) {
            return false;
        }

        GetWaasPolicyResponse other = (GetWaasPolicyResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.waasPolicy, other.waasPolicy);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.waasPolicy == null ? 43 : this.waasPolicy.hashCode());
        return result;
    }
}
