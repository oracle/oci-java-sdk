...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/waas/ListWafTrafficExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWafTrafficRequest.
 */
...
public class ListWafTrafficRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListWafTrafficRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListWafTrafficRequest o) {
         ...
         */
        public ListWafTrafficRequest build() {
            ListWafTrafficRequest request = buildWithoutInvocationCallback();
        ...
        public ListWafTrafficRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListWafTrafficRequest(waasPolicyId, opcRequestId,
            // timeObservedGreaterThanOrEqualTo, timeObservedLessThan, limit, page);
        }
    }
