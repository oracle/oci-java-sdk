...
public class UpdateWaasPolicyCustomProtectionRulesResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateWaasPolicyCustomProtectionRulesResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWaasPolicyCustomProtectionRulesResponse)) {
            return false;
        }

        UpdateWaasPolicyCustomProtectionRulesResponse other =
                (UpdateWaasPolicyCustomProtectionRulesResponse) o;
