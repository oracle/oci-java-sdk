...
/**
 * Details to enable Stack Monitoring on the external database. <br>
...
public final class EnableExternalDatabaseStackMonitoringDetailsBase
    ...
    public static class Builder {
        ...
        public EnableExternalDatabaseStackMonitoringDetailsBase build() {
            EnableExternalDatabaseStackMonitoringDetailsBase model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalDatabaseStackMonitoringDetailsBase model) {
