...
public class CompleteExternalBackupJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CompleteExternalBackupJobResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CompleteExternalBackupJobResponse o) {
         ...
         */
        public CompleteExternalBackupJobResponse build() {
            return new CompleteExternalBackupJobResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompleteExternalBackupJobResponse)) {
            return false;
        }

        CompleteExternalBackupJobResponse other = (CompleteExternalBackupJobResponse) o;
