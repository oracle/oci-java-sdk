...
public class GetCloudExadataInfrastructureUnallocatedResourcesResponse
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder cloudExadataInfrastructureUnallocatedResources(
                com.oracle.bmc.database.model.CloudExadataInfrastructureUnallocatedResources
                        cloudExadataInfrastructureUnallocatedResources) {
            this.cloudExadataInfrastructureUnallocatedResources =
                    cloudExadataInfrastructureUnallocatedResources;
        ...
        public Builder copy(GetCloudExadataInfrastructureUnallocatedResourcesResponse o) {
            ...
            cloudExadataInfrastructureUnallocatedResources(
                    o.getCloudExadataInfrastructureUnallocatedResources());
    ...
    public String toString() {
        ...
        sb.append(",cloudExadataInfrastructureUnallocatedResources=")
                .append(String.valueOf(cloudExadataInfrastructureUnallocatedResources));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCloudExadataInfrastructureUnallocatedResourcesResponse)) {
            return false;
        }

        GetCloudExadataInfrastructureUnallocatedResourcesResponse other =
                (GetCloudExadataInfrastructureUnallocatedResourcesResponse) o;
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.cloudExadataInfrastructureUnallocatedResources == null
                                ? 43
                                : this.cloudExadataInfrastructureUnallocatedResources.hashCode());
        return result;
    }
}
