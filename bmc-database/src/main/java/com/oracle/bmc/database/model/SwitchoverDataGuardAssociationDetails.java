...
/**
 * The Data Guard association switchover parameters. <br>
...
public final class SwitchoverDataGuardAssociationDetails
    ...
    public SwitchoverDataGuardAssociationDetails(String databaseAdminPassword) {
        super();
    ...
    public static class Builder {
        ...
        public SwitchoverDataGuardAssociationDetails build() {
            SwitchoverDataGuardAssociationDetails model =
                    new SwitchoverDataGuardAssociationDetails(this.databaseAdminPassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchoverDataGuardAssociationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverDataGuardAssociationDetails)) {
            return false;
        }

        SwitchoverDataGuardAssociationDetails other = (SwitchoverDataGuardAssociationDetails) o;
