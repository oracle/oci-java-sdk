...
public class ListVmClusterPatchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListVmClusterPatchesResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListVmClusterPatchesResponse> {
         ...
         */
        @Override
        public ListVmClusterPatchesResponse build() {
            return new ListVmClusterPatchesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVmClusterPatchesResponse)) {
            return false;
        }

        ListVmClusterPatchesResponse other = (ListVmClusterPatchesResponse) o;
