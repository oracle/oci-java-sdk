...
public class ListDbSystemPatchHistoryEntriesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListDbSystemPatchHistoryEntriesResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListDbSystemPatchHistoryEntriesResponse o) {
        ...
        public ListDbSystemPatchHistoryEntriesResponse build() {
            return new ListDbSystemPatchHistoryEntriesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemPatchHistoryEntriesResponse)) {
            return false;
        }

        ListDbSystemPatchHistoryEntriesResponse other = (ListDbSystemPatchHistoryEntriesResponse) o;
