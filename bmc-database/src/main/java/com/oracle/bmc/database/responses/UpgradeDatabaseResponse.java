...
public class UpgradeDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpgradeDatabaseResponse> {
         ...
         */
        @Override
        public Builder copy(UpgradeDatabaseResponse o) {
         ...
         */
        @Override
        public UpgradeDatabaseResponse build() {
            return new UpgradeDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpgradeDatabaseResponse)) {
            return false;
        }

        UpgradeDatabaseResponse other = (UpgradeDatabaseResponse) o;
