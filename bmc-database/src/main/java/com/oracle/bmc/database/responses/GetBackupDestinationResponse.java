...
public class GetBackupDestinationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBackupDestinationResponse> {
        ...
        public GetBackupDestinationResponse build() {
            return new GetBackupDestinationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBackupDestinationResponse)) {
            return false;
        }

        GetBackupDestinationResponse other = (GetBackupDestinationResponse) o;
