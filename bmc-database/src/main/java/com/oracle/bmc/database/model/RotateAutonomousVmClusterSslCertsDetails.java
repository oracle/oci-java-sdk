...
/**
 * Details for configuring the ORDS certificates on Autonomous Exadata VM Cluster <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RotateAutonomousVmClusterSslCertsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RotateAutonomousVmClusterSslCertsDetails
    ...
    public RotateAutonomousVmClusterSslCertsDetails(
    ...
    public static class Builder {
        ...
        public RotateAutonomousVmClusterSslCertsDetails build() {
            RotateAutonomousVmClusterSslCertsDetails model =
                    new RotateAutonomousVmClusterSslCertsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RotateAutonomousVmClusterSslCertsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateAutonomousVmClusterSslCertsDetails)) {
            return false;
        }

        RotateAutonomousVmClusterSslCertsDetails other =
                (RotateAutonomousVmClusterSslCertsDetails) o;
