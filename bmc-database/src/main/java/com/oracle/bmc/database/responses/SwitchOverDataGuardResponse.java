...
public class SwitchOverDataGuardResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SwitchOverDataGuardResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SwitchOverDataGuardResponse> {
         ...
         */
        @Override
        public Builder copy(SwitchOverDataGuardResponse o) {
         ...
         */
        @Override
        public SwitchOverDataGuardResponse build() {
            return new SwitchOverDataGuardResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchOverDataGuardResponse)) {
            return false;
        }

        SwitchOverDataGuardResponse other = (SwitchOverDataGuardResponse) o;
