...
public class StartPluggableDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StartPluggableDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(StartPluggableDatabaseResponse o) {
         ...
         */
        @Override
        public StartPluggableDatabaseResponse build() {
            return new StartPluggableDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartPluggableDatabaseResponse)) {
            return false;
        }

        StartPluggableDatabaseResponse other = (StartPluggableDatabaseResponse) o;
