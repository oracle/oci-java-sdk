...
/**
 * Details to enable Database Management on an external database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EnableExternalDatabaseManagementDetailsBase.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class EnableExternalDatabaseManagementDetailsBase
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalDatabaseConnectorId"})
    public EnableExternalDatabaseManagementDetailsBase(String externalDatabaseConnectorId) {
        super();
    ...
    public static class Builder {
        ...
        public EnableExternalDatabaseManagementDetailsBase build() {
            EnableExternalDatabaseManagementDetailsBase model =
                    new EnableExternalDatabaseManagementDetailsBase(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalDatabaseManagementDetailsBase model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EnableExternalDatabaseManagementDetailsBase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalDatabaseManagementDetailsBase)) {
            return false;
        }

        EnableExternalDatabaseManagementDetailsBase other =
                (EnableExternalDatabaseManagementDetailsBase) o;
