...
public final class EnableExternalDatabaseManagementDetailsBase {
    ...
    public static class Builder {
        ...
        public EnableExternalDatabaseManagementDetailsBase build() {
            EnableExternalDatabaseManagementDetailsBase __instance__ =
                    new EnableExternalDatabaseManagementDetailsBase(externalDatabaseConnectorId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalDatabaseManagementDetailsBase o) {
