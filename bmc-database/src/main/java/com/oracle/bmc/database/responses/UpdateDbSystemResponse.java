...
public class UpdateDbSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDbSystemResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDbSystemResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDbSystemResponse)) {
            return false;
        }

        UpdateDbSystemResponse other = (UpdateDbSystemResponse) o;
