...
public class ListMaintenanceRunHistoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.MaintenanceRunHistorySummary> getItems() {
        return items;
    }
    ...
    private ListMaintenanceRunHistoryResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.MaintenanceRunHistorySummary> items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListMaintenanceRunHistoryResponse o) {
         ...
         */
        @Override
        public ListMaintenanceRunHistoryResponse build() {
            return new ListMaintenanceRunHistoryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMaintenanceRunHistoryResponse)) {
            return false;
        }

        ListMaintenanceRunHistoryResponse other = (ListMaintenanceRunHistoryResponse) o;
