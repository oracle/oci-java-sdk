...
public class UpdateExascaleDbStorageVaultResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateExascaleDbStorageVaultResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateExascaleDbStorageVaultResponse o) {
         ...
         */
        @Override
        public UpdateExascaleDbStorageVaultResponse build() {
            return new UpdateExascaleDbStorageVaultResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExascaleDbStorageVaultResponse)) {
            return false;
        }

        UpdateExascaleDbStorageVaultResponse other = (UpdateExascaleDbStorageVaultResponse) o;
