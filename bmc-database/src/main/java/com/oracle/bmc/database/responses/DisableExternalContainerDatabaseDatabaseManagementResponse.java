...
public class DisableExternalContainerDatabaseDatabaseManagementResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalContainerDatabaseDatabaseManagementResponse)) {
            return false;
        }

        DisableExternalContainerDatabaseDatabaseManagementResponse other =
                (DisableExternalContainerDatabaseDatabaseManagementResponse) o;
