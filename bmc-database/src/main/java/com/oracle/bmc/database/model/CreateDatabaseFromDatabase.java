...
/**
 * Details for creating a database by restoring from a database backup closest to given timestamp.
 * This would work only if given timestamp is within the time range of available automatic backups.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDatabaseFromDatabase.Builder.class)
...
public final class CreateDatabaseFromDatabase extends CreateDatabaseBase {
    ...
    public static class Builder {
        ...
        public CreateDatabaseFromDatabase build() {
            CreateDatabaseFromDatabase model =
                    new CreateDatabaseFromDatabase(
                            this.dbHomeId,
                            this.dbVersion,
                            this.kmsKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDatabaseFromDatabase model) {
    ...
    @Deprecated
    public CreateDatabaseFromDatabase(
            String dbHomeId,
            String dbVersion,
            String kmsKeyId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDatabaseFromDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseFromDatabase)) {
            return false;
        }

        CreateDatabaseFromDatabase other = (CreateDatabaseFromDatabase) o;
