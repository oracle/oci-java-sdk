...
public class UpdateDbHomeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDbHomeResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDbHomeResponse)) {
            return false;
        }

        UpdateDbHomeResponse other = (UpdateDbHomeResponse) o;
