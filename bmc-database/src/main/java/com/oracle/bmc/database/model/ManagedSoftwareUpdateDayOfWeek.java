...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedSoftwareUpdateDayOfWeek.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ManagedSoftwareUpdateDayOfWeek
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dayOfWeek"})
    public ManagedSoftwareUpdateDayOfWeek(DayOfWeek dayOfWeek) {
        super();
    ...
    public static class Builder {
        ...
        public ManagedSoftwareUpdateDayOfWeek build() {
            ManagedSoftwareUpdateDayOfWeek model =
                    new ManagedSoftwareUpdateDayOfWeek(this.dayOfWeek);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedSoftwareUpdateDayOfWeek model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedSoftwareUpdateDayOfWeek(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedSoftwareUpdateDayOfWeek)) {
            return false;
        }

        ManagedSoftwareUpdateDayOfWeek other = (ManagedSoftwareUpdateDayOfWeek) o;
        return java.util.Objects.equals(this.dayOfWeek, other.dayOfWeek) && super.equals(other);
    }
