 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBaseccVmClustersRequest.
 */
...
public class ListBaseccVmClustersRequest
    ...
    public static class Builder
        ...
        /**
         * A filter to return only BaseDB-C@C VM clusters that match the given VM Cluster type
         * exactly.
         */
        private com.oracle.bmc.database.model.BaseccVmClusterSummary.VmClusterType vmClusterType =
                null;
        ...
        public ListBaseccVmClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListBaseccVmClustersRequest(compartmentId, baseInfrastructureId, limit, page,
            // sortBy, sortOrder, lifecycleState, availabilityDomain, displayName, opcRequestId,
            // vmClusterType);
        }
    }
