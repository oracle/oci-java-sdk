...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateStandByDatabaseDetails.Builder.class
)
...
public final class CreateStandByDatabaseDetails extends CreateDatabaseBase {
    ...
    public static class Builder {
        ...
        private CreateStandbyDetails database;

        public Builder database(CreateStandbyDetails database) {
        ...
        public CreateStandByDatabaseDetails build() {
            CreateStandByDatabaseDetails model =
                    new CreateStandByDatabaseDetails(
                            this.dbHomeId,
                            this.dbVersion,
                            this.kmsKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateStandByDatabaseDetails model) {
    ...
    @Deprecated
    public CreateStandByDatabaseDetails(
            String dbHomeId,
            String dbVersion,
            String kmsKeyId,
            String kmsKeyVersionId,
            CreateStandbyDetails database) {
        super(dbHomeId, dbVersion, kmsKeyId, kmsKeyVersionId);
        this.database = database;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("database")
    private final CreateStandbyDetails database;

    public CreateStandbyDetails getDatabase() {
        return database;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateStandByDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateStandByDatabaseDetails)) {
            return false;
        }

        CreateStandByDatabaseDetails other = (CreateStandByDatabaseDetails) o;
