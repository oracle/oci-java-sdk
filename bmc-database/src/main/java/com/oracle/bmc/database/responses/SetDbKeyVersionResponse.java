...
public class SetDbKeyVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private SetDbKeyVersionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SetDbKeyVersionResponse> {
         ...
         */
        @Override
        public Builder copy(SetDbKeyVersionResponse o) {
         ...
         */
        @Override
        public SetDbKeyVersionResponse build() {
            return new SetDbKeyVersionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetDbKeyVersionResponse)) {
            return false;
        }

        SetDbKeyVersionResponse other = (SetDbKeyVersionResponse) o;
