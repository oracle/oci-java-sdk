...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousDatabaseDataguardAssociationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousDatabaseDataguardAssociationsRequest.
 */
...
public class ListAutonomousDatabaseDataguardAssociationsRequest
    ...
    public static class Builder
        ...
        public ListAutonomousDatabaseDataguardAssociationsRequest buildWithoutInvocationCallback() {
            ListAutonomousDatabaseDataguardAssociationsRequest request =
                    new ListAutonomousDatabaseDataguardAssociationsRequest();
            request.autonomousDatabaseId = autonomousDatabaseId;
            request.limit = limit;
            request.page = page;
            return request;
            // new ListAutonomousDatabaseDataguardAssociationsRequest(autonomousDatabaseId, limit, page);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().autonomousDatabaseId(autonomousDatabaseId).limit(limit).page(page);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDatabaseDataguardAssociationsRequest)) {
            return false;
        }

        ListAutonomousDatabaseDataguardAssociationsRequest other =
                (ListAutonomousDatabaseDataguardAssociationsRequest) o;
