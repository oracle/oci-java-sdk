...
public class DeleteDbHomeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteDbHomeResponse o) {
         ...
         */
        public DeleteDbHomeResponse build() {
            return new DeleteDbHomeResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDbHomeResponse)) {
            return false;
        }

        DeleteDbHomeResponse other = (DeleteDbHomeResponse) o;
