...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ScheduledAction.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ScheduledAction extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduledAction model) {
    ...
    public boolean equals(Object o) {
        ...
        ScheduledAction other = (ScheduledAction) o;
