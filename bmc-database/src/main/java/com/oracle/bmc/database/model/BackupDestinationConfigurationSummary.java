...
public final class BackupDestinationConfigurationSummary
    ...
    public BackupDestinationConfigurationSummary(
    ...
    public static class Builder {
        ...
        public BackupDestinationConfigurationSummary build() {
            BackupDestinationConfigurationSummary model =
                    new BackupDestinationConfigurationSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BackupDestinationConfigurationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BackupDestinationConfigurationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BackupDestinationConfigurationSummary)) {
            return false;
        }

        BackupDestinationConfigurationSummary other = (BackupDestinationConfigurationSummary) o;
        return java.util.Objects.equals(this.recoveryWindowInDays, other.recoveryWindowInDays)
