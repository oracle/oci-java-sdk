...
/**
 * Details specifying which maintenance update to apply to the BaseDB-C@C VM cluster and which
 * action is to be performed by the maintenance update. Applies to Base Database Service on
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BaseccVmClusterUpdateDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BaseccVmClusterUpdateDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"updateId", "updateAction", "giSoftwareImageId"})
    public BaseccVmClusterUpdateDetails(
    ...
    public static class Builder {
        ...
        public BaseccVmClusterUpdateDetails build() {
            BaseccVmClusterUpdateDetails model =
                    new BaseccVmClusterUpdateDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BaseccVmClusterUpdateDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BaseccVmClusterUpdateDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseccVmClusterUpdateDetails)) {
            return false;
        }

        BaseccVmClusterUpdateDetails other = (BaseccVmClusterUpdateDetails) o;
