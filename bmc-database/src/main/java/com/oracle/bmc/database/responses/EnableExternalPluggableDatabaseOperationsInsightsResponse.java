...
public class EnableExternalPluggableDatabaseOperationsInsightsResponse
    ...
    private EnableExternalPluggableDatabaseOperationsInsightsResponse(
    ...
    public static class Builder {
         ...
         */
        public EnableExternalPluggableDatabaseOperationsInsightsResponse build() {
            return new EnableExternalPluggableDatabaseOperationsInsightsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalPluggableDatabaseOperationsInsightsResponse)) {
            return false;
        }

        EnableExternalPluggableDatabaseOperationsInsightsResponse other =
                (EnableExternalPluggableDatabaseOperationsInsightsResponse) o;
