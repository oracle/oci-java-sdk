...
public class RotateVaultKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RotateVaultKeyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RotateVaultKeyResponse> {
         ...
         */
        @Override
        public Builder copy(RotateVaultKeyResponse o) {
         ...
         */
        @Override
        public RotateVaultKeyResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateVaultKeyResponse)) {
            return false;
        }

        RotateVaultKeyResponse other = (RotateVaultKeyResponse) o;
