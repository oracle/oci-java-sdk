...
public class UnregisterCloudAutonomousVmClusterPkcsResponse
    ...
    private UnregisterCloudAutonomousVmClusterPkcsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UnregisterCloudAutonomousVmClusterPkcsResponse o) {
         ...
         */
        @Override
        public UnregisterCloudAutonomousVmClusterPkcsResponse build() {
            return new UnregisterCloudAutonomousVmClusterPkcsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnregisterCloudAutonomousVmClusterPkcsResponse)) {
            return false;
        }

        UnregisterCloudAutonomousVmClusterPkcsResponse other =
                (UnregisterCloudAutonomousVmClusterPkcsResponse) o;
