...
public class CancelExecutionWindowResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CancelExecutionWindowResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelExecutionWindowResponse> {
         ...
         */
        @Override
        public Builder copy(CancelExecutionWindowResponse o) {
         ...
         */
        @Override
        public CancelExecutionWindowResponse build() {
            return new CancelExecutionWindowResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelExecutionWindowResponse)) {
            return false;
        }

        CancelExecutionWindowResponse other = (CancelExecutionWindowResponse) o;
