...
public class DownloadVmClusterNetworkConfigFileResponse
    ...
    /**
     * The date and time the configuration file was created, as described in [RFC
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadVmClusterNetworkConfigFileResponse)) {
            return false;
        }

        DownloadVmClusterNetworkConfigFileResponse other =
                (DownloadVmClusterNetworkConfigFileResponse) o;
