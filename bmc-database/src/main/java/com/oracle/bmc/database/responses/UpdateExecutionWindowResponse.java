...
public class UpdateExecutionWindowResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateExecutionWindowResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateExecutionWindowResponse> {
         ...
         * @return this builder
         */
        public Builder executionWindow(
                com.oracle.bmc.database.model.ExecutionWindow executionWindow) {
            this.executionWindow = executionWindow;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(UpdateExecutionWindowResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcWorkRequestId(o.getOpcWorkRequestId());
            etag(o.getEtag());
            opcRequestId(o.getOpcRequestId());
            executionWindow(o.getExecutionWindow());
         ...
         */
        @Override
        public UpdateExecutionWindowResponse build() {
            return new UpdateExecutionWindowResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public String toString() {
        ...
        sb.append(",executionWindow=").append(String.valueOf(executionWindow));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExecutionWindowResponse)) {
            return false;
        }

        UpdateExecutionWindowResponse other = (UpdateExecutionWindowResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcWorkRequestId, other.opcWorkRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.executionWindow, other.executionWindow);
    }
