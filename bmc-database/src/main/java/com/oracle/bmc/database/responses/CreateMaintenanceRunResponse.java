...
public class CreateMaintenanceRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateMaintenanceRunResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMaintenanceRunResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMaintenanceRunResponse o) {
         ...
         */
        @Override
        public CreateMaintenanceRunResponse build() {
            return new CreateMaintenanceRunResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMaintenanceRunResponse)) {
            return false;
        }

        CreateMaintenanceRunResponse other = (CreateMaintenanceRunResponse) o;
