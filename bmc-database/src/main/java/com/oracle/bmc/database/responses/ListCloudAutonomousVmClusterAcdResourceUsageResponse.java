...
public class ListCloudAutonomousVmClusterAcdResourceUsageResponse
    ...
    private ListCloudAutonomousVmClusterAcdResourceUsageResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ListCloudAutonomousVmClusterAcdResourceUsageResponse o) {
         ...
         */
        public ListCloudAutonomousVmClusterAcdResourceUsageResponse build() {
            return new ListCloudAutonomousVmClusterAcdResourceUsageResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudAutonomousVmClusterAcdResourceUsageResponse)) {
            return false;
        }

        ListCloudAutonomousVmClusterAcdResourceUsageResponse other =
                (ListCloudAutonomousVmClusterAcdResourceUsageResponse) o;
