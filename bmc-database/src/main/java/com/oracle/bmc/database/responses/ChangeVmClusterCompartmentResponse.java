...
public class ChangeVmClusterCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeVmClusterCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVmClusterCompartmentResponse)) {
            return false;
        }

        ChangeVmClusterCompartmentResponse other = (ChangeVmClusterCompartmentResponse) o;
