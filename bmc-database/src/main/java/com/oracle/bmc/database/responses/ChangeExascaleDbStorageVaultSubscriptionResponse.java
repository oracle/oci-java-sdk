...
public class ChangeExascaleDbStorageVaultSubscriptionResponse
    ...
    private ChangeExascaleDbStorageVaultSubscriptionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeExascaleDbStorageVaultSubscriptionResponse o) {
         ...
         */
        @Override
        public ChangeExascaleDbStorageVaultSubscriptionResponse build() {
            return new ChangeExascaleDbStorageVaultSubscriptionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExascaleDbStorageVaultSubscriptionResponse)) {
            return false;
        }

        ChangeExascaleDbStorageVaultSubscriptionResponse other =
                (ChangeExascaleDbStorageVaultSubscriptionResponse) o;
