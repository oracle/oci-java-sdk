...
/**
 * Details to enable Database Management on an external pluggable database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EnableExternalPluggableDatabaseDatabaseManagementDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class EnableExternalPluggableDatabaseDatabaseManagementDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalDatabaseConnectorId"})
    public EnableExternalPluggableDatabaseDatabaseManagementDetails(
    ...
    public static class Builder {
        ...
        public EnableExternalPluggableDatabaseDatabaseManagementDetails build() {
            EnableExternalPluggableDatabaseDatabaseManagementDetails model =
                    new EnableExternalPluggableDatabaseDatabaseManagementDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalPluggableDatabaseDatabaseManagementDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalPluggableDatabaseDatabaseManagementDetails)) {
            return false;
        }

        EnableExternalPluggableDatabaseDatabaseManagementDetails other =
                (EnableExternalPluggableDatabaseDatabaseManagementDetails) o;
