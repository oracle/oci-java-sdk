...
public class StartAutonomousDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StartAutonomousDatabaseResponse(
    ...
    public static class Builder {
        ...
        public StartAutonomousDatabaseResponse build() {
            return new StartAutonomousDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartAutonomousDatabaseResponse)) {
            return false;
        }

        StartAutonomousDatabaseResponse other = (StartAutonomousDatabaseResponse) o;
