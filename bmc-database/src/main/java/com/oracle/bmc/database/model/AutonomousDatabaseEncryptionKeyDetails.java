...
/**
 * Details of the Autonomous AI Database encryption key. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "provider",
        defaultImpl = AutonomousDatabaseEncryptionKeyDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = OkvKeyDetails.class, name = "OKV"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = AzureKeyDetails.class,
            name = "AZURE"),
...
public class AutonomousDatabaseEncryptionKeyDetails
    ...
    protected AutonomousDatabaseEncryptionKeyDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousDatabaseEncryptionKeyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousDatabaseEncryptionKeyDetails)) {
            return false;
        }

        AutonomousDatabaseEncryptionKeyDetails other = (AutonomousDatabaseEncryptionKeyDetails) o;
