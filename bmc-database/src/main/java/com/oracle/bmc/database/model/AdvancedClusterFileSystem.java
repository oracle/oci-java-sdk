...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AdvancedClusterFileSystem.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AdvancedClusterFileSystem
    ...
    public AdvancedClusterFileSystem(
            String id,
            String name,
    ...
    public static class Builder {
         ...
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("isMounted")
        private Boolean isMounted;

        /**
         * True if the file system is mounted on all VMs within VM Cluster.
         * @param isMounted the value to set
         * @return this builder
         **/
        public Builder isMounted(Boolean isMounted) {
            this.isMounted = isMounted;
            this.__explicitlySet__.add("isMounted");
            return this;
        }
        /**
        ...
        public AdvancedClusterFileSystem build() {
            AdvancedClusterFileSystem model =
                    new AdvancedClusterFileSystem(
                            this.id,
                            this.name,
                            this.compartmentId,
                            this.vmClusterId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdvancedClusterFileSystem model) {
            ...
            if (model.wasPropertyExplicitlySet("isMounted")) {
                this.isMounted(model.getIsMounted());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdvancedClusterFileSystem(");
        ...
        sb.append(", isMounted=").append(String.valueOf(this.isMounted));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvancedClusterFileSystem)) {
            return false;
        }

        AdvancedClusterFileSystem other = (AdvancedClusterFileSystem) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.isMounted, other.isMounted)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.isMounted == null ? 43 : this.isMounted.hashCode());
