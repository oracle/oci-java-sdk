...
public class CreateDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDatabaseResponse> {
         ...
         */
        @Override
        public Builder copy(CreateDatabaseResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseResponse)) {
            return false;
        }

        CreateDatabaseResponse other = (CreateDatabaseResponse) o;
