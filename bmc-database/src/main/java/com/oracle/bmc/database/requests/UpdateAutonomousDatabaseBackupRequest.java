...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateAutonomousDatabaseBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAutonomousDatabaseBackupRequest.
 */
...
public class UpdateAutonomousDatabaseBackupRequest
    ...
    public static class Builder
        ...
        public UpdateAutonomousDatabaseBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAutonomousDatabaseBackupRequest(autonomousDatabaseBackupId, updateAutonomousDatabaseBackupDetails, ifMatch, opcRequestId);
        }
    }
