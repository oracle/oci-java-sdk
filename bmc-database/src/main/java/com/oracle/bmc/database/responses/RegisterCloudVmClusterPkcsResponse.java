...
public class RegisterCloudVmClusterPkcsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RegisterCloudVmClusterPkcsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RegisterCloudVmClusterPkcsResponse o) {
         ...
         */
        @Override
        public RegisterCloudVmClusterPkcsResponse build() {
            return new RegisterCloudVmClusterPkcsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisterCloudVmClusterPkcsResponse)) {
            return false;
        }

        RegisterCloudVmClusterPkcsResponse other = (RegisterCloudVmClusterPkcsResponse) o;
