...
public class CreateAutonomousDatabaseSoftwareImageResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousDatabaseSoftwareImageResponse)) {
            return false;
        }

        CreateAutonomousDatabaseSoftwareImageResponse other =
                (CreateAutonomousDatabaseSoftwareImageResponse) o;
