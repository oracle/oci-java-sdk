...
public class AddStorageCapacityCloudExadataInfrastructureResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddStorageCapacityCloudExadataInfrastructureResponse)) {
            return false;
        }

        AddStorageCapacityCloudExadataInfrastructureResponse other =
                (AddStorageCapacityCloudExadataInfrastructureResponse) o;
