...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ExternalContainerDatabase.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ExternalContainerDatabase {
    @Deprecated
    ...
    public ExternalContainerDatabase(
    ...
    public static class Builder {
        ...
        public ExternalContainerDatabase build() {
            ExternalContainerDatabase __instance__ =
                    new ExternalContainerDatabase(
                            compartmentId,
                            freeformTags,
                            definedTags,
                            displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalContainerDatabase o) {
    ...
    public String toString() {
        ...
        sb.append("ExternalContainerDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalContainerDatabase)) {
            return false;
        }

        ExternalContainerDatabase other = (ExternalContainerDatabase) o;
