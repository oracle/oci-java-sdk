...
public class UpdateExternalPluggableDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalPluggableDatabaseResponse)) {
            return false;
        }

        UpdateExternalPluggableDatabaseResponse other = (UpdateExternalPluggableDatabaseResponse) o;
