...
public class CreateExadbVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateExadbVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateExadbVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(CreateExadbVmClusterResponse o) {
         ...
         */
        @Override
        public CreateExadbVmClusterResponse build() {
            return new CreateExadbVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExadbVmClusterResponse)) {
            return false;
        }

        CreateExadbVmClusterResponse other = (CreateExadbVmClusterResponse) o;
