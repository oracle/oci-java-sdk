...
public class ConfigureExascaleCloudExadataInfrastructureResponse
    ...
    private ConfigureExascaleCloudExadataInfrastructureResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ConfigureExascaleCloudExadataInfrastructureResponse o) {
         ...
         */
        @Override
        public ConfigureExascaleCloudExadataInfrastructureResponse build() {
            return new ConfigureExascaleCloudExadataInfrastructureResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureExascaleCloudExadataInfrastructureResponse)) {
            return false;
        }

        ConfigureExascaleCloudExadataInfrastructureResponse other =
                (ConfigureExascaleCloudExadataInfrastructureResponse) o;
