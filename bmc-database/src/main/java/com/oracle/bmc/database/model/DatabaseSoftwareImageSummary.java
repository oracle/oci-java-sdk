...
/**
 * The Database service supports the creation of database software images for use in creating and
 * patching DB systems and databases.
 *
...
public final class DatabaseSoftwareImageSummary
    ...
    public static class Builder {
        ...
        public DatabaseSoftwareImageSummary build() {
            DatabaseSoftwareImageSummary model =
