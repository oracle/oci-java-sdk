...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateSchedulingWindowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSchedulingWindowRequest.
 */
...
public class UpdateSchedulingWindowRequest
    ...
    public static class Builder
        ...
        public UpdateSchedulingWindowRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSchedulingWindowRequest(schedulingPolicyId, schedulingWindowId, updateSchedulingWindowDetails, ifMatch, opcRequestId);
        }
    }
