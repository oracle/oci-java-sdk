...
/**
 * Details of removing Virtual Machines from the VM Cluster. Applies to Exadata Cloud@Customer
 * instances only. <br>
...
public final class RemoveVirtualMachineFromVmClusterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dbServers"})
    public RemoveVirtualMachineFromVmClusterDetails(java.util.List<DbServerDetails> dbServers) {
        super();
    ...
    public static class Builder {
        ...
        public RemoveVirtualMachineFromVmClusterDetails build() {
            RemoveVirtualMachineFromVmClusterDetails model =
                    new RemoveVirtualMachineFromVmClusterDetails(this.dbServers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveVirtualMachineFromVmClusterDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveVirtualMachineFromVmClusterDetails)) {
            return false;
        }

        RemoveVirtualMachineFromVmClusterDetails other =
                (RemoveVirtualMachineFromVmClusterDetails) o;
