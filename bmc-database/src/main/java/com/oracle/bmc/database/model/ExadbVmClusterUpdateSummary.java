...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadbVmClusterUpdateSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExadbVmClusterUpdateSummary
    ...
    public ExadbVmClusterUpdateSummary(
            String id,
            String description,
    ...
    public static class Builder {
        ...
        public ExadbVmClusterUpdateSummary build() {
            ExadbVmClusterUpdateSummary model =
                    new ExadbVmClusterUpdateSummary(
                            this.id,
                            this.description,
                            this.lastAction,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadbVmClusterUpdateSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadbVmClusterUpdateSummary)) {
            return false;
        }

        ExadbVmClusterUpdateSummary other = (ExadbVmClusterUpdateSummary) o;
