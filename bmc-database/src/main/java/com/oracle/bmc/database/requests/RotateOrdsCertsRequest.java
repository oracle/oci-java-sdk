...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/RotateOrdsCertsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RotateOrdsCertsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class RotateOrdsCertsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RotateOrdsCertsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RotateOrdsCertsRequest o) {
        ...
        /**
         * Build the instance of RotateOrdsCertsRequest as configured by this builder
         *
         ...
         *
         * @return instance of RotateOrdsCertsRequest
         */
        public RotateOrdsCertsRequest build() {
            RotateOrdsCertsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RotateOrdsCertsRequest
         */
        public RotateOrdsCertsRequest buildWithoutInvocationCallback() {
            RotateOrdsCertsRequest request = new RotateOrdsCertsRequest();
            request.autonomousExadataInfrastructureId = autonomousExadataInfrastructureId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new RotateOrdsCertsRequest(autonomousExadataInfrastructureId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateOrdsCertsRequest)) {
            return false;
        }

        RotateOrdsCertsRequest other = (RotateOrdsCertsRequest) o;
