...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DbNodeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DbNodeDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dbNodeId"})
    public DbNodeDetails(String dbNodeId) {
        super();
    ...
    public static class Builder {
        ...
        public DbNodeDetails build() {
            DbNodeDetails model = new DbNodeDetails(this.dbNodeId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbNodeDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbNodeDetails)) {
            return false;
        }

        DbNodeDetails other = (DbNodeDetails) o;
