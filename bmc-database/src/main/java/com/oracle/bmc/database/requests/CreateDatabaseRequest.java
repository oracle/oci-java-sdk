...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/CreateDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateDatabaseRequest.
 */
...
@lombok.Getter
public class CreateDatabaseRequest extends com.oracle.bmc.requests.BmcRequest<CreateDatabaseBase> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateDatabaseRequest, CreateDatabaseBase> {
