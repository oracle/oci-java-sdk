...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListPluggableDatabaseSnapshotsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPluggableDatabaseSnapshotsRequest.
 */
...
public class ListPluggableDatabaseSnapshotsRequest
    ...
    public static class Builder
        ...
        public ListPluggableDatabaseSnapshotsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPluggableDatabaseSnapshotsRequest(compartmentId, limit, page, sortBy, name, sortOrder, lifecycleState, clusterId, pluggableDatabaseId, opcRequestId);
        }
    }
