...
public class ListPluggableDatabaseSnapshotsRequest
    ...
    /**
     * A filter to return only Exadata Pluggable Database Snapshots that match the given lifecycle
     * state exactly.
     */
    private com.oracle.bmc.database.model.PluggableDatabaseSnapshot.LifecycleState lifecycleState;

    /**
     * A filter to return only Exadata Pluggable Database Snapshots that match the given lifecycle
     * state exactly.
     */
    public com.oracle.bmc.database.model.PluggableDatabaseSnapshot.LifecycleState
            getLifecycleState() {
    ...
    /**
     * A filter to return only Exadata Pluggable Database Snapshots that match the given database
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
     */
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListPluggableDatabaseSnapshotsRequest, java.lang.Void> {
        ...
        /**
         * A filter to return only Exadata Pluggable Database Snapshots that match the given
         * lifecycle state exactly.
         */
        private com.oracle.bmc.database.model.PluggableDatabaseSnapshot.LifecycleState
                lifecycleState = null;
        ...
        /**
         * A filter to return only Exadata Pluggable Database Snapshots that match the given
         * database [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
         */
         ...
         * @return this builder instance
         */
        public Builder copy(ListPluggableDatabaseSnapshotsRequest o) {
        ...
        /**
         * Build the instance of ListPluggableDatabaseSnapshotsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListPluggableDatabaseSnapshotsRequest
         */
        public ListPluggableDatabaseSnapshotsRequest build() {
            ListPluggableDatabaseSnapshotsRequest request = buildWithoutInvocationCallback();
        ...
        public ListPluggableDatabaseSnapshotsRequest buildWithoutInvocationCallback() {
            ListPluggableDatabaseSnapshotsRequest request =
                    new ListPluggableDatabaseSnapshotsRequest();
            ...
            return request;
            // new ListPluggableDatabaseSnapshotsRequest(compartmentId, limit, page, sortBy, name,
            // sortOrder, lifecycleState, clusterId, pluggableDatabaseId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPluggableDatabaseSnapshotsRequest)) {
            return false;
        }

        ListPluggableDatabaseSnapshotsRequest other = (ListPluggableDatabaseSnapshotsRequest) o;
