...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/AutonomousDatabaseManualRefreshExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AutonomousDatabaseManualRefreshRequest.
 */
...
public class AutonomousDatabaseManualRefreshRequest
    ...
    public static class Builder
        ...
        public AutonomousDatabaseManualRefreshRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AutonomousDatabaseManualRefreshRequest(autonomousDatabaseId, autonomousDatabaseManualRefreshDetails, ifMatch, opcRetryToken, opcRequestId, opcDryRun);
        }
    }
