...
public class ListOneoffPatchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.OneoffPatchSummary> getItems() {
        return items;
    }
    ...
    private ListOneoffPatchesResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.OneoffPatchSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListOneoffPatchesResponse> {
         ...
         */
        @Override
        public Builder copy(ListOneoffPatchesResponse o) {
         ...
         */
        @Override
        public ListOneoffPatchesResponse build() {
            return new ListOneoffPatchesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOneoffPatchesResponse)) {
            return false;
        }

        ListOneoffPatchesResponse other = (ListOneoffPatchesResponse) o;
