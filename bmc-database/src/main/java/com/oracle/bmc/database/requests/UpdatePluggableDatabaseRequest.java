...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdatePluggableDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePluggableDatabaseRequest.
 */
...
public class UpdatePluggableDatabaseRequest
        extends com.oracle.bmc.requests.BmcRequest<UpdatePluggableDatabaseDetails> {
    ...
    public UpdatePluggableDatabaseDetails getBody$() {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(UpdatePluggableDatabaseDetails body) {
