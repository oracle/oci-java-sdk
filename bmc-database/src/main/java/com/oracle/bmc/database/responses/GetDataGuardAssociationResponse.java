...
public class GetDataGuardAssociationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public GetDataGuardAssociationResponse build() {
            return new GetDataGuardAssociationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, dataGuardAssociation);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDataGuardAssociationResponse)) {
            return false;
        }

        GetDataGuardAssociationResponse other = (GetDataGuardAssociationResponse) o;
