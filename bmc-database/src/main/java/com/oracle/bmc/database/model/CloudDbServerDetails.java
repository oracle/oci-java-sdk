...
/**
 * Details of the ExaDB-D DB server. Applies to Exadata Cloud instances only. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudDbServerDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudDbServerDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dbServerId"})
    public CloudDbServerDetails(String dbServerId) {
        super();
    ...
    public static class Builder {
        ...
        public CloudDbServerDetails build() {
            CloudDbServerDetails model = new CloudDbServerDetails(this.dbServerId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudDbServerDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudDbServerDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbServerDetails)) {
            return false;
        }

        CloudDbServerDetails other = (CloudDbServerDetails) o;
