...
public class DeleteGiHomeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteGiHomeResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteGiHomeResponse o) {
         ...
         */
        @Override
        public DeleteGiHomeResponse build() {
            return new DeleteGiHomeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteGiHomeResponse)) {
            return false;
        }

        DeleteGiHomeResponse other = (DeleteGiHomeResponse) o;
