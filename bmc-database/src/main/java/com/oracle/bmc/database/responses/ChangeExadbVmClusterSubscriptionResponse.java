...
public class ChangeExadbVmClusterSubscriptionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeExadbVmClusterSubscriptionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeExadbVmClusterSubscriptionResponse o) {
         ...
         */
        @Override
        public ChangeExadbVmClusterSubscriptionResponse build() {
            return new ChangeExadbVmClusterSubscriptionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExadbVmClusterSubscriptionResponse)) {
            return false;
        }

        ChangeExadbVmClusterSubscriptionResponse other =
                (ChangeExadbVmClusterSubscriptionResponse) o;
