...
public class CreateDataGuardAssociationDetails
    ...
    /**
     * A strong password for the {@code SYS}, {@code SYSTEM}, and {@code PDB Admin} users to apply
     ...
     *
     * <p>*IMPORTANT** - The only protection mode currently supported by the Database service is
     * MAXIMUM_PERFORMANCE.
     */
