...
public class ResizeVmClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ResizeVmClusterNetworkResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ResizeVmClusterNetworkResponse o) {
         ...
         */
        public ResizeVmClusterNetworkResponse build() {
            return new ResizeVmClusterNetworkResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResizeVmClusterNetworkResponse)) {
            return false;
        }

        ResizeVmClusterNetworkResponse other = (ResizeVmClusterNetworkResponse) o;
