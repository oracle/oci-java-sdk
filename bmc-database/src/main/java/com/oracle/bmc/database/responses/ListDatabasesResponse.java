...
public class ListDatabasesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.database.model.DatabaseSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DatabaseSummary> getItems() {
        return items;
    }
    ...
    private ListDatabasesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.DatabaseSummary> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.database.model.DatabaseSummary> items) {
            this.items = items;
            return this;
        }
