...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeAutonomousDatabaseCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAutonomousDatabaseCompartmentRequest.
 */
...
public class ChangeAutonomousDatabaseCompartmentRequest
    ...
    public static class Builder
         ...
         */
        public ChangeAutonomousDatabaseCompartmentRequest build() {
            ChangeAutonomousDatabaseCompartmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ChangeAutonomousDatabaseCompartmentRequest
         */
        public ChangeAutonomousDatabaseCompartmentRequest buildWithoutInvocationCallback() {
            ChangeAutonomousDatabaseCompartmentRequest request =
                    new ChangeAutonomousDatabaseCompartmentRequest();
            ...
            return request;
            // new ChangeAutonomousDatabaseCompartmentRequest(changeCompartmentDetails, autonomousDatabaseId, opcRetryToken, opcRequestId, ifMatch, opcDryRun);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAutonomousDatabaseCompartmentRequest)) {
            return false;
        }

        ChangeAutonomousDatabaseCompartmentRequest other =
                (ChangeAutonomousDatabaseCompartmentRequest) o;
