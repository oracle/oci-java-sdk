...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeExadataInfrastructureCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeExadataInfrastructureCompartmentRequest.
 */
...
public class ChangeExadataInfrastructureCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeExadataInfrastructureCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeExadataInfrastructureCompartmentRequest(changeExadataInfrastructureCompartmentDetails, exadataInfrastructureId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
