...
public class UpdateBackupDestinationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBackupDestinationResponse)) {
            return false;
        }

        UpdateBackupDestinationResponse other = (UpdateBackupDestinationResponse) o;
