...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DeleteExadataInfrastructureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteExadataInfrastructureRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteExadataInfrastructureRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteExadataInfrastructureRequest, java.lang.Void> {
         ...
         * @return instance of DeleteExadataInfrastructureRequest
         */
        public DeleteExadataInfrastructureRequest buildWithoutInvocationCallback() {
            DeleteExadataInfrastructureRequest request = new DeleteExadataInfrastructureRequest();
            request.exadataInfrastructureId = exadataInfrastructureId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteExadataInfrastructureRequest(exadataInfrastructureId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExadataInfrastructureRequest)) {
            return false;
        }

        DeleteExadataInfrastructureRequest other = (DeleteExadataInfrastructureRequest) o;
