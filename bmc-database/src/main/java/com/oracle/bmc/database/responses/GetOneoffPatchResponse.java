...
public class GetOneoffPatchResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetOneoffPatchResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOneoffPatchResponse> {
         ...
         */
        @Override
        public Builder copy(GetOneoffPatchResponse o) {
         ...
         */
        @Override
        public GetOneoffPatchResponse build() {
            return new GetOneoffPatchResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOneoffPatchResponse)) {
            return false;
        }

        GetOneoffPatchResponse other = (GetOneoffPatchResponse) o;
