...
public class ListBackupDestinationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.database.model.BackupDestinationSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.BackupDestinationSummary> getItems() {
        return items;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListBackupDestinationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBackupDestinationResponse)) {
            return false;
        }

        ListBackupDestinationResponse other = (ListBackupDestinationResponse) o;
