...
/**
 * Details to create an Oracle Autonomous Database by cloning an existing Autonomous Database. <br>
...
public final class CreateAutonomousDatabaseCloneDetails extends CreateAutonomousDatabaseBase {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousDatabaseCloneDetails)) {
            return false;
        }

        CreateAutonomousDatabaseCloneDetails other = (CreateAutonomousDatabaseCloneDetails) o;
