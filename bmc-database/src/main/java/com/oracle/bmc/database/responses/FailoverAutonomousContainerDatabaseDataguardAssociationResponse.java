...
public class FailoverAutonomousContainerDatabaseDataguardAssociationResponse
    ...
    public static class Builder {
         ...
         */
        public FailoverAutonomousContainerDatabaseDataguardAssociationResponse build() {
            return new FailoverAutonomousContainerDatabaseDataguardAssociationResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverAutonomousContainerDatabaseDataguardAssociationResponse)) {
            return false;
        }

        FailoverAutonomousContainerDatabaseDataguardAssociationResponse other =
                (FailoverAutonomousContainerDatabaseDataguardAssociationResponse) o;
