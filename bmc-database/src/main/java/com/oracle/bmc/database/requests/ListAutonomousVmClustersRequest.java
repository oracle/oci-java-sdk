...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousVmClustersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousVmClustersRequest.
 */
...
public class ListAutonomousVmClustersRequest
    ...
    public static class Builder
        ...
        public ListAutonomousVmClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutonomousVmClustersRequest(compartmentId, exadataInfrastructureId, limit, page, sortBy, sortOrder, lifecycleState, displayName, opcRequestId);
        }
    }
