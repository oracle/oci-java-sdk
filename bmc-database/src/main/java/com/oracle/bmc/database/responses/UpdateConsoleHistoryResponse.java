...
public class UpdateConsoleHistoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.database.model.ConsoleHistory consoleHistory;
     ...
     * @return the value
     */
    public com.oracle.bmc.database.model.ConsoleHistory getConsoleHistory() {
    ...
    private UpdateConsoleHistoryResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcWorkRequestId,
            String opcRequestId,
            String etag,
            com.oracle.bmc.database.model.ConsoleHistory consoleHistory) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateConsoleHistoryResponse> {
         ...
         * @return this builder
         */
        public Builder consoleHistory(com.oracle.bmc.database.model.ConsoleHistory consoleHistory) {
            this.consoleHistory = consoleHistory;
            return this;
        }
