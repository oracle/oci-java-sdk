...
public class UpdateDataGuardResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateDataGuardResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDataGuardResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDataGuardResponse o) {
         ...
         */
        @Override
        public UpdateDataGuardResponse build() {
            return new UpdateDataGuardResponse(
                    __httpStatusCode__, headers, opcRequestId, opcWorkRequestId, etag, database);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDataGuardResponse)) {
            return false;
        }

        UpdateDataGuardResponse other = (UpdateDataGuardResponse) o;
