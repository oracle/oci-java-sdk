...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DeleteAutonomousDatabaseBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAutonomousDatabaseBackupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteAutonomousDatabaseBackupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAutonomousDatabaseBackupRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAutonomousDatabaseBackupRequest o) {
        ...
        /**
         * Build the instance of DeleteAutonomousDatabaseBackupRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAutonomousDatabaseBackupRequest
         */
        public DeleteAutonomousDatabaseBackupRequest build() {
            DeleteAutonomousDatabaseBackupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAutonomousDatabaseBackupRequest
         */
        public DeleteAutonomousDatabaseBackupRequest buildWithoutInvocationCallback() {
            DeleteAutonomousDatabaseBackupRequest request =
                    new DeleteAutonomousDatabaseBackupRequest();
            request.autonomousDatabaseBackupId = autonomousDatabaseBackupId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcDryRun = opcDryRun;
            return request;
            // new DeleteAutonomousDatabaseBackupRequest(autonomousDatabaseBackupId, ifMatch, opcRequestId, opcDryRun);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAutonomousDatabaseBackupRequest)) {
            return false;
        }

        DeleteAutonomousDatabaseBackupRequest other = (DeleteAutonomousDatabaseBackupRequest) o;
