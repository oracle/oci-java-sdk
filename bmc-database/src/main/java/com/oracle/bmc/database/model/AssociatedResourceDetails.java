...
/**
 * Details about the resources associated with the connection bundle. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AssociatedResourceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AssociatedResourceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"resourceIds"})
    public AssociatedResourceDetails(java.util.List<String> resourceIds) {
        super();
    ...
    public static class Builder {
        ...
        public AssociatedResourceDetails build() {
            AssociatedResourceDetails model = new AssociatedResourceDetails(this.resourceIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssociatedResourceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssociatedResourceDetails)) {
            return false;
        }

        AssociatedResourceDetails other = (AssociatedResourceDetails) o;
