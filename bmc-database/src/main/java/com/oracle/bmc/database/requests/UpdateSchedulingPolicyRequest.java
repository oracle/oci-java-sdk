...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateSchedulingPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSchedulingPolicyRequest.
 */
...
public class UpdateSchedulingPolicyRequest
     ...
     */
    private com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails
            updateSchedulingPolicyDetails;

    /**
     * Request to update the properties of a Scheduling Policy.
     */
    public com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails
            getUpdateSchedulingPolicyDetails() {
    ...
    public com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails getBody$() {
        return updateSchedulingPolicyDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails
                updateSchedulingPolicyDetails = null;

        /**
         * Request to update the properties of a Scheduling Policy.
         * @param updateSchedulingPolicyDetails the value to set
         * @return this builder instance
         */
        public Builder updateSchedulingPolicyDetails(
                com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails
                        updateSchedulingPolicyDetails) {
        ...
        public Builder copy(UpdateSchedulingPolicyRequest o) {
            ...
            updateSchedulingPolicyDetails(o.getUpdateSchedulingPolicyDetails());
         ...
         *
         * @return instance of UpdateSchedulingPolicyRequest
         */
        public UpdateSchedulingPolicyRequest build() {
            UpdateSchedulingPolicyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.database.model.UpdateSchedulingPolicyDetails body) {
            updateSchedulingPolicyDetails(body);
            return this;
        }
        ...
        public UpdateSchedulingPolicyRequest buildWithoutInvocationCallback() {
            ...
            request.updateSchedulingPolicyDetails = updateSchedulingPolicyDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateSchedulingPolicyRequest(schedulingPolicyId, updateSchedulingPolicyDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateSchedulingPolicyDetails=")
                .append(String.valueOf(this.updateSchedulingPolicyDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateSchedulingPolicyRequest other = (UpdateSchedulingPolicyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.schedulingPolicyId, other.schedulingPolicyId)
                && java.util.Objects.equals(
                        this.updateSchedulingPolicyDetails, other.updateSchedulingPolicyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateSchedulingPolicyDetails == null
                                ? 43
                                : this.updateSchedulingPolicyDetails.hashCode());
