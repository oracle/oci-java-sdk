...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/CancelExecutionWindowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CancelExecutionWindowRequest.
 */
...
public class CancelExecutionWindowRequest
    ...
    public static class Builder
        ...
        public CancelExecutionWindowRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CancelExecutionWindowRequest(executionWindowId, cancelExecutionWindowDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
