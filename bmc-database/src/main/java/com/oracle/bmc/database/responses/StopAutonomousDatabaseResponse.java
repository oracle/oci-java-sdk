...
public class StopAutonomousDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(StopAutonomousDatabaseResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopAutonomousDatabaseResponse)) {
            return false;
        }

        StopAutonomousDatabaseResponse other = (StopAutonomousDatabaseResponse) o;
