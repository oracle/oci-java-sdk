...
public class GetConsoleConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetConsoleConnectionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetConsoleConnectionResponse)) {
            return false;
        }

        GetConsoleConnectionResponse other = (GetConsoleConnectionResponse) o;
