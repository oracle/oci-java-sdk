...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListDbnodeSnapshotsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDbnodeSnapshotsRequest.
 */
...
public class ListDbnodeSnapshotsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDbnodeSnapshotsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDbnodeSnapshotsRequest(compartmentId, limit, page, sortBy, name, sortOrder, lifecycleState, clusterId, sourceDbnodeId, opcRequestId);
        }
    }
