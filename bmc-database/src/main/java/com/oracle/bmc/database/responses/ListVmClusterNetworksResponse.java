...
public class ListVmClusterNetworksResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.VmClusterNetworkSummary> getItems() {
        return items;
    }
    ...
    private ListVmClusterNetworksResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.VmClusterNetworkSummary> items) {
