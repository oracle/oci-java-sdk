...
public class DeleteVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteVmClusterResponse> {
         ...
         */
        @Override
        public DeleteVmClusterResponse build() {
            return new DeleteVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVmClusterResponse)) {
            return false;
        }

        DeleteVmClusterResponse other = (DeleteVmClusterResponse) o;
