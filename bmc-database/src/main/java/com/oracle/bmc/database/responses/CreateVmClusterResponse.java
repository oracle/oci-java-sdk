...
public class CreateVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateVmClusterResponse> {
        ...
        public CreateVmClusterResponse build() {
            return new CreateVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVmClusterResponse)) {
            return false;
        }

        CreateVmClusterResponse other = (CreateVmClusterResponse) o;
