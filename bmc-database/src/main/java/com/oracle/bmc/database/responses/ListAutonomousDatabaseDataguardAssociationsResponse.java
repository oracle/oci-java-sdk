...
public class ListAutonomousDatabaseDataguardAssociationsResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDatabaseDataguardAssociationsResponse)) {
            return false;
        }

        ListAutonomousDatabaseDataguardAssociationsResponse other =
                (ListAutonomousDatabaseDataguardAssociationsResponse) o;
