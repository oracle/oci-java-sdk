...
/**
 * The details for configuring the SSL certificates on Cloud Autonomous VM Cluster <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RotateCloudAutonomousVmClusterSslCertsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RotateCloudAutonomousVmClusterSslCertsDetails
    ...
    public RotateCloudAutonomousVmClusterSslCertsDetails(
    ...
    public static class Builder {
        /**
         * Specify SYSTEM for using Oracle managed certificates. Specify BYOC when you want to bring
        ...
        public RotateCloudAutonomousVmClusterSslCertsDetails build() {
            RotateCloudAutonomousVmClusterSslCertsDetails model =
                    new RotateCloudAutonomousVmClusterSslCertsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RotateCloudAutonomousVmClusterSslCertsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateCloudAutonomousVmClusterSslCertsDetails)) {
            return false;
        }

        RotateCloudAutonomousVmClusterSslCertsDetails other =
                (RotateCloudAutonomousVmClusterSslCertsDetails) o;
