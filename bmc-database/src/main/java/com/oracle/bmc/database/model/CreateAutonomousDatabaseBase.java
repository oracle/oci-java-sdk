...
public class CreateAutonomousDatabaseBase
    ...
    /**
     * The source of the database: Use {@code NONE} for creating a new Autonomous AI Database. Use {@code DATABASE} for creating a new Autonomous AI Database by cloning an existing Autonomous AI Database. Use {@code CROSS_REGION_DATAGUARD} to create a standby Data Guard database in another region.
     * <p>
     * For [Autonomous AI Database Serverless instances](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/), the following cloning options are available: Use {@code BACKUP_FROM_ID} for creating a new Autonomous AI Database from a specified backup. Use {@code BACKUP_FROM_TIMESTAMP} for creating a point-in-time Autonomous AI Database clone using backups. For more information, see [Cloning and Moving an Autonomous AI Database](https://docs.oracle.com/en/cloud/paas/autonomous-database/adbsa/clone-autonomous-database.html#GUID-D771796F-5081-4CFB-A7FF-0F893EABD7BC).
     *
     **/
    public enum Source {
        None("NONE"),
