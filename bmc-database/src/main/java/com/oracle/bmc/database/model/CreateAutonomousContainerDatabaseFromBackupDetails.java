...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousContainerDatabaseFromBackupDetails.Builder.class)
...
public final class CreateAutonomousContainerDatabaseFromBackupDetails
    ...
    public static class Builder {
        ...
        /**
         * A list of Autonomous Databases ( display name of the ADB in specific ) to be cloned from
         * backup of the source Autonomous Container Database.
         */
        ...
        /**
         * The speed at which the Autonomous Container Database Clone from backup operation to be
         * performed by OCI.
         */
        ...
        public Builder copy(CreateAutonomousContainerDatabaseFromBackupDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("autonomousContainerDatabaseBackupId")) {
                this.autonomousContainerDatabaseBackupId(
     ...
     * performed by OCI.
     */
    public enum CloneBandWidth implements com.oracle.bmc.http.internal.BmcEnum {
        Slow("SLOW"),
        Medium("MEDIUM"),
        Fast("FAST"),
        ;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousContainerDatabaseFromBackupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousContainerDatabaseFromBackupDetails)) {
            return false;
        }

        CreateAutonomousContainerDatabaseFromBackupDetails other =
                (CreateAutonomousContainerDatabaseFromBackupDetails) o;
