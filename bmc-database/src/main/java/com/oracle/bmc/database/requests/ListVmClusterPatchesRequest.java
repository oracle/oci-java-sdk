...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListVmClusterPatchesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVmClusterPatchesRequest.
 */
...
public class ListVmClusterPatchesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListVmClusterPatchesRequest
         */
        public ListVmClusterPatchesRequest buildWithoutInvocationCallback() {
            ListVmClusterPatchesRequest request = new ListVmClusterPatchesRequest();
            request.vmClusterId = vmClusterId;
            request.limit = limit;
            request.page = page;
            return request;
            // new ListVmClusterPatchesRequest(vmClusterId, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVmClusterPatchesRequest)) {
            return false;
        }

        ListVmClusterPatchesRequest other = (ListVmClusterPatchesRequest) o;
