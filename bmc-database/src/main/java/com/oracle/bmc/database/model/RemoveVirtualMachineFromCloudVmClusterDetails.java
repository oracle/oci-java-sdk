...
/**
 * Details of removing Virtual Machines from the Cloud VM Cluster. Applies to Exadata Cloud
 * instances only. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemoveVirtualMachineFromCloudVmClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RemoveVirtualMachineFromCloudVmClusterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dbServers"})
    public RemoveVirtualMachineFromCloudVmClusterDetails(
    ...
    public static class Builder {
        ...
        public RemoveVirtualMachineFromCloudVmClusterDetails build() {
            RemoveVirtualMachineFromCloudVmClusterDetails model =
                    new RemoveVirtualMachineFromCloudVmClusterDetails(this.dbServers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveVirtualMachineFromCloudVmClusterDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RemoveVirtualMachineFromCloudVmClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveVirtualMachineFromCloudVmClusterDetails)) {
            return false;
        }

        RemoveVirtualMachineFromCloudVmClusterDetails other =
                (RemoveVirtualMachineFromCloudVmClusterDetails) o;
