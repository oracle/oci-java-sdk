...
public class CancelBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelBackupResponse> {
         ...
         */
        @Override
        public Builder copy(CancelBackupResponse o) {
         ...
         */
        @Override
        public CancelBackupResponse build() {
            return new CancelBackupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelBackupResponse)) {
            return false;
        }

        CancelBackupResponse other = (CancelBackupResponse) o;
