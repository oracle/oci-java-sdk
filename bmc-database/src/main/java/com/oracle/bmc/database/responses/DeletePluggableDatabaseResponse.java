...
public class DeletePluggableDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeletePluggableDatabaseResponse o) {
         ...
         */
        @Override
        public DeletePluggableDatabaseResponse build() {
            return new DeletePluggableDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePluggableDatabaseResponse)) {
            return false;
        }

        DeletePluggableDatabaseResponse other = (DeletePluggableDatabaseResponse) o;
