...
public class ListAutonomousContainerDatabasesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.AutonomousContainerDatabaseSummary>
            getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousContainerDatabasesResponse)) {
            return false;
        }

        ListAutonomousContainerDatabasesResponse other =
                (ListAutonomousContainerDatabasesResponse) o;
