...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeKeyStoreCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeKeyStoreCompartmentRequest.
 */
...
public class ChangeKeyStoreCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeKeyStoreCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeKeyStoreCompartmentRequest(changeKeyStoreCompartmentDetails, keyStoreId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
