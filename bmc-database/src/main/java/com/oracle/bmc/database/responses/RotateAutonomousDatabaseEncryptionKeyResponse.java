...
public class RotateAutonomousDatabaseEncryptionKeyResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateAutonomousDatabaseEncryptionKeyResponse)) {
            return false;
        }

        RotateAutonomousDatabaseEncryptionKeyResponse other =
                (RotateAutonomousDatabaseEncryptionKeyResponse) o;
