...
public class UpdateExadataIormConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateExadataIormConfigResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExadataIormConfigResponse)) {
            return false;
        }

        UpdateExadataIormConfigResponse other = (UpdateExadataIormConfigResponse) o;
