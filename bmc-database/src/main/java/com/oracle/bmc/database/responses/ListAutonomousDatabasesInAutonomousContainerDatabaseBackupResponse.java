...
public class ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse
    ...
    /** The returned {@code AutonomousDatabaseInBackupCollection} instance. */
    ...
    public static class Builder
         ...
         * The returned {@code AutonomousDatabaseInBackupCollection} instance.
         *
         * @param autonomousDatabaseInBackupCollection the value to set
         * @return this builder
         */
        public Builder autonomousDatabaseInBackupCollection(
                com.oracle.bmc.database.model.AutonomousDatabaseInBackupCollection
                        autonomousDatabaseInBackupCollection) {
            this.autonomousDatabaseInBackupCollection = autonomousDatabaseInBackupCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            autonomousDatabaseInBackupCollection(o.getAutonomousDatabaseInBackupCollection());
         ...
         */
        @Override
        public ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse build() {
            return new ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public String toString() {
        ...
        sb.append(",autonomousDatabaseInBackupCollection=")
                .append(String.valueOf(autonomousDatabaseInBackupCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse)) {
            return false;
        }

        ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse other =
                (ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.autonomousDatabaseInBackupCollection,
                        other.autonomousDatabaseInBackupCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.autonomousDatabaseInBackupCollection == null
                                ? 43
                                : this.autonomousDatabaseInBackupCollection.hashCode());
        return result;
    }
}
