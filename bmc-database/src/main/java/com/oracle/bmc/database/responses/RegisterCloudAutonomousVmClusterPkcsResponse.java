...
public class RegisterCloudAutonomousVmClusterPkcsResponse
    ...
    private RegisterCloudAutonomousVmClusterPkcsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RegisterCloudAutonomousVmClusterPkcsResponse o) {
         ...
         */
        @Override
        public RegisterCloudAutonomousVmClusterPkcsResponse build() {
            return new RegisterCloudAutonomousVmClusterPkcsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisterCloudAutonomousVmClusterPkcsResponse)) {
            return false;
        }

        RegisterCloudAutonomousVmClusterPkcsResponse other =
                (RegisterCloudAutonomousVmClusterPkcsResponse) o;
