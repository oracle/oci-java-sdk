...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DisableExternalNonContainerDatabaseOperationsInsightsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DisableExternalNonContainerDatabaseOperationsInsightsRequest.
 */
...
public class DisableExternalNonContainerDatabaseOperationsInsightsRequest
    ...
    public static class Builder
         ...
         * @return instance of DisableExternalNonContainerDatabaseOperationsInsightsRequest
         */
        public DisableExternalNonContainerDatabaseOperationsInsightsRequest
                buildWithoutInvocationCallback() {
            DisableExternalNonContainerDatabaseOperationsInsightsRequest request =
                    new DisableExternalNonContainerDatabaseOperationsInsightsRequest();
            request.externalNonContainerDatabaseId = externalNonContainerDatabaseId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DisableExternalNonContainerDatabaseOperationsInsightsRequest(externalNonContainerDatabaseId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalNonContainerDatabaseOperationsInsightsRequest)) {
            return false;
        }

        DisableExternalNonContainerDatabaseOperationsInsightsRequest other =
                (DisableExternalNonContainerDatabaseOperationsInsightsRequest) o;
