...
public class DeleteOneoffPatchResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOneoffPatchResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteOneoffPatchResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteOneoffPatchResponse o) {
         ...
         */
        @Override
        public DeleteOneoffPatchResponse build() {
            return new DeleteOneoffPatchResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOneoffPatchResponse)) {
            return false;
        }

        DeleteOneoffPatchResponse other = (DeleteOneoffPatchResponse) o;
