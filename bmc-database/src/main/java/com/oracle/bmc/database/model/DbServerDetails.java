...
/**
 * Details of the Exacc Db server. Applies to Exadata Cloud@Customer instances only. <br>
...
public final class DbServerDetails
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of Exacc Db
     * server.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("dbServerId")
