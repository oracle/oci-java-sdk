...
public class ChangeCloudAutonomousVmClusterSubscriptionResponse
    ...
    private ChangeCloudAutonomousVmClusterSubscriptionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeCloudAutonomousVmClusterSubscriptionResponse o) {
         ...
         */
        @Override
        public ChangeCloudAutonomousVmClusterSubscriptionResponse build() {
            return new ChangeCloudAutonomousVmClusterSubscriptionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeCloudAutonomousVmClusterSubscriptionResponse)) {
            return false;
        }

        ChangeCloudAutonomousVmClusterSubscriptionResponse other =
                (ChangeCloudAutonomousVmClusterSubscriptionResponse) o;
