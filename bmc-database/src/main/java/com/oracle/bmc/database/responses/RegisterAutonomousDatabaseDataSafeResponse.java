...
public class RegisterAutonomousDatabaseDataSafeResponse
    ...
    private RegisterAutonomousDatabaseDataSafeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public RegisterAutonomousDatabaseDataSafeResponse build() {
            return new RegisterAutonomousDatabaseDataSafeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisterAutonomousDatabaseDataSafeResponse)) {
            return false;
        }

        RegisterAutonomousDatabaseDataSafeResponse other =
                (RegisterAutonomousDatabaseDataSafeResponse) o;
