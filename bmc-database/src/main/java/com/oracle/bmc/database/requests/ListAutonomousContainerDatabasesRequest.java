...
public class ListAutonomousContainerDatabasesRequest
    ...
    /**
     * The cloud Autonomous VM Cluster
     * [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm).
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only resources that match the given service-level agreement type
         * exactly.
         */
        ...
        /**
         * Build the instance of ListAutonomousContainerDatabasesRequest as configured by this
         * builder
         *
        ...
        public ListAutonomousContainerDatabasesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutonomousContainerDatabasesRequest(compartmentId,
            // autonomousExadataInfrastructureId, autonomousVmClusterId, infrastructureType, limit,
            // page, sortBy, sortOrder, lifecycleState, availabilityDomain, displayName,
            // serviceLevelAgreementType, cloudAutonomousVmClusterId);
        }
    }
