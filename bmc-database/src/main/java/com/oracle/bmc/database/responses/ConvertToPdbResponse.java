...
public class ConvertToPdbResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ConvertToPdbResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConvertToPdbResponse)) {
            return false;
        }

        ConvertToPdbResponse other = (ConvertToPdbResponse) o;
