...
public class ListAutonomousDatabaseCharacterSetsResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.AutonomousDatabaseCharacterSets>
            getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.database.model.AutonomousDatabaseCharacterSets>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDatabaseCharacterSetsResponse)) {
            return false;
        }

        ListAutonomousDatabaseCharacterSetsResponse other =
                (ListAutonomousDatabaseCharacterSetsResponse) o;
