...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BaseccVmClusterUpdateHistoryEntry.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BaseccVmClusterUpdateHistoryEntry
    ...
    public BaseccVmClusterUpdateHistoryEntry(
            String id,
            String updateId,
    ...
    public static class Builder {
        ...
        public BaseccVmClusterUpdateHistoryEntry build() {
            BaseccVmClusterUpdateHistoryEntry model =
                    new BaseccVmClusterUpdateHistoryEntry(
                            this.id,
                            this.updateId,
                            this.updateAction,
                            this.updateType,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BaseccVmClusterUpdateHistoryEntry model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseccVmClusterUpdateHistoryEntry)) {
            return false;
        }

        BaseccVmClusterUpdateHistoryEntry other = (BaseccVmClusterUpdateHistoryEntry) o;
