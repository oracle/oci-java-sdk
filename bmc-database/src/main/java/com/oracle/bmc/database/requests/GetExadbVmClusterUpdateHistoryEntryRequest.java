...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetExadbVmClusterUpdateHistoryEntryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetExadbVmClusterUpdateHistoryEntryRequest.
 */
...
public class GetExadbVmClusterUpdateHistoryEntryRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of GetExadbVmClusterUpdateHistoryEntryRequest as configured by this builder
         *
        ...
        public GetExadbVmClusterUpdateHistoryEntryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetExadbVmClusterUpdateHistoryEntryRequest(exadbVmClusterId, updateHistoryEntryId, opcRequestId);
        }
    }
