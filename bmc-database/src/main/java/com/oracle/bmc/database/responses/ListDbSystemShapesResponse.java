...
public class ListDbSystemShapesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** A list of {@code com.oracle.bmc.database.model.DbSystemShapeSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DbSystemShapeSummary> getItems() {
        return items;
    }
    ...
    private ListDbSystemShapesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.DbSystemShapeSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListDbSystemShapesResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemShapesResponse)) {
            return false;
        }

        ListDbSystemShapesResponse other = (ListDbSystemShapesResponse) o;
