...
public class DeleteBaseccVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteBaseccVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteBaseccVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteBaseccVmClusterResponse o) {
         ...
         */
        @Override
        public DeleteBaseccVmClusterResponse build() {
            return new DeleteBaseccVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBaseccVmClusterResponse)) {
            return false;
        }

        DeleteBaseccVmClusterResponse other = (DeleteBaseccVmClusterResponse) o;
