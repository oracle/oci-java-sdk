...
public class ListBackupsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.BackupSummary> getItems() {
        return items;
    }
    ...
    private ListBackupsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.BackupSummary> items) {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.database.model.BackupSummary> items) {
            this.items = items;
            return this;
        }
        ...
        public ListBackupsResponse build() {
            return new ListBackupsResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
