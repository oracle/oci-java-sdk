...
public class GetDbHomePatchResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDbHomePatchResponse> {
         ...
         */
        @Override
        public Builder copy(GetDbHomePatchResponse o) {
         ...
         */
        @Override
        public GetDbHomePatchResponse build() {
            return new GetDbHomePatchResponse(__httpStatusCode__, headers, opcRequestId, patch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDbHomePatchResponse)) {
            return false;
        }

        GetDbHomePatchResponse other = (GetDbHomePatchResponse) o;
