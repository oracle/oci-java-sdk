...
public class ChangeExascaleDbStorageVaultSubscriptionRequest
    ...
    public static class Builder
         ...
         */
        public Builder changeExascaleDbStorageVaultSubscriptionDetails(
                com.oracle.bmc.database.model.ChangeExascaleDbStorageVaultSubscriptionDetails
                        changeExascaleDbStorageVaultSubscriptionDetails) {
        ...
        public Builder copy(ChangeExascaleDbStorageVaultSubscriptionRequest o) {
            changeExascaleDbStorageVaultSubscriptionDetails(
                    o.getChangeExascaleDbStorageVaultSubscriptionDetails());
         ...
         */
        public ChangeExascaleDbStorageVaultSubscriptionRequest build() {
        ...
        public Builder body$(
                com.oracle.bmc.database.model.ChangeExascaleDbStorageVaultSubscriptionDetails
                        body) {
            changeExascaleDbStorageVaultSubscriptionDetails(body);
            return this;
        }
         ...
         * @return instance of ChangeExascaleDbStorageVaultSubscriptionRequest
         */
        public ChangeExascaleDbStorageVaultSubscriptionRequest buildWithoutInvocationCallback() {
            ChangeExascaleDbStorageVaultSubscriptionRequest request =
                    new ChangeExascaleDbStorageVaultSubscriptionRequest();
            request.changeExascaleDbStorageVaultSubscriptionDetails =
                    changeExascaleDbStorageVaultSubscriptionDetails;
    ...
    public String toString() {
        ...
        sb.append(",changeExascaleDbStorageVaultSubscriptionDetails=")
                .append(String.valueOf(this.changeExascaleDbStorageVaultSubscriptionDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExascaleDbStorageVaultSubscriptionRequest)) {
            return false;
        }

        ChangeExascaleDbStorageVaultSubscriptionRequest other =
                (ChangeExascaleDbStorageVaultSubscriptionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.changeExascaleDbStorageVaultSubscriptionDetails,
                        other.changeExascaleDbStorageVaultSubscriptionDetails)
                && java.util.Objects.equals(
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeExascaleDbStorageVaultSubscriptionDetails == null
                                ? 43
                                : this.changeExascaleDbStorageVaultSubscriptionDetails.hashCode());
        result =
                (result * PRIME)
