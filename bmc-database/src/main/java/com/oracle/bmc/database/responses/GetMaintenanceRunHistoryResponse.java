...
public class GetMaintenanceRunHistoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder maintenanceRunHistory(
                com.oracle.bmc.database.model.MaintenanceRunHistory maintenanceRunHistory) {
            this.maintenanceRunHistory = maintenanceRunHistory;
            return this;
        }
        ...
        public Builder copy(GetMaintenanceRunHistoryResponse o) {
            ...
            maintenanceRunHistory(o.getMaintenanceRunHistory());
    ...
    public String toString() {
        ...
        sb.append(",maintenanceRunHistory=").append(String.valueOf(maintenanceRunHistory));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMaintenanceRunHistoryResponse)) {
            return false;
        }

        GetMaintenanceRunHistoryResponse other = (GetMaintenanceRunHistoryResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.maintenanceRunHistory, other.maintenanceRunHistory);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.maintenanceRunHistory == null
                                ? 43
                                : this.maintenanceRunHistory.hashCode());
        return result;
    }
}
