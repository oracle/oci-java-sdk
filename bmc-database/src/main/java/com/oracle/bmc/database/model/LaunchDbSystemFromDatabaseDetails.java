...
/**
 * Used for creating a new DB system from a database, including archived redo log data. <br>
...
public final class LaunchDbSystemFromDatabaseDetails extends LaunchDbSystemBase {
    ...
    public static class Builder {
        ...
        /**
         * The type of redundancy configured for the DB system. NORMAL 2-way redundancy, recommended
        ...
        public LaunchDbSystemFromDatabaseDetails build() {
            LaunchDbSystemFromDatabaseDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LaunchDbSystemFromDatabaseDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dbHome")
    private final CreateDbHomeFromDatabaseDetails dbHome;
    ...
    /**
     * The type of redundancy configured for the DB system. NORMAL 2-way redundancy, recommended for
     * test and development systems. HIGH is 3-way redundancy, recommended for production systems.
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LaunchDbSystemFromDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LaunchDbSystemFromDatabaseDetails)) {
            return false;
        }

        LaunchDbSystemFromDatabaseDetails other = (LaunchDbSystemFromDatabaseDetails) o;
