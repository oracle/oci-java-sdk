...
public class DeleteExecutionActionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteExecutionActionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteExecutionActionResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteExecutionActionResponse o) {
         ...
         */
        @Override
        public DeleteExecutionActionResponse build() {
            return new DeleteExecutionActionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExecutionActionResponse)) {
            return false;
        }

        DeleteExecutionActionResponse other = (DeleteExecutionActionResponse) o;
