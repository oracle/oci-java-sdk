...
/**
 * Storage Details on the Exadata VM cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadbVmClusterStorageDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExadbVmClusterStorageDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"totalSizeInGbs"})
    public ExadbVmClusterStorageDetails(Integer totalSizeInGbs) {
        super();
    ...
    public static class Builder {
        ...
        public ExadbVmClusterStorageDetails build() {
            ExadbVmClusterStorageDetails model =
                    new ExadbVmClusterStorageDetails(this.totalSizeInGbs);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadbVmClusterStorageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadbVmClusterStorageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadbVmClusterStorageDetails)) {
            return false;
        }

        ExadbVmClusterStorageDetails other = (ExadbVmClusterStorageDetails) o;
