...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/RotateAutonomousContainerDatabaseEncryptionKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RotateAutonomousContainerDatabaseEncryptionKeyRequest.
 */
...
public class RotateAutonomousContainerDatabaseEncryptionKeyRequest
    ...
    public static class Builder
         ...
         */
        public RotateAutonomousContainerDatabaseEncryptionKeyRequest build() {
         ...
         * @return instance of RotateAutonomousContainerDatabaseEncryptionKeyRequest
         */
        public RotateAutonomousContainerDatabaseEncryptionKeyRequest
                buildWithoutInvocationCallback() {
            RotateAutonomousContainerDatabaseEncryptionKeyRequest request =
                    new RotateAutonomousContainerDatabaseEncryptionKeyRequest();
            request.autonomousContainerDatabaseId = autonomousContainerDatabaseId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new RotateAutonomousContainerDatabaseEncryptionKeyRequest(autonomousContainerDatabaseId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateAutonomousContainerDatabaseEncryptionKeyRequest)) {
            return false;
        }

        RotateAutonomousContainerDatabaseEncryptionKeyRequest other =
                (RotateAutonomousContainerDatabaseEncryptionKeyRequest) o;
