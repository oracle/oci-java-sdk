...
public class GetAutonomousVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetAutonomousVmClusterResponse o) {
        ...
        public GetAutonomousVmClusterResponse build() {
            return new GetAutonomousVmClusterResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, autonomousVmCluster);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAutonomousVmClusterResponse)) {
            return false;
        }

        GetAutonomousVmClusterResponse other = (GetAutonomousVmClusterResponse) o;
