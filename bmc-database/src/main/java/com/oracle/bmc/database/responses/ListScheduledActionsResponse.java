...
public class ListScheduledActionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder scheduledActionCollection(
                com.oracle.bmc.database.model.ScheduledActionCollection scheduledActionCollection) {
            this.scheduledActionCollection = scheduledActionCollection;
            return this;
        }
        ...
        public Builder copy(ListScheduledActionsResponse o) {
            ...
            scheduledActionCollection(o.getScheduledActionCollection());
    ...
    public String toString() {
        ...
        sb.append(",scheduledActionCollection=").append(String.valueOf(scheduledActionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListScheduledActionsResponse)) {
            return false;
        }

        ListScheduledActionsResponse other = (ListScheduledActionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.scheduledActionCollection, other.scheduledActionCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.scheduledActionCollection == null
                                ? 43
                                : this.scheduledActionCollection.hashCode());
        return result;
    }
}
