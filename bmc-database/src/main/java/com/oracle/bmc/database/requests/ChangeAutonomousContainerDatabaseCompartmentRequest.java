...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeAutonomousContainerDatabaseCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAutonomousContainerDatabaseCompartmentRequest.
 */
...
public class ChangeAutonomousContainerDatabaseCompartmentRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeAutonomousContainerDatabaseCompartmentRequest o) {
        ...
        /**
         * Build the instance of ChangeAutonomousContainerDatabaseCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeAutonomousContainerDatabaseCompartmentRequest
         */
        public ChangeAutonomousContainerDatabaseCompartmentRequest build() {
         ...
         * @return instance of ChangeAutonomousContainerDatabaseCompartmentRequest
         */
        public ChangeAutonomousContainerDatabaseCompartmentRequest
                buildWithoutInvocationCallback() {
            ChangeAutonomousContainerDatabaseCompartmentRequest request =
                    new ChangeAutonomousContainerDatabaseCompartmentRequest();
            ...
            return request;
            // new ChangeAutonomousContainerDatabaseCompartmentRequest(changeCompartmentDetails, autonomousContainerDatabaseId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAutonomousContainerDatabaseCompartmentRequest)) {
            return false;
        }

        ChangeAutonomousContainerDatabaseCompartmentRequest other =
                (ChangeAutonomousContainerDatabaseCompartmentRequest) o;
