...
public class SwitchoverAutonomousContainerDatabaseDataguardAssociationResponse
    ...
    private SwitchoverAutonomousContainerDatabaseDataguardAssociationResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverAutonomousContainerDatabaseDataguardAssociationResponse)) {
            return false;
        }

        SwitchoverAutonomousContainerDatabaseDataguardAssociationResponse other =
                (SwitchoverAutonomousContainerDatabaseDataguardAssociationResponse) o;
