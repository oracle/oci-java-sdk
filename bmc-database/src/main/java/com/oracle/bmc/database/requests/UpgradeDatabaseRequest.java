 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpgradeDatabaseRequest.
 */
...
public class UpgradeDatabaseRequest
    ...
    public static class Builder
        ...
        public UpgradeDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpgradeDatabaseRequest(databaseId, upgradeDatabaseDetails, ifMatch,
            // opcRequestId);
        }
    }
