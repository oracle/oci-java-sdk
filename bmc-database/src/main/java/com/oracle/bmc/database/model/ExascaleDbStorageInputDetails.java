...
/**
 * Create exadata Database Storage Details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExascaleDbStorageInputDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExascaleDbStorageInputDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"totalSizeInGbs"})
    public ExascaleDbStorageInputDetails(Integer totalSizeInGbs) {
        super();
    ...
    public static class Builder {
        ...
        public ExascaleDbStorageInputDetails build() {
            ExascaleDbStorageInputDetails model =
                    new ExascaleDbStorageInputDetails(this.totalSizeInGbs);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExascaleDbStorageInputDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExascaleDbStorageInputDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExascaleDbStorageInputDetails)) {
            return false;
        }

        ExascaleDbStorageInputDetails other = (ExascaleDbStorageInputDetails) o;
