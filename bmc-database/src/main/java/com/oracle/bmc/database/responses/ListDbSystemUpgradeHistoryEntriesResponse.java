...
public class ListDbSystemUpgradeHistoryEntriesResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DbSystemUpgradeHistoryEntrySummary>
            getItems() {
        return items;
    }
    ...
    private ListDbSystemUpgradeHistoryEntriesResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.DbSystemUpgradeHistoryEntrySummary>
                    items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListDbSystemUpgradeHistoryEntriesResponse o) {
         ...
         */
        @Override
        public ListDbSystemUpgradeHistoryEntriesResponse build() {
            return new ListDbSystemUpgradeHistoryEntriesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemUpgradeHistoryEntriesResponse)) {
            return false;
        }

        ListDbSystemUpgradeHistoryEntriesResponse other =
                (ListDbSystemUpgradeHistoryEntriesResponse) o;
