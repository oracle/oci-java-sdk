...
public class ListCloudVmClustersResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** A list of {@code com.oracle.bmc.database.model.CloudVmClusterSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.CloudVmClusterSummary> getItems() {
        return items;
    }
    ...
    private ListCloudVmClustersResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.CloudVmClusterSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListCloudVmClustersResponse> {
         ...
         */
        @Override
        public Builder copy(ListCloudVmClustersResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudVmClustersResponse)) {
            return false;
        }

        ListCloudVmClustersResponse other = (ListCloudVmClustersResponse) o;
