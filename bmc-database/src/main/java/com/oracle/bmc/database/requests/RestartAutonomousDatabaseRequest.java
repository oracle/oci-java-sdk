...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/RestartAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RestartAutonomousDatabaseRequest.
 */
...
public class RestartAutonomousDatabaseRequest
    ...
    public static class Builder
         ...
         *
         * @return instance of RestartAutonomousDatabaseRequest
         */
        public RestartAutonomousDatabaseRequest build() {
            RestartAutonomousDatabaseRequest request = buildWithoutInvocationCallback();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartAutonomousDatabaseRequest)) {
            return false;
        }
