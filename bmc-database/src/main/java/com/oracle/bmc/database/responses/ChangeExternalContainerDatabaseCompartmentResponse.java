...
public class ChangeExternalContainerDatabaseCompartmentResponse
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeExternalContainerDatabaseCompartmentResponse o) {
         ...
         */
        public ChangeExternalContainerDatabaseCompartmentResponse build() {
            return new ChangeExternalContainerDatabaseCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExternalContainerDatabaseCompartmentResponse)) {
            return false;
        }

        ChangeExternalContainerDatabaseCompartmentResponse other =
                (ChangeExternalContainerDatabaseCompartmentResponse) o;
