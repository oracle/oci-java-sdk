...
public class ListPluggableDatabasesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.PluggableDatabaseSummary> getItems() {
        return items;
    }
    ...
    private ListPluggableDatabasesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.PluggableDatabaseSummary> items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListPluggableDatabasesResponse o) {
         ...
         */
        @Override
        public ListPluggableDatabasesResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPluggableDatabasesResponse)) {
            return false;
        }

        ListPluggableDatabasesResponse other = (ListPluggableDatabasesResponse) o;
