...
public class ConvertStandbyAutonomousContainerDatabaseResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ConvertStandbyAutonomousContainerDatabaseResponse o) {
         ...
         */
        @Override
        public ConvertStandbyAutonomousContainerDatabaseResponse build() {
            return new ConvertStandbyAutonomousContainerDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConvertStandbyAutonomousContainerDatabaseResponse)) {
            return false;
        }

        ConvertStandbyAutonomousContainerDatabaseResponse other =
                (ConvertStandbyAutonomousContainerDatabaseResponse) o;
