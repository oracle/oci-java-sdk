...
/**
 * Details of unregistering PKCS11 driver. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UnregisterExadbVmClusterPkcsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UnregisterExadbVmClusterPkcsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"tdeKeyStoreType"})
    public UnregisterExadbVmClusterPkcsDetails(TdeKeyStoreType tdeKeyStoreType) {
        super();
    ...
    public static class Builder {
        ...
        public UnregisterExadbVmClusterPkcsDetails build() {
            UnregisterExadbVmClusterPkcsDetails model =
                    new UnregisterExadbVmClusterPkcsDetails(this.tdeKeyStoreType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnregisterExadbVmClusterPkcsDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UnregisterExadbVmClusterPkcsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnregisterExadbVmClusterPkcsDetails)) {
            return false;
        }

        UnregisterExadbVmClusterPkcsDetails other = (UnregisterExadbVmClusterPkcsDetails) o;
