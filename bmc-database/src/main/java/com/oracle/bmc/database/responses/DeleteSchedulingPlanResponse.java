...
public class DeleteSchedulingPlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteSchedulingPlanResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteSchedulingPlanResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteSchedulingPlanResponse o) {
         ...
         */
        @Override
        public DeleteSchedulingPlanResponse build() {
            return new DeleteSchedulingPlanResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSchedulingPlanResponse)) {
            return false;
        }

        DeleteSchedulingPlanResponse other = (DeleteSchedulingPlanResponse) o;
