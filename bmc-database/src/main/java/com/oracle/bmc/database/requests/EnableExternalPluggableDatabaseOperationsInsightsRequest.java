...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/EnableExternalPluggableDatabaseOperationsInsightsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use EnableExternalPluggableDatabaseOperationsInsightsRequest.
 */
...
public class EnableExternalPluggableDatabaseOperationsInsightsRequest
    ...
    public static class Builder
        ...
        public Builder enableExternalPluggableDatabaseOperationsInsightsDetails(
                com.oracle.bmc.database.model
                                .EnableExternalPluggableDatabaseOperationsInsightsDetails
                        enableExternalPluggableDatabaseOperationsInsightsDetails) {
            this.enableExternalPluggableDatabaseOperationsInsightsDetails =
                    enableExternalPluggableDatabaseOperationsInsightsDetails;
            return this;
        }
         ...
         * @return instance of EnableExternalPluggableDatabaseOperationsInsightsRequest
         */
        public EnableExternalPluggableDatabaseOperationsInsightsRequest
                buildWithoutInvocationCallback() {
            EnableExternalPluggableDatabaseOperationsInsightsRequest request =
                    new EnableExternalPluggableDatabaseOperationsInsightsRequest();
            request.externalPluggableDatabaseId = externalPluggableDatabaseId;
            request.enableExternalPluggableDatabaseOperationsInsightsDetails =
                    enableExternalPluggableDatabaseOperationsInsightsDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new EnableExternalPluggableDatabaseOperationsInsightsRequest(externalPluggableDatabaseId, enableExternalPluggableDatabaseOperationsInsightsDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalPluggableDatabaseOperationsInsightsRequest)) {
            return false;
        }

        EnableExternalPluggableDatabaseOperationsInsightsRequest other =
                (EnableExternalPluggableDatabaseOperationsInsightsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.externalPluggableDatabaseId, other.externalPluggableDatabaseId)
                && java.util.Objects.equals(
                        this.enableExternalPluggableDatabaseOperationsInsightsDetails,
                        other.enableExternalPluggableDatabaseOperationsInsightsDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.enableExternalPluggableDatabaseOperationsInsightsDetails == null
                                ? 43
                                : this.enableExternalPluggableDatabaseOperationsInsightsDetails
                                        .hashCode());
        result =
