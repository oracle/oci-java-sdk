...
public class GetDatabaseSoftwareImageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDatabaseSoftwareImageResponse o) {
         ...
         */
        @Override
        public GetDatabaseSoftwareImageResponse build() {
            return new GetDatabaseSoftwareImageResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, databaseSoftwareImage);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseSoftwareImageResponse)) {
            return false;
        }

        GetDatabaseSoftwareImageResponse other = (GetDatabaseSoftwareImageResponse) o;
