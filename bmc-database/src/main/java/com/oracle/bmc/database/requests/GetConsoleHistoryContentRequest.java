...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetConsoleHistoryContentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetConsoleHistoryContentRequest.
 */
...
public class GetConsoleHistoryContentRequest
    ...
    public static class Builder
        ...
        public GetConsoleHistoryContentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetConsoleHistoryContentRequest(dbNodeId, consoleHistoryId, opcRequestId);
        }
    }
