...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ReinstateAutonomousContainerDatabaseDataguardAssociationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ReinstateAutonomousContainerDatabaseDataguardAssociationRequest.
 */
...
public class ReinstateAutonomousContainerDatabaseDataguardAssociationRequest
    ...
    public static class Builder
         ...
         * @return instance of ReinstateAutonomousContainerDatabaseDataguardAssociationRequest
         */
        public ReinstateAutonomousContainerDatabaseDataguardAssociationRequest
                buildWithoutInvocationCallback() {
            ReinstateAutonomousContainerDatabaseDataguardAssociationRequest request =
                    new ReinstateAutonomousContainerDatabaseDataguardAssociationRequest();
            ...
            return request;
            // new ReinstateAutonomousContainerDatabaseDataguardAssociationRequest(autonomousContainerDatabaseId, autonomousContainerDatabaseDataguardAssociationId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReinstateAutonomousContainerDatabaseDataguardAssociationRequest)) {
            return false;
        }

        ReinstateAutonomousContainerDatabaseDataguardAssociationRequest other =
                (ReinstateAutonomousContainerDatabaseDataguardAssociationRequest) o;
