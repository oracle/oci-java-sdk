...
public class ActivateExadataInfrastructureResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateExadataInfrastructureResponse)) {
            return false;
        }

        ActivateExadataInfrastructureResponse other = (ActivateExadataInfrastructureResponse) o;
