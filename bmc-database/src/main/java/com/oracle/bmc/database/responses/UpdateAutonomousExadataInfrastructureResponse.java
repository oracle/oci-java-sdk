...
public class UpdateAutonomousExadataInfrastructureResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutonomousExadataInfrastructureResponse)) {
            return false;
        }

        UpdateAutonomousExadataInfrastructureResponse other =
                (UpdateAutonomousExadataInfrastructureResponse) o;
