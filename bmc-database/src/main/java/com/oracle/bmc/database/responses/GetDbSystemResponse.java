...
public class GetDbSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "etag", "opcRequestId", "dbSystem"})
    ...
    public static class Builder {
        ...
        public GetDbSystemResponse build() {
            return new GetDbSystemResponse(__httpStatusCode__, etag, opcRequestId, dbSystem);
        }
    }
