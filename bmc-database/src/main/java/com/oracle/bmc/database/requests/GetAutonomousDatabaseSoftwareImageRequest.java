...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetAutonomousDatabaseSoftwareImageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAutonomousDatabaseSoftwareImageRequest.
 */
...
public class GetAutonomousDatabaseSoftwareImageRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of GetAutonomousDatabaseSoftwareImageRequest as configured by this builder
         *
        ...
        public GetAutonomousDatabaseSoftwareImageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAutonomousDatabaseSoftwareImageRequest(autonomousDatabaseSoftwareImageId, opcRequestId);
        }
    }
