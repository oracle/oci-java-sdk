...
public class UpdateExternalNonContainerDatabaseResponse
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateExternalNonContainerDatabaseResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",externalNonContainerDatabase=")
                .append(String.valueOf(externalNonContainerDatabase));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalNonContainerDatabaseResponse)) {
            return false;
        }

        UpdateExternalNonContainerDatabaseResponse other =
                (UpdateExternalNonContainerDatabaseResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcWorkRequestId, other.opcWorkRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.externalNonContainerDatabase, other.externalNonContainerDatabase);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.externalNonContainerDatabase == null
                                ? 43
                                : this.externalNonContainerDatabase.hashCode());
        return result;
    }
}
