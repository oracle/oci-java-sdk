...
public class ChangeExadataInfrastructureCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExadataInfrastructureCompartmentResponse)) {
            return false;
        }

        ChangeExadataInfrastructureCompartmentResponse other =
                (ChangeExadataInfrastructureCompartmentResponse) o;
