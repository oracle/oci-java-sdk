...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListSystemVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSystemVersionsRequest.
 */
...
public class ListSystemVersionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListSystemVersionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSystemVersionsRequest(compartmentId, shape, giVersion, limit, page, sortOrder, opcRequestId);
        }
    }
