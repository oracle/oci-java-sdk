...
public class ConfigureExascaleExadataInfrastructureResponse
    ...
    private ConfigureExascaleExadataInfrastructureResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ConfigureExascaleExadataInfrastructureResponse o) {
         ...
         */
        @Override
        public ConfigureExascaleExadataInfrastructureResponse build() {
            return new ConfigureExascaleExadataInfrastructureResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureExascaleExadataInfrastructureResponse)) {
            return false;
        }

        ConfigureExascaleExadataInfrastructureResponse other =
                (ConfigureExascaleExadataInfrastructureResponse) o;
