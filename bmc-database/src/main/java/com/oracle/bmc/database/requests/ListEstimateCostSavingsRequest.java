...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListEstimateCostSavingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEstimateCostSavingsRequest.
 */
...
public class ListEstimateCostSavingsRequest
    ...
    public static class Builder
        ...
        public ListEstimateCostSavingsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListEstimateCostSavingsRequest(isCpuAutoscale, autonomousDatabaseId, opcRequestId, limit, page);
        }
    }
