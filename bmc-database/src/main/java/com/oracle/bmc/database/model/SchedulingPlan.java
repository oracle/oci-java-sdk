...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SchedulingPlan.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SchedulingPlan extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SchedulingPlan model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SchedulingPlan)) {
            return false;
        }

        SchedulingPlan other = (SchedulingPlan) o;
