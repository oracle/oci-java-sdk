...
public class GetBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.database.model.Backup getBackup() {
        return backup;
    }

    @java.beans.ConstructorProperties({"__httpStatusCode__", "etag", "opcRequestId", "backup"})
    private GetBackupResponse(
            int __httpStatusCode__,
            String etag,
            String opcRequestId,
            com.oracle.bmc.database.model.Backup backup) {
    ...
    public static class Builder {
        ...
        public Builder backup(com.oracle.bmc.database.model.Backup backup) {
            this.backup = backup;
            return this;
        }
        ...
        public GetBackupResponse build() {
            return new GetBackupResponse(__httpStatusCode__, etag, opcRequestId, backup);
        }
    }
