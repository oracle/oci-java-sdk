...
public class UpdateOneoffPatchResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateOneoffPatchResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateOneoffPatchResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateOneoffPatchResponse o) {
         ...
         */
        @Override
        public UpdateOneoffPatchResponse build() {
            return new UpdateOneoffPatchResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, oneoffPatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOneoffPatchResponse)) {
            return false;
        }

        UpdateOneoffPatchResponse other = (UpdateOneoffPatchResponse) o;
