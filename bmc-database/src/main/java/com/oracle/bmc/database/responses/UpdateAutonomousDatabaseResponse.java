...
public class UpdateAutonomousDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateAutonomousDatabaseResponse o) {
         ...
         */
        @Override
        public UpdateAutonomousDatabaseResponse build() {
            return new UpdateAutonomousDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutonomousDatabaseResponse)) {
            return false;
        }

        UpdateAutonomousDatabaseResponse other = (UpdateAutonomousDatabaseResponse) o;
