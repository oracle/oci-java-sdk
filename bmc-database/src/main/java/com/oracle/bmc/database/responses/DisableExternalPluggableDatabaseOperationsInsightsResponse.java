...
public class DisableExternalPluggableDatabaseOperationsInsightsResponse
    ...
    private DisableExternalPluggableDatabaseOperationsInsightsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public DisableExternalPluggableDatabaseOperationsInsightsResponse build() {
            return new DisableExternalPluggableDatabaseOperationsInsightsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalPluggableDatabaseOperationsInsightsResponse)) {
            return false;
        }

        DisableExternalPluggableDatabaseOperationsInsightsResponse other =
                (DisableExternalPluggableDatabaseOperationsInsightsResponse) o;
