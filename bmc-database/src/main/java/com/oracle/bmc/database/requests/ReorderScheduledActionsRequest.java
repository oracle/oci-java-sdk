...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ReorderScheduledActionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ReorderScheduledActionsRequest.
 */
...
public class ReorderScheduledActionsRequest
    ...
    public static class Builder
        ...
        public ReorderScheduledActionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ReorderScheduledActionsRequest(reorderScheduledActionsDetails, schedulingPlanId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
