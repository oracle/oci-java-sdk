...
/**
 * Details for updating the Exadata Database Storage Vault. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateExascaleDbStorageVaultDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateExascaleDbStorageVaultDetails
    ...
    public static class Builder {
        ...
        public UpdateExascaleDbStorageVaultDetails build() {
            UpdateExascaleDbStorageVaultDetails model =
                    new UpdateExascaleDbStorageVaultDetails(
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateExascaleDbStorageVaultDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExascaleDbStorageVaultDetails)) {
            return false;
        }

        UpdateExascaleDbStorageVaultDetails other = (UpdateExascaleDbStorageVaultDetails) o;
