...
public class RotatePluggableDatabaseEncryptionKeyResponse
    ...
    private RotatePluggableDatabaseEncryptionKeyResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RotatePluggableDatabaseEncryptionKeyResponse o) {
         ...
         */
        @Override
        public RotatePluggableDatabaseEncryptionKeyResponse build() {
            return new RotatePluggableDatabaseEncryptionKeyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotatePluggableDatabaseEncryptionKeyResponse)) {
            return false;
        }

        RotatePluggableDatabaseEncryptionKeyResponse other =
                (RotatePluggableDatabaseEncryptionKeyResponse) o;
