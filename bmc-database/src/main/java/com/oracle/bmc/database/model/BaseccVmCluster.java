...
/**
 * Details of the BaseDB-C@C VM cluster resource. Applies to Base Database Service on Cloud@Customer
 * instances only. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BaseccVmCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BaseccVmCluster
    ...
    public static class Builder {
        ...
        public BaseccVmCluster build() {
            BaseccVmCluster model =
                    new BaseccVmCluster(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BaseccVmCluster model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseccVmCluster)) {
            return false;
        }

        BaseccVmCluster other = (BaseccVmCluster) o;
