...
public class GenerateRecommendedVmClusterNetworkResponse
    ...
    public String toString() {
        ...
        sb.append(",vmClusterNetworkDetails=").append(String.valueOf(vmClusterNetworkDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateRecommendedVmClusterNetworkResponse)) {
            return false;
        }

        GenerateRecommendedVmClusterNetworkResponse other =
                (GenerateRecommendedVmClusterNetworkResponse) o;
