...
public class UnregisterCloudVmClusterPkcsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UnregisterCloudVmClusterPkcsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UnregisterCloudVmClusterPkcsResponse o) {
         ...
         */
        @Override
        public UnregisterCloudVmClusterPkcsResponse build() {
            return new UnregisterCloudVmClusterPkcsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnregisterCloudVmClusterPkcsResponse)) {
            return false;
        }

        UnregisterCloudVmClusterPkcsResponse other = (UnregisterCloudVmClusterPkcsResponse) o;
