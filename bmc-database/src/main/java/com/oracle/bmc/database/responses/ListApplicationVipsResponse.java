...
public class ListApplicationVipsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.ApplicationVipSummary> getItems() {
        return items;
    }
    ...
    private ListApplicationVipsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.ApplicationVipSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListApplicationVipsResponse> {
         ...
         */
        @Override
        public Builder copy(ListApplicationVipsResponse o) {
         ...
         */
        @Override
        public ListApplicationVipsResponse build() {
            return new ListApplicationVipsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListApplicationVipsResponse)) {
            return false;
        }

        ListApplicationVipsResponse other = (ListApplicationVipsResponse) o;
