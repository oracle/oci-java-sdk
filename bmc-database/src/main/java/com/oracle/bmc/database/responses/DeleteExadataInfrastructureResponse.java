...
public class DeleteExadataInfrastructureResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteExadataInfrastructureResponse(
    ...
    public static class Builder {
        ...
        public DeleteExadataInfrastructureResponse build() {
            return new DeleteExadataInfrastructureResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExadataInfrastructureResponse)) {
            return false;
        }

        DeleteExadataInfrastructureResponse other = (DeleteExadataInfrastructureResponse) o;
