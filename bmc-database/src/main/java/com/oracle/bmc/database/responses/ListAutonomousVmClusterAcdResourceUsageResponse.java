...
public class ListAutonomousVmClusterAcdResourceUsageResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousVmClusterAcdResourceUsageResponse)) {
            return false;
        }

        ListAutonomousVmClusterAcdResourceUsageResponse other =
                (ListAutonomousVmClusterAcdResourceUsageResponse) o;
