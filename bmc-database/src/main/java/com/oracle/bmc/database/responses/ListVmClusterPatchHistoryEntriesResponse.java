...
public class ListVmClusterPatchHistoryEntriesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.PatchHistoryEntrySummary> getItems() {
        return items;
    }
    ...
    private ListVmClusterPatchHistoryEntriesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.PatchHistoryEntrySummary> items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public ListVmClusterPatchHistoryEntriesResponse build() {
            return new ListVmClusterPatchHistoryEntriesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVmClusterPatchHistoryEntriesResponse)) {
            return false;
        }

        ListVmClusterPatchHistoryEntriesResponse other =
                (ListVmClusterPatchHistoryEntriesResponse) o;
