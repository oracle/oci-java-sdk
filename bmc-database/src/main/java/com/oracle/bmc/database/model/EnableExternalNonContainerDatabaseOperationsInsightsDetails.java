...
/**
 * Details to enable Operations Insights on the external non-container database <br>
...
public final class EnableExternalNonContainerDatabaseOperationsInsightsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalDatabaseConnectorId"})
    public EnableExternalNonContainerDatabaseOperationsInsightsDetails(
    ...
    public static class Builder {
        ...
        public EnableExternalNonContainerDatabaseOperationsInsightsDetails build() {
            EnableExternalNonContainerDatabaseOperationsInsightsDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalNonContainerDatabaseOperationsInsightsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalNonContainerDatabaseOperationsInsightsDetails)) {
            return false;
        }

        EnableExternalNonContainerDatabaseOperationsInsightsDetails other =
                (EnableExternalNonContainerDatabaseOperationsInsightsDetails) o;
