...
public class CreateCloudVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCloudVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(CreateCloudVmClusterResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCloudVmClusterResponse)) {
            return false;
        }

        CreateCloudVmClusterResponse other = (CreateCloudVmClusterResponse) o;
