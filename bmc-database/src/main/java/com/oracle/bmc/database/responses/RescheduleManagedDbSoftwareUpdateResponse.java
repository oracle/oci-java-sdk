...
public class RescheduleManagedDbSoftwareUpdateResponse
    ...
    private RescheduleManagedDbSoftwareUpdateResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RescheduleManagedDbSoftwareUpdateResponse o) {
         ...
         */
        @Override
        public RescheduleManagedDbSoftwareUpdateResponse build() {
            return new RescheduleManagedDbSoftwareUpdateResponse(
                    __httpStatusCode__, headers, opcWorkRequestId, opcRequestId, etag, database);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RescheduleManagedDbSoftwareUpdateResponse)) {
            return false;
        }

        RescheduleManagedDbSoftwareUpdateResponse other =
                (RescheduleManagedDbSoftwareUpdateResponse) o;
