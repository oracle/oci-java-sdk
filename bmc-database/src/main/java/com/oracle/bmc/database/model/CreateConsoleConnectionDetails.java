...
public final class CreateConsoleConnectionDetails
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"publicKey", "freeformTags", "definedTags"})
    public CreateConsoleConnectionDetails(
            String publicKey,
    ...
    public static class Builder {
        ...
        public CreateConsoleConnectionDetails build() {
            CreateConsoleConnectionDetails model =
                    new CreateConsoleConnectionDetails(
                            this.publicKey, this.freeformTags, this.definedTags);
