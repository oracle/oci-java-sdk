...
public class GetDbSystemPatchResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDbSystemPatchResponse> {
        ...
        public GetDbSystemPatchResponse build() {
            return new GetDbSystemPatchResponse(__httpStatusCode__, headers, opcRequestId, patch);
        }
    }
