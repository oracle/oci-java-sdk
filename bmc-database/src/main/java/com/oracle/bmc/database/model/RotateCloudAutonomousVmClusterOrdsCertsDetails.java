...
public final class RotateCloudAutonomousVmClusterOrdsCertsDetails
    ...
    public RotateCloudAutonomousVmClusterOrdsCertsDetails(
    ...
    public static class Builder {
        ...
        public RotateCloudAutonomousVmClusterOrdsCertsDetails build() {
            RotateCloudAutonomousVmClusterOrdsCertsDetails model =
                    new RotateCloudAutonomousVmClusterOrdsCertsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RotateCloudAutonomousVmClusterOrdsCertsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateCloudAutonomousVmClusterOrdsCertsDetails)) {
            return false;
        }

        RotateCloudAutonomousVmClusterOrdsCertsDetails other =
                (RotateCloudAutonomousVmClusterOrdsCertsDetails) o;
