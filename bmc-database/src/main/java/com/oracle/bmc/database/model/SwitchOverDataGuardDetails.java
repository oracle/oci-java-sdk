...
/**
 * The Data Guard switchover parameters. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SwitchOverDataGuardDetails.Builder.class)
...
public final class SwitchOverDataGuardDetails
    ...
    public static class Builder {
        ...
        public SwitchOverDataGuardDetails build() {
            SwitchOverDataGuardDetails model =
                    new SwitchOverDataGuardDetails(this.databaseAdminPassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchOverDataGuardDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchOverDataGuardDetails)) {
            return false;
        }

        SwitchOverDataGuardDetails other = (SwitchOverDataGuardDetails) o;
