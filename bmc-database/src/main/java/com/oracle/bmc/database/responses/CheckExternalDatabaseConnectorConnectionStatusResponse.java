...
public class CheckExternalDatabaseConnectorConnectionStatusResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckExternalDatabaseConnectorConnectionStatusResponse)) {
            return false;
        }

        CheckExternalDatabaseConnectorConnectionStatusResponse other =
                (CheckExternalDatabaseConnectorConnectionStatusResponse) o;
