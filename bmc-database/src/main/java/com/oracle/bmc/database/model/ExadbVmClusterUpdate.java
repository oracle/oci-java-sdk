...
public final class ExadbVmClusterUpdate
    ...
    public static class Builder {
        ...
        public ExadbVmClusterUpdate build() {
            ExadbVmClusterUpdate model =
                    new ExadbVmClusterUpdate(
                            this.id,
                            this.description,
                            this.lastAction,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadbVmClusterUpdate model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadbVmClusterUpdate(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadbVmClusterUpdate)) {
            return false;
        }

        ExadbVmClusterUpdate other = (ExadbVmClusterUpdate) o;
