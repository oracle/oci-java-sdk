...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeAutonomousExadataInfrastructureCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAutonomousExadataInfrastructureCompartmentRequest.
 */
...
public class ChangeAutonomousExadataInfrastructureCompartmentRequest
    ...
    public static class Builder
         ...
         * @return instance of ChangeAutonomousExadataInfrastructureCompartmentRequest
         */
        public ChangeAutonomousExadataInfrastructureCompartmentRequest
                buildWithoutInvocationCallback() {
            ChangeAutonomousExadataInfrastructureCompartmentRequest request =
                    new ChangeAutonomousExadataInfrastructureCompartmentRequest();
            ...
            return request;
            // new ChangeAutonomousExadataInfrastructureCompartmentRequest(changeCompartmentDetails, autonomousExadataInfrastructureId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAutonomousExadataInfrastructureCompartmentRequest)) {
            return false;
        }

        ChangeAutonomousExadataInfrastructureCompartmentRequest other =
                (ChangeAutonomousExadataInfrastructureCompartmentRequest) o;
