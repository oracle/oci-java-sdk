...
public class UpdateConsoleHistoryConverter {
    ...
    public static com.oracle.bmc.database.requests.UpdateConsoleHistoryRequest interceptRequest(
            com.oracle.bmc.database.requests.UpdateConsoleHistoryRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.database.responses.UpdateConsoleHistoryResponse>() {
                            @Override
                            public com.oracle.bmc.database.responses.UpdateConsoleHistoryResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.database.responses.UpdateConsoleHistoryResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
