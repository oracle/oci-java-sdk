...
public class GetVmClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVmClusterNetworkResponse> {
        ...
        public GetVmClusterNetworkResponse build() {
            return new GetVmClusterNetworkResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, vmClusterNetwork);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVmClusterNetworkResponse)) {
            return false;
        }

        GetVmClusterNetworkResponse other = (GetVmClusterNetworkResponse) o;
