...
public class DisableExternalNonContainerDatabaseOperationsInsightsResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public DisableExternalNonContainerDatabaseOperationsInsightsResponse build() {
            return new DisableExternalNonContainerDatabaseOperationsInsightsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalNonContainerDatabaseOperationsInsightsResponse)) {
            return false;
        }

        DisableExternalNonContainerDatabaseOperationsInsightsResponse other =
                (DisableExternalNonContainerDatabaseOperationsInsightsResponse) o;
