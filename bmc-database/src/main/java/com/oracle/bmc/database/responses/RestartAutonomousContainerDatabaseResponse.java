...
public class RestartAutonomousContainerDatabaseResponse
    ...
    private RestartAutonomousContainerDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartAutonomousContainerDatabaseResponse)) {
            return false;
        }

        RestartAutonomousContainerDatabaseResponse other =
                (RestartAutonomousContainerDatabaseResponse) o;
