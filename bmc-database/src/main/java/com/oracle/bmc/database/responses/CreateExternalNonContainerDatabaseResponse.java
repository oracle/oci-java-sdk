...
public class CreateExternalNonContainerDatabaseResponse
    ...
    private CreateExternalNonContainerDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateExternalNonContainerDatabaseResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExternalNonContainerDatabaseResponse)) {
            return false;
        }

        CreateExternalNonContainerDatabaseResponse other =
                (CreateExternalNonContainerDatabaseResponse) o;
