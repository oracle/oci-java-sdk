...
public final class SaasAdminUserConfiguration
    ...
    public SaasAdminUserConfiguration(
            String password,
            String secretId,
    ...
    public static class Builder {
        ...
        public SaasAdminUserConfiguration build() {
            SaasAdminUserConfiguration model =
                    new SaasAdminUserConfiguration(
                            this.password,
                            this.secretId,
    ...
    public boolean equals(Object o) {
        ...
        SaasAdminUserConfiguration other = (SaasAdminUserConfiguration) o;
