...
/**
 * The exascale config request details for the Cloud Exadata infrastructure. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConfigureExascaleCloudExadataInfrastructureDetails.Builder.class)
...
public final class ConfigureExascaleCloudExadataInfrastructureDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureExascaleCloudExadataInfrastructureDetails)) {
            return false;
        }
