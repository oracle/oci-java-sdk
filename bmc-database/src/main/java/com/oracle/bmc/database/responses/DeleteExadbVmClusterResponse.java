...
public class DeleteExadbVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteExadbVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteExadbVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteExadbVmClusterResponse o) {
         ...
         */
        @Override
        public DeleteExadbVmClusterResponse build() {
            return new DeleteExadbVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExadbVmClusterResponse)) {
            return false;
        }

        DeleteExadbVmClusterResponse other = (DeleteExadbVmClusterResponse) o;
