...
public class ChangeExascaleDbStorageVaultCompartmentResponse
    ...
    private ChangeExascaleDbStorageVaultCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeExascaleDbStorageVaultCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeExascaleDbStorageVaultCompartmentResponse build() {
            return new ChangeExascaleDbStorageVaultCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeExascaleDbStorageVaultCompartmentResponse)) {
            return false;
        }

        ChangeExascaleDbStorageVaultCompartmentResponse other =
                (ChangeExascaleDbStorageVaultCompartmentResponse) o;
