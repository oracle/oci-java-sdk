...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/AddVirtualMachineToVmClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddVirtualMachineToVmClusterRequest.
 */
...
public class AddVirtualMachineToVmClusterRequest
    ...
    public static class Builder
        ...
        public AddVirtualMachineToVmClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddVirtualMachineToVmClusterRequest(addVirtualMachineToVmClusterDetails, vmClusterId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
