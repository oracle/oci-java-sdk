...
public class ListDatabaseSoftwareImagesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DatabaseSoftwareImageSummary> getItems() {
        return items;
    }
    ...
    private ListDatabaseSoftwareImagesResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.DatabaseSoftwareImageSummary> items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListDatabaseSoftwareImagesResponse o) {
         ...
         */
        @Override
        public ListDatabaseSoftwareImagesResponse build() {
            return new ListDatabaseSoftwareImagesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseSoftwareImagesResponse)) {
            return false;
        }

        ListDatabaseSoftwareImagesResponse other = (ListDatabaseSoftwareImagesResponse) o;
