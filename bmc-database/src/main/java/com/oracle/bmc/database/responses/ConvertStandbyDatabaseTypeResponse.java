...
public class ConvertStandbyDatabaseTypeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ConvertStandbyDatabaseTypeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ConvertStandbyDatabaseTypeResponse o) {
         ...
         */
        @Override
        public ConvertStandbyDatabaseTypeResponse build() {
            return new ConvertStandbyDatabaseTypeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConvertStandbyDatabaseTypeResponse)) {
            return false;
        }

        ConvertStandbyDatabaseTypeResponse other = (ConvertStandbyDatabaseTypeResponse) o;
