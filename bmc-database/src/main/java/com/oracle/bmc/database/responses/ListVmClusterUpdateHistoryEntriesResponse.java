...
public class ListVmClusterUpdateHistoryEntriesResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.VmClusterUpdateHistoryEntrySummary>
            getItems() {
        return items;
    }
    ...
    private ListVmClusterUpdateHistoryEntriesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.VmClusterUpdateHistoryEntrySummary>
                    items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListVmClusterUpdateHistoryEntriesResponse o) {
         ...
         */
        @Override
        public ListVmClusterUpdateHistoryEntriesResponse build() {
            return new ListVmClusterUpdateHistoryEntriesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVmClusterUpdateHistoryEntriesResponse)) {
            return false;
        }

        ListVmClusterUpdateHistoryEntriesResponse other =
                (ListVmClusterUpdateHistoryEntriesResponse) o;
