...
public class CreateDatabaseFromBackup extends CreateDatabaseBase {
    ...
    public static class Builder {
        ...
        public CreateDatabaseFromBackup build() {
            CreateDatabaseFromBackup __instance__ =
                    new CreateDatabaseFromBackup(dbHomeId, dbVersion, database);
    ...
    public CreateDatabaseFromBackup(
            String dbHomeId, String dbVersion, CreateDatabaseFromBackupDetails database) {
