...
public class MigrateAutonomousContainerDatabaseDataguardAssociationResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrateAutonomousContainerDatabaseDataguardAssociationResponse)) {
            return false;
        }

        MigrateAutonomousContainerDatabaseDataguardAssociationResponse other =
                (MigrateAutonomousContainerDatabaseDataguardAssociationResponse) o;
