...
public class UpdateCloudVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateCloudVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateCloudVmClusterResponse o) {
        ...
        public UpdateCloudVmClusterResponse build() {
            return new UpdateCloudVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCloudVmClusterResponse)) {
            return false;
        }

        UpdateCloudVmClusterResponse other = (UpdateCloudVmClusterResponse) o;
