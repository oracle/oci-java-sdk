...
public final class UpdateDbSystemDetails
    ...
    public static class Builder {
        /**
         * The new number of CPU cores to set for the DB system. Not applicable for INTEL based
         ...
         * public keys can be provided. The length of the combined keys cannot exceed 40,000
         * characters.
         */
         ...
         * system. This value must be greater than current storage size. Note that the resulting
         * total storage size attached will be greater than the amount requested to allow for
         * REDO/RECO space and software volume. Applies only to virtual machine DB systems.
         */
         ...
         * DB system. This value must be greater than current storage size. Note that the resulting
         * total storage size attached will be greater than the amount requested to allow for the
        ...
        /**
         * The Oracle Database license model that applies to all databases on the DB system. The
    ...
    /**
     * The new number of CPU cores to set for the DB system. Not applicable for INTEL based virtual
     * machine DB systems.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("cpuCoreCount")
    ...
    /**
     * The size, in gigabytes, to scale the attached storage up to for this virtual machine DB
     * system. This value must be greater than current storage size. Note that the resulting total
     * storage size attached will be greater than the amount requested to allow for REDO/RECO space
     * and software volume. Applies only to virtual machine DB systems.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("dataStorageSizeInGBs")
     ...
     * system. This value must be greater than current storage size. Note that the resulting total
     * storage size attached will be greater than the amount requested to allow for the software
     * volume. Applies only to virtual machine DB systems.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("recoStorageSizeInGBs")
     ...
     * virtual machine shapes, the number of CPU cores and memory
     *
     * <p>To get a list of shapes, use the {@link #listDbSystemShapes(ListDbSystemShapesRequest)
     * listDbSystemShapes} operation.
     */
    ...
    /**
     * The Oracle Database license model that applies to all databases on the DB system. The default
     * is LICENSE_INCLUDED.
     */
