...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousDbPreviewVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousDbPreviewVersionsRequest.
 */
...
public class ListAutonomousDbPreviewVersionsRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ListAutonomousDbPreviewVersionsRequest o) {
         ...
         */
        public ListAutonomousDbPreviewVersionsRequest build() {
            ListAutonomousDbPreviewVersionsRequest request = buildWithoutInvocationCallback();
