...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetBaseccVmClusterUpdateHistoryEntryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBaseccVmClusterUpdateHistoryEntryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetBaseccVmClusterUpdateHistoryEntryRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBaseccVmClusterUpdateHistoryEntryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetBaseccVmClusterUpdateHistoryEntryRequest o) {
        ...
        /**
         * Build the instance of GetBaseccVmClusterUpdateHistoryEntryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetBaseccVmClusterUpdateHistoryEntryRequest
         */
        public GetBaseccVmClusterUpdateHistoryEntryRequest build() {
            GetBaseccVmClusterUpdateHistoryEntryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBaseccVmClusterUpdateHistoryEntryRequest
         */
        public GetBaseccVmClusterUpdateHistoryEntryRequest buildWithoutInvocationCallback() {
            GetBaseccVmClusterUpdateHistoryEntryRequest request =
                    new GetBaseccVmClusterUpdateHistoryEntryRequest();
            request.baseccVmClusterId = baseccVmClusterId;
            request.updateHistoryEntryId = updateHistoryEntryId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetBaseccVmClusterUpdateHistoryEntryRequest(baseccVmClusterId, updateHistoryEntryId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBaseccVmClusterUpdateHistoryEntryRequest)) {
            return false;
        }

        GetBaseccVmClusterUpdateHistoryEntryRequest other =
                (GetBaseccVmClusterUpdateHistoryEntryRequest) o;
