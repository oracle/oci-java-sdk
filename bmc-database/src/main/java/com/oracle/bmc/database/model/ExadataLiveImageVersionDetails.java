...
/**
 * Details about the most recent live image version applied on the VM Cluster, if any. If a full OS
 * update was applied, the fields would be blank. <br>
...
public final class ExadataLiveImageVersionDetails
    ...
    public static class Builder {
        ...
        /**
         * Indicates whether OS updates that require node reboot are pending after the previous
         * online update was applied.
         */
    ...
    /**
     * Indicates whether OS updates that require node reboot are pending after the previous online
     * update was applied.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("hasPendingUpdates")
