...
public class GetVmClusterUpdateHistoryEntryResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.database.model.VmClusterUpdateHistoryEntry
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder vmClusterUpdateHistoryEntry(
         ...
         */
        @Override
        public Builder copy(GetVmClusterUpdateHistoryEntryResponse o) {
        ...
        public GetVmClusterUpdateHistoryEntryResponse build() {
            return new GetVmClusterUpdateHistoryEntryResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, vmClusterUpdateHistoryEntry);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",vmClusterUpdateHistoryEntry=")
                .append(String.valueOf(vmClusterUpdateHistoryEntry));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVmClusterUpdateHistoryEntryResponse)) {
            return false;
        }

        GetVmClusterUpdateHistoryEntryResponse other = (GetVmClusterUpdateHistoryEntryResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.vmClusterUpdateHistoryEntry, other.vmClusterUpdateHistoryEntry);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.vmClusterUpdateHistoryEntry == null
                                ? 43
                                : this.vmClusterUpdateHistoryEntry.hashCode());
        return result;
    }
}
