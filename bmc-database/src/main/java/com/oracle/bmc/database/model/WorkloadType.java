...
public final class WorkloadType extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public WorkloadType build() {
            WorkloadType model = new WorkloadType(this.atp, this.adw);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WorkloadType model) {
            if (model.wasPropertyExplicitlySet("atp")) {
                this.atp(model.getAtp());
            }
            if (model.wasPropertyExplicitlySet("adw")) {
                this.adw(model.getAdw());
            }
            return this;
        }
    }
