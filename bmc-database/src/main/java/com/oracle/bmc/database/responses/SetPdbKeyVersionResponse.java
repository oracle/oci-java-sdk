...
public class SetPdbKeyVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private SetPdbKeyVersionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<SetPdbKeyVersionResponse> {
         ...
         */
        @Override
        public Builder copy(SetPdbKeyVersionResponse o) {
         ...
         */
        @Override
        public SetPdbKeyVersionResponse build() {
            return new SetPdbKeyVersionResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetPdbKeyVersionResponse)) {
            return false;
        }

        SetPdbKeyVersionResponse other = (SetPdbKeyVersionResponse) o;
