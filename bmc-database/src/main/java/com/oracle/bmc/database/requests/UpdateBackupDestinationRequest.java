...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateBackupDestinationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBackupDestinationRequest.
 */
...
public class UpdateBackupDestinationRequest
    ...
    public static class Builder
        ...
        public Builder updateBackupDestinationDetails(
                com.oracle.bmc.database.model.UpdateBackupDestinationDetails
                        updateBackupDestinationDetails) {
            this.updateBackupDestinationDetails = updateBackupDestinationDetails;
            return this;
        }
         ...
         * @return instance of UpdateBackupDestinationRequest
         */
        public UpdateBackupDestinationRequest buildWithoutInvocationCallback() {
            UpdateBackupDestinationRequest request = new UpdateBackupDestinationRequest();
            request.backupDestinationId = backupDestinationId;
            request.updateBackupDestinationDetails = updateBackupDestinationDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateBackupDestinationDetails=")
                .append(String.valueOf(this.updateBackupDestinationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBackupDestinationRequest)) {
            return false;
        }

        UpdateBackupDestinationRequest other = (UpdateBackupDestinationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.backupDestinationId, other.backupDestinationId)
                && java.util.Objects.equals(
                        this.updateBackupDestinationDetails, other.updateBackupDestinationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateBackupDestinationDetails == null
                                ? 43
                                : this.updateBackupDestinationDetails.hashCode());
