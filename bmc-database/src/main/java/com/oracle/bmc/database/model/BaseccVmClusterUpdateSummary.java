...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BaseccVmClusterUpdateSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BaseccVmClusterUpdateSummary
    ...
    public BaseccVmClusterUpdateSummary(
            String id,
            String description,
    ...
    public static class Builder {
        ...
        public BaseccVmClusterUpdateSummary build() {
            BaseccVmClusterUpdateSummary model =
                    new BaseccVmClusterUpdateSummary(
                            this.id,
                            this.description,
                            this.lastAction,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BaseccVmClusterUpdateSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BaseccVmClusterUpdateSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseccVmClusterUpdateSummary)) {
            return false;
        }

        BaseccVmClusterUpdateSummary other = (BaseccVmClusterUpdateSummary) o;
