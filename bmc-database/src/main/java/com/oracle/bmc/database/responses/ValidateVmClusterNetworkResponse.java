...
public class ValidateVmClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public ValidateVmClusterNetworkResponse build() {
            return new ValidateVmClusterNetworkResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateVmClusterNetworkResponse)) {
            return false;
        }

        ValidateVmClusterNetworkResponse other = (ValidateVmClusterNetworkResponse) o;
