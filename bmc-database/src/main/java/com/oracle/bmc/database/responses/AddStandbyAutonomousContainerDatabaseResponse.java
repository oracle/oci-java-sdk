...
public class AddStandbyAutonomousContainerDatabaseResponse
    ...
    private AddStandbyAutonomousContainerDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(AddStandbyAutonomousContainerDatabaseResponse o) {
         ...
         */
        @Override
        public AddStandbyAutonomousContainerDatabaseResponse build() {
            return new AddStandbyAutonomousContainerDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddStandbyAutonomousContainerDatabaseResponse)) {
            return false;
        }

        AddStandbyAutonomousContainerDatabaseResponse other =
                (AddStandbyAutonomousContainerDatabaseResponse) o;
