...
public class ChangeAutonomousVmClusterCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAutonomousVmClusterCompartmentResponse)) {
            return false;
        }

        ChangeAutonomousVmClusterCompartmentResponse other =
                (ChangeAutonomousVmClusterCompartmentResponse) o;
