...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetExecutionWindowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetExecutionWindowRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetExecutionWindowRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetExecutionWindowRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetExecutionWindowRequest
         */
        public GetExecutionWindowRequest build() {
            GetExecutionWindowRequest request = buildWithoutInvocationCallback();
        ...
        public GetExecutionWindowRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetExecutionWindowRequest(executionWindowId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().executionWindowId(executionWindowId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetExecutionWindowRequest other = (GetExecutionWindowRequest) o;
