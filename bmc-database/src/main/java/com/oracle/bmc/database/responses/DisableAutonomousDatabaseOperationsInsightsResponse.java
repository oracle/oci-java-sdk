...
public class DisableAutonomousDatabaseOperationsInsightsResponse
    ...
    private DisableAutonomousDatabaseOperationsInsightsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DisableAutonomousDatabaseOperationsInsightsResponse o) {
         ...
         */
        @Override
        public DisableAutonomousDatabaseOperationsInsightsResponse build() {
            return new DisableAutonomousDatabaseOperationsInsightsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableAutonomousDatabaseOperationsInsightsResponse)) {
            return false;
        }

        DisableAutonomousDatabaseOperationsInsightsResponse other =
                (DisableAutonomousDatabaseOperationsInsightsResponse) o;
