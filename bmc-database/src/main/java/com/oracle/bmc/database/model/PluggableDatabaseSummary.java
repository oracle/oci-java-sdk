...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = PluggableDatabaseSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class PluggableDatabaseSummary {
    @Deprecated
    ...
    public static class Builder {
        ...
        public PluggableDatabaseSummary build() {
            PluggableDatabaseSummary __instance__ =
                    new PluggableDatabaseSummary(
                            id,
                            containerDatabaseId,
                            pdbName,
                            lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PluggableDatabaseSummary o) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PluggableDatabaseSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PluggableDatabaseSummary)) {
            return false;
        }

        PluggableDatabaseSummary other = (PluggableDatabaseSummary) o;
