...
public class UpdateConsoleConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateConsoleConnectionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateConsoleConnectionResponse o) {
         ...
         */
        @Override
        public UpdateConsoleConnectionResponse build() {
            return new UpdateConsoleConnectionResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateConsoleConnectionResponse)) {
            return false;
        }

        UpdateConsoleConnectionResponse other = (UpdateConsoleConnectionResponse) o;
