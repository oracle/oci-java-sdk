...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListDbConnectionBundlesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDbConnectionBundlesRequest.
 */
...
public class ListDbConnectionBundlesRequest
    ...
    public static class Builder
        ...
        public ListDbConnectionBundlesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDbConnectionBundlesRequest(compartmentId, limit, page, sortOrder, sortBy, lifecycleState, opcRequestId, displayName, dbConnectionBundleType, associatedResourceId);
        }
    }
