...
public class DeleteExadbVmClusterConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteExadbVmClusterConverter.class);

    public static com.oracle.bmc.database.requests.DeleteExadbVmClusterRequest interceptRequest(
            com.oracle.bmc.database.requests.DeleteExadbVmClusterRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.database.responses.DeleteExadbVmClusterResponse>() {
                            @Override
                            public com.oracle.bmc.database.responses.DeleteExadbVmClusterResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.database.responses.DeleteExadbVmClusterResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
