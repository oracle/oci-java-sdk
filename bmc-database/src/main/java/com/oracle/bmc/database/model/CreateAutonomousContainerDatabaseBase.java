...
public class CreateAutonomousContainerDatabaseBase
    ...
    /**
     * The source of the database. Use {@code NONE} to create a new Autonomous Container Database (ACD). Use {@code BACKUP_FROM_ID} to create a new ACD from a specified backup.
     *
     **/
    public enum Source {
        None("NONE"),
