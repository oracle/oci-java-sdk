...
public class ListDbSystemPatchesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListDbSystemPatchesResponse> {
        ...
        public ListDbSystemPatchesResponse build() {
            return new ListDbSystemPatchesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemPatchesResponse)) {
            return false;
        }

        ListDbSystemPatchesResponse other = (ListDbSystemPatchesResponse) o;
