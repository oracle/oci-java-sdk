...
public class UpdateDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDatabaseResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseResponse)) {
            return false;
        }

        UpdateDatabaseResponse other = (UpdateDatabaseResponse) o;
