...
public class ListAutonomousExadataInfrastructureShapesResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousExadataInfrastructureShapesResponse)) {
            return false;
        }

        ListAutonomousExadataInfrastructureShapesResponse other =
                (ListAutonomousExadataInfrastructureShapesResponse) o;
