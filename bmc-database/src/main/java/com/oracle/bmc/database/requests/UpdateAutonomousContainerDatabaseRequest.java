...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateAutonomousContainerDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAutonomousContainerDatabaseRequest.
 */
...
public class UpdateAutonomousContainerDatabaseRequest
    ...
    public static class Builder
        ...
        /**
         * Request to update the properties of an Autonomous Container Database.
         * @param updateAutonomousContainerDatabaseDetails the value to set
         * @return this builder instance
         */
