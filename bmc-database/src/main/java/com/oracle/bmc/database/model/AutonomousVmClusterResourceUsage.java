...
public final class AutonomousVmClusterResourceUsage
    ...
    public static class Builder {
        ...
        public AutonomousVmClusterResourceUsage build() {
            AutonomousVmClusterResourceUsage model =
                    new AutonomousVmClusterResourceUsage(
                            this.displayName,
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousVmClusterResourceUsage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousVmClusterResourceUsage)) {
            return false;
        }

        AutonomousVmClusterResourceUsage other = (AutonomousVmClusterResourceUsage) o;
