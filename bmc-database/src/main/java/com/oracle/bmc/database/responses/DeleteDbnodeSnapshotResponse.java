...
public class DeleteDbnodeSnapshotResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteDbnodeSnapshotResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteDbnodeSnapshotResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteDbnodeSnapshotResponse o) {
         ...
         */
        @Override
        public DeleteDbnodeSnapshotResponse build() {
            return new DeleteDbnodeSnapshotResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDbnodeSnapshotResponse)) {
            return false;
        }

        DeleteDbnodeSnapshotResponse other = (DeleteDbnodeSnapshotResponse) o;
