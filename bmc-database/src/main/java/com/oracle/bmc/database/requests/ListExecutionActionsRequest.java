 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExecutionActionsRequest.
 */
...
public class ListExecutionActionsRequest
    ...
    public static class Builder
        ...
        public ListExecutionActionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListExecutionActionsRequest(compartmentId, limit, page, opcRequestId, sortBy,
            // sortOrder, lifecycleState, executionWindowId, displayName);
        }
    }
