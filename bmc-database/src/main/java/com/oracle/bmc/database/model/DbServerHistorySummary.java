...
/**
 * Details of a database server maintenance history. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbServerHistorySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class DbServerHistorySummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "displayName", "dbServerPatchingDetails"})
    public DbServerHistorySummary(
            String id, String displayName, DbServerPatchingDetails dbServerPatchingDetails) {
        super();
        this.id = id;
    ...
    public static class Builder {
        ...
        public DbServerHistorySummary build() {
            DbServerHistorySummary model =
                    new DbServerHistorySummary(
                            this.id, this.displayName, this.dbServerPatchingDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbServerHistorySummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbServerHistorySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbServerHistorySummary)) {
            return false;
        }

        DbServerHistorySummary other = (DbServerHistorySummary) o;
