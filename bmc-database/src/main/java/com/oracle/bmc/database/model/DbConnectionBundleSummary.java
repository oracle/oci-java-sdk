...
/**
 * Summary of a database connection bundle. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbConnectionBundleSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DbConnectionBundleSummary
    ...
    public DbConnectionBundleSummary(
            String id,
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbConnectionBundleSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbConnectionBundleSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbConnectionBundleSummary)) {
            return false;
        }

        DbConnectionBundleSummary other = (DbConnectionBundleSummary) o;
