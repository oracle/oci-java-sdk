...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/RestoreDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RestoreDatabaseRequest.
 */
...
public class RestoreDatabaseRequest
    ...
    public static class Builder
        ...
        /**
         * Request to perform database restore.
         * @param restoreDatabaseDetails the value to set
         * @return this builder instance
         */
        ...
        public RestoreDatabaseRequest build() {
            RestoreDatabaseRequest request = buildWithoutInvocationCallback();
