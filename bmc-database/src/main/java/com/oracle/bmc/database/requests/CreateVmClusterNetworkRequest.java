...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/CreateVmClusterNetworkExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateVmClusterNetworkRequest.
 */
...
public class CreateVmClusterNetworkRequest
    ...
    public static class Builder
        ...
        public CreateVmClusterNetworkRequest buildWithoutInvocationCallback() {
            ...
            request.vmClusterNetworkDetails = vmClusterNetworkDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateVmClusterNetworkRequest(exadataInfrastructureId, vmClusterNetworkDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.vmClusterNetworkDetails, other.vmClusterNetworkDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.vmClusterNetworkDetails == null
                                ? 43
                                : this.vmClusterNetworkDetails.hashCode());
        result =
                (result * PRIME)
