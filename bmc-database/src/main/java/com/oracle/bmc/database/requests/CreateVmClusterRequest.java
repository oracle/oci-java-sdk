 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateVmClusterRequest.
 */
...
public class CreateVmClusterRequest
    ...
    /**
     * Request to create a VM cluster. Applies to Exadata Cloud@Customer instances only. See {@link
     * #createCloudVmClusterDetails(CreateCloudVmClusterDetailsRequest) createCloudVmClusterDetails}
     * for details on creating a cloud VM cluster in an Exadata Cloud Service instance.
     */
    ...
    public static class Builder
        ...
        /**
         * Request to create a VM cluster. Applies to Exadata Cloud@Customer instances only. See
         * {@link #createCloudVmClusterDetails(CreateCloudVmClusterDetailsRequest)
         * createCloudVmClusterDetails} for details on creating a cloud VM cluster in an Exadata
