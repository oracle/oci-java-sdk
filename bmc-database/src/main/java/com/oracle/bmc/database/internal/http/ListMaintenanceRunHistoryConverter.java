...
public class ListMaintenanceRunHistoryConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListMaintenanceRunHistoryConverter.class);

    public static com.oracle.bmc.database.requests.ListMaintenanceRunHistoryRequest
            interceptRequest(
                    com.oracle.bmc.database.requests.ListMaintenanceRunHistoryRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20160918").path("maintenanceRunHistory");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.database.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.database.responses.ListMaintenanceRunHistoryResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
