...
public class UpdateKeyStoreResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateKeyStoreResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateKeyStoreResponse o) {
         ...
         */
        @Override
        public UpdateKeyStoreResponse build() {
            return new UpdateKeyStoreResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateKeyStoreResponse)) {
            return false;
        }

        UpdateKeyStoreResponse other = (UpdateKeyStoreResponse) o;
