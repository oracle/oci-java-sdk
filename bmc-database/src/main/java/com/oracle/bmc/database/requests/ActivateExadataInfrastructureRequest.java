...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ActivateExadataInfrastructureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ActivateExadataInfrastructureRequest.
 */
...
public class ActivateExadataInfrastructureRequest
    ...
    public static class Builder
        ...
        public ActivateExadataInfrastructureRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ActivateExadataInfrastructureRequest(exadataInfrastructureId, activateExadataInfrastructureDetails, opcRequestId, opcRetryToken);
        }
    }
