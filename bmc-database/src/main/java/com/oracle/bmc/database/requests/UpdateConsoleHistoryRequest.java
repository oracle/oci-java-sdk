...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateConsoleHistoryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateConsoleHistoryRequest.
 */
...
public class UpdateConsoleHistoryRequest
    ...
    public static class Builder
        ...
        public UpdateConsoleHistoryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateConsoleHistoryRequest(dbNodeId, consoleHistoryId, updateConsoleHistoryDetails, ifMatch, opcRequestId);
        }
    }
