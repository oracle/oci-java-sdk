...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousVirtualMachinesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousVirtualMachinesRequest.
 */
...
public class ListAutonomousVirtualMachinesRequest
    ...
    public static class Builder
        ...
        public ListAutonomousVirtualMachinesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutonomousVirtualMachinesRequest(compartmentId, autonomousVmClusterId, limit, page, opcRequestId, lifecycleState);
        }
    }
