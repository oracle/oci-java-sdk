...
public final class PdbConversionHistoryEntrySummary
    ...
    public PdbConversionHistoryEntrySummary(
            String id,
            Action action,
            Target target,
    ...
    public static class Builder {
        ...
        public PdbConversionHistoryEntrySummary build() {
            PdbConversionHistoryEntrySummary model =
    ...
    public boolean equals(Object o) {
        ...
        PdbConversionHistoryEntrySummary other = (PdbConversionHistoryEntrySummary) o;
