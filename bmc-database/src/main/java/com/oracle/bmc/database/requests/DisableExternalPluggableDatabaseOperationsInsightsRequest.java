...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DisableExternalPluggableDatabaseOperationsInsightsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DisableExternalPluggableDatabaseOperationsInsightsRequest.
 */
...
public class DisableExternalPluggableDatabaseOperationsInsightsRequest
    ...
    public static class Builder
         ...
         * @return instance of DisableExternalPluggableDatabaseOperationsInsightsRequest
         */
        public DisableExternalPluggableDatabaseOperationsInsightsRequest
                buildWithoutInvocationCallback() {
            DisableExternalPluggableDatabaseOperationsInsightsRequest request =
                    new DisableExternalPluggableDatabaseOperationsInsightsRequest();
            request.externalPluggableDatabaseId = externalPluggableDatabaseId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DisableExternalPluggableDatabaseOperationsInsightsRequest(externalPluggableDatabaseId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalPluggableDatabaseOperationsInsightsRequest)) {
            return false;
        }

        DisableExternalPluggableDatabaseOperationsInsightsRequest other =
                (DisableExternalPluggableDatabaseOperationsInsightsRequest) o;
