...
public class UpdateAutonomousContainerDatabaseDataguardAssociationResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutonomousContainerDatabaseDataguardAssociationResponse)) {
            return false;
        }

        UpdateAutonomousContainerDatabaseDataguardAssociationResponse other =
                (UpdateAutonomousContainerDatabaseDataguardAssociationResponse) o;
