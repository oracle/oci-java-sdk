...
public class GetVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVmClusterResponse> {
        ...
        public GetVmClusterResponse build() {
            return new GetVmClusterResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, vmCluster);
        }
    }
