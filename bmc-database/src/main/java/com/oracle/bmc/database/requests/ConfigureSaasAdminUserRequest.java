...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ConfigureSaasAdminUserExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ConfigureSaasAdminUserRequest.
 */
...
public class ConfigureSaasAdminUserRequest
    ...
    public static class Builder
        ...
        public ConfigureSaasAdminUserRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ConfigureSaasAdminUserRequest(autonomousDatabaseId, configureSaasAdminUserDetails, ifMatch, opcRequestId, opcDryRun);
        }
    }
