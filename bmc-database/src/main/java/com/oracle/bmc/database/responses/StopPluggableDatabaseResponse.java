...
public class StopPluggableDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StopPluggableDatabaseResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopPluggableDatabaseResponse> {
         ...
         */
        @Override
        public Builder copy(StopPluggableDatabaseResponse o) {
         ...
         */
        @Override
        public StopPluggableDatabaseResponse build() {
            return new StopPluggableDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopPluggableDatabaseResponse)) {
            return false;
        }

        StopPluggableDatabaseResponse other = (StopPluggableDatabaseResponse) o;
