...
public class ChangeBackupDestinationCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeBackupDestinationCompartmentResponse)) {
            return false;
        }

        ChangeBackupDestinationCompartmentResponse other =
                (ChangeBackupDestinationCompartmentResponse) o;
