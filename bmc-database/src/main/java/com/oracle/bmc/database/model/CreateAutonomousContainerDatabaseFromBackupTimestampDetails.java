...
/**
 * Details to create an Autonomous Container Database (ACD) by cloning backup available, of an
 * existing ACD, at the requested time stamp. <br>
...
public final class CreateAutonomousContainerDatabaseFromBackupTimestampDetails
    ...
    public static class Builder {
         ...
         * source ACD that you will clone to create a new ACD.
         */
        ...
        /**
         * The time stamp representing the point in time to which the Autonomous Container Database
         * should be cloned from backup. And the requested timeStamp should be in the past.
         */
        ...
        /**
         * If set to true, OCI shall attempt to create a point in time to the latest available
    ...
    /**
     * If set to true, OCI shall attempt to create a point in time to the latest available backup of
