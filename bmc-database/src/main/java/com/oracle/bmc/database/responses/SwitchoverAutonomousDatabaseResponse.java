...
public class SwitchoverAutonomousDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SwitchoverAutonomousDatabaseResponse o) {
         ...
         */
        public SwitchoverAutonomousDatabaseResponse build() {
            return new SwitchoverAutonomousDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverAutonomousDatabaseResponse)) {
            return false;
        }

        SwitchoverAutonomousDatabaseResponse other = (SwitchoverAutonomousDatabaseResponse) o;
