...
/**
 * The collection of Autonomous Database details that are part of Autonomous Container Database
 * Backup associated. <br>
...
public final class AutonomousDatabaseInBackupCollection
    ...
    public AutonomousDatabaseInBackupCollection(
            java.util.List<AutonomousDatabaseInBackupSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        /**
         * The list of Autonomous Databases that are part of the Autonomous Container Database
         * Backup.
         */
        @com.fasterxml.jackson.annotation.JsonProperty("items")
        private java.util.List<AutonomousDatabaseInBackupSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<AutonomousDatabaseInBackupSummary> items) {
            this.items = items;
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AutonomousDatabaseInBackupSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AutonomousDatabaseInBackupSummary> getItems() {
        return items;
    }
