...
public class RunDataPatchResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RunDataPatchResponse> {
         ...
         */
        @Override
        public Builder copy(RunDataPatchResponse o) {
         ...
         */
        @Override
        public RunDataPatchResponse build() {
            return new RunDataPatchResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RunDataPatchResponse)) {
            return false;
        }

        RunDataPatchResponse other = (RunDataPatchResponse) o;
