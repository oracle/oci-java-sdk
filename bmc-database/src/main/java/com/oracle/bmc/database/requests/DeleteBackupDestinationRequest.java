...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DeleteBackupDestinationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteBackupDestinationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteBackupDestinationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteBackupDestinationRequest, java.lang.Void> {
         ...
         * @return instance of DeleteBackupDestinationRequest
         */
        public DeleteBackupDestinationRequest buildWithoutInvocationCallback() {
            DeleteBackupDestinationRequest request = new DeleteBackupDestinationRequest();
            request.backupDestinationId = backupDestinationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteBackupDestinationRequest(backupDestinationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBackupDestinationRequest)) {
            return false;
        }

        DeleteBackupDestinationRequest other = (DeleteBackupDestinationRequest) o;
