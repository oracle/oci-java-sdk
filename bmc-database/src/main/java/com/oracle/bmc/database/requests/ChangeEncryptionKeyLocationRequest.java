...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeEncryptionKeyLocationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeEncryptionKeyLocationRequest.
 */
...
public class ChangeEncryptionKeyLocationRequest
    ...
    public static class Builder
        ...
        public ChangeEncryptionKeyLocationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeEncryptionKeyLocationRequest(databaseId, encryptionKeyLocationDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
