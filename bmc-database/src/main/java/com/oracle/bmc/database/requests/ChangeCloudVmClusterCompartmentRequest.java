...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeCloudVmClusterCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCloudVmClusterCompartmentRequest.
 */
...
public class ChangeCloudVmClusterCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Request to move cloud VM cluster to a different compartment
         * @param changeCloudVmClusterCompartmentDetails the value to set
