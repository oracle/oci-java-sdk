...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UnregisterCloudAutonomousVmClusterPkcsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UnregisterCloudAutonomousVmClusterPkcsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"tdeKeyStoreType"})
    public UnregisterCloudAutonomousVmClusterPkcsDetails(TdeKeyStoreType tdeKeyStoreType) {
        super();
    ...
    public static class Builder {
        ...
        public UnregisterCloudAutonomousVmClusterPkcsDetails build() {
            UnregisterCloudAutonomousVmClusterPkcsDetails model =
                    new UnregisterCloudAutonomousVmClusterPkcsDetails(this.tdeKeyStoreType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnregisterCloudAutonomousVmClusterPkcsDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UnregisterCloudAutonomousVmClusterPkcsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnregisterCloudAutonomousVmClusterPkcsDetails)) {
            return false;
        }

        UnregisterCloudAutonomousVmClusterPkcsDetails other =
                (UnregisterCloudAutonomousVmClusterPkcsDetails) o;
