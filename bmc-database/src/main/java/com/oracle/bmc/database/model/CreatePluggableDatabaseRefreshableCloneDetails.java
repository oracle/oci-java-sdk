...
/**
 * Parameters for creating Pluggable Database Refreshable Clone. **Warning:** Oracle recommends that
 * you avoid using any confidential information when you supply string values using the API. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreatePluggableDatabaseRefreshableCloneDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreatePluggableDatabaseRefreshableCloneDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isRefreshableClone"})
    public CreatePluggableDatabaseRefreshableCloneDetails(Boolean isRefreshableClone) {
        super();
    ...
    public static class Builder {
        ...
        public CreatePluggableDatabaseRefreshableCloneDetails build() {
            CreatePluggableDatabaseRefreshableCloneDetails model =
                    new CreatePluggableDatabaseRefreshableCloneDetails(this.isRefreshableClone);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePluggableDatabaseRefreshableCloneDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePluggableDatabaseRefreshableCloneDetails)) {
            return false;
        }

        CreatePluggableDatabaseRefreshableCloneDetails other =
                (CreatePluggableDatabaseRefreshableCloneDetails) o;
