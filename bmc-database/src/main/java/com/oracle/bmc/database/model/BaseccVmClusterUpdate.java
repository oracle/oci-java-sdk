...
/**
 * Maintenance update details for a BaseDB-C@C VM cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BaseccVmClusterUpdate.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BaseccVmClusterUpdate
    ...
    public static class Builder {
        ...
        /**
         * The type of Base Database Service on Cloud@Customer (BaseDB-C@C) VM cluster maintenance
         * update.
         */
        ...
        public BaseccVmClusterUpdate build() {
            BaseccVmClusterUpdate model =
                    new BaseccVmClusterUpdate(
                            this.id,
                            this.description,
                            this.lastAction,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BaseccVmClusterUpdate model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BaseccVmClusterUpdate(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseccVmClusterUpdate)) {
            return false;
        }

        BaseccVmClusterUpdate other = (BaseccVmClusterUpdate) o;
