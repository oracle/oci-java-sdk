...
public class DownloadExadataInfrastructureConfigFileResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadExadataInfrastructureConfigFileResponse)) {
            return false;
        }

        DownloadExadataInfrastructureConfigFileResponse other =
                (DownloadExadataInfrastructureConfigFileResponse) o;
