...
public class ModifyDatabaseManagementResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ModifyDatabaseManagementResponse o) {
         ...
         */
        @Override
        public ModifyDatabaseManagementResponse build() {
            return new ModifyDatabaseManagementResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModifyDatabaseManagementResponse)) {
            return false;
        }

        ModifyDatabaseManagementResponse other = (ModifyDatabaseManagementResponse) o;
