...
/**
 * Details of the Exadata Cloud@Customer infrastructure. Applies to Exadata Cloud@Customer instances
 * only. See {@link #cloudExadataInfrastructureSummary(CloudExadataInfrastructureSummaryRequest)
 * cloudExadataInfrastructureSummary} for details of the cloud Exadata infrastructure resource used
 * by Exadata Cloud Service instances. <br>
