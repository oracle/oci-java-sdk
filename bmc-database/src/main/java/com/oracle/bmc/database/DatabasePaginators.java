...
public class DatabasePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listAutonomousDatabasesInAutonomousContainerDatabaseBackup operation. This iterable will
     * fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.database.model.AutonomousDatabaseInBackupSummary} objects contained in
     * responses from the listAutonomousDatabasesInAutonomousContainerDatabaseBackup operation. This
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listAvailableMaintenanceWindows operation. This iterable will fetch more data from the server
     * as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.database.model.AutonomousDatabaseMaintenanceWindowSummary} objects contained
     * in responses from the listAvailableMaintenanceWindows operation. This iterable will fetch
     * more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.database.model.AutonomousDatabaseMaintenanceWindowSummary} objects
     *     contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listGiHomes
     * operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.database.model.GiHomeSummary} objects contained in responses from the
     * listGiHomes operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.database.model.GiHomeSummary} objects contained in responses received from
     *     the service.
     */
