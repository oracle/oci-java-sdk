...
/**
 * Describes the modification parameters for the Scheduling Policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateSchedulingPolicyDetails.Builder.class)
...
public final class UpdateSchedulingPolicyDetails
    ...
    public UpdateSchedulingPolicyDetails(
            String displayName,
            Cadence cadence,
    ...
    public static class Builder {
        ...
        /** The cadence period. */
        @com.fasterxml.jackson.annotation.JsonProperty("cadence")
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("cadenceStartMonth")
        private Month cadenceStartMonth;

        /**
         * Start of the month to be followed during the cadence period.
         *
         * @param cadenceStartMonth the value to set
         * @return this builder
         */
        ...
        public UpdateSchedulingPolicyDetails build() {
            UpdateSchedulingPolicyDetails model =
                    new UpdateSchedulingPolicyDetails(
                            this.displayName,
                            this.cadence,
                            this.cadenceStartMonth,
                            this.freeformTags,
                            this.definedTags);
    ...
    /** The cadence period. */
    public enum Cadence implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static java.util.Map<String, Cadence> map;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", cadenceStartMonth=").append(String.valueOf(this.cadenceStartMonth));
    ...
    public boolean equals(Object o) {
        ...
        UpdateSchedulingPolicyDetails other = (UpdateSchedulingPolicyDetails) o;
        return java.util.Objects.equals(this.displayName, other.displayName)
                && java.util.Objects.equals(this.cadence, other.cadence)
                && java.util.Objects.equals(this.cadenceStartMonth, other.cadenceStartMonth)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.cadenceStartMonth == null ? 43 : this.cadenceStartMonth.hashCode());
