...
public class ListExadataInfrastructuresResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.ExadataInfrastructureSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExadataInfrastructuresResponse)) {
            return false;
        }

        ListExadataInfrastructuresResponse other = (ListExadataInfrastructuresResponse) o;
