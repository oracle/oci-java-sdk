...
public final class UpdateSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSummary)) {
            return false;
        }

        UpdateSummary other = (UpdateSummary) o;
