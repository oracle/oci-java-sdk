...
public class ListDbSystemStoragePerformancesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DbSystemStoragePerformanceSummary>
            getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.database.model.DbSystemStoragePerformanceSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemStoragePerformancesResponse)) {
            return false;
        }

        ListDbSystemStoragePerformancesResponse other = (ListDbSystemStoragePerformancesResponse) o;
