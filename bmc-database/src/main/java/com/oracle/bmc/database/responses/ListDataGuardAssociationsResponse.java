...
public class ListDataGuardAssociationsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DataGuardAssociationSummary> getItems() {
        return items;
    }
    ...
    private ListDataGuardAssociationsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.DataGuardAssociationSummary> items) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListDataGuardAssociationsResponse o) {
         ...
         */
        @Override
        public ListDataGuardAssociationsResponse build() {
            return new ListDataGuardAssociationsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDataGuardAssociationsResponse)) {
            return false;
        }

        ListDataGuardAssociationsResponse other = (ListDataGuardAssociationsResponse) o;
