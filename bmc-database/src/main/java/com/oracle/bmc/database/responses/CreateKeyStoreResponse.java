...
public class CreateKeyStoreResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateKeyStoreResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKeyStoreResponse)) {
            return false;
        }

        CreateKeyStoreResponse other = (CreateKeyStoreResponse) o;
