...
public class FailoverDataGuardAssociationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public FailoverDataGuardAssociationResponse build() {
            return new FailoverDataGuardAssociationResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverDataGuardAssociationResponse)) {
            return false;
        }

        FailoverDataGuardAssociationResponse other = (FailoverDataGuardAssociationResponse) o;
