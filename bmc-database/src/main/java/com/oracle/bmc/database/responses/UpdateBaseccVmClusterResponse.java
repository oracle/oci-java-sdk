...
public class UpdateBaseccVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateBaseccVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateBaseccVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateBaseccVmClusterResponse o) {
         ...
         */
        @Override
        public UpdateBaseccVmClusterResponse build() {
            return new UpdateBaseccVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBaseccVmClusterResponse)) {
            return false;
        }

        UpdateBaseccVmClusterResponse other = (UpdateBaseccVmClusterResponse) o;
