...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateExascaleDbStorageVaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateExascaleDbStorageVaultRequest.
 */
...
public class UpdateExascaleDbStorageVaultRequest
    ...
    public static class Builder
        ...
        public UpdateExascaleDbStorageVaultRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateExascaleDbStorageVaultRequest(exascaleDbStorageVaultId, updateExascaleDbStorageVaultDetails, ifMatch, opcRequestId);
        }
    }
