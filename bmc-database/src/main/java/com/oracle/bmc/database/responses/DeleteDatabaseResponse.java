...
public class DeleteDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteDatabaseResponse o) {
        ...
        public DeleteDatabaseResponse build() {
            return new DeleteDatabaseResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatabaseResponse)) {
            return false;
        }

        DeleteDatabaseResponse other = (DeleteDatabaseResponse) o;
