...
/**
 * Details for creating a BaseDB-C@C VM cluster. Applies to Base Database Service on Cloud@Customer
 * instances only. <br>
...
public final class CreateBaseccVmClusterDetails
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * compute node of the Oracle Data Cloud@Customer Infrastructure, on which the VM should be
         * launched. Note: Applies to single node Base Database Service on Cloud@Customer
         * (BaseDB-C@C) VM clusters only
         */
     ...
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
     * compute node of the Oracle Data Cloud@Customer Infrastructure, on which the VM should be
     * launched. Note: Applies to single node Base Database Service on Cloud@Customer (BaseDB-C@C)
     * VM clusters only
     */
    @com.fasterxml.jackson.annotation.JsonProperty("dbServerId")
