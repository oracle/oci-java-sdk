...
public class UpdateVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateVmClusterResponse> {
        ...
        public UpdateVmClusterResponse build() {
            return new UpdateVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVmClusterResponse)) {
            return false;
        }

        UpdateVmClusterResponse other = (UpdateVmClusterResponse) o;
