...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApplicationVipSummary.Builder.class)
...
public final class ApplicationVipSummary
    ...
    public static class Builder {
        ...
        public ApplicationVipSummary build() {
            ApplicationVipSummary model =
                    new ApplicationVipSummary(
                            this.id,
    ...
    public boolean equals(Object o) {
        ...
        ApplicationVipSummary other = (ApplicationVipSummary) o;
