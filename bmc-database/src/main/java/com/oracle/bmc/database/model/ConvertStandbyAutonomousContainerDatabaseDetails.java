...
public final class ConvertStandbyAutonomousContainerDatabaseDetails
    ...
    public ConvertStandbyAutonomousContainerDatabaseDetails(
            Role role, ConnectionStringsType connectionStringsType) {
        super();
        this.role = role;
    ...
    public static class Builder {
        ...
        public ConvertStandbyAutonomousContainerDatabaseDetails build() {
            ConvertStandbyAutonomousContainerDatabaseDetails model =
                    new ConvertStandbyAutonomousContainerDatabaseDetails(
                            this.role, this.connectionStringsType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConvertStandbyAutonomousContainerDatabaseDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConvertStandbyAutonomousContainerDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConvertStandbyAutonomousContainerDatabaseDetails)) {
            return false;
        }

        ConvertStandbyAutonomousContainerDatabaseDetails other =
                (ConvertStandbyAutonomousContainerDatabaseDetails) o;
