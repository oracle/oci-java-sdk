...
public class CreateBackupDestinationRequest
        extends com.oracle.bmc.requests.BmcRequest<CreateBackupDestinationDetails> {
    ...
    public CreateBackupDestinationDetails getBody$() {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(CreateBackupDestinationDetails body) {
