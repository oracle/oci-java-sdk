...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/RotateCloudAutonomousVmClusterOrdsCertsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RotateCloudAutonomousVmClusterOrdsCertsRequest.
 */
...
public class RotateCloudAutonomousVmClusterOrdsCertsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of RotateCloudAutonomousVmClusterOrdsCertsRequest as configured by this builder
         *
         ...
         *
         * @return instance of RotateCloudAutonomousVmClusterOrdsCertsRequest
         */
        public RotateCloudAutonomousVmClusterOrdsCertsRequest build() {
         ...
         * @return instance of RotateCloudAutonomousVmClusterOrdsCertsRequest
         */
        public RotateCloudAutonomousVmClusterOrdsCertsRequest buildWithoutInvocationCallback() {
            RotateCloudAutonomousVmClusterOrdsCertsRequest request =
            ...
            return request;
            // new RotateCloudAutonomousVmClusterOrdsCertsRequest(cloudAutonomousVmClusterId, rotateCloudAutonomousVmClusterOrdsCertsDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateCloudAutonomousVmClusterOrdsCertsRequest)) {
            return false;
        }

        RotateCloudAutonomousVmClusterOrdsCertsRequest other =
                (RotateCloudAutonomousVmClusterOrdsCertsRequest) o;
