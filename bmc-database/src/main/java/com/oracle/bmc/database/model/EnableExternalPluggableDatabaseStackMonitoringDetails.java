...
/**
 * Details to enable Stack Monitoring on the external pluggable database. <br>
...
public final class EnableExternalPluggableDatabaseStackMonitoringDetails
    ...
    public static class Builder {
        ...
        public EnableExternalPluggableDatabaseStackMonitoringDetails build() {
            EnableExternalPluggableDatabaseStackMonitoringDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalPluggableDatabaseStackMonitoringDetails model) {
