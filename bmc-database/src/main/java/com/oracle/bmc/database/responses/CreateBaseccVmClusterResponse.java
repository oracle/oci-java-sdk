...
public class CreateBaseccVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** The returned {@code BaseccVmCluster} instance. */
    ...
    private CreateBaseccVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateBaseccVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(CreateBaseccVmClusterResponse o) {
         ...
         */
        @Override
        public CreateBaseccVmClusterResponse build() {
            return new CreateBaseccVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBaseccVmClusterResponse)) {
            return false;
        }

        CreateBaseccVmClusterResponse other = (CreateBaseccVmClusterResponse) o;
