...
public class ChangeDisasterRecoveryConfigurationResponse
    ...
    private ChangeDisasterRecoveryConfigurationResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeDisasterRecoveryConfigurationResponse o) {
         ...
         */
        public ChangeDisasterRecoveryConfigurationResponse build() {
            return new ChangeDisasterRecoveryConfigurationResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDisasterRecoveryConfigurationResponse)) {
            return false;
        }

        ChangeDisasterRecoveryConfigurationResponse other =
                (ChangeDisasterRecoveryConfigurationResponse) o;
