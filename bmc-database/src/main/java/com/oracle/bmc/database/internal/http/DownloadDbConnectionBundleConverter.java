...
public class DownloadDbConnectionBundleConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DownloadDbConnectionBundleConverter.class);

    public static com.oracle.bmc.database.requests.DownloadDbConnectionBundleRequest
            interceptRequest(
                    com.oracle.bmc.database.requests.DownloadDbConnectionBundleRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getDbConnectionBundleId()))
                        .path("actions")
                        .path("download");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.database.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.database.responses.DownloadDbConnectionBundleResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
