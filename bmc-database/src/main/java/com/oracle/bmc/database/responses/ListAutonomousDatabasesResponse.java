...
public class ListAutonomousDatabasesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDatabasesResponse)) {
            return false;
        }

        ListAutonomousDatabasesResponse other = (ListAutonomousDatabasesResponse) o;
