...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RegisterCloudAutonomousVmClusterPkcsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RegisterCloudAutonomousVmClusterPkcsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"tdeKeyStoreType"})
    public RegisterCloudAutonomousVmClusterPkcsDetails(TdeKeyStoreType tdeKeyStoreType) {
        super();
    ...
    public static class Builder {
        ...
        public RegisterCloudAutonomousVmClusterPkcsDetails build() {
            RegisterCloudAutonomousVmClusterPkcsDetails model =
                    new RegisterCloudAutonomousVmClusterPkcsDetails(this.tdeKeyStoreType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RegisterCloudAutonomousVmClusterPkcsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisterCloudAutonomousVmClusterPkcsDetails)) {
            return false;
        }

        RegisterCloudAutonomousVmClusterPkcsDetails other =
                (RegisterCloudAutonomousVmClusterPkcsDetails) o;
