...
public class DeleteAutonomousVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteAutonomousVmClusterResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteAutonomousVmClusterResponse o) {
         ...
         */
        @Override
        public DeleteAutonomousVmClusterResponse build() {
            return new DeleteAutonomousVmClusterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAutonomousVmClusterResponse)) {
            return false;
        }

        DeleteAutonomousVmClusterResponse other = (DeleteAutonomousVmClusterResponse) o;
