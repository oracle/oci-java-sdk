...
public final class UpdateDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * patching and upgrade of the Cloud VM Cluster. This is mutually exclusive option to {@code
     ...
     * and upgrade of the Cloud VM Cluster. This is mutually exclusive option to {@code updateId}
     * and {@code giSoftwareImageId} which are used for in place patching and upgrade using Oracle
