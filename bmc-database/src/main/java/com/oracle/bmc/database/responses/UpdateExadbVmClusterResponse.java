...
public class UpdateExadbVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateExadbVmClusterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateExadbVmClusterResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateExadbVmClusterResponse o) {
         ...
         */
        @Override
        public UpdateExadbVmClusterResponse build() {
            return new UpdateExadbVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExadbVmClusterResponse)) {
            return false;
        }

        UpdateExadbVmClusterResponse other = (UpdateExadbVmClusterResponse) o;
