...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListSystemVersionMinorVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSystemVersionMinorVersionsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListSystemVersionMinorVersionsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSystemVersionMinorVersionsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSystemVersionMinorVersionsRequest o) {
        ...
        /**
         * Build the instance of ListSystemVersionMinorVersionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSystemVersionMinorVersionsRequest
         */
        public ListSystemVersionMinorVersionsRequest build() {
            ListSystemVersionMinorVersionsRequest request = buildWithoutInvocationCallback();
        ...
        public ListSystemVersionMinorVersionsRequest buildWithoutInvocationCallback() {
            ListSystemVersionMinorVersionsRequest request =
                    new ListSystemVersionMinorVersionsRequest();
            ...
            return request;
            // new ListSystemVersionMinorVersionsRequest(majorVersion, compartmentId, giVersion, limit, page, sortOrder, opcRequestId, shape, resourceId, isLatest);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSystemVersionMinorVersionsRequest)) {
            return false;
        }

        ListSystemVersionMinorVersionsRequest other = (ListSystemVersionMinorVersionsRequest) o;
