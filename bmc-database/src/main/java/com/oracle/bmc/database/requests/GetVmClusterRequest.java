...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetVmClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetVmClusterRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetVmClusterRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetVmClusterRequest, java.lang.Void> {
        ...
        public GetVmClusterRequest buildWithoutInvocationCallback() {
            GetVmClusterRequest request = new GetVmClusterRequest();
            request.vmClusterId = vmClusterId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetVmClusterRequest(vmClusterId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().vmClusterId(vmClusterId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVmClusterRequest)) {
            return false;
        }

        GetVmClusterRequest other = (GetVmClusterRequest) o;
