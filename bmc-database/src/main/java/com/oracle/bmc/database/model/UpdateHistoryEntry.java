...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateHistoryEntry.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateHistoryEntry extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public UpdateHistoryEntry build() {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateHistoryEntry model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateHistoryEntry)) {
            return false;
        }

        UpdateHistoryEntry other = (UpdateHistoryEntry) o;
