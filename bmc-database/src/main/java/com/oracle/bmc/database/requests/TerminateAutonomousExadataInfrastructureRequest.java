...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/TerminateAutonomousExadataInfrastructureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use TerminateAutonomousExadataInfrastructureRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class TerminateAutonomousExadataInfrastructureRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    TerminateAutonomousExadataInfrastructureRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(TerminateAutonomousExadataInfrastructureRequest o) {
        ...
        /**
         * Build the instance of TerminateAutonomousExadataInfrastructureRequest as configured by this builder
         *
         ...
         *
         * @return instance of TerminateAutonomousExadataInfrastructureRequest
         */
        ...
        public TerminateAutonomousExadataInfrastructureRequest buildWithoutInvocationCallback() {
            TerminateAutonomousExadataInfrastructureRequest request =
                    new TerminateAutonomousExadataInfrastructureRequest();
            request.autonomousExadataInfrastructureId = autonomousExadataInfrastructureId;
            request.ifMatch = ifMatch;
            return request;
            // new TerminateAutonomousExadataInfrastructureRequest(autonomousExadataInfrastructureId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TerminateAutonomousExadataInfrastructureRequest)) {
            return false;
        }

        TerminateAutonomousExadataInfrastructureRequest other =
                (TerminateAutonomousExadataInfrastructureRequest) o;
