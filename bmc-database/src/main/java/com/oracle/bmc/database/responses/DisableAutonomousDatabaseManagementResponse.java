...
public class DisableAutonomousDatabaseManagementResponse
    ...
    private DisableAutonomousDatabaseManagementResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DisableAutonomousDatabaseManagementResponse o) {
         ...
         */
        public DisableAutonomousDatabaseManagementResponse build() {
            return new DisableAutonomousDatabaseManagementResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableAutonomousDatabaseManagementResponse)) {
            return false;
        }

        DisableAutonomousDatabaseManagementResponse other =
                (DisableAutonomousDatabaseManagementResponse) o;
