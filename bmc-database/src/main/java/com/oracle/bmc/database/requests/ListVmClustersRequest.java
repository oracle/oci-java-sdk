...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListVmClustersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVmClustersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListVmClustersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * A filter to return only resources that match the given lifecycle state exactly.
     */
    public com.oracle.bmc.database.model.VmClusterSummary.LifecycleState getLifecycleState() {
     ...
     */
    private com.oracle.bmc.database.model.VmClusterSummary.VmClusterType vmClusterType;

    /**
     * A filter to return only vmclusters that match the given vmcluster type exactly.
     */
    public com.oracle.bmc.database.model.VmClusterSummary.VmClusterType getVmClusterType() {
        return vmClusterType;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListVmClustersRequest, java.lang.Void> {
         ...
         * A filter to return only resources that match the given lifecycle state exactly.
         */
        private com.oracle.bmc.database.model.VmClusterSummary.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.database.model.VmClusterSummary.LifecycleState lifecycleState) {
         ...
         * A filter to return only vmclusters that match the given vmcluster type exactly.
         */
        private com.oracle.bmc.database.model.VmClusterSummary.VmClusterType vmClusterType = null;
        ...
        public Builder vmClusterType(
                com.oracle.bmc.database.model.VmClusterSummary.VmClusterType vmClusterType) {
         ...
         * @return instance of ListVmClustersRequest
         */
        public ListVmClustersRequest buildWithoutInvocationCallback() {
            ListVmClustersRequest request = new ListVmClustersRequest();
            ...
            return request;
            // new ListVmClustersRequest(compartmentId, exadataInfrastructureId, limit, page, sortBy, sortOrder, lifecycleState, displayName, opcRequestId, vmClusterType);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVmClustersRequest)) {
            return false;
        }

        ListVmClustersRequest other = (ListVmClustersRequest) o;
