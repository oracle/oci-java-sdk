...
public class UpdateDbNodeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDbNodeResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateDbNodeResponse o) {
         ...
         */
        @Override
        public UpdateDbNodeResponse build() {
            return new UpdateDbNodeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDbNodeResponse)) {
            return false;
        }

        UpdateDbNodeResponse other = (UpdateDbNodeResponse) o;
