...
public class ListDbSystemComputePerformancesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * A list of {@code com.oracle.bmc.database.model.DbSystemComputePerformanceSummary} instances.
     */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.DbSystemComputePerformanceSummary>
            getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        /**
         * A list of {@code com.oracle.bmc.database.model.DbSystemComputePerformanceSummary}
         * instances.
         */
        private java.util.List<com.oracle.bmc.database.model.DbSystemComputePerformanceSummary>
                items;
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.database.model.DbSystemComputePerformanceSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbSystemComputePerformancesResponse)) {
            return false;
        }

        ListDbSystemComputePerformancesResponse other = (ListDbSystemComputePerformancesResponse) o;
