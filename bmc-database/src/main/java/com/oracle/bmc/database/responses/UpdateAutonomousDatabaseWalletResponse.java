...
public class UpdateAutonomousDatabaseWalletResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateAutonomousDatabaseWalletResponse(
    ...
    public static class Builder {
        ...
        public UpdateAutonomousDatabaseWalletResponse build() {
            return new UpdateAutonomousDatabaseWalletResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAutonomousDatabaseWalletResponse)) {
            return false;
        }

        UpdateAutonomousDatabaseWalletResponse other = (UpdateAutonomousDatabaseWalletResponse) o;
