...
public final class ExternalContainerDatabaseSummary {
    ...
    public ExternalContainerDatabaseSummary(
    ...
    public static class Builder {
        ...
        public ExternalContainerDatabaseSummary build() {
            ExternalContainerDatabaseSummary __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalContainerDatabaseSummary o) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalContainerDatabaseSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalContainerDatabaseSummary)) {
            return false;
        }

        ExternalContainerDatabaseSummary other = (ExternalContainerDatabaseSummary) o;
