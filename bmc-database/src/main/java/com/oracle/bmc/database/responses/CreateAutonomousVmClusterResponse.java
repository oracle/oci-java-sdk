...
public class CreateAutonomousVmClusterResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateAutonomousVmClusterResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateAutonomousVmClusterResponse o) {
         ...
         */
        public CreateAutonomousVmClusterResponse build() {
            return new CreateAutonomousVmClusterResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousVmClusterResponse)) {
            return false;
        }

        CreateAutonomousVmClusterResponse other = (CreateAutonomousVmClusterResponse) o;
