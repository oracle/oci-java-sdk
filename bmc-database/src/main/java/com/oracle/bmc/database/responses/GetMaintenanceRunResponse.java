...
public class GetMaintenanceRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetMaintenanceRunResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetMaintenanceRunResponse> {
         ...
         */
        @Override
        public Builder copy(GetMaintenanceRunResponse o) {
        ...
        public GetMaintenanceRunResponse build() {
            return new GetMaintenanceRunResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMaintenanceRunResponse)) {
            return false;
        }

        GetMaintenanceRunResponse other = (GetMaintenanceRunResponse) o;
