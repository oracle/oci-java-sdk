...
public class ListAutonomousDbVersionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /** A list of {@code com.oracle.bmc.database.model.AutonomousDbVersionSummary} instances. */
    private java.util.List<com.oracle.bmc.database.model.AutonomousDbVersionSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.AutonomousDbVersionSummary> getItems() {
        return items;
    }
    ...
    private ListAutonomousDbVersionsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.database.model.AutonomousDbVersionSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousDbVersionsResponse)) {
            return false;
        }

        ListAutonomousDbVersionsResponse other = (ListAutonomousDbVersionsResponse) o;
