...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousDatabasesInAutonomousContainerDatabaseBackupExample.java.html"
...
public class ListAutonomousDatabasesInAutonomousContainerDatabaseBackupRequest
    ...
    /**
     * The timestamp at which the list of autonomous databases present to be returned (ISO-8601
     * format, e.g., "2025-12-02T06:39:15Z"). The requested value must be after the end timestamp of
     * the oldest available Autonomous Container Database backup.
     */
    ...
    /**
     * The compartment
     * [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm). If not
     * provided, uses the Autonomous Container Database's compartment.
     */
    ...
    public static class Builder
        ...
        /**
         * The timestamp at which the list of autonomous databases present to be returned (ISO-8601
         * format, e.g., "2025-12-02T06:39:15Z"). The requested value must be after the end
         * timestamp of the oldest available Autonomous Container Database backup.
         */
        ...
        /**
         * Build the instance of ListAutonomousDatabasesInAutonomousContainerDatabaseBackupRequest
        ...
        public ListAutonomousDatabasesInAutonomousContainerDatabaseBackupRequest
            ...
            return request;
            // new
            // ListAutonomousDatabasesInAutonomousContainerDatabaseBackupRequest(autonomousContainerDatabaseId, timeStampRequested, compartmentId, limit, page, opcRequestId);
        }
    }
