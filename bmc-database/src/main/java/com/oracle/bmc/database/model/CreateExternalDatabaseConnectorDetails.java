...
/**
 * Details for creating an external database connector resource. <br>
...
public class CreateExternalDatabaseConnectorDetails
    ...
    protected CreateExternalDatabaseConnectorDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExternalDatabaseConnectorDetails)) {
            return false;
        }

        CreateExternalDatabaseConnectorDetails other = (CreateExternalDatabaseConnectorDetails) o;
