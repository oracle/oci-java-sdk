...
public class MigrateVaultKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<MigrateVaultKeyResponse> {
         ...
         */
        @Override
        public Builder copy(MigrateVaultKeyResponse o) {
         ...
         */
        @Override
        public MigrateVaultKeyResponse build() {
            return new MigrateVaultKeyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrateVaultKeyResponse)) {
            return false;
        }

        MigrateVaultKeyResponse other = (MigrateVaultKeyResponse) o;
