...
public class ListDbHomePatchHistoryEntriesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListDbHomePatchHistoryEntriesResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListDbHomePatchHistoryEntriesResponse o) {
        ...
        public ListDbHomePatchHistoryEntriesResponse build() {
            return new ListDbHomePatchHistoryEntriesResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDbHomePatchHistoryEntriesResponse)) {
            return false;
        }

        ListDbHomePatchHistoryEntriesResponse other = (ListDbHomePatchHistoryEntriesResponse) o;
