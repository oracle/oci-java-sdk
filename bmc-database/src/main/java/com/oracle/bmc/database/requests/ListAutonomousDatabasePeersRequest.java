...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousDatabasePeersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousDatabasePeersRequest.
 */
...
public class ListAutonomousDatabasePeersRequest
    ...
    public static class Builder
        ...
        public ListAutonomousDatabasePeersRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListAutonomousDatabasePeersRequest(autonomousDatabaseId, opcRequestId, limit, page);
        }
    }
