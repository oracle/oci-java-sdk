...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListAutonomousContainerDatabaseBackupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutonomousContainerDatabaseBackupsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListAutonomousContainerDatabaseBackupsRequest
     ...
     */
    private com.oracle.bmc.database.model.AutonomousContainerDatabaseBackupSummary
                    .InfrastructureType
            infrastructureType;
     ...
     * A filter to return only resources that match the given Infrastructure Type.
     */
    public com.oracle.bmc.database.model.AutonomousContainerDatabaseBackupSummary.InfrastructureType
     ...
     */
    private com.oracle.bmc.database.model.AutonomousContainerDatabaseBackupSummary.LifecycleState
            lifecycleState;

    /**
     * A filter to return only resources that match the given lifecycle state exactly.
     */
    public com.oracle.bmc.database.model.AutonomousContainerDatabaseBackupSummary.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAutonomousContainerDatabaseBackupsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAutonomousContainerDatabaseBackupsRequest o) {
            compartmentId(o.getCompartmentId());
            autonomousContainerDatabaseId(o.getAutonomousContainerDatabaseId());
            isRemote(o.getIsRemote());
        ...
        /**
         * Build the instance of ListAutonomousContainerDatabaseBackupsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAutonomousContainerDatabaseBackupsRequest
         */
        public ListAutonomousContainerDatabaseBackupsRequest build() {
         ...
         * @return instance of ListAutonomousContainerDatabaseBackupsRequest
         */
        public ListAutonomousContainerDatabaseBackupsRequest buildWithoutInvocationCallback() {
            ListAutonomousContainerDatabaseBackupsRequest request =
                    new ListAutonomousContainerDatabaseBackupsRequest();
            request.compartmentId = compartmentId;
            request.autonomousContainerDatabaseId = autonomousContainerDatabaseId;
            request.isRemote = isRemote;
            ...
            return request;
            // new ListAutonomousContainerDatabaseBackupsRequest(compartmentId, autonomousContainerDatabaseId, isRemote, infrastructureType, lifecycleState, sortBy, opcRequestId, limit, page, sortOrder, displayName);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAutonomousContainerDatabaseBackupsRequest)) {
            return false;
        }

        ListAutonomousContainerDatabaseBackupsRequest other =
                (ListAutonomousContainerDatabaseBackupsRequest) o;
