...
public class LocalClonePluggableDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(LocalClonePluggableDatabaseResponse o) {
         ...
         */
        @Override
        public LocalClonePluggableDatabaseResponse build() {
            return new LocalClonePluggableDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocalClonePluggableDatabaseResponse)) {
            return false;
        }

        LocalClonePluggableDatabaseResponse other = (LocalClonePluggableDatabaseResponse) o;
