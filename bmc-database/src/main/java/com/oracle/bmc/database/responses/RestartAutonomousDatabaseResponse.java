...
public class RestartAutonomousDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartAutonomousDatabaseResponse)) {
            return false;
        }

        RestartAutonomousDatabaseResponse other = (RestartAutonomousDatabaseResponse) o;
