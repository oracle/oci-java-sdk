 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudVmClustersRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListCloudVmClustersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    private com.oracle.bmc.database.model.CloudVmClusterSummary.LifecycleState lifecycleState;

    /** A filter to return only cloud VM clusters that match the given lifecycle state exactly. */
    public com.oracle.bmc.database.model.CloudVmClusterSummary.LifecycleState getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudVmClustersRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.database.model.CloudVmClusterSummary.LifecycleState lifecycleState) {
        ...
        /**
         * A filter to return only cloud vmclusters that match the given cloud vmcluster type
         * exactly.
         */
        private com.oracle.bmc.database.model.CloudVmClusterSummary.VmClusterType vmClusterType =
                null;
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudVmClustersRequest o) {
         ...
         *
         * @return instance of ListCloudVmClustersRequest
         */
        public ListCloudVmClustersRequest build() {
            ListCloudVmClustersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudVmClustersRequest
         */
        public ListCloudVmClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCloudVmClustersRequest(compartmentId, cloudExadataInfrastructureId, limit,
            // page, sortBy, sortOrder, lifecycleState, displayName, opcRequestId, vmClusterType);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudVmClustersRequest)) {
            return false;
        }

        ListCloudVmClustersRequest other = (ListCloudVmClustersRequest) o;
