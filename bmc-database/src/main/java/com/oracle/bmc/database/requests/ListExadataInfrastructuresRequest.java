...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListExadataInfrastructuresExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExadataInfrastructuresRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListExadataInfrastructuresRequest
     ...
     * A filter to return only resources that match the given lifecycle state exactly.
     */
    public com.oracle.bmc.database.model.ExadataInfrastructureSummary.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListExadataInfrastructuresRequest, java.lang.Void> {
         ...
         * @return instance of ListExadataInfrastructuresRequest
         */
        public ListExadataInfrastructuresRequest buildWithoutInvocationCallback() {
            ListExadataInfrastructuresRequest request = new ListExadataInfrastructuresRequest();
            ...
            return request;
            // new ListExadataInfrastructuresRequest(compartmentId, limit, page, opcRequestId, sortBy, sortOrder, lifecycleState, displayName, excludedFields);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExadataInfrastructuresRequest)) {
            return false;
        }

        ListExadataInfrastructuresRequest other = (ListExadataInfrastructuresRequest) o;
