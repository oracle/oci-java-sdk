...
public final class CreateCrossTenancyDisasterRecoveryDetails extends CreateAutonomousDatabaseBase {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCrossTenancyDisasterRecoveryDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCrossTenancyDisasterRecoveryDetails)) {
            return false;
        }

        CreateCrossTenancyDisasterRecoveryDetails other =
                (CreateCrossTenancyDisasterRecoveryDetails) o;
        return java.util.Objects.equals(this.sourceId, other.sourceId)
                && java.util.Objects.equals(this.disasterRecoveryType, other.disasterRecoveryType)
