...
public class CreateExascaleDbStorageVaultResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateExascaleDbStorageVaultResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateExascaleDbStorageVaultResponse o) {
         ...
         */
        @Override
        public CreateExascaleDbStorageVaultResponse build() {
            return new CreateExascaleDbStorageVaultResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExascaleDbStorageVaultResponse)) {
            return false;
        }

        CreateExascaleDbStorageVaultResponse other = (CreateExascaleDbStorageVaultResponse) o;
