...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ListDbVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDbVersionsRequest.
 */
...
public class ListDbVersionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDbVersionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDbVersionsRequest(compartmentId, limit, page, dbSystemShape, dbSystemId, storageManagement, shapeAttribute, isUpgradeSupported, isDatabaseSoftwareImageSupported);
        }
    }
