...
/**
 * Details for creating a resource used to connect to an external Oracle Database using the
 * [Management Agent cloud service
 * (MACS)](https://docs.oracle.com/iaas/management-agents/index.html). <br>
