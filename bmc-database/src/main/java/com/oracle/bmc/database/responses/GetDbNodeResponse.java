...
public class GetDbNodeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDbNodeResponse> {
         ...
         */
        @Override
        public Builder copy(GetDbNodeResponse o) {
        ...
        public GetDbNodeResponse build() {
            return new GetDbNodeResponse(__httpStatusCode__, headers, etag, opcRequestId, dbNode);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDbNodeResponse)) {
            return false;
        }

        GetDbNodeResponse other = (GetDbNodeResponse) o;
