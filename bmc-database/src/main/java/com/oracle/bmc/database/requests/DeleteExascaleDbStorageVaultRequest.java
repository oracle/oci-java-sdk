...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/DeleteExascaleDbStorageVaultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteExascaleDbStorageVaultRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteExascaleDbStorageVaultRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteExascaleDbStorageVaultRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteExascaleDbStorageVaultRequest o) {
        ...
        /**
         * Build the instance of DeleteExascaleDbStorageVaultRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteExascaleDbStorageVaultRequest
         */
        public DeleteExascaleDbStorageVaultRequest build() {
            DeleteExascaleDbStorageVaultRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteExascaleDbStorageVaultRequest
         */
        public DeleteExascaleDbStorageVaultRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteExascaleDbStorageVaultRequest(exascaleDbStorageVaultId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteExascaleDbStorageVaultRequest)) {
            return false;
        }

        DeleteExascaleDbStorageVaultRequest other = (DeleteExascaleDbStorageVaultRequest) o;
