...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/GetBaseccVmClusterUpdateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBaseccVmClusterUpdateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetBaseccVmClusterUpdateRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBaseccVmClusterUpdateRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetBaseccVmClusterUpdateRequest o) {
        ...
        /**
         * Build the instance of GetBaseccVmClusterUpdateRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetBaseccVmClusterUpdateRequest
         */
        public GetBaseccVmClusterUpdateRequest build() {
            GetBaseccVmClusterUpdateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBaseccVmClusterUpdateRequest
         */
        public GetBaseccVmClusterUpdateRequest buildWithoutInvocationCallback() {
            GetBaseccVmClusterUpdateRequest request = new GetBaseccVmClusterUpdateRequest();
            request.baseccVmClusterId = baseccVmClusterId;
            request.updateId = updateId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetBaseccVmClusterUpdateRequest(baseccVmClusterId, updateId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBaseccVmClusterUpdateRequest)) {
            return false;
        }

        GetBaseccVmClusterUpdateRequest other = (GetBaseccVmClusterUpdateRequest) o;
