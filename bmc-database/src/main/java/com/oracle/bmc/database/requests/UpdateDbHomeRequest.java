...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/UpdateDbHomeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDbHomeRequest.
 */
...
public class UpdateDbHomeRequest
    ...
    public static class Builder
        ...
        /**
         * Request to update the properties of a Database Home.
         * @param updateDbHomeDetails the value to set
         * @return this builder instance
         */
