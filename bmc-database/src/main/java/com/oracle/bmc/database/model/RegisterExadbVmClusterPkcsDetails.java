...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = RegisterExadbVmClusterPkcsDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class RegisterExadbVmClusterPkcsDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"tdeKeyStoreType"})
    public RegisterExadbVmClusterPkcsDetails(TdeKeyStoreType tdeKeyStoreType) {
        super();
    ...
    public static class Builder {
        ...
        public RegisterExadbVmClusterPkcsDetails build() {
            RegisterExadbVmClusterPkcsDetails model =
                    new RegisterExadbVmClusterPkcsDetails(this.tdeKeyStoreType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RegisterExadbVmClusterPkcsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisterExadbVmClusterPkcsDetails)) {
            return false;
        }

        RegisterExadbVmClusterPkcsDetails other = (RegisterExadbVmClusterPkcsDetails) o;
