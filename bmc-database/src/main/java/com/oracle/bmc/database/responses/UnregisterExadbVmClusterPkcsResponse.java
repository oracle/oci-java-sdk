...
public class UnregisterExadbVmClusterPkcsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UnregisterExadbVmClusterPkcsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UnregisterExadbVmClusterPkcsResponse o) {
         ...
         */
        @Override
        public UnregisterExadbVmClusterPkcsResponse build() {
            return new UnregisterExadbVmClusterPkcsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnregisterExadbVmClusterPkcsResponse)) {
            return false;
        }

        UnregisterExadbVmClusterPkcsResponse other = (UnregisterExadbVmClusterPkcsResponse) o;
