...
public class FailoverAutonomousContainerDatabaseDataguardResponse
    ...
    private FailoverAutonomousContainerDatabaseDataguardResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(FailoverAutonomousContainerDatabaseDataguardResponse o) {
         ...
         */
        public FailoverAutonomousContainerDatabaseDataguardResponse build() {
            return new FailoverAutonomousContainerDatabaseDataguardResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailoverAutonomousContainerDatabaseDataguardResponse)) {
            return false;
        }

        FailoverAutonomousContainerDatabaseDataguardResponse other =
                (FailoverAutonomousContainerDatabaseDataguardResponse) o;
