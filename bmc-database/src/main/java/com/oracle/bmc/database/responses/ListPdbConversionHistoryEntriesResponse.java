...
public class ListPdbConversionHistoryEntriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * A list of {@code com.oracle.bmc.database.model.PdbConversionHistoryEntrySummary} instances.
     */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.database.model.PdbConversionHistoryEntrySummary>
            getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        /**
         * A list of {@code com.oracle.bmc.database.model.PdbConversionHistoryEntrySummary}
         * instances.
         */
        private java.util.List<com.oracle.bmc.database.model.PdbConversionHistoryEntrySummary>
                items;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPdbConversionHistoryEntriesResponse)) {
            return false;
        }

        ListPdbConversionHistoryEntriesResponse other = (ListPdbConversionHistoryEntriesResponse) o;
