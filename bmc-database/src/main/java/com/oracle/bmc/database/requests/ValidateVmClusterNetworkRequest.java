...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ValidateVmClusterNetworkExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ValidateVmClusterNetworkRequest.
 */
...
public class ValidateVmClusterNetworkRequest
    ...
    public static class Builder
        ...
        public ValidateVmClusterNetworkRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ValidateVmClusterNetworkRequest(exadataInfrastructureId, vmClusterNetworkId, opcRequestId, opcRetryToken);
        }
    }
