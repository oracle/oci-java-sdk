...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/database/ChangeAutonomousDatabaseSubscriptionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAutonomousDatabaseSubscriptionRequest.
 */
...
public class ChangeAutonomousDatabaseSubscriptionRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeAutonomousDatabaseSubscriptionRequest as configured by this builder
         *
