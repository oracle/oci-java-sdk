...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousVirtualMachineSummary.Builder.class)
...
public final class AutonomousVirtualMachineSummary
    ...
    public AutonomousVirtualMachineSummary(
            String id,
            String vmName,
            String dbServerId,
    ...
    public static class Builder {
        ...
        public AutonomousVirtualMachineSummary build() {
            AutonomousVirtualMachineSummary model =
                    new AutonomousVirtualMachineSummary(
                            this.id,
                            this.vmName,
                            this.dbServerId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousVirtualMachineSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousVirtualMachineSummary)) {
            return false;
        }

        AutonomousVirtualMachineSummary other = (AutonomousVirtualMachineSummary) o;
