...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/UpdateScriptExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateScriptRequest.
 */
...
public class UpdateScriptRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateScriptRequest o) {
            apmDomainId(o.getApmDomainId());
            scriptId(o.getScriptId());
            updateScriptDetails(o.getUpdateScriptDetails());
        ...
        public UpdateScriptRequest build() {
            UpdateScriptRequest request = buildWithoutInvocationCallback();
