...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/UpdateOnPremiseVantagePointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOnPremiseVantagePointRequest.
 */
...
public class UpdateOnPremiseVantagePointRequest
    ...
    public static class Builder
        ...
        public UpdateOnPremiseVantagePointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOnPremiseVantagePointRequest(apmDomainId, onPremiseVantagePointId, updateOnPremiseVantagePointDetails, ifMatch, opcRequestId);
        }
    }
