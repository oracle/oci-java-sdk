...
public class GetMonitorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetMonitorResponse> {
         ...
         */
        @Override
        public Builder copy(GetMonitorResponse o) {
        ...
        public GetMonitorResponse build() {
            return new GetMonitorResponse(__httpStatusCode__, headers, etag, opcRequestId, monitor);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMonitorResponse)) {
            return false;
        }

        GetMonitorResponse other = (GetMonitorResponse) o;
