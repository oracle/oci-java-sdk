...
public class AggregateNetworkDataResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.apmsynthetics.model.AggregatedNetworkDataResult
            getAggregatedNetworkDataResult() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder aggregatedNetworkDataResult(
                com.oracle.bmc.apmsynthetics.model.AggregatedNetworkDataResult
                        aggregatedNetworkDataResult) {
            this.aggregatedNetworkDataResult = aggregatedNetworkDataResult;
            return this;
        ...
        public Builder copy(AggregateNetworkDataResponse o) {
            ...
            aggregatedNetworkDataResult(o.getAggregatedNetworkDataResult());
    ...
    public String toString() {
        ...
        sb.append(",aggregatedNetworkDataResult=")
                .append(String.valueOf(aggregatedNetworkDataResult));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AggregateNetworkDataResponse)) {
            return false;
        }

        AggregateNetworkDataResponse other = (AggregateNetworkDataResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.aggregatedNetworkDataResult, other.aggregatedNetworkDataResult);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.aggregatedNetworkDataResult == null
                                ? 43
                                : this.aggregatedNetworkDataResult.hashCode());
        return result;
    }
}
