...
/**
 * Details of a Dedicated Vantage Point (DVP) stack in Resource Manager. <br>
...
public class DvpStackDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    /** Type of stack. */
    public enum DvpStackType implements com.oracle.bmc.http.internal.BmcEnum {
