...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/CreateOnPremiseVantagePointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOnPremiseVantagePointRequest.
 */
...
public class CreateOnPremiseVantagePointRequest
    ...
    public static class Builder
        ...
        public CreateOnPremiseVantagePointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateOnPremiseVantagePointRequest(apmDomainId, createOnPremiseVantagePointDetails, opcRetryToken, opcRequestId);
        }
    }
