...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/GetScriptExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetScriptRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200630")
public class GetScriptRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetScriptRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetScriptRequest
         */
        public GetScriptRequest build() {
            GetScriptRequest request = buildWithoutInvocationCallback();
        ...
        public GetScriptRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetScriptRequest(apmDomainId, scriptId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetScriptRequest)) {
            return false;
        }

        GetScriptRequest other = (GetScriptRequest) o;
