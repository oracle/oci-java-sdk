...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/DeleteWorkerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteWorkerRequest.
 */
...
public class DeleteWorkerRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteWorkerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteWorkerRequest(apmDomainId, onPremiseVantagePointId, workerId, ifMatch, opcRequestId);
        }
    }
