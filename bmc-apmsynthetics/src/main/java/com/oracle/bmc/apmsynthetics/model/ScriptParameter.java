...
/**
 * Details of the script parameters, paramName must be from the script content and these details can
 * be used to overwrite the default parameter present in the script content. <br>
...
public final class ScriptParameter
    ...
    public static class Builder {
        ...
        /**
         * If the parameter value is secret and should be kept confidential, then set isSecret to
         * true.
         */
