...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = Password.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = PasswordInText.class,
            name = "IN_TEXT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = PasswordInVault.class,
            name = "VAULT_SECRET_ID")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class Password extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public enum PasswordType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(PasswordType.class);
        ...
        public static PasswordType create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'PasswordType', returning UnknownEnumValue",
                    key);
