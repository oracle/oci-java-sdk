...
/**
 * Request configuration details for the NETWORK monitor type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkMonitorConfiguration.Builder.class)
...
public final class NetworkMonitorConfiguration extends MonitorConfiguration {
    ...
    public static class Builder {
        ...
        public NetworkMonitorConfiguration build() {
            NetworkMonitorConfiguration model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkMonitorConfiguration model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkMonitorConfiguration)) {
            return false;
        }

        NetworkMonitorConfiguration other = (NetworkMonitorConfiguration) o;
