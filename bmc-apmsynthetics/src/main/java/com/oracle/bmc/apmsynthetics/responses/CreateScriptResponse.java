...
public class CreateScriptResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateScriptResponse> {
         ...
         */
        @Override
        public Builder copy(CreateScriptResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateScriptResponse)) {
            return false;
        }

        CreateScriptResponse other = (CreateScriptResponse) o;
