...
public enum ProbeMode {
    ...
    static {
        ...
        for (ProbeMode v : ProbeMode.values()) {
    ...
    public static ProbeMode create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'ProbeMode', returning UnknownEnumValue",
                key);
