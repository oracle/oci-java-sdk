...
public final class VantagePointExecution
    ...
    public static class Builder {
        ...
        public VantagePointExecution build() {
            VantagePointExecution model = new VantagePointExecution(this.name, this.executions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VantagePointExecution model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VantagePointExecution(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VantagePointExecution)) {
            return false;
        }

        VantagePointExecution other = (VantagePointExecution) o;
