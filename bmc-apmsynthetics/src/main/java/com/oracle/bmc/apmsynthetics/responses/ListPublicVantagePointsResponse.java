...
public class ListPublicVantagePointsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.apmsynthetics.model.PublicVantagePointCollection
            getPublicVantagePointCollection() {
        return publicVantagePointCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder publicVantagePointCollection(
                com.oracle.bmc.apmsynthetics.model.PublicVantagePointCollection
                        publicVantagePointCollection) {
            this.publicVantagePointCollection = publicVantagePointCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(ListPublicVantagePointsResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",publicVantagePointCollection=")
                .append(String.valueOf(publicVantagePointCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPublicVantagePointsResponse)) {
            return false;
        }

        ListPublicVantagePointsResponse other = (ListPublicVantagePointsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.publicVantagePointCollection, other.publicVantagePointCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.publicVantagePointCollection == null
                                ? 43
                                : this.publicVantagePointCollection.hashCode());
        return result;
    }
}
