...
public class UpdateOnPremiseVantagePointResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code OnPremiseVantagePoint} instance. */
    ...
    private UpdateOnPremiseVantagePointResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateOnPremiseVantagePointResponse o) {
         ...
         */
        @Override
        public UpdateOnPremiseVantagePointResponse build() {
            return new UpdateOnPremiseVantagePointResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOnPremiseVantagePointResponse)) {
            return false;
        }

        UpdateOnPremiseVantagePointResponse other = (UpdateOnPremiseVantagePointResponse) o;
