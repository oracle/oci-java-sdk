...
public class AggregateNetworkDataConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AggregateNetworkDataConverter.class);

    public static com.oracle.bmc.apmsynthetics.requests.AggregateNetworkDataRequest
            interceptRequest(
                    com.oracle.bmc.apmsynthetics.requests.AggregateNetworkDataRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.apmsynthetics.responses.AggregateNetworkDataResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.apmsynthetics.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apmsynthetics.responses.AggregateNetworkDataResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.apmsynthetics.responses.AggregateNetworkDataResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.apmsynthetics.responses
                                                        .AggregateNetworkDataResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.aggregatedNetworkDataResult(response.getItem());
