...
/**
 * Information about On-premise vantage point. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OnPremiseVantagePointSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OnPremiseVantagePointSummary
    ...
    public OnPremiseVantagePointSummary(
            String id,
            String displayName,
            String name,
            Type type,
    ...
    public static class Builder {
        ...
        public OnPremiseVantagePointSummary build() {
            OnPremiseVantagePointSummary model =
                    new OnPremiseVantagePointSummary(
                            this.id,
                            this.displayName,
                            this.name,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OnPremiseVantagePointSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OnPremiseVantagePointSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OnPremiseVantagePointSummary)) {
            return false;
        }

        OnPremiseVantagePointSummary other = (OnPremiseVantagePointSummary) o;
