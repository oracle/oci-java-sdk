...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmsynthetics/GetOnPremiseVantagePointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOnPremiseVantagePointRequest.
 */
...
public class GetOnPremiseVantagePointRequest
    ...
    public static class Builder
        ...
        public GetOnPremiseVantagePointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetOnPremiseVantagePointRequest(apmDomainId, onPremiseVantagePointId, opcRequestId);
        }
    }
