...
public final class VerifyText extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public VerifyText build() {
            VerifyText model = new VerifyText(this.text);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerifyText model) {
