...
public class CreateMonitorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMonitorResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMonitorResponse)) {
            return false;
        }

        CreateMonitorResponse other = (CreateMonitorResponse) o;
