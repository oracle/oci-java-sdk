...
public class UpdateOnPremiseVantagePointConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateOnPremiseVantagePointConverter.class);

    public static com.oracle.bmc.apmsynthetics.requests.UpdateOnPremiseVantagePointRequest
            interceptRequest(
                    com.oracle.bmc.apmsynthetics.requests.UpdateOnPremiseVantagePointRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.apmsynthetics.requests.UpdateOnPremiseVantagePointRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.apmsynthetics.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apmsynthetics.responses.UpdateOnPremiseVantagePointResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.apmsynthetics.responses
                                                .UpdateOnPremiseVantagePointResponse.Builder
                                        builder =
                                                com.oracle.bmc.apmsynthetics.responses
                                                        .UpdateOnPremiseVantagePointResponse
                                                        .builder()
                                ...
                                builder.onPremiseVantagePoint(response.getItem());
