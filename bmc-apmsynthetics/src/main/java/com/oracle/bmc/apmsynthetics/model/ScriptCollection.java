...
public final class ScriptCollection
    ...
    public static class Builder {
        ...
        public ScriptCollection build() {
            ScriptCollection model = new ScriptCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScriptCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScriptCollection)) {
            return false;
        }

        ScriptCollection other = (ScriptCollection) o;
