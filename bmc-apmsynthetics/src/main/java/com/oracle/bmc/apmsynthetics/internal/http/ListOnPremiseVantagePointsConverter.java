...
public class ListOnPremiseVantagePointsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListOnPremiseVantagePointsConverter.class);

    public static com.oracle.bmc.apmsynthetics.requests.ListOnPremiseVantagePointsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.apmsynthetics.requests.ListOnPremiseVantagePointsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getApmDomainId(), "apmDomainId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20200630").path("onPremiseVantagePoints");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.apmsynthetics.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apmsynthetics.responses.ListOnPremiseVantagePointsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.onPremiseVantagePointCollection(response.getItem());
