...
/**
 * The information about a dedicated vantage point. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DedicatedVantagePoint.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DedicatedVantagePoint
    ...
    public static class Builder {
        ...
        /**
         * Unique permanent name of the dedicated vantage point. This is the same as the
         * displayName.
         */
        ...
        public DedicatedVantagePoint build() {
            DedicatedVantagePoint model =
                    new DedicatedVantagePoint(
                            this.id,
                            this.displayName,
                            this.name,
                            this.status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DedicatedVantagePoint model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DedicatedVantagePoint(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DedicatedVantagePoint)) {
            return false;
        }

        DedicatedVantagePoint other = (DedicatedVantagePoint) o;
