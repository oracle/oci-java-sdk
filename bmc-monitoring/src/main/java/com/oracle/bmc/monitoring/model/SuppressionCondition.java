...
/**
 * Precondition for an alarm suppression within the suppression date and time range ({@code
 * timeSuppressFrom} to {@code timeSuppressUntil}). <br>
...
public class SuppressionCondition
    ...
    public enum ConditionType implements com.oracle.bmc.http.internal.BmcEnum {
