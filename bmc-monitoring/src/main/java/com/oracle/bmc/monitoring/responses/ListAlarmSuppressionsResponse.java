...
public class ListAlarmSuppressionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.monitoring.model.AlarmSuppressionCollection
            getAlarmSuppressionCollection() {
        return alarmSuppressionCollection;
    }
    ...
    private ListAlarmSuppressionsResponse(
            ...
            com.oracle.bmc.monitoring.model.AlarmSuppressionCollection alarmSuppressionCollection) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder alarmSuppressionCollection(
        ...
        public Builder copy(ListAlarmSuppressionsResponse o) {
            ...
            alarmSuppressionCollection(o.getAlarmSuppressionCollection());
    ...
    public String toString() {
        ...
        sb.append(",alarmSuppressionCollection=")
                .append(String.valueOf(alarmSuppressionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAlarmSuppressionsResponse)) {
            return false;
        }

        ListAlarmSuppressionsResponse other = (ListAlarmSuppressionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPreviousPage, other.opcPreviousPage)
                && java.util.Objects.equals(
                        this.alarmSuppressionCollection, other.alarmSuppressionCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.alarmSuppressionCollection == null
                                ? 43
                                : this.alarmSuppressionCollection.hashCode());
        return result;
    }
}
