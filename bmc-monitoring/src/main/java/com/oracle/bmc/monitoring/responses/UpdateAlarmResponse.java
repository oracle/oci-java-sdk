...
public class UpdateAlarmResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateAlarmResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateAlarmResponse o) {
        ...
        public UpdateAlarmResponse build() {
            return new UpdateAlarmResponse(__httpStatusCode__, headers, etag, opcRequestId, alarm);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAlarmResponse)) {
            return false;
        }

        UpdateAlarmResponse other = (UpdateAlarmResponse) o;
