...
public class DeleteAlarmResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteAlarmResponse> {
        ...
        public DeleteAlarmResponse build() {
            return new DeleteAlarmResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAlarmResponse)) {
            return false;
        }

        DeleteAlarmResponse other = (DeleteAlarmResponse) o;
