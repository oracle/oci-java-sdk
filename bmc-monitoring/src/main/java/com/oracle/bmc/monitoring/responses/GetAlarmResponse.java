...
public class GetAlarmResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAlarmResponse> {
         ...
         */
        @Override
        public GetAlarmResponse build() {
            return new GetAlarmResponse(__httpStatusCode__, headers, etag, opcRequestId, alarm);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAlarmResponse)) {
            return false;
        }

        GetAlarmResponse other = (GetAlarmResponse) o;
