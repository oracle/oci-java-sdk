...
public class ListMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.monitoring.model.Metric> items) {
            this.items = items;
            return this;
        }
        ...
        public ListMetricsResponse build() {
            return new ListMetricsResponse(__httpStatusCode__, opcNextPage, opcRequestId, items);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMetricsResponse)) {
            return false;
        }

        ListMetricsResponse other = (ListMetricsResponse) o;
