...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "targetType",
    defaultImpl = AlarmSuppressionTarget.class
)
...
public class AlarmSuppressionTarget extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected AlarmSuppressionTarget() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AlarmSuppressionTarget(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlarmSuppressionTarget)) {
            return false;
        }

        AlarmSuppressionTarget other = (AlarmSuppressionTarget) o;
