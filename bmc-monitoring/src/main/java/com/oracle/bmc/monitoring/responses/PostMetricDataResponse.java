...
public class PostMetricDataResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public String toString() {
        ...
        sb.append(",postMetricDataResponseDetails=")
                .append(String.valueOf(postMetricDataResponseDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PostMetricDataResponse)) {
            return false;
        }

        PostMetricDataResponse other = (PostMetricDataResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.postMetricDataResponseDetails, other.postMetricDataResponseDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.postMetricDataResponseDetails == null
                                ? 43
                                : this.postMetricDataResponseDetails.hashCode());
        return result;
    }
}
