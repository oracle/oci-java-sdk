...
/**
 * The configuration details for an alarm suppression. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AlarmSuppression.Builder.class)
...
public final class AlarmSuppression
    ...
    public static class Builder {
         ...
         * RFC3339.
         *
         * <p>Example: {@code 2018-02-01T01:02:29.600Z}
         */
         ...
         * RFC3339.
         *
         * <p>Example: {@code 2018-02-01T02:02:29.600Z}
         */
         ...
         * RFC3339.
         *
         * <p>Example: {@code 2018-02-03T01:02:29.600Z}
         */
        ...
        public AlarmSuppression build() {
            AlarmSuppression model =
                    new AlarmSuppression(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AlarmSuppression model) {
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the compartment containing the alarm suppression.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlarmSuppression)) {
            return false;
        }

        AlarmSuppression other = (AlarmSuppression) o;
