...
public class CreateGroupCursorResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "headers", "opcRequestId", "cursor"})
    private CreateGroupCursorResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateGroupCursorResponse> {
        ...
        public CreateGroupCursorResponse build() {
            return new CreateGroupCursorResponse(__httpStatusCode__, headers, opcRequestId, cursor);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGroupCursorResponse)) {
            return false;
        }

        CreateGroupCursorResponse other = (CreateGroupCursorResponse) o;
