...
/**
 * The summary representation of a stream pool. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StreamPoolSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class StreamPoolSummary
    ...
    public static class Builder {
         ...
         * of a private stream pool can be retrieved through the {@link
         * #getStreamPool(GetStreamPoolRequest) getStreamPool} API.
         */
        ...
        public StreamPoolSummary build() {
            StreamPoolSummary model =
                    new StreamPoolSummary(
                            this.id,
                            this.compartmentId,
                            this.name,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamPoolSummary model) {
    ...
    /**
     * True if the stream pool is private, false otherwise. The associated endpoint and subnetId of
     * a private stream pool can be retrieved through the {@link
     * #getStreamPool(GetStreamPoolRequest) getStreamPool} API.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isPrivate")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamPoolSummary)) {
            return false;
        }

        StreamPoolSummary other = (StreamPoolSummary) o;
