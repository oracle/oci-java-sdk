...
public class StreamAdminAsyncClient implements StreamAdminAsync {
    ...
    public java.util.concurrent.Future<ChangeConnectHarnessCompartmentResponse>
            changeConnectHarnessCompartment(
                    final ChangeConnectHarnessCompartmentRequest request,
    ...
    public java.util.concurrent.Future<ChangeStreamCompartmentResponse> changeStreamCompartment(
            final ChangeStreamCompartmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    public java.util.concurrent.Future<ChangeStreamPoolCompartmentResponse>
            changeStreamPoolCompartment(
                    final ChangeStreamPoolCompartmentRequest request,
                    final com.oracle.bmc.responses.AsyncHandler<
    ...
    @Override
    public java.util.concurrent.Future<CreateArchiverResponse> createArchiver(
            final CreateArchiverRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            CreateArchiverRequest, CreateArchiverResponse>
                    handler) {
            ...
            handlerToUse =
                    new com.oracle.bmc.util.internal.RefreshAuthTokenWrappingAsyncHandler<
                        ...
                        public void retryCall() {
                            ...
                            client.post(
                                    ib,
                                    interceptedRequest.getCreateArchiverDetails(),
                                    interceptedRequest,
                                    onSuccess,
                                    onError);
                        }
    ...
    public java.util.concurrent.Future<CreateConnectHarnessResponse> createConnectHarness(
            final CreateConnectHarnessRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    public java.util.concurrent.Future<CreateStreamPoolResponse> createStreamPool(
            final CreateStreamPoolRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    public java.util.concurrent.Future<DeleteConnectHarnessResponse> deleteConnectHarness(
            final DeleteConnectHarnessRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    public java.util.concurrent.Future<DeleteStreamPoolResponse> deleteStreamPool(
            final DeleteStreamPoolRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    @Override
    public java.util.concurrent.Future<GetArchiverResponse> getArchiver(
            final GetArchiverRequest request,
            final com.oracle.bmc.responses.AsyncHandler<GetArchiverRequest, GetArchiverResponse>
                    handler) {
        ...
        com.oracle.bmc.responses.AsyncHandler<GetArchiverRequest, GetArchiverResponse>
                handlerToUse = handler;
        if (handler != null
                && this.authenticationDetailsProvider
                        instanceof com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider) {
    ...
    @Override
    public java.util.concurrent.Future<StartArchiverResponse> startArchiver(
            final StartArchiverRequest request,
            final com.oracle.bmc.responses.AsyncHandler<StartArchiverRequest, StartArchiverResponse>
                    handler) {
        ...
        if (handler != null
            ...
            handlerToUse =
                    new com.oracle.bmc.util.internal.RefreshAuthTokenWrappingAsyncHandler<
                            StartArchiverRequest, StartArchiverResponse>(
                            (com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider)
                                    this.authenticationDetailsProvider,
                            handler) {
                        @Override
    ...
    @Override
    public java.util.concurrent.Future<StopArchiverResponse> stopArchiver(
            final StopArchiverRequest request,
            final com.oracle.bmc.responses.AsyncHandler<StopArchiverRequest, StopArchiverResponse>
                    handler) {
        ...
        if (handler != null
            ...
            handlerToUse =
                    new com.oracle.bmc.util.internal.RefreshAuthTokenWrappingAsyncHandler<
                            StopArchiverRequest, StopArchiverResponse>(
                            (com.oracle.bmc.auth.RefreshableOnNotAuthenticatedProvider)
                                    this.authenticationDetailsProvider,
                            handler) {
                        @Override
    ...
    @Override
    public java.util.concurrent.Future<UpdateArchiverResponse> updateArchiver(
            final UpdateArchiverRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            UpdateArchiverRequest, UpdateArchiverResponse>
                    handler) {
            ...
            handlerToUse =
                    new com.oracle.bmc.util.internal.RefreshAuthTokenWrappingAsyncHandler<
                        ...
                        public void retryCall() {
                            ...
                            client.put(
                                    ib,
                                    interceptedRequest.getUpdateArchiverDetails(),
                                    interceptedRequest,
                                    onSuccess,
                                    onError);
                        }
    ...
    public java.util.concurrent.Future<UpdateConnectHarnessResponse> updateConnectHarness(
            final UpdateConnectHarnessRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
    ...
    public java.util.concurrent.Future<UpdateStreamResponse> updateStream(
            final UpdateStreamRequest request,
    ...
    public java.util.concurrent.Future<UpdateStreamPoolResponse> updateStreamPool(
            final UpdateStreamPoolRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
