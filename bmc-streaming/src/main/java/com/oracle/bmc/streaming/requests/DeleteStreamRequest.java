...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/streaming/DeleteStreamExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteStreamRequest.
 */
...
public class DeleteStreamRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteStreamRequest build() {
            DeleteStreamRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteStreamRequest
         */
        public DeleteStreamRequest buildWithoutInvocationCallback() {
            DeleteStreamRequest request = new DeleteStreamRequest();
            request.streamId = streamId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteStreamRequest(streamId, opcRequestId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().streamId(streamId).opcRequestId(opcRequestId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteStreamRequest)) {
            return false;
        }
