...
public class CreateCursorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCursorResponse> {
        ...
        public CreateCursorResponse build() {
            return new CreateCursorResponse(__httpStatusCode__, headers, opcRequestId, cursor);
        }
    }
