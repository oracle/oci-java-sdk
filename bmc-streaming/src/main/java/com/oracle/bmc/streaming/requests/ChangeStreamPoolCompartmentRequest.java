...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/streaming/ChangeStreamPoolCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeStreamPoolCompartmentRequest.
 */
...
public class ChangeStreamPoolCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeStreamPoolCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeStreamPoolCompartmentRequest(streamPoolId, changeStreamPoolCompartmentDetails, ifMatch, opcRequestId);
        }
    }
