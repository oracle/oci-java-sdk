...
public class UpdateStreamPoolResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateStreamPoolResponse> {
        ...
        public UpdateStreamPoolResponse build() {
            return new UpdateStreamPoolResponse(
                    __httpStatusCode__, headers, opcRequestId, opcWorkRequestId, etag, streamPool);
        }
    }
