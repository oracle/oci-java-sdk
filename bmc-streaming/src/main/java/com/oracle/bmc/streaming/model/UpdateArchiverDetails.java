...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateArchiverDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class UpdateArchiverDetails {
    ...
    public static class Builder {
        ...
        public UpdateArchiverDetails build() {
            UpdateArchiverDetails __instance__ =
                    new UpdateArchiverDetails(
                            bucketName,
                            useExistingBucket,
                            startPosition,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateArchiverDetails o) {
