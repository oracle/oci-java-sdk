...
public class ListStreamPoolsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListStreamPoolsResponse(
            ...
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.streaming.model.StreamPoolSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListStreamPoolsResponse)) {
            return false;
        }

        ListStreamPoolsResponse other = (ListStreamPoolsResponse) o;
