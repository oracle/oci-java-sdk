...
/**
 * Detailed representation of a connect harness. <br>
...
public final class ConnectHarness
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConnectHarness)) {
            return false;
        }

        ConnectHarness other = (ConnectHarness) o;
