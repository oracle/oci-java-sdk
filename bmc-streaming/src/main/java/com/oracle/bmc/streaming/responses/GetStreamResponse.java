...
public class GetStreamResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetStreamResponse> {
        ...
        public GetStreamResponse build() {
            return new GetStreamResponse(__httpStatusCode__, headers, opcRequestId, etag, stream);
        }
    }
