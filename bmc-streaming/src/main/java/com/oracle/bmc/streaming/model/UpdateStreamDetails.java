...
/**
 * Object used to update a stream. <br>
...
public final class UpdateStreamDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"streamPoolId", "freeformTags", "definedTags"})
    public UpdateStreamDetails(
            String streamPoolId,
    ...
    public static class Builder {
         ...
         * stream pool where the stream should be moved.
         */
        ...
        public UpdateStreamDetails build() {
            UpdateStreamDetails model =
                    new UpdateStreamDetails(this.streamPoolId, this.freeformTags, this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateStreamDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStreamDetails)) {
            return false;
        }

        UpdateStreamDetails other = (UpdateStreamDetails) o;
