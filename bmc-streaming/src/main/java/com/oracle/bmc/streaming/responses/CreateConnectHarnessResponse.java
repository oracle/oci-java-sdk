...
public class CreateConnectHarnessResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateConnectHarnessResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateConnectHarnessResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectHarnessResponse)) {
            return false;
        }
