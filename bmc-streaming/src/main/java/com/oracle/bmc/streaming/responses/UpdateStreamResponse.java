...
public class UpdateStreamResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateStreamResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateStreamResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStreamResponse)) {
            return false;
        }
