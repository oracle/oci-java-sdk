...
public class ConsumerHeartbeatResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ConsumerHeartbeatResponse> {
        ...
        public ConsumerHeartbeatResponse build() {
            return new ConsumerHeartbeatResponse(__httpStatusCode__, headers, opcRequestId, cursor);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConsumerHeartbeatResponse)) {
            return false;
        }

        ConsumerHeartbeatResponse other = (ConsumerHeartbeatResponse) o;
