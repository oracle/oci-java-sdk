...
public class UpdateGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateGroupResponse> {
        ...
        public UpdateGroupResponse build() {
            return new UpdateGroupResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGroupResponse)) {
            return false;
        }
