...
public class RemoveGatewayLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveGatewayLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveGatewayLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveGatewayLockResponse o) {
         ...
         */
        @Override
        public RemoveGatewayLockResponse build() {
            return new RemoveGatewayLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveGatewayLockResponse)) {
            return false;
        }

        RemoveGatewayLockResponse other = (RemoveGatewayLockResponse) o;
