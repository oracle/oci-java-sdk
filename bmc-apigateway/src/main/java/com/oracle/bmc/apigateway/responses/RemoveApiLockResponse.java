...
public class RemoveApiLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveApiLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveApiLockResponse o) {
         ...
         */
        @Override
        public RemoveApiLockResponse build() {
            return new RemoveApiLockResponse(__httpStatusCode__, headers, opcRequestId, etag, api);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveApiLockResponse)) {
            return false;
        }

        RemoveApiLockResponse other = (RemoveApiLockResponse) o;
