...
public class AddSdkLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddSdkLockResponse> {
         ...
         */
        @Override
        public Builder copy(AddSdkLockResponse o) {
         ...
         */
        @Override
        public AddSdkLockResponse build() {
            return new AddSdkLockResponse(__httpStatusCode__, headers, opcRequestId, etag, sdk);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddSdkLockResponse)) {
            return false;
        }

        AddSdkLockResponse other = (AddSdkLockResponse) o;
