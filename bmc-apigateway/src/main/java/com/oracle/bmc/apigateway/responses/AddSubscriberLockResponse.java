...
public class AddSubscriberLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AddSubscriberLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddSubscriberLockResponse> {
         ...
         */
        @Override
        public Builder copy(AddSubscriberLockResponse o) {
         ...
         */
        @Override
        public AddSubscriberLockResponse build() {
            return new AddSubscriberLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddSubscriberLockResponse)) {
            return false;
        }

        AddSubscriberLockResponse other = (AddSubscriberLockResponse) o;
