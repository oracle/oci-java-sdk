...
/**
 * Collection of deployment summaries. <br>
...
public final class DeploymentCollection
    ...
    public static class Builder {
        ...
        public DeploymentCollection build() {
            DeploymentCollection model = new DeploymentCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeploymentCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeploymentCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeploymentCollection)) {
            return false;
        }

        DeploymentCollection other = (DeploymentCollection) o;
