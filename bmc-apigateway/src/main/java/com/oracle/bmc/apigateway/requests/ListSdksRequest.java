...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/ListSdksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSdksRequest.
 */
...
public class ListSdksRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListSdksRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSdksRequest(sdkId, displayName, lifecycleState, limit, page, sortOrder, sortBy, apiId, opcRequestId);
        }
    }
