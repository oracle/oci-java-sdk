...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/DeleteApiExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApiRequest.
 */
...
public class DeleteApiRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteApiRequest
         */
        public DeleteApiRequest buildWithoutInvocationCallback() {
            DeleteApiRequest request = new DeleteApiRequest();
            request.apiId = apiId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteApiRequest(apiId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().apiId(apiId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApiRequest)) {
            return false;
        }
