...
public class GatewayAsyncClient implements GatewayAsync {
    ...
    public java.util.concurrent.Future<AddGatewayLockResponse> addGatewayLock(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async addGatewayLock");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, AddGatewayLockResponse>
                transformer =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                AddGatewayLockRequest, AddGatewayLockResponse>,
                        java.util.concurrent.Future<AddGatewayLockResponse>>
                futureSupplier =
    ...
    public java.util.concurrent.Future<DeleteGatewayResponse> deleteGateway(
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<DeleteGatewayResponse>>
    ...
    public java.util.concurrent.Future<GetGatewayResponse> getGateway(
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<GetGatewayResponse>>
    ...
    public java.util.concurrent.Future<ListGatewaysResponse> listGateways(
        ...
        java.util.function.Function<
                        ...
                        java.util.concurrent.Future<ListGatewaysResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<RemoveGatewayLockResponse> removeGatewayLock(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async removeGatewayLock");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, RemoveGatewayLockResponse>
                transformer =
                        RemoveGatewayLockConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<RemoveGatewayLockRequest, RemoveGatewayLockResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                RemoveGatewayLockRequest, RemoveGatewayLockResponse>,
                        java.util.concurrent.Future<RemoveGatewayLockResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
