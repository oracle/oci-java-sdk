...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/RemoveSdkLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveSdkLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190501")
public class RemoveSdkLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveSdkLockRequest o) {
            sdkId(o.getSdkId());
        ...
        /**
         * Build the instance of RemoveSdkLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveSdkLockRequest
         */
        public RemoveSdkLockRequest build() {
            RemoveSdkLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveSdkLockRequest
         */
        public RemoveSdkLockRequest buildWithoutInvocationCallback() {
            RemoveSdkLockRequest request = new RemoveSdkLockRequest();
            request.sdkId = sdkId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveSdkLockRequest(sdkId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveSdkLockRequest)) {
            return false;
        }

        RemoveSdkLockRequest other = (RemoveSdkLockRequest) o;
