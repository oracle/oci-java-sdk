...
public class UsagePlansClient implements UsagePlans {
    ...
    public AddUsagePlanLockResponse addUsagePlanLock(AddUsagePlanLockRequest request) {
        LOG.trace("Called addUsagePlanLock");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, AddUsagePlanLockResponse>
                transformer =
    ...
    public ChangeUsagePlanCompartmentResponse changeUsagePlanCompartment(
        ...
        LOG.trace("Called changeUsagePlanCompartment");
    ...
    public CreateUsagePlanResponse createUsagePlan(CreateUsagePlanRequest request) {
        LOG.trace("Called createUsagePlan");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateUsagePlanDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteUsagePlanResponse deleteUsagePlan(DeleteUsagePlanRequest request) {
        LOG.trace("Called deleteUsagePlan");
    ...
    public ListUsagePlansResponse listUsagePlans(ListUsagePlansRequest request) {
        LOG.trace("Called listUsagePlans");
    ...
    public RemoveUsagePlanLockResponse removeUsagePlanLock(RemoveUsagePlanLockRequest request) {
        LOG.trace("Called removeUsagePlanLock");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RemoveUsagePlanLockResponse>
                transformer =
    ...
    public UpdateUsagePlanResponse updateUsagePlan(UpdateUsagePlanRequest request) {
        LOG.trace("Called updateUsagePlan");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateUsagePlanDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
