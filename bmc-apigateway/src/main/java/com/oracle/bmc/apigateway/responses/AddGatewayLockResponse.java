...
public class AddGatewayLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AddGatewayLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddGatewayLockResponse> {
         ...
         */
        @Override
        public Builder copy(AddGatewayLockResponse o) {
         ...
         */
        @Override
        public AddGatewayLockResponse build() {
            return new AddGatewayLockResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, gateway);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddGatewayLockResponse)) {
            return false;
        }

        AddGatewayLockResponse other = (AddGatewayLockResponse) o;
