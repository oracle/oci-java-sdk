...
/**
 * A PEM-encoded public key used for verifying the JWT signature. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PemEncodedPublicKey.Builder.class)
...
public final class PemEncodedPublicKey extends StaticPublicKey {
    ...
    @Deprecated
    public PemEncodedPublicKey(String kid, String key) {
        super(kid);
        this.key = key;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PemEncodedPublicKey)) {
            return false;
        }
