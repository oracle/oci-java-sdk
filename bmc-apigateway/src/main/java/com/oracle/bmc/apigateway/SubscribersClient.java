...
public class SubscribersClient implements Subscribers {
    ...
    @Override
    public AddSubscriberLockResponse addSubscriberLock(AddSubscriberLockRequest request) {
        LOG.trace("Called addSubscriberLock");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, AddSubscriberLockResponse>
                transformer =
    ...
    public ChangeSubscriberCompartmentResponse changeSubscriberCompartment(
        ...
        LOG.trace("Called changeSubscriberCompartment");
    ...
    public CreateSubscriberResponse createSubscriber(CreateSubscriberRequest request) {
        LOG.trace("Called createSubscriber");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateSubscriberDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteSubscriberResponse deleteSubscriber(DeleteSubscriberRequest request) {
        LOG.trace("Called deleteSubscriber");
    ...
    public GetSubscriberResponse getSubscriber(GetSubscriberRequest request) {
        LOG.trace("Called getSubscriber");
    ...
    public ListSubscribersResponse listSubscribers(ListSubscribersRequest request) {
        LOG.trace("Called listSubscribers");
    ...
    @Override
    public RemoveSubscriberLockResponse removeSubscriberLock(RemoveSubscriberLockRequest request) {
        LOG.trace("Called removeSubscriberLock");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RemoveSubscriberLockResponse>
                transformer =
    ...
    public UpdateSubscriberResponse updateSubscriber(UpdateSubscriberRequest request) {
        LOG.trace("Called updateSubscriber");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateSubscriberDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
