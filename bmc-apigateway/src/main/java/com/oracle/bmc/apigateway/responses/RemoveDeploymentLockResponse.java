...
public class RemoveDeploymentLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveDeploymentLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveDeploymentLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveDeploymentLockResponse o) {
         ...
         */
        @Override
        public RemoveDeploymentLockResponse build() {
            return new RemoveDeploymentLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDeploymentLockResponse)) {
            return false;
        }

        RemoveDeploymentLockResponse other = (RemoveDeploymentLockResponse) o;
