...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = ValidationFailurePolicy.class
)
...
public class ValidationFailurePolicy extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ValidationFailurePolicy() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidationFailurePolicy)) {
            return false;
        }

        ValidationFailurePolicy other = (ValidationFailurePolicy) o;
