...
/**
 * Information about the new SDK. <br>
...
public final class CreateSdkDetails
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of API
         * resource
         */
        ...
        /**
         * Additional optional configurations that can be passed to generate SDK Api. The applicable
         * parameters are listed under "parameters" when "/sdkLanguageTypes" is called.
         *
