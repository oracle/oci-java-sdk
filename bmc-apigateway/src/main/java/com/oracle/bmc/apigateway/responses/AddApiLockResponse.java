...
public class AddApiLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddApiLockResponse> {
         ...
         */
        @Override
        public Builder copy(AddApiLockResponse o) {
         ...
         */
        @Override
        public AddApiLockResponse build() {
            return new AddApiLockResponse(__httpStatusCode__, headers, opcRequestId, etag, api);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddApiLockResponse)) {
            return false;
        }

        AddApiLockResponse other = (AddApiLockResponse) o;
