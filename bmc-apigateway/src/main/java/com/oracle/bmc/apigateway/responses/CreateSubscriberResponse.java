...
public class CreateSubscriberResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSubscriberResponse> {
         ...
         */
        @Override
        public Builder copy(CreateSubscriberResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSubscriberResponse)) {
            return false;
        }

        CreateSubscriberResponse other = (CreateSubscriberResponse) o;
