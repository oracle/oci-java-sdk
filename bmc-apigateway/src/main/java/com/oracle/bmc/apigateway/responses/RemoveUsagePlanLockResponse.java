...
public class RemoveUsagePlanLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveUsagePlanLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveUsagePlanLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveUsagePlanLockResponse o) {
         ...
         */
        @Override
        public RemoveUsagePlanLockResponse build() {
            return new RemoveUsagePlanLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveUsagePlanLockResponse)) {
            return false;
        }

        RemoveUsagePlanLockResponse other = (RemoveUsagePlanLockResponse) o;
