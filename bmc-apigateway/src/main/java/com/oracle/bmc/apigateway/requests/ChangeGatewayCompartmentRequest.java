...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/ChangeGatewayCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeGatewayCompartmentRequest.
 */
...
public class ChangeGatewayCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeGatewayCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeGatewayCompartmentRequest(gatewayId, changeGatewayCompartmentDetails, opcRetryToken, ifMatch, opcRequestId, isLockOverride);
        }
    }
