...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/RemoveGatewayLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveGatewayLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190501")
public class RemoveGatewayLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveGatewayLockRequest o) {
        ...
        /**
         * Build the instance of RemoveGatewayLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveGatewayLockRequest
         */
        public RemoveGatewayLockRequest build() {
            RemoveGatewayLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveGatewayLockRequest
         */
        public RemoveGatewayLockRequest buildWithoutInvocationCallback() {
            RemoveGatewayLockRequest request = new RemoveGatewayLockRequest();
            request.gatewayId = gatewayId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveGatewayLockRequest(gatewayId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveGatewayLockRequest)) {
            return false;
        }

        RemoveGatewayLockRequest other = (RemoveGatewayLockRequest) o;
