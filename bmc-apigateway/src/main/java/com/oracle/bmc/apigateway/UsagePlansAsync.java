...
public interface UsagePlansAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeUsagePlanCompartmentResponse> changeUsagePlanCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateUsagePlanResponse> createUsagePlan(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteUsagePlanResponse> deleteUsagePlan(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetUsagePlanResponse> getUsagePlan(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateUsagePlanResponse> updateUsagePlan(
