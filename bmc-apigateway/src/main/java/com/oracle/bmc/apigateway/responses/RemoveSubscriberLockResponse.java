...
public class RemoveSubscriberLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveSubscriberLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveSubscriberLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveSubscriberLockResponse o) {
         ...
         */
        @Override
        public RemoveSubscriberLockResponse build() {
            return new RemoveSubscriberLockResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, subscriber);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveSubscriberLockResponse)) {
            return false;
        }

        RemoveSubscriberLockResponse other = (RemoveSubscriberLockResponse) o;
