...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UsagePlan.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UsagePlan extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UsagePlan model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsagePlan)) {
            return false;
        }

        UsagePlan other = (UsagePlan) o;
