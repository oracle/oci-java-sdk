...
public final class CreateApiDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateApiDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApiDetails)) {
            return false;
        }

        CreateApiDetails other = (CreateApiDetails) o;
