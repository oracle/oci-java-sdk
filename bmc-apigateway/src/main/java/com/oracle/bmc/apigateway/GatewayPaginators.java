 ...
 * to any list operations of Gateway where multiple pages of data may be fetched. Two styles of
...
public class GatewayPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listGateways
     ...
     * com.oracle.bmc.apigateway.model.GatewaySummary} objects contained in responses from the
     * listGateways operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.apigateway.model.GatewaySummary} objects contained in responses received
     *     from the service.
     */
