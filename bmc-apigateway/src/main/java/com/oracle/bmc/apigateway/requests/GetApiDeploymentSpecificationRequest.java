...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/GetApiDeploymentSpecificationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetApiDeploymentSpecificationRequest.
 */
...
public class GetApiDeploymentSpecificationRequest
    ...
    public static class Builder
        ...
        public GetApiDeploymentSpecificationRequest buildWithoutInvocationCallback() {
            GetApiDeploymentSpecificationRequest request =
                    new GetApiDeploymentSpecificationRequest();
            request.apiId = apiId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new GetApiDeploymentSpecificationRequest(apiId, opcRequestId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().apiId(apiId).opcRequestId(opcRequestId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApiDeploymentSpecificationRequest)) {
            return false;
        }

        GetApiDeploymentSpecificationRequest other = (GetApiDeploymentSpecificationRequest) o;
