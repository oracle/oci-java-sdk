...
public class UpdateUsagePlanResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateUsagePlanResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateUsagePlanResponse)) {
            return false;
        }

        UpdateUsagePlanResponse other = (UpdateUsagePlanResponse) o;
