...
public interface SubscribersAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeSubscriberCompartmentResponse> changeSubscriberCompartment(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<CreateSubscriberResponse> createSubscriber(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<DeleteSubscriberResponse> deleteSubscriber(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetSubscriberResponse> getSubscriber(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateSubscriberResponse> updateSubscriber(
