...
public class GetUsagePlanResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetUsagePlanResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUsagePlanResponse)) {
            return false;
        }

        GetUsagePlanResponse other = (GetUsagePlanResponse) o;
