...
public class GatewayClient implements Gateway {
    ...
    public AddGatewayLockResponse addGatewayLock(AddGatewayLockRequest request) {
        LOG.trace("Called addGatewayLock");
        final AddGatewayLockRequest interceptedRequest =
                AddGatewayLockConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                AddGatewayLockConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, AddGatewayLockResponse> transformer =
                AddGatewayLockConverter.fromResponse(java.util.Optional.of(serviceDetails));
    ...
    public ChangeGatewayCompartmentResponse changeGatewayCompartment(
        ...
        LOG.trace("Called changeGatewayCompartment");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeGatewayCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateGatewayResponse createGateway(CreateGatewayRequest request) {
        LOG.trace("Called createGateway");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateGatewayDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteGatewayResponse deleteGateway(DeleteGatewayRequest request) {
        LOG.trace("Called deleteGateway");
    ...
    public RemoveGatewayLockResponse removeGatewayLock(RemoveGatewayLockRequest request) {
        LOG.trace("Called removeGatewayLock");
        final RemoveGatewayLockRequest interceptedRequest =
                RemoveGatewayLockConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                RemoveGatewayLockConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RemoveGatewayLockResponse>
                transformer =
                        RemoveGatewayLockConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public UpdateGatewayResponse updateGateway(UpdateGatewayRequest request) {
        LOG.trace("Called updateGateway");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateGatewayDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
