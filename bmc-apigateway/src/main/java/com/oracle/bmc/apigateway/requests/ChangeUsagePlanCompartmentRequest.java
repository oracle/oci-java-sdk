...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/ChangeUsagePlanCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeUsagePlanCompartmentRequest.
 */
...
public class ChangeUsagePlanCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeUsagePlanCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeUsagePlanCompartmentRequest(usagePlanId, changeUsagePlanCompartmentDetails, opcRetryToken, ifMatch, opcRequestId, isLockOverride);
        }
    }
