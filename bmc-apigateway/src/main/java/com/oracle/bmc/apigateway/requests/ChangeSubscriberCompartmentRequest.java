...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/ChangeSubscriberCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeSubscriberCompartmentRequest.
 */
...
public class ChangeSubscriberCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeSubscriberCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeSubscriberCompartmentRequest(subscriberId, changeSubscriberCompartmentDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
