...
public final class SetHeaderPolicy
    ...
    public static class Builder {
        ...
        public SetHeaderPolicy build() {
            SetHeaderPolicy model = new SetHeaderPolicy(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SetHeaderPolicy model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SetHeaderPolicy)) {
            return false;
        }

        SetHeaderPolicy other = (SetHeaderPolicy) o;
