...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.apigateway.model.WorkRequestCollection getWorkRequestCollection() {
    ...
    private ListWorkRequestsResponse(
            ...
            String opcNextPage,
            String opcPrevPage,
            com.oracle.bmc.apigateway.model.WorkRequestCollection workRequestCollection) {
