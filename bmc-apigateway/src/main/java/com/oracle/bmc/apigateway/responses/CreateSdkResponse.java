...
public class CreateSdkResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSdkResponse> {
         ...
         */
        @Override
        public Builder copy(CreateSdkResponse o) {
         ...
         */
        @Override
        public CreateSdkResponse build() {
            return new CreateSdkResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSdkResponse)) {
            return false;
        }

        CreateSdkResponse other = (CreateSdkResponse) o;
