...
public class ListSubscribersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder subscriberCollection(
                com.oracle.bmc.apigateway.model.SubscriberCollection subscriberCollection) {
            this.subscriberCollection = subscriberCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",subscriberCollection=").append(String.valueOf(subscriberCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSubscribersResponse)) {
            return false;
        }

        ListSubscribersResponse other = (ListSubscribersResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.subscriberCollection, other.subscriberCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.subscriberCollection == null
                                ? 43
                                : this.subscriberCollection.hashCode());
        return result;
    }
}
