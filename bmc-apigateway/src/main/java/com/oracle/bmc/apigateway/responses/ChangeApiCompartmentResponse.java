...
public class ChangeApiCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ChangeApiCompartmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeApiCompartmentResponse)) {
            return false;
        }

        ChangeApiCompartmentResponse other = (ChangeApiCompartmentResponse) o;
