...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/RemoveCertificateLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveCertificateLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190501")
public class RemoveCertificateLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveCertificateLockRequest o) {
        ...
        /**
         * Build the instance of RemoveCertificateLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveCertificateLockRequest
         */
        public RemoveCertificateLockRequest build() {
            RemoveCertificateLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveCertificateLockRequest
         */
        public RemoveCertificateLockRequest buildWithoutInvocationCallback() {
            RemoveCertificateLockRequest request = new RemoveCertificateLockRequest();
            request.certificateId = certificateId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveCertificateLockRequest(certificateId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveCertificateLockRequest)) {
            return false;
        }

        RemoveCertificateLockRequest other = (RemoveCertificateLockRequest) o;
