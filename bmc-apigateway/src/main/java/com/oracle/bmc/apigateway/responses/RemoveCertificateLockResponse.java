...
public class RemoveCertificateLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveCertificateLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveCertificateLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveCertificateLockResponse o) {
         ...
         */
        @Override
        public RemoveCertificateLockResponse build() {
            return new RemoveCertificateLockResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, certificate);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveCertificateLockResponse)) {
            return false;
        }

        RemoveCertificateLockResponse other = (RemoveCertificateLockResponse) o;
