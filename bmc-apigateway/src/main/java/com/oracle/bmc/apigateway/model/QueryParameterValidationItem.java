...
/**
 * Query parameter validation properties. <br>
...
public final class QueryParameterValidationItem
    ...
    public static class Builder {
        ...
        public QueryParameterValidationItem build() {
            QueryParameterValidationItem model =
                    new QueryParameterValidationItem(this.required, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueryParameterValidationItem model) {
