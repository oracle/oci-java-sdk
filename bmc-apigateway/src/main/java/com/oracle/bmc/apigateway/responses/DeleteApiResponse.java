...
public class DeleteApiResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public DeleteApiResponse build() {
            return new DeleteApiResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApiResponse)) {
            return false;
        }
