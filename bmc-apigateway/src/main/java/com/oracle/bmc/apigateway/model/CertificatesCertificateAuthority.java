...
public final class CertificatesCertificateAuthority extends CaBundle {
    ...
    public static class Builder {
        ...
        public CertificatesCertificateAuthority build() {
            CertificatesCertificateAuthority model =
                    new CertificatesCertificateAuthority(this.certificateAuthorityId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CertificatesCertificateAuthority model) {
