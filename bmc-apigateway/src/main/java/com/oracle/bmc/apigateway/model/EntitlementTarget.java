...
public final class EntitlementTarget extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public EntitlementTarget build() {
            EntitlementTarget model = new EntitlementTarget(this.deploymentId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntitlementTarget model) {
