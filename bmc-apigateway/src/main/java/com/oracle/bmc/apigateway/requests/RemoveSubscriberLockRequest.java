...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apigateway/RemoveSubscriberLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveSubscriberLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190501")
public class RemoveSubscriberLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveSubscriberLockRequest o) {
        ...
        /**
         * Build the instance of RemoveSubscriberLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveSubscriberLockRequest
         */
        public RemoveSubscriberLockRequest build() {
            RemoveSubscriberLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveSubscriberLockRequest
         */
        public RemoveSubscriberLockRequest buildWithoutInvocationCallback() {
            RemoveSubscriberLockRequest request = new RemoveSubscriberLockRequest();
            request.subscriberId = subscriberId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveSubscriberLockRequest(subscriberId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveSubscriberLockRequest)) {
            return false;
        }

        RemoveSubscriberLockRequest other = (RemoveSubscriberLockRequest) o;
