...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.containerengine.model.WorkRequestError} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.containerengine.model.WorkRequestError> getItems() {
        return items;
    }
    ...
    private ListWorkRequestErrorsResponse(
            ...
            String opcRequestId,
            java.util.List<com.oracle.bmc.containerengine.model.WorkRequestError> items) {
