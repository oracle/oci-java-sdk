...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/ListVirtualNodesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVirtualNodesRequest.
 */
...
public class ListVirtualNodesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListVirtualNodesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVirtualNodesRequest(virtualNodePoolId, opcRequestId, name, limit, page, sortOrder, sortBy);
        }
    }
