...
public final class UpdateNodeShapeConfigDetails
    ...
    public static class Builder {
        ...
        public UpdateNodeShapeConfigDetails build() {
            UpdateNodeShapeConfigDetails model =
                    new UpdateNodeShapeConfigDetails(this.ocpus, this.memoryInGBs);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateNodeShapeConfigDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateNodeShapeConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNodeShapeConfigDetails)) {
            return false;
        }

        UpdateNodeShapeConfigDetails other = (UpdateNodeShapeConfigDetails) o;
