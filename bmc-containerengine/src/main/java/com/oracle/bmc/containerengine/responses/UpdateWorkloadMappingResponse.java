...
public class UpdateWorkloadMappingResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateWorkloadMappingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateWorkloadMappingResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateWorkloadMappingResponse o) {
         ...
         */
        @Override
        public UpdateWorkloadMappingResponse build() {
            return new UpdateWorkloadMappingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWorkloadMappingResponse)) {
            return false;
        }

        UpdateWorkloadMappingResponse other = (UpdateWorkloadMappingResponse) o;
