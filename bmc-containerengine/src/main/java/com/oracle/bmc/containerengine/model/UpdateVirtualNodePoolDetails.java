...
/**
 * The properties that define a request to update a virtual node pool. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateVirtualNodePoolDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateVirtualNodePoolDetails
    ...
    public UpdateVirtualNodePoolDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateVirtualNodePoolDetails build() {
            UpdateVirtualNodePoolDetails model =
                    new UpdateVirtualNodePoolDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVirtualNodePoolDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVirtualNodePoolDetails)) {
            return false;
        }

        UpdateVirtualNodePoolDetails other = (UpdateVirtualNodePoolDetails) o;
