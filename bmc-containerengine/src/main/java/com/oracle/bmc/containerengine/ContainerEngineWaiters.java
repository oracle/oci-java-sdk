...
public class ContainerEngineWaiters {
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetNodePoolRequest, GetNodePoolResponse> forNodePool(
            GetNodePoolRequest request,
            com.oracle.bmc.containerengine.model.NodePoolLifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetNodePoolRequest, GetNodePoolResponse> forNodePool(
            GetNodePoolRequest request,
            com.oracle.bmc.containerengine.model.NodePoolLifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for NodePool.
    private com.oracle.bmc.waiter.Waiter<GetNodePoolRequest, GetNodePoolResponse> forNodePool(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetNodePoolRequest request,
            final com.oracle.bmc.containerengine.model.NodePoolLifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.containerengine.model.NodePoolLifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetWorkloadMappingRequest, GetWorkloadMappingResponse>
            forWorkloadMapping(
    ...
    public com.oracle.bmc.waiter.Waiter<GetWorkloadMappingRequest, GetWorkloadMappingResponse>
            forWorkloadMapping(
                    GetWorkloadMappingRequest request,
                    com.oracle.bmc.containerengine.model.WorkloadMappingLifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for WorkloadMapping.
    private com.oracle.bmc.waiter.Waiter<GetWorkloadMappingRequest, GetWorkloadMappingResponse>
            forWorkloadMapping(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetWorkloadMappingRequest request,
                    final com.oracle.bmc.containerengine.model.WorkloadMappingLifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.containerengine.model.WorkloadMappingLifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetWorkloadMappingResponse apply(
                                    GetWorkloadMappingRequest request) {
                                return client.getWorkloadMapping(request);
                            }
                        },
                        new java.util.function.Predicate<GetWorkloadMappingResponse>() {
                            @Override
                            public boolean test(GetWorkloadMappingResponse response) {
                                return targetStatesSet.contains(
                                        response.getWorkloadMapping().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.containerengine.model.WorkloadMappingLifecycleState
