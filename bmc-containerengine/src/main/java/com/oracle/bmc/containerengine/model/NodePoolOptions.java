...
/**
 * Options for creating or updating node pools. <br>
...
public final class NodePoolOptions
    ...
    public static class Builder {
        ...
        /**
         * Deprecated. See sources. When creating a node pool using the {@code
         * CreateNodePoolDetails} object, only image names contained in this property can be passed
         * to the {@code nodeImageName} property.
         */
    ...
    /**
     * Deprecated. See sources. When creating a node pool using the {@code CreateNodePoolDetails}
     * object, only image names contained in this property can be passed to the {@code
     * nodeImageName} property.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("images")
