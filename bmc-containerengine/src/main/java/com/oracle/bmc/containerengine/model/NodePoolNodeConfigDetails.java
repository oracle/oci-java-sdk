...
public final class NodePoolNodeConfigDetails
    ...
    public NodePoolNodeConfigDetails(
            Integer size,
    ...
    public static class Builder {
        ...
        public NodePoolNodeConfigDetails build() {
            NodePoolNodeConfigDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NodePoolNodeConfigDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NodePoolNodeConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NodePoolNodeConfigDetails)) {
            return false;
        }

        NodePoolNodeConfigDetails other = (NodePoolNodeConfigDetails) o;
