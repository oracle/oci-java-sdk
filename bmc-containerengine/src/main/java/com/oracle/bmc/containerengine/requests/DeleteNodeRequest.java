...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/DeleteNodeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNodeRequest.
 */
    ...
    public static class Builder
        ...
        public DeleteNodeRequest buildWithoutInvocationCallback() {
            ...
            request.isForceDeletionAfterOverrideGraceDuration =
                    isForceDeletionAfterOverrideGraceDuration;
            return request;
            // new DeleteNodeRequest(nodePoolId, nodeId, isDecrementSize, ifMatch, opcRequestId, overrideEvictionGraceDuration, isForceDeletionAfterOverrideGraceDuration);
        }
    }
