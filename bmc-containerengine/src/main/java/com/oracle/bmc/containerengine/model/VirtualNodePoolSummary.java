...
public final class VirtualNodePoolSummary
    ...
    public static class Builder {
        ...
        public VirtualNodePoolSummary build() {
            VirtualNodePoolSummary model =
                    new VirtualNodePoolSummary(
                            this.id,
                            this.compartmentId,
                            this.clusterId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualNodePoolSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VirtualNodePoolSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VirtualNodePoolSummary)) {
            return false;
        }

        VirtualNodePoolSummary other = (VirtualNodePoolSummary) o;
