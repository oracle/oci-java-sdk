...
public final class AddonError extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public AddonError build() {
            AddonError model = new AddonError(this.code, this.message, this.status);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddonError model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddonError)) {
            return false;
        }

        AddonError other = (AddonError) o;
