...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/ListClustersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListClustersRequest.
 */
...
public class ListClustersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A cluster lifecycle state to filter on. Can have multiple parameters of this name. For more information, see [Monitoring Clusters](https://docs.oracle.com/iaas/Content/ContEng/Tasks/contengmonitoringclusters.htm)
        ...
        public ListClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListClustersRequest(compartmentId, lifecycleState, name, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
