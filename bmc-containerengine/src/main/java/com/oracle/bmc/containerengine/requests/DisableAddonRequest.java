...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/DisableAddonExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DisableAddonRequest.
 */
...
public class DisableAddonRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DisableAddonRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DisableAddonRequest(clusterId, addonName, isRemoveExistingAddOn, ifMatch, opcRequestId);
        }
    }
