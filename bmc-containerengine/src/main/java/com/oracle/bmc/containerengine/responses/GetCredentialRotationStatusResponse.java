...
public class GetCredentialRotationStatusResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder credentialRotationStatus(
                com.oracle.bmc.containerengine.model.CredentialRotationStatus
                        credentialRotationStatus) {
            this.credentialRotationStatus = credentialRotationStatus;
            return this;
        ...
        public Builder copy(GetCredentialRotationStatusResponse o) {
            ...
            credentialRotationStatus(o.getCredentialRotationStatus());
    ...
    public String toString() {
        ...
        sb.append(",credentialRotationStatus=").append(String.valueOf(credentialRotationStatus));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCredentialRotationStatusResponse)) {
            return false;
        }

        GetCredentialRotationStatusResponse other = (GetCredentialRotationStatusResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.credentialRotationStatus, other.credentialRotationStatus);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.credentialRotationStatus == null
                                ? 43
                                : this.credentialRotationStatus.hashCode());
        return result;
    }
}
