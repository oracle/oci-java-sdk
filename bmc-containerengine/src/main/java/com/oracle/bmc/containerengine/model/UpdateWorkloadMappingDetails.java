...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateWorkloadMappingDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateWorkloadMappingDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mappedCompartmentId", "freeformTags", "definedTags"})
    public UpdateWorkloadMappingDetails(
    ...
    public static class Builder {
        ...
        public UpdateWorkloadMappingDetails build() {
            UpdateWorkloadMappingDetails model =
                    new UpdateWorkloadMappingDetails(
                            this.mappedCompartmentId, this.freeformTags, this.definedTags);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateWorkloadMappingDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWorkloadMappingDetails)) {
            return false;
        }

        UpdateWorkloadMappingDetails other = (UpdateWorkloadMappingDetails) o;
        return java.util.Objects.equals(this.mappedCompartmentId, other.mappedCompartmentId)
