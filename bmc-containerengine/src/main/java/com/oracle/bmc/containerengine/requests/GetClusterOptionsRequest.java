...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/GetClusterOptionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetClusterOptionsRequest.
 */
...
public class GetClusterOptionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetClusterOptionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetClusterOptionsRequest(clusterOptionId, compartmentId, shouldListAllPatchVersions, opcRequestId);
        }
    }
