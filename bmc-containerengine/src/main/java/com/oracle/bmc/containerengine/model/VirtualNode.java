...
/**
 * The properties that define a virtual node. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VirtualNode.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class VirtualNode extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VirtualNode model) {
    ...
    public boolean equals(Object o) {
        ...
        VirtualNode other = (VirtualNode) o;
