...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/DeleteNodePoolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNodePoolRequest.
 */
...
public class DeleteNodePoolRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteNodePoolRequest build() {
            DeleteNodePoolRequest request = buildWithoutInvocationCallback();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteNodePoolRequest)) {
            return false;
        }

        DeleteNodePoolRequest other = (DeleteNodePoolRequest) o;
