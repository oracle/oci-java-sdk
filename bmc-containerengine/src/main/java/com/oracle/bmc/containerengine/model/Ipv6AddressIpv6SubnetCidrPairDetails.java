...
/**
 * Used to specify from which subnet prefixes an IPv6 address should be allocated, or to assign
 * valid available IPv6 addresses <br>
...
public final class Ipv6AddressIpv6SubnetCidrPairDetails
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"ipv6Address", "ipv6SubnetCidr"})
    public Ipv6AddressIpv6SubnetCidrPairDetails(String ipv6Address, String ipv6SubnetCidr) {
        super();
    ...
    public static class Builder {
        ...
        public Ipv6AddressIpv6SubnetCidrPairDetails build() {
            Ipv6AddressIpv6SubnetCidrPairDetails model =
                    new Ipv6AddressIpv6SubnetCidrPairDetails(this.ipv6Address, this.ipv6SubnetCidr);
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.ipv6Address, other.ipv6Address)
