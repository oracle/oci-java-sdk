...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/GetNodePoolOptionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNodePoolOptionsRequest.
 */
...
public class GetNodePoolOptionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetNodePoolOptionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetNodePoolOptionsRequest(nodePoolOptionId, compartmentId, shouldListAllPatchVersions, nodePoolOsType, nodePoolOsArch, nodePoolK8sVersion, opcRequestId);
        }
    }
