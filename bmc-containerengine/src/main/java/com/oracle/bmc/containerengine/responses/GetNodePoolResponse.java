...
public class GetNodePoolResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code NodePool} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetNodePoolResponse> {
         ...
         * The returned {@code NodePool} instance.
         *
         * @param nodePool the value to set
         * @return this builder
         */
        ...
        public GetNodePoolResponse build() {
            return new GetNodePoolResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, nodePool);
        }
    }
