...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/UpdateAddonExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAddonRequest.
 */
...
public class UpdateAddonRequest
    ...
    public static class Builder
        ...
        public UpdateAddonRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAddonRequest(clusterId, addonName, updateAddonDetails, ifMatch, opcRequestId);
        }
    }
