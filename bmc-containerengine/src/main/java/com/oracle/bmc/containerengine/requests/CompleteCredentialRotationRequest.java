...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/containerengine/CompleteCredentialRotationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CompleteCredentialRotationRequest.
 */
...
public class CompleteCredentialRotationRequest
    ...
    public static class Builder
        ...
        public CompleteCredentialRotationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CompleteCredentialRotationRequest(clusterId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
