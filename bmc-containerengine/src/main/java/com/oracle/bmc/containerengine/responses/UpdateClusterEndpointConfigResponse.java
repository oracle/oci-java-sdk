...
public class UpdateClusterEndpointConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateClusterEndpointConfigResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateClusterEndpointConfigResponse)) {
            return false;
        }

        UpdateClusterEndpointConfigResponse other = (UpdateClusterEndpointConfigResponse) o;
