...
public class ListAddonOptionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.containerengine.model.AddonOptionSummary} instances. */
    private java.util.List<com.oracle.bmc.containerengine.model.AddonOptionSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.containerengine.model.AddonOptionSummary> getItems() {
        return items;
    }
    ...
    private ListAddonOptionsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.containerengine.model.AddonOptionSummary> items) {
