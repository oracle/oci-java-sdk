...
public class ArtifactsClient implements Artifacts {
    ...
    @Override
    public LookupContainerImageByUriResponse lookupContainerImageByUri(
            LookupContainerImageByUriRequest request) {
        LOG.trace("Called lookupContainerImageByUri");
        final LookupContainerImageByUriRequest interceptedRequest =
                LookupContainerImageByUriConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                LookupContainerImageByUriConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, LookupContainerImageByUriResponse>
                transformer =
                        LookupContainerImageByUriConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public UpdateContainerImageResponse updateContainerImage(UpdateContainerImageRequest request) {
        LOG.trace("Called updateContainerImage");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateContainerImageResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateContainerImageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateContainerImageSignatureResponse updateContainerImageSignature(
        ...
        LOG.trace("Called updateContainerImageSignature");
