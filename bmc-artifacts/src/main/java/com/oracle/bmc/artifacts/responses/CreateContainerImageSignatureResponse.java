...
public class CreateContainerImageSignatureResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.artifacts.model.ContainerImageSignature getContainerImageSignature() {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder containerImageSignature(
                com.oracle.bmc.artifacts.model.ContainerImageSignature containerImageSignature) {
            this.containerImageSignature = containerImageSignature;
            return this;
        }
        ...
        public CreateContainerImageSignatureResponse build() {
            return new CreateContainerImageSignatureResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, containerImageSignature);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",containerImageSignature=").append(String.valueOf(containerImageSignature));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContainerImageSignatureResponse)) {
            return false;
        }

        CreateContainerImageSignatureResponse other = (CreateContainerImageSignatureResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.containerImageSignature, other.containerImageSignature);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.containerImageSignature == null
                                ? 43
                                : this.containerImageSignature.hashCode());
        return result;
    }
}
