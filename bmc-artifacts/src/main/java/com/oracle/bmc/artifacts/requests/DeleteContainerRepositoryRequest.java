...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/DeleteContainerRepositoryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteContainerRepositoryRequest.
 */
...
public class DeleteContainerRepositoryRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteContainerRepositoryRequest
         */
        public DeleteContainerRepositoryRequest buildWithoutInvocationCallback() {
            DeleteContainerRepositoryRequest request = new DeleteContainerRepositoryRequest();
            request.repositoryId = repositoryId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteContainerRepositoryRequest(repositoryId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteContainerRepositoryRequest)) {
            return false;
        }

        DeleteContainerRepositoryRequest other = (DeleteContainerRepositoryRequest) o;
