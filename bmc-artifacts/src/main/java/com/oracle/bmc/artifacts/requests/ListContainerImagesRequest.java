...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/ListContainerImagesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListContainerImagesRequest.
 */
...
public class ListContainerImagesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListContainerImagesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListContainerImagesRequest(compartmentId, compartmentIdInSubtree, displayName, imageId, isVersioned, repositoryId, repositoryName, version, lifecycleState, imageDigest, limit, page, opcRequestId, sortBy, sortOrder);
        }
    }
