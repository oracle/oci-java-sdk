...
public class CreateContainerRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateContainerRepositoryResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public CreateContainerRepositoryResponse build() {
            return new CreateContainerRepositoryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContainerRepositoryResponse)) {
            return false;
        }

        CreateContainerRepositoryResponse other = (CreateContainerRepositoryResponse) o;
