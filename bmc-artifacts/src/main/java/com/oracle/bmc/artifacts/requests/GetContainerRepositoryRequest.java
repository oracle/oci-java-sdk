...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/GetContainerRepositoryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetContainerRepositoryRequest.
 */
...
public class GetContainerRepositoryRequest
    ...
    public static class Builder
         ...
         * @return instance of GetContainerRepositoryRequest
         */
        public GetContainerRepositoryRequest buildWithoutInvocationCallback() {
            GetContainerRepositoryRequest request = new GetContainerRepositoryRequest();
            request.repositoryId = repositoryId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetContainerRepositoryRequest(repositoryId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetContainerRepositoryRequest)) {
            return false;
        }

        GetContainerRepositoryRequest other = (GetContainerRepositoryRequest) o;
