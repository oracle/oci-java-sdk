...
/**
 * List container image results. <br>
...
public final class ContainerImageCollection
    ...
    public static class Builder {
        ...
        public ContainerImageCollection build() {
            ContainerImageCollection model =
                    new ContainerImageCollection(this.items, this.remainingItemsCount);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ContainerImageCollection model) {
