...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/UpdateContainerConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateContainerConfigurationRequest.
 */
...
public class UpdateContainerConfigurationRequest
     ...
     * Update container configuration details.
     */
    public com.oracle.bmc.artifacts.model.UpdateContainerConfigurationDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.artifacts.model.UpdateContainerConfigurationDetails
                updateContainerConfigurationDetails = null;

        /**
         * Update container configuration details.
         * @param updateContainerConfigurationDetails the value to set
         * @return this builder instance
         */
        public Builder updateContainerConfigurationDetails(
                com.oracle.bmc.artifacts.model.UpdateContainerConfigurationDetails
                        updateContainerConfigurationDetails) {
        ...
        public UpdateContainerConfigurationRequest buildWithoutInvocationCallback() {
            ...
            request.updateContainerConfigurationDetails = updateContainerConfigurationDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateContainerConfigurationRequest(compartmentId, updateContainerConfigurationDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateContainerConfigurationDetails=")
                .append(String.valueOf(this.updateContainerConfigurationDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateContainerConfigurationRequest other = (UpdateContainerConfigurationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.compartmentId, other.compartmentId)
                && java.util.Objects.equals(
                        this.updateContainerConfigurationDetails,
                        other.updateContainerConfigurationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateContainerConfigurationDetails == null
                                ? 43
                                : this.updateContainerConfigurationDetails.hashCode());
