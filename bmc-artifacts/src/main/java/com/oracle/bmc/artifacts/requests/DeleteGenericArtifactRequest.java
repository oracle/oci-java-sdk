...
public class DeleteGenericArtifactRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteGenericArtifactRequest
         */
        public DeleteGenericArtifactRequest buildWithoutInvocationCallback() {
            DeleteGenericArtifactRequest request = new DeleteGenericArtifactRequest();
            request.artifactId = artifactId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteGenericArtifactRequest(artifactId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().artifactId(artifactId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteGenericArtifactRequest)) {
            return false;
        }

        DeleteGenericArtifactRequest other = (DeleteGenericArtifactRequest) o;
