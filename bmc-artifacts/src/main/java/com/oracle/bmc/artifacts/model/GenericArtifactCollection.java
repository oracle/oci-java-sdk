...
public final class GenericArtifactCollection
    ...
    public static class Builder {
        ...
        public GenericArtifactCollection build() {
            GenericArtifactCollection model = new GenericArtifactCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenericArtifactCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GenericArtifactCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenericArtifactCollection)) {
            return false;
        }

        GenericArtifactCollection other = (GenericArtifactCollection) o;
