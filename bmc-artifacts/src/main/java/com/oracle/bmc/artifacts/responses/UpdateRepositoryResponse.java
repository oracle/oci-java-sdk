...
public class UpdateRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public com.oracle.bmc.artifacts.model.Repository getRepository() {
        return repository;
    }
    ...
    private UpdateRepositoryResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.artifacts.model.Repository repository) {
    ...
    public static class Builder {
        ...
        public Builder repository(com.oracle.bmc.artifacts.model.Repository repository) {
            this.repository = repository;
            return this;
        }
        ...
        public UpdateRepositoryResponse build() {
            return new UpdateRepositoryResponse(__httpStatusCode__, etag, opcRequestId, repository);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRepositoryResponse)) {
            return false;
        }

        UpdateRepositoryResponse other = (UpdateRepositoryResponse) o;
