...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/ListContainerRepositoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListContainerRepositoriesRequest.
 */
...
public class ListContainerRepositoriesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListContainerRepositoriesRequest
         */
        public ListContainerRepositoriesRequest buildWithoutInvocationCallback() {
            ListContainerRepositoriesRequest request = new ListContainerRepositoriesRequest();
            ...
            return request;
            // new ListContainerRepositoriesRequest(compartmentId, compartmentIdInSubtree, repositoryId, displayName, isPublic, lifecycleState, limit, page, opcRequestId, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListContainerRepositoriesRequest)) {
            return false;
        }

        ListContainerRepositoriesRequest other = (ListContainerRepositoriesRequest) o;
