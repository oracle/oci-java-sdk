...
/**
 * Parameters needed to create an artifact repository. <br>
...
public class CreateRepositoryDetails
    ...
    protected CreateRepositoryDetails(
            String displayName,
    ...
    /**
     * A user-friendly display name for the repository. If not present, will be auto-generated. It
     * can be modified later. Avoid entering confidential information.
     */
    ...
    /**
     * Whether to make the repository immutable. The artifacts of an immutable repository cannot be
     * overwritten.
     */
