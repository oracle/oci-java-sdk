...
public class UpdateContainerConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public UpdateContainerConfigurationResponse build() {
            return new UpdateContainerConfigurationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, containerConfiguration);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateContainerConfigurationResponse)) {
            return false;
        }

        UpdateContainerConfigurationResponse other = (UpdateContainerConfigurationResponse) o;
