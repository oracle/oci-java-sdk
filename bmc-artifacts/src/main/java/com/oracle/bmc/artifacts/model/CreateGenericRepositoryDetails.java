...
public final class CreateGenericRepositoryDetails extends CreateRepositoryDetails {
    ...
    public static class Builder {
        ...
        public CreateGenericRepositoryDetails build() {
            CreateGenericRepositoryDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGenericRepositoryDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGenericRepositoryDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGenericRepositoryDetails)) {
            return false;
        }

        CreateGenericRepositoryDetails other = (CreateGenericRepositoryDetails) o;
