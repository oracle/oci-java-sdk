...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/ChangeContainerRepositoryCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeContainerRepositoryCompartmentRequest.
 */
...
public class ChangeContainerRepositoryCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeContainerRepositoryCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeContainerRepositoryCompartmentRequest(repositoryId, changeContainerRepositoryCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
