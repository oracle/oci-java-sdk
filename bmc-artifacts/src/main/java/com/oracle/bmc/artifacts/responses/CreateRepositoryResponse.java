...
public class CreateRepositoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public CreateRepositoryResponse build() {
            return new CreateRepositoryResponse(__httpStatusCode__, etag, opcRequestId, repository);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRepositoryResponse)) {
            return false;
        }

        CreateRepositoryResponse other = (CreateRepositoryResponse) o;
