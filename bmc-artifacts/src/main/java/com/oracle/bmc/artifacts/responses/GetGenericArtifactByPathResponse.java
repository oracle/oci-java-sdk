...
public class GetGenericArtifactByPathResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetGenericArtifactByPathResponse(
    ...
    public static class Builder {
         ...
         */
        public GetGenericArtifactByPathResponse build() {
            return new GetGenericArtifactByPathResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, genericArtifact);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGenericArtifactByPathResponse)) {
            return false;
        }

        GetGenericArtifactByPathResponse other = (GetGenericArtifactByPathResponse) o;
