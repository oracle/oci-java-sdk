...
public class UpdateGenericArtifactByPathResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public UpdateGenericArtifactByPathResponse build() {
            return new UpdateGenericArtifactByPathResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGenericArtifactByPathResponse)) {
            return false;
        }

        UpdateGenericArtifactByPathResponse other = (UpdateGenericArtifactByPathResponse) o;
