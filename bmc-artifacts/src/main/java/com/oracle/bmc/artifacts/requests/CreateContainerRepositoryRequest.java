...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/artifacts/CreateContainerRepositoryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateContainerRepositoryRequest.
 */
...
public class CreateContainerRepositoryRequest
     ...
     * Create container repository details.
     */
    public com.oracle.bmc.artifacts.model.CreateContainerRepositoryDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.artifacts.model.CreateContainerRepositoryDetails
                createContainerRepositoryDetails = null;

        /**
         * Create container repository details.
         * @param createContainerRepositoryDetails the value to set
         * @return this builder instance
         */
        public Builder createContainerRepositoryDetails(
                com.oracle.bmc.artifacts.model.CreateContainerRepositoryDetails
                        createContainerRepositoryDetails) {
        ...
        public CreateContainerRepositoryRequest buildWithoutInvocationCallback() {
            CreateContainerRepositoryRequest request = new CreateContainerRepositoryRequest();
            request.createContainerRepositoryDetails = createContainerRepositoryDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateContainerRepositoryRequest(createContainerRepositoryDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createContainerRepositoryDetails=")
                .append(String.valueOf(this.createContainerRepositoryDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContainerRepositoryRequest)) {
            return false;
        }

        CreateContainerRepositoryRequest other = (CreateContainerRepositoryRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createContainerRepositoryDetails,
                        other.createContainerRepositoryDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createContainerRepositoryDetails == null
                                ? 43
                                : this.createContainerRepositoryDetails.hashCode());
