...
/**
 * The envelope and the header from email address details, that is sending the email. Email address
 * must be an approved sender. <br>
...
public final class Sender extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"senderAddress", "compartmentId"})
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("senderAddress")
     ...
     * the compartment that contains the approved sender resource.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("senderAddress=").append(String.valueOf(this.senderAddress));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.senderAddress, other.senderAddress)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.senderAddress == null ? 43 : this.senderAddress.hashCode());
        result =
                (result * PRIME)
