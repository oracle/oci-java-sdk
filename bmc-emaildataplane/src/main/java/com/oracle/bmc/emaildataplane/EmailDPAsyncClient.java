...
public class EmailDPAsyncClient implements EmailDPAsync {
    /**
    ...
    public java.util.concurrent.Future<SubmitEmailResponse> submitEmail(
            ...
            final com.oracle.bmc.responses.AsyncHandler<SubmitEmailRequest, SubmitEmailResponse>
                    handler) {
        LOG.trace("Called async submitEmail");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, SubmitEmailResponse>
                transformer =
                        SubmitEmailConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<SubmitEmailRequest, SubmitEmailResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                SubmitEmailRequest, SubmitEmailResponse>,
                        java.util.concurrent.Future<SubmitEmailResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getSubmitEmailDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<SubmitRawEmailResponse> submitRawEmail(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async submitRawEmail");
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, SubmitRawEmailResponse>
                transformer =
                        SubmitRawEmailConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<SubmitRawEmailRequest, SubmitRawEmailResponse>
                handlerToUse =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                SubmitRawEmailRequest, SubmitRawEmailResponse>,
                        java.util.concurrent.Future<SubmitRawEmailResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getRawMessage(),
                                ib,
                                transformer);
