...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EmailRawSubmittedResponse.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EmailRawSubmittedResponse
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"messageId", "envelopeId", "suppressedRecipients"})
    public EmailRawSubmittedResponse(
            String messageId, String envelopeId, java.util.List<String> suppressedRecipients) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<String> suppressedRecipients;
         ...
         * @return this builder
         */
        public Builder suppressedRecipients(java.util.List<String> suppressedRecipients) {
            this.suppressedRecipients = suppressedRecipients;
        ...
        public EmailRawSubmittedResponse build() {
            EmailRawSubmittedResponse model =
                    new EmailRawSubmittedResponse(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EmailRawSubmittedResponse model) {
    ...
    /** Return list of suppressed email addresses. */
    @com.fasterxml.jackson.annotation.JsonProperty("suppressedRecipients")
    private final java.util.List<String> suppressedRecipients;
     ...
     * @return the value
     */
    public java.util.List<String> getSuppressedRecipients() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EmailRawSubmittedResponse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmailRawSubmittedResponse)) {
            return false;
        }

        EmailRawSubmittedResponse other = (EmailRawSubmittedResponse) o;
