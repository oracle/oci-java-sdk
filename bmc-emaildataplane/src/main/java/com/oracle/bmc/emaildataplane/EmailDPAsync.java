...
public interface EmailDPAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<SubmitEmailResponse> submitEmail(
            SubmitEmailRequest request,
            com.oracle.bmc.responses.AsyncHandler<SubmitEmailRequest, SubmitEmailResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<SubmitRawEmailResponse> submitRawEmail(
