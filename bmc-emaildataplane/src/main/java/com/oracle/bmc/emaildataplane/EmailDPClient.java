...
import com.oracle.bmc.emaildataplane.internal.http.*;
...
public class EmailDPClient implements EmailDP {
    /**
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(EmailDPClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, EmailDPClient> {
    ...
    public SubmitEmailResponse submitEmail(SubmitEmailRequest request) {
        LOG.trace("Called submitEmail");
        final SubmitEmailRequest interceptedRequest =
                SubmitEmailConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                SubmitEmailConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, SubmitEmailResponse> transformer =
                SubmitEmailConverter.fromResponse(java.util.Optional.of(serviceDetails));
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getSubmitEmailDetails(),
                                                retriedRequest);
    ...
    @Override
    public SubmitRawEmailResponse submitRawEmail(SubmitRawEmailRequest request) {
        LOG.trace("Called submitRawEmail");
        try {
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier =
                    com.oracle.bmc.retrier.Retriers.createPreferredRetrier(
            ...
            if (request.getRetryConfiguration() != null
                ...
                request =
                        com.oracle.bmc.retrier.Retriers.wrapBodyInputStreamIfNecessary(
                                request, SubmitRawEmailRequest.builder());
            }
            final SubmitRawEmailRequest interceptedRequest =
                    SubmitRawEmailConverter.interceptRequest(request);
            com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    SubmitRawEmailConverter.fromRequest(client, interceptedRequest);
            com.oracle.bmc.http.internal.RetryUtils.setClientRetriesHeader(ib, retrier);
            com.oracle.bmc.ServiceDetails serviceDetails =
                    new com.oracle.bmc.ServiceDetails(
                            "EmailDP",
            ...
            java.util.function.Function<javax.ws.rs.core.Response, SubmitRawEmailResponse>
                    transformer =
                            SubmitRawEmailConverter.fromResponse(
                                    ...
                                    try {
                                        ...
                                        if (interceptedRequest.getRetryConfiguration() != null
                                            ...
                                            com.oracle.bmc.retrier.Retriers.tryResetStreamForRetry(
                                                    interceptedRequest.getRawMessage(), true);
                                        }
                                        throw e; // rethrow
                                    }
                                });
            ...
            com.oracle.bmc.io.internal.KeepOpenInputStream.closeStream(request.getRawMessage());
        }
    }
