...
public class EmailDPClient extends com.oracle.bmc.http.internal.BaseSyncClient implements EmailDP {
    ...
    public static class Builder
        ...
        public EmailDPClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new EmailDPClient(this, authenticationDetailsProvider);
        }
    }
