...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/emaildataplane/SubmitRawEmailExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SubmitRawEmailRequest.
 */
...
public class SubmitRawEmailRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream>
    ...
    public static class Builder
        ...
        public SubmitRawEmailRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SubmitRawEmailRequest(contentType, compartmentId, sender, recipients, rawMessage, opcRequestId, contentLength);
        }
    }
