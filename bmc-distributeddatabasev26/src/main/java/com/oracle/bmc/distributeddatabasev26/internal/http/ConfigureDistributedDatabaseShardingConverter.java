...
public class ConfigureDistributedDatabaseShardingConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ConfigureDistributedDatabaseShardingConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("actions")
                        .path("configureSharding");

        if (request.getIsRebalanceRequired() != null) {
            target =
                    target.queryParam(
                            "isRebalanceRequired",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getIsRebalanceRequired()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.distributeddatabasev26.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.distributeddatabasev26.responses.ConfigureDistributedDatabaseShardingResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
