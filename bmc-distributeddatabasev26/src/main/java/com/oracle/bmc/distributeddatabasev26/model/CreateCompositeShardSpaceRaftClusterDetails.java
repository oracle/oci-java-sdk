...
/**
 * Raft clusters details required for creation of composite shard spaces. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateCompositeShardSpaceRaftClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateCompositeShardSpaceRaftClusterDetails
    ...
    public CreateCompositeShardSpaceRaftClusterDetails(
            String name,
    ...
    public static class Builder {
        ...
        public CreateCompositeShardSpaceRaftClusterDetails build() {
            CreateCompositeShardSpaceRaftClusterDetails model =
                    new CreateCompositeShardSpaceRaftClusterDetails(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCompositeShardSpaceRaftClusterDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCompositeShardSpaceRaftClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCompositeShardSpaceRaftClusterDetails)) {
            return false;
        }

        CreateCompositeShardSpaceRaftClusterDetails other =
                (CreateCompositeShardSpaceRaftClusterDetails) o;
