...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConfigureDistributedDatabaseGsmsDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ConfigureDistributedDatabaseGsmsDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"oldGsmNames", "isLatestGsmImage"})
    public ConfigureDistributedDatabaseGsmsDetails(
    ...
    public static class Builder {
        ...
        public ConfigureDistributedDatabaseGsmsDetails build() {
            ConfigureDistributedDatabaseGsmsDetails model =
                    new ConfigureDistributedDatabaseGsmsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConfigureDistributedDatabaseGsmsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedDatabaseGsmsDetails)) {
            return false;
        }

        ConfigureDistributedDatabaseGsmsDetails other = (ConfigureDistributedDatabaseGsmsDetails) o;
