...
/**
 * Details of a distributed database catalog. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = DistributedDatabaseCatalogDatabase.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster.class,
            name = "XS_NEW_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseCatalogDatabaseWithExadbXd.class,
            name = "XD_EXISTING_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster.class,
            name = "XS_NEW_VAULT_AND_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseCatalogDatabaseWithDbHome.class,
            name = "EXISTING_DB_HOME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseCatalogDatabaseWithExadbXs.class,
...
public class DistributedDatabaseCatalogDatabase
    ...
    protected DistributedDatabaseCatalogDatabase(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseCatalogDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseCatalogDatabase)) {
            return false;
        }

        DistributedDatabaseCatalogDatabase other = (DistributedDatabaseCatalogDatabase) o;
