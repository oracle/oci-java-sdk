...
/**
 * Globally distributed database composite raft shard space. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CompositeRaftShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CompositeRaftShardSpace
    ...
    public CompositeRaftShardSpace(
            String name,
            Integer chunkCount,
            Integer replicationUnitCount,
            java.util.List<CompositeShardSpaceRaftCluster> raftClusters) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private java.util.List<CompositeShardSpaceRaftCluster> raftClusters;
         ...
         * @return this builder
         */
        public Builder raftClusters(java.util.List<CompositeShardSpaceRaftCluster> raftClusters) {
            this.raftClusters = raftClusters;
        ...
        public CompositeRaftShardSpace build() {
            CompositeRaftShardSpace model =
                    new CompositeRaftShardSpace(
                            this.name,
                            this.chunkCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompositeRaftShardSpace model) {
    ...
    /** The details of raft clusters associated with the shard space. */
    @com.fasterxml.jackson.annotation.JsonProperty("raftClusters")
    private final java.util.List<CompositeShardSpaceRaftCluster> raftClusters;
     ...
     * @return the value
     */
    public java.util.List<CompositeShardSpaceRaftCluster> getRaftClusters() {
        return raftClusters;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompositeRaftShardSpace(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompositeRaftShardSpace)) {
            return false;
        }

        CompositeRaftShardSpace other = (CompositeRaftShardSpace) o;
