...
/**
 * Details required to create a system data guard shard. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousSystemDataGuardDatabaseDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAutonomousSystemDataGuardDatabaseDetails
    ...
    public CreateAutonomousSystemDataGuardDatabaseDetails(
            CreateAutonomousSystemDataGuardReplicaDetails originalReplica,
            java.util.List<CreateAutonomousSystemDataGuardReplicaDetails> dataGuardReplicas) {
        super();
    ...
    public static class Builder {
        ...
        private CreateAutonomousSystemDataGuardReplicaDetails originalReplica;
        ...
        private java.util.List<CreateAutonomousSystemDataGuardReplicaDetails> dataGuardReplicas;
        ...
        public CreateAutonomousSystemDataGuardDatabaseDetails build() {
            CreateAutonomousSystemDataGuardDatabaseDetails model =
                    new CreateAutonomousSystemDataGuardDatabaseDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAutonomousSystemDataGuardDatabaseDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final CreateAutonomousSystemDataGuardReplicaDetails originalReplica;

    public CreateAutonomousSystemDataGuardReplicaDetails getOriginalReplica() {
        return originalReplica;
    }

    /** The details required to create system data guard replicas. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<CreateAutonomousSystemDataGuardReplicaDetails> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<CreateAutonomousSystemDataGuardReplicaDetails> getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousSystemDataGuardDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousSystemDataGuardDatabaseDetails)) {
            return false;
        }

        CreateAutonomousSystemDataGuardDatabaseDetails other =
                (CreateAutonomousSystemDataGuardDatabaseDetails) o;
