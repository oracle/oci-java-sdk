...
public class GetDistributedDatabaseConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetDistributedDatabaseConverter.class);

    public static com.oracle.bmc.distributeddatabasev26.requests.GetDistributedDatabaseRequest
            interceptRequest(
                    com.oracle.bmc.distributeddatabasev26.requests.GetDistributedDatabaseRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.distributeddatabasev26.requests.GetDistributedDatabaseRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.distributeddatabasev26.responses.GetDistributedDatabaseResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.distributeddatabasev26.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.distributeddatabasev26.responses.GetDistributedDatabaseResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.distributeddatabasev26.responses
                                                .GetDistributedDatabaseResponse.Builder
                                        builder =
                                                com.oracle.bmc.distributeddatabasev26.responses
                                                        .GetDistributedDatabaseResponse.builder()
