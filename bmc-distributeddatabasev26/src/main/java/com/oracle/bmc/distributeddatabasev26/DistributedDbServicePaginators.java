...
public class DistributedDbServicePaginators {
     ...
     * com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary} objects contained in
     * responses from the listDistributedDatabases operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary} objects contained
