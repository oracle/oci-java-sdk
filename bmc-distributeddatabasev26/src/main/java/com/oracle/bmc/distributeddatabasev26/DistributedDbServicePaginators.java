...
public class DistributedDbServicePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDistributedDatabases operation. This iterable
    ...
    public Iterable<ListDistributedDatabasesResponse> listDistributedDatabasesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDistributedDatabasesRequest.Builder, ListDistributedDatabasesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary} objects
     * contained in responses from the listDistributedDatabases operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary>
            listDistributedDatabasesRecordIterator(final ListDistributedDatabasesRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListDistributedDatabasesRequest.Builder, ListDistributedDatabasesRequest,
                ListDistributedDatabasesResponse,
                com.oracle.bmc.distributeddatabasev26.model.DistributedDatabaseSummary>(
                new java.util.function.Supplier<ListDistributedDatabasesRequest.Builder>() {
                    @Override
                    public ListDistributedDatabasesRequest.Builder get() {
                        return ListDistributedDatabasesRequest.builder().copy(request);
