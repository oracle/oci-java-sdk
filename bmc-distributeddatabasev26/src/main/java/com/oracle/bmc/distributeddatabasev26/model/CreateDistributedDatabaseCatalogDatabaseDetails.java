...
/**
 * Details for creating a distributed database catalog. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = CreateDistributedDatabaseCatalogDatabaseDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    ...
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDistributedDatabaseCatalogDatabaseWithDbHomeDetails.class,
            name = "EXISTING_DB_HOME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails.class,
            name = "XS_EXISTING_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDistributedDatabaseCatalogDatabaseWithExadbXdDetails.class,
            name = "XD_EXISTING_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDistributedDatabaseCatalogWithExadbXsNewClusterDetails.class,
            name = "XS_NEW_CLUSTER")
})
...
public class CreateDistributedDatabaseCatalogDatabaseDetails
    ...
    protected CreateDistributedDatabaseCatalogDatabaseDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseCatalogDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseCatalogDatabaseDetails)) {
            return false;
        }

        CreateDistributedDatabaseCatalogDatabaseDetails other =
                (CreateDistributedDatabaseCatalogDatabaseDetails) o;
