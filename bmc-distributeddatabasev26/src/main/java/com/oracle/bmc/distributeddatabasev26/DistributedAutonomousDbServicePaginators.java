...
public class DistributedAutonomousDbServicePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDistributedAutonomousDatabases operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedAutonomousDatabaseSummary} objects
     * contained in responses from the listDistributedAutonomousDatabases operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedAutonomousDatabaseSummary} objects
    ...
    public Iterable<
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListDistributedAutonomousDatabasesRequest,
                ListDistributedAutonomousDatabasesResponse,
                com.oracle.bmc.distributeddatabasev26.model.DistributedAutonomousDatabaseSummary>(
                new java.util.function.Supplier<
                        ListDistributedAutonomousDatabasesRequest.Builder>() {
                    @Override
                    public ListDistributedAutonomousDatabasesRequest.Builder get() {
