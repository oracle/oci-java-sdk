...
/**
 * Details of a distributed database shard. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = DistributedDatabaseShardDatabase.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardDatabaseWithExadbXsNewCluster.class,
            name = "XS_NEW_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster.class,
            name = "XS_NEW_VAULT_AND_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardDatabaseWithExadbXd.class,
            name = "XD_EXISTING_CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardDatabaseWithDbHome.class,
            name = "EXISTING_DB_HOME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedDatabaseShardDatabaseWithExadbXs.class,
...
public class DistributedDatabaseShardDatabase
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"name", "timeCreated", "timeUpdated", "metadata"})
    protected DistributedDatabaseShardDatabase(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabase)) {
            return false;
        }

        DistributedDatabaseShardDatabase other = (DistributedDatabaseShardDatabase) o;
