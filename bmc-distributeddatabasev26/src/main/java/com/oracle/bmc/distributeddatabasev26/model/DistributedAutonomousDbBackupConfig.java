...
/**
 * Backup options for the Distributed Autonomous Database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDbBackupConfig.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDbBackupConfig
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"backupDestinationDetails", "recoveryWindowInDays"})
    public DistributedAutonomousDbBackupConfig(
            java.util.List<DistributedAutonomousDbBackupDestination> backupDestinationDetails,
    ...
    public static class Builder {
        ...
        private java.util.List<DistributedAutonomousDbBackupDestination> backupDestinationDetails;
         ...
         * automatic backups. This value applies to automatic backups. When the value is updated, it
         * is applied to all existing automatic backups. If the number of specified days is 0 then
        ...
        public DistributedAutonomousDbBackupConfig build() {
            DistributedAutonomousDbBackupConfig model =
                    new DistributedAutonomousDbBackupConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDbBackupConfig model) {
    ...
    /** Backup destination details. */
    @com.fasterxml.jackson.annotation.JsonProperty("backupDestinationDetails")
    private final java.util.List<DistributedAutonomousDbBackupDestination> backupDestinationDetails;
     ...
     * @return the value
     */
    public java.util.List<DistributedAutonomousDbBackupDestination> getBackupDestinationDetails() {
        return backupDestinationDetails;
    }

    /**
     * Number of days between the current and the earliest point of recoverability covered by
     * automatic backups. This value applies to automatic backups. When the value is updated, it is
     * applied to all existing automatic backups. If the number of specified days is 0 then there
     * will be no backups.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("recoveryWindowInDays")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDbBackupConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDbBackupConfig)) {
            return false;
        }

        DistributedAutonomousDbBackupConfig other = (DistributedAutonomousDbBackupConfig) o;
