...
/**
 * Details to rotate password for a shard or catalog in the Globally distributed database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RotateDistributedDatabaseDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RotateDistributedDatabaseDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    public RotateDistributedDatabaseDetails(String name, String adminPassword) {
        super();
        this.name = name;
    ...
    public RotateDistributedDatabaseDetails(String name, char[] adminPassword) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public RotateDistributedDatabaseDetails build() {
            RotateDistributedDatabaseDetails model =
                    new RotateDistributedDatabaseDetails(this.name, this.adminPassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RotateDistributedDatabaseDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RotateDistributedDatabaseDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RotateDistributedDatabaseDetails)) {
            return false;
        }

        RotateDistributedDatabaseDetails other = (RotateDistributedDatabaseDetails) o;
