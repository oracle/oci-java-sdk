...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedAutonomousDatabaseShardingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ConfigureDistributedAutonomousDatabaseShardingRequest.
 */
...
public class ConfigureDistributedAutonomousDatabaseShardingRequest
     ...
     *
     */
    private Boolean isRebalanceRequired;
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ConfigureDistributedAutonomousDatabaseShardingRequest, java.lang.Void> {
         ...
         *
         */
        private Boolean isRebalanceRequired = null;

        /**
         * The flag to indicate whether chunks need to be re-balanced. This flag is not applicable for USER-defined
         * sharding type.
         *
         * @param isRebalanceRequired the value to set
         * @return this builder instance
         */
        ...
        /**
         * Build the instance of ConfigureDistributedAutonomousDatabaseShardingRequest as configured by this builder
         *
         ...
         *
         * @return instance of ConfigureDistributedAutonomousDatabaseShardingRequest
         */
        public ConfigureDistributedAutonomousDatabaseShardingRequest build() {
        ...
        public ConfigureDistributedAutonomousDatabaseShardingRequest
            ...
            return request;
            // new ConfigureDistributedAutonomousDatabaseShardingRequest(distributedAutonomousDatabaseId, isRebalanceRequired, certificateId, caBundleId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedAutonomousDatabaseShardingRequest)) {
            return false;
        }

        ConfigureDistributedAutonomousDatabaseShardingRequest other =
                (ConfigureDistributedAutonomousDatabaseShardingRequest) o;
