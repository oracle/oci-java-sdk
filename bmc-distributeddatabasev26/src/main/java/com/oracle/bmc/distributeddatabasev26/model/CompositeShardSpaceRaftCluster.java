...
/**
 * Raft clusters details for composite shard spaces. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CompositeShardSpaceRaftCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CompositeShardSpaceRaftCluster
    ...
    public CompositeShardSpaceRaftCluster(
            String name,
            Integer replicationFactor,
            Integer witnessCount,
            RuMode ruMode,
            java.util.List<DistributedDatabaseShardDatabase> databases) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public CompositeShardSpaceRaftCluster build() {
            CompositeShardSpaceRaftCluster model =
                    new CompositeShardSpaceRaftCluster(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompositeShardSpaceRaftCluster model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompositeShardSpaceRaftCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompositeShardSpaceRaftCluster)) {
            return false;
        }

        CompositeShardSpaceRaftCluster other = (CompositeShardSpaceRaftCluster) o;
