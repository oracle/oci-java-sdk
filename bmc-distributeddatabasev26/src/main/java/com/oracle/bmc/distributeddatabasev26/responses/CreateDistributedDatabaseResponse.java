...
public class CreateDistributedDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateDistributedDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateDistributedDatabaseResponse o) {
         ...
         */
        @Override
        public CreateDistributedDatabaseResponse build() {
            return new CreateDistributedDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseResponse)) {
            return false;
        }

        CreateDistributedDatabaseResponse other = (CreateDistributedDatabaseResponse) o;
