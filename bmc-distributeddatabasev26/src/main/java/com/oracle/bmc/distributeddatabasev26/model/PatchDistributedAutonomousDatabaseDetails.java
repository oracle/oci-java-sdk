...
public final class PatchDistributedAutonomousDatabaseDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public PatchDistributedAutonomousDatabaseDetails(java.util.List<PatchInstruction> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public PatchDistributedAutonomousDatabaseDetails build() {
            PatchDistributedAutonomousDatabaseDetails model =
                    new PatchDistributedAutonomousDatabaseDetails(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PatchDistributedAutonomousDatabaseDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchDistributedAutonomousDatabaseDetails)) {
            return false;
        }

        PatchDistributedAutonomousDatabaseDetails other =
                (PatchDistributedAutonomousDatabaseDetails) o;
