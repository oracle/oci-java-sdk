...
/**
 * Raft metrics for shards and catalog for the Globally distributed autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDatabaseRaftMetric.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDatabaseRaftMetric
    ...
    public static class Builder {
        ...
        public DistributedAutonomousDatabaseRaftMetric build() {
            DistributedAutonomousDatabaseRaftMetric model =
                    new DistributedAutonomousDatabaseRaftMetric(this.raftMetrics, this.configTasks);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseRaftMetric model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseRaftMetric(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseRaftMetric)) {
            return false;
        }

        DistributedAutonomousDatabaseRaftMetric other = (DistributedAutonomousDatabaseRaftMetric) o;
