...
public final class DistributedAutonomousDatabase
    ...
    public static class Builder {
        ...
        /**
         * Global Service Manager (GSM) instances associated with the distributed autonomous
         * database.
         */
    ...
    /**
     * The list of network security group (NSG) details associated with the distributed autonomous
     * database.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("vcnNsgIds")
