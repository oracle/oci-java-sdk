...
public class DistributedDbPrivateEndpointServicePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDistributedDatabasePrivateEndpoints operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedDatabasePrivateEndpointSummary} objects
     * contained in responses from the listDistributedDatabasePrivateEndpoints operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.distributeddatabasev26.model.DistributedDatabasePrivateEndpointSummary} objects
