...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateSystemRaftClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateSystemRaftClusterDetails
    ...
    public CreateSystemRaftClusterDetails(
            String name,
    ...
    public static class Builder {
        ...
        public CreateSystemRaftClusterDetails build() {
            CreateSystemRaftClusterDetails model =
                    new CreateSystemRaftClusterDetails(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSystemRaftClusterDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSystemRaftClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSystemRaftClusterDetails)) {
            return false;
        }

        CreateSystemRaftClusterDetails other = (CreateSystemRaftClusterDetails) o;
