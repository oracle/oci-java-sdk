...
public final class CreateDistributedDatabasePrivateEndpointDetails
    ...
    public CreateDistributedDatabasePrivateEndpointDetails(
    ...
    public static class Builder {
        ...
        /**
         * The list of network security group (NSG) details to be associated with the private
         * endpoint.
         */
        ...
        public CreateDistributedDatabasePrivateEndpointDetails build() {
            CreateDistributedDatabasePrivateEndpointDetails model =
                    new CreateDistributedDatabasePrivateEndpointDetails(
                            this.compartmentId,
                            this.subnetId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabasePrivateEndpointDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabasePrivateEndpointDetails)) {
            return false;
        }

        CreateDistributedDatabasePrivateEndpointDetails other =
                (CreateDistributedDatabasePrivateEndpointDetails) o;
