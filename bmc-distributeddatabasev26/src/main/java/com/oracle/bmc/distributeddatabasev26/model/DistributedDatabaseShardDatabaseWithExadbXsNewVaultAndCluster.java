...
/**
 * Details of a distributed database shard on ExaDB-XS with a new cluster and storage vault. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster.Builder.class)
...
public final class DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster
        extends DistributedDatabaseShardDatabase {
    ...
    public static class Builder {
        ...
        public DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster build() {
            DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster model =
                    new DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster model) {
    ...
    @Deprecated
    public DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster)) {
            return false;
        }

        DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster other =
                (DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster) o;
