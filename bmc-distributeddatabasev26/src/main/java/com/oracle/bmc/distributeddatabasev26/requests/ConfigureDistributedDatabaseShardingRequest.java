...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabasev26/ConfigureDistributedDatabaseShardingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ConfigureDistributedDatabaseShardingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260101")
public class ConfigureDistributedDatabaseShardingRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ConfigureDistributedDatabaseShardingRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ConfigureDistributedDatabaseShardingRequest o) {
        ...
        /**
         * Build the instance of ConfigureDistributedDatabaseShardingRequest as configured by this builder
         *
         ...
         *
         * @return instance of ConfigureDistributedDatabaseShardingRequest
         */
        public ConfigureDistributedDatabaseShardingRequest build() {
            ConfigureDistributedDatabaseShardingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ConfigureDistributedDatabaseShardingRequest
         */
        public ConfigureDistributedDatabaseShardingRequest buildWithoutInvocationCallback() {
            ConfigureDistributedDatabaseShardingRequest request =
                    new ConfigureDistributedDatabaseShardingRequest();
            ...
            return request;
            // new ConfigureDistributedDatabaseShardingRequest(distributedDatabaseId, isRebalanceRequired, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedDatabaseShardingRequest)) {
            return false;
        }

        ConfigureDistributedDatabaseShardingRequest other =
                (ConfigureDistributedDatabaseShardingRequest) o;
