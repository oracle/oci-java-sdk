...
/**
 * Distributed autonomous database user shard space details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousUserShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousUserShardSpace
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "originalReplica", "dataGuardReplicas"})
    public AutonomousUserShardSpace(
            String name,
            AutonomousUserShardSpaceReplica originalReplica,
            java.util.List<AutonomousUserShardSpaceReplica> dataGuardReplicas) {
        super();
        this.name = name;
    ...
    public static class Builder {
        /**
         * The name of the user shard space. It must start with a letter and contain only letters,
        ...
        private AutonomousUserShardSpaceReplica originalReplica;

        public Builder originalReplica(AutonomousUserShardSpaceReplica originalReplica) {
            this.originalReplica = originalReplica;
        ...
        private java.util.List<AutonomousUserShardSpaceReplica> dataGuardReplicas;
        ...
        public AutonomousUserShardSpace build() {
            AutonomousUserShardSpace model =
                    new AutonomousUserShardSpace(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousUserShardSpace model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final AutonomousUserShardSpaceReplica originalReplica;

    public AutonomousUserShardSpaceReplica getOriginalReplica() {
        return originalReplica;
    }

    /** Details of data guard replicas for the user shard space. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<AutonomousUserShardSpaceReplica> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<AutonomousUserShardSpaceReplica> getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousUserShardSpace(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousUserShardSpace)) {
            return false;
        }

        AutonomousUserShardSpace other = (AutonomousUserShardSpace) o;
