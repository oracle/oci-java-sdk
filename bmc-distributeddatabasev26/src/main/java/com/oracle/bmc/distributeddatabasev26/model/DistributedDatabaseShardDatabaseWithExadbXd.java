...
/**
 * Details of a distributed database shard running on ExaDB-D. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseShardDatabaseWithExadbXd.Builder.class)
...
public final class DistributedDatabaseShardDatabaseWithExadbXd
    ...
    public static class Builder {
        ...
        public DistributedDatabaseShardDatabaseWithExadbXd build() {
            DistributedDatabaseShardDatabaseWithExadbXd model =
                    new DistributedDatabaseShardDatabaseWithExadbXd(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardDatabaseWithExadbXd model) {
    ...
    @Deprecated
    public DistributedDatabaseShardDatabaseWithExadbXd(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabaseWithExadbXd(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabaseWithExadbXd)) {
            return false;
        }

        DistributedDatabaseShardDatabaseWithExadbXd other =
                (DistributedDatabaseShardDatabaseWithExadbXd) o;
