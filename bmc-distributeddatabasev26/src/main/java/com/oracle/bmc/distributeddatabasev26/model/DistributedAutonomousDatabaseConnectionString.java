...
/**
 * Details of Globally distributed autonomous database connection String. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDatabaseConnectionString.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDatabaseConnectionString
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"allConnectionStrings"})
    public DistributedAutonomousDatabaseConnectionString(
    ...
    public static class Builder {
        ...
        public DistributedAutonomousDatabaseConnectionString build() {
            DistributedAutonomousDatabaseConnectionString model =
                    new DistributedAutonomousDatabaseConnectionString(this.allConnectionStrings);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseConnectionString model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseConnectionString(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseConnectionString)) {
            return false;
        }

        DistributedAutonomousDatabaseConnectionString other =
                (DistributedAutonomousDatabaseConnectionString) o;
