...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = DistributedAutonomousDatabaseCatalogDatabase.class)
...
public class DistributedAutonomousDatabaseCatalogDatabase
    ...
    protected DistributedAutonomousDatabaseCatalogDatabase(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseCatalogDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseCatalogDatabase)) {
            return false;
        }

        DistributedAutonomousDatabaseCatalogDatabase other =
                (DistributedAutonomousDatabaseCatalogDatabase) o;
