...
/**
 * Composite raft shard space details for a Globally distributed autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousCompositeRaftShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousCompositeRaftShardSpace
    ...
    public AutonomousCompositeRaftShardSpace(
            String name,
            Integer chunkCount,
            Integer replicationUnitCount,
            java.util.List<AutonomousCompositeShardSpaceRaftCluster> raftClusters) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private java.util.List<AutonomousCompositeShardSpaceRaftCluster> raftClusters;
        ...
        public AutonomousCompositeRaftShardSpace build() {
            AutonomousCompositeRaftShardSpace model =
                    new AutonomousCompositeRaftShardSpace(
                            this.name,
                            this.chunkCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousCompositeRaftShardSpace model) {
    ...
    /** The details of raft clusters associated with the shard space. */
    @com.fasterxml.jackson.annotation.JsonProperty("raftClusters")
    private final java.util.List<AutonomousCompositeShardSpaceRaftCluster> raftClusters;
     ...
     * @return the value
     */
    public java.util.List<AutonomousCompositeShardSpaceRaftCluster> getRaftClusters() {
        return raftClusters;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousCompositeRaftShardSpace(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousCompositeRaftShardSpace)) {
            return false;
        }

        AutonomousCompositeRaftShardSpace other = (AutonomousCompositeRaftShardSpace) o;
