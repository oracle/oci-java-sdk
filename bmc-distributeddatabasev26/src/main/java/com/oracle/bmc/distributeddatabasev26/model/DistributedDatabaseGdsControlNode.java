...
/**
 * Details of Global Database Services Control(GDS CTL) instances for the Globally distributed
 * database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseGdsControlNode.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedDatabaseGdsControlNode
    ...
    public DistributedDatabaseGdsControlNode(
            String name,
            String subnetId,
            ...
            String privateIp,
            DistributedDbGdsControlNodeImage gdsControlNodeImageDetails,
    ...
    public static class Builder {
        ...
        /**
         * The time the Global Database Services Control instance was created. An RFC3339 formatted
         * datetime string.
         */
        ...
        /**
         * The time the Global Database Services Control instance was last updated. An RFC3339
        ...
        private DistributedDbGdsControlNodeImage gdsControlNodeImageDetails;
        ...
        public DistributedDatabaseGdsControlNode build() {
            DistributedDatabaseGdsControlNode model =
                    new DistributedDatabaseGdsControlNode(
                            this.name,
                            this.subnetId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseGdsControlNode model) {
    ...
    /**
     * The name of the availability domain where the Global Database Services Control instance is
     * located in.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("availabilityDomain")
    ...
    /**
     * The time the Global Database Services Control instance was last updated. An RFC3339 formatted
     * datetime string.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeUpdated")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("gdsControlNodeImageDetails")
    private final DistributedDbGdsControlNodeImage gdsControlNodeImageDetails;

    public DistributedDbGdsControlNodeImage getGdsControlNodeImageDetails() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseGdsControlNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseGdsControlNode)) {
            return false;
        }

        DistributedDatabaseGdsControlNode other = (DistributedDatabaseGdsControlNode) o;
