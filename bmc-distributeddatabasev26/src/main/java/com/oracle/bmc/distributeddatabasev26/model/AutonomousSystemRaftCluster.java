...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousSystemRaftCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousSystemRaftCluster
    ...
    public AutonomousSystemRaftCluster(
            String name,
    ...
    public static class Builder {
        ...
        public AutonomousSystemRaftCluster build() {
            AutonomousSystemRaftCluster model =
                    new AutonomousSystemRaftCluster(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousSystemRaftCluster model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousSystemRaftCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousSystemRaftCluster)) {
            return false;
        }

        AutonomousSystemRaftCluster other = (AutonomousSystemRaftCluster) o;
