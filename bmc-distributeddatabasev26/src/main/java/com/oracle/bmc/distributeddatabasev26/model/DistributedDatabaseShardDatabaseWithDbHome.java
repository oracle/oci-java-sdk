...
/**
 * Details of a distributed database shard using a pre-existing Database Home. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseShardDatabaseWithDbHome.Builder.class)
...
public final class DistributedDatabaseShardDatabaseWithDbHome
    ...
    public static class Builder {
        ...
        public DistributedDatabaseShardDatabaseWithDbHome build() {
            DistributedDatabaseShardDatabaseWithDbHome model =
                    new DistributedDatabaseShardDatabaseWithDbHome(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardDatabaseWithDbHome model) {
    ...
    @Deprecated
    public DistributedDatabaseShardDatabaseWithDbHome(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabaseWithDbHome(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabaseWithDbHome)) {
            return false;
        }

        DistributedDatabaseShardDatabaseWithDbHome other =
                (DistributedDatabaseShardDatabaseWithDbHome) o;
