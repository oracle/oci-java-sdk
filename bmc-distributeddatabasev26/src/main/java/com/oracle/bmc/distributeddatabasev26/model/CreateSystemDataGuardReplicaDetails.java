...
/**
 * Details required to create system data guard replica. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateSystemDataGuardReplicaDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateSystemDataGuardReplicaDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "databases"})
    public CreateSystemDataGuardReplicaDetails(
    ...
    public static class Builder {
        ...
        public CreateSystemDataGuardReplicaDetails build() {
            CreateSystemDataGuardReplicaDetails model =
                    new CreateSystemDataGuardReplicaDetails(this.name, this.databases);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSystemDataGuardReplicaDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSystemDataGuardReplicaDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSystemDataGuardReplicaDetails)) {
            return false;
        }

        CreateSystemDataGuardReplicaDetails other = (CreateSystemDataGuardReplicaDetails) o;
