...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabasev26/DeleteDistributedDatabasePrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDistributedDatabasePrivateEndpointRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260101")
public class DeleteDistributedDatabasePrivateEndpointRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDistributedDatabasePrivateEndpointRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDistributedDatabasePrivateEndpointRequest o) {
        ...
        /**
         * Build the instance of DeleteDistributedDatabasePrivateEndpointRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDistributedDatabasePrivateEndpointRequest
         */
        public DeleteDistributedDatabasePrivateEndpointRequest build() {
         ...
         * @return instance of DeleteDistributedDatabasePrivateEndpointRequest
         */
        public DeleteDistributedDatabasePrivateEndpointRequest buildWithoutInvocationCallback() {
            DeleteDistributedDatabasePrivateEndpointRequest request =
                    new DeleteDistributedDatabasePrivateEndpointRequest();
            request.distributedDatabasePrivateEndpointId = distributedDatabasePrivateEndpointId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteDistributedDatabasePrivateEndpointRequest(distributedDatabasePrivateEndpointId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDistributedDatabasePrivateEndpointRequest)) {
            return false;
        }

        DeleteDistributedDatabasePrivateEndpointRequest other =
                (DeleteDistributedDatabasePrivateEndpointRequest) o;
