...
/**
 * System data guard replica details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousSystemDataGuardReplica.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousSystemDataGuardReplica
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "databases"})
    public AutonomousSystemDataGuardReplica(
    ...
    public static class Builder {
        /**
         * The name of data guard replica. It must start with a letter and contain only letters,
        ...
        public AutonomousSystemDataGuardReplica build() {
            AutonomousSystemDataGuardReplica model =
                    new AutonomousSystemDataGuardReplica(this.name, this.databases);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousSystemDataGuardReplica model) {
    ...
    /**
     * The name of data guard replica. It must start with a letter and contain only letters, digits,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousSystemDataGuardReplica(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousSystemDataGuardReplica)) {
            return false;
        }

        AutonomousSystemDataGuardReplica other = (AutonomousSystemDataGuardReplica) o;
