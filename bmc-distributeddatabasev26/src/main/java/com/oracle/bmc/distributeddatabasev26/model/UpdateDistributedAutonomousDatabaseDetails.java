...
/**
 * The details of Globally distributed autonomous database to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDistributedAutonomousDatabaseDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateDistributedAutonomousDatabaseDetails
    ...
    public UpdateDistributedAutonomousDatabaseDetails(
            String displayName,
    ...
    public static class Builder {
         ...
         * notification topics associated with the globally distributed autonomous database. Pass an
         * empty list ({@code []}) to remove existing notification topics (set {@code
         * notificationTopicIds} to empty).
         */
        ...
        public UpdateDistributedAutonomousDatabaseDetails build() {
            UpdateDistributedAutonomousDatabaseDetails model =
                    new UpdateDistributedAutonomousDatabaseDetails(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDistributedAutonomousDatabaseDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDistributedAutonomousDatabaseDetails)) {
            return false;
        }

        UpdateDistributedAutonomousDatabaseDetails other =
                (UpdateDistributedAutonomousDatabaseDetails) o;
