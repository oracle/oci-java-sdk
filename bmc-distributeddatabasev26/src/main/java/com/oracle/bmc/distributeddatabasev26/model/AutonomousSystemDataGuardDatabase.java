...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AutonomousSystemDataGuardDatabase.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AutonomousSystemDataGuardDatabase
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"originalReplica", "dataGuardReplicas"})
    public AutonomousSystemDataGuardDatabase(
            AutonomousSystemDataGuardReplica originalReplica,
            java.util.List<AutonomousSystemDataGuardReplica> dataGuardReplicas) {
        super();
    ...
    public static class Builder {
        ...
        private AutonomousSystemDataGuardReplica originalReplica;

        public Builder originalReplica(AutonomousSystemDataGuardReplica originalReplica) {
            this.originalReplica = originalReplica;
        ...
        private java.util.List<AutonomousSystemDataGuardReplica> dataGuardReplicas;
        ...
        public AutonomousSystemDataGuardDatabase build() {
            AutonomousSystemDataGuardDatabase model =
                    new AutonomousSystemDataGuardDatabase(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousSystemDataGuardDatabase model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final AutonomousSystemDataGuardReplica originalReplica;

    public AutonomousSystemDataGuardReplica getOriginalReplica() {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<AutonomousSystemDataGuardReplica> dataGuardReplicas;

    /**
     * The system data guard replica details.
     * @return the value
     **/
    public java.util.List<AutonomousSystemDataGuardReplica> getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousSystemDataGuardDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousSystemDataGuardDatabase)) {
            return false;
        }

        AutonomousSystemDataGuardDatabase other = (AutonomousSystemDataGuardDatabase) o;
