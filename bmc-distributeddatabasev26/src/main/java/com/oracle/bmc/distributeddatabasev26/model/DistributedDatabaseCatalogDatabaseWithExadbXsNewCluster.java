...
/**
 * Details of a distributed database catalog on ExaDB-XS with a new cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster.Builder.class)
...
public final class DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster
    ...
    public static class Builder {
        ...
        /**
         * The name of the availability domain that the distributed database catalog will be located
         * in.
         */
        ...
        public DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster build() {
            DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster model =
                    new DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster model) {
    ...
    @Deprecated
    public DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster)) {
            return false;
        }

        DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster other =
                (DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster) o;
