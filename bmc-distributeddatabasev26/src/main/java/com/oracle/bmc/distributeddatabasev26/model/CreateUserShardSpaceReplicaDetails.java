...
/**
 * Details required to create user shard space replica. <br>
...
public final class CreateUserShardSpaceReplicaDetails
    ...
    public static class Builder {
        /**
         * The name of user shard space replica. It must start with a letter and contain only
    ...
    /**
     * The name of user shard space replica. It must start with a letter and contain only letters,
