...
/**
 * Details required to create a Globally distributed database catalog. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDistributedDatabaseCatalogDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateDistributedDatabaseCatalogDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"originalReplica", "dataGuardReplicas"})
    public CreateDistributedDatabaseCatalogDetails(
            CreateDistributedDatabaseCatalogReplicaDetails originalReplica,
            java.util.List<CreateDistributedDatabaseCatalogReplicaDetails> dataGuardReplicas) {
        super();
    ...
    public static class Builder {
        ...
        private CreateDistributedDatabaseCatalogReplicaDetails originalReplica;
        ...
        private java.util.List<CreateDistributedDatabaseCatalogReplicaDetails> dataGuardReplicas;
        ...
        public CreateDistributedDatabaseCatalogDetails build() {
            CreateDistributedDatabaseCatalogDetails model =
                    new CreateDistributedDatabaseCatalogDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabaseCatalogDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final CreateDistributedDatabaseCatalogReplicaDetails originalReplica;

    public CreateDistributedDatabaseCatalogReplicaDetails getOriginalReplica() {
        return originalReplica;
    }

    /** Details required to create data guard replicas for the catalog. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<CreateDistributedDatabaseCatalogReplicaDetails> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<CreateDistributedDatabaseCatalogReplicaDetails> getDataGuardReplicas() {
