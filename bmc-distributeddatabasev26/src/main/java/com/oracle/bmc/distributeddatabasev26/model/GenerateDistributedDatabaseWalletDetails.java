...
/**
 * Details to create and download an Globally distributed database wallet. <br>
...
public final class GenerateDistributedDatabaseWalletDetails
    ...
    public static class Builder {
        ...
        public GenerateDistributedDatabaseWalletDetails build() {
            GenerateDistributedDatabaseWalletDetails model =
                    new GenerateDistributedDatabaseWalletDetails(this.password);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateDistributedDatabaseWalletDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDistributedDatabaseWalletDetails)) {
            return false;
        }

        GenerateDistributedDatabaseWalletDetails other =
                (GenerateDistributedDatabaseWalletDetails) o;
