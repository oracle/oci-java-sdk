...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabasev26/GetDistributedDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDistributedDatabaseRequest.
 */
...
public class GetDistributedDatabaseRequest
    ...
    public static class Builder
        ...
        public GetDistributedDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDistributedDatabaseRequest(distributedDatabaseId, metadata, ifNoneMatch, opcRequestId);
        }
    }
