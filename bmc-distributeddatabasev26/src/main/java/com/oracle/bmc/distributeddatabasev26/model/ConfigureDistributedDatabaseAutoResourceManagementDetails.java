...
/**
 * AutoResourceManagement configuration details for the Globally distributed database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConfigureDistributedDatabaseAutoResourceManagementDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ConfigureDistributedDatabaseAutoResourceManagementDetails
    ...
    public ConfigureDistributedDatabaseAutoResourceManagementDetails(
            Boolean isEnabled,
    ...
    public static class Builder {
        ...
        public ConfigureDistributedDatabaseAutoResourceManagementDetails build() {
            ConfigureDistributedDatabaseAutoResourceManagementDetails model =
                    new ConfigureDistributedDatabaseAutoResourceManagementDetails(
                            this.isEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConfigureDistributedDatabaseAutoResourceManagementDetails model) {
    ...
    public enum MaxMoveRuUnit implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        public static MaxMoveRuUnit create(String key) {
            ...
            throw new IllegalArgumentException("Invalid MaxMoveRuUnit: " + key);
        }
    };
    /** Time unit applicable to maxMoveRuAttempts. */
    @com.fasterxml.jackson.annotation.JsonProperty("maxMoveRuUnit")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedDatabaseAutoResourceManagementDetails)) {
            return false;
        }

        ConfigureDistributedDatabaseAutoResourceManagementDetails other =
                (ConfigureDistributedDatabaseAutoResourceManagementDetails) o;
