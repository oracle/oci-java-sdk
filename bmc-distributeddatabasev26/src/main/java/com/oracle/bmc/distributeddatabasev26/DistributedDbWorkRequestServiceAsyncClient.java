...
/**
 * Async client implementation for DistributedDbWorkRequestService service. <br>
...
public class DistributedDbWorkRequestServiceAsyncClient
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DistributedDbWorkRequestServiceAsyncClient.class);

    DistributedDbWorkRequestServiceAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, DistributedDbWorkRequestServiceAsyncClient> {
         ...
         * @return the client
         */
        public DistributedDbWorkRequestServiceAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new DistributedDbWorkRequestServiceAsyncClient(
    ...
    public java.util.concurrent.Future<GetWorkRequestResponse> getWorkRequest(
        ...
        return clientCall(request, GetWorkRequestResponse::builder)
                ...
                .handleBody(
                        com.oracle.bmc.distributeddatabasev26.model.WorkRequest.class,
    ...
    public java.util.concurrent.Future<ListWorkRequestLogsResponse> listWorkRequestLogs(
        ...
        return clientCall(request, ListWorkRequestLogsResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBody(
                        com.oracle.bmc.distributeddatabasev26.model.WorkRequestLogEntryCollection
                                .class,
    ...
    public java.util.concurrent.Future<ListWorkRequestsResponse> listWorkRequests(
        ...
        return clientCall(request, ListWorkRequestsResponse::builder)
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBody(
                        com.oracle.bmc.distributeddatabasev26.model.WorkRequestSummaryCollection
                                .class,
     ...
     */
    @Deprecated
    public DistributedDbWorkRequestServiceAsyncClient(
