...
/**
 * Details required to create system raft cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousSystemRaftClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAutonomousSystemRaftClusterDetails
    ...
    public CreateAutonomousSystemRaftClusterDetails(
            String name,
    ...
    public static class Builder {
        ...
        public CreateAutonomousSystemRaftClusterDetails build() {
            CreateAutonomousSystemRaftClusterDetails model =
                    new CreateAutonomousSystemRaftClusterDetails(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAutonomousSystemRaftClusterDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousSystemRaftClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousSystemRaftClusterDetails)) {
            return false;
        }

        CreateAutonomousSystemRaftClusterDetails other =
                (CreateAutonomousSystemRaftClusterDetails) o;
