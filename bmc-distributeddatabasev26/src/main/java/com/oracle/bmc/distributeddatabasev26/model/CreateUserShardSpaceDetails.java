...
/**
 * Details required to create user shard space. <br>
...
public final class CreateUserShardSpaceDetails
    ...
    public static class Builder {
        /**
         * The name of user shard space. It must start with a letter and contain only letters,
    ...
    /**
     * The name of user shard space. It must start with a letter and contain only letters, digits,
