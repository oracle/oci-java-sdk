...
/**
 * Globally distributed autonomous database catalog details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDatabaseCatalog.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDatabaseCatalog
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"originalReplica", "dataGuardReplicas"})
    public DistributedAutonomousDatabaseCatalog(
            DistributedAutonomousDatabaseCatalogReplica originalReplica,
            java.util.List<DistributedAutonomousDatabaseCatalogReplica> dataGuardReplicas) {
        super();
    ...
    public static class Builder {
        ...
        private DistributedAutonomousDatabaseCatalogReplica originalReplica;
        ...
        private java.util.List<DistributedAutonomousDatabaseCatalogReplica> dataGuardReplicas;
        ...
        public DistributedAutonomousDatabaseCatalog build() {
            DistributedAutonomousDatabaseCatalog model =
                    new DistributedAutonomousDatabaseCatalog(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseCatalog model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final DistributedAutonomousDatabaseCatalogReplica originalReplica;

    public DistributedAutonomousDatabaseCatalogReplica getOriginalReplica() {
        return originalReplica;
    }

    /** The details of data guard replicas for the catalog. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<DistributedAutonomousDatabaseCatalogReplica> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<DistributedAutonomousDatabaseCatalogReplica> getDataGuardReplicas() {
