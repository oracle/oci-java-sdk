...
/**
 * Additional metadata related to Globally distributed database resources. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDbMetadata.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedDbMetadata
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"map"})
    public DistributedDbMetadata(java.util.Map<String, String> map) {
        super();
        this.map = map;
    }
    ...
    public static class Builder {
        ...
        public DistributedDbMetadata build() {
            DistributedDbMetadata model = new DistributedDbMetadata(this.map);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDbMetadata model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDbMetadata(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDbMetadata)) {
            return false;
        }

        DistributedDbMetadata other = (DistributedDbMetadata) o;
