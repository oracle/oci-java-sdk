...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddDistributedAutonomousDatabaseGdsControlNodeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddDistributedAutonomousDatabaseGdsControlNodeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"publicSshKey", "subnetId"})
    public AddDistributedAutonomousDatabaseGdsControlNodeDetails(
            String publicSshKey, String subnetId) {
        super();
    ...
    public static class Builder {
        ...
        public AddDistributedAutonomousDatabaseGdsControlNodeDetails build() {
            AddDistributedAutonomousDatabaseGdsControlNodeDetails model =
                    new AddDistributedAutonomousDatabaseGdsControlNodeDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddDistributedAutonomousDatabaseGdsControlNodeDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDistributedAutonomousDatabaseGdsControlNodeDetails)) {
            return false;
        }

        AddDistributedAutonomousDatabaseGdsControlNodeDetails other =
                (AddDistributedAutonomousDatabaseGdsControlNodeDetails) o;
