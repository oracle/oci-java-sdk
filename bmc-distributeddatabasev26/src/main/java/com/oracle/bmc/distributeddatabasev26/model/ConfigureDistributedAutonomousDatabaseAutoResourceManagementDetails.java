...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails
    ...
    public ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails(
            Boolean isEnabled,
    ...
    public static class Builder {
        ...
        public ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails build() {
            ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails model =
                    new ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails(
                            this.isEnabled,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails)) {
            return false;
        }

        ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails other =
                (ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails) o;
