...
/**
 * Composite data guard shard space details for a Globally distributed autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousCompositeDataGuardShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousCompositeDataGuardShardSpace
    ...
    public AutonomousCompositeDataGuardShardSpace(
            String name,
            Integer chunkCount,
            AutonomousCompositeDataGuardShardSpaceReplica originalReplica,
            java.util.List<AutonomousCompositeDataGuardShardSpaceReplica> dataGuardReplicas) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private AutonomousCompositeDataGuardShardSpaceReplica originalReplica;
        ...
        private java.util.List<AutonomousCompositeDataGuardShardSpaceReplica> dataGuardReplicas;
        ...
        public AutonomousCompositeDataGuardShardSpace build() {
            AutonomousCompositeDataGuardShardSpace model =
                    new AutonomousCompositeDataGuardShardSpace(
                            this.name,
                            this.chunkCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousCompositeDataGuardShardSpace model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final AutonomousCompositeDataGuardShardSpaceReplica originalReplica;

    public AutonomousCompositeDataGuardShardSpaceReplica getOriginalReplica() {
        return originalReplica;
    }

    /** The details of data guard replica associated with the shard. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<AutonomousCompositeDataGuardShardSpaceReplica> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<AutonomousCompositeDataGuardShardSpaceReplica> getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousCompositeDataGuardShardSpace(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousCompositeDataGuardShardSpace)) {
            return false;
        }

        AutonomousCompositeDataGuardShardSpace other = (AutonomousCompositeDataGuardShardSpace) o;
