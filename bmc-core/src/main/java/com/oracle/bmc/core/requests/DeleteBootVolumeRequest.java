...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeleteBootVolumeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteBootVolumeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteBootVolumeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteBootVolumeRequest, java.lang.Void> {
        ...
        public DeleteBootVolumeRequest buildWithoutInvocationCallback() {
            DeleteBootVolumeRequest request = new DeleteBootVolumeRequest();
            request.bootVolumeId = bootVolumeId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteBootVolumeRequest(bootVolumeId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBootVolumeRequest)) {
            return false;
        }

        DeleteBootVolumeRequest other = (DeleteBootVolumeRequest) o;
