...
public class GetTunnelCpeDeviceConfigContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTunnelCpeDeviceConfigContentResponse)) {
            return false;
        }

        GetTunnelCpeDeviceConfigContentResponse other = (GetTunnelCpeDeviceConfigContentResponse) o;
