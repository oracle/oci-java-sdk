...
public class ListComputeGlobalImageCapabilitySchemasResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListComputeGlobalImageCapabilitySchemasResponse)) {
            return false;
        }

        ListComputeGlobalImageCapabilitySchemasResponse other =
                (ListComputeGlobalImageCapabilitySchemasResponse) o;
