...
/**
 * An object used to detatch secondary private IPv4 addresses with a bulk operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkDetachPrivateIpItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkDetachPrivateIpItem
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"privateIpId"})
    public BulkDetachPrivateIpItem(String privateIpId) {
        super();
    ...
    public static class Builder {
        ...
        public BulkDetachPrivateIpItem build() {
            BulkDetachPrivateIpItem model = new BulkDetachPrivateIpItem(this.privateIpId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkDetachPrivateIpItem model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkDetachPrivateIpItem)) {
            return false;
        }

        BulkDetachPrivateIpItem other = (BulkDetachPrivateIpItem) o;
