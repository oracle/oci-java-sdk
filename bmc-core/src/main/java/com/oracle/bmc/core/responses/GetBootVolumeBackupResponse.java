...
public class GetBootVolumeBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBootVolumeBackupResponse> {
         ...
         */
        @Override
        public Builder copy(GetBootVolumeBackupResponse o) {
         ...
         */
        @Override
        public GetBootVolumeBackupResponse build() {
            return new GetBootVolumeBackupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, bootVolumeBackup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBootVolumeBackupResponse)) {
            return false;
        }

        GetBootVolumeBackupResponse other = (GetBootVolumeBackupResponse) o;
