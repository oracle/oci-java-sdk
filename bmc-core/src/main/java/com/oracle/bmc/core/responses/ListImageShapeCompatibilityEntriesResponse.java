...
public class ListImageShapeCompatibilityEntriesResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.ImageShapeCompatibilitySummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListImageShapeCompatibilityEntriesResponse)) {
            return false;
        }

        ListImageShapeCompatibilityEntriesResponse other =
                (ListImageShapeCompatibilityEntriesResponse) o;
