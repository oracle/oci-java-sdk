...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeInstanceConfigurationCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeInstanceConfigurationCompartmentRequest.
 */
...
public class ChangeInstanceConfigurationCompartmentRequest
    ...
    public static class Builder
        ...
        public Builder changeInstanceConfigurationCompartmentDetails(
                com.oracle.bmc.core.model.ChangeInstanceConfigurationCompartmentDetails
                        changeInstanceConfigurationCompartmentDetails) {
            this.changeInstanceConfigurationCompartmentDetails =
                    changeInstanceConfigurationCompartmentDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeInstanceConfigurationCompartmentRequest o) {
            instanceConfigurationId(o.getInstanceConfigurationId());
            changeInstanceConfigurationCompartmentDetails(
                    o.getChangeInstanceConfigurationCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeInstanceConfigurationCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeInstanceConfigurationCompartmentRequest
         */
        public ChangeInstanceConfigurationCompartmentRequest build() {
         ...
         * @return instance of ChangeInstanceConfigurationCompartmentRequest
         */
        public ChangeInstanceConfigurationCompartmentRequest buildWithoutInvocationCallback() {
            ChangeInstanceConfigurationCompartmentRequest request =
                    new ChangeInstanceConfigurationCompartmentRequest();
            request.instanceConfigurationId = instanceConfigurationId;
            request.changeInstanceConfigurationCompartmentDetails =
                    changeInstanceConfigurationCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeInstanceConfigurationCompartmentRequest(instanceConfigurationId, changeInstanceConfigurationCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeInstanceConfigurationCompartmentDetails=")
                .append(String.valueOf(this.changeInstanceConfigurationCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeInstanceConfigurationCompartmentRequest)) {
            return false;
        }

        ChangeInstanceConfigurationCompartmentRequest other =
                (ChangeInstanceConfigurationCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.instanceConfigurationId, other.instanceConfigurationId)
                && java.util.Objects.equals(
                        this.changeInstanceConfigurationCompartmentDetails,
                        other.changeInstanceConfigurationCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeInstanceConfigurationCompartmentDetails == null
                                ? 43
                                : this.changeInstanceConfigurationCompartmentDetails.hashCode());
