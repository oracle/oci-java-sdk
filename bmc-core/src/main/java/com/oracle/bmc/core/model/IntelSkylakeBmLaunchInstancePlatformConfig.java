 ...
 * processor (the Intel Skylake platform). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IntelSkylakeBmLaunchInstancePlatformConfig.Builder.class)
...
public final class IntelSkylakeBmLaunchInstancePlatformConfig extends LaunchInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public IntelSkylakeBmLaunchInstancePlatformConfig build() {
            IntelSkylakeBmLaunchInstancePlatformConfig model =
                    new IntelSkylakeBmLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IntelSkylakeBmLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public IntelSkylakeBmLaunchInstancePlatformConfig(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntelSkylakeBmLaunchInstancePlatformConfig)) {
            return false;
        }

        IntelSkylakeBmLaunchInstancePlatformConfig other =
                (IntelSkylakeBmLaunchInstancePlatformConfig) o;
