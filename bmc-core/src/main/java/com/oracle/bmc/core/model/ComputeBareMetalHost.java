...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComputeBareMetalHost.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ComputeBareMetalHost
    ...
    public static class Builder {
        ...
        public ComputeBareMetalHost build() {
            ComputeBareMetalHost model =
                    new ComputeBareMetalHost(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeBareMetalHost model) {
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the compute instance that runs on the compute bare metal host.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("instanceId")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeBareMetalHost(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeBareMetalHost)) {
            return false;
        }

        ComputeBareMetalHost other = (ComputeBareMetalHost) o;
