...
public class GetComputeImageCapabilitySchemaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetComputeImageCapabilitySchemaResponse(
    ...
    public static class Builder {
         ...
         */
        public GetComputeImageCapabilitySchemaResponse build() {
            return new GetComputeImageCapabilitySchemaResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetComputeImageCapabilitySchemaResponse)) {
            return false;
        }

        GetComputeImageCapabilitySchemaResponse other = (GetComputeImageCapabilitySchemaResponse) o;
