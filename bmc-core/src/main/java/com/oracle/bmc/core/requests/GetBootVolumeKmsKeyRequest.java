...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetBootVolumeKmsKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBootVolumeKmsKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetBootVolumeKmsKeyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBootVolumeKmsKeyRequest, java.lang.Void> {
         ...
         * @return instance of GetBootVolumeKmsKeyRequest
         */
        public GetBootVolumeKmsKeyRequest buildWithoutInvocationCallback() {
            GetBootVolumeKmsKeyRequest request = new GetBootVolumeKmsKeyRequest();
            request.bootVolumeId = bootVolumeId;
            request.ifMatch = ifMatch;
            return request;
            // new GetBootVolumeKmsKeyRequest(bootVolumeId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBootVolumeKmsKeyRequest)) {
            return false;
        }

        GetBootVolumeKmsKeyRequest other = (GetBootVolumeKmsKeyRequest) o;
