...
public class GetVolumeGroupBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetVolumeGroupBackupResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVolumeGroupBackupResponse> {
         ...
         */
        @Override
        public Builder copy(GetVolumeGroupBackupResponse o) {
         ...
         */
        @Override
        public GetVolumeGroupBackupResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumeGroupBackupResponse)) {
            return false;
        }

        GetVolumeGroupBackupResponse other = (GetVolumeGroupBackupResponse) o;
