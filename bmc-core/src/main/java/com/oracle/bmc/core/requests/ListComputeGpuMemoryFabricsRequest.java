...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ListComputeGpuMemoryFabricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListComputeGpuMemoryFabricsRequest.
 */
...
public class ListComputeGpuMemoryFabricsRequest
    ...
    public static class Builder
        ...
        public ListComputeGpuMemoryFabricsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListComputeGpuMemoryFabricsRequest(compartmentId, opcRequestId, computeGpuMemoryFabricId, availabilityDomain, displayName, computeHpcIslandId, computeNetworkBlockId, computeGpuMemoryFabricLifecycleState, computeGpuMemoryFabricHealth, limit, page, sortBy, sortOrder);
        }
    }
