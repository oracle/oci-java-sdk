...
public class CreateBootVolumeBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateBootVolumeBackupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBootVolumeBackupResponse)) {
            return false;
        }

        CreateBootVolumeBackupResponse other = (CreateBootVolumeBackupResponse) o;
