...
public final class InstanceAgentConfig
    ...
    public static class Builder {
        ...
        /**
         * Whether Oracle Cloud Agent can run all of the available plugins. This includes the
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceAgentConfig model) {
    ...
    /**
     * Whether Oracle Cloud Agent can run all of the available plugins. This includes the management
