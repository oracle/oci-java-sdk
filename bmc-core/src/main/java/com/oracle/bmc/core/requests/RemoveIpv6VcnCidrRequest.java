...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/RemoveIpv6VcnCidrExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveIpv6VcnCidrRequest.
 */
...
public class RemoveIpv6VcnCidrRequest
    ...
    public static class Builder
        ...
        public Builder removeVcnIpv6CidrDetails(
                com.oracle.bmc.core.model.RemoveVcnIpv6CidrDetails removeVcnIpv6CidrDetails) {
            this.removeVcnIpv6CidrDetails = removeVcnIpv6CidrDetails;
            return this;
        }
         ...
         * @return instance of RemoveIpv6VcnCidrRequest
         */
        public RemoveIpv6VcnCidrRequest buildWithoutInvocationCallback() {
            RemoveIpv6VcnCidrRequest request = new RemoveIpv6VcnCidrRequest();
            request.vcnId = vcnId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.removeVcnIpv6CidrDetails = removeVcnIpv6CidrDetails;
            return request;
            // new RemoveIpv6VcnCidrRequest(vcnId, opcRequestId, opcRetryToken, ifMatch, removeVcnIpv6CidrDetails);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",removeVcnIpv6CidrDetails=")
                .append(String.valueOf(this.removeVcnIpv6CidrDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveIpv6VcnCidrRequest)) {
            return false;
        }

        RemoveIpv6VcnCidrRequest other = (RemoveIpv6VcnCidrRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.removeVcnIpv6CidrDetails, other.removeVcnIpv6CidrDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removeVcnIpv6CidrDetails == null
                                ? 43
                                : this.removeVcnIpv6CidrDetails.hashCode());
        return result;
    }
}
