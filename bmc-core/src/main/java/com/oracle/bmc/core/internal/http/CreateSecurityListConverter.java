...
public class CreateSecurityListConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, CreateSecurityListRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateSecurityListResponse> fromResponse() {
        final Function<Response, CreateSecurityListResponse> transformer =
                new Function<Response, CreateSecurityListResponse>() {
                    @Override
                    public CreateSecurityListResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateSecurityListResponse");
