...
public class VirtualNetworkPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listProviderRemoteRegions operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListProviderRemoteRegionsResponse> listProviderRemoteRegionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListProviderRemoteRegionsRequest.Builder, ListProviderRemoteRegionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.core.model.ProviderRemoteRegionName} objects
     * contained in responses from the listProviderRemoteRegions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.core.model.ProviderRemoteRegionName} objects
     * contained in responses received from the service.
     */
