...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeNatGatewayCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeNatGatewayCompartmentRequest.
 */
...
public class ChangeNatGatewayCompartmentRequest
     ...
     * Request to change the compartment of a given NAT Gateway.
     */
    public com.oracle.bmc.core.model.ChangeNatGatewayCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.core.model.ChangeNatGatewayCompartmentDetails
                changeNatGatewayCompartmentDetails = null;

        /**
         * Request to change the compartment of a given NAT Gateway.
         * @param changeNatGatewayCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeNatGatewayCompartmentDetails(
                com.oracle.bmc.core.model.ChangeNatGatewayCompartmentDetails
                        changeNatGatewayCompartmentDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeNatGatewayCompartmentRequest o) {
            natGatewayId(o.getNatGatewayId());
            changeNatGatewayCompartmentDetails(o.getChangeNatGatewayCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeNatGatewayCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeNatGatewayCompartmentRequest
         */
        public ChangeNatGatewayCompartmentRequest build() {
            ChangeNatGatewayCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        public ChangeNatGatewayCompartmentRequest buildWithoutInvocationCallback() {
            ChangeNatGatewayCompartmentRequest request = new ChangeNatGatewayCompartmentRequest();
            ...
            return request;
            // new ChangeNatGatewayCompartmentRequest(natGatewayId, changeNatGatewayCompartmentDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeNatGatewayCompartmentDetails=")
                .append(String.valueOf(this.changeNatGatewayCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeNatGatewayCompartmentRequest)) {
            return false;
        }

        ChangeNatGatewayCompartmentRequest other = (ChangeNatGatewayCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.natGatewayId, other.natGatewayId)
                && java.util.Objects.equals(
                        this.changeNatGatewayCompartmentDetails,
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeNatGatewayCompartmentDetails == null
                                ? 43
                                : this.changeNatGatewayCompartmentDetails.hashCode());
