...
public class CreateDrgAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateDrgAttachmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDrgAttachmentResponse> {
         ...
         */
        @Override
        public Builder copy(CreateDrgAttachmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrgAttachmentResponse)) {
            return false;
        }

        CreateDrgAttachmentResponse other = (CreateDrgAttachmentResponse) o;
