...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetBlockVolumeReplicaExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBlockVolumeReplicaRequest.
 */
...
public class GetBlockVolumeReplicaRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(GetBlockVolumeReplicaRequest o) {
         ...
         */
        public GetBlockVolumeReplicaRequest build() {
            GetBlockVolumeReplicaRequest request = buildWithoutInvocationCallback();
