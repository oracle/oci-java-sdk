...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AmdRomeBmGpuPlatformConfig.Builder.class
)
...
public final class AmdRomeBmGpuPlatformConfig extends PlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdRomeBmGpuPlatformConfig build() {
            AmdRomeBmGpuPlatformConfig __instance__ =
                    new AmdRomeBmGpuPlatformConfig(
                            isSecureBootEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdRomeBmGpuPlatformConfig o) {
    ...
    @Deprecated
    public AmdRomeBmGpuPlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmdRomeBmGpuPlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdRomeBmGpuPlatformConfig)) {
            return false;
        }

        AmdRomeBmGpuPlatformConfig other = (AmdRomeBmGpuPlatformConfig) o;
