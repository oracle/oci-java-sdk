...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateComputeGpuMemoryFabricExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateComputeGpuMemoryFabricRequest.
 */
...
public class UpdateComputeGpuMemoryFabricRequest
    ...
    public static class Builder
        ...
        public UpdateComputeGpuMemoryFabricRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateComputeGpuMemoryFabricRequest(computeGpuMemoryFabricId, updateComputeGpuMemoryFabricDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
