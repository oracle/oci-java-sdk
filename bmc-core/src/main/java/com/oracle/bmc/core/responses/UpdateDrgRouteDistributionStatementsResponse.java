...
public class UpdateDrgRouteDistributionStatementsResponse
    ...
    private UpdateDrgRouteDistributionStatementsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateDrgRouteDistributionStatementsResponse o) {
         ...
         */
        @Override
        public UpdateDrgRouteDistributionStatementsResponse build() {
            return new UpdateDrgRouteDistributionStatementsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrgRouteDistributionStatementsResponse)) {
            return false;
        }

        UpdateDrgRouteDistributionStatementsResponse other =
                (UpdateDrgRouteDistributionStatementsResponse) o;
