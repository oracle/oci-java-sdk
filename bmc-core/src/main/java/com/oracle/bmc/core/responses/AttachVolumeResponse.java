...
public class AttachVolumeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AttachVolumeResponse> {
         ...
         */
        @Override
        public Builder copy(AttachVolumeResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachVolumeResponse)) {
            return false;
        }

        AttachVolumeResponse other = (AttachVolumeResponse) o;
