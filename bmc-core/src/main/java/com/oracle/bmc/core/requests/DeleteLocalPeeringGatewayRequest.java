...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeleteLocalPeeringGatewayExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteLocalPeeringGatewayRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DeleteLocalPeeringGatewayRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteLocalPeeringGatewayRequest, java.lang.Void> {
        ...
        public DeleteLocalPeeringGatewayRequest buildWithoutInvocationCallback() {
            DeleteLocalPeeringGatewayRequest request = new DeleteLocalPeeringGatewayRequest();
            request.localPeeringGatewayId = localPeeringGatewayId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteLocalPeeringGatewayRequest(localPeeringGatewayId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().localPeeringGatewayId(localPeeringGatewayId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLocalPeeringGatewayRequest)) {
            return false;
        }

        DeleteLocalPeeringGatewayRequest other = (DeleteLocalPeeringGatewayRequest) o;
