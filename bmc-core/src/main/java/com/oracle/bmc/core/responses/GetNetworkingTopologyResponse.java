...
public class GetNetworkingTopologyResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.NetworkingTopology getNetworkingTopology() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetNetworkingTopologyResponse> {
         ...
         * @return this builder
         */
        public Builder networkingTopology(
                com.oracle.bmc.core.model.NetworkingTopology networkingTopology) {
            this.networkingTopology = networkingTopology;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",networkingTopology=").append(String.valueOf(networkingTopology));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        GetNetworkingTopologyResponse other = (GetNetworkingTopologyResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.networkingTopology, other.networkingTopology);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.networkingTopology == null
                                ? 43
                                : this.networkingTopology.hashCode());
        return result;
    }
}
