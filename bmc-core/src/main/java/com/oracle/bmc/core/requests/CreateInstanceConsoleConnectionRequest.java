...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateInstanceConsoleConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateInstanceConsoleConnectionRequest.
 */
...
public class CreateInstanceConsoleConnectionRequest
    ...
    public static class Builder
         ...
         */
        public CreateInstanceConsoleConnectionRequest build() {
            CreateInstanceConsoleConnectionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateInstanceConsoleConnectionRequest
         */
        public CreateInstanceConsoleConnectionRequest buildWithoutInvocationCallback() {
            CreateInstanceConsoleConnectionRequest request =
                    new CreateInstanceConsoleConnectionRequest();
    ...
    public String toString() {
        ...
        sb.append(",createInstanceConsoleConnectionDetails=")
                .append(String.valueOf(this.createInstanceConsoleConnectionDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateInstanceConsoleConnectionRequest)) {
            return false;
        }

        CreateInstanceConsoleConnectionRequest other = (CreateInstanceConsoleConnectionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createInstanceConsoleConnectionDetails,
                        other.createInstanceConsoleConnectionDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createInstanceConsoleConnectionDetails == null
                                ? 43
                                : this.createInstanceConsoleConnectionDetails.hashCode());
        result =
                (result * PRIME)
