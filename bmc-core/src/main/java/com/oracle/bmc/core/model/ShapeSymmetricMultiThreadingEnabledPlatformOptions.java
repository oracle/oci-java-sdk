...
public final class ShapeSymmetricMultiThreadingEnabledPlatformOptions {
    ...
    public static class Builder {
        ...
        public ShapeSymmetricMultiThreadingEnabledPlatformOptions build() {
            ShapeSymmetricMultiThreadingEnabledPlatformOptions __instance__ =
                    new ShapeSymmetricMultiThreadingEnabledPlatformOptions(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShapeSymmetricMultiThreadingEnabledPlatformOptions o) {
