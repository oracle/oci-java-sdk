...
@Slf4j
public class CreateDrgAttachmentConverter {
    private static final ResponseConversionFunctionFactory RESPONSE_CONVERSION_FACTORY =
            new ResponseConversionFunctionFactory();

    public static Invocation.Builder fromRequest(
            RestClient client, CreateDrgAttachmentRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateDrgAttachmentResponse> fromResponse() {
        final Function<Response, CreateDrgAttachmentResponse> transformer =
                new Function<Response, CreateDrgAttachmentResponse>() {
                    @Override
                    public CreateDrgAttachmentResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateDrgAttachmentResponse");
