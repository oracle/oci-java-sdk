...
public class UpdateCpeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateCpeResponse> {
        ...
        public UpdateCpeResponse build() {
            return new UpdateCpeResponse(__httpStatusCode__, headers, etag, opcRequestId, cpe);
        }
    }
