...
public class GetDedicatedVmHostResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDedicatedVmHostResponse> {
        ...
        public GetDedicatedVmHostResponse build() {
            return new GetDedicatedVmHostResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDedicatedVmHostResponse)) {
            return false;
        }

        GetDedicatedVmHostResponse other = (GetDedicatedVmHostResponse) o;
