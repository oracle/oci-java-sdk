 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CopyVolumeBackupRequest.
 */
...
public class CopyVolumeBackupRequest
    ...
    public static class Builder
        ...
        public CopyVolumeBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CopyVolumeBackupRequest(volumeBackupId, copyVolumeBackupDetails, opcRetryToken,
            // opcRequestId);
        }
    }
