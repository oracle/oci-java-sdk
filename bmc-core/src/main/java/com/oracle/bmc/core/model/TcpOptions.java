...
/**
 * Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If
 * you specify TCP as the protocol but omit this object, then all destination ports are allowed.
 * <br>
...
public final class TcpOptions extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
