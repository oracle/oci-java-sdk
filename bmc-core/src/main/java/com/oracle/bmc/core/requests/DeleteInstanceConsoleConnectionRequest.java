...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeleteInstanceConsoleConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteInstanceConsoleConnectionRequest.
 */
...
public class DeleteInstanceConsoleConnectionRequest
    ...
    public static class Builder
        ...
        public DeleteInstanceConsoleConnectionRequest buildWithoutInvocationCallback() {
            DeleteInstanceConsoleConnectionRequest request =
                    new DeleteInstanceConsoleConnectionRequest();
            request.instanceConsoleConnectionId = instanceConsoleConnectionId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteInstanceConsoleConnectionRequest(instanceConsoleConnectionId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteInstanceConsoleConnectionRequest)) {
            return false;
        }

        DeleteInstanceConsoleConnectionRequest other = (DeleteInstanceConsoleConnectionRequest) o;
