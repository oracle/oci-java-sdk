...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComputeBareMetalHostPlacementConstraintDetails.Builder.class)
...
public final class ComputeBareMetalHostPlacementConstraintDetails
    ...
    public static class Builder {
        ...
        public ComputeBareMetalHostPlacementConstraintDetails build() {
            ComputeBareMetalHostPlacementConstraintDetails model =
                    new ComputeBareMetalHostPlacementConstraintDetails(this.computeBareMetalHostId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeBareMetalHostPlacementConstraintDetails model) {
    ...
    @Deprecated
    public ComputeBareMetalHostPlacementConstraintDetails(String computeBareMetalHostId) {
        super();
        this.computeBareMetalHostId = computeBareMetalHostId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeBareMetalHostPlacementConstraintDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeBareMetalHostPlacementConstraintDetails)) {
            return false;
        }

        ComputeBareMetalHostPlacementConstraintDetails other =
                (ComputeBareMetalHostPlacementConstraintDetails) o;
        return java.util.Objects.equals(this.computeBareMetalHostId, other.computeBareMetalHostId)
                && super.equals(other);
    }
