...
public class CreateVolumeBackupPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public CreateVolumeBackupPolicyResponse build() {
            return new CreateVolumeBackupPolicyResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, volumeBackupPolicy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeBackupPolicyResponse)) {
            return false;
        }

        CreateVolumeBackupPolicyResponse other = (CreateVolumeBackupPolicyResponse) o;
