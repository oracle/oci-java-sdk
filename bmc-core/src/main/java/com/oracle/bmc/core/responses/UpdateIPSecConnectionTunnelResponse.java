...
public class UpdateIPSecConnectionTunnelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code IPSecConnectionTunnel} instance. */
    ...
    public static class Builder
         ...
         * The returned {@code IPSecConnectionTunnel} instance.
         *
         * @param iPSecConnectionTunnel the value to set
         * @return this builder
         */
        ...
        public UpdateIPSecConnectionTunnelResponse build() {
            return new UpdateIPSecConnectionTunnelResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, iPSecConnectionTunnel);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIPSecConnectionTunnelResponse)) {
            return false;
        }

        UpdateIPSecConnectionTunnelResponse other = (UpdateIPSecConnectionTunnelResponse) o;
