...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AmdRomeBmLaunchInstancePlatformConfig.Builder.class
)
...
public final class AmdRomeBmLaunchInstancePlatformConfig extends LaunchInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdRomeBmLaunchInstancePlatformConfig build() {
            AmdRomeBmLaunchInstancePlatformConfig __instance__ =
                    new AmdRomeBmLaunchInstancePlatformConfig(
                            isSecureBootEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdRomeBmLaunchInstancePlatformConfig o) {
    ...
    @Deprecated
    public AmdRomeBmLaunchInstancePlatformConfig(
    ...
    public String toString() {
        ...
        sb.append("AmdRomeBmLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdRomeBmLaunchInstancePlatformConfig)) {
            return false;
        }

        AmdRomeBmLaunchInstancePlatformConfig other = (AmdRomeBmLaunchInstancePlatformConfig) o;
