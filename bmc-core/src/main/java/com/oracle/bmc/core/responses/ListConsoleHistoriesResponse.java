...
public class ListConsoleHistoriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.core.model.ConsoleHistory} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.ConsoleHistory> getItems() {
        return items;
    }
    ...
    private ListConsoleHistoriesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.core.model.ConsoleHistory> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.core.model.ConsoleHistory> items) {
            this.items = items;
            return this;
        }
