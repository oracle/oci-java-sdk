...
public class GetComputeGlobalImageCapabilitySchemaVersionResponse
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.ComputeGlobalImageCapabilitySchemaVersion
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder computeGlobalImageCapabilitySchemaVersion(
                com.oracle.bmc.core.model.ComputeGlobalImageCapabilitySchemaVersion
                        computeGlobalImageCapabilitySchemaVersion) {
            this.computeGlobalImageCapabilitySchemaVersion =
                    computeGlobalImageCapabilitySchemaVersion;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",computeGlobalImageCapabilitySchemaVersion=")
                .append(String.valueOf(computeGlobalImageCapabilitySchemaVersion));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetComputeGlobalImageCapabilitySchemaVersionResponse)) {
            return false;
        }

        GetComputeGlobalImageCapabilitySchemaVersionResponse other =
                (GetComputeGlobalImageCapabilitySchemaVersionResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.computeGlobalImageCapabilitySchemaVersion,
                        other.computeGlobalImageCapabilitySchemaVersion);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.computeGlobalImageCapabilitySchemaVersion == null
                                ? 43
                                : this.computeGlobalImageCapabilitySchemaVersion.hashCode());
        return result;
    }
}
