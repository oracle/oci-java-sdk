...
public class ListCrossconnectPortSpeedShapesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.core.model.CrossConnectPortSpeedShape} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.CrossConnectPortSpeedShape> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCrossconnectPortSpeedShapesResponse)) {
            return false;
        }

        ListCrossconnectPortSpeedShapesResponse other = (ListCrossconnectPortSpeedShapesResponse) o;
