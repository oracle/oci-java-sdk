...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateByoipRangeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateByoipRangeRequest.
 */
...
public class UpdateByoipRangeRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateByoipRangeRequest o) {
            byoipRangeId(o.getByoipRangeId());
            updateByoipRangeDetails(o.getUpdateByoipRangeDetails());
         ...
         */
        public UpdateByoipRangeRequest build() {
            UpdateByoipRangeRequest request = buildWithoutInvocationCallback();
