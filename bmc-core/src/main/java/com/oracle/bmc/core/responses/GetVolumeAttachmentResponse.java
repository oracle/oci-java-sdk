...
public class GetVolumeAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetVolumeAttachmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVolumeAttachmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumeAttachmentResponse)) {
            return false;
        }

        GetVolumeAttachmentResponse other = (GetVolumeAttachmentResponse) o;
