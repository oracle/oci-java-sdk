...
public class GetIPSecConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetIPSecConnectionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetIPSecConnectionResponse> {
        ...
        public GetIPSecConnectionResponse build() {
            return new GetIPSecConnectionResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, iPSecConnection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIPSecConnectionResponse)) {
            return false;
        }

        GetIPSecConnectionResponse other = (GetIPSecConnectionResponse) o;
