...
public class CreateDrgRouteDistributionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateDrgRouteDistributionResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrgRouteDistributionResponse)) {
            return false;
        }

        CreateDrgRouteDistributionResponse other = (CreateDrgRouteDistributionResponse) o;
