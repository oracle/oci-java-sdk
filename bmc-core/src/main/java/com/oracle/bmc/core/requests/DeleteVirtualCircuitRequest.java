...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeleteVirtualCircuitExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteVirtualCircuitRequest.
 */
...
public class DeleteVirtualCircuitRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteVirtualCircuitRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteVirtualCircuitRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteVirtualCircuitRequest
         */
        public DeleteVirtualCircuitRequest build() {
            DeleteVirtualCircuitRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteVirtualCircuitRequest buildWithoutInvocationCallback() {
            DeleteVirtualCircuitRequest request = new DeleteVirtualCircuitRequest();
            request.virtualCircuitId = virtualCircuitId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteVirtualCircuitRequest(virtualCircuitId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().virtualCircuitId(virtualCircuitId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVirtualCircuitRequest)) {
            return false;
        }

        DeleteVirtualCircuitRequest other = (DeleteVirtualCircuitRequest) o;
