...
public class GetVlanResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVlanResponse> {
         ...
         */
        @Override
        public Builder copy(GetVlanResponse o) {
        ...
        public GetVlanResponse build() {
            return new GetVlanResponse(__httpStatusCode__, headers, etag, opcRequestId, vlan);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVlanResponse)) {
            return false;
        }

        GetVlanResponse other = (GetVlanResponse) o;
