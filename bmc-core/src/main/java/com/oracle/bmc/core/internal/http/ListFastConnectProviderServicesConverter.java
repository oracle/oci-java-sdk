...
public class ListFastConnectProviderServicesConverter {
    ...
    public static Function<Response, ListFastConnectProviderServicesResponse> fromResponse() {
        final Function<Response, ListFastConnectProviderServicesResponse> transformer =
                new Function<Response, ListFastConnectProviderServicesResponse>() {
                    @Override
                    public ListFastConnectProviderServicesResponse apply(Response rawResponse) {
                        LOG.trace(
                                "Transform function invoked for ListFastConnectProviderServicesResponse");
                        Function<Response, WithHeaders<List<FastConnectProviderService>>>
                                responseFn =
                                        RESPONSE_CONVERSION_FACTORY.create(
                                                new GenericType<
                                                        List<FastConnectProviderService>>() {});

                        WithHeaders<List<FastConnectProviderService>> response =
                                responseFn.apply(rawResponse);
                        MultivaluedMap<String, String> headers = response.getHeaders();

                        ListFastConnectProviderServicesResponse.Builder builder =
                                ListFastConnectProviderServicesResponse.builder();
