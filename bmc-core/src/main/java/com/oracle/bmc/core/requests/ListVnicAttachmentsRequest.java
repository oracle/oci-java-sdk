...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ListVnicAttachmentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVnicAttachmentsRequest.
 */
...
public class ListVnicAttachmentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListVnicAttachmentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVnicAttachmentsRequest(compartmentId, availabilityDomain, instanceId, limit, page, vnicId);
        }
    }
