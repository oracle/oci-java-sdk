...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AmdVmLaunchInstancePlatformConfig.Builder.class
)
...
public final class AmdVmLaunchInstancePlatformConfig extends LaunchInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdVmLaunchInstancePlatformConfig build() {
            AmdVmLaunchInstancePlatformConfig __instance__ =
                    new AmdVmLaunchInstancePlatformConfig(
                            isSecureBootEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdVmLaunchInstancePlatformConfig o) {
    ...
    @Deprecated
    public AmdVmLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmdVmLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdVmLaunchInstancePlatformConfig)) {
            return false;
        }

        AmdVmLaunchInstancePlatformConfig other = (AmdVmLaunchInstancePlatformConfig) o;
