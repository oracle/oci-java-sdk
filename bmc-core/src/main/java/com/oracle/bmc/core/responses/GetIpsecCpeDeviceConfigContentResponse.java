...
public class GetIpsecCpeDeviceConfigContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetIpsecCpeDeviceConfigContentResponse o) {
         ...
         */
        public GetIpsecCpeDeviceConfigContentResponse build() {
            return new GetIpsecCpeDeviceConfigContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIpsecCpeDeviceConfigContentResponse)) {
            return false;
        }

        GetIpsecCpeDeviceConfigContentResponse other = (GetIpsecCpeDeviceConfigContentResponse) o;
