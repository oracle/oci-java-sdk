...
public final class InstanceConfigurationSummary
    ...
    public InstanceConfigurationSummary(
    ...
    public static class Builder {
        ...
        public InstanceConfigurationSummary build() {
            InstanceConfigurationSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationSummary)) {
            return false;
        }

        InstanceConfigurationSummary other = (InstanceConfigurationSummary) o;
