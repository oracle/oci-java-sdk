...
public class TerminateClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public TerminateClusterNetworkResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TerminateClusterNetworkResponse)) {
            return false;
        }

        TerminateClusterNetworkResponse other = (TerminateClusterNetworkResponse) o;
