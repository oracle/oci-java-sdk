 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVcnsRequest.
 */
...
public class ListVcnsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListVcnsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVcnsRequest(compartmentId, limit, page, displayName, sortBy, sortOrder,
            // lifecycleState);
        }
    }
