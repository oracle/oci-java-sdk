...
public class AttachServiceIdResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AttachServiceIdResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AttachServiceIdResponse> {
        ...
        public AttachServiceIdResponse build() {
            return new AttachServiceIdResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachServiceIdResponse)) {
            return false;
        }

        AttachServiceIdResponse other = (AttachServiceIdResponse) o;
