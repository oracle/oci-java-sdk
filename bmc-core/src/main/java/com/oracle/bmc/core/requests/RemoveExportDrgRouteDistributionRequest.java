...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/RemoveExportDrgRouteDistributionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveExportDrgRouteDistributionRequest.
 */
...
public class RemoveExportDrgRouteDistributionRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveExportDrgRouteDistributionRequest o) {
         ...
         */
        public RemoveExportDrgRouteDistributionRequest build() {
            RemoveExportDrgRouteDistributionRequest request = buildWithoutInvocationCallback();
