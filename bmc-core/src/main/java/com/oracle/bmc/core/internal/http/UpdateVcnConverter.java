...
public class UpdateVcnConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, UpdateVcnRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdateVcnResponse> fromResponse() {
        final Function<Response, UpdateVcnResponse> transformer =
                new Function<Response, UpdateVcnResponse>() {
                    @Override
                    public UpdateVcnResponse apply(Response rawResponse) {
