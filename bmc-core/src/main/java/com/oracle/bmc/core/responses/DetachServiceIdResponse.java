...
public class DetachServiceIdResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DetachServiceIdResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachServiceIdResponse)) {
            return false;
        }

        DetachServiceIdResponse other = (DetachServiceIdResponse) o;
