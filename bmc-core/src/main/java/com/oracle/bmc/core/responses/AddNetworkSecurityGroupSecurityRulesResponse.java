...
public class AddNetworkSecurityGroupSecurityRulesResponse
    ...
    /** The returned {@code AddedNetworkSecurityGroupSecurityRules} instance. */
    ...
    public String toString() {
        ...
        sb.append(",addedNetworkSecurityGroupSecurityRules=")
                .append(String.valueOf(addedNetworkSecurityGroupSecurityRules));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddNetworkSecurityGroupSecurityRulesResponse)) {
            return false;
        }

        AddNetworkSecurityGroupSecurityRulesResponse other =
                (AddNetworkSecurityGroupSecurityRulesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.addedNetworkSecurityGroupSecurityRules,
                        other.addedNetworkSecurityGroupSecurityRules);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.addedNetworkSecurityGroupSecurityRules == null
                                ? 43
                                : this.addedNetworkSecurityGroupSecurityRules.hashCode());
        return result;
    }
}
