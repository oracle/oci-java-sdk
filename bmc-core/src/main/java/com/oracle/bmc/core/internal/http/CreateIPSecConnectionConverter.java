...
public class CreateIPSecConnectionConverter {
    ...
    public static Function<Response, CreateIPSecConnectionResponse> fromResponse() {
        final Function<Response, CreateIPSecConnectionResponse> transformer =
                new Function<Response, CreateIPSecConnectionResponse>() {
                    @Override
                    public CreateIPSecConnectionResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateIPSecConnectionResponse");
