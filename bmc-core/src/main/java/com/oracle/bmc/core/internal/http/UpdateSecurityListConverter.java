...
public class UpdateSecurityListConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, UpdateSecurityListRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdateSecurityListResponse> fromResponse() {
        final Function<Response, UpdateSecurityListResponse> transformer =
                new Function<Response, UpdateSecurityListResponse>() {
                    @Override
                    public UpdateSecurityListResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for UpdateSecurityListResponse");
