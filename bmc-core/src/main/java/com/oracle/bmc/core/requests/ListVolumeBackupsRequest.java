 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVolumeBackupsRequest.
 */
...
public class ListVolumeBackupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListVolumeBackupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVolumeBackupsRequest(compartmentId, volumeId, limit, page, displayName,
            // sourceVolumeBackupId, sortBy, sortOrder, lifecycleState);
        }
    }
