 ...
 * shape (the AMD Rome platform). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig.Builder.class)
...
public final class InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig build() {
            InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig model =
                    new InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig)) {
            return false;
        }

        InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig other =
                (InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig) o;
