...
public final class InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig build() {
            InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig o) {
