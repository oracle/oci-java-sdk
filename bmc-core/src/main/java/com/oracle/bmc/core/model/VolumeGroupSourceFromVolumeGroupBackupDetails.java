...
/**
 * Specifies the volume group backup to restore from. <br>
...
public final class VolumeGroupSourceFromVolumeGroupBackupDetails extends VolumeGroupSourceDetails {
    ...
    public static class Builder {
        ...
        public VolumeGroupSourceFromVolumeGroupBackupDetails build() {
            VolumeGroupSourceFromVolumeGroupBackupDetails model =
                    new VolumeGroupSourceFromVolumeGroupBackupDetails(this.volumeGroupBackupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VolumeGroupSourceFromVolumeGroupBackupDetails model) {
