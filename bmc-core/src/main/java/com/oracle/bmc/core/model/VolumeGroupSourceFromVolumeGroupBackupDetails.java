...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VolumeGroupSourceFromVolumeGroupBackupDetails.Builder.class
)
...
public final class VolumeGroupSourceFromVolumeGroupBackupDetails extends VolumeGroupSourceDetails {
    ...
    public static class Builder {
        ...
        public VolumeGroupSourceFromVolumeGroupBackupDetails build() {
            VolumeGroupSourceFromVolumeGroupBackupDetails __instance__ =
                    new VolumeGroupSourceFromVolumeGroupBackupDetails(volumeGroupBackupId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VolumeGroupSourceFromVolumeGroupBackupDetails o) {
            Builder copiedBuilder = volumeGroupBackupId(o.getVolumeGroupBackupId());
    ...
    @Deprecated
    public VolumeGroupSourceFromVolumeGroupBackupDetails(String volumeGroupBackupId) {
        super();
        this.volumeGroupBackupId = volumeGroupBackupId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VolumeGroupSourceFromVolumeGroupBackupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VolumeGroupSourceFromVolumeGroupBackupDetails)) {
            return false;
        }

        VolumeGroupSourceFromVolumeGroupBackupDetails other =
                (VolumeGroupSourceFromVolumeGroupBackupDetails) o;
        return java.util.Objects.equals(this.volumeGroupBackupId, other.volumeGroupBackupId)
