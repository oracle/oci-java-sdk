...
public class GetImageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetImageResponse> {
         ...
         */
        @Override
        public Builder copy(GetImageResponse o) {
        ...
        public GetImageResponse build() {
            return new GetImageResponse(__httpStatusCode__, headers, etag, opcRequestId, image);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetImageResponse)) {
            return false;
        }
