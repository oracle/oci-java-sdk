...
/**
 * Properties used to configure MACsec (if capable). <br>
...
public final class CreateMacsecProperties
    ...
    public static class Builder {
        ...
        public CreateMacsecProperties build() {
            CreateMacsecProperties model =
                    new CreateMacsecProperties(this.state, this.primaryKey, this.encryptionCipher);
