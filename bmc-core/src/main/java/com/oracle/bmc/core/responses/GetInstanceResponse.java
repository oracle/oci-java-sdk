...
public class GetInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetInstanceResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetInstanceResponse)) {
            return false;
        }
