...
public class ChangeRemotePeeringConnectionCompartmentResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeRemotePeeringConnectionCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeRemotePeeringConnectionCompartmentResponse)) {
            return false;
        }

        ChangeRemotePeeringConnectionCompartmentResponse other =
                (ChangeRemotePeeringConnectionCompartmentResponse) o;
