...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateIPSecConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIPSecConnectionRequest.
 */
...
public class CreateIPSecConnectionRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of CreateIPSecConnectionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateIPSecConnectionRequest
         */
        ...
        public CreateIPSecConnectionRequest buildWithoutInvocationCallback() {
            CreateIPSecConnectionRequest request = new CreateIPSecConnectionRequest();
            request.createIPSecConnectionDetails = createIPSecConnectionDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateIPSecConnectionRequest(createIPSecConnectionDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createIPSecConnectionDetails=")
                .append(String.valueOf(this.createIPSecConnectionDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIPSecConnectionRequest)) {
            return false;
        }

        CreateIPSecConnectionRequest other = (CreateIPSecConnectionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createIPSecConnectionDetails, other.createIPSecConnectionDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createIPSecConnectionDetails == null
                                ? 43
                                : this.createIPSecConnectionDetails.hashCode());
        result =
                (result * PRIME)
