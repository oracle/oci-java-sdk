...
public class GetLocalPeeringGatewayResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public GetLocalPeeringGatewayResponse build() {
            return new GetLocalPeeringGatewayResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLocalPeeringGatewayResponse)) {
            return false;
        }

        GetLocalPeeringGatewayResponse other = (GetLocalPeeringGatewayResponse) o;
