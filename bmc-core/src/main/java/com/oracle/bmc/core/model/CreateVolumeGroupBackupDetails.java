...
public final class CreateVolumeGroupBackupDetails
    ...
    public static class Builder {
        /**
         * The OCID of the compartment that will contain the volume group backup. This parameter is
         * optional, by default backup will be created in the same compartment and source volume
         * group.
         */
    ...
    /**
     * The OCID of the compartment that will contain the volume group backup. This parameter is
     * optional, by default backup will be created in the same compartment and source volume group.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
