...
public class CopyBootVolumeBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CopyBootVolumeBackupResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyBootVolumeBackupResponse)) {
            return false;
        }

        CopyBootVolumeBackupResponse other = (CopyBootVolumeBackupResponse) o;
