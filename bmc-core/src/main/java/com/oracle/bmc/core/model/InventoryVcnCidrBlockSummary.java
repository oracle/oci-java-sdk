...
/**
 * Lists the CIDRs and utilization within a VCN. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InventoryVcnCidrBlockSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InventoryVcnCidrBlockSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"ipCidrBlock", "utilization"})
    public InventoryVcnCidrBlockSummary(String ipCidrBlock, Float utilization) {
        super();
    ...
    public static class Builder {
        ...
        public InventoryVcnCidrBlockSummary build() {
            InventoryVcnCidrBlockSummary model =
                    new InventoryVcnCidrBlockSummary(this.ipCidrBlock, this.utilization);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InventoryVcnCidrBlockSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InventoryVcnCidrBlockSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InventoryVcnCidrBlockSummary)) {
            return false;
        }

        InventoryVcnCidrBlockSummary other = (InventoryVcnCidrBlockSummary) o;
