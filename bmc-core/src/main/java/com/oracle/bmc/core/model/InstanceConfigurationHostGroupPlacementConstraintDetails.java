...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceConfigurationHostGroupPlacementConstraintDetails.Builder.class)
...
public final class InstanceConfigurationHostGroupPlacementConstraintDetails
        extends InstanceConfigurationPlacementConstraintDetails {
    ...
    public static class Builder {
        ...
        public InstanceConfigurationHostGroupPlacementConstraintDetails build() {
            InstanceConfigurationHostGroupPlacementConstraintDetails model =
                    new InstanceConfigurationHostGroupPlacementConstraintDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationHostGroupPlacementConstraintDetails model) {
    ...
    @Deprecated
    public InstanceConfigurationHostGroupPlacementConstraintDetails(String computeHostGroupId) {
        super();
        this.computeHostGroupId = computeHostGroupId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationHostGroupPlacementConstraintDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationHostGroupPlacementConstraintDetails)) {
            return false;
        }

        InstanceConfigurationHostGroupPlacementConstraintDetails other =
                (InstanceConfigurationHostGroupPlacementConstraintDetails) o;
