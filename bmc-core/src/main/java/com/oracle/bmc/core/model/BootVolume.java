...
public final class BootVolume extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The date and time the boot volume was created. Format defined by
    ...
    /**
     * Specifies whether the boot volume's data has finished copying from the source boot volume or
     * boot volume backup.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isHydrated")
