...
public class CreateNetworkSecurityGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateNetworkSecurityGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateNetworkSecurityGroupResponse o) {
        ...
        public CreateNetworkSecurityGroupResponse build() {
            return new CreateNetworkSecurityGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNetworkSecurityGroupResponse)) {
            return false;
        }

        CreateNetworkSecurityGroupResponse other = (CreateNetworkSecurityGroupResponse) o;
