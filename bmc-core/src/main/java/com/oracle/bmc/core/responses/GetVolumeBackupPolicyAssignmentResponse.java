...
public class GetVolumeBackupPolicyAssignmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.VolumeBackupPolicyAssignment
    ...
    private GetVolumeBackupPolicyAssignmentResponse(
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder volumeBackupPolicyAssignment(
         ...
         */
        public Builder copy(GetVolumeBackupPolicyAssignmentResponse o) {
         ...
         */
        public GetVolumeBackupPolicyAssignmentResponse build() {
    ...
    public String toString() {
        ...
        sb.append(",volumeBackupPolicyAssignment=")
                .append(String.valueOf(volumeBackupPolicyAssignment));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumeBackupPolicyAssignmentResponse)) {
            return false;
        }

        GetVolumeBackupPolicyAssignmentResponse other = (GetVolumeBackupPolicyAssignmentResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.volumeBackupPolicyAssignment, other.volumeBackupPolicyAssignment);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.volumeBackupPolicyAssignment == null
                                ? 43
                                : this.volumeBackupPolicyAssignment.hashCode());
        return result;
    }
}
