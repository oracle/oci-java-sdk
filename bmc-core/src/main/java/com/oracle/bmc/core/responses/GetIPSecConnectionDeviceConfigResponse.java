...
public class GetIPSecConnectionDeviceConfigResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.IPSecConnectionDeviceConfig getIPSecConnectionDeviceConfig() {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder iPSecConnectionDeviceConfig(
                com.oracle.bmc.core.model.IPSecConnectionDeviceConfig iPSecConnectionDeviceConfig) {
            this.iPSecConnectionDeviceConfig = iPSecConnectionDeviceConfig;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",iPSecConnectionDeviceConfig=")
                .append(String.valueOf(iPSecConnectionDeviceConfig));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIPSecConnectionDeviceConfigResponse)) {
            return false;
        }

        GetIPSecConnectionDeviceConfigResponse other = (GetIPSecConnectionDeviceConfigResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.iPSecConnectionDeviceConfig, other.iPSecConnectionDeviceConfig);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.iPSecConnectionDeviceConfig == null
                                ? 43
                                : this.iPSecConnectionDeviceConfig.hashCode());
        return result;
    }
}
