...
public class ChangeVolumeGroupBackupCompartmentResponse
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeVolumeGroupBackupCompartmentResponse o) {
         ...
         */
        public ChangeVolumeGroupBackupCompartmentResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVolumeGroupBackupCompartmentResponse)) {
            return false;
        }

        ChangeVolumeGroupBackupCompartmentResponse other =
                (ChangeVolumeGroupBackupCompartmentResponse) o;
