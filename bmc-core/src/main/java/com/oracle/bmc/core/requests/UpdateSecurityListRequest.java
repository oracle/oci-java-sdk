...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateSecurityListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSecurityListRequest.
 */
...
public class UpdateSecurityListRequest
    ...
    public static class Builder
        ...
        /**
         * Updated details for the security list.
         * @param updateSecurityListDetails the value to set
         * @return this builder instance
         */
