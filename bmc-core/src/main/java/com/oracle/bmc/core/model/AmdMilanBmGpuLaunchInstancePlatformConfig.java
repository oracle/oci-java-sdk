...
/**
 * The platform configuration used when launching a bare metal instance with a GPU shape on the AMD
 * Milan platform. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmdMilanBmGpuLaunchInstancePlatformConfig.Builder.class)
...
public final class AmdMilanBmGpuLaunchInstancePlatformConfig extends LaunchInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdMilanBmGpuLaunchInstancePlatformConfig build() {
            AmdMilanBmGpuLaunchInstancePlatformConfig model =
                    new AmdMilanBmGpuLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdMilanBmGpuLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public AmdMilanBmGpuLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmdMilanBmGpuLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdMilanBmGpuLaunchInstancePlatformConfig)) {
            return false;
        }

        AmdMilanBmGpuLaunchInstancePlatformConfig other =
                (AmdMilanBmGpuLaunchInstancePlatformConfig) o;
