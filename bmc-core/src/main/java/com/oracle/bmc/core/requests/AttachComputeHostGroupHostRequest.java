...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/AttachComputeHostGroupHostExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachComputeHostGroupHostRequest.
 */
...
public class AttachComputeHostGroupHostRequest
    ...
    public static class Builder
        ...
        public AttachComputeHostGroupHostRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AttachComputeHostGroupHostRequest(computeHostId, attachComputeHostGroupHostDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
