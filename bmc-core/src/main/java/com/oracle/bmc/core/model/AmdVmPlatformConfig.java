...
/**
 * The platform configuration of a virtual machine instance that uses the AMD platform. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmdVmPlatformConfig.Builder.class)
...
public final class AmdVmPlatformConfig extends PlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdVmPlatformConfig build() {
            AmdVmPlatformConfig model =
                    new AmdVmPlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdVmPlatformConfig model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdVmPlatformConfig)) {
            return false;
        }

        AmdVmPlatformConfig other = (AmdVmPlatformConfig) o;
