...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateImageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateImageRequest.
 */
...
public class CreateImageRequest
    ...
    public static class Builder
        ...
        public Builder createImageDetails(
                com.oracle.bmc.core.model.CreateImageDetails createImageDetails) {
         ...
         *
         * @return instance of CreateImageRequest
         */
        public CreateImageRequest build() {
            CreateImageRequest request = buildWithoutInvocationCallback();
        ...
        public CreateImageRequest buildWithoutInvocationCallback() {
            ...
            request.createImageDetails = createImageDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateImageRequest(createImageDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createImageDetails=").append(String.valueOf(this.createImageDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateImageRequest)) {
            return false;
        }

        CreateImageRequest other = (CreateImageRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.createImageDetails, other.createImageDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createImageDetails == null
                                ? 43
                                : this.createImageDetails.hashCode());
        result =
                (result * PRIME)
