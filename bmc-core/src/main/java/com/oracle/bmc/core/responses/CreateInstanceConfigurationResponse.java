...
public class CreateInstanceConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.InstanceConfiguration getInstanceConfiguration() {
    ...
    public static class Builder {
        ...
        public CreateInstanceConfigurationResponse build() {
            return new CreateInstanceConfigurationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, instanceConfiguration);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",instanceConfiguration=").append(String.valueOf(instanceConfiguration));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateInstanceConfigurationResponse)) {
            return false;
        }

        CreateInstanceConfigurationResponse other = (CreateInstanceConfigurationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.instanceConfiguration, other.instanceConfiguration);
    }
