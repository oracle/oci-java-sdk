...
public final class CreateVcnDetails
    ...
    public static class Builder {
         ...
         * assign the VCN a IPv6 /56 CIDR block.
         *
         * <p>You may skip having Oracle allocate the VCN a IPv6 /56 CIDR block by setting
         * isOracleGuaAllocationEnabled to {@code false}.
         *
