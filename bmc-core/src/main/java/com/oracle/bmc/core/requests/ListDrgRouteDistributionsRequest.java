...
public class ListDrgRouteDistributionsRequest
    ...
    /**
     * A filter that only returns resources that match the specified lifecycle state. The value is
     * case insensitive.
     */
    ...
    public static class Builder
        ...
        /**
         * A filter that only returns resources that match the specified lifecycle state. The value
         * is case insensitive.
         */
        ...
        public ListDrgRouteDistributionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDrgRouteDistributionsRequest(drgId, limit, page, displayName, sortBy,
