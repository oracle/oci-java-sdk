...
/**
 * A policy for automatically creating volume backups according to a recurring schedule. Has a set
 * of one or more schedules that control when and how backups are created.
 *
...
public final class VolumeBackupPolicy
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VolumeBackupPolicy model) {
