...
public class AttachComputeHostGroupHostResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private AttachComputeHostGroupHostResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(AttachComputeHostGroupHostResponse o) {
         ...
         */
        @Override
        public AttachComputeHostGroupHostResponse build() {
            return new AttachComputeHostGroupHostResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    location,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachComputeHostGroupHostResponse)) {
            return false;
        }

        AttachComputeHostGroupHostResponse other = (AttachComputeHostGroupHostResponse) o;
