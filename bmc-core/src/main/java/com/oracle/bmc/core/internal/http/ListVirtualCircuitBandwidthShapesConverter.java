...
public class ListVirtualCircuitBandwidthShapesConverter {
    ...
    public static Function<Response, ListVirtualCircuitBandwidthShapesResponse> fromResponse() {
        final Function<Response, ListVirtualCircuitBandwidthShapesResponse> transformer =
                new Function<Response, ListVirtualCircuitBandwidthShapesResponse>() {
                    @Override
                    public ListVirtualCircuitBandwidthShapesResponse apply(Response rawResponse) {
                        LOG.trace(
                                "Transform function invoked for ListVirtualCircuitBandwidthShapesResponse");
                        Function<Response, WithHeaders<List<VirtualCircuitBandwidthShape>>>
                                responseFn =
                                        RESPONSE_CONVERSION_FACTORY.create(
                                                new GenericType<
                                                        List<VirtualCircuitBandwidthShape>>() {});

                        WithHeaders<List<VirtualCircuitBandwidthShape>> response =
