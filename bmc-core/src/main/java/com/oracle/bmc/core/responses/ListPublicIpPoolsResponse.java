...
public class ListPublicIpPoolsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.PublicIpPoolCollection getPublicIpPoolCollection() {
        return publicIpPoolCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListPublicIpPoolsResponse> {
         ...
         * @return this builder
         */
        public Builder publicIpPoolCollection(
                com.oracle.bmc.core.model.PublicIpPoolCollection publicIpPoolCollection) {
            this.publicIpPoolCollection = publicIpPoolCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",publicIpPoolCollection=").append(String.valueOf(publicIpPoolCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPublicIpPoolsResponse)) {
            return false;
        }

        ListPublicIpPoolsResponse other = (ListPublicIpPoolsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.publicIpPoolCollection, other.publicIpPoolCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.publicIpPoolCollection == null
                                ? 43
                                : this.publicIpPoolCollection.hashCode());
        return result;
    }
}
