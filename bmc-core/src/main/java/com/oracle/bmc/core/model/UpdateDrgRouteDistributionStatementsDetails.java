...
public final class UpdateDrgRouteDistributionStatementsDetails {
    ...
    public static class Builder {
        ...
        public UpdateDrgRouteDistributionStatementsDetails build() {
            UpdateDrgRouteDistributionStatementsDetails __instance__ =
                    new UpdateDrgRouteDistributionStatementsDetails(statements);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrgRouteDistributionStatementsDetails o) {
