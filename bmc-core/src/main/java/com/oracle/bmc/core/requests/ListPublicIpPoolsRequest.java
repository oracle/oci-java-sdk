 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPublicIpPoolsRequest.
 */
...
public class ListPublicIpPoolsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListPublicIpPoolsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPublicIpPoolsRequest(compartmentId, opcRequestId, limit, page, displayName,
            // byoipRangeId, sortBy, sortOrder);
        }
    }
