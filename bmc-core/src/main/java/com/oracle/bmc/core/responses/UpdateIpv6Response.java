...
public class UpdateIpv6Response extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateIpv6Response> {
         ...
         */
        @Override
        public Builder copy(UpdateIpv6Response o) {
        ...
        public UpdateIpv6Response build() {
            return new UpdateIpv6Response(__httpStatusCode__, headers, etag, opcRequestId, ipv6);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIpv6Response)) {
            return false;
        }

        UpdateIpv6Response other = (UpdateIpv6Response) o;
