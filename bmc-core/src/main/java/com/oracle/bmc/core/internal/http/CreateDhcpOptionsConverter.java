...
@Slf4j
public class CreateDhcpOptionsConverter {
    ...
    public static Invocation.Builder fromRequest(
        ...
        WebTarget target = client.getBaseTarget().path("/20160918").path("dhcps");
    ...
    public static Function<Response, CreateDhcpOptionsResponse> fromResponse() {
        final Function<Response, CreateDhcpOptionsResponse> transformer =
                new Function<Response, CreateDhcpOptionsResponse>() {
                    @Override
                    public CreateDhcpOptionsResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateDhcpOptionsResponse");
