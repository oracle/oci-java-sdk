...
public class UpdateImageConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, UpdateImageRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdateImageResponse> fromResponse() {
        final Function<Response, UpdateImageResponse> transformer =
                new Function<Response, UpdateImageResponse>() {
                    @Override
                    public UpdateImageResponse apply(Response rawResponse) {
