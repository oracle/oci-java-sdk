 ...
 * cluster](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/compute-clusters.htm), which is
 * a remote direct memory access (RDMA) network group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateComputeClusterDetails.Builder.class)
...
public final class UpdateComputeClusterDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateComputeClusterDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateComputeClusterDetails)) {
            return false;
        }

        UpdateComputeClusterDetails other = (UpdateComputeClusterDetails) o;
