...
public class DeleteCpeConverter {
    ...
    public static Function<Response, DeleteCpeResponse> fromResponse() {
        final Function<Response, DeleteCpeResponse> transformer =
                new Function<Response, DeleteCpeResponse>() {
                    @Override
                    public DeleteCpeResponse apply(Response rawResponse) {
