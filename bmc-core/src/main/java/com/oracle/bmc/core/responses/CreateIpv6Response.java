...
public class CreateIpv6Response extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateIpv6Response> {
        ...
        public CreateIpv6Response build() {
            return new CreateIpv6Response(__httpStatusCode__, headers, etag, opcRequestId, ipv6);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIpv6Response)) {
            return false;
        }

        CreateIpv6Response other = (CreateIpv6Response) o;
