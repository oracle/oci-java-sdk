...
public class DrgRedundancyStatus {
    ...
    public static class Builder {
        ...
        public DrgRedundancyStatus build() {
            DrgRedundancyStatus __instance__ = new DrgRedundancyStatus(id, status);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DrgRedundancyStatus o) {
            Builder copiedBuilder = id(o.getId()).status(o.getStatus());
