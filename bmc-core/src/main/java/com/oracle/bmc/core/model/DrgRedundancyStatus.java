...
/**
 * The redundancy status of the DRG. For more information, see [Redundancy
 * Remedies](https://docs.oracle.com/iaas/Content/Network/Troubleshoot/drgredundancy.htm). <br>
