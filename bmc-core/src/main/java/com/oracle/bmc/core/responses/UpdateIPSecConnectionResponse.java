...
public class UpdateIPSecConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateIPSecConnectionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateIPSecConnectionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateIPSecConnectionResponse o) {
        ...
        public UpdateIPSecConnectionResponse build() {
            return new UpdateIPSecConnectionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIPSecConnectionResponse)) {
            return false;
        }

        UpdateIPSecConnectionResponse other = (UpdateIPSecConnectionResponse) o;
