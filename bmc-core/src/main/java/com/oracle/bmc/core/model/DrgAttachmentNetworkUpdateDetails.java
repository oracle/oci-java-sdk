...
public class DrgAttachmentNetworkUpdateDetails
    ...
    protected DrgAttachmentNetworkUpdateDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrgAttachmentNetworkUpdateDetails)) {
            return false;
        }

        DrgAttachmentNetworkUpdateDetails other = (DrgAttachmentNetworkUpdateDetails) o;
