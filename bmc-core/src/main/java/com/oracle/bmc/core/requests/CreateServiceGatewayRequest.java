...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateServiceGatewayExample.java.html">here</a> to see how to use CreateServiceGatewayRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
@lombok.Builder(builderClassName = "Builder", buildMethodName = "buildWithoutInvocationCallback")
@lombok.Getter
public class CreateServiceGatewayRequest
        extends com.oracle.bmc.requests.BmcRequest<CreateServiceGatewayDetails> {

    /**
     * Details for creating a service gateway.
     */
    private CreateServiceGatewayDetails createServiceGatewayDetails;
    ...
    public CreateServiceGatewayDetails getBody$() {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(CreateServiceGatewayDetails body) {
