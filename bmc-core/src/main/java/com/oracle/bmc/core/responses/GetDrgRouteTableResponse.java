...
public class GetDrgRouteTableResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDrgRouteTableResponse> {
         ...
         */
        @Override
        public Builder copy(GetDrgRouteTableResponse o) {
         ...
         */
        @Override
        public GetDrgRouteTableResponse build() {
            return new GetDrgRouteTableResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDrgRouteTableResponse)) {
            return false;
        }

        GetDrgRouteTableResponse other = (GetDrgRouteTableResponse) o;
