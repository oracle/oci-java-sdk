...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeInstanceCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeInstanceCompartmentRequest.
 */
...
public class ChangeInstanceCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeInstanceCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeInstanceCompartmentRequest(instanceId, changeInstanceCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
