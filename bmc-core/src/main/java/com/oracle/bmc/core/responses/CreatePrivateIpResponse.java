...
public class CreatePrivateIpResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreatePrivateIpResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreatePrivateIpResponse> {
        ...
        public CreatePrivateIpResponse build() {
            return new CreatePrivateIpResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePrivateIpResponse)) {
            return false;
        }

        CreatePrivateIpResponse other = (CreatePrivateIpResponse) o;
