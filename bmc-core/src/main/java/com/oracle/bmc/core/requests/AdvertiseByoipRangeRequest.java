...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/AdvertiseByoipRangeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AdvertiseByoipRangeRequest.
 */
...
public class AdvertiseByoipRangeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    AdvertiseByoipRangeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(AdvertiseByoipRangeRequest o) {
         ...
         *
         * @return instance of AdvertiseByoipRangeRequest
         */
        public AdvertiseByoipRangeRequest build() {
            AdvertiseByoipRangeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AdvertiseByoipRangeRequest
         */
        public AdvertiseByoipRangeRequest buildWithoutInvocationCallback() {
            AdvertiseByoipRangeRequest request = new AdvertiseByoipRangeRequest();
            request.byoipRangeId = byoipRangeId;
            request.opcRequestId = opcRequestId;
            return request;
            // new AdvertiseByoipRangeRequest(byoipRangeId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvertiseByoipRangeRequest)) {
            return false;
        }

        AdvertiseByoipRangeRequest other = (AdvertiseByoipRangeRequest) o;
