...
public class CreateAppCatalogSubscriptionResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.AppCatalogSubscription getAppCatalogSubscription() {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder appCatalogSubscription(
                com.oracle.bmc.core.model.AppCatalogSubscription appCatalogSubscription) {
            this.appCatalogSubscription = appCatalogSubscription;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",appCatalogSubscription=").append(String.valueOf(appCatalogSubscription));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAppCatalogSubscriptionResponse)) {
            return false;
        }

        CreateAppCatalogSubscriptionResponse other = (CreateAppCatalogSubscriptionResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.appCatalogSubscription, other.appCatalogSubscription);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.appCatalogSubscription == null
                                ? 43
                                : this.appCatalogSubscription.hashCode());
        return result;
    }
}
