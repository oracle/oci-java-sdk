...
public class CreateDrgRouteTableResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateDrgRouteTableResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDrgRouteTableResponse> {
         ...
         */
        @Override
        public Builder copy(CreateDrgRouteTableResponse o) {
         ...
         */
        @Override
        public CreateDrgRouteTableResponse build() {
            return new CreateDrgRouteTableResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrgRouteTableResponse)) {
            return false;
        }

        CreateDrgRouteTableResponse other = (CreateDrgRouteTableResponse) o;
