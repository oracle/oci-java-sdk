...
public final class InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig build() {
            InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig model =
    ...
    public boolean equals(Object o) {
        ...
        InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig other =
                (InstanceConfigurationAmdMilanBmLaunchInstancePlatformConfig) o;
