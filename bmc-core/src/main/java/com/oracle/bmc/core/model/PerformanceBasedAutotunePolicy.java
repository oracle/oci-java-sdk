...
public final class PerformanceBasedAutotunePolicy extends AutotunePolicy {
    ...
    public static class Builder {
        ...
        public PerformanceBasedAutotunePolicy build() {
            PerformanceBasedAutotunePolicy model =
                    new PerformanceBasedAutotunePolicy(this.maxVpusPerGB);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PerformanceBasedAutotunePolicy model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PerformanceBasedAutotunePolicy(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PerformanceBasedAutotunePolicy)) {
            return false;
        }

        PerformanceBasedAutotunePolicy other = (PerformanceBasedAutotunePolicy) o;
