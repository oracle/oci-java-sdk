...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceConfigurationGpuMemoryClusterScaleConfig.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InstanceConfigurationGpuMemoryClusterScaleConfig
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"isUpsizeEnabled", "isDownsizeEnabled", "targetSize"})
    public InstanceConfigurationGpuMemoryClusterScaleConfig(
    ...
    public static class Builder {
        ...
        public InstanceConfigurationGpuMemoryClusterScaleConfig build() {
            InstanceConfigurationGpuMemoryClusterScaleConfig model =
                    new InstanceConfigurationGpuMemoryClusterScaleConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationGpuMemoryClusterScaleConfig model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationGpuMemoryClusterScaleConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationGpuMemoryClusterScaleConfig)) {
            return false;
        }

        InstanceConfigurationGpuMemoryClusterScaleConfig other =
                (InstanceConfigurationGpuMemoryClusterScaleConfig) o;
