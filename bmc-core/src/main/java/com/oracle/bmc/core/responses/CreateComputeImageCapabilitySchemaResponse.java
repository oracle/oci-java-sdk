...
public class CreateComputeImageCapabilitySchemaResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateComputeImageCapabilitySchemaResponse)) {
            return false;
        }

        CreateComputeImageCapabilitySchemaResponse other =
                (CreateComputeImageCapabilitySchemaResponse) o;
