...
/**
 * Specifies the properties for updating maintenance due date. <br>
...
public final class UpdateInstanceMaintenanceEventDetails
    ...
    public static class Builder {
         ...
         *
         * <p>The timeWindowEnd is automatically calculated based on the maintenanceReason and the
         * instanceAction.
         */
         ...
         *
         * <p>For Instances that have local storage, this must be set to true to verify that the
         * local storage will be deleted during the migration. For instances without, this parameter
         * has no effect.
         *
         * <p>In cases where the local storage will be lost, this parameter must be set or the
         * request will fail.
         */
     ...
     * This field is only applicable when setting the alternativeResolutionAction.
     *
     * <p>For Instances that have local storage, this must be set to true to verify that the local
     * storage will be deleted during the migration. For instances without, this parameter has no
     * effect.
     *
     * <p>In cases where the local storage will be lost, this parameter must be set or the request
     * will fail.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("canDeleteLocalStorage")
