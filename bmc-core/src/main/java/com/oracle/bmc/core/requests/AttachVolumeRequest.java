...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/AttachVolumeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachVolumeRequest.
 */
...
public class AttachVolumeRequest
    ...
    public static class Builder
        ...
        public Builder attachVolumeDetails(
                com.oracle.bmc.core.model.AttachVolumeDetails attachVolumeDetails) {
         ...
         *
         * @return instance of AttachVolumeRequest
         */
        public AttachVolumeRequest build() {
            AttachVolumeRequest request = buildWithoutInvocationCallback();
        ...
        public AttachVolumeRequest buildWithoutInvocationCallback() {
            ...
            request.attachVolumeDetails = attachVolumeDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new AttachVolumeRequest(attachVolumeDetails, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachVolumeRequest)) {
            return false;
        }

        AttachVolumeRequest other = (AttachVolumeRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.attachVolumeDetails, other.attachVolumeDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.attachVolumeDetails == null
                                ? 43
                                : this.attachVolumeDetails.hashCode());
        result =
                (result * PRIME)
