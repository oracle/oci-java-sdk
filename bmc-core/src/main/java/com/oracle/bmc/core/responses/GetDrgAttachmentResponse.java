...
public class GetDrgAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDrgAttachmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDrgAttachmentResponse)) {
            return false;
        }

        GetDrgAttachmentResponse other = (GetDrgAttachmentResponse) o;
