...
public final class CreateDhcpDetails
    ...
    public static class Builder {
         ...
         * compartment to contain the set of DHCP options.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDhcpDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDhcpDetails)) {
            return false;
        }

        CreateDhcpDetails other = (CreateDhcpDetails) o;
