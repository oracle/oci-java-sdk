...
public final class UpdatePublicIpDetails {
    @Deprecated
    @java.beans.ConstructorProperties({"definedTags", "displayName", "freeformTags", "privateIpId"})
    public UpdatePublicIpDetails(
    ...
    public static class Builder {
        ...
        public UpdatePublicIpDetails build() {
            UpdatePublicIpDetails __instance__ =
                    new UpdatePublicIpDetails(definedTags, displayName, freeformTags, privateIpId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePublicIpDetails o) {
    ...
    public String toString() {
        ...
        sb.append("UpdatePublicIpDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePublicIpDetails)) {
            return false;
        }

        UpdatePublicIpDetails other = (UpdatePublicIpDetails) o;
