...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeCaptureFilterCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCaptureFilterCompartmentRequest.
 */
...
public class ChangeCaptureFilterCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeCaptureFilterCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeCaptureFilterCompartmentRequest(captureFilterId, changeCaptureFilterCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
