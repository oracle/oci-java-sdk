...
/**
 * The data to update an instance pool within a cluster network. <br>
...
public final class UpdateClusterNetworkInstancePoolDetails
    ...
    public UpdateClusterNetworkInstancePoolDetails(
            String id,
    ...
    public static class Builder {
        ...
        public UpdateClusterNetworkInstancePoolDetails build() {
            UpdateClusterNetworkInstancePoolDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateClusterNetworkInstancePoolDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateClusterNetworkInstancePoolDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateClusterNetworkInstancePoolDetails)) {
            return false;
        }

        UpdateClusterNetworkInstancePoolDetails other = (UpdateClusterNetworkInstancePoolDetails) o;
