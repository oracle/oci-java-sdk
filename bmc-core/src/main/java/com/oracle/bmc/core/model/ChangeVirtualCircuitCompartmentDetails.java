...
public class ChangeVirtualCircuitCompartmentDetails {
    ...
    public static class Builder {
        ...
        public ChangeVirtualCircuitCompartmentDetails build() {
            ChangeVirtualCircuitCompartmentDetails __instance__ =
                    new ChangeVirtualCircuitCompartmentDetails(compartmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeVirtualCircuitCompartmentDetails o) {
