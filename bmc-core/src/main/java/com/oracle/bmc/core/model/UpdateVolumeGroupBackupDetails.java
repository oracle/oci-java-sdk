...
public final class UpdateVolumeGroupBackupDetails {
    ...
    public static class Builder {
        ...
        public UpdateVolumeGroupBackupDetails build() {
            UpdateVolumeGroupBackupDetails __instance__ =
                    new UpdateVolumeGroupBackupDetails(definedTags, displayName, freeformTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVolumeGroupBackupDetails o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVolumeGroupBackupDetails)) {
            return false;
        }

        UpdateVolumeGroupBackupDetails other = (UpdateVolumeGroupBackupDetails) o;
