...
/**
 * A point-in-time copy of a volume that can then be used to create a new block volume or recover a
 * block volume. For more information, see [Overview of Cloud Volume
...
public final class VolumeBackup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The size of the volume in MBs. The value must be a multiple of 1024. This field is
        ...
        /**
         * The date and time the volume backup was created. This is the time the actual
        ...
        /**
         * The date and time the request to create the volume backup was received. Format defined by
         * [RFC3339]https://tools.ietf.org/html/rfc3339.
         */
         ...
         * the space consumed on the volume and whether the backup is full or incremental.
         */
        ...
        /**
         * The size used by the backup, in MBs. It is typically smaller than sizeInMBs, depending on
         * the space consumed on the volume and whether the backup is full or incremental. This
         * field is deprecated. Please use uniqueSizeInGBs.
         */
    ...
    /**
     * The date and time the volume backup was created. This is the time the actual point-in-time
     * image of the volume data was taken. Format defined by
     * [RFC3339](https://tools.ietf.org/html/rfc3339).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeCreated")
    ...
    /**
     * The size used by the backup, in MBs. It is typically smaller than sizeInMBs, depending on the
     * space consumed on the volume and whether the backup is full or incremental. This field is
     * deprecated. Please use uniqueSizeInGBs.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("uniqueSizeInMbs")
