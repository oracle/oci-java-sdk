...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeleteNetworkSecurityGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNetworkSecurityGroupRequest.
 */
...
public class DeleteNetworkSecurityGroupRequest
    ...
    public static class Builder
        ...
        public DeleteNetworkSecurityGroupRequest build() {
            DeleteNetworkSecurityGroupRequest request = buildWithoutInvocationCallback();
