...
public class CreateVolumeGroupBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeGroupBackupResponse)) {
            return false;
        }

        CreateVolumeGroupBackupResponse other = (CreateVolumeGroupBackupResponse) o;
