...
public final class AttachEmulatedVolumeDetails extends AttachVolumeDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachEmulatedVolumeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AttachEmulatedVolumeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachEmulatedVolumeDetails)) {
            return false;
        }

        AttachEmulatedVolumeDetails other = (AttachEmulatedVolumeDetails) o;
