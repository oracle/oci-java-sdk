...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ListIPSecConnectionTunnelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListIPSecConnectionTunnelsRequest.
 */
...
public class ListIPSecConnectionTunnelsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListIPSecConnectionTunnelsRequest, java.lang.Void> {
        ...
        public ListIPSecConnectionTunnelsRequest buildWithoutInvocationCallback() {
            ListIPSecConnectionTunnelsRequest request = new ListIPSecConnectionTunnelsRequest();
            request.ipscId = ipscId;
            request.limit = limit;
            request.page = page;
            return request;
            // new ListIPSecConnectionTunnelsRequest(ipscId, limit, page);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().ipscId(ipscId).limit(limit).page(page);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIPSecConnectionTunnelsRequest)) {
            return false;
        }

        ListIPSecConnectionTunnelsRequest other = (ListIPSecConnectionTunnelsRequest) o;
