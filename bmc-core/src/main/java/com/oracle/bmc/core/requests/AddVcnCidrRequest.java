 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use AddVcnCidrRequest.
 */
...
public class AddVcnCidrRequest
    ...
    public static class Builder
        ...
        public AddVcnCidrRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddVcnCidrRequest(vcnId, addVcnCidrDetails, opcRequestId, opcRetryToken,
            // ifMatch);
        }
    }
