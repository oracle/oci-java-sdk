...
/**
 * Defines the representation of a virtual network topology for a region. See [Network Visualizer
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NetworkingTopology.Builder.class)
...
public final class NetworkingTopology extends Topology {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkingTopology model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkingTopology)) {
            return false;
        }

        NetworkingTopology other = (NetworkingTopology) o;
