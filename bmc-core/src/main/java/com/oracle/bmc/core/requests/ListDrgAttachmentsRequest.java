...
public class ListDrgAttachmentsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the resource (virtual circuit, VCN, IPSec tunnel, or remote peering connection) attached to
     * the DRG.
     */
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the DRG route table assigned to the DRG attachment.
     */
    ...
    public static class Builder
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the resource (virtual circuit, VCN, IPSec tunnel, or remote peering connection)
         * attached to the DRG.
         */
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the DRG route table assigned to the DRG attachment.
         */
