...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetIPSecConnectionTunnelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetIPSecConnectionTunnelRequest.
 */
...
public class GetIPSecConnectionTunnelRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetIPSecConnectionTunnelRequest, java.lang.Void> {
        ...
        public GetIPSecConnectionTunnelRequest buildWithoutInvocationCallback() {
            GetIPSecConnectionTunnelRequest request = new GetIPSecConnectionTunnelRequest();
            request.ipscId = ipscId;
            request.tunnelId = tunnelId;
            return request;
            // new GetIPSecConnectionTunnelRequest(ipscId, tunnelId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIPSecConnectionTunnelRequest)) {
            return false;
        }

        GetIPSecConnectionTunnelRequest other = (GetIPSecConnectionTunnelRequest) o;
