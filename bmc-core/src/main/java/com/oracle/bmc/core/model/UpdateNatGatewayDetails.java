...
public final class UpdateNatGatewayDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateNatGatewayDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNatGatewayDetails)) {
            return false;
        }

        UpdateNatGatewayDetails other = (UpdateNatGatewayDetails) o;
