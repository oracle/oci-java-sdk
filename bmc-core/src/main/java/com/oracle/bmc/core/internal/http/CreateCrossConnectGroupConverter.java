...
public class CreateCrossConnectGroupConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, CreateCrossConnectGroupRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateCrossConnectGroupResponse> fromResponse() {
        final Function<Response, CreateCrossConnectGroupResponse> transformer =
                new Function<Response, CreateCrossConnectGroupResponse>() {
                    @Override
                    public CreateCrossConnectGroupResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for CreateCrossConnectGroupResponse");
