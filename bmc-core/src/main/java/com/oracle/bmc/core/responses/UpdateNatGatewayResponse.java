...
public class UpdateNatGatewayResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateNatGatewayResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateNatGatewayResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateNatGatewayResponse o) {
        ...
        public UpdateNatGatewayResponse build() {
            return new UpdateNatGatewayResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, natGateway);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNatGatewayResponse)) {
            return false;
        }

        UpdateNatGatewayResponse other = (UpdateNatGatewayResponse) o;
