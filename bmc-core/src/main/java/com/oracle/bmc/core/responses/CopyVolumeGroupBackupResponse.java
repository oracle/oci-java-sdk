...
public class CopyVolumeGroupBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CopyVolumeGroupBackupResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CopyVolumeGroupBackupResponse> {
         ...
         */
        @Override
        public CopyVolumeGroupBackupResponse build() {
            return new CopyVolumeGroupBackupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, volumeGroupBackup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyVolumeGroupBackupResponse)) {
            return false;
        }

        CopyVolumeGroupBackupResponse other = (CopyVolumeGroupBackupResponse) o;
