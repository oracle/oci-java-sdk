...
public class DeleteVolumeBackupPolicyAssignmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVolumeBackupPolicyAssignmentResponse)) {
            return false;
        }

        DeleteVolumeBackupPolicyAssignmentResponse other =
                (DeleteVolumeBackupPolicyAssignmentResponse) o;
