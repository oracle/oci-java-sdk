...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateVolumeBackupPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateVolumeBackupPolicyRequest.
 */
...
public class UpdateVolumeBackupPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateVolumeBackupPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateVolumeBackupPolicyRequest(policyId, updateVolumeBackupPolicyDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
