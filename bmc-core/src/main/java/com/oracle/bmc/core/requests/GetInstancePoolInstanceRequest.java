...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetInstancePoolInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetInstancePoolInstanceRequest.
 */
...
public class GetInstancePoolInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetInstancePoolInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetInstancePoolInstanceRequest o) {
         ...
         */
        public GetInstancePoolInstanceRequest build() {
            GetInstancePoolInstanceRequest request = buildWithoutInvocationCallback();
