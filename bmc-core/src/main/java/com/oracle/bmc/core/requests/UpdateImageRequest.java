...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateImageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateImageRequest.
 */
...
public class UpdateImageRequest
     ...
     *
     */
    public com.oracle.bmc.core.model.UpdateImageDetails getUpdateImageDetails() {
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.core.model.UpdateImageDetails updateImageDetails = null;

        /**
         * Updates the image display name field. Avoid entering confidential information.
         *
         * @param updateImageDetails the value to set
         * @return this builder instance
         */
        public Builder updateImageDetails(
                com.oracle.bmc.core.model.UpdateImageDetails updateImageDetails) {
        ...
        public UpdateImageRequest buildWithoutInvocationCallback() {
            ...
            request.updateImageDetails = updateImageDetails;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateImageRequest(imageId, updateImageDetails, opcRetryToken, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateImageDetails=").append(String.valueOf(this.updateImageDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.updateImageDetails, other.updateImageDetails)
        ...
        result =
                (result * PRIME)
                        + (this.updateImageDetails == null
                                ? 43
                                : this.updateImageDetails.hashCode());
        result =
                (result * PRIME)
