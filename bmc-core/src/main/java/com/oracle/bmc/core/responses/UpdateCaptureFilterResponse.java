...
public class UpdateCaptureFilterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateCaptureFilterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateCaptureFilterResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateCaptureFilterResponse o) {
         ...
         */
        @Override
        public UpdateCaptureFilterResponse build() {
            return new UpdateCaptureFilterResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, captureFilter);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCaptureFilterResponse)) {
            return false;
        }

        UpdateCaptureFilterResponse other = (UpdateCaptureFilterResponse) o;
