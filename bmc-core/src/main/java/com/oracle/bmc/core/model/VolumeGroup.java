...
/**
 * Specifies a volume group which is a collection of volumes. For more information, see [Volume
...
public final class VolumeGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The date and time the volume group was created. Format defined by
    ...
    /**
     * Specifies whether the newly created cloned volume group's data has finished copying from the
