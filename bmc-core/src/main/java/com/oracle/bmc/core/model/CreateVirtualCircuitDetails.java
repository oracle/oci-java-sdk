...
public final class CreateVirtualCircuitDetails
    ...
    public static class Builder {
        ...
        /**
         * The service key name or activation key offered by the provider (if the customer is
    ...
    /**
     * The service key name or activation key offered by the provider (if the customer is connecting
     * via a provider).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("providerServiceKeyName")
