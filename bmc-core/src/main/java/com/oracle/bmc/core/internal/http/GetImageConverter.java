...
public class GetImageConverter {
    ...
    public static Invocation.Builder fromRequest(RestClient client, GetImageRequest request) {
        if (request == null) {
    ...
    public static Function<Response, GetImageResponse> fromResponse() {
        final Function<Response, GetImageResponse> transformer =
                new Function<Response, GetImageResponse>() {
                    @Override
                    public GetImageResponse apply(Response rawResponse) {
