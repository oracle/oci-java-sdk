...
public class GetByoasnResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetByoasnResponse> {
         ...
         */
        @Override
        public Builder copy(GetByoasnResponse o) {
         ...
         */
        @Override
        public GetByoasnResponse build() {
            return new GetByoasnResponse(__httpStatusCode__, headers, etag, opcRequestId, byoasn);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetByoasnResponse)) {
            return false;
        }

        GetByoasnResponse other = (GetByoasnResponse) o;
