...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateBootVolumeBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBootVolumeBackupRequest.
 */
...
public class UpdateBootVolumeBackupRequest
    ...
    public com.oracle.bmc.core.model.UpdateBootVolumeBackupDetails getBody$() {
        return updateBootVolumeBackupDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateBootVolumeBackupDetails(
                com.oracle.bmc.core.model.UpdateBootVolumeBackupDetails
        ...
        public Builder copy(UpdateBootVolumeBackupRequest o) {
            ...
            updateBootVolumeBackupDetails(o.getUpdateBootVolumeBackupDetails());
         ...
         */
        public UpdateBootVolumeBackupRequest build() {
            UpdateBootVolumeBackupRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.core.model.UpdateBootVolumeBackupDetails body) {
            updateBootVolumeBackupDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateBootVolumeBackupRequest
         */
        public UpdateBootVolumeBackupRequest buildWithoutInvocationCallback() {
            UpdateBootVolumeBackupRequest request = new UpdateBootVolumeBackupRequest();
    ...
    public String toString() {
        ...
        sb.append(",updateBootVolumeBackupDetails=")
                .append(String.valueOf(this.updateBootVolumeBackupDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBootVolumeBackupRequest)) {
            return false;
        }

        UpdateBootVolumeBackupRequest other = (UpdateBootVolumeBackupRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.bootVolumeBackupId, other.bootVolumeBackupId)
                && java.util.Objects.equals(
                        this.updateBootVolumeBackupDetails, other.updateBootVolumeBackupDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateBootVolumeBackupDetails == null
                                ? 43
                                : this.updateBootVolumeBackupDetails.hashCode());
