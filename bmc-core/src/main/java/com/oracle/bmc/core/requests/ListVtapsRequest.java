 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVtapsRequest.
 */
...
public class ListVtapsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     *
     * <p>When {@code FALSE}, lists ALL running and stopped VTAPs. * When {@code TRUE}, lists only
     * running VTAPs (VTAPs where isVtapEnabled = {@code TRUE}).
     */
    ...
    public static class Builder
         ...
         * Indicates whether to list all VTAPs or only running VTAPs.
         *
         * <p>When {@code FALSE}, lists ALL running and stopped VTAPs. * When {@code TRUE}, lists
         * only running VTAPs (VTAPs where isVtapEnabled = {@code TRUE}).
         */
         ...
         * @return this builder instance
         */
        public Builder copy(ListVtapsRequest o) {
        ...
        public ListVtapsRequest build() {
            ListVtapsRequest request = buildWithoutInvocationCallback();
        ...
        public ListVtapsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListVtapsRequest(compartmentId, vcnId, source, targetId, targetIp, isVtapEnabled,
            // limit, page, opcRequestId, sortBy, sortOrder, displayName, lifecycleState);
        }
    }
