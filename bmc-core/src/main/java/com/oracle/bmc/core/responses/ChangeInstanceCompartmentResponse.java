...
public class ChangeInstanceCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeInstanceCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeInstanceCompartmentResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeInstanceCompartmentResponse)) {
            return false;
        }

        ChangeInstanceCompartmentResponse other = (ChangeInstanceCompartmentResponse) o;
