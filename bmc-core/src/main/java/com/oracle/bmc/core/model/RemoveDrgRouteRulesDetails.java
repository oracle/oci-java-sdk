...
public final class RemoveDrgRouteRulesDetails {
    ...
    public static class Builder {
        ...
        public RemoveDrgRouteRulesDetails build() {
            RemoveDrgRouteRulesDetails __instance__ = new RemoveDrgRouteRulesDetails(routeRuleIds);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveDrgRouteRulesDetails o) {
            Builder copiedBuilder = routeRuleIds(o.getRouteRuleIds());
