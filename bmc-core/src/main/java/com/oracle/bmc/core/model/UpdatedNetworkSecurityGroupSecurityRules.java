...
public final class UpdatedNetworkSecurityGroupSecurityRules {
    @Deprecated
    @java.beans.ConstructorProperties({"securityRules"})
    public UpdatedNetworkSecurityGroupSecurityRules(java.util.List<SecurityRule> securityRules) {
        super();
    ...
    public static class Builder {
        ...
        public UpdatedNetworkSecurityGroupSecurityRules build() {
            UpdatedNetworkSecurityGroupSecurityRules __instance__ =
                    new UpdatedNetworkSecurityGroupSecurityRules(securityRules);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatedNetworkSecurityGroupSecurityRules o) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatedNetworkSecurityGroupSecurityRules(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatedNetworkSecurityGroupSecurityRules)) {
            return false;
        }

        UpdatedNetworkSecurityGroupSecurityRules other =
                (UpdatedNetworkSecurityGroupSecurityRules) o;
