 ...
 * instance boots, such as kernel and BIOS messages, and is useful for checking the status of the
 * instance or diagnosing problems. The console data is minimally formatted ASCII text.
 *
...
public final class ConsoleHistory
    ...
    public static class Builder {
        ...
        /**
         * The date and time the history was created, in the format defined by
