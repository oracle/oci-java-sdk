...
public final class ShapeTrustedPlatformModuleOptions {
    ...
    public static class Builder {
        ...
        public ShapeTrustedPlatformModuleOptions build() {
            ShapeTrustedPlatformModuleOptions __instance__ =
                    new ShapeTrustedPlatformModuleOptions(allowedValues, isDefaultEnabled);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShapeTrustedPlatformModuleOptions o) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ShapeTrustedPlatformModuleOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShapeTrustedPlatformModuleOptions)) {
            return false;
        }

        ShapeTrustedPlatformModuleOptions other = (ShapeTrustedPlatformModuleOptions) o;
