...
public class CreateInstanceConsoleConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code InstanceConsoleConnection} instance. */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateInstanceConsoleConnectionResponse)) {
            return false;
        }

        CreateInstanceConsoleConnectionResponse other = (CreateInstanceConsoleConnectionResponse) o;
