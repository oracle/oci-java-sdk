 ...
 * BM.Standard2.52, BM.GPU2.2, BM.GPU3.8, or BM.DenseIO2.52 (the Intel Skylake platform). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IntelSkylakeBmPlatformConfig.Builder.class)
...
public final class IntelSkylakeBmPlatformConfig extends PlatformConfig {
    ...
    public static class Builder {
        ...
        public IntelSkylakeBmPlatformConfig build() {
            IntelSkylakeBmPlatformConfig model =
                    new IntelSkylakeBmPlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IntelSkylakeBmPlatformConfig model) {
    ...
    @Deprecated
    public IntelSkylakeBmPlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IntelSkylakeBmPlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntelSkylakeBmPlatformConfig)) {
            return false;
        }

        IntelSkylakeBmPlatformConfig other = (IntelSkylakeBmPlatformConfig) o;
