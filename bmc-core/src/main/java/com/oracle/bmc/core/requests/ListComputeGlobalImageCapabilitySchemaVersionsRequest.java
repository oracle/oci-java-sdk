...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ListComputeGlobalImageCapabilitySchemaVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListComputeGlobalImageCapabilitySchemaVersionsRequest.
 */
...
public class ListComputeGlobalImageCapabilitySchemaVersionsRequest
    ...
    public static class Builder
         ...
         * @return instance of ListComputeGlobalImageCapabilitySchemaVersionsRequest
         */
        public ListComputeGlobalImageCapabilitySchemaVersionsRequest
                buildWithoutInvocationCallback() {
            ListComputeGlobalImageCapabilitySchemaVersionsRequest request =
                    new ListComputeGlobalImageCapabilitySchemaVersionsRequest();
            ...
            return request;
            // new ListComputeGlobalImageCapabilitySchemaVersionsRequest(computeGlobalImageCapabilitySchemaId, displayName, limit, page, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListComputeGlobalImageCapabilitySchemaVersionsRequest)) {
            return false;
        }

        ListComputeGlobalImageCapabilitySchemaVersionsRequest other =
                (ListComputeGlobalImageCapabilitySchemaVersionsRequest) o;
