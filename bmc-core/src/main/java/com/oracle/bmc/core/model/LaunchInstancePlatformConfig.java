 ...
 * Instances](https://docs.cloud.oracle.com/iaas/Content/Compute/References/shielded-instances.htm).
 *
 * <p>For more information about BIOS settings for bare metal instances, see [BIOS Settings for Bare
 * Metal
 * Instances](https://docs.cloud.oracle.com/iaas/Content/Compute/References/bios-settings.htm). <br>
