...
@Slf4j
public class ListRouteTablesConverter {
    ...
    public static Function<Response, ListRouteTablesResponse> fromResponse() {
        final Function<Response, ListRouteTablesResponse> transformer =
                new Function<Response, ListRouteTablesResponse>() {
                    @Override
                    public ListRouteTablesResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for ListRouteTablesResponse");
                        Function<Response, WithHeaders<List<RouteTable>>> responseFn =
                                RESPONSE_CONVERSION_FACTORY.create(
                                        new GenericType<List<RouteTable>>() {});

                        WithHeaders<List<RouteTable>> response = responseFn.apply(rawResponse);
                        MultivaluedMap<String, String> headers = response.getHeaders();

                        ListRouteTablesResponse.Builder builder = ListRouteTablesResponse.builder();
