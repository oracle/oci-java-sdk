...
public class CheckHostConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CheckHostConfigurationResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<
                    CheckHostConfigurationResponse> {
         ...
         */
        @Override
        public Builder copy(CheckHostConfigurationResponse o) {
         ...
         */
        @Override
        public CheckHostConfigurationResponse build() {
            return new CheckHostConfigurationResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, location, computeHost);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CheckHostConfigurationResponse)) {
            return false;
        }

        CheckHostConfigurationResponse other = (CheckHostConfigurationResponse) o;
