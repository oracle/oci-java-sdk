...
public class GetCaptureFilterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetCaptureFilterResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetCaptureFilterResponse> {
         ...
         */
        @Override
        public Builder copy(GetCaptureFilterResponse o) {
         ...
         */
        @Override
        public GetCaptureFilterResponse build() {
            return new GetCaptureFilterResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCaptureFilterResponse)) {
            return false;
        }

        GetCaptureFilterResponse other = (GetCaptureFilterResponse) o;
