...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeComputeHostCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeComputeHostCompartmentRequest.
 */
...
public class ChangeComputeHostCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeComputeHostCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeComputeHostCompartmentRequest(computeHostId, changeComputeHostCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
