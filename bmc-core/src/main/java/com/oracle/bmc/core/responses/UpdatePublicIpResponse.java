...
public class UpdatePublicIpResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdatePublicIpResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdatePublicIpResponse> {
         ...
         */
        @Override
        public UpdatePublicIpResponse build() {
            return new UpdatePublicIpResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePublicIpResponse)) {
            return false;
        }

        UpdatePublicIpResponse other = (UpdatePublicIpResponse) o;
