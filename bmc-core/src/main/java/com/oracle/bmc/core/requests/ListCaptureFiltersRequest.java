 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCaptureFiltersRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class ListCaptureFiltersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only resources that match the given capture filter lifecycle state. The
     * state value is case-insensitive.
     */
    private com.oracle.bmc.core.model.CaptureFilter.LifecycleState lifecycleState;
    ...
    /**
     * A filter to only return resources that match the given capture {@code filterType}. The {@code
     * filterType} value is the string representation of enum - {@code VTAP}, {@code FLOWLOG}.
     */
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCaptureFiltersRequest, java.lang.Void> {
         ...
         */
        private com.oracle.bmc.core.model.CaptureFilter.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.core.model.CaptureFilter.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
            return this;
        }

        /**
         * A filter to only return resources that match the given capture {@code filterType}. The
         * {@code filterType} value is the string representation of enum - {@code VTAP}, {@code
         * FLOWLOG}.
         */
         ...
         * @return this builder instance
         */
        public Builder copy(ListCaptureFiltersRequest o) {
        ...
        /**
         * Build the instance of ListCaptureFiltersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCaptureFiltersRequest
         */
        public ListCaptureFiltersRequest build() {
            ListCaptureFiltersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCaptureFiltersRequest
         */
        public ListCaptureFiltersRequest buildWithoutInvocationCallback() {
            ListCaptureFiltersRequest request = new ListCaptureFiltersRequest();
            ...
            return request;
            // new ListCaptureFiltersRequest(compartmentId, limit, page, opcRequestId, sortBy,
            // sortOrder, displayName, lifecycleState, filterType);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCaptureFiltersRequest)) {
            return false;
        }

        ListCaptureFiltersRequest other = (ListCaptureFiltersRequest) o;
