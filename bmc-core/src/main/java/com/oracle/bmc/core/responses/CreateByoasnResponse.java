...
public class CreateByoasnResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateByoasnResponse> {
         ...
         */
        @Override
        public Builder copy(CreateByoasnResponse o) {
         ...
         */
        @Override
        public CreateByoasnResponse build() {
            return new CreateByoasnResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateByoasnResponse)) {
            return false;
        }

        CreateByoasnResponse other = (CreateByoasnResponse) o;
