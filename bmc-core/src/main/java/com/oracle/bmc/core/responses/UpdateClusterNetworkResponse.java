...
public class UpdateClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateClusterNetworkResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateClusterNetworkResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateClusterNetworkResponse o) {
         ...
         */
        @Override
        public UpdateClusterNetworkResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateClusterNetworkResponse)) {
            return false;
        }

        UpdateClusterNetworkResponse other = (UpdateClusterNetworkResponse) o;
