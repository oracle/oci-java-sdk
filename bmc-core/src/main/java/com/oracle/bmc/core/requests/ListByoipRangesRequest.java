 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListByoipRangesRequest.
 */
...
public class ListByoipRangesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListByoipRangesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListByoipRangesRequest(compartmentId, opcRequestId, limit, page, displayName,
            // lifecycleState, sortBy, sortOrder);
        }
    }
