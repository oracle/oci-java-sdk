...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ChangeIPSecConnectionCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeIPSecConnectionCompartmentRequest.
 */
...
public class ChangeIPSecConnectionCompartmentRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeIPSecConnectionCompartmentRequest o) {
            ipscId(o.getIpscId());
            changeIPSecConnectionCompartmentDetails(o.getChangeIPSecConnectionCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeIPSecConnectionCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeIPSecConnectionCompartmentRequest
         */
        public ChangeIPSecConnectionCompartmentRequest build() {
            ChangeIPSecConnectionCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        public ChangeIPSecConnectionCompartmentRequest buildWithoutInvocationCallback() {
            ChangeIPSecConnectionCompartmentRequest request =
                    new ChangeIPSecConnectionCompartmentRequest();
            request.ipscId = ipscId;
            request.changeIPSecConnectionCompartmentDetails =
                    changeIPSecConnectionCompartmentDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeIPSecConnectionCompartmentRequest(ipscId, changeIPSecConnectionCompartmentDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeIPSecConnectionCompartmentDetails=")
                .append(String.valueOf(this.changeIPSecConnectionCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeIPSecConnectionCompartmentRequest)) {
            return false;
        }

        ChangeIPSecConnectionCompartmentRequest other = (ChangeIPSecConnectionCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.ipscId, other.ipscId)
                && java.util.Objects.equals(
                        this.changeIPSecConnectionCompartmentDetails,
                        other.changeIPSecConnectionCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeIPSecConnectionCompartmentDetails == null
                                ? 43
                                : this.changeIPSecConnectionCompartmentDetails.hashCode());
