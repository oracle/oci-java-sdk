...
public class RemovePublicIpPoolCapacityResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.core.model.PublicIpPool getPublicIpPool() {
        return publicIpPool;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder publicIpPool(com.oracle.bmc.core.model.PublicIpPool publicIpPool) {
            this.publicIpPool = publicIpPool;
            return this;
        }
        ...
        public RemovePublicIpPoolCapacityResponse build() {
            return new RemovePublicIpPoolCapacityResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, publicIpPool);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",publicIpPool=").append(String.valueOf(publicIpPool));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePublicIpPoolCapacityResponse)) {
            return false;
        }

        RemovePublicIpPoolCapacityResponse other = (RemovePublicIpPoolCapacityResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.publicIpPool, other.publicIpPool);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.publicIpPool == null ? 43 : this.publicIpPool.hashCode());
        return result;
    }
}
