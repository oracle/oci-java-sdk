...
public final class CopyBootVolumeBackupDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"destinationRegion", "displayName", "kmsKeyId"})
    public CopyBootVolumeBackupDetails(
            String destinationRegion, String displayName, String kmsKeyId) {
        super();
    ...
    public static class Builder {
         ...
         * encryption key for the copied boot volume backup. If you do not specify this attribute
         * the boot volume backup will be encrypted with the Oracle-provided encryption key when it
        ...
        public CopyBootVolumeBackupDetails build() {
            CopyBootVolumeBackupDetails model =
                    new CopyBootVolumeBackupDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CopyBootVolumeBackupDetails model) {
    ...
    /**
     * The OCID of the Key Management key in the destination region which will be the master
     * encryption key for the copied boot volume backup. If you do not specify this attribute the
     * boot volume backup will be encrypted with the Oracle-provided encryption key when it is
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyBootVolumeBackupDetails)) {
            return false;
        }

        CopyBootVolumeBackupDetails other = (CopyBootVolumeBackupDetails) o;
