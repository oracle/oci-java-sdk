...
public final class CopyBootVolumeBackupDetails {
    ...
    public static class Builder {
        ...
        public CopyBootVolumeBackupDetails build() {
            CopyBootVolumeBackupDetails __instance__ =
                    new CopyBootVolumeBackupDetails(destinationRegion, displayName, kmsKeyId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CopyBootVolumeBackupDetails o) {
