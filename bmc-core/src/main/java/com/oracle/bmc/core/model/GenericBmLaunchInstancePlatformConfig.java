...
public final class GenericBmLaunchInstancePlatformConfig extends LaunchInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public GenericBmLaunchInstancePlatformConfig build() {
            GenericBmLaunchInstancePlatformConfig model =
                    new GenericBmLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenericBmLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public GenericBmLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GenericBmLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenericBmLaunchInstancePlatformConfig)) {
            return false;
        }

        GenericBmLaunchInstancePlatformConfig other = (GenericBmLaunchInstancePlatformConfig) o;
