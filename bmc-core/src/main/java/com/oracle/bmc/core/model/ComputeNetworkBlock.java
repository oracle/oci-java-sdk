...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ComputeNetworkBlock.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ComputeNetworkBlock extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ComputeNetworkBlock build() {
            ComputeNetworkBlock model =
                    new ComputeNetworkBlock(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeNetworkBlock model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeNetworkBlock)) {
            return false;
        }

        ComputeNetworkBlock other = (ComputeNetworkBlock) o;
