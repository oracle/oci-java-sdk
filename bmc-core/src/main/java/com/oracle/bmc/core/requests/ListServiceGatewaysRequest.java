 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListServiceGatewaysRequest.
 */
...
public class ListServiceGatewaysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListServiceGatewaysRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListServiceGatewaysRequest(compartmentId, vcnId, limit, page, sortBy, sortOrder,
            // lifecycleState);
        }
    }
