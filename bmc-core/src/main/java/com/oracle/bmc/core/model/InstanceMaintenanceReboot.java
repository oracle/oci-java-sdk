...
public final class InstanceMaintenanceReboot {
    ...
    public static class Builder {
        ...
        public InstanceMaintenanceReboot build() {
            InstanceMaintenanceReboot __instance__ =
                    new InstanceMaintenanceReboot(timeMaintenanceRebootDueMax);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceMaintenanceReboot o) {
            Builder copiedBuilder = timeMaintenanceRebootDueMax(o.getTimeMaintenanceRebootDueMax());
