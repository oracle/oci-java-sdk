...
/**
 * The customer facing object includes GPU memory fabric details. <br>
...
public final class ComputeGpuMemoryFabric
    ...
    public static class Builder {
        ...
        /**
         * Additional data that can be exposed to the customer. Right now it will include the switch
         * tray ids.
         */
    ...
    /** The health state of the GPU memory fabric */
    public enum FabricHealth implements com.oracle.bmc.http.internal.BmcEnum {
        Healthy("HEALTHY"),
        Unhealthy("UNHEALTHY"),
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for current
     * firmware bundle
     */
    @com.fasterxml.jackson.annotation.JsonProperty("currentFirmwareBundleId")
    ...
    /** The state of Memory Fabric Firmware update */
    public enum FirmwareUpdateState implements com.oracle.bmc.http.internal.BmcEnum {
