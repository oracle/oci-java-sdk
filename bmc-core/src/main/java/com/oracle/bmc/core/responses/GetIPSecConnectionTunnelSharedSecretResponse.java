...
public class GetIPSecConnectionTunnelSharedSecretResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIPSecConnectionTunnelSharedSecretResponse)) {
            return false;
        }

        GetIPSecConnectionTunnelSharedSecretResponse other =
                (GetIPSecConnectionTunnelSharedSecretResponse) o;
