...
public class UpdateDrgRouteTableResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDrgRouteTableResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrgRouteTableResponse)) {
            return false;
        }

        UpdateDrgRouteTableResponse other = (UpdateDrgRouteTableResponse) o;
