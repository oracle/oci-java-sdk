...
public class ChangeComputeImageCapabilitySchemaCompartmentResponse
    ...
    public static class Builder {
         ...
         */
        public ChangeComputeImageCapabilitySchemaCompartmentResponse build() {
            return new ChangeComputeImageCapabilitySchemaCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeComputeImageCapabilitySchemaCompartmentResponse)) {
            return false;
        }

        ChangeComputeImageCapabilitySchemaCompartmentResponse other =
                (ChangeComputeImageCapabilitySchemaCompartmentResponse) o;
