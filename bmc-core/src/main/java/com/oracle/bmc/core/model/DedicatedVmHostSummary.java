...
/**
 * A dedicated virtual machine (VM) host lets you host multiple instances on a dedicated server that
...
public final class DedicatedVmHostSummary
    ...
    public static class Builder {
        ...
        /**
         * The shape of the dedicated VM host. The shape determines the number of CPUs and other
        ...
        /**
         * The fault domain for the dedicated VM host's assigned instances. For more information,
         * see Fault Domains.
         *
         * <p>If you do not specify the fault domain, the system selects one for you. To change the
         * fault domain for a dedicated VM host, delete it and create a new dedicated VM host in the
         * preferred fault domain.
         *
         * <p>To get a list of fault domains, use the ListFaultDomains operation in the Identity and
    ...
    /**
     * The fault domain for the dedicated VM host's assigned instances. For more information, see
     * Fault Domains.
     *
     * <p>If you do not specify the fault domain, the system selects one for you. To change the
     * fault domain for a dedicated VM host, delete it and create a new dedicated VM host in the
