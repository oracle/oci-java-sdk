...
public final class UpdateVolumeBackupDetails {
    ...
    public static class Builder {
        ...
        public UpdateVolumeBackupDetails build() {
            UpdateVolumeBackupDetails __instance__ =
                    new UpdateVolumeBackupDetails(definedTags, displayName, freeformTags);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVolumeBackupDetails)) {
            return false;
        }

        UpdateVolumeBackupDetails other = (UpdateVolumeBackupDetails) o;
