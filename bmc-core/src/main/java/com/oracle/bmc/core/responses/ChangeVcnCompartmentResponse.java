...
public class ChangeVcnCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ChangeVcnCompartmentResponse> {
         ...
         */
        @Override
        public Builder copy(ChangeVcnCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVcnCompartmentResponse)) {
            return false;
        }

        ChangeVcnCompartmentResponse other = (ChangeVcnCompartmentResponse) o;
