...
public class UpdateVlanResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateVlanResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVlanResponse)) {
            return false;
        }

        UpdateVlanResponse other = (UpdateVlanResponse) o;
