...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateSubnetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateSubnetRequest.
 */
...
public class CreateSubnetRequest
    ...
    public static class Builder
        ...
        public Builder createSubnetDetails(
                com.oracle.bmc.core.model.CreateSubnetDetails createSubnetDetails) {
        ...
        /**
         * Build the instance of CreateSubnetRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateSubnetRequest
         */
        public CreateSubnetRequest build() {
            CreateSubnetRequest request = buildWithoutInvocationCallback();
        ...
        public CreateSubnetRequest buildWithoutInvocationCallback() {
            ...
            request.createSubnetDetails = createSubnetDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateSubnetRequest(createSubnetDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createSubnetDetails=").append(String.valueOf(this.createSubnetDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSubnetRequest)) {
            return false;
        }

        CreateSubnetRequest other = (CreateSubnetRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.createSubnetDetails, other.createSubnetDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createSubnetDetails == null
                                ? 43
                                : this.createSubnetDetails.hashCode());
        result =
                (result * PRIME)
