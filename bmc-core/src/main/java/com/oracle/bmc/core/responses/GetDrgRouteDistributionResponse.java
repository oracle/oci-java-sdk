...
public class GetDrgRouteDistributionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDrgRouteDistributionResponse)) {
            return false;
        }

        GetDrgRouteDistributionResponse other = (GetDrgRouteDistributionResponse) o;
