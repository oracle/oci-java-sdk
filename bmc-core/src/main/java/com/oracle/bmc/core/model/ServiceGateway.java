 ...
 * a supported Oracle service (use the {@link #listServices(ListServicesRequest) listServices}
 * operation to find available service CIDR labels) is routed through the service gateway and does
 * not traverse the internet. The instances in the VCN do not need to have public IP addresses nor
 * be in a public subnet. The VCN does not need an internet gateway for this traffic. For more
 * information, see [Access to Oracle Services: Service
 * Gateway](https://docs.oracle.com/iaas/Content/Network/Tasks/servicegateway.htm).
 *
...
public final class ServiceGateway
    ...
    public static class Builder {
         ...
         * compartment that contains the service gateway.
         */
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * route table the service gateway is using. For information about why you would associate a
     ...
     * the service gateway belongs to.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("vcnId")
