...
/**
 * The standard platform configuration of a bare metal instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GenericBmPlatformConfig.Builder.class)
...
public final class GenericBmPlatformConfig extends PlatformConfig {
    ...
    public static class Builder {
        ...
        public GenericBmPlatformConfig build() {
            GenericBmPlatformConfig model =
                    new GenericBmPlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenericBmPlatformConfig model) {
    ...
    @Deprecated
    public GenericBmPlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GenericBmPlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenericBmPlatformConfig)) {
            return false;
        }

        GenericBmPlatformConfig other = (GenericBmPlatformConfig) o;
