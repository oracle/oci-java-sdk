...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/AttachVnicExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachVnicRequest.
 */
...
public class AttachVnicRequest
    ...
    public static class Builder
        ...
        public Builder attachVnicDetails(
                com.oracle.bmc.core.model.AttachVnicDetails attachVnicDetails) {
         ...
         *
         * @return instance of AttachVnicRequest
         */
        public AttachVnicRequest build() {
            AttachVnicRequest request = buildWithoutInvocationCallback();
        ...
        public AttachVnicRequest buildWithoutInvocationCallback() {
            AttachVnicRequest request = new AttachVnicRequest();
            request.attachVnicDetails = attachVnicDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new AttachVnicRequest(attachVnicDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",attachVnicDetails=").append(String.valueOf(this.attachVnicDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachVnicRequest)) {
            return false;
        }

        AttachVnicRequest other = (AttachVnicRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.attachVnicDetails, other.attachVnicDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.attachVnicDetails == null ? 43 : this.attachVnicDetails.hashCode());
        result =
                (result * PRIME)
