...
public final class LaunchInstanceAvailabilityConfigDetails
    ...
    public static class Builder {
        ...
        public LaunchInstanceAvailabilityConfigDetails build() {
            LaunchInstanceAvailabilityConfigDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LaunchInstanceAvailabilityConfigDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LaunchInstanceAvailabilityConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LaunchInstanceAvailabilityConfigDetails)) {
            return false;
        }

        LaunchInstanceAvailabilityConfigDetails other = (LaunchInstanceAvailabilityConfigDetails) o;
