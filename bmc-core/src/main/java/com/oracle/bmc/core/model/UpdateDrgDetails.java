...
public final class UpdateDrgDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDrgDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrgDetails)) {
            return false;
        }

        UpdateDrgDetails other = (UpdateDrgDetails) o;
