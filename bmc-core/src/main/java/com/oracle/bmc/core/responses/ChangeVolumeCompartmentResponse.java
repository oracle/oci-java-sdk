...
public class ChangeVolumeCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeVolumeCompartmentResponse)) {
            return false;
        }

        ChangeVolumeCompartmentResponse other = (ChangeVolumeCompartmentResponse) o;
