...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/LaunchInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use LaunchInstanceRequest.
 */
...
public class LaunchInstanceRequest
    ...
    public static class Builder
        ...
        public Builder launchInstanceDetails(
                com.oracle.bmc.core.model.LaunchInstanceDetails launchInstanceDetails) {
         ...
         *
         * @return instance of LaunchInstanceRequest
         */
        public LaunchInstanceRequest build() {
            LaunchInstanceRequest request = buildWithoutInvocationCallback();
        ...
        public LaunchInstanceRequest buildWithoutInvocationCallback() {
            ...
            request.launchInstanceDetails = launchInstanceDetails;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new LaunchInstanceRequest(launchInstanceDetails, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",launchInstanceDetails=").append(String.valueOf(this.launchInstanceDetails));
    ...
    public boolean equals(Object o) {
        ...
        LaunchInstanceRequest other = (LaunchInstanceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.launchInstanceDetails, other.launchInstanceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.launchInstanceDetails == null
                                ? 43
                                : this.launchInstanceDetails.hashCode());
        result =
                (result * PRIME)
