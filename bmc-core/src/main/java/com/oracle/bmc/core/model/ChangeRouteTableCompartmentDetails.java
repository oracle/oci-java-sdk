...
public class ChangeRouteTableCompartmentDetails {
    ...
    public static class Builder {
        ...
        public ChangeRouteTableCompartmentDetails build() {
            ChangeRouteTableCompartmentDetails __instance__ =
                    new ChangeRouteTableCompartmentDetails(compartmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeRouteTableCompartmentDetails o) {
