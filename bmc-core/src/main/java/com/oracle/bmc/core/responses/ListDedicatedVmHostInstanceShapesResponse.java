...
public class ListDedicatedVmHostInstanceShapesResponse
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.core.model.DedicatedVmHostInstanceShapeSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDedicatedVmHostInstanceShapesResponse)) {
            return false;
        }

        ListDedicatedVmHostInstanceShapesResponse other =
                (ListDedicatedVmHostInstanceShapesResponse) o;
