...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateComputeGpuMemoryClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateComputeGpuMemoryClusterRequest.
 */
...
public class CreateComputeGpuMemoryClusterRequest
    ...
    public static class Builder
        ...
        public CreateComputeGpuMemoryClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateComputeGpuMemoryClusterRequest(createComputeGpuMemoryClusterDetails, opcRetryToken, opcRequestId);
        }
    }
