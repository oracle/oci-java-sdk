...
public class CreatePublicIpResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreatePublicIpResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreatePublicIpResponse> {
         ...
         */
        @Override
        public Builder copy(CreatePublicIpResponse o) {
         ...
         */
        @Override
        public CreatePublicIpResponse build() {
            return new CreatePublicIpResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePublicIpResponse)) {
            return false;
        }

        CreatePublicIpResponse other = (CreatePublicIpResponse) o;
