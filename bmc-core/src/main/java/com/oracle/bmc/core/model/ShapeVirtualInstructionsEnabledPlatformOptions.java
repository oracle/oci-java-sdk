...
public final class ShapeVirtualInstructionsEnabledPlatformOptions
    ...
    public static class Builder {
        ...
        public ShapeVirtualInstructionsEnabledPlatformOptions build() {
            ShapeVirtualInstructionsEnabledPlatformOptions model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShapeVirtualInstructionsEnabledPlatformOptions model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ShapeVirtualInstructionsEnabledPlatformOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShapeVirtualInstructionsEnabledPlatformOptions)) {
            return false;
        }

        ShapeVirtualInstructionsEnabledPlatformOptions other =
                (ShapeVirtualInstructionsEnabledPlatformOptions) o;
