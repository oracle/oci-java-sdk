...
public class ListComputeGlobalImageCapabilitySchemaVersionsResponse
    ...
    /**
     * A list of com.oracle.bmc.core.model.ComputeGlobalImageCapabilitySchemaVersionSummary instances.
     */
    ...
    public static class Builder {
        ...
        public ListComputeGlobalImageCapabilitySchemaVersionsResponse build() {
            return new ListComputeGlobalImageCapabilitySchemaVersionsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListComputeGlobalImageCapabilitySchemaVersionsResponse)) {
            return false;
        }

        ListComputeGlobalImageCapabilitySchemaVersionsResponse other =
                (ListComputeGlobalImageCapabilitySchemaVersionsResponse) o;
