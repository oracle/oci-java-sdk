...
public class ListVirtualCircuitPublicPrefixesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.VirtualCircuitPublicPrefix> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVirtualCircuitPublicPrefixesResponse)) {
            return false;
        }

        ListVirtualCircuitPublicPrefixesResponse other =
                (ListVirtualCircuitPublicPrefixesResponse) o;
