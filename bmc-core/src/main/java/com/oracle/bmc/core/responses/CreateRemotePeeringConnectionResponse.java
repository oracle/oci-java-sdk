...
public class CreateRemotePeeringConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateRemotePeeringConnectionResponse(
    ...
    public static class Builder
        ...
        public CreateRemotePeeringConnectionResponse build() {
            return new CreateRemotePeeringConnectionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRemotePeeringConnectionResponse)) {
            return false;
        }

        CreateRemotePeeringConnectionResponse other = (CreateRemotePeeringConnectionResponse) o;
