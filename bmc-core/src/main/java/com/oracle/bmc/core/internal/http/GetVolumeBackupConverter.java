...
@Slf4j
public class GetVolumeBackupConverter {
    ...
    public static Function<Response, GetVolumeBackupResponse> fromResponse() {
        final Function<Response, GetVolumeBackupResponse> transformer =
                new Function<Response, GetVolumeBackupResponse>() {
                    @Override
                    public GetVolumeBackupResponse apply(Response rawResponse) {
                        ...
                        GetVolumeBackupResponse.Builder builder = GetVolumeBackupResponse.builder();
