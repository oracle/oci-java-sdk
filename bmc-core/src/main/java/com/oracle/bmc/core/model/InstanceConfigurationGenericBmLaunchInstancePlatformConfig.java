...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = InstanceConfigurationGenericBmLaunchInstancePlatformConfig.Builder.class
)
...
public final class InstanceConfigurationGenericBmLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationGenericBmLaunchInstancePlatformConfig build() {
            InstanceConfigurationGenericBmLaunchInstancePlatformConfig model =
                    new InstanceConfigurationGenericBmLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationGenericBmLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public InstanceConfigurationGenericBmLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationGenericBmLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationGenericBmLaunchInstancePlatformConfig)) {
            return false;
        }

        InstanceConfigurationGenericBmLaunchInstancePlatformConfig other =
                (InstanceConfigurationGenericBmLaunchInstancePlatformConfig) o;
