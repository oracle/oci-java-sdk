...
/**
 * A collection of pinned component firmware versions organized by platform. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FirmwareBundle.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class FirmwareBundle
    ...
    public static class Builder {
        ...
        public FirmwareBundle build() {
            FirmwareBundle model =
                    new FirmwareBundle(
                            this.id,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FirmwareBundle model) {
    ...
    public boolean equals(Object o) {
        ...
        FirmwareBundle other = (FirmwareBundle) o;
