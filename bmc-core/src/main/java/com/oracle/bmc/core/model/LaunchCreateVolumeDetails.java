...
/**
 * Define a volume that will be created and attached or attached to an instance on creation. <br>
...
public class LaunchCreateVolumeDetails
    ...
    public enum VolumeCreationType implements com.oracle.bmc.http.internal.BmcEnum {
