...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/UpdateIPSecConnectionTunnelExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateIPSecConnectionTunnelRequest.
 */
...
public class UpdateIPSecConnectionTunnelRequest
    ...
    public static class Builder
        ...
        public UpdateIPSecConnectionTunnelRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateIPSecConnectionTunnelRequest(ipscId, tunnelId, updateIPSecConnectionTunnelDetails, ifMatch, opcRequestId);
        }
    }
