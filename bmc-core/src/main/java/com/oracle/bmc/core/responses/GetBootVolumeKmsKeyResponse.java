...
public class GetBootVolumeKmsKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBootVolumeKmsKeyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBootVolumeKmsKeyResponse)) {
            return false;
        }

        GetBootVolumeKmsKeyResponse other = (GetBootVolumeKmsKeyResponse) o;
