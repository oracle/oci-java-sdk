...
public class ChangeComputeCapacityReservationCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeComputeCapacityReservationCompartmentResponse)) {
            return false;
        }

        ChangeComputeCapacityReservationCompartmentResponse other =
                (ChangeComputeCapacityReservationCompartmentResponse) o;
