...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmdVmUpdateInstancePlatformConfig.Builder.class)
...
public final class AmdVmUpdateInstancePlatformConfig extends UpdateInstancePlatformConfig {
    ...
    public static class Builder {
        ...
        public AmdVmUpdateInstancePlatformConfig build() {
            AmdVmUpdateInstancePlatformConfig model =
                    new AmdVmUpdateInstancePlatformConfig(this.isSymmetricMultiThreadingEnabled);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmdVmUpdateInstancePlatformConfig model) {
    ...
    @Deprecated
    public AmdVmUpdateInstancePlatformConfig(Boolean isSymmetricMultiThreadingEnabled) {
        super();
        this.isSymmetricMultiThreadingEnabled = isSymmetricMultiThreadingEnabled;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmdVmUpdateInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmdVmUpdateInstancePlatformConfig)) {
            return false;
        }

        AmdVmUpdateInstancePlatformConfig other = (AmdVmUpdateInstancePlatformConfig) o;
