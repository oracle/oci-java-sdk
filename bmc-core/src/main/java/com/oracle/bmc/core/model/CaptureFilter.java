 ...
 * what traffic a *{@link Vtap}* mirrors. The capture filter is created with no rules defined, and
 * it must have at least one rule for the VTAP to start mirroring traffic. <br>
