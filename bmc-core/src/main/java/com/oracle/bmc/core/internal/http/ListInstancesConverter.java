...
public class ListInstancesConverter {
    ...
    public static Function<Response, ListInstancesResponse> fromResponse() {
        final Function<Response, ListInstancesResponse> transformer =
                new Function<Response, ListInstancesResponse>() {
                    @Override
                    public ListInstancesResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for ListInstancesResponse");
                        Function<Response, WithHeaders<List<Instance>>> responseFn =
                                RESPONSE_CONVERSION_FACTORY.create(
                                        new GenericType<List<Instance>>() {});

                        WithHeaders<List<Instance>> response = responseFn.apply(rawResponse);
                        MultivaluedMap<String, String> headers = response.getHeaders();

                        ListInstancesResponse.Builder builder = ListInstancesResponse.builder();
