...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig.Builder.class)
...
public final class InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig build() {
            InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig model =
                    new InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig model) {
    ...
    @Deprecated
    public InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig)) {
            return false;
        }

        InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig other =
                (InstanceConfigurationAmdMilanBmGpuLaunchInstancePlatformConfig) o;
