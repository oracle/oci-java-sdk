...
public class GetPublicIpResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPublicIpResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPublicIpResponse)) {
            return false;
        }

        GetPublicIpResponse other = (GetPublicIpResponse) o;
