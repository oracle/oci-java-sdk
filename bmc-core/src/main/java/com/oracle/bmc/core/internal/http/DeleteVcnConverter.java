...
@Slf4j
public class DeleteVcnConverter {
    ...
    public static Function<Response, DeleteVcnResponse> fromResponse() {
        final Function<Response, DeleteVcnResponse> transformer =
                new Function<Response, DeleteVcnResponse>() {
                    @Override
                    public DeleteVcnResponse apply(Response rawResponse) {
