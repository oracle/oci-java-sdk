...
/**
 * Details for creating an instance configuration for GPU Memory Cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGmcConfigurationDetails.Builder.class)
...
public final class CreateGmcConfigurationDetails extends CreateInstanceConfigurationBase {
    ...
    public static class Builder {
        ...
        public CreateGmcConfigurationDetails build() {
            CreateGmcConfigurationDetails model =
                    new CreateGmcConfigurationDetails(
                            this.compartmentId,
                            this.definedTags,
                            this.displayName,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGmcConfigurationDetails model) {
    ...
    @Deprecated
    public CreateGmcConfigurationDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGmcConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGmcConfigurationDetails)) {
            return false;
        }

        CreateGmcConfigurationDetails other = (CreateGmcConfigurationDetails) o;
        return java.util.Objects.equals(this.gmcConfigs, other.gmcConfigs) && super.equals(other);
    }
