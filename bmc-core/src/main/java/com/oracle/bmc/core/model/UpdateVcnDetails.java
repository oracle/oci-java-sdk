...
public final class UpdateVcnDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVcnDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVcnDetails)) {
            return false;
        }

        UpdateVcnDetails other = (UpdateVcnDetails) o;
