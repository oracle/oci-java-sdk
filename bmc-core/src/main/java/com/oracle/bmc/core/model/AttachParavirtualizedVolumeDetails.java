...
public final class AttachParavirtualizedVolumeDetails extends AttachVolumeDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachParavirtualizedVolumeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AttachParavirtualizedVolumeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachParavirtualizedVolumeDetails)) {
            return false;
        }

        AttachParavirtualizedVolumeDetails other = (AttachParavirtualizedVolumeDetails) o;
