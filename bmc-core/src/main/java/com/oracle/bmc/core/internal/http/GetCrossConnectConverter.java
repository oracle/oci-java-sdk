...
public class GetCrossConnectConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, GetCrossConnectRequest request) {
        if (request == null) {
    ...
    public static Function<Response, GetCrossConnectResponse> fromResponse() {
        final Function<Response, GetCrossConnectResponse> transformer =
                new Function<Response, GetCrossConnectResponse>() {
                    @Override
                    public GetCrossConnectResponse apply(Response rawResponse) {
                        ...
                        GetCrossConnectResponse.Builder builder = GetCrossConnectResponse.builder();
