...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetIPSecConnectionTunnelSharedSecretExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetIPSecConnectionTunnelSharedSecretRequest.
 */
...
public class GetIPSecConnectionTunnelSharedSecretRequest
    ...
    public static class Builder
         ...
         * @return instance of GetIPSecConnectionTunnelSharedSecretRequest
         */
        public GetIPSecConnectionTunnelSharedSecretRequest buildWithoutInvocationCallback() {
            GetIPSecConnectionTunnelSharedSecretRequest request =
                    new GetIPSecConnectionTunnelSharedSecretRequest();
            request.ipscId = ipscId;
            request.tunnelId = tunnelId;
            return request;
            // new GetIPSecConnectionTunnelSharedSecretRequest(ipscId, tunnelId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIPSecConnectionTunnelSharedSecretRequest)) {
            return false;
        }

        GetIPSecConnectionTunnelSharedSecretRequest other =
                (GetIPSecConnectionTunnelSharedSecretRequest) o;
