...
public final class AddedNetworkSecurityGroupSecurityRules {
    ...
    public static class Builder {
        ...
        public AddedNetworkSecurityGroupSecurityRules build() {
            AddedNetworkSecurityGroupSecurityRules __instance__ =
                    new AddedNetworkSecurityGroupSecurityRules(securityRules);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddedNetworkSecurityGroupSecurityRules o) {
