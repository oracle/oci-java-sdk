...
public class CreateVolumeBackupPolicyAssignmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeBackupPolicyAssignmentResponse)) {
            return false;
        }

        CreateVolumeBackupPolicyAssignmentResponse other =
                (CreateVolumeBackupPolicyAssignmentResponse) o;
