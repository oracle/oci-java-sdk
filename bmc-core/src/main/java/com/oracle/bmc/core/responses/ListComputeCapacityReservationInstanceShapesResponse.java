...
public class ListComputeCapacityReservationInstanceShapesResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListComputeCapacityReservationInstanceShapesResponse)) {
            return false;
        }

        ListComputeCapacityReservationInstanceShapesResponse other =
                (ListComputeCapacityReservationInstanceShapesResponse) o;
