...
public class ListComputeCapacityTopologyComputeBareMetalHostsConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    ListComputeCapacityTopologyComputeBareMetalHostsConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.core.requests.ListComputeCapacityTopologyComputeBareMetalHostsRequest
                    request) {
        ...
        if (request.getComputeLocalBlockId() != null) {
            target =
                    target.queryParam(
                            "computeLocalBlockId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getComputeLocalBlockId()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.core.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.core.responses.ListComputeCapacityTopologyComputeBareMetalHostsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.computeBareMetalHostCollection(response.getItem());
