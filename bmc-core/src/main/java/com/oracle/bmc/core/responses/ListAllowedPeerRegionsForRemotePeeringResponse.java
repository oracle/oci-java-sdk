...
public class ListAllowedPeerRegionsForRemotePeeringResponse
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.PeerRegionForRemotePeering> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAllowedPeerRegionsForRemotePeeringResponse)) {
            return false;
        }

        ListAllowedPeerRegionsForRemotePeeringResponse other =
                (ListAllowedPeerRegionsForRemotePeeringResponse) o;
