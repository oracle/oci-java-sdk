...
/**
 * Configuration options for the input-output memory management unit (IOMMU). <br>
...
public final class ShapeInputOutputMemoryManagementUnitEnabledPlatformOptions
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShapeInputOutputMemoryManagementUnitEnabledPlatformOptions)) {
            return false;
        }

        ShapeInputOutputMemoryManagementUnitEnabledPlatformOptions other =
