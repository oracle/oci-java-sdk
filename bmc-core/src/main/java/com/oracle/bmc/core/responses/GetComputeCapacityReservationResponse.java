...
public class GetComputeCapacityReservationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetComputeCapacityReservationResponse o) {
         ...
         */
        public GetComputeCapacityReservationResponse build() {
            return new GetComputeCapacityReservationResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, computeCapacityReservation);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetComputeCapacityReservationResponse)) {
            return false;
        }

        GetComputeCapacityReservationResponse other = (GetComputeCapacityReservationResponse) o;
