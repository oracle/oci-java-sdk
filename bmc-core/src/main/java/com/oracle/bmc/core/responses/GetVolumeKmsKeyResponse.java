...
public class GetVolumeKmsKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetVolumeKmsKeyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVolumeKmsKeyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumeKmsKeyResponse)) {
            return false;
        }

        GetVolumeKmsKeyResponse other = (GetVolumeKmsKeyResponse) o;
