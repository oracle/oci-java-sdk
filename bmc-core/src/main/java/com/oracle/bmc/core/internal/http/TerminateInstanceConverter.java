...
public class TerminateInstanceConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(TerminateInstanceConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getPreserveDataVolumesCreatedAtLaunch() != null) {
            target =
                    target.queryParam(
        ...
        if (request.getRecycleLevel() != null) {
            target =
                    target.queryParam(
                            "recycleLevel",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getRecycleLevel().getValue()));
        }
