...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AttachComputeHostGroupHostDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AttachComputeHostGroupHostDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"computeHostGroupId"})
    public AttachComputeHostGroupHostDetails(String computeHostGroupId) {
        super();
    ...
    public static class Builder {
        ...
        public AttachComputeHostGroupHostDetails build() {
            AttachComputeHostGroupHostDetails model =
                    new AttachComputeHostGroupHostDetails(this.computeHostGroupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachComputeHostGroupHostDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachComputeHostGroupHostDetails)) {
            return false;
        }

        AttachComputeHostGroupHostDetails other = (AttachComputeHostGroupHostDetails) o;
