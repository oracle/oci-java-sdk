...
public class CreateVolumeGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateVolumeGroupResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String etag,
            String opcRequestId,
            com.oracle.bmc.core.model.VolumeGroup volumeGroup) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateVolumeGroupResponse> {
         ...
         */
        @Override
        public Builder copy(CreateVolumeGroupResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            etag(o.getEtag());
            opcRequestId(o.getOpcRequestId());
            volumeGroup(o.getVolumeGroup());
        ...
        public CreateVolumeGroupResponse build() {
            return new CreateVolumeGroupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, volumeGroup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVolumeGroupResponse)) {
            return false;
        }

        CreateVolumeGroupResponse other = (CreateVolumeGroupResponse) o;
