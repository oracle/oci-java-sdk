...
/**
 * Configuration options for memory encryption. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ShapeMemoryEncryptionOptions.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ShapeMemoryEncryptionOptions
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"allowedValues", "isDefaultEnabled"})
    public ShapeMemoryEncryptionOptions(
    ...
    public static class Builder {
        ...
        public ShapeMemoryEncryptionOptions build() {
            ShapeMemoryEncryptionOptions model =
                    new ShapeMemoryEncryptionOptions(this.allowedValues, this.isDefaultEnabled);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShapeMemoryEncryptionOptions model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ShapeMemoryEncryptionOptions(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShapeMemoryEncryptionOptions)) {
            return false;
        }

        ShapeMemoryEncryptionOptions other = (ShapeMemoryEncryptionOptions) o;
