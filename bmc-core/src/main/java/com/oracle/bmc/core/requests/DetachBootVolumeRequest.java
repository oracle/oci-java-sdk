...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DetachBootVolumeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DetachBootVolumeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class DetachBootVolumeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DetachBootVolumeRequest, java.lang.Void> {
        ...
        public DetachBootVolumeRequest buildWithoutInvocationCallback() {
            ...
            request.bootVolumeAttachmentId = bootVolumeAttachmentId;
            request.ifMatch = ifMatch;
            return request;
            // new DetachBootVolumeRequest(bootVolumeAttachmentId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().bootVolumeAttachmentId(bootVolumeAttachmentId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        DetachBootVolumeRequest other = (DetachBootVolumeRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.bootVolumeAttachmentId, other.bootVolumeAttachmentId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.bootVolumeAttachmentId == null
                                ? 43
                                : this.bootVolumeAttachmentId.hashCode());
