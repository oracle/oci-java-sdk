...
/**
 * Specifies the volume backups (first & second) and block size in bytes. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VolumeSourceFromVolumeBackupDeltaDetails.Builder.class)
...
public final class VolumeSourceFromVolumeBackupDeltaDetails extends VolumeSourceDetails {
    ...
    public static class Builder {
        ...
        /**
         * Block size in bytes to be considered while performing volume restore. The value must be a
         * power of 2; ranging from 4KB (4096 bytes) to 1MB (1048576 bytes). If omitted, defaults to
         * 4,096 bytes (4 KiB).
         */
        ...
        public VolumeSourceFromVolumeBackupDeltaDetails build() {
            VolumeSourceFromVolumeBackupDeltaDetails model =
                    new VolumeSourceFromVolumeBackupDeltaDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VolumeSourceFromVolumeBackupDeltaDetails model) {
    ...
    @Deprecated
    public VolumeSourceFromVolumeBackupDeltaDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VolumeSourceFromVolumeBackupDeltaDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VolumeSourceFromVolumeBackupDeltaDetails)) {
            return false;
        }

        VolumeSourceFromVolumeBackupDeltaDetails other =
                (VolumeSourceFromVolumeBackupDeltaDetails) o;
