...
@Slf4j
public class CreateDrgConverter {
    private static final ResponseConversionFunctionFactory RESPONSE_CONVERSION_FACTORY =
            new ResponseConversionFunctionFactory();

    public static Invocation.Builder fromRequest(RestClient client, CreateDrgRequest request) {
        if (request == null) {
    ...
    public static Function<Response, CreateDrgResponse> fromResponse() {
        final Function<Response, CreateDrgResponse> transformer =
                new Function<Response, CreateDrgResponse>() {
                    @Override
                    public CreateDrgResponse apply(Response rawResponse) {
