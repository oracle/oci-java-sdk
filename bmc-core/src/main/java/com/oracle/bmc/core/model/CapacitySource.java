...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CapacitySource.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DedicatedCapacitySource.class,
            name = "DEDICATED")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class CapacitySource extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected CapacitySource() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CapacitySource)) {
            return false;
        }

        CapacitySource other = (CapacitySource) o;
