...
public class ChangeBootVolumeBackupCompartmentResponse
    ...
    private ChangeBootVolumeBackupCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeBootVolumeBackupCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeBootVolumeBackupCompartmentResponse)) {
            return false;
        }

        ChangeBootVolumeBackupCompartmentResponse other =
                (ChangeBootVolumeBackupCompartmentResponse) o;
