...
public class UpdateDrgAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateDrgAttachmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDrgAttachmentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDrgAttachmentResponse)) {
            return false;
        }

        UpdateDrgAttachmentResponse other = (UpdateDrgAttachmentResponse) o;
