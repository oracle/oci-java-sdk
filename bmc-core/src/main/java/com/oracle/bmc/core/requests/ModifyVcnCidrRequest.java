...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ModifyVcnCidrExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ModifyVcnCidrRequest.
 */
...
public class ModifyVcnCidrRequest
    ...
    public static class Builder
        ...
        public ModifyVcnCidrRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ModifyVcnCidrRequest(vcnId, modifyVcnCidrDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
