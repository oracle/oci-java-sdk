...
public class CreateNatGatewayResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateNatGatewayResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNatGatewayResponse)) {
            return false;
        }

        CreateNatGatewayResponse other = (CreateNatGatewayResponse) o;
