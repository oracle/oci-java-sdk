...
public class CreateVcnConverter {
    ...
    public static Function<Response, CreateVcnResponse> fromResponse() {
        final Function<Response, CreateVcnResponse> transformer =
                new Function<Response, CreateVcnResponse>() {
                    @Override
                    public CreateVcnResponse apply(Response rawResponse) {
