...
public class UpdateSubnetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateSubnetResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSubnetResponse)) {
            return false;
        }

        UpdateSubnetResponse other = (UpdateSubnetResponse) o;
