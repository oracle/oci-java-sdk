...
public class CreateClusterNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateClusterNetworkResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateClusterNetworkResponse)) {
            return false;
        }

        CreateClusterNetworkResponse other = (CreateClusterNetworkResponse) o;
