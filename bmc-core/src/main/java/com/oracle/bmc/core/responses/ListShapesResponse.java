...
public class ListShapesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.core.model.Shape> getItems() {
        return items;
    }
    ...
    private ListShapesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.core.model.Shape> items) {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.core.model.Shape> items) {
            this.items = items;
            return this;
        }
        ...
        public ListShapesResponse build() {
            return new ListShapesResponse(__httpStatusCode__, opcNextPage, opcRequestId, items);
        }
    }
