...
public class GetInternetGatewayConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, GetInternetGatewayRequest request) {
        if (request == null) {
    ...
    public static Function<Response, GetInternetGatewayResponse> fromResponse() {
        final Function<Response, GetInternetGatewayResponse> transformer =
                new Function<Response, GetInternetGatewayResponse>() {
                    @Override
                    public GetInternetGatewayResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for GetInternetGatewayResponse");
