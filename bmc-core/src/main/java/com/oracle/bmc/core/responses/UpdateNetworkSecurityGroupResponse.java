...
public class UpdateNetworkSecurityGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateNetworkSecurityGroupResponse(
    ...
    public static class Builder
        ...
        public UpdateNetworkSecurityGroupResponse build() {
            return new UpdateNetworkSecurityGroupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, networkSecurityGroup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNetworkSecurityGroupResponse)) {
            return false;
        }

        UpdateNetworkSecurityGroupResponse other = (UpdateNetworkSecurityGroupResponse) o;
