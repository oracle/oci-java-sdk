...
public class InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig
    ...
    public static class Builder {
        ...
        public InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig build() {
            InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstanceConfigurationIntelSkylakeBmLaunchInstancePlatformConfig o) {
