...
/**
 * The HPC cluster configuration requested when launching instances in a compute capacity
 * reservation.
 *
 * <p>If the parameter is provided, the reservation is created with the HPC island and a list of HPC
 * blocks that you specify. If a list of HPC blocks are missing or not provided, the reservation is
 * created with any HPC blocks in the HPC island that you specify. If the values of HPC island or
 * HPC block that you provide are not valid, an error is returned. <br>
...
public final class ClusterConfigDetails
