...
public class ListComputeCapacityTopologyComputeBareMetalHostsResponse
    ...
    public com.oracle.bmc.core.model.ComputeBareMetalHostCollection
            getComputeBareMetalHostCollection() {
        return computeBareMetalHostCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder computeBareMetalHostCollection(
                com.oracle.bmc.core.model.ComputeBareMetalHostCollection
                        computeBareMetalHostCollection) {
            this.computeBareMetalHostCollection = computeBareMetalHostCollection;
            return this;
        ...
        public Builder copy(ListComputeCapacityTopologyComputeBareMetalHostsResponse o) {
            ...
            computeBareMetalHostCollection(o.getComputeBareMetalHostCollection());
    ...
    public String toString() {
        ...
        sb.append(",computeBareMetalHostCollection=")
                .append(String.valueOf(computeBareMetalHostCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListComputeCapacityTopologyComputeBareMetalHostsResponse)) {
            return false;
        }

        ListComputeCapacityTopologyComputeBareMetalHostsResponse other =
                (ListComputeCapacityTopologyComputeBareMetalHostsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.computeBareMetalHostCollection, other.computeBareMetalHostCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.computeBareMetalHostCollection == null
                                ? 43
                                : this.computeBareMetalHostCollection.hashCode());
        return result;
    }
}
