...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/ListInstancesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInstancesRequest.
 */
...
public class ListInstancesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListInstancesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListInstancesRequest(compartmentId, availabilityDomain, capacityReservationId, computeClusterId, displayName, limit, page, sortBy, sortOrder, lifecycleState);
        }
    }
