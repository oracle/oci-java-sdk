...
/**
 * Parameters for the {@code reset} {@link #instanceAction(InstanceActionRequest) instanceAction}.
 * If omitted, default values are used. <br>
...
public final class ResetActionDetails extends InstancePowerActionDetails {
    ...
    public static class Builder {
        ...
        public ResetActionDetails build() {
            ResetActionDetails model = new ResetActionDetails(this.allowDenseRebootMigration);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResetActionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResetActionDetails)) {
            return false;
        }

        ResetActionDetails other = (ResetActionDetails) o;
