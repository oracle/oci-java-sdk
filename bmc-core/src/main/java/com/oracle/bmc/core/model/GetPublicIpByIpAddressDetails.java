...
public final class GetPublicIpByIpAddressDetails
    ...
    public static class Builder {
        ...
        public GetPublicIpByIpAddressDetails build() {
            GetPublicIpByIpAddressDetails model = new GetPublicIpByIpAddressDetails(this.ipAddress);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GetPublicIpByIpAddressDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPublicIpByIpAddressDetails)) {
            return false;
        }

        GetPublicIpByIpAddressDetails other = (GetPublicIpByIpAddressDetails) o;
