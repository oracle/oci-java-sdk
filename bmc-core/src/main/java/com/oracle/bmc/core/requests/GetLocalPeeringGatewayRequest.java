...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/GetLocalPeeringGatewayExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetLocalPeeringGatewayRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
public class GetLocalPeeringGatewayRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetLocalPeeringGatewayRequest, java.lang.Void> {
         ...
         * @return instance of GetLocalPeeringGatewayRequest
         */
        public GetLocalPeeringGatewayRequest buildWithoutInvocationCallback() {
            GetLocalPeeringGatewayRequest request = new GetLocalPeeringGatewayRequest();
            request.localPeeringGatewayId = localPeeringGatewayId;
            return request;
            // new GetLocalPeeringGatewayRequest(localPeeringGatewayId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLocalPeeringGatewayRequest)) {
            return false;
        }

        GetLocalPeeringGatewayRequest other = (GetLocalPeeringGatewayRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.localPeeringGatewayId, other.localPeeringGatewayId);
    }
