...
public class UpdateCrossConnectGroupConverter {
    ...
    public static Invocation.Builder fromRequest(
            RestClient client, UpdateCrossConnectGroupRequest request) {
        if (request == null) {
    ...
    public static Function<Response, UpdateCrossConnectGroupResponse> fromResponse() {
        final Function<Response, UpdateCrossConnectGroupResponse> transformer =
                new Function<Response, UpdateCrossConnectGroupResponse>() {
                    @Override
                    public UpdateCrossConnectGroupResponse apply(Response rawResponse) {
                        LOG.trace("Transform function invoked for UpdateCrossConnectGroupResponse");
