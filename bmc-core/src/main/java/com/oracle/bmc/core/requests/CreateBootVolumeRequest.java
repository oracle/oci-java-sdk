...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/CreateBootVolumeExample.java.html">here</a> to see how to use CreateBootVolumeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20160918")
@lombok.Builder(builderClassName = "Builder", buildMethodName = "buildWithoutInvocationCallback")
@lombok.Getter
public class CreateBootVolumeRequest
        extends com.oracle.bmc.requests.BmcRequest<CreateBootVolumeDetails> {
    ...
    public CreateBootVolumeDetails getBody$() {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(CreateBootVolumeDetails body) {
