...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/core/DeletePrivateIpExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePrivateIpRequest.
 */
...
public class DeletePrivateIpRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePrivateIpRequest, java.lang.Void> {
         ...
         *
         * @return instance of DeletePrivateIpRequest
         */
        public DeletePrivateIpRequest build() {
            DeletePrivateIpRequest request = buildWithoutInvocationCallback();
        ...
        public DeletePrivateIpRequest buildWithoutInvocationCallback() {
            DeletePrivateIpRequest request = new DeletePrivateIpRequest();
            request.privateIpId = privateIpId;
            request.ifMatch = ifMatch;
            return request;
            // new DeletePrivateIpRequest(privateIpId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().privateIpId(privateIpId).ifMatch(ifMatch);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePrivateIpRequest)) {
            return false;
        }

        DeletePrivateIpRequest other = (DeletePrivateIpRequest) o;
