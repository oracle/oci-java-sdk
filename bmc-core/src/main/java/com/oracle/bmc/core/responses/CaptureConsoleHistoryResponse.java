...
public class CaptureConsoleHistoryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CaptureConsoleHistoryResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CaptureConsoleHistoryResponse)) {
            return false;
        }

        CaptureConsoleHistoryResponse other = (CaptureConsoleHistoryResponse) o;
