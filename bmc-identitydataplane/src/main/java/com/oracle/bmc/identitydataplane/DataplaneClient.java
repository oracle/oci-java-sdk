...
public class DataplaneClient implements Dataplane {
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, DataplaneClient> {
    ...
    @Override
    public GenerateScopedAccessTokenResponse generateScopedAccessToken(
            GenerateScopedAccessTokenRequest request) {
        LOG.trace("Called generateScopedAccessToken");
