...
public class DataplaneAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements DataplaneAsync {
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, DataplaneAsyncClient> {
        private Builder(com.oracle.bmc.Service service) {
            super(service);
            final String packageName = "identitydataplane";
        ...
        public DataplaneAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new DataplaneAsyncClient(this, authenticationDetailsProvider);
        }
    }
    ...
    @Override
    public java.util.concurrent.Future<GenerateScopedAccessTokenResponse> generateScopedAccessToken(
        ...
        return clientCall(request, GenerateScopedAccessTokenResponse::builder)
                ...
                .appendPathParam("generateScopedAccessToken")
