...
public final class FilterGroupMembershipResult
    ...
    public static class Builder {
        ...
        /**
         * An array of group or dynamic group Ids which present the intersection between the
         * passed-in group/dynamic-group and the actual group/dynamic-group the resovled principal
         * belongs to.
         */
        ...
        public FilterGroupMembershipResult build() {
            FilterGroupMembershipResult model =
                    new FilterGroupMembershipResult(this.principal, this.groupIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FilterGroupMembershipResult model) {
    ...
    /**
     * An array of group or dynamic group Ids which present the intersection between the passed-in
     * group/dynamic-group and the actual group/dynamic-group the resovled principal belongs to.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("groupIds")
