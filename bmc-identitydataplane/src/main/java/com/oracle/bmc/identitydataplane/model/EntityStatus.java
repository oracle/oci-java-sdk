...
public final class EntityStatus extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public EntityStatus build() {
            EntityStatus model = new EntityStatus(this.status, this.inactiveBitMask);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityStatus model) {
            if (model.wasPropertyExplicitlySet("status")) {
                this.status(model.getStatus());
            }
            if (model.wasPropertyExplicitlySet("inactiveBitMask")) {
                this.inactiveBitMask(model.getInactiveBitMask());
            }
            return this;
        }
    }
