...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = ManagedComputeClusterScalingConfiguration.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ManagedComputeClusterCustomExpressionQueryScalingConfiguration.class,
            name = "QUERY"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration.class,
            name = "THRESHOLD")
})
...
public class ManagedComputeClusterScalingConfiguration
    ...
    protected ManagedComputeClusterScalingConfiguration(
            String pendingDuration, Integer instanceCountAdjustment) {
        super();
     ...
     * specified as a string in ISO 8601 format (PT10M for ten minutes or PT1H for one hour).
     * Minimum: PT3M. Maximum: PT1H. Default: PT3M.
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedComputeClusterScalingConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterScalingConfiguration)) {
            return false;
        }

        ManagedComputeClusterScalingConfiguration other =
                (ManagedComputeClusterScalingConfiguration) o;
