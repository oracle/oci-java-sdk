...
/**
 * Parameters needed to create a new notebook session. Notebook sessions are interactive coding
 * environments for data scientists. <br>
...
public final class CreateNotebookSessionDetails
    ...
    public static class Builder {
         ...
         * of the project to associate with the notebook session.
         */
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the compartment where you want to create the notebook session.
         */
        ...
        public CreateNotebookSessionDetails build() {
            CreateNotebookSessionDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNotebookSessionDetails model) {
     ...
     * the project to associate with the notebook session.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("projectId")
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the compartment where you want to create the notebook session.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
