...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ListModelDeploymentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelDeploymentsRequest.
 */
...
public class ListModelDeploymentsRequest
     ...
     *
     */
    public com.oracle.bmc.datascience.model.ModelDeploymentLifecycleState getLifecycleState() {
    ...
    public static class Builder
        ...
        public Builder lifecycleState(
                com.oracle.bmc.datascience.model.ModelDeploymentLifecycleState lifecycleState) {
         ...
         * @return instance of ListModelDeploymentsRequest
         */
        public ListModelDeploymentsRequest buildWithoutInvocationCallback() {
            ListModelDeploymentsRequest request = new ListModelDeploymentsRequest();
            ...
            return request;
            // new ListModelDeploymentsRequest(compartmentId, id, projectId, displayName, lifecycleState, createdBy, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListModelDeploymentsRequest)) {
            return false;
        }

        ListModelDeploymentsRequest other = (ListModelDeploymentsRequest) o;
