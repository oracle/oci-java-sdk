...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/PutMlApplicationPackageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutMlApplicationPackageRequest.
 */
...
public class PutMlApplicationPackageRequest
    ...
    public static class Builder
        ...
        public PutMlApplicationPackageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutMlApplicationPackageRequest(mlApplicationImplementationId, putMlApplicationPackage, contentLength, opcRequestId, opcRetryToken, contentDisposition, opcMlAppPackageArgs);
        }
    }
