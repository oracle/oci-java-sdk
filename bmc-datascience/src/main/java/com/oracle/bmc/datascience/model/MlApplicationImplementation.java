...
/**
 * Resource representing solution for AI/ML use-case defined by ML Application <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MlApplicationImplementation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MlApplicationImplementation
    ...
    public MlApplicationImplementation(
            String id,
            String name,
            String description,
    ...
    public static class Builder {
        ...
        public MlApplicationImplementation build() {
            MlApplicationImplementation model =
                    new MlApplicationImplementation(
                            this.id,
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MlApplicationImplementation model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MlApplicationImplementation)) {
            return false;
        }

        MlApplicationImplementation other = (MlApplicationImplementation) o;
