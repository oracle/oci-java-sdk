...
public class UpdateModelDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateModelDeploymentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateModelDeploymentResponse> {
         ...
         */
        @Override
        public UpdateModelDeploymentResponse build() {
            return new UpdateModelDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateModelDeploymentResponse)) {
            return false;
        }

        UpdateModelDeploymentResponse other = (UpdateModelDeploymentResponse) o;
