...
/**
 * An expression built using CPU or Memory metrics for triggering an autoscaling action for
 * workload. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TargetPredefinedMetricExpressionRule.Builder.class)
...
public final class TargetPredefinedMetricExpressionRule
    ...
    public static class Builder {
        ...
        private TargetPredefinedExpressionThresholdScalingConfiguration scaleConfiguration;

        public Builder scaleConfiguration(
                TargetPredefinedExpressionThresholdScalingConfiguration scaleConfiguration) {
        ...
        public TargetPredefinedMetricExpressionRule build() {
            TargetPredefinedMetricExpressionRule model =
                    new TargetPredefinedMetricExpressionRule(
                            this.metricType, this.scaleConfiguration);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetPredefinedMetricExpressionRule model) {
    ...
    @Deprecated
    public TargetPredefinedMetricExpressionRule(
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("scaleConfiguration")
    private final TargetPredefinedExpressionThresholdScalingConfiguration scaleConfiguration;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TargetPredefinedMetricExpressionRule(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetPredefinedMetricExpressionRule)) {
            return false;
        }

        TargetPredefinedMetricExpressionRule other = (TargetPredefinedMetricExpressionRule) o;
        return java.util.Objects.equals(this.metricType, other.metricType)
                && java.util.Objects.equals(this.scaleConfiguration, other.scaleConfiguration)
                && super.equals(other);
    }
