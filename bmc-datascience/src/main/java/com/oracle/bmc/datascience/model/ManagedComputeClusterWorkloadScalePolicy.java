...
/**
 * Workload scaling policy configuration for workloads on managed compute cluster type compute
 * target <br>
...
public final class ManagedComputeClusterWorkloadScalePolicy
    ...
    public static class Builder {
         ...
         * state changes from "OK" to "FIRING" or vice versa. For example, a value of 5 minutes
         * means that the alarm must persist in breaching the condition for five minutes before the
         * alarm updates its state to "FIRING"; likewise, the alarm must persist in not breaching
         * the condition for five minutes before the alarm updates its state to "OK." The duration
         * is specified as a string in ISO 8601 format (PT10M for ten minutes). Minimum: PT1M.
         * Maximum: PT30M. Default: PT3M.
         */
        ...
        /**
         * This value is the duration of time window used to restrict the flapping of instance count
         * when the metrics used for scaling keep fluctuating. This window is used to infer a
         * previous desired state and avoid unwanted changes to workload scale. Default value is 300
         * seconds.
         */
     ...
     * condition for five minutes before the alarm updates its state to "OK." The duration is
     * specified as a string in ISO 8601 format (PT10M for ten minutes). Minimum: PT1M. Maximum:
     * PT30M. Default: PT3M.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("pendingDuration")
    ...
    /**
     * This value is the duration of time window used to restrict the flapping of instance count
     * when the metrics used for scaling keep fluctuating. This window is used to infer a previous
     * desired state and avoid unwanted changes to workload scale. Default value is 300 seconds.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("coolDownInSeconds")
