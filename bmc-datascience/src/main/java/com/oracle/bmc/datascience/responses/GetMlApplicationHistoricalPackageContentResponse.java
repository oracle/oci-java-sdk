...
public class GetMlApplicationHistoricalPackageContentResponse
    ...
    private GetMlApplicationHistoricalPackageContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetMlApplicationHistoricalPackageContentResponse o) {
         ...
         */
        @Override
        public GetMlApplicationHistoricalPackageContentResponse build() {
            return new GetMlApplicationHistoricalPackageContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMlApplicationHistoricalPackageContentResponse)) {
            return false;
        }

        GetMlApplicationHistoricalPackageContentResponse other =
                (GetMlApplicationHistoricalPackageContentResponse) o;
