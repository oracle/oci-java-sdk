...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ListModelGroupModelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelGroupModelsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190101")
public class ListModelGroupModelsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListModelGroupModelsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListModelGroupModelsRequest o) {
        ...
        /**
         * Build the instance of ListModelGroupModelsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListModelGroupModelsRequest
         */
        public ListModelGroupModelsRequest build() {
            ListModelGroupModelsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListModelGroupModelsRequest
         */
        public ListModelGroupModelsRequest buildWithoutInvocationCallback() {
            ListModelGroupModelsRequest request = new ListModelGroupModelsRequest();
            ...
            return request;
            // new ListModelGroupModelsRequest(modelGroupId, compartmentId, id, displayName, lifecycleState, createdBy, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListModelGroupModelsRequest)) {
            return false;
        }

        ListModelGroupModelsRequest other = (ListModelGroupModelsRequest) o;
