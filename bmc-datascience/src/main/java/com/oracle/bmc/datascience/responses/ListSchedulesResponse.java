...
public class ListSchedulesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.datascience.model.ScheduleSummary} instances. */
    private java.util.List<com.oracle.bmc.datascience.model.ScheduleSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datascience.model.ScheduleSummary> getItems() {
        return items;
    }
    ...
    private ListSchedulesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.datascience.model.ScheduleSummary> items) {
