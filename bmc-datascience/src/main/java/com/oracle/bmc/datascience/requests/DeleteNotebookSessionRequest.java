...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/DeleteNotebookSessionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNotebookSessionRequest.
 */
...
public class DeleteNotebookSessionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteNotebookSessionRequest, java.lang.Void> {
         ...
         * @return instance of DeleteNotebookSessionRequest
         */
        public DeleteNotebookSessionRequest buildWithoutInvocationCallback() {
            DeleteNotebookSessionRequest request = new DeleteNotebookSessionRequest();
            request.notebookSessionId = notebookSessionId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteNotebookSessionRequest(notebookSessionId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteNotebookSessionRequest)) {
            return false;
        }

        DeleteNotebookSessionRequest other = (DeleteNotebookSessionRequest) o;
