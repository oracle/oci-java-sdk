...
public class GetMlApplicationInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetMlApplicationInstanceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetMlApplicationInstanceResponse o) {
         ...
         */
        @Override
        public GetMlApplicationInstanceResponse build() {
            return new GetMlApplicationInstanceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, mlApplicationInstance);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMlApplicationInstanceResponse)) {
            return false;
        }

        GetMlApplicationInstanceResponse other = (GetMlApplicationInstanceResponse) o;
