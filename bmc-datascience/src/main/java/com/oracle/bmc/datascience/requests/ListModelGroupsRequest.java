 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelGroupsRequest.
 */
...
public class ListModelGroupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListModelGroupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListModelGroupsRequest(compartmentId, projectId, id, displayName, lifecycleState,
            // createdBy, modelGroupVersionHistoryId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
