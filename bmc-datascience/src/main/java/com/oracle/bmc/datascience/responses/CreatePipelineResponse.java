...
public class CreatePipelineResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datascience.model.Pipeline getPipeline() {
        return pipeline;
    }
    ...
    private CreatePipelineResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.datascience.model.Pipeline pipeline) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreatePipelineResponse> {
         ...
         * @return this builder
         */
        public Builder pipeline(com.oracle.bmc.datascience.model.Pipeline pipeline) {
            this.pipeline = pipeline;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePipelineResponse)) {
            return false;
        }
