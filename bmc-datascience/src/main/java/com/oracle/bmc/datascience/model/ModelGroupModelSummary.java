...
/**
 * Summary information for a model associated with the model group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ModelGroupModelSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ModelGroupModelSummary
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ModelGroupModelSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ModelGroupModelSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModelGroupModelSummary)) {
            return false;
        }
