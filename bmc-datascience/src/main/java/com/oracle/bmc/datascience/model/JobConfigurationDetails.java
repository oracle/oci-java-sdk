...
public class JobConfigurationDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected JobConfigurationDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobConfigurationDetails)) {
            return false;
        }

        JobConfigurationDetails other = (JobConfigurationDetails) o;
