...
/**
 * The workload configuration details <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = WorkloadConfigurationDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ModelDeployWorkloadConfigurationDetails.class,
            name = "MODEL_DEPLOYMENT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = JobRunWorkloadConfigurationDetails.class,
            name = "JOB_RUN")
})
...
public class WorkloadConfigurationDetails
    ...
    protected WorkloadConfigurationDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WorkloadConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkloadConfigurationDetails)) {
            return false;
        }

        WorkloadConfigurationDetails other = (WorkloadConfigurationDetails) o;
