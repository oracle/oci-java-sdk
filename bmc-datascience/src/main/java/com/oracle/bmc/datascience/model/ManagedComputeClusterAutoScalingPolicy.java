...
public final class ManagedComputeClusterAutoScalingPolicy
    ...
    public static class Builder {
         ...
         * cooldown period starts when the managed compute cluster type compute target becomes
         * ACTIVE after the scaling operation.
         */
     ...
     * starts when the managed compute cluster type compute target becomes ACTIVE after the scaling
     * operation.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("coolDownInSeconds")
