...
/**
 * Summary information for a work request. <br>
...
public final class WorkRequestSummary
    ...
    public static class Builder {
        ...
        /**
         * The date and time the work request was accepted in the timestamp format defined by
        ...
        /**
         * The date and time the work request was started in the timestamp format defined by
         * [RFC3339](https://tools.ietf.org/html/rfc3339).
         */
        ...
        /**
         * The date and time the work request was finished in the timestamp format defined by
         * [RFC3339](https://tools.ietf.org/html/rfc3339).
         */
