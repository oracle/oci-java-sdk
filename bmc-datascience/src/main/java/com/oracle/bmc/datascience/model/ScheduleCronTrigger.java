...
/**
 * The scheduled UNIX cron definition. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ScheduleCronTrigger.Builder.class)
...
public final class ScheduleCronTrigger extends ScheduleTrigger {
    ...
    public static class Builder {
        ...
        public ScheduleCronTrigger build() {
            ScheduleCronTrigger model =
                    new ScheduleCronTrigger(this.timeStart, this.timeEnd, this.cronExpression);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleCronTrigger model) {
    ...
    @Deprecated
    public ScheduleCronTrigger(
            java.util.Date timeStart, java.util.Date timeEnd, String cronExpression) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleCronTrigger)) {
            return false;
        }

        ScheduleCronTrigger other = (ScheduleCronTrigger) o;
