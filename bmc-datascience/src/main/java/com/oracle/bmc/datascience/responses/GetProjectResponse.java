...
public class GetProjectResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datascience.model.Project getProject() {
        return project;
    }
    ...
    private GetProjectResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.datascience.model.Project project) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetProjectResponse> {
         ...
         * @return this builder
         */
        public Builder project(com.oracle.bmc.datascience.model.Project project) {
            this.project = project;
            return this;
        }
        ...
        public GetProjectResponse build() {
            return new GetProjectResponse(__httpStatusCode__, headers, etag, opcRequestId, project);
        }
    }
