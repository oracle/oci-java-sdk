...
/**
 * Instance Pool based Infrastructure configuration details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InstancePoolInfrastructureConfigurationDetails.Builder.class)
...
public final class InstancePoolInfrastructureConfigurationDetails
        extends InfrastructureConfigurationDetails {
    ...
    public static class Builder {
        ...
        public InstancePoolInfrastructureConfigurationDetails build() {
            InstancePoolInfrastructureConfigurationDetails model =
                    new InstancePoolInfrastructureConfigurationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InstancePoolInfrastructureConfigurationDetails model) {
    ...
    @Deprecated
    public InstancePoolInfrastructureConfigurationDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InstancePoolInfrastructureConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstancePoolInfrastructureConfigurationDetails)) {
            return false;
        }

        InstancePoolInfrastructureConfigurationDetails other =
                (InstancePoolInfrastructureConfigurationDetails) o;
