...
public class DeactivateModelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeactivateModelResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeactivateModelResponse> {
         ...
         */
        @Override
        public Builder copy(DeactivateModelResponse o) {
         ...
         */
        @Override
        public DeactivateModelResponse build() {
            return new DeactivateModelResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeactivateModelResponse)) {
            return false;
        }

        DeactivateModelResponse other = (DeactivateModelResponse) o;
