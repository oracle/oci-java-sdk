...
public class HeadStepArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private HeadStepArtifactResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<HeadStepArtifactResponse> {
         ...
         */
        @Override
        public Builder copy(HeadStepArtifactResponse o) {
         ...
         */
        @Override
        public HeadStepArtifactResponse build() {
            return new HeadStepArtifactResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadStepArtifactResponse)) {
            return false;
        }

        HeadStepArtifactResponse other = (HeadStepArtifactResponse) o;
