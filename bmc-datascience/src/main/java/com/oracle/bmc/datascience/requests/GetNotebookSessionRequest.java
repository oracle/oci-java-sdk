...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/GetNotebookSessionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNotebookSessionRequest.
 */
...
public class GetNotebookSessionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetNotebookSessionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetNotebookSessionRequest o) {
         ...
         *
         * @return instance of GetNotebookSessionRequest
         */
        public GetNotebookSessionRequest build() {
            GetNotebookSessionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetNotebookSessionRequest
         */
        public GetNotebookSessionRequest buildWithoutInvocationCallback() {
            GetNotebookSessionRequest request = new GetNotebookSessionRequest();
            request.notebookSessionId = notebookSessionId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetNotebookSessionRequest(notebookSessionId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().notebookSessionId(notebookSessionId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetNotebookSessionRequest)) {
            return false;
        }

        GetNotebookSessionRequest other = (GetNotebookSessionRequest) o;
