...
public class CreateModelArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateModelArtifactResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateModelArtifactResponse)) {
            return false;
        }

        CreateModelArtifactResponse other = (CreateModelArtifactResponse) o;
