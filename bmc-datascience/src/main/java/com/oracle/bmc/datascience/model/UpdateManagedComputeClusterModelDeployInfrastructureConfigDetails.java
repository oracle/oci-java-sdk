...
/**
 * Infrastructure configuration details for updating a model deploy of managed compute cluster type
 * compute target. You can update the {@code modelDeploymentResourceConfiguration} and {@code
 * scalingPolicy} properties. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails.Builder.class)
...
public final class UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails
    ...
    public static class Builder {
        ...
        public UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails build() {
            UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails model =
                    new UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails(
    ...
    @Deprecated
    public UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails)) {
            return false;
        }

        UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails other =
                (UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails) o;
