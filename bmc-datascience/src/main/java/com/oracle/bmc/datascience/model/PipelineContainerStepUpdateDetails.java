...
/**
 * Update the details for a container step type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PipelineContainerStepUpdateDetails.Builder.class)
...
public final class PipelineContainerStepUpdateDetails extends PipelineStepUpdateDetails {
    ...
    public static class Builder {
        ...
        public PipelineContainerStepUpdateDetails build() {
            PipelineContainerStepUpdateDetails model =
                    new PipelineContainerStepUpdateDetails(
                            this.stepName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PipelineContainerStepUpdateDetails model) {
    ...
    @Deprecated
    public PipelineContainerStepUpdateDetails(
            String stepName,
            String description,
            PipelineStepConfigurationDetails stepConfigurationDetails,
            PipelineInfrastructureConfigurationDetails stepInfrastructureConfigurationDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PipelineContainerStepUpdateDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PipelineContainerStepUpdateDetails)) {
            return false;
        }

        PipelineContainerStepUpdateDetails other = (PipelineContainerStepUpdateDetails) o;
