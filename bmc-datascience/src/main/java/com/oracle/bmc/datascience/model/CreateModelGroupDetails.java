...
/**
 * Parameters needed to create a model group. Model Group is a group of models. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateModelGroupDetails.Builder.class)
...
public final class CreateModelGroupDetails extends CreateBaseModelGroupDetails {
    ...
    public static class Builder {
        ...
        public CreateModelGroupDetails build() {
            CreateModelGroupDetails model =
                    new CreateModelGroupDetails(
                            this.compartmentId,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateModelGroupDetails model) {
    ...
    @Deprecated
    public CreateModelGroupDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateModelGroupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateModelGroupDetails)) {
            return false;
        }

        CreateModelGroupDetails other = (CreateModelGroupDetails) o;
        return java.util.Objects.equals(this.modelGroupDetails, other.modelGroupDetails)
