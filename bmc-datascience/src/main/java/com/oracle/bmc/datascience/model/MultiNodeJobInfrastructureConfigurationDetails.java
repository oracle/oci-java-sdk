...
/**
 * This type should only be used for the infrastructure configuration within node group
 * configuration details for configuring multi-node jobs. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MultiNodeJobInfrastructureConfigurationDetails.Builder.class)
...
public final class MultiNodeJobInfrastructureConfigurationDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MultiNodeJobInfrastructureConfigurationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MultiNodeJobInfrastructureConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MultiNodeJobInfrastructureConfigurationDetails)) {
            return false;
        }

        MultiNodeJobInfrastructureConfigurationDetails other =
