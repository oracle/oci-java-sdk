...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ChangePipelineRunCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangePipelineRunCompartmentRequest.
 */
...
public class ChangePipelineRunCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangePipelineRunCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangePipelineRunCompartmentRequest(pipelineRunId, changePipelineRunCompartmentDetails, opcRequestId, ifMatch);
        }
    }
