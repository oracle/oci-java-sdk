...
public class GetJobArtifactContentConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetJobArtifactContentConverter.class);

    public static com.oracle.bmc.datascience.requests.GetJobArtifactContentRequest interceptRequest(
            com.oracle.bmc.datascience.requests.GetJobArtifactContentRequest request) {
