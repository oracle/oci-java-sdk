...
public final class NotebookSessionShapeConfigDetails
    ...
    public NotebookSessionShapeConfigDetails(
    ...
    public static class Builder {
         ...
         * left bank, it will default to {@code BASELINE_1_1}. The following values are supported:
        ...
        public NotebookSessionShapeConfigDetails build() {
            NotebookSessionShapeConfigDetails model =
                    new NotebookSessionShapeConfigDetails(
     ...
     * bank, it will default to {@code BASELINE_1_1}. The following values are supported:
