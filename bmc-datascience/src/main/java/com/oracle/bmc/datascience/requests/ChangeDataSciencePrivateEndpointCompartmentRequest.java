...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ChangeDataSciencePrivateEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDataSciencePrivateEndpointCompartmentRequest.
 */
...
public class ChangeDataSciencePrivateEndpointCompartmentRequest
    ...
    public static class Builder
         ...
         * Details for changing a private endpoint's compartment.
         *
         * @param changeDataSciencePrivateEndpointCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeDataSciencePrivateEndpointCompartmentDetails(
                com.oracle.bmc.datascience.model.ChangeDataSciencePrivateEndpointCompartmentDetails
                        changeDataSciencePrivateEndpointCompartmentDetails) {
            this.changeDataSciencePrivateEndpointCompartmentDetails =
                    changeDataSciencePrivateEndpointCompartmentDetails;
            return this;
        }
        ...
        public Builder copy(ChangeDataSciencePrivateEndpointCompartmentRequest o) {
            ...
            changeDataSciencePrivateEndpointCompartmentDetails(
                    o.getChangeDataSciencePrivateEndpointCompartmentDetails());
         ...
         */
        public ChangeDataSciencePrivateEndpointCompartmentRequest build() {
        ...
        public Builder body$(
                com.oracle.bmc.datascience.model.ChangeDataSciencePrivateEndpointCompartmentDetails
                        body) {
            changeDataSciencePrivateEndpointCompartmentDetails(body);
            return this;
        }
         ...
         * @return instance of ChangeDataSciencePrivateEndpointCompartmentRequest
         */
        public ChangeDataSciencePrivateEndpointCompartmentRequest buildWithoutInvocationCallback() {
            ChangeDataSciencePrivateEndpointCompartmentRequest request =
                    new ChangeDataSciencePrivateEndpointCompartmentRequest();
            request.dataSciencePrivateEndpointId = dataSciencePrivateEndpointId;
            request.changeDataSciencePrivateEndpointCompartmentDetails =
                    changeDataSciencePrivateEndpointCompartmentDetails;
    ...
    public String toString() {
        ...
        sb.append(",changeDataSciencePrivateEndpointCompartmentDetails=")
                .append(String.valueOf(this.changeDataSciencePrivateEndpointCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDataSciencePrivateEndpointCompartmentRequest)) {
            return false;
        }

        ChangeDataSciencePrivateEndpointCompartmentRequest other =
                (ChangeDataSciencePrivateEndpointCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.dataSciencePrivateEndpointId, other.dataSciencePrivateEndpointId)
                && java.util.Objects.equals(
                        this.changeDataSciencePrivateEndpointCompartmentDetails,
                        other.changeDataSciencePrivateEndpointCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeDataSciencePrivateEndpointCompartmentDetails == null
                                ? 43
                                : this.changeDataSciencePrivateEndpointCompartmentDetails
                                        .hashCode());
