...
public class GetModelCustomMetadatumArtifactContentResponse
    ...
    private GetModelCustomMetadatumArtifactContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetModelCustomMetadatumArtifactContentResponse o) {
         ...
         */
        @Override
        public GetModelCustomMetadatumArtifactContentResponse build() {
            return new GetModelCustomMetadatumArtifactContentResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetModelCustomMetadatumArtifactContentResponse)) {
            return false;
        }

        GetModelCustomMetadatumArtifactContentResponse other =
                (GetModelCustomMetadatumArtifactContentResponse) o;
