...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/CreateNotebookSessionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateNotebookSessionRequest.
 */
...
public class CreateNotebookSessionRequest
    ...
    public static class Builder
        ...
        /**
         * Details for creating a new notebook session.
         * @param createNotebookSessionDetails the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(CreateNotebookSessionRequest o) {
            createNotebookSessionDetails(o.getCreateNotebookSessionDetails());
         ...
         */
        public CreateNotebookSessionRequest build() {
            CreateNotebookSessionRequest request = buildWithoutInvocationCallback();
