...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "actionType",
        defaultImpl = ScheduleAction.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ScheduleHttpAction.class,
            name = "HTTP")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class ScheduleAction extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleAction)) {
            return false;
        }

        ScheduleAction other = (ScheduleAction) o;
