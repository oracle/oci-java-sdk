...
public final class UpdateOcirModelDeploymentEnvironmentConfigurationDetails
    ...
    public static class Builder {
        ...
        /**
         * The chosen specification from predefined set of endpoints a user can access. For example,
         * if the value is 'openai', the user can access OpenAI-compliant endpoints like
         * /v1/completions, /v1/chat/completions, /v1/models, etc., for inference.
         */
        ...
        /**
         * List of custom inference HTTP endpoints configured on the model deployment instance for
         * inferencing.
         */
    ...
    /**
     * The chosen specification from predefined set of endpoints a user can access. For example, if
     * the value is 'openai', the user can access OpenAI-compliant endpoints like /v1/completions,
     * /v1/chat/completions, /v1/models, etc., for inference.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("predictApiSpecification")
