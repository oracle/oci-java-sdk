...
public class GetPipelineRunResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetPipelineRunResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPipelineRunResponse> {
         ...
         */
        @Override
        public Builder copy(GetPipelineRunResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPipelineRunResponse)) {
            return false;
        }

        GetPipelineRunResponse other = (GetPipelineRunResponse) o;
