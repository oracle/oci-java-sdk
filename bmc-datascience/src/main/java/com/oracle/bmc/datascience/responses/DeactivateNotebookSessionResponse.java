...
public class DeactivateNotebookSessionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeactivateNotebookSessionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeactivateNotebookSessionResponse o) {
         ...
         */
        @Override
        public DeactivateNotebookSessionResponse build() {
            return new DeactivateNotebookSessionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeactivateNotebookSessionResponse)) {
            return false;
        }

        DeactivateNotebookSessionResponse other = (DeactivateNotebookSessionResponse) o;
