...
/**
 * The model group configuration details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ModelGroupConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ModelGroupConfigurationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelGroupId"})
    public ModelGroupConfigurationDetails(String modelGroupId) {
        super();
    ...
    public static class Builder {
        ...
        public ModelGroupConfigurationDetails build() {
            ModelGroupConfigurationDetails model =
                    new ModelGroupConfigurationDetails(this.modelGroupId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ModelGroupConfigurationDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModelGroupConfigurationDetails)) {
            return false;
        }

        ModelGroupConfigurationDetails other = (ModelGroupConfigurationDetails) o;
