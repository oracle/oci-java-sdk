...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/DeleteModelDeploymentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteModelDeploymentRequest.
 */
...
public class DeleteModelDeploymentRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteModelDeploymentRequest
         */
        public DeleteModelDeploymentRequest buildWithoutInvocationCallback() {
            DeleteModelDeploymentRequest request = new DeleteModelDeploymentRequest();
            request.modelDeploymentId = modelDeploymentId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteModelDeploymentRequest(modelDeploymentId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteModelDeploymentRequest)) {
            return false;
        }

        DeleteModelDeploymentRequest other = (DeleteModelDeploymentRequest) o;
