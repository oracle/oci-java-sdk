...
/**
 * Managed compute cluster type compute target based model deployment system data. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedComputeClusterModelDeploymentSystemData.Builder.class)
...
public final class ManagedComputeClusterModelDeploymentSystemData
        extends ModelDeploymentSystemData {
    ...
    public static class Builder {
        ...
        public ManagedComputeClusterModelDeploymentSystemData build() {
            ManagedComputeClusterModelDeploymentSystemData model =
                    new ManagedComputeClusterModelDeploymentSystemData(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedComputeClusterModelDeploymentSystemData model) {
    ...
    @Deprecated
    public ManagedComputeClusterModelDeploymentSystemData(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedComputeClusterModelDeploymentSystemData(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterModelDeploymentSystemData)) {
            return false;
        }

        ManagedComputeClusterModelDeploymentSystemData other =
                (ManagedComputeClusterModelDeploymentSystemData) o;
