...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/DeletePipelineRunExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePipelineRunRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190101")
public class DeletePipelineRunRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePipelineRunRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePipelineRunRequest o) {
        ...
        /**
         * Build the instance of DeletePipelineRunRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePipelineRunRequest
         */
        public DeletePipelineRunRequest build() {
            DeletePipelineRunRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePipelineRunRequest
         */
        public DeletePipelineRunRequest buildWithoutInvocationCallback() {
            DeletePipelineRunRequest request = new DeletePipelineRunRequest();
            request.pipelineRunId = pipelineRunId;
            request.deleteRelatedJobRuns = deleteRelatedJobRuns;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeletePipelineRunRequest(pipelineRunId, deleteRelatedJobRuns, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePipelineRunRequest)) {
            return false;
        }

        DeletePipelineRunRequest other = (DeletePipelineRunRequest) o;
