...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ScheduleLogDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ScheduleLogDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"logGroupId", "logId"})
    public ScheduleLogDetails(String logGroupId, String logId) {
        super();
    ...
    public static class Builder {
        ...
        public ScheduleLogDetails build() {
            ScheduleLogDetails model = new ScheduleLogDetails(this.logGroupId, this.logId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleLogDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleLogDetails)) {
            return false;
        }

        ScheduleLogDetails other = (ScheduleLogDetails) o;
