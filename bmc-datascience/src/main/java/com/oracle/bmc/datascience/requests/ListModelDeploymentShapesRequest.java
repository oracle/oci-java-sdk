...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ListModelDeploymentShapesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelDeploymentShapesRequest.
 */
...
public class ListModelDeploymentShapesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListModelDeploymentShapesRequest
         */
        public ListModelDeploymentShapesRequest buildWithoutInvocationCallback() {
            ListModelDeploymentShapesRequest request = new ListModelDeploymentShapesRequest();
            request.compartmentId = compartmentId;
            request.opcRequestId = opcRequestId;
            request.limit = limit;
            request.page = page;
            return request;
            // new ListModelDeploymentShapesRequest(compartmentId, opcRequestId, limit, page);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListModelDeploymentShapesRequest)) {
            return false;
        }

        ListModelDeploymentShapesRequest other = (ListModelDeploymentShapesRequest) o;
