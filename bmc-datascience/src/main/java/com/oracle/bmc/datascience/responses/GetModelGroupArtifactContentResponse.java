...
public class GetModelGroupArtifactContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetModelGroupArtifactContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetModelGroupArtifactContentResponse o) {
         ...
         */
        @Override
        public GetModelGroupArtifactContentResponse build() {
            return new GetModelGroupArtifactContentResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetModelGroupArtifactContentResponse)) {
            return false;
        }

        GetModelGroupArtifactContentResponse other = (GetModelGroupArtifactContentResponse) o;
