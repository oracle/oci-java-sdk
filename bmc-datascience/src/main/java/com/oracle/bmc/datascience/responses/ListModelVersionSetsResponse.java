...
public class ListModelVersionSetsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datascience.model.ModelVersionSetSummary> getItems() {
        return items;
    }
    ...
    private ListModelVersionSetsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcNextPage,
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.ModelVersionSetSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListModelVersionSetsResponse> {
         ...
         */
        @Override
        public Builder copy(ListModelVersionSetsResponse o) {
         ...
         */
        @Override
        public ListModelVersionSetsResponse build() {
            return new ListModelVersionSetsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListModelVersionSetsResponse)) {
            return false;
        }

        ListModelVersionSetsResponse other = (ListModelVersionSetsResponse) o;
