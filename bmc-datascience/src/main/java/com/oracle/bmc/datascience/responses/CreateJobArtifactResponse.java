...
public class CreateJobArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateJobArtifactResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateJobArtifactResponse)) {
            return false;
        }

        CreateJobArtifactResponse other = (CreateJobArtifactResponse) o;
