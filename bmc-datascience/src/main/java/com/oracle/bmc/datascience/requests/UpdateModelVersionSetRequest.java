...
public class UpdateModelVersionSetRequest
    ...
    public static class Builder
        ...
        /**
         * Details for updating a model version set. You can update {@code description} property
         * only.
         */
        private com.oracle.bmc.datascience.model.UpdateModelVersionSetDetails
        ...
        public UpdateModelVersionSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateModelVersionSetRequest(modelVersionSetId, updateModelVersionSetDetails,
