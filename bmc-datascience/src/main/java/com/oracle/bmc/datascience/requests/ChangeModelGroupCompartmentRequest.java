...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ChangeModelGroupCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeModelGroupCompartmentRequest.
 */
...
public class ChangeModelGroupCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeModelGroupCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeModelGroupCompartmentRequest(modelGroupId, changeModelGroupCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
