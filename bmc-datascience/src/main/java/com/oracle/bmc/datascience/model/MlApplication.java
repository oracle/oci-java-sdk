...
/**
 * Resource representing a definition of an AI/ML use-case <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MlApplication.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MlApplication extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MlApplication model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MlApplication)) {
            return false;
        }

        MlApplication other = (MlApplication) o;
