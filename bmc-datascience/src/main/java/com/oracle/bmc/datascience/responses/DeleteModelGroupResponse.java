...
public class DeleteModelGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteModelGroupResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteModelGroupResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteModelGroupResponse o) {
        ...
        public DeleteModelGroupResponse build() {
            return new DeleteModelGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteModelGroupResponse)) {
            return false;
        }
