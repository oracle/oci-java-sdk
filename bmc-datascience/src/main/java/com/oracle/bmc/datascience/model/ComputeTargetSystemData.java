...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = ComputeTargetSystemData.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = ManagedComputeClusterSystemData.class,
        name = "MANAGED_COMPUTE_CLUSTER"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class ComputeTargetSystemData extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ComputeTargetSystemData() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeTargetSystemData)) {
            return false;
        }

        ComputeTargetSystemData other = (ComputeTargetSystemData) o;
