...
/**
 * A repeating action. Examples: * Invoke a ML Pipeline Run once an hour. * Call ML Job Run every
...
public final class Schedule extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * The last schedule execution time. Format is defined by RFC3339. Example: {@code
        ...
        /**
         * Details about the action performed by the last schedule execution. Example: {@code
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the compartment where you want to create the schedule.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
    ...
    /**
     * The next scheduled execution time for the schedule. Format is defined by RFC3339. Example:
     * {@code 2022-08-05T01:02:29.600Z}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeNextScheduledRun")
    ...
    /**
     * Details about the action performed by the last schedule execution. Example: {@code Invoked ML
     * Application trigger.}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("lastScheduleRunDetails")
