...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/CreatePipelineRunExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePipelineRunRequest.
 */
...
public class CreatePipelineRunRequest
    ...
    public com.oracle.bmc.datascience.model.CreatePipelineRunDetails getBody$() {
        return createPipelineRunDetails;
    }
    ...
    public static class Builder
         ...
         */
        public Builder createPipelineRunDetails(
                com.oracle.bmc.datascience.model.CreatePipelineRunDetails
        ...
        public CreatePipelineRunRequest build() {
            CreatePipelineRunRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.datascience.model.CreatePipelineRunDetails body) {
            createPipelineRunDetails(body);
            return this;
        }
         ...
         * @return instance of CreatePipelineRunRequest
         */
        public CreatePipelineRunRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePipelineRunRequest)) {
            return false;
        }

        CreatePipelineRunRequest other = (CreatePipelineRunRequest) o;
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createPipelineRunDetails == null
                                ? 43
                                : this.createPipelineRunDetails.hashCode());
        result =
                (result * PRIME)
