...
public final class PipelineRunLogDetails
    ...
    public static class Builder {
        ...
        public PipelineRunLogDetails build() {
            PipelineRunLogDetails model = new PipelineRunLogDetails(this.logGroupId, this.logId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PipelineRunLogDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PipelineRunLogDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PipelineRunLogDetails)) {
            return false;
        }

        PipelineRunLogDetails other = (PipelineRunLogDetails) o;
