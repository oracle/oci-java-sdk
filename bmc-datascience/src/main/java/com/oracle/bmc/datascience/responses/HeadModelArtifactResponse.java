...
public class HeadModelArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<HeadModelArtifactResponse> {
         ...
         */
        @Override
        public Builder copy(HeadModelArtifactResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadModelArtifactResponse)) {
            return false;
        }

        HeadModelArtifactResponse other = (HeadModelArtifactResponse) o;
