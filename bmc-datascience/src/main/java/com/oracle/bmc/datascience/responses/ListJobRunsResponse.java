...
public class ListJobRunsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListJobRunsResponse(
            ...
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.JobRunSummary> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.datascience.model.JobRunSummary> items) {
            this.items = items;
            return this;
        }
