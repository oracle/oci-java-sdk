...
public final class NotebookSessionGitRepoConfigDetails {
    ...
    public static class Builder {
        ...
        public NotebookSessionGitRepoConfigDetails build() {
            NotebookSessionGitRepoConfigDetails __instance__ =
                    new NotebookSessionGitRepoConfigDetails(url);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotebookSessionGitRepoConfigDetails o) {
            Builder copiedBuilder = url(o.getUrl());
