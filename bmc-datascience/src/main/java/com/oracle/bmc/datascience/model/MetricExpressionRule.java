...
/**
 * The metric expression rule base. <br>
...
public class MetricExpressionRule
     ...
     *
     * <p>{@code PREDEFINED_EXPRESSION}: An expression built using CPU or Memory metrics emitted by
     * the Model Deployment Monitoring.
     *
     * <p>{@code CUSTOM_EXPRESSION}: A custom Monitoring Query Language (MQL) expression.
     */
