...
public class ListPipelinesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datascience.model.PipelineSummary> getItems() {
        return items;
    }
    ...
    private ListPipelinesResponse(
            ...
            String opcNextPage,
            String opcPrevPage,
            java.util.List<com.oracle.bmc.datascience.model.PipelineSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListPipelinesResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPipelinesResponse)) {
            return false;
        }

        ListPipelinesResponse other = (ListPipelinesResponse) o;
