...
/**
 * Notebook sessions are interactive coding environments for data scientists. <br>
...
public final class NotebookSession
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotebookSession model) {
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the project associated with the notebook session.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("projectId")
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the user who created the notebook session.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("createdBy")
    ...
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * the notebook session's compartment.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
