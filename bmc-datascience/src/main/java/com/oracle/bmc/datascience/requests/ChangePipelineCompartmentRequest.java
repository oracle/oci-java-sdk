...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ChangePipelineCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangePipelineCompartmentRequest.
 */
...
public class ChangePipelineCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangePipelineCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangePipelineCompartmentRequest(pipelineId, changePipelineCompartmentDetails, opcRequestId, ifMatch);
        }
    }
