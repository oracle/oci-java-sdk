...
public class HeadModelGroupArtifactResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private HeadModelGroupArtifactResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(HeadModelGroupArtifactResponse o) {
         ...
         */
        @Override
        public HeadModelGroupArtifactResponse build() {
            return new HeadModelGroupArtifactResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadModelGroupArtifactResponse)) {
            return false;
        }

        HeadModelGroupArtifactResponse other = (HeadModelGroupArtifactResponse) o;
