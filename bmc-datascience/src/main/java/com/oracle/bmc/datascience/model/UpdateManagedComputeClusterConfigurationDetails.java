...
/**
 * The configuration details for the managed compute cluster type compute target. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateManagedComputeClusterConfigurationDetails.Builder.class)
...
public final class UpdateManagedComputeClusterConfigurationDetails
        extends UpdateComputeConfigurationDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {

        @com.fasterxml.jackson.annotation.JsonProperty("instanceConfiguration")
        private UpdateManagedComputeClusterInstanceConfigurationDetails instanceConfiguration;

        public Builder instanceConfiguration(
                UpdateManagedComputeClusterInstanceConfigurationDetails instanceConfiguration) {
        ...
        public UpdateManagedComputeClusterConfigurationDetails build() {
            UpdateManagedComputeClusterConfigurationDetails model =
                    new UpdateManagedComputeClusterConfigurationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateManagedComputeClusterConfigurationDetails model) {
    ...
    @Deprecated
    public UpdateManagedComputeClusterConfigurationDetails(
            UpdateManagedComputeClusterInstanceConfigurationDetails instanceConfiguration,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("instanceConfiguration")
    private final UpdateManagedComputeClusterInstanceConfigurationDetails instanceConfiguration;

    public UpdateManagedComputeClusterInstanceConfigurationDetails getInstanceConfiguration() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateManagedComputeClusterConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagedComputeClusterConfigurationDetails)) {
            return false;
        }

        UpdateManagedComputeClusterConfigurationDetails other =
                (UpdateManagedComputeClusterConfigurationDetails) o;
