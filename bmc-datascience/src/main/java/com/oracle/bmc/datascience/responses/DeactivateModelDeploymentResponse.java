...
public class DeactivateModelDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeactivateModelDeploymentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public DeactivateModelDeploymentResponse build() {
            return new DeactivateModelDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeactivateModelDeploymentResponse)) {
            return false;
        }

        DeactivateModelDeploymentResponse other = (DeactivateModelDeploymentResponse) o;
