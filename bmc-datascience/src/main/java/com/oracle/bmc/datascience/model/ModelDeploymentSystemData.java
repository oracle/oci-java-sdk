...
/**
 * Model deployment system data. <br>
...
public class ModelDeploymentSystemData
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ModelDeploymentSystemData)) {
            return false;
        }
    ...
    public enum SystemInfraType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(SystemInfraType.class);

        private final String value;
        private static java.util.Map<String, SystemInfraType> map;

        static {
            map = new java.util.HashMap<>();
            for (SystemInfraType v : SystemInfraType.values()) {
        ...
        public static SystemInfraType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'SystemInfraType', returning UnknownEnumValue",
                    key);
