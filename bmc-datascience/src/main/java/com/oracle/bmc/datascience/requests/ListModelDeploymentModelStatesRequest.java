...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/ListModelDeploymentModelStatesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelDeploymentModelStatesRequest.
 */
...
public class ListModelDeploymentModelStatesRequest
    ...
    public static class Builder
        ...
        public ListModelDeploymentModelStatesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListModelDeploymentModelStatesRequest(modelDeploymentId, compartmentId, projectId, displayName, inferenceKey, modelId, opcRequestId, limit, page, sortOrder, sortBy, opcRetryToken);
        }
    }
