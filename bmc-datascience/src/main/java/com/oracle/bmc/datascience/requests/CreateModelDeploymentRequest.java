...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/CreateModelDeploymentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateModelDeploymentRequest.
 */
...
public class CreateModelDeploymentRequest
    ...
    public static class Builder
        ...
        public CreateModelDeploymentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateModelDeploymentRequest(createModelDeploymentDetails, opcRequestId, opcRetryToken, opcParentRptUrl);
        }
    }
