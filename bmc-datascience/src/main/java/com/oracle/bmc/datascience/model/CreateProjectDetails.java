...
/**
 * Parameters needed to create a new project. Projects enable users to organize their data science
 * work. <br>
...
public final class CreateProjectDetails
    ...
    public static class Builder {
         ...
         * of the compartment to create the project in.
         */
     ...
     * the compartment to create the project in.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
