...
public class ListFastLaunchJobConfigsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListFastLaunchJobConfigsResponse(
            ...
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.FastLaunchJobConfigSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListFastLaunchJobConfigsResponse)) {
            return false;
        }

        ListFastLaunchJobConfigsResponse other = (ListFastLaunchJobConfigsResponse) o;
