...
public class ListDataSciencePrivateEndpointsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListDataSciencePrivateEndpointsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.DataSciencePrivateEndpointSummary>
                    items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDataSciencePrivateEndpointsResponse)) {
            return false;
        }

        ListDataSciencePrivateEndpointsResponse other = (ListDataSciencePrivateEndpointsResponse) o;
