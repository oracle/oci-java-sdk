...
/**
 * Details for a threshold-based autoscaling policy to enable on the managed compute cluster type
 * compute target . In a threshold-based autoscaling policy, an autoscaling action is triggered when
 * a performance metric meets or exceeds a threshold. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails.Builder.class)
...
public final class ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails
        extends ManagedComputeClusterAutoScalingPolicyDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {
        /** The list of autoscaling policy rules. */
        @com.fasterxml.jackson.annotation.JsonProperty("rules")
        private java.util.List<ManagedComputeClusterMetricExpressionRule> rules;
         ...
         * @return this builder
         */
        public Builder rules(java.util.List<ManagedComputeClusterMetricExpressionRule> rules) {
            this.rules = rules;
         ...
         * autoscaling is enabled. Note that anytime this value is updated, the number of instances
         * will be reset to this value. After autoscaling retrieves performance metrics, the number
         * of instances is automatically adjusted from this initial number to a number that is based
        ...
        public ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails build() {
            ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails model =
                    new ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails(
                            this.rules,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails model) {
    ...
    @Deprecated
    public ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails(
            java.util.List<ManagedComputeClusterMetricExpressionRule> rules,
    ...
    /** The list of autoscaling policy rules. */
    @com.fasterxml.jackson.annotation.JsonProperty("rules")
    private final java.util.List<ManagedComputeClusterMetricExpressionRule> rules;
     ...
     * @return the value
     */
    public java.util.List<ManagedComputeClusterMetricExpressionRule> getRules() {
        return rules;
    }

    /**
     * For a threshold-based autoscaling policy, this value is the maximum number of instances the
     * managed compute cluster type compute target is allowed to increase to (scale out).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("maximumInstanceCount")
     ...
     * managed compute cluster type compute target is allowed to decrease to (scale in).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("minimumInstanceCount")
     ...
     * launch in the managed compute cluster type compute target immediately after autoscaling is
     * enabled. Note that anytime this value is updated, the number of instances will be reset to
     * this value. After autoscaling retrieves performance metrics, the number of instances is
     * automatically adjusted from this initial number to a number that is based on the limits that
     * you set.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("initialInstanceCount")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails)) {
            return false;
        }

        ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails other =
                (ManagedComputeClusterThresholdBasedAutoScalingPolicyDetails) o;
