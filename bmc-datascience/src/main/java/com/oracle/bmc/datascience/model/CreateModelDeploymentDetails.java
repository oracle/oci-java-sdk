 ...
 * to perform predictions from the model hosted on an HTTP server. <br>
...
public final class CreateModelDeploymentDetails
    ...
    public CreateModelDeploymentDetails(
            String displayName,
            String description,
            String projectId,
    ...
    public static class Builder {
         ...
         * of the project to associate with the model deployment.
         */
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
         * of the compartment where you want to create the model deployment.
         */
        ...
        public CreateModelDeploymentDetails build() {
            CreateModelDeploymentDetails model =
