...
/**
 * Summary of the MlApplicationInstance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MlApplicationInstanceSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MlApplicationInstanceSummary
    ...
    public MlApplicationInstanceSummary(
            String id,
            String displayName,
            ...
            MlApplicationInstance.LifecycleState lifecycleState,
            MlApplicationInstance.LifecycleSubstate lifecycleSubstate,
    ...
    public static class Builder {
        ...
        private MlApplicationInstance.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(MlApplicationInstance.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        private MlApplicationInstance.LifecycleSubstate lifecycleSubstate;
        ...
        public MlApplicationInstanceSummary build() {
            MlApplicationInstanceSummary model =
                    new MlApplicationInstanceSummary(
                            this.id,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MlApplicationInstanceSummary model) {
    ...
    /** The current state of the MlApplicationInstance. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final MlApplicationInstance.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public MlApplicationInstance.LifecycleState getLifecycleState() {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleSubstate")
    private final MlApplicationInstance.LifecycleSubstate lifecycleSubstate;
     ...
     * @return the value
     */
    public MlApplicationInstance.LifecycleSubstate getLifecycleSubstate() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MlApplicationInstanceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MlApplicationInstanceSummary)) {
            return false;
        }

        MlApplicationInstanceSummary other = (MlApplicationInstanceSummary) o;
