...
/**
 * An expression built using CPU or Memory metrics for triggering an autoscaling action on the
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedComputeClusterPredefinedMetricExpressionRule.Builder.class)
...
public final class ManagedComputeClusterPredefinedMetricExpressionRule
    ...
    public static class Builder {
        ...
        private ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration
        ...
        public ManagedComputeClusterPredefinedMetricExpressionRule build() {
            ManagedComputeClusterPredefinedMetricExpressionRule model =
                    new ManagedComputeClusterPredefinedMetricExpressionRule(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedComputeClusterPredefinedMetricExpressionRule model) {
    ...
    @Deprecated
    public ManagedComputeClusterPredefinedMetricExpressionRule(
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("scaleInConfiguration")
    private final ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration
            scaleInConfiguration;

    public ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedComputeClusterPredefinedMetricExpressionRule(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterPredefinedMetricExpressionRule)) {
            return false;
        }

        ManagedComputeClusterPredefinedMetricExpressionRule other =
                (ManagedComputeClusterPredefinedMetricExpressionRule) o;
