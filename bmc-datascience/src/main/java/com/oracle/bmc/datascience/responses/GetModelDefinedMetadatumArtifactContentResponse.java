...
public class GetModelDefinedMetadatumArtifactContentResponse
    ...
    private GetModelDefinedMetadatumArtifactContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetModelDefinedMetadatumArtifactContentResponse o) {
         ...
         */
        @Override
        public GetModelDefinedMetadatumArtifactContentResponse build() {
            return new GetModelDefinedMetadatumArtifactContentResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetModelDefinedMetadatumArtifactContentResponse)) {
            return false;
        }

        GetModelDefinedMetadatumArtifactContentResponse other =
                (GetModelDefinedMetadatumArtifactContentResponse) o;
