...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedComputeClusterInstanceConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ManagedComputeClusterInstanceConfigurationDetails
    ...
    public static class Builder {
        ...
        public ManagedComputeClusterInstanceConfigurationDetails build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterInstanceConfigurationDetails)) {
            return false;
        }
