...
public class UpdateNotebookSessionRequest
    ...
    /**
     * Details for updating a notebook session. {@code notebookSessionConfigurationDetails} can only
     * be updated while the notebook session is in the {@code INACTIVE} state. Changes to the {@code
     * notebookSessionConfigurationDetails} take effect the next time the {@code
     * ActivateNotebookSession} action is invoked on the notebook session resource.
     */
    ...
    public static class Builder
        ...
        /**
         * Details for updating a notebook session. {@code notebookSessionConfigurationDetails} can
         * only be updated while the notebook session is in the {@code INACTIVE} state. Changes to
         * the {@code notebookSessionConfigurationDetails} take effect the next time the {@code
         * ActivateNotebookSession} action is invoked on the notebook session resource.
         */
        private com.oracle.bmc.datascience.model.UpdateNotebookSessionDetails
        ...
        public UpdateNotebookSessionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateNotebookSessionRequest(notebookSessionId, updateNotebookSessionDetails,
