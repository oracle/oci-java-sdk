...
/**
 * Details for updating a notebook session. {@code notebookSessionConfigurationDetails} can only be
 * updated while the notebook session is in the {@code INACTIVE} state. Changes to the {@code
 * notebookSessionConfigurationDetails} take effect the next time the {@code
 * ActivateNotebookSession} action is invoked on the notebook session resource. <br>
