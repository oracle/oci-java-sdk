...
public class ListModelDeploymentShapesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListModelDeploymentShapesResponse(
            ...
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.ModelDeploymentShapeSummary> items) {
    ...
    public static class Builder {
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.datascience.model.ModelDeploymentShapeSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListModelDeploymentShapesResponse)) {
            return false;
        }

        ListModelDeploymentShapesResponse other = (ListModelDeploymentShapesResponse) o;
