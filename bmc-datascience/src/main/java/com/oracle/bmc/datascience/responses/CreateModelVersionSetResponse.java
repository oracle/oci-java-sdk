...
public class CreateModelVersionSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateModelVersionSetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateModelVersionSetResponse> {
         ...
         */
        @Override
        public Builder copy(CreateModelVersionSetResponse o) {
         ...
         */
        @Override
        public CreateModelVersionSetResponse build() {
            return new CreateModelVersionSetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateModelVersionSetResponse)) {
            return false;
        }

        CreateModelVersionSetResponse other = (CreateModelVersionSetResponse) o;
