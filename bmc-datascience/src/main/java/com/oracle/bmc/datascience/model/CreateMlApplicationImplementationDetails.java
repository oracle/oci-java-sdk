...
/**
 * The information about new MlApplicationImplementation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMlApplicationImplementationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateMlApplicationImplementationDetails
    ...
    public CreateMlApplicationImplementationDetails(
            String name,
            String mlApplicationId,
            ImplementationLogging logging,
    ...
    public static class Builder {
        ...
        private ImplementationLogging logging;

        public Builder logging(ImplementationLogging logging) {
            this.logging = logging;
        ...
        public CreateMlApplicationImplementationDetails build() {
            CreateMlApplicationImplementationDetails model =
                    new CreateMlApplicationImplementationDetails(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMlApplicationImplementationDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("logging")
    private final ImplementationLogging logging;

    public ImplementationLogging getLogging() {
        return logging;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMlApplicationImplementationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMlApplicationImplementationDetails)) {
            return false;
        }

        CreateMlApplicationImplementationDetails other =
                (CreateMlApplicationImplementationDetails) o;
