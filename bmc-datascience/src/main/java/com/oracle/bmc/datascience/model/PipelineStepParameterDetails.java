...
/**
 * Pipeline step parameter details <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = PipelineStepParameterDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = PipelineDefaultStepParameterDetails.class,
            name = "DEFAULT")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class PipelineStepParameterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected PipelineStepParameterDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PipelineStepParameterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PipelineStepParameterDetails)) {
            return false;
        }

        PipelineStepParameterDetails other = (PipelineStepParameterDetails) o;
