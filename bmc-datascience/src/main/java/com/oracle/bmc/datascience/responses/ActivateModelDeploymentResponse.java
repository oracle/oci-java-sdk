...
public class ActivateModelDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public ActivateModelDeploymentResponse build() {
            return new ActivateModelDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateModelDeploymentResponse)) {
            return false;
        }

        ActivateModelDeploymentResponse other = (ActivateModelDeploymentResponse) o;
