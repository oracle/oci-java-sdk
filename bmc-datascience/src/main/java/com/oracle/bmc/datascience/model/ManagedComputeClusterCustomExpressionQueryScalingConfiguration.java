...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManagedComputeClusterCustomExpressionQueryScalingConfiguration.Builder.class)
...
public final class ManagedComputeClusterCustomExpressionQueryScalingConfiguration
        extends ManagedComputeClusterScalingConfiguration {
    ...
    public static class Builder {
         ...
         * alarm: {@code CPUUtilization[1m]{resourceId = "Compute_Target_OCID"}.grouping().mean() <
         * 25 CPUUtilization[1m]{resourceId = "Compute_Target_OCID"}.grouping().mean() > 75 }
         */
        ...
        public ManagedComputeClusterCustomExpressionQueryScalingConfiguration build() {
            ManagedComputeClusterCustomExpressionQueryScalingConfiguration model =
                    new ManagedComputeClusterCustomExpressionQueryScalingConfiguration(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagedComputeClusterCustomExpressionQueryScalingConfiguration model) {
     ...
     * "Compute_Target_OCID"}.grouping().mean() < 25 CPUUtilization[1m]{resourceId =
     * "Compute_Target_OCID"}.grouping().mean() > 75 }
     */
    @com.fasterxml.jackson.annotation.JsonProperty("query")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ManagedComputeClusterCustomExpressionQueryScalingConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagedComputeClusterCustomExpressionQueryScalingConfiguration)) {
            return false;
        }

        ManagedComputeClusterCustomExpressionQueryScalingConfiguration other =
                (ManagedComputeClusterCustomExpressionQueryScalingConfiguration) o;
