...
public class UpdateNotebookSessionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateNotebookSessionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateNotebookSessionResponse o) {
        ...
        public UpdateNotebookSessionResponse build() {
            return new UpdateNotebookSessionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNotebookSessionResponse)) {
            return false;
        }

        UpdateNotebookSessionResponse other = (UpdateNotebookSessionResponse) o;
