...
public class UpdateModelVersionSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateModelVersionSetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateModelVersionSetResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateModelVersionSetResponse o) {
         ...
         */
        @Override
        public UpdateModelVersionSetResponse build() {
            return new UpdateModelVersionSetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateModelVersionSetResponse)) {
            return false;
        }

        UpdateModelVersionSetResponse other = (UpdateModelVersionSetResponse) o;
