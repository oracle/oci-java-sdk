...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/UpdateMlApplicationInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateMlApplicationInstanceRequest.
 */
...
public class UpdateMlApplicationInstanceRequest
    ...
    public static class Builder
        ...
        public UpdateMlApplicationInstanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateMlApplicationInstanceRequest(mlApplicationInstanceId, updateMlApplicationInstanceDetails, ifMatch, opcRequestId);
        }
    }
