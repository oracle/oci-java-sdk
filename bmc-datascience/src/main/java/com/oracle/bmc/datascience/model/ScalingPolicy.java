...
/**
 * The scaling policy to apply to each model of the deployment. <br>
...
public class ScalingPolicy extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
