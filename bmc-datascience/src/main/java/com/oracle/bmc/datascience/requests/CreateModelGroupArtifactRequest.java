...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datascience/CreateModelGroupArtifactExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateModelGroupArtifactRequest.
 */
...
public class CreateModelGroupArtifactRequest
    ...
    public static class Builder
        ...
        public CreateModelGroupArtifactRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateModelGroupArtifactRequest(modelGroupId, contentLength, modelGroupArtifact, opcRequestId, opcRetryToken, contentDisposition, ifMatch);
        }
    }
