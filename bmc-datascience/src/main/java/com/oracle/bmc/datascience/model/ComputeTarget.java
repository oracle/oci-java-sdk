...
public final class ComputeTarget extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * Metadata for the compute target. The size of metadata must be less than 2048 bytes. Key
         * should be under 32 characters. Key should contain only letters, digits and underscore (_)
         * Key should start with a letter. Key should have at least 2 characters. Key should not end
         * with underscore eg. {@code TEST_} Key if added cannot be empty. Value can be empty. No
         * specific size limits on individual Values. But overall metadata is limited to 2048 bytes.
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * user who created the compute target.
         */
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * compartment associated with the compute target.
         */
    ...
    /**
     * Metadata for the compute target. The size of metadata must be less than 2048 bytes. Key
     * should be under 32 characters. Key should contain only letters, digits and underscore (_) Key
     * should start with a letter. Key should have at least 2 characters. Key should not end with
     * underscore eg. {@code TEST_} Key if added cannot be empty. Value can be empty. No specific
     * size limits on individual Values. But overall metadata is limited to 2048 bytes. Key can't be
     * reserved Compute Target metadata.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("metadata")
     ...
     * who created the compute target.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("createdBy")
