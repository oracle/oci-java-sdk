...
public class ListContainersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.datascience.model.ContainerSummary} instances. */
    private java.util.List<com.oracle.bmc.datascience.model.ContainerSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datascience.model.ContainerSummary> getItems() {
        return items;
    }
    ...
    private ListContainersResponse(
            ...
            String opcPrevPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.datascience.model.ContainerSummary> items) {
