...
public class ServiceManagerProxyAsyncClient implements ServiceManagerProxyAsync {
    /**
    ...
    public static class Builder
        ...
        public ServiceManagerProxyAsyncClient build(
            ...
            return new ServiceManagerProxyAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<GetServiceEnvironmentResponse> getServiceEnvironment(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async getServiceEnvironment");
        final GetServiceEnvironmentRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetServiceEnvironmentRequest, GetServiceEnvironmentResponse>,
                        java.util.concurrent.Future<GetServiceEnvironmentResponse>>
    ...
    public java.util.concurrent.Future<ListServiceEnvironmentsResponse> listServiceEnvironments(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async listServiceEnvironments");
        final ListServiceEnvironmentsRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListServiceEnvironmentsRequest, ListServiceEnvironmentsResponse>,
                        java.util.concurrent.Future<ListServiceEnvironmentsResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
