...
public interface ServiceManagerProxy extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemanagerproxy/GetServiceEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetServiceEnvironment API.
     */
     ...
     * The specifics of the default retry strategy are described here https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *
     * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/servicemanagerproxy/ListServiceEnvironmentsExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListServiceEnvironments API.
     */
    ListServiceEnvironmentsResponse listServiceEnvironments(ListServiceEnvironmentsRequest request);
     ...
     */
    ServiceManagerProxyPaginators getPaginators();
}
