 ...
 * to any list operations of ServiceManagerProxy where multiple pages of data may be fetched. Two
...
public class ServiceManagerProxyPaginators {
     ...
     * listServiceEnvironments operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.servicemanagerproxy.model.ServiceEnvironmentSummary} objects contained in
     * responses from the listServiceEnvironments operation. This iterable will fetch more data from
