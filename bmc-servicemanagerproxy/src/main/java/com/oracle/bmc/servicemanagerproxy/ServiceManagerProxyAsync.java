...
public interface ServiceManagerProxyAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetServiceEnvironmentResponse> getServiceEnvironment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListServiceEnvironmentsResponse> listServiceEnvironments(
