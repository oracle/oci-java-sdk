...
public class GenerateEnrichmentJobClient extends com.oracle.bmc.http.internal.BaseSyncClient
        implements GenerateEnrichmentJob {
    ...
    public static class Builder
        ...
        public GenerateEnrichmentJobClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new GenerateEnrichmentJobClient(this, authenticationDetailsProvider);
        }
    }
