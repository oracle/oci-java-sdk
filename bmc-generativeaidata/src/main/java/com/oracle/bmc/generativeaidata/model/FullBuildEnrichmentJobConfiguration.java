...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FullBuildEnrichmentJobConfiguration.Builder.class)
...
public final class FullBuildEnrichmentJobConfiguration extends EnrichmentJobConfiguration {
    ...
    public static class Builder {
        ...
        public FullBuildEnrichmentJobConfiguration build() {
            FullBuildEnrichmentJobConfiguration model =
                    new FullBuildEnrichmentJobConfiguration(this.schemaName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FullBuildEnrichmentJobConfiguration model) {
    ...
    @Deprecated
    public FullBuildEnrichmentJobConfiguration(String schemaName) {
        super();
        this.schemaName = schemaName;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FullBuildEnrichmentJobConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FullBuildEnrichmentJobConfiguration)) {
            return false;
        }

        FullBuildEnrichmentJobConfiguration other = (FullBuildEnrichmentJobConfiguration) o;
