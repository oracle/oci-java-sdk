...
/**
 * Async client implementation for CancelEnrichmentJob service. <br>
...
public class CancelEnrichmentJobAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements CancelEnrichmentJobAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CancelEnrichmentJobAsyncClient.class);

    CancelEnrichmentJobAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, CancelEnrichmentJobAsyncClient> {
         ...
         * @return the client
         */
        public CancelEnrichmentJobAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new CancelEnrichmentJobAsyncClient(this, authenticationDetailsProvider);
        }
    }
     ...
     */
    @Deprecated
    public CancelEnrichmentJobAsyncClient(
