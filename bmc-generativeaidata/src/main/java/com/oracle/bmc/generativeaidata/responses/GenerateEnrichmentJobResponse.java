...
public class GenerateEnrichmentJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code EnrichmentJob} instance. */
    ...
    private GenerateEnrichmentJobResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GenerateEnrichmentJobResponse> {
         ...
         */
        @Override
        public Builder copy(GenerateEnrichmentJobResponse o) {
         ...
         */
        @Override
        public GenerateEnrichmentJobResponse build() {
            return new GenerateEnrichmentJobResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateEnrichmentJobResponse)) {
            return false;
        }

        GenerateEnrichmentJobResponse other = (GenerateEnrichmentJobResponse) o;
