...
public class GetEnrichmentJobClient extends com.oracle.bmc.http.internal.BaseSyncClient
        implements GetEnrichmentJob {
        ...
        public GetEnrichmentJobClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new GetEnrichmentJobClient(this, authenticationDetailsProvider, executorService);
        }
    }
