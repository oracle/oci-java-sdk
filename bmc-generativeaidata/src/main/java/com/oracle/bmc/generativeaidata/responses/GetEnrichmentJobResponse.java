...
public class GetEnrichmentJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetEnrichmentJobResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetEnrichmentJobResponse> {
         ...
         */
        @Override
        public Builder copy(GetEnrichmentJobResponse o) {
         ...
         */
        @Override
        public GetEnrichmentJobResponse build() {
            return new GetEnrichmentJobResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, enrichmentJob);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEnrichmentJobResponse)) {
            return false;
        }

        GetEnrichmentJobResponse other = (GetEnrichmentJobResponse) o;
