...
public interface GenerateSqlFromNlJobAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GenerateSqlFromNlResponse> generateSqlFromNl(
            GenerateSqlFromNlRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            GenerateSqlFromNlRequest, GenerateSqlFromNlResponse>
                    handler);
}
