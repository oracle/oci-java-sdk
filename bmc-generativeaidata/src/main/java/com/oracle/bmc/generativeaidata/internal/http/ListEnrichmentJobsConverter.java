...
public class ListEnrichmentJobsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListEnrichmentJobsConverter.class);

    public static com.oracle.bmc.generativeaidata.requests.ListEnrichmentJobsRequest
            interceptRequest(
                    com.oracle.bmc.generativeaidata.requests.ListEnrichmentJobsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.generativeaidata.responses.ListEnrichmentJobsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.generativeaidata.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.generativeaidata.responses.ListEnrichmentJobsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.generativeaidata.responses.ListEnrichmentJobsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.generativeaidata.responses
                                                        .ListEnrichmentJobsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.enrichmentJobCollection(response.getItem());
