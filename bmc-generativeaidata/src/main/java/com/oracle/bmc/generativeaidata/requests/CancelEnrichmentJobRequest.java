...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/generativeaidata/CancelEnrichmentJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CancelEnrichmentJobRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260325")
public class CancelEnrichmentJobRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CancelEnrichmentJobRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(CancelEnrichmentJobRequest o) {
        ...
        /**
         * Build the instance of CancelEnrichmentJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelEnrichmentJobRequest
         */
        public CancelEnrichmentJobRequest build() {
            CancelEnrichmentJobRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CancelEnrichmentJobRequest
         */
        public CancelEnrichmentJobRequest buildWithoutInvocationCallback() {
            CancelEnrichmentJobRequest request = new CancelEnrichmentJobRequest();
            ...
            return request;
            // new CancelEnrichmentJobRequest(semanticStoreId, enrichmentJobId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelEnrichmentJobRequest)) {
            return false;
        }

        CancelEnrichmentJobRequest other = (CancelEnrichmentJobRequest) o;
