...
/**
 * Async client implementation for GetEnrichmentJob service. <br>
...
public class GetEnrichmentJobAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements GetEnrichmentJobAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetEnrichmentJobAsyncClient.class);

    GetEnrichmentJobAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, GetEnrichmentJobAsyncClient> {
         ...
         * @return the client
         */
        public GetEnrichmentJobAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new GetEnrichmentJobAsyncClient(this, authenticationDetailsProvider);
        }
    }
     ...
     */
    @Deprecated
    public GetEnrichmentJobAsyncClient(
