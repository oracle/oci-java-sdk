...
public class ListEnrichmentJobsAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements ListEnrichmentJobsAsync {
    ...
    public static class Builder
        ...
        public ListEnrichmentJobsAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ListEnrichmentJobsAsyncClient(this, authenticationDetailsProvider);
        }
    }
