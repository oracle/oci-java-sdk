 ...
 * to any list operations of EnrichmentJob where multiple pages of data may be fetched. Two styles
...
public class EnrichmentJobPaginators {
    ...
    public EnrichmentJobPaginators(EnrichmentJob client) {
        this.client = client;
    }

    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listEnrichmentJobs operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.generativeaidata.model.EnrichmentJobSummary} objects contained in responses
     * from the listEnrichmentJobs operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.generativeaidata.model.EnrichmentJobSummary} objects contained in
