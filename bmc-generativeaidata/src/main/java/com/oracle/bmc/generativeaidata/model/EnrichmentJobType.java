...
/**
 * Enrichment job type. Currently supported Full Build (All supported objects in a given schema) and
 * Partial Build (Selected tables and/or supported objects in a given schema).
 */
