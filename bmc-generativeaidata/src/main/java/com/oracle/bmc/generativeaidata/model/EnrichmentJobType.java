...
/**
 * Enrichment job type. Supported values are Full Build (all supported objects in a given schema),
 * Partial Build (selected tables and/or supported objects in a given schema), and Delta Refresh
 * (objects in a given schema that have changed since the previous enrichment job).
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260325")
public enum EnrichmentJobType implements com.oracle.bmc.http.internal.BmcEnum {
