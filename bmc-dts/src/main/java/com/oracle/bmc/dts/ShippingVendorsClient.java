...
public class ShippingVendorsClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public ListShippingVendorsResponse listShippingVendors(ListShippingVendorsRequest request) {
        ...
        return clientCall(request, ListShippingVendorsResponse::builder)
                .logger(LOG, "listShippingVendors")
                .serviceDetails("ShippingVendors", "ListShippingVendors", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(ListShippingVendorsRequest::builder)
                .basePath("/20171001")
                .appendPathParam("shippingVendors")
                .accept("application/json")
                .handleBody(
                        com.oracle.bmc.dts.model.ShippingVendors.class,
                        ListShippingVendorsResponse.Builder::shippingVendors)
                .handleResponseHeaderString(
                        "opc-request-id", ListShippingVendorsResponse.Builder::opcRequestId)
                .callSync();
    }
