...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dts/GetTransferApplianceEncryptionPassphraseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTransferApplianceEncryptionPassphraseRequest.
 */
...
public class GetTransferApplianceEncryptionPassphraseRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetTransferApplianceEncryptionPassphraseRequest, java.lang.Void> {
        ...
        public GetTransferApplianceEncryptionPassphraseRequest buildWithoutInvocationCallback() {
            GetTransferApplianceEncryptionPassphraseRequest request =
                    new GetTransferApplianceEncryptionPassphraseRequest();
            request.id = id;
            request.transferApplianceLabel = transferApplianceLabel;
            return request;
            // new GetTransferApplianceEncryptionPassphraseRequest(id, transferApplianceLabel);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTransferApplianceEncryptionPassphraseRequest)) {
            return false;
        }

        GetTransferApplianceEncryptionPassphraseRequest other =
                (GetTransferApplianceEncryptionPassphraseRequest) o;
