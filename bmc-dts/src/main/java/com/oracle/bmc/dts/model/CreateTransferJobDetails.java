...
public final class CreateTransferJobDetails
    ...
    public CreateTransferJobDetails(
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTransferJobDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTransferJobDetails)) {
            return false;
        }

        CreateTransferJobDetails other = (CreateTransferJobDetails) o;
