...
public final class CreateTransferApplianceEntitlementDetails
    ...
    public CreateTransferApplianceEntitlementDetails(
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTransferApplianceEntitlementDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTransferApplianceEntitlementDetails)) {
            return false;
        }

        CreateTransferApplianceEntitlementDetails other =
                (CreateTransferApplianceEntitlementDetails) o;
