...
public class CreateTransferJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /** */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTransferJobResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTransferJobResponse)) {
            return false;
        }

        CreateTransferJobResponse other = (CreateTransferJobResponse) o;
