...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dts/AttachDevicesToTransferPackageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachDevicesToTransferPackageRequest.
 */
...
public class AttachDevicesToTransferPackageRequest
    ...
    public static class Builder
        ...
        public AttachDevicesToTransferPackageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AttachDevicesToTransferPackageRequest(id, transferPackageLabel, attachDevicesDetails, opcRetryToken);
        }
    }
