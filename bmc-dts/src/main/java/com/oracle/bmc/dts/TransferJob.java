...
public interface TransferJob extends AutoCloseable {
     ...
     *     ChangeTransferJobCompartment API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use CreateTransferJob
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use DeleteTransferJob
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetTransferJob API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dts/ListTransferJobsExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListTransferJobs
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use UpdateTransferJob
     *     API.
     */
