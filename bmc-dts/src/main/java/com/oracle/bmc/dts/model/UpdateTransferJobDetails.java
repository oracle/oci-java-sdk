...
public final class UpdateTransferJobDetails
    ...
    public UpdateTransferJobDetails(
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTransferJobDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTransferJobDetails)) {
            return false;
        }

        UpdateTransferJobDetails other = (UpdateTransferJobDetails) o;
