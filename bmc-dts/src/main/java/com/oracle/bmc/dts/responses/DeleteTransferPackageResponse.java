...
public class DeleteTransferPackageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteTransferPackageResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTransferPackageResponse)) {
            return false;
        }

        DeleteTransferPackageResponse other = (DeleteTransferPackageResponse) o;
