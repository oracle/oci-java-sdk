...
public class CreateTransferApplianceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     *
     */
    ...
    private CreateTransferApplianceResponse(
    ...
    public static class Builder {
         ...
         */
        public CreateTransferApplianceResponse build() {
            return new CreateTransferApplianceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTransferApplianceResponse)) {
            return false;
        }

        CreateTransferApplianceResponse other = (CreateTransferApplianceResponse) o;
