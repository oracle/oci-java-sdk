...
public class UpdateTransferJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTransferJobResponse> {
    ...
    public String toString() {
        ...
        sb.append(",transferJob=").append(String.valueOf(transferJob));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTransferJobResponse)) {
            return false;
        }

        UpdateTransferJobResponse other = (UpdateTransferJobResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.transferJob, other.transferJob);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.transferJob == null ? 43 : this.transferJob.hashCode());
        return result;
    }
}
