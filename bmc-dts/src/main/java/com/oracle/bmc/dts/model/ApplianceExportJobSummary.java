...
public class ApplianceExportJobSummary {
    ...
    public static class Builder {
        ...
        public ApplianceExportJobSummary build() {
            ApplianceExportJobSummary __instance__ =
                    new ApplianceExportJobSummary(
                            id,
                            bucketName,
                            displayName,
                            creationTime,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplianceExportJobSummary o) {
