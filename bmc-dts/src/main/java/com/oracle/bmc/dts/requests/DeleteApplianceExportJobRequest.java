...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dts/DeleteApplianceExportJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApplianceExportJobRequest.
 */
...
public class DeleteApplianceExportJobRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteApplianceExportJobRequest o) {
        ...
        /**
         * Build the instance of DeleteApplianceExportJobRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteApplianceExportJobRequest
         */
        public DeleteApplianceExportJobRequest build() {
            DeleteApplianceExportJobRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteApplianceExportJobRequest
         */
        public DeleteApplianceExportJobRequest buildWithoutInvocationCallback() {
            DeleteApplianceExportJobRequest request = new DeleteApplianceExportJobRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApplianceExportJobRequest)) {
            return false;
        }

        DeleteApplianceExportJobRequest other = (DeleteApplianceExportJobRequest) o;
