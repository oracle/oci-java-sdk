...
public interface TransferJobAsync extends AutoCloseable {
    ...
    /**
     * Create a new Transfer Job that corresponds with customer's logical dataset e.g. a DB or a
     * filesystem.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
    ...
    /**
     * Updates a Transfer Job that corresponds with customer's logical dataset e.g. a DB or a
     * filesystem.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
