...
public class DeleteTransferDeviceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteTransferDeviceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteTransferDeviceResponse> {
        ...
        public DeleteTransferDeviceResponse build() {
            return new DeleteTransferDeviceResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTransferDeviceResponse)) {
            return false;
        }

        DeleteTransferDeviceResponse other = (DeleteTransferDeviceResponse) o;
