...
public class GetResourceProfileResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder resourceProfile(
                com.oracle.bmc.cloudguard.model.ResourceProfile resourceProfile) {
            this.resourceProfile = resourceProfile;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",resourceProfile=").append(String.valueOf(resourceProfile));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetResourceProfileResponse)) {
            return false;
        }

        GetResourceProfileResponse other = (GetResourceProfileResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.resourceProfile, other.resourceProfile);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.resourceProfile == null ? 43 : this.resourceProfile.hashCode());
        return result;
    }
}
