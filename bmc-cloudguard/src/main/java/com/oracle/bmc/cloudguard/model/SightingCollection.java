...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SightingCollection.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SightingCollection {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SightingCollection build() {
            SightingCollection __instance__ = new SightingCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SightingCollection o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SightingCollection)) {
            return false;
        }
