...
public class RequestSummarizedResponderExecutionsResponse
    ...
    private RequestSummarizedResponderExecutionsResponse(
        ...
        this.responderExecutionAggregationCollection = responderExecutionAggregationCollection;
    }
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RequestSummarizedResponderExecutionsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            responderExecutionAggregationCollection(o.getResponderExecutionAggregationCollection());
    ...
    public String toString() {
        ...
        sb.append(",responderExecutionAggregationCollection=")
                .append(String.valueOf(responderExecutionAggregationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedResponderExecutionsResponse)) {
            return false;
        }

        RequestSummarizedResponderExecutionsResponse other =
                (RequestSummarizedResponderExecutionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.responderExecutionAggregationCollection,
                        other.responderExecutionAggregationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.responderExecutionAggregationCollection == null
                                ? 43
                                : this.responderExecutionAggregationCollection.hashCode());
        return result;
    }
}
