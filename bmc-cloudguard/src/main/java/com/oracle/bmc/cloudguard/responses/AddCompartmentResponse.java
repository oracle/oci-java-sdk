...
public class AddCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private AddCompartmentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddCompartmentResponse> {
         ...
         */
        @Override
        public Builder copy(AddCompartmentResponse o) {
         ...
         */
        @Override
        public AddCompartmentResponse build() {
            return new AddCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddCompartmentResponse)) {
            return false;
        }

        AddCompartmentResponse other = (AddCompartmentResponse) o;
