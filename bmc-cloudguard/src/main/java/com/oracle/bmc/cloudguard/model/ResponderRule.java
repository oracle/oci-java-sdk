 ...
 * Guard provides.
 *
 * <p>A ResponderRule resource: * Is used as the original source for a rule in an Oracle-managed
 * responder of the specified type. * Is not directly visible in the Cloud Guard UI. * Can\u2019t be
 * modified by users, programmatically or through the UI. * May be modified from time to time by
 * Cloud Guard. <br>
...
public final class ResponderRule extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResponderRule model) {
