...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/ListManagedListsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedListsRequest.
 */
...
public class ListManagedListsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListManagedListsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagedListsRequest(compartmentId, displayName, resourceMetadataOnly, lifecycleState, listType, limit, page, compartmentIdInSubtree, accessLevel, sortOrder, sortBy, opcRequestId);
        }
    }
