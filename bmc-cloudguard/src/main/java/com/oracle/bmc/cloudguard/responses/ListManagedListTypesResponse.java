...
public class ListManagedListTypesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudguard.model.ManagedListTypeCollection
            getManagedListTypeCollection() {
        return managedListTypeCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListManagedListTypesResponse> {
         ...
         * @return this builder
         */
        public Builder managedListTypeCollection(
         ...
         */
        @Override
        public Builder copy(ListManagedListTypesResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",managedListTypeCollection=").append(String.valueOf(managedListTypeCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedListTypesResponse)) {
            return false;
        }

        ListManagedListTypesResponse other = (ListManagedListTypesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.managedListTypeCollection, other.managedListTypeCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.managedListTypeCollection == null
                                ? 43
                                : this.managedListTypeCollection.hashCode());
        return result;
    }
}
