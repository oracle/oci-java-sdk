...
public class ListTargetDetectorRecipesConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTargetDetectorRecipesConverter.class);

    public static com.oracle.bmc.cloudguard.requests.ListTargetDetectorRecipesRequest
            interceptRequest(
                    com.oracle.bmc.cloudguard.requests.ListTargetDetectorRecipesRequest request) {
