...
public final class AttachTargetResponderRecipeDetails {
    ...
    public static class Builder {
        ...
        public AttachTargetResponderRecipeDetails build() {
            AttachTargetResponderRecipeDetails __instance__ =
                    new AttachTargetResponderRecipeDetails(responderRecipeId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachTargetResponderRecipeDetails o) {
            Builder copiedBuilder = responderRecipeId(o.getResponderRecipeId());
