...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/GetDetectorRecipeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDetectorRecipeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200131")
public class GetDetectorRecipeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDetectorRecipeRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetDetectorRecipeRequest
         */
        public GetDetectorRecipeRequest build() {
            GetDetectorRecipeRequest request = buildWithoutInvocationCallback();
        ...
        public GetDetectorRecipeRequest buildWithoutInvocationCallback() {
            GetDetectorRecipeRequest request = new GetDetectorRecipeRequest();
            request.detectorRecipeId = detectorRecipeId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDetectorRecipeRequest(detectorRecipeId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().detectorRecipeId(detectorRecipeId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDetectorRecipeRequest)) {
            return false;
        }

        GetDetectorRecipeRequest other = (GetDetectorRecipeRequest) o;
