...
public class GetSecurityZoneResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSecurityZoneResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSecurityZoneResponse)) {
            return false;
        }

        GetSecurityZoneResponse other = (GetSecurityZoneResponse) o;
