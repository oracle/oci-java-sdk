...
public class UpdateDetectorRecipeDetectorRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public String toString() {
        ...
        sb.append(",detectorRecipeDetectorRule=")
                .append(String.valueOf(detectorRecipeDetectorRule));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDetectorRecipeDetectorRuleResponse)) {
            return false;
        }

        UpdateDetectorRecipeDetectorRuleResponse other =
                (UpdateDetectorRecipeDetectorRuleResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.detectorRecipeDetectorRule, other.detectorRecipeDetectorRule);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.detectorRecipeDetectorRule == null
                                ? 43
                                : this.detectorRecipeDetectorRule.hashCode());
        return result;
    }
}
