...
/**
 * Summary information for a responder recipe. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ResponderRecipeSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ResponderRecipeSummary
    ...
    public static class Builder {
        ...
        public ResponderRecipeSummary build() {
            ResponderRecipeSummary model =
                    new ResponderRecipeSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.owner,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResponderRecipeSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ResponderRecipeSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResponderRecipeSummary)) {
            return false;
        }

        ResponderRecipeSummary other = (ResponderRecipeSummary) o;
