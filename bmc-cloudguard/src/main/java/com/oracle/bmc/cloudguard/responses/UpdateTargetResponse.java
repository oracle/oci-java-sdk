...
public class UpdateTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTargetResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateTargetResponse o) {
         ...
         */
        @Override
        public UpdateTargetResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetResponse)) {
            return false;
        }

        UpdateTargetResponse other = (UpdateTargetResponse) o;
