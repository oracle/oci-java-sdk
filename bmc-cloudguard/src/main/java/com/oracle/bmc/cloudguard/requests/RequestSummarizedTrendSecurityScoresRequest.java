...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/RequestSummarizedTrendSecurityScoresExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestSummarizedTrendSecurityScoresRequest.
 */
...
public class RequestSummarizedTrendSecurityScoresRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of RequestSummarizedTrendSecurityScoresRequest as configured by this builder
         *
        ...
        public RequestSummarizedTrendSecurityScoresRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RequestSummarizedTrendSecurityScoresRequest(compartmentId, timeScoreComputedGreaterThanOrEqualTo, timeScoreComputedLessThanOrEqualTo, limit, page, opcRequestId);
        }
    }
