...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/ListSecurityZonesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSecurityZonesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200131")
public class ListSecurityZonesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSecurityZonesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSecurityZonesRequest o) {
            compartmentId(o.getCompartmentId());
            lifecycleState(o.getLifecycleState());
            displayName(o.getDisplayName());
            id(o.getId());
            securityRecipeId(o.getSecurityRecipeId());
            isRequiredSecurityZonesInSubtree(o.getIsRequiredSecurityZonesInSubtree());
            limit(o.getLimit());
            page(o.getPage());
        ...
        /**
         * Build the instance of ListSecurityZonesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSecurityZonesRequest
         */
        public ListSecurityZonesRequest build() {
            ListSecurityZonesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListSecurityZonesRequest
         */
        public ListSecurityZonesRequest buildWithoutInvocationCallback() {
            ListSecurityZonesRequest request = new ListSecurityZonesRequest();
            request.compartmentId = compartmentId;
            request.lifecycleState = lifecycleState;
            request.displayName = displayName;
            request.id = id;
            request.securityRecipeId = securityRecipeId;
            request.isRequiredSecurityZonesInSubtree = isRequiredSecurityZonesInSubtree;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new ListSecurityZonesRequest(compartmentId, lifecycleState, displayName, id, securityRecipeId, isRequiredSecurityZonesInSubtree, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",isRequiredSecurityZonesInSubtree=")
                .append(String.valueOf(this.isRequiredSecurityZonesInSubtree));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSecurityZonesRequest)) {
            return false;
        }

        ListSecurityZonesRequest other = (ListSecurityZonesRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.isRequiredSecurityZonesInSubtree,
                        other.isRequiredSecurityZonesInSubtree)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.isRequiredSecurityZonesInSubtree == null
                                ? 43
                                : this.isRequiredSecurityZonesInSubtree.hashCode());
