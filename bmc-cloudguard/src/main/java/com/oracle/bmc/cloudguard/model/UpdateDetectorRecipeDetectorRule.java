...
public class UpdateDetectorRecipeDetectorRule {
    ...
    public static class Builder {
        ...
        public UpdateDetectorRecipeDetectorRule build() {
            UpdateDetectorRecipeDetectorRule __instance__ =
                    new UpdateDetectorRecipeDetectorRule(detectorRuleId, details);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDetectorRecipeDetectorRule o) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("details")
    UpdateDetectorRuleDetails details;
