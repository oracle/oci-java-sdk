...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/DeleteDataMaskRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDataMaskRuleRequest.
 */
...
public class DeleteDataMaskRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteDataMaskRuleRequest
         */
        public DeleteDataMaskRuleRequest buildWithoutInvocationCallback() {
            DeleteDataMaskRuleRequest request = new DeleteDataMaskRuleRequest();
            request.dataMaskRuleId = dataMaskRuleId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDataMaskRuleRequest(dataMaskRuleId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDataMaskRuleRequest)) {
            return false;
        }

        DeleteDataMaskRuleRequest other = (DeleteDataMaskRuleRequest) o;
