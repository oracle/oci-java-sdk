...
/**
 * Adhoc query result resource from running on a resource. <br>
...
public final class AdhocQueryResultSummary
    ...
    /**
     * The region this adhoc work request is running in, needed for tracking when work request is
     * synced to reporting region
     */
    @com.fasterxml.jackson.annotation.JsonProperty("region")
