...
public class CreateTargetDetectorRecipeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateTargetDetectorRecipeResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateTargetDetectorRecipeResponse o) {
         ...
         */
        public CreateTargetDetectorRecipeResponse build() {
            return new CreateTargetDetectorRecipeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTargetDetectorRecipeResponse)) {
            return false;
        }

        CreateTargetDetectorRecipeResponse other = (CreateTargetDetectorRecipeResponse) o;
