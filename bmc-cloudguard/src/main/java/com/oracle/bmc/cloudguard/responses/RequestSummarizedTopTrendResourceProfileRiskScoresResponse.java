...
public class RequestSummarizedTopTrendResourceProfileRiskScoresResponse
    ...
    public com.oracle.bmc.cloudguard.model.ResourceProfileRiskScoreAggregationSummaryCollection
            getResourceProfileRiskScoreAggregationSummaryCollection() {
        return resourceProfileRiskScoreAggregationSummaryCollection;
    }
    ...
    private RequestSummarizedTopTrendResourceProfileRiskScoresResponse(
        ...
        this.resourceProfileRiskScoreAggregationSummaryCollection =
                resourceProfileRiskScoreAggregationSummaryCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder resourceProfileRiskScoreAggregationSummaryCollection(
                com.oracle.bmc.cloudguard.model.ResourceProfileRiskScoreAggregationSummaryCollection
                        resourceProfileRiskScoreAggregationSummaryCollection) {
            this.resourceProfileRiskScoreAggregationSummaryCollection =
                    resourceProfileRiskScoreAggregationSummaryCollection;
        ...
        public Builder copy(RequestSummarizedTopTrendResourceProfileRiskScoresResponse o) {
            ...
            resourceProfileRiskScoreAggregationSummaryCollection(
                    o.getResourceProfileRiskScoreAggregationSummaryCollection());
    ...
    public String toString() {
        ...
        sb.append(",resourceProfileRiskScoreAggregationSummaryCollection=")
                .append(String.valueOf(resourceProfileRiskScoreAggregationSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedTopTrendResourceProfileRiskScoresResponse)) {
            return false;
        }

        RequestSummarizedTopTrendResourceProfileRiskScoresResponse other =
                (RequestSummarizedTopTrendResourceProfileRiskScoresResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.resourceProfileRiskScoreAggregationSummaryCollection,
                        other.resourceProfileRiskScoreAggregationSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.resourceProfileRiskScoreAggregationSummaryCollection == null
                                ? 43
                                : this.resourceProfileRiskScoreAggregationSummaryCollection
                                        .hashCode());
        return result;
