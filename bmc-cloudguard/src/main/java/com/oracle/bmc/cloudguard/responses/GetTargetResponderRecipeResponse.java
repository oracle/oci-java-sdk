...
public class GetTargetResponderRecipeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetTargetResponderRecipeResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetTargetResponderRecipeResponse o) {
         ...
         */
        public GetTargetResponderRecipeResponse build() {
            return new GetTargetResponderRecipeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTargetResponderRecipeResponse)) {
            return false;
        }

        GetTargetResponderRecipeResponse other = (GetTargetResponderRecipeResponse) o;
