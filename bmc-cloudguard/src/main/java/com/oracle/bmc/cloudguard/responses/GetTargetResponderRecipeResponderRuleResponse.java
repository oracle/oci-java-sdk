...
public class GetTargetResponderRecipeResponderRuleResponse
    ...
    private GetTargetResponderRecipeResponderRuleResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetTargetResponderRecipeResponderRuleResponse o) {
         ...
         */
        public GetTargetResponderRecipeResponderRuleResponse build() {
            return new GetTargetResponderRecipeResponderRuleResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTargetResponderRecipeResponderRuleResponse)) {
            return false;
        }

        GetTargetResponderRecipeResponderRuleResponse other =
                (GetTargetResponderRecipeResponderRuleResponse) o;
