...
public class RequestSummarizedRiskScoresResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(RequestSummarizedRiskScoresResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedRiskScoresResponse)) {
            return false;
        }

        RequestSummarizedRiskScoresResponse other = (RequestSummarizedRiskScoresResponse) o;
