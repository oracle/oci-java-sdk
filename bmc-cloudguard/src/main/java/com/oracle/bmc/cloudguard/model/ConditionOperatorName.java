...
public enum ConditionOperatorName {
    ...
    static {
        ...
        for (ConditionOperatorName v : ConditionOperatorName.values()) {
    ...
    ConditionOperatorName(String value) {
        this.value = value;
    }
    ...
    public static ConditionOperatorName create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'ConditionOperatorName', returning UnknownEnumValue",
                key);
