...
public class UpdateTargetResponderRecipeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetResponderRecipeResponse)) {
            return false;
        }

        UpdateTargetResponderRecipeResponse other = (UpdateTargetResponderRecipeResponse) o;
