...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/DeleteDetectorRecipeDetectorRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDetectorRecipeDetectorRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200131")
public class DeleteDetectorRecipeDetectorRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDetectorRecipeDetectorRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDetectorRecipeDetectorRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteDetectorRecipeDetectorRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDetectorRecipeDetectorRuleRequest
         */
        public DeleteDetectorRecipeDetectorRuleRequest build() {
            DeleteDetectorRecipeDetectorRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDetectorRecipeDetectorRuleRequest
         */
        public DeleteDetectorRecipeDetectorRuleRequest buildWithoutInvocationCallback() {
            DeleteDetectorRecipeDetectorRuleRequest request =
                    new DeleteDetectorRecipeDetectorRuleRequest();
            request.detectorRecipeId = detectorRecipeId;
            request.detectorRuleId = detectorRuleId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDetectorRecipeDetectorRuleRequest(detectorRecipeId, detectorRuleId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDetectorRecipeDetectorRuleRequest)) {
            return false;
        }

        DeleteDetectorRecipeDetectorRuleRequest other = (DeleteDetectorRecipeDetectorRuleRequest) o;
