...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/ChangeSecurityRecipeCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeSecurityRecipeCompartmentRequest.
 */
...
public class ChangeSecurityRecipeCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeSecurityRecipeCompartmentRequest as configured by this builder
         *
        ...
        public ChangeSecurityRecipeCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeSecurityRecipeCompartmentRequest(securityRecipeId, changeSecurityRecipeCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
