...
/**
 * WLP agent resource running on an on-premise resource. Example: {@code {"id":
 ...
 * "ocid1.certificate.oc1..exampleawwcufihrc62gpbcvbjizswgoj4w7oj4w7rg5q4fwbg2fauxv"}} <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = WlpAgentSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class WlpAgentSummary
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WlpAgentSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WlpAgentSummary)) {
            return false;
        }

        WlpAgentSummary other = (WlpAgentSummary) o;
