...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/TriggerResponderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use TriggerResponderRequest.
 */
...
public class TriggerResponderRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder triggerResponderDetails(
                com.oracle.bmc.cloudguard.model.TriggerResponderDetails triggerResponderDetails) {
        ...
        public Builder copy(TriggerResponderRequest o) {
            ...
            triggerResponderDetails(o.getTriggerResponderDetails());
        ...
        /**
         * Build the instance of TriggerResponderRequest as configured by this builder
         *
         ...
         *
         * @return instance of TriggerResponderRequest
         */
        public TriggerResponderRequest build() {
            TriggerResponderRequest request = buildWithoutInvocationCallback();
        ...
        public TriggerResponderRequest buildWithoutInvocationCallback() {
            ...
            request.triggerResponderDetails = triggerResponderDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new TriggerResponderRequest(problemId, triggerResponderDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",triggerResponderDetails=").append(String.valueOf(this.triggerResponderDetails));
    ...
    public boolean equals(Object o) {
        ...
        TriggerResponderRequest other = (TriggerResponderRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.problemId, other.problemId)
                && java.util.Objects.equals(
                        this.triggerResponderDetails, other.triggerResponderDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.triggerResponderDetails == null
                                ? 43
                                : this.triggerResponderDetails.hashCode());
        result =
                (result * PRIME)
