 ...
 * in the recipe. Any actions in the zone's compartment (and any subcompartments in the zone) that
 * violate a policy are denied. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SecurityZone.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SecurityZone extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("securityZoneTargetId")
        private String securityZoneTargetId;

        /**
         * The OCID of the target associated with the security zone
         *
         * @param securityZoneTargetId the value to set
         * @return this builder
         */
        public Builder securityZoneTargetId(String securityZoneTargetId) {
            this.securityZoneTargetId = securityZoneTargetId;
            this.__explicitlySet__.add("securityZoneTargetId");
            return this;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityZone model) {
            ...
            if (model.wasPropertyExplicitlySet("securityZoneTargetId")) {
                this.securityZoneTargetId(model.getSecurityZoneTargetId());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", securityZoneTargetId=").append(String.valueOf(this.securityZoneTargetId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityZone)) {
            return false;
        }

        SecurityZone other = (SecurityZone) o;
        return java.util.Objects.equals(this.id, other.id)
                && java.util.Objects.equals(this.displayName, other.displayName)
                && java.util.Objects.equals(this.description, other.description)
                && java.util.Objects.equals(this.compartmentId, other.compartmentId)
                && java.util.Objects.equals(this.securityZoneRecipeId, other.securityZoneRecipeId)
                && java.util.Objects.equals(this.securityZoneTargetId, other.securityZoneTargetId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.securityZoneTargetId == null
                                ? 43
                                : this.securityZoneTargetId.hashCode());
        result =
                (result * PRIME)
