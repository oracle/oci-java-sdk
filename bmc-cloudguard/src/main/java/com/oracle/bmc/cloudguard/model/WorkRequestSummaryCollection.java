...
public final class WorkRequestSummaryCollection
    ...
    public WorkRequestSummaryCollection(
            java.util.List<WorkRequestSummary> items, java.util.List<ResourceLock> locks) {
        super();
        this.items = items;
        this.locks = locks;
    }
    ...
    public static class Builder {
        ...
        public WorkRequestSummaryCollection build() {
            WorkRequestSummaryCollection model =
                    new WorkRequestSummaryCollection(this.items, this.locks);
