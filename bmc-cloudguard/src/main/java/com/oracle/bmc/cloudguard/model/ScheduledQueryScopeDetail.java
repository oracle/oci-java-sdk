...
public final class ScheduledQueryScopeDetail
    ...
    public static class Builder {
        ...
        public ScheduledQueryScopeDetail build() {
            ScheduledQueryScopeDetail model =
                    new ScheduledQueryScopeDetail(this.region, this.resourceIds, this.resourceType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduledQueryScopeDetail model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduledQueryScopeDetail)) {
            return false;
        }

        ScheduledQueryScopeDetail other = (ScheduledQueryScopeDetail) o;
