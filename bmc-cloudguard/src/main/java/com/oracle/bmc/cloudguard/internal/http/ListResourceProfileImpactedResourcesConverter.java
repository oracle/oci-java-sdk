...
public class ListResourceProfileImpactedResourcesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListResourceProfileImpactedResourcesConverter.class);

    public static com.oracle.bmc.cloudguard.requests.ListResourceProfileImpactedResourcesRequest
            interceptRequest(
                    com.oracle.bmc.cloudguard.requests.ListResourceProfileImpactedResourcesRequest
                            request) {
