...
public enum ResponderExecutionModes implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    static {
        ...
        for (ResponderExecutionModes v : ResponderExecutionModes.values()) {
    ...
    ResponderExecutionModes(String value) {
        this.value = value;
    }
    ...
    public static ResponderExecutionModes create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'ResponderExecutionModes', returning UnknownEnumValue",
                key);
