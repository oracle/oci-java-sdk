...
public class ListSightingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListSightingsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSightingsRequest(compartmentId, problemId, resourceProfileId,
            // compartmentIdInSubtree, accessLevel, limit, page, sortOrder, sortBy,
            // timeLastDetectedGreaterThanOrEqualTo, timeLastDetectedLessThanOrEqualTo,
            // opcRequestId);
        }
    }
