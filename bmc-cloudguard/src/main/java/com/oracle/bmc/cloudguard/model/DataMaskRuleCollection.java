...
/**
 * Collection of data mask rules. <br>
...
public final class DataMaskRuleCollection
    ...
    public DataMaskRuleCollection(
            java.util.List<DataMaskRuleSummary> items, java.util.List<ResourceLock> locks) {
        super();
        this.items = items;
        this.locks = locks;
    }
    ...
    public static class Builder {
        ...
        public DataMaskRuleCollection build() {
            DataMaskRuleCollection model = new DataMaskRuleCollection(this.items, this.locks);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataMaskRuleCollection model) {
