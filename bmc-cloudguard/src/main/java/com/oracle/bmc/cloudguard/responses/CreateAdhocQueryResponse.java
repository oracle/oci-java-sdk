...
public class CreateAdhocQueryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder adhocQuery(com.oracle.bmc.cloudguard.model.AdhocQuery adhocQuery) {
            this.adhocQuery = adhocQuery;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",adhocQuery=").append(String.valueOf(adhocQuery));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAdhocQueryResponse)) {
            return false;
        }

        CreateAdhocQueryResponse other = (CreateAdhocQueryResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.adhocQuery, other.adhocQuery);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.adhocQuery == null ? 43 : this.adhocQuery.hashCode());
        return result;
    }
}
