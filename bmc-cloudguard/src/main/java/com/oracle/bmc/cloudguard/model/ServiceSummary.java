...
/**
 * A SaaS service which exists in the tenancy. <br>
...
public final class ServiceSummary
    ...
    public ServiceSummary(
        ...
        this.serviceOverviewPath = serviceOverviewPath;
        this.region = region;
    ...
    public static class Builder {
        ...
        /**
         * The service name of the service. This value is fetched from Tenant-Manager which syncs
         * with TAS
         */
        ...
        /**
         * The service overview path of the service. This value is used to perform navigation to the
         * service overview page.
         */
        @com.fasterxml.jackson.annotation.JsonProperty("serviceOverviewPath")
        private String serviceOverviewPath;

        /**
         * The service overview path of the service. This value is used to perform navigation to the
         * service overview page.
         *
         * @param serviceOverviewPath the value to set
         * @return this builder
         */
        public Builder serviceOverviewPath(String serviceOverviewPath) {
            this.serviceOverviewPath = serviceOverviewPath;
            this.__explicitlySet__.add("serviceOverviewPath");
            return this;
        }
        ...
        public Builder copy(ServiceSummary model) {
            ...
            if (model.wasPropertyExplicitlySet("serviceOverviewPath")) {
                this.serviceOverviewPath(model.getServiceOverviewPath());
            }
    ...
    /**
     * The service name of the service. This value is fetched from Tenant-Manager which syncs with
     * TAS
     */
    @com.fasterxml.jackson.annotation.JsonProperty("saasServiceName")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("serviceOverviewPath")
    private final String serviceOverviewPath;
     ...
     * @return the value
     */
    public String getServiceOverviewPath() {
        return serviceOverviewPath;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", serviceOverviewPath=").append(String.valueOf(this.serviceOverviewPath));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.serviceOverviewPath, other.serviceOverviewPath)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.serviceOverviewPath == null
                                ? 43
                                : this.serviceOverviewPath.hashCode());
