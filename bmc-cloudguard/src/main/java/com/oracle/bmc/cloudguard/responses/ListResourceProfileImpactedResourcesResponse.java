...
public class ListResourceProfileImpactedResourcesResponse
    ...
    public static class Builder
        ...
        public Builder resourceProfileImpactedResourceCollection(
                com.oracle.bmc.cloudguard.model.ResourceProfileImpactedResourceCollection
                        resourceProfileImpactedResourceCollection) {
            this.resourceProfileImpactedResourceCollection =
                    resourceProfileImpactedResourceCollection;
            return this;
        }
        ...
        public Builder copy(ListResourceProfileImpactedResourcesResponse o) {
            ...
            resourceProfileImpactedResourceCollection(
                    o.getResourceProfileImpactedResourceCollection());
    ...
    public String toString() {
        ...
        sb.append(",resourceProfileImpactedResourceCollection=")
                .append(String.valueOf(resourceProfileImpactedResourceCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListResourceProfileImpactedResourcesResponse)) {
            return false;
        }

        ListResourceProfileImpactedResourcesResponse other =
                (ListResourceProfileImpactedResourcesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.resourceProfileImpactedResourceCollection,
                        other.resourceProfileImpactedResourceCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.resourceProfileImpactedResourceCollection == null
                                ? 43
                                : this.resourceProfileImpactedResourceCollection.hashCode());
        return result;
    }
}
