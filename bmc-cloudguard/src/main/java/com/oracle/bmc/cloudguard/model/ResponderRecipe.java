...
public final class ResponderRecipe extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResponderRecipe model) {
            ...
            if (model.wasPropertyExplicitlySet("sourceResponderRecipeId")) {
                this.sourceResponderRecipeId(model.getSourceResponderRecipeId());
            }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("responderRules")
    private final java.util.List<ResponderRecipeResponderRule> responderRules;

    /**
     * List of responder rules associated with the recipe
     * @return the value
     **/
    public java.util.List<ResponderRecipeResponderRule> getResponderRules() {
     ...
     * @return the value
     **/
    public java.util.List<ResponderRecipeResponderRule> getEffectiveResponderRules() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", sourceResponderRecipeId=")
                .append(String.valueOf(this.sourceResponderRecipeId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResponderRecipe)) {
            return false;
        }

        ResponderRecipe other = (ResponderRecipe) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(
                        this.sourceResponderRecipeId, other.sourceResponderRecipeId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.sourceResponderRecipeId == null
                                ? 43
                                : this.sourceResponderRecipeId.hashCode());
        result =
                (result * PRIME)
