...
public class ListSightingsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code SightingCollection} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSightingsResponse> {
         ...
         * The returned {@code SightingCollection} instance.
         *
         * @param sightingCollection the value to set
         * @return this builder
         */
