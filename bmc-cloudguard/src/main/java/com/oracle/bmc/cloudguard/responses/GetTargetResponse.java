...
public class GetTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTargetResponse> {
        ...
        public GetTargetResponse build() {
            return new GetTargetResponse(__httpStatusCode__, headers, etag, opcRequestId, target);
        }
    }
