...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TargetDetectorRecipeDetectorRuleCollection.Builder.class
)
...
public final class TargetDetectorRecipeDetectorRuleCollection {
    ...
    public static class Builder {
        ...
        public TargetDetectorRecipeDetectorRuleCollection build() {
            TargetDetectorRecipeDetectorRuleCollection __instance__ =
                    new TargetDetectorRecipeDetectorRuleCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetDetectorRecipeDetectorRuleCollection o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetDetectorRecipeDetectorRuleCollection)) {
            return false;
        }
