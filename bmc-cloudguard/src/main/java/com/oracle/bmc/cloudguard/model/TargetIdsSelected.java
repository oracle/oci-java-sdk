...
/**
 * Target selection on basis of target IDs. <br>
...
public final class TargetIdsSelected extends TargetSelected {
    ...
    public static class Builder {
        ...
        public TargetIdsSelected build() {
            TargetIdsSelected model = new TargetIdsSelected(this.values);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetIdsSelected model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetIdsSelected)) {
            return false;
        }

        TargetIdsSelected other = (TargetIdsSelected) o;
