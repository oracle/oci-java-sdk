...
public class UpdateResponderRecipeResponderRuleResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateResponderRecipeResponderRuleResponse)) {
            return false;
        }

        UpdateResponderRecipeResponderRuleResponse other =
                (UpdateResponderRecipeResponderRuleResponse) o;
