...
public class RequestSummarizedActivityProblemsResponse
    ...
    public com.oracle.bmc.cloudguard.model.ActivityProblemAggregationCollection
            getActivityProblemAggregationCollection() {
        return activityProblemAggregationCollection;
    }
    ...
    public static class Builder {
        ...
        public Builder activityProblemAggregationCollection(
                com.oracle.bmc.cloudguard.model.ActivityProblemAggregationCollection
                        activityProblemAggregationCollection) {
            this.activityProblemAggregationCollection = activityProblemAggregationCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",activityProblemAggregationCollection=")
                .append(String.valueOf(activityProblemAggregationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedActivityProblemsResponse)) {
            return false;
        }

        RequestSummarizedActivityProblemsResponse other =
                (RequestSummarizedActivityProblemsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.activityProblemAggregationCollection,
                        other.activityProblemAggregationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.activityProblemAggregationCollection == null
                                ? 43
                                : this.activityProblemAggregationCollection.hashCode());
        return result;
    }
}
