...
public class ListDataSourcesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * ({@code DataSourceFeedProvider} resource).
     */
    ...
    public static class Builder
        ...
        /**
         * A filter to return only resources when their feed provider matches the given feed
         * provider ({@code DataSourceFeedProvider} resource).
         */
        private com.oracle.bmc.cloudguard.model.DataSourceFeedProvider dataSourceFeedProvider =
                null;
         ...
         * @return this builder instance
         */
        public Builder dataSourceFeedProvider(
                com.oracle.bmc.cloudguard.model.DataSourceFeedProvider dataSourceFeedProvider) {
        ...
        /**
         * A filter to return only resources where their query type matches the given
         * LoggingQueryType.
         */
         ...
         * @return this builder instance
         */
        public Builder loggingQueryType(
                com.oracle.bmc.cloudguard.model.LoggingQueryType loggingQueryType) {
        ...
        public Builder copy(ListDataSourcesRequest o) {
            ...
            dataSourceFeedProvider(o.getDataSourceFeedProvider());
            lifecycleState(o.getLifecycleState());
            limit(o.getLimit());
            page(o.getPage());
            loggingQueryType(o.getLoggingQueryType());
        ...
        public ListDataSourcesRequest buildWithoutInvocationCallback() {
            ...
            request.dataSourceFeedProvider = dataSourceFeedProvider;
            request.lifecycleState = lifecycleState;
            request.limit = limit;
            request.page = page;
            request.loggingQueryType = loggingQueryType;
