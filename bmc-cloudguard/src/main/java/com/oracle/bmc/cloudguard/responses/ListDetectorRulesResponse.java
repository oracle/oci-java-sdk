...
public class ListDetectorRulesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudguard.model.DetectorRuleCollection getDetectorRuleCollection() {
        return detectorRuleCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListDetectorRulesResponse> {
         ...
         * @return this builder
         */
        public Builder detectorRuleCollection(
                com.oracle.bmc.cloudguard.model.DetectorRuleCollection detectorRuleCollection) {
            this.detectorRuleCollection = detectorRuleCollection;
            return this;
        }
        ...
        public ListDetectorRulesResponse build() {
            return new ListDetectorRulesResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, detectorRuleCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",detectorRuleCollection=").append(String.valueOf(detectorRuleCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDetectorRulesResponse)) {
            return false;
        }

        ListDetectorRulesResponse other = (ListDetectorRulesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.detectorRuleCollection, other.detectorRuleCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.detectorRuleCollection == null
                                ? 43
                                : this.detectorRuleCollection.hashCode());
        return result;
    }
}
