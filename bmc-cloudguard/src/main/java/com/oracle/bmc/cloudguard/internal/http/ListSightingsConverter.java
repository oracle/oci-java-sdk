...
public class ListSightingsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListSightingsConverter.class);

    public static com.oracle.bmc.cloudguard.requests.ListSightingsRequest interceptRequest(
            com.oracle.bmc.cloudguard.requests.ListSightingsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20200131").path("sightings");
        ...
        if (request.getResourceProfileId() != null) {
            target =
                    target.queryParam(
                            "resourceProfileId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.cloudguard.responses.ListSightingsResponse>() {
                            @Override
                            public com.oracle.bmc.cloudguard.responses.ListSightingsResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.cloudguard.responses.ListSightingsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.cloudguard.responses.ListSightingsResponse.Builder
                                        builder =
