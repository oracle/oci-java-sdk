...
public final class UpdateTargetDetectorRecipeDetectorRuleDetails {
    ...
    public static class Builder {
        ...
        public UpdateTargetDetectorRecipeDetectorRuleDetails build() {
            UpdateTargetDetectorRecipeDetectorRuleDetails __instance__ =
                    new UpdateTargetDetectorRecipeDetectorRuleDetails(details);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTargetDetectorRecipeDetectorRuleDetails o) {
