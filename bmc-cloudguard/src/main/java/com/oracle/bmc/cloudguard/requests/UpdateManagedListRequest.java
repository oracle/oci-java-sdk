...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/UpdateManagedListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateManagedListRequest.
 */
...
public class UpdateManagedListRequest
    ...
    public static class Builder
        ...
        public Builder updateManagedListDetails(
                com.oracle.bmc.cloudguard.model.UpdateManagedListDetails updateManagedListDetails) {
        ...
        public Builder copy(UpdateManagedListRequest o) {
            ...
            updateManagedListDetails(o.getUpdateManagedListDetails());
        ...
        /**
         * Build the instance of UpdateManagedListRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateManagedListRequest
         */
        public UpdateManagedListRequest build() {
            UpdateManagedListRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateManagedListRequest buildWithoutInvocationCallback() {
            ...
            request.updateManagedListDetails = updateManagedListDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new UpdateManagedListRequest(managedListId, updateManagedListDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateManagedListDetails=")
                .append(String.valueOf(this.updateManagedListDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateManagedListRequest other = (UpdateManagedListRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.managedListId, other.managedListId)
                && java.util.Objects.equals(
                        this.updateManagedListDetails, other.updateManagedListDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateManagedListDetails == null
                                ? 43
                                : this.updateManagedListDetails.hashCode());
