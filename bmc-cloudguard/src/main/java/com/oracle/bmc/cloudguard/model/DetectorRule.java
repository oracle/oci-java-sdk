...
/**
 * Information for a detector rule (DetectorRule object). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DetectorRule.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DetectorRule extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        DetectorRule other = (DetectorRule) o;
