...
public final class DataMaskRuleSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataMaskRuleSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataMaskRuleSummary)) {
            return false;
        }

        DataMaskRuleSummary other = (DataMaskRuleSummary) o;
