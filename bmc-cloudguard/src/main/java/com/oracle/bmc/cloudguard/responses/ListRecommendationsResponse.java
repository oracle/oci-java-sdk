...
public class ListRecommendationsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudguard.model.RecommendationSummaryCollection
            getRecommendationSummaryCollection() {
        return recommendationSummaryCollection;
    }
    ...
    private ListRecommendationsResponse(
        ...
        this.recommendationSummaryCollection = recommendationSummaryCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder recommendationSummaryCollection(
                com.oracle.bmc.cloudguard.model.RecommendationSummaryCollection
                        recommendationSummaryCollection) {
            this.recommendationSummaryCollection = recommendationSummaryCollection;
            return this;
        ...
        public Builder copy(ListRecommendationsResponse o) {
            ...
            recommendationSummaryCollection(o.getRecommendationSummaryCollection());
        ...
        public ListRecommendationsResponse build() {
            return new ListRecommendationsResponse(
                    __httpStatusCode__, opcRequestId, opcNextPage, recommendationSummaryCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",recommendationSummaryCollection=")
                .append(String.valueOf(recommendationSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.recommendationSummaryCollection,
                        other.recommendationSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.recommendationSummaryCollection == null
                                ? 43
                                : this.recommendationSummaryCollection.hashCode());
        return result;
    }
}
