...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/GetSecurityRecipeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSecurityRecipeRequest.
 */
...
public class GetSecurityRecipeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetSecurityRecipeRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetSecurityRecipeRequest
         */
        public GetSecurityRecipeRequest build() {
            GetSecurityRecipeRequest request = buildWithoutInvocationCallback();
        ...
        public GetSecurityRecipeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSecurityRecipeRequest(securityRecipeId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().securityRecipeId(securityRecipeId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetSecurityRecipeRequest other = (GetSecurityRecipeRequest) o;
