...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/GetResponderRecipeResponderRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetResponderRecipeResponderRuleRequest.
 */
...
public class GetResponderRecipeResponderRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetResponderRecipeResponderRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetResponderRecipeResponderRuleRequest o) {
        ...
        /**
         * Build the instance of GetResponderRecipeResponderRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetResponderRecipeResponderRuleRequest
         */
        public GetResponderRecipeResponderRuleRequest build() {
            GetResponderRecipeResponderRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetResponderRecipeResponderRuleRequest
         */
        public GetResponderRecipeResponderRuleRequest buildWithoutInvocationCallback() {
            GetResponderRecipeResponderRuleRequest request =
                    new GetResponderRecipeResponderRuleRequest();
            request.responderRecipeId = responderRecipeId;
            request.responderRuleId = responderRuleId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetResponderRecipeResponderRuleRequest(responderRecipeId, responderRuleId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetResponderRecipeResponderRuleRequest)) {
            return false;
        }

        GetResponderRecipeResponderRuleRequest other = (GetResponderRecipeResponderRuleRequest) o;
