...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/CreateDetectorRecipeDetectorRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateDetectorRecipeDetectorRuleRequest.
 */
...
public class CreateDetectorRecipeDetectorRuleRequest
    ...
    public com.oracle.bmc.cloudguard.model.CreateDetectorRecipeDetectorRuleDetails getBody$() {
        return createDetectorRecipeDetectorRuleDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder createDetectorRecipeDetectorRuleDetails(
                com.oracle.bmc.cloudguard.model.CreateDetectorRecipeDetectorRuleDetails
                        createDetectorRecipeDetectorRuleDetails) {
            this.createDetectorRecipeDetectorRuleDetails = createDetectorRecipeDetectorRuleDetails;
            return this;
        }
        ...
        public Builder copy(CreateDetectorRecipeDetectorRuleRequest o) {
            ...
            createDetectorRecipeDetectorRuleDetails(o.getCreateDetectorRecipeDetectorRuleDetails());
         ...
         */
        public CreateDetectorRecipeDetectorRuleRequest build() {
            CreateDetectorRecipeDetectorRuleRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.cloudguard.model.CreateDetectorRecipeDetectorRuleDetails body) {
            createDetectorRecipeDetectorRuleDetails(body);
            return this;
        }
         ...
         * @return instance of CreateDetectorRecipeDetectorRuleRequest
         */
        public CreateDetectorRecipeDetectorRuleRequest buildWithoutInvocationCallback() {
            CreateDetectorRecipeDetectorRuleRequest request =
                    new CreateDetectorRecipeDetectorRuleRequest();
            request.detectorRecipeId = detectorRecipeId;
            request.createDetectorRecipeDetectorRuleDetails =
                    createDetectorRecipeDetectorRuleDetails;
    ...
    public String toString() {
        ...
        sb.append(",createDetectorRecipeDetectorRuleDetails=")
                .append(String.valueOf(this.createDetectorRecipeDetectorRuleDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDetectorRecipeDetectorRuleRequest)) {
            return false;
        }

        CreateDetectorRecipeDetectorRuleRequest other = (CreateDetectorRecipeDetectorRuleRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.detectorRecipeId, other.detectorRecipeId)
                && java.util.Objects.equals(
                        this.createDetectorRecipeDetectorRuleDetails,
                        other.createDetectorRecipeDetectorRuleDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createDetectorRecipeDetectorRuleDetails == null
                                ? 43
                                : this.createDetectorRecipeDetectorRuleDetails.hashCode());
