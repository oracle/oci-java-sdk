...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/UpdateProblemStatusExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateProblemStatusRequest.
 */
...
public class UpdateProblemStatusRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateProblemStatusDetails(
                com.oracle.bmc.cloudguard.model.UpdateProblemStatusDetails
        ...
        public Builder copy(UpdateProblemStatusRequest o) {
            ...
            updateProblemStatusDetails(o.getUpdateProblemStatusDetails());
         ...
         *
         * @return instance of UpdateProblemStatusRequest
         */
        public UpdateProblemStatusRequest build() {
            UpdateProblemStatusRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateProblemStatusRequest buildWithoutInvocationCallback() {
            ...
            request.updateProblemStatusDetails = updateProblemStatusDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new UpdateProblemStatusRequest(problemId, updateProblemStatusDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateProblemStatusDetails=")
                .append(String.valueOf(this.updateProblemStatusDetails));
    ...
    public boolean equals(Object o) {
        ...
        UpdateProblemStatusRequest other = (UpdateProblemStatusRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.problemId, other.problemId)
                && java.util.Objects.equals(
                        this.updateProblemStatusDetails, other.updateProblemStatusDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateProblemStatusDetails == null
                                ? 43
                                : this.updateProblemStatusDetails.hashCode());
        result =
                (result * PRIME)
