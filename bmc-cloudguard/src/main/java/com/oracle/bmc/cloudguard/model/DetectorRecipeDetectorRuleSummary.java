...
public final class DetectorRecipeDetectorRuleSummary {
    ...
    public static class Builder {
        ...
        public DetectorRecipeDetectorRuleSummary build() {
            DetectorRecipeDetectorRuleSummary __instance__ =
                    new DetectorRecipeDetectorRuleSummary(
                            id,
                            displayName,
                            description,
                            recommendation,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetectorRecipeDetectorRuleSummary o) {
