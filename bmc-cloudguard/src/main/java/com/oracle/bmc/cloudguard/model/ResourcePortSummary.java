...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ResourcePortSummary.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ResourcePortSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public Builder process(String process) {
            this.process = process;
            this.__explicitlySet__.add("process");
            return this;
        }
        /**
         * Type of port
        ...
        public ResourcePortSummary build() {
            ResourcePortSummary model =
                    new ResourcePortSummary(
                            this.portNumber,
                            this.process,
                            this.type,
                            this.freeformTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResourcePortSummary model) {
            if (model.wasPropertyExplicitlySet("portNumber")) {
                this.portNumber(model.getPortNumber());
            }
            if (model.wasPropertyExplicitlySet("process")) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ResourcePortSummary(");
        sb.append("super=").append(super.toString());
        sb.append("portNumber=").append(String.valueOf(this.portNumber));
        sb.append(", process=").append(String.valueOf(this.process));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourcePortSummary)) {
            return false;
        }

        ResourcePortSummary other = (ResourcePortSummary) o;
        return java.util.Objects.equals(this.portNumber, other.portNumber)
                && java.util.Objects.equals(this.process, other.process)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.process == null ? 43 : this.process.hashCode());
