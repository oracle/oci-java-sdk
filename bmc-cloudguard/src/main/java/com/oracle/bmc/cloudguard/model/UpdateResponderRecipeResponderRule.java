...
public class UpdateResponderRecipeResponderRule {
    ...
    public static class Builder {
        ...
        public UpdateResponderRecipeResponderRule build() {
            UpdateResponderRecipeResponderRule __instance__ =
                    new UpdateResponderRecipeResponderRule(responderRuleId, details);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateResponderRecipeResponderRule o) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("details")
    UpdateResponderRuleDetails details;
