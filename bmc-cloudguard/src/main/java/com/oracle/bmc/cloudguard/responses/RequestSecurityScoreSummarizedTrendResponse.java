...
public class RequestSecurityScoreSummarizedTrendResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSecurityScoreSummarizedTrendResponse)) {
            return false;
        }

        RequestSecurityScoreSummarizedTrendResponse other =
                (RequestSecurityScoreSummarizedTrendResponse) o;
