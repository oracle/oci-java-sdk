...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SecurityRecipe.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SecurityRecipe
    ...
    public static class Builder {
         ...
         * provide actionable information for a recipe in the {@code Failed} state.
         */
        ...
        public SecurityRecipe build() {
            SecurityRecipe model =
                    new SecurityRecipe(
                            this.id,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityRecipe model) {
            ...
            if (model.wasPropertyExplicitlySet("securityPolicies")) {
                this.securityPolicies(model.getSecurityPolicies());
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityRecipe)) {
            return false;
        }

        SecurityRecipe other = (SecurityRecipe) o;
