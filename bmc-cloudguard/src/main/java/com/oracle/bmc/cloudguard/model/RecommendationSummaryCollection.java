...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = RecommendationSummaryCollection.Builder.class
)
...
public final class RecommendationSummaryCollection {
    ...
    public static class Builder {
        ...
        public RecommendationSummaryCollection build() {
            RecommendationSummaryCollection __instance__ =
                    new RecommendationSummaryCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RecommendationSummaryCollection o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RecommendationSummaryCollection)) {
            return false;
        }
