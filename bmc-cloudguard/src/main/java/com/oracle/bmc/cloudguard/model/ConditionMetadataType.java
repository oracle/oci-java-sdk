...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ConditionMetadataType.Builder.class
)
...
public final class ConditionMetadataType {
    ...
    public static class Builder {
        ...
        public ConditionMetadataType build() {
            ConditionMetadataType __instance__ = new ConditionMetadataType(name, serviceTypes);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConditionMetadataType o) {
            Builder copiedBuilder = name(o.getName()).serviceTypes(o.getServiceTypes());
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConditionMetadataType)) {
            return false;
        }
