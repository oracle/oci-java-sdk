...
public class UpdateTargetResponderRecipeResponderRuleResponse
    ...
    public String toString() {
        ...
        sb.append(",targetResponderRecipeResponderRule=")
                .append(String.valueOf(targetResponderRecipeResponderRule));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTargetResponderRecipeResponderRuleResponse)) {
            return false;
        }

        UpdateTargetResponderRecipeResponderRuleResponse other =
                (UpdateTargetResponderRecipeResponderRuleResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.targetResponderRecipeResponderRule,
                        other.targetResponderRecipeResponderRule);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.targetResponderRecipeResponderRule == null
                                ? 43
                                : this.targetResponderRecipeResponderRule.hashCode());
        return result;
    }
}
