...
public class RequestSummarizedSecurityScoresResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedSecurityScoresResponse)) {
            return false;
        }

        RequestSummarizedSecurityScoresResponse other = (RequestSummarizedSecurityScoresResponse) o;
