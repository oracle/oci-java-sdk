...
public class ChangeDetectorRecipeCompartmentDetails {
    ...
    public static class Builder {
        ...
        public ChangeDetectorRecipeCompartmentDetails build() {
            ChangeDetectorRecipeCompartmentDetails __instance__ =
                    new ChangeDetectorRecipeCompartmentDetails(compartmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeDetectorRecipeCompartmentDetails o) {
