...
public class ListResponderActivitiesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.cloudguard.model.ResponderActivityCollection
            getResponderActivityCollection() {
        return responderActivityCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder responderActivityCollection(
                com.oracle.bmc.cloudguard.model.ResponderActivityCollection
                        responderActivityCollection) {
            this.responderActivityCollection = responderActivityCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",responderActivityCollection=")
                .append(String.valueOf(responderActivityCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListResponderActivitiesResponse)) {
            return false;
        }

        ListResponderActivitiesResponse other = (ListResponderActivitiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.responderActivityCollection, other.responderActivityCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.responderActivityCollection == null
                                ? 43
                                : this.responderActivityCollection.hashCode());
        return result;
    }
}
