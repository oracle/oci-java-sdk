...
/**
 * Parameters to update a responder rule for a responder recipe attached to a target. <br>
...
public final class UpdateTargetResponderRecipeResponderRuleDetails
    ...
    public static class Builder {
        ...
        public UpdateTargetResponderRecipeResponderRuleDetails build() {
            UpdateTargetResponderRecipeResponderRuleDetails model =
                    new UpdateTargetResponderRecipeResponderRuleDetails(this.details);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTargetResponderRecipeResponderRuleDetails model) {
