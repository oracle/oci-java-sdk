...
/**
 * A non-disclosure agreement that describes terms of use for a particular compliance document. <br>
...
public final class NonDisclosureAgreement
    ...
    public static class Builder {
         ...
         * non-disclosure agreement, which is assigned when you create the non-disclosure agreement
         * as an Oracle Cloud Infrastructure resource and is immutable.
         */
        ...
        /**
         * The date and time the non-disclosure agreement was created, expressed in [RFC
        ...
        /**
         * The OCID of the principal that called
         * [CreateNonDisclosureAgreement](https://docs.oracle.com/iaas/api/#/en/compliancedocs/release/NonDisclosureAgreement/CreateNonDisclosureAgreement).
         */
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
     * non-disclosure agreement, which is assigned when you create the non-disclosure agreement as
     * an Oracle Cloud Infrastructure resource and is immutable.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("id")
