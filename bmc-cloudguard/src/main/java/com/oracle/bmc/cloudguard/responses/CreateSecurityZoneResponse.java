...
public class CreateSecurityZoneResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSecurityZoneResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSecurityZoneResponse)) {
            return false;
        }

        CreateSecurityZoneResponse other = (CreateSecurityZoneResponse) o;
