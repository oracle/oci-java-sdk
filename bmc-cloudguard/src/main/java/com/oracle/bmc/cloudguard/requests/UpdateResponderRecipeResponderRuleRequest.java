...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/UpdateResponderRecipeResponderRuleExample.java.html">here</a> to see how to use UpdateResponderRecipeResponderRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200131")
@lombok.Builder(builderClassName = "Builder", buildMethodName = "buildWithoutInvocationCallback")
@lombok.Getter
public class UpdateResponderRecipeResponderRuleRequest
        extends com.oracle.bmc.requests.BmcRequest<UpdateResponderRecipeResponderRuleDetails> {
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(UpdateResponderRecipeResponderRuleDetails body) {
