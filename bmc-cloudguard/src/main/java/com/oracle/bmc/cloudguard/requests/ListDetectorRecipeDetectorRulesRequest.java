...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/cloudguard/ListDetectorRecipeDetectorRulesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDetectorRecipeDetectorRulesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200131")
public class ListDetectorRecipeDetectorRulesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDetectorRecipeDetectorRulesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDetectorRecipeDetectorRulesRequest o) {
        ...
        /**
         * Build the instance of ListDetectorRecipeDetectorRulesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDetectorRecipeDetectorRulesRequest
         */
        public ListDetectorRecipeDetectorRulesRequest build() {
            ListDetectorRecipeDetectorRulesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDetectorRecipeDetectorRulesRequest
         */
        public ListDetectorRecipeDetectorRulesRequest buildWithoutInvocationCallback() {
            ListDetectorRecipeDetectorRulesRequest request =
                    new ListDetectorRecipeDetectorRulesRequest();
            ...
            return request;
            // new ListDetectorRecipeDetectorRulesRequest(detectorRecipeId, compartmentId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDetectorRecipeDetectorRulesRequest)) {
            return false;
        }

        ListDetectorRecipeDetectorRulesRequest other = (ListDetectorRecipeDetectorRulesRequest) o;
