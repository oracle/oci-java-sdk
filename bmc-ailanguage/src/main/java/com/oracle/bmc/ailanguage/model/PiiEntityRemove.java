...
/**
 * Remove PII entities from output. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PiiEntityRemove.Builder.class)
...
public final class PiiEntityRemove extends PiiEntityMasking {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PiiEntityRemove)) {
            return false;
        }

        PiiEntityRemove other = (PiiEntityRemove) o;
