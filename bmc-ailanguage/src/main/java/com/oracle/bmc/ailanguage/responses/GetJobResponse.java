...
public class GetJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetJobResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.ailanguage.model.Job job) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetJobResponse> {
         ...
         * @return this builder
         */
        public Builder job(com.oracle.bmc.ailanguage.model.Job job) {
            this.job = job;
            return this;
        }
        ...
        public GetJobResponse build() {
            return new GetJobResponse(__httpStatusCode__, headers, etag, opcRequestId, job);
        }
    }
