...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ailanguage/GetEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetEndpointRequest.
 */
...
public class GetEndpointRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetEndpointRequest(endpointId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().endpointId(endpointId).opcRequestId(opcRequestId);
    }
