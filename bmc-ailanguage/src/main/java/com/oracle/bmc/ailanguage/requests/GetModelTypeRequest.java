...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ailanguage/GetModelTypeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetModelTypeRequest.
 */
...
public class GetModelTypeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetModelTypeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetModelTypeRequest(modelType, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().modelType(modelType).opcRequestId(opcRequestId);
    }
