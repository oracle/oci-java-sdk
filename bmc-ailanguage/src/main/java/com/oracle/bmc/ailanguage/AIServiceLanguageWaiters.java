...
public class AIServiceLanguageWaiters {
    ...
    public AIServiceLanguageWaiters(
            java.util.concurrent.ExecutorService executorService, AIServiceLanguage client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            ...
            com.oracle.bmc.ailanguage.model.Endpoint.LifecycleState... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            GetEndpointRequest request,
            com.oracle.bmc.ailanguage.model.Endpoint.LifecycleState targetState,
    ...
    private com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            ...
            final com.oracle.bmc.ailanguage.model.Endpoint.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.ailanguage.model.Endpoint.LifecycleState>
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            com.oracle.bmc.ailanguage.model.Job.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            GetJobRequest request,
            com.oracle.bmc.ailanguage.model.Job.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetJobRequest, GetJobResponse> forJob(
            ...
            final com.oracle.bmc.ailanguage.model.Job.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.ailanguage.model.Job.LifecycleState> targetStatesSet =
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.ailanguage.model.Job.LifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            ...
            com.oracle.bmc.ailanguage.model.Model.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            GetModelRequest request,
            com.oracle.bmc.ailanguage.model.Model.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetModelRequest, GetModelResponse> forModel(
            ...
            final com.oracle.bmc.ailanguage.model.Model.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.ailanguage.model.Model.LifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
    ...
    public com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            ...
            com.oracle.bmc.ailanguage.model.Project.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            GetProjectRequest request,
            com.oracle.bmc.ailanguage.model.Project.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetProjectRequest, GetProjectResponse> forProject(
            ...
            final com.oracle.bmc.ailanguage.model.Project.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.ailanguage.model.Project.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
