...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ailanguage/ListModelsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModelsRequest.
 */
...
public class ListModelsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListModelsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListModelsRequest(compartmentId, modelId, projectId, lifecycleState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
