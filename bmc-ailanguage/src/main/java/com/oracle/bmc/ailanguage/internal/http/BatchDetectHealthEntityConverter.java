...
public class BatchDetectHealthEntityConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(BatchDetectHealthEntityConverter.class);

    public static com.oracle.bmc.ailanguage.requests.BatchDetectHealthEntityRequest
            interceptRequest(
                    com.oracle.bmc.ailanguage.requests.BatchDetectHealthEntityRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        .path("/20221001")
                        .path("actions")
                        .path("batchDetectHealthEntities");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.ailanguage.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.ailanguage.responses.BatchDetectHealthEntityResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.batchDetectHealthEntityResult(response.getItem());
