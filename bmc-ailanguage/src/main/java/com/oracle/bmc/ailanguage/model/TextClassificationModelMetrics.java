...
public final class TextClassificationModelMetrics
    ...
    public TextClassificationModelMetrics(
            Float accuracy,
            Float microF1,
    ...
    public static class Builder {
        ...
        public TextClassificationModelMetrics build() {
            TextClassificationModelMetrics model =
                    new TextClassificationModelMetrics(
                            this.accuracy,
                            this.microF1,
                            this.microPrecision,
                            this.microRecall,
    ...
    public boolean equals(Object o) {
        ...
        TextClassificationModelMetrics other = (TextClassificationModelMetrics) o;
        return java.util.Objects.equals(this.accuracy, other.accuracy)
                && java.util.Objects.equals(this.microF1, other.microF1)
