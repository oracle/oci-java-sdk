...
public class BatchDetectDominantLanguageDetails {
    ...
    public static class Builder {
        ...
        public BatchDetectDominantLanguageDetails build() {
            BatchDetectDominantLanguageDetails __instance__ =
                    new BatchDetectDominantLanguageDetails(documents);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchDetectDominantLanguageDetails o) {
