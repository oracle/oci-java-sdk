...
/**
 * Result of entities detect call. <br>
...
public final class DetectLanguageEntitiesResult
    ...
    public static class Builder {
        ...
        public DetectLanguageEntitiesResult build() {
            DetectLanguageEntitiesResult model = new DetectLanguageEntitiesResult(this.entities);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DetectLanguageEntitiesResult model) {
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.entities, other.entities) && super.equals(other);
    }
