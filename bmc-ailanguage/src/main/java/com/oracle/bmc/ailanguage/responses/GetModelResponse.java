...
public class GetModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.ailanguage.model.Model model;
     ...
     * @return the value
     */
    public com.oracle.bmc.ailanguage.model.Model getModel() {
        return model;
    }
    ...
    private GetModelResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.ailanguage.model.Model model) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetModelResponse> {
         ...
         * @return this builder
         */
        public Builder model(com.oracle.bmc.ailanguage.model.Model model) {
            this.model = model;
            return this;
        }
        ...
        public GetModelResponse build() {
            return new GetModelResponse(__httpStatusCode__, headers, etag, opcRequestId, model);
        }
    }
