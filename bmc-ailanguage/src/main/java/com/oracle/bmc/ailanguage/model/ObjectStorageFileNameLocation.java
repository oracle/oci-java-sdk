...
/**
 * list of text files need to be used for prediction <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageFileNameLocation.Builder.class)
...
public final class ObjectStorageFileNameLocation extends InputLocation {
    ...
    public static class Builder {
        ...
        public ObjectStorageFileNameLocation build() {
            ObjectStorageFileNameLocation model =
                    new ObjectStorageFileNameLocation(
                            this.namespaceName, this.bucketName, this.objectNames);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageFileNameLocation model) {
    ...
    @Deprecated
    public ObjectStorageFileNameLocation(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectStorageFileNameLocation(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageFileNameLocation)) {
            return false;
        }

        ObjectStorageFileNameLocation other = (ObjectStorageFileNameLocation) o;
