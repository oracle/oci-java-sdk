...
public class BatchDetectLanguageSentimentsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code BatchDetectLanguageSentimentsResult} instance. */
    ...
    public static class Builder
        ...
        public BatchDetectLanguageSentimentsResponse build() {
            return new BatchDetectLanguageSentimentsResponse(
                    __httpStatusCode__, headers, opcRequestId, batchDetectLanguageSentimentsResult);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",batchDetectLanguageSentimentsResult=")
                .append(String.valueOf(batchDetectLanguageSentimentsResult));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchDetectLanguageSentimentsResponse)) {
            return false;
        }

        BatchDetectLanguageSentimentsResponse other = (BatchDetectLanguageSentimentsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.batchDetectLanguageSentimentsResult,
                        other.batchDetectLanguageSentimentsResult);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.batchDetectLanguageSentimentsResult == null
                                ? 43
                                : this.batchDetectLanguageSentimentsResult.hashCode());
        return result;
    }
}
