...
public class BatchDetectLanguageEntitiesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public String toString() {
        ...
        sb.append(",batchDetectLanguageEntitiesResult=")
                .append(String.valueOf(batchDetectLanguageEntitiesResult));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchDetectLanguageEntitiesResponse)) {
            return false;
        }

        BatchDetectLanguageEntitiesResponse other = (BatchDetectLanguageEntitiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.batchDetectLanguageEntitiesResult,
                        other.batchDetectLanguageEntitiesResult);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.batchDetectLanguageEntitiesResult == null
                                ? 43
                                : this.batchDetectLanguageEntitiesResult.hashCode());
        return result;
    }
}
