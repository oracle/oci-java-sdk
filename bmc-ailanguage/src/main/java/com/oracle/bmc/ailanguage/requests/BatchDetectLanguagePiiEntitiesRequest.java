...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ailanguage/BatchDetectLanguagePiiEntitiesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BatchDetectLanguagePiiEntitiesRequest.
 */
...
public class BatchDetectLanguagePiiEntitiesRequest
    ...
    public static class Builder
        ...
        public BatchDetectLanguagePiiEntitiesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new BatchDetectLanguagePiiEntitiesRequest(batchDetectLanguagePiiEntitiesDetails, opcRequestId);
        }
    }
