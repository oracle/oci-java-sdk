...
/**
 * Result of health entity detect call. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BatchDetectHealthEntityResult.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchDetectHealthEntityResult
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"documents", "errors"})
    public BatchDetectHealthEntityResult(
            java.util.List<HealthEntityDocumentResult> documents,
    ...
    public static class Builder {
        ...
        private java.util.List<HealthEntityDocumentResult> documents;
         ...
         * @return this builder
         */
        public Builder documents(java.util.List<HealthEntityDocumentResult> documents) {
            this.documents = documents;
        ...
        public BatchDetectHealthEntityResult build() {
            BatchDetectHealthEntityResult model =
                    new BatchDetectHealthEntityResult(this.documents, this.errors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchDetectHealthEntityResult model) {
    ...
    /** List of succeeded document response. */
    @com.fasterxml.jackson.annotation.JsonProperty("documents")
    private final java.util.List<HealthEntityDocumentResult> documents;
     ...
     * @return the value
     */
    public java.util.List<HealthEntityDocumentResult> getDocuments() {
        return documents;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchDetectHealthEntityResult)) {
            return false;
        }

        BatchDetectHealthEntityResult other = (BatchDetectHealthEntityResult) o;
