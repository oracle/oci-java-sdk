...
public final class SentimentsDocument extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SentimentsDocument build() {
            SentimentsDocument model =
                    new SentimentsDocument(this.key, this.text, this.languageCode);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SentimentsDocument model) {
