...
/**
 * Replace with entity value with the same context <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PiiEntityRelexify.Builder.class)
...
public final class PiiEntityRelexify extends PiiEntityMasking {
    ...
    public static class Builder {
        ...
        public PiiEntityRelexify build() {
            PiiEntityRelexify model = new PiiEntityRelexify(this.exclude, this.shouldDetect);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PiiEntityRelexify model) {
    ...
    @Deprecated
    public PiiEntityRelexify(java.util.List<String> exclude, Boolean shouldDetect) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PiiEntityRelexify)) {
            return false;
        }

        PiiEntityRelexify other = (PiiEntityRelexify) o;
