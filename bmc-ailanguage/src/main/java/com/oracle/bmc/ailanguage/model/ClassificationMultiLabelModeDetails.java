...
/**
 * Possible text classification multi label mode details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ClassificationMultiLabelModeDetails.Builder.class)
...
public final class ClassificationMultiLabelModeDetails extends ClassificationType {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClassificationMultiLabelModeDetails)) {
            return false;
        }
