...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ailanguage/DetectLanguageTextClassificationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DetectLanguageTextClassificationRequest.
 */
...
public class DetectLanguageTextClassificationRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(DetectLanguageTextClassificationRequest o) {
            detectLanguageTextClassificationDetails(o.getDetectLanguageTextClassificationDetails());
         ...
         */
        public DetectLanguageTextClassificationRequest build() {
            DetectLanguageTextClassificationRequest request = buildWithoutInvocationCallback();
