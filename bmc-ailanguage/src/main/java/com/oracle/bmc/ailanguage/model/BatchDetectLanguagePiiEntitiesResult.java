...
/**
 * Result of batch detect personal identification. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BatchDetectLanguagePiiEntitiesResult.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class BatchDetectLanguagePiiEntitiesResult
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"documents", "errors"})
    public BatchDetectLanguagePiiEntitiesResult(
            java.util.List<PiiEntityDocumentResult> documents,
    ...
    public static class Builder {
        ...
        private java.util.List<PiiEntityDocumentResult> documents;
         ...
         * @return this builder
         */
        public Builder documents(java.util.List<PiiEntityDocumentResult> documents) {
            this.documents = documents;
        ...
        public BatchDetectLanguagePiiEntitiesResult build() {
            BatchDetectLanguagePiiEntitiesResult model =
                    new BatchDetectLanguagePiiEntitiesResult(this.documents, this.errors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchDetectLanguagePiiEntitiesResult model) {
    ...
    /** List of succeeded document response. */
    @com.fasterxml.jackson.annotation.JsonProperty("documents")
    private final java.util.List<PiiEntityDocumentResult> documents;
     ...
     * @return the value
     */
    public java.util.List<PiiEntityDocumentResult> getDocuments() {
        return documents;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchDetectLanguagePiiEntitiesResult)) {
            return false;
        }

        BatchDetectLanguagePiiEntitiesResult other = (BatchDetectLanguagePiiEntitiesResult) o;
