...
public class DominantLanguageDocumentResult {
    ...
    public static class Builder {
        ...
        public DominantLanguageDocumentResult build() {
            DominantLanguageDocumentResult __instance__ =
                    new DominantLanguageDocumentResult(key, languages);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DominantLanguageDocumentResult o) {
            Builder copiedBuilder = key(o.getKey()).languages(o.getLanguages());
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("languages")
    java.util.List<DetectedLanguage> languages;
