...
/**
 * Possible TextClassificationModelDetails <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TextClassificationModelDetails.Builder.class)
...
public final class TextClassificationModelDetails extends ModelDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("classificationMode")
        ...
        public TextClassificationModelDetails build() {
            TextClassificationModelDetails model =
                    new TextClassificationModelDetails(this.languageCode, this.classificationMode);
    ...
    @Deprecated
    public TextClassificationModelDetails(
            String languageCode, ClassificationType classificationMode) {
        super(languageCode);
        this.classificationMode = classificationMode;
    }
    ...
    public boolean equals(Object o) {
        ...
        TextClassificationModelDetails other = (TextClassificationModelDetails) o;
        return java.util.Objects.equals(this.classificationMode, other.classificationMode)
                && super.equals(other);
    }
        ...
        result =
                (result * PRIME)
                        + (this.classificationMode == null
                                ? 43
                                : this.classificationMode.hashCode());
        return result;
    }
}
