...
public final class BatchDetectLanguageTextClassificationResult
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder documents(java.util.List<TextClassificationDocumentResult> documents) {
            this.documents = documents;
        ...
        public BatchDetectLanguageTextClassificationResult build() {
            BatchDetectLanguageTextClassificationResult model =
                    new BatchDetectLanguageTextClassificationResult(this.documents, this.errors);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchDetectLanguageTextClassificationResult model) {
