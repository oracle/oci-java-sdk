...
public final class BatchDetectLanguageTextClassificationResult {
    ...
    public static class Builder {
        ...
        public BatchDetectLanguageTextClassificationResult build() {
            BatchDetectLanguageTextClassificationResult __instance__ =
                    new BatchDetectLanguageTextClassificationResult(documents, errors);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchDetectLanguageTextClassificationResult o) {
