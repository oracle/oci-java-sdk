...
public class ListDetectAnomalyJobsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListDetectAnomalyJobsConverter.class);

    public static com.oracle.bmc.aianomalydetection.requests.ListDetectAnomalyJobsRequest
            interceptRequest(
                    com.oracle.bmc.aianomalydetection.requests.ListDetectAnomalyJobsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.aianomalydetection.requests.ListDetectAnomalyJobsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210101").path("detectAnomalyJobs");
        ...
        if (request.getDetectAnomalyJobId() != null) {
            target =
                    target.queryParam(
                            "detectAnomalyJobId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.aianomalydetection.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.aianomalydetection.responses.ListDetectAnomalyJobsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.detectAnomalyJobCollection(response.getItem());
