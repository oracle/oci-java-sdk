...
/**
 * Detect anomaly job output details. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "outputType",
        defaultImpl = OutputDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = ObjectStoreOutputDetails.class,
            name = "OBJECT_STORAGE")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class OutputDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutputDetails)) {
            return false;
        }

        OutputDetails other = (OutputDetails) o;
    ...
    /**
     * The type of output location. Allowed values are: - {@code OBJECT_STORAGE}: Object store
     * output location.
     */
