...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "inputType",
    defaultImpl = InputDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = EmbeddedInputDetails.class,
        name = "BASE64_ENCODED"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = ObjectListInputDetails.class,
        name = "OBJECT_LIST"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = InlineInputDetails.class,
        name = "INLINE"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class InputDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InputDetails)) {
            return false;
        }

        InputDetails other = (InputDetails) o;
