...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AiPrivateEndpointCollection.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AiPrivateEndpointCollection
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public AiPrivateEndpointCollection(java.util.List<AiPrivateEndpointSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public AiPrivateEndpointCollection build() {
            AiPrivateEndpointCollection model = new AiPrivateEndpointCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AiPrivateEndpointCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AiPrivateEndpointCollection)) {
            return false;
        }

        AiPrivateEndpointCollection other = (AiPrivateEndpointCollection) o;
