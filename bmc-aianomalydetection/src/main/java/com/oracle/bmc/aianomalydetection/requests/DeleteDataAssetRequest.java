...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aianomalydetection/DeleteDataAssetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDataAssetRequest.
 */
...
public class DeleteDataAssetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteDataAssetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteDataAssetRequest(dataAssetId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().dataAssetId(dataAssetId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
