...
/**
 * This is the specialised JSON format with an additional field for 'locationType'. This is a
 * required field used for deciding if it is an object-storage location. <br>
...
public final class ObjectStorageLocation extends OutputJobDetails {
    ...
    public static class Builder {
        ...
        public ObjectStorageLocation build() {
            ObjectStorageLocation model =
                    new ObjectStorageLocation(this.namespaceName, this.bucketName, this.prefix);
    ...
    @Deprecated
    public ObjectStorageLocation(String namespaceName, String bucketName, String prefix) {
        super();
        this.namespaceName = namespaceName;
        this.bucketName = bucketName;
        this.prefix = prefix;
