...
public enum DataSourceType implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DataSourceType.class);

    private final String value;
    private static java.util.Map<String, DataSourceType> map;
    ...
    public static DataSourceType create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'DataSourceType', returning UnknownEnumValue",
                key);
