...
public class GetDetectAnomalyJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDetectAnomalyJobResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDetectAnomalyJobResponse> {
         ...
         */
        @Override
        public Builder copy(GetDetectAnomalyJobResponse o) {
         ...
         */
        @Override
        public GetDetectAnomalyJobResponse build() {
            return new GetDetectAnomalyJobResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDetectAnomalyJobResponse)) {
            return false;
        }

        GetDetectAnomalyJobResponse other = (GetDetectAnomalyJobResponse) o;
