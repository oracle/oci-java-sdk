...
public class ListDetectAnomalyJobsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * page} parameter for the precedent GET request to get the previous batch of items.
     */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListDetectAnomalyJobsResponse> {
         ...
         * {@code page} parameter for the precedent GET request to get the previous batch of items.
         */
        private String opcPrevPage;
