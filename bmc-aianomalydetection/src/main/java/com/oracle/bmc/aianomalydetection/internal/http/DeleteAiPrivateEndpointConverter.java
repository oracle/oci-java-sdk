...
public class DeleteAiPrivateEndpointConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteAiPrivateEndpointConverter.class);

    public static com.oracle.bmc.aianomalydetection.requests.DeleteAiPrivateEndpointRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.aianomalydetection.requests.DeleteAiPrivateEndpointRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.aianomalydetection.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.aianomalydetection.responses.DeleteAiPrivateEndpointResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.aianomalydetection.responses
                                                .DeleteAiPrivateEndpointResponse.Builder
                                        builder =
                                                com.oracle.bmc.aianomalydetection.responses
                                                        .DeleteAiPrivateEndpointResponse.builder()
                                                        .__httpStatusCode__(
