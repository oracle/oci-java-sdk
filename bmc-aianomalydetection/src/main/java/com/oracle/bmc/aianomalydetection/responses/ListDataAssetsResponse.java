...
public class ListDataAssetsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code DataAssetCollection} instance. */
     ...
     * @return the value
     */
    public com.oracle.bmc.aianomalydetection.model.DataAssetCollection getDataAssetCollection() {
    ...
    private ListDataAssetsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.aianomalydetection.model.DataAssetCollection dataAssetCollection) {
    ...
    public static class Builder
         ...
         * The returned {@code DataAssetCollection} instance.
         *
         * @param dataAssetCollection the value to set
         * @return this builder
         */
        ...
        public ListDataAssetsResponse build() {
            return new ListDataAssetsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, dataAssetCollection);
        }
    }
