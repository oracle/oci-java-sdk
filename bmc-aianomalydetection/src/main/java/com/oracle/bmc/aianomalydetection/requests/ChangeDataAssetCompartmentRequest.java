...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aianomalydetection/ChangeDataAssetCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDataAssetCompartmentRequest.
 */
...
public class ChangeDataAssetCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeDataAssetCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeDataAssetCompartmentRequest(dataAssetId, changeDataAssetCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
