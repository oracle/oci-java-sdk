...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aianomalydetection/CreateAiPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAiPrivateEndpointRequest.
 */
...
public class CreateAiPrivateEndpointRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAiPrivateEndpointRequest o) {
            createAiPrivateEndpointDetails(o.getCreateAiPrivateEndpointDetails());
         ...
         */
        public CreateAiPrivateEndpointRequest build() {
            CreateAiPrivateEndpointRequest request = buildWithoutInvocationCallback();
