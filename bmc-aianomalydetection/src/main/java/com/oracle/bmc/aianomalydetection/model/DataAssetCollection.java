...
public final class DataAssetCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public DataAssetCollection(java.util.List<DataAssetSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public DataAssetCollection build() {
            DataAssetCollection model = new DataAssetCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataAssetCollection model) {
