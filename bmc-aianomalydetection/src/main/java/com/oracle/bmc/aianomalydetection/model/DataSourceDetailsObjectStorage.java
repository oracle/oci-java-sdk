...
public class DataSourceDetailsObjectStorage extends DataSourceDetails {
    ...
    public static class Builder {
        ...
        public DataSourceDetailsObjectStorage build() {
            DataSourceDetailsObjectStorage __instance__ =
                    new DataSourceDetailsObjectStorage(namespace, bucketName, objectName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataSourceDetailsObjectStorage o) {
