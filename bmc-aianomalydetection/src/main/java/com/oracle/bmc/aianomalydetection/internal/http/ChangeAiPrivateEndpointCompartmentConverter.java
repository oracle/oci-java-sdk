...
public class ChangeAiPrivateEndpointCompartmentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ChangeAiPrivateEndpointCompartmentConverter.class);
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getAiPrivateEndpointId()))
                        .path("actions")
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.aianomalydetection.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.aianomalydetection.responses.ChangeAiPrivateEndpointCompartmentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.aianomalydetection.responses
                                                .ChangeAiPrivateEndpointCompartmentResponse.Builder
                                        builder =
                                                com.oracle.bmc.aianomalydetection.responses
                                                        .ChangeAiPrivateEndpointCompartmentResponse
                                                        .builder()
