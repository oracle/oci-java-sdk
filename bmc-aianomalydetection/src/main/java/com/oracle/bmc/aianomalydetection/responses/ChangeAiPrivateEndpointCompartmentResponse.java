...
public class ChangeAiPrivateEndpointCompartmentResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeAiPrivateEndpointCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeAiPrivateEndpointCompartmentResponse)) {
            return false;
        }

        ChangeAiPrivateEndpointCompartmentResponse other =
                (ChangeAiPrivateEndpointCompartmentResponse) o;
