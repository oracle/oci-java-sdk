...
/**
 * Base class for the DetectAnomalies call. It contains the identifier that will be used for
...
public class DetectAnomaliesDetails
    ...
    /**
     * Type of request. This parameter will be filled autmatically by classes generated by the SDK.
     * For raw curl request, user will have to provide this field.
     */
