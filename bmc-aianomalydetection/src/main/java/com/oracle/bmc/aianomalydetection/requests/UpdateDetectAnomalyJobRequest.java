...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aianomalydetection/UpdateDetectAnomalyJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDetectAnomalyJobRequest.
 */
...
public class UpdateDetectAnomalyJobRequest
    ...
    public com.oracle.bmc.aianomalydetection.model.UpdateDetectAnomalyJobDetails getBody$() {
        return updateDetectAnomalyJobDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateDetectAnomalyJobDetails(
                com.oracle.bmc.aianomalydetection.model.UpdateDetectAnomalyJobDetails
                        updateDetectAnomalyJobDetails) {
            this.updateDetectAnomalyJobDetails = updateDetectAnomalyJobDetails;
            return this;
        }
        ...
        public Builder copy(UpdateDetectAnomalyJobRequest o) {
            ...
            updateDetectAnomalyJobDetails(o.getUpdateDetectAnomalyJobDetails());
         ...
         */
        public UpdateDetectAnomalyJobRequest build() {
            UpdateDetectAnomalyJobRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.aianomalydetection.model.UpdateDetectAnomalyJobDetails body) {
            updateDetectAnomalyJobDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateDetectAnomalyJobRequest
         */
        public UpdateDetectAnomalyJobRequest buildWithoutInvocationCallback() {
            UpdateDetectAnomalyJobRequest request = new UpdateDetectAnomalyJobRequest();
            request.detectAnomalyJobId = detectAnomalyJobId;
            request.updateDetectAnomalyJobDetails = updateDetectAnomalyJobDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateDetectAnomalyJobDetails=")
                .append(String.valueOf(this.updateDetectAnomalyJobDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDetectAnomalyJobRequest)) {
            return false;
        }

        UpdateDetectAnomalyJobRequest other = (UpdateDetectAnomalyJobRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.detectAnomalyJobId, other.detectAnomalyJobId)
                && java.util.Objects.equals(
                        this.updateDetectAnomalyJobDetails, other.updateDetectAnomalyJobDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateDetectAnomalyJobDetails == null
                                ? 43
                                : this.updateDetectAnomalyJobDetails.hashCode());
