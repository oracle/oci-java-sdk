...
public class DeleteAiPrivateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteAiPrivateEndpointResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteAiPrivateEndpointResponse o) {
         ...
         */
        public DeleteAiPrivateEndpointResponse build() {
            return new DeleteAiPrivateEndpointResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiPrivateEndpointResponse)) {
            return false;
        }

        DeleteAiPrivateEndpointResponse other = (DeleteAiPrivateEndpointResponse) o;
