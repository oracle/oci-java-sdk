...
public class UpdateDetectAnomalyJobResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateDetectAnomalyJobResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateDetectAnomalyJobResponse o) {
         ...
         */
        public UpdateDetectAnomalyJobResponse build() {
            return new UpdateDetectAnomalyJobResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDetectAnomalyJobResponse)) {
            return false;
        }

        UpdateDetectAnomalyJobResponse other = (UpdateDetectAnomalyJobResponse) o;
