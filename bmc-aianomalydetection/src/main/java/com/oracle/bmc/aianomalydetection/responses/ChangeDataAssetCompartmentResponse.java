...
public class ChangeDataAssetCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeDataAssetCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDataAssetCompartmentResponse)) {
            return false;
        }

        ChangeDataAssetCompartmentResponse other = (ChangeDataAssetCompartmentResponse) o;
