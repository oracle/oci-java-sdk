...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psa/UpdatePrivateServiceAccessExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePrivateServiceAccessRequest.
 */
...
public class UpdatePrivateServiceAccessRequest
    ...
    public static class Builder
        ...
        public UpdatePrivateServiceAccessRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePrivateServiceAccessRequest(privateServiceAccessId, updatePrivateServiceAccessDetails, ifMatch, opcRequestId);
        }
    }
