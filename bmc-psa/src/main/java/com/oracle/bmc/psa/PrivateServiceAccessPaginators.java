...
public class PrivateServiceAccessPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPrivateServiceAccesses operation. This iterable
    ...
    public Iterable<ListPrivateServiceAccessesResponse> listPrivateServiceAccessesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPrivateServiceAccessesRequest.Builder, ListPrivateServiceAccessesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psa.model.PrivateServiceAccessSummary} objects
     * contained in responses from the listPrivateServiceAccesses operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psa.model.PrivateServiceAccessSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPsaServices operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psa.model.PsaServiceSummary} objects
     * contained in responses from the listPsaServices operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psa.model.PsaServiceSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPsaWorkRequestErrors operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListPsaWorkRequestErrorsResponse> listPsaWorkRequestErrorsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPsaWorkRequestErrorsRequest.Builder, ListPsaWorkRequestErrorsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psa.model.WorkRequestError} objects
     * contained in responses from the listPsaWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psa.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.psa.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListPsaWorkRequestErrorsRequest.Builder, ListPsaWorkRequestErrorsRequest,
                ListPsaWorkRequestErrorsResponse, com.oracle.bmc.psa.model.WorkRequestError>(
                new java.util.function.Supplier<ListPsaWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListPsaWorkRequestErrorsRequest.Builder get() {
                        return ListPsaWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPsaWorkRequestLogs operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListPsaWorkRequestLogsResponse> listPsaWorkRequestLogsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPsaWorkRequestLogsRequest.Builder, ListPsaWorkRequestLogsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psa.model.WorkRequestLogEntry} objects
     * contained in responses from the listPsaWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psa.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.psa.model.WorkRequestLogEntry>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListPsaWorkRequestLogsRequest.Builder, ListPsaWorkRequestLogsRequest,
                ListPsaWorkRequestLogsResponse, com.oracle.bmc.psa.model.WorkRequestLogEntry>(
                new java.util.function.Supplier<ListPsaWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListPsaWorkRequestLogsRequest.Builder get() {
                        return ListPsaWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPsaWorkRequests operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListPsaWorkRequestsResponse> listPsaWorkRequestsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPsaWorkRequestsRequest.Builder, ListPsaWorkRequestsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.psa.model.WorkRequestSummary} objects
     * contained in responses from the listPsaWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.psa.model.WorkRequestSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.psa.model.WorkRequestSummary> listPsaWorkRequestsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListPsaWorkRequestsRequest.Builder, ListPsaWorkRequestsRequest,
                ListPsaWorkRequestsResponse, com.oracle.bmc.psa.model.WorkRequestSummary>(
                new java.util.function.Supplier<ListPsaWorkRequestsRequest.Builder>() {
                    @Override
                    public ListPsaWorkRequestsRequest.Builder get() {
                        return ListPsaWorkRequestsRequest.builder().copy(request);
