...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psa/DeletePrivateServiceAccessExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePrivateServiceAccessRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240301")
public class DeletePrivateServiceAccessRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePrivateServiceAccessRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePrivateServiceAccessRequest o) {
        ...
        /**
         * Build the instance of DeletePrivateServiceAccessRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePrivateServiceAccessRequest
         */
        public DeletePrivateServiceAccessRequest build() {
            DeletePrivateServiceAccessRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePrivateServiceAccessRequest
         */
        public DeletePrivateServiceAccessRequest buildWithoutInvocationCallback() {
            DeletePrivateServiceAccessRequest request = new DeletePrivateServiceAccessRequest();
            request.privateServiceAccessId = privateServiceAccessId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeletePrivateServiceAccessRequest(privateServiceAccessId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePrivateServiceAccessRequest)) {
            return false;
        }

        DeletePrivateServiceAccessRequest other = (DeletePrivateServiceAccessRequest) o;
