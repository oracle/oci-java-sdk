...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/psa/ListPrivateServiceAccessesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPrivateServiceAccessesRequest.
 */
...
public class ListPrivateServiceAccessesRequest
    ...
    public static class Builder
        ...
        public ListPrivateServiceAccessesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPrivateServiceAccessesRequest(compartmentId, lifecycleState, displayName, id, vcnId, serviceId, limit, page, sortBy, sortOrder, opcRequestId);
        }
    }
