...
/**
 * Private Service Access (PSA) is a new way to create private accesss for a service. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PrivateServiceAccess.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PrivateServiceAccess
    ...
    public static class Builder {
        ...
        public PrivateServiceAccess build() {
            PrivateServiceAccess model =
                    new PrivateServiceAccess(
                            this.compartmentId,
                            this.definedTags,
                            this.freeformTags,
                            this.systemTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrivateServiceAccess model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrivateServiceAccess(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrivateServiceAccess)) {
            return false;
        }

        PrivateServiceAccess other = (PrivateServiceAccess) o;
