...
public class ListPsaWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private com.oracle.bmc.psa.model.WorkRequestErrorCollection workRequestErrorCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.psa.model.WorkRequestErrorCollection getWorkRequestErrorCollection() {
    ...
    private ListPsaWorkRequestErrorsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.psa.model.WorkRequestErrorCollection workRequestErrorCollection) {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListPsaWorkRequestErrorsResponse o) {
         ...
         */
        @Override
        public ListPsaWorkRequestErrorsResponse build() {
            return new ListPsaWorkRequestErrorsResponse(
                    __httpStatusCode__,
                    headers,
                    opcNextPage,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPsaWorkRequestErrorsResponse)) {
            return false;
        }

        ListPsaWorkRequestErrorsResponse other = (ListPsaWorkRequestErrorsResponse) o;
