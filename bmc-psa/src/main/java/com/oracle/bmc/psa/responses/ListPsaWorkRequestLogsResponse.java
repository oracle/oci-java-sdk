...
public class ListPsaWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private com.oracle.bmc.psa.model.WorkRequestLogEntryCollection workRequestLogEntryCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.psa.model.WorkRequestLogEntryCollection
    ...
    private ListPsaWorkRequestLogsResponse(
            int __httpStatusCode__,
            java.util.Map<String, java.util.List<String>> headers,
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.psa.model.WorkRequestLogEntryCollection workRequestLogEntryCollection) {
    ...
    public static class Builder
        ...
        /** The returned {@code WorkRequestLogEntryCollection} instance. */
        private com.oracle.bmc.psa.model.WorkRequestLogEntryCollection
                workRequestLogEntryCollection;
         ...
         */
        @Override
        public Builder copy(ListPsaWorkRequestLogsResponse o) {
         ...
         */
        @Override
        public ListPsaWorkRequestLogsResponse build() {
            return new ListPsaWorkRequestLogsResponse(
                    __httpStatusCode__,
                    headers,
                    opcNextPage,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPsaWorkRequestLogsResponse)) {
            return false;
        }

        ListPsaWorkRequestLogsResponse other = (ListPsaWorkRequestLogsResponse) o;
