...
public class ListRecipientInvitationsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.tenantmanagercontrolplane.model.RecipientInvitationCollection
            getRecipientInvitationCollection() {
        return recipientInvitationCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder recipientInvitationCollection(
                com.oracle.bmc.tenantmanagercontrolplane.model.RecipientInvitationCollection
                        recipientInvitationCollection) {
            this.recipientInvitationCollection = recipientInvitationCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",recipientInvitationCollection=")
                .append(String.valueOf(recipientInvitationCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecipientInvitationsResponse)) {
            return false;
        }

        ListRecipientInvitationsResponse other = (ListRecipientInvitationsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.recipientInvitationCollection, other.recipientInvitationCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.recipientInvitationCollection == null
                                ? 43
                                : this.recipientInvitationCollection.hashCode());
        return result;
    }
}
