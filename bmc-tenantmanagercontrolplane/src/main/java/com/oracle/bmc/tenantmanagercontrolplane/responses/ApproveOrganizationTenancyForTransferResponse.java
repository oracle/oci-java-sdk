...
public class ApproveOrganizationTenancyForTransferResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApproveOrganizationTenancyForTransferResponse)) {
            return false;
        }

        ApproveOrganizationTenancyForTransferResponse other =
                (ApproveOrganizationTenancyForTransferResponse) o;
