...
public class UpdateRecipientInvitationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    public static com.oracle.bmc.tenantmanagercontrolplane.requests.UpdateRecipientInvitationRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.tenantmanagercontrolplane.requests.UpdateRecipientInvitationRequest
                    request) {
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.tenantmanagercontrolplane.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.tenantmanagercontrolplane.responses.UpdateRecipientInvitationResponse");
                                com.google.common.base.Function<
                                        ...
                                        responseFn =
                                                RESPONSE_CONVERSION_FACTORY.create(
                                                        RecipientInvitation.class);

                                com.oracle.bmc.http.internal.WithHeaders<RecipientInvitation>
                                        response = responseFn.apply(rawResponse);
                                javax.ws.rs.core.MultivaluedMap<String, String> headers =
                                        response.getHeaders();

                                com.oracle.bmc.tenantmanagercontrolplane.responses
                                                .UpdateRecipientInvitationResponse.Builder
                                        builder =
                                                com.oracle.bmc.tenantmanagercontrolplane.responses
                                                        .UpdateRecipientInvitationResponse.builder()
                                                        .__httpStatusCode__(
