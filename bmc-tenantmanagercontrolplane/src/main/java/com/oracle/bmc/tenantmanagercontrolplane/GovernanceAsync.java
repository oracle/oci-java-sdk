...
public interface GovernanceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<AddGovernanceResponse> addGovernance(
            AddGovernanceRequest request,
            com.oracle.bmc.responses.AsyncHandler<AddGovernanceRequest, AddGovernanceResponse>
                    handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<RemoveGovernanceResponse> removeGovernance(
            RemoveGovernanceRequest request,
            com.oracle.bmc.responses.AsyncHandler<RemoveGovernanceRequest, RemoveGovernanceResponse>
                    handler);
}
