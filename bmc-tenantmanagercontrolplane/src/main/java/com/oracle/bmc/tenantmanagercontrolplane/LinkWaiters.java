...
public class LinkWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<
        ...
        return forLinkWithTenancyNames(
    ...
    // Helper method to create a new Waiter for LinkWithTenancyNames.
    private com.oracle.bmc.waiter.Waiter<
                    GetLinkWithTenancyNamesRequest, GetLinkWithTenancyNamesResponse>
            forLinkWithTenancyNames(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetLinkWithTenancyNamesRequest request,
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetLinkWithTenancyNamesRequest, GetLinkWithTenancyNamesResponse>() {
                            @Override
                            public GetLinkWithTenancyNamesResponse apply(
                                    GetLinkWithTenancyNamesRequest request) {
                                return client.getLinkWithTenancyNames(request);
                            }
                        },
                        new java.util.function.Predicate<GetLinkWithTenancyNamesResponse>() {
                            @Override
                            public boolean test(GetLinkWithTenancyNamesResponse response) {
                                return targetStatesSet.contains(
                                        response.getLinkWithTenancyNames().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.tenantmanagercontrolplane.model.LifecycleState
