...
public class OrdersClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Orders {
    ...
    @Override
    public ActivateOrderResponse activateOrder(ActivateOrderRequest request) {
        Objects.requireNonNull(
                request.getActivateOrderDetails(), "activateOrderDetails is required");

        Validate.notBlank(request.getActivationToken(), "activationToken must not be blank");

        return clientCall(request, ActivateOrderResponse::builder)
                .logger(LOG, "activateOrder")
                .serviceDetails(
                        "Orders",
                        "ActivateOrder",
                ...
                .handleResponseHeaderString(
                        "opc-request-id", ActivateOrderResponse.Builder::opcRequestId)
                .handleResponseHeaderString(
                        "opc-work-request-id", ActivateOrderResponse.Builder::opcWorkRequestId)
                .callSync();
    }
    ...
    public GetOrderResponse getOrder(GetOrderRequest request) {
        ...
        return clientCall(request, GetOrderResponse::builder)
                .logger(LOG, "getOrder")
                .serviceDetails(
                        "Orders",
                        "GetOrder",
                ...
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleBody(
                        com.oracle.bmc.tenantmanagercontrolplane.model.Order.class,
                        GetOrderResponse.Builder::order)
                .handleResponseHeaderString(
                        "opc-request-id", GetOrderResponse.Builder::opcRequestId)
                .callSync();
    }
