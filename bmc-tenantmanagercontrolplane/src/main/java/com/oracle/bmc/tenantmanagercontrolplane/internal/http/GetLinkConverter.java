...
public class GetLinkConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetLinkConverter.class);

    public static com.oracle.bmc.tenantmanagercontrolplane.requests.GetLinkRequest interceptRequest(
            com.oracle.bmc.tenantmanagercontrolplane.requests.GetLinkRequest request) {
