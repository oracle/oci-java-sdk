...
public class DeleteLinkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteLinkResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLinkResponse)) {
            return false;
        }

        DeleteLinkResponse other = (DeleteLinkResponse) o;
