 ...
 * resources of RecipientInvitation.
 * <p>
...
public class RecipientInvitationWaiters {
    ...
    public RecipientInvitationWaiters(
            java.util.concurrent.ExecutorService executorService, RecipientInvitation client) {
    ...
    // Helper method to create a new Waiter for RecipientInvitation.
    private com.oracle.bmc.waiter.Waiter<
                    GetRecipientInvitationRequest, GetRecipientInvitationResponse>
            forRecipientInvitation(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetRecipientInvitationRequest request,
