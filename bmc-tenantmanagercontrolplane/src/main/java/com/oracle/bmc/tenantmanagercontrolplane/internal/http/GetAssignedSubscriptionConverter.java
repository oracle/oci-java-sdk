...
public class GetAssignedSubscriptionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAssignedSubscriptionConverter.class);

    public static com.oracle.bmc.tenantmanagercontrolplane.requests.GetAssignedSubscriptionRequest
            interceptRequest(
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getAssignedSubscriptionId()));
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.tenantmanagercontrolplane.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.tenantmanagercontrolplane.responses.GetAssignedSubscriptionResponse");
                                final com.google.common.base.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.tenantmanagercontrolplane
                                                                .model.AssignedSubscription>>
                                        responseFn;
                                ...
                                builder.assignedSubscription(response.getItem());
