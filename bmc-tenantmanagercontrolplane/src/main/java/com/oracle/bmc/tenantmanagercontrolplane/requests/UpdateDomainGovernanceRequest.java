...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/tenantmanagercontrolplane/UpdateDomainGovernanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDomainGovernanceRequest.
 */
...
public class UpdateDomainGovernanceRequest
    ...
    public static class Builder
        ...
        public UpdateDomainGovernanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDomainGovernanceRequest(domainGovernanceId, updateDomainGovernanceDetails, ifMatch, opcRequestId);
        }
    }
