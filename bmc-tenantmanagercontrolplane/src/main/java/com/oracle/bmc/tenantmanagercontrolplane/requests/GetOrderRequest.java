...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/tenantmanagercontrolplane/GetOrderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOrderRequest.
 */
...
public class GetOrderRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetOrderRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOrderRequest o) {
        ...
        /**
         * Build the instance of GetOrderRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOrderRequest
         */
        public GetOrderRequest build() {
            GetOrderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOrderRequest
         */
        public GetOrderRequest buildWithoutInvocationCallback() {
            GetOrderRequest request = new GetOrderRequest();
            request.activationToken = activationToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetOrderRequest(activationToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOrderRequest)) {
            return false;
        }
