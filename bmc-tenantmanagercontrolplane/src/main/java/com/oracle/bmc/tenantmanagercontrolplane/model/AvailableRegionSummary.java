...
public final class AvailableRegionSummary {
    ...
    public static class Builder {
        ...
        public AvailableRegionSummary build() {
            AvailableRegionSummary __instance__ = new AvailableRegionSummary(regionName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AvailableRegionSummary o) {
            Builder copiedBuilder = regionName(o.getRegionName());
