...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudAssignedSubscriptionSummary.Builder.class)
...
public final class CloudAssignedSubscriptionSummary extends AssignedSubscriptionSummary {
    ...
    public static class Builder {
        ...
        public CloudAssignedSubscriptionSummary build() {
            CloudAssignedSubscriptionSummary model =
                    new CloudAssignedSubscriptionSummary(
                            this.id,
                            this.compartmentId,
                            this.serviceName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudAssignedSubscriptionSummary model) {
    ...
    @Deprecated
    public CloudAssignedSubscriptionSummary(
            String id,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAssignedSubscriptionSummary)) {
            return false;
        }

        CloudAssignedSubscriptionSummary other = (CloudAssignedSubscriptionSummary) o;
