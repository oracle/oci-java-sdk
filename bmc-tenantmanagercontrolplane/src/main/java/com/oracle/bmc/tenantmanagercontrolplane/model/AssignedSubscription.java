...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = AssignedSubscription.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = ClassicAssignedSubscription.class,
        name = "V1"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CloudAssignedSubscription.class,
        name = "V2"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class AssignedSubscription extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected AssignedSubscription(
            String id,
