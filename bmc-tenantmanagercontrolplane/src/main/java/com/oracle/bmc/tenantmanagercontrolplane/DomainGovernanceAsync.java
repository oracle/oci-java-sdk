...
public interface DomainGovernanceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateDomainGovernanceResponse> createDomainGovernance(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<DeleteDomainGovernanceResponse> deleteDomainGovernance(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetDomainGovernanceResponse> getDomainGovernance(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListDomainGovernancesResponse> listDomainGovernances(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateDomainGovernanceResponse> updateDomainGovernance(
