...
public class ListWorkRequestErrorsConverter {
    ...
    public static com.oracle.bmc.tenantmanagercontrolplane.requests.ListWorkRequestErrorsRequest
            interceptRequest(
                    com.oracle.bmc.tenantmanagercontrolplane.requests.ListWorkRequestErrorsRequest
                            request) {
