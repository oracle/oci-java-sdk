...
public class GovernanceClient extends com.oracle.bmc.http.internal.BaseSyncClient
    ...
    public static class Builder
        ...
        public GovernanceClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new GovernanceClient(this, authenticationDetailsProvider);
        }
    }
    ...
    public AddGovernanceResponse addGovernance(AddGovernanceRequest request) {
        ...
        return clientCall(request, AddGovernanceResponse::builder)
                .logger(LOG, "addGovernance")
                .serviceDetails(
                        "Governance",
                        "AddGovernance",
                ...
                .appendPathParam("addGovernance")
                .accept("application/json")
                .appendHeader("if-match", request.getIfMatch())
                .appendHeader("opc-retry-token", request.getOpcRetryToken())
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleResponseHeaderString(
                        "opc-request-id", AddGovernanceResponse.Builder::opcRequestId)
                .handleResponseHeaderString(
                        "opc-work-request-id", AddGovernanceResponse.Builder::opcWorkRequestId)
                .callSync();
    }
    ...
    public RemoveGovernanceResponse removeGovernance(RemoveGovernanceRequest request) {
        ...
        return clientCall(request, RemoveGovernanceResponse::builder)
                .logger(LOG, "removeGovernance")
                .serviceDetails(
                        "Governance",
                        "RemoveGovernance",
                ...
                .appendPathParam(request.getOrganizationTenancyId())
                .appendPathParam("actions")
                .appendPathParam("removeGovernance")
                .accept("application/json")
                .appendHeader("if-match", request.getIfMatch())
                .appendHeader("opc-retry-token", request.getOpcRetryToken())
                .appendHeader("opc-request-id", request.getOpcRequestId())
                .handleResponseHeaderString(
                        "opc-request-id", RemoveGovernanceResponse.Builder::opcRequestId)
                .handleResponseHeaderString(
                        "opc-work-request-id", RemoveGovernanceResponse.Builder::opcWorkRequestId)
                .callSync();
    }
