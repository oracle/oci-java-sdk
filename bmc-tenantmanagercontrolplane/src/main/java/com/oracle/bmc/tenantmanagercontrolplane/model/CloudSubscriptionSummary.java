...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CloudSubscriptionSummary.Builder.class
)
...
public final class CloudSubscriptionSummary extends SubscriptionSummary {
    ...
    public static class Builder {
        ...
        public CloudSubscriptionSummary build() {
            CloudSubscriptionSummary model =
                    new CloudSubscriptionSummary(
                            this.id,
                            this.compartmentId,
                            this.serviceName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudSubscriptionSummary model) {
    ...
    @Deprecated
    public CloudSubscriptionSummary(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudSubscriptionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudSubscriptionSummary)) {
            return false;
        }

        CloudSubscriptionSummary other = (CloudSubscriptionSummary) o;
