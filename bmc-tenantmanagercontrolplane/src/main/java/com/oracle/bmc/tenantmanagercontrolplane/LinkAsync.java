...
public interface LinkAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<DeleteLinkResponse> deleteLink(
            DeleteLinkRequest request,
            com.oracle.bmc.responses.AsyncHandler<DeleteLinkRequest, DeleteLinkResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetLinkResponse> getLink(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListLinksResponse> listLinks(
            ListLinksRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListLinksRequest, ListLinksResponse> handler);
}
