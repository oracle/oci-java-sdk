...
public interface RecipientInvitationAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<AcceptRecipientInvitationResponse> acceptRecipientInvitation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetRecipientInvitationResponse> getRecipientInvitation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<IgnoreRecipientInvitationResponse> ignoreRecipientInvitation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListRecipientInvitationsResponse> listRecipientInvitations(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateRecipientInvitationResponse> updateRecipientInvitation(
