...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/tenantmanagercontrolplane/ListDomainsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDomainsRequest.
 */
...
public class ListDomainsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.tenantmanagercontrolplane.model.Domain.Status status) {
            this.status = status;
            return this;
        }
