...
public class SenderInvitationClient implements SenderInvitation {
     ...
     */
    protected SenderInvitationClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public CancelSenderInvitationResponse cancelSenderInvitation(
        ...
        LOG.trace("Called cancelSenderInvitation");
    ...
    public CreateSenderInvitationResponse createSenderInvitation(
        ...
        LOG.trace("Called createSenderInvitation");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateSenderInvitationDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetSenderInvitationResponse getSenderInvitation(GetSenderInvitationRequest request) {
        LOG.trace("Called getSenderInvitation");
    ...
    public ListSenderInvitationsResponse listSenderInvitations(
        ...
        LOG.trace("Called listSenderInvitations");
    ...
    public UpdateSenderInvitationResponse updateSenderInvitation(
        ...
        LOG.trace("Called updateSenderInvitation");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateSenderInvitationDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
