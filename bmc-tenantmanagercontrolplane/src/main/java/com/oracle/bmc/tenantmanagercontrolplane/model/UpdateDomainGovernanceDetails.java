...
public class UpdateDomainGovernanceDetails {
    ...
    public static class Builder {
        ...
        public UpdateDomainGovernanceDetails build() {
            UpdateDomainGovernanceDetails __instance__ =
                    new UpdateDomainGovernanceDetails(
                            subscriptionEmail, isGovernanceEnabled, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDomainGovernanceDetails o) {
