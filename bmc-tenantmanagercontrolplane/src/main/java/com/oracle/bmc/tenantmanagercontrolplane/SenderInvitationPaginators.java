 ...
 * to any list operations of SenderInvitation where multiple pages of data may be fetched. Two
...
public class SenderInvitationPaginators {
     ...
     * listSenderInvitations operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.tenantmanagercontrolplane.model.SenderInvitationSummary} objects contained in
     * responses from the listSenderInvitations operation. This iterable will fetch more data from
     * the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.tenantmanagercontrolplane.model.SenderInvitationSummary} objects contained
