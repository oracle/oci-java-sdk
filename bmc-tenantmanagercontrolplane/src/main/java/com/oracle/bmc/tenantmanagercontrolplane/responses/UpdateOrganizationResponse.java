...
public class UpdateOrganizationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateOrganizationResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateOrganizationResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOrganizationResponse)) {
            return false;
        }
