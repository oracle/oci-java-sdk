...
public class DomainGovernanceClient implements DomainGovernance {
    ...
    public static final com.oracle.bmc.Service SERVICE =
            com.oracle.bmc.Services.serviceBuilder()
                    .serviceName(DomainGovernanceClient.class.getName())
     ...
     */
    protected DomainGovernanceClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public DomainGovernanceClient build(
            ...
            return new DomainGovernanceClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public CreateDomainGovernanceResponse createDomainGovernance(
        ...
        LOG.trace("Called createDomainGovernance");
        final CreateDomainGovernanceRequest interceptedRequest =
                CreateDomainGovernanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateDomainGovernanceConverter.fromRequest(client, interceptedRequest);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDomainGovernanceDetails(),
                                                retriedRequest);
    ...
    public DeleteDomainGovernanceResponse deleteDomainGovernance(
        ...
        LOG.trace("Called deleteDomainGovernance");
        final DeleteDomainGovernanceRequest interceptedRequest =
                DeleteDomainGovernanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteDomainGovernanceConverter.fromRequest(client, interceptedRequest);
    ...
    public GetDomainGovernanceResponse getDomainGovernance(GetDomainGovernanceRequest request) {
        LOG.trace("Called getDomainGovernance");
        final GetDomainGovernanceRequest interceptedRequest =
                GetDomainGovernanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetDomainGovernanceConverter.fromRequest(client, interceptedRequest);
    ...
    public ListDomainGovernancesResponse listDomainGovernances(
        ...
        LOG.trace("Called listDomainGovernances");
        final ListDomainGovernancesRequest interceptedRequest =
                ListDomainGovernancesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListDomainGovernancesConverter.fromRequest(client, interceptedRequest);
    ...
    public UpdateDomainGovernanceResponse updateDomainGovernance(
        ...
        LOG.trace("Called updateDomainGovernance");
        final UpdateDomainGovernanceRequest interceptedRequest =
                UpdateDomainGovernanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateDomainGovernanceConverter.fromRequest(client, interceptedRequest);
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateDomainGovernanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
