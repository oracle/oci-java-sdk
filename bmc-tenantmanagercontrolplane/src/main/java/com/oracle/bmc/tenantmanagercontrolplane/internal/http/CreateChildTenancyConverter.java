...
public class CreateChildTenancyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateChildTenancyConverter.class);

    public static com.oracle.bmc.tenantmanagercontrolplane.requests.CreateChildTenancyRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.tenantmanagercontrolplane.requests.CreateChildTenancyRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(
                request.getCreateChildTenancyDetails(), "createChildTenancyDetails is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20200801").path("childTenancies");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.tenantmanagercontrolplane.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.tenantmanagercontrolplane.responses.CreateChildTenancyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
