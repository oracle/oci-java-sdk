...
public class GetOrganizationTenancyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOrganizationTenancyResponse)) {
            return false;
        }

        GetOrganizationTenancyResponse other = (GetOrganizationTenancyResponse) o;
