...
public interface OrdersAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ActivateOrderResponse> activateOrder(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetOrderResponse> getOrder(
            GetOrderRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetOrderRequest, GetOrderResponse> handler);
}
