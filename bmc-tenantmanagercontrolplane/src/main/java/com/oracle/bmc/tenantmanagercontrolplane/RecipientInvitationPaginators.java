 ...
 * to any list operations of RecipientInvitation where multiple pages of data may be fetched. Two
...
public class RecipientInvitationPaginators {
     ...
     * listRecipientInvitations operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.tenantmanagercontrolplane.model.RecipientInvitationSummary} objects contained
     * in responses from the listRecipientInvitations operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.tenantmanagercontrolplane.model.RecipientInvitationSummary} objects
