...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "kind",
    defaultImpl = FailureDestinationDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = StreamFailureDestinationDetails.class,
        name = "STREAM"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = QueueFailureDestinationDetails.class,
        name = "QUEUE"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = NotificationFailureDestinationDetails.class,
        name = "NOTIFICATION"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = NoneFailureDestinationDetails.class,
        name = "NONE"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class FailureDestinationDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected FailureDestinationDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FailureDestinationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FailureDestinationDetails)) {
            return false;
        }

        FailureDestinationDetails other = (FailureDestinationDetails) o;
