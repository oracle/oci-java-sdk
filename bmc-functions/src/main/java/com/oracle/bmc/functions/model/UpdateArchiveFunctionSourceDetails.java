...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateArchiveFunctionSourceDetails.Builder.class
)
...
public final class UpdateArchiveFunctionSourceDetails extends UpdateFunctionSourceDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {

        @com.fasterxml.jackson.annotation.JsonProperty("archiveSourceDetails")
        private UpdateArchiveSourceDetails archiveSourceDetails;

        public Builder archiveSourceDetails(UpdateArchiveSourceDetails archiveSourceDetails) {
        ...
        private UpdateRuntimeConfig runtimeConfig;

        public Builder runtimeConfig(UpdateRuntimeConfig runtimeConfig) {
        ...
        public UpdateArchiveFunctionSourceDetails build() {
            UpdateArchiveFunctionSourceDetails model =
                    new UpdateArchiveFunctionSourceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateArchiveFunctionSourceDetails model) {
    ...
    @Deprecated
    public UpdateArchiveFunctionSourceDetails(
            UpdateArchiveSourceDetails archiveSourceDetails,
            String handler,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("archiveSourceDetails")
    private final UpdateArchiveSourceDetails archiveSourceDetails;

    public UpdateArchiveSourceDetails getArchiveSourceDetails() {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("runtimeConfig")
    private final UpdateRuntimeConfig runtimeConfig;

    public UpdateRuntimeConfig getRuntimeConfig() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateArchiveFunctionSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateArchiveFunctionSourceDetails)) {
            return false;
        }

        UpdateArchiveFunctionSourceDetails other = (UpdateArchiveFunctionSourceDetails) o;
