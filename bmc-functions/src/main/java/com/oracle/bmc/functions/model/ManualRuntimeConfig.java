...
/**
 * FunctionsRuntime configuration for a function with 'MANUAL' Runtime Update strategy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ManualRuntimeConfig.Builder.class)
...
public final class ManualRuntimeConfig extends RuntimeConfig {
    ...
    public static class Builder {
        ...
        public ManualRuntimeConfig build() {
            ManualRuntimeConfig model =
                    new ManualRuntimeConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManualRuntimeConfig model) {
    ...
    @Deprecated
    public ManualRuntimeConfig(String functionsRuntimeName, String functionsRuntimeVersionId) {
        super();
        this.functionsRuntimeName = functionsRuntimeName;
        this.functionsRuntimeVersionId = functionsRuntimeVersionId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManualRuntimeConfig)) {
            return false;
        }

        ManualRuntimeConfig other = (ManualRuntimeConfig) o;
