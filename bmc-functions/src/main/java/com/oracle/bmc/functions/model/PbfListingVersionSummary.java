...
/**
 * Note: Deprecated. Use the new resource model APIs instead. Summary of the PbfListingVersion. <br>
...
public final class PbfListingVersionSummary
    ...
    public PbfListingVersionSummary(
            String id,
            String pbfListingId,
            String name,
    ...
    public static class Builder {
        ...
        public PbfListingVersionSummary build() {
            PbfListingVersionSummary model =
                    new PbfListingVersionSummary(
                            this.id,
                            this.pbfListingId,
                            this.name,
                            this.config,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PbfListingVersionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PbfListingVersionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PbfListingVersionSummary)) {
            return false;
        }

        PbfListingVersionSummary other = (PbfListingVersionSummary) o;
