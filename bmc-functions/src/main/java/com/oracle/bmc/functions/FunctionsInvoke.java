...
public interface FunctionsInvoke extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/functions/InvokeFunctionExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use InvokeFunction API.
     */
