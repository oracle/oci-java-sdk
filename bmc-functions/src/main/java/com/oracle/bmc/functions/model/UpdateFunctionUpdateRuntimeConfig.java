...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFunctionUpdateRuntimeConfig.Builder.class)
...
public final class UpdateFunctionUpdateRuntimeConfig extends UpdateRuntimeConfig {
    ...
    public static class Builder {
        ...
        public UpdateFunctionUpdateRuntimeConfig build() {
            UpdateFunctionUpdateRuntimeConfig model =
                    new UpdateFunctionUpdateRuntimeConfig(this.functionsRuntimeName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateFunctionUpdateRuntimeConfig model) {
    ...
    @Deprecated
    public UpdateFunctionUpdateRuntimeConfig(String functionsRuntimeName) {
        super();
        this.functionsRuntimeName = functionsRuntimeName;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFunctionUpdateRuntimeConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFunctionUpdateRuntimeConfig)) {
            return false;
        }

        UpdateFunctionUpdateRuntimeConfig other = (UpdateFunctionUpdateRuntimeConfig) o;
