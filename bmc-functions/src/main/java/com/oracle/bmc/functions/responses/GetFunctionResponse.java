...
public class GetFunctionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public GetFunctionResponse build() {
            return new GetFunctionResponse(__httpStatusCode__, etag, opcRequestId, function);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFunctionResponse)) {
            return false;
        }

        GetFunctionResponse other = (GetFunctionResponse) o;
