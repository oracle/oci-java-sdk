...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "kind",
    defaultImpl = SuccessDestinationDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = StreamSuccessDestinationDetails.class,
        name = "STREAM"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = NotificationSuccessDestinationDetails.class,
        name = "NOTIFICATION"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = QueueSuccessDestinationDetails.class,
        name = "QUEUE"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = NoneSuccessDestinationDetails.class,
        name = "NONE"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class SuccessDestinationDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected SuccessDestinationDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SuccessDestinationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SuccessDestinationDetails)) {
            return false;
        }

        SuccessDestinationDetails other = (SuccessDestinationDetails) o;
