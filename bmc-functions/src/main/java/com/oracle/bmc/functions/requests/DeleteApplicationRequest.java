...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/functions/DeleteApplicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteApplicationRequest.
 */
...
public class DeleteApplicationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteApplicationRequest
         */
        public DeleteApplicationRequest buildWithoutInvocationCallback() {
            DeleteApplicationRequest request = new DeleteApplicationRequest();
            request.applicationId = applicationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteApplicationRequest(applicationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApplicationRequest)) {
            return false;
        }

        DeleteApplicationRequest other = (DeleteApplicationRequest) o;
