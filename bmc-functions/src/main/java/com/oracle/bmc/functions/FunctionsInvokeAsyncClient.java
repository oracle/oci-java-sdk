...
public class FunctionsInvokeAsyncClient implements FunctionsInvokeAsync {
     ...
     */
    public FunctionsInvokeAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, FunctionsInvokeAsyncClient> {
        ...
        public FunctionsInvokeAsyncClient build(
            ...
            return new FunctionsInvokeAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public java.util.concurrent.Future<InvokeFunctionResponse> invokeFunction(
            InvokeFunctionRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            InvokeFunctionRequest, InvokeFunctionResponse>
                    handler) {
        LOG.trace("Called async invokeFunction");
            ...
            return new com.oracle.bmc.util.internal.RefreshAuthTokenWrapper<
                ...
                protected void beforeRetryAction() {
                    ...
                    com.oracle.bmc.retrier.Retriers.tryResetStreamForRetry(
                            interceptedRequest.getInvokeFunctionBody(), true);
                }
            };
        } else {
