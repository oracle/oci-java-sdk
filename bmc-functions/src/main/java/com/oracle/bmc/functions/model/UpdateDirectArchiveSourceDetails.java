...
/**
 * Source details required for updating an archive based function from Direct Archive. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDirectArchiveSourceDetails.Builder.class)
...
public final class UpdateDirectArchiveSourceDetails extends UpdateArchiveSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateDirectArchiveSourceDetails build() {
            UpdateDirectArchiveSourceDetails model =
                    new UpdateDirectArchiveSourceDetails(this.archiveFile);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDirectArchiveSourceDetails model) {
    ...
    @Deprecated
    public UpdateDirectArchiveSourceDetails(byte[] archiveFile) {
        super();
        this.archiveFile = archiveFile;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDirectArchiveSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDirectArchiveSourceDetails)) {
            return false;
        }

        UpdateDirectArchiveSourceDetails other = (UpdateDirectArchiveSourceDetails) o;
