...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/functions/ListWorkRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestsRequest.
 */
...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.functions.model.OperationStatus status;

    /**
     * A filter to return only the resources that match the given lifecycle state.
     */
    public com.oracle.bmc.functions.model.OperationStatus getStatus() {
        return status;
    }
    /**
    ...
    public static class Builder
         ...
         * A filter to return only the resources that match the given lifecycle state.
         */
        private com.oracle.bmc.functions.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.functions.model.OperationStatus status) {
            this.status = status;
            return this;
        }
