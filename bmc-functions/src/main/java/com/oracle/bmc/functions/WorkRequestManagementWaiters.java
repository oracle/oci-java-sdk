 ...
 * resources of WorkRequestManagement.
 *
...
public class WorkRequestManagementWaiters {
    ...
    public WorkRequestManagementWaiters(
            java.util.concurrent.ExecutorService executorService, WorkRequestManagement client) {
