...
/**
 * Source details for creating a container image based function. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateContainerImageFunctionSourceDetails.Builder.class)
...
public final class CreateContainerImageFunctionSourceDetails extends CreateFunctionSourceDetails {
    ...
    public static class Builder {
        ...
        public CreateContainerImageFunctionSourceDetails build() {
            CreateContainerImageFunctionSourceDetails model =
                    new CreateContainerImageFunctionSourceDetails(this.image, this.imageDigest);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateContainerImageFunctionSourceDetails model) {
    ...
    @Deprecated
    public CreateContainerImageFunctionSourceDetails(String image, String imageDigest) {
        super();
        this.image = image;
        this.imageDigest = imageDigest;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateContainerImageFunctionSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateContainerImageFunctionSourceDetails)) {
            return false;
        }

        CreateContainerImageFunctionSourceDetails other =
                (CreateContainerImageFunctionSourceDetails) o;
