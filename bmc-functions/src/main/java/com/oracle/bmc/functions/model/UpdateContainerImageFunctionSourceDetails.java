...
/**
 * Source details for updating a container image based function. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateContainerImageFunctionSourceDetails.Builder.class)
...
public final class UpdateContainerImageFunctionSourceDetails extends UpdateFunctionSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdateContainerImageFunctionSourceDetails build() {
            UpdateContainerImageFunctionSourceDetails model =
                    new UpdateContainerImageFunctionSourceDetails(this.image, this.imageDigest);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateContainerImageFunctionSourceDetails model) {
    ...
    @Deprecated
    public UpdateContainerImageFunctionSourceDetails(String image, String imageDigest) {
        super();
        this.image = image;
        this.imageDigest = imageDigest;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateContainerImageFunctionSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateContainerImageFunctionSourceDetails)) {
            return false;
        }

        UpdateContainerImageFunctionSourceDetails other =
                (UpdateContainerImageFunctionSourceDetails) o;
