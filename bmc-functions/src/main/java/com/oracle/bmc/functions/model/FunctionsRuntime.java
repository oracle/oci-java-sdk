 ...
 * user. This resource contains details about the runtimes supported language and os etc. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FunctionsRuntime.Builder.class)
...
public final class FunctionsRuntime
    ...
    public static class Builder {
        ...
        /**
         * A brief descriptive name for the FunctionsRuntime. The FunctionsRuntime name must be
         * unique, and not match any existing FunctionsRuntime.
         */
        ...
        /**
         * The operating system of the FunctionsRuntime. This is the OS that the FunctionsRuntime
         * provides for execution of customer payloads.
         */
        ...
        /**
         * The programming language of the FunctionsRuntime. This is the language that the
        ...
        /**
         * The time when the FunctionsRuntime will be deprecated. An RFC3339 formatted datetime
         * string.
         */
        ...
        /**
         * The time when the FunctionsRuntime will be decommissioned. An RFC3339 formatted datetime
         * string.
         */
        ...
        /**
         * The current state of the FunctionsRuntime resource. - {@code ACTIVE}: The resource is
         * currently active and operational. - {@code INACTIVE}: The resource is currently inactive
         * and not operational.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FunctionsRuntime model) {
    ...
    /**
     * A brief descriptive name for the FunctionsRuntime. The FunctionsRuntime name must be unique,
     * and not match any existing FunctionsRuntime.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("name")
