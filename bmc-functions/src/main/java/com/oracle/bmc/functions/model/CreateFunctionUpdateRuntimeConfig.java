...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateFunctionUpdateRuntimeConfig.Builder.class
)
...
public final class CreateFunctionUpdateRuntimeConfig extends CreateRuntimeConfig {
    ...
    public static class Builder {
        ...
        public CreateFunctionUpdateRuntimeConfig build() {
            CreateFunctionUpdateRuntimeConfig model =
                    new CreateFunctionUpdateRuntimeConfig(this.functionsRuntimeName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateFunctionUpdateRuntimeConfig model) {
    ...
    @Deprecated
    public CreateFunctionUpdateRuntimeConfig(String functionsRuntimeName) {
        super();
        this.functionsRuntimeName = functionsRuntimeName;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateFunctionUpdateRuntimeConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFunctionUpdateRuntimeConfig)) {
            return false;
        }

        CreateFunctionUpdateRuntimeConfig other = (CreateFunctionUpdateRuntimeConfig) o;
