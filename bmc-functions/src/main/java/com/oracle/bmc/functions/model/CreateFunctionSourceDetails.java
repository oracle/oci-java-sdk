...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "sourceType",
    defaultImpl = CreateFunctionSourceDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CreatePreBuiltFunctionSourceDetails.class,
        name = "PRE_BUILT_FUNCTIONS"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CreateArchiveFunctionSourceDetails.class,
        name = "ARCHIVE"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CreateContainerImageFunctionSourceDetails.class,
...
public class CreateFunctionSourceDetails
    ...
    protected CreateFunctionSourceDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateFunctionSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFunctionSourceDetails)) {
            return false;
        }

        CreateFunctionSourceDetails other = (CreateFunctionSourceDetails) o;
