...
public class ListApplicationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.functions.model.ApplicationSummary} instances. */
    private java.util.List<com.oracle.bmc.functions.model.ApplicationSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.functions.model.ApplicationSummary> getItems() {
        return items;
    }
    ...
    private ListApplicationsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.functions.model.ApplicationSummary> items) {
