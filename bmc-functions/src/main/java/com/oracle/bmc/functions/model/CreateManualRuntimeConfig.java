...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateManualRuntimeConfig.Builder.class
)
...
public final class CreateManualRuntimeConfig extends CreateRuntimeConfig {
    ...
    public static class Builder {
        ...
        public CreateManualRuntimeConfig build() {
            CreateManualRuntimeConfig model =
                    new CreateManualRuntimeConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateManualRuntimeConfig model) {
    ...
    @Deprecated
    public CreateManualRuntimeConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateManualRuntimeConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManualRuntimeConfig)) {
            return false;
        }

        CreateManualRuntimeConfig other = (CreateManualRuntimeConfig) o;
