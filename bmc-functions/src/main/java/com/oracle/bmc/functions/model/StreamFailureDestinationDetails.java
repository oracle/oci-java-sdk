...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StreamFailureDestinationDetails.Builder.class)
...
public final class StreamFailureDestinationDetails extends FailureDestinationDetails {
    ...
    public static class Builder {
        ...
        public StreamFailureDestinationDetails build() {
            StreamFailureDestinationDetails model =
                    new StreamFailureDestinationDetails(this.streamId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamFailureDestinationDetails model) {
    ...
    @Deprecated
    public StreamFailureDestinationDetails(String streamId) {
        super();
        this.streamId = streamId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StreamFailureDestinationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamFailureDestinationDetails)) {
            return false;
        }

        StreamFailureDestinationDetails other = (StreamFailureDestinationDetails) o;
