...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateManualRuntimeConfig.Builder.class
)
...
public final class UpdateManualRuntimeConfig extends UpdateRuntimeConfig {
    ...
    public static class Builder {
        ...
        public UpdateManualRuntimeConfig build() {
            UpdateManualRuntimeConfig model =
                    new UpdateManualRuntimeConfig(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateManualRuntimeConfig model) {
    ...
    @Deprecated
    public UpdateManualRuntimeConfig(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateManualRuntimeConfig(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManualRuntimeConfig)) {
            return false;
        }

        UpdateManualRuntimeConfig other = (UpdateManualRuntimeConfig) o;
