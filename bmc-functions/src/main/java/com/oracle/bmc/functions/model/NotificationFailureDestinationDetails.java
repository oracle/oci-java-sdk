...
public final class NotificationFailureDestinationDetails extends FailureDestinationDetails {
    ...
    public static class Builder {
        ...
        public NotificationFailureDestinationDetails build() {
            NotificationFailureDestinationDetails model =
                    new NotificationFailureDestinationDetails(this.topicId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotificationFailureDestinationDetails model) {
    ...
    @Deprecated
    public NotificationFailureDestinationDetails(String topicId) {
        super();
        this.topicId = topicId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NotificationFailureDestinationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotificationFailureDestinationDetails)) {
            return false;
        }

        NotificationFailureDestinationDetails other = (NotificationFailureDestinationDetails) o;
