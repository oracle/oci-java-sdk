...
public final class QueueFailureDestinationDetails extends FailureDestinationDetails {
    ...
    public static class Builder {
        ...
        public QueueFailureDestinationDetails build() {
            QueueFailureDestinationDetails model =
                    new QueueFailureDestinationDetails(this.queueId, this.channelId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueueFailureDestinationDetails model) {
    ...
    @Deprecated
    public QueueFailureDestinationDetails(String queueId, String channelId) {
        super();
        this.queueId = queueId;
        this.channelId = channelId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("QueueFailureDestinationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QueueFailureDestinationDetails)) {
            return false;
        }

        QueueFailureDestinationDetails other = (QueueFailureDestinationDetails) o;
