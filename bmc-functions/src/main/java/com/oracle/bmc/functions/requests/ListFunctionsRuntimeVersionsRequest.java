...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/functions/ListFunctionsRuntimeVersionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFunctionsRuntimeVersionsRequest.
 */
...
public class ListFunctionsRuntimeVersionsRequest
    ...
    public static class Builder
        ...
        public ListFunctionsRuntimeVersionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFunctionsRuntimeVersionsRequest(functionsRuntimeId, functionsRuntimeName, functionsRuntimeVersionId, displayName, osVersion, languageVersion, isCurrentVersion, lifecycleState, sortBy, limit, page, sortOrder, opcRequestId);
        }
    }
