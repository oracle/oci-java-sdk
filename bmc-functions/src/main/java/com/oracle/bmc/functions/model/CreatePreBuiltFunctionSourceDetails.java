...
/**
 * Source details for creating a function from a Pre\u2011Built Functions listing (PbfListing). <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreatePreBuiltFunctionSourceDetails.Builder.class)
...
public final class CreatePreBuiltFunctionSourceDetails extends CreateFunctionSourceDetails {
    ...
    public static class Builder {
        ...
        public CreatePreBuiltFunctionSourceDetails build() {
            CreatePreBuiltFunctionSourceDetails model =
                    new CreatePreBuiltFunctionSourceDetails(this.pbfListingId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePreBuiltFunctionSourceDetails model) {
    ...
    @Deprecated
    public CreatePreBuiltFunctionSourceDetails(String pbfListingId) {
        super();
        this.pbfListingId = pbfListingId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreatePreBuiltFunctionSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePreBuiltFunctionSourceDetails)) {
            return false;
        }

        CreatePreBuiltFunctionSourceDetails other = (CreatePreBuiltFunctionSourceDetails) o;
