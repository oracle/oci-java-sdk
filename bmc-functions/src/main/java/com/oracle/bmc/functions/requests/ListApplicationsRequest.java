...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/functions/ListApplicationsExample.java.html"
...
public class ListApplicationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * the compartment to which this resource belongs.
     */
    ...
    /**
     * A filter to return only applications with display names that match the display name string.
     * Matching is exact.
     */
    ...
    public static class Builder
         ...
         * of the compartment to which this resource belongs.
         */
        ...
        public Builder lifecycleState(
                com.oracle.bmc.functions.model.Application.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
            return this;
        }

        /**
         * A filter to return only applications with display names that match the display name
        ...
        public ListApplicationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListApplicationsRequest(compartmentId, limit, page, opcRequestId, lifecycleState,
