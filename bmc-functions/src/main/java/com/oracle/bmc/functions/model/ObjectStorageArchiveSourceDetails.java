...
/**
 * The details for the Archive source of the Function from Object Storage. This is used when the
 * function code is stored in Object Storage. It is suitable for scenarios where the function code
 * is uploaded as an archive file to a specific bucket and namespace <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ObjectStorageArchiveSourceDetails.Builder.class)
...
public final class ObjectStorageArchiveSourceDetails extends ArchiveSourceDetails {
    ...
    public static class Builder {
        ...
        public ObjectStorageArchiveSourceDetails build() {
            ObjectStorageArchiveSourceDetails model =
                    new ObjectStorageArchiveSourceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageArchiveSourceDetails model) {
    ...
    @Deprecated
    public ObjectStorageArchiveSourceDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectStorageArchiveSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageArchiveSourceDetails)) {
            return false;
        }

        ObjectStorageArchiveSourceDetails other = (ObjectStorageArchiveSourceDetails) o;
