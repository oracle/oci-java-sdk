...
public class GetFunctionsRuntimeVersionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetFunctionsRuntimeVersionConverter.class);

    public static com.oracle.bmc.functions.requests.GetFunctionsRuntimeVersionRequest
            interceptRequest(
                    com.oracle.bmc.functions.requests.GetFunctionsRuntimeVersionRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.functions.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.functions.responses.GetFunctionsRuntimeVersionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.functions.responses
                                                .GetFunctionsRuntimeVersionResponse.Builder
                                        builder =
                                                com.oracle.bmc.functions.responses
                                                        .GetFunctionsRuntimeVersionResponse
                                                        .builder()
                                ...
                                builder.functionsRuntimeVersion(response.getItem());
