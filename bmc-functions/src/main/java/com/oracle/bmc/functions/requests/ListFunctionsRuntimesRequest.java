...
public class ListFunctionsRuntimesRequest
    ...
    /**
     * A filter to return only resources that contain the supplied filter text in the
     * FunctionsRuntime name given.
     */
    ...
    /**
     * A filter to return only resources that start with the supplied filter text in the
     * FunctionsRuntime name given.
     */
    ...
    public static class Builder
        ...
        public ListFunctionsRuntimesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFunctionsRuntimesRequest(functionsRuntimeId, name, nameContains,
            // nameStartsWith, os, language, lifecycleState, limit, page, sortOrder, sortBy,
            // opcRequestId);
        }
    }
