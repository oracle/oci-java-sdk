 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPatchManagementRequest.
 */
...
public class GetPatchManagementRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * A filter to return only resources whose timeStarted is greater than or equal to the given
     * date-time.
     */
    ...
    public static class Builder
        ...
        public GetPatchManagementRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetPatchManagementRequest(compartmentId, opcRequestId, databaseRelease,
            // lifecycleState, timeStartedGreaterThanOrEqualTo, timeStartedLessThan);
        }
    }
