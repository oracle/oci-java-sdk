...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dblm/GetPatchManagementExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPatchManagementRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240102")
public class GetPatchManagementRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private java.util.Date timeStartedLessThan;

    /**
     * A filter to return only resources whose timeStarted is less than the given date-time.
     */
    public java.util.Date getTimeStartedLessThan() {
        return timeStartedLessThan;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetPatchManagementRequest, java.lang.Void> {
         ...
         * A filter to return only resources whose timeStarted is less than the given date-time.
         */
        private java.util.Date timeStartedLessThan = null;

        /**
         * A filter to return only resources whose timeStarted is less than the given date-time.
         * @param timeStartedLessThan the value to set
         * @return this builder instance
         */
        public Builder timeStartedLessThan(java.util.Date timeStartedLessThan) {
         ...
         * @return this builder instance
         */
        public Builder copy(GetPatchManagementRequest o) {
            ...
            timeStartedLessThan(o.getTimeStartedLessThan());
        ...
        /**
         * Build the instance of GetPatchManagementRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetPatchManagementRequest
         */
        public GetPatchManagementRequest build() {
            GetPatchManagementRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetPatchManagementRequest
         */
        public GetPatchManagementRequest buildWithoutInvocationCallback() {
            GetPatchManagementRequest request = new GetPatchManagementRequest();
            ...
            request.timeStartedLessThan = timeStartedLessThan;
            return request;
            // new GetPatchManagementRequest(compartmentId, opcRequestId, databaseRelease, lifecycleState, timeStartedGreaterThanOrEqualTo, timeStartedLessThan);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",timeStartedLessThan=").append(String.valueOf(this.timeStartedLessThan));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPatchManagementRequest)) {
            return false;
        }

        GetPatchManagementRequest other = (GetPatchManagementRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.timeStartedLessThan, other.timeStartedLessThan);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.timeStartedLessThan == null
                                ? 43
                                : this.timeStartedLessThan.hashCode());
        return result;
    }
}
