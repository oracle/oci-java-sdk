...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dblm/ListDatabasesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatabasesRequest.
 */
...
public class ListDatabasesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDatabasesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDatabasesRequest(compartmentId, lifecycleState, databaseRelease, databaseType, limit, page, sortOrder, sortBy, imageId, opcRequestId, displayName, drifterPatchId, imageCompliance, severityType);
        }
    }
