...
public interface DbLifeCycleManagementAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateVulnerabilityScanResponse> createVulnerabilityScan(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetPatchManagementResponse> getPatchManagement(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetVulnerabilityScanResponse> getVulnerabilityScan(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListAggregatedVulnerabilityDataResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListNotificationsResponse> listNotifications(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListVulnerabilityResourcesResponse> listVulnerabilityResources(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListVulnerabilityScansResponse> listVulnerabilityScans(
