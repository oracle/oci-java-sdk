...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateStreamGroupDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateStreamGroupDetails
    ...
    public UpdateStreamGroupDetails(
            String displayName,
            Boolean isEnabled,
    ...
    public static class Builder {
        ...
        public UpdateStreamGroupDetails build() {
            UpdateStreamGroupDetails model =
                    new UpdateStreamGroupDetails(
                            this.displayName,
                            this.isEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateStreamGroupDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateStreamGroupDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStreamGroupDetails)) {
            return false;
        }

        UpdateStreamGroupDetails other = (UpdateStreamGroupDetails) o;
