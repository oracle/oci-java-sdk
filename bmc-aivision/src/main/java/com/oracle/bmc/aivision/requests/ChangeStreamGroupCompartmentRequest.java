...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aivision/ChangeStreamGroupCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeStreamGroupCompartmentRequest.
 */
...
public class ChangeStreamGroupCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeStreamGroupCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeStreamGroupCompartmentRequest(streamGroupId, changeStreamGroupCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
