...
public class ImageFeature extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * boxes. - {@code TEXT_DETECTION}: Recognize text in the image.
     */
