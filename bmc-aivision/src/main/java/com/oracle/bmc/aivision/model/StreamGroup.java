...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StreamGroup.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StreamGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamGroup model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamGroup)) {
            return false;
        }

        StreamGroup other = (StreamGroup) o;
