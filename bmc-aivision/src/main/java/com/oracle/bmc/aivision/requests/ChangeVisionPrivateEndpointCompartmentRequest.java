...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aivision/ChangeVisionPrivateEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeVisionPrivateEndpointCompartmentRequest.
 */
...
public class ChangeVisionPrivateEndpointCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeVisionPrivateEndpointCompartmentRequest as configured by this builder
         *
        ...
        public ChangeVisionPrivateEndpointCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeVisionPrivateEndpointCompartmentRequest(visionPrivateEndpointId, changeVisionPrivateEndpointCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
