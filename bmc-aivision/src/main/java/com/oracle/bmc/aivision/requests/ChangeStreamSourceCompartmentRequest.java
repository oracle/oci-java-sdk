...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aivision/ChangeStreamSourceCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeStreamSourceCompartmentRequest.
 */
...
public class ChangeStreamSourceCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeStreamSourceCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeStreamSourceCompartmentRequest(streamSourceId, changeStreamSourceCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
