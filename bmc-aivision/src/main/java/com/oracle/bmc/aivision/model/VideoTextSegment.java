...
public final class VideoTextSegment extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"videoSegment", "confidence", "frames"})
    public VideoTextSegment(
            VideoSegment videoSegment, Float confidence, java.util.List<VideoTextFrame> frames) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<VideoTextFrame> frames;
         ...
         * @return this builder
         **/
        public Builder frames(java.util.List<VideoTextFrame> frames) {
            this.frames = frames;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("frames")
    private final java.util.List<VideoTextFrame> frames;

    /**
     * Text frame in a segment.
     * @return the value
     **/
    public java.util.List<VideoTextFrame> getFrames() {
        return frames;
    }
