...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VideoStreamMetadata.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class VideoStreamMetadata extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"frameRate", "frameWidth", "frameHeight"})
    public VideoStreamMetadata(Float frameRate, Integer frameWidth, Integer frameHeight) {
        super();
    ...
    public static class Builder {
        ...
        public VideoStreamMetadata build() {
            VideoStreamMetadata model =
                    new VideoStreamMetadata(this.frameRate, this.frameWidth, this.frameHeight);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VideoStreamMetadata model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoStreamMetadata)) {
            return false;
        }

        VideoStreamMetadata other = (VideoStreamMetadata) o;
        return java.util.Objects.equals(this.frameRate, other.frameRate)
