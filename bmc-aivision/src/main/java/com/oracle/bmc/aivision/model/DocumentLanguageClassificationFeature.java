...
/**
 * Detecting the language of the document. <br>
...
public final class DocumentLanguageClassificationFeature extends DocumentFeature {
    ...
    public static class Builder {
        ...
        public DocumentLanguageClassificationFeature build() {
            DocumentLanguageClassificationFeature model =
                    new DocumentLanguageClassificationFeature(this.maxResults);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DocumentLanguageClassificationFeature model) {
