...
public final class ObjectListInlineInputLocation extends InputLocation {
    ...
    public static class Builder {
        ...
        public ObjectListInlineInputLocation build() {
            ObjectListInlineInputLocation __instance__ =
                    new ObjectListInlineInputLocation(objectLocations);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectListInlineInputLocation o) {
            Builder copiedBuilder = objectLocations(o.getObjectLocations());
