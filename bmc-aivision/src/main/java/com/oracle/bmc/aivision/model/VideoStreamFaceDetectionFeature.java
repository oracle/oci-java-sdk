...
/**
 * Video stream face detection feature <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VideoStreamFaceDetectionFeature.Builder.class)
...
public final class VideoStreamFaceDetectionFeature extends VideoStreamFeature {
    ...
    public static class Builder {
        ...
        public VideoStreamFaceDetectionFeature build() {
            VideoStreamFaceDetectionFeature model =
                    new VideoStreamFaceDetectionFeature(
                            this.maxResults, this.shouldReturnLandmarks, this.minConfidence);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VideoStreamFaceDetectionFeature model) {
    ...
    @Deprecated
    public VideoStreamFaceDetectionFeature(
            Integer maxResults, Boolean shouldReturnLandmarks, Float minConfidence) {
        super();
        this.maxResults = maxResults;
        this.shouldReturnLandmarks = shouldReturnLandmarks;
        this.minConfidence = minConfidence;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VideoStreamFaceDetectionFeature(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoStreamFaceDetectionFeature)) {
            return false;
        }

        VideoStreamFaceDetectionFeature other = (VideoStreamFaceDetectionFeature) o;
