...
public class ValueDate extends FieldValue {
    ...
    public static class Builder {
        ...
        public ValueDate build() {
            ValueDate __instance__ =
                    new ValueDate(text, confidence, boundingPolygon, wordIndexes, value);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ValueDate o) {
