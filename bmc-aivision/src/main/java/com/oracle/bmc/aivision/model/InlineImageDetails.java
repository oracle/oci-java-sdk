...
/**
 * The image incorporated in the request payload. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InlineImageDetails.Builder.class)
...
public final class InlineImageDetails extends ImageDetails {
    ...
    public static class Builder {
        ...
        public InlineImageDetails build() {
            InlineImageDetails model = new InlineImageDetails(this.data);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InlineImageDetails model) {
    ...
    @Deprecated
    public InlineImageDetails(byte[] data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InlineImageDetails)) {
            return false;
        }
