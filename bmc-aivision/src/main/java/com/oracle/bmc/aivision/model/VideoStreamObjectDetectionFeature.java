...
/**
 * Video stream object detection feature <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VideoStreamObjectDetectionFeature.Builder.class)
...
public final class VideoStreamObjectDetectionFeature extends VideoStreamFeature {
    ...
    public static class Builder {
        ...
        public VideoStreamObjectDetectionFeature build() {
            VideoStreamObjectDetectionFeature model =
                    new VideoStreamObjectDetectionFeature(this.minConfidence, this.maxResults);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VideoStreamObjectDetectionFeature model) {
    ...
    @Deprecated
    public VideoStreamObjectDetectionFeature(Float minConfidence, Integer maxResults) {
        super();
        this.minConfidence = minConfidence;
        this.maxResults = maxResults;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VideoStreamObjectDetectionFeature(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VideoStreamObjectDetectionFeature)) {
            return false;
        }

        VideoStreamObjectDetectionFeature other = (VideoStreamObjectDetectionFeature) o;
