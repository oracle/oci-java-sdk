...
public final class VideoObject extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "segments"})
    public VideoObject(String name, java.util.List<VideoObjectSegment> segments) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private java.util.List<VideoObjectSegment> segments;
         ...
         * @return this builder
         **/
        public Builder segments(java.util.List<VideoObjectSegment> segments) {
            this.segments = segments;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("segments")
    private final java.util.List<VideoObjectSegment> segments;

    /**
     * Object segments in a video.
     * @return the value
     **/
    public java.util.List<VideoObjectSegment> getSegments() {
        return segments;
    }
