...
/**
 * A label describing an image. Every label returned by the pre-deployed model is in English. <br>
...
public final class Label extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public Label build() {
            Label model = new Label(this.name, this.confidence);
