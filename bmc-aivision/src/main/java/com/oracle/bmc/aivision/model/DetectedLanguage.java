...
public final class DetectedLanguage {
    ...
    public static class Builder {
        ...
        public DetectedLanguage build() {
            DetectedLanguage __instance__ = new DetectedLanguage(languageCode, confidence);
        ...
        public Builder copy(DetectedLanguage o) {
            Builder copiedBuilder = languageCode(o.getLanguageCode()).confidence(o.getConfidence());
