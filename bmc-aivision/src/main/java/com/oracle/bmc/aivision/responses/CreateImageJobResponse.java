...
public class CreateImageJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code ImageJob} instance. */
    ...
    private CreateImageJobResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateImageJobResponse> {
         ...
         */
        @Override
        public Builder copy(CreateImageJobResponse o) {
         ...
         */
        @Override
        public CreateImageJobResponse build() {
            return new CreateImageJobResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateImageJobResponse)) {
            return false;
        }

        CreateImageJobResponse other = (CreateImageJobResponse) o;
