...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StreamJobSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class StreamJobSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public StreamJobSummary(
            ...
            StreamJob.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private StreamJob.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(StreamJob.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public StreamJobSummary build() {
            StreamJobSummary model =
                    new StreamJobSummary(
                            this.id,
                            this.streamSourceId,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamJobSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final StreamJob.LifecycleState lifecycleState;

    /**
     * The current state of the Stream job.
     * @return the value
     **/
    public StreamJob.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamJobSummary)) {
            return false;
        }

        StreamJobSummary other = (StreamJobSummary) o;
