...
public final class WorkRequestSummary
    ...
    public static class Builder {
         ...
         * it is up to the service team to pick the primary resource whose compartment is used.
         */
     ...
     * service team to pick the primary resource whose compartment is used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
