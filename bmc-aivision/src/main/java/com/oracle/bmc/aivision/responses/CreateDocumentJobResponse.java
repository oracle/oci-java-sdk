...
public class CreateDocumentJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDocumentJobResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDocumentJobResponse)) {
            return false;
        }

        CreateDocumentJobResponse other = (CreateDocumentJobResponse) o;
