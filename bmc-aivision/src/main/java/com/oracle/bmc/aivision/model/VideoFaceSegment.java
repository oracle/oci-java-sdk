...
public final class VideoFaceSegment extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"videoSegment", "confidence", "frames"})
    public VideoFaceSegment(
            VideoSegment videoSegment, Float confidence, java.util.List<VideoFaceFrame> frames) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<VideoFaceFrame> frames;
         ...
         * @return this builder
         **/
        public Builder frames(java.util.List<VideoFaceFrame> frames) {
            this.frames = frames;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("frames")
    private final java.util.List<VideoFaceFrame> frames;

    /**
     * Face frames in a segment.
     * @return the value
     **/
    public java.util.List<VideoFaceFrame> getFrames() {
        return frames;
    }
