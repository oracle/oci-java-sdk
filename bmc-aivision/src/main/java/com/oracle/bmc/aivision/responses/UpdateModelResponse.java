...
public class UpdateModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateModelResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateModelResponse)) {
            return false;
        }

        UpdateModelResponse other = (UpdateModelResponse) o;
