...
public class CancelDocumentJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CancelDocumentJobResponse(int __httpStatusCode__, String opcRequestId) {
    ...
    public static class Builder {
        ...
        public CancelDocumentJobResponse build() {
            return new CancelDocumentJobResponse(__httpStatusCode__, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelDocumentJobResponse)) {
            return false;
        }

        CancelDocumentJobResponse other = (CancelDocumentJobResponse) o;
