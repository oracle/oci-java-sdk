...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StreamJob.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class StreamJob extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("agentParticipantId")
        private String agentParticipantId;

        /**
         * participant id of agent where results need to be sent
         *
         * @param agentParticipantId the value to set
         * @return this builder
         */
        public Builder agentParticipantId(String agentParticipantId) {
            this.agentParticipantId = agentParticipantId;
            this.__explicitlySet__.add("agentParticipantId");
            return this;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamJob model) {
            ...
            if (model.wasPropertyExplicitlySet("agentParticipantId")) {
                this.agentParticipantId(model.getAgentParticipantId());
            }
    ...
    /** participant id of agent where results need to be sent */
    @com.fasterxml.jackson.annotation.JsonProperty("agentParticipantId")
    private final String agentParticipantId;
     ...
     * @return the value
     */
    public String getAgentParticipantId() {
        return agentParticipantId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", agentParticipantId=").append(String.valueOf(this.agentParticipantId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamJob)) {
            return false;
        }

        StreamJob other = (StreamJob) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.agentParticipantId, other.agentParticipantId)
        ...
        result =
                (result * PRIME)
                        + (this.agentParticipantId == null
                                ? 43
                                : this.agentParticipantId.hashCode());
        result =
                (result * PRIME)
