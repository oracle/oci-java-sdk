...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/CopyDeploymentBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CopyDeploymentBackupRequest.
 */
...
public class CopyDeploymentBackupRequest
    ...
    public static class Builder
        ...
        public CopyDeploymentBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CopyDeploymentBackupRequest(deploymentBackupId, copyDeploymentBackupDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
