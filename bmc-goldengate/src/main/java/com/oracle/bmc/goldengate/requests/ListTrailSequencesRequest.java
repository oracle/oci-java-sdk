...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ListTrailSequencesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTrailSequencesRequest.
 */
...
public class ListTrailSequencesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListTrailSequencesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTrailSequencesRequest(deploymentId, trailFileId, trailSequenceId, displayName, opcRequestId, limit, page, sortBy, sortOrder);
        }
    }
