...
public final class UpdateGroupToRolesMappingDetails
    ...
    public UpdateGroupToRolesMappingDetails(
    ...
    public static class Builder {
        ...
        public UpdateGroupToRolesMappingDetails build() {
            UpdateGroupToRolesMappingDetails model =
                    new UpdateGroupToRolesMappingDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGroupToRolesMappingDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGroupToRolesMappingDetails)) {
            return false;
        }

        UpdateGroupToRolesMappingDetails other = (UpdateGroupToRolesMappingDetails) o;
