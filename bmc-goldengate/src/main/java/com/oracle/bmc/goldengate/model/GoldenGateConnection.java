...
/**
 * Represents the metadata of a GoldenGate Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GoldenGateConnection.Builder.class)
...
public final class GoldenGateConnection extends Connection {
    ...
    public static class Builder {
        ...
        public GoldenGateConnection build() {
            GoldenGateConnection model =
                    new GoldenGateConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GoldenGateConnection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GoldenGateConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoldenGateConnection)) {
            return false;
        }

        GoldenGateConnection other = (GoldenGateConnection) o;
