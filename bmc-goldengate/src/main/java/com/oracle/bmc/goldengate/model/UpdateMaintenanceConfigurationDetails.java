...
/**
 * Defines the maintenance configuration for update operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMaintenanceConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateMaintenanceConfigurationDetails
    ...
    public UpdateMaintenanceConfigurationDetails(
    ...
    public static class Builder {
        ...
        public UpdateMaintenanceConfigurationDetails build() {
            UpdateMaintenanceConfigurationDetails model =
                    new UpdateMaintenanceConfigurationDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMaintenanceConfigurationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMaintenanceConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMaintenanceConfigurationDetails)) {
            return false;
        }

        UpdateMaintenanceConfigurationDetails other = (UpdateMaintenanceConfigurationDetails) o;
