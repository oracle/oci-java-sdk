...
/**
 * The information about a new DB2 Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDb2ConnectionDetails.Builder.class)
...
public final class CreateDb2ConnectionDetails extends CreateConnectionDetails {
    ...
    public static class Builder {
        ...
        public CreateDb2ConnectionDetails build() {
            CreateDb2ConnectionDetails model =
                    new CreateDb2ConnectionDetails(
                            this.displayName,
                            this.description,
                            this.compartmentId,
                            this.freeformTags,
    ...
    public boolean equals(Object o) {
        ...
        CreateDb2ConnectionDetails other = (CreateDb2ConnectionDetails) o;
