...
/**
 * Summary of the Snowflake Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SnowflakeConnectionSummary.Builder.class)
...
public final class SnowflakeConnectionSummary extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public SnowflakeConnectionSummary build() {
            SnowflakeConnectionSummary model =
                    new SnowflakeConnectionSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SnowflakeConnectionSummary model) {
    ...
    @Deprecated
    public SnowflakeConnectionSummary(
            String id,
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SnowflakeConnectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SnowflakeConnectionSummary)) {
            return false;
        }

        SnowflakeConnectionSummary other = (SnowflakeConnectionSummary) o;
