...
/**
 * The information to update API key authentication details for an AI Model connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateApiKeyAiModelAuthDetails.Builder.class)
...
public final class UpdateApiKeyAiModelAuthDetails extends UpdateAiModelAuthDetails {
    ...
    public static class Builder {
        ...
        public UpdateApiKeyAiModelAuthDetails build() {
            UpdateApiKeyAiModelAuthDetails model =
                    new UpdateApiKeyAiModelAuthDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateApiKeyAiModelAuthDetails model) {
    ...
    @Deprecated
    public UpdateApiKeyAiModelAuthDetails(String baseUrl, String apiKey, String apiKeySecretId) {
        super();
        this.baseUrl = baseUrl;
        this.apiKey = apiKey != null ? apiKey.toCharArray() : null;
        this.apiKeySecretId = apiKeySecretId;
    ...
    @Deprecated
    public UpdateApiKeyAiModelAuthDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateApiKeyAiModelAuthDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateApiKeyAiModelAuthDetails)) {
            return false;
        }

        UpdateApiKeyAiModelAuthDetails other = (UpdateApiKeyAiModelAuthDetails) o;
