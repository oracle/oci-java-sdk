...
public class RemoveConnectionLockResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RemoveConnectionLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveConnectionLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveConnectionLockResponse o) {
         ...
         */
        @Override
        public RemoveConnectionLockResponse build() {
            return new RemoveConnectionLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveConnectionLockResponse)) {
            return false;
        }

        RemoveConnectionLockResponse other = (RemoveConnectionLockResponse) o;
