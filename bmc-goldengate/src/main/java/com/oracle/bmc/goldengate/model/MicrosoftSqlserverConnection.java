...
public final class MicrosoftSqlserverConnection extends Connection {
    ...
    public static class Builder {
        ...
        public MicrosoftSqlserverConnection build() {
            MicrosoftSqlserverConnection model =
                    new MicrosoftSqlserverConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MicrosoftSqlserverConnection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MicrosoftSqlserverConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MicrosoftSqlserverConnection)) {
            return false;
        }

        MicrosoftSqlserverConnection other = (MicrosoftSqlserverConnection) o;
