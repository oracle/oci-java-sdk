...
/**
 * Represents a Kafka bootstrap server with host name, optional port defaults to 9092. Deprecated:
 * privateIp is returned only for legacy deployments created with it. On update payloads, privateIp
 * can only be set to empty (cleared). <br>
