...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/StartDeploymentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartDeploymentRequest.
 */
...
public class StartDeploymentRequest
     ...
     *
     */
    public com.oracle.bmc.goldengate.model.StartDeploymentDetails getStartDeploymentDetails() {
    ...
    public static class Builder
         ...
         * A placeholder for any additional metadata to describe the deployment start.
         *
         * @param startDeploymentDetails the value to set
         * @return this builder instance
         */
        public Builder startDeploymentDetails(
                com.oracle.bmc.goldengate.model.StartDeploymentDetails startDeploymentDetails) {
        ...
        public StartDeploymentRequest buildWithoutInvocationCallback() {
            ...
            request.startDeploymentDetails = startDeploymentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.isLockOverride = isLockOverride;
            return request;
            // new StartDeploymentRequest(deploymentId, startDeploymentDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",startDeploymentDetails=").append(String.valueOf(this.startDeploymentDetails));
    ...
    public boolean equals(Object o) {
        ...
        StartDeploymentRequest other = (StartDeploymentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.deploymentId, other.deploymentId)
                && java.util.Objects.equals(
                        this.startDeploymentDetails, other.startDeploymentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.startDeploymentDetails == null
                                ? 43
                                : this.startDeploymentDetails.hashCode());
