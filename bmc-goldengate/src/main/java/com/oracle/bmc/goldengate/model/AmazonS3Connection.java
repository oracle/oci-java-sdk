...
/**
 * Represents the metadata of a Amazon S3 Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmazonS3Connection.Builder.class)
...
public final class AmazonS3Connection extends Connection {
    ...
    public static class Builder {
        ...
        public AmazonS3Connection build() {
            AmazonS3Connection model =
                    new AmazonS3Connection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmazonS3Connection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmazonS3Connection)) {
            return false;
        }
