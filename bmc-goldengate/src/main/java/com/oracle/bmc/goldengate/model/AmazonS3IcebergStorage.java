...
/**
 * Represents an Amazon S3 storage used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmazonS3IcebergStorage.Builder.class)
...
public final class AmazonS3IcebergStorage extends IcebergStorage {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder schemeType(SchemeType schemeType) {
        ...
        public AmazonS3IcebergStorage build() {
            AmazonS3IcebergStorage model =
                    new AmazonS3IcebergStorage(
                            this.schemeType,
                            this.endpoint,
                            this.accessKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmazonS3IcebergStorage model) {
    ...
    /** The scheme of the storage. */
    public enum SchemeType implements com.oracle.bmc.http.internal.BmcEnum {
        S3("S3"),
        S3A("S3A"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(SchemeType.class);

        private final String value;
        private static java.util.Map<String, SchemeType> map;

        static {
            map = new java.util.HashMap<>();
            for (SchemeType v : SchemeType.values()) {
        ...
        public static SchemeType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'SchemeType', returning UnknownEnumValue",
                    key);
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmazonS3IcebergStorage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmazonS3IcebergStorage)) {
            return false;
        }

        AmazonS3IcebergStorage other = (AmazonS3IcebergStorage) o;
