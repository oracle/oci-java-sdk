...
/**
 * Summary of the Amazon S3 storage used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmazonS3IcebergStorageSummary.Builder.class)
...
public final class AmazonS3IcebergStorageSummary extends IcebergStorageSummary {
    ...
    public static class Builder {
        ...
        public AmazonS3IcebergStorageSummary build() {
            AmazonS3IcebergStorageSummary model =
                    new AmazonS3IcebergStorageSummary(
                            this.schemeType,
                            this.endpoint,
                            this.accessKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmazonS3IcebergStorageSummary model) {
    ...
    @Deprecated
    public AmazonS3IcebergStorageSummary(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmazonS3IcebergStorageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmazonS3IcebergStorageSummary)) {
            return false;
        }

        AmazonS3IcebergStorageSummary other = (AmazonS3IcebergStorageSummary) o;
