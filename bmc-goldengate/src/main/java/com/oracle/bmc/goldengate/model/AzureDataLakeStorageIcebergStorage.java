...
/**
 * Represents an Azure Data Lake Storage storage used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AzureDataLakeStorageIcebergStorage.Builder.class)
...
public final class AzureDataLakeStorageIcebergStorage extends IcebergStorage {
    ...
    public static class Builder {
        ...
        public AzureDataLakeStorageIcebergStorage build() {
            AzureDataLakeStorageIcebergStorage model =
                    new AzureDataLakeStorageIcebergStorage(
                            this.accountName,
                            this.container,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AzureDataLakeStorageIcebergStorage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AzureDataLakeStorageIcebergStorage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureDataLakeStorageIcebergStorage)) {
            return false;
        }

        AzureDataLakeStorageIcebergStorage other = (AzureDataLakeStorageIcebergStorage) o;
