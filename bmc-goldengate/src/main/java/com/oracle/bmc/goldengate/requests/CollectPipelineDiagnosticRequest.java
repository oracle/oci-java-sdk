...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/CollectPipelineDiagnosticExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CollectPipelineDiagnosticRequest.
 */
...
public class CollectPipelineDiagnosticRequest
    ...
    public static class Builder
        ...
        public CollectPipelineDiagnosticRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CollectPipelineDiagnosticRequest(pipelineId, collectPipelineDiagnosticDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
