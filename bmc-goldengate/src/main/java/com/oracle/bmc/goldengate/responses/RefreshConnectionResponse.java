...
public class RefreshConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RefreshConnectionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RefreshConnectionResponse> {
         ...
         */
        @Override
        public Builder copy(RefreshConnectionResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshConnectionResponse)) {
            return false;
        }

        RefreshConnectionResponse other = (RefreshConnectionResponse) o;
