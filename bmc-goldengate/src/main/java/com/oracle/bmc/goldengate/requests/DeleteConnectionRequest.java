...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/DeleteConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteConnectionRequest.
 */
...
public class DeleteConnectionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteConnectionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteConnectionRequest(connectionId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().connectionId(connectionId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
