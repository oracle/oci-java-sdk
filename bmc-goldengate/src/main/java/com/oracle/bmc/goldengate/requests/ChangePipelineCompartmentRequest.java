...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ChangePipelineCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangePipelineCompartmentRequest.
 */
...
public class ChangePipelineCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangePipelineCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangePipelineCompartmentRequest(pipelineId, changePipelineCompartmentDetails, ifMatch, opcRequestId, isLockOverride, opcRetryToken);
        }
    }
