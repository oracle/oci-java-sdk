...
/**
 * The information about a new Google Cloud Storage Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGoogleCloudStorageConnectionDetails.Builder.class)
...
public final class CreateGoogleCloudStorageConnectionDetails extends CreateConnectionDetails {
    ...
    public static class Builder {
         ...
         * by "serviceAccountKeyFileSecretId". This change follows the GoldenGate "Plain Text Fields
        ...
        public CreateGoogleCloudStorageConnectionDetails build() {
            CreateGoogleCloudStorageConnectionDetails model =
                    new CreateGoogleCloudStorageConnectionDetails(
                            this.displayName,
                            this.description,
                            this.compartmentId,
                            this.freeformTags,
    ...
    @Deprecated
    public CreateGoogleCloudStorageConnectionDetails(
            String displayName,
            String description,
