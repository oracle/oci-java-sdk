...
/**
 * The error returned when a pipeline connection fails to connect. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TestPipelineConnectionError.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class TestPipelineConnectionError
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"code", "message", "issue", "action"})
    public TestPipelineConnectionError(String code, String message, String issue, String action) {
        super();
        this.code = code;
    ...
    public static class Builder {
        ...
        public TestPipelineConnectionError build() {
            TestPipelineConnectionError model =
                    new TestPipelineConnectionError(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TestPipelineConnectionError model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TestPipelineConnectionError(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestPipelineConnectionError)) {
            return false;
        }

        TestPipelineConnectionError other = (TestPipelineConnectionError) o;
