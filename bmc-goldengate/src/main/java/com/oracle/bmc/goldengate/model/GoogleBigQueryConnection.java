...
/**
 * Represents the metadata of a Google BigQuery Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GoogleBigQueryConnection.Builder.class)
...
public final class GoogleBigQueryConnection extends Connection {
    ...
    public static class Builder {
        ...
        public GoogleBigQueryConnection build() {
            GoogleBigQueryConnection model =
                    new GoogleBigQueryConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GoogleBigQueryConnection model) {
    ...
    @Deprecated
    public GoogleBigQueryConnection(
            String id,
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GoogleBigQueryConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleBigQueryConnection)) {
            return false;
        }

        GoogleBigQueryConnection other = (GoogleBigQueryConnection) o;
