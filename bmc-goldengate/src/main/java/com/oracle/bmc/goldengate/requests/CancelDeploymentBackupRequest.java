...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/CancelDeploymentBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CancelDeploymentBackupRequest.
 */
...
public class CancelDeploymentBackupRequest
    ...
    public static class Builder
        ...
        public CancelDeploymentBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CancelDeploymentBackupRequest(deploymentBackupId, cancelDeploymentBackupDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
