...
/**
 * Represents a Rest catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RestIcebergCatalog.Builder.class)
...
public final class RestIcebergCatalog extends IcebergCatalog {
    ...
    public static class Builder {
        ...
        public RestIcebergCatalog build() {
            RestIcebergCatalog model = new RestIcebergCatalog(this.uri, this.propertiesSecretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestIcebergCatalog model) {
    ...
    @Deprecated
    public RestIcebergCatalog(String uri, String propertiesSecretId) {
        super();
        this.uri = uri;
        this.propertiesSecretId = propertiesSecretId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestIcebergCatalog)) {
            return false;
        }

        RestIcebergCatalog other = (RestIcebergCatalog) o;
