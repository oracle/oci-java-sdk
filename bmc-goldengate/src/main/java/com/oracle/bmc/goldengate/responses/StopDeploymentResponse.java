...
public class StopDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private StopDeploymentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopDeploymentResponse> {
         ...
         */
        @Override
        public Builder copy(StopDeploymentResponse o) {
        ...
        public StopDeploymentResponse build() {
            return new StopDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDeploymentResponse)) {
            return false;
        }

        StopDeploymentResponse other = (StopDeploymentResponse) o;
