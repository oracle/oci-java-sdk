...
public class StartPipelineResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StartPipelineResponse> {
         ...
         */
        @Override
        public Builder copy(StartPipelineResponse o) {
        ...
        public StartPipelineResponse build() {
            return new StartPipelineResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartPipelineResponse)) {
            return false;
        }

        StartPipelineResponse other = (StartPipelineResponse) o;
