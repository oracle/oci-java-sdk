...
/**
 * The information to update the Amazon S3 storage used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateAmazonS3IcebergStorageDetails.Builder.class)
...
public final class UpdateAmazonS3IcebergStorageDetails extends UpdateIcebergStorageDetails {
    ...
    public static class Builder {
        ...
        public UpdateAmazonS3IcebergStorageDetails build() {
            UpdateAmazonS3IcebergStorageDetails model =
                    new UpdateAmazonS3IcebergStorageDetails(
                            this.schemeType,
                            this.endpoint,
                            this.accessKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateAmazonS3IcebergStorageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateAmazonS3IcebergStorageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateAmazonS3IcebergStorageDetails)) {
            return false;
        }

        UpdateAmazonS3IcebergStorageDetails other = (UpdateAmazonS3IcebergStorageDetails) o;
