...
/**
 * Represents the metadata description of a connection assignment. Before you can use a connection
 * as a GoldenGate source or target, you must assign it to a deployment. <br>
...
public final class ConnectionAssignment
