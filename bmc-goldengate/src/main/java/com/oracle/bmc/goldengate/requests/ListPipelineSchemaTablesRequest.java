...
public class ListPipelineSchemaTablesRequest
    ...
    public static class Builder
        ...
        public Builder copy(ListPipelineSchemaTablesRequest o) {
            ...
            sourceSchemaName(o.getSourceSchemaName());
            targetSchemaName(o.getTargetSchemaName());
         ...
         */
        public ListPipelineSchemaTablesRequest build() {
            ListPipelineSchemaTablesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListPipelineSchemaTablesRequest
         */
        public ListPipelineSchemaTablesRequest buildWithoutInvocationCallback() {
            ListPipelineSchemaTablesRequest request = new ListPipelineSchemaTablesRequest();
            request.pipelineId = pipelineId;
            request.sourceSchemaName = sourceSchemaName;
            request.targetSchemaName = targetSchemaName;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPipelineSchemaTablesRequest)) {
            return false;
        }

        ListPipelineSchemaTablesRequest other = (ListPipelineSchemaTablesRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.pipelineId, other.pipelineId)
                && java.util.Objects.equals(this.sourceSchemaName, other.sourceSchemaName)
