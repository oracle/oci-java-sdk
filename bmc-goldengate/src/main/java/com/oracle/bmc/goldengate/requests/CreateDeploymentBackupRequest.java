...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/CreateDeploymentBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateDeploymentBackupRequest.
 */
...
public class CreateDeploymentBackupRequest
    ...
    public static class Builder
        ...
        public Builder createDeploymentBackupDetails(
                com.oracle.bmc.goldengate.model.CreateDeploymentBackupDetails
                        createDeploymentBackupDetails) {
            this.createDeploymentBackupDetails = createDeploymentBackupDetails;
            return this;
        }
         ...
         * @return instance of CreateDeploymentBackupRequest
         */
        public CreateDeploymentBackupRequest buildWithoutInvocationCallback() {
            CreateDeploymentBackupRequest request = new CreateDeploymentBackupRequest();
            request.createDeploymentBackupDetails = createDeploymentBackupDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateDeploymentBackupRequest(createDeploymentBackupDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createDeploymentBackupDetails=")
                .append(String.valueOf(this.createDeploymentBackupDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDeploymentBackupRequest)) {
            return false;
        }

        CreateDeploymentBackupRequest other = (CreateDeploymentBackupRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createDeploymentBackupDetails, other.createDeploymentBackupDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createDeploymentBackupDetails == null
                                ? 43
                                : this.createDeploymentBackupDetails.hashCode());
        result =
                (result * PRIME)
