...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ListDeploymentBackupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDeploymentBackupsRequest.
 */
...
public class ListDeploymentBackupsRequest
    ...
    public static class Builder
        ...
        public ListDeploymentBackupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDeploymentBackupsRequest(compartmentId, deploymentId, lifecycleState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
