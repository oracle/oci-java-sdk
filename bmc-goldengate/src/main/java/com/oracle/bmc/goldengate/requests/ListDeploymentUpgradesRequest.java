...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ListDeploymentUpgradesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDeploymentUpgradesRequest.
 */
...
public class ListDeploymentUpgradesRequest
    ...
    public static class Builder
         ...
         * @return instance of ListDeploymentUpgradesRequest
         */
        public ListDeploymentUpgradesRequest buildWithoutInvocationCallback() {
            ListDeploymentUpgradesRequest request = new ListDeploymentUpgradesRequest();
            ...
            return request;
            // new ListDeploymentUpgradesRequest(compartmentId, deploymentId, lifecycleState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDeploymentUpgradesRequest)) {
            return false;
        }

        ListDeploymentUpgradesRequest other = (ListDeploymentUpgradesRequest) o;
