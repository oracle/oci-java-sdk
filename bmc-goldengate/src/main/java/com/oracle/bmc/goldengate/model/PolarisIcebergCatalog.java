...
/**
 * Represents a Polaris catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PolarisIcebergCatalog.Builder.class)
...
public final class PolarisIcebergCatalog extends IcebergCatalog {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PolarisIcebergCatalog model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PolarisIcebergCatalog(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolarisIcebergCatalog)) {
            return false;
        }

        PolarisIcebergCatalog other = (PolarisIcebergCatalog) o;
