...
public final class UpdateKafkaSchemaRegistryConnectionDetails extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateKafkaSchemaRegistryConnectionDetails build() {
            UpdateKafkaSchemaRegistryConnectionDetails model =
                    new UpdateKafkaSchemaRegistryConnectionDetails(
                            this.displayName,
                            this.description,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateKafkaSchemaRegistryConnectionDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateKafkaSchemaRegistryConnectionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateKafkaSchemaRegistryConnectionDetails)) {
            return false;
        }

        UpdateKafkaSchemaRegistryConnectionDetails other =
                (UpdateKafkaSchemaRegistryConnectionDetails) o;
