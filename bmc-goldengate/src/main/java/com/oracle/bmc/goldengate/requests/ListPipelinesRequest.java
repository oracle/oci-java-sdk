...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ListPipelinesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPipelinesRequest.
 */
...
public class ListPipelinesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     *
     */
    private com.oracle.bmc.goldengate.model.Pipeline.LifecycleState lifecycleState;

    /**
     * A filtered list of pipelines to return for a given lifecycleState.
     *
     */
    public com.oracle.bmc.goldengate.model.Pipeline.LifecycleState getLifecycleState() {
     ...
     *
     */
    private com.oracle.bmc.goldengate.model.PipelineLifecycleSubState lifecycleSubState;

    /**
     * A filtered list of pipelines to return for a given lifecycleSubState.
     *
     */
    public com.oracle.bmc.goldengate.model.PipelineLifecycleSubState getLifecycleSubState() {
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.goldengate.model.Pipeline.LifecycleState lifecycleState = null;
        ...
        public Builder lifecycleState(
                com.oracle.bmc.goldengate.model.Pipeline.LifecycleState lifecycleState) {
         ...
         *
         */
        private com.oracle.bmc.goldengate.model.PipelineLifecycleSubState lifecycleSubState = null;
        ...
        public Builder lifecycleSubState(
                com.oracle.bmc.goldengate.model.PipelineLifecycleSubState lifecycleSubState) {
        ...
        public ListPipelinesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPipelinesRequest(compartmentId, lifecycleState, lifecycleSubState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
