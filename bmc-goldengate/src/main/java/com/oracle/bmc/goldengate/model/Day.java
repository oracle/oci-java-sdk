...
public enum Day implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    private static java.util.Map<String, Day> map;
    ...
    public static Day create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn("Received unknown value '{}' for enum 'Day', returning UnknownEnumValue", key);
