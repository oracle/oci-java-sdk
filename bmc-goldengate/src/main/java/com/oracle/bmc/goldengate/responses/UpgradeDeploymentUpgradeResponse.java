...
public class UpgradeDeploymentUpgradeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpgradeDeploymentUpgradeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpgradeDeploymentUpgradeResponse o) {
         ...
         */
        @Override
        public UpgradeDeploymentUpgradeResponse build() {
            return new UpgradeDeploymentUpgradeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpgradeDeploymentUpgradeResponse)) {
            return false;
        }

        UpgradeDeploymentUpgradeResponse other = (UpgradeDeploymentUpgradeResponse) o;
