...
public class CollectPipelineDiagnosticConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CollectPipelineDiagnosticConverter.class);

    public static com.oracle.bmc.goldengate.requests.CollectPipelineDiagnosticRequest
            interceptRequest(
                    com.oracle.bmc.goldengate.requests.CollectPipelineDiagnosticRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.goldengate.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.goldengate.responses.CollectPipelineDiagnosticResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.goldengate.responses
                                                .CollectPipelineDiagnosticResponse.Builder
                                        builder =
                                                com.oracle.bmc.goldengate.responses
                                                        .CollectPipelineDiagnosticResponse.builder()
