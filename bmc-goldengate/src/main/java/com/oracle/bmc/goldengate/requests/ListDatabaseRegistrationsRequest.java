...
public class ListDatabaseRegistrationsRequest
    ...
    public static class Builder
         ...
         */
        public ListDatabaseRegistrationsRequest build() {
            ListDatabaseRegistrationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDatabaseRegistrationsRequest
         */
        public ListDatabaseRegistrationsRequest buildWithoutInvocationCallback() {
            ListDatabaseRegistrationsRequest request = new ListDatabaseRegistrationsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseRegistrationsRequest)) {
            return false;
        }

        ListDatabaseRegistrationsRequest other = (ListDatabaseRegistrationsRequest) o;
