...
/**
 * Summary of the Google BigQuery Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GoogleBigQueryConnectionSummary.Builder.class)
...
public final class GoogleBigQueryConnectionSummary extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        /**
         * A legal URL to connect to BigQuery including scheme, server name and port (if not the
         * default port). Default: https://bigquery.googleapis.com
         */
        ...
        public GoogleBigQueryConnectionSummary build() {
            GoogleBigQueryConnectionSummary model =
                    new GoogleBigQueryConnectionSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GoogleBigQueryConnectionSummary model) {
    ...
    @Deprecated
    public GoogleBigQueryConnectionSummary(
            String id,
            String displayName,
            String description,
    ...
    /**
     * A legal URL to connect to BigQuery including scheme, server name and port (if not the default
     * port). Default: https://bigquery.googleapis.com
     */
    @com.fasterxml.jackson.annotation.JsonProperty("endpoint")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleBigQueryConnectionSummary)) {
            return false;
        }
