...
public class UpgradeDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpgradeDeploymentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpgradeDeploymentResponse> {
        ...
        public UpgradeDeploymentResponse build() {
            return new UpgradeDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpgradeDeploymentResponse)) {
            return false;
        }

        UpgradeDeploymentResponse other = (UpgradeDeploymentResponse) o;
