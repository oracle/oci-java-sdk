...
/**
 * Summary of the Azure Data Lake Storage storage used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AzureDataLakeStorageIcebergStorageSummary.Builder.class)
...
public final class AzureDataLakeStorageIcebergStorageSummary extends IcebergStorageSummary {
    ...
    public static class Builder {
        ...
        public AzureDataLakeStorageIcebergStorageSummary build() {
            AzureDataLakeStorageIcebergStorageSummary model =
                    new AzureDataLakeStorageIcebergStorageSummary(
                            this.accountName,
                            this.container,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AzureDataLakeStorageIcebergStorageSummary model) {
    ...
    @Deprecated
    public AzureDataLakeStorageIcebergStorageSummary(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AzureDataLakeStorageIcebergStorageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AzureDataLakeStorageIcebergStorageSummary)) {
            return false;
        }

        AzureDataLakeStorageIcebergStorageSummary other =
                (AzureDataLakeStorageIcebergStorageSummary) o;
