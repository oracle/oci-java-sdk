...
public final class InitialDataLoad
    ...
    public static class Builder {
        ...
        /**
         * Directory path of ADB wallet locally available in Non-ADB target DB. Required for ADB to
         * non-ADB DBLink type initial load only. If not provided the default wallet path
         * "/u01/targetwallet" will be used.
         */
        ...
        /**
         * Directory path of ObjectStorage wallet locally available in Non-ADB source DB. Required
         * for Object Storage type initial load only if source DB is Non-ADB type.
         */
        ...
        /**
         * Directory path of ObjectStorage wallet locally available in Non-ADB target DB. Required
         * for Object Storage type initial load only if target DB is Non-ADB type.
         */
        ...
        /**
         * Namespace that serves as a container of the ObjectStorage bucket. Required only for
         * Objectstorage Initial load.
         */
    ...
    /** Type of Initial load, which can be objectStorage or dbLink. */
    public enum InitialLoadType implements com.oracle.bmc.http.internal.BmcEnum {
        DbLink("DB_LINK"),
    ...
    /**
     * Directory path of ObjectStorage wallet locally available in Non-ADB source DB. Required for
     * Object Storage type initial load only if source DB is Non-ADB type.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sourceWalletPath")
    ...
    /**
     * Directory path of ObjectStorage wallet locally available in Non-ADB target DB. Required for
     * Object Storage type initial load only if target DB is Non-ADB type.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("targetWalletPath")
