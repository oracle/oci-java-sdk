...
/**
 * Represents a Glue catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GlueIcebergCatalog.Builder.class)
...
public final class GlueIcebergCatalog extends IcebergCatalog {
    ...
    public static class Builder {
        ...
        public GlueIcebergCatalog build() {
            GlueIcebergCatalog model = new GlueIcebergCatalog(this.glueId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GlueIcebergCatalog model) {
    ...
    @Deprecated
    public GlueIcebergCatalog(String glueId) {
        super();
        this.glueId = glueId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GlueIcebergCatalog)) {
            return false;
        }

        GlueIcebergCatalog other = (GlueIcebergCatalog) o;
