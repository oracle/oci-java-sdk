...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ChangeConnectionCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeConnectionCompartmentRequest.
 */
...
public class ChangeConnectionCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeConnectionCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeConnectionCompartmentRequest(connectionId, changeConnectionCompartmentDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
