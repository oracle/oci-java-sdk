...
/**
 * Defines the backup schedule details for create operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateBackupScheduleDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateBackupScheduleDetails
    ...
    public static class Builder {
        ...
        public CreateBackupScheduleDetails build() {
            CreateBackupScheduleDetails model =
                    new CreateBackupScheduleDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateBackupScheduleDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateBackupScheduleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBackupScheduleDetails)) {
            return false;
        }

        CreateBackupScheduleDetails other = (CreateBackupScheduleDetails) o;
