...
public class StartDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private StartDeploymentResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StartDeploymentResponse> {
         ...
         */
        @Override
        public Builder copy(StartDeploymentResponse o) {
        ...
        public StartDeploymentResponse build() {
            return new StartDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDeploymentResponse)) {
            return false;
        }

        StartDeploymentResponse other = (StartDeploymentResponse) o;
