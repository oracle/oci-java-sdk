...
/**
 * Summary of the Nessie catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NessieIcebergCatalogSummary.Builder.class)
...
public final class NessieIcebergCatalogSummary extends IcebergCatalogSummary {
    ...
    public static class Builder {
        ...
        public NessieIcebergCatalogSummary build() {
            NessieIcebergCatalogSummary model =
                    new NessieIcebergCatalogSummary(this.uri, this.branch);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NessieIcebergCatalogSummary model) {
    ...
    @Deprecated
    public NessieIcebergCatalogSummary(String uri, String branch) {
        super();
        this.uri = uri;
        this.branch = branch;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NessieIcebergCatalogSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NessieIcebergCatalogSummary)) {
            return false;
        }

        NessieIcebergCatalogSummary other = (NessieIcebergCatalogSummary) o;
