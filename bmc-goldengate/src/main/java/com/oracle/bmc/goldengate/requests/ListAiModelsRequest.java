...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ListAiModelsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAiModelsRequest.
 */
...
public class ListAiModelsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * OCI tenancy OCID to use when resolving provider models, for example for OCI Generative AI
     * model discovery across a specific tenancy.
     */
    ...
    public static class Builder
        ...
        public ListAiModelsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAiModelsRequest(compartmentId, providerType, region, tenancyId,
            // opcRequestId);
        }
    }
