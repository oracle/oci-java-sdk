...
public interface GoldenGate extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListAiModels API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListAiProviders
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use MigrateConnection
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use PausePipeline API.
     */
