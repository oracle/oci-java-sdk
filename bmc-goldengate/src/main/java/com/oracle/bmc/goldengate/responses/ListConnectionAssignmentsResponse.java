...
public class ListConnectionAssignmentsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.goldengate.model.ConnectionAssignmentCollection
            getConnectionAssignmentCollection() {
        return connectionAssignmentCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder connectionAssignmentCollection(
                com.oracle.bmc.goldengate.model.ConnectionAssignmentCollection
                        connectionAssignmentCollection) {
            this.connectionAssignmentCollection = connectionAssignmentCollection;
            return this;
        ...
        public Builder copy(ListConnectionAssignmentsResponse o) {
            ...
            connectionAssignmentCollection(o.getConnectionAssignmentCollection());
    ...
    public String toString() {
        ...
        sb.append(",connectionAssignmentCollection=")
                .append(String.valueOf(connectionAssignmentCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListConnectionAssignmentsResponse)) {
            return false;
        }

        ListConnectionAssignmentsResponse other = (ListConnectionAssignmentsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.connectionAssignmentCollection, other.connectionAssignmentCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.connectionAssignmentCollection == null
                                ? 43
                                : this.connectionAssignmentCollection.hashCode());
        return result;
    }
}
