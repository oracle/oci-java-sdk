...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/TestConnectionAssignmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use TestConnectionAssignmentRequest.
 */
...
public class TestConnectionAssignmentRequest
    ...
    public static class Builder
        ...
        public TestConnectionAssignmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new TestConnectionAssignmentRequest(connectionAssignmentId, testConnectionAssignmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
