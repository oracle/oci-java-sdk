...
public class DeleteDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public DeleteDeploymentResponse build() {
            return new DeleteDeploymentResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDeploymentResponse)) {
            return false;
        }

        DeleteDeploymentResponse other = (DeleteDeploymentResponse) o;
