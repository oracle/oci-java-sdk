...
public class StopPipelineResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopPipelineResponse> {
         ...
         */
        @Override
        public Builder copy(StopPipelineResponse o) {
        ...
        public StopPipelineResponse build() {
            return new StopPipelineResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopPipelineResponse)) {
            return false;
        }

        StopPipelineResponse other = (StopPipelineResponse) o;
