...
/**
 * Summary of the Elasticsearch Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ElasticsearchConnectionSummary.Builder.class)
...
public final class ElasticsearchConnectionSummary extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public ElasticsearchConnectionSummary build() {
            ElasticsearchConnectionSummary model =
                    new ElasticsearchConnectionSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ElasticsearchConnectionSummary model) {
    ...
    @Deprecated
    public ElasticsearchConnectionSummary(
            String id,
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ElasticsearchConnectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElasticsearchConnectionSummary)) {
            return false;
        }

        ElasticsearchConnectionSummary other = (ElasticsearchConnectionSummary) o;
