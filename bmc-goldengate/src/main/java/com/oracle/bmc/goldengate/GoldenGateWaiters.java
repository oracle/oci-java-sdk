...
public class GoldenGateWaiters {
    ...
    public GoldenGateWaiters(
            java.util.concurrent.ExecutorService executorService, GoldenGate client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    ...
                    com.oracle.bmc.goldengate.model.CertificateLifecycleState... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    GetCertificateRequest request,
                    com.oracle.bmc.goldengate.model.CertificateLifecycleState targetState,
    ...
    private com.oracle.bmc.waiter.Waiter<GetCertificateRequest, GetCertificateResponse>
            forCertificate(
                    ...
                    final com.oracle.bmc.goldengate.model.CertificateLifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.goldengate.model.CertificateLifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.goldengate.model.CertificateLifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetConnectionRequest, GetConnectionResponse> forConnection(
            ...
            com.oracle.bmc.goldengate.model.Connection.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetConnectionRequest, GetConnectionResponse> forConnection(
            GetConnectionRequest request,
            com.oracle.bmc.goldengate.model.Connection.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetConnectionRequest, GetConnectionResponse> forConnection(
            ...
            final com.oracle.bmc.goldengate.model.Connection.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.goldengate.model.Connection.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.goldengate.model.Connection.LifecycleState.Deleted)),
                request);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forConnectionAssignment(
                    GetConnectionAssignmentRequest request,
                    com.oracle.bmc.goldengate.model.ConnectionAssignment.LifecycleState...
                            targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
        ...
        return forConnectionAssignment(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forConnectionAssignment(
                    GetConnectionAssignmentRequest request,
                    com.oracle.bmc.goldengate.model.ConnectionAssignment.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for ConnectionAssignment.
    private com.oracle.bmc.waiter.Waiter<
                    GetConnectionAssignmentRequest, GetConnectionAssignmentResponse>
            forConnectionAssignment(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetConnectionAssignmentRequest request,
                    final com.oracle.bmc.goldengate.model.ConnectionAssignment.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.goldengate.model.ConnectionAssignment.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetConnectionAssignmentRequest, GetConnectionAssignmentResponse>() {
                            @Override
                            public GetConnectionAssignmentResponse apply(
                                    GetConnectionAssignmentRequest request) {
                                return client.getConnectionAssignment(request);
                            }
                        },
                        new java.util.function.Predicate<GetConnectionAssignmentResponse>() {
                            @Override
                            public boolean test(GetConnectionAssignmentResponse response) {
                                return targetStatesSet.contains(
                                        response.getConnectionAssignment().getLifecycleState());
                            }
                        },
                        false),
                request);
    ...
    public com.oracle.bmc.waiter.Waiter<
        ...
        return forDatabaseRegistration(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    // Helper method to create a new Waiter for DatabaseRegistration.
    private com.oracle.bmc.waiter.Waiter<
                    GetDatabaseRegistrationRequest, GetDatabaseRegistrationResponse>
            forDatabaseRegistration(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetDatabaseRegistrationRequest request,
    ...
    // Helper method to create a new Waiter for DeploymentBackup.
    private com.oracle.bmc.waiter.Waiter<GetDeploymentBackupRequest, GetDeploymentBackupResponse>
            forDeploymentBackup(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
    ...
    public com.oracle.bmc.waiter.Waiter<GetPipelineRequest, GetPipelineResponse> forPipeline(
            GetPipelineRequest request,
            com.oracle.bmc.goldengate.model.Pipeline.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    private com.oracle.bmc.waiter.Waiter<GetPipelineRequest, GetPipelineResponse> forPipeline(
            ...
            final com.oracle.bmc.goldengate.model.Pipeline.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.goldengate.model.Pipeline.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.goldengate.model.Pipeline.LifecycleState.Deleted)),
                request);
    }
