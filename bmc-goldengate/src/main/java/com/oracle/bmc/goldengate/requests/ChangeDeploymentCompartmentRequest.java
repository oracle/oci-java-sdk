...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ChangeDeploymentCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDeploymentCompartmentRequest.
 */
...
public class ChangeDeploymentCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeDeploymentCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeDeploymentCompartmentRequest(deploymentId, changeDeploymentCompartmentDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
