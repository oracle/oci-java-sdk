...
/**
 * Summary details of an AI provider and its supported models. <br>
...
public final class AiProviderSummary
    ...
    public static class Builder {
        ...
        /**
         * List of AI models supported by this provider, when available. This field is null when the
         * provider's models can be retrieved only after supplying additional context. For example,
         * OCI_GENERATIVE_AI model availability may vary by region.
         */
