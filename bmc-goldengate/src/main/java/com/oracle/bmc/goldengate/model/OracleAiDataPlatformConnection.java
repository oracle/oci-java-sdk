...
/**
 * Represents the metadata of an Oracle AI Data Platform Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OracleAiDataPlatformConnection.Builder.class)
...
public final class OracleAiDataPlatformConnection extends Connection {
    ...
    public static class Builder {
        ...
        public OracleAiDataPlatformConnection build() {
            OracleAiDataPlatformConnection model =
                    new OracleAiDataPlatformConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OracleAiDataPlatformConnection model) {
    ...
    @Deprecated
    public OracleAiDataPlatformConnection(
            String id,
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OracleAiDataPlatformConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OracleAiDataPlatformConnection)) {
            return false;
        }

        OracleAiDataPlatformConnection other = (OracleAiDataPlatformConnection) o;
