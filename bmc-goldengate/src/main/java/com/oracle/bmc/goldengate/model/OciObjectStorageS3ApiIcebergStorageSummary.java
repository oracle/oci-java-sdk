...
/**
 * Summary of the OCI Object Storage (S3 Compatibility API) configuration used by the Iceberg
 * connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OciObjectStorageS3ApiIcebergStorageSummary.Builder.class)
...
public final class OciObjectStorageS3ApiIcebergStorageSummary extends IcebergStorageSummary {
    ...
    public static class Builder {
        ...
        public OciObjectStorageS3ApiIcebergStorageSummary build() {
            OciObjectStorageS3ApiIcebergStorageSummary model =
                    new OciObjectStorageS3ApiIcebergStorageSummary(
                            this.endpoint,
                            this.accessKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciObjectStorageS3ApiIcebergStorageSummary model) {
    ...
    @Deprecated
    public OciObjectStorageS3ApiIcebergStorageSummary(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OciObjectStorageS3ApiIcebergStorageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciObjectStorageS3ApiIcebergStorageSummary)) {
            return false;
        }

        OciObjectStorageS3ApiIcebergStorageSummary other =
                (OciObjectStorageS3ApiIcebergStorageSummary) o;
