...
public class PausePipelineResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PausePipelineResponse> {
         ...
         */
        @Override
        public Builder copy(PausePipelineResponse o) {
        ...
        public PausePipelineResponse build() {
            return new PausePipelineResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PausePipelineResponse)) {
            return false;
        }

        PausePipelineResponse other = (PausePipelineResponse) o;
