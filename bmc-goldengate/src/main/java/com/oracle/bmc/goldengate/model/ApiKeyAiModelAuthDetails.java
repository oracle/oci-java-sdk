...
/**
 * API key authentication details for an AI Model connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApiKeyAiModelAuthDetails.Builder.class)
...
public final class ApiKeyAiModelAuthDetails extends AiModelAuthDetails {
    ...
    public static class Builder {
        ...
        public ApiKeyAiModelAuthDetails build() {
            ApiKeyAiModelAuthDetails model =
                    new ApiKeyAiModelAuthDetails(this.baseUrl, this.apiKey, this.apiKeySecretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApiKeyAiModelAuthDetails model) {
    ...
    @Deprecated
    public ApiKeyAiModelAuthDetails(String baseUrl, String apiKey, String apiKeySecretId) {
        super();
        this.baseUrl = baseUrl;
        this.apiKey = apiKey != null ? apiKey.toCharArray() : null;
        this.apiKeySecretId = apiKeySecretId;
    ...
    @Deprecated
    public ApiKeyAiModelAuthDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ApiKeyAiModelAuthDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApiKeyAiModelAuthDetails)) {
            return false;
        }

        ApiKeyAiModelAuthDetails other = (ApiKeyAiModelAuthDetails) o;
