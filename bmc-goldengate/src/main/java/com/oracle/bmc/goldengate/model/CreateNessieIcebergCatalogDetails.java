...
/**
 * The information about a new Nessie catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateNessieIcebergCatalogDetails.Builder.class)
...
public final class CreateNessieIcebergCatalogDetails extends CreateIcebergCatalogDetails {
    ...
    public static class Builder {
        ...
        public CreateNessieIcebergCatalogDetails build() {
            CreateNessieIcebergCatalogDetails model =
                    new CreateNessieIcebergCatalogDetails(this.uri, this.branch);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNessieIcebergCatalogDetails model) {
    ...
    @Deprecated
    public CreateNessieIcebergCatalogDetails(String uri, String branch) {
        super();
        this.uri = uri;
        this.branch = branch;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateNessieIcebergCatalogDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNessieIcebergCatalogDetails)) {
            return false;
        }

        CreateNessieIcebergCatalogDetails other = (CreateNessieIcebergCatalogDetails) o;
