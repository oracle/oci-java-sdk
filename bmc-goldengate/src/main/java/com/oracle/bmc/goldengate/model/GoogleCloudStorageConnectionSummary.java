...
public final class GoogleCloudStorageConnectionSummary extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public GoogleCloudStorageConnectionSummary build() {
            GoogleCloudStorageConnectionSummary model =
                    new GoogleCloudStorageConnectionSummary(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GoogleCloudStorageConnectionSummary model) {
    ...
    @Deprecated
    public GoogleCloudStorageConnectionSummary(
            String id,
            String displayName,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoogleCloudStorageConnectionSummary)) {
            return false;
        }
