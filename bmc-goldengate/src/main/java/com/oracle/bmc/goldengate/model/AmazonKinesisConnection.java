...
/**
 * Represents the metadata of a Amazon Kinesis Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AmazonKinesisConnection.Builder.class)
...
public final class AmazonKinesisConnection extends Connection {
    ...
    public static class Builder {
        ...
        public AmazonKinesisConnection build() {
            AmazonKinesisConnection model =
                    new AmazonKinesisConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AmazonKinesisConnection model) {
    ...
    @Deprecated
    public AmazonKinesisConnection(
            String id,
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AmazonKinesisConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmazonKinesisConnection)) {
            return false;
        }

        AmazonKinesisConnection other = (AmazonKinesisConnection) o;
