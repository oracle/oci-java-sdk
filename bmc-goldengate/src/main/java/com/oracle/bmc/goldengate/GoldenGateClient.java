...
public class GoldenGateClient implements GoldenGate {
    ...
    public AddDeploymentLocalPeerResponse addDeploymentLocalPeer(
        ...
        LOG.trace("Called addDeploymentLocalPeer");
        final AddDeploymentLocalPeerRequest interceptedRequest =
                AddDeploymentLocalPeerConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                AddDeploymentLocalPeerConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, AddDeploymentLocalPeerResponse>
                transformer =
                        AddDeploymentLocalPeerConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getAddDeploymentLocalPeerDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    @Override
    public ChangeConnectionSubscriptionResponse changeConnectionSubscription(
            ChangeConnectionSubscriptionRequest request) {
        LOG.trace("Called changeConnectionSubscription");
        final ChangeConnectionSubscriptionRequest interceptedRequest =
                ChangeConnectionSubscriptionConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeConnectionSubscriptionConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ChangeConnectionSubscriptionResponse>
                transformer =
                        ChangeConnectionSubscriptionConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    @Override
    public ChangeDeploymentSubscriptionResponse changeDeploymentSubscription(
            ChangeDeploymentSubscriptionRequest request) {
        LOG.trace("Called changeDeploymentSubscription");
        final ChangeDeploymentSubscriptionRequest interceptedRequest =
                ChangeDeploymentSubscriptionConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeDeploymentSubscriptionConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ChangeDeploymentSubscriptionResponse>
                transformer =
                        ChangeDeploymentSubscriptionConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getChangeDeploymentSubscriptionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CollectPipelineDiagnosticResponse collectPipelineDiagnostic(
        ...
        LOG.trace("Called collectPipelineDiagnostic");
        final CollectPipelineDiagnosticRequest interceptedRequest =
                CollectPipelineDiagnosticConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CollectPipelineDiagnosticConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CollectPipelineDiagnosticResponse>
                transformer =
                        CollectPipelineDiagnosticConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    @Override
    public ListAiModelsResponse listAiModels(ListAiModelsRequest request) {
        LOG.trace("Called listAiModels");
        final ListAiModelsRequest interceptedRequest =
                ListAiModelsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListAiModelsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListAiModelsResponse> transformer =
                ListAiModelsConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
    ...
    @Override
    public ListAiProvidersResponse listAiProviders(ListAiProvidersRequest request) {
        LOG.trace("Called listAiProviders");
        final ListAiProvidersRequest interceptedRequest =
                ListAiProvidersConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListAiProvidersConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListAiProvidersResponse>
                transformer =
                        ListAiProvidersConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListDeploymentPeersResponse listDeploymentPeers(ListDeploymentPeersRequest request) {
        LOG.trace("Called listDeploymentPeers");
        final ListDeploymentPeersRequest interceptedRequest =
                ListDeploymentPeersConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListDeploymentPeersConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListDeploymentPeersResponse>
                transformer =
                        ListDeploymentPeersConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListPipelineInitializationStepsResponse listPipelineInitializationSteps(
        ...
        LOG.trace("Called listPipelineInitializationSteps");
        final ListPipelineInitializationStepsRequest interceptedRequest =
                ListPipelineInitializationStepsConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListPipelineInitializationStepsConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, ListPipelineInitializationStepsResponse>
                transformer =
                        ListPipelineInitializationStepsConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListPipelineRunningProcessesResponse listPipelineRunningProcesses(
        ...
        LOG.trace("Called listPipelineRunningProcesses");
        final ListPipelineRunningProcessesRequest interceptedRequest =
                ListPipelineRunningProcessesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListPipelineRunningProcessesConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListPipelineRunningProcessesResponse>
                transformer =
                        ListPipelineRunningProcessesConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListPipelineSchemaTablesResponse listPipelineSchemaTables(
        ...
        LOG.trace("Called listPipelineSchemaTables");
        final ListPipelineSchemaTablesRequest interceptedRequest =
                ListPipelineSchemaTablesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListPipelineSchemaTablesConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListPipelineSchemaTablesResponse>
                transformer =
                        ListPipelineSchemaTablesConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListPipelineSchemasResponse listPipelineSchemas(ListPipelineSchemasRequest request) {
        LOG.trace("Called listPipelineSchemas");
        final ListPipelineSchemasRequest interceptedRequest =
                ListPipelineSchemasConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListPipelineSchemasConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListPipelineSchemasResponse>
                transformer =
                        ListPipelineSchemasConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListRecipesResponse listRecipes(ListRecipesRequest request) {
        LOG.trace("Called listRecipes");
        final ListRecipesRequest interceptedRequest =
                ListRecipesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListRecipesConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListRecipesResponse> transformer =
                ListRecipesConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
    ...
    public PausePipelineResponse pausePipeline(PausePipelineRequest request) {
        LOG.trace("Called pausePipeline");
        final PausePipelineRequest interceptedRequest =
                PausePipelineConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                PausePipelineConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, PausePipelineResponse> transformer =
                PausePipelineConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getPausePipelineDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public RemoveDeploymentLocalPeerResponse removeDeploymentLocalPeer(
        ...
        LOG.trace("Called removeDeploymentLocalPeer");
        final RemoveDeploymentLocalPeerRequest interceptedRequest =
                RemoveDeploymentLocalPeerConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                RemoveDeploymentLocalPeerConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RemoveDeploymentLocalPeerResponse>
                transformer =
                        RemoveDeploymentLocalPeerConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public StartPipelineResponse startPipeline(StartPipelineRequest request) {
        LOG.trace("Called startPipeline");
        final StartPipelineRequest interceptedRequest =
                StartPipelineConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                StartPipelineConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, StartPipelineResponse> transformer =
                StartPipelineConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getStartPipelineDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public StopPipelineResponse stopPipeline(StopPipelineRequest request) {
        LOG.trace("Called stopPipeline");
        final StopPipelineRequest interceptedRequest =
                StopPipelineConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                StopPipelineConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, StopPipelineResponse> transformer =
                StopPipelineConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getStopPipelineDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public SwitchoverDeploymentPeerResponse switchoverDeploymentPeer(
        ...
        LOG.trace("Called switchoverDeploymentPeer");
        final SwitchoverDeploymentPeerRequest interceptedRequest =
                SwitchoverDeploymentPeerConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                SwitchoverDeploymentPeerConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, SwitchoverDeploymentPeerResponse>
                transformer =
                        SwitchoverDeploymentPeerConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getSwitchoverDeploymentPeerDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public TestPipelineConnectionResponse testPipelineConnection(
        ...
        LOG.trace("Called testPipelineConnection");
        final TestPipelineConnectionRequest interceptedRequest =
                TestPipelineConnectionConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                TestPipelineConnectionConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, TestPipelineConnectionResponse>
                transformer =
                        TestPipelineConnectionConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getTestPipelineConnectionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
