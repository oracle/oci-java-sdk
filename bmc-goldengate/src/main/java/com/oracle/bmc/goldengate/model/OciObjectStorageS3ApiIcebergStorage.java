...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OciObjectStorageS3ApiIcebergStorage.Builder.class
)
...
public final class OciObjectStorageS3ApiIcebergStorage extends IcebergStorage {
    ...
    public static class Builder {
        ...
        public OciObjectStorageS3ApiIcebergStorage build() {
            OciObjectStorageS3ApiIcebergStorage model =
                    new OciObjectStorageS3ApiIcebergStorage(
                            this.endpoint,
                            this.accessKeyId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciObjectStorageS3ApiIcebergStorage model) {
    ...
    @Deprecated
    public OciObjectStorageS3ApiIcebergStorage(
            String endpoint, String accessKeyId, String secretAccessKeySecretId, String bucket) {
        super();
        this.endpoint = endpoint;
        this.accessKeyId = accessKeyId;
        this.secretAccessKeySecretId = secretAccessKeySecretId;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OciObjectStorageS3ApiIcebergStorage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciObjectStorageS3ApiIcebergStorage)) {
            return false;
        }

        OciObjectStorageS3ApiIcebergStorage other = (OciObjectStorageS3ApiIcebergStorage) o;
