...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/AddConnectionLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddConnectionLockRequest.
 */
...
public class AddConnectionLockRequest
    ...
    public static class Builder
        ...
        public AddConnectionLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddConnectionLockRequest(connectionId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
