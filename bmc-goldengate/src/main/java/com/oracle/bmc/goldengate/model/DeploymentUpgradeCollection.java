...
/**
 * A list of Deployment Upgrades. <br>
...
public final class DeploymentUpgradeCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public DeploymentUpgradeCollection(java.util.List<DeploymentUpgradeSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public DeploymentUpgradeCollection build() {
            DeploymentUpgradeCollection model = new DeploymentUpgradeCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeploymentUpgradeCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeploymentUpgradeCollection)) {
            return false;
        }

        DeploymentUpgradeCollection other = (DeploymentUpgradeCollection) o;
