...
/**
 * The information about switching to deployment peer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SwitchoverDeploymentPeerDetails.Builder.class)
...
public final class SwitchoverDeploymentPeerDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SwitchoverDeploymentPeerDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SwitchoverDeploymentPeerDetails)) {
            return false;
        }
