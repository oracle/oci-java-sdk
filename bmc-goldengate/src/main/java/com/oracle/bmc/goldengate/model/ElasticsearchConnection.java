...
/**
 * Represents the metadata of a Elasticsearch Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ElasticsearchConnection.Builder.class)
...
public final class ElasticsearchConnection extends Connection {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ElasticsearchConnection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ElasticsearchConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElasticsearchConnection)) {
            return false;
        }

        ElasticsearchConnection other = (ElasticsearchConnection) o;
