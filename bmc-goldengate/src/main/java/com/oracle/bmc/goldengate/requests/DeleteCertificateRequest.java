...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/DeleteCertificateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCertificateRequest.
 */
...
public class DeleteCertificateRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteCertificateRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteCertificateRequest(deploymentId, certificateKey, ifMatch, opcRequestId, isLockOverride);
        }
    }
