...
public class CancelDeploymentUpgradeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CancelDeploymentUpgradeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CancelDeploymentUpgradeResponse o) {
         ...
         */
        @Override
        public CancelDeploymentUpgradeResponse build() {
            return new CancelDeploymentUpgradeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelDeploymentUpgradeResponse)) {
            return false;
        }

        CancelDeploymentUpgradeResponse other = (CancelDeploymentUpgradeResponse) o;
