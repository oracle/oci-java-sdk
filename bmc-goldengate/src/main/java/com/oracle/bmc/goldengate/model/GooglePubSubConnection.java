...
/**
 * Represents the metadata of a Google PubSub Connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GooglePubSubConnection.Builder.class)
...
public final class GooglePubSubConnection extends Connection {
    ...
    public static class Builder {
        ...
        public GooglePubSubConnection build() {
            GooglePubSubConnection model =
                    new GooglePubSubConnection(
                            this.id,
                            this.displayName,
                            this.description,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GooglePubSubConnection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GooglePubSubConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GooglePubSubConnection)) {
            return false;
        }

        GooglePubSubConnection other = (GooglePubSubConnection) o;
