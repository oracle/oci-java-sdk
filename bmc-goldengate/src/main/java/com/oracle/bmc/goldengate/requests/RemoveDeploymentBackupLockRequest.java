...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/RemoveDeploymentBackupLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDeploymentBackupLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200407")
public class RemoveDeploymentBackupLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDeploymentBackupLockRequest o) {
        ...
        /**
         * Build the instance of RemoveDeploymentBackupLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveDeploymentBackupLockRequest
         */
        public RemoveDeploymentBackupLockRequest build() {
            RemoveDeploymentBackupLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveDeploymentBackupLockRequest
         */
        public RemoveDeploymentBackupLockRequest buildWithoutInvocationCallback() {
            RemoveDeploymentBackupLockRequest request = new RemoveDeploymentBackupLockRequest();
            request.deploymentBackupId = deploymentBackupId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveDeploymentBackupLockRequest(deploymentBackupId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDeploymentBackupLockRequest)) {
            return false;
        }

        RemoveDeploymentBackupLockRequest other = (RemoveDeploymentBackupLockRequest) o;
