...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/SnoozeDeploymentUpgradeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SnoozeDeploymentUpgradeRequest.
 */
...
public class SnoozeDeploymentUpgradeRequest
    ...
    public static class Builder
        ...
        public SnoozeDeploymentUpgradeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SnoozeDeploymentUpgradeRequest(deploymentUpgradeId, snoozeDeploymentUpgradeDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
