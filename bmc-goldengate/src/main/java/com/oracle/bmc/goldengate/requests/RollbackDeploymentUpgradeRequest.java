...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/RollbackDeploymentUpgradeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RollbackDeploymentUpgradeRequest.
 */
...
public class RollbackDeploymentUpgradeRequest
    ...
    public static class Builder
        ...
        public RollbackDeploymentUpgradeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RollbackDeploymentUpgradeRequest(deploymentUpgradeId, rollbackDeploymentUpgradeDetails, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
