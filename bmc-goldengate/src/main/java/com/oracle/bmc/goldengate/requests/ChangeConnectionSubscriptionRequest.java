...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/ChangeConnectionSubscriptionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeConnectionSubscriptionRequest.
 */
...
public class ChangeConnectionSubscriptionRequest
    ...
    public static class Builder
        ...
        public ChangeConnectionSubscriptionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeConnectionSubscriptionRequest(changeConnectionSubscriptionDetails, connectionId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
