...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/UpdateDeploymentBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDeploymentBackupRequest.
 */
...
public class UpdateDeploymentBackupRequest
    ...
    public static class Builder
        ...
        public UpdateDeploymentBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDeploymentBackupRequest(deploymentBackupId, updateDeploymentBackupDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
