...
/**
 * Summary of the Rest catalog used in the Iceberg connection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RestIcebergCatalogSummary.Builder.class)
...
public final class RestIcebergCatalogSummary extends IcebergCatalogSummary {
    ...
    public static class Builder {
        ...
        public RestIcebergCatalogSummary build() {
            RestIcebergCatalogSummary model =
                    new RestIcebergCatalogSummary(this.uri, this.propertiesSecretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestIcebergCatalogSummary model) {
    ...
    @Deprecated
    public RestIcebergCatalogSummary(String uri, String propertiesSecretId) {
        super();
        this.uri = uri;
        this.propertiesSecretId = propertiesSecretId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RestIcebergCatalogSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestIcebergCatalogSummary)) {
            return false;
        }

        RestIcebergCatalogSummary other = (RestIcebergCatalogSummary) o;
