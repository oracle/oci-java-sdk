...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/goldengate/RemoveDeploymentLocalPeerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDeploymentLocalPeerRequest.
 */
...
public class RemoveDeploymentLocalPeerRequest
    ...
    public static class Builder
        ...
        public RemoveDeploymentLocalPeerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RemoveDeploymentLocalPeerRequest(deploymentId, removeDeploymentLocalPeerDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
