...
public class UpgradeDeploymentDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected UpgradeDeploymentDetails() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpgradeDeploymentDetails)) {
            return false;
        }

        UpgradeDeploymentDetails other = (UpgradeDeploymentDetails) o;
