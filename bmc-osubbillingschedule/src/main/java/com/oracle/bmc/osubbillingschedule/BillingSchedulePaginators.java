...
public class BillingSchedulePaginators {
     ...
     * com.oracle.bmc.osubbillingschedule.model.BillingScheduleSummary} objects contained in
     * responses from the listBillingSchedules operation. This iterable will fetch more data from
