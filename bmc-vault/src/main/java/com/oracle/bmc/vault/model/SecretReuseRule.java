...
/**
 * A rule that disallows reuse of previously used secret content by the specified secret. <br>
...
public final class SecretReuseRule extends SecretRule {
    ...
    /**
     * A property indicating whether the rule is applied even if the secret version with the content
     * you are trying to reuse was deleted.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isEnforcedOnDeletedSecretVersions")
