...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/vault/ScheduleSecretVersionDeletionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ScheduleSecretVersionDeletionRequest.
 */
...
public class ScheduleSecretVersionDeletionRequest
     ...
     *
     */
    public com.oracle.bmc.vault.model.ScheduleSecretVersionDeletionDetails
            getScheduleSecretVersionDeletionDetails() {
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.vault.model.ScheduleSecretVersionDeletionDetails
                scheduleSecretVersionDeletionDetails = null;

        /**
         * Request to delete a secret version.
         *
         * @param scheduleSecretVersionDeletionDetails the value to set
         * @return this builder instance
         */
        public Builder scheduleSecretVersionDeletionDetails(
                com.oracle.bmc.vault.model.ScheduleSecretVersionDeletionDetails
                        scheduleSecretVersionDeletionDetails) {
        ...
        public ScheduleSecretVersionDeletionRequest buildWithoutInvocationCallback() {
            ScheduleSecretVersionDeletionRequest request =
                    new ScheduleSecretVersionDeletionRequest();
            request.secretId = secretId;
            request.secretVersionNumber = secretVersionNumber;
            request.scheduleSecretVersionDeletionDetails = scheduleSecretVersionDeletionDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ScheduleSecretVersionDeletionRequest(secretId, secretVersionNumber, scheduleSecretVersionDeletionDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",scheduleSecretVersionDeletionDetails=")
                .append(String.valueOf(this.scheduleSecretVersionDeletionDetails));
    ...
    public boolean equals(Object o) {
        ...
        ScheduleSecretVersionDeletionRequest other = (ScheduleSecretVersionDeletionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.secretId, other.secretId)
                && java.util.Objects.equals(this.secretVersionNumber, other.secretVersionNumber)
                && java.util.Objects.equals(
                        this.scheduleSecretVersionDeletionDetails,
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.scheduleSecretVersionDeletionDetails == null
                                ? 43
                                : this.scheduleSecretVersionDeletionDetails.hashCode());
