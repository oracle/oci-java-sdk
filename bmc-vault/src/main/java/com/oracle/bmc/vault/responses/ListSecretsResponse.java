...
public class ListSecretsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.vault.model.SecretSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.vault.model.SecretSummary> getItems() {
        return items;
    }
    ...
    private ListSecretsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.vault.model.SecretSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSecretsResponse> {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.vault.model.SecretSummary> items) {
            this.items = items;
            return this;
        }
