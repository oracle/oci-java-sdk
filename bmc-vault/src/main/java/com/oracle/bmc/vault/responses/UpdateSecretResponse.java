...
public class UpdateSecretResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateSecretResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSecretResponse)) {
            return false;
        }

        UpdateSecretResponse other = (UpdateSecretResponse) o;
