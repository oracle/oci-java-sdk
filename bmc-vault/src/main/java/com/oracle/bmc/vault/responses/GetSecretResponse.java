...
public class GetSecretResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSecretResponse> {
        ...
        public GetSecretResponse build() {
            return new GetSecretResponse(__httpStatusCode__, headers, etag, opcRequestId, secret);
        }
    }
