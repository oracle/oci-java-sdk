...
public final class FunctionTargetSystemDetails extends TargetSystemDetails {
    ...
    public static class Builder {
        ...
        public FunctionTargetSystemDetails build() {
            FunctionTargetSystemDetails model = new FunctionTargetSystemDetails(this.functionId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FunctionTargetSystemDetails model) {
    ...
    @Deprecated
    public FunctionTargetSystemDetails(String functionId) {
        super();
        this.functionId = functionId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FunctionTargetSystemDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FunctionTargetSystemDetails)) {
            return false;
        }

        FunctionTargetSystemDetails other = (FunctionTargetSystemDetails) o;
