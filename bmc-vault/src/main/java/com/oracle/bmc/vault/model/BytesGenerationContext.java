...
/**
 * Generates random bytes. By default, secrets of type Bytes has no structure. The generated bytes
 * are stored as a Base64 encoded string. The SecretTemplate must have the %GENERATED_BYTES% keyword
 * which is replaced with the generated bytes, if provided <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BytesGenerationContext.Builder.class)
...
public final class BytesGenerationContext extends SecretGenerationContext {
    ...
    public static class Builder {
        ...
        public BytesGenerationContext build() {
            BytesGenerationContext model =
                    new BytesGenerationContext(this.secretTemplate, this.generationTemplate);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BytesGenerationContext model) {
    ...
    @Deprecated
    public BytesGenerationContext(String secretTemplate, GenerationTemplate generationTemplate) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BytesGenerationContext(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BytesGenerationContext)) {
            return false;
        }

        BytesGenerationContext other = (BytesGenerationContext) o;
