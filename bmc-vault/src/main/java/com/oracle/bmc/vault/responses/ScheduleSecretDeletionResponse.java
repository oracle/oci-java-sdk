...
public class ScheduleSecretDeletionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public ScheduleSecretDeletionResponse build() {
            return new ScheduleSecretDeletionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleSecretDeletionResponse)) {
            return false;
        }

        ScheduleSecretDeletionResponse other = (ScheduleSecretDeletionResponse) o;
