...
public class VaultsClient implements Vaults {
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeSecretCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateSecretDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetSecretResponse getSecret(GetSecretRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, GetSecretResponse> transformer =
                GetSecretConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getScheduleSecretDeletionDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateSecretDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
