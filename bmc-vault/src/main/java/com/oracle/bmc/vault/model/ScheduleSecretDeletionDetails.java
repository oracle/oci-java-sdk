...
/**
 * Details for scheduling the deletion of the specified secret. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ScheduleSecretDeletionDetails.Builder.class)
...
public final class ScheduleSecretDeletionDetails
    ...
    public ScheduleSecretDeletionDetails(java.util.Date timeOfDeletion) {
        super();
    ...
    public static class Builder {
        ...
        public ScheduleSecretDeletionDetails build() {
            ScheduleSecretDeletionDetails model =
                    new ScheduleSecretDeletionDetails(this.timeOfDeletion);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleSecretDeletionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleSecretDeletionDetails)) {
            return false;
        }

        ScheduleSecretDeletionDetails other = (ScheduleSecretDeletionDetails) o;
