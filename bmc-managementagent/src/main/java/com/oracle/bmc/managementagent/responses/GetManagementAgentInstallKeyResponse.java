...
public class GetManagementAgentInstallKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetManagementAgentInstallKeyResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetManagementAgentInstallKeyResponse)) {
            return false;
        }

        GetManagementAgentInstallKeyResponse other = (GetManagementAgentInstallKeyResponse) o;
