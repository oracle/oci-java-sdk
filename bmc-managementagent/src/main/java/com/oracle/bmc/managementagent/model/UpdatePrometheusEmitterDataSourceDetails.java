...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdatePrometheusEmitterDataSourceDetails.Builder.class
)
...
public final class UpdatePrometheusEmitterDataSourceDetails extends UpdateDataSourceDetails {
    ...
    public static class Builder {
        ...
        public UpdatePrometheusEmitterDataSourceDetails build() {
            UpdatePrometheusEmitterDataSourceDetails model =
                    new UpdatePrometheusEmitterDataSourceDetails(
                            this.url,
                            this.allowMetrics,
                            this.proxyUrl,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdatePrometheusEmitterDataSourceDetails model) {
    ...
    @Deprecated
    public UpdatePrometheusEmitterDataSourceDetails(
            String url,
            String allowMetrics,
            String proxyUrl,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdatePrometheusEmitterDataSourceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePrometheusEmitterDataSourceDetails)) {
            return false;
        }

        UpdatePrometheusEmitterDataSourceDetails other =
                (UpdatePrometheusEmitterDataSourceDetails) o;
