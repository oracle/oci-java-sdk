...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementagent/GetNamedCredentialsMetadatumExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNamedCredentialsMetadatumRequest.
 */
...
public class GetNamedCredentialsMetadatumRequest
    ...
    public static class Builder
        ...
        public GetNamedCredentialsMetadatumRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetNamedCredentialsMetadatumRequest(compartmentId, opcRequestId, managementAgentId);
        }
    }
