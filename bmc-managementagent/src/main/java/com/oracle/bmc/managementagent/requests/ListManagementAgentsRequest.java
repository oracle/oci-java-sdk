...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementagent/ListManagementAgentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagementAgentsRequest.
 */
...
public class ListManagementAgentsRequest
    ...
    public static class Builder
        ...
        public ListManagementAgentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagementAgentsRequest(compartmentId, pluginName, version, displayName, lifecycleState, availabilityStatus, hostId, platformType, isCustomerDeployed, installType, gatewayId, limit, page, sortOrder, sortBy, opcRequestId, compartmentIdInSubtree, accessLevel, dataSourceType, dataSourceName);
        }
    }
