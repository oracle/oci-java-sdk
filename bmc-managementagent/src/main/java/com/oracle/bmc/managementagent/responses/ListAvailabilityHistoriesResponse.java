...
public class ListAvailabilityHistoriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.managementagent.model.AvailabilityHistorySummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAvailabilityHistoriesResponse)) {
            return false;
        }

        ListAvailabilityHistoriesResponse other = (ListAvailabilityHistoriesResponse) o;
