...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = KubernetesClusterDataSourceSummary.Builder.class)
...
public final class KubernetesClusterDataSourceSummary extends DataSourceSummary {
    ...
    public static class Builder {
        ...
        public KubernetesClusterDataSourceSummary build() {
            KubernetesClusterDataSourceSummary model =
                    new KubernetesClusterDataSourceSummary(this.key, this.name, this.isDaemonSet);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KubernetesClusterDataSourceSummary model) {
    ...
    @Deprecated
    public KubernetesClusterDataSourceSummary(String key, String name, Boolean isDaemonSet) {
        super(key, name);
        this.isDaemonSet = isDaemonSet;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("KubernetesClusterDataSourceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KubernetesClusterDataSourceSummary)) {
            return false;
        }

        KubernetesClusterDataSourceSummary other = (KubernetesClusterDataSourceSummary) o;
