...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/managementagent/ListNamedCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNamedCredentialsRequest.
 */
...
public class ListNamedCredentialsRequest
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Filter to return only Management Agents in the particular lifecycle state.
        ...
        public ListNamedCredentialsRequest buildWithoutInvocationCallback() {
            ...
            request.id = id;
            return request;
            // new ListNamedCredentialsRequest(managementAgentId, opcRequestId, page, limit, sortOrder, sortBy, lifecycleState, name, type, id);
        }
    }
