...
public class UpdateManagementAgentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateManagementAgentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateManagementAgentResponse)) {
            return false;
        }

        UpdateManagementAgentResponse other = (UpdateManagementAgentResponse) o;
