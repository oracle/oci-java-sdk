...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PrometheusEmitterDataSource.Builder.class)
...
public final class PrometheusEmitterDataSource extends DataSource {
    ...
    public static class Builder {
         ...
         * limit of 400 (KB).
         */
        @com.fasterxml.jackson.annotation.JsonProperty("readDataLimit")
         ...
         * limit of 400 (KB).
         *
         * @param readDataLimit the value to set
         * @return this builder
         */
        ...
        public PrometheusEmitterDataSource build() {
            PrometheusEmitterDataSource model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrometheusEmitterDataSource model) {
            ...
            if (model.wasPropertyExplicitlySet("readDataLimit")) {
                this.readDataLimit(model.getReadDataLimit());
            }
    ...
    @Deprecated
    public PrometheusEmitterDataSource(
            String key,
            String name,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrometheusEmitterDataSource)) {
            return false;
        }

        PrometheusEmitterDataSource other = (PrometheusEmitterDataSource) o;
        return java.util.Objects.equals(this.url, other.url)
                ...
                && java.util.Objects.equals(this.readDataLimit, other.readDataLimit)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.readDataLimit == null ? 43 : this.readDataLimit.hashCode());
