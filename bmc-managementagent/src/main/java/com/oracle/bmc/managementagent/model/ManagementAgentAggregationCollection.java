...
/**
 * The summary of Management Agent count items <br>
...
public final class ManagementAgentAggregationCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public ManagementAgentAggregationCollection(java.util.List<ManagementAgentAggregation> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public ManagementAgentAggregationCollection build() {
            ManagementAgentAggregationCollection model =
                    new ManagementAgentAggregationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementAgentAggregationCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementAgentAggregationCollection)) {
            return false;
        }

        ManagementAgentAggregationCollection other = (ManagementAgentAggregationCollection) o;
