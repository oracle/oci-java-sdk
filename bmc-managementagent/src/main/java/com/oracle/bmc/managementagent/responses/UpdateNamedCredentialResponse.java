...
public class UpdateNamedCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateNamedCredentialResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateNamedCredentialResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateNamedCredentialResponse o) {
         ...
         */
        @Override
        public UpdateNamedCredentialResponse build() {
            return new UpdateNamedCredentialResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNamedCredentialResponse)) {
            return false;
        }

        UpdateNamedCredentialResponse other = (UpdateNamedCredentialResponse) o;
