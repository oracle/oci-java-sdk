...
public class ManagementAgentPluginAggregation {
    ...
    public static class Builder {
        ...
        public ManagementAgentPluginAggregation build() {
            ManagementAgentPluginAggregation __instance__ =
                    new ManagementAgentPluginAggregation(dimensions, count);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementAgentPluginAggregation o) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dimensions")
    ManagementAgentPluginAggregationDimensions dimensions;
