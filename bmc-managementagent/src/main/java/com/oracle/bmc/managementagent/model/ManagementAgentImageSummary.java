...
public final class ManagementAgentImageSummary
    ...
    public static class Builder {
        ...
        public ManagementAgentImageSummary build() {
            ManagementAgentImageSummary model =
                    new ManagementAgentImageSummary(
                            this.id,
                            this.platformType,
                            this.platformName,
                            this.packageType,
                            this.packageArchitectureType,
                            this.version,
                            this.size,
                            this.checksum,
                            this.objectUrl,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ManagementAgentImageSummary model) {
            ...
            if (model.wasPropertyExplicitlySet("packageArchitectureType")) {
                this.packageArchitectureType(model.getPackageArchitectureType());
            }
