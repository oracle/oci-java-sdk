...
public class CreateManagementAgentInstallKeyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateManagementAgentInstallKeyConverter.class);

    public static com.oracle.bmc.managementagent.requests.CreateManagementAgentInstallKeyRequest
            interceptRequest(
