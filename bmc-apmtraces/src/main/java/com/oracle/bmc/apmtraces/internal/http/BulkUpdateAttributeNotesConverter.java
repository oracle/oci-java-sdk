...
public class BulkUpdateAttributeNotesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(BulkUpdateAttributeNotesConverter.class);

    public static com.oracle.bmc.apmtraces.requests.BulkUpdateAttributeNotesRequest
            interceptRequest(
                    com.oracle.bmc.apmtraces.requests.BulkUpdateAttributeNotesRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.apmtraces.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apmtraces.responses.BulkUpdateAttributeNotesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.apmtraces.responses.BulkUpdateAttributeNotesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.apmtraces.responses
                                                        .BulkUpdateAttributeNotesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.bulkUpdateNotesStatus(response.getItem());
