...
public class CreateScheduledQueryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateScheduledQueryResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateScheduledQueryResponse> {
         ...
         */
        @Override
        public Builder copy(CreateScheduledQueryResponse o) {
        ...
        public CreateScheduledQueryResponse build() {
            return new CreateScheduledQueryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateScheduledQueryResponse)) {
            return false;
        }

        CreateScheduledQueryResponse other = (CreateScheduledQueryResponse) o;
