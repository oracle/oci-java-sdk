 ...
 * to any list operations of ScheduledQuery where multiple pages of data may be fetched.
...
public class ScheduledQueryPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listScheduledQueries operation. This iterable
    ...
    public Iterable<ListScheduledQueriesResponse> listScheduledQueriesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListScheduledQueriesRequest.Builder, ListScheduledQueriesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.apmtraces.model.ScheduledQuerySummary} objects
     * contained in responses from the listScheduledQueries operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.apmtraces.model.ScheduledQuerySummary} objects
    ...
    public Iterable<com.oracle.bmc.apmtraces.model.ScheduledQuerySummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListScheduledQueriesRequest.Builder, ListScheduledQueriesRequest,
                ListScheduledQueriesResponse, com.oracle.bmc.apmtraces.model.ScheduledQuerySummary>(
                new java.util.function.Supplier<ListScheduledQueriesRequest.Builder>() {
                    @Override
                    public ListScheduledQueriesRequest.Builder get() {
                        return ListScheduledQueriesRequest.builder().copy(request);
