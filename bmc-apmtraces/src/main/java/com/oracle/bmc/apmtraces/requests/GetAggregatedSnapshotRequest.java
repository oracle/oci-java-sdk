...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmtraces/GetAggregatedSnapshotExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAggregatedSnapshotRequest.
 */
...
public class GetAggregatedSnapshotRequest
    ...
    public static class Builder
        ...
        public GetAggregatedSnapshotRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAggregatedSnapshotRequest(apmDomainId, traceKey, opcRequestId, serviceName, serverName, spanKey, spanName);
        }
    }
