 ...
 * to any list operations of Query where multiple pages of data may be fetched. Two styles of
...
public class QueryPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listQuickPicks
     ...
     * com.oracle.bmc.apmtraces.model.QuickPickSummary} objects contained in responses from the
     * listQuickPicks operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.apmtraces.model.QuickPickSummary} objects contained in responses received
     *     from the service.
     */
