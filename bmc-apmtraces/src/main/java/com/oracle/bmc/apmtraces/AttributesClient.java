...
public class AttributesClient implements Attributes {
    /**
    ...
    public BulkActivateAttributeResponse bulkActivateAttribute(
        ...
        LOG.trace("Called bulkActivateAttribute");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkActivateAttributeResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkActivateAttributeDetails(),
                                                retriedRequest);
    ...
    public BulkDeActivateAttributeResponse bulkDeActivateAttribute(
        ...
        LOG.trace("Called bulkDeActivateAttribute");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkDeActivateAttributeResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkDeActivateAttributeDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public BulkPinAttributeResponse bulkPinAttribute(BulkPinAttributeRequest request) {
        LOG.trace("Called bulkPinAttribute");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkPinAttributeResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkPinAttributeDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public BulkUnpinAttributeResponse bulkUnpinAttribute(BulkUnpinAttributeRequest request) {
        LOG.trace("Called bulkUnpinAttribute");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkUnpinAttributeResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkUnpinAttributeDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public BulkUpdateAttributeResponse bulkUpdateAttribute(BulkUpdateAttributeRequest request) {
        LOG.trace("Called bulkUpdateAttribute");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkUpdateAttributeResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkUpdateAttributeDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public BulkUpdateAttributeNotesResponse bulkUpdateAttributeNotes(
        ...
        LOG.trace("Called bulkUpdateAttributeNotes");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, BulkUpdateAttributeNotesResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getBulkUpdateAttributeNotesDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetStatusAutoActivateResponse getStatusAutoActivate(
        ...
        LOG.trace("Called getStatusAutoActivate");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetStatusAutoActivateResponse>
                transformer =
    ...
    public PutToggleAutoActivateResponse putToggleAutoActivate(
        ...
        LOG.trace("Called putToggleAutoActivate");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, PutToggleAutoActivateResponse>
                transformer =
