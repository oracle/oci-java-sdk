...
public class BulkPinAttributeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder bulkPinStatus(com.oracle.bmc.apmtraces.model.BulkPinStatus bulkPinStatus) {
            this.bulkPinStatus = bulkPinStatus;
            return this;
        }
        ...
        public Builder copy(BulkPinAttributeResponse o) {
            ...
            bulkPinStatus(o.getBulkPinStatus());
    ...
    public String toString() {
        ...
        sb.append(",bulkPinStatus=").append(String.valueOf(bulkPinStatus));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkPinAttributeResponse)) {
            return false;
        }

        BulkPinAttributeResponse other = (BulkPinAttributeResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.bulkPinStatus, other.bulkPinStatus);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.bulkPinStatus == null ? 43 : this.bulkPinStatus.hashCode());
        return result;
    }
}
