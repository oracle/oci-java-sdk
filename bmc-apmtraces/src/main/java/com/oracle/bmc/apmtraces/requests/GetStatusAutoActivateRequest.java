...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmtraces/GetStatusAutoActivateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetStatusAutoActivateRequest.
 */
...
public class GetStatusAutoActivateRequest
    ...
    public static class Builder
         ...
         */
        public GetStatusAutoActivateRequest build() {
            GetStatusAutoActivateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetStatusAutoActivateRequest
         */
        public GetStatusAutoActivateRequest buildWithoutInvocationCallback() {
            GetStatusAutoActivateRequest request = new GetStatusAutoActivateRequest();
            request.apmDomainId = apmDomainId;
            request.dataKeyType = dataKeyType;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetStatusAutoActivateRequest(apmDomainId, dataKeyType, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetStatusAutoActivateRequest)) {
            return false;
        }

        GetStatusAutoActivateRequest other = (GetStatusAutoActivateRequest) o;
