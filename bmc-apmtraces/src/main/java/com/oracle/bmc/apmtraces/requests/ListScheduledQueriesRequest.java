...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmtraces/ListScheduledQueriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListScheduledQueriesRequest.
 */
...
public class ListScheduledQueriesRequest
    ...
    public static class Builder
        ...
        public ListScheduledQueriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListScheduledQueriesRequest(apmDomainId, opcRequestId, opcRetryToken, limit, page, displayName, sortOrder, sortBy);
        }
    }
