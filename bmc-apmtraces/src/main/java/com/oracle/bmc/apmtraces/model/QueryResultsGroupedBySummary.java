...
public class QueryResultsGroupedBySummary {
    ...
    public static class Builder {
        ...
        public QueryResultsGroupedBySummary build() {
            QueryResultsGroupedBySummary __instance__ =
                    new QueryResultsGroupedBySummary(queryResultsGroupedByColumn);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueryResultsGroupedBySummary o) {
            Builder copiedBuilder = queryResultsGroupedByColumn(o.getQueryResultsGroupedByColumn());
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("queryResultsGroupedByColumn")
    String queryResultsGroupedByColumn;
