...
public interface ScheduledQueryAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateScheduledQueryResponse> createScheduledQuery(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteScheduledQueryResponse> deleteScheduledQuery(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetScheduledQueryResponse> getScheduledQuery(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListScheduledQueriesResponse> listScheduledQueries(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateScheduledQueryResponse> updateScheduledQuery(
