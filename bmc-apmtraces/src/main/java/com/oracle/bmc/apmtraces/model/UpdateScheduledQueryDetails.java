...
/**
 * Object that contains the details about the scheduled query to be updated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateScheduledQueryDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateScheduledQueryDetails
    ...
    public UpdateScheduledQueryDetails(
    ...
    public static class Builder {
        ...
        public UpdateScheduledQueryDetails build() {
            UpdateScheduledQueryDetails model =
                    new UpdateScheduledQueryDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateScheduledQueryDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateScheduledQueryDetails)) {
            return false;
        }

        UpdateScheduledQueryDetails other = (UpdateScheduledQueryDetails) o;
