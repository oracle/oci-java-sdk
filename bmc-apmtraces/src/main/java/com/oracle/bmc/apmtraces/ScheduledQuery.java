...
public interface ScheduledQuery extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetScheduledQuery
     *     API.
     */
