...
public class QueryClient implements Query {
    ...
    public ListQuickPicksResponse listQuickPicks(ListQuickPicksRequest request) {
        LOG.trace("Called listQuickPicks");
    ...
    @Override
    public QueryOldResponse queryOld(QueryOldRequest request) {
        LOG.trace("Called queryOld");
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, QueryOldResponse> transformer =
                QueryOldConverter.fromResponse();
