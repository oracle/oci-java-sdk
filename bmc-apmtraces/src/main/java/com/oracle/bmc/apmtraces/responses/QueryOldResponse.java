...
@lombok.Getter
public class QueryOldResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(QueryOldResponse o) {
        ...
        public QueryOldResponse build() {
            return new QueryOldResponse(
                    __httpStatusCode__,
                    opcRequestId,
                    opcTotalItems,
                    opcNextPage,
