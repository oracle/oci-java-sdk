...
public final class BulkPinAttributeDetail
    ...
    public static class Builder {
        ...
        public BulkPinAttributeDetail build() {
            BulkPinAttributeDetail model =
                    new BulkPinAttributeDetail(this.attributeName, this.attributeNameSpace);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkPinAttributeDetail model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BulkPinAttributeDetail(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkPinAttributeDetail)) {
            return false;
        }

        BulkPinAttributeDetail other = (BulkPinAttributeDetail) o;
