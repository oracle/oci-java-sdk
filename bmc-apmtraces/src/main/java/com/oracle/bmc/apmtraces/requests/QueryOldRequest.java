...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmtraces/QueryOldExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use QueryOldRequest.
 */
...
@lombok.Getter
public class QueryOldRequest extends com.oracle.bmc.requests.BmcRequest<QueryDetails> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<QueryOldRequest, QueryDetails> {
         ...
         * @return this builder instance
         */
        public Builder copy(QueryOldRequest o) {
        ...
        /**
         * Build the instance of QueryOldRequest as configured by this builder
         *
         ...
         *
         * @return instance of QueryOldRequest
         */
        public QueryOldRequest build() {
            QueryOldRequest request = buildWithoutInvocationCallback();
