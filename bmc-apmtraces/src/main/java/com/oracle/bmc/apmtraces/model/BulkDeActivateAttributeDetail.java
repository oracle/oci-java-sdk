...
/**
 * Object that contains the details about a single attribute to be deactivated. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkDeActivateAttributeDetail.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkDeActivateAttributeDetail
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"attributeName", "attributeNameSpace"})
    public BulkDeActivateAttributeDetail(
            String attributeName, AttributeNameSpace attributeNameSpace) {
        super();
    ...
    public static class Builder {
        ...
        /**
         * Namespace of the attribute to be deactivated. The attributeNameSpace will default to
        ...
        public BulkDeActivateAttributeDetail build() {
            BulkDeActivateAttributeDetail model =
                    new BulkDeActivateAttributeDetail(this.attributeName, this.attributeNameSpace);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkDeActivateAttributeDetail model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BulkDeActivateAttributeDetail(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkDeActivateAttributeDetail)) {
            return false;
        }

        BulkDeActivateAttributeDetail other = (BulkDeActivateAttributeDetail) o;
