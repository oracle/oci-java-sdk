...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apmtraces/UpdateScheduledQueryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateScheduledQueryRequest.
 */
...
public class UpdateScheduledQueryRequest
    ...
    public static class Builder
        ...
        public UpdateScheduledQueryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateScheduledQueryRequest(apmDomainId, scheduledQueryId, updateScheduledQueryDetails, ifMatch, opcRequestId, opcRetryToken, opcDryRun);
        }
    }
