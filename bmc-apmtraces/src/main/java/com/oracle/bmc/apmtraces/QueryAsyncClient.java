...
public class QueryAsyncClient implements QueryAsync {
    /**
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, QueryAsyncClient> {
    ...
    @Override
    public java.util.concurrent.Future<ListQuickPicksResponse> listQuickPicks(
            ListQuickPicksRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            ListQuickPicksRequest, ListQuickPicksResponse>
                    handler) {
        LOG.trace("Called async listQuickPicks");
        final ListQuickPicksRequest interceptedRequest =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListQuickPicksRequest, ListQuickPicksResponse>,
                        java.util.concurrent.Future<ListQuickPicksResponse>>
