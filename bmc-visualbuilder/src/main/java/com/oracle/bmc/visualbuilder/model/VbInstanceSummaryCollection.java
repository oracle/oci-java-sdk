...
/**
 * Result of a VbInstance Summary request. Contains VbInstanceSummary items. <br>
...
public final class VbInstanceSummaryCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public VbInstanceSummaryCollection(java.util.List<VbInstanceSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public VbInstanceSummaryCollection build() {
            VbInstanceSummaryCollection model = new VbInstanceSummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbInstanceSummaryCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbInstanceSummaryCollection)) {
            return false;
        }

        VbInstanceSummaryCollection other = (VbInstanceSummaryCollection) o;
