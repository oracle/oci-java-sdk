...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/visualbuilder/ListVbInstancesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListVbInstancesRequest.
 */
...
public class ListVbInstancesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListVbInstancesRequest
         */
        public ListVbInstancesRequest buildWithoutInvocationCallback() {
            ListVbInstancesRequest request = new ListVbInstancesRequest();
            ...
            return request;
            // new ListVbInstancesRequest(compartmentId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListVbInstancesRequest)) {
            return false;
        }

        ListVbInstancesRequest other = (ListVbInstancesRequest) o;
