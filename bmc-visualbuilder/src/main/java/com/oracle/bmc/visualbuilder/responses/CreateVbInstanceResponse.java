...
public class CreateVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateVbInstanceResponse> {
        ...
        public CreateVbInstanceResponse build() {
            return new CreateVbInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVbInstanceResponse)) {
            return false;
        }

        CreateVbInstanceResponse other = (CreateVbInstanceResponse) o;
