...
public final class VbInstanceSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbInstanceSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbInstanceSummary)) {
            return false;
        }

        VbInstanceSummary other = (VbInstanceSummary) o;
