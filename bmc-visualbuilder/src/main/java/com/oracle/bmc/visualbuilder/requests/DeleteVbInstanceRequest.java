...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/visualbuilder/DeleteVbInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteVbInstanceRequest.
 */
...
public class DeleteVbInstanceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteVbInstanceRequest
         */
        public DeleteVbInstanceRequest buildWithoutInvocationCallback() {
            DeleteVbInstanceRequest request = new DeleteVbInstanceRequest();
            request.vbInstanceId = vbInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteVbInstanceRequest(vbInstanceId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().vbInstanceId(vbInstanceId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVbInstanceRequest)) {
            return false;
        }

        DeleteVbInstanceRequest other = (DeleteVbInstanceRequest) o;
