...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/visualbuilder/RequestSummarizedApplicationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestSummarizedApplicationsRequest.
 */
...
public class RequestSummarizedApplicationsRequest
    ...
    public static class Builder
        ...
        public RequestSummarizedApplicationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RequestSummarizedApplicationsRequest(requestSummarizedApplicationsDetails, vbInstanceId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
