...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/visualbuilder/ChangeVbInstanceCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeVbInstanceCompartmentRequest.
 */
...
public class ChangeVbInstanceCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeVbInstanceCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeVbInstanceCompartmentRequest(vbInstanceId, changeVbInstanceCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
