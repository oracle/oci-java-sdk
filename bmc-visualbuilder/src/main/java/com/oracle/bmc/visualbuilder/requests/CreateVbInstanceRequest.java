...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/visualbuilder/CreateVbInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateVbInstanceRequest.
 */
...
public class CreateVbInstanceRequest
    ...
    public static class Builder
        ...
        public CreateVbInstanceRequest buildWithoutInvocationCallback() {
            CreateVbInstanceRequest request = new CreateVbInstanceRequest();
            request.createVbInstanceDetails = createVbInstanceDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateVbInstanceRequest(createVbInstanceDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVbInstanceRequest)) {
            return false;
        }

        CreateVbInstanceRequest other = (CreateVbInstanceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createVbInstanceDetails, other.createVbInstanceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createVbInstanceDetails == null
                                ? 43
                                : this.createVbInstanceDetails.hashCode());
        result =
                (result * PRIME)
