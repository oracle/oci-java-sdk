...
public class GetVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.visualbuilder.model.VbInstance getVbInstance() {
        return vbInstance;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVbInstanceResponse> {
         ...
         * @return this builder
         */
        public Builder vbInstance(com.oracle.bmc.visualbuilder.model.VbInstance vbInstance) {
            this.vbInstance = vbInstance;
            return this;
        }
        ...
        public GetVbInstanceResponse build() {
            return new GetVbInstanceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, vbInstance);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",vbInstance=").append(String.valueOf(vbInstance));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVbInstanceResponse)) {
            return false;
        }

        GetVbInstanceResponse other = (GetVbInstanceResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.vbInstance, other.vbInstance);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.vbInstance == null ? 43 : this.vbInstance.hashCode());
        return result;
    }
}
