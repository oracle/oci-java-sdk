...
public class UpdateVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateVbInstanceResponse> {
        ...
        public UpdateVbInstanceResponse build() {
            return new UpdateVbInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVbInstanceResponse)) {
            return false;
        }

        UpdateVbInstanceResponse other = (UpdateVbInstanceResponse) o;
