...
public class DeleteVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteVbInstanceResponse> {
        ...
        public DeleteVbInstanceResponse build() {
            return new DeleteVbInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVbInstanceResponse)) {
            return false;
        }

        DeleteVbInstanceResponse other = (DeleteVbInstanceResponse) o;
