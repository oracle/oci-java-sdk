...
public class StartVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StartVbInstanceResponse> {
        ...
        public StartVbInstanceResponse build() {
            return new StartVbInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartVbInstanceResponse)) {
            return false;
        }

        StartVbInstanceResponse other = (StartVbInstanceResponse) o;
