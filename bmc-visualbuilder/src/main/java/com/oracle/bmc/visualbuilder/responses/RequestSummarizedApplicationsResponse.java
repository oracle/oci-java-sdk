...
public class RequestSummarizedApplicationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.visualbuilder.model.ApplicationSummaryCollection
            getApplicationSummaryCollection() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder applicationSummaryCollection(
                com.oracle.bmc.visualbuilder.model.ApplicationSummaryCollection
                        applicationSummaryCollection) {
            this.applicationSummaryCollection = applicationSummaryCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",applicationSummaryCollection=")
                .append(String.valueOf(applicationSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestSummarizedApplicationsResponse)) {
            return false;
        }

        RequestSummarizedApplicationsResponse other = (RequestSummarizedApplicationsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.applicationSummaryCollection, other.applicationSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.applicationSummaryCollection == null
                                ? 43
                                : this.applicationSummaryCollection.hashCode());
        return result;
    }
}
