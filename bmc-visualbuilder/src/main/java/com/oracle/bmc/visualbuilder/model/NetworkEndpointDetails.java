...
/**
 * Base representation of a network endpoint. In input payload to update an Visual Builder instance
 * endpoint details, an empty payload will clear out any existing configuration for Public Visual
 * Builder instance. <br>
