 ...
 * to any list operations of VbInstance where multiple pages of data may be fetched. Two styles of
...
public class VbInstancePaginators {
    ...
    public VbInstancePaginators(VbInstance client) {
        this.client = client;
    }

    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listVbInstances operation. This iterable will fetch more data from the server as needed.
     *
    ...
    public Iterable<ListVbInstancesResponse> listVbInstancesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new java.util.function.Supplier<ListVbInstancesRequest.Builder>() {
                    @Override
                    public ListVbInstancesRequest.Builder get() {
                        return ListVbInstancesRequest.builder().copy(request);
                    }
                },
                new java.util.function.Function<ListVbInstancesResponse, String>() {
                    @Override
                ...
                new java.util.function.Function<ListVbInstancesRequest, ListVbInstancesResponse>() {
                    @Override
     ...
     * com.oracle.bmc.visualbuilder.model.VbInstanceSummary} objects contained in responses from the
     * listVbInstances operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.visualbuilder.model.VbInstanceSummary} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.visualbuilder.model.WorkRequestError} objects contained in responses from the
     * listWorkRequestErrors operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.visualbuilder.model.WorkRequestError} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.visualbuilder.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse,
                com.oracle.bmc.visualbuilder.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.visualbuilder.model.WorkRequestLogEntry} objects contained in responses from
     * the listWorkRequestLogs operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.visualbuilder.model.WorkRequestLogEntry} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.visualbuilder.model.WorkRequestSummary} objects contained in responses from
     * the listWorkRequests operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.visualbuilder.model.WorkRequestSummary} objects contained in responses
     *     received from the service.
     */
