...
public class StopVbInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopVbInstanceResponse> {
        ...
        public StopVbInstanceResponse build() {
            return new StopVbInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopVbInstanceResponse)) {
            return false;
        }

        StopVbInstanceResponse other = (StopVbInstanceResponse) o;
