 ...
 * resources of LustreFileStorage.
 *
 * <p>The default configuration used is defined by {@link
 * com.oracle.bmc.waiter.Waiters.Waiters#DEFAULT_POLLING_WAITER}.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250228")
public class LustreFileStorageWaiters {
    private final java.util.concurrent.ExecutorService executorService;
    private final LustreFileStorage client;

    public LustreFileStorageWaiters(
            java.util.concurrent.ExecutorService executorService, LustreFileStorage client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetLustreFileSystemRequest, GetLustreFileSystemResponse>
            forLustreFileSystem(
    ...
    // Helper method to create a new Waiter for LustreFileSystem.
    private com.oracle.bmc.waiter.Waiter<GetLustreFileSystemRequest, GetLustreFileSystemResponse>
            forLustreFileSystem(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetLustreFileSystemRequest request,
                    final com.oracle.bmc.lustrefilestorage.model.LustreFileSystem.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.lustrefilestorage.model.LustreFileSystem.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetLustreFileSystemResponse apply(
                                    GetLustreFileSystemRequest request) {
                                return client.getLustreFileSystem(request);
                            }
                        },
                        new java.util.function.Predicate<GetLustreFileSystemResponse>() {
                            @Override
                            public boolean test(GetLustreFileSystemResponse response) {
                                return targetStatesSet.contains(
                                        response.getLustreFileSystem().getLifecycleState());
                            }
                        },
