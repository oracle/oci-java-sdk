...
/**
 * Cluster Placement Groups lets you create resources in close proximity to one another to support
 * low-latency networking use cases. <br>
...
public final class ClusterPlacementGroup
    ...
    public ClusterPlacementGroup(String id) {
        super();
        this.id = id;
    }
    ...
    public static class Builder {
        ...
        public ClusterPlacementGroup build() {
            ClusterPlacementGroup model = new ClusterPlacementGroup(this.id);
