 ...
 * [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with
 * this Lustre file system. For more information about NSGs, see [Security
 * Rules](https://docs.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). <br>
...
public final class NetworkSecurityGroup
    ...
    public NetworkSecurityGroup(java.util.List<String> nsgIds) {
        super();
        this.nsgIds = nsgIds;
    }
    ...
    public static class Builder {
        ...
        public NetworkSecurityGroup build() {
            NetworkSecurityGroup model = new NetworkSecurityGroup(this.nsgIds);
