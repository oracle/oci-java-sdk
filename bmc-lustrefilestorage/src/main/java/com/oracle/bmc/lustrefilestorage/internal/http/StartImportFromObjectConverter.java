...
public class StartImportFromObjectConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(StartImportFromObjectConverter.class);

    public static com.oracle.bmc.lustrefilestorage.requests.StartImportFromObjectRequest
            interceptRequest(
                    com.oracle.bmc.lustrefilestorage.requests.StartImportFromObjectRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.lustrefilestorage.requests.StartImportFromObjectRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.lustrefilestorage.responses
                                        .StartImportFromObjectResponse>() {
                            @Override
                            public com.oracle.bmc.lustrefilestorage.responses
                                            .StartImportFromObjectResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.lustrefilestorage.responses.StartImportFromObjectResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.lustrefilestorage.responses
                                                .StartImportFromObjectResponse.Builder
                                        builder =
                                                com.oracle.bmc.lustrefilestorage.responses
                                                        .StartImportFromObjectResponse.builder()
