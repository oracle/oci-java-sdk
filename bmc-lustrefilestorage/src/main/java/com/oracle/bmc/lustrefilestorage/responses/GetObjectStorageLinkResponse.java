...
public class GetObjectStorageLinkResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetObjectStorageLinkResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetObjectStorageLinkResponse> {
         ...
         */
        @Override
        public Builder copy(GetObjectStorageLinkResponse o) {
         ...
         */
        @Override
        public GetObjectStorageLinkResponse build() {
            return new GetObjectStorageLinkResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, objectStorageLink);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetObjectStorageLinkResponse)) {
            return false;
        }

        GetObjectStorageLinkResponse other = (GetObjectStorageLinkResponse) o;
