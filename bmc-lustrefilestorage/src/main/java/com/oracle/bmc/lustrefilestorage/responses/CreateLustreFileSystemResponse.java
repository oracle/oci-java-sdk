...
public class CreateLustreFileSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     * URL for the created Lustre file system. The lustreFileSystem OCID is generated after this
     * request is sent.
     */
    ...
    private CreateLustreFileSystemResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateLustreFileSystemResponse o) {
         ...
         */
        @Override
        public CreateLustreFileSystemResponse build() {
            return new CreateLustreFileSystemResponse(
                    __httpStatusCode__,
                    headers,
                    location,
                    contentLocation,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLustreFileSystemResponse)) {
            return false;
        }

        CreateLustreFileSystemResponse other = (CreateLustreFileSystemResponse) o;
