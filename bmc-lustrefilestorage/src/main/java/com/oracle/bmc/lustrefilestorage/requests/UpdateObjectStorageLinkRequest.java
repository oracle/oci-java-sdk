...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/lustrefilestorage/UpdateObjectStorageLinkExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateObjectStorageLinkRequest.
 */
...
public class UpdateObjectStorageLinkRequest
    ...
    public static class Builder
        ...
        public UpdateObjectStorageLinkRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateObjectStorageLinkRequest(objectStorageLinkId, updateObjectStorageLinkDetails, ifMatch, opcRequestId);
        }
    }
