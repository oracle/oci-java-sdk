...
public interface LustreFileStorageAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateLustreFileSystemResponse> createLustreFileSystem(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteLustreFileSystemResponse> deleteLustreFileSystem(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetLustreFileSystemResponse> getLustreFileSystem(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListLustreFileSystemsResponse> listLustreFileSystems(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateLustreFileSystemResponse> updateLustreFileSystem(
