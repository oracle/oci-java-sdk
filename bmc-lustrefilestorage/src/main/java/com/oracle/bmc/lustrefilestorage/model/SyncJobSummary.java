...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SyncJobSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SyncJobSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public SyncJobSummary(
            String id,
            JobType jobType,
            SyncJob.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private SyncJob.LifecycleState lifecycleState;
         ...
         * @return this builder
         **/
        public Builder lifecycleState(SyncJob.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SyncJobSummary model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final SyncJob.LifecycleState lifecycleState;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SyncJobSummary)) {
            return false;
        }

        SyncJobSummary other = (SyncJobSummary) o;
