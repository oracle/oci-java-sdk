...
public class UpdateObjectStorageLinkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned ObjectStorageLink instance.
     */
    ...
    private UpdateObjectStorageLinkResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateObjectStorageLinkResponse o) {
         ...
         */
        public UpdateObjectStorageLinkResponse build() {
            return new UpdateObjectStorageLinkResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateObjectStorageLinkResponse)) {
            return false;
        }

        UpdateObjectStorageLinkResponse other = (UpdateObjectStorageLinkResponse) o;
