...
public class DataFlowWaiters {
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetSqlEndpointRequest, GetSqlEndpointResponse>
            forSqlEndpoint(
                    GetSqlEndpointRequest request,
                    com.oracle.bmc.dataflow.model.SqlEndpointLifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forSqlEndpoint(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetSqlEndpointRequest, GetSqlEndpointResponse>
            forSqlEndpoint(
                    GetSqlEndpointRequest request,
                    com.oracle.bmc.dataflow.model.SqlEndpointLifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for SqlEndpoint.
    private com.oracle.bmc.waiter.Waiter<GetSqlEndpointRequest, GetSqlEndpointResponse>
            forSqlEndpoint(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetSqlEndpointRequest request,
                    final com.oracle.bmc.dataflow.model.SqlEndpointLifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.dataflow.model.SqlEndpointLifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetSqlEndpointResponse apply(GetSqlEndpointRequest request) {
                                return client.getSqlEndpoint(request);
                            }
                        },
                        new java.util.function.Predicate<GetSqlEndpointResponse>() {
                            @Override
                            public boolean test(GetSqlEndpointResponse response) {
                                return targetStatesSet.contains(
                                        response.getSqlEndpoint().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.dataflow.model.SqlEndpointLifecycleState.Deleted)),
                request);
    }
