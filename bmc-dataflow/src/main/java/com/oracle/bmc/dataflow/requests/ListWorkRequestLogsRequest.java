...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataflow/ListWorkRequestLogsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestLogsRequest.
 */
...
public class ListWorkRequestLogsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListWorkRequestLogsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListWorkRequestLogsRequest(workRequestId, limit, opcRequestId, page);
        }
    }
