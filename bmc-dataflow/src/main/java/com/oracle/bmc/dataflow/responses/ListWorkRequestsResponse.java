...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.dataflow.model.WorkRequestCollection getWorkRequestCollection() {
    ...
    private ListWorkRequestsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.dataflow.model.WorkRequestCollection workRequestCollection) {
