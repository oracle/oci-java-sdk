...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataflow/StartPoolExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartPoolRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200129")
public class StartPoolRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    StartPoolRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(StartPoolRequest o) {
            poolId(o.getPoolId());
         ...
         *
         * @return instance of StartPoolRequest
         */
        public StartPoolRequest build() {
            StartPoolRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StartPoolRequest
         */
        public StartPoolRequest buildWithoutInvocationCallback() {
            StartPoolRequest request = new StartPoolRequest();
            request.poolId = poolId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new StartPoolRequest(poolId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartPoolRequest)) {
            return false;
        }

        StartPoolRequest other = (StartPoolRequest) o;
