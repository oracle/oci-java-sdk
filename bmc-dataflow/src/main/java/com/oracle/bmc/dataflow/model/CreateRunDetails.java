...
/**
 * The create run details. The following properties are optional and override the default values set
 * in the associated application: - applicationId - archiveUri - applicationLogConfig - arguments -
 * configuration - definedTags - displayName - driverShape - execute - executorShape - freeformTags
 * - logsBucketUri - metastoreId - numExecutors - parameters - sparkVersion - warehouseBucketUri It
 * is expected that either the applicationId or the execute parameter is specified; but not both. If
 * both or none are set, a Bad Request (HTTP 400) status will be sent as the response. If an
 * appicationId is not specified, then a value for the execute parameter is expected. Using data
 * parsed from the value, a new application will be created and assicated with the new run. See
 * information on the execute parameter for details on the format of this parameter.
 *
 * <p>The optional parameter spark version can only be specified when using the execute parameter.
 * If it is not specified when using the execute parameter, the latest version will be used as
 * default. If the execute parameter is not used, the spark version will be taken from the
 * associated application.
 *
 * <p>If displayName is not specified, it will be derived from the displayName of associated
 ...
 * properties of the run will not update. <br>
...
public final class CreateRunDetails
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the associated application. If this value is set, then no value for the
         * execute parameter is required. If this value is not set, then a value for the execute
         * parameter is required, and a new application is created and associated with the new run.
         */
        ...
        /**
         * A user-friendly name that does not have to be unique. Avoid entering confidential
         * information. If this value is not specified, it will be derived from the associated
         * application's displayName or set by API using fileUri's application file name.
         */
    ...
    /**
     * The OCID of the associated application. If this value is set, then no value for the execute
     * parameter is required. If this value is not set, then a value for the execute parameter is
     * required, and a new application is created and associated with the new run.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("applicationId")
