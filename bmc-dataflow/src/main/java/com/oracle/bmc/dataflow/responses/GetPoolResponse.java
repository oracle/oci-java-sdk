...
public class GetPoolResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPoolResponse> {
         ...
         */
        @Override
        public Builder copy(GetPoolResponse o) {
        ...
        public GetPoolResponse build() {
            return new GetPoolResponse(__httpStatusCode__, headers, etag, opcRequestId, pool);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPoolResponse)) {
            return false;
        }
