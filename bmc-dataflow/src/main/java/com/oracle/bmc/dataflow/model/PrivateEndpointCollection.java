...
public class PrivateEndpointCollection {
    ...
    public static class Builder {
        ...
        public PrivateEndpointCollection build() {
            PrivateEndpointCollection __instance__ = new PrivateEndpointCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrivateEndpointCollection o) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    java.util.List<PrivateEndpointSummary> items;
