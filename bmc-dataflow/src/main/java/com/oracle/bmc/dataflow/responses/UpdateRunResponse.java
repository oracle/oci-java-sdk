...
public class UpdateRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRunResponse> {
        ...
        public UpdateRunResponse build() {
            return new UpdateRunResponse(__httpStatusCode__, headers, etag, opcRequestId, run);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRunResponse)) {
            return false;
        }

        UpdateRunResponse other = (UpdateRunResponse) o;
