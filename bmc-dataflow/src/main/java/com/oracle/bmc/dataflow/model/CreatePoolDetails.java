...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreatePoolDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CreatePoolDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CreatePoolDetails build() {
            CreatePoolDetails model =
                    new CreatePoolDetails(
                            this.compartmentId,
                            this.displayName,
                            this.description,
                            this.configurations,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePoolDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePoolDetails)) {
            return false;
        }

        CreatePoolDetails other = (CreatePoolDetails) o;
