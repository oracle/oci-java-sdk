...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MetricBasedHorizontalScalingPolicyDetails.Builder.class
)
...
public final class MetricBasedHorizontalScalingPolicyDetails extends AutoScalePolicyDetails {
    ...
    @Deprecated
    public MetricBasedHorizontalScalingPolicyDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MetricBasedHorizontalScalingPolicyDetails)) {
            return false;
        }

        MetricBasedHorizontalScalingPolicyDetails other =
