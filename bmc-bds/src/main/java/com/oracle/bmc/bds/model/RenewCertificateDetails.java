...
/**
 * The request body info about renew certificate service list. <br>
...
public final class RenewCertificateDetails
    ...
    public static class Builder {
        ...
        /**
         * List of services for which certificate needs to be renewed. If no services provided renew
         * will happen only for default services - AMBARI,RANGER,HUE,LIVY.
         */
