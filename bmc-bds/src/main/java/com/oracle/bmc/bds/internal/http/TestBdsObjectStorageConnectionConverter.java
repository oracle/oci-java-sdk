...
public class TestBdsObjectStorageConnectionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(TestBdsObjectStorageConnectionConverter.class);

    public static com.oracle.bmc.bds.requests.TestBdsObjectStorageConnectionRequest
            interceptRequest(
                    com.oracle.bmc.bds.requests.TestBdsObjectStorageConnectionRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getApiKeyId()))
                        .path("actions")
                        .path("testObjectStorageConnection");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.bds.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.bds.responses.TestBdsObjectStorageConnectionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
