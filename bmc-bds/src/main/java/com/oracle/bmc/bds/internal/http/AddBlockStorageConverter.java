...
public class AddBlockStorageConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AddBlockStorageConverter.class);

    public static com.oracle.bmc.bds.requests.AddBlockStorageRequest interceptRequest(
            com.oracle.bmc.bds.requests.AddBlockStorageRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getAddBlockStorageDetails(), "addBlockStorageDetails is required");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.bds.responses.AddBlockStorageResponse>() {
                            @Override
                            public com.oracle.bmc.bds.responses.AddBlockStorageResponse apply(
