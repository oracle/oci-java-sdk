...
public final class MetricThresholdRule {
    ...
    public static class Builder {
        ...
        public MetricThresholdRule build() {
            MetricThresholdRule __instance__ =
                    new MetricThresholdRule(durationInMinutes, operator, value);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MetricThresholdRule o) {
            Builder copiedBuilder =
                    durationInMinutes(o.getDurationInMinutes())
