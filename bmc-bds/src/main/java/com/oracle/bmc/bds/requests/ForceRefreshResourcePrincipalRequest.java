...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ForceRefreshResourcePrincipalExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ForceRefreshResourcePrincipalRequest.
 */
...
public class ForceRefreshResourcePrincipalRequest
    ...
    public static class Builder
        ...
        public ForceRefreshResourcePrincipalRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ForceRefreshResourcePrincipalRequest(bdsInstanceId, resourcePrincipalConfigurationId, forceRefreshResourcePrincipalDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
