...
public class GetAutoScalingConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
        ...
        public GetAutoScalingConfigurationResponse build() {
            return new GetAutoScalingConfigurationResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, autoScalingConfiguration);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAutoScalingConfigurationResponse)) {
            return false;
        }

        GetAutoScalingConfigurationResponse other = (GetAutoScalingConfigurationResponse) o;
