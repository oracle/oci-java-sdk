...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/UpdateNodeBackupConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateNodeBackupConfigurationRequest.
 */
...
public class UpdateNodeBackupConfigurationRequest
    ...
    public static class Builder
        ...
        public UpdateNodeBackupConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateNodeBackupConfigurationRequest(bdsInstanceId, nodeBackupConfigurationId, updateNodeBackupConfigurationDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
