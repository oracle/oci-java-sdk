 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBdsInstanceRequest.
 */
...
public class UpdateBdsInstanceRequest
    ...
    public static class Builder
         ...
         * Details for the cluster to be updated.
         *
         * @param updateBdsInstanceDetails the value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateBdsInstanceRequest o) {
            bdsInstanceId(o.getBdsInstanceId());
            updateBdsInstanceDetails(o.getUpdateBdsInstanceDetails());
         ...
         */
        public UpdateBdsInstanceRequest build() {
            UpdateBdsInstanceRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateBdsInstanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateBdsInstanceRequest(bdsInstanceId, updateBdsInstanceDetails, ifMatch,
            // opcRequestId);
        }
    }
