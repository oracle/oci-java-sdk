...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/GetNodeBackupConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNodeBackupConfigurationRequest.
 */
...
public class GetNodeBackupConfigurationRequest
    ...
    public static class Builder
        ...
        public GetNodeBackupConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetNodeBackupConfigurationRequest(bdsInstanceId, nodeBackupConfigurationId, opcRequestId);
        }
    }
