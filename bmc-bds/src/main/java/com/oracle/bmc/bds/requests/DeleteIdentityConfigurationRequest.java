...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/DeleteIdentityConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteIdentityConfigurationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190531")
public class DeleteIdentityConfigurationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteIdentityConfigurationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteIdentityConfigurationRequest o) {
        ...
        /**
         * Build the instance of DeleteIdentityConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteIdentityConfigurationRequest
         */
        public DeleteIdentityConfigurationRequest build() {
            DeleteIdentityConfigurationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteIdentityConfigurationRequest
         */
        public DeleteIdentityConfigurationRequest buildWithoutInvocationCallback() {
            DeleteIdentityConfigurationRequest request = new DeleteIdentityConfigurationRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.identityConfigurationId = identityConfigurationId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteIdentityConfigurationRequest(bdsInstanceId, identityConfigurationId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIdentityConfigurationRequest)) {
            return false;
        }

        DeleteIdentityConfigurationRequest other = (DeleteIdentityConfigurationRequest) o;
