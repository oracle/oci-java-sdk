...
public class RemoveNodeReplaceConfigurationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RemoveNodeReplaceConfigurationConverter.class);

    public static com.oracle.bmc.bds.requests.RemoveNodeReplaceConfigurationRequest
            interceptRequest(
                    com.oracle.bmc.bds.requests.RemoveNodeReplaceConfigurationRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("nodeReplaceConfigurations")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getNodeReplaceConfigurationId()))
                        .path("actions")
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.bds.responses.RemoveNodeReplaceConfigurationResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.bds.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.bds.responses.RemoveNodeReplaceConfigurationResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
