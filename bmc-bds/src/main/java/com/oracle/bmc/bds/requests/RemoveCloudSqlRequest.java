...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/RemoveCloudSqlExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveCloudSqlRequest.
 */
...
public class RemoveCloudSqlRequest
     ...
     * Details for the Cloud SQL capability
     */
    public com.oracle.bmc.bds.model.RemoveCloudSqlDetails getRemoveCloudSqlDetails() {
    ...
    public static class Builder
         ...
         * Details for the Cloud SQL capability
         */
        private com.oracle.bmc.bds.model.RemoveCloudSqlDetails removeCloudSqlDetails = null;

        /**
         * Details for the Cloud SQL capability
         * @param removeCloudSqlDetails the value to set
         * @return this builder instance
         */
        public Builder removeCloudSqlDetails(
                com.oracle.bmc.bds.model.RemoveCloudSqlDetails removeCloudSqlDetails) {
            this.removeCloudSqlDetails = removeCloudSqlDetails;
            return this;
        }
         ...
         * @return instance of RemoveCloudSqlRequest
         */
        public RemoveCloudSqlRequest buildWithoutInvocationCallback() {
            RemoveCloudSqlRequest request = new RemoveCloudSqlRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.removeCloudSqlDetails = removeCloudSqlDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new RemoveCloudSqlRequest(bdsInstanceId, removeCloudSqlDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",removeCloudSqlDetails=").append(String.valueOf(this.removeCloudSqlDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveCloudSqlRequest)) {
            return false;
        }

        RemoveCloudSqlRequest other = (RemoveCloudSqlRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.bdsInstanceId, other.bdsInstanceId)
                && java.util.Objects.equals(this.removeCloudSqlDetails, other.removeCloudSqlDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removeCloudSqlDetails == null
                                ? 43
                                : this.removeCloudSqlDetails.hashCode());
