...
public class ListWorkRequestErrorsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bds.model.WorkRequestError} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.bds.model.WorkRequestError> getItems() {
        return items;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.bds.model.WorkRequestError> items) {
            this.items = items;
            return this;
        }
