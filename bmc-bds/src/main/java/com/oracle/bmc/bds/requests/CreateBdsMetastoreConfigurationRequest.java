...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/CreateBdsMetastoreConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBdsMetastoreConfigurationRequest.
 */
...
public class CreateBdsMetastoreConfigurationRequest
    ...
    public static class Builder
        ...
        public Builder createBdsMetastoreConfigurationDetails(
                com.oracle.bmc.bds.model.CreateBdsMetastoreConfigurationDetails
                        createBdsMetastoreConfigurationDetails) {
            this.createBdsMetastoreConfigurationDetails = createBdsMetastoreConfigurationDetails;
            return this;
        }
         ...
         * @return instance of CreateBdsMetastoreConfigurationRequest
         */
        public CreateBdsMetastoreConfigurationRequest buildWithoutInvocationCallback() {
            CreateBdsMetastoreConfigurationRequest request =
                    new CreateBdsMetastoreConfigurationRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.createBdsMetastoreConfigurationDetails = createBdsMetastoreConfigurationDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateBdsMetastoreConfigurationRequest(bdsInstanceId, createBdsMetastoreConfigurationDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createBdsMetastoreConfigurationDetails=")
                .append(String.valueOf(this.createBdsMetastoreConfigurationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBdsMetastoreConfigurationRequest)) {
            return false;
        }

        CreateBdsMetastoreConfigurationRequest other = (CreateBdsMetastoreConfigurationRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.bdsInstanceId, other.bdsInstanceId)
                && java.util.Objects.equals(
                        this.createBdsMetastoreConfigurationDetails,
                        other.createBdsMetastoreConfigurationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createBdsMetastoreConfigurationDetails == null
                                ? 43
                                : this.createBdsMetastoreConfigurationDetails.hashCode());
        result =
                (result * PRIME)
