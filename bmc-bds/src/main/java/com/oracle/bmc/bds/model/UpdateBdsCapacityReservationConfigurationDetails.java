...
/**
 * Details for updating a BDS capacity reservation configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateBdsCapacityReservationConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateBdsCapacityReservationConfigurationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"bdsCapacityReservationId", "displayName"})
    public UpdateBdsCapacityReservationConfigurationDetails(
            String bdsCapacityReservationId, String displayName) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateBdsCapacityReservationConfigurationDetails build() {
            UpdateBdsCapacityReservationConfigurationDetails model =
                    new UpdateBdsCapacityReservationConfigurationDetails(
                            this.bdsCapacityReservationId, this.displayName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBdsCapacityReservationConfigurationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateBdsCapacityReservationConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBdsCapacityReservationConfigurationDetails)) {
            return false;
        }

        UpdateBdsCapacityReservationConfigurationDetails other =
                (UpdateBdsCapacityReservationConfigurationDetails) o;
