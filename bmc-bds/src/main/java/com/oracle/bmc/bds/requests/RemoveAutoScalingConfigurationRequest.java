...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/RemoveAutoScalingConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveAutoScalingConfigurationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190531")
public class RemoveAutoScalingConfigurationRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails> {
     ...
     */
    private com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails
            removeAutoScalingConfigurationDetails;

    /**
     * Details for the autoscale configuration
     */
    public com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails
    ...
    public com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails getBody$() {
        return removeAutoScalingConfigurationDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails
                removeAutoScalingConfigurationDetails = null;

        /**
         * Details for the autoscale configuration
         * @param removeAutoScalingConfigurationDetails the value to set
         * @return this builder instance
         */
        public Builder removeAutoScalingConfigurationDetails(
                com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails
                        removeAutoScalingConfigurationDetails) {
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.bds.model.RemoveAutoScalingConfigurationDetails body) {
        ...
        public RemoveAutoScalingConfigurationRequest buildWithoutInvocationCallback() {
            RemoveAutoScalingConfigurationRequest request =
                    new RemoveAutoScalingConfigurationRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.autoScalingConfigurationId = autoScalingConfigurationId;
            request.removeAutoScalingConfigurationDetails = removeAutoScalingConfigurationDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new RemoveAutoScalingConfigurationRequest(bdsInstanceId, autoScalingConfigurationId, removeAutoScalingConfigurationDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",removeAutoScalingConfigurationDetails=")
                .append(String.valueOf(this.removeAutoScalingConfigurationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveAutoScalingConfigurationRequest)) {
            return false;
        }

        RemoveAutoScalingConfigurationRequest other = (RemoveAutoScalingConfigurationRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.removeAutoScalingConfigurationDetails,
                        other.removeAutoScalingConfigurationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.removeAutoScalingConfigurationDetails == null
                                ? 43
                                : this.removeAutoScalingConfigurationDetails.hashCode());
