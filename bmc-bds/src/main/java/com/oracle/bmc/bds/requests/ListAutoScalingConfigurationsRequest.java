...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ListAutoScalingConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAutoScalingConfigurationsRequest.
 */
...
public class ListAutoScalingConfigurationsRequest
    ...
    public static class Builder
        ...
        public ListAutoScalingConfigurationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAutoScalingConfigurationsRequest(compartmentId, bdsInstanceId, page, limit, sortBy, sortOrder, displayName, lifecycleState, opcRequestId);
        }
    }
