...
public final class ActivateBdsMetastoreConfigurationDetails {
    ...
    public static class Builder {
        ...
        public ActivateBdsMetastoreConfigurationDetails build() {
            ActivateBdsMetastoreConfigurationDetails __instance__ =
                    new ActivateBdsMetastoreConfigurationDetails(
                            bdsApiKeyPassphrase, clusterAdminPassword);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ActivateBdsMetastoreConfigurationDetails o) {
