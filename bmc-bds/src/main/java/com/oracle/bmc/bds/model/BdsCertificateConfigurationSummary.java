...
/**
 * Summary details of the BDS certificate configuration. <br>
...
public final class BdsCertificateConfigurationSummary
    ...
    public static class Builder {
         ...
         * configuration. The value is Null when this BDS certificate configuration type is
         * SELF_SIGNED.
         */
        ...
        /**
         * The last time the BDS certificate configuration was used to generate or renew the
         * certificate(s).
         */
        ...
        /**
         * The time when the BDS certificate configuration was created, shown as an RFC 3339
        ...
        /**
         * The time the BDS certificate configuration was updated, shown as an RFC 3339 formatted
         * datetime string.
         */
        ...
        /**
         * If this BDS certificate configuration is a default configuration or not. There will be
         * only one Default certificate configuration per BDS cluster.
         */
    ...
    /**
     * The OCID of the certificate authority which is associated with this certificate
     * configuration. The value is Null when this BDS certificate configuration type is SELF_SIGNED.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("certificateAuthorityId")
    ...
    /**
     * The time when the BDS certificate configuration was created, shown as an RFC 3339 formatted
     * datetime string.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeCreated")
    ...
    /**
     * If this BDS certificate configuration is a default configuration or not. There will be only
     * one Default certificate configuration per BDS cluster.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isDefaultConfiguration")
