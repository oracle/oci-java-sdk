...
public class ActivateUpstConfigurationConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ActivateUpstConfigurationConverter.class);

    public static com.oracle.bmc.bds.requests.ActivateUpstConfigurationRequest interceptRequest(
            com.oracle.bmc.bds.requests.ActivateUpstConfigurationRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("actions")
                        .path("activateUpstConfiguration");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.bds.responses.ActivateUpstConfigurationResponse>() {
                            @Override
                            public com.oracle.bmc.bds.responses.ActivateUpstConfigurationResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.bds.responses.ActivateUpstConfigurationResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.bds.responses.ActivateUpstConfigurationResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.bds.responses
                                                        .ActivateUpstConfigurationResponse.builder()
