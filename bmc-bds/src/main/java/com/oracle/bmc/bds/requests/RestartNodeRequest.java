...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/RestartNodeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RestartNodeRequest.
 */
...
public class RestartNodeRequest
     ...
     * Details for restarting the node.
     */
    public com.oracle.bmc.bds.model.RestartNodeDetails getRestartNodeDetails() {
    ...
    public static class Builder
         ...
         * Details for restarting the node.
         */
        private com.oracle.bmc.bds.model.RestartNodeDetails restartNodeDetails = null;

        /**
         * Details for restarting the node.
         * @param restartNodeDetails the value to set
         * @return this builder instance
         */
        public Builder restartNodeDetails(
                com.oracle.bmc.bds.model.RestartNodeDetails restartNodeDetails) {
            this.restartNodeDetails = restartNodeDetails;
            return this;
        }
         ...
         * @return instance of RestartNodeRequest
         */
        public RestartNodeRequest buildWithoutInvocationCallback() {
            RestartNodeRequest request = new RestartNodeRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.restartNodeDetails = restartNodeDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new RestartNodeRequest(bdsInstanceId, restartNodeDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",restartNodeDetails=").append(String.valueOf(this.restartNodeDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartNodeRequest)) {
            return false;
        }

        RestartNodeRequest other = (RestartNodeRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.bdsInstanceId, other.bdsInstanceId)
                && java.util.Objects.equals(this.restartNodeDetails, other.restartNodeDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.restartNodeDetails == null
                                ? 43
                                : this.restartNodeDetails.hashCode());
