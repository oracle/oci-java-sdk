...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ListNodeReplaceConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNodeReplaceConfigurationsRequest.
 */
...
public class ListNodeReplaceConfigurationsRequest
    ...
    public static class Builder
        ...
        public ListNodeReplaceConfigurationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNodeReplaceConfigurationsRequest(bdsInstanceId, page, limit, sortBy, sortOrder, displayName, lifecycleState, opcRequestId);
        }
    }
