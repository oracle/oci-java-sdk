...
/**
 * A configuration between a BDS cluster and a BDS capacity reservation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BdsCapacityReservationConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BdsCapacityReservationConfiguration
    ...
    public BdsCapacityReservationConfiguration(
            String id,
    ...
    public static class Builder {
        ...
        /**
         * The time the BDS capacity reservation configuration was created, shown as an RFC 3339
        ...
        /**
         * The time the BDS capacity reservation configuration was updated, shown as an RFC 3339
         * formatted datetime string.
         */
        ...
        public BdsCapacityReservationConfiguration build() {
            BdsCapacityReservationConfiguration model =
                    new BdsCapacityReservationConfiguration(
                            this.id,
                            this.bdsInstanceId,
                            this.bdsCapacityReservationId,
                            this.displayName,
                            this.lifecycleState,
                            this.timeCreated,
                            this.timeUpdated);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BdsCapacityReservationConfiguration model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BdsCapacityReservationConfiguration)) {
            return false;
        }

        BdsCapacityReservationConfiguration other = (BdsCapacityReservationConfiguration) o;
