...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/CreateNodeBackupConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateNodeBackupConfigurationRequest.
 */
...
public class CreateNodeBackupConfigurationRequest
    ...
    public static class Builder
        ...
        public CreateNodeBackupConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateNodeBackupConfigurationRequest(bdsInstanceId, createNodeBackupConfigurationDetails, opcRequestId, opcRetryToken);
        }
    }
