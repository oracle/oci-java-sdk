...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/RefreshUpstTokenExchangeKeytabExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshUpstTokenExchangeKeytabRequest.
 */
...
public class RefreshUpstTokenExchangeKeytabRequest
    ...
    public static class Builder
        ...
        public RefreshUpstTokenExchangeKeytabRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RefreshUpstTokenExchangeKeytabRequest(bdsInstanceId, identityConfigurationId, refreshUpstTokenExchangeKeytabDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
