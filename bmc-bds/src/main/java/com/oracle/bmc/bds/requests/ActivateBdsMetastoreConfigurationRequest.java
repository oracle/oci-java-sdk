...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ActivateBdsMetastoreConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ActivateBdsMetastoreConfigurationRequest.
 */
...
public class ActivateBdsMetastoreConfigurationRequest
    ...
    public com.oracle.bmc.bds.model.ActivateBdsMetastoreConfigurationDetails getBody$() {
        return activateBdsMetastoreConfigurationDetails;
    }
    ...
    public static class Builder
        ...
        public Builder activateBdsMetastoreConfigurationDetails(
                com.oracle.bmc.bds.model.ActivateBdsMetastoreConfigurationDetails
                        activateBdsMetastoreConfigurationDetails) {
            this.activateBdsMetastoreConfigurationDetails =
                    activateBdsMetastoreConfigurationDetails;
            return this;
        }
        ...
        public Builder copy(ActivateBdsMetastoreConfigurationRequest o) {
            ...
            activateBdsMetastoreConfigurationDetails(
                    o.getActivateBdsMetastoreConfigurationDetails());
         ...
         */
        public ActivateBdsMetastoreConfigurationRequest build() {
            ActivateBdsMetastoreConfigurationRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.bds.model.ActivateBdsMetastoreConfigurationDetails body) {
            activateBdsMetastoreConfigurationDetails(body);
            return this;
        }
         ...
         * @return instance of ActivateBdsMetastoreConfigurationRequest
         */
        public ActivateBdsMetastoreConfigurationRequest buildWithoutInvocationCallback() {
            ActivateBdsMetastoreConfigurationRequest request =
                    new ActivateBdsMetastoreConfigurationRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.metastoreConfigId = metastoreConfigId;
            request.activateBdsMetastoreConfigurationDetails =
                    activateBdsMetastoreConfigurationDetails;
    ...
    public String toString() {
        ...
        sb.append(",activateBdsMetastoreConfigurationDetails=")
                .append(String.valueOf(this.activateBdsMetastoreConfigurationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ActivateBdsMetastoreConfigurationRequest)) {
            return false;
        }

        ActivateBdsMetastoreConfigurationRequest other =
                (ActivateBdsMetastoreConfigurationRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.activateBdsMetastoreConfigurationDetails,
                        other.activateBdsMetastoreConfigurationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.activateBdsMetastoreConfigurationDetails == null
                                ? 43
                                : this.activateBdsMetastoreConfigurationDetails.hashCode());
