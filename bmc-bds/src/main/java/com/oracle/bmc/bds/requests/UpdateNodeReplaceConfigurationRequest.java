...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/UpdateNodeReplaceConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateNodeReplaceConfigurationRequest.
 */
...
public class UpdateNodeReplaceConfigurationRequest
    ...
    public static class Builder
        ...
        public UpdateNodeReplaceConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateNodeReplaceConfigurationRequest(bdsInstanceId, nodeReplaceConfigurationId, updateNodeReplaceConfigurationDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
