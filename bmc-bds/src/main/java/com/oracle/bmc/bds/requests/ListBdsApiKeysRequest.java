...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ListBdsApiKeysExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBdsApiKeysRequest.
 */
...
public class ListBdsApiKeysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListBdsApiKeysRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListBdsApiKeysRequest o) {
         ...
         */
        public ListBdsApiKeysRequest build() {
            ListBdsApiKeysRequest request = buildWithoutInvocationCallback();
