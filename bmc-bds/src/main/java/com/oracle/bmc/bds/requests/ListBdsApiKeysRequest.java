 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBdsApiKeysRequest.
 */
...
public class ListBdsApiKeysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListBdsApiKeysRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListBdsApiKeysRequest(bdsInstanceId, lifecycleState, userId, page, limit, sortBy,
            // sortOrder, displayName, opcRequestId);
        }
    }
