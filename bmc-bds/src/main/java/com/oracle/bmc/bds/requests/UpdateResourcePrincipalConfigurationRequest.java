...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/UpdateResourcePrincipalConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateResourcePrincipalConfigurationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190531")
public class UpdateResourcePrincipalConfigurationRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails> {
    ...
    public com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails
        ...
        return updateResourcePrincipalConfigurationDetails;
    }
    /**
    ...
    public com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails getBody$() {
        return updateResourcePrincipalConfigurationDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails
                updateResourcePrincipalConfigurationDetails = null;

        /**
         * Details for updating the resourcePrincipalConfiguration.
         * @param updateResourcePrincipalConfigurationDetails the value to set
         * @return this builder instance
         */
        public Builder updateResourcePrincipalConfigurationDetails(
                com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails
                        updateResourcePrincipalConfigurationDetails) {
            this.updateResourcePrincipalConfigurationDetails =
                    updateResourcePrincipalConfigurationDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateResourcePrincipalConfigurationRequest o) {
            bdsInstanceId(o.getBdsInstanceId());
            resourcePrincipalConfigurationId(o.getResourcePrincipalConfigurationId());
            updateResourcePrincipalConfigurationDetails(
                    o.getUpdateResourcePrincipalConfigurationDetails());
        ...
        /**
         * Build the instance of UpdateResourcePrincipalConfigurationRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateResourcePrincipalConfigurationRequest
         */
        public UpdateResourcePrincipalConfigurationRequest build() {
            UpdateResourcePrincipalConfigurationRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.bds.model.UpdateResourcePrincipalConfigurationDetails body) {
            updateResourcePrincipalConfigurationDetails(body);
            return this;
        }
        ...
        public UpdateResourcePrincipalConfigurationRequest buildWithoutInvocationCallback() {
            UpdateResourcePrincipalConfigurationRequest request =
                    new UpdateResourcePrincipalConfigurationRequest();
            request.bdsInstanceId = bdsInstanceId;
            request.resourcePrincipalConfigurationId = resourcePrincipalConfigurationId;
            request.updateResourcePrincipalConfigurationDetails =
                    updateResourcePrincipalConfigurationDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new UpdateResourcePrincipalConfigurationRequest(bdsInstanceId, resourcePrincipalConfigurationId, updateResourcePrincipalConfigurationDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateResourcePrincipalConfigurationDetails=")
                .append(String.valueOf(this.updateResourcePrincipalConfigurationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateResourcePrincipalConfigurationRequest)) {
            return false;
        }

        UpdateResourcePrincipalConfigurationRequest other =
                (UpdateResourcePrincipalConfigurationRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateResourcePrincipalConfigurationDetails,
                        other.updateResourcePrincipalConfigurationDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateResourcePrincipalConfigurationDetails == null
                                ? 43
                                : this.updateResourcePrincipalConfigurationDetails.hashCode());
