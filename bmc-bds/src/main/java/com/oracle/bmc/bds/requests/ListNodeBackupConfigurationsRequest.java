...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ListNodeBackupConfigurationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNodeBackupConfigurationsRequest.
 */
...
public class ListNodeBackupConfigurationsRequest
    ...
    public static class Builder
        ...
        public ListNodeBackupConfigurationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNodeBackupConfigurationsRequest(bdsInstanceId, page, limit, sortBy, sortOrder, displayName, lifecycleState, opcRequestId);
        }
    }
