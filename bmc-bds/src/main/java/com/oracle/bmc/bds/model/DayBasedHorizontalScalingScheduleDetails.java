...
public class DayBasedHorizontalScalingScheduleDetails extends HorizontalScalingScheduleDetails {
    ...
    public static class Builder {
        ...
        public DayBasedHorizontalScalingScheduleDetails build() {
            DayBasedHorizontalScalingScheduleDetails __instance__ =
                    new DayBasedHorizontalScalingScheduleDetails(timeAndHorizontalScalingConfig);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DayBasedHorizontalScalingScheduleDetails o) {
            Builder copiedBuilder =
                    timeAndHorizontalScalingConfig(o.getTimeAndHorizontalScalingConfig());
