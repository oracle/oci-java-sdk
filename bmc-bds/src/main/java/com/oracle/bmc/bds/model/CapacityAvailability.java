...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CapacityAvailability.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CapacityAvailability
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"availabilityStatus", "availableCount"})
    public CapacityAvailability(AvailabilityStatus availabilityStatus, Long availableCount) {
        super();
    ...
    public static class Builder {
        ...
        /**
         * The total number of new cluster nodes that can be created with the specified shape
         * configuration.
         */
        ...
        public CapacityAvailability build() {
            CapacityAvailability model =
                    new CapacityAvailability(this.availabilityStatus, this.availableCount);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CapacityAvailability model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CapacityAvailability(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CapacityAvailability)) {
            return false;
        }

        CapacityAvailability other = (CapacityAvailability) o;
