...
public final class AddKafkaDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddKafkaDetails model) {
            if (model.wasPropertyExplicitlySet("shape")) {
                this.shape(model.getShape());
            }
            if (model.wasPropertyExplicitlySet("numberOfKafkaNodes")) {
                this.numberOfKafkaNodes(model.getNumberOfKafkaNodes());
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddKafkaDetails)) {
            return false;
        }

        AddKafkaDetails other = (AddKafkaDetails) o;
        return java.util.Objects.equals(this.shape, other.shape)
                && java.util.Objects.equals(this.numberOfKafkaNodes, other.numberOfKafkaNodes)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.numberOfKafkaNodes == null
                                ? 43
                                : this.numberOfKafkaNodes.hashCode());
