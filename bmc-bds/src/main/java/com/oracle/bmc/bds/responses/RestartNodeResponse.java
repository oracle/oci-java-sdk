...
public class RestartNodeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RestartNodeResponse> {
        ...
        public RestartNodeResponse build() {
            return new RestartNodeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestartNodeResponse)) {
            return false;
        }

        RestartNodeResponse other = (RestartNodeResponse) o;
