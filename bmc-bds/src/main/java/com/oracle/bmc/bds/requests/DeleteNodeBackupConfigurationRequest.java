...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/DeleteNodeBackupConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNodeBackupConfigurationRequest.
 */
...
public class DeleteNodeBackupConfigurationRequest
    ...
    public static class Builder
        ...
        public DeleteNodeBackupConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteNodeBackupConfigurationRequest(bdsInstanceId, nodeBackupConfigurationId, opcRequestId, ifMatch);
        }
    }
