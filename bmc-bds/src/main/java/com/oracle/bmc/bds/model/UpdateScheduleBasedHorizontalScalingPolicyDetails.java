...
public final class UpdateScheduleBasedHorizontalScalingPolicyDetails
    ...
    public static class Builder {
        ...
        public UpdateScheduleBasedHorizontalScalingPolicyDetails build() {
            UpdateScheduleBasedHorizontalScalingPolicyDetails __instance__ =
                    new UpdateScheduleBasedHorizontalScalingPolicyDetails(
                            timezone, scheduleDetails);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateScheduleBasedHorizontalScalingPolicyDetails o) {
