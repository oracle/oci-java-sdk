...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/GetBdsApiKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBdsApiKeyRequest.
 */
...
public class GetBdsApiKeyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBdsApiKeyRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetBdsApiKeyRequest o) {
         ...
         */
        public GetBdsApiKeyRequest build() {
            GetBdsApiKeyRequest request = buildWithoutInvocationCallback();
