...
public class ListPatchHistoriesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bds.model.PatchHistorySummary} instances. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListPatchHistoriesResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPatchHistoriesResponse)) {
            return false;
        }

        ListPatchHistoriesResponse other = (ListPatchHistoriesResponse) o;
