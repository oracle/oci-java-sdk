...
public class RenewCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private RenewCertificateResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RenewCertificateResponse> {
         ...
         */
        @Override
        public Builder copy(RenewCertificateResponse o) {
