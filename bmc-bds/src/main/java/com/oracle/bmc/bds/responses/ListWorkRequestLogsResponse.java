...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.bds.model.WorkRequestLogEntry} instances. */
    private java.util.List<com.oracle.bmc.bds.model.WorkRequestLogEntry> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.bds.model.WorkRequestLogEntry> getItems() {
        return items;
    }
    ...
    private ListWorkRequestLogsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.bds.model.WorkRequestLogEntry> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.bds.model.WorkRequestLogEntry> items) {
            this.items = items;
            return this;
        }
