...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/InstallPatchExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use InstallPatchRequest.
 */
...
public class InstallPatchRequest
    ...
    public com.oracle.bmc.bds.model.InstallPatchDetails getBody$() {
        return installPatchDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder installPatchDetails(
                com.oracle.bmc.bds.model.InstallPatchDetails installPatchDetails) {
        ...
        public Builder copy(InstallPatchRequest o) {
            ...
            installPatchDetails(o.getInstallPatchDetails());
        ...
        public InstallPatchRequest build() {
            InstallPatchRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.bds.model.InstallPatchDetails body) {
            installPatchDetails(body);
            return this;
        }
        ...
        public InstallPatchRequest buildWithoutInvocationCallback() {
            ...
            request.installPatchDetails = installPatchDetails;
    ...
    public String toString() {
        ...
        sb.append(",installPatchDetails=").append(String.valueOf(this.installPatchDetails));
    ...
    public boolean equals(Object o) {
        ...
        InstallPatchRequest other = (InstallPatchRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.bdsInstanceId, other.bdsInstanceId)
                && java.util.Objects.equals(this.installPatchDetails, other.installPatchDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.installPatchDetails == null
                                ? 43
                                : this.installPatchDetails.hashCode());
