...
public class GetBdsInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBdsInstanceResponse> {
        ...
        public GetBdsInstanceResponse build() {
            return new GetBdsInstanceResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, bdsInstance);
        }
    }
