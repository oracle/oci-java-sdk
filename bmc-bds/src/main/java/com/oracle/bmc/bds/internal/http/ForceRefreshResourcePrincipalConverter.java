...
public class ForceRefreshResourcePrincipalConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ForceRefreshResourcePrincipalConverter.class);

    public static com.oracle.bmc.bds.requests.ForceRefreshResourcePrincipalRequest interceptRequest(
            com.oracle.bmc.bds.requests.ForceRefreshResourcePrincipalRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getResourcePrincipalConfigurationId()))
                        .path("actions")
                        .path("forceRefreshResourcePrincipal");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.bds.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.bds.responses.ForceRefreshResourcePrincipalResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
