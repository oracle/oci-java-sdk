...
/**
 * The reqeust body when testing a BDS metastore configuration <br>
...
public final class TestBdsMetastoreConfigurationDetails
    ...
    public static class Builder {
        ...
        public TestBdsMetastoreConfigurationDetails build() {
            TestBdsMetastoreConfigurationDetails model =
                    new TestBdsMetastoreConfigurationDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestBdsMetastoreConfigurationDetails)) {
            return false;
        }
