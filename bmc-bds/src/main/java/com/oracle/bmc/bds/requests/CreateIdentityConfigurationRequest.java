...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/CreateIdentityConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIdentityConfigurationRequest.
 */
...
public class CreateIdentityConfigurationRequest
    ...
    public static class Builder
        ...
        public CreateIdentityConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateIdentityConfigurationRequest(bdsInstanceId, createIdentityConfigurationDetails, opcRetryToken, opcRequestId);
        }
    }
