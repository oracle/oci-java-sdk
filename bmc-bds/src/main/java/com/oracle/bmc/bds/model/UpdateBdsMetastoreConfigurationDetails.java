...
/**
 * The request body when updating BDS metastore configuration. <br>
...
public final class UpdateBdsMetastoreConfigurationDetails
    ...
    public static class Builder {
        ...
        /**
         * The ID of BDS Api Key used for Data Catalog metastore integration. Set only if
         * metastore's type is EXTERNAL.
         */
        ...
        public UpdateBdsMetastoreConfigurationDetails build() {
            UpdateBdsMetastoreConfigurationDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBdsMetastoreConfigurationDetails model) {
    ...
    /**
     * The ID of BDS Api Key used for Data Catalog metastore integration. Set only if metastore's
     * type is EXTERNAL.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("bdsApiKeyId")
