...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/bds/ListNodeBackupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNodeBackupsRequest.
 */
...
public class ListNodeBackupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListNodeBackupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNodeBackupsRequest(bdsInstanceId, page, limit, sortBy, sortOrder, nodeHostName, lifecycleState, opcRequestId, displayName);
        }
    }
