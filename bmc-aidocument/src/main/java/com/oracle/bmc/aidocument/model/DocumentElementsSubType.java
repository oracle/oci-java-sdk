...
/**
 * The Document Elements Extraction model sub type <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DocumentElementsSubType.Builder.class)
...
public final class DocumentElementsSubType extends ModelSubType {
    ...
    public static class Builder {
        ...
        public DocumentElementsSubType build() {
            DocumentElementsSubType model = new DocumentElementsSubType(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DocumentElementsSubType model) {
    ...
    @Deprecated
    public DocumentElementsSubType(ModelSubType modelSubType) {
        super();
        this.modelSubType = modelSubType;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DocumentElementsSubType(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentElementsSubType)) {
            return false;
        }

        DocumentElementsSubType other = (DocumentElementsSubType) o;
