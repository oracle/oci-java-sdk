...
public class ModelSubType extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
     ...
     * - {@code PRE_TRAINED_KEY_VALUE_EXTRACTION}
     * - {@code PRE_TRAINED_DOCUMENT_ELEMENTS_EXTRACTION}
     *
     **/
