...
public final class DocumentClassificationLabelMetricsReport
    ...
    public static class Builder {
        ...
        public DocumentClassificationLabelMetricsReport build() {
            DocumentClassificationLabelMetricsReport model =
                    new DocumentClassificationLabelMetricsReport(
                            this.label, this.meanAveragePrecision, this.confidenceEntries);
    ...
    public boolean equals(Object o) {
        ...
        DocumentClassificationLabelMetricsReport other =
                (DocumentClassificationLabelMetricsReport) o;
