...
public final class AnalyzeDocumentDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("ocrData")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", ocrData=").append(String.valueOf(this.ocrData));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.features, other.features)
                ...
                && java.util.Objects.equals(this.ocrData, other.ocrData)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.ocrData == null ? 43 : this.ocrData.hashCode());
