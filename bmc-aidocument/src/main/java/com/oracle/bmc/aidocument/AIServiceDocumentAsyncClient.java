...
import com.oracle.bmc.aidocument.internal.http.*;
...
public class AIServiceDocumentAsyncClient implements AIServiceDocumentAsync {
    /**
    ...
    public static class Builder
        ...
        public AIServiceDocumentAsyncClient build(
            ...
            return new AIServiceDocumentAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<CancelProcessorJobResponse> cancelProcessorJob(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async cancelProcessorJob");
        final CancelProcessorJobRequest interceptedRequest =
                CancelProcessorJobConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CancelProcessorJobConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "AIServiceDocument",
                        "CancelProcessorJob",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CancelProcessorJobResponse>
                transformer =
                        CancelProcessorJobConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<CancelProcessorJobRequest, CancelProcessorJobResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CancelProcessorJobRequest, CancelProcessorJobResponse>,
                        java.util.concurrent.Future<CancelProcessorJobResponse>>
    ...
    public java.util.concurrent.Future<CreateModelResponse> createModel(
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "AIServiceDocument", "CreateModel", ib.getRequestUri().toString(), "");
    ...
    public java.util.concurrent.Future<CreateProcessorJobResponse> createProcessorJob(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async createProcessorJob");
        final CreateProcessorJobRequest interceptedRequest =
                CreateProcessorJobConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateProcessorJobConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "AIServiceDocument",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CreateProcessorJobResponse>
                transformer =
                        CreateProcessorJobConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<CreateProcessorJobRequest, CreateProcessorJobResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateProcessorJobRequest, CreateProcessorJobResponse>,
                        java.util.concurrent.Future<CreateProcessorJobResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateProcessorJobDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<CreateProjectResponse> createProject(
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "AIServiceDocument", "CreateProject", ib.getRequestUri().toString(), "");
    ...
    public java.util.concurrent.Future<GetProcessorJobResponse> getProcessorJob(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async getProcessorJob");
        final GetProcessorJobRequest interceptedRequest =
                GetProcessorJobConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetProcessorJobRequest, GetProcessorJobResponse>,
                        java.util.concurrent.Future<GetProcessorJobResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<PatchModelResponse> patchModel(
            ...
            final com.oracle.bmc.responses.AsyncHandler<PatchModelRequest, PatchModelResponse>
                    handler) {
        LOG.trace("Called async patchModel");
        final PatchModelRequest interceptedRequest = PatchModelConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                PatchModelConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "AIServiceDocument",
                        "PatchModel",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, PatchModelResponse>
                transformer =
                        PatchModelConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<PatchModelRequest, PatchModelResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                PatchModelRequest, PatchModelResponse>,
                        java.util.concurrent.Future<PatchModelResponse>>
                futureSupplier =
                        client.patchFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getPatchModelDetails(),
                                ib,
                                transformer);
