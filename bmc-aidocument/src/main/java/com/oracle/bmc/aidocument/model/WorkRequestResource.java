...
public final class WorkRequestResource
    ...
    public static class Builder {
         ...
         * resource being created, updated, or deleted remains in the IN_PROGRESS state until the
         * work is complete for. At that point, it transitions to CREATED, UPDATED, or DELETED, as
         * appropriate.
         */
    ...
    /**
     * The way in which this resource is affected by the work tracked in the work request. A
     * resource being created, updated, or deleted remains in the IN_PROGRESS state until the work
     * is complete for. At that point, it transitions to CREATED, UPDATED, or DELETED, as
     * appropriate.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("actionType")
