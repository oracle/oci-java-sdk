...
public class PatchModelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private PatchModelResponse(
            ...
            String opcRequestId,
            String etag,
            com.oracle.bmc.aidocument.model.PatchResponseMessage patchResponseMessage) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder patchResponseMessage(
                com.oracle.bmc.aidocument.model.PatchResponseMessage patchResponseMessage) {
            this.patchResponseMessage = patchResponseMessage;
            return this;
        }
        ...
        public Builder copy(PatchModelResponse o) {
            ...
            etag(o.getEtag());
            patchResponseMessage(o.getPatchResponseMessage());
    ...
    public String toString() {
        ...
        sb.append(",patchResponseMessage=").append(String.valueOf(patchResponseMessage));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchModelResponse)) {
            return false;
        }

        PatchModelResponse other = (PatchModelResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcWorkRequestId, other.opcWorkRequestId)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.patchResponseMessage, other.patchResponseMessage);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.patchResponseMessage == null
                                ? 43
                                : this.patchResponseMessage.hashCode());
        return result;
    }
}
