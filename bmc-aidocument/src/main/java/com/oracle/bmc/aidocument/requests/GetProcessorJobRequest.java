...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aidocument/GetProcessorJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetProcessorJobRequest.
 */
...
public class GetProcessorJobRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetProcessorJobRequest, java.lang.Void> {
        ...
        /**
         * Processor job id.
         * @param processorJobId the value to set
        ...
        public Builder copy(GetProcessorJobRequest o) {
            processorJobId(o.getProcessorJobId());
         ...
         *
         * @return instance of GetProcessorJobRequest
         */
        public GetProcessorJobRequest build() {
            GetProcessorJobRequest request = buildWithoutInvocationCallback();
        ...
        public GetProcessorJobRequest buildWithoutInvocationCallback() {
            ...
            request.processorJobId = processorJobId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetProcessorJobRequest(processorJobId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().processorJobId(processorJobId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetProcessorJobRequest other = (GetProcessorJobRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.processorJobId, other.processorJobId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.processorJobId == null ? 43 : this.processorJobId.hashCode());
