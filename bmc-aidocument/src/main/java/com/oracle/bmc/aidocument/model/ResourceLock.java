...
/**
 * Resource locks prevent certain APIs from being called for the resource. A full lock prevents both
 * updating and deleting the resource. A lock delete prevents deleting the resource. <br>
