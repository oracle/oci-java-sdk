...
/**
 * Passport KV model sub type details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PassportKvModelSubTypeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PassportKvModelSubTypeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelSubType"})
    public PassportKvModelSubTypeDetails(ModelSubType modelSubType) {
        super();
    ...
    public static class Builder {
        ...
        public PassportKvModelSubTypeDetails build() {
            PassportKvModelSubTypeDetails model =
                    new PassportKvModelSubTypeDetails(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PassportKvModelSubTypeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PassportKvModelSubTypeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PassportKvModelSubTypeDetails)) {
            return false;
        }

        PassportKvModelSubTypeDetails other = (PassportKvModelSubTypeDetails) o;
