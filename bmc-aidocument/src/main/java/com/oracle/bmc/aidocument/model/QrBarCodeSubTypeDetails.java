...
/**
 * Bar Code / QR Code Document Element Extraction model sub type details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = QrBarCodeSubTypeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class QrBarCodeSubTypeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelSubType"})
    public QrBarCodeSubTypeDetails(ModelSubType modelSubType) {
        super();
    ...
    public static class Builder {
        /**
         * The model sub type for DOCUMENT_ELEMENTS_EXTRACTION. The allowed values are: - {@code
         * QR_BAR_CODE} - {@code SIGNATURE}
         */
        ...
        public QrBarCodeSubTypeDetails build() {
            QrBarCodeSubTypeDetails model = new QrBarCodeSubTypeDetails(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QrBarCodeSubTypeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("QrBarCodeSubTypeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof QrBarCodeSubTypeDetails)) {
            return false;
        }

        QrBarCodeSubTypeDetails other = (QrBarCodeSubTypeDetails) o;
