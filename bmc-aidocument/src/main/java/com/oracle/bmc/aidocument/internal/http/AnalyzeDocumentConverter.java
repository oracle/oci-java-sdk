...
public class AnalyzeDocumentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AnalyzeDocumentConverter.class);

    public static com.oracle.bmc.aidocument.requests.AnalyzeDocumentRequest interceptRequest(
            com.oracle.bmc.aidocument.requests.AnalyzeDocumentRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getAnalyzeDocumentDetails(), "analyzeDocumentDetails is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20221109").path("actions").path("analyzeDocument");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.aidocument.responses.AnalyzeDocumentResponse>() {
                            @Override
                            public com.oracle.bmc.aidocument.responses.AnalyzeDocumentResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.aidocument.responses.AnalyzeDocumentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.aidocument.responses.AnalyzeDocumentResponse.Builder
                                        builder =
