...
/**
 * Receipt KV model sub type details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ReceiptKvModelSubTypeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ReceiptKvModelSubTypeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelSubType"})
    public ReceiptKvModelSubTypeDetails(ModelSubType modelSubType) {
        super();
    ...
    public static class Builder {
        ...
        public ReceiptKvModelSubTypeDetails build() {
            ReceiptKvModelSubTypeDetails model =
                    new ReceiptKvModelSubTypeDetails(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReceiptKvModelSubTypeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ReceiptKvModelSubTypeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReceiptKvModelSubTypeDetails)) {
            return false;
        }

        ReceiptKvModelSubTypeDetails other = (ReceiptKvModelSubTypeDetails) o;
