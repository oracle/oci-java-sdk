...
/**
 * Invoice KV model sub type details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InvoiceKvModelSubTypeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class InvoiceKvModelSubTypeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelSubType"})
    public InvoiceKvModelSubTypeDetails(ModelSubType modelSubType) {
        super();
    ...
    public static class Builder {
        ...
        public InvoiceKvModelSubTypeDetails build() {
            InvoiceKvModelSubTypeDetails model =
                    new InvoiceKvModelSubTypeDetails(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvoiceKvModelSubTypeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InvoiceKvModelSubTypeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvoiceKvModelSubTypeDetails)) {
            return false;
        }

        InvoiceKvModelSubTypeDetails other = (InvoiceKvModelSubTypeDetails) o;
