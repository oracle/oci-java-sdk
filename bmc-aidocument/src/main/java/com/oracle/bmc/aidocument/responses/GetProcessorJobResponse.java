...
public class GetProcessorJobResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetProcessorJobResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetProcessorJobResponse> {
         ...
         */
        @Override
        public Builder copy(GetProcessorJobResponse o) {
         ...
         */
        @Override
        public GetProcessorJobResponse build() {
            return new GetProcessorJobResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, processorJob);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetProcessorJobResponse)) {
            return false;
        }

        GetProcessorJobResponse other = (GetProcessorJobResponse) o;
