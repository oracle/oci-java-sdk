...
/**
 * Driving licence KV model sub type details <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DrivingLicenseKvModelSubTypeDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DrivingLicenseKvModelSubTypeDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"modelSubType"})
    public DrivingLicenseKvModelSubTypeDetails(ModelSubType modelSubType) {
        super();
    ...
    public static class Builder {
        ...
        public DrivingLicenseKvModelSubTypeDetails build() {
            DrivingLicenseKvModelSubTypeDetails model =
                    new DrivingLicenseKvModelSubTypeDetails(this.modelSubType);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DrivingLicenseKvModelSubTypeDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DrivingLicenseKvModelSubTypeDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrivingLicenseKvModelSubTypeDetails)) {
            return false;
        }

        DrivingLicenseKvModelSubTypeDetails other = (DrivingLicenseKvModelSubTypeDetails) o;
