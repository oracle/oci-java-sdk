...
public interface AIServiceDocumentAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CancelProcessorJobResponse> cancelProcessorJob(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<CreateProcessorJobResponse> createProcessorJob(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetProcessorJobResponse> getProcessorJob(
            GetProcessorJobRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetProcessorJobRequest, GetProcessorJobResponse>
                    handler);
