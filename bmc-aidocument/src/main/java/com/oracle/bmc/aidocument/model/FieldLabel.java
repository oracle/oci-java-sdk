...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = FieldLabel.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class FieldLabel extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "confidence"})
    public FieldLabel(String name, Float confidence) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public FieldLabel build() {
            FieldLabel model = new FieldLabel(this.name, this.confidence);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FieldLabel model) {
