...
public final class Retriers {
    ...
    public static InputStream wrapInputStreamForRetry(InputStream body) {
        ...
        } else if (body instanceof com.oracle.bmc.io.DuplicatableInputStream) {
            LOG.debug("Wrapping FileInputStream in a DuplicatableKeepOpenInputStream");
            wrappedStream = new com.oracle.bmc.io.internal.DuplicatableKeepOpenInputStream(body);
        } else {
            LOG.debug("Wrapping FileInputStream in a KeepOpenInputStream");
