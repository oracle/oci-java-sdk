 ...
 * These are the items which are contained with the response received from a list operation (e.g. by
 * calling <b>getItems()</b> method on the response object). This iterable will handle calling the
 * service to retrieve more results when required.
 *
