...
public class Waiters {
    ...
    /**
     * The default OCI polling waiter that will be used. Configured using {@link
     * #DEFAULT_POLLING_TERMINATION_STRATEGY} and {@link #DEFAULT_POLLING_DELAY_STRATEGY}.
     */
    ...
    /**
     * Creates a new waiter using the given strategies. If any of the args are null, the default
     * strategy listed in this class will be used.
     *
     * @param terminationStrategy The termination strategy.
