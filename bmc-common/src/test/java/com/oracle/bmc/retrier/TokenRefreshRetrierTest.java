...
public class TokenRefreshRetrierTest {
    ...
    /**
     * Verifies that by default, the TokenRefreshRetrier will perform up to 2 retries before failing with 401 error.
     */
    @Test
    ...
    /**
     * Ensures that setting the system property 'oci.javasdk.token.refresh.enabled' to false disables
     * the TokenRefreshRetrier from performing any additional retries after the initial 401 failure.
     */
    @Test
    ...
    /**
     * Verifies that by default, the TokenRefreshRetrier will perform up to 4 retries before failing with Processing Exception.
     */
    @Test
    ...
    /**
     * Ensures that setting the system property 'oci.javasdk.token.refresh.enabled' to false disables
     * the TokenRefreshRetrier from performing any additional retries after the initial Processing exception.
     */
    @Test
