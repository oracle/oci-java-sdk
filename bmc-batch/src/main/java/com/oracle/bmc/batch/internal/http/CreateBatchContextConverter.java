...
public class CreateBatchContextConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateBatchContextConverter.class);

    public static com.oracle.bmc.batch.requests.CreateBatchContextRequest interceptRequest(
            com.oracle.bmc.batch.requests.CreateBatchContextRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20251031").path("batchContexts");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.batch.responses.CreateBatchContextResponse>() {
                            @Override
                            public com.oracle.bmc.batch.responses.CreateBatchContextResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.batch.responses.CreateBatchContextResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.batch.responses.CreateBatchContextResponse.Builder
                                        builder =
                                ...
                                builder.batchContext(response.getItem());
