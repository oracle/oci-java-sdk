...
/**
 * Fleet configuration of the batch context. <br>
...
public class CreateFleetDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected CreateFleetDetails() {
        super();
    }
