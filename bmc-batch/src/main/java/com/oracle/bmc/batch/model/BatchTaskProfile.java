...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BatchTaskProfile.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchTaskProfile
    ...
    public static class Builder {
        ...
        /**
         * The date and time the batch task profile was created, in the format defined by [RFC
        ...
        /**
         * The date and time the batch task profile was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        public BatchTaskProfile build() {
            BatchTaskProfile model =
                    new BatchTaskProfile(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchTaskProfile model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchTaskProfile)) {
            return false;
        }

        BatchTaskProfile other = (BatchTaskProfile) o;
