...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/ListBatchTasksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBatchTasksRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251031")
public class ListBatchTasksRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListBatchTasksRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListBatchTasksRequest o) {
        ...
        /**
         * Build the instance of ListBatchTasksRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListBatchTasksRequest
         */
        public ListBatchTasksRequest build() {
            ListBatchTasksRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListBatchTasksRequest
         */
        public ListBatchTasksRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBatchTasksRequest)) {
            return false;
        }

        ListBatchTasksRequest other = (ListBatchTasksRequest) o;
