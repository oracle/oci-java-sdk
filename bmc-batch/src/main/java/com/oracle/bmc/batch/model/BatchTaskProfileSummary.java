...
/**
 * Summary information about a batch task profile. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BatchTaskProfileSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchTaskProfileSummary
    ...
    public BatchTaskProfileSummary(
            String id,
    ...
    public static class Builder {
        ...
        private BatchTaskProfile.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(BatchTaskProfile.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public BatchTaskProfileSummary build() {
            BatchTaskProfileSummary model =
                    new BatchTaskProfileSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchTaskProfileSummary model) {
    ...
    /** The current state of the batch task profile. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final BatchTaskProfile.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public BatchTaskProfile.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BatchTaskProfileSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchTaskProfileSummary)) {
            return false;
        }

        BatchTaskProfileSummary other = (BatchTaskProfileSummary) o;
