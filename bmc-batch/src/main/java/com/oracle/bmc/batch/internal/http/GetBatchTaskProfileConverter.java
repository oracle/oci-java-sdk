...
public class GetBatchTaskProfileConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetBatchTaskProfileConverter.class);

    public static com.oracle.bmc.batch.requests.GetBatchTaskProfileRequest interceptRequest(
            com.oracle.bmc.batch.requests.GetBatchTaskProfileRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.batch.responses.GetBatchTaskProfileResponse>() {
                            @Override
                            public com.oracle.bmc.batch.responses.GetBatchTaskProfileResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.batch.responses.GetBatchTaskProfileResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.batch.responses.GetBatchTaskProfileResponse.Builder
                                        builder =
                                                com.oracle.bmc.batch.responses
                                                        .GetBatchTaskProfileResponse.builder()
