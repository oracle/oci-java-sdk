...
/**
 * The amount of memory available for container instances that use this shape. <br>
...
public final class ShapeMemoryOptions
    ...
    public static class Builder {
        ...
        /**
         * For a flexible shape, the maximum amount of memory per OCPU available for this shape
         * (GB).
         */
