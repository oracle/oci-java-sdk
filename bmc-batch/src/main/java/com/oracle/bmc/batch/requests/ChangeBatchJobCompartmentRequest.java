...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/ChangeBatchJobCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeBatchJobCompartmentRequest.
 */
...
public class ChangeBatchJobCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeBatchJobCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeBatchJobCompartmentRequest(batchJobId, changeBatchJobCompartmentDetails, ifMatch, opcRequestId);
        }
    }
