...
/**
 * A batch task environment resource defines the software that is used to execute tasks. It mainly
 * contains a URL to a container image along with other configurations that are needed by the image.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BatchTaskEnvironment.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchTaskEnvironment
    ...
    public static class Builder {
        ...
        public BatchTaskEnvironment build() {
            BatchTaskEnvironment model =
                    new BatchTaskEnvironment(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchTaskEnvironment model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BatchTaskEnvironment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchTaskEnvironment)) {
            return false;
        }

        BatchTaskEnvironment other = (BatchTaskEnvironment) o;
