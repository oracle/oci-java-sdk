 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBatchJobsRequest.
 */
...
public class ListBatchJobsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListBatchJobsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListBatchJobsRequest(compartmentId, lifecycleState, displayName, id,
            // batchJobPoolId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
