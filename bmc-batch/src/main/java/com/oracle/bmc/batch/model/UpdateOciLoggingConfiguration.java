...
/**
 * The data to update logging configuration for OCI Logging service. <br>
...
public final class UpdateOciLoggingConfiguration extends UpdateLoggingConfigurationDetails {
    ...
    public static class Builder {
        /**
         * A switch to enable or disable propagation of job and task events to the customer's logs
         * in OCI logging service.
         */
    ...
    /**
     * A switch to enable or disable propagation of job and task events to the customer's logs in
     * OCI logging service.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isJobTaskEventsPropagationEnabled")
