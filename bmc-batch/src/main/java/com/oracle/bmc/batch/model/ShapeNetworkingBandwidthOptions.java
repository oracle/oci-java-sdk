...
public final class ShapeNetworkingBandwidthOptions
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"defaultPerOcpuInGbps", "maxInGbps", "minInGbps"})
    public ShapeNetworkingBandwidthOptions(
            Float defaultPerOcpuInGbps, Float maxInGbps, Float minInGbps) {
        super();
        ...
        public ShapeNetworkingBandwidthOptions build() {
            ShapeNetworkingBandwidthOptions model =
                    new ShapeNetworkingBandwidthOptions(
                            this.defaultPerOcpuInGbps, this.maxInGbps, this.minInGbps);
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.defaultPerOcpuInGbps, other.defaultPerOcpuInGbps)
                && java.util.Objects.equals(this.maxInGbps, other.maxInGbps)
                && java.util.Objects.equals(this.minInGbps, other.minInGbps)
                && super.equals(other);
    }
