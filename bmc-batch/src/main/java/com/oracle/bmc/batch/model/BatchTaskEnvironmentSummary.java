...
/**
 * Summary information about a batch task environment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BatchTaskEnvironmentSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchTaskEnvironmentSummary
    ...
    public BatchTaskEnvironmentSummary(
            String id,
            ...
            BatchTaskEnvironment.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private BatchTaskEnvironment.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(BatchTaskEnvironment.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
            this.__explicitlySet__.add("lifecycleState");
            return this;
        }
        /**
         * The date and time the batch task environment was created, in the format defined by [RFC
        ...
        /**
         * The date and time the batch task environment was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        public BatchTaskEnvironmentSummary build() {
            BatchTaskEnvironmentSummary model =
                    new BatchTaskEnvironmentSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchTaskEnvironmentSummary model) {
    ...
    /** The current state of the batch task environment. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final BatchTaskEnvironment.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public BatchTaskEnvironment.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BatchTaskEnvironmentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BatchTaskEnvironmentSummary)) {
            return false;
        }

        BatchTaskEnvironmentSummary other = (BatchTaskEnvironmentSummary) o;
