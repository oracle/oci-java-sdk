...
public final class ServiceManagedGpuFleet extends Fleet {
    ...
    public static class Builder {
        ...
        /**
         * A message that describes the current state of the service managed GPU fleet configuration
         * in more detail.
         */
    ...
    /**
     * A message that describes the current state of the service managed GPU fleet configuration in
     * more detail.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("details")
