...
public class ChangeBatchTaskProfileCompartmentConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ChangeBatchTaskProfileCompartmentConverter.class);

    public static com.oracle.bmc.batch.requests.ChangeBatchTaskProfileCompartmentRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.batch.requests.ChangeBatchTaskProfileCompartmentRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.batch.responses
                                            .ChangeBatchTaskProfileCompartmentResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.batch.responses.ChangeBatchTaskProfileCompartmentResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.batch.responses
                                                .ChangeBatchTaskProfileCompartmentResponse.Builder
                                        builder =
                                                com.oracle.bmc.batch.responses
                                                        .ChangeBatchTaskProfileCompartmentResponse
                                                        .builder()
