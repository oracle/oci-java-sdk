...
/**
 * A batch job represents the execution unit that is invoked on a batch's pools of compute
 * resources. A job is composed of one or more tasks, which are the executable commands.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BatchJob.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BatchJob extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BatchJob model) {
