...
public class BatchComputingPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchContextShapes operation. This iterable
    ...
    public Iterable<ListBatchContextShapesResponse> listBatchContextShapesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchContextShapesRequest.Builder, ListBatchContextShapesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchContextShapeSummary} objects
     * contained in responses from the listBatchContextShapes operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchContextShapeSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchContexts operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListBatchContextsResponse> listBatchContextsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchContextsRequest.Builder, ListBatchContextsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchContextSummary} objects
     * contained in responses from the listBatchContexts operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchContextSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.BatchContextSummary> listBatchContextsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListBatchContextsRequest.Builder, ListBatchContextsRequest,
                ListBatchContextsResponse, com.oracle.bmc.batch.model.BatchContextSummary>(
                new java.util.function.Supplier<ListBatchContextsRequest.Builder>() {
                    @Override
                    public ListBatchContextsRequest.Builder get() {
                        return ListBatchContextsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchJobPools operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListBatchJobPoolsResponse> listBatchJobPoolsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchJobPoolsRequest.Builder, ListBatchJobPoolsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchJobPoolSummary} objects
     * contained in responses from the listBatchJobPools operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchJobPoolSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.BatchJobPoolSummary> listBatchJobPoolsRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListBatchJobPoolsRequest.Builder, ListBatchJobPoolsRequest,
                ListBatchJobPoolsResponse, com.oracle.bmc.batch.model.BatchJobPoolSummary>(
                new java.util.function.Supplier<ListBatchJobPoolsRequest.Builder>() {
                    @Override
                    public ListBatchJobPoolsRequest.Builder get() {
                        return ListBatchJobPoolsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchJobTasks operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListBatchJobTasksResponse> listBatchJobTasksResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchJobTasksRequest.Builder, ListBatchJobTasksRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchTaskSummary} objects
     * contained in responses from the listBatchJobTasks operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchTaskSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.BatchTaskSummary> listBatchJobTasksRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListBatchJobTasksRequest.Builder, ListBatchJobTasksRequest,
                ListBatchJobTasksResponse, com.oracle.bmc.batch.model.BatchTaskSummary>(
                new java.util.function.Supplier<ListBatchJobTasksRequest.Builder>() {
                    @Override
                    public ListBatchJobTasksRequest.Builder get() {
                        return ListBatchJobTasksRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchJobs operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchJobSummary} objects
     * contained in responses from the listBatchJobs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchJobSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchTaskEnvironments operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListBatchTaskEnvironmentsResponse> listBatchTaskEnvironmentsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchTaskEnvironmentsRequest.Builder, ListBatchTaskEnvironmentsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchTaskEnvironmentSummary} objects
     * contained in responses from the listBatchTaskEnvironments operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchTaskEnvironmentSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchTaskProfiles operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListBatchTaskProfilesResponse> listBatchTaskProfilesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListBatchTaskProfilesRequest.Builder, ListBatchTaskProfilesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchTaskProfileSummary} objects
     * contained in responses from the listBatchTaskProfiles operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchTaskProfileSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.BatchTaskProfileSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListBatchTaskProfilesRequest.Builder, ListBatchTaskProfilesRequest,
                ListBatchTaskProfilesResponse, com.oracle.bmc.batch.model.BatchTaskProfileSummary>(
                new java.util.function.Supplier<ListBatchTaskProfilesRequest.Builder>() {
                    @Override
                    public ListBatchTaskProfilesRequest.Builder get() {
                        return ListBatchTaskProfilesRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listBatchTasks operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.BatchTaskSummary} objects
     * contained in responses from the listBatchTasks operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.BatchTaskSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.WorkRequestError} objects
     * contained in responses from the listWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestErrorsRequest.Builder, ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse, com.oracle.bmc.batch.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.WorkRequestLogEntry} objects
     * contained in responses from the listWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.batch.model.WorkRequestLogEntry>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestLogsRequest.Builder, ListWorkRequestLogsRequest,
                ListWorkRequestLogsResponse, com.oracle.bmc.batch.model.WorkRequestLogEntry>(
                new java.util.function.Supplier<ListWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListWorkRequestLogsRequest.Builder get() {
                        return ListWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.batch.model.WorkRequestSummary} objects
     * contained in responses from the listWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.batch.model.WorkRequestSummary} objects
     * contained in responses received from the service.
     */
