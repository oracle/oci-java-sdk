...
/**
 * Execution details for a compute task. <br>
...
public final class ComputeTaskExecutionDetails extends BatchTaskExecutionDetails {
    ...
    public static class Builder {
        ...
        /**
         * The date and time when the lifecycleState was changed to Waiting, and it is waiting for
         * its dependencies to run, in the format defined by [RFC
        ...
        /**
         * The date and time when the lifecycleState was changed to Waiting, and it is queued to be
         * executed, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).
        ...
        /**
         * The date and time when the lifecycleState was changed to In_Progress, in the format
         * defined by [RFC 3339](https://tools.ietf.org/html/rfc3339). Example: {@code
        ...
        /**
         * The date and time when the lifecycleState changed to Succeeded, or Failed, in the format
         * defined by [RFC 3339](https://tools.ietf.org/html/rfc3339). Example: {@code
         * 2016-08-25T21:10:29.600Z}
         */
        ...
        /**
         * The terminal lifecycle state of the task for this execution. Valid values are: SUCCEEDED,
         * NEEDS_ATTENTION, CANCELED, or FAILED.
         */
        ...
        /**
         * List of error messages related to this task execution. Be aware that the maximum number
         * of items returned may change in the future.
         */
    ...
    /**
     * The date and time when the lifecycleState was changed to Waiting, and it is waiting for its
     * dependencies to run, in the format defined by [RFC
     * 3339](https://tools.ietf.org/html/rfc3339). Example: {@code 2016-08-25T21:10:29.600Z}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeTransitionedToWaitingDependencies")
    ...
    /**
     * The date and time when the lifecycleState was changed to Waiting, and it is queued to be
     * executed, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339). Example:
    ...
    /**
     * The date and time when the lifecycleState was changed to In_Progress, in the format defined
     * by [RFC 3339](https://tools.ietf.org/html/rfc3339). Example: {@code 2016-08-25T21:10:29.600Z}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeStarted")
    ...
    /**
     * List of error messages related to this task execution. Be aware that the maximum number of
     * items returned may change in the future.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("errors")
