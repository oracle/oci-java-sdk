...
public final class Vnic extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id", "sourceIps"})
    public Vnic(String id, java.util.List<String> sourceIps) {
        super();
        this.id = id;
    ...
    public static class Builder {
         ...
         * private endpoint's VNIC, which resides in the customer's VCN.
         */
        ...
        /**
         * A list of private IP addresses (in the customer's VCN) that represent access points for
         * the service.
         */
        ...
        public Vnic build() {
            Vnic model = new Vnic(this.id, this.sourceIps);
    ...
    /**
     * A list of private IP addresses (in the customer's VCN) that represent access points for the
     * service.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sourceIps")
