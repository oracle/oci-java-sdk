...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/DeleteBatchTaskEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteBatchTaskEnvironmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251031")
public class DeleteBatchTaskEnvironmentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteBatchTaskEnvironmentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteBatchTaskEnvironmentRequest o) {
        ...
        /**
         * Build the instance of DeleteBatchTaskEnvironmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteBatchTaskEnvironmentRequest
         */
        public DeleteBatchTaskEnvironmentRequest build() {
            DeleteBatchTaskEnvironmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteBatchTaskEnvironmentRequest
         */
        public DeleteBatchTaskEnvironmentRequest buildWithoutInvocationCallback() {
            DeleteBatchTaskEnvironmentRequest request = new DeleteBatchTaskEnvironmentRequest();
            request.batchTaskEnvironmentId = batchTaskEnvironmentId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteBatchTaskEnvironmentRequest(batchTaskEnvironmentId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBatchTaskEnvironmentRequest)) {
            return false;
        }

        DeleteBatchTaskEnvironmentRequest other = (DeleteBatchTaskEnvironmentRequest) o;
