...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateComputeTaskDetails.Builder.class)
...
public final class CreateComputeTaskDetails extends CreateBatchTaskDetails {
    ...
    public static class Builder {
        ...
        public CreateComputeTaskDetails build() {
            CreateComputeTaskDetails model =
                    new CreateComputeTaskDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateComputeTaskDetails model) {
    ...
    @Deprecated
    public CreateComputeTaskDetails(
            String name,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateComputeTaskDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateComputeTaskDetails)) {
            return false;
        }

        CreateComputeTaskDetails other = (CreateComputeTaskDetails) o;
