...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/ListWorkRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestsRequest.
 */
...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.batch.model.OperationStatus status;

    /**
     * A filter to return only the resources that match the given lifecycle state.
     */
    public com.oracle.bmc.batch.model.OperationStatus getStatus() {
        return status;
    }
    /**
     ...
     *
     */
    private com.oracle.bmc.batch.model.WorkRequestSortBy sortBy;

    /**
     * The field to sort by. Only one sort order may be provided. Default order for {@code timeAccepted} is descending.
     *
     */
    public com.oracle.bmc.batch.model.WorkRequestSortBy getSortBy() {
        return sortBy;
    }
    ...
    public static class Builder
         ...
         * A filter to return only the resources that match the given lifecycle state.
         */
        private com.oracle.bmc.batch.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.batch.model.OperationStatus status) {
            this.status = status;
            return this;
        }
         ...
         *
         */
        private com.oracle.bmc.batch.model.WorkRequestSortBy sortBy = null;
         ...
         * @return this builder instance
         */
        public Builder sortBy(com.oracle.bmc.batch.model.WorkRequestSortBy sortBy) {
            this.sortBy = sortBy;
            return this;
        }
