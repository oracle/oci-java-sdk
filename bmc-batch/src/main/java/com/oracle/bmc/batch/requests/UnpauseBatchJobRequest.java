...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/UnpauseBatchJobExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UnpauseBatchJobRequest.
 */
...
public class UnpauseBatchJobRequest
    ...
    public static class Builder
        ...
        public UnpauseBatchJobRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UnpauseBatchJobRequest(batchJobId, unpauseBatchJobDetails, ifMatch, opcRequestId);
        }
    }
