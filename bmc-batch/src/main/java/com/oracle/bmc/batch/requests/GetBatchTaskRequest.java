...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/batch/GetBatchTaskExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBatchTaskRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20251031")
public class GetBatchTaskRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBatchTaskRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetBatchTaskRequest o) {
        ...
        /**
         * Build the instance of GetBatchTaskRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetBatchTaskRequest
         */
        public GetBatchTaskRequest build() {
            GetBatchTaskRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBatchTaskRequest
         */
        public GetBatchTaskRequest buildWithoutInvocationCallback() {
            GetBatchTaskRequest request = new GetBatchTaskRequest();
            request.batchJobId = batchJobId;
            request.taskName = taskName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetBatchTaskRequest(batchJobId, taskName, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().batchJobId(batchJobId).taskName(taskName).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBatchTaskRequest)) {
            return false;
        }

        GetBatchTaskRequest other = (GetBatchTaskRequest) o;
