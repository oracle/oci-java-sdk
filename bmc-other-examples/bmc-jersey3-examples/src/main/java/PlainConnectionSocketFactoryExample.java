...
public class PlainConnectionSocketFactoryExample {
    public static void main(String[] args) throws Exception {
        ...
        final Identity directPlaintextClient = createPlaintextClient(provider);

        // The normal configuration fails closed. This catch preserves the previous automatic
        // fallback only when the application explicitly chooses plaintext after SSL initialization
        // fails.
        final Identity fallbackPlaintextClient = createClientWithPlaintextFallback(provider);
    }
