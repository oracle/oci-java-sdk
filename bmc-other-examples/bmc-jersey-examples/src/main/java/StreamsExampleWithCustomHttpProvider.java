 ...
 *
 * It also uses the <code>httpProvider</code> method to set a custom HTTP provider (that in this example,
 * however, just wraps the {@link JerseyHttpProvider}).
 */
public class StreamsExampleWithCustomHttpProvider {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamClient streamClient = StreamClient.builder().stream(stream)
                .httpProvider(new HttpProviderWrapper())
                .build(provider);
    ...
    public static class HttpProviderWrapper implements HttpProvider {
        @Override
