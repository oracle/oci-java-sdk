    ...
    public static void main(String[] args) throws Exception {
        ...
        ObjectStorageClient objectStorageClient = ObjectStorageClient
                ...
                .clientConfigurator(builder -> {
                    ...
                    builder.property(JerseyClientProperties.APACHE_IDLE_CONNECTION_MONITOR_THREAD_WAIT_TIME_SECONDS, 30);
                    // configure wait time for idle connection monitor thread
                    builder.property(JerseyClientProperties.APACHE_IDLE_CONNECTION_MONITOR_THREAD_IDLE_TIMEOUT_SECONDS, 15);
