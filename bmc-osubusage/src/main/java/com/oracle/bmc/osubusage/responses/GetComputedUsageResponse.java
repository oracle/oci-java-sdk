...
public class GetComputedUsageResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.osubusage.model.ComputedUsage getComputedUsage() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder computedUsage(com.oracle.bmc.osubusage.model.ComputedUsage computedUsage) {
            this.computedUsage = computedUsage;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",computedUsage=").append(String.valueOf(computedUsage));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetComputedUsageResponse)) {
            return false;
        }

        GetComputedUsageResponse other = (GetComputedUsageResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.computedUsage, other.computedUsage);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.computedUsage == null ? 43 : this.computedUsage.hashCode());
        return result;
    }
}
