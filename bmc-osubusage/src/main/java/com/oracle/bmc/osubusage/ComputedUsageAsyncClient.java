...
public class ComputedUsageAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
    ...
    private ComputedUsageAsyncClient(
    ...
    public static class Builder
        ...
        public ComputedUsageAsyncClient build(
                @javax.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ComputedUsageAsyncClient(this, authenticationDetailsProvider);
        }
    }
