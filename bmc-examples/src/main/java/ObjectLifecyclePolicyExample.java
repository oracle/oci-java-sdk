...
public class ObjectLifecyclePolicyExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final CreateBucketDetails createBucketDetails = CreateBucketDetails.builder()
        ...
        try {
            ...
            if (bmce.getStatusCode() == 409) {
                System.out.println("-----");
                System.out.println("Got 409 " + bmce.getServiceCode() + " attempting to create the bucket.");
                System.out.println("Either the bucket already exists, or we don't have permissions to create bucket.");
                System.out.println("Attempting to proceed with object lifecycle policy creation.");
                System.out.println("If object lifecycle policy creation fails with 404 NotFound/NotAuthorized, then ");
                System.out.println("that means you have a permissions error and aren't authorized to use the bucket.");
                System.out.println("-----");
            } else {
                throw bmce;
            }
        ...
        final ObjectLifecycleRule objectLifecycleRule = ObjectLifecycleRule.builder()
                ...
                .build();
        final PutObjectLifecyclePolicyDetails objectLifecyclePolicyDetails = PutObjectLifecyclePolicyDetails.builder()
                ...
                .build();
        final PutObjectLifecyclePolicyRequest putObjectLifecyclePolicyRequest = PutObjectLifecyclePolicyRequest
                .builder()
                .namespaceName(namespaceName)
        ...
        try {
            ...
            if (bmce.getStatusCode() == 404) {
                System.out.println("-----");
                System.out.println("Your user does not have permissions to create new object lifecycle policies.");
                System.out.println("Please see the object lifecycle policy authorization documentation:");
                System.out.println("https://docs.cloud.oracle.com/iaas/Content/Object/Tasks/usinglifecyclepolicies.htm");
                System.out.println("-----");
                System.exit(-1);
            } else {
                throw bmce;
        ...
        final GetObjectLifecyclePolicyRequest getObjectLifecyclePolicyRequest = GetObjectLifecyclePolicyRequest
                .builder()
                .namespaceName(namespaceName)
                .bucketName(bucketName)
                .build();
        ...
        final DeleteObjectLifecyclePolicyRequest deleteObjectLifecyclePolicyRequest = DeleteObjectLifecyclePolicyRequest
                .builder()
                .namespaceName(namespaceName)
                .bucketName(bucketName)
                .build();
