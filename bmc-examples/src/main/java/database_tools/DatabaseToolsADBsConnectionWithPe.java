 ...
 */
public class DatabaseToolsADBsConnectionWithPe {
     ...
     * <ul>
     *   <li>The OCID of an ADB-S created following the instructions from: https://docs.oracle.com/en-us/iaas/Content/Database/Concepts/adbsprivateaccess.htm</li>
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            throw new IllegalArgumentException(
                    "This example expects 4 arguments: 1. ADB-S OCID 2. Vault OCID 3. DB User name 4. DB Password");
        }
