...
public class RealtimeSpeechWhisperExampleClient implements RealtimeSpeechClientListener {
    ...
    private static final String MODEL_TYPE = "WHISPER";
    ...
    RealtimeSpeechWhisperExampleClient(String endpoint, String compartmentId) {
    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            startSession(
                    new RealtimeSpeechWhisperExampleClient(endpoint, compartmentId),
                    configFile,
                    client);
    ...
    public static void startSession(
            RealtimeSpeechWhisperExampleClient realtimeTestClient,
