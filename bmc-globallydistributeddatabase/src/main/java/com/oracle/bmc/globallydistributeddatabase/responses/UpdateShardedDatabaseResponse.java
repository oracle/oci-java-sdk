...
public class UpdateShardedDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateShardedDatabaseResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateShardedDatabaseResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateShardedDatabaseResponse o) {
         ...
         */
        @Override
        public UpdateShardedDatabaseResponse build() {
            return new UpdateShardedDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateShardedDatabaseResponse)) {
            return false;
        }

        UpdateShardedDatabaseResponse other = (UpdateShardedDatabaseResponse) o;
