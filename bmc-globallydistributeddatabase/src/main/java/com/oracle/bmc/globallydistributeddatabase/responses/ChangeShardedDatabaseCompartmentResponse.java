...
public class ChangeShardedDatabaseCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeShardedDatabaseCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeShardedDatabaseCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeShardedDatabaseCompartmentResponse build() {
            return new ChangeShardedDatabaseCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeShardedDatabaseCompartmentResponse)) {
            return false;
        }

        ChangeShardedDatabaseCompartmentResponse other =
                (ChangeShardedDatabaseCompartmentResponse) o;
