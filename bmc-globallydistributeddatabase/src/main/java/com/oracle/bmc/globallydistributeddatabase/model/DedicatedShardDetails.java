...
/**
 * Details of ATP-D based shard. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DedicatedShardDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DedicatedShardDetails
    ...
    public static class Builder {
        ...
        /**
         * The time the ssl certificate associated with shard expires. An RFC3339 formatted datetime
         * string
         */
        ...
        public DedicatedShardDetails build() {
            DedicatedShardDetails model =
                    new DedicatedShardDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DedicatedShardDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DedicatedShardDetails)) {
            return false;
        }

        DedicatedShardDetails other = (DedicatedShardDetails) o;
