...
/**
 * Details to create and download an Oracle Sharded Database wallet. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GenerateWalletDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GenerateWalletDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"password"})
    public GenerateWalletDetails(String password) {
        super();
    ...
    public static class Builder {
        ...
        public GenerateWalletDetails build() {
            GenerateWalletDetails model = new GenerateWalletDetails(this.password);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GenerateWalletDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GenerateWalletDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateWalletDetails)) {
            return false;
        }

        GenerateWalletDetails other = (GenerateWalletDetails) o;
