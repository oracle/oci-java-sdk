...
public class ValidateNetworkResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ValidateNetworkResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ValidateNetworkResponse> {
         ...
         */
        @Override
        public Builder copy(ValidateNetworkResponse o) {
         ...
         */
        @Override
        public ValidateNetworkResponse build() {
            return new ValidateNetworkResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateNetworkResponse)) {
            return false;
        }

        ValidateNetworkResponse other = (ValidateNetworkResponse) o;
