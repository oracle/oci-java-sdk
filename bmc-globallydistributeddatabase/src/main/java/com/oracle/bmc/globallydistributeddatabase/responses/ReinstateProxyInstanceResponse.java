...
public class ReinstateProxyInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ReinstateProxyInstanceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ReinstateProxyInstanceResponse o) {
         ...
         */
        @Override
        public ReinstateProxyInstanceResponse build() {
            return new ReinstateProxyInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReinstateProxyInstanceResponse)) {
            return false;
        }

        ReinstateProxyInstanceResponse other = (ReinstateProxyInstanceResponse) o;
