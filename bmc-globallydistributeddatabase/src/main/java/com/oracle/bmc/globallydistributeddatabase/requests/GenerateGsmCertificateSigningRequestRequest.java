...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/GenerateGsmCertificateSigningRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GenerateGsmCertificateSigningRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230301")
public class GenerateGsmCertificateSigningRequestRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GenerateGsmCertificateSigningRequestRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GenerateGsmCertificateSigningRequestRequest o) {
        ...
        /**
         * Build the instance of GenerateGsmCertificateSigningRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GenerateGsmCertificateSigningRequestRequest
         */
        public GenerateGsmCertificateSigningRequestRequest build() {
            GenerateGsmCertificateSigningRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GenerateGsmCertificateSigningRequestRequest
         */
        public GenerateGsmCertificateSigningRequestRequest buildWithoutInvocationCallback() {
            GenerateGsmCertificateSigningRequestRequest request =
                    new GenerateGsmCertificateSigningRequestRequest();
            ...
            return request;
            // new GenerateGsmCertificateSigningRequestRequest(shardedDatabaseId, opcRequestId, ifMatch, opcRetryToken, caBundleId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateGsmCertificateSigningRequestRequest)) {
            return false;
        }

        GenerateGsmCertificateSigningRequestRequest other =
                (GenerateGsmCertificateSigningRequestRequest) o;
