...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/GetShardedDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetShardedDatabaseRequest.
 */
...
public class GetShardedDatabaseRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetShardedDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetShardedDatabaseRequest(shardedDatabaseId, metadata, ifNoneMatch, opcRequestId);
        }
    }
