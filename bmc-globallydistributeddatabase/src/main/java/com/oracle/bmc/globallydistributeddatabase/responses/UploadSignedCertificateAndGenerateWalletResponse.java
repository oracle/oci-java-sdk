...
public class UploadSignedCertificateAndGenerateWalletResponse
    ...
    private UploadSignedCertificateAndGenerateWalletResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UploadSignedCertificateAndGenerateWalletResponse o) {
         ...
         */
        @Override
        public UploadSignedCertificateAndGenerateWalletResponse build() {
            return new UploadSignedCertificateAndGenerateWalletResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadSignedCertificateAndGenerateWalletResponse)) {
            return false;
        }

        UploadSignedCertificateAndGenerateWalletResponse other =
                (UploadSignedCertificateAndGenerateWalletResponse) o;
