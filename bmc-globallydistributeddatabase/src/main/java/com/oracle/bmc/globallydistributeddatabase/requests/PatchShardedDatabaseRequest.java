...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/PatchShardedDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchShardedDatabaseRequest.
 */
...
public class PatchShardedDatabaseRequest
    ...
    public static class Builder
        ...
        public PatchShardedDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchShardedDatabaseRequest(shardedDatabaseId, patchShardedDatabaseDetails, ifMatch, opcRequestId);
        }
    }
