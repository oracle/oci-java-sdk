...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/ChangePrivateEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangePrivateEndpointCompartmentRequest.
 */
...
public class ChangePrivateEndpointCompartmentRequest
     ...
     */
    private com.oracle.bmc.globallydistributeddatabase.model.ChangePrivateEndpointCompartmentDetails
            changePrivateEndpointCompartmentDetails;

    /**
     * Request to move the private endpoint to a different compartment.
     */
    public com.oracle.bmc.globallydistributeddatabase.model.ChangePrivateEndpointCompartmentDetails
    ...
    public static class Builder
        ...
        public ChangePrivateEndpointCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangePrivateEndpointCompartmentRequest(changePrivateEndpointCompartmentDetails, privateEndpointId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
