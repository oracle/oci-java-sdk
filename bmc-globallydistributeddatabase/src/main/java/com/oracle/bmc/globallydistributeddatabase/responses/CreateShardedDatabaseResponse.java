...
public class CreateShardedDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateShardedDatabaseResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateShardedDatabaseResponse> {
         ...
         */
        @Override
        public Builder copy(CreateShardedDatabaseResponse o) {
         ...
         */
        @Override
        public CreateShardedDatabaseResponse build() {
            return new CreateShardedDatabaseResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateShardedDatabaseResponse)) {
            return false;
        }

        CreateShardedDatabaseResponse other = (CreateShardedDatabaseResponse) o;
