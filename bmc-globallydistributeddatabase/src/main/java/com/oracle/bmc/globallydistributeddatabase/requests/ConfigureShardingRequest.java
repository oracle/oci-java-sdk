...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/ConfigureShardingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ConfigureShardingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230301")
public class ConfigureShardingRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ConfigureShardingRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ConfigureShardingRequest o) {
         ...
         *
         * @return instance of ConfigureShardingRequest
         */
        public ConfigureShardingRequest build() {
            ConfigureShardingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ConfigureShardingRequest
         */
        public ConfigureShardingRequest buildWithoutInvocationCallback() {
            ConfigureShardingRequest request = new ConfigureShardingRequest();
            ...
            return request;
            // new ConfigureShardingRequest(shardedDatabaseId, isRebalanceRequired, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureShardingRequest)) {
            return false;
        }

        ConfigureShardingRequest other = (ConfigureShardingRequest) o;
