...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/globallydistributeddatabase/UpdatePrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePrivateEndpointRequest.
 */
...
public class UpdatePrivateEndpointRequest
    ...
    public static class Builder
        ...
        public UpdatePrivateEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePrivateEndpointRequest(privateEndpointId, updatePrivateEndpointDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
