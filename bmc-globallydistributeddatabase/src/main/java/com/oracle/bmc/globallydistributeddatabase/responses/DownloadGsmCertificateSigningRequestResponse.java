...
public class DownloadGsmCertificateSigningRequestResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadGsmCertificateSigningRequestResponse)) {
            return false;
        }

        DownloadGsmCertificateSigningRequestResponse other =
                (DownloadGsmCertificateSigningRequestResponse) o;
