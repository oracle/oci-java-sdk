...
/**
 * Request details for creation of ATP-Dedicated based sharded database. <br>
...
public final class CreateDedicatedShardedDatabase extends CreateShardedDatabaseDetails {
    ...
    public static class Builder {
        ...
        /**
         * The character set for the new shard database being created. Use database api
         * ListAutonomousDatabaseCharacterSets to get the list of allowed character set for
         * autonomous dedicated database. See documentation:
        ...
        /**
         * The national character set for the new shard database being created. Use database api
         * ListAutonomousDatabaseCharacterSets to get the list of allowed national character set for
         * autonomous dedicated database. See documentation:
         * https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/AutonomousDatabaseCharacterSets/ListAutonomousDatabaseCharacterSets
         */
        ...
        /**
         * Unique name prefix for the sharded databases. Only alpha-numeric values are allowed.
         * First character has to be a letter followed by any combination of letter and number.
         */
    ...
    /**
     * The character set for the new shard database being created. Use database api
     * ListAutonomousDatabaseCharacterSets to get the list of allowed character set for autonomous
     * dedicated database. See documentation:
     * https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/AutonomousDatabaseCharacterSets/ListAutonomousDatabaseCharacterSets
     */
    @com.fasterxml.jackson.annotation.JsonProperty("characterSet")
    ...
    /**
     * Unique name prefix for the sharded databases. Only alpha-numeric values are allowed. First
     * character has to be a letter followed by any combination of letter and number.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("prefix")
