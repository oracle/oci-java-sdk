...
public class ConfigureShardingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ConfigureShardingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ConfigureShardingResponse> {
         ...
         */
        @Override
        public Builder copy(ConfigureShardingResponse o) {
         ...
         */
        @Override
        public ConfigureShardingResponse build() {
            return new ConfigureShardingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureShardingResponse)) {
            return false;
        }

        ConfigureShardingResponse other = (ConfigureShardingResponse) o;
