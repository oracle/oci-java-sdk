...
public final class ConnectionString extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"allConnectionStrings"})
    public ConnectionString(java.util.Map<String, String> allConnectionStrings) {
        super();
