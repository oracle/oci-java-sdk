...
public final class ConfigureShardedDatabaseGsmsDetails
    ...
    public static class Builder {
        ...
        public ConfigureShardedDatabaseGsmsDetails build() {
            ConfigureShardedDatabaseGsmsDetails model =
                    new ConfigureShardedDatabaseGsmsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConfigureShardedDatabaseGsmsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureShardedDatabaseGsmsDetails)) {
            return false;
        }

        ConfigureShardedDatabaseGsmsDetails other = (ConfigureShardedDatabaseGsmsDetails) o;
