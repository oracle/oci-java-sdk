...
public class GenerateWalletConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GenerateWalletConverter.class);

    public static com.oracle.bmc.globallydistributeddatabase.requests.GenerateWalletRequest
            interceptRequest(
                    com.oracle.bmc.globallydistributeddatabase.requests.GenerateWalletRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.globallydistributeddatabase.requests.GenerateWalletRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notBlank(request.getShardedDatabaseId(), "shardedDatabaseId must not be blank");
        Validate.notNull(request.getGenerateWalletDetails(), "generateWalletDetails is required");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.globallydistributeddatabase.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.globallydistributeddatabase.responses.GenerateWalletResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.globallydistributeddatabase.responses
                                                .GenerateWalletResponse.Builder
                                        builder =
                                                com.oracle.bmc.globallydistributeddatabase.responses
                                                        .GenerateWalletResponse.builder()
