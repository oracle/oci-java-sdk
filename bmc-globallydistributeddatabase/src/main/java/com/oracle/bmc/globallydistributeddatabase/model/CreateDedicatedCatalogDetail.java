...
/**
 * Details required for creation of ATP-D based catalog. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDedicatedCatalogDetail.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateDedicatedCatalogDetail
    ...
    public CreateDedicatedCatalogDetail(
    ...
    public static class Builder {
        ...
        public CreateDedicatedCatalogDetail build() {
            CreateDedicatedCatalogDetail model =
                    new CreateDedicatedCatalogDetail(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDedicatedCatalogDetail model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDedicatedCatalogDetail)) {
            return false;
        }

        CreateDedicatedCatalogDetail other = (CreateDedicatedCatalogDetail) o;
