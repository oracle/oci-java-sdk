...
public class ListShardedDatabasesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListShardedDatabasesConverter.class);

    public static com.oracle.bmc.globallydistributeddatabase.requests.ListShardedDatabasesRequest
            interceptRequest(
                    com.oracle.bmc.globallydistributeddatabase.requests.ListShardedDatabasesRequest
                            request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.globallydistributeddatabase.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.globallydistributeddatabase.responses.ListShardedDatabasesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.globallydistributeddatabase
                                                                .model.ShardedDatabaseCollection>>
                                        responseFn;
                                ...
                                com.oracle.bmc.globallydistributeddatabase.responses
                                                .ListShardedDatabasesResponse.Builder
                                        builder =
                                                com.oracle.bmc.globallydistributeddatabase.responses
                                                        .ListShardedDatabasesResponse.builder()
                                ...
                                builder.shardedDatabaseCollection(response.getItem());
