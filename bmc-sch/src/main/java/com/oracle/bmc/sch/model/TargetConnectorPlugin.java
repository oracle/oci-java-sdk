...
/**
 * A connector plugin for sending data to a target service. For configuration instructions, see
 * [Creating a
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TargetConnectorPlugin.Builder.class)
...
public final class TargetConnectorPlugin extends ConnectorPlugin {
    ...
    public static class Builder {
        ...
        public TargetConnectorPlugin build() {
            TargetConnectorPlugin model =
                    new TargetConnectorPlugin(
                            this.name,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetConnectorPlugin model) {
    ...
    public TargetConnectorPlugin(
            ...
            String displayName,
            String schema) {
        super(name, timeCreated, estimatedThroughput, lifecycleState, displayName, schema);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetConnectorPlugin)) {
            return false;
        }

        TargetConnectorPlugin other = (TargetConnectorPlugin) o;
