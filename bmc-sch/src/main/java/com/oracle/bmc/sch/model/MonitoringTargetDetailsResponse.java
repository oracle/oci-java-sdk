...
/**
 * The destination metric for data transferred from the source. For configuration instructions, see
 * [Creating a
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MonitoringTargetDetailsResponse.Builder.class)
...
public final class MonitoringTargetDetailsResponse extends TargetDetailsResponse {
    ...
    public static class Builder {
         ...
         * compartment containing the metric.
         */
        ...
        public MonitoringTargetDetailsResponse build() {
            MonitoringTargetDetailsResponse model =
                    new MonitoringTargetDetailsResponse(
                            this.privateEndpointMetadata,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MonitoringTargetDetailsResponse model) {
    ...
    @Deprecated
    public MonitoringTargetDetailsResponse(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MonitoringTargetDetailsResponse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoringTargetDetailsResponse)) {
            return false;
        }

        MonitoringTargetDetailsResponse other = (MonitoringTargetDetailsResponse) o;
