...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/sch/UpdateServiceConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateServiceConnectorRequest.
 */
...
public class UpdateServiceConnectorRequest
    ...
    public static class Builder
        ...
        public UpdateServiceConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateServiceConnectorRequest(serviceConnectorId, updateServiceConnectorDetails, ifMatch, opcRequestId);
        }
    }
