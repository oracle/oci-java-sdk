 ...
 * Monitoring
 * Source](https://docs.oracle.com/iaas/Content/connector-hub/create-service-connector-monitoring-source.htm).
 * <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MonitoringSourceDetailsResponse.Builder.class)
...
public final class MonitoringSourceDetailsResponse extends SourceDetailsResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder monitoringSources(java.util.List<MonitoringSource> monitoringSources) {
            this.monitoringSources = monitoringSources;
            this.__explicitlySet__.add("monitoringSources");
            return this;
        }
        ...
        public MonitoringSourceDetailsResponse build() {
            MonitoringSourceDetailsResponse model =
                    new MonitoringSourceDetailsResponse(
                            this.privateEndpointMetadata, this.monitoringSources);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MonitoringSourceDetailsResponse model) {
    ...
    @Deprecated
    public MonitoringSourceDetailsResponse(
            PrivateEndpointMetadata privateEndpointMetadata,
            java.util.List<MonitoringSource> monitoringSources) {
     ...
     * @return the value
     */
    public java.util.List<MonitoringSource> getMonitoringSources() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MonitoringSourceDetailsResponse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoringSourceDetailsResponse)) {
            return false;
        }

        MonitoringSourceDetailsResponse other = (MonitoringSourceDetailsResponse) o;
