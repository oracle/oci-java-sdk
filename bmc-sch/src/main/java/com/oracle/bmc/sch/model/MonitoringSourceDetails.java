...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MonitoringSourceDetails.Builder.class
)
...
public class MonitoringSourceDetails extends SourceDetails {
    ...
    @Deprecated
    public MonitoringSourceDetails(java.util.List<MonitoringSource> monitoringSources) {
        super();
        this.monitoringSources = monitoringSources;
    }
