...
public class FunctionsTargetDetails extends TargetDetails {
    ...
    public static class Builder {
        ...
        public FunctionsTargetDetails build() {
            FunctionsTargetDetails __instance__ = new FunctionsTargetDetails(functionId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FunctionsTargetDetails o) {
