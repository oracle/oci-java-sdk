...
public interface ConnectorPluginsAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetConnectorPluginResponse> getConnectorPlugin(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListConnectorPluginsResponse> listConnectorPlugins(
