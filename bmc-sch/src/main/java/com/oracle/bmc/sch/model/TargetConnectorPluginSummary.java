...
/**
 * Summary information for a connector plugin that sends data to a target service. For configuration
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TargetConnectorPluginSummary.Builder.class)
...
public final class TargetConnectorPluginSummary extends ConnectorPluginSummary {
    ...
    public static class Builder {
        ...
        public TargetConnectorPluginSummary build() {
            TargetConnectorPluginSummary model =
                    new TargetConnectorPluginSummary(
                            this.name,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetConnectorPluginSummary model) {
    ...
    @Deprecated
    public TargetConnectorPluginSummary(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TargetConnectorPluginSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetConnectorPluginSummary)) {
            return false;
        }

        TargetConnectorPluginSummary other = (TargetConnectorPluginSummary) o;
