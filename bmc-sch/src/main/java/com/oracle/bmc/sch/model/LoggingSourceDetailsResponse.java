...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LoggingSourceDetailsResponse.Builder.class)
...
public final class LoggingSourceDetailsResponse extends SourceDetailsResponse {
    ...
    public static class Builder {
        ...
        public LoggingSourceDetailsResponse build() {
            LoggingSourceDetailsResponse model =
                    new LoggingSourceDetailsResponse(this.privateEndpointMetadata, this.logSources);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LoggingSourceDetailsResponse model) {
    ...
    @Deprecated
    public LoggingSourceDetailsResponse(
            PrivateEndpointMetadata privateEndpointMetadata, java.util.List<LogSource> logSources) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LoggingSourceDetailsResponse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoggingSourceDetailsResponse)) {
            return false;
        }

        LoggingSourceDetailsResponse other = (LoggingSourceDetailsResponse) o;
