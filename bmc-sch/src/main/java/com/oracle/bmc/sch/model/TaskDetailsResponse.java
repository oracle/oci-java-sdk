...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "kind",
        defaultImpl = TaskDetailsResponse.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = LogRuleTaskDetailsResponse.class,
            name = "logRule"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = FunctionTaskDetailsResponse.class,
            name = "function")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class TaskDetailsResponse extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"privateEndpointMetadata"})
    protected TaskDetailsResponse(PrivateEndpointMetadata privateEndpointMetadata) {
        super();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskDetailsResponse)) {
            return false;
        }

        TaskDetailsResponse other = (TaskDetailsResponse) o;
