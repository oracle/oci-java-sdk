...
public final class PluginSourceDetails extends SourceDetails {
    ...
    public static class Builder {
         ...
         * names of connector plugins, list the plugin using
         * (ListConnectorPlugin)[#/en/serviceconnectors/latest/ConnectorPluginSummary/ListConnectorPlugins].
         */
         ...
         * using
         * (GetConnectorPlugin)[#/en/serviceconnectors/latest/ConnectorPlugin/GetConnectorPlugin]
     ...
     * of connector plugins, list the plugin using
     * (ListConnectorPlugin)[#/en/serviceconnectors/latest/ConnectorPluginSummary/ListConnectorPlugins].
     */
    @com.fasterxml.jackson.annotation.JsonProperty("pluginName")
     ...
     * selected queue. To find the parameters for a connector plugin, get the plugin using
     * (GetConnectorPlugin)[#/en/serviceconnectors/latest/ConnectorPlugin/GetConnectorPlugin] and
