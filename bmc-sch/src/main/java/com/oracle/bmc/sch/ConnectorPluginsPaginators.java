 ...
 * to any list operations of ConnectorPlugins where multiple pages of data may be fetched.
...
public class ConnectorPluginsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listConnectorPlugins operation. This iterable
    ...
    public Iterable<ListConnectorPluginsResponse> listConnectorPluginsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListConnectorPluginsRequest.Builder, ListConnectorPluginsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.sch.model.ConnectorPluginSummary} objects
     * contained in responses from the listConnectorPlugins operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.sch.model.ConnectorPluginSummary} objects
    ...
    public Iterable<com.oracle.bmc.sch.model.ConnectorPluginSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListConnectorPluginsRequest.Builder, ListConnectorPluginsRequest,
                ListConnectorPluginsResponse, com.oracle.bmc.sch.model.ConnectorPluginSummary>(
                new java.util.function.Supplier<ListConnectorPluginsRequest.Builder>() {
                    @Override
                    public ListConnectorPluginsRequest.Builder get() {
                        return ListConnectorPluginsRequest.builder().copy(request);
