...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LoggingAnalyticsTargetDetailsResponse.Builder.class)
...
public final class LoggingAnalyticsTargetDetailsResponse extends TargetDetailsResponse {
    ...
    public static class Builder {
        ...
        public LoggingAnalyticsTargetDetailsResponse build() {
            LoggingAnalyticsTargetDetailsResponse model =
                    new LoggingAnalyticsTargetDetailsResponse(
                            this.privateEndpointMetadata,
                            this.logGroupId,
                            this.logSourceIdentifier);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LoggingAnalyticsTargetDetailsResponse model) {
    ...
    @Deprecated
    public LoggingAnalyticsTargetDetailsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoggingAnalyticsTargetDetailsResponse)) {
            return false;
        }

        LoggingAnalyticsTargetDetailsResponse other = (LoggingAnalyticsTargetDetailsResponse) o;
