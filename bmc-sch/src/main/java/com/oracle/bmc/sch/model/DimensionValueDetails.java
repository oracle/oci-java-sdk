...
/**
 * Instructions for extracting the value corresponding to the specified dimension key: Either
 * extract the value as-is (static) or derive the value from a path (evaluated). <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "kind",
        defaultImpl = DimensionValueDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = StaticDimensionValue.class,
            name = "static"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = JmesPathDimensionValue.class,
            name = "jmesPath")
})
...
public class DimensionValueDetails
    ...
    protected DimensionValueDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DimensionValueDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DimensionValueDetails)) {
            return false;
        }

        DimensionValueDetails other = (DimensionValueDetails) o;
