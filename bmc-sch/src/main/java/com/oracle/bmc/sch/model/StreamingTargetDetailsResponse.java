...
/**
 * The Streaming target response. Private metadata is included when the target is a stream accessed
 * through a [private
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StreamingTargetDetailsResponse.Builder.class)
...
public final class StreamingTargetDetailsResponse extends TargetDetailsResponse {
    ...
    public static class Builder {
        ...
        public StreamingTargetDetailsResponse build() {
            StreamingTargetDetailsResponse model =
                    new StreamingTargetDetailsResponse(this.privateEndpointMetadata, this.streamId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StreamingTargetDetailsResponse model) {
    ...
    @Deprecated
    public StreamingTargetDetailsResponse(
            PrivateEndpointMetadata privateEndpointMetadata, String streamId) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("StreamingTargetDetailsResponse(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamingTargetDetailsResponse)) {
            return false;
        }

        StreamingTargetDetailsResponse other = (StreamingTargetDetailsResponse) o;
