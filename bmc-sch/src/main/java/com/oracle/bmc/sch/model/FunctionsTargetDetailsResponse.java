...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FunctionsTargetDetailsResponse.Builder.class)
...
public final class FunctionsTargetDetailsResponse extends TargetDetailsResponse {
    ...
    public static class Builder {
        ...
        public FunctionsTargetDetailsResponse build() {
            FunctionsTargetDetailsResponse model =
                    new FunctionsTargetDetailsResponse(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FunctionsTargetDetailsResponse model) {
    ...
    @Deprecated
    public FunctionsTargetDetailsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FunctionsTargetDetailsResponse)) {
            return false;
        }

        FunctionsTargetDetailsResponse other = (FunctionsTargetDetailsResponse) o;
