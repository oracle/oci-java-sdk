 ...
 */
package com.oracle.bmc.modeldeployment.model;
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = InferenceResult.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class InferenceResult extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"data"})
    public InferenceResult(byte[] data) {
        super();
        this.data = data;
    }
    ...
    public static class Builder {
        ...
        public InferenceResult build() {
            InferenceResult model = new InferenceResult(this.data);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InferenceResult model) {
    ...
    public boolean equals(Object o) {
        ...
        InferenceResult other = (InferenceResult) o;
