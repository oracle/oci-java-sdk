...
public interface ModelDeploymentAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<PredictResponse> predict(
            PredictRequest request,
            com.oracle.bmc.responses.AsyncHandler<PredictRequest, PredictResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<PredictWithResponseStreamResponse> predictWithResponseStream(
            PredictWithResponseStreamRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            PredictWithResponseStreamRequest, PredictWithResponseStreamResponse>
                    handler);
}
