...
public class PredictWithResponseStreamConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PredictWithResponseStreamConverter.class);

    public static com.oracle.bmc.modeldeployment.requests.PredictWithResponseStreamRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.modeldeployment.requests.PredictWithResponseStreamRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("predictWithResponseStream");

        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib = target.request();

        ib.accept("application/json", "text/event-stream");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.modeldeployment.responses
                                            .PredictWithResponseStreamResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.modeldeployment.responses.PredictWithResponseStreamResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.modeldeployment.responses
                                                .PredictWithResponseStreamResponse.Builder
                                        builder =
                                                com.oracle.bmc.modeldeployment.responses
                                                        .PredictWithResponseStreamResponse.builder()
