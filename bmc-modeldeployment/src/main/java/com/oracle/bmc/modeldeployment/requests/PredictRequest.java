...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/modeldeployment/PredictExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PredictRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240424")
public class PredictRequest extends com.oracle.bmc.requests.BmcRequest<String> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<PredictRequest, String> {
         ...
         * @return this builder instance
         */
        public Builder copy(PredictRequest o) {
        ...
        /**
         * Build the instance of PredictRequest as configured by this builder
         *
         ...
         *
         * @return instance of PredictRequest
         */
        public PredictRequest build() {
            PredictRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PredictRequest
         */
        public PredictRequest buildWithoutInvocationCallback() {
            PredictRequest request = new PredictRequest();
            request.modelDeploymentId = modelDeploymentId;
            request.requestBody = requestBody;
            request.opcRequestId = opcRequestId;
            return request;
            // new PredictRequest(modelDeploymentId, requestBody, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PredictRequest)) {
            return false;
        }

        PredictRequest other = (PredictRequest) o;
