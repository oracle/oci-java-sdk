...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ShellDeployStageSummary.Builder.class)
...
public final class ShellDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public ShellDeployStageSummary build() {
            ShellDeployStageSummary model =
                    new ShellDeployStageSummary(
                            this.id,
                            this.description,
                            this.displayName,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShellDeployStageSummary model) {
    ...
    @Deprecated
    public ShellDeployStageSummary(
            String id,
            String description,
            String displayName,
            String projectId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ShellDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShellDeployStageSummary)) {
            return false;
        }

        ShellDeployStageSummary other = (ShellDeployStageSummary) o;
