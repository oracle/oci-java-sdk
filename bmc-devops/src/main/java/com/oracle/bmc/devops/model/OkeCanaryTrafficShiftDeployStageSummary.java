...
public final class OkeCanaryTrafficShiftDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public OkeCanaryTrafficShiftDeployStageSummary build() {
            OkeCanaryTrafficShiftDeployStageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeCanaryTrafficShiftDeployStageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeCanaryTrafficShiftDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryTrafficShiftDeployStageSummary)) {
            return false;
        }

        OkeCanaryTrafficShiftDeployStageSummary other = (OkeCanaryTrafficShiftDeployStageSummary) o;
