...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFunctionDeployStageDetails.Builder.class)
...
public final class UpdateFunctionDeployStageDetails extends UpdateDeployStageDetails {
    ...
    @Deprecated
    public UpdateFunctionDeployStageDetails(
            String description,
            String displayName,
            DeployStagePredecessorCollection deployStagePredecessorCollection,
    ...
    public boolean equals(Object o) {
        ...
        UpdateFunctionDeployStageDetails other = (UpdateFunctionDeployStageDetails) o;
