...
public final class CreateComputeInstanceGroupBlueGreenDeployStageDetails
    ...
    public static class Builder {
        ...
        public CreateComputeInstanceGroupBlueGreenDeployStageDetails build() {
            CreateComputeInstanceGroupBlueGreenDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateComputeInstanceGroupBlueGreenDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateComputeInstanceGroupBlueGreenDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateComputeInstanceGroupBlueGreenDeployStageDetails)) {
            return false;
        }

        CreateComputeInstanceGroupBlueGreenDeployStageDetails other =
                (CreateComputeInstanceGroupBlueGreenDeployStageDetails) o;
