...
/**
 * Attributes to filter GitLab events. File filter criteria - Changes only affecting excluded files
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GitlabFilterExclusionAttributes.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GitlabFilterExclusionAttributes
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"fileFilter"})
    public GitlabFilterExclusionAttributes(FileFilter fileFilter) {
        super();
    ...
    public static class Builder {
        ...
        public GitlabFilterExclusionAttributes build() {
            GitlabFilterExclusionAttributes model =
                    new GitlabFilterExclusionAttributes(this.fileFilter);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabFilterExclusionAttributes model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabFilterExclusionAttributes(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabFilterExclusionAttributes)) {
            return false;
        }

        GitlabFilterExclusionAttributes other = (GitlabFilterExclusionAttributes) o;
