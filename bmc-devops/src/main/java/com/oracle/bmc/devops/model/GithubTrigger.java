...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GithubTrigger.Builder.class)
...
public final class GithubTrigger extends Trigger {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GithubTrigger model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GithubTrigger)) {
            return false;
        }

        GithubTrigger other = (GithubTrigger) o;
