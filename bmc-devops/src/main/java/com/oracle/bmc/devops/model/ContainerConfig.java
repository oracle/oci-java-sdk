...
/**
 * Specifies the container configuration. <br>
...
public class ContainerConfig extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public enum ContainerConfigType implements com.oracle.bmc.http.internal.BmcEnum {
