...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.devops.model.WorkRequestCollection getWorkRequestCollection() {
    ...
    private ListWorkRequestsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.devops.model.WorkRequestCollection workRequestCollection) {
