...
/**
 * Specifies list of arguments passed along with the deployment. <br>
...
public final class DeploymentArgumentCollection
    ...
    public static class Builder {
        ...
        public DeploymentArgumentCollection build() {
            DeploymentArgumentCollection model = new DeploymentArgumentCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeploymentArgumentCollection model) {
