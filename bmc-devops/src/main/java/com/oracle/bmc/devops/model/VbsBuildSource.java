...
/**
 * VBS Server Build Source for Build Stage <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VbsBuildSource.Builder.class)
...
public final class VbsBuildSource extends BuildSource {
    ...
    public static class Builder {
        ...
        public VbsBuildSource build() {
            VbsBuildSource model =
                    new VbsBuildSource(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsBuildSource model) {
    ...
    @Deprecated
    public VbsBuildSource(String name, String repositoryUrl, String branch, String connectionId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsBuildSource)) {
            return false;
        }

        VbsBuildSource other = (VbsBuildSource) o;
