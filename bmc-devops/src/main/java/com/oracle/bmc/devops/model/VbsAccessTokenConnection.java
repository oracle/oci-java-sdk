...
/**
 * The properties that define a connection of the type {@code VBS_ACCESS_TOKEN}. This type
 * corresponds to a connection in Visual Builder Studio that is authenticated with a Personal Access
 * Token. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VbsAccessTokenConnection.Builder.class)
...
public final class VbsAccessTokenConnection extends Connection {
    ...
    public static class Builder {
        ...
        public VbsAccessTokenConnection build() {
            VbsAccessTokenConnection model =
                    new VbsAccessTokenConnection(
                            this.id,
                            this.description,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsAccessTokenConnection model) {
    ...
    @Deprecated
    public VbsAccessTokenConnection(
            String id,
            String description,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VbsAccessTokenConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsAccessTokenConnection)) {
            return false;
        }

        VbsAccessTokenConnection other = (VbsAccessTokenConnection) o;
