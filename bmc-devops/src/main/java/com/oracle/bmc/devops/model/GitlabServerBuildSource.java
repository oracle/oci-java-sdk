...
/**
 * GitLab self-hosted Server Build Source for Build Stage <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GitlabServerBuildSource.Builder.class)
...
public final class GitlabServerBuildSource extends BuildSource {
    ...
    public static class Builder {
        ...
        public GitlabServerBuildSource build() {
            GitlabServerBuildSource model =
                    new GitlabServerBuildSource(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabServerBuildSource model) {
    ...
    @Deprecated
    public GitlabServerBuildSource(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabServerBuildSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabServerBuildSource)) {
            return false;
        }

        GitlabServerBuildSource other = (GitlabServerBuildSource) o;
