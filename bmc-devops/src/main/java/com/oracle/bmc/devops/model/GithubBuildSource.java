...
/**
 * GitHub build source for Build stage. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GithubBuildSource.Builder.class)
...
public final class GithubBuildSource extends BuildSource {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GithubBuildSource)) {
            return false;
        }
