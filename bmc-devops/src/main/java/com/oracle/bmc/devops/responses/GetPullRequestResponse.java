...
public class GetPullRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetPullRequestResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPullRequestResponse> {
         ...
         */
        @Override
        public Builder copy(GetPullRequestResponse o) {
         ...
         */
        @Override
        public GetPullRequestResponse build() {
            return new GetPullRequestResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, pullRequest);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPullRequestResponse)) {
            return false;
        }

        GetPullRequestResponse other = (GetPullRequestResponse) o;
