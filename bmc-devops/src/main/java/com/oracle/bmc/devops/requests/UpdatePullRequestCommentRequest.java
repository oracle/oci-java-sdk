...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/UpdatePullRequestCommentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePullRequestCommentRequest.
 */
...
public class UpdatePullRequestCommentRequest
    ...
    public static class Builder
        ...
        public UpdatePullRequestCommentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePullRequestCommentRequest(pullRequestId, commentId, updatePullRequestCommentDetails, ifMatch, opcRequestId);
        }
    }
