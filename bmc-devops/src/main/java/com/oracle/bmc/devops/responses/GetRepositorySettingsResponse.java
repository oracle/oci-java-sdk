...
public class GetRepositorySettingsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetRepositorySettingsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetRepositorySettingsResponse> {
         ...
         */
        @Override
        public Builder copy(GetRepositorySettingsResponse o) {
         ...
         */
        @Override
        public GetRepositorySettingsResponse build() {
            return new GetRepositorySettingsResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, repositorySettings);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRepositorySettingsResponse)) {
            return false;
        }

        GetRepositorySettingsResponse other = (GetRepositorySettingsResponse) o;
