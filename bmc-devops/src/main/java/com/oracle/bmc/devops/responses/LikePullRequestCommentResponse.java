...
public class LikePullRequestCommentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private LikePullRequestCommentResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(LikePullRequestCommentResponse o) {
         ...
         */
        public LikePullRequestCommentResponse build() {
            return new LikePullRequestCommentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LikePullRequestCommentResponse)) {
            return false;
        }

        LikePullRequestCommentResponse other = (LikePullRequestCommentResponse) o;
