...
public class DeployEnvironmentSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected DeployEnvironmentSummary(
            String id,
            String description,
            String displayName,
            String projectId,
    ...
    private final DeployEnvironment.LifecycleState lifecycleState;

    /**
     * The current state of the deployment environment.
     * @return the value
     **/
    public DeployEnvironment.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployEnvironmentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployEnvironmentSummary)) {
            return false;
        }

        DeployEnvironmentSummary other = (DeployEnvironmentSummary) o;
