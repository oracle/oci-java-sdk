...
public final class OkeCanaryTrafficShiftDeployStageExecutionProgress
    ...
    public static class Builder {
        ...
        public OkeCanaryTrafficShiftDeployStageExecutionProgress build() {
            OkeCanaryTrafficShiftDeployStageExecutionProgress model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeCanaryTrafficShiftDeployStageExecutionProgress model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeCanaryTrafficShiftDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryTrafficShiftDeployStageExecutionProgress)) {
            return false;
        }

        OkeCanaryTrafficShiftDeployStageExecutionProgress other =
                (OkeCanaryTrafficShiftDeployStageExecutionProgress) o;
