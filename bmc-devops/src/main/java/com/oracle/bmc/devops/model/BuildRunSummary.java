...
public final class BuildRunSummary {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BuildRunSummary o) {
            Builder copiedBuilder =
                    id(o.getId())
                            ...
                            .buildRunProgressSummary(o.getBuildRunProgressSummary())
