...
public class UpdateDeployEnvironmentDetails
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"description", "displayName", "freeformTags", "definedTags"})
    protected UpdateDeployEnvironmentDetails(
            String description,
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDeployEnvironmentDetails)) {
            return false;
        }

        UpdateDeployEnvironmentDetails other = (UpdateDeployEnvironmentDetails) o;
