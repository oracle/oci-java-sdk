...
/**
 * Specifies the Compute instance group environment filtered by the RQS query expression. <br>
...
public final class ComputeInstanceGroupByQuerySelector extends ComputeInstanceGroupSelector {
    ...
    public static class Builder {
        /**
         * Region identifier referred by the deployment environment. Region identifiers are listed
         * at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm
         */
        ...
        /**
         * Query expression confirming to the OCI Search Language syntax to select compute instances
         * for the group. The language is documented at
    ...
    /**
     * Region identifier referred by the deployment environment. Region identifiers are listed at
    ...
    /**
     * Query expression confirming to the OCI Search Language syntax to select compute instances for
     * the group. The language is documented at
     * https://docs.oracle.com/en-us/iaas/Content/Search/Concepts/querysyntax.htm
     */
    @com.fasterxml.jackson.annotation.JsonProperty("query")
