...
/**
 * Trigger create response specific to GitLab self-hosted server. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GitlabServerTriggerCreateResult.Builder.class)
...
public final class GitlabServerTriggerCreateResult extends TriggerCreateResult {
    ...
    public static class Builder {
        ...
        /**
         * The secret used to validate the incoming trigger call. This is visible only after the
         * resource is created.
         */
        ...
        public GitlabServerTriggerCreateResult build() {
            GitlabServerTriggerCreateResult model =
                    new GitlabServerTriggerCreateResult(
                            this.id,
                            this.displayName,
                            this.description,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabServerTriggerCreateResult model) {
    ...
    @Deprecated
    public GitlabServerTriggerCreateResult(
            String id,
            String displayName,
            String description,
            String projectId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabServerTriggerCreateResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabServerTriggerCreateResult)) {
            return false;
        }

        GitlabServerTriggerCreateResult other = (GitlabServerTriggerCreateResult) o;
