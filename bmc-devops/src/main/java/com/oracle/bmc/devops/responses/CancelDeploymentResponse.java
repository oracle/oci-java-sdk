...
public class CancelDeploymentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelDeploymentResponse> {
         ...
         */
        @Override
        public Builder copy(CancelDeploymentResponse o) {
        ...
        public CancelDeploymentResponse build() {
            return new CancelDeploymentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelDeploymentResponse)) {
            return false;
        }

        CancelDeploymentResponse other = (CancelDeploymentResponse) o;
