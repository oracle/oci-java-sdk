...
public final class UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails
    ...
    public static class Builder {
        ...
        public UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails build() {
            UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails model =
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails)) {
            return false;
        }

        UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails other =
                (UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails) o;
