...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateDeliverArtifactStageDetails.Builder.class
)
...
public final class UpdateDeliverArtifactStageDetails extends UpdateBuildPipelineStageDetails {
    ...
    @Deprecated
    public UpdateDeliverArtifactStageDetails(
            String displayName,
            String description,
            BuildPipelineStagePredecessorCollection buildPipelineStagePredecessorCollection,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDeliverArtifactStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDeliverArtifactStageDetails)) {
            return false;
        }
