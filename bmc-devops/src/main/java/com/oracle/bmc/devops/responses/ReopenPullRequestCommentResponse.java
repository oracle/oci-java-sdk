...
public class ReopenPullRequestCommentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ReopenPullRequestCommentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ReopenPullRequestCommentResponse o) {
         ...
         */
        @Override
        public ReopenPullRequestCommentResponse build() {
            return new ReopenPullRequestCommentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReopenPullRequestCommentResponse)) {
            return false;
        }

        ReopenPullRequestCommentResponse other = (ReopenPullRequestCommentResponse) o;
