...
public class UpdateBuildRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateBuildRunResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBuildRunResponse)) {
            return false;
        }

        UpdateBuildRunResponse other = (UpdateBuildRunResponse) o;
