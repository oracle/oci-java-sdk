...
/**
 * Deployment of a single stage within the pipeline. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SingleDeployStageDeployment.Builder.class)
...
public final class SingleDeployStageDeployment extends Deployment {
    ...
    public static class Builder {
        ...
        public SingleDeployStageDeployment build() {
            SingleDeployStageDeployment model =
                    new SingleDeployStageDeployment(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SingleDeployStageDeployment model) {
            ...
            if (model.wasPropertyExplicitlySet("deploymentExecutionProgress")) {
                this.deploymentExecutionProgress(model.getDeploymentExecutionProgress());
            }
    ...
    @Deprecated
    public SingleDeployStageDeployment(
            DeployPipelineArtifactCollection deployPipelineArtifacts,
            DeployPipelineEnvironmentCollection deployPipelineEnvironments,
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SingleDeployStageDeployment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SingleDeployStageDeployment)) {
            return false;
        }

        SingleDeployStageDeployment other = (SingleDeployStageDeployment) o;
