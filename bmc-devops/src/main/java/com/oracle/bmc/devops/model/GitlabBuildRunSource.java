...
/**
 * Specifies details of build run through GitLab. <br>
...
public final class GitlabBuildRunSource extends BuildRunSource {
    ...
    public static class Builder {
        ...
        public GitlabBuildRunSource build() {
            GitlabBuildRunSource model = new GitlabBuildRunSource(this.triggerId, this.triggerInfo);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabBuildRunSource model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabBuildRunSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabBuildRunSource)) {
            return false;
        }

        GitlabBuildRunSource other = (GitlabBuildRunSource) o;
