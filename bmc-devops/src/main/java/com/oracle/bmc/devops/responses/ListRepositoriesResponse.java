...
public class ListRepositoriesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.devops.model.RepositoryCollection getRepositoryCollection() {
    ...
    private ListRepositoriesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.devops.model.RepositoryCollection repositoryCollection) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListRepositoriesResponse> {
        ...
        public ListRepositoriesResponse build() {
            return new ListRepositoriesResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, repositoryCollection);
        }
    }
