...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ListBuildPipelineStagesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBuildPipelineStagesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210630")
public class ListBuildPipelineStagesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListBuildPipelineStagesRequest, java.lang.Void> {
        ...
        public Builder lifecycleState(
                com.oracle.bmc.devops.model.BuildPipelineStage.LifecycleState lifecycleState) {
         ...
         * @return this builder instance
         */
        public Builder copy(ListBuildPipelineStagesRequest o) {
            id(o.getId());
        ...
        /**
         * Build the instance of ListBuildPipelineStagesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListBuildPipelineStagesRequest
         */
        public ListBuildPipelineStagesRequest build() {
            ListBuildPipelineStagesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListBuildPipelineStagesRequest
         */
        public ListBuildPipelineStagesRequest buildWithoutInvocationCallback() {
            ListBuildPipelineStagesRequest request = new ListBuildPipelineStagesRequest();
            request.id = id;
            ...
            return request;
            // new ListBuildPipelineStagesRequest(id, buildPipelineId, compartmentId, lifecycleState, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBuildPipelineStagesRequest)) {
            return false;
        }

        ListBuildPipelineStagesRequest other = (ListBuildPipelineStagesRequest) o;
