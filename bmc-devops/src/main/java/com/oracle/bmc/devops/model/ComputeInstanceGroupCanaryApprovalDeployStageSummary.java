...
public final class ComputeInstanceGroupCanaryApprovalDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryApprovalDeployStageSummary build() {
            ComputeInstanceGroupCanaryApprovalDeployStageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryApprovalDeployStageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryApprovalDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryApprovalDeployStageSummary)) {
            return false;
        }

        ComputeInstanceGroupCanaryApprovalDeployStageSummary other =
                (ComputeInstanceGroupCanaryApprovalDeployStageSummary) o;
