...
public class GetPullRequestNotificationPreferenceResponse
    ...
    /** The returned {@code PullRequestNotificationPreference} instance. */
    ...
    private GetPullRequestNotificationPreferenceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetPullRequestNotificationPreferenceResponse o) {
         ...
         */
        @Override
        public GetPullRequestNotificationPreferenceResponse build() {
            return new GetPullRequestNotificationPreferenceResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPullRequestNotificationPreferenceResponse)) {
            return false;
        }

        GetPullRequestNotificationPreferenceResponse other =
                (GetPullRequestNotificationPreferenceResponse) o;
