 ...
 * ResolvePullRequestCommentRequest.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210630")
public class ResolvePullRequestCommentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ResolvePullRequestCommentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ResolvePullRequestCommentRequest o) {
        ...
        /**
         * Build the instance of ResolvePullRequestCommentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResolvePullRequestCommentRequest
         */
        public ResolvePullRequestCommentRequest build() {
            ResolvePullRequestCommentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ResolvePullRequestCommentRequest
         */
        public ResolvePullRequestCommentRequest buildWithoutInvocationCallback() {
            ResolvePullRequestCommentRequest request = new ResolvePullRequestCommentRequest();
            request.pullRequestId = pullRequestId;
            request.commentId = commentId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ResolvePullRequestCommentRequest(pullRequestId, commentId, ifMatch,
            // opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResolvePullRequestCommentRequest)) {
            return false;
        }

        ResolvePullRequestCommentRequest other = (ResolvePullRequestCommentRequest) o;
