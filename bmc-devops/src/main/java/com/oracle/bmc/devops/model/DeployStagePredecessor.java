...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeployStagePredecessor.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DeployStagePredecessor
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"id"})
    public DeployStagePredecessor(String id) {
        super();
        this.id = id;
    }
    ...
    public static class Builder {
        ...
        public DeployStagePredecessor build() {
            DeployStagePredecessor model = new DeployStagePredecessor(this.id);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployStagePredecessor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployStagePredecessor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployStagePredecessor)) {
            return false;
        }

        DeployStagePredecessor other = (DeployStagePredecessor) o;
