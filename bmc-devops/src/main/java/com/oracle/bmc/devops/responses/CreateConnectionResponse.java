...
public class CreateConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.devops.model.Connection getConnection() {
        return connection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder connection(com.oracle.bmc.devops.model.Connection connection) {
            this.connection = connection;
            return this;
        }
        ...
        public CreateConnectionResponse build() {
            return new CreateConnectionResponse(
                    __httpStatusCode__, etag, opcWorkRequestId, opcRequestId, location, connection);
        }
    }
