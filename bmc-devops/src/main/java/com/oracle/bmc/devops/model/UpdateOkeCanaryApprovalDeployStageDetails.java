...
public final class UpdateOkeCanaryApprovalDeployStageDetails extends UpdateDeployStageDetails {
    ...
    public static class Builder {
        ...
        public UpdateOkeCanaryApprovalDeployStageDetails build() {
            UpdateOkeCanaryApprovalDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOkeCanaryApprovalDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOkeCanaryApprovalDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOkeCanaryApprovalDeployStageDetails)) {
            return false;
        }

        UpdateOkeCanaryApprovalDeployStageDetails other =
                (UpdateOkeCanaryApprovalDeployStageDetails) o;
