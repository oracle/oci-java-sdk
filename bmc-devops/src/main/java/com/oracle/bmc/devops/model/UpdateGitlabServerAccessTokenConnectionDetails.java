...
public final class UpdateGitlabServerAccessTokenConnectionDetails extends UpdateConnectionDetails {
    ...
    public static class Builder {
        ...
        public UpdateGitlabServerAccessTokenConnectionDetails build() {
            UpdateGitlabServerAccessTokenConnectionDetails __instance__ =
                    new UpdateGitlabServerAccessTokenConnectionDetails(
                            description,
                            displayName,
                            freeformTags,
                            definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateGitlabServerAccessTokenConnectionDetails o) {
    ...
    @Deprecated
    public UpdateGitlabServerAccessTokenConnectionDetails(
            String description,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateGitlabServerAccessTokenConnectionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateGitlabServerAccessTokenConnectionDetails)) {
            return false;
        }

        UpdateGitlabServerAccessTokenConnectionDetails other =
                (UpdateGitlabServerAccessTokenConnectionDetails) o;
