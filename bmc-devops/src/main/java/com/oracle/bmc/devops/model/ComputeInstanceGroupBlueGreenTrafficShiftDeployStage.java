...
public final class ComputeInstanceGroupBlueGreenTrafficShiftDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupBlueGreenTrafficShiftDeployStage build() {
            ComputeInstanceGroupBlueGreenTrafficShiftDeployStage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupBlueGreenTrafficShiftDeployStage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupBlueGreenTrafficShiftDeployStage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupBlueGreenTrafficShiftDeployStage)) {
            return false;
        }

        ComputeInstanceGroupBlueGreenTrafficShiftDeployStage other =
                (ComputeInstanceGroupBlueGreenTrafficShiftDeployStage) o;
