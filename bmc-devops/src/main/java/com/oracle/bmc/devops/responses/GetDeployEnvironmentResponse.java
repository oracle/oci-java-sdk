...
public class GetDeployEnvironmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDeployEnvironmentResponse> {
        ...
        public GetDeployEnvironmentResponse build() {
            return new GetDeployEnvironmentResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, deployEnvironment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDeployEnvironmentResponse)) {
            return false;
        }

        GetDeployEnvironmentResponse other = (GetDeployEnvironmentResponse) o;
