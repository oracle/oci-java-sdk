...
public class GetPullRequestAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetPullRequestAttachmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetPullRequestAttachmentResponse o) {
        ...
        public GetPullRequestAttachmentResponse build() {
            return new GetPullRequestAttachmentResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, pullRequestAttachment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPullRequestAttachmentResponse)) {
            return false;
        }

        GetPullRequestAttachmentResponse other = (GetPullRequestAttachmentResponse) o;
