...
/**
 * Specifies the configuration to access private endpoint. <br>
...
public final class PrivateEndpointChannel extends NetworkChannel {
    ...
    public static class Builder {
        ...
        public PrivateEndpointChannel build() {
            PrivateEndpointChannel model = new PrivateEndpointChannel(this.subnetId, this.nsgIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrivateEndpointChannel model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrivateEndpointChannel)) {
            return false;
        }

        PrivateEndpointChannel other = (PrivateEndpointChannel) o;
