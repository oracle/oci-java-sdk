...
public class InvokeFunctionDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public InvokeFunctionDeployStageSummary build() {
            InvokeFunctionDeployStageSummary __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvokeFunctionDeployStageSummary o) {
