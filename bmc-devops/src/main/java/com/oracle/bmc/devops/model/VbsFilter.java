...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VbsFilter.Builder.class)
...
public final class VbsFilter extends Filter {
    ...
    public static class Builder {
        ...
        private VbsFilterAttributes include;

        public Builder include(VbsFilterAttributes include) {
        ...
        private VbsFilterExclusionAttributes exclude;

        public Builder exclude(VbsFilterExclusionAttributes exclude) {
        ...
        public VbsFilter build() {
            VbsFilter model = new VbsFilter(this.events, this.include, this.exclude);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsFilter model) {
    ...
    public VbsFilter(
            ...
            VbsFilterAttributes include,
            VbsFilterExclusionAttributes exclude) {
        super();
        this.events = events;
        this.include = include;
        this.exclude = exclude;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("include")
    private final VbsFilterAttributes include;

    public VbsFilterAttributes getInclude() {
        return include;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("exclude")
    private final VbsFilterExclusionAttributes exclude;

    public VbsFilterExclusionAttributes getExclude() {
        return exclude;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsFilter)) {
            return false;
        }

        VbsFilter other = (VbsFilter) o;
