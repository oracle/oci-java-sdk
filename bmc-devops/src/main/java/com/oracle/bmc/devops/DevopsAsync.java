...
public interface DevopsAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ReopenPullRequestCommentResponse> reopenPullRequestComment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ResolvePullRequestCommentResponse> resolvePullRequestComment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<TriggerDeploymentDryRunResponse> triggerDeploymentDryRun(
