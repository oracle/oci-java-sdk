...
public final class ExportedVariableCollection
    ...
    public static class Builder {
        ...
        public ExportedVariableCollection build() {
            ExportedVariableCollection model = new ExportedVariableCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExportedVariableCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExportedVariableCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportedVariableCollection)) {
            return false;
        }

        ExportedVariableCollection other = (ExportedVariableCollection) o;
