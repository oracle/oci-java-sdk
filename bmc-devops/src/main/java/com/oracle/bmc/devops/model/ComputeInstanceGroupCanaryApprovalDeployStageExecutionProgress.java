...
public final class ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress build() {
            ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress)) {
            return false;
        }

        ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress other =
                (ComputeInstanceGroupCanaryApprovalDeployStageExecutionProgress) o;
