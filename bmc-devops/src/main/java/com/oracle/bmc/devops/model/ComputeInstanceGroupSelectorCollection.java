...
public final class ComputeInstanceGroupSelectorCollection {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupSelectorCollection build() {
            ComputeInstanceGroupSelectorCollection __instance__ =
                    new ComputeInstanceGroupSelectorCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupSelectorCollection o) {
