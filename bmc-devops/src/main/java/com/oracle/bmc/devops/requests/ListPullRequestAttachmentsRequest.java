...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ListPullRequestAttachmentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPullRequestAttachmentsRequest.
 */
...
public class ListPullRequestAttachmentsRequest
    ...
    public static class Builder
        ...
        public ListPullRequestAttachmentsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPullRequestAttachmentsRequest(pullRequestId, compartmentId, sortOrder, sortBy, fileName, limit, page, opcRequestId);
        }
    }
