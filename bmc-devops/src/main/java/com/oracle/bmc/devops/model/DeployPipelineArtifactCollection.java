...
public class DeployPipelineArtifactCollection {
    ...
    public static class Builder {
        ...
        public DeployPipelineArtifactCollection build() {
            DeployPipelineArtifactCollection __instance__ =
                    new DeployPipelineArtifactCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineArtifactCollection o) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    java.util.List<DeployPipelineArtifact> items;
