...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = RepositorySettings.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class RepositorySettings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RepositorySettings model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RepositorySettings)) {
            return false;
        }
