...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFunctionDeployEnvironmentDetails.Builder.class)
...
public final class UpdateFunctionDeployEnvironmentDetails extends UpdateDeployEnvironmentDetails {
    ...
    @Deprecated
    public UpdateFunctionDeployEnvironmentDetails(
            String description,
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFunctionDeployEnvironmentDetails)) {
            return false;
        }
