...
/**
 * Information about the new build pipeline to be created. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateBuildPipelineDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateBuildPipelineDetails
    ...
    public CreateBuildPipelineDetails(
            String description,
            String displayName,
            String projectId,
    ...
    public static class Builder {
        ...
        public CreateBuildPipelineDetails build() {
            CreateBuildPipelineDetails model =
                    new CreateBuildPipelineDetails(
                            this.description,
                            this.displayName,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateBuildPipelineDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("buildPipelineParameters")) {
                this.buildPipelineParameters(model.getBuildPipelineParameters());
            }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBuildPipelineDetails)) {
            return false;
        }

        CreateBuildPipelineDetails other = (CreateBuildPipelineDetails) o;
