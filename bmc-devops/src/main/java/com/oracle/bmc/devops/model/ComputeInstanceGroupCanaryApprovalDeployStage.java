...
public final class ComputeInstanceGroupCanaryApprovalDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryApprovalDeployStage build() {
            ComputeInstanceGroupCanaryApprovalDeployStage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryApprovalDeployStage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryApprovalDeployStage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryApprovalDeployStage)) {
            return false;
        }

        ComputeInstanceGroupCanaryApprovalDeployStage other =
                (ComputeInstanceGroupCanaryApprovalDeployStage) o;
