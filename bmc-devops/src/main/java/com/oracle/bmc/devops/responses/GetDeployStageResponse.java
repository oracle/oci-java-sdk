...
public class GetDeployStageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDeployStageResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDeployStageResponse> {
         ...
         */
        @Override
        public Builder copy(GetDeployStageResponse o) {
         ...
         */
        @Override
        public GetDeployStageResponse build() {
            return new GetDeployStageResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, deployStage);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDeployStageResponse)) {
            return false;
        }

        GetDeployStageResponse other = (GetDeployStageResponse) o;
