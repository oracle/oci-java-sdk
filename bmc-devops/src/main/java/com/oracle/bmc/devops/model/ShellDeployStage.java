...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ShellDeployStage.Builder.class)
...
public final class ShellDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        public ShellDeployStage build() {
            ShellDeployStage model =
                    new ShellDeployStage(
                            this.id,
                            this.description,
                            this.displayName,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShellDeployStage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShellDeployStage)) {
            return false;
        }

        ShellDeployStage other = (ShellDeployStage) o;
