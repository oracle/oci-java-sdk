...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/CreatePullRequestCommentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePullRequestCommentRequest.
 */
...
public class CreatePullRequestCommentRequest
    ...
    public static class Builder
        ...
        public CreatePullRequestCommentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreatePullRequestCommentRequest(pullRequestId, createPullRequestCommentDetails, opcRetryToken, opcRequestId);
        }
    }
