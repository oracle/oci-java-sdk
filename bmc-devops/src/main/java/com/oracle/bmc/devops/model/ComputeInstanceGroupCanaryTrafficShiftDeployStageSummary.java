...
public final class ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary build() {
            ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary)) {
            return false;
        }

        ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary other =
                (ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary) o;
