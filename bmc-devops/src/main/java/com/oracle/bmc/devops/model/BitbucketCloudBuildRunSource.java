...
/**
 * Specifies details of build run through Bitbucket Cloud. <br>
...
public final class BitbucketCloudBuildRunSource extends BuildRunSource {
    ...
    public static class Builder {
        ...
        public BitbucketCloudBuildRunSource build() {
            BitbucketCloudBuildRunSource model =
                    new BitbucketCloudBuildRunSource(this.triggerId, this.triggerInfo);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketCloudBuildRunSource model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketCloudBuildRunSource)) {
            return false;
        }

        BitbucketCloudBuildRunSource other = (BitbucketCloudBuildRunSource) o;
