...
/**
 * DevOps project groups resources needed to implement the CI/CD workload. DevOps resources include
 * artifacts, pipelines, and environments. <br>
...
public final class Project extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * Time the project was created. Format defined by
        ...
        /**
         * Time the project was updated. Format defined by
         * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
         */
        ...
        public Builder copy(Project model) {
            ...
            if (model.wasPropertyExplicitlySet("notificationConfig")) {
                this.notificationConfig(model.getNotificationConfig());
            }
