...
public class GithubFilter extends Filter {
    ...
    public static class Builder {
        ...
        public GithubFilter build() {
            GithubFilter __instance__ = new GithubFilter(events, include);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GithubFilter o) {
    ...
    @Deprecated
    public GithubFilter(java.util.List<Events> events, GithubFilterAttributes include) {
        super();
        this.events = events;
        this.include = include;
    }
