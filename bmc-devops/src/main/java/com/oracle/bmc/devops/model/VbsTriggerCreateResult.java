...
/**
 * Trigger create response specific to VBS. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VbsTriggerCreateResult.Builder.class)
...
public final class VbsTriggerCreateResult extends TriggerCreateResult {
    ...
    public static class Builder {
        ...
        public VbsTriggerCreateResult build() {
            VbsTriggerCreateResult model =
                    new VbsTriggerCreateResult(
                            this.id,
                            this.displayName,
                            this.description,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsTriggerCreateResult model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VbsTriggerCreateResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsTriggerCreateResult)) {
            return false;
        }

        VbsTriggerCreateResult other = (VbsTriggerCreateResult) o;
