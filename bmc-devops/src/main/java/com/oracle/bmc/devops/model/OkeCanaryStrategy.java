...
/**
 * Specifies the required canary release strategy for OKE deployment. <br>
...
public class OkeCanaryStrategy extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected OkeCanaryStrategy() {
        super();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryStrategy)) {
            return false;
        }

        OkeCanaryStrategy other = (OkeCanaryStrategy) o;
