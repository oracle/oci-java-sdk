...
/**
 * Summary of a full pipeline deployment. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeployPipelineDeploymentSummary.Builder.class)
...
public final class DeployPipelineDeploymentSummary extends DeploymentSummary {
    ...
    public static class Builder {
        ...
        public DeployPipelineDeploymentSummary build() {
            DeployPipelineDeploymentSummary model =
                    new DeployPipelineDeploymentSummary(
                            this.id,
                            this.displayName,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineDeploymentSummary model) {
    ...
    @Deprecated
    public DeployPipelineDeploymentSummary(
            String id,
            String displayName,
            String projectId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployPipelineDeploymentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployPipelineDeploymentSummary)) {
            return false;
        }

        DeployPipelineDeploymentSummary other = (DeployPipelineDeploymentSummary) o;
