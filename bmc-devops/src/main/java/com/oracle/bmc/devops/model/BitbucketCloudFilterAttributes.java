...
/**
 * Attributes to filter Bitbucket Cloud events. <br>
...
public final class BitbucketCloudFilterAttributes
    ...
    public BitbucketCloudFilterAttributes(String headRef, String baseRef, FileFilter fileFilter) {
        super();
    ...
    public static class Builder {
        ...
        public BitbucketCloudFilterAttributes build() {
            BitbucketCloudFilterAttributes model =
                    new BitbucketCloudFilterAttributes(this.headRef, this.baseRef, this.fileFilter);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketCloudFilterAttributes model) {
