...
public final class OkeCanaryApprovalDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public OkeCanaryApprovalDeployStageSummary build() {
            OkeCanaryApprovalDeployStageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeCanaryApprovalDeployStageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeCanaryApprovalDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryApprovalDeployStageSummary)) {
            return false;
        }

        OkeCanaryApprovalDeployStageSummary other = (OkeCanaryApprovalDeployStageSummary) o;
