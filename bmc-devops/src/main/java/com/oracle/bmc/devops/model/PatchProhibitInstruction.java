 ...
 * attempting to create it, avoiding accidental update). It fails if value is provided and the
 * selection includes an item matching it, or if value is not provided and the selection is not
 * empty, but ignores NOT_FOUND exceptions. <br>
...
public final class PatchProhibitInstruction extends PatchInstruction {
    ...
    public static class Builder {
        ...
        /**
         * A value to be compared against each item of the selection. If this value is an object,
         * then it matches any item that would be unaffected by applying this value as a merge
         * operation. Otherwise, it matches any item to which it is equal according to the rules of
         * [JSON Schema](https://tools.ietf.org/html/draft-handrews-json-schema-00#section-4.2.3).
         */
    ...
    /**
     * A value to be compared against each item of the selection. If this value is an object, then
     * it matches any item that would be unaffected by applying this value as a merge operation.
     * Otherwise, it matches any item to which it is equal according to the rules of [JSON
     * Schema](https://tools.ietf.org/html/draft-handrews-json-schema-00#section-4.2.3).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("value")
