...
/**
 * A set of stages forming a directed acyclic graph that defines the build process. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BuildPipeline.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class BuildPipeline extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * Build pipeline display name, which can be renamed and is not necessarily unique. Avoid
        ...
        /**
         * The time the build pipeline was created. Format defined by
        ...
        /**
         * The time the build pipeline was updated. Format defined by
         * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BuildPipeline model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BuildPipeline)) {
            return false;
        }

        BuildPipeline other = (BuildPipeline) o;
