...
/**
 * Specifies the shell stage specific execution details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ShellDeployStageExecutionProgress.Builder.class)
...
public final class ShellDeployStageExecutionProgress extends DeployStageExecutionProgress {
    ...
    public static class Builder {
        ...
        public ShellDeployStageExecutionProgress build() {
            ShellDeployStageExecutionProgress model =
                    new ShellDeployStageExecutionProgress(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ShellDeployStageExecutionProgress model) {
    ...
    @Deprecated
    public ShellDeployStageExecutionProgress(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ShellDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShellDeployStageExecutionProgress)) {
            return false;
        }

        ShellDeployStageExecutionProgress other = (ShellDeployStageExecutionProgress) o;
