...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ListRepositoriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRepositoriesRequest.
 */
...
public class ListRepositoriesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListRepositoriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListRepositoriesRequest(compartmentId, projectId, repositoryId, lifecycleState, name, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
