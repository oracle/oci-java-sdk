...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateDeliverArtifactStageDetails.Builder.class
)
...
public final class CreateDeliverArtifactStageDetails extends CreateBuildPipelineStageDetails {
    ...
    @Deprecated
    public CreateDeliverArtifactStageDetails(
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDeliverArtifactStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDeliverArtifactStageDetails)) {
            return false;
        }
