...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = VbsTrigger.Builder.class)
...
public final class VbsTrigger extends Trigger {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsTrigger model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsTrigger)) {
            return false;
        }

        VbsTrigger other = (VbsTrigger) o;
