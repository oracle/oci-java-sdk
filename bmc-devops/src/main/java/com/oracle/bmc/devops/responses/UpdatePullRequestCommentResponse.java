...
public class UpdatePullRequestCommentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdatePullRequestCommentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdatePullRequestCommentResponse o) {
         ...
         */
        @Override
        public UpdatePullRequestCommentResponse build() {
            return new UpdatePullRequestCommentResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, pullRequestComment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePullRequestCommentResponse)) {
            return false;
        }

        UpdatePullRequestCommentResponse other = (UpdatePullRequestCommentResponse) o;
