...
public final class UpdateWaitDeployStageDetails extends UpdateDeployStageDetails {
    ...
    public static class Builder {
        ...
        public UpdateWaitDeployStageDetails build() {
            UpdateWaitDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateWaitDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateWaitDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateWaitDeployStageDetails)) {
            return false;
        }

        UpdateWaitDeployStageDetails other = (UpdateWaitDeployStageDetails) o;
