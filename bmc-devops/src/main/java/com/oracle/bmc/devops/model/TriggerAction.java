...
/**
 * The trigger action to be performed. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = TriggerAction.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = TriggerBuildPipelineAction.class,
            name = "TRIGGER_BUILD_PIPELINE")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class TriggerAction extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public enum Type implements com.oracle.bmc.http.internal.BmcEnum {
        TriggerBuildPipeline("TRIGGER_BUILD_PIPELINE"),
