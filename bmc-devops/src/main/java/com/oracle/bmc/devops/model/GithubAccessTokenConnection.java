...
/**
 * The properties that define a connection of the type {@code GITHUB_ACCESS_TOKEN}. This type
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GithubAccessTokenConnection.Builder.class)
...
public final class GithubAccessTokenConnection extends Connection {
    ...
    public static class Builder {
        ...
        public GithubAccessTokenConnection build() {
            GithubAccessTokenConnection model =
                    new GithubAccessTokenConnection(
                            this.id,
                            this.description,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GithubAccessTokenConnection model) {
    ...
    @Deprecated
    public GithubAccessTokenConnection(
            String id,
            String description,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GithubAccessTokenConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GithubAccessTokenConnection)) {
            return false;
        }

        GithubAccessTokenConnection other = (GithubAccessTokenConnection) o;
        return java.util.Objects.equals(this.accessToken, other.accessToken) && super.equals(other);
    }
