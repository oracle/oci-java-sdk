...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ListBuildRunsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBuildRunsRequest.
 */
...
public class ListBuildRunsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public Builder lifecycleState(
                com.oracle.bmc.devops.model.BuildRun.LifecycleState lifecycleState) {
         ...
         * @return instance of ListBuildRunsRequest
         */
        public ListBuildRunsRequest buildWithoutInvocationCallback() {
            ListBuildRunsRequest request = new ListBuildRunsRequest();
            request.id = id;
            ...
            return request;
            // new ListBuildRunsRequest(id, buildPipelineId, projectId, compartmentId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBuildRunsRequest)) {
            return false;
        }

        ListBuildRunsRequest other = (ListBuildRunsRequest) o;
