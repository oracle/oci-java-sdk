...
/**
 * Summary of a single stage redeployment. <br>
...
public final class SingleDeployStageRedeploymentSummary extends DeploymentSummary {
    ...
    public static class Builder {
        ...
        public SingleDeployStageRedeploymentSummary build() {
            SingleDeployStageRedeploymentSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SingleDeployStageRedeploymentSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SingleDeployStageRedeploymentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SingleDeployStageRedeploymentSummary)) {
            return false;
        }

        SingleDeployStageRedeploymentSummary other = (SingleDeployStageRedeploymentSummary) o;
