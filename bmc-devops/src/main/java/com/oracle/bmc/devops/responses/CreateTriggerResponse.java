...
public class CreateTriggerResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public Builder copy(CreateTriggerResponse o) {
            ...
            triggerCreateResult(o.getTriggerCreateResult());
    ...
    public String toString() {
        ...
        sb.append(",triggerCreateResult=").append(String.valueOf(triggerCreateResult));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTriggerResponse)) {
            return false;
        }
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.triggerCreateResult, other.triggerCreateResult);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.triggerCreateResult == null
                                ? 43
                                : this.triggerCreateResult.hashCode());
        return result;
    }
}
