...
/**
 * The properties that define a connection of the type {@code BITBUCKET_SERVER_ACCESS_TOKEN}. This
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BitbucketServerAccessTokenConnection.Builder.class)
...
public final class BitbucketServerAccessTokenConnection extends Connection {
    ...
    public static class Builder {
        ...
        public BitbucketServerAccessTokenConnection build() {
            BitbucketServerAccessTokenConnection model =
                    new BitbucketServerAccessTokenConnection(
                            this.id,
                            this.description,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketServerAccessTokenConnection model) {
    ...
    @Deprecated
    public BitbucketServerAccessTokenConnection(
            String id,
            String description,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BitbucketServerAccessTokenConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketServerAccessTokenConnection)) {
            return false;
        }

        BitbucketServerAccessTokenConnection other = (BitbucketServerAccessTokenConnection) o;
