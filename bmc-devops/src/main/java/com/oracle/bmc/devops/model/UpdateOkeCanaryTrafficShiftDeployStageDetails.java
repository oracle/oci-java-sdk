...
public final class UpdateOkeCanaryTrafficShiftDeployStageDetails extends UpdateDeployStageDetails {
    ...
    public static class Builder {
        ...
        public UpdateOkeCanaryTrafficShiftDeployStageDetails build() {
            UpdateOkeCanaryTrafficShiftDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOkeCanaryTrafficShiftDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOkeCanaryTrafficShiftDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOkeCanaryTrafficShiftDeployStageDetails)) {
            return false;
        }

        UpdateOkeCanaryTrafficShiftDeployStageDetails other =
                (UpdateOkeCanaryTrafficShiftDeployStageDetails) o;
