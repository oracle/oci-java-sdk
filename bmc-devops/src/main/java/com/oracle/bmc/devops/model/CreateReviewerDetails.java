...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateReviewerDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateReviewerDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"principalId"})
    public CreateReviewerDetails(String principalId) {
        super();
    ...
    public static class Builder {
        ...
        public CreateReviewerDetails build() {
            CreateReviewerDetails model = new CreateReviewerDetails(this.principalId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateReviewerDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateReviewerDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateReviewerDetails)) {
            return false;
        }

        CreateReviewerDetails other = (CreateReviewerDetails) o;
