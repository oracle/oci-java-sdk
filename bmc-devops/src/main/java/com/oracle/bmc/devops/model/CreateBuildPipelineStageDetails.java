...
/**
 * The information about a new stage. <br>
...
public class CreateBuildPipelineStageDetails
    ...
    protected CreateBuildPipelineStageDetails(
            String displayName,
            String description,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBuildPipelineStageDetails)) {
            return false;
        }

        CreateBuildPipelineStageDetails other = (CreateBuildPipelineStageDetails) o;
