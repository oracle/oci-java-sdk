...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ListPullRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPullRequestsRequest.
 */
...
public class ListPullRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListPullRequestsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListPullRequestsRequest(compartmentId, lifecycleState, lifecycleDetails, repositoryId, displayName, id, createdBy, destinationBranch, sourceBranch, reviewerPrincipalId, sourceRepositoryId, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
