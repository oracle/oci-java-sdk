...
/**
 * Deployment of all the stages in the pipeline. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeployPipelineDeployment.Builder.class)
...
public final class DeployPipelineDeployment extends Deployment {
    ...
    public static class Builder {
        ...
        public DeployPipelineDeployment build() {
            DeployPipelineDeployment model =
                    new DeployPipelineDeployment(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineDeployment model) {
    ...
    @Deprecated
    public DeployPipelineDeployment(
            DeployPipelineArtifactCollection deployPipelineArtifacts,
            DeployPipelineEnvironmentCollection deployPipelineEnvironments,
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployPipelineDeployment(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployPipelineDeployment)) {
            return false;
        }

        DeployPipelineDeployment other = (DeployPipelineDeployment) o;
