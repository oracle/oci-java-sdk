...
public final class ComputeInstanceGroupCanaryDeployStageExecutionProgress
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryDeployStageExecutionProgress build() {
            ComputeInstanceGroupCanaryDeployStageExecutionProgress model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryDeployStageExecutionProgress model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryDeployStageExecutionProgress)) {
            return false;
        }

        ComputeInstanceGroupCanaryDeployStageExecutionProgress other =
                (ComputeInstanceGroupCanaryDeployStageExecutionProgress) o;
