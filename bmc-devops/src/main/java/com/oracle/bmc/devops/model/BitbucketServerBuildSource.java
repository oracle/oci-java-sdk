...
public final class BitbucketServerBuildSource extends BuildSource {
    ...
    public static class Builder {
        ...
        public BitbucketServerBuildSource build() {
            BitbucketServerBuildSource __instance__ =
                    new BitbucketServerBuildSource(name, repositoryUrl, branch, connectionId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketServerBuildSource o) {
