...
/**
 * Bitbucket Server Build Source for Build Stage <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BitbucketServerBuildSource.Builder.class)
...
public final class BitbucketServerBuildSource extends BuildSource {
    ...
    public static class Builder {
        ...
        public BitbucketServerBuildSource build() {
            BitbucketServerBuildSource model =
                    new BitbucketServerBuildSource(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketServerBuildSource model) {
    ...
    @Deprecated
    public BitbucketServerBuildSource(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BitbucketServerBuildSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketServerBuildSource)) {
            return false;
        }

        BitbucketServerBuildSource other = (BitbucketServerBuildSource) o;
