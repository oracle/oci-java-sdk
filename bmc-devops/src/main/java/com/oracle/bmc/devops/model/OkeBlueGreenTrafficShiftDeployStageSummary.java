...
public final class OkeBlueGreenTrafficShiftDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public OkeBlueGreenTrafficShiftDeployStageSummary build() {
            OkeBlueGreenTrafficShiftDeployStageSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeBlueGreenTrafficShiftDeployStageSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeBlueGreenTrafficShiftDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeBlueGreenTrafficShiftDeployStageSummary)) {
            return false;
        }

        OkeBlueGreenTrafficShiftDeployStageSummary other =
                (OkeBlueGreenTrafficShiftDeployStageSummary) o;
