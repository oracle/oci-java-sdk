...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = WaitDeployStageSummary.Builder.class
)
...
public final class WaitDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        private WaitCriteriaSummary waitCriteria;

        public Builder waitCriteria(WaitCriteriaSummary waitCriteria) {
        ...
        public WaitDeployStageSummary build() {
            WaitDeployStageSummary __instance__ =
                    new WaitDeployStageSummary(
                            id,
                            description,
                            displayName,
                            projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WaitDeployStageSummary o) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("waitCriteria")
    private final WaitCriteriaSummary waitCriteria;

    public WaitCriteriaSummary getWaitCriteria() {
        return waitCriteria;
    }
    ...
    public String toString() {
        ...
        sb.append("WaitDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaitDeployStageSummary)) {
            return false;
        }

        WaitDeployStageSummary other = (WaitDeployStageSummary) o;
