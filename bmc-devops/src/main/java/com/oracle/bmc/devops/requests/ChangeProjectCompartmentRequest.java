...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/ChangeProjectCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeProjectCompartmentRequest.
 */
...
public class ChangeProjectCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeProjectCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeProjectCompartmentRequest(projectId, changeProjectCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
