...
public final class AbsoluteWaitCriteria extends WaitCriteria {
    ...
    public static class Builder {
        ...
        public AbsoluteWaitCriteria build() {
            AbsoluteWaitCriteria __instance__ = new AbsoluteWaitCriteria(waitDuration);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AbsoluteWaitCriteria o) {
            Builder copiedBuilder = waitDuration(o.getWaitDuration());
