...
/**
 * Parameter name for which the values will be supplied at the time of deployment. <br>
...
public final class DeployPipelineParameter
    ...
    public static class Builder {
        ...
        public DeployPipelineParameter build() {
            DeployPipelineParameter model =
                    new DeployPipelineParameter(this.name, this.defaultValue, this.description);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineParameter model) {
