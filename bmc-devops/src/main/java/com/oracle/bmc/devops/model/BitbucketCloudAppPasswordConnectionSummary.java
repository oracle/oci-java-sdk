...
/**
 * Summary information for a connection of the type {@code BITBUCKET_CLOUD_APP_PASSWORD}. This type
 * corresponds to a connection in Bitbucket Cloud that is authenticated with a username and app
 * password. <br>
...
public final class BitbucketCloudAppPasswordConnectionSummary extends ConnectionSummary {
    ...
    public static class Builder {
        ...
        public BitbucketCloudAppPasswordConnectionSummary build() {
            BitbucketCloudAppPasswordConnectionSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketCloudAppPasswordConnectionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BitbucketCloudAppPasswordConnectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketCloudAppPasswordConnectionSummary)) {
            return false;
        }

        BitbucketCloudAppPasswordConnectionSummary other =
                (BitbucketCloudAppPasswordConnectionSummary) o;
