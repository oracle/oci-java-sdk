...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = WaitStage.Builder.class)
...
public final class WaitStage extends BuildPipelineStage {
    ...
    public static class Builder {
        ...
        public WaitStage build() {
            WaitStage __instance__ =
                    new WaitStage(
                            id,
                            displayName,
                            description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WaitStage o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WaitStage)) {
            return false;
        }

        WaitStage other = (WaitStage) o;
