...
public final class ComputeInstanceGroupCanaryDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryDeployStage build() {
            ComputeInstanceGroupCanaryDeployStage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryDeployStage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryDeployStage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryDeployStage)) {
            return false;
        }

        ComputeInstanceGroupCanaryDeployStage other = (ComputeInstanceGroupCanaryDeployStage) o;
