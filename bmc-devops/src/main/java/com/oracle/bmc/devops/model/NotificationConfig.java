...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = NotificationConfig.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class NotificationConfig extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"topicId"})
    public NotificationConfig(String topicId) {
        super();
    ...
    public static class Builder {
        ...
        public NotificationConfig build() {
            NotificationConfig model = new NotificationConfig(this.topicId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotificationConfig model) {
