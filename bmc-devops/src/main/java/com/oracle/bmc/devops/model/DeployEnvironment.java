 ...
 * clusters, or Function, where artifacts are deployed. <br>
...
public class DeployEnvironment extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    /**
     * Time the deployment environment was created. Format defined by
    ...
    /**
     * Time the deployment environment was updated. Format defined by
     * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
     */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployEnvironment)) {
            return false;
        }

        DeployEnvironment other = (DeployEnvironment) o;
    ...
    public enum DeployEnvironmentType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(DeployEnvironmentType.class);
