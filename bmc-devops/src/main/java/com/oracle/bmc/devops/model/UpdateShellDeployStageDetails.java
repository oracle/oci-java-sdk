...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateShellDeployStageDetails.Builder.class)
...
public final class UpdateShellDeployStageDetails extends UpdateDeployStageDetails {
    ...
    public static class Builder {
        ...
        public UpdateShellDeployStageDetails build() {
            UpdateShellDeployStageDetails model =
                    new UpdateShellDeployStageDetails(
                            this.description,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateShellDeployStageDetails model) {
    ...
    @Deprecated
    public UpdateShellDeployStageDetails(
            String description,
            String displayName,
            DeployStagePredecessorCollection deployStagePredecessorCollection,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateShellDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateShellDeployStageDetails)) {
            return false;
        }

        UpdateShellDeployStageDetails other = (UpdateShellDeployStageDetails) o;
