...
public final class UpdateApprovalRuleDetails
    ...
    public UpdateApprovalRuleDetails(
            String name,
    ...
    public static class Builder {
        ...
        public UpdateApprovalRuleDetails build() {
            UpdateApprovalRuleDetails model =
                    new UpdateApprovalRuleDetails(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateApprovalRuleDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateApprovalRuleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateApprovalRuleDetails)) {
            return false;
        }

        UpdateApprovalRuleDetails other = (UpdateApprovalRuleDetails) o;
