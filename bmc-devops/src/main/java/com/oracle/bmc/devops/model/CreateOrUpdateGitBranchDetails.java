...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOrUpdateGitBranchDetails.Builder.class)
...
public final class CreateOrUpdateGitBranchDetails extends CreateOrUpdateGitRefDetails {
    ...
    public static class Builder {
        ...
        public CreateOrUpdateGitBranchDetails build() {
            CreateOrUpdateGitBranchDetails model =
                    new CreateOrUpdateGitBranchDetails(this.refName, this.commitId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOrUpdateGitBranchDetails model) {
    ...
    @Deprecated
    public CreateOrUpdateGitBranchDetails(String refName, String commitId) {
        super(refName);
        this.commitId = commitId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOrUpdateGitBranchDetails)) {
            return false;
        }

        CreateOrUpdateGitBranchDetails other = (CreateOrUpdateGitBranchDetails) o;
