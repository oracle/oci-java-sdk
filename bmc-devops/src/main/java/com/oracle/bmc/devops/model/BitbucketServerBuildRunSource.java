...
/**
 * Specifies details of build run through Bitbucket Server. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BitbucketServerBuildRunSource.Builder.class)
...
public final class BitbucketServerBuildRunSource extends BuildRunSource {
    ...
    public static class Builder {
        ...
        public BitbucketServerBuildRunSource build() {
            BitbucketServerBuildRunSource model =
                    new BitbucketServerBuildRunSource(this.triggerId, this.triggerInfo);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketServerBuildRunSource model) {
    ...
    @Deprecated
    public BitbucketServerBuildRunSource(String triggerId, TriggerInfo triggerInfo) {
        super();
        this.triggerId = triggerId;
        this.triggerInfo = triggerInfo;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BitbucketServerBuildRunSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketServerBuildRunSource)) {
            return false;
        }

        BitbucketServerBuildRunSource other = (BitbucketServerBuildRunSource) o;
