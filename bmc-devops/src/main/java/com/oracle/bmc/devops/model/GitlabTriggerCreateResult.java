...
/**
 * Trigger create response specific to GitLab. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GitlabTriggerCreateResult.Builder.class)
...
public final class GitlabTriggerCreateResult extends TriggerCreateResult {
    ...
    public static class Builder {
        ...
        public GitlabTriggerCreateResult build() {
            GitlabTriggerCreateResult model =
                    new GitlabTriggerCreateResult(
                            this.id,
                            this.displayName,
                            this.description,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabTriggerCreateResult model) {
    ...
    @Deprecated
    public GitlabTriggerCreateResult(
            String id,
            String displayName,
            String description,
            String projectId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabTriggerCreateResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabTriggerCreateResult)) {
            return false;
        }

        GitlabTriggerCreateResult other = (GitlabTriggerCreateResult) o;
