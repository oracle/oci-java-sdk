...
public final class DeliverArtifactCollection
    ...
    public static class Builder {
        ...
        public DeliverArtifactCollection build() {
            DeliverArtifactCollection model = new DeliverArtifactCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeliverArtifactCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeliverArtifactCollection)) {
            return false;
        }

        DeliverArtifactCollection other = (DeliverArtifactCollection) o;
