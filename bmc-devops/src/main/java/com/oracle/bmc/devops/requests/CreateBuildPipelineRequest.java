...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/CreateBuildPipelineExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBuildPipelineRequest.
 */
...
public class CreateBuildPipelineRequest
    ...
    public com.oracle.bmc.devops.model.CreateBuildPipelineDetails getBody$() {
        return createBuildPipelineDetails;
    }
    ...
    public static class Builder
         ...
         * Details for the new build pipeline.
         *
         * @param createBuildPipelineDetails the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(CreateBuildPipelineRequest o) {
            createBuildPipelineDetails(o.getCreateBuildPipelineDetails());
         ...
         */
        public CreateBuildPipelineRequest build() {
            CreateBuildPipelineRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.devops.model.CreateBuildPipelineDetails body) {
        ...
        public CreateBuildPipelineRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateBuildPipelineRequest(createBuildPipelineDetails, opcRetryToken,
            // opcRequestId);
        }
    }
