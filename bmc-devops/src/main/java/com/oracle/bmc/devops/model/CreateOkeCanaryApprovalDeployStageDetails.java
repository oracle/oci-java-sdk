...
public final class CreateOkeCanaryApprovalDeployStageDetails extends CreateDeployStageDetails {
    ...
    public static class Builder {
        ...
        public CreateOkeCanaryApprovalDeployStageDetails build() {
            CreateOkeCanaryApprovalDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOkeCanaryApprovalDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateOkeCanaryApprovalDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOkeCanaryApprovalDeployStageDetails)) {
            return false;
        }

        CreateOkeCanaryApprovalDeployStageDetails other =
                (CreateOkeCanaryApprovalDeployStageDetails) o;
