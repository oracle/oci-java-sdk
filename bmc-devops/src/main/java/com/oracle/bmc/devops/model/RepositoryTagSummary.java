...
public final class RepositoryTagSummary extends RepositoryRefSummary {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RepositoryTagSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RepositoryTagSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RepositoryTagSummary)) {
            return false;
        }

        RepositoryTagSummary other = (RepositoryTagSummary) o;
