...
public final class DevopsCodeRepositoryFilterAttributes {
    ...
    public static class Builder {
        ...
        public DevopsCodeRepositoryFilterAttributes build() {
            DevopsCodeRepositoryFilterAttributes __instance__ =
                    new DevopsCodeRepositoryFilterAttributes(headRef);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DevopsCodeRepositoryFilterAttributes o) {
            Builder copiedBuilder = headRef(o.getHeadRef());
