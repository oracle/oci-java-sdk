...
public final class DeployPipelineParameterCollection
    ...
    public static class Builder {
        ...
        public DeployPipelineParameterCollection build() {
            DeployPipelineParameterCollection model =
                    new DeployPipelineParameterCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineParameterCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployPipelineParameterCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployPipelineParameterCollection)) {
            return false;
        }

        DeployPipelineParameterCollection other = (DeployPipelineParameterCollection) o;
