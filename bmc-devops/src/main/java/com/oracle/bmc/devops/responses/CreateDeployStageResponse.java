...
public class CreateDeployStageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDeployStageResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDeployStageResponse)) {
            return false;
        }

        CreateDeployStageResponse other = (CreateDeployStageResponse) o;
