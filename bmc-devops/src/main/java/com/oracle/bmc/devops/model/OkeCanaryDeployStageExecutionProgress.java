...
public final class OkeCanaryDeployStageExecutionProgress extends DeployStageExecutionProgress {
    ...
    public static class Builder {
        ...
        public OkeCanaryDeployStageExecutionProgress build() {
            OkeCanaryDeployStageExecutionProgress model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeCanaryDeployStageExecutionProgress model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryDeployStageExecutionProgress)) {
            return false;
        }
