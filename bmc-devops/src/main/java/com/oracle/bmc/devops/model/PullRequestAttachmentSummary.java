...
/**
 * summary of a pullRequest attachment <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PullRequestAttachmentSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PullRequestAttachmentSummary
    ...
    public PullRequestAttachmentSummary(
            String id,
    ...
    public static class Builder {
        ...
        public PullRequestAttachmentSummary build() {
            PullRequestAttachmentSummary model =
                    new PullRequestAttachmentSummary(
                            this.id,
                            this.pullRequestId,
                            this.fileName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PullRequestAttachmentSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PullRequestAttachmentSummary)) {
            return false;
        }

        PullRequestAttachmentSummary other = (PullRequestAttachmentSummary) o;
