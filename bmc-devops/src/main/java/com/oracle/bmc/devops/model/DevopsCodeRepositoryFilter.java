...
public class DevopsCodeRepositoryFilter extends Filter {
    ...
    public static class Builder {
        ...
        public DevopsCodeRepositoryFilter build() {
            DevopsCodeRepositoryFilter __instance__ =
                    new DevopsCodeRepositoryFilter(events, include);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DevopsCodeRepositoryFilter o) {
