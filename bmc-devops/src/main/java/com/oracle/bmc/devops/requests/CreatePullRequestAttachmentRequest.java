...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/CreatePullRequestAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePullRequestAttachmentRequest.
 */
...
public class CreatePullRequestAttachmentRequest
    ...
    public static class Builder
        ...
        public CreatePullRequestAttachmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreatePullRequestAttachmentRequest(pullRequestId, contentDisposition, createPullRequestAttachmentBody, opcRetryToken, opcRequestId);
        }
    }
