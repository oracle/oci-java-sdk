...
public final class OkeBlueGreenDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeBlueGreenDeployStage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeBlueGreenDeployStage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeBlueGreenDeployStage)) {
            return false;
        }

        OkeBlueGreenDeployStage other = (OkeBlueGreenDeployStage) o;
