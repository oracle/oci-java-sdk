...
/**
 * Specifies details of build run through GitLab self-hosted Server. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GitlabServerBuildRunSource.Builder.class)
...
public final class GitlabServerBuildRunSource extends BuildRunSource {
    ...
    public static class Builder {
        ...
        public GitlabServerBuildRunSource build() {
            GitlabServerBuildRunSource model =
                    new GitlabServerBuildRunSource(this.triggerId, this.triggerInfo);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabServerBuildRunSource model) {
    ...
    @Deprecated
    public GitlabServerBuildRunSource(String triggerId, TriggerInfo triggerInfo) {
        super();
        this.triggerId = triggerId;
        this.triggerInfo = triggerInfo;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GitlabServerBuildRunSource(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabServerBuildRunSource)) {
            return false;
        }

        GitlabServerBuildRunSource other = (GitlabServerBuildRunSource) o;
