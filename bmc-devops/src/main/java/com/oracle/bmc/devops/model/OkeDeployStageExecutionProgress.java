...
public class OkeDeployStageExecutionProgress extends DeployStageExecutionProgress {
    ...
    public static class Builder {
        ...
        public OkeDeployStageExecutionProgress build() {
            OkeDeployStageExecutionProgress __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeDeployStageExecutionProgress o) {
