...
/**
 * Attributes to filter VBS events. File filter criteria - Changes only affecting excluded files
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VbsFilterExclusionAttributes.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class VbsFilterExclusionAttributes
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"fileFilter"})
    public VbsFilterExclusionAttributes(FileFilter fileFilter) {
        super();
    ...
    public static class Builder {
        ...
        public VbsFilterExclusionAttributes build() {
            VbsFilterExclusionAttributes model = new VbsFilterExclusionAttributes(this.fileFilter);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsFilterExclusionAttributes model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VbsFilterExclusionAttributes(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsFilterExclusionAttributes)) {
            return false;
        }

        VbsFilterExclusionAttributes other = (VbsFilterExclusionAttributes) o;
