...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/devops/DeleteRepositoryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRepositoryRequest.
 */
...
public class DeleteRepositoryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteRepositoryRequest
         */
        public DeleteRepositoryRequest buildWithoutInvocationCallback() {
            DeleteRepositoryRequest request = new DeleteRepositoryRequest();
            request.repositoryId = repositoryId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteRepositoryRequest(repositoryId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRepositoryRequest)) {
            return false;
        }
