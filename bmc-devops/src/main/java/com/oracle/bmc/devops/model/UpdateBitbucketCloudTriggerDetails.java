...
/**
 * Update trigger specific to Bitbucket Cloud. <br>
...
public final class UpdateBitbucketCloudTriggerDetails extends UpdateTriggerDetails {
    ...
    public static class Builder {
        ...
        public UpdateBitbucketCloudTriggerDetails build() {
            UpdateBitbucketCloudTriggerDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBitbucketCloudTriggerDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBitbucketCloudTriggerDetails)) {
            return false;
        }
