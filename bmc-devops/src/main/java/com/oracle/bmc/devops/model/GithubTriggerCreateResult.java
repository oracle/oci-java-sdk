...
/**
 * Trigger create response specific to GitHub. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GithubTriggerCreateResult.Builder.class)
...
public final class GithubTriggerCreateResult extends TriggerCreateResult {
    ...
    public static class Builder {
        ...
        public GithubTriggerCreateResult build() {
            GithubTriggerCreateResult model =
                    new GithubTriggerCreateResult(
                            this.id,
                            this.displayName,
                            this.description,
                            this.projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GithubTriggerCreateResult model) {
    ...
    @Deprecated
    public GithubTriggerCreateResult(
            String id,
            String displayName,
            String description,
            String projectId,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GithubTriggerCreateResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GithubTriggerCreateResult)) {
            return false;
        }
