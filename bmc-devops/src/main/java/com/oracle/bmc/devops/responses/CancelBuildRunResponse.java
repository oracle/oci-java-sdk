...
public class CancelBuildRunResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public CancelBuildRunResponse build() {
            return new CancelBuildRunResponse(__httpStatusCode__, etag, opcRequestId, buildRun);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelBuildRunResponse)) {
            return false;
        }

        CancelBuildRunResponse other = (CancelBuildRunResponse) o;
