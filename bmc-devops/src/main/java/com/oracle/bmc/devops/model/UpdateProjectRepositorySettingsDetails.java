...
/**
 * Information to update custom project repository settings. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateProjectRepositorySettingsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateProjectRepositorySettingsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"mergeSettings", "approvalRules"})
    public UpdateProjectRepositorySettingsDetails(
            MergeSettings mergeSettings, UpdateApprovalRuleDetailsCollection approvalRules) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateProjectRepositorySettingsDetails build() {
            UpdateProjectRepositorySettingsDetails model =
                    new UpdateProjectRepositorySettingsDetails(
                            this.mergeSettings, this.approvalRules);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateProjectRepositorySettingsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateProjectRepositorySettingsDetails)) {
            return false;
        }

        UpdateProjectRepositorySettingsDetails other = (UpdateProjectRepositorySettingsDetails) o;
