...
public class GetDeployPipelineResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDeployPipelineResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDeployPipelineResponse> {
         ...
         */
        @Override
        public Builder copy(GetDeployPipelineResponse o) {
         ...
         */
        @Override
        public GetDeployPipelineResponse build() {
            return new GetDeployPipelineResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, deployPipeline);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDeployPipelineResponse)) {
            return false;
        }

        GetDeployPipelineResponse other = (GetDeployPipelineResponse) o;
