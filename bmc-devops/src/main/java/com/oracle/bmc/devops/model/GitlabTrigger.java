...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GitlabTrigger.Builder.class)
...
public final class GitlabTrigger extends Trigger {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabTrigger model) {
