...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ComputeInstanceGroupDeployStageSummary.Builder.class
)
...
public final class ComputeInstanceGroupDeployStageSummary extends DeployStageSummary {
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupDeployStageSummary build() {
            ComputeInstanceGroupDeployStageSummary __instance__ =
                    new ComputeInstanceGroupDeployStageSummary(
                            id,
                            description,
                            displayName,
                            projectId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupDeployStageSummary o) {
    ...
    @Deprecated
    public ComputeInstanceGroupDeployStageSummary(
            String id,
            String description,
            String displayName,
            String projectId,
    ...
    public String toString() {
        ...
        sb.append("ComputeInstanceGroupDeployStageSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupDeployStageSummary)) {
            return false;
        }

        ComputeInstanceGroupDeployStageSummary other = (ComputeInstanceGroupDeployStageSummary) o;
