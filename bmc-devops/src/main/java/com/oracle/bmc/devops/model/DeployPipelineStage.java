...
public final class DeployPipelineStage {
    ...
    public static class Builder {
        ...
        public DeployPipelineStage build() {
            DeployPipelineStage __instance__ = new DeployPipelineStage(deployStageId, displayName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployPipelineStage o) {
            Builder copiedBuilder =
                    deployStageId(o.getDeployStageId()).displayName(o.getDisplayName());
