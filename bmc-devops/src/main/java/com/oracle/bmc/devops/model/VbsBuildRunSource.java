...
/**
 * Specifies details of build run through VBS Server. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VbsBuildRunSource.Builder.class)
...
public final class VbsBuildRunSource extends BuildRunSource {
    ...
    public static class Builder {
        ...
        public VbsBuildRunSource build() {
            VbsBuildRunSource model = new VbsBuildRunSource(this.triggerId, this.triggerInfo);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VbsBuildRunSource model) {
    ...
    @Deprecated
    public VbsBuildRunSource(String triggerId, TriggerInfo triggerInfo) {
        super();
        this.triggerId = triggerId;
        this.triggerInfo = triggerInfo;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VbsBuildRunSource)) {
            return false;
        }

        VbsBuildRunSource other = (VbsBuildRunSource) o;
