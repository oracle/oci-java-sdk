...
/**
 * Details of the work request status. <br>
...
public final class WorkRequestSummary
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the compartment that contains the work request. Work requests must be scoped
         * to the same compartment as the resource that the work request affects. If the work
         * request affects multiple resources, and those resources are not in the same compartment,
         * the service team must pick the primary resource whose compartment must be used.
         */
        ...
        /**
         * Date and time the request was created. Format defined by
        ...
        /**
         * Date and time the request was started. Format defined by
         * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
         */
        ...
        /**
         * Date and time the request was completed. Format defined by
         * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
         */
    ...
    /**
     * The OCID of the compartment that contains the work request. Work requests must be scoped to
     * the same compartment as the resource that the work request affects. If the work request
     * affects multiple resources, and those resources are not in the same compartment, the service
     * team must pick the primary resource whose compartment must be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
