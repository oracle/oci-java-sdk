...
/**
 * Information about canceling the build run. <br>
...
public final class CancelBuildRunDetails
    ...
    public static class Builder {
        ...
        public CancelBuildRunDetails build() {
            CancelBuildRunDetails model = new CancelBuildRunDetails(this.reason);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CancelBuildRunDetails model) {
