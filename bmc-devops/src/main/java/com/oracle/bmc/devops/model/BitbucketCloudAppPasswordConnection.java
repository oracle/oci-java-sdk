...
/**
 * The properties that define a connection of the type {@code BITBUCKET_CLOUD_APP_PASSWORD}. This
 * type corresponds to a connection in Bitbucket Cloud that is authenticated with a App Password
 * along with username. <br>
...
public final class BitbucketCloudAppPasswordConnection extends Connection {
    ...
    public static class Builder {
        ...
        public BitbucketCloudAppPasswordConnection build() {
            BitbucketCloudAppPasswordConnection model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BitbucketCloudAppPasswordConnection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BitbucketCloudAppPasswordConnection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BitbucketCloudAppPasswordConnection)) {
            return false;
        }

        BitbucketCloudAppPasswordConnection other = (BitbucketCloudAppPasswordConnection) o;
