...
public final class OkeBlueGreenTrafficShiftDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        public OkeBlueGreenTrafficShiftDeployStage build() {
            OkeBlueGreenTrafficShiftDeployStage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeBlueGreenTrafficShiftDeployStage model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeBlueGreenTrafficShiftDeployStage)) {
            return false;
        }

        OkeBlueGreenTrafficShiftDeployStage other = (OkeBlueGreenTrafficShiftDeployStage) o;
