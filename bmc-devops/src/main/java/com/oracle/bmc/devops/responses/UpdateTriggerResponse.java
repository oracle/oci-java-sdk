...
public class UpdateTriggerResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateTriggerResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTriggerResponse)) {
            return false;
        }
