...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = UpdateDeploymentDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateSingleDeployStageDeploymentDetails.class,
        name = "SINGLE_STAGE_DEPLOYMENT"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = UpdateDeployPipelineRedeploymentDetails.class,
...
public class UpdateDeploymentDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "freeformTags", "definedTags"})
    protected UpdateDeploymentDetails(
            String displayName,
