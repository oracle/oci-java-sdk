...
public final class CaCertVerify extends TlsVerifyConfig {
    ...
    public static class Builder {
        ...
        public CaCertVerify build() {
            CaCertVerify __instance__ = new CaCertVerify(caCertificateBundleId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CaCertVerify o) {
            Builder copiedBuilder = caCertificateBundleId(o.getCaCertificateBundleId());
