...
public final class UpdateOkeBlueGreenTrafficShiftDeployStageDetails
    ...
    public static class Builder {
        ...
        public UpdateOkeBlueGreenTrafficShiftDeployStageDetails build() {
            UpdateOkeBlueGreenTrafficShiftDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOkeBlueGreenTrafficShiftDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOkeBlueGreenTrafficShiftDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOkeBlueGreenTrafficShiftDeployStageDetails)) {
            return false;
        }

        UpdateOkeBlueGreenTrafficShiftDeployStageDetails other =
                (UpdateOkeBlueGreenTrafficShiftDeployStageDetails) o;
