...
public final class GitlabBuildSource extends BuildSource {
    ...
    public static class Builder {
        ...
        public GitlabBuildSource build() {
            GitlabBuildSource model =
                    new GitlabBuildSource(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GitlabBuildSource model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GitlabBuildSource)) {
            return false;
        }

        GitlabBuildSource other = (GitlabBuildSource) o;
