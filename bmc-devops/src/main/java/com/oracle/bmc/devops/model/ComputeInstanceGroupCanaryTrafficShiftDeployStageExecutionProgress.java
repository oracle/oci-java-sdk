...
public final class ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress
    ...
    public static class Builder {
        ...
        public ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress build() {
            ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress model =
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress)) {
            return false;
        }

        ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress other =
                (ComputeInstanceGroupCanaryTrafficShiftDeployStageExecutionProgress) o;
