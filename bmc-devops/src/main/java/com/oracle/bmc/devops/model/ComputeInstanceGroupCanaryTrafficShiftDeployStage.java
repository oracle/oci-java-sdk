...
public final class ComputeInstanceGroupCanaryTrafficShiftDeployStage extends DeployStage {
    ...
    public static class Builder {
        ...
        /**
         * The OCID of an upstream compute instance group canary deployment stage ID in this
         * pipeline.
         */
        ...
        public ComputeInstanceGroupCanaryTrafficShiftDeployStage build() {
            ComputeInstanceGroupCanaryTrafficShiftDeployStage model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComputeInstanceGroupCanaryTrafficShiftDeployStage model) {
