...
/**
 * Specifies the Container Engine for Kubernetes (OKE) cluster Canary approval stage. <br>
...
public final class OkeCanaryApprovalDeployStageExecutionProgress
    ...
    public static class Builder {
        ...
        public OkeCanaryApprovalDeployStageExecutionProgress build() {
            OkeCanaryApprovalDeployStageExecutionProgress model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OkeCanaryApprovalDeployStageExecutionProgress model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OkeCanaryApprovalDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OkeCanaryApprovalDeployStageExecutionProgress)) {
            return false;
        }

        OkeCanaryApprovalDeployStageExecutionProgress other =
                (OkeCanaryApprovalDeployStageExecutionProgress) o;
