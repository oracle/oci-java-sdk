...
public final class UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails
    ...
    public static class Builder {
        ...
        public UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails build() {
            UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails)) {
            return false;
        }

        UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails other =
                (UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails) o;
