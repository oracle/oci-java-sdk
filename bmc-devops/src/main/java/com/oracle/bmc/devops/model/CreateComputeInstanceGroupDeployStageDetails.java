...
public final class CreateComputeInstanceGroupDeployStageDetails extends CreateDeployStageDetails {
    ...
    @Deprecated
    public CreateComputeInstanceGroupDeployStageDetails(
            String description,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateComputeInstanceGroupDeployStageDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateComputeInstanceGroupDeployStageDetails)) {
            return false;
        }

        CreateComputeInstanceGroupDeployStageDetails other =
                (CreateComputeInstanceGroupDeployStageDetails) o;
