...
/**
 * Specifies the Invoke Function stage specific execution details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InvokeFunctionDeployStageExecutionProgress.Builder.class)
...
public final class InvokeFunctionDeployStageExecutionProgress extends DeployStageExecutionProgress {
    ...
    public static class Builder {
        ...
        public InvokeFunctionDeployStageExecutionProgress build() {
            InvokeFunctionDeployStageExecutionProgress model =
                    new InvokeFunctionDeployStageExecutionProgress(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InvokeFunctionDeployStageExecutionProgress model) {
    ...
    @Deprecated
    public InvokeFunctionDeployStageExecutionProgress(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InvokeFunctionDeployStageExecutionProgress(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvokeFunctionDeployStageExecutionProgress)) {
            return false;
        }

        InvokeFunctionDeployStageExecutionProgress other =
                (InvokeFunctionDeployStageExecutionProgress) o;
