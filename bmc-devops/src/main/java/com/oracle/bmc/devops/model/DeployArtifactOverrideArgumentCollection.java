...
public final class DeployArtifactOverrideArgumentCollection {
    ...
    public static class Builder {
        ...
        public DeployArtifactOverrideArgumentCollection build() {
            DeployArtifactOverrideArgumentCollection __instance__ =
                    new DeployArtifactOverrideArgumentCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployArtifactOverrideArgumentCollection o) {
