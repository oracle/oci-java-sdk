...
public final class DeployArtifactOverrideArgumentCollection
    ...
    public DeployArtifactOverrideArgumentCollection(
            java.util.List<DeployArtifactOverrideArgument> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public DeployArtifactOverrideArgumentCollection build() {
            DeployArtifactOverrideArgumentCollection model =
                    new DeployArtifactOverrideArgumentCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployArtifactOverrideArgumentCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DeployArtifactOverrideArgumentCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployArtifactOverrideArgumentCollection)) {
            return false;
        }

        DeployArtifactOverrideArgumentCollection other =
                (DeployArtifactOverrideArgumentCollection) o;
