...
public class CreateDeployPipelineRequest
        extends com.oracle.bmc.requests.BmcRequest<CreateDeployPipelineDetails> {

    /**
     * Details for the new deployment pipeline.
     */
    private CreateDeployPipelineDetails createDeployPipelineDetails;
    ...
    public static class Builder
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(CreateDeployPipelineDetails body) {
