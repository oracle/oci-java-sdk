 ...
 * to any list operations of MonitoredRegion where multiple pages of data may be fetched.
...
public class MonitoredRegionPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMonitoredRegions operation. This iterable
    ...
    public Iterable<ListMonitoredRegionsResponse> listMonitoredRegionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMonitoredRegionsRequest.Builder, ListMonitoredRegionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.resourceanalytics.model.MonitoredRegionSummary} objects
     * contained in responses from the listMonitoredRegions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.resourceanalytics.model.MonitoredRegionSummary} objects
