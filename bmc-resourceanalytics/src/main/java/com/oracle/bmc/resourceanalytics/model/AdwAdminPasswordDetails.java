...
/**
 * Details for the ADW Admin password. Password can be passed as {@code VaultSecretPasswordDetails}
 * or {@code PlainTextPasswordDetails}.
 *
 * <p>Example: {@code {"passwordType":"PLAIN_TEXT","password":"..."}} Example: {@code
 * {"passwordType":"VAULT_SECRET","secretId":"ocid..."}} <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = AdwAdminPasswordDetails.class)
...
public class AdwAdminPasswordDetails
    ...
    protected AdwAdminPasswordDetails() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdwAdminPasswordDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdwAdminPasswordDetails)) {
            return false;
        }

        AdwAdminPasswordDetails other = (AdwAdminPasswordDetails) o;
