...
/**
 * Secret details for the ADW Admin password. <br>
...
public final class VaultSecretPasswordDetails extends AdwAdminPasswordDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * vault secret to use as the ADW admin password.
         */
        ...
        public VaultSecretPasswordDetails build() {
            VaultSecretPasswordDetails model = new VaultSecretPasswordDetails(this.secretId);
    ...
    @Deprecated
    public VaultSecretPasswordDetails(String secretId) {
        super();
        this.secretId = secretId;
    }
