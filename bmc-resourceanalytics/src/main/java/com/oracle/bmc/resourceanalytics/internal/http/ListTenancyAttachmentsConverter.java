...
public class ListTenancyAttachmentsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTenancyAttachmentsConverter.class);

    public static com.oracle.bmc.resourceanalytics.requests.ListTenancyAttachmentsRequest
            interceptRequest(
                    com.oracle.bmc.resourceanalytics.requests.ListTenancyAttachmentsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.resourceanalytics.requests.ListTenancyAttachmentsRequest request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20241031").path("tenancyAttachments");

        if (request.getResourceAnalyticsInstanceId() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.resourceanalytics.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.resourceanalytics.responses.ListTenancyAttachmentsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
