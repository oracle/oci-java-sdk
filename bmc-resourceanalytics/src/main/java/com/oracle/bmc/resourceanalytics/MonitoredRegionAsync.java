...
public interface MonitoredRegionAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateMonitoredRegionResponse> createMonitoredRegion(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteMonitoredRegionResponse> deleteMonitoredRegion(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetMonitoredRegionResponse> getMonitoredRegion(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListMonitoredRegionsResponse> listMonitoredRegions(
