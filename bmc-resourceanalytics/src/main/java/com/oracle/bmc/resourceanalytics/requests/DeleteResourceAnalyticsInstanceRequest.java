...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourceanalytics/DeleteResourceAnalyticsInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteResourceAnalyticsInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241031")
public class DeleteResourceAnalyticsInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteResourceAnalyticsInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteResourceAnalyticsInstanceRequest o) {
        ...
        /**
         * Build the instance of DeleteResourceAnalyticsInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteResourceAnalyticsInstanceRequest
         */
        public DeleteResourceAnalyticsInstanceRequest build() {
            DeleteResourceAnalyticsInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteResourceAnalyticsInstanceRequest
         */
        public DeleteResourceAnalyticsInstanceRequest buildWithoutInvocationCallback() {
            DeleteResourceAnalyticsInstanceRequest request =
                    new DeleteResourceAnalyticsInstanceRequest();
            request.resourceAnalyticsInstanceId = resourceAnalyticsInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteResourceAnalyticsInstanceRequest(resourceAnalyticsInstanceId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteResourceAnalyticsInstanceRequest)) {
            return false;
        }

        DeleteResourceAnalyticsInstanceRequest other = (DeleteResourceAnalyticsInstanceRequest) o;
