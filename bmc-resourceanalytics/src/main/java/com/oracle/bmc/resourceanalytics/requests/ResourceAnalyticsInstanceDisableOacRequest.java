...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourceanalytics/ResourceAnalyticsInstanceDisableOacExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResourceAnalyticsInstanceDisableOacRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241031")
public class ResourceAnalyticsInstanceDisableOacRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ResourceAnalyticsInstanceDisableOacRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ResourceAnalyticsInstanceDisableOacRequest o) {
        ...
        /**
         * Build the instance of ResourceAnalyticsInstanceDisableOacRequest as configured by this builder
         *
         ...
         *
         * @return instance of ResourceAnalyticsInstanceDisableOacRequest
         */
        public ResourceAnalyticsInstanceDisableOacRequest build() {
            ResourceAnalyticsInstanceDisableOacRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ResourceAnalyticsInstanceDisableOacRequest
         */
        public ResourceAnalyticsInstanceDisableOacRequest buildWithoutInvocationCallback() {
            ResourceAnalyticsInstanceDisableOacRequest request =
                    new ResourceAnalyticsInstanceDisableOacRequest();
            request.resourceAnalyticsInstanceId = resourceAnalyticsInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ResourceAnalyticsInstanceDisableOacRequest(resourceAnalyticsInstanceId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceAnalyticsInstanceDisableOacRequest)) {
            return false;
        }

        ResourceAnalyticsInstanceDisableOacRequest other =
                (ResourceAnalyticsInstanceDisableOacRequest) o;
