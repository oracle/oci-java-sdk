...
public interface ResourceAnalyticsInstanceAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ChangeResourceAnalyticsInstanceCompartmentResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetResourceAnalyticsInstanceResponse> getResourceAnalyticsInstance(
