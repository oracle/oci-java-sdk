...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourceanalytics/UpdateTenancyAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateTenancyAttachmentRequest.
 */
...
public class UpdateTenancyAttachmentRequest
    ...
    public static class Builder
        ...
        public UpdateTenancyAttachmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateTenancyAttachmentRequest(tenancyAttachmentId, updateTenancyAttachmentDetails, ifMatch, opcRequestId);
        }
    }
