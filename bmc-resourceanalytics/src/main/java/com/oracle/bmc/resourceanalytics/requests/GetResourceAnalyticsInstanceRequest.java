...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourceanalytics/GetResourceAnalyticsInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetResourceAnalyticsInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241031")
public class GetResourceAnalyticsInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetResourceAnalyticsInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetResourceAnalyticsInstanceRequest o) {
        ...
        /**
         * Build the instance of GetResourceAnalyticsInstanceRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetResourceAnalyticsInstanceRequest
         */
        public GetResourceAnalyticsInstanceRequest build() {
            GetResourceAnalyticsInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetResourceAnalyticsInstanceRequest
         */
        public GetResourceAnalyticsInstanceRequest buildWithoutInvocationCallback() {
            GetResourceAnalyticsInstanceRequest request = new GetResourceAnalyticsInstanceRequest();
            request.resourceAnalyticsInstanceId = resourceAnalyticsInstanceId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetResourceAnalyticsInstanceRequest(resourceAnalyticsInstanceId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetResourceAnalyticsInstanceRequest)) {
            return false;
        }

        GetResourceAnalyticsInstanceRequest other = (GetResourceAnalyticsInstanceRequest) o;
