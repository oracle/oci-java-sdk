...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MonitoredRegion.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MonitoredRegion
    ...
    public static class Builder {
        ...
        /**
         * The date and time the MonitoredRegion was created, in the format defined by [RFC
        ...
        /**
         * The date and time the MonitoredRegion was updated, in the format defined by [RFC
         * 3339](https://tools.ietf.org/html/rfc3339).
         *
         * <p>Example: {@code 2016-08-25T21:10:29.600Z}
         */
        ...
        /**
         * A message that describes the current state of the MonitoredRegion in more detail. For
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MonitoredRegion model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoredRegion)) {
            return false;
        }

        MonitoredRegion other = (MonitoredRegion) o;
