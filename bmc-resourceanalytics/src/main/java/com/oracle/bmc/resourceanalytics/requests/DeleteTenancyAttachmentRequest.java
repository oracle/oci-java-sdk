...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourceanalytics/DeleteTenancyAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteTenancyAttachmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241031")
public class DeleteTenancyAttachmentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteTenancyAttachmentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteTenancyAttachmentRequest o) {
        ...
        /**
         * Build the instance of DeleteTenancyAttachmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteTenancyAttachmentRequest
         */
        public DeleteTenancyAttachmentRequest build() {
            DeleteTenancyAttachmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteTenancyAttachmentRequest
         */
        public DeleteTenancyAttachmentRequest buildWithoutInvocationCallback() {
            DeleteTenancyAttachmentRequest request = new DeleteTenancyAttachmentRequest();
            request.tenancyAttachmentId = tenancyAttachmentId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteTenancyAttachmentRequest(tenancyAttachmentId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTenancyAttachmentRequest)) {
            return false;
        }

        DeleteTenancyAttachmentRequest other = (DeleteTenancyAttachmentRequest) o;
