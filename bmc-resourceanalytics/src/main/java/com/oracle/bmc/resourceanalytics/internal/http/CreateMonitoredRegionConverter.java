...
public class CreateMonitoredRegionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateMonitoredRegionConverter.class);

    public static com.oracle.bmc.resourceanalytics.requests.CreateMonitoredRegionRequest
            interceptRequest(
                    com.oracle.bmc.resourceanalytics.requests.CreateMonitoredRegionRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.resourceanalytics.requests.CreateMonitoredRegionRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.resourceanalytics.responses.CreateMonitoredRegionResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.resourceanalytics.responses
                                        .CreateMonitoredRegionResponse>() {
                            @Override
                            public com.oracle.bmc.resourceanalytics.responses
                                            .CreateMonitoredRegionResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.resourceanalytics.responses.CreateMonitoredRegionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.resourceanalytics.responses
                                                .CreateMonitoredRegionResponse.Builder
                                        builder =
                                                com.oracle.bmc.resourceanalytics.responses
                                                        .CreateMonitoredRegionResponse.builder()
