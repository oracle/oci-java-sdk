...
public class ResourceAnalyticsInstanceClient implements ResourceAnalyticsInstance {
    /**
     ...
     */
    protected ResourceAnalyticsInstanceClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeResourceAnalyticsInstanceCompartmentResponse
        ...
        LOG.trace("Called changeResourceAnalyticsInstanceCompartment");
    ...
    public CreateResourceAnalyticsInstanceResponse createResourceAnalyticsInstance(
        ...
        LOG.trace("Called createResourceAnalyticsInstance");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getCreateResourceAnalyticsInstanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteResourceAnalyticsInstanceResponse deleteResourceAnalyticsInstance(
        ...
        LOG.trace("Called deleteResourceAnalyticsInstance");
    ...
    public GetResourceAnalyticsInstanceResponse getResourceAnalyticsInstance(
        ...
        LOG.trace("Called getResourceAnalyticsInstance");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetResourceAnalyticsInstanceResponse>
                transformer =
    ...
    public ListResourceAnalyticsInstancesResponse listResourceAnalyticsInstances(
        ...
        LOG.trace("Called listResourceAnalyticsInstances");
    ...
    public ResourceAnalyticsInstanceDisableOacResponse resourceAnalyticsInstanceDisableOac(
        ...
        LOG.trace("Called resourceAnalyticsInstanceDisableOac");
    ...
    public ResourceAnalyticsInstanceEnableOacResponse resourceAnalyticsInstanceEnableOac(
        ...
        LOG.trace("Called resourceAnalyticsInstanceEnableOac");
    ...
    public UpdateResourceAnalyticsInstanceResponse updateResourceAnalyticsInstance(
        ...
        LOG.trace("Called updateResourceAnalyticsInstance");
