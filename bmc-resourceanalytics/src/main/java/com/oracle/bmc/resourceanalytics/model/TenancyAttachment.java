...
/**
 * A TenancyAttachment is a customers' tenancy attached to a ResourceAnalyticsInstance. Attached
 * tenancies will be included in analytics collection.
 *
...
public final class TenancyAttachment
    ...
    /** The overall status of the data population from the tenancy. */
    public enum DataPopulationStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Accepted("ACCEPTED"),
