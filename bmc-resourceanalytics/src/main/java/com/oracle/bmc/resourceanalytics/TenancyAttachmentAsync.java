...
public interface TenancyAttachmentAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateTenancyAttachmentResponse> createTenancyAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteTenancyAttachmentResponse> deleteTenancyAttachment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateTenancyAttachmentResponse> updateTenancyAttachment(
