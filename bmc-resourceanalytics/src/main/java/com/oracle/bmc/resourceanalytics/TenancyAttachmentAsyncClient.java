...
import com.oracle.bmc.resourceanalytics.internal.http.*;
...
/**
 * Async client implementation for TenancyAttachment service. <br/>
...
public class TenancyAttachmentAsyncClient implements TenancyAttachmentAsync {
    /**
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(TenancyAttachmentAsyncClient.class);
     ...
     */
    public TenancyAttachmentAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, TenancyAttachmentAsyncClient> {
         ...
         * @return the client
         */
        public TenancyAttachmentAsyncClient build(
            ...
            return new TenancyAttachmentAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public java.util.concurrent.Future<CreateTenancyAttachmentResponse> createTenancyAttachment(
            CreateTenancyAttachmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            CreateTenancyAttachmentRequest, CreateTenancyAttachmentResponse>
                    handler) {
        LOG.trace("Called async createTenancyAttachment");
        final CreateTenancyAttachmentRequest interceptedRequest =
                CreateTenancyAttachmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CreateTenancyAttachmentConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<
                        javax.ws.rs.core.Response, CreateTenancyAttachmentResponse>
                transformer =
                        CreateTenancyAttachmentConverter.fromResponse(
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CreateTenancyAttachmentRequest, CreateTenancyAttachmentResponse>,
                        java.util.concurrent.Future<CreateTenancyAttachmentResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCreateTenancyAttachmentDetails(),
                                ib,
                                transformer);
    ...
    @Override
    public java.util.concurrent.Future<DeleteTenancyAttachmentResponse> deleteTenancyAttachment(
            DeleteTenancyAttachmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            DeleteTenancyAttachmentRequest, DeleteTenancyAttachmentResponse>
                    handler) {
        LOG.trace("Called async deleteTenancyAttachment");
        final DeleteTenancyAttachmentRequest interceptedRequest =
                DeleteTenancyAttachmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                DeleteTenancyAttachmentConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "TenancyAttachment",
        ...
        final java.util.function.Function<
                        javax.ws.rs.core.Response, DeleteTenancyAttachmentResponse>
                transformer =
                        DeleteTenancyAttachmentConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<
                        DeleteTenancyAttachmentRequest, DeleteTenancyAttachmentResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                DeleteTenancyAttachmentRequest, DeleteTenancyAttachmentResponse>,
                        java.util.concurrent.Future<DeleteTenancyAttachmentResponse>>
    ...
    @Override
    public java.util.concurrent.Future<UpdateTenancyAttachmentResponse> updateTenancyAttachment(
            UpdateTenancyAttachmentRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            UpdateTenancyAttachmentRequest, UpdateTenancyAttachmentResponse>
                    handler) {
        LOG.trace("Called async updateTenancyAttachment");
        final UpdateTenancyAttachmentRequest interceptedRequest =
                UpdateTenancyAttachmentConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateTenancyAttachmentConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "TenancyAttachment",
        ...
        final java.util.function.Function<
                        javax.ws.rs.core.Response, UpdateTenancyAttachmentResponse>
                transformer =
                        UpdateTenancyAttachmentConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<
                        UpdateTenancyAttachmentRequest, UpdateTenancyAttachmentResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateTenancyAttachmentRequest, UpdateTenancyAttachmentResponse>,
                        java.util.concurrent.Future<UpdateTenancyAttachmentResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateTenancyAttachmentDetails(),
                                ib,
                                transformer);
