...
public class TenancyAttachmentAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements TenancyAttachmentAsync {
    ...
    public static class Builder
        ...
        public TenancyAttachmentAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new TenancyAttachmentAsyncClient(this, authenticationDetailsProvider);
        }
    }
