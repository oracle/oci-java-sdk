...
public class TenancyAttachmentClient implements TenancyAttachment {
    /**
     ...
     */
    protected TenancyAttachmentClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public CreateTenancyAttachmentResponse createTenancyAttachment(
        ...
        LOG.trace("Called createTenancyAttachment");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateTenancyAttachmentResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateTenancyAttachmentDetails(),
                                                retriedRequest);
    ...
    public DeleteTenancyAttachmentResponse deleteTenancyAttachment(
        ...
        LOG.trace("Called deleteTenancyAttachment");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteTenancyAttachmentResponse>
                transformer =
    ...
    public UpdateTenancyAttachmentResponse updateTenancyAttachment(
        ...
        LOG.trace("Called updateTenancyAttachment");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateTenancyAttachmentResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateTenancyAttachmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
