...
public class DeleteOccmDemandSignalItemResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccmDemandSignalItemResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteOccmDemandSignalItemResponse o) {
         ...
         */
        @Override
        public DeleteOccmDemandSignalItemResponse build() {
            return new DeleteOccmDemandSignalItemResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccmDemandSignalItemResponse)) {
            return false;
        }

        DeleteOccmDemandSignalItemResponse other = (DeleteOccmDemandSignalItemResponse) o;
