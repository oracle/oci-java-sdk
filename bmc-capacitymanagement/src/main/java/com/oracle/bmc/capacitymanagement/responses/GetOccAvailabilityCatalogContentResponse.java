...
public class GetOccAvailabilityCatalogContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetOccAvailabilityCatalogContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetOccAvailabilityCatalogContentResponse o) {
         ...
         */
        @Override
        public GetOccAvailabilityCatalogContentResponse build() {
            return new GetOccAvailabilityCatalogContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccAvailabilityCatalogContentResponse)) {
            return false;
        }

        GetOccAvailabilityCatalogContentResponse other =
                (GetOccAvailabilityCatalogContentResponse) o;
