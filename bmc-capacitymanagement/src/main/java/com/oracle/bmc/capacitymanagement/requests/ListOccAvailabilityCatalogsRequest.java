...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListOccAvailabilityCatalogsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOccAvailabilityCatalogsRequest.
 */
...
public class ListOccAvailabilityCatalogsRequest
    ...
    public static class Builder
         ...
         */
        public ListOccAvailabilityCatalogsRequest build() {
            ListOccAvailabilityCatalogsRequest request = buildWithoutInvocationCallback();
        ...
        public ListOccAvailabilityCatalogsRequest buildWithoutInvocationCallback() {
            ListOccAvailabilityCatalogsRequest request = new ListOccAvailabilityCatalogsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccAvailabilityCatalogsRequest)) {
            return false;
        }

        ListOccAvailabilityCatalogsRequest other = (ListOccAvailabilityCatalogsRequest) o;
