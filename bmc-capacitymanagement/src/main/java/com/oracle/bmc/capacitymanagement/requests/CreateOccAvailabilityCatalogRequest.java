...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/CreateOccAvailabilityCatalogExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOccAvailabilityCatalogRequest.
 */
...
public class CreateOccAvailabilityCatalogRequest
    ...
    public static class Builder
        ...
        public CreateOccAvailabilityCatalogRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateOccAvailabilityCatalogRequest(createOccAvailabilityCatalogDetails, opcRetryToken, opcRequestId);
        }
    }
