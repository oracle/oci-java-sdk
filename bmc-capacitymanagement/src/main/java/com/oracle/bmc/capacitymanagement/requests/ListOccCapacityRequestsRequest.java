...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListOccCapacityRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOccCapacityRequestsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListOccCapacityRequestsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOccCapacityRequestsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOccCapacityRequestsRequest o) {
        ...
        /**
         * Build the instance of ListOccCapacityRequestsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOccCapacityRequestsRequest
         */
        public ListOccCapacityRequestsRequest build() {
            ListOccCapacityRequestsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOccCapacityRequestsRequest
         */
        public ListOccCapacityRequestsRequest buildWithoutInvocationCallback() {
            ListOccCapacityRequestsRequest request = new ListOccCapacityRequestsRequest();
            ...
            return request;
            // new ListOccCapacityRequestsRequest(compartmentId, occAvailabilityCatalogId, namespace, requestType, displayName, id, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccCapacityRequestsRequest)) {
            return false;
        }

        ListOccCapacityRequestsRequest other = (ListOccCapacityRequestsRequest) o;
