...
public class DeleteOccCustomerResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccCustomerResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteOccCustomerResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteOccCustomerResponse o) {
         ...
         */
        @Override
        public DeleteOccCustomerResponse build() {
            return new DeleteOccCustomerResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccCustomerResponse)) {
            return false;
        }

        DeleteOccCustomerResponse other = (DeleteOccCustomerResponse) o;
