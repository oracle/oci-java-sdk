...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListInternalNamespaceOccOverviewsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInternalNamespaceOccOverviewsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListInternalNamespaceOccOverviewsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListInternalNamespaceOccOverviewsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListInternalNamespaceOccOverviewsRequest o) {
         ...
         *
         * @return instance of ListInternalNamespaceOccOverviewsRequest
         */
        public ListInternalNamespaceOccOverviewsRequest build() {
            ListInternalNamespaceOccOverviewsRequest request = buildWithoutInvocationCallback();
        ...
        public ListInternalNamespaceOccOverviewsRequest buildWithoutInvocationCallback() {
            ListInternalNamespaceOccOverviewsRequest request =
                    new ListInternalNamespaceOccOverviewsRequest();
            ...
            return request;
            // new ListInternalNamespaceOccOverviewsRequest(namespace, compartmentId, occCustomerGroupId, workloadType, from, to, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalNamespaceOccOverviewsRequest)) {
            return false;
        }

        ListInternalNamespaceOccOverviewsRequest other =
                (ListInternalNamespaceOccOverviewsRequest) o;
