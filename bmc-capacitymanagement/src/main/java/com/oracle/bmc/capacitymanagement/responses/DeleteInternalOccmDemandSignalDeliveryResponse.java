...
public class DeleteInternalOccmDemandSignalDeliveryResponse
    ...
    private DeleteInternalOccmDemandSignalDeliveryResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteInternalOccmDemandSignalDeliveryResponse o) {
         ...
         */
        @Override
        public DeleteInternalOccmDemandSignalDeliveryResponse build() {
            return new DeleteInternalOccmDemandSignalDeliveryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteInternalOccmDemandSignalDeliveryResponse)) {
            return false;
        }

        DeleteInternalOccmDemandSignalDeliveryResponse other =
                (DeleteInternalOccmDemandSignalDeliveryResponse) o;
