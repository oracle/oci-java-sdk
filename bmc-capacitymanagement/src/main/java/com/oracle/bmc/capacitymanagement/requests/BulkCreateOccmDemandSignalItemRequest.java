...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/BulkCreateOccmDemandSignalItemExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BulkCreateOccmDemandSignalItemRequest.
 */
...
public class BulkCreateOccmDemandSignalItemRequest
    ...
    public static class Builder
        ...
        public BulkCreateOccmDemandSignalItemRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new BulkCreateOccmDemandSignalItemRequest(bulkCreateOccmDemandSignalItemDetails, opcRetryToken, opcRequestId);
        }
    }
