...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/DeleteOccCustomerGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOccCustomerGroupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class DeleteOccCustomerGroupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOccCustomerGroupRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOccCustomerGroupRequest o) {
         ...
         *
         * @return instance of DeleteOccCustomerGroupRequest
         */
        public DeleteOccCustomerGroupRequest build() {
            DeleteOccCustomerGroupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOccCustomerGroupRequest
         */
        public DeleteOccCustomerGroupRequest buildWithoutInvocationCallback() {
            DeleteOccCustomerGroupRequest request = new DeleteOccCustomerGroupRequest();
            request.occCustomerGroupId = occCustomerGroupId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteOccCustomerGroupRequest(occCustomerGroupId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccCustomerGroupRequest)) {
            return false;
        }

        DeleteOccCustomerGroupRequest other = (DeleteOccCustomerGroupRequest) o;
