...
public class ListInternalOccHandoverResourceBlocksResponse
    ...
    private ListInternalOccHandoverResourceBlocksResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ListInternalOccHandoverResourceBlocksResponse o) {
        ...
        public ListInternalOccHandoverResourceBlocksResponse build() {
            return new ListInternalOccHandoverResourceBlocksResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalOccHandoverResourceBlocksResponse)) {
            return false;
        }

        ListInternalOccHandoverResourceBlocksResponse other =
                (ListInternalOccHandoverResourceBlocksResponse) o;
