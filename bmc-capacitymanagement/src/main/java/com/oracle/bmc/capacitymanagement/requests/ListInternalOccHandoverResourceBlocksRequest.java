...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListInternalOccHandoverResourceBlocksExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInternalOccHandoverResourceBlocksRequest.
 */
...
public class ListInternalOccHandoverResourceBlocksRequest
    ...
    public static class Builder
         ...
         */
        public ListInternalOccHandoverResourceBlocksRequest build() {
            ListInternalOccHandoverResourceBlocksRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListInternalOccHandoverResourceBlocksRequest
         */
        public ListInternalOccHandoverResourceBlocksRequest buildWithoutInvocationCallback() {
            ListInternalOccHandoverResourceBlocksRequest request =
                    new ListInternalOccHandoverResourceBlocksRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalOccHandoverResourceBlocksRequest)) {
            return false;
        }

        ListInternalOccHandoverResourceBlocksRequest other =
                (ListInternalOccHandoverResourceBlocksRequest) o;
