...
public class ListOccCapacityRequestsInternalResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ListOccCapacityRequestsInternalResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ListOccCapacityRequestsInternalResponse o) {
         ...
         */
        @Override
        public ListOccCapacityRequestsInternalResponse build() {
            return new ListOccCapacityRequestsInternalResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccCapacityRequestsInternalResponse)) {
            return false;
        }

        ListOccCapacityRequestsInternalResponse other = (ListOccCapacityRequestsInternalResponse) o;
