...
public class BulkCreateOccmDemandSignalItemConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(BulkCreateOccmDemandSignalItemConverter.class);

    public static com.oracle.bmc.capacitymanagement.requests.BulkCreateOccmDemandSignalItemRequest
            interceptRequest(
                    com.oracle.bmc.capacitymanagement.requests.BulkCreateOccmDemandSignalItemRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("actions")
                        .path("bulkCreateDemandSignalItems");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.BulkCreateOccmDemandSignalItemResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.capacitymanagement.responses
                                                .BulkCreateOccmDemandSignalItemResponse.Builder
                                        builder =
                                                com.oracle.bmc.capacitymanagement.responses
                                                        .BulkCreateOccmDemandSignalItemResponse
                                                        .builder()
