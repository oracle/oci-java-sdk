...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalDeliveriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInternalOccmDemandSignalDeliveriesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListInternalOccmDemandSignalDeliveriesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListInternalOccmDemandSignalDeliveriesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListInternalOccmDemandSignalDeliveriesRequest o) {
        ...
        /**
         * Build the instance of ListInternalOccmDemandSignalDeliveriesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListInternalOccmDemandSignalDeliveriesRequest
         */
        public ListInternalOccmDemandSignalDeliveriesRequest build() {
         ...
         * @return instance of ListInternalOccmDemandSignalDeliveriesRequest
         */
        public ListInternalOccmDemandSignalDeliveriesRequest buildWithoutInvocationCallback() {
            ListInternalOccmDemandSignalDeliveriesRequest request =
                    new ListInternalOccmDemandSignalDeliveriesRequest();
            ...
            return request;
            // new ListInternalOccmDemandSignalDeliveriesRequest(compartmentId, occCustomerGroupId, id, occmDemandSignalItemId, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalOccmDemandSignalDeliveriesRequest)) {
            return false;
        }

        ListInternalOccmDemandSignalDeliveriesRequest other =
                (ListInternalOccmDemandSignalDeliveriesRequest) o;
