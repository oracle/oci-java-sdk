...
/**
 * The occm demand signal item which will be used for the bulk creation api. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BulkCreateOccmDemandSignalItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BulkCreateOccmDemandSignalItem
    ...
    public BulkCreateOccmDemandSignalItem(
    ...
    public static class Builder {
        ...
        public BulkCreateOccmDemandSignalItem build() {
            BulkCreateOccmDemandSignalItem model =
                    new BulkCreateOccmDemandSignalItem(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BulkCreateOccmDemandSignalItem model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BulkCreateOccmDemandSignalItem(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkCreateOccmDemandSignalItem)) {
            return false;
        }

        BulkCreateOccmDemandSignalItem other = (BulkCreateOccmDemandSignalItem) o;
