...
public class UpdateOccCapacityRequestConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateOccCapacityRequestConverter.class);

    public static com.oracle.bmc.capacitymanagement.requests.UpdateOccCapacityRequestRequest
            interceptRequest(
                    com.oracle.bmc.capacitymanagement.requests.UpdateOccCapacityRequestRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.capacitymanagement.requests.UpdateOccCapacityRequestRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getOccCapacityRequestId()));
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.capacitymanagement.responses.UpdateOccCapacityRequestResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.UpdateOccCapacityRequestResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.capacitymanagement.responses
                                                .UpdateOccCapacityRequestResponse.Builder
                                        builder =
                                                com.oracle.bmc.capacitymanagement.responses
                                                        .UpdateOccCapacityRequestResponse.builder()
                                ...
                                builder.occCapacityRequest(response.getItem());
