...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/GetInternalOccmDemandSignalDeliveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetInternalOccmDemandSignalDeliveryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class GetInternalOccmDemandSignalDeliveryRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetInternalOccmDemandSignalDeliveryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetInternalOccmDemandSignalDeliveryRequest o) {
        ...
        /**
         * Build the instance of GetInternalOccmDemandSignalDeliveryRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetInternalOccmDemandSignalDeliveryRequest
         */
        public GetInternalOccmDemandSignalDeliveryRequest build() {
            GetInternalOccmDemandSignalDeliveryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetInternalOccmDemandSignalDeliveryRequest
         */
        public GetInternalOccmDemandSignalDeliveryRequest buildWithoutInvocationCallback() {
            GetInternalOccmDemandSignalDeliveryRequest request =
                    new GetInternalOccmDemandSignalDeliveryRequest();
            request.occmDemandSignalDeliveryId = occmDemandSignalDeliveryId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetInternalOccmDemandSignalDeliveryRequest(occmDemandSignalDeliveryId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetInternalOccmDemandSignalDeliveryRequest)) {
            return false;
        }

        GetInternalOccmDemandSignalDeliveryRequest other =
                (GetInternalOccmDemandSignalDeliveryRequest) o;
