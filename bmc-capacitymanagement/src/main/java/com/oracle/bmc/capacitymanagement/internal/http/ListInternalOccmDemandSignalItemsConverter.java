...
public class ListInternalOccmDemandSignalItemsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListInternalOccmDemandSignalItemsConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getOccmDemandSignalId() != null) {
            target =
                    target.queryParam(
                            "occmDemandSignalId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
        ...
        if (request.getDemandSignalNamespace() != null) {
            target =
                    target.queryParam(
                            "demandSignalNamespace",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getDemandSignalNamespace().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.ListInternalOccmDemandSignalItemsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.internalOccmDemandSignalItemCollection(response.getItem());
