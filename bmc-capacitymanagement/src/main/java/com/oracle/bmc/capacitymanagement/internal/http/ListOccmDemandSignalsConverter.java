...
public class ListOccmDemandSignalsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListOccmDemandSignalsConverter.class);

    public static com.oracle.bmc.capacitymanagement.requests.ListOccmDemandSignalsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.capacitymanagement.requests.ListOccmDemandSignalsRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20231107").path("occmDemandSignals");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.capacitymanagement.responses.ListOccmDemandSignalsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.ListOccmDemandSignalsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.capacitymanagement.responses
                                                .ListOccmDemandSignalsResponse.Builder
                                        builder =
                                                com.oracle.bmc.capacitymanagement.responses
                                                        .ListOccmDemandSignalsResponse.builder()
                                ...
                                builder.occmDemandSignalCollection(response.getItem());
