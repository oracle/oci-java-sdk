...
public class ListOccOverviewsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListOccOverviewsConverter.class);

    public static com.oracle.bmc.capacitymanagement.requests.ListOccOverviewsRequest
            interceptRequest(
                    com.oracle.bmc.capacitymanagement.requests.ListOccOverviewsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.capacitymanagement.responses.ListOccOverviewsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.ListOccOverviewsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.capacitymanagement.responses.ListOccOverviewsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.capacitymanagement.responses
                                                        .ListOccOverviewsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.occOverviewCollection(response.getItem());
