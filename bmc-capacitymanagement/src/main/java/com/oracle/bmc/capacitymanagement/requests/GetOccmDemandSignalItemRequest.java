...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/GetOccmDemandSignalItemExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOccmDemandSignalItemRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class GetOccmDemandSignalItemRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOccmDemandSignalItemRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetOccmDemandSignalItemRequest o) {
        ...
        /**
         * Build the instance of GetOccmDemandSignalItemRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOccmDemandSignalItemRequest
         */
        public GetOccmDemandSignalItemRequest build() {
            GetOccmDemandSignalItemRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOccmDemandSignalItemRequest
         */
        public GetOccmDemandSignalItemRequest buildWithoutInvocationCallback() {
            GetOccmDemandSignalItemRequest request = new GetOccmDemandSignalItemRequest();
            request.occmDemandSignalItemId = occmDemandSignalItemId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetOccmDemandSignalItemRequest(occmDemandSignalItemId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccmDemandSignalItemRequest)) {
            return false;
        }

        GetOccmDemandSignalItemRequest other = (GetOccmDemandSignalItemRequest) o;
