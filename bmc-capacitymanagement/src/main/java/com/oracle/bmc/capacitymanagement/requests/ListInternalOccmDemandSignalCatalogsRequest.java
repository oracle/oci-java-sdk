...
public class ListInternalOccmDemandSignalCatalogsRequest
    ...
    /**
     * The field to sort the response of List Demand catalog API. Only one sort order may be
     * provided. The default order for name is case sensitive alphabetical order.
     */
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListInternalOccmDemandSignalCatalogsRequest as configured by this
         * builder
         *
        ...
        public ListInternalOccmDemandSignalCatalogsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListInternalOccmDemandSignalCatalogsRequest(compartmentId, occCustomerGroupId,
            // displayName, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
