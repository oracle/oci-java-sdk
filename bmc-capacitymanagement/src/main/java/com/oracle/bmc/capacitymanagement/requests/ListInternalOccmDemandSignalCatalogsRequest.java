...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalCatalogsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInternalOccmDemandSignalCatalogsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListInternalOccmDemandSignalCatalogsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListInternalOccmDemandSignalCatalogsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListInternalOccmDemandSignalCatalogsRequest o) {
        ...
        /**
         * Build the instance of ListInternalOccmDemandSignalCatalogsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListInternalOccmDemandSignalCatalogsRequest
         */
        public ListInternalOccmDemandSignalCatalogsRequest build() {
            ListInternalOccmDemandSignalCatalogsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListInternalOccmDemandSignalCatalogsRequest
         */
        public ListInternalOccmDemandSignalCatalogsRequest buildWithoutInvocationCallback() {
            ListInternalOccmDemandSignalCatalogsRequest request =
                    new ListInternalOccmDemandSignalCatalogsRequest();
            ...
            return request;
            // new ListInternalOccmDemandSignalCatalogsRequest(compartmentId, occCustomerGroupId, displayName, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalOccmDemandSignalCatalogsRequest)) {
            return false;
        }

        ListInternalOccmDemandSignalCatalogsRequest other =
                (ListInternalOccmDemandSignalCatalogsRequest) o;
