...
/**
 * An occm demand signal item is a resource that is used to communicate the forecasting need for a
 * particular resource with OCI. It's a sub-resource and need to be grouped inside a demand signal.
 * <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OccmDemandSignalItem.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OccmDemandSignalItem
    ...
    public static class Builder {
        ...
        public OccmDemandSignalItem build() {
            OccmDemandSignalItem model =
                    new OccmDemandSignalItem(
                            this.id,
                            this.compartmentId,
                            this.demandSignalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OccmDemandSignalItem model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OccmDemandSignalItem(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OccmDemandSignalItem)) {
            return false;
        }

        OccmDemandSignalItem other = (OccmDemandSignalItem) o;
