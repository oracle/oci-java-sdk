...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/UpdateOccCapacityRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOccCapacityRequestRequest.
 */
...
public class UpdateOccCapacityRequestRequest
    ...
    public static class Builder
        ...
        public UpdateOccCapacityRequestRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOccCapacityRequestRequest(updateOccCapacityRequestDetails, occCapacityRequestId, ifMatch, opcRequestId);
        }
    }
