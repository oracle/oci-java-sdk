...
/**
 * A summary model containing information about the demand signal delivery resources. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OccmDemandSignalDeliverySummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OccmDemandSignalDeliverySummary
    ...
    public OccmDemandSignalDeliverySummary(
            String id,
    ...
    public static class Builder {
         ...
         * resource.
         *
         * <p>ACCEPTED -> OCI has accepted your resource request and will deliver the quantity as
         * specified by acceptance quantity of this resource. DECLINED -> OCI has declined you
         * resource request. DELIVERED -> OCI has delivered the accepted quantity to the customers.
         *
         * <p>Note: Under extreme rare scenarios the delivery state can toggle between ACCEPTED and
         * DECLINED states
         */
        ...
        public OccmDemandSignalDeliverySummary build() {
            OccmDemandSignalDeliverySummary model =
                    new OccmDemandSignalDeliverySummary(
                            this.id,
                            this.compartmentId,
                            this.demandSignalId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OccmDemandSignalDeliverySummary model) {
     ...
     *
     * <p>ACCEPTED -> OCI has accepted your resource request and will deliver the quantity as
     * specified by acceptance quantity of this resource. DECLINED -> OCI has declined you resource
     * request. DELIVERED -> OCI has delivered the accepted quantity to the customers.
     *
     * <p>Note: Under extreme rare scenarios the delivery state can toggle between ACCEPTED and
     * DECLINED states
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OccmDemandSignalDeliverySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OccmDemandSignalDeliverySummary)) {
            return false;
        }

        OccmDemandSignalDeliverySummary other = (OccmDemandSignalDeliverySummary) o;
