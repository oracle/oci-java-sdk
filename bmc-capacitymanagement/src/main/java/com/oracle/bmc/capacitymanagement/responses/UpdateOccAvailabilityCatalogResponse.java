...
public class UpdateOccAvailabilityCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateOccAvailabilityCatalogResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateOccAvailabilityCatalogResponse o) {
         ...
         */
        @Override
        public UpdateOccAvailabilityCatalogResponse build() {
            return new UpdateOccAvailabilityCatalogResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccAvailabilityCatalogResponse)) {
            return false;
        }

        UpdateOccAvailabilityCatalogResponse other = (UpdateOccAvailabilityCatalogResponse) o;
