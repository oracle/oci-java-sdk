...
public class DeleteOccCapacityRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccCapacityRequestResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteOccCapacityRequestResponse o) {
         ...
         */
        public DeleteOccCapacityRequestResponse build() {
            return new DeleteOccCapacityRequestResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccCapacityRequestResponse)) {
            return false;
        }

        DeleteOccCapacityRequestResponse other = (DeleteOccCapacityRequestResponse) o;
