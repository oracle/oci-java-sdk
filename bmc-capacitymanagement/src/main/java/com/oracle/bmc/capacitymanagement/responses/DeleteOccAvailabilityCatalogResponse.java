...
public class DeleteOccAvailabilityCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccAvailabilityCatalogResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteOccAvailabilityCatalogResponse o) {
         ...
         */
        @Override
        public DeleteOccAvailabilityCatalogResponse build() {
            return new DeleteOccAvailabilityCatalogResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccAvailabilityCatalogResponse)) {
            return false;
        }

        DeleteOccAvailabilityCatalogResponse other = (DeleteOccAvailabilityCatalogResponse) o;
