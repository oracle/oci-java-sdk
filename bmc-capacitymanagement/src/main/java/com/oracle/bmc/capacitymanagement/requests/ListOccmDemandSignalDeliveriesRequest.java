...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListOccmDemandSignalDeliveriesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOccmDemandSignalDeliveriesRequest.
 */
...
public class ListOccmDemandSignalDeliveriesRequest
    ...
    public static class Builder
        ...
        public ListOccmDemandSignalDeliveriesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOccmDemandSignalDeliveriesRequest(compartmentId, id, occmDemandSignalItemId, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
