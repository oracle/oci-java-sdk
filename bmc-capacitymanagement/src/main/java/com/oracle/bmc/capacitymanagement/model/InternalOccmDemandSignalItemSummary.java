...
/**
 * An internal summary model containing information about the details of a demand signal items. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = InternalOccmDemandSignalItemSummary.Builder.class)
...
public final class InternalOccmDemandSignalItemSummary
    ...
    public InternalOccmDemandSignalItemSummary(
    ...
    public static class Builder {
        ...
        public InternalOccmDemandSignalItemSummary build() {
            InternalOccmDemandSignalItemSummary model =
                    new InternalOccmDemandSignalItemSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InternalOccmDemandSignalItemSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("InternalOccmDemandSignalItemSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InternalOccmDemandSignalItemSummary)) {
            return false;
        }

        InternalOccmDemandSignalItemSummary other = (InternalOccmDemandSignalItemSummary) o;
