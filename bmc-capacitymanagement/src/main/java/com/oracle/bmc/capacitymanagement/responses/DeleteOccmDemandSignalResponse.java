...
public class DeleteOccmDemandSignalResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccmDemandSignalResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<
                    DeleteOccmDemandSignalResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteOccmDemandSignalResponse o) {
         ...
         */
        @Override
        public DeleteOccmDemandSignalResponse build() {
            return new DeleteOccmDemandSignalResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccmDemandSignalResponse)) {
            return false;
        }

        DeleteOccmDemandSignalResponse other = (DeleteOccmDemandSignalResponse) o;
