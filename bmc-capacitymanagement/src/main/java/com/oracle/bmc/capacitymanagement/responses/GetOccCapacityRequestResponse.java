...
public class GetOccCapacityRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetOccCapacityRequestResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOccCapacityRequestResponse> {
         ...
         */
        @Override
        public Builder copy(GetOccCapacityRequestResponse o) {
         ...
         */
        @Override
        public GetOccCapacityRequestResponse build() {
            return new GetOccCapacityRequestResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, occCapacityRequest);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccCapacityRequestResponse)) {
            return false;
        }

        GetOccCapacityRequestResponse other = (GetOccCapacityRequestResponse) o;
