...
/**
 * An occm demand signal is a resource that communicates the forecasting needs of a customer to OCI
 * in advance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OccmDemandSignal.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OccmDemandSignal
    ...
    public static class Builder {
         ...
         * given demand signal. They transition it to IN_PROGRESS. CANCELLED -> OCI can transition
         * the demand signal to this state. COMPLETED -> OCI will transition the demand signal to
         * COMPLETED state once the quantities which OCI committed to deliver to you has been
         * delivered.
         */
        ...
        public OccmDemandSignal build() {
            OccmDemandSignal model =
                    new OccmDemandSignal(
                            this.id,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OccmDemandSignal model) {
     ...
     * signal. They transition it to IN_PROGRESS. CANCELLED -> OCI can transition the demand signal
     * to this state. COMPLETED -> OCI will transition the demand signal to COMPLETED state once the
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OccmDemandSignal)) {
            return false;
        }

        OccmDemandSignal other = (OccmDemandSignal) o;
