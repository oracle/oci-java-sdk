...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListOccmDemandSignalItemsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOccmDemandSignalItemsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListOccmDemandSignalItemsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOccmDemandSignalItemsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOccmDemandSignalItemsRequest o) {
        ...
        /**
         * Build the instance of ListOccmDemandSignalItemsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOccmDemandSignalItemsRequest
         */
        public ListOccmDemandSignalItemsRequest build() {
            ListOccmDemandSignalItemsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOccmDemandSignalItemsRequest
         */
        public ListOccmDemandSignalItemsRequest buildWithoutInvocationCallback() {
            ListOccmDemandSignalItemsRequest request = new ListOccmDemandSignalItemsRequest();
            ...
            return request;
            // new ListOccmDemandSignalItemsRequest(compartmentId, occmDemandSignalId, resourceName, demandSignalNamespace, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccmDemandSignalItemsRequest)) {
            return false;
        }

        ListOccmDemandSignalItemsRequest other = (ListOccmDemandSignalItemsRequest) o;
