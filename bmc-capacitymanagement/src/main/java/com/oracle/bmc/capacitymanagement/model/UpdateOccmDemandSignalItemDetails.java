...
/**
 * Details about different fields used to update the demand signal item. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateOccmDemandSignalItemDetails.Builder.class)
...
public final class UpdateOccmDemandSignalItemDetails
    ...
    public UpdateOccmDemandSignalItemDetails(
            String region,
    ...
    public static class Builder {
        ...
        /**
         * A map of various properties associated with the OCI resource. This parameter will act as
         * a replace parameter i.e the existing resource properties will be overridden by this
         * update.
         */
        ...
        public UpdateOccmDemandSignalItemDetails build() {
            UpdateOccmDemandSignalItemDetails model =
                    new UpdateOccmDemandSignalItemDetails(
                            this.region,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateOccmDemandSignalItemDetails model) {
    ...
    /**
     * A map of various properties associated with the OCI resource. This parameter will act as a
     * replace parameter i.e the existing resource properties will be overridden by this update.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("resourceProperties")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateOccmDemandSignalItemDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccmDemandSignalItemDetails)) {
            return false;
        }

        UpdateOccmDemandSignalItemDetails other = (UpdateOccmDemandSignalItemDetails) o;
