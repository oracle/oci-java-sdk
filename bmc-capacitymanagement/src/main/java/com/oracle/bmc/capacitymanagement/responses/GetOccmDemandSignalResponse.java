...
public class GetOccmDemandSignalResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetOccmDemandSignalResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOccmDemandSignalResponse> {
         ...
         */
        @Override
        public Builder copy(GetOccmDemandSignalResponse o) {
         ...
         */
        @Override
        public GetOccmDemandSignalResponse build() {
            return new GetOccmDemandSignalResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, occmDemandSignal);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOccmDemandSignalResponse)) {
            return false;
        }

        GetOccmDemandSignalResponse other = (GetOccmDemandSignalResponse) o;
