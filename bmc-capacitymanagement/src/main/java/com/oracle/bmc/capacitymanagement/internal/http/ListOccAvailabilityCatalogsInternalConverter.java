...
public class ListOccAvailabilityCatalogsInternalConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListOccAvailabilityCatalogsInternalConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.capacitymanagement.requests.ListOccAvailabilityCatalogsInternalRequest
                    request) {
        ...
        if (request.getCatalogState() != null) {
            target =
                    target.queryParam(
                            "catalogState",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getCatalogState().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.capacitymanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.capacitymanagement.responses.ListOccAvailabilityCatalogsInternalResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.occAvailabilityCatalogCollection(response.getItem());
