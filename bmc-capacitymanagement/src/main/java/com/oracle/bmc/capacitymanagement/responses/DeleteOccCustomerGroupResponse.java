...
public class DeleteOccCustomerGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteOccCustomerGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteOccCustomerGroupResponse o) {
         ...
         */
        public DeleteOccCustomerGroupResponse build() {
            return new DeleteOccCustomerGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOccCustomerGroupResponse)) {
            return false;
        }

        DeleteOccCustomerGroupResponse other = (DeleteOccCustomerGroupResponse) o;
