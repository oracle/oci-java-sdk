...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListOccmDemandSignalsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOccmDemandSignalsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListOccmDemandSignalsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOccmDemandSignalsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOccmDemandSignalsRequest o) {
        ...
        /**
         * Build the instance of ListOccmDemandSignalsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOccmDemandSignalsRequest
         */
        public ListOccmDemandSignalsRequest build() {
            ListOccmDemandSignalsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOccmDemandSignalsRequest
         */
        public ListOccmDemandSignalsRequest buildWithoutInvocationCallback() {
            ListOccmDemandSignalsRequest request = new ListOccmDemandSignalsRequest();
            ...
            return request;
            // new ListOccmDemandSignalsRequest(compartmentId, id, lifecycleDetails, displayName, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOccmDemandSignalsRequest)) {
            return false;
        }

        ListOccmDemandSignalsRequest other = (ListOccmDemandSignalsRequest) o;
