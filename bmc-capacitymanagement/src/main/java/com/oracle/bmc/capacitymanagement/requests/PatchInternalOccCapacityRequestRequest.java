...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/PatchInternalOccCapacityRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchInternalOccCapacityRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class PatchInternalOccCapacityRequestRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchInternalOccCapacityRequestRequest o) {
        ...
        /**
         * Build the instance of PatchInternalOccCapacityRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchInternalOccCapacityRequestRequest
         */
        public PatchInternalOccCapacityRequestRequest build() {
            PatchInternalOccCapacityRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchInternalOccCapacityRequestRequest
         */
        public PatchInternalOccCapacityRequestRequest buildWithoutInvocationCallback() {
            PatchInternalOccCapacityRequestRequest request =
                    new PatchInternalOccCapacityRequestRequest();
            ...
            return request;
            // new PatchInternalOccCapacityRequestRequest(patchOccCapacityRequestDetails, occCapacityRequestId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchInternalOccCapacityRequestRequest)) {
            return false;
        }

        PatchInternalOccCapacityRequestRequest other = (PatchInternalOccCapacityRequestRequest) o;
