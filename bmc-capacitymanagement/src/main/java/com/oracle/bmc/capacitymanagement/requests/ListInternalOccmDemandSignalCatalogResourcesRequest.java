...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/ListInternalOccmDemandSignalCatalogResourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInternalOccmDemandSignalCatalogResourcesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class ListInternalOccmDemandSignalCatalogResourcesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListInternalOccmDemandSignalCatalogResourcesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListInternalOccmDemandSignalCatalogResourcesRequest o) {
        ...
        /**
         * Build the instance of ListInternalOccmDemandSignalCatalogResourcesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListInternalOccmDemandSignalCatalogResourcesRequest
         */
         ...
         * @return instance of ListInternalOccmDemandSignalCatalogResourcesRequest
         */
        public ListInternalOccmDemandSignalCatalogResourcesRequest
                buildWithoutInvocationCallback() {
            ListInternalOccmDemandSignalCatalogResourcesRequest request =
                    new ListInternalOccmDemandSignalCatalogResourcesRequest();
            ...
            return request;
            // new ListInternalOccmDemandSignalCatalogResourcesRequest(compartmentId, occCustomerGroupId, occmDemandSignalCatalogId, name, demandSignalNamespace, limit, page, opcRequestId, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInternalOccmDemandSignalCatalogResourcesRequest)) {
            return false;
        }

        ListInternalOccmDemandSignalCatalogResourcesRequest other =
                (ListInternalOccmDemandSignalCatalogResourcesRequest) o;
