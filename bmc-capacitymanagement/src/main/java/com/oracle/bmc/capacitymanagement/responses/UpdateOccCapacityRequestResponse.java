...
public class UpdateOccCapacityRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateOccCapacityRequestResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateOccCapacityRequestResponse o) {
         ...
         */
        @Override
        public UpdateOccCapacityRequestResponse build() {
            return new UpdateOccCapacityRequestResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccCapacityRequestResponse)) {
            return false;
        }

        UpdateOccCapacityRequestResponse other = (UpdateOccCapacityRequestResponse) o;
