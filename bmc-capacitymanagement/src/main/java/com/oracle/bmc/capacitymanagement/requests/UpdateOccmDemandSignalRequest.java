...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/UpdateOccmDemandSignalExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOccmDemandSignalRequest.
 */
...
public class UpdateOccmDemandSignalRequest
    ...
    public static class Builder
        ...
        public UpdateOccmDemandSignalRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOccmDemandSignalRequest(updateOccmDemandSignalDetails, occmDemandSignalId, ifMatch, opcRequestId);
        }
    }
