...
public class UpdateOccmDemandSignalResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned OccmDemandSignal instance.
     */
    ...
    private UpdateOccmDemandSignalResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateOccmDemandSignalResponse o) {
         ...
         */
        public UpdateOccmDemandSignalResponse build() {
            return new UpdateOccmDemandSignalResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOccmDemandSignalResponse)) {
            return false;
        }

        UpdateOccmDemandSignalResponse other = (UpdateOccmDemandSignalResponse) o;
