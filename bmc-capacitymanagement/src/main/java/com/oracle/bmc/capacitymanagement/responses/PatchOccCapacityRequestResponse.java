...
public class PatchOccCapacityRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchOccCapacityRequestResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(PatchOccCapacityRequestResponse o) {
         ...
         */
        public PatchOccCapacityRequestResponse build() {
            return new PatchOccCapacityRequestResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchOccCapacityRequestResponse)) {
            return false;
        }

        PatchOccCapacityRequestResponse other = (PatchOccCapacityRequestResponse) o;
