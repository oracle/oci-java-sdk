...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/DeleteInternalOccmDemandSignalDeliveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteInternalOccmDemandSignalDeliveryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20231107")
public class DeleteInternalOccmDemandSignalDeliveryRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteInternalOccmDemandSignalDeliveryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteInternalOccmDemandSignalDeliveryRequest o) {
        ...
        /**
         * Build the instance of DeleteInternalOccmDemandSignalDeliveryRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteInternalOccmDemandSignalDeliveryRequest
         */
        public DeleteInternalOccmDemandSignalDeliveryRequest build() {
         ...
         * @return instance of DeleteInternalOccmDemandSignalDeliveryRequest
         */
        public DeleteInternalOccmDemandSignalDeliveryRequest buildWithoutInvocationCallback() {
            DeleteInternalOccmDemandSignalDeliveryRequest request =
                    new DeleteInternalOccmDemandSignalDeliveryRequest();
            request.occmDemandSignalDeliveryId = occmDemandSignalDeliveryId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteInternalOccmDemandSignalDeliveryRequest(occmDemandSignalDeliveryId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteInternalOccmDemandSignalDeliveryRequest)) {
            return false;
        }

        DeleteInternalOccmDemandSignalDeliveryRequest other =
                (DeleteInternalOccmDemandSignalDeliveryRequest) o;
