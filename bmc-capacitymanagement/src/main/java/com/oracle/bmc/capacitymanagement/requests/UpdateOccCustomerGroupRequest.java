...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/capacitymanagement/UpdateOccCustomerGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOccCustomerGroupRequest.
 */
...
public class UpdateOccCustomerGroupRequest
    ...
    public static class Builder
        ...
        public UpdateOccCustomerGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOccCustomerGroupRequest(updateOccCustomerGroupDetails, occCustomerGroupId, ifMatch, opcRequestId);
        }
    }
