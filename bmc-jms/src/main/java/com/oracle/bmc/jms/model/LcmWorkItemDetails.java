...
/**
 * The work item details with LCM related information. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LcmWorkItemDetails.Builder.class)
...
public final class LcmWorkItemDetails extends WorkItemDetails {
    ...
    public static class Builder {
        ...
        public LcmWorkItemDetails build() {
            LcmWorkItemDetails model =
                    new LcmWorkItemDetails(this.workItemType, this.postInstallationActions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LcmWorkItemDetails model) {
    ...
    @Deprecated
    public LcmWorkItemDetails(
            WorkItemType workItemType, PostInstallationActionSettings postInstallationActions) {
        super(workItemType);
        this.postInstallationActions = postInstallationActions;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LcmWorkItemDetails)) {
            return false;
        }

        LcmWorkItemDetails other = (LcmWorkItemDetails) o;
        return java.util.Objects.equals(this.postInstallationActions, other.postInstallationActions)
                && super.equals(other);
    }
