...
public class RequestDeployedApplicationMigrationAnalysesConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    RequestDeployedApplicationMigrationAnalysesConverter.class);

    public static com.oracle.bmc.jms.requests.RequestDeployedApplicationMigrationAnalysesRequest
            interceptRequest(
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getFleetId()))
                        .path("actions")
                        .path("requestDeployedApplicationMigrationAnalyses");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.jms.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jms.responses.RequestDeployedApplicationMigrationAnalysesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
