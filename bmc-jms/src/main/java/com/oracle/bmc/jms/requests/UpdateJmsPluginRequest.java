...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/UpdateJmsPluginExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateJmsPluginRequest.
 */
...
public class UpdateJmsPluginRequest
    ...
    public static class Builder
        ...
        public UpdateJmsPluginRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateJmsPluginRequest(jmsPluginId, updateJmsPluginDetails, ifMatch, opcRequestId);
        }
    }
