...
public class UpdateFleetAdvancedFeatureConfigurationResponse
    ...
    private UpdateFleetAdvancedFeatureConfigurationResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateFleetAdvancedFeatureConfigurationResponse o) {
         ...
         */
        @Override
        public UpdateFleetAdvancedFeatureConfigurationResponse build() {
            return new UpdateFleetAdvancedFeatureConfigurationResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFleetAdvancedFeatureConfigurationResponse)) {
            return false;
        }

        UpdateFleetAdvancedFeatureConfigurationResponse other =
                (UpdateFleetAdvancedFeatureConfigurationResponse) o;
