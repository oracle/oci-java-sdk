...
public class SummarizeApplicationUsageResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.jms.model.ApplicationUsageCollection getApplicationUsageCollection() {
        return applicationUsageCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder applicationUsageCollection(
                com.oracle.bmc.jms.model.ApplicationUsageCollection applicationUsageCollection) {
            this.applicationUsageCollection = applicationUsageCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",applicationUsageCollection=")
                .append(String.valueOf(applicationUsageCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeApplicationUsageResponse)) {
            return false;
        }

        SummarizeApplicationUsageResponse other = (SummarizeApplicationUsageResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.applicationUsageCollection, other.applicationUsageCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.applicationUsageCollection == null
                                ? 43
                                : this.applicationUsageCollection.hashCode());
        return result;
    }
}
