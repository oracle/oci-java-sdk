...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/SummarizeLibraryUsageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeLibraryUsageRequest.
 */
...
public class SummarizeLibraryUsageRequest
    ...
    public static class Builder
        ...
        public SummarizeLibraryUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeLibraryUsageRequest(fleetId, serverInstanceKey, managedInstanceId, applicationKey, libraryKey, libraryNameContains, libraryName, cvssScoreGreaterThan, cvssScoreLessThan, timeStart, timeEnd, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
