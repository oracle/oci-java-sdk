...
public final class DeployedApplicationInstallationUsageSummaryCollection
    ...
    public DeployedApplicationInstallationUsageSummaryCollection(
            java.util.List<DeployedApplicationInstallationUsageSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public DeployedApplicationInstallationUsageSummaryCollection build() {
            DeployedApplicationInstallationUsageSummaryCollection model =
                    new DeployedApplicationInstallationUsageSummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DeployedApplicationInstallationUsageSummaryCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeployedApplicationInstallationUsageSummaryCollection)) {
            return false;
        }

        DeployedApplicationInstallationUsageSummaryCollection other =
                (DeployedApplicationInstallationUsageSummaryCollection) o;
