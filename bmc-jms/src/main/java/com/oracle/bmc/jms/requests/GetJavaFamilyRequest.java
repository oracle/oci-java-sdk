...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/GetJavaFamilyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJavaFamilyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210610")
public class GetJavaFamilyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetJavaFamilyRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetJavaFamilyRequest
         */
        public GetJavaFamilyRequest build() {
            GetJavaFamilyRequest request = buildWithoutInvocationCallback();
        ...
        public GetJavaFamilyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetJavaFamilyRequest(familyVersion, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().familyVersion(familyVersion).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetJavaFamilyRequest other = (GetJavaFamilyRequest) o;
