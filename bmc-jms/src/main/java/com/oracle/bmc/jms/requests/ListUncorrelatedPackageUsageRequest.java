...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/ListUncorrelatedPackageUsageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUncorrelatedPackageUsageRequest.
 */
...
public class ListUncorrelatedPackageUsageRequest
    ...
    public static class Builder
        ...
        public ListUncorrelatedPackageUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUncorrelatedPackageUsageRequest(fleetId, packageName, managedInstanceId, applicationId, timeStart, timeEnd, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
