...
public class SummarizeDeployedApplicationInstallationUsageConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    SummarizeDeployedApplicationInstallationUsageConverter.class);

    public static com.oracle.bmc.jms.requests.SummarizeDeployedApplicationInstallationUsageRequest
            interceptRequest(
                    com.oracle.bmc.jms.requests.SummarizeDeployedApplicationInstallationUsageRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getFleetId()))
                        .path("actions")
                        .path("summarizeDeployedApplicationInstallationUsage");
        ...
        if (request.getApplicationSourcePathContains() != null) {
            target =
                    target.queryParam(
                            "applicationSourcePathContains",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getApplicationSourcePathContains()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.jms.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jms.responses.SummarizeDeployedApplicationInstallationUsageResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.deployedApplicationInstallationUsageSummaryCollection(
                                        response.getItem());
