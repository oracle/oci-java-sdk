...
/**
 * The details for creating a JmsPlugin. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateJmsPluginDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateJmsPluginDetails
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateJmsPluginDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateJmsPluginDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateJmsPluginDetails)) {
            return false;
        }
