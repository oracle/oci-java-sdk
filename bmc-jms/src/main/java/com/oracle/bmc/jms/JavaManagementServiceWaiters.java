...
public class JavaManagementServiceWaiters {
     ...
     * @return a new {@code com.oracle.bmc.waiter.Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetJmsPluginRequest, GetJmsPluginResponse> forJmsPlugin(
            GetJmsPluginRequest request,
            com.oracle.bmc.jms.model.JmsPluginLifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetJmsPluginRequest, GetJmsPluginResponse> forJmsPlugin(
            GetJmsPluginRequest request,
            com.oracle.bmc.jms.model.JmsPluginLifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for JmsPlugin.
    private com.oracle.bmc.waiter.Waiter<GetJmsPluginRequest, GetJmsPluginResponse> forJmsPlugin(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetJmsPluginRequest request,
            final com.oracle.bmc.jms.model.JmsPluginLifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.jms.model.JmsPluginLifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetJmsPluginResponse apply(GetJmsPluginRequest request) {
                                return client.getJmsPlugin(request);
                            }
                        },
                        new java.util.function.Predicate<GetJmsPluginResponse>() {
                            @Override
                            public boolean test(GetJmsPluginResponse response) {
                                return targetStatesSet.contains(
                                        response.getJmsPlugin().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.jms.model.JmsPluginLifecycleState.Deleted)),
                request);
    }
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetTaskScheduleRequest, GetTaskScheduleResponse>
            forTaskSchedule(
                    GetTaskScheduleRequest request,
                    com.oracle.bmc.jms.model.TaskSchedule.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forTaskSchedule(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    public com.oracle.bmc.waiter.Waiter<GetTaskScheduleRequest, GetTaskScheduleResponse>
            forTaskSchedule(
                    GetTaskScheduleRequest request,
                    com.oracle.bmc.jms.model.TaskSchedule.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for TaskSchedule.
    private com.oracle.bmc.waiter.Waiter<GetTaskScheduleRequest, GetTaskScheduleResponse>
            forTaskSchedule(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetTaskScheduleRequest request,
                    final com.oracle.bmc.jms.model.TaskSchedule.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.jms.model.TaskSchedule.LifecycleState> targetStatesSet =
                new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetTaskScheduleResponse apply(GetTaskScheduleRequest request) {
                                return client.getTaskSchedule(request);
                            }
                        },
                        new java.util.function.Predicate<GetTaskScheduleResponse>() {
                            @Override
                            public boolean test(GetTaskScheduleResponse response) {
                                return targetStatesSet.contains(
                                        response.getTaskSchedule().getLifecycleState());
                            }
                        },
                        false),
                request);
