...
public class RequestSummarizedApplicationUsageResponse
    ...
    private RequestSummarizedApplicationUsageResponse(
    ...
    public static class Builder {
        ...
        public RequestSummarizedApplicationUsageResponse build() {
            return new RequestSummarizedApplicationUsageResponse(
