...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ScanJavaServerUsageDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ScanJavaServerUsageDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"managedInstanceIds"})
    public ScanJavaServerUsageDetails(java.util.List<String> managedInstanceIds) {
        super();
    ...
    public static class Builder {
        ...
        public ScanJavaServerUsageDetails build() {
            ScanJavaServerUsageDetails model =
                    new ScanJavaServerUsageDetails(this.managedInstanceIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScanJavaServerUsageDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScanJavaServerUsageDetails)) {
            return false;
        }

        ScanJavaServerUsageDetails other = (ScanJavaServerUsageDetails) o;
