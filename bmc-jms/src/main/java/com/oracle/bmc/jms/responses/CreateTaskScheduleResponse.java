...
public class CreateTaskScheduleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTaskScheduleResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTaskScheduleResponse)) {
            return false;
        }

        CreateTaskScheduleResponse other = (CreateTaskScheduleResponse) o;
