...
public class CreateJmsPluginResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateJmsPluginResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateJmsPluginResponse> {
         ...
         */
        @Override
        public Builder copy(CreateJmsPluginResponse o) {
         ...
         */
        @Override
        public CreateJmsPluginResponse build() {
            return new CreateJmsPluginResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, jmsPlugin);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateJmsPluginResponse)) {
            return false;
        }

        CreateJmsPluginResponse other = (CreateJmsPluginResponse) o;
