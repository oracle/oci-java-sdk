...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/GetPerformanceTuningAnalysisResultExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPerformanceTuningAnalysisResultRequest.
 */
...
public class GetPerformanceTuningAnalysisResultRequest
    ...
    public static class Builder
        ...
        public Builder copy(GetPerformanceTuningAnalysisResultRequest o) {
            ...
            performanceTuningAnalysisResultId(o.getPerformanceTuningAnalysisResultId());
        ...
        public GetPerformanceTuningAnalysisResultRequest build() {
            GetPerformanceTuningAnalysisResultRequest request = buildWithoutInvocationCallback();
        ...
        public GetPerformanceTuningAnalysisResultRequest buildWithoutInvocationCallback() {
            GetPerformanceTuningAnalysisResultRequest request =
                    new GetPerformanceTuningAnalysisResultRequest();
    ...
    public String toString() {
        ...
        sb.append(",performanceTuningAnalysisResultId=")
                .append(String.valueOf(this.performanceTuningAnalysisResultId));
    ...
    public boolean equals(Object o) {
        ...
        GetPerformanceTuningAnalysisResultRequest other =
                (GetPerformanceTuningAnalysisResultRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.fleetId, other.fleetId)
                && java.util.Objects.equals(
                        this.performanceTuningAnalysisResultId,
                        other.performanceTuningAnalysisResultId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.performanceTuningAnalysisResultId == null
                                ? 43
                                : this.performanceTuningAnalysisResultId.hashCode());
