...
/**
 * Details of the request to start a JFR performance tuning analysis. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RequestPerformanceTuningAnalysesDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RequestPerformanceTuningAnalysesDetails
    ...
    public RequestPerformanceTuningAnalysesDetails(
    ...
    public static class Builder {
        ...
        public RequestPerformanceTuningAnalysesDetails build() {
            RequestPerformanceTuningAnalysesDetails model =
                    new RequestPerformanceTuningAnalysesDetails(
                            this.targets,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RequestPerformanceTuningAnalysesDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestPerformanceTuningAnalysesDetails)) {
            return false;
        }

        RequestPerformanceTuningAnalysesDetails other = (RequestPerformanceTuningAnalysesDetails) o;
