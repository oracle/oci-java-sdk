...
public class SummarizeLibraryUsageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder libraryUsageCollection(
                com.oracle.bmc.jms.model.LibraryUsageCollection libraryUsageCollection) {
            this.libraryUsageCollection = libraryUsageCollection;
            return this;
        }
        ...
        public Builder copy(SummarizeLibraryUsageResponse o) {
            ...
            libraryUsageCollection(o.getLibraryUsageCollection());
    ...
    public String toString() {
        ...
        sb.append(",libraryUsageCollection=").append(String.valueOf(libraryUsageCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeLibraryUsageResponse)) {
            return false;
        }

        SummarizeLibraryUsageResponse other = (SummarizeLibraryUsageResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.libraryUsageCollection, other.libraryUsageCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.libraryUsageCollection == null
                                ? 43
                                : this.libraryUsageCollection.hashCode());
        return result;
    }
}
