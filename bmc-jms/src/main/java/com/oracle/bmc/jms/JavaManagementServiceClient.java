...
public class JavaManagementServiceClient implements JavaManagementService {
    ...
    @Override
    public RequestSummarizedApplicationUsageResponse requestSummarizedApplicationUsage(
            RequestSummarizedApplicationUsageRequest request) {
        LOG.trace("Called requestSummarizedApplicationUsage");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getRequestSummarizedApplicationUsageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    @Override
    public RequestSummarizedInstallationUsageResponse requestSummarizedInstallationUsage(
            RequestSummarizedInstallationUsageRequest request) {
        LOG.trace("Called requestSummarizedInstallationUsage");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getRequestSummarizedInstallationUsageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    @Override
    public RequestSummarizedJreUsageResponse requestSummarizedJreUsage(
            RequestSummarizedJreUsageRequest request) {
        LOG.trace("Called requestSummarizedJreUsage");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getRequestSummarizedJreUsageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    @Override
    public RequestSummarizedManagedInstanceUsageResponse requestSummarizedManagedInstanceUsage(
            RequestSummarizedManagedInstanceUsageRequest request) {
        LOG.trace("Called requestSummarizedManagedInstanceUsage");
