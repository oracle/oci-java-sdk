...
public final class CreateDrsFileDetails
    ...
    public static class Builder {
        ...
        public CreateDrsFileDetails build() {
            CreateDrsFileDetails model =
                    new CreateDrsFileDetails(this.bucketName, this.namespace, this.drsFileName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDrsFileDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDrsFileDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDrsFileDetails)) {
            return false;
        }

        CreateDrsFileDetails other = (CreateDrsFileDetails) o;
