...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/GetJmsPluginExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJmsPluginRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210610")
public class GetJmsPluginRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetJmsPluginRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetJmsPluginRequest
         */
        public GetJmsPluginRequest build() {
            GetJmsPluginRequest request = buildWithoutInvocationCallback();
        ...
        public GetJmsPluginRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetJmsPluginRequest(jmsPluginId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().jmsPluginId(jmsPluginId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetJmsPluginRequest other = (GetJmsPluginRequest) o;
