...
public class SummarizeJavaServerInstanceUsageConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SummarizeJavaServerInstanceUsageConverter.class);

    public static com.oracle.bmc.jms.requests.SummarizeJavaServerInstanceUsageRequest
            interceptRequest(
                    com.oracle.bmc.jms.requests.SummarizeJavaServerInstanceUsageRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getFleetId()))
                        .path("actions")
                        .path("summarizeJavaServerInstanceUsage");
        ...
        if (request.getServerInstanceNameContains() != null) {
            target =
                    target.queryParam(
                            "serverInstanceNameContains",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getServerInstanceNameContains()));
        }

        if (request.getServerInstanceName() != null) {
            target =
                    target.queryParam(
                            "serverInstanceName",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getServerInstanceName()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.jms.responses.SummarizeJavaServerInstanceUsageResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.jms.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jms.responses.SummarizeJavaServerInstanceUsageResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.javaServerInstanceUsageCollection(response.getItem());
