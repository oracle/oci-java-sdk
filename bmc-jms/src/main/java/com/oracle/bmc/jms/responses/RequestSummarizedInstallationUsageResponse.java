...
@lombok.Getter
public class RequestSummarizedInstallationUsageResponse
    ...
    private RequestSummarizedInstallationUsageResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(RequestSummarizedInstallationUsageResponse o) {
        ...
        public RequestSummarizedInstallationUsageResponse build() {
            return new RequestSummarizedInstallationUsageResponse(
