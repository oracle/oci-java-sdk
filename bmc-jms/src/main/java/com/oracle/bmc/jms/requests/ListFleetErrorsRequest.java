 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFleetErrorsRequest.
 */
...
public class ListFleetErrorsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * The field to sort FleetError. Only one sort order may be provided. Default order is
    ...
    public static class Builder
        ...
        public ListFleetErrorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFleetErrorsRequest(compartmentId, compartmentIdInSubtree, fleetId,
