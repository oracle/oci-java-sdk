...
public final class PerformanceTuningAnalysisResultSummary
    ...
    public PerformanceTuningAnalysisResultSummary(
            String id,
    ...
    public static class Builder {
        ...
        public PerformanceTuningAnalysisResultSummary build() {
            PerformanceTuningAnalysisResultSummary model =
                    new PerformanceTuningAnalysisResultSummary(
                            this.id,
                            this.workRequestId,
                            this.fleetId,
                            this.applicationId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PerformanceTuningAnalysisResultSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PerformanceTuningAnalysisResultSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PerformanceTuningAnalysisResultSummary)) {
            return false;
        }

        PerformanceTuningAnalysisResultSummary other = (PerformanceTuningAnalysisResultSummary) o;
