...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = JavaMigrationAnalysisResultSummary.Builder.class)
...
public final class JavaMigrationAnalysisResultSummary
    ...
    public JavaMigrationAnalysisResultSummary(
            String id,
    ...
    public static class Builder {
        ...
        public JavaMigrationAnalysisResultSummary build() {
            JavaMigrationAnalysisResultSummary model =
                    new JavaMigrationAnalysisResultSummary(
                            this.id,
                            this.workRequestId,
                            this.fleetId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JavaMigrationAnalysisResultSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JavaMigrationAnalysisResultSummary)) {
            return false;
        }

        JavaMigrationAnalysisResultSummary other = (JavaMigrationAnalysisResultSummary) o;
