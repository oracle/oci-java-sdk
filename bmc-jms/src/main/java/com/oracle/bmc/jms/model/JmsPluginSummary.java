...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = JmsPluginSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class JmsPluginSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public JmsPluginSummary build() {
            JmsPluginSummary model =
                    new JmsPluginSummary(
                            this.id,
                            this.agentId,
                            this.agentType,
                            this.lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JmsPluginSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JmsPluginSummary)) {
            return false;
        }

        JmsPluginSummary other = (JmsPluginSummary) o;
