...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/ListWorkItemsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkItemsRequest.
 */
...
public class ListWorkItemsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListWorkItemsRequest
         */
        public ListWorkItemsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListWorkItemsRequest(workRequestId, opcRequestId, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListWorkItemsRequest)) {
            return false;
        }

        ListWorkItemsRequest other = (ListWorkItemsRequest) o;
