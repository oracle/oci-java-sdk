...
public class CreateBlocklistResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.jms.model.Blocklist getBlocklist() {
        return blocklist;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateBlocklistResponse> {
         ...
         * @return this builder
         */
        public Builder blocklist(com.oracle.bmc.jms.model.Blocklist blocklist) {
            this.blocklist = blocklist;
            return this;
        }
        ...
        public CreateBlocklistResponse build() {
            return new CreateBlocklistResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, blocklist);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",blocklist=").append(String.valueOf(blocklist));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateBlocklistResponse)) {
            return false;
        }

        CreateBlocklistResponse other = (CreateBlocklistResponse) o;
