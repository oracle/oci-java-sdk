 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTaskSchedulesRequest.
 */
...
public class ListTaskSchedulesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    private String taskScheduleNameContains;

    /** Filter the list with task schedule name contains the given value. */
    public String getTaskScheduleNameContains() {
        return taskScheduleNameContains;
    }
    ...
    /**
     * The field used to sort task schedule records. Only one sort order may be provided. Default
     * order for _timeCreated_ is **ascending**. If no value is specified, _timeCreated_ is default.
     */
    private com.oracle.bmc.jms.model.TaskScheduleSortBy sortBy;

    /**
     * The field used to sort task schedule records. Only one sort order may be provided. Default
     * order for _timeCreated_ is **ascending**. If no value is specified, _timeCreated_ is default.
     */
    public com.oracle.bmc.jms.model.TaskScheduleSortBy getSortBy() {
        return sortBy;
    }
    ...
    public static class Builder
        ...
        /** Filter the list with task schedule name contains the given value. */
        private String taskScheduleNameContains = null;

        /**
         * Filter the list with task schedule name contains the given value.
         *
         * @param taskScheduleNameContains the value to set
         * @return this builder instance
         */
         ...
         * Default order for _timeCreated_ is **ascending**. If no value is specified, _timeCreated_
         * is default.
         */
        private com.oracle.bmc.jms.model.TaskScheduleSortBy sortBy = null;
         ...
         * @return this builder instance
         */
        public Builder sortBy(com.oracle.bmc.jms.model.TaskScheduleSortBy sortBy) {
            this.sortBy = sortBy;
            return this;
        }
        ...
        public Builder copy(ListTaskSchedulesRequest o) {
            ...
            name(o.getName());
            taskScheduleNameContains(o.getTaskScheduleNameContains());
            limit(o.getLimit());
            page(o.getPage());
        ...
        public ListTaskSchedulesRequest buildWithoutInvocationCallback() {
            ...
            request.name = name;
            request.taskScheduleNameContains = taskScheduleNameContains;
            request.limit = limit;
            request.page = page;
            ...
            return request;
            // new ListTaskSchedulesRequest(fleetId, id, managedInstanceId, name,
            // taskScheduleNameContains, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",taskScheduleNameContains=")
                .append(String.valueOf(this.taskScheduleNameContains));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.taskScheduleNameContains, other.taskScheduleNameContains)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.taskScheduleNameContains == null
                                ? 43
                                : this.taskScheduleNameContains.hashCode());
