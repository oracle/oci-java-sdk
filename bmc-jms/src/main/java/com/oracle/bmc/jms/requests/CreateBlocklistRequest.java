...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/CreateBlocklistExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateBlocklistRequest.
 */
...
public class CreateBlocklistRequest
    ...
    public static class Builder
        ...
        public Builder createBlocklistDetails(
                com.oracle.bmc.jms.model.CreateBlocklistDetails createBlocklistDetails) {
        ...
        public CreateBlocklistRequest buildWithoutInvocationCallback() {
            ...
            request.createBlocklistDetails = createBlocklistDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateBlocklistRequest(fleetId, createBlocklistDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createBlocklistDetails=").append(String.valueOf(this.createBlocklistDetails));
    ...
    public boolean equals(Object o) {
        ...
        CreateBlocklistRequest other = (CreateBlocklistRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.fleetId, other.fleetId)
                && java.util.Objects.equals(
                        this.createBlocklistDetails, other.createBlocklistDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createBlocklistDetails == null
                                ? 43
                                : this.createBlocklistDetails.hashCode());
        result =
                (result * PRIME)
