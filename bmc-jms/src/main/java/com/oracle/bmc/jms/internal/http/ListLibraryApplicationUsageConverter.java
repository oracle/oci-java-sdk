...
public class ListLibraryApplicationUsageConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListLibraryApplicationUsageConverter.class);

    public static com.oracle.bmc.jms.requests.ListLibraryApplicationUsageRequest interceptRequest(
            com.oracle.bmc.jms.requests.ListLibraryApplicationUsageRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.jms.responses.ListLibraryApplicationUsageResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.jms.responses.ListLibraryApplicationUsageResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jms.responses.ListLibraryApplicationUsageResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.libraryApplicationUsageCollection(response.getItem());
