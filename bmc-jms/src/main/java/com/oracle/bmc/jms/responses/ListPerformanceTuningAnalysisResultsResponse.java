...
public class ListPerformanceTuningAnalysisResultsResponse
    ...
    public com.oracle.bmc.jms.model.PerformanceTuningAnalysisResultCollection
            getPerformanceTuningAnalysisResultCollection() {
        return performanceTuningAnalysisResultCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder performanceTuningAnalysisResultCollection(
                com.oracle.bmc.jms.model.PerformanceTuningAnalysisResultCollection
                        performanceTuningAnalysisResultCollection) {
            this.performanceTuningAnalysisResultCollection =
                    performanceTuningAnalysisResultCollection;
            return this;
        }
        ...
        public Builder copy(ListPerformanceTuningAnalysisResultsResponse o) {
            ...
            performanceTuningAnalysisResultCollection(
                    o.getPerformanceTuningAnalysisResultCollection());
    ...
    public String toString() {
        ...
        sb.append(",performanceTuningAnalysisResultCollection=")
                .append(String.valueOf(performanceTuningAnalysisResultCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPerformanceTuningAnalysisResultsResponse)) {
            return false;
        }

        ListPerformanceTuningAnalysisResultsResponse other =
                (ListPerformanceTuningAnalysisResultsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.performanceTuningAnalysisResultCollection,
                        other.performanceTuningAnalysisResultCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.performanceTuningAnalysisResultCollection == null
                                ? 43
                                : this.performanceTuningAnalysisResultCollection.hashCode());
        return result;
    }
}
