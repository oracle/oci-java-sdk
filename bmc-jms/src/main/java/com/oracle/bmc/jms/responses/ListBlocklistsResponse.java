...
public class ListBlocklistsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.jms.model.BlocklistCollection getBlocklistCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListBlocklistsResponse> {
         ...
         * @return this builder
         */
        public Builder blocklistCollection(
                com.oracle.bmc.jms.model.BlocklistCollection blocklistCollection) {
            this.blocklistCollection = blocklistCollection;
            return this;
        }
        ...
        public ListBlocklistsResponse build() {
            return new ListBlocklistsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, blocklistCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",blocklistCollection=").append(String.valueOf(blocklistCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBlocklistsResponse)) {
            return false;
        }

        ListBlocklistsResponse other = (ListBlocklistsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.blocklistCollection, other.blocklistCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.blocklistCollection == null
                                ? 43
                                : this.blocklistCollection.hashCode());
        return result;
    }
}
