...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CryptoAnalysisResult.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CryptoAnalysisResult extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CryptoAnalysisResult build() {
            CryptoAnalysisResult model =
                    new CryptoAnalysisResult(
                            this.id,
                            this.workRequestId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CryptoAnalysisResult model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CryptoAnalysisResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CryptoAnalysisResult)) {
            return false;
        }

        CryptoAnalysisResult other = (CryptoAnalysisResult) o;
