...
public class DeleteBlocklistResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteBlocklistResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteBlocklistResponse> {
        ...
        public DeleteBlocklistResponse build() {
            return new DeleteBlocklistResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBlocklistResponse)) {
            return false;
        }

        DeleteBlocklistResponse other = (DeleteBlocklistResponse) o;
