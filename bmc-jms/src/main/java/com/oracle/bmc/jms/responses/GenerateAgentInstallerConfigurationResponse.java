...
public class GenerateAgentInstallerConfigurationResponse
    ...
    private GenerateAgentInstallerConfigurationResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GenerateAgentInstallerConfigurationResponse o) {
         ...
         */
        public GenerateAgentInstallerConfigurationResponse build() {
            return new GenerateAgentInstallerConfigurationResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    contentLength,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateAgentInstallerConfigurationResponse)) {
            return false;
        }

        GenerateAgentInstallerConfigurationResponse other =
                (GenerateAgentInstallerConfigurationResponse) o;
