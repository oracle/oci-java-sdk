...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/ListContainersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListContainersRequest.
 */
...
public class ListContainersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListContainersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListContainersRequest(fleetId, managedInstanceId, displayName, applicationName, jreVersion, jreSecurityStatus, timeStartedGreaterThanOrEqualTo, timeStartedLessThanOrEqualTo, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
