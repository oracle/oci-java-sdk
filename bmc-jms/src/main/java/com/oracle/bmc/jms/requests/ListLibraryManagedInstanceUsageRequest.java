...
public class ListLibraryManagedInstanceUsageRequest
    ...
    public static class Builder
        ...
        /**
         * The field to sort library application usage summaries. Only one sort order may be
         * provided. If no value is specified _lastSeenInClasspath_ is default.
         */
        ...
        /**
         * Build the instance of ListLibraryManagedInstanceUsageRequest as configured by this
         * builder
         *
        ...
        public ListLibraryManagedInstanceUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListLibraryManagedInstanceUsageRequest(fleetId, libraryKey, applicationId,
            // managedInstanceId, hostName, hostnameContains, timeStart, timeEnd, limit, page,
