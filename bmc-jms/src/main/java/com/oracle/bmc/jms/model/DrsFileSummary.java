...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DrsFileSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DrsFileSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public DrsFileSummary build() {
            DrsFileSummary model =
                    new DrsFileSummary(
                            this.bucketName,
                            this.namespace,
                            this.drsFileName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DrsFileSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DrsFileSummary)) {
            return false;
        }

        DrsFileSummary other = (DrsFileSummary) o;
