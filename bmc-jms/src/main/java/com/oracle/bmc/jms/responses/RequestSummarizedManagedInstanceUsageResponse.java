...
public class RequestSummarizedManagedInstanceUsageResponse
    ...
    private RequestSummarizedManagedInstanceUsageResponse(
    ...
    public static class Builder {
        ...
        public RequestSummarizedManagedInstanceUsageResponse build() {
            return new RequestSummarizedManagedInstanceUsageResponse(
