...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/SummarizeManagedInstanceUsageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeManagedInstanceUsageRequest.
 */
...
public class SummarizeManagedInstanceUsageRequest
    ...
    public static class Builder
        ...
        public SummarizeManagedInstanceUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeManagedInstanceUsageRequest(fleetId, managedInstanceId, managedInstanceType, jreVendor, jreDistribution, jreVersion, installationPath, applicationId, fields, timeStart, timeEnd, limit, page, sortOrder, sortBy, opcRequestId, osFamily, hostnameContains, libraryKey);
        }
    }
