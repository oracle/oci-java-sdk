...
public class SummarizeManagedInstanceUsageRequest
     ...
     * parameter can also include 'approximateJreCount', 'approximateInstallationCount' and
     * 'approximateApplicationCount'. For example
     * 'approximateJreCount,approximateInstallationCount'.
     */
    ...
    /**
     * The field to sort managed instance views. Only one sort order may be provided. Default order
     * for _timeFirstSeen_, _timeLastSeen_, approximateJreCount_, _approximateInstallationCount_ and
     * _approximateApplicationCount_ is **descending**. Default order for _osName_ is **ascending**.
    ...
    public static class Builder
         ...
         * 'approximateInstallationCount' and 'approximateApplicationCount'. For example
         * 'approximateJreCount,approximateInstallationCount'.
         *
        ...
        /**
         * The field to sort managed instance views. Only one sort order may be provided. Default
         * order for _timeFirstSeen_, _timeLastSeen_, approximateJreCount_,
         * _approximateInstallationCount_ and _approximateApplicationCount_ is **descending**.
         * Default order for _osName_ is **ascending**. If no value is specified _timeLastSeen_ is
         * default.
         */
        ...
        public SummarizeManagedInstanceUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeManagedInstanceUsageRequest(fleetId, managedInstanceId,
            // managedInstanceType, jreVendor, jreDistribution, jreVersion, installationPath,
            // applicationId, fields, timeStart, timeEnd, limit, page, sortOrder, sortBy,
            // opcRequestId, osFamily, hostnameContains, libraryKey);
        }
    }
