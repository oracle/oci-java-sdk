...
public class UpdateJmsPluginResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateJmsPluginResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateJmsPluginResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateJmsPluginResponse o) {
         ...
         */
        @Override
        public UpdateJmsPluginResponse build() {
            return new UpdateJmsPluginResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, jmsPlugin);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateJmsPluginResponse)) {
            return false;
        }

        UpdateJmsPluginResponse other = (UpdateJmsPluginResponse) o;
