...
/**
 * Performance tuning analysis configuration <br>
...
public final class PerformanceTuningAnalysis
    ...
    public PerformanceTuningAnalysis(Boolean isEnabled) {
        super();
    ...
    public static class Builder {
        ...
        public PerformanceTuningAnalysis build() {
            PerformanceTuningAnalysis model = new PerformanceTuningAnalysis(this.isEnabled);
