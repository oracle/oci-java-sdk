...
public class SummarizeJavaServerUsageRequest
    ...
    /**
     * The field to sort Java servers. Only one sort order may be provided. If no value is specified
    ...
    public static class Builder
        ...
        /**
         * The field to sort Java servers. Only one sort order may be provided. If no value is
