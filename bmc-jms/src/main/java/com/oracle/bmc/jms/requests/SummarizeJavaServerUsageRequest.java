...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/jms/SummarizeJavaServerUsageExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeJavaServerUsageRequest.
 */
...
public class SummarizeJavaServerUsageRequest
    ...
    public static class Builder
        ...
        public SummarizeJavaServerUsageRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeJavaServerUsageRequest(fleetId, serverKey, serverNameContains, serverName, serverVersion, timeStart, timeEnd, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
