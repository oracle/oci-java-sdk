...
public class ListFleetErrorsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListFleetErrorsConverter.class);

    public static com.oracle.bmc.jms.requests.ListFleetErrorsRequest interceptRequest(
            com.oracle.bmc.jms.requests.ListFleetErrorsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210610").path("fleetErrors");
    ...
    public static java.util.function.Function<
                    javax.ws.rs.core.Response, com.oracle.bmc.jms.responses.ListFleetErrorsResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.jms.responses.ListFleetErrorsResponse>() {
                            @Override
                            public com.oracle.bmc.jms.responses.ListFleetErrorsResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.jms.responses.ListFleetErrorsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.jms.responses.ListFleetErrorsResponse.Builder
                                        builder =
                                                com.oracle.bmc.jms.responses.ListFleetErrorsResponse
                                                        .builder()
                                ...
                                builder.fleetErrorCollection(response.getItem());
