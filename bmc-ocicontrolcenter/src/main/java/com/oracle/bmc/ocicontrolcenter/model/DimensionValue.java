...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DimensionValue.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DimensionValue extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dimensionValue"})
    public DimensionValue(String dimensionValue) {
        super();
    ...
    public static class Builder {
        ...
        public DimensionValue build() {
            DimensionValue model = new DimensionValue(this.dimensionValue);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DimensionValue model) {
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.dimensionValue, other.dimensionValue)
                && super.equals(other);
    }
