...
/**
 * A summary of the source service or application emitting the metric. <br>
...
public final class NamespaceSummary
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"namespaceName"})
    public NamespaceSummary(String namespaceName) {
        super();
    ...
    public static class Builder {
        ...
        public NamespaceSummary build() {
            NamespaceSummary model = new NamespaceSummary(this.namespaceName);
