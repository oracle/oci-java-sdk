 ...
 * to any list operations of OccMetrics where multiple pages of data may be fetched.
...
public class OccMetricsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMetricProperties operation. This iterable
    ...
    public Iterable<ListMetricPropertiesResponse> listMetricPropertiesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMetricPropertiesRequest.Builder, ListMetricPropertiesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.ocicontrolcenter.model.MetricPropertySummary} objects
     * contained in responses from the listMetricProperties operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.ocicontrolcenter.model.MetricPropertySummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.ocicontrolcenter.model.NamespaceSummary} objects
     * contained in responses from the listNamespaces operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.ocicontrolcenter.model.NamespaceSummary} objects
     * contained in responses received from the service.
     */
