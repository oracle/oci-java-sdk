...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocicontrolcenter/RequestSummarizedMetricDataExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RequestSummarizedMetricDataRequest.
 */
...
public class RequestSummarizedMetricDataRequest
    ...
    public static class Builder
        ...
        public RequestSummarizedMetricDataRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RequestSummarizedMetricDataRequest(requestSummarizedMetricDataDetails, page, limit, opcRequestId);
        }
    }
