...
/**
 * Details for creating the snapshot. <br>
...
public final class CreateSnapshotDetails
    ...
    public static class Builder {
        ...
        /**
         * Name of the snapshot. This value is immutable. It must also be unique with respect to all
         * other non-DELETED snapshots on the associated file system.
         *
