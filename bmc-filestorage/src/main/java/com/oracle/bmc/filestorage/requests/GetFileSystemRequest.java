...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/GetFileSystemExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFileSystemRequest.
 */
...
public class GetFileSystemRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetFileSystemRequest, java.lang.Void> {
         ...
         * @return instance of GetFileSystemRequest
         */
        public GetFileSystemRequest buildWithoutInvocationCallback() {
            GetFileSystemRequest request = new GetFileSystemRequest();
            request.fileSystemId = fileSystemId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetFileSystemRequest(fileSystemId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().fileSystemId(fileSystemId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFileSystemRequest)) {
            return false;
        }

        GetFileSystemRequest other = (GetFileSystemRequest) o;
