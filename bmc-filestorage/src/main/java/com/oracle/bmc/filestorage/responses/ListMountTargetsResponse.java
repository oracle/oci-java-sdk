...
public class ListMountTargetsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.filestorage.model.MountTargetSummary> getItems() {
        return items;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListMountTargetsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMountTargetsResponse)) {
            return false;
        }

        ListMountTargetsResponse other = (ListMountTargetsResponse) o;
