...
public class UpdateExportSetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public UpdateExportSetResponse build() {
            return new UpdateExportSetResponse(__httpStatusCode__, etag, opcRequestId, exportSet);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExportSetResponse)) {
            return false;
        }

        UpdateExportSetResponse other = (UpdateExportSetResponse) o;
