...
public class CreateMountTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateMountTargetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMountTargetResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMountTargetResponse)) {
            return false;
        }

        CreateMountTargetResponse other = (CreateMountTargetResponse) o;
