...
public final class LdapIdmap extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LdapIdmap model) {
    ...
    public enum SchemaType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(SchemaType.class);
        ...
        public static SchemaType create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'SchemaType', returning UnknownEnumValue",
                    key);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LdapIdmap)) {
            return false;
        }

        LdapIdmap other = (LdapIdmap) o;
