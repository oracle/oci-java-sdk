 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListReplicationsRequest.
 */
...
public class ListReplicationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListReplicationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListReplicationsRequest(compartmentId, availabilityDomain, limit, page,
            // lifecycleState, displayName, id, sortBy, sortOrder, opcRequestId, fileSystemId);
        }
    }
