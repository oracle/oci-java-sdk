...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/GetMountTargetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMountTargetRequest.
 */
...
public class GetMountTargetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMountTargetRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetMountTargetRequest
         */
        public GetMountTargetRequest build() {
            GetMountTargetRequest request = buildWithoutInvocationCallback();
        ...
        public GetMountTargetRequest buildWithoutInvocationCallback() {
            GetMountTargetRequest request = new GetMountTargetRequest();
            request.mountTargetId = mountTargetId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetMountTargetRequest(mountTargetId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().mountTargetId(mountTargetId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMountTargetRequest)) {
            return false;
        }

        GetMountTargetRequest other = (GetMountTargetRequest) o;
