...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/ChangeReplicationCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeReplicationCompartmentRequest.
 */
...
public class ChangeReplicationCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeReplicationCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeReplicationCompartmentRequest(replicationId, changeReplicationCompartmentDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
