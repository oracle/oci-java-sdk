...
public class DeleteMountTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private DeleteMountTargetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteMountTargetResponse> {
        ...
        public DeleteMountTargetResponse build() {
            return new DeleteMountTargetResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMountTargetResponse)) {
            return false;
        }

        DeleteMountTargetResponse other = (DeleteMountTargetResponse) o;
