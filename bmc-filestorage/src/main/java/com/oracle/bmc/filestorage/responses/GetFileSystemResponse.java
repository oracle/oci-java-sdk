...
public class GetFileSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder fileSystem(com.oracle.bmc.filestorage.model.FileSystem fileSystem) {
            this.fileSystem = fileSystem;
            return this;
        }
        ...
        public GetFileSystemResponse build() {
            return new GetFileSystemResponse(__httpStatusCode__, etag, opcRequestId, fileSystem);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",fileSystem=").append(String.valueOf(fileSystem));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        GetFileSystemResponse other = (GetFileSystemResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.fileSystem, other.fileSystem);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.fileSystem == null ? 43 : this.fileSystem.hashCode());
        return result;
    }
}
