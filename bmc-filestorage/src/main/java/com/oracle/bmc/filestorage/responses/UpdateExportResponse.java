...
public class UpdateExportResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateExportResponse> {
        ...
        public UpdateExportResponse build() {
            return new UpdateExportResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExportResponse)) {
            return false;
        }

        UpdateExportResponse other = (UpdateExportResponse) o;
