...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/DeleteQuotaRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteQuotaRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20171215")
public class DeleteQuotaRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteQuotaRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteQuotaRuleRequest o) {
         ...
         *
         * @return instance of DeleteQuotaRuleRequest
         */
        public DeleteQuotaRuleRequest build() {
            DeleteQuotaRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteQuotaRuleRequest
         */
        public DeleteQuotaRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteQuotaRuleRequest(fileSystemId, quotaRuleId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteQuotaRuleRequest)) {
            return false;
        }

        DeleteQuotaRuleRequest other = (DeleteQuotaRuleRequest) o;
