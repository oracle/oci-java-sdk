...
/**
 * Details for creating the replication and replication target. <br>
...
public final class CreateReplicationDetails
    ...
    public static class Builder {
         ...
         * confidential information. An associated replication target will also created with the
         * same {@code displayName}. Example: {@code My replication}
         */
     ...
     * {@code displayName}. Example: {@code My replication}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("displayName")
