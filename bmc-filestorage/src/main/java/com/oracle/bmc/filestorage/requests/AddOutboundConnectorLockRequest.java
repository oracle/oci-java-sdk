...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/AddOutboundConnectorLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddOutboundConnectorLockRequest.
 */
...
public class AddOutboundConnectorLockRequest
    ...
    public static class Builder
        ...
        public AddOutboundConnectorLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddOutboundConnectorLockRequest(outboundConnectorId, addOutboundConnectorLockDetails, ifMatch, opcRequestId);
        }
    }
