...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/ChangeFileSystemCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeFileSystemCompartmentRequest.
 */
...
public class ChangeFileSystemCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeFileSystemCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeFileSystemCompartmentRequest(fileSystemId, changeFileSystemCompartmentDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
