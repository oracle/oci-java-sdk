...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/CreateFileSystemExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateFileSystemRequest.
 */
...
public class CreateFileSystemRequest
    ...
    public static class Builder
        ...
        public Builder createFileSystemDetails(
                com.oracle.bmc.filestorage.model.CreateFileSystemDetails createFileSystemDetails) {
        ...
        public CreateFileSystemRequest buildWithoutInvocationCallback() {
            ...
            request.createFileSystemDetails = createFileSystemDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateFileSystemRequest(createFileSystemDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createFileSystemDetails=").append(String.valueOf(this.createFileSystemDetails));
    ...
    public boolean equals(Object o) {
        ...
        CreateFileSystemRequest other = (CreateFileSystemRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createFileSystemDetails, other.createFileSystemDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createFileSystemDetails == null
                                ? 43
                                : this.createFileSystemDetails.hashCode());
        result =
                (result * PRIME)
