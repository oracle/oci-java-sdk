...
public class GetMountTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetMountTargetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetMountTargetResponse> {
         ...
         */
        @Override
        public Builder copy(GetMountTargetResponse o) {
        ...
        public GetMountTargetResponse build() {
            return new GetMountTargetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMountTargetResponse)) {
            return false;
        }

        GetMountTargetResponse other = (GetMountTargetResponse) o;
