...
public class ListFileSystemsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.filestorage.model.FileSystemSummary> getItems() {
        return items;
    }
    ...
    private ListFileSystemsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.filestorage.model.FileSystemSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListFileSystemsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListFileSystemsResponse)) {
            return false;
        }

        ListFileSystemsResponse other = (ListFileSystemsResponse) o;
