...
public class GetSnapshotResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetSnapshotResponse o) {
        ...
        public GetSnapshotResponse build() {
            return new GetSnapshotResponse(__httpStatusCode__, etag, opcRequestId, snapshot);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSnapshotResponse)) {
            return false;
        }
