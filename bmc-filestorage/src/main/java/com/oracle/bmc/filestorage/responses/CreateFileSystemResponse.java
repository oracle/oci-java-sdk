...
public class CreateFileSystemResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateFileSystemResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFileSystemResponse)) {
            return false;
        }

        CreateFileSystemResponse other = (CreateFileSystemResponse) o;
