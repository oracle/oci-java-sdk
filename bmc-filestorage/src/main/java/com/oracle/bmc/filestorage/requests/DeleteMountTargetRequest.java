...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/DeleteMountTargetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMountTargetRequest.
 */
...
public class DeleteMountTargetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMountTargetRequest, java.lang.Void> {
         ...
         * @return instance of DeleteMountTargetRequest
         */
        public DeleteMountTargetRequest buildWithoutInvocationCallback() {
            DeleteMountTargetRequest request = new DeleteMountTargetRequest();
            request.mountTargetId = mountTargetId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.isLockOverride = isLockOverride;
            return request;
            // new DeleteMountTargetRequest(mountTargetId, ifMatch, opcRequestId, isLockOverride);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMountTargetRequest)) {
            return false;
        }

        DeleteMountTargetRequest other = (DeleteMountTargetRequest) o;
