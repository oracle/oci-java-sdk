...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/AddReplicationLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddReplicationLockRequest.
 */
...
public class AddReplicationLockRequest
    ...
    public static class Builder
        ...
        public AddReplicationLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddReplicationLockRequest(replicationId, addReplicationLockDetails, ifMatch, opcRequestId);
        }
    }
