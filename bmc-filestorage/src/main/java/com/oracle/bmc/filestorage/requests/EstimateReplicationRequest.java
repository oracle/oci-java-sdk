 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use EstimateReplicationRequest.
 */
...
public class EstimateReplicationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public EstimateReplicationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new EstimateReplicationRequest(fileSystemId, ifMatch, opcRequestId,
            // changeRateInMBps);
        }
    }
