...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/GetSnapshotExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSnapshotRequest.
 */
...
public class GetSnapshotRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetSnapshotRequest, java.lang.Void> {
        ...
        public GetSnapshotRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSnapshotRequest(snapshotId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().snapshotId(snapshotId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSnapshotRequest)) {
            return false;
        }
