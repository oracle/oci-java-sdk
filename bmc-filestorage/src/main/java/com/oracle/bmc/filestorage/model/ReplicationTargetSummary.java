...
/**
 * Summary information for replication target. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ReplicationTargetSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ReplicationTargetSummary
    ...
    public ReplicationTargetSummary(
    ...
    public static class Builder {
         ...
         * domain as the target file system. Example: {@code Uocm:PHX-AD-1}
         */
        ...
        public ReplicationTargetSummary build() {
            ReplicationTargetSummary model =
                    new ReplicationTargetSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReplicationTargetSummary model) {
    ...
    /**
     * The availability domain the replication target is in. Must be in the same availability domain
     * as the target file system. Example: {@code Uocm:PHX-AD-1}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("availabilityDomain")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ReplicationTargetSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicationTargetSummary)) {
            return false;
        }

        ReplicationTargetSummary other = (ReplicationTargetSummary) o;
