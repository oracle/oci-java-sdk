...
public class ChangeFileSystemCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ChangeFileSystemCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeFileSystemCompartmentResponse)) {
            return false;
        }

        ChangeFileSystemCompartmentResponse other = (ChangeFileSystemCompartmentResponse) o;
