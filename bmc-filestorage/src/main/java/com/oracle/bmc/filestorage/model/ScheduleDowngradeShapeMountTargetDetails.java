...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ScheduleDowngradeShapeMountTargetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ScheduleDowngradeShapeMountTargetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"requestedThroughput"})
    public ScheduleDowngradeShapeMountTargetDetails(Long requestedThroughput) {
        super();
    ...
    public static class Builder {
        ...
        public ScheduleDowngradeShapeMountTargetDetails build() {
            ScheduleDowngradeShapeMountTargetDetails model =
                    new ScheduleDowngradeShapeMountTargetDetails(this.requestedThroughput);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleDowngradeShapeMountTargetDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleDowngradeShapeMountTargetDetails)) {
            return false;
        }

        ScheduleDowngradeShapeMountTargetDetails other =
                (ScheduleDowngradeShapeMountTargetDetails) o;
