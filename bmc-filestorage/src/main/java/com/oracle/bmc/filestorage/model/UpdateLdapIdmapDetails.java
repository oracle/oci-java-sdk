...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateLdapIdmapDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateLdapIdmapDetails
    ...
    public static class Builder {
        ...
        public UpdateLdapIdmapDetails build() {
            UpdateLdapIdmapDetails model =
                    new UpdateLdapIdmapDetails(
                            this.schemaType,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateLdapIdmapDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateLdapIdmapDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLdapIdmapDetails)) {
            return false;
        }

        UpdateLdapIdmapDetails other = (UpdateLdapIdmapDetails) o;
