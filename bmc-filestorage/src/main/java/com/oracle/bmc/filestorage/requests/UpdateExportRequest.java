...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/UpdateExportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateExportRequest.
 */
...
public class UpdateExportRequest
    ...
    public static class Builder
        ...
        /**
         * Details object for updating an export.
         * @param updateExportDetails the value to set
         * @return this builder instance
         */
        ...
        public UpdateExportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateExportRequest(exportId, updateExportDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
