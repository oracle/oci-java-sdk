...
public class UpgradeShapeMountTargetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpgradeShapeMountTargetResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpgradeShapeMountTargetResponse o) {
         ...
         */
        public UpgradeShapeMountTargetResponse build() {
            return new UpgradeShapeMountTargetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpgradeShapeMountTargetResponse)) {
            return false;
        }

        UpgradeShapeMountTargetResponse other = (UpgradeShapeMountTargetResponse) o;
