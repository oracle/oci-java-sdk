...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/RemoveOutboundConnectorLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveOutboundConnectorLockRequest.
 */
...
public class RemoveOutboundConnectorLockRequest
    ...
    public static class Builder
        ...
        public RemoveOutboundConnectorLockRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RemoveOutboundConnectorLockRequest(outboundConnectorId, removeOutboundConnectorLockDetails, ifMatch, opcRequestId);
        }
    }
