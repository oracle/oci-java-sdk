...
/**
 * Kerberos details needed to update configuration. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateKerberosDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateKerberosDetails
    ...
    public static class Builder {
        ...
        public UpdateKerberosDetails build() {
            UpdateKerberosDetails model =
                    new UpdateKerberosDetails(
                            this.kerberosRealm,
                            this.keyTabSecretId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateKerberosDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateKerberosDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateKerberosDetails)) {
            return false;
        }

        UpdateKerberosDetails other = (UpdateKerberosDetails) o;
