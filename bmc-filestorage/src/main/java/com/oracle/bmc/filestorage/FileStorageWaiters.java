...
public class FileStorageWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<
        ...
        return forFilesystemSnapshotPolicy(
                com.oracle.bmc.waiter.Waiters.DEFAULT_POLLING_WAITER, request, targetStates);
    }
    ...
    // Helper method to create a new Waiter for FilesystemSnapshotPolicy.
    private com.oracle.bmc.waiter.Waiter<
                    GetFilesystemSnapshotPolicyRequest, GetFilesystemSnapshotPolicyResponse>
            forFilesystemSnapshotPolicy(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetFilesystemSnapshotPolicyRequest request,
                    final com.oracle.bmc.filestorage.model.FilesystemSnapshotPolicy.LifecycleState
                                    ...
                            targetStates) {
        final java.util.Set<
                        com.oracle.bmc.filestorage.model.FilesystemSnapshotPolicy.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetFilesystemSnapshotPolicyResponse apply(
                                    GetFilesystemSnapshotPolicyRequest request) {
                                return client.getFilesystemSnapshotPolicy(request);
                            }
                        },
                        new java.util.function.Predicate<GetFilesystemSnapshotPolicyResponse>() {
                            @Override
                            public boolean test(GetFilesystemSnapshotPolicyResponse response) {
                                return targetStatesSet.contains(
                                        response.getFilesystemSnapshotPolicy().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetOutboundConnectorRequest, GetOutboundConnectorResponse>
    ...
    public com.oracle.bmc.waiter.Waiter<GetOutboundConnectorRequest, GetOutboundConnectorResponse>
            forOutboundConnector(
                    GetOutboundConnectorRequest request,
                    com.oracle.bmc.filestorage.model.OutboundConnector.LifecycleState targetState,
                    com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
                    com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for OutboundConnector.
    private com.oracle.bmc.waiter.Waiter<GetOutboundConnectorRequest, GetOutboundConnectorResponse>
            forOutboundConnector(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetOutboundConnectorRequest request,
                    final com.oracle.bmc.filestorage.model.OutboundConnector.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.filestorage.model.OutboundConnector.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetOutboundConnectorResponse apply(
                                    GetOutboundConnectorRequest request) {
                                return client.getOutboundConnector(request);
                            }
                        },
                        new java.util.function.Predicate<GetOutboundConnectorResponse>() {
                            @Override
                            public boolean test(GetOutboundConnectorResponse response) {
                                return targetStatesSet.contains(
                                        response.getOutboundConnector().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.filestorage.model.OutboundConnector.LifecycleState
