...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/filestorage/GetExportSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetExportSetRequest.
 */
...
public class GetExportSetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetExportSetRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetExportSetRequest
         */
        public GetExportSetRequest build() {
            GetExportSetRequest request = buildWithoutInvocationCallback();
        ...
        public GetExportSetRequest buildWithoutInvocationCallback() {
            GetExportSetRequest request = new GetExportSetRequest();
            request.exportSetId = exportSetId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetExportSetRequest(exportSetId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().exportSetId(exportSetId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExportSetRequest)) {
            return false;
        }

        GetExportSetRequest other = (GetExportSetRequest) o;
