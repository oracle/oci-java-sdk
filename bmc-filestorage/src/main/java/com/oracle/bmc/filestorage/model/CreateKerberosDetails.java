...
public final class CreateKerberosDetails
    ...
    public static class Builder {
        ...
        public CreateKerberosDetails build() {
            CreateKerberosDetails model =
                    new CreateKerberosDetails(
                            this.kerberosRealm,
                            this.keyTabSecretId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateKerberosDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKerberosDetails)) {
            return false;
        }

        CreateKerberosDetails other = (CreateKerberosDetails) o;
