...
public class CreateFileSystemDetails {
    ...
    public static class Builder {
        ...
        public CreateFileSystemDetails build() {
            CreateFileSystemDetails __instance__ =
                    new CreateFileSystemDetails(availabilityDomain, compartmentId, displayName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateFileSystemDetails o) {
