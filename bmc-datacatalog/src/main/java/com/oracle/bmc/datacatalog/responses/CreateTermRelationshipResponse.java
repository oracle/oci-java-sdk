...
public class CreateTermRelationshipResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateTermRelationshipResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateTermRelationshipResponse o) {
        ...
        public CreateTermRelationshipResponse build() {
            return new CreateTermRelationshipResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTermRelationshipResponse)) {
            return false;
        }

        CreateTermRelationshipResponse other = (CreateTermRelationshipResponse) o;
