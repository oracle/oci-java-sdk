...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/AddCatalogLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddCatalogLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190325")
public class AddCatalogLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddCatalogLockRequest o) {
        ...
        /**
         * Build the instance of AddCatalogLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddCatalogLockRequest
         */
        public AddCatalogLockRequest build() {
            AddCatalogLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddCatalogLockRequest
         */
        public AddCatalogLockRequest buildWithoutInvocationCallback() {
            AddCatalogLockRequest request = new AddCatalogLockRequest();
            request.catalogId = catalogId;
            request.addResourceLockDetails = addResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new AddCatalogLockRequest(catalogId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddCatalogLockRequest)) {
            return false;
        }

        AddCatalogLockRequest other = (AddCatalogLockRequest) o;
