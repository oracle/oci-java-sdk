...
/**
 * Properties used in custom property create operations. <br>
...
public final class CreateNamespaceDetails
    ...
    public static class Builder {
        ...
        public CreateNamespaceDetails build() {
            CreateNamespaceDetails model =
                    new CreateNamespaceDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNamespaceDetails model) {
