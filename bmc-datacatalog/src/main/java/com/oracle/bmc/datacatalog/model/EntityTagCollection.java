...
public final class EntityTagCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * @return this builder
         **/
        public Builder items(java.util.List<EntityTagSummary> items) {
            this.items = items;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<EntityTagSummary> items;

    /**
     * Collection of entity tags.
     * @return the value
     **/
    public java.util.List<EntityTagSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityTagCollection)) {
            return false;
        }
