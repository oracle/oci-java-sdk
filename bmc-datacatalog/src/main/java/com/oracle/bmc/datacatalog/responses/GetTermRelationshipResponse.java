...
public class GetTermRelationshipResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTermRelationshipResponse> {
         ...
         */
        @Override
        public GetTermRelationshipResponse build() {
            return new GetTermRelationshipResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTermRelationshipResponse)) {
            return false;
        }

        GetTermRelationshipResponse other = (GetTermRelationshipResponse) o;
