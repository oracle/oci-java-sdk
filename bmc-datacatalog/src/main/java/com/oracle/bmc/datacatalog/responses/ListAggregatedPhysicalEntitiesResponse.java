...
public class ListAggregatedPhysicalEntitiesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public ListAggregatedPhysicalEntitiesResponse build() {
            return new ListAggregatedPhysicalEntitiesResponse(
                    __httpStatusCode__, headers, opcRequestId, entityCollection);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAggregatedPhysicalEntitiesResponse)) {
            return false;
        }

        ListAggregatedPhysicalEntitiesResponse other = (ListAggregatedPhysicalEntitiesResponse) o;
