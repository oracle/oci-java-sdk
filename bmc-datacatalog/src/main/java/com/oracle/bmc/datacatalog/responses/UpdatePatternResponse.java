...
public class UpdatePatternResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdatePatternResponse> {
         ...
         */
        @Override
        public UpdatePatternResponse build() {
            return new UpdatePatternResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, pattern);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePatternResponse)) {
            return false;
        }

        UpdatePatternResponse other = (UpdatePatternResponse) o;
