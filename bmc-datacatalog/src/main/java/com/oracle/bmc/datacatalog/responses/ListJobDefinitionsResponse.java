...
public class ListJobDefinitionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.datacatalog.model.JobDefinitionCollection getJobDefinitionCollection() {
        return jobDefinitionCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder jobDefinitionCollection(
                com.oracle.bmc.datacatalog.model.JobDefinitionCollection jobDefinitionCollection) {
            this.jobDefinitionCollection = jobDefinitionCollection;
            return this;
        }
        ...
        public Builder copy(ListJobDefinitionsResponse o) {
            ...
            jobDefinitionCollection(o.getJobDefinitionCollection());
        ...
        public ListJobDefinitionsResponse build() {
            return new ListJobDefinitionsResponse(
                    __httpStatusCode__, opcRequestId, opcNextPage, jobDefinitionCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",jobDefinitionCollection=").append(String.valueOf(jobDefinitionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListJobDefinitionsResponse)) {
            return false;
        }

        ListJobDefinitionsResponse other = (ListJobDefinitionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.jobDefinitionCollection, other.jobDefinitionCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.jobDefinitionCollection == null
                                ? 43
                                : this.jobDefinitionCollection.hashCode());
        return result;
    }
}
