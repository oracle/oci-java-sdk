...
public class ChangeCatalogPrivateEndpointCompartmentResponse
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeCatalogPrivateEndpointCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeCatalogPrivateEndpointCompartmentResponse)) {
            return false;
        }

        ChangeCatalogPrivateEndpointCompartmentResponse other =
                (ChangeCatalogPrivateEndpointCompartmentResponse) o;
