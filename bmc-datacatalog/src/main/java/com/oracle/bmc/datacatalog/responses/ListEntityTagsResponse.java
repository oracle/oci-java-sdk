...
public class ListEntityTagsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.datacatalog.model.EntityTagCollection getEntityTagCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListEntityTagsResponse> {
         ...
         * @return this builder
         */
        public Builder entityTagCollection(
                com.oracle.bmc.datacatalog.model.EntityTagCollection entityTagCollection) {
            this.entityTagCollection = entityTagCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",entityTagCollection=").append(String.valueOf(entityTagCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListEntityTagsResponse)) {
            return false;
        }

        ListEntityTagsResponse other = (ListEntityTagsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.entityTagCollection, other.entityTagCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.entityTagCollection == null
                                ? 43
                                : this.entityTagCollection.hashCode());
        return result;
    }
}
