...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/AssociateCustomPropertyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AssociateCustomPropertyRequest.
 */
...
public class AssociateCustomPropertyRequest
    ...
    public static class Builder
        ...
        public Builder associateCustomPropertyDetails(
                com.oracle.bmc.datacatalog.model.TypeCustomPropertyDetails
                        associateCustomPropertyDetails) {
            this.associateCustomPropertyDetails = associateCustomPropertyDetails;
            return this;
        }
         ...
         * @return instance of AssociateCustomPropertyRequest
         */
        public AssociateCustomPropertyRequest buildWithoutInvocationCallback() {
            AssociateCustomPropertyRequest request = new AssociateCustomPropertyRequest();
            request.catalogId = catalogId;
            request.typeKey = typeKey;
            request.associateCustomPropertyDetails = associateCustomPropertyDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new AssociateCustomPropertyRequest(catalogId, typeKey, associateCustomPropertyDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                .catalogId(catalogId)
                .typeKey(typeKey)
                .associateCustomPropertyDetails(associateCustomPropertyDetails)
    ...
    public String toString() {
        ...
        sb.append(",associateCustomPropertyDetails=")
                .append(String.valueOf(this.associateCustomPropertyDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssociateCustomPropertyRequest)) {
            return false;
        }

        AssociateCustomPropertyRequest other = (AssociateCustomPropertyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.catalogId, other.catalogId)
                && java.util.Objects.equals(this.typeKey, other.typeKey)
                && java.util.Objects.equals(
                        this.associateCustomPropertyDetails, other.associateCustomPropertyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.associateCustomPropertyDetails == null
                                ? 43
                                : this.associateCustomPropertyDetails.hashCode());
