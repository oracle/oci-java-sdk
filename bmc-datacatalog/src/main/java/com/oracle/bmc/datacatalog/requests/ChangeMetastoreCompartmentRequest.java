...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ChangeMetastoreCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeMetastoreCompartmentRequest.
 */
...
public class ChangeMetastoreCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeMetastoreCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeMetastoreCompartmentRequest(changeMetastoreCompartmentDetails, metastoreId, ifMatch, opcRequestId, isLockOverride);
        }
    }
