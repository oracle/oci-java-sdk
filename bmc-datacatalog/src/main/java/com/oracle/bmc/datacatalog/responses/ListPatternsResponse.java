...
public class ListPatternsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.datacatalog.model.PatternCollection getPatternCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListPatternsResponse> {
         ...
         * @return this builder
         */
        public Builder patternCollection(
                com.oracle.bmc.datacatalog.model.PatternCollection patternCollection) {
            this.patternCollection = patternCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",patternCollection=").append(String.valueOf(patternCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPatternsResponse)) {
            return false;
        }

        ListPatternsResponse other = (ListPatternsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.patternCollection, other.patternCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.patternCollection == null ? 43 : this.patternCollection.hashCode());
        return result;
    }
}
