...
public class ListCustomPropertiesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datacatalog.model.CustomPropertyCollection getCustomPropertyCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListCustomPropertiesResponse> {
         ...
         * @return this builder
         */
        public Builder customPropertyCollection(
    ...
    public String toString() {
        ...
        sb.append(",customPropertyCollection=").append(String.valueOf(customPropertyCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCustomPropertiesResponse)) {
            return false;
        }

        ListCustomPropertiesResponse other = (ListCustomPropertiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.customPropertyCollection, other.customPropertyCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.customPropertyCollection == null
                                ? 43
                                : this.customPropertyCollection.hashCode());
        return result;
    }
}
