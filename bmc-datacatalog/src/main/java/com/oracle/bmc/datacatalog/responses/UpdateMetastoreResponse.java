...
public class UpdateMetastoreResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateMetastoreResponse> {
        ...
        public UpdateMetastoreResponse build() {
            return new UpdateMetastoreResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMetastoreResponse)) {
            return false;
        }

        UpdateMetastoreResponse other = (UpdateMetastoreResponse) o;
