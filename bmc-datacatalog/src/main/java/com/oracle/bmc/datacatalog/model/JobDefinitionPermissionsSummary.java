...
/**
 * Permissions object for job definitions. <br>
...
public final class JobDefinitionPermissionsSummary
    ...
    public static class Builder {
        ...
        public JobDefinitionPermissionsSummary build() {
            JobDefinitionPermissionsSummary model =
                    new JobDefinitionPermissionsSummary(
                            this.jobDefinitionKey, this.userPermissions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JobDefinitionPermissionsSummary model) {
