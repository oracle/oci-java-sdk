...
public class UpdateNamespaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public UpdateNamespaceResponse build() {
            return new UpdateNamespaceResponse(__httpStatusCode__, etag, opcRequestId, namespace);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNamespaceResponse)) {
            return false;
        }

        UpdateNamespaceResponse other = (UpdateNamespaceResponse) o;
