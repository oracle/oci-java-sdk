...
public final class UpdateTermRelationshipDetails {
    ...
    public static class Builder {
        ...
        public UpdateTermRelationshipDetails build() {
            UpdateTermRelationshipDetails __instance__ =
                    new UpdateTermRelationshipDetails(displayName, description);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTermRelationshipDetails o) {
