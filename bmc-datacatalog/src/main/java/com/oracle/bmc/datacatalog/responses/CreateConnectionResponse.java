...
public class CreateConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.datacatalog.model.Connection getConnection() {
        return connection;
    }
    ...
    public static class Builder {
        ...
        public Builder connection(com.oracle.bmc.datacatalog.model.Connection connection) {
            this.connection = connection;
            return this;
        }
        ...
        public CreateConnectionResponse build() {
            return new CreateConnectionResponse(__httpStatusCode__, etag, opcRequestId, connection);
        }
    }
