...
/**
 * Results of a data assets listing. A data asset is often synonymous with a 'System', such as a
 * database, or may be a file container or a message stream. <br>
...
public final class DataAssetCollection
    ...
    public static class Builder {
        ...
        public DataAssetCollection build() {
            DataAssetCollection model = new DataAssetCollection(this.count, this.items);
