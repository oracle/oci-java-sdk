...
public class UpdateEntityResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateEntityResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateEntityResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEntityResponse)) {
            return false;
        }

        UpdateEntityResponse other = (UpdateEntityResponse) o;
