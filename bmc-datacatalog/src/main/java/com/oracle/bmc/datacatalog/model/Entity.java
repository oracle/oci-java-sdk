...
/**
 * Data entity details. A representation of data with a set of attributes, normally representing a
 * single business entity. Synonymous with 'table' or 'view' in a database, or a single logical file
 * structure that one or many files may match. <br>
...
public final class Entity extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * Time that the data entities status was last updated. An
         * [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
         */
