...
/**
 * Specifies the file contents to be imported. <br>
...
public final class ImportDataAssetDetails
    ...
    public static class Builder {
        ...
        public ImportDataAssetDetails build() {
            ImportDataAssetDetails model = new ImportDataAssetDetails(this.importFileContents);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportDataAssetDetails model) {
            if (model.wasPropertyExplicitlySet("importFileContents")) {
                this.importFileContents(model.getImportFileContents());
            }
            return this;
        }
    }
