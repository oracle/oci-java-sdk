...
public class ImportConnectionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ImportConnectionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportConnectionResponse)) {
            return false;
        }

        ImportConnectionResponse other = (ImportConnectionResponse) o;
