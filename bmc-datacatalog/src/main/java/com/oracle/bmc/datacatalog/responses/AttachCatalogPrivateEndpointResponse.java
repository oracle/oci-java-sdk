...
public class AttachCatalogPrivateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private AttachCatalogPrivateEndpointResponse(
    ...
    public static class Builder {
         ...
         */
        public AttachCatalogPrivateEndpointResponse build() {
            return new AttachCatalogPrivateEndpointResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachCatalogPrivateEndpointResponse)) {
            return false;
        }

        AttachCatalogPrivateEndpointResponse other = (AttachCatalogPrivateEndpointResponse) o;
