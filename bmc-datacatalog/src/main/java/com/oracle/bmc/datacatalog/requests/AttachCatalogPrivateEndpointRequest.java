...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/AttachCatalogPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachCatalogPrivateEndpointRequest.
 */
...
public class AttachCatalogPrivateEndpointRequest
    ...
    public static class Builder
        ...
        /**
         * Details for private reverse connection endpoint to be used for attachment.
         * @param attachCatalogPrivateEndpointDetails the value to set
        ...
        public AttachCatalogPrivateEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AttachCatalogPrivateEndpointRequest(attachCatalogPrivateEndpointDetails, catalogId, ifMatch, opcRequestId, opcRetryToken, isLockOverride);
        }
    }
