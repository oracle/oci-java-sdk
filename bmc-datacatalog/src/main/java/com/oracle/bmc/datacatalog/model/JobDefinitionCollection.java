...
/**
 * Results of a job definition listing. Job definitions are resources that describe the scope and
 * type of jobs (eg: harvest, profiling, sampling) that are defined by users in the system. <br>
