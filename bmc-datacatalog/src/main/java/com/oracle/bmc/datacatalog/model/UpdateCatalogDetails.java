...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateCatalogDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateCatalogDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "freeformTags", "definedTags"})
    public UpdateCatalogDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateCatalogDetails build() {
            UpdateCatalogDetails model =
                    new UpdateCatalogDetails(this.displayName, this.freeformTags, this.definedTags);
