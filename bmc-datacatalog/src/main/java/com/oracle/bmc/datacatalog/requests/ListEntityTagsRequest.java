...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListEntityTagsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEntityTagsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190325")
public class ListEntityTagsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListEntityTagsRequest, java.lang.Void> {
        ...
        /**
         * Singular setter. Specifies the fields to return in an entity tag summary response.
         *
         ...
         * @return this builder instance
         */
        public Builder copy(ListEntityTagsRequest o) {
        ...
        /**
         * Build the instance of ListEntityTagsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListEntityTagsRequest
         */
        public ListEntityTagsRequest build() {
            ListEntityTagsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListEntityTagsRequest
         */
        public ListEntityTagsRequest buildWithoutInvocationCallback() {
            ListEntityTagsRequest request = new ListEntityTagsRequest();
            ...
            return request;
            // new ListEntityTagsRequest(catalogId, dataAssetKey, entityKey, name, lifecycleState, termKey, termPath, timeCreated, createdById, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListEntityTagsRequest)) {
            return false;
        }

        ListEntityTagsRequest other = (ListEntityTagsRequest) o;
