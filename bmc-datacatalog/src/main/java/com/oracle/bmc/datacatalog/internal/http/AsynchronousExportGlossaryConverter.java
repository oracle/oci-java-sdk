...
public class AsynchronousExportGlossaryConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AsynchronousExportGlossaryConverter.class);

    public static com.oracle.bmc.datacatalog.requests.AsynchronousExportGlossaryRequest
            interceptRequest(
                    com.oracle.bmc.datacatalog.requests.AsynchronousExportGlossaryRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.datacatalog.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.datacatalog.responses.AsynchronousExportGlossaryResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.asynchronousExportGlossaryResult(response.getItem());
