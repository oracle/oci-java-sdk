...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/DisassociateCustomPropertyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DisassociateCustomPropertyRequest.
 */
...
public class DisassociateCustomPropertyRequest
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.datacatalog.model.TypeCustomPropertyDetails
                disassociateCustomPropertyDetails = null;

        /**
         * The information used to remove the custom properties.
         *
         * @param disassociateCustomPropertyDetails the value to set
         * @return this builder instance
         */
        public Builder disassociateCustomPropertyDetails(
                com.oracle.bmc.datacatalog.model.TypeCustomPropertyDetails
                        disassociateCustomPropertyDetails) {
            this.disassociateCustomPropertyDetails = disassociateCustomPropertyDetails;
            return this;
        }
        ...
        public DisassociateCustomPropertyRequest buildWithoutInvocationCallback() {
            DisassociateCustomPropertyRequest request = new DisassociateCustomPropertyRequest();
            request.catalogId = catalogId;
            request.typeKey = typeKey;
            request.disassociateCustomPropertyDetails = disassociateCustomPropertyDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new DisassociateCustomPropertyRequest(catalogId, typeKey, disassociateCustomPropertyDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                .catalogId(catalogId)
                .typeKey(typeKey)
                .disassociateCustomPropertyDetails(disassociateCustomPropertyDetails)
    ...
    public String toString() {
        ...
        sb.append(",disassociateCustomPropertyDetails=")
                .append(String.valueOf(this.disassociateCustomPropertyDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisassociateCustomPropertyRequest)) {
            return false;
        }

        DisassociateCustomPropertyRequest other = (DisassociateCustomPropertyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.catalogId, other.catalogId)
                && java.util.Objects.equals(this.typeKey, other.typeKey)
                && java.util.Objects.equals(
                        this.disassociateCustomPropertyDetails,
                        other.disassociateCustomPropertyDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.disassociateCustomPropertyDetails == null
                                ? 43
                                : this.disassociateCustomPropertyDetails.hashCode());
