...
public class UploadCredentialsDetails {
    ...
    public static class Builder {
        ...
        public UploadCredentialsDetails build() {
            UploadCredentialsDetails __instance__ =
                    new UploadCredentialsDetails(connectionDetail, credentialPayload);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UploadCredentialsDetails o) {
            Builder copiedBuilder =
                    connectionDetail(o.getConnectionDetail())
                            .credentialPayload(o.getCredentialPayload());
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("connectionDetail")
    UpdateConnectionDetails connectionDetail;
