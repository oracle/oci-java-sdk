...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/GetGlossaryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetGlossaryRequest.
 */
...
public class GetGlossaryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetGlossaryRequest build() {
            GetGlossaryRequest request = buildWithoutInvocationCallback();
        ...
        public GetGlossaryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetGlossaryRequest(catalogId, glossaryKey, fields, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGlossaryRequest)) {
            return false;
        }

        GetGlossaryRequest other = (GetGlossaryRequest) o;
