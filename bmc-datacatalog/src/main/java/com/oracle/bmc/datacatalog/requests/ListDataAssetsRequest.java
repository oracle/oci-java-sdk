...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListDataAssetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDataAssetsRequest.
 */
...
public class ListDataAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Specifies the fields to return in a data asset summary response.
         *
        ...
        public ListDataAssetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataAssetsRequest(catalogId, displayName, displayNameContains, lifecycleState, timeCreated, timeUpdated, createdById, updatedById, externalKey, typeKey, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
