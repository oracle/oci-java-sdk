...
public class ListDataAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDataAssetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataAssetsRequest(catalogId, displayName, displayNameContains,
            // lifecycleState, timeCreated, timeUpdated, createdById, updatedById, externalKey,
            // typeKey, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
