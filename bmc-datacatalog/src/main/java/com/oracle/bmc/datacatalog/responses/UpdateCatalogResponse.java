...
public class UpdateCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateCatalogResponse> {
        ...
        public UpdateCatalogResponse build() {
            return new UpdateCatalogResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, catalog);
        }
    }
