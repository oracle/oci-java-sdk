...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListDerivedLogicalEntitiesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDerivedLogicalEntitiesRequest.
 */
...
public class ListDerivedLogicalEntitiesRequest
    ...
    public static class Builder
        ...
        public ListDerivedLogicalEntitiesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDerivedLogicalEntitiesRequest(catalogId, patternKey, displayNameContains, sortBy, sortOrder, limit, page, opcRequestId, ifMatch, opcRetryToken);
        }
    }
