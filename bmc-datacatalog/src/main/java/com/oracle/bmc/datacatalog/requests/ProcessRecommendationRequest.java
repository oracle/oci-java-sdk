...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ProcessRecommendationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ProcessRecommendationRequest.
 */
...
public class ProcessRecommendationRequest
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.datacatalog.model.ProcessRecommendationDetails
                processRecommendationDetails = null;
        ...
        /**
         * Build the instance of ProcessRecommendationRequest as configured by this builder
         *
         ...
         *
         * @return instance of ProcessRecommendationRequest
         */
        public ProcessRecommendationRequest build() {
            ProcessRecommendationRequest request = buildWithoutInvocationCallback();
        ...
        public ProcessRecommendationRequest buildWithoutInvocationCallback() {
            ProcessRecommendationRequest request = new ProcessRecommendationRequest();
            request.catalogId = catalogId;
            request.processRecommendationDetails = processRecommendationDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ProcessRecommendationRequest(catalogId, processRecommendationDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",processRecommendationDetails=")
                .append(String.valueOf(this.processRecommendationDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessRecommendationRequest)) {
            return false;
        }

        ProcessRecommendationRequest other = (ProcessRecommendationRequest) o;
