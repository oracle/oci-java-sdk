...
public class ListConnectionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    /**
     * Time that the resource's status was last updated. An
    ...
    public static class Builder
        ...
        public ListConnectionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListConnectionsRequest(catalogId, dataAssetKey, displayName, displayNameContains,
            // lifecycleState, timeCreated, timeUpdated, createdById, updatedById, externalKey,
            // timeStatusUpdated, isDefault, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
