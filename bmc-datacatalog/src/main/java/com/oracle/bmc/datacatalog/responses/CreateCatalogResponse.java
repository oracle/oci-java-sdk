...
public class CreateCatalogResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateCatalogResponse o) {
        ...
        public CreateCatalogResponse build() {
            return new CreateCatalogResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCatalogResponse)) {
            return false;
        }

        CreateCatalogResponse other = (CreateCatalogResponse) o;
