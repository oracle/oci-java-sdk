...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListFoldersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFoldersRequest.
 */
...
public class ListFoldersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListFoldersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFoldersRequest(catalogId, dataAssetKey, displayName, businessName, displayOrBusinessNameContains, displayNameContains, lifecycleState, parentFolderKey, path, externalKey, timeCreated, timeUpdated, createdById, updatedById, harvestStatus, lastJobKey, fields, typeKey, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
