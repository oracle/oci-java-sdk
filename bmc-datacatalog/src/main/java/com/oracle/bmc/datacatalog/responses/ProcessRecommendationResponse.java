...
public class ProcessRecommendationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ProcessRecommendationResponse> {
    ...
    public String toString() {
        ...
        sb.append(",processRecommendationDetails=")
                .append(String.valueOf(processRecommendationDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProcessRecommendationResponse)) {
            return false;
        }

        ProcessRecommendationResponse other = (ProcessRecommendationResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.processRecommendationDetails, other.processRecommendationDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.processRecommendationDetails == null
                                ? 43
                                : this.processRecommendationDetails.hashCode());
        return result;
    }
}
