...
/**
 * Results of a data entities listing. Data entities are representation of a dataset with a set of
 * attributes. <br>
...
public final class EntityCollection
    ...
    public static class Builder {
        ...
        public EntityCollection build() {
            EntityCollection model = new EntityCollection(this.count, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityCollection model) {
