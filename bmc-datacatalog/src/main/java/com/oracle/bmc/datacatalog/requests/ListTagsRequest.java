...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListTagsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTagsRequest.
 */
...
public class ListTagsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListTagsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTagsRequest(catalogId, displayName, displayNameContains, lifecycleState, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
