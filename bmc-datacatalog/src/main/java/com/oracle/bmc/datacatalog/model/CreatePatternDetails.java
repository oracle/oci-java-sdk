...
public final class CreatePatternDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreatePatternDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreatePatternDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePatternDetails)) {
            return false;
        }

        CreatePatternDetails other = (CreatePatternDetails) o;
