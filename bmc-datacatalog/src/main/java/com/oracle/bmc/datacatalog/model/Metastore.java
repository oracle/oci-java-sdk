...
public final class Metastore {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Metastore o) {
            Builder copiedBuilder =
                    id(o.getId())
                            ...
                            .defaultManagedTableLocation(o.getDefaultManagedTableLocation())
                            .defaultExternalTableLocation(o.getDefaultExternalTableLocation())
