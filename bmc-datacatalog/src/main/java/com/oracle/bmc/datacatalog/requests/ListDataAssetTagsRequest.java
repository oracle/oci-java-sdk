 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDataAssetTagsRequest.
 */
...
public class ListDataAssetTagsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDataAssetTagsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataAssetTagsRequest(catalogId, dataAssetKey, name, lifecycleState, termKey,
            // termPath, timeCreated, createdById, fields, sortBy, sortOrder, limit, page,
            // opcRequestId);
        }
    }
