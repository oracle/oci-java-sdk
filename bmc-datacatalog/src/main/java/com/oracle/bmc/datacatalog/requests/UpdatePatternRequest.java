 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePatternRequest.
 */
...
public class UpdatePatternRequest
    ...
    public static class Builder
        ...
        public UpdatePatternRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePatternRequest(catalogId, patternKey, updatePatternDetails, ifMatch,
            // opcRequestId);
        }
    }
