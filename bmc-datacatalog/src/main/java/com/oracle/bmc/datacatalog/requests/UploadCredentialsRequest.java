...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/UploadCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UploadCredentialsRequest.
 */
...
public class UploadCredentialsRequest
    ...
    public static class Builder
        ...
        public Builder copy(UploadCredentialsRequest o) {
            ...
            uploadCredentialsDetails(o.getUploadCredentialsDetails());
        ...
        /**
         * Build the instance of UploadCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of UploadCredentialsRequest
         */
        public UploadCredentialsRequest build() {
            UploadCredentialsRequest request = buildWithoutInvocationCallback();
        ...
        public UploadCredentialsRequest buildWithoutInvocationCallback() {
            UploadCredentialsRequest request = new UploadCredentialsRequest();
            request.catalogId = catalogId;
            request.dataAssetKey = dataAssetKey;
            request.connectionKey = connectionKey;
            request.uploadCredentialsDetails = uploadCredentialsDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new UploadCredentialsRequest(catalogId, dataAssetKey, connectionKey, uploadCredentialsDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",uploadCredentialsDetails=")
                .append(String.valueOf(this.uploadCredentialsDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadCredentialsRequest)) {
            return false;
        }

        UploadCredentialsRequest other = (UploadCredentialsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.catalogId, other.catalogId)
                && java.util.Objects.equals(this.dataAssetKey, other.dataAssetKey)
                && java.util.Objects.equals(this.connectionKey, other.connectionKey)
                && java.util.Objects.equals(
                        this.uploadCredentialsDetails, other.uploadCredentialsDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.uploadCredentialsDetails == null
                                ? 43
                                : this.uploadCredentialsDetails.hashCode());
