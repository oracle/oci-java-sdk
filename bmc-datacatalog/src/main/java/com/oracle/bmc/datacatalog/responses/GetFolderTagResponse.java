...
public class GetFolderTagResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetFolderTagResponse> {
        ...
        public GetFolderTagResponse build() {
            return new GetFolderTagResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFolderTagResponse)) {
            return false;
        }

        GetFolderTagResponse other = (GetFolderTagResponse) o;
