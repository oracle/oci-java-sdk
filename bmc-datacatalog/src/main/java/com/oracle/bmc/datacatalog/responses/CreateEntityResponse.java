...
public class CreateEntityResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateEntityResponse> {
         ...
         */
        @Override
        public Builder copy(CreateEntityResponse o) {
        ...
        public CreateEntityResponse build() {
            return new CreateEntityResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, entity);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEntityResponse)) {
            return false;
        }

        CreateEntityResponse other = (CreateEntityResponse) o;
