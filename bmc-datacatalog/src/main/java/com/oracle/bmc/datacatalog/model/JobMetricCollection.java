...
public final class JobMetricCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public JobMetricCollection build() {
            JobMetricCollection model = new JobMetricCollection(this.count, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JobMetricCollection model) {
