...
/**
 * Properties used in attribute create operations. <br>
...
public final class CreateAttributeDetails
    ...
    public static class Builder {
         ...
         * for an attribute type, a query can be done on '/types?type=attribute' that returns a
         ...
         * {@code {"properties": { "default": { "key1": "value1"}}}}
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAttributeDetails model) {
     ...
     * type, a query can be done on '/types?type=attribute' that returns a collection of all
