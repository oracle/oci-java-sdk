...
public class GetJobLogResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datacatalog.model.JobLog getJobLog() {
        return jobLog;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetJobLogResponse> {
         ...
         * @return this builder
         */
        public Builder jobLog(com.oracle.bmc.datacatalog.model.JobLog jobLog) {
            this.jobLog = jobLog;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",jobLog=").append(String.valueOf(jobLog));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetJobLogResponse)) {
            return false;
        }

        GetJobLogResponse other = (GetJobLogResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.jobLog, other.jobLog);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.jobLog == null ? 43 : this.jobLog.hashCode());
        return result;
    }
}
