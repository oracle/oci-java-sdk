...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ChangeCatalogCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCatalogCompartmentRequest.
 */
...
public class ChangeCatalogCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeCatalogCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeCatalogCompartmentRequest(changeCatalogCompartmentDetails, catalogId, ifMatch, opcRequestId, isLockOverride);
        }
    }
