...
public class ObjectStatsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ObjectStatsResponse> {
        ...
        public ObjectStatsResponse build() {
            return new ObjectStatsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, value);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStatsResponse)) {
            return false;
        }

        ObjectStatsResponse other = (ObjectStatsResponse) o;
