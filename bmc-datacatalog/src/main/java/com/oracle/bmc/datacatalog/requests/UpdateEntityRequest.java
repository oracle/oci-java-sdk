...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/UpdateEntityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateEntityRequest.
 */
...
public class UpdateEntityRequest
     ...
     * The information to be updated in the data entity.
     */
    public com.oracle.bmc.datacatalog.model.UpdateEntityDetails getUpdateEntityDetails() {
    ...
    public static class Builder
         ...
         * The information to be updated in the data entity.
         */
        private com.oracle.bmc.datacatalog.model.UpdateEntityDetails updateEntityDetails = null;

        /**
         * The information to be updated in the data entity.
         * @param updateEntityDetails the value to set
         * @return this builder instance
         */
        public Builder updateEntityDetails(
                com.oracle.bmc.datacatalog.model.UpdateEntityDetails updateEntityDetails) {
        ...
        public Builder copy(UpdateEntityRequest o) {
            ...
            updateEntityDetails(o.getUpdateEntityDetails());
         ...
         *
         * @return instance of UpdateEntityRequest
         */
        public UpdateEntityRequest build() {
            UpdateEntityRequest request = buildWithoutInvocationCallback();
        ...
        public UpdateEntityRequest buildWithoutInvocationCallback() {
            ...
            request.updateEntityDetails = updateEntityDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateEntityRequest(catalogId, dataAssetKey, entityKey, updateEntityDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateEntityDetails=").append(String.valueOf(this.updateEntityDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEntityRequest)) {
            return false;
        }

        UpdateEntityRequest other = (UpdateEntityRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.catalogId, other.catalogId)
                && java.util.Objects.equals(this.dataAssetKey, other.dataAssetKey)
                && java.util.Objects.equals(this.entityKey, other.entityKey)
                && java.util.Objects.equals(this.updateEntityDetails, other.updateEntityDetails)
        ...
        result =
                (result * PRIME)
                        + (this.updateEntityDetails == null
                                ? 43
                                : this.updateEntityDetails.hashCode());
