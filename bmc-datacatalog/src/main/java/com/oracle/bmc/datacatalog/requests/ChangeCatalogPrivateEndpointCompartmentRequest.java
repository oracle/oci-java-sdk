...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ChangeCatalogPrivateEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeCatalogPrivateEndpointCompartmentRequest.
 */
...
public class ChangeCatalogPrivateEndpointCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeCatalogPrivateEndpointCompartmentRequest as configured by this builder
         *
        ...
        public ChangeCatalogPrivateEndpointCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeCatalogPrivateEndpointCompartmentRequest(changeCatalogPrivateEndpointCompartmentDetails, catalogPrivateEndpointId, ifMatch, opcRequestId, isLockOverride);
        }
    }
