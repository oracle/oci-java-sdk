...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/CreateNamespaceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateNamespaceRequest.
 */
...
public class CreateNamespaceRequest
    ...
    public static class Builder
        ...
        public Builder createNamespaceDetails(
                com.oracle.bmc.datacatalog.model.CreateNamespaceDetails createNamespaceDetails) {
        ...
        public CreateNamespaceRequest buildWithoutInvocationCallback() {
            ...
            request.createNamespaceDetails = createNamespaceDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateNamespaceRequest(catalogId, createNamespaceDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createNamespaceDetails=").append(String.valueOf(this.createNamespaceDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNamespaceRequest)) {
            return false;
        }
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.createNamespaceDetails, other.createNamespaceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createNamespaceDetails == null
                                ? 43
                                : this.createNamespaceDetails.hashCode());
