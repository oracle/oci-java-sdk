...
public class GetCustomPropertyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetCustomPropertyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetCustomPropertyResponse> {
         ...
         */
        @Override
        public GetCustomPropertyResponse build() {
            return new GetCustomPropertyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCustomPropertyResponse)) {
            return false;
        }

        GetCustomPropertyResponse other = (GetCustomPropertyResponse) o;
