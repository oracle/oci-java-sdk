...
public class ListGlossariesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder glossaryCollection(
                com.oracle.bmc.datacatalog.model.GlossaryCollection glossaryCollection) {
            this.glossaryCollection = glossaryCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",glossaryCollection=").append(String.valueOf(glossaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListGlossariesResponse)) {
            return false;
        }

        ListGlossariesResponse other = (ListGlossariesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.glossaryCollection, other.glossaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.glossaryCollection == null
                                ? 43
                                : this.glossaryCollection.hashCode());
        return result;
    }
}
