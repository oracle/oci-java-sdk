...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = TermRelationshipSummary.Builder.class
)
...
public final class TermRelationshipSummary {
    ...
    public TermRelationshipSummary(
            String key,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public TermRelationshipSummary build() {
            TermRelationshipSummary __instance__ =
                    new TermRelationshipSummary(
                            key,
                            displayName,
                            description,
                            relatedTermKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TermRelationshipSummary o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TermRelationshipSummary)) {
            return false;
        }

        TermRelationshipSummary other = (TermRelationshipSummary) o;
