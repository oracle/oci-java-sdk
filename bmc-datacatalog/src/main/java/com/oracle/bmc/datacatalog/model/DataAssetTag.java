...
/**
 * Represents an association of a data asset to a term. <br>
...
public final class DataAssetTag extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
