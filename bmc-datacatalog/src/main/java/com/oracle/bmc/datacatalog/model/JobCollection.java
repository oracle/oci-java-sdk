...
/**
 * Results of a jobs listing. Jobs are scheduled instances of a job definition. <br>
...
public final class JobCollection extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public JobCollection(Integer count, java.util.List<JobSummary> items) {
        super();
        this.count = count;
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public JobCollection build() {
            JobCollection model = new JobCollection(this.count, this.items);
