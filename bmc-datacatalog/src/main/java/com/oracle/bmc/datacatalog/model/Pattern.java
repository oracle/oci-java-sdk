 ...
 * aggregating multiple physical data artifacts for ease of use. <br>
...
public final class Pattern extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * The last time that any change was made to the pattern. An
