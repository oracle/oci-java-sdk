...
public class UploadCredentialsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UploadCredentialsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadCredentialsResponse)) {
            return false;
        }

        UploadCredentialsResponse other = (UploadCredentialsResponse) o;
