...
public class RemoveDataSelectorPatternsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDataSelectorPatternsResponse)) {
            return false;
        }

        RemoveDataSelectorPatternsResponse other = (RemoveDataSelectorPatternsResponse) o;
