...
public class ListCatalogsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.datacatalog.model.CatalogSummary> getItems() {
        return items;
    }
    ...
    private ListCatalogsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.datacatalog.model.CatalogSummary> items) {
    ...
    public static class Builder {
        ...
        public ListCatalogsResponse build() {
            return new ListCatalogsResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
