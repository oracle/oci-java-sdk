 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAttributeTagsRequest.
 */
...
public class ListAttributeTagsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Specifies the fields to return in an entity attribute tag summary
         * response.
         *
        ...
        public ListAttributeTagsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAttributeTagsRequest(catalogId, dataAssetKey, entityKey, attributeKey, name,
            // lifecycleState, termKey, termPath, timeCreated, createdById, fields, sortBy,
