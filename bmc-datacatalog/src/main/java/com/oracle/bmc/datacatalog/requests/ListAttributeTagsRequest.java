...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListAttributeTagsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAttributeTagsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190325")
public class ListAttributeTagsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAttributeTagsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAttributeTagsRequest o) {
        ...
        /**
         * Build the instance of ListAttributeTagsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAttributeTagsRequest
         */
        public ListAttributeTagsRequest build() {
            ListAttributeTagsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAttributeTagsRequest
         */
        public ListAttributeTagsRequest buildWithoutInvocationCallback() {
            ListAttributeTagsRequest request = new ListAttributeTagsRequest();
            ...
            return request;
            // new ListAttributeTagsRequest(catalogId, dataAssetKey, entityKey, attributeKey, name, lifecycleState, termKey, termPath, timeCreated, createdById, fields, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAttributeTagsRequest)) {
            return false;
        }

        ListAttributeTagsRequest other = (ListAttributeTagsRequest) o;
