...
public class GetJobExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetJobExecutionResponse> {
         ...
         */
        @Override
        public Builder copy(GetJobExecutionResponse o) {
        ...
        public GetJobExecutionResponse build() {
            return new GetJobExecutionResponse(
