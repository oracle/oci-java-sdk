...
public class ImportGlossaryConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ImportGlossaryConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getImportGlossaryDetails(), "importGlossaryDetails is required");
        ...
        if (request.getIsRelationshipImported() != null) {
            target =
                    target.queryParam(
                            "isRelationshipImported",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getIsRelationshipImported()));
        }
