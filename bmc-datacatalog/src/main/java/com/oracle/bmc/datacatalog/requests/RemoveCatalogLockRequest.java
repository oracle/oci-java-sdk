...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/RemoveCatalogLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveCatalogLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190325")
public class RemoveCatalogLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveCatalogLockRequest o) {
        ...
        /**
         * Build the instance of RemoveCatalogLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveCatalogLockRequest
         */
        public RemoveCatalogLockRequest build() {
            RemoveCatalogLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveCatalogLockRequest
         */
        public RemoveCatalogLockRequest buildWithoutInvocationCallback() {
            RemoveCatalogLockRequest request = new RemoveCatalogLockRequest();
            request.catalogId = catalogId;
            request.removeResourceLockDetails = removeResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new RemoveCatalogLockRequest(catalogId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveCatalogLockRequest)) {
            return false;
        }

        RemoveCatalogLockRequest other = (RemoveCatalogLockRequest) o;
