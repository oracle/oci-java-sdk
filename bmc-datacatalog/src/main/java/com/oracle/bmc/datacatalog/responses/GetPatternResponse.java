...
public class GetPatternResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPatternResponse> {
         ...
         */
        @Override
        public GetPatternResponse build() {
            return new GetPatternResponse(__httpStatusCode__, headers, etag, opcRequestId, pattern);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPatternResponse)) {
            return false;
        }

        GetPatternResponse other = (GetPatternResponse) o;
