...
public class CreateCustomPropertyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCustomPropertyResponse> {
         ...
         */
        @Override
        public CreateCustomPropertyResponse build() {
            return new CreateCustomPropertyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCustomPropertyResponse)) {
            return false;
        }

        CreateCustomPropertyResponse other = (CreateCustomPropertyResponse) o;
