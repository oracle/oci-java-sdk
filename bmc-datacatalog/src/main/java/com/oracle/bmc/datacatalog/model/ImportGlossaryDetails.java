...
public final class ImportGlossaryDetails
    ...
    public static class Builder {
        ...
        public ImportGlossaryDetails build() {
            ImportGlossaryDetails model = new ImportGlossaryDetails(this.glossaryFileContents);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportGlossaryDetails model) {
            if (model.wasPropertyExplicitlySet("glossaryFileContents")) {
                this.glossaryFileContents(model.getGlossaryFileContents());
            }
            return this;
        }
    }
