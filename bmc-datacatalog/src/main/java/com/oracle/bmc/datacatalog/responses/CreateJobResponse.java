...
public class CreateJobResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.datacatalog.model.Job getJob() {
        return job;
    }
    ...
    private CreateJobResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.datacatalog.model.Job job) {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder job(com.oracle.bmc.datacatalog.model.Job job) {
            this.job = job;
            return this;
        }
        ...
        public CreateJobResponse build() {
            return new CreateJobResponse(__httpStatusCode__, etag, opcRequestId, job);
        }
    }
