...
public class ListNamespacesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListNamespacesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNamespacesRequest(catalogId, displayName, displayNameContains,
            // lifecycleState, timeCreated, timeUpdated, createdById, updatedById, sortBy,
            // sortOrder, fields, limit, page, opcRequestId);
        }
    }
