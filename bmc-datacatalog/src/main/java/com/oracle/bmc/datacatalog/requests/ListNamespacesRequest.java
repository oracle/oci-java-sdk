...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/ListNamespacesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNamespacesRequest.
 */
...
public class ListNamespacesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Specifies the fields to return in a namespace summary response.
         *
        ...
        public ListNamespacesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNamespacesRequest(catalogId, displayName, displayNameContains, lifecycleState, timeCreated, timeUpdated, createdById, updatedById, sortBy, sortOrder, fields, limit, page, opcRequestId);
        }
    }
