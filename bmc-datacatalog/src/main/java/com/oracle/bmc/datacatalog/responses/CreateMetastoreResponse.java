...
public class CreateMetastoreResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMetastoreResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMetastoreResponse o) {
        ...
        public CreateMetastoreResponse build() {
            return new CreateMetastoreResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMetastoreResponse)) {
            return false;
        }

        CreateMetastoreResponse other = (CreateMetastoreResponse) o;
