...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = JobExecutionCollection.Builder.class)
...
public final class JobExecutionCollection
    ...
    public JobExecutionCollection(Integer count, java.util.List<JobExecutionSummary> items) {
        super();
        this.count = count;
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public JobExecutionCollection build() {
            JobExecutionCollection model = new JobExecutionCollection(this.count, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JobExecutionCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("JobExecutionCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobExecutionCollection)) {
            return false;
        }

        JobExecutionCollection other = (JobExecutionCollection) o;
