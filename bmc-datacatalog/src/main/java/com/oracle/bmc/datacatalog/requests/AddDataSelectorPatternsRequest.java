...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/datacatalog/AddDataSelectorPatternsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddDataSelectorPatternsRequest.
 */
...
public class AddDataSelectorPatternsRequest
    ...
    public static class Builder
         ...
         * @return instance of AddDataSelectorPatternsRequest
         */
        public AddDataSelectorPatternsRequest buildWithoutInvocationCallback() {
            AddDataSelectorPatternsRequest request = new AddDataSelectorPatternsRequest();
            request.catalogId = catalogId;
            request.dataAssetKey = dataAssetKey;
            request.dataSelectorPatternDetails = dataSelectorPatternDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new AddDataSelectorPatternsRequest(catalogId, dataAssetKey, dataSelectorPatternDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",dataSelectorPatternDetails=")
                .append(String.valueOf(this.dataSelectorPatternDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDataSelectorPatternsRequest)) {
            return false;
        }

        AddDataSelectorPatternsRequest other = (AddDataSelectorPatternsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.catalogId, other.catalogId)
                && java.util.Objects.equals(this.dataAssetKey, other.dataAssetKey)
                && java.util.Objects.equals(
                        this.dataSelectorPatternDetails, other.dataSelectorPatternDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataSelectorPatternDetails == null
                                ? 43
                                : this.dataSelectorPatternDetails.hashCode());
