...
public class UsersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UsersResponse> {
         ...
         */
        @Override
        public Builder copy(UsersResponse o) {
        ...
        public UsersResponse build() {
            return new UsersResponse(__httpStatusCode__, headers, opcRequestId, opcNextPage, value);
        }
    }
