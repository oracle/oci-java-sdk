...
/**
 * Import connection from the connection metadata and oracle wallet file. <br>
...
public final class ImportConnectionDetails
    ...
    public static class Builder {
        ...
        public ImportConnectionDetails build() {
            ImportConnectionDetails model =
                    new ImportConnectionDetails(this.connectionDetail, this.connectionPayload);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportConnectionDetails model) {
