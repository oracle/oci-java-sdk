...
/**
 * Summary of a custom property <br>
...
public final class CustomPropertySummary
    ...
    public static class Builder {
        ...
        /**
         * Type or scope of the custom property belongs to. This will be an array of type id it will
         * be belongs to
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomPropertySummary model) {
    ...
    /**
     * Type or scope of the custom property belongs to. This will be an array of type id it will be
     * belongs to
     */
    @com.fasterxml.jackson.annotation.JsonProperty("scope")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CustomPropertySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomPropertySummary)) {
            return false;
        }

        CustomPropertySummary other = (CustomPropertySummary) o;
