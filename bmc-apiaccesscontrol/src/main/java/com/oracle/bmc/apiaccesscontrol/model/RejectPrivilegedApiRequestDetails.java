...
/**
 * Summary of why the privilegedApi request was rejected. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RejectPrivilegedApiRequestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RejectPrivilegedApiRequestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"approverComment"})
    public RejectPrivilegedApiRequestDetails(String approverComment) {
        super();
    ...
    public static class Builder {
        ...
        public RejectPrivilegedApiRequestDetails build() {
            RejectPrivilegedApiRequestDetails model =
                    new RejectPrivilegedApiRequestDetails(this.approverComment);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RejectPrivilegedApiRequestDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RejectPrivilegedApiRequestDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RejectPrivilegedApiRequestDetails)) {
            return false;
        }

        RejectPrivilegedApiRequestDetails other = (RejectPrivilegedApiRequestDetails) o;
