...
public class ListApiMetadataConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListApiMetadataConverter.class);

    public static com.oracle.bmc.apiaccesscontrol.requests.ListApiMetadataRequest interceptRequest(
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.apiaccesscontrol.responses.ListApiMetadataResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.apiaccesscontrol.responses.ListApiMetadataResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.apiaccesscontrol.responses.ListApiMetadataResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.apiaccesscontrol.responses.ListApiMetadataResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.apiaccesscontrol.responses
                                                        .ListApiMetadataResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.apiMetadataCollection(response.getItem());
