 ...
 * to any list operations of ApiMetadata where multiple pages of data may be fetched.
...
public class ApiMetadataPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listApiMetadata operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.ApiMetadataSummary} objects
     * contained in responses from the listApiMetadata operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.ApiMetadataSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listApiMetadataByEntityTypes operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListApiMetadataByEntityTypesResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListApiMetadataByEntityTypesRequest.Builder, ListApiMetadataByEntityTypesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.ApiMetadataByEntityTypeSummary} objects
     * contained in responses from the listApiMetadataByEntityTypes operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.ApiMetadataByEntityTypeSummary} objects
     * contained in responses received from the service.
     */
