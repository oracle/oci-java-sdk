...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apiaccesscontrol/DeletePrivilegedApiControlExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePrivilegedApiControlRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241130")
public class DeletePrivilegedApiControlRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePrivilegedApiControlRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePrivilegedApiControlRequest o) {
        ...
        /**
         * Build the instance of DeletePrivilegedApiControlRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePrivilegedApiControlRequest
         */
        public DeletePrivilegedApiControlRequest build() {
            DeletePrivilegedApiControlRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePrivilegedApiControlRequest
         */
        public DeletePrivilegedApiControlRequest buildWithoutInvocationCallback() {
            DeletePrivilegedApiControlRequest request = new DeletePrivilegedApiControlRequest();
            request.privilegedApiControlId = privilegedApiControlId;
            request.description = description;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeletePrivilegedApiControlRequest(privilegedApiControlId, description, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePrivilegedApiControlRequest)) {
            return false;
        }

        DeletePrivilegedApiControlRequest other = (DeletePrivilegedApiControlRequest) o;
