...
/**
 * Async client implementation for PrivilegedApiWorkRequest service. <br>
...
public class PrivilegedApiWorkRequestAsyncClient
        extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements PrivilegedApiWorkRequestAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PrivilegedApiWorkRequestAsyncClient.class);

    PrivilegedApiWorkRequestAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, PrivilegedApiWorkRequestAsyncClient> {
         ...
         * @return the client
         */
        public PrivilegedApiWorkRequestAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new PrivilegedApiWorkRequestAsyncClient(this, authenticationDetailsProvider);
        }
    }
     ...
     */
    @Deprecated
    public PrivilegedApiWorkRequestAsyncClient(
