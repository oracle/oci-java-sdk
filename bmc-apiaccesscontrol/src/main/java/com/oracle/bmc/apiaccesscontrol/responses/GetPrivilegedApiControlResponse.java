...
public class GetPrivilegedApiControlResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetPrivilegedApiControlResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<
                    GetPrivilegedApiControlResponse> {
         ...
         */
        @Override
        public Builder copy(GetPrivilegedApiControlResponse o) {
         ...
         */
        @Override
        public GetPrivilegedApiControlResponse build() {
            return new GetPrivilegedApiControlResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, privilegedApiControl);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPrivilegedApiControlResponse)) {
            return false;
        }

        GetPrivilegedApiControlResponse other = (GetPrivilegedApiControlResponse) o;
