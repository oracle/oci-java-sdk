...
/**
 * A PrivilegedApiControl is a kind of Policy definition which provides details about which
 * operations needs to be secure; who can approve a privilegedApiRequest requesting for a particular
 * operation, whether the operations needs to be approved by customer or is it preApproved.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = PrivilegedApiControl.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class PrivilegedApiControl
    ...
    public static class Builder {
        ...
        /**
         * List of IAM user group ids who can approve an privilegedApi request associated with a
         * target resource under the governance of this operator control.
         */
        ...
        /**
         * List of privileged operations/apis. These operations/apis will be treaated as secured,
         * once enabled by the Privileged API Managment for a resource. Any of these operations, if
         * needs to be executed, needs to be raised as a PrivilegedApi Request which needs to be
         * approved by customers or it can be pre-approved.
         */
        ...
        public PrivilegedApiControl build() {
            PrivilegedApiControl model =
                    new PrivilegedApiControl(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrivilegedApiControl model) {
    ...
    /**
     * List of IAM user group ids who can approve an privilegedApi request associated with a target
    ...
    /**
     * List of privileged operations/apis. These operations/apis will be treaated as secured, once
     * enabled by the Privileged API Managment for a resource. Any of these operations, if needs to
     * be executed, needs to be raised as a PrivilegedApi Request which needs to be approved by
     * customers or it can be pre-approved.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("privilegedOperationList")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrivilegedApiControl(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrivilegedApiControl)) {
            return false;
        }

        PrivilegedApiControl other = (PrivilegedApiControl) o;
