...
public interface PrivilegedApiControlAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreatePrivilegedApiControlResponse> createPrivilegedApiControl(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeletePrivilegedApiControlResponse> deletePrivilegedApiControl(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetPrivilegedApiControlResponse> getPrivilegedApiControl(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListPrivilegedApiControlsResponse> listPrivilegedApiControls(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdatePrivilegedApiControlResponse> updatePrivilegedApiControl(
