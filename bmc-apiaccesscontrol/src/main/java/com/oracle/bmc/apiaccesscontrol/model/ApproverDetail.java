...
/**
 * It contains appprovers details such as who approved it, when he approved and any details the
 * approver would have entered as a part of approval process. <br>
...
public final class ApproverDetail
    ...
    public static class Builder {
        ...
        /**
         * Time when the privilegedApi request was authorized by the customer in [RFC
        ...
        /**
         * Time for when the privilegedApi request should start that is authorized by the customer
    ...
    /**
     * Time for when the privilegedApi request should start that is authorized by the customer in
