 ...
 * resources of PrivilegedApiWorkRequest.
 *
 * <p>The default configuration used is defined by {@link
 * com.oracle.bmc.waiter.Waiters.Waiters#DEFAULT_POLLING_WAITER}.
 */
@jakarta.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20241130")
public class PrivilegedApiWorkRequestWaiters {
    private final java.util.concurrent.ExecutorService executorService;
    private final PrivilegedApiWorkRequest client;

    public PrivilegedApiWorkRequestWaiters(
            java.util.concurrent.ExecutorService executorService, PrivilegedApiWorkRequest client) {
