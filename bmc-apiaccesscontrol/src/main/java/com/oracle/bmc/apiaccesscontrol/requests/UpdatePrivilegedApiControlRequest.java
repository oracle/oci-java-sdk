...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/apiaccesscontrol/UpdatePrivilegedApiControlExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdatePrivilegedApiControlRequest.
 */
...
public class UpdatePrivilegedApiControlRequest
    ...
    public static class Builder
        ...
        public UpdatePrivilegedApiControlRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdatePrivilegedApiControlRequest(privilegedApiControlId, updatePrivilegedApiControlDetails, ifMatch, opcRequestId);
        }
    }
