 ...
 * to any list operations of PrivilegedApiRequests where multiple pages of data may be fetched.
...
public class PrivilegedApiRequestsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPrivilegedApiRequests operation. This iterable
    ...
    public Iterable<ListPrivilegedApiRequestsResponse> listPrivilegedApiRequestsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPrivilegedApiRequestsRequest.Builder, ListPrivilegedApiRequestsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.PrivilegedApiRequestSummary} objects
     * contained in responses from the listPrivilegedApiRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.PrivilegedApiRequestSummary} objects
