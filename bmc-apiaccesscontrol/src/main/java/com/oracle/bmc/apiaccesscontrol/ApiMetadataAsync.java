...
public interface ApiMetadataAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetApiMetadataResponse> getApiMetadata(
            GetApiMetadataRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetApiMetadataRequest, GetApiMetadataResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListApiMetadataResponse> listApiMetadata(
            ListApiMetadataRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListApiMetadataRequest, ListApiMetadataResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListApiMetadataByEntityTypesResponse> listApiMetadataByEntityTypes(
