 ...
 * to any list operations of PrivilegedApiControl where multiple pages of data may be fetched.
...
public class PrivilegedApiControlPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listPrivilegedApiControls operation. This iterable
    ...
    public Iterable<ListPrivilegedApiControlsResponse> listPrivilegedApiControlsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListPrivilegedApiControlsRequest.Builder, ListPrivilegedApiControlsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.PrivilegedApiControlSummary} objects
     * contained in responses from the listPrivilegedApiControls operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.apiaccesscontrol.model.PrivilegedApiControlSummary} objects
