...
/**
 * Search for resources in your cloud network. This service client uses
...
public interface ResourceSearch extends AutoCloseable {
     ...
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/resourcesearch/GetResourceTypeExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetResourceType
     *     API.
     */
     ...
     * specified criteria. Results include resources that you have permission to view and can span
     * different resource types. You can also sort results based on a specified resource attribute.
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     * @throws BmcException when an error occurs. This operation uses
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use SearchResources
     *     API.
     */
