 ...
 * length of the wrapped stream matches its known length.
 *
 * <p>NOTE: This implementation of content length verification does not support {@link
 * InputStream#reset()} and the verification is disabled upon invocation of {@link
 * InputStream#reset()}.
 */
            ...
            if (totalBytesProcessed != contentLength) {
                throw new IOException(
                        String.format(
                                ...
                                totalBytesProcessed, contentLength));
            }
        } else {
