...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/certificatesmanagement/CancelCertificateAuthorityVersionDeletionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CancelCertificateAuthorityVersionDeletionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210224")
public class CancelCertificateAuthorityVersionDeletionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CancelCertificateAuthorityVersionDeletionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(CancelCertificateAuthorityVersionDeletionRequest o) {
        ...
        /**
         * Build the instance of CancelCertificateAuthorityVersionDeletionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CancelCertificateAuthorityVersionDeletionRequest
         */
        public CancelCertificateAuthorityVersionDeletionRequest build() {
         ...
         * @return instance of CancelCertificateAuthorityVersionDeletionRequest
         */
        public CancelCertificateAuthorityVersionDeletionRequest buildWithoutInvocationCallback() {
            CancelCertificateAuthorityVersionDeletionRequest request =
                    new CancelCertificateAuthorityVersionDeletionRequest();
            ...
            return request;
            // new CancelCertificateAuthorityVersionDeletionRequest(certificateAuthorityId, certificateAuthorityVersionNumber, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelCertificateAuthorityVersionDeletionRequest)) {
            return false;
        }

        CancelCertificateAuthorityVersionDeletionRequest other =
                (CancelCertificateAuthorityVersionDeletionRequest) o;
