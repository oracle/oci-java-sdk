...
/**
 * The details for updating a private root certificate authority (CA). Note: This operation
 * automatically rotates the private key. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateRootCaByGeneratingInternallyConfigDetails.Builder.class)
...
public final class UpdateRootCaByGeneratingInternallyConfigDetails
    ...
    @Deprecated
    public UpdateRootCaByGeneratingInternallyConfigDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRootCaByGeneratingInternallyConfigDetails)) {
            return false;
        }
