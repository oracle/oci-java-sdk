...
public class ChangeCertificateAuthorityCompartmentResponse
    ...
    private ChangeCertificateAuthorityCompartmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ChangeCertificateAuthorityCompartmentResponse o) {
         ...
         */
        @Override
        public ChangeCertificateAuthorityCompartmentResponse build() {
            return new ChangeCertificateAuthorityCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeCertificateAuthorityCompartmentResponse)) {
            return false;
        }

        ChangeCertificateAuthorityCompartmentResponse other =
                (ChangeCertificateAuthorityCompartmentResponse) o;
