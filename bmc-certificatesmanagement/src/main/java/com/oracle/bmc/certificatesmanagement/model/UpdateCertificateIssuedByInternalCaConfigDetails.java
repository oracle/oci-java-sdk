...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateCertificateIssuedByInternalCaConfigDetails.Builder.class
)
...
public final class UpdateCertificateIssuedByInternalCaConfigDetails
    ...
    public static class Builder {
        ...
        public UpdateCertificateIssuedByInternalCaConfigDetails build() {
            UpdateCertificateIssuedByInternalCaConfigDetails __instance__ =
                    new UpdateCertificateIssuedByInternalCaConfigDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateCertificateIssuedByInternalCaConfigDetails o) {
    ...
    @Deprecated
    public UpdateCertificateIssuedByInternalCaConfigDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateCertificateIssuedByInternalCaConfigDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateCertificateIssuedByInternalCaConfigDetails)) {
            return false;
        }

        UpdateCertificateIssuedByInternalCaConfigDetails other =
                (UpdateCertificateIssuedByInternalCaConfigDetails) o;
