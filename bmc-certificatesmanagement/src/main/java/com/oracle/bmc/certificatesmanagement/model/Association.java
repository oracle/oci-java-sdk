...
public final class Association extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    /**
     * A user-friendly name generated by the service for the association, expressed in a format that
     * follows the pattern: [certificatesResourceEntityType]-[associatedResourceEntityType]-UUID.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("name")
    ...
    /**
     * The compartment OCID of the association, which is strongly tied to the compartment OCID of
