...
public class ListCertificatesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.certificatesmanagement.model.CertificateCollection
    ...
    public static class Builder {
        ...
        public Builder certificateCollection(
                com.oracle.bmc.certificatesmanagement.model.CertificateCollection
                        certificateCollection) {
            this.certificateCollection = certificateCollection;
            return this;
        ...
        public Builder copy(ListCertificatesResponse o) {
            ...
            certificateCollection(o.getCertificateCollection());
        ...
        public ListCertificatesResponse build() {
            return new ListCertificatesResponse(
                    __httpStatusCode__, opcRequestId, opcNextPage, certificateCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",certificateCollection=").append(String.valueOf(certificateCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCertificatesResponse)) {
            return false;
        }

        ListCertificatesResponse other = (ListCertificatesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.certificateCollection, other.certificateCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.certificateCollection == null
                                ? 43
                                : this.certificateCollection.hashCode());
        return result;
    }
}
