...
public class GetCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.certificatesmanagement.model.Certificate getCertificate() {
        return certificate;
    }
    ...
    private GetCertificateResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.certificatesmanagement.model.Certificate certificate) {
