...
public class ListAssociationsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAssociationsConverter.class);

    public static com.oracle.bmc.certificatesmanagement.requests.ListAssociationsRequest
            interceptRequest(
                    com.oracle.bmc.certificatesmanagement.requests.ListAssociationsRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.certificatesmanagement.requests.ListAssociationsRequest request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210224").path("associations");
        ...
        if (request.getCertificatesResourceId() != null) {
            target =
                    target.queryParam(
                            "certificatesResourceId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getCertificatesResourceId()));
        }
        ...
        if (request.getAssociationType() != null) {
            target =
                    target.queryParam(
                            "associationType",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getAssociationType().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.certificatesmanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.certificatesmanagement.responses.ListAssociationsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
