...
public class GetCaBundleResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.certificatesmanagement.model.CaBundle getCaBundle() {
        return caBundle;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetCaBundleResponse> {
         ...
         * @return this builder
         */
        public Builder caBundle(com.oracle.bmc.certificatesmanagement.model.CaBundle caBundle) {
            this.caBundle = caBundle;
            return this;
        }
        ...
        public GetCaBundleResponse build() {
            return new GetCaBundleResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, caBundle);
        }
    }
