...
public class ListCaBundlesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListCaBundlesResponse> {
    ...
    public String toString() {
        ...
        sb.append(",caBundleCollection=").append(String.valueOf(caBundleCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCaBundlesResponse)) {
            return false;
        }

        ListCaBundlesResponse other = (ListCaBundlesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.caBundleCollection, other.caBundleCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.caBundleCollection == null
                                ? 43
                                : this.caBundleCollection.hashCode());
        return result;
    }
}
