...
public class UpdateSubordinateCaIssuedByInternalCaConfigDetails
    ...
    public static class Builder {
        ...
        public UpdateSubordinateCaIssuedByInternalCaConfigDetails build() {
            UpdateSubordinateCaIssuedByInternalCaConfigDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSubordinateCaIssuedByInternalCaConfigDetails o) {
