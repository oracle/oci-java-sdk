...
public class CancelCertificateAuthorityDeletionResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelCertificateAuthorityDeletionResponse)) {
            return false;
        }

        CancelCertificateAuthorityDeletionResponse other =
                (CancelCertificateAuthorityDeletionResponse) o;
