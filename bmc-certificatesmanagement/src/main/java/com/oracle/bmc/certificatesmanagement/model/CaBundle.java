...
/**
 * CA bundle metadata. This object does not contain the CA bundle certificates. <br>
...
public final class CaBundle extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        /**
         * A user-friendly name for the CA bundle. Names are unique within a compartment. Avoid
         * entering confidential information. Valid characters include uppercase or lowercase
        ...
        private CaBundleLifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(CaBundleLifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
    ...
    /**
     * A user-friendly name for the CA bundle. Names are unique within a compartment. Avoid entering
    ...
    /** The current lifecycle state of the CA bundle. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final CaBundleLifecycleState lifecycleState;
     ...
     * @return the value
     */
    public CaBundleLifecycleState getLifecycleState() {
