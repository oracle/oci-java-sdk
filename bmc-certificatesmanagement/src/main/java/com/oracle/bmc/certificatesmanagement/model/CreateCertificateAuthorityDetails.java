...
/**
 * The details for creating a certificate authority (CA). <br>
...
public final class CreateCertificateAuthorityDetails
    ...
    public static class Builder {
        ...
        /**
         * For externally managed CAs, a description of the externally managed private key. Avoid
        ...
        public CreateCertificateAuthorityDetails build() {
            CreateCertificateAuthorityDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCertificateAuthorityDetails model) {
