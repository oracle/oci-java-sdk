...
public final class CertificateAuthorityVersionCollection
    ...
    public CertificateAuthorityVersionCollection(
            java.util.List<CertificateAuthorityVersionSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public CertificateAuthorityVersionCollection build() {
            CertificateAuthorityVersionCollection model =
                    new CertificateAuthorityVersionCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CertificateAuthorityVersionCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CertificateAuthorityVersionCollection)) {
            return false;
        }

        CertificateAuthorityVersionCollection other = (CertificateAuthorityVersionCollection) o;
