...
public final class CertificateAuthorityVersionCollection {
    ...
    public static class Builder {
        ...
        public CertificateAuthorityVersionCollection build() {
            CertificateAuthorityVersionCollection __instance__ =
                    new CertificateAuthorityVersionCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CertificateAuthorityVersionCollection o) {
