...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/securityattribute/DeleteSecurityAttributeNamespaceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSecurityAttributeNamespaceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240815")
public class DeleteSecurityAttributeNamespaceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteSecurityAttributeNamespaceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteSecurityAttributeNamespaceRequest o) {
        ...
        /**
         * Build the instance of DeleteSecurityAttributeNamespaceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSecurityAttributeNamespaceRequest
         */
        public DeleteSecurityAttributeNamespaceRequest build() {
            DeleteSecurityAttributeNamespaceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteSecurityAttributeNamespaceRequest
         */
        public DeleteSecurityAttributeNamespaceRequest buildWithoutInvocationCallback() {
            DeleteSecurityAttributeNamespaceRequest request =
                    new DeleteSecurityAttributeNamespaceRequest();
            request.securityAttributeNamespaceId = securityAttributeNamespaceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new DeleteSecurityAttributeNamespaceRequest(securityAttributeNamespaceId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSecurityAttributeNamespaceRequest)) {
            return false;
        }

        DeleteSecurityAttributeNamespaceRequest other = (DeleteSecurityAttributeNamespaceRequest) o;
