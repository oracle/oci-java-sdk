...
public class CreateSecurityAttributeNamespaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateSecurityAttributeNamespaceResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateSecurityAttributeNamespaceResponse o) {
         ...
         */
        public CreateSecurityAttributeNamespaceResponse build() {
            return new CreateSecurityAttributeNamespaceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSecurityAttributeNamespaceResponse)) {
            return false;
        }

        CreateSecurityAttributeNamespaceResponse other =
                (CreateSecurityAttributeNamespaceResponse) o;
