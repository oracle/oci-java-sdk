 ...
 */
package com.oracle.bmc.securityattribute.internal.http;
...
public class UpdateSecurityAttributeConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateSecurityAttributeConverter.class);

    public static com.oracle.bmc.securityattribute.requests.UpdateSecurityAttributeRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.securityattribute.requests.UpdateSecurityAttributeRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getSecurityAttributeNamespaceId()))
                        .path("securityAttributes")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getSecurityAttributeName()));
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.securityattribute.responses
                                            .UpdateSecurityAttributeResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.securityattribute.responses.UpdateSecurityAttributeResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.securityattribute.responses
                                                .UpdateSecurityAttributeResponse.Builder
                                        builder =
                                                com.oracle.bmc.securityattribute.responses
                                                        .UpdateSecurityAttributeResponse.builder()
                                ...
                                builder.securityAttribute(response.getItem());
