...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/securityattribute/ListSecurityAttributeNamespacesExample.java.html"
...
public class ListSecurityAttributeNamespacesRequest
     ...
     * namespaces in subcompartments. If this parameter is not specified, only the namespaces
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ListSecurityAttributeNamespacesRequest as configured by this
         * builder
         *
        ...
        public ListSecurityAttributeNamespacesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSecurityAttributeNamespacesRequest(compartmentId, page, limit, sortOrder,
            // sortBy, name, opcRequestId, compartmentIdInSubtree, lifecycleState);
        }
    }
