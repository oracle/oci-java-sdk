...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/securityattribute/UpdateSecurityAttributeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSecurityAttributeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240815")
public class UpdateSecurityAttributeRequest
     ...
     */
    private com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails
            updateSecurityAttributeDetails;

    /**
     * Request object for updating a security attribute.
     */
    public com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails
            getUpdateSecurityAttributeDetails() {
        return updateSecurityAttributeDetails;
    }
    /**
    ...
    public com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails getBody$() {
        return updateSecurityAttributeDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails
                updateSecurityAttributeDetails = null;

        /**
         * Request object for updating a security attribute.
         * @param updateSecurityAttributeDetails the value to set
         * @return this builder instance
         */
        public Builder updateSecurityAttributeDetails(
                com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails
                        updateSecurityAttributeDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(UpdateSecurityAttributeRequest o) {
            securityAttributeNamespaceId(o.getSecurityAttributeNamespaceId());
            securityAttributeName(o.getSecurityAttributeName());
            updateSecurityAttributeDetails(o.getUpdateSecurityAttributeDetails());
        ...
        /**
         * Build the instance of UpdateSecurityAttributeRequest as configured by this builder
         *
         ...
         *
         * @return instance of UpdateSecurityAttributeRequest
         */
        public UpdateSecurityAttributeRequest build() {
            UpdateSecurityAttributeRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.securityattribute.model.UpdateSecurityAttributeDetails body) {
            updateSecurityAttributeDetails(body);
            return this;
        }
        ...
        public UpdateSecurityAttributeRequest buildWithoutInvocationCallback() {
            UpdateSecurityAttributeRequest request = new UpdateSecurityAttributeRequest();
            request.securityAttributeNamespaceId = securityAttributeNamespaceId;
            request.securityAttributeName = securityAttributeName;
            request.updateSecurityAttributeDetails = updateSecurityAttributeDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new UpdateSecurityAttributeRequest(securityAttributeNamespaceId, securityAttributeName, updateSecurityAttributeDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateSecurityAttributeDetails=")
                .append(String.valueOf(this.updateSecurityAttributeDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSecurityAttributeRequest)) {
            return false;
        }

        UpdateSecurityAttributeRequest other = (UpdateSecurityAttributeRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateSecurityAttributeDetails, other.updateSecurityAttributeDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateSecurityAttributeDetails == null
                                ? 43
                                : this.updateSecurityAttributeDetails.hashCode());
