...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/securityattribute/CreateSecurityAttributeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateSecurityAttributeRequest.
 */
...
public class CreateSecurityAttributeRequest
    ...
    public static class Builder
        ...
        public CreateSecurityAttributeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateSecurityAttributeRequest(securityAttributeNamespaceId, createSecurityAttributeDetails, opcRequestId, opcRetryToken);
        }
    }
