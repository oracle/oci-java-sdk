...
public class GetSecurityAttributeNamespaceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetSecurityAttributeNamespaceResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetSecurityAttributeNamespaceResponse o) {
         ...
         */
        @Override
        public GetSecurityAttributeNamespaceResponse build() {
            return new GetSecurityAttributeNamespaceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSecurityAttributeNamespaceResponse)) {
            return false;
        }

        GetSecurityAttributeNamespaceResponse other = (GetSecurityAttributeNamespaceResponse) o;
