...
public class UpdateSecurityAttributeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateSecurityAttributeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateSecurityAttributeResponse o) {
         ...
         */
        @Override
        public UpdateSecurityAttributeResponse build() {
            return new UpdateSecurityAttributeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSecurityAttributeResponse)) {
            return false;
        }

        UpdateSecurityAttributeResponse other = (UpdateSecurityAttributeResponse) o;
