...
public class CascadingDeleteSecurityAttributeNamespaceResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CascadingDeleteSecurityAttributeNamespaceResponse)) {
            return false;
        }

        CascadingDeleteSecurityAttributeNamespaceResponse other =
                (CascadingDeleteSecurityAttributeNamespaceResponse) o;
