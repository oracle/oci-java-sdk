...
public interface OpensearchClusterAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<BackupOpensearchClusterResponse> backupOpensearchCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateOpensearchClusterResponse> createOpensearchCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOpensearchClusterResponse> deleteOpensearchCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOpensearchClusterResponse> getOpensearchCluster(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOpensearchClusterShapesResponse> listOpensearchClusterShapes(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOpensearchClustersResponse> listOpensearchClusters(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOpensearchVersionsResponse> listOpensearchVersions(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<OpensearchClusterRestoreResponse> opensearchClusterRestore(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOpensearchClusterResponse> updateOpensearchCluster(
