...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opensearch/OpensearchClusterRestoreExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use OpensearchClusterRestoreRequest.
 */
...
public class OpensearchClusterRestoreRequest
    ...
    public static class Builder
        ...
        public OpensearchClusterRestoreRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new OpensearchClusterRestoreRequest(opensearchClusterId, restoreOpensearchClusterDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
