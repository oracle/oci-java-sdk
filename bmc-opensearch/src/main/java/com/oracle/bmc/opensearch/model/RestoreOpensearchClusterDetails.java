...
public final class RestoreOpensearchClusterDetails
    ...
    public static class Builder {
        ...
        public RestoreOpensearchClusterDetails build() {
            RestoreOpensearchClusterDetails model =
                    new RestoreOpensearchClusterDetails(
                            this.opensearchClusterBackupId, this.compartmentId, this.prefix);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestoreOpensearchClusterDetails model) {
            if (model.wasPropertyExplicitlySet("opensearchClusterBackupId")) {
                this.opensearchClusterBackupId(model.getOpensearchClusterBackupId());
            }
