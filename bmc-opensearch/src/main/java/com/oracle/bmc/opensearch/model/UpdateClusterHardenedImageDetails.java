...
public final class UpdateClusterHardenedImageDetails {
    ...
    public static class Builder {
        ...
        public UpdateClusterHardenedImageDetails build() {
            UpdateClusterHardenedImageDetails __instance__ =
                    new UpdateClusterHardenedImageDetails(clusterId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateClusterHardenedImageDetails o) {
            Builder copiedBuilder = clusterId(o.getClusterId());
