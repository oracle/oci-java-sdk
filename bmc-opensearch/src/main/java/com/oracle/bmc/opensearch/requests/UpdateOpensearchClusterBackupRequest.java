...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/opensearch/UpdateOpensearchClusterBackupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOpensearchClusterBackupRequest.
 */
...
public class UpdateOpensearchClusterBackupRequest
    ...
    public static class Builder
        ...
        public UpdateOpensearchClusterBackupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOpensearchClusterBackupRequest(opensearchClusterBackupId, updateOpensearchClusterBackupDetails, ifMatch, opcRequestId);
        }
    }
