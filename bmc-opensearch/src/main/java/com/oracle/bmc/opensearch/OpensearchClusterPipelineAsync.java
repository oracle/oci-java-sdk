...
public interface OpensearchClusterPipelineAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOpensearchClusterPipelineResponse> getOpensearchClusterPipeline(
