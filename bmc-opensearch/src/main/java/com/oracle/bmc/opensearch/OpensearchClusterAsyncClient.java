    ...
    public java.util.concurrent.Future<ListOpensearchClusterShapesResponse>
            listOpensearchClusterShapes(
                    ...
                    final com.oracle.bmc.responses.AsyncHandler<
                            ...
                            handler) {
        LOG.trace("Called async listOpensearchClusterShapes");
        final ListOpensearchClusterShapesRequest interceptedRequest =
                ListOpensearchClusterShapesConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListOpensearchClusterShapesConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "OpensearchCluster",
                        "ListOpensearchClusterShapes",
        ...
        final java.util.function.Function<
                        javax.ws.rs.core.Response, ListOpensearchClusterShapesResponse>
                transformer =
                        ListOpensearchClusterShapesConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<
                        ListOpensearchClusterShapesRequest, ListOpensearchClusterShapesResponse>
                handlerToUse = handler;
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListOpensearchClusterShapesRequest,
                                ListOpensearchClusterShapesResponse>,
                        java.util.concurrent.Future<ListOpensearchClusterShapesResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
