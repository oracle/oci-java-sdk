...
/**
 * An error encountered while executing an operation that is tracked by a work request. <br>
...
public final class WorkRequestError
    ...
    public static class Builder {
        /**
         * A machine-usable code for the error that occured. For a list of error codes, see [API
