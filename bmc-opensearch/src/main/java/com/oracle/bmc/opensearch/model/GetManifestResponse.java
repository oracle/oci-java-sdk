...
public final class GetManifestResponse {
    @Deprecated
    ...
    public static class Builder {
        ...
        public GetManifestResponse build() {
            GetManifestResponse __instance__ = new GetManifestResponse(serializedManifest);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GetManifestResponse o) {
            Builder copiedBuilder = serializedManifest(o.getSerializedManifest());
