...
public interface OpensearchClusterBackupAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<DeleteOpensearchClusterBackupResponse>
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetOpensearchClusterBackupResponse> getOpensearchClusterBackup(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListOpensearchClusterBackupsResponse> listOpensearchClusterBackups(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOpensearchClusterBackupResponse>
