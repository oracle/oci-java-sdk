...
/**
 * The configuration details for a new OpenSearch cluster pipeline. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateOpensearchClusterPipelineDetails.Builder.class)
...
public final class CreateOpensearchClusterPipelineDetails
    ...
    public static class Builder {
        ...
        public CreateOpensearchClusterPipelineDetails build() {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOpensearchClusterPipelineDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOpensearchClusterPipelineDetails)) {
            return false;
        }
