...
/**
 * Details for configuring the cluster to work as an Outbound cluster <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConfigureOutboundClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ConfigureOutboundClusterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"inboundClusterIds"})
    public ConfigureOutboundClusterDetails(java.util.List<String> inboundClusterIds) {
        super();
    ...
    public static class Builder {
        ...
        public ConfigureOutboundClusterDetails build() {
            ConfigureOutboundClusterDetails model =
                    new ConfigureOutboundClusterDetails(this.inboundClusterIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConfigureOutboundClusterDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureOutboundClusterDetails)) {
            return false;
        }

        ConfigureOutboundClusterDetails other = (ConfigureOutboundClusterDetails) o;
        return java.util.Objects.equals(this.inboundClusterIds, other.inboundClusterIds)
                && super.equals(other);
    }
