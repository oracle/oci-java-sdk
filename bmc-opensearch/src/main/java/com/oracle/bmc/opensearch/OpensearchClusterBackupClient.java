...
public class OpensearchClusterBackupClient implements OpensearchClusterBackup {
    /**
     ...
     */
    protected OpensearchClusterBackupClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public DeleteOpensearchClusterBackupResponse deleteOpensearchClusterBackup(
        ...
        LOG.trace("Called deleteOpensearchClusterBackup");
    ...
    public GetOpensearchClusterBackupResponse getOpensearchClusterBackup(
        ...
        LOG.trace("Called getOpensearchClusterBackup");
    ...
    public ListOpensearchClusterBackupsResponse listOpensearchClusterBackups(
        ...
        LOG.trace("Called listOpensearchClusterBackups");
    ...
    public UpdateOpensearchClusterBackupResponse updateOpensearchClusterBackup(
        ...
        LOG.trace("Called updateOpensearchClusterBackup");
