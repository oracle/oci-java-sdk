...
public class OpensearchClusterPipelineClient implements OpensearchClusterPipeline {
    /**
     ...
     */
    protected OpensearchClusterPipelineClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public CreateOpensearchClusterPipelineResponse createOpensearchClusterPipeline(
        ...
        LOG.trace("Called createOpensearchClusterPipeline");
    ...
    public DeleteOpensearchClusterPipelineResponse deleteOpensearchClusterPipeline(
        ...
        LOG.trace("Called deleteOpensearchClusterPipeline");
    ...
    public GetOpensearchClusterPipelineResponse getOpensearchClusterPipeline(
        ...
        LOG.trace("Called getOpensearchClusterPipeline");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetOpensearchClusterPipelineResponse>
                transformer =
    ...
    public ListOpensearchClusterPipelinesResponse listOpensearchClusterPipelines(
        ...
        LOG.trace("Called listOpensearchClusterPipelines");
    ...
    public UpdateOpensearchClusterPipelineResponse updateOpensearchClusterPipeline(
        ...
        LOG.trace("Called updateOpensearchClusterPipeline");
