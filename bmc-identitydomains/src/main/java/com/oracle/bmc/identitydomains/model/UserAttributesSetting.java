...
/**
 * Schema for End User Attribute mutability <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserAttributesSetting.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserAttributesSetting
    ...
    public UserAttributesSetting(
            ...
            String tenancyOcid,
            java.util.List<UserAttributesSettingsAttributeSettings> attributeSettings) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
         ...
         */
        @com.fasterxml.jackson.annotation.JsonProperty("attributeSettings")
        private java.util.List<UserAttributesSettingsAttributeSettings> attributeSettings;
         ...
         * readWrite - required: false - returned: default - type: complex
         *
         * @param attributeSettings the value to set
         * @return this builder
         */
        public Builder attributeSettings(
                java.util.List<UserAttributesSettingsAttributeSettings> attributeSettings) {
            this.attributeSettings = attributeSettings;
            this.__explicitlySet__.add("attributeSettings");
            return this;
        }
        ...
        public UserAttributesSetting build() {
            UserAttributesSetting model =
                    new UserAttributesSetting(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserAttributesSetting model) {
            ...
            if (model.wasPropertyExplicitlySet("attributeSettings")) {
                this.attributeSettings(model.getAttributeSettings());
            }
            return this;
        }
    }
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("attributeSettings")
    private final java.util.List<UserAttributesSettingsAttributeSettings> attributeSettings;
     ...
     * @return the value
     */
    public java.util.List<UserAttributesSettingsAttributeSettings> getAttributeSettings() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserAttributesSetting(");
        ...
        sb.append(", attributeSettings=").append(String.valueOf(this.attributeSettings));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserAttributesSetting)) {
            return false;
        }

        UserAttributesSetting other = (UserAttributesSetting) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.attributeSettings, other.attributeSettings)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.attributeSettings == null ? 43 : this.attributeSettings.hashCode());
