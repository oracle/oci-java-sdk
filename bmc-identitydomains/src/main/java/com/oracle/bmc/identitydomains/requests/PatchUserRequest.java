...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchUserExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchUserRequest.
 */
...
public class PatchUserRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchUserRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchUserRequest o) {
            userId(o.getUserId());
        ...
        /**
         * Build the instance of PatchUserRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchUserRequest
         */
        public PatchUserRequest build() {
            PatchUserRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchUserRequest
         */
        public PatchUserRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchUserRequest(userId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchUserRequest)) {
            return false;
        }
