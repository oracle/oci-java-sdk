...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListSettingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSettingsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListSettingsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSettingsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSettingsRequest o) {
        ...
        /**
         * Build the instance of ListSettingsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSettingsRequest
         */
        public ListSettingsRequest build() {
            ListSettingsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListSettingsRequest
         */
        public ListSettingsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListSettingsRequest(attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSettingsRequest)) {
            return false;
        }

        ListSettingsRequest other = (ListSettingsRequest) o;
