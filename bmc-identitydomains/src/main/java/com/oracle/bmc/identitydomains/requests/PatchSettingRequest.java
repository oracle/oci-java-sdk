...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSettingRequest.
 */
...
public class PatchSettingRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchSettingRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
        ...
        /**
         * ID of the resource
         * @param settingId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchSettingRequest o) {
            settingId(o.getSettingId());
        ...
        /**
         * Build the instance of PatchSettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchSettingRequest
         */
        public PatchSettingRequest build() {
            PatchSettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchSettingRequest
         */
        public PatchSettingRequest buildWithoutInvocationCallback() {
            PatchSettingRequest request = new PatchSettingRequest();
            ...
            return request;
            // new PatchSettingRequest(settingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",settingId=").append(String.valueOf(this.settingId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchSettingRequest)) {
            return false;
        }

        PatchSettingRequest other = (PatchSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.settingId, other.settingId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.settingId == null ? 43 : this.settingId.hashCode());
        result =
                (result * PRIME)
