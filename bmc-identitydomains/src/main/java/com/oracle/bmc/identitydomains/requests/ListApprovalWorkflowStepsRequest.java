...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListApprovalWorkflowStepsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApprovalWorkflowStepsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListApprovalWorkflowStepsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListApprovalWorkflowStepsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListApprovalWorkflowStepsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListApprovalWorkflowStepsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListApprovalWorkflowStepsRequest
         */
        public ListApprovalWorkflowStepsRequest build() {
            ListApprovalWorkflowStepsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListApprovalWorkflowStepsRequest
         */
        public ListApprovalWorkflowStepsRequest buildWithoutInvocationCallback() {
            ListApprovalWorkflowStepsRequest request = new ListApprovalWorkflowStepsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListApprovalWorkflowStepsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListApprovalWorkflowStepsRequest)) {
            return false;
        }

        ListApprovalWorkflowStepsRequest other = (ListApprovalWorkflowStepsRequest) o;
