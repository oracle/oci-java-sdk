...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = IdentitySettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class IdentitySettings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public IdentitySettings(
            ...
            java.util.List<IdentitySetting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<IdentitySetting> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<IdentitySetting> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentitySettings model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<IdentitySetting> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<IdentitySetting> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentitySettings)) {
            return false;
        }

        IdentitySettings other = (IdentitySettings) o;
