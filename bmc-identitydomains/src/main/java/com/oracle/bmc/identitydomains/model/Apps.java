...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Apps.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Apps extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private java.util.List<App> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<App> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Apps model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<App> resources;
     ...
     * @return the value
     */
    public java.util.List<App> getResources() {
        return resources;
    }
