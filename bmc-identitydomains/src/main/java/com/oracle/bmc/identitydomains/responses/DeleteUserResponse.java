...
public class DeleteUserResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteUserResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteUserResponse o) {
        ...
        public DeleteUserResponse build() {
            return new DeleteUserResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteUserResponse)) {
            return false;
        }
