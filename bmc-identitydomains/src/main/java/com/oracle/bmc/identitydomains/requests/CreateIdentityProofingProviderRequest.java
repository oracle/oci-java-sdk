...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateIdentityProofingProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIdentityProofingProviderRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateIdentityProofingProviderRequest
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.IdentityProofingProvider identityProofingProvider;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.IdentityProofingProvider
            getIdentityProofingProvider() {
        return identityProofingProvider;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.IdentityProofingProvider getBody$() {
        return identityProofingProvider;
    }
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.IdentityProofingProvider
                identityProofingProvider = null;
         ...
         *   - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param identityProofingProvider the value to set
         * @return this builder instance
         */
        public Builder identityProofingProvider(
                com.oracle.bmc.identitydomains.model.IdentityProofingProvider
                        identityProofingProvider) {
            this.identityProofingProvider = identityProofingProvider;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateIdentityProofingProviderRequest o) {
            ...
            identityProofingProvider(o.getIdentityProofingProvider());
        ...
        /**
         * Build the instance of CreateIdentityProofingProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateIdentityProofingProviderRequest
         */
        public CreateIdentityProofingProviderRequest build() {
            CreateIdentityProofingProviderRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.IdentityProofingProvider body) {
            identityProofingProvider(body);
            return this;
        }
         ...
         * @return instance of CreateIdentityProofingProviderRequest
         */
        public CreateIdentityProofingProviderRequest buildWithoutInvocationCallback() {
            CreateIdentityProofingProviderRequest request =
                    new CreateIdentityProofingProviderRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.identityProofingProvider = identityProofingProvider;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateIdentityProofingProviderRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, identityProofingProvider, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",identityProofingProvider=")
                .append(String.valueOf(this.identityProofingProvider));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIdentityProofingProviderRequest)) {
            return false;
        }

        CreateIdentityProofingProviderRequest other = (CreateIdentityProofingProviderRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.identityProofingProvider, other.identityProofingProvider)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.identityProofingProvider == null
                                ? 43
                                : this.identityProofingProvider.hashCode());
        result =
                (result * PRIME)
