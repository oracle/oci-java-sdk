...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AuthenticationFactorsRemoverUser.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AuthenticationFactorsRemoverUser
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display", "ocid"})
    public AuthenticationFactorsRemoverUser(String value, String ref, String display, String ocid) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public AuthenticationFactorsRemoverUser build() {
            AuthenticationFactorsRemoverUser model =
                    new AuthenticationFactorsRemoverUser(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuthenticationFactorsRemoverUser model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AuthenticationFactorsRemoverUser(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuthenticationFactorsRemoverUser)) {
            return false;
        }

        AuthenticationFactorsRemoverUser other = (AuthenticationFactorsRemoverUser) o;
