...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyDevices.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyDevices extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyDevices(
            ...
            java.util.List<MyDevice> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyDevice> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<MyDevice> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyDevices model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyDevice> resources;
     ...
     * @return the value
     */
    public java.util.List<MyDevice> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyDevices)) {
            return false;
        }

        MyDevices other = (MyDevices) o;
