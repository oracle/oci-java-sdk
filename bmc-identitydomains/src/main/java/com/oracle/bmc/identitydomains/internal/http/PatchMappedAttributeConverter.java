...
public class PatchMappedAttributeConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PatchMappedAttributeConverter.class);

    public static com.oracle.bmc.identitydomains.requests.PatchMappedAttributeRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.PatchMappedAttributeRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses
                                        .PatchMappedAttributeResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses
                                            .PatchMappedAttributeResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.PatchMappedAttributeResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .PatchMappedAttributeResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .PatchMappedAttributeResponse.builder()
