...
public class PutUserPasswordResetterResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public String toString() {
        ...
        sb.append(",userPasswordResetter=").append(String.valueOf(userPasswordResetter));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutUserPasswordResetterResponse)) {
            return false;
        }

        PutUserPasswordResetterResponse other = (PutUserPasswordResetterResponse) o;
