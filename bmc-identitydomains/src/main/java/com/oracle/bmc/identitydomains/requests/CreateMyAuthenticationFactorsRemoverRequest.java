...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMyAuthenticationFactorsRemoverExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMyAuthenticationFactorsRemoverRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateMyAuthenticationFactorsRemoverRequest
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover
            getMyAuthenticationFactorsRemover() {
        return myAuthenticationFactorsRemover;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover getBody$() {
        return myAuthenticationFactorsRemover;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover
                myAuthenticationFactorsRemover = null;
         ...
         *  - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param myAuthenticationFactorsRemover the value to set
         * @return this builder instance
         */
        public Builder myAuthenticationFactorsRemover(
                com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover
                        myAuthenticationFactorsRemover) {
            this.myAuthenticationFactorsRemover = myAuthenticationFactorsRemover;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateMyAuthenticationFactorsRemoverRequest o) {
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            myAuthenticationFactorsRemover(o.getMyAuthenticationFactorsRemover());
        ...
        /**
         * Build the instance of CreateMyAuthenticationFactorsRemoverRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateMyAuthenticationFactorsRemoverRequest
         */
        public CreateMyAuthenticationFactorsRemoverRequest build() {
            CreateMyAuthenticationFactorsRemoverRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.identitydomains.model.MyAuthenticationFactorsRemover body) {
            myAuthenticationFactorsRemover(body);
            return this;
        }
         ...
         * @return instance of CreateMyAuthenticationFactorsRemoverRequest
         */
        public CreateMyAuthenticationFactorsRemoverRequest buildWithoutInvocationCallback() {
            CreateMyAuthenticationFactorsRemoverRequest request =
                    new CreateMyAuthenticationFactorsRemoverRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.myAuthenticationFactorsRemover = myAuthenticationFactorsRemover;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateMyAuthenticationFactorsRemoverRequest(authorization, resourceTypeSchemaVersion, myAuthenticationFactorsRemover, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myAuthenticationFactorsRemover=")
                .append(String.valueOf(this.myAuthenticationFactorsRemover));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyAuthenticationFactorsRemoverRequest)) {
            return false;
        }

        CreateMyAuthenticationFactorsRemoverRequest other =
                (CreateMyAuthenticationFactorsRemoverRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.myAuthenticationFactorsRemover, other.myAuthenticationFactorsRemover)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myAuthenticationFactorsRemover == null
                                ? 43
                                : this.myAuthenticationFactorsRemover.hashCode());
        result =
                (result * PRIME)
