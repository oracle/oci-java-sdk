...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyOAuth2ClientCredentials.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyOAuth2ClientCredentials
    ...
    public MyOAuth2ClientCredentials(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyOAuth2ClientCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyOAuth2ClientCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyOAuth2ClientCredential> resources) {
            this.resources = resources;
        ...
        public MyOAuth2ClientCredentials build() {
            MyOAuth2ClientCredentials model =
                    new MyOAuth2ClientCredentials(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyOAuth2ClientCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyOAuth2ClientCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyOAuth2ClientCredential> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyOAuth2ClientCredentials(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyOAuth2ClientCredentials)) {
            return false;
        }

        MyOAuth2ClientCredentials other = (MyOAuth2ClientCredentials) o;
