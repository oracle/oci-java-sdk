...
/**
 * ApprovalWorkflowSteps applicable for the ApprovalWorkflowInstance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApprovalWorkflowApprovalWorkflowSteps.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ApprovalWorkflowApprovalWorkflowSteps
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "type", "order", "ref"})
    public ApprovalWorkflowApprovalWorkflowSteps(
            String value, String ocid, String type, Integer order, String ref) {
        super();
        this.value = value;
        this.ocid = ocid;
        this.type = type;
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
         * mutability: readOnly - required: false - returned: default - type: integer - uniqueness:
         * none
         */
        ...
        public ApprovalWorkflowApprovalWorkflowSteps build() {
            ApprovalWorkflowApprovalWorkflowSteps model =
                    new ApprovalWorkflowApprovalWorkflowSteps(
                            this.value, this.ocid, this.type, this.order, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalWorkflowApprovalWorkflowSteps model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ApprovalWorkflowApprovalWorkflowSteps(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApprovalWorkflowApprovalWorkflowSteps)) {
            return false;
        }

        ApprovalWorkflowApprovalWorkflowSteps other = (ApprovalWorkflowApprovalWorkflowSteps) o;
