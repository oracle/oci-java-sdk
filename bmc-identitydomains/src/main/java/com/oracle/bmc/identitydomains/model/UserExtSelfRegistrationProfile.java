 ...
 * required: true - returned: request - type: complex - uniqueness: none <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserExtSelfRegistrationProfile.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserExtSelfRegistrationProfile
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public UserExtSelfRegistrationProfile(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public UserExtSelfRegistrationProfile build() {
            UserExtSelfRegistrationProfile model =
                    new UserExtSelfRegistrationProfile(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserExtSelfRegistrationProfile model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserExtSelfRegistrationProfile(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserExtSelfRegistrationProfile)) {
            return false;
        }

        UserExtSelfRegistrationProfile other = (UserExtSelfRegistrationProfile) o;
