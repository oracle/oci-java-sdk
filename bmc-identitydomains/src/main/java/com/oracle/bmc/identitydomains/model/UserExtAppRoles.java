...
/**
 * A list of all AppRoles to which this User belongs directly, indirectly or implicitly. The User
 * could belong directly because the User is a member of the AppRole, could belong indirectly
 * because the User is a member of a Group that is a member of the AppRole, or could belong
 * implicitly because the AppRole is public.
 *
...
public final class UserExtAppRoles
    ...
    public static class Builder {
        ...
        /**
         * The kind of membership this User has in the AppRole. A value of 'direct' indicates that
         * the User is a member of the AppRole. A value of 'indirect' indicates that the User is a
         * member of a Group that is a member of the AppRole. A value of 'implicit' indicates that
         * the AppRole is public.
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
    ...
    /**
     * The kind of membership this User has in the AppRole. A value of 'direct' indicates that the
     * User is a member of the AppRole. A value of 'indirect' indicates that the User is a member of
     * a Group that is a member of the AppRole. A value of 'implicit' indicates that the AppRole is
     * public.
     *
     * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
