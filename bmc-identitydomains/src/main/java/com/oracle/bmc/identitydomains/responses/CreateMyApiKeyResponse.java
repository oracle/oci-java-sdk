...
public class CreateMyApiKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateMyApiKeyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMyApiKeyResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMyApiKeyResponse o) {
         ...
         */
        @Override
        public CreateMyApiKeyResponse build() {
            return new CreateMyApiKeyResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, myApiKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyApiKeyResponse)) {
            return false;
        }

        CreateMyApiKeyResponse other = (CreateMyApiKeyResponse) o;
