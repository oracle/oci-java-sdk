...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyApiKeysExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyApiKeysRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListMyApiKeysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMyApiKeysRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMyApiKeysRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListMyApiKeysRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMyApiKeysRequest
         */
        public ListMyApiKeysRequest build() {
            ListMyApiKeysRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMyApiKeysRequest
         */
        public ListMyApiKeysRequest buildWithoutInvocationCallback() {
            ListMyApiKeysRequest request = new ListMyApiKeysRequest();
            ...
            request.limit = limit;
            return request;
            // new ListMyApiKeysRequest(filter, sortBy, sortOrder, startIndex, count, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyApiKeysRequest)) {
            return false;
        }

        ListMyApiKeysRequest other = (ListMyApiKeysRequest) o;
