...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMyOAuth2ClientCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMyOAuth2ClientCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateMyOAuth2ClientCredentialRequest
    ...
    public com.oracle.bmc.identitydomains.model.MyOAuth2ClientCredential getBody$() {
        return myOAuth2ClientCredential;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateMyOAuth2ClientCredentialRequest o) {
        ...
        /**
         * Build the instance of CreateMyOAuth2ClientCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateMyOAuth2ClientCredentialRequest
         */
        public CreateMyOAuth2ClientCredentialRequest build() {
            CreateMyOAuth2ClientCredentialRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.MyOAuth2ClientCredential body) {
            myOAuth2ClientCredential(body);
            return this;
        }
         ...
         * @return instance of CreateMyOAuth2ClientCredentialRequest
         */
        public CreateMyOAuth2ClientCredentialRequest buildWithoutInvocationCallback() {
            CreateMyOAuth2ClientCredentialRequest request =
                    new CreateMyOAuth2ClientCredentialRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.myOAuth2ClientCredential = myOAuth2ClientCredential;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateMyOAuth2ClientCredentialRequest(authorization, resourceTypeSchemaVersion, myOAuth2ClientCredential, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myOAuth2ClientCredential=")
                .append(String.valueOf(this.myOAuth2ClientCredential));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyOAuth2ClientCredentialRequest)) {
            return false;
        }

        CreateMyOAuth2ClientCredentialRequest other = (CreateMyOAuth2ClientCredentialRequest) o;
