...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListUserAttributesSettingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUserAttributesSettingsRequest.
 */
...
public class ListUserAttributesSettingsRequest
    ...
    public static class Builder
         ...
         */
        public ListUserAttributesSettingsRequest build() {
            ListUserAttributesSettingsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUserAttributesSettingsRequest
         */
        public ListUserAttributesSettingsRequest buildWithoutInvocationCallback() {
            ListUserAttributesSettingsRequest request = new ListUserAttributesSettingsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUserAttributesSettingsRequest)) {
            return false;
        }

        ListUserAttributesSettingsRequest other = (ListUserAttributesSettingsRequest) o;
