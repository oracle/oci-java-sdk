...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SecurityQuestions.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SecurityQuestions extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public SecurityQuestions(
            ...
            java.util.List<SecurityQuestion> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<SecurityQuestion> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<SecurityQuestion> resources) {
            this.resources = resources;
        ...
        public SecurityQuestions build() {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityQuestions model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<SecurityQuestion> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<SecurityQuestion> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityQuestions)) {
            return false;
        }

        SecurityQuestions other = (SecurityQuestions) o;
