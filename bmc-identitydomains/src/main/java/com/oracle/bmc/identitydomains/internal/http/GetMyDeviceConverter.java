...
public class GetMyDeviceConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMyDeviceConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetMyDeviceRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.GetMyDeviceRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses.GetMyDeviceResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses.GetMyDeviceResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetMyDeviceResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetMyDeviceResponse.Builder
                                        builder =
                                ...
                                builder.myDevice(response.getItem());
