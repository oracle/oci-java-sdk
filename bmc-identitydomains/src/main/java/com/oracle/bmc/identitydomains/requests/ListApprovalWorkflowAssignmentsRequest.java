...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListApprovalWorkflowAssignmentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApprovalWorkflowAssignmentsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListApprovalWorkflowAssignmentsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListApprovalWorkflowAssignmentsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListApprovalWorkflowAssignmentsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListApprovalWorkflowAssignmentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListApprovalWorkflowAssignmentsRequest
         */
        public ListApprovalWorkflowAssignmentsRequest build() {
            ListApprovalWorkflowAssignmentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListApprovalWorkflowAssignmentsRequest
         */
        public ListApprovalWorkflowAssignmentsRequest buildWithoutInvocationCallback() {
            ListApprovalWorkflowAssignmentsRequest request =
                    new ListApprovalWorkflowAssignmentsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListApprovalWorkflowAssignmentsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListApprovalWorkflowAssignmentsRequest)) {
            return false;
        }

        ListApprovalWorkflowAssignmentsRequest other = (ListApprovalWorkflowAssignmentsRequest) o;
