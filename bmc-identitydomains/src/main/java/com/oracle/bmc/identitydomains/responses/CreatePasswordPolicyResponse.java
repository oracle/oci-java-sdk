...
public class CreatePasswordPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreatePasswordPolicyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreatePasswordPolicyResponse> {
         ...
         */
        @Override
        public Builder copy(CreatePasswordPolicyResponse o) {
        ...
        public CreatePasswordPolicyResponse build() {
            return new CreatePasswordPolicyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePasswordPolicyResponse)) {
            return false;
        }

        CreatePasswordPolicyResponse other = (CreatePasswordPolicyResponse) o;
