...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchAppExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchAppRequest.
 */
...
public class PatchAppRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchAppRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchAppRequest o) {
            appId(o.getAppId());
         ...
         *
         * @return instance of PatchAppRequest
         */
        public PatchAppRequest build() {
            PatchAppRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchAppRequest
         */
        public PatchAppRequest buildWithoutInvocationCallback() {
            PatchAppRequest request = new PatchAppRequest();
            request.appId = appId;
            ...
            return request;
            // new PatchAppRequest(appId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAppRequest)) {
            return false;
        }
