...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchRuleRequest.
 */
...
public class PatchRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchRuleRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchRuleRequest o) {
            ruleId(o.getRuleId());
        ...
        /**
         * Build the instance of PatchRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchRuleRequest
         */
        public PatchRuleRequest build() {
            PatchRuleRequest request = buildWithoutInvocationCallback();
        ...
        public PatchRuleRequest buildWithoutInvocationCallback() {
            PatchRuleRequest request = new PatchRuleRequest();
            ...
            return request;
            // new PatchRuleRequest(ruleId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchRuleRequest)) {
            return false;
        }
