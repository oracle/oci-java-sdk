...
public class PutSecurityQuestionSettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(PutSecurityQuestionSettingResponse o) {
         ...
         */
        public PutSecurityQuestionSettingResponse build() {
            return new PutSecurityQuestionSettingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSecurityQuestionSettingResponse)) {
            return false;
        }

        PutSecurityQuestionSettingResponse other = (PutSecurityQuestionSettingResponse) o;
