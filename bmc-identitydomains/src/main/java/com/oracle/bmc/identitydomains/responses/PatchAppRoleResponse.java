...
public class PatchAppRoleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchAppRoleResponse> {
         ...
         */
        @Override
        public Builder copy(PatchAppRoleResponse o) {
         ...
         */
        @Override
        public PatchAppRoleResponse build() {
            return new PatchAppRoleResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAppRoleResponse)) {
            return false;
        }

        PatchAppRoleResponse other = (PatchAppRoleResponse) o;
