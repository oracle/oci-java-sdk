...
public class DeleteNetworkPerimeterConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteNetworkPerimeterConverter.class);

    public static com.oracle.bmc.identitydomains.requests.DeleteNetworkPerimeterRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.DeleteNetworkPerimeterRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.DeleteNetworkPerimeterResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.DeleteNetworkPerimeterResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .DeleteNetworkPerimeterResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .DeleteNetworkPerimeterResponse.builder()
