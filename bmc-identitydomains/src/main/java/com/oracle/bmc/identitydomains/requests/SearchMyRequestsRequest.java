 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchMyRequestsRequest.
 */
...
public class SearchMyRequestsRequest
    ...
    public static class Builder
        ...
        public SearchMyRequestsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchMyRequestsRequest(authorization, resourceTypeSchemaVersion,
            // myRequestSearchRequest, opcRetryToken, page, limit);
        }
    }
