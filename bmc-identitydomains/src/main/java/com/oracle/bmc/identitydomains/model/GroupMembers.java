...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GroupMembers.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GroupMembers extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GroupMembers model) {
    ...
    public boolean equals(Object o) {
        ...
        GroupMembers other = (GroupMembers) o;
