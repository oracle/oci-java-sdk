...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteMySupportAccountExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMySupportAccountRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteMySupportAccountRequest
     ...
     * ID of the resource
     */
    public String getMySupportAccountId() {
        return mySupportAccountId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMySupportAccountRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String mySupportAccountId = null;

        /**
         * ID of the resource
         * @param mySupportAccountId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMySupportAccountRequest o) {
            mySupportAccountId(o.getMySupportAccountId());
        ...
        /**
         * Build the instance of DeleteMySupportAccountRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMySupportAccountRequest
         */
        public DeleteMySupportAccountRequest build() {
            DeleteMySupportAccountRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMySupportAccountRequest
         */
        public DeleteMySupportAccountRequest buildWithoutInvocationCallback() {
            DeleteMySupportAccountRequest request = new DeleteMySupportAccountRequest();
            ...
            return request;
            // new DeleteMySupportAccountRequest(mySupportAccountId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",mySupportAccountId=").append(String.valueOf(this.mySupportAccountId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMySupportAccountRequest)) {
            return false;
        }

        DeleteMySupportAccountRequest other = (DeleteMySupportAccountRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.mySupportAccountId, other.mySupportAccountId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.mySupportAccountId == null
                                ? 43
                                : this.mySupportAccountId.hashCode());
        result =
                (result * PRIME)
