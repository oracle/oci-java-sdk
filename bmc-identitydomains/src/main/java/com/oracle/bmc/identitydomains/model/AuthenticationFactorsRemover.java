...
/**
 * This schema defines the attributes of Authentication Factors Remover call. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AuthenticationFactorsRemover.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AuthenticationFactorsRemover
    ...
    public static class Builder {
        ...
        private AuthenticationFactorsRemoverUser user;

        public Builder user(AuthenticationFactorsRemoverUser user) {
            this.user = user;
            this.__explicitlySet__.add("user");
            return this;
        }
        /**
         * Specifies the type of factors to remove. Either MFA factors or AccountRecovery factors or
         * All factors
         *
        ...
        public AuthenticationFactorsRemover build() {
            AuthenticationFactorsRemover model =
                    new AuthenticationFactorsRemover(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuthenticationFactorsRemover model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final AuthenticationFactorsRemoverUser user;

    public AuthenticationFactorsRemoverUser getUser() {
        return user;
    }

    /**
     * Specifies the type of factors to remove. Either MFA factors or AccountRecovery factors or All
     * factors
     *
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuthenticationFactorsRemover)) {
            return false;
        }

        AuthenticationFactorsRemover other = (AuthenticationFactorsRemover) o;
