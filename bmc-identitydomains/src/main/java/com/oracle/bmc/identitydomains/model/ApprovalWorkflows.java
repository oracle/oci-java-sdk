...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ApprovalWorkflows.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ApprovalWorkflows extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public ApprovalWorkflows(
            ...
            java.util.List<ApprovalWorkflow> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<ApprovalWorkflow> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<ApprovalWorkflow> resources) {
            this.resources = resources;
        ...
        public ApprovalWorkflows build() {
            ApprovalWorkflows model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalWorkflows model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<ApprovalWorkflow> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<ApprovalWorkflow> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApprovalWorkflows)) {
            return false;
        }

        ApprovalWorkflows other = (ApprovalWorkflows) o;
