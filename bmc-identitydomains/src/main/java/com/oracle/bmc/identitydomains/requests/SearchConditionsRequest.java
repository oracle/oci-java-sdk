 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchConditionsRequest.
 */
...
public class SearchConditionsRequest
    ...
    public static class Builder
        ...
        public SearchConditionsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchConditionsRequest(authorization, resourceTypeSchemaVersion,
            // conditionSearchRequest, opcRetryToken, page, limit);
        }
    }
