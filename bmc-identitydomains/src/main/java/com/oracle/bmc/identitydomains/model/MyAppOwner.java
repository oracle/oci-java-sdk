...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyAppOwner.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyAppOwner extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public MyAppOwner(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public MyAppOwner build() {
            MyAppOwner model = new MyAppOwner(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyAppOwner model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyAppOwner)) {
            return false;
        }

        MyAppOwner other = (MyAppOwner) o;
