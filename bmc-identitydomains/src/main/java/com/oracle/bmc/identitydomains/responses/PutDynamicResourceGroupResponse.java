...
public class PutDynamicResourceGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PutDynamicResourceGroupResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(PutDynamicResourceGroupResponse o) {
         ...
         */
        public PutDynamicResourceGroupResponse build() {
            return new PutDynamicResourceGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutDynamicResourceGroupResponse)) {
            return false;
        }

        PutDynamicResourceGroupResponse other = (PutDynamicResourceGroupResponse) o;
