...
public class DeleteSecurityQuestionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteSecurityQuestionConverter.class);

    public static com.oracle.bmc.identitydomains.requests.DeleteSecurityQuestionRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.DeleteSecurityQuestionRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.DeleteSecurityQuestionResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.DeleteSecurityQuestionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .DeleteSecurityQuestionResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .DeleteSecurityQuestionResponse.builder()
