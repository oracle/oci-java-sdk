...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetMyRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMyRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetMyRequestRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMyRequestRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String myRequestId = null;

        /**
         * ID of the resource
         * @param myRequestId the value to set
         * @return this builder instance
         */
        public Builder myRequestId(String myRequestId) {
         ...
         * @return this builder instance
         */
        public Builder copy(GetMyRequestRequest o) {
            myRequestId(o.getMyRequestId());
        ...
        /**
         * Build the instance of GetMyRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetMyRequestRequest
         */
        public GetMyRequestRequest build() {
            GetMyRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetMyRequestRequest
         */
        public GetMyRequestRequest buildWithoutInvocationCallback() {
            GetMyRequestRequest request = new GetMyRequestRequest();
            request.myRequestId = myRequestId;
            ...
            return request;
            // new GetMyRequestRequest(myRequestId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myRequestId=").append(String.valueOf(this.myRequestId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMyRequestRequest)) {
            return false;
        }

        GetMyRequestRequest other = (GetMyRequestRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.myRequestId, other.myRequestId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.myRequestId == null ? 43 : this.myRequestId.hashCode());
        result =
                (result * PRIME)
