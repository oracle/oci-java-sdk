...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = GrantSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class GrantSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public GrantSearchRequest build() {
            GrantSearchRequest model =
                    new GrantSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GrantSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GrantSearchRequest)) {
            return false;
        }

        GrantSearchRequest other = (GrantSearchRequest) o;
