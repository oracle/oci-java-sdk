...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutKmsiSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutKmsiSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutKmsiSettingRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.KmsiSetting> {
     ...
     * ID of the resource
     */
    public String getKmsiSettingId() {
        return kmsiSettingId;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.KmsiSetting getBody$() {
        return kmsiSetting;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutKmsiSettingRequest, com.oracle.bmc.identitydomains.model.KmsiSetting> {
         ...
         * ID of the resource
         */
        private String kmsiSettingId = null;

        /**
         * ID of the resource
         * @param kmsiSettingId the value to set
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.KmsiSetting kmsiSetting = null;
         ...
         * @return this builder instance
         */
        public Builder copy(PutKmsiSettingRequest o) {
            kmsiSettingId(o.getKmsiSettingId());
        ...
        /**
         * Build the instance of PutKmsiSettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutKmsiSettingRequest
         */
        public PutKmsiSettingRequest build() {
            PutKmsiSettingRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.KmsiSetting body) {
            kmsiSetting(body);
            return this;
        }
         ...
         * @return instance of PutKmsiSettingRequest
         */
        public PutKmsiSettingRequest buildWithoutInvocationCallback() {
            PutKmsiSettingRequest request = new PutKmsiSettingRequest();
            ...
            request.kmsiSetting = kmsiSetting;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutKmsiSettingRequest(kmsiSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, kmsiSetting, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",kmsiSettingId=").append(String.valueOf(this.kmsiSettingId));
        ...
        sb.append(",kmsiSetting=").append(String.valueOf(this.kmsiSetting));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutKmsiSettingRequest)) {
            return false;
        }

        PutKmsiSettingRequest other = (PutKmsiSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.kmsiSettingId, other.kmsiSettingId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.kmsiSettingId == null ? 43 : this.kmsiSettingId.hashCode());
        result =
                (result * PRIME)
