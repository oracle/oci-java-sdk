 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutConditionRequest.
 */
...
public class PutConditionRequest
    ...
    public static class Builder
        ...
        public PutConditionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutConditionRequest(conditionId, authorization, resourceTypeSchemaVersion,
            // attributes, attributeSets, condition, ifMatch, opcRetryToken);
        }
    }
