...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetMyAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMyAuthTokenRequest.
 */
...
public class GetMyAuthTokenRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetMyAuthTokenRequest build() {
            GetMyAuthTokenRequest request = buildWithoutInvocationCallback();
        ...
        public GetMyAuthTokenRequest buildWithoutInvocationCallback() {
            GetMyAuthTokenRequest request = new GetMyAuthTokenRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMyAuthTokenRequest)) {
            return false;
        }

        GetMyAuthTokenRequest other = (GetMyAuthTokenRequest) o;
