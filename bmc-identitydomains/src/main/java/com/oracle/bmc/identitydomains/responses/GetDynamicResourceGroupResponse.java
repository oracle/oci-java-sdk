...
public class GetDynamicResourceGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetDynamicResourceGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDynamicResourceGroupResponse o) {
         ...
         */
        @Override
        public GetDynamicResourceGroupResponse build() {
            return new GetDynamicResourceGroupResponse(
                    __httpStatusCode__, headers, opcRequestId, dynamicResourceGroup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDynamicResourceGroupResponse)) {
            return false;
        }

        GetDynamicResourceGroupResponse other = (GetDynamicResourceGroupResponse) o;
