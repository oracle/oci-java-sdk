...
public final class ExtensionRequestableGroup
    ...
    public static class Builder {
        ...
        public ExtensionRequestableGroup build() {
            ExtensionRequestableGroup model = new ExtensionRequestableGroup(this.requestable);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExtensionRequestableGroup model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExtensionRequestableGroup(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExtensionRequestableGroup)) {
            return false;
        }

        ExtensionRequestableGroup other = (ExtensionRequestableGroup) o;
