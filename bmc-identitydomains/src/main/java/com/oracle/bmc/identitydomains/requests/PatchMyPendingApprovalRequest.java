...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMyPendingApprovalExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMyPendingApprovalRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchMyPendingApprovalRequest
     ...
     * ID of the resource
     */
    public String getMyPendingApprovalId() {
        return myPendingApprovalId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchMyPendingApprovalRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * ID of the resource
         */
        private String myPendingApprovalId = null;

        /**
         * ID of the resource
         * @param myPendingApprovalId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchMyPendingApprovalRequest o) {
            myPendingApprovalId(o.getMyPendingApprovalId());
         ...
         *
         * @return instance of PatchMyPendingApprovalRequest
         */
        public PatchMyPendingApprovalRequest build() {
            PatchMyPendingApprovalRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchMyPendingApprovalRequest
         */
        public PatchMyPendingApprovalRequest buildWithoutInvocationCallback() {
            PatchMyPendingApprovalRequest request = new PatchMyPendingApprovalRequest();
            request.myPendingApprovalId = myPendingApprovalId;
            ...
            return request;
            // new PatchMyPendingApprovalRequest(myPendingApprovalId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myPendingApprovalId=").append(String.valueOf(this.myPendingApprovalId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyPendingApprovalRequest)) {
            return false;
        }

        PatchMyPendingApprovalRequest other = (PatchMyPendingApprovalRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.myPendingApprovalId, other.myPendingApprovalId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myPendingApprovalId == null
                                ? 43
                                : this.myPendingApprovalId.hashCode());
        result =
                (result * PRIME)
