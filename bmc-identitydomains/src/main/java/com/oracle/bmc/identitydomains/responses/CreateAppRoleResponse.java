...
public class CreateAppRoleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAppRoleResponse> {
         ...
         */
        @Override
        public Builder copy(CreateAppRoleResponse o) {
         ...
         */
        @Override
        public CreateAppRoleResponse build() {
            return new CreateAppRoleResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, appRole);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAppRoleResponse)) {
            return false;
        }

        CreateAppRoleResponse other = (CreateAppRoleResponse) o;
