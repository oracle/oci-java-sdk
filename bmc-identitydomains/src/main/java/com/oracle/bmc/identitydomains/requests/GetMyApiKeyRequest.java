 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMyApiKeyRequest.
 */
...
public class GetMyApiKeyRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetMyApiKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetMyApiKeyRequest(myApiKeyId, authorization, resourceTypeSchemaVersion,
            // opcRetryToken);
        }
    }
