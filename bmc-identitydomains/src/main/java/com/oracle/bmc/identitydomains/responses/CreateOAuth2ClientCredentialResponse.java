...
public class CreateOAuth2ClientCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateOAuth2ClientCredentialResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateOAuth2ClientCredentialResponse o) {
         ...
         */
        public CreateOAuth2ClientCredentialResponse build() {
            return new CreateOAuth2ClientCredentialResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOAuth2ClientCredentialResponse)) {
            return false;
        }

        CreateOAuth2ClientCredentialResponse other = (CreateOAuth2ClientCredentialResponse) o;
