...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PasswordPolicies.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class PasswordPolicies extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public PasswordPolicies(
            ...
            java.util.List<PasswordPolicy> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<PasswordPolicy> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<PasswordPolicy> resources) {
            this.resources = resources;
        ...
        public PasswordPolicies build() {
            PasswordPolicies model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PasswordPolicies model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<PasswordPolicy> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<PasswordPolicy> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PasswordPolicies)) {
            return false;
        }

        PasswordPolicies other = (PasswordPolicies) o;
