...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyCustomerSecretKeys.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyCustomerSecretKeys extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyCustomerSecretKeys(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyCustomerSecretKey> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyCustomerSecretKey> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyCustomerSecretKey> resources) {
            this.resources = resources;
        ...
        public MyCustomerSecretKeys build() {
            MyCustomerSecretKeys model =
                    new MyCustomerSecretKeys(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyCustomerSecretKeys model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyCustomerSecretKey> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyCustomerSecretKey> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyCustomerSecretKeys(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyCustomerSecretKeys)) {
            return false;
        }

        MyCustomerSecretKeys other = (MyCustomerSecretKeys) o;
