...
/**
 * The user's OAuth2 client credentials. <br>
...
public final class OAuth2ClientCredential
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: false - idcsSearchable: false - multiValued: false
         * - mutability: writeOnly - required: false - returned: default - type: boolean -
         * uniqueness: none
         */
         ...
         * complex - mutability: readWrite - multiValued: true - required: true - returned: default
         */
        @com.fasterxml.jackson.annotation.JsonProperty("scopes")
        private java.util.List<OAuth2ClientCredentialScopes> scopes;
         ...
         * @return this builder
         */
        public Builder scopes(java.util.List<OAuth2ClientCredentialScopes> scopes) {
            this.scopes = scopes;
        ...
        private OAuth2ClientCredentialUser user;

        public Builder user(OAuth2ClientCredentialUser user) {
            this.user = user;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuth2ClientCredential model) {
     ...
     *
     * <p>*SCIM++ Properties:** - caseExact: false - idcsSearchable: false - multiValued: false -
     * mutability: writeOnly - required: false - returned: default - type: boolean - uniqueness:
     * none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isResetSecret")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("scopes")
    private final java.util.List<OAuth2ClientCredentialScopes> scopes;
     ...
     * @return the value
     */
    public java.util.List<OAuth2ClientCredentialScopes> getScopes() {
        return scopes;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final OAuth2ClientCredentialUser user;

    public OAuth2ClientCredentialUser getUser() {
        return user;
    }
