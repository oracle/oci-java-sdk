...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyApiKeyUser.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class MyApiKeyUser extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref", "display", "name"})
    public MyApiKeyUser(String value, String ocid, String ref, String display, String name) {
        super();
        this.value = value;
        this.ocid = ocid;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public MyApiKeyUser build() {
            MyApiKeyUser model =
                    new MyApiKeyUser(this.value, this.ocid, this.ref, this.display, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyApiKeyUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyApiKeyUser)) {
            return false;
        }

        MyApiKeyUser other = (MyApiKeyUser) o;
