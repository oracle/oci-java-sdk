...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetAuthenticationFactorSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAuthenticationFactorSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetAuthenticationFactorSettingRequest
     ...
     * ID of the resource
     */
    public String getAuthenticationFactorSettingId() {
        return authenticationFactorSettingId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAuthenticationFactorSettingRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String authenticationFactorSettingId = null;

        /**
         * ID of the resource
         * @param authenticationFactorSettingId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetAuthenticationFactorSettingRequest o) {
            authenticationFactorSettingId(o.getAuthenticationFactorSettingId());
         ...
         *
         * @return instance of GetAuthenticationFactorSettingRequest
         */
        public GetAuthenticationFactorSettingRequest build() {
            GetAuthenticationFactorSettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAuthenticationFactorSettingRequest
         */
        public GetAuthenticationFactorSettingRequest buildWithoutInvocationCallback() {
            GetAuthenticationFactorSettingRequest request =
                    new GetAuthenticationFactorSettingRequest();
            ...
            return request;
            // new GetAuthenticationFactorSettingRequest(authenticationFactorSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",authenticationFactorSettingId=")
                .append(String.valueOf(this.authenticationFactorSettingId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAuthenticationFactorSettingRequest)) {
            return false;
        }

        GetAuthenticationFactorSettingRequest other = (GetAuthenticationFactorSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.authenticationFactorSettingId, other.authenticationFactorSettingId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.authenticationFactorSettingId == null
                                ? 43
                                : this.authenticationFactorSettingId.hashCode());
        result =
                (result * PRIME)
