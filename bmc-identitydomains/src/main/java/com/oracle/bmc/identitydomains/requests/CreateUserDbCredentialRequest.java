...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateUserDbCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateUserDbCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateUserDbCredentialRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.UserDbCredential> {
    ...
    public com.oracle.bmc.identitydomains.model.UserDbCredential getBody$() {
        return userDbCredential;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateUserDbCredentialRequest,
                    com.oracle.bmc.identitydomains.model.UserDbCredential> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.UserDbCredential userDbCredential = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateUserDbCredentialRequest o) {
        ...
        /**
         * Build the instance of CreateUserDbCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateUserDbCredentialRequest
         */
        public CreateUserDbCredentialRequest build() {
            CreateUserDbCredentialRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.UserDbCredential body) {
            userDbCredential(body);
            return this;
        }
         ...
         * @return instance of CreateUserDbCredentialRequest
         */
        public CreateUserDbCredentialRequest buildWithoutInvocationCallback() {
            CreateUserDbCredentialRequest request = new CreateUserDbCredentialRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.userDbCredential = userDbCredential;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateUserDbCredentialRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, userDbCredential, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",userDbCredential=").append(String.valueOf(this.userDbCredential));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateUserDbCredentialRequest)) {
            return false;
        }

        CreateUserDbCredentialRequest other = (CreateUserDbCredentialRequest) o;
