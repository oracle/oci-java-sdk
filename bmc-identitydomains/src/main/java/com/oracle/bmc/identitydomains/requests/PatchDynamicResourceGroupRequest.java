...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchDynamicResourceGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchDynamicResourceGroupRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchDynamicResourceGroupRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchDynamicResourceGroupRequest o) {
        ...
        /**
         * Build the instance of PatchDynamicResourceGroupRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchDynamicResourceGroupRequest
         */
        public PatchDynamicResourceGroupRequest build() {
            PatchDynamicResourceGroupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchDynamicResourceGroupRequest
         */
        public PatchDynamicResourceGroupRequest buildWithoutInvocationCallback() {
            PatchDynamicResourceGroupRequest request = new PatchDynamicResourceGroupRequest();
            ...
            return request;
            // new PatchDynamicResourceGroupRequest(dynamicResourceGroupId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchDynamicResourceGroupRequest)) {
            return false;
        }

        PatchDynamicResourceGroupRequest other = (PatchDynamicResourceGroupRequest) o;
