...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutMePasswordChangerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutMePasswordChangerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutMePasswordChangerRequest
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.MePasswordChanger mePasswordChanger;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.MePasswordChanger getMePasswordChanger() {
        return mePasswordChanger;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.MePasswordChanger getBody$() {
        return mePasswordChanger;
    }
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.MePasswordChanger mePasswordChanger = null;
         ...
         *  - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param mePasswordChanger the value to set
         * @return this builder instance
         */
        public Builder mePasswordChanger(
                com.oracle.bmc.identitydomains.model.MePasswordChanger mePasswordChanger) {
         ...
         * @return this builder instance
         */
        public Builder copy(PutMePasswordChangerRequest o) {
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            mePasswordChanger(o.getMePasswordChanger());
        ...
        /**
         * Build the instance of PutMePasswordChangerRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutMePasswordChangerRequest
         */
        public PutMePasswordChangerRequest build() {
            PutMePasswordChangerRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.MePasswordChanger body) {
            mePasswordChanger(body);
            return this;
        }
        ...
        public PutMePasswordChangerRequest buildWithoutInvocationCallback() {
            PutMePasswordChangerRequest request = new PutMePasswordChangerRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.mePasswordChanger = mePasswordChanger;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutMePasswordChangerRequest(authorization, resourceTypeSchemaVersion, mePasswordChanger, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutMePasswordChangerRequest)) {
            return false;
        }

        PutMePasswordChangerRequest other = (PutMePasswordChangerRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.mePasswordChanger, other.mePasswordChanger)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.mePasswordChanger == null ? 43 : this.mePasswordChanger.hashCode());
