...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MyAppUserWalletArtifact.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyAppUserWalletArtifact
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref"})
    public MyAppUserWalletArtifact(String value, String ref) {
        super();
        this.value = value;
        this.ref = ref;
    }
    ...
    public static class Builder {
        ...
        public MyAppUserWalletArtifact build() {
            MyAppUserWalletArtifact model = new MyAppUserWalletArtifact(this.value, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyAppUserWalletArtifact model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyAppUserWalletArtifact(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyAppUserWalletArtifact)) {
            return false;
        }

        MyAppUserWalletArtifact other = (MyAppUserWalletArtifact) o;
