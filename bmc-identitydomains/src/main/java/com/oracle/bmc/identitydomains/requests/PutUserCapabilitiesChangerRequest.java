...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutUserCapabilitiesChangerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutUserCapabilitiesChangerRequest.
 */
...
public class PutUserCapabilitiesChangerRequest
    ...
    public static class Builder
        ...
        public PutUserCapabilitiesChangerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutUserCapabilitiesChangerRequest(userCapabilitiesChangerId, authorization, resourceTypeSchemaVersion, userCapabilitiesChanger, ifMatch, opcRetryToken);
        }
    }
