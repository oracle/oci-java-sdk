...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateApprovalWorkflowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateApprovalWorkflowRequest.
 */
...
public class CreateApprovalWorkflowRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateApprovalWorkflowRequest o) {
        ...
        /**
         * Build the instance of CreateApprovalWorkflowRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateApprovalWorkflowRequest
         */
        public CreateApprovalWorkflowRequest build() {
            CreateApprovalWorkflowRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateApprovalWorkflowRequest
         */
        public CreateApprovalWorkflowRequest buildWithoutInvocationCallback() {
            CreateApprovalWorkflowRequest request = new CreateApprovalWorkflowRequest();
            ...
            return request;
            // new CreateApprovalWorkflowRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, approvalWorkflow, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApprovalWorkflowRequest)) {
            return false;
        }

        CreateApprovalWorkflowRequest other = (CreateApprovalWorkflowRequest) o;
