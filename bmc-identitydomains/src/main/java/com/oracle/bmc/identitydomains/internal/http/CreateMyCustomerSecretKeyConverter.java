...
public class CreateMyCustomerSecretKeyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateMyCustomerSecretKeyConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreateMyCustomerSecretKeyRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.identitydomains.requests.CreateMyCustomerSecretKeyRequest request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/admin/v1").path("MyCustomerSecretKeys");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreateMyCustomerSecretKeyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
