...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DynamicResourceGroups.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DynamicResourceGroups
    ...
    public DynamicResourceGroups(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<DynamicResourceGroup> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<DynamicResourceGroup> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<DynamicResourceGroup> resources) {
            this.resources = resources;
        ...
        public DynamicResourceGroups build() {
            DynamicResourceGroups model =
                    new DynamicResourceGroups(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DynamicResourceGroups model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<DynamicResourceGroup> resources;
     ...
     * @return the value
     */
    public java.util.List<DynamicResourceGroup> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DynamicResourceGroups(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DynamicResourceGroups)) {
            return false;
        }

        DynamicResourceGroups other = (DynamicResourceGroups) o;
