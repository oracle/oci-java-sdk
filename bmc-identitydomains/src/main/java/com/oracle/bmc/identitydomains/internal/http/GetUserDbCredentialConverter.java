...
public class GetUserDbCredentialConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetUserDbCredentialConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetUserDbCredentialRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.GetUserDbCredentialRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.GetUserDbCredentialResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetUserDbCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetUserDbCredentialResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .GetUserDbCredentialResponse.builder()
