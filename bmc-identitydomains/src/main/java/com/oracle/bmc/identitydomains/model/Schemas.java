...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Schemas.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Schemas extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Schemas(
            ...
            java.util.List<Schema> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<Schema> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Schema> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Schemas model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Schema> resources;
