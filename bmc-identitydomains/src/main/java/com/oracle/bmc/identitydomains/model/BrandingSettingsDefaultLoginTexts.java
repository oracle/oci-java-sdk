...
/**
 * Default Login text in different locales <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BrandingSettingsDefaultLoginTexts.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class BrandingSettingsDefaultLoginTexts
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "locale"})
    public BrandingSettingsDefaultLoginTexts(String value, String locale) {
        super();
        this.value = value;
        this.locale = locale;
    }
    ...
    public static class Builder {
        ...
        public BrandingSettingsDefaultLoginTexts build() {
            BrandingSettingsDefaultLoginTexts model =
                    new BrandingSettingsDefaultLoginTexts(this.value, this.locale);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BrandingSettingsDefaultLoginTexts model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BrandingSettingsDefaultLoginTexts(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BrandingSettingsDefaultLoginTexts)) {
            return false;
        }

        BrandingSettingsDefaultLoginTexts other = (BrandingSettingsDefaultLoginTexts) o;
