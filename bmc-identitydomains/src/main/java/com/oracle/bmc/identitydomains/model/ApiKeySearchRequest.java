...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ApiKeySearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ApiKeySearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ApiKeySearchRequest build() {
            ApiKeySearchRequest model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApiKeySearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApiKeySearchRequest)) {
            return false;
        }

        ApiKeySearchRequest other = (ApiKeySearchRequest) o;
