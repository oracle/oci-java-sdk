...
public class PatchMyAuthTokenResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchMyAuthTokenResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchMyAuthTokenResponse> {
         ...
         */
        @Override
        public Builder copy(PatchMyAuthTokenResponse o) {
         ...
         */
        @Override
        public PatchMyAuthTokenResponse build() {
            return new PatchMyAuthTokenResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyAuthTokenResponse)) {
            return false;
        }

        PatchMyAuthTokenResponse other = (PatchMyAuthTokenResponse) o;
