...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetOciConsoleSignOnPolicyConsentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOciConsoleSignOnPolicyConsentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetOciConsoleSignOnPolicyConsentRequest
     ...
     * ID of the resource
     */
    public String getOciConsoleSignOnPolicyConsentId() {
        return ociConsoleSignOnPolicyConsentId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetOciConsoleSignOnPolicyConsentRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String ociConsoleSignOnPolicyConsentId = null;

        /**
         * ID of the resource
         * @param ociConsoleSignOnPolicyConsentId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetOciConsoleSignOnPolicyConsentRequest o) {
            ociConsoleSignOnPolicyConsentId(o.getOciConsoleSignOnPolicyConsentId());
        ...
        /**
         * Build the instance of GetOciConsoleSignOnPolicyConsentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetOciConsoleSignOnPolicyConsentRequest
         */
        public GetOciConsoleSignOnPolicyConsentRequest build() {
            GetOciConsoleSignOnPolicyConsentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetOciConsoleSignOnPolicyConsentRequest
         */
        public GetOciConsoleSignOnPolicyConsentRequest buildWithoutInvocationCallback() {
            GetOciConsoleSignOnPolicyConsentRequest request =
                    new GetOciConsoleSignOnPolicyConsentRequest();
            request.ociConsoleSignOnPolicyConsentId = ociConsoleSignOnPolicyConsentId;
            ...
            return request;
            // new GetOciConsoleSignOnPolicyConsentRequest(ociConsoleSignOnPolicyConsentId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",ociConsoleSignOnPolicyConsentId=")
                .append(String.valueOf(this.ociConsoleSignOnPolicyConsentId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOciConsoleSignOnPolicyConsentRequest)) {
            return false;
        }

        GetOciConsoleSignOnPolicyConsentRequest other = (GetOciConsoleSignOnPolicyConsentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.ociConsoleSignOnPolicyConsentId, other.ociConsoleSignOnPolicyConsentId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ociConsoleSignOnPolicyConsentId == null
                                ? 43
                                : this.ociConsoleSignOnPolicyConsentId.hashCode());
        result =
                (result * PRIME)
