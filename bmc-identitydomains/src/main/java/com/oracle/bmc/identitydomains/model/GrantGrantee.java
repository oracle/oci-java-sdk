...
public final class GrantGrantee extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public GrantGrantee build() {
            GrantGrantee model = new GrantGrantee(this.value, this.ref, this.type, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GrantGrantee model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GrantGrantee)) {
            return false;
        }

        GrantGrantee other = (GrantGrantee) o;
