...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetBrandingSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBrandingSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetBrandingSettingRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * ID of the resource
     */
    public String getBrandingSettingId() {
        return brandingSettingId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBrandingSettingRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String brandingSettingId = null;

        /**
         * ID of the resource
         * @param brandingSettingId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetBrandingSettingRequest o) {
            brandingSettingId(o.getBrandingSettingId());
        ...
        /**
         * Build the instance of GetBrandingSettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetBrandingSettingRequest
         */
        public GetBrandingSettingRequest build() {
            GetBrandingSettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBrandingSettingRequest
         */
        public GetBrandingSettingRequest buildWithoutInvocationCallback() {
            GetBrandingSettingRequest request = new GetBrandingSettingRequest();
            request.brandingSettingId = brandingSettingId;
            ...
            return request;
            // new GetBrandingSettingRequest(brandingSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",brandingSettingId=").append(String.valueOf(this.brandingSettingId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBrandingSettingRequest)) {
            return false;
        }

        GetBrandingSettingRequest other = (GetBrandingSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.brandingSettingId, other.brandingSettingId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.brandingSettingId == null ? 43 : this.brandingSettingId.hashCode());
        result =
                (result * PRIME)
