...
public class PutAppStatusChangerConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PutAppStatusChangerConverter.class);

    public static com.oracle.bmc.identitydomains.requests.PutAppStatusChangerRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.PutAppStatusChangerRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("admin")
                        .path("v1")
                        .path("AppStatusChanger")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getAppStatusChangerId()));
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.PutAppStatusChangerResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.PutAppStatusChangerResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.appStatusChanger(response.getItem());
