...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateVerificationClaimExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateVerificationClaimRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateVerificationClaimRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.VerificationClaim> {
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.VerificationClaim verificationClaim;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.VerificationClaim getVerificationClaim() {
    ...
    public com.oracle.bmc.identitydomains.model.VerificationClaim getBody$() {
        return verificationClaim;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateVerificationClaimRequest,
                    com.oracle.bmc.identitydomains.model.VerificationClaim> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.VerificationClaim verificationClaim = null;
         ...
         *   - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param verificationClaim the value to set
         * @return this builder instance
         */
        public Builder verificationClaim(
                com.oracle.bmc.identitydomains.model.VerificationClaim verificationClaim) {
            this.verificationClaim = verificationClaim;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateVerificationClaimRequest o) {
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            verificationClaim(o.getVerificationClaim());
        ...
        /**
         * Build the instance of CreateVerificationClaimRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateVerificationClaimRequest
         */
        public CreateVerificationClaimRequest build() {
            CreateVerificationClaimRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.VerificationClaim body) {
            verificationClaim(body);
            return this;
        }
         ...
         * @return instance of CreateVerificationClaimRequest
         */
        public CreateVerificationClaimRequest buildWithoutInvocationCallback() {
            CreateVerificationClaimRequest request = new CreateVerificationClaimRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.verificationClaim = verificationClaim;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateVerificationClaimRequest(authorization, resourceTypeSchemaVersion, verificationClaim, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",verificationClaim=").append(String.valueOf(this.verificationClaim));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVerificationClaimRequest)) {
            return false;
        }

        CreateVerificationClaimRequest other = (CreateVerificationClaimRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.verificationClaim, other.verificationClaim)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.verificationClaim == null ? 43 : this.verificationClaim.hashCode());
        result =
                (result * PRIME)
