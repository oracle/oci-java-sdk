...
public class PutRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutRuleResponse> {
         ...
         */
        @Override
        public Builder copy(PutRuleResponse o) {
        ...
        public PutRuleResponse build() {
            return new PutRuleResponse(__httpStatusCode__, headers, opcRequestId, etag, rule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutRuleResponse)) {
            return false;
        }

        PutRuleResponse other = (PutRuleResponse) o;
