...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserDbCredential.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserDbCredential extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private UserDbCredentialsUser user;

        public Builder user(UserDbCredentialsUser user) {
            this.user = user;
        ...
        public UserDbCredential build() {
            UserDbCredential model =
                    new UserDbCredential(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserDbCredential model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final UserDbCredentialsUser user;

    public UserDbCredentialsUser getUser() {
        return user;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserDbCredential)) {
            return false;
        }

        UserDbCredential other = (UserDbCredential) o;
