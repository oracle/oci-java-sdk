...
public class PutCloudGateServerResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PutCloudGateServerResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutCloudGateServerResponse> {
         ...
         */
        @Override
        public Builder copy(PutCloudGateServerResponse o) {
         ...
         */
        @Override
        public PutCloudGateServerResponse build() {
            return new PutCloudGateServerResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutCloudGateServerResponse)) {
            return false;
        }

        PutCloudGateServerResponse other = (PutCloudGateServerResponse) o;
