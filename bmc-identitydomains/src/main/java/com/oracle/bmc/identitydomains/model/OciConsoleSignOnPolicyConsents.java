...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OciConsoleSignOnPolicyConsents.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OciConsoleSignOnPolicyConsents
    ...
    public OciConsoleSignOnPolicyConsents(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<OciConsoleSignOnPolicyConsent> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<OciConsoleSignOnPolicyConsent> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<OciConsoleSignOnPolicyConsent> resources) {
            this.resources = resources;
        ...
        public OciConsoleSignOnPolicyConsents build() {
            OciConsoleSignOnPolicyConsents model =
                    new OciConsoleSignOnPolicyConsents(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciConsoleSignOnPolicyConsents model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<OciConsoleSignOnPolicyConsent> resources;
     ...
     * @return the value
     */
    public java.util.List<OciConsoleSignOnPolicyConsent> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciConsoleSignOnPolicyConsents)) {
            return false;
        }

        OciConsoleSignOnPolicyConsents other = (OciConsoleSignOnPolicyConsents) o;
