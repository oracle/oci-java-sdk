...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UserSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserSearchRequest)) {
            return false;
        }

        UserSearchRequest other = (UserSearchRequest) o;
