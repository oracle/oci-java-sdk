...
public class CreateGroupConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateGroupConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreateGroupRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.CreateGroupRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("Groups");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses.CreateGroupResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses.CreateGroupResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreateGroupResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.CreateGroupResponse.Builder
                                        builder =
