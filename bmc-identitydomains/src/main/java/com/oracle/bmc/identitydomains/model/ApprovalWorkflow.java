...
/**
 * Schema for ApprovalWorkflow <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApprovalWorkflow.Builder.class)
...
public final class ApprovalWorkflow
    ...
    public ApprovalWorkflow(
            ...
            String name,
            String description,
            ApprovalWorkflowMaxDuration maxDuration,
            java.util.List<ApprovalWorkflowApprovalWorkflowSteps> approvalWorkflowSteps) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
        ...
        private ApprovalWorkflowMaxDuration maxDuration;

        public Builder maxDuration(ApprovalWorkflowMaxDuration maxDuration) {
            this.maxDuration = maxDuration;
            this.__explicitlySet__.add("maxDuration");
            return this;
        }
        /**
         * ApprovalWorkflowSteps applicable for the ApprovalWorkflowInstance.
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - idcsCompositeKey:
         * [value, type] - multiValued: true - mutability: readWrite - required: false - returned:
         * default - type: complex - uniqueness: none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("approvalWorkflowSteps")
        private java.util.List<ApprovalWorkflowApprovalWorkflowSteps> approvalWorkflowSteps;
         ...
         * default - type: complex - uniqueness: none
         *
         * @param approvalWorkflowSteps the value to set
         * @return this builder
         */
        public Builder approvalWorkflowSteps(
                java.util.List<ApprovalWorkflowApprovalWorkflowSteps> approvalWorkflowSteps) {
            this.approvalWorkflowSteps = approvalWorkflowSteps;
            this.__explicitlySet__.add("approvalWorkflowSteps");
            return this;
        }
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalWorkflow model) {
            ...
            if (model.wasPropertyExplicitlySet("maxDuration")) {
                this.maxDuration(model.getMaxDuration());
            }
            if (model.wasPropertyExplicitlySet("approvalWorkflowSteps")) {
                this.approvalWorkflowSteps(model.getApprovalWorkflowSteps());
            }
            return this;
        }
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("maxDuration")
    private final ApprovalWorkflowMaxDuration maxDuration;

    public ApprovalWorkflowMaxDuration getMaxDuration() {
        return maxDuration;
    }
     ...
     * ApprovalWorkflowSteps applicable for the ApprovalWorkflowInstance.
     *
     * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - idcsCompositeKey: [value,
     * type] - multiValued: true - mutability: readWrite - required: false - returned: default -
     * type: complex - uniqueness: none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approvalWorkflowSteps")
    private final java.util.List<ApprovalWorkflowApprovalWorkflowSteps> approvalWorkflowSteps;
     ...
     * @return the value
     */
    public java.util.List<ApprovalWorkflowApprovalWorkflowSteps> getApprovalWorkflowSteps() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", maxDuration=").append(String.valueOf(this.maxDuration));
        sb.append(", approvalWorkflowSteps=").append(String.valueOf(this.approvalWorkflowSteps));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        ApprovalWorkflow other = (ApprovalWorkflow) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.maxDuration, other.maxDuration)
                && java.util.Objects.equals(this.approvalWorkflowSteps, other.approvalWorkflowSteps)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.maxDuration == null ? 43 : this.maxDuration.hashCode());
        result =
                (result * PRIME)
                        + (this.approvalWorkflowSteps == null
                                ? 43
                                : this.approvalWorkflowSteps.hashCode());
