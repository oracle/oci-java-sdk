...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = RuleSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class RuleSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public RuleSearchRequest build() {
            RuleSearchRequest model =
                    new RuleSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RuleSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RuleSearchRequest)) {
            return false;
        }

        RuleSearchRequest other = (RuleSearchRequest) o;
