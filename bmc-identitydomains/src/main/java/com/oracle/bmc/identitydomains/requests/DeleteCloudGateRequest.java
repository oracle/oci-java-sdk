...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteCloudGateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCloudGateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteCloudGateRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteCloudGateRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteCloudGateRequest o) {
            cloudGateId(o.getCloudGateId());
        ...
        /**
         * Build the instance of DeleteCloudGateRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteCloudGateRequest
         */
        public DeleteCloudGateRequest build() {
            DeleteCloudGateRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteCloudGateRequest
         */
        public DeleteCloudGateRequest buildWithoutInvocationCallback() {
            DeleteCloudGateRequest request = new DeleteCloudGateRequest();
            ...
            return request;
            // new DeleteCloudGateRequest(cloudGateId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",cloudGateId=").append(String.valueOf(this.cloudGateId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCloudGateRequest)) {
            return false;
        }

        DeleteCloudGateRequest other = (DeleteCloudGateRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.cloudGateId, other.cloudGateId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.cloudGateId == null ? 43 : this.cloudGateId.hashCode());
        result =
                (result * PRIME)
