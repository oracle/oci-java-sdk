...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateSecurityQuestionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateSecurityQuestionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateSecurityQuestionRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.SecurityQuestion> {
    ...
    public com.oracle.bmc.identitydomains.model.SecurityQuestion getBody$() {
        return securityQuestion;
    }
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.SecurityQuestion securityQuestion = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateSecurityQuestionRequest o) {
        ...
        /**
         * Build the instance of CreateSecurityQuestionRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateSecurityQuestionRequest
         */
        public CreateSecurityQuestionRequest build() {
            CreateSecurityQuestionRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.SecurityQuestion body) {
            securityQuestion(body);
            return this;
        }
         ...
         * @return instance of CreateSecurityQuestionRequest
         */
        public CreateSecurityQuestionRequest buildWithoutInvocationCallback() {
            CreateSecurityQuestionRequest request = new CreateSecurityQuestionRequest();
            ...
            return request;
            // new CreateSecurityQuestionRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, securityQuestion, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",securityQuestion=").append(String.valueOf(this.securityQuestion));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSecurityQuestionRequest)) {
            return false;
        }

        CreateSecurityQuestionRequest other = (CreateSecurityQuestionRequest) o;
