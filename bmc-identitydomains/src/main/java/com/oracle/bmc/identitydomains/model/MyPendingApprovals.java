...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyPendingApprovals.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyPendingApprovals extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyPendingApprovals(
            ...
            java.util.List<MyPendingApproval> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyPendingApproval> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyPendingApproval> resources) {
            this.resources = resources;
        ...
        public MyPendingApprovals build() {
            MyPendingApprovals model =
                    new MyPendingApprovals(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyPendingApprovals model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyPendingApproval> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyPendingApproval> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyPendingApprovals)) {
            return false;
        }

        MyPendingApprovals other = (MyPendingApprovals) o;
