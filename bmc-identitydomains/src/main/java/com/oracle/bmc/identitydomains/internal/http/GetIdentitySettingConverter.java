...
public class GetIdentitySettingConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetIdentitySettingConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetIdentitySettingRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.GetIdentitySettingRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetIdentitySettingResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetIdentitySettingResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .GetIdentitySettingResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.identitySetting(response.getItem());
