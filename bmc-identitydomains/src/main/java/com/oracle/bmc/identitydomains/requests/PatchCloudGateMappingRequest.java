...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchCloudGateMappingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchCloudGateMappingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchCloudGateMappingRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchCloudGateMappingRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchCloudGateMappingRequest o) {
         ...
         *
         * @return instance of PatchCloudGateMappingRequest
         */
        public PatchCloudGateMappingRequest build() {
            PatchCloudGateMappingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchCloudGateMappingRequest
         */
        public PatchCloudGateMappingRequest buildWithoutInvocationCallback() {
            PatchCloudGateMappingRequest request = new PatchCloudGateMappingRequest();
            ...
            return request;
            // new PatchCloudGateMappingRequest(cloudGateMappingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchCloudGateMappingRequest)) {
            return false;
        }

        PatchCloudGateMappingRequest other = (PatchCloudGateMappingRequest) o;
