...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AccountRecoverySettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AccountRecoverySettings
    ...
    public AccountRecoverySettings(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<AccountRecoverySetting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<AccountRecoverySetting> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<AccountRecoverySetting> resources) {
            this.resources = resources;
        ...
        public AccountRecoverySettings build() {
            AccountRecoverySettings model =
                    new AccountRecoverySettings(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AccountRecoverySettings model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<AccountRecoverySetting> resources;
     ...
     * @return the value
     */
    public java.util.List<AccountRecoverySetting> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AccountRecoverySettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountRecoverySettings)) {
            return false;
        }

        AccountRecoverySettings other = (AccountRecoverySettings) o;
