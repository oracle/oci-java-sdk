...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchSocialIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSocialIdentityProviderRequest.
 */
...
public class PatchSocialIdentityProviderRequest
    ...
    public static class Builder
        ...
        public PatchSocialIdentityProviderRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchSocialIdentityProviderRequest(socialIdentityProviderId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
