...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetAuthTokenRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAuthTokenRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetAuthTokenRequest o) {
        ...
        /**
         * Build the instance of GetAuthTokenRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAuthTokenRequest
         */
        public GetAuthTokenRequest build() {
            GetAuthTokenRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAuthTokenRequest
         */
        public GetAuthTokenRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAuthTokenRequest(authTokenId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAuthTokenRequest)) {
            return false;
        }

        GetAuthTokenRequest other = (GetAuthTokenRequest) o;
