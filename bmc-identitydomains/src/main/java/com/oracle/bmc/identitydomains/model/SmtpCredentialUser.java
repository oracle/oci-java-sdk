...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SmtpCredentialUser.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SmtpCredentialUser extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref", "display", "name"})
    public SmtpCredentialUser(String value, String ocid, String ref, String display, String name) {
        super();
        this.value = value;
        this.ocid = ocid;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public SmtpCredentialUser build() {
            SmtpCredentialUser model =
                    new SmtpCredentialUser(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SmtpCredentialUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SmtpCredentialUser)) {
            return false;
        }

        SmtpCredentialUser other = (SmtpCredentialUser) o;
