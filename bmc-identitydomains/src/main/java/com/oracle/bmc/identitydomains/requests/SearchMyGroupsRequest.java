 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchMyGroupsRequest.
 */
...
public class SearchMyGroupsRequest
    ...
    public static class Builder
        ...
        public SearchMyGroupsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchMyGroupsRequest(authorization, resourceTypeSchemaVersion,
            // myGroupSearchRequest, opcRetryToken, page, limit);
        }
    }
