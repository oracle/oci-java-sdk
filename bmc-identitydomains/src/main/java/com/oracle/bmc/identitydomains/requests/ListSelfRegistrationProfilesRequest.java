...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListSelfRegistrationProfilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSelfRegistrationProfilesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListSelfRegistrationProfilesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSelfRegistrationProfilesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListSelfRegistrationProfilesRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListSelfRegistrationProfilesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListSelfRegistrationProfilesRequest
         */
        public ListSelfRegistrationProfilesRequest build() {
            ListSelfRegistrationProfilesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListSelfRegistrationProfilesRequest
         */
        public ListSelfRegistrationProfilesRequest buildWithoutInvocationCallback() {
            ListSelfRegistrationProfilesRequest request = new ListSelfRegistrationProfilesRequest();
            ...
            request.limit = limit;
            return request;
            // new ListSelfRegistrationProfilesRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSelfRegistrationProfilesRequest)) {
            return false;
        }

        ListSelfRegistrationProfilesRequest other = (ListSelfRegistrationProfilesRequest) o;
