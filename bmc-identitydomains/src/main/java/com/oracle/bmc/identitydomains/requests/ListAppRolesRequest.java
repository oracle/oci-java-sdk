 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAppRolesRequest.
 */
...
public class ListAppRolesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAppRolesRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListAppRolesRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
