...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListAccountMgmtInfosExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAccountMgmtInfosRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListAccountMgmtInfosRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListAccountMgmtInfosRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListAccountMgmtInfosRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListAccountMgmtInfosRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListAccountMgmtInfosRequest
         */
        public ListAccountMgmtInfosRequest build() {
            ListAccountMgmtInfosRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListAccountMgmtInfosRequest
         */
        public ListAccountMgmtInfosRequest buildWithoutInvocationCallback() {
            ListAccountMgmtInfosRequest request = new ListAccountMgmtInfosRequest();
            ...
            request.limit = limit;
            return request;
            // new ListAccountMgmtInfosRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAccountMgmtInfosRequest)) {
            return false;
        }

        ListAccountMgmtInfosRequest other = (ListAccountMgmtInfosRequest) o;
