...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMyApiKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMyApiKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchMyApiKeyRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchMyApiKeyRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchMyApiKeyRequest o) {
         ...
         *
         * @return instance of PatchMyApiKeyRequest
         */
        public PatchMyApiKeyRequest build() {
            PatchMyApiKeyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchMyApiKeyRequest
         */
        public PatchMyApiKeyRequest buildWithoutInvocationCallback() {
            PatchMyApiKeyRequest request = new PatchMyApiKeyRequest();
            ...
            return request;
            // new PatchMyApiKeyRequest(myApiKeyId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyApiKeyRequest)) {
            return false;
        }

        PatchMyApiKeyRequest other = (PatchMyApiKeyRequest) o;
