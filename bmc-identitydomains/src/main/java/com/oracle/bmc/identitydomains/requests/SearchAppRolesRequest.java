 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchAppRolesRequest.
 */
...
public class SearchAppRolesRequest
    ...
    public static class Builder
        ...
        public SearchAppRolesRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchAppRolesRequest(authorization, resourceTypeSchemaVersion,
            // appRoleSearchRequest, opcRetryToken, page, limit);
        }
    }
