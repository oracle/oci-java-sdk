...
public class PatchMyDeviceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchMyDeviceResponse> {
         ...
         */
        @Override
        public Builder copy(PatchMyDeviceResponse o) {
         ...
         */
        @Override
        public PatchMyDeviceResponse build() {
            return new PatchMyDeviceResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, myDevice);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyDeviceResponse)) {
            return false;
        }

        PatchMyDeviceResponse other = (PatchMyDeviceResponse) o;
