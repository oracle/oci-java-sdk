...
public class PutIdentitySettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PutIdentitySettingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutIdentitySettingResponse> {
         ...
         */
        @Override
        public Builder copy(PutIdentitySettingResponse o) {
         ...
         */
        @Override
        public PutIdentitySettingResponse build() {
            return new PutIdentitySettingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutIdentitySettingResponse)) {
            return false;
        }

        PutIdentitySettingResponse other = (PutIdentitySettingResponse) o;
