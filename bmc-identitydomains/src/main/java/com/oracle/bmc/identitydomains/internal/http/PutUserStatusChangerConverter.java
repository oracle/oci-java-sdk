...
public class PutUserStatusChangerConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PutUserStatusChangerConverter.class);

    public static com.oracle.bmc.identitydomains.requests.PutUserStatusChangerRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.PutUserStatusChangerRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("admin")
                        .path("v1")
                        .path("UserStatusChanger")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getUserStatusChangerId()));
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.PutUserStatusChangerResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.PutUserStatusChangerResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.userStatusChanger(response.getItem());
