...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchApprovalWorkflowStepExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchApprovalWorkflowStepRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchApprovalWorkflowStepRequest
     ...
     * ID of the resource
     */
    public String getApprovalWorkflowStepId() {
        return approvalWorkflowStepId;
    }
    /**
    ...
    public static class Builder
         ...
         * ID of the resource
         */
        private String approvalWorkflowStepId = null;

        /**
         * ID of the resource
         * @param approvalWorkflowStepId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchApprovalWorkflowStepRequest o) {
            approvalWorkflowStepId(o.getApprovalWorkflowStepId());
        ...
        /**
         * Build the instance of PatchApprovalWorkflowStepRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchApprovalWorkflowStepRequest
         */
        public PatchApprovalWorkflowStepRequest build() {
            PatchApprovalWorkflowStepRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchApprovalWorkflowStepRequest
         */
        public PatchApprovalWorkflowStepRequest buildWithoutInvocationCallback() {
            PatchApprovalWorkflowStepRequest request = new PatchApprovalWorkflowStepRequest();
            ...
            return request;
            // new PatchApprovalWorkflowStepRequest(approvalWorkflowStepId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",approvalWorkflowStepId=").append(String.valueOf(this.approvalWorkflowStepId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchApprovalWorkflowStepRequest)) {
            return false;
        }

        PatchApprovalWorkflowStepRequest other = (PatchApprovalWorkflowStepRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.approvalWorkflowStepId, other.approvalWorkflowStepId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.approvalWorkflowStepId == null
                                ? 43
                                : this.approvalWorkflowStepId.hashCode());
        result =
                (result * PRIME)
