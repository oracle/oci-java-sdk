...
public final class SettingsLoginTexts
    ...
    public static class Builder {
        ...
        public SettingsLoginTexts build() {
            SettingsLoginTexts model = new SettingsLoginTexts(this.value, this.locale);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SettingsLoginTexts model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SettingsLoginTexts)) {
            return false;
        }

        SettingsLoginTexts other = (SettingsLoginTexts) o;
