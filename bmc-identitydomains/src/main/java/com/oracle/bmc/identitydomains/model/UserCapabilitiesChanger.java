...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserCapabilitiesChanger.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UserCapabilitiesChanger
    ...
    public static class Builder {
        ...
        public UserCapabilitiesChanger build() {
            UserCapabilitiesChanger model =
                    new UserCapabilitiesChanger(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserCapabilitiesChanger model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserCapabilitiesChanger)) {
            return false;
        }

        UserCapabilitiesChanger other = (UserCapabilitiesChanger) o;
