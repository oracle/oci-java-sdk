 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutSettingRequest.
 */
...
public class PutSettingRequest
    ...
    public static class Builder
        ...
        public PutSettingRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutSettingRequest(settingId, authorization, resourceTypeSchemaVersion,
            // attributes, attributeSets, setting, ifMatch, opcRetryToken);
        }
    }
