...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AppSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AppSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public AppSearchRequest build() {
            AppSearchRequest model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppSearchRequest)) {
            return false;
        }

        AppSearchRequest other = (AppSearchRequest) o;
