...
public class CreateMeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMeResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMeResponse o) {
         ...
         */
        @Override
        public CreateMeResponse build() {
            return new CreateMeResponse(__httpStatusCode__, headers, opcRequestId, etag, me);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMeResponse)) {
            return false;
        }

        CreateMeResponse other = (CreateMeResponse) o;
