...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateAppRoleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAppRoleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateAppRoleRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.AppRole> {
    ...
    public com.oracle.bmc.identitydomains.model.AppRole getBody$() {
        return appRole;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateAppRoleRequest, com.oracle.bmc.identitydomains.model.AppRole> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.AppRole appRole = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAppRoleRequest o) {
         ...
         *
         * @return instance of CreateAppRoleRequest
         */
        public CreateAppRoleRequest build() {
            CreateAppRoleRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.AppRole body) {
            appRole(body);
            return this;
        }
         ...
         * @return instance of CreateAppRoleRequest
         */
        public CreateAppRoleRequest buildWithoutInvocationCallback() {
            CreateAppRoleRequest request = new CreateAppRoleRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.appRole = appRole;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateAppRoleRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, appRole, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",appRole=").append(String.valueOf(this.appRole));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAppRoleRequest)) {
            return false;
        }

        CreateAppRoleRequest other = (CreateAppRoleRequest) o;
