...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListOAuthPartnerCertificatesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOAuthPartnerCertificatesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListOAuthPartnerCertificatesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOAuthPartnerCertificatesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOAuthPartnerCertificatesRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListOAuthPartnerCertificatesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOAuthPartnerCertificatesRequest
         */
        public ListOAuthPartnerCertificatesRequest build() {
            ListOAuthPartnerCertificatesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOAuthPartnerCertificatesRequest
         */
        public ListOAuthPartnerCertificatesRequest buildWithoutInvocationCallback() {
            ListOAuthPartnerCertificatesRequest request = new ListOAuthPartnerCertificatesRequest();
            ...
            request.limit = limit;
            return request;
            // new ListOAuthPartnerCertificatesRequest(filter, sortBy, sortOrder, startIndex, count, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOAuthPartnerCertificatesRequest)) {
            return false;
        }

        ListOAuthPartnerCertificatesRequest other = (ListOAuthPartnerCertificatesRequest) o;
