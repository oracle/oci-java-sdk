...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UserStatusChanger.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserStatusChanger extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public UserStatusChanger build() {
            UserStatusChanger model =
                    new UserStatusChanger(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserStatusChanger model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserStatusChanger)) {
            return false;
        }

        UserStatusChanger other = (UserStatusChanger) o;
