...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Settings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Settings extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Settings(
            ...
            java.util.List<Setting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<Setting> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Setting> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Settings model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Setting> resources;
     ...
     * @return the value
     */
    public java.util.List<Setting> getResources() {
        return resources;
    }
