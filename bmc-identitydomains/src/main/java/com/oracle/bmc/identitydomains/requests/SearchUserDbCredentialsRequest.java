...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/SearchUserDbCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchUserDbCredentialsRequest.
 */
...
public class SearchUserDbCredentialsRequest
    ...
    public static class Builder
        ...
        public SearchUserDbCredentialsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchUserDbCredentialsRequest(authorization, resourceTypeSchemaVersion, userDbCredentialsSearchRequest, opcRetryToken, page, limit);
        }
    }
