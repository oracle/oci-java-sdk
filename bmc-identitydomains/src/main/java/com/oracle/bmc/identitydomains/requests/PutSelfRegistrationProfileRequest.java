...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutSelfRegistrationProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutSelfRegistrationProfileRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutSelfRegistrationProfileRequest
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.SelfRegistrationProfile selfRegistrationProfile;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.SelfRegistrationProfile
    ...
    public com.oracle.bmc.identitydomains.model.SelfRegistrationProfile getBody$() {
        return selfRegistrationProfile;
    }
    ...
    public static class Builder
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.SelfRegistrationProfile
                selfRegistrationProfile = null;
         ...
         *   - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param selfRegistrationProfile the value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(PutSelfRegistrationProfileRequest o) {
            ...
            selfRegistrationProfile(o.getSelfRegistrationProfile());
        ...
        /**
         * Build the instance of PutSelfRegistrationProfileRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutSelfRegistrationProfileRequest
         */
        public PutSelfRegistrationProfileRequest build() {
            PutSelfRegistrationProfileRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.SelfRegistrationProfile body) {
            selfRegistrationProfile(body);
            return this;
        }
         ...
         * @return instance of PutSelfRegistrationProfileRequest
         */
        public PutSelfRegistrationProfileRequest buildWithoutInvocationCallback() {
            PutSelfRegistrationProfileRequest request = new PutSelfRegistrationProfileRequest();
            ...
            request.selfRegistrationProfile = selfRegistrationProfile;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutSelfRegistrationProfileRequest(selfRegistrationProfileId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, selfRegistrationProfile, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSelfRegistrationProfileRequest)) {
            return false;
        }

        PutSelfRegistrationProfileRequest other = (PutSelfRegistrationProfileRequest) o;
