...
public class GetMappedAttributeConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetMappedAttributeConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetMappedAttributeRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.GetMappedAttributeRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses
                                        .GetMappedAttributeResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses
                                            .GetMappedAttributeResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetMappedAttributeResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetMappedAttributeResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .GetMappedAttributeResponse.builder()
