 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListGroupsRequest.
 */
...
public class ListGroupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListGroupsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListGroupsRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
