...
public class CreateMyAuthTokenResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateMyAuthTokenResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateMyAuthTokenResponse> {
         ...
         */
        @Override
        public Builder copy(CreateMyAuthTokenResponse o) {
         ...
         */
        @Override
        public CreateMyAuthTokenResponse build() {
            return new CreateMyAuthTokenResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, myAuthToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyAuthTokenResponse)) {
            return false;
        }

        CreateMyAuthTokenResponse other = (CreateMyAuthTokenResponse) o;
