...
public final class IdentityProviderRelayIdpParamMappings
    ...
    public static class Builder {
        ...
        public IdentityProviderRelayIdpParamMappings build() {
            IdentityProviderRelayIdpParamMappings model =
                    new IdentityProviderRelayIdpParamMappings(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityProviderRelayIdpParamMappings model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IdentityProviderRelayIdpParamMappings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityProviderRelayIdpParamMappings)) {
            return false;
        }

        IdentityProviderRelayIdpParamMappings other = (IdentityProviderRelayIdpParamMappings) o;
