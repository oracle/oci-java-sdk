...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteSocialIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSocialIdentityProviderRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteSocialIdentityProviderRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteSocialIdentityProviderRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteSocialIdentityProviderRequest o) {
        ...
        /**
         * Build the instance of DeleteSocialIdentityProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSocialIdentityProviderRequest
         */
        public DeleteSocialIdentityProviderRequest build() {
            DeleteSocialIdentityProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteSocialIdentityProviderRequest
         */
        public DeleteSocialIdentityProviderRequest buildWithoutInvocationCallback() {
            DeleteSocialIdentityProviderRequest request = new DeleteSocialIdentityProviderRequest();
            ...
            return request;
            // new DeleteSocialIdentityProviderRequest(socialIdentityProviderId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSocialIdentityProviderRequest)) {
            return false;
        }

        DeleteSocialIdentityProviderRequest other = (DeleteSocialIdentityProviderRequest) o;
