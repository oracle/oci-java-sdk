...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchNetworkPerimeterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchNetworkPerimeterRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchNetworkPerimeterRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchNetworkPerimeterRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchNetworkPerimeterRequest o) {
        ...
        /**
         * Build the instance of PatchNetworkPerimeterRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchNetworkPerimeterRequest
         */
        public PatchNetworkPerimeterRequest build() {
            PatchNetworkPerimeterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchNetworkPerimeterRequest
         */
        public PatchNetworkPerimeterRequest buildWithoutInvocationCallback() {
            PatchNetworkPerimeterRequest request = new PatchNetworkPerimeterRequest();
            ...
            return request;
            // new PatchNetworkPerimeterRequest(networkPerimeterId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchNetworkPerimeterRequest)) {
            return false;
        }

        PatchNetworkPerimeterRequest other = (PatchNetworkPerimeterRequest) o;
