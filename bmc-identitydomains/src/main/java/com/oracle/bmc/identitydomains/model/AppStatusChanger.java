...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AppStatusChanger.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AppStatusChanger extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public AppStatusChanger build() {
            AppStatusChanger model =
                    new AppStatusChanger(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppStatusChanger model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppStatusChanger)) {
            return false;
        }

        AppStatusChanger other = (AppStatusChanger) o;
