...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MyRequestSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyRequestSearchRequest
    ...
    public static class Builder {
        ...
        public MyRequestSearchRequest build() {
            MyRequestSearchRequest model =
                    new MyRequestSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyRequestSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyRequestSearchRequest)) {
            return false;
        }

        MyRequestSearchRequest other = (MyRequestSearchRequest) o;
