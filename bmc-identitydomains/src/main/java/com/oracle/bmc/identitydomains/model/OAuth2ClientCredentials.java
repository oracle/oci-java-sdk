...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OAuth2ClientCredentials.Builder.class
)
...
public final class OAuth2ClientCredentials
    ...
    public OAuth2ClientCredentials(
            ...
            java.util.List<OAuth2ClientCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<OAuth2ClientCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<OAuth2ClientCredential> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuth2ClientCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<OAuth2ClientCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<OAuth2ClientCredential> getResources() {
        return resources;
    }
