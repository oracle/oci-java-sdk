...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListApprovalWorkflowsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApprovalWorkflowsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListApprovalWorkflowsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListApprovalWorkflowsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListApprovalWorkflowsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListApprovalWorkflowsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListApprovalWorkflowsRequest
         */
        public ListApprovalWorkflowsRequest build() {
            ListApprovalWorkflowsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListApprovalWorkflowsRequest
         */
        public ListApprovalWorkflowsRequest buildWithoutInvocationCallback() {
            ListApprovalWorkflowsRequest request = new ListApprovalWorkflowsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListApprovalWorkflowsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListApprovalWorkflowsRequest)) {
            return false;
        }

        ListApprovalWorkflowsRequest other = (ListApprovalWorkflowsRequest) o;
