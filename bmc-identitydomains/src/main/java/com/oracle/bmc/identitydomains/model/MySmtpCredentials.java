...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MySmtpCredentials.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MySmtpCredentials extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MySmtpCredentials(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MySmtpCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MySmtpCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MySmtpCredential> resources) {
            this.resources = resources;
        ...
        public MySmtpCredentials build() {
            MySmtpCredentials model =
                    new MySmtpCredentials(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySmtpCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MySmtpCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MySmtpCredential> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySmtpCredentials)) {
            return false;
        }

        MySmtpCredentials other = (MySmtpCredentials) o;
