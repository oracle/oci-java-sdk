...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = BrandingSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class BrandingSettings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public BrandingSettings(
            ...
            java.util.List<BrandingSetting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<BrandingSetting> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<BrandingSetting> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BrandingSettings model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<BrandingSetting> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<BrandingSetting> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BrandingSettings)) {
            return false;
        }

        BrandingSettings other = (BrandingSettings) o;
