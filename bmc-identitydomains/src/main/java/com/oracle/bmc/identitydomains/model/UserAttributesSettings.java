...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserAttributesSettings.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserAttributesSettings
    ...
    public UserAttributesSettings(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<UserAttributesSetting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<UserAttributesSetting> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<UserAttributesSetting> resources) {
            this.resources = resources;
        ...
        public UserAttributesSettings build() {
            UserAttributesSettings model =
                    new UserAttributesSettings(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserAttributesSettings model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<UserAttributesSetting> resources;
     ...
     * @return the value
     */
    public java.util.List<UserAttributesSetting> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserAttributesSettings(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserAttributesSettings)) {
            return false;
        }

        UserAttributesSettings other = (UserAttributesSettings) o;
