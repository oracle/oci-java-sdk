 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyRequestsRequest.
 */
...
public class ListMyRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMyRequestsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListMyRequestsRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
