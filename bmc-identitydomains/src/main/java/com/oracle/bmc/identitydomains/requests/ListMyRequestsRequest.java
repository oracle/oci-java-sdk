...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyRequestsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListMyRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMyRequestsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMyRequestsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListMyRequestsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMyRequestsRequest
         */
        public ListMyRequestsRequest build() {
            ListMyRequestsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMyRequestsRequest
         */
        public ListMyRequestsRequest buildWithoutInvocationCallback() {
            ListMyRequestsRequest request = new ListMyRequestsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListMyRequestsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyRequestsRequest)) {
            return false;
        }

        ListMyRequestsRequest other = (ListMyRequestsRequest) o;
