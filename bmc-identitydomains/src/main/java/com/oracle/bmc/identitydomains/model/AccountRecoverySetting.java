...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AccountRecoverySetting.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AccountRecoverySetting
    ...
    public static class Builder {
        ...
        private java.util.List<Factors> factors;
         ...
         * none
         *
         * @param factors the value to set
         * @return this builder
         */
        public Builder factors(java.util.List<Factors> factors) {
            this.factors = factors;
            this.__explicitlySet__.add("factors");
            return this;
        }
        /**
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite
         * - required: true - returned: default - type: integer - uniqueness: none - idcsMinValue: 1
         * - idcsMaxValue: 99
         */
        ...
        /**
         * Indicates how many minutes to disable account recovery for the user. The default value is
         * 30 metric minutes.
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite
         * - required: true - returned: default - type: integer - uniqueness: none - idcsMinValue: 5
         * - idcsMaxValue: 9999
         */
        ...
        public AccountRecoverySetting build() {
            AccountRecoverySetting model =
                    new AccountRecoverySetting(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AccountRecoverySetting model) {
            ...
            if (model.wasPropertyExplicitlySet("factors")) {
    ...
    /** */
    public enum Factors implements com.oracle.bmc.http.internal.BmcEnum {
        Email("email"),
        Sms("sms"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(Factors.class);

        private final String value;
        private static java.util.Map<String, Factors> map;

        static {
            map = new java.util.HashMap<>();
            for (Factors v : Factors.values()) {
        ...
        public static Factors create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'Factors', returning UnknownEnumValue",
                    key);
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("factors")
    private final java.util.List<Factors> factors;
     ...
     * @return the value
     */
    public java.util.List<Factors> getFactors() {
        return factors;
    }
    ...
    /**
     * Indicates how many minutes to disable account recovery for the user. The default value is 30
     * metric minutes.
     *
     * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite -
     * required: true - returned: default - type: integer - uniqueness: none - idcsMinValue: 5 -
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AccountRecoverySetting(");
        ...
        sb.append(", factors=").append(String.valueOf(this.factors));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountRecoverySetting)) {
            return false;
        }

        AccountRecoverySetting other = (AccountRecoverySetting) o;
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.factors == null ? 43 : this.factors.hashCode());
        result =
                (result * PRIME)
