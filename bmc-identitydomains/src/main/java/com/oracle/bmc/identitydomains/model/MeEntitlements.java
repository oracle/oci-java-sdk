...
public final class MeEntitlements extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public MeEntitlements build() {
            MeEntitlements model =
                    new MeEntitlements(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MeEntitlements model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeEntitlements)) {
            return false;
        }

        MeEntitlements other = (MeEntitlements) o;
