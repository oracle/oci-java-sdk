...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyUserDbCredentials.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyUserDbCredentials extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyUserDbCredentials(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyUserDbCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyUserDbCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyUserDbCredential> resources) {
            this.resources = resources;
        ...
        public MyUserDbCredentials build() {
            MyUserDbCredentials model =
                    new MyUserDbCredentials(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyUserDbCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyUserDbCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyUserDbCredential> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyUserDbCredentials)) {
            return false;
        }

        MyUserDbCredentials other = (MyUserDbCredentials) o;
