...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListIdentityProofingProvidersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListIdentityProofingProvidersRequest.
 */
...
public class ListIdentityProofingProvidersRequest
    ...
    public static class Builder
        ...
        public ListIdentityProofingProvidersRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListIdentityProofingProvidersRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
