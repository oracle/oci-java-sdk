...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteIdentityProviderRequest.
 */
...
public class DeleteIdentityProviderRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteIdentityProviderRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of DeleteIdentityProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteIdentityProviderRequest
         */
        public DeleteIdentityProviderRequest build() {
            DeleteIdentityProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteIdentityProviderRequest
         */
        public DeleteIdentityProviderRequest buildWithoutInvocationCallback() {
            DeleteIdentityProviderRequest request = new DeleteIdentityProviderRequest();
            ...
            return request;
            // new DeleteIdentityProviderRequest(identityProviderId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIdentityProviderRequest)) {
            return false;
        }

        DeleteIdentityProviderRequest other = (DeleteIdentityProviderRequest) o;
