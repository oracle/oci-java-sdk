...
/**
 * Text to be displayed on UI after doing self registration <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SelfRegistrationProfileAfterSubmitText.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SelfRegistrationProfileAfterSubmitText
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"locale", "value", "isDefault"})
    public SelfRegistrationProfileAfterSubmitText(String locale, String value, Boolean isDefault) {
        super();
        this.locale = locale;
        this.value = value;
    ...
    public static class Builder {
        ...
        public SelfRegistrationProfileAfterSubmitText build() {
            SelfRegistrationProfileAfterSubmitText model =
                    new SelfRegistrationProfileAfterSubmitText(
                            this.locale, this.value, this.isDefault);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SelfRegistrationProfileAfterSubmitText model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SelfRegistrationProfileAfterSubmitText(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SelfRegistrationProfileAfterSubmitText)) {
            return false;
        }

        SelfRegistrationProfileAfterSubmitText other = (SelfRegistrationProfileAfterSubmitText) o;
