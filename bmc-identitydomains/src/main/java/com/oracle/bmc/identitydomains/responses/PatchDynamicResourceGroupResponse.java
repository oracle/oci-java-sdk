...
public class PatchDynamicResourceGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchDynamicResourceGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(PatchDynamicResourceGroupResponse o) {
         ...
         */
        @Override
        public PatchDynamicResourceGroupResponse build() {
            return new PatchDynamicResourceGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchDynamicResourceGroupResponse)) {
            return false;
        }

        PatchDynamicResourceGroupResponse other = (PatchDynamicResourceGroupResponse) o;
