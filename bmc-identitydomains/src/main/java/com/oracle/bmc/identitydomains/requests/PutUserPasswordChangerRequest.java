...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutUserPasswordChangerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutUserPasswordChangerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutUserPasswordChangerRequest
     ...
     * ID of the resource
     */
    private String userPasswordChangerId;

    /**
     * ID of the resource
     */
    public String getUserPasswordChangerId() {
        return userPasswordChangerId;
    }
    /**
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.UserPasswordChanger getUserPasswordChanger() {
    ...
    public com.oracle.bmc.identitydomains.model.UserPasswordChanger getBody$() {
        return userPasswordChanger;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutUserPasswordChangerRequest,
                    com.oracle.bmc.identitydomains.model.UserPasswordChanger> {
         ...
         * ID of the resource
         */
        private String userPasswordChangerId = null;

        /**
         * ID of the resource
         * @param userPasswordChangerId the value to set
         * @return this builder instance
         */
        public Builder userPasswordChangerId(String userPasswordChangerId) {
            this.userPasswordChangerId = userPasswordChangerId;
            return this;
        }
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.UserPasswordChanger userPasswordChanger = null;
         ...
         * @return this builder instance
         */
        public Builder userPasswordChanger(
                com.oracle.bmc.identitydomains.model.UserPasswordChanger userPasswordChanger) {
         ...
         * @return this builder instance
         */
        public Builder copy(PutUserPasswordChangerRequest o) {
            userPasswordChangerId(o.getUserPasswordChangerId());
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            userPasswordChanger(o.getUserPasswordChanger());
        ...
        /**
         * Build the instance of PutUserPasswordChangerRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutUserPasswordChangerRequest
         */
        public PutUserPasswordChangerRequest build() {
            PutUserPasswordChangerRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.UserPasswordChanger body) {
         ...
         * @return instance of PutUserPasswordChangerRequest
         */
        public PutUserPasswordChangerRequest buildWithoutInvocationCallback() {
            PutUserPasswordChangerRequest request = new PutUserPasswordChangerRequest();
            request.userPasswordChangerId = userPasswordChangerId;
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.userPasswordChanger = userPasswordChanger;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutUserPasswordChangerRequest(userPasswordChangerId, authorization, resourceTypeSchemaVersion, userPasswordChanger, ifMatch, opcRetryToken);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder()
                .userPasswordChangerId(userPasswordChangerId)
    ...
    public String toString() {
        ...
        sb.append(",userPasswordChangerId=").append(String.valueOf(this.userPasswordChangerId));
        ...
        sb.append(",userPasswordChanger=").append(String.valueOf(this.userPasswordChanger));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutUserPasswordChangerRequest)) {
            return false;
        }

        PutUserPasswordChangerRequest other = (PutUserPasswordChangerRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.userPasswordChangerId, other.userPasswordChangerId)
                ...
                && java.util.Objects.equals(this.userPasswordChanger, other.userPasswordChanger)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userPasswordChangerId == null
                                ? 43
                                : this.userPasswordChangerId.hashCode());
        result =
                (result * PRIME)
        ...
        result =
                (result * PRIME)
                        + (this.userPasswordChanger == null
                                ? 43
                                : this.userPasswordChanger.hashCode());
