...
public final class Setting extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         * "languages" and attrValues.value eq "$(preferredLanguage)" -
         * idcsCanonicalValueSourceResourceType: AllowedValue - multiValued: false - mutability:
         ...
         * AllowedValue - multiValued: false - mutability: readWrite - required: false - returned:
        ...
        /**
         * Controls whether DiagnosticRecords for external search-operations (against SCIM
         * resource-types in the Admin service) identify returned resources. If true, indicates that
         * for each successful external search-operation at least one DiagnosticRecord will include
         * at least one identifier for each matching resource that is returned in that
         * search-response. If false, no DiagnosticRecord should be expected to identify returned
         * resources for a search-operation. The default value is false.
         *
        ...
        /**
         * Specifies whether re-authentication is required or not when a user changes one of their
         * security factors such as password or email. Default is true to ensure more secure
         * behavior.
         *
         * <p>*Added In:** 20.1.3
         *
        ...
        /**
         * If reAuthWhenChangingMyAuthenticationFactors is true (default), this attribute specifies
         * which re-authentication factor to use. Allowed value is \\"password\\".
         *
         * <p>*Added In:** 20.1.3
         *
        ...
        /**
         * This value indicates whether Customer Service Representatives can login and have readOnly
         * or readWrite access. A value of 'none' means CSR cannot login to the services.
         *
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite
         * - required: false - returned: default - type: string - uniqueness: none Subject mapping
         * user profile attribute. The input format should be SCIM compliant. This attribute should
         * be of type String and multivalued to false.
         */
        ...
        /**
         * Indicates whether all the Apps in this customer tenancy should trust each other. A value
         * of true overrides the 'defaultTrustScope' attribute here in Settings, as well as any
         * App-specific 'trustScope' attribute, to force in effect 'trustScope=Account' for every
         * App in this customer tenancy.
         *
         * <p>*Added In:** 18.1.6
         *
         * <p>*SCIM++ Properties:** - multiValued: false - mutability: readWrite - required: false -
         ...
         *
         * <p>*SCIM++ Properties:** - multiValued: false - mutability: readWrite - required: false -
         * returned: default - type: string Indicates the default trust scope for all apps
         */
        ...
        /**
         * Previous Tenant issuer. This is an Oracle Identity Cloud Service internal attribute which
         * is not meant to be directly modified by ID Admin. Even if the request body (Settings)
         * contains this attribute, the actual value will be set according to the Oracle Identity
         * Cloud Service internal logic rather than solely based on the value provided in the
         * request payload.
         *
         * <p>*Added In:** 20.1.3
         *
        ...
        /**
         * The level of diagnostic logging that is currently in effect. A level of 0 (zero)
         * indicates that diagnostic logging is disabled. A level of 1 (one) indicates that
        ...
        /**
         * One or more email domains allowed in a user's email field. If unassigned, any domain is
         * allowed.
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: true - mutability: readWrite -
         * required: false - returned: default - type: string - uniqueness: none
        ...
        /**
         * Audit Event retention period. If set, overrides default of 30 days after which Audit
        ...
        /**
         * If specified, indicates the custom SIM Migrator Url which can be used while SIM to Oracle
         * Identity Cloud Service CloudAccount Migration.
         *
         * <p>*Added In:** 2012271618
         *
        ...
        /**
         * By default, a service admin can list all users in stripe. If true, a service admin cannot
         * list other users.
         *
         * <p>*Added In:** 2108190438
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite
         ...
         *
         * <p>*SCIM++ Properties:** - idcsMinValue: 0 - multiValued: false - mutability: readWrite -
         ...
         *
         * <p>*SCIM++ Properties:** - idcsCompositeKey: [resourceName] - multiValued: true -
         * mutability: readWrite - required: false - returned: default - type: complex
         */
    ...
    /**
     * Controls whether DiagnosticRecords for external search-operations (against SCIM
     * resource-types in the Admin service) identify returned resources. If true, indicates that for
     * each successful external search-operation at least one DiagnosticRecord will include at least
     * one identifier for each matching resource that is returned in that search-response. If false,
     * no DiagnosticRecord should be expected to identify returned resources for a search-operation.
    ...
    /**
     * Specifies whether re-authentication is required or not when a user changes one of their
     * security factors such as password or email. Default is true to ensure more secure behavior.
     *
     * <p>*Added In:** 20.1.3
     *
     * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite -
    ...
    /** */
    public enum ReAuthFactor implements com.oracle.bmc.http.internal.BmcEnum {
        Password("password"),
     ...
     * readWrite access. A value of 'none' means CSR cannot login to the services.
     *
     * <p>*SCIM++ Properties:** - multiValued: false - mutability: readWrite - required: true -
     * returned: default - type: string
     */
    public enum CsrAccess implements com.oracle.bmc.http.internal.BmcEnum {
        ReadOnly("readOnly"),
        ReadWrite("readWrite"),
        None("none"),
     ...
     *
     * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite -
     * required: false - returned: default - type: string - uniqueness: none Subject mapping user
     * profile attribute. The input format should be SCIM compliant. This attribute should be of
    ...
    /**
     * Indicates whether all the Apps in this customer tenancy should trust each other. A value of
     * true overrides the 'defaultTrustScope' attribute here in Settings, as well as any
     * App-specific 'trustScope' attribute, to force in effect 'trustScope=Account' for every App in
     ...
     * returned: default - type: string Indicates the default trust scope for all apps
     */
    public enum DefaultTrustScope implements com.oracle.bmc.http.internal.BmcEnum {
        Explicit("Explicit"),
        Account("Account"),
        Tags("Tags"),
    ...
    /**
     * Previous Tenant issuer. This is an Oracle Identity Cloud Service internal attribute which is
     * not meant to be directly modified by ID Admin. Even if the request body (Settings) contains
     * this attribute, the actual value will be set according to the Oracle Identity Cloud Service
     * internal logic rather than solely based on the value provided in the request payload.
     *
     * <p>*Added In:** 20.1.3
     *
     * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - mutability: readWrite -
    ...
    /**
     * The level of diagnostic logging that is currently in effect. A level of 0 (zero) indicates
     * that diagnostic logging is disabled. A level of 1 (one) indicates that diagnostic logging is
     * enabled.
     *
     * <p>*SCIM++ Properties:** - caseExact: false - idcsSearchable: false - multiValued: false -
     ...
     * readWrite - returned: default - uniqueness: none - caseExact: false
     */
    @com.fasterxml.jackson.annotation.JsonProperty("allowedForgotPasswordFlowReturnUrls")
    ...
    /**
     * If specified, indicates the set of allowed notification redirect Urls which can be specified
     * as the value of \\"notificationRedirectUrl\\" in the POST
     * .../admin/v1/MePasswordResetRequestor request payload, which will then be included in the
     * reset password email notification sent to a user as part of the forgot password / password
     * reset flow.
     *
     * <p>*Added In:** 2009041201
     *
    ...
    /**
     * Audit Event retention period. If set, overrides default of 30 days after which Audit Events
     * will be purged
     *
     * <p>*Added In:** 19.2.1
     *
     ...
     * <p>*Deprecated Since: 19.1.6**
     *
     * <p>*SCIM++ Properties:** - idcsCompositeKey: [resourceName] - multiValued: true - mutability:
     * readWrite - required: false - returned: default - type: complex
     */
    @com.fasterxml.jackson.annotation.JsonProperty("purgeConfigs")
