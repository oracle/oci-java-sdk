...
/**
 * OAuth Client Certificate schema <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OAuthClientCertificate.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OAuthClientCertificate
    ...
    public static class Builder {
         ...
         * SHA-1 Thumbprint
         *
         * <p>*SCIM++ Properties:** - type: string - multiValued: false - idcsSearchable: true -
         * required: false - caseExact: true - returned: default - uniqueness: none
         */
        ...
        public OAuthClientCertificate build() {
            OAuthClientCertificate model =
                    new OAuthClientCertificate(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuthClientCertificate model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OAuthClientCertificate(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OAuthClientCertificate)) {
            return false;
        }

        OAuthClientCertificate other = (OAuthClientCertificate) o;
