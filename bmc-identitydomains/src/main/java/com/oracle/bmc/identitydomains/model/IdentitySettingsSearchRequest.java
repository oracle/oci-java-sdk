...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IdentitySettingsSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IdentitySettingsSearchRequest
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"schemas", "attributes", "attributeSets"})
    public IdentitySettingsSearchRequest(
    ...
    public static class Builder {
        ...
        public IdentitySettingsSearchRequest build() {
            IdentitySettingsSearchRequest model =
                    new IdentitySettingsSearchRequest(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentitySettingsSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentitySettingsSearchRequest)) {
            return false;
        }

        IdentitySettingsSearchRequest other = (IdentitySettingsSearchRequest) o;
