...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserExtPreferredDevice.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserExtPreferredDevice
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public UserExtPreferredDevice(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public UserExtPreferredDevice build() {
            UserExtPreferredDevice model =
                    new UserExtPreferredDevice(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserExtPreferredDevice model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserExtPreferredDevice(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserExtPreferredDevice)) {
            return false;
        }

        UserExtPreferredDevice other = (UserExtPreferredDevice) o;
