...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OAuthPartnerCertificates.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class OAuthPartnerCertificates
    ...
    public OAuthPartnerCertificates(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<OAuthPartnerCertificate> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<OAuthPartnerCertificate> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<OAuthPartnerCertificate> resources) {
            this.resources = resources;
        ...
        public OAuthPartnerCertificates build() {
            OAuthPartnerCertificates model =
                    new OAuthPartnerCertificates(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuthPartnerCertificates model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<OAuthPartnerCertificate> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<OAuthPartnerCertificate> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OAuthPartnerCertificates(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OAuthPartnerCertificates)) {
            return false;
        }

        OAuthPartnerCertificates other = (OAuthPartnerCertificates) o;
