...
public class PatchMyApiKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchMyApiKeyResponse> {
         ...
         */
        @Override
        public Builder copy(PatchMyApiKeyResponse o) {
         ...
         */
        @Override
        public PatchMyApiKeyResponse build() {
            return new PatchMyApiKeyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyApiKeyResponse)) {
            return false;
        }

        PatchMyApiKeyResponse other = (PatchMyApiKeyResponse) o;
