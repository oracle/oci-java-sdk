...
public class SearchResourceTypeSchemaAttributesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SearchResourceTypeSchemaAttributesConverter.class);

    public static com.oracle.bmc.identitydomains.requests.SearchResourceTypeSchemaAttributesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("admin")
                        .path("v1")
                        .path("ResourceTypeSchemaAttributes")
                        .path(".search");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.SearchResourceTypeSchemaAttributesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.resourceTypeSchemaAttributes(response.getItem());
