...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AccountMgmtInfos.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AccountMgmtInfos extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public AccountMgmtInfos(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<AccountMgmtInfo> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<AccountMgmtInfo> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<AccountMgmtInfo> resources) {
            this.resources = resources;
        ...
        public AccountMgmtInfos build() {
            AccountMgmtInfos model =
                    new AccountMgmtInfos(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AccountMgmtInfos model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<AccountMgmtInfo> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<AccountMgmtInfo> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountMgmtInfos)) {
            return false;
        }

        AccountMgmtInfos other = (AccountMgmtInfos) o;
