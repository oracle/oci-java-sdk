...
public class CreateOAuthClientCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateOAuthClientCertificateResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateOAuthClientCertificateResponse o) {
         ...
         */
        @Override
        public CreateOAuthClientCertificateResponse build() {
            return new CreateOAuthClientCertificateResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, oAuthClientCertificate);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOAuthClientCertificateResponse)) {
            return false;
        }

        CreateOAuthClientCertificateResponse other = (CreateOAuthClientCertificateResponse) o;
