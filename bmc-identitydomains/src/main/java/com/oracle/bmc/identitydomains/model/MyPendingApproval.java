...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyPendingApproval.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyPendingApproval extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public MyPendingApproval build() {
            MyPendingApproval model =
                    new MyPendingApproval(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyPendingApproval model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyPendingApproval)) {
            return false;
        }

        MyPendingApproval other = (MyPendingApproval) o;
