...
/**
 * A complex type that specifies the set of Resource attributes <br>
...
public final class SchemaAttributes
    ...
    public static class Builder {
         ...
         * Cloud Service complex attributes (e.g. email => emails[work].value)
         *
         * <p>*SCIM++ Properties:** - multiValued: true - mutability: readOnly - required: false -
         * returned: default - type: complex
         */
         ...
         * operation before calling data provider update. Default is true.
         */
     ...
     * Service complex attributes (e.g. email => emails[work].value)
     *
     * <p>*SCIM++ Properties:** - multiValued: true - mutability: readOnly - required: false -
     * returned: default - type: complex
     */
    ...
    /**
     * Csv meta data for those resource type attributes which can be imported / exported from / to
     * csv.
     *
     * <p>*SCIM++ Properties:** - multiValued: true - mutability: readWrite - required: false -
     * returned: default - type: complex
     ...
     * mutability: readWrite - required: false - returned: default - type: string - uniqueness: none
     */
    public enum IdcsCanonicalValueType implements com.oracle.bmc.http.internal.BmcEnum {
        Dynamic("dynamic"),
        Static("static"),
    ...
    /** */
    public enum IdcsFeatures implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    /**
     * A subset of \\"canonicalValues\\" that are not supported when the \\"optionalPii\\" feature
     * is disabled in GlobalConfig.
     *
     * <p>*Deprecated Since: 19.1.6**
     *
     * <p>*SCIM++ Properties:** - caseExact: true - multiValued: true - mutability: readOnly -
    ...
    /**
     * Specifies whether the attribute from resource schema should override from common schema with
     * the same name.
     *
     * <p>*Added In:** 2102181953
     *
    ...
    /**
     * Set this attribute to True if the resource is eligibal for update while system is in readonly
     * mode.
     *
     * <p>*Added In:** 2106170416
     *
