...
public class SearchOAuth2ClientCredentialsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.identitydomains.model.OAuth2ClientCredentials
    ...
    private SearchOAuth2ClientCredentialsResponse(
            int __httpStatusCode__,
            javax.ws.rs.core.MultivaluedMap<String, String> headers,
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.identitydomains.model.OAuth2ClientCredentials oAuth2ClientCredentials) {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SearchOAuth2ClientCredentialsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            oAuth2ClientCredentials(o.getOAuth2ClientCredentials());
         ...
         */
        public SearchOAuth2ClientCredentialsResponse build() {
            return new SearchOAuth2ClientCredentialsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public String toString() {
        ...
        sb.append(",oAuth2ClientCredentials=").append(String.valueOf(oAuth2ClientCredentials));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchOAuth2ClientCredentialsResponse)) {
            return false;
        }

        SearchOAuth2ClientCredentialsResponse other = (SearchOAuth2ClientCredentialsResponse) o;
