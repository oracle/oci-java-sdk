...
public class PatchOAuth2ClientCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchOAuth2ClientCredentialResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(PatchOAuth2ClientCredentialResponse o) {
         ...
         */
        @Override
        public PatchOAuth2ClientCredentialResponse build() {
            return new PatchOAuth2ClientCredentialResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchOAuth2ClientCredentialResponse)) {
            return false;
        }

        PatchOAuth2ClientCredentialResponse other = (PatchOAuth2ClientCredentialResponse) o;
