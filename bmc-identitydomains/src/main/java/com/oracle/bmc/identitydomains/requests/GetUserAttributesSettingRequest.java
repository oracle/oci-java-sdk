...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetUserAttributesSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetUserAttributesSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetUserAttributesSettingRequest
     ...
     * ID of the resource
     */
    public String getUserAttributesSettingId() {
        return userAttributesSettingId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetUserAttributesSettingRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String userAttributesSettingId = null;

        /**
         * ID of the resource
         * @param userAttributesSettingId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetUserAttributesSettingRequest o) {
            userAttributesSettingId(o.getUserAttributesSettingId());
         ...
         *
         * @return instance of GetUserAttributesSettingRequest
         */
        public GetUserAttributesSettingRequest build() {
            GetUserAttributesSettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetUserAttributesSettingRequest
         */
        public GetUserAttributesSettingRequest buildWithoutInvocationCallback() {
            GetUserAttributesSettingRequest request = new GetUserAttributesSettingRequest();
            ...
            return request;
            // new GetUserAttributesSettingRequest(userAttributesSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",userAttributesSettingId=").append(String.valueOf(this.userAttributesSettingId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserAttributesSettingRequest)) {
            return false;
        }

        GetUserAttributesSettingRequest other = (GetUserAttributesSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.userAttributesSettingId, other.userAttributesSettingId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userAttributesSettingId == null
                                ? 43
                                : this.userAttributesSettingId.hashCode());
        result =
                (result * PRIME)
