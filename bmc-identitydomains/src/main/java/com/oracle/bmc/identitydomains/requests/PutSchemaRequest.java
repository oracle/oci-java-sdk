...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutSchemaExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutSchemaRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutSchemaRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.Schema> {
    ...
    public com.oracle.bmc.identitydomains.model.Schema getBody$() {
        return schema;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutSchemaRequest, com.oracle.bmc.identitydomains.model.Schema> {
        ...
        /**
         * ID of the resource
         * @param schemaId the value to set
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.Schema schema = null;
         ...
         * @return this builder instance
         */
        public Builder copy(PutSchemaRequest o) {
         ...
         *
         * @return instance of PutSchemaRequest
         */
        public PutSchemaRequest build() {
            PutSchemaRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.Schema body) {
            schema(body);
            return this;
        }
        ...
        public PutSchemaRequest buildWithoutInvocationCallback() {
            PutSchemaRequest request = new PutSchemaRequest();
            ...
            return request;
            // new PutSchemaRequest(schemaId, authorization, resourceTypeSchemaVersion, schema, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSchemaRequest)) {
            return false;
        }

        PutSchemaRequest other = (PutSchemaRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.schemaId, other.schemaId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.schemaId == null ? 43 : this.schemaId.hashCode());
        result =
                (result * PRIME)
