...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListAuthTokensExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAuthTokensRequest.
 */
...
public class ListAuthTokensRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListAuthTokensRequest
         */
        public ListAuthTokensRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListAuthTokensRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAuthTokensRequest)) {
            return false;
        }

        ListAuthTokensRequest other = (ListAuthTokensRequest) o;
