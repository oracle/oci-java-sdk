 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAuthTokensRequest.
 */
...
public class ListAuthTokensRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAuthTokensRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListAuthTokensRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
