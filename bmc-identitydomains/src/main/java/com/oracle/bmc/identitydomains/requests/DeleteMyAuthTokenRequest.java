...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteMyAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMyAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteMyAuthTokenRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMyAuthTokenRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMyAuthTokenRequest o) {
        ...
        /**
         * Build the instance of DeleteMyAuthTokenRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMyAuthTokenRequest
         */
        public DeleteMyAuthTokenRequest build() {
            DeleteMyAuthTokenRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMyAuthTokenRequest
         */
        public DeleteMyAuthTokenRequest buildWithoutInvocationCallback() {
            DeleteMyAuthTokenRequest request = new DeleteMyAuthTokenRequest();
            ...
            return request;
            // new DeleteMyAuthTokenRequest(myAuthTokenId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMyAuthTokenRequest)) {
            return false;
        }

        DeleteMyAuthTokenRequest other = (DeleteMyAuthTokenRequest) o;
