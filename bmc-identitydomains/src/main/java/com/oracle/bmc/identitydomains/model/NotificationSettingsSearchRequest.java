...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = NotificationSettingsSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class NotificationSettingsSearchRequest
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"schemas", "attributes", "attributeSets"})
    public NotificationSettingsSearchRequest(
    ...
    public static class Builder {
        ...
        public NotificationSettingsSearchRequest build() {
            NotificationSettingsSearchRequest model =
                    new NotificationSettingsSearchRequest(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotificationSettingsSearchRequest model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NotificationSettingsSearchRequest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotificationSettingsSearchRequest)) {
            return false;
        }

        NotificationSettingsSearchRequest other = (NotificationSettingsSearchRequest) o;
