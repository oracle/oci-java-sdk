...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MeRoles.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MeRoles extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "display", "type", "primary"})
    public MeRoles(String value, String display, String type, Boolean primary) {
        super();
        this.value = value;
    ...
    public static class Builder {
        ...
        public MeRoles build() {
            MeRoles model = new MeRoles(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MeRoles model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeRoles)) {
            return false;
        }

        MeRoles other = (MeRoles) o;
