...
/**
 * List of password policy rules that have values set. This map of stringKey:stringValue pairs can
 * be used to aid users while setting/resetting password <br>
