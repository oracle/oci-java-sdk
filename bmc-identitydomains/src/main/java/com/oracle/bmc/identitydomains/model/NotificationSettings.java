...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = NotificationSettings.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class NotificationSettings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public NotificationSettings(
            ...
            java.util.List<NotificationSetting> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<NotificationSetting> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<NotificationSetting> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NotificationSettings model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<NotificationSetting> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<NotificationSetting> getResources() {
        return resources;
    }
