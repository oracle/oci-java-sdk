...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchOAuth2ClientCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchOAuth2ClientCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchOAuth2ClientCredentialRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchOAuth2ClientCredentialRequest o) {
        ...
        /**
         * Build the instance of PatchOAuth2ClientCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchOAuth2ClientCredentialRequest
         */
        public PatchOAuth2ClientCredentialRequest build() {
            PatchOAuth2ClientCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchOAuth2ClientCredentialRequest
         */
        public PatchOAuth2ClientCredentialRequest buildWithoutInvocationCallback() {
            PatchOAuth2ClientCredentialRequest request = new PatchOAuth2ClientCredentialRequest();
            ...
            return request;
            // new PatchOAuth2ClientCredentialRequest(oAuth2ClientCredentialId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchOAuth2ClientCredentialRequest)) {
            return false;
        }

        PatchOAuth2ClientCredentialRequest other = (PatchOAuth2ClientCredentialRequest) o;
