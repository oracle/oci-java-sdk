 ...
 *
 * <p>*SCIM++ Properties:** - idcsCsvAttributeNameMappings: [[columnHeaderName:Manager,
 * deprecatedColumnHeaderName:Manager Name, mapsTo:manager.value]] - idcsPii: true - multiValued:
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserExtManager.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UserExtManager
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "displayName"})
    public UserExtManager(String value, String ref, String displayName) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - idcsCsvAttributeName: Manager Name - idcsSearchable: true -
        ...
        public UserExtManager build() {
            UserExtManager model = new UserExtManager(this.value, this.ref, this.displayName);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserExtManager model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserExtManager)) {
            return false;
        }

        UserExtManager other = (UserExtManager) o;
