 ...
 *
 * <p>*SCIM++ Properties:** - idcsCompositeKey: [value] - idcsSearchable: false - multiValued: true
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = IdentityProviderJitProvAssignedGroups.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class IdentityProviderJitProvAssignedGroups
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public IdentityProviderJitProvAssignedGroups(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public IdentityProviderJitProvAssignedGroups build() {
            IdentityProviderJitProvAssignedGroups model =
                    new IdentityProviderJitProvAssignedGroups(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityProviderJitProvAssignedGroups model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("IdentityProviderJitProvAssignedGroups(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityProviderJitProvAssignedGroups)) {
            return false;
        }

        IdentityProviderJitProvAssignedGroups other = (IdentityProviderJitProvAssignedGroups) o;
