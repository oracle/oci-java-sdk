...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchAccountRecoverySettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchAccountRecoverySettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchAccountRecoverySettingRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchAccountRecoverySettingRequest o) {
        ...
        /**
         * Build the instance of PatchAccountRecoverySettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchAccountRecoverySettingRequest
         */
        public PatchAccountRecoverySettingRequest build() {
            PatchAccountRecoverySettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchAccountRecoverySettingRequest
         */
        public PatchAccountRecoverySettingRequest buildWithoutInvocationCallback() {
            PatchAccountRecoverySettingRequest request = new PatchAccountRecoverySettingRequest();
            ...
            return request;
            // new PatchAccountRecoverySettingRequest(accountRecoverySettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAccountRecoverySettingRequest)) {
            return false;
        }

        PatchAccountRecoverySettingRequest other = (PatchAccountRecoverySettingRequest) o;
