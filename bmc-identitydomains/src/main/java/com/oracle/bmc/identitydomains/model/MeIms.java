...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MeIms.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class MeIms extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "display", "type", "primary"})
    public MeIms(String value, String display, Type type, Boolean primary) {
        super();
        this.value = value;
    ...
    public static class Builder {
        ...
        public MeIms build() {
            MeIms model = new MeIms(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MeIms model) {
