...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyTrustedUserAgents.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyTrustedUserAgents extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyTrustedUserAgents(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyTrustedUserAgent> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyTrustedUserAgent> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyTrustedUserAgent> resources) {
            this.resources = resources;
        ...
        public MyTrustedUserAgents build() {
            MyTrustedUserAgents model =
                    new MyTrustedUserAgents(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyTrustedUserAgents model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyTrustedUserAgent> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyTrustedUserAgent> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyTrustedUserAgents)) {
            return false;
        }

        MyTrustedUserAgents other = (MyTrustedUserAgents) o;
