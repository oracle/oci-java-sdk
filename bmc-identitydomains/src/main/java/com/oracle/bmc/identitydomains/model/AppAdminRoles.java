 ...
 * administrative privilege within this App. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AppAdminRoles.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AppAdminRoles extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display", "description"})
    public AppAdminRoles(String value, String ref, String display, String description) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public AppAdminRoles build() {
            AppAdminRoles model =
                    new AppAdminRoles(this.value, this.ref, this.display, this.description);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppAdminRoles model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppAdminRoles)) {
            return false;
        }

        AppAdminRoles other = (AppAdminRoles) o;
