...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UserDbCredentials.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserDbCredentials extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public UserDbCredentials(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<UserDbCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<UserDbCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<UserDbCredential> resources) {
            this.resources = resources;
        ...
        public UserDbCredentials build() {
            UserDbCredentials model =
                    new UserDbCredentials(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserDbCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<UserDbCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<UserDbCredential> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserDbCredentials)) {
            return false;
        }

        UserDbCredentials other = (UserDbCredentials) o;
