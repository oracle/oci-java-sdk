...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = GroupSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class GroupSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GroupSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GroupSearchRequest)) {
            return false;
        }

        GroupSearchRequest other = (GroupSearchRequest) o;
