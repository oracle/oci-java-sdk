...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMyCustomerSecretKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMyCustomerSecretKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchMyCustomerSecretKeyRequest
     ...
     * ID of the resource
     */
    public String getMyCustomerSecretKeyId() {
        return myCustomerSecretKeyId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchMyCustomerSecretKeyRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * ID of the resource
         */
        private String myCustomerSecretKeyId = null;

        /**
         * ID of the resource
         * @param myCustomerSecretKeyId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchMyCustomerSecretKeyRequest o) {
            myCustomerSecretKeyId(o.getMyCustomerSecretKeyId());
         ...
         *
         * @return instance of PatchMyCustomerSecretKeyRequest
         */
        public PatchMyCustomerSecretKeyRequest build() {
            PatchMyCustomerSecretKeyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchMyCustomerSecretKeyRequest
         */
        public PatchMyCustomerSecretKeyRequest buildWithoutInvocationCallback() {
            PatchMyCustomerSecretKeyRequest request = new PatchMyCustomerSecretKeyRequest();
            request.myCustomerSecretKeyId = myCustomerSecretKeyId;
            ...
            return request;
            // new PatchMyCustomerSecretKeyRequest(myCustomerSecretKeyId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myCustomerSecretKeyId=").append(String.valueOf(this.myCustomerSecretKeyId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyCustomerSecretKeyRequest)) {
            return false;
        }

        PatchMyCustomerSecretKeyRequest other = (PatchMyCustomerSecretKeyRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.myCustomerSecretKeyId, other.myCustomerSecretKeyId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myCustomerSecretKeyId == null
                                ? 43
                                : this.myCustomerSecretKeyId.hashCode());
        result =
                (result * PRIME)
