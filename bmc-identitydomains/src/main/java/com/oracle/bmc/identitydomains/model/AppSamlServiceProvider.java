 ...
 * end user in to this App automatically. Note that this will be used only if the loginMechanism is
 * 'SAML'.
 *
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AppSamlServiceProvider.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AppSamlServiceProvider
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref"})
    public AppSamlServiceProvider(String value, String ref) {
        super();
        this.value = value;
        this.ref = ref;
    }
    ...
    public static class Builder {
        ...
        public AppSamlServiceProvider build() {
            AppSamlServiceProvider model = new AppSamlServiceProvider(this.value, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppSamlServiceProvider model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AppSamlServiceProvider(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppSamlServiceProvider)) {
            return false;
        }

        AppSamlServiceProvider other = (AppSamlServiceProvider) o;
