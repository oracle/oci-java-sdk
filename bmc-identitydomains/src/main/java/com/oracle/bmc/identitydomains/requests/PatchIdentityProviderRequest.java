...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchIdentityProviderRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchIdentityProviderRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchIdentityProviderRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchIdentityProviderRequest o) {
        ...
        /**
         * Build the instance of PatchIdentityProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchIdentityProviderRequest
         */
        public PatchIdentityProviderRequest build() {
            PatchIdentityProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchIdentityProviderRequest
         */
        public PatchIdentityProviderRequest buildWithoutInvocationCallback() {
            PatchIdentityProviderRequest request = new PatchIdentityProviderRequest();
            ...
            return request;
            // new PatchIdentityProviderRequest(identityProviderId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchIdentityProviderRequest)) {
            return false;
        }

        PatchIdentityProviderRequest other = (PatchIdentityProviderRequest) o;
