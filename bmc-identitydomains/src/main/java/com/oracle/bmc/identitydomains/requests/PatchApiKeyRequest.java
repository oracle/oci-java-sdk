...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchApiKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchApiKeyRequest.
 */
...
public class PatchApiKeyRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchApiKeyRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchApiKeyRequest o) {
         ...
         *
         * @return instance of PatchApiKeyRequest
         */
        public PatchApiKeyRequest build() {
            PatchApiKeyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchApiKeyRequest
         */
        public PatchApiKeyRequest buildWithoutInvocationCallback() {
            PatchApiKeyRequest request = new PatchApiKeyRequest();
            ...
            return request;
            // new PatchApiKeyRequest(apiKeyId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchApiKeyRequest)) {
            return false;
        }

        PatchApiKeyRequest other = (PatchApiKeyRequest) o;
