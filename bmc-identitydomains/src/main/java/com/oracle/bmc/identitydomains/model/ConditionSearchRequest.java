...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ConditionSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ConditionSearchRequest
    ...
    public static class Builder {
        ...
        public ConditionSearchRequest build() {
            ConditionSearchRequest model =
                    new ConditionSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ConditionSearchRequest model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ConditionSearchRequest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConditionSearchRequest)) {
            return false;
        }

        ConditionSearchRequest other = (ConditionSearchRequest) o;
