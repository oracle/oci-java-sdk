...
public class ListMyOAuth2ClientCredentialsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.identitydomains.model.MyOAuth2ClientCredentials
            getMyOAuth2ClientCredentials() {
        return myOAuth2ClientCredentials;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder myOAuth2ClientCredentials(
                com.oracle.bmc.identitydomains.model.MyOAuth2ClientCredentials
                        myOAuth2ClientCredentials) {
            this.myOAuth2ClientCredentials = myOAuth2ClientCredentials;
            return this;
        ...
        public Builder copy(ListMyOAuth2ClientCredentialsResponse o) {
            ...
            myOAuth2ClientCredentials(o.getMyOAuth2ClientCredentials());
    ...
    public String toString() {
        ...
        sb.append(",myOAuth2ClientCredentials=").append(String.valueOf(myOAuth2ClientCredentials));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyOAuth2ClientCredentialsResponse)) {
            return false;
        }

        ListMyOAuth2ClientCredentialsResponse other = (ListMyOAuth2ClientCredentialsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.myOAuth2ClientCredentials, other.myOAuth2ClientCredentials);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myOAuth2ClientCredentials == null
                                ? 43
                                : this.myOAuth2ClientCredentials.hashCode());
        return result;
    }
}
