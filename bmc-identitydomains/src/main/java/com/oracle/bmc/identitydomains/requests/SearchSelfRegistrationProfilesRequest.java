...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/SearchSelfRegistrationProfilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchSelfRegistrationProfilesRequest.
 */
...
public class SearchSelfRegistrationProfilesRequest
    ...
    public com.oracle.bmc.identitydomains.model.SelfRegistrationProfileSearchRequest getBody$() {
        return selfRegistrationProfileSearchRequest;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder selfRegistrationProfileSearchRequest(
                com.oracle.bmc.identitydomains.model.SelfRegistrationProfileSearchRequest
                        selfRegistrationProfileSearchRequest) {
            this.selfRegistrationProfileSearchRequest = selfRegistrationProfileSearchRequest;
            return this;
        }
        ...
        public Builder copy(SearchSelfRegistrationProfilesRequest o) {
            ...
            selfRegistrationProfileSearchRequest(o.getSelfRegistrationProfileSearchRequest());
         ...
         */
        public SearchSelfRegistrationProfilesRequest build() {
            SearchSelfRegistrationProfilesRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.identitydomains.model.SelfRegistrationProfileSearchRequest body) {
            selfRegistrationProfileSearchRequest(body);
            return this;
        }
         ...
         * @return instance of SearchSelfRegistrationProfilesRequest
         */
        public SearchSelfRegistrationProfilesRequest buildWithoutInvocationCallback() {
            SearchSelfRegistrationProfilesRequest request =
                    new SearchSelfRegistrationProfilesRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.selfRegistrationProfileSearchRequest = selfRegistrationProfileSearchRequest;
    ...
    public String toString() {
        ...
        sb.append(",selfRegistrationProfileSearchRequest=")
                .append(String.valueOf(this.selfRegistrationProfileSearchRequest));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchSelfRegistrationProfilesRequest)) {
            return false;
        }

        SearchSelfRegistrationProfilesRequest other = (SearchSelfRegistrationProfilesRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.selfRegistrationProfileSearchRequest,
                        other.selfRegistrationProfileSearchRequest)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.selfRegistrationProfileSearchRequest == null
                                ? 43
                                : this.selfRegistrationProfileSearchRequest.hashCode());
        result =
                (result * PRIME)
