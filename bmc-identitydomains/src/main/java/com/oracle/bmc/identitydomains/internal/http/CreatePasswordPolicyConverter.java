...
public class CreatePasswordPolicyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreatePasswordPolicyConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreatePasswordPolicyRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.CreatePasswordPolicyRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("PasswordPolicies");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreatePasswordPolicyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .CreatePasswordPolicyResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .CreatePasswordPolicyResponse.builder()
