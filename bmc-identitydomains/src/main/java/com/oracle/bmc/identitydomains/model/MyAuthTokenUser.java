...
public final class MyAuthTokenUser
    ...
    public static class Builder {
        ...
        public MyAuthTokenUser build() {
            MyAuthTokenUser model =
                    new MyAuthTokenUser(this.value, this.ocid, this.ref, this.display, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyAuthTokenUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyAuthTokenUser)) {
            return false;
        }

        MyAuthTokenUser other = (MyAuthTokenUser) o;
