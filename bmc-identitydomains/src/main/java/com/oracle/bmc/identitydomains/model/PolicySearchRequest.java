...
public final class PolicySearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public PolicySearchRequest build() {
            PolicySearchRequest model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PolicySearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PolicySearchRequest)) {
            return false;
        }

        PolicySearchRequest other = (PolicySearchRequest) o;
