...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateApprovalWorkflowAssignmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateApprovalWorkflowAssignmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateApprovalWorkflowAssignmentRequest
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment
            getApprovalWorkflowAssignment() {
        return approvalWorkflowAssignment;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment getBody$() {
        return approvalWorkflowAssignment;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment
                approvalWorkflowAssignment = null;
         ...
         *   - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param approvalWorkflowAssignment the value to set
         * @return this builder instance
         */
        public Builder approvalWorkflowAssignment(
                com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment
                        approvalWorkflowAssignment) {
            this.approvalWorkflowAssignment = approvalWorkflowAssignment;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(CreateApprovalWorkflowAssignmentRequest o) {
            ...
            approvalWorkflowAssignment(o.getApprovalWorkflowAssignment());
        ...
        /**
         * Build the instance of CreateApprovalWorkflowAssignmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateApprovalWorkflowAssignmentRequest
         */
        public CreateApprovalWorkflowAssignmentRequest build() {
            CreateApprovalWorkflowAssignmentRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.ApprovalWorkflowAssignment body) {
            approvalWorkflowAssignment(body);
            return this;
        }
         ...
         * @return instance of CreateApprovalWorkflowAssignmentRequest
         */
        public CreateApprovalWorkflowAssignmentRequest buildWithoutInvocationCallback() {
            CreateApprovalWorkflowAssignmentRequest request =
                    new CreateApprovalWorkflowAssignmentRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.approvalWorkflowAssignment = approvalWorkflowAssignment;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateApprovalWorkflowAssignmentRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, approvalWorkflowAssignment, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",approvalWorkflowAssignment=")
                .append(String.valueOf(this.approvalWorkflowAssignment));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApprovalWorkflowAssignmentRequest)) {
            return false;
        }

        CreateApprovalWorkflowAssignmentRequest other = (CreateApprovalWorkflowAssignmentRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.approvalWorkflowAssignment, other.approvalWorkflowAssignment)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.approvalWorkflowAssignment == null
                                ? 43
                                : this.approvalWorkflowAssignment.hashCode());
        result =
                (result * PRIME)
