...
public class PatchMeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchMeResponse> {
         ...
         */
        @Override
        public Builder copy(PatchMeResponse o) {
         ...
         */
        @Override
        public PatchMeResponse build() {
            return new PatchMeResponse(__httpStatusCode__, headers, opcRequestId, etag, me);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMeResponse)) {
            return false;
        }

        PatchMeResponse other = (PatchMeResponse) o;
