...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListIdentityProvidersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListIdentityProvidersRequest.
 */
...
public class ListIdentityProvidersRequest
    ...
    public static class Builder
         ...
         * @return instance of ListIdentityProvidersRequest
         */
        public ListIdentityProvidersRequest buildWithoutInvocationCallback() {
            ListIdentityProvidersRequest request = new ListIdentityProvidersRequest();
            ...
            request.limit = limit;
            return request;
            // new ListIdentityProvidersRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIdentityProvidersRequest)) {
            return false;
        }

        ListIdentityProvidersRequest other = (ListIdentityProvidersRequest) o;
