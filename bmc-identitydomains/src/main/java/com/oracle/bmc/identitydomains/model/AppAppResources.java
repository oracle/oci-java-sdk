...
public final class AppAppResources
    ...
    public static class Builder {
        ...
        public AppAppResources build() {
            AppAppResources model = new AppAppResources(this.value, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppAppResources model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppAppResources)) {
            return false;
        }

        AppAppResources other = (AppAppResources) o;
