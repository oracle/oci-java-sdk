...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Conditions.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Conditions extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Conditions(
            ...
            java.util.List<Condition> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<Condition> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Condition> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Conditions model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Condition> resources;
     ...
     * @return the value
     */
    public java.util.List<Condition> getResources() {
        return resources;
    }
