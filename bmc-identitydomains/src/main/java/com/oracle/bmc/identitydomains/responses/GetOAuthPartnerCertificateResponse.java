...
public class GetOAuthPartnerCertificateResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetOAuthPartnerCertificateResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetOAuthPartnerCertificateResponse o) {
         ...
         */
        public GetOAuthPartnerCertificateResponse build() {
            return new GetOAuthPartnerCertificateResponse(
                    __httpStatusCode__, headers, opcRequestId, oAuthPartnerCertificate);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOAuthPartnerCertificateResponse)) {
            return false;
        }

        GetOAuthPartnerCertificateResponse other = (GetOAuthPartnerCertificateResponse) o;
