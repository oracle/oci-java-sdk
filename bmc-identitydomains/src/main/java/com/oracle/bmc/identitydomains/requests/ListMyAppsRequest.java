...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyAppsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyAppsRequest.
 */
...
public class ListMyAppsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMyAppsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListMyAppsRequest(filter, sortBy, sortOrder, startIndex, count, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
