...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchSecurityQuestionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSecurityQuestionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchSecurityQuestionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchSecurityQuestionRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
        ...
        /**
         * ID of the resource
         * @param securityQuestionId the value to set
         * @return this builder instance
         */
        public Builder securityQuestionId(String securityQuestionId) {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchSecurityQuestionRequest o) {
            securityQuestionId(o.getSecurityQuestionId());
        ...
        /**
         * Build the instance of PatchSecurityQuestionRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchSecurityQuestionRequest
         */
        public PatchSecurityQuestionRequest build() {
            PatchSecurityQuestionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchSecurityQuestionRequest
         */
        public PatchSecurityQuestionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchSecurityQuestionRequest(securityQuestionId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",securityQuestionId=").append(String.valueOf(this.securityQuestionId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchSecurityQuestionRequest)) {
            return false;
        }

        PatchSecurityQuestionRequest other = (PatchSecurityQuestionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.securityQuestionId, other.securityQuestionId)
        ...
        result =
                (result * PRIME)
                        + (this.securityQuestionId == null
                                ? 43
                                : this.securityQuestionId.hashCode());
        result =
                (result * PRIME)
