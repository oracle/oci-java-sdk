...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CustomerSecretKeys.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CustomerSecretKeys extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public CustomerSecretKeys(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<CustomerSecretKey> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<CustomerSecretKey> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<CustomerSecretKey> resources) {
            this.resources = resources;
        ...
        public CustomerSecretKeys build() {
            CustomerSecretKeys model =
                    new CustomerSecretKeys(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CustomerSecretKeys model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<CustomerSecretKey> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<CustomerSecretKey> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomerSecretKeys)) {
            return false;
        }

        CustomerSecretKeys other = (CustomerSecretKeys) o;
