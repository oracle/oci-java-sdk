...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutSecurityQuestionSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutSecurityQuestionSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutSecurityQuestionSettingRequest
    ...
    public String getSecurityQuestionSettingId() {
        return securityQuestionSettingId;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.SecurityQuestionSetting getBody$() {
        return securityQuestionSetting;
    }
    ...
    public static class Builder
        ...
        /**
         * ID of the resource
         * @param securityQuestionSettingId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PutSecurityQuestionSettingRequest o) {
            securityQuestionSettingId(o.getSecurityQuestionSettingId());
        ...
        /**
         * Build the instance of PutSecurityQuestionSettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutSecurityQuestionSettingRequest
         */
        public PutSecurityQuestionSettingRequest build() {
            PutSecurityQuestionSettingRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.SecurityQuestionSetting body) {
            securityQuestionSetting(body);
            return this;
        }
        ...
        public PutSecurityQuestionSettingRequest buildWithoutInvocationCallback() {
            PutSecurityQuestionSettingRequest request = new PutSecurityQuestionSettingRequest();
            request.securityQuestionSettingId = securityQuestionSettingId;
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.securityQuestionSetting = securityQuestionSetting;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutSecurityQuestionSettingRequest(securityQuestionSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, securityQuestionSetting, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",securityQuestionSettingId=")
                .append(String.valueOf(this.securityQuestionSettingId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSecurityQuestionSettingRequest)) {
            return false;
        }

        PutSecurityQuestionSettingRequest other = (PutSecurityQuestionSettingRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.securityQuestionSettingId, other.securityQuestionSettingId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.securityQuestionSettingId == null
                                ? 43
                                : this.securityQuestionSettingId.hashCode());
        result =
                (result * PRIME)
