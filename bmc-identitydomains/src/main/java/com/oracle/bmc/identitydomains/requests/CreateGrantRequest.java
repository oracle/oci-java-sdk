...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateGrantExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateGrantRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateGrantRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.Grant> {
    ...
    public com.oracle.bmc.identitydomains.model.Grant getBody$() {
        return grant;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateGrantRequest, com.oracle.bmc.identitydomains.model.Grant> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.Grant grant = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateGrantRequest o) {
         ...
         *
         * @return instance of CreateGrantRequest
         */
        public CreateGrantRequest build() {
            CreateGrantRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.Grant body) {
            grant(body);
            return this;
        }
         ...
         * @return instance of CreateGrantRequest
         */
        public CreateGrantRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateGrantRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, grant, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",grant=").append(String.valueOf(this.grant));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGrantRequest)) {
            return false;
        }

        CreateGrantRequest other = (CreateGrantRequest) o;
