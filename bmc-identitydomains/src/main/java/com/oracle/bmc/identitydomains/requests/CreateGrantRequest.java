 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateGrantRequest.
 */
...
public class CreateGrantRequest
    ...
    public static class Builder
        ...
        public CreateGrantRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateGrantRequest(authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, grant, opcRetryToken);
        }
    }
