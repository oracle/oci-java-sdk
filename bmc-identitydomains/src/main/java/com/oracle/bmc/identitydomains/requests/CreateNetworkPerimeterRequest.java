...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateNetworkPerimeterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateNetworkPerimeterRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateNetworkPerimeterRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateNetworkPerimeterRequest o) {
        ...
        /**
         * Build the instance of CreateNetworkPerimeterRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateNetworkPerimeterRequest
         */
        public CreateNetworkPerimeterRequest build() {
            CreateNetworkPerimeterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreateNetworkPerimeterRequest
         */
        public CreateNetworkPerimeterRequest buildWithoutInvocationCallback() {
            CreateNetworkPerimeterRequest request = new CreateNetworkPerimeterRequest();
            ...
            return request;
            // new CreateNetworkPerimeterRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, networkPerimeter, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNetworkPerimeterRequest)) {
            return false;
        }

        CreateNetworkPerimeterRequest other = (CreateNetworkPerimeterRequest) o;
