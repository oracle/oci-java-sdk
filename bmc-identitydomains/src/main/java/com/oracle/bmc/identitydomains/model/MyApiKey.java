...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyApiKey.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyApiKey extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - type: string -
         * mutability: readOnly - required: true - returned: default
         */
         ...
         * <p>*Added In:** 2010242156
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsPii: true - type: string - mutability:
         * immutable - required: true - returned: default
         */
        ...
        private MyApiKeyUser user;

        public Builder user(MyApiKeyUser user) {
            this.user = user;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyApiKey model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final MyApiKeyUser user;

    public MyApiKeyUser getUser() {
        return user;
    }
