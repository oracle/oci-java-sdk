...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchGrantExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchGrantRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchGrantRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchGrantRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
        ...
        /**
         * ID of the resource
         * @param grantId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchGrantRequest o) {
            grantId(o.getGrantId());
        ...
        /**
         * Build the instance of PatchGrantRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchGrantRequest
         */
        public PatchGrantRequest build() {
            PatchGrantRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchGrantRequest
         */
        public PatchGrantRequest buildWithoutInvocationCallback() {
            PatchGrantRequest request = new PatchGrantRequest();
            ...
            return request;
            // new PatchGrantRequest(grantId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",grantId=").append(String.valueOf(this.grantId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchGrantRequest)) {
            return false;
        }

        PatchGrantRequest other = (PatchGrantRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.grantId, other.grantId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.grantId == null ? 43 : this.grantId.hashCode());
        result =
                (result * PRIME)
