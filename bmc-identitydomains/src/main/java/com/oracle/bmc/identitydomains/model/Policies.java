...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Policies.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Policies extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Policies(
            ...
            java.util.List<Policy> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<Policy> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Policy> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Policies model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Policy> resources;
     ...
     * @return the value
     */
    public java.util.List<Policy> getResources() {
        return resources;
    }
