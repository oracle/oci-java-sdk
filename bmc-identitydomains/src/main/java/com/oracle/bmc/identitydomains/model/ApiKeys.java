...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApiKeys.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ApiKeys extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public ApiKeys(
            ...
            java.util.List<ApiKey> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<ApiKey> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<ApiKey> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApiKeys model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<ApiKey> resources;
     ...
     * @return the value
     */
    public java.util.List<ApiKey> getResources() {
        return resources;
    }
