...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteOAuth2ClientCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteOAuth2ClientCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteOAuth2ClientCredentialRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteOAuth2ClientCredentialRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteOAuth2ClientCredentialRequest o) {
        ...
        /**
         * Build the instance of DeleteOAuth2ClientCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteOAuth2ClientCredentialRequest
         */
        public DeleteOAuth2ClientCredentialRequest build() {
            DeleteOAuth2ClientCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteOAuth2ClientCredentialRequest
         */
        public DeleteOAuth2ClientCredentialRequest buildWithoutInvocationCallback() {
            DeleteOAuth2ClientCredentialRequest request = new DeleteOAuth2ClientCredentialRequest();
            ...
            return request;
            // new DeleteOAuth2ClientCredentialRequest(oAuth2ClientCredentialId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOAuth2ClientCredentialRequest)) {
            return false;
        }

        DeleteOAuth2ClientCredentialRequest other = (DeleteOAuth2ClientCredentialRequest) o;
