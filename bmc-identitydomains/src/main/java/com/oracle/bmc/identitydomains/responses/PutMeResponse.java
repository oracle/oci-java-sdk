...
public class PutMeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutMeResponse> {
         ...
         */
        @Override
        public Builder copy(PutMeResponse o) {
         ...
         */
        @Override
        public PutMeResponse build() {
            return new PutMeResponse(__httpStatusCode__, headers, opcRequestId, etag, me);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutMeResponse)) {
            return false;
        }

        PutMeResponse other = (PutMeResponse) o;
