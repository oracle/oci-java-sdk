...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutIdentityProofingProviderTemplateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutIdentityProofingProviderTemplateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutIdentityProofingProviderTemplateRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate> {
     ...
     * ID of the resource.
     */
    public String getIdentityProofingProviderTemplateId() {
        return identityProofingProviderTemplateId;
    }
    /**
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate
            getIdentityProofingProviderTemplate() {
        return identityProofingProviderTemplate;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate getBody$() {
        return identityProofingProviderTemplate;
    }
    ...
    public static class Builder
         ...
         * ID of the resource.
         */
        private String identityProofingProviderTemplateId = null;

        /**
         * ID of the resource.
         * @param identityProofingProviderTemplateId the value to set
         * @return this builder instance
         */
        public Builder identityProofingProviderTemplateId(
         ...
         */
        private com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate
                identityProofingProviderTemplate = null;
         ...
         *   - The SCIM APIs to read a resource (or to search a resource-type) will ignore silently any request to return an attribute that is defined as *returned:never*.
         *
         * @param identityProofingProviderTemplate the value to set
         * @return this builder instance
         */
        public Builder identityProofingProviderTemplate(
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate
                        identityProofingProviderTemplate) {
            this.identityProofingProviderTemplate = identityProofingProviderTemplate;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(PutIdentityProofingProviderTemplateRequest o) {
            identityProofingProviderTemplateId(o.getIdentityProofingProviderTemplateId());
            ...
            identityProofingProviderTemplate(o.getIdentityProofingProviderTemplate());
        ...
        /**
         * Build the instance of PutIdentityProofingProviderTemplateRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutIdentityProofingProviderTemplateRequest
         */
        public PutIdentityProofingProviderTemplateRequest build() {
            PutIdentityProofingProviderTemplateRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.identitydomains.model.IdentityProofingProviderTemplate body) {
            identityProofingProviderTemplate(body);
            return this;
        }
         ...
         * @return instance of PutIdentityProofingProviderTemplateRequest
         */
        public PutIdentityProofingProviderTemplateRequest buildWithoutInvocationCallback() {
            PutIdentityProofingProviderTemplateRequest request =
                    new PutIdentityProofingProviderTemplateRequest();
            ...
            request.identityProofingProviderTemplate = identityProofingProviderTemplate;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutIdentityProofingProviderTemplateRequest(identityProofingProviderTemplateId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, identityProofingProviderTemplate, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",identityProofingProviderTemplateId=")
                .append(String.valueOf(this.identityProofingProviderTemplateId));
        ...
        sb.append(",identityProofingProviderTemplate=")
                .append(String.valueOf(this.identityProofingProviderTemplate));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutIdentityProofingProviderTemplateRequest)) {
            return false;
        }

        PutIdentityProofingProviderTemplateRequest other =
                (PutIdentityProofingProviderTemplateRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.identityProofingProviderTemplateId,
                        other.identityProofingProviderTemplateId)
                ...
                && java.util.Objects.equals(
                        this.identityProofingProviderTemplate,
                        other.identityProofingProviderTemplate)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.identityProofingProviderTemplateId == null
                                ? 43
                                : this.identityProofingProviderTemplateId.hashCode());
        result =
                (result * PRIME)
        ...
        result =
                (result * PRIME)
                        + (this.identityProofingProviderTemplate == null
                                ? 43
                                : this.identityProofingProviderTemplate.hashCode());
