...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMyAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMyAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchMyAuthTokenRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchMyAuthTokenRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchMyAuthTokenRequest o) {
            myAuthTokenId(o.getMyAuthTokenId());
        ...
        /**
         * Build the instance of PatchMyAuthTokenRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchMyAuthTokenRequest
         */
        public PatchMyAuthTokenRequest build() {
            PatchMyAuthTokenRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchMyAuthTokenRequest
         */
        public PatchMyAuthTokenRequest buildWithoutInvocationCallback() {
            PatchMyAuthTokenRequest request = new PatchMyAuthTokenRequest();
            ...
            return request;
            // new PatchMyAuthTokenRequest(myAuthTokenId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMyAuthTokenRequest)) {
            return false;
        }

        PatchMyAuthTokenRequest other = (PatchMyAuthTokenRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.myAuthTokenId, other.myAuthTokenId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myAuthTokenId == null ? 43 : this.myAuthTokenId.hashCode());
        result =
                (result * PRIME)
