...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutIdentityPropagationTrustExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutIdentityPropagationTrustRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutIdentityPropagationTrustRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PutIdentityPropagationTrustRequest o) {
        ...
        /**
         * Build the instance of PutIdentityPropagationTrustRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutIdentityPropagationTrustRequest
         */
        public PutIdentityPropagationTrustRequest build() {
            PutIdentityPropagationTrustRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutIdentityPropagationTrustRequest
         */
        public PutIdentityPropagationTrustRequest buildWithoutInvocationCallback() {
            PutIdentityPropagationTrustRequest request = new PutIdentityPropagationTrustRequest();
            ...
            return request;
            // new PutIdentityPropagationTrustRequest(identityPropagationTrustId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, identityPropagationTrust, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutIdentityPropagationTrustRequest)) {
            return false;
        }

        PutIdentityPropagationTrustRequest other = (PutIdentityPropagationTrustRequest) o;
