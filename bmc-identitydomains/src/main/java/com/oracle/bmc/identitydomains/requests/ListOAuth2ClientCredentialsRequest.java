...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListOAuth2ClientCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOAuth2ClientCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListOAuth2ClientCredentialsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOAuth2ClientCredentialsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOAuth2ClientCredentialsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListOAuth2ClientCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOAuth2ClientCredentialsRequest
         */
        public ListOAuth2ClientCredentialsRequest build() {
            ListOAuth2ClientCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOAuth2ClientCredentialsRequest
         */
        public ListOAuth2ClientCredentialsRequest buildWithoutInvocationCallback() {
            ListOAuth2ClientCredentialsRequest request = new ListOAuth2ClientCredentialsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListOAuth2ClientCredentialsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOAuth2ClientCredentialsRequest)) {
            return false;
        }

        ListOAuth2ClientCredentialsRequest other = (ListOAuth2ClientCredentialsRequest) o;
