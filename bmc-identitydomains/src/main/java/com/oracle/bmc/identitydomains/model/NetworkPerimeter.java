...
/**
 * NetworkPerimeter resource. A unit that captures a NetworkPerimeter as a collection of IP
 * Addresses. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = NetworkPerimeter.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class NetworkPerimeter
    ...
    public NetworkPerimeter(
            ...
            String name,
            String description,
            java.util.List<NetworkPerimeterIpAddresses> ipAddresses) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
        ...
        private java.util.List<NetworkPerimeterIpAddresses> ipAddresses;
         ...
         * @return this builder
         */
        public Builder ipAddresses(java.util.List<NetworkPerimeterIpAddresses> ipAddresses) {
            this.ipAddresses = ipAddresses;
        ...
        public NetworkPerimeter build() {
            NetworkPerimeter model =
                    new NetworkPerimeter(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkPerimeter model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("ipAddresses")
    private final java.util.List<NetworkPerimeterIpAddresses> ipAddresses;
     ...
     * @return the value
     */
    public java.util.List<NetworkPerimeterIpAddresses> getIpAddresses() {
        return ipAddresses;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkPerimeter)) {
            return false;
        }

        NetworkPerimeter other = (NetworkPerimeter) o;
