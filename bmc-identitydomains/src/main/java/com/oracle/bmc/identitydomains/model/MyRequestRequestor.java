...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MyRequestRequestor.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyRequestRequestor
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public MyRequestRequestor(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
         ...
         * User identifier
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsCsvAttributeName: requestor_id -
        ...
        public MyRequestRequestor build() {
            MyRequestRequestor model = new MyRequestRequestor(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyRequestRequestor model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyRequestRequestor)) {
            return false;
        }

        MyRequestRequestor other = (MyRequestRequestor) o;
