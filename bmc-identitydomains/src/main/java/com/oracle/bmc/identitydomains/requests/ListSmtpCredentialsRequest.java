...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListSmtpCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSmtpCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListSmtpCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListSmtpCredentialsRequest, java.lang.Void> {
         ...
         * @return instance of ListSmtpCredentialsRequest
         */
        public ListSmtpCredentialsRequest buildWithoutInvocationCallback() {
            ListSmtpCredentialsRequest request = new ListSmtpCredentialsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListSmtpCredentialsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSmtpCredentialsRequest)) {
            return false;
        }

        ListSmtpCredentialsRequest other = (ListSmtpCredentialsRequest) o;
