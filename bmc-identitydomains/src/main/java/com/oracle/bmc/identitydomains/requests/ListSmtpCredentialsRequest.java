 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSmtpCredentialsRequest.
 */
...
public class ListSmtpCredentialsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListSmtpCredentialsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListSmtpCredentialsRequest(filter, sortBy, sortOrder, startIndex, count,
