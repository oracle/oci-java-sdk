...
public class PutSocialIdentityProviderResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(PutSocialIdentityProviderResponse o) {
         ...
         */
        @Override
        public PutSocialIdentityProviderResponse build() {
            return new PutSocialIdentityProviderResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSocialIdentityProviderResponse)) {
            return false;
        }

        PutSocialIdentityProviderResponse other = (PutSocialIdentityProviderResponse) o;
