 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchAuthTokensRequest.
 */
...
public class SearchAuthTokensRequest
    ...
    public static class Builder
        ...
        public SearchAuthTokensRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchAuthTokensRequest(authorization, resourceTypeSchemaVersion,
            // authTokenSearchRequest, opcRetryToken, page, limit);
        }
    }
