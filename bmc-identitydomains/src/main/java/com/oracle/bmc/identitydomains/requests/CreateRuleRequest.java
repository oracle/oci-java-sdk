...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateRuleRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.Rule> {
    ...
    public com.oracle.bmc.identitydomains.model.Rule getBody$() {
        return rule;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateRuleRequest, com.oracle.bmc.identitydomains.model.Rule> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.Rule rule = null;
         ...
         *
         * @return instance of CreateRuleRequest
         */
        public CreateRuleRequest build() {
            CreateRuleRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.Rule body) {
            rule(body);
            return this;
        }
        ...
        public CreateRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateRuleRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, rule, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRuleRequest)) {
            return false;
        }

        CreateRuleRequest other = (CreateRuleRequest) o;
