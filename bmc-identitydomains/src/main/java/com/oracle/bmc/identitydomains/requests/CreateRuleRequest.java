 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateRuleRequest.
 */
...
public class CreateRuleRequest
    ...
    public static class Builder
        ...
        public CreateRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateRuleRequest(authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, rule, opcRetryToken);
        }
    }
