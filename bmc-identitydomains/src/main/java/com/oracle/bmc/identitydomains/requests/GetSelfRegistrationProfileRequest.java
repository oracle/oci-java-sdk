...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetSelfRegistrationProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSelfRegistrationProfileRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetSelfRegistrationProfileRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetSelfRegistrationProfileRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetSelfRegistrationProfileRequest o) {
        ...
        /**
         * Build the instance of GetSelfRegistrationProfileRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetSelfRegistrationProfileRequest
         */
        public GetSelfRegistrationProfileRequest build() {
            GetSelfRegistrationProfileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetSelfRegistrationProfileRequest
         */
        public GetSelfRegistrationProfileRequest buildWithoutInvocationCallback() {
            GetSelfRegistrationProfileRequest request = new GetSelfRegistrationProfileRequest();
            ...
            return request;
            // new GetSelfRegistrationProfileRequest(selfRegistrationProfileId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSelfRegistrationProfileRequest)) {
            return false;
        }

        GetSelfRegistrationProfileRequest other = (GetSelfRegistrationProfileRequest) o;
