...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteCustomerSecretKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteCustomerSecretKeyRequest.
 */
...
public class DeleteCustomerSecretKeyRequest
    ...
    public static class Builder
        ...
        public DeleteCustomerSecretKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteCustomerSecretKeyRequest(customerSecretKeyId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
