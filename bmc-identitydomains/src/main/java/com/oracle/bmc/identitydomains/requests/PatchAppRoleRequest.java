...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchAppRoleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchAppRoleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchAppRoleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchAppRoleRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchAppRoleRequest o) {
         ...
         *
         * @return instance of PatchAppRoleRequest
         */
        public PatchAppRoleRequest build() {
            PatchAppRoleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchAppRoleRequest
         */
        public PatchAppRoleRequest buildWithoutInvocationCallback() {
            PatchAppRoleRequest request = new PatchAppRoleRequest();
            ...
            return request;
            // new PatchAppRoleRequest(appRoleId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAppRoleRequest)) {
            return false;
        }

        PatchAppRoleRequest other = (PatchAppRoleRequest) o;
