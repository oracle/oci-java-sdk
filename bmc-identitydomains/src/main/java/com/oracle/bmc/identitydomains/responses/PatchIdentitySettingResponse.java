...
public class PatchIdentitySettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchIdentitySettingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchIdentitySettingResponse> {
         ...
         */
        @Override
        public Builder copy(PatchIdentitySettingResponse o) {
         ...
         */
        @Override
        public PatchIdentitySettingResponse build() {
            return new PatchIdentitySettingResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, identitySetting);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchIdentitySettingResponse)) {
            return false;
        }

        PatchIdentitySettingResponse other = (PatchIdentitySettingResponse) o;
