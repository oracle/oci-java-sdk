...
public class ListBrandingSettingsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListBrandingSettingsConverter.class);

    public static com.oracle.bmc.identitydomains.requests.ListBrandingSettingsRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.ListBrandingSettingsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("BrandingSettings");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.ListBrandingSettingsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .ListBrandingSettingsResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .ListBrandingSettingsResponse.builder()
                                ...
                                builder.brandingSettings(response.getItem());
