...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Grants.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Grants extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Grants(
            ...
            java.util.List<Grant> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<Grant> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Grant> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Grants model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Grant> resources;
     ...
     * @return the value
     */
    public java.util.List<Grant> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Grants)) {
            return false;
        }

        Grants other = (Grants) o;
