...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MySmtpCredential.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MySmtpCredential extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private MySmtpCredentialUser user;

        public Builder user(MySmtpCredentialUser user) {
            this.user = user;
        ...
        public MySmtpCredential build() {
            MySmtpCredential model =
                    new MySmtpCredential(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySmtpCredential model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final MySmtpCredentialUser user;

    public MySmtpCredentialUser getUser() {
        return user;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySmtpCredential)) {
            return false;
        }

        MySmtpCredential other = (MySmtpCredential) o;
