...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyCustomerSecretKey.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyCustomerSecretKey extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private MyCustomerSecretKeyUser user;

        public Builder user(MyCustomerSecretKeyUser user) {
            this.user = user;
        ...
        public MyCustomerSecretKey build() {
            MyCustomerSecretKey model =
                    new MyCustomerSecretKey(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyCustomerSecretKey model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final MyCustomerSecretKeyUser user;

    public MyCustomerSecretKeyUser getUser() {
        return user;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyCustomerSecretKey)) {
            return false;
        }

        MyCustomerSecretKey other = (MyCustomerSecretKey) o;
