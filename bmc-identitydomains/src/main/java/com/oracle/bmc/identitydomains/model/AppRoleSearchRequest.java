...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = AppRoleSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class AppRoleSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public AppRoleSearchRequest build() {
            AppRoleSearchRequest model =
                    new AppRoleSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppRoleSearchRequest model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AppRoleSearchRequest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppRoleSearchRequest)) {
            return false;
        }

        AppRoleSearchRequest other = (AppRoleSearchRequest) o;
