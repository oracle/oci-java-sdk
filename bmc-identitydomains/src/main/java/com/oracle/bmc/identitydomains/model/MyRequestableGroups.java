...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyRequestableGroups.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyRequestableGroups extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyRequestableGroups(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyRequestableGroup> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyRequestableGroup> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyRequestableGroup> resources) {
            this.resources = resources;
        ...
        public MyRequestableGroups build() {
            MyRequestableGroups model =
                    new MyRequestableGroups(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyRequestableGroups model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyRequestableGroup> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyRequestableGroup> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyRequestableGroups)) {
            return false;
        }

        MyRequestableGroups other = (MyRequestableGroups) o;
