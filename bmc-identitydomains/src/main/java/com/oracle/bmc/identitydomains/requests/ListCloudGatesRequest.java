...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListCloudGatesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudGatesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListCloudGatesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudGatesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudGatesRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListCloudGatesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudGatesRequest
         */
        public ListCloudGatesRequest build() {
            ListCloudGatesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudGatesRequest
         */
        public ListCloudGatesRequest buildWithoutInvocationCallback() {
            ListCloudGatesRequest request = new ListCloudGatesRequest();
            ...
            request.limit = limit;
            return request;
            // new ListCloudGatesRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudGatesRequest)) {
            return false;
        }

        ListCloudGatesRequest other = (ListCloudGatesRequest) o;
