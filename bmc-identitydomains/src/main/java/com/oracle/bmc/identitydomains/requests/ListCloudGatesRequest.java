 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudGatesRequest.
 */
...
public class ListCloudGatesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCloudGatesRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListCloudGatesRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
            // attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
