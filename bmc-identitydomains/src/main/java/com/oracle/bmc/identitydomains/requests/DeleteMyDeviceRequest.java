...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteMyDeviceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMyDeviceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteMyDeviceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMyDeviceRequest, java.lang.Void> {
        ...
        /**
         * ID of the resource
         * @param myDeviceId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMyDeviceRequest o) {
            myDeviceId(o.getMyDeviceId());
        ...
        /**
         * Build the instance of DeleteMyDeviceRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMyDeviceRequest
         */
        public DeleteMyDeviceRequest build() {
            DeleteMyDeviceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMyDeviceRequest
         */
        public DeleteMyDeviceRequest buildWithoutInvocationCallback() {
            DeleteMyDeviceRequest request = new DeleteMyDeviceRequest();
            request.myDeviceId = myDeviceId;
            ...
            return request;
            // new DeleteMyDeviceRequest(myDeviceId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myDeviceId=").append(String.valueOf(this.myDeviceId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMyDeviceRequest)) {
            return false;
        }

        DeleteMyDeviceRequest other = (DeleteMyDeviceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.myDeviceId, other.myDeviceId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.myDeviceId == null ? 43 : this.myDeviceId.hashCode());
        result =
                (result * PRIME)
