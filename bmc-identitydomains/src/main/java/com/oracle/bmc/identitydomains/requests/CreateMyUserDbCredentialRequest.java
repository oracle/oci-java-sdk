...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMyUserDbCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMyUserDbCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateMyUserDbCredentialRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.MyUserDbCredential> {
    ...
    public com.oracle.bmc.identitydomains.model.MyUserDbCredential getBody$() {
        return myUserDbCredential;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateMyUserDbCredentialRequest,
                    com.oracle.bmc.identitydomains.model.MyUserDbCredential> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.MyUserDbCredential myUserDbCredential = null;
         ...
         * @return this builder instance
         */
        public Builder myUserDbCredential(
         ...
         * @return this builder instance
         */
        public Builder copy(CreateMyUserDbCredentialRequest o) {
            authorization(o.getAuthorization());
            resourceTypeSchemaVersion(o.getResourceTypeSchemaVersion());
            myUserDbCredential(o.getMyUserDbCredential());
        ...
        /**
         * Build the instance of CreateMyUserDbCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateMyUserDbCredentialRequest
         */
        public CreateMyUserDbCredentialRequest build() {
            CreateMyUserDbCredentialRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.MyUserDbCredential body) {
            myUserDbCredential(body);
            return this;
        }
         ...
         * @return instance of CreateMyUserDbCredentialRequest
         */
        public CreateMyUserDbCredentialRequest buildWithoutInvocationCallback() {
            CreateMyUserDbCredentialRequest request = new CreateMyUserDbCredentialRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.myUserDbCredential = myUserDbCredential;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateMyUserDbCredentialRequest(authorization, resourceTypeSchemaVersion, myUserDbCredential, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myUserDbCredential=").append(String.valueOf(this.myUserDbCredential));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyUserDbCredentialRequest)) {
            return false;
        }

        CreateMyUserDbCredentialRequest other = (CreateMyUserDbCredentialRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.myUserDbCredential, other.myUserDbCredential)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.myUserDbCredential == null
                                ? 43
                                : this.myUserDbCredential.hashCode());
        result =
                (result * PRIME)
