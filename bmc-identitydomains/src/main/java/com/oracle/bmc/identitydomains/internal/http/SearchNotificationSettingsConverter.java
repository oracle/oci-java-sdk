...
public class SearchNotificationSettingsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(SearchNotificationSettingsConverter.class);

    public static com.oracle.bmc.identitydomains.requests.SearchNotificationSettingsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.identitydomains.requests.SearchNotificationSettingsRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.SearchNotificationSettingsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .SearchNotificationSettingsResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .SearchNotificationSettingsResponse
                                                        .builder()
                                ...
                                builder.notificationSettings(response.getItem());
