...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetIdentityPropagationTrustExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetIdentityPropagationTrustRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetIdentityPropagationTrustRequest
     ...
     * ID of the resource
     */
    public String getIdentityPropagationTrustId() {
        return identityPropagationTrustId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetIdentityPropagationTrustRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String identityPropagationTrustId = null;

        /**
         * ID of the resource
         * @param identityPropagationTrustId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetIdentityPropagationTrustRequest o) {
            identityPropagationTrustId(o.getIdentityPropagationTrustId());
        ...
        /**
         * Build the instance of GetIdentityPropagationTrustRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetIdentityPropagationTrustRequest
         */
        public GetIdentityPropagationTrustRequest build() {
            GetIdentityPropagationTrustRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetIdentityPropagationTrustRequest
         */
        public GetIdentityPropagationTrustRequest buildWithoutInvocationCallback() {
            GetIdentityPropagationTrustRequest request = new GetIdentityPropagationTrustRequest();
            ...
            return request;
            // new GetIdentityPropagationTrustRequest(identityPropagationTrustId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",identityPropagationTrustId=")
                .append(String.valueOf(this.identityPropagationTrustId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIdentityPropagationTrustRequest)) {
            return false;
        }

        GetIdentityPropagationTrustRequest other = (GetIdentityPropagationTrustRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.identityPropagationTrustId, other.identityPropagationTrustId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.identityPropagationTrustId == null
                                ? 43
                                : this.identityPropagationTrustId.hashCode());
        result =
                (result * PRIME)
