...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutIdentityProviderRequest.
 */
...
public class PutIdentityProviderRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PutIdentityProviderRequest o) {
        ...
        /**
         * Build the instance of PutIdentityProviderRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutIdentityProviderRequest
         */
        public PutIdentityProviderRequest build() {
            PutIdentityProviderRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutIdentityProviderRequest
         */
        public PutIdentityProviderRequest buildWithoutInvocationCallback() {
            PutIdentityProviderRequest request = new PutIdentityProviderRequest();
            ...
            return request;
            // new PutIdentityProviderRequest(identityProviderId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, identityProvider, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutIdentityProviderRequest)) {
            return false;
        }

        PutIdentityProviderRequest other = (PutIdentityProviderRequest) o;
