 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutIdentityProviderRequest.
 */
...
public class PutIdentityProviderRequest
    ...
    public static class Builder
        ...
        public PutIdentityProviderRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutIdentityProviderRequest(identityProviderId, authorization,
            // resourceTypeSchemaVersion, attributes, attributeSets, identityProvider, ifMatch,
            // opcRetryToken);
        }
    }
