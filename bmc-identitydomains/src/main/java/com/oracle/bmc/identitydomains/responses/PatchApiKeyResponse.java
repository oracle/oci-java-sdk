...
public class PatchApiKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchApiKeyResponse> {
         ...
         */
        @Override
        public Builder copy(PatchApiKeyResponse o) {
         ...
         */
        @Override
        public PatchApiKeyResponse build() {
            return new PatchApiKeyResponse(__httpStatusCode__, headers, opcRequestId, etag, apiKey);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchApiKeyResponse)) {
            return false;
        }

        PatchApiKeyResponse other = (PatchApiKeyResponse) o;
