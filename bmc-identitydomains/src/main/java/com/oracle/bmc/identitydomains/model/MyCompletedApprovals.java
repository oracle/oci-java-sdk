...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyCompletedApprovals.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyCompletedApprovals extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyCompletedApprovals(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<MyCompletedApproval> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyCompletedApproval> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MyCompletedApproval> resources) {
            this.resources = resources;
        ...
        public MyCompletedApprovals build() {
            MyCompletedApprovals model =
                    new MyCompletedApprovals(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyCompletedApprovals model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyCompletedApproval> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MyCompletedApproval> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyCompletedApprovals(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyCompletedApprovals)) {
            return false;
        }

        MyCompletedApprovals other = (MyCompletedApprovals) o;
