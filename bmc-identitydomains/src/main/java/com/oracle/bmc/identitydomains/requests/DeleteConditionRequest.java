...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteConditionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteConditionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteConditionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteConditionRequest, java.lang.Void> {
        ...
        /**
         * ID of the resource
         * @param conditionId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteConditionRequest o) {
            conditionId(o.getConditionId());
        ...
        /**
         * Build the instance of DeleteConditionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteConditionRequest
         */
        public DeleteConditionRequest build() {
            DeleteConditionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteConditionRequest
         */
        public DeleteConditionRequest buildWithoutInvocationCallback() {
            DeleteConditionRequest request = new DeleteConditionRequest();
            ...
            return request;
            // new DeleteConditionRequest(conditionId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",conditionId=").append(String.valueOf(this.conditionId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteConditionRequest)) {
            return false;
        }

        DeleteConditionRequest other = (DeleteConditionRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.conditionId, other.conditionId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.conditionId == null ? 43 : this.conditionId.hashCode());
        result =
                (result * PRIME)
