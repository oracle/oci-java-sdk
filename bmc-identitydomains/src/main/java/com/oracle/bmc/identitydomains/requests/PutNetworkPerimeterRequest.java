...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutNetworkPerimeterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutNetworkPerimeterRequest.
 */
...
public class PutNetworkPerimeterRequest
    ...
    public static class Builder
        ...
        public PutNetworkPerimeterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutNetworkPerimeterRequest(networkPerimeterId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, networkPerimeter, ifMatch, opcRetryToken);
        }
    }
