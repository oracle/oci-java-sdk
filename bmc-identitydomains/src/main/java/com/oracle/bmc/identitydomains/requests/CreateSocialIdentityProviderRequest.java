...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateSocialIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateSocialIdentityProviderRequest.
 */
...
public class CreateSocialIdentityProviderRequest
    ...
    public static class Builder
        ...
        public CreateSocialIdentityProviderRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateSocialIdentityProviderRequest(authorization, resourceTypeSchemaVersion, socialIdentityProvider, opcRetryToken);
        }
    }
