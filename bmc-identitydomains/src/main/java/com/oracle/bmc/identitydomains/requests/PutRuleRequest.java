 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutRuleRequest.
 */
...
public class PutRuleRequest
    ...
    public static class Builder
        ...
        public PutRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutRuleRequest(ruleId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, rule, ifMatch, opcRetryToken);
        }
    }
