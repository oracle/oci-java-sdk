...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutRuleRequest.
 */
...
public class PutRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutRuleRequest, com.oracle.bmc.identitydomains.model.Rule> {
         ...
         * @return this builder instance
         */
        public Builder copy(PutRuleRequest o) {
            ruleId(o.getRuleId());
         ...
         *
         * @return instance of PutRuleRequest
         */
        public PutRuleRequest build() {
            PutRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutRuleRequest
         */
        public PutRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutRuleRequest(ruleId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, rule, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutRuleRequest)) {
            return false;
        }

        PutRuleRequest other = (PutRuleRequest) o;
