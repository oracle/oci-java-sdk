...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyAuthToken.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyAuthToken extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private MyAuthTokenUser user;

        public Builder user(MyAuthTokenUser user) {
            this.user = user;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyAuthToken model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final MyAuthTokenUser user;

    public MyAuthTokenUser getUser() {
        return user;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyAuthToken)) {
            return false;
        }

        MyAuthToken other = (MyAuthToken) o;
