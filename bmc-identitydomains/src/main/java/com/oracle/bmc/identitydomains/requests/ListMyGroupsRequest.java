...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyGroupsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListMyGroupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMyGroupsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMyGroupsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListMyGroupsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMyGroupsRequest
         */
        public ListMyGroupsRequest build() {
            ListMyGroupsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMyGroupsRequest
         */
        public ListMyGroupsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListMyGroupsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyGroupsRequest)) {
            return false;
        }

        ListMyGroupsRequest other = (ListMyGroupsRequest) o;
