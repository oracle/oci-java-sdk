 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyGroupsRequest.
 */
...
public class ListMyGroupsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMyGroupsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListMyGroupsRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
