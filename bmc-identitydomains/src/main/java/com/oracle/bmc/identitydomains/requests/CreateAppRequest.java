...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateAppExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAppRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateAppRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.App> {
    ...
    public com.oracle.bmc.identitydomains.model.App getBody$() {
        return app;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateAppRequest, com.oracle.bmc.identitydomains.model.App> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.App app = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateAppRequest o) {
         ...
         *
         * @return instance of CreateAppRequest
         */
        public CreateAppRequest build() {
            CreateAppRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.App body) {
            app(body);
            return this;
        }
         ...
         * @return instance of CreateAppRequest
         */
        public CreateAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateAppRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, app, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAppRequest)) {
            return false;
        }
