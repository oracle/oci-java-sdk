 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAppRequest.
 */
...
public class CreateAppRequest
    ...
    public static class Builder
        ...
        public CreateAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateAppRequest(authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, app, opcRetryToken);
        }
    }
