...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyGroupSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyGroupSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public MyGroupSearchRequest build() {
            MyGroupSearchRequest model =
                    new MyGroupSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyGroupSearchRequest model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyGroupSearchRequest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyGroupSearchRequest)) {
            return false;
        }

        MyGroupSearchRequest other = (MyGroupSearchRequest) o;
