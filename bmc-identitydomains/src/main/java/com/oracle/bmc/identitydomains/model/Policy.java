...
/**
 * Policy resource. A named list of rules. <br>
...
public final class Policy extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        private java.util.List<PolicyRules> rules;
         ...
         * @return this builder
         */
        public Builder rules(java.util.List<PolicyRules> rules) {
            this.rules = rules;
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("rules")
    private final java.util.List<PolicyRules> rules;
     ...
     * @return the value
     */
    public java.util.List<PolicyRules> getRules() {
        return rules;
    }
