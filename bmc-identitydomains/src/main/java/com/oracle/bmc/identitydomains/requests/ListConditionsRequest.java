...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListConditionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListConditionsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListConditionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListConditionsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListConditionsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListConditionsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListConditionsRequest
         */
        public ListConditionsRequest build() {
            ListConditionsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListConditionsRequest
         */
        public ListConditionsRequest buildWithoutInvocationCallback() {
            ListConditionsRequest request = new ListConditionsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListConditionsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListConditionsRequest)) {
            return false;
        }

        ListConditionsRequest other = (ListConditionsRequest) o;
