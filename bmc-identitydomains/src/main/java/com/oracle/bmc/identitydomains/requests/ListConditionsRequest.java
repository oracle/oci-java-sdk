 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListConditionsRequest.
 */
...
public class ListConditionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListConditionsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListConditionsRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
