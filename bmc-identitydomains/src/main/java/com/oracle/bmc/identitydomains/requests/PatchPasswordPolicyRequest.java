...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchPasswordPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchPasswordPolicyRequest.
 */
...
public class PatchPasswordPolicyRequest
    ...
    public static class Builder
        ...
        public PatchPasswordPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchPasswordPolicyRequest(passwordPolicyId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
