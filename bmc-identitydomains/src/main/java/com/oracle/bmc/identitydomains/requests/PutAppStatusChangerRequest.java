...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutAppStatusChangerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutAppStatusChangerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutAppStatusChangerRequest
     ...
     * ID of the resource
     */
    private String appStatusChangerId;

    /**
     * ID of the resource
     */
    public String getAppStatusChangerId() {
        return appStatusChangerId;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.AppStatusChanger getBody$() {
        return appStatusChanger;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutAppStatusChangerRequest,
                    com.oracle.bmc.identitydomains.model.AppStatusChanger> {
         ...
         * ID of the resource
         */
        private String appStatusChangerId = null;

        /**
         * ID of the resource
         * @param appStatusChangerId the value to set
         * @return this builder instance
         */
        public Builder appStatusChangerId(String appStatusChangerId) {
            this.appStatusChangerId = appStatusChangerId;
            return this;
        }
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.AppStatusChanger appStatusChanger = null;
         ...
         * @return this builder instance
         */
        public Builder copy(PutAppStatusChangerRequest o) {
            appStatusChangerId(o.getAppStatusChangerId());
        ...
        /**
         * Build the instance of PutAppStatusChangerRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutAppStatusChangerRequest
         */
        public PutAppStatusChangerRequest build() {
            PutAppStatusChangerRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.AppStatusChanger body) {
            appStatusChanger(body);
            return this;
        }
         ...
         * @return instance of PutAppStatusChangerRequest
         */
        public PutAppStatusChangerRequest buildWithoutInvocationCallback() {
            PutAppStatusChangerRequest request = new PutAppStatusChangerRequest();
            request.appStatusChangerId = appStatusChangerId;
            ...
            return request;
            // new PutAppStatusChangerRequest(appStatusChangerId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, appStatusChanger, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",appStatusChangerId=").append(String.valueOf(this.appStatusChangerId));
        ...
        sb.append(",appStatusChanger=").append(String.valueOf(this.appStatusChanger));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutAppStatusChangerRequest)) {
            return false;
        }

        PutAppStatusChangerRequest other = (PutAppStatusChangerRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.appStatusChangerId, other.appStatusChangerId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.appStatusChangerId == null
                                ? 43
                                : this.appStatusChangerId.hashCode());
        result =
                (result * PRIME)
