...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateOAuth2ClientCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOAuth2ClientCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateOAuth2ClientCredentialRequest
    ...
    public com.oracle.bmc.identitydomains.model.OAuth2ClientCredential getBody$() {
        return oAuth2ClientCredential;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateOAuth2ClientCredentialRequest o) {
        ...
        /**
         * Build the instance of CreateOAuth2ClientCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateOAuth2ClientCredentialRequest
         */
        public CreateOAuth2ClientCredentialRequest build() {
            CreateOAuth2ClientCredentialRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.OAuth2ClientCredential body) {
            oAuth2ClientCredential(body);
            return this;
        }
         ...
         * @return instance of CreateOAuth2ClientCredentialRequest
         */
        public CreateOAuth2ClientCredentialRequest buildWithoutInvocationCallback() {
            CreateOAuth2ClientCredentialRequest request = new CreateOAuth2ClientCredentialRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.oAuth2ClientCredential = oAuth2ClientCredential;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateOAuth2ClientCredentialRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, oAuth2ClientCredential, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",oAuth2ClientCredential=").append(String.valueOf(this.oAuth2ClientCredential));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOAuth2ClientCredentialRequest)) {
            return false;
        }

        CreateOAuth2ClientCredentialRequest other = (CreateOAuth2ClientCredentialRequest) o;
