...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteRuleRequest o) {
            ruleId(o.getRuleId());
        ...
        /**
         * Build the instance of DeleteRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteRuleRequest
         */
        public DeleteRuleRequest build() {
            DeleteRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteRuleRequest
         */
        public DeleteRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteRuleRequest(ruleId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRuleRequest)) {
            return false;
        }
