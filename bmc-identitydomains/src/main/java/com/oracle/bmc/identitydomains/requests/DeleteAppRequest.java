...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteAppExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAppRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteAppRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAppRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAppRequest o) {
            appId(o.getAppId());
        ...
        /**
         * Build the instance of DeleteAppRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAppRequest
         */
        public DeleteAppRequest build() {
            DeleteAppRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAppRequest
         */
        public DeleteAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteAppRequest(appId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
