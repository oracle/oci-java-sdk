...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyOAuth2ClientCredentialUser.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyOAuth2ClientCredentialUser
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref", "display", "name"})
    public MyOAuth2ClientCredentialUser(
    ...
    public static class Builder {
        ...
        public MyOAuth2ClientCredentialUser build() {
            MyOAuth2ClientCredentialUser model =
                    new MyOAuth2ClientCredentialUser(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyOAuth2ClientCredentialUser model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MyOAuth2ClientCredentialUser(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyOAuth2ClientCredentialUser)) {
            return false;
        }

        MyOAuth2ClientCredentialUser other = (MyOAuth2ClientCredentialUser) o;
