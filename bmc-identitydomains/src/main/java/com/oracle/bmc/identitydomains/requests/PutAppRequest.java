 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutAppRequest.
 */
...
public class PutAppRequest
    ...
    public static class Builder
        ...
        public PutAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutAppRequest(appId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, app, ifMatch, opcRetryToken);
        }
    }
