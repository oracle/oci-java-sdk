...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutAppExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutAppRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutAppRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutAppRequest, com.oracle.bmc.identitydomains.model.App> {
         ...
         * @return this builder instance
         */
        public Builder copy(PutAppRequest o) {
            appId(o.getAppId());
        ...
        /**
         * Build the instance of PutAppRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutAppRequest
         */
        public PutAppRequest build() {
            PutAppRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutAppRequest
         */
        public PutAppRequest buildWithoutInvocationCallback() {
            PutAppRequest request = new PutAppRequest();
            request.appId = appId;
            ...
            return request;
            // new PutAppRequest(appId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, app, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutAppRequest)) {
            return false;
        }

        PutAppRequest other = (PutAppRequest) o;
