...
public final class SettingsDefaultImages
    ...
    public static class Builder {
        ...
        public SettingsDefaultImages build() {
            SettingsDefaultImages model =
                    new SettingsDefaultImages(this.value, this.type, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SettingsDefaultImages model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SettingsDefaultImages(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SettingsDefaultImages)) {
            return false;
        }

        SettingsDefaultImages other = (SettingsDefaultImages) o;
