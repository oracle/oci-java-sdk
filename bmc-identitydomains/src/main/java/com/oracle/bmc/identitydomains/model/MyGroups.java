...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyGroups.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyGroups extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyGroups(
            ...
            java.util.List<MyGroup> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyGroup> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<MyGroup> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyGroups model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyGroup> resources;
     ...
     * @return the value
     */
    public java.util.List<MyGroup> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyGroups)) {
            return false;
        }

        MyGroups other = (MyGroups) o;
