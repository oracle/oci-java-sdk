...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserExtOAuth2ClientCredentials.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UserExtOAuth2ClientCredentials
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref"})
    public UserExtOAuth2ClientCredentials(String value, String ocid, String ref) {
        super();
        this.value = value;
        this.ocid = ocid;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public UserExtOAuth2ClientCredentials build() {
            UserExtOAuth2ClientCredentials model =
                    new UserExtOAuth2ClientCredentials(this.value, this.ocid, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserExtOAuth2ClientCredentials model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserExtOAuth2ClientCredentials(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserExtOAuth2ClientCredentials)) {
            return false;
        }

        UserExtOAuth2ClientCredentials other = (UserExtOAuth2ClientCredentials) o;
