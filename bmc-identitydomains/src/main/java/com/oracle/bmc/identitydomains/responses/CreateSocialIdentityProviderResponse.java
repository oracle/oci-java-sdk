...
public class CreateSocialIdentityProviderResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateSocialIdentityProviderResponse o) {
         ...
         */
        public CreateSocialIdentityProviderResponse build() {
            return new CreateSocialIdentityProviderResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSocialIdentityProviderResponse)) {
            return false;
        }

        CreateSocialIdentityProviderResponse other = (CreateSocialIdentityProviderResponse) o;
