...
public class ListAccountMgmtInfosConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAccountMgmtInfosConverter.class);

    public static com.oracle.bmc.identitydomains.requests.ListAccountMgmtInfosRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.ListAccountMgmtInfosRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("AccountMgmtInfos");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.ListAccountMgmtInfosResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .ListAccountMgmtInfosResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .ListAccountMgmtInfosResponse.builder()
                                ...
                                builder.accountMgmtInfos(response.getItem());
