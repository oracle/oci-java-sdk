...
public class GetAppRoleConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetAppRoleConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetAppRoleRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.GetAppRoleRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses.GetAppRoleResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses.GetAppRoleResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetAppRoleResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetAppRoleResponse.Builder
                                        builder =
                                ...
                                builder.appRole(response.getItem());
