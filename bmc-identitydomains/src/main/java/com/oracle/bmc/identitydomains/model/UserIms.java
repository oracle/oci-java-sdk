...
/**
 * User's instant messaging addresses <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserIms.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserIms extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "display", "type", "primary"})
    public UserIms(String value, String display, Type type, Boolean primary) {
        super();
        this.value = value;
    ...
    public static class Builder {
         ...
         * attribute--for example, the preferred messenger or primary messenger. The primary
        ...
        public UserIms build() {
            UserIms model = new UserIms(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserIms model) {
    ...
    /**
     * A Boolean value that indicates the 'primary' or preferred attribute value for this
     * attribute--for example, the preferred messenger or primary messenger. The primary attribute
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserIms)) {
            return false;
        }

        UserIms other = (UserIms) o;
