...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserRoles.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserRoles extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "display", "type", "primary"})
    public UserRoles(String value, String display, String type, Boolean primary) {
        super();
        this.value = value;
    ...
    public static class Builder {
        ...
        public UserRoles build() {
            UserRoles model = new UserRoles(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserRoles model) {
