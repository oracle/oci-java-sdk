...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SettingsDefaultLoginTexts.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SettingsDefaultLoginTexts
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "locale"})
    public SettingsDefaultLoginTexts(String value, String locale) {
        super();
        this.value = value;
        this.locale = locale;
    }
    ...
    public static class Builder {
         ...
         * returned: default - type: string - idcsSanitize: true
         */
        ...
        public SettingsDefaultLoginTexts build() {
            SettingsDefaultLoginTexts model =
                    new SettingsDefaultLoginTexts(this.value, this.locale);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SettingsDefaultLoginTexts model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SettingsDefaultLoginTexts(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SettingsDefaultLoginTexts)) {
            return false;
        }

        SettingsDefaultLoginTexts other = (SettingsDefaultLoginTexts) o;
