 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutCloudGateServerRequest.
 */
...
public class PutCloudGateServerRequest
    ...
    public static class Builder
        ...
        public PutCloudGateServerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutCloudGateServerRequest(cloudGateServerId, authorization,
            // resourceTypeSchemaVersion, attributes, attributeSets, cloudGateServer, ifMatch,
            // opcRetryToken);
        }
    }
