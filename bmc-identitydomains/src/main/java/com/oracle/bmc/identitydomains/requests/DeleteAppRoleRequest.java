...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteAppRoleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAppRoleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteAppRoleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAppRoleRequest, java.lang.Void> {
        ...
        /**
         * ID of the resource
         * @param appRoleId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAppRoleRequest o) {
            appRoleId(o.getAppRoleId());
        ...
        /**
         * Build the instance of DeleteAppRoleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAppRoleRequest
         */
        public DeleteAppRoleRequest build() {
            DeleteAppRoleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAppRoleRequest
         */
        public DeleteAppRoleRequest buildWithoutInvocationCallback() {
            DeleteAppRoleRequest request = new DeleteAppRoleRequest();
            ...
            return request;
            // new DeleteAppRoleRequest(appRoleId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",appRoleId=").append(String.valueOf(this.appRoleId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAppRoleRequest)) {
            return false;
        }

        DeleteAppRoleRequest other = (DeleteAppRoleRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.appRoleId, other.appRoleId)
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.appRoleId == null ? 43 : this.appRoleId.hashCode());
        result =
                (result * PRIME)
