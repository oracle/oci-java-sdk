...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchIdentityProofingProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchIdentityProofingProviderRequest.
 */
...
public class PatchIdentityProofingProviderRequest
    ...
    public static class Builder
        ...
        public PatchIdentityProofingProviderRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchIdentityProofingProviderRequest(identityProofingProviderId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
