...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SmtpCredentials.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SmtpCredentials extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public SmtpCredentials(
            ...
            java.util.List<SmtpCredential> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<SmtpCredential> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<SmtpCredential> resources) {
            this.resources = resources;
        ...
        public SmtpCredentials build() {
            SmtpCredentials model =
                    new SmtpCredentials(
                            this.schemas,
                            this.totalResults,
                            this.resources,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SmtpCredentials model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<SmtpCredential> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<SmtpCredential> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SmtpCredentials)) {
            return false;
        }

        SmtpCredentials other = (SmtpCredentials) o;
