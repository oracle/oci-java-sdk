...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMyOAuth2ClientCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMyOAuth2ClientCredentialRequest.
 */
...
public class PatchMyOAuth2ClientCredentialRequest
    ...
    public static class Builder
        ...
        public PatchMyOAuth2ClientCredentialRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchMyOAuth2ClientCredentialRequest(myOAuth2ClientCredentialId, authorization, resourceTypeSchemaVersion, patchOp, ifMatch, opcRetryToken);
        }
    }
