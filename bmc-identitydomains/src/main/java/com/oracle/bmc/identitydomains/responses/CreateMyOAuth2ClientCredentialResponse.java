...
public class CreateMyOAuth2ClientCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateMyOAuth2ClientCredentialResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateMyOAuth2ClientCredentialResponse o) {
         ...
         */
        @Override
        public CreateMyOAuth2ClientCredentialResponse build() {
            return new CreateMyOAuth2ClientCredentialResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyOAuth2ClientCredentialResponse)) {
            return false;
        }

        CreateMyOAuth2ClientCredentialResponse other = (CreateMyOAuth2ClientCredentialResponse) o;
