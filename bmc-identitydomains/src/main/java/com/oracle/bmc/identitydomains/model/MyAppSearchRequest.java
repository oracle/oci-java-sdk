...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = MyAppSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyAppSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public MyAppSearchRequest build() {
            MyAppSearchRequest model =
                    new MyAppSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyAppSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyAppSearchRequest)) {
            return false;
        }

        MyAppSearchRequest other = (MyAppSearchRequest) o;
