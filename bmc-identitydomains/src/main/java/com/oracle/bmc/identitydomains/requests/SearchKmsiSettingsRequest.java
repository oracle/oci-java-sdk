 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchKmsiSettingsRequest.
 */
...
public class SearchKmsiSettingsRequest
    ...
    public static class Builder
        ...
        public SearchKmsiSettingsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchKmsiSettingsRequest(authorization, resourceTypeSchemaVersion,
            // kmsiSettingsSearchRequest, opcRetryToken, page, limit);
        }
    }
