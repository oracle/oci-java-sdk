...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchMeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchMeRequest.
 */
...
public class PatchMeRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchMeRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchMeRequest o) {
         ...
         *
         * @return instance of PatchMeRequest
         */
        public PatchMeRequest build() {
            PatchMeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchMeRequest
         */
        public PatchMeRequest buildWithoutInvocationCallback() {
            PatchMeRequest request = new PatchMeRequest();
            ...
            return request;
            // new PatchMeRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchMeRequest)) {
            return false;
        }

        PatchMeRequest other = (PatchMeRequest) o;
