 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchKmsiSettingRequest.
 */
...
public class PatchKmsiSettingRequest
    ...
    public static class Builder
        ...
        public PatchKmsiSettingRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchKmsiSettingRequest(kmsiSettingId, authorization, resourceTypeSchemaVersion,
            // attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
