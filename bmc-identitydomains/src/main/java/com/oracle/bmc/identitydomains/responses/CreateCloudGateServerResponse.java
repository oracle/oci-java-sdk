...
public class CreateCloudGateServerResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateCloudGateServerResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateCloudGateServerResponse> {
         ...
         */
        @Override
        public Builder copy(CreateCloudGateServerResponse o) {
         ...
         */
        @Override
        public CreateCloudGateServerResponse build() {
            return new CreateCloudGateServerResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCloudGateServerResponse)) {
            return false;
        }

        CreateCloudGateServerResponse other = (CreateCloudGateServerResponse) o;
