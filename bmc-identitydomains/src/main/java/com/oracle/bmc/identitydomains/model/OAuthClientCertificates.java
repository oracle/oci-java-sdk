...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OAuthClientCertificates.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OAuthClientCertificates
    ...
    public OAuthClientCertificates(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<OAuthClientCertificate> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<OAuthClientCertificate> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<OAuthClientCertificate> resources) {
            this.resources = resources;
        ...
        public OAuthClientCertificates build() {
            OAuthClientCertificates model =
                    new OAuthClientCertificates(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuthClientCertificates model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<OAuthClientCertificate> resources;
     ...
     * @return the value
     */
    public java.util.List<OAuthClientCertificate> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OAuthClientCertificates(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OAuthClientCertificates)) {
            return false;
        }

        OAuthClientCertificates other = (OAuthClientCertificates) o;
