...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MySupportAccount.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class MySupportAccount
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - required: true -
         ...
         * <p>*Added In:** 2102181953
         *
         * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - idcsSearchable: true -
         * mutability: readOnly - required: false - returned: default - type: string - uniqueness:
         * none
         */
        ...
        private MySupportAccountUser user;

        public Builder user(MySupportAccountUser user) {
            this.user = user;
        ...
        public MySupportAccount build() {
            MySupportAccount model =
                    new MySupportAccount(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySupportAccount model) {
     ...
     * <p>*Added In:** 2102181953
     *
     * <p>*SCIM++ Properties:** - caseExact: false - multiValued: false - required: true - returned:
     * never - type: string - uniqueness: none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("token")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("user")
    private final MySupportAccountUser user;

    public MySupportAccountUser getUser() {
        return user;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySupportAccount)) {
            return false;
        }

        MySupportAccount other = (MySupportAccount) o;
