...
public class CreateCloudGateServerConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateCloudGateServerConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreateCloudGateServerRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.CreateCloudGateServerRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("CloudGateServers");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreateCloudGateServerResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
