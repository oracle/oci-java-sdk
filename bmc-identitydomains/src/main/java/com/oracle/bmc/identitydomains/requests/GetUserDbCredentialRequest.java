...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetUserDbCredentialExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetUserDbCredentialRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetUserDbCredentialRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * ID of the resource
     */
    public String getUserDbCredentialId() {
        return userDbCredentialId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetUserDbCredentialRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String userDbCredentialId = null;

        /**
         * ID of the resource
         * @param userDbCredentialId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetUserDbCredentialRequest o) {
            userDbCredentialId(o.getUserDbCredentialId());
        ...
        /**
         * Build the instance of GetUserDbCredentialRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetUserDbCredentialRequest
         */
        public GetUserDbCredentialRequest build() {
            GetUserDbCredentialRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetUserDbCredentialRequest
         */
        public GetUserDbCredentialRequest buildWithoutInvocationCallback() {
            GetUserDbCredentialRequest request = new GetUserDbCredentialRequest();
            ...
            return request;
            // new GetUserDbCredentialRequest(userDbCredentialId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",userDbCredentialId=").append(String.valueOf(this.userDbCredentialId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetUserDbCredentialRequest)) {
            return false;
        }

        GetUserDbCredentialRequest other = (GetUserDbCredentialRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.userDbCredentialId, other.userDbCredentialId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userDbCredentialId == null
                                ? 43
                                : this.userDbCredentialId.hashCode());
        result =
                (result * PRIME)
