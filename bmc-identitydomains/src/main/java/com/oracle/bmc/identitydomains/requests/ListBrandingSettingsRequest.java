...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListBrandingSettingsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBrandingSettingsRequest.
 */
...
public class ListBrandingSettingsRequest
    ...
    public static class Builder
        ...
        public ListBrandingSettingsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListBrandingSettingsRequest(attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
