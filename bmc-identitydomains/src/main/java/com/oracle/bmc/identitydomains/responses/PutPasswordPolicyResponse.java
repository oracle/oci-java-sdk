...
public class PutPasswordPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PutPasswordPolicyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutPasswordPolicyResponse> {
         ...
         */
        @Override
        public Builder copy(PutPasswordPolicyResponse o) {
         ...
         */
        @Override
        public PutPasswordPolicyResponse build() {
            return new PutPasswordPolicyResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutPasswordPolicyResponse)) {
            return false;
        }

        PutPasswordPolicyResponse other = (PutPasswordPolicyResponse) o;
