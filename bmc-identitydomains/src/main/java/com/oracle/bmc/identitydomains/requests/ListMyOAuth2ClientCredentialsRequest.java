...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyOAuth2ClientCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyOAuth2ClientCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListMyOAuth2ClientCredentialsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMyOAuth2ClientCredentialsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMyOAuth2ClientCredentialsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListMyOAuth2ClientCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMyOAuth2ClientCredentialsRequest
         */
        public ListMyOAuth2ClientCredentialsRequest build() {
            ListMyOAuth2ClientCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMyOAuth2ClientCredentialsRequest
         */
        public ListMyOAuth2ClientCredentialsRequest buildWithoutInvocationCallback() {
            ListMyOAuth2ClientCredentialsRequest request =
                    new ListMyOAuth2ClientCredentialsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListMyOAuth2ClientCredentialsRequest(filter, sortBy, sortOrder, startIndex, count, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyOAuth2ClientCredentialsRequest)) {
            return false;
        }

        ListMyOAuth2ClientCredentialsRequest other = (ListMyOAuth2ClientCredentialsRequest) o;
