...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListPasswordPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPasswordPoliciesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListPasswordPoliciesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListPasswordPoliciesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListPasswordPoliciesRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListPasswordPoliciesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListPasswordPoliciesRequest
         */
        public ListPasswordPoliciesRequest build() {
            ListPasswordPoliciesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListPasswordPoliciesRequest
         */
        public ListPasswordPoliciesRequest buildWithoutInvocationCallback() {
            ListPasswordPoliciesRequest request = new ListPasswordPoliciesRequest();
            ...
            request.limit = limit;
            return request;
            // new ListPasswordPoliciesRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPasswordPoliciesRequest)) {
            return false;
        }

        ListPasswordPoliciesRequest other = (ListPasswordPoliciesRequest) o;
