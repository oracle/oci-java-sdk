 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPasswordPoliciesRequest.
 */
...
public class ListPasswordPoliciesRequest
    ...
    public static class Builder
        ...
        public ListPasswordPoliciesRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListPasswordPoliciesRequest(filter, sortBy, sortOrder, startIndex, count,
