...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyGroupMembers.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MyGroupMembers extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public MyGroupMembers build() {
            MyGroupMembers model =
                    new MyGroupMembers(
                            this.value,
                            this.dateAdded,
                            this.ocid,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyGroupMembers model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyGroupMembers)) {
            return false;
        }

        MyGroupMembers other = (MyGroupMembers) o;
