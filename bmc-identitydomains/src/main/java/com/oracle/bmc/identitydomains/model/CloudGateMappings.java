...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CloudGateMappings.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CloudGateMappings extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public CloudGateMappings(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<CloudGateMapping> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<CloudGateMapping> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<CloudGateMapping> resources) {
            this.resources = resources;
        ...
        public CloudGateMappings build() {
            CloudGateMappings model =
                    new CloudGateMappings(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudGateMappings model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<CloudGateMapping> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<CloudGateMapping> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudGateMappings)) {
            return false;
        }

        CloudGateMappings other = (CloudGateMappings) o;
