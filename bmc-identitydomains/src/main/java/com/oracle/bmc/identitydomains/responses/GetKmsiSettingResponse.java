...
public class GetKmsiSettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetKmsiSettingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetKmsiSettingResponse> {
         ...
         */
        @Override
        public Builder copy(GetKmsiSettingResponse o) {
         ...
         */
        @Override
        public GetKmsiSettingResponse build() {
            return new GetKmsiSettingResponse(
                    __httpStatusCode__, headers, opcRequestId, kmsiSetting);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetKmsiSettingResponse)) {
            return false;
        }

        GetKmsiSettingResponse other = (GetKmsiSettingResponse) o;
