...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = NetworkPerimeters.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class NetworkPerimeters extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public NetworkPerimeters(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<NetworkPerimeter> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<NetworkPerimeter> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<NetworkPerimeter> resources) {
            this.resources = resources;
        ...
        public NetworkPerimeters build() {
            NetworkPerimeters model =
                    new NetworkPerimeters(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkPerimeters model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<NetworkPerimeter> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<NetworkPerimeter> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkPerimeters)) {
            return false;
        }

        NetworkPerimeters other = (NetworkPerimeters) o;
