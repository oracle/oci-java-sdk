...
public class DeleteUserDbCredentialConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DeleteUserDbCredentialConverter.class);

    public static com.oracle.bmc.identitydomains.requests.DeleteUserDbCredentialRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.DeleteUserDbCredentialRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.DeleteUserDbCredentialResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.DeleteUserDbCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses
                                                .DeleteUserDbCredentialResponse.Builder
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .DeleteUserDbCredentialResponse.builder()
