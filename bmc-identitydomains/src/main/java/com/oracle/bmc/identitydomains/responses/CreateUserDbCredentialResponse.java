...
public class CreateUserDbCredentialResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateUserDbCredentialResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateUserDbCredentialResponse o) {
         ...
         */
        @Override
        public CreateUserDbCredentialResponse build() {
            return new CreateUserDbCredentialResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, userDbCredential);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateUserDbCredentialResponse)) {
            return false;
        }

        CreateUserDbCredentialResponse other = (CreateUserDbCredentialResponse) o;
