...
public class PutKmsiSettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PutKmsiSettingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PutKmsiSettingResponse> {
         ...
         */
        @Override
        public Builder copy(PutKmsiSettingResponse o) {
         ...
         */
        @Override
        public PutKmsiSettingResponse build() {
            return new PutKmsiSettingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutKmsiSettingResponse)) {
            return false;
        }

        PutKmsiSettingResponse other = (PutKmsiSettingResponse) o;
