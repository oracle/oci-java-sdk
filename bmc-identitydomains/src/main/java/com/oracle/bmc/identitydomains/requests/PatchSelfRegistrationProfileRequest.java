...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchSelfRegistrationProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSelfRegistrationProfileRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchSelfRegistrationProfileRequest
     ...
     * ID of the resource
     */
    public String getSelfRegistrationProfileId() {
        return selfRegistrationProfileId;
    }
    /**
    ...
    public static class Builder
         ...
         * ID of the resource
         */
        private String selfRegistrationProfileId = null;

        /**
         * ID of the resource
         * @param selfRegistrationProfileId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchSelfRegistrationProfileRequest o) {
            selfRegistrationProfileId(o.getSelfRegistrationProfileId());
         ...
         *
         * @return instance of PatchSelfRegistrationProfileRequest
         */
        public PatchSelfRegistrationProfileRequest build() {
            PatchSelfRegistrationProfileRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchSelfRegistrationProfileRequest
         */
        public PatchSelfRegistrationProfileRequest buildWithoutInvocationCallback() {
            PatchSelfRegistrationProfileRequest request = new PatchSelfRegistrationProfileRequest();
            ...
            return request;
            // new PatchSelfRegistrationProfileRequest(selfRegistrationProfileId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",selfRegistrationProfileId=")
                .append(String.valueOf(this.selfRegistrationProfileId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchSelfRegistrationProfileRequest)) {
            return false;
        }

        PatchSelfRegistrationProfileRequest other = (PatchSelfRegistrationProfileRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.selfRegistrationProfileId, other.selfRegistrationProfileId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.selfRegistrationProfileId == null
                                ? 43
                                : this.selfRegistrationProfileId.hashCode());
        result =
                (result * PRIME)
