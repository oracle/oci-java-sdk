...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutUserStatusChangerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutUserStatusChangerRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutUserStatusChangerRequest
        extends com.oracle.bmc.requests.BmcRequest<
                com.oracle.bmc.identitydomains.model.UserStatusChanger> {

    /**
     * ID of the resource
     */
    private String userStatusChangerId;

    /**
     * ID of the resource
     */
    public String getUserStatusChangerId() {
        return userStatusChangerId;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.UserStatusChanger getBody$() {
        return userStatusChanger;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutUserStatusChangerRequest,
                    com.oracle.bmc.identitydomains.model.UserStatusChanger> {
         ...
         * ID of the resource
         */
        private String userStatusChangerId = null;

        /**
         * ID of the resource
         * @param userStatusChangerId the value to set
         * @return this builder instance
         */
        public Builder userStatusChangerId(String userStatusChangerId) {
            this.userStatusChangerId = userStatusChangerId;
            return this;
        }
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.UserStatusChanger userStatusChanger = null;
         ...
         * @return this builder instance
         */
        public Builder copy(PutUserStatusChangerRequest o) {
            userStatusChangerId(o.getUserStatusChangerId());
        ...
        /**
         * Build the instance of PutUserStatusChangerRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutUserStatusChangerRequest
         */
        public PutUserStatusChangerRequest build() {
            PutUserStatusChangerRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.UserStatusChanger body) {
         ...
         * @return instance of PutUserStatusChangerRequest
         */
        public PutUserStatusChangerRequest buildWithoutInvocationCallback() {
            PutUserStatusChangerRequest request = new PutUserStatusChangerRequest();
            request.userStatusChangerId = userStatusChangerId;
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.userStatusChanger = userStatusChanger;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new PutUserStatusChangerRequest(userStatusChangerId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, userStatusChanger, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",userStatusChangerId=").append(String.valueOf(this.userStatusChangerId));
        ...
        sb.append(",userStatusChanger=").append(String.valueOf(this.userStatusChanger));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutUserStatusChangerRequest)) {
            return false;
        }

        PutUserStatusChangerRequest other = (PutUserStatusChangerRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.userStatusChangerId, other.userStatusChangerId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.userStatusChangerId == null
                                ? 43
                                : this.userStatusChangerId.hashCode());
        result =
                (result * PRIME)
