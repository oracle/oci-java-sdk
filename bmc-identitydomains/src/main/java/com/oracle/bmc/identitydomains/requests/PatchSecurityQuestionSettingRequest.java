...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchSecurityQuestionSettingExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchSecurityQuestionSettingRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchSecurityQuestionSettingRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchSecurityQuestionSettingRequest o) {
        ...
        /**
         * Build the instance of PatchSecurityQuestionSettingRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchSecurityQuestionSettingRequest
         */
        public PatchSecurityQuestionSettingRequest build() {
            PatchSecurityQuestionSettingRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchSecurityQuestionSettingRequest
         */
        public PatchSecurityQuestionSettingRequest buildWithoutInvocationCallback() {
            PatchSecurityQuestionSettingRequest request = new PatchSecurityQuestionSettingRequest();
            ...
            return request;
            // new PatchSecurityQuestionSettingRequest(securityQuestionSettingId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchSecurityQuestionSettingRequest)) {
            return false;
        }

        PatchSecurityQuestionSettingRequest other = (PatchSecurityQuestionSettingRequest) o;
