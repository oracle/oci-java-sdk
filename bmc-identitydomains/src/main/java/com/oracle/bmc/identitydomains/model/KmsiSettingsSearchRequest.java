...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = KmsiSettingsSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class KmsiSettingsSearchRequest
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"schemas", "attributes", "attributeSets"})
    public KmsiSettingsSearchRequest(
    ...
    public static class Builder {
        ...
        public KmsiSettingsSearchRequest build() {
            KmsiSettingsSearchRequest model =
                    new KmsiSettingsSearchRequest(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(KmsiSettingsSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KmsiSettingsSearchRequest)) {
            return false;
        }

        KmsiSettingsSearchRequest other = (KmsiSettingsSearchRequest) o;
