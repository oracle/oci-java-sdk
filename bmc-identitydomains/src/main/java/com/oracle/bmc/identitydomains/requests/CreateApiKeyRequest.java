 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateApiKeyRequest.
 */
...
public class CreateApiKeyRequest
    ...
    public static class Builder
        ...
        public CreateApiKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateApiKeyRequest(authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, apiKey, opcRetryToken);
        }
    }
