...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateApiKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateApiKeyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateApiKeyRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.ApiKey> {
    ...
    public com.oracle.bmc.identitydomains.model.ApiKey getBody$() {
        return apiKey;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateApiKeyRequest, com.oracle.bmc.identitydomains.model.ApiKey> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.ApiKey apiKey = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateApiKeyRequest o) {
         ...
         *
         * @return instance of CreateApiKeyRequest
         */
        public CreateApiKeyRequest build() {
            CreateApiKeyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.ApiKey body) {
            apiKey(body);
            return this;
        }
         ...
         * @return instance of CreateApiKeyRequest
         */
        public CreateApiKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateApiKeyRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, apiKey, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",apiKey=").append(String.valueOf(this.apiKey));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApiKeyRequest)) {
            return false;
        }

        CreateApiKeyRequest other = (CreateApiKeyRequest) o;
