...
public class PatchPasswordPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PatchPasswordPolicyResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchPasswordPolicyResponse> {
         ...
         */
        @Override
        public Builder copy(PatchPasswordPolicyResponse o) {
         ...
         */
        @Override
        public PatchPasswordPolicyResponse build() {
            return new PatchPasswordPolicyResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, passwordPolicy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchPasswordPolicyResponse)) {
            return false;
        }

        PatchPasswordPolicyResponse other = (PatchPasswordPolicyResponse) o;
