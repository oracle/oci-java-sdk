...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MappedAttributes.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class MappedAttributes extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MappedAttributes(
            ...
            java.util.List<MappedAttribute> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MappedAttribute> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<MappedAttribute> resources) {
            this.resources = resources;
        ...
        public MappedAttributes build() {
            MappedAttributes model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MappedAttributes model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MappedAttribute> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<MappedAttribute> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MappedAttributes)) {
            return false;
        }

        MappedAttributes other = (MappedAttributes) o;
