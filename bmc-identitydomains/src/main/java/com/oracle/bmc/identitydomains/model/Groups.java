...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Groups.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class Groups extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public Groups(
            ...
            java.util.List<Group> resources,
            Integer startIndex,
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Group> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Groups model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Group> resources;
