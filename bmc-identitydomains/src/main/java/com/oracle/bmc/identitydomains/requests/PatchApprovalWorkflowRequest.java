...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchApprovalWorkflowExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchApprovalWorkflowRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchApprovalWorkflowRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchApprovalWorkflowRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * ID of the resource
         */
        private String approvalWorkflowId = null;

        /**
         * ID of the resource
         * @param approvalWorkflowId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(PatchApprovalWorkflowRequest o) {
            approvalWorkflowId(o.getApprovalWorkflowId());
        ...
        /**
         * Build the instance of PatchApprovalWorkflowRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchApprovalWorkflowRequest
         */
        public PatchApprovalWorkflowRequest build() {
            PatchApprovalWorkflowRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchApprovalWorkflowRequest
         */
        public PatchApprovalWorkflowRequest buildWithoutInvocationCallback() {
            PatchApprovalWorkflowRequest request = new PatchApprovalWorkflowRequest();
            ...
            return request;
            // new PatchApprovalWorkflowRequest(approvalWorkflowId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",approvalWorkflowId=").append(String.valueOf(this.approvalWorkflowId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchApprovalWorkflowRequest)) {
            return false;
        }

        PatchApprovalWorkflowRequest other = (PatchApprovalWorkflowRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.approvalWorkflowId, other.approvalWorkflowId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.approvalWorkflowId == null
                                ? 43
                                : this.approvalWorkflowId.hashCode());
        result =
                (result * PRIME)
