...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CloudGateServers.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CloudGateServers extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public CloudGateServers(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<CloudGateServer> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<CloudGateServer> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<CloudGateServer> resources) {
            this.resources = resources;
        ...
        public CloudGateServers build() {
            CloudGateServers model =
                    new CloudGateServers(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudGateServers model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<CloudGateServer> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<CloudGateServer> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudGateServers)) {
            return false;
        }

        CloudGateServers other = (CloudGateServers) o;
