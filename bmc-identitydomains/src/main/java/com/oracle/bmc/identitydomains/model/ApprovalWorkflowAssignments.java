...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApprovalWorkflowAssignments.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ApprovalWorkflowAssignments
    ...
    public ApprovalWorkflowAssignments(
            java.util.List<String> schemas,
            Integer totalResults,
            java.util.List<ApprovalWorkflowAssignment> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<ApprovalWorkflowAssignment> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<ApprovalWorkflowAssignment> resources) {
            this.resources = resources;
        ...
        public ApprovalWorkflowAssignments build() {
            ApprovalWorkflowAssignments model =
                    new ApprovalWorkflowAssignments(
                            this.schemas,
                            this.totalResults,
                            this.resources,
                            this.startIndex,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalWorkflowAssignments model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<ApprovalWorkflowAssignment> resources;
     ...
     * @return the value
     */
    public java.util.List<ApprovalWorkflowAssignment> getResources() {
        return resources;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ApprovalWorkflowAssignments(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApprovalWorkflowAssignments)) {
            return false;
        }

        ApprovalWorkflowAssignments other = (ApprovalWorkflowAssignments) o;
