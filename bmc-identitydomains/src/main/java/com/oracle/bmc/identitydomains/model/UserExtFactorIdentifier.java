...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UserExtFactorIdentifier.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserExtFactorIdentifier
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display"})
    public UserExtFactorIdentifier(String value, String ref, String display) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public UserExtFactorIdentifier build() {
            UserExtFactorIdentifier model =
                    new UserExtFactorIdentifier(this.value, this.ref, this.display);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserExtFactorIdentifier model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserExtFactorIdentifier(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserExtFactorIdentifier)) {
            return false;
        }

        UserExtFactorIdentifier other = (UserExtFactorIdentifier) o;
