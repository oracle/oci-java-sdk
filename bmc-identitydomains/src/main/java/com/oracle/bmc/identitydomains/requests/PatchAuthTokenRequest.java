...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchAuthTokenRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchAuthTokenRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchAuthTokenRequest o) {
         ...
         *
         * @return instance of PatchAuthTokenRequest
         */
        public PatchAuthTokenRequest build() {
            PatchAuthTokenRequest request = buildWithoutInvocationCallback();
        ...
        public PatchAuthTokenRequest buildWithoutInvocationCallback() {
            PatchAuthTokenRequest request = new PatchAuthTokenRequest();
            ...
            return request;
            // new PatchAuthTokenRequest(authTokenId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchAuthTokenRequest)) {
            return false;
        }

        PatchAuthTokenRequest other = (PatchAuthTokenRequest) o;
