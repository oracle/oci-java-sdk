...
public class ListUsersConverter {
    ...
    public static com.oracle.bmc.identitydomains.requests.ListUsersRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.ListUsersRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("Users");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses.ListUsersResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses.ListUsersResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.ListUsersResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.ListUsersResponse.Builder
                                        builder =
                                ...
                                builder.users(response.getItem());
