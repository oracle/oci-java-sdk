...
/**
 * Accounts assigned to this User. Each value of this attribute refers to an app-specific identity
 * that is owned by this User. Therefore, this attribute is a convenience that allows one to see on
 * each User the Apps to which that User has access.
 *
 * <p>*SCIM++ Properties:** - idcsPii: true - idcsSearchable: true - multiValued: true - mutability:
 * readOnly - required: false - returned: request - type: complex - uniqueness: none <br>
...
public final class UserExtAccounts
