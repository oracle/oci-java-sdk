...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Rules.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Rules extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        private java.util.List<Rule> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<Rule> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Rules model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<Rule> resources;
     ...
     * @return the value
     */
    public java.util.List<Rule> getResources() {
        return resources;
    }
