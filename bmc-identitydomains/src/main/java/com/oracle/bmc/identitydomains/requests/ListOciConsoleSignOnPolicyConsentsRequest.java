...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListOciConsoleSignOnPolicyConsentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOciConsoleSignOnPolicyConsentsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListOciConsoleSignOnPolicyConsentsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListOciConsoleSignOnPolicyConsentsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListOciConsoleSignOnPolicyConsentsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListOciConsoleSignOnPolicyConsentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListOciConsoleSignOnPolicyConsentsRequest
         */
        public ListOciConsoleSignOnPolicyConsentsRequest build() {
            ListOciConsoleSignOnPolicyConsentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListOciConsoleSignOnPolicyConsentsRequest
         */
        public ListOciConsoleSignOnPolicyConsentsRequest buildWithoutInvocationCallback() {
            ListOciConsoleSignOnPolicyConsentsRequest request =
                    new ListOciConsoleSignOnPolicyConsentsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListOciConsoleSignOnPolicyConsentsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListOciConsoleSignOnPolicyConsentsRequest)) {
            return false;
        }

        ListOciConsoleSignOnPolicyConsentsRequest other =
                (ListOciConsoleSignOnPolicyConsentsRequest) o;
