...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutSocialIdentityProviderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutSocialIdentityProviderRequest.
 */
...
public class PutSocialIdentityProviderRequest
    ...
    public static class Builder
        ...
        public PutSocialIdentityProviderRequest build() {
            PutSocialIdentityProviderRequest request = buildWithoutInvocationCallback();
        ...
        public PutSocialIdentityProviderRequest buildWithoutInvocationCallback() {
            PutSocialIdentityProviderRequest request = new PutSocialIdentityProviderRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutSocialIdentityProviderRequest)) {
            return false;
        }

        PutSocialIdentityProviderRequest other = (PutSocialIdentityProviderRequest) o;
