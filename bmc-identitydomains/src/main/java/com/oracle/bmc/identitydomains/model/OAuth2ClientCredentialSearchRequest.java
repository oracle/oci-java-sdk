...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = OAuth2ClientCredentialSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class OAuth2ClientCredentialSearchRequest
    ...
    public OAuth2ClientCredentialSearchRequest(
    ...
    public static class Builder {
        ...
        public OAuth2ClientCredentialSearchRequest build() {
            OAuth2ClientCredentialSearchRequest model =
                    new OAuth2ClientCredentialSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OAuth2ClientCredentialSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OAuth2ClientCredentialSearchRequest)) {
            return false;
        }

        OAuth2ClientCredentialSearchRequest other = (OAuth2ClientCredentialSearchRequest) o;
