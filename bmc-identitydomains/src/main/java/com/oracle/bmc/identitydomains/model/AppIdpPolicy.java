...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AppIdpPolicy.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AppIdpPolicy extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref"})
    public AppIdpPolicy(String value, String ref) {
        super();
        this.value = value;
        this.ref = ref;
    }
    ...
    public static class Builder {
        ...
        public AppIdpPolicy build() {
            AppIdpPolicy model = new AppIdpPolicy(this.value, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AppIdpPolicy model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AppIdpPolicy)) {
            return false;
        }

        AppIdpPolicy other = (AppIdpPolicy) o;
