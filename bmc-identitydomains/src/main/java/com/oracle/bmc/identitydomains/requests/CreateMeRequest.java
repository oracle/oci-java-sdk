 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMeRequest.
 */
...
public class CreateMeRequest
    ...
    public static class Builder
        ...
        public CreateMeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateMeRequest(authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, me, opcRetryToken);
        }
    }
