...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateMeRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.Me> {
    ...
    public com.oracle.bmc.identitydomains.model.Me getBody$() {
        return me;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateMeRequest, com.oracle.bmc.identitydomains.model.Me> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.Me me = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateMeRequest o) {
         ...
         *
         * @return instance of CreateMeRequest
         */
        public CreateMeRequest build() {
            CreateMeRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.Me body) {
            me(body);
            return this;
        }
         ...
         * @return instance of CreateMeRequest
         */
        public CreateMeRequest buildWithoutInvocationCallback() {
            CreateMeRequest request = new CreateMeRequest();
            ...
            return request;
            // new CreateMeRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, me, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",me=").append(String.valueOf(this.me));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMeRequest)) {
            return false;
        }

        CreateMeRequest other = (CreateMeRequest) o;
