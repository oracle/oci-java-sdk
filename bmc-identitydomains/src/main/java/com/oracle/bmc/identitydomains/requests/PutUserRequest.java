 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutUserRequest.
 */
...
public class PutUserRequest
    ...
    public static class Builder
        ...
        public PutUserRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutUserRequest(userId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, user, ifMatch, opcRetryToken);
        }
    }
