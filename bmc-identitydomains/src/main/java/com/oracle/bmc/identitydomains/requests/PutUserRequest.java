...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutUserExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutUserRequest.
 */
...
public class PutUserRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutUserRequest, com.oracle.bmc.identitydomains.model.User> {
         ...
         * @return this builder instance
         */
        public Builder copy(PutUserRequest o) {
            userId(o.getUserId());
        ...
        /**
         * Build the instance of PutUserRequest as configured by this builder
         *
         ...
         *
         * @return instance of PutUserRequest
         */
        public PutUserRequest build() {
            PutUserRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutUserRequest
         */
        public PutUserRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutUserRequest(userId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, user, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutUserRequest)) {
            return false;
        }

        PutUserRequest other = (PutUserRequest) o;
