...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SelfRegistrationProfileHeaderText.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SelfRegistrationProfileHeaderText
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"locale", "value", "isDefault"})
    public SelfRegistrationProfileHeaderText(String locale, String value, Boolean isDefault) {
        super();
        this.locale = locale;
        this.value = value;
    ...
    public static class Builder {
        ...
        public SelfRegistrationProfileHeaderText build() {
            SelfRegistrationProfileHeaderText model =
                    new SelfRegistrationProfileHeaderText(this.locale, this.value, this.isDefault);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SelfRegistrationProfileHeaderText model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SelfRegistrationProfileHeaderText)) {
            return false;
        }

        SelfRegistrationProfileHeaderText other = (SelfRegistrationProfileHeaderText) o;
