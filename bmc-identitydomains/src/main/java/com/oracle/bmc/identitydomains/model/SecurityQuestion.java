...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SecurityQuestion.Builder.class)
...
public final class SecurityQuestion
    ...
    public SecurityQuestion(
            ...
            Boolean active,
            Type type,
            java.util.List<SecurityQuestionQuestionText> questionText) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
         ...
         * readWrite - required: true - returned: always - type: boolean - uniqueness: none
         */
         ...
         * mutability: readWrite - required: true - returned: always - idcsCompositeKey: [locale] -
         * type: complex - uniqueness: none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("questionText")
        private java.util.List<SecurityQuestionQuestionText> questionText;
         ...
         * @return this builder
         */
        public Builder questionText(java.util.List<SecurityQuestionQuestionText> questionText) {
            this.questionText = questionText;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SecurityQuestion model) {
    ...
    /**
     * This indicates if the question is selected by the Security Admin and is available for the end
     * user.
     *
     * <p>*SCIM++ Properties:** - idcsSearchable: true - multiValued: false - mutability: readWrite
     * - required: true - returned: always - type: boolean - uniqueness: none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("active")
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("questionText")
    private final java.util.List<SecurityQuestionQuestionText> questionText;
     ...
     * @return the value
     */
    public java.util.List<SecurityQuestionQuestionText> getQuestionText() {
        return questionText;
    }
