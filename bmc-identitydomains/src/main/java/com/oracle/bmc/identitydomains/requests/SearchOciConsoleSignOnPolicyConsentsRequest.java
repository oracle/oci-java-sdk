...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/SearchOciConsoleSignOnPolicyConsentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchOciConsoleSignOnPolicyConsentsRequest.
 */
...
public class SearchOciConsoleSignOnPolicyConsentsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of SearchOciConsoleSignOnPolicyConsentsRequest as configured by this builder
         *
        ...
        public SearchOciConsoleSignOnPolicyConsentsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchOciConsoleSignOnPolicyConsentsRequest(authorization, resourceTypeSchemaVersion, ociConsoleSignOnPolicyConsentSearchRequest, opcRetryToken, page, limit);
        }
    }
