...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchGroupRequest.
 */
...
public class PatchGroupRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PatchGroupRequest, com.oracle.bmc.identitydomains.model.PatchOp> {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchGroupRequest o) {
        ...
        /**
         * Build the instance of PatchGroupRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchGroupRequest
         */
        public PatchGroupRequest build() {
            PatchGroupRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchGroupRequest
         */
        public PatchGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchGroupRequest(groupId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchGroupRequest)) {
            return false;
        }

        PatchGroupRequest other = (PatchGroupRequest) o;
