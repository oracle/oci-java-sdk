 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchGroupRequest.
 */
...
public class PatchGroupRequest
    ...
    public static class Builder
        ...
        public PatchGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchGroupRequest(groupId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
