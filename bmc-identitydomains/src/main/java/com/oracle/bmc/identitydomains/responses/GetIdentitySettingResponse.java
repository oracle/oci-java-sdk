...
public class GetIdentitySettingResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetIdentitySettingResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetIdentitySettingResponse> {
         ...
         */
        @Override
        public Builder copy(GetIdentitySettingResponse o) {
         ...
         */
        @Override
        public GetIdentitySettingResponse build() {
            return new GetIdentitySettingResponse(
                    __httpStatusCode__, headers, opcRequestId, identitySetting);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",identitySetting=").append(String.valueOf(identitySetting));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIdentitySettingResponse)) {
            return false;
        }

        GetIdentitySettingResponse other = (GetIdentitySettingResponse) o;
