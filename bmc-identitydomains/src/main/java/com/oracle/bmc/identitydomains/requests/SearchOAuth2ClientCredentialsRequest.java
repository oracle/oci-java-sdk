...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/SearchOAuth2ClientCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SearchOAuth2ClientCredentialsRequest.
 */
...
public class SearchOAuth2ClientCredentialsRequest
    ...
    public static class Builder
        ...
        public SearchOAuth2ClientCredentialsRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new SearchOAuth2ClientCredentialsRequest(authorization, resourceTypeSchemaVersion, oAuth2ClientCredentialSearchRequest, opcRetryToken, page, limit);
        }
    }
