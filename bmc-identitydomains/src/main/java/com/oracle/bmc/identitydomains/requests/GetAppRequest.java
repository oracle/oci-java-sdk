...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetAppExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAppRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetAppRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<GetAppRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetAppRequest o) {
            appId(o.getAppId());
        ...
        /**
         * Build the instance of GetAppRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAppRequest
         */
        public GetAppRequest build() {
            GetAppRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAppRequest
         */
        public GetAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAppRequest(appId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAppRequest)) {
            return false;
        }

        GetAppRequest other = (GetAppRequest) o;
