 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAppRequest.
 */
...
public class GetAppRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetAppRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAppRequest(appId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, opcRetryToken);
        }
    }
