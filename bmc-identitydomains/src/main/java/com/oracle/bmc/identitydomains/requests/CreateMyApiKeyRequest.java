 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMyApiKeyRequest.
 */
...
public class CreateMyApiKeyRequest
    ...
    public static class Builder
        ...
        public CreateMyApiKeyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateMyApiKeyRequest(authorization, resourceTypeSchemaVersion, myApiKey,
            // opcRetryToken);
        }
    }
