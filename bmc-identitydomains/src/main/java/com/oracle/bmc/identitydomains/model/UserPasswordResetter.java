...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserPasswordResetter.Builder.class)
...
public final class UserPasswordResetter
    ...
    public static class Builder {
         ...
         *
         * <p>*SCIM++ Properties:** - type: boolean - caseExact: false - idcsSearchable: false -
         * multiValued: false - mutability: immutable - required: false - returned: never -
         * uniqueness: none
         */
        ...
        private UserPasswordResetterUserToken userToken;

        public Builder userToken(UserPasswordResetterUserToken userToken) {
            this.userToken = userToken;
        ...
        public UserPasswordResetter build() {
            UserPasswordResetter model =
                    new UserPasswordResetter(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserPasswordResetter model) {
            ...
            if (model.wasPropertyExplicitlySet("oneTimePassword")) {
                this.oneTimePassword(model.getOneTimePassword());
            }
     ...
     *
     * <p>*SCIM++ Properties:** - type: boolean - caseExact: false - idcsSearchable: false -
     * multiValued: false - mutability: immutable - required: false - returned: never - uniqueness:
     * none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("userFlowControlledByExternalClient")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("userToken")
    private final UserPasswordResetterUserToken userToken;

    public UserPasswordResetterUserToken getUserToken() {
        return userToken;
    }
    ...
    /**
     * A one time password will be returned when the user doesn&#39;t have a primary email address.
     * &lt;p&gt; *SCIM++ Properties:** - caseExact: false - idcsSearchable: false - multiValued:
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserPasswordResetter(");
        ...
        sb.append(", oneTimePassword=").append("<redacted>");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserPasswordResetter)) {
            return false;
        }

        UserPasswordResetter other = (UserPasswordResetter) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.oneTimePassword, other.oneTimePassword)
                && java.util.Objects.equals(
                        this.urnIetfParamsScimSchemasOracleIdcsExtensionSelfChangeUser,
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.oneTimePassword == null ? 43 : this.oneTimePassword.hashCode());
        result =
                (result * PRIME)
