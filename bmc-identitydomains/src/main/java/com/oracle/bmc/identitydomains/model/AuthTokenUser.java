...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AuthTokenUser.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AuthTokenUser extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ocid", "ref", "display", "name"})
    public AuthTokenUser(String value, String ocid, String ref, String display, String name) {
        super();
        this.value = value;
        this.ocid = ocid;
        this.ref = ref;
    ...
    public static class Builder {
        ...
        public AuthTokenUser build() {
            AuthTokenUser model =
                    new AuthTokenUser(this.value, this.ocid, this.ref, this.display, this.name);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AuthTokenUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AuthTokenUser)) {
            return false;
        }

        AuthTokenUser other = (AuthTokenUser) o;
