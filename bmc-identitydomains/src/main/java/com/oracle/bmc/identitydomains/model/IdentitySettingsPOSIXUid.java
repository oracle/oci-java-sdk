...
public final class IdentitySettingsPOSIXUid
    ...
    public static class Builder {
        ...
        public IdentitySettingsPOSIXUid build() {
            IdentitySettingsPOSIXUid model =
                    new IdentitySettingsPOSIXUid(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentitySettingsPOSIXUid model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentitySettingsPOSIXUid)) {
            return false;
        }

        IdentitySettingsPOSIXUid other = (IdentitySettingsPOSIXUid) o;
