...
public class ListGrantsConverter {
    ...
    public static com.oracle.bmc.identitydomains.requests.ListGrantsRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.ListGrantsRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.identitydomains.responses.ListGrantsResponse>() {
                            @Override
                            public com.oracle.bmc.identitydomains.responses.ListGrantsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.ListGrantsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.identitydomains.model.Grants
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.identitydomains.responses.ListGrantsResponse.Builder
                                        builder =
                                ...
                                builder.grants(response.getItem());
