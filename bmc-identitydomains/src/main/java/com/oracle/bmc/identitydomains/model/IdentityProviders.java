...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = IdentityProviders.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class IdentityProviders extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public IdentityProviders(
            ...
            java.util.List<IdentityProvider> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<IdentityProvider> resources;
         ...
         * @return this builder
         **/
        public Builder resources(java.util.List<IdentityProvider> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IdentityProviders model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<IdentityProvider> resources;

    /**
     * A multi-valued list of complex objects containing the requested resources. This MAY be a subset of the full set of resources if pagination is requested. REQUIRED if "totalResults" is non-zero.
     * @return the value
     **/
    public java.util.List<IdentityProvider> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IdentityProviders)) {
            return false;
        }

        IdentityProviders other = (IdentityProviders) o;
