...
public class ListCustomerSecretKeysConverter {
    ...
    public static com.oracle.bmc.identitydomains.requests.ListCustomerSecretKeysRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.ListCustomerSecretKeysRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("CustomerSecretKeys");
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.identitydomains.responses.ListCustomerSecretKeysResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.ListCustomerSecretKeysResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.customerSecretKeys(response.getItem());
