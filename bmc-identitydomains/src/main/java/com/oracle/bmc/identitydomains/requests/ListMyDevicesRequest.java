 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyDevicesRequest.
 */
...
public class ListMyDevicesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMyDevicesRequest buildWithoutInvocationCallback() {
            ...
            request.limit = limit;
            return request;
            // new ListMyDevicesRequest(filter, sortBy, sortOrder, startIndex, count, attributes,
