...
public class CreateAuthTokenConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateAuthTokenConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreateAuthTokenRequest interceptRequest(
            com.oracle.bmc.identitydomains.requests.CreateAuthTokenRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("AuthTokens");
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.identitydomains.responses.CreateAuthTokenResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreateAuthTokenResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
