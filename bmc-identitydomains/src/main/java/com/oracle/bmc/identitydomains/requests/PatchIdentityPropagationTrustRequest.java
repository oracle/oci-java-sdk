...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PatchIdentityPropagationTrustExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchIdentityPropagationTrustRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PatchIdentityPropagationTrustRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(PatchIdentityPropagationTrustRequest o) {
        ...
        /**
         * Build the instance of PatchIdentityPropagationTrustRequest as configured by this builder
         *
         ...
         *
         * @return instance of PatchIdentityPropagationTrustRequest
         */
        public PatchIdentityPropagationTrustRequest build() {
            PatchIdentityPropagationTrustRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PatchIdentityPropagationTrustRequest
         */
        public PatchIdentityPropagationTrustRequest buildWithoutInvocationCallback() {
            PatchIdentityPropagationTrustRequest request =
                    new PatchIdentityPropagationTrustRequest();
            ...
            return request;
            // new PatchIdentityPropagationTrustRequest(identityPropagationTrustId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, patchOp, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchIdentityPropagationTrustRequest)) {
            return false;
        }

        PatchIdentityPropagationTrustRequest other = (PatchIdentityPropagationTrustRequest) o;
