...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SchemaSearchRequest.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class SchemaSearchRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SchemaSearchRequest build() {
            SchemaSearchRequest model =
                    new SchemaSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.sortBy,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SchemaSearchRequest model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SchemaSearchRequest)) {
            return false;
        }

        SchemaSearchRequest other = (SchemaSearchRequest) o;
