...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MyApps.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MyApps extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public MyApps(
            ...
            java.util.List<MyApp> resources,
            Integer startIndex,
    ...
    public static class Builder {
        ...
        private java.util.List<MyApp> resources;
         ...
         * @return this builder
         */
        public Builder resources(java.util.List<MyApp> resources) {
            this.resources = resources;
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MyApps model) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("Resources")
    private final java.util.List<MyApp> resources;
     ...
     * @return the value
     */
    public java.util.List<MyApp> getResources() {
        return resources;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyApps)) {
            return false;
        }

        MyApps other = (MyApps) o;
