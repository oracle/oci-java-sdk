...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserPasswordResetterUserToken.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UserPasswordResetterUserToken
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref"})
    public UserPasswordResetterUserToken(String value, String ref) {
        super();
        this.value = value;
        this.ref = ref;
    }
    ...
    public static class Builder {
        ...
        public UserPasswordResetterUserToken build() {
            UserPasswordResetterUserToken model =
                    new UserPasswordResetterUserToken(this.value, this.ref);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserPasswordResetterUserToken model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserPasswordResetterUserToken(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserPasswordResetterUserToken)) {
            return false;
        }

        UserPasswordResetterUserToken other = (UserPasswordResetterUserToken) o;
