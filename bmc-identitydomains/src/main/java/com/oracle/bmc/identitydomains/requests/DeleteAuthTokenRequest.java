...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAuthTokenRequest.
 */
...
public class DeleteAuthTokenRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteAuthTokenRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteAuthTokenRequest(authTokenId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
