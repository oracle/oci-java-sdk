...
/**
 * Matching owning users of the account <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AccountMgmtInfoMatchingOwners.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AccountMgmtInfoMatchingOwners
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "ref", "display", "userName", "email"})
    public AccountMgmtInfoMatchingOwners(
            String value, String ref, String display, String userName, String email) {
        super();
        this.value = value;
        this.ref = ref;
    ...
    public static class Builder {
         ...
         * User display name
         *
         * <p>*SCIM++ Properties:** - idcsPii: true - idcsSearchable: false - multiValued: false -
        ...
        public AccountMgmtInfoMatchingOwners build() {
            AccountMgmtInfoMatchingOwners model =
                    new AccountMgmtInfoMatchingOwners(
                            this.value, this.ref, this.display, this.userName, this.email);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AccountMgmtInfoMatchingOwners model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AccountMgmtInfoMatchingOwners(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountMgmtInfoMatchingOwners)) {
            return false;
        }

        AccountMgmtInfoMatchingOwners other = (AccountMgmtInfoMatchingOwners) o;
