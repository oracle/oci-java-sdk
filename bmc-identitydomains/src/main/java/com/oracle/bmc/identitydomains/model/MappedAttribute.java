...
/**
 * Schema for MappedAttribute resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MappedAttribute.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MappedAttribute
    ...
    public MappedAttribute(
            ...
            Direction direction,
            java.util.List<MappedAttributeAttributeMappings> attributeMappings) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
         ...
         * none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("idcsResourceType")
        private IdcsResourceType idcsResourceType;
         ...
         * none
         *
         * @param idcsResourceType the value to set
         * @return this builder
         */
        public Builder idcsResourceType(IdcsResourceType idcsResourceType) {
            this.idcsResourceType = idcsResourceType;
            this.__explicitlySet__.add("idcsResourceType");
            return this;
        }
        /**
         ...
         * none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("refResourceType")
        private RefResourceType refResourceType;
         ...
         * none
         *
         * @param refResourceType the value to set
         * @return this builder
         */
        public Builder refResourceType(RefResourceType refResourceType) {
            this.refResourceType = refResourceType;
            this.__explicitlySet__.add("refResourceType");
            return this;
        }
        /**
         ...
         * none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("refResourceID")
         ...
         * none
         *
         * @param refResourceID the value to set
         * @return this builder
         */
        public Builder refResourceID(String refResourceID) {
            this.refResourceID = refResourceID;
            this.__explicitlySet__.add("refResourceID");
            return this;
        }
        /**
         * Direction of the attribute mapping. inbound indicates mapping is from source
         * ManagedObjectClass to Oracle Identity Cloud Service ResourceType. outbound indicates
         * mapping is from Oracle Identity Cloud Service Resource Type to target ManagedObjectClass.
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
         * mutability: immutable - required: true - returned: default - type: string - uniqueness:
         * none
        ...
        /**
         * A list of attribute mappings between Oracle Identity Cloud Service Resource Type and
         * Account Object Class
         *
         * <p>*SCIM++ Properties:** - idcsCompositeKey: [idcsAttributeName,
         * managedObjectAttributeName] - idcsSearchable: true - multiValued: true - mutability:
         * readWrite - required: false - returned: default - type: complex - uniqueness: none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("attributeMappings")
        private java.util.List<MappedAttributeAttributeMappings> attributeMappings;
         ...
         * readWrite - required: false - returned: default - type: complex - uniqueness: none
         *
         * @param attributeMappings the value to set
         * @return this builder
         */
        public Builder attributeMappings(
                java.util.List<MappedAttributeAttributeMappings> attributeMappings) {
            this.attributeMappings = attributeMappings;
            this.__explicitlySet__.add("attributeMappings");
            return this;
        }
        ...
        public MappedAttribute build() {
            MappedAttribute model =
                    new MappedAttribute(
                            ...
                            this.tenancyOcid,
                            this.idcsResourceType,
                            this.refResourceType,
                            this.refResourceID,
                            this.direction,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MappedAttribute model) {
            ...
            if (model.wasPropertyExplicitlySet("idcsResourceType")) {
                this.idcsResourceType(model.getIdcsResourceType());
            }
            if (model.wasPropertyExplicitlySet("refResourceType")) {
                this.refResourceType(model.getRefResourceType());
            }
            if (model.wasPropertyExplicitlySet("refResourceID")) {
                this.refResourceID(model.getRefResourceID());
            }
            if (model.wasPropertyExplicitlySet("direction")) {
                this.direction(model.getDirection());
            }
            if (model.wasPropertyExplicitlySet("attributeMappings")) {
                this.attributeMappings(model.getAttributeMappings());
            }
            return this;
        }
    }
     ...
     */
    public enum IdcsResourceType implements com.oracle.bmc.http.internal.BmcEnum {
        User("User"),
        Group("Group"),
        Container("Container"),
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(IdcsResourceType.class);

        private final String value;
        private static java.util.Map<String, IdcsResourceType> map;

        static {
            map = new java.util.HashMap<>();
            for (IdcsResourceType v : IdcsResourceType.values()) {
        ...
        public static IdcsResourceType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'IdcsResourceType', returning UnknownEnumValue",
                    key);
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("idcsResourceType")
    private final IdcsResourceType idcsResourceType;
     ...
     * @return the value
     */
    public IdcsResourceType getIdcsResourceType() {
        return idcsResourceType;
    }
     ...
     */
    public enum RefResourceType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(RefResourceType.class);

        private final String value;
        private static java.util.Map<String, RefResourceType> map;

        static {
            map = new java.util.HashMap<>();
            for (RefResourceType v : RefResourceType.values()) {
                if (v != UnknownEnumValue) {
                    map.put(v.getValue(), v);
                }
            }
        ...
        @com.fasterxml.jackson.annotation.JsonCreator
        public static RefResourceType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'RefResourceType', returning UnknownEnumValue",
                    key);
            return UnknownEnumValue;
        }
    };
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("refResourceType")
    private final RefResourceType refResourceType;
     ...
     * @return the value
     */
    public RefResourceType getRefResourceType() {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("refResourceID")
    private final String refResourceID;
    ...
    /**
     * Direction of the attribute mapping. inbound indicates mapping is from source
     * ManagedObjectClass to Oracle Identity Cloud Service ResourceType. outbound indicates mapping
     * is from Oracle Identity Cloud Service Resource Type to target ManagedObjectClass.
     *
     * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
     * mutability: immutable - required: true - returned: default - type: string - uniqueness: none
     */
     ...
     * Object Class
     *
     * <p>*SCIM++ Properties:** - idcsCompositeKey: [idcsAttributeName, managedObjectAttributeName]
     * - idcsSearchable: true - multiValued: true - mutability: readWrite - required: false -
     * returned: default - type: complex - uniqueness: none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("attributeMappings")
    private final java.util.List<MappedAttributeAttributeMappings> attributeMappings;
     ...
     * @return the value
     */
    public java.util.List<MappedAttributeAttributeMappings> getAttributeMappings() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", idcsResourceType=").append(String.valueOf(this.idcsResourceType));
        sb.append(", refResourceType=").append(String.valueOf(this.refResourceType));
        sb.append(", refResourceID=").append(String.valueOf(this.refResourceID));
        sb.append(", direction=").append(String.valueOf(this.direction));
        sb.append(", attributeMappings=").append(String.valueOf(this.attributeMappings));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MappedAttribute)) {
            return false;
        }

        MappedAttribute other = (MappedAttribute) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.idcsResourceType, other.idcsResourceType)
                && java.util.Objects.equals(this.refResourceType, other.refResourceType)
                && java.util.Objects.equals(this.refResourceID, other.refResourceID)
                && java.util.Objects.equals(this.direction, other.direction)
                && java.util.Objects.equals(this.attributeMappings, other.attributeMappings)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.idcsResourceType == null ? 43 : this.idcsResourceType.hashCode());
        result =
                (result * PRIME)
                        + (this.refResourceType == null ? 43 : this.refResourceType.hashCode());
        result =
                (result * PRIME)
                        + (this.refResourceID == null ? 43 : this.refResourceID.hashCode());
        result = (result * PRIME) + (this.direction == null ? 43 : this.direction.hashCode());
        result =
                (result * PRIME)
                        + (this.attributeMappings == null ? 43 : this.attributeMappings.hashCode());
