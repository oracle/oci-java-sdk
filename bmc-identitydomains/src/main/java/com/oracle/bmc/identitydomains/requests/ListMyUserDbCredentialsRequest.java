...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListMyUserDbCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMyUserDbCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListMyUserDbCredentialsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListMyUserDbCredentialsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListMyUserDbCredentialsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListMyUserDbCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListMyUserDbCredentialsRequest
         */
        public ListMyUserDbCredentialsRequest build() {
            ListMyUserDbCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListMyUserDbCredentialsRequest
         */
        public ListMyUserDbCredentialsRequest buildWithoutInvocationCallback() {
            ListMyUserDbCredentialsRequest request = new ListMyUserDbCredentialsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListMyUserDbCredentialsRequest(filter, sortBy, sortOrder, startIndex, count, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListMyUserDbCredentialsRequest)) {
            return false;
        }

        ListMyUserDbCredentialsRequest other = (ListMyUserDbCredentialsRequest) o;
