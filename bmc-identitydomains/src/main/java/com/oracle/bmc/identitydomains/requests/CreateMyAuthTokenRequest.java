...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMyAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMyAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateMyAuthTokenRequest
    ...
    public com.oracle.bmc.identitydomains.model.MyAuthToken getBody$() {
        return myAuthToken;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateMyAuthTokenRequest, com.oracle.bmc.identitydomains.model.MyAuthToken> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.MyAuthToken myAuthToken = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateMyAuthTokenRequest o) {
        ...
        /**
         * Build the instance of CreateMyAuthTokenRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateMyAuthTokenRequest
         */
        public CreateMyAuthTokenRequest build() {
            CreateMyAuthTokenRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.MyAuthToken body) {
            myAuthToken(body);
            return this;
        }
         ...
         * @return instance of CreateMyAuthTokenRequest
         */
        public CreateMyAuthTokenRequest buildWithoutInvocationCallback() {
            CreateMyAuthTokenRequest request = new CreateMyAuthTokenRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.myAuthToken = myAuthToken;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateMyAuthTokenRequest(authorization, resourceTypeSchemaVersion, myAuthToken, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",myAuthToken=").append(String.valueOf(this.myAuthToken));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMyAuthTokenRequest)) {
            return false;
        }

        CreateMyAuthTokenRequest other = (CreateMyAuthTokenRequest) o;
