...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeletePasswordPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeletePasswordPolicyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeletePasswordPolicyRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeletePasswordPolicyRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeletePasswordPolicyRequest o) {
        ...
        /**
         * Build the instance of DeletePasswordPolicyRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeletePasswordPolicyRequest
         */
        public DeletePasswordPolicyRequest build() {
            DeletePasswordPolicyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeletePasswordPolicyRequest
         */
        public DeletePasswordPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeletePasswordPolicyRequest(passwordPolicyId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeletePasswordPolicyRequest)) {
            return false;
        }

        DeletePasswordPolicyRequest other = (DeletePasswordPolicyRequest) o;
