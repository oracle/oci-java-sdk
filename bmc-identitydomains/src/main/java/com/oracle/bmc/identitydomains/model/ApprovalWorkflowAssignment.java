...
/**
 * Schema for ApprovalWorkflowAssignment <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApprovalWorkflowAssignment.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ApprovalWorkflowAssignment
    ...
    public ApprovalWorkflowAssignment(
            String id,
            String ocid,
            ...
            ApprovalWorkflowAssignmentApprovalWorkflow approvalWorkflow,
            ApprovalWorkflowAssignmentAssignedTo assignedTo) {
        super();
        this.id = id;
        this.ocid = ocid;
    ...
    public static class Builder {
        ...
        /**
         * Type of approval workflow assignment to the resource. Resources like Group have only one
         * workflow associated (default assignment type is membership), but resources like
         * TemporalBusinessRole can have atleast 2 AWs attached, one for membership to TPR, another
         * for activation of that TPR membership
         *
         * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
         * mutability: readWrite - required: true - returned: default - type: string - uniqueness:
         * none
         */
        @com.fasterxml.jackson.annotation.JsonProperty("assignmentType")
         ...
         * none
         *
         * @param assignmentType the value to set
         * @return this builder
         */
        public Builder assignmentType(AssignmentType assignmentType) {
            this.assignmentType = assignmentType;
            this.__explicitlySet__.add("assignmentType");
            return this;
        }

        @com.fasterxml.jackson.annotation.JsonProperty("approvalWorkflow")
        private ApprovalWorkflowAssignmentApprovalWorkflow approvalWorkflow;

        public Builder approvalWorkflow(
                ApprovalWorkflowAssignmentApprovalWorkflow approvalWorkflow) {
            this.approvalWorkflow = approvalWorkflow;
            this.__explicitlySet__.add("approvalWorkflow");
            return this;
        }

        @com.fasterxml.jackson.annotation.JsonProperty("assignedTo")
        private ApprovalWorkflowAssignmentAssignedTo assignedTo;

        public Builder assignedTo(ApprovalWorkflowAssignmentAssignedTo assignedTo) {
            this.assignedTo = assignedTo;
            this.__explicitlySet__.add("assignedTo");
            return this;
        }
        ...
        public ApprovalWorkflowAssignment build() {
            ApprovalWorkflowAssignment model =
                    new ApprovalWorkflowAssignment(
                            this.id,
                            this.ocid,
                            this.schemas,
                            this.meta,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApprovalWorkflowAssignment model) {
            ...
            if (model.wasPropertyExplicitlySet("assignmentType")) {
                this.assignmentType(model.getAssignmentType());
            }
            if (model.wasPropertyExplicitlySet("approvalWorkflow")) {
                this.approvalWorkflow(model.getApprovalWorkflow());
            }
            if (model.wasPropertyExplicitlySet("assignedTo")) {
     ...
     * Type of approval workflow assignment to the resource. Resources like Group have only one
     * workflow associated (default assignment type is membership), but resources like
     * TemporalBusinessRole can have atleast 2 AWs attached, one for membership to TPR, another for
     * activation of that TPR membership
     *
     * <p>*SCIM++ Properties:** - caseExact: true - idcsSearchable: true - multiValued: false -
     * mutability: readWrite - required: true - returned: default - type: string - uniqueness: none
     */
    public enum AssignmentType implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG =
                org.slf4j.LoggerFactory.getLogger(AssignmentType.class);

        private final String value;
        private static java.util.Map<String, AssignmentType> map;

        static {
            map = new java.util.HashMap<>();
            for (AssignmentType v : AssignmentType.values()) {
        ...
        public static AssignmentType create(String key) {
            if (map.containsKey(key)) {
                return map.get(key);
            }
            LOG.warn(
                    "Received unknown value '{}' for enum 'AssignmentType', returning UnknownEnumValue",
                    key);
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("approvalWorkflow")
    private final ApprovalWorkflowAssignmentApprovalWorkflow approvalWorkflow;

    public ApprovalWorkflowAssignmentApprovalWorkflow getApprovalWorkflow() {
        return approvalWorkflow;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("assignedTo")
    private final ApprovalWorkflowAssignmentAssignedTo assignedTo;

    public ApprovalWorkflowAssignmentAssignedTo getAssignedTo() {
        return assignedTo;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", assignmentType=").append(String.valueOf(this.assignmentType));
        sb.append(", approvalWorkflow=").append(String.valueOf(this.approvalWorkflow));
        sb.append(", assignedTo=").append(String.valueOf(this.assignedTo));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApprovalWorkflowAssignment)) {
            return false;
        }

        ApprovalWorkflowAssignment other = (ApprovalWorkflowAssignment) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.assignmentType, other.assignmentType)
                && java.util.Objects.equals(this.approvalWorkflow, other.approvalWorkflow)
                && java.util.Objects.equals(this.assignedTo, other.assignedTo)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.assignmentType == null ? 43 : this.assignmentType.hashCode());
        result =
                (result * PRIME)
                        + (this.approvalWorkflow == null ? 43 : this.approvalWorkflow.hashCode());
        result = (result * PRIME) + (this.assignedTo == null ? 43 : this.assignedTo.hashCode());
