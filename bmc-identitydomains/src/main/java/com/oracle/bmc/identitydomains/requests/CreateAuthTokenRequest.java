...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateAuthTokenExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateAuthTokenRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateAuthTokenRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.AuthToken> {
    ...
    public com.oracle.bmc.identitydomains.model.AuthToken getBody$() {
        return authToken;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateAuthTokenRequest, com.oracle.bmc.identitydomains.model.AuthToken> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.AuthToken authToken = null;
         ...
         * @return this builder instance
         */
        public Builder authToken(com.oracle.bmc.identitydomains.model.AuthToken authToken) {
        ...
        public CreateAuthTokenRequest build() {
            CreateAuthTokenRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.AuthToken body) {
            authToken(body);
            return this;
        }
        ...
        public CreateAuthTokenRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateAuthTokenRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, authToken, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAuthTokenRequest)) {
            return false;
        }
