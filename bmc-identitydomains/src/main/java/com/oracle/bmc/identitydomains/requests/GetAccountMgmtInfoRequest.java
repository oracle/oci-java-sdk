...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/GetAccountMgmtInfoExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAccountMgmtInfoRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class GetAccountMgmtInfoRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     * ID of the resource
     */
    public String getAccountMgmtInfoId() {
        return accountMgmtInfoId;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAccountMgmtInfoRequest, java.lang.Void> {
         ...
         * ID of the resource
         */
        private String accountMgmtInfoId = null;

        /**
         * ID of the resource
         * @param accountMgmtInfoId the value to set
         ...
         * @return this builder instance
         */
        public Builder copy(GetAccountMgmtInfoRequest o) {
            accountMgmtInfoId(o.getAccountMgmtInfoId());
        ...
        /**
         * Build the instance of GetAccountMgmtInfoRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetAccountMgmtInfoRequest
         */
        public GetAccountMgmtInfoRequest build() {
            GetAccountMgmtInfoRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetAccountMgmtInfoRequest
         */
        public GetAccountMgmtInfoRequest buildWithoutInvocationCallback() {
            GetAccountMgmtInfoRequest request = new GetAccountMgmtInfoRequest();
            request.accountMgmtInfoId = accountMgmtInfoId;
            ...
            return request;
            // new GetAccountMgmtInfoRequest(accountMgmtInfoId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",accountMgmtInfoId=").append(String.valueOf(this.accountMgmtInfoId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAccountMgmtInfoRequest)) {
            return false;
        }

        GetAccountMgmtInfoRequest other = (GetAccountMgmtInfoRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.accountMgmtInfoId, other.accountMgmtInfoId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.accountMgmtInfoId == null ? 43 : this.accountMgmtInfoId.hashCode());
        result =
                (result * PRIME)
