...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreatePasswordPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreatePasswordPolicyRequest.
 */
...
public class CreatePasswordPolicyRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreatePasswordPolicyRequest o) {
        ...
        /**
         * Build the instance of CreatePasswordPolicyRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreatePasswordPolicyRequest
         */
        public CreatePasswordPolicyRequest build() {
            CreatePasswordPolicyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of CreatePasswordPolicyRequest
         */
        public CreatePasswordPolicyRequest buildWithoutInvocationCallback() {
            CreatePasswordPolicyRequest request = new CreatePasswordPolicyRequest();
            ...
            return request;
            // new CreatePasswordPolicyRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, passwordPolicy, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatePasswordPolicyRequest)) {
            return false;
        }

        CreatePasswordPolicyRequest other = (CreatePasswordPolicyRequest) o;
