...
public class GetPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "headers", "opcRequestId", "policy"})
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPolicyResponse> {
        ...
        public GetPolicyResponse build() {
            return new GetPolicyResponse(__httpStatusCode__, headers, opcRequestId, policy);
        }
    }
