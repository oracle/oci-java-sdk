 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutMeRequest.
 */
...
public class PutMeRequest
    ...
    public static class Builder
        ...
        public PutMeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutMeRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets,
            // me, ifMatch, opcRetryToken);
        }
    }
