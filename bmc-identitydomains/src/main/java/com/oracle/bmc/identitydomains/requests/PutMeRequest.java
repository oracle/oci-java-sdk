...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutMeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutMeRequest.
 */
...
public class PutMeRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutMeRequest, com.oracle.bmc.identitydomains.model.Me> {
         ...
         * @return this builder instance
         */
        public Builder copy(PutMeRequest o) {
         ...
         *
         * @return instance of PutMeRequest
         */
        public PutMeRequest build() {
            PutMeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of PutMeRequest
         */
        public PutMeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutMeRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, me, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutMeRequest)) {
            return false;
        }

        PutMeRequest other = (PutMeRequest) o;
