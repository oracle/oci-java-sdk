...
public class GetBrandingSettingConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetBrandingSettingConverter.class);

    public static com.oracle.bmc.identitydomains.requests.GetBrandingSettingRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.GetBrandingSettingRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("admin")
                        .path("v1")
                        .path("BrandingSettings")
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getBrandingSettingId()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.GetBrandingSettingResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.GetBrandingSettingResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .GetBrandingSettingResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.brandingSetting(response.getItem());
