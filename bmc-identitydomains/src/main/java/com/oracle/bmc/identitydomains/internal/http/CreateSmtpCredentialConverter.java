...
public class CreateSmtpCredentialConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateSmtpCredentialConverter.class);

    public static com.oracle.bmc.identitydomains.requests.CreateSmtpCredentialRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.CreateSmtpCredentialRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("").path("admin").path("v1").path("SmtpCredentials");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.CreateSmtpCredentialResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.http.internal.WithHeaders<
                                                com.oracle.bmc.identitydomains.model.SmtpCredential>
