...
public class CreateApprovalWorkflowStepResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned ApprovalWorkflowStep instance.
     */
    ...
    private CreateApprovalWorkflowStepResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateApprovalWorkflowStepResponse o) {
         ...
         */
        public CreateApprovalWorkflowStepResponse build() {
            return new CreateApprovalWorkflowStepResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApprovalWorkflowStepResponse)) {
            return false;
        }

        CreateApprovalWorkflowStepResponse other = (CreateApprovalWorkflowStepResponse) o;
