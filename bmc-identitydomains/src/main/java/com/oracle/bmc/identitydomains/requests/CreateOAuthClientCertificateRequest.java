...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateOAuthClientCertificateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOAuthClientCertificateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateOAuthClientCertificateRequest
    ...
    public com.oracle.bmc.identitydomains.model.OAuthClientCertificate getBody$() {
        return oAuthClientCertificate;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateOAuthClientCertificateRequest o) {
         ...
         *
         * @return instance of CreateOAuthClientCertificateRequest
         */
        public CreateOAuthClientCertificateRequest build() {
            CreateOAuthClientCertificateRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.OAuthClientCertificate body) {
            oAuthClientCertificate(body);
            return this;
        }
         ...
         * @return instance of CreateOAuthClientCertificateRequest
         */
        public CreateOAuthClientCertificateRequest buildWithoutInvocationCallback() {
            CreateOAuthClientCertificateRequest request = new CreateOAuthClientCertificateRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.oAuthClientCertificate = oAuthClientCertificate;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateOAuthClientCertificateRequest(authorization, resourceTypeSchemaVersion, oAuthClientCertificate, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",oAuthClientCertificate=").append(String.valueOf(this.oAuthClientCertificate));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOAuthClientCertificateRequest)) {
            return false;
        }

        CreateOAuthClientCertificateRequest other = (CreateOAuthClientCertificateRequest) o;
