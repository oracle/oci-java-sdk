...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/PutPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PutPolicyRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class PutPolicyRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.Policy> {
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.Policy policy;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.Policy getPolicy() {
        return policy;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.Policy getBody$() {
        return policy;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    PutPolicyRequest, com.oracle.bmc.identitydomains.model.Policy> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.Policy policy = null;
         ...
         * @return this builder instance
         */
        public Builder policy(com.oracle.bmc.identitydomains.model.Policy policy) {
            this.policy = policy;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(PutPolicyRequest o) {
         ...
         *
         * @return instance of PutPolicyRequest
         */
        public PutPolicyRequest build() {
            PutPolicyRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.Policy body) {
            policy(body);
            return this;
        }
         ...
         * @return instance of PutPolicyRequest
         */
        public PutPolicyRequest buildWithoutInvocationCallback() {
            PutPolicyRequest request = new PutPolicyRequest();
            ...
            return request;
            // new PutPolicyRequest(policyId, authorization, resourceTypeSchemaVersion, attributes, attributeSets, policy, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PutPolicyRequest)) {
            return false;
        }
