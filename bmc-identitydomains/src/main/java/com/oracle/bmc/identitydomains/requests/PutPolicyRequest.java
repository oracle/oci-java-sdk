 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutPolicyRequest.
 */
...
public class PutPolicyRequest
    ...
    public static class Builder
        ...
        public PutPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutPolicyRequest(policyId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, policy, ifMatch, opcRetryToken);
        }
    }
