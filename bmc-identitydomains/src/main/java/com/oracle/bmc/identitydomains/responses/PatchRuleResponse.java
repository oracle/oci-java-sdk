...
public class PatchRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PatchRuleResponse> {
         ...
         */
        @Override
        public Builder copy(PatchRuleResponse o) {
        ...
        public PatchRuleResponse build() {
            return new PatchRuleResponse(__httpStatusCode__, headers, opcRequestId, etag, rule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchRuleResponse)) {
            return false;
        }
