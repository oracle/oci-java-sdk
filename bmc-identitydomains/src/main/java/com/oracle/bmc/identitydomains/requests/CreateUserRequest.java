...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateUserExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateUserRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateUserRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.User> {
     ...
     *
     */
    private com.oracle.bmc.identitydomains.model.User user;
     ...
     *
     */
    public com.oracle.bmc.identitydomains.model.User getUser() {
        return user;
    }
    /**
    ...
    public com.oracle.bmc.identitydomains.model.User getBody$() {
        return user;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateUserRequest, com.oracle.bmc.identitydomains.model.User> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.User user = null;
         ...
         * @return this builder instance
         */
        public Builder user(com.oracle.bmc.identitydomains.model.User user) {
            this.user = user;
            return this;
        }
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.User body) {
            user(body);
            return this;
        }
        ...
        public CreateUserRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateUserRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, user, opcRetryToken);
        }
    }
