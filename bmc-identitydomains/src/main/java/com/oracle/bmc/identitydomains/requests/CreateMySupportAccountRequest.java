...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateMySupportAccountExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateMySupportAccountRequest.
 */
...
public class CreateMySupportAccountRequest
    ...
    public static class Builder
        ...
        public CreateMySupportAccountRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateMySupportAccountRequest(authorization, resourceTypeSchemaVersion, mySupportAccount, opcRetryToken);
        }
    }
