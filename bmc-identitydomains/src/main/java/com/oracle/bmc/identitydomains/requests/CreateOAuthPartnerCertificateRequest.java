...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateOAuthPartnerCertificateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateOAuthPartnerCertificateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateOAuthPartnerCertificateRequest
    ...
    public com.oracle.bmc.identitydomains.model.OAuthPartnerCertificate getBody$() {
        return oAuthPartnerCertificate;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateOAuthPartnerCertificateRequest o) {
        ...
        /**
         * Build the instance of CreateOAuthPartnerCertificateRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateOAuthPartnerCertificateRequest
         */
        public CreateOAuthPartnerCertificateRequest build() {
            CreateOAuthPartnerCertificateRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.OAuthPartnerCertificate body) {
            oAuthPartnerCertificate(body);
            return this;
        }
         ...
         * @return instance of CreateOAuthPartnerCertificateRequest
         */
        public CreateOAuthPartnerCertificateRequest buildWithoutInvocationCallback() {
            CreateOAuthPartnerCertificateRequest request =
                    new CreateOAuthPartnerCertificateRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.oAuthPartnerCertificate = oAuthPartnerCertificate;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateOAuthPartnerCertificateRequest(authorization, resourceTypeSchemaVersion, oAuthPartnerCertificate, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",oAuthPartnerCertificate=").append(String.valueOf(this.oAuthPartnerCertificate));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOAuthPartnerCertificateRequest)) {
            return false;
        }

        CreateOAuthPartnerCertificateRequest other = (CreateOAuthPartnerCertificateRequest) o;
