 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use PutGroupRequest.
 */
...
public class PutGroupRequest
    ...
    public static class Builder
        ...
        public PutGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PutGroupRequest(groupId, authorization, resourceTypeSchemaVersion, attributes,
            // attributeSets, group, ifMatch, opcRetryToken);
        }
    }
