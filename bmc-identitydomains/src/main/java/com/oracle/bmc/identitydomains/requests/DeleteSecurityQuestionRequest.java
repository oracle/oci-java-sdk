...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteSecurityQuestionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSecurityQuestionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteSecurityQuestionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteSecurityQuestionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteSecurityQuestionRequest o) {
        ...
        /**
         * Build the instance of DeleteSecurityQuestionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSecurityQuestionRequest
         */
        public DeleteSecurityQuestionRequest build() {
            DeleteSecurityQuestionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteSecurityQuestionRequest
         */
        public DeleteSecurityQuestionRequest buildWithoutInvocationCallback() {
            DeleteSecurityQuestionRequest request = new DeleteSecurityQuestionRequest();
            ...
            return request;
            // new DeleteSecurityQuestionRequest(securityQuestionId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSecurityQuestionRequest)) {
            return false;
        }

        DeleteSecurityQuestionRequest other = (DeleteSecurityQuestionRequest) o;
