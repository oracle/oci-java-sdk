...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/ListUserDbCredentialsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUserDbCredentialsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class ListUserDbCredentialsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListUserDbCredentialsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListUserDbCredentialsRequest o) {
            filter(o.getFilter());
            sortBy(o.getSortBy());
        ...
        /**
         * Build the instance of ListUserDbCredentialsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListUserDbCredentialsRequest
         */
        public ListUserDbCredentialsRequest build() {
            ListUserDbCredentialsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUserDbCredentialsRequest
         */
        public ListUserDbCredentialsRequest buildWithoutInvocationCallback() {
            ListUserDbCredentialsRequest request = new ListUserDbCredentialsRequest();
            ...
            request.limit = limit;
            return request;
            // new ListUserDbCredentialsRequest(filter, sortBy, sortOrder, startIndex, count, attributes, attributeSets, authorization, resourceTypeSchemaVersion, opcRetryToken, page, limit);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUserDbCredentialsRequest)) {
            return false;
        }

        ListUserDbCredentialsRequest other = (ListUserDbCredentialsRequest) o;
