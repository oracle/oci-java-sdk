...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/DeleteNetworkPerimeterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteNetworkPerimeterRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class DeleteNetworkPerimeterRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteNetworkPerimeterRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteNetworkPerimeterRequest o) {
        ...
        /**
         * Build the instance of DeleteNetworkPerimeterRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteNetworkPerimeterRequest
         */
        public DeleteNetworkPerimeterRequest build() {
            DeleteNetworkPerimeterRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteNetworkPerimeterRequest
         */
        public DeleteNetworkPerimeterRequest buildWithoutInvocationCallback() {
            DeleteNetworkPerimeterRequest request = new DeleteNetworkPerimeterRequest();
            ...
            return request;
            // new DeleteNetworkPerimeterRequest(networkPerimeterId, authorization, resourceTypeSchemaVersion, forceDelete, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteNetworkPerimeterRequest)) {
            return false;
        }

        DeleteNetworkPerimeterRequest other = (DeleteNetworkPerimeterRequest) o;
