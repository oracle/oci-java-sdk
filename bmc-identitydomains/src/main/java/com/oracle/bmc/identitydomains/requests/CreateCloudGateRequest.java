...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/identitydomains/CreateCloudGateExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCloudGateRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: v1")
public class CreateCloudGateRequest
        extends com.oracle.bmc.requests.BmcRequest<com.oracle.bmc.identitydomains.model.CloudGate> {
    ...
    public com.oracle.bmc.identitydomains.model.CloudGate getBody$() {
        return cloudGate;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    CreateCloudGateRequest, com.oracle.bmc.identitydomains.model.CloudGate> {
         ...
         *
         */
        private com.oracle.bmc.identitydomains.model.CloudGate cloudGate = null;
         ...
         * @return this builder instance
         */
        public Builder copy(CreateCloudGateRequest o) {
         ...
         *
         * @return instance of CreateCloudGateRequest
         */
        public CreateCloudGateRequest build() {
            CreateCloudGateRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.identitydomains.model.CloudGate body) {
            cloudGate(body);
            return this;
        }
         ...
         * @return instance of CreateCloudGateRequest
         */
        public CreateCloudGateRequest buildWithoutInvocationCallback() {
            CreateCloudGateRequest request = new CreateCloudGateRequest();
            request.authorization = authorization;
            request.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            request.attributes = attributes;
            request.attributeSets = attributeSets;
            request.cloudGate = cloudGate;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateCloudGateRequest(authorization, resourceTypeSchemaVersion, attributes, attributeSets, cloudGate, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCloudGateRequest)) {
            return false;
        }

        CreateCloudGateRequest other = (CreateCloudGateRequest) o;
