...
public class PatchPasswordPolicyConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(PatchPasswordPolicyConverter.class);

    public static com.oracle.bmc.identitydomains.requests.PatchPasswordPolicyRequest
            interceptRequest(
                    com.oracle.bmc.identitydomains.requests.PatchPasswordPolicyRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.identitydomains.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.identitydomains.responses.PatchPasswordPolicyResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.identitydomains.responses.PatchPasswordPolicyResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.identitydomains.responses
                                                        .PatchPasswordPolicyResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.passwordPolicy(response.getItem());
