...
public final class CustomerSecretKey extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public Builder user(CustomerSecretKeyUser user) {
            this.user = user;
    ...
    public CustomerSecretKeyUser getUser() {
        return user;
    }
