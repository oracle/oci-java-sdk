...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudGateSearchRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudGateSearchRequest
    ...
    public static class Builder {
        ...
        public CloudGateSearchRequest build() {
            CloudGateSearchRequest model =
                    new CloudGateSearchRequest(
                            this.schemas,
                            this.attributes,
                            this.attributeSets,
                            this.filter,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudGateSearchRequest model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudGateSearchRequest(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudGateSearchRequest)) {
            return false;
        }

        CloudGateSearchRequest other = (CloudGateSearchRequest) o;
