...
/**
 * A list of certificates issued to the User. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UserX509Certificates.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UserX509Certificates
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"value", "display", "type", "primary"})
    public UserX509Certificates(Object value, String display, String type, Boolean primary) {
        super();
        this.value = value;
    ...
    public static class Builder {
         ...
         * readWrite - required: true - returned: default - type: binary - uniqueness: none
         */
        ...
        public UserX509Certificates build() {
            UserX509Certificates model =
                    new UserX509Certificates(this.value, this.display, this.type, this.primary);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserX509Certificates model) {
     ...
     * - required: true - returned: default - type: binary - uniqueness: none
     */
    @com.fasterxml.jackson.annotation.JsonProperty("value")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UserX509Certificates(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserX509Certificates)) {
            return false;
        }

        UserX509Certificates other = (UserX509Certificates) o;
