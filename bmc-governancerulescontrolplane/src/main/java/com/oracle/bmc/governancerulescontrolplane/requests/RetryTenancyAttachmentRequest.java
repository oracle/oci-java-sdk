...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/governancerulescontrolplane/RetryTenancyAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RetryTenancyAttachmentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220504")
public class RetryTenancyAttachmentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RetryTenancyAttachmentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(RetryTenancyAttachmentRequest o) {
         ...
         *
         * @return instance of RetryTenancyAttachmentRequest
         */
        public RetryTenancyAttachmentRequest build() {
            RetryTenancyAttachmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RetryTenancyAttachmentRequest
         */
        public RetryTenancyAttachmentRequest buildWithoutInvocationCallback() {
            RetryTenancyAttachmentRequest request = new RetryTenancyAttachmentRequest();
            request.tenancyAttachmentId = tenancyAttachmentId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new RetryTenancyAttachmentRequest(tenancyAttachmentId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RetryTenancyAttachmentRequest)) {
            return false;
        }

        RetryTenancyAttachmentRequest other = (RetryTenancyAttachmentRequest) o;
