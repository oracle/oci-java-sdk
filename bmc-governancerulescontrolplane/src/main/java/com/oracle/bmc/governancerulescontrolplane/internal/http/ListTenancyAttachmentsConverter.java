...
public class ListTenancyAttachmentsConverter {
    ...
    public static com.oracle.bmc.governancerulescontrolplane.requests.ListTenancyAttachmentsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.governancerulescontrolplane.requests.ListTenancyAttachmentsRequest
                    request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220504").path("tenancyAttachments");
        ...
        if (request.getTenancyAttachmentId() != null) {
            target =
                    target.queryParam(
                            "tenancyAttachmentId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
        ...
        if (request.getGovernanceRuleId() != null) {
            target =
                    target.queryParam(
                            "governanceRuleId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.governancerulescontrolplane.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.governancerulescontrolplane.responses.ListTenancyAttachmentsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.governancerulescontrolplane
                                                                .model.TenancyAttachmentCollection>>
                                        responseFn;
