...
public class ListInclusionCriteriaConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListInclusionCriteriaConverter.class);

    public static com.oracle.bmc.governancerulescontrolplane.requests.ListInclusionCriteriaRequest
            interceptRequest(
                    com.oracle.bmc.governancerulescontrolplane.requests.ListInclusionCriteriaRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getGovernanceRuleId(), "governanceRuleId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220504").path("inclusionCriteria");
        ...
        if (request.getInclusionCriterionId() != null) {
            target =
                    target.queryParam(
