...
public class ListGovernanceRulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListGovernanceRulesConverter.class);

    public static com.oracle.bmc.governancerulescontrolplane.requests.ListGovernanceRulesRequest
            interceptRequest(
                    com.oracle.bmc.governancerulescontrolplane.requests.ListGovernanceRulesRequest
                            request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.governancerulescontrolplane.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.governancerulescontrolplane.responses.ListGovernanceRulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                                com.oracle.bmc.http.internal.WithHeaders<
                                                        com.oracle.bmc.governancerulescontrolplane
                                                                .model.GovernanceRuleCollection>>
                                        responseFn;
                                ...
                                com.oracle.bmc.governancerulescontrolplane.responses
                                                .ListGovernanceRulesResponse.Builder
                                        builder =
                                                com.oracle.bmc.governancerulescontrolplane.responses
                                                        .ListGovernanceRulesResponse.builder()
                                ...
                                builder.governanceRuleCollection(response.getItem());
