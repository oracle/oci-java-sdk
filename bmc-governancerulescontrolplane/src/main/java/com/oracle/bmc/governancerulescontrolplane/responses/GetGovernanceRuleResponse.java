...
public class GetGovernanceRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetGovernanceRuleResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetGovernanceRuleResponse)) {
            return false;
        }

        GetGovernanceRuleResponse other = (GetGovernanceRuleResponse) o;
