...
public class GetEnforcedGovernanceRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder enforcedGovernanceRule(
                com.oracle.bmc.governancerulescontrolplane.model.EnforcedGovernanceRule
                        enforcedGovernanceRule) {
            this.enforcedGovernanceRule = enforcedGovernanceRule;
            return this;
        ...
        public Builder copy(GetEnforcedGovernanceRuleResponse o) {
            ...
            enforcedGovernanceRule(o.getEnforcedGovernanceRule());
        ...
        public GetEnforcedGovernanceRuleResponse build() {
            return new GetEnforcedGovernanceRuleResponse(
                    __httpStatusCode__, etag, opcRequestId, enforcedGovernanceRule);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",enforcedGovernanceRule=").append(String.valueOf(enforcedGovernanceRule));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEnforcedGovernanceRuleResponse)) {
            return false;
        }

        GetEnforcedGovernanceRuleResponse other = (GetEnforcedGovernanceRuleResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.enforcedGovernanceRule, other.enforcedGovernanceRule);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.enforcedGovernanceRule == null
                                ? 43
                                : this.enforcedGovernanceRule.hashCode());
        return result;
    }
}
