...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/governancerulescontrolplane/ListGovernanceRulesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListGovernanceRulesRequest.
 */
...
public class ListGovernanceRulesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListGovernanceRulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListGovernanceRulesRequest(compartmentId, governanceRuleId, lifecycleState, displayName, governanceRuleType, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
