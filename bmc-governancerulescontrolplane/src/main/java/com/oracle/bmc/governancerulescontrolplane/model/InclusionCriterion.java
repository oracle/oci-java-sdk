...
/**
 * Represents the criterion for the inclusion of the child tenancies under a governance rule. This
 * can be either TENANCY or TAG. <br>
...
public final class InclusionCriterion
