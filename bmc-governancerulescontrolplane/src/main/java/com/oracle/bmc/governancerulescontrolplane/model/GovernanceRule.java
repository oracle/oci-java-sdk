...
/**
 * Represents a rule in parent tenancy which governs resources in child tenancies. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GovernanceRule.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class GovernanceRule
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GovernanceRule model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GovernanceRule)) {
            return false;
        }

        GovernanceRule other = (GovernanceRule) o;
