...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GdpWorkRequest.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class GdpWorkRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public GdpWorkRequest(
            GdpOperationType operationType,
    ...
    public static class Builder {
        ...
        private GdpOperationType operationType;
         ...
         * @return this builder
         **/
        public Builder operationType(GdpOperationType operationType) {
            this.operationType = operationType;
        ...
        public GdpWorkRequest build() {
            GdpWorkRequest model =
                    new GdpWorkRequest(
                            this.operationType,
                            this.status,
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GdpWorkRequest model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("operationType")
    private final GdpOperationType operationType;

    /**
     * Type of work request.
     * @return the value
     **/
    public GdpOperationType getOperationType() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GdpWorkRequest)) {
            return false;
        }

        GdpWorkRequest other = (GdpWorkRequest) o;
