...
public class RedisClusterClient implements RedisCluster {
    /**
    ...
    public AttachOciCacheUsersResponse attachOciCacheUsers(AttachOciCacheUsersRequest request) {
        LOG.trace("Called attachOciCacheUsers");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, AttachOciCacheUsersResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getAttachOciCacheUsersDetails(),
                                                retriedRequest);
    ...
    public ChangeRedisClusterCompartmentResponse changeRedisClusterCompartment(
        ...
        LOG.trace("Called changeRedisClusterCompartment");
    ...
    public ConvertToSecondaryClusterResponse convertToSecondaryCluster(
        ...
        LOG.trace("Called convertToSecondaryCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ConvertToSecondaryClusterResponse>
                transformer =
    ...
    public ConvertToStandaloneClusterResponse convertToStandaloneCluster(
        ...
        LOG.trace("Called convertToStandaloneCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ConvertToStandaloneClusterResponse>
                transformer =
    ...
    public CreateRedisClusterResponse createRedisCluster(CreateRedisClusterRequest request) {
        LOG.trace("Called createRedisCluster");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateRedisClusterDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteRedisClusterResponse deleteRedisCluster(DeleteRedisClusterRequest request) {
        LOG.trace("Called deleteRedisCluster");
    ...
    public DetachOciCacheUsersResponse detachOciCacheUsers(DetachOciCacheUsersRequest request) {
        LOG.trace("Called detachOciCacheUsers");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DetachOciCacheUsersResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getDetachOciCacheUsersDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetRedisClusterResponse getRedisCluster(GetRedisClusterRequest request) {
        LOG.trace("Called getRedisCluster");
    ...
    @Override
    public ListAttachedOciCacheUsersResponse listAttachedOciCacheUsers(
            ListAttachedOciCacheUsersRequest request) {
        LOG.trace("Called listAttachedOciCacheUsers");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListAttachedOciCacheUsersResponse>
                transformer =
    ...
    public ListRedisClustersResponse listRedisClusters(ListRedisClustersRequest request) {
        LOG.trace("Called listRedisClusters");
    ...
    public UpdateRedisClusterResponse updateRedisCluster(UpdateRedisClusterRequest request) {
        LOG.trace("Called updateRedisCluster");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateRedisClusterDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
