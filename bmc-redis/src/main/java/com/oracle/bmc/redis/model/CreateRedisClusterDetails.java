...
public final class CreateRedisClusterDetails
    ...
    public static class Builder {
        ...
        /**
         * The ID of the OCI Cache Backup from which this cluster was created.Mutually exclusive
         * with 'importFromObjectStorageDetails'.
         */
    ...
    /**
     * The ID of the OCI Cache Backup from which this cluster was created.Mutually exclusive with
     * 'importFromObjectStorageDetails'.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("backupId")
