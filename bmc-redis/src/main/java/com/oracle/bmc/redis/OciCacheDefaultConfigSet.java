...
public interface OciCacheDefaultConfigSet extends AutoCloseable {
     ...
     *     GetOciCacheDefaultConfigSet API.
     */
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/ListOciCacheDefaultConfigSetsExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
     *     ListOciCacheDefaultConfigSets API.
     */
