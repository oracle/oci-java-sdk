...
public class OciCacheDefaultConfigSetPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOciCacheDefaultConfigSets operation. This iterable
    ...
    public Iterable<ListOciCacheDefaultConfigSetsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOciCacheDefaultConfigSetsRequest.Builder, ListOciCacheDefaultConfigSetsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.redis.model.OciCacheDefaultConfigSetSummary} objects
     * contained in responses from the listOciCacheDefaultConfigSets operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.redis.model.OciCacheDefaultConfigSetSummary} objects
