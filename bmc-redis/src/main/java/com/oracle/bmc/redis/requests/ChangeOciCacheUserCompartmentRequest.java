...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/ChangeOciCacheUserCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeOciCacheUserCompartmentRequest.
 */
...
public class ChangeOciCacheUserCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeOciCacheUserCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeOciCacheUserCompartmentRequest(ociCacheUserId, changeOciCacheUserCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
