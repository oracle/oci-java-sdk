...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/ChangeRedisClusterCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeRedisClusterCompartmentRequest.
 */
...
public class ChangeRedisClusterCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeRedisClusterCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeRedisClusterCompartmentRequest(redisClusterId, changeRedisClusterCompartmentDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
