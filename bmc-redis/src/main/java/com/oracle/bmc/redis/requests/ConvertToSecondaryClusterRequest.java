...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/ConvertToSecondaryClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ConvertToSecondaryClusterRequest.
 */
...
public class ConvertToSecondaryClusterRequest
    ...
    public static class Builder
        ...
        public ConvertToSecondaryClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ConvertToSecondaryClusterRequest(convertToSecondaryClusterDetails, redisClusterId, ifMatch, opcRetryToken, opcRequestId);
        }
    }
