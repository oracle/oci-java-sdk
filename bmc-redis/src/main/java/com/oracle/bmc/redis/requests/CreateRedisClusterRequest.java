 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateRedisClusterRequest.
 */
...
public class CreateRedisClusterRequest
    ...
    public static class Builder
        ...
        public CreateRedisClusterRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateRedisClusterRequest(createRedisClusterDetails, opcRetryToken,
            // opcRequestId);
        }
    }
