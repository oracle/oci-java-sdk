 ...
 * to any list operations of OciCacheUser where multiple pages of data may be fetched.
...
public class OciCacheUserPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listAttachedRedisClusters operation. This iterable
    ...
    public Iterable<ListAttachedRedisClustersResponse> listAttachedRedisClustersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListAttachedRedisClustersRequest.Builder, ListAttachedRedisClustersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.redis.model.AttachedOciCacheCluster} objects
     * contained in responses from the listAttachedRedisClusters operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.redis.model.AttachedOciCacheCluster} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOciCacheUsers operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListOciCacheUsersResponse> listOciCacheUsersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOciCacheUsersRequest.Builder, ListOciCacheUsersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.redis.model.OciCacheUserSummary} objects
     * contained in responses from the listOciCacheUsers operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.redis.model.OciCacheUserSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.redis.model.OciCacheUserSummary> listOciCacheUsersRecordIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListOciCacheUsersRequest.Builder, ListOciCacheUsersRequest,
                ListOciCacheUsersResponse, com.oracle.bmc.redis.model.OciCacheUserSummary>(
                new java.util.function.Supplier<ListOciCacheUsersRequest.Builder>() {
                    @Override
                    public ListOciCacheUsersRequest.Builder get() {
                        return ListOciCacheUsersRequest.builder().copy(request);
