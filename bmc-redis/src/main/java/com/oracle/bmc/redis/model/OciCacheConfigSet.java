...
/**
 * Configurations for OCI Cache to manage the behavior, performance, and functionality of the
 * underlying cache engine. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OciCacheConfigSet.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OciCacheConfigSet
    ...
    public static class Builder {
        ...
        /**
         * The date and time the OCI Cache Config Set was created. An
        ...
        /**
         * The date and time the OCI Cache Config Set was updated. An
         * [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
         */
        ...
        public OciCacheConfigSet build() {
            OciCacheConfigSet model =
                    new OciCacheConfigSet(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciCacheConfigSet model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciCacheConfigSet)) {
            return false;
        }

        OciCacheConfigSet other = (OciCacheConfigSet) o;
