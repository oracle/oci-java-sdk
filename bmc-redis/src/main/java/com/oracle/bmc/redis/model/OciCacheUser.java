...
/**
 * An OCI cache user is required to connect to an OCI cache cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OciCacheUser.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class OciCacheUser extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OciCacheUser model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OciCacheUser)) {
            return false;
        }

        OciCacheUser other = (OciCacheUser) o;
