...
public interface OciCacheConfigSetAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateOciCacheConfigSetResponse> createOciCacheConfigSet(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOciCacheConfigSetResponse> deleteOciCacheConfigSet(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOciCacheConfigSetResponse> getOciCacheConfigSet(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOciCacheConfigSetsResponse> listOciCacheConfigSets(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOciCacheConfigSetResponse> updateOciCacheConfigSet(
