...
public interface OciCacheBackupAsync extends AutoCloseable {
    ...
    /**
     * Moves an OCI Cache Backup resource from one compartment identifier to another. When provided,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateOciCacheBackupResponse> createOciCacheBackup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOciCacheBackupResponse> deleteOciCacheBackup(
    ...
    /**
     * Initiates an asynchronous export of the backup\u2019s RDB file(s) to the specified Object
     * Storage bucket. The service generates the object names. For sharded backups, one object is
     * written per shard under the optional prefix.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOciCacheBackupResponse> getOciCacheBackup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOciCacheBackupsResponse> listOciCacheBackups(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOciCacheBackupResponse> updateOciCacheBackup(
