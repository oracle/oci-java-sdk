...
public final class RedisClusterCollection
    ...
    public static class Builder {
        ...
        public RedisClusterCollection build() {
            RedisClusterCollection model = new RedisClusterCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RedisClusterCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RedisClusterCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RedisClusterCollection)) {
            return false;
        }

        RedisClusterCollection other = (RedisClusterCollection) o;
