...
public interface OciCacheDefaultConfigSetAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetOciCacheDefaultConfigSetResponse> getOciCacheDefaultConfigSet(
            GetOciCacheDefaultConfigSetRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            GetOciCacheDefaultConfigSetRequest, GetOciCacheDefaultConfigSetResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOciCacheDefaultConfigSetsResponse>
