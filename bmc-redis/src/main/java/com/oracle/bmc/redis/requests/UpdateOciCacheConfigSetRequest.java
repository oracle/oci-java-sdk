...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/UpdateOciCacheConfigSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOciCacheConfigSetRequest.
 */
...
public class UpdateOciCacheConfigSetRequest
    ...
    public static class Builder
        ...
        public UpdateOciCacheConfigSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOciCacheConfigSetRequest(ociCacheConfigSetId, updateOciCacheConfigSetDetails, ifMatch, opcRequestId);
        }
    }
