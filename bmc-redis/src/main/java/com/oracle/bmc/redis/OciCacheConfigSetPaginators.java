...
public class OciCacheConfigSetPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listAssociatedOciCacheClusters operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.redis.model.AssociatedOciCacheClusterSummary} objects
     * contained in responses from the listAssociatedOciCacheClusters operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.redis.model.AssociatedOciCacheClusterSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listOciCacheConfigSets operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListOciCacheConfigSetsResponse> listOciCacheConfigSetsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListOciCacheConfigSetsRequest.Builder, ListOciCacheConfigSetsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.redis.model.OciCacheConfigSetSummary} objects
     * contained in responses from the listOciCacheConfigSets operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.redis.model.OciCacheConfigSetSummary} objects
     * contained in responses received from the service.
     */
