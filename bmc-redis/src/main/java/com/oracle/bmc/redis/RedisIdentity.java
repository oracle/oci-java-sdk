...
public interface RedisIdentity extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/redis/CreateIdentityTokenExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use CreateIdentityToken API.
     */
    CreateIdentityTokenResponse createIdentityToken(CreateIdentityTokenRequest request);
}
