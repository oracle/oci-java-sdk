...
/**
 * List of OCI Cache Config Set Values. <br>
...
public final class ConfigurationDetails
    ...
    public ConfigurationDetails(java.util.List<ConfigurationInfo> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<ConfigurationInfo> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<ConfigurationInfo> items) {
            this.items = items;
    ...
    /** List of ConfigurationInfo objects. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<ConfigurationInfo> items;
     ...
     * @return the value
     */
    public java.util.List<ConfigurationInfo> getItems() {
        return items;
    }
