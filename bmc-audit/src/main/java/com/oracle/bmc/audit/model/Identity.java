...
/**
 * A container object for identity attributes. <br>
...
public final class Identity extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        /**
         * The name of the user or service. This value is the friendly name associated with {@code
         * principalId}.
         *
         * <p>Example: {@code ExampleName}
         */
        ...
        /**
         * The credential ID of the user. This value is extracted from the HTTP 'Authorization'
         * request header. It consists of the tenantId, userId, and user fingerprint, all delimited
         * by a slash (/).
         */
         ...
         *
         * <p>Example: {@code Jersey/2.23 (HttpUrlConnection 1.8.0_212)}
         */
