...
public interface VbsInstanceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeVbsInstanceCompartmentResponse> changeVbsInstanceCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateVbsInstanceResponse> createVbsInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteVbsInstanceResponse> deleteVbsInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetVbsInstanceResponse> getVbsInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListVbsInstancesResponse> listVbsInstances(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateVbsInstanceResponse> updateVbsInstance(
