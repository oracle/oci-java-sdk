...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/vbsinst/ChangeVbsInstanceCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeVbsInstanceCompartmentRequest.
 */
...
public class ChangeVbsInstanceCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeVbsInstanceCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeVbsInstanceCompartmentRequest(vbsInstanceId, changeVbsInstanceCompartmentDetails, ifMatch, opcRequestId);
        }
    }
