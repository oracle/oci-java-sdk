...
public class VbsInstanceWaiters {
    ...
    public VbsInstanceWaiters(
            java.util.concurrent.ExecutorService executorService, VbsInstance client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetVbsInstanceRequest, GetVbsInstanceResponse>
            forVbsInstance(
                    GetVbsInstanceRequest request,
                    com.oracle.bmc.vbsinst.model.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forVbsInstance(
    ...
    public com.oracle.bmc.waiter.Waiter<GetVbsInstanceRequest, GetVbsInstanceResponse>
            forVbsInstance(
                    GetVbsInstanceRequest request,
                    com.oracle.bmc.vbsinst.model.LifecycleState targetState,
    ...
    // Helper method to create a new Waiter for VbsInstance.
    private com.oracle.bmc.waiter.Waiter<GetVbsInstanceRequest, GetVbsInstanceResponse>
            forVbsInstance(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetVbsInstanceRequest request,
                    final com.oracle.bmc.vbsinst.model.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.vbsinst.model.LifecycleState> targetStatesSet =
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            public GetVbsInstanceResponse apply(GetVbsInstanceRequest request) {
                                return client.getVbsInstance(request);
                            }
                        },
                        new java.util.function.Predicate<GetVbsInstanceResponse>() {
                            @Override
                            public boolean test(GetVbsInstanceResponse response) {
                                return targetStatesSet.contains(
                                        response.getVbsInstance().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.vbsinst.model.LifecycleState.Deleted)),
                request);
    }
