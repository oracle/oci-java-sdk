...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/emwarehouse/ListWorkRequestsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestsRequest.
 */
...
public class ListWorkRequestsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
     ...
     */
    private com.oracle.bmc.emwarehouse.model.OperationStatus status;

    /**
     * A filter to return only resources their lifecycleState matches the given OperationStatus.
     */
    public com.oracle.bmc.emwarehouse.model.OperationStatus getStatus() {
        return status;
    }
    /**
     ...
     */
    private com.oracle.bmc.emwarehouse.model.SortOrder sortOrder;

    /**
     * The sort order to use, either 'ASC' or 'DESC'.
     */
    public com.oracle.bmc.emwarehouse.model.SortOrder getSortOrder() {
        return sortOrder;
    }
    /**
    ...
    public static class Builder
         ...
         * A filter to return only resources their lifecycleState matches the given OperationStatus.
         */
        private com.oracle.bmc.emwarehouse.model.OperationStatus status = null;
         ...
         * @return this builder instance
         */
        public Builder status(com.oracle.bmc.emwarehouse.model.OperationStatus status) {
            this.status = status;
            return this;
        }
         ...
         * The sort order to use, either 'ASC' or 'DESC'.
         */
        private com.oracle.bmc.emwarehouse.model.SortOrder sortOrder = null;
         ...
         * @return this builder instance
         */
        public Builder sortOrder(com.oracle.bmc.emwarehouse.model.SortOrder sortOrder) {
