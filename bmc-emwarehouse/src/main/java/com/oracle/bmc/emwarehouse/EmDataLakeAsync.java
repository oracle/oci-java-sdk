...
public interface EmDataLakeAsync extends AutoCloseable {
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ChangeEmWarehouseCompartmentResponse> changeEmWarehouseCompartment(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<CreateEmWarehouseResponse> createEmWarehouse(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<DeleteEmWarehouseResponse> deleteEmWarehouse(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetEmWarehouseResponse> getEmWarehouse(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetEmWarehouseResourceUsageResponse> getEmWarehouseResourceUsage(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListEmWarehousesResponse> listEmWarehouses(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListEtlRunsResponse> listEtlRuns(
            ListEtlRunsRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListEtlRunsRequest, ListEtlRunsResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateEmWarehouseResponse> updateEmWarehouse(
