...
public class EmWarehouseClient implements EmWarehouse {
    ...
    public ChangeEmWarehouseCompartmentResponse changeEmWarehouseCompartment(
        ...
        LOG.trace("Called changeEmWarehouseCompartment");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getChangeEmWarehouseCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateEmWarehouseResponse createEmWarehouse(CreateEmWarehouseRequest request) {
        LOG.trace("Called createEmWarehouse");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateEmWarehouseDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteEmWarehouseResponse deleteEmWarehouse(DeleteEmWarehouseRequest request) {
        LOG.trace("Called deleteEmWarehouse");
    ...
    public GetEmWarehouseResponse getEmWarehouse(GetEmWarehouseRequest request) {
        LOG.trace("Called getEmWarehouse");
    ...
    public GetEmWarehouseResourceUsageResponse getEmWarehouseResourceUsage(
        ...
        LOG.trace("Called getEmWarehouseResourceUsage");
    ...
    public ListEmWarehousesResponse listEmWarehouses(ListEmWarehousesRequest request) {
        LOG.trace("Called listEmWarehouses");
    ...
    public UpdateEmWarehouseResponse updateEmWarehouse(UpdateEmWarehouseRequest request) {
        LOG.trace("Called updateEmWarehouse");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateEmWarehouseDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
