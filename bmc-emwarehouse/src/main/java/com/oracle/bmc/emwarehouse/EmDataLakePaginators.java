...
public class EmDataLakePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listEmWarehouses operation. This iterable
    ...
    public Iterable<ListEmWarehousesResponse> listEmWarehousesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new com.google.common.base.Supplier<ListEmWarehousesRequest.Builder>() {
                    @Override
                    public ListEmWarehousesRequest.Builder get() {
                        return ListEmWarehousesRequest.builder().copy(request);
                    }
                },
                new com.google.common.base.Function<ListEmWarehousesResponse, String>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.emwarehouse.model.EmWarehouseSummary} objects
     * contained in responses from the listEmWarehouses operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.emwarehouse.model.EmWarehouseSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listEtlRuns operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListEtlRunsResponse> listEtlRunsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ...
                new com.google.common.base.Supplier<ListEtlRunsRequest.Builder>() {
                    @Override
                    public ListEtlRunsRequest.Builder get() {
                        return ListEtlRunsRequest.builder().copy(request);
                    }
                },
                new com.google.common.base.Function<ListEtlRunsResponse, String>() {
                    @Override
                ...
                new com.google.common.base.Function<ListEtlRunsRequest, ListEtlRunsResponse>() {
                    @Override
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.emwarehouse.model.EtlRunSummary} objects
     * contained in responses from the listEtlRuns operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.emwarehouse.model.EtlRunSummary} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestError} objects
     * contained in responses from the listWorkRequestErrors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestError} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.emwarehouse.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestErrorsRequest.Builder, ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse, com.oracle.bmc.emwarehouse.model.WorkRequestError>(
                new com.google.common.base.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestLogEntry} objects
     * contained in responses from the listWorkRequestLogs operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestLogEntry} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.emwarehouse.model.WorkRequestLogEntry>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListWorkRequestLogsRequest.Builder, ListWorkRequestLogsRequest,
                ListWorkRequestLogsResponse, com.oracle.bmc.emwarehouse.model.WorkRequestLogEntry>(
                new com.google.common.base.Supplier<ListWorkRequestLogsRequest.Builder>() {
                    @Override
                    public ListWorkRequestLogsRequest.Builder get() {
                        return ListWorkRequestLogsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestSummary} objects
     * contained in responses from the listWorkRequests operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.emwarehouse.model.WorkRequestSummary} objects
     * contained in responses received from the service.
     */
