...
public class UpdateEmWarehouseResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateEmWarehouseResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateEmWarehouseResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateEmWarehouseResponse o) {
         ...
         */
        @Override
        public UpdateEmWarehouseResponse build() {
            return new UpdateEmWarehouseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEmWarehouseResponse)) {
            return false;
        }

        UpdateEmWarehouseResponse other = (UpdateEmWarehouseResponse) o;
