...
public class DatastoreClusterPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listDatastoreClusters operation. This iterable
    ...
    public Iterable<ListDatastoreClustersResponse> listDatastoreClustersResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListDatastoreClustersRequest.Builder, ListDatastoreClustersRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.ocvp.model.DatastoreClusterSummary} objects
     * contained in responses from the listDatastoreClusters operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.ocvp.model.DatastoreClusterSummary} objects
    ...
    public Iterable<com.oracle.bmc.ocvp.model.DatastoreClusterSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListDatastoreClustersRequest.Builder, ListDatastoreClustersRequest,
                ListDatastoreClustersResponse, com.oracle.bmc.ocvp.model.DatastoreClusterSummary>(
                new java.util.function.Supplier<ListDatastoreClustersRequest.Builder>() {
                    @Override
                    public ListDatastoreClustersRequest.Builder get() {
                        return ListDatastoreClustersRequest.builder().copy(request);
