...
/**
 * Details for the datastore attachment to Datastore Cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddDatastoreToDatastoreClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddDatastoreToDatastoreClusterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"datastoreIds"})
    public AddDatastoreToDatastoreClusterDetails(java.util.List<String> datastoreIds) {
        super();
    ...
    public static class Builder {
        ...
        public AddDatastoreToDatastoreClusterDetails build() {
            AddDatastoreToDatastoreClusterDetails model =
                    new AddDatastoreToDatastoreClusterDetails(this.datastoreIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddDatastoreToDatastoreClusterDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddDatastoreToDatastoreClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatastoreToDatastoreClusterDetails)) {
            return false;
        }

        AddDatastoreToDatastoreClusterDetails other = (AddDatastoreToDatastoreClusterDetails) o;
