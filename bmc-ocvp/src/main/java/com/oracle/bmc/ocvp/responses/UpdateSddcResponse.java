...
public class UpdateSddcResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateSddcResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateSddcResponse o) {
         ...
         */
        @Override
        public UpdateSddcResponse build() {
            return new UpdateSddcResponse(__httpStatusCode__, headers, etag, opcRequestId, sddc);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSddcResponse)) {
            return false;
        }

        UpdateSddcResponse other = (UpdateSddcResponse) o;
