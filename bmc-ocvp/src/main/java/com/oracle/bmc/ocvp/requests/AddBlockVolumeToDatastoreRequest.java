...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/AddBlockVolumeToDatastoreExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddBlockVolumeToDatastoreRequest.
 */
...
public class AddBlockVolumeToDatastoreRequest
    ...
    public static class Builder
        ...
        public AddBlockVolumeToDatastoreRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddBlockVolumeToDatastoreRequest(datastoreId, addBlockVolumeToDatastoreDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
