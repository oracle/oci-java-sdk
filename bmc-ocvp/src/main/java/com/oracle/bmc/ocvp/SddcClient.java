...
public class SddcClient implements Sddc {
    ...
    @Override
    public GenerateVmwareBinaryDownloadInfoResponse generateVmwareBinaryDownloadInfo(
            GenerateVmwareBinaryDownloadInfoRequest request) {
        LOG.trace("Called generateVmwareBinaryDownloadInfo");
    ...
    @Override
    public RetrieveVmwareBinariesResponse retrieveVmwareBinaries(
            RetrieveVmwareBinariesRequest request) {
        LOG.trace("Called retrieveVmwareBinaries");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, RetrieveVmwareBinariesResponse>
                transformer =
