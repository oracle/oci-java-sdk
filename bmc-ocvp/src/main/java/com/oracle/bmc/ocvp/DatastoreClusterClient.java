...
public class DatastoreClusterClient implements DatastoreCluster {
    /**
     ...
     */
    protected DatastoreClusterClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public DatastoreClusterClient build(
            ...
            return new DatastoreClusterClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public AddDatastoreToDatastoreClusterResponse addDatastoreToDatastoreCluster(
        ...
        LOG.trace("Called addDatastoreToDatastoreCluster");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getAddDatastoreToDatastoreClusterDetails(),
                                                retriedRequest);
    ...
    public AttachDatastoreClusterToClusterResponse attachDatastoreClusterToCluster(
        ...
        LOG.trace("Called attachDatastoreClusterToCluster");
    ...
    public AttachDatastoreClusterToEsxiHostResponse attachDatastoreClusterToEsxiHost(
        ...
        LOG.trace("Called attachDatastoreClusterToEsxiHost");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getAttachDatastoreClusterToEsxiHostDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ChangeDatastoreClusterCompartmentResponse changeDatastoreClusterCompartment(
        ...
        LOG.trace("Called changeDatastoreClusterCompartment");
    ...
    public CreateDatastoreClusterResponse createDatastoreCluster(
        ...
        LOG.trace("Called createDatastoreCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateDatastoreClusterResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDatastoreClusterDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteDatastoreClusterResponse deleteDatastoreCluster(
        ...
        LOG.trace("Called deleteDatastoreCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteDatastoreClusterResponse>
                transformer =
    ...
    public DetachDatastoreClusterFromClusterResponse detachDatastoreClusterFromCluster(
        ...
        LOG.trace("Called detachDatastoreClusterFromCluster");
    ...
    public DetachDatastoreClusterFromEsxiHostResponse detachDatastoreClusterFromEsxiHost(
        ...
        LOG.trace("Called detachDatastoreClusterFromEsxiHost");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getDetachDatastoreClusterFromEsxiHostDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetDatastoreClusterResponse getDatastoreCluster(GetDatastoreClusterRequest request) {
        LOG.trace("Called getDatastoreCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetDatastoreClusterResponse>
                transformer =
    ...
    public ListDatastoreClustersResponse listDatastoreClusters(
        ...
        LOG.trace("Called listDatastoreClusters");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListDatastoreClustersResponse>
                transformer =
    ...
    public RemoveDatastoreFromDatastoreClusterResponse removeDatastoreFromDatastoreCluster(
        ...
        LOG.trace("Called removeDatastoreFromDatastoreCluster");
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest
                                                        .getRemoveDatastoreFromDatastoreClusterDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public UpdateDatastoreClusterResponse updateDatastoreCluster(
        ...
        LOG.trace("Called updateDatastoreCluster");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateDatastoreClusterResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateDatastoreClusterDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
