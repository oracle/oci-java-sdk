...
public class ClusterWaiters {
    ...
    public ClusterWaiters(java.util.concurrent.ExecutorService executorService, Cluster client) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetClusterRequest, GetClusterResponse> forCluster(
            GetClusterRequest request, com.oracle.bmc.ocvp.model.LifecycleStates... targetStates) {
