...
public class ClusterClient extends com.oracle.bmc.http.internal.BaseSyncClient implements Cluster {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ClusterClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ClusterClient> {
        ...
        public ClusterClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new ClusterClient(this, authenticationDetailsProvider, executorService);
        }
    }
