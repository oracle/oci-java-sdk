...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/ListByolsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListByolsRequest.
 */
...
public class ListByolsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListByolsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListByolsRequest(compartmentId, byolId, lifecycleState, softwareType, availableUnitsGreaterThanOrEqualTo, displayName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
