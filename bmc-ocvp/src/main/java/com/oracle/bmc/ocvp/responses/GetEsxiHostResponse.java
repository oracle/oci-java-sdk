...
public class GetEsxiHostResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetEsxiHostResponse> {
        ...
        public GetEsxiHostResponse build() {
            return new GetEsxiHostResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, esxiHost);
        }
    }
