...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/UpdateManagementApplianceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateManagementApplianceRequest.
 */
...
public class UpdateManagementApplianceRequest
    ...
    public static class Builder
        ...
        public UpdateManagementApplianceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateManagementApplianceRequest(managementApplianceId, updateManagementApplianceDetails, ifMatch, opcRequestId);
        }
    }
