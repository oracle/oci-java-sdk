...
public interface ByolAllocationAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeByolAllocationCompartmentResponse>
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<CreateByolAllocationResponse> createByolAllocation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<DeleteByolAllocationResponse> deleteByolAllocation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetByolAllocationResponse> getByolAllocation(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListByolAllocationsResponse> listByolAllocations(
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateByolAllocationResponse> updateByolAllocation(
