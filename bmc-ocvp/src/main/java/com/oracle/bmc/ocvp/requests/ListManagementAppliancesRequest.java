...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/ListManagementAppliancesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagementAppliancesRequest.
 */
...
public class ListManagementAppliancesRequest
    ...
    public static class Builder
        ...
        public ListManagementAppliancesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagementAppliancesRequest(compartmentId, managementApplianceId, sddcId, displayName, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
