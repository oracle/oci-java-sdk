...
public interface ManagementApplianceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CreateManagementApplianceResponse> createManagementAppliance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteManagementApplianceResponse> deleteManagementAppliance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetManagementApplianceResponse> getManagementAppliance(
    ...
    /**
     * Lists management appliances in compartment specified. List can be filtered by management
     * appliance, compartment, name and lifecycle state.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListManagementAppliancesResponse> listManagementAppliances(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateManagementApplianceResponse> updateManagementAppliance(
