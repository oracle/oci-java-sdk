...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ClusterCollection.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ClusterCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ClusterCollection build() {
            ClusterCollection model = new ClusterCollection(this.items);
