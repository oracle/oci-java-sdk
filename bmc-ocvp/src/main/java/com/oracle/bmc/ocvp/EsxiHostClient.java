...
public class EsxiHostClient implements EsxiHost {
    ...
    public CreateEsxiHostResponse createEsxiHost(CreateEsxiHostRequest request) {
        LOG.trace("Called createEsxiHost");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateEsxiHostDetails(),
                                                retriedRequest);
    ...
    public DeleteEsxiHostResponse deleteEsxiHost(DeleteEsxiHostRequest request) {
        LOG.trace("Called deleteEsxiHost");
    ...
    public ListEsxiHostsResponse listEsxiHosts(ListEsxiHostsRequest request) {
        LOG.trace("Called listEsxiHosts");
    ...
    public UpdateEsxiHostResponse updateEsxiHost(UpdateEsxiHostRequest request) {
        LOG.trace("Called updateEsxiHost");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateEsxiHostDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
