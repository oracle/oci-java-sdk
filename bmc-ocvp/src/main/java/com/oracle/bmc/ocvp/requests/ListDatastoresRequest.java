...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/ListDatastoresExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatastoresRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230701")
public class ListDatastoresRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDatastoresRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDatastoresRequest o) {
        ...
        /**
         * Build the instance of ListDatastoresRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDatastoresRequest
         */
        public ListDatastoresRequest build() {
            ListDatastoresRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDatastoresRequest
         */
        public ListDatastoresRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDatastoresRequest(compartmentId, displayName, clusterId, datastoreId, limit, page, sortOrder, sortBy, opcRequestId, lifecycleState);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatastoresRequest)) {
            return false;
        }

        ListDatastoresRequest other = (ListDatastoresRequest) o;
