 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatastoresRequest.
 */
...
public class ListDatastoresRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListDatastoresRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDatastoresRequest(compartmentId, displayName, clusterId, datastoreId, limit,
            // page, sortOrder, sortBy, opcRequestId, lifecycleState);
        }
    }
