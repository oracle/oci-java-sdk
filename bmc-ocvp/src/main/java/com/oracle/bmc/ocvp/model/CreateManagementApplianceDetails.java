...
/**
 * Information about management appliance to be created. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateManagementApplianceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateManagementApplianceDetails
    ...
    public CreateManagementApplianceDetails(
            String sddcId,
            String displayName,
    ...
    public static class Builder {
        ...
        /**
         * One or more public SSH keys to be included in {@code ~/.ssh/authorized_keys} file for
         * Management Appliance compute instance. Several public SSH keys must be separate by
         * newline character.
         */
        @com.fasterxml.jackson.annotation.JsonProperty("publicSshKeys")
         ...
         * newline character.
         *
         * @param publicSshKeys the value to set
         * @return this builder
         */
        public Builder publicSshKeys(String publicSshKeys) {
            this.publicSshKeys = publicSshKeys;
            this.__explicitlySet__.add("publicSshKeys");
            return this;
        }
        /**
        ...
        public CreateManagementApplianceDetails build() {
            CreateManagementApplianceDetails model =
                    new CreateManagementApplianceDetails(
                            this.sddcId,
                            this.displayName,
                            this.configuration,
                            this.connections,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateManagementApplianceDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("publicSshKeys")) {
                this.publicSshKeys(model.getPublicSshKeys());
            }
    ...
    /**
     * One or more public SSH keys to be included in {@code ~/.ssh/authorized_keys} file for
     * Management Appliance compute instance. Several public SSH keys must be separate by newline
     * character.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("publicSshKeys")
    private final String publicSshKeys;
     ...
     * @return the value
     */
    public String getPublicSshKeys() {
        return publicSshKeys;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", publicSshKeys=").append(String.valueOf(this.publicSshKeys));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManagementApplianceDetails)) {
            return false;
        }

        CreateManagementApplianceDetails other = (CreateManagementApplianceDetails) o;
        return java.util.Objects.equals(this.sddcId, other.sddcId)
                ...
                && java.util.Objects.equals(this.publicSshKeys, other.publicSshKeys)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.publicSshKeys == null ? 43 : this.publicSshKeys.hashCode());
