...
public final class VmwareBinaryDownloadInfo
    ...
    public static class Builder {
        ...
        /**
         * The expiration date for the URL, in the format defined by
         * [RFC3339](https://tools.ietf.org/html/rfc3339). After this date the URL will no longer be
         * valid.
         *
