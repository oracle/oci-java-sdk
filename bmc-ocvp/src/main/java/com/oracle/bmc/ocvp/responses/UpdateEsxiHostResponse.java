...
public class UpdateEsxiHostResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateEsxiHostResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateEsxiHostResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateEsxiHostResponse o) {
         ...
         */
        @Override
        public UpdateEsxiHostResponse build() {
            return new UpdateEsxiHostResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateEsxiHostResponse)) {
            return false;
        }

        UpdateEsxiHostResponse other = (UpdateEsxiHostResponse) o;
