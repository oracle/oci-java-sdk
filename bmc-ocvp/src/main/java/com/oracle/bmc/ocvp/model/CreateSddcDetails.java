...
public final class CreateSddcDetails
    ...
    public static class Builder {
         ...
         * #createEsxiHost(CreateEsxiHostRequest) createEsxiHost}). Creating a SDDC with a ESXi host
         * count of 1 will be considered a single ESXi host SDDC.
         *
         * <p>*Note:** If you later delete EXSi hosts from a production SDDC to total less than 3,
         * you are still billed for the 3 minimum recommended ESXi hosts. Also, you cannot add more
         * VMware workloads to the SDDC until it again has at least 3 ESXi hosts.
         */
         ...
         * when {@code isHcxEnabled} is true.
         */
     ...
     * count of 1 will be considered a single ESXi host SDDC.
     *
     * <p>*Note:** If you later delete EXSi hosts from a production SDDC to total less than 3, you
     * are still billed for the 3 minimum recommended ESXi hosts. Also, you cannot add more VMware
     * workloads to the SDDC until it again has at least 3 ESXi hosts.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("esxiHostsCount")
