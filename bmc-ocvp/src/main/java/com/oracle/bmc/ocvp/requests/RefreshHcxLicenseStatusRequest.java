...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/RefreshHcxLicenseStatusExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RefreshHcxLicenseStatusRequest.
 */
...
public class RefreshHcxLicenseStatusRequest
    ...
    public static class Builder
         ...
         * @return instance of RefreshHcxLicenseStatusRequest
         */
        public RefreshHcxLicenseStatusRequest buildWithoutInvocationCallback() {
            RefreshHcxLicenseStatusRequest request = new RefreshHcxLicenseStatusRequest();
            request.sddcId = sddcId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new RefreshHcxLicenseStatusRequest(sddcId, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RefreshHcxLicenseStatusRequest)) {
            return false;
        }

        RefreshHcxLicenseStatusRequest other = (RefreshHcxLicenseStatusRequest) o;
