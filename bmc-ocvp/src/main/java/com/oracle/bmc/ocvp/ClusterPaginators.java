 ...
 * to any list operations of Cluster where multiple pages of data may be fetched. Two styles of
...
public class ClusterPaginators {
     ...
     * com.oracle.bmc.ocvp.model.ClusterSummary} objects contained in responses from the
     * listClusters operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.ocvp.model.ClusterSummary} objects contained in responses received from
     *     the service.
     */
