...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/ocvp/ListDatastoreClustersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatastoreClustersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230701")
public class ListDatastoreClustersRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDatastoreClustersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDatastoreClustersRequest o) {
        ...
        /**
         * Build the instance of ListDatastoreClustersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDatastoreClustersRequest
         */
        public ListDatastoreClustersRequest build() {
            ListDatastoreClustersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDatastoreClustersRequest
         */
        public ListDatastoreClustersRequest buildWithoutInvocationCallback() {
            ListDatastoreClustersRequest request = new ListDatastoreClustersRequest();
            ...
            return request;
            // new ListDatastoreClustersRequest(compartmentId, displayName, datastoreClusterId, clusterId, limit, page, sortOrder, sortBy, opcRequestId, lifecycleState);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatastoreClustersRequest)) {
            return false;
        }

        ListDatastoreClustersRequest other = (ListDatastoreClustersRequest) o;
