...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UpdateByolDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UpdateByolDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public UpdateByolDetails build() {
            UpdateByolDetails model =
                    new UpdateByolDetails(
                            this.displayName,
                            this.totalUnits,
                            this.description,
                            this.softwareType,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateByolDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateByolDetails)) {
            return false;
        }

        UpdateByolDetails other = (UpdateByolDetails) o;
