...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/logging/DeleteLogExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteLogRequest.
 */
...
public class DeleteLogRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteLogRequest build() {
            DeleteLogRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteLogRequest
         */
        public DeleteLogRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteLogRequest(logGroupId, logId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteLogRequest)) {
            return false;
        }

        DeleteLogRequest other = (DeleteLogRequest) o;
