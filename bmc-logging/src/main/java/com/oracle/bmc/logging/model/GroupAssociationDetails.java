...
public final class GroupAssociationDetails {
    ...
    public static class Builder {
        ...
        public GroupAssociationDetails build() {
            GroupAssociationDetails __instance__ = new GroupAssociationDetails(groupList);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GroupAssociationDetails o) {
            Builder copiedBuilder = groupList(o.getGroupList());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.groupList, other.groupList)
