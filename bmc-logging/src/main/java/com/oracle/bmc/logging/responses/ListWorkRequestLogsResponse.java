...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.logging.model.WorkRequestLog} instances. */
    private java.util.List<com.oracle.bmc.logging.model.WorkRequestLog> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.logging.model.WorkRequestLog> getItems() {
        return items;
    }
    ...
    private ListWorkRequestLogsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            java.util.List<com.oracle.bmc.logging.model.WorkRequestLog> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.logging.model.WorkRequestLog> items) {
            this.items = items;
            return this;
        }
