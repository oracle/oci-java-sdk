...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UnifiedAgentMsgpackParser.Builder.class
)
...
public final class UnifiedAgentMsgpackParser extends UnifiedAgentParser {
    ...
    public static class Builder {
        ...
        public UnifiedAgentMsgpackParser build() {
            UnifiedAgentMsgpackParser __instance__ =
                    new UnifiedAgentMsgpackParser(
                            fieldTimeKey,
                            types,
                            nullValuePattern,
                            isNullEmptyString,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentMsgpackParser o) {
    ...
    @Deprecated
    public UnifiedAgentMsgpackParser(
            String fieldTimeKey,
    ...
    public String toString() {
        ...
        sb.append("UnifiedAgentMsgpackParser(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAgentMsgpackParser)) {
            return false;
        }

        UnifiedAgentMsgpackParser other = (UnifiedAgentMsgpackParser) o;
