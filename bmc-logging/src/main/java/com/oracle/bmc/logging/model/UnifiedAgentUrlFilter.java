...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = UnifiedAgentUrlFilter.Builder.class
)
...
public final class UnifiedAgentUrlFilter extends UnifiedAgentMonitoringFilter {
    ...
    public static class Builder {
        ...
        public UnifiedAgentUrlFilter build() {
            UnifiedAgentUrlFilter model =
                    new UnifiedAgentUrlFilter(this.name, this.allowList, this.denyList);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentUrlFilter model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UnifiedAgentUrlFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAgentUrlFilter)) {
            return false;
        }

        UnifiedAgentUrlFilter other = (UnifiedAgentUrlFilter) o;
