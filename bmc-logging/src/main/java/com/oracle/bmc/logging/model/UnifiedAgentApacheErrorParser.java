...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UnifiedAgentApacheErrorParser.Builder.class)
...
public final class UnifiedAgentApacheErrorParser extends UnifiedAgentParser {
    ...
    public static class Builder {
        ...
        public UnifiedAgentApacheErrorParser build() {
            UnifiedAgentApacheErrorParser model =
                    new UnifiedAgentApacheErrorParser(
                            this.fieldTimeKey,
                            this.types,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentApacheErrorParser model) {
    ...
    @Deprecated
    public UnifiedAgentApacheErrorParser(
            String fieldTimeKey,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UnifiedAgentApacheErrorParser(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAgentApacheErrorParser)) {
            return false;
        }

        UnifiedAgentApacheErrorParser other = (UnifiedAgentApacheErrorParser) o;
