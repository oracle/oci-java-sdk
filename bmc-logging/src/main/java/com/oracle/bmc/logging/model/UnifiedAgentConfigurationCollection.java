...
public final class UnifiedAgentConfigurationCollection {
    ...
    public static class Builder {
        ...
        public UnifiedAgentConfigurationCollection build() {
            UnifiedAgentConfigurationCollection __instance__ =
                    new UnifiedAgentConfigurationCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentConfigurationCollection o) {
