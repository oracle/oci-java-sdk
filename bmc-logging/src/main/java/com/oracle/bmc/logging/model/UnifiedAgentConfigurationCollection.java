...
public final class UnifiedAgentConfigurationCollection
    ...
    public UnifiedAgentConfigurationCollection(
            java.util.List<UnifiedAgentConfigurationSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public UnifiedAgentConfigurationCollection build() {
            UnifiedAgentConfigurationCollection model =
                    new UnifiedAgentConfigurationCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentConfigurationCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAgentConfigurationCollection)) {
            return false;
        }

        UnifiedAgentConfigurationCollection other = (UnifiedAgentConfigurationCollection) o;
