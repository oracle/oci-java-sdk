...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UnifiedAgentOpenmetricsParser.Builder.class)
...
public final class UnifiedAgentOpenmetricsParser extends UnifiedAgentParser {
    ...
    public static class Builder {
        ...
        private UnifiedAgentOpenmetricsParserRecord recordInput;

        public Builder recordInput(UnifiedAgentOpenmetricsParserRecord recordInput) {
        ...
        public UnifiedAgentOpenmetricsParser build() {
            UnifiedAgentOpenmetricsParser model =
                    new UnifiedAgentOpenmetricsParser(
                            this.fieldTimeKey,
                            this.types,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UnifiedAgentOpenmetricsParser model) {
    ...
    @Deprecated
    public UnifiedAgentOpenmetricsParser(
            String fieldTimeKey,
            ...
            UnifiedAgentOpenmetricsParserRecord recordInput) {
        super(
                fieldTimeKey,
                types,
                nullValuePattern,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("recordInput")
    private final UnifiedAgentOpenmetricsParserRecord recordInput;

    public UnifiedAgentOpenmetricsParserRecord getRecordInput() {
        return recordInput;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UnifiedAgentOpenmetricsParser(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UnifiedAgentOpenmetricsParser)) {
            return false;
        }

        UnifiedAgentOpenmetricsParser other = (UnifiedAgentOpenmetricsParser) o;
        return java.util.Objects.equals(this.recordInput, other.recordInput) && super.equals(other);
    }
