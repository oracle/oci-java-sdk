...
public class CreateLogResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public CreateLogResponse build() {
            return new CreateLogResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogResponse)) {
            return false;
        }

        CreateLogResponse other = (CreateLogResponse) o;
