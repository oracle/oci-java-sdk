...
public class LoggingManagementClient implements LoggingManagement {
     ...
     */
    protected LoggingManagementClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeLogLogGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateLogResponse createLog(CreateLogRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, CreateLogResponse> transformer =
                CreateLogConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateLogDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateLogGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateLogSavedSearchDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteLogResponse deleteLog(DeleteLogRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, DeleteLogResponse> transformer =
                DeleteLogConverter.fromResponse();
    ...
    public ListLogsResponse listLogs(ListLogsRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ListLogsResponse> transformer =
                ListLogsConverter.fromResponse();
    ...
    public UpdateLogResponse updateLog(UpdateLogRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, UpdateLogResponse> transformer =
                UpdateLogConverter.fromResponse();
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateLogDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateLogGroupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateLogSavedSearchDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
