...
public class ChangeUnifiedAgentConfigurationCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeUnifiedAgentConfigurationCompartmentResponse)) {
            return false;
        }

        ChangeUnifiedAgentConfigurationCompartmentResponse other =
                (ChangeUnifiedAgentConfigurationCompartmentResponse) o;
