...
public class CreateLogSavedSearchResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateLogSavedSearchResponse> {
         ...
         */
        @Override
        public Builder copy(CreateLogSavedSearchResponse o) {
         ...
         */
        @Override
        public CreateLogSavedSearchResponse build() {
            return new CreateLogSavedSearchResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogSavedSearchResponse)) {
            return false;
        }

        CreateLogSavedSearchResponse other = (CreateLogSavedSearchResponse) o;
