...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/budget/GetBudgetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBudgetRequest.
 */
...
public class GetBudgetRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBudgetRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetBudgetRequest
         */
        public GetBudgetRequest build() {
            GetBudgetRequest request = buildWithoutInvocationCallback();
        ...
        public GetBudgetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetBudgetRequest(budgetId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().budgetId(budgetId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBudgetRequest)) {
            return false;
        }

        GetBudgetRequest other = (GetBudgetRequest) o;
