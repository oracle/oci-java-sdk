...
public class CostAdPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.budget.model.CostAlertSubscriptionSummary} objects
     * contained in responses from the listCostAlertSubscriptions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.budget.model.CostAlertSubscriptionSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.budget.model.CostAnomalyEventSummary} objects
     * contained in responses from the listCostAnomalyEvents operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.budget.model.CostAnomalyEventSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.budget.model.CostAnomalyEventSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListCostAnomalyEventsRequest.Builder, ListCostAnomalyEventsRequest,
                ListCostAnomalyEventsResponse, com.oracle.bmc.budget.model.CostAnomalyEventSummary>(
                new java.util.function.Supplier<ListCostAnomalyEventsRequest.Builder>() {
                    @Override
                    public ListCostAnomalyEventsRequest.Builder get() {
                        return ListCostAnomalyEventsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.budget.model.CostAnomalyMonitorSummary} objects
     * contained in responses from the listCostAnomalyMonitors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.budget.model.CostAnomalyMonitorSummary} objects
     * contained in responses received from the service.
     */
