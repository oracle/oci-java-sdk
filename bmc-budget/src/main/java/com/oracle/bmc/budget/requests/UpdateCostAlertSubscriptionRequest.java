...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/budget/UpdateCostAlertSubscriptionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCostAlertSubscriptionRequest.
 */
...
public class UpdateCostAlertSubscriptionRequest
    ...
    public static class Builder
        ...
        public UpdateCostAlertSubscriptionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCostAlertSubscriptionRequest(costAlertSubscriptionId, updateCostAlertSubscriptionDetails, ifMatch, opcRequestId);
        }
    }
