...
public class UpdateBudgetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateBudgetResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBudgetResponse)) {
            return false;
        }

        UpdateBudgetResponse other = (UpdateBudgetResponse) o;
