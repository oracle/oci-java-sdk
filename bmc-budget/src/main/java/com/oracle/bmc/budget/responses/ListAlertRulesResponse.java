...
public class ListAlertRulesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public Builder items(java.util.List<com.oracle.bmc.budget.model.AlertRuleSummary> items) {
            this.items = items;
            return this;
        }
        ...
        public ListAlertRulesResponse build() {
            return new ListAlertRulesResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAlertRulesResponse)) {
            return false;
        }

        ListAlertRulesResponse other = (ListAlertRulesResponse) o;
