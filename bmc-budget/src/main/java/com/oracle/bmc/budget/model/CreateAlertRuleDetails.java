...
/**
 * The create alert rule details. This is a batch-create. <br>
...
public final class CreateAlertRuleDetails
    ...
    public static class Builder {
        ...
        /**
         * The audience that receives the alert when it triggers. An empty string is interpreted as
         * null.
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAlertRuleDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAlertRuleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAlertRuleDetails)) {
            return false;
        }

        CreateAlertRuleDetails other = (CreateAlertRuleDetails) o;
