...
/**
 * Results of a CostAnomalyEventAnalytics search. <br>
...
public final class CostAnomalyEventAnalyticCollection
    ...
    public CostAnomalyEventAnalyticCollection(
            java.util.List<CostAnomalyEventAnalyticSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<CostAnomalyEventAnalyticSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<CostAnomalyEventAnalyticSummary> items) {
            this.items = items;
    ...
    /** The list of CostAnomalyEvent Analytic summary. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<CostAnomalyEventAnalyticSummary> items;
     ...
     * @return the value
     */
    public java.util.List<CostAnomalyEventAnalyticSummary> getItems() {
        return items;
    }
