...
public class GetCostAnomalyEventConverter {
    ...
    public static com.oracle.bmc.budget.requests.GetCostAnomalyEventRequest interceptRequest(
            com.oracle.bmc.budget.requests.GetCostAnomalyEventRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.budget.responses.GetCostAnomalyEventResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.budget.responses.GetCostAnomalyEventResponse>() {
                            @Override
                            public com.oracle.bmc.budget.responses.GetCostAnomalyEventResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.budget.responses.GetCostAnomalyEventResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.budget.model.CostAnomalyEvent
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
                                ...
                                com.oracle.bmc.budget.responses.GetCostAnomalyEventResponse.Builder
                                        builder =
