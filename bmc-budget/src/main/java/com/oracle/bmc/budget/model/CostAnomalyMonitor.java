...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CostAnomalyMonitor.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CostAnomalyMonitor extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CostAnomalyMonitor build() {
            CostAnomalyMonitor model =
                    new CostAnomalyMonitor(
                            this.id,
                            this.compartmentId,
                            this.name,
                            this.type,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CostAnomalyMonitor model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CostAnomalyMonitor)) {
            return false;
        }

        CostAnomalyMonitor other = (CostAnomalyMonitor) o;
