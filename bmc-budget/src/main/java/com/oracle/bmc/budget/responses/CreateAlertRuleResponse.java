...
public class CreateAlertRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateAlertRuleResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateAlertRuleResponse> {
        ...
        public CreateAlertRuleResponse build() {
            return new CreateAlertRuleResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, alertRule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAlertRuleResponse)) {
            return false;
        }

        CreateAlertRuleResponse other = (CreateAlertRuleResponse) o;
