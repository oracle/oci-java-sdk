...
public final class CostAlertSubscriptionCollection
    ...
    public CostAlertSubscriptionCollection(java.util.List<CostAlertSubscriptionSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        private java.util.List<CostAlertSubscriptionSummary> items;
         ...
         * @return this builder
         */
        public Builder items(java.util.List<CostAlertSubscriptionSummary> items) {
            this.items = items;
    ...
    /** A page of CostAnomalyMonitorSummary objects. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<CostAlertSubscriptionSummary> items;
     ...
     * @return the value
     */
    public java.util.List<CostAlertSubscriptionSummary> getItems() {
        return items;
    }
