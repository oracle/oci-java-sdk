...
public class DeleteBudgetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteBudgetResponse> {
        ...
        public DeleteBudgetResponse build() {
            return new DeleteBudgetResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBudgetResponse)) {
            return false;
        }

        DeleteBudgetResponse other = (DeleteBudgetResponse) o;
