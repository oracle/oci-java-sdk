...
public class DeleteAlertRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteAlertRuleResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAlertRuleResponse)) {
            return false;
        }

        DeleteAlertRuleResponse other = (DeleteAlertRuleResponse) o;
