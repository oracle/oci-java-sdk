...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/budget/ListCostAnomalyEventsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCostAnomalyEventsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190111")
public class ListCostAnomalyEventsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCostAnomalyEventsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCostAnomalyEventsRequest o) {
        ...
        /**
         * Build the instance of ListCostAnomalyEventsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCostAnomalyEventsRequest
         */
        public ListCostAnomalyEventsRequest build() {
            ListCostAnomalyEventsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCostAnomalyEventsRequest
         */
        public ListCostAnomalyEventsRequest buildWithoutInvocationCallback() {
            ListCostAnomalyEventsRequest request = new ListCostAnomalyEventsRequest();
            ...
            return request;
            // new ListCostAnomalyEventsRequest(compartmentId, limit, page, sortOrder, sortBy, name, costAnomalyMonitorId, targetTenantId, timeAnomalyEventStartDate, timeAnomalyEventEndDate, region, costImpact, costImpactPercentage, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCostAnomalyEventsRequest)) {
            return false;
        }

        ListCostAnomalyEventsRequest other = (ListCostAnomalyEventsRequest) o;
