...
public class QueryDiagnosisSummaryConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(QueryDiagnosisSummaryConverter.class);

    public static com.oracle.bmc.clusterhealth.requests.QueryDiagnosisSummaryRequest
            interceptRequest(
                    com.oracle.bmc.clusterhealth.requests.QueryDiagnosisSummaryRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.clusterhealth.responses.QueryDiagnosisSummaryResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.clusterhealth.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.clusterhealth.responses.QueryDiagnosisSummaryResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.clusterhealth.responses.QueryDiagnosisSummaryResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.clusterhealth.responses
                                                        .QueryDiagnosisSummaryResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.diagnosisSummaryCollection(response.getItem());
