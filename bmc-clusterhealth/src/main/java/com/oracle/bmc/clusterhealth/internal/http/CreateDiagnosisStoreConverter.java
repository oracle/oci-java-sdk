...
public class CreateDiagnosisStoreConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateDiagnosisStoreConverter.class);

    public static com.oracle.bmc.clusterhealth.requests.CreateDiagnosisStoreRequest
            interceptRequest(
                    com.oracle.bmc.clusterhealth.requests.CreateDiagnosisStoreRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20260331").path("diagnosisStores");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.clusterhealth.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.clusterhealth.responses.CreateDiagnosisStoreResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.http.internal.WithHeaders<
                                                com.oracle.bmc.clusterhealth.model.DiagnosisStore>
                                ...
                                com.oracle.bmc.clusterhealth.responses.CreateDiagnosisStoreResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.clusterhealth.responses
                                                        .CreateDiagnosisStoreResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.diagnosisStore(response.getItem());
