...
public class DiagnosisWaiters {
    ...
    public DiagnosisWaiters(
            java.util.concurrent.ExecutorService executorService, Diagnosis client) {
     ...
     */
    public com.oracle.bmc.waiter.Waiter<GetDiagnosisStoreRequest, GetDiagnosisStoreResponse>
            forDiagnosisStore(
    ...
    public com.oracle.bmc.waiter.Waiter<GetDiagnosisStoreRequest, GetDiagnosisStoreResponse>
            forDiagnosisStore(
                    GetDiagnosisStoreRequest request,
                    com.oracle.bmc.clusterhealth.model.DiagnosisStore.LifecycleState targetState,
    ...
    // Helper method to create a new Waiter for DiagnosisStore.
    private com.oracle.bmc.waiter.Waiter<GetDiagnosisStoreRequest, GetDiagnosisStoreResponse>
            forDiagnosisStore(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetDiagnosisStoreRequest request,
                    final com.oracle.bmc.clusterhealth.model.DiagnosisStore.LifecycleState...
                            targetStates) {
        final java.util.Set<com.oracle.bmc.clusterhealth.model.DiagnosisStore.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetDiagnosisStoreResponse apply(
                                    GetDiagnosisStoreRequest request) {
                                return client.getDiagnosisStore(request);
                            }
                        },
                        new java.util.function.Predicate<GetDiagnosisStoreResponse>() {
                            @Override
                            public boolean test(GetDiagnosisStoreResponse response) {
                                return targetStatesSet.contains(
                                        response.getDiagnosisStore().getLifecycleState());
                            }
                        },
