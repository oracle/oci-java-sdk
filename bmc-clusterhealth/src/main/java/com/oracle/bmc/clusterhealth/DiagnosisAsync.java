...
public interface DiagnosisAsync extends AutoCloseable {
    ...
    /**
     * Moves a Diagnosis into a different compartment within the same tenancy. For information about
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ChangeDiagnosisStoreCompartmentResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateDiagnosisStoreResponse> createDiagnosisStore(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteDiagnosisStoreResponse> deleteDiagnosisStore(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetDiagnosisStoreResponse> getDiagnosisStore(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListDiagnosisStoresResponse> listDiagnosisStores(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<QueryDiagnosisByHealthCheckKeyResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<QueryDiagnosisSummaryResponse> queryDiagnosisSummary(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<RequestDiagnosisResponse> requestDiagnosis(
            RequestDiagnosisRequest request,
            com.oracle.bmc.responses.AsyncHandler<RequestDiagnosisRequest, RequestDiagnosisResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateDiagnosisStoreResponse> updateDiagnosisStore(
