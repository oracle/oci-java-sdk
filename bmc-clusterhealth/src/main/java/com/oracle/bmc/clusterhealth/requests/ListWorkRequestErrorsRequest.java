...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/clusterhealth/ListWorkRequestErrorsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWorkRequestErrorsRequest.
 */
...
public class ListWorkRequestErrorsRequest
     ...
     */
    private com.oracle.bmc.clusterhealth.model.SortOrder sortOrder;

    /**
     * The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}).
     */
    public com.oracle.bmc.clusterhealth.model.SortOrder getSortOrder() {
        return sortOrder;
    }
    ...
    public static class Builder
         ...
         * The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}).
         */
        private com.oracle.bmc.clusterhealth.model.SortOrder sortOrder = null;
         ...
         * @return this builder instance
         */
        public Builder sortOrder(com.oracle.bmc.clusterhealth.model.SortOrder sortOrder) {
