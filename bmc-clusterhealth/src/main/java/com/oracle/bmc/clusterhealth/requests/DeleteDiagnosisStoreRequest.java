...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/clusterhealth/DeleteDiagnosisStoreExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDiagnosisStoreRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260331")
public class DeleteDiagnosisStoreRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDiagnosisStoreRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDiagnosisStoreRequest o) {
        ...
        /**
         * Build the instance of DeleteDiagnosisStoreRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDiagnosisStoreRequest
         */
        public DeleteDiagnosisStoreRequest build() {
            DeleteDiagnosisStoreRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDiagnosisStoreRequest
         */
        public DeleteDiagnosisStoreRequest buildWithoutInvocationCallback() {
            DeleteDiagnosisStoreRequest request = new DeleteDiagnosisStoreRequest();
            request.diagnosisStoreId = diagnosisStoreId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDiagnosisStoreRequest(diagnosisStoreId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDiagnosisStoreRequest)) {
            return false;
        }

        DeleteDiagnosisStoreRequest other = (DeleteDiagnosisStoreRequest) o;
