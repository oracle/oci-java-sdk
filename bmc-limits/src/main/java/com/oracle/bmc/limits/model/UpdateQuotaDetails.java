...
public final class UpdateQuotaDetails {
    @Deprecated
    ...
    public static class Builder {
        ...
        public UpdateQuotaDetails build() {
            UpdateQuotaDetails __instance__ =
                    new UpdateQuotaDetails(description, statements, freeformTags, definedTags);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateQuotaDetails o) {
