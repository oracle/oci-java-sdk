...
public class UpdateQuotaResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateQuotaResponse> {
        ...
        public UpdateQuotaResponse build() {
            return new UpdateQuotaResponse(__httpStatusCode__, headers, opcRequestId, etag, quota);
        }
    }
