...
public class DeleteQuotaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteQuotaResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteQuotaResponse o) {
        ...
        public DeleteQuotaResponse build() {
            return new DeleteQuotaResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteQuotaResponse)) {
            return false;
        }

        DeleteQuotaResponse other = (DeleteQuotaResponse) o;
