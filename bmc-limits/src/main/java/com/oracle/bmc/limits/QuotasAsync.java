...
public interface QuotasAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateQuotaResponse> createQuota(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteQuotaResponse> deleteQuota(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetQuotaResponse> getQuota(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateQuotaResponse> updateQuota(
