...
public class AddQuotaLockResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<AddQuotaLockResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddQuotaLockResponse)) {
            return false;
        }

        AddQuotaLockResponse other = (AddQuotaLockResponse) o;
