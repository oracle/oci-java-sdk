...
public interface LimitsAsync extends AutoCloseable {
     ...
     * compartment for the given limit. If the subscription ID is provided, then usage for resource
    ...
    /**
     * Includes a list of resource limits that are currently supported. If the subscription ID is
     * provided, then only resource limits supported by the subscription will be returned. If the
    ...
    /**
     * Includes a full list of resource limits belonging to a given service. If the subscription ID
     * is provided, the limit value for the subscription will be returned.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     * @return A Future that can be used to get the response if no AsyncHandler was provided. Note,
