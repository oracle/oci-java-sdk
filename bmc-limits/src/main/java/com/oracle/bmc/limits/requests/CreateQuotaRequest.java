...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/limits/CreateQuotaExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateQuotaRequest.
 */
...
public class CreateQuotaRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(CreateQuotaRequest o) {
            createQuotaDetails(o.getCreateQuotaDetails());
        ...
        public CreateQuotaRequest build() {
            CreateQuotaRequest request = buildWithoutInvocationCallback();
