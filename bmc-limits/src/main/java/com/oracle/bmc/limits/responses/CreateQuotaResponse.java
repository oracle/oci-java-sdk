...
public class CreateQuotaResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateQuotaResponse> {
        ...
        public CreateQuotaResponse build() {
            return new CreateQuotaResponse(__httpStatusCode__, headers, opcRequestId, etag, quota);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateQuotaResponse)) {
            return false;
        }

        CreateQuotaResponse other = (CreateQuotaResponse) o;
