...
public class RemoveQuotaLockResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RemoveQuotaLockResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveQuotaLockResponse> {
         ...
         */
        @Override
        public Builder copy(RemoveQuotaLockResponse o) {
         ...
         */
        @Override
        public RemoveQuotaLockResponse build() {
            return new RemoveQuotaLockResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, quota);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveQuotaLockResponse)) {
            return false;
        }

        RemoveQuotaLockResponse other = (RemoveQuotaLockResponse) o;
