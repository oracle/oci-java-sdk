...
public final class SqlTuningSetInput extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public SqlTuningSetInput build() {
            SqlTuningSetInput model = new SqlTuningSetInput(this.name, this.owner);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SqlTuningSetInput model) {
