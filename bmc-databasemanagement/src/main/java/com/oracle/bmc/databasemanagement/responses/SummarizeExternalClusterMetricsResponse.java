...
public class SummarizeExternalClusterMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeExternalClusterMetricsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SummarizeExternalClusterMetricsResponse o) {
         ...
         */
        public SummarizeExternalClusterMetricsResponse build() {
            return new SummarizeExternalClusterMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalClusterMetricsResponse)) {
            return false;
        }

        SummarizeExternalClusterMetricsResponse other = (SummarizeExternalClusterMetricsResponse) o;
