...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAwrDbMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDbMetricsRequest.
 */
...
public class SummarizeAwrDbMetricsRequest
    ...
    public static class Builder
         ...
         * @return instance of SummarizeAwrDbMetricsRequest
         */
        public SummarizeAwrDbMetricsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDbMetricsRequest request = new SummarizeAwrDbMetricsRequest();
            ...
            return request;
            // new SummarizeAwrDbMetricsRequest(managedDatabaseId, awrDbId, name, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDbMetricsRequest)) {
            return false;
        }

        SummarizeAwrDbMetricsRequest other = (SummarizeAwrDbMetricsRequest) o;
