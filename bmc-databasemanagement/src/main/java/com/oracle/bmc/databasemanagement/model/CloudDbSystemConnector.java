...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = CloudDbSystemConnector.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CloudDbSystemMacsConnector.class,
        name = "MACS"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class CloudDbSystemConnector extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected CloudDbSystemConnector(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudDbSystemConnector(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbSystemConnector)) {
            return false;
        }

        CloudDbSystemConnector other = (CloudDbSystemConnector) o;
