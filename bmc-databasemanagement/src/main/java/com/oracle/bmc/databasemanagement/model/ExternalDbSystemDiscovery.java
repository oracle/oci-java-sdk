...
/**
 * The details of an external DB system discovery. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExternalDbSystemDiscovery.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExternalDbSystemDiscovery
    ...
    public ExternalDbSystemDiscovery(
            String id,
            String displayName,
            String compartmentId,
            String agentId,
            String gridHome,
            java.util.List<DiscoveredExternalDbSystemComponent> discoveredComponents,
            String resourceId,
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("discoveredComponents")
        private java.util.List<DiscoveredExternalDbSystemComponent> discoveredComponents;

        /**
         * The list of DB system components that were found in the DB system discovery.
         *
         * @param discoveredComponents the value to set
         * @return this builder
         */
        public Builder discoveredComponents(
                java.util.List<DiscoveredExternalDbSystemComponent> discoveredComponents) {
            this.discoveredComponents = discoveredComponents;
            this.__explicitlySet__.add("discoveredComponents");
            return this;
        }
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * existing OCI resource matching the discovered DB system.
         */
        ...
        public ExternalDbSystemDiscovery build() {
            ExternalDbSystemDiscovery model =
                    new ExternalDbSystemDiscovery(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.agentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalDbSystemDiscovery model) {
            ...
            if (model.wasPropertyExplicitlySet("discoveredComponents")) {
                this.discoveredComponents(model.getDiscoveredComponents());
            }
    ...
    /** The list of DB system components that were found in the DB system discovery. */
    @com.fasterxml.jackson.annotation.JsonProperty("discoveredComponents")
    private final java.util.List<DiscoveredExternalDbSystemComponent> discoveredComponents;
     ...
     * @return the value
     */
    public java.util.List<DiscoveredExternalDbSystemComponent> getDiscoveredComponents() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalDbSystemDiscovery(");
        ...
        sb.append(", discoveredComponents=").append(String.valueOf(this.discoveredComponents));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalDbSystemDiscovery)) {
            return false;
        }

        ExternalDbSystemDiscovery other = (ExternalDbSystemDiscovery) o;
        return java.util.Objects.equals(this.id, other.id)
                ...
                && java.util.Objects.equals(this.discoveredComponents, other.discoveredComponents)
        ...
        result =
                (result * PRIME)
                        + (this.discoveredComponents == null
                                ? 43
                                : this.discoveredComponents.hashCode());
