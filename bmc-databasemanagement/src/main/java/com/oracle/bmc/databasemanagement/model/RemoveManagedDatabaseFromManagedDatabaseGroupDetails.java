...
public final class RemoveManagedDatabaseFromManagedDatabaseGroupDetails {
    ...
    public static class Builder {
        ...
        public RemoveManagedDatabaseFromManagedDatabaseGroupDetails build() {
            RemoveManagedDatabaseFromManagedDatabaseGroupDetails __instance__ =
                    new RemoveManagedDatabaseFromManagedDatabaseGroupDetails(managedDatabaseId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveManagedDatabaseFromManagedDatabaseGroupDetails o) {
