...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudAsmInstanceParameters.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudAsmInstanceParameters
    ...
    public CloudAsmInstanceParameters(
    ...
    public static class Builder {
        ...
        public CloudAsmInstanceParameters build() {
            CloudAsmInstanceParameters model =
                    new CloudAsmInstanceParameters(
                            this.asmInstanceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudAsmInstanceParameters model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudAsmInstanceParameters(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAsmInstanceParameters)) {
            return false;
        }

        CloudAsmInstanceParameters other = (CloudAsmInstanceParameters) o;
