...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CloudAsmInstance.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CloudAsmInstance extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CloudAsmInstance build() {
            CloudAsmInstance model =
                    new CloudAsmInstance(
                            this.id,
                            this.dbaasId,
                            this.displayName,
                            this.componentName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudAsmInstance model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAsmInstance)) {
            return false;
        }

        CloudAsmInstance other = (CloudAsmInstance) o;
