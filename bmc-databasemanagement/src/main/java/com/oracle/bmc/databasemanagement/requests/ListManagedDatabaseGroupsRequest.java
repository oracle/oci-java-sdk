...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListManagedDatabaseGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedDatabaseGroupsRequest.
 */
...
public class ListManagedDatabaseGroupsRequest
    ...
    public static class Builder
        ...
        public ListManagedDatabaseGroupsRequest buildWithoutInvocationCallback() {
            ListManagedDatabaseGroupsRequest request = new ListManagedDatabaseGroupsRequest();
            ...
            return request;
            // new ListManagedDatabaseGroupsRequest(compartmentId, opcRequestId, id, name, lifecycleState, page, limit, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedDatabaseGroupsRequest)) {
            return false;
        }

        ListManagedDatabaseGroupsRequest other = (ListManagedDatabaseGroupsRequest) o;
