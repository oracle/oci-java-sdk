...
public class SummarizeExternalListenerMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeExternalListenerMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeExternalListenerMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeExternalListenerMetricsResponse build() {
            return new SummarizeExternalListenerMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalListenerMetricsResponse)) {
            return false;
        }

        SummarizeExternalListenerMetricsResponse other =
                (SummarizeExternalListenerMetricsResponse) o;
