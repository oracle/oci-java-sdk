...
public class GetDatabaseHaBackupDetailsRequest
    ...
    public static class Builder
         ...
         */
        public GetDatabaseHaBackupDetailsRequest build() {
            GetDatabaseHaBackupDetailsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDatabaseHaBackupDetailsRequest
         */
        public GetDatabaseHaBackupDetailsRequest buildWithoutInvocationCallback() {
            GetDatabaseHaBackupDetailsRequest request = new GetDatabaseHaBackupDetailsRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseHaBackupDetailsRequest)) {
            return false;
        }

        GetDatabaseHaBackupDetailsRequest other = (GetDatabaseHaBackupDetailsRequest) o;
