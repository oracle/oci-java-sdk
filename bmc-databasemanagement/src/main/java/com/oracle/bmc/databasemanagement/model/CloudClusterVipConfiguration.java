...
/**
 * The details of the Virtual IP (VIP) address for a node in a cloud cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudClusterVipConfiguration.Builder.class)
...
public final class CloudClusterVipConfiguration
    ...
    public CloudClusterVipConfiguration(String nodeName, String address, Integer networkNumber) {
        super();
    ...
    public static class Builder {
        ...
        public CloudClusterVipConfiguration build() {
            CloudClusterVipConfiguration model =
                    new CloudClusterVipConfiguration(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudClusterVipConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudClusterVipConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudClusterVipConfiguration)) {
            return false;
        }

        CloudClusterVipConfiguration other = (CloudClusterVipConfiguration) o;
