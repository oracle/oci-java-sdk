...
public class GetDatabaseFleetDataguardMetricsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetDatabaseFleetDataguardMetricsConverter.class);

    public static com.oracle.bmc.databasemanagement.requests.GetDatabaseFleetDataguardMetricsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.databasemanagement.requests.GetDatabaseFleetDataguardMetricsRequest
                    request) {
        Validate.notNull(request, "request instance is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20201101").path("databaseFleetDataguardMetrics");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasemanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemanagement.responses.GetDatabaseFleetDataguardMetricsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.databaseFleetDataguardMetrics(response.getItem());
