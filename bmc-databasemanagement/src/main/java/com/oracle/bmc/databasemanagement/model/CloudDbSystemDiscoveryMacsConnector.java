...
/**
 * The details of a cloud DB system connector that uses the [Management Agent Cloud Service
 * (MACS)](https://docs.oracle.com/iaas/management-agents/index.html) to connect to a cloud DB
 * system component. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudDbSystemDiscoveryMacsConnector.Builder.class)
...
public final class CloudDbSystemDiscoveryMacsConnector extends CloudDbSystemDiscoveryConnector {
    ...
    public static class Builder {
         ...
         * management agent used for the cloud DB system connector.
         */
        ...
        private CloudDbSystemConnectionInfo connectionInfo;

        public Builder connectionInfo(CloudDbSystemConnectionInfo connectionInfo) {
        ...
        public CloudDbSystemDiscoveryMacsConnector build() {
            CloudDbSystemDiscoveryMacsConnector model =
                    new CloudDbSystemDiscoveryMacsConnector(
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudDbSystemDiscoveryMacsConnector model) {
    ...
    @Deprecated
    public CloudDbSystemDiscoveryMacsConnector(
            String displayName,
            String connectionStatus,
            String connectionFailureMessage,
            java.util.Date timeConnectionStatusLastUpdated,
            String agentId,
            CloudDbSystemConnectionInfo connectionInfo) {
        super(
                displayName,
                connectionStatus,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("connectionInfo")
    private final CloudDbSystemConnectionInfo connectionInfo;

    public CloudDbSystemConnectionInfo getConnectionInfo() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudDbSystemDiscoveryMacsConnector(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbSystemDiscoveryMacsConnector)) {
            return false;
        }

        CloudDbSystemDiscoveryMacsConnector other = (CloudDbSystemDiscoveryMacsConnector) o;
