...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateCloudDbSystemConnectorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCloudDbSystemConnectorRequest.
 */
...
public class UpdateCloudDbSystemConnectorRequest
    ...
    public static class Builder
        ...
        public UpdateCloudDbSystemConnectorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCloudDbSystemConnectorRequest(cloudDbSystemConnectorId, updateCloudDbSystemConnectorDetails, ifMatch, opcRequestId);
        }
    }
