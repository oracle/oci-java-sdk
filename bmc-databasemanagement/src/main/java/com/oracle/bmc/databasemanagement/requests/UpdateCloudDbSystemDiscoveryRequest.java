...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateCloudDbSystemDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCloudDbSystemDiscoveryRequest.
 */
...
public class UpdateCloudDbSystemDiscoveryRequest
    ...
    public static class Builder
        ...
        public UpdateCloudDbSystemDiscoveryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCloudDbSystemDiscoveryRequest(cloudDbSystemDiscoveryId, updateCloudDbSystemDiscoveryDetails, opcRequestId, ifMatch);
        }
    }
