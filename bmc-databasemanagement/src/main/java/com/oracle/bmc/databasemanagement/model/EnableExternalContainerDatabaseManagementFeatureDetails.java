...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EnableExternalContainerDatabaseManagementFeatureDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class EnableExternalContainerDatabaseManagementFeatureDetails
    ...
    public static class Builder {
        ...
        public EnableExternalContainerDatabaseManagementFeatureDetails build() {
            EnableExternalContainerDatabaseManagementFeatureDetails model =
                    new EnableExternalContainerDatabaseManagementFeatureDetails(
                            this.featureDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableExternalContainerDatabaseManagementFeatureDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableExternalContainerDatabaseManagementFeatureDetails)) {
            return false;
        }

        EnableExternalContainerDatabaseManagementFeatureDetails other =
                (EnableExternalContainerDatabaseManagementFeatureDetails) o;
