...
/**
 * The details of an ASM instance discovered in a cloud DB system discovery run. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DiscoveredCloudAsmInstance.Builder.class)
...
public final class DiscoveredCloudAsmInstance extends DiscoveredCloudDbSystemComponent {
    ...
    public static class Builder {
        ...
        public DiscoveredCloudAsmInstance build() {
            DiscoveredCloudAsmInstance model =
                    new DiscoveredCloudAsmInstance(
                            this.componentId,
                            this.displayName,
                            this.componentName,
                            this.resourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveredCloudAsmInstance model) {
    ...
    @Deprecated
    public DiscoveredCloudAsmInstance(
            String componentId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredCloudAsmInstance(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredCloudAsmInstance)) {
            return false;
        }

        DiscoveredCloudAsmInstance other = (DiscoveredCloudAsmInstance) o;
