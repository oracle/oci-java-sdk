...
/**
 * The details of a specific job run. <br>
...
public final class JobRun extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    /**
     * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of Managed
     * Database where the parent job has to be executed.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("managedDatabaseId")
    ...
    /** The status of the job run. */
    public enum RunStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Completed("COMPLETED"),
        Failed("FAILED"),
