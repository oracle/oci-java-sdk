...
/**
 * The details required to enable Automatic SPM Evolve Advisor task. It takes either credentials or
...
public final class EnableAutomaticSpmEvolveAdvisorTaskDetails
    ...
    public EnableAutomaticSpmEvolveAdvisorTaskDetails(
    ...
    public static class Builder {
        ...
        public EnableAutomaticSpmEvolveAdvisorTaskDetails build() {
            EnableAutomaticSpmEvolveAdvisorTaskDetails model =
                    new EnableAutomaticSpmEvolveAdvisorTaskDetails(
