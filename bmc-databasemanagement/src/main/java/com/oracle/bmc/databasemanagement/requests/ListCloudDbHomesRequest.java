...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudDbHomesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudDbHomesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListCloudDbHomesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudDbHomesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudDbHomesRequest o) {
        ...
        /**
         * Build the instance of ListCloudDbHomesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudDbHomesRequest
         */
        public ListCloudDbHomesRequest build() {
            ListCloudDbHomesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudDbHomesRequest
         */
        public ListCloudDbHomesRequest buildWithoutInvocationCallback() {
            ListCloudDbHomesRequest request = new ListCloudDbHomesRequest();
            ...
            return request;
            // new ListCloudDbHomesRequest(compartmentId, cloudDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudDbHomesRequest)) {
            return false;
        }

        ListCloudDbHomesRequest other = (ListCloudDbHomesRequest) o;
