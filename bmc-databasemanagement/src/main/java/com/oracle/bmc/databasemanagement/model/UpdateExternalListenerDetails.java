...
/**
 * The details required to update an external listener. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateExternalListenerDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UpdateExternalListenerDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalConnectorId"})
    public UpdateExternalListenerDetails(String externalConnectorId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateExternalListenerDetails build() {
            UpdateExternalListenerDetails model =
                    new UpdateExternalListenerDetails(this.externalConnectorId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateExternalListenerDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalListenerDetails)) {
            return false;
        }

        UpdateExternalListenerDetails other = (UpdateExternalListenerDetails) o;
