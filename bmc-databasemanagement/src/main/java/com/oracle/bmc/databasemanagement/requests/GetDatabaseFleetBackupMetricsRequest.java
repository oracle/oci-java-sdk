...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetDatabaseFleetBackupMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseFleetBackupMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class GetDatabaseFleetBackupMetricsRequest
        extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {

    /**
     * Indicates whether the database is a cloud database or an external database.
     */
    private com.oracle.bmc.databasemanagement.model.DatabaseHostedIn databaseHostedIn;

    /**
     * Indicates whether the database is a cloud database or an external database.
     */
    public com.oracle.bmc.databasemanagement.model.DatabaseHostedIn getDatabaseHostedIn() {
        return databaseHostedIn;
    }
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDatabaseFleetBackupMetricsRequest, java.lang.Void> {
         ...
         * Indicates whether the database is a cloud database or an external database.
         */
        private com.oracle.bmc.databasemanagement.model.DatabaseHostedIn databaseHostedIn = null;

        /**
         * Indicates whether the database is a cloud database or an external database.
         * @param databaseHostedIn the value to set
         * @return this builder instance
         */
        public Builder databaseHostedIn(
                com.oracle.bmc.databasemanagement.model.DatabaseHostedIn databaseHostedIn) {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDatabaseFleetBackupMetricsRequest o) {
            databaseHostedIn(o.getDatabaseHostedIn());
        ...
        /**
         * Build the instance of GetDatabaseFleetBackupMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDatabaseFleetBackupMetricsRequest
         */
        public GetDatabaseFleetBackupMetricsRequest build() {
            GetDatabaseFleetBackupMetricsRequest request = buildWithoutInvocationCallback();
        ...
        public GetDatabaseFleetBackupMetricsRequest buildWithoutInvocationCallback() {
            GetDatabaseFleetBackupMetricsRequest request =
                    new GetDatabaseFleetBackupMetricsRequest();
            request.databaseHostedIn = databaseHostedIn;
            ...
            return request;
            // new GetDatabaseFleetBackupMetricsRequest(databaseHostedIn, startTime, endTime, opcRequestId, managedDatabaseGroupId, compartmentId, filterByMetricNames, page, limit, sortBy, sortOrder, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseFleetBackupMetricsRequest)) {
            return false;
        }

        GetDatabaseFleetBackupMetricsRequest other = (GetDatabaseFleetBackupMetricsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.databaseHostedIn, other.databaseHostedIn)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.databaseHostedIn == null ? 43 : this.databaseHostedIn.hashCode());
