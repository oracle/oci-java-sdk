...
public class GetCloudAsmInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetCloudAsmInstanceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetCloudAsmInstanceResponse> {
         ...
         */
        @Override
        public Builder copy(GetCloudAsmInstanceResponse o) {
         ...
         */
        @Override
        public GetCloudAsmInstanceResponse build() {
            return new GetCloudAsmInstanceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, cloudAsmInstance);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCloudAsmInstanceResponse)) {
            return false;
        }

        GetCloudAsmInstanceResponse other = (GetCloudAsmInstanceResponse) o;
