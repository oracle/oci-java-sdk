...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListAwrDbsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAwrDbsRequest.
 */
...
public class ListAwrDbsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListAwrDbsRequest
         */
        public ListAwrDbsRequest buildWithoutInvocationCallback() {
            ListAwrDbsRequest request = new ListAwrDbsRequest();
            ...
            return request;
            // new ListAwrDbsRequest(managedDatabaseId, name, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAwrDbsRequest)) {
            return false;
        }

        ListAwrDbsRequest other = (ListAwrDbsRequest) o;
