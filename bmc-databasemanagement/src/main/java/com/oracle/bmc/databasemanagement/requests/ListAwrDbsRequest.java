 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAwrDbsRequest.
 */
...
public class ListAwrDbsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAwrDbsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAwrDbsRequest(managedDatabaseId, name, timeGreaterThanOrEqualTo,
            // timeLessThanOrEqualTo, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken,
