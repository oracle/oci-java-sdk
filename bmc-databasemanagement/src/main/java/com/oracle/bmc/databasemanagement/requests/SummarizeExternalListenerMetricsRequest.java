...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeExternalListenerMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeExternalListenerMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class SummarizeExternalListenerMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeExternalListenerMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeExternalListenerMetricsRequest o) {
        ...
        /**
         * Build the instance of SummarizeExternalListenerMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeExternalListenerMetricsRequest
         */
        public SummarizeExternalListenerMetricsRequest build() {
            SummarizeExternalListenerMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeExternalListenerMetricsRequest
         */
        public SummarizeExternalListenerMetricsRequest buildWithoutInvocationCallback() {
            SummarizeExternalListenerMetricsRequest request =
                    new SummarizeExternalListenerMetricsRequest();
            ...
            return request;
            // new SummarizeExternalListenerMetricsRequest(externalListenerId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalListenerMetricsRequest)) {
            return false;
        }

        SummarizeExternalListenerMetricsRequest other = (SummarizeExternalListenerMetricsRequest) o;
