 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDataFileRequest.
 */
...
public class RemoveDataFileRequest
    ...
    public com.oracle.bmc.databasemanagement.model.RemoveDataFileDetails getBody$() {
        return removeDataFileDetails;
    }

    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    RemoveDataFileRequest,
                    com.oracle.bmc.databasemanagement.model.RemoveDataFileDetails> {
         ...
         * The details required to remove a data file or temp file from the tablespace.
         *
         * @param removeDataFileDetails the value to set
         * @return this builder instance
         */
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDataFileRequest o) {
            managedDatabaseId(o.getManagedDatabaseId());
            tablespaceName(o.getTablespaceName());
            removeDataFileDetails(o.getRemoveDataFileDetails());
         ...
         */
        public RemoveDataFileRequest build() {
            RemoveDataFileRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.databasemanagement.model.RemoveDataFileDetails body) {
        ...
        public RemoveDataFileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RemoveDataFileRequest(managedDatabaseId, tablespaceName, removeDataFileDetails,
