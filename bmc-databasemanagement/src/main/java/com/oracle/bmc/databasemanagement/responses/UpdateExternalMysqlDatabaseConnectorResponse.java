...
public class UpdateExternalMysqlDatabaseConnectorResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalMysqlDatabaseConnectorResponse)) {
            return false;
        }

        UpdateExternalMysqlDatabaseConnectorResponse other =
                (UpdateExternalMysqlDatabaseConnectorResponse) o;
