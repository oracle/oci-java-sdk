...
/**
 * The summary of a SQL Tuning Advisor task. <br>
...
public final class SqlTuningAdvisorTaskSummary
    ...
    public static class Builder {
        ...
        /**
         * The number of days left before the task expires. If the value equals -1, then the task
         * has no expiration time (UNLIMITED).
         */
    ...
    /**
     * The number of days left before the task expires. If the value equals -1, then the task has no
