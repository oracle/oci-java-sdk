...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "protocol",
    defaultImpl = CloudListenerEndpoint.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CloudListenerTcpsEndpoint.class,
        name = "TCPS"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CloudListenerIpcEndpoint.class,
        name = "IPC"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CloudListenerTcpEndpoint.class,
        name = "TCP"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class CloudListenerEndpoint extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"services"})
    protected CloudListenerEndpoint(java.util.List<String> services) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudListenerEndpoint(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudListenerEndpoint)) {
            return false;
        }

        CloudListenerEndpoint other = (CloudListenerEndpoint) o;
