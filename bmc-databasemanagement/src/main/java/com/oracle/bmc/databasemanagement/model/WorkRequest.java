...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * picks the primary resource whose compartment should be used.
         */
        ...
        /**
         * The date and time the work request was accepted, as described in [RFC
         * 3339](https://tools.ietf.org/rfc/rfc3339). The precision for this time object in
         * milliseconds.
         */
         ...
         * described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339). The precision for this time
         ...
         * as described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339). The precision for this
         * time object is in milliseconds.
         */
     ...
     * multiple resources that are not in the same compartment, then the system picks the primary
     ...
     * [RFC 3339](https://tools.ietf.org/rfc/rfc3339). The precision for this time object is in
     * milliseconds.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("timeStarted")
