...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudExadataStorageServersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudExadataStorageServersRequest.
 */
...
public class ListCloudExadataStorageServersRequest
    ...
    public static class Builder
        ...
        public ListCloudExadataStorageServersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCloudExadataStorageServersRequest(compartmentId, cloudExadataInfrastructureId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
