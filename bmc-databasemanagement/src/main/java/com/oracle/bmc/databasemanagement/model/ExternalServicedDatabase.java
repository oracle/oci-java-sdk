...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ExternalServicedDatabase.Builder.class
)
...
public final class ExternalServicedDatabase
    ...
    public ExternalServicedDatabase(
            String id,
            String displayName,
            String dbUniqueName,
    ...
    public static class Builder {
        ...
        public ExternalServicedDatabase build() {
            ExternalServicedDatabase model =
                    new ExternalServicedDatabase(
                            this.id,
                            this.displayName,
                            this.dbUniqueName,
                            this.compartmentId,
    ...
    public boolean equals(Object o) {
        ...
        ExternalServicedDatabase other = (ExternalServicedDatabase) o;
