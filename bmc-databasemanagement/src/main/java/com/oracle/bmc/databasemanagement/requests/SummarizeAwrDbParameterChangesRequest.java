...
public class SummarizeAwrDbParameterChangesRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbParameterChangesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbParameterChangesRequest(managedDatabaseId, awrDbId, name, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken);
        }
    }
