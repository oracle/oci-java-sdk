...
public class GetAwrDbReportResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAwrDbReportResponse> {
    ...
    public String toString() {
        ...
        sb.append(",awrDbReport=").append(String.valueOf(awrDbReport));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAwrDbReportResponse)) {
            return false;
        }

        GetAwrDbReportResponse other = (GetAwrDbReportResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.awrDbReport, other.awrDbReport);
    }
    ...
    public int hashCode() {
        ...
        result = (result * PRIME) + (this.awrDbReport == null ? 43 : this.awrDbReport.hashCode());
        return result;
    }
}
