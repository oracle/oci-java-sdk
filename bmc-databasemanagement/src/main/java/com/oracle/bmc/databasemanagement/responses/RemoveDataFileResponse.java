...
public class RemoveDataFileResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemoveDataFileResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDataFileResponse)) {
            return false;
        }

        RemoveDataFileResponse other = (RemoveDataFileResponse) o;
