...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListSqlPlanBaselinesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSqlPlanBaselinesRequest.
 */
...
public class ListSqlPlanBaselinesRequest
    ...
    public static class Builder
        ...
        public ListSqlPlanBaselinesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSqlPlanBaselinesRequest(managedDatabaseId, planName, sqlHandle, sqlText, isEnabled, isAccepted, isReproduced, isFixed, isAdaptive, origin, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
