...
public class SummarizeExternalAsmMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeExternalAsmMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeExternalAsmMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeExternalAsmMetricsResponse build() {
            return new SummarizeExternalAsmMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalAsmMetricsResponse)) {
            return false;
        }

        SummarizeExternalAsmMetricsResponse other = (SummarizeExternalAsmMetricsResponse) o;
