...
public final class AssociatedServiceDetails
    ...
    public static class Builder {
        ...
        public AssociatedServiceDetails build() {
            AssociatedServiceDetails model =
                    new AssociatedServiceDetails(this.isEnabled, this.metadata);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssociatedServiceDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssociatedServiceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssociatedServiceDetails)) {
            return false;
        }

        AssociatedServiceDetails other = (AssociatedServiceDetails) o;
