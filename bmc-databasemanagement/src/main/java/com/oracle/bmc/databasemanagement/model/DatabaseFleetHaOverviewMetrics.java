...
/**
 * The details of the HA metrics for the fleet of databases. <br>
...
public final class DatabaseFleetHaOverviewMetrics
    ...
    public DatabaseFleetHaOverviewMetrics(java.util.List<DatabaseHaMetrics> haMetrics) {
        super();
    ...
    public static class Builder {
        ...
        private java.util.List<DatabaseHaMetrics> haMetrics;
         ...
         * @return this builder
         */
        public Builder haMetrics(java.util.List<DatabaseHaMetrics> haMetrics) {
            this.haMetrics = haMetrics;
    ...
    /** A list of the databases present in the fleet and their HA usage metrics. */
    @com.fasterxml.jackson.annotation.JsonProperty("haMetrics")
    private final java.util.List<DatabaseHaMetrics> haMetrics;
     ...
     * @return the value
     */
    public java.util.List<DatabaseHaMetrics> getHaMetrics() {
        return haMetrics;
    }
