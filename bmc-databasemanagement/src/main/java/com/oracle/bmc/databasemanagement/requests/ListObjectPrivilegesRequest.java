 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListObjectPrivilegesRequest.
 */
...
public class ListObjectPrivilegesRequest
    ...
    public static class Builder
        ...
        public ListObjectPrivilegesRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListObjectPrivilegesRequest(managedDatabaseId, userName, opcRequestId, name,
