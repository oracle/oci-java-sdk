...
public interface DiagnosabilityAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ListAlertLogsResponse> listAlertLogs(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListAttentionLogsResponse> listAttentionLogs(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<SummarizeAlertLogCountsResponse> summarizeAlertLogCounts(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<SummarizeAttentionLogCountsResponse> summarizeAttentionLogCounts(
