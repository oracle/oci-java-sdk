...
/**
 * Error from the fetch operation of a MySQL server replication channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MySqlFetchError.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MySqlFetchError
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"lastErrorNumber", "lastErrorMessage", "timeLastError"})
    public MySqlFetchError(
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MySqlFetchError model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MySqlFetchError)) {
            return false;
        }

        MySqlFetchError other = (MySqlFetchError) o;
