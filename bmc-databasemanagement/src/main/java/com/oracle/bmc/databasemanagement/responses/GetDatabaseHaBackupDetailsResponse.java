...
public class GetDatabaseHaBackupDetailsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.databasemanagement.model.DatabaseHaBackupDetails
        ...
        return databaseHaBackupDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder databaseHaBackupDetails(
                com.oracle.bmc.databasemanagement.model.DatabaseHaBackupDetails
                        databaseHaBackupDetails) {
            this.databaseHaBackupDetails = databaseHaBackupDetails;
            return this;
        ...
        public Builder copy(GetDatabaseHaBackupDetailsResponse o) {
            ...
            databaseHaBackupDetails(o.getDatabaseHaBackupDetails());
    ...
    public String toString() {
        ...
        sb.append(",databaseHaBackupDetails=").append(String.valueOf(databaseHaBackupDetails));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseHaBackupDetailsResponse)) {
            return false;
        }

        GetDatabaseHaBackupDetailsResponse other = (GetDatabaseHaBackupDetailsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.databaseHaBackupDetails, other.databaseHaBackupDetails);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.databaseHaBackupDetails == null
                                ? 43
                                : this.databaseHaBackupDetails.hashCode());
        return result;
    }
}
