...
public final class AwrDbSnapshotCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbSnapshotCollection build() {
            AwrDbSnapshotCollection model =
                    new AwrDbSnapshotCollection(
                            this.name,
                            this.version,
                            this.queryKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbSnapshotCollection model) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDbSnapshotSummary> items;

    /**
     * A list of AWR snapshot summary data.
     * @return the value
     **/
    public java.util.List<AwrDbSnapshotSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AwrDbSnapshotCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbSnapshotCollection)) {
            return false;
        }

        AwrDbSnapshotCollection other = (AwrDbSnapshotCollection) o;
