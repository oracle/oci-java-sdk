...
/**
 * The details of an external database node. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ExternalDbNode.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class ExternalDbNode
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the
         * external DB system that the DB node is a part of.
         */
        ...
        /**
         * The additional details of the external DB node defined in {@code {"key": "value"}}
        ...
        public ExternalDbNode build() {
            ExternalDbNode model =
                    new ExternalDbNode(
                            this.id,
                            this.displayName,
                            this.componentName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalDbNode model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalDbNode)) {
            return false;
        }

        ExternalDbNode other = (ExternalDbNode) o;
