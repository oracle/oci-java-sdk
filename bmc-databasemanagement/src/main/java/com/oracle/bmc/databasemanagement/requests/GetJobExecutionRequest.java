...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetJobExecutionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetJobExecutionRequest.
 */
...
public class GetJobExecutionRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * The identifier of the job execution.
         * @param jobExecutionId the value to set
        ...
        public Builder copy(GetJobExecutionRequest o) {
            jobExecutionId(o.getJobExecutionId());
        ...
        public GetJobExecutionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetJobExecutionRequest(jobExecutionId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().jobExecutionId(jobExecutionId).opcRequestId(opcRequestId);
    }
    ...
    public String toString() {
        ...
        sb.append(",jobExecutionId=").append(String.valueOf(this.jobExecutionId));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                && java.util.Objects.equals(this.jobExecutionId, other.jobExecutionId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.jobExecutionId == null ? 43 : this.jobExecutionId.hashCode());
