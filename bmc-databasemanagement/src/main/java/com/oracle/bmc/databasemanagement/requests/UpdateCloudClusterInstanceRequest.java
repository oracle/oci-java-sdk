...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateCloudClusterInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateCloudClusterInstanceRequest.
 */
...
public class UpdateCloudClusterInstanceRequest
    ...
    public static class Builder
        ...
        public UpdateCloudClusterInstanceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateCloudClusterInstanceRequest(cloudClusterInstanceId, updateCloudClusterInstanceDetails, opcRequestId, ifMatch);
        }
    }
