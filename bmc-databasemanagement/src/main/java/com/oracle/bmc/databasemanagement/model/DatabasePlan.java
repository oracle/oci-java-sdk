...
/**
 * The resource allocation directives must all use the share attribute, or they must all use the
 * level and allocation attributes. If you use the share attribute to allocate I/O resources, then
 * the database plan can have a maximum of 1024 directives. If you use the level and allocation
 * attributes to allocate I/O resources, then the database plan can have a maximum of 32 directives.
 * Only one directive is allowed for each database name and each profile name. <br>
...
public final class DatabasePlan extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
