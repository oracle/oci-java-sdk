...
/**
 * The summary of Pluggable Databases (PDBs) and their resource usage metrics, within a specific
...
public final class PdbMetrics extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        /**
         * A summary of PDBs and their resource usage metrics such as CPU, User I/O, and Storage,
    ...
    /**
     * A summary of PDBs and their resource usage metrics such as CPU, User I/O, and Storage, within
     * a specific CDB.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("databaseUsageMetrics")
