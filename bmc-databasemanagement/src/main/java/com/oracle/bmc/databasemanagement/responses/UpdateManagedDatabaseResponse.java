...
public class UpdateManagedDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateManagedDatabaseResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateManagedDatabaseResponse> {
        ...
        public UpdateManagedDatabaseResponse build() {
            return new UpdateManagedDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        UpdateManagedDatabaseResponse other = (UpdateManagedDatabaseResponse) o;
