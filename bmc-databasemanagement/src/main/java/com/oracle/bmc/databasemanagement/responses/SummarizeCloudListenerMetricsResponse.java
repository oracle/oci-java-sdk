...
public class SummarizeCloudListenerMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeCloudListenerMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeCloudListenerMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeCloudListenerMetricsResponse build() {
            return new SummarizeCloudListenerMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeCloudListenerMetricsResponse)) {
            return false;
        }

        SummarizeCloudListenerMetricsResponse other = (SummarizeCloudListenerMetricsResponse) o;
