...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListExternalDbNodesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExternalDbNodesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListExternalDbNodesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListExternalDbNodesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListExternalDbNodesRequest o) {
        ...
        /**
         * Build the instance of ListExternalDbNodesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListExternalDbNodesRequest
         */
        public ListExternalDbNodesRequest build() {
            ListExternalDbNodesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExternalDbNodesRequest
         */
        public ListExternalDbNodesRequest buildWithoutInvocationCallback() {
            ListExternalDbNodesRequest request = new ListExternalDbNodesRequest();
            ...
            return request;
            // new ListExternalDbNodesRequest(compartmentId, externalDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExternalDbNodesRequest)) {
            return false;
        }

        ListExternalDbNodesRequest other = (ListExternalDbNodesRequest) o;
