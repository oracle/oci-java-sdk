...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListExternalListenerServicesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExternalListenerServicesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListExternalListenerServicesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListExternalListenerServicesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListExternalListenerServicesRequest o) {
        ...
        /**
         * Build the instance of ListExternalListenerServicesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListExternalListenerServicesRequest
         */
        public ListExternalListenerServicesRequest build() {
            ListExternalListenerServicesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExternalListenerServicesRequest
         */
        public ListExternalListenerServicesRequest buildWithoutInvocationCallback() {
            ListExternalListenerServicesRequest request = new ListExternalListenerServicesRequest();
            ...
            return request;
            // new ListExternalListenerServicesRequest(externalListenerId, managedDatabaseId, page, limit, sortBy, sortOrder, opcRequestId, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExternalListenerServicesRequest)) {
            return false;
        }

        ListExternalListenerServicesRequest other = (ListExternalListenerServicesRequest) o;
