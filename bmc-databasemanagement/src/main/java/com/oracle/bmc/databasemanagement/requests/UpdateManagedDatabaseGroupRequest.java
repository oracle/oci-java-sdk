...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateManagedDatabaseGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateManagedDatabaseGroupRequest.
 */
...
public class UpdateManagedDatabaseGroupRequest
    ...
    public static class Builder
        ...
        public UpdateManagedDatabaseGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateManagedDatabaseGroupRequest(managedDatabaseGroupId, updateManagedDatabaseGroupDetails, ifMatch, opcRequestId);
        }
    }
