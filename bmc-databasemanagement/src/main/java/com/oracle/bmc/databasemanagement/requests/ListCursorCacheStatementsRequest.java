...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCursorCacheStatementsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCursorCacheStatementsRequest.
 */
...
public class ListCursorCacheStatementsRequest
    ...
    public static class Builder
         ...
         */
        public ListCursorCacheStatementsRequest build() {
            ListCursorCacheStatementsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCursorCacheStatementsRequest
         */
        public ListCursorCacheStatementsRequest buildWithoutInvocationCallback() {
            ListCursorCacheStatementsRequest request = new ListCursorCacheStatementsRequest();
            ...
            return request;
            // new ListCursorCacheStatementsRequest(managedDatabaseId, sqlText, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCursorCacheStatementsRequest)) {
            return false;
        }

        ListCursorCacheStatementsRequest other = (ListCursorCacheStatementsRequest) o;
