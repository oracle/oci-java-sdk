...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListDbManagementPrivateEndpointsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDbManagementPrivateEndpointsRequest.
 */
...
public class ListDbManagementPrivateEndpointsRequest
    ...
    public static class Builder
        ...
        public ListDbManagementPrivateEndpointsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDbManagementPrivateEndpointsRequest(compartmentId, name, vcnId, isCluster, isDnsResolutionEnabled, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
