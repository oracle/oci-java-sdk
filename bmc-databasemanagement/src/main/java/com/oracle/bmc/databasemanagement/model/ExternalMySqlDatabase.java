...
public final class ExternalMySqlDatabase
    ...
    public static class Builder {
        ...
        public ExternalMySqlDatabase build() {
            ExternalMySqlDatabase model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalMySqlDatabase model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalMySqlDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalMySqlDatabase)) {
            return false;
        }

        ExternalMySqlDatabase other = (ExternalMySqlDatabase) o;
