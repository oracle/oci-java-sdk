...
public class GetDataguardPerformanceMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.databasemanagement.model.DataguardPerformanceMetrics
        ...
        return dataguardPerformanceMetrics;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder dataguardPerformanceMetrics(
                com.oracle.bmc.databasemanagement.model.DataguardPerformanceMetrics
                        dataguardPerformanceMetrics) {
            this.dataguardPerformanceMetrics = dataguardPerformanceMetrics;
            return this;
        ...
        public Builder copy(GetDataguardPerformanceMetricsResponse o) {
            ...
            dataguardPerformanceMetrics(o.getDataguardPerformanceMetrics());
    ...
    public String toString() {
        ...
        sb.append(",dataguardPerformanceMetrics=")
                .append(String.valueOf(dataguardPerformanceMetrics));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDataguardPerformanceMetricsResponse)) {
            return false;
        }

        GetDataguardPerformanceMetricsResponse other = (GetDataguardPerformanceMetricsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.dataguardPerformanceMetrics, other.dataguardPerformanceMetrics);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.dataguardPerformanceMetrics == null
                                ? 43
                                : this.dataguardPerformanceMetrics.hashCode());
        return result;
    }
}
