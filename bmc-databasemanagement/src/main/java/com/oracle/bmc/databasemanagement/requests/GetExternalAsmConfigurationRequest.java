...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetExternalAsmConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetExternalAsmConfigurationRequest.
 */
...
public class GetExternalAsmConfigurationRequest
    ...
    public static class Builder
        ...
        public GetExternalAsmConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetExternalAsmConfigurationRequest(externalAsmId, opcRequestId, opcNamedCredentialId);
        }
    }
