...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetPeerDatabaseMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetPeerDatabaseMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class GetPeerDatabaseMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetPeerDatabaseMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetPeerDatabaseMetricsRequest o) {
        ...
        /**
         * Build the instance of GetPeerDatabaseMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetPeerDatabaseMetricsRequest
         */
        public GetPeerDatabaseMetricsRequest build() {
            GetPeerDatabaseMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetPeerDatabaseMetricsRequest
         */
        public GetPeerDatabaseMetricsRequest buildWithoutInvocationCallback() {
            GetPeerDatabaseMetricsRequest request = new GetPeerDatabaseMetricsRequest();
            ...
            return request;
            // new GetPeerDatabaseMetricsRequest(managedDatabaseId, startTime, endTime, opcRequestId, peerDatabaseCompartmentId, compareType, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPeerDatabaseMetricsRequest)) {
            return false;
        }

        GetPeerDatabaseMetricsRequest other = (GetPeerDatabaseMetricsRequest) o;
