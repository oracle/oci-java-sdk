...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DisableExternalContainerDatabaseManagementFeatureDetails.Builder.class)
...
public final class DisableExternalContainerDatabaseManagementFeatureDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalContainerDatabaseManagementFeatureDetails)) {
            return false;
        }
