 ...
 * (MACS)](https://docs.oracle.com/iaas/management-agents/index.html) connector used to connect to
 * an external DB system component. <br>
    ...
    public static class Builder {
        ...
        public UpdateExternalDbSystemMacsConnectorDetails build() {
            UpdateExternalDbSystemMacsConnectorDetails model =
                    new UpdateExternalDbSystemMacsConnectorDetails(
                            this.connectionInfo, this.freeformTags, this.definedTags);
