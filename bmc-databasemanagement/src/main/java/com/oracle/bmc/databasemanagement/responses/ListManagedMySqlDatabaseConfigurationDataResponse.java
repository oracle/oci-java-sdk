...
public class ListManagedMySqlDatabaseConfigurationDataResponse
    ...
    public com.oracle.bmc.databasemanagement.model.MySqlConfigurationDataCollection
        ...
        return mySqlConfigurationDataCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder mySqlConfigurationDataCollection(
                com.oracle.bmc.databasemanagement.model.MySqlConfigurationDataCollection
                        mySqlConfigurationDataCollection) {
            this.mySqlConfigurationDataCollection = mySqlConfigurationDataCollection;
            return this;
        ...
        public Builder copy(ListManagedMySqlDatabaseConfigurationDataResponse o) {
            ...
            mySqlConfigurationDataCollection(o.getMySqlConfigurationDataCollection());
    ...
    public String toString() {
        ...
        sb.append(",mySqlConfigurationDataCollection=")
                .append(String.valueOf(mySqlConfigurationDataCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListManagedMySqlDatabaseConfigurationDataResponse)) {
            return false;
        }

        ListManagedMySqlDatabaseConfigurationDataResponse other =
                (ListManagedMySqlDatabaseConfigurationDataResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.mySqlConfigurationDataCollection,
                        other.mySqlConfigurationDataCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.mySqlConfigurationDataCollection == null
                                ? 43
                                : this.mySqlConfigurationDataCollection.hashCode());
        return result;
    }
}
