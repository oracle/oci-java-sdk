...
public class GetPdbMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPdbMetricsResponse> {
        ...
        public GetPdbMetricsResponse build() {
            return new GetPdbMetricsResponse(__httpStatusCode__, headers, opcRequestId, pdbMetrics);
        }
    }
