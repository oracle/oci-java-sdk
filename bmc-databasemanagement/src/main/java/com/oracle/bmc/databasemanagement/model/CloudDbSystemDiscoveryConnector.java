...
/**
 * The connector details used to connect to the cloud DB system component. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CloudDbSystemDiscoveryConnector.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CloudDbSystemDiscoveryMacsConnector.class,
            name = "MACS")
})
...
public class CloudDbSystemDiscoveryConnector
    ...
    protected CloudDbSystemDiscoveryConnector(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudDbSystemDiscoveryConnector(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbSystemDiscoveryConnector)) {
            return false;
        }

        CloudDbSystemDiscoveryConnector other = (CloudDbSystemDiscoveryConnector) o;
