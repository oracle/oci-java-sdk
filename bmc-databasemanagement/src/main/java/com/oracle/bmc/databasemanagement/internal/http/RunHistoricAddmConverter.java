...
public class RunHistoricAddmConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RunHistoricAddmConverter.class);

    public static com.oracle.bmc.databasemanagement.requests.RunHistoricAddmRequest
            interceptRequest(
                    com.oracle.bmc.databasemanagement.requests.RunHistoricAddmRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getRunHistoricAddmDetails(), "runHistoricAddmDetails is required");
