...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeCloudClusterMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeCloudClusterMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class SummarizeCloudClusterMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeCloudClusterMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeCloudClusterMetricsRequest o) {
        ...
        /**
         * Build the instance of SummarizeCloudClusterMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeCloudClusterMetricsRequest
         */
        public SummarizeCloudClusterMetricsRequest build() {
            SummarizeCloudClusterMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeCloudClusterMetricsRequest
         */
        public SummarizeCloudClusterMetricsRequest buildWithoutInvocationCallback() {
            SummarizeCloudClusterMetricsRequest request = new SummarizeCloudClusterMetricsRequest();
            ...
            return request;
            // new SummarizeCloudClusterMetricsRequest(cloudClusterId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeCloudClusterMetricsRequest)) {
            return false;
        }

        SummarizeCloudClusterMetricsRequest other = (SummarizeCloudClusterMetricsRequest) o;
