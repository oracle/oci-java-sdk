...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudListenersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudListenersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListCloudListenersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudListenersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudListenersRequest o) {
        ...
        /**
         * Build the instance of ListCloudListenersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudListenersRequest
         */
        public ListCloudListenersRequest build() {
            ListCloudListenersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudListenersRequest
         */
        public ListCloudListenersRequest buildWithoutInvocationCallback() {
            ListCloudListenersRequest request = new ListCloudListenersRequest();
            ...
            return request;
            // new ListCloudListenersRequest(compartmentId, cloudDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudListenersRequest)) {
            return false;
        }

        ListCloudListenersRequest other = (ListCloudListenersRequest) o;
