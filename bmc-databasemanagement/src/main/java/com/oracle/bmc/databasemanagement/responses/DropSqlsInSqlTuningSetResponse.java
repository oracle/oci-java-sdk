...
public class DropSqlsInSqlTuningSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DropSqlsInSqlTuningSetResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DropSqlsInSqlTuningSetResponse o) {
         ...
         */
        @Override
        public DropSqlsInSqlTuningSetResponse build() {
            return new DropSqlsInSqlTuningSetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DropSqlsInSqlTuningSetResponse)) {
            return false;
        }

        DropSqlsInSqlTuningSetResponse other = (DropSqlsInSqlTuningSetResponse) o;
