...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabasePasswordCredentialDetails.Builder.class
)
...
public final class DatabasePasswordCredentialDetails extends DatabaseCredentialDetails {
    ...
    public static class Builder {
        ...
        public DatabasePasswordCredentialDetails build() {
            DatabasePasswordCredentialDetails model =
                    new DatabasePasswordCredentialDetails(this.password, this.username, this.role);
    ...
    @Deprecated
    public DatabasePasswordCredentialDetails(char[] password, String username, Role role) {
        super();
        this.password = password;
        this.username = username;
        this.role = role;
    ...
    public boolean equals(Object o) {
        ...
        DatabasePasswordCredentialDetails other = (DatabasePasswordCredentialDetails) o;
