...
/**
 * The details required to disable SQL plan baseline usage. It takes either credentials or
...
public final class DisableSqlPlanBaselinesUsageDetails
    ...
    public DisableSqlPlanBaselinesUsageDetails(
    ...
    public static class Builder {
        ...
        public DisableSqlPlanBaselinesUsageDetails build() {
            DisableSqlPlanBaselinesUsageDetails model =
                    new DisableSqlPlanBaselinesUsageDetails(
