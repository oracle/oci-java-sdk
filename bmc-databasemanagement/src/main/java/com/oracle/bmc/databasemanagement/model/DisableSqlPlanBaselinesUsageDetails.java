...
/**
 * The details required to disable SQL plan baseline usage. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DisableSqlPlanBaselinesUsageDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DisableSqlPlanBaselinesUsageDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"credentials"})
    public DisableSqlPlanBaselinesUsageDetails(ManagedDatabaseCredential credentials) {
        super();
    ...
    public static class Builder {
        ...
        public DisableSqlPlanBaselinesUsageDetails build() {
            DisableSqlPlanBaselinesUsageDetails model =
                    new DisableSqlPlanBaselinesUsageDetails(this.credentials);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DisableSqlPlanBaselinesUsageDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableSqlPlanBaselinesUsageDetails)) {
            return false;
        }

        DisableSqlPlanBaselinesUsageDetails other = (DisableSqlPlanBaselinesUsageDetails) o;
