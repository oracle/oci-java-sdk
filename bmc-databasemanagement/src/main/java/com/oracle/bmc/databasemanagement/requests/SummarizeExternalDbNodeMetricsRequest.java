...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeExternalDbNodeMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeExternalDbNodeMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class SummarizeExternalDbNodeMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeExternalDbNodeMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeExternalDbNodeMetricsRequest o) {
        ...
        /**
         * Build the instance of SummarizeExternalDbNodeMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeExternalDbNodeMetricsRequest
         */
        public SummarizeExternalDbNodeMetricsRequest build() {
            SummarizeExternalDbNodeMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeExternalDbNodeMetricsRequest
         */
        public SummarizeExternalDbNodeMetricsRequest buildWithoutInvocationCallback() {
            SummarizeExternalDbNodeMetricsRequest request =
                    new SummarizeExternalDbNodeMetricsRequest();
            ...
            return request;
            // new SummarizeExternalDbNodeMetricsRequest(externalDbNodeId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalDbNodeMetricsRequest)) {
            return false;
        }

        SummarizeExternalDbNodeMetricsRequest other = (SummarizeExternalDbNodeMetricsRequest) o;
