...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListManagedMySqlDatabaseSqlDataExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListManagedMySqlDatabaseSqlDataRequest.
 */
...
public class ListManagedMySqlDatabaseSqlDataRequest
    ...
    public static class Builder
        ...
        public ListManagedMySqlDatabaseSqlDataRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListManagedMySqlDatabaseSqlDataRequest(managedMySqlDatabaseId, startTime, endTime, filterColumn, opcRequestId, limit, page, sortBy, sortOrder);
        }
    }
