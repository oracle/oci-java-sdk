...
public final class AwrDbParameterChangeCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbParameterChangeCollection build() {
            AwrDbParameterChangeCollection model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbParameterChangeCollection model) {
    ...
    /** A list of AWR database parameter change summary data. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDbParameterChangeSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AwrDbParameterChangeSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AwrDbParameterChangeCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbParameterChangeCollection)) {
            return false;
        }

        AwrDbParameterChangeCollection other = (AwrDbParameterChangeCollection) o;
