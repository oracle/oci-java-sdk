...
/**
 * The details required to connect to a cloud Oracle Database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudDatabaseConnectionInfo.Builder.class)
...
public final class CloudDatabaseConnectionInfo extends CloudDbSystemConnectionInfo {
    ...
    public static class Builder {
        ...
        public CloudDatabaseConnectionInfo build() {
            CloudDatabaseConnectionInfo model =
                    new CloudDatabaseConnectionInfo(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudDatabaseConnectionInfo model) {
    ...
    @Deprecated
    public CloudDatabaseConnectionInfo(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudDatabaseConnectionInfo(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDatabaseConnectionInfo)) {
            return false;
        }

        CloudDatabaseConnectionInfo other = (CloudDatabaseConnectionInfo) o;
