...
public class ListRolesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemanagement.model.RoleCollection getRoleCollection() {
    ...
    private ListRolesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.databasemanagement.model.RoleCollection roleCollection) {
    ...
    public static class Builder
        ...
        public ListRolesResponse build() {
            return new ListRolesResponse(
                    __httpStatusCode__, headers, opcNextPage, opcRequestId, roleCollection);
        }
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.roleCollection == null ? 43 : this.roleCollection.hashCode());
        return result;
    }
}
