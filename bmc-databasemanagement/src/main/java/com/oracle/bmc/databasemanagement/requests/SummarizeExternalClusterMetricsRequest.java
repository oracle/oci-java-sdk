...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeExternalClusterMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeExternalClusterMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class SummarizeExternalClusterMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeExternalClusterMetricsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeExternalClusterMetricsRequest o) {
        ...
        /**
         * Build the instance of SummarizeExternalClusterMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeExternalClusterMetricsRequest
         */
        public SummarizeExternalClusterMetricsRequest build() {
            SummarizeExternalClusterMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeExternalClusterMetricsRequest
         */
        public SummarizeExternalClusterMetricsRequest buildWithoutInvocationCallback() {
            SummarizeExternalClusterMetricsRequest request =
                    new SummarizeExternalClusterMetricsRequest();
            ...
            return request;
            // new SummarizeExternalClusterMetricsRequest(externalClusterId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalClusterMetricsRequest)) {
            return false;
        }

        SummarizeExternalClusterMetricsRequest other = (SummarizeExternalClusterMetricsRequest) o;
