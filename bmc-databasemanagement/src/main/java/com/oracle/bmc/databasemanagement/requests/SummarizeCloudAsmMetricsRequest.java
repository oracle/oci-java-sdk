...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeCloudAsmMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeCloudAsmMetricsRequest.
 */
...
public class SummarizeCloudAsmMetricsRequest
    ...
    public static class Builder
        ...
        public SummarizeCloudAsmMetricsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeCloudAsmMetricsRequest(cloudAsmId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
