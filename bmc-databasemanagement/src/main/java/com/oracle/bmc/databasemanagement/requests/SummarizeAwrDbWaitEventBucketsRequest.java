...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAwrDbWaitEventBucketsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDbWaitEventBucketsRequest.
 */
...
public class SummarizeAwrDbWaitEventBucketsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbWaitEventBucketsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbWaitEventBucketsRequest(managedDatabaseId, awrDbId, name, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, numBucket, minValue, maxValue, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
