...
/**
 * The summary of an external ASM instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExternalAsmInstanceSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExternalAsmInstanceSummary
    ...
    public ExternalAsmInstanceSummary(
            String id,
            String displayName,
            ...
            String hostName,
            ExternalAsmInstance.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        private ExternalAsmInstance.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(ExternalAsmInstance.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public ExternalAsmInstanceSummary build() {
            ExternalAsmInstanceSummary model =
                    new ExternalAsmInstanceSummary(
                            this.id,
                            this.displayName,
                            this.componentName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalAsmInstanceSummary model) {
    ...
    /** The current lifecycle state of the external ASM instance. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final ExternalAsmInstance.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public ExternalAsmInstance.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalAsmInstanceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalAsmInstanceSummary)) {
            return false;
        }

        ExternalAsmInstanceSummary other = (ExternalAsmInstanceSummary) o;
