...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BasicPreferredCredential.Builder.class)
...
public final class BasicPreferredCredential extends PreferredCredential {
    ...
    public static class Builder {
        ...
        public BasicPreferredCredential build() {
            BasicPreferredCredential model =
                    new BasicPreferredCredential(
                            this.credentialName,
                            this.status,
                            this.isAccessible,
                            this.userName,
    ...
    @Deprecated
    public BasicPreferredCredential(
    ...
    public boolean equals(Object o) {
        ...
        BasicPreferredCredential other = (BasicPreferredCredential) o;
