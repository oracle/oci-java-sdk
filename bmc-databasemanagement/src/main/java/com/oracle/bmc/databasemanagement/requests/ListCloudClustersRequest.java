...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudClustersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudClustersRequest.
 */
...
public class ListCloudClustersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListCloudClustersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCloudClustersRequest(compartmentId, cloudDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
