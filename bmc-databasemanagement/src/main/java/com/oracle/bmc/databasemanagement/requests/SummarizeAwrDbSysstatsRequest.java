...
public class SummarizeAwrDbSysstatsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbSysstatsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbSysstatsRequest(managedDatabaseId, awrDbId, name, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken);
        }
    }
