...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAwrDbSysstatsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDbSysstatsRequest.
 */
...
public class SummarizeAwrDbSysstatsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbSysstatsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbSysstatsRequest(managedDatabaseId, awrDbId, name, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
