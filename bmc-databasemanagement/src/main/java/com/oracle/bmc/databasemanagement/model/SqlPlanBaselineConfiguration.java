 ...
 *
 * <p>- whether automatic initial plan capture is enabled or disabled - whether use of SQL plan
 ...
 * task - plan retention and allocated space for the plan baselines <br>
...
public final class SqlPlanBaselineConfiguration
    ...
    public static class Builder {
        /**
         * Indicates whether the automatic capture of SQL plan baselines is enabled ({@code true})
         * or not ({@code false}).
         */
        ...
        /**
         * Indicates whether the database uses SQL plan baselines ({@code true}) or not ({@code
         * false}).
         */
        ...
        /**
         * Indicates whether the Automatic SPM Evolve Advisor task is enabled ({@code true}) or not
         * ({@code false}).
         */
        ...
        /**
         * Indicates whether the high frequency Automatic SPM Evolve Advisor task is enabled ({@code
    ...
    /**
     * Indicates whether the automatic capture of SQL plan baselines is enabled ({@code true}) or
     * not ({@code false}).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isAutomaticInitialPlanCaptureEnabled")
