...
public final class ObjectStorageJobExecutionResultLocation extends JobExecutionResultLocation {
    ...
    public static class Builder {
        ...
        public ObjectStorageJobExecutionResultLocation build() {
            ObjectStorageJobExecutionResultLocation model =
                    new ObjectStorageJobExecutionResultLocation(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageJobExecutionResultLocation model) {
