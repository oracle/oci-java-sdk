...
public final class ObjectStorageJobExecutionResultLocation extends JobExecutionResultLocation {
    ...
    public static class Builder {
        ...
        public ObjectStorageJobExecutionResultLocation build() {
            ObjectStorageJobExecutionResultLocation __instance__ =
                    new ObjectStorageJobExecutionResultLocation(namespaceName, bucketName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ObjectStorageJobExecutionResultLocation o) {
    ...
    @Deprecated
    public ObjectStorageJobExecutionResultLocation(String namespaceName, String bucketName) {
        super();
        this.namespaceName = namespaceName;
        this.bucketName = bucketName;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ObjectStorageJobExecutionResultLocation(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ObjectStorageJobExecutionResultLocation)) {
            return false;
        }

        ObjectStorageJobExecutionResultLocation other = (ObjectStorageJobExecutionResultLocation) o;
