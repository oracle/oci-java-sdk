...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetDatabaseFleetDataguardMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseFleetDataguardMetricsRequest.
 */
...
public class GetDatabaseFleetDataguardMetricsRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of GetDatabaseFleetDataguardMetricsRequest as configured by this builder
         *
        ...
        public GetDatabaseFleetDataguardMetricsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDatabaseFleetDataguardMetricsRequest(opcRequestId, managedDatabaseGroupId, compartmentId, filterByMetricNames, page, limit, sortBy, sortOrder, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists);
        }
    }
