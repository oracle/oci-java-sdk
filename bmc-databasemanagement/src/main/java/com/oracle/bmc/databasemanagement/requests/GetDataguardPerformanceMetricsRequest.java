...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetDataguardPerformanceMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDataguardPerformanceMetricsRequest.
 */
...
public class GetDataguardPerformanceMetricsRequest
    ...
    public static class Builder
        ...
        public GetDataguardPerformanceMetricsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDataguardPerformanceMetricsRequest(managedDatabaseId, startTime, endTime, opcRequestId, peerDatabaseCompartmentId, filterByMetricNames);
        }
    }
