...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateExternalListenerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateExternalListenerRequest.
 */
...
public class UpdateExternalListenerRequest
    ...
    public static class Builder
        ...
        public UpdateExternalListenerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateExternalListenerRequest(externalListenerId, updateExternalListenerDetails, opcRequestId, ifMatch);
        }
    }
