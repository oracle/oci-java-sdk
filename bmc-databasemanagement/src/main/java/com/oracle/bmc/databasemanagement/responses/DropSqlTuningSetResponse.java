...
public class DropSqlTuningSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DropSqlTuningSetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DropSqlTuningSetResponse> {
         ...
         */
        @Override
        public Builder copy(DropSqlTuningSetResponse o) {
         ...
         */
        @Override
        public DropSqlTuningSetResponse build() {
            return new DropSqlTuningSetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DropSqlTuningSetResponse)) {
            return false;
        }

        DropSqlTuningSetResponse other = (DropSqlTuningSetResponse) o;
