...
/**
 * A summary of the database parameter. <br>
...
public final class DatabaseParameterSummary
    ...
    public static class Builder {
        ...
        /**
         * The parameter value in a user-friendly format. For example, if the {@code value} property
         * shows the value 262144 for a big integer parameter, then the {@code displayValue}
        ...
        /**
         * Indicates whether the parameter is set to the default value ({@code TRUE}) or the
         * parameter value was specified in the parameter file ({@code FALSE}).
         */
        ...
        /**
         * Indicates whether the parameter can be changed with {@code ALTER SESSION} ({@code TRUE})
         * or not ({@code FALSE})
         */
        ...
        /**
         * Indicates whether the parameter can be changed with {@code ALTER SYSTEM} and when the
         * change takes effect: - IMMEDIATE: Parameter can be changed with {@code ALTER SYSTEM}
         * regardless of the type of parameter file used to start the instance. The change takes
         * effect immediately. - DEFERRED: Parameter can be changed with {@code ALTER SYSTEM}
         * regardless of the type of parameter file used to start the instance. The change takes
         * effect in subsequent sessions. - FALSE: Parameter cannot be changed with {@code ALTER
         * SYSTEM} unless a server parameter file was used to start the instance. The change takes
        ...
        /**
         * Indicates whether the parameter can be modified on a per-PDB basis ({@code TRUE}) or not
         * ({@code FALSE}). In a non-CDB, the value of this property is {@code null}.
         */
        ...
        /**
         * For parameters that can be changed with {@code ALTER SYSTEM}, indicates whether the value
         * of the parameter can be different for every instance ({@code TRUE}) or whether the
         * parameter must have the same value for all Real Application Clusters instances ({@code
         * FALSE}). For other parameters, this is always {@code FALSE}.
         */
        ...
        /**
         * Indicates how the parameter was modified. If an {@code ALTER SYSTEM} was performed, the
         * value will be {@code MODIFIED}.
         */
        ...
        /**
         * Indicates whether the parameter has been deprecated ({@code TRUE}) or not ({@code
         * FALSE}).
         */
        ...
        /**
         * Indicates whether the parameter is a basic parameter ({@code TRUE}) or not ({@code
         * FALSE}).
         */
        ...
        /**
         * The position (ordinal number) of the parameter value. Useful only for parameters whose
         ...
         * {@code 0}: This value is used for data that pertain to the entire CDB. This value is also
         * used for data in non-CDBs. - {@code 1}: This value is used for data that pertain to only
         * the root container. - {@code n}: Where n is the applicable container ID for the data.
         */
        ...
        /**
         * Applicable in case of Oracle Real Application Clusters (Oracle RAC) databases. A {@code
         * UNIQUE} parameter is one which is unique to each Oracle Real Application Clusters (Oracle
         * RAC) instance. For example, the parameter {@code INSTANCE_NUMBER} must have different
         * values in each instance. An {@code IDENTICAL} parameter must have the same value for
         * every instance. For example, the parameter {@code DB_BLOCK_SIZE} must have the same value
         * in all instances.
         */
        ...
        /**
         * Indicates whether the parameter was specified in the server parameter file ({@code TRUE})
         * or not ({@code FALSE}). Applicable only when the parameter source is {@code SPFILE}.
         */
    ...
    /**
     * The parameter value in a user-friendly format. For example, if the {@code value} property
     * shows the value 262144 for a big integer parameter, then the {@code displayValue} property
     * will show the value 256K.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("displayValue")
    ...
    /**
     * Indicates whether the parameter is set to the default value ({@code TRUE}) or the parameter
     * value was specified in the parameter file ({@code FALSE}).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isDefault")
    ...
    /**
     * Indicates whether the parameter can be changed with {@code ALTER SESSION} ({@code TRUE}) or
     * not ({@code FALSE})
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isSessionModifiable")
    ...
    /**
     * Indicates whether the parameter can be changed with {@code ALTER SYSTEM} and when the change
     * takes effect: - IMMEDIATE: Parameter can be changed with {@code ALTER SYSTEM} regardless of
     * the type of parameter file used to start the instance. The change takes effect immediately. -
     * DEFERRED: Parameter can be changed with {@code ALTER SYSTEM} regardless of the type of
     * parameter file used to start the instance. The change takes effect in subsequent sessions. -
     * FALSE: Parameter cannot be changed with {@code ALTER SYSTEM} unless a server parameter file
     * was used to start the instance. The change takes effect in subsequent instances.
     */
    public enum IsSystemModifiable implements com.oracle.bmc.http.internal.BmcEnum {
        Immediate("IMMEDIATE"),
        Deferred("DEFERRED"),
        False("FALSE"),
    ...
    /**
     * For parameters that can be changed with {@code ALTER SYSTEM}, indicates whether the value of
     * the parameter can be different for every instance ({@code TRUE}) or whether the parameter
     * must have the same value for all Real Application Clusters instances ({@code FALSE}). For
     * other parameters, this is always {@code FALSE}.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isInstanceModifiable")
    ...
    /**
     * Indicates how the parameter was modified. If an {@code ALTER SYSTEM} was performed, the value
     * will be {@code MODIFIED}.
     */
    public enum IsModified implements com.oracle.bmc.http.internal.BmcEnum {
        Modified("MODIFIED"),
        False("FALSE"),
    ...
    /**
     * The position (ordinal number) of the parameter value. Useful only for parameters whose values
     ...
     * The ID of the database container to which the data pertains. Possible values include: -
     * {@code 0}: This value is used for data that pertain to the entire CDB. This value is also
     * used for data in non-CDBs. - {@code 1}: This value is used for data that pertain to only the
     * root container. - {@code n}: Where n is the applicable container ID for the data.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("containerId")
     ...
     * Applicable in case of Oracle Real Application Clusters (Oracle RAC) databases. A {@code
     * UNIQUE} parameter is one which is unique to each Oracle Real Application Clusters (Oracle
     * RAC) instance. For example, the parameter {@code INSTANCE_NUMBER} must have different values
     * in each instance. An {@code IDENTICAL} parameter must have the same value for every instance.
     * For example, the parameter {@code DB_BLOCK_SIZE} must have the same value in all instances.
     */
    public enum Constraint implements com.oracle.bmc.http.internal.BmcEnum {
        Unique("UNIQUE"),
        Identical("IDENTICAL"),
        None("NONE"),
    ...
    /**
     * Indicates whether the parameter was specified in the server parameter file ({@code TRUE}) or
     * not ({@code FALSE}). Applicable only when the parameter source is {@code SPFILE}.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isSpecified")
