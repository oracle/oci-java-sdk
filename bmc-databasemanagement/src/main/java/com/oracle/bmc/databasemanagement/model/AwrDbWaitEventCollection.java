...
public final class AwrDbWaitEventCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbWaitEventCollection build() {
            AwrDbWaitEventCollection model =
                    new AwrDbWaitEventCollection(
                            this.name,
                            this.version,
                            this.queryKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbWaitEventCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AwrDbWaitEventCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbWaitEventCollection)) {
            return false;
        }

        AwrDbWaitEventCollection other = (AwrDbWaitEventCollection) o;
