...
/**
 * The credentials used to connect to the Cloud ASM instance. Currently only the {@code DETAILS}
 * type is supported for creating MACS connector credentials. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = CloudAsmConnectionCredentials.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CloudAsmConnectionCredentialsByDetails.class,
            name = "DETAILS"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CloudAsmConnectionCredentialsByName.class,
            name = "NAME_REFERENCE")
})
...
public class CloudAsmConnectionCredentials
    ...
    protected CloudAsmConnectionCredentials() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudAsmConnectionCredentials(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAsmConnectionCredentials)) {
            return false;
        }

        CloudAsmConnectionCredentials other = (CloudAsmConnectionCredentials) o;
