...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "feature",
    defaultImpl = ExternalPluggableDatabaseFeatureDetails.class
)
...
public class ExternalPluggableDatabaseFeatureDetails
    ...
    protected ExternalPluggableDatabaseFeatureDetails(ConnectorDetails connectorDetails) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalPluggableDatabaseFeatureDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalPluggableDatabaseFeatureDetails)) {
            return false;
        }

        ExternalPluggableDatabaseFeatureDetails other = (ExternalPluggableDatabaseFeatureDetails) o;
