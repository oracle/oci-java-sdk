...
public class SummarizeSqlPlanBaselinesByLastExecutionResponse
    ...
    private SummarizeSqlPlanBaselinesByLastExecutionResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SummarizeSqlPlanBaselinesByLastExecutionResponse o) {
         ...
         */
        public SummarizeSqlPlanBaselinesByLastExecutionResponse build() {
            return new SummarizeSqlPlanBaselinesByLastExecutionResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeSqlPlanBaselinesByLastExecutionResponse)) {
            return false;
        }

        SummarizeSqlPlanBaselinesByLastExecutionResponse other =
                (SummarizeSqlPlanBaselinesByLastExecutionResponse) o;
