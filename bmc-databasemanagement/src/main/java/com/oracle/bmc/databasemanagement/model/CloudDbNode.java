...
/**
 * The details of a cloud database node. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CloudDbNode.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudDbNode extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudDbNode model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbNode)) {
            return false;
        }

        CloudDbNode other = (CloudDbNode) o;
