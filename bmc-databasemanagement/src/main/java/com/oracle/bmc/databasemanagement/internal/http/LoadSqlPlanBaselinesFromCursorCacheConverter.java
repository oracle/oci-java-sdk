...
public class LoadSqlPlanBaselinesFromCursorCacheConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(LoadSqlPlanBaselinesFromCursorCacheConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.databasemanagement.requests.LoadSqlPlanBaselinesFromCursorCacheRequest
                    request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path("actions")
                        .path("loadSqlPlanBaselinesFromCursorCache");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasemanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemanagement.responses.LoadSqlPlanBaselinesFromCursorCacheResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasemanagement.responses
                                                .LoadSqlPlanBaselinesFromCursorCacheResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasemanagement.responses
                                                        .LoadSqlPlanBaselinesFromCursorCacheResponse
                                                        .builder()
                                ...
                                builder.sqlPlanBaselineJob(response.getItem());
