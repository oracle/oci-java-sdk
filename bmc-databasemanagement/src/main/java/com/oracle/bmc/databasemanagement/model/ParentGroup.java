...
/**
 * The parent Managed Database Group of a Managed Database. <br>
...
public final class ParentGroup extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ParentGroup)) {
            return false;
        }

        ParentGroup other = (ParentGroup) o;
