...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VMClusterDiscoverySummary.Builder.class
)
...
public final class VMClusterDiscoverySummary extends EntityDiscovered {
    ...
    public static class Builder {
        ...
        public VMClusterDiscoverySummary build() {
            VMClusterDiscoverySummary model =
                    new VMClusterDiscoverySummary(
                            this.id,
                            this.agentId,
                            this.connectorId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VMClusterDiscoverySummary model) {
    ...
    @Deprecated
    public VMClusterDiscoverySummary(
            String id,
            String agentId,
            String connectorId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("VMClusterDiscoverySummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VMClusterDiscoverySummary)) {
            return false;
        }

        VMClusterDiscoverySummary other = (VMClusterDiscoverySummary) o;
