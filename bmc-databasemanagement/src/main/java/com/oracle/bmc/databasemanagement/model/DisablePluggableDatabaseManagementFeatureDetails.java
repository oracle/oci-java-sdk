...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DisablePluggableDatabaseManagementFeatureDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DisablePluggableDatabaseManagementFeatureDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"feature"})
    public DisablePluggableDatabaseManagementFeatureDetails(DbManagementFeature feature) {
        super();
    ...
    public static class Builder {
        ...
        public DisablePluggableDatabaseManagementFeatureDetails build() {
            DisablePluggableDatabaseManagementFeatureDetails model =
                    new DisablePluggableDatabaseManagementFeatureDetails(this.feature);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DisablePluggableDatabaseManagementFeatureDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisablePluggableDatabaseManagementFeatureDetails)) {
            return false;
        }

        DisablePluggableDatabaseManagementFeatureDetails other =
                (DisablePluggableDatabaseManagementFeatureDetails) o;
