...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListMySqlDatabaseConnectorsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMySqlDatabaseConnectorsRequest.
 */
...
public class ListMySqlDatabaseConnectorsRequest
    ...
    public static class Builder
        ...
        public ListMySqlDatabaseConnectorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMySqlDatabaseConnectorsRequest(compartmentId, opcRequestId, externalDatabaseId, name, page, limit, sortBy, sortOrder);
        }
    }
