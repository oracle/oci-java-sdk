...
public class ListAwrDbsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemanagement.model.AwrDbCollection getAwrDbCollection() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListAwrDbsResponse> {
         ...
         * @return this builder
         */
        public Builder awrDbCollection(
                com.oracle.bmc.databasemanagement.model.AwrDbCollection awrDbCollection) {
            this.awrDbCollection = awrDbCollection;
            return this;
        }
        ...
        public ListAwrDbsResponse build() {
            return new ListAwrDbsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, awrDbCollection);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",awrDbCollection=").append(String.valueOf(awrDbCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAwrDbsResponse)) {
            return false;
        }

        ListAwrDbsResponse other = (ListAwrDbsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.awrDbCollection, other.awrDbCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.awrDbCollection == null ? 43 : this.awrDbCollection.hashCode());
        return result;
    }
}
