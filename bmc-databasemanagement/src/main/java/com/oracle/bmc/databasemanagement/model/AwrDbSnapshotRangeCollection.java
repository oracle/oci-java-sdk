...
public final class AwrDbSnapshotRangeCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbSnapshotRangeCollection build() {
            AwrDbSnapshotRangeCollection model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbSnapshotRangeCollection model) {
    ...
    /** A list of AWR snapshot range summary data. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDbSnapshotRangeSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AwrDbSnapshotRangeSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbSnapshotRangeCollection)) {
            return false;
        }

        AwrDbSnapshotRangeCollection other = (AwrDbSnapshotRangeCollection) o;
