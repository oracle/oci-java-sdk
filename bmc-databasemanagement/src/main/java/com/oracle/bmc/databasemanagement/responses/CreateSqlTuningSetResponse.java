...
public class CreateSqlTuningSetResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateSqlTuningSetResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSqlTuningSetResponse> {
         ...
         */
        @Override
        public Builder copy(CreateSqlTuningSetResponse o) {
         ...
         */
        @Override
        public CreateSqlTuningSetResponse build() {
            return new CreateSqlTuningSetResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSqlTuningSetResponse)) {
            return false;
        }

        CreateSqlTuningSetResponse other = (CreateSqlTuningSetResponse) o;
