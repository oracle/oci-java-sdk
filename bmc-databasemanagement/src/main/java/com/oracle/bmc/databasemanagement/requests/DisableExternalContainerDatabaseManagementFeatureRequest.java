...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/DisableExternalContainerDatabaseManagementFeatureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DisableExternalContainerDatabaseManagementFeatureRequest.
 */
...
public class DisableExternalContainerDatabaseManagementFeatureRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder disableExternalContainerDatabaseManagementFeatureDetails(
                com.oracle.bmc.databasemanagement.model
                                .DisableExternalContainerDatabaseManagementFeatureDetails
                        disableExternalContainerDatabaseManagementFeatureDetails) {
        ...
        public Builder copy(DisableExternalContainerDatabaseManagementFeatureRequest o) {
            ...
            disableExternalContainerDatabaseManagementFeatureDetails(
                    o.getDisableExternalContainerDatabaseManagementFeatureDetails());
         ...
         */
        public DisableExternalContainerDatabaseManagementFeatureRequest build() {
        ...
        public Builder body$(
                com.oracle.bmc.databasemanagement.model
                                .DisableExternalContainerDatabaseManagementFeatureDetails
                        body) {
            disableExternalContainerDatabaseManagementFeatureDetails(body);
            return this;
        }
        ...
        public DisableExternalContainerDatabaseManagementFeatureRequest
                buildWithoutInvocationCallback() {
            DisableExternalContainerDatabaseManagementFeatureRequest request =
                    new DisableExternalContainerDatabaseManagementFeatureRequest();
            request.externalContainerDatabaseId = externalContainerDatabaseId;
            request.disableExternalContainerDatabaseManagementFeatureDetails =
                    disableExternalContainerDatabaseManagementFeatureDetails;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalContainerDatabaseManagementFeatureRequest)) {
            return false;
        }

        DisableExternalContainerDatabaseManagementFeatureRequest other =
                (DisableExternalContainerDatabaseManagementFeatureRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.externalContainerDatabaseId, other.externalContainerDatabaseId)
                && java.util.Objects.equals(
                        this.disableExternalContainerDatabaseManagementFeatureDetails,
                        other.disableExternalContainerDatabaseManagementFeatureDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.disableExternalContainerDatabaseManagementFeatureDetails == null
                                ? 43
                                : this.disableExternalContainerDatabaseManagementFeatureDetails
                                        .hashCode());
