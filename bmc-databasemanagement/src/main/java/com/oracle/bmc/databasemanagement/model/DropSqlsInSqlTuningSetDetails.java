...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DropSqlsInSqlTuningSetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DropSqlsInSqlTuningSetDetails
    ...
    /**
     * Flag to indicate whether to drop the Sql statements or just display the plsql used to drop
     * the Sql statements.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("showSqlOnly")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DropSqlsInSqlTuningSetDetails)) {
            return false;
        }
