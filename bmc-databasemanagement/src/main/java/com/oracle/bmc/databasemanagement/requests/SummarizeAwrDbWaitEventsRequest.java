...
public class SummarizeAwrDbWaitEventsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbWaitEventsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbWaitEventsRequest(managedDatabaseId, awrDbId, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, name, sessionType, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken);
        }
    }
