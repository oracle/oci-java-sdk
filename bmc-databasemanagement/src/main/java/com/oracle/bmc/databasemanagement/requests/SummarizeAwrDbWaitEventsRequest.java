...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAwrDbWaitEventsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDbWaitEventsRequest.
 */
...
public class SummarizeAwrDbWaitEventsRequest
    ...
    public static class Builder
         ...
         * @return instance of SummarizeAwrDbWaitEventsRequest
         */
        public SummarizeAwrDbWaitEventsRequest buildWithoutInvocationCallback() {
            SummarizeAwrDbWaitEventsRequest request = new SummarizeAwrDbWaitEventsRequest();
            ...
            return request;
            // new SummarizeAwrDbWaitEventsRequest(managedDatabaseId, awrDbId, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, name, sessionType, containerId, page, limit, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDbWaitEventsRequest)) {
            return false;
        }

        SummarizeAwrDbWaitEventsRequest other = (SummarizeAwrDbWaitEventsRequest) o;
