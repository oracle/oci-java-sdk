...
public class CreateCloudDbSystemConnectorResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private CreateCloudDbSystemConnectorResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateCloudDbSystemConnectorResponse o) {
         ...
         */
        @Override
        public CreateCloudDbSystemConnectorResponse build() {
            return new CreateCloudDbSystemConnectorResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, cloudDbSystemConnector);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCloudDbSystemConnectorResponse)) {
            return false;
        }

        CreateCloudDbSystemConnectorResponse other = (CreateCloudDbSystemConnectorResponse) o;
