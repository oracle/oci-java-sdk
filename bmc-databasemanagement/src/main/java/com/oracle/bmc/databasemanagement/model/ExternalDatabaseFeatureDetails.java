...
public class ExternalDatabaseFeatureDetails
    ...
    @Deprecated
    @java.beans.ConstructorProperties({"connectorDetails"})
    protected ExternalDatabaseFeatureDetails(ConnectorDetails connectorDetails) {
        super();
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalDatabaseFeatureDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalDatabaseFeatureDetails)) {
            return false;
        }

        ExternalDatabaseFeatureDetails other = (ExternalDatabaseFeatureDetails) o;
        return java.util.Objects.equals(this.connectorDetails, other.connectorDetails)
                && super.equals(other);
    }
