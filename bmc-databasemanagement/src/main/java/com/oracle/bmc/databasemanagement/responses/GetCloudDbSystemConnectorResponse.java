...
public class GetCloudDbSystemConnectorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetCloudDbSystemConnectorResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetCloudDbSystemConnectorResponse o) {
         ...
         */
        @Override
        public GetCloudDbSystemConnectorResponse build() {
            return new GetCloudDbSystemConnectorResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, cloudDbSystemConnector);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetCloudDbSystemConnectorResponse)) {
            return false;
        }

        GetCloudDbSystemConnectorResponse other = (GetCloudDbSystemConnectorResponse) o;
