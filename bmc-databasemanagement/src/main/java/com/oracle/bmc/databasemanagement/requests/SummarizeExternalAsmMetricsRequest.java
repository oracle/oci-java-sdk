...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeExternalAsmMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeExternalAsmMetricsRequest.
 */
...
public class SummarizeExternalAsmMetricsRequest
    ...
    public static class Builder
        ...
        public SummarizeExternalAsmMetricsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeExternalAsmMetricsRequest(externalAsmId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
