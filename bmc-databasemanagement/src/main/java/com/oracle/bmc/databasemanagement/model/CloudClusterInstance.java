...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CloudClusterInstance.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class CloudClusterInstance extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CloudClusterInstance build() {
            CloudClusterInstance model =
                    new CloudClusterInstance(
                            this.id,
                            this.dbaasId,
                            this.displayName,
                            this.componentName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudClusterInstance model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudClusterInstance(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudClusterInstance)) {
            return false;
        }

        CloudClusterInstance other = (CloudClusterInstance) o;
