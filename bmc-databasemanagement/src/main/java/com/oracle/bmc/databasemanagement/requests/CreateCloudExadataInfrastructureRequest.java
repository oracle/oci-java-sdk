...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/CreateCloudExadataInfrastructureExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCloudExadataInfrastructureRequest.
 */
...
public class CreateCloudExadataInfrastructureRequest
    ...
    public static class Builder
        ...
        public CreateCloudExadataInfrastructureRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateCloudExadataInfrastructureRequest(createCloudExadataInfrastructureDetails, opcRequestId, opcRetryToken);
        }
    }
