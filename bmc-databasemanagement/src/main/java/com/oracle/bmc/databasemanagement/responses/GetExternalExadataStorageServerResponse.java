...
public class GetExternalExadataStorageServerResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetExternalExadataStorageServerResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetExternalExadataStorageServerResponse o) {
         ...
         */
        public GetExternalExadataStorageServerResponse build() {
            return new GetExternalExadataStorageServerResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExternalExadataStorageServerResponse)) {
            return false;
        }

        GetExternalExadataStorageServerResponse other = (GetExternalExadataStorageServerResponse) o;
