...
public enum DatabaseStatus {
    ...
    static {
        ...
        for (DatabaseStatus v : DatabaseStatus.values()) {
    ...
    public static DatabaseStatus create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'DatabaseStatus', returning UnknownEnumValue",
                key);
