...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = DatabaseCredentialDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabaseSecretCredentialDetails.class,
        name = "SECRET"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabaseNamedCredentialDetails.class,
        name = "NAMED_CREDENTIAL"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabasePasswordCredentialDetails.class,
        name = "PASSWORD"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class DatabaseCredentialDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected DatabaseCredentialDetails() {
        super();
    }
