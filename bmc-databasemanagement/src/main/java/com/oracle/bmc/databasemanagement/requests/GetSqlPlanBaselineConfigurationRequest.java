...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetSqlPlanBaselineConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSqlPlanBaselineConfigurationRequest.
 */
...
public class GetSqlPlanBaselineConfigurationRequest
    ...
    public static class Builder
        ...
        public GetSqlPlanBaselineConfigurationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSqlPlanBaselineConfigurationRequest(managedDatabaseId, opcRequestId, opcNamedCredentialId);
        }
    }
