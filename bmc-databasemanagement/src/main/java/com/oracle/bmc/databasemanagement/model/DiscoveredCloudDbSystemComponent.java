...
/**
 * The details of a cloud DB system component. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        defaultImpl = DiscoveredCloudDbSystemComponent.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudClusterInstance.class,
            name = "CLUSTER_INSTANCE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudPluggableDatabase.class,
            name = "PLUGGABLE_DATABASE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudCluster.class,
            name = "CLUSTER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudAsm.class,
            name = "ASM"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudListener.class,
            name = "LISTENER"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudDbInstance.class,
            name = "DATABASE_INSTANCE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudDatabase.class,
            name = "DATABASE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudDbHome.class,
            name = "DATABASE_HOME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudDbNode.class,
            name = "DATABASE_NODE"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DiscoveredCloudAsmInstance.class,
            name = "ASM_INSTANCE")
})
...
public class DiscoveredCloudDbSystemComponent
    ...
    protected DiscoveredCloudDbSystemComponent(
            String componentId,
            String displayName,
    ...
    private final java.util.List<AssociatedCloudComponent> associatedComponents;
     ...
     * @return the value
     */
    public java.util.List<AssociatedCloudComponent> getAssociatedComponents() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredCloudDbSystemComponent(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredCloudDbSystemComponent)) {
            return false;
        }

        DiscoveredCloudDbSystemComponent other = (DiscoveredCloudDbSystemComponent) o;
