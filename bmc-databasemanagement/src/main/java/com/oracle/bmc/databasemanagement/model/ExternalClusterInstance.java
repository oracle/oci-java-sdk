...
/**
 * The details of an external cluster instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExternalClusterInstance.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExternalClusterInstance
    ...
    public static class Builder {
        ...
        public ExternalClusterInstance build() {
            ExternalClusterInstance model =
                    new ExternalClusterInstance(
                            this.id,
                            this.displayName,
                            this.componentName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalClusterInstance model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalClusterInstance(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalClusterInstance)) {
            return false;
        }

        ExternalClusterInstance other = (ExternalClusterInstance) o;
