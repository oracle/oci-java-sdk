...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeCloudDbNodeMetricsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeCloudDbNodeMetricsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class SummarizeCloudDbNodeMetricsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SummarizeCloudDbNodeMetricsRequest, java.lang.Void> {
         ...
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud database node.
         */
        private String cloudDbNodeId = null;
         ...
         * @return this builder instance
         */
        public Builder copy(SummarizeCloudDbNodeMetricsRequest o) {
            cloudDbNodeId(o.getCloudDbNodeId());
        ...
        /**
         * Build the instance of SummarizeCloudDbNodeMetricsRequest as configured by this builder
         *
         ...
         *
         * @return instance of SummarizeCloudDbNodeMetricsRequest
         */
        public SummarizeCloudDbNodeMetricsRequest build() {
            SummarizeCloudDbNodeMetricsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SummarizeCloudDbNodeMetricsRequest
         */
        public SummarizeCloudDbNodeMetricsRequest buildWithoutInvocationCallback() {
            SummarizeCloudDbNodeMetricsRequest request = new SummarizeCloudDbNodeMetricsRequest();
            request.cloudDbNodeId = cloudDbNodeId;
            ...
            return request;
            // new SummarizeCloudDbNodeMetricsRequest(cloudDbNodeId, startTime, endTime, opcRequestId, page, limit, filterByMetricNames);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeCloudDbNodeMetricsRequest)) {
            return false;
        }

        SummarizeCloudDbNodeMetricsRequest other = (SummarizeCloudDbNodeMetricsRequest) o;
