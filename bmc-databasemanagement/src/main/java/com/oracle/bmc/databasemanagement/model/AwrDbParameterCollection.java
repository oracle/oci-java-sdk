...
/**
 * The AWR database parameter data. <br>
...
public final class AwrDbParameterCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbParameterCollection build() {
            AwrDbParameterCollection model =
                    new AwrDbParameterCollection(
                            this.name,
                            this.version,
                            this.queryKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbParameterCollection model) {
    ...
    /** A list of AWR database parameter summary data. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDbParameterSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AwrDbParameterSummary> getItems() {
        return items;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AwrDbParameterCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbParameterCollection)) {
            return false;
        }

        AwrDbParameterCollection other = (AwrDbParameterCollection) o;
