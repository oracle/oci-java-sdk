...
public final class AwrDbMetricCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbMetricCollection build() {
            AwrDbMetricCollection model =
                    new AwrDbMetricCollection(
                            this.name,
                            this.version,
                            this.queryKey,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbMetricCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AwrDbMetricCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbMetricCollection)) {
            return false;
        }

        AwrDbMetricCollection other = (AwrDbMetricCollection) o;
