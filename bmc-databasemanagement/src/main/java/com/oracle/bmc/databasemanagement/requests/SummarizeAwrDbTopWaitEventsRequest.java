...
public class SummarizeAwrDbTopWaitEventsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbTopWaitEventsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbTopWaitEventsRequest(managedDatabaseId, awrDbId, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, sessionType, containerId, topN, sortBy, sortOrder, opcRequestId, opcRetryToken);
        }
    }
