...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAwrDbTopWaitEventsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAwrDbTopWaitEventsRequest.
 */
...
public class SummarizeAwrDbTopWaitEventsRequest
    ...
    public static class Builder
        ...
        public SummarizeAwrDbTopWaitEventsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAwrDbTopWaitEventsRequest(managedDatabaseId, awrDbId, instNum, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, sessionType, containerId, topN, sortBy, sortOrder, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
