...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAlertLogCountsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAlertLogCountsRequest.
 */
...
public class SummarizeAlertLogCountsRequest
    ...
    public static class Builder
        ...
        public SummarizeAlertLogCountsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAlertLogCountsRequest(managedDatabaseId, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, levelFilter, groupBy, typeFilter, logSearchText, isRegularExpression, page, limit, opcRequestId, opcNamedCredentialId);
        }
    }
