...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseNamedCredentialDetails.Builder.class)
...
public final class DatabaseNamedCredentialDetails extends DatabaseCredentialDetails {
    ...
    public static class Builder {
        ...
        public DatabaseNamedCredentialDetails build() {
            DatabaseNamedCredentialDetails model =
                    new DatabaseNamedCredentialDetails(this.namedCredentialId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseNamedCredentialDetails model) {
    ...
    @Deprecated
    public DatabaseNamedCredentialDetails(String namedCredentialId) {
        super();
        this.namedCredentialId = namedCredentialId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseNamedCredentialDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseNamedCredentialDetails)) {
            return false;
        }

        DatabaseNamedCredentialDetails other = (DatabaseNamedCredentialDetails) o;
