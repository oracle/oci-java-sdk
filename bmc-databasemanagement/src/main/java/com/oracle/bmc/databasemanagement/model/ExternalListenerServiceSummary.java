...
/**
 * The summary of a service registered with an external listener. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExternalListenerServiceSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ExternalListenerServiceSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "listenerId", "managedDatabaseId"})
    public ExternalListenerServiceSummary(
            String name, String listenerId, String managedDatabaseId) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        public ExternalListenerServiceSummary build() {
            ExternalListenerServiceSummary model =
                    new ExternalListenerServiceSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalListenerServiceSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalListenerServiceSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalListenerServiceSummary)) {
            return false;
        }

        ExternalListenerServiceSummary other = (ExternalListenerServiceSummary) o;
