...
public class GetDbManagementPrivateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDbManagementPrivateEndpointResponse)) {
            return false;
        }

        GetDbManagementPrivateEndpointResponse other = (GetDbManagementPrivateEndpointResponse) o;
