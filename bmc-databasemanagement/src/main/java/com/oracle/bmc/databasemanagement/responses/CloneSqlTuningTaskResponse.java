...
public class CloneSqlTuningTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CloneSqlTuningTaskResponse> {
         ...
         */
        @Override
        public Builder copy(CloneSqlTuningTaskResponse o) {
         ...
         */
        @Override
        public CloneSqlTuningTaskResponse build() {
            return new CloneSqlTuningTaskResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneSqlTuningTaskResponse)) {
            return false;
        }

        CloneSqlTuningTaskResponse other = (CloneSqlTuningTaskResponse) o;
