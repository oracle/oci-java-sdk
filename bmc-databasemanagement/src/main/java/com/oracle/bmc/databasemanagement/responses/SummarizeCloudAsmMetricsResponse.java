...
public class SummarizeCloudAsmMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeCloudAsmMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeCloudAsmMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeCloudAsmMetricsResponse build() {
            return new SummarizeCloudAsmMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeCloudAsmMetricsResponse)) {
            return false;
        }

        SummarizeCloudAsmMetricsResponse other = (SummarizeCloudAsmMetricsResponse) o;
