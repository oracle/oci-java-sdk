...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudAsmUsersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudAsmUsersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListCloudAsmUsersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudAsmUsersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudAsmUsersRequest o) {
        ...
        /**
         * Build the instance of ListCloudAsmUsersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudAsmUsersRequest
         */
        public ListCloudAsmUsersRequest build() {
            ListCloudAsmUsersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudAsmUsersRequest
         */
        public ListCloudAsmUsersRequest buildWithoutInvocationCallback() {
            ListCloudAsmUsersRequest request = new ListCloudAsmUsersRequest();
            ...
            return request;
            // new ListCloudAsmUsersRequest(cloudAsmId, page, limit, sortBy, sortOrder, opcRequestId, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudAsmUsersRequest)) {
            return false;
        }

        ListCloudAsmUsersRequest other = (ListCloudAsmUsersRequest) o;
