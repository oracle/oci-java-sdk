...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudAsmsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudAsmsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListCloudAsmsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudAsmsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudAsmsRequest o) {
        ...
        /**
         * Build the instance of ListCloudAsmsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudAsmsRequest
         */
        public ListCloudAsmsRequest build() {
            ListCloudAsmsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudAsmsRequest
         */
        public ListCloudAsmsRequest buildWithoutInvocationCallback() {
            ListCloudAsmsRequest request = new ListCloudAsmsRequest();
            ...
            return request;
            // new ListCloudAsmsRequest(compartmentId, cloudDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudAsmsRequest)) {
            return false;
        }

        ListCloudAsmsRequest other = (ListCloudAsmsRequest) o;
