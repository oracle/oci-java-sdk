...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetAwrDbReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAwrDbReportRequest.
 */
...
public class GetAwrDbReportRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetAwrDbReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAwrDbReportRequest(managedDatabaseId, awrDbId, instNums, beginSnIdGreaterThanOrEqualTo, endSnIdLessThanOrEqualTo, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, reportType, containerId, reportFormat, opcRequestId, opcRetryToken, opcNamedCredentialId);
        }
    }
