...
public class GetExecutionPlanStatsComparisionResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemanagement.model.ExecutionPlanStatsComparision
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder executionPlanStatsComparision(
                com.oracle.bmc.databasemanagement.model.ExecutionPlanStatsComparision
                        executionPlanStatsComparision) {
            this.executionPlanStatsComparision = executionPlanStatsComparision;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",executionPlanStatsComparision=")
                .append(String.valueOf(executionPlanStatsComparision));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetExecutionPlanStatsComparisionResponse)) {
            return false;
        }

        GetExecutionPlanStatsComparisionResponse other =
                (GetExecutionPlanStatsComparisionResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.executionPlanStatsComparision, other.executionPlanStatsComparision);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.executionPlanStatsComparision == null
                                ? 43
                                : this.executionPlanStatsComparision.hashCode());
        return result;
    }
}
