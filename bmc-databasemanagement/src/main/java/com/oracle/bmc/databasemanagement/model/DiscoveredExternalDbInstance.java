...
/**
 * The details of an Oracle DB instance discovered in an external DB system discovery run. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DiscoveredExternalDbInstance.Builder.class)
...
public final class DiscoveredExternalDbInstance extends DiscoveredExternalDbSystemComponent {
    ...
    public static class Builder {
        ...
        public DiscoveredExternalDbInstance build() {
            DiscoveredExternalDbInstance model =
                    new DiscoveredExternalDbInstance(
                            this.componentId,
                            this.displayName,
                            this.componentName,
                            this.resourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveredExternalDbInstance model) {
    ...
    @Deprecated
    public DiscoveredExternalDbInstance(
            String componentId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredExternalDbInstance(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredExternalDbInstance)) {
            return false;
        }

        DiscoveredExternalDbInstance other = (DiscoveredExternalDbInstance) o;
