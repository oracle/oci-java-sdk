...
/**
 * The details required to enable high frequency Automatic SPM Evolve Advisor task. It takes either
    ...
    public static class Builder {
        ...
        public EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails build() {
            EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails model =
                    new EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails(
