...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudAsmDiskGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudAsmDiskGroupsRequest.
 */
...
public class ListCloudAsmDiskGroupsRequest
    ...
    public static class Builder
        ...
        public ListCloudAsmDiskGroupsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCloudAsmDiskGroupsRequest(cloudAsmId, page, limit, sortBy, sortOrder, opcRequestId, opcNamedCredentialId);
        }
    }
