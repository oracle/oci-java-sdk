...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/SummarizeAttentionLogCountsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SummarizeAttentionLogCountsRequest.
 */
...
public class SummarizeAttentionLogCountsRequest
    ...
    public static class Builder
        ...
        public SummarizeAttentionLogCountsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAttentionLogCountsRequest(managedDatabaseId, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, urgencyFilter, groupBy, typeFilter, logSearchText, isRegularExpression, page, limit, opcRequestId, opcNamedCredentialId);
        }
    }
