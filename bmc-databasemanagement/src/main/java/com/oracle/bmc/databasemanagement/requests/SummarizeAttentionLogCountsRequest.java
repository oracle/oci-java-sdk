...
public class SummarizeAttentionLogCountsRequest
    ...
    public static class Builder
        ...
        public SummarizeAttentionLogCountsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new SummarizeAttentionLogCountsRequest(managedDatabaseId, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, urgencyFilter, groupBy, typeFilter, logSearchText, isRegularExpression, page, limit, opcRequestId);
        }
    }
