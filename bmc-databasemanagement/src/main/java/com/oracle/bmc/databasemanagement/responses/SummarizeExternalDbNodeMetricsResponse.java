...
public class SummarizeExternalDbNodeMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeExternalDbNodeMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeExternalDbNodeMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeExternalDbNodeMetricsResponse build() {
            return new SummarizeExternalDbNodeMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalDbNodeMetricsResponse)) {
            return false;
        }

        SummarizeExternalDbNodeMetricsResponse other = (SummarizeExternalDbNodeMetricsResponse) o;
