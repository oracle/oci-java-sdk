...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ChangeDbManagementPrivateEndpointCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDbManagementPrivateEndpointCompartmentRequest.
 */
...
public class ChangeDbManagementPrivateEndpointCompartmentRequest
    ...
    public static class Builder
        ...
        public Builder changeDbManagementPrivateEndpointCompartmentDetails(
                com.oracle.bmc.databasemanagement.model
                                .ChangeDbManagementPrivateEndpointCompartmentDetails
                        changeDbManagementPrivateEndpointCompartmentDetails) {
            this.changeDbManagementPrivateEndpointCompartmentDetails =
                    changeDbManagementPrivateEndpointCompartmentDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeDbManagementPrivateEndpointCompartmentRequest o) {
            dbManagementPrivateEndpointId(o.getDbManagementPrivateEndpointId());
            changeDbManagementPrivateEndpointCompartmentDetails(
                    o.getChangeDbManagementPrivateEndpointCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeDbManagementPrivateEndpointCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeDbManagementPrivateEndpointCompartmentRequest
         */
        public ChangeDbManagementPrivateEndpointCompartmentRequest build() {
         ...
         * @return instance of ChangeDbManagementPrivateEndpointCompartmentRequest
         */
        public ChangeDbManagementPrivateEndpointCompartmentRequest
                buildWithoutInvocationCallback() {
            ChangeDbManagementPrivateEndpointCompartmentRequest request =
                    new ChangeDbManagementPrivateEndpointCompartmentRequest();
            request.dbManagementPrivateEndpointId = dbManagementPrivateEndpointId;
            request.changeDbManagementPrivateEndpointCompartmentDetails =
                    changeDbManagementPrivateEndpointCompartmentDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new ChangeDbManagementPrivateEndpointCompartmentRequest(dbManagementPrivateEndpointId, changeDbManagementPrivateEndpointCompartmentDetails, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeDbManagementPrivateEndpointCompartmentDetails=")
                .append(String.valueOf(this.changeDbManagementPrivateEndpointCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDbManagementPrivateEndpointCompartmentRequest)) {
            return false;
        }

        ChangeDbManagementPrivateEndpointCompartmentRequest other =
                (ChangeDbManagementPrivateEndpointCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.dbManagementPrivateEndpointId, other.dbManagementPrivateEndpointId)
                && java.util.Objects.equals(
                        this.changeDbManagementPrivateEndpointCompartmentDetails,
                        other.changeDbManagementPrivateEndpointCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeDbManagementPrivateEndpointCompartmentDetails == null
                                ? 43
                                : this.changeDbManagementPrivateEndpointCompartmentDetails
                                        .hashCode());
