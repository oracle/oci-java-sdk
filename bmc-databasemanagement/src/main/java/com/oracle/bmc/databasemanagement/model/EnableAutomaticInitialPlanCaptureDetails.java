...
/**
 * The details required to enable automatic initial plan capture. It takes either credentials or
...
public final class EnableAutomaticInitialPlanCaptureDetails
    ...
    public EnableAutomaticInitialPlanCaptureDetails(
    ...
    public static class Builder {
        ...
        public EnableAutomaticInitialPlanCaptureDetails build() {
            EnableAutomaticInitialPlanCaptureDetails model =
                    new EnableAutomaticInitialPlanCaptureDetails(
