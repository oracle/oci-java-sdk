...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AssociatedCloudComponent.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AssociatedCloudComponent
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"componentId", "componentType", "associationType"})
    public AssociatedCloudComponent(
            String componentId,
            CloudDbSystemComponentType componentType,
    ...
    public static class Builder {
        ...
        private CloudDbSystemComponentType componentType;
         ...
         * @return this builder
         */
        public Builder componentType(CloudDbSystemComponentType componentType) {
            this.componentType = componentType;
        ...
        public AssociatedCloudComponent build() {
            AssociatedCloudComponent model =
                    new AssociatedCloudComponent(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AssociatedCloudComponent model) {
    ...
    /** The type of associated component. */
    @com.fasterxml.jackson.annotation.JsonProperty("componentType")
    private final CloudDbSystemComponentType componentType;
     ...
     * @return the value
     */
    public CloudDbSystemComponentType getComponentType() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AssociatedCloudComponent(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AssociatedCloudComponent)) {
            return false;
        }

        AssociatedCloudComponent other = (AssociatedCloudComponent) o;
