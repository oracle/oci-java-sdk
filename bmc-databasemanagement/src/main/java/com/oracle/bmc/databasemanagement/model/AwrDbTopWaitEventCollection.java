...
public final class AwrDbTopWaitEventCollection extends AwrQueryResult {
    ...
    public static class Builder {
        ...
        public AwrDbTopWaitEventCollection build() {
            AwrDbTopWaitEventCollection model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AwrDbTopWaitEventCollection model) {
    ...
    /** A list of AWR top event summary data. */
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    private final java.util.List<AwrDbTopWaitEventSummary> items;
     ...
     * @return the value
     */
    public java.util.List<AwrDbTopWaitEventSummary> getItems() {
        return items;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwrDbTopWaitEventCollection)) {
            return false;
        }

        AwrDbTopWaitEventCollection other = (AwrDbTopWaitEventCollection) o;
