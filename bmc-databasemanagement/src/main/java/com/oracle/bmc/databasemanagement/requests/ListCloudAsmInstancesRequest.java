...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudAsmInstancesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudAsmInstancesRequest.
 */
...
public class ListCloudAsmInstancesRequest
    ...
    public static class Builder
        ...
        public ListCloudAsmInstancesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListCloudAsmInstancesRequest(compartmentId, cloudAsmId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
