...
public class SummarizeCloudDbNodeMetricsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private SummarizeCloudDbNodeMetricsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SummarizeCloudDbNodeMetricsResponse o) {
         ...
         */
        @Override
        public SummarizeCloudDbNodeMetricsResponse build() {
            return new SummarizeCloudDbNodeMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeCloudDbNodeMetricsResponse)) {
            return false;
        }

        SummarizeCloudDbNodeMetricsResponse other = (SummarizeCloudDbNodeMetricsResponse) o;
