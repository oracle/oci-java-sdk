...
public class LoadSqlPlanBaselinesFromCursorCacheResponse
    ...
    private LoadSqlPlanBaselinesFromCursorCacheResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(LoadSqlPlanBaselinesFromCursorCacheResponse o) {
         ...
         */
        @Override
        public LoadSqlPlanBaselinesFromCursorCacheResponse build() {
            return new LoadSqlPlanBaselinesFromCursorCacheResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadSqlPlanBaselinesFromCursorCacheResponse)) {
            return false;
        }

        LoadSqlPlanBaselinesFromCursorCacheResponse other =
                (LoadSqlPlanBaselinesFromCursorCacheResponse) o;
