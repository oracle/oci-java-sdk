...
public class UpdateExternalMysqlDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateExternalMysqlDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateExternalMysqlDatabaseResponse o) {
         ...
         */
        @Override
        public UpdateExternalMysqlDatabaseResponse build() {
            return new UpdateExternalMysqlDatabaseResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, externalMySqlDatabase);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalMysqlDatabaseResponse)) {
            return false;
        }

        UpdateExternalMysqlDatabaseResponse other = (UpdateExternalMysqlDatabaseResponse) o;
