...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetIormPlanExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetIormPlanRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class GetIormPlanRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetIormPlanRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetIormPlanRequest o) {
        ...
        /**
         * Build the instance of GetIormPlanRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetIormPlanRequest
         */
        public GetIormPlanRequest build() {
            GetIormPlanRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetIormPlanRequest
         */
        public GetIormPlanRequest buildWithoutInvocationCallback() {
            GetIormPlanRequest request = new GetIormPlanRequest();
            request.externalExadataStorageServerId = externalExadataStorageServerId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetIormPlanRequest(externalExadataStorageServerId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetIormPlanRequest)) {
            return false;
        }

        GetIormPlanRequest other = (GetIormPlanRequest) o;
