...
/**
 * The details used to update a Database Management private endpoint. <br>
...
public final class UpdateDbManagementPrivateEndpointDetails
    ...
    public static class Builder {
        ...
        public UpdateDbManagementPrivateEndpointDetails build() {
            UpdateDbManagementPrivateEndpointDetails model =
                    new UpdateDbManagementPrivateEndpointDetails(
                            this.name, this.description, this.nsgIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDbManagementPrivateEndpointDetails model) {
