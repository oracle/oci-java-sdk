...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/GetTopSqlCpuActivityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTopSqlCpuActivityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class GetTopSqlCpuActivityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetTopSqlCpuActivityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetTopSqlCpuActivityRequest o) {
        ...
        /**
         * Build the instance of GetTopSqlCpuActivityRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetTopSqlCpuActivityRequest
         */
        public GetTopSqlCpuActivityRequest build() {
            GetTopSqlCpuActivityRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetTopSqlCpuActivityRequest
         */
        public GetTopSqlCpuActivityRequest buildWithoutInvocationCallback() {
            GetTopSqlCpuActivityRequest request = new GetTopSqlCpuActivityRequest();
            request.externalExadataStorageServerId = externalExadataStorageServerId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetTopSqlCpuActivityRequest(externalExadataStorageServerId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTopSqlCpuActivityRequest)) {
            return false;
        }

        GetTopSqlCpuActivityRequest other = (GetTopSqlCpuActivityRequest) o;
