...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListExternalAsmDiskGroupsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExternalAsmDiskGroupsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListExternalAsmDiskGroupsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListExternalAsmDiskGroupsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListExternalAsmDiskGroupsRequest o) {
        ...
        /**
         * Build the instance of ListExternalAsmDiskGroupsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListExternalAsmDiskGroupsRequest
         */
        public ListExternalAsmDiskGroupsRequest build() {
            ListExternalAsmDiskGroupsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExternalAsmDiskGroupsRequest
         */
        public ListExternalAsmDiskGroupsRequest buildWithoutInvocationCallback() {
            ListExternalAsmDiskGroupsRequest request = new ListExternalAsmDiskGroupsRequest();
            ...
            return request;
            // new ListExternalAsmDiskGroupsRequest(externalAsmId, page, limit, sortBy, sortOrder, opcRequestId, opcNamedCredentialId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExternalAsmDiskGroupsRequest)) {
            return false;
        }

        ListExternalAsmDiskGroupsRequest other = (ListExternalAsmDiskGroupsRequest) o;
