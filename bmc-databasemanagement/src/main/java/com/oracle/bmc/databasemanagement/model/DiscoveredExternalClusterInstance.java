...
public final class DiscoveredExternalClusterInstance extends DiscoveredExternalDbSystemComponent {
    ...
    public static class Builder {
        ...
        public DiscoveredExternalClusterInstance build() {
            DiscoveredExternalClusterInstance model =
                    new DiscoveredExternalClusterInstance(
                            this.componentId,
                            this.displayName,
                            this.componentName,
                            this.resourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveredExternalClusterInstance model) {
    ...
    @Deprecated
    public DiscoveredExternalClusterInstance(
            String componentId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredExternalClusterInstance(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredExternalClusterInstance)) {
            return false;
        }

        DiscoveredExternalClusterInstance other = (DiscoveredExternalClusterInstance) o;
