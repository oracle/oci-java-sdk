...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/DropSqlsInSqlTuningSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DropSqlsInSqlTuningSetRequest.
 */
...
public class DropSqlsInSqlTuningSetRequest
    ...
    public static class Builder
        ...
        public DropSqlsInSqlTuningSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DropSqlsInSqlTuningSetRequest(managedDatabaseId, sqlTuningSetId, dropSqlsInSqlTuningSetDetails, opcRequestId, opcRetryToken);
        }
    }
