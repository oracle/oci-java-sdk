...
/**
 * The details of an Oracle listener discovered in a cloud DB system discovery run. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DiscoveredCloudListener.Builder.class)
...
public final class DiscoveredCloudListener extends DiscoveredCloudDbSystemComponent {
    ...
    public static class Builder {
        ...
        public DiscoveredCloudListener build() {
            DiscoveredCloudListener model =
                    new DiscoveredCloudListener(
                            this.componentId,
                            this.displayName,
                            this.componentName,
                            this.resourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveredCloudListener model) {
    ...
    @Deprecated
    public DiscoveredCloudListener(
            String componentId,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredCloudListener(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredCloudListener)) {
            return false;
        }

        DiscoveredCloudListener other = (DiscoveredCloudListener) o;
