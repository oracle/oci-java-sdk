...
public class CreateTablespaceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
        ...
        public CreateTablespaceResponse build() {
            return new CreateTablespaceResponse(__httpStatusCode__, opcRequestId, tablespace);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTablespaceResponse)) {
            return false;
        }

        CreateTablespaceResponse other = (CreateTablespaceResponse) o;
