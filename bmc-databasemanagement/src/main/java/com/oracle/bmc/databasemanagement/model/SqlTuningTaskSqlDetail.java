...
public final class SqlTuningTaskSqlDetail {
    ...
    public static class Builder {
        ...
        public SqlTuningTaskSqlDetail build() {
            SqlTuningTaskSqlDetail __instance__ = new SqlTuningTaskSqlDetail(sqlId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SqlTuningTaskSqlDetail o) {
            Builder copiedBuilder = sqlId(o.getSqlId());
