...
public class ImplementOptimizerStatisticsAdvisorRecommendationsResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImplementOptimizerStatisticsAdvisorRecommendationsResponse)) {
            return false;
        }

        ImplementOptimizerStatisticsAdvisorRecommendationsResponse other =
                (ImplementOptimizerStatisticsAdvisorRecommendationsResponse) o;
