...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TestNamedPreferredCredentialDetails.Builder.class)
...
public final class TestNamedPreferredCredentialDetails extends TestPreferredCredentialDetails {
    ...
    public static class Builder {
        ...
        public TestNamedPreferredCredentialDetails build() {
            TestNamedPreferredCredentialDetails model =
                    new TestNamedPreferredCredentialDetails(this.namedCredentialId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TestNamedPreferredCredentialDetails model) {
    ...
    @Deprecated
    public TestNamedPreferredCredentialDetails(String namedCredentialId) {
        super();
        this.namedCredentialId = namedCredentialId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TestNamedPreferredCredentialDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TestNamedPreferredCredentialDetails)) {
            return false;
        }

        TestNamedPreferredCredentialDetails other = (TestNamedPreferredCredentialDetails) o;
