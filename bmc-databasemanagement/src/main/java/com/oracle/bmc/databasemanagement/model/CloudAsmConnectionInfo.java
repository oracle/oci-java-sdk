...
/**
 * The details required to connect to a cloud ASM instance. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudAsmConnectionInfo.Builder.class)
...
public final class CloudAsmConnectionInfo extends CloudDbSystemConnectionInfo {
    ...
    public static class Builder {
        ...
        private CloudAsmConnectionCredentials connectionCredentials;

        public Builder connectionCredentials(CloudAsmConnectionCredentials connectionCredentials) {
        ...
        public CloudAsmConnectionInfo build() {
            CloudAsmConnectionInfo model =
                    new CloudAsmConnectionInfo(this.connectionString, this.connectionCredentials);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudAsmConnectionInfo model) {
    ...
    @Deprecated
    public CloudAsmConnectionInfo(
            AsmConnectionString connectionString,
            CloudAsmConnectionCredentials connectionCredentials) {
        super();
        this.connectionString = connectionString;
        this.connectionCredentials = connectionCredentials;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("connectionCredentials")
    private final CloudAsmConnectionCredentials connectionCredentials;

    public CloudAsmConnectionCredentials getConnectionCredentials() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudAsmConnectionInfo(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAsmConnectionInfo)) {
            return false;
        }

        CloudAsmConnectionInfo other = (CloudAsmConnectionInfo) o;
