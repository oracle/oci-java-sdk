...
/**
 * The details of an Oracle DB node discovered in a cloud DB system discovery run. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DiscoveredCloudDbNode.Builder.class)
...
public final class DiscoveredCloudDbNode extends DiscoveredCloudDbSystemComponent {
    ...
    public static class Builder {
        ...
        public DiscoveredCloudDbNode build() {
            DiscoveredCloudDbNode model =
                    new DiscoveredCloudDbNode(
                            this.componentId,
                            this.displayName,
                            this.componentName,
                            this.resourceId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DiscoveredCloudDbNode model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DiscoveredCloudDbNode(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiscoveredCloudDbNode)) {
            return false;
        }

        DiscoveredCloudDbNode other = (DiscoveredCloudDbNode) o;
