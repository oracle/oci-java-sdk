...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/CreateCloudDbSystemDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateCloudDbSystemDiscoveryRequest.
 */
...
public class CreateCloudDbSystemDiscoveryRequest
    ...
    public static class Builder
        ...
        public CreateCloudDbSystemDiscoveryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateCloudDbSystemDiscoveryRequest(createCloudDbSystemDiscoveryDetails, opcRequestId, opcRetryToken);
        }
    }
