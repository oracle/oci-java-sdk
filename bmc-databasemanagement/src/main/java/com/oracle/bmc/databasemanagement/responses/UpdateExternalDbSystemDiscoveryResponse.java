...
public class UpdateExternalDbSystemDiscoveryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateExternalDbSystemDiscoveryResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(UpdateExternalDbSystemDiscoveryResponse o) {
         ...
         */
        @Override
        public UpdateExternalDbSystemDiscoveryResponse build() {
            return new UpdateExternalDbSystemDiscoveryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalDbSystemDiscoveryResponse)) {
            return false;
        }

        UpdateExternalDbSystemDiscoveryResponse other = (UpdateExternalDbSystemDiscoveryResponse) o;
