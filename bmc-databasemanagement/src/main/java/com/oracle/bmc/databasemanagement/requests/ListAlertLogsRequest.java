...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListAlertLogsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAlertLogsRequest.
 */
...
public class ListAlertLogsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAlertLogsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAlertLogsRequest(managedDatabaseId, timeGreaterThanOrEqualTo, timeLessThanOrEqualTo, levelFilter, typeFilter, logSearchText, isRegularExpression, sortBy, sortOrder, page, limit, opcRequestId, opcNamedCredentialId);
        }
    }
