...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListInboundReplicationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInboundReplicationsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListInboundReplicationsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListInboundReplicationsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListInboundReplicationsRequest o) {
        ...
        /**
         * Build the instance of ListInboundReplicationsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListInboundReplicationsRequest
         */
        public ListInboundReplicationsRequest build() {
            ListInboundReplicationsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListInboundReplicationsRequest
         */
        public ListInboundReplicationsRequest buildWithoutInvocationCallback() {
            ListInboundReplicationsRequest request = new ListInboundReplicationsRequest();
            ...
            return request;
            // new ListInboundReplicationsRequest(managedMySqlDatabaseId, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInboundReplicationsRequest)) {
            return false;
        }

        ListInboundReplicationsRequest other = (ListInboundReplicationsRequest) o;
