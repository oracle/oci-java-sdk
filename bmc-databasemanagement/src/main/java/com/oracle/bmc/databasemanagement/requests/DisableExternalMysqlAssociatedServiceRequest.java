...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/DisableExternalMysqlAssociatedServiceExample.java.html"
...
public class DisableExternalMysqlAssociatedServiceRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder disableExternalMysqlAssociatedServiceDetails(
                com.oracle.bmc.databasemanagement.model.DisableExternalMysqlAssociatedServiceDetails
                        disableExternalMysqlAssociatedServiceDetails) {
            this.disableExternalMysqlAssociatedServiceDetails =
                    disableExternalMysqlAssociatedServiceDetails;
            return this;
        }
         ...
         */
        public DisableExternalMysqlAssociatedServiceRequest build() {
            DisableExternalMysqlAssociatedServiceRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(
                com.oracle.bmc.databasemanagement.model.DisableExternalMysqlAssociatedServiceDetails
                        body) {
            disableExternalMysqlAssociatedServiceDetails(body);
            return this;
        }
         ...
         * @return instance of DisableExternalMysqlAssociatedServiceRequest
         */
        public DisableExternalMysqlAssociatedServiceRequest buildWithoutInvocationCallback() {
            DisableExternalMysqlAssociatedServiceRequest request =
                    new DisableExternalMysqlAssociatedServiceRequest();
            request.externalMySqlDatabaseId = externalMySqlDatabaseId;
            request.disableExternalMysqlAssociatedServiceDetails =
                    disableExternalMysqlAssociatedServiceDetails;
    ...
    public String toString() {
        ...
        sb.append(",disableExternalMysqlAssociatedServiceDetails=")
                .append(String.valueOf(this.disableExternalMysqlAssociatedServiceDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableExternalMysqlAssociatedServiceRequest)) {
            return false;
        }

        DisableExternalMysqlAssociatedServiceRequest other =
                (DisableExternalMysqlAssociatedServiceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.externalMySqlDatabaseId, other.externalMySqlDatabaseId)
                && java.util.Objects.equals(
                        this.disableExternalMysqlAssociatedServiceDetails,
                        other.disableExternalMysqlAssociatedServiceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.disableExternalMysqlAssociatedServiceDetails == null
                                ? 43
                                : this.disableExternalMysqlAssociatedServiceDetails.hashCode());
        result =
                (result * PRIME)
