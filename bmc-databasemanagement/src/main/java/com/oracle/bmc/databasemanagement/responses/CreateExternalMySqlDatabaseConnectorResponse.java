...
public class CreateExternalMySqlDatabaseConnectorResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateExternalMySqlDatabaseConnectorResponse)) {
            return false;
        }

        CreateExternalMySqlDatabaseConnectorResponse other =
                (CreateExternalMySqlDatabaseConnectorResponse) o;
