...
public final class AttentionLogCollection
    ...
    public AttentionLogCollection(
            String managedDatabaseId, java.util.List<AttentionLogSummary> items) {
        super();
    ...
    public static class Builder {
        ...
        public AttentionLogCollection build() {
            AttentionLogCollection model =
                    new AttentionLogCollection(this.managedDatabaseId, this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttentionLogCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AttentionLogCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttentionLogCollection)) {
            return false;
        }

        AttentionLogCollection other = (AttentionLogCollection) o;
