...
public class SummarizeExternalDbSystemAvailabilityMetricsResponse
    ...
    private SummarizeExternalDbSystemAvailabilityMetricsResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(SummarizeExternalDbSystemAvailabilityMetricsResponse o) {
         ...
         */
        public SummarizeExternalDbSystemAvailabilityMetricsResponse build() {
            return new SummarizeExternalDbSystemAvailabilityMetricsResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcNextPage,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeExternalDbSystemAvailabilityMetricsResponse)) {
            return false;
        }

        SummarizeExternalDbSystemAvailabilityMetricsResponse other =
                (SummarizeExternalDbSystemAvailabilityMetricsResponse) o;
