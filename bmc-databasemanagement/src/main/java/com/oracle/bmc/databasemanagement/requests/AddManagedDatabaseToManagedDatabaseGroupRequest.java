...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/AddManagedDatabaseToManagedDatabaseGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddManagedDatabaseToManagedDatabaseGroupRequest.
 */
...
public class AddManagedDatabaseToManagedDatabaseGroupRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder addManagedDatabaseToManagedDatabaseGroupDetails(
                com.oracle.bmc.databasemanagement.model
                                .AddManagedDatabaseToManagedDatabaseGroupDetails
                        addManagedDatabaseToManagedDatabaseGroupDetails) {
            this.addManagedDatabaseToManagedDatabaseGroupDetails =
                    addManagedDatabaseToManagedDatabaseGroupDetails;
            return this;
        }
         ...
         * @return instance of AddManagedDatabaseToManagedDatabaseGroupRequest
         */
        public AddManagedDatabaseToManagedDatabaseGroupRequest buildWithoutInvocationCallback() {
            AddManagedDatabaseToManagedDatabaseGroupRequest request =
                    new AddManagedDatabaseToManagedDatabaseGroupRequest();
            request.managedDatabaseGroupId = managedDatabaseGroupId;
            request.addManagedDatabaseToManagedDatabaseGroupDetails =
                    addManagedDatabaseToManagedDatabaseGroupDetails;
    ...
    public String toString() {
        ...
        sb.append(",addManagedDatabaseToManagedDatabaseGroupDetails=")
                .append(String.valueOf(this.addManagedDatabaseToManagedDatabaseGroupDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddManagedDatabaseToManagedDatabaseGroupRequest)) {
            return false;
        }

        AddManagedDatabaseToManagedDatabaseGroupRequest other =
                (AddManagedDatabaseToManagedDatabaseGroupRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.managedDatabaseGroupId, other.managedDatabaseGroupId)
                && java.util.Objects.equals(
                        this.addManagedDatabaseToManagedDatabaseGroupDetails,
                        other.addManagedDatabaseToManagedDatabaseGroupDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.addManagedDatabaseToManagedDatabaseGroupDetails == null
                                ? 43
                                : this.addManagedDatabaseToManagedDatabaseGroupDetails.hashCode());
