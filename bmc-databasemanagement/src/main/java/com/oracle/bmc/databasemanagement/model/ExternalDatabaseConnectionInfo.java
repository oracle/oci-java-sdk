...
/**
 * The details required to connect to an external Oracle Database. It takes either
 * connectionCredentials or databaseCredential. It's recommended to provide databaseCredential <br>
