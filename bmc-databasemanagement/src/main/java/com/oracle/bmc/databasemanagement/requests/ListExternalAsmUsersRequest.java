...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListExternalAsmUsersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExternalAsmUsersRequest.
 */
...
public class ListExternalAsmUsersRequest
    ...
    public static class Builder
         ...
         */
        public ListExternalAsmUsersRequest build() {
            ListExternalAsmUsersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExternalAsmUsersRequest
         */
        public ListExternalAsmUsersRequest buildWithoutInvocationCallback() {
            ListExternalAsmUsersRequest request = new ListExternalAsmUsersRequest();
            ...
            return request;
            // new ListExternalAsmUsersRequest(externalAsmId, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExternalAsmUsersRequest)) {
            return false;
        }

        ListExternalAsmUsersRequest other = (ListExternalAsmUsersRequest) o;
