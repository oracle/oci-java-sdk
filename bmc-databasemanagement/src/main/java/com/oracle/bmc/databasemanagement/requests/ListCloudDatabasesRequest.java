...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListCloudDatabasesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListCloudDatabasesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListCloudDatabasesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListCloudDatabasesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListCloudDatabasesRequest o) {
        ...
        /**
         * Build the instance of ListCloudDatabasesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListCloudDatabasesRequest
         */
        public ListCloudDatabasesRequest build() {
            ListCloudDatabasesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListCloudDatabasesRequest
         */
        public ListCloudDatabasesRequest buildWithoutInvocationCallback() {
            ListCloudDatabasesRequest request = new ListCloudDatabasesRequest();
            ...
            return request;
            // new ListCloudDatabasesRequest(cloudDbSystemId, compartmentId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListCloudDatabasesRequest)) {
            return false;
        }

        ListCloudDatabasesRequest other = (ListCloudDatabasesRequest) o;
