...
/**
 * The summary of a cloud ASM disk group. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudAsmDiskGroupSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudAsmDiskGroupSummary
    ...
    public CloudAsmDiskGroupSummary(
            String name,
    ...
    public static class Builder {
        ...
        public CloudAsmDiskGroupSummary build() {
            CloudAsmDiskGroupSummary model =
                    new CloudAsmDiskGroupSummary(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudAsmDiskGroupSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudAsmDiskGroupSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudAsmDiskGroupSummary)) {
            return false;
        }

        CloudAsmDiskGroupSummary other = (CloudAsmDiskGroupSummary) o;
