...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/UpdateExternalDbSystemExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateExternalDbSystemRequest.
 */
...
public class UpdateExternalDbSystemRequest
    ...
    public static class Builder
        ...
        public UpdateExternalDbSystemRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateExternalDbSystemRequest(externalDbSystemId, updateExternalDbSystemDetails, opcRequestId, ifMatch);
        }
    }
