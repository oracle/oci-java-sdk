...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasemanagement/ListExternalDbHomesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListExternalDbHomesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201101")
public class ListExternalDbHomesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListExternalDbHomesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListExternalDbHomesRequest o) {
        ...
        /**
         * Build the instance of ListExternalDbHomesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListExternalDbHomesRequest
         */
        public ListExternalDbHomesRequest build() {
            ListExternalDbHomesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListExternalDbHomesRequest
         */
        public ListExternalDbHomesRequest buildWithoutInvocationCallback() {
            ListExternalDbHomesRequest request = new ListExternalDbHomesRequest();
            ...
            return request;
            // new ListExternalDbHomesRequest(compartmentId, externalDbSystemId, displayName, page, limit, sortBy, sortOrder, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListExternalDbHomesRequest)) {
            return false;
        }

        ListExternalDbHomesRequest other = (ListExternalDbHomesRequest) o;
