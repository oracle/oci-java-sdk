...
public class SummarizeAwrDbParametersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code AwrDbParameterCollection} instance. */
     ...
     * @return the value
     */
    public com.oracle.bmc.databasemanagement.model.AwrDbParameterCollection
            getAwrDbParameterCollection() {
    ...
    public static class Builder
         ...
         * The returned {@code AwrDbParameterCollection} instance.
         *
         * @param awrDbParameterCollection the value to set
         * @return this builder
         */
        public Builder awrDbParameterCollection(
                com.oracle.bmc.databasemanagement.model.AwrDbParameterCollection
                        awrDbParameterCollection) {
            this.awrDbParameterCollection = awrDbParameterCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",awrDbParameterCollection=").append(String.valueOf(awrDbParameterCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeAwrDbParametersResponse)) {
            return false;
        }

        SummarizeAwrDbParametersResponse other = (SummarizeAwrDbParametersResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.awrDbParameterCollection, other.awrDbParameterCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.awrDbParameterCollection == null
                                ? 43
                                : this.awrDbParameterCollection.hashCode());
        return result;
    }
}
