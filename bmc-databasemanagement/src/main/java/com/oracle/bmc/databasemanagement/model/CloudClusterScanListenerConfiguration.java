...
/**
 * The details of a SCAN listener in a cloud cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudClusterScanListenerConfiguration.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudClusterScanListenerConfiguration
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"scanName", "networkNumber", "scanPort", "scanProtocol"})
    public CloudClusterScanListenerConfiguration(
    ...
    public static class Builder {
        ...
        public CloudClusterScanListenerConfiguration build() {
            CloudClusterScanListenerConfiguration model =
                    new CloudClusterScanListenerConfiguration(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudClusterScanListenerConfiguration model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudClusterScanListenerConfiguration(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudClusterScanListenerConfiguration)) {
            return false;
        }

        CloudClusterScanListenerConfiguration other = (CloudClusterScanListenerConfiguration) o;
