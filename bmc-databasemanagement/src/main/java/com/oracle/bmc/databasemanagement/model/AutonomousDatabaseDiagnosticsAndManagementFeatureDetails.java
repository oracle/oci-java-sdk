...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousDatabaseDiagnosticsAndManagementFeatureDetails.Builder.class)
...
public final class AutonomousDatabaseDiagnosticsAndManagementFeatureDetails
    ...
    public static class Builder {
        ...
        public AutonomousDatabaseDiagnosticsAndManagementFeatureDetails build() {
            AutonomousDatabaseDiagnosticsAndManagementFeatureDetails model =
                    new AutonomousDatabaseDiagnosticsAndManagementFeatureDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousDatabaseDiagnosticsAndManagementFeatureDetails model) {
    ...
    @Deprecated
    public AutonomousDatabaseDiagnosticsAndManagementFeatureDetails(
            DatabaseConnectionDetails databaseConnectionDetails,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousDatabaseDiagnosticsAndManagementFeatureDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousDatabaseDiagnosticsAndManagementFeatureDetails)) {
            return false;
        }

        AutonomousDatabaseDiagnosticsAndManagementFeatureDetails other =
                (AutonomousDatabaseDiagnosticsAndManagementFeatureDetails) o;
