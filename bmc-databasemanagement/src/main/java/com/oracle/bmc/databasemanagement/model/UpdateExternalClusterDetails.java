...
/**
 * The details required to update an external cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateExternalClusterDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class UpdateExternalClusterDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalConnectorId"})
    public UpdateExternalClusterDetails(String externalConnectorId) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateExternalClusterDetails build() {
            UpdateExternalClusterDetails model =
                    new UpdateExternalClusterDetails(this.externalConnectorId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateExternalClusterDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateExternalClusterDetails)) {
            return false;
        }

        UpdateExternalClusterDetails other = (UpdateExternalClusterDetails) o;
