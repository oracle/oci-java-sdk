...
public class GetDatabaseFleetBackupMetricsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetDatabaseFleetBackupMetricsConverter.class);

    public static com.oracle.bmc.databasemanagement.requests.GetDatabaseFleetBackupMetricsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        Validate.notNull(request.getDatabaseHostedIn(), "databaseHostedIn is required");
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20201101").path("databaseFleetBackupMetrics");

        target =
                target.queryParam(
                        "databaseHostedIn",
                        com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                request.getDatabaseHostedIn().getValue()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.databasemanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.databasemanagement.responses.GetDatabaseFleetBackupMetricsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.databasemanagement.responses
                                                .GetDatabaseFleetBackupMetricsResponse.Builder
                                        builder =
                                                com.oracle.bmc.databasemanagement.responses
                                                        .GetDatabaseFleetBackupMetricsResponse
                                                        .builder()
                                ...
                                builder.databaseFleetBackupMetrics(response.getItem());
