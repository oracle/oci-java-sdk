...
/**
 * The summary of a cloud database node. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudDbNodeSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudDbNodeSummary
    ...
    public CloudDbNodeSummary(
            ...
            String hostName,
            CloudDbNode.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * cloud DB node in DBaas service.
         */
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * cloud DB system that the DB node is a part of.
         */
        ...
        private CloudDbNode.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(CloudDbNode.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public CloudDbNodeSummary build() {
            CloudDbNodeSummary model =
                    new CloudDbNodeSummary(
                            this.id,
                            this.dbaasId,
                            this.displayName,
                            this.componentName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudDbNodeSummary model) {
    ...
    /** The current lifecycle state of the cloud DB node. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final CloudDbNode.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public CloudDbNode.LifecycleState getLifecycleState() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudDbNodeSummary)) {
            return false;
        }

        CloudDbNodeSummary other = (CloudDbNodeSummary) o;
