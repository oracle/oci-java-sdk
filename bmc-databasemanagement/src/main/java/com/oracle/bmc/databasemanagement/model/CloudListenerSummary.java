...
/**
 * The summary of a cloud listener. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloudListenerSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CloudListenerSummary
    ...
    public CloudListenerSummary(
            ...
            CloudListener.ListenerType listenerType,
            CloudListener.LifecycleState lifecycleState,
    ...
    public static class Builder {
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * cloud DB system that the listener is a member of.
         */
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * cloud DB node on which the listener is running.
         */
        ...
        private CloudListener.ListenerType listenerType;
         ...
         * @return this builder
         */
        public Builder listenerType(CloudListener.ListenerType listenerType) {
            this.listenerType = listenerType;
        ...
        private CloudListener.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(CloudListener.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public CloudListenerSummary build() {
            CloudListenerSummary model =
                    new CloudListenerSummary(
                            this.id,
                            this.dbaasId,
                            this.displayName,
                            this.componentName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CloudListenerSummary model) {
    ...
    /** The type of listener. */
    @com.fasterxml.jackson.annotation.JsonProperty("listenerType")
    private final CloudListener.ListenerType listenerType;
     ...
     * @return the value
     */
    public CloudListener.ListenerType getListenerType() {
        return listenerType;
    }

    /** The current lifecycle state of the cloud listener. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final CloudListener.LifecycleState lifecycleState;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloudListenerSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloudListenerSummary)) {
            return false;
        }

        CloudListenerSummary other = (CloudListenerSummary) o;
