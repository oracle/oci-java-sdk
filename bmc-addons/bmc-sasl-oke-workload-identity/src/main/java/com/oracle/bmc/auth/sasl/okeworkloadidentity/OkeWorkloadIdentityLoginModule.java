 ...
 */
package com.oracle.bmc.auth.sasl.okeworkloadidentity;
...
/**
 * A {@link javax.security.auth.spi.LoginModule} that will use OKE Workload Identity to fill the
 ...
 * </pre>
 */
public class OkeWorkloadIdentityLoginModule extends OciLoginModule {
    @Override
    protected BasicAuthenticationDetailsProvider loadAuthenticationProvider(
            Map<String, ?> options) {

        final OkeWorkloadIdentityAuthenticationDetailsProvider
