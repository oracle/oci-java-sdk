...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/healthchecks/ChangeHttpMonitorCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeHttpMonitorCompartmentRequest.
 */
...
public class ChangeHttpMonitorCompartmentRequest
     ...
     * The details needed to move the monitor.
     */
    public com.oracle.bmc.healthchecks.model.ChangeHttpMonitorCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.healthchecks.model.ChangeHttpMonitorCompartmentDetails
                changeHttpMonitorCompartmentDetails = null;

        /**
         * The details needed to move the monitor.
         * @param changeHttpMonitorCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeHttpMonitorCompartmentDetails(
                com.oracle.bmc.healthchecks.model.ChangeHttpMonitorCompartmentDetails
                        changeHttpMonitorCompartmentDetails) {
        ...
        public ChangeHttpMonitorCompartmentRequest buildWithoutInvocationCallback() {
            ChangeHttpMonitorCompartmentRequest request = new ChangeHttpMonitorCompartmentRequest();
            request.monitorId = monitorId;
            request.changeHttpMonitorCompartmentDetails = changeHttpMonitorCompartmentDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ChangeHttpMonitorCompartmentRequest(monitorId, changeHttpMonitorCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeHttpMonitorCompartmentDetails=")
                .append(String.valueOf(this.changeHttpMonitorCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeHttpMonitorCompartmentRequest)) {
            return false;
        }

        ChangeHttpMonitorCompartmentRequest other = (ChangeHttpMonitorCompartmentRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.monitorId, other.monitorId)
                && java.util.Objects.equals(
                        this.changeHttpMonitorCompartmentDetails,
                        other.changeHttpMonitorCompartmentDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeHttpMonitorCompartmentDetails == null
                                ? 43
                                : this.changeHttpMonitorCompartmentDetails.hashCode());
