...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/healthchecks/UpdateHttpMonitorExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateHttpMonitorRequest.
 */
...
public class UpdateHttpMonitorRequest
    ...
    public static class Builder
         ...
         * The configuration details to update for the HTTP monitor.
         *
         * @param updateHttpMonitorDetails the value to set
         * @return this builder instance
         */
        ...
        public UpdateHttpMonitorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateHttpMonitorRequest(monitorId, updateHttpMonitorDetails, opcRequestId,
            // ifMatch);
        }
    }
