...
/**
 * A summary containing all of the mutable and immutable properties for a ping monitor. <br>
...
public final class PingMonitor extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PingMonitor model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PingMonitor)) {
            return false;
        }

        PingMonitor other = (PingMonitor) o;
