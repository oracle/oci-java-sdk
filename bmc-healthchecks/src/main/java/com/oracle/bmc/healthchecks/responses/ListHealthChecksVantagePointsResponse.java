...
public class ListHealthChecksVantagePointsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListHealthChecksVantagePointsResponse)) {
            return false;
        }

        ListHealthChecksVantagePointsResponse other = (ListHealthChecksVantagePointsResponse) o;
