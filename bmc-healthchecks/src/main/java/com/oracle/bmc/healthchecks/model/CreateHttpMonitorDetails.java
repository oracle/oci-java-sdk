...
/**
 * The request body used to create an HTTP monitor. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateHttpMonitorDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class CreateHttpMonitorDetails
    ...
    public CreateHttpMonitorDetails(
    ...
    public static class Builder {
        ...
        public CreateHttpMonitorDetails build() {
            CreateHttpMonitorDetails model =
                    new CreateHttpMonitorDetails(
                            this.compartmentId,
                            this.targets,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateHttpMonitorDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateHttpMonitorDetails)) {
            return false;
        }

        CreateHttpMonitorDetails other = (CreateHttpMonitorDetails) o;
