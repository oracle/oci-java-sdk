...
/**
 * A summary that contains all of the mutable and immutable properties for an HTTP probe. <br>
...
public final class HttpProbe extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
