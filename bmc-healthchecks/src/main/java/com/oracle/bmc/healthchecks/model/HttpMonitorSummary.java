...
/**
 * A summary containing all of the mutable and immutable properties for an HTTP monitor. <br>
...
public final class HttpMonitorSummary
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HttpMonitorSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HttpMonitorSummary)) {
            return false;
        }

        HttpMonitorSummary other = (HttpMonitorSummary) o;
