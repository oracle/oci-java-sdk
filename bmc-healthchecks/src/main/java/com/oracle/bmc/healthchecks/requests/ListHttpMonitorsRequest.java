...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/healthchecks/ListHttpMonitorsExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListHttpMonitorsRequest.
 */
...
public class ListHttpMonitorsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ListHttpMonitorsRequest o) {
         ...
         */
        public ListHttpMonitorsRequest build() {
            ListHttpMonitorsRequest request = buildWithoutInvocationCallback();
        ...
        public ListHttpMonitorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListHttpMonitorsRequest(compartmentId, opcRequestId, limit, page, sortBy,
