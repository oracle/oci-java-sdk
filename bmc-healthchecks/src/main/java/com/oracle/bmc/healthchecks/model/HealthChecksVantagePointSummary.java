...
/**
 * Information about a vantage point. <br>
...
public final class HealthChecksVantagePointSummary
    ...
    public static class Builder {
        /**
         * The display name for the vantage point. Display names are determined by the best
         * information available and may change over time.
         */
        ...
        /**
         * The organization on whose infrastructure this vantage point resides. Provider names are
         * not unique, as Oracle Cloud Infrastructure maintains many vantage points in each major
         * provider.
         */
         ...
         *
         * <p>The addresses are sorted from the most-specific to least-specific prefix (the smallest
         * network to largest network). When a prefix has multiple origin ASNs (MOAS routing), they
         * are sorted by weight (highest to lowest). Weight is determined by the total percentage of
         * peers observing the prefix originating from an ASN. Only present if {@code fields}
         * includes {@code routing}. The field will be null if the address's routing information is
         * unknown.
         */
    ...
    /**
     * The display name for the vantage point. Display names are determined by the best information
     * available and may change over time.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("displayName")
    ...
    /**
     * The organization on whose infrastructure this vantage point resides. Provider names are not
     * unique, as Oracle Cloud Infrastructure maintains many vantage points in each major provider.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("providerName")
     ...
     *
     * <p>The addresses are sorted from the most-specific to least-specific prefix (the smallest
     * network to largest network). When a prefix has multiple origin ASNs (MOAS routing), they are
     * sorted by weight (highest to lowest). Weight is determined by the total percentage of peers
     * observing the prefix originating from an ASN. Only present if {@code fields} includes {@code
     * routing}. The field will be null if the address's routing information is unknown.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("routing")
