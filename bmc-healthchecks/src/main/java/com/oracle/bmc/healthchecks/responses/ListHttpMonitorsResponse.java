...
public class ListHttpMonitorsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListHttpMonitorsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListHttpMonitorsResponse)) {
            return false;
        }

        ListHttpMonitorsResponse other = (ListHttpMonitorsResponse) o;
