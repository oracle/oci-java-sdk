...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/AddDatabaseToolsDatabaseApiGatewayConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddDatabaseToolsDatabaseApiGatewayConfigLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class AddDatabaseToolsDatabaseApiGatewayConfigLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddDatabaseToolsDatabaseApiGatewayConfigLockRequest o) {
        ...
        /**
         * Build the instance of AddDatabaseToolsDatabaseApiGatewayConfigLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddDatabaseToolsDatabaseApiGatewayConfigLockRequest
         */
        public AddDatabaseToolsDatabaseApiGatewayConfigLockRequest build() {
         ...
         * @return instance of AddDatabaseToolsDatabaseApiGatewayConfigLockRequest
         */
        public AddDatabaseToolsDatabaseApiGatewayConfigLockRequest
                buildWithoutInvocationCallback() {
            AddDatabaseToolsDatabaseApiGatewayConfigLockRequest request =
                    new AddDatabaseToolsDatabaseApiGatewayConfigLockRequest();
            ...
            return request;
            // new AddDatabaseToolsDatabaseApiGatewayConfigLockRequest(databaseToolsDatabaseApiGatewayConfigId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatabaseToolsDatabaseApiGatewayConfigLockRequest)) {
            return false;
        }

        AddDatabaseToolsDatabaseApiGatewayConfigLockRequest other =
                (AddDatabaseToolsDatabaseApiGatewayConfigLockRequest) o;
