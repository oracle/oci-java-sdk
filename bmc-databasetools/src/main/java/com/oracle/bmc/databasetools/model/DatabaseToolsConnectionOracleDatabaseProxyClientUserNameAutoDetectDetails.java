...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder =
            DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails.Builder.class
)
...
public final class DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails
    ...
    public static class Builder {
        ...
        public DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails build() {
            DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails model =
                    new DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails(
                            this.roles);
    ...
    @Deprecated
    public DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails(");
    ...
    public boolean equals(Object o) {
        ...
        DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails other =
                (DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails) o;
