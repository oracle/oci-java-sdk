...
public class RemoveDatabaseToolsPrivateEndpointLockResponse
    ...
    private RemoveDatabaseToolsPrivateEndpointLockResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(RemoveDatabaseToolsPrivateEndpointLockResponse o) {
         ...
         */
        @Override
        public RemoveDatabaseToolsPrivateEndpointLockResponse build() {
            return new RemoveDatabaseToolsPrivateEndpointLockResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatabaseToolsPrivateEndpointLockResponse)) {
            return false;
        }

        RemoveDatabaseToolsPrivateEndpointLockResponse other =
                (RemoveDatabaseToolsPrivateEndpointLockResponse) o;
