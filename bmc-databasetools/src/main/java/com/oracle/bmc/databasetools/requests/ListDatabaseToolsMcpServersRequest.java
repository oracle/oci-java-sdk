...
public class ListDatabaseToolsMcpServersRequest
    ...
    /**
     * A filter to return resources only when their {@code databaseToolsMcpServerLifecycleState}
     * matches the specified {@code databaseToolsMcpServerLifecycleState}.
     */
    ...
    public static class Builder
        ...
        public ListDatabaseToolsMcpServersRequest buildWithoutInvocationCallback() {
            ...
            request.type = type;
            return request;
            // new ListDatabaseToolsMcpServersRequest(compartmentId, lifecycleState, displayName,
            // databaseToolsConnectionId, relatedResourceIdentifier, limit, page, sortOrder, sortBy,
            // opcRequestId, type);
        }
    }
