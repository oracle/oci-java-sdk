...
public final class DatabaseToolsConnectionMySqlSummary extends DatabaseToolsConnectionSummary {
    ...
    public static class Builder {
        ...
        public DatabaseToolsConnectionMySqlSummary build() {
            DatabaseToolsConnectionMySqlSummary __instance__ =
                    new DatabaseToolsConnectionMySqlSummary(
                            id,
                            displayName,
                            compartmentId,
                            lifecycleState,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsConnectionMySqlSummary o) {
    ...
    public DatabaseToolsConnectionMySqlSummary(
            ...
            java.util.List<DatabaseToolsKeyStoreMySqlSummary> keyStores,
    ...
    public boolean equals(Object o) {
        ...
        DatabaseToolsConnectionMySqlSummary other = (DatabaseToolsConnectionMySqlSummary) o;
