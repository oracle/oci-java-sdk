...
public final class DatabaseToolsRelatedResourceMySql {
    ...
    public static class Builder {
        ...
        public DatabaseToolsRelatedResourceMySql build() {
            DatabaseToolsRelatedResourceMySql __instance__ =
                    new DatabaseToolsRelatedResourceMySql(entityType, identifier);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsRelatedResourceMySql o) {
