...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/ValidateDatabaseToolsConnectionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ValidateDatabaseToolsConnectionRequest.
 */
...
public class ValidateDatabaseToolsConnectionRequest
    ...
    public static class Builder
        ...
        public ValidateDatabaseToolsConnectionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ValidateDatabaseToolsConnectionRequest(databaseToolsConnectionId, validateDatabaseToolsConnectionDetails, ifMatch, opcRequestId);
        }
    }
