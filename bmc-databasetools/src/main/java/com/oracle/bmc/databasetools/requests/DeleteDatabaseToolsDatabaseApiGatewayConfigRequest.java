...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/DeleteDatabaseToolsDatabaseApiGatewayConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDatabaseToolsDatabaseApiGatewayConfigRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class DeleteDatabaseToolsDatabaseApiGatewayConfigRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDatabaseToolsDatabaseApiGatewayConfigRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDatabaseToolsDatabaseApiGatewayConfigRequest o) {
        ...
        /**
         * Build the instance of DeleteDatabaseToolsDatabaseApiGatewayConfigRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDatabaseToolsDatabaseApiGatewayConfigRequest
         */
        public DeleteDatabaseToolsDatabaseApiGatewayConfigRequest build() {
         ...
         * @return instance of DeleteDatabaseToolsDatabaseApiGatewayConfigRequest
         */
        public DeleteDatabaseToolsDatabaseApiGatewayConfigRequest buildWithoutInvocationCallback() {
            DeleteDatabaseToolsDatabaseApiGatewayConfigRequest request =
                    new DeleteDatabaseToolsDatabaseApiGatewayConfigRequest();
            ...
            return request;
            // new DeleteDatabaseToolsDatabaseApiGatewayConfigRequest(databaseToolsDatabaseApiGatewayConfigId, ifMatch, opcRequestId, isLockOverride);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatabaseToolsDatabaseApiGatewayConfigRequest)) {
            return false;
        }

        DeleteDatabaseToolsDatabaseApiGatewayConfigRequest other =
                (DeleteDatabaseToolsDatabaseApiGatewayConfigRequest) o;
