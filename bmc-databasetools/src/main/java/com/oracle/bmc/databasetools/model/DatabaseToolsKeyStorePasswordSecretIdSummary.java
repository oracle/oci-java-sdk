...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsKeyStorePasswordSecretIdSummary.Builder.class)
...
public final class DatabaseToolsKeyStorePasswordSecretIdSummary
        extends DatabaseToolsKeyStorePasswordSummary {
    ...
    @Deprecated
    public DatabaseToolsKeyStorePasswordSecretIdSummary(String secretId) {
        super();
        this.secretId = secretId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStorePasswordSecretIdSummary)) {
            return false;
        }
