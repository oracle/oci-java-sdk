 ...
 * to any list operations of DatabaseTools where multiple pages of data may be fetched. Two styles
...
public class DatabaseToolsPaginators {
     ...
     * listDatabaseToolsConnections operation. This iterable will fetch more data from the server as
     * needed.
     *
     ...
     * com.oracle.bmc.databasetools.model.DatabaseToolsConnectionSummary} objects contained in
     * responses from the listDatabaseToolsConnections operation. This iterable will fetch more data
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.DatabaseToolsEndpointServiceSummary} objects contained in
     * responses from the listDatabaseToolsEndpointServices operation. This iterable will fetch more
     * data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.databasetools.model.DatabaseToolsEndpointServiceSummary} objects contained
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the
     * listDatabaseToolsIdentities operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.DatabaseToolsIdentitySummary} objects contained in
     * responses from the listDatabaseToolsIdentities operation. This iterable will fetch more data
     * from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.DatabaseToolsPrivateEndpointSummary} objects contained in
     * responses from the listDatabaseToolsPrivateEndpoints operation. This iterable will fetch more
     * data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.databasetools.model.DatabaseToolsPrivateEndpointSummary} objects contained
     *     in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.WorkRequestError} objects contained in responses from the
     * listWorkRequestErrors operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.databasetools.model.WorkRequestError} objects contained in responses
     *     received from the service.
     */
    public Iterable<com.oracle.bmc.databasetools.model.WorkRequestError>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                ListWorkRequestErrorsRequest,
                ListWorkRequestErrorsResponse,
                com.oracle.bmc.databasetools.model.WorkRequestError>(
                new java.util.function.Supplier<ListWorkRequestErrorsRequest.Builder>() {
                    @Override
                    public ListWorkRequestErrorsRequest.Builder get() {
                        return ListWorkRequestErrorsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.WorkRequestLogEntry} objects contained in responses from
     * the listWorkRequestLogs operation. This iterable will fetch more data from the server as
     * needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.databasetools.model.WorkRequestLogEntry} objects contained in responses
     *     received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link
     * com.oracle.bmc.databasetools.model.WorkRequestSummary} objects contained in responses from
     * the listWorkRequests operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.databasetools.model.WorkRequestSummary} objects contained in responses
     *     received from the service.
     */
