...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = DatabaseToolsMcpServer.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = DatabaseToolsMcpServerDefault.class,
        name = "DEFAULT"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class DatabaseToolsMcpServer extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected DatabaseToolsMcpServer(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsMcpServer(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsMcpServer)) {
            return false;
        }

        DatabaseToolsMcpServer other = (DatabaseToolsMcpServer) o;
