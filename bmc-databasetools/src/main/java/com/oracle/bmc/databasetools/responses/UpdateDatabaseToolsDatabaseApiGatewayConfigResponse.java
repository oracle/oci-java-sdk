...
public class UpdateDatabaseToolsDatabaseApiGatewayConfigResponse
    ...
    private UpdateDatabaseToolsDatabaseApiGatewayConfigResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateDatabaseToolsDatabaseApiGatewayConfigResponse o) {
         ...
         */
        public UpdateDatabaseToolsDatabaseApiGatewayConfigResponse build() {
            return new UpdateDatabaseToolsDatabaseApiGatewayConfigResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsDatabaseApiGatewayConfigResponse)) {
            return false;
        }

        UpdateDatabaseToolsDatabaseApiGatewayConfigResponse other =
                (UpdateDatabaseToolsDatabaseApiGatewayConfigResponse) o;
