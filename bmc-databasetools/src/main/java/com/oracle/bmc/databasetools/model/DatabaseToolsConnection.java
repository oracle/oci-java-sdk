...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = DatabaseToolsConnection.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsConnectionOracleDatabase.class,
...
public class DatabaseToolsConnection
     ...
     * to use the caller\u2019s identity (On-Behalf-Of token), or RESOURCE_PRINCIPAL to use the
