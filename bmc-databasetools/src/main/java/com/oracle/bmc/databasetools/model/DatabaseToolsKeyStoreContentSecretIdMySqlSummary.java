...
public final class DatabaseToolsKeyStoreContentSecretIdMySqlSummary
    ...
    public static class Builder {
        ...
        public DatabaseToolsKeyStoreContentSecretIdMySqlSummary build() {
            DatabaseToolsKeyStoreContentSecretIdMySqlSummary model =
                    new DatabaseToolsKeyStoreContentSecretIdMySqlSummary(this.secretId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStoreContentSecretIdMySqlSummary model) {
