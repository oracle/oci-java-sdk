...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/AddDatabaseToolsMcpToolsetLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddDatabaseToolsMcpToolsetLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class AddDatabaseToolsMcpToolsetLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddDatabaseToolsMcpToolsetLockRequest o) {
        ...
        /**
         * Build the instance of AddDatabaseToolsMcpToolsetLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddDatabaseToolsMcpToolsetLockRequest
         */
        public AddDatabaseToolsMcpToolsetLockRequest build() {
            AddDatabaseToolsMcpToolsetLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddDatabaseToolsMcpToolsetLockRequest
         */
        public AddDatabaseToolsMcpToolsetLockRequest buildWithoutInvocationCallback() {
            AddDatabaseToolsMcpToolsetLockRequest request =
                    new AddDatabaseToolsMcpToolsetLockRequest();
            ...
            return request;
            // new AddDatabaseToolsMcpToolsetLockRequest(databaseToolsMcpToolsetId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatabaseToolsMcpToolsetLockRequest)) {
            return false;
        }

        AddDatabaseToolsMcpToolsetLockRequest other = (AddDatabaseToolsMcpToolsetLockRequest) o;
