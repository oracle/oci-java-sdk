...
public final class UpdateDatabaseToolsPrivateEndpointDetails {
    ...
    public static class Builder {
        ...
        public UpdateDatabaseToolsPrivateEndpointDetails build() {
            UpdateDatabaseToolsPrivateEndpointDetails __instance__ =
                    new UpdateDatabaseToolsPrivateEndpointDetails(
                            definedTags, freeformTags, displayName, description, nsgIds);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDatabaseToolsPrivateEndpointDetails o) {
