...
/**
 * Database Tools MCP server information to be updated for the default type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateDatabaseToolsMcpServerDetailsDefault.Builder.class)
...
public final class UpdateDatabaseToolsMcpServerDetailsDefault
        extends UpdateDatabaseToolsMcpServerDetails {
    ...
    public static class Builder {
        ...
        public UpdateDatabaseToolsMcpServerDetailsDefault build() {
            UpdateDatabaseToolsMcpServerDetailsDefault model =
                    new UpdateDatabaseToolsMcpServerDetailsDefault(
                            this.displayName,
                            this.description,
                            this.customRoles,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateDatabaseToolsMcpServerDetailsDefault model) {
    ...
    @Deprecated
    public UpdateDatabaseToolsMcpServerDetailsDefault(
            String displayName,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDatabaseToolsMcpServerDetailsDefault(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDatabaseToolsMcpServerDetailsDefault)) {
            return false;
        }

        UpdateDatabaseToolsMcpServerDetailsDefault other =
                (UpdateDatabaseToolsMcpServerDetailsDefault) o;
        return java.util.Objects.equals(this.storage, other.storage) && super.equals(other);
    }
