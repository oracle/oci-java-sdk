...
public class ListDatabaseToolsPrivateEndpointsResponse
     ...
     * @return the value
     */
    public com.oracle.bmc.databasetools.model.DatabaseToolsPrivateEndpointCollection
            getDatabaseToolsPrivateEndpointCollection() {
        return databaseToolsPrivateEndpointCollection;
    }
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder databaseToolsPrivateEndpointCollection(
                com.oracle.bmc.databasetools.model.DatabaseToolsPrivateEndpointCollection
                        databaseToolsPrivateEndpointCollection) {
            this.databaseToolsPrivateEndpointCollection = databaseToolsPrivateEndpointCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",databaseToolsPrivateEndpointCollection=")
                .append(String.valueOf(databaseToolsPrivateEndpointCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDatabaseToolsPrivateEndpointsResponse)) {
            return false;
        }

        ListDatabaseToolsPrivateEndpointsResponse other =
                (ListDatabaseToolsPrivateEndpointsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.databaseToolsPrivateEndpointCollection,
                        other.databaseToolsPrivateEndpointCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.databaseToolsPrivateEndpointCollection == null
                                ? 43
                                : this.databaseToolsPrivateEndpointCollection.hashCode());
        return result;
    }
}
