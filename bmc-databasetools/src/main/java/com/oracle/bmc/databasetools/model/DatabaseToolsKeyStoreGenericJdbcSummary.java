...
/**
 * The summary of the key store. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsKeyStoreGenericJdbcSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DatabaseToolsKeyStoreGenericJdbcSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStoreGenericJdbcSummary(
            KeyStoreTypeGenericJdbc keyStoreType,
            DatabaseToolsKeyStoreContentGenericJdbcSummary keyStoreContent,
            DatabaseToolsKeyStorePasswordGenericJdbcSummary keyStorePassword) {
        super();
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder keyStoreType(KeyStoreTypeGenericJdbc keyStoreType) {
            this.keyStoreType = keyStoreType;
        ...
        private DatabaseToolsKeyStoreContentGenericJdbcSummary keyStoreContent;

        public Builder keyStoreContent(
                DatabaseToolsKeyStoreContentGenericJdbcSummary keyStoreContent) {
            this.keyStoreContent = keyStoreContent;
        ...
        private DatabaseToolsKeyStorePasswordGenericJdbcSummary keyStorePassword;
        ...
        public DatabaseToolsKeyStoreGenericJdbcSummary build() {
            DatabaseToolsKeyStoreGenericJdbcSummary model =
                    new DatabaseToolsKeyStoreGenericJdbcSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStoreGenericJdbcSummary model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("keyStoreContent")
    private final DatabaseToolsKeyStoreContentGenericJdbcSummary keyStoreContent;

    public DatabaseToolsKeyStoreContentGenericJdbcSummary getKeyStoreContent() {
        return keyStoreContent;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("keyStorePassword")
    private final DatabaseToolsKeyStorePasswordGenericJdbcSummary keyStorePassword;

    public DatabaseToolsKeyStorePasswordGenericJdbcSummary getKeyStorePassword() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStoreGenericJdbcSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreGenericJdbcSummary)) {
            return false;
        }

        DatabaseToolsKeyStoreGenericJdbcSummary other = (DatabaseToolsKeyStoreGenericJdbcSummary) o;
