...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/UpdateDatabaseToolsMcpToolsetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDatabaseToolsMcpToolsetRequest.
 */
...
public class UpdateDatabaseToolsMcpToolsetRequest
    ...
    public static class Builder
        ...
        public UpdateDatabaseToolsMcpToolsetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDatabaseToolsMcpToolsetRequest(databaseToolsMcpToolsetId, updateDatabaseToolsMcpToolsetDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
