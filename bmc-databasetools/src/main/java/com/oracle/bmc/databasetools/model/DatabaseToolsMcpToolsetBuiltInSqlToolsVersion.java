...
/**
 * A specific version entry for a BUILT_IN_SQL_TOOLS MCP toolset version <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsMcpToolsetBuiltInSqlToolsVersion.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DatabaseToolsMcpToolsetBuiltInSqlToolsVersion
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"version", "description", "features", "tools"})
    public DatabaseToolsMcpToolsetBuiltInSqlToolsVersion(
            Integer version,
            String description,
    ...
    public static class Builder {
        ...
        public DatabaseToolsMcpToolsetBuiltInSqlToolsVersion build() {
            DatabaseToolsMcpToolsetBuiltInSqlToolsVersion model =
                    new DatabaseToolsMcpToolsetBuiltInSqlToolsVersion(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsMcpToolsetBuiltInSqlToolsVersion model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsMcpToolsetBuiltInSqlToolsVersion(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsMcpToolsetBuiltInSqlToolsVersion)) {
            return false;
        }

        DatabaseToolsMcpToolsetBuiltInSqlToolsVersion other =
                (DatabaseToolsMcpToolsetBuiltInSqlToolsVersion) o;
