...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseToolsKeyStoreGenericJdbc.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DatabaseToolsKeyStoreGenericJdbc
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStoreGenericJdbc(
            KeyStoreTypeGenericJdbc keyStoreType,
            DatabaseToolsKeyStoreContentGenericJdbc keyStoreContent,
            DatabaseToolsKeyStorePasswordGenericJdbc keyStorePassword) {
        super();
    ...
    public static class Builder {
        ...
        private DatabaseToolsKeyStoreContentGenericJdbc keyStoreContent;

        public Builder keyStoreContent(DatabaseToolsKeyStoreContentGenericJdbc keyStoreContent) {
            this.keyStoreContent = keyStoreContent;
        ...
        private DatabaseToolsKeyStorePasswordGenericJdbc keyStorePassword;

        public Builder keyStorePassword(DatabaseToolsKeyStorePasswordGenericJdbc keyStorePassword) {
            this.keyStorePassword = keyStorePassword;
        ...
        public DatabaseToolsKeyStoreGenericJdbc build() {
            DatabaseToolsKeyStoreGenericJdbc model =
                    new DatabaseToolsKeyStoreGenericJdbc(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStoreGenericJdbc model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("keyStoreContent")
    private final DatabaseToolsKeyStoreContentGenericJdbc keyStoreContent;

    public DatabaseToolsKeyStoreContentGenericJdbc getKeyStoreContent() {
        return keyStoreContent;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("keyStorePassword")
    private final DatabaseToolsKeyStorePasswordGenericJdbc keyStorePassword;

    public DatabaseToolsKeyStorePasswordGenericJdbc getKeyStorePassword() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStoreGenericJdbc(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreGenericJdbc)) {
            return false;
        }

        DatabaseToolsKeyStoreGenericJdbc other = (DatabaseToolsKeyStoreGenericJdbc) o;
