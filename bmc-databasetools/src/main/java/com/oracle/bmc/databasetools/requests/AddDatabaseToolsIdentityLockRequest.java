...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/AddDatabaseToolsIdentityLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddDatabaseToolsIdentityLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class AddDatabaseToolsIdentityLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddDatabaseToolsIdentityLockRequest o) {
        ...
        /**
         * Build the instance of AddDatabaseToolsIdentityLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddDatabaseToolsIdentityLockRequest
         */
        public AddDatabaseToolsIdentityLockRequest build() {
            AddDatabaseToolsIdentityLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddDatabaseToolsIdentityLockRequest
         */
        public AddDatabaseToolsIdentityLockRequest buildWithoutInvocationCallback() {
            AddDatabaseToolsIdentityLockRequest request = new AddDatabaseToolsIdentityLockRequest();
            request.databaseToolsIdentityId = databaseToolsIdentityId;
            request.addResourceLockDetails = addResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new AddDatabaseToolsIdentityLockRequest(databaseToolsIdentityId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatabaseToolsIdentityLockRequest)) {
            return false;
        }

        AddDatabaseToolsIdentityLockRequest other = (AddDatabaseToolsIdentityLockRequest) o;
