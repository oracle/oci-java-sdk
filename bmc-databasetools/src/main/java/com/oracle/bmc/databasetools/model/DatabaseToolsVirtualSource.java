...
public class DatabaseToolsVirtualSource {
    ...
    public static class Builder {
        ...
        public DatabaseToolsVirtualSource build() {
            DatabaseToolsVirtualSource __instance__ =
                    new DatabaseToolsVirtualSource(vcnId, ipRanges);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsVirtualSource o) {
