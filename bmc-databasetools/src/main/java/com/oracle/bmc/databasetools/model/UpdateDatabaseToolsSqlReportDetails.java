...
/**
 * Database Tools SQL report information to be updated. <br>
...
public class UpdateDatabaseToolsSqlReportDetails
    ...
    /**
     * Purpose of the Database Tools SQL report. Scenario or conditions describing when or why this
     * report should be used. Provides selection criteria to AI agents to improve report selection
     * accuracy.
     */
    ...
    /**
     * Instructions on how to use the SQL report. Step-by-step guidance for an AI agent on how to
     * execute or fill in parameters for the report.
     */
