...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/RemoveDatabaseToolsDatabaseApiGatewayConfigLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest o) {
        ...
        /**
         * Build the instance of RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest
         */
        public RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest build() {
         ...
         * @return instance of RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest
         */
        public RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest
                buildWithoutInvocationCallback() {
            RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest request =
                    new RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest();
            ...
            return request;
            // new RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest(databaseToolsDatabaseApiGatewayConfigId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest)) {
            return false;
        }

        RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest other =
                (RemoveDatabaseToolsDatabaseApiGatewayConfigLockRequest) o;
