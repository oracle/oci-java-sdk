...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsMcpServerDefault.Builder.class)
...
public final class DatabaseToolsMcpServerDefault extends DatabaseToolsMcpServer {
    ...
    public static class Builder {
        ...
        public DatabaseToolsMcpServerDefault build() {
            DatabaseToolsMcpServerDefault model =
                    new DatabaseToolsMcpServerDefault(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsMcpServerDefault model) {
    ...
    @Deprecated
    public DatabaseToolsMcpServerDefault(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsMcpServerDefault(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsMcpServerDefault)) {
            return false;
        }

        DatabaseToolsMcpServerDefault other = (DatabaseToolsMcpServerDefault) o;
