...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseToolsConnectionOracleDatabaseProxyClientUserName.Builder.class
)
...
public final class DatabaseToolsConnectionOracleDatabaseProxyClientUserName
    ...
    public static class Builder {
        ...
        public DatabaseToolsConnectionOracleDatabaseProxyClientUserName build() {
            DatabaseToolsConnectionOracleDatabaseProxyClientUserName model =
                    new DatabaseToolsConnectionOracleDatabaseProxyClientUserName(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsConnectionOracleDatabaseProxyClientUserName model) {
    ...
    @Deprecated
    public DatabaseToolsConnectionOracleDatabaseProxyClientUserName(
            String userName, DatabaseToolsUserPassword userPassword, java.util.List<String> roles) {
        super();
        this.userName = userName;
        this.userPassword = userPassword;
        this.roles = roles;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsConnectionOracleDatabaseProxyClientUserName(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsConnectionOracleDatabaseProxyClientUserName)) {
            return false;
        }

        DatabaseToolsConnectionOracleDatabaseProxyClientUserName other =
                (DatabaseToolsConnectionOracleDatabaseProxyClientUserName) o;
