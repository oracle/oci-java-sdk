...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/RemoveDatabaseToolsSqlReportLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDatabaseToolsSqlReportLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class RemoveDatabaseToolsSqlReportLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDatabaseToolsSqlReportLockRequest o) {
        ...
        /**
         * Build the instance of RemoveDatabaseToolsSqlReportLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveDatabaseToolsSqlReportLockRequest
         */
        public RemoveDatabaseToolsSqlReportLockRequest build() {
            RemoveDatabaseToolsSqlReportLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveDatabaseToolsSqlReportLockRequest
         */
        public RemoveDatabaseToolsSqlReportLockRequest buildWithoutInvocationCallback() {
            RemoveDatabaseToolsSqlReportLockRequest request =
                    new RemoveDatabaseToolsSqlReportLockRequest();
            ...
            return request;
            // new RemoveDatabaseToolsSqlReportLockRequest(databaseToolsSqlReportId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatabaseToolsSqlReportLockRequest)) {
            return false;
        }

        RemoveDatabaseToolsSqlReportLockRequest other = (RemoveDatabaseToolsSqlReportLockRequest) o;
