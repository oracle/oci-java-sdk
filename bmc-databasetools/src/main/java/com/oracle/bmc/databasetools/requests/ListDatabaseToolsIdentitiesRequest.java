...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/ListDatabaseToolsIdentitiesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDatabaseToolsIdentitiesRequest.
 */
...
public class ListDatabaseToolsIdentitiesRequest
    ...
    public static class Builder
        ...
        public ListDatabaseToolsIdentitiesRequest buildWithoutInvocationCallback() {
            ...
            request.type = type;
            return request;
            // new ListDatabaseToolsIdentitiesRequest(compartmentId, lifecycleState, displayName, databaseToolsConnectionId, limit, page, sortOrder, sortBy, opcRequestId, type);
        }
    }
