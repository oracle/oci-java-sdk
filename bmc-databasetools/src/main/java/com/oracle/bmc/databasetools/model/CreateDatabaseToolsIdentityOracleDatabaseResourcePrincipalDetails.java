...
/**
 * Details for the new Database Tools identity for the Oracle Database resource principal identity
 * type. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails.Builder.class)
...
public final class CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails
        extends CreateDatabaseToolsIdentityDetails {
    ...
    public static class Builder {
        ...
        public CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails build() {
            CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails model =
                    new CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails(
                            this.compartmentId,
                            this.displayName,
    ...
    @Deprecated
    public CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails)) {
            return false;
        }

        CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails other =
                (CreateDatabaseToolsIdentityOracleDatabaseResourcePrincipalDetails) o;
