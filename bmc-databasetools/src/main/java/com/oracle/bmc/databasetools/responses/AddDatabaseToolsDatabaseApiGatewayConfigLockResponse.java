...
public class AddDatabaseToolsDatabaseApiGatewayConfigLockResponse
    ...
    private AddDatabaseToolsDatabaseApiGatewayConfigLockResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(AddDatabaseToolsDatabaseApiGatewayConfigLockResponse o) {
         ...
         */
        public AddDatabaseToolsDatabaseApiGatewayConfigLockResponse build() {
            return new AddDatabaseToolsDatabaseApiGatewayConfigLockResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatabaseToolsDatabaseApiGatewayConfigLockResponse)) {
            return false;
        }

        AddDatabaseToolsDatabaseApiGatewayConfigLockResponse other =
                (AddDatabaseToolsDatabaseApiGatewayConfigLockResponse) o;
