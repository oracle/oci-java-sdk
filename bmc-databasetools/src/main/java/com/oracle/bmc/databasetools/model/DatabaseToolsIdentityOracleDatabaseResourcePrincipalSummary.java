...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary.Builder.class)
...
public final class DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary
        extends DatabaseToolsIdentitySummary {
    ...
    public static class Builder {
        ...
        private DatabaseToolsIdentityLifecycleState lifecycleState;

        public Builder lifecycleState(DatabaseToolsIdentityLifecycleState lifecycleState) {
        ...
        public DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary build() {
            DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary model =
                    new DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary model) {
    ...
    @Deprecated
    public DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary(
            String id,
            String compartmentId,
            String displayName,
            String databaseToolsConnectionId,
            DatabaseToolsIdentityLifecycleState lifecycleState,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary)) {
            return false;
        }

        DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary other =
                (DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary) o;
