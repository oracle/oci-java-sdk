...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/UpdateDatabaseToolsSqlReportExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDatabaseToolsSqlReportRequest.
 */
...
public class UpdateDatabaseToolsSqlReportRequest
    ...
    public static class Builder
        ...
        public UpdateDatabaseToolsSqlReportRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDatabaseToolsSqlReportRequest(databaseToolsSqlReportId, updateDatabaseToolsSqlReportDetails, ifMatch, opcRequestId, isLockOverride);
        }
    }
