...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseToolsKeyStorePostgresqlDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DatabaseToolsKeyStorePostgresqlDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStorePostgresqlDetails(
            KeyStoreTypePostgresql keyStoreType,
            DatabaseToolsKeyStoreContentPostgresqlDetails keyStoreContent,
            DatabaseToolsKeyStorePasswordPostgresqlDetails keyStorePassword) {
        super();
    ...
    public static class Builder {
        ...
        public DatabaseToolsKeyStorePostgresqlDetails build() {
            DatabaseToolsKeyStorePostgresqlDetails model =
                    new DatabaseToolsKeyStorePostgresqlDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStorePostgresqlDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStorePostgresqlDetails)) {
            return false;
        }

        DatabaseToolsKeyStorePostgresqlDetails other = (DatabaseToolsKeyStorePostgresqlDetails) o;
