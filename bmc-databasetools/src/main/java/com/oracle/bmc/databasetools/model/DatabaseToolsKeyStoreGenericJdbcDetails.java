...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseToolsKeyStoreGenericJdbcDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DatabaseToolsKeyStoreGenericJdbcDetails
        extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStoreGenericJdbcDetails(
            KeyStoreTypeGenericJdbc keyStoreType,
            DatabaseToolsKeyStoreContentGenericJdbcDetails keyStoreContent,
            DatabaseToolsKeyStorePasswordGenericJdbcDetails keyStorePassword) {
        super();
    ...
    public static class Builder {
        ...
        public DatabaseToolsKeyStoreGenericJdbcDetails build() {
            DatabaseToolsKeyStoreGenericJdbcDetails model =
                    new DatabaseToolsKeyStoreGenericJdbcDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStoreGenericJdbcDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreGenericJdbcDetails)) {
            return false;
        }

        DatabaseToolsKeyStoreGenericJdbcDetails other = (DatabaseToolsKeyStoreGenericJdbcDetails) o;
