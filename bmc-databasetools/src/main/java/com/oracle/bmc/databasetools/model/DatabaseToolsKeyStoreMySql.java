...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DatabaseToolsKeyStoreMySql.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class DatabaseToolsKeyStoreMySql {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStoreMySql(
            KeyStoreTypeMySql keyStoreType,
            DatabaseToolsKeyStoreContentMySql keyStoreContent,
            DatabaseToolsKeyStorePasswordMySql keyStorePassword) {
        super();
    ...
    public static class Builder {
        ...
        public Builder keyStoreContent(DatabaseToolsKeyStoreContentMySql keyStoreContent) {
            this.keyStoreContent = keyStoreContent;
        ...
        public Builder keyStorePassword(DatabaseToolsKeyStorePasswordMySql keyStorePassword) {
            this.keyStorePassword = keyStorePassword;
        ...
        public DatabaseToolsKeyStoreMySql build() {
            DatabaseToolsKeyStoreMySql __instance__ =
                    new DatabaseToolsKeyStoreMySql(keyStoreType, keyStoreContent, keyStorePassword);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStoreMySql o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreMySql)) {
            return false;
        }

        DatabaseToolsKeyStoreMySql other = (DatabaseToolsKeyStoreMySql) o;
