...
public class DatabaseToolsUserPasswordSecretIdSummary extends DatabaseToolsUserPasswordSummary {
    ...
    public static class Builder {
        ...
        public DatabaseToolsUserPasswordSecretIdSummary build() {
            DatabaseToolsUserPasswordSecretIdSummary __instance__ =
                    new DatabaseToolsUserPasswordSecretIdSummary(secretId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsUserPasswordSecretIdSummary o) {
