...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/DeleteDatabaseToolsPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDatabaseToolsPrivateEndpointRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class DeleteDatabaseToolsPrivateEndpointRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDatabaseToolsPrivateEndpointRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDatabaseToolsPrivateEndpointRequest o) {
        ...
        /**
         * Build the instance of DeleteDatabaseToolsPrivateEndpointRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDatabaseToolsPrivateEndpointRequest
         */
        public DeleteDatabaseToolsPrivateEndpointRequest build() {
            DeleteDatabaseToolsPrivateEndpointRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDatabaseToolsPrivateEndpointRequest
         */
        public DeleteDatabaseToolsPrivateEndpointRequest buildWithoutInvocationCallback() {
            DeleteDatabaseToolsPrivateEndpointRequest request =
                    new DeleteDatabaseToolsPrivateEndpointRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDatabaseToolsPrivateEndpointRequest)) {
            return false;
        }

        DeleteDatabaseToolsPrivateEndpointRequest other =
                (DeleteDatabaseToolsPrivateEndpointRequest) o;
