...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "valueType",
        defaultImpl = DatabaseToolsKeyStoreContentMySql.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsKeyStoreContentSecretIdMySql.class,
            name = "SECRETID")
})
...
public class DatabaseToolsKeyStoreContentMySql
    ...
    protected DatabaseToolsKeyStoreContentMySql() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStoreContentMySql(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreContentMySql)) {
            return false;
        }

        DatabaseToolsKeyStoreContentMySql other = (DatabaseToolsKeyStoreContentMySql) o;
