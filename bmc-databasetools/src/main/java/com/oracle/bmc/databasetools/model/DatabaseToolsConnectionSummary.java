...
/**
 * Summary of the Database Tools connection. <br>
...
public class DatabaseToolsConnectionSummary
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsConnectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsConnectionSummary)) {
            return false;
        }

        DatabaseToolsConnectionSummary other = (DatabaseToolsConnectionSummary) o;
