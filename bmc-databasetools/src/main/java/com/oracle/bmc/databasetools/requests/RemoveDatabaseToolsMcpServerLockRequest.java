...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/RemoveDatabaseToolsMcpServerLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDatabaseToolsMcpServerLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class RemoveDatabaseToolsMcpServerLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDatabaseToolsMcpServerLockRequest o) {
        ...
        /**
         * Build the instance of RemoveDatabaseToolsMcpServerLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveDatabaseToolsMcpServerLockRequest
         */
        public RemoveDatabaseToolsMcpServerLockRequest build() {
            RemoveDatabaseToolsMcpServerLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveDatabaseToolsMcpServerLockRequest
         */
        public RemoveDatabaseToolsMcpServerLockRequest buildWithoutInvocationCallback() {
            RemoveDatabaseToolsMcpServerLockRequest request =
                    new RemoveDatabaseToolsMcpServerLockRequest();
            ...
            return request;
            // new RemoveDatabaseToolsMcpServerLockRequest(databaseToolsMcpServerId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatabaseToolsMcpServerLockRequest)) {
            return false;
        }

        RemoveDatabaseToolsMcpServerLockRequest other = (RemoveDatabaseToolsMcpServerLockRequest) o;
