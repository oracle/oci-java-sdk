...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/RemoveDatabaseToolsIdentityLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveDatabaseToolsIdentityLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class RemoveDatabaseToolsIdentityLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(RemoveDatabaseToolsIdentityLockRequest o) {
        ...
        /**
         * Build the instance of RemoveDatabaseToolsIdentityLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of RemoveDatabaseToolsIdentityLockRequest
         */
        public RemoveDatabaseToolsIdentityLockRequest build() {
            RemoveDatabaseToolsIdentityLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RemoveDatabaseToolsIdentityLockRequest
         */
        public RemoveDatabaseToolsIdentityLockRequest buildWithoutInvocationCallback() {
            RemoveDatabaseToolsIdentityLockRequest request =
                    new RemoveDatabaseToolsIdentityLockRequest();
            ...
            return request;
            // new RemoveDatabaseToolsIdentityLockRequest(databaseToolsIdentityId, removeResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveDatabaseToolsIdentityLockRequest)) {
            return false;
        }

        RemoveDatabaseToolsIdentityLockRequest other = (RemoveDatabaseToolsIdentityLockRequest) o;
