...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/AddDatabaseToolsSqlReportLockExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddDatabaseToolsSqlReportLockRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class AddDatabaseToolsSqlReportLockRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(AddDatabaseToolsSqlReportLockRequest o) {
        ...
        /**
         * Build the instance of AddDatabaseToolsSqlReportLockRequest as configured by this builder
         *
         ...
         *
         * @return instance of AddDatabaseToolsSqlReportLockRequest
         */
        public AddDatabaseToolsSqlReportLockRequest build() {
            AddDatabaseToolsSqlReportLockRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of AddDatabaseToolsSqlReportLockRequest
         */
        public AddDatabaseToolsSqlReportLockRequest buildWithoutInvocationCallback() {
            AddDatabaseToolsSqlReportLockRequest request =
                    new AddDatabaseToolsSqlReportLockRequest();
            request.databaseToolsSqlReportId = databaseToolsSqlReportId;
            request.addResourceLockDetails = addResourceLockDetails;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new AddDatabaseToolsSqlReportLockRequest(databaseToolsSqlReportId, addResourceLockDetails, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddDatabaseToolsSqlReportLockRequest)) {
            return false;
        }

        AddDatabaseToolsSqlReportLockRequest other = (AddDatabaseToolsSqlReportLockRequest) o;
