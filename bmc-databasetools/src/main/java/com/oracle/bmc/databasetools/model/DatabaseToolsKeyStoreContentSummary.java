...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "valueType",
        defaultImpl = DatabaseToolsKeyStoreContentSummary.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsKeyStoreContentSecretIdSummary.class,
            name = "SECRETID")
})
...
public class DatabaseToolsKeyStoreContentSummary
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreContentSummary)) {
            return false;
        }
