...
/**
 * Allows the creation, configuration and management of an SQL Report. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsSqlReportOracleDatabase.Builder.class)
...
public final class DatabaseToolsSqlReportOracleDatabase extends DatabaseToolsSqlReport {
    ...
    public static class Builder {
        ...
        private DatabaseToolsSqlReportLifecycleState lifecycleState;

        public Builder lifecycleState(DatabaseToolsSqlReportLifecycleState lifecycleState) {
        ...
        public DatabaseToolsSqlReportOracleDatabase build() {
            DatabaseToolsSqlReportOracleDatabase model =
                    new DatabaseToolsSqlReportOracleDatabase(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsSqlReportOracleDatabase model) {
    ...
    @Deprecated
    public DatabaseToolsSqlReportOracleDatabase(
            String id,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsSqlReportOracleDatabase(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsSqlReportOracleDatabase)) {
            return false;
        }

        DatabaseToolsSqlReportOracleDatabase other = (DatabaseToolsSqlReportOracleDatabase) o;
