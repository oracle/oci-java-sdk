...
public final class DatabaseToolsPrivateEndpoint
    ...
    public static class Builder {
        ...
        /**
         * The time the Database Tools private endpoint was created. An RFC3339 formatted datetime
         * string
         */
        ...
        /**
         * The time the Database Tools private endpoint was updated. An RFC3339 formatted datetime
         * string
         */
