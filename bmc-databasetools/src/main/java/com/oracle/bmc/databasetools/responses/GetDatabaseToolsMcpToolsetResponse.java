...
public class GetDatabaseToolsMcpToolsetResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetDatabaseToolsMcpToolsetResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDatabaseToolsMcpToolsetResponse o) {
         ...
         */
        @Override
        public GetDatabaseToolsMcpToolsetResponse build() {
            return new GetDatabaseToolsMcpToolsetResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, databaseToolsMcpToolset);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseToolsMcpToolsetResponse)) {
            return false;
        }

        GetDatabaseToolsMcpToolsetResponse other = (GetDatabaseToolsMcpToolsetResponse) o;
