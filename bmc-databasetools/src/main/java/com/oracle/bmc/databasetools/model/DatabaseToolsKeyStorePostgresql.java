...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsKeyStorePostgresql.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DatabaseToolsKeyStorePostgresql
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStorePostgresql(
            KeyStoreTypePostgresql keyStoreType,
            DatabaseToolsKeyStoreContentPostgresql keyStoreContent,
            DatabaseToolsKeyStorePasswordPostgresql keyStorePassword) {
        super();
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder keyStoreType(KeyStoreTypePostgresql keyStoreType) {
            this.keyStoreType = keyStoreType;
        ...
        private DatabaseToolsKeyStoreContentPostgresql keyStoreContent;

        public Builder keyStoreContent(DatabaseToolsKeyStoreContentPostgresql keyStoreContent) {
            this.keyStoreContent = keyStoreContent;
        ...
        private DatabaseToolsKeyStorePasswordPostgresql keyStorePassword;

        public Builder keyStorePassword(DatabaseToolsKeyStorePasswordPostgresql keyStorePassword) {
            this.keyStorePassword = keyStorePassword;
        ...
        public DatabaseToolsKeyStorePostgresql build() {
            DatabaseToolsKeyStorePostgresql model =
                    new DatabaseToolsKeyStorePostgresql(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStorePostgresql model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("keyStoreContent")
    private final DatabaseToolsKeyStoreContentPostgresql keyStoreContent;

    public DatabaseToolsKeyStoreContentPostgresql getKeyStoreContent() {
        return keyStoreContent;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("keyStorePassword")
    private final DatabaseToolsKeyStorePasswordPostgresql keyStorePassword;

    public DatabaseToolsKeyStorePasswordPostgresql getKeyStorePassword() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStorePostgresql(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStorePostgresql)) {
            return false;
        }

        DatabaseToolsKeyStorePostgresql other = (DatabaseToolsKeyStorePostgresql) o;
