...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/databasetools/GetDatabaseToolsDatabaseApiGatewayConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDatabaseToolsDatabaseApiGatewayConfigRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20201005")
public class GetDatabaseToolsDatabaseApiGatewayConfigRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDatabaseToolsDatabaseApiGatewayConfigRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDatabaseToolsDatabaseApiGatewayConfigRequest o) {
        ...
        /**
         * Build the instance of GetDatabaseToolsDatabaseApiGatewayConfigRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDatabaseToolsDatabaseApiGatewayConfigRequest
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigRequest build() {
         ...
         * @return instance of GetDatabaseToolsDatabaseApiGatewayConfigRequest
         */
        public GetDatabaseToolsDatabaseApiGatewayConfigRequest buildWithoutInvocationCallback() {
            GetDatabaseToolsDatabaseApiGatewayConfigRequest request =
                    new GetDatabaseToolsDatabaseApiGatewayConfigRequest();
            request.databaseToolsDatabaseApiGatewayConfigId =
                    databaseToolsDatabaseApiGatewayConfigId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDatabaseToolsDatabaseApiGatewayConfigRequest(databaseToolsDatabaseApiGatewayConfigId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDatabaseToolsDatabaseApiGatewayConfigRequest)) {
            return false;
        }

        GetDatabaseToolsDatabaseApiGatewayConfigRequest other =
                (GetDatabaseToolsDatabaseApiGatewayConfigRequest) o;
