...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DatabaseToolsKeyStorePostgresqlSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DatabaseToolsKeyStorePostgresqlSummary
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"keyStoreType", "keyStoreContent", "keyStorePassword"})
    public DatabaseToolsKeyStorePostgresqlSummary(
            KeyStoreTypePostgresql keyStoreType,
            DatabaseToolsKeyStoreContentPostgresqlSummary keyStoreContent,
            DatabaseToolsKeyStorePasswordPostgresqlSummary keyStorePassword) {
        super();
    ...
    public static class Builder {
        ...
        private DatabaseToolsKeyStoreContentPostgresqlSummary keyStoreContent;
        ...
        private DatabaseToolsKeyStorePasswordPostgresqlSummary keyStorePassword;
        ...
        public DatabaseToolsKeyStorePostgresqlSummary build() {
            DatabaseToolsKeyStorePostgresqlSummary model =
                    new DatabaseToolsKeyStorePostgresqlSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DatabaseToolsKeyStorePostgresqlSummary model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("keyStoreContent")
    private final DatabaseToolsKeyStoreContentPostgresqlSummary keyStoreContent;

    public DatabaseToolsKeyStoreContentPostgresqlSummary getKeyStoreContent() {
        return keyStoreContent;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("keyStorePassword")
    private final DatabaseToolsKeyStorePasswordPostgresqlSummary keyStorePassword;

    public DatabaseToolsKeyStorePasswordPostgresqlSummary getKeyStorePassword() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStorePostgresqlSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStorePostgresqlSummary)) {
            return false;
        }

        DatabaseToolsKeyStorePostgresqlSummary other = (DatabaseToolsKeyStorePostgresqlSummary) o;
