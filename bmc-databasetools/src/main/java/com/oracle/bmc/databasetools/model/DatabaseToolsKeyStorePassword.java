...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "valueType",
        defaultImpl = DatabaseToolsKeyStorePassword.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DatabaseToolsKeyStorePasswordSecretId.class,
            name = "SECRETID")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public class DatabaseToolsKeyStorePassword
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected DatabaseToolsKeyStorePassword() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStorePassword(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStorePassword)) {
            return false;
        }

        DatabaseToolsKeyStorePassword other = (DatabaseToolsKeyStorePassword) o;
