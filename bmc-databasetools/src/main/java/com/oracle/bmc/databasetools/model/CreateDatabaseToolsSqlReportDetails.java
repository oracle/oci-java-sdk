...
/**
 * Details for the new Database Tools SQL report. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = CreateDatabaseToolsSqlReportDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = CreateDatabaseToolsSqlReportOracleDatabaseDetails.class,
...
public class CreateDatabaseToolsSqlReportDetails
    ...
    protected CreateDatabaseToolsSqlReportDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseToolsSqlReportDetails)) {
            return false;
        }

        CreateDatabaseToolsSqlReportDetails other = (CreateDatabaseToolsSqlReportDetails) o;
