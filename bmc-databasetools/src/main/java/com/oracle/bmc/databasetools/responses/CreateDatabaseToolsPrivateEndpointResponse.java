...
public class CreateDatabaseToolsPrivateEndpointResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDatabaseToolsPrivateEndpointResponse)) {
            return false;
        }

        CreateDatabaseToolsPrivateEndpointResponse other =
                (CreateDatabaseToolsPrivateEndpointResponse) o;
