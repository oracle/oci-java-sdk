...
public class DatabaseToolsKeyStoreContent
    ...
    protected DatabaseToolsKeyStoreContent() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DatabaseToolsKeyStoreContent(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsKeyStoreContent)) {
            return false;
        }

        DatabaseToolsKeyStoreContent other = (DatabaseToolsKeyStoreContent) o;
