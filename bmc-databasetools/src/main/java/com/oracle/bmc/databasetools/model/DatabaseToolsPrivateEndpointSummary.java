...
/**
 * Summary of the Database Tools private endpoint. <br>
...
public final class DatabaseToolsPrivateEndpointSummary
    ...
    public DatabaseToolsPrivateEndpointSummary(
    ...
    public static class Builder {
         ...
         * compartment containing the private endpoint.
         */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DatabaseToolsPrivateEndpointSummary)) {
            return false;
        }

        DatabaseToolsPrivateEndpointSummary other = (DatabaseToolsPrivateEndpointSummary) o;
