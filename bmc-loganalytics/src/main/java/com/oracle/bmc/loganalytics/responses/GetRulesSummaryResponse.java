...
public class GetRulesSummaryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder ruleSummaryReport(
                com.oracle.bmc.loganalytics.model.RuleSummaryReport ruleSummaryReport) {
            this.ruleSummaryReport = ruleSummaryReport;
            return this;
        }
        ...
        public Builder copy(GetRulesSummaryResponse o) {
            ...
            ruleSummaryReport(o.getRuleSummaryReport());
    ...
    public String toString() {
        ...
        sb.append(",ruleSummaryReport=").append(String.valueOf(ruleSummaryReport));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRulesSummaryResponse)) {
            return false;
        }

        GetRulesSummaryResponse other = (GetRulesSummaryResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.ruleSummaryReport, other.ruleSummaryReport);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ruleSummaryReport == null ? 43 : this.ruleSummaryReport.hashCode());
        return result;
    }
}
