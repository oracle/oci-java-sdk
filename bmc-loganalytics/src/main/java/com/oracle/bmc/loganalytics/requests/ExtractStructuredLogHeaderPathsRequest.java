...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ExtractStructuredLogHeaderPathsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ExtractStructuredLogHeaderPathsRequest.
 */
...
public class ExtractStructuredLogHeaderPathsRequest
    ...
    public static class Builder
        ...
        public ExtractStructuredLogHeaderPathsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ExtractStructuredLogHeaderPathsRequest(namespaceName, loganParserDetails, parserType, opcRetryToken, opcRequestId);
        }
    }
