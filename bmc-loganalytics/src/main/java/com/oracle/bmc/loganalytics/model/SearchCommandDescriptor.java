...
/**
 * Command descriptor for querylanguage SEARCH command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SearchCommandDescriptor.Builder.class)
...
public final class SearchCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public SearchCommandDescriptor build() {
            SearchCommandDescriptor model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SearchCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SearchCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchCommandDescriptor)) {
            return false;
        }

        SearchCommandDescriptor other = (SearchCommandDescriptor) o;
