...
/**
 * Command descriptor for querylanguage EVAL command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EvalCommandDescriptor.Builder.class)
...
public final class EvalCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public EvalCommandDescriptor build() {
            EvalCommandDescriptor model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EvalCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EvalCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EvalCommandDescriptor)) {
            return false;
        }

        EvalCommandDescriptor other = (EvalCommandDescriptor) o;
