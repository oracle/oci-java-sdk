...
public class ListAssociatedEntitiesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsAssociatedEntityCollection
            getLogAnalyticsAssociatedEntityCollection() {
        return logAnalyticsAssociatedEntityCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder logAnalyticsAssociatedEntityCollection(
                com.oracle.bmc.loganalytics.model.LogAnalyticsAssociatedEntityCollection
                        logAnalyticsAssociatedEntityCollection) {
            this.logAnalyticsAssociatedEntityCollection = logAnalyticsAssociatedEntityCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",logAnalyticsAssociatedEntityCollection=")
                .append(String.valueOf(logAnalyticsAssociatedEntityCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAssociatedEntitiesResponse)) {
            return false;
        }

        ListAssociatedEntitiesResponse other = (ListAssociatedEntitiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.logAnalyticsAssociatedEntityCollection,
                        other.logAnalyticsAssociatedEntityCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.logAnalyticsAssociatedEntityCollection == null
                                ? 43
                                : this.logAnalyticsAssociatedEntityCollection.hashCode());
        return result;
    }
}
