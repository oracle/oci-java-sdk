...
/**
 * Command descriptor for querylanguage BOTTOM command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = BottomCommandDescriptor.Builder.class)
...
public final class BottomCommandDescriptor extends AbstractCommandDescriptor {
    ...
    @Deprecated
    public BottomCommandDescriptor(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BottomCommandDescriptor)) {
            return false;
        }
