...
public final class CreateAccelerationTaskDetails extends CreateScheduledTaskDetails {
    ...
    public static class Builder {
        ...
        public CreateAccelerationTaskDetails build() {
            CreateAccelerationTaskDetails __instance__ =
                    new CreateAccelerationTaskDetails(
                            compartmentId, displayName, freeformTags, definedTags, savedSearchId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAccelerationTaskDetails o) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAccelerationTaskDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAccelerationTaskDetails)) {
            return false;
        }

        CreateAccelerationTaskDetails other = (CreateAccelerationTaskDetails) o;
