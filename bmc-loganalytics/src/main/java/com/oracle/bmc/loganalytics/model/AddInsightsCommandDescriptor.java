...
/**
 * Command descriptor for querylanguage ADDINSIGHTS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddInsightsCommandDescriptor.Builder.class)
...
public final class AddInsightsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public AddInsightsCommandDescriptor build() {
            AddInsightsCommandDescriptor model =
                    new AddInsightsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddInsightsCommandDescriptor model) {
    ...
    @Deprecated
    public AddInsightsCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddInsightsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddInsightsCommandDescriptor)) {
            return false;
        }

        AddInsightsCommandDescriptor other = (AddInsightsCommandDescriptor) o;
