...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListPropertiesMetadataExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListPropertiesMetadataRequest.
 */
...
public class ListPropertiesMetadataRequest
    ...
    public static class Builder
         ...
         */
        public ListPropertiesMetadataRequest build() {
            ListPropertiesMetadataRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListPropertiesMetadataRequest
         */
        public ListPropertiesMetadataRequest buildWithoutInvocationCallback() {
            ListPropertiesMetadataRequest request = new ListPropertiesMetadataRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPropertiesMetadataRequest)) {
            return false;
        }

        ListPropertiesMetadataRequest other = (ListPropertiesMetadataRequest) o;
