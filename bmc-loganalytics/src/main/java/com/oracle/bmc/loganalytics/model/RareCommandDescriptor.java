...
/**
 * Command descriptor for querylanguage RARE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RareCommandDescriptor.Builder.class)
...
public final class RareCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public RareCommandDescriptor build() {
            RareCommandDescriptor model =
                    new RareCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RareCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RareCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RareCommandDescriptor)) {
            return false;
        }

        RareCommandDescriptor other = (RareCommandDescriptor) o;
