...
public class ResumeScheduledTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ResumeScheduledTaskResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResumeScheduledTaskResponse)) {
            return false;
        }

        ResumeScheduledTaskResponse other = (ResumeScheduledTaskResponse) o;
