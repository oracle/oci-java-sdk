...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/EnableSourceEventTypesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use EnableSourceEventTypesRequest.
 */
...
public class EnableSourceEventTypesRequest
    ...
    public static class Builder
        ...
        public EnableSourceEventTypesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new EnableSourceEventTypesRequest(namespaceName, sourceName, enableEventTypeDetails, opcRetryToken, opcRequestId);
        }
    }
