...
public class ValidateFileResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code FileValidationResponse} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ValidateFileResponse> {
        ...
        public ValidateFileResponse build() {
            return new ValidateFileResponse(
                    __httpStatusCode__, headers, opcRequestId, fileValidationResponse);
        }
    }
