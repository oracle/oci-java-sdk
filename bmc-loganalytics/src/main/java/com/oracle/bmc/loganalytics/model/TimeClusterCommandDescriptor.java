...
public final class TimeClusterCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public TimeClusterCommandDescriptor build() {
            TimeClusterCommandDescriptor model =
                    new TimeClusterCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TimeClusterCommandDescriptor model) {
    ...
    @Deprecated
    public TimeClusterCommandDescriptor(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TimeClusterCommandDescriptor)) {
            return false;
        }

        TimeClusterCommandDescriptor other = (TimeClusterCommandDescriptor) o;
