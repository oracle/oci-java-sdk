...
/**
 * Command descriptor for querylanguage UPDATETABLE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateTableCommandDescriptor.Builder.class)
...
public final class UpdateTableCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public UpdateTableCommandDescriptor build() {
            UpdateTableCommandDescriptor model =
                    new UpdateTableCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateTableCommandDescriptor model) {
    ...
    @Deprecated
    public UpdateTableCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateTableCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateTableCommandDescriptor)) {
            return false;
        }

        UpdateTableCommandDescriptor other = (UpdateTableCommandDescriptor) o;
