...
/**
 * Command descriptor for querylanguage SORT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SortCommandDescriptor.Builder.class)
...
public final class SortCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public SortCommandDescriptor build() {
            SortCommandDescriptor model =
                    new SortCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SortCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SortCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SortCommandDescriptor)) {
            return false;
        }

        SortCommandDescriptor other = (SortCommandDescriptor) o;
