...
public interface LogAnalyticsAsync extends AutoCloseable {
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ChangeLookupCompartmentResponse> changeLookupCompartment(
            ChangeLookupCompartmentRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            ChangeLookupCompartmentRequest, ChangeLookupCompartmentResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetFieldUsagesResponse> getFieldUsages(
            GetFieldUsagesRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetFieldUsagesRequest, GetFieldUsagesResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetRecallCountResponse> getRecallCount(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetRecalledDataSizeResponse> getRecalledDataSize(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetRulesSummaryResponse> getRulesSummary(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListEffectivePropertiesResponse> listEffectiveProperties(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOverlappingRecallsResponse> listOverlappingRecalls(
    ...
    /**
     * Returns a list of parser actions. You may limit the number of results and provide sorting
     * order.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListParserActionsResponse> listParserActions(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListPropertiesMetadataResponse> listPropertiesMetadata(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListRecalledInfoResponse> listRecalledInfo(
            ListRecalledInfoRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListRecalledInfoRequest, ListRecalledInfoResponse>
                    handler);
    ...
    /**
     * Returns a list of templates, containing detailed information about them. You may limit the
     * number of results, provide sorting order, and filter by information such as template name,
     * type, display name and description.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UploadDiscoveryDataResponse> uploadDiscoveryData(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UploadOtlpLogsResponse> uploadOtlpLogs(
            UploadOtlpLogsRequest request,
            com.oracle.bmc.responses.AsyncHandler<UploadOtlpLogsRequest, UploadOtlpLogsResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ValidateEndpointResponse> validateEndpoint(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ValidateLabelConditionResponse> validateLabelCondition(
