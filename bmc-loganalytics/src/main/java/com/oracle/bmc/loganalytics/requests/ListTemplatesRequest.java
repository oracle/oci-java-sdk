...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListTemplatesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListTemplatesRequest.
 */
...
public class ListTemplatesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListTemplatesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListTemplatesRequest(namespaceName, compartmentId, type, name, templateDisplayText, lifecycleState, filter, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
