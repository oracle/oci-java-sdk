...
public class GetLogAnalyticsLogGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetLogAnalyticsLogGroupResponse o) {
         ...
         */
        @Override
        public GetLogAnalyticsLogGroupResponse build() {
            return new GetLogAnalyticsLogGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLogAnalyticsLogGroupResponse)) {
            return false;
        }

        GetLogAnalyticsLogGroupResponse other = (GetLogAnalyticsLogGroupResponse) o;
