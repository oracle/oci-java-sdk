...
public final class LabelNames {
    ...
    public static class Builder {
        ...
        public LabelNames build() {
            LabelNames __instance__ = new LabelNames(labelNames);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LabelNames o) {
            Builder copiedBuilder = labelNames(o.getLabelNames());
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.labelNames, other.labelNames)
