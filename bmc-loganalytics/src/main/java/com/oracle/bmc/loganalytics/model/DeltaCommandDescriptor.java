...
/**
 * Command descriptor for querylanguage DELTA command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeltaCommandDescriptor.Builder.class)
...
public final class DeltaCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        /**
         * Value specified in DELTA command in queryString if set controlling whether delta is
         * calculating difference between consecutive result rows or skipping N rows for each
         * calculation.
         */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeltaCommandDescriptor)) {
            return false;
        }
