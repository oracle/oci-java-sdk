...
public class UpdateScheduledTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateScheduledTaskResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateScheduledTaskResponse)) {
            return false;
        }

        UpdateScheduledTaskResponse other = (UpdateScheduledTaskResponse) o;
