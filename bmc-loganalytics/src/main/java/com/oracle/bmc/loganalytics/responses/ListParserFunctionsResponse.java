...
public class ListParserFunctionsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsParserFunctionCollection
            getLogAnalyticsParserFunctionCollection() {
        return logAnalyticsParserFunctionCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListParserFunctionsResponse> {
         ...
         * @return this builder
         */
        public Builder logAnalyticsParserFunctionCollection(
                com.oracle.bmc.loganalytics.model.LogAnalyticsParserFunctionCollection
                        logAnalyticsParserFunctionCollection) {
            this.logAnalyticsParserFunctionCollection = logAnalyticsParserFunctionCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(ListParserFunctionsResponse o) {
    ...
    public String toString() {
        ...
        sb.append(",logAnalyticsParserFunctionCollection=")
                .append(String.valueOf(logAnalyticsParserFunctionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListParserFunctionsResponse)) {
            return false;
        }

        ListParserFunctionsResponse other = (ListParserFunctionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.logAnalyticsParserFunctionCollection,
                        other.logAnalyticsParserFunctionCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.logAnalyticsParserFunctionCollection == null
                                ? 43
                                : this.logAnalyticsParserFunctionCollection.hashCode());
        return result;
    }
}
