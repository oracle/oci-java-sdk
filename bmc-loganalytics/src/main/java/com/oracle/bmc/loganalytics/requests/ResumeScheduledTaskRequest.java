...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ResumeScheduledTaskExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ResumeScheduledTaskRequest.
 */
...
public class ResumeScheduledTaskRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ResumeScheduledTaskRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ResumeScheduledTaskRequest(namespaceName, scheduledTaskId, ifMatch,
            // opcRequestId);
        }
    }
