...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ResumeScheduledTaskExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ResumeScheduledTaskRequest.
 */
...
public class ResumeScheduledTaskRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ResumeScheduledTaskRequest
         */
        public ResumeScheduledTaskRequest buildWithoutInvocationCallback() {
            ResumeScheduledTaskRequest request = new ResumeScheduledTaskRequest();
            request.namespaceName = namespaceName;
            request.scheduledTaskId = scheduledTaskId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ResumeScheduledTaskRequest(namespaceName, scheduledTaskId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResumeScheduledTaskRequest)) {
            return false;
        }

        ResumeScheduledTaskRequest other = (ResumeScheduledTaskRequest) o;
