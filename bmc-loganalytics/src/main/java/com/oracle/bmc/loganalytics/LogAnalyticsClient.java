...
public class LogAnalyticsClient implements LogAnalytics {
    ...
    public ChangeLookupCompartmentResponse changeLookupCompartment(
        ...
        LOG.trace("Called changeLookupCompartment");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ChangeLookupCompartmentResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeLookupCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetFieldUsagesResponse getFieldUsages(GetFieldUsagesRequest request) {
        LOG.trace("Called getFieldUsages");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetFieldUsagesResponse> transformer =
    ...
    public ListParserActionsResponse listParserActions(ListParserActionsRequest request) {
        LOG.trace("Called listParserActions");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListParserActionsResponse>
                transformer =
    ...
    public ListRecalledInfoResponse listRecalledInfo(ListRecalledInfoRequest request) {
        LOG.trace("Called listRecalledInfo");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListRecalledInfoResponse>
                transformer =
    ...
    public UploadOtlpLogsResponse uploadOtlpLogs(UploadOtlpLogsRequest request) {
        LOG.trace("Called uploadOtlpLogs");
        try {
            final com.oracle.bmc.retrier.BmcGenericRetrier retrier =
                    com.oracle.bmc.retrier.Retriers.createPreferredRetrier(
                            request.getRetryConfiguration(), retryConfiguration, true);
            ...
            java.util.function.Function<javax.ws.rs.core.Response, UploadOtlpLogsResponse>
                    transformer =
                            UploadOtlpLogsConverter.fromResponse(
                                    java.util.Optional.of(serviceDetails));
            return retrier.execute(
                    interceptedRequest,
                    retryRequest -> {
                                ...
                                retriedRequest -> {
                                    try {
                                        javax.ws.rs.core.Response response =
                                                client.post(
                                                        ib,
                                                        retriedRequest.getUploadOtlpLogsDetails(),
                                                        retriedRequest);
                                        return transformer.apply(response);
                                    } catch (RuntimeException e) {
                                        if (interceptedRequest.getRetryConfiguration() != null
            ...
            com.oracle.bmc.io.internal.KeepOpenInputStream.closeStream(
                    request.getUploadOtlpLogsDetails());
        }
    }
