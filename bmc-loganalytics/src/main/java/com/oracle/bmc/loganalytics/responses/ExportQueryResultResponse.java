...
public class ExportQueryResultResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ExportQueryResultResponse> {
         ...
         */
        @Override
        public Builder copy(ExportQueryResultResponse o) {
        ...
        public ExportQueryResultResponse build() {
            return new ExportQueryResultResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportQueryResultResponse)) {
            return false;
        }

        ExportQueryResultResponse other = (ExportQueryResultResponse) o;
