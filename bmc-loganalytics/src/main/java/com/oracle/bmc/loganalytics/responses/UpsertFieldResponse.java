...
public class UpsertFieldResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpsertFieldResponse> {
         ...
         */
        @Override
        public Builder copy(UpsertFieldResponse o) {
         ...
         */
        @Override
        public UpsertFieldResponse build() {
            return new UpsertFieldResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpsertFieldResponse)) {
            return false;
        }

        UpsertFieldResponse other = (UpsertFieldResponse) o;
