...
/**
 * Command descriptor for querylanguage CLUSTERDETAILS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ClusterDetailsCommandDescriptor.Builder.class)
...
public final class ClusterDetailsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public ClusterDetailsCommandDescriptor build() {
            ClusterDetailsCommandDescriptor model =
                    new ClusterDetailsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ClusterDetailsCommandDescriptor model) {
    ...
    @Deprecated
    public ClusterDetailsCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ClusterDetailsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterDetailsCommandDescriptor)) {
            return false;
        }

        ClusterDetailsCommandDescriptor other = (ClusterDetailsCommandDescriptor) o;
