...
/**
 * Command descriptor for querylanguage WHERE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = WhereCommandDescriptor.Builder.class)
...
public final class WhereCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public WhereCommandDescriptor build() {
            WhereCommandDescriptor model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WhereCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("WhereCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WhereCommandDescriptor)) {
            return false;
        }

        WhereCommandDescriptor other = (WhereCommandDescriptor) o;
