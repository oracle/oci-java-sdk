...
public class ListLogAnalyticsEntitiesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListLogAnalyticsEntitiesResponse)) {
            return false;
        }

        ListLogAnalyticsEntitiesResponse other = (ListLogAnalyticsEntitiesResponse) o;
