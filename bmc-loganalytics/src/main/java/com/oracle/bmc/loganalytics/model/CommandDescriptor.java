...
/**
 * Generic catch-all command descriptor <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CommandDescriptor.Builder.class)
...
public final class CommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CommandDescriptor model) {
    ...
    public boolean equals(Object o) {
        ...
        CommandDescriptor other = (CommandDescriptor) o;
