...
public class ListRulesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.RuleSummaryCollection getRuleSummaryCollection() {
        return ruleSummaryCollection;
    }
    ...
    private ListRulesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.loganalytics.model.RuleSummaryCollection ruleSummaryCollection) {
        super(__httpStatusCode__, headers);
        this.opcPrevPage = opcPrevPage;
        this.opcRequestId = opcRequestId;
        this.opcNextPage = opcNextPage;
        this.ruleSummaryCollection = ruleSummaryCollection;
    }

    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListRulesResponse> {
         ...
         * @return this builder
         */
        public Builder ruleSummaryCollection(
                com.oracle.bmc.loganalytics.model.RuleSummaryCollection ruleSummaryCollection) {
            this.ruleSummaryCollection = ruleSummaryCollection;
            return this;
        }
        ...
        public Builder copy(ListRulesResponse o) {
            ...
            ruleSummaryCollection(o.getRuleSummaryCollection());
    ...
    public String toString() {
        ...
        sb.append(",ruleSummaryCollection=").append(String.valueOf(ruleSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRulesResponse)) {
            return false;
        }
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.ruleSummaryCollection, other.ruleSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.ruleSummaryCollection == null
                                ? 43
                                : this.ruleSummaryCollection.hashCode());
        return result;
    }
}
