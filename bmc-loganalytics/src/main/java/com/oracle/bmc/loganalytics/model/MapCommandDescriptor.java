...
/**
 * Command descriptor for querylanguage MAP command. <br>
...
public final class MapCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MapCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MapCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MapCommandDescriptor)) {
            return false;
        }

        MapCommandDescriptor other = (MapCommandDescriptor) o;
