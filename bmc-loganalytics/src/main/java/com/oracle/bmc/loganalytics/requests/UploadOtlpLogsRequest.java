...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/UploadOtlpLogsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UploadOtlpLogsRequest.
 */
...
public class UploadOtlpLogsRequest extends com.oracle.bmc.requests.BmcRequest<java.io.InputStream> {
    ...
    public static class Builder
        ...
        public UploadOtlpLogsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UploadOtlpLogsRequest(namespaceName, opcMetaLoggrpid, uploadOtlpLogsDetails, opcRequestId, logSet, contentType, opcRetryToken, opcMetaProperties, expect);
        }
    }
