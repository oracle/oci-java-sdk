...
public class UploadOtlpLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UploadOtlpLogsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UploadOtlpLogsResponse> {
         ...
         */
        @Override
        public Builder copy(UploadOtlpLogsResponse o) {
         ...
         */
        @Override
        public UploadOtlpLogsResponse build() {
            return new UploadOtlpLogsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UploadOtlpLogsResponse)) {
            return false;
        }

        UploadOtlpLogsResponse other = (UploadOtlpLogsResponse) o;
