...
public class CreateScheduledTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateScheduledTaskResponse> {
         ...
         */
        @Override
        public Builder copy(CreateScheduledTaskResponse o) {
        ...
        public CreateScheduledTaskResponse build() {
            return new CreateScheduledTaskResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, scheduledTask);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateScheduledTaskResponse)) {
            return false;
        }

        CreateScheduledTaskResponse other = (CreateScheduledTaskResponse) o;
