...
/**
 * Command descriptor for querylanguage DELETE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DeleteCommandDescriptor.Builder.class)
...
public final class DeleteCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        /**
         * Value specified in DELETE command in queryString as to whether the delete is a dry-run
         * (only report number of rows removed) rather than actually remove matching log records.
         */
    ...
    /**
     * Value specified in DELETE command in queryString as to whether the delete is a dry-run (only
     * report number of rows removed) rather than actually remove matching log records.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isDryRun")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteCommandDescriptor)) {
            return false;
        }
