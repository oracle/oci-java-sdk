...
/**
 * Enterprise manager bridge summary. <br>
...
public final class LogAnalyticsEmBridgeSummary
    ...
    public LogAnalyticsEmBridgeSummary(
            String id,
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public LogAnalyticsEmBridgeSummary build() {
            LogAnalyticsEmBridgeSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LogAnalyticsEmBridgeSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LogAnalyticsEmBridgeSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogAnalyticsEmBridgeSummary)) {
            return false;
        }

        LogAnalyticsEmBridgeSummary other = (LogAnalyticsEmBridgeSummary) o;
