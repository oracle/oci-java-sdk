...
public class LogAnalyticsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listParserActions operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListParserActionsResponse> listParserActionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListParserActionsRequest.Builder, ListParserActionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.loganalytics.model.ParserActionSummary} objects
     * contained in responses from the listParserActions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.loganalytics.model.ParserActionSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.loganalytics.model.ParserActionSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListParserActionsRequest.Builder, ListParserActionsRequest,
                ListParserActionsResponse, com.oracle.bmc.loganalytics.model.ParserActionSummary>(
                new java.util.function.Supplier<ListParserActionsRequest.Builder>() {
                    @Override
                    public ListParserActionsRequest.Builder get() {
                        return ListParserActionsRequest.builder().copy(request);
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listRecalledInfo operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.loganalytics.model.RecalledInfo} objects
     * contained in responses from the listRecalledInfo operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.loganalytics.model.RecalledInfo} objects
     * contained in responses received from the service.
     */
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.loganalytics.model.LogAnalyticsTemplateSummary} objects
     * contained in responses from the listTemplates operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.loganalytics.model.LogAnalyticsTemplateSummary} objects
     * contained in responses received from the service.
     */
