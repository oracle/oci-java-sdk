...
/**
 * Command descriptor for querylanguage REGEX command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RegexCommandDescriptor.Builder.class)
...
public final class RegexCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public RegexCommandDescriptor build() {
            RegexCommandDescriptor model =
                    new RegexCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RegexCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RegexCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegexCommandDescriptor)) {
            return false;
        }

        RegexCommandDescriptor other = (RegexCommandDescriptor) o;
