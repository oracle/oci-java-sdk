...
/**
 * Command descriptor for querylanguage RENAME command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RenameCommandDescriptor.Builder.class)
...
public final class RenameCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public RenameCommandDescriptor build() {
            RenameCommandDescriptor model =
                    new RenameCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RenameCommandDescriptor model) {
    ...
    @Deprecated
    public RenameCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RenameCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RenameCommandDescriptor)) {
            return false;
        }

        RenameCommandDescriptor other = (RenameCommandDescriptor) o;
