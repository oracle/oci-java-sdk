...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ChangeLogAnalyticsEntityCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeLogAnalyticsEntityCompartmentRequest.
 */
...
public class ChangeLogAnalyticsEntityCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeLogAnalyticsEntityCompartmentRequest as configured by this builder
         *
        ...
        public ChangeLogAnalyticsEntityCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeLogAnalyticsEntityCompartmentRequest(namespaceName, logAnalyticsEntityId, changeLogAnalyticsEntityCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
