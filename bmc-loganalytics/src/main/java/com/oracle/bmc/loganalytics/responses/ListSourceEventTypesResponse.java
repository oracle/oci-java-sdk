...
public class ListSourceEventTypesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.EventTypeCollection getEventTypeCollection() {
    ...
    private ListSourceEventTypesResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.loganalytics.model.EventTypeCollection eventTypeCollection) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSourceEventTypesResponse> {
         ...
         * @return this builder
         */
        public Builder eventTypeCollection(
                com.oracle.bmc.loganalytics.model.EventTypeCollection eventTypeCollection) {
            this.eventTypeCollection = eventTypeCollection;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(ListSourceEventTypesResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcPrevPage(o.getOpcPrevPage());
            opcNextPage(o.getOpcNextPage());
            opcRequestId(o.getOpcRequestId());
            eventTypeCollection(o.getEventTypeCollection());
         ...
         */
        @Override
        public ListSourceEventTypesResponse build() {
            return new ListSourceEventTypesResponse(
                    __httpStatusCode__,
                    headers,
                    opcPrevPage,
                    opcNextPage,
    ...
    public String toString() {
        ...
        sb.append(",eventTypeCollection=").append(String.valueOf(eventTypeCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSourceEventTypesResponse)) {
            return false;
        }

        ListSourceEventTypesResponse other = (ListSourceEventTypesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.eventTypeCollection, other.eventTypeCollection);
    }
        ...
        result =
                (result * PRIME)
                        + (this.eventTypeCollection == null
                                ? 43
                                : this.eventTypeCollection.hashCode());
        return result;
    }
}
