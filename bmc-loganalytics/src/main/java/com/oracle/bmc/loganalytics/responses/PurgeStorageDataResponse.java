...
public class PurgeStorageDataResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PurgeStorageDataResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurgeStorageDataResponse)) {
            return false;
        }

        PurgeStorageDataResponse other = (PurgeStorageDataResponse) o;
