...
public class GetLookupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetLookupResponse> {
         ...
         */
        @Override
        public GetLookupResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLookupResponse)) {
            return false;
        }

        GetLookupResponse other = (GetLookupResponse) o;
