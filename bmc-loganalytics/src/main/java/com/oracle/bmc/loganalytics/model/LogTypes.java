...
public enum LogTypes {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(LogTypes.class);
    ...
    public static LogTypes create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'LogTypes', returning UnknownEnumValue", key);
