...
/**
 * Command descriptor for querylanguage OUTLIER command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OutlierCommandDescriptor.Builder.class)
...
public final class OutlierCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public OutlierCommandDescriptor build() {
            OutlierCommandDescriptor model =
                    new OutlierCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OutlierCommandDescriptor model) {
    ...
    @Deprecated
    public OutlierCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OutlierCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutlierCommandDescriptor)) {
            return false;
        }

        OutlierCommandDescriptor other = (OutlierCommandDescriptor) o;
