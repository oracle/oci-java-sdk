...
/**
 * Command descriptor for querylanguage CREATEVIEW command. <br>
...
public final class CreateViewCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public CreateViewCommandDescriptor build() {
            CreateViewCommandDescriptor model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateViewCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateViewCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateViewCommandDescriptor)) {
            return false;
        }

        CreateViewCommandDescriptor other = (CreateViewCommandDescriptor) o;
