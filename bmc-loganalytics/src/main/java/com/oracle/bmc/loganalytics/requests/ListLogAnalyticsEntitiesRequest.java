...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListLogAnalyticsEntitiesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListLogAnalyticsEntitiesRequest.
 */
...
public class ListLogAnalyticsEntitiesRequest
    ...
    public static class Builder
        ...
        /**
         * Singular setter. A filter to return only log analytics entities whose metadata name, value and type matches the specified string.
         * Each item in the array has the format "{name}:{value}:{type}".  All inputs are case-insensitive.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
        ...
        /**
         * Singular setter. A list of tag filters to apply.  Only entities with a defined tag matching the value will be returned.
         * Each item in the list has the format "{namespace}.{tagName}.{value}".  All inputs are case-insensitive.
         * Multiple values for the same key (i.e. same namespace and tag name) are interpreted as "OR".
         * Values for different keys (i.e. different namespaces, different tag names, or both) are interpreted as "AND".
         *
        ...
        /**
         * Singular setter. A list of tag filters to apply.  Only entities with a freeform tag matching the value will be returned.
         * The key for each tag is "{tagName}.{value}".  All inputs are case-insensitive.
         * Multiple values for the same tag name are interpreted as "OR".  Values for different tag names are interpreted as "AND".
         *
         * @param singularValue the singular value to set
        ...
        /**
         * Singular setter. A list of tag existence filters to apply.  Only entities for which the specified defined tags exist will be returned.
         * Each item in the list has the format "{namespace}.{tagName}.true" (for checking existence of a defined tag)
         * or "{namespace}.true".  All inputs are case-insensitive.
         * Currently, only existence ("true" at the end) is supported. Absence ("false" at the end) is not supported.
         * Multiple values for the same key (i.e. same namespace and tag name) are interpreted as "OR".
        ...
        /**
         * Singular setter. A list of tag existence filters to apply.  Only entities for which the specified freeform tags exist the value will be returned.
         * The key for each tag is "{tagName}.true".  All inputs are case-insensitive.
         * Currently, only existence ("true" at the end) is supported. Absence ("false" at the end) is not supported.
         * Multiple values for different tag names are interpreted as "AND".
         *
        ...
        public ListLogAnalyticsEntitiesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListLogAnalyticsEntitiesRequest(namespaceName, compartmentId, name, nameContains, entityTypeName, cloudResourceId, lifecycleState, lifecycleDetailsContains, isManagementAgentIdNull, hostname, hostnameContains, sourceId, creationSourceType, creationSourceDetails, limit, page, sortOrder, sortBy, opcRequestId, metadataEquals, definedTagEquals, freeformTagEquals, definedTagExists, freeformTagExists, isShowAssociatedSourcesCount);
        }
    }
