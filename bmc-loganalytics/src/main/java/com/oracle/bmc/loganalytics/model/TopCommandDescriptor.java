...
/**
 * Command descriptor for querylanguage TOP command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TopCommandDescriptor.Builder.class)
...
public final class TopCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public TopCommandDescriptor build() {
            TopCommandDescriptor model =
                    new TopCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TopCommandDescriptor model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TopCommandDescriptor)) {
            return false;
        }

        TopCommandDescriptor other = (TopCommandDescriptor) o;
