...
public class GetColumnNamesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code ColumnNameCollection} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetColumnNamesResponse> {
         ...
         * The returned {@code ColumnNameCollection} instance.
         *
         * @param columnNameCollection the value to set
         * @return this builder
         */
