...
/**
 * Command descriptor for querylanguage DEDUP command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DedupCommandDescriptor.Builder.class)
...
public final class DedupCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public DedupCommandDescriptor build() {
            DedupCommandDescriptor model =
                    new DedupCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DedupCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DedupCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DedupCommandDescriptor)) {
            return false;
        }

        DedupCommandDescriptor other = (DedupCommandDescriptor) o;
