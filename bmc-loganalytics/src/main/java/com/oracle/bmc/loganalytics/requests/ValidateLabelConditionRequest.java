...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ValidateLabelConditionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ValidateLabelConditionRequest.
 */
...
public class ValidateLabelConditionRequest
    ...
    public static class Builder
        ...
        public ValidateLabelConditionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ValidateLabelConditionRequest(namespaceName, validateLabelConditionDetails, opcRequestId);
        }
    }
