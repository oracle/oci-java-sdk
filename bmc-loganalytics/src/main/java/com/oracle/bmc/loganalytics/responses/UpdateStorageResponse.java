...
public class UpdateStorageResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateStorageResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateStorageResponse o) {
        ...
        public UpdateStorageResponse build() {
            return new UpdateStorageResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, storage);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateStorageResponse)) {
            return false;
        }

        UpdateStorageResponse other = (UpdateStorageResponse) o;
