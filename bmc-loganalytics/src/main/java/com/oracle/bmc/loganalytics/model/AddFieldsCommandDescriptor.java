...
/**
 * Command descriptor for querylanguage ADDFIELDS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddFieldsCommandDescriptor.Builder.class)
...
public final class AddFieldsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public AddFieldsCommandDescriptor build() {
            AddFieldsCommandDescriptor model =
                    new AddFieldsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddFieldsCommandDescriptor model) {
    ...
    @Deprecated
    public AddFieldsCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AddFieldsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddFieldsCommandDescriptor)) {
            return false;
        }

        AddFieldsCommandDescriptor other = (AddFieldsCommandDescriptor) o;
