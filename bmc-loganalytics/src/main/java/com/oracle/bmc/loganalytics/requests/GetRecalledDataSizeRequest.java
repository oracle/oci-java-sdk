...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/GetRecalledDataSizeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetRecalledDataSizeRequest.
 */
...
public class GetRecalledDataSizeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetRecalledDataSizeRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetRecalledDataSizeRequest(namespaceName, opcRequestId, timeDataStarted, timeDataEnded);
        }
    }
