...
/**
 * Command descriptor for querylanguage CLUSTERSPLIT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ClusterSplitCommandDescriptor.Builder.class)
...
public final class ClusterSplitCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public ClusterSplitCommandDescriptor build() {
            ClusterSplitCommandDescriptor model =
                    new ClusterSplitCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ClusterSplitCommandDescriptor model) {
    ...
    @Deprecated
    public ClusterSplitCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ClusterSplitCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterSplitCommandDescriptor)) {
            return false;
        }

        ClusterSplitCommandDescriptor other = (ClusterSplitCommandDescriptor) o;
