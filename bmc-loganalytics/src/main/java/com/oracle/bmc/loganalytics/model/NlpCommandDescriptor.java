...
/**
 * Command descriptor for querylanguage NLP command. <br>
...
public final class NlpCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NlpCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("NlpCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NlpCommandDescriptor)) {
            return false;
        }

        NlpCommandDescriptor other = (NlpCommandDescriptor) o;
