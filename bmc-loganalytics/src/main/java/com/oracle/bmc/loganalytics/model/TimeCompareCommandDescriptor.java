...
/**
 * Command descriptor for querylanguage TIMECOMPARE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TimeCompareCommandDescriptor.Builder.class)
...
public final class TimeCompareCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public TimeCompareCommandDescriptor build() {
            TimeCompareCommandDescriptor model =
                    new TimeCompareCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TimeCompareCommandDescriptor model) {
    ...
    @Deprecated
    public TimeCompareCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TimeCompareCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TimeCompareCommandDescriptor)) {
            return false;
        }

        TimeCompareCommandDescriptor other = (TimeCompareCommandDescriptor) o;
