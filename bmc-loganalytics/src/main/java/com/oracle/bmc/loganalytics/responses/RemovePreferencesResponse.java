...
public class RemovePreferencesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private RemovePreferencesResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<RemovePreferencesResponse> {
        ...
        public RemovePreferencesResponse build() {
            return new RemovePreferencesResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePreferencesResponse)) {
            return false;
        }

        RemovePreferencesResponse other = (RemovePreferencesResponse) o;
