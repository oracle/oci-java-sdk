...
public class ListLabelPrioritiesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.LabelPriorityCollection getLabelPriorityCollection() {
        return labelPriorityCollection;
    }
    ...
    private ListLabelPrioritiesResponse(
        ...
        this.labelPriorityCollection = labelPriorityCollection;
    }

    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListLabelPrioritiesResponse> {
         ...
         * @return this builder
         */
        public Builder labelPriorityCollection(
                com.oracle.bmc.loganalytics.model.LabelPriorityCollection labelPriorityCollection) {
            this.labelPriorityCollection = labelPriorityCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",labelPriorityCollection=").append(String.valueOf(labelPriorityCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListLabelPrioritiesResponse)) {
            return false;
        }

        ListLabelPrioritiesResponse other = (ListLabelPrioritiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.labelPriorityCollection, other.labelPriorityCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.labelPriorityCollection == null
                                ? 43
                                : this.labelPriorityCollection.hashCode());
        return result;
    }
}
