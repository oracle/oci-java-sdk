...
/**
 * Command descriptor for querylanguage MACRO command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MacroCommandDescriptor.Builder.class)
...
public final class MacroCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public MacroCommandDescriptor build() {
            MacroCommandDescriptor model =
                    new MacroCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MacroCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("MacroCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MacroCommandDescriptor)) {
            return false;
        }

        MacroCommandDescriptor other = (MacroCommandDescriptor) o;
