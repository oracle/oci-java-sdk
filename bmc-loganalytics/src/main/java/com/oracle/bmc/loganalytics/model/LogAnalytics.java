...
@lombok.Value
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = LogAnalytics.Builder.class)
...
public class LogAnalytics {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("logAnalyticsType")
        private String logAnalyticsType;

        public Builder logAnalyticsType(String logAnalyticsType) {
            this.logAnalyticsType = logAnalyticsType;
            this.__explicitlySet__.add("logAnalyticsType");
            return this;
        }
        ...
        public LogAnalytics build() {
            LogAnalytics __instance__ =
                    new LogAnalytics(
                            id,
                            displayName,
                            compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LogAnalytics o) {
            Builder copiedBuilder =
                    id(o.getId())
                            .displayName(o.getDisplayName())
                            .compartmentId(o.getCompartmentId())
                            .logAnalyticsType(o.getLogAnalyticsType())
