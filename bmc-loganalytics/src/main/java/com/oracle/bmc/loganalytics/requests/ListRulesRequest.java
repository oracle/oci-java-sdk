...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListRulesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRulesRequest.
 */
...
public class ListRulesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListRulesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListRulesRequest(namespaceName, compartmentId, displayName, kind, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
