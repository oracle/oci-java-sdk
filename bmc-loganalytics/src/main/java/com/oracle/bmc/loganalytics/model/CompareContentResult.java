...
public final class CompareContentResult {
    ...
    public static class Builder {
        ...
        public CompareContentResult build() {
            CompareContentResult __instance__ = new CompareContentResult(lineComparisonResults);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompareContentResult o) {
            Builder copiedBuilder = lineComparisonResults(o.getLineComparisonResults());
