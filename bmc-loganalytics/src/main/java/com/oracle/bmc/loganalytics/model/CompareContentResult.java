...
public final class CompareContentResult extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public Builder lineComparisonResults(
            ...
            this.lineComparisonResults = lineComparisonResults;
            this.__explicitlySet__.add("lineComparisonResults");
            return this;
        }
        ...
        public CompareContentResult build() {
            CompareContentResult model = new CompareContentResult(this.lineComparisonResults);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompareContentResult model) {
            if (model.wasPropertyExplicitlySet("lineComparisonResults")) {
                this.lineComparisonResults(model.getLineComparisonResults());
            }
            return this;
        }
    }
