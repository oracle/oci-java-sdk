...
public class DeleteUploadFileResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteUploadFileResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteUploadFileResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteUploadFileResponse o) {
         ...
         */
        @Override
        public DeleteUploadFileResponse build() {
            return new DeleteUploadFileResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    opcDeletedLogCount,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteUploadFileResponse)) {
            return false;
        }

        DeleteUploadFileResponse other = (DeleteUploadFileResponse) o;
