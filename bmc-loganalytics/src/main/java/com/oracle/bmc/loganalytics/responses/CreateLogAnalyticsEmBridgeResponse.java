...
public class CreateLogAnalyticsEmBridgeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogAnalyticsEmBridgeResponse)) {
            return false;
        }

        CreateLogAnalyticsEmBridgeResponse other = (CreateLogAnalyticsEmBridgeResponse) o;
