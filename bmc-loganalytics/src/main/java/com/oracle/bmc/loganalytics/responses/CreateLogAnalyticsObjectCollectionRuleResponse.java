...
public class CreateLogAnalyticsObjectCollectionRuleResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogAnalyticsObjectCollectionRuleResponse)) {
            return false;
        }

        CreateLogAnalyticsObjectCollectionRuleResponse other =
                (CreateLogAnalyticsObjectCollectionRuleResponse) o;
