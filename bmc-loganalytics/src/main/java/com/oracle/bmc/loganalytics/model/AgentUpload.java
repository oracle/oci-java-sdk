...
@lombok.Value
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = AgentUpload.Builder.class)
...
public class AgentUpload {
    ...
    public static class Builder {
        ...
        public AgentUpload build() {
            AgentUpload __instance__ = new AgentUpload(name);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AgentUpload o) {
