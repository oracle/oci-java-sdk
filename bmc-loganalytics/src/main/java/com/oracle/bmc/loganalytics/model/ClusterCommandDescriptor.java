...
/**
 * Command descriptor for querylanguage CLUSTER command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ClusterCommandDescriptor.Builder.class)
...
public final class ClusterCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public ClusterCommandDescriptor build() {
            ClusterCommandDescriptor model =
                    new ClusterCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ClusterCommandDescriptor model) {
    ...
    @Deprecated
    public ClusterCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ClusterCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClusterCommandDescriptor)) {
            return false;
        }

        ClusterCommandDescriptor other = (ClusterCommandDescriptor) o;
