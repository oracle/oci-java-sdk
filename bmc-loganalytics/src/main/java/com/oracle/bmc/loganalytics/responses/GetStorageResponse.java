...
public class GetStorageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetStorageResponse(
            ...
            String opcRequestId,
            String etag,
            com.oracle.bmc.loganalytics.model.Storage storage) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetStorageResponse> {
         ...
         */
        @Override
        public Builder copy(GetStorageResponse o) {
        ...
        public GetStorageResponse build() {
            return new GetStorageResponse(__httpStatusCode__, headers, opcRequestId, etag, storage);
        }
    }
