...
/**
 * Command descriptor for querylanguage XMLEXTRACT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = XmlExtractCommandDescriptor.Builder.class)
...
public final class XmlExtractCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public XmlExtractCommandDescriptor build() {
            XmlExtractCommandDescriptor model =
                    new XmlExtractCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(XmlExtractCommandDescriptor model) {
    ...
    @Deprecated
    public XmlExtractCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("XmlExtractCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof XmlExtractCommandDescriptor)) {
            return false;
        }

        XmlExtractCommandDescriptor other = (XmlExtractCommandDescriptor) o;
