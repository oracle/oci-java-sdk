...
public class ListSourceMetaFunctionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsMetaFunctionCollection
            getLogAnalyticsMetaFunctionCollection() {
        return logAnalyticsMetaFunctionCollection;
    }
    ...
    private ListSourceMetaFunctionsResponse(
            ...
            String opcNextPage,
            String opcRequestId,
            com.oracle.bmc.loganalytics.model.LogAnalyticsMetaFunctionCollection
                    logAnalyticsMetaFunctionCollection) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder logAnalyticsMetaFunctionCollection(
                com.oracle.bmc.loganalytics.model.LogAnalyticsMetaFunctionCollection
                        logAnalyticsMetaFunctionCollection) {
            this.logAnalyticsMetaFunctionCollection = logAnalyticsMetaFunctionCollection;
            return this;
         ...
         */
        @Override
        public Builder copy(ListSourceMetaFunctionsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcPrevPage(o.getOpcPrevPage());
            opcNextPage(o.getOpcNextPage());
            opcRequestId(o.getOpcRequestId());
            logAnalyticsMetaFunctionCollection(o.getLogAnalyticsMetaFunctionCollection());
        ...
        public ListSourceMetaFunctionsResponse build() {
            return new ListSourceMetaFunctionsResponse(
                    __httpStatusCode__,
                    headers,
                    opcPrevPage,
                    opcNextPage,
    ...
    public String toString() {
        ...
        sb.append(",logAnalyticsMetaFunctionCollection=")
                .append(String.valueOf(logAnalyticsMetaFunctionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSourceMetaFunctionsResponse)) {
            return false;
        }

        ListSourceMetaFunctionsResponse other = (ListSourceMetaFunctionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.logAnalyticsMetaFunctionCollection,
                        other.logAnalyticsMetaFunctionCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.logAnalyticsMetaFunctionCollection == null
                                ? 43
                                : this.logAnalyticsMetaFunctionCollection.hashCode());
        return result;
    }
}
