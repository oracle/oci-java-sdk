...
public final class WorkRequest extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        private LogAnalyticsOperationTypes operationType;
         ...
         * @return this builder
         **/
        public Builder operationType(LogAnalyticsOperationTypes operationType) {
            this.operationType = operationType;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("operationType")
    private final LogAnalyticsOperationTypes operationType;

    /**
     * Type of the work request
     * @return the value
     **/
    public LogAnalyticsOperationTypes getOperationType() {
