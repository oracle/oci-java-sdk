...
/**
 * Command descriptor for querylanguage DISTINCT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistinctCommandDescriptor.Builder.class)
...
public final class DistinctCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public DistinctCommandDescriptor build() {
            DistinctCommandDescriptor model =
                    new DistinctCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistinctCommandDescriptor model) {
    ...
    @Deprecated
    public DistinctCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistinctCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistinctCommandDescriptor)) {
            return false;
        }

        DistinctCommandDescriptor other = (DistinctCommandDescriptor) o;
