...
public class GetSourceSummaryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSourceSummaryResponse> {
         ...
         */
        @Override
        public Builder copy(GetSourceSummaryResponse o) {
        ...
        public GetSourceSummaryResponse build() {
            return new GetSourceSummaryResponse(
                    __httpStatusCode__, headers, opcRequestId, sourceSummaryReport);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",sourceSummaryReport=").append(String.valueOf(sourceSummaryReport));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetSourceSummaryResponse)) {
            return false;
        }

        GetSourceSummaryResponse other = (GetSourceSummaryResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.sourceSummaryReport, other.sourceSummaryReport);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.sourceSummaryReport == null
                                ? 43
                                : this.sourceSummaryReport.hashCode());
        return result;
    }
}
