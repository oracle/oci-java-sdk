...
public class UpdatePreferencesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdatePreferencesResponse> {
        ...
        public UpdatePreferencesResponse build() {
            return new UpdatePreferencesResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdatePreferencesResponse)) {
            return false;
        }

        UpdatePreferencesResponse other = (UpdatePreferencesResponse) o;
