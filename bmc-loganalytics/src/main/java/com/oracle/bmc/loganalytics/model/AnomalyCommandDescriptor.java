...
/**
 * Command descriptor for querylanguage ANOMALY command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AnomalyCommandDescriptor.Builder.class)
...
public final class AnomalyCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public AnomalyCommandDescriptor build() {
            AnomalyCommandDescriptor model =
                    new AnomalyCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AnomalyCommandDescriptor model) {
    ...
    @Deprecated
    public AnomalyCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AnomalyCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AnomalyCommandDescriptor)) {
            return false;
        }

        AnomalyCommandDescriptor other = (AnomalyCommandDescriptor) o;
