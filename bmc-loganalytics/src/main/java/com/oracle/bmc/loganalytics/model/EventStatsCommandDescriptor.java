...
/**
 * Command descriptor for querylanguage EVENTSTATS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EventStatsCommandDescriptor.Builder.class)
...
public final class EventStatsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public EventStatsCommandDescriptor build() {
            EventStatsCommandDescriptor model =
                    new EventStatsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EventStatsCommandDescriptor model) {
    ...
    @Deprecated
    public EventStatsCommandDescriptor(
    ...
    /**
     * Statistical functions specified in the query string. Atleast 1 is required for a EVENTSTATS
     * command.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("functions")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EventStatsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventStatsCommandDescriptor)) {
            return false;
        }

        EventStatsCommandDescriptor other = (EventStatsCommandDescriptor) o;
