...
/**
 * Command descriptor for querylanguage COMPARE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CompareCommandDescriptor.Builder.class)
...
public final class CompareCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public CompareCommandDescriptor build() {
            CompareCommandDescriptor model =
                    new CompareCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompareCommandDescriptor model) {
    ...
    @Deprecated
    public CompareCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompareCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompareCommandDescriptor)) {
            return false;
        }

        CompareCommandDescriptor other = (CompareCommandDescriptor) o;
