...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/UpdateIngestTimeRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateIngestTimeRuleRequest.
 */
...
public class UpdateIngestTimeRuleRequest
    ...
    public static class Builder
        ...
        public UpdateIngestTimeRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateIngestTimeRuleRequest(namespaceName, ingestTimeRuleId, updateIngestTimeRuleDetails, ifMatch, opcRequestId);
        }
    }
