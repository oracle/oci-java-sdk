...
public class ParserSummaryReport {
    ...
    public static class Builder {
        ...
        public ParserSummaryReport build() {
            ParserSummaryReport __instance__ = new ParserSummaryReport(nonOobCount, oobCount);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ParserSummaryReport o) {
            Builder copiedBuilder = nonOobCount(o.getNonOobCount()).oobCount(o.getOobCount());
