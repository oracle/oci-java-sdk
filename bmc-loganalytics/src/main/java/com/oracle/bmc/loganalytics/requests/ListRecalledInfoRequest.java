...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListRecalledInfoExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListRecalledInfoRequest.
 */
...
public class ListRecalledInfoRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListRecalledInfoRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListRecalledInfoRequest(namespaceName, opcRequestId, limit, page, sortBy, sortOrder, timeDataStartedGreaterThanOrEqual, timeDataEndedLessThan, logSets);
        }
    }
