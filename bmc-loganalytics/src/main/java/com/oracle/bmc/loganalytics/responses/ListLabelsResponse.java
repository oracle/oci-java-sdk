...
public class ListLabelsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListLabelsResponse> {
         ...
         */
        @Override
        public Builder copy(ListLabelsResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListLabelsResponse)) {
            return false;
        }

        ListLabelsResponse other = (ListLabelsResponse) o;
