...
/**
 * Command descriptor for querylanguage DEMOMODE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DemoModeCommandDescriptor.Builder.class)
...
public final class DemoModeCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public DemoModeCommandDescriptor build() {
            DemoModeCommandDescriptor model =
                    new DemoModeCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DemoModeCommandDescriptor model) {
    ...
    @Deprecated
    public DemoModeCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DemoModeCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DemoModeCommandDescriptor)) {
            return false;
        }

        DemoModeCommandDescriptor other = (DemoModeCommandDescriptor) o;
