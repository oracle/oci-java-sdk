...
public class UpsertLogAnalyticsAssociationDetails {
    ...
    public static class Builder {
        ...
        public UpsertLogAnalyticsAssociationDetails build() {
            UpsertLogAnalyticsAssociationDetails __instance__ =
                    new UpsertLogAnalyticsAssociationDetails(compartmentId, items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpsertLogAnalyticsAssociationDetails o) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    java.util.List<UpsertLogAnalyticsAssociation> items;
