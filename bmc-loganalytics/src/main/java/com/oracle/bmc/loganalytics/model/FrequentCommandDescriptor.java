...
/**
 * Command descriptor for querylanguage FREQUENT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FrequentCommandDescriptor.Builder.class)
...
public final class FrequentCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public FrequentCommandDescriptor build() {
            FrequentCommandDescriptor model =
                    new FrequentCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FrequentCommandDescriptor model) {
    ...
    @Deprecated
    public FrequentCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FrequentCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FrequentCommandDescriptor)) {
            return false;
        }

        FrequentCommandDescriptor other = (FrequentCommandDescriptor) o;
