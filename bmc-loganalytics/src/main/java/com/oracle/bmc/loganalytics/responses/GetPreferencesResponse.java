...
public class GetPreferencesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceCollection
            getLogAnalyticsPreferenceCollection() {
        return logAnalyticsPreferenceCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetPreferencesResponse> {
         ...
         * @return this builder
         */
        public Builder logAnalyticsPreferenceCollection(
                com.oracle.bmc.loganalytics.model.LogAnalyticsPreferenceCollection
                        logAnalyticsPreferenceCollection) {
            this.logAnalyticsPreferenceCollection = logAnalyticsPreferenceCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",logAnalyticsPreferenceCollection=")
                .append(String.valueOf(logAnalyticsPreferenceCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetPreferencesResponse)) {
            return false;
        }

        GetPreferencesResponse other = (GetPreferencesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.logAnalyticsPreferenceCollection,
                        other.logAnalyticsPreferenceCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.logAnalyticsPreferenceCollection == null
                                ? 43
                                : this.logAnalyticsPreferenceCollection.hashCode());
        return result;
    }
}
