...
public class ListLogSetsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder logSetCollection(
                com.oracle.bmc.loganalytics.model.LogSetCollection logSetCollection) {
            this.logSetCollection = logSetCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",logSetCollection=").append(String.valueOf(logSetCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListLogSetsResponse)) {
            return false;
        }

        ListLogSetsResponse other = (ListLogSetsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.logSetCollection, other.logSetCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.logSetCollection == null ? 43 : this.logSetCollection.hashCode());
        return result;
    }
}
