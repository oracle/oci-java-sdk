...
/**
 * Command descriptor for querylanguage SEQUENCE command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SequenceCommandDescriptor.Builder.class)
...
public final class SequenceCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public SequenceCommandDescriptor build() {
            SequenceCommandDescriptor model =
                    new SequenceCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SequenceCommandDescriptor model) {
    ...
    @Deprecated
    public SequenceCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SequenceCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SequenceCommandDescriptor)) {
            return false;
        }

        SequenceCommandDescriptor other = (SequenceCommandDescriptor) o;
