...
/**
 * LogAnalytics Lookup Collection <br>
...
public final class LogAnalyticsLookupCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public LogAnalyticsLookupCollection(java.util.List<LogAnalyticsLookup> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public LogAnalyticsLookupCollection build() {
            LogAnalyticsLookupCollection model = new LogAnalyticsLookupCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LogAnalyticsLookupCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogAnalyticsLookupCollection)) {
            return false;
        }

        LogAnalyticsLookupCollection other = (LogAnalyticsLookupCollection) o;
