...
public class UpdateLookupDataResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateLookupDataResponse> {
        ...
        public UpdateLookupDataResponse build() {
            return new UpdateLookupDataResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLookupDataResponse)) {
            return false;
        }

        UpdateLookupDataResponse other = (UpdateLookupDataResponse) o;
