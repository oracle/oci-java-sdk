...
/**
 * Command descriptor for querylanguage EXTRACT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExtractCommandDescriptor.Builder.class)
...
public final class ExtractCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public ExtractCommandDescriptor build() {
            ExtractCommandDescriptor model =
                    new ExtractCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExtractCommandDescriptor model) {
    ...
    @Deprecated
    public ExtractCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExtractCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExtractCommandDescriptor)) {
            return false;
        }

        ExtractCommandDescriptor other = (ExtractCommandDescriptor) o;
