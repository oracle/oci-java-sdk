...
/**
 * Command descriptor for querylanguage LINKDETAILS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LinkDetailsCommandDescriptor.Builder.class)
...
public final class LinkDetailsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public LinkDetailsCommandDescriptor build() {
            LinkDetailsCommandDescriptor model =
                    new LinkDetailsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LinkDetailsCommandDescriptor model) {
    ...
    @Deprecated
    public LinkDetailsCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LinkDetailsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LinkDetailsCommandDescriptor)) {
            return false;
        }

        LinkDetailsCommandDescriptor other = (LinkDetailsCommandDescriptor) o;
