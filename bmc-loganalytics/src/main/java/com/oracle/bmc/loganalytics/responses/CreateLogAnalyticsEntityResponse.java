...
public class CreateLogAnalyticsEntityResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateLogAnalyticsEntityResponse o) {
         ...
         */
        public CreateLogAnalyticsEntityResponse build() {
            return new CreateLogAnalyticsEntityResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateLogAnalyticsEntityResponse)) {
            return false;
        }

        CreateLogAnalyticsEntityResponse other = (CreateLogAnalyticsEntityResponse) o;
