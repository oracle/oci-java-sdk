...
/**
 * Command descriptor for querylanguage LOOKUP command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = LookupCommandDescriptor.Builder.class)
...
public final class LookupCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public LookupCommandDescriptor build() {
            LookupCommandDescriptor model =
                    new LookupCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LookupCommandDescriptor model) {
    ...
    @Deprecated
    public LookupCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("LookupCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LookupCommandDescriptor)) {
            return false;
        }

        LookupCommandDescriptor other = (LookupCommandDescriptor) o;
