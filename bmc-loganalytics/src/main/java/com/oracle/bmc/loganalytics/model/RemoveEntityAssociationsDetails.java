...
/**
 * Information about the associations to be deleted between source entity and other existing
 * destination entities. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemoveEntityAssociationsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class RemoveEntityAssociationsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"associationEntities"})
    public RemoveEntityAssociationsDetails(java.util.List<String> associationEntities) {
        super();
    ...
    public static class Builder {
        ...
        public RemoveEntityAssociationsDetails build() {
            RemoveEntityAssociationsDetails model =
                    new RemoveEntityAssociationsDetails(this.associationEntities);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveEntityAssociationsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveEntityAssociationsDetails)) {
            return false;
        }

        RemoveEntityAssociationsDetails other = (RemoveEntityAssociationsDetails) o;
