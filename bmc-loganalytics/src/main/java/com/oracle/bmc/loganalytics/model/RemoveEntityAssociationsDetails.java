...
public final class RemoveEntityAssociationsDetails {
    ...
    public static class Builder {
        ...
        public RemoveEntityAssociationsDetails build() {
            RemoveEntityAssociationsDetails __instance__ =
                    new RemoveEntityAssociationsDetails(associationEntities);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemoveEntityAssociationsDetails o) {
