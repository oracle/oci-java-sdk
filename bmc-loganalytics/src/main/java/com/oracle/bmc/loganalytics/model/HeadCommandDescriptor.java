...
/**
 * Command descriptor for querylanguage HEAD command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = HeadCommandDescriptor.Builder.class)
...
public final class HeadCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public HeadCommandDescriptor build() {
            HeadCommandDescriptor model =
                    new HeadCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HeadCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HeadCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HeadCommandDescriptor)) {
            return false;
        }

        HeadCommandDescriptor other = (HeadCommandDescriptor) o;
