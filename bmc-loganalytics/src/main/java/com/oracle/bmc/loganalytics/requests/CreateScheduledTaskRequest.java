...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/CreateScheduledTaskExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateScheduledTaskRequest.
 */
...
public class CreateScheduledTaskRequest
    ...
    public static class Builder
        ...
        public Builder copy(CreateScheduledTaskRequest o) {
            ...
            createScheduledTaskDetails(o.getCreateScheduledTaskDetails());
        ...
        /**
         * Build the instance of CreateScheduledTaskRequest as configured by this builder
         *
         ...
         *
         * @return instance of CreateScheduledTaskRequest
         */
        public CreateScheduledTaskRequest build() {
            CreateScheduledTaskRequest request = buildWithoutInvocationCallback();
        ...
        public CreateScheduledTaskRequest buildWithoutInvocationCallback() {
            ...
            request.createScheduledTaskDetails = createScheduledTaskDetails;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new CreateScheduledTaskRequest(namespaceName, createScheduledTaskDetails, opcRequestId, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createScheduledTaskDetails=")
                .append(String.valueOf(this.createScheduledTaskDetails));
    ...
    public boolean equals(Object o) {
        ...
        CreateScheduledTaskRequest other = (CreateScheduledTaskRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.namespaceName, other.namespaceName)
                && java.util.Objects.equals(
                        this.createScheduledTaskDetails, other.createScheduledTaskDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createScheduledTaskDetails == null
                                ? 43
                                : this.createScheduledTaskDetails.hashCode());
