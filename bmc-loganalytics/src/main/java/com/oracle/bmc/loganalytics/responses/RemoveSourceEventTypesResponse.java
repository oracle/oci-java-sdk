...
public class RemoveSourceEventTypesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveSourceEventTypesResponse)) {
            return false;
        }

        RemoveSourceEventTypesResponse other = (RemoveSourceEventTypesResponse) o;
