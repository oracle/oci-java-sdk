...
public class ExportCustomContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ExportCustomContentResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExportCustomContentResponse)) {
            return false;
        }

        ExportCustomContentResponse other = (ExportCustomContentResponse) o;
