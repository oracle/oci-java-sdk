...
/**
 * Command descriptor for querylanguage TAIL command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = TailCommandDescriptor.Builder.class)
...
public final class TailCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public TailCommandDescriptor build() {
            TailCommandDescriptor model =
                    new TailCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TailCommandDescriptor model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("TailCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TailCommandDescriptor)) {
            return false;
        }

        TailCommandDescriptor other = (TailCommandDescriptor) o;
