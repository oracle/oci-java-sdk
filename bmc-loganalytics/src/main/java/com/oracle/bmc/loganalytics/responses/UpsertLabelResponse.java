...
public class UpsertLabelResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpsertLabelResponse> {
         ...
         */
        @Override
        public Builder copy(UpsertLabelResponse o) {
         ...
         */
        @Override
        public UpsertLabelResponse build() {
            return new UpsertLabelResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, logAnalyticsLabel);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpsertLabelResponse)) {
            return false;
        }

        UpsertLabelResponse other = (UpsertLabelResponse) o;
