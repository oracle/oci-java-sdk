...
public class ChangeLogAnalyticsObjectCollectionRuleCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeLogAnalyticsObjectCollectionRuleCompartmentResponse)) {
            return false;
        }

        ChangeLogAnalyticsObjectCollectionRuleCompartmentResponse other =
                (ChangeLogAnalyticsObjectCollectionRuleCompartmentResponse) o;
