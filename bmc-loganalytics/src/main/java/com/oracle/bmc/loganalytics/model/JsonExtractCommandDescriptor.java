...
/**
 * Command descriptor for querylanguage JSONEXTRACT command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = JsonExtractCommandDescriptor.Builder.class)
...
public final class JsonExtractCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public JsonExtractCommandDescriptor build() {
            JsonExtractCommandDescriptor model =
                    new JsonExtractCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JsonExtractCommandDescriptor model) {
    ...
    @Deprecated
    public JsonExtractCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("JsonExtractCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JsonExtractCommandDescriptor)) {
            return false;
        }

        JsonExtractCommandDescriptor other = (JsonExtractCommandDescriptor) o;
