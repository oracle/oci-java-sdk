...
public final class LogAnalyticsWarningCollection
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public LogAnalyticsWarningCollection(java.util.List<LogAnalyticsWarning> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public LogAnalyticsWarningCollection build() {
            LogAnalyticsWarningCollection model = new LogAnalyticsWarningCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LogAnalyticsWarningCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogAnalyticsWarningCollection)) {
            return false;
        }

        LogAnalyticsWarningCollection other = (LogAnalyticsWarningCollection) o;
