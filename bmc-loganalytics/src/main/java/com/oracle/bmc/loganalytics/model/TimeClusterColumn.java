...
public final class TimeClusterColumn extends AbstractColumn {
    ...
    public static class Builder {
        ...
        public TimeClusterColumn build() {
            TimeClusterColumn model =
                    new TimeClusterColumn(
                            this.displayName,
                            this.subSystem,
                            this.values,
                            this.isListOfValues,
    ...
    public TimeClusterColumn(
            ...
            java.util.List<AbstractColumn> groupByColumns,
            java.util.Map<String, TimeStatsCluster> clusters,
            java.util.List<TimeClusterDataColumn> series) {
        super(
                displayName,
                subSystem,
                values,
    ...
    public boolean equals(Object o) {
        ...
        TimeClusterColumn other = (TimeClusterColumn) o;
        return java.util.Objects.equals(this.intervalGap, other.intervalGap)
                ...
                && java.util.Objects.equals(this.groupByColumns, other.groupByColumns)
