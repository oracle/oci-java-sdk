...
public class ChangeLogAnalyticsLogGroupCompartmentResponse
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeLogAnalyticsLogGroupCompartmentResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeLogAnalyticsLogGroupCompartmentResponse)) {
            return false;
        }

        ChangeLogAnalyticsLogGroupCompartmentResponse other =
                (ChangeLogAnalyticsLogGroupCompartmentResponse) o;
