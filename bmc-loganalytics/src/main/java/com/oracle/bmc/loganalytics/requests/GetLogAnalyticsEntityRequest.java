...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/GetLogAnalyticsEntityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetLogAnalyticsEntityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200601")
public class GetLogAnalyticsEntityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetLogAnalyticsEntityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetLogAnalyticsEntityRequest o) {
         ...
         *
         * @return instance of GetLogAnalyticsEntityRequest
         */
        public GetLogAnalyticsEntityRequest build() {
            GetLogAnalyticsEntityRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetLogAnalyticsEntityRequest
         */
        public GetLogAnalyticsEntityRequest buildWithoutInvocationCallback() {
            GetLogAnalyticsEntityRequest request = new GetLogAnalyticsEntityRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetLogAnalyticsEntityRequest)) {
            return false;
        }

        GetLogAnalyticsEntityRequest other = (GetLogAnalyticsEntityRequest) o;
