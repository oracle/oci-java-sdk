...
public class UpdateLookupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateLookupResponse> {
         ...
         */
        @Override
        public UpdateLookupResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateLookupResponse)) {
            return false;
        }
