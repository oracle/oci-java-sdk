...
public class ListEffectivePropertiesRequest
    ...
    public static class Builder
        ...
        public ListEffectivePropertiesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListEffectivePropertiesRequest(namespaceName, agentId, sourceName, isIncludePatterns, entityId, patternId, patternIdLong, name, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
