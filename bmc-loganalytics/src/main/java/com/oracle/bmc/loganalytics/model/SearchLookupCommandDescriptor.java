...
/**
 * Command descriptor for querylanguage SEARCHLOOKUP command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = SearchLookupCommandDescriptor.Builder.class)
...
public final class SearchLookupCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public SearchLookupCommandDescriptor build() {
            SearchLookupCommandDescriptor model =
                    new SearchLookupCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SearchLookupCommandDescriptor model) {
    ...
    @Deprecated
    public SearchLookupCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SearchLookupCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchLookupCommandDescriptor)) {
            return false;
        }

        SearchLookupCommandDescriptor other = (SearchLookupCommandDescriptor) o;
