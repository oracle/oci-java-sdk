...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/loganalytics/ListSourceAssociationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListSourceAssociationsRequest.
 */
...
public class ListSourceAssociationsRequest
    ...
    public static class Builder
        ...
        public ListSourceAssociationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListSourceAssociationsRequest(namespaceName, sourceName, compartmentId, entityId, entityName, lifeCycleState, isShowTotal, opcRequestId, limit, page, sortOrder, sortBy);
        }
    }
