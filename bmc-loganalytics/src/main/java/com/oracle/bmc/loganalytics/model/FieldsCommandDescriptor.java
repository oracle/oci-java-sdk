...
/**
 * Command descriptor for querylanguage FIELDS command. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = FieldsCommandDescriptor.Builder.class)
...
public final class FieldsCommandDescriptor extends AbstractCommandDescriptor {
    ...
    public static class Builder {
        ...
        public FieldsCommandDescriptor build() {
            FieldsCommandDescriptor model =
                    new FieldsCommandDescriptor(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FieldsCommandDescriptor model) {
    ...
    @Deprecated
    public FieldsCommandDescriptor(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FieldsCommandDescriptor(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FieldsCommandDescriptor)) {
            return false;
        }

        FieldsCommandDescriptor other = (FieldsCommandDescriptor) o;
