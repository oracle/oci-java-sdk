...
public enum ResourceTypes {
    ...
    static {
        ...
        for (ResourceTypes v : ResourceTypes.values()) {
    ...
    public static ResourceTypes create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'ResourceTypes', returning UnknownEnumValue",
                key);
