...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/operatoraccesscontrol/ListInteractionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListInteractionsRequest.
 */
...
public class ListInteractionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of ListInteractionsRequest
         */
        public ListInteractionsRequest buildWithoutInvocationCallback() {
            ListInteractionsRequest request = new ListInteractionsRequest();
            request.accessRequestId = accessRequestId;
            request.limit = limit;
            request.page = page;
            request.opcRequestId = opcRequestId;
            return request;
            // new ListInteractionsRequest(accessRequestId, limit, page, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInteractionsRequest)) {
            return false;
        }

        ListInteractionsRequest other = (ListInteractionsRequest) o;
