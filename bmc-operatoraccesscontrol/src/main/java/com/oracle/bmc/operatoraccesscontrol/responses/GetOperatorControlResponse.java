...
public class GetOperatorControlResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetOperatorControlResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOperatorControlResponse)) {
            return false;
        }

        GetOperatorControlResponse other = (GetOperatorControlResponse) o;
