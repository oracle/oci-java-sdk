...
public interface OperatorActionsAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<GetOperatorActionResponse> getOperatorAction(
            GetOperatorActionRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            GetOperatorActionRequest, GetOperatorActionResponse>
                    handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOperatorActionsResponse> listOperatorActions(
