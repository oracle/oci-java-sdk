...
/**
 * While creating the operator control, specify how operator actions are approved and the users who
 * have the privilege of approving the operator actions associated with the Operator Control.
 *
 * <p>You must specify which operator actions must be pre-approved. The rest of the operator actions
 * associated with the Operator Control will require an explicit approval from the users selected
 * either through the approver groups or individually.
 *
 * <p>You must name your Operator Control appropriately so it reflects the resources that will be
 * governed by the Operator Control. Neither the Operator Controls nor their assignments to
 * resources are visible to the Oracle operators. <br>
...
public final class CreateOperatorControlDetails
    ...
    public static class Builder {
         ...
         * governed by this operator control will be auto-approved if the access request only
         * contain operator actions in the pre-approved list.
         */
        ...
        public CreateOperatorControlDetails build() {
            CreateOperatorControlDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOperatorControlDetails model) {
    ...
    /**
     * List of users who can approve an access request associated with a resource governed by this
     * operator control.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approversList")
    ...
    /**
     * List of user groups who can approve an access request associated with a resource governed by
     * this operator control.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approverGroupsList")
     ...
     * this operator control will be auto-approved if the access request only contain operator
     * actions in the pre-approved list.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("preApprovedOpActionList")
