...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/operatoraccesscontrol/ApproveAccessRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ApproveAccessRequestRequest.
 */
...
public class ApproveAccessRequestRequest
    ...
    public static class Builder
        ...
        public ApproveAccessRequestRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ApproveAccessRequestRequest(accessRequestId, approveAccessRequestDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
