...
public class UpdateOperatorControlResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateOperatorControlResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateOperatorControlResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateOperatorControlResponse o) {
         ...
         */
        @Override
        public UpdateOperatorControlResponse build() {
            return new UpdateOperatorControlResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateOperatorControlResponse)) {
            return false;
        }

        UpdateOperatorControlResponse other = (UpdateOperatorControlResponse) o;
