...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/operatoraccesscontrol/ReviewAccessRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ReviewAccessRequestRequest.
 */
...
public class ReviewAccessRequestRequest
     ...
     * Details regarding the approval of an access request created by the operator.
     */
    public com.oracle.bmc.operatoraccesscontrol.model.ReviewAccessRequestDetails
            getReviewAccessRequestDetails() {
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.operatoraccesscontrol.model.ReviewAccessRequestDetails
                reviewAccessRequestDetails = null;

        /**
         * Details regarding the approval of an access request created by the operator.
         * @param reviewAccessRequestDetails the value to set
         * @return this builder instance
         */
        public Builder reviewAccessRequestDetails(
                com.oracle.bmc.operatoraccesscontrol.model.ReviewAccessRequestDetails
                        reviewAccessRequestDetails) {
        ...
        public ReviewAccessRequestRequest buildWithoutInvocationCallback() {
            ...
            request.reviewAccessRequestDetails = reviewAccessRequestDetails;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new ReviewAccessRequestRequest(accessRequestId, reviewAccessRequestDetails, opcRetryToken, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",reviewAccessRequestDetails=")
                .append(String.valueOf(this.reviewAccessRequestDetails));
    ...
    public boolean equals(Object o) {
        ...
        ReviewAccessRequestRequest other = (ReviewAccessRequestRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.accessRequestId, other.accessRequestId)
                && java.util.Objects.equals(
                        this.reviewAccessRequestDetails, other.reviewAccessRequestDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.reviewAccessRequestDetails == null
                                ? 43
                                : this.reviewAccessRequestDetails.hashCode());
        result =
                (result * PRIME)
