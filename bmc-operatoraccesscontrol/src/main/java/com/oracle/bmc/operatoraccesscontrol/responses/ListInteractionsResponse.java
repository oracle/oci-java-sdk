...
public class ListInteractionsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.operatoraccesscontrol.model.InteractionCollection
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListInteractionsResponse> {
         ...
         * @return this builder
         */
        public Builder interactionCollection(
                com.oracle.bmc.operatoraccesscontrol.model.InteractionCollection
                        interactionCollection) {
            this.interactionCollection = interactionCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",interactionCollection=").append(String.valueOf(interactionCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListInteractionsResponse)) {
            return false;
        }

        ListInteractionsResponse other = (ListInteractionsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.interactionCollection, other.interactionCollection);
    }
        ...
        result =
                (result * PRIME)
                        + (this.interactionCollection == null
                                ? 43
                                : this.interactionCollection.hashCode());
        return result;
    }
}
