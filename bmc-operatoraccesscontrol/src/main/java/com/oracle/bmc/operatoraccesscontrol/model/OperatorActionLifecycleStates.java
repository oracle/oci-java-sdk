...
public enum OperatorActionLifecycleStates implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    static {
        ...
        for (OperatorActionLifecycleStates v : OperatorActionLifecycleStates.values()) {
    ...
    OperatorActionLifecycleStates(String value) {
        this.value = value;
    }
    ...
    public static OperatorActionLifecycleStates create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'OperatorActionLifecycleStates', returning UnknownEnumValue",
                key);
