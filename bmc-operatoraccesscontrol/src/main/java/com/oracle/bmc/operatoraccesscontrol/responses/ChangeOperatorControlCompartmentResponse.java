...
public class ChangeOperatorControlCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ChangeOperatorControlCompartmentResponse(
    ...
    public static class Builder {
        ...
        public ChangeOperatorControlCompartmentResponse build() {
            return new ChangeOperatorControlCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeOperatorControlCompartmentResponse)) {
            return false;
        }

        ChangeOperatorControlCompartmentResponse other =
                (ChangeOperatorControlCompartmentResponse) o;
