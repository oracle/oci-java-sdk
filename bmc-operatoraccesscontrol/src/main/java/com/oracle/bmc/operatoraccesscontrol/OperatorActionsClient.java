...
public class OperatorActionsClient implements OperatorActions {
    /**
     ...
     */
    protected OperatorActionsClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
        ...
        this.paginators = new OperatorActionsPaginators(this);
    ...
    public static class Builder
        ...
        public OperatorActionsClient build(
            ...
            return new OperatorActionsClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public GetOperatorActionResponse getOperatorAction(GetOperatorActionRequest request) {
        LOG.trace("Called getOperatorAction");
        final GetOperatorActionRequest interceptedRequest =
    ...
    public ListOperatorActionsResponse listOperatorActions(ListOperatorActionsRequest request) {
        LOG.trace("Called listOperatorActions");
        final ListOperatorActionsRequest interceptedRequest =
