...
/**
 * Summary of why the already approved access request was revoked. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RevokeAccessRequestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class RevokeAccessRequestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"approverComment"})
    public RevokeAccessRequestDetails(String approverComment) {
        super();
    ...
    public static class Builder {
        ...
        public RevokeAccessRequestDetails build() {
            RevokeAccessRequestDetails model = new RevokeAccessRequestDetails(this.approverComment);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RevokeAccessRequestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RevokeAccessRequestDetails)) {
            return false;
        }

        RevokeAccessRequestDetails other = (RevokeAccessRequestDetails) o;
