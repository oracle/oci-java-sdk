...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/operatoraccesscontrol/RejectAccessRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RejectAccessRequestRequest.
 */
...
public class RejectAccessRequestRequest
    ...
    public static class Builder
        ...
        public Builder rejectAccessRequestDetails(
                com.oracle.bmc.operatoraccesscontrol.model.RejectAccessRequestDetails
                        rejectAccessRequestDetails) {
            this.rejectAccessRequestDetails = rejectAccessRequestDetails;
            return this;
        }
        ...
        public Builder copy(RejectAccessRequestRequest o) {
            ...
            rejectAccessRequestDetails(o.getRejectAccessRequestDetails());
         ...
         */
        public RejectAccessRequestRequest build() {
            RejectAccessRequestRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of RejectAccessRequestRequest
         */
        public RejectAccessRequestRequest buildWithoutInvocationCallback() {
            RejectAccessRequestRequest request = new RejectAccessRequestRequest();
            request.accessRequestId = accessRequestId;
            request.rejectAccessRequestDetails = rejectAccessRequestDetails;
    ...
    public String toString() {
        ...
        sb.append(",rejectAccessRequestDetails=")
                .append(String.valueOf(this.rejectAccessRequestDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RejectAccessRequestRequest)) {
            return false;
        }

        RejectAccessRequestRequest other = (RejectAccessRequestRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.accessRequestId, other.accessRequestId)
                && java.util.Objects.equals(
                        this.rejectAccessRequestDetails, other.rejectAccessRequestDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.rejectAccessRequestDetails == null
                                ? 43
                                : this.rejectAccessRequestDetails.hashCode());
        result =
                (result * PRIME)
