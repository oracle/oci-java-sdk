 ...
 * to any list operations of OperatorControl where multiple pages of data may be fetched. Two styles
...
public class OperatorControlPaginators {
     ...
     * listOperatorControls operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.operatoraccesscontrol.model.OperatorControlSummary} objects contained in
     * responses from the listOperatorControls operation. This iterable will fetch more data from
