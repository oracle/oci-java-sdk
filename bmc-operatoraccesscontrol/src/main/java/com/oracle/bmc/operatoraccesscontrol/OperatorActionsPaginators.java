 ...
 * to any list operations of OperatorActions where multiple pages of data may be fetched. Two styles
...
public class OperatorActionsPaginators {
     ...
     * listOperatorActions operation. This iterable will fetch more data from the server as needed.
     *
     ...
     * com.oracle.bmc.operatoraccesscontrol.model.OperatorActionSummary} objects contained in
     * responses from the listOperatorActions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
