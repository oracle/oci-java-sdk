...
public final class OperatorControlCollection
    ...
    public static class Builder {
        ...
        public OperatorControlCollection build() {
            OperatorControlCollection model = new OperatorControlCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OperatorControlCollection model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("OperatorControlCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperatorControlCollection)) {
            return false;
        }

        OperatorControlCollection other = (OperatorControlCollection) o;
