...
/**
 * Details for asking to provide more information to operators. <br>
...
public final class InteractionRequestDetails
    ...
    public static class Builder {
        ...
        public InteractionRequestDetails build() {
            InteractionRequestDetails model = new InteractionRequestDetails(this.moreInfoDetails);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(InteractionRequestDetails model) {
