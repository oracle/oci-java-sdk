...
public interface OperatorActions extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetOperatorAction
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListOperatorActions
     *     API.
     */
