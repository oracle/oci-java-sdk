...
public class OperatorControlClient implements OperatorControl {
     ...
     */
    protected OperatorControlClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeOperatorControlCompartmentResponse changeOperatorControlCompartment(
        ...
        LOG.trace("Called changeOperatorControlCompartment");
    ...
    public CreateOperatorControlResponse createOperatorControl(
        ...
        LOG.trace("Called createOperatorControl");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateOperatorControlDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteOperatorControlResponse deleteOperatorControl(
        ...
        LOG.trace("Called deleteOperatorControl");
    ...
    public GetOperatorControlResponse getOperatorControl(GetOperatorControlRequest request) {
        LOG.trace("Called getOperatorControl");
    ...
    public ListOperatorControlsResponse listOperatorControls(ListOperatorControlsRequest request) {
        LOG.trace("Called listOperatorControls");
    ...
    public UpdateOperatorControlResponse updateOperatorControl(
        ...
        LOG.trace("Called updateOperatorControl");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateOperatorControlDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
