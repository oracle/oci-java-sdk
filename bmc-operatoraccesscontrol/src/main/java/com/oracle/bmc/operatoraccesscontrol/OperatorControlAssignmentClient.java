...
public class OperatorControlAssignmentClient implements OperatorControlAssignment {
     ...
     */
    protected OperatorControlAssignmentClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeOperatorControlAssignmentCompartmentResponse
        ...
        LOG.trace("Called changeOperatorControlAssignmentCompartment");
    ...
    public CreateOperatorControlAssignmentResponse createOperatorControlAssignment(
        ...
        LOG.trace("Called createOperatorControlAssignment");
    ...
    public DeleteOperatorControlAssignmentResponse deleteOperatorControlAssignment(
        ...
        LOG.trace("Called deleteOperatorControlAssignment");
    ...
    public GetAssignmentValidationStatusResponse getAssignmentValidationStatus(
        ...
        LOG.trace("Called getAssignmentValidationStatus");
    ...
    public GetOperatorControlAssignmentResponse getOperatorControlAssignment(
        ...
        LOG.trace("Called getOperatorControlAssignment");
    ...
    public ListOperatorControlAssignmentsResponse listOperatorControlAssignments(
        ...
        LOG.trace("Called listOperatorControlAssignments");
    ...
    public UpdateOperatorControlAssignmentResponse updateOperatorControlAssignment(
        ...
        LOG.trace("Called updateOperatorControlAssignment");
    ...
    public ValidateOperatorAssignmentResponse validateOperatorAssignment(
        ...
        LOG.trace("Called validateOperatorAssignment");
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        ...
                        ib.getRequestUri().toString(),
                        "");
        java.util.function.Function<javax.ws.rs.core.Response, ValidateOperatorAssignmentResponse>
                transformer =
