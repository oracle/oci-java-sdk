...
/**
 * Operator Access Control enables you to grant, audit, or revoke the access Oracle has to your
 * Exadata Cloud@Customer infrastructure, and obtain audit reports of all actions taken by a human
 * operator, in a near real-time manner. <br>
...
public final class OperatorControl
    ...
    public static class Builder {
        ...
        /**
         * List of pre-approved operator actions. Access requests associated with a resource
         * governed by this operator control will be automatically approved if the access request
         * only contain operator actions in the pre-approved list.
         */
        ...
        /**
         * List of operator actions that need explicit approval. Any operator action not in the
         * pre-approved list will require explicit approval. Access requests associated with a
         * resource governed by this operator control will be require explicit approval if the
         * access request contains any operator action in this list.
         */
        ...
        /**
         * Whether all the operator actions have been pre-approved. If yes, all access requests
         * associated with a resource governed by this operator control will be auto-approved.
         */
         ...
         * in the system, so that you can still audit operator actions associated with access
         * requests raised on target resources governed by the deleted operator control.
         */
    ...
    /**
     * List of users who can approve an access request associated with a target resource under the
     * governance of this operator control.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approversList")
    ...
    /**
     * List of user groups who can approve an access request associated with a target resource under
     * the governance of this operator control.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approverGroupsList")
    ...
    /**
     * List of pre-approved operator actions. Access requests associated with a resource governed by
     * this operator control will be automatically approved if the access request only contain
     * operator actions in the pre-approved list.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("preApprovedOpActionList")
    ...
    /**
     * List of operator actions that need explicit approval. Any operator action not in the
     * pre-approved list will require explicit approval. Access requests associated with a resource
     * governed by this operator control will be require explicit approval if the access request
     * contains any operator action in this list.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("approvalRequiredOpActionList")
     ...
     * the system, so that you can still audit operator actions associated with access requests
