...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/ListListenersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListListenersRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20200501")
public class ListListenersRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListListenersRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListListenersRequest o) {
        ...
        /**
         * Build the instance of ListListenersRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListListenersRequest
         */
        public ListListenersRequest build() {
            ListListenersRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListListenersRequest
         */
        public ListListenersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListListenersRequest(networkLoadBalancerId, opcRequestId, ifNoneMatch, limit, page, sortOrder, sortBy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListListenersRequest)) {
            return false;
        }

        ListListenersRequest other = (ListListenersRequest) o;
