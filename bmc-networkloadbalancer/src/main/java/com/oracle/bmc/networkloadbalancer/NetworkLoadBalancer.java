...
/**
 * This describes the network load balancer API. This service client uses
...
public interface NetworkLoadBalancer extends AutoCloseable {
     ...
     *     https://docs.oracle.com/en-us/iaas/Content/API/SDKDocs/javasdkconcepts.htm#javasdkconcepts_topic_Retries
     *     <p><b>Example: </b>Click <a
     *     href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/GetBackendOperationalStatusExample.java.html"
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use
