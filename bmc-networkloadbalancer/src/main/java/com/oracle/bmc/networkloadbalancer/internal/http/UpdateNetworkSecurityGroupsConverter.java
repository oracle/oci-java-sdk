...
public class UpdateNetworkSecurityGroupsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateNetworkSecurityGroupsConverter.class);

    public static com.oracle.bmc.networkloadbalancer.requests.UpdateNetworkSecurityGroupsRequest
            interceptRequest(
                    com.oracle.bmc.networkloadbalancer.requests.UpdateNetworkSecurityGroupsRequest
                            request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkloadbalancer.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkloadbalancer.responses.UpdateNetworkSecurityGroupsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkloadbalancer.responses
                                                .UpdateNetworkSecurityGroupsResponse.Builder
                                        builder =
                                                com.oracle.bmc.networkloadbalancer.responses
                                                        .UpdateNetworkSecurityGroupsResponse
                                                        .builder()
