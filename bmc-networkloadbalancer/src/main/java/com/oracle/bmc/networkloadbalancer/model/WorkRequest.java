...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * affects multiple resources, and those resources are not in the same compartment, then the
         * service team must choose the primary resource whose compartment is to be used.
         */
        ...
        /**
         * The date and time that the object was finished, as described in [RFC
    ...
    /**
     * The OCID of the compartment that contains the work request. Work requests are scoped to the
     * same compartment as the resource that the work request affects. If the work request affects
     * multiple resources, and those resources are not in the same compartment, then the service
     * team must choose the primary resource whose compartment is to be used.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("compartmentId")
