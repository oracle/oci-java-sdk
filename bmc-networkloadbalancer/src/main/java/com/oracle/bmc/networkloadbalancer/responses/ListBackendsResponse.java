...
public class ListBackendsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code BackendCollection} instance. */
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListBackendsResponse> {
        ...
        public ListBackendsResponse build() {
            return new ListBackendsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, backendCollection);
        }
    }
