 ...
 * Health Check
 * Policies](https://docs.cloud.oracle.com/Content/NetworkLoadBalancer/HealthCheckPolicies/update-health-check-management.htm).
 * <br>
...
public final class HealthChecker extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
         ...
         * specified, then the network load balancer uses the port information from the {@code
         * Backend} object. The port must be specified if the backend port is 0.
         *
         * <p>Example: {@code 8080}
         */
         ...
         * number also applies when recovering a server to the "healthy" state. The default value is
         * 3.
         *
         * <p>Example: {@code 3}
         */
         ...
         * is successful only if a reply returns within this timeout period. The default value is
         * 3000 (3 seconds).
         *
         * <p>Example: {@code 3000}
         */
        ...
        /**
         * The interval between health checks, in milliseconds. The default value is 10000 (10
         * seconds).
         *
        ...
        /**
         * The status code a healthy backend server should return. If you configure the health check
         * policy to use the HTTP protocol, then you can use common HTTP status codes such as "200".
         *
         * <p>Example: {@code 200}
         */
     ...
     * then the network load balancer uses the port information from the {@code Backend} object. The
     * port must be specified if the backend port is 0.
     *
     * <p>Example: {@code 8080}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("port")
    ...
    /**
     * The number of retries to attempt before a backend server is considered "unhealthy". This
     * number also applies when recovering a server to the "healthy" state. The default value is 3.
     *
     * <p>Example: {@code 3}
     */
    @com.fasterxml.jackson.annotation.JsonProperty("retries")
     ...
     * successful only if a reply returns within this timeout period. The default value is 3000 (3
     * seconds).
     *
     * <p>Example: {@code 3000}
     */
