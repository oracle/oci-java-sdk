...
public final class NetworkLoadBalancersProtocolCollection {
    ...
    public static class Builder {
        ...
        public NetworkLoadBalancersProtocolCollection build() {
            NetworkLoadBalancersProtocolCollection __instance__ =
                    new NetworkLoadBalancersProtocolCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkLoadBalancersProtocolCollection o) {
