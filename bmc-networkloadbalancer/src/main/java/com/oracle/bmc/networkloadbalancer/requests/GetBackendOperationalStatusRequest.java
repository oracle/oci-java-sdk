...
public class GetBackendOperationalStatusRequest
    ...
    public static class Builder
         ...
         */
        public GetBackendOperationalStatusRequest build() {
            GetBackendOperationalStatusRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBackendOperationalStatusRequest
         */
        public GetBackendOperationalStatusRequest buildWithoutInvocationCallback() {
            GetBackendOperationalStatusRequest request = new GetBackendOperationalStatusRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBackendOperationalStatusRequest)) {
            return false;
        }

        GetBackendOperationalStatusRequest other = (GetBackendOperationalStatusRequest) o;
