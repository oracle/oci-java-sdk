...
/**
 * A resource that a work request creates or on which the work request operates. <br>
...
public final class WorkRequestResource
    ...
    public static class Builder {
         ...
         * is complete for that resource, at which point the resource transitions to CREATED,
     ...
     * complete for that resource, at which point the resource transitions to CREATED, UPDATED, or
