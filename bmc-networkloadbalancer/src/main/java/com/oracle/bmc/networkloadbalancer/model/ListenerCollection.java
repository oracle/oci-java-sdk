...
public final class ListenerCollection
    ...
    public static class Builder {
        ...
        public ListenerCollection build() {
            ListenerCollection model = new ListenerCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ListenerCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListenerCollection)) {
            return false;
        }

        ListenerCollection other = (ListenerCollection) o;
