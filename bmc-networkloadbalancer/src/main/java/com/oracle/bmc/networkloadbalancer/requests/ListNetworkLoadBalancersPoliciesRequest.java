...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancersPoliciesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNetworkLoadBalancersPoliciesRequest.
 */
...
public class ListNetworkLoadBalancersPoliciesRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(ListNetworkLoadBalancersPoliciesRequest o) {
         ...
         */
        public ListNetworkLoadBalancersPoliciesRequest build() {
            ListNetworkLoadBalancersPoliciesRequest request = buildWithoutInvocationCallback();
