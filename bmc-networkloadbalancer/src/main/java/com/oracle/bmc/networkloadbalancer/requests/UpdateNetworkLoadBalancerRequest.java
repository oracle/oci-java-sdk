...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/UpdateNetworkLoadBalancerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateNetworkLoadBalancerRequest.
 */
...
public class UpdateNetworkLoadBalancerRequest
    ...
    public static class Builder
        ...
        public UpdateNetworkLoadBalancerRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateNetworkLoadBalancerRequest(networkLoadBalancerId, updateNetworkLoadBalancerDetails, ifMatch, opcRequestId);
        }
    }
