...
public enum NetworkLoadBalancersPolicySummary implements com.oracle.bmc.http.internal.BmcEnum {
    TwoTuple("TWO_TUPLE"),
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(NetworkLoadBalancersPolicySummary.class);
    ...
    public static NetworkLoadBalancersPolicySummary create(String key) {
        ...
        LOG.warn(
                "Received unknown value '{}' for enum 'NetworkLoadBalancersPolicySummary', returning UnknownEnumValue",
                key);
