...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/UpdateHealthCheckerExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateHealthCheckerRequest.
 */
...
public class UpdateHealthCheckerRequest
    ...
    public static class Builder
        ...
        /**
         * The health check policy configuration details.
         * @param updateHealthCheckerDetails the value to set
         * @return this builder instance
         */
        ...
        public Builder copy(UpdateHealthCheckerRequest o) {
            ...
            updateHealthCheckerDetails(o.getUpdateHealthCheckerDetails());
