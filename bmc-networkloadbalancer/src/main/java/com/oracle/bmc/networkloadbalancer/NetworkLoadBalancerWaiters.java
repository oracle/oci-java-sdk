 ...
 * resources of NetworkLoadBalancer.
 * <p>
...
public class NetworkLoadBalancerWaiters {
    ...
    public NetworkLoadBalancerWaiters(
            java.util.concurrent.ExecutorService executorService, NetworkLoadBalancer client) {
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forNetworkLoadBalancer(
                    GetNetworkLoadBalancerRequest request,
                    com.oracle.bmc.networkloadbalancer.model.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");

        return forNetworkLoadBalancer(
    ...
    public com.oracle.bmc.waiter.Waiter<
            ...
            forNetworkLoadBalancer(
                    GetNetworkLoadBalancerRequest request,
                    com.oracle.bmc.networkloadbalancer.model.LifecycleState targetState,
    ...
    // Helper method to create a new Waiter for NetworkLoadBalancer.
    private com.oracle.bmc.waiter.Waiter<
                    GetNetworkLoadBalancerRequest, GetNetworkLoadBalancerResponse>
            forNetworkLoadBalancer(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetNetworkLoadBalancerRequest request,
                    final com.oracle.bmc.networkloadbalancer.model.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.networkloadbalancer.model.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                                GetNetworkLoadBalancerRequest, GetNetworkLoadBalancerResponse>() {
                            @Override
                            public GetNetworkLoadBalancerResponse apply(
                                    GetNetworkLoadBalancerRequest request) {
                                return client.getNetworkLoadBalancer(request);
                            }
                        },
                        new java.util.function.Predicate<GetNetworkLoadBalancerResponse>() {
                            @Override
                            public boolean test(GetNetworkLoadBalancerResponse response) {
                                return targetStatesSet.contains(
                                        response.getNetworkLoadBalancer().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.networkloadbalancer.model.LifecycleState.Deleted)),
                request);
    }
