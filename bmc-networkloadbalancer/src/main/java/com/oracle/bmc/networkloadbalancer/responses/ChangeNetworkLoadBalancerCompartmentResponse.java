...
public class ChangeNetworkLoadBalancerCompartmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeNetworkLoadBalancerCompartmentResponse)) {
            return false;
        }

        ChangeNetworkLoadBalancerCompartmentResponse other =
                (ChangeNetworkLoadBalancerCompartmentResponse) o;
