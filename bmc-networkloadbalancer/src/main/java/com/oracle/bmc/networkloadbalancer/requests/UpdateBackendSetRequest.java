...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/UpdateBackendSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBackendSetRequest.
 */
...
public class UpdateBackendSetRequest
    ...
    public static class Builder
        ...
        public UpdateBackendSetRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateBackendSetRequest(networkLoadBalancerId, updateBackendSetDetails, backendSetName, opcRequestId, opcRetryToken, ifMatch);
        }
    }
