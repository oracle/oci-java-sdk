...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancerHealthsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNetworkLoadBalancerHealthsRequest.
 */
...
public class ListNetworkLoadBalancerHealthsRequest
    ...
    public static class Builder
        ...
        public ListNetworkLoadBalancerHealthsRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new ListNetworkLoadBalancerHealthsRequest(compartmentId, sortOrder, sortBy, opcRequestId, limit, page);
        }
    }
