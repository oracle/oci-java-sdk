...
public final class ParentReference extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"parent"})
    public ParentReference(String parent) {
        super();
        this.parent = parent;
    }
    ...
    public static class Builder {
        ...
        public ParentReference build() {
            ParentReference model = new ParentReference(this.parent);
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.parent, other.parent) && super.equals(other);
    }
