...
/**
 * The data store entity data entity details. <br>
...
public final class DataEntityFromDataStoreEntityDetails extends DataEntityDetails {
    ...
    @Deprecated
    public DataEntityFromDataStoreEntityDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntityFromDataStoreEntityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromDataStoreEntityDetails)) {
            return false;
        }

        DataEntityFromDataStoreEntityDetails other = (DataEntityFromDataStoreEntityDetails) o;
