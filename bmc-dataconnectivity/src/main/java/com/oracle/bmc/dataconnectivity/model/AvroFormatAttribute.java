...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AvroFormatAttribute.Builder.class)
...
public final class AvroFormatAttribute extends AbstractFormatAttribute {
    ...
    public static class Builder {
        ...
        public AvroFormatAttribute build() {
            AvroFormatAttribute model = new AvroFormatAttribute(this.compression);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AvroFormatAttribute)) {
            return false;
        }
