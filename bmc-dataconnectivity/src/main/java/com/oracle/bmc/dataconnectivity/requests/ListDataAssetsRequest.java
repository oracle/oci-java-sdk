...
public class ListDataAssetsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        /**
         * Singular setter. Endpoint IDs used for data-plane APIs to filter or prefer specific
         * endpoint.
         *
         * @param singularValue the singular value to set
         * @return this builder instance
        ...
        public ListDataAssetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDataAssetsRequest(registryId, page, limit, fields, includeTypes, sortBy,
            // sortOrder, name, opcRequestId, excludeTypes, favoritesQueryParam, folderId,
            // endpointIds, excludeEndpointIds);
        }
    }
