...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataconnectivity/ListConnectionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListConnectionsRequest.
 */
...
public class ListConnectionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListConnectionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListConnectionsRequest(registryId, dataAssetKey, name, page, limit, fields, type, sortBy, sortOrder, opcRequestId, favoritesQueryParam);
        }
    }
