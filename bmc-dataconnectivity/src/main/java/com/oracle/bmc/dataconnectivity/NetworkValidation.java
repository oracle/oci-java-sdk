...
public interface NetworkValidation extends AutoCloseable {
    ...
    /**
     * This API is used to get the network connectivity status fofor all the data assets attached to
     * the provided private endpoint.
     *
     ...
     *     GetNetworkConnectivityStatusCollection API.
     */
    GetNetworkConnectivityStatusCollectionResponse getNetworkConnectivityStatusCollection(
