...
public class ParquetFormatAttribute extends AbstractFormatAttribute {
    ...
    public static class Builder {
        ...
        public ParquetFormatAttribute build() {
            ParquetFormatAttribute __instance__ = new ParquetFormatAttribute(compression);
    ...
    @Deprecated
    public ParquetFormatAttribute(String compression) {
        super();
        this.compression = compression;
    }
