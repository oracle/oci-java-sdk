...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EntityShapeFromMessage.Builder.class
)
...
public final class EntityShapeFromMessage extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromMessage build() {
            EntityShapeFromMessage model =
                    new EntityShapeFromMessage(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromMessage model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityShapeFromMessage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromMessage)) {
            return false;
        }

        EntityShapeFromMessage other = (EntityShapeFromMessage) o;
