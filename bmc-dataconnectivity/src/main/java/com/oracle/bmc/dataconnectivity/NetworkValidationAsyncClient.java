...
public class NetworkValidationAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(NetworkValidationAsyncClient.class);

    private NetworkValidationAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, NetworkValidationAsyncClient> {
    ...
    @Override
    public java.util.concurrent.Future<GetNetworkConnectivityStatusCollectionResponse>
        ...
        Validate.notBlank(request.getEndpointKey(), "endpointKey must not be blank");

        return clientCall(request, GetNetworkConnectivityStatusCollectionResponse::builder)
                .logger(LOG, "getNetworkConnectivityStatusCollection")
                .serviceDetails("NetworkValidation", "GetNetworkConnectivityStatusCollection", "")
                .method(com.oracle.bmc.http.client.Method.GET)
                .requestBuilder(GetNetworkConnectivityStatusCollectionRequest::builder)
                .basePath("/20210217")
                .appendPathParam("registries")
                .appendPathParam(request.getRegistryId())
                .appendPathParam("endpoints")
                .appendPathParam(request.getEndpointKey())
                .appendPathParam("networkConnectivityStatusCollection")
                ...
                .handleBody(
                        com.oracle.bmc.dataconnectivity.model.NetworkConnectivityStatusCollection
                                .class,
                        GetNetworkConnectivityStatusCollectionResponse.Builder
                                ::networkConnectivityStatusCollection)
                .handleResponseHeaderString(
                        "opc-request-id",
                        GetNetworkConnectivityStatusCollectionResponse.Builder::opcRequestId)
                .callAsync(handler);
    }
