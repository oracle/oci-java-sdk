...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateEntityShapeFromMessage.Builder.class)
...
public final class CreateEntityShapeFromMessage extends CreateEntityShapeDetails {
    ...
    public static class Builder {
        ...
        public CreateEntityShapeFromMessage build() {
            CreateEntityShapeFromMessage model =
                    new CreateEntityShapeFromMessage(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEntityShapeFromMessage model) {
    ...
    @Deprecated
    public CreateEntityShapeFromMessage(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateEntityShapeFromMessage(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEntityShapeFromMessage)) {
            return false;
        }

        CreateEntityShapeFromMessage other = (CreateEntityShapeFromMessage) o;
