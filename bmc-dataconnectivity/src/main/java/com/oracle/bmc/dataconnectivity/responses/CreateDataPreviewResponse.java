...
public class CreateDataPreviewResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateDataPreviewResponse> {
         ...
         * The returned DataPreview instance.
         *
         * @param dataPreview the value to set
         * @return this builder
         */
        ...
        public CreateDataPreviewResponse build() {
            return new CreateDataPreviewResponse(
                    __httpStatusCode__, headers, opcRequestId, dataPreview);
        }
    }
