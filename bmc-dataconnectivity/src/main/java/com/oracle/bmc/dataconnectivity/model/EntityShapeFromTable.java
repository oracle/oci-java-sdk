...
/**
 * The table data entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityShapeFromTable.Builder.class)
...
public final class EntityShapeFromTable extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromTable build() {
            EntityShapeFromTable model =
                    new EntityShapeFromTable(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromTable model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityShapeFromTable(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromTable)) {
            return false;
        }

        EntityShapeFromTable other = (EntityShapeFromTable) o;
