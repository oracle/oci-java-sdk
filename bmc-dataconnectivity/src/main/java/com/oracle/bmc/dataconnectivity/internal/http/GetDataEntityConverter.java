...
public class GetDataEntityConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetDataEntityConverter.class);

    public static com.oracle.bmc.dataconnectivity.requests.GetDataEntityRequest interceptRequest(
            com.oracle.bmc.dataconnectivity.requests.GetDataEntityRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dataconnectivity.responses.GetDataEntityResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.dataconnectivity.responses.GetDataEntityResponse>() {
                            @Override
                            public com.oracle.bmc.dataconnectivity.responses.GetDataEntityResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dataconnectivity.responses.GetDataEntityResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                if (serviceDetails.isPresent()) {
                                    responseFn =
                                            RESPONSE_CONVERSION_FACTORY.create(
                                                    com.oracle.bmc.dataconnectivity.model.DataEntity
                                                            .class,
                                                    serviceDetails.get());
                                } else {
                                    responseFn =
