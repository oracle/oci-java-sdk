...
/**
 * The operation summary object. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "modelType",
        defaultImpl = OperationSummary.class)
...
public class OperationSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OperationSummary)) {
            return false;
        }
