...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataconnectivity/DeleteRegistryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRegistryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210217")
public class DeleteRegistryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteRegistryRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteRegistryRequest o) {
        ...
        /**
         * Build the instance of DeleteRegistryRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteRegistryRequest
         */
        public DeleteRegistryRequest build() {
            DeleteRegistryRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteRegistryRequest
         */
        public DeleteRegistryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteRegistryRequest(registryId, isForceOperation, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRegistryRequest)) {
            return false;
        }

        DeleteRegistryRequest other = (DeleteRegistryRequest) o;
