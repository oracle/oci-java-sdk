...
/**
 * A summary type containing information about the object including its key, name, the time that it
 * was created or updated, and the user who created or updated it. <br>
...
public final class ObjectMetadata
    ...
    public static class Builder {
        ...
        /**
         * Labels are keywords or tags that you can add to data assets, dataflows, and so on. You
