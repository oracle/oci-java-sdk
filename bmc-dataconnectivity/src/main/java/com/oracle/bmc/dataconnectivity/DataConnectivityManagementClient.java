...
public class DataConnectivityManagementClient implements DataConnectivityManagement {
     ...
     */
    protected DataConnectivityManagementClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public ChangeRegistryCompartmentResponse changeRegistryCompartment(
        ...
        LOG.trace("Called changeRegistryCompartment");
    ...
    public CreateAttachDataAssetResponse createAttachDataAsset(
        ...
        LOG.trace("Called createAttachDataAsset");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateAttachDataAssetDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateConnectivityValidationResponse createConnectivityValidation(
        ...
        LOG.trace("Called createConnectivityValidation");
    ...
    public CreateDataPreviewResponse createDataPreview(CreateDataPreviewRequest request) {
        LOG.trace("Called createDataPreview");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDataPreviewDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateDataProfileResponse createDataProfile(CreateDataProfileRequest request) {
        LOG.trace("Called createDataProfile");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDataProfileDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateDeReferenceArtifactResponse createDeReferenceArtifact(
        ...
        LOG.trace("Called createDeReferenceArtifact");
    ...
    public CreateDetachDataAssetResponse createDetachDataAsset(
        ...
        LOG.trace("Called createDetachDataAsset");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateDetachDataAssetDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateExecuteOperationJobResponse createExecuteOperationJob(
        ...
        LOG.trace("Called createExecuteOperationJob");
    ...
    public CreateFullPushDownTaskResponse createFullPushDownTask(
        ...
        LOG.trace("Called createFullPushDownTask");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateFullPushDownTaskDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateReferenceArtifactResponse createReferenceArtifact(
        ...
        LOG.trace("Called createReferenceArtifact");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateReferenceArtifactDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateRegistryResponse createRegistry(CreateRegistryRequest request) {
        LOG.trace("Called createRegistry");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateRegistryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateTestNetworkConnectivityResponse createTestNetworkConnectivity(
        ...
        LOG.trace("Called createTestNetworkConnectivity");
    ...
    public DeleteNetworkConnectivityStatusResponse deleteNetworkConnectivityStatus(
        ...
        LOG.trace("Called deleteNetworkConnectivityStatus");
    ...
    public DeleteRegistryResponse deleteRegistry(DeleteRegistryRequest request) {
        LOG.trace("Called deleteRegistry");
    ...
    public DeriveEntitiesResponse deriveEntities(DeriveEntitiesRequest request) {
        LOG.trace("Called deriveEntities");
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        ...
                        ib.getRequestUri().toString(),
                        "");
        java.util.function.Function<javax.ws.rs.core.Response, DeriveEntitiesResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getDeriveEntitiesDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetEngineConfigurationsResponse getEngineConfigurations(
        ...
        LOG.trace("Called getEngineConfigurations");
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        ...
                        ib.getRequestUri().toString(),
                        "");
        java.util.function.Function<javax.ws.rs.core.Response, GetEngineConfigurationsResponse>
                transformer =
    ...
    public GetExecuteOperationJobResponse getExecuteOperationJob(
        ...
        LOG.trace("Called getExecuteOperationJob");
    ...
    public GetNetworkConnectivityStatusResponse getNetworkConnectivityStatus(
        ...
        LOG.trace("Called getNetworkConnectivityStatus");
    ...
    public ListOperationsResponse listOperations(ListOperationsRequest request) {
        LOG.trace("Called listOperations");
    ...
    public ListReferenceArtifactsResponse listReferenceArtifacts(
        ...
        LOG.trace("Called listReferenceArtifacts");
    ...
    public ListRegistriesResponse listRegistries(ListRegistriesRequest request) {
        LOG.trace("Called listRegistries");
    ...
    public UpdateRegistryResponse updateRegistry(UpdateRegistryRequest request) {
        LOG.trace("Called updateRegistry");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateRegistryDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ValidateDataAssetNetworkReachablityResponse validateDataAssetNetworkReachablity(
        ...
        LOG.trace("Called validateDataAssetNetworkReachablity");
