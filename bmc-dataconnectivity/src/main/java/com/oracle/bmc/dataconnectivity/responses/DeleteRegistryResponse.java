...
public class DeleteRegistryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteRegistryResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteRegistryResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteRegistryResponse o) {
         ...
         */
        @Override
        public DeleteRegistryResponse build() {
            return new DeleteRegistryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteRegistryResponse)) {
            return false;
        }

        DeleteRegistryResponse other = (DeleteRegistryResponse) o;
