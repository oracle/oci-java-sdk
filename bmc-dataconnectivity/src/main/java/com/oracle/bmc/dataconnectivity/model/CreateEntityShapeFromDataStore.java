...
public class CreateEntityShapeFromDataStore extends CreateEntityShapeDetails {
    ...
    public static class Builder {
        ...
        public CreateEntityShapeFromDataStore build() {
            CreateEntityShapeFromDataStore __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEntityShapeFromDataStore o) {
