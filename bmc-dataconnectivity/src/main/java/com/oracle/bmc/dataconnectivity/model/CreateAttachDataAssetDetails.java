...
/**
 * The attach DataAsset payload. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAttachDataAssetDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class CreateAttachDataAssetDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dataAssets"})
    public CreateAttachDataAssetDetails(java.util.List<DataAsset> dataAssets) {
        super();
    ...
    public static class Builder {
        ...
        public CreateAttachDataAssetDetails build() {
            CreateAttachDataAssetDetails model = new CreateAttachDataAssetDetails(this.dataAssets);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAttachDataAssetDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAttachDataAssetDetails)) {
            return false;
        }

        CreateAttachDataAssetDetails other = (CreateAttachDataAssetDetails) o;
