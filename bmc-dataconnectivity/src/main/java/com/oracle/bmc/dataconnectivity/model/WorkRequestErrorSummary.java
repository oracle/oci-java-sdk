...
public final class WorkRequestErrorSummary
    ...
    public static class Builder {
        ...
        public WorkRequestErrorSummary build() {
            WorkRequestErrorSummary model =
                    new WorkRequestErrorSummary(this.code, this.message, this.timestamp);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(WorkRequestErrorSummary model) {
