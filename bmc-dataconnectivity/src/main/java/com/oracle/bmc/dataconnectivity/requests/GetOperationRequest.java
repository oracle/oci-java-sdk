 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetOperationRequest.
 */
...
public class GetOperationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetOperationRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetOperationRequest(registryId, connectionKey, schemaResourceName,
            // operationResourceName, opcRequestId, endpointId);
        }
    }
