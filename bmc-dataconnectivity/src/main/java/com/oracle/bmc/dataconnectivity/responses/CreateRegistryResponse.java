...
public class CreateRegistryResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateRegistryResponse> {
         ...
         */
        @Override
        public Builder copy(CreateRegistryResponse o) {
         ...
         */
        @Override
        public CreateRegistryResponse build() {
            return new CreateRegistryResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRegistryResponse)) {
            return false;
        }

        CreateRegistryResponse other = (CreateRegistryResponse) o;
