...
public class CreateFullPushDownTaskResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder fullPushDownTaskResponse(
                com.oracle.bmc.dataconnectivity.model.FullPushDownTaskResponse
                        fullPushDownTaskResponse) {
            this.fullPushDownTaskResponse = fullPushDownTaskResponse;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",fullPushDownTaskResponse=").append(String.valueOf(fullPushDownTaskResponse));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateFullPushDownTaskResponse)) {
            return false;
        }

        CreateFullPushDownTaskResponse other = (CreateFullPushDownTaskResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.fullPushDownTaskResponse, other.fullPushDownTaskResponse);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.fullPushDownTaskResponse == null
                                ? 43
                                : this.fullPushDownTaskResponse.hashCode());
        return result;
    }
}
