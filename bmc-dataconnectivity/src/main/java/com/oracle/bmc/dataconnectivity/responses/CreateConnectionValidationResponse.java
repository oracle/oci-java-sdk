...
public class CreateConnectionValidationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(CreateConnectionValidationResponse o) {
         ...
         */
        public CreateConnectionValidationResponse build() {
            return new CreateConnectionValidationResponse(
                    __httpStatusCode__, etag, opcRequestId, connectionValidation);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateConnectionValidationResponse)) {
            return false;
        }

        CreateConnectionValidationResponse other = (CreateConnectionValidationResponse) o;
