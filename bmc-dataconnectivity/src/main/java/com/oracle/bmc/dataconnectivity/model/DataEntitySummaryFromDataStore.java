...
public class DataEntitySummaryFromDataStore extends DataEntitySummary {
    ...
    public static class Builder {
        ...
        public DataEntitySummaryFromDataStore build() {
            DataEntitySummaryFromDataStore __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntitySummaryFromDataStore o) {
