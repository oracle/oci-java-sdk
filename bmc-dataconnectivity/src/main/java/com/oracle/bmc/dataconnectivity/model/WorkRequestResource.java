...
public final class WorkRequestResource
    ...
    public static class Builder {
         ...
         * work is complete for that resource, after which it moves to CREATED, UPDATED, or DELETED
         * state, respectively.
         */
     ...
     * is complete for that resource, after which it moves to CREATED, UPDATED, or DELETED state,
     * respectively.
     */
