...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EntityShapeFromSQL.Builder.class
)
...
public final class EntityShapeFromSQL extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromSQL build() {
            EntityShapeFromSQL __instance__ =
                    new EntityShapeFromSQL(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromSQL o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromSQL)) {
            return false;
        }

        EntityShapeFromSQL other = (EntityShapeFromSQL) o;
