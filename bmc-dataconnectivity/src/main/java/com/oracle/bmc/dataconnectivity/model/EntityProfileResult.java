...
/**
 * The metadata details of a profiling entity result. <br>
...
public final class EntityProfileResult
    ...
    public static class Builder {
        /**
         * Number of columns in the DataFrame (arrow buffer) sent from Java layer. This value is not
         * impacted by the list of attributes to profile as being passed via configuration.
         */
