...
public class DpEndpointFromPrivateDetails extends DpEndpointDetails {
    ...
    public static class Builder {
        ...
        public DpEndpointFromPrivateDetails build() {
            DpEndpointFromPrivateDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DpEndpointFromPrivateDetails o) {
