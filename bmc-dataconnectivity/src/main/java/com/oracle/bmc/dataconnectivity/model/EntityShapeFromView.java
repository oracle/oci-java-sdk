...
/**
 * The view data entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityShapeFromView.Builder.class)
...
public final class EntityShapeFromView extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromView build() {
            EntityShapeFromView model =
                    new EntityShapeFromView(
                            this.metadata,
                            this.key,
                            this.modelVersion,
                            this.parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromView model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromView)) {
            return false;
        }

        EntityShapeFromView other = (EntityShapeFromView) o;
