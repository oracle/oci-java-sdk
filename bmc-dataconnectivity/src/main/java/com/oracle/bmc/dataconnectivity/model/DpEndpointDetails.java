...
public class DpEndpointDetails extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DpEndpointDetails)) {
            return false;
        }

        DpEndpointDetails other = (DpEndpointDetails) o;
