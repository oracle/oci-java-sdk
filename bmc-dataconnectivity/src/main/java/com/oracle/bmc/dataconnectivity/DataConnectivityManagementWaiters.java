 ...
 * resources of DataConnectivityManagement.
 * <p>
...
public class DataConnectivityManagementWaiters {
    ...
    public com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            ...
            com.oracle.bmc.dataconnectivity.model.Endpoint.LifecycleState... targetStates) {
    ...
    public com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            GetEndpointRequest request,
            com.oracle.bmc.dataconnectivity.model.Endpoint.LifecycleState targetState,
    ...
    private com.oracle.bmc.waiter.Waiter<GetEndpointRequest, GetEndpointResponse> forEndpoint(
            ...
            final com.oracle.bmc.dataconnectivity.model.Endpoint.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.dataconnectivity.model.Endpoint.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.dataconnectivity.model.Endpoint.LifecycleState
                                        .Deleted)),
                request);
    }
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetRegistryRequest, GetRegistryResponse> forRegistry(
            GetRegistryRequest request,
            com.oracle.bmc.dataconnectivity.model.Registry.LifecycleState... targetStates) {
        com.oracle.bmc.util.internal.Validate.notEmpty(
                targetStates, "At least one targetState must be provided");
        com.oracle.bmc.util.internal.Validate.noNullElements(
                targetStates, "Null targetState values are not permitted");
    ...
    public com.oracle.bmc.waiter.Waiter<GetRegistryRequest, GetRegistryResponse> forRegistry(
            GetRegistryRequest request,
            com.oracle.bmc.dataconnectivity.model.Registry.LifecycleState targetState,
            com.oracle.bmc.waiter.TerminationStrategy terminationStrategy,
            com.oracle.bmc.waiter.DelayStrategy delayStrategy) {
        com.oracle.bmc.util.internal.Validate.notNull(
                targetState, "The targetState cannot be null");
    ...
    // Helper method to create a new Waiter for Registry.
    private com.oracle.bmc.waiter.Waiter<GetRegistryRequest, GetRegistryResponse> forRegistry(
            com.oracle.bmc.waiter.BmcGenericWaiter waiter,
            final GetRegistryRequest request,
            final com.oracle.bmc.dataconnectivity.model.Registry.LifecycleState... targetStates) {
        final java.util.Set<com.oracle.bmc.dataconnectivity.model.Registry.LifecycleState>
                targetStatesSet = new java.util.HashSet<>(java.util.Arrays.asList(targetStates));
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        targetStatesSet.contains(
                                com.oracle.bmc.dataconnectivity.model.Registry.LifecycleState
                                        .Deleted)),
                request);
    }
