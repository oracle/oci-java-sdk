...
/**
 * Properties used in the update operations of the folder. <br>
...
public final class UpdateFolderDetails
    ...
    public static class Builder {
        ...
        /**
         * Generated key that can be used in API calls to identify the folder. In scenarios where
         * reference to the folder is required, a value can be passed in create.
         */
