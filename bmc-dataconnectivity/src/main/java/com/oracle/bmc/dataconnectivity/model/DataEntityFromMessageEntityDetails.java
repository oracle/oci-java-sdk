...
/**
 * The message data entity details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DataEntityFromMessageEntityDetails.Builder.class)
...
public final class DataEntityFromMessageEntityDetails extends DataEntityDetails {
    ...
    public static class Builder {
         ...
         * letters, numbers, and special characters. The value is unique, editable and is restricted
         * to 1000 characters.
         */
        ...
        public DataEntityFromMessageEntityDetails build() {
            DataEntityFromMessageEntityDetails model =
                    new DataEntityFromMessageEntityDetails(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntityFromMessageEntityDetails model) {
    ...
    @Deprecated
    public DataEntityFromMessageEntityDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DataEntityFromMessageEntityDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntityFromMessageEntityDetails)) {
            return false;
        }

        DataEntityFromMessageEntityDetails other = (DataEntityFromMessageEntityDetails) o;
