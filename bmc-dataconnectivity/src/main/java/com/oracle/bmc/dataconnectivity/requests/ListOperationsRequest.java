...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataconnectivity/ListOperationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListOperationsRequest.
 */
...
public class ListOperationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListOperationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListOperationsRequest(registryId, connectionKey, schemaResourceName, opcRequestId, name, page, limit, sortBy, sortOrder, endpointId);
        }
    }
