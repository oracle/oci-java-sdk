...
/**
 * A registry is an organizational construct to keep multiple data connectivity management solutions
 * and their resources (data assets, data flows, tasks, and so on) separate from each other, helping
 * you to stay organized. For example, you could have separate registries for development, testing,
 * and production. <br>
...
public final class Registry extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Registry model) {
