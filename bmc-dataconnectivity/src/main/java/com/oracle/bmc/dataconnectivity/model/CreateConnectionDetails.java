...
/**
 * Properties used in the create connection operations. <br>
...
public final class CreateConnectionDetails
    ...
    public static class Builder {
        /**
         * Generated key that can be used in API calls to identify the connection. In scenarios
         * where reference to the connection is required, a value can be passed in create.
         */
    ...
    /**
     * Generated key that can be used in API calls to identify the connection. In scenarios where
     * reference to the connection is required, a value can be passed in create.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("key")
