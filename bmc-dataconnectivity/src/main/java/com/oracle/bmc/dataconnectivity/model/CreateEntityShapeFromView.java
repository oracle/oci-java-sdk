...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateEntityShapeFromView.Builder.class
)
...
public final class CreateEntityShapeFromView extends CreateEntityShapeDetails {
    ...
    @Deprecated
    public CreateEntityShapeFromView(
            String key,
            String modelVersion,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEntityShapeFromView)) {
            return false;
        }
