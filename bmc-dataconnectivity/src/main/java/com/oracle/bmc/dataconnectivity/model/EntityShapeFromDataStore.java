...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = EntityShapeFromDataStore.Builder.class
)
...
public final class EntityShapeFromDataStore extends EntityShape {
    ...
    public static class Builder {
        ...
        public EntityShapeFromDataStore build() {
            EntityShapeFromDataStore __instance__ =
                    new EntityShapeFromDataStore(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityShapeFromDataStore o) {
    ...
    @Deprecated
    public EntityShapeFromDataStore(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityShapeFromDataStore)) {
            return false;
        }

        EntityShapeFromDataStore other = (EntityShapeFromDataStore) o;
