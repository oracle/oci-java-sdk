...
public class CreateExecuteOperationJobConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateExecuteOperationJobConverter.class);

    public static com.oracle.bmc.dataconnectivity.requests.CreateExecuteOperationJobRequest
            interceptRequest(
                    com.oracle.bmc.dataconnectivity.requests.CreateExecuteOperationJobRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.dataconnectivity.requests.CreateExecuteOperationJobRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.dataconnectivity.responses.CreateExecuteOperationJobResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.dataconnectivity.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.dataconnectivity.responses.CreateExecuteOperationJobResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.dataconnectivity.responses
                                                .CreateExecuteOperationJobResponse.Builder
                                        builder =
                                                com.oracle.bmc.dataconnectivity.responses
                                                        .CreateExecuteOperationJobResponse.builder()
                                                        .__httpStatusCode__(
                                ...
                                builder.executeOperationJobDetails(response.getItem());
