...
/**
 * Input to perform connector validation. Defines the data integration semantics in a data flow. It
 * can be about reading, writing, or transforming the data. <br>
