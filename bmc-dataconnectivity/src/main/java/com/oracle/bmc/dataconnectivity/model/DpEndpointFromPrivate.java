...
/**
 * The endpoint details of a private endpoint. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DpEndpointFromPrivate.Builder.class)
...
public final class DpEndpointFromPrivate extends DpEndpoint {
    ...
    public static class Builder {
        ...
        public DpEndpointFromPrivate build() {
            DpEndpointFromPrivate model =
                    new DpEndpointFromPrivate(
                            this.key,
                            this.modelVersion,
                            this.parentRef,
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DpEndpointFromPrivate model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DpEndpointFromPrivate(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DpEndpointFromPrivate)) {
            return false;
        }

        DpEndpointFromPrivate other = (DpEndpointFromPrivate) o;
