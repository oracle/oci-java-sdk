...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DataEntitySummaryFromFile.Builder.class
)
...
public final class DataEntitySummaryFromFile extends DataEntitySummary {
    ...
    public static class Builder {
        ...
        public DataEntitySummaryFromFile build() {
            DataEntitySummaryFromFile __instance__ =
                    new DataEntitySummaryFromFile(
                            metadata,
                            key,
                            modelVersion,
                            parentRef,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DataEntitySummaryFromFile o) {
    ...
    @Deprecated
    public DataEntitySummaryFromFile(
    ...
    public String toString() {
        ...
        sb.append("DataEntitySummaryFromFile(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DataEntitySummaryFromFile)) {
            return false;
        }

        DataEntitySummaryFromFile other = (DataEntitySummaryFromFile) o;
