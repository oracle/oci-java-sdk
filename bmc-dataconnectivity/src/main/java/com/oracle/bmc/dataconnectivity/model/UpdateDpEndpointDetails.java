...
/**
 * Properties used in the update operations of the endpoint. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "modelType",
        defaultImpl = UpdateDpEndpointDetails.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateDpEndpointFromPublic.class,
            name = "PUBLIC_END_POINT"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = UpdateDpEndpointFromPrivate.class,
            name = "PRIVATE_END_POINT")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public class UpdateDpEndpointDetails
    ...
    protected UpdateDpEndpointDetails(
            String key,
            String modelVersion,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateDpEndpointDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDpEndpointDetails)) {
            return false;
        }

        UpdateDpEndpointDetails other = (UpdateDpEndpointDetails) o;
