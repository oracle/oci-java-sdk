...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dataconnectivity/GetFolderExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFolderRequest.
 */
...
public class GetFolderRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetFolderRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetFolderRequest(registryId, folderKey, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().registryId(registryId).folderKey(folderKey).opcRequestId(opcRequestId);
    }
