...
public class NoMixedOciJavaSdkVersionsRule extends AbstractEnforcerRule {
    ...
    /**
     * Whether to distinguish between different timed snapshots (e.g is "2.84.1-preview1-20250522.215840-13"
     * different than "2.84.1-preview1-20250522.215043-12"?) or to treat all snapshots the same (i.e. both
     * "2.84.1-preview1-20250522.215840-13" and "2.84.1-preview1-20250522.215043-12" are treated as
