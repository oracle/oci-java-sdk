...
public interface AiDataPlatformAsync extends AutoCloseable {
    ...
    /**
     * Moves a AiDataPlatform into a different compartment within the same tenancy. For information
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateAiDataPlatformResponse> createAiDataPlatform(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteAiDataPlatformResponse> deleteAiDataPlatform(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetAiDataPlatformResponse> getAiDataPlatform(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListAiDataPlatformsResponse> listAiDataPlatforms(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateAiDataPlatformResponse> updateAiDataPlatform(
