...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aidataplatform/DeleteAiDataPlatformExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAiDataPlatformRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20240831")
public class DeleteAiDataPlatformRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAiDataPlatformRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAiDataPlatformRequest o) {
        ...
        /**
         * Build the instance of DeleteAiDataPlatformRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAiDataPlatformRequest
         */
        public DeleteAiDataPlatformRequest build() {
            DeleteAiDataPlatformRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAiDataPlatformRequest
         */
        public DeleteAiDataPlatformRequest buildWithoutInvocationCallback() {
            DeleteAiDataPlatformRequest request = new DeleteAiDataPlatformRequest();
            request.aiDataPlatformId = aiDataPlatformId;
            request.isForceDelete = isForceDelete;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteAiDataPlatformRequest(aiDataPlatformId, isForceDelete, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAiDataPlatformRequest)) {
            return false;
        }

        DeleteAiDataPlatformRequest other = (DeleteAiDataPlatformRequest) o;
