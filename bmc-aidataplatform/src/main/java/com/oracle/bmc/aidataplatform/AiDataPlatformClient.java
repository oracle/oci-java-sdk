...
public class AiDataPlatformClient implements AiDataPlatform {
    /**
     ...
     */
    protected AiDataPlatformClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public static class Builder
        ...
        public AiDataPlatformClient build(
            ...
            return new AiDataPlatformClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public ChangeAiDataPlatformCompartmentResponse changeAiDataPlatformCompartment(
        ...
        LOG.trace("Called changeAiDataPlatformCompartment");
    ...
    public CreateAiDataPlatformResponse createAiDataPlatform(CreateAiDataPlatformRequest request) {
        LOG.trace("Called createAiDataPlatform");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateAiDataPlatformResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateAiDataPlatformDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteAiDataPlatformResponse deleteAiDataPlatform(DeleteAiDataPlatformRequest request) {
        LOG.trace("Called deleteAiDataPlatform");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteAiDataPlatformResponse>
                transformer =
    ...
    public GetAiDataPlatformResponse getAiDataPlatform(GetAiDataPlatformRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetAiDataPlatformResponse>
                transformer =
    ...
    public ListAiDataPlatformsResponse listAiDataPlatforms(ListAiDataPlatformsRequest request) {
        LOG.trace("Called listAiDataPlatforms");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListAiDataPlatformsResponse>
                transformer =
    ...
    public UpdateAiDataPlatformResponse updateAiDataPlatform(UpdateAiDataPlatformRequest request) {
        LOG.trace("Called updateAiDataPlatform");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateAiDataPlatformResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateAiDataPlatformDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
