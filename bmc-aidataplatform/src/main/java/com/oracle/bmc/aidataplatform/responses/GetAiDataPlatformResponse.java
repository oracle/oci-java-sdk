...
public class GetAiDataPlatformResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetAiDataPlatformResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetAiDataPlatformResponse> {
         ...
         */
        @Override
        public Builder copy(GetAiDataPlatformResponse o) {
         ...
         */
        @Override
        public GetAiDataPlatformResponse build() {
            return new GetAiDataPlatformResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, aiDataPlatform);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAiDataPlatformResponse)) {
            return false;
        }

        GetAiDataPlatformResponse other = (GetAiDataPlatformResponse) o;
