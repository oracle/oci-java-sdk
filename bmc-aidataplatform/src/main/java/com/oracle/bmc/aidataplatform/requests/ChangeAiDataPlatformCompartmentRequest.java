...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/aidataplatform/ChangeAiDataPlatformCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeAiDataPlatformCompartmentRequest.
 */
...
public class ChangeAiDataPlatformCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeAiDataPlatformCompartmentRequest as configured by this builder
         *
        ...
        public ChangeAiDataPlatformCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeAiDataPlatformCompartmentRequest(aiDataPlatformId, changeAiDataPlatformCompartmentDetails, ifMatch, opcRequestId);
        }
    }
