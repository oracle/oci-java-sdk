...
public class CreateAiDataPlatformConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateAiDataPlatformConverter.class);

    public static com.oracle.bmc.aidataplatform.requests.CreateAiDataPlatformRequest
            interceptRequest(
                    com.oracle.bmc.aidataplatform.requests.CreateAiDataPlatformRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.aidataplatform.responses
                                        .CreateAiDataPlatformResponse>() {
                            @Override
                            public com.oracle.bmc.aidataplatform.responses
                                            .CreateAiDataPlatformResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.aidataplatform.responses.CreateAiDataPlatformResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.aidataplatform.responses.CreateAiDataPlatformResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.aidataplatform.responses
                                                        .CreateAiDataPlatformResponse.builder()
