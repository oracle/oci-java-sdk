...
/**
 * Summary information about a AiDataPlatform. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AiDataPlatformSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AiDataPlatformSummary
    ...
    public static class Builder {
        ...
        private AiDataPlatform.LifecycleState lifecycleState;
         ...
         * @return this builder
         */
        public Builder lifecycleState(AiDataPlatform.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        public AiDataPlatformSummary build() {
            AiDataPlatformSummary model =
                    new AiDataPlatformSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AiDataPlatformSummary model) {
    ...
    /** The current state of the AiDataPlatform. */
    @com.fasterxml.jackson.annotation.JsonProperty("lifecycleState")
    private final AiDataPlatform.LifecycleState lifecycleState;
     ...
     * @return the value
     */
    public AiDataPlatform.LifecycleState getLifecycleState() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AiDataPlatformSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AiDataPlatformSummary)) {
            return false;
        }

        AiDataPlatformSummary other = (AiDataPlatformSummary) o;
