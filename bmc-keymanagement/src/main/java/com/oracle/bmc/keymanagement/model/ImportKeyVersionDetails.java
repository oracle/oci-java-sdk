...
public final class ImportKeyVersionDetails {
    ...
    public static class Builder {
        ...
        public ImportKeyVersionDetails build() {
            ImportKeyVersionDetails __instance__ =
                    new ImportKeyVersionDetails(definedTags, freeformTags, wrappedImportKey);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportKeyVersionDetails o) {
