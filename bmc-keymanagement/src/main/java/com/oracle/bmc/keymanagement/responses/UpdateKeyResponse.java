...
public class UpdateKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateKeyResponse> {
        ...
        public UpdateKeyResponse build() {
            return new UpdateKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateKeyResponse)) {
            return false;
        }

        UpdateKeyResponse other = (UpdateKeyResponse) o;
