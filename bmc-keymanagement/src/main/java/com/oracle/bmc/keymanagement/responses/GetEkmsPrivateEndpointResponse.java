...
public class GetEkmsPrivateEndpointResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetEkmsPrivateEndpointResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetEkmsPrivateEndpointResponse o) {
         ...
         */
        public GetEkmsPrivateEndpointResponse build() {
            return new GetEkmsPrivateEndpointResponse(
                    __httpStatusCode__, headers, opcRequestId, etag, ekmsPrivateEndpoint);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetEkmsPrivateEndpointResponse)) {
            return false;
        }

        GetEkmsPrivateEndpointResponse other = (GetEkmsPrivateEndpointResponse) o;
