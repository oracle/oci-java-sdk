...
public class CreateVaultResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateVaultResponse> {
         ...
         */
        @Override
        public Builder copy(CreateVaultResponse o) {
        ...
        public CreateVaultResponse build() {
            return new CreateVaultResponse(__httpStatusCode__, headers, etag, opcRequestId, vault);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateVaultResponse)) {
            return false;
        }

        CreateVaultResponse other = (CreateVaultResponse) o;
