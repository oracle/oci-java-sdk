...
public class ListKeyVersionsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListKeyVersionsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListKeyVersionsResponse)) {
            return false;
        }

        ListKeyVersionsResponse other = (ListKeyVersionsResponse) o;
