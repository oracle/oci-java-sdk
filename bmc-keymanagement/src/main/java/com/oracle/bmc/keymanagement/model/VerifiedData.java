...
/**
 * The response to a request to verify the message. <br>
...
public final class VerifiedData extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public VerifiedData build() {
            VerifiedData model = new VerifiedData(this.isSignatureValid);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VerifiedData model) {
            if (model.wasPropertyExplicitlySet("isSignatureValid")) {
                this.isSignatureValid(model.getIsSignatureValid());
            }
            return this;
        }
    }
