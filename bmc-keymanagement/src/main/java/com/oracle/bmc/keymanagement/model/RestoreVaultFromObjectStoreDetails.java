...
/**
 * The details of the backup location from which you want to restore the Vault. <br>
...
public final class RestoreVaultFromObjectStoreDetails
    ...
    public static class Builder {
        ...
        public RestoreVaultFromObjectStoreDetails build() {
            RestoreVaultFromObjectStoreDetails model =
                    new RestoreVaultFromObjectStoreDetails(this.backupLocation);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestoreVaultFromObjectStoreDetails model) {
