...
public final class RestoreVaultFromObjectStoreDetails {
    ...
    public static class Builder {
        ...
        public RestoreVaultFromObjectStoreDetails build() {
            RestoreVaultFromObjectStoreDetails __instance__ =
                    new RestoreVaultFromObjectStoreDetails(backupLocation);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestoreVaultFromObjectStoreDetails o) {
