...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = VaultReplicaDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class VaultReplicaDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"replicationId"})
    public VaultReplicaDetails(String replicationId) {
        super();
    ...
    public static class Builder {
        ...
        public VaultReplicaDetails build() {
            VaultReplicaDetails model = new VaultReplicaDetails(this.replicationId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VaultReplicaDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VaultReplicaDetails)) {
            return false;
        }

        VaultReplicaDetails other = (VaultReplicaDetails) o;
