...
public class CreateKeyVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateKeyVersionResponse> {
        ...
        public CreateKeyVersionResponse build() {
            return new CreateKeyVersionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKeyVersionResponse)) {
            return false;
        }

        CreateKeyVersionResponse other = (CreateKeyVersionResponse) o;
