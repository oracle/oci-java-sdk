...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/keymanagement/ListKeysExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListKeysRequest.
 */
...
public class ListKeysRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListKeysRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListKeysRequest(compartmentId, limit, page, opcRequestId, sortBy, sortOrder, protectionMode, algorithm, length, curveId);
        }
    }
