...
public class GetKeyVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetKeyVersionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetKeyVersionResponse)) {
            return false;
        }

        GetKeyVersionResponse other = (GetKeyVersionResponse) o;
