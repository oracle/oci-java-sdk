...
public final class ScheduleVaultDeletionDetails
    ...
    public static class Builder {
        ...
        public ScheduleVaultDeletionDetails build() {
            ScheduleVaultDeletionDetails model =
                    new ScheduleVaultDeletionDetails(this.timeOfDeletion);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ScheduleVaultDeletionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleVaultDeletionDetails)) {
            return false;
        }

        ScheduleVaultDeletionDetails other = (ScheduleVaultDeletionDetails) o;
