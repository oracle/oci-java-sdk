...
public class KmsHsmClusterPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHsmClusters operation. This iterable
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.keymanagement.model.HsmClusterSummary} objects
     * contained in responses from the listHsmClusters operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.keymanagement.model.HsmClusterSummary} objects
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listHsmPartitions operation. This iterable
     * will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the responses received from the service.
    ...
    public Iterable<ListHsmPartitionsResponse> listHsmPartitionsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListHsmPartitionsRequest.Builder, ListHsmPartitionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.keymanagement.model.HsmPartitionSummary} objects
     * contained in responses from the listHsmPartitions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.keymanagement.model.HsmPartitionSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.keymanagement.model.HsmPartitionSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListHsmPartitionsRequest.Builder, ListHsmPartitionsRequest,
                ListHsmPartitionsResponse, com.oracle.bmc.keymanagement.model.HsmPartitionSummary>(
                new java.util.function.Supplier<ListHsmPartitionsRequest.Builder>() {
                    @Override
                    public ListHsmPartitionsRequest.Builder get() {
                        return ListHsmPartitionsRequest.builder().copy(request);
