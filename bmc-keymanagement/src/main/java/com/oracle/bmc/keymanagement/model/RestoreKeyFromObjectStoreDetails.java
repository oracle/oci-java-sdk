...
public final class RestoreKeyFromObjectStoreDetails {
    ...
    public static class Builder {
        ...
        public RestoreKeyFromObjectStoreDetails build() {
            RestoreKeyFromObjectStoreDetails __instance__ =
                    new RestoreKeyFromObjectStoreDetails(backupLocation);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RestoreKeyFromObjectStoreDetails o) {
            Builder copiedBuilder = backupLocation(o.getBackupLocation());
