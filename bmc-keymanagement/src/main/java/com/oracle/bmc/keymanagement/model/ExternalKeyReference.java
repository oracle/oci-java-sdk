...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ExternalKeyReference.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ExternalKeyReference extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"externalKeyId"})
    public ExternalKeyReference(String externalKeyId) {
        super();
    ...
    public static class Builder {
        ...
        public ExternalKeyReference build() {
            ExternalKeyReference model = new ExternalKeyReference(this.externalKeyId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalKeyReference model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExternalKeyReference(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExternalKeyReference)) {
            return false;
        }

        ExternalKeyReference other = (ExternalKeyReference) o;
