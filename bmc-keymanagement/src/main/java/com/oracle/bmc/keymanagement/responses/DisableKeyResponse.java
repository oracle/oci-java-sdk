...
public class DisableKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DisableKeyResponse> {
        ...
        public DisableKeyResponse build() {
            return new DisableKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DisableKeyResponse)) {
            return false;
        }

        DisableKeyResponse other = (DisableKeyResponse) o;
