...
public class GetVaultResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetVaultResponse> {
        ...
        public GetVaultResponse build() {
            return new GetVaultResponse(__httpStatusCode__, headers, etag, opcRequestId, vault);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVaultResponse)) {
            return false;
        }

        GetVaultResponse other = (GetVaultResponse) o;
