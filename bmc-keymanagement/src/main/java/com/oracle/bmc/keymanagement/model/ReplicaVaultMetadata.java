...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "vaultType",
    defaultImpl = ReplicaVaultMetadata.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = ReplicaExternalVaultMetadata.class,
        name = "EXTERNAL"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class ReplicaVaultMetadata extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected ReplicaVaultMetadata() {
        super();
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ReplicaVaultMetadata(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicaVaultMetadata)) {
            return false;
        }

        ReplicaVaultMetadata other = (ReplicaVaultMetadata) o;
