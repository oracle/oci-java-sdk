...
public class ExportKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code ExportedKeyData} instance. */
     ...
     * @return the value
     */
    public com.oracle.bmc.keymanagement.model.ExportedKeyData getExportedKeyData() {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ExportKeyResponse> {
         ...
         * The returned {@code ExportedKeyData} instance.
         *
         * @param exportedKeyData the value to set
         * @return this builder
         */
        public Builder exportedKeyData(
                com.oracle.bmc.keymanagement.model.ExportedKeyData exportedKeyData) {
            this.exportedKeyData = exportedKeyData;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",exportedKeyData=").append(String.valueOf(exportedKeyData));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        ExportKeyResponse other = (ExportKeyResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.exportedKeyData, other.exportedKeyData);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.exportedKeyData == null ? 43 : this.exportedKeyData.hashCode());
        return result;
    }
}
