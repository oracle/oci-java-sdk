...
/**
 * Dedicated KMS-HSM Cluster Management <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = HsmCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class HsmCluster extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * A user-friendly display name for the HSMCluster resource. It does not have to be unique,
        ...
        /**
         * The date and time this HSM resource was created, expressed in [RFC
        ...
        /**
         * The date and time this HSM resource was updated, expressed in [RFC
         * 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
         *
         * <p>Example: {@code 2023-04-03T21:10:29.600Z}
         */
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HsmCluster model) {
    ...
    /**
     * A user-friendly display name for the HSMCluster resource. It does not have to be unique, and
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HsmCluster)) {
            return false;
        }

        HsmCluster other = (HsmCluster) o;
