...
public class CreateKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateKeyResponse> {
        ...
        public CreateKeyResponse build() {
            return new CreateKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateKeyResponse)) {
            return false;
        }

        CreateKeyResponse other = (CreateKeyResponse) o;
