...
public class UpdateVaultResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateVaultResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateVaultResponse o) {
        ...
        public UpdateVaultResponse build() {
            return new UpdateVaultResponse(__httpStatusCode__, headers, etag, opcRequestId, vault);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVaultResponse)) {
            return false;
        }

        UpdateVaultResponse other = (UpdateVaultResponse) o;
