...
public class EkmPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listEkmsPrivateEndpoints operation. This iterable
    ...
    public Iterable<ListEkmsPrivateEndpointsResponse> listEkmsPrivateEndpointsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListEkmsPrivateEndpointsRequest.Builder, ListEkmsPrivateEndpointsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.keymanagement.model.EkmsPrivateEndpointSummary} objects
     * contained in responses from the listEkmsPrivateEndpoints operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.keymanagement.model.EkmsPrivateEndpointSummary} objects
