...
public class ImportKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ImportKeyResponse> {
         ...
         */
        @Override
        public ImportKeyResponse build() {
            return new ImportKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportKeyResponse)) {
            return false;
        }

        ImportKeyResponse other = (ImportKeyResponse) o;
