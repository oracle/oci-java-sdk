...
public class EnableKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<EnableKeyResponse> {
        ...
        public EnableKeyResponse build() {
            return new EnableKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableKeyResponse)) {
            return false;
        }

        EnableKeyResponse other = (EnableKeyResponse) o;
