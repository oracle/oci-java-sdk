...
public class ScheduleVaultDeletionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ScheduleVaultDeletionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScheduleVaultDeletionResponse)) {
            return false;
        }

        ScheduleVaultDeletionResponse other = (ScheduleVaultDeletionResponse) o;
