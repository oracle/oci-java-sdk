...
public class GetKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetKeyResponse> {
         ...
         */
        @Override
        public Builder copy(GetKeyResponse o) {
        ...
        public GetKeyResponse build() {
            return new GetKeyResponse(__httpStatusCode__, headers, etag, opcRequestId, key);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetKeyResponse)) {
            return false;
        }

        GetKeyResponse other = (GetKeyResponse) o;
