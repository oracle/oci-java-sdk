...
public class CancelKeyDeletionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CancelKeyDeletionResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CancelKeyDeletionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CancelKeyDeletionResponse)) {
            return false;
        }

        CancelKeyDeletionResponse other = (CancelKeyDeletionResponse) o;
