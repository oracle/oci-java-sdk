...
public class ImportKeyVersionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ImportKeyVersionResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportKeyVersionResponse)) {
            return false;
        }

        ImportKeyVersionResponse other = (ImportKeyVersionResponse) o;
