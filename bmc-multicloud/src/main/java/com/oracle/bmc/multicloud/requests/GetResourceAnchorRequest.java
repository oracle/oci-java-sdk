...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/GetResourceAnchorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetResourceAnchorRequest.
 */
...
public class GetResourceAnchorRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetResourceAnchorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetResourceAnchorRequest(resourceAnchorId, subscriptionServiceName, subscriptionId, opcRequestId, shouldFetchCompartmentName);
        }
    }
