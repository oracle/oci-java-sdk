...
public interface MulticloudAlerts extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/ListMulticloudAlertsExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListMulticloudAlerts API.
     */
    ListMulticloudAlertsResponse listMulticloudAlerts(ListMulticloudAlertsRequest request);
     ...
     */
    MulticloudAlertsPaginators getPaginators();
}
