...
public class MetadataClient implements Metadata {
    /**
    ...
    public ListExternalLocationDetailsMetadataResponse listExternalLocationDetailsMetadata(
        ...
        LOG.trace("Called listExternalLocationDetailsMetadata");
        final ListExternalLocationDetailsMetadataRequest interceptedRequest =
                ListExternalLocationDetailsMetadataConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListExternalLocationDetailsMetadataConverter.fromRequest(
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, ListExternalLocationDetailsMetadataResponse>
                transformer =
                        ListExternalLocationDetailsMetadataConverter.fromResponse(
    ...
    public ListExternalLocationMappingMetadataResponse listExternalLocationMappingMetadata(
        ...
        LOG.trace("Called listExternalLocationMappingMetadata");
        final ListExternalLocationMappingMetadataRequest interceptedRequest =
                ListExternalLocationMappingMetadataConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListExternalLocationMappingMetadataConverter.fromRequest(
                        client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, ListExternalLocationMappingMetadataResponse>
                transformer =
                        ListExternalLocationMappingMetadataConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
    ...
    public ListExternalLocationSummariesMetadataResponse listExternalLocationSummariesMetadata(
        ...
        LOG.trace("Called listExternalLocationSummariesMetadata");
        final ListExternalLocationSummariesMetadataRequest interceptedRequest =
                ListExternalLocationSummariesMetadataConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListExternalLocationSummariesMetadataConverter.fromRequest(
                        client, interceptedRequest);
        ...
        java.util.function.Function<
                        javax.ws.rs.core.Response, ListExternalLocationSummariesMetadataResponse>
                transformer =
                        ListExternalLocationSummariesMetadataConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
