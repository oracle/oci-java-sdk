 ...
 * to any list operations of OmhubNetworkAnchor where multiple pages of data may be fetched.
...
public class OmhubNetworkAnchorPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listNetworkAnchors operation. This iterable
    ...
    public Iterable<ListNetworkAnchorsResponse> listNetworkAnchorsResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListNetworkAnchorsRequest.Builder, ListNetworkAnchorsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.multicloud.model.NetworkAnchorSummary} objects
     * contained in responses from the listNetworkAnchors operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.multicloud.model.NetworkAnchorSummary} objects
    ...
    public Iterable<com.oracle.bmc.multicloud.model.NetworkAnchorSummary>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ListNetworkAnchorsRequest.Builder, ListNetworkAnchorsRequest,
                ListNetworkAnchorsResponse, com.oracle.bmc.multicloud.model.NetworkAnchorSummary>(
                new java.util.function.Supplier<ListNetworkAnchorsRequest.Builder>() {
                    @Override
                    public ListNetworkAnchorsRequest.Builder get() {
                        return ListNetworkAnchorsRequest.builder().copy(request);
