...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/ListNetworkAnchorsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListNetworkAnchorsRequest.
 */
...
public class ListNetworkAnchorsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListNetworkAnchorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListNetworkAnchorsRequest(compartmentId, subscriptionId, subscriptionServiceName, networkAnchorLifecycleState, displayName, externalLocation, networkAnchorOciSubnetId, compartmentIdInSubtree, networkAnchorOciVcnId, id, limit, page, shouldFetchVcnName, sortOrder, sortBy, opcRequestId);
        }
    }
