...
public class MulticloudsubscriptionsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMulticloudSubscriptions operation. This iterable
    ...
    public Iterable<ListMulticloudSubscriptionsResponse>
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMulticloudSubscriptionsRequest.Builder, ListMulticloudSubscriptionsRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.multicloud.model.MulticloudSubscriptionSummary} objects
     * contained in responses from the listMulticloudSubscriptions operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.multicloud.model.MulticloudSubscriptionSummary} objects
