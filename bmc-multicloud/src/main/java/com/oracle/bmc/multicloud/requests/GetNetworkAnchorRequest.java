...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/GetNetworkAnchorExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetNetworkAnchorRequest.
 */
...
public class GetNetworkAnchorRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetNetworkAnchorRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetNetworkAnchorRequest(networkAnchorId, subscriptionServiceName, subscriptionId, opcRequestId, externalLocation, shouldFetchVcnName);
        }
    }
