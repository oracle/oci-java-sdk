...
public interface Metadata extends AutoCloseable {
     ...
     * Availability Zones, and Cluster Placement Group ID.
     *
    ...
    /**
     * List mapped partner cloud regions and zones across cloud service providers for the specified
     * Multicloud base compartment and subscription service name. Each mapping includes the OCI
     * region, logical availability domain, and physical availability domain, along with mapped
     * partner cloud details that depend on the partner cloud. For example, Azure includes a logical
     * zone while AWS doesn't. For more information, see [Cross-Cloud Region-Zone
     * Mapping](https://docs.oracle.com/iaas/Content/multicloud-hub/view-cloud-mapping.htm).
     *
     * @param request The request object containing the details to send
     * @return A response object containing details about the completed operation
     * @throws BmcException when an error occurs. This operation uses
