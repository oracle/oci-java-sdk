...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/ListResourceAnchorsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListResourceAnchorsRequest.
 */
...
public class ListResourceAnchorsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListResourceAnchorsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListResourceAnchorsRequest(compartmentId, linkedCompartmentId, lifecycleState, displayName, id, limit, page, sortOrder, sortBy, isCompartmentIdInSubtree, shouldFetchCompartmentName, subscriptionServiceName, subscriptionId, opcRequestId);
        }
    }
