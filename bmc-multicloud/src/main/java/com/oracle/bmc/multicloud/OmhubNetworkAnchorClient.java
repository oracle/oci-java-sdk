...
public class OmhubNetworkAnchorClient implements OmhubNetworkAnchor {
    /**
     ...
     */
    protected OmhubNetworkAnchorClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
    ...
    public GetNetworkAnchorResponse getNetworkAnchor(GetNetworkAnchorRequest request) {
        LOG.trace("Called getNetworkAnchor");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetNetworkAnchorResponse>
                transformer =
    ...
    public ListNetworkAnchorsResponse listNetworkAnchors(ListNetworkAnchorsRequest request) {
        LOG.trace("Called listNetworkAnchors");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListNetworkAnchorsResponse>
                transformer =
