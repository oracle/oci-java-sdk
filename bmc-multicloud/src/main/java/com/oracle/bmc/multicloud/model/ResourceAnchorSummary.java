...
/**
 * The properties that define a resource anchor. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ResourceAnchorSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ResourceAnchorSummary
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder lifecycleState(ResourceAnchor.LifecycleState lifecycleState) {
            this.lifecycleState = lifecycleState;
        ...
        /**
         * The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the
         * optional OCI compartment that was created or linked with the resource anchor. This
         * compartment is different from the compartment that contains the resource anchor.
         */
        ...
        /**
         * The name of the optional OCI compartment that was created or linked with the resource
         * anchor. This compartment is different from the compartment that contains the resource
         * anchor.
         */
        ...
        public ResourceAnchorSummary build() {
            ResourceAnchorSummary model =
                    new ResourceAnchorSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResourceAnchorSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ResourceAnchorSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceAnchorSummary)) {
            return false;
        }

        ResourceAnchorSummary other = (ResourceAnchorSummary) o;
