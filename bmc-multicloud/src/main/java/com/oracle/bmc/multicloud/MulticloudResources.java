...
public interface MulticloudResources extends AutoCloseable {
     ...
     *
     * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/multicloud/ListMulticloudResourcesExample.java.html" target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListMulticloudResources API.
     */
    ListMulticloudResourcesResponse listMulticloudResources(ListMulticloudResourcesRequest request);
     ...
     */
    MulticloudResourcesPaginators getPaginators();
}
