...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ExternalLocation.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ExternalLocation extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExternalLocation model) {
    ...
    public boolean equals(Object o) {
        ...
        ExternalLocation other = (ExternalLocation) o;
