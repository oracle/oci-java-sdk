...
/**
 * Async client implementation for Metadata service. <br>
...
public class MetadataAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements MetadataAsync {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(MetadataAsyncClient.class);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, MetadataAsyncClient> {
         ...
         * @return the client
         */
        public MetadataAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new MetadataAsyncClient(this, authenticationDetailsProvider);
        }
    }
    ...
    @Override
    public java.util.concurrent.Future<ListExternalLocationDetailsMetadataResponse>
    ...
    @Override
    public java.util.concurrent.Future<ListExternalLocationMappingMetadataResponse>
    ...
    @Override
    public java.util.concurrent.Future<ListExternalLocationSummariesMetadataResponse>
