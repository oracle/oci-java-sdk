...
public class ListExternalLocationDetailsMetadataConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListExternalLocationDetailsMetadataConverter.class);

    public static com.oracle.bmc.multicloud.requests.ListExternalLocationDetailsMetadataRequest
            interceptRequest(
                    com.oracle.bmc.multicloud.requests.ListExternalLocationDetailsMetadataRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.multicloud.requests.ListExternalLocationDetailsMetadataRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20180828").path("externalLocationsMetadata");
        ...
        if (request.getLogicalZone() != null) {
            target =
                    target.queryParam(
                            "logicalZone",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getLogicalZone()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.multicloud.responses.ListExternalLocationDetailsMetadataResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.multicloud.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.multicloud.responses.ListExternalLocationDetailsMetadataResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.externalLocationsMetadatumCollection(response.getItem());
