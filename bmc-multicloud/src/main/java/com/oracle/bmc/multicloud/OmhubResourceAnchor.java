...
public interface OmhubResourceAnchor extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetResourceAnchor
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListResourceAnchors
     *     API.
     */
