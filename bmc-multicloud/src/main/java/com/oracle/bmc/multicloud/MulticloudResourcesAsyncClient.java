...
public class MulticloudResourcesAsyncClient extends com.oracle.bmc.http.internal.BaseAsyncClient
        implements MulticloudResourcesAsync {
    ...
    MulticloudResourcesAsyncClient(
    ...
    public static class Builder
        ...
        public MulticloudResourcesAsyncClient build(
                @jakarta.annotation.Nonnull
                        com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider
                                authenticationDetailsProvider) {
            return new MulticloudResourcesAsyncClient(this, authenticationDetailsProvider);
        }
    }
