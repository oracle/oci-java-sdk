...
public interface MulticloudPoliciesAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ListMulticloudPoliciesResponse> listMulticloudPolicies(
            ListMulticloudPoliciesRequest request,
            com.oracle.bmc.responses.AsyncHandler<
                            ListMulticloudPoliciesRequest, ListMulticloudPoliciesResponse>
                    handler);
}
