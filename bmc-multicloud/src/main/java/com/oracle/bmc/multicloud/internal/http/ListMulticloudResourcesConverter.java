...
public class ListMulticloudResourcesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListMulticloudResourcesConverter.class);

    public static com.oracle.bmc.multicloud.requests.ListMulticloudResourcesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getResourceAnchorId() != null) {
            target =
                    target.queryParam(
                            "resourceAnchorId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getResourceAnchorId()));
        }
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.multicloud.responses.ListMulticloudResourcesResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.multicloud.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.multicloud.responses.ListMulticloudResourcesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.multicloud.responses.ListMulticloudResourcesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.multicloud.responses
                                                        .ListMulticloudResourcesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.multicloudResourceCollection(response.getItem());
