 ...
 * to any list operations of MulticloudResources where multiple pages of data may be fetched.
...
public class MulticloudResourcesPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the responses received from the listMulticloudResources operation. This iterable
    ...
    public Iterable<ListMulticloudResourcesResponse> listMulticloudResourcesResponseIterator(
        ...
        return new com.oracle.bmc.paginator.internal.ResponseIterable<
                ListMulticloudResourcesRequest.Builder, ListMulticloudResourcesRequest,
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.multicloud.model.MulticloudResourceSummary} objects
     * contained in responses from the listMulticloudResources operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.multicloud.model.MulticloudResourceSummary} objects
