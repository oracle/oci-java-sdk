...
/**
 * A missing IAM policy required for multicloud operation. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = MulticloudPolicy.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MulticloudPolicy
    ...
    public static class Builder {
        ...
        public MulticloudPolicy build() {
            MulticloudPolicy model =
                    new MulticloudPolicy(
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MulticloudPolicy model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MulticloudPolicy)) {
            return false;
        }

        MulticloudPolicy other = (MulticloudPolicy) o;
