...
public interface OmhubNetworkAnchor extends AutoCloseable {
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use GetNetworkAnchor
     *     API.
     */
     ...
     *     target="_blank" rel="noopener noreferrer" >here</a> to see how to use ListNetworkAnchors
     *     API.
     */
