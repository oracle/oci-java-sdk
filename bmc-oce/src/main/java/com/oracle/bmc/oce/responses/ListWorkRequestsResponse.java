...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.oce.model.WorkRequest> getItems() {
        return items;
    }
    ...
    private ListWorkRequestsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.oce.model.WorkRequest> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.oce.model.WorkRequest> items) {
            this.items = items;
            return this;
        }
