...
public class OceInstanceClient implements OceInstance {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(OceInstanceClient.class);
    ...
    public ChangeOceInstanceCompartmentResponse changeOceInstanceCompartment(
        ...
        LOG.trace("Called changeOceInstanceCompartment");
        final ChangeOceInstanceCompartmentRequest interceptedRequest =
                ChangeOceInstanceCompartmentConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ChangeOceInstanceCompartmentConverter.fromRequest(client, interceptedRequest);
    ...
    public CreateOceInstanceResponse createOceInstance(CreateOceInstanceRequest request) {
        LOG.trace("Called createOceInstance");
        final CreateOceInstanceRequest interceptedRequest =
                CreateOceInstanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateOceInstanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteOceInstanceResponse deleteOceInstance(DeleteOceInstanceRequest request) {
        LOG.trace("Called deleteOceInstance");
        final DeleteOceInstanceRequest interceptedRequest =
                DeleteOceInstanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public GetOceInstanceResponse getOceInstance(GetOceInstanceRequest request) {
        LOG.trace("Called getOceInstance");
        final GetOceInstanceRequest interceptedRequest =
                GetOceInstanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public ListOceInstancesResponse listOceInstances(ListOceInstancesRequest request) {
        LOG.trace("Called listOceInstances");
        final ListOceInstancesRequest interceptedRequest =
                ListOceInstancesConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
    ...
    public UpdateOceInstanceResponse updateOceInstance(UpdateOceInstanceRequest request) {
        LOG.trace("Called updateOceInstance");
        final UpdateOceInstanceRequest interceptedRequest =
                UpdateOceInstanceConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateOceInstanceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
