...
public class OceInstanceWaiters {
    ...
    public OceInstanceWaiters(
            java.util.concurrent.ExecutorService executorService, OceInstance client) {
    ...
    // Helper method to create a new Waiter for OceInstance.
    private com.oracle.bmc.waiter.Waiter<GetOceInstanceRequest, GetOceInstanceResponse>
            forOceInstance(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            public GetOceInstanceResponse apply(GetOceInstanceRequest request) {
                                return client.getOceInstance(request);
                            }
                        },
                        new java.util.function.Predicate<GetOceInstanceResponse>() {
                            @Override
                            public boolean test(GetOceInstanceResponse response) {
