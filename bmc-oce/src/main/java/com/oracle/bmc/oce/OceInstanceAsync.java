 ...
 * and accelerate experience delivery
 */
...
public interface OceInstanceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeOceInstanceCompartmentResponse> changeOceInstanceCompartment(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateOceInstanceResponse> createOceInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteOceInstanceResponse> deleteOceInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetOceInstanceResponse> getOceInstance(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListOceInstancesResponse> listOceInstances(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateOceInstanceResponse> updateOceInstance(
