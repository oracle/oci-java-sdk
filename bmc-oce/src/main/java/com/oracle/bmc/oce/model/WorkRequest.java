...
public final class WorkRequest extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("workflowMonitor")
        private WorkflowMonitor workflowMonitor;

        public Builder workflowMonitor(WorkflowMonitor workflowMonitor) {
            this.workflowMonitor = workflowMonitor;
            this.__explicitlySet__.add("workflowMonitor");
            return this;
        }
        ...
        public Builder copy(WorkRequest model) {
            ...
            if (model.wasPropertyExplicitlySet("workflowMonitor")) {
                this.workflowMonitor(model.getWorkflowMonitor());
            }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append(", workflowMonitor=").append(String.valueOf(this.workflowMonitor));
    ...
    public boolean equals(Object o) {
        ...
        return java.util.Objects.equals(this.operationType, other.operationType)
                ...
                && java.util.Objects.equals(this.workflowMonitor, other.workflowMonitor)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.workflowMonitor == null ? 43 : this.workflowMonitor.hashCode());
        result =
                (result * PRIME)
