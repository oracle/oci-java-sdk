...
public class GetBaselineableMetricResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetBaselineableMetricResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetBaselineableMetricResponse> {
         ...
         */
        @Override
        public Builder copy(GetBaselineableMetricResponse o) {
         ...
         */
        @Override
        public GetBaselineableMetricResponse build() {
            return new GetBaselineableMetricResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBaselineableMetricResponse)) {
            return false;
        }

        GetBaselineableMetricResponse other = (GetBaselineableMetricResponse) o;
