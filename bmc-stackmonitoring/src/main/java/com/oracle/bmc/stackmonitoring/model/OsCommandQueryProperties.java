...
/**
 * Query Properties applicable to OS_COMMAND type of collection method <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = OsCommandQueryProperties.Builder.class)
...
public final class OsCommandQueryProperties extends MetricExtensionQueryProperties {
    ...
    public static class Builder {
        ...
        public OsCommandQueryProperties build() {
            OsCommandQueryProperties model =
                    new OsCommandQueryProperties(
                            this.command,
                            this.delimiter,
                            this.scriptDetails,
                            this.arguments,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OsCommandQueryProperties model) {
    ...
    @Deprecated
    public OsCommandQueryProperties(
            String command,
            String delimiter,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OsCommandQueryProperties)) {
            return false;
        }

        OsCommandQueryProperties other = (OsCommandQueryProperties) o;
