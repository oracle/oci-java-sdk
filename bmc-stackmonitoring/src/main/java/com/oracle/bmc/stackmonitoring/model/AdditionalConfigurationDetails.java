...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AdditionalConfigurationDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AdditionalConfigurationDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"propertiesMap"})
    public AdditionalConfigurationDetails(java.util.Map<String, String> propertiesMap) {
        super();
    ...
    public static class Builder {
        ...
        public AdditionalConfigurationDetails build() {
            AdditionalConfigurationDetails model =
                    new AdditionalConfigurationDetails(this.propertiesMap);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AdditionalConfigurationDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AdditionalConfigurationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdditionalConfigurationDetails)) {
            return false;
        }

        AdditionalConfigurationDetails other = (AdditionalConfigurationDetails) o;
