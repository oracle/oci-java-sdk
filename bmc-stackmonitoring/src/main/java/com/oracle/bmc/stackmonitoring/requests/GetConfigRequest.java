...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/GetConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetConfigRequest.
 */
...
public class GetConfigRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetConfigRequest(configId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().configId(configId).opcRequestId(opcRequestId);
    }
