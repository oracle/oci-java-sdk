...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    defaultImpl = MaintenanceWindowSchedule.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = RecurrentMaintenanceWindowSchedule.class,
        name = "RECURRENT"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = OneTimeMaintenanceWindowSchedule.class,
        name = "ONE_TIME"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class MaintenanceWindowSchedule extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({})
    protected MaintenanceWindowSchedule() {
        super();
    }
