...
public final class CreateAlarmConditionDetails
    ...
    public CreateAlarmConditionDetails(
            String namespace,
    ...
    public static class Builder {
        ...
        public CreateAlarmConditionDetails build() {
            CreateAlarmConditionDetails model =
                    new CreateAlarmConditionDetails(
                            this.namespace,
                            this.compositeType,
                            this.resourceType,
                            this.metricName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAlarmConditionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAlarmConditionDetails)) {
            return false;
        }

        CreateAlarmConditionDetails other = (CreateAlarmConditionDetails) o;
