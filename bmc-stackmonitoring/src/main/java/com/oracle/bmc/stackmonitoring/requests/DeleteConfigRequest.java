...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/DeleteConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteConfigRequest.
 */
...
public class DeleteConfigRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteConfigRequest, java.lang.Void> {
        ...
        public DeleteConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteConfigRequest(configId, ifMatch, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().configId(configId).ifMatch(ifMatch).opcRequestId(opcRequestId);
    }
