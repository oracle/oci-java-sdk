...
public class CreateBaselineableMetricConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateBaselineableMetricConverter.class);

    public static com.oracle.bmc.stackmonitoring.requests.CreateBaselineableMetricRequest
            interceptRequest(
                    com.oracle.bmc.stackmonitoring.requests.CreateBaselineableMetricRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.stackmonitoring.requests.CreateBaselineableMetricRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210330").path("baselineableMetrics");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.stackmonitoring.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.stackmonitoring.responses.CreateBaselineableMetricResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.baselineableMetric(response.getItem());
