...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateBaselineableMetricDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateBaselineableMetricDetails
    ...
    public UpdateBaselineableMetricDetails(
            String id,
    ...
    public static class Builder {
        ...
        public UpdateBaselineableMetricDetails build() {
            UpdateBaselineableMetricDetails model =
                    new UpdateBaselineableMetricDetails(
                            this.id,
                            this.lifecycleState,
                            this.tenancyId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateBaselineableMetricDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateBaselineableMetricDetails)) {
            return false;
        }

        UpdateBaselineableMetricDetails other = (UpdateBaselineableMetricDetails) o;
