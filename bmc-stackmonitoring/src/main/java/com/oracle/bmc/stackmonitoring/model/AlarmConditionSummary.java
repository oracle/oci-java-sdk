...
public final class AlarmConditionSummary
    ...
    public static class Builder {
        ...
        public AlarmConditionSummary build() {
            AlarmConditionSummary model =
                    new AlarmConditionSummary(
                            this.id,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AlarmConditionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AlarmConditionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AlarmConditionSummary)) {
            return false;
        }

        AlarmConditionSummary other = (AlarmConditionSummary) o;
