...
public class ListConfigsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.stackmonitoring.model.ConfigCollection configCollection;
     ...
     * @return the value
     */
    public com.oracle.bmc.stackmonitoring.model.ConfigCollection getConfigCollection() {
    ...
    private ListConfigsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            com.oracle.bmc.stackmonitoring.model.ConfigCollection configCollection) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListConfigsResponse> {
        ...
        public ListConfigsResponse build() {
            return new ListConfigsResponse(
                    __httpStatusCode__, headers, opcRequestId, opcNextPage, configCollection);
        }
    }
