...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/ListAlarmConditionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAlarmConditionsRequest.
 */
...
public class ListAlarmConditionsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAlarmConditionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAlarmConditionsRequest(monitoringTemplateId, limit, page, sortBy, sortOrder, status, lifecycleState, resourceTypes, metricName, opcRequestId);
        }
    }
