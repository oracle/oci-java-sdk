...
public class CreateMonitoredResourceConverter {
    ...
    public static com.oracle.bmc.stackmonitoring.requests.CreateMonitoredResourceRequest
            interceptRequest(
                    com.oracle.bmc.stackmonitoring.requests.CreateMonitoredResourceRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.stackmonitoring.requests.CreateMonitoredResourceRequest request) {
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210330").path("monitoredResources");
        ...
        if (request.getExternalResourceId() != null) {
            ib.header("external-resource-id", request.getExternalResourceId());
        }
    ...
    public static com.google.common.base.Function<
                    ...
                    com.oracle.bmc.stackmonitoring.responses.CreateMonitoredResourceResponse>
            fromResponse() {
                ...
                transformer =
                        new com.google.common.base.Function<
                            ...
                            public com.oracle.bmc.stackmonitoring.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.stackmonitoring.responses.CreateMonitoredResourceResponse");
                                ...
                                if (opcMonitoredResourceIdHeader.isPresent()) {
                                    builder.opcMonitoredResourceId(
                                            com.oracle.bmc.http.internal.HeaderUtils.toValue(
                                                    ...
                                                    opcMonitoredResourceIdHeader.get().get(0),
                                                    String.class));
                                }
