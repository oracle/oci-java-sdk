...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/UpdateBaselineableMetricExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBaselineableMetricRequest.
 */
...
public class UpdateBaselineableMetricRequest
    ...
    public static class Builder
        ...
        public UpdateBaselineableMetricRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateBaselineableMetricRequest(updateBaselineableMetricDetails, baselineableMetricId, ifMatch, opcRequestId);
        }
    }
