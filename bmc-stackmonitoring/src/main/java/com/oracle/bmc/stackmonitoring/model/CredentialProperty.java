...
public final class CredentialProperty
    ...
    public static class Builder {
        ...
        public CredentialProperty build() {
            CredentialProperty model = new CredentialProperty(this.name, this.value);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CredentialProperty model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CredentialProperty)) {
            return false;
        }

        CredentialProperty other = (CredentialProperty) o;
