...
public class ListDiscoveryJobsConverter {
    ...
    public static com.oracle.bmc.stackmonitoring.requests.ListDiscoveryJobsRequest interceptRequest(
            com.oracle.bmc.stackmonitoring.requests.ListDiscoveryJobsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20210330").path("discoveryJobs");
