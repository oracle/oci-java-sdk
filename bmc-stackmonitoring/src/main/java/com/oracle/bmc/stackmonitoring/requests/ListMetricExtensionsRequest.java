...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/ListMetricExtensionsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMetricExtensionsRequest.
 */
...
public class ListMetricExtensionsRequest
    ...
    public static class Builder
        ...
        public ListMetricExtensionsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMetricExtensionsRequest(limit, page, sortBy, sortOrder, compartmentId, resourceType, name, status, lifecycleState, enabledOnResourceId, metricExtensionId, opcRequestId);
        }
    }
