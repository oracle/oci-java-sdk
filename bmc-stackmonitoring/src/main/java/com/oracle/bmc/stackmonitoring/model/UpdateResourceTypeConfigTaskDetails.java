...
/**
 * Update the availability metrics and the handler configuration for the telegraf/collectd resource
 * types. <br>
...
public final class UpdateResourceTypeConfigTaskDetails extends MonitoredResourceTaskDetails {
    ...
    public static class Builder {
        ...
        /**
         * A collection of resource type configuration details. User can provide availability proxy
         * metrics list for resource types along with the telegraf/collectd handler configuration
    ...
    /**
     * A collection of resource type configuration details. User can provide availability proxy
     * metrics list for resource types along with the telegraf/collectd handler configuration for
     * the resource types.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("resourceTypesConfiguration")
