...
public final class MonitoredResourceDetails
    ...
    public MonitoredResourceDetails(
            String resourceId, String name, String type, Integer numberOfMembers) {
        super();
    ...
    public static class Builder {
        ...
        public MonitoredResourceDetails build() {
            MonitoredResourceDetails model =
                    new MonitoredResourceDetails(
                            this.resourceId, this.name, this.type, this.numberOfMembers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MonitoredResourceDetails model) {
            ...
            if (model.wasPropertyExplicitlySet("numberOfMembers")) {
                this.numberOfMembers(model.getNumberOfMembers());
            }
            return this;
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoredResourceDetails)) {
            return false;
        }

        MonitoredResourceDetails other = (MonitoredResourceDetails) o;
        return java.util.Objects.equals(this.resourceId, other.resourceId)
                && java.util.Objects.equals(this.name, other.name)
                && java.util.Objects.equals(this.type, other.type)
                && java.util.Objects.equals(this.numberOfMembers, other.numberOfMembers)
                && super.equals(other);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.numberOfMembers == null ? 43 : this.numberOfMembers.hashCode());
