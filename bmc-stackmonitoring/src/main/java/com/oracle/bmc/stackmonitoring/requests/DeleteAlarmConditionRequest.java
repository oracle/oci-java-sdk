...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/DeleteAlarmConditionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteAlarmConditionRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20210330")
public class DeleteAlarmConditionRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteAlarmConditionRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteAlarmConditionRequest o) {
        ...
        /**
         * Build the instance of DeleteAlarmConditionRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteAlarmConditionRequest
         */
        public DeleteAlarmConditionRequest build() {
            DeleteAlarmConditionRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteAlarmConditionRequest
         */
        public DeleteAlarmConditionRequest buildWithoutInvocationCallback() {
            DeleteAlarmConditionRequest request = new DeleteAlarmConditionRequest();
            request.alarmConditionId = alarmConditionId;
            request.monitoringTemplateId = monitoringTemplateId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteAlarmConditionRequest(alarmConditionId, monitoringTemplateId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteAlarmConditionRequest)) {
            return false;
        }

        DeleteAlarmConditionRequest other = (DeleteAlarmConditionRequest) o;
