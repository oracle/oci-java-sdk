...
public final class CreateMonitoringTemplateDetails
    ...
    public CreateMonitoringTemplateDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public CreateMonitoringTemplateDetails build() {
            CreateMonitoringTemplateDetails model =
                    new CreateMonitoringTemplateDetails(
                            this.displayName,
                            this.compartmentId,
                            this.description,
                            this.destinations,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateMonitoringTemplateDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMonitoringTemplateDetails)) {
            return false;
        }

        CreateMonitoringTemplateDetails other = (CreateMonitoringTemplateDetails) o;
