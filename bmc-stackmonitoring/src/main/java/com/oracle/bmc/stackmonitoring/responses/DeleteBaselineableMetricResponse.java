...
public class DeleteBaselineableMetricResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private DeleteBaselineableMetricResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(DeleteBaselineableMetricResponse o) {
         ...
         */
        @Override
        public DeleteBaselineableMetricResponse build() {
            return new DeleteBaselineableMetricResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteBaselineableMetricResponse)) {
            return false;
        }

        DeleteBaselineableMetricResponse other = (DeleteBaselineableMetricResponse) o;
