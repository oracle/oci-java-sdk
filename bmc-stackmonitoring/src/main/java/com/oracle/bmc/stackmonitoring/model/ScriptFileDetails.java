...
/**
 * Script details applicable to any OS Command based Metric Extension which needs to run a script to
 * collect data. For removing it during update, set its "content" property to an empty string. In
 * that case, "name" property value is ignored. <br>
...
public final class ScriptFileDetails
