...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateOnboardConfigDetails.Builder.class
)
...
public final class CreateOnboardConfigDetails extends CreateConfigDetails {
    ...
    public static class Builder {
        ...
        public CreateOnboardConfigDetails build() {
            CreateOnboardConfigDetails model =
                    new CreateOnboardConfigDetails(
                            this.displayName,
                            this.compartmentId,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateOnboardConfigDetails model) {
    ...
    @Deprecated
    public CreateOnboardConfigDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateOnboardConfigDetails)) {
            return false;
        }

        CreateOnboardConfigDetails other = (CreateOnboardConfigDetails) o;
