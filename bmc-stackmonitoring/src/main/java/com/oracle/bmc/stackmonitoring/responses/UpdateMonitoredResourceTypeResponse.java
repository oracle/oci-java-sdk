...
public class UpdateMonitoredResourceTypeResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    /**
     * The returned MonitoredResourceType instance.
     */
    ...
    private UpdateMonitoredResourceTypeResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(UpdateMonitoredResourceTypeResponse o) {
         ...
         */
        public UpdateMonitoredResourceTypeResponse build() {
            return new UpdateMonitoredResourceTypeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMonitoredResourceTypeResponse)) {
            return false;
        }

        UpdateMonitoredResourceTypeResponse other = (UpdateMonitoredResourceTypeResponse) o;
