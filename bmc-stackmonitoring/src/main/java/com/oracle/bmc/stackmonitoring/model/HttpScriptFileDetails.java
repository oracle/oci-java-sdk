...
public final class HttpScriptFileDetails
    ...
    public static class Builder {
        ...
        public HttpScriptFileDetails build() {
            HttpScriptFileDetails model = new HttpScriptFileDetails(this.name, this.content);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HttpScriptFileDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("HttpScriptFileDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HttpScriptFileDetails)) {
            return false;
        }

        HttpScriptFileDetails other = (HttpScriptFileDetails) o;
