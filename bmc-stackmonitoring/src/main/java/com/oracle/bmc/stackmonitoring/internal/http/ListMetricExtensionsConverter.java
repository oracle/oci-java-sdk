...
public class ListMetricExtensionsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListMetricExtensionsConverter.class);

    public static com.oracle.bmc.stackmonitoring.requests.ListMetricExtensionsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getEnabledOnResourceId() != null) {
            target =
                    target.queryParam(
                            "enabledOnResourceId",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.stackmonitoring.responses.ListMetricExtensionsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.stackmonitoring.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.stackmonitoring.responses.ListMetricExtensionsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.stackmonitoring.responses
                                                .ListMetricExtensionsResponse.Builder
                                        builder =
                                                com.oracle.bmc.stackmonitoring.responses
                                                        .ListMetricExtensionsResponse.builder()
                                ...
                                builder.metricExtensionCollection(response.getItem());
