...
/**
 * The Resource IDs for which metric extension will be enabled <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EnableMetricExtensionDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EnableMetricExtensionDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"resourceIds"})
    public EnableMetricExtensionDetails(java.util.List<String> resourceIds) {
        super();
    ...
    public static class Builder {
        ...
        public EnableMetricExtensionDetails build() {
            EnableMetricExtensionDetails model = new EnableMetricExtensionDetails(this.resourceIds);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnableMetricExtensionDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnableMetricExtensionDetails)) {
            return false;
        }

        EnableMetricExtensionDetails other = (EnableMetricExtensionDetails) o;
