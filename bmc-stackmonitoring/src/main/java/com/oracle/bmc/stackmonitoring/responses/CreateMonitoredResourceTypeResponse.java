...
public class CreateMonitoredResourceTypeResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateMonitoredResourceTypeResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateMonitoredResourceTypeResponse o) {
         ...
         */
        @Override
        public CreateMonitoredResourceTypeResponse build() {
            return new CreateMonitoredResourceTypeResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMonitoredResourceTypeResponse)) {
            return false;
        }

        CreateMonitoredResourceTypeResponse other = (CreateMonitoredResourceTypeResponse) o;
