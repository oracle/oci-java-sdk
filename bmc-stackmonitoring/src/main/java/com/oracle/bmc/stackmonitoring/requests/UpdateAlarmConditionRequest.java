...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/UpdateAlarmConditionExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAlarmConditionRequest.
 */
...
public class UpdateAlarmConditionRequest
    ...
    public static class Builder
        ...
        public UpdateAlarmConditionRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAlarmConditionRequest(updateAlarmConditionDetails, alarmConditionId, monitoringTemplateId, ifMatch, opcRequestId);
        }
    }
