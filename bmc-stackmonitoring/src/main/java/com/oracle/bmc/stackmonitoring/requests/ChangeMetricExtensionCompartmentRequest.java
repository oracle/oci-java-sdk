...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/ChangeMetricExtensionCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeMetricExtensionCompartmentRequest.
 */
...
public class ChangeMetricExtensionCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeMetricExtensionCompartmentRequest as configured by this builder
         *
        ...
        public ChangeMetricExtensionCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeMetricExtensionCompartmentRequest(metricExtensionId, changeMetricExtensionCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
