...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/ListMonitoredResourcesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMonitoredResourcesRequest.
 */
...
public class ListMonitoredResourcesRequest
    ...
    public static class Builder
        ...
        public ListMonitoredResourcesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMonitoredResourcesRequest(compartmentId, name, workRequestId, status, sortBy, sortOrder, limit, page, opcRequestId);
        }
    }
