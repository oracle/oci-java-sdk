...
/**
 * Summary of an AUTO_PROMOTE config. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutoPromoteConfigSummary.Builder.class)
...
public final class AutoPromoteConfigSummary extends ConfigSummary {
    ...
    public static class Builder {
        ...
        public AutoPromoteConfigSummary build() {
            AutoPromoteConfigSummary model =
                    new AutoPromoteConfigSummary(
                            this.id,
                            this.compartmentId,
                            this.displayName,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutoPromoteConfigSummary model) {
    ...
    @Deprecated
    public AutoPromoteConfigSummary(
            String id,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutoPromoteConfigSummary)) {
            return false;
        }

        AutoPromoteConfigSummary other = (AutoPromoteConfigSummary) o;
