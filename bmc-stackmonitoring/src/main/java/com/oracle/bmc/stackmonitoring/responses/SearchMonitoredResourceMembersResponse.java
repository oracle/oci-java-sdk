...
public class SearchMonitoredResourceMembersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code MonitoredResourceMembersCollection} instance. */
    ...
    public String toString() {
        ...
        sb.append(",monitoredResourceMembersCollection=")
                .append(String.valueOf(monitoredResourceMembersCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchMonitoredResourceMembersResponse)) {
            return false;
        }

        SearchMonitoredResourceMembersResponse other = (SearchMonitoredResourceMembersResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcTotalItems, other.opcTotalItems)
                && java.util.Objects.equals(
                        this.monitoredResourceMembersCollection,
                        other.monitoredResourceMembersCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.monitoredResourceMembersCollection == null
                                ? 43
                                : this.monitoredResourceMembersCollection.hashCode());
        return result;
    }
}
