...
public class GetConfigResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.stackmonitoring.model.Config config;
     ...
     * @return the value
     */
    public com.oracle.bmc.stackmonitoring.model.Config getConfig() {
        return config;
    }
    ...
    private GetConfigResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.stackmonitoring.model.Config config) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetConfigResponse> {
         ...
         * @return this builder
         */
        public Builder config(com.oracle.bmc.stackmonitoring.model.Config config) {
            this.config = config;
            return this;
        }
        ...
        public GetConfigResponse build() {
            return new GetConfigResponse(__httpStatusCode__, headers, etag, opcRequestId, config);
        }
    }
