...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/stackmonitoring/UpdateMonitoredResourceTaskExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateMonitoredResourceTaskRequest.
 */
...
public class UpdateMonitoredResourceTaskRequest
    ...
    public static class Builder
        ...
        public UpdateMonitoredResourceTaskRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateMonitoredResourceTaskRequest(monitoredResourceTaskId, updateMonitoredResourceTaskDetails, ifMatch, opcRequestId);
        }
    }
