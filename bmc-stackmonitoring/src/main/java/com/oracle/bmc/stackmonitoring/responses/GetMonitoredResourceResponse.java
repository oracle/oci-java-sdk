...
public class GetMonitoredResourceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetMonitoredResourceResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetMonitoredResourceResponse> {
         ...
         */
        @Override
        public Builder copy(GetMonitoredResourceResponse o) {
         ...
         */
        @Override
        public GetMonitoredResourceResponse build() {
            return new GetMonitoredResourceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, monitoredResource);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMonitoredResourceResponse)) {
            return false;
        }

        GetMonitoredResourceResponse other = (GetMonitoredResourceResponse) o;
