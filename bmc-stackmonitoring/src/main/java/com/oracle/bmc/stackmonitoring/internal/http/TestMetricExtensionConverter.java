...
public class TestMetricExtensionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(TestMetricExtensionConverter.class);

    public static com.oracle.bmc.stackmonitoring.requests.TestMetricExtensionRequest
            interceptRequest(
                    com.oracle.bmc.stackmonitoring.requests.TestMetricExtensionRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.stackmonitoring.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.stackmonitoring.responses.TestMetricExtensionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.stackmonitoring.responses.TestMetricExtensionResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.stackmonitoring.responses
                                                        .TestMetricExtensionResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.testMetricExtensionData(response.getItem());
