...
/**
 * The summary details for the task. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = MonitoredResourceTaskSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class MonitoredResourceTaskSummary
    ...
    public static class Builder {
        ...
        public MonitoredResourceTaskSummary build() {
            MonitoredResourceTaskSummary model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(MonitoredResourceTaskSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoredResourceTaskSummary)) {
            return false;
        }
