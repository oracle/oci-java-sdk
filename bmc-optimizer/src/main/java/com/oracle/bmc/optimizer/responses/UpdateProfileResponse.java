...
public class UpdateProfileResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateProfileResponse> {
        ...
        public UpdateProfileResponse build() {
            return new UpdateProfileResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, profile);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateProfileResponse)) {
            return false;
        }
