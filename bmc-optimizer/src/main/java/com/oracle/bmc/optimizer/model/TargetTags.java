...
/**
 * Optional. The tags specified in the profile override for a recommendation. <br>
...
public final class TargetTags extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public TargetTags(java.util.List<TargetTag> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public TargetTags build() {
            TargetTags model = new TargetTags(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TargetTags model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TargetTags)) {
            return false;
        }

        TargetTags other = (TargetTags) o;
