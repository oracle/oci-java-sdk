...
public class ListRecommendationStrategiesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code RecommendationStrategyCollection} instance. */
    ...
    public com.oracle.bmc.optimizer.model.RecommendationStrategyCollection
            getRecommendationStrategyCollection() {
        return recommendationStrategyCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder recommendationStrategyCollection(
                com.oracle.bmc.optimizer.model.RecommendationStrategyCollection
                        recommendationStrategyCollection) {
            this.recommendationStrategyCollection = recommendationStrategyCollection;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",recommendationStrategyCollection=")
                .append(String.valueOf(recommendationStrategyCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRecommendationStrategiesResponse)) {
            return false;
        }

        ListRecommendationStrategiesResponse other = (ListRecommendationStrategiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.recommendationStrategyCollection,
                        other.recommendationStrategyCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.recommendationStrategyCollection == null
                                ? 43
                                : this.recommendationStrategyCollection.hashCode());
        return result;
    }
}
