...
public final class EnrollmentStatus extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnrollmentStatus model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EnrollmentStatus)) {
            return false;
        }

        EnrollmentStatus other = (EnrollmentStatus) o;
