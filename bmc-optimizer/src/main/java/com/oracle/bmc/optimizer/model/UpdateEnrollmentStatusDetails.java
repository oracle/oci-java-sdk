...
public class UpdateEnrollmentStatusDetails {
    ...
    public static class Builder {
        ...
        public UpdateEnrollmentStatusDetails build() {
            UpdateEnrollmentStatusDetails __instance__ = new UpdateEnrollmentStatusDetails(status);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateEnrollmentStatusDetails o) {
