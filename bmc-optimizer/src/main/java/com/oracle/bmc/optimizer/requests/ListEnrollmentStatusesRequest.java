...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/optimizer/ListEnrollmentStatusesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListEnrollmentStatusesRequest.
 */
...
public class ListEnrollmentStatusesRequest
    ...
    public static class Builder
        ...
        public ListEnrollmentStatusesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListEnrollmentStatusesRequest(compartmentId, limit, page, sortOrder, sortBy, lifecycleState, status, opcRequestId);
        }
    }
