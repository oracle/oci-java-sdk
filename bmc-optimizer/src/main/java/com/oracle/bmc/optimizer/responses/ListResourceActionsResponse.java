...
public class ListResourceActionsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListResourceActionsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListResourceActionsResponse)) {
            return false;
        }

        ListResourceActionsResponse other = (ListResourceActionsResponse) o;
