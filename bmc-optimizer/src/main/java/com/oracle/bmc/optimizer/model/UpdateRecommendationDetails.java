...
/**
 * The request object for updating the recommendation details. <br>
...
public final class UpdateRecommendationDetails
    ...
    public static class Builder {
        ...
        public UpdateRecommendationDetails build() {
            UpdateRecommendationDetails model =
                    new UpdateRecommendationDetails(this.status, this.timeStatusEnd);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateRecommendationDetails model) {
