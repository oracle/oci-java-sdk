...
public final class LevelsConfiguration extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public LevelsConfiguration build() {
            LevelsConfiguration model = new LevelsConfiguration(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(LevelsConfiguration model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LevelsConfiguration)) {
            return false;
        }

        LevelsConfiguration other = (LevelsConfiguration) o;
