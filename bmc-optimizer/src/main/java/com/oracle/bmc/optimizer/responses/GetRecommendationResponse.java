...
public class GetRecommendationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetRecommendationResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetRecommendationResponse)) {
            return false;
        }

        GetRecommendationResponse other = (GetRecommendationResponse) o;
