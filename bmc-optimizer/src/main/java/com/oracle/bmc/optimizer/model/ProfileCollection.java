...
public final class ProfileCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
        ...
        public ProfileCollection build() {
            ProfileCollection model = new ProfileCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ProfileCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        ProfileCollection other = (ProfileCollection) o;
