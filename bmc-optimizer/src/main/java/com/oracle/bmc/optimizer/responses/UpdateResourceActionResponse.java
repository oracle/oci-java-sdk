...
public class UpdateResourceActionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateResourceActionResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateResourceActionResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateResourceActionResponse)) {
            return false;
        }

        UpdateResourceActionResponse other = (UpdateResourceActionResponse) o;
