...
public class EnrollmentStatusCollection {
    ...
    public static class Builder {
        ...
        public EnrollmentStatusCollection build() {
            EnrollmentStatusCollection __instance__ = new EnrollmentStatusCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EnrollmentStatusCollection o) {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("items")
    java.util.List<EnrollmentStatusSummary> items;
