...
public class ListProfileLevelsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListProfileLevelsResponse> {
         ...
         */
        @Override
        public Builder copy(ListProfileLevelsResponse o) {
            __httpStatusCode__(o.get__httpStatusCode__());
            headers(o.getHeaders());
            opcRequestId(o.getOpcRequestId());
            opcNextPage(o.getOpcNextPage());
            opcPrevPage(o.getOpcPrevPage());
            profileLevelCollection(o.getProfileLevelCollection());
    ...
    public String toString() {
        ...
        sb.append(",profileLevelCollection=").append(String.valueOf(profileLevelCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListProfileLevelsResponse)) {
            return false;
        }

        ListProfileLevelsResponse other = (ListProfileLevelsResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcPrevPage, other.opcPrevPage)
                && java.util.Objects.equals(
                        this.profileLevelCollection, other.profileLevelCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.profileLevelCollection == null
                                ? 43
                                : this.profileLevelCollection.hashCode());
        return result;
    }
}
