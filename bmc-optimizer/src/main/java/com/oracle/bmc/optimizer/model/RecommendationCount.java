...
public final class RecommendationCount {
    ...
    public static class Builder {
        ...
        public RecommendationCount build() {
            RecommendationCount __instance__ = new RecommendationCount(importance, count);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RecommendationCount o) {
            Builder copiedBuilder = importance(o.getImportance()).count(o.getCount());
