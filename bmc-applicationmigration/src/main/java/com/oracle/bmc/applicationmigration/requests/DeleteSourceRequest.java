...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/applicationmigration/DeleteSourceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSourceRequest.
 */
...
public class DeleteSourceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteSourceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteSourceRequest(sourceId, opcRequestId, ifMatch);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().sourceId(sourceId).opcRequestId(opcRequestId).ifMatch(ifMatch);
    }
