...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/applicationmigration/GetSourceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetSourceRequest.
 */
...
public class GetSourceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetSourceRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetSourceRequest(sourceId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().sourceId(sourceId).opcRequestId(opcRequestId);
    }
