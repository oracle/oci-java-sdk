...
/**
 * Credentials to access the Oracle Integration application in the source environment. Application
 * Migration connects to the application in the source environment with the supplied credentials.
 * <br>
...
public final class OicDiscoveryDetails extends DiscoveryDetails {
    ...
    public static class Builder {
        /**
         * Application administrator username to access the Oracle Integration Classic instance in
        ...
        public OicDiscoveryDetails build() {
            OicDiscoveryDetails model =
                    new OicDiscoveryDetails(this.serviceInstanceUser, this.serviceInstancePassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OicDiscoveryDetails model) {
    ...
    /**
     * Application administrator username to access the Oracle Integration Classic instance in the
     * source environment.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("serviceInstanceUser")
