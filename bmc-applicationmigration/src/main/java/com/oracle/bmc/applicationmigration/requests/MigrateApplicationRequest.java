...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/applicationmigration/MigrateApplicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use MigrateApplicationRequest.
 */
...
public class MigrateApplicationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    MigrateApplicationRequest, java.lang.Void> {
        ...
        /**
         * Build the instance of MigrateApplicationRequest as configured by this builder
         *
         ...
         *
         * @return instance of MigrateApplicationRequest
         */
        public MigrateApplicationRequest build() {
            MigrateApplicationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of MigrateApplicationRequest
         */
        public MigrateApplicationRequest buildWithoutInvocationCallback() {
            MigrateApplicationRequest request = new MigrateApplicationRequest();
            request.migrationId = migrationId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new MigrateApplicationRequest(migrationId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrateApplicationRequest)) {
            return false;
        }

        MigrateApplicationRequest other = (MigrateApplicationRequest) o;
