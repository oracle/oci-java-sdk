...
public class ApplicationMigrationClient implements ApplicationMigration {
     ...
     */
    protected ApplicationMigrationClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            new com.google.common.util.concurrent.ThreadFactoryBuilder()
                                    .setDaemon(true)
                                    .setNameFormat("ApplicationMigration-waiters-%d")
                                    .build());
    ...
    public ChangeSourceCompartmentResponse changeSourceCompartment(
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ChangeSourceCompartmentResponse>
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getChangeSourceCompartmentDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public CreateSourceResponse createSource(CreateSourceRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, CreateSourceResponse>
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateSourceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ListSourceApplicationsResponse listSourceApplications(
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, ListSourceApplicationsResponse>
    ...
    public MigrateApplicationResponse migrateApplication(MigrateApplicationRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, MigrateApplicationResponse>
    ...
    public UpdateSourceResponse updateSource(UpdateSourceRequest request) {
        ...
        com.google.common.base.Function<javax.ws.rs.core.Response, UpdateSourceResponse>
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateSourceDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
