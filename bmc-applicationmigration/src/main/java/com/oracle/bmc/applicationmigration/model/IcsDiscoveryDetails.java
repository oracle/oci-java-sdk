...
/**
 * Credentials to access the Oracle Integration Cloud Service application in the source environment.
...
public final class IcsDiscoveryDetails extends DiscoveryDetails {
    ...
    public static class Builder {
        ...
        public IcsDiscoveryDetails build() {
            IcsDiscoveryDetails model =
                    new IcsDiscoveryDetails(this.serviceInstanceUser, this.serviceInstancePassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(IcsDiscoveryDetails model) {
    ...
    /**
     * Application administrator username to access the Oracle Integration Cloud Service application
