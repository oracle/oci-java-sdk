...
public class ListMigrationsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public java.util.List<com.oracle.bmc.applicationmigration.model.MigrationSummary> getItems() {
        return items;
    }
    ...
    private ListMigrationsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.applicationmigration.model.MigrationSummary> items) {
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ListMigrationsResponse o) {
        ...
        public ListMigrationsResponse build() {
            return new ListMigrationsResponse(__httpStatusCode__, opcRequestId, opcNextPage, items);
        }
    }
