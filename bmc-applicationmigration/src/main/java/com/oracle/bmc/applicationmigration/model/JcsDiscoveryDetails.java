...
/**
 * Credentials to access the Oracle Java Cloud Service application in the source environment. When
...
public final class JcsDiscoveryDetails extends DiscoveryDetails {
    ...
    public static class Builder {
        /**
         * WebLogic administrator username for the Oracle Java Cloud Service application in the
         * source environment.
         */
        ...
        /**
         * The password of the WebLogic administrator for the Oracle Java Cloud Service application
        ...
        public JcsDiscoveryDetails build() {
            JcsDiscoveryDetails model =
                    new JcsDiscoveryDetails(this.weblogicUser, this.weblogicPassword);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JcsDiscoveryDetails model) {
    ...
    /**
     * WebLogic administrator username for the Oracle Java Cloud Service application in the source
     * environment.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("weblogicUser")
    ...
    /**
     * The password of the WebLogic administrator for the Oracle Java Cloud Service application in
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JcsDiscoveryDetails)) {
            return false;
        }

        JcsDiscoveryDetails other = (JcsDiscoveryDetails) o;
