...
public class GetSourceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSourceResponse> {
        ...
        public GetSourceResponse build() {
            return new GetSourceResponse(__httpStatusCode__, headers, opcRequestId, etag, source);
        }
    }
