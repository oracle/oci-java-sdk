...
/**
 * Resource object that can be used to pass details about any list of resources associated with
 * Migrations. The List of resources are added to ConfigurationField to add the capability to pass
 * lists of resources of any type and group. <br>
...
public final class ResourceField extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ResourceField build() {
            ResourceField model = new ResourceField(this.name, this.group, this.type, this.value);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResourceField model) {
