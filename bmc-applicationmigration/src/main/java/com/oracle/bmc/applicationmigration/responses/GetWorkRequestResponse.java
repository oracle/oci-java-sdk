...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public com.oracle.bmc.applicationmigration.model.WorkRequest getWorkRequest() {
        return workRequest;
    }

    @java.beans.ConstructorProperties({"__httpStatusCode__", "opcRequestId", "etag", "workRequest"})
    private GetWorkRequestResponse(
            int __httpStatusCode__,
            String opcRequestId,
            String etag,
            com.oracle.bmc.applicationmigration.model.WorkRequest workRequest) {
    ...
    public static class Builder {
        ...
        public GetWorkRequestResponse build() {
            return new GetWorkRequestResponse(__httpStatusCode__, opcRequestId, etag, workRequest);
        }
    }
