 ...
 * you want to migrate the application. <br>
...
public final class OcicSourceDetails extends SourceDetails {
    ...
    public static class Builder {
         ...
         * applications. For example, uscom-east-1 or uscom-central-1.
         */
         ...
         * Service (IDCS), enter the service instance ID. For example, if Compute-567890123 is the
         * account name of your Oracle Cloud Infrastructure Classic Compute service entitlement,
         * then enter 567890123.
         *
         * <p>If you are using a traditional Oracle Cloud Infrastructure - Classic account, enter
         * your identity domain ID.
         */
    ...
    /**
     * If you are using an Oracle Cloud Infrastructure - Classic account with Identity Cloud Service
     * (IDCS), enter the service instance ID. For example, if Compute-567890123 is the account name
     * of your Oracle Cloud Infrastructure Classic Compute service entitlement, then enter
     * 567890123.
     *
     * <p>If you are using a traditional Oracle Cloud Infrastructure - Classic account, enter your
     * identity domain ID.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("computeAccount")
