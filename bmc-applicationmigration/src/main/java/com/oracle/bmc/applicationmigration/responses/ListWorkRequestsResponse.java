...
public class ListWorkRequestsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.applicationmigration.model.WorkRequestSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.applicationmigration.model.WorkRequestSummary> getItems() {
        return items;
    }
    ...
    public static class Builder
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.applicationmigration.model.WorkRequestSummary>
                        items) {
            this.items = items;
            return this;
        }
