...
public class CreateSourceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateSourceResponse> {
        ...
        public CreateSourceResponse build() {
            return new CreateSourceResponse(
                    __httpStatusCode__, headers, opcRequestId, opcWorkRequestId, etag, source);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSourceResponse)) {
            return false;
        }
