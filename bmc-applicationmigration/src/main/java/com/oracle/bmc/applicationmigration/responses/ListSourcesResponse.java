...
public class ListSourcesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.applicationmigration.model.SourceSummary> getItems() {
        return items;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSourcesResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSourcesResponse)) {
            return false;
        }
