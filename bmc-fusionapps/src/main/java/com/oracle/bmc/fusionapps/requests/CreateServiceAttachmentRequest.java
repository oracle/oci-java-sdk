...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/CreateServiceAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateServiceAttachmentRequest.
 */
...
public class CreateServiceAttachmentRequest
    ...
    public static class Builder
        ...
        public CreateServiceAttachmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateServiceAttachmentRequest(createServiceAttachmentDetails, fusionEnvironmentId, opcRetryToken, opcRequestId);
        }
    }
