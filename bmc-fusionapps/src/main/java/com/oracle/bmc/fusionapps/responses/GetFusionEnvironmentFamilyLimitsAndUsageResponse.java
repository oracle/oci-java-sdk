...
public class GetFusionEnvironmentFamilyLimitsAndUsageResponse
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder fusionEnvironmentFamilyLimitsAndUsage(
                com.oracle.bmc.fusionapps.model.FusionEnvironmentFamilyLimitsAndUsage
                        fusionEnvironmentFamilyLimitsAndUsage) {
            this.fusionEnvironmentFamilyLimitsAndUsage = fusionEnvironmentFamilyLimitsAndUsage;
            return this;
    ...
    public String toString() {
        ...
        sb.append(",fusionEnvironmentFamilyLimitsAndUsage=")
                .append(String.valueOf(fusionEnvironmentFamilyLimitsAndUsage));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFusionEnvironmentFamilyLimitsAndUsageResponse)) {
            return false;
        }

        GetFusionEnvironmentFamilyLimitsAndUsageResponse other =
                (GetFusionEnvironmentFamilyLimitsAndUsageResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(
                        this.fusionEnvironmentFamilyLimitsAndUsage,
                        other.fusionEnvironmentFamilyLimitsAndUsage);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.fusionEnvironmentFamilyLimitsAndUsage == null
                                ? 43
                                : this.fusionEnvironmentFamilyLimitsAndUsage.hashCode());
        return result;
    }
}
