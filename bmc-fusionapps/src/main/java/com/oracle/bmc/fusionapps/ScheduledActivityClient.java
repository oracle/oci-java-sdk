...
public class ScheduledActivityClient implements ScheduledActivity {
    /**
     * Service instance for ScheduledActivity.
     */
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ScheduledActivityAsyncClient.class);

    com.oracle.bmc.http.internal.RestClient getClient() {
        return client;
    }

    private final ScheduledActivityWaiters waiters;

    private final ScheduledActivityPaginators paginators;
     ...
     */
    public ScheduledActivityClient(
     ...
     */
    protected ScheduledActivityClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("ScheduledActivity-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new ScheduledActivityWaiters(executorService, this);

        this.paginators = new ScheduledActivityPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ScheduledActivityClient> {
         ...
         * @return the client
         */
        public ScheduledActivityClient build(
            ...
            return new ScheduledActivityClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public ScheduledActivityWaiters getWaiters() {
        return waiters;
    }

    @Override
    public ScheduledActivityPaginators getPaginators() {
        return paginators;
    }
}
