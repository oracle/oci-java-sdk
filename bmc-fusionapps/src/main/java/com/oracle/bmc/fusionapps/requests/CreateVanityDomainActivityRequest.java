...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/CreateVanityDomainActivityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateVanityDomainActivityRequest.
 */
...
public class CreateVanityDomainActivityRequest
    ...
    public static class Builder
        ...
        public CreateVanityDomainActivityRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateVanityDomainActivityRequest(createVanityDomainActivityDetails, fusionEnvironmentId, opcRetryToken, opcRequestId);
        }
    }
