...
public class GetFusionEnvironmentFamilySubscriptionDetailResponse
     ...
     * @return the value
     */
    public com.oracle.bmc.fusionapps.model.SubscriptionDetail getSubscriptionDetail() {
    ...
    public static class Builder {
         ...
         * @return this builder
         */
        public Builder subscriptionDetail(
                com.oracle.bmc.fusionapps.model.SubscriptionDetail subscriptionDetail) {
            this.subscriptionDetail = subscriptionDetail;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",subscriptionDetail=").append(String.valueOf(subscriptionDetail));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFusionEnvironmentFamilySubscriptionDetailResponse)) {
            return false;
        }

        GetFusionEnvironmentFamilySubscriptionDetailResponse other =
                (GetFusionEnvironmentFamilySubscriptionDetailResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.etag, other.etag)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.subscriptionDetail, other.subscriptionDetail);
    }
        ...
        result =
                (result * PRIME)
                        + (this.subscriptionDetail == null
                                ? 43
                                : this.subscriptionDetail.hashCode());
        return result;
    }
}
