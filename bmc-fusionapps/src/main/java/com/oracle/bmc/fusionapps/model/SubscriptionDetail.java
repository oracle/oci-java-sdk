...
public final class SubscriptionDetail {
    ...
    public static class Builder {
        ...
        public SubscriptionDetail build() {
            SubscriptionDetail __instance__ = new SubscriptionDetail(subscriptions);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SubscriptionDetail o) {
            Builder copiedBuilder = subscriptions(o.getSubscriptions());
