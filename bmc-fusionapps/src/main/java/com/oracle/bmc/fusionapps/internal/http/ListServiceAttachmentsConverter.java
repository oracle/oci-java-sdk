...
public class ListServiceAttachmentsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListServiceAttachmentsConverter.class);

    public static com.oracle.bmc.fusionapps.requests.ListServiceAttachmentsRequest interceptRequest(
            com.oracle.bmc.fusionapps.requests.ListServiceAttachmentsRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getServiceInstanceType() != null) {
            target =
                    target.queryParam(
                            "serviceInstanceType",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getServiceInstanceType().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.fusionapps.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fusionapps.responses.ListServiceAttachmentsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
