...
/**
 * Async client implementation for DataMaskingActivity service. <br/>
...
public class DataMaskingActivityAsyncClient implements DataMaskingActivityAsync {
    /**
     * Service instance for DataMaskingActivity.
     */
    public static final com.oracle.bmc.Service SERVICE =
            com.oracle.bmc.Services.serviceBuilder()
                    .serviceName("DATAMASKINGACTIVITY")
                    .serviceEndpointPrefix("")
                    .serviceEndpointTemplate("https://fusionapps.{region}.oci.{secondLevelDomain}")
                    .build();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(DataMaskingActivityAsyncClient.class);
     ...
     */
    public DataMaskingActivityAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, DataMaskingActivityAsyncClient> {
         ...
         * @return the client
         */
        public DataMaskingActivityAsyncClient build(
            ...
            return new DataMaskingActivityAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
