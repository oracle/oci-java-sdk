...
public class ListRefreshActivitiesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public com.oracle.bmc.fusionapps.model.RefreshActivityCollection
            getRefreshActivityCollection() {
        return refreshActivityCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListRefreshActivitiesResponse> {
         ...
         * @return this builder
         */
        public Builder refreshActivityCollection(
    ...
    public String toString() {
        ...
        sb.append(",refreshActivityCollection=").append(String.valueOf(refreshActivityCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListRefreshActivitiesResponse)) {
            return false;
        }

        ListRefreshActivitiesResponse other = (ListRefreshActivitiesResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(
                        this.refreshActivityCollection, other.refreshActivityCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.refreshActivityCollection == null
                                ? 43
                                : this.refreshActivityCollection.hashCode());
        return result;
    }
}
