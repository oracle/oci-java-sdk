...
public class RefreshActivityClient implements RefreshActivity {
    /**
     * Service instance for RefreshActivity.
     */
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(RefreshActivityAsyncClient.class);

    com.oracle.bmc.http.internal.RestClient getClient() {
        return client;
    }

    private final RefreshActivityWaiters waiters;

    private final RefreshActivityPaginators paginators;
     ...
     */
    protected RefreshActivityClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("RefreshActivity-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new RefreshActivityWaiters(executorService, this);

        this.paginators = new RefreshActivityPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, RefreshActivityClient> {
         ...
         * @return the client
         */
        public RefreshActivityClient build(
            ...
            return new RefreshActivityClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public GetRefreshActivityResponse getRefreshActivity(GetRefreshActivityRequest request) {
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "RefreshActivity", "GetRefreshActivity", ib.getRequestUri().toString(), "");
    ...
    @Override
    public RefreshActivityWaiters getWaiters() {
        return waiters;
    }

    @Override
    public RefreshActivityPaginators getPaginators() {
        return paginators;
    }
}
