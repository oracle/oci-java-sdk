...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/ValidateAndConfigureMicrositeDnsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ValidateAndConfigureMicrositeDnsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class ValidateAndConfigureMicrositeDnsRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ValidateAndConfigureMicrositeDnsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ValidateAndConfigureMicrositeDnsRequest o) {
        ...
        /**
         * Build the instance of ValidateAndConfigureMicrositeDnsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ValidateAndConfigureMicrositeDnsRequest
         */
        public ValidateAndConfigureMicrositeDnsRequest build() {
            ValidateAndConfigureMicrositeDnsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ValidateAndConfigureMicrositeDnsRequest
         */
        public ValidateAndConfigureMicrositeDnsRequest buildWithoutInvocationCallback() {
            ValidateAndConfigureMicrositeDnsRequest request =
                    new ValidateAndConfigureMicrositeDnsRequest();
            ...
            return request;
            // new ValidateAndConfigureMicrositeDnsRequest(fusionEnvironmentId, marketingBrandId, micrositeId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateAndConfigureMicrositeDnsRequest)) {
            return false;
        }

        ValidateAndConfigureMicrositeDnsRequest other = (ValidateAndConfigureMicrositeDnsRequest) o;
