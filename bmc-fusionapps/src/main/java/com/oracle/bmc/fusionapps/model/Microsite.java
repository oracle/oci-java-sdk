...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Microsite.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class Microsite extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(Microsite model) {
    ...
    /** dns management type for microsite */
    public enum DnsManagement implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    /** dns status for microsite */
    public enum DnsStatus implements com.oracle.bmc.http.internal.BmcEnum {
        Active("ACTIVE"),
    ...
    /** certificate management type for microsite */
    public enum CertificateManagement implements com.oracle.bmc.http.internal.BmcEnum {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Microsite)) {
            return false;
        }

        Microsite other = (Microsite) o;
