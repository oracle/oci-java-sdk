...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/GetMicrositeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMicrositeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class GetMicrositeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMicrositeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetMicrositeRequest o) {
        ...
        /**
         * Build the instance of GetMicrositeRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetMicrositeRequest
         */
        public GetMicrositeRequest build() {
            GetMicrositeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetMicrositeRequest
         */
        public GetMicrositeRequest buildWithoutInvocationCallback() {
            GetMicrositeRequest request = new GetMicrositeRequest();
            ...
            return request;
            // new GetMicrositeRequest(fusionEnvironmentId, marketingBrandId, micrositeId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMicrositeRequest)) {
            return false;
        }

        GetMicrositeRequest other = (GetMicrositeRequest) o;
