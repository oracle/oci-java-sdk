...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/DeleteVanityDomainActivityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteVanityDomainActivityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class DeleteVanityDomainActivityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteVanityDomainActivityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteVanityDomainActivityRequest o) {
        ...
        /**
         * Build the instance of DeleteVanityDomainActivityRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteVanityDomainActivityRequest
         */
        public DeleteVanityDomainActivityRequest build() {
            DeleteVanityDomainActivityRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteVanityDomainActivityRequest
         */
        public DeleteVanityDomainActivityRequest buildWithoutInvocationCallback() {
            DeleteVanityDomainActivityRequest request = new DeleteVanityDomainActivityRequest();
            request.fusionEnvironmentId = fusionEnvironmentId;
            request.vanityDomainActivityId = vanityDomainActivityId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteVanityDomainActivityRequest(fusionEnvironmentId, vanityDomainActivityId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteVanityDomainActivityRequest)) {
            return false;
        }

        DeleteVanityDomainActivityRequest other = (DeleteVanityDomainActivityRequest) o;
