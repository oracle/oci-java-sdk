...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/UpdateFusionEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateFusionEnvironmentRequest.
 */
...
public class UpdateFusionEnvironmentRequest
    ...
    public static class Builder
        ...
        public UpdateFusionEnvironmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateFusionEnvironmentRequest(fusionEnvironmentId, updateFusionEnvironmentDetails, ifMatch, opcRequestId);
        }
    }
