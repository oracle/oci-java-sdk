...
public class FusionEnvironmentClient implements FusionEnvironment {
    /**
    ...
    private final FusionEnvironmentWaiters waiters;

    private final FusionEnvironmentPaginators paginators;
     ...
     */
    public FusionEnvironmentClient(
     ...
     */
    protected FusionEnvironmentClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("FusionEnvironment-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new FusionEnvironmentWaiters(executorService, this);

        this.paginators = new FusionEnvironmentPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, FusionEnvironmentClient> {
         ...
         * @return the client
         */
        public FusionEnvironmentClient build(
            ...
            return new FusionEnvironmentClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public FusionEnvironmentWaiters getWaiters() {
        return waiters;
    }

    @Override
    public FusionEnvironmentPaginators getPaginators() {
        return paginators;
    }
}
