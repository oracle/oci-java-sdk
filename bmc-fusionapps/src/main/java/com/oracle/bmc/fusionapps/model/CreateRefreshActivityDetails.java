...
public final class CreateRefreshActivityDetails {
    ...
    public static class Builder {
        ...
        public CreateRefreshActivityDetails build() {
            CreateRefreshActivityDetails __instance__ =
                    new CreateRefreshActivityDetails(sourceFusionEnvironmentId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateRefreshActivityDetails o) {
            Builder copiedBuilder = sourceFusionEnvironmentId(o.getSourceFusionEnvironmentId());
