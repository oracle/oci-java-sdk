 ...
 * to any list operations of FusionEnvironmentFamily where multiple pages of data may be fetched.
...
public class FusionEnvironmentFamilyPaginators {
    private final FusionEnvironmentFamily client;

    public FusionEnvironmentFamilyPaginators(FusionEnvironmentFamily client) {
        this.client = client;
    }
