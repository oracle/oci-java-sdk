...
public class UpdateRefreshActivityResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private UpdateRefreshActivityResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateRefreshActivityResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateRefreshActivityResponse o) {
         ...
         */
        @Override
        public UpdateRefreshActivityResponse build() {
            return new UpdateRefreshActivityResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRefreshActivityResponse)) {
            return false;
        }

        UpdateRefreshActivityResponse other = (UpdateRefreshActivityResponse) o;
