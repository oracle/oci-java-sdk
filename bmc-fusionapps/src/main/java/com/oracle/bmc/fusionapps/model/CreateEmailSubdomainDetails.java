...
/**
 * Configuration details for email subdomain. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateEmailSubdomainDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateEmailSubdomainDetails
    ...
    public CreateEmailSubdomainDetails(
            String name,
    ...
    public static class Builder {
        ...
        public CreateEmailSubdomainDetails build() {
            CreateEmailSubdomainDetails model =
                    new CreateEmailSubdomainDetails(
                            this.name,
                            this.dnsManagement,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateEmailSubdomainDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEmailSubdomainDetails)) {
            return false;
        }

        CreateEmailSubdomainDetails other = (CreateEmailSubdomainDetails) o;
