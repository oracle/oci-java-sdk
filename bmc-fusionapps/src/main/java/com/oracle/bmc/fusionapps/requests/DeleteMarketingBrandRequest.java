...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/DeleteMarketingBrandExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMarketingBrandRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class DeleteMarketingBrandRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMarketingBrandRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMarketingBrandRequest o) {
        ...
        /**
         * Build the instance of DeleteMarketingBrandRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMarketingBrandRequest
         */
        public DeleteMarketingBrandRequest build() {
            DeleteMarketingBrandRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMarketingBrandRequest
         */
        public DeleteMarketingBrandRequest buildWithoutInvocationCallback() {
            DeleteMarketingBrandRequest request = new DeleteMarketingBrandRequest();
            request.fusionEnvironmentId = fusionEnvironmentId;
            request.marketingBrandId = marketingBrandId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteMarketingBrandRequest(fusionEnvironmentId, marketingBrandId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMarketingBrandRequest)) {
            return false;
        }

        DeleteMarketingBrandRequest other = (DeleteMarketingBrandRequest) o;
