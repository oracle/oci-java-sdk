...
public class GetScheduledActivityConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetScheduledActivityConverter.class);

    public static com.oracle.bmc.fusionapps.requests.GetScheduledActivityRequest interceptRequest(
            com.oracle.bmc.fusionapps.requests.GetScheduledActivityRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getScheduledActivityId()));
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.fusionapps.responses.GetScheduledActivityResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.fusionapps.responses.GetScheduledActivityResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fusionapps.responses.GetScheduledActivityResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
