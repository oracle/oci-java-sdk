...
public interface FusionEnvironmentFamily extends AutoCloseable {
     ...
     */
    FusionEnvironmentFamilyWaiters getWaiters();
     ...
     */
    FusionEnvironmentFamilyPaginators getPaginators();
}
