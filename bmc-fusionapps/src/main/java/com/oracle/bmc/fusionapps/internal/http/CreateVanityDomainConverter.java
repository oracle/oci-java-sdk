...
public class CreateVanityDomainConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateVanityDomainConverter.class);

    public static com.oracle.bmc.fusionapps.requests.CreateVanityDomainRequest interceptRequest(
            com.oracle.bmc.fusionapps.requests.CreateVanityDomainRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.fusionapps.responses.CreateVanityDomainResponse>() {
                            @Override
                            public com.oracle.bmc.fusionapps.responses.CreateVanityDomainResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fusionapps.responses.CreateVanityDomainResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fusionapps.responses.CreateVanityDomainResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.fusionapps.responses
                                                        .CreateVanityDomainResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.vanityDomain(response.getItem());
