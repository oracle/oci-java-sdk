...
public class ServiceAttachmentClient implements ServiceAttachment {
    /**
    ...
    private final ServiceAttachmentWaiters waiters;

    private final ServiceAttachmentPaginators paginators;
     ...
     */
    public ServiceAttachmentClient(
     ...
     */
    protected ServiceAttachmentClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("ServiceAttachment-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new ServiceAttachmentWaiters(executorService, this);

        this.paginators = new ServiceAttachmentPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<Builder, ServiceAttachmentClient> {
         ...
         * @return the client
         */
        public ServiceAttachmentClient build(
            ...
            return new ServiceAttachmentClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public ServiceAttachmentWaiters getWaiters() {
        return waiters;
    }

    @Override
    public ServiceAttachmentPaginators getPaginators() {
        return paginators;
    }
}
