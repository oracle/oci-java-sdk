...
public class CreateEmailSubdomainResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateEmailSubdomainResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateEmailSubdomainResponse> {
         ...
         */
        @Override
        public Builder copy(CreateEmailSubdomainResponse o) {
         ...
         */
        @Override
        public CreateEmailSubdomainResponse build() {
            return new CreateEmailSubdomainResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateEmailSubdomainResponse)) {
            return false;
        }

        CreateEmailSubdomainResponse other = (CreateEmailSubdomainResponse) o;
