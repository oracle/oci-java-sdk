 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetVanityDomainRequest.
 */
...
public class GetVanityDomainRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetVanityDomainRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetVanityDomainRequest(fusionEnvironmentId, vanityDomainId, opcRequestId,
            // doesDownloadOriginCsr, doesDownloadAkamaiCsr);
        }
    }
