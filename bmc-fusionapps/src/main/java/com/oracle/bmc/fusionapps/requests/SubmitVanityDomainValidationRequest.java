...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/SubmitVanityDomainValidationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use SubmitVanityDomainValidationRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class SubmitVanityDomainValidationRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    SubmitVanityDomainValidationRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(SubmitVanityDomainValidationRequest o) {
        ...
        /**
         * Build the instance of SubmitVanityDomainValidationRequest as configured by this builder
         *
         ...
         *
         * @return instance of SubmitVanityDomainValidationRequest
         */
        public SubmitVanityDomainValidationRequest build() {
            SubmitVanityDomainValidationRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of SubmitVanityDomainValidationRequest
         */
        public SubmitVanityDomainValidationRequest buildWithoutInvocationCallback() {
            SubmitVanityDomainValidationRequest request = new SubmitVanityDomainValidationRequest();
            request.vanityDomainId = vanityDomainId;
            request.fusionEnvironmentId = fusionEnvironmentId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new SubmitVanityDomainValidationRequest(vanityDomainId, fusionEnvironmentId, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SubmitVanityDomainValidationRequest)) {
            return false;
        }

        SubmitVanityDomainValidationRequest other = (SubmitVanityDomainValidationRequest) o;
