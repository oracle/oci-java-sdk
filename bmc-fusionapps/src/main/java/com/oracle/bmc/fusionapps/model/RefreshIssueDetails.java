...
/**
 * Details of refresh failure or validation failure that needs to be investigated. <br>
...
public final class RefreshIssueDetails
    ...
    public static class Builder {
        /**
         * Detail reasons of refresh failure or validation failure that needs to be shown to
         * customer.
         */
