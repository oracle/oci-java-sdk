...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/GetMicrositeDnsConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetMicrositeDnsConfigRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class GetMicrositeDnsConfigRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetMicrositeDnsConfigRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetMicrositeDnsConfigRequest o) {
        ...
        /**
         * Build the instance of GetMicrositeDnsConfigRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetMicrositeDnsConfigRequest
         */
        public GetMicrositeDnsConfigRequest build() {
            GetMicrositeDnsConfigRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetMicrositeDnsConfigRequest
         */
        public GetMicrositeDnsConfigRequest buildWithoutInvocationCallback() {
            GetMicrositeDnsConfigRequest request = new GetMicrositeDnsConfigRequest();
            ...
            return request;
            // new GetMicrositeDnsConfigRequest(fusionEnvironmentId, marketingBrandId, micrositeId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetMicrositeDnsConfigRequest)) {
            return false;
        }

        GetMicrositeDnsConfigRequest other = (GetMicrositeDnsConfigRequest) o;
