...
/**
 * Async client implementation for ServiceAttachment service. <br/>
...
public class ServiceAttachmentAsyncClient implements ServiceAttachmentAsync {
    /**
     * Service instance for ServiceAttachment.
     */
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ServiceAttachmentAsyncClient.class);
     ...
     */
    public ServiceAttachmentAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, ServiceAttachmentAsyncClient> {
         ...
         * @return the client
         */
        public ServiceAttachmentAsyncClient build(
            ...
            return new ServiceAttachmentAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
