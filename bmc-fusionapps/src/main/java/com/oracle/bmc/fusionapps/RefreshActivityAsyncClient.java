...
/**
 * Async client implementation for RefreshActivity service. <br/>
...
public class RefreshActivityAsyncClient implements RefreshActivityAsync {
    /**
     ...
     */
    public RefreshActivityAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, RefreshActivityAsyncClient> {
         ...
         * @return the client
         */
        public RefreshActivityAsyncClient build(
            ...
            return new RefreshActivityAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
