 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListMicrositesRequest.
 */
...
public class ListMicrositesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListMicrositesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListMicrositesRequest(fusionEnvironmentId, marketingBrandId, micrositeId, name,
            // lifecycleState, sortOrder, sortBy, limit, page, opcRequestId);
        }
    }
