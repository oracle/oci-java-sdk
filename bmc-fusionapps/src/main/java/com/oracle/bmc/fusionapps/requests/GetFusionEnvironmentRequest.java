...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/GetFusionEnvironmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFusionEnvironmentRequest.
 */
...
public class GetFusionEnvironmentRequest
    ...
    public static class Builder
         ...
         */
        public GetFusionEnvironmentRequest build() {
            GetFusionEnvironmentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetFusionEnvironmentRequest
         */
        public GetFusionEnvironmentRequest buildWithoutInvocationCallback() {
            GetFusionEnvironmentRequest request = new GetFusionEnvironmentRequest();
            request.fusionEnvironmentId = fusionEnvironmentId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetFusionEnvironmentRequest(fusionEnvironmentId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFusionEnvironmentRequest)) {
            return false;
        }

        GetFusionEnvironmentRequest other = (GetFusionEnvironmentRequest) o;
