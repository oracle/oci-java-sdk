...
public final class ResetFusionEnvironmentPasswordDetails {
    ...
    public static class Builder {
        ...
        public ResetFusionEnvironmentPasswordDetails build() {
            ResetFusionEnvironmentPasswordDetails __instance__ =
                    new ResetFusionEnvironmentPasswordDetails(password);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ResetFusionEnvironmentPasswordDetails o) {
