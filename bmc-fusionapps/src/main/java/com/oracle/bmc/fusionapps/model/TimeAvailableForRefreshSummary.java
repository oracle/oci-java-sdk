...
public final class TimeAvailableForRefreshSummary {
    ...
    public static class Builder {
        ...
        public TimeAvailableForRefreshSummary build() {
            TimeAvailableForRefreshSummary __instance__ =
                    new TimeAvailableForRefreshSummary(timeAvailableForRefresh);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(TimeAvailableForRefreshSummary o) {
