...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/GetVanityDomainActivityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetVanityDomainActivityRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class GetVanityDomainActivityRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetVanityDomainActivityRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetVanityDomainActivityRequest o) {
        ...
        /**
         * Build the instance of GetVanityDomainActivityRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetVanityDomainActivityRequest
         */
        public GetVanityDomainActivityRequest build() {
            GetVanityDomainActivityRequest request = buildWithoutInvocationCallback();
        ...
        public GetVanityDomainActivityRequest buildWithoutInvocationCallback() {
            GetVanityDomainActivityRequest request = new GetVanityDomainActivityRequest();
            request.fusionEnvironmentId = fusionEnvironmentId;
            request.vanityDomainActivityId = vanityDomainActivityId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetVanityDomainActivityRequest(fusionEnvironmentId, vanityDomainActivityId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVanityDomainActivityRequest)) {
            return false;
        }

        GetVanityDomainActivityRequest other = (GetVanityDomainActivityRequest) o;
