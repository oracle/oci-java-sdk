...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/DeleteRefreshActivityExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteRefreshActivityRequest.
 */
...
public class DeleteRefreshActivityRequest
    ...
    public static class Builder
        ...
        public DeleteRefreshActivityRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteRefreshActivityRequest(fusionEnvironmentId, refreshActivityId, ifMatch, opcRequestId);
        }
    }
