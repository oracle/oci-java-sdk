 ...
 * to any list operations of FusionEnvironment where multiple pages of data may be fetched.
...
public class FusionEnvironmentPaginators {
    private final FusionEnvironment client;

    public FusionEnvironmentPaginators(FusionEnvironment client) {
        this.client = client;
    }
