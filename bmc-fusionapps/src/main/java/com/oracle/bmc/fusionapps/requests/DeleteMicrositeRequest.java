...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/DeleteMicrositeExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteMicrositeRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class DeleteMicrositeRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteMicrositeRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteMicrositeRequest o) {
        ...
        /**
         * Build the instance of DeleteMicrositeRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteMicrositeRequest
         */
        public DeleteMicrositeRequest build() {
            DeleteMicrositeRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteMicrositeRequest
         */
        public DeleteMicrositeRequest buildWithoutInvocationCallback() {
            DeleteMicrositeRequest request = new DeleteMicrositeRequest();
            ...
            return request;
            // new DeleteMicrositeRequest(fusionEnvironmentId, marketingBrandId, micrositeId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteMicrositeRequest)) {
            return false;
        }

        DeleteMicrositeRequest other = (DeleteMicrositeRequest) o;
