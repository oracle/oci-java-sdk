...
/**
 * Async client implementation for ScheduledActivity service. <br/>
...
public class ScheduledActivityAsyncClient implements ScheduledActivityAsync {
    /**
     ...
     */
    public ScheduledActivityAsyncClient(
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, ScheduledActivityAsyncClient> {
         ...
         * @return the client
         */
        public ScheduledActivityAsyncClient build(
            ...
            return new ScheduledActivityAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
