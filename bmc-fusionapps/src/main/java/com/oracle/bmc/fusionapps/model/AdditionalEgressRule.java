...
public final class AdditionalEgressRule
    ...
    public static class Builder {
        ...
        /**
         * Specifies the destination CIDR block the port should be opened for. Must be IPv4 only,
         * and cannot be part of any private range from [RFC
    ...
    /**
     * Specifies the destination CIDR block the port should be opened for. Must be IPv4 only, and
     * cannot be part of any private range from [RFC
     * 1918](https://datatracker.ietf.org/doc/html/rfc1918).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("destinationCidr")
