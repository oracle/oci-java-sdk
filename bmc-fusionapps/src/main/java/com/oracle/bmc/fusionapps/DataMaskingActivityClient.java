...
public class DataMaskingActivityClient implements DataMaskingActivity {
    /**
    ...
    private final DataMaskingActivityWaiters waiters;

    private final DataMaskingActivityPaginators paginators;
     ...
     */
    public DataMaskingActivityClient(
     ...
     */
    protected DataMaskingActivityClient(
            com.oracle.bmc.auth.AbstractAuthenticationDetailsProvider authenticationDetailsProvider,
            com.oracle.bmc.ClientConfiguration configuration,
            com.oracle.bmc.http.ClientConfigurator clientConfigurator,
            com.oracle.bmc.http.signing.RequestSignerFactory defaultRequestSignerFactory,
            ...
            java.util.concurrent.ThreadPoolExecutor threadPoolExecutor =
                    new java.util.concurrent.ThreadPoolExecutor(
                            ...
                            com.oracle.bmc.internal.ClientThreadFactory.builder()
                                    .isDaemon(true)
                                    .nameFormat("DataMaskingActivity-waiters-%d")
                                    .build());
            threadPoolExecutor.allowCoreThreadTimeOut(true);

            executorService = threadPoolExecutor;
        }
        this.waiters = new DataMaskingActivityWaiters(executorService, this);

        this.paginators = new DataMaskingActivityPaginators(this);
    ...
    public static class Builder
            extends com.oracle.bmc.common.RegionalClientBuilder<
                    Builder, DataMaskingActivityClient> {
         ...
         * @return the client
         */
        public DataMaskingActivityClient build(
            ...
            return new DataMaskingActivityClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    @Override
    public DataMaskingActivityWaiters getWaiters() {
        return waiters;
    }

    @Override
    public DataMaskingActivityPaginators getPaginators() {
        return paginators;
    }
}
