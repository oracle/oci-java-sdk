 ...
 * to any list operations of DataMaskingActivity where multiple pages of data may be fetched.
...
public class DataMaskingActivityPaginators {
    private final DataMaskingActivity client;

    public DataMaskingActivityPaginators(DataMaskingActivity client) {
        this.client = client;
    }
