 ...
 * resources of FusionEnvironmentFamily.
 * <p>
...
public class FusionEnvironmentFamilyWaiters {
    ...
    public FusionEnvironmentFamilyWaiters(
            java.util.concurrent.ExecutorService executorService, FusionEnvironmentFamily client) {
