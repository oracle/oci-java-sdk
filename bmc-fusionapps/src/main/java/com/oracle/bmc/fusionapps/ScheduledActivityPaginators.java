 ...
 * to any list operations of ScheduledActivity where multiple pages of data may be fetched.
...
public class ScheduledActivityPaginators {
    private final ScheduledActivity client;

    public ScheduledActivityPaginators(ScheduledActivity client) {
        this.client = client;
    }
