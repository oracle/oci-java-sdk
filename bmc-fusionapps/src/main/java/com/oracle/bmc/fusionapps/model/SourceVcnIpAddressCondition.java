...
public final class SourceVcnIpAddressCondition extends RuleCondition {
    ...
    public static class Builder {
         ...
         * specified VCN) of an incoming packet must match. The service accepts only classless
         * inter-domain routing (CIDR) format (x.x.x.x/y) strings. Specify 0.0.0.0/0 to match all
         * incoming traffic in the customer VCN.
         */
     ...
     * VCN) of an incoming packet must match. The service accepts only classless inter-domain
     * routing (CIDR) format (x.x.x.x/y) strings. Specify 0.0.0.0/0 to match all incoming traffic in
     * the customer VCN.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("attributeValue")
