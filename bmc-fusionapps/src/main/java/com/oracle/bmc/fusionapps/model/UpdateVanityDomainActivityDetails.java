...
/**
 * The information about scheduled refresh. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateVanityDomainActivityDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateVanityDomainActivityDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"timeScheduled"})
    public UpdateVanityDomainActivityDetails(java.util.Date timeScheduled) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateVanityDomainActivityDetails build() {
            UpdateVanityDomainActivityDetails model =
                    new UpdateVanityDomainActivityDetails(this.timeScheduled);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateVanityDomainActivityDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateVanityDomainActivityDetails)) {
            return false;
        }

        UpdateVanityDomainActivityDetails other = (UpdateVanityDomainActivityDetails) o;
