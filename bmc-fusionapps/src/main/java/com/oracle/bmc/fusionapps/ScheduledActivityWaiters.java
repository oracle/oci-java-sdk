 ...
 * resources of ScheduledActivity.
 * <p>
 * The default configuration used is defined by {@link com.oracle.bmc.waiter.Waiters.Waiters#DEFAULT_POLLING_WAITER}.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20211201")
public class ScheduledActivityWaiters {
    private final java.util.concurrent.ExecutorService executorService;
    private final ScheduledActivity client;

    public ScheduledActivityWaiters(
            java.util.concurrent.ExecutorService executorService, ScheduledActivity client) {
