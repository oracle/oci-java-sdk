...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fusionapps/GetFusionEnvironmentFamilyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFusionEnvironmentFamilyRequest.
 */
...
public class GetFusionEnvironmentFamilyRequest
    ...
    public static class Builder
         ...
         */
        public GetFusionEnvironmentFamilyRequest build() {
            GetFusionEnvironmentFamilyRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetFusionEnvironmentFamilyRequest
         */
        public GetFusionEnvironmentFamilyRequest buildWithoutInvocationCallback() {
            GetFusionEnvironmentFamilyRequest request = new GetFusionEnvironmentFamilyRequest();
            request.fusionEnvironmentFamilyId = fusionEnvironmentFamilyId;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetFusionEnvironmentFamilyRequest(fusionEnvironmentFamilyId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFusionEnvironmentFamilyRequest)) {
            return false;
        }

        GetFusionEnvironmentFamilyRequest other = (GetFusionEnvironmentFamilyRequest) o;
