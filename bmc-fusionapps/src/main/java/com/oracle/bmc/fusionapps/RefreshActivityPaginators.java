 ...
 * to any list operations of RefreshActivity where multiple pages of data may be fetched.
...
public class RefreshActivityPaginators {
    private final RefreshActivity client;

    public RefreshActivityPaginators(RefreshActivity client) {
        this.client = client;
    }
