...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = ReadEndpointDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ReadEndpointDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ReadEndpointDetails build() {
            ReadEndpointDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReadEndpointDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReadEndpointDetails)) {
            return false;
        }

        ReadEndpointDetails other = (ReadEndpointDetails) o;
