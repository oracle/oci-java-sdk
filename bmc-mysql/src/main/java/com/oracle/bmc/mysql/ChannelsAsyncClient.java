...
public class ChannelsAsyncClient implements ChannelsAsync {
    ...
    public java.util.concurrent.Future<GenerateChannelStatusResponse> generateChannelStatus(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async generateChannelStatus");
        final GenerateChannelStatusRequest interceptedRequest =
                GenerateChannelStatusConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GenerateChannelStatusConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Channels",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GenerateChannelStatusResponse>
                transformer =
                        GenerateChannelStatusConverter.fromResponse(
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GenerateChannelStatusRequest, GenerateChannelStatusResponse>,
                        java.util.concurrent.Future<GenerateChannelStatusResponse>>
    ...
    public java.util.concurrent.Future<GetChannelStatusResponse> getChannelStatus(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async getChannelStatus");
        final GetChannelStatusRequest interceptedRequest =
                GetChannelStatusConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetChannelStatusConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Channels",
                        "GetChannelStatus",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetChannelStatusResponse>
                transformer =
                        GetChannelStatusConverter.fromResponse(
                                java.util.Optional.of(serviceDetails));
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetChannelStatusRequest, GetChannelStatusResponse>,
                        java.util.concurrent.Future<GetChannelStatusResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
