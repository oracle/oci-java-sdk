...
public class DbBackupsClient implements DbBackups {
    ...
    public CancelBackupDeletionResponse cancelBackupDeletion(CancelBackupDeletionRequest request) {
        LOG.trace("Called cancelBackupDeletion");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CancelBackupDeletionResponse>
                transformer =
    ...
    public CopyBackupResponse copyBackup(CopyBackupRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CopyBackupResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCopyBackupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ExportBackupResponse exportBackup(ExportBackupRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ExportBackupResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getExportBackupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public ValidateBackupResponse validateBackup(ValidateBackupRequest request) {
        LOG.trace("Called validateBackup");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ValidateBackupResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getValidateBackupDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
