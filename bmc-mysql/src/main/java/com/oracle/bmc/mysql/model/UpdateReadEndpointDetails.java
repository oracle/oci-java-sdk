...
public final class UpdateReadEndpointDetails
    ...
    public UpdateReadEndpointDetails(
            Boolean isEnabled,
    ...
    public static class Builder {
        ...
        public UpdateReadEndpointDetails build() {
            UpdateReadEndpointDetails model =
                    new UpdateReadEndpointDetails(
                            this.isEnabled,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateReadEndpointDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateReadEndpointDetails)) {
            return false;
        }

        UpdateReadEndpointDetails other = (UpdateReadEndpointDetails) o;
