...
public class DbSystemClient implements DbSystem {
    ...
    @Override
    public ControlledUpdateDbSystemResponse controlledUpdateDbSystem(
            ControlledUpdateDbSystemRequest request) {
        LOG.trace("Called controlledUpdateDbSystem");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ControlledUpdateDbSystemResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getControlledUpdateDbSystemDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GenerateDbSystemStatusResponse generateDbSystemStatus(
        ...
        LOG.trace("Called generateDbSystemStatus");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GenerateDbSystemStatusResponse>
                transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getGenerateDbSystemStatusDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public GetDbSystemStatusResponse getDbSystemStatus(GetDbSystemStatusRequest request) {
        LOG.trace("Called getDbSystemStatus");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetDbSystemStatusResponse>
                transformer =
    ...
    public ListMaintenanceEventsResponse listMaintenanceEvents(
        ...
        LOG.trace("Called listMaintenanceEvents");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListMaintenanceEventsResponse>
                transformer =
