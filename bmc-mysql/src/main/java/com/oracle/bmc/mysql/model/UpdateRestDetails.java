...
/**
 * Details required to configure REST while updating a DB System. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateRestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UpdateRestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"configuration", "port"})
    public UpdateRestDetails(RestConfigurationType configuration, Integer port) {
        super();
    ...
    public static class Builder {
        ...
        public UpdateRestDetails build() {
            UpdateRestDetails model = new UpdateRestDetails(this.configuration, this.port);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateRestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateRestDetails)) {
            return false;
        }

        UpdateRestDetails other = (UpdateRestDetails) o;
