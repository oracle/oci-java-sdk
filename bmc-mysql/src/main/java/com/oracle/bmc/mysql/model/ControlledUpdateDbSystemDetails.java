...
/**
 * Details of the controlled update action, including the target subset of MySQL instances to update
 * based on their role. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ControlledUpdateDbSystemDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ControlledUpdateDbSystemDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"targetMysqlVersion", "targetDbInstances"})
    public ControlledUpdateDbSystemDetails(
    ...
    public static class Builder {
        ...
        /**
         * Defines the MySQL instances to be operated during a controlled update. - ALL_BUT_PRIMARY:
         * Update all MySQL instances in a highly available DB System except the primary group
         * member, without triggering a controlled failover. - PRIMARY_ONLY: Update the primary
         * group member in a highly available DB System after a controlled failover (downtime is
         * expected). This operation requires that the other MySQL instances have been previously
         * updated using the ALL_BUT_PRIMARY option.
         */
        ...
        public ControlledUpdateDbSystemDetails build() {
            ControlledUpdateDbSystemDetails model =
                    new ControlledUpdateDbSystemDetails(
                            this.targetMysqlVersion, this.targetDbInstances);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ControlledUpdateDbSystemDetails model) {
    ...
    /**
     * Defines the MySQL instances to be operated during a controlled update. - ALL_BUT_PRIMARY:
     * Update all MySQL instances in a highly available DB System except the primary group member,
     * without triggering a controlled failover. - PRIMARY_ONLY: Update the primary group member in
     * a highly available DB System after a controlled failover (downtime is expected). This
     * operation requires that the other MySQL instances have been previously updated using the
     * ALL_BUT_PRIMARY option.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("targetDbInstances")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ControlledUpdateDbSystemDetails)) {
            return false;
        }

        ControlledUpdateDbSystemDetails other = (ControlledUpdateDbSystemDetails) o;
