...
public class ChannelSource extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelSource)) {
            return false;
        }

        ChannelSource other = (ChannelSource) o;
