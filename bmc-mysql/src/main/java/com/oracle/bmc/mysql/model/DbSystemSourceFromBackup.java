...
/**
 * From which backup this DB System was created. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbSystemSourceFromBackup.Builder.class)
...
public final class DbSystemSourceFromBackup extends DbSystemSource {
    ...
    @Deprecated
    public DbSystemSourceFromBackup(String backupId) {
        super();
        this.backupId = backupId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbSystemSourceFromBackup)) {
            return false;
        }
