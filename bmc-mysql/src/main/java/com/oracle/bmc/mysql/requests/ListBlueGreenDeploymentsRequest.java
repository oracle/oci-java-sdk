...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mysql/ListBlueGreenDeploymentsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListBlueGreenDeploymentsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190415")
public class ListBlueGreenDeploymentsRequest
     ...
     */
    private com.oracle.bmc.mysql.model.BlueGreenDeploymentSummary.LifecycleState lifecycleState;

    /**
     * Filters deployments by lifecycle state.
     */
    public com.oracle.bmc.mysql.model.BlueGreenDeploymentSummary.LifecycleState
            getLifecycleState() {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListBlueGreenDeploymentsRequest, java.lang.Void> {
         ...
         * Source DB system [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) filter.
         */
        private String sourceDbSystemId = null;
         ...
         * Target DB system [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) filter.
         */
        private String targetDbSystemId = null;
         ...
         * Filters deployments by lifecycle state.
         */
        private com.oracle.bmc.mysql.model.BlueGreenDeploymentSummary.LifecycleState
                lifecycleState = null;
         ...
         * @return this builder instance
         */
        public Builder copy(ListBlueGreenDeploymentsRequest o) {
            compartmentId(o.getCompartmentId());
            opcRequestId(o.getOpcRequestId());
            limit(o.getLimit());
            page(o.getPage());
            sourceDbSystemId(o.getSourceDbSystemId());
            targetDbSystemId(o.getTargetDbSystemId());
        ...
        /**
         * Build the instance of ListBlueGreenDeploymentsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListBlueGreenDeploymentsRequest
         */
        public ListBlueGreenDeploymentsRequest build() {
            ListBlueGreenDeploymentsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListBlueGreenDeploymentsRequest
         */
        public ListBlueGreenDeploymentsRequest buildWithoutInvocationCallback() {
            ListBlueGreenDeploymentsRequest request = new ListBlueGreenDeploymentsRequest();
            request.compartmentId = compartmentId;
            request.opcRequestId = opcRequestId;
            request.limit = limit;
            request.page = page;
            request.sourceDbSystemId = sourceDbSystemId;
            request.targetDbSystemId = targetDbSystemId;
            request.displayName = displayName;
            request.lifecycleState = lifecycleState;
            request.sortBy = sortBy;
            request.sortOrder = sortOrder;
            return request;
            // new ListBlueGreenDeploymentsRequest(compartmentId, opcRequestId, limit, page, sourceDbSystemId, targetDbSystemId, displayName, lifecycleState, sortBy, sortOrder);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListBlueGreenDeploymentsRequest)) {
            return false;
        }

        ListBlueGreenDeploymentsRequest other = (ListBlueGreenDeploymentsRequest) o;
