...
public interface ReplicasAsync extends AutoCloseable {
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<GetReplicaResponse> getReplica(
            GetReplicaRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetReplicaRequest, GetReplicaResponse> handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<ListReplicasResponse> listReplicas(
            ListReplicasRequest request,
            com.oracle.bmc.responses.AsyncHandler<ListReplicasRequest, ListReplicasResponse>
                    handler);
     ...
     *         both places as the underlying stream may only be consumed once.
     */
    java.util.concurrent.Future<UpdateReplicaResponse> updateReplica(
            UpdateReplicaRequest request,
            com.oracle.bmc.responses.AsyncHandler<UpdateReplicaRequest, UpdateReplicaResponse>
                    handler);
}
