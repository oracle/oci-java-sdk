 ...
 * to any list operations of DbBackups where multiple pages of data may be fetched.
...
public class DbBackupsPaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.mysql.model.BackupSummary} objects
     * contained in responses from the listBackups operation. This iterable will fetch more data from the
     * server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.mysql.model.BackupSummary} objects
     * contained in responses received from the service.
     */
    public Iterable<com.oracle.bmc.mysql.model.BackupSummary> listBackupsRecordIterator(
            final ListBackupsRequest request) {
        return new com.oracle.bmc.paginator.internal.ResponseRecordIterable<
                ...
                new com.google.common.base.Function<
                    ...
                    @Override
                    public java.util.List<com.oracle.bmc.mysql.model.BackupSummary> apply(
