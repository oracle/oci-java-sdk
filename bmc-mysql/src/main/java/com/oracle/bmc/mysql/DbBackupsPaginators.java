 ...
 * to any list operations of DbBackups where multiple pages of data may be fetched. Two styles of
...
public class DbBackupsPaginators {
     ...
     * com.oracle.bmc.mysql.model.BackupSummary} objects contained in responses from the listBackups
     * operation. This iterable will fetch more data from the server as needed.
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link
     *     com.oracle.bmc.mysql.model.BackupSummary} objects contained in responses received from
     *     the service.
     */
