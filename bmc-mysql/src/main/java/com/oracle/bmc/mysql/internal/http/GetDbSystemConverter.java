...
public class GetDbSystemConverter {
    ...
    public static com.oracle.bmc.mysql.requests.GetDbSystemRequest interceptRequest(
            com.oracle.bmc.mysql.requests.GetDbSystemRequest request) {
    ...
    public static java.util.function.Function<
                    javax.ws.rs.core.Response, com.oracle.bmc.mysql.responses.GetDbSystemResponse>
            fromResponse() {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.mysql.responses.GetDbSystemResponse>() {
                            @Override
                            public com.oracle.bmc.mysql.responses.GetDbSystemResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.mysql.responses.GetDbSystemResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.mysql.responses.GetDbSystemResponse responseWrapper =
                                        builder.build();
