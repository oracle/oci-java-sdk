...
public class ReplicasAsyncClient implements ReplicasAsync {
    /**
    ...
    public static class Builder
        ...
        public ReplicasAsyncClient build(
            ...
            return new ReplicasAsyncClient(
                    authenticationDetailsProvider,
                    configuration,
                    clientConfigurator,
                    requestSignerFactory,
    ...
    public java.util.concurrent.Future<CreateReplicaResponse> createReplica(
        ...
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Replicas", "CreateReplica", ib.getRequestUri().toString(), "");
    ...
    public java.util.concurrent.Future<GetReplicaResponse> getReplica(
            ...
            final com.oracle.bmc.responses.AsyncHandler<GetReplicaRequest, GetReplicaResponse>
                    handler) {
        LOG.trace("Called async getReplica");
        final GetReplicaRequest interceptedRequest = GetReplicaConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                GetReplicaConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Replicas",
                        "GetReplica",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, GetReplicaResponse>
                transformer =
                        GetReplicaConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<GetReplicaRequest, GetReplicaResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                GetReplicaRequest, GetReplicaResponse>,
                        java.util.concurrent.Future<GetReplicaResponse>>
    ...
    public java.util.concurrent.Future<ListReplicasResponse> listReplicas(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ListReplicasRequest, ListReplicasResponse>
                    handler) {
        LOG.trace("Called async listReplicas");
        final ListReplicasRequest interceptedRequest =
                ListReplicasConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ListReplicasConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Replicas",
                        "ListReplicas",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ListReplicasResponse>
                transformer =
                        ListReplicasConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ListReplicasRequest, ListReplicasResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ListReplicasRequest, ListReplicasResponse>,
                        java.util.concurrent.Future<ListReplicasResponse>>
                futureSupplier = client.getFutureSupplier(interceptedRequest, ib, transformer);
    ...
    public java.util.concurrent.Future<UpdateReplicaResponse> updateReplica(
            ...
            final com.oracle.bmc.responses.AsyncHandler<UpdateReplicaRequest, UpdateReplicaResponse>
                    handler) {
        LOG.trace("Called async updateReplica");
        final UpdateReplicaRequest interceptedRequest =
                UpdateReplicaConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UpdateReplicaConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "Replicas",
                        "UpdateReplica",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, UpdateReplicaResponse>
                transformer =
                        UpdateReplicaConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<UpdateReplicaRequest, UpdateReplicaResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                UpdateReplicaRequest, UpdateReplicaResponse>,
                        java.util.concurrent.Future<UpdateReplicaResponse>>
                futureSupplier =
                        client.putFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getUpdateReplicaDetails(),
                                ib,
                                transformer);
