...
public class ListBackupsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.mysql.model.BackupSummary} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.mysql.model.BackupSummary> getItems() {
        return items;
    }
    ...
    private ListBackupsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.mysql.model.BackupSummary> items) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.mysql.model.BackupSummary> items) {
            this.items = items;
            return this;
        }
