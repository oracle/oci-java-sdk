...
/**
 * Details required to configure REST while creating a DB System. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateRestDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateRestDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"configuration", "port"})
    public CreateRestDetails(RestConfigurationType configuration, Integer port) {
        super();
    ...
    public static class Builder {
        ...
        public CreateRestDetails build() {
            CreateRestDetails model = new CreateRestDetails(this.configuration, this.port);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateRestDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRestDetails)) {
            return false;
        }

        CreateRestDetails other = (CreateRestDetails) o;
