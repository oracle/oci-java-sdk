...
public interface DbBackupsAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<CancelBackupDeletionResponse> cancelBackupDeletion(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CopyBackupResponse> copyBackup(
            CopyBackupRequest request,
            com.oracle.bmc.responses.AsyncHandler<CopyBackupRequest, CopyBackupResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ExportBackupResponse> exportBackup(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ValidateBackupResponse> validateBackup(
