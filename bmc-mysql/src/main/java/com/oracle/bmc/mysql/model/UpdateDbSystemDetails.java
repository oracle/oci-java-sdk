...
public final class UpdateDbSystemDetails
    ...
    public static class Builder {
        ...
        /**
         * Whether to allocate an IPv6 address for the DB system in an IPv6 enabled subnet. When
         * provided you may optionally provide an IPv6 prefix (ipv6AddressIpv6SubnetCidrPairDetails)
         * of your choice to assign the IPv6 address from. If ipv6AddressIpv6SubnetCidrPairDetails
