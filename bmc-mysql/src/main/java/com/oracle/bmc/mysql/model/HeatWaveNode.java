...
public final class HeatWaveNode {
    @Deprecated
    ...
    public static class Builder {
        ...
        public HeatWaveNode build() {
            HeatWaveNode __instance__ =
                    new HeatWaveNode(nodeId, lifecycleState, timeCreated, timeUpdated);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(HeatWaveNode o) {
