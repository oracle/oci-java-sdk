...
public class GetHeatWaveClusterMemoryEstimateConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactory
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactory();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetHeatWaveClusterMemoryEstimateConverter.class);

    public static com.oracle.bmc.mysql.requests.GetHeatWaveClusterMemoryEstimateRequest
            interceptRequest(
                    com.oracle.bmc.mysql.requests.GetHeatWaveClusterMemoryEstimateRequest request) {
