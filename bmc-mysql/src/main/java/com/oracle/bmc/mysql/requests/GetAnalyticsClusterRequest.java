...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mysql/GetAnalyticsClusterExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAnalyticsClusterRequest.
 */
...
public class GetAnalyticsClusterRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of GetAnalyticsClusterRequest
         */
        public GetAnalyticsClusterRequest buildWithoutInvocationCallback() {
            GetAnalyticsClusterRequest request = new GetAnalyticsClusterRequest();
            request.dbSystemId = dbSystemId;
            request.opcRequestId = opcRequestId;
            request.ifNoneMatch = ifNoneMatch;
            return request;
            // new GetAnalyticsClusterRequest(dbSystemId, opcRequestId, ifNoneMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAnalyticsClusterRequest)) {
            return false;
        }

        GetAnalyticsClusterRequest other = (GetAnalyticsClusterRequest) o;
