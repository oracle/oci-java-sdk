...
public class UpdateChannelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public UpdateChannelResponse build() {
            return new UpdateChannelResponse(__httpStatusCode__, opcRequestId, opcWorkRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateChannelResponse)) {
            return false;
        }

        UpdateChannelResponse other = (UpdateChannelResponse) o;
