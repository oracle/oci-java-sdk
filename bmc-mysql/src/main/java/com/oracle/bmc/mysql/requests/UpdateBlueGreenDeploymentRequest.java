...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mysql/UpdateBlueGreenDeploymentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateBlueGreenDeploymentRequest.
 */
...
public class UpdateBlueGreenDeploymentRequest
    ...
    public static class Builder
        ...
        public UpdateBlueGreenDeploymentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateBlueGreenDeploymentRequest(blueGreenDeploymentId, updateBlueGreenDeploymentDetails, ifMatch, opcRequestId);
        }
    }
