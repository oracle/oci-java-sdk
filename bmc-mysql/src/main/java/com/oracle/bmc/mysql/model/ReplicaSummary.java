...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ReplicaSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class ReplicaSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public ReplicaSummary build() {
            ReplicaSummary model =
                    new ReplicaSummary(
                            this.id,
                            this.dbSystemId,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ReplicaSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReplicaSummary)) {
            return false;
        }

        ReplicaSummary other = (ReplicaSummary) o;
