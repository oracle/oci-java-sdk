...
/**
 * An Object Storage PAR from which to import the DB System initial data. <br>
...
public final class CreateDbSystemSourceImportFromUrlDetails extends CreateDbSystemSourceDetails {
    ...
    public static class Builder {
         ...
         * from the Object Storage. Check [Using Pre-Authenticated
         * Requests](https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/usingpreauthenticatedrequests.htm)
         * for information related to PAR creation. Please create PAR with "Permit object reads"
         * access type and "Enable Object Listing" permission when using a bucket/prefix PAR. Please
         * create PAR with "Permit object reads" access type when using a @.manifest.json object
         * PAR.
         */
    ...
    @Deprecated
    public CreateDbSystemSourceImportFromUrlDetails(
            @com.fasterxml.jackson.annotation.JsonProperty("sourceUrl") char[] sourceUrl) {
        super();
        this.sourceUrl = sourceUrl;
    }
     ...
     * from the Object Storage. Check [Using Pre-Authenticated
     * Requests](https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/usingpreauthenticatedrequests.htm)
     * for information related to PAR creation. Please create PAR with "Permit object reads" access
     * type and "Enable Object Listing" permission when using a bucket/prefix PAR. Please create PAR
     * with "Permit object reads" access type when using a @.manifest.json object PAR.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sourceUrl")
     ...
     * from the Object Storage. Check [Using Pre-Authenticated
     * Requests](https://docs.oracle.com/en-us/iaas/Content/Object/Tasks/usingpreauthenticatedrequests.htm)
     * for information related to PAR creation. Please create PAR with &quot;Permit object
     * reads&quot; access type and &quot;Enable Object Listing&quot; permission when using a
     * bucket/prefix PAR. Please create PAR with &quot;Permit object reads&quot; access type when
     * using a @.manifest.json object PAR.
     *
     * @return the value
