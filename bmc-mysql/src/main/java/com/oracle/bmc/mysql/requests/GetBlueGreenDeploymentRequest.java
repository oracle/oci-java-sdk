...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mysql/GetBlueGreenDeploymentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetBlueGreenDeploymentRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20190415")
public class GetBlueGreenDeploymentRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetBlueGreenDeploymentRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetBlueGreenDeploymentRequest o) {
        ...
        /**
         * Build the instance of GetBlueGreenDeploymentRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetBlueGreenDeploymentRequest
         */
        public GetBlueGreenDeploymentRequest build() {
            GetBlueGreenDeploymentRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetBlueGreenDeploymentRequest
         */
        public GetBlueGreenDeploymentRequest buildWithoutInvocationCallback() {
            GetBlueGreenDeploymentRequest request = new GetBlueGreenDeploymentRequest();
            request.blueGreenDeploymentId = blueGreenDeploymentId;
            request.opcRequestId = opcRequestId;
            request.ifNoneMatch = ifNoneMatch;
            return request;
            // new GetBlueGreenDeploymentRequest(blueGreenDeploymentId, opcRequestId, ifNoneMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetBlueGreenDeploymentRequest)) {
            return false;
        }

        GetBlueGreenDeploymentRequest other = (GetBlueGreenDeploymentRequest) o;
