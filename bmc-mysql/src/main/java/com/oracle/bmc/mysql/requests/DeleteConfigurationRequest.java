...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/mysql/DeleteConfigurationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteConfigurationRequest.
 */
...
public class DeleteConfigurationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
         ...
         * @return instance of DeleteConfigurationRequest
         */
        public DeleteConfigurationRequest buildWithoutInvocationCallback() {
            DeleteConfigurationRequest request = new DeleteConfigurationRequest();
            request.configurationId = configurationId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteConfigurationRequest(configurationId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteConfigurationRequest)) {
            return false;
        }

        DeleteConfigurationRequest other = (DeleteConfigurationRequest) o;
