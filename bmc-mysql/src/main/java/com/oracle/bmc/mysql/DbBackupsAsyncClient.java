...
public class DbBackupsAsyncClient implements DbBackupsAsync {
    ...
    public java.util.concurrent.Future<CancelBackupDeletionResponse> cancelBackupDeletion(
            ...
            final com.oracle.bmc.responses.AsyncHandler<
                    ...
                    handler) {
        LOG.trace("Called async cancelBackupDeletion");
        final CancelBackupDeletionRequest interceptedRequest =
                CancelBackupDeletionConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CancelBackupDeletionConverter.fromRequest(client, interceptedRequest);
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CancelBackupDeletionResponse>
                transformer =
                        CancelBackupDeletionConverter.fromResponse(
        ...
        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CancelBackupDeletionRequest, CancelBackupDeletionResponse>,
                        java.util.concurrent.Future<CancelBackupDeletionResponse>>
    ...
    public java.util.concurrent.Future<CopyBackupResponse> copyBackup(
            ...
            final com.oracle.bmc.responses.AsyncHandler<CopyBackupRequest, CopyBackupResponse>
                    handler) {
        LOG.trace("Called async copyBackup");
        final CopyBackupRequest interceptedRequest = CopyBackupConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                CopyBackupConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "DbBackups",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, CopyBackupResponse>
                transformer =
                        CopyBackupConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<CopyBackupRequest, CopyBackupResponse> handlerToUse =
                handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                CopyBackupRequest, CopyBackupResponse>,
                        java.util.concurrent.Future<CopyBackupResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getCopyBackupDetails(),
                                ib,
                                transformer);
    ...
    public java.util.concurrent.Future<ExportBackupResponse> exportBackup(
            ...
            final com.oracle.bmc.responses.AsyncHandler<ExportBackupRequest, ExportBackupResponse>
                    handler) {
        LOG.trace("Called async exportBackup");
        final ExportBackupRequest interceptedRequest =
                ExportBackupConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ExportBackupConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "DbBackups",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ExportBackupResponse>
                transformer =
                        ExportBackupConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ExportBackupRequest, ExportBackupResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ExportBackupRequest, ExportBackupResponse>,
                        java.util.concurrent.Future<ExportBackupResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getExportBackupDetails(),
                                ib,
                                transformer);
    ...
    @Override
    public java.util.concurrent.Future<ValidateBackupResponse> validateBackup(
            ValidateBackupRequest request,
            final com.oracle.bmc.responses.AsyncHandler<
                            ValidateBackupRequest, ValidateBackupResponse>
                    handler) {
        LOG.trace("Called async validateBackup");
        final ValidateBackupRequest interceptedRequest =
                ValidateBackupConverter.interceptRequest(request);
        final com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                ValidateBackupConverter.fromRequest(client, interceptedRequest);
        com.oracle.bmc.http.internal.RetryTokenUtils.addRetryToken(ib);
        com.oracle.bmc.ServiceDetails serviceDetails =
                new com.oracle.bmc.ServiceDetails(
                        "DbBackups",
        ...
        final java.util.function.Function<javax.ws.rs.core.Response, ValidateBackupResponse>
                transformer =
                        ValidateBackupConverter.fromResponse(java.util.Optional.of(serviceDetails));
        com.oracle.bmc.responses.AsyncHandler<ValidateBackupRequest, ValidateBackupResponse>
                handlerToUse = handler;

        java.util.function.Function<
                        com.oracle.bmc.responses.AsyncHandler<
                                ValidateBackupRequest, ValidateBackupResponse>,
                        java.util.concurrent.Future<ValidateBackupResponse>>
                futureSupplier =
                        client.postFutureSupplier(
                                interceptedRequest,
                                interceptedRequest.getValidateBackupDetails(),
                                ib,
                                transformer);
