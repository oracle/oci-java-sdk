...
public class CopyBackupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CopyBackupResponse> {
         ...
         */
        @Override
        public Builder copy(CopyBackupResponse o) {
         ...
         */
        @Override
        public CopyBackupResponse build() {
            return new CopyBackupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CopyBackupResponse)) {
            return false;
        }

        CopyBackupResponse other = (CopyBackupResponse) o;
