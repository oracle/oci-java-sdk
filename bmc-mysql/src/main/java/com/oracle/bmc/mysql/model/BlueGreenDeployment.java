...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = BlueGreenDeployment.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class BlueGreenDeployment extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public BlueGreenDeployment(
            BlueGreenDeploymentTargetDbSystemDetails targetDbSystemDetails,
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("targetDbSystemDetails")
        private BlueGreenDeploymentTargetDbSystemDetails targetDbSystemDetails;

        public Builder targetDbSystemDetails(
                BlueGreenDeploymentTargetDbSystemDetails targetDbSystemDetails) {
            this.targetDbSystemDetails = targetDbSystemDetails;
            this.__explicitlySet__.add("targetDbSystemDetails");
            return this;
        }
        /**
         * Replication channel [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
         **/
        @com.fasterxml.jackson.annotation.JsonProperty("replicationChannelId")
        private String replicationChannelId;

        /**
         * Replication channel [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
         * @param replicationChannelId the value to set
         * @return this builder
         **/
        public Builder replicationChannelId(String replicationChannelId) {
            this.replicationChannelId = replicationChannelId;
            this.__explicitlySet__.add("replicationChannelId");
            return this;
        }
        /**
        ...
        public BlueGreenDeployment build() {
            BlueGreenDeployment model =
                    new BlueGreenDeployment(
                            this.targetDbSystemDetails,
                            this.replicationChannelId,
                            this.sslMode,
                            this.id,
                            this.compartmentId,
                            this.displayName,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(BlueGreenDeployment model) {
            if (model.wasPropertyExplicitlySet("targetDbSystemDetails")) {
                this.targetDbSystemDetails(model.getTargetDbSystemDetails());
            }
            if (model.wasPropertyExplicitlySet("replicationChannelId")) {
                this.replicationChannelId(model.getReplicationChannelId());
            }
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("targetDbSystemDetails")
    private final BlueGreenDeploymentTargetDbSystemDetails targetDbSystemDetails;

    public BlueGreenDeploymentTargetDbSystemDetails getTargetDbSystemDetails() {
        return targetDbSystemDetails;
    }
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("replicationChannelId")
    private final String replicationChannelId;

    /**
     * Replication channel [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
     * @return the value
     **/
    public String getReplicationChannelId() {
        return replicationChannelId;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("BlueGreenDeployment(");
        sb.append("super=").append(super.toString());
        sb.append("targetDbSystemDetails=").append(String.valueOf(this.targetDbSystemDetails));
        sb.append(", replicationChannelId=").append(String.valueOf(this.replicationChannelId));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BlueGreenDeployment)) {
            return false;
        }

        BlueGreenDeployment other = (BlueGreenDeployment) o;
        return java.util.Objects.equals(this.targetDbSystemDetails, other.targetDbSystemDetails)
                && java.util.Objects.equals(this.replicationChannelId, other.replicationChannelId)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.targetDbSystemDetails == null
                                ? 43
                                : this.targetDbSystemDetails.hashCode());
        result =
                (result * PRIME)
                        + (this.replicationChannelId == null
                                ? 43
                                : this.replicationChannelId.hashCode());
