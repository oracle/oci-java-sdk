...
public class ReplicasClient implements Replicas {
    /**
    ...
    public GetReplicaResponse getReplica(GetReplicaRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, GetReplicaResponse> transformer =
    ...
    public ListReplicasResponse listReplicas(ListReplicasRequest request) {
        ...
        java.util.function.Function<javax.ws.rs.core.Response, ListReplicasResponse> transformer =
    ...
    public UpdateReplicaResponse updateReplica(UpdateReplicaRequest request) {
        LOG.trace("Called updateReplica");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UpdateReplicaResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateReplicaDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
