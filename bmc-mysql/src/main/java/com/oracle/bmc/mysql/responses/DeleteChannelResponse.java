...
public class DeleteChannelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public DeleteChannelResponse build() {
            return new DeleteChannelResponse(__httpStatusCode__, opcRequestId, opcWorkRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteChannelResponse)) {
            return false;
        }

        DeleteChannelResponse other = (DeleteChannelResponse) o;
