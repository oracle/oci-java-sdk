...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagement/ListWindowsUpdatesExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use ListWindowsUpdatesRequest.
 */
...
public class ListWindowsUpdatesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListWindowsUpdatesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListWindowsUpdatesRequest(compartmentId, displayName, limit, page, sortOrder,
            // sortBy, opcRequestId);
        }
    }
