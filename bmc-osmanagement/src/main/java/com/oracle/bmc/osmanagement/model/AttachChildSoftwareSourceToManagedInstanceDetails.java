...
public final class AttachChildSoftwareSourceToManagedInstanceDetails
    ...
    public static class Builder {
        ...
        public AttachChildSoftwareSourceToManagedInstanceDetails build() {
            AttachChildSoftwareSourceToManagedInstanceDetails model =
                    new AttachChildSoftwareSourceToManagedInstanceDetails(this.softwareSourceId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachChildSoftwareSourceToManagedInstanceDetails model) {
