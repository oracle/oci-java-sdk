...
public final class AttachParentSoftwareSourceToManagedInstanceDetails {
    ...
    public static class Builder {
        ...
        public AttachParentSoftwareSourceToManagedInstanceDetails build() {
            AttachParentSoftwareSourceToManagedInstanceDetails __instance__ =
                    new AttachParentSoftwareSourceToManagedInstanceDetails(softwareSourceId);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AttachParentSoftwareSourceToManagedInstanceDetails o) {
