...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagement/AttachManagedInstanceToManagedInstanceGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AttachManagedInstanceToManagedInstanceGroupRequest.
 */
...
public class AttachManagedInstanceToManagedInstanceGroupRequest
    ...
    public static class Builder
        ...
        public AttachManagedInstanceToManagedInstanceGroupRequest buildWithoutInvocationCallback() {
            AttachManagedInstanceToManagedInstanceGroupRequest request =
                    new AttachManagedInstanceToManagedInstanceGroupRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachManagedInstanceToManagedInstanceGroupRequest)) {
            return false;
        }

        AttachManagedInstanceToManagedInstanceGroupRequest other =
                (AttachManagedInstanceToManagedInstanceGroupRequest) o;
