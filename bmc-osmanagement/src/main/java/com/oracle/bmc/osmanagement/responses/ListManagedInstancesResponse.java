...
public class ListManagedInstancesResponse extends com.oracle.bmc.responses.BmcResponse {
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.osmanagement.model.ManagedInstanceSummary> getItems() {
        return items;
    }
    ...
    private ListManagedInstancesResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.osmanagement.model.ManagedInstanceSummary> items) {
