...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagement/DetachManagedInstanceFromManagedInstanceGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DetachManagedInstanceFromManagedInstanceGroupRequest.
 */
...
public class DetachManagedInstanceFromManagedInstanceGroupRequest
    ...
    public static class Builder
         ...
         * @return instance of DetachManagedInstanceFromManagedInstanceGroupRequest
         */
        public DetachManagedInstanceFromManagedInstanceGroupRequest
                buildWithoutInvocationCallback() {
            DetachManagedInstanceFromManagedInstanceGroupRequest request =
                    new DetachManagedInstanceFromManagedInstanceGroupRequest();
            request.managedInstanceGroupId = managedInstanceGroupId;
            request.managedInstanceId = managedInstanceId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new DetachManagedInstanceFromManagedInstanceGroupRequest(managedInstanceGroupId, managedInstanceId, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetachManagedInstanceFromManagedInstanceGroupRequest)) {
            return false;
        }

        DetachManagedInstanceFromManagedInstanceGroupRequest other =
                (DetachManagedInstanceFromManagedInstanceGroupRequest) o;
