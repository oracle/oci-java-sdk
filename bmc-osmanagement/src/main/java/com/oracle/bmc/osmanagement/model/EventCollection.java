...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = EventCollection.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class EventCollection extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public EventCollection(java.util.List<EventSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public EventCollection build() {
            EventCollection model = new EventCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EventCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventCollection)) {
            return false;
        }

        EventCollection other = (EventCollection) o;
