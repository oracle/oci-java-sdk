...
public class InstallAllPackageUpdatesOnManagedInstanceResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallAllPackageUpdatesOnManagedInstanceResponse)) {
            return false;
        }

        InstallAllPackageUpdatesOnManagedInstanceResponse other =
                (InstallAllPackageUpdatesOnManagedInstanceResponse) o;
