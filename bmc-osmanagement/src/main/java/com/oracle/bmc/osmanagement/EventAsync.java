...
public interface EventAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<DeleteEventContentResponse> deleteEventContent(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetEventResponse> getEvent(
            GetEventRequest request,
            com.oracle.bmc.responses.AsyncHandler<GetEventRequest, GetEventResponse> handler);

    /**
     * Get additional data about a event as a ZIP archive. The archive content depends on the event
     * eventType.
     *
     * @param request The request object containing the details to send
     * @param handler The request handler to invoke upon completion, may be null.
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetEventContentResponse> getEventContent(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<GetEventReportResponse> getEventReport(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListRelatedEventsResponse> listRelatedEvents(
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateEventResponse> updateEvent(
            UpdateEventRequest request,
            com.oracle.bmc.responses.AsyncHandler<UpdateEventRequest, UpdateEventResponse> handler);
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UploadEventContentResponse> uploadEventContent(
