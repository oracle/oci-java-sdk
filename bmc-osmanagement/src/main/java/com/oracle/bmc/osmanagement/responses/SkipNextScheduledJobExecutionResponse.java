...
public class SkipNextScheduledJobExecutionResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private SkipNextScheduledJobExecutionResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(SkipNextScheduledJobExecutionResponse o) {
        ...
        public SkipNextScheduledJobExecutionResponse build() {
            return new SkipNextScheduledJobExecutionResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SkipNextScheduledJobExecutionResponse)) {
            return false;
        }

        SkipNextScheduledJobExecutionResponse other = (SkipNextScheduledJobExecutionResponse) o;
