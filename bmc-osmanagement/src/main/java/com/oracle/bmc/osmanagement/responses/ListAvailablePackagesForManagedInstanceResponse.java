...
public class ListAvailablePackagesForManagedInstanceResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAvailablePackagesForManagedInstanceResponse)) {
            return false;
        }

        ListAvailablePackagesForManagedInstanceResponse other =
                (ListAvailablePackagesForManagedInstanceResponse) o;
