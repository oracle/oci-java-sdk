...
public class ChangeManagedInstanceGroupCompartmentResponse
    ...
    public static class Builder {
         ...
         */
        public ChangeManagedInstanceGroupCompartmentResponse build() {
            return new ChangeManagedInstanceGroupCompartmentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeManagedInstanceGroupCompartmentResponse)) {
            return false;
        }

        ChangeManagedInstanceGroupCompartmentResponse other =
                (ChangeManagedInstanceGroupCompartmentResponse) o;
