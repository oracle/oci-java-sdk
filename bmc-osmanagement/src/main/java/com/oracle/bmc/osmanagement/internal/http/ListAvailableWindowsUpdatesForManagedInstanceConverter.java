...
public class ListAvailableWindowsUpdatesForManagedInstanceConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    ListAvailableWindowsUpdatesForManagedInstanceConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getIsEligibleForInstallation() != null) {
            target =
                    target.queryParam(
                            "isEligibleForInstallation",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getIsEligibleForInstallation().getValue()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.osmanagement.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.osmanagement.responses.ListAvailableWindowsUpdatesForManagedInstanceResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
