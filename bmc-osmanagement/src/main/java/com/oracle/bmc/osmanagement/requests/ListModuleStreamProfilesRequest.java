...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagement/ListModuleStreamProfilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListModuleStreamProfilesRequest.
 */
...
public class ListModuleStreamProfilesRequest
    ...
    public static class Builder
        ...
        public ListModuleStreamProfilesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListModuleStreamProfilesRequest(softwareSourceId, compartmentId, moduleName, streamName, profileName, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
