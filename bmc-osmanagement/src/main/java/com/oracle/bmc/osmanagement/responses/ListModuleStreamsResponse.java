...
public class ListModuleStreamsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.osmanagement.model.ModuleStreamSummary} instances. */
    private java.util.List<com.oracle.bmc.osmanagement.model.ModuleStreamSummary> items;
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.osmanagement.model.ModuleStreamSummary> getItems() {
        return items;
    }
    ...
    private ListModuleStreamsResponse(
            ...
            String opcRequestId,
            String opcNextPage,
            java.util.List<com.oracle.bmc.osmanagement.model.ModuleStreamSummary> items) {
