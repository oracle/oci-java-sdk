...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RemovePackagesFromSoftwareSourceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetFilter.NAME)
public final class RemovePackagesFromSoftwareSourceDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"packageNames"})
    public RemovePackagesFromSoftwareSourceDetails(java.util.List<String> packageNames) {
        super();
    ...
    public static class Builder {
        ...
        public RemovePackagesFromSoftwareSourceDetails build() {
            RemovePackagesFromSoftwareSourceDetails model =
                    new RemovePackagesFromSoftwareSourceDetails(this.packageNames);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemovePackagesFromSoftwareSourceDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemovePackagesFromSoftwareSourceDetails)) {
            return false;
        }

        RemovePackagesFromSoftwareSourceDetails other = (RemovePackagesFromSoftwareSourceDetails) o;
