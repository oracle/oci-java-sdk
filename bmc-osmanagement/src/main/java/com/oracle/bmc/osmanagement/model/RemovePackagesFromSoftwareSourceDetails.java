...
public final class RemovePackagesFromSoftwareSourceDetails {
    ...
    public static class Builder {
        ...
        public RemovePackagesFromSoftwareSourceDetails build() {
            RemovePackagesFromSoftwareSourceDetails __instance__ =
                    new RemovePackagesFromSoftwareSourceDetails(packageNames);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RemovePackagesFromSoftwareSourceDetails o) {
