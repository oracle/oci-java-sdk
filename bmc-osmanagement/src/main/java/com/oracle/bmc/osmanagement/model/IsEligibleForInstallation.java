...
public enum IsEligibleForInstallation {
    ...
    static {
        ...
        for (IsEligibleForInstallation v : IsEligibleForInstallation.values()) {
    ...
    IsEligibleForInstallation(String value) {
        this.value = value;
    }
    ...
    public static IsEligibleForInstallation create(String key) {
        if (map.containsKey(key)) {
            return map.get(key);
        }
        LOG.warn(
                "Received unknown value '{}' for enum 'IsEligibleForInstallation', returning UnknownEnumValue",
                key);
