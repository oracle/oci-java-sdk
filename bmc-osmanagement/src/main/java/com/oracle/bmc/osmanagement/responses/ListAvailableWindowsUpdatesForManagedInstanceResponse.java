...
public class ListAvailableWindowsUpdatesForManagedInstanceResponse
    ...
    public static class Builder {
        ...
        public Builder items(
                java.util.List<com.oracle.bmc.osmanagement.model.AvailableWindowsUpdateSummary>
                        items) {
            this.items = items;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListAvailableWindowsUpdatesForManagedInstanceResponse)) {
            return false;
        }

        ListAvailableWindowsUpdatesForManagedInstanceResponse other =
                (ListAvailableWindowsUpdatesForManagedInstanceResponse) o;
