...
public class UpdateManagedInstanceConverter {
    ...
    public static com.oracle.bmc.osmanagement.requests.UpdateManagedInstanceRequest
            interceptRequest(
                    com.oracle.bmc.osmanagement.requests.UpdateManagedInstanceRequest request) {
