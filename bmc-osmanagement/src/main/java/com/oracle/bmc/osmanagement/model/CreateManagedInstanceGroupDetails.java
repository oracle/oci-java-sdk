...
/**
 * Detail information for creating a managed instance group <br>
...
public final class CreateManagedInstanceGroupDetails
    ...
    public CreateManagedInstanceGroupDetails(
            String displayName,
            String description,
    ...
    public static class Builder {
        ...
        public CreateManagedInstanceGroupDetails build() {
            CreateManagedInstanceGroupDetails model =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateManagedInstanceGroupDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateManagedInstanceGroupDetails)) {
            return false;
        }

        CreateManagedInstanceGroupDetails other = (CreateManagedInstanceGroupDetails) o;
