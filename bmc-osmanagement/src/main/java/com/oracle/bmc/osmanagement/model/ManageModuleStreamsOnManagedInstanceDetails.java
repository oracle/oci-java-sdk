...
public final class ManageModuleStreamsOnManagedInstanceDetails
    ...
    public static class Builder {
        /**
         * Indicates if this operation is a dry run or if the operation should be commited. If set
    ...
    /**
     * Indicates if this operation is a dry run or if the operation should be commited. If set to
