...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/osmanagement/InstallAllWindowsUpdatesOnManagedInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use InstallAllWindowsUpdatesOnManagedInstanceRequest.
 */
...
public class InstallAllWindowsUpdatesOnManagedInstanceRequest
    ...
    public static class Builder
        ...
        public InstallAllWindowsUpdatesOnManagedInstanceRequest buildWithoutInvocationCallback() {
            InstallAllWindowsUpdatesOnManagedInstanceRequest request =
                    new InstallAllWindowsUpdatesOnManagedInstanceRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InstallAllWindowsUpdatesOnManagedInstanceRequest)) {
            return false;
        }

        InstallAllWindowsUpdatesOnManagedInstanceRequest other =
                (InstallAllWindowsUpdatesOnManagedInstanceRequest) o;
