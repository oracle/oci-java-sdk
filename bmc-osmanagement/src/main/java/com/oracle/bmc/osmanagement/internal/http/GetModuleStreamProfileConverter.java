...
public class GetModuleStreamProfileConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetModuleStreamProfileConverter.class);

    public static com.oracle.bmc.osmanagement.requests.GetModuleStreamProfileRequest
            interceptRequest(
                    com.oracle.bmc.osmanagement.requests.GetModuleStreamProfileRequest request) {
