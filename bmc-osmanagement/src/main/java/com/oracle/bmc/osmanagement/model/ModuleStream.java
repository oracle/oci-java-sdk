...
public final class ModuleStream extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    ...
    public static class Builder {
         ...
         * profile. The name is suitable to use as an argument to other OS Management APIs that
         ...
         * of a package. The name is suitable to use as an argument to other OS Management APIs that
    ...
    /**
     * A list of profiles that are part of the stream. Each element in the list is the name of a
     * profile. The name is suitable to use as an argument to other OS Management APIs that interact
     * directly with module stream profiles. However, it is not URL encoded.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("profiles")
     ...
     * a package. The name is suitable to use as an argument to other OS Management APIs that
     * interact directly with packages.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("packages")
