...
public class UpdateZoneRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateZoneRecordsResponse> {
         ...
         */
        @Override
        public UpdateZoneRecordsResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateZoneRecordsResponse)) {
            return false;
        }

        UpdateZoneRecordsResponse other = (UpdateZoneRecordsResponse) o;
