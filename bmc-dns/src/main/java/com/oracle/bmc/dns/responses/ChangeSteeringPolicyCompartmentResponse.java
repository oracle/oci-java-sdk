...
public class ChangeSteeringPolicyCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ChangeSteeringPolicyCompartmentResponse o) {
        ...
        public ChangeSteeringPolicyCompartmentResponse build() {
            return new ChangeSteeringPolicyCompartmentResponse(__httpStatusCode__, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeSteeringPolicyCompartmentResponse)) {
            return false;
        }
