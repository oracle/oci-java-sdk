...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/UpdateTsigKeyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateTsigKeyRequest.
 */
...
public class UpdateTsigKeyRequest
    ...
    public static class Builder
        ...
        public UpdateTsigKeyRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new UpdateTsigKeyRequest(tsigKeyId, updateTsigKeyDetails, ifMatch, ifUnmodifiedSince, opcRequestId, scope);
        }
    }
