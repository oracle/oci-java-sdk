 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSteeringPolicyRequest.
 */
...
public class UpdateSteeringPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateSteeringPolicyRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new UpdateSteeringPolicyRequest(steeringPolicyId, updateSteeringPolicyDetails,
            // ifMatch, ifUnmodifiedSince, opcRequestId, scope);
        }
    }
