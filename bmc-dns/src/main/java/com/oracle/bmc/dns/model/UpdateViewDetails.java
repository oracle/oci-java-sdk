...
public final class UpdateViewDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"displayName", "freeformTags", "definedTags"})
    public UpdateViewDetails(
            String displayName,
    ...
    public static class Builder {
        ...
        public UpdateViewDetails build() {
            UpdateViewDetails model =
                    new UpdateViewDetails(this.displayName, this.freeformTags, this.definedTags);
