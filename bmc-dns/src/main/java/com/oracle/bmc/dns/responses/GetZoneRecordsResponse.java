...
public class GetZoneRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetZoneRecordsResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetZoneRecordsResponse> {
         ...
         */
        @Override
        public Builder copy(GetZoneRecordsResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetZoneRecordsResponse)) {
            return false;
        }

        GetZoneRecordsResponse other = (GetZoneRecordsResponse) o;
