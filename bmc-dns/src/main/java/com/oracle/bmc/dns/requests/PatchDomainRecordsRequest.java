...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/PatchDomainRecordsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchDomainRecordsRequest.
 */
...
public class PatchDomainRecordsRequest
    ...
    public static class Builder
        ...
        public PatchDomainRecordsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchDomainRecordsRequest(zoneNameOrId, domain, patchDomainRecordsDetails, ifMatch, ifUnmodifiedSince, opcRequestId, scope, viewId, compartmentId);
        }
    }
