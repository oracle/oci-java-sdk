...
public class GetZoneContentResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetZoneContentResponse> {
         ...
         */
        @Override
        public Builder copy(GetZoneContentResponse o) {
        ...
        public GetZoneContentResponse build() {
            return new GetZoneContentResponse(
