...
public class UpdateDomainRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateDomainRecordsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateDomainRecordsResponse)) {
            return false;
        }

        UpdateDomainRecordsResponse other = (UpdateDomainRecordsResponse) o;
