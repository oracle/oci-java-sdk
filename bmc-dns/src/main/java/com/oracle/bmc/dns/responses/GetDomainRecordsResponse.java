...
public class GetDomainRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDomainRecordsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDomainRecordsResponse)) {
            return false;
        }

        GetDomainRecordsResponse other = (GetDomainRecordsResponse) o;
