...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/UpdateViewExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateViewRequest.
 */
...
public class UpdateViewRequest
    ...
    public static class Builder
        ...
        public UpdateViewRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new UpdateViewRequest(viewId, updateViewDetails, ifMatch, ifUnmodifiedSince, opcRequestId, scope);
        }
    }
