...
public final class CreateViewDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        public CreateViewDetails build() {
            CreateViewDetails model =
                    new CreateViewDetails(
                            this.compartmentId,
                            this.displayName,
                            this.freeformTags,
                            this.definedTags);
