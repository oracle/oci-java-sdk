...
public class DeleteZoneResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
        ...
        public DeleteZoneResponse build() {
            return new DeleteZoneResponse(__httpStatusCode__, opcRequestId, opcWorkRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteZoneResponse)) {
            return false;
        }

        DeleteZoneResponse other = (DeleteZoneResponse) o;
