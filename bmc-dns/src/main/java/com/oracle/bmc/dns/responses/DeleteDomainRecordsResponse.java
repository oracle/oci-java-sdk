...
public class DeleteDomainRecordsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteDomainRecordsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDomainRecordsResponse)) {
            return false;
        }

        DeleteDomainRecordsResponse other = (DeleteDomainRecordsResponse) o;
