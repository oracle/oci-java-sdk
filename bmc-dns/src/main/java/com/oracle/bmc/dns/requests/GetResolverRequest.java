 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetResolverRequest.
 */
...
public class GetResolverRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetResolverRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new GetResolverRequest(resolverId, ifModifiedSince, ifNoneMatch, opcRequestId,
            // scope);
        }
    }
