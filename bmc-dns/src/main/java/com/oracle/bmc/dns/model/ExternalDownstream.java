...
/**
 * External downstream nameserver for the zone. This field is currently not supported when {@code
 * zoneType} is {@code SECONDARY} or {@code scope} is {@code PRIVATE}. <br>
...
public final class ExternalDownstream
    ...
    public static class Builder {
        ...
        /**
         * The OCID of the TSIG key. A TSIG key is used to secure DNS messages (in this case, zone
         * transfers) between two systems that both have the (shared) secret.
         */
