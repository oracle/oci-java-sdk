...
/**
 * A collection of DNS records of the same domain and type. For more information about record types,
 * see [Resource Record (RR)
...
public final class RRSet extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"items"})
    public RRSet(java.util.List<Record> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public RRSet build() {
            RRSet model = new RRSet(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RRSet model) {
