...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/PatchRRSetExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchRRSetRequest.
 */
...
public class PatchRRSetRequest
     ...
     * Operations describing how to modify the collection of records.
     */
    public com.oracle.bmc.dns.model.PatchRRSetDetails getPatchRRSetDetails() {
    ...
    public static class Builder
         ...
         * Operations describing how to modify the collection of records.
         */
        private com.oracle.bmc.dns.model.PatchRRSetDetails patchRRSetDetails = null;

        /**
         * Operations describing how to modify the collection of records.
         * @param patchRRSetDetails the value to set
         * @return this builder instance
         */
        public Builder patchRRSetDetails(
                com.oracle.bmc.dns.model.PatchRRSetDetails patchRRSetDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(PatchRRSetRequest o) {
            zoneNameOrId(o.getZoneNameOrId());
            domain(o.getDomain());
            rtype(o.getRtype());
            patchRRSetDetails(o.getPatchRRSetDetails());
         ...
         *
         * @return instance of PatchRRSetRequest
         */
        ...
        public PatchRRSetRequest buildWithoutInvocationCallback() {
            PatchRRSetRequest request = new PatchRRSetRequest();
            request.zoneNameOrId = zoneNameOrId;
            request.domain = domain;
            request.rtype = rtype;
            request.patchRRSetDetails = patchRRSetDetails;
            ...
            return request;
            // new PatchRRSetRequest(zoneNameOrId, domain, rtype, patchRRSetDetails, ifMatch, ifUnmodifiedSince, opcRequestId, scope, viewId, compartmentId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatchRRSetRequest)) {
            return false;
        }

        PatchRRSetRequest other = (PatchRRSetRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.patchRRSetDetails, other.patchRRSetDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.patchRRSetDetails == null ? 43 : this.patchRRSetDetails.hashCode());
