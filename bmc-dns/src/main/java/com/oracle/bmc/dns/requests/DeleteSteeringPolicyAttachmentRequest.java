...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/DeleteSteeringPolicyAttachmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSteeringPolicyAttachmentRequest.
 */
...
public class DeleteSteeringPolicyAttachmentRequest
    ...
    public static class Builder
         ...
         */
        public DeleteSteeringPolicyAttachmentRequest build() {
            DeleteSteeringPolicyAttachmentRequest request = buildWithoutInvocationCallback();
        ...
        public DeleteSteeringPolicyAttachmentRequest buildWithoutInvocationCallback() {
            DeleteSteeringPolicyAttachmentRequest request =
                    new DeleteSteeringPolicyAttachmentRequest();
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSteeringPolicyAttachmentRequest)) {
            return false;
        }

        DeleteSteeringPolicyAttachmentRequest other = (DeleteSteeringPolicyAttachmentRequest) o;
