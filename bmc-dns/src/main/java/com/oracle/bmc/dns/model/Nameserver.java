...
/**
 * A server that has been set up to answer DNS queries for a zone. <br>
...
public final class Nameserver extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
