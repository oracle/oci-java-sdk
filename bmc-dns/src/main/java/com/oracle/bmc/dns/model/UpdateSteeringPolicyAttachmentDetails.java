...
public final class UpdateSteeringPolicyAttachmentDetails {
    ...
    public static class Builder {
        ...
        public UpdateSteeringPolicyAttachmentDetails build() {
            UpdateSteeringPolicyAttachmentDetails __instance__ =
                    new UpdateSteeringPolicyAttachmentDetails(displayName);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSteeringPolicyAttachmentDetails o) {
