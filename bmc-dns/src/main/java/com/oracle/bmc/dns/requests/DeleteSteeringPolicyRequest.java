 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSteeringPolicyRequest.
 */
...
public class DeleteSteeringPolicyRequest
    ...
    public static class Builder
        ...
        public DeleteSteeringPolicyRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new DeleteSteeringPolicyRequest(steeringPolicyId, ifMatch, ifUnmodifiedSince,
            // opcRequestId, scope);
        }
    }
