...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/UpdateResolverExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateResolverRequest.
 */
...
public class UpdateResolverRequest
     ...
     * New data for the resolver.
     */
    public com.oracle.bmc.dns.model.UpdateResolverDetails getUpdateResolverDetails() {
    ...
    public static class Builder
         ...
         * New data for the resolver.
         */
        private com.oracle.bmc.dns.model.UpdateResolverDetails updateResolverDetails = null;

        /**
         * New data for the resolver.
         * @param updateResolverDetails the value to set
         * @return this builder instance
         */
        public Builder updateResolverDetails(
                com.oracle.bmc.dns.model.UpdateResolverDetails updateResolverDetails) {
        ...
        public UpdateResolverRequest buildWithoutInvocationCallback() {
            UpdateResolverRequest request = new UpdateResolverRequest();
            request.resolverId = resolverId;
            request.updateResolverDetails = updateResolverDetails;
            request.ifMatch = ifMatch;
            request.ifUnmodifiedSince = ifUnmodifiedSince;
            request.opcRequestId = opcRequestId;
            request.scope = scope;
            return request;
            // new UpdateResolverRequest(resolverId, updateResolverDetails, ifMatch, ifUnmodifiedSince, opcRequestId, scope);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateResolverDetails=").append(String.valueOf(this.updateResolverDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateResolverRequest)) {
            return false;
        }

        UpdateResolverRequest other = (UpdateResolverRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.resolverId, other.resolverId)
                && java.util.Objects.equals(this.updateResolverDetails, other.updateResolverDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateResolverDetails == null
                                ? 43
                                : this.updateResolverDetails.hashCode());
