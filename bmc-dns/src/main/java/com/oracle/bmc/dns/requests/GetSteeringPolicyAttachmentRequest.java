...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/GetSteeringPolicyAttachmentExample.java.html">here</a> to see how to use GetSteeringPolicyAttachmentRequest.
 */
...
public class GetSteeringPolicyAttachmentRequest
    ...
    public static class Builder
        ...
        public GetSteeringPolicyAttachmentRequest build() {
            GetSteeringPolicyAttachmentRequest request = buildWithoutInvocationCallback();
