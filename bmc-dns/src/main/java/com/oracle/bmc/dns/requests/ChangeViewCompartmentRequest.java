...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/dns/ChangeViewCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeViewCompartmentRequest.
 */
...
public class ChangeViewCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeViewCompartmentRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new ChangeViewCompartmentRequest(viewId, changeViewCompartmentDetails, ifMatch, opcRetryToken, opcRequestId, scope);
        }
    }
