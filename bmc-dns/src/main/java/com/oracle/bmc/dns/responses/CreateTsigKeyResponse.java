...
public class CreateTsigKeyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateTsigKeyResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTsigKeyResponse)) {
            return false;
        }

        CreateTsigKeyResponse other = (CreateTsigKeyResponse) o;
