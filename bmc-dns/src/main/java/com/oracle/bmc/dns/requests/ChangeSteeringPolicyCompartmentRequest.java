...
public class ChangeSteeringPolicyCompartmentRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeSteeringPolicyCompartmentRequest as configured by this
         * builder
         *
        ...
        public ChangeSteeringPolicyCompartmentRequest buildWithoutInvocationCallback() {
            ...
            request.scope = scope;
            return request;
            // new ChangeSteeringPolicyCompartmentRequest(steeringPolicyId,
            // changeSteeringPolicyCompartmentDetails, ifMatch, opcRetryToken, opcRequestId, scope);
        }
    }
