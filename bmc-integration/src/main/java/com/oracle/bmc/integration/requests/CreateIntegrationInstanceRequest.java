...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/integration/CreateIntegrationInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIntegrationInstanceRequest.
 */
...
public class CreateIntegrationInstanceRequest
    ...
    public static class Builder
        ...
        public Builder createIntegrationInstanceDetails(
                com.oracle.bmc.integration.model.CreateIntegrationInstanceDetails
                        createIntegrationInstanceDetails) {
            this.createIntegrationInstanceDetails = createIntegrationInstanceDetails;
            return this;
        }
         ...
         * @return instance of CreateIntegrationInstanceRequest
         */
        public CreateIntegrationInstanceRequest buildWithoutInvocationCallback() {
            CreateIntegrationInstanceRequest request = new CreateIntegrationInstanceRequest();
            request.createIntegrationInstanceDetails = createIntegrationInstanceDetails;
    ...
    public String toString() {
        ...
        sb.append(",createIntegrationInstanceDetails=")
                .append(String.valueOf(this.createIntegrationInstanceDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIntegrationInstanceRequest)) {
            return false;
        }

        CreateIntegrationInstanceRequest other = (CreateIntegrationInstanceRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.createIntegrationInstanceDetails,
                        other.createIntegrationInstanceDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createIntegrationInstanceDetails == null
                                ? 43
                                : this.createIntegrationInstanceDetails.hashCode());
        result =
                (result * PRIME)
