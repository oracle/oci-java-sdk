...
public class ListIntegrationInstancesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private ListIntegrationInstancesResponse(
            ...
            java.util.List<com.oracle.bmc.integration.model.IntegrationInstanceSummary> items) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIntegrationInstancesResponse)) {
            return false;
        }

        ListIntegrationInstancesResponse other = (ListIntegrationInstancesResponse) o;
