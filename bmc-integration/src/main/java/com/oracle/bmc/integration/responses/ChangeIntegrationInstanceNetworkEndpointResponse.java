...
public class ChangeIntegrationInstanceNetworkEndpointResponse
    ...
    private ChangeIntegrationInstanceNetworkEndpointResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public ChangeIntegrationInstanceNetworkEndpointResponse build() {
            return new ChangeIntegrationInstanceNetworkEndpointResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeIntegrationInstanceNetworkEndpointResponse)) {
            return false;
        }

        ChangeIntegrationInstanceNetworkEndpointResponse other =
                (ChangeIntegrationInstanceNetworkEndpointResponse) o;
