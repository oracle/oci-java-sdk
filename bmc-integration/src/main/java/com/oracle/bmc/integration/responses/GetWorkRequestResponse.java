...
public class GetWorkRequestResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /**
     * some decimal number representing the number of seconds the client should wait before polling
     * this endpoint again.
     */
    ...
    private com.oracle.bmc.integration.model.WorkRequest workRequest;
     ...
     * @return the value
     */
    public com.oracle.bmc.integration.model.WorkRequest getWorkRequest() {
        return workRequest;
    }
    ...
    private GetWorkRequestResponse(
            ...
            String opcRequestId,
            Float retryAfter,
            com.oracle.bmc.integration.model.WorkRequest workRequest) {
    ...
    public static class Builder
        ...
        /**
         * some decimal number representing the number of seconds the client should wait before
         ...
         * @return this builder
         */
        public Builder workRequest(com.oracle.bmc.integration.model.WorkRequest workRequest) {
            this.workRequest = workRequest;
            return this;
        }
