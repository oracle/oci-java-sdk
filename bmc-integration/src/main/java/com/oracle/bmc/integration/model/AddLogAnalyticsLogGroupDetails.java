...
/**
 * Input payload to ADD Log Analytics Log Group for given IntegrationInstance. Some actions may not
 * be applicable to specific integration types. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddLogAnalyticsLogGroupDetails.Builder.class)
...
public final class AddLogAnalyticsLogGroupDetails
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddLogAnalyticsLogGroupDetails)) {
            return false;
        }
