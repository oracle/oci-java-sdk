...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/integration/RemoveLogAnalyticsLogGroupExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use RemoveLogAnalyticsLogGroupRequest.
 */
...
public class RemoveLogAnalyticsLogGroupRequest
    ...
    public static class Builder
         ...
         *
         * @return instance of RemoveLogAnalyticsLogGroupRequest
         */
        public RemoveLogAnalyticsLogGroupRequest build() {
            RemoveLogAnalyticsLogGroupRequest request = buildWithoutInvocationCallback();
        ...
        public RemoveLogAnalyticsLogGroupRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new RemoveLogAnalyticsLogGroupRequest(integrationInstanceId, removeLogAnalyticsLogGroupDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RemoveLogAnalyticsLogGroupRequest)) {
            return false;
        }
