...
public class UpdateIntegrationInstanceResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private UpdateIntegrationInstanceResponse(
    ...
    public static class Builder {
         ...
         */
        public UpdateIntegrationInstanceResponse build() {
            return new UpdateIntegrationInstanceResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIntegrationInstanceResponse)) {
            return false;
        }

        UpdateIntegrationInstanceResponse other = (UpdateIntegrationInstanceResponse) o;
