...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/integration/StopIntegrationInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StopIntegrationInstanceRequest.
 */
...
public class StopIntegrationInstanceRequest
    ...
    public static class Builder
         ...
         * @return instance of StopIntegrationInstanceRequest
         */
        public StopIntegrationInstanceRequest buildWithoutInvocationCallback() {
            StopIntegrationInstanceRequest request = new StopIntegrationInstanceRequest();
            request.integrationInstanceId = integrationInstanceId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new StopIntegrationInstanceRequest(integrationInstanceId, ifMatch, opcRequestId, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopIntegrationInstanceRequest)) {
            return false;
        }

        StopIntegrationInstanceRequest other = (StopIntegrationInstanceRequest) o;
