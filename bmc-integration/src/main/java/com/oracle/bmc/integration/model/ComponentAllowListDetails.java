...
/**
 * A collection of AllowListedIps and AllowListedVcns for a specific OIC component: global, RT, or
 * DT <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ComponentAllowListDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ComponentAllowListDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"allowlistedHttpIps", "allowlistedHttpVcns"})
    public ComponentAllowListDetails(
    ...
    public static class Builder {
        ...
        public ComponentAllowListDetails build() {
            ComponentAllowListDetails model =
                    new ComponentAllowListDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ComponentAllowListDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ComponentAllowListDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComponentAllowListDetails)) {
            return false;
        }

        ComponentAllowListDetails other = (ComponentAllowListDetails) o;
