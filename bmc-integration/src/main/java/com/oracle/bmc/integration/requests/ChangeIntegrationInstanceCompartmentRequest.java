...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/integration/ChangeIntegrationInstanceCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeIntegrationInstanceCompartmentRequest.
 */
...
public class ChangeIntegrationInstanceCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeIntegrationInstanceCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeIntegrationInstanceCompartmentRequest(integrationInstanceId, changeIntegrationInstanceCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
