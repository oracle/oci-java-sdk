...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/nosql/ListIndexesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListIndexesRequest.
 */
...
public class ListIndexesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListIndexesRequest build() {
            ListIndexesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListIndexesRequest
         */
        public ListIndexesRequest buildWithoutInvocationCallback() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListIndexesRequest)) {
            return false;
        }

        ListIndexesRequest other = (ListIndexesRequest) o;
