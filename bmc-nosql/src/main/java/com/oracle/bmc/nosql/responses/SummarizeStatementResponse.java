...
public class SummarizeStatementResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public String toString() {
        ...
        sb.append(",statementSummary=").append(String.valueOf(statementSummary));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SummarizeStatementResponse)) {
            return false;
        }

        SummarizeStatementResponse other = (SummarizeStatementResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.statementSummary, other.statementSummary);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.statementSummary == null ? 43 : this.statementSummary.hashCode());
        return result;
    }
}
