...
public class DeleteIndexResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteIndexResponse> {
         ...
         */
        @Override
        public Builder copy(DeleteIndexResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteIndexResponse)) {
            return false;
        }
