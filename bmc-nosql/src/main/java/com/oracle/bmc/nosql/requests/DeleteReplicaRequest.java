...
/**
 * <b>Example: </b>Click <a
 * href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/nosql/DeleteReplicaExample.java.html"
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteReplicaRequest.
 */
...
public class DeleteReplicaRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public DeleteReplicaRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteReplicaRequest(tableNameOrId, region, compartmentId, ifMatch,
            // opcRequestId);
        }
    }
