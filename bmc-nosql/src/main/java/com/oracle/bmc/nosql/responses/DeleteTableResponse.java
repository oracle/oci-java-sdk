...
public class DeleteTableResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder {
         ...
         */
        public Builder copy(DeleteTableResponse o) {
        ...
        public DeleteTableResponse build() {
            return new DeleteTableResponse(__httpStatusCode__, opcWorkRequestId, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTableResponse)) {
            return false;
        }

        DeleteTableResponse other = (DeleteTableResponse) o;
