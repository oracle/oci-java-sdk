...
public class ChangeTableCompartmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ChangeTableCompartmentResponse(
    ...
    public static class Builder {
         ...
         */
        public ChangeTableCompartmentResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeTableCompartmentResponse)) {
            return false;
        }

        ChangeTableCompartmentResponse other = (ChangeTableCompartmentResponse) o;
