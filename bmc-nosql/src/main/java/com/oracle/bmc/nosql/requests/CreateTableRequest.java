...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/nosql/CreateTableExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateTableRequest.
 */
...
public class CreateTableRequest
    ...
    public com.oracle.bmc.nosql.model.CreateTableDetails getBody$() {
        return createTableDetails;
    }
    ...
    public static class Builder
        ...
        public Builder createTableDetails(
                com.oracle.bmc.nosql.model.CreateTableDetails createTableDetails) {
            this.createTableDetails = createTableDetails;
            return this;
        }
        ...
        public Builder copy(CreateTableRequest o) {
            createTableDetails(o.getCreateTableDetails());
        ...
        public CreateTableRequest build() {
            CreateTableRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.nosql.model.CreateTableDetails body) {
            createTableDetails(body);
            return this;
        }
         ...
         * @return instance of CreateTableRequest
         */
        public CreateTableRequest buildWithoutInvocationCallback() {
            CreateTableRequest request = new CreateTableRequest();
            request.createTableDetails = createTableDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateTableRequest(createTableDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createTableDetails=").append(String.valueOf(this.createTableDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTableRequest)) {
            return false;
        }

        CreateTableRequest other = (CreateTableRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.createTableDetails, other.createTableDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createTableDetails == null
                                ? 43
                                : this.createTableDetails.hashCode());
        result =
                (result * PRIME)
