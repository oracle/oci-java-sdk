...
public class NosqlClient implements Nosql {
    ...
    public CreateReplicaResponse createReplica(CreateReplicaRequest request) {
        LOG.trace("Called createReplica");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, CreateReplicaResponse> transformer =
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateReplicaDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
    ...
    public DeleteReplicaResponse deleteReplica(DeleteReplicaRequest request) {
        LOG.trace("Called deleteReplica");
        ...
        java.util.function.Function<javax.ws.rs.core.Response, DeleteReplicaResponse> transformer =
    ...
    public UnassignKmsKeyResponse unassignKmsKey(UnassignKmsKeyRequest request) {
        LOG.trace("Called unassignKmsKey");
        final UnassignKmsKeyRequest interceptedRequest =
                UnassignKmsKeyConverter.interceptRequest(request);
        com.oracle.bmc.http.internal.WrappedInvocationBuilder ib =
                UnassignKmsKeyConverter.fromRequest(client, interceptedRequest);
        ...
        java.util.function.Function<javax.ws.rs.core.Response, UnassignKmsKeyResponse> transformer =
                UnassignKmsKeyConverter.fromResponse(java.util.Optional.of(serviceDetails));
        return retrier.execute(
                interceptedRequest,
                retryRequest -> {
                    final com.oracle.bmc.retrier.TokenRefreshRetrier tokenRefreshRetrier =
