...
public class GetConfigurationResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private com.oracle.bmc.nosql.model.Configuration configuration;
     ...
     * @return the value
     */
    public com.oracle.bmc.nosql.model.Configuration getConfiguration() {
    ...
    private GetConfigurationResponse(
            ...
            String etag,
            String opcRequestId,
            com.oracle.bmc.nosql.model.Configuration configuration) {
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder configuration(com.oracle.bmc.nosql.model.Configuration configuration) {
            this.configuration = configuration;
            return this;
        }
