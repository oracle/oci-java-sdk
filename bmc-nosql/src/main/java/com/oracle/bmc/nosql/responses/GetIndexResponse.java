...
public class GetIndexResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetIndexResponse> {
        ...
        public GetIndexResponse build() {
            return new GetIndexResponse(__httpStatusCode__, headers, etag, opcRequestId, index);
        }
    }
