...
public class QueryResultCollection {
    ...
    public static class Builder {
        ...
        public QueryResultCollection build() {
            QueryResultCollection __instance__ = new QueryResultCollection(items, usage);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(QueryResultCollection o) {
            Builder copiedBuilder = items(o.getItems()).usage(o.getUsage());
