...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/nosql/CreateIndexExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateIndexRequest.
 */
...
public class CreateIndexRequest
    ...
    public static class Builder
        ...
        public Builder createIndexDetails(
                com.oracle.bmc.nosql.model.CreateIndexDetails createIndexDetails) {
        ...
        public CreateIndexRequest buildWithoutInvocationCallback() {
            ...
            request.createIndexDetails = createIndexDetails;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            return request;
            // new CreateIndexRequest(tableNameOrId, createIndexDetails, opcRetryToken, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",createIndexDetails=").append(String.valueOf(this.createIndexDetails));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.createIndexDetails, other.createIndexDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.createIndexDetails == null
                                ? 43
                                : this.createIndexDetails.hashCode());
        result =
                (result * PRIME)
