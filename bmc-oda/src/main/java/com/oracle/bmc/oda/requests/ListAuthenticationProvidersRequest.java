...
public class ListAuthenticationProvidersRequest
    ...
    /**
     * List only the information for Authentication Providers with this name. Authentication
     * Provider names are unique and may not change.
     *
     * <p>Example: {@code MyProvider}
     */
    private String name;
    ...
    public static class Builder
        ...
        public ListAuthenticationProvidersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAuthenticationProvidersRequest(odaInstanceId, id, identityProvider, name,
