...
public class ListSkillParametersResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code SkillParameterCollection} instance. */
     ...
     * @return the value
     */
    public com.oracle.bmc.oda.model.SkillParameterCollection getSkillParameterCollection() {
        return skillParameterCollection;
    }
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListSkillParametersResponse> {
         ...
         * The returned {@code SkillParameterCollection} instance.
         *
         * @param skillParameterCollection the value to set
         * @return this builder
         */
        public Builder skillParameterCollection(
                com.oracle.bmc.oda.model.SkillParameterCollection skillParameterCollection) {
            this.skillParameterCollection = skillParameterCollection;
            return this;
        }
    ...
    public String toString() {
        ...
        sb.append(",skillParameterCollection=").append(String.valueOf(skillParameterCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListSkillParametersResponse)) {
            return false;
        }

        ListSkillParametersResponse other = (ListSkillParametersResponse) o;
        return super.equals(o)
                && java.util.Objects.equals(this.opcRequestId, other.opcRequestId)
                && java.util.Objects.equals(this.opcNextPage, other.opcNextPage)
                && java.util.Objects.equals(this.opcTotalItems, other.opcTotalItems)
                && java.util.Objects.equals(
                        this.skillParameterCollection, other.skillParameterCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.skillParameterCollection == null
                                ? 43
                                : this.skillParameterCollection.hashCode());
        return result;
    }
}
