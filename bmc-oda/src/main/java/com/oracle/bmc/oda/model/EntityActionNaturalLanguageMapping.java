...
/**
 * Natural language mapping of an entity action. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityActionNaturalLanguageMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EntityActionNaturalLanguageMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"languages"})
    public EntityActionNaturalLanguageMapping(java.util.List<LanguageMapping> languages) {
        super();
    ...
    public static class Builder {
        ...
        public EntityActionNaturalLanguageMapping build() {
            EntityActionNaturalLanguageMapping model =
                    new EntityActionNaturalLanguageMapping(this.languages);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityActionNaturalLanguageMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityActionNaturalLanguageMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityActionNaturalLanguageMapping)) {
            return false;
        }

        EntityActionNaturalLanguageMapping other = (EntityActionNaturalLanguageMapping) o;
