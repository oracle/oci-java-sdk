...
public final class ChannelCollection {
    ...
    public ChannelCollection(java.util.List<ChannelSummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public ChannelCollection build() {
            ChannelCollection __instance__ = new ChannelCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChannelCollection o) {
