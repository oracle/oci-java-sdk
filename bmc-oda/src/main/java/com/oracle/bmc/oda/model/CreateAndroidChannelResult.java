...
public class CreateAndroidChannelResult extends CreateChannelResult {
    ...
    public static class Builder {
        ...
        public CreateAndroidChannelResult build() {
            CreateAndroidChannelResult __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAndroidChannelResult o) {
