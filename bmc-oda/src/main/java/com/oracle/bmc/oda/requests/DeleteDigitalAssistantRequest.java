...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/oda/DeleteDigitalAssistantExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDigitalAssistantRequest.
 */
...
public class DeleteDigitalAssistantRequest
    ...
    public static class Builder
         ...
         * @return instance of DeleteDigitalAssistantRequest
         */
        public DeleteDigitalAssistantRequest buildWithoutInvocationCallback() {
            DeleteDigitalAssistantRequest request = new DeleteDigitalAssistantRequest();
            request.odaInstanceId = odaInstanceId;
            request.digitalAssistantId = digitalAssistantId;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDigitalAssistantRequest(odaInstanceId, digitalAssistantId, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDigitalAssistantRequest)) {
            return false;
        }

        DeleteDigitalAssistantRequest other = (DeleteDigitalAssistantRequest) o;
