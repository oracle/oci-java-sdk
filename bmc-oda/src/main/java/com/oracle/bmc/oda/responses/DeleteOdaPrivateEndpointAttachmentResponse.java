...
public class DeleteOdaPrivateEndpointAttachmentResponse
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteOdaPrivateEndpointAttachmentResponse)) {
            return false;
        }

        DeleteOdaPrivateEndpointAttachmentResponse other =
                (DeleteOdaPrivateEndpointAttachmentResponse) o;
