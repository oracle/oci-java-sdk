...
public class GetOdaPrivateEndpointAttachmentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetOdaPrivateEndpointAttachmentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetOdaPrivateEndpointAttachmentResponse o) {
         ...
         */
        @Override
        public GetOdaPrivateEndpointAttachmentResponse build() {
            return new GetOdaPrivateEndpointAttachmentResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, odaPrivateEndpointAttachment);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetOdaPrivateEndpointAttachmentResponse)) {
            return false;
        }

        GetOdaPrivateEndpointAttachmentResponse other = (GetOdaPrivateEndpointAttachmentResponse) o;
