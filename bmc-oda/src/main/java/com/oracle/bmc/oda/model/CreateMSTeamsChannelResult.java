...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateMSTeamsChannelResult.Builder.class)
...
public final class CreateMSTeamsChannelResult extends CreateChannelResult {
    ...
    @Deprecated
    public CreateMSTeamsChannelResult(
            String id,
            String name,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateMSTeamsChannelResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateMSTeamsChannelResult)) {
            return false;
        }

        CreateMSTeamsChannelResult other = (CreateMSTeamsChannelResult) o;
