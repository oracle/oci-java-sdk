...
public class PublishSkillResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<PublishSkillResponse> {
         ...
         */
        @Override
        public Builder copy(PublishSkillResponse o) {
         ...
         */
        @Override
        public PublishSkillResponse build() {
            return new PublishSkillResponse(__httpStatusCode__, headers, etag, opcRequestId, skill);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublishSkillResponse)) {
            return false;
        }

        PublishSkillResponse other = (PublishSkillResponse) o;
