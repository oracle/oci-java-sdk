...
public class StartChannelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    @java.beans.ConstructorProperties({"__httpStatusCode__", "etag", "opcRequestId", "channel"})
    ...
    public static class Builder {
         ...
         */
        public Builder copy(StartChannelResponse o) {
        ...
        public StartChannelResponse build() {
            return new StartChannelResponse(__httpStatusCode__, etag, opcRequestId, channel);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartChannelResponse)) {
            return false;
        }

        StartChannelResponse other = (StartChannelResponse) o;
