...
/**
 * Properties to import a Bot resource from Object Storage. <br>
...
public final class ImportBotDetails
    ...
    public static class Builder {
        ...
        public Builder source(StorageLocation source) {
            this.source = source;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("source")
    private final StorageLocation source;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImportBotDetails)) {
            return false;
        }
