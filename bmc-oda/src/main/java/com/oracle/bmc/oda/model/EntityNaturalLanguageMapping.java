...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityNaturalLanguageMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EntityNaturalLanguageMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"languages"})
    public EntityNaturalLanguageMapping(java.util.List<LanguageMapping> languages) {
        super();
    ...
    public static class Builder {
        ...
        public EntityNaturalLanguageMapping build() {
            EntityNaturalLanguageMapping model = new EntityNaturalLanguageMapping(this.languages);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityNaturalLanguageMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityNaturalLanguageMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityNaturalLanguageMapping)) {
            return false;
        }

        EntityNaturalLanguageMapping other = (EntityNaturalLanguageMapping) o;
