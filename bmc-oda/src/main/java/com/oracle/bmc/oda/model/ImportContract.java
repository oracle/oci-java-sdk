...
/**
 * The contract guiding the import experience for the consumer and behavior of the resource
 * providers for all resource types in a package. <br>
...
public final class ImportContract
    ...
    public static class Builder {
        ...
        public ImportContract build() {
            ImportContract model = new ImportContract(this.importContract);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ImportContract model) {
    ...
    /**
     * A list of resource type specific import contracts, one for each resource type listed in the
     * package definition.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("importContract")
