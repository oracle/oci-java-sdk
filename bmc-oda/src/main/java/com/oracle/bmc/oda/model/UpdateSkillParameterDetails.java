...
public final class UpdateSkillParameterDetails {
    ...
    public static class Builder {
        ...
        public UpdateSkillParameterDetails build() {
            UpdateSkillParameterDetails __instance__ =
                    new UpdateSkillParameterDetails(displayName, description, value);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateSkillParameterDetails o) {
