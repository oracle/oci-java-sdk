...
public class CreateImportedPackageResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateImportedPackageResponse> {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateImportedPackageResponse)) {
            return false;
        }

        CreateImportedPackageResponse other = (CreateImportedPackageResponse) o;
