...
public class StopChannelResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<StopChannelResponse> {
         ...
         */
        @Override
        public Builder copy(StopChannelResponse o) {
        ...
        public StopChannelResponse build() {
            return new StopChannelResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopChannelResponse)) {
            return false;
        }

        StopChannelResponse other = (StopChannelResponse) o;
