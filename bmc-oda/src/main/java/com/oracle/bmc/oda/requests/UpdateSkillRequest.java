 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSkillRequest.
 */
...
public class UpdateSkillRequest
    ...
    public static class Builder
        ...
        public UpdateSkillRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateSkillRequest(odaInstanceId, skillId, updateSkillDetails, ifMatch,
            // opcRequestId);
        }
    }
