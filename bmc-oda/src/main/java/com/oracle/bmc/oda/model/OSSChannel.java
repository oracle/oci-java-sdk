...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = OSSChannel.Builder.class)
...
public final class OSSChannel extends Channel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(OSSChannel o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OSSChannel)) {
            return false;
        }

        OSSChannel other = (OSSChannel) o;
