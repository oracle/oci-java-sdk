...
/**
 * Natural language mapping of an entity action argument. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityActionArgumentNaturalLanguageMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EntityActionArgumentNaturalLanguageMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"languages"})
    public EntityActionArgumentNaturalLanguageMapping(java.util.List<LanguageMapping> languages) {
        super();
    ...
    public static class Builder {
        ...
        public EntityActionArgumentNaturalLanguageMapping build() {
            EntityActionArgumentNaturalLanguageMapping model =
                    new EntityActionArgumentNaturalLanguageMapping(this.languages);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityActionArgumentNaturalLanguageMapping model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityActionArgumentNaturalLanguageMapping)) {
            return false;
        }

        EntityActionArgumentNaturalLanguageMapping other =
                (EntityActionArgumentNaturalLanguageMapping) o;
