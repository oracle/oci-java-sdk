...
/**
 * Properties to update an iOS channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateIosChannelDetails.Builder.class)
...
public final class UpdateIosChannelDetails extends UpdateChannelDetails {
    ...
    public static class Builder {
        ...
        public UpdateIosChannelDetails build() {
            UpdateIosChannelDetails model =
                    new UpdateIosChannelDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateIosChannelDetails model) {
    ...
    @Deprecated
    public UpdateIosChannelDetails(
            String name,
            String description,
            Long sessionExpiryDurationInMilliseconds,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateIosChannelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIosChannelDetails)) {
            return false;
        }

        UpdateIosChannelDetails other = (UpdateIosChannelDetails) o;
