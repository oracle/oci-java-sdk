...
/**
 * Properties required to create a Twilio channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateTwilioChannelDetails.Builder.class)
...
public final class CreateTwilioChannelDetails extends CreateChannelDetails {
    ...
    public static class Builder {
        ...
        public CreateTwilioChannelDetails build() {
            CreateTwilioChannelDetails model =
                    new CreateTwilioChannelDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateTwilioChannelDetails model) {
    ...
    @Deprecated
    public CreateTwilioChannelDetails(
            String name,
            String description,
            Long sessionExpiryDurationInMilliseconds,
    ...
    public CreateTwilioChannelDetails(
            ...
            @com.fasterxml.jackson.annotation.JsonProperty("definedTags")
                    java.util.Map<String, java.util.Map<String, Object>> definedTags,
            @com.fasterxml.jackson.annotation.JsonProperty("accountSID") String accountSID,
            @com.fasterxml.jackson.annotation.JsonProperty("phoneNumber") String phoneNumber,
            @com.fasterxml.jackson.annotation.JsonProperty("authToken") char[] authToken,
            @com.fasterxml.jackson.annotation.JsonProperty("isMmsEnabled") Boolean isMmsEnabled,
            @com.fasterxml.jackson.annotation.JsonProperty("originalConnectorsUrl")
                    String originalConnectorsUrl,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateTwilioChannelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateTwilioChannelDetails)) {
            return false;
        }

        CreateTwilioChannelDetails other = (CreateTwilioChannelDetails) o;
