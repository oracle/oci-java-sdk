...
public class ListWorkRequestLogsResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** A list of {@code com.oracle.bmc.oda.model.WorkRequestLogEntry} instances. */
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.oda.model.WorkRequestLogEntry> getItems() {
        return items;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.oda.model.WorkRequestLogEntry> items) {
            this.items = items;
            return this;
        }
