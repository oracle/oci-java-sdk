...
/**
 * Properties to update an MS Teams channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateMSTeamsChannelDetails.Builder.class)
...
public final class UpdateMSTeamsChannelDetails extends UpdateChannelDetails {
    ...
    public static class Builder {
        ...
        public UpdateMSTeamsChannelDetails build() {
            UpdateMSTeamsChannelDetails model =
                    new UpdateMSTeamsChannelDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateMSTeamsChannelDetails model) {
    ...
    @Deprecated
    public UpdateMSTeamsChannelDetails(
            String name,
            String description,
            Long sessionExpiryDurationInMilliseconds,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateMSTeamsChannelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateMSTeamsChannelDetails)) {
            return false;
        }

        UpdateMSTeamsChannelDetails other = (UpdateMSTeamsChannelDetails) o;
