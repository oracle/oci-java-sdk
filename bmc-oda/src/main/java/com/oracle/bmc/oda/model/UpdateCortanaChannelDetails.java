...
public class UpdateCortanaChannelDetails extends UpdateChannelDetails {
    ...
    public static class Builder {
        ...
        public UpdateCortanaChannelDetails build() {
            UpdateCortanaChannelDetails __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateCortanaChannelDetails o) {
