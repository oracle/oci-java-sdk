...
public class GetAuthenticationProviderResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetAuthenticationProviderResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(GetAuthenticationProviderResponse o) {
         ...
         */
        public GetAuthenticationProviderResponse build() {
            return new GetAuthenticationProviderResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAuthenticationProviderResponse)) {
            return false;
        }

        GetAuthenticationProviderResponse other = (GetAuthenticationProviderResponse) o;
