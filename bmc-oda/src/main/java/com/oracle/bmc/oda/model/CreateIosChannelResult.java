...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateIosChannelResult.Builder.class
)
...
public final class CreateIosChannelResult extends CreateChannelResult {
    ...
    public static class Builder {
        ...
        public CreateIosChannelResult build() {
            CreateIosChannelResult __instance__ =
                    new CreateIosChannelResult(
                            id,
                            name,
                            description,
                            category,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateIosChannelResult o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIosChannelResult)) {
            return false;
        }

        CreateIosChannelResult other = (CreateIosChannelResult) o;
