...
public class PublishDigitalAssistantResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private PublishDigitalAssistantResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(PublishDigitalAssistantResponse o) {
         ...
         */
        public PublishDigitalAssistantResponse build() {
            return new PublishDigitalAssistantResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PublishDigitalAssistantResponse)) {
            return false;
        }

        PublishDigitalAssistantResponse other = (PublishDigitalAssistantResponse) o;
