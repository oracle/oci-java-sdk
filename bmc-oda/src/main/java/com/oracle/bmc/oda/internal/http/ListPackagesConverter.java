...
public class ListPackagesConverter {
    ...
    public static com.oracle.bmc.oda.requests.ListPackagesRequest interceptRequest(
            com.oracle.bmc.oda.requests.ListPackagesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20190506").path("packages");

        if (request.getOdaInstanceId() != null) {
            target =
                    target.queryParam(
                            "odaInstanceId",
    ...
    public static java.util.function.Function<
                    javax.ws.rs.core.Response, com.oracle.bmc.oda.responses.ListPackagesResponse>
            fromResponse() {
    ...
    public static java.util.function.Function<
        ...
        final java.util.function.Function<
                        ...
                        com.oracle.bmc.oda.responses.ListPackagesResponse>
                transformer =
                        new java.util.function.Function<
                                javax.ws.rs.core.Response,
                                com.oracle.bmc.oda.responses.ListPackagesResponse>() {
                            @Override
                            public com.oracle.bmc.oda.responses.ListPackagesResponse apply(
                                    javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.oda.responses.ListPackagesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.oda.responses.ListPackagesResponse responseWrapper =
                                        builder.build();
