...
/**
 * Properties required to create a Cortana channel. <br>
...
public final class CreateCortanaChannelDetails extends CreateChannelDetails {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCortanaChannelDetails)) {
            return false;
        }

        CreateCortanaChannelDetails other = (CreateCortanaChannelDetails) o;
