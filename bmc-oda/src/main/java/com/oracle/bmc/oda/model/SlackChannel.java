...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SlackChannel.Builder.class)
...
public final class SlackChannel extends Channel {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SlackChannel o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SlackChannel)) {
            return false;
        }

        SlackChannel other = (SlackChannel) o;
