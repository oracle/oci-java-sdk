...
public class OdapackageClient implements Odapackage {
    ...
    public CreateImportedPackageResponse createImportedPackage(
        ...
        LOG.trace("Called createImportedPackage");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.post(
                                                ib,
                                                retriedRequest.getCreateImportedPackageDetails(),
                                                retriedRequest);
    ...
    public DeleteImportedPackageResponse deleteImportedPackage(
        ...
        LOG.trace("Called deleteImportedPackage");
    ...
    public GetImportedPackageResponse getImportedPackage(GetImportedPackageRequest request) {
        LOG.trace("Called getImportedPackage");
    ...
    public ListImportedPackagesResponse listImportedPackages(ListImportedPackagesRequest request) {
        LOG.trace("Called listImportedPackages");
    ...
    public UpdateImportedPackageResponse updateImportedPackage(
        ...
        LOG.trace("Called updateImportedPackage");
                    ...
                    return tokenRefreshRetrier.execute(
                            ...
                            retriedRequest -> {
                                javax.ws.rs.core.Response response =
                                        client.put(
                                                ib,
                                                retriedRequest.getUpdateImportedPackageDetails(),
                                                retriedRequest);
                                return transformer.apply(response);
                            });
                });
