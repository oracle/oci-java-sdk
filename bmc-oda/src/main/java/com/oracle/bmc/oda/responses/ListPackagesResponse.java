...
public class ListPackagesResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
     ...
     * @return the value
     */
    public java.util.List<com.oracle.bmc.oda.model.PackageSummary> getItems() {
        return items;
    }
    ...
    private ListPackagesResponse(
            ...
            java.util.List<com.oracle.bmc.oda.model.PackageSummary> items) {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<ListPackagesResponse> {
         ...
         * @return this builder
         */
        public Builder items(java.util.List<com.oracle.bmc.oda.model.PackageSummary> items) {
            this.items = items;
            return this;
        }
         ...
         */
        @Override
        public Builder copy(ListPackagesResponse o) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListPackagesResponse)) {
            return false;
        }

        ListPackagesResponse other = (ListPackagesResponse) o;
