...
/**
 * The configuration for a Cortana channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateCortanaChannelResult.Builder.class)
...
public final class CreateCortanaChannelResult extends CreateChannelResult {
    ...
    public static class Builder {
        ...
        public CreateCortanaChannelResult build() {
            CreateCortanaChannelResult model =
                    new CreateCortanaChannelResult(
                            this.id,
                            this.name,
                            this.description,
                            this.category,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCortanaChannelResult model) {
    ...
    @Deprecated
    public CreateCortanaChannelResult(
            String id,
            String name,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCortanaChannelResult(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCortanaChannelResult)) {
            return false;
        }

        CreateCortanaChannelResult other = (CreateCortanaChannelResult) o;
