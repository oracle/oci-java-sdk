...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/oda/ListDigitalAssistantParametersExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDigitalAssistantParametersRequest.
 */
...
public class ListDigitalAssistantParametersRequest
    ...
    public static class Builder
        ...
        public ListDigitalAssistantParametersRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListDigitalAssistantParametersRequest(odaInstanceId, digitalAssistantId, name, lifecycleState, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
