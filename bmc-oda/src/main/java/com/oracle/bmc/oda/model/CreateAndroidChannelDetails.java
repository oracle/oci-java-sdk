...
/**
 * Properties required to create an Android channel. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAndroidChannelDetails.Builder.class)
...
public final class CreateAndroidChannelDetails extends CreateChannelDetails {
    ...
    public static class Builder {
        ...
        public CreateAndroidChannelDetails build() {
            CreateAndroidChannelDetails model =
                    new CreateAndroidChannelDetails(
                            this.name,
                            this.description,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAndroidChannelDetails model) {
    ...
    @Deprecated
    public CreateAndroidChannelDetails(
            String name,
            String description,
            Long sessionExpiryDurationInMilliseconds,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAndroidChannelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAndroidChannelDetails)) {
            return false;
        }

        CreateAndroidChannelDetails other = (CreateAndroidChannelDetails) o;
