...
public class GetSkillResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetSkillResponse> {
        ...
        public GetSkillResponse build() {
            return new GetSkillResponse(__httpStatusCode__, headers, etag, opcRequestId, skill);
        }
    }
