...
/**
 * Metadata for a composite entity. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CompositeEntity.Builder.class)
...
public final class CompositeEntity extends Entity {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompositeEntity model) {
    ...
    public boolean equals(Object o) {
        ...
        CompositeEntity other = (CompositeEntity) o;
