...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/oda/UpdateOdaPrivateEndpointExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateOdaPrivateEndpointRequest.
 */
...
public class UpdateOdaPrivateEndpointRequest
    ...
    public static class Builder
        ...
        public UpdateOdaPrivateEndpointRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateOdaPrivateEndpointRequest(odaPrivateEndpointId, updateOdaPrivateEndpointDetails, ifMatch, opcRequestId);
        }
    }
