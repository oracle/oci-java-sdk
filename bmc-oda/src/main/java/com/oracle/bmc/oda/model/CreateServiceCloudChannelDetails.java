...
/**
 * Properties required to create an Service Cloud channel. <br>
...
public final class CreateServiceCloudChannelDetails extends CreateChannelDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateServiceCloudChannelDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceCloudChannelDetails)) {
            return false;
        }

        CreateServiceCloudChannelDetails other = (CreateServiceCloudChannelDetails) o;
