...
/**
 * Natural language mapping of an entity attribute <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = EntityAttributeNaturalLanguageMapping.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class EntityAttributeNaturalLanguageMapping
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"languages"})
    public EntityAttributeNaturalLanguageMapping(java.util.List<LanguageMapping> languages) {
        super();
    ...
    public static class Builder {
        ...
        public EntityAttributeNaturalLanguageMapping build() {
            EntityAttributeNaturalLanguageMapping model =
                    new EntityAttributeNaturalLanguageMapping(this.languages);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(EntityAttributeNaturalLanguageMapping model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("EntityAttributeNaturalLanguageMapping(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntityAttributeNaturalLanguageMapping)) {
            return false;
        }

        EntityAttributeNaturalLanguageMapping other = (EntityAttributeNaturalLanguageMapping) o;
