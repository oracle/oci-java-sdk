...
/**
 * Properties that are required to create a new Digital Assistant by cloning an existing Digital
 * Assistant. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CloneDigitalAssistantDetails.Builder.class)
...
public final class CloneDigitalAssistantDetails extends CreateDigitalAssistantDetails {
    ...
    @Deprecated
    public CloneDigitalAssistantDetails(
            String category,
            String description,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CloneDigitalAssistantDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneDigitalAssistantDetails)) {
            return false;
        }

        CloneDigitalAssistantDetails other = (CloneDigitalAssistantDetails) o;
