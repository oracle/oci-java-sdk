...
public class CreateWebhookChannelResult extends CreateChannelResult {
    ...
    public static class Builder {
        ...
        public CreateWebhookChannelResult build() {
            CreateWebhookChannelResult __instance__ =
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateWebhookChannelResult o) {
