...
public class GetTranslatorResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetTranslatorResponse> {
         ...
         */
        @Override
        public Builder copy(GetTranslatorResponse o) {
        ...
        public GetTranslatorResponse build() {
            return new GetTranslatorResponse(
