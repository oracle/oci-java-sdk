...
public class ListAuthenticationProvidersConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListAuthenticationProvidersConverter.class);

    public static com.oracle.bmc.oda.requests.ListAuthenticationProvidersRequest interceptRequest(
            com.oracle.bmc.oda.requests.ListAuthenticationProvidersRequest request) {
        ...
        if (request.getIdentityProvider() != null) {
            target =
                    target.queryParam(
                            "identityProvider",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getIdentityProvider().getValue()));
        }
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.oda.responses.ListAuthenticationProvidersResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.oda.responses.ListAuthenticationProvidersResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
