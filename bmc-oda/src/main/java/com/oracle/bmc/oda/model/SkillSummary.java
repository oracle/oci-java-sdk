...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = SkillSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class SkillSummary extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SkillSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SkillSummary)) {
            return false;
        }

        SkillSummary other = (SkillSummary) o;
