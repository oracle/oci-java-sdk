...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/StopDistributedAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StopDistributedAutonomousDatabaseRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class StopDistributedAutonomousDatabaseRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    StopDistributedAutonomousDatabaseRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(StopDistributedAutonomousDatabaseRequest o) {
        ...
        /**
         * Build the instance of StopDistributedAutonomousDatabaseRequest as configured by this builder
         *
         ...
         *
         * @return instance of StopDistributedAutonomousDatabaseRequest
         */
        public StopDistributedAutonomousDatabaseRequest build() {
            StopDistributedAutonomousDatabaseRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StopDistributedAutonomousDatabaseRequest
         */
        public StopDistributedAutonomousDatabaseRequest buildWithoutInvocationCallback() {
            StopDistributedAutonomousDatabaseRequest request =
                    new StopDistributedAutonomousDatabaseRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new StopDistributedAutonomousDatabaseRequest(distributedAutonomousDatabaseId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDistributedAutonomousDatabaseRequest)) {
            return false;
        }

        StopDistributedAutonomousDatabaseRequest other =
                (StopDistributedAutonomousDatabaseRequest) o;
