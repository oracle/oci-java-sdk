...
/**
 * One move RU invocation record for the Globally distributed autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDatabaseRuChangeLogSummary.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDatabaseRuChangeLogSummary
    ...
    public DistributedAutonomousDatabaseRuChangeLogSummary(
    ...
    public static class Builder {
        ...
        public DistributedAutonomousDatabaseRuChangeLogSummary build() {
            DistributedAutonomousDatabaseRuChangeLogSummary model =
                    new DistributedAutonomousDatabaseRuChangeLogSummary(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseRuChangeLogSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseRuChangeLogSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseRuChangeLogSummary)) {
            return false;
        }

        DistributedAutonomousDatabaseRuChangeLogSummary other =
                (DistributedAutonomousDatabaseRuChangeLogSummary) o;
