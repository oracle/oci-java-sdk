...
public class ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest
    ...
    public com.oracle.bmc.distributeddatabase.model
        ...
        return configureDistributedAutonomousDatabaseAutoResourceManagementDetails;
    }
    /**
    ...
    public static class Builder
        ...
        private com.oracle.bmc.distributeddatabase.model
                        .ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails
                configureDistributedAutonomousDatabaseAutoResourceManagementDetails = null;

        /**
         * The payload for configuring autoResourceManagement for autonomous distributed database.
         * @param configureDistributedAutonomousDatabaseAutoResourceManagementDetails the value to set
         * @return this builder instance
         */
        public Builder configureDistributedAutonomousDatabaseAutoResourceManagementDetails(
                com.oracle.bmc.distributeddatabase.model
                                .ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails
                        configureDistributedAutonomousDatabaseAutoResourceManagementDetails) {
            this.configureDistributedAutonomousDatabaseAutoResourceManagementDetails =
                    configureDistributedAutonomousDatabaseAutoResourceManagementDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest o) {
            distributedAutonomousDatabaseId(o.getDistributedAutonomousDatabaseId());
            configureDistributedAutonomousDatabaseAutoResourceManagementDetails(
                    o.getConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails());
        ...
        /**
         * Build the instance of ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest as configured by this builder
         *
         ...
         *
         * @return instance of ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest
         */
        public ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest build() {
        ...
        public Builder body$(
                com.oracle.bmc.distributeddatabase.model
                                .ConfigureDistributedAutonomousDatabaseAutoResourceManagementDetails
                        body) {
            configureDistributedAutonomousDatabaseAutoResourceManagementDetails(body);
            return this;
        }
         ...
         * @return instance of ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest
         */
        public ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest
                buildWithoutInvocationCallback() {
            ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest request =
                    new ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest();
            ...
            return request;
            // new ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest(distributedAutonomousDatabaseId, configureDistributedAutonomousDatabaseAutoResourceManagementDetails, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest)) {
            return false;
        }

        ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest other =
                (ConfigureDistributedAutonomousDatabaseAutoResourceManagementRequest) o;
