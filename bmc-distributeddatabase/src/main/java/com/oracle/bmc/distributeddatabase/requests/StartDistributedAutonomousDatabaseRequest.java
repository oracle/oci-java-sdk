...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/StartDistributedAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use StartDistributedAutonomousDatabaseRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class StartDistributedAutonomousDatabaseRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    StartDistributedAutonomousDatabaseRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(StartDistributedAutonomousDatabaseRequest o) {
        ...
        /**
         * Build the instance of StartDistributedAutonomousDatabaseRequest as configured by this builder
         *
         ...
         *
         * @return instance of StartDistributedAutonomousDatabaseRequest
         */
        public StartDistributedAutonomousDatabaseRequest build() {
            StartDistributedAutonomousDatabaseRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of StartDistributedAutonomousDatabaseRequest
         */
        public StartDistributedAutonomousDatabaseRequest buildWithoutInvocationCallback() {
            StartDistributedAutonomousDatabaseRequest request =
                    new StartDistributedAutonomousDatabaseRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.opcRetryToken = opcRetryToken;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            return request;
            // new StartDistributedAutonomousDatabaseRequest(distributedAutonomousDatabaseId, opcRetryToken, opcRequestId, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StartDistributedAutonomousDatabaseRequest)) {
            return false;
        }

        StartDistributedAutonomousDatabaseRequest other =
                (StartDistributedAutonomousDatabaseRequest) o;
