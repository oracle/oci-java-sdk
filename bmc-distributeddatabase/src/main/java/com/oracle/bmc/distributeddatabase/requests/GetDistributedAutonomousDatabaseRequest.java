...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/GetDistributedAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDistributedAutonomousDatabaseRequest.
 */
...
public class GetDistributedAutonomousDatabaseRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDistributedAutonomousDatabaseRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDistributedAutonomousDatabaseRequest o) {
        ...
        /**
         * Build the instance of GetDistributedAutonomousDatabaseRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDistributedAutonomousDatabaseRequest
         */
        public GetDistributedAutonomousDatabaseRequest build() {
            GetDistributedAutonomousDatabaseRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetDistributedAutonomousDatabaseRequest
         */
        public GetDistributedAutonomousDatabaseRequest buildWithoutInvocationCallback() {
            GetDistributedAutonomousDatabaseRequest request =
                    new GetDistributedAutonomousDatabaseRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.metadata = metadata;
            request.ifNoneMatch = ifNoneMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDistributedAutonomousDatabaseRequest(distributedAutonomousDatabaseId, metadata, ifNoneMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDistributedAutonomousDatabaseRequest)) {
            return false;
        }

        GetDistributedAutonomousDatabaseRequest other = (GetDistributedAutonomousDatabaseRequest) o;
