...
public class StopDistributedDatabaseResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private StopDistributedDatabaseResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(StopDistributedDatabaseResponse o) {
         ...
         */
        @Override
        public StopDistributedDatabaseResponse build() {
            return new StopDistributedDatabaseResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopDistributedDatabaseResponse)) {
            return false;
        }

        StopDistributedDatabaseResponse other = (StopDistributedDatabaseResponse) o;
