...
/**
 * Details of a distributed database catalog running on ExaDB-D. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseCatalogDatabaseWithExadbXd.Builder.class)
...
public final class DistributedDatabaseCatalogDatabaseWithExadbXd
    ...
    public static class Builder {
        ...
        public DistributedDatabaseCatalogDatabaseWithExadbXd build() {
            DistributedDatabaseCatalogDatabaseWithExadbXd model =
                    new DistributedDatabaseCatalogDatabaseWithExadbXd(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseCatalogDatabaseWithExadbXd model) {
    ...
    @Deprecated
    public DistributedDatabaseCatalogDatabaseWithExadbXd(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseCatalogDatabaseWithExadbXd(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseCatalogDatabaseWithExadbXd)) {
            return false;
        }

        DistributedDatabaseCatalogDatabaseWithExadbXd other =
                (DistributedDatabaseCatalogDatabaseWithExadbXd) o;
