...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/DeleteDistributedAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDistributedAutonomousDatabaseRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class DeleteDistributedAutonomousDatabaseRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDistributedAutonomousDatabaseRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDistributedAutonomousDatabaseRequest o) {
        ...
        /**
         * Build the instance of DeleteDistributedAutonomousDatabaseRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDistributedAutonomousDatabaseRequest
         */
        public DeleteDistributedAutonomousDatabaseRequest build() {
            DeleteDistributedAutonomousDatabaseRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDistributedAutonomousDatabaseRequest
         */
        public DeleteDistributedAutonomousDatabaseRequest buildWithoutInvocationCallback() {
            DeleteDistributedAutonomousDatabaseRequest request =
                    new DeleteDistributedAutonomousDatabaseRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.opcRequestId = opcRequestId;
            request.opcRetryToken = opcRetryToken;
            request.ifMatch = ifMatch;
            return request;
            // new DeleteDistributedAutonomousDatabaseRequest(distributedAutonomousDatabaseId, opcRequestId, opcRetryToken, ifMatch);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDistributedAutonomousDatabaseRequest)) {
            return false;
        }

        DeleteDistributedAutonomousDatabaseRequest other =
                (DeleteDistributedAutonomousDatabaseRequest) o;
