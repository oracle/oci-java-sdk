...
/**
 * Configuration for creating a distributed database shard on a new ExaDB-XS VM cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDistributedDatabaseShardWithExadbXsNewClusterDetails.Builder.class)
...
public final class CreateDistributedDatabaseShardWithExadbXsNewClusterDetails
    ...
    public static class Builder {
        ...
        public CreateDistributedDatabaseShardWithExadbXsNewClusterDetails build() {
            CreateDistributedDatabaseShardWithExadbXsNewClusterDetails model =
                    new CreateDistributedDatabaseShardWithExadbXsNewClusterDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabaseShardWithExadbXsNewClusterDetails model) {
    ...
    @Deprecated
    public CreateDistributedDatabaseShardWithExadbXsNewClusterDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseShardWithExadbXsNewClusterDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseShardWithExadbXsNewClusterDetails)) {
            return false;
        }

        CreateDistributedDatabaseShardWithExadbXsNewClusterDetails other =
                (CreateDistributedDatabaseShardWithExadbXsNewClusterDetails) o;
