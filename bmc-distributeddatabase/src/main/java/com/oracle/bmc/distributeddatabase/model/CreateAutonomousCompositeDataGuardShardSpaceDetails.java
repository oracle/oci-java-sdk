...
/**
 * Details required to create a composite data guard shard space for a Globally distributed
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousCompositeDataGuardShardSpaceDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAutonomousCompositeDataGuardShardSpaceDetails
    ...
    public CreateAutonomousCompositeDataGuardShardSpaceDetails(
            String name,
            Integer chunkCount,
            CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails originalReplica,
            java.util.List<CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails>
                    dataGuardReplicas) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails originalReplica;
        ...
        private java.util.List<CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails>
                dataGuardReplicas;
        ...
        public CreateAutonomousCompositeDataGuardShardSpaceDetails build() {
            CreateAutonomousCompositeDataGuardShardSpaceDetails model =
                    new CreateAutonomousCompositeDataGuardShardSpaceDetails(
                            this.name,
                            this.chunkCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAutonomousCompositeDataGuardShardSpaceDetails model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails originalReplica;
    ...
    /** The details of data guard replica for the shard being created. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails>
            dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails>
            getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousCompositeDataGuardShardSpaceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousCompositeDataGuardShardSpaceDetails)) {
            return false;
        }

        CreateAutonomousCompositeDataGuardShardSpaceDetails other =
                (CreateAutonomousCompositeDataGuardShardSpaceDetails) o;
