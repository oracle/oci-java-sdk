...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ChangeDistributedAutonomousDbBackupConfigDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class ChangeDistributedAutonomousDbBackupConfigDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"dbBackupConfig"})
    public ChangeDistributedAutonomousDbBackupConfigDetails(
    ...
    public static class Builder {
        ...
        public ChangeDistributedAutonomousDbBackupConfigDetails build() {
            ChangeDistributedAutonomousDbBackupConfigDetails model =
                    new ChangeDistributedAutonomousDbBackupConfigDetails(this.dbBackupConfig);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ChangeDistributedAutonomousDbBackupConfigDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDistributedAutonomousDbBackupConfigDetails)) {
            return false;
        }

        ChangeDistributedAutonomousDbBackupConfigDetails other =
                (ChangeDistributedAutonomousDbBackupConfigDetails) o;
