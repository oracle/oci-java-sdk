...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDistributedDatabaseShardDatabaseWithExadbXdDetails.Builder.class)
...
public final class CreateDistributedDatabaseShardDatabaseWithExadbXdDetails
    ...
    public static class Builder {
        ...
        public CreateDistributedDatabaseShardDatabaseWithExadbXdDetails build() {
            CreateDistributedDatabaseShardDatabaseWithExadbXdDetails model =
                    new CreateDistributedDatabaseShardDatabaseWithExadbXdDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabaseShardDatabaseWithExadbXdDetails model) {
    ...
    @Deprecated
    public CreateDistributedDatabaseShardDatabaseWithExadbXdDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseShardDatabaseWithExadbXdDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseShardDatabaseWithExadbXdDetails)) {
            return false;
        }

        CreateDistributedDatabaseShardDatabaseWithExadbXdDetails other =
                (CreateDistributedDatabaseShardDatabaseWithExadbXdDetails) o;
