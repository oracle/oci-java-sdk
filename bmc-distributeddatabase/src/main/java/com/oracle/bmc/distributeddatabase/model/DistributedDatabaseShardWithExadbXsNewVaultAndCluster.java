...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = DistributedDatabaseShardWithExadbXsNewVaultAndCluster.Builder.class
)
...
public final class DistributedDatabaseShardWithExadbXsNewVaultAndCluster
    ...
    public static class Builder {
        ...
        private DistributedDbStorageVault dbStorageVaultDetails;

        public Builder dbStorageVaultDetails(DistributedDbStorageVault dbStorageVaultDetails) {
        ...
        private java.util.List<ShardPeerWithExadbXsNewVaultAndCluster> peerDetails;
        ...
        public Builder peerDetails(
                java.util.List<ShardPeerWithExadbXsNewVaultAndCluster> peerDetails) {
        ...
        public DistributedDatabaseShardWithExadbXsNewVaultAndCluster build() {
            DistributedDatabaseShardWithExadbXsNewVaultAndCluster model =
                    new DistributedDatabaseShardWithExadbXsNewVaultAndCluster(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.dbHomeId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardWithExadbXsNewVaultAndCluster model) {
    ...
    @Deprecated
    public DistributedDatabaseShardWithExadbXsNewVaultAndCluster(
            String name,
            ...
            DistributedDbVmCluster vmClusterDetails,
            java.util.List<ShardPeerWithExadbXsNewVaultAndCluster> peerDetails,
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("dbStorageVaultDetails")
    private final DistributedDbStorageVault dbStorageVaultDetails;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("vmClusterDetails")
    private final DistributedDbVmCluster vmClusterDetails;
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("peerDetails")
    private final java.util.List<ShardPeerWithExadbXsNewVaultAndCluster> peerDetails;

    /**
     * Peer details for the shard.
     * @return the value
     **/
    public java.util.List<ShardPeerWithExadbXsNewVaultAndCluster> getPeerDetails() {
        return peerDetails;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardWithExadbXsNewVaultAndCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardWithExadbXsNewVaultAndCluster)) {
            return false;
        }

        DistributedDatabaseShardWithExadbXsNewVaultAndCluster other =
                (DistributedDatabaseShardWithExadbXsNewVaultAndCluster) o;
