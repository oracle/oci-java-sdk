...
public final class CreateDistributedDatabaseDetails
    ...
    public static class Builder {
         ...
         * private endpoints associated with the Globally distributed database.
         */
         ...
         * port number should not be re-used for any other distributed database. For EXADB based
         * distributed databases, tls is not supported hence the listenerPortTls is not needed to be
         * provided in create payload.
         */
        ...
        /**
         * TCP SCAN listener port for new clusters to be created. Applicable only when shard and
         * catalog source types are XS_NEW_VAULT_AND_CLUSTER or XS_NEW_CLUSTER. Defaults to 1521
         * when not provided.
         */
     ...
     * endpoints associated with the Globally distributed database.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("privateEndpointIds")
     ...
     * number should not be re-used for any other distributed database. For EXADB based distributed
     * databases, tls is not supported hence the listenerPortTls is not needed to be provided in
     * create payload.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("listenerPortTls")
    ...
    /**
     * TCP SCAN listener port for new clusters to be created. Applicable only when shard and catalog
     * source types are XS_NEW_VAULT_AND_CLUSTER or XS_NEW_CLUSTER. Defaults to 1521 when not
     * provided.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("scanListenerPort")
