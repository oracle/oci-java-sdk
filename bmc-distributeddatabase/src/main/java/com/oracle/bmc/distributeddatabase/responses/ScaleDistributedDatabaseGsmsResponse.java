...
public class ScaleDistributedDatabaseGsmsResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ScaleDistributedDatabaseGsmsResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ScaleDistributedDatabaseGsmsResponse o) {
         ...
         */
        @Override
        public ScaleDistributedDatabaseGsmsResponse build() {
            return new ScaleDistributedDatabaseGsmsResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleDistributedDatabaseGsmsResponse)) {
            return false;
        }

        ScaleDistributedDatabaseGsmsResponse other = (ScaleDistributedDatabaseGsmsResponse) o;
