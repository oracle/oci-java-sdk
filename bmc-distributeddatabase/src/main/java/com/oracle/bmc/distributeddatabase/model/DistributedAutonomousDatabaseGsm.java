 ...
 * distributed autonomous database. <br>
...
public final class DistributedAutonomousDatabaseGsm
    ...
    public DistributedAutonomousDatabaseGsm(
            String name,
            Float computeCount,
            ...
            DistributedAutonomousDatabaseGsmImage gsmImageDetails,
    ...
    public static class Builder {
        ...
        private DistributedAutonomousDatabaseGsmImage gsmImageDetails;

        public Builder gsmImageDetails(DistributedAutonomousDatabaseGsmImage gsmImageDetails) {
            this.gsmImageDetails = gsmImageDetails;
        ...
        public DistributedAutonomousDatabaseGsm build() {
            DistributedAutonomousDatabaseGsm model =
                    new DistributedAutonomousDatabaseGsm(
                            this.name,
                            this.computeCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDatabaseGsm model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("gsmImageDetails")
    private final DistributedAutonomousDatabaseGsmImage gsmImageDetails;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseGsm(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseGsm)) {
            return false;
        }

        DistributedAutonomousDatabaseGsm other = (DistributedAutonomousDatabaseGsm) o;
