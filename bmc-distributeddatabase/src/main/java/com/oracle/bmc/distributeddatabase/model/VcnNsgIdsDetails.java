...
/**
 * Specifies the Virtual Cloud Network (VCN) and the list of associated Network Security Group (NSG)
 * OCIDs.
 *
 * <p>This model is shared across create (POST), update (PUT/PATCH), and retrieve (GET) operations.
 *
 * <p>- During create, {@code nsgIds} (if provided) specifies the NSGs to associate with the new
 * resource. - During update or patch, {@code nsgIds} modifies the associations: provide an empty
 * array ({@code []}) to clear all NSGs, or provide a new list to replace them. - GET responses
 * return the current associations (which may be empty). <br>
...
public final class VcnNsgIdsDetails
    ...
    public static class Builder {
         ...
         * customer Virtual Cloud Network.
         */
         ...
         * network security groups (NSGs) associated with resources in this VCN. For more
     ...
     * the network security groups (NSGs) associated with resources in this VCN. For more
     * information about NSGs, see [Security
     * Rules](https://docs.oracle.com/iaas/Content/Network/Concepts/securityrules.htm).
     */
    @com.fasterxml.jackson.annotation.JsonProperty("nsgIds")
