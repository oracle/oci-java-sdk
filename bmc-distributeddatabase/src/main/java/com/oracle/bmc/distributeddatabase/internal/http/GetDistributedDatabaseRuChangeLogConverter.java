...
public class GetDistributedDatabaseRuChangeLogConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetDistributedDatabaseRuChangeLogConverter.class);
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.distributeddatabase.requests.GetDistributedDatabaseRuChangeLogRequest
                    request) {
        ...
        if (request.getSourceShardName() != null) {
            target =
                    target.queryParam(
                            "sourceShardName",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getSourceShardName()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.distributeddatabase.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.distributeddatabase.responses.GetDistributedDatabaseRuChangeLogResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.distributedDatabaseRuChangeLog(response.getItem());
