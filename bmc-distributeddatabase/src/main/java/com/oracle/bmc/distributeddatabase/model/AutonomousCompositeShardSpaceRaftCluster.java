...
/**
 * Raft cluster details for composite shard spaces. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AutonomousCompositeShardSpaceRaftCluster.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AutonomousCompositeShardSpaceRaftCluster
    ...
    public AutonomousCompositeShardSpaceRaftCluster(
            String name,
    ...
    public static class Builder {
        ...
        public AutonomousCompositeShardSpaceRaftCluster build() {
            AutonomousCompositeShardSpaceRaftCluster model =
                    new AutonomousCompositeShardSpaceRaftCluster(
                            this.name,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AutonomousCompositeShardSpaceRaftCluster model) {
    ...
    public enum RuMode implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(RuMode.class);
        ...
        public static RuMode create(String key) {
            ...
            LOG.warn(
                    "Received unknown value '{}' for enum 'RuMode', returning UnknownEnumValue",
                    key);
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("AutonomousCompositeShardSpaceRaftCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AutonomousCompositeShardSpaceRaftCluster)) {
            return false;
        }

        AutonomousCompositeShardSpaceRaftCluster other =
                (AutonomousCompositeShardSpaceRaftCluster) o;
