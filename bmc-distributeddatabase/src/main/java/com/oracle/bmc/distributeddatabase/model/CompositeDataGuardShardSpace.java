...
/**
 * Globally distributed database composite data guard shard space details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CompositeDataGuardShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CompositeDataGuardShardSpace
    ...
    public CompositeDataGuardShardSpace(
            String name,
            Integer chunkCount,
            CompositeDataGuardShardSpaceReplica originalReplica,
            java.util.List<CompositeDataGuardShardSpaceReplica> dataGuardReplicas) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private CompositeDataGuardShardSpaceReplica originalReplica;

        public Builder originalReplica(CompositeDataGuardShardSpaceReplica originalReplica) {
            this.originalReplica = originalReplica;
        ...
        private java.util.List<CompositeDataGuardShardSpaceReplica> dataGuardReplicas;
        ...
        public CompositeDataGuardShardSpace build() {
            CompositeDataGuardShardSpace model =
                    new CompositeDataGuardShardSpace(
                            this.name,
                            this.chunkCount,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CompositeDataGuardShardSpace model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final CompositeDataGuardShardSpaceReplica originalReplica;

    public CompositeDataGuardShardSpaceReplica getOriginalReplica() {
        return originalReplica;
    }

    /** The details of data guard replica associated with the shard. */
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<CompositeDataGuardShardSpaceReplica> dataGuardReplicas;
     ...
     * @return the value
     */
    public java.util.List<CompositeDataGuardShardSpaceReplica> getDataGuardReplicas() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CompositeDataGuardShardSpace(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CompositeDataGuardShardSpace)) {
            return false;
        }

        CompositeDataGuardShardSpace other = (CompositeDataGuardShardSpace) o;
