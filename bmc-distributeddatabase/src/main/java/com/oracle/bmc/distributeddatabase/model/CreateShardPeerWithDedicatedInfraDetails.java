...
/**
 * Details required for creation of autonomous dedicated infrastructure based shard peer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateShardPeerWithDedicatedInfraDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateShardPeerWithDedicatedInfraDetails
    ...
    public CreateShardPeerWithDedicatedInfraDetails(
    ...
    public static class Builder {
         ...
         * cloud Autonomous VM Cluster for the peer shard.
         */
        ...
        public CreateShardPeerWithDedicatedInfraDetails build() {
            CreateShardPeerWithDedicatedInfraDetails model =
                    new CreateShardPeerWithDedicatedInfraDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateShardPeerWithDedicatedInfraDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateShardPeerWithDedicatedInfraDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateShardPeerWithDedicatedInfraDetails)) {
            return false;
        }

        CreateShardPeerWithDedicatedInfraDetails other =
                (CreateShardPeerWithDedicatedInfraDetails) o;
