...
public class GenerateDistributedDatabaseWalletResponse
    ...
    private GenerateDistributedDatabaseWalletResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GenerateDistributedDatabaseWalletResponse o) {
         ...
         */
        @Override
        public GenerateDistributedDatabaseWalletResponse build() {
            return new GenerateDistributedDatabaseWalletResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDistributedDatabaseWalletResponse)) {
            return false;
        }

        GenerateDistributedDatabaseWalletResponse other =
                (GenerateDistributedDatabaseWalletResponse) o;
