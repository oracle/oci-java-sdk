...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDistributedDatabaseShardDatabaseWithExadbXsDetails.Builder.class)
...
public final class CreateDistributedDatabaseShardDatabaseWithExadbXsDetails
    ...
    public static class Builder {
        ...
        public CreateDistributedDatabaseShardDatabaseWithExadbXsDetails build() {
            CreateDistributedDatabaseShardDatabaseWithExadbXsDetails model =
                    new CreateDistributedDatabaseShardDatabaseWithExadbXsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabaseShardDatabaseWithExadbXsDetails model) {
    ...
    @Deprecated
    public CreateDistributedDatabaseShardDatabaseWithExadbXsDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseShardDatabaseWithExadbXsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseShardDatabaseWithExadbXsDetails)) {
            return false;
        }

        CreateDistributedDatabaseShardDatabaseWithExadbXsDetails other =
                (CreateDistributedDatabaseShardDatabaseWithExadbXsDetails) o;
