...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/DownloadDistributedDatabaseGsmCertificateSigningRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DownloadDistributedDatabaseGsmCertificateSigningRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class DownloadDistributedDatabaseGsmCertificateSigningRequestRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(DownloadDistributedDatabaseGsmCertificateSigningRequestRequest o) {
        ...
        /**
         * Build the instance of DownloadDistributedDatabaseGsmCertificateSigningRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of DownloadDistributedDatabaseGsmCertificateSigningRequestRequest
         */
        public DownloadDistributedDatabaseGsmCertificateSigningRequestRequest build() {
         ...
         * @return instance of DownloadDistributedDatabaseGsmCertificateSigningRequestRequest
         */
        public DownloadDistributedDatabaseGsmCertificateSigningRequestRequest
                buildWithoutInvocationCallback() {
            DownloadDistributedDatabaseGsmCertificateSigningRequestRequest request =
                    new DownloadDistributedDatabaseGsmCertificateSigningRequestRequest();
            request.distributedDatabaseId = distributedDatabaseId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new DownloadDistributedDatabaseGsmCertificateSigningRequestRequest(distributedDatabaseId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DownloadDistributedDatabaseGsmCertificateSigningRequestRequest)) {
            return false;
        }

        DownloadDistributedDatabaseGsmCertificateSigningRequestRequest other =
                (DownloadDistributedDatabaseGsmCertificateSigningRequestRequest) o;
