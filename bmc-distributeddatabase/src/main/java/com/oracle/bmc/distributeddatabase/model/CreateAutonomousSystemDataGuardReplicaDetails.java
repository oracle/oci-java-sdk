...
/**
 * Details required to create a system data guard replica. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousSystemDataGuardReplicaDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAutonomousSystemDataGuardReplicaDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "databases"})
    public CreateAutonomousSystemDataGuardReplicaDetails(
            String name,
    ...
    public static class Builder {
        /**
         * The name of the data guard replica. It must start with a letter and contain only letters,
        ...
        public CreateAutonomousSystemDataGuardReplicaDetails build() {
            CreateAutonomousSystemDataGuardReplicaDetails model =
                    new CreateAutonomousSystemDataGuardReplicaDetails(this.name, this.databases);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAutonomousSystemDataGuardReplicaDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousSystemDataGuardReplicaDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousSystemDataGuardReplicaDetails)) {
            return false;
        }

        CreateAutonomousSystemDataGuardReplicaDetails other =
                (CreateAutonomousSystemDataGuardReplicaDetails) o;
