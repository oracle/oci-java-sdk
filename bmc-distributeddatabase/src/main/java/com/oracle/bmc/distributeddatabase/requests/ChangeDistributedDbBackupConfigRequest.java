...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/ChangeDistributedDbBackupConfigExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeDistributedDbBackupConfigRequest.
 */
...
public class ChangeDistributedDbBackupConfigRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of ChangeDistributedDbBackupConfigRequest as configured by this builder
         *
        ...
        public ChangeDistributedDbBackupConfigRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeDistributedDbBackupConfigRequest(distributedDatabaseId, changeDistributedDbBackupConfigDetails, opcRequestId, ifMatch, opcRetryToken);
        }
    }
