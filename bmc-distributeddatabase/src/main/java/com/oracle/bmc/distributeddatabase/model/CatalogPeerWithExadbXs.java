...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CatalogPeerWithExadbXs.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CatalogPeerWithExadbXs
    ...
    public static class Builder {
        ...
        public CatalogPeerWithExadbXs build() {
            CatalogPeerWithExadbXs model =
                    new CatalogPeerWithExadbXs(
                            this.vmClusterId,
                            this.shardGroup,
                            this.status,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CatalogPeerWithExadbXs model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CatalogPeerWithExadbXs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatalogPeerWithExadbXs)) {
            return false;
        }

        CatalogPeerWithExadbXs other = (CatalogPeerWithExadbXs) o;
