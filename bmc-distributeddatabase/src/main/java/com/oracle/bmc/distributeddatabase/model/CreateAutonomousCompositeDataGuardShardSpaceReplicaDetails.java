...
/**
 * Details required to create a composite data guard shard space replica for a Globally distributed
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "databases"})
    public CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails(
            String name,
    ...
    public static class Builder {
        ...
        public CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails build() {
            CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails model =
                    new CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails(
                            this.name, this.databases);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails)) {
            return false;
        }

        CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails other =
                (CreateAutonomousCompositeDataGuardShardSpaceReplicaDetails) o;
