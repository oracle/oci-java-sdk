...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/GetDistributedAutonomousDatabaseRuChangeLogExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDistributedAutonomousDatabaseRuChangeLogRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20260101")
public class GetDistributedAutonomousDatabaseRuChangeLogRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetDistributedAutonomousDatabaseRuChangeLogRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetDistributedAutonomousDatabaseRuChangeLogRequest o) {
        ...
        /**
         * Build the instance of GetDistributedAutonomousDatabaseRuChangeLogRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetDistributedAutonomousDatabaseRuChangeLogRequest
         */
        public GetDistributedAutonomousDatabaseRuChangeLogRequest build() {
         ...
         * @return instance of GetDistributedAutonomousDatabaseRuChangeLogRequest
         */
        public GetDistributedAutonomousDatabaseRuChangeLogRequest buildWithoutInvocationCallback() {
            GetDistributedAutonomousDatabaseRuChangeLogRequest request =
                    new GetDistributedAutonomousDatabaseRuChangeLogRequest();
            request.distributedAutonomousDatabaseId = distributedAutonomousDatabaseId;
            request.sourceShardName = sourceShardName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetDistributedAutonomousDatabaseRuChangeLogRequest(distributedAutonomousDatabaseId, sourceShardName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDistributedAutonomousDatabaseRuChangeLogRequest)) {
            return false;
        }

        GetDistributedAutonomousDatabaseRuChangeLogRequest other =
                (GetDistributedAutonomousDatabaseRuChangeLogRequest) o;
