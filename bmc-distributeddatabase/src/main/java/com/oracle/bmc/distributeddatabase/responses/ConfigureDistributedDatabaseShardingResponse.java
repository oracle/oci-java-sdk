...
public class ConfigureDistributedDatabaseShardingResponse
    ...
    private ConfigureDistributedDatabaseShardingResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(ConfigureDistributedDatabaseShardingResponse o) {
         ...
         */
        @Override
        public ConfigureDistributedDatabaseShardingResponse build() {
            return new ConfigureDistributedDatabaseShardingResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ConfigureDistributedDatabaseShardingResponse)) {
            return false;
        }

        ConfigureDistributedDatabaseShardingResponse other =
                (ConfigureDistributedDatabaseShardingResponse) o;
