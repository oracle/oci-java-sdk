...
/**
 * Details of a distributed database shard on ExaDB-XS with a new cluster. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseShardDatabaseWithExadbXsNewCluster.Builder.class)
...
public final class DistributedDatabaseShardDatabaseWithExadbXsNewCluster
    ...
    public static class Builder {
        ...
        public DistributedDatabaseShardDatabaseWithExadbXsNewCluster build() {
            DistributedDatabaseShardDatabaseWithExadbXsNewCluster model =
                    new DistributedDatabaseShardDatabaseWithExadbXsNewCluster(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardDatabaseWithExadbXsNewCluster model) {
    ...
    @Deprecated
    public DistributedDatabaseShardDatabaseWithExadbXsNewCluster(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabaseWithExadbXsNewCluster(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabaseWithExadbXsNewCluster)) {
            return false;
        }

        DistributedDatabaseShardDatabaseWithExadbXsNewCluster other =
                (DistributedDatabaseShardDatabaseWithExadbXsNewCluster) o;
