...
public class ListDistributedAutonomousDatabasesConverter {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.distributeddatabase.requests.ListDistributedAutonomousDatabasesRequest
                    request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(request.getCompartmentId(), "compartmentId is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20250101").path("distributedAutonomousDatabases");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.distributeddatabase.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.distributeddatabase.responses.ListDistributedAutonomousDatabasesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
