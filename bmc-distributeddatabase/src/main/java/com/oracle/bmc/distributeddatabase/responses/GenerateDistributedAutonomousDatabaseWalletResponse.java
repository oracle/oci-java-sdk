...
public class GenerateDistributedAutonomousDatabaseWalletResponse
    ...
    private GenerateDistributedAutonomousDatabaseWalletResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GenerateDistributedAutonomousDatabaseWalletResponse o) {
         ...
         */
        @Override
        public GenerateDistributedAutonomousDatabaseWalletResponse build() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDistributedAutonomousDatabaseWalletResponse)) {
            return false;
        }

        GenerateDistributedAutonomousDatabaseWalletResponse other =
                (GenerateDistributedAutonomousDatabaseWalletResponse) o;
