...
public class ChangeDistributedDatabaseCompartmentRequest
     ...
     */
    private com.oracle.bmc.distributeddatabase.model.ChangeDistributedDatabaseCompartmentDetails
            changeDistributedDatabaseCompartmentDetails;

    /**
     * Request to move the Globally distributed database to a different compartment.
     */
    public com.oracle.bmc.distributeddatabase.model.ChangeDistributedDatabaseCompartmentDetails
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.distributeddatabase.model.ChangeDistributedDatabaseCompartmentDetails
                changeDistributedDatabaseCompartmentDetails = null;

        /**
         * Request to move the Globally distributed database to a different compartment.
         * @param changeDistributedDatabaseCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeDistributedDatabaseCompartmentDetails(
                com.oracle.bmc.distributeddatabase.model.ChangeDistributedDatabaseCompartmentDetails
                        changeDistributedDatabaseCompartmentDetails) {
            this.changeDistributedDatabaseCompartmentDetails =
                    changeDistributedDatabaseCompartmentDetails;
            return this;
        }
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeDistributedDatabaseCompartmentRequest o) {
            changeDistributedDatabaseCompartmentDetails(
                    o.getChangeDistributedDatabaseCompartmentDetails());
        ...
        /**
         * Build the instance of ChangeDistributedDatabaseCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeDistributedDatabaseCompartmentRequest
         */
        public ChangeDistributedDatabaseCompartmentRequest build() {
            ChangeDistributedDatabaseCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(
                com.oracle.bmc.distributeddatabase.model.ChangeDistributedDatabaseCompartmentDetails
                        body) {
            changeDistributedDatabaseCompartmentDetails(body);
            return this;
        }
         ...
         * @return instance of ChangeDistributedDatabaseCompartmentRequest
         */
        public ChangeDistributedDatabaseCompartmentRequest buildWithoutInvocationCallback() {
            ChangeDistributedDatabaseCompartmentRequest request =
                    new ChangeDistributedDatabaseCompartmentRequest();
            request.changeDistributedDatabaseCompartmentDetails =
                    changeDistributedDatabaseCompartmentDetails;
            ...
            return request;
            // new ChangeDistributedDatabaseCompartmentRequest(changeDistributedDatabaseCompartmentDetails, distributedDatabaseId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",changeDistributedDatabaseCompartmentDetails=")
                .append(String.valueOf(this.changeDistributedDatabaseCompartmentDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeDistributedDatabaseCompartmentRequest)) {
            return false;
        }

        ChangeDistributedDatabaseCompartmentRequest other =
                (ChangeDistributedDatabaseCompartmentRequest) o;
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeDistributedDatabaseCompartmentDetails == null
                                ? 43
                                : this.changeDistributedDatabaseCompartmentDetails.hashCode());
        result =
                (result * PRIME)
