...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/PatchDistributedAutonomousDatabaseExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use PatchDistributedAutonomousDatabaseRequest.
 */
...
public class PatchDistributedAutonomousDatabaseRequest
    ...
    public static class Builder
        ...
        /**
         * Build the instance of PatchDistributedAutonomousDatabaseRequest as configured by this builder
         *
        ...
        public PatchDistributedAutonomousDatabaseRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new PatchDistributedAutonomousDatabaseRequest(distributedAutonomousDatabaseId, patchDistributedAutonomousDatabaseDetails, ifMatch, opcRetryToken, opcRequestId);
        }
    }
