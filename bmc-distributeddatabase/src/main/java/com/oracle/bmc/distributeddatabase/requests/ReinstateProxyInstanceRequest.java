...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/ReinstateProxyInstanceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ReinstateProxyInstanceRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class ReinstateProxyInstanceRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ReinstateProxyInstanceRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ReinstateProxyInstanceRequest o) {
         ...
         *
         * @return instance of ReinstateProxyInstanceRequest
         */
        public ReinstateProxyInstanceRequest build() {
            ReinstateProxyInstanceRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ReinstateProxyInstanceRequest
         */
        public ReinstateProxyInstanceRequest buildWithoutInvocationCallback() {
            ReinstateProxyInstanceRequest request = new ReinstateProxyInstanceRequest();
            request.distributedDatabasePrivateEndpointId = distributedDatabasePrivateEndpointId;
            request.opcRequestId = opcRequestId;
            request.ifMatch = ifMatch;
            request.opcRetryToken = opcRetryToken;
            return request;
            // new ReinstateProxyInstanceRequest(distributedDatabasePrivateEndpointId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReinstateProxyInstanceRequest)) {
            return false;
        }

        ReinstateProxyInstanceRequest other = (ReinstateProxyInstanceRequest) o;
