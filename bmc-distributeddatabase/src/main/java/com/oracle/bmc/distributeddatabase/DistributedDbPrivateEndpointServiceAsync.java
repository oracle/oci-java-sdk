...
public interface DistributedDbPrivateEndpointServiceAsync extends AutoCloseable {
     ...
     */
    java.util.concurrent.Future<ChangeDistributedDatabasePrivateEndpointCompartmentResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<CreateDistributedDatabasePrivateEndpointResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<DeleteDistributedDatabasePrivateEndpointResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<ListDistributedDatabasePrivateEndpointsResponse>
     ...
     *     may only be consumed once.
     */
    java.util.concurrent.Future<UpdateDistributedDatabasePrivateEndpointResponse>
