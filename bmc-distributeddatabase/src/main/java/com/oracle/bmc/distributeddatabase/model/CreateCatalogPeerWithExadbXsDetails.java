...
/**
 * Details required for creation of ExadbXs infrastructure based catalog peer. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateCatalogPeerWithExadbXsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class CreateCatalogPeerWithExadbXsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"vmClusterId", "protectionMode", "transportType"})
    public CreateCatalogPeerWithExadbXsDetails(
            String vmClusterId,
    ...
    public static class Builder {
         ...
         * VM Cluster for the catalog peer.
         */
        ...
        public CreateCatalogPeerWithExadbXsDetails build() {
            CreateCatalogPeerWithExadbXsDetails model =
                    new CreateCatalogPeerWithExadbXsDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateCatalogPeerWithExadbXsDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateCatalogPeerWithExadbXsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateCatalogPeerWithExadbXsDetails)) {
            return false;
        }

        CreateCatalogPeerWithExadbXsDetails other = (CreateCatalogPeerWithExadbXsDetails) o;
