...
public class DistributedDbPrivateEndpointServicePaginators {
    ...
    /**
     * Creates a new iterable which will iterate over the {@link com.oracle.bmc.distributeddatabase.model.DistributedDatabasePrivateEndpointSummary} objects
     ...
     *
     * @param request a request which can be sent to the service operation
     * @return an {@link java.lang.Iterable} which can be used to iterate over the {@link com.oracle.bmc.distributeddatabase.model.DistributedDatabasePrivateEndpointSummary} objects
