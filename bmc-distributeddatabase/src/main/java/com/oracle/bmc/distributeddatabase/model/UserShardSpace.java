...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserShardSpace.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class UserShardSpace extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "originalReplica", "dataGuardReplicas"})
    public UserShardSpace(
            String name,
            UserShardSpaceReplica originalReplica,
            java.util.List<UserShardSpaceReplica> dataGuardReplicas) {
        super();
        this.name = name;
    ...
    public static class Builder {
        ...
        private UserShardSpaceReplica originalReplica;

        public Builder originalReplica(UserShardSpaceReplica originalReplica) {
            this.originalReplica = originalReplica;
        ...
        private java.util.List<UserShardSpaceReplica> dataGuardReplicas;
         ...
         * @return this builder
         **/
        public Builder dataGuardReplicas(java.util.List<UserShardSpaceReplica> dataGuardReplicas) {
            this.dataGuardReplicas = dataGuardReplicas;
        ...
        public UserShardSpace build() {
            UserShardSpace model =
                    new UserShardSpace(this.name, this.originalReplica, this.dataGuardReplicas);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UserShardSpace model) {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("originalReplica")
    private final UserShardSpaceReplica originalReplica;

    public UserShardSpaceReplica getOriginalReplica() {
     ...
     **/
    @com.fasterxml.jackson.annotation.JsonProperty("dataGuardReplicas")
    private final java.util.List<UserShardSpaceReplica> dataGuardReplicas;

    /**
     * The details of data guard replica for the user shard space.
     * @return the value
     **/
    public java.util.List<UserShardSpaceReplica> getDataGuardReplicas() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserShardSpace)) {
            return false;
        }

        UserShardSpace other = (UserShardSpace) o;
