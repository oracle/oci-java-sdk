...
/**
 * Details of a distributed database shard running on ExaDB-XS. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDatabaseShardDatabaseWithExadbXs.Builder.class)
...
public final class DistributedDatabaseShardDatabaseWithExadbXs
    ...
    public static class Builder {
        ...
        public DistributedDatabaseShardDatabaseWithExadbXs build() {
            DistributedDatabaseShardDatabaseWithExadbXs model =
                    new DistributedDatabaseShardDatabaseWithExadbXs(
                            this.name,
                            this.timeCreated,
                            this.timeUpdated,
                            this.metadata,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDatabaseShardDatabaseWithExadbXs model) {
    ...
    @Deprecated
    public DistributedDatabaseShardDatabaseWithExadbXs(
            String name,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDatabaseShardDatabaseWithExadbXs(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDatabaseShardDatabaseWithExadbXs)) {
            return false;
        }

        DistributedDatabaseShardDatabaseWithExadbXs other =
                (DistributedDatabaseShardDatabaseWithExadbXs) o;
