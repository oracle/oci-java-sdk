...
public class ConfigureDistributedAutonomousDatabaseAutoResourceManagementConverter {
    ...
    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(
                    ConfigureDistributedAutonomousDatabaseAutoResourceManagementConverter.class);
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getDistributedAutonomousDatabaseId()))
                        .path("actions")
                        .path("configureAutoResourceManagement");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.distributeddatabase.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.distributeddatabase.responses.ConfigureDistributedAutonomousDatabaseAutoResourceManagementResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.distributedAutonomousDatabaseAutoResourceManagementDetails(
                                        response.getItem());
