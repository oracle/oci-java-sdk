...
public class GetDistributedDatabasePrivateEndpointResponse
    ...
    private GetDistributedDatabasePrivateEndpointResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetDistributedDatabasePrivateEndpointResponse o) {
         ...
         */
        @Override
        public GetDistributedDatabasePrivateEndpointResponse build() {
            return new GetDistributedDatabasePrivateEndpointResponse(
                    __httpStatusCode__,
                    headers,
                    opcRequestId,
                    etag,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDistributedDatabasePrivateEndpointResponse)) {
            return false;
        }

        GetDistributedDatabasePrivateEndpointResponse other =
                (GetDistributedDatabasePrivateEndpointResponse) o;
