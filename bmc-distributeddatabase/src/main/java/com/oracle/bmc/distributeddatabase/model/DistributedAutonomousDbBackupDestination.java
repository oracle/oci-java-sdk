...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedAutonomousDbBackupDestination.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedAutonomousDbBackupDestination
    ...
    public DistributedAutonomousDbBackupDestination(
            Type type,
            String id,
            String vpcUser,
            String vpcPassword,
    ...
    public static class Builder {
        ...
        public DistributedAutonomousDbBackupDestination build() {
            DistributedAutonomousDbBackupDestination model =
                    new DistributedAutonomousDbBackupDestination(
                            this.type,
                            this.id,
                            this.vpcUser,
                            this.vpcPassword,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedAutonomousDbBackupDestination model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDbBackupDestination(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDbBackupDestination)) {
            return false;
        }

        DistributedAutonomousDbBackupDestination other =
                (DistributedAutonomousDbBackupDestination) o;
