...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "source",
        defaultImpl = DistributedAutonomousDatabaseShard.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DistributedAutonomousDatabaseShardWithDedicatedInfra.class,
            name = "ADB_D")
})
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public class DistributedAutonomousDatabaseShard
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"name", "timeCreated", "timeUpdated"})
    protected DistributedAutonomousDatabaseShard(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedAutonomousDatabaseShard(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedAutonomousDatabaseShard)) {
            return false;
        }

        DistributedAutonomousDatabaseShard other = (DistributedAutonomousDatabaseShard) o;
