...
/**
 * Details of Globally distributed database connection String. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DistributedDbConnectionString.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class DistributedDbConnectionString
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"allConnectionStrings"})
    public DistributedDbConnectionString(java.util.Map<String, String> allConnectionStrings) {
        super();
    ...
    public static class Builder {
        ...
        public DistributedDbConnectionString build() {
            DistributedDbConnectionString model =
                    new DistributedDbConnectionString(this.allConnectionStrings);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DistributedDbConnectionString model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DistributedDbConnectionString(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DistributedDbConnectionString)) {
            return false;
        }

        DistributedDbConnectionString other = (DistributedDbConnectionString) o;
