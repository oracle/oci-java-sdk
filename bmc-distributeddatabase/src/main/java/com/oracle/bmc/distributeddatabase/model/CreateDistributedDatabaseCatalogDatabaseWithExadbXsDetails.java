...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails.Builder.class
)
...
public final class CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails
    ...
    public static class Builder {
        ...
        public CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails build() {
            CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails model =
                    new CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails(
                            this.tdeWalletPassword,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails model) {
    ...
    @Deprecated
    public CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails)) {
            return false;
        }

        CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails other =
                (CreateDistributedDatabaseCatalogDatabaseWithExadbXsDetails) o;
