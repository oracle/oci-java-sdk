...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/distributeddatabase/GenerateDistributedDatabaseGsmCertificateSigningRequestExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GenerateDistributedDatabaseGsmCertificateSigningRequestRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20250101")
public class GenerateDistributedDatabaseGsmCertificateSigningRequestRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder copy(GenerateDistributedDatabaseGsmCertificateSigningRequestRequest o) {
        ...
        /**
         * Build the instance of GenerateDistributedDatabaseGsmCertificateSigningRequestRequest as configured by this builder
         *
         ...
         *
         * @return instance of GenerateDistributedDatabaseGsmCertificateSigningRequestRequest
         */
        public GenerateDistributedDatabaseGsmCertificateSigningRequestRequest build() {
         ...
         * @return instance of GenerateDistributedDatabaseGsmCertificateSigningRequestRequest
         */
        public GenerateDistributedDatabaseGsmCertificateSigningRequestRequest
                buildWithoutInvocationCallback() {
            GenerateDistributedDatabaseGsmCertificateSigningRequestRequest request =
                    new GenerateDistributedDatabaseGsmCertificateSigningRequestRequest();
            ...
            return request;
            // new GenerateDistributedDatabaseGsmCertificateSigningRequestRequest(distributedDatabaseId, caBundleId, opcRequestId, ifMatch, opcRetryToken);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenerateDistributedDatabaseGsmCertificateSigningRequestRequest)) {
            return false;
        }

        GenerateDistributedDatabaseGsmCertificateSigningRequestRequest other =
                (GenerateDistributedDatabaseGsmCertificateSigningRequestRequest) o;
