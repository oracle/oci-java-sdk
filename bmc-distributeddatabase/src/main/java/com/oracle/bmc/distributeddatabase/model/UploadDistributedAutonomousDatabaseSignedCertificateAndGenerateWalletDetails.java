 ...
 * of the Globally distributed autonomous database. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder =
                UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails.Builder
                        .class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"caSignedCertificate"})
    public UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails(
    ...
    public static class Builder {
        ...
        public UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails
                build() {
            UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails model =
                    new UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails(
    ...
    public boolean equals(Object o) {
        ...
        UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails other =
                (UploadDistributedAutonomousDatabaseSignedCertificateAndGenerateWalletDetails) o;
