...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetTunnelInspectionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetTunnelInspectionRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class GetTunnelInspectionRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetTunnelInspectionRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetTunnelInspectionRuleRequest o) {
         ...
         *
         * @return instance of GetTunnelInspectionRuleRequest
         */
        public GetTunnelInspectionRuleRequest build() {
            GetTunnelInspectionRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetTunnelInspectionRuleRequest
         */
        public GetTunnelInspectionRuleRequest buildWithoutInvocationCallback() {
            GetTunnelInspectionRuleRequest request = new GetTunnelInspectionRuleRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.tunnelInspectionRuleName = tunnelInspectionRuleName;
            request.opcRequestId = opcRequestId;
            return request;
            // new GetTunnelInspectionRuleRequest(networkFirewallPolicyId, tunnelInspectionRuleName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetTunnelInspectionRuleRequest)) {
            return false;
        }

        GetTunnelInspectionRuleRequest other = (GetTunnelInspectionRuleRequest) o;
