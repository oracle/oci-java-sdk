...
public class ListSecurityRulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListSecurityRulesConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.ListSecurityRulesRequest interceptRequest(
            com.oracle.bmc.networkfirewall.requests.ListSecurityRulesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getSecurityRulePriorityOrder() != null) {
            target =
                    target.queryParam(
                            "securityRulePriorityOrder",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getSecurityRulePriorityOrder()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkfirewall.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.ListSecurityRulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses.ListSecurityRulesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .ListSecurityRulesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.securityRuleSummaryCollection(response.getItem());
