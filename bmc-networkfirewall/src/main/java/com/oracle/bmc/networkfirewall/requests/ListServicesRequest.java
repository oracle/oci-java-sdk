...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListServicesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListServicesRequest.
 */
...
public class ListServicesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListServicesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListServicesRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
