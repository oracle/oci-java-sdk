...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListDecryptionProfilesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListDecryptionProfilesRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class ListDecryptionProfilesRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListDecryptionProfilesRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListDecryptionProfilesRequest o) {
        ...
        /**
         * Build the instance of ListDecryptionProfilesRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListDecryptionProfilesRequest
         */
        public ListDecryptionProfilesRequest build() {
            ListDecryptionProfilesRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListDecryptionProfilesRequest
         */
        public ListDecryptionProfilesRequest buildWithoutInvocationCallback() {
            ListDecryptionProfilesRequest request = new ListDecryptionProfilesRequest();
            ...
            return request;
            // new ListDecryptionProfilesRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListDecryptionProfilesRequest)) {
            return false;
        }

        ListDecryptionProfilesRequest other = (ListDecryptionProfilesRequest) o;
