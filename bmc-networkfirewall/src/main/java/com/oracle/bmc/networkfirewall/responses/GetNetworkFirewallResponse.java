...
public class GetNetworkFirewallResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetNetworkFirewallResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetNetworkFirewallResponse> {
         ...
         */
        @Override
        public Builder copy(GetNetworkFirewallResponse o) {
         ...
         */
        @Override
        public GetNetworkFirewallResponse build() {
            return new GetNetworkFirewallResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, networkFirewall);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetNetworkFirewallResponse)) {
            return false;
        }

        GetNetworkFirewallResponse other = (GetNetworkFirewallResponse) o;
