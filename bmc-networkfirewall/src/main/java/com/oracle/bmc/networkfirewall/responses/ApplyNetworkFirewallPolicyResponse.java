...
public class ApplyNetworkFirewallPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private ApplyNetworkFirewallPolicyResponse(
    ...
    public static class Builder {
         ...
         */
        public Builder copy(ApplyNetworkFirewallPolicyResponse o) {
         ...
         */
        public ApplyNetworkFirewallPolicyResponse build() {
            return new ApplyNetworkFirewallPolicyResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplyNetworkFirewallPolicyResponse)) {
            return false;
        }

        ApplyNetworkFirewallPolicyResponse other = (ApplyNetworkFirewallPolicyResponse) o;
