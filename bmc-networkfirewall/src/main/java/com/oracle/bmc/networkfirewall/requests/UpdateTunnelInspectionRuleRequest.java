...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateTunnelInspectionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateTunnelInspectionRuleRequest.
 */
...
public class UpdateTunnelInspectionRuleRequest
    ...
    public static class Builder
        ...
        public UpdateTunnelInspectionRuleRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateTunnelInspectionRuleRequest(networkFirewallPolicyId, tunnelInspectionRuleName, updateTunnelInspectionRuleDetails, ifMatch, opcRequestId);
        }
    }
