...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteDecryptionProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDecryptionProfileRequest.
 */
...
public class DeleteDecryptionProfileRequest
    ...
    public static class Builder
        ...
        public DeleteDecryptionProfileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteDecryptionProfileRequest(networkFirewallPolicyId, decryptionProfileName, ifMatch, opcRequestId);
        }
    }
