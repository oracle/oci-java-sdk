...
/**
 * Request for creating NATV4 type Nat Rule used in the firewall policy. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateNatV4RuleDetails.Builder.class)
...
public final class CreateNatV4RuleDetails extends CreateNatRuleDetails {
    ...
    public static class Builder {
        ...
        public CreateNatV4RuleDetails build() {
            CreateNatV4RuleDetails model =
                    new CreateNatV4RuleDetails(
                            this.name,
                            this.description,
                            this.position,
                            this.condition,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateNatV4RuleDetails model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateNatV4RuleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNatV4RuleDetails)) {
            return false;
        }

        CreateNatV4RuleDetails other = (CreateNatV4RuleDetails) o;
