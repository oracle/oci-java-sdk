...
public class ListServiceListsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListServiceListsConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.ListServiceListsRequest interceptRequest(
            com.oracle.bmc.networkfirewall.requests.ListServiceListsRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            @Override
                            public com.oracle.bmc.networkfirewall.responses.ListServiceListsResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.ListServiceListsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses.ListServiceListsResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .ListServiceListsResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.serviceListSummaryCollection(response.getItem());
