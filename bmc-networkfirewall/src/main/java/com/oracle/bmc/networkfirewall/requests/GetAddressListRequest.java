...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetAddressListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetAddressListRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class GetAddressListRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetAddressListRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetAddressListRequest
         */
        public GetAddressListRequest build() {
            GetAddressListRequest request = buildWithoutInvocationCallback();
        ...
        public GetAddressListRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetAddressListRequest(networkFirewallPolicyId, addressListName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetAddressListRequest)) {
            return false;
        }

        GetAddressListRequest other = (GetAddressListRequest) o;
