...
public class CreateNetworkFirewallPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateNetworkFirewallPolicyResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateNetworkFirewallPolicyResponse o) {
         ...
         */
        @Override
        public CreateNetworkFirewallPolicyResponse build() {
            return new CreateNetworkFirewallPolicyResponse(
                    __httpStatusCode__,
                    headers,
                    etag,
                    opcWorkRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNetworkFirewallPolicyResponse)) {
            return false;
        }

        CreateNetworkFirewallPolicyResponse other = (CreateNetworkFirewallPolicyResponse) o;
