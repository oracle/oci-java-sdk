...
public class ListNatRulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListNatRulesConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.ListNatRulesRequest interceptRequest(
            com.oracle.bmc.networkfirewall.requests.ListNatRulesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getNatRulePriorityOrder() != null) {
            target =
                    target.queryParam(
                            "natRulePriorityOrder",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getNatRulePriorityOrder()));
        }
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.networkfirewall.responses.ListNatRulesResponse>() {
                            @Override
                            public com.oracle.bmc.networkfirewall.responses.ListNatRulesResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.ListNatRulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses.ListNatRulesResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .ListNatRulesResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.natRuleCollection(response.getItem());
