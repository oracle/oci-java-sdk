...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteSecurityRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteSecurityRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteSecurityRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteSecurityRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteSecurityRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteSecurityRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteSecurityRuleRequest
         */
        public DeleteSecurityRuleRequest build() {
            DeleteSecurityRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteSecurityRuleRequest
         */
        public DeleteSecurityRuleRequest buildWithoutInvocationCallback() {
            DeleteSecurityRuleRequest request = new DeleteSecurityRuleRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.securityRuleName = securityRuleName;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteSecurityRuleRequest(networkFirewallPolicyId, securityRuleName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteSecurityRuleRequest)) {
            return false;
        }

        DeleteSecurityRuleRequest other = (DeleteSecurityRuleRequest) o;
