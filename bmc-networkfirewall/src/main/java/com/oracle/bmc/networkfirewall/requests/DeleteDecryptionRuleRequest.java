...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteDecryptionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteDecryptionRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteDecryptionRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteDecryptionRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteDecryptionRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteDecryptionRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteDecryptionRuleRequest
         */
        public DeleteDecryptionRuleRequest build() {
            DeleteDecryptionRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteDecryptionRuleRequest
         */
        public DeleteDecryptionRuleRequest buildWithoutInvocationCallback() {
            DeleteDecryptionRuleRequest request = new DeleteDecryptionRuleRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.decryptionRuleName = decryptionRuleName;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteDecryptionRuleRequest(networkFirewallPolicyId, decryptionRuleName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteDecryptionRuleRequest)) {
            return false;
        }

        DeleteDecryptionRuleRequest other = (DeleteDecryptionRuleRequest) o;
