...
public class CreateServiceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateServiceResponse> {
         ...
         */
        @Override
        public Builder copy(CreateServiceResponse o) {
        ...
        public CreateServiceResponse build() {
            return new CreateServiceResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, service);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceResponse)) {
            return false;
        }

        CreateServiceResponse other = (CreateServiceResponse) o;
