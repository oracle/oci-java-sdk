...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetApplicationExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetApplicationRequest.
 */
...
public class GetApplicationRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetApplicationRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new GetApplicationRequest(networkFirewallPolicyId, applicationName, opcRequestId, limit, page);
        }
    }
