...
public class CreateNatRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CreateNatRuleResponse> {
         ...
         */
        @Override
        public Builder copy(CreateNatRuleResponse o) {
         ...
         */
        @Override
        public CreateNatRuleResponse build() {
            return new CreateNatRuleResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, natRule);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateNatRuleResponse)) {
            return false;
        }

        CreateNatRuleResponse other = (CreateNatRuleResponse) o;
