...
/**
 * Request for updating ICMP6 Application used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateIcmp6ApplicationDetails.Builder.class)
...
public final class UpdateIcmp6ApplicationDetails extends UpdateApplicationDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateIcmp6ApplicationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateIcmp6ApplicationDetails)) {
            return false;
        }

        UpdateIcmp6ApplicationDetails other = (UpdateIcmp6ApplicationDetails) o;
