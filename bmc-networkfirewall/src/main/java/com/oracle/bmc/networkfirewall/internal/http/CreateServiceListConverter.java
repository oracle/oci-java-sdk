...
public class CreateServiceListConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateServiceListConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.CreateServiceListRequest interceptRequest(
            com.oracle.bmc.networkfirewall.requests.CreateServiceListRequest request) {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkfirewall.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.CreateServiceListResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses.CreateServiceListResponse
                                        ...
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .CreateServiceListResponse.builder()
                                                        .__httpStatusCode__(rawResponse.getStatus())
                                                        .headers(headers);

                                builder.serviceList(response.getItem());
