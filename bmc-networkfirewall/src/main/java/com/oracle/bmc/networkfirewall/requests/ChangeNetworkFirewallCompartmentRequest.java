...
/**
 * <b>Example: </b>Click <a href="https://docs.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ChangeNetworkFirewallCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeNetworkFirewallCompartmentRequest.
 */
...
public class ChangeNetworkFirewallCompartmentRequest
     ...
     */
    private com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails
            changeNetworkFirewallCompartmentDetails;

    /**
     * The information to be updated.
     */
    public com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails
            getChangeNetworkFirewallCompartmentDetails() {
        return changeNetworkFirewallCompartmentDetails;
    }
    /**
    ...
    public com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails getBody$() {
        return changeNetworkFirewallCompartmentDetails;
    }
    ...
    public static class Builder
         ...
         */
        private com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails
                changeNetworkFirewallCompartmentDetails = null;

        /**
         * The information to be updated.
         * @param changeNetworkFirewallCompartmentDetails the value to set
         * @return this builder instance
         */
        public Builder changeNetworkFirewallCompartmentDetails(
                com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails
                        changeNetworkFirewallCompartmentDetails) {
         ...
         * @return this builder instance
         */
        public Builder copy(ChangeNetworkFirewallCompartmentRequest o) {
        ...
        /**
         * Build the instance of ChangeNetworkFirewallCompartmentRequest as configured by this builder
         *
         ...
         *
         * @return instance of ChangeNetworkFirewallCompartmentRequest
         */
        public ChangeNetworkFirewallCompartmentRequest build() {
            ChangeNetworkFirewallCompartmentRequest request = buildWithoutInvocationCallback();
        ...
        @com.oracle.bmc.InternalSdk
        public Builder body$(
                com.oracle.bmc.networkfirewall.model.ChangeNetworkFirewallCompartmentDetails body) {
            changeNetworkFirewallCompartmentDetails(body);
            return this;
        }
        ...
        public ChangeNetworkFirewallCompartmentRequest buildWithoutInvocationCallback() {
            ChangeNetworkFirewallCompartmentRequest request =
                    new ChangeNetworkFirewallCompartmentRequest();
            request.networkFirewallId = networkFirewallId;
            request.changeNetworkFirewallCompartmentDetails =
                    changeNetworkFirewallCompartmentDetails;
    ...
    public String toString() {
        ...
        sb.append(",changeNetworkFirewallCompartmentDetails=")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChangeNetworkFirewallCompartmentRequest)) {
            return false;
        }

        ChangeNetworkFirewallCompartmentRequest other = (ChangeNetworkFirewallCompartmentRequest) o;
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.changeNetworkFirewallCompartmentDetails == null
                                ? 43
