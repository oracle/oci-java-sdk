...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListUrlListsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListUrlListsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class ListUrlListsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListUrlListsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListUrlListsRequest o) {
        ...
        /**
         * Build the instance of ListUrlListsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListUrlListsRequest
         */
        public ListUrlListsRequest build() {
            ListUrlListsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListUrlListsRequest
         */
        public ListUrlListsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListUrlListsRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListUrlListsRequest)) {
            return false;
        }

        ListUrlListsRequest other = (ListUrlListsRequest) o;
