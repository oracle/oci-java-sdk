...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateServiceListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateServiceListRequest.
 */
...
public class UpdateServiceListRequest
    ...
    public static class Builder
        ...
        public UpdateServiceListRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateServiceListRequest(networkFirewallPolicyId, serviceListName, updateServiceListDetails, ifMatch, opcRequestId);
        }
    }
