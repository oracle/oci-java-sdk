...
public class GetApplicationGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetApplicationGroupResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetApplicationGroupResponse> {
         ...
         */
        @Override
        public Builder copy(GetApplicationGroupResponse o) {
        ...
        public GetApplicationGroupResponse build() {
            return new GetApplicationGroupResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, applicationGroup);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetApplicationGroupResponse)) {
            return false;
        }

        GetApplicationGroupResponse other = (GetApplicationGroupResponse) o;
