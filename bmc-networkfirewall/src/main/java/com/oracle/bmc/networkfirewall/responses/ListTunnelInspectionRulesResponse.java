...
public class ListTunnelInspectionRulesResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public com.oracle.bmc.networkfirewall.model.TunnelInspectionRuleSummaryCollection
            getTunnelInspectionRuleSummaryCollection() {
        return tunnelInspectionRuleSummaryCollection;
    }
    ...
    public static class Builder
         ...
         * @return this builder
         */
        public Builder tunnelInspectionRuleSummaryCollection(
                com.oracle.bmc.networkfirewall.model.TunnelInspectionRuleSummaryCollection
                        tunnelInspectionRuleSummaryCollection) {
            this.tunnelInspectionRuleSummaryCollection = tunnelInspectionRuleSummaryCollection;
            return this;
        ...
        public Builder copy(ListTunnelInspectionRulesResponse o) {
            ...
            tunnelInspectionRuleSummaryCollection(o.getTunnelInspectionRuleSummaryCollection());
    ...
    public String toString() {
        ...
        sb.append(",tunnelInspectionRuleSummaryCollection=")
                .append(String.valueOf(tunnelInspectionRuleSummaryCollection));
        sb.append(")");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListTunnelInspectionRulesResponse)) {
            return false;
        }

        ListTunnelInspectionRulesResponse other = (ListTunnelInspectionRulesResponse) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.tunnelInspectionRuleSummaryCollection,
                        other.tunnelInspectionRuleSummaryCollection);
    }
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.tunnelInspectionRuleSummaryCollection == null
                                ? 43
                                : this.tunnelInspectionRuleSummaryCollection.hashCode());
        return result;
    }
}
