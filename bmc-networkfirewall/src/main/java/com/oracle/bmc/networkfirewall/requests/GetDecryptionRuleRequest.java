...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetDecryptionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDecryptionRuleRequest.
 */
...
public class GetDecryptionRuleRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetDecryptionRuleRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new GetDecryptionRuleRequest(networkFirewallPolicyId, decryptionRuleName, opcRequestId, limit, page);
        }
    }
