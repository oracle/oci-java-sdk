...
public class BulkUploadDecryptionProfilesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(BulkUploadDecryptionProfilesConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.BulkUploadDecryptionProfilesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.networkfirewall.requests.BulkUploadDecryptionProfilesRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.networkfirewall.responses.BulkUploadDecryptionProfilesResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkfirewall.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.BulkUploadDecryptionProfilesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses
                                                .BulkUploadDecryptionProfilesResponse.Builder
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .BulkUploadDecryptionProfilesResponse
                                                        .builder()
