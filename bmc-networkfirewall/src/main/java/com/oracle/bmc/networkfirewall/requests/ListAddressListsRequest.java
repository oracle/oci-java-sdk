...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListAddressListsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListAddressListsRequest.
 */
...
public class ListAddressListsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListAddressListsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListAddressListsRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
