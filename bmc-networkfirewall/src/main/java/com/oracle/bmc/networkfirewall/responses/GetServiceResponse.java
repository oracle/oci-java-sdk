...
public class GetServiceResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetServiceResponse> {
        ...
        public GetServiceResponse build() {
            return new GetServiceResponse(__httpStatusCode__, headers, etag, opcRequestId, service);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetServiceResponse)) {
            return false;
        }

        GetServiceResponse other = (GetServiceResponse) o;
