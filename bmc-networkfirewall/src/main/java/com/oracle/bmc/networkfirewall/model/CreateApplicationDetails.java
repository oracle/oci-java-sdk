...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = CreateApplicationDetails.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CreateIcmpApplicationDetails.class,
        name = "ICMP"
    ),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = CreateIcmp6ApplicationDetails.class,
        name = "ICMP_V6"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class CreateApplicationDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
