...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/CreateNetworkFirewallPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use CreateNetworkFirewallPolicyRequest.
 */
...
public class CreateNetworkFirewallPolicyRequest
    ...
    public static class Builder
        ...
        public CreateNetworkFirewallPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new CreateNetworkFirewallPolicyRequest(createNetworkFirewallPolicyDetails, opcRetryToken, opcRequestId);
        }
    }
