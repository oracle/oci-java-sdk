...
public class CreateApplicationGroupResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private CreateApplicationGroupResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(CreateApplicationGroupResponse o) {
        ...
        public CreateApplicationGroupResponse build() {
            return new CreateApplicationGroupResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApplicationGroupResponse)) {
            return false;
        }

        CreateApplicationGroupResponse other = (CreateApplicationGroupResponse) o;
