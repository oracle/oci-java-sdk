...
public class DeleteApplicationResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<DeleteApplicationResponse> {
        ...
        public DeleteApplicationResponse build() {
            return new DeleteApplicationResponse(__httpStatusCode__, headers, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteApplicationResponse)) {
            return false;
        }

        DeleteApplicationResponse other = (DeleteApplicationResponse) o;
