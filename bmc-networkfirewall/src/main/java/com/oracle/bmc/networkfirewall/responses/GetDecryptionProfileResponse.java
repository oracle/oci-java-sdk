...
public class GetDecryptionProfileResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    /** The returned {@code DecryptionProfile} instance. */
    ...
    private GetDecryptionProfileResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetDecryptionProfileResponse> {
         ...
         */
        @Override
        public Builder copy(GetDecryptionProfileResponse o) {
         ...
         */
        @Override
        public GetDecryptionProfileResponse build() {
            return new GetDecryptionProfileResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetDecryptionProfileResponse)) {
            return false;
        }

        GetDecryptionProfileResponse other = (GetDecryptionProfileResponse) o;
