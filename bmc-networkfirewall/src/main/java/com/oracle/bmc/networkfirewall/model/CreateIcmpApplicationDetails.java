...
/**
 * Request for ICMP Application used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateIcmpApplicationDetails.Builder.class)
...
public final class CreateIcmpApplicationDetails extends CreateApplicationDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateIcmpApplicationDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateIcmpApplicationDetails)) {
            return false;
        }

        CreateIcmpApplicationDetails other = (CreateIcmpApplicationDetails) o;
