...
public class GetNetworkFirewallPolicyResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetNetworkFirewallPolicyResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetNetworkFirewallPolicyResponse o) {
         ...
         */
        @Override
        public GetNetworkFirewallPolicyResponse build() {
            return new GetNetworkFirewallPolicyResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, networkFirewallPolicy);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetNetworkFirewallPolicyResponse)) {
            return false;
        }

        GetNetworkFirewallPolicyResponse other = (GetNetworkFirewallPolicyResponse) o;
