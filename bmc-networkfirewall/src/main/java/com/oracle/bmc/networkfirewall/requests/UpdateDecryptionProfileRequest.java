...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateDecryptionProfileExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateDecryptionProfileRequest.
 */
...
public class UpdateDecryptionProfileRequest
    ...
    public static class Builder
        ...
        public UpdateDecryptionProfileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateDecryptionProfileRequest(networkFirewallPolicyId, decryptionProfileName, updateDecryptionProfileDetails, ifMatch, opcRequestId);
        }
    }
