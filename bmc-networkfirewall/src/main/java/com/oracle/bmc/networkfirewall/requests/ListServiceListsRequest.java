...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListServiceListsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListServiceListsRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class ListServiceListsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    ListServiceListsRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(ListServiceListsRequest o) {
        ...
        /**
         * Build the instance of ListServiceListsRequest as configured by this builder
         *
         ...
         *
         * @return instance of ListServiceListsRequest
         */
        public ListServiceListsRequest build() {
            ListServiceListsRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of ListServiceListsRequest
         */
        public ListServiceListsRequest buildWithoutInvocationCallback() {
            ListServiceListsRequest request = new ListServiceListsRequest();
            ...
            return request;
            // new ListServiceListsRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListServiceListsRequest)) {
            return false;
        }

        ListServiceListsRequest other = (ListServiceListsRequest) o;
