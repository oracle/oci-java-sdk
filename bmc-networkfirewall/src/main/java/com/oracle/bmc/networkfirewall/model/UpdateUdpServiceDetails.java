...
/**
 * Request for updating UDP Service used on the firewall policy rules. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateUdpServiceDetails.Builder.class)
...
public final class UpdateUdpServiceDetails extends UpdateServiceDetails {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateUdpServiceDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateUdpServiceDetails)) {
            return false;
        }

        UpdateUdpServiceDetails other = (UpdateUdpServiceDetails) o;
