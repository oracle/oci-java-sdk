...
/**
 * Collection of Applications in the network firewall policy <br>
...
public final class ApplicationSummaryCollection
    ...
    public static class Builder {
        ...
        public ApplicationSummaryCollection build() {
            ApplicationSummaryCollection model = new ApplicationSummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplicationSummaryCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplicationSummaryCollection)) {
            return false;
        }

        ApplicationSummaryCollection other = (ApplicationSummaryCollection) o;
