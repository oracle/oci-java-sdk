...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/BulkUploadMappedSecretsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use BulkUploadMappedSecretsRequest.
 */
...
public class BulkUploadMappedSecretsRequest
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder bulkUploadMappedSecretsDetails(
                java.io.InputStream bulkUploadMappedSecretsDetails) {
            this.bulkUploadMappedSecretsDetails = bulkUploadMappedSecretsDetails;
            return this;
        }
        ...
        public Builder copy(BulkUploadMappedSecretsRequest o) {
            ...
            bulkUploadMappedSecretsDetails(o.getBulkUploadMappedSecretsDetails());
         ...
         */
        public BulkUploadMappedSecretsRequest build() {
            BulkUploadMappedSecretsRequest request = buildWithoutInvocationCallback();
        ...
        public Builder body$(java.io.InputStream body) {
            bulkUploadMappedSecretsDetails(body);
            return this;
        }
         ...
         * @return instance of BulkUploadMappedSecretsRequest
         */
        public BulkUploadMappedSecretsRequest buildWithoutInvocationCallback() {
            BulkUploadMappedSecretsRequest request = new BulkUploadMappedSecretsRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.bulkUploadMappedSecretsDetails = bulkUploadMappedSecretsDetails;
    ...
    public String toString() {
        ...
        sb.append(",bulkUploadMappedSecretsDetails=")
                .append(String.valueOf(this.bulkUploadMappedSecretsDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BulkUploadMappedSecretsRequest)) {
            return false;
        }

        BulkUploadMappedSecretsRequest other = (BulkUploadMappedSecretsRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(
                        this.networkFirewallPolicyId, other.networkFirewallPolicyId)
                && java.util.Objects.equals(
                        this.bulkUploadMappedSecretsDetails, other.bulkUploadMappedSecretsDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.bulkUploadMappedSecretsDetails == null
                                ? 43
                                : this.bulkUploadMappedSecretsDetails.hashCode());
        result =
                (result * PRIME)
