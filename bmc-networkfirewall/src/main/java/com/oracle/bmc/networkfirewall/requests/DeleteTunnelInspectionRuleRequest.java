...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteTunnelInspectionRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteTunnelInspectionRuleRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteTunnelInspectionRuleRequest
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteTunnelInspectionRuleRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteTunnelInspectionRuleRequest o) {
        ...
        /**
         * Build the instance of DeleteTunnelInspectionRuleRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteTunnelInspectionRuleRequest
         */
        public DeleteTunnelInspectionRuleRequest build() {
            DeleteTunnelInspectionRuleRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteTunnelInspectionRuleRequest
         */
        public DeleteTunnelInspectionRuleRequest buildWithoutInvocationCallback() {
            DeleteTunnelInspectionRuleRequest request = new DeleteTunnelInspectionRuleRequest();
            ...
            return request;
            // new DeleteTunnelInspectionRuleRequest(networkFirewallPolicyId, tunnelInspectionRuleName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteTunnelInspectionRuleRequest)) {
            return false;
        }

        DeleteTunnelInspectionRuleRequest other = (DeleteTunnelInspectionRuleRequest) o;
