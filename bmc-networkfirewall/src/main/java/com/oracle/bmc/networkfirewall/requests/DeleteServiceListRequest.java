...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteServiceListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteServiceListRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteServiceListRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteServiceListRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteServiceListRequest o) {
        ...
        /**
         * Build the instance of DeleteServiceListRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteServiceListRequest
         */
        public DeleteServiceListRequest build() {
            DeleteServiceListRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteServiceListRequest
         */
        public DeleteServiceListRequest buildWithoutInvocationCallback() {
            DeleteServiceListRequest request = new DeleteServiceListRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.serviceListName = serviceListName;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new DeleteServiceListRequest(networkFirewallPolicyId, serviceListName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteServiceListRequest)) {
            return false;
        }

        DeleteServiceListRequest other = (DeleteServiceListRequest) o;
