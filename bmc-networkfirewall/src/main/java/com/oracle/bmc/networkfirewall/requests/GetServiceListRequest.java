...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetServiceListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetServiceListRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class GetServiceListRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetServiceListRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(GetServiceListRequest o) {
        ...
        /**
         * Build the instance of GetServiceListRequest as configured by this builder
         *
         ...
         *
         * @return instance of GetServiceListRequest
         */
        public GetServiceListRequest build() {
            GetServiceListRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of GetServiceListRequest
         */
        public GetServiceListRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetServiceListRequest(networkFirewallPolicyId, serviceListName, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetServiceListRequest)) {
            return false;
        }

        GetServiceListRequest other = (GetServiceListRequest) o;
