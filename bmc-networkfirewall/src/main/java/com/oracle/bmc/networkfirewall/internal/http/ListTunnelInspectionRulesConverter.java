...
public class ListTunnelInspectionRulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListTunnelInspectionRulesConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.ListTunnelInspectionRulesRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.networkfirewall.requests.ListTunnelInspectionRulesRequest request) {
        ...
        if (request.getTunnelInspectionRulePriorityOrder() != null) {
            target =
                    target.queryParam(
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkfirewall.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.ListTunnelInspectionRulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.tunnelInspectionRuleSummaryCollection(response.getItem());
