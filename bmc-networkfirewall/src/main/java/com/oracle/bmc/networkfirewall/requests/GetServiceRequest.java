...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/GetServiceExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetServiceRequest.
 */
...
public class GetServiceRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public GetServiceRequest buildWithoutInvocationCallback() {
            ...
            request.page = page;
            return request;
            // new GetServiceRequest(networkFirewallPolicyId, serviceName, opcRequestId, limit, page);
        }
    }
