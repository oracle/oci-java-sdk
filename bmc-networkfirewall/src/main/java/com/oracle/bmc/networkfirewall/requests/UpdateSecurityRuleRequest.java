...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateSecurityRuleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateSecurityRuleRequest.
 */
...
public class UpdateSecurityRuleRequest
    ...
    public com.oracle.bmc.networkfirewall.model.UpdateSecurityRuleDetails getBody$() {
        return updateSecurityRuleDetails;
    }
    ...
    public static class Builder
         ...
         * @return this builder instance
         */
        public Builder updateSecurityRuleDetails(
                com.oracle.bmc.networkfirewall.model.UpdateSecurityRuleDetails
                        updateSecurityRuleDetails) {
            this.updateSecurityRuleDetails = updateSecurityRuleDetails;
            return this;
        }
        ...
        public Builder copy(UpdateSecurityRuleRequest o) {
            ...
            updateSecurityRuleDetails(o.getUpdateSecurityRuleDetails());
         ...
         */
        public UpdateSecurityRuleRequest build() {
            UpdateSecurityRuleRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.networkfirewall.model.UpdateSecurityRuleDetails body) {
            updateSecurityRuleDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateSecurityRuleRequest
         */
        public UpdateSecurityRuleRequest buildWithoutInvocationCallback() {
            UpdateSecurityRuleRequest request = new UpdateSecurityRuleRequest();
            request.networkFirewallPolicyId = networkFirewallPolicyId;
            request.securityRuleName = securityRuleName;
            request.updateSecurityRuleDetails = updateSecurityRuleDetails;
    ...
    public String toString() {
        ...
        sb.append(",updateSecurityRuleDetails=")
                .append(String.valueOf(this.updateSecurityRuleDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateSecurityRuleRequest)) {
            return false;
        }

        UpdateSecurityRuleRequest other = (UpdateSecurityRuleRequest) o;
        return super.equals(o)
                ...
                && java.util.Objects.equals(
                        this.updateSecurityRuleDetails, other.updateSecurityRuleDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateSecurityRuleDetails == null
                                ? 43
                                : this.updateSecurityRuleDetails.hashCode());
