...
public final class NetworkFirewallPolicySummaryCollection {
    ...
    public static class Builder {
        ...
        public NetworkFirewallPolicySummaryCollection build() {
            NetworkFirewallPolicySummaryCollection __instance__ =
                    new NetworkFirewallPolicySummaryCollection(items);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkFirewallPolicySummaryCollection o) {
