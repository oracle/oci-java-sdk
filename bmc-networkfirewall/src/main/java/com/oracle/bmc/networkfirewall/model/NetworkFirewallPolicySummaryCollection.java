...
public final class NetworkFirewallPolicySummaryCollection
    ...
    public NetworkFirewallPolicySummaryCollection(
            java.util.List<NetworkFirewallPolicySummary> items) {
        super();
        this.items = items;
    }
    ...
    public static class Builder {
        ...
        public NetworkFirewallPolicySummaryCollection build() {
            NetworkFirewallPolicySummaryCollection model =
                    new NetworkFirewallPolicySummaryCollection(this.items);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(NetworkFirewallPolicySummaryCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NetworkFirewallPolicySummaryCollection)) {
            return false;
        }

        NetworkFirewallPolicySummaryCollection other = (NetworkFirewallPolicySummaryCollection) o;
