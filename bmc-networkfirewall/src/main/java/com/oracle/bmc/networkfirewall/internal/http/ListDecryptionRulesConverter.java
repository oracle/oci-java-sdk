...
public class ListDecryptionRulesConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(ListDecryptionRulesConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.ListDecryptionRulesRequest
            interceptRequest(
                    com.oracle.bmc.networkfirewall.requests.ListDecryptionRulesRequest request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
        ...
        if (request.getDecryptionRulePriorityOrder() != null) {
            target =
                    target.queryParam(
                            "decryptionRulePriorityOrder",
                            com.oracle.bmc.util.internal.HttpUtils.attemptEncodeQueryParam(
                                    request.getDecryptionRulePriorityOrder()));
        }
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.networkfirewall.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.ListDecryptionRulesResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                builder.decryptionRuleSummaryCollection(response.getItem());
