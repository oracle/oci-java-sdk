...
public class GetUrlListConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(GetUrlListConverter.class);

    public static com.oracle.bmc.networkfirewall.requests.GetUrlListRequest interceptRequest(
            com.oracle.bmc.networkfirewall.requests.GetUrlListRequest request) {
        ...
        final java.util.function.Function<
                ...
                transformer =
                        new java.util.function.Function<
                                ...
                                com.oracle.bmc.networkfirewall.responses.GetUrlListResponse>() {
                            @Override
                            public com.oracle.bmc.networkfirewall.responses.GetUrlListResponse
                                    apply(javax.ws.rs.core.Response rawResponse) {
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.networkfirewall.responses.GetUrlListResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.networkfirewall.responses.GetUrlListResponse.Builder
                                        builder =
                                                com.oracle.bmc.networkfirewall.responses
                                                        .GetUrlListResponse.builder()
