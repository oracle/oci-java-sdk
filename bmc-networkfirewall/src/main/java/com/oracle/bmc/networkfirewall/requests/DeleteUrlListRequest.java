...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/DeleteUrlListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use DeleteUrlListRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20230501")
public class DeleteUrlListRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    DeleteUrlListRequest, java.lang.Void> {
         ...
         * @return this builder instance
         */
        public Builder copy(DeleteUrlListRequest o) {
        ...
        /**
         * Build the instance of DeleteUrlListRequest as configured by this builder
         *
         ...
         *
         * @return instance of DeleteUrlListRequest
         */
        public DeleteUrlListRequest build() {
            DeleteUrlListRequest request = buildWithoutInvocationCallback();
         ...
         * @return instance of DeleteUrlListRequest
         */
        public DeleteUrlListRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new DeleteUrlListRequest(networkFirewallPolicyId, urlListName, ifMatch, opcRequestId);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DeleteUrlListRequest)) {
            return false;
        }

        DeleteUrlListRequest other = (DeleteUrlListRequest) o;
