...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateNetworkFirewallPolicyExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateNetworkFirewallPolicyRequest.
 */
...
public class UpdateNetworkFirewallPolicyRequest
    ...
    public static class Builder
        ...
        public UpdateNetworkFirewallPolicyRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateNetworkFirewallPolicyRequest(networkFirewallPolicyId, updateNetworkFirewallPolicyDetails, ifMatch, opcRequestId);
        }
    }
