 ...
 * target="_blank" rel="noopener noreferrer">here</a> to see how to use GetDecryptionProfileRequest.
 */
...
public class GetDecryptionProfileRequest
    ...
    public static class Builder
        ...
        public GetDecryptionProfileRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetDecryptionProfileRequest(networkFirewallPolicyId, decryptionProfileName,
            // opcRequestId);
        }
    }
