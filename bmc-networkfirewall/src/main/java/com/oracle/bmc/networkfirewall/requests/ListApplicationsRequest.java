...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/ListApplicationsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListApplicationsRequest.
 */
...
public class ListApplicationsRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListApplicationsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListApplicationsRequest(networkFirewallPolicyId, limit, page, sortOrder, sortBy, opcRequestId, displayName);
        }
    }
