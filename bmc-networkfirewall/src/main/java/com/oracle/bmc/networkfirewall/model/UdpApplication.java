...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UdpApplication.Builder.class)
...
public final class UdpApplication extends Application {
    ...
    public static class Builder {
        ...
        public UdpApplication build() {
            UdpApplication __instance__ = new UdpApplication(minimumPort, maximumPort);
            __instance__.__explicitlySet__.addAll(__explicitlySet__);
            return __instance__;
        }

        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UdpApplication o) {
    ...
    public boolean equals(Object o) {
        ...
        UdpApplication other = (UdpApplication) o;
