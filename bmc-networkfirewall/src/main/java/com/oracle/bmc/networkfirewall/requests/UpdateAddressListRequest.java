...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/networkfirewall/UpdateAddressListExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateAddressListRequest.
 */
...
public class UpdateAddressListRequest
     ...
     */
    private com.oracle.bmc.networkfirewall.model.UpdateAddressListDetails updateAddressListDetails;

    /**
     * The information to be updated.
     */
    public com.oracle.bmc.networkfirewall.model.UpdateAddressListDetails
            getUpdateAddressListDetails() {
    ...
    public com.oracle.bmc.networkfirewall.model.UpdateAddressListDetails getBody$() {
        return updateAddressListDetails;
    }
    ...
    public static class Builder
         ...
         * Unique identifier for address lists.
         */
        private String addressListName = null;

        /**
         * Unique identifier for address lists.
         * @param addressListName the value to set
         * @return this builder instance
         */
        public Builder addressListName(String addressListName) {
         ...
         * The information to be updated.
         */
        private com.oracle.bmc.networkfirewall.model.UpdateAddressListDetails
                updateAddressListDetails = null;
        ...
        public Builder copy(UpdateAddressListRequest o) {
            ...
            addressListName(o.getAddressListName());
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.networkfirewall.model.UpdateAddressListDetails body) {
        ...
        public UpdateAddressListRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new UpdateAddressListRequest(networkFirewallPolicyId, addressListName, updateAddressListDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",addressListName=").append(String.valueOf(this.addressListName));
    ...
    public boolean equals(Object o) {
        ...
        return super.equals(o)
                ...
                && java.util.Objects.equals(this.addressListName, other.addressListName)
                && java.util.Objects.equals(
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.addressListName == null ? 43 : this.addressListName.hashCode());
        result =
                (result * PRIME)
