...
public class UpdateNatRuleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<UpdateNatRuleResponse> {
         ...
         */
        @Override
        public Builder copy(UpdateNatRuleResponse o) {
         ...
         */
        @Override
        public UpdateNatRuleResponse build() {
            return new UpdateNatRuleResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateNatRuleResponse)) {
            return false;
        }

        UpdateNatRuleResponse other = (UpdateNatRuleResponse) o;
