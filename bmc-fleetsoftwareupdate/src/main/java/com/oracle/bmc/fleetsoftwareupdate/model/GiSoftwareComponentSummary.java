...
/**
 * Summary of 'GI' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiSoftwareComponentSummary.Builder.class)
...
public final class GiSoftwareComponentSummary extends SoftwareComponentSummary {
    ...
    public static class Builder {
        ...
        public GiSoftwareComponentSummary build() {
            GiSoftwareComponentSummary model =
                    new GiSoftwareComponentSummary(this.sourceMajorVersion);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiSoftwareComponentSummary model) {
    ...
    @Deprecated
    public GiSoftwareComponentSummary(GiSourceMajorVersions sourceMajorVersion) {
        super();
        this.sourceMajorVersion = sourceMajorVersion;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GiSoftwareComponentSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiSoftwareComponentSummary)) {
            return false;
        }

        GiSoftwareComponentSummary other = (GiSoftwareComponentSummary) o;
