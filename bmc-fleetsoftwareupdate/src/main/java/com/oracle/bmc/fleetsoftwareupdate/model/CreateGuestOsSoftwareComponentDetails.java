...
/**
 * Details to create 'GUEST_OS' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGuestOsSoftwareComponentDetails.Builder.class)
...
public final class CreateGuestOsSoftwareComponentDetails extends CreateSoftwareComponentDetails {
    ...
    public static class Builder {
        ...
        public CreateGuestOsSoftwareComponentDetails build() {
            CreateGuestOsSoftwareComponentDetails model =
                    new CreateGuestOsSoftwareComponentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGuestOsSoftwareComponentDetails model) {
    ...
    @Deprecated
    public CreateGuestOsSoftwareComponentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGuestOsSoftwareComponentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGuestOsSoftwareComponentDetails)) {
            return false;
        }

        CreateGuestOsSoftwareComponentDetails other = (CreateGuestOsSoftwareComponentDetails) o;
