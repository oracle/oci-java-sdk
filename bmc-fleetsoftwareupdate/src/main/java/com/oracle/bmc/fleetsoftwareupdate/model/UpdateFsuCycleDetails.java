...
/**
 * Update Exadata Fleet Update Cycle resource details. If automated maintenance is enabled for the
 * associated Exadata Fleet Update Collection, updating Exadata Fleet Update Cycle will not affect
 * the Exadata Fleet Update Collection. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = UpdateFsuCycleDetails.class)
...
public class UpdateFsuCycleDetails
    ...
    protected UpdateFsuCycleDetails(
            String displayName,
    ...
    private final UpdateBatchingStrategyDetails batchingStrategy;
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFsuCycleDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFsuCycleDetails)) {
            return false;
        }

        UpdateFsuCycleDetails other = (UpdateFsuCycleDetails) o;
