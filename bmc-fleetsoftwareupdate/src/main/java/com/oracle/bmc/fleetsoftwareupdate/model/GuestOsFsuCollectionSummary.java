...
/**
 * Summary of 'GUEST_OS' type Exadata Fleet Update Collection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsFsuCollectionSummary.Builder.class)
...
public final class GuestOsFsuCollectionSummary extends FsuCollectionSummary {
    ...
    public static class Builder {
        ...
        public GuestOsFsuCollectionSummary build() {
            GuestOsFsuCollectionSummary model =
                    new GuestOsFsuCollectionSummary(
                            this.id,
                            this.displayName,
                            this.serviceType,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsFsuCollectionSummary model) {
    ...
    @Deprecated
    public GuestOsFsuCollectionSummary(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsFsuCollectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsFsuCollectionSummary)) {
            return false;
        }

        GuestOsFsuCollectionSummary other = (GuestOsFsuCollectionSummary) o;
