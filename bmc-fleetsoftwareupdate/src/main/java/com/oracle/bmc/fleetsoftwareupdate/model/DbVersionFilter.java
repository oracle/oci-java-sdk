...
/**
 * Versions to include in the discovery. These should be under the Source Major Version of the
 * Collection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DbVersionFilter.Builder.class)
...
public final class DbVersionFilter extends DbFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        public DbVersionFilter build() {
            DbVersionFilter model = new DbVersionFilter(this.mode, this.versions);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbVersionFilter model) {
    ...
    @Deprecated
    public DbVersionFilter(Mode mode, java.util.List<String> versions) {
        super(mode);
        this.versions = versions;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbVersionFilter)) {
            return false;
        }

        DbVersionFilter other = (DbVersionFilter) o;
