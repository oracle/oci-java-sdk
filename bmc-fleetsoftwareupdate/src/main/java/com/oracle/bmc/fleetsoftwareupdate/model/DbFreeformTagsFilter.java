...
/**
 * Freeform tags to include in the discovery. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbFreeformTagsFilter.Builder.class)
...
public final class DbFreeformTagsFilter extends DbFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        public DbFreeformTagsFilter build() {
            DbFreeformTagsFilter model =
                    new DbFreeformTagsFilter(this.mode, this.tags, this.operator);
    ...
    public boolean equals(Object o) {
        ...
        DbFreeformTagsFilter other = (DbFreeformTagsFilter) o;
