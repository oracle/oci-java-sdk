...
/**
 * Cleanup Exadata Fleet Update Action details. For a 'DB' Collection, Cleanup Action will attempt
 * to remove unused source DBHomes for a completed Maintenance Cycle. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CleanupAction.Builder.class)
...
public final class CleanupAction extends FsuAction {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CleanupAction model) {
    ...
    public boolean equals(Object o) {
        ...
        CleanupAction other = (CleanupAction) o;
