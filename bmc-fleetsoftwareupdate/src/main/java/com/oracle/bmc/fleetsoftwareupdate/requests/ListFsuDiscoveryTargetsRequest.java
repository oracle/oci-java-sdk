...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/ListFsuDiscoveryTargetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFsuDiscoveryTargetsRequest.
 */
...
public class ListFsuDiscoveryTargetsRequest
    ...
    public static class Builder
        ...
        public ListFsuDiscoveryTargetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFsuDiscoveryTargetsRequest(fsuDiscoveryId, compartmentId, targetId, status, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
