...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiDefinedTagsFilter.Builder.class)
...
public final class GiDefinedTagsFilter extends GiFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        public GiDefinedTagsFilter build() {
            GiDefinedTagsFilter model =
                    new GiDefinedTagsFilter(this.mode, this.tags, this.operator);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiDefinedTagsFilter model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiDefinedTagsFilter)) {
            return false;
        }

        GiDefinedTagsFilter other = (GiDefinedTagsFilter) o;
