...
public final class CreateSequentialBatchingStrategyDetails extends CreateBatchingStrategyDetails {
    ...
    public static class Builder {
        ...
        public CreateSequentialBatchingStrategyDetails build() {
            CreateSequentialBatchingStrategyDetails model =
                    new CreateSequentialBatchingStrategyDetails(this.isForceRolling);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateSequentialBatchingStrategyDetails model) {
    ...
    @Deprecated
    public CreateSequentialBatchingStrategyDetails(Boolean isForceRolling) {
        super();
        this.isForceRolling = isForceRolling;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateSequentialBatchingStrategyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateSequentialBatchingStrategyDetails)) {
            return false;
        }

        CreateSequentialBatchingStrategyDetails other = (CreateSequentialBatchingStrategyDetails) o;
