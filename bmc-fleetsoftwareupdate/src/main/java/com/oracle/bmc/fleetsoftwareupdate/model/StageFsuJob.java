...
/**
 * Stage Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = StageFsuJob.Builder.class)
...
public final class StageFsuJob extends FsuJob {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageFsuJob model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageFsuJob)) {
            return false;
        }

        StageFsuJob other = (StageFsuJob) o;
