...
public class FleetSoftwareUpdateWaiters {
     ...
     * @return a new {@code Waiter} instance
     */
    public com.oracle.bmc.waiter.Waiter<GetFsuReadinessCheckRequest, GetFsuReadinessCheckResponse>
            forFsuReadinessCheck(
    ...
    // Helper method to create a new Waiter for FsuReadinessCheck.
    private com.oracle.bmc.waiter.Waiter<GetFsuReadinessCheckRequest, GetFsuReadinessCheckResponse>
            forFsuReadinessCheck(
                    com.oracle.bmc.waiter.BmcGenericWaiter waiter,
                    final GetFsuReadinessCheckRequest request,
                    final com.oracle.bmc.fleetsoftwareupdate.model.FsuReadinessCheck
                                    .LifecycleState...
                            targetStates) {
        final java.util.Set<
                        com.oracle.bmc.fleetsoftwareupdate.model.FsuReadinessCheck.LifecycleState>
        ...
        return new com.oracle.bmc.waiter.internal.SimpleWaiterImpl<>(
                ...
                waiter.toCallable(
                        ...
                        new java.util.function.Function<
                            ...
                            @Override
                            public GetFsuReadinessCheckResponse apply(
                                    GetFsuReadinessCheckRequest request) {
                                return client.getFsuReadinessCheck(request);
                            }
                        },
                        new java.util.function.Predicate<GetFsuReadinessCheckResponse>() {
                            @Override
                            public boolean test(GetFsuReadinessCheckResponse response) {
                                return targetStatesSet.contains(
                                        response.getFsuReadinessCheck().getLifecycleState());
                            }
                        },
                        targetStatesSet.contains(
                                com.oracle.bmc.fleetsoftwareupdate.model.FsuReadinessCheck
