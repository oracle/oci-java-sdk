...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = FsuCollectionSummary.class
)
...
public class FsuCollectionSummary extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected FsuCollectionSummary(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FsuCollectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FsuCollectionSummary)) {
            return false;
        }

        FsuCollectionSummary other = (FsuCollectionSummary) o;
