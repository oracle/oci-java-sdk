...
/**
 * List of Compartments to include in the discovery. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbCompartmentIdFilter.Builder.class)
...
public final class DbCompartmentIdFilter extends DbFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        public DbCompartmentIdFilter build() {
            DbCompartmentIdFilter model = new DbCompartmentIdFilter(this.mode, this.identifiers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbCompartmentIdFilter model) {
    ...
    @Deprecated
    public DbCompartmentIdFilter(Mode mode, java.util.List<String> identifiers) {
        super(mode);
        this.identifiers = identifiers;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbCompartmentIdFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbCompartmentIdFilter)) {
            return false;
        }

        DbCompartmentIdFilter other = (DbCompartmentIdFilter) o;
