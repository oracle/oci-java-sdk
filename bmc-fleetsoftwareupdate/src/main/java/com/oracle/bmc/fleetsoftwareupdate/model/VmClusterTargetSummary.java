...
/**
 * Details of a VmCluster target member of a Exadata Fleet Update Collection. Stored references of
 * the resource documented in
 * https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/VmCluster/ <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = VmClusterTargetSummary.Builder.class)
...
public final class VmClusterTargetSummary extends TargetDetails {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(VmClusterTargetSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VmClusterTargetSummary)) {
            return false;
        }
