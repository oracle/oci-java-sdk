...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = AddFsuCollectionTargetsDetails.Builder.class)
@com.fasterxml.jackson.annotation.JsonFilter(
        com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel.EXPLICITLY_SET_FILTER_NAME)
public final class AddFsuCollectionTargetsDetails
        extends com.oracle.bmc.http.client.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"targets"})
    public AddFsuCollectionTargetsDetails(java.util.List<TargetEntry> targets) {
        super();
    ...
    public static class Builder {
        ...
        public AddFsuCollectionTargetsDetails build() {
            AddFsuCollectionTargetsDetails model = new AddFsuCollectionTargetsDetails(this.targets);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(AddFsuCollectionTargetsDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddFsuCollectionTargetsDetails)) {
            return false;
        }

        AddFsuCollectionTargetsDetails other = (AddFsuCollectionTargetsDetails) o;
