...
/**
 * Apply Exadata Fleet Update Action creation details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateApplyActionDetails.Builder.class)
...
public final class CreateApplyActionDetails extends CreateFsuActionDetails {
    ...
    public static class Builder {
        ...
        public CreateApplyActionDetails build() {
            CreateApplyActionDetails model =
                    new CreateApplyActionDetails(
                            this.displayName,
                            this.compartmentId,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateApplyActionDetails model) {
    ...
    @Deprecated
    public CreateApplyActionDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateApplyActionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateApplyActionDetails)) {
            return false;
        }

        CreateApplyActionDetails other = (CreateApplyActionDetails) o;
