...
/**
 * Details of 'EXADB_STACK' type Exadata Fleet Update Collection. Currently, components allowed in
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ExadbStackCollection.Builder.class)
...
public final class ExadbStackCollection extends FsuCollection {
    ...
    public static class Builder {
        ...
        private java.util.List<SoftwareComponentDetails> components;
         ...
         * @return this builder
         */
        public Builder components(java.util.List<SoftwareComponentDetails> components) {
        ...
        public ExadbStackCollection build() {
            ExadbStackCollection model =
                    new ExadbStackCollection(
                            this.id,
                            this.displayName,
                            this.serviceType,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ExadbStackCollection model) {
    ...
    public ExadbStackCollection(
            ...
            java.util.List<SoftwareComponentDetails> components) {
        super(
                id,
                displayName,
                serviceType,
    ...
    /** Details of components in an Exadata software stack. */
    @com.fasterxml.jackson.annotation.JsonProperty("components")
    private final java.util.List<SoftwareComponentDetails> components;
     ...
     * @return the value
     */
    public java.util.List<SoftwareComponentDetails> getComponents() {
        return components;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ExadbStackCollection(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExadbStackCollection)) {
            return false;
        }

        ExadbStackCollection other = (ExadbStackCollection) o;
