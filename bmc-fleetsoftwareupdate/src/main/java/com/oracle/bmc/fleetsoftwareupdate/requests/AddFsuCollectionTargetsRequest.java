...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/AddFsuCollectionTargetsExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use AddFsuCollectionTargetsRequest.
 */
...
public class AddFsuCollectionTargetsRequest
    ...
    public static class Builder
        ...
        public AddFsuCollectionTargetsRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new AddFsuCollectionTargetsRequest(fsuCollectionId, addFsuCollectionTargetsDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
