...
public final class CreateRollbackActionDetails extends CreateFsuActionDetails {
    ...
    public static class Builder {
        ...
        public CreateRollbackActionDetails build() {
            CreateRollbackActionDetails model =
                    new CreateRollbackActionDetails(
                            this.displayName,
                            this.compartmentId,
                            this.freeformTags,
                            this.definedTags,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateRollbackActionDetails model) {
    ...
    @Deprecated
    public CreateRollbackActionDetails(
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateRollbackActionDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateRollbackActionDetails)) {
            return false;
        }

        CreateRollbackActionDetails other = (CreateRollbackActionDetails) o;
