...
/**
 * Summary of Apply Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApplyFsuJobSummary.Builder.class)
...
public final class ApplyFsuJobSummary extends FsuJobSummary {
    ...
    public static class Builder {
        ...
        public ApplyFsuJobSummary build() {
            ApplyFsuJobSummary model =
                    new ApplyFsuJobSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplyFsuJobSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplyFsuJobSummary)) {
            return false;
        }

        ApplyFsuJobSummary other = (ApplyFsuJobSummary) o;
