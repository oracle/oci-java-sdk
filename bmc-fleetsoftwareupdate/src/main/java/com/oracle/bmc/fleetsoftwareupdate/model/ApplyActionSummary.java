...
/**
 * Apply Exadata Fleet Update Action summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ApplyActionSummary.Builder.class)
...
public final class ApplyActionSummary extends FsuActionSummary {
    ...
    public static class Builder {
        ...
        public ApplyActionSummary build() {
            ApplyActionSummary model =
                    new ApplyActionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplyActionSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplyActionSummary)) {
            return false;
        }

        ApplyActionSummary other = (ApplyActionSummary) o;
