...
/**
 * Stage Exadata Fleet Update Action summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StageActionSummary.Builder.class)
...
public final class StageActionSummary extends FsuActionSummary {
    ...
    public static class Builder {
        ...
        public StageActionSummary build() {
            StageActionSummary model =
                    new StageActionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageActionSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageActionSummary)) {
            return false;
        }

        StageActionSummary other = (StageActionSummary) o;
