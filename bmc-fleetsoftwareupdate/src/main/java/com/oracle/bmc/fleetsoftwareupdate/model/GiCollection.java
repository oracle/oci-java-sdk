...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = GiCollection.Builder.class)
...
public final class GiCollection extends FsuCollection {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiCollection)) {
            return false;
        }

        GiCollection other = (GiCollection) o;
