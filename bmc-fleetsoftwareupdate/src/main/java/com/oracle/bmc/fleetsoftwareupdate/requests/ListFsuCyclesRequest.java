...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/ListFsuCyclesExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ListFsuCyclesRequest.
 */
...
public class ListFsuCyclesRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
        ...
        public ListFsuCyclesRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ListFsuCyclesRequest(compartmentId, fsuCollectionId, lifecycleState, collectionType, displayName, targetVersion, limit, page, sortOrder, sortBy, opcRequestId);
        }
    }
