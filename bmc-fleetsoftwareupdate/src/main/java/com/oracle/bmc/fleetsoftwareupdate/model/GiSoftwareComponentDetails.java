...
/**
 * Details of 'GI' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiSoftwareComponentDetails.Builder.class)
...
public final class GiSoftwareComponentDetails extends SoftwareComponentDetails {
    ...
    public static class Builder {
        ...
        public GiSoftwareComponentDetails build() {
            GiSoftwareComponentDetails model =
                    new GiSoftwareComponentDetails(this.sourceMajorVersion, this.fleetDiscovery);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiSoftwareComponentDetails model) {
    ...
    @Deprecated
    public GiSoftwareComponentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GiSoftwareComponentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiSoftwareComponentDetails)) {
            return false;
        }

        GiSoftwareComponentDetails other = (GiSoftwareComponentDetails) o;
