...
/**
 * Details of 'GUEST_OS' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsSoftwareComponentDetails.Builder.class)
...
public final class GuestOsSoftwareComponentDetails extends SoftwareComponentDetails {
    ...
    public static class Builder {
        ...
        public GuestOsSoftwareComponentDetails build() {
            GuestOsSoftwareComponentDetails model =
                    new GuestOsSoftwareComponentDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsSoftwareComponentDetails model) {
    ...
    @Deprecated
    public GuestOsSoftwareComponentDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsSoftwareComponentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsSoftwareComponentDetails)) {
            return false;
        }

        GuestOsSoftwareComponentDetails other = (GuestOsSoftwareComponentDetails) o;
