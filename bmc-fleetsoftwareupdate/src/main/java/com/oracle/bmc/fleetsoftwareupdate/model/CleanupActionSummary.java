...
/**
 * Cleanup Exadata Fleet Update Action summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CleanupActionSummary.Builder.class)
...
public final class CleanupActionSummary extends FsuActionSummary {
    ...
    public static class Builder {
        ...
        public CleanupActionSummary build() {
            CleanupActionSummary model =
                    new CleanupActionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CleanupActionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CleanupActionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CleanupActionSummary)) {
            return false;
        }

        CleanupActionSummary other = (CleanupActionSummary) o;
