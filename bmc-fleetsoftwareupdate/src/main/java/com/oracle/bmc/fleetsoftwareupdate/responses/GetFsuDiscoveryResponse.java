...
public class GetFsuDiscoveryResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    private GetFsuDiscoveryResponse(
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetFsuDiscoveryResponse> {
         ...
         */
        @Override
        public Builder copy(GetFsuDiscoveryResponse o) {
         ...
         */
        @Override
        public GetFsuDiscoveryResponse build() {
            return new GetFsuDiscoveryResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, fsuDiscovery);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFsuDiscoveryResponse)) {
            return false;
        }

        GetFsuDiscoveryResponse other = (GetFsuDiscoveryResponse) o;
