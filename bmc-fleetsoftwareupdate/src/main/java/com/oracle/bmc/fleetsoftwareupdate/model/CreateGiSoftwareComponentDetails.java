...
/**
 * Details to create 'GI' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateGiSoftwareComponentDetails.Builder.class)
...
public final class CreateGiSoftwareComponentDetails extends CreateSoftwareComponentDetails {
    ...
    public static class Builder {
        ...
        public CreateGiSoftwareComponentDetails build() {
            CreateGiSoftwareComponentDetails model =
                    new CreateGiSoftwareComponentDetails(
                            this.sourceMajorVersion, this.fleetDiscovery);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateGiSoftwareComponentDetails model) {
    ...
    @Deprecated
    public CreateGiSoftwareComponentDetails(
            GiSourceMajorVersions sourceMajorVersion, GiFleetDiscoveryDetails fleetDiscovery) {
        super();
        this.sourceMajorVersion = sourceMajorVersion;
        this.fleetDiscovery = fleetDiscovery;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("CreateGiSoftwareComponentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateGiSoftwareComponentDetails)) {
            return false;
        }

        CreateGiSoftwareComponentDetails other = (CreateGiSoftwareComponentDetails) o;
