...
/**
 * Summary of Rolback & Remove Targets Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RollbackFsuJobSummary.Builder.class)
...
public final class RollbackFsuJobSummary extends FsuJobSummary {
    ...
    public static class Builder {
        ...
        public RollbackFsuJobSummary build() {
            RollbackFsuJobSummary model =
                    new RollbackFsuJobSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RollbackFsuJobSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RollbackFsuJobSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RollbackFsuJobSummary)) {
            return false;
        }

        RollbackFsuJobSummary other = (RollbackFsuJobSummary) o;
