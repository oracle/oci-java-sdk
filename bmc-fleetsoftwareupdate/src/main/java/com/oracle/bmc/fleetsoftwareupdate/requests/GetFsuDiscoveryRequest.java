...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/GetFsuDiscoveryExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use GetFsuDiscoveryRequest.
 */
@javax.annotation.Generated(value = "OracleSDKGenerator", comments = "API Version: 20220528")
public class GetFsuDiscoveryRequest extends com.oracle.bmc.requests.BmcRequest<java.lang.Void> {
    ...
    public static class Builder
            implements com.oracle.bmc.requests.BmcRequest.Builder<
                    GetFsuDiscoveryRequest, java.lang.Void> {
         ...
         *
         * @return instance of GetFsuDiscoveryRequest
         */
        public GetFsuDiscoveryRequest build() {
            GetFsuDiscoveryRequest request = buildWithoutInvocationCallback();
        ...
        public GetFsuDiscoveryRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new GetFsuDiscoveryRequest(fsuDiscoveryId, opcRequestId);
        }
    }
    ...
    public Builder toBuilder() {
        return new Builder().fsuDiscoveryId(fsuDiscoveryId).opcRequestId(opcRequestId);
    }
    ...
    public boolean equals(Object o) {
        ...
        GetFsuDiscoveryRequest other = (GetFsuDiscoveryRequest) o;
