...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
    ...
    property = "type",
    defaultImpl = FsuReadinessCheck.class
)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
        value = TargetFsuReadinessCheck.class,
        name = "TARGET"
    )
})
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public class FsuReadinessCheck extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    ...
    protected FsuReadinessCheck(
            String id,
            String displayName,
            String compartmentId,
            Integer issueCount,
            java.util.List<PatchingIssueEntry> issues,
    ...
    private final java.util.List<PatchingIssueEntry> issues;
     ...
     * @return the value
     **/
    public java.util.List<PatchingIssueEntry> getIssues() {
        return issues;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FsuReadinessCheck)) {
            return false;
        }

        FsuReadinessCheck other = (FsuReadinessCheck) o;
