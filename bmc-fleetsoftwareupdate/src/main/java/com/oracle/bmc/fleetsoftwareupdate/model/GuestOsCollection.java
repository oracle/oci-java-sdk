...
/**
 * Details of a 'GUEST_OS' type Exadata Fleet Update Collection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsCollection.Builder.class)
...
public final class GuestOsCollection extends FsuCollection {
    ...
    public static class Builder {
        ...
        public GuestOsCollection build() {
            GuestOsCollection model =
                    new GuestOsCollection(
                            this.id,
                            this.displayName,
                            this.serviceType,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsCollection)) {
            return false;
        }

        GuestOsCollection other = (GuestOsCollection) o;
