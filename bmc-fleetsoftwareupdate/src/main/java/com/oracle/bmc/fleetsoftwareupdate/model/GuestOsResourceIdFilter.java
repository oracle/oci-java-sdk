...
/**
 * The [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of associated
 * resources to include when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection.
 * <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsResourceIdFilter.Builder.class)
...
public final class GuestOsResourceIdFilter extends GuestOsFleetDiscoveryFilter {
    ...
    public static class Builder {
         ...
         * associated resources to include when discovering Exadata VM Cluster targets for a
         * 'GUEST_OS' collection. Specified resources must match the specified 'entityType'.
        ...
        public GuestOsResourceIdFilter build() {
            GuestOsResourceIdFilter model =
                    new GuestOsResourceIdFilter(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsResourceIdFilter model) {
    ...
    @Deprecated
    public GuestOsResourceIdFilter(
            Mode mode,
    ...
    /**
     * The [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
     * associated resources to include when discovering Exadata VM Cluster targets for a 'GUEST_OS'
     * collection. Specified resources must match the specified 'entityType'. FsuCollection of type
     * 'GI' or 'GUEST_OS' can be specified.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("identifiers")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsResourceIdFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsResourceIdFilter)) {
            return false;
        }

        GuestOsResourceIdFilter other = (GuestOsResourceIdFilter) o;
