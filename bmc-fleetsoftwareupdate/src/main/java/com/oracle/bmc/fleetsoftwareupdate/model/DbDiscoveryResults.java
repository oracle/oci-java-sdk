...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = DbDiscoveryResults.Builder.class)
...
public final class DbDiscoveryResults extends DbFleetDiscoveryDetails {
    ...
    public static class Builder {
        ...
        public DbDiscoveryResults build() {
            DbDiscoveryResults model = new DbDiscoveryResults(this.fsuDiscoveryId);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbDiscoveryResults model) {
    ...
    @Deprecated
    public DbDiscoveryResults(String fsuDiscoveryId) {
        super();
        this.fsuDiscoveryId = fsuDiscoveryId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbDiscoveryResults)) {
            return false;
        }

        DbDiscoveryResults other = (DbDiscoveryResults) o;
