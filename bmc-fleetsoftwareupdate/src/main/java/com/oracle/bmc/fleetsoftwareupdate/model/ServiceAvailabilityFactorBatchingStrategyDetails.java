...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = ServiceAvailabilityFactorBatchingStrategyDetails.Builder.class)
...
public final class ServiceAvailabilityFactorBatchingStrategyDetails
        extends BatchingStrategyDetails {
    ...
    public static class Builder {
        ...
        public ServiceAvailabilityFactorBatchingStrategyDetails build() {
            ServiceAvailabilityFactorBatchingStrategyDetails model =
                    new ServiceAvailabilityFactorBatchingStrategyDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ServiceAvailabilityFactorBatchingStrategyDetails model) {
    ...
    @Deprecated
    public ServiceAvailabilityFactorBatchingStrategyDetails(
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("ServiceAvailabilityFactorBatchingStrategyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceAvailabilityFactorBatchingStrategyDetails)) {
            return false;
        }

        ServiceAvailabilityFactorBatchingStrategyDetails other =
                (ServiceAvailabilityFactorBatchingStrategyDetails) o;
