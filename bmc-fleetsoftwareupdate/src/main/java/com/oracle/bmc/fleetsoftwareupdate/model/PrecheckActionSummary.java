...
public final class PrecheckActionSummary extends FsuActionSummary {
    ...
    public static class Builder {
        ...
        public PrecheckActionSummary build() {
            PrecheckActionSummary model =
                    new PrecheckActionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrecheckActionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrecheckActionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrecheckActionSummary)) {
            return false;
        }

        PrecheckActionSummary other = (PrecheckActionSummary) o;
