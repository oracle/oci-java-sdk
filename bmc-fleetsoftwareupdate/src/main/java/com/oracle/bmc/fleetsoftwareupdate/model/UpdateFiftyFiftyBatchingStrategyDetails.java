...
/**
 * Fifty-Fifty batching strategy details to use during PRECHECK and APPLY Cycle Actions. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = UpdateFiftyFiftyBatchingStrategyDetails.Builder.class)
...
public final class UpdateFiftyFiftyBatchingStrategyDetails extends UpdateBatchingStrategyDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {
        /**
         * True to wait for customer to resume the Apply Action once the first half is done. False
         * to automatically patch the second half.
         */
        ...
        public UpdateFiftyFiftyBatchingStrategyDetails build() {
            UpdateFiftyFiftyBatchingStrategyDetails model =
                    new UpdateFiftyFiftyBatchingStrategyDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(UpdateFiftyFiftyBatchingStrategyDetails model) {
    ...
    @Deprecated
    public UpdateFiftyFiftyBatchingStrategyDetails(
    ...
    /**
     * True to wait for customer to resume the Apply Action once the first half is done. False to
     * automatically patch the second half.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("isWaitForBatchResume")
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("UpdateFiftyFiftyBatchingStrategyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFiftyFiftyBatchingStrategyDetails)) {
            return false;
        }

        UpdateFiftyFiftyBatchingStrategyDetails other = (UpdateFiftyFiftyBatchingStrategyDetails) o;
