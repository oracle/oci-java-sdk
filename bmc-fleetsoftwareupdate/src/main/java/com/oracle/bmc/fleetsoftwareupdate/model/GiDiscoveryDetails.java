...
/**
 * Details to create a 'GI' type Exadata Fleet Update Discovery. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiDiscoveryDetails.Builder.class)
...
public final class GiDiscoveryDetails extends DiscoveryDetails {
    ...
    public static class Builder {
         ...
         * Discovery results. Only GI targets that match the version specified in this value would
         * be added to the Exadata Fleet Update Discovery results.
         */
        ...
        public GiDiscoveryDetails build() {
            GiDiscoveryDetails model =
                    new GiDiscoveryDetails(
    ...
    /**
     * Grid Infrastructure Major Version of targets to be included in the Exadata Fleet Update
     * Discovery results. Only GI targets that match the version specified in this value would be
     * added to the Exadata Fleet Update Discovery results.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("sourceMajorVersion")
    ...
    public boolean equals(Object o) {
        ...
        GiDiscoveryDetails other = (GiDiscoveryDetails) o;
