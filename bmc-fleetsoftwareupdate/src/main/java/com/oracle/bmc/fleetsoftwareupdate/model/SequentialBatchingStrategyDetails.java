...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = SequentialBatchingStrategyDetails.Builder.class
)
...
public final class SequentialBatchingStrategyDetails extends BatchingStrategyDetails {
    ...
    public static class Builder {
        ...
        public SequentialBatchingStrategyDetails build() {
            SequentialBatchingStrategyDetails model =
                    new SequentialBatchingStrategyDetails(this.isForceRolling);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(SequentialBatchingStrategyDetails model) {
    ...
    @Deprecated
    public SequentialBatchingStrategyDetails(Boolean isForceRolling) {
        super();
        this.isForceRolling = isForceRolling;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("SequentialBatchingStrategyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SequentialBatchingStrategyDetails)) {
            return false;
        }

        SequentialBatchingStrategyDetails other = (SequentialBatchingStrategyDetails) o;
        return java.util.Objects.equals(this.isForceRolling, other.isForceRolling)
                && super.equals(other);
    }
