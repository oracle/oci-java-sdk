...
public final class RollbackCycleFsuJobSummary extends FsuJobSummary {
    ...
    public static class Builder {
        ...
        public RollbackCycleFsuJobSummary build() {
            RollbackCycleFsuJobSummary model =
                    new RollbackCycleFsuJobSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RollbackCycleFsuJobSummary model) {
    ...
    @Deprecated
    public RollbackCycleFsuJobSummary(
            String id,
            String displayName,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RollbackCycleFsuJobSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RollbackCycleFsuJobSummary)) {
            return false;
        }

        RollbackCycleFsuJobSummary other = (RollbackCycleFsuJobSummary) o;
