...
/**
 * Apply Exadata Fleet Update Action details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApplyAction.Builder.class)
...
public final class ApplyAction extends FsuAction {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(ApplyAction model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ApplyAction)) {
            return false;
        }

        ApplyAction other = (ApplyAction) o;
