...
public class AddFsuCollectionTargetsConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(AddFsuCollectionTargetsConverter.class);

    public static com.oracle.bmc.fleetsoftwareupdate.requests.AddFsuCollectionTargetsRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.fleetsoftwareupdate.requests.AddFsuCollectionTargetsRequest request) {
    ...
    public static java.util.function.Function<
                    ...
                    com.oracle.bmc.fleetsoftwareupdate.responses.AddFsuCollectionTargetsResponse>
            fromResponse() {
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.fleetsoftwareupdate.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetsoftwareupdate.responses.AddFsuCollectionTargetsResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                .AddFsuCollectionTargetsResponse.Builder
                                        builder =
                                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                        .AddFsuCollectionTargetsResponse.builder()
