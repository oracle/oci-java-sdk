...
/**
 * Precheck Exadata Fleet Update Action details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PrecheckAction.Builder.class)
...
public final class PrecheckAction extends FsuAction {
    ...
    public static class Builder {
        ...
        public PrecheckAction build() {
            PrecheckAction model =
                    new PrecheckAction(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrecheckAction model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrecheckAction)) {
            return false;
        }

        PrecheckAction other = (PrecheckAction) o;
