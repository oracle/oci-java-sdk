...
/**
 * Summary of Stage Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = StageFsuJobSummary.Builder.class)
...
public final class StageFsuJobSummary extends FsuJobSummary {
    ...
    public static class Builder {
        ...
        public StageFsuJobSummary build() {
            StageFsuJobSummary model =
                    new StageFsuJobSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(StageFsuJobSummary model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StageFsuJobSummary)) {
            return false;
        }

        StageFsuJobSummary other = (StageFsuJobSummary) o;
