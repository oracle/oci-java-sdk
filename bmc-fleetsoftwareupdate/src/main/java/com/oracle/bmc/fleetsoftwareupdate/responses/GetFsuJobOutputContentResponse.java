...
public class GetFsuJobOutputContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetFsuJobOutputContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetFsuJobOutputContentResponse o) {
         ...
         */
        @Override
        public GetFsuJobOutputContentResponse build() {
            return new GetFsuJobOutputContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFsuJobOutputContentResponse)) {
            return false;
        }

        GetFsuJobOutputContentResponse other = (GetFsuJobOutputContentResponse) o;
