...
/**
 * Details of goal version for 'GI' component in an 'EXADB_STACK' type Exadata Fleet Update
 * Collection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiGoalSoftwareComponentDetails.Builder.class)
...
public final class GiGoalSoftwareComponentDetails extends GoalSoftwareComponentDetails {
    @com.fasterxml.jackson.databind.annotation.JsonPOJOBuilder(withPrefix = "")
    public static class Builder {

        @com.fasterxml.jackson.annotation.JsonProperty("goalVersionDetails")
        private GiGoalVersionDetails goalVersionDetails;

        public Builder goalVersionDetails(GiGoalVersionDetails goalVersionDetails) {
            this.goalVersionDetails = goalVersionDetails;
            this.__explicitlySet__.add("goalVersionDetails");
            return this;
        }
        /**
         * Goal home policy to use when Staging the Goal Version during patching. CREATE_NEW: Create
         * a new DBHome (for Database Collections) for the specified image or version. USE_EXISTING:
         * All database targets in the same VMCluster or CloudVmCluster will be moved to a shared
         * database home. If an existing home for the selected image or version is not found in the
         * VM Cluster for a target database, then a new home will be created. If more than one
         * existing home for the selected image is found, then the home with the least number of
         * databases will be used. If multiple homes have the least number of databases, then a home
         ...
         * will be selected at random.
         *
         * @param homePolicy the value to set
         * @return this builder
         */
         ...
         * generated for the new DB home resources created.
         *
         * @param newHomePrefix the value to set
         * @return this builder
         */
        ...
        public GiGoalSoftwareComponentDetails build() {
            GiGoalSoftwareComponentDetails model =
                    new GiGoalSoftwareComponentDetails(
                            this.goalVersionDetails, this.homePolicy, this.newHomePrefix);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiGoalSoftwareComponentDetails model) {
    ...
    @Deprecated
    public GiGoalSoftwareComponentDetails(
            GiGoalVersionDetails goalVersionDetails, HomePolicy homePolicy, String newHomePrefix) {
        super();
        this.goalVersionDetails = goalVersionDetails;
        this.homePolicy = homePolicy;
        this.newHomePrefix = newHomePrefix;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("goalVersionDetails")
    private final GiGoalVersionDetails goalVersionDetails;

    public GiGoalVersionDetails getGoalVersionDetails() {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GiGoalSoftwareComponentDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiGoalSoftwareComponentDetails)) {
            return false;
        }

        GiGoalSoftwareComponentDetails other = (GiGoalSoftwareComponentDetails) o;
        return java.util.Objects.equals(this.goalVersionDetails, other.goalVersionDetails)
                && java.util.Objects.equals(this.homePolicy, other.homePolicy)
