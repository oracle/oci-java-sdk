...
public final class DbNameFilter extends DbFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        public DbNameFilter build() {
            DbNameFilter model = new DbNameFilter(this.mode, this.names);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbNameFilter model) {
    ...
    @Deprecated
    public DbNameFilter(Mode mode, java.util.List<String> names) {
        super(mode);
        this.names = names;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbNameFilter)) {
            return false;
        }

        DbNameFilter other = (DbNameFilter) o;
