...
/**
 * 'DB' type Exadata Fleet Update Collection details. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = DbCollection.Builder.class)
...
public final class DbCollection extends FsuCollection {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(DbCollection model) {
    ...
    public boolean equals(Object o) {
        ...
        DbCollection other = (DbCollection) o;
