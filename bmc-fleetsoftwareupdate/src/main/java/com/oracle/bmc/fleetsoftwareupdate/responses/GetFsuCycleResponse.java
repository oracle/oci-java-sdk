...
public class GetFsuCycleResponse extends com.oracle.bmc.responses.BmcResponse {
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<GetFsuCycleResponse> {
         ...
         */
        @Override
        public Builder copy(GetFsuCycleResponse o) {
         ...
         */
        @Override
        public GetFsuCycleResponse build() {
            return new GetFsuCycleResponse(
                    __httpStatusCode__, headers, etag, opcRequestId, fsuCycle);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFsuCycleResponse)) {
            return false;
        }

        GetFsuCycleResponse other = (GetFsuCycleResponse) o;
