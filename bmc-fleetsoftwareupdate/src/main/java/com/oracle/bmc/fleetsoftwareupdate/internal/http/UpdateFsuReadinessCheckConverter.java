...
public class UpdateFsuReadinessCheckConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(UpdateFsuReadinessCheckConverter.class);

    public static com.oracle.bmc.fleetsoftwareupdate.requests.UpdateFsuReadinessCheckRequest
            interceptRequest(
                    com.oracle.bmc.fleetsoftwareupdate.requests.UpdateFsuReadinessCheckRequest
                            request) {
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.fleetsoftwareupdate.requests.UpdateFsuReadinessCheckRequest request) {
                ...
                client.getBaseTarget()
                        ...
                        .path(
                                com.oracle.bmc.util.internal.HttpUtils.encodePathSegment(
                                        request.getFsuReadinessCheckId()));
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.fleetsoftwareupdate.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetsoftwareupdate.responses.UpdateFsuReadinessCheckResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                .UpdateFsuReadinessCheckResponse.Builder
                                        builder =
                                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                        .UpdateFsuReadinessCheckResponse.builder()
