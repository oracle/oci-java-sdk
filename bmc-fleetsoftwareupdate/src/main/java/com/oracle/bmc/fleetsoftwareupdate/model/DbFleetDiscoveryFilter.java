...
/**
 * Possible Discovery filters for Database targets. <br>
...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = DbFleetDiscoveryFilter.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbDefinedTagsFilter.class,
            name = "DEFINED_TAG"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbUniqueNameFilter.class,
            name = "DB_UNIQUE_NAME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbVersionFilter.class,
            name = "VERSION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbResourceIdFilter.class,
            name = "RESOURCE_ID"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbHomeNameFilter.class,
            name = "DB_HOME_NAME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbCompartmentIdFilter.class,
            name = "COMPARTMENT_ID"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbNameFilter.class,
            name = "DB_NAME"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = DbFreeformTagsFilter.class,
            name = "FREEFORM_TAG")
})
...
public class DbFleetDiscoveryFilter
    ...
    protected DbFleetDiscoveryFilter(Mode mode) {
        super();
        this.mode = mode;
    }

    /**
     * INCLUDE or EXCLUDE the filter results in the discovery for DB targets. Supported for
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("DbFleetDiscoveryFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DbFleetDiscoveryFilter)) {
            return false;
        }

        DbFleetDiscoveryFilter other = (DbFleetDiscoveryFilter) o;
