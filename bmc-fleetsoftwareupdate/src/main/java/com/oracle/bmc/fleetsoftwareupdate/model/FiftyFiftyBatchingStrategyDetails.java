...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = FiftyFiftyBatchingStrategyDetails.Builder.class
)
...
public final class FiftyFiftyBatchingStrategyDetails extends BatchingStrategyDetails {
    ...
    public static class Builder {
        ...
        public FiftyFiftyBatchingStrategyDetails build() {
            FiftyFiftyBatchingStrategyDetails model =
                    new FiftyFiftyBatchingStrategyDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(FiftyFiftyBatchingStrategyDetails model) {
    ...
    @Deprecated
    public FiftyFiftyBatchingStrategyDetails(Boolean isWaitForBatchResume, Boolean isForceRolling) {
        super();
        this.isWaitForBatchResume = isWaitForBatchResume;
        this.isForceRolling = isForceRolling;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("FiftyFiftyBatchingStrategyDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FiftyFiftyBatchingStrategyDetails)) {
            return false;
        }

        FiftyFiftyBatchingStrategyDetails other = (FiftyFiftyBatchingStrategyDetails) o;
