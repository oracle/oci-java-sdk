...
/**
 * 'GI' type Exadata Fleet Update Collection summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GiFsuCollectionSummary.Builder.class)
...
public final class GiFsuCollectionSummary extends FsuCollectionSummary {
    ...
    public static class Builder {
        ...
        public GiFsuCollectionSummary build() {
            GiFsuCollectionSummary model =
                    new GiFsuCollectionSummary(
                            this.id,
                            this.displayName,
                            this.serviceType,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GiFsuCollectionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GiFsuCollectionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GiFsuCollectionSummary)) {
            return false;
        }

        GiFsuCollectionSummary other = (GiFsuCollectionSummary) o;
