...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = CreateServiceAvailabilityFactorBatchingStrategyDetails.Builder.class
)
...
public final class CreateServiceAvailabilityFactorBatchingStrategyDetails
        extends CreateBatchingStrategyDetails {
    ...
    public static class Builder {
        ...
        public CreateServiceAvailabilityFactorBatchingStrategyDetails build() {
            CreateServiceAvailabilityFactorBatchingStrategyDetails model =
                    new CreateServiceAvailabilityFactorBatchingStrategyDetails(
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(CreateServiceAvailabilityFactorBatchingStrategyDetails model) {
    ...
    @Deprecated
    public CreateServiceAvailabilityFactorBatchingStrategyDetails(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateServiceAvailabilityFactorBatchingStrategyDetails)) {
            return false;
        }

        CreateServiceAvailabilityFactorBatchingStrategyDetails other =
                (CreateServiceAvailabilityFactorBatchingStrategyDetails) o;
