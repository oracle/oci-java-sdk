...
public class CloneFsuCycleResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    public static class Builder
            implements com.oracle.bmc.responses.BmcResponse.Builder<CloneFsuCycleResponse> {
         ...
         */
        @Override
        public Builder copy(CloneFsuCycleResponse o) {
         ...
         */
        @Override
        public CloneFsuCycleResponse build() {
            return new CloneFsuCycleResponse(
                    __httpStatusCode__,
                    headers,
                    opcWorkRequestId,
                    opcRequestId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CloneFsuCycleResponse)) {
            return false;
        }

        CloneFsuCycleResponse other = (CloneFsuCycleResponse) o;
