...
@com.fasterxml.jackson.annotation.JsonTypeInfo(
        ...
        property = "type",
        defaultImpl = GuestOsFleetDiscoveryFilter.class)
@com.fasterxml.jackson.annotation.JsonSubTypes({
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsVersionFilter.class,
            name = "VERSION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsExadataReleaseVersionFilter.class,
            name = "EXADATA_RELEASE_VERSION"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsFreeformTagsFilter.class,
            name = "FREEFORM_TAG"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsDefinedTagsFilter.class,
            name = "DEFINED_TAG"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsCompartmentIdFilter.class,
            name = "COMPARTMENT_ID"),
    @com.fasterxml.jackson.annotation.JsonSubTypes.Type(
            value = GuestOsResourceIdFilter.class,
            name = "RESOURCE_ID")
})
...
public class GuestOsFleetDiscoveryFilter
    ...
    protected GuestOsFleetDiscoveryFilter(Mode mode) {
        super();
        this.mode = mode;
    }

    /**
     * INCLUDE or EXCLUDE the filter results when discovering Exadata VM Cluster targets for a
     * 'GUEST_OS' collection. Supported only for RESOURCE_ID filter.
     */
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsFleetDiscoveryFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsFleetDiscoveryFilter)) {
            return false;
        }

        GuestOsFleetDiscoveryFilter other = (GuestOsFleetDiscoveryFilter) o;
    ...
    public enum Type implements com.oracle.bmc.http.internal.BmcEnum {
        ...
        Version("VERSION"),
        ExadataReleaseVersion("EXADATA_RELEASE_VERSION"),
