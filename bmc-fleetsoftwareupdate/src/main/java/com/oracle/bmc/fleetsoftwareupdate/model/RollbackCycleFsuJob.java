...
/**
 * Rollback Maintenance Cycle Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RollbackCycleFsuJob.Builder.class)
...
public final class RollbackCycleFsuJob extends FsuJob {
    ...
    public static class Builder {
        ...
        public RollbackCycleFsuJob build() {
            RollbackCycleFsuJob model =
                    new RollbackCycleFsuJob(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RollbackCycleFsuJob model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RollbackCycleFsuJob)) {
            return false;
        }

        RollbackCycleFsuJob other = (RollbackCycleFsuJob) o;
