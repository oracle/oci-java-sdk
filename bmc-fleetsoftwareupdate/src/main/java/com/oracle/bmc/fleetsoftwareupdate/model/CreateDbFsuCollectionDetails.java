...
/**
 * Details to create a 'DB' type Exadata Fleet Update Collection. Targets belonging to another 'DB'
 * type Exadata Fleet Update Collection will be rejected. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = CreateDbFsuCollectionDetails.Builder.class)
...
public final class CreateDbFsuCollectionDetails extends CreateFsuCollectionDetails {
    ...
    public static class Builder {
        ...
        public CreateDbFsuCollectionDetails build() {
            CreateDbFsuCollectionDetails model =
                    new CreateDbFsuCollectionDetails(
                            this.displayName,
                            this.serviceType,
                            this.compartmentId,
                            this.freeformTags,
    ...
    @Deprecated
    public CreateDbFsuCollectionDetails(
            String displayName,
    ...
    public boolean equals(Object o) {
        ...
        CreateDbFsuCollectionDetails other = (CreateDbFsuCollectionDetails) o;
