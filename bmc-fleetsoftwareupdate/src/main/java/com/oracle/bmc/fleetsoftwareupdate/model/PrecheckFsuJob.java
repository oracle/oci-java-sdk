...
/**
 * Precheck Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = PrecheckFsuJob.Builder.class)
...
public final class PrecheckFsuJob extends FsuJob {
    ...
    public static class Builder {
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrecheckFsuJob model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrecheckFsuJob)) {
            return false;
        }

        PrecheckFsuJob other = (PrecheckFsuJob) o;
