...
/**
 * [Defined tags](https://docs.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) to include
 * when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsDefinedTagsFilter.Builder.class)
...
public final class GuestOsDefinedTagsFilter extends GuestOsFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        /**
         * [Defined tags](https://docs.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) to
         * include when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection.
         */
        ...
        public GuestOsDefinedTagsFilter build() {
            GuestOsDefinedTagsFilter model =
                    new GuestOsDefinedTagsFilter(this.mode, this.tags, this.operator);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsDefinedTagsFilter model) {
    ...
    @Deprecated
    public GuestOsDefinedTagsFilter(
            Mode mode,
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsDefinedTagsFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsDefinedTagsFilter)) {
            return false;
        }

        GuestOsDefinedTagsFilter other = (GuestOsDefinedTagsFilter) o;
