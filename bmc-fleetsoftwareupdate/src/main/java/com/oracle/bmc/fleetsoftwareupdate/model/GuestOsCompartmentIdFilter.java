 ...
 * compartments to include when discovering Exadata VM Cluster targets for a 'GUEST_OS' collection.
 * <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsCompartmentIdFilter.Builder.class)
...
public final class GuestOsCompartmentIdFilter extends GuestOsFleetDiscoveryFilter {
    ...
    public static class Builder {
        ...
        /**
         * List of [OCIDs](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of
         * Compartments to include when discovering Exadata VM Cluster targets for a 'GUEST_OS'
         * collection.
         */
        ...
        public GuestOsCompartmentIdFilter build() {
            GuestOsCompartmentIdFilter model =
                    new GuestOsCompartmentIdFilter(this.mode, this.identifiers);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsCompartmentIdFilter model) {
    ...
    @Deprecated
    public GuestOsCompartmentIdFilter(Mode mode, java.util.List<String> identifiers) {
        super(mode);
        this.identifiers = identifiers;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsCompartmentIdFilter(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsCompartmentIdFilter)) {
            return false;
        }

        GuestOsCompartmentIdFilter other = (GuestOsCompartmentIdFilter) o;
