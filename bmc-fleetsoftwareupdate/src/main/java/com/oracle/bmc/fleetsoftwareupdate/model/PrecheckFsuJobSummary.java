...
public final class PrecheckFsuJobSummary extends FsuJobSummary {
    ...
    public static class Builder {
        ...
        public PrecheckFsuJobSummary build() {
            PrecheckFsuJobSummary model =
                    new PrecheckFsuJobSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.fsuActionId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(PrecheckFsuJobSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("PrecheckFsuJobSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrecheckFsuJobSummary)) {
            return false;
        }

        PrecheckFsuJobSummary other = (PrecheckFsuJobSummary) o;
