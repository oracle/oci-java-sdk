...
/**
 * Rollback Exadata Fleet Update Action summary. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = RollbackActionSummary.Builder.class)
...
public final class RollbackActionSummary extends FsuActionSummary {
    ...
    public static class Builder {
        ...
        public Builder details(RollbackDetails details) {
        ...
        public RollbackActionSummary build() {
            RollbackActionSummary model =
                    new RollbackActionSummary(
                            this.id,
                            this.displayName,
                            this.compartmentId,
                            this.timeCreated,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RollbackActionSummary model) {
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("RollbackActionSummary(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RollbackActionSummary)) {
            return false;
        }

        RollbackActionSummary other = (RollbackActionSummary) o;
