...
public class GetFsuActionOutputContentResponse extends com.oracle.bmc.responses.BmcResponse {
    /**
    ...
    private GetFsuActionOutputContentResponse(
    ...
    public static class Builder
         ...
         */
        @Override
        public Builder copy(GetFsuActionOutputContentResponse o) {
         ...
         */
        @Override
        public GetFsuActionOutputContentResponse build() {
            return new GetFsuActionOutputContentResponse(
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetFsuActionOutputContentResponse)) {
            return false;
        }

        GetFsuActionOutputContentResponse other = (GetFsuActionOutputContentResponse) o;
