...
/**
 * Rolback & Remove Targets Exadata Fleet Update Job resource. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RollbackFsuJob.Builder.class)
...
public final class RollbackFsuJob extends FsuJob {
    ...
    public static class Builder {
        ...
        public RollbackFsuJob build() {
            RollbackFsuJob model =
                    new RollbackFsuJob(
                            this.id,
                            this.displayName,
                            this.compartmentId,
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(RollbackFsuJob model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RollbackFsuJob)) {
            return false;
        }

        RollbackFsuJob other = (RollbackFsuJob) o;
