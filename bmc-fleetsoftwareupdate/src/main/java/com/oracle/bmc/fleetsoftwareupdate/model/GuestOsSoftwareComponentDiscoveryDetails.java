...
/**
 * Discovery filter details of 'GUEST_OS' component in an Exadata software stack. <br>
...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
        builder = GuestOsSoftwareComponentDiscoveryDetails.Builder.class)
...
public final class GuestOsSoftwareComponentDiscoveryDetails
        extends SoftwareComponentDiscoveryDetails {
    ...
    public static class Builder {
        ...
        public GuestOsSoftwareComponentDiscoveryDetails build() {
            GuestOsSoftwareComponentDiscoveryDetails model =
                    new GuestOsSoftwareComponentDiscoveryDetails(
                            this.sourceMajorVersion, this.criteria);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(GuestOsSoftwareComponentDiscoveryDetails model) {
    ...
    @Deprecated
    public GuestOsSoftwareComponentDiscoveryDetails(
            GuestOsSourceMajorVersions sourceMajorVersion, GuestOsFleetDiscoveryDetails criteria) {
        super();
        this.sourceMajorVersion = sourceMajorVersion;
        this.criteria = criteria;
    }
    ...
    public String toString(boolean includeByteArrayContents) {
        ...
        sb.append("GuestOsSoftwareComponentDiscoveryDetails(");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuestOsSoftwareComponentDiscoveryDetails)) {
            return false;
        }

        GuestOsSoftwareComponentDiscoveryDetails other =
                (GuestOsSoftwareComponentDiscoveryDetails) o;
