...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/ChangeFsuDiscoveryCompartmentExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use ChangeFsuDiscoveryCompartmentRequest.
 */
...
public class ChangeFsuDiscoveryCompartmentRequest
    ...
    public static class Builder
        ...
        public ChangeFsuDiscoveryCompartmentRequest buildWithoutInvocationCallback() {
            ...
            return request;
            // new ChangeFsuDiscoveryCompartmentRequest(fsuDiscoveryId, changeFsuDiscoveryCompartmentDetails, ifMatch, opcRequestId, opcRetryToken);
        }
    }
