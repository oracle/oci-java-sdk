...
public class CreateFsuCollectionConverter {
    private static final com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2
            RESPONSE_CONVERSION_FACTORY =
                    new com.oracle.bmc.http.internal.ResponseConversionFunctionFactoryV2();

    private static final org.slf4j.Logger LOG =
            org.slf4j.LoggerFactory.getLogger(CreateFsuCollectionConverter.class);

    public static com.oracle.bmc.fleetsoftwareupdate.requests.CreateFsuCollectionRequest
            interceptRequest(
    ...
    public static com.oracle.bmc.http.internal.WrappedInvocationBuilder fromRequest(
            ...
            com.oracle.bmc.fleetsoftwareupdate.requests.CreateFsuCollectionRequest request) {
        Validate.notNull(request, "request instance is required");
        Validate.notNull(
                request.getCreateFsuCollectionDetails(), "createFsuCollectionDetails is required");

        com.oracle.bmc.http.internal.WrappedWebTarget target =
                client.getBaseTarget().path("/20220528").path("fsuCollections");
                ...
                transformer =
                        new java.util.function.Function<
                            ...
                            public com.oracle.bmc.fleetsoftwareupdate.responses
                                ...
                                LOG.trace(
                                        "Transform function invoked for com.oracle.bmc.fleetsoftwareupdate.responses.CreateFsuCollectionResponse");
                                final java.util.function.Function<
                                                javax.ws.rs.core.Response,
                                ...
                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                .CreateFsuCollectionResponse.Builder
                                        builder =
                                                com.oracle.bmc.fleetsoftwareupdate.responses
                                                        .CreateFsuCollectionResponse.builder()
