...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
    builder = JobProgressDetails.Builder.class
)
@com.fasterxml.jackson.annotation.JsonFilter(com.oracle.bmc.http.internal.ExplicitlySetFilter.NAME)
public final class JobProgressDetails extends com.oracle.bmc.http.internal.ExplicitlySetBmcModel {
    @Deprecated
    @java.beans.ConstructorProperties({"progressOfOperation"})
    public JobProgressDetails(Integer progressOfOperation) {
        super();
    ...
    public static class Builder {
        ...
        public JobProgressDetails build() {
            JobProgressDetails model = new JobProgressDetails(this.progressOfOperation);
        ...
        @com.fasterxml.jackson.annotation.JsonIgnore
        public Builder copy(JobProgressDetails model) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JobProgressDetails)) {
            return false;
        }

        JobProgressDetails other = (JobProgressDetails) o;
