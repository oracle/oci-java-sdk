...
/**
 * <b>Example: </b>Click <a href="https://docs.cloud.oracle.com/en-us/iaas/tools/java-sdk-examples/latest/fleetsoftwareupdate/UpdateFsuCycleExample.java.html" target="_blank" rel="noopener noreferrer">here</a> to see how to use UpdateFsuCycleRequest.
 */
...
public class UpdateFsuCycleRequest
    ...
    public com.oracle.bmc.fleetsoftwareupdate.model.UpdateFsuCycleDetails getBody$() {
        return updateFsuCycleDetails;
    }
    ...
    public static class Builder
         ...
         * The Exadata Fleet Update Cycle details to be updated.
         *
         * @param updateFsuCycleDetails the value to set
         * @return this builder instance
         */
        public Builder updateFsuCycleDetails(
                com.oracle.bmc.fleetsoftwareupdate.model.UpdateFsuCycleDetails
                        updateFsuCycleDetails) {
            this.updateFsuCycleDetails = updateFsuCycleDetails;
            return this;
        }
        ...
        public Builder copy(UpdateFsuCycleRequest o) {
            ...
            updateFsuCycleDetails(o.getUpdateFsuCycleDetails());
         ...
         */
        public UpdateFsuCycleRequest build() {
            UpdateFsuCycleRequest request = buildWithoutInvocationCallback();
         ...
         */
        @com.oracle.bmc.InternalSdk
        public Builder body$(com.oracle.bmc.fleetsoftwareupdate.model.UpdateFsuCycleDetails body) {
            updateFsuCycleDetails(body);
            return this;
        }
         ...
         * @return instance of UpdateFsuCycleRequest
         */
        public UpdateFsuCycleRequest buildWithoutInvocationCallback() {
            UpdateFsuCycleRequest request = new UpdateFsuCycleRequest();
            request.fsuCycleId = fsuCycleId;
            request.updateFsuCycleDetails = updateFsuCycleDetails;
            request.ifMatch = ifMatch;
            request.opcRequestId = opcRequestId;
            return request;
            // new UpdateFsuCycleRequest(fsuCycleId, updateFsuCycleDetails, ifMatch, opcRequestId);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(",updateFsuCycleDetails=").append(String.valueOf(this.updateFsuCycleDetails));
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UpdateFsuCycleRequest)) {
            return false;
        }

        UpdateFsuCycleRequest other = (UpdateFsuCycleRequest) o;
        return super.equals(o)
                && java.util.Objects.equals(this.fsuCycleId, other.fsuCycleId)
                && java.util.Objects.equals(this.updateFsuCycleDetails, other.updateFsuCycleDetails)
    ...
    public int hashCode() {
        ...
        result =
                (result * PRIME)
                        + (this.updateFsuCycleDetails == null
                                ? 43
                                : this.updateFsuCycleDetails.hashCode());
